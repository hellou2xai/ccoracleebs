...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for PTO Accrual Plan Analyzer              |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE pto_analyzer_pkg AUTHID DEFINER AS
...
END pto_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY pto_analyzer_pkg AS
-- $Id: pto_analyzer.sql, 200.16 2025/12/05 18:50:47 siionesc Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2633288.1));
g_cmos_patch_url   VARCHAR2(500) :=
  'https://support.oracle.com/support/ui/patch/PatchDetail.jspx?patchId=';
...
g_analyzer_id      VARCHAR2(24) := '2575';
g_framework_version VARCHAR(240) := '4.8.2';
...
----------------------------------------------------------------
g_plan_name PAY_ACCRUAL_PLANS.accrual_plan_name%type;
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'PTO_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'PTO_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>PTO Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2633288.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/ptolatest.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,2575,EBS,EBS HCM,EBS - HR" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,2575,EBS,EBS HCM,EBS - HR" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},2575,EBS,EBS HCM,EBS - HR" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4315250" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">2575</span>
...
<p>This analyzer will validate basic setup data required around PTO processing and setup.&nbsp;</p><p>&nbsp;Version 200.16<br>
&nbsp;- &nbsp; Removed all non-PTO related SIGs. &nbsp; &nbsp;</p><p>&nbsp;Version 200.15<br>
&nbsp;- &nbsp;Added HCM RUP19</p><p>&nbsp;Version 200.14<br>
&nbsp;- &nbsp; Latest patches</p>
            <br><br>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,2575,'||l_sig.sigrepo_id||',EBS,EBS HCM,EBS - HR" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,2575,'||l_sig.sigrepo_id||',EBS,EBS HCM,EBS - HR" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},2575,'||l_sig.sigrepo_id||',EBS,EBS HCM,EBS - HR" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,2575,'||p_sig.sigrepo_id||',EBS,EBS HCM,EBS - HR" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,2575,'||p_sig.sigrepo_id||',EBS,EBS HCM,EBS - HR" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},2575,'||p_sig.sigrepo_id||',EBS,EBS HCM,EBS - HR" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
and ACTUAL_COMPLETION_DATE>sysdate-31;
return v_exists;
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Accrual Plan ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_planid,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2025/12/05 18:50:46 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'pto_analyzer.sql';
...
debug('begin parameter validation: p_planid');
IF p_planid IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Accrual Plan ID is required.');
...
WHERE ACCRUAL_PLAN_ID = p_planid and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: This is not a valid accrual_plan_id from pay_accrual_plans table.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_planid failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_planid');
...
select accrual_plan_name into g_plan_name 
from PAY_ACCRUAL_PLANS
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$PLANID$$##') := p_planid;
   g_masked_tokens('##$$PLANID$$##') := mask_text( g_sql_tokens('##$$PLANID$$##'), 'NO_MASK');
...
debug('begin add_signature: PTOPLANDETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13925',
      p_sig_id                 => 'PTOPLANDETAILS',
      p_sig_sql                => 'SELECT
    substr(c.accrual_plan_name,1,50) "Plan and Accrual Element Name",
    pet.element_type_id "Plan Element Type Id",
    substr(
        b.formula_name,
        1,
        50
    ...
    (select fff.formula_name from ff_formulas_f fff
     where c.Payroll_formula_id = fff.formula_id
     and Trunc(sysdate) between fff.effective_start_date and fff.effective_end_date)  "Payroll Formula",
        (select fff.formula_name from ff_formulas_f fff
     where c.ineligibility_formula_id = fff.formula_id
     and Trunc(sysdate) between fff.effective_start_date and fff.effective_end_date)  "Ineligibility Formula",
    c.accrual_category "Category",
    (SELECT Meaning from hr_lookups
    where lookup_type = ''ABSENCE_CATEGORY''
    and lookup_code = c.accrual_category) "Absence Category",
    c.accrual_start "Start Type",
    (SELECT Meaning from hr_lookups
    where lookup_type = ''US_ACCRUAL_START_TYPE''
    and lookup_code = c.accrual_start) "Start Type Name ",
    decode(substr(c.accrual_units_of_measure,1,15), ''D'', ''Days'', ''H'', ''Hours'') "Unit Of Measure",
     (select element_type_id from pay_element_types_f
    where element_type_id = ( select  element_type_id from pay_input_values_f
    where input_value_id= c.pto_input_value_id
    and trunc(sysdate) between effective_start_date and effective_end_date)
    and trunc(sysdate) between effective_start_date and effective_end_date)"PTO Absence Element Type Id",
    (select element_name from pay_element_types_f
    where element_type_id = ( select  element_type_id from pay_input_values_f
    where input_value_id= c.pto_input_value_id
    and trunc(sysdate) between effective_start_date and effective_end_date)
    and trunc(sysdate) between effective_start_date and effective_end_date)"PTO Absence Element Name"  ,
    c.defined_balance_id "Balance Id",
    c.ineligible_period_length "Ineligible Period Length",
    c.ineligible_period_type "Ineligible Period Type",
    c.ineligibility_formula_id "Ineligibility Formula Id"
FROM
    pay_accrual_plans c,
    ...
    ff_formulas_f d
WHERE
        c.accrual_plan_id = ##$$PLANID$$##
    AND pet.element_type_id = c.accrual_plan_element_type_id
    AND a.formula_id = co_formula_id
    AND  b.formula_id = accrual_formula_id
    AND d.formula_id (+) = ineligibility_formula_id
    AND trunc(sysdate) between pet.effective_start_date and pet.effective_end_date
    AND trunc(sysdate) between a.effective_start_date and a.effective_end_date
    AND trunc(sysdate) between b.effective_start_date and b.effective_end_date',
      p_title                  => 'Accrual Plan Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Accrual plan name does not exist for the given plan id. Recheck the plan id and run the analyzer again with correct plan Id.',
      p_solution               => 'Please check your Accrual Plan details in the below navigation<br>
N>Total Compensation > Basic > Accrual Plans <br>
Please review the following document in order to setup an Accrual plan: <br>
[148524.1] - How To Setup a PTO Plan and the Elements for This Plan.<br>
[267289.1] - Almost Everything You Wanted to Know About Oracle HRMS Paid Time Off (PTO)<br>
[2097767.1] -Sample Accrual Plan Examples using seeded PTO accrual and Carry Over Formulas	<br>
',
      p_success_msg            => 'This is a data collection of plan details of Accrual Plan: "'||mask_text(g_plan_name, nvl( upper(''), 'NO_MASK') )||'" .',
   ...
   l_info.delete;
debug('end add_signature: PTOPLANDETAILS');



debug('begin add_signature: PTO_ABSENCE_TYPE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13926',
      p_sig_id                 => 'PTO_ABSENCE_TYPE',
      p_sig_sql                => 'SELECT
    substr(paat.name,1,30) "Absence Type Name",
    paat.absence_attendance_type_id "Absence Attendance Type Id",
    substr(paat.d_absence_category,1,20) "Category",
    paat.business_group_id "Business Group Id",
    paat.date_effective "Effective Date",
    paat.date_end "End Date",
    paat.element_type_id "Absence Element Type Id",
    substr(paat.d_element_name,1,20) "Absence Element Name",
    paat.input_value_id "Input Value Id",
    substr(paat.d_input_value_name,1,15) "Input Value Name",
    substr(paat.d_hours_or_days,1,20) "Units",
    substr(paat.d_inc_dec_flag,1,15) "Balance"
...
WHERE
    input_value_id = (
        ...
        FROM
            pay_accrual_plans 
        WHERE
                accrual_plan_id = ##$$PLANID$$##
          )',
      p_title                  => 'Absence Type',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Absence Type created!',
      p_solution               => 'Please review the following document in order to setup an Accrual plan: [148524.1] - How To Setup a PTO Plan and the Elements for This Plan ',
      p_success_msg            => 'This is a data collection of the absence types of Accrual Plan: "'||mask_text(g_plan_name, nvl( upper(''), 'NO_MASK') )||'" .  ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PTO_ABSENCE_TYPE');



debug('begin add_signature: PTO_BAND');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13927',
      p_sig_id                 => 'PTO_BAND',
      p_sig_sql                => 'SELECT
    lower_limit "Age Lower Limit",
    upper_limit "Age Upper Limit",
...
WHERE
    accrual_plan_id = ##$$PLANID$$##
    order by lower_limit, upper_limit',
      p_title                  => 'Accrual Band and Annual Rates',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Bands and Annual Rates are not defined for the Accrual plan.',
      p_solution               => 'This an optional step to define Accrual bands and rates. 
If you haven''t defined them in the accrual fast formula, then please follow the bellow document and configure them per your business requirements.<br><br>

Please review the following document in order to setup an Accrual Plan:<br>
[148524.1] - How To Setup a PTO Plan and the Elements for This Plan.',
      p_success_msg            => 'This is a data collection of the band and rates of Accrual Plan: "'||mask_text(g_plan_name, nvl( upper(''), 'NO_MASK') )||'" .',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PTO_BAND');



debug('begin add_signature: PTO_CALCULATION_RULES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13928',
      p_sig_id                 => 'PTO_CALCULATION_RULES',
      p_sig_sql                => 'SELECT
    substr(
        c.element_name,
        1,
    ...
    a.input_value_id "Input Value Id",
    a.date_input_value_id "Date Input Value Id",
    substr(
        d.name,
        1,
        20
...
WHERE
        accrual_plan_id = ##$$PLANID$$##
    AND
        b.input_value_id = a.input_value_id
    AND
        c.element_type_id = b.element_type_id
    AND
        d.input_value_id (+) = a.date_input_value_id',
      p_title                  => 'Accrual Net Calculation Rules',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No calculation rules are available in the Accrual Plan.',
      p_solution               => 'Please review the following documents in order to setup an Accrual plan: <br>
[148524.1] - How To Setup a PTO Plan and the Elements for This Plan.<br>
[2097767.1] - Sample Accrual Plan Examples using seeded PTO accrual and Carry Over Formulas ',
      p_success_msg            => 'This is a data collection of net calculation rules of Accrual Plan: "'||mask_text(g_plan_name, nvl( upper(''), 'NO_MASK') )||'" .',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PTO_CALCULATION_RULES');



debug('begin add_signature: PTO_ACCRUAL_CATEGORY_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13945',
      p_sig_id                 => 'PTO_ACCRUAL_CATEGORY_DETAILS',
      p_sig_sql                => 'select Lookup_code "Lookup Code",
substr(meaning, 1, 30) "Meaning",
...
AND application_id = 800',
      p_title                  => 'Absence Categories',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No absence category defined.',
      p_solution               => 'Please review the following document in order to setup an Accrual plan: [148524.1] - How To Setup a PTO Plan and the Elements for This Plan.',
      p_success_msg            => 'This is data collection of the absence categories.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PTO_ACCRUAL_CATEGORY_DETAILS');



debug('begin add_signature: PTO_CARRYOVER_CONC_REQUEST_RUN');
   l_info('##MASK##SUBMITTED BY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '21816',
      p_sig_id                 => 'PTO_CARRYOVER_CONC_REQUEST_RUN',
      p_sig_sql                => 'select fcr.request_id,actual_start_date, actual_completion_date,
       Decode(fcr.status_code,''C'',''Normal'',''E'',''Error'',fcr.status_code) "Completed Status",
       fcr.argument1 "Calculation date",fcr.argument3 "Accrual Plan Id",
       (select Accrual_plan_name from pay_accrual_plans where accrual_plan_id = pap.accrual_plan_id) "Accrual Plan Name",
       fcr.argument4 "Accrual Category",fcr.argument5 "Process All Participants",
       fcr.argument6 "Accrual Term",
       (select User_name from fnd_user where user_id = fcr.requested_by) "Submitted By"
       from fnd_concurrent_requests fcr,
            pay_accrual_plans pap
where  pap.accrual_plan_id =  ##$$PLANID$$##
and to_char(pap.accrual_plan_id) = fcr.argument3
Order by fcr.request_id desc',
      p_title                  => 'PTO CarryOver Concurrent Request Run Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This is a data collection of PTO CarryOver Concurrent Request Run Details.',
      p_solution               => '',
      p_success_msg            => 'No PTO CarryOver Concurrent Request Run Details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PTO_CARRYOVER_CONC_REQUEST_RUN');



debug('begin add_signature: PTO_ELEMENT_LINK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13929',
      p_sig_id                 => 'PTO_ELEMENT_LINK',
      p_sig_sql                => 'SELECT
    pel.element_link_id "PTO Element Link Id",
    pel.element_type_id "PTO Element Type Id",
   (select a.element_name from pay_element_types_f a
    where a.element_type_id = pel.element_type_id
    and trunc(sysdate) between a.effective_start_date and a.effective_end_date) "PTO Element Name" ,
    pel.effective_start_date "Effective Start Date",
    pel.effective_end_date "Effective End Date",
    pel.payroll_id "Payroll Id",
    (select a.payroll_name from pay_all_payrolls_f a
    where a.payroll_id = pel.payroll_id
    and trunc(sysdate) between a.effective_start_date and a.effective_end_date) "Payroll Name" ,
    pel.job_id "Job Id",
    (select a.name from per_jobs a
    where a.job_id = pel.job_id ) "Job Name" ,
    pel.position_id "Position Id",
    (select a.name from per_positions a
    where a.position_id = pel.position_id ) "Position Name" ,
    pel.people_group_id "People Group Id",
    (select a.group_name from pay_people_groups a
    where a.people_group_id = pel.people_group_id ) "People Group Name" ,
    pel.organization_id "Organization Id",
    (select a.name from hr_all_organization_units a
    where a.organization_id = pel.organization_id ) "Organization Name" ,
    pel.location_id "Location Id",
    (select a.location_code from hr_locations_all a
    where a.location_id = pel.location_id ) "Location Name" ,
    pel.grade_id "Grade Id",
     (select a.name from per_grades a
    where a.grade_id = pel.grade_id ) "Grade Name" ,
    pel.pay_basis_id "Pay Basis Id",
    (select a.name from per_pay_bases a
    where a.pay_basis_id = pel.pay_basis_id ) "Salary Basis",
    pel.link_to_all_payrolls_flag "Link To Payrolls Flag"
FROM
...
AND  pel.element_type_id = pivf.element_type_id
...
AND  trunc(sysdate) between pivf.effective_start_date and pivf.effective_end_date',
      p_title                  => 'PTO Absence Element Links',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no PTO Absence element link available. <br>
When the Accrual Plan is created, there are 5 elements and corresponding element links created automatically. The links are based on the absence element link definition. If any element link is missing, then the Accrual Plan processes may not behave as expected. Elements:<br>

1. Accrual Plan Element Same as Accrual Plan Name<br>
2. Carry Over Element Same as Accrual Plan name with suffix "Carried Over"<br>
3. Residual Element Same as Accrual Plan name with suffix "Residual"<br>
4. Payroll Balance Element Same as Accrual Plan name with suffix "Payroll Balance"<br>
5. Tagging Element Same as Accrual Plan name with suffix "Tagging" <br>
',
      p_solution               => 'Please create PTO Absence Element link in order to avoid any potential issues! <br>

Accrual Plan setup: [748000.1] - PTO Carryover Process Completes Successfully but does not Create Carryover Elements.<br>
Setup steps: [148524.1] - How To Setup a PTO Plan and the Elements for This Plan.<br>
Detailed setup: [267289.1] - Almost Everything You Wanted to Know About Oracle HRMS Paid Time Off (PTO).<br>
Example setup: [2097767.1] - Sample Accrual Plan Examples using seeded PTO accrual and Carry Over Formulas.<br>
',
      p_success_msg            => 'This is a data collection of the PTO Absence Element Links, which is used for your absence type definition for Accrual Plan: "'||mask_text(g_plan_name, nvl( upper(''), 'NO_MASK') )||'" .',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PTO_ELEMENT_LINK');



debug('begin add_signature: ACCRUAL_PLAN_ELEMENT_LINK_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13941',
      p_sig_id                 => 'ACCRUAL_PLAN_ELEMENT_LINK_DETAILS',
      p_sig_sql                => 'SELECT
    pel.element_link_id "Accrual Plan Element Link Id",
    pel.element_type_id "Plan Element Type Id",
   (select a.element_name from pay_element_types_f a
    where a.element_type_id = pel.element_type_id
    and trunc(sysdate) between a.effective_start_date and a.effective_end_date) "Plan Element Name" ,
    pel.effective_start_date "Effective Start Date",
    pel.effective_end_date "Effective End Date",
    pel.payroll_id "Payroll Id",
    (select a.payroll_name from pay_all_payrolls_f a
...
AND  trunc(sysdate) between pel.effective_start_date and pel.effective_end_date',
      p_title                  => 'Accrual Plan Element Links',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no Accrual Plan element link available.<br>
When the Accrual Plan is created, there are 5 elements and corresponding element links created automatically. The links are based on the absence element link definition. If any element link is missing, then the Accrual Plan processes may not behave as expected. Elements:<br>
...
3. Residual Element Same as Accrual Plan name with suffix "Residual"<br>
4. Payroll Balance Element Same as Accrual Plan name with suffix "Payroll Balance"<br>
5. Tagging Element Same as Accrual Plan name with suffix "Tagging" <br><br>

If an Accrual Plan element link is missing, then you cannot enroll an accrual plan to the employees.',
      p_solution               => 'Please review the following documents in order to setup an Accrual plan element link: <br>
Setup steps: [148524.1] - How To Setup a PTO Plan and the Elements for This Plan.<br>
Detailed setup: [267289.1] - Almost Everything You Wanted to Know About Oracle HRMS Paid Time Off (PTO).<br>
Example setup: [2097767.1] - Sample Accrual Plan Examples using seeded PTO accrual and Carry Over Formulas.<br>
',
      p_success_msg            => 'This is a data collection of the Accrual Plan Element Links of Accrual Plan: "'||mask_text(g_plan_name, nvl( upper(''), 'NO_MASK') )||'" .',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ACCRUAL_PLAN_ELEMENT_LINK_DETAILS');



debug('begin add_signature: PTO_CARRYOVER_ELEMENT_LINK_DETALS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13942',
      p_sig_id                 => 'PTO_CARRYOVER_ELEMENT_LINK_DETALS',
      p_sig_sql                => 'SELECT
    pel.element_link_id "CarryOver Element Link Id",
    pel.element_type_id "CarryOver Element Type Id",
   (select a.element_name from pay_element_types_f a
    where a.element_type_id = pel.element_type_id
    and trunc(sysdate) between a.effective_start_date and a.effective_end_date) "CarryOver Element Name" ,
    pel.effective_start_date "Effective Start Date",
    pel.effective_end_date "Effective End Date",
    pel.payroll_id "Payroll Id",
    (select a.Payroll_name from pay_all_payrolls_f a
...
FROM
    ...
    pay_accrual_plans pap
WHERE pap.accrual_plan_id = ##$$PLANID$$##
AND  pivf.input_value_id = pap.co_input_value_id
AND  pel.element_type_id = pivf.element_type_id
AND  trunc(sysdate) between pel.effective_start_date and pel.effective_end_date
AND  trunc(sysdate) between pivf.effective_start_date and pivf.effective_end_date',
      p_title                  => 'Carry Over Element Links',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no Carry Over element link available.<br>
When the Accrual Plan is created, there are 5 elements and corresponding element links created automatically. The links are based on the absence element link definition. If any element link is missing, then the Accrual Plan processes may not behave as expected. Elements:<br>
...
If a Carried Over Element link is missing, you cannot Carry Over leave balances to your employees in the next year.<br>',
      p_solution               => 'Please review the following documents in order to setup a Carried Over link: <br><br>
Setup steps: [148524.1] - How To Setup a PTO Plan and the Elements for This Plan.<br>
Detailed setup: [267289.1] - Almost Everything You Wanted to Know About Oracle HRMS Paid Time Off (PTO).<br>
Example setup: [2097767.1] - Sample Accrual Plan Examples using seeded PTO accrual and Carry Over Formulas.<br>
',
      p_success_msg            => 'This is a data collection of the Carry Over Element Links of Accrual Plan: "'||mask_text(g_plan_name, nvl( upper(''), 'NO_MASK') )||'" .',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PTO_CARRYOVER_ELEMENT_LINK_DETALS');



debug('begin add_signature: PTO_RESIDUAL_ELEMENT_LINK_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13947',
      p_sig_id                 => 'PTO_RESIDUAL_ELEMENT_LINK_DETAILS',
      p_sig_sql                => 'SELECT
    pel.element_link_id "Residual Element Link Id",
    pel.element_type_id "Residual Element Type Id",
   (select a.element_name from pay_element_types_f a
    where a.element_type_id = pel.element_type_id
    and trunc(sysdate) between a.effective_start_date and a.effective_end_date) "Residual Element Name" ,
    pel.effective_start_date "Effective Start Date",
    pel.effective_end_date "Effective End Date",
    pel.payroll_id "Payroll Id",
    (select a.payroll_name from pay_all_payrolls_f a
...
FROM
    ...
    pay_accrual_plans pap
WHERE pap.accrual_plan_id = ##$$PLANID$$##
AND  pivf.input_value_id = pap.residual_input_value_id
AND  pel.element_type_id = pivf.element_type_id
AND  trunc(sysdate) between pel.effective_start_date and pel.effective_end_date
AND  trunc(sysdate) between pivf.effective_start_date and pivf.effective_end_date',
      p_title                  => 'Residual Element Links',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no Residual element link available.<br>
When the Accrual Plan is created, there are 5 elements and corresponding element links created automatically. The links are based on the absence element link definition. If any element link is missing, then the Accrual Plan processes may not behave as expected. Elements:<br>
...
If a Residual Element link is missing you cannot have Residual, Carry Over leave balances to your employees in the next year.<br>  ',
      p_solution               => 'Please review the following documents in order to setup a Residual element link: <br><br>

Setup steps: [148524.1] - How To Setup a PTO Plan and the Elements for This Plan.<br>
Detailed setup: [267289.1] - Almost Everything You Wanted to Know About Oracle HRMS Paid Time Off (PTO).<br>
Example setup: [2097767.1] - Sample Accrual Plan Examples using seeded PTO accrual and Carry Over Formulas.<br>
',
      p_success_msg            => 'This is a data collection of the Residual Element Links of Accrual Plan: "'||mask_text(g_plan_name, nvl( upper(''), 'NO_MASK') )||'" .',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PTO_RESIDUAL_ELEMENT_LINK_DETAILS');



debug('begin add_signature: TAGGING_ELEMENT_LINK_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13943',
      p_sig_id                 => 'TAGGING_ELEMENT_LINK_DETAILS',
      p_sig_sql                => 'SELECT
    pel.element_link_id "Tagging Element Link Id",
    pel.element_type_id "Tagging Element Type Id",
   (select a.element_name from pay_element_types_f a
    where a.element_type_id = pel.element_type_id
    and trunc(sysdate) between a.effective_start_date and a.effective_end_date) "Tagging Element Name" ,
    pel.effective_start_date "Effective Start Date",
    pel.effective_end_date "Effective End Date",
    pel.payroll_id "Payroll Id",
    (select a.payroll_name from pay_all_payrolls_f a
...
FROM
    ...
    pay_accrual_plans pap
WHERE pap.accrual_plan_id = ##$$PLANID$$##
AND  pel.element_type_id = pap.tagging_element_type_id
AND  trunc(sysdate) between pel.effective_start_date and pel.effective_end_date',
      p_title                  => 'Tagging Element Links',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no Tagging Accrual Plan Link available.<br>
Tagging Element helps to identify absences and other element entries that have been entered retrospectively and not yet included in the gross accrual calculation.<br>
When an Accrual Plan is created, it also creates a Tagging Element and its link as below:<br>
Tagging Element Name: Accrual Plan name with suffix "Tagging". <br>
If a Tagging Element link is missing, then you cannot carry over leave balances to your employees in the next year.
',
      p_solution               => 'You will need to setup Tagging Element Link(s).<br>
Please review the following documents in order to setup a Tagging link: <br><br>

Setup steps: [148524.1] - How To Setup a PTO Plan and the Elements for This Plan.<br>
Detailed setup: [267289.1] - Almost Everything You Wanted to Know About Oracle HRMS Paid Time Off (PTO).<br>
Example setup: [2097767.1] - Sample Accrual Plan Examples using seeded PTO accrual and Carry Over Formulas.<br>',
      p_success_msg            => 'This is a data collection of the Tagging Accrual Element Links of Accrual Plan: "'||mask_text(g_plan_name, nvl( upper(''), 'NO_MASK') )||'" .',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: TAGGING_ELEMENT_LINK_DETAILS');



debug('begin add_signature: PTO_BALANCE_ELEMENT_LINKS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13993',
      p_sig_id                 => 'PTO_BALANCE_ELEMENT_LINKS',
      p_sig_sql                => 'SELECT
    pel.element_link_id "Balance Element Link Id",
    pel.element_type_id "Balance Element Type Id",
   (select a.element_name from pay_element_types_f a
    where a.element_type_id = pel.element_type_id
    and trunc(sysdate) between a.effective_start_date and a.effective_end_date) "Balance Element Name" ,
    pel.effective_start_date "Effective Start Date",
    pel.effective_end_date "Effective End Date",
    pel.payroll_id "Payroll Id",
    (select a.payroll_name from pay_all_payrolls_f a
...
FROM
    ...
    pay_accrual_plans pap
WHERE pap.accrual_plan_id = ##$$PLANID$$##
AND  pel.element_type_id = pap.balance_element_type_id
AND  trunc(sysdate) between pel.effective_start_date and pel.effective_end_date',
      p_title                  => 'Payroll Balance Element Links',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no Payroll Balance Element Link available.<br>
When an Accrual Plan is created, it also creates a Payroll Balance Element and its link as below:<br>
Payroll Balance Element Name: Accrual Plan name with suffix "Payroll Balance" <br>
Payroll Balance Element helps to feed the payroll balance that stores gross accruals. <br>
If a Payroll Balance Element link is missing, then you cannot carry over leave balances to your employees in the next year.
',
      p_solution               => 'You will need to setup Payroll Balance Link(s).
Please review the following documents in order to setup Payroll Balance Link(s): <br><br>

Setup steps: [148524.1] - How To Setup a PTO Plan and the Elements for This Plan.<br>
Detailed setup: [267289.1] - Almost Everything You Wanted to Know About Oracle HRMS Paid Time Off (PTO).<br>
Example setup: [2097767.1] - Sample Accrual Plan Examples using seeded PTO accrual and Carry Over Formulas.<br>
',
      p_success_msg            => 'This is a data collection for the Payroll Balance Element Links of Accrual Plan: "'||mask_text(g_plan_name, nvl( upper(''), 'NO_MASK') )||'" .',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PTO_BALANCE_ELEMENT_LINKS');



debug('begin add_signature: PTO_ACCRUAL_SPACIFIC_PAYROLL_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13950',
      p_sig_id                 => 'PTO_ACCRUAL_SPACIFIC_PAYROLL_DETAILS',
      p_sig_sql                => 'select payroll_id "Payroll ID"
,payroll_name "Payroll Name"
,period_type  "Period Type"
,to_char(effective_start_date,''DD-Mon-YYYY'') "Eff Start Date"
,to_char(effective_end_date,''DD-Mon-YYYY'') "Eff End Date"
,business_group_id "BG ID "
,object_version_number "OVN"
,to_char(first_period_end_date,''DD-Mon-YYYY'') "First Period End Date"
,number_of_years "Calender Years"
, pay_date_offset "Pay Date Offset"
, direct_deposit_date_offset "Direct Deposit Date Offset"
, pay_advice_date_offset "Pay Advice Date Offset"
, cut_off_date_offset "Cut Off Date Offset"
, payslip_view_date_offset "Payslip Date Offset"
    from pay_all_payrolls_f
    where payroll_id in (select payroll_id 
                         from pay_all_payrolls_f papf,
                               pay_accrual_plans pap
                         where pap.business_group_id = papf.business_group_id
                         and  pap.accrual_plan_id = ##$$PLANID$$##
                         AND  trunc(sysdate) between papf.effective_start_date and papf.effective_end_date)                                    
     AND  trunc(sysdate) between  effective_start_date and  effective_end_date
    order by payroll_id,effective_start_date',
      p_title                  => 'Business Group Payroll',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This is a data collection of the business group payroll details for Accrual Plan: "'||mask_text(g_plan_name, nvl( upper(''), 'NO_MASK') )||'" .',
      p_solution               => '',
      p_success_msg            => 'No payroll under the Accrual Plan Business Group.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PTO_ACCRUAL_SPACIFIC_PAYROLL_DETAILS');



debug('begin add_signature: PTO_HR ACCRUAL PLAN ELEMENT SET DISPLAYED TO USER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13951',
      p_sig_id                 => 'PTO_HR ACCRUAL PLAN ELEMENT SET DISPLAYED TO USER',
      p_sig_sql                => 'select decode(to_char(pov.level_id),''10001'', ''Site'',''10002'', ''Application'',''10003'', ''Responsibility'',''10005'', ''Server'',''10006'', ''Org'',''10007'', ''Servresp'', ''???'') "Level" ,
       decode(to_char(pov.level_id),''10001'', ''Site'',
        ...
        where  po.profile_option_name =''PER_ACCRUAL_PLAN_ELEMENT_SET''
	...
	and    n.language=''US''
      ...
      p_title                  => 'Profile HR: Accrual Plan Element Set Displayed to User (PER_ACCRUAL_PLAN_ELEMENT_SET)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The profile "HR: Accrual Plan Element Set Displayed to User" is not setup. This will not display accruals on the Self Service Absence page.
',
      p_solution               => 'Please setup the profile in order to display an Entitlement Balance for employees on the Self Service Absence page.<br>
Review [2100324.1] - How to Setup the Accrual Balance on the View Entitlement Balance Popup in Self Service',
      p_success_msg            => 'This is a data collection of the "HR: Accrual Plan Element Set Displayed to User" profile.<br>
...
',
   ...
   l_info.delete;
debug('end add_signature: PTO_HR ACCRUAL PLAN ELEMENT SET DISPLAYED TO USER');



debug('begin add_signature: PTO_HR_RESTRICT_ACCRUALPLAN_BY_ELEMENTSET_NULL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13962',
      p_sig_id                 => 'PTO_HR_RESTRICT_ACCRUALPLAN_BY_ELEMENTSET_NULL',
      p_sig_sql                => 'select decode(to_char(pov.level_id),''10001'', ''Site'',''10002'', ''Application'',''10003'', ''Responsibility'',''10005'', ''Server'',''10006'', ''Org'',''10007'', ''Servresp'', ''???'') "Level" ,
       decode(to_char(pov.level_id),''10001'', ''Site'',
              ''10002'', nvl(app.application_short_name,to_char(pov.level_value)),''10003'', nvl(rsp.responsibility_name,to_char(pov.level_value)),
              ''10005'', svr.node_name,''10006'', org.name,''10007'', pov.level_value ||'', ''|| pov.level_value_application_id ||'', ''|| pov.level_value2,''???'') "Context", pov.profile_option_value "Profile Value"
        from   fnd_profile_options po,fnd_profile_option_values pov,fnd_profile_options_tl n,
               fnd_user usr,fnd_application app,fnd_responsibility_vl rsp,fnd_nodes svr,hr_operating_units org
        where  po.profile_option_name =''HR_RESTRICT_ACCRUALPLAN_BY_ELEMENTSET''
        and    pov.application_id (+) = po.application_id
        and    po.profile_option_name (+) = n.profile_option_name
        and    pov.profile_option_id = po.profile_option_id
        and    usr.user_id (+) = pov.level_value
	...
	and    n.language=''US''
        and (pov.level_id in (10001,10002,10005,10006,10007) or ( pov.level_id=10003 and rsp.APPLICATION_ID in (453,805,8301,800,8403,801,8401,8302,8303,809,808,810)))
        order by pov.level_id,"Context"',
      p_title                  => 'Profile HR: Restrict Display of Accrual Plan by Element Set (HR_RESTRICT_ACCRUALPLAN_BY_ELEMENTSET)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The profile "HR: Restrict Display of Accrual Plan by Element Set" is not set. This will not display accruals on the Self Service Absence page based upon the Element Set.',
      p_solution               => 'This profile setting will control the display behavior of accrual plans.<br>
If you wish to display accruals plans by element set, please change the profiles options:<br>

  "HR: Accrual Plan Element Set Displayed to User" set to The Element set.<br>
  "HR: Restrict Display of Accrual Plan by Element Set" set to “Yes”. <br>

Review [2100324.1] - How to Setup the Accrual Balance on the View Entitlement Balance Popup in Self Service <br>

',
      p_success_msg            => 'This is a data collection of HR: Restrict Display of Accrual Plan by Element Set Profile.<br>
This profile setting will control the display behavior of accrual plans.<br>
The page will display accruals based on Element Set.',
   ...
   l_info.delete;
debug('end add_signature: PTO_HR_RESTRICT_ACCRUALPLAN_BY_ELEMENTSET_NULL');



debug('begin add_signature: PTO_HR_RESTRICT_ACCRUALPLAN_BY_ELEMENTSET_SET_NO');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##Profile Value'):= ',#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '13952',
      p_sig_id                 => 'PTO_HR_RESTRICT_ACCRUALPLAN_BY_ELEMENTSET_SET_NO',
      p_sig_sql                => 'select decode(to_char(pov.level_id),''10001'', ''Site'',''10002'', ''Application'',''10003'', ''Responsibility'',''10005'', ''Server'',''10006'', ''Org'',''10007'', ''Servresp'', ''???'') "Level" ,
       decode(to_char(pov.level_id),''10001'', ''Site'',
              ''10002'', nvl(app.application_short_name,to_char(pov.level_value)),''10003'', nvl(rsp.responsibility_name,to_char(pov.level_value)),
              ''10005'', svr.node_name,''10006'', org.name,''10007'', pov.level_value ||'', ''|| pov.level_value_application_id ||'', ''|| pov.level_value2,''???'') "Context", pov.profile_option_value "Profile Value"
	...
	and    n.language=''US''
        ...
        order by pov.level_id,"Context"',
      p_title                  => 'Profile HR: Restrict Display of Accrual Plan by Element Set (HR_RESTRICT_ACCRUALPLAN_BY_ELEMENTSET)',
      p_fail_condition         => '[Profile Value] = [N]',
      p_problem_descr          => 'The profile "HR: Restrict Display of Accrual Plan by Element Set" is set to No at several levels.',
      p_solution               => 'The page will display accruals based on Assignment Element Entry, but not based on Element Set. <br>
Review [2100324.1] - How to Setup the Accrual Balance on the View Entitlement Balance Popup in Self Service.',
      p_success_msg            => 'This is a data collection of "HR: Restrict Display of Accrual Plan by Element Set" Profile.
This profile setting will control the display behavior of accrual plans.
The page will display accruals based on Element Set. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: PTO_HR_RESTRICT_ACCRUALPLAN_BY_ELEMENTSET_SET_NO');



debug('begin add_signature: PER_ABSENCE_DURATION_AUTO_OVERWRITE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5555',
      p_sig_id                 => 'PER_ABSENCE_DURATION_AUTO_OVERWRITE',
      p_sig_sql                => 'select decode(to_char(pov.level_id),''10001'', ''Site'',''10002'', ''Application'',''10003'', ''Responsibility'',''10005'', ''Server'',''10006'', ''Org'',''10007'', ''Servresp'', ''???'') "Level" ,
       decode(to_char(pov.level_id),''10001'', ''Site'',
              ''10002'', nvl(app.application_short_name,to_char(pov.level_value)),''10003'', nvl(rsp.responsibility_name,to_char(pov.level_value)),
              ''10005'', svr.node_name,''10006'', org.name,''10007'', pov.level_value ||'', ''|| pov.level_value_application_id ||'', ''|| pov.level_value2,''???'') "Context", pov.profile_option_value "Profile Value"
        from   fnd_profile_options po,fnd_profile_option_values pov,fnd_profile_options_tl n,
               fnd_user usr,fnd_application app,fnd_responsibility_vl rsp,fnd_nodes svr,hr_operating_units org
        where  po.profile_option_name =''PER_ABSENCE_DURATION_AUTO_OVERWRITE''
        and    pov.application_id = po.application_id
        and    po.profile_option_name = n.profile_option_name
        and    pov.profile_option_id = po.profile_option_id
        and    usr.user_id (+) = pov.level_value
	...
	and    n.language=''US''
        and (pov.level_id in (10001,10002,10005,10006,10007) or ( pov.level_id=10003 and rsp.APPLICATION_ID in (453,805,8301,800,8403,801,8401,8302,8303,809,808,810)))
        order by pov.level_id,"Context"',
      p_title                  => 'Profile HR: Absence Duration Auto Overwrite (PER_ABSENCE_DURATION_AUTO_OVERWRITE)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No profile values defined.<br>
Review the following documents for more information:<br>
[304116.1] SSHR Absence Request - Unable To Manually Overwrite Days and Hours After Auto Calculate Duration',
      p_solution               => '',
      p_success_msg            => 'Review the following documents for more information:<br>
[304116.1] SSHR Absence Request - Unable To Manually Overwrite Days and Hours After Auto Calculate Duration',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: PER_ABSENCE_DURATION_AUTO_OVERWRITE');



debug('begin add_signature: HR_ALLOW_NEG_ABS_BAL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5557',
      p_sig_id                 => 'HR_ALLOW_NEG_ABS_BAL',
      p_sig_sql                => 'select decode(to_char(pov.level_id),''10001'', ''Site'',''10002'', ''Application'',''10003'', ''Responsibility'',''10005'', ''Server'',''10006'', ''Org'',''10007'', ''Servresp'', ''???'') "Level" ,
       decode(to_char(pov.level_id),''10001'', ''Site'',
              ''10002'', nvl(app.application_short_name,to_char(pov.level_value)),''10003'', nvl(rsp.responsibility_name,to_char(pov.level_value)),
              ''10005'', svr.node_name ,''10006'', org.name,''10007'', pov.level_value ||'', ''|| pov.level_value_application_id ||'', ''|| pov.level_value2,''???'') "Context", pov.profile_option_value "Profile Value"
        from   fnd_profile_options po,fnd_profile_option_values pov,fnd_profile_options_tl n,
               fnd_user usr,fnd_application app,fnd_responsibility_vl rsp,fnd_nodes svr,hr_operating_units org
        where  po.profile_option_name =''HR_ALLOW_NEG_ABS_BAL''
        and    pov.application_id = po.application_id
        and    po.profile_option_name = n.profile_option_name
        and    pov.profile_option_id = po.profile_option_id
        and    usr.user_id (+) = pov.level_value
	...
	and    n.language=''US''
        and (pov.level_id in (10001,10002,10005,10006,10007) or ( pov.level_id=10003 and rsp.APPLICATION_ID in (453,805,8301,800,8403,801,8401,8302,8303,809,808,810)))
        order by pov.level_id,"Context"',
      p_title                  => 'Profile HR: Allow Absence Negative Balance (HR_ALLOW_NEG_ABS_BAL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No profile values defined.<br>
Review the following documents for more information:<br>
[1457958.1] How can you use the new functionality of the system profile "HR Allow Absence Negative Balance"<br>
[1946713.1] Profile "HR: Allow Absence Negative Balance" is Not Considering Future Dated Leave Entries <br>
[1641321.1] "HR: Allow Absence Negative Balance" Does Not Work Correctly for Future Dated Absences ',
      p_solution               => '',
      p_success_msg            => 'Review the following documents for more information:<br>
[1457958.1] How can you use the new functionality of the system profile "HR Allow Absence Negative Balance"<br>
[1946713.1] Profile "HR: Allow Absence Negative Balance" is Not Considering Future Dated Leave Entries <br>
[1641321.1] "HR: Allow Absence Negative Balance" Does Not Work Correctly for Future Dated Absences ',
   ...
   l_info.delete;
debug('end add_signature: HR_ALLOW_NEG_ABS_BAL');



debug('begin add_signature: HR_SCH_BASED_ABS_CALC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5572',
      p_sig_id                 => 'HR_SCH_BASED_ABS_CALC',
      p_sig_sql                => 'select decode(to_char(pov.level_id),''10001'', ''Site'',''10002'', ''Application'',''10003'', ''Responsibility'',''10005'', ''Server'',''10006'', ''Org'',''10007'', ''Servresp'', ''???'') "Level" ,
       decode(to_char(pov.level_id),''10001'', ''Site'',
              ''10002'', nvl(app.application_short_name,to_char(pov.level_value)),''10003'', nvl(rsp.responsibility_name,to_char(pov.level_value)),
              ''10005'', svr.node_name ,''10006'', org.name,''10007'', pov.level_value ||'', ''|| pov.level_value_application_id ||'', ''|| pov.level_value2,''???'') "Context", pov.profile_option_value "Profile Value"
	...
	and    n.language=''US''
        and (pov.level_id in (10001,10002,10005,10006,10007) or ( pov.level_id=10003 and rsp.APPLICATION_ID in (453,805,8301,800,8403,801,8401,8302,8303,809,808,810)))
        order by pov.level_id,"Context"',
      p_title                  => 'Profile HR: Schedule Based Absence Calculation (HR_SCH_BASED_ABS_CALC)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No profile values defined.<br>
Review the following documents for more information:<br>
[1083254.1] Schedule Based Absence Duration Calculation, Exceptions not Taken into Account<br>
[1608438.1] Is Schedule Based Absence Duration Calculation Based on Free or Busy Time ?<br>
[437083.1] Schedule Based Absence Calculation In Self Service<br>
[808814.1] Troubleshooting Tips for Oracle HRMS Absence Management ',
      p_solution               => '',
      p_success_msg            => 'Review the following documents for more information:<br>
[1083254.1] Schedule Based Absence Duration Calculation, Exceptions not Taken into Account<br>
[1608438.1] Is Schedule Based Absence Duration Calculation Based on Free or Busy Time ?<br>
...
[808814.1] Troubleshooting Tips for Oracle HRMS Absence Management ',
   ...
   l_info.delete;
debug('end add_signature: HR_SCH_BASED_ABS_CALC');



debug('begin add_signature: HR_ABS_OTL_INTEGRATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5556',
      p_sig_id                 => 'HR_ABS_OTL_INTEGRATION',
      p_sig_sql                => 'select decode(to_char(pov.level_id),''10001'', ''Site'',''10002'', ''Application'',''10003'', ''Responsibility'',''10005'', ''Server'',''10006'', ''Org'',''10007'', ''Servresp'', ''???'') "Level" ,
       decode(to_char(pov.level_id),''10001'', ''Site'',
              ''10002'', nvl(app.application_short_name,to_char(pov.level_value)),''10003'', nvl(rsp.responsibility_name,to_char(pov.level_value)),
              ''10005'', svr.node_name,''10006'', org.name,''10007'', pov.level_value ||'', ''|| pov.level_value_application_id ||'', ''|| pov.level_value2,''???'') "Context", pov.profile_option_value "Profile Value"
        from   fnd_profile_options po,fnd_profile_option_values pov,fnd_profile_options_tl n,
               fnd_user usr,fnd_application app,fnd_responsibility_vl rsp,fnd_nodes svr,hr_operating_units org
        where  po.profile_option_name =''HR_ABS_OTL_INTEGRATION''
        and    pov.application_id = po.application_id
        and    po.profile_option_name = n.profile_option_name
        and    pov.profile_option_id = po.profile_option_id
        and    usr.user_id (+) = pov.level_value
	...
	and    n.language=''US''
        and (pov.level_id in (10001,10002,10005,10006,10007) or ( pov.level_id=10003 and rsp.APPLICATION_ID in (453,805,8301,800,8403,801,8401,8302,8303,809,808,810)))
        order by pov.level_id,"Context"',
      p_title                  => 'Profile HR: Absences Integration with OTL (HR_ABS_OTL_INTEGRATION)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No profile values defined.<br>
Review the following documents for more information:<br>
[883038.1] OTL/HR Absence Integration Issues<br>
[2055950.1] How to set the Profile Option "HR: Absences Integration with OTL" at Responsibility Level ?<br>
[1122794.1] HR - OTL Absence Integration Technical Brief',
      p_solution               => '',
      p_success_msg            => 'Review the following documents for more information:<br>
[883038.1] OTL/HR Absence Integration Issues<br>
[2055950.1] How to set the Profile Option "HR: Absences Integration with OTL" at Responsibility Level ?<br>
[1122794.1] HR - OTL Absence Integration Technical Brief',
   ...
   l_info.delete;
debug('end add_signature: HR_ABS_OTL_INTEGRATION');



debug('begin add_signature: PAY_USE_FF_PTO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5575',
      p_sig_id                 => 'PAY_USE_FF_PTO',
      p_sig_sql                => 'select decode(to_char(pov.level_id),''10001'', ''Site'',''10002'', ''Application'',''10003'', ''Responsibility'',''10005'', ''Server'',''10006'', ''Org'',''10007'', ''Servresp'', ''???'') "Level" ,
       decode(to_char(pov.level_id),''10001'', ''Site'',
              ''10002'', nvl(app.application_short_name,to_char(pov.level_value)),''10003'', nvl(rsp.responsibility_name,to_char(pov.level_value)),
              ''10005'', svr.node_name,''10006'', org.name,''10007'', pov.level_value ||'', ''|| pov.level_value_application_id ||'', ''|| pov.level_value2,''???'') "Context", pov.profile_option_value "Profile Value"
        from   fnd_profile_options po,fnd_profile_option_values pov,fnd_profile_options_tl n,
               fnd_user usr,fnd_application app,fnd_responsibility_vl rsp,fnd_nodes svr,hr_operating_units org
        where  po.profile_option_name =''PAY_USE_FF_PTO''
        and    pov.application_id = po.application_id
        and    po.profile_option_name = n.profile_option_name
        and    pov.profile_option_id = po.profile_option_id
        and    usr.user_id (+) = pov.level_value
	...
	and    n.language=''US''
        and (pov.level_id in (10001,10002,10005,10006,10007) or ( pov.level_id=10003 and rsp.APPLICATION_ID in (453,805,8301,800,8403,801,8401,8302,8303,809,808,810)))
        order by pov.level_id,"Context"',
      p_title                  => 'Profile HR: Use Fast Formula Based PTO Accruals (PAY_USE_FF_PTO)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No profile values defined.<br>
Review the following documents for more information:<br>
[167826.1] What is PTO Profile option HR: Use Fast Formula-based PTO Accruals<br>
[267289.1] Almost Everything You Wanted to Know About Oracle HRMS Paid Time Off (PTO) ',
      p_solution               => '',
      p_success_msg            => 'Review the following documents for more information:<br>
[167826.1] What is PTO Profile option HR: Use Fast Formula-based PTO Accruals<br>
[267289.1] Almost Everything You Wanted to Know About Oracle HRMS Paid Time Off (PTO) ',
   ...
   l_info.delete;
debug('end add_signature: PAY_USE_FF_PTO');
...
BEGIN
  ...
  IF (p_planid IS NOT NULL) THEN
    g_params_string := g_params_string || to_char(p_planid) || '_';
  END IF;
  ...
  analyzer_title := 'PTO Accrual Plan Analyzer';
...
debug('begin section: AccrualPlan');
start_section('Accrual Plan', 'AccrualPlan');
   set_item_result(run_stored_sig('PTOPLANDETAILS'));
   set_item_result(run_stored_sig('PTO_ABSENCE_TYPE'));
   set_item_result(run_stored_sig('PTO_BAND'));
   set_item_result(run_stored_sig('PTO_CALCULATION_RULES'));
   set_item_result(run_stored_sig('PTO_ACCRUAL_CATEGORY_DETAILS'));
   set_item_result(run_stored_sig('PTO_CARRYOVER_CONC_REQUEST_RUN'));
end_section;
debug('end section: AccrualPlan');

debug('begin section: AccrualPlanLinksSetup');
start_section('Accrual Plan Element Link Setup', 'AccrualPlanLinksSetup');
   set_item_result(run_stored_sig('PTO_ELEMENT_LINK'));
   set_item_result(run_stored_sig('ACCRUAL_PLAN_ELEMENT_LINK_DETAILS'));
   set_item_result(run_stored_sig('PTO_CARRYOVER_ELEMENT_LINK_DETALS'));
   set_item_result(run_stored_sig('PTO_RESIDUAL_ELEMENT_LINK_DETAILS'));
   set_item_result(run_stored_sig('TAGGING_ELEMENT_LINK_DETAILS'));
   set_item_result(run_stored_sig('PTO_BALANCE_ELEMENT_LINKS'));
   set_item_result(run_stored_sig('PTO_ACCRUAL_SPACIFIC_PAYROLL_DETAILS'));
end_section;
debug('end section: AccrualPlanLinksSetup');

debug('begin section: Profiles');
start_section('Profiles', 'Profiles');
   set_item_result(run_stored_sig('PTO_HR ACCRUAL PLAN ELEMENT SET DISPLAYED TO USER'));
   set_item_result(run_stored_sig('PTO_HR_RESTRICT_ACCRUALPLAN_BY_ELEMENTSET_NULL'));
   set_item_result(run_stored_sig('PTO_HR_RESTRICT_ACCRUALPLAN_BY_ELEMENTSET_SET_NO'));
   set_item_result(run_stored_sig('PER_ABSENCE_DURATION_AUTO_OVERWRITE'));
   set_item_result(run_stored_sig('HR_ALLOW_NEG_ABS_BAL'));
   set_item_result(run_stored_sig('HR_SCH_BASED_ABS_CALC'));
   set_item_result(run_stored_sig('HR_ABS_OTL_INTEGRATION'));
   set_item_result(run_stored_sig('PAY_USE_FF_PTO'));
end_section;
