...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Approvals Management Analyzer          |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE ame_analyzer_pkg AUTHID DEFINER AS
...
CREATE OR REPLACE PACKAGE BODY ame_analyzer_pkg AS
-- $Id: ame_analyzer.sql, 200.38 2026/01/29 07:58:43 siionesc Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2332426.1));
...
-- page title
    ...
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1334,EBS,EBS HCM,EBS - HR" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1334,EBS,EBS HCM,EBS - HR" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1334,EBS,EBS HCM,EBS - HR" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
<div class="ck-content"><p>This analyzers <span style="color:Black;"><span class="kmContent" style="font-size:small;" id="kmPgTpl:sd_r1:0:dv_rDoc:ot71">reviews&nbsp;Approvals Management related data, analyzes current configurations and settings for the environment and provides feedback and recommendations on best practices</span></span></p><p>Version 200.38<br>
- Validate/Modify KM links post migration</p><p>Version 200.37<br>
&nbsp;- Changed links from MOS to MOSFS</p><p>Version: 200.36<br>
- Update to included &nbsp;ATG RUP.14<br>
- Added Latest R12.TXK.C.Delta16&nbsp;<br>
- ATG FWK Updates<br>
- Added Latest TXK &nbsp;R12.TXK.C.Delta17</p><p>&nbsp;</p><p>&nbsp;</p></div>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1334,'||l_sig.sigrepo_id||',EBS,EBS HCM,EBS - HR" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1334,'||l_sig.sigrepo_id||',EBS,EBS HCM,EBS - HR" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1334,'||l_sig.sigrepo_id||',EBS,EBS HCM,EBS - HR" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1334,'||p_sig.sigrepo_id||',EBS,EBS HCM,EBS - HR" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1334,'||p_sig.sigrepo_id||',EBS,EBS HCM,EBS - HR" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1334,'||p_sig.sigrepo_id||',EBS,EBS HCM,EBS - HR" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
BEGIN
   ...
   IF l_ame_rules.COUNT > 0 THEN
    ...
    l_sig.solution := 'Review the AME configuration information to determine why there are no available rules.<br> For further details review [434567/KB647612] How to Access Oracle Approvals Management? HRMS Approvals Management (AME) Responsibilities and Setups';
    l_sig.success_msg := 'This is a data collection of rules for this transaction.<br>[434567/KB647612] How to Access Oracle Approvals Management? HRMS Approvals Management (AME) Responsibilities and Setups';
...
BEGIN
   ...
   IF l_ame_approvers.COUNT > 0 THEN
    ...
    l_sig.solution := 'Review the AME configuration information to determine why there are no approvers.<br> [434567/KB647612] How to Access Oracle Approvals Management? HRMS Approvals Management (AME) Responsibilities and Setups';
    l_sig.success_msg := 'This is a data collection of approvers found for this transaction.<br> For further details review [434567/KB647612] How to Access Oracle Approvals Management? HRMS Approvals Management (AME) Responsibilities and Setups';
    l_sig.print_condition := 'ALWAYS';
    l_sig.fail_type := 'I';
    l_sig.print_sql_output := 'RS';
    l_sig.limit_rows := 'N';
 ...
 for i in 1..ame_invalappr.count loop
  ...
  l_col_rows.extend(4);
   IF wNameList.COUNT > 0 THEN
    ...
    l_sig.solution := 'Review the AME configuration information to determine why there are invalid approvers.<br> Review [434567/KB647612] How to Access Oracle Approvals Management? HRMS Approvals Management (AME) Responsibilities and Setups';
    l_sig.success_msg := 'No invalid approvers found. <br> For further details consult [434567/KB647612] How to Access Oracle Approvals Management? HRMS Approvals Management (AME) Responsibilities and Setups';
    l_sig.print_condition := 'ALWAYS';
    l_sig.fail_type := 'W';
...
BEGIN
    ...
    print_log('Processing recommended patches signature: HCM_TXK (check_rec_patches_1) "Applications Technology Stack (TXK) patches" (version 10)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '11.5' THEN
   ...
   l_col_rows(1)(l_rows) := '2668469';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '11i.TXK.A';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '3219567';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '11i.TXK.B';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '4018905';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '11i.TXK.C';
   l_col_rows(5)(l_rows) := NULL;
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '6430145';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.TXK.B';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '7310275';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.TXK.B.delta.1';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '7651166';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.TXK.B.delta.2';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '27135427';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.TXK.B.delta.4';
   l_col_rows(5)(l_rows) := NULL;
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '10110941';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.TXK.C';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21830810';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.TXK.C.DELTA.8';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25180736';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.TXK.C.delta.9';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_col_rows(5)(l_rows) := '[2938001.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36117775';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.TXK.C.Delta.16';
   l_col_rows(5)(l_rows) := '[2967000.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37204510';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.TXK.C.Delta.17';
   l_col_rows(5)(l_rows) := '[2975000.1]';

END IF;

   l_extra_info('##SHOW_SQL##'):= 'Y';

   l_sig.sigrepo_id := '8373';
   l_sig.title := 'Applications Technology Stack (TXK) patches';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := 'You have TXK patch(es) not applied to this environment. Please expand the list above for the details.';
...
<b>To get a current accurate list of recommended EBS product patches that are applied/not applied to your instance, please run Patch Wizard.</b><br>
See [976188/KB739927] - Patch Wizard Utility, [10940175/KA580] FAQ, or [1077813/KB627816] Videos for more information.<br>
<ul>Above is a short list of recommended product patches as of the date this script was written to show you what may or may not be applied on this instance.
...
<li>Refer to the note indicated for more information about each patch</li></ul><br>';
   l_sig.success_msg := '<b>All known recommended EBS product patches, at the time this script was written, have been applied.<br>
...
See [976188/KB739927] - Patch Wizard Utility, [10940175] FAQ, or [1077813/KB627816] Videos for more information.<br>';
   l_sig.print_condition := 'ALWAYS';
   l_sig.fail_type := 'W';
   l_sig.print_sql_output := 'Y';
   l_sig.limit_rows := 'Y';
...
BEGIN
    ...
    print_log('Processing recommended patches signature: RUP (check_rec_patches_2) "RUP Patches" (version 39)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35672406';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.HR_PF.C.Delta.18';
   l_col_rows(5)(l_rows) := '[3011891.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37171789';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.HR_PF.C.Delta.19';
   l_col_rows(5)(l_rows) := '[3072239.1]';
...
Oracle recommend you to be at latest version of HR_PF.';
   l_sig.solution := 'Note! If a patch was applied and the analyzer shows it as not applied, this can be caused by snapshot out of sync (run AD Utilities (Adadmin) "Maintain Snapshot Information" -> Update a current view snapshot -> Update Complete APPL_TOP).<br>
[1160507/KB207070] Oracle E-Business Suite HCM Information Center - Consolidated HRMS Mandatory Patch List';
   l_sig.success_msg := 'Latest RUP patch applied.<br>
Please review known issues for latest RUP in:<br>
- 12.2: [3072218/KB188474] Known Issues on Top of Patch 37171789- R12.hr_pf.C.DELTA.19<br>
- 12.2: [3011893/KB159217] Known Issues on Top of Patch 35672406 - R12.hr_pf.C.DELTA.18<br>
- 12.2: [2935950/KB548986] Known Issues on Top of Patch 34444470 - R12.hr_pf.C.DELTA.17<br>
- 12.2: [2862918/KB581247] Known Issues on Top of Patch 33527653 - R12.hr_pf.C.DELTA.16<br>
- 12.2: [2750035/KB582650]  Known Issues on Top of Patch 31800665 - R12.hr_pf.C.DELTA.15<br>
- 12.2: [2656623/KB673241] Known Issues on Top of Patch 30096069 - R12.HR_PF.C.DELTA.14 <br>

- 12.1: [2750078/KB251556] Known Issues on Top of Patch 32105001 - R12.HR_PF.B.DELTA.14<br>
- 12.1: [2656621/KB686945] Known Issues on Top of Patch 30066331 - R12.HR_PF.B.DELTA.13 <br>
';
   l_sig.print_condition := 'ALWAYS';
   l_sig.fail_type := 'W';
   l_sig.print_sql_output := 'Y';
...
BEGIN
    ...
    print_log('Processing recommended patches signature: ATGFORHCM (check_rec_patches_3) "ATG Patches" (version 17)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.ATG_PF.C.DELTA.11';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.ATG_PF.C.DELTA.12';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.ATG_PF.C.DELTA.13';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37182828';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.ATG_PF.C.DELTA.14';
   l_col_rows(5)(l_rows) := NULL;
...
';
   l_sig.success_msg := 'All ATG verified patches applied.<br>
For the most current recommendations, use the Patch Wizard or the Updates & Patches Tab in My Oracle Support.<br>
Further guidance can be found in the following documents:<br>
<ul>
...
BEGIN
    ...
    print_log('Processing recommended patches signature: FWK_B (check_rec_patches_4) "Recommended Framework  Patches" (version 8)');
...
BEGIN
    ...
    print_log('Processing recommended patches signature: FWK_C4 (check_rec_patches_5) "Recommended Framework  Patches" (version 22)');
...
BEGIN
    ...
    print_log('Processing recommended patches signature: FWK_C5 (check_rec_patches_6) "Recommended Framework  Patches" (version 26)');
...
BEGIN
    ...
    print_log('Processing recommended patches signature: FWK_C6 (check_rec_patches_7) "Recommended Framework  Patches" (version 35)');
...
BEGIN
    ...
    print_log('Processing recommended patches signature: FWK_C7 (check_rec_patches_8) "Recommended Framework Patches" (version 34)');
...
BEGIN
    ...
    print_log('Processing recommended patches signature: FWK_C8 (check_rec_patches_9) "Recommended Framework Patches" (version 23)');
...
BEGIN
    ...
    print_log('Processing recommended patches signature: FWK_C9 (check_rec_patches_10) "Recommended Framework Patches" (version 24)');
...
BEGIN
    ...
    print_log('Processing recommended patches signature: FWK_C10 (check_rec_patches_11) "Recommended Framework Patches" (version 12)');
...
BEGIN
    ...
    print_log('Processing recommended patches signature: FWK_C11 (check_rec_patches_12) "Recommended Framework Patches" (version 13)');
...
BEGIN
    ...
    print_log('Processing recommended patches signature: EBS_ATG_FWK_C12 (check_rec_patches_13) "Recommended Framework Patches" (version 8)');
...
BEGIN
    ...
    print_log('Processing recommended patches signature: EBS_ATG_FWK_C13 (check_rec_patches_14) "Recommended Framework Patches" (version 7)');
...
('37171789','35672406','34444470','33527653','31800665','30096069','28862999','26787667','25251133','24007222','22559919','21507777','20000400','19193000','17909898','17050005','17001123','16169935','14040707','10124646'))
and rownum < 2
union
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/01/29 07:58:42 $','$',''));
...
--Setting the Framework Codelevel Global Variable
...
union
SELECT ''FWK Code Level          = ''  || codelevel FROM AD_TRACKABLE_ENTITIES WHERE abbreviation = ''fwk''
union
...
union
SELECT ''RUP Level               = '' || RUP_LEVEL || '' applied on '' || LAST_UPDATE_DATE
	  from  (select ''12.2'' release, DECODE(bug_number
	...
	,''35672406'', ''35672406 R12.HR_PF.C.Delta.18''
    ,''37171789'', ''37171789 R12.HR.PF.C.Delta.19''
    ) RUP_LEVEL , LAST_UPDATE_DATE
	 FROM ad_bugs
	WHERE BUG_NUMBER =(SELECT to_char(max(to_number(adb.bug_number))) 
						 FROM ad_bugs adb
						WHERE adb.bug_number in (''34444470'',''33527653'',''31800665'',''30096069'',''28862999'',''26787667'',''25251133'',''24007222'',''22559919'',''21507777'',''20000400'',''19193000'',''17909898'',''17050005'',''17001123'',''16169935'',''14040707'',''10124646'',''35672406'',''37171789''))
	  and rownum < 2 
	union  
...
SELECT ''ATG Patch Code          = '' || RUP_LEVEL || '' applied on '' || LAST_UPDATE_DATE from
	...
	,''33527666'', ''33527666   R12.ATG_PF.C.DELTA.11''
	,''34776645'', ''34776645   R12.ATG_PF.C.DELTA.12''
    ,''36034949'', ''36034949   R12.ATG_PF.C.DELTA.13''
    ,''37182828'', ''37182828   R12.ATG_PF.C.DELTA.14''
	) RUP_LEVEL , LAST_UPDATE_DATE
	FROM ad_bugs
	WHERE BUG_NUMBER =(SELECT to_char(max(to_number(adb.bug_number))) FROM ad_bugs adb
	WHERE adb.bug_number in (''31856779'',''30399994'',''19245366'',''10110982'',''14222219'',''15890638'',''17007206'',''17909318'',''21900895'',''24690680'',''28840844'',''33527666'',''34776645'',''36034949'',''37182828''))
	and rownum < 2 
	union
	select ''12.1'' release ,DECODE(BUG_NUMBER
...
Refer [1072409/KB559691] Database Documentation Resources for E-Business Suite',
      p_success_msg            => '',
...
[140511/KB747666]        12.1:  How to Install HRMS Legislative Data Using Data Installer and hrglobal.drv 12.1 Specifics<br>
 [1469456/KB207194]   12.2:  DataInstall and HRGLOBAL Application: 12.2 Specifics
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
...
[1303973/KB205467]  ORA-03113: end-of-file on communication channel<br>
[370137/KB149984] After Upgrade, Some Packages Intermittently Fail with ORA-04065 ORA-06508',
...
AND (a.object_name like ''BEN%'' OR 
           a.object_name like ''HR%''   OR 
           a.object_name like ''PER%'' OR
           a.object_name like ''PE%'' )
order by 1',
...
<li>If you still have invalid objects, please review steps from [1325394/KB401905]  Troubleshooting Guide - invalid objects in the E-Business Suite Environment 11i and 12
</ul>',
...
See [1493350/KB91037#aref_section218]- Overview of Oracle Tablespace Management. 
',
...
debug('begin add_signature: EBS_HCM_HR_AME_LDT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28104',
      p_sig_id                 => 'EBS_HCM_HR_AME_LDT',
      p_sig_sql                => 'SELECT files.filename,ver2.version,ver2.last_update_date
			FROM   ad_file_versions ver2,ad_files f2
				  , (SELECT   MAX (ver.file_version_id) file_version_id, f.filename
					...
					AND (lower(f.filename) like ''%.ldt'')
					 GROUP BY f.filename) files
			WHERE  files.filename = f2.filename	
                         AND       f2.file_id = ver2.file_id
			AND       files.file_version_id = ver2.file_version_id	
                        AND        f2.app_short_name = ''AME''
                       Order by files.filename',
      p_title                  => 'AME LDT Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No settings.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of AME LDT versions.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_HCM_HR_AME_LDT');
...
debug('begin add_signature: EBS_HCM_HR_AME_SQL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28105',
      p_sig_id                 => 'EBS_HCM_HR_AME_SQL',
      p_sig_sql                => 'SELECT files.filename,ver2.version,ver2.last_update_date
			FROM   ad_file_versions ver2,ad_files f2
				  , (SELECT   MAX (ver.file_version_id) file_version_id, f.filename
					 FROM     ad_file_versions ver, ad_files f
			...
			AND       files.file_version_id = ver2.file_version_id	
                        AND        f2.app_short_name = ''AME''
                       Order by files.filename',
      p_title                  => 'AME SQL Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No settings.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of AME SQL versions.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_HCM_HR_AME_SQL');



debug('begin add_signature: EBS_HCM_HR_AME_XML');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28103',
      p_sig_id                 => 'EBS_HCM_HR_AME_XML',
      p_sig_sql                => 'SELECT files.filename,ver2.version,ver2.last_update_date
			FROM   ad_file_versions ver2,ad_files f2
				  , (SELECT   MAX (ver.file_version_id) file_version_id, f.filename
					 FROM     ad_file_versions ver, ad_files f
					 WHERE    f.file_id = ver.file_id
					AND (lower(f.filename) like ''%.xml'')
					 GROUP BY f.filename) files
			WHERE  files.filename = f2.filename	
                         AND       f2.file_id = ver2.file_id
			AND       files.file_version_id = ver2.file_version_id	and f2.app_short_name = ''AME''
                       Order by files.filename',
      p_title                  => 'AME XML Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No settings.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of AME XML versions.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_HCM_HR_AME_XML');
...
Review [338508/KB163628#incorrect_value] Approvals Management (AME) Error "Oracle Approvals Management has Found Parallelisation Configuration whereas the Context in which AME invoked Using AME_API Does Not Support Parallelisation"<br>
...
Review [338508/KB163628#issue2] Approvals Management (AME) Error "Oracle Approvals Management has Found Parallelisation Configuration whereas the Context in which AME invoked Using AME_API Does Not Support Parallelisation"
',
...
where application_id = ''##$$AMEAPPID$$##''
  ...
  and (atu.rule_type, atc.order_number) in (select rule_type,order_number
      ...
      p_solution               => 'You may hit error ORA-20001: Oracle Approvals Management has found parallelization configuration details.<br>
Review [338508/KB163628#issue3] Approvals Management (AME) Error "Oracle Approvals Management has Found Parallelisation Configuration whereas the Context in which AME invoked Using AME_API Does Not Support Parallelisation"
',
      p_success_msg            => 'No issues found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
...
debug('begin add_signature: NON SERIAL OR ORDER NUMBER VOTING REGIME');
 ...
 where apg.approval_group_id = apgc.approval_group_id
   ...
   and sysdate between apg.start_date and nvl(apg.end_date,sysdate + 1)',
      ...
      p_solution               => 'You may hit error ORA-20001: Oracle Approvals Management has found parallelization configuration details.<br>
Review [338508/KB163628#issue4] Approvals Management (AME) Error "Oracle Approvals Management has Found Parallelisation Configuration whereas the Context in which AME invoked Using AME_API Does Not Support Parallelisation"
',
...
debug('begin add_signature: NON UNIQUE ORDER NUMBERS FOR APPROVAL GROUP CONFIG');
 ...
 where apg.approval_group_id = apgc.approval_group_id
   ...
   and order_number in (select order_number 
      ...
      p_solution               => 'You may hit error ORA-20001: Oracle Approvals Management has found parallelization configuration details.<br>
Review [338508/KB163628#issue5] Approvals Management (AME) Error "Oracle Approvals Management has Found Parallelisation Configuration whereas the Context in which AME invoked Using AME_API Does Not Support Parallelisation"
',
      p_success_msg            => 'No issue found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
...
where sysdate between apg.start_date and nvl(apg.end_date,sysdate + 1)  
  and apg.approval_group_id in (  select apgi.approval_group_id
      ...
      p_solution               => 'You may hit error ORA-20001: Oracle Approvals Management has found parallelization configuration details.<br>
Review [338508/KB163628#issue1] Approvals Management (AME) Error "Oracle Approvals Management has Found Parallelisation Configuration whereas the Context in which AME invoked Using AME_API Does Not Support Parallelisation"
',
      p_success_msg            => 'No issue found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
...
debug('begin add_signature: NON SERIAL SUBLIST MODES FOR ITEM CLASS USAGES');
  ...
  where sysdate between itc.start_date and nvl(itc.end_date,sysdate+1)
    and itc.item_class_id in (select itu.item_class_id
      ...
      p_solution               => 'You may hit error ORA-20001: Oracle Approvals Management has found parallelization configuration details.<br>
Review [338508/KB163628#issue6] Approvals Management (AME) Error "Oracle Approvals Management has Found Parallelisation Configuration whereas the Context in which AME invoked Using AME_API Does Not Support Parallelisation"',
      p_success_msg            => 'No issue found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
...
debug('begin add_signature: TRANSACTION_SUMMARY');
  ...
  add_signature(
      ...
      p_solution               => 'Review [434567/KB647612] How to Access Oracle Approvals Management? HRMS Approvals Management (AME)  Responsibilities and Setups in AME.B ',
...
AND sup.current_applicant_flag IS NULL',
      ...
      p_solution               => 'Review [2253893/KB627222] How to Navigate and check Employee Supervisor/Manager in the Application?',
...
debug('begin add_signature: INCORRECT_VALUE_CONFIGURATION_VARIABLE');
  ...
  add_signature(
     ...
     where application_id = ##$$AMEAPPID$$##
      ...
      p_solution               => 'You may hit error ORA-20001: Oracle Approvals Management has found parallelization configuration details<br>
Review [338508/KB163628#incorrect_trans] Approvals Management (AME) Error "Oracle Approvals Management has Found Parallelisation Configuration whereas the Context in which AME invoked Using AME_API Does Not Support Parallelisation"<br>
...
Review [2754862/KB752486] Encounter the Error "An Invalid Setup has been detected for the current Transaction Type in Approvals Management. Please contact your System Administrator." For Any Transaction That Involves Approval',
...
Review [1627030/KB785056] How to Identify a Loop in the Supervisor Hierarchy?',
...
Useful documentation [431815/FAQ6653#profile1] Oracle Approvals Management (AME) Frequently asked Questions (FAQ) - section When using dynamic approvals, the user is allowed to insert any approver into any part of the list. This can break the requirement of always want a specific person to be the last approver.',
      p_solution               => '',
      p_success_msg            => 'Useful documentation [431815/FAQ6653] Oracle Approvals Management (AME) Frequently asked Questions (FAQ) ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
...
order by pov.level_id,"Context"',
      ...
      p_solution               => 'Useful documentation: [434567/KB647612] How to Access Oracle Approvals Management? HRMS Approvals Management (AME) Responsibilities and Setups in AME.B 
',
      p_success_msg            => 'Useful documentation: [434567/KB647612] How to Access Oracle Approvals Management? HRMS Approvals Management (AME) Responsibilities and Setups in AME.B ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
...
order by pov.level_id,"Context"',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No profile values defined.',
      p_solution               => 'In order to collect information for a particular application_id use [287255/KB353243] HRMS Approvals Management (AME) Reporting Utility Support Tool<br>
Troubleshooting steps available in [883338/KB517811] Help Documentation on Supporting AME Issues and Different Diagnostic Steps',
      p_success_msg            => 'In order to collect information for a particular application_id use [287255/KB353243] HRMS Approvals Management (AME) Reporting Utility Support Tool<br>
Troubleshooting steps available in [883338/KB517811] Help Documentation on Supporting AME Issues and Different Diagnostic Steps',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
...
debug('begin add_signature: PER_EX_SECURITY_PROFILE2');
  ...
  add_signature(
	...
	and    n.language=''US''
      ...
      p_problem_descr          => 'No profile values defined.<br>
Details in <br>
[848518/KB335552] How To View Ex-Employee and Future Dated Employee Records Data When Security Profile Is Enabled<br>
[1253694/KB627134] Enabling Access to Ex-Employee and Future Dated Employee Records<br>
[394083/KB729881] Understanding and Using HRMS Security in Oracle HRMS<br>
[1266051/KB205827] Troubleshooting eBusiness Suite HRMS Security Issues<br>
[1385633/KB789984] Security, MultiOrg, and Multi Org Access Control(MOAC) support in relation to Oracle Human Resources applications',
      p_solution               => '',
...
Details in [2170727/KB856698] HR Security Profile Not Working',
      p_success_msg            => 'No value setup for the profile "HR: Data Migrator Business Group Lockout". This is the correct setup as per [2170727/KB856698] HR Security Profile Not Working',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
...
debug('begin add_signature: HR_DEFER_UPDATE FOR AME');
  ...
  add_signature(
	...
	and    n.language=''US''
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No profile values defined.<br>
Useful documentation [431815/FAQ6653#profile2] Oracle Approvals Management (AME) Frequently asked Questions (FAQ) - section When a transaction is approved the status still remains as ''Pending Approval''',
      p_solution               => '',
      p_success_msg            => 'Useful documentation [431815/FAQ6653] Oracle Approvals Management (AME) Frequently asked Questions (FAQ) ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
...
Details in [2301785/KB791019] The Applicants, Ex-Applicants, Employee.Ex-Applicants cannot restrict via Security Profiles.',
...
Useful documentation [394083/KB729881] Understanding and Using HRMS Security in Oracle HRMS<br>
[1266051/KB205827] Troubleshooting eBusiness Suite HRMS Security Issues<br>
[1385633/KB789984] Security, MultiOrg, and Multi Org Access Control(MOAC) support in relation to Oracle Human Resources applications',
      p_solution               => '',
      p_success_msg            => 'Useful documentation [394083/KB729881] Understanding and Using HRMS Security in Oracle HRMS<br>
[1266051/KB205827] Troubleshooting eBusiness Suite HRMS Security Issues<br>
[1385633/KB789984] Security, MultiOrg, and Multi Org Access Control(MOAC) support in relation to Oracle Human Resources applications',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
...
Details in<br>
[394083/KB729881] Understanding and Using HRMS Security in Oracle HRMS<br>
[468932/KB476549] Employee Directory Search Displaying All Employees Ignoring the Security Profile<br>
[1266051/KB205827] Troubleshooting eBusiness Suite HRMS Security Issues<br>
[1385633/KB789984] Security,MultiOrg,Multi Org Access Control(MOAC),Operating Unit,Operating Unit Information,Inventory Organization,and Accounting Information Support in Relation to Oracle Human Resources Applications',
      p_solution               => '',
      p_success_msg            => 'Details in<br>
[394083/KB729881] Understanding and Using HRMS Security in Oracle HRMS<br>
[468932/KB476549] Employee Directory Search Displaying All Employees Ignoring the Security Profile<br>
...
debug('begin add_signature: ENABLE_SECURITY_GROUPS');
  ...
  add_signature(
	...
	and    n.language=''US''
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Review [412152/KB771703] How Can I Know if I am Working on Enable Security Group or Standard Security Model?<br>
[394083/KB729881] Understanding and Using HRMS Security in Oracle HRMS<br>
[1266051/KB205827] Troubleshooting eBusiness Suite HRMS Security Issues<br>
[1385633/KB789984] Security, MultiOrg, and Multi Org Access Control(MOAC) support in relation to Oracle Human Resources applications',
      p_solution               => '',
      p_success_msg            => 'Useful documentation [394083/KB729881] Understanding and Using HRMS Security in Oracle HRMS<br>
[1266051/KB205827] Troubleshooting eBusiness Suite HRMS Security Issues<br>
[1385633/KB789984] Security, MultiOrg, and Multi Org Access Control(MOAC) support in relation to Oracle Human Resources applications<br>
[412152/KB771703] How Can I Know if I’m Working on Enable Security Group or Standard Security Model?<br>',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
...
',
      p_solution               => 'Review [412152/KB771703] How Can I Know if Working on Enable Security Group or Standard Security Model?<br>
[394083/KB729881] Understanding and Using HRMS Security in Oracle HRMS<br>
[1266051/KB205827] Troubleshooting eBusiness Suite HRMS Security Issues<br>
[1385633/KB789984] Security, MultiOrg, and Multi Org Access Control(MOAC) support in relation to Oracle Human Resources applications',
      p_success_msg            => '',
...
Details in<br>
[758275/KB206235] Is There a Datafix To Rollback when Process Enable Multiple Security Groups Is Run? <br>
[1680048/KB747405] Can Multiple Security Groups be used outside of the HRMS Application? <br>
[394083/KB729881] Understanding and Using HRMS Security in Oracle HRMS<br>
[1266051/KB205827] Troubleshooting eBusiness Suite HRMS Security Issues<br>
[1385633/KB789984] Security, MultiOrg, and Multi Org Access Control(MOAC) support in relation to Oracle Human Resources applications
',
...
ORDER BY LOG_ID',
      ...
      p_solution               => '[2318305/KB654044] Steps to collect AME exception log',
...
[430232/KB187928] - Testing A Real Transaction Fails With ORA-06502',
...
Reference Note:
[451949/KB783005] - Changing Job on Employee Assignment, error''s: APP-FND-00690: Program error: The data that defines the flexfield on this field may be inconsistent',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
...
debug('begin add_signature: Currency_not_USD');
  ...
  add_signature(
      ...
      p_solution               => 'Please review: [815934/KB625656] After Upgrade - Setup Business Group Name Reverts Back To Setup Business Group<br>
[796593/KB627953]Can the Setup Business Group name be Changed?',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
...
where last_update_date > to_date(''##$$LDATE$$##'') 
and PATCH_NAME <> ''6390830''
group by PATCH_TYPE,PATCH_NAME 
order by max(trunc(LAST_UPDATE_DATE))',
...
In order to gather schema statistics schedule use [419728/KB627293] Concurrent Processing - How To Gather Statistics On Oracle Applications Release 11i and/or Release 12 - Concurrent Process,Temp Tables, Manually.<br>
...
ORDER BY 4 desc',
      ...
      p_solution               => 'In order to gather schema statistics schedule use [419728/KB627293] Concurrent Processing - How To Gather Statistics On Oracle Applications Release 11i and/or Release 12 - Concurrent Process,Temp Tables, Manually.<br>
Note! You can ignore the warning if you are manually gathering statistics using FND_STATS.GATHER_SCHEMA_STATS.
',
      p_success_msg            => 'OK! Gather schema statistics was performed in the last month.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
...
',
      p_solution               => 'Review [317002/KB588798] Approval Is Delayed In Defer Thread Activity ',
      p_success_msg            => 'This is a data collection of latest Workflow Background Process completing normal. <br>
Review [317002/KB588798] Approval Is Delayed In Defer Thread Activity ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
...
Review [370095/KB664601] How To Cancel / Delete HR Workflow Transactions / Notifications.',
      p_success_msg            => 'Complete Defunct HR Workflow process was performed in last 6 months.<br>
Useful documentation [370095/KB664601] How To Cancel / Delete HR Workflow Transactions / Notifications',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
...
debug('begin add_signature: Complete_defunct_HR');
  ...
  add_signature(
	...
	ORDER BY 2 desc',
      ...
      p_solution               => 'Review [370095/KB664601] How To Cancel / Delete HR Workflow Transactions / Notifications.',
      p_success_msg            => 'Complete Defunct HR Workflow process was performed in last 6 months.<br>
Useful documentation [370095/KB664601] How To Cancel / Delete HR Workflow Transactions / Notifications',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
...
Details in [1962912/KB795631] Where Can Information Regarding The Parameters For Running Security List Maintenance Process Be Found?
',
...
',
      p_solution               => 'Details in [1962912/KB795631] Where Can Information Regarding The Parameters For Running Security List Maintenance Process Be Found?',
      p_success_msg            => 'This section is a data collector for last successful run of Security List Maintenance process.<br>
Details in [1962912/KB795631] Where Can Information Regarding The Parameters For Running Security List Maintenance Process Be Found?',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
...
start_section('Instance Summary', 'Overview');
   ...
   set_item_result(run_stored_sig('EBS_HCM_HR_AME_LDT'));
   set_item_result(run_stored_sig('AME PACKAGES'));
   set_item_result(run_stored_sig('EBS_HCM_HR_AME_SQL'));
   set_item_result(run_stored_sig('EBS_HCM_HR_AME_XML'));
end_section;
...
start_section('Patching', 'PATCHING');
   set_item_result(check_rec_patches_1); /* Signature HCM_TXK */
...
if ((g_fwk_level)='B.5') then 
     set_item_result(check_rec_patches_4); /* Signature FWK_B */
  elsif ((g_fwk_level)='C.4') then 
     set_item_result(check_rec_patches_5); /* Signature FWK_C4 */
  elsif ((g_fwk_level)='C.5') then 
     set_item_result(check_rec_patches_6); /* Signature FWK_C5 */
  elsif ((g_fwk_level)='C.6') then 
     set_item_result(check_rec_patches_7); /* Signature FWK_C6 */
  elsif ((g_fwk_level)='C.7') then 
     set_item_result(check_rec_patches_8); /* Signature FWK_C7 */
  elsif ((g_fwk_level)='C.8') then 
     set_item_result(check_rec_patches_9); /* Signature FWK_C8 */
  elsif ((g_fwk_level)='C.9') then 
     set_item_result(check_rec_patches_10); /* Signature FWK_C9 */
  elsif ((g_fwk_level)='C.10') then 
     set_item_result(check_rec_patches_11); /* Signature FWK_C10 */
  elsif ((g_fwk_level)='C.11') then 
     set_item_result(check_rec_patches_12); /* Signature FWK_C11 */
  elsif ((g_fwk_level)='C.12') then 
     set_item_result(check_rec_patches_13); /* Signature EBS_ATG_FWK_C12 */
elsif ((g_fwk_level)='C.13') then
     set_item_result(check_rec_patches_14); /* Signature EBS_ATG_FWK_C13 */
end if;
end_section;
