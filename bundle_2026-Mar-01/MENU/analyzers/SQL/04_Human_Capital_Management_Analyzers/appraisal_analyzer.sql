...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Appraisals Analyzer                    |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE appraisal_analyzer_pkg AUTHID DEFINER AS
...
END appraisal_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY appraisal_analyzer_pkg AS
-- $Id: appraisal_analyzer.sql, 200.52 2026/01/29 07:51:27 siionesc Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2068338.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'APPRAISAL_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'APPRAISAL_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>APPRAISAL Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2068338.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/hcm_appr_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,222,EBS,EBS HCM,EBS - HR" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,222,EBS,EBS HCM,EBS - HR" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},222,EBS,EBS HCM,EBS - HR" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/3870737" class="blacklink" target="new">
...
<p><span style="font-size:small;">This analyzer gathers Appraisals related data, analyzes current configurations and settings for the environment and provides solutions for known issues, feedback and recommendations on best practices</span>.</p><p>Version 200.52&nbsp;<br>
&nbsp;- Validate/modified KM format for MOSFS</p><p>Version 200.51&nbsp;<br>
&nbsp;- Changed links from MOS to MOSFS</p><p>&nbsp;Version 200.50&nbsp;<br>
&nbsp; - Update ATG.RUP14 into RUP/OVERVIEW&nbsp;</p><p>&nbsp;Version 200.49&nbsp;<br>
&nbsp; - Latest Sequence Update&nbsp;</p><p><br>
<br>
&nbsp;</p>
            <br><br>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,222,'||l_sig.sigrepo_id||',EBS,EBS HCM,EBS - HR" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,222,'||l_sig.sigrepo_id||',EBS,EBS HCM,EBS - HR" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},222,'||l_sig.sigrepo_id||',EBS,EBS HCM,EBS - HR" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,222,'||p_sig.sigrepo_id||',EBS,EBS HCM,EBS - HR" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,222,'||p_sig.sigrepo_id||',EBS,EBS HCM,EBS - HR" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},222,'||p_sig.sigrepo_id||',EBS,EBS HCM,EBS - HR" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
BEGIN
    ...
    print_log('Processing recommended patches signature: ATGFORHCM (check_rec_patches_1) "ATG Patches" (version 17)');
...
WHERE adb.bug_number in ('37171789','35672406','34444470','33527653','31800665','30096069','28862999','26787667','25251133','24007222','22559919','21507777','20000400','19193000','17909898','17050005','17001123','16169935','14040707','10124646'))
and rownum < 2
union
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Appraisal ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_appraisal_id,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/01/29 07:51:26 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'appraisal_analyzer.sql';
...
debug('begin parameter validation: p_appraisal_id');
IF p_appraisal_id IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Appraisal ID is required.');
...
SELECT APPRAISAL_ID
INTO l_exists_val
FROM PER_APPRAISALS A,PER_ALL_PEOPLE_F
WHERE APPRAISAL_ID = p_appraisal_id
 AND appraisee_person_id = person_id

 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: This APPRAISAL ID is not available in table PER_APPRAISALS.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_appraisal_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_appraisal_id');
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$APPRID$$##') := p_appraisal_id;
   g_masked_tokens('##$$APPRID$$##') := mask_text( g_sql_tokens('##$$APPRID$$##'), 'NO_MASK');
   ...
   l_system_function_var := null;
   g_masked_tokens('##$$hr_status$$##') := mask_text( g_sql_tokens('##$$hr_status$$##'), 'NO_MASK');
...
, decode(i.patch_level, null, ''11i.'' || b.application_short_name || ''.?'', i.patch_level) "Patch Level"
		  ...
		  AND b.application_id = t.application_id
		  and (b.application_id in (''0'', ''50'', ''101'',''178'',''200'', ''201'',''203'', ''231'', ''275'', ''426'', ''453'',''603'', ''800'', ''801'',
''802'', ''803'', ''804'', ''805'', ''808'', ''809'', ''810'', ''821'', ''8301'', ''8302'', ''8303'',''8401'',''8403'',''601'',''160'',''175'',''265'',''260'',''200''))
		  and (l.lookup_type = ''FND_PRODUCT_STATUS'')
		  and (l.lookup_code = i.status )
      ...
      p_solution               => '',
      p_success_msg            => 'This is a data collection of products status (Installed / Shared / Not installed) and patching level.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
...
debug('begin add_signature: AME_GATHER_SCHEMA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '624',
      p_sig_id                 => 'AME_GATHER_SCHEMA',
	...
	ORDER BY 2 desc',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Gather schema statistics never performed for ALL, HR in last month. This can cause performance issues.',
      p_solution               => 'Run Gather Schema Statistics.<br>
In order to schedule use [419728/KB627293] Concurrent Processing - How To Gather Statistics On Oracle Applications Release 11i and/or Release 12 - Concurrent Process,Temp Tables, Manually',
      p_success_msg            => 'OK! Gather Statistics performed in last month.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AME_GATHER_SCHEMA');
...
order by n.user_profile_option_name',
      ...
      p_solution               => '',
      p_success_msg            => 'This is a data collection of important profiles settings. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
...
and    pov.application_id = po.application_id  and pov.profile_option_id = po.profile_option_id',
      p_title                  => 'Profile "HR: Manager Appraisals Menu" null',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Profile "HR: Manager Appraisals Menu" is not set as ''Manager Appraisals Menu'', this may cause issues when working with custom responsibility/menu.',
      p_solution               => 'Set ''HR: Manager Appraisals Menu'' to ''Manager Appraisals Menu''.<br>
Review: [796769/KB535128] Appraisal Not Being Created When Performance Management Plan Is Published',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
...
and    pov.application_id = po.application_id  and pov.profile_option_id = po.profile_option_id',
      p_title                  => 'Profile "HR: Manager Appraisals Menu" not set as Manager Appraisals Menu',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Profile "HR: Manager Appraisals Menu" is not set as Manager Appraisals Menu, Custom menu is set here. ',
      p_solution               => 'Please make sure it follows the same structure of seeded menu.<br>
Review: [796769/KB535128] Appraisal Not Being Created When Performance Management Plan Is Published',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
...
and    pov.application_id = po.application_id  and pov.profile_option_id = po.profile_option_id',
      p_title                  => 'Profile "HR: Worker Appraisals Menu" null',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Profile "HR: Worker Appraisals Menu" is not set at Site level.',
      p_solution               => 'This may case issues when working with custom responsibility/menu.<br>
Please set profile "HR: Worker Appraisals Menu" at Site level.<br>
Review: [796769/KB535128] Appraisal Not Being Created When Performance Management Plan Is Published',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
...
where  po.profile_option_name =''HR_WORKER_APPRAISALS_MENU'' and pov.level_id=''10001'' and pov.profile_option_value <>''HR_EMPLOYEE_APPRAISALS_MENU'' and    pov.application_id = po.application_id  and pov.profile_option_id = po.profile_option_id',
      p_title                  => 'Profile "HR: Worker Appraisals Menu" incorrect setup',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Profile "HR: Worker Appraisals Menu" is not set as Employee Appraisals Menu, Custom menu is set here.',
      p_solution               => 'Please make sure it follows the same structure of seeded menu.<br>
Review: [796769/KB535128] Appraisal Not Being Created When Performance Management Plan Is Published',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
...
where  po.profile_option_name =''FND_DISABLE_OA_CUSTOMIZATIONS''   and pov.profile_option_value=''N''
	and    pov.application_id = po.application_id  and pov.profile_option_id = po.profile_option_id',
      p_title                  => 'Profile "Disable Self-Service Personal"',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Profile "Disable Self-Service Personal" is set to N at one/several levels, so personalization/OA page customization is used. 

See the Profile setup for ''Disable Self-Service Personal'' to identify the associated profile levels. ',
      p_solution               => 'This can cause issues in system behavior (caused by custom personalization).<br>
If you have issues in web pages, before raising an Service Request, please turn this profile to Y (to disable all personalizations) and retest. If the issue is not reproducible, then it is caused by customization.<br>
Details in [787400/KB793448] Which Profile Options Are Relevant When Setting Up OA Framework Personalizations?',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
...
debug('begin add_signature: FND_OA_DEFAULTS_HR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5551',
      p_sig_id                 => 'FND_OA_DEFAULTS_HR',
      p_sig_sql                => 'select  po.profile_option_name "Profile", 
decode(pov.level_id, 10001, ''Site'',
        10002, ''Application'',
        10003, ''Responsibility'',
...
where  po.profile_option_name =''FND_OA_ENABLE_DEFAULTS''   and pov.profile_option_value=''N''
	and    pov.application_id = po.application_id  and pov.profile_option_id = po.profile_option_id',
      p_title                  => 'Profile "FND:OA:Enable Defaults"',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Profile "FND:OA:Enable Defaults" is set to N at one/several levels.',
      p_solution               => 'Default values specified in personalizations and base meta data applied to your pages will not be displayed.<br>
Review:<br>
[337958/KB559930] Cannot set Default values on Leave of Absence Function<br>
[388770/KB539409] How To Be Able To Default Appraisal Setup Details Values <br>
[433965/KB713828] Salary Admin - How to Default Status to Approved Instead of Proposed? 
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: FND_OA_DEFAULTS_HR');
...
and pov.application_id = po.application_id  and pov.profile_option_id = po.profile_option_id',
      p_title                  => 'Global Numbering Profile (FND_PROFILE_OPTIONS_VL and  FND_PROFILE_OPTION_VALUES)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'For Oracle Support: Profile "HR:Use Global Employee Numbering" is set to Yes. ',
      p_solution               => 'This note was followed: <br>
[422218/KB712987] How to Change the Value of Profile ''HR:Use Global Employee Numbering'' <br>
[259160/KB679304] Step By Step Instructions For Implementing Global Sequencing.<br>
[752815/KB717470] How to Remove Gaps in Automatic Numbering with Global Sequencing ?<br>
[297944/KB206918] PER_NUMBER_GENERATION_CONTROL Table No Longer Used After Global Numbering?<br> 
[460955/KB767072] Employee Number Sequence Is Wrong after Enabling Global Employee Numbering<br>
Once a customer implements Global Numbering, they cannot go backwards and revert back to Automatic or Manual Numbering via Business Group Info. They must continue to use Global Numbering.<br>
Global Numbering is a functionality which is supported by Oracle Human Resources support.',
      p_success_msg            => 'OK! Profile "HR:Use Global Employee Numbering" is set to No.<br>
Details in:<br>
[422218/KB712987] How to Change the Value of Profile ''HR:Use Global Employee Numbering'' <br>
[259160/KB679304] Step By Step Instructions For Implementing Global Sequencing.<br>
[752815/KB717470] How to Remove Gaps in Automatic Numbering with Global Sequencing ?<br>
...
debug('begin add_signature: Security_profile');
  ...
  add_signature(
	...
	order by upper(security_profile_name)',
      ...
      p_solution               => '',
      p_success_msg            => 'Useful documentation: <br> 
[394083/KB729881] Understanding and Using HRMS Security in Oracle HRMS<br> 
[1266051/KB205827] Troubleshooting eBusiness Suite HRMS Security Issues<br> 
[1385633/KB789984] Security, MultiOrg, and Multi Org Access Control(MOAC) support in relation to Oracle Human Resources applications',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
...
debug('begin add_signature: BUSINESS_GROUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1366',
      p_sig_id                 => 'BUSINESS_GROUP',
...
ORDER BY   1',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This is a data collection of Business Groups defined.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: BUSINESS_GROUP');



debug('begin add_signature: 1PER_APPRAISALS');
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '481',
      p_sig_id                 => '1PER_APPRAISALS',
      p_sig_sql                => 'SELECT  *
FROM    per_appraisals
WHERE   appraisal_id = ##$$APPRID$$##',
      p_title                  => 'Appraisals (PER_APPRAISALS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No appraisal defined.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of appraisal information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: 1PER_APPRAISALS');



debug('begin add_signature: OVERLAPPING APPRAISALS IN PER_APPRAISALS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22511',
      p_sig_id                 => 'OVERLAPPING APPRAISALS IN PER_APPRAISALS',
      p_sig_sql                => 'select a.appraisal_id                appraisal_id,
       a.appraisee_person_id         appraisee_person_id,
       a.appraisal_template_id       appraisal_template_id,
       a.appraisal_date              appraisal_date,
       a.appraisal_period_start_date appraisal_period_start_date,
       a.appraisal_period_end_date   appraisal_period_end_date,
       a.appraisal_system_status     appraisal_status,
       a.plan_id

  from per_appraisals a, per_appraisals b

 where a.appraisee_person_id = b.appraisee_person_id
   and a.appraisal_id != b.appraisal_id
   and (a.appraisal_template_id = b.appraisal_template_id and
            a.appraisal_period_start_date = b.appraisal_period_start_date and
            a.appraisal_period_end_date = b.appraisal_period_end_date and
            a.type = b.type and
            a.appraisal_system_status <> b.appraisal_system_status and
            a.appraisal_system_status not in ''DELETED'' and
            b.appraisal_system_status not in ''DELETED'')
   and a.appraisee_person_id in
       (select c.appraisee_person_id
          from per_appraisals c
         where c.appraisal_id = ##$$APPRID$$## )

 order by a.appraisee_person_id
',
      p_title                  => 'Overlapping Appraisals',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'You have overlapping appraisals.',
      p_solution               => 'Review Overlapping/Duplicated Records in PER_APPRAISALS Table [2910961/KB721242]',
      p_success_msg            => 'You have NO overlapping appraisals.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OVERLAPPING APPRAISALS IN PER_APPRAISALS');



debug('begin add_signature: 2PER_COMPETENCE_ELEMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '482',
      p_sig_id                 => '2PER_COMPETENCE_ELEMENTS',
      p_sig_sql                => 'SELECT  *
...
order by 1',
      p_title                  => 'Competence Elements (PER_COMPETENCE_ELEMENTS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No competence elements defined for this appraisal.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of competence elements defined for this appraisal.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: 2PER_COMPETENCE_ELEMENTS');



debug('begin add_signature: 3PER_OBJECTIVES');
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##DETAIL'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MEASURE_COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '483',
      p_sig_id                 => '3PER_OBJECTIVES',
      p_sig_sql                => 'select *
from  per_objectives
where APPRAISAL_ID = ##$$APPRID$$##',
      p_title                  => 'Objectives (PER_OBJECTIVES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No objectives defined for the appraisal.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of objectives defined for this appraisal.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: 3PER_OBJECTIVES');



debug('begin add_signature: 4PER_PERFORMANCE_RATINGS');
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '484',
      p_sig_id                 => '4PER_PERFORMANCE_RATINGS',
      p_sig_sql                => 'select *
from  per_performance_ratings
where APPRAISAL_ID = ##$$APPRID$$## 
order by 1 desc',
      p_title                  => 'Performance Ratings (PER_PERFORMANCE_RATINGS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No performance ratings defined for this appraisal.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of performance ratings for this appraisal.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: 4PER_PERFORMANCE_RATINGS');



debug('begin add_signature: 5PER_PARTICIPANTS');
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '485',
      p_sig_id                 => '5PER_PARTICIPANTS',
      p_sig_sql                => 'select *
from  per_participants
where PARTICIPATION_IN_ID = ##$$APPRID$$##
order by 1 desc',
      p_title                  => 'Participants (PER_PARTICIPANTS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No participants defined for this appraisal.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of objectives defined for this appraisal.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: 5PER_PARTICIPANTS');



debug('begin add_signature: 6HR_API_TRANSACTIONS');
   l_info('##MASK##TRANSACTION_DOCUMENT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '486',
      p_sig_id                 => '6HR_API_TRANSACTIONS',
      p_sig_sql                => 'select *
from  hr_api_transactions
where TRANSACTION_REF_ID = ##$$APPRID$$##
order by 1 desc',
      p_title                  => 'API Transactions (HR_API_TRANSACTIONS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No API transactions available for this appraisal.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of API transactions available for this appraisal.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: 6HR_API_TRANSACTIONS');



debug('begin add_signature: 9PER_EVENTS');
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CONTACT_TELEPHONE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##EXTERNAL_CONTACT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '489',
      p_sig_id                 => '9PER_EVENTS',
      p_sig_sql                => 'SELECT  *
FROM    per_events
WHERE   event_id IN
        (
...
ORDER BY 1 DESC',
      p_title                  => 'Events (PER_EVENTS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No event available for this appraisal.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of events available for this appraisal.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: 9PER_EVENTS');



debug('begin add_signature: 11PER_ASSESSMENT_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '491',
      p_sig_id                 => '11PER_ASSESSMENT_TYPES',
      p_sig_sql                => 'SELECT  *
FROM    per_assessment_types
WHERE   assessment_type_id = ##$$FK4$$##',
      p_title                  => 'Assessment Types - Competencies (PER_ASSESSMENT_TYPES - COMPETENCIES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No assessment types related to competencies.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of assessment types related to competencies.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: 11PER_ASSESSMENT_TYPES');



debug('begin add_signature: 12PER_ASSESSMENTS');
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '492',
      p_sig_id                 => '12PER_ASSESSMENTS',
      p_sig_sql                => 'SELECT  *
FROM    per_assessments pass
WHERE   pass.assessment_type_id = ##$$FK4$$##
AND APPRAISAL_ID = ##$$APPRID$$##
ORDER BY 1 DESC',
      p_title                  => 'Assessments (PER_ASSESSMENTS - COMPETENCIES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No assessments defined for this appraisal.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of assessments defined for this appraisal.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: 12PER_ASSESSMENTS');



debug('begin add_signature: 13PER_ASSESSMENT_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '493',
      p_sig_id                 => '13PER_ASSESSMENT_TYPES',
      p_sig_sql                => 'SELECT  *
FROM    per_assessment_types
WHERE   assessment_type_id = ##$$FK5$$##',
      p_title                  => 'Assessment Types - Objectives (PER_ASSESSMENT_TYPES - OBJECTIVES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No assessment types - objectives defined for this appraisal.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of assessment types - objectives defined for this appraisal.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: 13PER_ASSESSMENT_TYPES');



debug('begin add_signature: 14PER_ASSESSMENTS');
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '494',
      p_sig_id                 => '14PER_ASSESSMENTS',
      p_sig_sql                => 'SELECT  *
FROM    per_assessments pass
WHERE   pass.assessment_type_id = ##$$FK5$$##
AND APPRAISAL_ID = ##$$APPRID$$##
ORDER BY 1 DESC',
      p_title                  => 'Assessments - Objectives (PER_ASSESSMENTS - OBJECTIVES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No assessments - objectives defined for this appraisal.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of assessments - objectives defined for this appraisal.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: 14PER_ASSESSMENTS');



debug('begin add_signature: 10PER_APPRAISAL_TEMPLATES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '490',
      p_sig_id                 => '10PER_APPRAISAL_TEMPLATES',
      p_sig_sql                => 'SELECT  nvl(assessment_type_id,-1) "##$$FK4$$##",nvl(objective_asmnt_type_id,-1) "##$$FK5$$##", APPRAISAL_TEMPLATE_ID,BUSINESS_GROUP_ID,OBJECT_VERSION_NUMBER,NAME,DESCRIPTION,DATE_FROM,DATE_TO,ASSESSMENT_TYPE_ID,RATING_SCALE_ID,QUESTIONNAIRE_TEMPLATE_ID,QUESTIONNAIRE_LANGUAGE,ATTRIBUTE_CATEGORY, LAST_UPDATE_DATE,LAST_UPDATED_BY,LAST_UPDATE_LOGIN,CREATED_BY,CREATION_DATE,OBJECTIVE_ASMNT_TYPE_ID,MA_QUEST_TEMPLATE_ID,LINK_APPR_TO_LEARNING_PATH,FINAL_SCORE_FORMULA_ID,UPDATE_PERSONAL_COMP_PROFILE
FROM    per_appraisal_templates
WHERE   appraisal_template_id IN
        (
        SELECT  appraisal_template_id
        FROM    per_appraisals
        WHERE   appraisal_id = ##$$APPRID$$##
        )',
      p_title                  => 'Appraisal Templates (PER_APPRAISAL_TEMPLATES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No appraisal template used for this appraisal.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of templates used for this appraisal.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('11PER_ASSESSMENT_TYPES','12PER_ASSESSMENTS','13PER_ASSESSMENT_TYPES','14PER_ASSESSMENTS'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '13'
      );
   l_info.delete;
debug('end add_signature: 10PER_APPRAISAL_TEMPLATES');



debug('begin add_signature: 16PQH_SS_TRANSACTION_HISTORY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '502',
      p_sig_id                 => '16PQH_SS_TRANSACTION_HISTORY',
      p_sig_sql                => 'SELECT  *
FROM    pqh_ss_transaction_history
WHERE   item_key IN
        (
        SELECT  substr (system_params
                       ,instr (system_params
                              ,''ItemKey='') + 8)
        FROM    per_appraisals
        WHERE   appraisal_id = ##$$APPRID$$##
...
ORDER BY 1 DESC',
      p_title                  => 'Transaction History (PQH_SS_TRANSACTION_HISTORY)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No transaction history available for this appraisal.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of transaction history available for this appraisal.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: 16PQH_SS_TRANSACTION_HISTORY');



debug('begin add_signature: 17HR_ORGANIZATION_UNITS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '503',
      p_sig_id                 => '17HR_ORGANIZATION_UNITS',
      p_sig_sql                => 'SELECT  *
...
WHERE   organization_id IN
      ...
      p_title                  => 'Organization Units (HR_ORGANIZATION_UNITS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No organization unit used by this appraisal.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of organization units used by this appraisal.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: 17HR_ORGANIZATION_UNITS');



debug('begin add_signature: 18PER_RATING_SCALES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '504',
      p_sig_id                 => '18PER_RATING_SCALES',
      p_sig_sql                => 'SELECT  *
FROM    per_rating_scales',
      p_title                  => 'Rating Scales (PER_RATING_SCALES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No rating scales defined.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of rating scales.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: 18PER_RATING_SCALES');



debug('begin add_signature: 28OTA_LEARNING_PATH_MEMBERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '611',
      p_sig_id                 => '28OTA_LEARNING_PATH_MEMBERS',
      p_sig_sql                => 'SELECT  *
FROM    ota_learning_path_members
WHERE   learning_path_id = ##$$FK6$$##',
      p_title                  => 'Learning Path members (OTA_LEARNING_PATH_MEMBERS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No member defined for this learning path.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of members defined for this learning path.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: 28OTA_LEARNING_PATH_MEMBERS');



debug('begin add_signature: 29OTA_ACTIVITY_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '612',
      p_sig_id                 => '29OTA_ACTIVITY_VERSIONS',
      p_sig_sql                => 'SELECT  *
...
WHERE   activity_version_id IN
      ...
      p_title                  => 'Learning Path courses (OTA_ACTIVITY_VERSIONS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No course defined for this learning path.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of courses defined for this learning path.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: 29OTA_ACTIVITY_VERSIONS');



debug('begin add_signature: 27OTA_LEARNING_PATHS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '610',
      p_sig_id                 => '27OTA_LEARNING_PATHS',
      p_sig_sql                => 'select nvl(learning_path_id,-1) "##$$FK6$$##",LEARNING_PATH_ID,BUSINESS_GROUP_ID,DURATION,DURATION_UNITS,START_DATE_ACTIVE,END_DATE_ACTIVE,OBJECT_VERSION_NUMBER,CREATED_BY,CREATION_DATE,LAST_UPDATE_DATE,LAST_UPDATED_BY,LAST_UPDATE_LOGIN,ATTRIBUTE_CATEGORY
from   OTA_LEARNING_PATHS
where  SOURCE_FUNCTION_CODE = ''APPRAISAL''
AND    SOURCE_ID = ##$$APPRID$$##',
      p_title                  => 'Learning Paths (OTA_LEARNING_PATHS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No learning path defined for this appraisal.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of learning paths defined for this appraisal.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('28OTA_LEARNING_PATH_MEMBERS','29OTA_ACTIVITY_VERSIONS'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '9'
      );
   l_info.delete;
debug('end add_signature: 27OTA_LEARNING_PATHS');



debug('begin add_signature: EBS_HCM_HRTOOLS_APPRAISAL_USER_HOOK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25293',
      p_sig_id                 => 'EBS_HCM_HRTOOLS_APPRAISAL_USER_HOOK',
      p_sig_sql                => 'SELECT m.*,
       h.*,
       c.*
  FROM apps.hr_api_modules m, apps.hr_api_hooks h, apps.hr_api_hook_calls c
 WHERE ( m.module_name IN  (''PER_PERSONAL_SCORECARDS'', ''PER_PERF_MGMT_PLANS'',''PER_OBJECTIVES'', ''PER_APPRAISALS'',''PER_OBJECTIVES_LIBRARY'')
        OR m.module_package IN   (''HR_APPRAISALS_API'', ''HR_PERSONAL_SCORECARD_API,'', ''HR_OBJECTIVES_API''))
   AND m.api_module_id = h.api_module_id(+)
   AND h.api_hook_id = c.api_hook_id(+)
   AND c.call_package IS NOT NULL
   AND c.call_package IS NOT NULL',
      p_title                  => 'Custom User Hook',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This a data collection about user hook.',
      p_solution               => '',
      p_success_msg            => 'No custom user hook in place.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_HCM_HRTOOLS_APPRAISAL_USER_HOOK');



debug('begin add_signature: 8HR_QUEST_ANSWER_VALUES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '488',
      p_sig_id                 => '8HR_QUEST_ANSWER_VALUES',
      p_sig_sql                => 'SELECT  *
FROM    hr_quest_answer_values
WHERE   questionnaire_answer_id = ##$$FK3$$##
ORDER BY 1 DESC',
      p_title                  => 'Questionnaire answers values (HR_QUEST_ANSWER_VALUES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No questionnaire answer values',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: 8HR_QUEST_ANSWER_VALUES');



debug('begin add_signature: 7HR_QUEST_ANSWERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '487',
      p_sig_id                 => '7HR_QUEST_ANSWERS',
      p_sig_sql                => 'select nvl(QUESTIONNAIRE_ANSWER_ID,-1) "##$$FK3$$##", QUESTIONNAIRE_ANSWER_ID,QUESTIONNAIRE_TEMPLATE_ID,TYPE,TYPE_OBJECT_ID,BUSINESS_GROUP_ID,LAST_UPDATED_BY,LAST_UPDATE_LOGIN,CREATED_BY,CREATION_DATE,LAST_UPDATE_DATE
from  hr_quest_answers
where TYPE_OBJECT_ID = ##$$APPRID$$##
order by 1 desc',
      p_title                  => 'Questionnaire answers (HR_QUEST_ANSWERS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No questionnaire answer defined in this appraisal.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of questionnaire answers defined in this appraisal.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('8HR_QUEST_ANSWER_VALUES'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '6'
      );
   l_info.delete;
debug('end add_signature: 7HR_QUEST_ANSWERS');



debug('begin add_signature: 19HR_QUESTIONNAIRES - APPRAISEE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '505',
      p_sig_id                 => '19HR_QUESTIONNAIRES - APPRAISEE',
      p_sig_sql                => 'SELECT  questionnaire_template_id, NAME,AVAILABLE_FLAG,BUSINESS_GROUP_ID,OBJECT_VERSION_NUMBER,LAST_UPDATED_BY,LAST_UPDATE_LOGIN,CREATED_BY,CREATION_DATE,LAST_UPDATE_DATE,substr(replace(replace(TEXT,''<'','' ''),''>'','' ''),1,2000) "Text (first 2000 characters)"
FROM    hr_questionnaires
WHERE   questionnaire_template_id IN
        (
      ...
      p_title                  => 'Questionnaires - Appraised (HR_QUESTIONNAIRES - APPRAISAL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No questionnaires for appraised person.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of questionnaires for appraised person.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: 19HR_QUESTIONNAIRES - APPRAISEE');



debug('begin add_signature: 20HR_QUEST_FIELDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '506',
      p_sig_id                 => '20HR_QUEST_FIELDS',
      p_sig_sql                => 'SELECT  *
...
WHERE   questionnaire_template_id IN
      ...
      p_title                  => 'Questionnaire Fields - Appraised (HR_QUEST_FIELDS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No questionnaire fields for appraised person.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of questionnaire fields for appraised person.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: 20HR_QUEST_FIELDS');



debug('begin add_signature: 22HR_QUEST_FIELDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '508',
      p_sig_id                 => '22HR_QUEST_FIELDS',
      p_sig_sql                => 'SELECT  *
FROM    hr_quest_fields
WHERE   questionnaire_template_id = ##$$FK8$$##',
      p_title                  => 'Main Appraiser Questionnaire Fields',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No fields.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: 22HR_QUEST_FIELDS');



debug('begin add_signature: 21HR_QUESTIONNAIRES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '507',
      p_sig_id                 => '21HR_QUESTIONNAIRES',
      p_sig_sql                => 'SELECT  nvl(questionnaire_template_id,-1) "##$$FK8$$##", questionnaire_template_id, NAME,AVAILABLE_FLAG,BUSINESS_GROUP_ID,OBJECT_VERSION_NUMBER,LAST_UPDATED_BY,LAST_UPDATE_LOGIN,CREATED_BY,CREATION_DATE,LAST_UPDATE_DATE,substr(replace(replace(TEXT,''<'','' ''),''>'','' ''),1,2000) "Text (first 2000 characters)"
FROM    hr_questionnaires 
WHERE   questionnaire_template_id IN
        (
        SELECT  ma_quest_template_id
        FROM    per_appraisal_templates
        WHERE   appraisal_template_id IN
                (
                SELECT  appraisal_template_id
      ...
      p_title                  => 'Main Appraiser Questionnaire Template (HR_QUESTIONNAIRES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No main appraiser questionnaire template defined in this appraisal.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of main appraiser questionnaire template defined in this appraisal.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('22HR_QUEST_FIELDS'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '7'
      );
   l_info.delete;
debug('end add_signature: 21HR_QUESTIONNAIRES');



debug('begin add_signature: 23HR_QUESTIONNAIRES - PARTICIPANTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '509',
      p_sig_id                 => '23HR_QUESTIONNAIRES - PARTICIPANTS',
      p_sig_sql                => 'SELECT  *
FROM    hr_questionnaires
WHERE   questionnaire_template_id IN
        (
      ...
      p_title                  => 'Questionnaires - Participants (HR_QUESTIONNAIRES - PARTICIPANTS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No questionnaire for participants defined in this appraisal.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of questionnaires for participants defined in this appraisal.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: 23HR_QUESTIONNAIRES - PARTICIPANTS');



debug('begin add_signature: 24HR_QUEST_FIELDS - PARTICIPANTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '510',
      p_sig_id                 => '24HR_QUEST_FIELDS - PARTICIPANTS',
      p_sig_sql                => 'SELECT  *
FROM    hr_quest_fields
WHERE   questionnaire_template_id IN
        (
      ...
      p_title                  => 'Questionnaires Fields - Participants (HR_QUEST_FIELDS - PARTICIPANTS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No questionnaire fields for participants defined in this appraisal.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of questionnaire fields for participants defined in this appraisal.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: 24HR_QUEST_FIELDS - PARTICIPANTS');



debug('begin add_signature: 26HR_QUEST_ANSWER_VALUES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '511',
      p_sig_id                 => '26HR_QUEST_ANSWER_VALUES',
      p_sig_sql                => 'SELECT  *
FROM    hr_quest_answer_values
WHERE   questionnaire_answer_id = ##$$FK2$$##',
      p_title                  => 'Questionnaire Answer Values - Participants (HR_QUEST_ANSWER_VALUES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Questionnaire Answer Values - Participants',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: 26HR_QUEST_ANSWER_VALUES');



debug('begin add_signature: 25HR_QUEST_ANSWERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '512',
      p_sig_id                 => '25HR_QUEST_ANSWERS',
      p_sig_sql                => 'SELECT  nvl(QUESTIONNAIRE_ANSWER_ID,-1)  "##$$FK2$$##",QUESTIONNAIRE_ANSWER_ID,QUESTIONNAIRE_TEMPLATE_ID,TYPE,TYPE_OBJECT_ID,BUSINESS_GROUP_ID,LAST_UPDATED_BY,LAST_UPDATE_LOGIN             ,CREATED_BY,CREATION_DATE,LAST_UPDATE_DATE
FROM    hr_quest_answers
WHERE   type_object_id IN
        (
...
ORDER BY 1 DESC',
      p_title                  => 'Questionnaire Answers - Participants',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No questionnaire answers for participants available in this appraisal.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of questionnaire answers for participants available in this appraisal.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('26HR_QUEST_ANSWER_VALUES'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '6'
      );
   l_info.delete;
debug('end add_signature: 25HR_QUEST_ANSWERS');



debug('begin add_signature: 30PER_ALL_PEOPLE_F - APPRAISEE');
   l_info('##MASK##APPLICANT_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   ...
   l_info('##MASK##NPW_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '615',
      p_sig_id                 => '30PER_ALL_PEOPLE_F - APPRAISEE',
      p_sig_sql                => 'select
...
, party_id
, business_group_id
, current_applicant_flag applicant_flag
, current_emp_or_apl_flag emp_or_apl_flag
, current_employee_flag employee_flag
, current_npw_flag npw_flag
, decode(to_char(SEX),''F'',''(F) Female'',''M'',''(M) Male'',''N'',''(N) Unspecified'',''U'',''(U) Unknown'') Gender
, email_address
, start_date
, original_date_of_hire
, comment_id
, object_version_number
, decode(to_char(nvl(expense_check_send_to_address,''-'')),''H'',''Home'',''O'',''Office'',''P'',''Provisional'',''-'') Mail_To
, created_by
, creation_date
, last_updated_by
, last_update_date
...
WHERE   person_id IN
        (
        SELECT  appraisee_person_id
        FROM    per_appraisals
        WHERE   appraisal_id = ##$$APPRID$$##
        )',
      p_title                  => 'Appraised person details (PER_ALL_PEOPLE_F - APPRAISED)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No persons.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of appraised person details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: 30PER_ALL_PEOPLE_F - APPRAISEE');



debug('begin add_signature: 31PER_ALL_ASSIGNMENTS_F_APPRAISEE');
   l_info('##MASK##ASSIGNMENT_NUMBER'):= 'DISPLAY_LAST_25_PCNT';
   l_info('##MASK##INTERNAL_ADDRESS_LINE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##LABOUR_UNION_MEMBER_FLAG'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '617',
      p_sig_id                 => '31PER_ALL_ASSIGNMENTS_F_APPRAISEE',
      p_sig_sql                => 'SELECT  *
...
WHERE   assignment_id IN
      ...
      p_title                  => 'Appraised assignments  (PER_ALL_ASSIGNMENTS_F - APPRAISED)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No assignment for appraised person.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of assignments for appraised person.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: 31PER_ALL_ASSIGNMENTS_F_APPRAISEE');



debug('begin add_signature: 32PER_ALL_PEOPLE_F_APPRAISER');
   l_info('##MASK##APPLICANT_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##EMAIL_ADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##EMPLOYEE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FULL_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '618',
      p_sig_id                 => '32PER_ALL_PEOPLE_F_APPRAISER',
      p_sig_sql                => 'select
effective_start_date
, effective_end_date
, full_name
...
WHERE person_id IN
(
SELECT APPRAISER_PERSON_ID
FROM per_appraisals
WHERE appraisal_id = ##$$APPRID$$##
)
order by effective_start_date',
      p_title                  => 'Appraiser person details  (PER_ALL_PEOPLE_F - APPRAISER)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No appraiser.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of appraiser person details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: 32PER_ALL_PEOPLE_F_APPRAISER');



debug('begin add_signature: 33PER_ALL_PEOPLE_F - MAIN APPRIASER');
   l_info('##MASK##APPLICANT_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##EMAIL_ADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##EMPLOYEE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FULL_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '619',
      p_sig_id                 => '33PER_ALL_PEOPLE_F - MAIN APPRIASER',
      p_sig_sql                => 'select
effective_start_date
, effective_end_date
, full_name
...
WHERE   person_id IN
      ...
      p_title                  => 'Main Appraiser person details (PER_ALL_PEOPLE_F - MAIN APPRIASER)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No main appraiser.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of main appraiser person details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: 33PER_ALL_PEOPLE_F - MAIN APPRIASER');



debug('begin add_signature: 34PER_ALL_PEOPLE_F - PARTICIPANTS');
   l_info('##MASK##APPLICANT_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##EMAIL_ADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##EMPLOYEE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FULL_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '621',
      p_sig_id                 => '34PER_ALL_PEOPLE_F - PARTICIPANTS',
      p_sig_sql                => 'select
effective_start_date
, effective_end_date
, full_name
...
WHERE   person_id IN
      ...
      p_title                  => 'Participants person details (PER_ALL_PEOPLE_F - PARTICIPANTS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No participant person details available.',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of participants person details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: 34PER_ALL_PEOPLE_F - PARTICIPANTS');



debug('begin add_signature: EBS_HCM_HR_APPRAISAL_ASSIGNMENTS_PER_ALL_PEOPLE_F');
   l_info('##MASK##ASG_NUMBER'):= 'DISPLAY_LAST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30200',
      p_sig_id                 => 'EBS_HCM_HR_APPRAISAL_ASSIGNMENTS_PER_ALL_PEOPLE_F',
      p_sig_sql                => 'select
to_char(paf.assignment_id) "Asg ID"
, nvl(paf.assignment_number,''-'') Asg_Number
, to_char(paf.effective_start_date,''DD-Mon-YYYY'') "Eff_Start_Dt"
, to_char(paf.effective_end_date,''DD-Mon-YYYY'') "Effe_End_Dt"
, nvl(paf.primary_flag,''-'') "Pri"
, nvl(to_char(paf.assignment_sequence),''-'') "Asg Seq"
, decode(to_char(paf.assignment_type),''A'',''Applicant'',''B'',''Benefits'',''C'',''Contingent'',''E'',''Employee'',to_char(paf.assignment_type)) || '' ('' || paf.assignment_status_type_id || '')'' "Asg Type(Type ID)"
, nvl(hr_general.decode_lookup(''PER_ASS_SYS_STATUS'',past.per_system_status),''-'') "Asg Status"
, nvl(to_char(paf.organization_id),''-'') "Org ID"
, nvl(to_char(paf.location_id),''-'') "Loc ID"
, nvl(to_char(paf.job_id),''-'') "Job ID"
, nvl(to_char(paf.position_id),''-'') "Position ID"
, nvl(to_char(paf.grade_id),''-'') "Grade ID"
, nvl(to_char(paf.period_of_service_id),''-'') "PO Serv-ID"
, nvl(to_char(paf.application_id),''-'') "Application-ID"
, nvl(to_char(paf.business_group_id),''-'') "BG ID"
, nvl(to_char(paf.pay_basis_id),''-'') "Pay Bas ID"
, nvl(to_char(paf.payroll_id),''-'') "Payroll ID"
, nvl(to_char(paf.supervisor_id),''-'') "Suprv ID"
, nvl(to_char(paf.vacancy_id),''-'') "Vacancy ID"
, nvl(to_char(paf.object_version_number),''-'') "OVN"
, nvl(to_char(paf.projected_assignment_end) ,''-'') "Proj Asg End"
, paf.created_by "Created By"
, to_char(paf.creation_date,''DD-Mon-YYYY'') "Created_Date"
, paf.last_updated_by "Last Update By"
, to_char(paf.last_update_date,''DD-Mon-YYYY'') "Last_Update"
, nvl(to_char(paf.people_group_id),''-'') "People Group ID"
, nvl(to_char(paf.special_ceiling_step_id),''-'') "Spec Ceiling Step ID"
, nvl(to_char(paf.soft_coding_keyflex_id),''-'') "Soft Coding Flex"
from per_all_assignments_f paf
, per_assignment_status_types past
where paf.person_id IN ( SELECT APPRAISER_PERSON_ID FROM per_appraisals WHERE appraisal_id = ##$$APPRID$$## )
and past.assignment_status_type_id = paf.assignment_status_type_id
order by assignment_id, effective_start_date',
      p_title                  => 'Assignment Details (PER_ALL_ASSIGNMENTS_F)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This section lists the Assignment details for each Effective Date Range for PERSON_ID  IN ( SELECT APPRAISER_PERSON_ID FROM per_appraisals WHERE appraisal_id = ##$$APPRID$$## )',
      p_solution               => '',
      p_success_msg            => 'No rows for PERSON_ID  IN ( SELECT APPRAISER_PERSON_ID FROM per_appraisals WHERE appraisal_id = ##$$APPRID$$## )',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_HCM_HR_APPRAISAL_ASSIGNMENTS_PER_ALL_PEOPLE_F');
...
debug('begin add_signature: HRglobal_shared');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3476',
      p_sig_id                 => 'HRglobal_shared',
...
AND pr.SUCCESS_FLAG = ''Y'')',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Hrglobal was performed in shared instance. ',
      p_solution               => 'Hrglobal should not be performed in shared instance.<br>
Review [1476979/KB763348] Shared HR implementation - Things to check when doing an Oracle Human Resources ''Shared HR'' implementation.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: HRglobal_shared');
...
debug('begin add_signature: Data_Install');
  ...
  add_signature(
      ...
      p_title                  => 'DataInstaller Actions - Legislations selected for Install',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'You have legislations currently selected for install by the DataInstall.',
      p_solution               => 'You need to perform hrglobal in order to install/upgrade all legislative data selected during DataInstaller.<br>
Review: <br>
[1469456/KB207194] Datainstall and Hrglobal Application: 12.2 specifics<br>
[2006776/KB737673] R12.2: How to Install HRMS Legislative Data Using Data Installer and hrglobal.drv<br><br>
[145837/KB859896] 11.5-12.1: Latest Oracle HRMS Legislative Data Patch Available<br>
[140511/KB747666] How to Install HRMS Legislative Data Using Data Installer and hrglobal.drv 12.1 Specificsdrv<br>

',
      p_success_msg            => 'OK! No legislation''s currently selected for install by the DataInstall.<br>
HRGlobal was performed after DataInstall.<br>
Useful documentation: <br>
[1469456/KB207194] R12.2:  Datainstall and Hrglobal Application: 12.2 specifics<br>
[2006776/KB737673] R12.2: How to Install HRMS Legislative Data Using Data Installer and hrglobal.drv<br><br>
[145837/KB859896] 11.5-12.1: Latest Oracle HRMS Legislative Data Patch Available<br>
[140511/KB747666] How to Install HRMS Legislative Data Using Data Installer and hrglobal.drv 12.1 Specifics.drv<br>
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
...
debug('begin add_signature: Statutory_exception');
  ...
  add_signature(
      ...
      p_solution               => 'In order to solve please review: [101351/KB792531] HRGLOBAL.DRV:DIAGNOSING PROBLEMS WITH LEGISLATIVE UPDATES - HR_LEGISLATION.INSTALL',
      p_success_msg            => 'OK! No statutory exceptions found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
...
BEGIN
  ...
  analyzer_title := 'Appraisals Analyzer';
...
start_section('Instance Overview', 'Overview');
   ...
   set_item_result(run_stored_sig('AME_GATHER_SCHEMA'));
...
start_section('Patching', 'Patching');
   ...
   IF g_sql_tokens('##$$hr_status$$##') ='Shared' THEN
      set_item_result(run_stored_sig('HRglobal_shared'));
   END IF;
   IF g_sql_tokens('##$$hr_status$$##') ='Installed' THEN
...
start_section('Settings', 'Settings');
   ...
   set_item_result(run_stored_sig('FND_OA_DEFAULTS_HR'));
   set_item_result(run_stored_sig('ProfilePER_GLOBAL_EMP_NUM'));
   set_item_result(run_stored_sig('Security_profile'));
   set_item_result(run_stored_sig('BUSINESS_GROUP'));
end_section;
debug('end section: Settings');

debug('begin section: Generic_Appraisal');
start_section('Generic Appraisal', 'Generic_Appraisal');
   set_item_result(run_stored_sig('1PER_APPRAISALS'));
   set_item_result(run_stored_sig('OVERLAPPING APPRAISALS IN PER_APPRAISALS'));
   set_item_result(run_stored_sig('2PER_COMPETENCE_ELEMENTS'));
   set_item_result(run_stored_sig('3PER_OBJECTIVES'));
   set_item_result(run_stored_sig('4PER_PERFORMANCE_RATINGS'));
   set_item_result(run_stored_sig('5PER_PARTICIPANTS'));
   set_item_result(run_stored_sig('6HR_API_TRANSACTIONS'));
   set_item_result(run_stored_sig('9PER_EVENTS'));
   set_item_result(run_stored_sig('10PER_APPRAISAL_TEMPLATES'));
   set_item_result(run_stored_sig('16PQH_SS_TRANSACTION_HISTORY'));
   set_item_result(run_stored_sig('17HR_ORGANIZATION_UNITS'));
   set_item_result(run_stored_sig('18PER_RATING_SCALES'));
   set_item_result(run_stored_sig('27OTA_LEARNING_PATHS'));
   set_item_result(run_stored_sig('EBS_HCM_HRTOOLS_APPRAISAL_USER_HOOK'));
end_section;
debug('end section: Generic_Appraisal');

debug('begin section: Questionnaire');
start_section('Questionnaire', 'Questionnaire');
   set_item_result(run_stored_sig('7HR_QUEST_ANSWERS'));
   set_item_result(run_stored_sig('19HR_QUESTIONNAIRES - APPRAISEE'));
   set_item_result(run_stored_sig('20HR_QUEST_FIELDS'));
   set_item_result(run_stored_sig('21HR_QUESTIONNAIRES'));
   set_item_result(run_stored_sig('23HR_QUESTIONNAIRES - PARTICIPANTS'));
   set_item_result(run_stored_sig('24HR_QUEST_FIELDS - PARTICIPANTS'));
   set_item_result(run_stored_sig('25HR_QUEST_ANSWERS'));
end_section;
debug('end section: Questionnaire');

debug('begin section: Persons');
start_section('Person Details', 'Persons');
   set_item_result(run_stored_sig('30PER_ALL_PEOPLE_F - APPRAISEE'));
   set_item_result(run_stored_sig('31PER_ALL_ASSIGNMENTS_F_APPRAISEE'));
   set_item_result(run_stored_sig('32PER_ALL_PEOPLE_F_APPRAISER'));
   set_item_result(run_stored_sig('33PER_ALL_PEOPLE_F - MAIN APPRIASER'));
   set_item_result(run_stored_sig('34PER_ALL_PEOPLE_F - PARTICIPANTS'));
   set_item_result(run_stored_sig('EBS_HCM_HR_APPRAISAL_ASSIGNMENTS_PER_ALL_PEOPLE_F'));
end_section;
debug('end section: Persons');
