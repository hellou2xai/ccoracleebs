...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for NLS and MLS Analyzer                   |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE nls_analyzer_pkg AUTHID DEFINER AS
...
END nls_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY nls_analyzer_pkg AS
-- $Id: ebs_nls_analyzer.sql, 200.47 2026/01/28 01:57:12 dterrell Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2066198.1));
...
----------------------------------------------------------------
g_global_update_date                    number;
g_site_profile_id                       number;
g_site_profile_code                     varchar2(50);
g_client_timezone_user_diff             number;
g_client_timezone_user_cnt              number;
g_fnd_native_client_user_cnt		number;
g_fnd_native_client_user_diff		number;
g_fnd_native_client_encoding            varchar2(240);
g_icx_client_iana_user_cnt		number;
g_icx_client_iana_user_diff		number;
g_icx_date_fmt_mask_user_cnt		number;
g_icx_date_fmt_mask_user_diff   	number;
g_icx_date_lang_user_cnt		number;
g_icx_date_lang_user_diff		number;
g_icx_nls_sort_user_cnt			number;
g_icx_nls_sort_user_diff		number;
g_icx_num_char_user_cnt			number;
g_icx_num_char_user_diff		number;
g_icx_pref_currency_user_cnt		number;
g_icx_pref_currency_user_diff		number;
g_icx_territory_user_cnt		number;
g_icx_territory_user_diff		number;
g_db_charset                            varchar2(64);
g_instance                              V$INSTANCE.INSTANCE_NAME%TYPE;
g_menus_not_synch                       number;
g_lang_cnt                              number;
g_lang_code                             varchar2(7);
g_base_lang                             varchar2(3);
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'EBS_NLS_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'EBS_NLS_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>EBS_NLS Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2066198.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/nls_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,324,EBS,EBS ATG,EBS - Component Tools" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,324,EBS,EBS ATG,EBS - Component Tools" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},324,EBS,EBS ATG,EBS - Component Tools" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/mosc/discussion/3929512" class="blacklink" target="new">
...
<div>&nbsp;</div>
<div>&nbsp;</div>
<div>7/2/25: Signature EBS_ATG_UGLE_32BIT_SEQUENCES_CLOSE_TO_MAX has been changed.</div>
<div>&nbsp;</div>
<div>4/16/25: There are 2 new features:<br>
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;1. Fixed the input is too long error when running an analyzer in SQL*Plus&nbsp;</div>
<div>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;2. Added the click to highlight rows in tables</div>
<div>&nbsp;</div>
<div>The NLS Analyzer is now executed as a Package instead of an Anonymous Block.</div>
<div>Please see the instructions in Doc ID 2066198.1 for running the analyzer via Sql*Plus, and as a Concurrent Request.</div>
<div>The framework was updated to framework version <span title="">4.5.9.1</span></div>
<div>The Data Masking feature has been expanded.&nbsp;&nbsp;&nbsp;&nbsp;<br>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,324,'||p_sig.sigrepo_id||',EBS,EBS ATG,EBS - Component Tools" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,324,'||p_sig.sigrepo_id||',EBS,EBS ATG,EBS - Component Tools" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},324,'||p_sig.sigrepo_id||',EBS,EBS ATG,EBS - Component Tools" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
----------------------------------------------------------------
----------------------------------------------------------------
-- Creates a Note Box to display some important Information   --
----------------------------------------------------------------
PROCEDURE show_note IS
	  emesg  			    VARCHAR2(250);
	  
begin

print_log('  Processing Procedure: show_note');

print_out('<div class="divItem" align="center" id="sigNOTE">');
	
    print_out('<table border="1" name="NoteBox" cellpadding="10" bordercolor="#ffde16" bgcolor="#FEFCEE" cellspacing="0">');
    print_out('<tbody><tr><td> ');
    print_out('<p><B>ATTENTION:</B> For the BEST DISPLAY results of the possible different characters and charactersets, set your <i>Browser Character Encoding</i> to <b>Unicode</b>.</p>');
    print_out('</td></tr></tbody></table>');
...
FUNCTION tab_to_string (p_delimiter     IN  VARCHAR2 DEFAULT ',') RETURN VARCHAR2 IS
	l_string     VARCHAR2(32767);
	      l_lang_list_installed varchar2(200):=null;
	      l_lang varchar2(20);
	      cursor c is
...
----------------------------------------------------------------
snap_days                         number := 0;
global_update_date                number := 0;
l_site_profile_id                 number := -1;
l_siteset			  number := 0;
l_site_profile_code               varchar2(50);
l_client_timezone_user_cnt        number := 0;
l_client_timezone_user_diff       number := 0;
l_fnd_native_client_user_cnt	  number := 0;
l_fnd_native_client_user_diff	  number := 0;
l_fnd_native_client_encoding      varchar2(240);
l_icx_client_iana_user_cnt	  number := 0;
l_icx_client_iana_user_diff	  number := 0;
l_icx_date_fmt_mask_user_cnt	  number := 0;
l_icx_date_fmt_mask_user_diff     number := 0;
l_icx_date_lang_user_cnt	  number := 0;
l_icx_date_lang_user_diff	  number := 0;
l_icx_nls_sort_user_cnt		  number := 0;
l_icx_nls_sort_user_diff	  number := 0;
l_icx_num_char_user_cnt		  number := 0;
l_icx_num_char_user_diff	  number := 0;
l_icx_pref_currency_user_cnt	  number := 0;
l_icx_pref_currency_user_diff	  number := 0;
l_icx_territory_user_cnt	  number := 0;
l_icx_territory_user_diff	  number := 0;
db_charset                        varchar2(64);
l_menus_not_synch                 number := 0;
l_lang_cnt                        number := 0;
l_lang_code                       varchar2(7);
l_base_lang                       varchar2(3);
...
-- Revision and date values can be populated by RCS
  l_revision := rtrim(replace('$Revision: 200.47  $','$',''));
  l_revision := ltrim(replace(l_revision,'Revision:',''));
  l_date_char := rtrim(replace('$Date: 2026/01/28 01:57:11 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'ebs_nls_analyzer.sql';
...
select round(sysdate - (select * from (select snapshot_update_date from ad_snapshots 
       where snapshot_name like '%_VIEW'
         ...
         and SNAPSHOT_TYPE in ('C','G')
         order by snapshot_update_date desc)
         where rownum = 1),0)+1 into snap_days
         from dual;  
         
print_log('.........snap_days = '||snap_days);

print_log('Variable global_update_date....');
        
select round(sysdate - (select * from (select LAST_UPDATE_DATE from ad_snapshots 
       where snapshot_name like '%_VIEW'
         and appl_top_id in (select appl_top_id from ad_appl_tops where name in ('GLOBAL'))
         and SNAPSHOT_TYPE in ('C','G')
         order by LAST_UPDATE_DATE desc)
         where rownum = 1),0)+1 into global_update_date
         from dual;  

print_log('.........global_update_date = '||global_update_date);

print_log('Variable db_charset....');
select VALUE into db_charset from V$NLS_PARAMETERS where PARAMETER = 'NLS_CHARACTERSET';
print_log('.........db_charset = '||db_charset);

print_log('Variable l_site_profile_id....');

select count(rownum) into l_siteset
from fnd_profile_options p, fnd_profile_option_values v
where v.level_id = '10001' and 
p.profile_option_id = v.profile_option_id (+)
and p.profile_option_name = 'CLIENT_TIMEZONE_ID';

print_log('.........l_siteset = '||l_siteset);

if (l_siteset > 0) then
	--Identify the CLIENT_TIMEZONE_ID at the SITE level
	select nvl(v.profile_option_value,'-1') into l_site_profile_id
	from fnd_profile_options p, fnd_profile_option_values v
	...
	--Identify the Timezone Code at the SITE level
	select timezone_code into l_site_profile_code 
	from fnd_timezones_b where upgrade_tz_id=(select v.profile_option_value
								   from fnd_profile_options p, fnd_profile_option_values v
								   where v.level_id = '10001' 
								   and p.profile_option_id = v.profile_option_id (+)
								   and p.profile_option_name = 'CLIENT_TIMEZONE_ID');
	  ...
	  l_site_profile_id := -1;
	  l_site_profile_code := 'not set';
end if;

print_log('.........l_site_profile_id = '||l_site_profile_id);

print_log('Variable l_site_profile_code....');
print_log('.........l_site_profile_code = '||l_site_profile_code);

print_log('Variable l_client_timezone_user_cnt....');
--Identify the count of Users with Profile CLIENT_TIMEZONE_ID set at USER level
select count(usr.user_name) into l_client_timezone_user_cnt
...
print_log('.........l_client_timezone_user_cnt = '||l_client_timezone_user_cnt);

print_log('Variable l_client_timezone_user_diff....');
--Count of Users with Profile CLIENT_TIMEZONE_ID set a USER level different than SITE
select count(usr.user_name) into l_client_timezone_user_diff
from fnd_profile_options p, fnd_profile_option_values v, fnd_profile_options_tl n, fnd_user usr, fnd_application app, 
fnd_responsibility rsp, fnd_nodes svr, hr_operating_units org 
where v.level_id = '10004' 
and p.profile_option_id = v.profile_option_id (+) 
...
and v.profile_option_value <> (select v.profile_option_value
                               ...
                               and p.profile_option_name = 'CLIENT_TIMEZONE_ID')
and org.organization_id (+) = v.level_value;
print_log('.........l_client_timezone_user_diff = '||l_client_timezone_user_diff);

print_log('Variable l_fnd_native_client_user_cnt....');
--Identify the count of Users with Profile FND_NATIVE_CLIENT_ENCODING set a USER level
select count(usr.user_name) into l_fnd_native_client_user_cnt
from fnd_profile_options p, fnd_profile_option_values v, fnd_profile_options_tl n, fnd_user usr, fnd_application app, 
fnd_responsibility rsp, fnd_nodes svr, hr_operating_units org 
where v.level_id = '10004' 
and p.profile_option_id = v.profile_option_id (+) 
and p.profile_option_name = n.profile_option_name 
and p.profile_option_name = 'FND_NATIVE_CLIENT_ENCODING' 
and usr.user_id (+) = v.level_value 
and n.language = 'US'
and rsp.application_id (+) = v.level_value_application_id 
and rsp.responsibility_id (+) = v.level_value 
...
and svr.node_id (+) = v.level_value 
and org.organization_id (+) = v.level_value;
print_log('.........l_fnd_native_client_user_cnt = '||l_fnd_native_client_user_cnt);

print_log('Variable l_fnd_native_client_user_diff....');
--Count of Users with Profile FND_NATIVE_CLIENT_ENCODING set a USER level different than SITE
select count(usr.user_name) into l_fnd_native_client_user_diff
from fnd_profile_options p, fnd_profile_option_values v, fnd_profile_options_tl n, fnd_user usr, fnd_application app, 
fnd_responsibility rsp, fnd_nodes svr, hr_operating_units org 
where v.level_id = '10004' 
and p.profile_option_id = v.profile_option_id (+) 
...
and v.profile_option_value <> (select v.profile_option_value
                               ...
                               and p.profile_option_name = 'FND_NATIVE_CLIENT_ENCODING')
and org.organization_id (+) = v.level_value;
print_log('.........l_fnd_native_client_user_diff = '||l_fnd_native_client_user_diff);


print_log('Variable l_fnd_native_client_encoding....');
select nvl(v.profile_option_value,'not set') into l_fnd_native_client_encoding
from fnd_profile_options p, fnd_profile_option_values v
where v.level_id = '10001' 
and p.profile_option_id = v.profile_option_id (+)
and p.profile_option_name = 'FND_NATIVE_CLIENT_ENCODING';
print_log('.........l_fnd_native_client_encoding = '||l_fnd_native_client_encoding);


print_log('Variable l_icx_client_iana_user_cnt....');
--Identify the count of Users with Profile ICX_CLIENT_IANA_ENCODING set a USER level
select count(usr.user_name) into l_icx_client_iana_user_cnt
from fnd_profile_options p, fnd_profile_option_values v, fnd_profile_options_tl n, fnd_user usr, fnd_application app, 
fnd_responsibility rsp, fnd_nodes svr, hr_operating_units org 
where v.level_id = '10004' 
and p.profile_option_id = v.profile_option_id (+) 
and p.profile_option_name = n.profile_option_name 
and p.profile_option_name = 'ICX_CLIENT_IANA_ENCODING' 
and usr.user_id (+) = v.level_value 
and n.language = 'US'
and rsp.application_id (+) = v.level_value_application_id 
and rsp.responsibility_id (+) = v.level_value 
...
and svr.node_id (+) = v.level_value 
and org.organization_id (+) = v.level_value;
print_log('.........l_icx_client_iana_user_cnt = '||l_icx_client_iana_user_cnt);

print_log('Variable l_icx_client_iana_user_diff....');
--Count of Users with Profile ICX_CLIENT_IANA_ENCODING set a USER level different than SITE
select count(usr.user_name) into l_icx_client_iana_user_diff
from fnd_profile_options p, fnd_profile_option_values v, fnd_profile_options_tl n, fnd_user usr, fnd_application app, 
fnd_responsibility rsp, fnd_nodes svr, hr_operating_units org 
where v.level_id = '10004' 
and p.profile_option_id = v.profile_option_id (+) 
...
and v.profile_option_value <> (select v.profile_option_value
                               ...
                               and p.profile_option_name = 'ICX_CLIENT_IANA_ENCODING')
and org.organization_id (+) = v.level_value;
print_log('.........l_icx_client_iana_user_diff = '||l_icx_client_iana_user_diff);

print_log('Variable l_icx_date_fmt_mask_user_cnt....');
--Identify the count of Users with Profile ICX_DATE_FORMAT_MASK set a USER level
select count(usr.user_name) into l_icx_date_fmt_mask_user_cnt
from fnd_profile_options p, fnd_profile_option_values v, fnd_profile_options_tl n, fnd_user usr, fnd_application app, 
fnd_responsibility rsp, fnd_nodes svr, hr_operating_units org 
where v.level_id = '10004' 
and p.profile_option_id = v.profile_option_id (+) 
and p.profile_option_name = n.profile_option_name 
and p.profile_option_name = 'ICX_DATE_FORMAT_MASK' 
and usr.user_id (+) = v.level_value 
and n.language = 'US'
and rsp.application_id (+) = v.level_value_application_id 
and rsp.responsibility_id (+) = v.level_value 
...
and svr.node_id (+) = v.level_value 
and org.organization_id (+) = v.level_value;
print_log('.........l_icx_date_fmt_mask_user_cnt = '||l_icx_date_fmt_mask_user_cnt);

print_log('Variable l_icx_date_fmt_mask_user_diff....');
--Count of Users with Profile ICX_DATE_FORMAT_MASK set a USER level different than SITE
select count(usr.user_name) into l_icx_date_fmt_mask_user_diff
from fnd_profile_options p, fnd_profile_option_values v, fnd_profile_options_tl n, fnd_user usr, fnd_application app, 
fnd_responsibility rsp, fnd_nodes svr, hr_operating_units org 
where v.level_id = '10004' 
and p.profile_option_id = v.profile_option_id (+) 
...
and v.profile_option_value <> (select v.profile_option_value
                               ...
                               and p.profile_option_name = 'ICX_DATE_FORMAT_MASK')
and org.organization_id (+) = v.level_value;
print_log('.........l_icx_date_fmt_mask_user_diff = '||l_icx_date_fmt_mask_user_diff);

print_log('Variable l_icx_date_lang_user_cnt....');
--Identify the count of Users with Profile ICX_DATE_LANGUAGE set a USER level
select count(usr.user_name) into l_icx_date_lang_user_cnt
from fnd_profile_options p, fnd_profile_option_values v, fnd_profile_options_tl n, fnd_user usr, fnd_application app, 
fnd_responsibility rsp, fnd_nodes svr, hr_operating_units org 
where v.level_id = '10004' 
and p.profile_option_id = v.profile_option_id (+) 
and p.profile_option_name = n.profile_option_name 
and p.profile_option_name = 'ICX_DATE_LANGUAGE' 
and usr.user_id (+) = v.level_value 
and n.language = 'US'
and rsp.application_id (+) = v.level_value_application_id 
and rsp.responsibility_id (+) = v.level_value 
...
and svr.node_id (+) = v.level_value 
and org.organization_id (+) = v.level_value;
print_log('.........l_icx_date_lang_user_cnt = '||l_icx_date_lang_user_cnt);

print_log('Variable l_icx_date_lang_user_diff....');
--Count of Users with Profile ICX_DATE_LANGUAGE set a USER level different than SITE
select count(usr.user_name) into l_icx_date_lang_user_diff
from fnd_profile_options p, fnd_profile_option_values v, fnd_profile_options_tl n, fnd_user usr, fnd_application app, 
fnd_responsibility rsp, fnd_nodes svr, hr_operating_units org 
where v.level_id = '10004' 
and p.profile_option_id = v.profile_option_id (+) 
...
and v.profile_option_value <> (select v.profile_option_value
                               ...
                               and p.profile_option_name = 'ICX_DATE_LANGUAGE')
and org.organization_id (+) = v.level_value;
print_log('.........l_icx_date_lang_user_diff = '||l_icx_date_lang_user_diff);

print_log('Variable l_icx_nls_sort_user_cnt....');
--Identify the count of Users with Profile ICX_NLS_SORT set a USER level
select count(usr.user_name) into l_icx_nls_sort_user_cnt
from fnd_profile_options p, fnd_profile_option_values v, fnd_profile_options_tl n, fnd_user usr, fnd_application app, 
fnd_responsibility rsp, fnd_nodes svr, hr_operating_units org 
where v.level_id = '10004' 
and p.profile_option_id = v.profile_option_id (+) 
and p.profile_option_name = n.profile_option_name 
and p.profile_option_name = 'ICX_NLS_SORT' 
and usr.user_id (+) = v.level_value 
and n.language = 'US'
and rsp.application_id (+) = v.level_value_application_id 
and rsp.responsibility_id (+) = v.level_value 
...
and svr.node_id (+) = v.level_value 
and org.organization_id (+) = v.level_value;
print_log('.........l_icx_nls_sort_user_cnt = '||l_icx_nls_sort_user_cnt);

print_log('Variable l_icx_nls_sort_user_diff....');
--Count of Users with Profile ICX_NLS_SORT set a USER level different than SITE
select count(usr.user_name) into l_icx_nls_sort_user_diff
from fnd_profile_options p, fnd_profile_option_values v, fnd_profile_options_tl n, fnd_user usr, fnd_application app, 
fnd_responsibility rsp, fnd_nodes svr, hr_operating_units org 
where v.level_id = '10004' 
and p.profile_option_id = v.profile_option_id (+) 
...
and v.profile_option_value <> (select v.profile_option_value
                               ...
                               and p.profile_option_name = 'ICX_NLS_SORT')
and org.organization_id (+) = v.level_value;
print_log('.........l_icx_nls_sort_user_diff = '||l_icx_nls_sort_user_diff);

print_log('Variable l_icx_num_char_user_cnt....');
--Identify the count of Users with Profile ICX_NUMERIC_CHARACTERS set a USER level
select count(usr.user_name) into l_icx_num_char_user_cnt
from fnd_profile_options p, fnd_profile_option_values v, fnd_profile_options_tl n, fnd_user usr, fnd_application app, 
fnd_responsibility rsp, fnd_nodes svr, hr_operating_units org 
where v.level_id = '10004' 
and p.profile_option_id = v.profile_option_id (+) 
...
and svr.node_id (+) = v.level_value 
and org.organization_id (+) = v.level_value;
print_log('.........l_icx_num_char_user_cnt = '||l_icx_num_char_user_cnt);

print_log('Variable l_icx_num_char_user_diff....');
--Count of Users with Profile ICX_NUMERIC_CHARACTERS set a USER level different than SITE
select count(usr.user_name) into l_icx_num_char_user_diff
from fnd_profile_options p, fnd_profile_option_values v, fnd_profile_options_tl n, fnd_user usr, fnd_application app, 
fnd_responsibility rsp, fnd_nodes svr, hr_operating_units org 
where v.level_id = '10004' 
and p.profile_option_id = v.profile_option_id (+) 
...
and v.profile_option_value <> (select v.profile_option_value
                               ...
                               and p.profile_option_name = 'ICX_NUMERIC_CHARACTERS')
and org.organization_id (+) = v.level_value;
print_log('.........l_icx_num_char_user_diff = '||l_icx_num_char_user_diff);

print_log('Variable l_icx_pref_currency_user_cnt....');
--Identify the count of Users with Profile ICX_PREFERRED_CURRENCY set a USER level
select count(usr.user_name) into l_icx_pref_currency_user_cnt
from fnd_profile_options p, fnd_profile_option_values v, fnd_profile_options_tl n, fnd_user usr, fnd_application app, 
fnd_responsibility rsp, fnd_nodes svr, hr_operating_units org 
where v.level_id = '10004' 
and p.profile_option_id = v.profile_option_id (+) 
and p.profile_option_name = n.profile_option_name 
and p.profile_option_name = 'ICX_PREFERRED_CURRENCY' 
and usr.user_id (+) = v.level_value 
and n.language = 'US'
and rsp.application_id (+) = v.level_value_application_id 
and rsp.responsibility_id (+) = v.level_value 
...
and svr.node_id (+) = v.level_value 
and org.organization_id (+) = v.level_value;
print_log('.........l_icx_pref_currency_user_cnt = '||l_icx_pref_currency_user_cnt);

print_log('Variable l_icx_pref_currency_user_diff....');
--Count of Users with Profile ICX_PREFERRED_CURRENCY set a USER level different than SITE
select count(usr.user_name) into l_icx_pref_currency_user_diff
from fnd_profile_options p, fnd_profile_option_values v, fnd_profile_options_tl n, fnd_user usr, fnd_application app, 
fnd_responsibility rsp, fnd_nodes svr, hr_operating_units org 
where v.level_id = '10004' 
and p.profile_option_id = v.profile_option_id (+) 
...
and v.profile_option_value <> (select v.profile_option_value
                               ...
                               and p.profile_option_name = 'ICX_PREFERRED_CURRENCY')
and org.organization_id (+) = v.level_value;
print_log('.........l_icx_pref_currency_user_diff = '||l_icx_pref_currency_user_diff);

print_log('Variable l_icx_territory_user_cnt....');
--Identify the count of Users with Profile ICX_TERRITORY set a USER level
select count(usr.user_name) into l_icx_territory_user_cnt
from fnd_profile_options p, fnd_profile_option_values v, fnd_profile_options_tl n, fnd_user usr, fnd_application app, 
fnd_responsibility rsp, fnd_nodes svr, hr_operating_units org 
where v.level_id = '10004' 
and p.profile_option_id = v.profile_option_id (+) 
and p.profile_option_name = n.profile_option_name 
and p.profile_option_name = 'ICX_TERRITORY' 
and usr.user_id (+) = v.level_value 
and n.language = 'US'
and rsp.application_id (+) = v.level_value_application_id 
and rsp.responsibility_id (+) = v.level_value 
...
and svr.node_id (+) = v.level_value 
and org.organization_id (+) = v.level_value;
print_log('.........l_icx_territory_user_cnt = '||l_icx_territory_user_cnt);

print_log('Variable l_icx_territory_user_diff....');
--Count of Users with Profile ICX_TERRITORY set a USER level different than SITE
select count(usr.user_name) into l_icx_territory_user_diff
from fnd_profile_options p, fnd_profile_option_values v, fnd_profile_options_tl n, fnd_user usr, fnd_application app, 
fnd_responsibility rsp, fnd_nodes svr, hr_operating_units org 
where v.level_id = '10004' 
and p.profile_option_id = v.profile_option_id (+) 
...
and v.profile_option_value <> (select v.profile_option_value
                               ...
                               and p.profile_option_name = 'ICX_TERRITORY')
and org.organization_id (+) = v.level_value;
print_log('.........l_icx_territory_user_diff = '||l_icx_territory_user_diff);

print_log('Variable l_lang_cnt....');
SELECT nvl(max(rownum),0) into l_lang_cnt FROM FND_LANGUAGES where INSTALLED_FLAG in ('B','I');
print_log('.........l_lang_cnt = '||l_lang_cnt);

print_log('Variable l_base_lang....');
SELECT language_code into l_base_lang FROM FND_LANGUAGES where INSTALLED_FLAG = 'B';
print_log('.........l_base_lang = '||l_base_lang);

if l_lang_cnt > 2 then 
	l_lang_code := 'MLS';
...
print_log('Variable l_menus_not_synch....');
select nvl(max(rownum),0) into l_menus_not_synch from (
select language "INSTALLED LANGUAGES", count(MENU_ID) "MENU COUNTS", (select count(MENU_ID) from FND_MENUS_TL
where language = (SELECT language_code FROM FND_LANGUAGES where INSTALLED_FLAG = 'B')) "BASE LANGUAGE MENU COUNT"
from FND_MENUS_TL
where language in (SELECT language_code FROM FND_LANGUAGES where INSTALLED_FLAG in ('B','I'))
group by language)
where ("MENU COUNTS" < "BASE LANGUAGE MENU COUNT");
print_log('.........l_menus_not_synch = '||l_menus_not_synch);
...
g_snap_days := snap_days;
g_global_update_date :=global_update_date;
g_db_charset := db_charset;
g_instance := l_instance;

g_site_profile_id := l_site_profile_id;
g_site_profile_code := l_site_profile_code;
g_client_timezone_user_cnt := l_client_timezone_user_cnt;
g_client_timezone_user_diff := l_client_timezone_user_diff;
g_fnd_native_client_user_cnt := l_fnd_native_client_user_cnt;
g_fnd_native_client_user_diff := l_fnd_native_client_user_diff;
g_fnd_native_client_encoding := l_fnd_native_client_encoding;
g_icx_client_iana_user_cnt := l_icx_client_iana_user_cnt;
g_icx_client_iana_user_diff := l_icx_client_iana_user_diff;
g_icx_date_fmt_mask_user_cnt := l_icx_date_fmt_mask_user_cnt;
g_icx_date_fmt_mask_user_diff := l_icx_date_fmt_mask_user_diff;
g_icx_date_lang_user_cnt := l_icx_date_lang_user_cnt;
g_icx_date_lang_user_diff := l_icx_date_lang_user_diff;
g_icx_nls_sort_user_cnt := l_icx_nls_sort_user_cnt;
g_icx_nls_sort_user_diff := l_icx_nls_sort_user_diff;
g_icx_num_char_user_cnt := l_icx_num_char_user_cnt;
g_icx_num_char_user_diff := l_icx_num_char_user_diff;
g_icx_pref_currency_user_cnt := l_icx_pref_currency_user_cnt;
g_icx_pref_currency_user_diff := l_icx_pref_currency_user_diff;
g_icx_territory_user_cnt := l_icx_territory_user_cnt;
g_icx_territory_user_diff := l_icx_territory_user_diff;
g_menus_not_synch := l_menus_not_synch;
g_lang_cnt := l_lang_cnt;
g_lang_code := l_lang_code;
g_base_lang := l_base_lang;
...
print_log('Variable Settings');
print_log('   l_dbversion	= '||l_dbversion);
print_log('   g_db_version	= '||g_db_version);
print_log('   snap_days = '||snap_days);
print_log('   db_charset = '||g_db_charset);
print_log('   global_update_date = '||global_update_date);
print_log('   g_instance = '||g_instance);
print_log('   g_site_profile_id = '||g_site_profile_id);
print_log('   g_site_profile_code = '||l_site_profile_code);
print_log('   g_client_timezone_user_cnt = '||g_client_timezone_user_cnt);
print_log('   g_client_timezone_user_diff = '||g_client_timezone_user_diff);
print_log('   g_fnd_native_client_user_cnt = '||g_fnd_native_client_user_cnt);	
print_log('   g_fnd_native_client_user_diff = '||g_fnd_native_client_user_diff);
print_log('   g_fnd_native_client_encoding = '||g_fnd_native_client_encoding);	
print_log('   g_icx_client_iana_user_cnt = '||g_icx_client_iana_user_cnt);	
print_log('   g_icx_client_iana_user_diff = '||g_icx_client_iana_user_diff);	
print_log('   g_icx_date_fmt_mask_user_cnt = '||g_icx_date_fmt_mask_user_cnt);	
print_log('   g_icx_date_fmt_mask_user_diff = '||g_icx_date_fmt_mask_user_diff);
print_log('   g_icx_date_lang_user_cnt = '||g_icx_date_lang_user_cnt);	
print_log('   g_icx_date_lang_user_diff = '||g_icx_date_lang_user_diff);	
print_log('   g_icx_nls_sort_user_cnt = '||g_icx_nls_sort_user_cnt);		
print_log('   g_icx_nls_sort_user_diff = '||g_icx_nls_sort_user_diff);	
print_log('   g_icx_num_char_user_cnt = '||g_icx_num_char_user_cnt);		
print_log('   g_icx_num_char_user_diff = '||g_icx_num_char_user_diff);	
print_log('   g_icx_pref_currency_user_cnt = '||g_icx_pref_currency_user_cnt);	
print_log('   g_icx_pref_currency_user_diff = '||g_icx_pref_currency_user_diff);	
print_log('   g_icx_territory_user_cnt = '||g_icx_territory_user_cnt);	
print_log('   g_icx_territory_user_diff = '||g_icx_territory_user_diff);
print_log('   g_menus_not_synch = '||g_menus_not_synch);
print_log('   g_lang_cnt = '||g_lang_cnt);
print_log('   g_lang_code = '||g_lang_code);
...
debug('begin add_signature: EBS_ATG_CT_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23217',
      p_sig_id                 => 'EBS_ATG_CT_VERSIONS',
      p_sig_sql                => 'select ''01. EBS Instance : ''|| upper(INSTANCE_NAME) "Instance Summary" from V$INSTANCE
union
select ''02. EBS Release : ''|| RELEASE_NAME from FND_PRODUCT_GROUPS
union
select ''03. EBS Host Name : ''|| HOST_NAME from V$INSTANCE
union
select ''04. EBS Instance Creation Date : '' || CREATED from V$DATABASE
union
select ''05. EBS Database Version : '||mask_text(g_db_version, nvl( upper(''), 'NO_MASK') )||''' from dual
union
select ''06. Database Role : '' || INSTANCE_ROLE from V$INSTANCE
union
select ''07. EBS OS Platform : '' || SUBSTR(REPLACE(REPLACE(pcv1.product, ''TNS for ''), '':'' )||pcv2.status, 1, 80)
...
union
select ''08. Database Language : '' || VALUE from V$NLS_PARAMETERS where PARAMETER = ''NLS_LANGUAGE''
union
select ''09. Database Character Set : '' || VALUE from V$NLS_PARAMETERS where PARAMETER = ''NLS_CHARACTERSET''
union
SELECT ''10. EBS Multi Org enabled : '' || MULTI_ORG_FLAG from FND_PRODUCT_GROUPS
union
SELECT ''11. EBS Multi Currency enabled : '' || MULTI_CURRENCY_FLAG from FND_PRODUCT_GROUPS',
      p_title                  => 'Instance Overview',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The SQL select(s) did not return any value.',
      p_solution               => 'Please ensure that the Database and the Database-Listener is up and running.<br>
Additionally ensure that the EBS Middle-Tier OS Environment has been sourced and that the binary <i>sqlplus</i> is findable.',
      p_success_msg            => 'NLS Related Instance Overview<br>
Overview of the E-Business Suite (EBS) settings for Instance '||mask_text(g_instance, nvl( upper(''), 'NO_MASK') )||', which are important from a National Language Support (NLS) or Multi-Language Support (MLS) point of view.<br>Note: Throughout this Analyzer Report, we refer to NLS or MLS setups alike as simply NLS for readability.  ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_ATG_CT_VERSIONS');



debug('begin add_signature: ATG_PRODUCTS_INSTALLED2');
   l_info('##COMPLEX_TYPE##'):= 'I';
  add_signature(
      p_sig_repo_id            => '4103',
      p_sig_id                 => 'ATG_PRODUCTS_INSTALLED2',
...
AND t.language = ''US'' AND l.language = ''US'' order by upper(t.application_name)',
      p_title                  => 'E- Business Suite Products installed',
      p_fail_condition         => 'NRS',
      p_problem_descr          => '<b>The SQL select(s) did not return any value !</b>',
      ...
      p_success_msg            => '<h4>Overview of all E-Business Suite products installed on '||upper(g_rep_info('Instance'))||' including SHARED or FULL INSTALLED status.</h4>
Review the Installation Status of all EBS Products above.<br>
If you have installed one or more non-US languages, please refer to :
<ul>
<li>[405992/KB846427] - "Oracle Applications Release 12.2, 12.1 & Release 12.0 Translation Scope and Availability"</li>
</ul>to see which Products are translated into your local language(s).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: ATG_PRODUCTS_INSTALLED2');



debug('begin add_signature: atg_lang_installed');
   l_info('##COMPLEX_TYPE##'):= 'I';
  add_signature(
      p_sig_repo_id            => '3746',
      p_sig_id                 => 'atg_lang_installed',
      p_sig_sql                => 'SELECT rpad(language_code, 30, '' '') "Language Code ",
rpad(decode(INSTALLED_FLAG ,''B'',''Base Language'',''I'',''Installed Language'',''D'',''Not Installed''), 30, '' '') " Type ",
rpad(nls_language, 30, '' '') " Language ",
rpad(nls_territory, 30, '' '') " Territory "
FROM FND_LANGUAGES
where INSTALLED_FLAG in (''B'',''I'')
order by INSTALLED_FLAG, LANGUAGE_CODE',
      p_title                  => g_lang_code||' Languages installed',
      p_fail_condition         => 'NRS',
      p_problem_descr          => '<b>The SQL select(s) did not return any value !</b>',
      p_solution               => 'Please ensure that the Database and the Database-Listener is up and running. Additionally ensure that the EBS Middle-Tier OS Environment has been sourced and that the binary <i>sqlplus</i> is findable.',
      p_success_msg            => '<h4>Overview of '||g_lang_cnt||' installed languages including the base "'||g_base_lang||'" language</h4>
For more information on National Language Support (NLS) or Multi-Language Support (MLS) and how to install it, please have a look into following documents:<br>
<ul>
<li>[1314621/KB852244] - "Oracle E-Business Suite NLS Release Notes, Release 12.2"</li>
<li>[405992/KB846427] - "Oracle Applications Release 12.2, 12.1 & Release 12.0 Translation Scope and Availability"</li>
<li>[412218/KB842633] - "Oracle Applications Release 12 Product Level Software Translation Matrix"</li>
<li>[969716/KB781305] - "Oracle Applications Release 12 Product Level Online Help Translation Matrix"</li>
<li>[393861/KB856469] - "Globalization Guide for Oracle Applications Release 12"</li>
<li>[314411/KB813768] - "Translation Scope for Oracle Applications Release 11i Software"</li>
<li>[185637/KB725609] - "Oracle Applications 11i Translation Scope and Availability"</li>
</ul>',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','I'),
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: atg_lang_installed');



debug('begin add_signature: ATG_NLS_DB_PARAMETERS2');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4241',
      p_sig_id                 => 'ATG_NLS_DB_PARAMETERS2',
      p_sig_sql                => 'select parameter, value from NLS_DATABASE_PARAMETERS order by PARAMETER',
      p_title                  => 'NLS_DATABASE_PARAMETERS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => '<b>The SQL select(s) did not return any value !</b>',
      p_solution               => 'Please ensure that the Database and the Database-Listener is up and running. Additionally ensure that the EBS Middle-Tier OS Environment has been sourced and that the binary <i>sqlplus</i> is findable.<br>
For further details around the EBS Database, please see following documents:<br>
<ul>
<li>[11158187/KA1002] - "Database Initialization Parameters for Oracle E-Business Suite Release 12"</li>
<li>[393861/KB856469] - "Globalization Guide for Oracle Applications Release 12 - Installing area"</li>
</ul>',
      p_success_msg            => '<h4>Overview of the NLS related Database Parameter Settings</h4>
These are the NLS settings that were used during database creation time!<br>
If there were parameters set in the init.ora during database creation you see them here. <br>
These are always defaulting to AMERICAN AMERICA if there were no parameters explicitly set in the init.ora during database creation time.<br><br>

There is no way to change these settings after database creation (except the NLS_(NCHAR)_CHARACTERSET). <br>
Do NOT update system tables to change these values!<br><br>

These settings are used to give the database a default if the INSTANCE and SESSION parameters are not set.<br>
Since NLS_INSTANCE_PARAMETERS and NLS_SESSION_PARAMETERS take precedence this is not a problem at all and changing them is not needed.<br><br>

In other words, if you have an application that requires that a certain NLS setting need to be set "on database level" and it is seen in NLS_INSTANCE_PARAMETERS then all is fine even if the value in NLS_DATABASE_PARAMETERS is different, there is NO need to "see" this also in NLS_DATABASE_PARAMETERS.<br><br>

Other points that are good to know:<br>

* These parameters are "overruled" by NLS_INSTANCE_PARAMETERS and NLS_SESSION_PARAMETERS. The only exceptions are the NLS_CHARACTERSET and NLS_NCHAR_CHARACTERSET settings.<br>

* A real "create database" is needed to set the NLS_DATABASE_PARAMETERS, when using the DBCA and a "seed" database (=template has "includes datafiles" set to YES in page 2 of the DBCA) then the NLS_DATABASE_PARAMETERS will be AMERICAN AMERICA since this is actually a clone operation of a existing database (who is using AMERICAN AMERICA), not a real "create database". Since NLS_INSTANCE_PARAMETERS takes precedence, this is not a problem at all and simply irrelevant.<br>
To define the NLS_DATABASE_PARAMETERS using DBCA choose a template that has "includes datafiles" set to NO in page 2 of the DBCA and in step 9 click on "all initialization parameters" and then "show advanced parameters", there you can then set NLS_SORT, NLS_LANGUAGE, etc for the NLS DATABASE PARAMETERS.<br>

* NLS_LANG is not an init.ora parameter, NLS_LANGUAGE and NLS_TERRITORY are.  NLS_LANGUAGE and NLS_TERRITORY need to be set separately.<br>

* the <clients characterset> or NLS_LANG is NOT defined in the init.ora , the clients characterset is defined by the NLS_LANG on client side (see above).<br>

* the database characterset is NOT defined in the init.ora. The database (national) characterset (NLS_(NCHAR)_CHARACTERSET) is defined by the "Create Database ..." command.<br>

* The NLS_CHARACTERSET and NLS_NCHAR_CHARACTERSET parameters cannot be overruled by instance or session parameters. They are defined by the value specified in "create database ..." and are not intended to be changed afterwards dynamically. See [225912/KB109438] - Changing the Database Character Set (NLS_CHARACTERSET), if you want to change the database characterset. Do NOT update system tables like <b>props$</b> to change the characterset.<br>

* Setting the NLS_LANG during the creation of the database does not influence the NLS_DATABASE_PARAMETERS or the NLS_(NCHAR)_CHARACTERSET.<br>

* NLS_DATABASE_PARAMETERS are used in evaluation of CHECK constraints if TO_CHAR/TO_DATE without a date format is used in the CHECK condition. Writing CHECK constraints without explicit date formats is a bad habit, you should use explicit formats and this setting becomes irrelevant.<br><br>
For further details around the EBS Database, please see following documents:<br>
<ul>
<li>[11158187/KA1002] - "Database Initialization Parameters for Oracle E-Business Suite Release 12"</li>
<li>[393861/KB856469] - "Globalization Guide for Oracle Applications Release 12 - Installing area"</li>
   ...
   l_info.delete;
debug('end add_signature: ATG_NLS_DB_PARAMETERS2');



debug('begin add_signature: ATG_NLS_SESSION_PARAMETERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4239',
      p_sig_id                 => 'ATG_NLS_SESSION_PARAMETERS',
      p_sig_sql                => 'select parameter, value from NLS_SESSION_PARAMETERS',
      p_title                  => 'NLS_SESSION_PARAMETERS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No rows found identifying NLS_SESSION_PARAMETERS',
      p_solution               => 'Please check the table NLS_SESSION_PARAMETERS',
      p_success_msg            => 'These are the settings used for the current sql session. <br>
The value in NLS_SESSION_PARAMETERS is the one used.<br>NLS_SESSION_PARAMETERS values take precedence over the values (for the same parameter) in NLS_DATABASE_PARAMETERS or NLS_INSTANCE_PARAMETERS.<br><br>

In other words, this is session specific, if you connect from one client (like sqlplus on the server) and do this select then this does NOT mean these values will be used for OTHER clients.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ATG_NLS_SESSION_PARAMETERS');



debug('begin add_signature: atg_nls_lightweight_languages');
   l_info('##COMPLEX_TYPE##'):= 'W';
  add_signature(
      p_sig_repo_id            => '3672',
      p_sig_id                 => 'atg_nls_lightweight_languages',
      p_sig_sql                => 'select profile_option_value
from fnd_profile_options fpo, fnd_profile_option_values fpov
where fpo.profile_option_name = ''FND_LTWGT_LANGUAGES''
and fpov.profile_option_id = fpo.profile_option_id',
      p_title                  => 'Check for Lightweight MLS Languages Installed',
      p_fail_condition         => 'RS',
      p_problem_descr          => '<b>Attention!!</b><br>
There are Lightweight MLS Languages installed on this '||g_rep_info('Apps Version')||' instance.',
      p_solution               => 'Please be aware of the steps involved when using Lightweight Languages.<br><br>
The current MLS architecture always requires customers to apply NLS patches for enabled languages, regardless of  the way the MLS environment is being utilized. Common usages include MLS reporting and MLS data entry (especially for reporting). Translations (via a patch) are often not required, and having to apply an NLS patch in such circumstances incurs a needless cost in terms of maintenance efforts and downtime, as well as disk space requirements.<br><br>

To address these requirements, especially for MLS reporting and MLS data entry without application of an NLS patch, customers on Oracle E-Business Suite Release 12.1.3 and higher can utilize a Lightweight MLS environment.<br><br>

Key features of this environment include:
<ul>
<li>The capability to enable a language without applying an NLS patch. Specifically:</li>
<ul>
  <li>A new language only needs to be activated via OAM and then adadmins Maintain MLS Table option. All that is required after that is to restart the application tier services: no NLS patches need to be applied.</li>
  <li>Any language already supported by Oracle E-Business Suite can be activated in this way. For a full list of supported languages including Lightweight-only languages, see Appendix B of My Oracle Support Knowledge [393861/KB856469] - <i>Globalization Guide for Oracle Applications Release 12.</i></li>
  <li>The same Oracle E-Business Suite system can simultaneously support a mixture of languages with full translation (NLS patches applied) and languages without translation (Lightweight MLS, with no NLS patches applied).</li>
</ul>
<li>The capability to enter and maintain language data via an English user interface; for example, setup data or customer data such as item or item description. Specifically:</li>
<ul>
  <li>The UI is in English, while the setup or customer data are shown in the relevant language.</li>
  <li>Loaders such as FNDLOAD can be used to enter and maintain language data. This is more useful for setup data than transaction or customer data.</li>
  <li>The Oracle Forms "globe" icon can be also used to enter language data.</li>
</ul>
  <li>The capability to prepare and set up custom reports or templates, and then generate language reports with the language data entered.</li>
  <li>Elimination of the management overhead and system downtime associated with applying NLS translation patches.</li>
  <li>Reduction of disk space used for translation, and hence simplification of backup procedures.</li>
  <li>The capability to move to a full translation any time, by applying the relevant NLS patch.	  </li>
</ul>
Review [1077709/KB856434] - Using Lightweight MLS With Oracle E-Business Suite Release 12.1.3 and higher for more details.',
      p_success_msg            => 'There are no Lightweight MLS languages installed in this '||g_rep_info('Apps Version')||' instance.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: atg_nls_lightweight_languages');



debug('begin add_signature: NLS_ORA_NLS10');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15225',
      p_sig_id                 => 'NLS_ORA_NLS10',
      p_sig_sql                => 'select
   decode(to_char(to_date(''2020-08-10'', ''RRRR-MM-DD''), ''MON'', ''NLS_DATE_LANGUAGE = JAPANESE''),
   ''AUG'', ''OK'', ''NOT OK'') status
from dual',
      p_title                  => 'Verify ORA_NLS10',
      p_fail_condition         => '[STATUS]=[NOT OK]',
      p_problem_descr          => 'ORA_NLS10 is not properly set or not pointing to 9i resources. ',
      p_solution               => 'Please follow [292942/KB857645#aref_section34] Section 4 - How to use the "9i behavior" definitions, to properly set ORA_NLS10 or correctly point to 9i resources.<br>
It is required to set ORA_NLS10 pointing to 9i resource to display data format correctly in some languages.',
      p_success_msg            => 'ORA_NLS10 is properly set or pointing to 9i resources.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: NLS_ORA_NLS10');



debug('begin add_signature: atg_nls_profile_options3');
   l_info('##COMPLEX_TYPE##'):= 'I';
  add_signature(
      p_sig_repo_id            => '3747',
      p_sig_id                 => 'atg_nls_profile_options3',
      p_sig_sql                => 'select p.profile_option_name as Name, n.language as LANG, n.user_profile_option_name as Translation,
decode(v.level_id,10001,''Site'',10002,''Application'',10003,''Responsibility'',10004,''User'',10005,''Server'',10006,''Organization'',10007,''ServResp'',''Undefined'') as LEVEL_SET, 
v.profile_option_value as VALUE, p.APP_ENABLED_FLAG as APP, p.SITE_ENABLED_FLAG as SITE, p.RESP_ENABLED_FLAG as RESP, p.USER_ENABLED_FLAG as USR
 from 
...
where
  v.level_id = ''10001''
  and n.language = '''||g_base_lang||'''
  and p.profile_option_id = v.profile_option_id (+)
  and p.profile_option_name = n.profile_option_name
  and n.profile_option_name in 
    (''ICX_TERRITORY'',
    ...
    ''CLIENT_TIMEZONE_ID'',
    ''SERVER_TIMEZONE_ID'',
    ''FND_FORMS_USER_CALENDAR'',
    ''FND_CALENDAR_WEEK_START_DAY'',
  ...
  and svr.node_id (+) = v.level_value
  and org.organization_id (+) = v.level_value
order by n.profile_option_name,v.level_id',
      p_title                  => 'NLS MLS related Profile Options',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is a problem displaying the NLS related Profile Options',
      p_solution               => 'In Oracle Applications, a users session can be influenced by a number of profile options, such as their timezone, date display formats, and behavior.<br>
Administrators should review the following NLS related profile options below where users can override what is currently set at the Site level. <br><br>

Administrators can access these values in either of these two paths:<br>
<ul>
  <li>Functional Administrator responsibility: Core Services > Profiles web page</li>
  <li>System Administrator responsibility: Profile > System Form</li>
</ul>
<b>Attention:</b><br>
In the Profiles below, we display the profile Options flags to indicate on which level the Profile Option can be overwritten.<br>
For more information, please review http://oracleapplicationstechfunc.blogspot.com/2017/04/nlsmls-in-oracle-apps.html.',
      p_success_msg            => 'In Oracle Applications, a users session can be influenced by a number of profile options, such as their timezone, date display formats, and behavior.<br>
Administrators should review the following NLS related profile options below where users can override what is currently set at the Site level. <br><br>
...
In the Profiles below, we display the profile Options flags to indicate on which level the Profile Option can be overwritten.<br>',
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: atg_nls_profile_options3');



debug('begin add_signature: atg_nls_profile_SERVER_TIMEZONE_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1077',
      p_sig_id                 => 'atg_nls_profile_SERVER_TIMEZONE_ID',
      p_sig_sql                => 'select ''(''||language||'')-''||n.user_profile_option_name Profilename,
...
v.profile_option_value "Timezone ID"
from
fnd_profile_options p,fnd_profile_option_values v,fnd_profile_options_tl n,fnd_user usr,fnd_application app,fnd_responsibility rsp,fnd_nodes svr,hr_operating_units org
where
v.level_id in (''10001'',''10002'',''10003'',''10005'',''10006'',''10007'')
and p.profile_option_id = v.profile_option_id (+)
and p.profile_option_name = n.profile_option_name
and p.profile_option_name = ''SERVER_TIMEZONE_ID''
and n.language = ''US''
and usr.user_id (+) = v.level_value
and rsp.application_id (+) = v.level_value_application_id
and rsp.responsibility_id (+) = v.level_value
...
order by name, v.level_id',
      p_title                  => 'Profile Option <b>Server Timezone</b>',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The <i>Server Timezone</i> is not set on your Instance !',
      p_solution               => 'The Server Timezone has to be set on Site level dependent on the timezone setting of the Database-Tier. Please refer to
<ul>
<li>[402650/KB711359] - "User-Preferred Time Zone Support in Oracle E-Business Suite Release 12" - Step 2.1 ''Timezone Concept and Examples''.</li>
</ul>',
      p_success_msg            => 'This setting is available to administrators only, and cannot be overridden by the user at the session level in the Preferences page.<br> Time zones in Oracle Applications are handled by the database tier.<br>
Please see
<ul>
<li>[393861/KB856469] - "Globalization Guide for Oracle Applications Release 12" for further information around NLS and global settings.</li>
</ul>',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: atg_nls_profile_SERVER_TIMEZONE_ID');



debug('begin add_signature: atg_nls_profiles_FND_NATIVE_CLIENT_ENCODING2');
   l_info('##COMPLEX_TYPE##'):= 'E';
  add_signature(
      p_sig_repo_id            => '3570',
      p_sig_id                 => 'atg_nls_profiles_FND_NATIVE_CLIENT_ENCODING2',
      p_sig_sql                => 'select p.profile_option_name as Profilename, n.language as LANG, n.user_profile_option_name as Translation,
decode(v.level_id,10001,''Site'',10002,''Application'',10003,''Responsibility'',10004,''User'') as LEVEL_SET,
v.profile_option_value as VALUE, --(select timezone_code from fnd_timezones_b where upgrade_tz_id=profile_option_value) as Timezone,
p.APP_ENABLED_FLAG as APP, p.SITE_ENABLED_FLAG as SITE, p.RESP_ENABLED_FLAG as RESP, p.USER_ENABLED_FLAG as USR
from 
fnd_profile_options p,
fnd_profile_option_values v,
fnd_profile_options_tl n,
...
hr_operating_units org
where
v.level_id in (''10001'',''10002'',''10003'')
and p.USER_UPDATE_ALLOWED_FLAG = ''Y''
and p.profile_option_id = v.profile_option_id (+)
and p.profile_option_name = n.profile_option_name
and n.profile_option_name = ''FND_NATIVE_CLIENT_ENCODING''
and n.language = ''US''
and rsp.application_id (+) = v.level_value_application_id
and rsp.responsibility_id (+) = v.level_value
and app.application_id (+) = v.level_value
and svr.node_id (+) = v.level_value
and org.organization_id (+) = v.level_value
order by n.profile_option_name,v.level_id, n.language',
      p_title                  => 'Profile Option <b>FND: Native Client Encoding</b>',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The <i>FND: Native Client Encoding</i> Profile is not set at the Site level !',
      p_solution               => 'The <b><i>FND: Native Client Encoding</i></b> Profile indicates the character set that a client machine uses as its
native character set.<br> The value must be one of the Oracle character sets and should correspond to the client native character set. The character set used in a client machine varies depending on language and platform.<br>
This profile option is used when storing text data. When a user uploads text files as attachments, the current value of FND: Native Client Encoding is stored along with the text data. With the value of this profile option, the server can then convert the text data to another character set as necessary when the text data is downloaded.<br><br>
For Confidentiality, we are only presenting the Site, Application and Responsibility levels in this report where appropriate. <br><font color="#FF0000">There are '||g_fnd_native_client_user_cnt||' Users that have this profile set at the User Level, of which '||g_fnd_native_client_user_diff||' are different than the SITE level setting of</font> <b>'||g_site_profile_code||'</b>, so if you want to see a detailed list of these Users and their USER level settings, please run following select statement as APPS :<br>
<blockquote>
<code>...<br>
select ''(''||language||'') - ''||n.user_profile_option_name Profilename, usr.user_id, <br>
decode(v.level_id,10001,''Site'',10002,''Application'',10003,''Responsibility'',10004,''User'',10005,''Server'',10006,''Organization'',10007,''ServResp'', ''Undefined'') "LEVEL", <br>
decode(to_char(v.level_id),''10001'', '' '',''10002'', app.application_short_name,''10003'', rsp.responsibility_key,''10004'', usr.user_name,''10005'', svr.node_name,''10006'', org.name,''10007'', <br>
(select n.node_name from fnd_nodes n where n.node_id=level_value2)||''/''||(decode(to_char(v.level_value), -1,''Default'', <br>
(select responsibility_key from fnd_responsibility where responsibility_id=level_value))), v.level_id) "User Name", <br>
FND_PROFILE.VALUE_SPECIFIC(''FND_NATIVE_CLIENT_ENCODING'',usr.user_id) "FND_NATIVE_CLIENT_ENCODING"<br>
from fnd_profile_options p, fnd_profile_option_values v, fnd_profile_options_tl n, fnd_user usr, fnd_application app, <br>
fnd_responsibility rsp, fnd_nodes svr, hr_operating_units org <br>
where v.level_id = ''10004'' <br>
and p.profile_option_id = v.profile_option_id (+) <br>
and p.profile_option_name = n.profile_option_name <br>
and p.profile_option_name = ''FND_NATIVE_CLIENT_ENCODING'' <br>
and usr.user_id (+) = v.level_value <br>
and rsp.application_id (+) = v.level_value_application_id <br>
and rsp.responsibility_id (+) = v.level_value <br>
and app.application_id (+) = v.level_value <br>
and v.profile_option_value <> '''||g_site_profile_id||'''<br>
and v.profile_option_value <> (select v.profile_option_value<br>
                               from fnd_profile_options p, fnd_profile_option_values v<br>
                               where v.level_id = ''10001'' <br>
                               and p.profile_option_id = v.profile_option_id (+)<br>
                               and p.profile_option_name = ''FND_NATIVE_CLIENT_ENCODING'')<br>
and svr.node_id (+) = v.level_value <br>
and org.organization_id (+) = v.level_value <br>
order by name, v.level_id;<br>
...</code>
</blockquote>
Or call the profile option API to get the value for a specific user: <br>
<ul><i>SELECT FND_PROFILE.VALUE_SPECIFIC(''FND_NATIVE_CLIENT_ENCODING'', &USER_ID) FROM DUAL;</i>
</ul>
For further details please refer to [402650/KB711359] - "User-Preferred Time Zone Support in Oracle E-Business Suite Release 12" - Step 2.1 ''Timezone Concept and Examples''.',
      p_success_msg            => 'The <b><i>FND: Native Client Encoding</i></b> Profile indicates the character set that a client machine uses as its
native character set.<br> The value must be one of the Oracle character sets and should correspond to the client native character set. The character set used in a client machine varies depending on language and platform.<br>
This profile option is used when storing text data. When a user uploads text files as attachments, the current value of FND: Native Client Encoding is stored along with the text data. With the value of this profile option, the server can then convert the text data to another character set as necessary when the text data is downloaded.<br><br>
For Confidentiality, we are only presenting the Site, Application and Responsibility levels in this report where appropriate. <br><font color="#FF0000">There are '||g_fnd_native_client_user_cnt||' Users that have this profile set at the User Level, of which '||g_fnd_native_client_user_diff||' are different than the SITE level setting of</font> <b>'||g_site_profile_code||'</b>, the DB Characterset is set to '||g_db_charset||', so if you want to see a detailed list of these Users and their USER level settings, please run following select statement as APPS :<br>
<blockquote>
<code>...<br>
select ''(''||language||'') - ''||n.user_profile_option_name Profilename, usr.user_id, <br>
decode(v.level_id,10001,''Site'',10002,''Application'',10003,''Responsibility'',10004,''User'',10005,''Server'',10006,''Organization'',10007,''ServResp'', ''Undefined'') "LEVEL", <br>
...
Or call the profile option API to get this value for a specific user: <br>
<ul><i>SELECT FND_PROFILE.VALUE_SPECIFIC(''FND_NATIVE_CLIENT_ENCODING'',&USER_ID) FROM DUAL;</i>
</ul>
Please see [393861/KB856469] - "Globalization Guide for Oracle Applications Release 12" for further information around NLS and global settings.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: atg_nls_profiles_FND_NATIVE_CLIENT_ENCODING2');



debug('begin add_signature: atg_nls_profile_ICX_CLIENT_IANA_ENCODING2');
   l_info('##COMPLEX_TYPE##'):= 'E';
  add_signature(
      p_sig_repo_id            => '3571',
      p_sig_id                 => 'atg_nls_profile_ICX_CLIENT_IANA_ENCODING2',
      p_sig_sql                => 'select p.profile_option_name as Profilename, n.language as LANG, n.user_profile_option_name as Translation,
decode(v.level_id,10001,''Site'',10002,''Application'',10003,''Responsibility'',10004,''User'') as LEVEL_SET,
...
and p.profile_option_id = v.profile_option_id (+)
and p.profile_option_name = n.profile_option_name
and n.profile_option_name = ''ICX_CLIENT_IANA_ENCODING''
and n.language = ''US''
and rsp.application_id (+) = v.level_value_application_id
and rsp.responsibility_id (+) = v.level_value
and app.application_id (+) = v.level_value
...
and org.organization_id (+) = v.level_value
order by n.profile_option_name,v.level_id, n.language',
      p_title                  => 'Profile Option <b>ICX: Client IANA Encoding</b>',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The <i>ICX: IANA Client Encoding</i> Profile is not set at the Site level !',
      p_solution               => 'SOLUTION-The Profile Option <i>ICX: Client IANA Encoding</i> shows the IANA character encoding used with displays for HTML-based Applications products.<br>
The ICX: Client IANA Encoding profile option is set at SITE level only.<br>
IANA character encoding is used with displays for HTML-based Applications products, and since a single encoding is shared by all Applications users, the value used should be a character set that supports all languages in use.<br><br>
Please set this profile option, and for further details please refer to [402650/KB711359] - "User-Preferred Time Zone Support in Oracle E-Business Suite Release 12" - Step 2.1 ''Timezone Concept and Examples''.',
      p_success_msg            => 'The Profile Option <i>ICX: Client IANA Encoding</i> is currently set and shows the IANA character encoding used with displays for HTML-based Applications products.<br>
The <i>ICX: Client IANA Encoding</i> profile option is set at SITE level only.<br>
IANA character encoding is used with displays for HTML-based Applications products, and since a single encoding is shared by all Applications users, the value used should be a character set that supports all languages in use.<br><br>
Please see [393861/KB856469] - "Globalization Guide for Oracle Applications Release 12" for further information around NLS and global settings.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;   
   l_info.delete;
debug('end add_signature: atg_nls_profile_ICX_CLIENT_IANA_ENCODING2');



debug('begin add_signature: atg_nls_profiles_ICX_DATE_FORMAT_MASK2');
   l_info('##COMPLEX_TYPE##'):= 'E';
  add_signature(
      p_sig_repo_id            => '3572',
      p_sig_id                 => 'atg_nls_profiles_ICX_DATE_FORMAT_MASK2',
      p_sig_sql                => 'select p.profile_option_name as Profilename, n.language as LANG, n.user_profile_option_name as Translation,
decode(v.level_id,10001,''Site'',10002,''Application'',10003,''Responsibility'',10004,''User'') as LEVEL_SET,
v.profile_option_value as VALUE,
p.APP_ENABLED_FLAG as APP, p.SITE_ENABLED_FLAG as SITE, p.RESP_ENABLED_FLAG as RESP, p.USER_ENABLED_FLAG as USR
...
and p.profile_option_id = v.profile_option_id (+)
and p.profile_option_name = n.profile_option_name
and n.profile_option_name = ''ICX_DATE_FORMAT_MASK''
and n.language = ''US''
and rsp.application_id (+) = v.level_value_application_id
and rsp.responsibility_id (+) = v.level_value
and app.application_id (+) = v.level_value
...
and org.organization_id (+) = v.level_value
order by n.profile_option_name,v.level_id, n.language',
      p_title                  => 'Profile Option <b>ICX: Date format mask</b>',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The <i>ICX: Date format mask</i> Profile is not set at the Site level !',
      p_solution               => 'SOLUTION-The Profile Option <i>ICX: Date format mask</i> is used to set the format of the date used in the E-Business Suite.<br>
For Security measures, we are only presenting the Site, Application and Responsibility levels in this report where appropriate. <br><font color="#FF0000">There are '||g_icx_date_fmt_mask_user_cnt||' Users that have this profile set at the User Level, of which '||g_icx_date_fmt_mask_user_diff||' are different than the SITE level setting of </font><b>'||g_site_profile_code||'</b>, so if you want to see a detailed list of these Users and their USER level settings, please run following select statement as APPS :<br>
<blockquote>
<code>...<br>
select ''(''||language||'') - ''||n.user_profile_option_name Profilename, <br>
decode(v.level_id,10001,''Site'',10002,''Application'',10003,''Responsibility'',10004,''User'',10005,''Server'',10006,''Organization'',10007,''ServResp'', ''Undefined'') LEVEL_SET, <br>
decode(to_char(v.level_id),''10001'', '' '',''10002'', app.application_short_name,''10003'', rsp.responsibility_key,''10004'', usr.user_name,''10005'', svr.node_name,''10006'', org.name,''10007'', <br>
(select n.node_name from fnd_nodes n where n.node_id=level_value2)||''/''||(decode(to_char(v.level_value), -1,''Default'', <br>
(select responsibility_key from fnd_responsibility where responsibility_id=level_value))), v.level_id) "User-ID", <br>
(select timezone_code from fnd_timezones_b where upgrade_tz_id=profile_option_value) "Timezone" <br>
from fnd_profile_options p, fnd_profile_option_values v, fnd_profile_options_tl n, fnd_user usr, fnd_application app, <br>
fnd_responsibility rsp, fnd_nodes svr, hr_operating_units org <br>
where v.level_id = ''10004'' <br>
and p.profile_option_id = v.profile_option_id (+) <br>
and p.profile_option_name = n.profile_option_name <br>
and p.profile_option_name = ''ICX_DATE_FORMAT_MASK'' <br>
and usr.user_id (+) = v.level_value <br>
and rsp.application_id (+) = v.level_value_application_id <br>
and rsp.responsibility_id (+) = v.level_value <br>
and app.application_id (+) = v.level_value <br>
...
Or call the profile option API to get the value for a specific user: <br>
<ul><i>SELECT FND_PROFILE.VALUE_SPECIFIC(''ICX_DATE_FORMAT_MASK'', &USER_ID) FROM DUAL;</i>
</ul>
For further details please refer to [402650/KB711359] - "User-Preferred Time Zone Support in Oracle E-Business Suite Release 12" - Step 2.1 ''Timezone Concept and Examples''.',
      p_success_msg            => 'The Profile Option <i>ICX: Date format mask</i> is successfully set at the SITE level and used to set the format of the date used in the E-Business Suite.<br>
For Confidentiality concerns, we are only presenting the Site, Application and Responsibility levels in this report where appropriate. <br><font color="#FF0000">There are '||g_icx_date_fmt_mask_user_cnt||' Users that have this profile set at the User Level, of which '||g_icx_date_fmt_mask_user_diff||' are different than the SITE level setting of </font><b>'||g_site_profile_code||'</b>, so if you want to see a detailed list of these Users and their USER level settings, please run following select statement as APPS :<br>
<blockquote>
<code>...<br>
select ''(''||language||'') - ''||n.user_profile_option_name Profilename, <br>
decode(v.level_id,10001,''Site'',10002,''Application'',10003,''Responsibility'',10004,''User'',10005,''Server'',10006,''Organization'',10007,''ServResp'', ''Undefined'') LEVEL_SET, <br>
...
Please see [393861/KB856469] - "Globalization Guide for Oracle Applications Release 12" for further information around NLS and global settings.',
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: atg_nls_profiles_ICX_DATE_FORMAT_MASK2');



debug('begin add_signature: atg_nls_profiles_ICX_NLS_SORT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1115',
      p_sig_id                 => 'atg_nls_profiles_ICX_NLS_SORT',
      p_sig_sql                => 'select p.profile_option_name as Profilename, n.language as LANG, n.user_profile_option_name as Translation,
decode(v.level_id,10001,''Site'',10002,''Application'',10003,''Responsibility'',10004,''User'') as LEVEL_SET,
v.profile_option_value as VALUE,p.APP_ENABLED_FLAG as APP, p.SITE_ENABLED_FLAG as SITE, p.RESP_ENABLED_FLAG as RESP, p.USER_ENABLED_FLAG as USR
 from 
...
where
  ...
  and p.profile_option_id = v.profile_option_id (+)
  and p.profile_option_name = n.profile_option_name
  and n.profile_option_name = ''ICX_NLS_SORT''
  and v.profile_option_value <> ''BINARY''
  and rsp.application_id (+) = v.level_value_application_id
  and rsp.responsibility_id (+) = v.level_value
  and app.application_id (+) = v.level_value
  and svr.node_id (+) = v.level_value
  and org.organization_id (+) = v.level_value
order by n.profile_option_name,v.level_id, n.language',
      p_title                  => 'Profile Option <b>ICX: NLS Sort</b>',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Since EBS Release 12 <i>another sorting than BINARY</i> is not supported anymore !
',
      p_solution               => 'In the result area we are showing the settings on Site-, Application-, Responsibility-, Server- and Organization-level.<br>Starting with E-Business Suite Release 12 and higher only the <b>BINARY</b> Setting for the Profile Option <i>ICX: NLS Sort</i> is supported.<br>
It is recommended to check for the Profile Option values on <b>USER level</b> using following SQL select:
<br><blockquote><code>
...<br>
select p.profile_option_name as Profilename, n.language as LANG, n.user_profile_option_name as Translation,<br>
decode(v.level_id,10001,''Site'',10002,''Application'',10003,''Responsibility'',10004,''User'') as LEVEL_SET,<br>
decode(to_char(v.level_id),''10001'', '' '',''10002'', app.application_short_name,''10003'', rsp.responsibility_key,''10004'', usr.user_name,''10005'', svr.node_name,''10006'', org.name,''10007'',<br>
(select n.node_name from fnd_nodes n where n.node_id=level_value2)||''/''||(decode(to_char(v.level_value), -1,''Default'', <br>(select responsibility_key from fnd_responsibility where responsibility_id=level_value))), v.level_id) as "User-ID",
v.profile_option_value as VALUE<br>
from fnd_profile_options p, fnd_profile_option_values v, fnd_profile_options_tl n,<br>
fnd_user usr, fnd_application app, fnd_responsibility rsp, fnd_nodes svr, hr_operating_units org<br>
where<br>
v.level_id = ''10004''<br>
and p.profile_option_id = v.profile_option_id (+)<br>
and p.profile_option_name = n.profile_option_name<br>
and n.profile_option_name = ''ICX_NLS_SORT''<br>
and v.profile_option_value <> ''BINARY''<br>
and rsp.application_id (+) = v.level_value_application_id<br>
and rsp.responsibility_id (+) = v.level_value<br>
and app.application_id (+) = v.level_value<br>
and svr.node_id (+) = v.level_value<br>
and org.organization_id (+) = v.level_value<br>
order by n.profile_option_name,v.level_id, n.language<br>
...</code></blockquote><br>
If the select shows <b><i>no rows selected</i></b> it means that the Profile Option is not set on User level and the Site level Setting will be used - so everything is fine.<br>
For further Information please check
<ul>
<li>[393861/KB856469] - Globalization Guide for Oracle Applications Release 12</li>
</ul>',
      p_success_msg            => 'For the Profile Option <i>ICX: NLS Sort</i> we have no different value than <b>BINARY</b> identified on Site-, Apps- or Responsibility-level.<br><br>
We recommend to verify the same on <i>User-level</i> by using following SQL select:
<br><blockquote><code>
...<br>
select p.profile_option_name as Profilename, n.language as LANG, n.user_profile_option_name as Translation,<br>
decode(v.level_id,10001,''Site'',10002,''Application'',10003,''Responsibility'',10004,''User'') as LEVEL_SET,<br>
...
<li>[393861/KB856469] - Globalization Guide for Oracle Applications Release 12</li>
   ...
   l_info.delete;
debug('end add_signature: atg_nls_profiles_ICX_NLS_SORT');



debug('begin add_signature: atg_nls_profiles_ICX_NUMERIC_CHARACTERS2');
   l_info('##COMPLEX_TYPE##'):= 'E';
  add_signature(
      p_sig_repo_id            => '3575',
      p_sig_id                 => 'atg_nls_profiles_ICX_NUMERIC_CHARACTERS2',
      p_sig_sql                => 'select p.profile_option_name as Profilename, n.language as LANG, n.user_profile_option_name as Translation,
decode(v.level_id,10001,''Site'',10002,''Application'',10003,''Responsibility'',10004,''User'') as LEVEL_SET,
v.profile_option_value as VALUE, 
p.APP_ENABLED_FLAG as APP, p.SITE_ENABLED_FLAG as SITE, p.RESP_ENABLED_FLAG as RESP, p.USER_ENABLED_FLAG as USR
...
and p.profile_option_id = v.profile_option_id (+)
and p.profile_option_name = n.profile_option_name
and n.profile_option_name = ''ICX_NUMERIC_CHARACTERS''
and rsp.application_id (+) = v.level_value_application_id
and rsp.responsibility_id (+) = v.level_value
and app.application_id (+) = v.level_value
and svr.node_id (+) = v.level_value
and org.organization_id (+) = v.level_value
order by n.profile_option_name,v.level_id, n.language',
      p_title                  => 'Profile Option <b>ICX: Numeric characters</b>',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The <i>ICX: Numeric characters</i> Profile is not set at the Site level !',
      p_solution               => 'The Profile Option <i>ICX: Numeric characters</i> is used to set the decimal- and grouping-separator as needed or prefered.<br>
For Security measures, we are only presenting the Site, Application and Responsibility levels in this report where appropriate. <br><font color="#FF0000">There are '||g_icx_num_char_user_cnt||' Users that have this profile set at the User Level, of which '||g_icx_num_char_user_diff||' are different than the SITE level setting of </font> <b>'||g_site_profile_code||'</b>, so if you want to see a detailed list of these Users and their USER level settings, please run following select statement as APPS :<br>
<blockquote>
<code>...<br>
select ''(''||language||'') - ''||n.user_profile_option_name Profilename, <br>
decode(v.level_id,10001,''Site'',10002,''Application'',10003,''Responsibility'',10004,''User'',10005,''Server'',10006,''Organization'',10007,''ServResp'', ''Undefined'') LEVEL_SET, <br>
...
and p.profile_option_id = v.profile_option_id (+) <br>
and p.profile_option_name = n.profile_option_name <br>
and p.profile_option_name = ''ICX_NUMERIC_CHARACTERS'' <br>
and usr.user_id (+) = v.level_value <br>
and rsp.application_id (+) = v.level_value_application_id <br>
and rsp.responsibility_id (+) = v.level_value <br>
and app.application_id (+) = v.level_value <br>
...
Or call the profile option API to get the value for a specific user: <br>
<ul><i>SELECT FND_PROFILE.VALUE_SPECIFIC(''ICX_NUMERIC_CHARACTERS'', &USER_ID) FROM DUAL;</i>
</ul>
For further details please refer to [402650/KB711359] - "User-Preferred Time Zone Support in Oracle E-Business Suite Release 12" - Step 2.1 ''Timezone Concept and Examples''.',
      p_success_msg            => 'The Profile Option <i>ICX: Numeric characters</i> is used to set the decimal- and grouping-separator as needed or prefered.<br>
For Security measures, we are only presenting the Site, Application and Responsibility levels in this report where appropriate. <br><font color="#FF0000">There are '||g_icx_num_char_user_cnt||' Users that have this profile set at the User Level, of which '||g_icx_num_char_user_diff||' are different than the SITE level setting of </font><b>'||g_site_profile_code||'</b>, so if you want to see a detailed list of these Users and their USER level settings, please run following select statement as APPS :<br>
<blockquote>
<code>...<br>
select ''(''||language||'') - ''||n.user_profile_option_name Profilename, <br>
...
Please see [393861/KB856469] - "Globalization Guide for Oracle Applications Release 12" for further information around NLS and global settings.',
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: atg_nls_profiles_ICX_NUMERIC_CHARACTERS2');



debug('begin add_signature: atg_nls_profiles_ICX_PREFERRED_CURRENCY2');
   l_info('##COMPLEX_TYPE##'):= 'E';
  add_signature(
      p_sig_repo_id            => '3577',
      p_sig_id                 => 'atg_nls_profiles_ICX_PREFERRED_CURRENCY2',
      p_sig_sql                => 'select''(''||language||'') - ''||n.user_profile_option_name Profilename,
decode(v.level_id, 10001,''Site'',10002,''Application'', 10003,''Responsibility'',10004,''User'',10005,''Server'',10006,''Organization'',10007,''ServResp'',''Undefined'') LEVEL_SET, 
v.profile_option_value VALUE
from fnd_profile_options p, fnd_profile_option_values v, fnd_profile_options_tl n, fnd_application app, fnd_responsibility rsp, fnd_nodes svr, hr_operating_units org
where
  v.level_id in (''10001'',''10002'',''10003'',''10005'',''10006'',''10007'')
  and p.profile_option_id = v.profile_option_id (+)
  and p.profile_option_name = n.profile_option_name
  and n.profile_option_name = ''ICX_PREFERRED_CURRENCY''
  and rsp.application_id (+) = v.level_value_application_id
  and rsp.responsibility_id (+) = v.level_value
  and app.application_id (+) = v.level_value
  and svr.node_id (+) = v.level_value
  and org.organization_id (+) = v.level_value
order by name, v.level_id',
      p_title                  => 'Profile Option <b>ICX: Preferred Currency</b>',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Overview of the values stored for the Profile Option <i>ICX: Preferred Currency</i>.',
      p_solution               => '<b>There is no Profile Option <i>ICX: Preferred Currency</i> set on Site level !</b><br>
If you are using Sales within the E-Business Suite the Profile Option should be set on Site-level and it can be overwritten by Users setting it on User-level to a different value.',
      p_success_msg            => 'Via this Profile Option is the preferred Currency iso-code passed to EBS.<br>
In the area above we are presenting the values for the Site-, Application-, Responsibility-, Server- and Organization-level. If you want to check for the values on <b>User-level</b>, please use following SQL select:<br>
<blockquote>
<code>...<br>
select ''(''||language||'') - ''||n.user_profile_option_name Profilename, <br>
decode(to_char(v.level_id),''10001'', '' '',''10002'', app.application_short_name,''10003'', rsp.responsibility_key,''10004'', usr.user_name,''10005'', svr.node_name,''10006'', org.name,''10007'', <br>
(select n.node_name from fnd_nodes n where n.node_id=level_value2)||''/''||(decode(to_char(v.level_value), -1,''Default'', <br>
(select responsibility_key from fnd_responsibility where responsibility_id=level_value))), v.level_id) "User-ID", v.profile_option_value VALUE<br>
from fnd_profile_options p, fnd_profile_option_values v, fnd_profile_options_tl n, fnd_user usr, fnd_application app, <br>
fnd_responsibility rsp, fnd_nodes svr, hr_operating_units org <br>
where v.level_id = ''10004'' <br>
and p.profile_option_id = v.profile_option_id (+) <br>
and p.profile_option_name = n.profile_option_name <br>
and p.profile_option_name = ''ICX_PREFERRED_CURRENCY'' <br>
and usr.user_id (+) = v.level_value <br>
and rsp.application_id (+) = v.level_value_application_id <br>
and rsp.responsibility_id (+) = v.level_value <br>
and app.application_id (+) = v.level_value <br>
...
Or call the profile option API to get the value for a specific user: <br>
<ul><i>SELECT FND_PROFILE.VALUE_SPECIFIC(''ICX_PREFERRED_CURRENCY'', &USER_ID) FROM DUAL;</i>
</ul>
For further details please see [393861/KB856469] - "Globalization Guide for Oracle Applications Release 12"',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: atg_nls_profiles_ICX_PREFERRED_CURRENCY2');



debug('begin add_signature: atg_nls_profiles_ICX_TERRITORY2');
   l_info('##COMPLEX_TYPE##'):= 'E';
  add_signature(
      p_sig_repo_id            => '3576',
      p_sig_id                 => 'atg_nls_profiles_ICX_TERRITORY2',
      p_sig_sql                => 'select''(''||language||'') - ''||n.user_profile_option_name Profilename,
decode(v.level_id, 10001,''Site'',10002,''Application'', 10003,''Responsibility'',10004,''User'',10005,''Server'',10006,''Organization'',10007,''ServResp'',''Undefined'') LEVEL_SET, 
v.profile_option_value VALUE
from fnd_profile_options p, fnd_profile_option_values v, fnd_profile_options_tl n, fnd_application app, fnd_responsibility rsp, fnd_nodes svr, hr_operating_units org
where
  ...
  and p.profile_option_id = v.profile_option_id (+)
  and p.profile_option_name = n.profile_option_name
  and n.profile_option_name = ''ICX_TERRITORY''
  and rsp.application_id (+) = v.level_value_application_id
  and rsp.responsibility_id (+) = v.level_value
  and app.application_id (+) = v.level_value
  and svr.node_id (+) = v.level_value
  and org.organization_id (+) = v.level_value
order by name, v.level_id',
      p_title                  => 'Profile Option <b>ICX: Territory</b>',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Overview of the values stored for the Profile Option <i>ICX: Territory</i>.',
      p_solution               => '<b>There is no Profile Option <i>ICX: Territory<i> set on Site level !</b><br>
It is expected to have this Profile Option set on the Site-level as a minimum.',
      p_success_msg            => 'Via this Profile option the preferred Territory is set, which determines cultural conventions such as local time, date, numeric, and monetary conventions.<br>
In the area above we are presenting the values for the Site-, Application-, Responsibility-, Server- and Organization-level. If you want to check for the values on <b>User-level</b>, please use following SQL select:<br>
<blockquote>
<code>...<br>
select ''(''||language||'') - ''||n.user_profile_option_name Profilename, <br>
...
and p.profile_option_id = v.profile_option_id (+) <br>
and p.profile_option_name = n.profile_option_name <br>
and p.profile_option_name = ''ICX_TERRITORY'' <br>
and usr.user_id (+) = v.level_value <br>
and rsp.application_id (+) = v.level_value_application_id <br>
and rsp.responsibility_id (+) = v.level_value <br>
and app.application_id (+) = v.level_value <br>
...
For further details please see [393861/KB856469] - "Globalization Guide for Oracle Applications Release 12"',
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: atg_nls_profiles_ICX_TERRITORY2');



debug('begin add_signature: ATG_NLS_PROFILE_ENABLE_TIMEZONE_CONVERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19879',
      p_sig_id                 => 'ATG_NLS_PROFILE_ENABLE_TIMEZONE_CONVERSIONS',
      p_sig_sql                => 'select n.user_profile_option_name Profilename,
decode(v.level_id, 10001,''Site'',10002,''Application'', 10003,''Responsibility'',10004,''User'',10005,''Server'',10006,''Organization'',10007,''ServResp'',''Undefined'') LEVEL_SET, 
v.profile_option_value VALUE,
nvl2((select v.profile_option_value 
       from
       fnd_profile_options p,fnd_profile_option_values v
       where
         v.level_id in (''10001'')
         and p.profile_option_id = v.profile_option_id
         and p.profile_option_name = ''SERVER_TIMEZONE_ID''), decode(v.profile_option_value, ''Y'', ''OK'', ''WARNING''), ''OK'')  status
from fnd_profile_options p, fnd_profile_option_values v, fnd_profile_options_tl n, fnd_application app, fnd_responsibility rsp, fnd_nodes svr, hr_operating_units org
where
  v.level_id in (''10001'')
  and p.profile_option_id = v.profile_option_id (+)
  and p.profile_option_name = n.profile_option_name
  and n.profile_option_name = ''ENABLE_TIMEZONE_CONVERSIONS''
  and n.language = ''US''
  and rsp.application_id (+) = v.level_value_application_id
  and rsp.responsibility_id (+) = v.level_value
  and app.application_id (+) = v.level_value
  ...
  and org.organization_id (+) = v.level_value
order by name, v.level_id',
      p_title                  => 'Profile Option <b>Enable Timezone Conversions</b>',
      p_fail_condition         => '[STATUS]=[WARNING]',
      p_problem_descr          => 'Profile Enable Timezone Conversions (ENABLE_TIMEZONE_CONVERSIONS) is set to ''No'' (or ''N'') at the site level.',
      p_solution               => 'Profile Enable Timezone Conversions (ENABLE_TIMEZONE_CONVERSIONS) must be set to ''Yes'' (or ''Y'') at the site level in order to use user-preferred time zone feature. <br>
For more information, please review :<br>
<ul>
<li>Oracle E-Business Suite Release 12.2:
<ul>
<li><a href="https://docs.oracle.com/cd/E26401_01/doc.122/e22953/T174296T575363.htm">Time Zone Support</a>, <em>Oracle E-Business Suite Setup Guide</em></li>
</ul>
</li>
<li>Oracle E-Business Suite Release 12.1:
<ul>
<li>My Oracle Support Knowledge Document [402650/KB711359], <em>User-Preferred Time Zone Support in Oracle E-Business Suite Release 12</em></li>
<li><a href="https://docs.oracle.com/cd/E18727_01/doc.121/e12893/T174296T481580.htm">Time Zone Support</a>, <em>Oracle E-Business Suite Administrator''s Guide - Configuration</em></li>
</ul>
</li>
</ul>',
      p_success_msg            => 'Profile Enable Timezone Conversions (ENABLE_TIMEZONE_CONVERSIONS) is properly set to use user-preferred time zone feature.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ATG_NLS_PROFILE_ENABLE_TIMEZONE_CONVERSIONS');



debug('begin add_signature: ATG_NLS_PROFILE_CONC_MULTI_TZ');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19880',
      p_sig_id                 => 'ATG_NLS_PROFILE_CONC_MULTI_TZ',
      p_sig_sql                => 'select n.user_profile_option_name Profilename,
decode(v.level_id, 10001,''Site'',10002,''Application'', 10003,''Responsibility'',10004,''User'',10005,''Server'',10006,''Organization'',10007,''ServResp'',''Undefined'') LEVEL_SET, 
v.profile_option_value VALUE,
nvl2((select v.profile_option_value 
       ...
       where
         v.level_id in (''10001'')
         and p.profile_option_id = v.profile_option_id
         and p.profile_option_name = ''SERVER_TIMEZONE_ID''), decode(v.profile_option_value, ''N'', ''OK'', ''WARNING''), ''OK'')  status
from fnd_profile_options p, fnd_profile_option_values v, fnd_profile_options_tl n, fnd_application app, fnd_responsibility rsp, fnd_nodes svr, hr_operating_units org
where
  v.level_id in (''10001'')
  and p.profile_option_id = v.profile_option_id (+)
  and p.profile_option_name = n.profile_option_name
  and n.profile_option_name = ''CONC_MULTI_TZ''
  and n.language = ''US''
  and rsp.application_id (+) = v.level_value_application_id
  and rsp.responsibility_id (+) = v.level_value
  and app.application_id (+) = v.level_value
  ...
  and org.organization_id (+) = v.level_value
order by name, v.level_id',
      p_title                  => 'Profile Option <b>Concurrent:Multiple Time Zones</b>',
      p_fail_condition         => '[STATUS]=[WARNING]',
      p_problem_descr          => 'Profile Concurrent: Enable Timezone Conversions (CONC_MULTI_TZ) is set to ''Yes'' (or ''Y'') at the site level.',
      p_solution               => 'Profile Concurrent: Multiple Time Zones (CONC_MULTI_TZ) must be set to ''No'' (or ''N'') at the site level in order to use user-preferred time zone feature. <br>
For more information, please review :<br>
<ul>
<li>Oracle E-Business Suite Release 12.2:
<ul>
...
<li><a href="https://docs.oracle.com/cd/E18727_01/doc.121/e12893/T174296T481580.htm">Time Zone Support</a>, <em>Oracle E-Business Suite Administrator''s Guide - Configuration</em></li>
      ...
      p_success_msg            => 'Profile Concurrent: Multiple Time Zones (CONC_MULTI_TZ) is properly set to use user-preferred time zone feature.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ATG_NLS_PROFILE_CONC_MULTI_TZ');



debug('begin add_signature: ATG_NLS_TIMEZONE_SETTING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19878',
      p_sig_id                 => 'ATG_NLS_TIMEZONE_SETTING',
      p_sig_sql                => 'select
to_char(systimestamp, ''TZR'') "DATABASE TIMESTAMP OFFSET",
rtrim(tz_offset(fnd_timezones.get_server_timezone_code)) "SERVER TIMEZONE PROFILE OFFSET",
fnd_timezones.get_server_timezone_code "SERVER TIMEZONE PROFILE",
nvl2((select v.profile_option_value 
       from
       fnd_profile_options p,fnd_profile_option_values v
       where
         ...
         and p.profile_option_id = v.profile_option_id
         and p.profile_option_name = ''SERVER_TIMEZONE_ID''),
	  decode(to_char(systimestamp, ''TZR''),
	  rtrim(tz_offset(fnd_timezones.get_server_timezone_code), chr(0)),
	  ''OK'', ''NOT OK''), ''OK'') "VALIDATION STATUS" from dual',
      p_title                  => 'Verify Timezone Setting',
      p_fail_condition         => '[VALIDATION STATUS]=[NOT OK]',
      p_problem_descr          => 'Server Timezone profile option (SERVER_TIMEZONE_ID) does not match your database system time stamp offset.',
      p_solution               => 'The database system time stamp offset has to match with the Server Timezone profile option setting. <br>
Please log an EBS technology Service Request (SR) with Oracle Support for assistance.<br><br>
For more information, please review :<br>
<ul>
  <li>Oracle E-Business Suite Release 12.2:
    <ul>
  ...
  <li>For Oracle Cloud Infrastructure (OCI) customers, please review:
    <ul>
      <li>My Oracle Support Knowledge Document [2774525/KB820527], <em>Setting Oracle E-Business Suite Time Zones When Migrating to Oracle Cloud Infrastructure</em>.</li>
    </ul>
  </li>
</ul>
',
      p_success_msg            => 'Server Timezone profile option matches your database system time stamp offset.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ATG_NLS_TIMEZONE_SETTING');



debug('begin add_signature: atg_nls_forms_out_of_synch');
   l_info('##COMPLEX_TYPE##'):= 'W';
  add_signature(
      p_sig_repo_id            => '3742',
      p_sig_id                 => 'atg_nls_forms_out_of_synch',
      p_sig_sql                => 'select *  from 
(select "Top", "US Subdir","Filename",  "US Version", "Subdir", "Non US Version"
  from ( select af1.APP_SHORT_NAME||''_TOP/'' "Top", af1.subdir "US Subdir",af1.filename "Filename", afv1.version "US Version",
       ...
       af2.subdir "Subdir", afv2.version "Non US Version",
	   rank()over(partition by af2.filename
	     order by afv2.version_segment1 desc,
	     afv2.version_segment2 desc,afv2.version_segment3 desc,
	     afv2.version_segment4 desc,afv2.version_segment5 desc,
	     afv2.version_segment6 desc,afv2.version_segment7 desc,
	     afv2.version_segment8 desc,afv2.version_segment9 desc,
	     afv2.version_segment10 desc,
	     afv2.translation_level desc) as rankNUS
  from ad_files af1, ad_file_versions afv1, ad_files af2, ad_file_versions afv2
where af1.file_id = afv1.file_id
  and af1.filename like ''%.fmb''
  and af1.subdir = ''forms/US''
  and af2.file_id = afv2.file_id
  and af2.filename like ''%.fmb''
  and af2.subdir <> ''forms/US''
  and af1.filename = af2.filename)
where rankUS = 1
and rankNUS = 1
order by 1)
where ("US Version" > "Non US Version")',
      p_title                  => 'NLS Forms Out of Synch',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are NLS Forms that are lower in version than the "US" Form version.',
      p_solution               => 'This is a potential problem and should be reviewed in more detail.<br><br>

Please follow [252422/KB860741] - "Oracle E-Business Suite Translation Synchronization Patches" to request and apply the Customer specific Translation Synchronization Patch.',
      p_success_msg            => 'There are no NLS Forms out of Synch on this instance.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: atg_nls_forms_out_of_synch');



debug('begin add_signature: atg_nls_reports_out_of_synch');
   l_info('##COMPLEX_TYPE##'):= 'W';
  add_signature(
      p_sig_repo_id            => '3743',
      p_sig_id                 => 'atg_nls_reports_out_of_synch',
      p_sig_sql                => 'select *  from 
(select "Top", "US Subdir","Filename",  "US Version", "Subdir", "Non US Version"
  from ( select af1.APP_SHORT_NAME||''_TOP/'' "Top", af1.subdir "US Subdir",af1.filename "Filename", afv1.version "US Version",
	   rank()over(partition by af1.filename
  ...
  from ad_files af1, ad_file_versions afv1, ad_files af2, ad_file_versions afv2
where af1.file_id = afv1.file_id
  and af1.filename like ''%.rdf''
  and af1.subdir = ''reports/US''
  and af2.file_id = afv2.file_id
  and af2.filename like ''%.rdf''
  and af2.subdir <> ''reports/US''
  and af1.filename = af2.filename)
where rankUS = 1
and rankNUS = 1
order by 1)
where ("US Version" > "Non US Version")',
      p_title                  => 'NLS Reports Out of Synch',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are NLS Reports that are lower in version than the "US" Report version.',
      p_solution               => 'This is a potential problem and should be reviewed in more detail.<br><br>

Please follow [252422/KB860741] - Oracle E-Business Suite Translation Synchronization Patches.',
      p_success_msg            => 'There are no NLS Reports out of Synch on this instance.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: atg_nls_reports_out_of_synch');



debug('begin add_signature: atg_nls_ldt_out_of_synch');
   l_info('##COMPLEX_TYPE##'):= 'W';
  add_signature(
      p_sig_repo_id            => '3745',
      p_sig_id                 => 'atg_nls_ldt_out_of_synch',
      p_sig_sql                => 'select *  from 
(select "Top", "US Subdir","Filename",  "US Version", "Subdir", "Non US Version"
  from ( select af1.APP_SHORT_NAME||''_TOP/'' "Top", af1.subdir "US Subdir",af1.filename "Filename", afv1.version "US Version",
	   rank()over(partition by af1.filename
  ...
  from ad_files af1, ad_file_versions afv1, ad_files af2, ad_file_versions afv2
where af1.file_id = afv1.file_id
  and af1.filename like ''%.ldt''
  and af1.subdir = ''patch/115/import/US''
  and af2.file_id = afv2.file_id
  and af2.filename like ''%.ldt''
  and (af2.subdir <> ''patch/115/import/US'')
  and (af2.subdir <> ''admin/import'')
  and (af2.subdir <> ''admin/import/US'')
  and (af2.subdir <> ''patch/115/import'')
  and (af2.subdir <> ''patch/115/import/US/loc_us'')
  and af1.filename = af2.filename)
where rankUS = 1
and rankNUS = 1
order by 1)
where ("US Version" > "Non US Version")',
      p_title                  => 'NLS Loader Data (ldt) files Out of Synch',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are NLS Loader Data (ldt) files that are lower in version than the "US" Loader Data (ldt) file version.',
      p_solution               => 'This is a potential problem and should be reviewed in more detail.<br><br>

Please follow [252422/KB860741] - "Oracle E-Business Suite Translation Synchronization Patches" to request and apply the Customer specific Translation Synchronization Patch.',
      p_success_msg            => 'There are no NLS Loader Data (ldt) files out of Synch on this instance.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: atg_nls_ldt_out_of_synch');
...
debug('begin add_signature: atg_nls_profile_CLIENT_TIMEZONE_ID2');
   l_info('##COMPLEX_TYPE##'):= 'E';
  add_signature(
      p_sig_repo_id            => '3562',
      p_sig_id                 => 'atg_nls_profile_CLIENT_TIMEZONE_ID2',
      p_sig_sql                => 'select p.profile_option_name as Profilename, n.language as LANG, n.user_profile_option_name as Translation,
decode(v.level_id,10001,''Site'',10002,''Application'',10003,''Responsibility'',10004,''User'') as LEVEL_SET,
v.profile_option_value as VALUE, (select timezone_code from fnd_timezones_b where upgrade_tz_id=profile_option_value) as Timezone,
p.APP_ENABLED_FLAG as APP, p.SITE_ENABLED_FLAG as SITE, p.RESP_ENABLED_FLAG as RESP, p.USER_ENABLED_FLAG as USR
...
and p.profile_option_id = v.profile_option_id (+)
and p.profile_option_name = n.profile_option_name
and n.profile_option_name = ''CLIENT_TIMEZONE_ID''
and n.language = ''US''
and rsp.application_id (+) = v.level_value_application_id
and rsp.responsibility_id (+) = v.level_value
and app.application_id (+) = v.level_value
...
and org.organization_id (+) = v.level_value
order by n.profile_option_name,v.level_id, n.language',
      p_title                  => 'Profile Option <b>Client Timezone</b>',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The <i>Client Timezone</i> Profile is not set at the Site level !',
      p_solution               => 'The Profile Option <b>Client Timezone</b> is used for the Timezone Setting on the Client Site.<br>
For Security measures, we are only presenting the Site, Application and Responsibility levels in this report where appropriate. <br><font color="#FF0000">There are '||g_client_timezone_user_cnt||' Users that have this profile set at the User Level, of which '||g_client_timezone_user_diff||' are different than the SITE level setting of </font><b>'||g_site_profile_code||'</b>, so if you want to see a detailed list of these Users and their USER level settings, please run following select statement as APPS :<br>
<blockquote>
<code>...<br>
select ''(''||language||'') - ''||n.user_profile_option_name Profilename, <br>
decode(v.level_id,10001,''Site'',10002,''Application'',10003,''Responsibility'',10004,''User'',10005,''Server'',10006,''Organization'',10007,''ServResp'', ''Undefined'') LEVEL_SET, <br>
...
and p.profile_option_id = v.profile_option_id (+) <br>
and p.profile_option_name = n.profile_option_name <br>
and p.profile_option_name = ''CLIENT_TIMEZONE_ID'' <br>
and usr.user_id (+) = v.level_value <br>
and rsp.application_id (+) = v.level_value_application_id <br>
and rsp.responsibility_id (+) = v.level_value <br>
and app.application_id (+) = v.level_value <br>
...
Or call the profile option API to get the value for a specific user: <br>
<ul><i>SELECT FND_PROFILE.VALUE_SPECIFIC(''CLIENT_TIMEZONE_ID'', &USER_ID) FROM DUAL;</i>
</ul>
For further details please refer to [402650/KB711359] - "User-Preferred Time Zone Support in Oracle E-Business Suite Release 12" - Step 2.1 ''Timezone Concept and Examples''.',
      p_success_msg            => 'The Profile Option <b>Client Timezone</b> is used for the Timezone Setting on the Client Site.<br>
For Security measures, we are only presenting the Site, Application and Responsibility levels in this report where appropriate. <br><font color="#FF0000">There are '||g_client_timezone_user_cnt||' Users that have this profile set at the User Level, of which '||g_client_timezone_user_diff||' are different than the SITE level setting of</font> <b>'||g_site_profile_code||'</b>, so if you want to see a detailed list of these Users and their USER level settings, please run following select statement as APPS :<br>
<blockquote>
<code>...<br>
select ''(''||language||'') - ''||n.user_profile_option_name Profilename, <br>
...
Please see [393861/KB856469] - "Globalization Guide for Oracle Applications Release 12" for further information around NLS and global settings.',
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: atg_nls_profile_CLIENT_TIMEZONE_ID2');



debug('begin add_signature: atg_nls_profile_CLIENT_TIMEZONE_ID3');
   l_info('##COMPLEX_TYPE##'):= 'W';
add_signature(
      p_sig_repo_id            => '3562',
      p_sig_id                 => 'atg_nls_profile_CLIENT_TIMEZONE_ID3',
      p_sig_sql                => 'select p.profile_option_name as Profilename, n.language as LANG, n.user_profile_option_name as Translation,
decode(v.level_id,10001,''Site'',10002,''Application'',10003,''Responsibility'',10004,''User'') as LEVEL_SET,
v.profile_option_value as VALUE, (select timezone_code from fnd_timezones_b where upgrade_tz_id=profile_option_value) as Timezone,
p.APP_ENABLED_FLAG as APP, p.SITE_ENABLED_FLAG as SITE, p.RESP_ENABLED_FLAG as RESP, p.USER_ENABLED_FLAG as USR
...
order by n.profile_option_name,v.level_id, n.language',
      p_title                  => 'Profile Option <b>Client Timezone</b>',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The Profile Option <b>Client Timezone</b> has USER level Timezone Settings on the Client Site.',
      p_solution               => 'For Security measures, we are only presenting the Site, Application and Responsibility levels in this report where appropriate. <br><font color="#FF0000">There are '||g_client_timezone_user_cnt||' Users that have this profile set at the User Level, of which '||g_client_timezone_user_diff||' are different than the SITE level setting of </font><b>'||g_site_profile_code||'</b>, so if you want to see a detailed list of these Users and their USER level settings, please run following select statement as APPS :<br>
<blockquote>
<code>...<br>
select ''(''||language||'') - ''||n.user_profile_option_name Profilename, <br>
decode(v.level_id,10001,''Site'',10002,''Application'',10003,''Responsibility'',10004,''User'',10005,''Server'',10006,''Organization'',10007,''ServResp'', ''Undefined'') LEVEL_SET, <br>
...
For further details please refer to [402650/KB711359] - "User-Preferred Time Zone Support in Oracle E-Business Suite Release 12" - Step 2.1 ''Timezone Concept and Examples''.',
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: atg_nls_profile_CLIENT_TIMEZONE_ID3');



debug('begin add_signature: ATG_NLS_PROFILE_CLIENT_TIMEZONE_ID_NOT_SET');
   l_info('##COMPLEX_TYPE##'):= 'W';
add_signature(
      p_sig_repo_id            => '5235',
      p_sig_id                 => 'atg_nls_profile_CLIENT_TIMEZONE_ID_NOT_SET',
      p_sig_sql                => 'select p.profile_option_name as Profilename, n.language as LANG, n.user_profile_option_name as Translation,
decode(v.level_id,10001,''Site'',10002,''Application'',10003,''Responsibility'',10004,''User'') as LEVEL_SET,
v.profile_option_value as VALUE, (select timezone_code from fnd_timezones_b where upgrade_tz_id=profile_option_value) as Timezone,
p.APP_ENABLED_FLAG as APP, p.SITE_ENABLED_FLAG as SITE, p.RESP_ENABLED_FLAG as RESP, p.USER_ENABLED_FLAG as USR
...
order by n.profile_option_name,v.level_id, n.language',
      p_title                  => 'Profile Option <b>Client Timezone</b>',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The Profile Option <b>Client Timezone</b> has no SITE level Timezone Settings on the Client Site.',
      p_solution               => 'For Security measures, we normally only present the Site, Application and Responsibility levels in this report where appropriate. 

Since the SITE level is not set, call the profile option API to get the value for a specific user: <br>
<ul><i>SELECT FND_PROFILE.VALUE_SPECIFIC(''CLIENT_TIMEZONE_ID'', &USER_ID) FROM DUAL;</i>
</ul>
For further details please refer to [402650/KB711359] - "User-Preferred Time Zone Support in Oracle E-Business Suite Release 12" - Step 2.1 ''Timezone Concept and Examples''.',
      p_success_msg            => '',
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: ATG_NLS_PROFILE_CLIENT_TIMEZONE_ID_NOT_SET');



debug('begin add_signature: ATG_NLS_EXPORT_PROFILES7');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4218',
      p_sig_id                 => 'ATG_NLS_EXPORT_PROFILES7',
      p_sig_sql                => 'select p.profile_option_name, v.profile_option_value
from fnd_profile_options p, fnd_profile_option_values v
where v.level_id = ''10001'' 
and p.profile_option_id = v.profile_option_id (+)
and p.profile_option_name in (''FND_NATIVE_CLIENT_ENCODING'', ''FND_EXPORT_MIME_TYPE'', ''FND_UNICODE_IN_EXPORT'')',
      p_title                  => 'Export Profile Options',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No rows found identifying the Export Profile Options <i>FND: Unicode in Export</i>, and <i>Export MIME type</i>.',
      p_solution               => 'The Export Profile Options are not used as NLS_LANG is not UTF-8',
      p_success_msg            => 'In Release 12.1.3, the Oracle Application Framework-based export function was enhanced to handle tab-delimited values and choice of Unicode encoding. In Release 12.2, the Forms-based export function is also enhanced to support those for Global customers. The two profile options to control the feature are:<br>
<ul>
 <li><b>FND: Unicode in Export:</b><br>
 This determines the export file encoding when FND: Native Client Encoding is set to UTF-8. The supported profile values are:</li>
 <ul>
  <li>Always UnicodeLittle: export file encoding is UnicodeLittle.</li>
  <li>Always UTF-8: export file encoding is UTF-8.</li>
  <li>UnicodeLittle if Excel Exists: From OA Framework, this exports the file in UnicodeLittle if Microsoft Excel is detected on the client machine. From Forms, it is treated the same as Unicode Little.</li>
 </ul>
...
<li><b>Export MIME type:</b></li>
<ul>
This profile defines the delimiter of the exported file and the content-type header of the response. Valid values include:<br>
<li>
"text/comma-separated-values": the delimiter in the export file is comma, and this sets content-type header to text/comma-separated-values.</li>
<li>"text/tab-separated-values": the delimiter in the export file is tab, and this sets the content-type header to text/tab-separated-values.</li>
If something else is specified to this profile option, the delimiter is comma for OA Framework but tab with Forms for the backward compatibility.
 </ul>
</ul>
For more information, please review [393861/KB856469] - Globalization Guide for Oracle Applications Release 12.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ATG_NLS_EXPORT_PROFILES7');



debug('begin add_signature: ATG_NLS_EXPORT_PROFILES8');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5294',
      p_sig_id                 => 'ATG_NLS_EXPORT_PROFILES8',
      p_sig_sql                => 'select p.profile_option_name, v.profile_option_value
from fnd_profile_options p, fnd_profile_option_values v
where v.level_id = ''10001'' 
and p.profile_option_id = v.profile_option_id (+)
and p.profile_option_name in (''FND_NATIVE_CLIENT_ENCODING'', ''FND_EXPORT_MIME_TYPE'', ''FND_UNICODE_IN_EXPORT'')',
      ...
      p_problem_descr          => 'No rows found identifying the Export Profile Options <i>FND: Unicode in Export</i>, and <i>Export MIME type</i>.',
      p_solution               => 'The Export Profile Options are not used as NLS_LANG is not UTF-8',
      p_success_msg            => 'The Export Profile Option <b>FND_NATIVE_CLIENT_ENCODING</b> is not set at the Site Level.<br>
...
Default is UnicodeLittle if Excel Exists with OA Framework, and Always UnicodeLittle with Forms so the export feature works with the default configuration. <br>FND: Unicode in Export only works when FND: Native Client Encoding is set to UTF-8. <br>If otherwise specified, this profile option value is ignored.
<li><b>Export MIME type:</b></li>
<ul>
This profile defines the delimiter of the exported file and the content-type header of the response. Valid values include:<br>
<li>
...
For more information, please review [393861/KB856469] - Globalization Guide for Oracle Applications Release 12.',
   ...
   l_info.delete;
debug('end add_signature: ATG_NLS_EXPORT_PROFILES8');



debug('begin add_signature: ATG_NLS_PROFILES_ICX_DATE_LANGUAGE_11');
   l_info('##COMPLEX_TYPE##'):= 'W';
add_signature(
      p_sig_repo_id            => '4110',
      p_sig_id                 => 'ATG_NLS_PROFILES_ICX_DATE_LANGUAGE_11',
      p_sig_sql                => 'select''(''||language||'') - ''||n.user_profile_option_name Profilename,
decode(v.level_id, 10001,''Site'',10002,''Application'', 10003,''Responsibility'',10004,''User'',10005,''Server'',10006,''Organization'',10007,''ServResp'',''Undefined'') LEVEL_SET, 
v.profile_option_value VALUE
from fnd_profile_options p, fnd_profile_option_values v, fnd_profile_options_tl n, fnd_application app, fnd_responsibility rsp, fnd_nodes svr, hr_operating_units org
where
  ...
  and p.profile_option_id = v.profile_option_id (+)
  and p.profile_option_name = n.profile_option_name
  and n.profile_option_name = ''ICX_DATE_LANGUAGE''
  and n.language = ''US''
  and rsp.application_id (+) = v.level_value_application_id
  and rsp.responsibility_id (+) = v.level_value
  and app.application_id (+) = v.level_value
  ...
  and org.organization_id (+) = v.level_value
order by name, v.level_id',
      p_title                  => 'Profile Option <b>ICX: Date language</b>',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Missing the Profile Option <i>ICX: Date language</i>.',
      p_solution               => '<b>The usage of the Profile Option <i>ICX: Date language</i> is still used in Oracle Applications Release 11i, but not recommended anymore starting with Release 12 !</b><br><br>
In the result area above we are presenting the values for the Site-, Application-, Responsibility-, Server- and Organization-level (a NULL value is OK).
<br>If you want to verify if there is a cleanup needed on <b>User-level</b>, please check for the values using following SQL select:<br>
<blockquote>
<code>...<br>
select ''(''||language||'') - ''||n.user_profile_option_name Profilename, <br>
decode(to_char(v.level_id),''10001'', '' '',''10002'', app.application_short_name,''10003'', rsp.responsibility_key,''10004'', usr.user_name,''10005'', svr.node_name,''10006'', org.name,''10007'', <br>
...
and p.profile_option_id = v.profile_option_id (+) <br>
and p.profile_option_name = n.profile_option_name <br>
and p.profile_option_name = ''ICX_DATE_LANGUAGE'' <br>
and usr.user_id (+) = v.level_value <br>
and rsp.application_id (+) = v.level_value_application_id <br>
and rsp.responsibility_id (+) = v.level_value <br>
and app.application_id (+) = v.level_value <br>
...
Or call the profile option API to get the value for a specific user: <br>
<ul><i>SELECT FND_PROFILE.VALUE_SPECIFIC(''ICX_DATE_LANGUAGE'', &USER_ID) FROM DUAL;</i>
</ul>
Please see [393861/KB856469] - "Globalization Guide for Oracle Applications Release 12" - Configuration part for further details.',
      p_success_msg            => '<b>The Profile Option <i>ICX: Date language</i> is used as expected in 11i ! Very Good !</b><br>
As in the result area above we are presenting the values for the Site-, Application-, Responsibility-, Server- and Organization-level (a NULL value is OK), you should check the User-level.
<br>To verify if there is a cleanup needed on <b>User-level</b>, please check for the values using following SQL select:<br>
<blockquote>
<code>...<br>
select ''(''||language||'') - ''||n.user_profile_option_name Profilename, <br>
decode(to_char(v.level_id),''10001'', '' '',''10002'', app.application_short_name,''10003'', rsp.responsibility_key,''10004'', usr.user_name,''10005'', svr.node_name,''10006'', org.name,''10007'', <br>
...
Please see [393861/KB856469] - "Globalization Guide for Oracle Applications Release 12" - Configuration part for further details.',
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: ATG_NLS_PROFILES_ICX_DATE_LANGUAGE_11');



debug('begin add_signature: atg_nls_profiles_ICX_DATE_LANGUAGE2');
   l_info('##COMPLEX_TYPE##'):= 'W';
  add_signature(
      p_sig_repo_id            => '3573',
      p_sig_id                 => 'atg_nls_profiles_ICX_DATE_LANGUAGE2',
      p_sig_sql                => 'select''(''||language||'') - ''||n.user_profile_option_name Profilename,
decode(v.level_id, 10001,''Site'',10002,''Application'', 10003,''Responsibility'',10004,''User'',10005,''Server'',10006,''Organization'',10007,''ServResp'',''Undefined'') LEVEL_SET, 
v.profile_option_value VALUE
from fnd_profile_options p, fnd_profile_option_values v, fnd_profile_options_tl n, fnd_application app, fnd_responsibility rsp, fnd_nodes svr, hr_operating_units org
...
order by name, v.level_id',
      p_title                  => 'Profile Option <b>ICX: Date language</b>',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Overview of the values stored for the Profile Option <i>ICX: Date language</i>.',
      p_solution               => '<b>The usage of the Profile Option <i>ICX: Date language</i> is not recommended anymore starting with Release 12 !</b><br><br>
In the result area above we are presenting the values for the Site-, Application-, Responsibility-, Server- and Organization-level (a NULL value is OK).
<br>If you want to verify if there is a cleanup needed on <b>User-level</b>, please check for the values using following SQL select:<br>
<blockquote>
<code>...<br>
...
Please see [393861/KB856469] - "Globalization Guide for Oracle Applications Release 12" - Configuration part for further details.',
      p_success_msg            => '<b>The Profile Option <i>ICX: Date language</i> is not used as recommended ! Very Good !</b><br>
As in the result area above we are presenting the values for the Site-, Application-, Responsibility-, Server- and Organization-level (a NULL value is OK), you should check the User-level.
<br>To verify if there is a cleanup needed on <b>User-level</b>, please check for the values using following SQL select:<br>
<blockquote>
<code>...<br>
...
Please see [393861/KB856469] - "Globalization Guide for Oracle Applications Release 12" - Configuration part for further details.',
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: atg_nls_profiles_ICX_DATE_LANGUAGE2');



debug('begin add_signature: atg_nls_workflows_out_of_synch_11i');
   l_info('##COMPLEX_TYPE##'):= 'W';
  add_signature(
      p_sig_repo_id            => '3561',
      p_sig_id                 => 'atg_nls_workflows_out_of_synch_11i',
      p_sig_sql                => 'select *  from 
(select "Top", "US Subdir","Filename",  "US Version", "Subdir", "Non US Version"
  from ( select af1.APP_SHORT_NAME||''_TOP/'' "Top", af1.subdir "US Subdir",af1.filename "Filename", afv1.version "US Version",
	   rank()over(partition by af1.filename
  ...
  from ad_files af1, ad_file_versions afv1, ad_files af2, ad_file_versions afv2
where af1.file_id = afv1.file_id
  and af1.filename like ''%.wft''
  and af1.subdir = ''patch/115/import/US''
  and af2.file_id = afv2.file_id
  and af2.filename like ''%.wft''
  and ((af2.subdir <> ''patch/115/import/US'')
       and (af2.subdir <> ''admin/%'')
       and (af2.subdir <> ''patch/115/import''))
  and af1.filename = af2.filename)
where rankUS = 1
and rankNUS = 1
order by 1)
where ("US Version" > "Non US Version")',
      p_title                  => 'NLS Workflows Out of Synch in 11i',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are NLS Workflow Definition files (*.wft) that are lower in version than the base "'||g_base_lang||'" Workflow Version.',
      p_solution               => 'This is a potential problem as your language files should match or be higher than the base "'||g_base_lang||'" language files, and should be reviewed in more detail.<br><br>

Please follow [252422/KB860741] - Oracle E-Business Suite Translation Synchronization Patches.',
      p_success_msg            => 'There are no NLS Workflow Definition files (*.wft) out of Synch on this instance.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: atg_nls_workflows_out_of_synch_11i');



debug('begin add_signature: atg_nls_workflows_out_of_synch');
   l_info('##COMPLEX_TYPE##'):= 'W';
  add_signature(
      p_sig_repo_id            => '3740',
      p_sig_id                 => 'atg_nls_workflows_out_of_synch',
      p_sig_sql                => 'select *  from 
(select "Top", "US Subdir","Filename",  "US Version", "Subdir", "Non US Version"
  from ( select af1.APP_SHORT_NAME||''_TOP/'' "Top", af1.subdir "US Subdir",af1.filename "Filename", afv1.version "US Version",
	   rank()over(partition by af1.filename
...
order by 1)
where ("US Version" > "Non US Version")',
      p_title                  => 'NLS Workflows Out of Synch',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are NLS Workflow Definition files (*.wft) that are lower in version than the "US" Workflow Version.',
...
Please follow [252422/KB860741] - Oracle E-Business Suite Translation Synchronization Patches.',
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: atg_nls_workflows_out_of_synch');



debug('begin add_signature: SNAPSHOT_IS_CURRENT');
   l_info('##COMPLEX_TYPE##'):= 'W';
  add_signature(
      p_sig_repo_id            => '3599',
      p_sig_id                 => 'SNAPSHOT_IS_CURRENT',
      p_sig_sql                => 'select snapshot_name, appl_top_id, SNAPSHOT_UPDATE_DATE, LAST_UPDATE_DATE from ad_snapshots 
where snapshot_name like ''%_VIEW''
 and appl_top_id in (select appl_top_id from ad_appl_tops where name in (select focf.node_name
			 From Fnd_Oam_Context_Files Focf
			Where Focf.Name Not In (''TEMPLATE'',''METADATA'',''config.txt'') And Focf.Ctx_Type=''A'' 
			  And (Focf.Status Is Null Or Upper(Focf.Status) In (''S'',''F'')) 
			  And Extractvalue(Xmltype(Focf.Text),''//file_edition_type'') = ''run''))
 and SNAPSHOT_TYPE in (''C'',''G'')
UNION ALL
select snapshot_name, appl_top_id, SNAPSHOT_UPDATE_DATE, LAST_UPDATE_DATE from ad_snapshots 
where snapshot_name like ''%_VIEW''
 and appl_top_id in (select appl_top_id from ad_appl_tops where name in (''GLOBAL''))
 and SNAPSHOT_TYPE in (''C'',''G'')
order by snapshot_name, LAST_UPDATE_DATE desc',
      p_title                  => 'ADADMIN : Maintain Snapshot Information is Current',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is an issue verifying when ADADMIN : Maintain Snapshot Information was last run.',
      p_solution               => 'You have bigger problems...

Check the ADADMIN Utiltities manual.',
      p_success_msg            => 'ADADMIN : Maintain Snapshot Information is current, or was last ran '||g_snap_days||' days ago on '||upper(g_instance)||'.<br><br>
It is recommended that AD Utilities (Adadmin) "Maintain Snapshot Information" is run periodically as key tools (Patch Wizard, ADPatch,etc) rely on this information being accurate and up-to-date.<br>
<ul>
<li>If SNAPSHOT_UPDATE_DATE is newer than LAST_UPDATE_DATE, then snapshot was last run by ADADMIN on that date.</li>
<li>If LAST_UPDATE_DATE is newer than SNAPSHOT_UPDATE_DATE, then snapshot was last updated by AD_PATCH.</li></ul>

Patch Wizard uses the information contained in the global current view snapshot to determine which patches have already been applied.<br>
AutoPatch uses the APPL_TOP current view snapshot to determine if all prerequisite patches have been applied to that APPL_TOP.<br><br>

ADPATCH regenerates the current view and global view snapshots after each patch application; however ADPATCH only runs the delta on a patch, whereas ADADMIN runs a complete snapshot update on both Global View and Current View.<br>
For more information, review "Maintain Snapshot Information" in <a href="http://docs.oracle.com/cd/E18727_01/doc.121/e13676.pdf" target="_blank">Maintenance Utilities</a>.<br>',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: SNAPSHOT_IS_CURRENT');



debug('begin add_signature: SNAPSHOT_IS_OLD');
   l_info('##COMPLEX_TYPE##'):= 'W';
  add_signature(
      p_sig_repo_id            => '2459',
      p_sig_id                 => 'SNAPSHOT_IS_OLD',
      p_sig_sql                => 'select snapshot_name, appl_top_id, 
       SNAPSHOT_UPDATE_DATE, LAST_UPDATE_DATE from ad_snapshots 
       where snapshot_name like ''%_VIEW''
         and appl_top_id in (select appl_top_id from ad_appl_tops where name in 
        (select focf.node_name From Fnd_Oam_Context_Files Focf
       	  Where Focf.Name Not In (''TEMPLATE'',''METADATA'',''config.txt'') And Focf.Ctx_Type=''A'' 
       	    And (Focf.Status Is Null Or Upper(Focf.Status) In (''S'',''F'')) 
       	    And Extractvalue(Xmltype(Focf.Text),''//file_edition_type'') = ''run''))
         and SNAPSHOT_TYPE in (''C'',''G'')
       ...
       where snapshot_name like ''%_VIEW''
         ...
         and SNAPSHOT_TYPE in (''C'',''G'')
       order by snapshot_name, LAST_UPDATE_DATE desc',
      p_title                  => 'ADADMIN : Maintain Snapshot Information is '||g_snap_days||' Days Old',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'ADADMIN : Maintain Snapshot Information was last ran over '||g_snap_days||' days ago on '||upper(g_instance)||', so this is OLD',
      p_solution               => 'It is recommended that AD Utilities (Adadmin) "Maintain Snapshot Information" is run periodically as key tools (Patch Wizard, ADPatch,etc) rely on this information being accurate and up-to-date.<br>
<ul>
<li>If SNAPSHOT_UPDATE_DATE is newer than LAST_UPDATE_DATE, then snapshot was last run by ADADMIN on that date.</li>
<li>If LAST_UPDATE_DATE is newer than SNAPSHOT_UPDATE_DATE, then snapshot was last updated by AD_PATCH.</li></ul>
...
ADPATCH regenerates the current view and global view snapshots after each patch application; however ADPATCH only runs the delta on a patch, whereas ADADMIN runs a complete snapshot update on both Global View and Current View.<br>
If these two columns are not recently in synch, then we recommend using ADADMIN to run "Maintain Snapshot Information" for "Update Complete APPL_TOP" on each distributed APPL_TOP to make sure that output is current.<br><br>
Review "Maintain Snapshot Information" in <a href="http://docs.oracle.com/cd/E18727_01/doc.121/e13676.pdf" target="_blank">Maintenance Utilities</a><br>
Follow [252422/KB860741] - Oracle E-Business Suite Translation Synchronization Patches, and run Snapshot using the ADADMIN utility.',
      p_success_msg            => 'You got big complex problems...',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: SNAPSHOT_IS_OLD');



debug('begin add_signature: SNAPSHOT_NOT_RUN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3598',
      p_sig_id                 => 'SNAPSHOT_NOT_RUN',
      p_sig_sql                => 'select snapshot_name, appl_top_id, SNAPSHOT_UPDATE_DATE, LAST_UPDATE_DATE from ad_snapshots 
       where snapshot_name like ''%_VIEW''
         and appl_top_id in (select appl_top_id from ad_appl_tops where name in (select focf.node_name
       				 From Fnd_Oam_Context_Files Focf
       ...
       where snapshot_name like ''%_VIEW''
         ...
         and SNAPSHOT_TYPE in (''C'',''G'')
       order by snapshot_name, LAST_UPDATE_DATE desc',
      p_title                  => 'ADADMIN: Maintain Snapshot Information Has Not Been Run',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'ADADMIN : Maintain Snapshot Information has not been run in a long time, or the data has been purged and is not available for use by Patch Wizard, or AutoPatch.',
      p_solution               => 'It is recommended that AD Utilities (ADADMIN) "Maintain Snapshot Information" is run periodically as key tools (Patch Wizard, ADPatch,etc) rely on this information being accurate and up-to-date.<br>
<ul>
<li>If SNAPSHOT_UPDATE_DATE is newer than LAST_UPDATE_DATE, then snapshot was last run by ADADMIN on that date.</li>
<li>If LAST_UPDATE_DATE is newer than SNAPSHOT_UPDATE_DATE, then snapshot was last updated by AD_PATCH.</li></ul>
...
Patch Wizard uses the information contained in the global current view snapshot to determine which patches have already been applied.<br>
 ...
 For more information, please review [10940175/KA580] - Patch Wizard FAQs.<br>
 ADPATCH regenerates the current view and global view snapshots after each patch application; however ADPATCH only runs the delta on a patch, whereas ADADMIN runs a complete snapshot update on both Global View and Current View.<br>
 If these two columns are not recently in synch, then we recommend using ADADMIN utility to run "Maintain Snapshot Information" for "Update Complete APPL_TOP" on each distributed APPL_TOP to make sure that output is current.<br><br>
 Review "Maintain Snapshot Information" in <a href="http://docs.oracle.com/cd/E18727_01/doc.121/e13676.pdf" target="_blank">Maintenance Utilities</a><br>',
      p_success_msg            => 'It is recommended that AD Utilities (ADADMIN) "Maintain Snapshot Information" is run periodically as key tools (Patch Wizard, ADPatch,etc) rely on this information being accurate and up-to-date.<br>
<ul>
<li>If SNAPSHOT_UPDATE_DATE is newer than LAST_UPDATE_DATE, then snapshot was last run by ADADMIN on that date.</li>
<li>If LAST_UPDATE_DATE is newer than SNAPSHOT_UPDATE_DATE, then snapshot was last updated by AD_PATCH.</li></ul>
...
For more information, review "Maintain Snapshot Information" in <a href="http://docs.oracle.com/cd/E18727_01/doc.121/e13676.pdf" target="_blank">Maintenance Utilities</a>.<br>',
   ...
   l_info.delete;
debug('end add_signature: SNAPSHOT_NOT_RUN');



debug('begin add_signature: atg_nls_fnd_menus_tl_base');
   l_info('##COMPLEX_TYPE##'):= 'E';
  add_signature(
      p_sig_repo_id            => '3739',
      p_sig_id                 => 'atg_nls_fnd_menus_tl_base',
      p_sig_sql                => 'select language "LANGUAGES", decode(FND_LANGUAGES.INSTALLED_FLAG, ''B'',''Base Language'', ''I'',''Installed'') "INSTALLED", count(MENU_ID) "MENU COUNTS", (select count(MENU_ID) from FND_MENUS_TL
where language = (SELECT language_code FROM FND_LANGUAGES where INSTALLED_FLAG = ''B'')) "BASE LANGUAGE MENU COUNT"
from FND_MENUS_TL, FND_LANGUAGES
where FND_MENUS_TL.LANGUAGE = FND_LANGUAGES.LANGUAGE_CODE 
and language in (SELECT language_code FROM FND_LANGUAGES where INSTALLED_FLAG in (''B'',''I''))
group by language, FND_LANGUAGES.INSTALLED_FLAG
order by 2, 1',
      p_title                  => 'Validate FND_MENUS_TL for Language Menus',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no Language Menus missing',
      p_solution               => 'There are no additional languages installed, only the base language, so there are no missing language Menus.
<br><br>
If languages are installed, then please follow [252422/KB860741] - Oracle E-Business Suite Translation Synchronization Patches.',
      p_success_msg            => 'There are no additional languages installed, so only Base Language Menus exist as expected.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: atg_nls_fnd_menus_tl_base');



debug('begin add_signature: atg_nls_fnd_menus_tl_mls');
   l_info('##COMPLEX_TYPE##'):= 'E';
  add_signature(
      p_sig_repo_id            => '3736',
      p_sig_id                 => 'atg_nls_fnd_menus_tl_mls',
      p_sig_sql                => 'select language "LANGUAGES", decode(FND_LANGUAGES.INSTALLED_FLAG, ''B'',''Base Language'', ''I'',''Installed'') "INSTALLED", count(MENU_ID) "MENU COUNTS", (select count(MENU_ID) from FND_MENUS_TL
where language = (SELECT language_code FROM FND_LANGUAGES where INSTALLED_FLAG = ''B'')) "BASE LANGUAGE MENU COUNT"
from FND_MENUS_TL, FND_LANGUAGES
where FND_MENUS_TL.LANGUAGE = FND_LANGUAGES.LANGUAGE_CODE 
...
group by language, FND_LANGUAGES.INSTALLED_FLAG
order by 2, 1',
      p_title                  => 'Validate FND_MENUS_TL for NLS Menus',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are NLS Menus missing',
      p_solution               => 'The count of NLS Menus does not match the count of Base Language Menus.
<br><br>
Please follow [252422/KB860741] - Oracle E-Business Suite Translation Synchronization Patches.',
      p_success_msg            => 'The NLS Menus match the Base Menus count as expected.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: atg_nls_fnd_menus_tl_mls');



debug('begin add_signature: atg_nls_fnd_menus_tl_mls2');
   l_info('##COMPLEX_TYPE##'):= 'E';
     add_signature(
      p_sig_repo_id            => '3737',
      p_sig_id                 => 'atg_nls_fnd_menus_tl_mls2',
      p_sig_sql                => 'select language "LANGUAGES", decode(FND_LANGUAGES.INSTALLED_FLAG, ''B'',''Base Language'', ''I'',''Installed'') "INSTALLED", count(MENU_ID) "MENU COUNTS", (select count(MENU_ID) from FND_MENUS_TL
where language = (SELECT language_code FROM FND_LANGUAGES where INSTALLED_FLAG = ''B'')) "BASE LANGUAGE MENU COUNT"
from FND_MENUS_TL, FND_LANGUAGES
where FND_MENUS_TL.LANGUAGE = FND_LANGUAGES.LANGUAGE_CODE 
...
<br><br>
Please follow [252422/KB860741] - Oracle E-Business Suite Translation Synchronization Patches.',
      p_success_msg            => 'The NLS Menus match the Base Language "'||g_base_lang||'" Menus count as expected.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: atg_nls_fnd_menus_tl_mls2');



debug('begin add_signature: atg_nls_fnd_menus_tl_nil');
   l_info('##COMPLEX_TYPE##'):= 'E';
  add_signature(
      p_sig_repo_id            => '3738',
      p_sig_id                 => 'atg_nls_fnd_menus_tl_nil',
      p_sig_sql                => 'select language "INSTALLED LANGUAGES", count(MENU_ID) "MENU COUNTS", (select count(MENU_ID) from FND_MENUS_TL
where language = (SELECT language_code FROM FND_LANGUAGES where INSTALLED_FLAG = ''B'')) "BASE LANGUAGE MENU COUNT"
from FND_MENUS_TL
where language in (SELECT language_code FROM FND_LANGUAGES where INSTALLED_FLAG in (''B'',''I''))
group by language',
      p_title                  => 'Validate FND_MENUS_TL for Language Menus',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are language Menus missing',
      p_solution               => 'There are zero languages installed including a base language.
<br><br>
Please follow [252422/KB860741] - Oracle E-Business Suite Translation Synchronization Patches.',
      p_success_msg            => 'The NLS Menus match the Base Menus count as expected.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: atg_nls_fnd_menus_tl_nil');
...
BEGIN
  ...
  analyzer_title := 'NLS and MLS Analyzer';
...
start_section('NLS Instance Overview', 'Overview');
   set_item_result(run_stored_sig('EBS_ATG_AT_TECHSTACK_CLASSIC'));
   set_item_result(run_stored_sig('EBS_ATG_CT_VERSIONS'));
   set_item_result(run_stored_sig('ATG_PRODUCTS_INSTALLED2'));
   set_item_result(run_stored_sig('atg_lang_installed'));
   set_item_result(run_stored_sig('ATG_NLS_DB_PARAMETERS2'));
   set_item_result(run_stored_sig('ATG_NLS_SESSION_PARAMETERS'));
if (g_global_update_date = 0) then 
   set_item_result(run_stored_sig('SNAPSHOT_NOT_RUN'));
elsif (g_global_update_date < 31) then 
   set_item_result(run_stored_sig('SNAPSHOT_IS_CURRENT'));
else 
   set_item_result(run_stored_sig('SNAPSHOT_IS_OLD'));
end if;   

   
	if (g_lang_cnt > 1) then 
		if (g_menus_not_synch = 0) then 
				set_item_result(run_stored_sig('atg_nls_fnd_menus_tl_mls'));
			elsif (g_menus_not_synch > 0) then 
				set_item_result(run_stored_sig('atg_nls_fnd_menus_tl_mls2'));
		    else 		
			set_item_result(run_stored_sig('atg_nls_fnd_menus_tl_mls2'));
		end if;
	elsif (g_lang_cnt = 0) then
			set_item_result(run_stored_sig('atg_nls_fnd_menus_tl_nil'));
	else
		set_item_result(run_stored_sig('atg_nls_fnd_menus_tl_base'));
	end if;
   set_item_result(run_stored_sig('atg_nls_lightweight_languages'));
   set_item_result(run_stored_sig('NLS_ORA_NLS10'));
end_section;
debug('end section: Overview');

debug('begin section: nls_profile_options');
start_section('NLS Profile Option Values', 'nls_profile_options');
show_note;
   set_item_result(run_stored_sig('atg_nls_profile_options3'));
   set_item_result(run_stored_sig('atg_nls_profile_SERVER_TIMEZONE_ID'));
   set_item_result(run_stored_sig('atg_nls_profiles_FND_NATIVE_CLIENT_ENCODING2'));

if (g_site_profile_id <> '-1') then
   if (g_client_timezone_user_cnt > 0) then
      set_item_result(run_stored_sig('atg_nls_profile_CLIENT_TIMEZONE_ID3'));
   else
      set_item_result(run_stored_sig('atg_nls_profile_CLIENT_TIMEZONE_ID2'));
   end if;
else
   set_item_result(run_stored_sig('atg_nls_profile_CLIENT_TIMEZONE_ID_NOT_SET'));
end if;
if (g_fnd_native_client_encoding <> 'not set') then
  if (g_fnd_native_client_encoding = 'UTF-8') then 
     set_item_result(run_stored_sig('ATG_NLS_EXPORT_PROFILES7'));
  end if;
else
  set_item_result(run_stored_sig('ATG_NLS_EXPORT_PROFILES8'));
end if;
   set_item_result(run_stored_sig('atg_nls_profile_ICX_CLIENT_IANA_ENCODING2'));
   set_item_result(run_stored_sig('atg_nls_profiles_ICX_DATE_FORMAT_MASK2'));
if (g_rep_info('Apps Version') < '12.0') then
     print_log('Checking ICX_DATE_LANG_REL_CHECK release < 12');
     set_item_result(run_stored_sig('ATG_NLS_PROFILES_ICX_DATE_LANGUAGE_11'));
else 
     print_log('Checking ICX_DATE_LANG_REL_CHECK release > 12');
     set_item_result(run_stored_sig('atg_nls_profiles_ICX_DATE_LANGUAGE2'));
end if;
   set_item_result(run_stored_sig('atg_nls_profiles_ICX_NLS_SORT'));
   set_item_result(run_stored_sig('atg_nls_profiles_ICX_NUMERIC_CHARACTERS2'));
   set_item_result(run_stored_sig('atg_nls_profiles_ICX_PREFERRED_CURRENCY2'));
   set_item_result(run_stored_sig('atg_nls_profiles_ICX_TERRITORY2'));
   set_item_result(run_stored_sig('ATG_NLS_PROFILE_ENABLE_TIMEZONE_CONVERSIONS'));
   set_item_result(run_stored_sig('ATG_NLS_PROFILE_CONC_MULTI_TZ'));
   set_item_result(run_stored_sig('ATG_NLS_TIMEZONE_SETTING'));
end_section;
debug('end section: nls_profile_options');

debug('begin section: NLS_FILES_OUT_OF_SYNCH');
start_section('NLS File(s) Out of Synch', 'NLS_FILES_OUT_OF_SYNCH');
   set_item_result(run_stored_sig('atg_nls_forms_out_of_synch'));
   set_item_result(run_stored_sig('atg_nls_reports_out_of_synch'));
   if (g_rep_info('Apps Version') like '11.5%') then
      set_item_result(run_stored_sig('atg_nls_workflows_out_of_synch_11i'));
   else 
      set_item_result(run_stored_sig('atg_nls_workflows_out_of_synch'));
   end if;
   set_item_result(run_stored_sig('atg_nls_ldt_out_of_synch'));
end_section;
debug('end section: NLS_FILES_OUT_OF_SYNCH');
