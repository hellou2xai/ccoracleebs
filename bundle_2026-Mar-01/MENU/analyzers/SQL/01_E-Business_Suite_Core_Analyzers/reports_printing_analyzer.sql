...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Reports and Printing Analyzer          |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE fnd_report_print_analyzer_pkg AUTHID DEFINER AS
...
END fnd_report_print_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY fnd_report_print_analyzer_pkg AS
-- $Id: reports_printing_analyzer.sql, 200.63 2026/02/25 16:22:14 dterrell Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(1610143.1));
...
g_rpt_method_code     VARCHAR2(30);
g_prodtop	      varchar2(50);
g_filename	      varchar2(200);
g_subdir	      varchar2(200);
g_version	      varchar2(4000);
g_spec                varchar2(4000);
g_body	              varchar2(4000);
g_package	      varchar2(60);
g_pkg_status          varchar2(10);
g_pkgb_status         varchar2(10);
g_cp_name             VARCHAR2(240);
g_req_id_xml          number;
g_is_sub_req          VARCHAR2(1);
g_has_sub_req         VARCHAR2(1);
g_instance            varchar2(16);
g_instance_nls        VARCHAR2(256);
beginmin              number;
beginmax   	      number;
maxitems	      number;
cls_cnt		      number;
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'RPTPRT_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'RPTPRT_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>RPTPRT Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=1610143.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/rpa_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,383,EBS,EBS ATG,EBS - Component Tools" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,383,EBS,EBS ATG,EBS - Component Tools" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},383,EBS,EBS ATG,EBS - Component Tools" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/mosc/discussion/3903863" class="blacklink" target="new">
...
<p style="tab-stops:list 1.0in;">7/2/25: Signature EBS_ATG_UGLE_32BIT_SEQUENCES_CLOSE_TO_MAX has been changed.</p><p style="tab-stops:list 1.0in;"><span style="color:#707070;">4/16/25: There are 2 new features:</span><br>
<span style="color:#707070;">&nbsp; &nbsp; 1. Fixed the input is too long error when running an analyzer in SQL*Plus&nbsp;</span><br>
<span style="color:#707070;">&nbsp; &nbsp; 2. Added the click to highlight rows in tables</span></p><div>&nbsp;</div>
<div><span style="font-family:&apos;Calibri&apos;,sans-serif;font-size:16px;">The analyzer is now executed as a Package instead of an Anonymous Block. Please see the instructions in Doc ID </span>1610143.1<span style="font-family:&apos;Calibri&apos;,sans-serif;font-size:16px;"> for running the analyzer from Sql*Plus and from Concurrent Manager as a Concurrent Program.</span></div>
<div>The framework was updated to framework version 4.5.7</div>
...
<!-- '||l_current_sig||' -->
	...
	l_html := l_html || '
			...
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,383,'||p_sig.sigrepo_id||',EBS,EBS ATG,EBS - Component Tools" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},383,'||p_sig.sigrepo_id||',EBS,EBS ATG,EBS - Component Tools" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
PROCEDURE check_profile_options IS
	prof1 fnd_profile_option_values.PROFILE_OPTION_VALUE%type;
        prof2 fnd_profile_option_values.PROFILE_OPTION_VALUE%type;
begin

select v.PROFILE_OPTION_VALUE into prof1
...
and (t.PROFILE_OPTION_NAME in ('ICX_CLIENT_IANA_ENCODING'))
order by z.USER_PROFILE_OPTION_NAME;

g_rep_info('prof1') := prof1;

select v.PROFILE_OPTION_VALUE into prof2
from fnd_profile_options t, fnd_profile_option_values v, fnd_profile_options_tl z
where (v.PROFILE_OPTION_ID (+) = t.PROFILE_OPTION_ID)
and (v.level_id = 10001)
and (z.LANGUAGE='US')
and (z.PROFILE_OPTION_NAME = t.PROFILE_OPTION_NAME)
and (t.PROFILE_OPTION_NAME in ('FND_NATIVE_CLIENT_ENCODING'))
order by z.USER_PROFILE_OPTION_NAME;

g_rep_info('prof2') := prof2;

print_log('Instance '||g_instance||' has NLS_CHARACTERSET   = '||g_instance_nls);
print_log('ICX_CLIENT_IANA_ENCODING has NLS_CHARACTERSET   = '||prof1);
print_log('FND_NATIVE_CLIENT_ENCODING has NLS_CHARACTERSET = '||prof2);
...
BEGIN
    ...
    print_log('Processing recommended patches signature: CHECK_RPT_PATCHES (check_rec_patches_1) "Recommended Reports Patches for '||mask_text(g_apps_version, nvl( upper(''), 'NO_MASK') )||'" (version 12)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_col_rows(1)(l_rows) := '16778382';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'APPS6: REPORT SERVER PRODUCES AN OUTPUT PDF 1.4 NOT COMPLIANT TO ITS SPECS';
   l_col_rows(5)(l_rows) := '[11151171/KA989]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '14374587';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'APPS6:REP-57054 REP-50159 REP-54002 ERROR WHEN RUNNING REPORT IN BATCH';
   l_col_rows(5)(l_rows) := '[1237834/KB668806]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '12384570';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R.TST122:SUPPLY CHAIN CONSOLIDATED BILLS OF MATERIAL COST REPORT IS COMPLETING';
   l_col_rows(5)(l_rows) := '[105115/FAQ6084]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '8602992';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'APPS1012: CACHE DIRECTORY NOT BEING CLEANED OUT';
   l_col_rows(5)(l_rows) := '[859255/KB562113]';

END IF;

   l_extra_info('##SHOW_SQL##'):= 'Y';

   l_sig.sigrepo_id := '1134';
   l_sig.title := 'Recommended Reports Patches for '||mask_text(g_apps_version, nvl( upper(''), 'NO_MASK') )||'';
   ...
   l_sig.success_msg := '<b>All known recommended EBS Reports patches, at the time this script was written, for release '||mask_text(g_apps_version, nvl( upper(''), 'NO_MASK') )||' have been applied.<br>
  ...
  -- Register
  l_step := '60';
  g_signatures('CHECK_RPT_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'CHECK_RPT_PATCHES',     -- sig ID
...
BEGIN
    ...
    print_log('Processing recommended patches signature: check_prt_patches (check_rec_patches_2) "Recommended Printing Patches" (version 9)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '14486338';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'REPRINT/REPUBLISH - NOT DEFAULTING TO WHAT WAS STYLE AND PRINTER';
   l_col_rows(5)(l_rows) := '[1548274/KB360312]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '14265552';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'REPRINT/REPUBLISH USING USER_PRINTER_STLYE_NAME - ERROR INVALID STYLE';
...
END IF;
   ...
   l_sig.sigrepo_id := '1133';
   l_sig.title := 'Recommended Printing Patches';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := 'Please check the recommended Printing patches that are not applied on this instance';
   l_sig.solution := '<b>To get a current accurate list of recommended EBS product patches that are applied/not applied to your instance, please run Patch Wizard.</b><br>
		See [976188/KB739927] - Patch Wizard Utility, [10940175/KA580] FAQ, or [1077813/KB627816] Videos for more information.<br>
		<ul>Above is a short list of recommended product patches as of the date this script was written to show you what may or may not be applied on this '||mask_text(g_instance, nvl( upper(''), 'NO_MASK') )||' instance.
		<li>Please review the list above and schedule to apply any unapplied patches as soon as possible</li>
        <li>Refer to the note indicated for more information about each patch</li></ul><br>';
   l_sig.success_msg := '<b>All known recommended EBS Printing patches, at the time this script was written, for release '||mask_text(g_apps_version, nvl( upper(''), 'NO_MASK') )||' have been applied.<br>
	  To get the most current list of recommended EBS product patches that are applied/not applied to your instance, please run Patch Wizard.</b><br>
	  See [976188/KB739927] - Patch Wizard Utility, [10940175/KA580] FAQ, or [1077813/KB627816] Videos for more information.<br>';
   l_sig.print_condition := 'ALWAYS';
   l_sig.fail_type := 'W';
  ...
  -- Register
  l_step := '60';
  g_signatures('check_prt_patches') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'check_prt_patches',     -- sig ID
    l_sig,                              -- signature information
    l_col_rows,                         -- data
    l_hdr);                             -- headers
...
----------------------------------------------------------------
  ...
  l_rpt_method_code     VARCHAR2(30);
  l_prodtop             varchar2(50);
  l_filename	        varchar2(200);
  l_subdir 	        varchar2(200);
  l_version	        varchar2(4000);
  l_spec                varchar2(4000);
  l_body	        varchar2(4000);
  l_package             varchar2(200);
  l_pkg_status          varchar2(10);
  l_pkgb_status         varchar2(10);
  l_cp_name             VARCHAR2(240);
  l_req_id_xml          number:=0;
  l_is_sub_req          VARCHAR2(1):='N';
  l_has_sub_req         VARCHAR2(1):='N';
  l_instance_nls        VARCHAR2(256);
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Request ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(req_id,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Minimum acceptable volume of Concurrent Reports data';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_min_volume,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Maximum acceptable volume of Concurrent Reports data';
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/02/25 16:22:13 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'reports_printing_analyzer.sql';
...
debug('begin parameter validation: req_id');
IF req_id IS NOT NULL THEN
BEGIN
SELECT REQUEST_ID
INTO l_exists_val
FROM FND_CONCURRENT_REQUESTS
WHERE REQUEST_ID = req_id and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Error: invalid value entered for request_id (' || req_id || '), no records exist for this request_id. Skipping this section by setting default value to 0.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for req_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: req_id');
...
print_log('Variable l_tl_cnt....');

select count(request_id) into l_tl_cnt from fnd_concurrent_requests where phase_code='C';
         
print_log('.........l_tl_cnt = '||l_tl_cnt);
	
select count(request_id) into l_reqid_cnt from fnd_concurrent_requests where phase_code='C' and ofile_size >0;

select count(request_id) into l_err_cnt from fnd_concurrent_requests where phase_code='C'
and ofile_size >0 and status_code='E';

print_log('Variable l_cantprt....');

select count(CONCURRENT_PROGRAM_ID) into l_cantprt
from fnd_concurrent_programs 
where print_flag = 'N';

print_log('.........l_cantprt = '||l_cantprt);

print_log('Variable l_canprt....');

select count(CONCURRENT_PROGRAM_ID)  into l_canprt
from fnd_concurrent_programs 
where print_flag = 'Y';

print_log('.........l_canprt = '||l_canprt);

print_log('Variables l_cp_status, l_nodename, l_cp_start_date, l_logfile_name, l_last_update_date....');
...
print_log('............l_cp_status = '||l_cp_status);
print_log('.............l_nodename = '||l_nodename);
print_log('........l_cp_start_date = '||l_cp_start_date);
print_log('.........l_logfile_name = '||l_logfile_name);
print_log('.....l_last_update_date = '||l_last_update_date);

IF req_id <> '-1' THEN
g_request_id  := req_id;
 
 print_log('Variable l_rpt_method_code....');

 select DECODE(p.execution_method_code, 'A','Spawned',
	'B','Request Set Stage Function','E','Perl Concurrent Program',
	'F','FlexSql','H','Host','I','PL/SQL Stored Procedure',
	'J','Java Stored Procedure','K','Java Concurrent Program','L','SQL*Loader',
	'M','Multi Language Function','P','Oracle Reports','Q','SQL*Plus',
	'R','SQL*Report','S','Immediate','X','FlexRpt',
	'Z','Shutdown Callback') "METHOD" 
	into l_rpt_method_code
    from apps.fnd_concurrent_programs p, apps.fnd_concurrent_requests r
	where r.CONCURRENT_PROGRAM_ID = p.CONCURRENT_PROGRAM_ID
      and r.program_application_id = p.application_id
      and r.request_id = req_id;

	print_log('.........l_rpt_method_code = '||l_rpt_method_code);

print_log('Variable l_cp_name....');

        select fcpv.USER_CONCURRENT_PROGRAM_NAME into l_cp_name
	from fnd_concurrent_requests fcr, FND_CONCURRENT_PROGRAMS_VL fcpv
...
print_log('.........l_cp_name = '||l_cp_name);

	print_log('Starting Check_Rpt_Versions....');

	if (l_exists_val > 0) then

select r.IS_SUB_REQUEST, r.HAS_SUB_REQUEST into l_is_sub_req, l_has_sub_req
from fnd_concurrent_requests r
where r.request_id = req_id;

if (l_is_sub_req='Y') then
print_log('*************************************Request_id is a CHILD Request');
else
print_log('*************************************Request_id is NOT a CHILD request');
end if;

if (l_has_sub_req='Y') then
print_log('*************************************Request_id has a CHILD Request');
else
print_log('*************************************Request_id has NO CHILD request');
end if;

if (l_rpt_method_code = 'Oracle Reports') THEN
print_log('Starting Oracle Report Check_Rpt_Versions....');
select "Top", "Filename", "Subdir", "Version"
into l_prodtop, l_filename, l_subdir, l_version
from ( select af1.APP_SHORT_NAME "Top", af1.filename "Filename", 
       af1.subdir "Subdir", afv1.version "Version",
 ...
 order by afv1.version_segment1 desc,
	 ...
	 afv1.translation_level desc) as rank 
from ad_files af1, ad_file_versions afv1
where af1.file_id = afv1.file_id
and af1.filename = (select execution_file_name||'.rdf' "Report"
                     from fnd_executables
                     where executable_id = (select p.EXECUTABLE_ID
                                 from apps.fnd_concurrent_programs p, apps.fnd_concurrent_requests r
                                where r.CONCURRENT_PROGRAM_ID = p.CONCURRENT_PROGRAM_ID
                                  and r.program_application_id = p.application_id
                                  and r.request_id = req_id))
...
elsif (l_rpt_method_code = 'PL/SQL Stored Procedure') THEN
print_log('Starting PL/SQL Procedure Report Check_Rpt_Versions....');
select upper(substr(execution_file_name,1,(instr(execution_file_name, '.')-1))) "Package"
into l_package
  from fnd_executables
  where executable_id = (select p.EXECUTABLE_ID
			from apps.fnd_concurrent_programs p, apps.fnd_concurrent_requests r
		...
		print_log('Package is : '||l_package||'.');
		
			select substr(text,3,75) 
			into l_spec
			from dba_source 
			where owner = 'APPS' 
			and name = l_package
			and type = 'PACKAGE' and line = 2;
	 
		print_log('l_spec is : '||l_spec||'.');
			...
			where owner = 'APPS' 
			and name = l_package
			and type = 'PACKAGE BODY' and line = 2;
			
		print_log('l_body is : '||l_body||'.');
		
			select status into l_pkg_status
			from dba_objects
			where object_name = l_package
			and object_type = 'PACKAGE'
			and owner = 'APPS';
			
		print_log('l_pkgb_status is : '||l_pkg_status||'.');

			select status into l_pkgb_status
			from dba_objects
			where object_name = l_package
			and object_type = 'PACKAGE BODY'
			and owner = 'APPS';
			
		print_log('l_pkgb_status is : '||l_pkgb_status||'.');	

/* **************  This is checking for Java Concurrent Program entries **************************** */
	elsif (l_rpt_method_code = 'Java Concurrent Program') THEN
	print_log('Starting Java Concurrent Program Check_Rpt_Versions....');
	select "Top", "Filename", "Subdir", "Version"
	into l_prodtop, l_filename, l_subdir, l_version
	from ( select af1.APP_SHORT_NAME "Top", af1.filename "Filename", af1.subdir "Subdir", afv1.version "Version",
	   rank()over(partition by af1.filename
		 order by afv1.version_segment1 desc,
			 afv1.version_segment2 desc,afv1.version_segment3 desc,
			 afv1.version_segment4 desc,afv1.version_segment5 desc,
		...
		from ad_files af1, ad_file_versions afv1
		where af1.file_id = afv1.file_id
		and af1.filename = (select execution_file_name||'.class' "Java Concurrent Program"
	  			     from fnd_executables
				 where executable_id = (select p.EXECUTABLE_ID 
						  from apps.fnd_concurrent_programs p, apps.fnd_concurrent_requests r
                        where r.CONCURRENT_PROGRAM_ID = p.CONCURRENT_PROGRAM_ID
                          and r.program_application_id = p.application_id
                          and r.request_id = req_id))
				and af1.subdir like '%java%')
			where rank = 1;	

		print_log('Java Concurrent Program is running : $'||l_prodtop||'_TOP/'||l_subdir||'/'||l_filename||' version: '||l_version||'.');
			

		/* **************  This is checking for SQL*Plus entries ********************************************************************** */
			elsif (l_rpt_method_code = 'SQL*Plus') THEN
		print_log('Starting SQL*Plus Report Check_Rpt_Versions....');
			select "Top", "Filename", "Subdir", "Version"
			into l_prodtop, l_filename, l_subdir, l_version
			from ( select af1.APP_SHORT_NAME "Top", af1.filename "Filename", af1.subdir "Subdir", afv1.version "Version",
				   rank()over(partition by af1.filename
				...
				from ad_files af1, ad_file_versions afv1
				where af1.file_id = afv1.file_id
				and af1.filename = (select execution_file_name||'.sql' "SQL*Plus"
							  from fnd_executables
							 where executable_id = (select p.EXECUTABLE_ID
									  from apps.fnd_concurrent_programs p, apps.fnd_concurrent_requests r
                        where r.CONCURRENT_PROGRAM_ID = p.CONCURRENT_PROGRAM_ID
                          and r.program_application_id = p.application_id
                          and r.request_id = req_id))
										and af1.subdir like '%sql%')
			   where rank = 1;	

		print_log('SQL*Plus is running : $'||l_prodtop||'_TOP/'||l_subdir||'/'||l_filename||' version: '||l_version||'.');
										
		end if;
	else
		l_version := 'No Version found';
		
	end if;
end if;

select count(rownum) into l_req_id_xml 
from FND_CONCURRENT_REQUESTS r
where r.OUTPUT_FILE_TYPE='XML'
and r.PP_START_DATE is not NULL
and r.request_id = req_id;

if (l_req_id_xml=0) then
   print_log('Request ID:'||req_id||' Output_File_Type is not XML, so skipping the Output Post Processing Section');
end if; 

select value into l_instance_nls
...
END into l_DBbanner from dual where rownum=1;
  ...
  g_instance_nls := l_instance_nls;
  g_tl_cnt := l_tl_cnt;
  g_reqid_cnt := l_reqid_cnt;
  g_err_cnt := l_err_cnt;
  g_canprt := l_canprt;
  g_cantprt := l_cantprt;
  g_valid_reqid := l_exists_val;
  g_request_id := req_id;
  ...
  g_rpt_method_code := l_rpt_method_code;
  g_prodtop := l_prodtop;
  ...
  g_body := l_body;
  g_package := l_package;
  g_pkg_status := l_pkg_status;
  g_pkgb_status := l_pkgb_status;
  g_cp_name := l_cp_name;
  g_req_id_xml := l_req_id_xml;
  g_is_sub_req := l_is_sub_req;
  g_has_sub_req := l_has_sub_req;
...
print_log('g_request_id= '||g_request_id);
print_log('g_rpt_method_code= '||g_rpt_method_code);
print_log('g_valid_reqid= '||g_valid_reqid);
print_log('g_is_sub_req= '||g_is_sub_req);
print_log('g_has_sub_req= '||g_has_sub_req);
...
select ''$''||af1.APP_SHORT_NAME||''_TOP/'' "Top", af1.subdir||''/'' "Subdir",af1.filename "Filename",
  ...
  from ad_files af1, ad_file_versions afv1
where af1.file_id = afv1.file_id
  and af1.filename like ''FNDRSRUN%'')
where rankUS = 1',
      p_title                  => 'Identify the version of FNDRSRUN',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no version for FNDRSRUN form.',
      p_solution               => 'Please recompile FND Forms, following this blog reference http://madhanappsdba.blogspot.com/2014/12/how-to-compile-oracle-apps-r12-forms.html.',
      p_success_msg            => 'Validating the FNDRSRUN Form version.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
...
debug('begin add_signature: RPT1_CHAR_SET');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2462',
      p_sig_id                 => 'RPT1_CHAR_SET',
      p_sig_sql                => 'select parameter, value
  from nls_database_parameters
 where parameter = ''NLS_CHARACTERSET''
',
      p_title                  => 'Character Set Used',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This identifies the character set that is used on the instance which impacts report output.',
      p_solution               => 'Please verify the value of the character-set used is correct for this instance within the table above if report output is not formatted as expected. <br>
	  If it is not, please contact the operating system administrator for correction.',
      p_success_msg            => 'Please verify the value of the character+set used is correct for this instance within the table above if report output is not formatted as expected. <br>
	  If it is not, please contact the operating system administrator for correction.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: RPT1_CHAR_SET');



debug('begin add_signature: RPT1_NLS_TERRITORY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2463',
      p_sig_id                 => 'RPT1_NLS_TERRITORY',
      p_sig_sql                => 'select language_code, nls_language, nls_territory, nls_codeset, last_update_date
  from fnd_languages
 where language_code in (select userenv(''LANG'') from dual)',
      p_title                  => 'NLS_TERRITORY variable Used',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This identifies what the NLS_TERRITORY enviroment variable is set to. <br>
	  If not set properly, reports may result in numeric data as to an expected language in text or can generate ORA-20100 errors in the report log files.',
      p_solution               => '<ul>Ensure the correct NLS_TERRITORY variable above is properly set for this instance. <br>
          If it is not, please contact the operating system administrator to set it as required.
	   <li>For more information on the NLS_TERRITORY variable, please refer to:</li>
       <li>[1496915/KB87986] - Overview of Oracle Database Initialization Parameters</li> 
	   <li>[261693/KB627197] - Concurrent Processing - Troubleshooting Concurrent Request ORA-20100 errors in the request logs</li>
     </ul>',
      p_success_msg            => 'This identifies what the NLS_TERRITORY enviroment variable is set to. <br>
	  If not set properly, reports may result in numeric data as to an expected language in text or can generate ORA-20100 errors in the report log files.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: RPT1_NLS_TERRITORY');



debug('begin add_signature: RPT1_VARIABLES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2461',
      p_sig_id                 => 'RPT1_VARIABLES',
      p_sig_sql                => 'select sysdate from dual
',
      p_title                  => 'Variables that Impact Reports',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This identifies Variables that Impact Reports. <br>
	  If not set properly, reports may result in numeric data as to an expected language in text or can generate ORA-20100 errors in the report log files.',
      p_solution               => '<ul>Please ensure the correct Character Set used and the NLS_TERRITORY variable above is properly set for this instance. <br>
      If it is not, please contact the operating system administrator to set it as required.
      </ul>',
      p_success_msg            => 'This identifies what the Character Set and NLS_TERRITORY enviroment variable are set to. <br>
	  If not set properly, reports may result in numeric data as to an expected language in text or can generate ORA-20100 errors in the report log files.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('RPT1_CHAR_SET','RPT1_NLS_TERRITORY'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '12'
      );
   l_info.delete;
debug('end add_signature: RPT1_VARIABLES');



debug('begin add_signature: RPT1_LONG_RUN_RPTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1120',
      p_sig_id                 => 'RPT1_LONG_RUN_RPTS',
      p_sig_sql                => 'select p.user_concurrent_program_name, count(r.request_id),
       round(avg((nvl(r.actual_completion_date,sysdate) - r.actual_start_date) * 1440), 2) "AVG",
       round(min((nvl(r.actual_completion_date,sysdate) - r.actual_start_date) * 1440), 2) "MIN",
       round(max((nvl(r.actual_completion_date,sysdate) - r.actual_start_date) * 1440), 2) "MAX"
       from fnd_concurrent_requests r, fnd_concurrent_processes c,
            fnd_concurrent_queues q, fnd_concurrent_programs_vl p
       where
      ...
      p_title                  => 'Long Running Reports or Requests During Business Hours',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are long running Reports or Requests During Business Hours<br>
	   The intent is to proactively identify requests which could represent potential performance problems.',
      p_solution               => 'Review the Reports Requests listed and confirm if they are intended to run for longer amounts of time.<br> 
	   If the wrong date range is used or a large volume of data exists for the request, a longer run time can be expected.<br>
	   Monthly, Quarterly, and Yearly reports typically run longer.<br><br>
	   For more information, please refer to [134035/KB627830] - Concurrent Processing - ANALYZEREQ.SQL Detailed Analysis of One Concurrent Request (Release 11 and up).',
      p_success_msg            => 'There are no long running Reports or Requests During Business Hours.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: RPT1_LONG_RUN_RPTS');



debug('begin add_signature: RPT1_OUTPUT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1139',
      p_sig_id                 => 'RPT1_OUTPUT',
      p_sig_sql                => 'select unique variable_name, value
      ...
      p_title                  => 'Location of Report output and Log files',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is a problem identifying the Location of Report output and Log files',
      p_solution               => 'Verify the Location of Report output and Log files',
      p_success_msg            => 'The Application Reports and Logs are in the location of: $APPLCSF/$APPLLOG/$APPLOUT reflected in the table above<br> OR <br>
	   in the Product Log/Out directories if the $APPLCSF/$APPLOUT environment variables are not set.
	   <ul>
	    For Reports, from the operating system command prompt, enter the following command to identify the location: <b>echo $APPLOUT</b><br>
		For Logs, from the operating system command prompt, enter the following command to identify the location: <b>echo $APPLLOG</b>
	   </ul>
		<b>NOTE:</b> If the $APPLLOG/$APPLOUT environment variables are not set, it places the files under the product top of the application associated with the request.<br>For example, a PO report would go under PO_TOP/APPLLOG and PO_TOP/APPLOUT.<br>
		Example location Report files would go to: /u01/appl/po/9.0/out<br>
		Example location Logfiles would go to: /u01/appl/po/9.0/log<br><br>
		For more information on the Log and Out directories, please refer to [105133/FAQ6959] - Concurrent Processing - Concurrent Manager Generic Platform Questions and Answers<br><br>

		For more information on APPLTMP and APPLPTMP temp directories, please refer to [1355735/KB707634] - Difference between APPLPTMP and APPLTMP Directories in EBS.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: RPT1_OUTPUT');
...
debug('begin add_signature: RPT1_BAD_REQ2');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11100',
      p_sig_id                 => 'RPT1_BAD_REQ2',
      p_sig_sql                => 'select request_id from fnd_concurrent_requests 
where request_id =  '||mask_text(g_request_id, nvl( upper(''), 'NO_MASK') )||'',
      p_title                  => 'Single Request ID ##$$REQID$$##',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is a problem identifying the Request ID '||mask_text(g_request_id, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => 'Please verify the Request ID submitted (##$$REQID$$##) is for this instance '||mask_text(g_instance, nvl( upper(''), 'NO_MASK') )||', and try again.<br><br>
For more information, please review instructions in : <br>
[1610143/KB539680] - EBS Reports & Printing Analyzer.

',
      p_success_msg            => 'Request ID  '||mask_text(g_request_id, nvl( upper(''), 'NO_MASK') )||' is found.',
   ...
   l_info.delete;
debug('end add_signature: RPT1_BAD_REQ2');
...
debug('begin add_signature: BIPXDO_OPP_RUNTIME_PROPS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '446',
      p_sig_id                 => 'BIPXDO_OPP_RUNTIME_PROPS',
   ...
   ORDER BY xcv.config_level, xcp.CATEGORY, xcp.sort_order',
      ...
      p_fail_condition         => '[count(rownum)]<[4]',
...
<li>For more information see [737311/KB358344] and [1410160/KB789809]</li>
   ...
   l_info.delete;
debug('end add_signature: BIPXDO_OPP_RUNTIME_PROPS');



debug('begin add_signature: BIPXDO_OPP_TIMEOUT_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('Profile-value'):= '[PROFILE_VALUE] < [300]';
  add_signature(
      p_sig_repo_id            => '445',
      p_sig_id                 => 'BIPXDO_OPP_TIMEOUT_CHECK',
      p_sig_sql                => 'select
...
<li>If your request still completes in warning status, the next step is to increase the number of processes and threads available for OPP</li>
<li><strong>Concurrent:OPP Process Timeout</strong> - specifies the amount of time the manager waits for the OPP to actually process the request
<ul>
...
<li>For more information see [352518/KB717296] and [862644/FAQ3670]</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: BIPXDO_OPP_TIMEOUT_CHECK');



debug('begin add_signature: RPT2_OPP_SCALABLE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5106',
      p_sig_id                 => 'RPT2_OPP_SCALABLE_CHECK',
...
And C.Concurrent_Program_Name = (Select Fcp.Concurrent_Program_Name From Fnd_Concurrent_Programs Fcp, Fnd_Concurrent_Requests Fcr
                                  Where Fcr.Concurrent_Program_Id = Fcp.Concurrent_Program_Id
                                    And Fcr.Request_Id =''##$$REQID$$##'')
Order By F.Descriptive_Flexfield_Name, F.Column_Seq_Num',
      p_title                  => 'Scalable Flag Setting',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Scalable Flag Parameter Option is not set for this Concurrent Program.
',
      p_solution               => 'Set the Scalable Flag parameter (P_SCALABLE_FLAG) to Y to avoid issues of high data volume causing memory exceptions.
<p>For more information, see the [1410160/KB789809] to Set the Scalable Option to on for issues of high data volume causing memory exceptions.</p>
<p>As an Example: This prevents this error in the Subledger Accounting program''s log: Calling XDO Data Engine... <blockquote><span style="color: #ff0000;"><em>****Warning!!! Due to high volume of data, got out of memory exception...***<br>****Please retry with scalable option or modify the Data template to run in scalable mode...*** </em></span></blockquote></p>
<p><strong>Steps to Configure:</strong></p>
<li>1. As System Administrator: Navigate to Concurrent-&gt;Program-&gt;Define.</li>
<li>2. Query up the report: Account Analysis Report (do this for both the General Ledger and the Subledger Accounting program definitions).</li>
<li>3. Add a parameter: ScalableFlag. Value set should be yes_no Default value should be Y.</li>
<li>Select checkboxes Enable and Required.</li>
...
<p>Token needs to be ScalableFlag (this is a case sensitive value).</p>',
      p_success_msg            => 'The Scalable_Flag Option is enabled for this Concurrent Program.</br> 
This option will help handle any issues of high data volume which could cause memory exceptions.<br><br>
<p>For more information, see the [1410160/KB789809] to Set the Scalable Option to on for issues of high data volume causing memory exceptions.</p>',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: RPT2_OPP_SCALABLE_CHECK');



debug('begin add_signature: PRT_TEST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1130',
      p_sig_id                 => 'PRT_TEST',
      p_sig_sql                => 'select ''Perform a Printer Test here.'' "Steps to" from dual',
      p_title                  => 'Printer Test',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Test each Printer from the Command Line.',
      p_solution               => 'Test Printing from the Operating System command line to ensure a Printer can Print.<br><br>
       Please use the following command for Unix or Windows operating systems to perform a printer test where (printer_name) is the name of your printer and (report_file_name) is the name of your report.
		<br><ul>
		Unix:<br>
		lp -d (printer_name) (report_file_name)
		<br><br>
		Windows:<br>
		print /d:\server(printer_name) (report_file_name)</ul>
		<b>Printing Notes:</b><br>
		One must be able to successfully print to a printer from the Operating System command line in order to print Oracle Application Reports.<br><br>
		For more information on this, please refer to [112172/KB408144] - Oracle Applications Character Printing',
      p_success_msg            => 'Test Printing from the Operating System command line to ensure a Printer can Print.<br><br>
       Please use the following command for Unix or Windows operating systems to perform a printer test where (printer_name) is the name of your printer and (report_file_name) is the name of your report.
		<br><ul>
		Unix:<br>
		lp -d (printer_name) (report_file_name)
   ...
   l_info.delete;
debug('end add_signature: PRT_TEST');



debug('begin add_signature: PRT_PROFILES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1131',
      p_sig_id                 => 'PRT_PROFILES',
      p_sig_sql                => 'select t.PROFILE_OPTION_ID, t.PROFILE_OPTION_NAME, z.USER_PROFILE_OPTION_NAME, v.PROFILE_OPTION_VALUE, z.DESCRIPTION
       from fnd_profile_options t, fnd_profile_option_values v, fnd_profile_options_tl z
       where (v.PROFILE_OPTION_ID (+) = t.PROFILE_OPTION_ID)
       and (v.level_id = 10001)
       and (z.LANGUAGE=''US'') 
       and (z.PROFILE_OPTION_NAME = t.PROFILE_OPTION_NAME)
       and (t.PROFILE_OPTION_NAME in (''CONC_COPIES'', ''PRINTER'',''PRINTER:TYPE'',''MAX_PAGE_LENGTH'',''CONC_FORCE_LOCAL_OUTPUT_FILE_MODE''))
       order by z.USER_PROFILE_OPTION_NAME',
      p_title                  => 'Printer Profile Options',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The <b><i>Concurrent: Report Copies</b></i> profile option value is set to zero.<br>
	   This is fine for testing, but is commonly set to 1 when printing is required.',
      p_solution               => 'Please review the values for the profile options below to ensure they are properly set for this instance.<br><br>
	   <b>Profile Option Notes:</b><ul>
		Since the <b><i>Concurrent: Report Copies</b></i> Profile Option VALUE is set to zero, <b>NO REPORTS WILL PRINT</b>.<br> Please ensure the value for Concurrent:Report Copies Profile Option is set properly.<br><br>
		If the <b><i>Maximum Page Length</b></i> Profile Option is Set, the Default Printer (if set) will use the maximum page length for Printing Applications Reports. The profile should only be set for use of a default maximum page length.<br><br>
		If the <b><i>Printer</b></i> Profile Option is Not Set, a Default Printer will not be set for Printing Applications Reports where the VALUE in the table should be NULL. The profile should only be set for use of a default printer.<br><br>
		If the <b><i>Printer:Type</b></i> Profile Option is Set, the Default Printer (if set) will use that printer type for Printing Applications Reports. The profile should only be set for use of a default printer type.<br></ul>  
		For more information, please refer to [297522/KB616611] - How To Investigate Printing Issues and Work Towards its Resolution?',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PRT_PROFILES');



debug('begin add_signature: APPL_PRINTERS');
   l_info('##MASK##USER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1121',
      p_sig_id                 => 'APPL_PRINTERS',
      p_sig_sql                => 'select p.printer_name, p.printer_type, p.last_update_date, u.user_name
       from fnd_printer p, fnd_user u
       where u.user_id = p.last_updated_by',
      p_title                  => 'Application Printers Defined for '||mask_text(g_instance, nvl( upper(''), 'NO_MASK') )||'',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no Application Printers Defined for instance '||mask_text(g_instance, nvl( upper(''), 'NO_MASK') )||'',
      p_solution               => 'Verify the Application Printers Defined for instance '||mask_text(g_instance, nvl( upper(''), 'NO_MASK') )||'.<br><br>
For more information, please refer to [269129/KB782749] - How to Implement Printing for Oracle Applications: Getting Started',
      p_success_msg            => 'Available list of Application Printers that have been defined on '||mask_text(g_instance, nvl( upper(''), 'NO_MASK') )||'<br><br>
For more information, please refer to [269129/KB782749] - How to Implement Printing for Oracle Applications: Getting Started',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: APPL_PRINTERS');



debug('begin add_signature: PRINTABLE_PRGMS2');
   l_info('##COMPLEX_TYPE##'):= 'W';
debug('begin add_signature: PRINTABLE_PRGMS2');
   l_info('Comments'):= 'There are '||to_char(g_canprt,'999,999,999,999')||' Programs on the '||g_rep_info('Instance')||' instance with the Print Flag Set to Y, so we have limited the output of this query to show a sampling only.<br>Run the query in the blue box below to get a full list.';
  add_signature(
      p_sig_repo_id            => '3132',
      p_sig_id                 => 'PRINTABLE_PRGMS2',
      p_sig_sql                => 'select r.CONCURRENT_PROGRAM_ID ID, r.print_flag, r.CONCURRENT_PROGRAM_NAME NAME
	from fnd_concurrent_programs r
	where r.print_flag = ''Y''',
      p_title                  => 'Programs that can be printed',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no reports or concurrent programs that can be printed on '||g_rep_info('Instance')||', with Print Flag set to Y',
      p_solution               => 'To enable a report or program to be able to print, change the Print Flag setting to Y.<br>
	 <ul>
     <li>The Print Flag indicates whether the Concurrent Manager can or cannot print the output of the Concurrent Program.<br>
         Use the following query to identify any Concurrent Programs that you currently use and how this Print Flag parameter is set. </li>
     <blockquote>
        select r.CONCURRENT_PROGRAM_ID ID, r.print_flag, r.CONCURRENT_PROGRAM_NAME NAME,<br> 
	p.USER_CONCURRENT_PROGRAM_NAME PROGRAM, p.DESCRIPTION<br>
	FROM fnd_concurrent_programs r, FND_CONCURRENT_PROGRAMS_TL p, fnd_concurrent_programs fcp<br>
	WHERE r.CONCURRENT_PROGRAM_ID = p.CONCURRENT_PROGRAM_ID<br>
	and p.CONCURRENT_PROGRAM_ID = fcp.CONCURRENT_PROGRAM_ID<br>
	and p.USER_CONCURRENT_PROGRAM_NAME like ''&Enter%Program%Name%Here%''<br>
	and p.LANGUAGE = ''US'';
	</blockquote></ul>
	 Please refer to [269129/KB782749] - How to Implement Printing for Oracle Applications: Getting Started',
      p_success_msg            => 'There are '||to_char(g_canprt,'999,999,999,999')||' Programs on this Instance with the Print Flag Set to Y, and '||to_char(g_cantprt,'999,999,999,999')||' that cannot print, or Print Flag Set to N.
	<ul>
     <li>The Print Flag indicates whether the Concurrent Manager can or cannot print the output of the Concurrent Program.<br>
         Use the following query to identify any Concurrent Programs that you currently use and how this Print Flag parameter is set. </li>
     <blockquote>
	...
	and p.LANGUAGE = ''US'';
     ...
     <b>If you wish to change the Print Flag for any Concurrent Program:</b>
     <ul>
     <li>To change this, the Concurrent Program Print Flag should be set to Y to Print a Report. To change the value:</li>
     <ol>
     <li>Edit the Concurrent Program Name definition within Applications. (Navigate:Concurrent/Program/Define). </li>
     <li>Query the program that is not printing. </li>
     <li>Change the Print Flag value from N to Y and save. When the program is run again, the output should be printed.</li>
     </ol>
     </ul>
     <b>NOTE:</b> Not all requests run need to be printed. For any that do not print and should, please confirm the Print Flag is set to Y witin the program definition reflected above.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRINTABLE_PRGMS2');
   l_info.delete;
debug('end add_signature: PRINTABLE_PRGMS2');
...
debug('begin add_signature: RPT1_CONC_REQ1');
   l_info('##COMPLEX_TYPE##'):= 'W';
  add_signature(
      p_sig_repo_id            => '2464',
      p_sig_id                 => 'RPT1_CONC_REQ1',
	 ...
	 order by to_char(actual_completion_date,''YYYY'') desc',
      p_title                  => 'Your overall Reports Purging HealthCheck Status is in need of Immediate Review!',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The data in the FND_CONCURRENT_REQUESTS Table suggests Reports Purging is never performed on a regular basis.<br>
	 There are <b>'||to_char(g_reqid_cnt,'999,999,999,999')||'</b> Report Requests that can be purged from a total of all <b>'||to_char(g_tl_cnt,'999,999,999,999')||'</b> Concurrent requests eligible to purge.  <BR>
	 There are <b>'||to_char(g_err_cnt,'999,999,999,999')||'</b> Errored Report Requests.',
      p_solution               => '<ul>Adopt these Purging guidelines running the Purge Concurrent Request and/or Manager Data request according to business needs:<br><br>
	 <li>Every 30 days for normal usage.</li>
	 <li>Every two weeks (14 days) for heavy usage.</li>
	 <li>If using the AGE mode, set the Mode Value to 7 or higher to retain
	   the most recent days of concurrent request data, log files, and report output
	   files.</li> 
	<b>For optimum purging, the request could be scheduled to run on a daily
	   basis off hours using the AGE that best meets the business needs.</ul>
	 <b>Note: When you purge concurrent request information, you lose audit details
	 which are used by the Signon Audit Concurrent Requests report.<br><br></b>
	 For more information on Purging Reports and Requests, please refer to: [104282/KB627426] Concurrent Processing - Purge Concurrent Request and/or Manager Data Program (FNDCPPUR).',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: RPT1_CONC_REQ1');



debug('begin add_signature: RPT1_CONC_REQ2');
   l_info('##COMPLEX_TYPE##'):= 'W';
  add_signature(
      p_sig_repo_id            => '2465',
      p_sig_id                 => 'RPT1_CONC_REQ2',
      p_sig_sql                => 'select to_char(actual_completion_date,''YYYY'') "COMPLETED", count(request_id) "COUNT" 
	 from fnd_concurrent_requests where phase_code=''C''
	 and ofile_size >0
	 group by to_char(actual_completion_date,''YYYY'')
	 order by to_char(actual_completion_date,''YYYY'') desc',
      p_title                  => 'Your overall Reports Purging HealthCheck Status is in need of Review!',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The data in the FND_CONCURRENT_REQUESTS Table suggests Reports Purging is not performed as often as required.<BR>
	 There are <b>'||to_char(g_reqid_cnt,'999,999,999,999')||'</b> Report Requests that can be purged from a total of all <b>'||to_char(g_tl_cnt,'999,999,999,999')||'</b> Concurrent requests eligible to purge.  <BR>
 	 There are <b>'||to_char(g_err_cnt,'999,999,999,999')||'</b> Errored Report Requests.',
      p_solution               => '<ul>Adopt these Purging guidelines running the Purge Concurrent Request and/or Manager Data request according to business needs:
	 <li>Every 30 days for normal usage.</li>
	 <li>Every two weeks (14 days) for heavy usage.</li>
	 <li>If using the AGE mode, set the Mode Value to 7 or higher to retain the most recent days of concurrent request data, log files, and report output files.</li>
	<b>For optimum purging, the request could be scheduled to run on a daily basis off hours using the AGE that best meets the business needs.</ul>
	Note: When you purge concurrent request information, you lose audit details which are used by the Signon Audit Concurrent Requests report.<br><br>
	For more information on Purging Reports and Requests, please refer to: [104282/KB627426] Concurrent Processing - Purge Concurrent Request and/or Manager Data Program (FNDCPPUR)',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: RPT1_CONC_REQ2');



debug('begin add_signature: RPT1_CONC_REQ3');
   l_info('##COMPLEX_TYPE##'):= 'I';
  add_signature(
      p_sig_repo_id            => '2466',
      p_sig_id                 => 'RPT1_CONC_REQ3',
      p_sig_sql                => 'select to_char(actual_completion_date,''YYYY'') "COMPLETED", count(request_id) "COUNT" 
	 from fnd_concurrent_requests where phase_code=''C''
	 and ofile_size >0
	 group by to_char(actual_completion_date,''YYYY'')
	 order by to_char(actual_completion_date,''YYYY'') desc',
      p_title                  => 'Your overall Reports Purging HealthCheck Status is Healthy!',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The data in the FND_CONCURRENT_REQUESTS Table suggests Reports Purging is performed on a regular basis.<br>
	 There are <b>'||to_char(g_reqid_cnt,'999,999,999,999')||'</b> Report Requests from a total of all <b>'||to_char(g_tl_cnt,'999,999,999,999')||'</b> Concurrent requests eligible to purge.<br>
	 There are <b>'||to_char(g_err_cnt,'999,999,999,999')||'</b> Errored Report Requests.<br><br>
	Please continue running the Purge Concurrent Request and/or Manager Data request according to your business needs.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: RPT1_CONC_REQ3');



debug('begin add_signature: RPT1_SINGLE_REQ_JAVACP');
   l_info('##COMPLEX_TYPE##'):= 'I';
  add_signature(
      p_sig_repo_id            => '3508',
      p_sig_id                 => 'RPT1_SINGLE_REQ_JAVACP',
      p_sig_sql                => 'select r.request_id "REQ ID", 
		a.application_name "APPLICATION", 
		t.user_concurrent_program_name "CONCURRENT PROGRAM",
		p.concurrent_program_name "NAME",
		DECODE(p.execution_method_code, ''A'',''A = Spawned'',
		''B'',''B = Request Set Stage Function'',''E'',''E = Perl Concurrent Program'',
		''F'',''F = FlexSql'',''H'',''H = Host'',''I'',''I = PL/SQL Stored Procedure'',
		''J'',''J = Java Stored Procedure'',''K'',''K = Java Concurrent Program'',''L'',''L = SQL*Loader'',
		''M'',''M = Multi Language Function'',''P'',''P = Oracle Reports'',''Q'',''Q = SQL*Plus'',
		''R'',''R = SQL*Report'',''S'',''S = Immediate'',''X'',''X = FlexRpt'',
		''Z'',''Z = Shutdown Callback'') "METHOD", 
		p.execution_options "OPTIONS", 
		p.output_file_type "FILE TYPE",
		p.save_output_flag "SAVE OUTPUT", 
		p.required_style "STYLE",
		TO_CHAR(r.actual_completion_date, ''DD-MON-RR HH24:MI:SS'') "COMPLETED",
		r.nls_language "LANG",
		r.nls_territory "TERR",
		r.nls_codeset "CODESET",
		r.is_sub_request "IS SUB REQ",
		...
		r.completion_text "COMPLETION",
		r.output_file_type "FILE TYPE",
		r.number_of_copies "# COPIES",
		s.WIDTH "WIDTH",
		s.LENGTH "LENGTH",
		...
		apps.fnd_languages l, APPS.FND_PRINTER_STYLES s
		...
		and printer_style_name in (''LANDSCAPE'')
		and r.request_id = ''##$$REQID$$##''',
      p_title                  => 'Request ID '||g_request_id||' Analysis for Java Concurrent Program',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is a problem identifying the Analysis of a Java Concurrent Program Report',
      p_solution               => '',
      p_success_msg            => 'Click on the Arrow above to display the details for Java Concurrent Program Request ID '||g_request_id||'.<br>
	  This Java Concurrent Program Report executed : $'||g_prodtop||'_TOP/'||g_subdir||'/'||g_filename||', version : '||g_version||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('RPT1_SINGLE_REQ3','RPT1_SINGLE_REQ2'),
      p_include_in_dx_summary  => nvl('Y','Y')
      );
   l_info.delete;
   l_info.delete;
debug('end add_signature: RPT1_SINGLE_REQ_JAVACP');



debug('begin add_signature: RPT1_SINGLE_REQ_ORPTS');
   l_info('##COMPLEX_TYPE##'):= 'I';
  add_signature(
      p_sig_repo_id            => '3507',
      p_sig_id                 => 'RPT1_SINGLE_REQ_ORPTS',
      p_sig_sql                => 'select r.request_id "REQ ID", 
		a.application_name "APPLICATION", 
		t.user_concurrent_program_name "CONCURRENT PROGRAM",
		p.concurrent_program_name "NAME",
		...
		and printer_style_name in (''LANDSCAPE'')
		and r.request_id = ''##$$REQID$$##''',
      p_title                  => 'Request ID '||g_request_id||' Analysis for Oracle Report',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is a problem identifying the Analysis of a Single Oracle Reports request ID '||g_request_id||'.',
      p_solution               => '',
      p_success_msg            => 'Click on the Arrow above to display the details for Oracle Reports Request ID '||g_request_id||'.<br>
	  This Oracle Report is : $'||g_prodtop||'_TOP/'||g_subdir||'/'||g_filename||' version '||g_version||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: RPT1_SINGLE_REQ_ORPTS');



debug('begin add_signature: RPT1_SINGLE_REQ_PKG');
   l_info('##COMPLEX_TYPE##'):= 'I';
  add_signature(
      p_sig_repo_id            => '3506',
      p_sig_id                 => 'RPT1_SINGLE_REQ_PKG',
      p_sig_sql                => 'select r.request_id "REQ ID", 
		a.application_name "APPLICATION", 
		t.user_concurrent_program_name "CONCURRENT PROGRAM",
		p.concurrent_program_name "NAME",
		...
		and printer_style_name in (''LANDSCAPE'')
		and r.request_id = ''##$$REQID$$##''',
      p_title                  => 'Request ID '||g_request_id||' Analysis for PL/SQL Stored Procedure',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is a problem identifying the Analysis of a PL/SQL Stored Procedure Report',
      p_solution               => '',
      p_success_msg            => 'Click on the Arrow above to display the details for PL/SQL Stored Procedure Request ID '||g_request_id||'.<br>
	  This PL/SQL Procedure Report called package '||g_package||', version :<br>
	  SPEC: '||g_spec||'.<br>
	  BODY: '||g_body||'.<br><br>
	  Verified package '||g_package||' is currently '||g_pkg_status||',<br>
	  and also that the package body is currently '||g_pkgb_status||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: RPT1_SINGLE_REQ_PKG');



debug('begin add_signature: RPT1_SINGLE_REQ_SQL');
   l_info('##COMPLEX_TYPE##'):= 'I';
  add_signature(
      p_sig_repo_id            => '3505',
      p_sig_id                 => 'RPT1_SINGLE_REQ_SQL',
      p_sig_sql                => 'select r.request_id "REQ ID", 
		a.application_name "APPLICATION", 
		t.user_concurrent_program_name "CONCURRENT PROGRAM",
		p.concurrent_program_name "NAME",
		...
		and printer_style_name in (''LANDSCAPE'')
		and r.request_id = ''##$$REQID$$##''',
      p_title                  => 'Request ID '||g_request_id||' Analysis for SQL*Plus',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is a problem identifying the Analysis of a SQL*Plus Report',
      p_solution               => '',
      p_success_msg            => 'Click on the Arrow above to display the details for SQL*Plus Request ID '||g_request_id||'.<br>
	  This SQL*Plus Report executed : $'||g_prodtop||'_TOP/'||g_subdir||'/'||g_filename||', version : '||g_version||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: RPT1_SINGLE_REQ_SQL');



debug('begin add_signature: RPT1_SINGLE_REQ');
   l_info('##COMPLEX_TYPE##'):= 'I';
  add_signature(
      p_sig_repo_id            => '3518',
      p_sig_id                 => 'RPT1_SINGLE_REQ',
      p_sig_sql                => 'select r.request_id "REQ ID", 
		a.application_name "APPLICATION", 
		t.user_concurrent_program_name "CONCURRENT PROGRAM",
		p.concurrent_program_name "NAME",
		...
		and printer_style_name in (''LANDSCAPE'')
		and r.request_id = ''##$$REQID$$##''',
      p_title                  => 'Single Request ID '||g_request_id||'  Analysis',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is a problem identifying the Analysis of this Single Report',
      p_solution               => '',
      p_success_msg            => 'Click on the Arrow above to display the details for this '||g_rpt_method_code||',  Request ID '||g_request_id||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: RPT1_SINGLE_REQ');



debug('begin add_signature: RPT1_SINGLE_REQ2');
   l_info('##COMPLEX_TYPE##'):= 'I';
add_signature(
      p_sig_repo_id            => '3511',
      p_sig_id                 => 'RPT1_SINGLE_REQ2',
      p_sig_sql                => 'select r.request_id "REQ ID", p.print_flag "PRINT",
		p.output_print_style "PRINT STYLE",  d.platform_code, p.required_style "REQ STYLE",
		d.PRINTER_DRIVER_NAME "PRINTER DRIVER", d.USER_PRINTER_DRIVER_NAME "USER PRINTER DRIVER",
		r.printer "PRINTER NAME", n.printer_type "PRINTER TYPE", r.print_style "OUTPUT PRINT STYLE",
		i.printer_style "PRINTER STYLE", i.printer_driver "PRINTER DRIVER", d.srw_driver "SRW DRIVER", s.WIDTH "WIDTH", s.LENGTH "LENGTH", s.ORIENTATION "ORIENTATION",
		printer_driver_method_code "PRT DRV METHOD", spool_flag "SPOOL FLAG", stdin_flag "STD INPUT FLAG",
		d.command_name "COMMAND NAME", d.arguments "ARGUMENTS", d.initialization "PRINTER INITIALIZATION STRING", 
		d.RESET "RESET STRING"
		FROM apps.fnd_concurrent_programs_tl t,
		apps.fnd_concurrent_programs p, apps.fnd_application_tl a,
		apps.fnd_concurrent_requests r, apps.fnd_printer n,
		apps.fnd_printer_information i, apps.fnd_printer_drivers d,
		...
		and printer_style_name in (''LANDSCAPE'')
		and r.request_id = ''##$$REQID$$##''    ',
      p_title                  => 'Printing Details for Request ID '||g_request_id||' ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is a problem identifying the Printing details for Request ID '||g_request_id||'.',
      p_solution               => '',
      p_success_msg            => 'Click on the Arrow above to display the Printing details for Request ID '||g_request_id||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: RPT1_SINGLE_REQ2');



debug('begin add_signature: RPT1_SINGLE_REQ3');
   l_info('##COMPLEX_TYPE##'):= 'I';
  add_signature(
      p_sig_repo_id            => '3512',
      p_sig_id                 => 'RPT1_SINGLE_REQ3',
      p_sig_sql                => 'select r.request_id "REQ ID",
		...
		and printer_style_name in (''LANDSCAPE'')
		and r.request_id = ''##$$REQID$$##''    ',
      p_title                  => 'Report & Log Locations for Request ID '||g_request_id||' ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is a problem identifying the Report & Log Locations for Request ID '||g_request_id||'.',
      p_solution               => '',
      p_success_msg            => 'Click on the Arrow above to display the Report & Log Locations for Request ID '||g_request_id||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: RPT1_SINGLE_REQ3');



debug('begin add_signature: RPT1_CHILD_REQ');
   l_info('##COMPLEX_TYPE##'):= 'I';
add_signature(
      p_sig_repo_id            => '5093',
      p_sig_id                 => 'RPT1_CHILD_REQ',
      p_sig_sql                => 'select r.request_id "CHILD REQ ID", r.parent_request_id "PARENT REQ", 
		a.application_name "APPLICATION",
		t.user_concurrent_program_name "CONCURRENT PROGRAM",
		p.concurrent_program_name "NAME",
		DECODE(p.execution_method_code, ''A'',''A = Spawned'',
    ...
    r.completion_text "COMPLETION"
		...
		and r.concurrent_program_id  = t.concurrent_program_id 
		And T.Concurrent_Program_Id  = P.Concurrent_Program_Id
		and r.parent_request_id = ''##$$REQID$$##''',
      p_title                  => 'Request ID '||g_request_id||' also has a Child Request',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is a problem identifying the child request of this Request_id',
      p_solution               => '',
      p_success_msg            => 'Click on the Arrow above to display the details for the Child Request_id of this '||g_rpt_method_code||',  Request ID '||g_request_id||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: RPT1_CHILD_REQ');



debug('begin add_signature: RPT1_PARENT_REQ');
   l_info('##COMPLEX_TYPE##'):= 'I';
add_signature(
      p_sig_repo_id            => '5092',
      p_sig_id                 => 'RPT1_PARENT_REQ',
      p_sig_sql                => 'select r.request_id "PARENT REQ ID", 
                a.application_name "APPLICATION",
		t.user_concurrent_program_name "CONCURRENT PROGRAM",
		p.concurrent_program_name "NAME",
		DECODE(p.execution_method_code, ''A'',''A = Spawned'',
    ...
    r.completion_text "COMPLETION"
		...
		and r.concurrent_program_id  = t.concurrent_program_id 
		And T.Concurrent_Program_Id  = P.Concurrent_Program_Id
		And R.Request_Id = (Select X.Parent_Request_Id From Fnd_Concurrent_Requests X Where X.Request_Id =''##$$REQID$$##'')',
      p_title                  => 'Request ID '||g_request_id||' also has a Parent Request',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is a problem identifying the Analysis of the Parent Request',
      p_solution               => '',
      p_success_msg            => 'Click on the Arrow above to display the details for the Parent Request of this '||g_rpt_method_code||',  Request ID '||g_request_id||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: RPT1_PARENT_REQ');
...
''TK_PRINTER'',''TNS_ADMIN'',''TWO_TASK'',''XDO_TOP'',''XENVIRONMENT'', ''APPLLDM'',''APPCPNAM'')
...
Refer to [2302177/KB762153] - No Data Generated in Logs and Out Files after Setting APPLLDM Environment Variable',
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: CP1_ENV1');
...
Refer to [2302177/KB762153] - No Data Generated in Logs and Out Files after Setting APPLLDM Environment Variable',
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: CP1_ENV2');
...
Refer to [2302177/KB762153] - No Data Generated in Logs and Out Files after Setting APPLLDM Environment Variable',
   ...
   l_info.delete;
   l_info.delete;
debug('end add_signature: CP1_ENV3');



debug('begin add_signature: RPT1_PROFILE');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##PROFILE_OPTION_VALUE'):= ',#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '1135',
      p_sig_id                 => 'RPT1_PROFILE',
      p_sig_sql                => 'select t.PROFILE_OPTION_ID, t.PROFILE_OPTION_NAME, z.USER_PROFILE_OPTION_NAME, v.PROFILE_OPTION_VALUE, z.DESCRIPTION
       from fnd_profile_options t, fnd_profile_option_values v, fnd_profile_options_tl z
       where (v.PROFILE_OPTION_ID (+) = t.PROFILE_OPTION_ID)
       and (v.level_id = 10001)
       and (z.LANGUAGE=''US'') 
       and (z.PROFILE_OPTION_NAME = t.PROFILE_OPTION_NAME)
       and (t.PROFILE_OPTION_NAME in (''ICX_CLIENT_IANA_ENCODING'',''FND_NATIVE_CLIENT_ENCODING'',''CONC_REPORT_ACCESS_LEVEL'',''CONC_PRIORITY''))
       order by z.USER_PROFILE_OPTION_NAME',
      p_title                  => 'Reports Profile Options',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Reports Profile Options are not set',
      p_solution               => '<ul> 
       ...
       <li>Refer to [356501/KB592761] for How to Setup Pasta Quickly and Effectively</li> 
     </ul>',
      p_success_msg            => 'The Profile Option values for <b>ICX: Client IANA Encoding</b> and <b>FND: Native Client Encoding</b> both match the Instance NLS_CHARACTERSET value of '||mask_text(g_instance_nls, nvl( upper(''), 'NO_MASK') )||' for instance '||mask_text(g_instance, nvl( upper(''), 'NO_MASK') )||', so BIP and PASTA are configured correctly<br>
	  For more information, please refer [356501/KB592761] - How to Setup Pasta Quickly and Effectively',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: RPT1_PROFILE');



debug('begin add_signature: RPT1_PROFILE2');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##PROFILE_OPTION_VALUE'):= ',#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '1136',
      p_sig_id                 => 'RPT1_PROFILE2',
      p_sig_sql                => 'select t.PROFILE_OPTION_ID, t.PROFILE_OPTION_NAME, z.USER_PROFILE_OPTION_NAME, v.PROFILE_OPTION_VALUE, z.DESCRIPTION
       from fnd_profile_options t, fnd_profile_option_values v, fnd_profile_options_tl z
       where (v.PROFILE_OPTION_ID (+) = t.PROFILE_OPTION_ID)
       and (v.level_id = 10001)
      ...
      p_title                  => 'Reports Profile Options',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The Profile Option Values for <b>ICX: Client IANA Encoding</b> and <b>FND: Native Client Encoding</b> both do not match the NLS_CHARACTERSET value '||mask_text(g_instance_nls, nvl( upper(''), 'NO_MASK') )||' for instance '||mask_text(g_instance, nvl( upper(''), 'NO_MASK') )||', so BIP and PASTA are not configured correctly.<br>
',
      p_solution               => '<ul>To correctly configure BIP and Pasta, please refer to [356501/KB592761] - How to Setup Pasta Quickly and Effectively
     </ul>',
      p_success_msg            => 'This section displays Profile Options that can affect how Reports work.<BR>
	 <BR><b>Action:</b><BR> Please review the values for the profile options above to ensure they are properly set for this instance.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: RPT1_PROFILE2');



debug('begin add_signature: RPT1_PROFILE_11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1137',
      p_sig_id                 => 'RPT1_PROFILE_11I',
      p_sig_sql                => 'select release_name from fnd_product_groups',
      p_title                  => 'Reports Profile for 11i',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Reports Profile for 11i are not set',
      p_solution               => '<ul> 
       <li>In Oracle Applications 11i there is a profile option: <b>Concurrent: Report Access Level</b> that defines who can access the output of concurrent requests.<br></li>
       <li>It can be set to "Site", "User", or "Responsibility".<br>  When set to Responsibility, the responsibility the report was created under must be assigned to the user who wishes to view the report.<BR></li> 
	   <li>If you wish to change this, modify the value of the <b>Concurrent:Report Access Level</b> profile option to meet the needs for the instance.  <BR><br></li>
	   <li>For more information, please refer to [736547/KB728394] - Concurrent Processing - Settings for Profile Option "Concurrent Report Access Level" <br></li>
	   </ul>',
      p_success_msg            => 'This identifies what the Reports Profile for 11i. <br>
	  If not set properly, reports may result in numeric data as to an expected language in text or can generate ORA-20100 errors in the report log files.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: RPT1_PROFILE_11I');



debug('begin add_signature: RPT1_PROFILE_12');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1138',
      p_sig_id                 => 'RPT1_PROFILE_12',
      p_sig_sql                => 'select release_name from fnd_product_groups',
      p_title                  => 'Reports Profile for Release 12',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Reports Profile for 12 are not set',
      p_solution               => '',
      p_success_msg            => 'This identifies what the Reports Profile for R12. <br>
	  The profile option: <b>Concurrent: Report Access Level</b> in R12 was replaced by Role Based Access Control.<br>
      The UMX Role Based Access Control (RBAC) is used to control who can view request output files.<BR><br>
      Please see the E-Business Suite <a href="http://docs.oracle.com/cd/E18727_01/doc.121/e12893.pdf" target="_blank"> System Administrators Guide - Configuration</a> for details on RBAC.<br>',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: RPT1_PROFILE_12');
...
BEGIN
  ...
  analyzer_title := 'Reports and Printing Analyzer';
...
debug('begin section: E_Business_Reports_Analysis');
start_section('E-Business Reports Analysis', 'E_Business_Reports_Analysis');
   set_item_result(run_stored_sig('EBS_ATG_AT_TECHSTACK_CLASSIC'));
if (g_reqid_cnt < 100) THEN
--	show_data_gauge;
	set_item_result(run_stored_sig('RPT1_CONC_REQ3'));

	elsif (g_reqid_cnt > 99) THEN
--		show_gauge_chart;

		if (g_reqid_cnt > 5000) THEN
			set_item_result(run_stored_sig('RPT1_CONC_REQ1'));

			elsif (g_reqid_cnt > 3500) THEN
			set_item_result(run_stored_sig('RPT1_CONC_REQ2'));
...
if (g_valid_reqid > 0) then
   if (g_rpt_method_code = 'Oracle Reports') THEN
	   set_item_result(run_stored_sig('RPT1_SINGLE_REQ_ORPTS'));
     elsif (g_rpt_method_code = 'PL/SQL Stored Procedure') THEN
	   set_item_result(run_stored_sig('RPT1_SINGLE_REQ_PKG'));
     elsif (g_rpt_method_code = 'SQL*Plus') THEN
	   set_item_result(run_stored_sig('RPT1_SINGLE_REQ_SQL'));	 
     elsif (g_rpt_method_code = 'Java Concurrent Program') THEN
	   set_item_result(run_stored_sig('RPT1_SINGLE_REQ_JAVACP'));		   
     else
           set_item_result(run_stored_sig('RPT1_SINGLE_REQ'));
   end if;

   if (g_is_sub_req = 'Y') then
           set_item_result(run_stored_sig('RPT1_PARENT_REQ'));
   end if;
  
   if (g_has_sub_req = 'Y') then
           set_item_result(run_stored_sig('RPT1_CHILD_REQ'));
   end if;
   ...
   set_item_result(check_rec_patches_1); /* Signature CHECK_RPT_PATCHES */
   set_item_result(run_stored_sig('CP1_FNDRSRUN'));
   set_item_result(run_stored_sig('RPT1_VARIABLES'));
   set_item_result(run_stored_sig('RPT1_LONG_RUN_RPTS'));
check_profile_options;

if (g_rep_info('prof1') <> g_rep_info('prof2')) then
  set_item_result(run_stored_sig('RPT1_PROFILE2'));
else
  set_item_result(run_stored_sig('RPT1_PROFILE'));
end if;

if ((g_rep_info('Apps Version') > '11.5') and (g_rep_info('Apps Version') < '12.0')) then
  set_item_result(run_stored_sig('RPT1_PROFILE_11I'));
elsif (g_rep_info('Apps Version') > '12.0') then
  set_item_result(run_stored_sig('RPT1_PROFILE_12'));
end if;	
   set_item_result(run_stored_sig('RPT1_OUTPUT'));
   set_item_result(run_stored_sig('CP3_CPADV17'));
   set_item_result(run_stored_sig('RPT1_BAD_REQ2'));
end_section;
debug('end section: E_Business_Reports_Analysis');

debug('begin section: PostProcessing');
  IF (g_req_id_xml>0) THEN

      start_section('Post Processing');
 
        print_log('Request ID:'||req_id||' has Output_File_Type of XML, so adding the Output Post Processing Section');

        --need COMPLEX section for this:
        set_item_result(run_stored_sig('RPT2_OPP_SCALABLE_CHECK'));
        ...
        set_item_result(run_stored_sig('BIPXDO_OPP_RUNTIME_PROPS'));
        set_item_result(run_stored_sig('BIPXDO_OPP_TIMEOUT_CHECK'));
  ...
  END IF;
debug('end section: PostProcessing');

debug('begin section: E_Business_Printing_Analysis');
start_section('E-Business Printing Analysis', 'E_Business_Printing_Analysis');
   set_item_result(run_stored_sig('PRT_TEST'));
   set_item_result(check_rec_patches_2); /* Signature check_prt_patches */
   set_item_result(run_stored_sig('PRT_PROFILES'));
   set_item_result(run_stored_sig('APPL_PRINTERS'));
   set_item_result(run_stored_sig('PRINTABLE_PRGMS2'));
end_section;
debug('end section: E_Business_Printing_Analysis');
