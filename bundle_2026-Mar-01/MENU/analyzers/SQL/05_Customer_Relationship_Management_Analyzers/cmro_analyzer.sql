...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Complex Maintenance Repair and         |
...
CREATE OR REPLACE PACKAGE cmro_analyzer_pkg AUTHID DEFINER AS
...
PROCEDURE main
(            p_visit_id                     IN NUMBER      DEFAULT NULL
           ,p_workorder_id                 IN VARCHAR2    DEFAULT NULL
           ,p_mr_header_id                 IN VARCHAR2    DEFAULT NULL
...
END cmro_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY cmro_analyzer_pkg AS
-- $Id: cmro_analyzer.sql, 200.19 2026/01/28 17:38:17 svedula Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2201872.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'CMRO_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'CMRO_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>CMRO Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2201872.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/AHL_Latest_Version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,566,EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,566,EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},566,EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/3885325" class="blacklink" target="new">
...
<div class="ck-content"><p><strong>Version 200.19 01/28/2026</strong></p><ul><li>Signature PREMIER_SUPPORT signatures updated</li>
...
<p>&nbsp;</p><p><strong>Version 200.18 11-Dec-2025</strong><br>
-----<br>
Signature AC_TABLE_INDEXES has been updated<br>
Signature EBS_ATG_UGLE_SEQUENCES_CLOSE_TO_MAXIMUM_VALUE has been updated</p><p>&nbsp;</p><p><strong>Version 200.17 24-Apr-2025</strong><br>
<strong>---------</strong><br>
<strong>Added two new signatures:&nbsp;</strong><br>
EBS_CRM_SC_CMRO_FREEZE_KFF_CHECK - <span class="display_only apex-item-display-only" id="P18_TITLE_DISPLAY" data-escape="true">KFF Definition Not Frozen</span><br>
Visit Task Schedule Materials<br>
<br>
Version 200.16 26-SEP-2024<br>
----------<br>
signature updates</p><p>Version 200.15 17-JUL-2024<br>
----------</p><p>Signature updates</p><p>&nbsp;</p><p>Version 200.14&nbsp;<br>
---------<br>
Added a new Signature: <span class="display_only apex-item-display-only" id="P18_TITLE_DISPLAY">CMRO Visit Item Instance having Open Repair Orders</span></p><p>Version 200.12&nbsp;<br>
----------------<br>
Added the following new signatures:</p><p>a) Indexes with FAILED value for DOMIDX_OPSTATUS column<br>
b) DBA Objects reaching MAX# of Extents</p><p>Version 200.11:<br>
-----------------<br>
Added a new Signature: CMRO Sequences Reaching Maximum Value.</p><p>Version 200.10:<br>
-----------------<br>
Analyzer Framework 4.6.0.1 version released.</p><p>Version 200.9:<br>
-----------------<br>
Analyzer Framework 4.5.9.1 version released.</p><p>Version 200.8:<br>
-----------------<br>
Lifetime Support Policy: Premier Support for R12.1.3 customers updated.</p><p>Version 200.7:<br>
-----------------<br>
Lifetime Support Policy<br>
New Analyzer Framework version 4.5.7 released with these changes:<br>
Summary of signatures that failed at the end of the log<br>
Signature Version Reported in Analyzer Output<br>
Remove unnecessary icons for signatures with no data<br>
Fixed DB Name character string buffer too small</p></div>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,566,'||p_sig.sigrepo_id||',EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,566,'||p_sig.sigrepo_id||',EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},566,'||p_sig.sigrepo_id||',EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
FUNCTION check_rec_patches_1 RETURN VARCHAR2 IS
  /* Signature CMRO RECOMMENDED PATCHES */
...
BEGIN
    ...
    print_log('Processing recommended patches signature: CMRO RECOMMENDED PATCHES (check_rec_patches_1) "CMRO Recommended Patches" (version 5)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(1)(l_rows) := '21948002';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Complex MRO Recommended Patch Collection (October/2015)';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21500294';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.2.3:Dependent BPEL processes in Complex MRO(AHL) fail to deploy at Weblogic server restart';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '20732584';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.2.2:SPECIAL CHARACTERS SHOWN IN STANDARD ERROR MESSAGES AND LOV';
   l_col_rows(5)(l_rows) := NULL;
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '10210767';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.1.3.1: cMRO Rollup Patch';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '8624319';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.1.1:Consolidated Bug Fixes Patch - Jun 15th 2009';
   l_col_rows(5)(l_rows) := NULL;
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.0' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '7202897';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'cMRO:12.0.7 : Rollup Patch';
   l_col_rows(5)(l_rows) := NULL;
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33537135';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.2.8: CMRO ROUTE MANAGEMENT PAGE DFF DOES NOT STORE VALUE SET ID';
   l_col_rows(5)(l_rows) := '[2825529.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33224749';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.2.5+ UNABLE TO ENTER OPERATION QUALITY RESULTS FROM WORKBENCH';
   l_col_rows(5)(l_rows) := '[2804211.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33530018';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'When assigning items to a Unit Configuration Position the Assign Item region is not displaying any records';
   l_col_rows(5)(l_rows) := '[2865551.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '34411971';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'MARSHALING WB RESERVATION ONLY CONSIDERING UC ITEMS';
   l_col_rows(5)(l_rows) := '[2904100.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35891785';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'CMRO Material Issue Page Lot Number Field Has a 30 Character Limit';
   l_col_rows(5)(l_rows) := '[3007500.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37378431';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'The Validation Of The Scheduling Hierarchy Has Failed';
   l_col_rows(5)(l_rows) := '[3069049.1]';

END IF;

   l_extra_info('##SHOW_SQL##'):= 'Y';

   l_sig.sigrepo_id := '3094';
   l_sig.title := 'CMRO Recommended Patches';
   ...
   l_sig.solution := 'Above are the recommended patches for this product area as of 17-OCT-16. For the most
current recommendations, use the Patch Wizard or the Updates &amp;
Patches Tab in My Oracle Support. Further guidance can be found in the
following documents:
<br>
<ul>
<li>[11086538/KA747] How to Find EBS Patches and EBS Technology Patches
</li>
<li>[976188/KB739927] R11i / R12 : Patch Wizard Utility<br>
</li>
<li>[10940175/KA580] Patch Wizard FAQ
</li>
</ul>
Best Practice: Always ensure that you are on the latest code with all
recommended patches applied. This will help avoid known issues, prevent
potential data corruption and provide the latest features and
functionality. Having a proactive patching plan and periodic proactive
patching process in place are the best ways to stay current.';
   l_sig.success_msg := '';
  ...
  -- Register
  l_step := '60';
  g_signatures('CMRO RECOMMENDED PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'CMRO RECOMMENDED PATCHES',     -- sig ID
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Visit Id';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_visit_id,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Workorder Id';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_workorder_id,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'MR Id';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_mr_header_id,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/01/28 17:38:16 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'cmro_analyzer.sql';
...
debug('begin parameter validation: p_visit_id');
...
WHERE VISIT_ID = p_visit_id
 AND (mo_global.is_mo_init_done = 'N' or mo_global.check_access(ORGANIZATION_ID) = 'Y')
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Enter a valid Visit Id.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_visit_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_visit_id');

debug('begin parameter validation: p_workorder_id');
IF p_workorder_id IS NOT NULL THEN
BEGIN
SELECT WORKORDER_ID
INTO l_exists_val
FROM AHL_WORKORDERS
WHERE WORKORDER_ID = p_workorder_id and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Enter a valid Workorder Id.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_workorder_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_workorder_id');

debug('begin parameter validation: p_mr_header_id');
IF p_mr_header_id IS NOT NULL THEN
BEGIN
SELECT MR_HEADER_ID
INTO l_exists_val
FROM AHL_MR_HEADERS_B
WHERE MR_HEADER_ID = p_mr_header_id and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Enter a valid MR Header Id.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_mr_header_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_mr_header_id');
...
--Subba added on 22-05-2024
select nvl(ITEM_INSTANCE_ID, null) into g_inst_id from ahl_visits_b where visit_id = p_visit_id;
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$VISIT_ID$$##') := p_visit_id;
   g_masked_tokens('##$$VISIT_ID$$##') := mask_text( g_sql_tokens('##$$VISIT_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$WO_ID$$##') := p_workorder_id;
   g_masked_tokens('##$$WO_ID$$##') := mask_text( g_sql_tokens('##$$WO_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$MR_ID$$##') := p_mr_header_id;
   g_masked_tokens('##$$MR_ID$$##') := mask_text( g_sql_tokens('##$$MR_ID$$##'), 'NO_MASK');
   ...
   g_sql_tokens('##$$INSTANCEID$$##') := g_inst_id;
   g_masked_tokens('##$$INSTANCEID$$##') := mask_text( g_sql_tokens('##$$INSTANCEID$$##'), 'NO_MASK');
...
debug('begin add_signature: CMRO INVALIDS');
   l_info('##MASK##TEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2984',
      p_sig_id                 => 'CMRO INVALIDS',
...
FROM dba_objects a, dba_errors b
    ...
    AND a.owner = ''APPS''
    AND a.object_name like ''AHL%''
    AND a.status = ''INVALID''',
      p_title                  => 'CMRO Invalid Objects',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invalid CMRO objects exists.',
      p_solution               => 'Recompile the individual objects manually or recompile the entire APPS schema with adadmin utility. Review any error messages provided.',
      p_success_msg            => 'No CMRO invalid objects exists in the database.',
   ...
   l_info.delete;
debug('end add_signature: CMRO INVALIDS');



debug('begin add_signature: CMRO_COMPLETED_REQUESTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3633',
      p_sig_id                 => 'CMRO_COMPLETED_REQUESTS',
      p_sig_sql                => 'SELECT 
...
and f.application_short_name = ''AHL''
GROUP BY c.request_class_name,
  ...
  r.priority
ORDER BY COUNT(*)',
      p_title                  => 'CMRO Concurrent Requests Performance Statistics',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This section identifies the total time duration for recently completed AHL (CMRO) requests.',
      p_solution               => 'Check the latest performance related fixes on [1366009/KB421410].',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CMRO_COMPLETED_REQUESTS');



debug('begin add_signature: CMRO_LATEST_COMPLETED_REQUESTS');
   l_info('##MASK##ARGUMENT_TEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMPLETION_TEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4899',
      p_sig_id                 => 'CMRO_LATEST_COMPLETED_REQUESTS',
      p_sig_sql                => 'SELECT ptl.USER_CONCURRENT_PROGRAM_NAME,
  r.REQUEST_ID,
  DECODE(r.PHASE_CODE, ''C'', ''Completed'', ''I'', ''Inactive'', ''P'', ''Pending'', ''R'', ''Running'', NULL) PHASE_CODE,
  DECODE(r.STATUS_CODE, ''A'', ''Waiting'', ''B'', ''Resuming'', ''C'', ''Normal'', ''D'', ''Cancelled'', ''E'', ''Error'', ''F'', ''Scheduled'', ''G'', ''Warning'', ''H'', ''On Hold'', ''I'', ''Normal'', ''M'', ''No Manager'', ''Q'', ''Standby'', ''R'', ''Normal'', ''S'', ''Suspended'', ''T'', ''Terminating'', ''U'', ''Disabled'', ''W'', ''Paused'', ''X'', ''Terminated'', ''Z'', ''Waiting'', NULL) STATUS_CODE,
...
AND (p.CONCURRENT_PROGRAM_NAME LIKE ''AHL%''
OR p.CONCURRENT_PROGRAM_NAME LIKE ''CMRO%'')
AND r.program_application_id = p.application_id
AND r.concurrent_program_id  = p.concurrent_program_id
ORDER BY request_id DESC',
      p_title                  => 'Latest Submitted CMRO Concurrent Requests',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This section identifies the ordered list of AHL concurrent requests (latest on top) and their attributes.',
      p_solution               => 'Please review the list of the most recent AHL concurrent requests and address any issues with your DBA.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CMRO_LATEST_COMPLETED_REQUESTS');
...
debug('begin add_signature: EBS_CRM_SC_CMRO_FREEZE_KFF_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31380',
      p_sig_id                 => 'EBS_CRM_SC_CMRO_FREEZE_KFF_CHECK',
      p_sig_sql                => 'SELECT
...
FROM
    ...
    fnd_application    fap,
    fnd_application_tl fapt
WHERE
    fif.application_id = fap.application_id
    ...
    and fap.application_id IN (##$$APPS_PARAM1$$##, ##$$APPS_PARAM2$$##, ##$$APPS_PARAM3$$##, ##$$APPS_PARAM4$$##, ##$$APPS_PARAM5$$##, 0)
    AND nvl(fifs.FREEZE_FLEX_DEFINITION_FLAG, ''N'') = ''N''
    AND fapt.language = userenv(''LANG'')
ORDER BY
    fap.application_id,
    fif.id_flex_name',
      p_title                  => 'KFF Definition Not Frozen',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are KFF definition in the instance which are not frozen.  Such KFF fields will not work correctly on the application and may encounter error. For example: Operation Codes display as X in CMRO Work order & Route Management',
      p_solution               => 'See the  [833209/KB857630] for solution.',
      p_success_msg            => 'All AHL(CMRO) KFF''s are frozen.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_CMRO_FREEZE_KFF_CHECK');



debug('begin add_signature: VISIT_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3264',
      p_sig_id                 => 'VISIT_ID',
      p_sig_sql                => 'SELECT visit_id FROM ahl_visits_vl WHERE visit_id = ##$$VISIT_ID$$##',
      p_title                  => 'Visit ID',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Visit ID.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: VISIT_ID');



debug('begin add_signature: VISIT_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3095',
      p_sig_id                 => 'VISIT_DETAILS',
      p_sig_sql                => 'SELECT avts.visit_id,
  avts.visit_number,
  avtstl.visit_name,
  ...
  aspvtl.simulation_plan_name,
  NVL(aspv.primary_plan_flag, ''Y''),
  csab.incident_number,
  uc.name unit_name,
  pa.name project_template_name,
  avts.inv_locator_id
FROM ahl_visits_b avts,
  ahl_visits_tl avtstl,
  ahl_simulation_plans_b aspv,
  ahl_simulation_plans_tl aspvtl,
...
AND avts.visit_id             = ##$$VISIT_ID$$##
',
      p_title                  => 'Visit Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Visit Details.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: VISIT_DETAILS');



debug('begin add_signature: VISIT_TASKS');
   l_info('##MASK##DEPARTMENT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ITEM_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MR_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ROUTE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##STAGE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TASK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TASK_TYPE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##UNIT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3096',
      p_sig_id                 => 'VISIT_TASKS',
      p_sig_sql                => 'SELECT DISTINCT visit_id,
  task_number,
  task_id,
  item_name,
  instance_number,
...
',
      p_title                  => 'Visit Tasks Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Visit Tasks.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: VISIT_TASKS');



debug('begin add_signature: VISIT_MRS');
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3102',
      p_sig_id                 => 'VISIT_MRS',
      p_sig_sql                => 'SELECT atsk.visit_task_id,
  amrh.mr_header_id,
  csiv.incident_id,
  csiv.incident_number,
  csiv.summary,
  amrh.title,
  amrh.description,
  amrh.type_code,
  ...
  avst.status_code v_status_code,
  atsk.status_code t_status_code,
  atsk.object_version_number,
  DECODE(NVL(TO_CHAR(amrh.mr_header_id), ''F''), ''F'', ''F'', ''T'') COSTICONENABLEFLAG
FROM ahl_visits_vl avst,
  ahl_visit_tasks_vl atsk,
  ahl_mr_headers_vl amrh,
  mtl_system_items_b_kfv mtsb,
  csi_item_instances csis,
  cs_incidents_all_vl csiv
WHERE atsk.instance_id          = csis.instance_id(+)
AND atsk.mr_id                  = amrh.mr_header_id(+)
...
AND avst.visit_id               = atsk.visit_id
AND atsk.service_request_id     = csiv.incident_id(+)
AND(originating_task_id        IS NOT NULL
OR(atsk.originating_task_id    IS NULL
AND NOT EXISTS
  (SELECT 1
  FROM ahl_visit_tasks_b
  WHERE visit_id         = avst.visit_id
  AND service_request_id = atsk.service_request_id
  AND mr_id             IS NOT NULL
  )))
AND atsk.mr_id
  || atsk.service_request_id IS NOT NULL
AND atsk.visit_id             = ##$$VISIT_ID$$##',
      p_title                  => 'Visit Maintenance Requirements',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Visit Maintenance Requirements.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: VISIT_MRS');



debug('begin add_signature: VISIT_STAGES');
   l_info('##MASK##STAGE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3103',
      p_sig_id                 => 'VISIT_STAGES',
      p_sig_sql                => 'SELECT s.stage_id,
  s.stage_num,
  s.stage_name,
...
ORDER BY s.stage_num',
      p_title                  => 'Visit Stages',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Visit Stages.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: VISIT_STAGES');



debug('begin add_signature: VISIT_CURRENCY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3244',
      p_sig_id                 => 'VISIT_CURRENCY',
      p_sig_sql                => 'SELECT currency_code
FROM cst_acct_info_v cod,
  gl_sets_of_books gsob
WHERE cod.organization_id =
  (SELECT vst.organization_id
  FROM ahl_visits_b vst
  WHERE vst.visit_id = ##$$VISIT_ID$$##
  )
AND ledger_id                                           = gsob.set_of_books_id
AND NVL(operating_unit, mo_global.get_current_org_id()) = mo_global.get_current_org_id()',
      p_title                  => 'Visit Currency',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Visit Currency.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: VISIT_CURRENCY');



debug('begin add_signature: VISIT_MASTER_WO');
   l_info('##MASK##WORKORDER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3097',
      p_sig_id                 => 'VISIT_MASTER_WO',
      p_sig_sql                => 'SELECT workorder_name,
  workorder_id
FROM ahl_workorders
WHERE master_workorder_flag = ''Y''
AND visit_id                =
  (SELECT visit_id FROM ahl_visits_vl WHERE visit_id = ##$$VISIT_ID$$##
  )
AND visit_task_id IS NULL',
      p_title                  => 'Visit Master Work Order',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Visit Master Work Order.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: VISIT_MASTER_WO');



debug('begin add_signature: VISIT_UC_HEADER');
   l_info('##MASK##NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3243',
      p_sig_id                 => 'VISIT_UC_HEADER',
      p_sig_sql                => 'SELECT name,
  unit_config_header_id
FROM ahl_unit_config_headers
WHERE csi_item_instance_id =
  (SELECT item_instance_id FROM ahl_visits_vl WHERE visit_id = ##$$VISIT_ID$$##
  )
AND active_end_date IS NULL',
      p_title                  => 'Visit Unit Configuration Header',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Visit Unit Configuration Header Information.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: VISIT_UC_HEADER');



debug('begin add_signature: VISIT_IB_ERRORED_TRANSACTIONS');
   l_info('##MASK##ERROR_TEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MESSAGE_STRING'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SERIAL_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4901',
      p_sig_id                 => 'VISIT_IB_ERRORED_TRANSACTIONS',
      p_sig_sql                => 'SELECT *
FROM csi_txn_errors
WHERE inventory_item_id IN
  ...
  WHERE visit_id =
    ##$$VISIT_ID$$##
      ...
      p_title                  => 'Visit IB Errored Transactions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Install Base(IB) Errored Transactions exists in CSI_TXN_ERRORS table for the specific Visit''s Inventory Item found in AHL_VISITS_VL.',
      p_solution               => 'For fixing the Install Base(IB) Errored Transactions follow the recommendations from notes:
Install Base Transaction Error Diagnostic Program [1501025/KB540052]
and
EBS Install Base Analyzer [1597450/KB193165]',
      p_success_msg            => 'No Install Base(IB) Errored Transactions exists in CSI_TXN_ERRORS table for the specific Visit''s Inventory Item found in AHL_VISITS_VL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: VISIT_IB_ERRORED_TRANSACTIONS');



debug('begin add_signature: EBS_CRM_SC_CMRO_VST_SCHED_MAT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30574',
      p_sig_id                 => 'EBS_CRM_SC_CMRO_VST_SCHED_MAT',
      p_sig_sql                => 'SELECT 
...
WHERE 
	ASM.RT_OPER_MATERIAL_ID = ARM.RT_OPER_MATERIAL_ID(+)
	AND ASM.STATUS IN (''ACTIVE'',''IN-SERVICE'')
	AND ASM.MATERIAL_REQUEST_TYPE = ''PLANNED''
	AND ASM.WORKORDER_OPERATION_ID IS NULL
	AND ASM.VISIT_ID = ##$$VISIT_ID$$##
	ORDER BY ASM.VISIT_TASK_ID ASC',
      p_title                  => 'Visit Task Schedule Materials',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'When updating VWP Material Schedule, error is displayed
ORA-01400: cannot insert NULL into ("AHL"."AHL_WO_OPERATIONS_TXNS"."WORKORDER_OPERATION_ID") in Package AHL_PP_MATERIALS_PVT Procedure UPDATE_MATERIAL_REQST
',
      p_solution               => 'Refer to the [2602828/KB290931] - CMRO-VWP Update Material Schedule Error: ORA-01400: cannot insert NULL',
      p_success_msg            => 'Visit Task Schedule Materials can be updated successfully as the WORKORDER_OPERATION_ID has a non-null value',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_CMRO_VST_SCHED_MAT');



debug('begin add_signature: EBS_CRM_SC_CMRO_REPAIR_ORDER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29079',
      p_sig_id                 => 'EBS_CRM_SC_CMRO_REPAIR_ORDER',
      p_sig_sql                => 'SELECT
    COUNT(*)
FROM
    csd_repairs cr
WHERE
        cr.status <> ''C''
    AND ( cr.customer_product_id = ##$$INSTANCEID$$##
          OR EXISTS (
        SELECT
            ''X''
        FROM
            csd_product_txns_v cptv
        WHERE
                cptv.repair_line_id = cr.repair_line_id
            AND ( cptv.source_instance_id = ##$$INSTANCEID$$##
                  OR cptv.non_source_instance_id = ##$$INSTANCEID$$## )) )',
      p_title                  => 'CMRO Visit Item Instance having Open Repair Orders',
      p_fail_condition         => '[count(*)] > [0]',
      p_problem_descr          => 'When trying to change the serial number of the item in the CMRO Workorder, following error appears:

Cannot update the INVENTORY_ITEM_ID OR SERIAL_NUMBER, as the Item Instance you are trying to update has Open Repair Orders.',
      p_solution               => 'Please refer to the solution in [2753756/KB679230]',
      p_success_msg            => 'No open repair orders referencing the CMRO Visit item instance exists..',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_CMRO_REPAIR_ORDER');



debug('begin add_signature: WORKORDER_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3098',
      p_sig_id                 => 'WORKORDER_ID',
      p_sig_sql                => 'SELECT workorder_id FROM ahl_workorders WHERE workorder_id = ##$$WO_ID$$##',
      p_title                  => 'Work Order ID',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Work Order ID.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: WORKORDER_ID');



debug('begin add_signature: WORKORDER_DETAILS');
   l_info('##MASK##DEPARTMENT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MR_TITLE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PROJECT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PROJECT_TASK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SERIAL_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##UNIT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3099',
      p_sig_id                 => 'WORKORDER_DETAILS',
      p_sig_sql                => 'SELECT workorder_id,
  job_number,
  visit_task_number,
  department_name,
  organization_name,
...
WHERE workorder_id = ##$$WO_ID$$##',
      p_title                  => 'Work Order Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Work Order Details.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: WORKORDER_DETAILS');



debug('begin add_signature: WORKORDER_OPERATIONS');
   l_info('##MASK##DEPARTMENT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3226',
      p_sig_id                 => 'WORKORDER_OPERATIONS',
      p_sig_sql                => 'SELECT operation_sequence_num,
  operation_code,
  description,
  actual_start_date,
  actual_end_date,
...
WHERE workorder_id = ##$$WO_ID$$##',
      p_title                  => 'Work Order Operations',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Work Order Operations',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: WORKORDER_OPERATIONS');



debug('begin add_signature: WORKORDER_DISPOSITIONS');
   l_info('##MASK##ITEM_GROUP_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SERIAL_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3227',
      p_sig_id                 => 'WORKORDER_DISPOSITIONS',
      p_sig_sql                => 'SELECT disposition_id,
  part_change_id,
  path_position_id,
  position_reference,
  inventory_item_id,
  ...
  item_group_id,
  item_group_name
FROM ahl_prd_dispositions_v dis
WHERE workorder_id = ##$$WO_ID$$##',
      p_title                  => 'Work Order Dispositions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Work Order Dispositions.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: WORKORDER_DISPOSITIONS');



debug('begin add_signature: RESOURCE_ASSIGNMENTS');
   l_info('##MASK##EMPLOYEE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##RESOURCE_TYPE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SERIAL_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3228',
      p_sig_id                 => 'RESOURCE_ASSIGNMENTS',
      p_sig_sql                => 'SELECT DISTINCT assignment_id,
  job_id,
  employee_name,
  employee_number,
  resource_type_name,
  ...
  NULL ROWCHANGEDFLAG,
  self_assigned_flag
FROM ahl_pp_assignment_v
WHERE job_id = ##$$WO_ID$$##
ORDER BY operation_sequence,
  resource_sequence',
      p_title                  => 'Work Order Resource Assignments',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Work Order Resource Assignments.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: RESOURCE_ASSIGNMENTS');



debug('begin add_signature: RESOURCE_REQUIREMENTS');
   l_info('##MASK##RESOURCE_TYPE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3229',
      p_sig_id                 => 'RESOURCE_REQUIREMENTS',
      p_sig_sql                => 'SELECT DISTINCT requirement_id,
  job_id,
  resource_sequence,
  operation_sequence,
  resource_type_name,
...
ORDER BY operation_sequence,
  resource_sequence',
      p_title                  => 'Work Order Resource Requirements',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Work Order Resource Requirements.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: RESOURCE_REQUIREMENTS');



debug('begin add_signature: WORKORDER_MATERIALS_TRACKED');
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3230',
      p_sig_id                 => 'WORKORDER_MATERIALS_TRACKED',
      p_sig_sql                => 'SELECT workorder_operation_id,
  operation_sequence,
  ...
  NULL ROWCHANGEDFLAG,
  reserved_quantity,
  DECODE(status, ''IN-SERVICE'', ''Y'', ''N'')
FROM ahl_job_oper_materials_v
WHERE workorder_id = ##$$WO_ID$$##
ORDER BY 2, 3',
      p_title                  => 'Work Order Tracked Materials ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Work Order Tracked Materials.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: WORKORDER_MATERIALS_TRACKED');



debug('begin add_signature: OPERATIONS_MATERIAL_REQUIREMENTS');
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3231',
      p_sig_id                 => 'OPERATIONS_MATERIAL_REQUIREMENTS',
      p_sig_sql                => 'SELECT workorder_operation_id,
  operation_sequence,
  concatenated_segments,
  description,
  ...
  NULL ROWCHANGEDFLAG,
  reserved_quantity,
  DECODE(status, ''IN-SERVICE'', ''Y'', ''N'') REPAIRITEM
FROM ahl_job_oper_materials_v
WHERE workorder_id = ##$$WO_ID$$##
ORDER BY 2, 3',
      p_title                  => 'Work Order Operations Material Requirements',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Work Order Operations Material Requirements.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OPERATIONS_MATERIAL_REQUIREMENTS');



debug('begin add_signature: EAM_WORKORDER_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3233',
      p_sig_id                 => 'EAM_WORKORDER_DETAILS',
...
AND wdj.wip_entity_id   =
  (SELECT wip_entity_id FROM ahl_workorders_v WHERE workorder_id = ##$$WO_ID$$##
  )
AND wdj.organization_id =
  (SELECT organization_id FROM ahl_workorders_v WHERE workorder_id = ##$$WO_ID$$##
  )
AND wdj.wip_entity_id   = ewod.wip_entity_id(+)
AND wdj.organization_id = ewod.organization_id(+)',
      p_title                  => 'EAM Work Order Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No EAM Work Orders.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EAM_WORKORDER_DETAILS');



debug('begin add_signature: ASSOCIATED_OSP_ORDERS');
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MEANING'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3232',
      p_sig_id                 => 'ASSOCIATED_OSP_ORDERS',
      p_sig_sql                => 'SELECT *
FROM
  (SELECT ospordereo.osp_order_id,
    ospordereo.object_version_number,
    ospordereo.last_update_date,
    ospordereo.last_updated_by,
    ospordereo.creation_date,
    ospordereo.created_by,
    ospordereo.last_update_login,
    ospordereo.osp_order_number,
    ospordereo.order_type_code,
    ospordereo.status_code,
    ospordereo.single_instance_flag,
    ospordereo.order_date,
    ospordereo.operating_unit_id,
    ospordereo.vendor_id,
    ospordereo.vendor_site_id,
    ospordereo.customer_id,
    ospordereo.contract_id,
    ospordereo.contract_terms,
    ospordereo.po_header_id,
    ospordereo.po_synch_flag,
    ospordereo.po_batch_id,
    ospordereo.po_request_id,
    ospordereo.po_interface_header_id,
    ospordereo.po_agent_id,
    ospordereo.oe_header_id,
    ospordereo.security_group_id,
    ospordereo.attribute_category,
    ootl.description,
    fnd1.meaning order_type,
    fnd3.meaning single_instance_meaning,
    po.segment1 po_number,
    oe.order_number shipment_number,
    (SELECT hz.party_name
    FROM ap_suppliers vend,
      hz_parties hz
    WHERE vend.vendor_id = ospordereo.vendor_id
    AND hz.party_id      = vend.party_id
    ) vendor,
    (SELECT vens.vendor_site_code
    FROM ap_supplier_sites_all vens
    WHERE ospordereo.vendor_site_id = vens.vendor_site_id
    ) vendor_location,
    cust.party_name customer,
    ctrct.contract_number,
    fnd2.meaning status,
    papf.full_name buyer,
    ospordereo.vendor_contact_id,
    (SELECT RTRIM(DECODE(NVL(hp.person_pre_name_adjunct, hp.salutation), NULL, '''', NVL(hp.person_pre_name_adjunct, hp.salutation)
      || '' '')
      || DECODE(hp.person_first_name, NULL, '''', SUBSTR(hp.person_first_name, 1, 15)
      || '' '')
      || DECODE(hp.person_middle_name, NULL, '''', SUBSTR(hp.person_middle_name, 1, 15)
      || '' '')
      || SUBSTR(hp.person_last_name, 1, 15))
    FROM ap_supplier_contacts con,
      hz_parties hp
    WHERE ospordereo.vendor_contact_id = con.vendor_contact_id
    AND con.per_party_id               = hp.party_id
    ) vendor_contact,
    NVL(
    (SELECT ''true''
    FROM ahl_item_vendor_rels ven,
      ahl_inv_service_item_rels rels,
      ahl_osp_order_lines lines
    WHERE rels.inv_service_item_rel_id = ven.inv_service_item_rel_id
    AND lines.inventory_item_id        = rels.inv_item_id
    AND lines.inventory_org_id         = rels.inv_org_id
    AND lines.service_item_id          = rels.service_item_id
    AND TRUNC(sysdate) BETWEEN TRUNC(rels.active_start_date) AND TRUNC(NVL(rels.active_end_date, sysdate))
    AND lines.osp_order_id = ospordereo.osp_order_id
    AND rownum             = 1
    ), ''false'') vendorlovrender,
    ospordereo.po_req_header_id,
    porh.segment1 po_req_number
  FROM ahl_osp_orders_b ospordereo,
    ahl_osp_orders_tl ootl,
    ...
    hz_parties cust,
    okc_k_headers_all_b ctrct,
    per_all_people_f papf,
    po_requisition_headers_all porh
  WHERE ospordereo.osp_order_id       = ootl.osp_order_id
  AND ootl.LANGUAGE                   = userenv(''LANG'')
  AND fnd1.lookup_type                = ''AHL_OSP_ORDER_TYPE''
  AND ospordereo.order_type_code      = fnd1.lookup_code
  AND ospordereo.po_header_id         = po.po_header_id(+)
  AND ospordereo.oe_header_id         = oe.header_id(+)
  AND ospordereo.customer_id          = cust.party_id(+)
  AND ospordereo.contract_id          = ctrct.id(+)
  AND fnd2.lookup_type                = ''AHL_OSP_STATUS_TYPE''
  AND ospordereo.status_code          = fnd2.lookup_code
  AND fnd3.lookup_type(+)             = ''AHL_YES_NO_TYPE''
  AND ospordereo.single_instance_flag = fnd3.lookup_code(+)
  AND fnd1.LANGUAGE                   = userenv(''LANG'')
  AND fnd2.LANGUAGE                   = userenv(''LANG'')
  AND fnd3.LANGUAGE(+)                = userenv(''LANG'')
  AND ospordereo.po_agent_id          = papf.person_id(+)
  AND TRUNC(sysdate) BETWEEN TRUNC(NVL(papf.effective_start_date, sysdate)) AND TRUNC(NVL(papf.effective_end_date, sysdate))
  AND ospordereo.po_req_header_id = porh.requisition_header_id(+)
  ) qrslt
WHERE(osp_order_id =
  (SELECT osp_order_id
  ...
  WHERE workorder_id = ##$$WO_ID$$##
      ...
      p_title                  => 'Work Order Associated OSP Orders',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Work Order Associated OSP Orders.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ASSOCIATED_OSP_ORDERS');



debug('begin add_signature: ASSOCIATED_OSP_ORDER_LINES');
   l_info('##MASK##MEANING'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3234',
      p_sig_id                 => 'ASSOCIATED_OSP_ORDER_LINES',
      p_sig_sql                => 'SELECT *
FROM
  (SELECT ahlosporderlineeo.osp_order_line_id,
    ahlosporderlineeo.object_version_number,
    ahlosporderlineeo.last_update_date,
    ahlosporderlineeo.last_updated_by,
    ahlosporderlineeo.creation_date,
    ahlosporderlineeo.created_by,
    ahlosporderlineeo.last_update_login,
    ahlosporderlineeo.osp_order_id,
    ahlosporderlineeo.osp_line_number,
    ahlosporderlineeo.workorder_id,
    ahlosporderlineeo.status_code,
    ahlosporderlineeo.service_item_id,
    ahlosporderlineeo.service_item_description,
    ahlosporderlineeo.service_item_uom_code,
    ahlosporderlineeo.need_by_date,
    ahlosporderlineeo.ship_by_date,
    ahlosporderlineeo.po_line_id,
    ahlosporderlineeo.po_line_type_id,
    ahlosporderlineeo.oe_ship_line_id,
    ahlosporderlineeo.oe_return_line_id,
    ahlosporderlineeo.operation_id,
    ahlosporderlineeo.exchange_instance_id,
    ahlosporderlineeo.quantity,
    ahlosporderlineeo.security_group_id,
    ahlosporderlineeo.attribute_category,
    wo.workorder_name job_number,
    (SELECT concatenated_segments
    FROM mtl_system_items_kfv mtls
    WHERE mtls.inventory_item_id = ahlosporderlineeo.service_item_id
    AND mtls.organization_id     = DECODE(ahlosporderlineeo.workorder_id, NULL, ahlosporderlineeo.inventory_org_id, vst.organization_id)
    ) service_item_number,
    NVL(fnd1.meaning, fnd.meaning) status,
    DECODE(ahlosporderlineeo.workorder_id, NULL, csii.instance_number, csiwo.instance_number) item_instance_number,
    csiex.instance_number exchange_instance_number,
    ''Y'' delete_flag,
    DECODE(ahlosporderlineeo.workorder_id, NULL, ahlosporderlineeo.sub_inventory, NULL) sub_inventory,
    ahlosporderlineeo.inventory_item_id,
    ahlosporderlineeo.inventory_org_id,
    DECODE(ahlosporderlineeo.workorder_id, NULL, mtli.concatenated_segments, mtlwo.concatenated_segments) item_number,
    DECODE(ahlosporderlineeo.workorder_id, NULL, mtli.description, mtlwo.description) item_description,
    ahlosporderlineeo.serial_number,
    ahlosporderlineeo.lot_number,
    ahlosporderlineeo.inventory_item_uom,
    ahlosporderlineeo.inventory_item_quantity,
    paa.name project_name,
    pat.task_name project_task_name,
    (SELECT name
    FROM hr_all_organization_units
    WHERE organization_id = ahlosporderlineeo.inventory_org_id
    ) organization_name,
    NVL(
    (SELECT ''PreferredSvcItem''
    FROM ahl_inv_service_item_rels
    WHERE inv_item_id = ahlosporderlineeo.inventory_item_id
    AND inv_org_id    = ahlosporderlineeo.inventory_org_id
    AND rownum        < 2
    ), ''AllSvcItem'') svcitemlov_switcher,
    mtlex.concatenated_segments exchange_item_number,
    csiex.serial_number exchange_instance_sl_no,
    ahlosporderlineeo.po_req_line_id,
    DECODE(ahl_osp_shipment_pub.is_part_chg_valid_for_ospline(ahlosporderlineeo.osp_order_line_id), ''Y'', ''ShowPartNumChange'', ''HidePartNumChange'') part_num_change,
    csitld.instance_id ship_line_inst_id
  FROM ahl_osp_order_lines ahlosporderlineeo,
    ahl_osp_orders_b header,
    ...
    mtl_system_items_kfv mtlex,
    csi_item_instances csiwo,
    mtl_system_items_kfv mtlwo,
    csi_t_transaction_lines csitl,
    csi_t_txn_line_details csitld
  WHERE ahlosporderlineeo.osp_order_id    = header.osp_order_id
  AND header.status_code                  = fnd.lookup_code(+)
  AND fnd.lookup_type(+)                  = ''AHL_OSP_STATUS_TYPE''
  AND fnd.LANGUAGE(+)                     = userenv(''LANG'')
  AND fnd1.lookup_type(+)                 = ''AHL_OSP_LINE_STATUS_TYPE''
  AND fnd1.LANGUAGE(+)                    = userenv(''LANG'')
  AND fnd1.lookup_code(+)                 = ahlosporderlineeo.status_code
  AND ahlosporderlineeo.workorder_id      = wo.workorder_id(+)
  ...
  AND csii.last_vld_organization_id(+)    = ahlosporderlineeo.inventory_org_id
  AND csii.inventory_item_id(+)           = ahlosporderlineeo.inventory_item_id
  AND csii.serial_number(+)               = ahlosporderlineeo.serial_number
  AND ahlosporderlineeo.inventory_item_id = mtli.inventory_item_id(+)
  AND ahlosporderlineeo.inventory_org_id  = mtli.organization_id(+)
  AND csiex.instance_id(+)                = ahlosporderlineeo.exchange_instance_id
  AND csiex.inventory_item_id             = mtlex.inventory_item_id(+)
  AND csiex.inv_master_organization_id    = mtlex.organization_id(+)
  AND vts.instance_id                     = csiwo.instance_id(+)
  AND csiwo.inventory_item_id             = mtlwo.inventory_item_id(+)
  AND csiwo.inv_master_organization_id    = mtlwo.organization_id(+)
  AND csitl.source_transaction_id(+)      = ahlosporderlineeo.oe_ship_line_id
  AND csitl.source_transaction_table(+)   = ''OE_ORDER_LINES_ALL''
  AND csitl.transaction_line_id           = csitld.transaction_line_id(+)
  ) qrslt
WHERE osp_order_id =
  (SELECT osp_order_id
  FROM ahl_search_workorders_v
...
ORDER BY osp_order_id,
  osp_line_number',
      p_title                  => 'Work Order Associated OSP Orders Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Work Order Associated OSP Orders Lines.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ASSOCIATED_OSP_ORDER_LINES');



debug('begin add_signature: WORKORDER_ID_ERRORED_TRANSACTIONS');
   l_info('##MASK##ERROR_TEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MESSAGE_STRING'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SERIAL_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4900',
      p_sig_id                 => 'WORKORDER_ID_ERRORED_TRANSACTIONS',
      p_sig_sql                => 'SELECT *
FROM csi_txn_errors
WHERE inventory_item_id IN
  (SELECT DISTINCT inventory_item_id FROM AHL_WORKORDERS_V
  WHERE workorder_id = ##$$WO_ID$$##
  )',
      p_title                  => 'Workorder Errored Transactions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Install Base(IB) Errored Transactions exists in CSI_TXN_ERRORS table for the specific Workorder''s Inventory Item found in AHL_WORKORDERS_V.',
      p_solution               => 'For fixing the Install Base(IB) Errored Transactions follow the recommendations from notes: Install Base Transaction Error Diagnostic Program [1501025/KB540052] and EBS Install Base Analyzer [1597450/KB193165].',
      p_success_msg            => 'No Install Base(IB) Errored Transactions exists in CSI_TXN_ERRORS table for the specific Workorder''s Inventory Item found in AHL_WORKORDERS_V.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: WORKORDER_ID_ERRORED_TRANSACTIONS');



debug('begin add_signature: MR_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3266',
      p_sig_id                 => 'MR_ID',
      p_sig_sql                => 'select mr_header_id FROM AHL_MR_HEADERS_V
WHERE mr_header_id = ##$$MR_ID$$##',
      p_title                  => 'Maintenance Requirement ID',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Maintenance Requirement ID.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: MR_ID');



debug('begin add_signature: MR_DEFINITION');
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PRECEDING_MR_TITLE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TITLE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3235',
      p_sig_id                 => 'MR_DEFINITION',
      p_sig_sql                => 'SELECT title "Title",
  version_number "Version",
  mr_header_id,
  object_version_number "OBJ Version",
  preceding_mr_header_id "Preceding MR Hdr ID",
  preceding_mr_title "Preceding MR Title",
  preceding_mr_revision "Preceding MR Revision",
  category "Category",
  service_type "Service Type",
  status "Status",
  implement_status "Implement Status",
  repetitive "Repetitive",
  show_repetitive "Show Repetitive",
  whichever_first "Whichever First",
  copy_accomplishment "Copy Accomp",
  ...
  comments "Comments",
  service_request_template_id "SR Template ID",
  type "Type",
  down_time "Down Time",
  uom "UOM",
  space_category "Space Category",
  billing_item "Billing Item",
  billing_org_id "Billing Org ID",
  qa_inspection_type "QA Inspection Type",
  application_usg_code "Application Usage Code",
  auto_signoff "Auto Signoff",
  copy_init_accomplsmnts "Copy Init Accomp",
  copy_deferrals "Copy Deferrals"
FROM AHL_MR_HEADERS_V
WHERE mr_header_id = ##$$MR_ID$$##
AND TRUNC(NVL(effective_to, sysdate + 1)) > TRUNC(sysdate)
AND mr_status_code                        = ''COMPLETE''',
      p_title                  => 'Maintenance Requirement Definition',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Maintenance Requirement Definition.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: MR_DEFINITION');



debug('begin add_signature: MR_UMP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3241',
      p_sig_id                 => 'MR_UMP',
      p_sig_sql                => 'SELECT eff.unit_effectivity_id "Eff ID",
  eff.csi_item_instance_id "Item Instance ID",
  eff.mr_interval_id "MR Interval ID",
  eff.mr_effectivity_id "MR Eff ID",
  eff.mr_header_id "MR Hdr ID",
  eff.status_code "Status Code",
  eff.due_date "Due Date",
  eff.due_counter_value "Due Counter Value",
  eff.forecast_sequence "Forecast Sequence",
  eff.repetitive_mr_flag "Repetitive",
  eff.tolerance_flag "Tolerance",
  eff.remarks "Remarks",
  eff.message_code "Msg Code",
  eff.preceding_ue_id "Preceding UE ID",
  eff.date_run "Date Run",
  eff.set_due_date "Set Due Date",
  eff.accomplished_date "Accomp Date",
  eff.service_line_id "Service Line ID",
  eff.program_mr_header_id "Pgm MR Header ID",
  eff.cancel_reason_code "Cancel Reason Code",
  eff.earliest_due_date "Earliest Due",
  eff.latest_due_date "Latest Due",
  eff.defer_from_ue_id "Defer From UE ID",
  eff.cs_incident_id "Incident ID",
  eff.qa_collection_id "QA Collection ID",
  eff.orig_deferral_ue_id "Orig Deferral UE ID",
  eff.application_usg_code "Appln Usage",
  eff.object_type "Obj Type",
  eff.counter_id "Counter ID",
  eff.manually_planned_flag "Manually Planned",
  eff.log_series_code "Log Series Code",
  eff.log_series_number "Log Series Number",
  eff.flight_number "Flight No.",
  eff.mel_cdl_type_code "Mel Cdl Type",
  eff.position_path_id "Pos. Path ID",
  eff.ata_code "ATA Code",
  eff.unit_config_header_id "Unit Config Hdr ID",
  eff.object_version_number "Obj Version"
FROM ahl_unit_effectivities_app_v eff
WHERE eff.mr_header_id = ##$$MR_ID$$##
AND object_type        = ''MR''
AND(eff.status_code   IS NULL
OR eff.status_code     = ''INIT-DUE'')
AND NOT EXISTS
  (SELECT ''x''
  FROM ahl_ue_relationships
  WHERE related_ue_id = eff.unit_effectivity_id
  )',
      p_title                  => 'Maintenance Requirement Unit Maintenance Plan',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Maintenance Requirement Unit Maintenance Plan.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: MR_UMP');



debug('begin add_signature: MR_EFFECTIVITIES');
   l_info('##MASK##NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3101',
      p_sig_id                 => 'MR_EFFECTIVITIES',
      p_sig_sql                => 'SELECT AHL_MR_EFFECTIVITIES_V.MR_EFFECTIVITY_ID "Effectivity ID",
  AHL_MR_EFFECTIVITIES_V.NAME "Name",
  AHL_MR_EFFECTIVITIES_V.THRESHOLD_DATE "Threshold Date",
  AHL_MR_EFFECTIVITIES_V.OBJECT_VERSION_NUMBER "Object Version",
  AHL_MR_EFFECTIVITIES_V.INVENTORY_ITEM_ID "Inv Item ID",
  AHL_MR_EFFECTIVITIES_V.ITEM_NUMBER "Inv Item Number",
  AHL_MR_EFFECTIVITIES_V.RELATIONSHIP_ID "Relationship ID",
  AHL_MR_EFFECTIVITIES_V.POSITION_REF_MEANING "Master Confg Position" ,
  AHL_MR_EFFECTIVITIES_V.POSITION_ITEM_NUMBER "Master Confg Item" ,
  AHL_MR_EFFECTIVITIES_V.PC_NODE_ID "PC Node ID",
  AHL_MR_EFFECTIVITIES_V.PC_NODE_NAME "PC Node Name",
  AHL_MR_EFFECTIVITIES_V.DEFAULT_FLAG "Default",
  AHL_MR_EFFECTIVITIES_V.PROGRAM_DURATION "Program Duration",
  AHL_MR_EFFECTIVITIES_V.PROGRAM_DURATION_UOM_CODE "Program Duration UOM"
FROM AHL_MR_EFFECTIVITIES_V
WHERE AHL_MR_EFFECTIVITIES_V.MR_HEADER_ID = ##$$MR_ID$$##',
      p_title                  => 'Maintenance Requirement Effectivities',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Maintenance Requirement Effectivities.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: MR_EFFECTIVITIES');



debug('begin add_signature: MR_EFFECTIVITY_DETAILS');
   l_info('##MASK##SERIAL_NUMBER_FROM'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SERIAL_NUMBER_TO'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3236',
      p_sig_id                 => 'MR_EFFECTIVITY_DETAILS',
      p_sig_sql                => 'SELECT mr_effectivity_detail_id "MR Eff Detail ID",
  object_version_number "Obj Version",
  exclude_flag "Exclude",
  manufacturer_id "Manufacturer ID",
  country_code "Country",
  serial_number_from "From Serial",
  serial_number_to "To Serial",
  manufacture_date_from "From Manufacture Date",
  manufacture_date_to "To Manufacture Date"
FROM ahl_mr_effectivity_dtls
WHERE mr_effectivity_id IN
  (SELECT mr_effectivity_id
  FROM ahl_mr_effectivities
  WHERE mr_header_id = ##$$MR_ID$$##
  )',
      p_title                  => 'Maintenance Requirement Effectivity Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Maintenance Requirement Effectivity Details.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: MR_EFFECTIVITY_DETAILS');



debug('begin add_signature: MR_INTERVAL_THRESHOLDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3237',
      p_sig_id                 => 'MR_INTERVAL_THRESHOLDS',
      p_sig_sql                => 'SELECT mr_interval_id "MR Interval ID",
  object_version_number "Obj Version",
  mr_effectivity_id "MR Eff ID",
  ...
  stop_date "Stop Date",
  tolerance_before "Before Tolerance",
  tolerance_after "After Tolerance",
  reset_value "Reset Value",
  earliest_due_value "Earliest Due Value"
FROM ahl_mr_intervals
WHERE mr_effectivity_id IN
  (SELECT mr_effectivity_id
  FROM ahl_mr_effectivities
  WHERE mr_header_id = ##$$MR_ID$$##
  )',
      p_title                  => 'Maintenance Requirement Interval Thresholds',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Maintenance Requirement Interval Thresholds.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: MR_INTERVAL_THRESHOLDS');



debug('begin add_signature: MR_RELATIONSHIPS');
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MR_TITLE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3238',
      p_sig_id                 => 'MR_RELATIONSHIPS',
      p_sig_sql                => 'SELECT related_mr_title "MR Title",
  object_version_number "Obj Ver.",
  mr_relationship_id "Relationship ID",
  related_mr_revision "MR Rev.",
  ''CHILD'',
  related_description "Description",
  related_program_type "Program Type",
  related_status "Status",
  related_effective_from "Eff From",
  related_effective_to "Eff To",
  related_mr_header_id "MR Header",
  related_mr_status_code "MR Status",
  related_program_type_code "Program Type Code",
  related_type_code "Type Code",
  related_type "Type",
  ''True''
FROM ahl_mr_relationships_v
WHERE mr_header_id    = ##$$MR_ID$$##
AND relationship_code = ''CHILD''
UNION
SELECT mr_title "MR Title",
  object_version_number "Obj Ver.",
  mr_relationship_id "Relationship ID",
  mr_revision "MR Rev.",
  ''PARENT'',
  ...
  program_type "Program Type",
  status "Status",
  effective_from "Eff From",
  effective_to "Eff To",
  mr_header_id "MR Header",
  mr_status_code "MR Status",
  program_type_code "Program Type Code",
  type_code "Type Code",
  type "Type",
  ''True''
FROM ahl_mr_relationships_v
WHERE related_mr_header_id = ##$$MR_ID$$##
AND relationship_code      = ''PARENT''',
      p_title                  => 'Maintenance Requirement Relationships',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Maintenance Requirement Relationships.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: MR_RELATIONSHIPS');



debug('begin add_signature: MR_ATTACHED_ROUTES');
   l_info('##MASK##OPERATOR'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ROUTE_DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3239',
      p_sig_id                 => 'MR_ATTACHED_ROUTES',
      p_sig_sql                => 'SELECT ahl_mr_routes_v.route_id "Route ID",
  ahl_mr_routes_v.route_number "Route Number",
  ahl_mr_routes_v.route_description "Route Description",
  ahl_mr_routes_v.product_type "Product Type",
  ahl_mr_routes_v.operator "Operator",
  ahl_mr_routes_v.route_revision_number "Route Revision",
  ahl_mr_routes_v.object_version_number "Object Version",
  ahl_mr_routes_v.mr_route_id "MR Route ID",
  ahl_mr_routes_v.stage "Stage"
FROM ahl_mr_routes_v
WHERE ahl_mr_routes_v.mr_header_id    = ##$$MR_ID$$##
AND NVL(end_date_active, sysdate + 1) > sysdate
ORDER BY ahl_mr_routes_v.route_number',
      p_title                  => 'Maintenance Requirement Attached Routes',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Maintenance Requirement Attached Routes.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: MR_ATTACHED_ROUTES');



debug('begin add_signature: MR_ROUTE_SEQ');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3240',
      p_sig_id                 => 'MR_ROUTE_SEQ',
      p_sig_sql                => 'SELECT mr_route_sequence_id "Route Sequence ID",
  object_version_number "Obj Version",
  mr_route_id "Mr Route ID",
  related_mr_route_id "Related Mr Route ID",
  sequence_code "Sequence Code"
FROM ahl_mr_route_sequences c
WHERE mr_route_id IN
...
AND EXISTS
  ...
  AND route_id      IN
    ...
    AND revision_status_code              = ''COMPLETE''
      ...
      p_title                  => 'Maintenance Requirement Route Sequencing',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Maintenance Requirement Route Sequencing.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: MR_ROUTE_SEQ');



debug('begin add_signature: MR_DOC_ASSOCIATIONS');
   l_info('##MASK##DOCUMENT_TITLE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##DOC_TYPE_DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FILENAME_OR_URL'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MEDIA DESC'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##NOTE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SOURCE_MEANING'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SUBJECT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3242',
      p_sig_id                 => 'MR_DOC_ASSOCIATIONS',
      p_sig_sql                => 'SELECT ahl_document_assos_v.source_meaning "Source Meaning",
  ahl_document_assos_v.source_ref_code "Source Ref Code",
  ahl_document_assos_v.document_no "Doc No.",
  ahl_document_assos_v.document_title "Doc Title",
  ahl_document_assos_v.doc_type_description "Doc Type Desc.",
  ahl_document_assos_v.revision_no "Rev No.",
  ahl_document_assos_v.chapter "Chapter",
  ahl_document_assos_v.SECTION "Section",
  ahl_document_assos_v.subject "Subject",
  ahl_document_assos_v.PAGE "Page",
  ahl_document_assos_v.figure "Figure",
  ahl_document_assos_v.note "Note",
  ahl_document_assos_v.document_id "Doc ID",
  ahl_document_assos_v.doc_title_asso_id "Doc Title Assoc ID",
  ahl_document_assos_v.object_version_number "Obj Ver",
  ahl_document_assos_v.is_view_doc "Can View",
  ahl_document_assos_v.media_desc "Media Desc",
  ahl_document_assos_v.file_id "File ID",
  ahl_document_assos_v.filename_or_url "File/url"
FROM ahl_document_assos_v
WHERE ahl_document_assos_v.aso_object_id      = ##$$MR_ID$$##
AND ahl_document_assos_v.aso_object_type_code = ''MR''
ORDER BY ahl_document_assos_v.document_no,
  ahl_document_assos_v.revision_no',
      p_title                  => 'Maintenance Requirement Document Associations',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Maintenance Requirement Document Associations.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: MR_DOC_ASSOCIATIONS');



debug('begin add_signature: MR_EFFECTIVITIES_IB_ERRORED_TRANSACTIONS');
   l_info('##MASK##ERROR_TEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MESSAGE_STRING'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SERIAL_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4902',
      p_sig_id                 => 'MR_EFFECTIVITIES_IB_ERRORED_TRANSACTIONS',
      p_sig_sql                => 'SELECT *
FROM csi_txn_errors
WHERE inventory_item_id IN
  (SELECT DISTINCT inventory_item_id
...
WHERE AHL_MR_EFFECTIVITIES_V.MR_HEADER_ID = ##$$MR_ID$$##
      ...
      p_title                  => 'Maintenance Requirement Effectivities IB Errored Transactions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Install Base(IB) Errored Transactions exists in CSI_TXN_ERRORS table for the specific MR''s Inventory Item found in AHL_MR_EFFECTIVITIES_V.',
      p_solution               => 'For fixing the Install Base(IB) Errored Transactions follow the recommendations from notes: Install Base Transaction Error Diagnostic Program [1501025/KB540052] and EBS Install Base Analyzer [1597450/KB193165].',
      p_success_msg            => 'No Install Base(IB) Errored Transactions exists in CSI_TXN_ERRORS table for the specific MR''s Inventory Item found in AHL_MR_EFFECTIVITIES_V.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MR_EFFECTIVITIES_IB_ERRORED_TRANSACTIONS');



debug('begin add_signature: PL_SQL_FILE_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3619',
      p_sig_id                 => 'PL_SQL_FILE_VERSIONS',
      p_sig_sql                => 'select
       o.object_name
     ...
     and   (o.object_name like ''AHL\_%'' escape ''\'')
     and   s.line between 2 and 3
     and   s.text like ''%Header: %''
     order by 1, 3 desc, 5 desc',
      p_title                  => 'PL/SQL Packages Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'PL/SQL Packages Versions',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PL_SQL_FILE_VERSIONS');



debug('begin add_signature: JAVA_CLASSES_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3620',
      p_sig_id                 => 'JAVA_CLASSES_VERSIONS',
      p_sig_sql                => 'SELECT que.subdir,
  que.filename,
  que.version
FROM ( select files.filename filename,files.subdir subdir, file_version.version version, rank()over(partition BY files.filename order by file_version.version_segment1 DESC, file_version.version_segment2 DESC,file_version.version_segment3 DESC, file_version.version_segment4 DESC,file_version.version_segment5 DESC, file_version.version_segment6 DESC,file_version.version_segment7 DESC, file_version.version_segment8 DESC,file_version.version_segment9 DESC, file_version.version_segment10 DESC, file_version.translation_level DESC) AS rank1
FROM ad_file_versions file_version,
  (SELECT filename,
    ...
    file_id
  FROM ad_files
  WHERE app_short_name=''AHL''
  AND upper(filename) LIKE upper(''%.class'')
  ) files
WHERE files.file_id = file_version.file_id ) que
WHERE rank1         = 1
ORDER BY 1,2',
      p_title                  => 'Java Classes Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Java Classes Versions',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: JAVA_CLASSES_VERSIONS');



debug('begin add_signature: ODF_FILE_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3622',
      p_sig_id                 => 'ODF_FILE_VERSIONS',
...
from ad_files
where app_short_name in (''AHL'') and upper(filename) like upper(''%.odf'')
) files
where files.file_id = file_version.file_id and file_version.version like substr(''12.1.1'',1,2)||''%''
) que
where rank1 = 1
order by 1',
      p_title                  => 'ODF File Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'ODF File Versions',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ODF_FILE_VERSIONS');



debug('begin add_signature: LDT_FILE_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3621',
      p_sig_id                 => 'LDT_FILE_VERSIONS',
...
from ad_files
where app_short_name in (''AHL'') and upper(filename) like upper(''%.ldt'') and subdir like ''%US''
) files
where files.file_id = file_version.file_id and file_version.version like substr(''12.1.1'',1,2)||''%''
) que
where rank1 = 1
order by 1,2',
      p_title                  => 'LDT File Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'LDT File Versions',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: LDT_FILE_VERSIONS');



debug('begin add_signature: WF_FILE_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3624',
      p_sig_id                 => 'WF_FILE_VERSIONS',
      p_sig_sql                => 'select que.filename, que.version
from (
select files.filename filename,files.subdir subdir,
file_version.version version,
...
select filename, app_short_name, subdir, file_id
from ad_files
where upper(filename) like upper(''ahl%'') and subdir like ''%US%''
) files
where files.file_id = file_version.file_id
) que
where rank1 = 1 and rownum < 2
order by 1,2',
      p_title                  => 'Workflow File Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Workflow File Versions',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: WF_FILE_VERSIONS');



debug('begin add_signature: SQL_FILE_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3623',
      p_sig_id                 => 'SQL_FILE_VERSIONS',
      p_sig_sql                => 'select  que.filename, que.version
from (
select files.filename filename,file_version.version version,
rank()over(partition by files.filename
...
select filename, app_short_name, file_id
from ad_files
where app_short_name in (''AHL'') and upper(filename) like upper(''%.sql'')
) files
where files.file_id = file_version.file_id and file_version.version like substr(''12.1.1'',1,2)||''%''
) que
where rank1 = 1
order by 1',
      p_title                  => 'SQL File Versions',
      p_fail_condition         => 'NRS',
   ...
   l_info.delete;
debug('end add_signature: SQL_FILE_VERSIONS');



debug('begin add_signature: PROFILE_OPTION_VALUES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3625',
      p_sig_id                 => 'PROFILE_OPTION_VALUES',
      p_sig_sql                => 'SELECT n.user_profile_option_name,
  po.profile_option_name ,
  DECODE(TO_CHAR(pov.level_id), ''10001'', ''Site'', ''10002'', ''Application'', ''10003'', ''Responsibility'', ''10005'', ''Server'', ''10006'', ''Org'', ''10007'', ''Servresp'', ''10004'', ''User'', ''???'') Level_,
  ...
  ||'', ''
  || pov.level_value2, ''10004'', NVL(usr.user_name,TO_CHAR(pov.level_value)), ''???'') Level_Value_,
...
WHERE (po.profile_option_name LIKE ''AHL%''
OR po.profile_option_name LIKE ''AHL%''
)
...
AND n.language                =''US''
ORDER BY 2,3',
      p_title                  => 'Profile Options Values',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Profile Options Values',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PROFILE_OPTION_VALUES');



debug('begin add_signature: AHL_DEFAULT_NON_ROUTINE_TASK_TYPE NOT SET');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5367',
      p_sig_id                 => 'AHL_DEFAULT_NON_ROUTINE_TASK_TYPE NOT SET',
      p_sig_sql                => 'SELECT n.user_profile_option_name,
  po.profile_option_name ,
  DECODE(TO_CHAR(pov.level_id), ''10001'', ''Site'', ''10002'', ''Application'', ''10003'', ''Responsibility'', ''10005'', ''Server'', ''10006'', ''Org'', ''10007'', ''Servresp'', ''10004'', ''User'', ''???'') Level_,
  DECODE(TO_CHAR(pov.level_id), ''10001'', ''Site'', ''10002'', NVL(app.application_short_name,TO_CHAR(pov.level_value)), ''10003'', NVL(rsp.responsibility_name,TO_CHAR(pov.level_value)), ''10005'', svr.node_name, ''10006'', org.name, ''10007'', pov.level_value
...
FROM fnd_profile_options po,
  ...
  fnd_nodes svr,
  hr_operating_units org
WHERE (po.profile_option_name like(''AHL_DEFAULT_NON_ROUTINE_TASK_TYPE%''))
...
AND n.language                =''US''
ORDER BY 2,3',
      p_title                  => 'Mandatory profile "AHL: Default Service Type for Non-Routine tasks" not set',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This mandatory profile option "AHL: Default Service Type for Non-Routine tasks" (AHL_DEFAULT_NON_ROUTINE_TASK_TYPE) is not set for any level.
<br>
This might generate error <br>
"java.lang.NullPointerException" 
<br>when attempting to create Non-Routine Tasks from Component Technician Workbench.
',
      p_solution               => 'This mandatory profile should be set to the following value:
<br>
Name - AHL: Default Service Type for Non-Routine tasks <br>
Value - Administration <br>

Note: After setting the value, logout and sign back in to test the functionality.<br>
',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: AHL_DEFAULT_NON_ROUTINE_TASK_TYPE NOT SET');



debug('begin add_signature: AHL_DEFAULT_ROUTINE_TASK_TYPE NOT SET');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5655',
      p_sig_id                 => 'AHL_DEFAULT_ROUTINE_TASK_TYPE NOT SET',
      p_sig_sql                => 'SELECT n.user_profile_option_name,
  po.profile_option_name ,
  DECODE(TO_CHAR(pov.level_id), ''10001'', ''Site'', ''10002'', ''Application'', ''10003'', ''Responsibility'', ''10005'', ''Server'', ''10006'', ''Org'', ''10007'', ''Servresp'', ''10004'', ''User'', ''???'') Level_,
  DECODE(TO_CHAR(pov.level_id), ''10001'', ''Site'', ''10002'', NVL(app.application_short_name,TO_CHAR(pov.level_value)), ''10003'', NVL(rsp.responsibility_name,TO_CHAR(pov.level_value)), ''10005'', svr.node_name, ''10006'', org.name, ''10007'', pov.level_value
...
FROM fnd_profile_options po,
  ...
  fnd_nodes svr,
  hr_operating_units org
WHERE (po.profile_option_name like(''AHL_DEFAULT_ROUTINE_TASK_TYPE%''))
-- AND pov.level_id = ''10003''
AND pov.application_id        = po.application_id
AND po.profile_option_name    = n.profile_option_name
AND pov.profile_option_id     = po.profile_option_id
...
AND n.language                =''US''
ORDER BY 2,3',
      p_title                  => 'Mandatory profile "AHL: Default Service Type for Routine tasks" not set',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This mandatory profile option "AHL: Default Service Type for Routine tasks" (AHL_DEFAULT_ROUTINE_TASK_TYPE) is not set for any level.
<br>
This might generate error <br>
"java.lang.NullPointerException" 
<br>when attempting to create Routine Tasks from Component Technician Workbench.
',
      p_solution               => 'This mandatory profile should be set to the following value:
<br>
Name - AHL: Default Service Type for Routine tasks <br>
Value - Administration <br>
...
',
   ...
   l_info.delete;
debug('end add_signature: AHL_DEFAULT_ROUTINE_TASK_TYPE NOT SET');



debug('begin add_signature: AHL_UTIL_UC_PKG INVALID PACKAGE');
   l_info('##MASK##TEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5368',
      p_sig_id                 => 'AHL_UTIL_UC_PKG INVALID PACKAGE',
      p_sig_sql                => 'SELECT ao.object_name,
  ao.status,
  ue.text
FROM all_objects ao,
  user_errors ue
WHERE ao.object_name LIKE ''AHL_UTIL_UC_PKG''
AND ao.status      = ''INVALID''
AND ao.object_name = ue.name
AND ue.text LIKE ''PLS-00452: Subprogram ''''GETCSI_LOCATIONDESC'''' violates its associated pragma%''',
      p_title                  => 'Invalid Package AHL_UTIL_UC_PKG After Upgrade to 12.1.3',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Package AHL_UTIL_UC_PKG is invalid, due to a code mismatch.',
      p_solution               => 'Please review [1547020/KB542121] and apply the solution recommended to fix this issue.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: AHL_UTIL_UC_PKG INVALID PACKAGE');
...
BEGIN
  ...
  analyzer_title := 'Complex Maintenance Repair and Overhaul Analyzer';
...
debug('begin section: CMRO_RECOMMENDATIONS');
start_section('Proactive and Preventative Recommendations', 'CMRO_RECOMMENDATIONS');
   set_item_result(run_stored_sig('CMRO INVALIDS'));
   set_item_result(check_rec_patches_1); /* Signature CMRO RECOMMENDED PATCHES */
   set_item_result(run_stored_sig('CMRO_COMPLETED_REQUESTS'));
   set_item_result(run_stored_sig('CMRO_LATEST_COMPLETED_REQUESTS'));
   ...
   set_item_result(run_stored_sig('EBS_CRM_SC_CMRO_FREEZE_KFF_CHECK'));
end_section('All the Proactive and Preventive Recommendations have passed.');
debug('end section: CMRO_RECOMMENDATIONS');

debug('begin section: VISIT_DETAILS');
IF g_sql_tokens('##$$VISIT_ID$$##') is not null THEN
   start_section('Visit Details', 'VISIT_DETAILS');
      set_item_result(run_stored_sig('VISIT_ID'));
      set_item_result(run_stored_sig('VISIT_DETAILS'));
      set_item_result(run_stored_sig('VISIT_TASKS'));
      set_item_result(run_stored_sig('VISIT_MRS'));
      set_item_result(run_stored_sig('VISIT_STAGES'));
      set_item_result(run_stored_sig('VISIT_CURRENCY'));
      set_item_result(run_stored_sig('VISIT_MASTER_WO'));
      set_item_result(run_stored_sig('VISIT_UC_HEADER'));
      set_item_result(run_stored_sig('VISIT_IB_ERRORED_TRANSACTIONS'));
      set_item_result(run_stored_sig('EBS_CRM_SC_CMRO_VST_SCHED_MAT'));
      set_item_result(run_stored_sig('EBS_CRM_SC_CMRO_REPAIR_ORDER'));
   end_section;
END IF;
debug('end section: VISIT_DETAILS');

debug('begin section: WO_DETAILS');
IF g_sql_tokens('##$$WO_ID$$##') is not null THEN
   start_section('Work Order Details', 'WO_DETAILS');
      set_item_result(run_stored_sig('WORKORDER_ID'));
      set_item_result(run_stored_sig('WORKORDER_DETAILS'));
      set_item_result(run_stored_sig('WORKORDER_OPERATIONS'));
      set_item_result(run_stored_sig('WORKORDER_DISPOSITIONS'));
      set_item_result(run_stored_sig('RESOURCE_ASSIGNMENTS'));
      set_item_result(run_stored_sig('RESOURCE_REQUIREMENTS'));
      set_item_result(run_stored_sig('WORKORDER_MATERIALS_TRACKED'));
      set_item_result(run_stored_sig('OPERATIONS_MATERIAL_REQUIREMENTS'));
      set_item_result(run_stored_sig('EAM_WORKORDER_DETAILS'));
      set_item_result(run_stored_sig('ASSOCIATED_OSP_ORDERS'));
      set_item_result(run_stored_sig('ASSOCIATED_OSP_ORDER_LINES'));
      set_item_result(run_stored_sig('WORKORDER_ID_ERRORED_TRANSACTIONS'));
   end_section;
END IF;
debug('end section: WO_DETAILS');

debug('begin section: MR_DETAILS');
IF g_sql_tokens('##$$MR_ID$$##') is not null THEN
   start_section('Maintenance Requirement Details', 'MR_DETAILS');
      set_item_result(run_stored_sig('MR_ID'));
      set_item_result(run_stored_sig('MR_DEFINITION'));
      set_item_result(run_stored_sig('MR_UMP'));
      set_item_result(run_stored_sig('MR_EFFECTIVITIES'));
      set_item_result(run_stored_sig('MR_EFFECTIVITY_DETAILS'));
      set_item_result(run_stored_sig('MR_INTERVAL_THRESHOLDS'));
      set_item_result(run_stored_sig('MR_RELATIONSHIPS'));
      set_item_result(run_stored_sig('MR_ATTACHED_ROUTES'));
      set_item_result(run_stored_sig('MR_ROUTE_SEQ'));
      set_item_result(run_stored_sig('MR_DOC_ASSOCIATIONS'));
      set_item_result(run_stored_sig('MR_EFFECTIVITIES_IB_ERRORED_TRANSACTIONS'));
   end_section;
END IF;
debug('end section: MR_DETAILS');

debug('begin section: FILE_VERSIONS');
start_section('File Versions', 'FILE_VERSIONS');
   set_item_result(run_stored_sig('PL_SQL_FILE_VERSIONS'));
   set_item_result(run_stored_sig('JAVA_CLASSES_VERSIONS'));
   set_item_result(run_stored_sig('ODF_FILE_VERSIONS'));
   set_item_result(run_stored_sig('LDT_FILE_VERSIONS'));
   set_item_result(run_stored_sig('WF_FILE_VERSIONS'));
   set_item_result(run_stored_sig('SQL_FILE_VERSIONS'));
end_section;
debug('end section: FILE_VERSIONS');

debug('begin section: SETUP_CHECKS');
start_section('Setup Checks', 'SETUP_CHECKS');
   set_item_result(run_stored_sig('PROFILE_OPTION_VALUES'));
   set_item_result(run_stored_sig('AHL_DEFAULT_NON_ROUTINE_TASK_TYPE NOT SET'));
   set_item_result(run_stored_sig('AHL_DEFAULT_ROUTINE_TASK_TYPE NOT SET'));
   set_item_result(run_stored_sig('AHL_UTIL_UC_PKG INVALID PACKAGE'));
end_section;
