...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Field Service Analyzer                 |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE csf_analyzer_pkg AUTHID DEFINER AS
...
(            p_app_id                       IN NUMBER      DEFAULT NULL
           ...
           ,p_resource_num                 IN VARCHAR2    DEFAULT NULL
           ,p_task_number                  IN VARCHAR2    DEFAULT NULL
           ,p_req_num                      IN NUMBER      DEFAULT NULL
...
END csf_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY csf_analyzer_pkg AS
-- $Id: csf_analyzer.sql, 200.20 2026/01/28 18:12:08 svedula Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2246049.1));
...
g_family_area      VARCHAR2(24) := 'EBS CRM';
...
----------------------------------------------------------------
g_org_id       number;
g_res_num VARCHAR2(100);
g_org_name     varchar(500);
l_org_name     varchar(500);
g_instance_name     VARCHAR2(100);
g_app_id             NUMBER;
g_app_name  varchar2(10);
g_item_name varchar2(500);
g_res_id number;
g_task_id number;
g_task_num  VARCHAR2(100);
g_serial_number VARCHAR2(200);
g_req_num number;
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'CSF_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'CSF_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>CSF Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2246049.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/fs_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,4479,EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,4479,EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},4479,EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4083539" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">4479</span>
...
<div class="ck-content"><p>Version 200.20 01-28-2026</p><ul><li>Signature PREMIER_SUPPORT signatures updated</li>
<li>Signature AC_DB_PARAMETERS updated</li>
<li>Signature EBS_ATG_UGLE_32BIT_SEQUENCES_CLOSE_TO_MAX updated</li>
<li>Signature EBS_ATG_UGLE_SEQUENCES_CLOSE_TO_MAXIMUM_VALUE updated</li>
<li>Signature AC_INVALID_TABLE_INDEXES updated</li>
</ul>
<p>&nbsp;</p><p>Version 200.19 11-Dec-2025<br>
----<br>
Signature AC_TABLE_INDEXES has been updated<br>
Signature EBS_ATG_UGLE_SEQUENCES_CLOSE_TO_MAXIMUM_VALUE has been updated</p><p>&nbsp;</p><p>&nbsp;</p><p>Version 200.18 26-SEP-2024<br>
----------------</p><p>Signature updates</p><p>&nbsp;</p><p>Version 200.17 10-Jul-2024<br>
-------------------<br>
Added a new Signature: EBS_CRM_SC_UMX_ACCESS_ROLE<br>
<br>
Version 200.15<br>
----------------<br>
Added the following new signature:</p><ul><li>Duplicate Columns in JTY_1001_DENORM_DEA_VALUES</li>
<li><span class="display_only apex-item-display-only" id="P18_TITLE_DISPLAY">Duplicate Document IDs</span></li>
</ul>
<p>&nbsp;</p><p>Version 200.14&nbsp;<br>
----------------<br>
Added the following new signatures:</p><p>a) Indexes with FAILED value for DOMIDX_OPSTATUS column<br>
b) DBA Objects reaching MAX of Extents</p><p>Version 200.13<br>
----------------<br>
Added the following new signatures:</p><p>a) Default Subinventory Trunk Stock Item Details<br>
b) Parts Return Excess And Defective Items<br>
c) Territories Associated To The Resource<br>
d) Roles Associated To The Resource<br>
e) Group Roles Associated To The Resource</p><p>Version 200.12&nbsp;<br>
----------------<br>
New Signatures Added:&nbsp;<br>
Field Service Sequences Reaching Maximum Value.<br>
Territories<br>
Territories with Null matching attribute values&nbsp;</p><p>Version 200.11<br>
----------------<br>
New Analyzer Framework version 4.6.0.1 released with bug fixes.</p><p>Version 200.10<br>
----------------<br>
Analyzer Framework 4.5.9.1 version released.<br>
Several signatures modified to check for 19C DB.</p><p>Version 200.9<br>
----------------<br>
Lifetime Support Policy: Premier Support for R12.1.3 customers updated.</p><p>Version 200.8<br>
----------------<br>
Added new signatures for Field Service and Mobile Field Service modules.</p><p>New signatures were designed:<br>
1. Debrief Material Item Billable Flag Check signature to check for Inventory Item having billable type flag defined or not.<br>
2. Multiple Debrief Header IDs signature Created to avoid the duplicate debrief header ids creation.<br>
3. Debrief Lines Completion Profile check signatures validates the debrief lines error to prevent charges Being Submitted To Order Management Before All Debrief Lines Are Completed.<br>
4. Default Defective Sub Inventory Check signature created to validate the default defective sub inventory defined for the resource.<br>
5. The following patches were updated:<br>
&nbsp; &nbsp; a) Spares Suggested Patches<br>
&nbsp; &nbsp; b) Field Service Suggested Patches</p><p>Version 200.7:<br>
----------------<br>
1) The following patches were updated:</p><p>&nbsp; &nbsp; Spares Suggested Patches<br>
&nbsp; &nbsp; Field Service Suggested Patches</p><p>2) New Analyzer Framework version 4.5.7 released with these changes:</p><p>&nbsp; &nbsp; Summary of signatures that failed at the end of the log<br>
&nbsp; &nbsp; Signature Version Reported in Analyzer Output<br>
&nbsp; &nbsp; Remove unnecessary icons for signatures with no data<br>
&nbsp; &nbsp; Fixed DB Name character string buffer too small</p><p>Version 200.6:<br>
----------------<br>
a) Added new module specific patch signatures:</p><p>&nbsp; &nbsp; * Field Service Suggested patches<br>
&nbsp; &nbsp; * Mobile Field Service Suggested patches<br>
&nbsp; &nbsp; * Spares Suggested patches<br>
&nbsp; &nbsp;&nbsp;<br>
b) Added the following product signatures:<br>
&nbsp; &nbsp; Field Service:<br>
&nbsp; &nbsp; * Reprocess Errored Debrief lines<br>
&nbsp; &nbsp; * JTF Hooks Seed data corruption<br>
&nbsp; &nbsp;&nbsp;<br>
&nbsp; &nbsp; Mobile Field Service:<br>
&nbsp; &nbsp; * Party Item Instance Download details<br>
&nbsp; &nbsp; * Mobile Field Service Multiplatform Cache<br>
&nbsp; &nbsp; * Can Task be downloaded?<br>
&nbsp; &nbsp; * JTF Hooks Seed data corruption</p></div>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,4479,'||l_sig.sigrepo_id||',EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,4479,'||l_sig.sigrepo_id||',EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},4479,'||l_sig.sigrepo_id||',EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,4479,'||p_sig.sigrepo_id||',EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,4479,'||p_sig.sigrepo_id||',EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},4479,'||p_sig.sigrepo_id||',EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
FUNCTION check_rec_patches_1 RETURN VARCHAR2 IS
  /* Signature CRM_CSF_CHECK_REC_PATCHES */
...
BEGIN
    ...
    print_log('Processing recommended patches signature: CRM_CSF_CHECK_REC_PATCHES (check_rec_patches_1) "Recommended Patches" (version 13)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(4)(l_rows) := 'Oracle E-Business Suite Product Specific Release Notes, Release 12.2.5';
   l_col_rows(5)(l_rows) := '[2049015.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25904314';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Field Service (CSF) & Oracle Spares Management (CSP): Latest Patches for Releases 12.2.3 and 12.2.4';
   l_col_rows(5)(l_rows) := '[2276357.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '27161867';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Field Service (CSF) & Oracle Spares Management (CSP): Latest Patches for Release 12.2.6';
   l_col_rows(5)(l_rows) := '[2404786.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '32495371';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Urgency and Advanced Find Tasks Forms Displayed When Minimizing Gantt Chart In Dispatch Center';
   l_col_rows(5)(l_rows) := '[2788797.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '32553150';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Updating Trip End Date In Dispatch Center Gives "FRM-40700 No such Trigger.CALENDAR_WROTE_DATE" Error';
   l_col_rows(5)(l_rows) := '[2786347.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '32609888';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Dispatch Center Form Map Options Are Disabled After Upgrade to 12.2.6 or Higher';
   l_col_rows(5)(l_rows) := '[2787147.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '28033754';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'What Patches Are Required To Get Field Service Module To The Current Level For R12.1.3?';
   l_col_rows(5)(l_rows) := '[2499381.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '13785770';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Field Service Debrief: Java Exception Error JBO-29000 On Material LOV';
   l_col_rows(5)(l_rows) := '[1461909.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '31501928';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Field Service Wireless: Blank Page When Searching For Open Tasks';
   l_col_rows(5)(l_rows) := '[2699380.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '31748541';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Getting JBO-26041 Error While Saving Debrief Lines In Field Service Technician Portal After Upgrade To 12.2.9';
   l_col_rows(5)(l_rows) := '[2707074.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30341270';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Debrief Post Failing With API Error: The Value For Parameter P_price_list_id Cannot Be "NULL".';
   l_col_rows(5)(l_rows) := '[2605730.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30507065';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Error SearchAssistedOptions Did Not Complete Successfully When Scheduling Tasks After Switching Responsiblities';
   l_col_rows(5)(l_rows) := '[2651769.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30425794';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Dispatch Scheduling Error: "The request SearchAssistedOptions did not complete successfully"';
   l_col_rows(5)(l_rows) := '[2664461.1]';

END IF;

   l_extra_info('##SHOW_SQL##'):= 'Y';

   l_sig.sigrepo_id := '18882';
...
<li>[10940175/KA580] Patch Wizard FAQ</li>
  ...
  -- Register
  l_step := '60';
  g_signatures('CRM_CSF_CHECK_REC_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'CRM_CSF_CHECK_REC_PATCHES',     -- sig ID
...
FUNCTION check_rec_patches_2 RETURN VARCHAR2 IS
  /* Signature CRM_CSF_CHECK_SPECIFIC_PATCHES */
  l_col_rows   COL_LIST_TBL := col_list_tbl(); -- Row values
  l_rel_rows   COL_LIST_TBL := col_list_tbl(); -- Row release
  l_hdr        VARCHAR_TBL  := varchar_tbl(); -- Column headings
  l_app_date   DATE;         -- Patch applied date
...
BEGIN
    ...
    print_log('Processing recommended patches signature: CRM_CSF_CHECK_SPECIFIC_PATCHES (check_rec_patches_2) "Field Service Suggested Patches" (version 13)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21768109';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Debrief Error: API Programming Error (Validate_Charge_Details): The value for parameter Bill_to_Contact_Id is invalid';
   l_col_rows(5)(l_rows) := '[1538621.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '12411681';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'FS Wireless: CsfwPartsReturnSave.jsp And CsfwPartsSrchResults.jsp Fail To Compile';
   l_col_rows(5)(l_rows) := '[1516179.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '12696560';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Field Service: Debrief Error: Transaction processor error. Negative balances not allowed.';
   l_col_rows(5)(l_rows) := '[1368102.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '13407512';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'FS Debrief Error: java.lang.NullPointerException When Opening HTML Page';
   l_col_rows(5)(l_rows) := '[1500525.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '20284490';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Debrief Html : Error in unit of measure conversion When Navigating Away From The Labor Item Field';
   l_col_rows(5)(l_rows) := '[1983190.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '20383159';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Debrief Error: An error occurred while getting pricing information for inventory item ID:XX, price list ID:XX, unit of measure:XX, and currency code:XX';
   l_col_rows(5)(l_rows) := '[2098318.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'FIELD SERVICE WIRELESS JSP FILES';
   l_col_rows(5)(l_rows) := '[2699380.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'When Gantt Chat Is Minimized Showing Task Page';
   l_col_rows(5)(l_rows) := '[2788797.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Updating Trip End Date In Dispatch Center Gives FRM-40700 Error';
   l_col_rows(5)(l_rows) := '[2786347.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'After Upgrade From 12.2.5 To 12.2.6 Form Map Options Are Greyed Out (Disabled)';
   l_col_rows(5)(l_rows) := '[2787147.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Getting JBO-26041 While Saving Field Service Portals After Upgrade';
   l_col_rows(5)(l_rows) := '[2707074.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Validate_Charge_Details: The Value For Parameter P_Price_List_Id Cannot Be Null';
   l_col_rows(5)(l_rows) := '[2605730.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26855358';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Submitting The Debrief Posting Program Completes With Error: Cost line already Exists for this Charge Line';
   l_col_rows(5)(l_rows) := '[2336457.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '16365623';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'System Error: ORA-06508: PL/SQL: could not find program unit being called: APPS.CSP_PARTS_REQUIREMENT and Package Compile Error: PLS-00302: component 
G_RESCHEDULE must be declared';
   l_col_rows(5)(l_rows) := '[1576316.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '29924538';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Task Addresses Are Showing As Unresolved And Not Plotting On The Google Map';
   l_col_rows(5)(l_rows) := '[2581320.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30226625';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Mobile Field Service: Solutions Included in Cumulative Patch 30226625:R12.CSM.C';
   l_col_rows(5)(l_rows) := '[2586954.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '31339453';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Field Serivce Wireless: Error java.lang.IllegalStateException Opening Task After January 2020 CPU + 30471595:R12.CSF.B';
   l_col_rows(5)(l_rows) := '[2670951.1]';

END IF;

   l_extra_info('##SHOW_SQL##'):= 'Y';

   l_sig.sigrepo_id := '19072';
   l_sig.title := 'Field Service Suggested Patches';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := 'Please check if any of the field service suggested patches were not applied in this instance.';
   l_sig.solution := 'Above are the field service specific patches for this product area. 
...
<li>[10940175/KA580] Patch Wizard FAQ</li>
   ...
   l_sig.success_msg := 'All field service suggested patches have been applied.';
   l_sig.print_condition := 'ALWAYS';
   l_sig.fail_type := 'W';
   l_sig.print_sql_output := 'Y';
   l_sig.limit_rows := 'N';
  ...
  -- Register
  l_step := '60';
  g_signatures('CRM_CSF_CHECK_SPECIFIC_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'CRM_CSF_CHECK_SPECIFIC_PATCHES',     -- sig ID
    l_sig,                              -- signature information
    l_col_rows,                         -- data
    l_hdr);                             -- headers
...
FUNCTION check_rec_patches_3 RETURN VARCHAR2 IS
  /* Signature CRM_CSP_CHECK_SPECIFIC_PATCHES */
  l_col_rows   COL_LIST_TBL := col_list_tbl(); -- Row values
  l_rel_rows   COL_LIST_TBL := col_list_tbl(); -- Row release
  l_hdr        VARCHAR_TBL  := varchar_tbl(); -- Column headings
  l_app_date   DATE;         -- Patch applied date
...
BEGIN
    ...
    print_log('Processing recommended patches signature: CRM_CSP_CHECK_SPECIFIC_PATCHES (check_rec_patches_3) "Spares Suggested Patches" (version 6)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30170572';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Part Requirement Html Item Details Button Not Working-Unresponsive';
   l_col_rows(5)(l_rows) := '[2590295.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Part Requirement Html Item Details Button Not Working-Unresponsive';
   l_col_rows(5)(l_rows) := '[2595398.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '31884735';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Parts Transfer - Unable To Transfer Item With Lot Number';
   l_col_rows(5)(l_rows) := '[2786882.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '13939756';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Not Able To Do Sub Inventory Transfer Using Parts Requirement HTML';
   l_col_rows(5)(l_rows) := '[1463729.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30493056';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Debrief: Error INV-ROW NOT FOUND Processing Record for Material Debrief';
   l_col_rows(5)(l_rows) := '[2280615.1]';

END IF;

   l_extra_info('##SHOW_SQL##'):= 'Y';

   l_sig.sigrepo_id := '19609';
   l_sig.title := 'Spares Suggested Patches';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := 'Please check if any of the spares management suggested patches were not applied in this instance.';
   l_sig.solution := 'Above are the spares management specific patches for this product area. 
...
<li>[10940175/KA580] Patch Wizard FAQ</li>
   ...
   l_sig.success_msg := 'All spares management suggested patches have been applied.';
   l_sig.print_condition := 'ALWAYS';
   l_sig.fail_type := 'W';
   l_sig.print_sql_output := 'Y';
   l_sig.limit_rows := 'N';
  ...
  -- Register
  l_step := '60';
  g_signatures('CRM_CSP_CHECK_SPECIFIC_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'CRM_CSP_CHECK_SPECIFIC_PATCHES',     -- sig ID
    l_sig,                              -- signature information
    l_col_rows,                         -- data
    l_hdr);                             -- headers
...
FUNCTION check_rec_patches_4 RETURN VARCHAR2 IS
  /* Signature CRM_CSM_CHECK_SPECIFIC_PATCHES */
  l_col_rows   COL_LIST_TBL := col_list_tbl(); -- Row values
  l_rel_rows   COL_LIST_TBL := col_list_tbl(); -- Row release
  l_hdr        VARCHAR_TBL  := varchar_tbl(); -- Column headings
  l_app_date   DATE;         -- Patch applied date
...
BEGIN
    ...
    print_log('Processing recommended patches signature: CRM_CSM_CHECK_SPECIFIC_PATCHES (check_rec_patches_4) "Mobile Field Service Suggested Patches" (version 12)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '18463177';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Mobile Field Service 12.1.3 Release, Install and Implementation Notes';
   l_col_rows(5)(l_rows) := '[1282974.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25858036';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'What Are Recommended Server and Client Patches For Oracle Mobile Field Service 12.2.6?';
   l_col_rows(5)(l_rows) := '[2300273.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '29550609';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Mobile Field Service (CSM): Latest Patches for Releases 12.2.x';
   l_col_rows(5)(l_rows) := '[2433042.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '32788124';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Upgarde Issues With Mobile Field Service Multiplatform Application IOS 14.5 Version';
   l_col_rows(5)(l_rows) := '[2778906.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33000985';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'MFS 26.89 CSM 12.2: DESTINATION ORGANIZATION DESCRIPTION MISSING IN MATERIAL INSTALL/RETURN';
   l_col_rows(5)(l_rows) := '[2797521.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '32954321';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'CSM 12.2: ISSUES AFTER APPLYING PATCH 32788124';
   l_col_rows(5)(l_rows) := '[2795275.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '32796340';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'CSM 12.2: APPS SCHEMA NAME HARDCODED';
   l_col_rows(5)(l_rows) := '[2785575.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30020355';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'GETTING ERROR ON ACCESSING ORACLE MOBILE FIELD SERVICE RESPONSIBILITY';
   l_col_rows(5)(l_rows) := '[2571845.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '32794791';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'MFS 26.87 NOT ABLE TO CHANGE LABEL NAME OF SPARES INFO BUTTON IN MOBILE FIELD SERVICE';
   l_col_rows(5)(l_rows) := '[2780578.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '32786160';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'MFS22.12.1.0 CREATE A FILE FROM MFS APPLICATION IN LOCAL DRIVE WINDOWS OS';
   l_col_rows(5)(l_rows) := '[2780879.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '32806725';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'MFS 26.86 - TASK DETAILS GOT BLANK AFTER SYNCH';
   l_col_rows(5)(l_rows) := '[2780879.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30911255';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'FIELD SERVICE TASKS ARE NOT FLOWING FROM EBS TO MFS MP';
   l_col_rows(5)(l_rows) := '[2659180.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33494754';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'MFS 26.96 NOTE TYPE AND VISIBILITY BECOME NON-EDITABLE IN MFS';
   l_col_rows(5)(l_rows) := '[2823787.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33301251';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Unable To Hide Labor Item Field In Mobile Field Service - Debrief Labor Screen';
   l_col_rows(5)(l_rows) := '[2808885.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '31835942';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Mobile Field Service: Note Type Does Not Change From Default Value';
   l_col_rows(5)(l_rows) := '[2809639.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '31772368';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'JTM Master Concurrent Program Erroring When Parameter Category Is Selected As Transaction';
   l_col_rows(5)(l_rows) := '[2807072.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '31245137';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Csmseq.ldt Hung When Applying Patches 31940339:R12.CSM.C, 31197431:R12.CSM.C';
   l_col_rows(5)(l_rows) := '[2734802.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '32028927';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Mobile Field Service Multiplatform(MFS MP): Not Able to Create Service Request(SR) Without Entering Urgency Field';
   l_col_rows(5)(l_rows) := '[2808495.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36912797';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'MFS 28.188: Mandatory patch for New MFS Client application for iOS Platform Users';
   l_col_rows(5)(l_rows) := '[3071038.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37829017';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Field Engineers Are Unable To Properly Input Time/Calendar Updates';
   l_col_rows(5)(l_rows) := '[3087058.1]';

END IF;

   l_extra_info('##SHOW_SQL##'):= 'Y';

   l_sig.sigrepo_id := '19610';
   l_sig.title := 'Mobile Field Service Suggested Patches';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := 'Please check if any of the mobile field service suggested patches were not applied in this instance.';
   l_sig.solution := 'Above are the mobile field service specific patches for this product area. 
...
<li>[10940175/KA580] Patch Wizard FAQ</li>
   ...
   l_sig.success_msg := 'All mobile field service suggested patches have been applied.';
   l_sig.print_condition := 'ALWAYS';
   l_sig.fail_type := 'W';
   l_sig.print_sql_output := 'Y';
   l_sig.limit_rows := 'N';
  ...
  -- Register
  l_step := '60';
  g_signatures('CRM_CSM_CHECK_SPECIFIC_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'CRM_CSM_CHECK_SPECIFIC_PATCHES',     -- sig ID
    l_sig,                              -- signature information
    l_col_rows,                         -- data
    l_hdr);                             -- headers
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Application Name';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_app_id,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Organization';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_org_id,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Resource Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_resource_num,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Task Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_task_number,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Part Requirement Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_req_num,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Item Name';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_item_name,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Serial Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_serial_number,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/01/28 18:12:07 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'csf_analyzer.sql';
...
debug('begin parameter validation: p_app_id');
IF p_app_id IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Application Name is required.');
...
INTO l_exists_val
FROM FND_PRODUCT_INSTALLATIONS PI, FND_APPLICATION_VL APP, FND_APPLICATION_TL T
WHERE PI.APPLICATION_ID = p_app_id
 AND app.application_id = pi.application_id
AND app.application_id = t.application_id
AND pi.application_id = t.application_id
AND app.application_short_name IN ('CSF', 'CSP','CSM','CSR')
AND pi.status <> 'N'
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Application is Not Installed');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_app_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_app_id');

debug('begin parameter validation: p_org_id');
IF p_org_id IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Organization is required.');
   raise invalid_parameters;
END IF;
...
WHERE OOD.ORGANIZATION_ID = p_org_id
 AND  OOD.inventory_enabled_flag = 'Y'
    AND OOD.operating_unit IS NOT NULL

 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Please select Organization');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
debug('begin parameter validation: p_resource_num');
IF p_resource_num IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Resource Number is required.');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_resource_num');
...
/*
g_org_id := p_org_id;  -- there is no ORG_ID parameter, you have to figure out where to source this from
g_org_name := l_org_name;
g_instance_name := l_instance;
g_app_name := p_app_name;
g_item_name := p_item_name;

select name into l_org_name
from HR_ALL_ORGANIZATION_UNITS where organization_id = g_org_id;

select application_id into g_app_id from fnd_application where application_short_name = g_app_name;

SELECT
    material_billable_flag into g_billing_type
FROM
    mtl_system_items_b
WHERE
    organization_id = g_org_id
    AND segment1 like g_item_name
    AND TO_DATE(sysdate, 'YYYY/MM/DD HH24:MI:SS') BETWEEN nvl(trunc(mtl_system_items_b.start_date_active), TO_DATE(sysdate, 'YYYY/MM/DD HH24:MI:SS'
    )) AND nvl(trunc(mtl_system_items_b.end_date_active), TO_DATE(sysdate, 'YYYY/MM/DD HH24:MI:SS'))
    	AND inventory_item_status_code <> 'Inactive' ;

--added by subba
SELECT
    inventory_item_id into g_item_id
FROM
    mtl_system_items_b
WHERE
    organization_id = 204
    AND upper(segment1) like upper(p_item_name);
...
into g_app_name, g_app_id
from fnd_application_vl 
where application_id = p_app_id;

-- added by Subba
g_org_id := p_org_id;
g_res_num :=  p_resource_num;
select nvl(resource_id, null) into g_res_id from jtf_rs_resource_extns where resource_number = p_resource_num;

IF p_task_number is null THEN
	g_task_num := null;
else
	g_task_num := p_task_number;
end if;
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$RESOURCEID$$##') := g_res_id;
   g_masked_tokens('##$$RESOURCEID$$##') := mask_text( g_sql_tokens('##$$RESOURCEID$$##'), 'NO_MASK');
   g_sql_tokens('##$$ORGID$$##') := p_org_id;
   g_masked_tokens('##$$ORGID$$##') := mask_text( g_sql_tokens('##$$ORGID$$##'), 'NO_MASK');
   g_sql_tokens('##$$ITEMNAME$$##') := p_item_name;
   g_masked_tokens('##$$ITEMNAME$$##') := mask_text( g_sql_tokens('##$$ITEMNAME$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPID$$##') := p_app_id;
   g_masked_tokens('##$$APPID$$##') := mask_text( g_sql_tokens('##$$APPID$$##'), 'NO_MASK');
   g_sql_tokens('##$$A$$##') := 'csf_analyzer_pkg';
   ...
   g_sql_tokens('##$$SERIALNUMBER$$##') := p_serial_number;
   g_masked_tokens('##$$SERIALNUMBER$$##') := mask_text( g_sql_tokens('##$$SERIALNUMBER$$##'), 'NO_MASK');
   g_sql_tokens('##$$TASKNUM$$##') := g_task_num;
   g_masked_tokens('##$$TASKNUM$$##') := mask_text( g_sql_tokens('##$$TASKNUM$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM1$$##') := g_app_id;
   g_masked_tokens('##$$APPS_PARAM1$$##') := mask_text( g_sql_tokens('##$$APPS_PARAM1$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM2$$##') := '170';
...
debug('begin add_signature: EBS_CRM_SC_GEN_MAX_SEQ');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28262',
      p_sig_id                 => 'EBS_CRM_SC_GEN_MAX_SEQ',
  ...
  FROM dba_sequences
 WHERE sequence_owner IN ('''||mask_text(g_app_name, nvl( upper(''), 'NO_MASK') )||''')
   AND round ((100 / max_value) * last_number, 2) >= 70
 ORDER BY 5 DESC, 2',
      p_title                  => 'Sequences Reaching Maximum Value',
      p_fail_condition         => 'RS',
...
If assistance is needed, log an SR with Sequence Owner product. ',
      p_solution               => 'Refer to [2989870/KA1025] - Managing Sequences in Oracle E-Business Suite Release 12.2 ',
      p_success_msg            => 'All the sequence(s) values are well within the maximum value.',
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_GEN_MAX_SEQ');



debug('begin add_signature: EBS_CRM_SC_GEN_DOMIDX_FAILED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27924',
      p_sig_id                 => 'EBS_CRM_SC_GEN_DOMIDX_FAILED',
      p_sig_sql                => 'SELECT
    OWNER,
    INDEX_NAME,
    INDEX_TYPE,
...
FROM
    DBA_INDEXES
WHERE
    INDEX_NAME LIKE ('''||mask_text(g_app_name, nvl( upper(''), 'NO_MASK') )||'%'')
    AND DOMIDX_OPSTATUS IS NOT NULL
    AND DOMIDX_OPSTATUS =''FAILED'' 
    ORDER BY 2 DESC',
      p_title                  => 'Indexes with FAILED value for DOMIDX_OPSTATUS column',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Indexes with ''FAILED'' value for DOMIDX_OPSTATUS column',
      p_solution               => 'Some indexes have a ''FAILED'' value for the domidx_opstatus column, One of the causes could be max_extents parameter must have exceeded for the indexes.

Findings and Recommendations:
Refer to [786538/KB565666] - ORA-29858, ORA-01631 And ORA-13249 Errors When Creating CSF Spatial Indexes.',
      p_success_msg            => 'All indexes have ''Valid'' status.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_GEN_DOMIDX_FAILED');



debug('begin add_signature: EBS_CRM_SC_GEN_MAX_EXTENT_OBJ');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27925',
      p_sig_id                 => 'EBS_CRM_SC_GEN_MAX_EXTENT_OBJ',
      p_sig_sql                => 'SELECT
OWNER                     
, SEGMENT_NAME              
, SEGMENT_TYPE              
...
FROM 
 DBA_SEGMENTS
WHERE
 SEGMENT_NAME LIKE  ('''||mask_text(g_app_name, nvl( upper(''), 'NO_MASK') )||'%'')
 AND (EXTENTS*1.10) >= MAX_EXTENTS
 ORDER BY 2 DESC',
      p_title                  => 'DBA Objects reaching MAX# of Extents',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'DBA Objects reaching MAX# of Extents',
      p_solution               => 'Some DBA Objects have reached max value for max_extents. 

Findings and Recommendations:
Refer to [1025581.6] - How to Diagnose and Resolve ORA-1628, ORA-1630, ORA-1631, ORA-1632, ORA-1684 : max # of extents <num> reached in < OBJECT >',
      p_success_msg            => 'All DBA objects are within Max_extents range. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_GEN_MAX_EXTENT_OBJ');



debug('begin add_signature: EBS_CRM_SC_UMX_ACCESS_ROLE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29415',
      p_sig_id                 => 'EBS_CRM_SC_UMX_ACCESS_ROLE',
      p_sig_sql                => 'SELECT * FROM (SELECT wf.NAME code,
  wf.orig_system,
  wf.display_name griddata,
  Decode(Sign(SYSDATE - Nvl(wf.start_date,SYSDATE - 1)),
1,Decode(Sign(Nvl(wf.expiration_date,SYSDATE + 1) - SYSDATE),1,''ACTIVE'',''INACTIVE''),
-1,''INACTIVE'', ''ACTIVE'') status,
  cat.lookup_code category_code,
  fa.application_name,
  wf.owner_tag,
  wf.partition_id,
  Sign(Nvl(fga_selected_rows.can_update,0) + fga_all_rows.can_update)                   can_update,
  Sign(Nvl(fga_selected_rows.can_create_grant,0) + fga_all_rows.can_create_grant)       can_create_grant,
  Sign(Nvl(fga_selected_rows.can_alter_hierarchy,0) + fga_all_rows.can_alter_hierarchy) can_alter_hierarchy,
  Sign(Nvl(fga_selected_rows.security_wizard,0) + fga_all_rows.security_wizard)         security_wizard
FROM   umx_all_role_vl wf,
  fnd_lookup_assignments cat,
  fnd_application_vl fa,
  (SELECT   Sum(ulr.can_update)          can_update,
Sum(ulr.can_create_grant)    can_create_grant,
Sum(ulr.can_alter_hierarchy) can_alter_hierarchy,
Sum(ulr.security_wizard)     security_wizard,
ulrsr.role_name              admin_role
FROM     umx_lsa_role ulr,
umx_lsa_role_set_roles ulrsr,
fnd_user u,
wf_user_roles wur
WHERE    u.user_id = fnd_global.user_id
AND wur.user_name = u.user_name
AND wur.role_name = ulr.admin_role
AND ulrsr.role_set_id = ulr.role_set_id
AND ulrsr.role_set_id <> 0
GROUP BY ulrsr.role_name) fga_selected_rows,
  (SELECT Sum(can_update)          can_update,
  Sum(can_create_grant)    can_create_grant,
  Sum(can_alter_hierarchy) can_alter_hierarchy,
  Sum(security_wizard)     security_wizard
FROM   (SELECT Sum(ulr.can_update)          can_update,
  Sum(ulr.can_create_grant)    can_create_grant,
  Sum(ulr.can_alter_hierarchy) can_alter_hierarchy,
  Sum(ulr.security_wizard)     security_wizard
FROM   umx_lsa_role ulr,
...
WHERE  u.user_id = fnd_global.user_id
  AND wur.user_name = u.user_name
  AND wur.role_name = ulr.admin_role
  AND ulr.role_set_id = 0
UNION
SELECT 0 can_update,
  0 can_create_grant,
  0 can_alter_hierarchy,
  0 security_wizard
FROM   dual)) fga_all_rows
WHERE  cat.obj_name (+)  = ''UMX_ACCESS_ROLE''
  ...
  AND wf.NAME = cat.instance_pk1_value (+)
  AND wf.owner_tag = fa.application_short_name (+)
  AND wf.NAME = fga_selected_rows.admin_role (+)) QRSLT  WHERE (UPPER(GridData) like ''%'' and UPPER(Code) like ''FND_RESP|'||mask_text(g_app_name, nvl( upper(''), 'NO_MASK') )||'%'')',
      p_title                  => 'UMX Role maintenance for '||mask_text(g_app_name, nvl( upper(''), 'NO_MASK') )||' application',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'UMX Role maintenance for '||mask_text(g_app_name, nvl( upper(''), 'NO_MASK') )||' application',
      p_solution               => 'Please refer to the following, [3034043/KB765781]',
      p_success_msg            => 'List of responsibilities having the UMX Role are displayed.
 ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_UMX_ACCESS_ROLE');



debug('begin add_signature: EBS_CRM_CSF_DBFASG_STAT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17418',
      p_sig_id                 => 'EBS_CRM_CSF_DBFASG_STAT',
      p_sig_sql                => 'select * from
(
SELECT
jts_vl.TASK_STATUS_ID
,jts_vl.NAME
,jts_vl.DESCRIPTION
, to_char(jts_vl.start_date_active,''DD-Mon-YYYY'') START_DATE_ACTIVE
, to_char(jts_vl.end_date_active,''DD-Mon-YYYY'') END_DATE_ACTIVE
,jts_vl.CLOSED_FLAG
,jts_vl.SEEDED_FLAG
,jts_vl.ASSIGNED_FLAG
,jts_vl.WORKING_FLAG
,jts_vl.APPROVED_FLAG
,jts_vl.COMPLETED_FLAG
,jts_vl.CANCELLED_FLAG
,jts_vl.REJECTED_FLAG
,jts_vl.ACCEPTED_FLAG
,jts_vl.ON_HOLD_FLAG
,jts_vl.SCHEDULABLE_FLAG
,jts_vl.DELETE_ALLOWED_FLAG
,jts_vl.TASK_STATUS_FLAG
,jts_vl.ASSIGNMENT_STATUS_FLAG
,jts_vl.ENFORCE_VALIDATION_FLAG
...
order by task_status_id',
      p_title                  => 'Task Statuses',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no active task statuses.',
      p_solution               => 'Please refer to solution in [1145975/KB481450] - How To Setup Field Service Task Transition Flow.',
      p_success_msg            => 'Displaying the list of active task statuses.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSF_DBFASG_STAT');



debug('begin add_signature: EBS_CRM_GEN_TSKTYP_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16888',
      p_sig_id                 => 'EBS_CRM_GEN_TSKTYP_CHECK',
      p_sig_sql                => 'SELECT
	 (T2.TASK_TYPE_ID || '' - ''|| T2.NAME ) "TASK TYPE"
	, SUBSTR(T2.DESCRIPTION, 0, 100) "DESCRIPTION"
    , T3.SEEDED_FLAG
    , to_char(T3.START_DATE_ACTIVE, ''DD-Mon-YYYY'')START_DATE_ACTIVE
    ,to_char(T3.END_DATE_ACTIVE, ''DD-Mon-YYYY'') END_DATE_ACTIVE
    , T3.SCHEDULE_FLAG
    , T3.SPARES_ALLOWED_FLAG
    , T3.PLANNED_EFFORT
    , T3.PLANNED_EFFORT_UOM
FROM
	JTF_TASK_TYPES_TL T2 ,
	JTF_TASK_TYPES_B T3
WHERE
	T2.TASK_TYPE_ID = T3.TASK_TYPE_ID
	AND T2.LANGUAGE       = ''US''
	AND T3.RULE           = ''DISPATCH''   
    AND (TRUNC(SYSDATE) BETWEEN TRUNC(NVL(T3.START_DATE_ACTIVE,SYSDATE)) 
    AND TRUNC(NVL(T3.END_DATE_ACTIVE,SYSDATE)))
GROUP BY
	T2.TASK_TYPE_ID
    ,T2.NAME
    ,T2.DESCRIPTION
    ,  T3.SEEDED_FLAG
     , to_char(T3.START_DATE_ACTIVE, ''DD-Mon-YYYY'') 
    ,to_char(T3.END_DATE_ACTIVE, ''DD-Mon-YYYY'')  
    , T3.SCHEDULE_FLAG
    , T3.SPARES_ALLOWED_FLAG
    , T3.PLANNED_EFFORT
    , T3.PLANNED_EFFORT_UOM
 ORDER BY T2.TASK_TYPE_ID
       ',
      p_title                  => 'Task Types',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no field service task types defined that can be used to create tasks.',
      p_solution               => 'When field service task type is not selected, system errors with:<br>FRM-40212: Invalid value for field TASK_TYPE.<br>

Please refer to solution in [2351331/KB786876] - How to Setup the Task Types to Make a Task Qualify As a Field Service Task for Scheduling.',
      p_success_msg            => 'Displaying field service task types used to create tasks.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_GEN_TSKTYP_CHECK');



debug('begin add_signature: EBS_CRM_GEN_BP_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17227',
      p_sig_id                 => 'EBS_CRM_GEN_BP_CHECK',
      p_sig_sql                => 'SELECT 
NAME || '' - ('' || BUSINESS_PROCESS_ID || '')'' AS "BUSINESS PROCESS"
, DESCRIPTION
...
AND FIELD_SERVICE_FLAG <> ''N''
ORDER BY NAME',
      p_title                  => 'Business Processes',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no business processes defined.',
      p_solution               => '<ul>
	<li>The system can throw following errors, when there are no active business processes: 
	 
	 <ol>
	 	<li> Business Process ID is invalid
		FND_AS_UNEXPECTED_ERROR (PKG_NAME=CSF_DEBRIEF_P
		FND_AS_UNEXPECTED_ERROR (PKG_NAME=CSF_DEBRIEF_PVT) (PROCED
		(PROCEDURE_NAME=Create_debrief_lines) (ERROR_TEXT=ORA-1001: invalid cursor).
		</li>
		
		<li>
			API Programming Error (CS_ServiceRequest_PVT.Create_ServiceRequest): The value "" for parameter business_process_id is invalid.<br>
		</li>
	
	</ol>
	</li>
	
	<li>Please refer to solution in  [2317130/KB743266] - How to Setup Business Processes in Oracle Teleservice.</li>
</ul>',
      p_success_msg            => 'Displaying business processes.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_GEN_BP_CHECK');



debug('begin add_signature: EBS_CRM_CSF_DBF_FLXFLDS');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##FREEZE_FLEX_DEFINITION_FLAG'):= 'left,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '15896',
      p_sig_id                 => 'EBS_CRM_CSF_DBF_FLXFLDS',
      p_sig_sql                => 'SELECT
A.DESCRIPTIVE_FLEXFIELD_NAME "FLEX FIELD NAME"
    , A.DESCRIPTIVE_FLEX_CONTEXT_CODE "CONTEXT"
    , D.END_USER_COLUMN_NAME "CONTEXT COL"
    , D.APPLICATION_COLUMN_NAME
    , A.ENABLED_FLAG 
    , D.REQUIRED_FLAG
    , C.FREEZE_FLEX_DEFINITION_FLAG
FROM
    FND_DESCR_FLEX_CONTEXTS_VL   A,
    FND_DESCRIPTIVE_FLEXS_VL     C,
    FND_DESCR_FLEX_COLUMN_USAGES D
WHERE
    A.DESCRIPTIVE_FLEXFIELD_NAME IN (''CSF_DEBRIEF_HEADERS'', ''CSF_DEBRIEF_LINES'')
    AND A.ENABLED_FLAG = ''Y''
    AND C.FREEZE_FLEX_DEFINITION_FLAG <>''Y''
    AND C.DESCRIPTIVE_FLEXFIELD_NAME = A.DESCRIPTIVE_FLEXFIELD_NAME
    AND C.DESCRIPTIVE_FLEXFIELD_NAME = D.DESCRIPTIVE_FLEXFIELD_NAME
    AND 0 < (
        SELECT
            COUNT(*)
        FROM
        ...
        WHERE
            B.DESCRIPTIVE_FLEX_CONTEXT_CODE = A.DESCRIPTIVE_FLEX_CONTEXT_CODE
            AND B.DESCRIPTIVE_FLEX_CONTEXT_CODE = D.DESCRIPTIVE_FLEX_CONTEXT_CODE
            AND B.ENABLED_FLAG = ''Y''
            AND B.DESCRIPTIVE_FLEXFIELD_NAME IN (''CSF_DEBRIEF_HEADERS'', ''CSF_DEBRIEF_LINES'')
    )
    ORDER BY A.DESCRIPTIVE_FLEXFIELD_NAME, D.APPLICATION_COLUMN_NAME
   ',
      p_title                  => 'Debrief Flexfields Compilation/Frozen Check',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Additional debrief information flexfields are not compiled/frozen.',
      p_solution               => 'When additional debrief information flexfields not compiled, system errors with: <br>
Error: JBO-27122: SQL Error During Statement Preparation.
<br>
Please refer to solution in [1296543/KB217988] - Error: JBO-27122: SQL Error During Statement Preparation, When Opening Debrief Html Page.
',
      p_success_msg            => 'Displaying additional debrief information flexfields.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSF_DBF_FLXFLDS');



debug('begin add_signature: EBS_CRM_MAT_SAC_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17226',
      p_sig_id                 => 'EBS_CRM_MAT_SAC_CHECK',
      p_sig_sql                => 'SELECT DISTINCT CTTV.NAME AS SERVICE_ACTIVITY_NAME,
    CTTV.TRANSACTION_TYPE_ID,
    CTST.UPDATE_IB_FLAG,
    CTST.SRC_CHANGE_OWNER,
    CTTV.LINE_ORDER_CATEGORY_CODE,
    CIS.NAME STATUS_NAME,
   CTBO.ORG_ID
  FROM CS_TRANSACTION_TYPES_VL CTTV,
    ...
    CS_TXN_BILLING_OETXN_ALL CTBO
  WHERE CTTV.TRANSACTION_TYPE_ID = CTBT.TRANSACTION_TYPE_ID
  AND CTTV.TRANSACTION_TYPE_ID   = CBPT.TRANSACTION_TYPE_ID
  AND TRUNC(SYSDATE) BETWEEN NVL(CTTV.START_DATE_ACTIVE,TRUNC(SYSDATE) ) AND NVL(CTTV.END_DATE_ACTIVE,TRUNC(SYSDATE) )
  AND TRUNC(SYSDATE) BETWEEN NVL(CTBT.START_DATE_ACTIVE,TRUNC(SYSDATE) ) AND NVL(CTBT.END_DATE_ACTIVE,TRUNC(SYSDATE) )
  AND TRUNC(SYSDATE) BETWEEN NVL(CBPT.START_DATE_ACTIVE,TRUNC(SYSDATE) ) AND NVL(CBPT.END_DATE_ACTIVE,TRUNC(SYSDATE) )
  ...
  AND ( CTST.SRC_CHANGE_OWNER_TO_CODE       = ''E'' ) ) )
  OR NVL(CTST.SRC_CHANGE_OWNER_TO_CODE,''N'') = ''N'' ) )
  AND CTTV.LINE_ORDER_CATEGORY_CODE  IS NOT NULL
  AND CTBT.TXN_BILLING_TYPE_ID              = CTBO.TXN_BILLING_TYPE_ID (+)
  AND (CTBO.ORG_ID IN (''##$$ORGID$$##'') OR CTBO.ORG_ID IS NULL)
  ORDER BY CTTV.NAME',
      p_title                  => ' Material Service Activities',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Material service activities are not defined for the organization id: '||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => 'When material service activities are not displayed in the service activity code list of values, debrief transaction cannot be created. <br>

Please refer to solution in [353477/KB560223#aref_section23] - Troubleshooting Why a Service Activity Code Is Not In The List Of Values On a Debrief Transaction.
',
      p_success_msg            => 'Displaying material service activities for the organization id: '||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_MAT_SAC_CHECK');



debug('begin add_signature: EBS_CRM_LABEXP_SAC_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17603',
      p_sig_id                 => 'EBS_CRM_LABEXP_SAC_CHECK',
      p_sig_sql                => 'SELECT
   DECODE(CBTC.BILLING_CATEGORY, ''E'', ''EXPENSE'', ''L'', ''LABOR'') "BILLING CATEGORY",
   CTT.NAME SERVICEACTIVITY,
...
FROM
    ...
    CS_BUSINESS_PROCESSES        CBP
WHERE
    CTT.TRANSACTION_TYPE_ID = CBPT.TRANSACTION_TYPE_ID
    AND CBPT.BUSINESS_PROCESS_ID = CBP.BUSINESS_PROCESS_ID
    AND CBTC.BILLING_CATEGORY IN (''L'', ''E'')
    AND CTBO.ORG_ID = ##$$ORGID$$##
    AND CTBT.BILLING_TYPE = CBTC.BILLING_TYPE
    AND CTBT.TRANSACTION_TYPE_ID = CTT.TRANSACTION_TYPE_ID
    AND TRUNC(SYSDATE) BETWEEN TRUNC(NVL(CBPT.START_DATE_ACTIVE,SYSDATE)) AND TRUNC(NVL(CBPT.END_DATE_ACTIVE,SYSDATE)) 
    AND TRUNC(SYSDATE) BETWEEN TRUNC(NVL(CTT.START_DATE_ACTIVE,SYSDATE)) AND TRUNC(NVL(CTT.END_DATE_ACTIVE,SYSDATE))
    AND TRUNC(SYSDATE) BETWEEN TRUNC(NVL(CTBT.START_DATE_ACTIVE,SYSDATE)) AND TRUNC(NVL(CTBT.END_DATE_ACTIVE,SYSDATE))
    AND CTBT.TXN_BILLING_TYPE_ID = CTBO.TXN_BILLING_TYPE_ID (+) 
    ORDER BY CBTC.BILLING_CATEGORY, CTT.LINE_ORDER_CATEGORY_CODE, CTT.NAME',
      p_title                  => 'Labor/Expense Service Activities',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Labor/expense service activities are not defined.',
      p_solution               => 'When labor/expense service activities are not displayed in the service activity code list of values, debrief transaction cannot be created. <br>

Please refer to solution in [353477/KB560223#aref_section22] - Troubleshooting Why a Service Activity Code Is Not In The List Of Values On a Debrief Transaction.',
      p_success_msg            => 'Displaying labor/expense service activities.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_LABEXP_SAC_CHECK');



debug('begin add_signature: EBS_CRM_GEN_BILLING_ITEM');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17257',
      p_sig_id                 => 'EBS_CRM_GEN_BILLING_ITEM',
      p_sig_sql                => 'SELECT
  SEGMENT1            "ITEM NAME",
    DESCRIPTION         " ITEM DESCRIPTION",
    DECODE(MATERIAL_BILLABLE_FLAG, ''L'', ''LABOR'', ''E'', ''EXPENSE'', ''M'', ''MATERIAL'') BILLABLE_FLAG,
    DECODE(MTL_TRANSACTIONS_ENABLED_FLAG,''N'', ''MATERIAL TRANSACTIONS NOT ENABLED'', ''Y'', ''MATERIAL TRANSACTIONS ENABLED'') "TRANSACTION FLAG",
...
WHERE 
	...
	AND UPPER(SEGMENT1) LIKE UPPER(''##$$ITEMNAME$$##'')
	AND INVENTORY_ITEM_STATUS_CODE <> ''INACTIVE''
	AND MATERIAL_BILLABLE_FLAG IS NOT NULL
	AND TO_DATE(SYSDATE, ''YYYY/MM/DD HH24:MI:SS'') BETWEEN NVL(TRUNC(MTL_SYSTEM_ITEMS_B.START_DATE_ACTIVE), TO_DATE(SYSDATE, ''YYYY/MM/DD HH24:MI:SS''
	)) AND NVL(TRUNC(MTL_SYSTEM_ITEMS_B.END_DATE_ACTIVE), TO_DATE(SYSDATE, ''YYYY/MM/DD HH24:MI:SS''))
ORDER BY "ITEM NAME"
',
      p_title                  => 'Service Billing Items',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Material/expense/labor service billing items are not defined.',
      p_solution               => 'When the item cannot be entered/selected in the Item list of values, than the debrief transaction cannot be created.<br>
Please refer to solution in [2285623/KB394612] - How To Create An Expense/Labor/Material Billable Item.',
      p_success_msg            => 'Displaying material/expense/labor service billing items.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_GEN_BILLING_ITEM');



debug('begin add_signature: EBS_CRM_GEN_OPENPRD_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16886',
      p_sig_id                 => 'EBS_CRM_GEN_OPENPRD_CHECK',
      p_sig_sql                => 'SELECT 
       ORGANIZATION_ID,
	ACCT_PERIOD_ID, 
	PERIOD_START_DATE, 
...
WHERE 
	...
	AND PERIOD_SET_NAME = ''Accounting''
	AND EXTRACT(MONTH FROM PERIOD_START_DATE) = EXTRACT(MONTH FROM SYSDATE)
	AND EXTRACT(YEAR FROM PERIOD_START_DATE) = EXTRACT(YEAR FROM SYSDATE)
	AND OPEN_FLAG = ''Y'')
order by ACCT_PERIOD_ID',
      p_title                  => 'Inventory Accounting Periods',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Inventory accounting periods are not opened for the organization id '||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => 'When inventory accounting periods are not open for the current sysdate, system may error with:<br> Error: "ORA-01400: cannot insert NULL." <br>
Please refer to solution in [389551/KB517038] - Debrief Error: ORA-01400: cannot insert NULL in Concurrent Program.',
      p_success_msg            => 'Displaying open inventory accounting periods for the organization id '||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_GEN_OPENPRD_CHECK');



debug('begin add_signature: EBS_CRM_CSF_SRLNUM_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17421',
      p_sig_id                 => 'EBS_CRM_CSF_SRLNUM_CHECK',
...
FROM mtl_serial_numbers msn left join csf_debrief_mat_lines_v cdml 
on cdml.inventory_item_id = msn.inventory_item_id
WHERE(msn.group_mark_id IS NOT NULL
AND msn.group_mark_id   <> -1
and msn.inventory_item_id in (select msik.inventory_item_id from mtl_system_items_kfv msik
where 1=1 and upper(msik.concatenated_segments)  =upper( ''##$$ITEMNAME$$##'')
and msn.current_organization_id=msik.organization_id) 
and msn.current_organization_id= ##$$ORGID$$##
and msn.serial_number= ''##$$SERIALNUMBER$$##''
...
order by msn.serial_number',
      p_title                  => 'Serial Number in Debrief',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Serial number will not be displayed in the material debrief list of values.
',
      p_solution               => 'Please refer to solution in  [1273346/KB618235] - Debrief Error: Unable To Find The Serial Number On A Material Line.',
      p_success_msg            => 'Serial number can be used while performing the debrief.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSF_SRLNUM_CHECK');



debug('begin add_signature: EBS_CRM_CSM_JTF_HOOK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19158',
      p_sig_id                 => 'EBS_CRM_CSM_JTF_HOOK',
      p_sig_sql                => 'SELECT
    *
FROM
    (
...
ORDER BY
    hook_id ASC
',
      p_title                  => 'JTF Hooks Corrupted Seed Data',
      p_fail_condition         => 'RSGT1',
      p_problem_descr          => 'Worker failed to execute csfhook.ldt job when loading seed data for JTF_HOOKS_DATA. ',
      p_solution               => 'Please refer to solution in [2071076/KB760660] - Error Loading Seed Data For JTF_HOOKS_DATA: HOOK_ID = 10084, ORA-01422: Exact Fetch Returns More Than Requested Number of Rows',
      p_success_msg            => 'JTF Hooks seed data is not corrupted.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSM_JTF_HOOK');



debug('begin add_signature: EBS_CRM_CSFW_ORD_FAIL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18751',
      p_sig_id                 => 'EBS_CRM_CSFW_ORD_FAIL',
      p_sig_sql                => 'select Ad_Patch.Is_Patch_Applied(''R12'',-1,12411681) From Dual

',
      p_title                  => 'Wireless Process Order Files',
      p_fail_condition         => '[Ad_Patch.Is_Patch_Applied("R12",-1,12411681)] = [NOT_APPLIED]',
      p_problem_descr          => 'Field Service Wireless Process Order Files are Invalid',
      p_solution               => 'Follow the solution mentioned in the [1516179/KB776165] - FS Wireless: CsfwPartsReturnSave.jsp And CsfwPartsSrchResults.jsp Fail To Compile.',
      p_success_msg            => 'Field Service Wireless Process Order Files are Valid.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSFW_ORD_FAIL');



debug('begin add_signature: EBS_CRM_CSP_REQ_FLEX');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##FREEZE_FLEX_DEFINITION_FLAG'):= 'left,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '17607',
      p_sig_id                 => 'EBS_CRM_CSP_REQ_FLEX',
      p_sig_sql                => 'SELECT
A.DESCRIPTIVE_FLEXFIELD_NAME "FLEX FIELD NAME"
    , A.DESCRIPTIVE_FLEX_CONTEXT_CODE "CONTEXT"
    , D.END_USER_COLUMN_NAME "CONTEXT COL"
...
FROM
    ...
    FND_DESCR_FLEX_COLUMN_USAGES D
WHERE
    A.DESCRIPTIVE_FLEXFIELD_NAME IN (
    ...
    ',
      p_title                  => 'Spares Flexfields Compilation/Frozen Check',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Spares requirement flexfields are not compiled/frozen.',
      p_solution               => 'When spares requirement flexfields are not compiled, system errors with:<br>
The Descriptive Flexfields With Application Name Spares Management (CSP) And Name Spares Requirement Lines (Csp_Requirement_Lines) Is Not Frozen. 
<br>
Please refer to solution in [2778391/KB230023] - Error: The Descriptive Flexfields With Application Name Spares Management (CSP) And Name Spares Requirement Lines (Csp_Requirement_Lines) Is Not Frozen. 
',
      p_success_msg            => 'Displaying spares requirement flexfields.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSP_REQ_FLEX');



debug('begin add_signature: EBS_CRM_CSP_PLN_DSKTOP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18842',
      p_sig_id                 => 'EBS_CRM_CSP_PLN_DSKTOP',
      p_sig_sql                => 'SELECT
    CPP.PLANNING_PARAMETERS_ID   PLANNING_PARAMETERS_ID,
    CPP.ORGANIZATION_TYPE,
    CPP.ORGANIZATION_ID          ORGANIZATION_ID,
    CPP.FORECAST_RULE_ID         FORECAST_RULE_ID,
    CFRB.FORECAST_RULE_NAME      FORECAST_RULE_NAME,
    CPP.SECONDARY_INVENTORY      SECONDARY_INVENTORY,
    CPP.SERVICE_LEVEL            SERVICE_LEVEL,
    CPP.EDQ_FACTOR               EDQ_FACTOR,
    CPP.CONDITION_TYPE           CONDITION_TYPE,
    FL.MEANING                   CONDITION_TYPE_MEANING,
    CPP.ASL_FLAG,
    CPP.SAFETY_STOCK_FLAG,
    CPP.EXCESS_RULE_ID,
    CER.EXCESS_RULE_NAME,
    CPP.EDQ_MULTIPLE,
    CPP.MINIMUM_VALUE,
    ...
    CPP.NODE_TYPE,
    DECODE(CPP.NODE_TYPE, ''ORGANIZATION_WH'', OOD.ORGANIZATION_NAME, ''SUBINVENTORY'', OOD.ORGANIZATION_CODE
                                                                                    || ''.''
                                                                                    || CPP.SECONDARY_INVENTORY, CPP.NODE_NAME) NODE_NAME,
    CPP.PARENT_NODE_ID,
    CPP.LEVEL_ID,
    CPP.STOCKING_SITE_TYPE,
    FLS.MEANING                  STOCKING_SITE_TYPE_MEANING
   FROM
    CSP_PLANNING_PARAMETERS        CPP,
    CSP_FORECAST_RULES_B           CFRB,
    CSP_EXCESS_RULES_B             CER,
    CSP_BUSINESS_RULES_B           CBRB1,
    CSP_BUSINESS_RULES_B           CBRB2,
    CSP_BUSINESS_RULES_B           CBRB3,
    CSP_BUSINESS_RULES_B           CBRB4,
    FND_LOOKUPS                    FL,
    FND_LOOKUPS                    FLR,
    FND_LOOKUPS                    FLS,
    FND_LOOKUPS                    FLM,
    CSP_SEC_INVENTORIES            CSI,
    JTF_CALENDARS_VL               JCAL,
    HZ_TIMEZONES_VL                HZT,
    ORG_ORGANIZATION_DEFINITIONS   OOD
WHERE
    CFRB.FORECAST_RULE_ID (+) = CPP.FORECAST_RULE_ID
    AND CER.EXCESS_RULE_ID (+) = CPP.EXCESS_RULE_ID
    AND CBRB1.BUSINESS_RULE_ID (+) = CPP.RECOMMENDATION_RULE_ID
    AND CBRB1.BUSINESS_RULE_TYPE (+) = ''RECOMMENDATIONS''
    AND CBRB2.BUSINESS_RULE_ID (+) = CPP.NOTIFICATION_RULE_ID
    AND CBRB2.BUSINESS_RULE_TYPE (+) = ''NOTIFICATIONS''
    AND CBRB3.BUSINESS_RULE_ID (+) = CPP.RESCHEDULE_RULE_ID
    AND CBRB3.BUSINESS_RULE_TYPE (+) = ''RESCHEDULE''
    AND CBRB4.BUSINESS_RULE_ID (+) = CPP.WRP_RULE_ID
    AND CBRB4.BUSINESS_RULE_TYPE (+) = ''WRP''
    AND CSI.SECONDARY_INVENTORY_NAME (+) = CPP.SECONDARY_INVENTORY
    AND CSI.ORGANIZATION_ID (+) = CPP.ORGANIZATION_ID
    AND FL.LOOKUP_TYPE (+) = ''CSP_CONDITION_TYPE''
    AND FL.LOOKUP_CODE (+) = CPP.CONDITION_TYPE
    AND FL.ENABLED_FLAG (+) = ''Y''
    AND FLR.LOOKUP_TYPE (+) = ''CSP_RECOMMENDATION_METHOD''
    AND FLR.LOOKUP_CODE (+) = CPP.RECOMMEND_METHOD
    AND FLR.ENABLED_FLAG (+) = ''Y''
    AND FLS.LOOKUP_TYPE (+) = ''CSP_STOCKING_SITE_TYPE''
    AND FLS.LOOKUP_CODE (+) = CPP.STOCKING_SITE_TYPE
    AND FLS.ENABLED_FLAG (+) = ''Y''
    AND FLM.LOOKUP_TYPE (+) = ''CSP_MANAGED_BY''
    AND FLM.LOOKUP_CODE (+) = CPP.MANAGED_BY
    AND FLM.ENABLED_FLAG (+) = ''Y''
    AND JCAL.CALENDAR_ID (+) = CPP.CALENDAR_ID
    AND HZT.TIMEZONE_ID (+) = CPP.TIMEZONE_ID
    AND OOD.ORGANIZATION_ID (+) = CPP.ORGANIZATION_ID
AND (CPP.NODE_NAME IS NOT NULL
OR NODE_TYPE IS NOT NULL
OR LEVEL_ID IS NOT NULL
)
   ORDER BY  PLANNING_PARAMETERS_ID
    
    ',
      p_title                  => 'Spares Planners Desktop',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No planning nodes displayed in the spares planners desktop.',
      p_solution               => 'When no plannig nodes exists in the spares planners desktop, system errors with:<br>
FRM-47337: Tree Node Label Cannot Be Null

<br>
Log a Service Request with Support for assistance with a data fix script, and upload this EBS Oracle Field Service Analyzer.
<br>
Please refer the [1313870/KB726417] - Planner Desktop Error: "FRM-47337: Tree Node Label Cannot Be Null", for Oracle Support reference.',
      p_success_msg            => 'Displaying planning nodes in spares planners desktop.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSP_PLN_DSKTOP');



debug('begin add_signature: EBS_CRM_CSP_PR_SRC_ORG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18843',
      p_sig_id                 => 'EBS_CRM_CSP_PR_SRC_ORG',
      p_sig_sql                => 'SELECT MP.ORGANIZATION_CODE AS ORGANIZATION_CODE,
 HOU.NAME AS ORGANIZATION_NAME,
 MP.ORGANIZATION_CODE
 || '' : ''
 || HOU.NAME AS ORGANIZATION_FULLNAME,
...
FROM
 ...
 AND NVL(CONDITION_TYPE, ''G'') = ''G''
 ) SPARESORG,
 HR_ALL_ORGANIZATION_UNITS HOU,
 MTL_PARAMETERS MP
WHERE SPARESORG.ORGANIZATION_ID = MP.ORGANIZATION_ID
...
FROM
 ...
 HR_ALL_ORGANIZATION_UNITS HOU,
 MTL_PARAMETERS MP,
 MTL_SHIPPING_NETWORK_VIEW SHIP
WHERE SPARESORG.ORGANIZATION_ID = MP.ORGANIZATION_ID
AND MP.ORGANIZATION_ID = HOU.ORGANIZATION_ID
AND DECODE(''PART_REQ'', ''DEBRIEF'', SHIP.TO_ORGANIZATION_ID, SHIP.FROM_ORGANIZATION_ID) = MP.ORGANIZATION_ID
AND DECODE(''PART_REQ'', ''DEBRIEF'', SHIP.FROM_ORGANIZATION_ID, SHIP.TO_ORGANIZATION_ID) = ##$$ORGID$$##
ORDER BY ORGANIZATION_NAME',
      p_title                  => 'Source Organizations',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Source organizations are not listed in the list of values.',
      p_solution               => 'When the source organization list of values does not display the organizations, than the parts requirement cannot be created. <br>
Please refer to the solution in [1900013/KB424760] - Spares Management: Unable To See The List Of Values (LOV)For Source Organization And Source Sub Inventory On The Part Requirement.',
      p_success_msg            => 'Displaying all source organizations in the list of values.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSP_PR_SRC_ORG');



debug('begin add_signature: EBS_CRM_CSP_SRC_SUBINV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18849',
      p_sig_id                 => 'EBS_CRM_CSP_SRC_SUBINV',
      p_sig_sql                => 'SELECT mtl.organization_id,
   mtl.secondary_inventory_name,
   csp.secondary_inventory_id,
   csp.condition_type,
   csp.autoreceipt_flag,
   csp.spares_location_flag,
   csp.OWNER_RESOURCE_TYPE,
   csp.OWNER_RESOURCE_ID,
   csp.RETURN_ORGANIZATION_ID,
   csp.RETURN_SUBINVENTORY_NAME
 FROM mtl_subinventories_all_v mtl, CSP_SEC_INVENTORIES csp
 WHERE mtl.organization_id           = ##$$ORGID$$##
 AND NVL(mtl.disable_date, sysdate) >= sysdate
 and mtl.organization_id = csp.organization_id(+)
 and mtl.secondary_inventory_name = csp.secondary_inventory_name(+)
ORDER BY mtl.secondary_inventory_name ASC

',
      p_title                  => 'Source Subinventories',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Source subinventories are not listed in the list of values.',
      p_solution               => 'When the subinventory is not listed in the source subinventory list of values than: <br>
Please refer to solution in [1486843/KB757351] - Source Subinventory LOV in Parts Requirement HTML Does Not Display All Subinventories.',
      p_success_msg            => 'Displaying all source subinventories in the list of values.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSP_SRC_SUBINV');



debug('begin add_signature: EBS_CRM_CSP_SHIP_METHODS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18846',
      p_sig_id                 => 'EBS_CRM_CSP_SHIP_METHODS',
...
to_location_id,
cutoff_time,
shipping_method_meaning,
destination_type
from CSP_SHIPPING_DETAILS_V
where 
organization_id = ##$$ORGID$$##
and Destination_type =''L''
order by destination_type',
      p_title                  => 'Shipping Methods',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are duplicate shipping methods in the list of values.
',
      p_solution               => 'When duplicate shipping methods exist in the  list of values, <br>
Please refer to solution in [1525770/KB692466] - Duplicate Shipping Methods In The Shipping Method List Of Values.',
      p_success_msg            => 'Displaying all unique shipping methods in the list of values.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSP_SHIP_METHODS');



debug('begin add_signature: EBS_CRM_JTF_RESINFO');
   l_info('##MASK##SOURCE_ADDRESS1'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SOURCE_ADDRESS2'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SOURCE_ADDRESS3'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SOURCE_ADDRESS4'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SOURCE_EMAIL'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SOURCE_PHONE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##USER_ID'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##USER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19127',
      p_sig_id                 => 'EBS_CRM_JTF_RESINFO',
      p_sig_sql                => 'SELECT
RESOURCE_ID                
,CATEGORY                   
,RESOURCE_NUMBER            
...
',
      p_title                  => 'Resource Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Resource details not found for the resource number: '||mask_text(g_res_num, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => 'When the resource number: '||mask_text(g_res_num, nvl( upper(''), 'NO_MASK') )||' is not created properly, the field service application cannot be used. In order to create a valid field service resource:<br>
Please refer to solutions in: [1082537/KB376634] - How to Setup a Field Service Technician.
<br>
[404407/KB590191] - How to Drop and Recreate a Mobile User for Mobile Field Service (MFS) .',
      p_success_msg            => 'Displaying resource details for the resource number: '||mask_text(g_res_num, nvl( upper(''), 'NO_MASK') )||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_JTF_RESINFO');



debug('begin add_signature: EBS_CRM_GEN_RES_SUBINV');
   l_info('##MASK##OWNER_RESOURCE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##RESOURCE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17088',
      p_sig_id                 => 'EBS_CRM_GEN_RES_SUBINV',
      p_sig_sql                => 'SELECT
    *
FROM
    CSP_RS_SUBINVENTORIES_V
WHERE
    RESOURCE_ID = ##$$RESOURCEID$$##
    AND ORGANIZATION_ID = ##$$ORGID$$##
ORDER BY
...
',
      p_title                  => 'Resource Subinventories',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Subinventories are not defined for the resource number: '||mask_text(g_res_num, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => 'When subinventories are not defined for this resource, system errors with:  <br>Error: java.lang.NullPointerException<br>

Please refer to solution in [2497084/KB296280] - Error: "java.lang.NullPointerException", While Adding Items in Material Tab Of Debrief Page.',
      p_success_msg            => 'Displaying subinventories for the resource number: '||mask_text(g_res_num, nvl( upper(''), 'NO_MASK') )||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_GEN_RES_SUBINV');



debug('begin add_signature: EBS_CRM_JTF_TASKS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19065',
      p_sig_id                 => 'EBS_CRM_JTF_TASKS',
      p_sig_sql                => 'select 
task_id,
    task_number,
    task_name,
...
WHERE
    ...
    order by task_id',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Task details do not exist.',
      p_solution               => '',
      p_success_msg            => 'Displaying the task details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_JTF_TASKS');



debug('begin add_signature: EBS_CRM_JTF_TASK_ASSIGN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19066',
      p_sig_id                 => 'EBS_CRM_JTF_TASK_ASSIGN',
      p_sig_sql                => 'SELECT
    jtav.task_assignment_id,
    jtav.task_id,
    jtav.resource_type_code,
    jtav.resource_id,
    jtav.assignment_status_id,
    jtav.actual_effort,
    jtav.resource_territory_id,
    jtav.actual_effort_uom,
    jtav.schedule_flag,
    jtav.sched_travel_distance,
    jtav.sched_travel_duration,
    jtav.sched_travel_duration_uom,
    jtav.actual_travel_distance,
    jtav.actual_travel_duration,
    jtav.actual_travel_duration_uom,
    jtav.actual_start_date,
    jtav.actual_end_date,
    jtav.assignee_role
FROM
    jtf_task_assignments_v   jtav,
    jtf_tasks_vl             jtv
WHERE
    jtav.task_id = JTV.task_id
    AND jtv.task_number = ''##$$TASKNUM$$##''
ORDER BY JTAV.task_assignment_id',
      p_title                  => 'Task Assignments',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Task assignments do not exist..',
      p_solution               => '',
      p_success_msg            => 'Displaying the task assignments.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_JTF_TASK_ASSIGN');



debug('begin add_signature: EBS_CRM_CSF_DEF_DEFSUBINV_CHK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20787',
      p_sig_id                 => 'EBS_CRM_CSF_DEF_DEFSUBINV_CHK',
      p_sig_sql                => 'select crsv.resource_name, 
       crsv.organization_code,
       crsv.subinventory_code, 
       crsv.condition_type, 
       crsv.default_flag 
from csp_rs_subinventories_v crsv
where crsv.condition_type=''D''
and crsv.resource_id =##$$RESOURCEID$$##
and crsv.organization_id=##$$ORGID$$##
',
      p_title                  => 'Default Defective SubInventory Check',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Default Defective Organization/Sub inventory is not defined for the Resource.',
      p_solution               => 'Please refer to solution in [2799738.1 ]-Default Defective Org Setup is required for the resource to add DOA line'' When Submitting A Debrief Material Install Line With ''Defect on Arrival'' Usage Type.',
      p_success_msg            => 'Default Defective Organization/Sub inventory is defined for the Resource.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSF_DEF_DEFSUBINV_CHK');



debug('begin add_signature: EBS_CRM_SC_CSF_DEF_TRUNK_STK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27732',
      p_sig_id                 => 'EBS_CRM_SC_CSF_DEF_TRUNK_STK',
      p_sig_sql                => 'SELECT
          QRSLT.ORGANIZATION_CODE, 
          QRSLT.ORGANIZATION_ID,
          QRSLT.SUBINVENTORY,
          QRSLT.ITEM_ID,
          QRSLT.ITEM_NUMBER,
          QRSLT.REVISION,
...
FROM
    (
        SELECT
            MP.ORGANIZATION_CODE, 
            MOLV.ORGANIZATION_ID,
            MOLV.SUBINVENTORY_CODE SUBINVENTORY,
            MOLV.INVENTORY_ITEM_ID ITEM_ID,
            MOLV.PADDED_CONCATENATED_SEGMENTS  ITEM_NUMBER,
            MOLV.REVISION,
            MOLV.PRIMARY_UOM_CODE UOM,
            MOLV.TOTAL_QOH ONHAND,
            CSP_VALIDATE_PUB.GET_AVAIL_QTY(MOLV.ORGANIZATION_ID, MOLV.SUBINVENTORY_CODE, MOLV.LOCATOR_ID, MOLV.INVENTORY_ITEM_ID, MOLV.REVISION) AVAILABLE,
            MILK.CONCATENATED_SEGMENTS LOCATOR,
 	        MOLV.LOCATOR_ID
        FROM
            MTL_ONHAND_LOCATOR_V   MOLV,
            MTL_ITEM_LOCATIONS_KFV MILK,
            MTL_PARAMETERS         MP,
            MTL_ITEM_UOMS_VIEW     MIUV
        WHERE
            MILK.INVENTORY_LOCATION_ID (+) = MOLV.LOCATOR_ID
            AND MOLV.ORGANIZATION_ID = MP.ORGANIZATION_ID
            AND MIUV.ORGANIZATION_ID = MOLV.ORGANIZATION_ID
            AND MIUV.INVENTORY_ITEM_ID = MOLV.INVENTORY_ITEM_ID
            AND MIUV.UOM_CODE = MOLV.PRIMARY_UOM_CODE
        ORDER BY
            MOLV.SUBINVENTORY_CODE,
            MILK.CONCATENATED_SEGMENTS
    ) 
    QRSLT,
    CSP_INV_LOC_ASSIGNMENTS INVAS
WHERE
    	QRSLT.ORGANIZATION_ID = INVAS.ORGANIZATION_ID 
        AND QRSLT.SUBINVENTORY = INVAS.SUBINVENTORY_CODE
        AND INVAS.RESOURCE_TYPE = ''RS_EMPLOYEE''
        AND INVAS.DEFAULT_CODE = ''IN''
        AND QRSLT.ORGANIZATION_ID = ##$$ORGID$$##
        AND INVAS.RESOURCE_ID = ##$$RESOURCEID$$##
ORDER BY
	QRSLT.ITEM_NUMBER ASC    ',
      p_title                  => 'Default Subinventory Trunk Stock Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Default Subinventory Trunk Stock Item Details',
      p_solution               => 'Please refer to solutions in: [1082537/KB376634] - How to Setup a Field Service Technician.',
      p_success_msg            => 'Displaying Default Subinventory Trunk Stock Item Details',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_CSF_DEF_TRUNK_STK');



debug('begin add_signature: EBS_CRM_SC_CSF_RES_TERR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27733',
      p_sig_id                 => 'EBS_CRM_SC_CSF_RES_TERR',
      p_sig_sql                => 'SELECT
    TER.NAME,
    DECODE(PARENTTERR.TERR_ID, 1, HR.NAME, PARENTTERR.NAME) AS PARENT_TERRITORY_NAME,
    ''SERVICE'' TER_USAGE,
    TTA.NAME TERRITORY_TYPE,
    TER.ORG_ID,
    (
        SELECT
            TRANS_ACCESS_CODE
        ...
        WHERE
                TERR_RSC_ID = RESTERRITORYEO.TERR_RSC_ID
            AND ACCESS_TYPE = ''SERV_REQ''
    ) AS SERVICE_REQUEST,
    (
        SELECT
            TRANS_ACCESS_CODE
        ...
        WHERE
                TERR_RSC_ID = RESTERRITORYEO.TERR_RSC_ID
            AND ACCESS_TYPE = ''TASK''
    ) AS SERVICE_TASK
FROM
    JTF_TERR_RSC_ALL        RESTERRITORYEO,
    JTF_TERR_RSC_ACCESS_ALL TERRRESACCESSEO,
    JTF_TERR_ALL            TER,
    JTF_TERR_ALL            PARENTTERR,
    HR_OPERATING_UNITS      HR,
    JTF_TERR_TYPES_ALL      TTA
WHERE
    ( RESTERRITORYEO.TERR_RSC_ID = TERRRESACCESSEO.TERR_RSC_ID )
    AND ( RESTERRITORYEO.ORG_ID = TERRRESACCESSEO.ORG_ID )
    AND RESTERRITORYEO.TERR_ID = TER.TERR_ID
    AND TERRRESACCESSEO.ACCESS_TYPE = ''SRV_TASK''
    AND TER.ATTRIBUTE_CATEGORY = ''JTY_SERVICE''
    AND TER.PARENT_TERRITORY_ID = PARENTTERR.TERR_ID
    AND TER.ORG_ID = PARENTTERR.ORG_ID
    AND TER.ORG_ID = HR.ORGANIZATION_ID
    AND TER.TERRITORY_TYPE_ID = TTA.TERR_TYPE_ID (+)
    AND RESTERRITORYEO.RESOURCE_ID = ##$$RESOURCEID$$##',
      p_title                  => 'Territories Associated To The Resource',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Territories Associated To The Resource',
      p_solution               => 'Please refer to solutions in: [1082537/KB376634] - How to Setup a Field Service Technician.',
      p_success_msg            => 'Displaying Territories Associated To The Resource.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_CSF_RES_TERR');



debug('begin add_signature: EBS_CRM_SC_CSF_RES_ROLES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27734',
      p_sig_id                 => 'EBS_CRM_SC_CSF_RES_ROLES',
      p_sig_sql                => ' SELECT
    ROL.ROLE_NAME,
    LKP.MEANING  AS ROLE_TYPE,
    RESROLERELATIONEO.START_DATE_ACTIVE,
    RESROLERELATIONEO.END_DATE_ACTIVE
FROM
    JTF_RS_ROLE_RELATIONS RESROLERELATIONEO,
    JTF_RS_ROLES_VL       ROL,
    FND_LOOKUPS           LKP
WHERE
	RESROLERELATIONEO.ROLE_RESOURCE_TYPE = ''RS_INDIVIDUAL''
    AND NVL(RESROLERELATIONEO.DELETE_FLAG, ''N'') <> ''Y''
    AND TRUNC(SYSDATE) <= NVL(RESROLERELATIONEO.END_DATE_ACTIVE, SYSDATE)
    AND ROL.ROLE_ID = RESROLERELATIONEO.ROLE_ID
    AND LKP.LOOKUP_TYPE = ''JTF_RS_ROLE_TYPE''
    AND ROL.ROLE_TYPE_CODE = LKP.LOOKUP_CODE
    AND RESROLERELATIONEO.ROLE_RESOURCE_ID = ##$$RESOURCEID$$##',
      p_title                  => 'Roles Associated To The Resource',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Roles Associated To The Resource',
      p_solution               => 'Please refer to solutions in: [1082537/KB376634] - How to Setup a Field Service Technician.',
      p_success_msg            => 'Displaying Roles Associated To The Resource.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_CSF_RES_ROLES');



debug('begin add_signature: EBS_CRM_SC_CSF_RES_GRP_ROLE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27735',
      p_sig_id                 => 'EBS_CRM_SC_CSF_RES_GRP_ROLE',
      p_sig_sql                => 'SELECT
    RESGROUPMEMBERROLEEO.GROUP_NAME,
    RESGROUPMEMBERROLEEO.ROLE_NAME,
    RESGROUPMEMBERROLEEO.START_DATE_ACTIVE,
    RESGROUPMEMBERROLEEO.END_DATE_ACTIVE
FROM
    CSF_GROUP_MEMBER_ROLES_V RESGROUPMEMBERROLEEO
WHERE
    TRUNC(SYSDATE) <= NVL(RESGROUPMEMBERROLEEO.END_DATE_ACTIVE, SYSDATE)
    AND RESGROUPMEMBERROLEEO.RESOURCE_ID = ##$$RESOURCEID$$##',
      p_title                  => 'Group Roles Associated To The Resource',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Group Roles Associated To The Resource',
      p_solution               => 'Please refer to solutions in: [1082537/KB376634] - How to Setup a Field Service Technician.',
      p_success_msg            => 'Displaying Group Roles Associated To The Resource.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_CSF_RES_GRP_ROLE');



debug('begin add_signature: EBS_CRM_CSF_DBF_HDRS');
   l_info('##MASK##ADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19067',
      p_sig_id                 => 'EBS_CRM_CSF_DBF_HDRS',
      p_sig_sql                => 'select
...
,cdh.SOURCE_OBJECT_ID       
,cdh.CUSTOMER_ID            
,cdh.CUST_ACCOUNT_ID        
,cdh.ORGANIZATION_ID        
from 
csf_debrief_headers_v cdh
, JTF_TASK_ASSIGNMENTS_v JTA
, JTF_TASKS_VL JTV
where
cdh.task_id = JTA.task_id
...
order by cdh.debrief_header_id',
      p_title                  => 'Headers',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Debrief headers do not exist.',
      p_solution               => '',
      p_success_msg            => 'Displaying the debrief headers.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSF_DBF_HDRS');



debug('begin add_signature: EBS_CRM_CSF_DBF_EXP_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19070',
      p_sig_id                 => 'EBS_CRM_CSF_DBF_EXP_LINES',
      p_sig_sql                => 'SELECT
    cdev.channel_code,
    cdev.debrief_line_id,
    cdev.debrief_header_id,
    cdev.service_date,
    cdev.inventory_item_id,
    cdev.uom_code,
    cdev.quantity,
    cdev.expense_amount,
    cdev.currency_code,
    ...
    cdev.attribute14,
    cdev.attribute15,
    cdev.attribute_category,
    cdev.expense_reason_code, 
    CDEV.business_process_id,
    cdev.transaction_type_id,
    cdev.txn_type,
    cdev.expense_meaning,
    cdev.charge_upload_status,
    cdev.charge_upload_msg_code,
    cdev.charge_upload_message,
    cdev.error_text
FROM
    csf_debrief_exp_lines_v   cdev,
    csf_debrief_tasks_v       cdtv
WHERE
    cdev.debrief_header_id = cdtv.debrief_header_id
    AND cdtv.task_number = ''##$$TASKNUM$$##''
ORDER BY
    cdev.debrief_line_id',
      p_title                  => 'Expense Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Expense debrief lines do not exist.',
      p_solution               => '',
      p_success_msg            => 'Displaying the expense debrief lines.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSF_DBF_EXP_LINES');



debug('begin add_signature: EBS_CRM_CSF_DBF_LBR_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19069',
      p_sig_id                 => 'EBS_CRM_CSF_DBF_LBR_LINES',
      p_sig_sql                => 'SELECT
    cdlv.channel_code,
    cdlv.debrief_line_id,
    cdlv.debrief_header_id,
    cdlv.service_date,
    cdlv.inventory_item_id,
    cdlv.uom_code,
    cdlv.labor_start_date,
    cdlv.labor_end_date,
    cdlv.quantity,
    cdlv.starting_mileage,
    cdlv.ending_mileage,
    cdlv.attribute1,
    cdlv.attribute2,
    cdlv.attribute3,
    ...
    cdlv.attribute14,
    cdlv.attribute15, 
    CDLV.attribute_category,
    cdlv.labor_reason_code,
    cdlv.business_process_id,
    cdlv.transaction_type_id,
    cdlv.txn_type,
    cdlv.txn_type_description,
    cdlv.labor_meaning,
    cdlv.charge_upload_status,
    cdlv.charge_upload_msg_code,
    cdlv.charge_upload_message,
    cdlv.error_text
FROM
    csf_debrief_lab_lines_v   cdlv,
    csf_debrief_tasks_v       cdtv
WHERE
    cdtv.debrief_header_id = cdlv.debrief_header_id
    AND cdtv.task_number = ''##$$TASKNUM$$##''
ORDER BY
    cdlv.debrief_line_id',
      p_title                  => 'Labor Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Labor debrief lines do not exist.',
      p_solution               => '',
      p_success_msg            => 'Displaying the labor debrief lines.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSF_DBF_LBR_LINES');



debug('begin add_signature: EBS_CRM_CSF_DBF_MTL_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19068',
      p_sig_id                 => 'EBS_CRM_CSF_DBF_MTL_LINES',
      p_sig_sql                => 'SELECT
    cdmv.channel_code,
    cdmv.debrief_line_id,
    cdmv.debrief_header_id,
    cdmv.service_date,
    cdmv.inventory_item_id,
    cdmv.instance_id,
    cdmv.instance_number,
    cdmv.inventory_org_id,
    cdmv.sub_inventory_code,
    cdmv.locator,
    cdmv.uom_code,
    cdmv.parent_product_id,
    cdmv.removed_product_id,
    cdmv.received_part_status,
    cdmv.quantity,
    cdmv.item_revision,
    cdmv.item_lotnumber,
    cdmv.item_serial_number,
    cdmv.attribute1,
    cdmv.attribute2,
    cdmv.attribute3,
    cdmv.attribute4,
    ...
    cdmv.attribute14,
    cdmv.attribute15,
    cdmv.attribute_category,
    cdmv.material_reason_code,
    cdmv.business_process_id,
    cdmv.transaction_type_id,
    cdmv.line_order_category_code,
    cdmv.txn_type,
    cdmv.material_meaning,
    cdmv.revision_flag,
    cdmv.ib_update_status,
    cdmv.ib_update_msg_code,
    cdmv.ib_update_message,
    cdmv.spare_update_status,
    cdmv.spare_update_msg_code,
    cdmv.spare_update_message,
    cdmv.charge_upload_status,
    cdmv.charge_upload_msg_code,
    cdmv.charge_upload_message,
    cdmv.return_reason_code,
    cdmv.return_reason,
    cdmv.return_date,
    cdmv.error_text,
    cdmv.material_transaction_id,
    cdmv.usage_type,
    cdmv.return_subinventory_name,
    cdmv.return_organization_id,
    cdmv.carrier_code,
    cdmv.shipping_method,
    cdmv.shipping_number,
    cdmv.waybill
FROM
    csf_debrief_mat_lines_v   cdmv,
    csf_debrief_tasks_v       cdtv
WHERE
    cdmv.debrief_header_id = cdtv.debrief_header_id
    AND cdtv.task_number = ''##$$TASKNUM$$##''
ORDER BY
    cdmv.debrief_line_id',
      p_title                  => 'Material Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Material debrief lines do not exist.',
      p_solution               => '',
      p_success_msg            => 'Displaying the material debrief lines.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSF_DBF_MTL_LINES');



debug('begin add_signature: EBS_CRM_CSF_DBF_CHARGES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19071',
      p_sig_id                 => 'EBS_CRM_CSF_DBF_CHARGES',
      p_sig_sql                => 'SELECT
    csd.*
FROM
    cs_estimate_details   csd,
    csf_debrief_lines     cdl,
    csf_debrief_tasks_v   cdtv
WHERE
    cdl.debrief_header_id = cdtv.debrief_header_id
    AND csd.source_id = cdl.debrief_line_id
    AND cdtv.task_number = ''##$$TASKNUM$$##''
ORDER BY
  csd.estimate_detail_id',
      p_title                  => 'Estimate Charge Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no charges associated to debrief lines.',
      p_solution               => '',
      p_success_msg            => 'Displaying charges associated to debrief lines.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSF_DBF_CHARGES');



debug('begin add_signature: EBS_CRM_CSF_REPROCESS_DEBRIEF');
   l_info('##MASK##ADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19799',
      p_sig_id                 => 'EBS_CRM_CSF_REPROCESS_DEBRIEF',
      p_sig_sql                => 'SELECT
    ch.task_number,
    ch.task_id,
    ch.task_source,
    ...
    ch.task_status,
    ch.debrief_number,
    ch.debrief_header_id,
    ch.debrief_status_id,
    cl.debrief_line_id,
    cl.error_text
FROM
    csf_debrief_headers_v   ch,
    csf_debrief_lines       cl
WHERE
    ch.debrief_header_id = cl.debrief_header_id
    AND cl.error_text IS NOT NULL
    AND ch.processed_flag = ''COMPLETED W/ERRORS''
and ch.resource_id = ''##$$RESOURCEID$$##''
    AND ch.organization_id = ##$$ORGID$$##
ORDER BY
    cl.creation_date DESC',
      p_title                  => 'Reprocess Errored Debrief Line(s)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are errored debrief line(s).',
      p_solution               => 'Please refer to solution in [2799997/KB220046] - How To Reprocess Debrief Lines That Are In Error Status.
<br>
Also, refer to [2489925/KB319695] - How to process Debrief using REST API?, when using REST API to process the debriefs.',
      p_success_msg            => 'There are no errored debrief line(s).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSF_REPROCESS_DEBRIEF');



debug('begin add_signature: EBS_CRM_CSF_DEB_MTL_BILL_FLAG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20785',
      p_sig_id                 => 'EBS_CRM_CSF_DEB_MTL_BILL_FLAG',
      p_sig_sql                => 'SELECT msik.concatenated_segments "Item Name",
msik.DESCRIPTION "Item Description"
, msik.START_DATE_ACTIVE
, msik.END_DATE_ACTIVE
, organization_id
FROM mtl_system_items_kfv msik-- MTL_SYSTEM_ITEMS_VL
WHERE 1=1
AND msik.ENABLED_FLAG = ''Y''
and upper(msik.concatenated_segments)  = upper( ''##$$ITEMNAME$$##'')  
AND msik.ORGANIZATION_ID =   ##$$ORGID$$##
AND ( (MTL_TRANSACTIONS_ENABLED_FLAG = ''Y''
AND MATERIAL_BILLABLE_FLAG IN (''M'') ))
AND trunc(sysdate)  
BETWEEN NVL( msik.START_DATE_ACTIVE,trunc(sysdate-1))
AND NVL(msik.END_DATE_ACTIVE ,trunc(sysdate+1))',
      p_title                  => 'Debrief Material Item Billable Flag Check',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Material Billable Flag not defined for the Item used in the Debrief.',
      p_solution               => 'Please refer to solution in [2575245/KB379007]-Error When Completing A Debrief - Failed To Retrieve The Billable Flag For Inventory Item With ID ',
      p_success_msg            => 'Material Billable Flag defined for the Item used in the Debrief.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSF_DEB_MTL_BILL_FLAG');



debug('begin add_signature: EBS_CRM_CSF_CHRGE_SUB_DBF_LINES_CHK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20788',
      p_sig_id                 => 'EBS_CRM_CSF_CHRGE_SUB_DBF_LINES_CHK',
      p_sig_sql                => 'SELECT A.profile_option_id,b.lasT_update_date,C.profile_option_name, C.user_profile_option_name, b.last_updated_by,
DECODE(B.level_id, ''10001'', ''SITE'' , ''10002'', ''APPLICATION'', ''10003'', ''RESPONSIBILITY'', ''10004'', ''USER'') LevelID, 
B.level_value,
B.profile_option_value,
DECODE(A.End_date_active, NULL, ''ACTIVE'', ''INACTIVE'') Status
...
and c.user_profile_option_name  in (''Service:Check debrief status when submitting charges'')
order by  3',
      p_title                  => 'Debrief Lines Completion Profile Check',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Debrief Lines Completion Profile is not defined.',
      p_solution               => 'Please refer to solution in [394563/KB424135]-How To Prevent Charges Being Submitted To Order Management Before All Debrief Lines Are Completed',
      p_success_msg            => 'Debrief Lines Completion Profile is defined.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSF_CHRGE_SUB_DBF_LINES_CHK');



debug('begin add_signature: EBS_CRM_CSF_DEB_MUL_HDR_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20904',
      p_sig_id                 => 'EBS_CRM_CSF_DEB_MUL_HDR_ID',
      p_sig_sql                => 'select task_assignment_id,debrief_number, debrief_header_id
from csf_debrief_headers
where task_assignment_id in
(select task_assignment_id
from csf_debrief_headers
where task_assignment_id in (select task_assignment_id from jtf_task_assignments
where task_id in (select task_id from jtf_Tasks_b where task_number= ''##$$TASKNUM$$##''))
group by task_assignment_id
having count(*) > 1)',
      p_title                  => 'Multiple Debrief Header Ids Check',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Multiple debrief headers for the same task_assignment_id exists.',
      p_solution               => 'Please refer to solution in  [1467976/KB418238]-Multiple Debrief Header IDs Are Created For A Single Task Assignment',
      p_success_msg            => 'Multiple debrief headers for the same task_assignment_id doesn''t exists.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSF_DEB_MUL_HDR_ID');



debug('begin add_signature: EBS_CRM_CSP_REQ_HDR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19101',
      p_sig_id                 => 'EBS_CRM_CSP_REQ_HDR',
      p_sig_sql                => 'SELECT * FROM CSP_REQUIREMENT_HEADERS_V
WHERE
(
TASK_NUMBER = ''##$$TASKNUM$$##''
OR 
REQUIREMENT_HEADER_ID = ''##$$REQNUM$$##''
)
AND RESOURCE_ID =##$$RESOURCEID$$##
ORDER BY REQUIREMENT_HEADER_ID  ',
      p_title                  => 'Headers',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Part requirement header details do not exist.',
      p_solution               => '',
      p_success_msg            => 'Displaying part requirement header details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSP_REQ_HDR');



debug('begin add_signature: EBS_CRM_CSP_REQ_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19102',
      p_sig_id                 => 'EBS_CRM_CSP_REQ_LINES',
      p_sig_sql                => 'SELECT
    CRLD.*
FROM
    CSP_REQ_LINE_DETAILS_V      CRLD,
    CSP_REQUIREMENT_HEADERS_V   CRHD
WHERE
    CRHD.REQUIREMENT_HEADER_ID = CRLD.REQUIREMENT_HEADER_ID
    AND 
    (
    CRHD.TASK_NUMBER =  ''##$$TASKNUM$$##''
    OR
    CRHD.REQUIREMENT_HEADER_ID = ''##$$REQNUM$$##''
    )
    AND CRHD.RESOURCE_ID = ##$$RESOURCEID$$##
ORDER BY
    CRLD.REQUIREMENT_LINE_ID ',
      p_title                  => 'Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Part requirement lines do not exist.',
      p_solution               => '',
      p_success_msg            => 'Displaying part requirement lines. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSP_REQ_LINES');



debug('begin add_signature: EBS_CRM_CSP_MTL_RES_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19105',
      p_sig_id                 => 'EBS_CRM_CSP_MTL_RES_LINES',
      p_sig_sql                => 'SELECT
    MR.*
FROM
    MTL_RESERVATIONS            MR,
...
WHERE
    ...
    AND MR.DEMAND_SOURCE_LINE_ID = CRLD.REQUIREMENT_LINE_ID
    AND CRHD.RESOURCE_ID = ''##$$RESOURCEID$$##''
ORDER BY
    MR.RESERVATION_ID ',
      p_title                  => 'Material Reservations',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Part requirement material reservations do not exist.',
      p_solution               => '',
      p_success_msg            => 'Displaying part requirement material reservations.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSP_MTL_RES_LINES');



debug('begin add_signature: EBS_CRM_CSP_REQ_IO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19106',
      p_sig_id                 => 'EBS_CRM_CSP_REQ_IO',
      p_sig_sql                => 'SELECT
    COMV.*
FROM
    CSP_SPARES_ORDERS_OM_V      COMV,
    CSP_REQUIREMENT_HEADERS_V   CRHD
WHERE
    COMV.REQUIREMENT_NUMBER = CRHD.REQUIREMENT_HEADER_ID
    AND 
    ( 
    CRHD.TASK_NUMBER =''##$$TASKNUM$$##''
          OR 
    ...
    AND CRHD.RESOURCE_ID = ##$$RESOURCEID$$## 
ORDER BY COMV.REQUIREMENT_NUMBER',
      p_title                  => 'Internal Orders',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Part requirement internal orders do not exist.',
      p_solution               => '',
      p_success_msg            => 'Displaying part requirement internal orders.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSP_REQ_IO');



debug('begin add_signature: EBS_CRM_SC_CSF_INB_ORD_RES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27712',
      p_sig_id                 => 'EBS_CRM_SC_CSF_INB_ORD_RES',
      p_sig_sql                => 'SELECT DISTINCT
    csp.document_number             AS docnumber,
    csp.header_id                   AS dochdrid,
    csp.source_type || '' - '' || look.meaning AS doctype,
    csp.creation_date               AS createdate,
    csp.task_number                 AS task,
    csp.source_organization_id      AS srcorgid,
    csp.source_subinventory         AS srcsubinv,
    csp.source                      AS srcname,
    csp.destination_organization_id AS destorgid,
    csp.destination_subinventory    AS destsubinv,
    csp.destination                 AS destname,
    csp.status                      AS status
FROM
    csp_receiving_headers_v csp,
    fnd_lookup_values_vl    look,
    csp_receiving_lines_v   crl
WHERE
    csp.header_id = crl.header_id
    AND csp.source_type = look.lookup_code
    AND look.lookup_type = ''CSP_REQ_SOURCE_TYPE''
    AND look.enabled_flag = ''Y''
    AND csp.resource_type = nvl(''RS_EMPLOYEE'', csp.resource_type)
    AND csp.resource_id = nvl(''##$$RESOURCEID$$##'', csp.resource_id)
    AND nvl(crl.inventory_item_id, - 9999) = nvl(NULL,nvl(crl.inventory_item_id, - 9999))
    AND nvl(crl.shipment_number, ''SHIP_NULL'') = nvl(NULL,nvl(crl.shipment_number, ''SHIP_NULL''))
    AND nvl(csp.document_number, - 9999) = nvl(NULL,nvl(csp.document_number, - 9999))
    AND csp.destination_organization_id = nvl(NULL, csp.destination_organization_id)
    AND nvl(csp.destination_subinventory, ''SUB_NULL'') = nvl(NULL,nvl(csp.destination_subinventory, ''SUB_NULL''))
ORDER BY
    csp.creation_date DESC',
      p_title                  => 'Inbound Orders and Reservations',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Part requirement Receive Parts - Inbound Orders and Reservations',
      p_solution               => 'Refer to Spares Management: Cannot Find Expected Receipt in Inbound Orders and Reservations Page [1503947/KB244411]',
      p_success_msg            => 'Displaying part requirement Inbound Orders and Reservations',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_CSF_INB_ORD_RES');



debug('begin add_signature: EBS_CRM_SC_CSF_RET_EXCESS_DEF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27731',
      p_sig_id                 => 'EBS_CRM_SC_CSF_RET_EXCESS_DEF',
      p_sig_sql                => 'SELECT
    ex.return_organization_id || '' - '' || ood.organization_code || '' - '' || ood.organization_name As ReturnOrg,
    ex.return_subinventory_name AS retsubname,
    ex.organization_id || '' - '' || ood1.organization_code || '' - '' || ood1.organization_name As SourceOrg,
    ex.subinventory_code        AS Srcsubinv,
    ex.inventory_item_id,
    (select distinct segment1 from mtl_system_items_b where inventory_item_id = ex.inventory_item_id) ItemName,
    Decode(ex.condition_code,''G'',''Good'', ''B'', ''Defective'') As Condition,
    ex.current_excess_quantity As Curr_Excess_Or_Def_Qty
FROM
    csp_excess_lists_v           ex,
    org_organization_definitions ood,
    org_organization_definitions ood1
WHERE
        ex.current_excess_quantity > 0
    AND ( ( ex.organization_id, ex.subinventory_code ) IN (
        SELECT
    ...
    AND ex.organization_id = nvl(NULL, ex.organization_id)
    AND nvl(ex.subinventory_code, ''NULL'') = nvl(NULL, nvl(ex.subinventory_code, ''NULL''))
    AND ex.inventory_item_id = nvl(NULL, ex.inventory_item_id)
    AND ex.condition_code = nvl(NULL, ex.condition_code)
    AND ex.return_organization_id = ood.organization_id (+)
    AND ex.organization_id = ood1.organization_id
ORDER BY
    SourceOrg DESC',
      p_title                  => 'Parts Return Excess And Defective Items',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Parts Return Excess And Defective Items',
      p_solution               => 'Refer to: Item Not Appearing In The Field Service Excess Return Form [2793103/KB786260]',
      p_success_msg            => 'Displaying Parts Return Excess And Defective Items',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_CSF_RET_EXCESS_DEF');



debug('begin add_signature: EBS_CRM_CSM_PUBITEM');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18853',
      p_sig_id                 => 'EBS_CRM_CSM_PUBITEM',
      p_sig_sql                => 'SELECT
    name,
    base_object_name,
    status,
...
FROM
    asg_pub_item
WHERE
pub_name in (''SERVICEP'',''JTM_HANDHELD'')
ORDER BY
    name ASC',
      p_title                  => 'Publication Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Publication items not enabled which prevents the setup/application data download in the mobile field service client application.',
      p_solution               => 'When the setup/application data is missing in the mobile field service client application, than the client application cannot be used. <br>
Please refer to solution in [1586773/KB261889] - MFS Multiplatform: Cannot See Tasks In Oracle Mobile Field Service Due to Missing Lookup Data (and JTM Master Program Reporting Errors).',
      p_success_msg            => 'Displaying the publication items to download the setup/application data correctly loaded in the mobile field service client application.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSM_PUBITEM');



debug('begin add_signature: EBS_CRM_CSM_DEFER_TRANS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19160',
      p_sig_id                 => 'EBS_CRM_CSM_DEFER_TRANS',
      p_sig_sql                => 'SELECT T1.object_name 
,Decode(T1.dml, ''I'', ''Insert'', ''U'', ''Update'', ''D'', ''Delete'')  DML
,T2.access_id
,T1.deferred_tran_id 
,T1.tracking_id 
,T1.sequence 
,T1.object_id 
,T1.error_msg 
FROM CSM_DEFERRED_NFN_INFO T1
, CSM_DEFERRED_TRANSACTIONS_ACC T2
, asg_user T3
WHERE 
T1.tracking_id = T2.tracking_id
and T1.client_id = T3.user_name
and T3.resource_id = ''##$$RESOURCEID$$##''
order by t1.sequence asc
',
      p_title                  => 'Deferred Transactions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Deferred transactions found for the resource number: '||mask_text(g_res_num, nvl( upper(''), 'NO_MASK') )||'',
      p_solution               => 'To understand the meaning of deferred transaction messages, refer to [1150023/KB749405] - MFS: What do the Deferred Transaction Messages mean?<br><br> 
To purge these deferred transactions, please refer to the solution in [2502862/KB745452] - How To Purge Oracle Mobile Field Service Discarded Deferred Transaction Messages Using Script?. ',
      p_success_msg            => 'Deferred transactions does not exist for the resource number: '||mask_text(g_res_num, nvl( upper(''), 'NO_MASK') )||'',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSM_DEFER_TRANS');



debug('begin add_signature: EBS_CRM_CSM_JTM_RUN_DATA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19159',
      p_sig_id                 => 'EBS_CRM_CSM_JTM_RUN_DATA',
      p_sig_sql                => 'SELECT 
PACKAGE_NAME 
,PROCEDURE_NAME 
,EXECUTE_FLAG 
...
,STATUS
FROM 
JTM_CON_REQUEST_DATA
WHERE 
PROCEDURE_NAME like ''REFRESH%''
and category in (''INV'', ''LOOKUP'', ''TXC'')
and EXECUTE_FLAG = ''Y''
and package_name like ''CSM%''
order by last_run_date desc',
      p_title                  => 'JTM Run Statistics',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'JTM Master concurrent programs are not executed',
      p_solution               => '',
      p_success_msg            => 'Displaying the JTM Master concurrent program execution details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSM_JTM_RUN_DATA');



debug('begin add_signature: EBS_CRM_CSM_LONG_SYNC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19611',
      p_sig_id                 => 'EBS_CRM_CSM_LONG_SYNC',
      p_sig_sql                => 'SELECT hp.party_name,COUNT(cii.instance_id)
...
and tcpa.party_id = hp.party_id
AND au.USER_ID=cpsa.USER_ID
and au.resource_id = ##$$RESOURCEID$$##
...
UNION
SELECT hp.party_name,COUNT(cii.instance_id)
FROM csi_item_instances cii
...
and cpa.party_id = hp.party_id
AND au.USER_ID=cpa.USER_ID
and au.resource_id = ##$$RESOURCEID$$##
...
',
      p_title                  => 'Party Item Instance Download Details',
      p_fail_condition         => 'RSGT1',
      p_problem_descr          => 'When a new mobile field service user attempts to Install, the initial sync takes a long time because of huge party item instances.',
      p_solution               => 'Please refer to the solution in [2435702/KB676636] - MFS MP Sync Is Taking A Long Time For A New User. <br> <br>
Also, sometimes there are sync issues with the application. Please refer to the [1598250/KB640270] - Mobile Field Service (MFS): How To Troubleshoot Multi-Platform Synchronization Issues.',
      p_success_msg            => 'Initial sync takes short time to download Party Item Instances.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSM_LONG_SYNC');



debug('begin add_signature: EBS_CRM_CSM_CLR_CACHE');
   l_info('##MASK##ASDQ.CLIENT_ID'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ASDQ.CREATION_DATE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ASDQ.LAST_UPDATE_DATE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19678',
      p_sig_id                 => 'EBS_CRM_CSM_CLR_CACHE',
      p_sig_sql                => 'SELECT
   asdq.*
FROM
    asg_system_dirty_queue   asdq,
    asg_user                 au
WHERE
    au.user_name = asdq.client_id
    AND au.resource_id = ''##$$RESOURCEID$$##''
AND trunc(asdq.creation_date) >= trunc(SYSDATE)
order by asdq.creation_date desc',
      p_title                  => 'MFS MP Cache',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Sometimes the tasks, debrief, items, addresses, organizations, inventory locations created in e-Business Suite (EBS) are not getting downloaded to mobile field service multiplatform client.',
      p_solution               => 'There seems to be some caching issue with mobile field service multiplatform application. <br>
Please refer to the solution in [2482387/KB713452] - MFS MP Download And Upload Stopped Working Suddenly.',
      p_success_msg            => 'All the details are downloaded to mobile field service multiplatform client without any issues.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSM_CLR_CACHE');



debug('begin add_signature: EBS_CRM_SC_CSF_DUPLICATE_DOC_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28233',
      p_sig_id                 => 'EBS_CRM_SC_CSF_DUPLICATE_DOC_ID',
      p_sig_sql                => 'SELECT acc.user_id, fnddoc.document_id
...
GROUP BY acc.user_id, fnddoc.document_id
HAVING COUNT(*) >1',
      p_title                  => 'Duplicate Document IDs',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'When attempting to run JTM Master Concurrent program with Lookup parameter, the following error occurs:<br>
Error message:<br>CSM_LOBS_EVENT_PKG.CONC_DOWNLOAD_ATTACHMENTS: Error in<br>
CSM_LOBS_EVENT_PKG.CONC_DOWNLOAD_ATTACHMENTS: -1:ORA-00001: unique constraint (CSM.CSM_FND_LOBS_ACC_U2) violated',
      p_solution               => 'For steps to resolve the issue see [856361/KB756842]',
      p_success_msg            => 'There are no duplicate document ids.',
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_CSF_DUPLICATE_DOC_ID');



debug('begin add_signature: EBS_CRM_SC_CSF_ASG_ITEM_INDEX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29099',
      p_sig_id                 => 'EBS_CRM_SC_CSF_ASG_ITEM_INDEX',
      p_sig_sql                => 'SELECT INDEX_ID "Index Id", INDEX_NAME, count(*)  "Count"
  FROM ASG.ASG_ITEM_INDEX
  GROUP BY INDEX_ID, INDEX_NAME  HAVING count(*)>1
',
      p_title                  => 'ASG Item Index',
      p_fail_condition         => '[count(*)] > [1]',
      p_problem_descr          => 'Upgrade To Release 12.2.x Fails On asgasg.odf: "The index cannot be created as the table has duplicate keys.',
      p_solution               => 'While creating the unique index "ASG.ASG_ITEM_INDEX" getting  AD Worker error:
The index cannot be created as the table has duplicate keys.

Please refer to solution in [2367604/KB781097] -Upgrade To Release 12.2.x Fails On asgasg.odf: "The index cannot be created as the table has duplicate keys." (ASG_ITEM_INDEX) ',
      p_success_msg            => 'Displaying the details for ASG.ASG_ITEM_INDEX',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_CSF_ASG_ITEM_INDEX');



debug('begin add_signature: EBS_CRM_CSM_RES_INFO');
   l_info('##MASK##ADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '18850',
      p_sig_id                 => 'EBS_CRM_CSM_RES_INFO',
      p_sig_sql                => 'SELECT 
T1.RESOURCE_NUMBER 
, T1.RESOURCE_ID 
,T1.SOURCE_NAME SOURCE_NAME
, T1.CATEGORY 
, T1.SOURCE_JOB_TITLE JOB
, T1.SOURCE_ADDRESS1
|| '' '' 
|| T1.SOURCE_CITY
|| '' '' 
|| T1.SOURCE_POSTAL_CODE
|| '' '' 
|| T1.SOURCE_STATE
|| '' '' 
|| T1.SOURCE_COUNTRY ADDRESS
, T1.START_DATE_ACTIVE 
, T1.END_DATE_ACTIVE 
, T1.USER_NAME USER_NAME
, T1.USER_ID
, T2.ENABLED
,(T3.organization_code || '' - '' || T3.Organization_name || ''('' || T3.ORGANIZATION_ID || '')'' ) ORG_NAME
, T2.CREATION_DATE C_DATE
, T2.MULTI_PLATFORM 
FROM 
JTF_RS_RESOURCE_EXTNS T1
, ASG_USER T2
, ORG_ORGANIZATION_DEFINITIONS T3
WHERE 
T2.ORG_id    = T3.ORGANIZATION_ID
...
',
      p_title                  => 'Resource Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Resource number: '||mask_text(g_res_num, nvl( upper(''), 'NO_MASK') )||' cannot be used in mobile field service multiplatform application(MFS MP)',
      p_solution               => 'When the resource number: '||mask_text(g_res_num, nvl( upper(''), 'NO_MASK') )||' is not created properly, the mobile field service multiplatform application(MFS MP) cannot be used. In order to create a valid mobile field service resource:<br>
Please refer to solution in [1564644/KB540601] - Oracle Mobile Field Service Store and Forward Multiple Platforms Support.',
      p_success_msg            => 'Displaying the details for resource number: '||mask_text(g_res_num, nvl( upper(''), 'NO_MASK') )||' who can be used in mobile field service multiplatform application(MFS MP).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSM_RES_INFO');



debug('begin add_signature: EBS_CRM_CSM_RES_ADDR');
   l_info('##MASK##ADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18851',
      p_sig_id                 => 'EBS_CRM_CSM_RES_ADDR',
      p_sig_sql                => '    SELECT 
		T1.access_id
		,T1.location_id
		,T3.ADDRESS_LINE_1
		...
		|| '' '' 
		|| T3.REGION_2 ADDRESS
		,(T2.organization_code || '' - '' || T2.Organization_name || ''('' || T2.ORGANIZATION_ID || '')'' ) org_name
		,T1.Creation_date
        , t3.customer_id
        ,t3.CUST_ACCT_SITE_ID
        ,t3.party_site_id
        ,t3.site_use_id
        ,t3.site_use_code
        ,t3.primary_flag
        ,t3.status
	FROM 
		CSM_PO_LOC_ASS_ALL_ACC T1
		, ORG_ORGANIZATION_DEFINITIONS T2
		, CSP_RS_SHIP_TO_ADDRESSES_ALL_V T3
	WHERE 
		T1.ORG_id    = T2.ORGANIZATION_ID
		and T1.location_id = T3.inv_loc_id
		and T3.resource_ID = ##$$RESOURCEID$$##
		ORDER BY t3.primary_flag DESC
',
      p_title                  => 'Resource Addresses',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Addresses are not setup for the resource number: '||mask_text(g_res_num, nvl( upper(''), 'NO_MASK') )||'',
      p_solution               => 'When addresses are not setup for the resource number: '||mask_text(g_res_num, nvl( upper(''), 'NO_MASK') )||', the parts requirement cannot be created. <br>
Please refer to solution in [2681849/KB575071] - Technician''s Primary Address Is Not Picked Up By Mobile Field Service Multiplatform When Creating Parts Requirement.',
      p_success_msg            => 'Displaying addresses for the resource number: '||mask_text(g_res_num, nvl( upper(''), 'NO_MASK') )||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSM_RES_ADDR');



debug('begin add_signature: EBS_CRM_CSM_RES_SUBINV');
   l_info('##MASK##USER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18852',
      p_sig_id                 => 'EBS_CRM_CSM_RES_SUBINV',
      p_sig_sql                => 'SELECT 
	T3.ACCESS_ID
	,(T2.organization_code || '' - '' || T2.Organization_name || ''('' || T2.ORGANIZATION_ID || '')'' ) ORG_NAME
	, T1.SUBINVENTORY_CODE 
	,T3.CSP_INV_LOC_ASSIGNMENT_ID 
	,T4.USER_NAME USER_NAME
	,T3.CREATION_DATE 
	,T1.DEFAULT_CODE 
FROM 
	CSP_INV_LOC_ASSIGNMENTS T1
	, ORG_ORGANIZATION_DEFINITIONS T2
	, CSM_INV_LOC_ASS_ACC T3
	, JTF_RS_RESOURCE_EXTNS T4
WHERE 
	T1.ORGANIZATION_ID    = T2.ORGANIZATION_ID
	and T1.csp_inv_loc_assignment_id = T3.csp_inv_loc_assignment_id 
	and T3.user_id = T4.user_id
	and T1.resource_ID = ##$$RESOURCEID$$##
	ORDER BY T1.ORGANIZATION_ID asc
',
      p_title                  => 'Resource Subinventories',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Subinventories are not setup for the resource number: '||mask_text(g_res_num, nvl( upper(''), 'NO_MASK') )||'',
      p_solution               => 'When subinventories are not setup for the resource number: '||mask_text(g_res_num, nvl( upper(''), 'NO_MASK') )||', parts requirement cannot be created.<br>
Please refer to solution in [1564644/KB540601] - Oracle Mobile Field Service Store and Forward Multiple Platforms Support.',
      p_success_msg            => 'Displaying subinventories for the resource number: '||mask_text(g_res_num, nvl( upper(''), 'NO_MASK') )||'',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSM_RES_SUBINV');



debug('begin add_signature: EBS_CRM_CSM_TASK');
   l_info('##MASK##CTA.USER_ID'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19128',
      p_sig_id                 => 'EBS_CRM_CSM_TASK',
      p_sig_sql                => 'SELECT
CTA.ACCESS_ID,
CTA.USER_ID,
CTA.CREATION_DATE,
...
JTV.TASK_ID,
    ...
    JTV.SOURCE_OBJECT_NAME,
    JTV.DURATION,
    JTV.DURATION_UOM,
    JTV.PLANNED_EFFORT,
    JTV.PLANNED_EFFORT_UOM,
    JTV.ACTUAL_EFFORT,
    JTV.ACTUAL_EFFORT_UOM,
    JTV.PERCENTAGE_COMPLETE,
    JTV.PRIVATE_FLAG,
    JTV.PUBLISH_FLAG,
    JTV.RESTRICT_CLOSURE_FLAG,
    JTV.MULTI_BOOKED_FLAG,
    JTV.MILESTONE_FLAG,
    JTV.NOTIFICATION_FLAG,
    JTV.PLANNED_END_DATE,
    JTV.SCHEDULED_START_DATE,
    JTV.SCHEDULED_END_DATE,
    JTV.TEMPLATE_ID,
    JTV.TEMPLATE_GROUP_ID,
    JTV.OPEN_FLAG,
    JTV.TASK_CONFIRMATION_STATUS,
    JTV.TASK_SPLIT_FLAG,
    JTV.FOLLOW_UP_TASK_FLAG
FROM 
	JTF_TASKS_VL JTV
	, CSM_TASKS_ACC CTA
WHERE
	CTA.TASK_ID = JTV.TASK_ID
	AND JTV.TASK_NUMBER = ''##$$TASKNUM$$##''
    ORDER BY JTV.TASK_ID',
      p_title                  => 'Task Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Task details do not exist.',
      p_solution               => '',
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSM_TASK');



debug('begin add_signature: EBS_CRM_CSM_TASK_ASSGN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19129',
      p_sig_id                 => 'EBS_CRM_CSM_TASK_ASSGN',
      p_sig_sql                => 'SELECT
    CSM_UTIL_PKG.GET_NUMBER(ACC.ACCESS_ID) ACCESS_ID,
    JTA.TASK_ASSIGNMENT_ID,
    CSM_UTIL_PKG.GET_NUMBER(JTA.TASK_ID) TASK_ID,
    CSM_UTIL_PKG.GET_NUMBER(JTA.ASSIGNMENT_STATUS_ID) ASSIGNMENT_STATUS_ID,
    JTA.ACTUAL_START_DATE,
    JTA.ACTUAL_END_DATE,
    CSM_UTIL_PKG.GET_NUMBER(JTA.RESOURCE_ID) RESOURCE_ID,
    NVL(JTA.RESOURCE_TYPE_CODE, JTA.RESOURCE_TYPE_CODE) RESOURCE_TYPE,
    JTA.SCHED_TRAVEL_DISTANCE,
    JTA.SCHED_TRAVEL_DURATION,
    JTA.SCHED_TRAVEL_DURATION_UOM,
    JTA.ACTUAL_TRAVEL_DISTANCE,
    JTA.ACTUAL_TRAVEL_DURATION,
    ...
    JTA.ATTRIBUTE14,
    JTA.ATTRIBUTE15,
    JTA.ATTRIBUTE_CATEGORY    
FROM
    CSM_TASK_ASSIGNMENTS_ACC   ACC,
    JTF_TASK_ASSIGNMENTS       JTA,
    JTF_TASKS_VL JTV
WHERE
    ACC.TASK_ASSIGNMENT_ID = JTA.TASK_ASSIGNMENT_ID
    AND JTV.TASK_ID = JTA.TASK_ID
    AND JTV.TASK_NUMBER = ''##$$TASKNUM$$##''
    ORDER BY JTA.TASK_ASSIGNMENT_ID
',
      p_title                  => 'Task Assignments',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Task assignments do not exist..',
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSM_TASK_ASSGN');



debug('begin add_signature: EBS_CRM_CSM_TASK_DOWNLOAD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19695',
      p_sig_id                 => 'EBS_CRM_CSM_TASK_DOWNLOAD',
      p_sig_sql                => 'SELECT
    COUNT(*)
FROM
    jtf_tasks_b        tsk,
...
WHERE 
tsk.task_number = ''##$$TASKNUM$$##'' 
AND tsk.task_type_id = ttype.task_type_id
AND ( nvl(ttype.rule, ''NULL'') = DECODE(nvl(fnd_profile.value_specific(''CSM_RESTRICT_TSK_TYPE_DISPATCH'' ), ''Y''), ''Y'', ''DISPATCH'', nvl(ttype.rule, ''NULL'')) OR ttype.private_flag = ''Y'' )
AND tsk.scheduled_start_date IS NOT NULL
AND tsk.scheduled_end_date IS NOT NULL
AND tsk.source_object_type_code IN (''SR'',''TASK'', null)    
',
      p_title                  => 'Can Task be Downloaded?',
      p_fail_condition         => '[count(*)] < [1]',
      p_problem_descr          => 'Task cannot be downloaded to mobile field service multiplatform client application.',
      p_solution               => 'To verify if the task can be downloaded, please refer to the script in [2188540/KB578080] - Script To Verify If A Task/Service Request Can Be Downloaded To The Mobile Field Service Multiplatform Device.
<br><br>
If there is an issue with the task creation, refer to the solution in [1145975/KB481450#aref_section25] - How To Setup Field Service Task Transition Flow (Release 12).',
      p_success_msg            => 'Task can be successfully downloaded to mobile field service multiplatform client application.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSM_TASK_DOWNLOAD');



debug('begin add_signature: EBS_CRM_CSM_DBF_HDR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19130',
      p_sig_id                 => 'EBS_CRM_CSM_DBF_HDR',
      p_sig_sql                => 'SELECT T2.ACCESS_ID ,
  T1.DEBRIEF_HEADER_ID ,
  T1.DEBRIEF_NUMBER,
  T1.DEBRIEF_DATE,
  T1.TASK_ASSIGNMENT_ID ,
  T1.CREATION_DATE,
  T1.PROCESSED_FLAG
FROM 
	CSF_DEBRIEF_HEADERS_V T1 ,
	CSM_DEBRIEF_HEADERS_ACC T2,
	JTF_TASK_ASSIGNMENTS       JTA,
	JTF_TASKS_VL JTV
WHERE 
	T1.DEBRIEF_HEADER_ID = T2.DEBRIEF_HEADER_ID
	AND T1.TASK_ASSIGNMENT_ID = JTA.TASK_ASSIGNMENT_ID
	AND JTV.TASK_ID = JTA.TASK_ID
        AND JTV.TASK_NUMBER = ''##$$TASKNUM$$##''
ORDER BY T1.DEBRIEF_HEADER_ID',
      p_title                  => 'Debrief Headers',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Debrief headers do not exist.',
      p_solution               => '',
      p_success_msg            => 'Displaying the debrief headers.',
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSM_DBF_HDR');



debug('begin add_signature: EBS_CRM_CSM_DBF_EXP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19133',
      p_sig_id                 => 'EBS_CRM_CSM_DBF_EXP',
      p_sig_sql                => 'SELECT 
	T2.access_id ,
	T1.Debrief_Line_Id ,
	T1.Debrief_Header_Id ,
	...
	T1.Expense_Amount ,
	T1.Currency_Code ,
	T1.business_process_id ,
	T1.transaction_type_id ,
	T1.Txn_type ,
	T1.expense_meaning ,
	T1.Charge_Upload_Status ,
	T1.error_text 
FROM 
	CSF_DEBRIEF_EXP_LINES_V T1 ,
	CSM_DEBRIEF_LINES_ACC T2,
	CSF_DEBRIEF_TASKS_V T3
WHERE 
	T1.Debrief_Line_Id = T2.Debrief_Line_Id
	and T1.DEBRIEF_HEADER_ID = T3.DEBRIEF_HEADER_ID
	and T3.TASK_NUMBER = ''##$$TASKNUM$$##''
	order by T1.Debrief_Line_Id',
      p_title                  => 'Expense Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Debrief expense lines do not exist.',
      p_solution               => '',
      p_success_msg            => 'Displaying the debrief expense lines.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSM_DBF_EXP');



debug('begin add_signature: EBS_CRM_CSM_DBF_LAB');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19132',
      p_sig_id                 => 'EBS_CRM_CSM_DBF_LAB',
      p_sig_sql                => 'SELECT 
	T2.access_id ,
	T1.Debrief_Line_Id ,
	T1.Debrief_Header_Id ,
	...
	T1.transaction_type_id ,
	T1.txn_type ,
	T1.txn_type_Description ,
	T1.labor_meaning ,
	T1.Charge_Upload_Status ,
	T1.error_text etext
FROM 
	CSF_DEBRIEF_LAB_LINES_V T1 ,
	CSM_DEBRIEF_LINES_ACC T2,
	CSF_DEBRIEF_TASKS_V T3
WHERE 
	T1.Debrief_Line_Id = T2.Debrief_Line_Id
	...
	',
      p_title                  => 'Labor Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Debrief labor lines do not exist.',
      p_solution               => '',
      p_success_msg            => 'Displaying debrief labor lines.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSM_DBF_LAB');



debug('begin add_signature: EBS_CRM_CSM_DBF_MTL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19131',
      p_sig_id                 => 'EBS_CRM_CSM_DBF_MTL',
      p_sig_sql                => 'SELECT T2.access_id ,
T1.Debrief_Line_Id ,
T1.Debrief_Header_Id ,
T1.Channel_code ,
...
T1.INVENTORY_ITEM_ID,
T1.INSTANCE_NUMBER ,
T1.SUB_INVENTORY_CODE ,
T1.UOM_CODE ,
T1.received_part_status ,
T1.QUANTITY ,
T1.ITEM_SERIAL_NUMBER ,
T1.BUSINESS_PROCESS_ID ,
T1.TRANSACTION_TYPE_ID ,
T1.LINE_ORDER_CATEGORY_CODE ,
T1.txn_type ,
T1.Material_MEANING ,
T1.IB_UPDATE_STATUS ,
T1.SPARE_UPDATE_STATUS ,
T1.CHARGE_UPLOAD_STATUS ,
T1.RETURN_SUBINVENTORY_NAME ,
T1.RETURN_ORGANIZATION_ID ,
T1.RETURN_REASON ,
T1.MATERIAL_TRANSACTION_ID ,
T1.error_text 
FROM 
	CSF_DEBRIEF_MAT_LINES_V T1 ,
	CSM_DEBRIEF_LINES_ACC T2,
	CSF_DEBRIEF_TASKS_V T3
WHERE 
	T1.Debrief_Line_Id = T2.Debrief_Line_Id
	...
	order by T1.Debrief_Line_Id',
      p_title                  => 'Material Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Debrief material lines do not exist.',
      p_solution               => '',
      p_success_msg            => 'Displaying the debrief material lines.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSM_DBF_MTL');



debug('begin add_signature: EBS_CRM_CSM_REQ_HDR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19134',
      p_sig_id                 => 'EBS_CRM_CSM_REQ_HDR',
      p_sig_sql                => 'SELECT
    acc.access_id,
    hdr.requirement_header_id,
    hdr.open_requirement,
    hdr.address_type,
    (
        SELECT
            MAX(party_site_id)
        ...
        WHERE
            pa.location_id = hdr.ship_to_location_id
            AND pa.address_id = cas.cust_acct_site_id
            AND pa.org_id = cas.org_id
    ) AS ship_to_location_id,
    hdr.timezone_id,
    hdr.task_id,
    hdr.task_assignment_id,
    hdr.resource_type,
    hdr.resource_id,
    hdr.shipping_method_code,
    hdr.need_by_date,
  ...
  FROM
    ...
    csm_req_headers_acc       acc,
    CSF_DEBRIEF_TASKS_V T3
WHERE
    acc.requirement_header_id = hdr.requirement_header_id
    and hdr.task_assignment_id = T3.task_assignment_id 
    and 
    (T3.TASK_NUMBER = ''##$$TASKNUM$$##''
    or
    acc.requirement_header_id = ''##$$REQNUM$$##''
    )
    order by hdr.requirement_header_id
	',
      p_title                  => 'Headers',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Part requirement header details do not exist.',
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSM_REQ_HDR');



debug('begin add_signature: EBS_CRM_CSM_REQ_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19135',
      p_sig_id                 => 'EBS_CRM_CSM_REQ_LINES',
      p_sig_sql                => 'SELECT
    acc.access_id,
...
FROM
    ...
    CSF_DEBRIEF_TASKS_V T3
WHERE
    acc.requirement_line_id = lines.requirement_line_id
    and lines.requirement_header_id = hdr.requirement_header_id
    and hdr.task_assignment_id = T3.task_assignment_id 
    and 
    (
    T3.TASK_NUMBER = ''##$$TASKNUM$$##''
    or
    hdr.requirement_header_id = ''##$$REQNUM$$##''
    )
    order by lines.requirement_line_id
	',
      p_title                  => 'Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Part requirement lines do not exist.',
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSM_REQ_LINES');



debug('begin add_signature: EBS_CRM_CSM_REQ_LINE_DTLS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19136',
      p_sig_id                 => 'EBS_CRM_CSM_REQ_LINE_DTLS',
      p_sig_sql                => '  SELECT  
    acc.access_id,
    rld.req_line_detail_id,
    rld.requirement_line_id,
    Decode(rld.SOURCED_FROM, ''RES'',''Reservation'', ''IO'', ''Internal Order'') SOURCED_FROM,
    rld.source_id,
    CPPV.TASK
FROM
    csm_req_line_details_acc   acc,
    CSP_REQ_LINE_DETAILS_V     rld
    , CSP_PARTS_REQUIREMENTS_V CPPV
WHERE
    acc.req_line_detail_id = rld.req_line_detail_id
    and rld.source_id = cppv.order_number
    and 
    (
    CPPV.TASK = ''##$$TASKNUM$$##''
    or
    rld.requirement_header_id = ''##$$REQNUM$$##''
    )
    order by rld.req_line_detail_id    
        ',
      p_title                  => 'Lines Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Part requirement line details do not exist.',
      p_solution               => '',
      p_success_msg            => 'Displaying part requirement line details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSM_REQ_LINE_DTLS');



debug('begin add_signature: EBS_CRM_CSR_RULES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18752',
      p_sig_id                 => 'EBS_CRM_CSR_RULES',
      p_sig_sql                => 'select *
     from all_objects 
     where object_name like ''CSR_RULES%'' 
     and status = ''INVALID''
     order by object_type',
      p_title                  => 'Rules Validation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are scheduler invalid objects when the script CSRRSREG.sql is executed.',
      p_solution               => 'When the  scheduler objects are invalid, the advanced scheduler features cannot be used. <br>
Please refer to the solution in [1221233/KB774051] - Invalid CSR_RULES_B Table And Invalid Objects With CSRRSREG.sql',
      p_success_msg            => 'Scheduler objects are valid when the script CSRRSREG.sql is executed.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSR_RULES');



debug('begin add_signature: EBS_CRM_CSR_RULES_VIEW');
   l_info('##MASK##RULE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18862',
      p_sig_id                 => 'EBS_CRM_CSR_RULES_VIEW',
      p_sig_sql                => 'SELECT
    rule_id,
    RULE_NAME,
    resp_id,
    ...
    sp_max_overtime,
    sp_wtp_threshold,
    sp_enforce_plan_window,
    sp_consider_standby_shifts,
    sp_spares_mandatory,
    sp_spares_source,
    sp_min_task_length,
    sp_default_shift_duration,
    sp_dist_last_child_effort,
    sp_pick_contract_resources,
    sp_pick_ib_resources,
    sp_pick_territory_resources,
    sp_pick_skilled_resources,
    sp_auto_sch_default_query,
    sp_auto_reject_sts_id_spares,
    sp_auto_reject_sts_id_others,
    sp_force_optimizer_to_group,
    sp_optimizer_success_perc,
    sp_commutes_position,
    sp_commute_excluded_time,
    sp_commute_home_empty_trip,
    sp_router_mode,
    sp_travel_time_extra,
    sp_default_router_enabled,
    sp_default_travel_distance,
    sp_default_travel_duration,
    sp_max_distance_in_group,
    sp_max_dist_to_skip_actual,
    sp_resource_preference,
    sp_load_balance_mode,SP_LOAD_BALANCE_TYPE,
    sp_maximum_travel_distance,
    sp_maximum_travel_time,
    sp_same_site_srch_radius,
    sp_same_site_srch_horizon,
    sp_pick_same_site_resources,
    sp_same_site_auto_reject,
    sp_same_site_auto_commit,
    sp_gps_data_to_schedule_tasks,
    sp_resource_cost_weighting,
    sp_route_pref,RC_ROUTER_CALC_TYPE,
    rc_consider_toll_roads,
    rc_route_func_delay_0,
    rc_route_func_delay_1,
    rc_route_func_delay_2,
    rc_route_func_delay_3,
    rc_route_func_delay_4,
    rc_estimate_first_boundary,
    rc_estimate_second_boundary,
    rc_estimate_first_avg_speed,
    rc_estimate_second_avg_speed,
    rc_estimate_third_avg_speed,
    cp_task_per_day_delayed,
    cp_task_per_min_early,
    cp_task_per_min_late,
    cp_tls_per_day_extra,
    cp_tls_per_child_extra,
    cp_parts_violation,
    cp_res_per_min_overtime,
    cp_res_assigned_not_pref,
    cp_res_skill_level,
    cp_standby_shift_usage,
    cp_travel_per_unit_distance,
    cp_travel_per_unit_duration,
    cp_defer_same_site,
    cp_task_priority,
    cp_non_critical_task,
    cp_load_balance
FROM
    csr_rules_exploded_v
    order by rule_id',
      p_title                  => 'Rules Exploded View',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no scheduler rules to schedule the task.',
      p_solution               => 'When no scheduler rules are defined and attempting to schedule a task, the system errors with:<br>

The request SearchIntelligentOptions did not complete successfully. Please refer to the Help>Diagnostics>Logging menu for information about the cause of the request failure. If no logging found, please enable logging on level Error and execute the request again.
<br>

Please refer to the solution in [1631169/KB783375] - Advanced Scheduler Error: "The request SearchIntelligentOptions did not complete successfully" While Scheduling The Task.',
      p_success_msg            => 'Displaying the scheduler rules to schedule the tasks.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSR_RULES_VIEW');



debug('begin add_signature: EBS_CRM_SC_CSF_TERR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27687',
      p_sig_id                 => 'EBS_CRM_SC_CSF_TERR',
      p_sig_sql                => 'select 
	TERR_ID                   
	, APPLICATION_SHORT_NAME  APP_NAME  
	, NAME                      
	, START_DATE_ACTIVE         
	, END_DATE_ACTIVE           
	, PARENT_TERRITORY_ID       
...
from 
	...
	WHERE ENABLED_FLAG = ''Y''
      ...
      p_title                  => 'Territories',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No territories are setup.',
      p_solution               => 'Please refer to solution in [1077836/KB764349] - How to Create Service Territories.',
      p_success_msg            => 'Displaying the list of territories.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_CSF_TERR');



debug('begin add_signature: EBS_CRM_CSR_TERR_QUAL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19143',
      p_sig_id                 => 'EBS_CRM_CSR_TERR_QUAL',
      p_sig_sql                => 'SELECT   qual_usg_id USAGE_ID, seeded_qual_name LABEL
...
ORDER BY UPPER (seeded_qual_name)',
      p_title                  => 'Territory Qualifiers',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no territory qualifiers for scheduling the task.',
      p_solution               => 'Please refer to solution in [757344/KB728966] - How can a user identify the Territory Qualifiers which can be used by Advanced Scheduler?',
      p_success_msg            => 'Displaying the list of territory qualifiers for scheduling the task.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSR_TERR_QUAL');



debug('begin add_signature: EBS_CRM_SC_CSF_TERR_NULL_ATTR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27688',
      p_sig_id                 => 'EBS_CRM_SC_CSF_TERR_NULL_ATTR',
      p_sig_sql                => 'SELECT
*
FROM
(
...
(
	jtf_territory_pvt.get_qual_value( jtfterrqual.qual_usg_id,
	jqu.display_type,
	jqu.convert_to_id_flag,
	jtfterrvalue.comparison_operator,
	jqu.display_sql1,
	jqu.display_sql2,
	jqu.display_sql3,
...
(
	...
	jtfterrvalue.value1_id,
	jtfterrvalue.value2_id,
	jtfterrvalue.currency_code,''1'') 
)
value1,
DECODE(nvl(jtfterrvalue.high_value_char,jtfterrvalue.high_value_number),NULL,
jtf_territory_pvt.get_qual_value(jtfterrqual.qual_usg_id,
jqu.display_type,
jqu.convert_to_id_flag,
jtfterrvalue.comparison_operator,
...
jtfterrvalue.value1_id,
jtfterrvalue.value2_id,
jtfterrvalue.currency_code,''2''),nvl(jtfterrvalue.high_value_char,jtfterrvalue.high_value_number) ) value2,
(
	jtf_territory_pvt.get_qual_value(jtfterrqual.qual_usg_id,
	jqu.display_type,
	jqu.convert_to_id_flag,
...
jtf_sources_all js
WHERE
	jtfterrqual.qual_usg_id = jqu.qual_usg_id
	...
	AND jqtu.source_id = js.source_id
) qrslt
WHERE
org_id =##$$ORGID$$##
AND ( Value1 is null and value2 is null and value3 is null)
ORDER BY
seeded_qual_name
',
      p_title                  => 'Territories with NULL matching attribute values',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No territories exist with Null matching attribute values',
      p_solution               => 'Please refer to solution in [1077836/KB764349] - How to Create Service Territories
',
      p_success_msg            => 'Displaying the list of territories with NULL matching attribute values',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_CSF_TERR_NULL_ATTR');



debug('begin add_signature: EBS_CRM_SM_GEN_JTY_1001_DENORM');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28051',
      p_sig_id                 => 'EBS_CRM_SM_GEN_JTY_1001_DENORM',
      p_sig_sql                => 'SELECT column_name, count(1)
   FROM  all_tab_columns
   WHERE table_name = ''JTY_1001_DENORM_DEA_VALUES''
   AND   owner      = ''JTF''
   group by column_name
   having count(1)>1',
      p_title                  => 'Duplicate Columns in JTY_1001_DENORM_DEA_VALUES',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'JTY_STAR: Synchronize Territory Assignment Rules concurrent program completes with 
Error: ORA-00957: duplicate column name

Duplicate Columns in JTY_1001_DENORM_DEA_VALUES',
      p_solution               => 'Please refer to solution in [1077836/KB764349] - How to Create Service Territories
',
      p_success_msg            => 'There are no Duplicate Columns in JTY_1001_DENORM_DEA_VALUES',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_GEN_JTY_1001_DENORM');



debug('begin add_signature: EBS_CRM_SC_CSF_TERR_ROLGRP_NULL');
   l_info('##MASK##RESOURCE_NAME'):= 'DISPLAY_FIRST_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28107',
      p_sig_id                 => 'EBS_CRM_SC_CSF_TERR_ROLGRP_NULL',
      p_sig_sql                => 'SELECT
*
FROM
( SELECT
    jtfterrresource.terr_id,
    jtfterrresource.start_date_active,
    jtfterrresource.end_date_active,
    jtf_rs_resource_extns_tl.resource_name,
    jtf_rs_resource_extns_tl.resource_id,
    jtf_rs_groups_tl.group_name,
    jtf_rs_roles_tl.role_name,
    jtfterrresource.org_id,
    jtfterrresource.attribute_category
FROM
    jtf_terr_rsc_all jtfterrresource,
    ...
    jtf_rs_roles_tl
WHERE
jtfterrresource.resource_id = jtf_rs_resource_extns.resource_id
AND jtfterrresource.resource_type = decode(jtf_rs_resource_extns.category, ''EMPLOYEE'', ''RS_EMPLOYEE'', ''PARTNER'', ''RS_PARTNER'',''SUPPLIER_CONTACT'', ''RS_SUPPLIER_CONTACT''
, ''PARTY'', ''RS_PARTY'', ''OTHER'',''RS_OTHER'', ''TBH'', ''RS_TBH'')
AND jtfterrresource.group_id = jtf_rs_groups_b.group_id (+)
AND jtfterrresource.role = jtf_rs_roles_b.role_code (+)
AND jtf_rs_roles_b.role_id = jtf_rs_roles_tl.role_id (+)
AND jtf_rs_roles_tl.language (+) = userenv(''LANG'')
AND jtf_rs_groups_tl.group_id (+) = jtf_rs_groups_b.group_id
AND jtf_rs_groups_tl.language (+) = userenv(''LANG'')
AND jtf_rs_resource_extns.category IN ( ''EMPLOYEE'', ''PARTNER'', ''PARTY'', ''SUPPLIER_CONTACT'')
AND jtf_rs_resource_extns.resource_id = jtf_rs_resource_extns_tl.resource_id
AND jtf_rs_resource_extns.category = jtf_rs_resource_extns_tl.category
AND jtf_rs_resource_extns_tl.language = userenv(''LANG'')
UNION ALL
SELECT
jtfterrresource.terr_id,
jtfterrresource.start_date_active,
...
jtfterrresource.attribute_category
FROM
jtf.jtf_terr_rsc_all         jtfterrresource,
jtf_rs_resource_extns,
jtf_rs_resource_extns_tl,
...
WHERE
jtfterrresource.resource_id = jtf_rs_resource_extns.resource_id
AND jtfterrresource.resource_type = decode(jtf_rs_resource_extns.category, ''EMPLOYEE'', ''RS_EMPLOYEE'', ''PARTNER'', ''RS_PARTNER'',''SUPPLIER_CONTACT'', ''RS_SUPPLIER_CONTACT'', ''PARTY'', ''RS_PARTY'', ''OTHER'',''RS_OTHER'', ''TBH'', ''RS_TBH'')
AND jtfterrresource.group_id = jtf_rs_groups_b.group_id (+)
AND jtfterrresource.role = jtf_rs_roles_b.role_code (+)
AND jtf_rs_roles_b.role_id = jtf_rs_roles_tl.role_id (+)
AND jtf_rs_roles_tl.language (+) = userenv(''LANG'')
AND jtf_rs_groups_tl.group_id (+) = jtf_rs_groups_b.group_id
AND jtf_rs_groups_tl.language (+) = userenv(''LANG'')
AND jtf_rs_resource_extns.category IN ( ''OTHER'', ''TBH'' )
AND srp.resource_id = jtf_rs_resource_extns.resource_id
AND srp.org_id (+) = hao.organization_id
AND decode(hr_security.view_all,''Y'',''TRUE'',hr_security.show_record(''HR_ALL_ORGANIZATION_UNITS'', haotl.organization_id)) = ''TRUE''
AND
DECODE(hr_general.get_xbg_profile,''Y'',hao.business_group_id,hr_general.get_business_group_id) = hao.business_group_id
AND hao.organization_id = haotl.organization_id
AND haotl.language = userenv(''LANG'')
AND jtf_rs_resource_extns.resource_id =
jtf_rs_resource_extns_tl.resource_id
AND jtf_rs_resource_extns.category =
jtf_rs_resource_extns_tl.category
AND jtf_rs_resource_extns_tl.language = userenv(''LANG'')
) qrslt WHERE ( terr_id IN (
SELECT
terr_id
FROM
jtf_terr_all
...
and resource_id = ##$$RESOURCEID$$##
Order by TERR_ID ASC',
      p_title                  => 'Territories associated to resource having Role and Group as NULL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Territories associated to resource having Role and Group as NULL',
      p_solution               => 'Please refer to solution in [1077836/KB764349] - How to Create Service Territories
',
      p_success_msg            => 'Displaying the list of Territories associated to resource having Role and Group as NULL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_CSF_TERR_ROLGRP_NULL');
...
debug('begin add_signature: EBS_CRM_GEN_PROF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18895',
      p_sig_id                 => 'EBS_CRM_GEN_PROF',
      p_sig_sql                => 'SELECT
B.USER_PROFILE_OPTION_NAME "PROFILE NAME",
A.PROFILE_OPTION_NAME "PROFILE SHORT NAME",
DECODE(TO_CHAR(C.LEVEL_ID), ''10001'', ''SITE'', ''10002'', ''APPLICATION'',''10003'', ''RESPONSIBILITY'', ''10004'', ''USER'', ''UNKNOWN'') "LEVEL",
DECODE(TO_CHAR(C.LEVEL_ID), ''10001'', ''SITE'', ''10002'',
NVL(H.APPLICATION_SHORT_NAME, TO_CHAR(C.LEVEL_VALUE)),
''10003'', NVL(G.RESPONSIBILITY_NAME, TO_CHAR(C.LEVEL_VALUE)),
''10004'',##$$A$$##.MASK_TEXT(E.USER_NAME,''##$$M$$##'')) "LEVEL VALUE",
DECODE(INSTR(A.PROFILE_OPTION_NAME,''APPROVER''), 0,
                                                DECODE(INSTR(A.PROFILE_OPTION_NAME,''NOTIFY''), 0 ,
                                                                                              DECODE(INSTR(A.PROFILE_OPTION_NAME,''REQUEST_CREATOR''), 0, C.PROFILE_OPTION_VALUE,
                                                                                                     ##$$A$$##.MASK_TEXT(C.PROFILE_OPTION_VALUE,''##$$M$$##'')
                                                                                                    ) ,
                                                                                                    ##$$A$$##.MASK_TEXT(C.PROFILE_OPTION_VALUE,''##$$M$$##'')
                                                       ),
                                                ##$$A$$##.MASK_TEXT(C.PROFILE_OPTION_VALUE,''##$$M$$##'')
      ) "PROFILE VALUE",
TO_CHAR(C.LAST_UPDATE_DATE, ''DD-MON-YYYY HH24:MI'') "UPDATED DATE", ##$$A$$##.MASK_TEXT(NVL(D.USER_NAME, TO_CHAR(C.LAST_UPDATED_BY)),''##$$M$$##'') "UPDATED BY"
FROM
APPS.FND_PROFILE_OPTIONS A,
APPS.FND_PROFILE_OPTIONS_TL B,
APPS.FND_PROFILE_OPTIONS B1,
...
WHERE
1 = 1
AND A.APPLICATION_ID IN (##$$APPS_PARAM1$$##,##$$APPS_PARAM2$$##,##$$APPS_PARAM3$$##,##$$APPS_PARAM4$$##,##$$APPS_PARAM5$$##)
...
AND B.PROFILE_OPTION_NAME = B1.PROFILE_OPTION_NAME
ORDER BY
B.USER_PROFILE_OPTION_NAME,
C.LEVEL_ID,
DECODE(TO_CHAR(C.LEVEL_ID), ''10001'', ''SITE'', ''10002'', NVL(H.APPLICATION_SHORT_NAME, TO_CHAR(C.LEVEL_VALUE)), ''10003'', NVL(G.RESPONSIBILITY_NAME
, TO_CHAR(C.LEVEL_VALUE)), ''10004'', NVL(E.USER_NAME, TO_CHAR(C.LEVEL_VALUE)), ''UNKNOWN'')
',
      p_title                  => 'EBS CRM Product Profiles',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'EBS CRM profiles are not defined.',
      p_solution               => '',
      p_success_msg            => 'Displaying EBS CRM profiles.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_GEN_PROF');
...
debug('begin add_signature: EBS_CRM_CSP_RES_SHIP_TO_ADDR');
   l_info('##MASK##FORMATTEDADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18844',
      p_sig_id                 => 'EBS_CRM_CSP_RES_SHIP_TO_ADDR',
      p_sig_sql                => '  SELECT DISTINCT
         HZ_FORMAT_PUB.FORMAT_ADDRESS(SITE_LOC_ID, NULL, NULL, '', '') || '','' || POSTAL_CODE AS FORMATTEDADDRESS,
         SITE_LOC_ID AS HZLOCATIONID,
         INV_LOC_ID AS HRLOCATIONID,
         LOCATION_CODE AS HRLOCATIONCODE,
         COUNTRY AS COUNTRY,
         RESOURCE_TYPE,
         RESOURCE_ID,
         ...
         WHERE STATUS =''A''
         AND RESOURCE_ID = ''##$$RESOURCEID$$##''
ORDER BY HRLOCATIONCODE',
      p_title                  => 'Resource Ship To Address',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Ship to addresses does not exist for the resource number: '||mask_text(g_res_num, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => 'When all the ship to addresses are not displayed in part requirement html, than the parts requirement cannot be created. <br>
Please refer to solution in [2043724/KB227659] - Parts Requirement HTML Does Not Display All The Ship To Address When Compared to Part Requirement Form.',
      p_success_msg            => 'Displaying all ship to addresses for the resource number: '||mask_text(g_res_num, nvl( upper(''), 'NO_MASK') )||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSP_RES_SHIP_TO_ADDR');



debug('begin add_signature: EBS_CRM_CSP_CUS_SHIP_TO_ADDR');
   l_info('##MASK##FORMATTEDADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18845',
      p_sig_id                 => 'EBS_CRM_CSP_CUS_SHIP_TO_ADDR',
      p_sig_sql                => 'SELECT * FROM 
(
SELECT DISTINCT
   HZ_FORMAT_PUB.FORMAT_ADDRESS(JPL.LOCATION_ID, NULL, NULL, '', '') || '','' || JPL.POSTAL_CODE AS FORMATTEDADDRESS,
   JPL.LOCATION_ID AS HZLOCATIONID,
   NULL AS HRLOCATIONID,
   NULL AS HRLOCATIONCODE,
   JPL.COUNTRY AS COUNTRY,
   HTT.NAME AS TIMEZONE,
   JPL.PARTY_ID AS CUSTOMERID,
   JPL.PARTY_SITE_ID AS PARTYSITEID
 FROM HZ_TIMEZONES_TL HTT,
   HZ_LOCATIONS HL,
   JTF_PARTY_LOCATIONS_V JPL,
   CS_INCIDENTS_ALL_B CIA,
   JTF_TASKS_B JTB,
   HZ_CUST_SITE_USES_ALL HCSU,
   HZ_CUST_ACCT_SITES_ALL HCAS,
   PO_LOCATION_ASSOCIATIONS_ALL PA
 WHERE HTT.TIMEZONE_ID(+) = HL.TIMEZONE_ID
   AND JTB.TASK_NUMBER = ''##$$TASKNUM$$##''
   AND HTT.LANGUAGE(+)        = NVL(USERENV(''LANG''), ''US'')
   AND HL.LOCATION_ID         = JPL.LOCATION_ID
 ...
 WHERE HTT.TIMEZONE_ID(+) = HL.TIMEZONE_ID
   AND JTB.TASK_ID = ''##$$TASKNUM$$##''
   AND HTT.LANGUAGE(+)        = NVL(USERENV(''LANG''), ''US'')
   AND HL.LOCATION_ID         = JPL.LOCATION_ID
   AND JTB.SOURCE_OBJECT_TYPE_CODE = ''SR''
   AND JTB.SOURCE_OBJECT_ID = CIA.INCIDENT_ID
   AND CIA.CUSTOMER_PRODUCT_ID IS NOT NULL
   AND CII.INSTANCE_ID = CIA.CUSTOMER_PRODUCT_ID
   AND JPL.PARTY_SITE_ID = CII.INSTALL_LOCATION_ID
   AND JPL.TYPE               = ''SHIP_TO''  
   AND JPL.TYPE = HCSU.SITE_USE_CODE
   AND HCSU.CUST_ACCT_SITE_ID = HCAS.CUST_ACCT_SITE_ID
   AND HCAS.PARTY_SITE_ID     = JPL.PARTY_SITE_ID
 ...
 WHERE HTT.TIMEZONE_ID(+) = HL.TIMEZONE_ID
   ...
   AND JTB.SOURCE_OBJECT_TYPE_CODE = ''SR''
   AND JTB.SOURCE_OBJECT_ID = CIA.INCIDENT_ID
   AND JPL.PARTY_ID           = CIA.SHIP_TO_PARTY_ID
   AND JPL.TYPE               = ''SHIP_TO''  
   AND JPL.TYPE = HCSU.SITE_USE_CODE
   AND JPL.PARTY_SITE_USE_ID = CIA.SHIP_TO_SITE_USE_ID
   AND HCSU.CUST_ACCT_SITE_ID = HCAS.CUST_ACCT_SITE_ID
   AND HCAS.PARTY_SITE_ID     = JPL.PARTY_SITE_ID
   AND HCAS.CUST_ACCOUNT_ID = CIA.SHIP_TO_ACCOUNT_ID  
   AND HCSU.SITE_USE_ID = PA.SITE_USE_ID(+)
   AND PA.ADDRESS_ID(+) = HCSU.CUST_ACCT_SITE_ID
   AND HCSU.STATUS = ''A''
   )
   ORDER BY PARTYSITEID',
      p_title                  => 'Customer Ship To Addresses',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Ship to addresses does not exist for the customer associated with the task number.',
      p_solution               => 'When all the ship to addresses are not displayed in part requirement html, than the parts requirement cannot be created. <br>
Please refer to solution in [2043724/KB227659] - Parts Requirement HTML Does Not Display All The Ship To Address When Compared to Part Requirement Form.
',
      p_success_msg            => 'Displaying all ship to addresses for the customer associated with the task number.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSP_CUS_SHIP_TO_ADDR');
...
BEGIN
  ...
  IF (p_app_id IS NOT NULL) THEN
    g_params_string := g_params_string || to_char(p_app_id) || '_';
  END IF;
  ...
  analyzer_title := 'Field Service Analyzer';
...
debug('begin section: Proactive_and_Preventative_Recommendations');
start_section('Proactive and Preventative Recommendations', 'Proactive_and_Preventative_Recommendations');
   set_item_result(check_rec_patches_1); /* Signature CRM_CSF_CHECK_REC_PATCHES */
   set_item_result(run_stored_sig('EBS_CRM_SC_GEN_MAX_SEQ'));
   set_item_result(run_stored_sig('EBS_CRM_SC_GEN_DOMIDX_FAILED'));
   set_item_result(run_stored_sig('EBS_CRM_SC_GEN_MAX_EXTENT_OBJ'));
   set_item_result(run_stored_sig('EBS_CRM_SC_UMX_ACCESS_ROLE'));
   IF p_app_id=513 THEN
      set_item_result(check_rec_patches_2); /* Signature CRM_CSF_CHECK_SPECIFIC_PATCHES */
   END IF;
   IF p_app_id=523 THEN
      set_item_result(check_rec_patches_3); /* Signature CRM_CSP_CHECK_SPECIFIC_PATCHES */
   END IF;
   IF p_app_id=883 THEN
      set_item_result(check_rec_patches_4); /* Signature CRM_CSM_CHECK_SPECIFIC_PATCHES */
   END IF;
end_section;
debug('end section: Proactive_and_Preventative_Recommendations');

debug('begin section: FieldService_Setup');
IF p_app_id=513 THEN
   start_section('Field Service Setup', 'FieldService_Setup');
      set_item_result(run_stored_sig('EBS_CRM_CSF_DBFASG_STAT'));
      set_item_result(run_stored_sig('EBS_CRM_GEN_TSKTYP_CHECK'));
      set_item_result(run_stored_sig('EBS_CRM_GEN_BP_CHECK'));
      set_item_result(run_stored_sig('EBS_CRM_CSF_DBF_FLXFLDS'));
      set_item_result(run_stored_sig('EBS_CRM_MAT_SAC_CHECK'));
      set_item_result(run_stored_sig('EBS_CRM_LABEXP_SAC_CHECK'));
      set_item_result(run_stored_sig('EBS_CRM_GEN_BILLING_ITEM'));
      set_item_result(run_stored_sig('EBS_CRM_GEN_OPENPRD_CHECK'));
      set_item_result(run_stored_sig('EBS_CRM_CSF_SRLNUM_CHECK'));
      set_item_result(run_stored_sig('EBS_CRM_CSM_JTF_HOOK'));
      set_item_result(run_stored_sig('EBS_CRM_CSFW_ORD_FAIL'));
   end_section;
END IF;
debug('end section: FieldService_Setup');

debug('begin section: Spares_setup');
IF p_app_id=523 THEN
   start_section('Spares Setup', 'Spares_setup');
      set_item_result(run_stored_sig('EBS_CRM_GEN_OPENPRD_CHECK'));
      set_item_result(run_stored_sig('EBS_CRM_CSP_REQ_FLEX'));
      set_item_result(run_stored_sig('EBS_CRM_CSP_PLN_DSKTOP'));
      set_item_result(run_stored_sig('EBS_CRM_CSP_PR_SRC_ORG'));
      set_item_result(run_stored_sig('EBS_CRM_CSP_SRC_SUBINV'));
      set_item_result(run_stored_sig('EBS_CRM_CSP_SHIP_METHODS'));
   end_section;
END IF;
debug('end section: Spares_setup');

debug('begin section: Task_Information');
IF p_app_id=513 or p_app_id=523  THEN
   start_section('Resource and Task', 'Task_Information');
      set_item_result(run_stored_sig('EBS_CRM_JTF_RESINFO'));
      set_item_result(run_stored_sig('EBS_CRM_GEN_RES_SUBINV'));
      IF p_app_id=523 THEN
         set_item_result(run_stored_sig('EBS_CRM_CSP_RES_SHIP_TO_ADDR'));
         set_item_result(run_stored_sig('EBS_CRM_CSP_CUS_SHIP_TO_ADDR'));
      END IF;
      set_item_result(run_stored_sig('EBS_CRM_JTF_TASKS'));
      set_item_result(run_stored_sig('EBS_CRM_JTF_TASK_ASSIGN'));
      set_item_result(run_stored_sig('EBS_CRM_CSF_DEF_DEFSUBINV_CHK'));
      set_item_result(run_stored_sig('EBS_CRM_SC_CSF_DEF_TRUNK_STK'));
      set_item_result(run_stored_sig('EBS_CRM_SC_CSF_RES_TERR'));
      set_item_result(run_stored_sig('EBS_CRM_SC_CSF_RES_ROLES'));
      set_item_result(run_stored_sig('EBS_CRM_SC_CSF_RES_GRP_ROLE'));
   end_section;
END IF;
debug('end section: Task_Information');

debug('begin section: Debrief');
IF p_app_id=513 THEN
   start_section('Debrief and Charges', 'Debrief');
      set_item_result(run_stored_sig('EBS_CRM_CSF_DBF_HDRS'));
      set_item_result(run_stored_sig('EBS_CRM_CSF_DBF_EXP_LINES'));
      set_item_result(run_stored_sig('EBS_CRM_CSF_DBF_LBR_LINES'));
      set_item_result(run_stored_sig('EBS_CRM_CSF_DBF_MTL_LINES'));
      set_item_result(run_stored_sig('EBS_CRM_CSF_DBF_CHARGES'));
      set_item_result(run_stored_sig('EBS_CRM_CSF_REPROCESS_DEBRIEF'));
      set_item_result(run_stored_sig('EBS_CRM_CSF_DEB_MTL_BILL_FLAG'));
      set_item_result(run_stored_sig('EBS_CRM_CSF_CHRGE_SUB_DBF_LINES_CHK'));
      set_item_result(run_stored_sig('EBS_CRM_CSF_DEB_MUL_HDR_ID'));
   end_section;
END IF;
debug('end section: Debrief');

debug('begin section: Part_requirement');
IF p_app_id=523 THEN
   start_section('Parts Requirement and Orders', 'Part_requirement');
      set_item_result(run_stored_sig('EBS_CRM_CSP_REQ_HDR'));
      set_item_result(run_stored_sig('EBS_CRM_CSP_REQ_LINES'));
      set_item_result(run_stored_sig('EBS_CRM_CSP_MTL_RES_LINES'));
      set_item_result(run_stored_sig('EBS_CRM_CSP_REQ_IO'));
      set_item_result(run_stored_sig('EBS_CRM_SC_CSF_INB_ORD_RES'));
      set_item_result(run_stored_sig('EBS_CRM_SC_CSF_RET_EXCESS_DEF'));
   end_section;
END IF;
debug('end section: Part_requirement');

debug('begin section: MobileFieldService');
IF p_app_id=883 THEN
   start_section('Mobile Field Service Setup', 'MobileFieldService');
      set_item_result(run_stored_sig('EBS_CRM_CSM_PUBITEM'));
      set_item_result(run_stored_sig('EBS_CRM_CSM_DEFER_TRANS'));
      set_item_result(run_stored_sig('EBS_CRM_CSM_JTF_HOOK'));
      set_item_result(run_stored_sig('EBS_CRM_CSM_JTM_RUN_DATA'));
      set_item_result(run_stored_sig('EBS_CRM_CSM_LONG_SYNC'));
      set_item_result(run_stored_sig('EBS_CRM_CSM_CLR_CACHE'));
      set_item_result(run_stored_sig('EBS_CRM_SC_CSF_DUPLICATE_DOC_ID'));
      set_item_result(run_stored_sig('EBS_CRM_SC_CSF_ASG_ITEM_INDEX'));
   end_section;
END IF;
debug('end section: MobileFieldService');

debug('begin section: MFS_RES_TASK');
IF p_app_id=883 THEN
   start_section('Resource and Task', 'MFS_RES_TASK');
      set_item_result(run_stored_sig('EBS_CRM_CSM_RES_INFO'));
      set_item_result(run_stored_sig('EBS_CRM_CSM_RES_ADDR'));
      set_item_result(run_stored_sig('EBS_CRM_CSM_RES_SUBINV'));
      set_item_result(run_stored_sig('EBS_CRM_CSM_TASK'));
      set_item_result(run_stored_sig('EBS_CRM_CSM_TASK_ASSGN'));
      set_item_result(run_stored_sig('EBS_CRM_CSM_TASK_DOWNLOAD'));
      set_item_result(run_stored_sig('EBS_CRM_CSF_DEF_DEFSUBINV_CHK'));
      set_item_result(run_stored_sig('EBS_CRM_SC_CSF_DEF_TRUNK_STK'));
      set_item_result(run_stored_sig('EBS_CRM_SC_CSF_RES_TERR'));
      set_item_result(run_stored_sig('EBS_CRM_SC_CSF_RES_ROLES'));
   ...
   end_section;
END IF;
debug('end section: MFS_RES_TASK');

debug('begin section: MFS_Debrief');
IF p_app_id=883 THEN
   start_section('Debrief', 'MFS_Debrief');
      set_item_result(run_stored_sig('EBS_CRM_CSM_DBF_HDR'));
      set_item_result(run_stored_sig('EBS_CRM_CSM_DBF_EXP'));
      set_item_result(run_stored_sig('EBS_CRM_CSM_DBF_LAB'));
      set_item_result(run_stored_sig('EBS_CRM_CSM_DBF_MTL'));
   end_section;
END IF;
debug('end section: MFS_Debrief');

debug('begin section: MFS_Parts');
IF p_app_id=883 THEN
   start_section('Parts Requirement', 'MFS_Parts');
      set_item_result(run_stored_sig('EBS_CRM_CSM_REQ_HDR'));
      set_item_result(run_stored_sig('EBS_CRM_CSM_REQ_LINES'));
      set_item_result(run_stored_sig('EBS_CRM_CSM_REQ_LINE_DTLS'));
   end_section;
END IF;
debug('end section: MFS_Parts');

debug('begin section: AdvancedScheduler');
IF p_app_id=698 THEN
   start_section('Scheduler Setup', 'AdvancedScheduler');
      set_item_result(run_stored_sig('EBS_CRM_CSR_RULES'));
      set_item_result(run_stored_sig('EBS_CRM_CSR_RULES_VIEW'));
      set_item_result(run_stored_sig('EBS_CRM_SC_CSF_TERR'));
      set_item_result(run_stored_sig('EBS_CRM_CSR_TERR_QUAL'));
      set_item_result(run_stored_sig('EBS_CRM_SC_CSF_TERR_NULL_ATTR'));
      set_item_result(run_stored_sig('EBS_CRM_SM_GEN_JTY_1001_DENORM'));
      set_item_result(run_stored_sig('EBS_CRM_SC_CSF_TERR_ROLGRP_NULL'));
   end_section;
END IF;
debug('end section: AdvancedScheduler');
...
start_section('Diagnostics: Apps Check', 'Apps_Check');
   ...
   set_item_result(run_stored_sig('EBS_CRM_GEN_PROF'));
