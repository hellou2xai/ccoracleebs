...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Quoting Analyzer                       |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE qot_analyzer_pkg AUTHID DEFINER AS
...
PROCEDURE main
(            QUOTE_NUMBER                   IN NUMBER      DEFAULT NULL
           ,ITEM_DESCRIPTION               IN VARCHAR2    DEFAULT NULL
...
END qot_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY qot_analyzer_pkg AS
-- $Id: qot_analyzer.sql, 200.32 2026/01/28 17:18:53 svedula Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2315991.1));
...
----------------------------------------------------------------
g_quote_number number;
g_item_desc varchar2(100);
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'QOTANALYZER_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'QOTANALYZER_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>QOTANALYZER Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2315991.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/qot_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1176,EBS,EBS CRM,EBS - Sales/Marketing" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1176,EBS,EBS CRM,EBS - Sales/Marketing" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1176,EBS,EBS CRM,EBS - Sales/Marketing" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4088154" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">1176</span>
...
<div class="ck-content"><p>Version 200.32</p><ul><li>Signatures Signature PREMIER_SUPPORT updated</li>
<li>Signature AC_DB_PARAMETERS updated</li>
<li>Signature DBSTAT1_GSS updated</li>
...
<p><strong>Version 200.31</strong></p><ul><li>Signature EBS_ATG_UGLE_SEQUENCES_CLOSE_TO_MAXIMUM_VALUE has been updated</li>
<li>Signature AC_TABLE_INDEXES has been updated<br>
&nbsp;</li>
</ul>
<p><strong>Version 200.20</strong></p><ul><li><strong>Updated signatures, internal security</strong></li>
</ul>
<p><strong>Version 200.16</strong></p><ul><li><strong>Added signature &apos;</strong><span class="display_only apex-item-display-only" data-escape="true" id="P18_TITLE_DISPLAY"><strong>Incorrect value for Profile option ASO : Reservation Level&apos;</strong></span></li>
</ul>
<p>&nbsp;</p><p><strong>Version 200.15</strong></p><ul><li>Signature updates</li>
</ul>
<p>&nbsp;</p><p><strong>Version 200.14</strong></p><ul><li>Signature updates</li>
</ul>
<p>&nbsp;</p><p><strong>Version 200.12</strong></p><ul><li>Added new signature: Sequences Reaching Maximum Value</li>
</ul>
<p><strong>Version 200.11</strong></p><ul><li>Added section - Diagnostics: Apps Check</li>
</ul>
<p><strong>Version 200.10</strong>:</p><ul><li>New Analyzer Framework version 4.6.0.1 released with bug fixes.</li>
</ul>
<p><strong>Version 200.9</strong>:</p><ul><li>Analyzer Framework 4.5.9.1 version released.</li>
</ul>
<p><strong>Version 200.8</strong>:</p><ul><li>Lifetime Support Policy: Premier Support for R12.1.3 customers updated.</li>
</ul>
<p><strong>Version 200.7</strong>:</p><ol><li>Lifetime Support Policy</li>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1176,'||p_sig.sigrepo_id||',EBS,EBS CRM,EBS - Sales/Marketing" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1176,'||p_sig.sigrepo_id||',EBS,EBS CRM,EBS - Sales/Marketing" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
...
FUNCTION check_rec_patches_1 RETURN VARCHAR2 IS
  /* Signature CHECK_RECOMMENDED_PATCHES */
...
BEGIN
    ...
    print_log('Processing recommended patches signature: CHECK_RECOMMENDED_PATCHES (check_rec_patches_1) "Quoting and Order Capture Recommended Patches" (version 3)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_col_rows(1)(l_rows) := '8233195';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'ADS12.0.4 :SLS:QOT SALES SUPPLEMENT FORM DOES NOT ALLOW TEMPLATE MODIFICATION';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '18702527';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'VOLUME BASED MODIFIER REMOVED FROM CONFIGURATION AFTER RECONFIGURING';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19004518';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'QUOTE STILL REMAINS IN APPROVAL PENDING STATUS ON SELF APPROVAL WHEN QA CHECK E';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19239672';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'SUPPORT CUSTOMER PART NUMBERS IN FORMS UI';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19544801';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'NEW PROFILE ASO_SHOW_ORDERED_PRODUCT_IN_QUOTE FOR ER 19239672';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19553947';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'QUOTE FIELDS REMAIN READ-ONLY AFTER CHANGING TO UPDATEABLE QUOTE STATUS';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19796851';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'PROBLEMS WITH COPY TO CART FROM QUOTE IN ISTORE';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19812910';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'LATIN TAX ERRORS ARE NOT SHOWING TO USERS IN QUOTE TAX LINES';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19878674';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.1.3 PATCH FOR ASOATOCI.SQL RUNNING TOO LONG ON 12.1.3 UPGRADE';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19930275';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'FP:6326261:QUOTE PRICING STATUS CHANGE TO INCOMPLETE UPON CLICKING ACTION BUTTON';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19944384';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'QUOTE CREATED FROM OPPORTUNITY DOES NOT HAVE DEFAULT DFF CONTEXT POPULATED';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19952104';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'INCORRECT LINE NUMBERS ARE COMING IN COPY TO CART FROM QUOTE AT ISTORE';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '20124165';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'UNABLE TO PLACE ORDER FROM ISTORE -- APPLICATION ERROR';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '20159655';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'PERFORMANCE ISSUE WITH TABLE ASO_QUOTE_LINES_ALL';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '20215472';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'SLOW PERFORMANCE WHEN PRICING QUOTES';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '20281028';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Order Capture Recommended Patch Collection (Dec. 2014)';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '20332841';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'GETTING ERROR FOR COPY QUOTE TO DIFFERENT CUSTOMER HAVING SERVICE ITEM';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '20381525';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'PERFORMANCE ISSUE WHEN PURGING QUOTES WITH PURGE QUOTES PROGRAM';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '20485460';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'LINE LEVEL PRICE LIST IS NOT DEFAULTING CORRECTLY AT QUOTING FORMS';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '20501846';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'DUPLICATE QUOTE COPIES ASO_SHIPMENTS.ORDER_LINE_ID VALUES TO NEW QUOTE';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '20532841';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Quoting Recommended Patch Collection (Feb. 2015)';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '20543604';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'ORA-06502 IN ISTORE AFTER APPLYING 19812910:R12.ASO.B';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '20752067';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'ADDITIONAL OPTION FOR ASO: CONFIGURATION EFFECTIVE DATE';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21187289';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'PATCH 20700246:R12.ASO.B CAUSED ASO_DEFAULTING_INT INVALID';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21189761';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'FP:12.2.7:SALES REP NAME NOT PRINTING ON QUOTE';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21237538';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'INVALID ORDER SOURCE REFERENCE NUMBERS ON SALES ORDERS WITH THE SERVICE BILLING';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21358274';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Order Capture Recommended Patch Collection (Jul/ 2015)';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21571359';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'SALES SUPPLEMENT DATA NOT COPIED CORRECTLY ON MODEL LINES';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '24010778';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '"CHANGE CUSTOMER" ACTION NULLS OUT DEFAULTS FOR FOB AND FREIGHT TERMS';
   l_col_rows(5)(l_rows) := NULL;
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25115125';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'QOT 12.2 ROLLLUP PATCH';
   l_col_rows(5)(l_rows) := NULL;
...
END IF;
   ...
   l_sig.sigrepo_id := '9784';
   l_sig.title := 'Quoting and Order Capture Recommended Patches';
...
<br>
Best Practice: Always ensure that you are on the latest code with all recommended patches applied. This will help avoid known issues, prevent potential data corruption<br>
and provide the latest features and functionality. Having a proactive patching plan and periodic proactive patching process in place are the best ways to stay current.';
   l_sig.success_msg := 'All recommended patches are applied in your environment.';
  ...
  -- Register
  l_step := '60';
  g_signatures('CHECK_RECOMMENDED_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'CHECK_RECOMMENDED_PATCHES',     -- sig ID
...
FUNCTION get_AMEAPPID
   return VARCHAR2 IS
BEGIN
debug('begin sql token function: AMEAPPID');
begin

select application_id
into ameID 
from ame_calling_apps
where application_name =  'Oracle Quoting' ;

return ameID;


end;
debug('end sql token function: AMEAPPID');
END get_AMEAPPID;
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Quote Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(QUOTE_NUMBER,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Inventory item number or description';
   g_parameters(g_parameters.LAST).pvalue := mask_text(ITEM_DESCRIPTION,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/01/28 17:18:52 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'qot_analyzer.sql';
...
debug('begin parameter validation: QUOTE_NUMBER');
IF QUOTE_NUMBER IS NOT NULL THEN
BEGIN
SELECT QUOTE_NUMBER
INTO l_exists_val
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: The quote number parameter is optional. The number you have provided is not a vaild quote number. Please provide a valid one.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for QUOTE_NUMBER failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: QUOTE_NUMBER');
...
g_quote_number := QUOTE_NUMBER;
g_item_desc := ITEM_DESCRIPTION;
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$QUOTE_NUMBER$$##') := QUOTE_NUMBER;
   g_masked_tokens('##$$QUOTE_NUMBER$$##') := mask_text( g_sql_tokens('##$$QUOTE_NUMBER$$##'), 'NO_MASK');
   g_sql_tokens('##$$ITEM_DESCRIPTION$$##') := ITEM_DESCRIPTION;
   g_masked_tokens('##$$ITEM_DESCRIPTION$$##') := mask_text( g_sql_tokens('##$$ITEM_DESCRIPTION$$##'), 'NO_MASK');
   g_sql_tokens('##$$AMEAPPID$$##') := get_AMEAPPID();
   l_system_function_var := null;
   g_masked_tokens('##$$AMEAPPID$$##') := mask_text( g_sql_tokens('##$$AMEAPPID$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM3$$##') := '660';
...
debug('begin add_signature: ASO_QOT_INVALIDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8308',
      p_sig_id                 => 'ASO_QOT_INVALIDS',
      p_sig_sql                => 'SELECT OBJECT_NAME,OWNER, OBJECT_TYPE
  FROM DBA_OBJECTS
  WHERE STATUS = ''INVALID''
  AND OBJECT_NAME like ''ASO%''
  ORDER by owner',
      p_title                  => 'ASO Invalid Packages',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Please note that some of the ASO packages are invalid. Invalid packages (unless obsolete) can lead to application errors. ',
      p_solution               => '<ul>
...
<li>Review any error messages provided and see [1325394/KB401905]
for details on compiling these invalid objects.</li>
</ul>',
      p_success_msg            => 'No invalid ASO packages.',
   ...
   l_info.delete;
debug('end add_signature: ASO_QOT_INVALIDS');



debug('begin add_signature: ENABLED_QUOTING_USER_HOOKS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7416',
      p_sig_id                 => 'ENABLED_QUOTING_USER_HOOKS',
      p_sig_sql                => 'SELECT api_name, processing_type, execute_flag
FROM JTF_USER_HOOKS
WHERE product_code = ''ASO''
AND user_hook_type = ''C''
AND pkg_name = ''ASO_QUOTE_PUB''
AND execute_flag = ''Y''',
      p_title                  => 'List of All Enabled Customer User Hooks for ASO',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Please note that you have user hooks enabled. User hooks contain custom code. Please refer to [373923/KB690940] for more information regarding user hooks and how they work in Quoting.',
      p_solution               => 'If you are experiencing any issues in Quoting, for testing purposes please disable them using :
...
and retest. For more details please refer to [373923/KB690940] .',
      p_success_msg            => 'No user hooks enabled. User hooks contain custom code and they should be disabled when desiring to test unexpected behavior or data.',
   ...
   l_info.delete;
debug('end add_signature: ENABLED_QUOTING_USER_HOOKS');



debug('begin add_signature: ENABLED_FORMS_CUSTOMIZATIONS');
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8393',
      p_sig_id                 => 'ENABLED_FORMS_CUSTOMIZATIONS',
      p_sig_sql                => 'select FORM_NAME, description,ENABLED
from FND_FORM_CUSTOM_RULES
where FORM_NAME like ''QOT%''',
      p_title                  => 'List of Forms Custom Rules for Quoting',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'List of all the personalization defined against the Quoting Forms. These are created by users and they can contain custom logic. ',
      p_solution               => 'For testing purposes, please disable all personalization by navigating to Help -> Diagnostics -> Custom Code -> Off. Please refer to [1501592/KB788767].',
      p_success_msg            => 'No personalizations defined on Quoting Forms.',
   ...
   l_info.delete;
debug('end add_signature: ENABLED_FORMS_CUSTOMIZATIONS');



debug('begin add_signature: EXISTING_FOLDERS_FORMS');
   l_info('##MASK##NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8394',
      p_sig_id                 => 'EXISTING_FOLDERS_FORMS',
      p_sig_sql                => 'Select f.folder_id, f.object, f.name, f.window_width, f.public_flag, f.autoquery_flag, f.where_clause, u.user_id, u.user_name
from fnd_folders f , fnd_user u
where object like ''QOT%''
and f.created_by = u.user_id (+) order by object',
      p_title                  => 'List of Forms Folders for Quoting',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Forms Folders are a standard Forms mechanism allowing the customers to modify the layout and the query criteria of a Form block. More details are available in the E-Business Help, section "Managing Folder Definitions".',
      p_solution               => 'Please note that you have defined Forms folders on the Quoting Form. In case you are experiencing any issues in Forms, please verify if the issue is reproducible with the folders disabled.',
      p_success_msg            => 'No custom folders defined in the Quoting Forms.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EXISTING_FOLDERS_FORMS');



debug('begin add_signature: ORG_ID_QUOTING_PARAMETERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8395',
      p_sig_id                 => 'ORG_ID_QUOTING_PARAMETERS',
      p_sig_sql                => 'SELECT org_information_id, organization_id, org_information1, org_information2, org_information3, org_information4, org_information5, org_information6
FROM hr_organization_information WHERE org_information_context = ''ASO_ORG_INFO''',
      p_title                  => 'List of All Quoting Operating Unit Parameters',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Quoting Parameters were setup for any of the operating units. Quoting Parameters are a mandatory step in implementing the Quoting module.',
      p_solution               => 'Please setup the Quoting Parameters for all the operating units used in Quoting.<br>
Please refer to [1162858/KB293233] Where are the Quoting Parameters setup? ',
      p_success_msg            => 'Quoting Parameters have been set up for at least some operating units.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ORG_ID_QUOTING_PARAMETERS');



debug('begin add_signature: QUOTING_STATS_GATHERED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8396',
      p_sig_id                 => 'QUOTING_STATS_GATHERED',
      p_sig_sql                => 'SELECT
owner,
table_name,
ini_trans,
...
FROM all_tables
WHERE owner = ''ASO''',
      p_title                  => 'List of All ASO Tables and the Stats for Each Table',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No table information.',
      p_solution               => 'Please make sure Quoting module is installed.',
      p_success_msg            => 'List of all ASO tables and the time stats were gathered for each of them.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: QUOTING_STATS_GATHERED');



debug('begin add_signature: ASO_DEBUG_PROFILES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7411',
      p_sig_id                 => 'ASO_DEBUG_PROFILES',
      p_sig_sql                => 'SELECT SUBSTR(e.profile_option_name,1,25) PROFILE,DECODE(a.level_id,10001,''Site'',10002,''Application'',10003,''Resp'',10004,''User'') L,
DECODE(a.level_id,10001,''Site'',10002,c.application_short_name,10003,b.responsibility_name,10004,d.user_name) LValue,
NVL(a.profile_option_value,''Is Null'') Value,SUBSTR(a.last_update_date,1,25) UPDATED_DATE
FROM fnd_profile_option_values a, fnd_responsibility_tl b, fnd_application c,fnd_user d, fnd_profile_options e
WHERE e.profile_option_name in (''OE_DEBUG_LOG_DIRECTORY'', ''ONT_DEBUG_LEVEL'', ''QP_DEBUG'', ''ASO_ENABLE_DEBUG'', ''AFLOG_ENABLED'', ''AFLOG_MODULE'', ''AFLOG_LEVEL'', ''AFLOG_FILENAME'')
...
ORDER BY profile_option_name',
      p_title                  => 'Value of All Profiles Related to Quoting Debug',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'All debug profiles are unset.',
      p_solution               => '',
      p_success_msg            => 'Value of all profiles related to Quoting debugging.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ASO_DEBUG_PROFILES');



debug('begin add_signature: OM_DEBUG_LOG_LOCATION');
   l_info('##MASK##VALUE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7412',
      p_sig_id                 => 'OM_DEBUG_LOG_LOCATION',
      p_sig_sql                => 'select value from v$parameter where name = ''utl_file_dir''',
      p_title                  => 'Valid Locations for OM Debug Log File',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Database parameter ''utl_file_dir'' contains no values.',
      p_solution               => '',
      p_success_msg            => 'Valid locations for OM debug log file.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: OM_DEBUG_LOG_LOCATION');
...
debug('begin add_signature: ASO_PROFILE_VALUES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8397',
      p_sig_id                 => 'ASO_PROFILE_VALUES',
      p_sig_sql                => 'SELECT SUBSTR(e.profile_option_name,1,25) PROFILE,DECODE(a.level_id,10001,''Site'',10002,''Application'',10003,''Resp'',10004,''User'') L,
DECODE(a.level_id,10001,''Site'',10002,c.application_short_name,10003,b.responsibility_name,10004,d.user_name) LValue,
NVL(a.profile_option_value,''Is Null'') Value,SUBSTR(a.last_update_date,1,25) UPDATED_DATE
FROM fnd_profile_option_values a, fnd_responsibility_tl b, fnd_application c,fnd_user d, fnd_profile_options e
WHERE e.profile_option_name like ''ASO%''
AND e.profile_option_id = a.profile_option_id (+) AND a.level_value = b.responsibility_id (+)
AND a.level_value = c.application_id (+) AND a.level_value = d.user_id (+)
ORDER BY profile_option_name',
      p_title                  => 'Values of All ASO Profiles at All Levels',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No profile information.',
      p_solution               => '',
      p_success_msg            => 'Values of all ASO profiles at all levels.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ASO_PROFILE_VALUES');



debug('begin add_signature: ASO_SECURITY_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8398',
      p_sig_id                 => 'ASO_SECURITY_CHECK',
      p_sig_sql                => 'SELECT SUBSTR(e.profile_option_name,1,25) PROFILE,DECODE(a.level_id,10001,''Site'',10002,''Application'',10003,''Resp'',10004,''User'') L,
DECODE(a.level_id,10001,''Site'',10002,c.application_short_name,10003,b.responsibility_name,10004,d.user_name) LValue,
NVL(a.profile_option_value,''Is Null'') Value,SUBSTR(a.last_update_date,1,25) UPDATED_DATE
FROM fnd_profile_option_values a, fnd_responsibility_tl b, fnd_application c,fnd_user d, fnd_profile_options e
WHERE e.profile_option_name in (''XLA_MO_SECURITY_PROFILE_LEVEL'', ''ORG_ID'', ''DEFAULT_ORG_ID'', ''ASO_ENABLE_SECURITY_CHECK'', ''ASO_API_ENABLE_SECURITY'' , ''ASO_API_MGR_ROLE_ACCESS'')
AND e.profile_option_id = a.profile_option_id (+) AND a.level_value = b.responsibility_id (+)
AND a.level_value = c.application_id (+) AND a.level_value = d.user_id (+)
ORDER BY profile_option_name',
      p_title                  => 'List of Profiles Involved in Quoting Access Security',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Security profiles not set.',
      p_solution               => '',
      p_success_msg            => 'List of profiles involved in Quoting Access Security.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ASO_SECURITY_CHECK');



debug('begin add_signature: ASO_QUOTE_STATUSES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8399',
      p_sig_id                 => 'ASO_QUOTE_STATUSES',
      p_sig_sql                => 'select quote_status_id, language, source_lang, meaning, description from aso_quote_statuses_tl',
      p_title                  => 'List of All Defined Quote Statuses',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No quote statuses available.',
      p_solution               => '',
      p_success_msg            => 'List of all defined quote statuses from table ASO_QUOTE_STATUSES_TL.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ASO_QUOTE_STATUSES');



debug('begin add_signature: ASO_QUOTE_STATUS_TRANSITIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8400',
      p_sig_id                 => 'ASO_QUOTE_STATUS_TRANSITIONS',
      p_sig_sql                => 'select a.from_status_id, a.to_status_id, b.meaning, c. meaning,  a.enabled_flag
from ASO_QUOTE_STATUS_TRANSITIONS a, aso_quote_statuses_tl b, aso_quote_statuses_tl c
where a.from_status_id = b.quote_status_id
and a.to_status_id = c.quote_status_id
order by a.from_status_id',
      p_title                  => 'List of All Defined Quote Status Transitions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No valid quote status transitions available . ',
      p_solution               => '',
      p_success_msg            => 'List of all defined quote status transitions.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ASO_QUOTE_STATUS_TRANSITIONS');



debug('begin add_signature: EBS_CRM_SM_QOT_OHD_FAIL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30711',
      p_sig_id                 => 'EBS_CRM_SM_QOT_OHD_FAIL',
...
WHERE e.application_id like 697
AND t.USER_PROFILE_OPTION_NAME IN (''ASO : Reservation Level'')
AND a.profile_option_value <> ''MANUAL''
...
ORDER BY user_profile_option_name, a.level_id',
      p_title                  => 'Incorrect value for Profile option ASO : Reservation Level',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Profile option ''ASO : Reservation Level'' was set incorrect',
      p_solution               => 'Please review profile "ASO : Reservation Level" option setting and update it to a correct value.  Refer to [729659/KB559221]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_QOT_OHD_FAIL');



debug('begin add_signature: INTERMEDIA_PROFILES_SETUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7410',
      p_sig_id                 => 'INTERMEDIA_PROFILES_SETUP',
      p_sig_sql                => 'select po.profile_option_name "NAME",
...
where po.profile_option_name in (''ORG_ID'',''ASO_USE_INTERMEDIA_SEARCH'',''ASO_CATEGORY_SET'',''IBE_SEARCH_CATEGORY_SET'',''IBE_SEARCH_WEB_STATUS'',''ASO_WEB_ATTR_FILTER'',''ASO_REQUIRE_SERVICE_REFERENCE'')
...
order by "NAME", pov.level_id, "VALUE"',
      p_title                  => 'Item Search Related Profiles',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'None of the profiles required for item search are set.',
      p_solution               => '',
      p_success_msg            => 'This list of profiles is used to check setup when logging a Service Request with Oracle Support for Item Search Issues. See [1932322/KB673186] for more information.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: INTERMEDIA_PROFILES_SETUP');



debug('begin add_signature: OM_SYNONYMS_PRESENT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7408',
      p_sig_id                 => 'OM_SYNONYMS_PRESENT',
      p_sig_sql                => 'SELECT * FROM all_synonyms
WHERE synonym_name like ''OE_SYSTEM_PARAMETERS%''',
      p_title                  => 'OE_SYSTEM_PARAMETERS Synonyms for R12',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'OM System Parameters are not set.',
      p_solution               => '',
      p_success_msg            => 'List of OM System Parameters required to see if they are created correctly as per [549870/KB195643]. ',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: OM_SYNONYMS_PRESENT');



debug('begin add_signature: AVAILABLE_CATEGORY_SETS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7407',
      p_sig_id                 => 'AVAILABLE_CATEGORY_SETS',
      p_sig_sql                => 'Select category_set_id, category_set_name from mtl_category_sets_vl',
      p_title                  => 'Available Category Sets Related to Inventory Integration',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No category sets defined in Inventory.',
      p_solution               => '',
      p_success_msg            => 'All category sets available in Inventory. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AVAILABLE_CATEGORY_SETS');



debug('begin add_signature: INVENTORY_OPERATING_UNITS');
   l_info('##MASK##NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7402',
      p_sig_id                 => 'INVENTORY_OPERATING_UNITS',
      p_sig_sql                => 'select osp.org_id , substr(ouo.name,1,25) OU
, osp.master_organization_id INV_ORG_ID, substr(ino.name,1,25) Inventory_Org
from oe_system_parameters_all osp,
hr_all_organization_units ouo,
hr_all_organization_units ino
where osp.org_id = ouo.organization_id (+)
and osp.master_organization_id = ino.organization_id (+)
group by osp.org_id , ouo.name, osp.master_organization_id, ino.name',
      p_title                  => 'List of All Operating Units and Inventory Organizations',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No operating units and no inventory organizations defined.',
      p_solution               => '',
      p_success_msg            => 'List of all operating units and inventory organizations.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: INVENTORY_OPERATING_UNITS');



debug('begin add_signature: INTERMEDIA_TABLE_ORG_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7405',
      p_sig_id                 => 'INTERMEDIA_TABLE_ORG_ID',
      p_sig_sql                => 'Select distinct(organization_id) from ibe_ct_imedia_search',
      p_title                  => 'List of Operating Units from Intermedia Table',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No inventory operating units listed in the records from the Intermedia table.',
      p_solution               => '',
      p_success_msg            => 'List of distinct inventory operating units from the Intermedia table. ',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: INTERMEDIA_TABLE_ORG_ID');



debug('begin add_signature: LANGUAGES_INTERMEDIA_TABLE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7404',
      p_sig_id                 => 'LANGUAGES_INTERMEDIA_TABLE',
      p_sig_sql                => 'Select distinct(language) from ibe_ct_imedia_search',
      p_title                  => 'Distinct Languages of the Items Populated in the Intermedia Tables',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No languages defined for the items from the Intermedia Search table.',
      p_solution               => '',
      p_success_msg            => 'Distinct languages of the items populated in the Intermedia Search table.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LANGUAGES_INTERMEDIA_TABLE');



debug('begin add_signature: DISTINCT_CATEGORY_SETS_INTERMEDIA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7401',
      p_sig_id                 => 'DISTINCT_CATEGORY_SETS_INTERMEDIA',
      p_sig_sql                => 'Select distinct(category_set_id) from ibe_ct_imedia_search',
      p_title                  => 'List of Category Sets Available in Intermedia Table',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No category sets available in the Intermedia Search table.',
      p_solution               => '',
      p_success_msg            => 'List of distinct category sets available in Intermedia Search table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: DISTINCT_CATEGORY_SETS_INTERMEDIA');



debug('begin add_signature: WEB_STATUS_INTERMEDIA_TABLE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7400',
      p_sig_id                 => 'WEB_STATUS_INTERMEDIA_TABLE',
      p_sig_sql                => 'Select distinct(web_status) from ibe_ct_imedia_search',
      p_title                  => 'List of Distinct Web Statuses for Items Populated in the Intermedia Table',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No information related to web status available in the Intermedia Search table.',
      p_solution               => '',
      p_success_msg            => 'List of distinct web statuses for items populated in the Intermedia table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: WEB_STATUS_INTERMEDIA_TABLE');



debug('begin add_signature: ASO_QUOTE_HEADERS_ALL');
   l_info('##MASK##%ATTRIBUTES%'):= 'REMOVE_COLUMN';
   l_info('##MASK##CUSTOMER_NAME_AND_TITLE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PHONE_ID'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##QUOTE_PASSWORD'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SUPPLIER_NAME_AND_TITLE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8401',
      p_sig_id                 => 'ASO_QUOTE_HEADERS_ALL',
      p_sig_sql                => 'select * from aso_quote_headers_all where quote_number =  ##$$QUOTE_NUMBER$$##',
      p_title                  => 'Quoting Header Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No quote header information for quote number '||mask_text(g_quote_number, nvl( upper(''), 'NO_MASK') )||'. ',
      p_solution               => '',
      p_success_msg            => 'Quoting header info for quote number '||mask_text(g_quote_number, nvl( upper(''), 'NO_MASK') )||' from table ASO_QUOTE_HEADERS_ALL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ASO_QUOTE_HEADERS_ALL');



debug('begin add_signature: ASO_QUOTE_LINES_ALL');
   l_info('##MASK##%ATTRIBUTE%'):= 'REMOVE_COLUMN';
   l_info('##MASK##DISPLAY_ARITHMETIC_OPERATOR'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8404',
      p_sig_id                 => 'ASO_QUOTE_LINES_ALL',
      p_sig_sql                => 'select * from aso_quote_lines_all where quote_header_id in (select quote_header_id from aso_quote_headers_all where quote_number = ##$$QUOTE_NUMBER$$##)',
      p_title                  => 'Details of All Quote Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No quote lines added to quote number '||mask_text(g_quote_number, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => '',
      p_success_msg            => 'Details of all quote lines for quote number '||mask_text(g_quote_number, nvl( upper(''), 'NO_MASK') )||' from table ASO_QUOTE_LINES_ALL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ASO_QUOTE_LINES_ALL');



debug('begin add_signature: ASO_QUOTE_LINE_DETAILS');
   l_info('##MASK##%ATTRIBUTE%'):= 'REMOVE_COLUMN';
   l_info('##MASK##BOM_SORT_ORDER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CONFIG_INSTANCE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8403',
      p_sig_id                 => 'ASO_QUOTE_LINE_DETAILS',
      p_sig_sql                => 'select * from aso_quote_line_details
where quote_line_id in 
 (select quote_line_id from aso_quote_lines_all where quote_header_id in 
   (select quote_header_id from aso_quote_headers_all where quote_number = ##$$QUOTE_NUMBER$$##))',
      p_title                  => 'List of Service Related Attributes, Model/Option Related Attributes and Return Related Attributes for All Quote Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No quote lines details from quote number '||mask_text(g_quote_number, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => '',
      p_success_msg            => 'List of service related attributes, model/option related attributes and return related attributes for all quote lines for quote number '||mask_text(g_quote_number, nvl( upper(''), 'NO_MASK') )||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ASO_QUOTE_LINE_DETAILS');



debug('begin add_signature: ASO_PRICE_ADJUSTMENTS');
   l_info('##MASK##%ATTRIBUTES%'):= 'REMOVE_COLUMN';
   l_info('##MASK##TAX_EXEMPT_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8405',
      p_sig_id                 => 'ASO_PRICE_ADJUSTMENTS',
      p_sig_sql                => 'select * from aso_price_adjustments where quote_header_id in 
   (select quote_header_id from aso_quote_headers_all where quote_number = ##$$QUOTE_NUMBER$$##)',
      p_title                  => 'List of All Modifiers Available',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No modifiers available for quote number '||mask_text(g_quote_number, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => '',
      p_success_msg            => 'Output from table ASO_PRICE_ADJUSTMENTS, listing applied and not applied modifiers available for quote number '||mask_text(g_quote_number, nvl( upper(''), 'NO_MASK') )||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ASO_PRICE_ADJUSTMENTS');



debug('begin add_signature: ASO_APR_OBJ_APPROVALS');
   l_info('##MASK##%ATTRIBUTE%'):= 'REMOVE_COLUMN';
   l_info('##MASK##CONTEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##REQUESTER_COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8406',
      p_sig_id                 => 'ASO_APR_OBJ_APPROVALS',
      p_sig_sql                => 'select * from ASO_APR_OBJ_APPROVALS where object_id in 
   (select quote_header_id from aso_quote_headers_all where quote_number = ##$$QUOTE_NUMBER$$##)',
      p_title                  => 'List of All Approval Requests',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No approval information for quote number '||mask_text(g_quote_number, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => '',
      p_success_msg            => 'List of all approval requests for quote number '||mask_text(g_quote_number, nvl( upper(''), 'NO_MASK') )||' from table ASO_APR_OBJ_APPROVALS.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ASO_APR_OBJ_APPROVALS');



debug('begin add_signature: ASO_APR_APPROVAL_DETAILS');
   l_info('##MASK##%ATTRIBUTE%'):= 'REMOVE_COLUMN';
   l_info('##MASK##APPROVER_COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8407',
      p_sig_id                 => 'ASO_APR_APPROVAL_DETAILS',
      p_sig_sql                => 'select * from ASO_APR_APPROVAL_DETAILS where object_approval_id in 
 (select object_approval_id from ASO_APR_OBJ_APPROVALS where object_id in 
   (select quote_header_id from aso_quote_headers_all where quote_number = ##$$QUOTE_NUMBER$$##))',
      p_title                  => 'List of All Approval Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No approval detail information available for quote number '||mask_text(g_quote_number, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => '',
      p_success_msg            => 'Relevant output from ASO_APR_APPROVAL_DETAILS containing detailed information regarding the quote approvals (if any triggered) for quote number '||mask_text(g_quote_number, nvl( upper(''), 'NO_MASK') )||'.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ASO_APR_APPROVAL_DETAILS');



debug('begin add_signature: ASO_PAYMENTS');
   l_info('##MASK##%ATTRIBUTES%'):= 'REMOVE_COLUMN';
   l_info('##MASK##CREDIT_CARD_HOLDER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PAYMENT_REF_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8408',
      p_sig_id                 => 'ASO_PAYMENTS',
      p_sig_sql                => 'select * from ASO_PAYMENTS where quote_header_id in (select quote_header_id from aso_quote_headers_all where quote_number = ##$$QUOTE_NUMBER$$##)',
      p_title                  => 'Lists Payment Related Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No payment information for quote number '||mask_text(g_quote_number, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => '',
      p_success_msg            => 'Lists payment related information for quote number '||mask_text(g_quote_number, nvl( upper(''), 'NO_MASK') )||' from table ASO_PAYMENTS.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ASO_PAYMENTS');



debug('begin add_signature: ASO_QUOTE_ACCESSES');
   l_info('##MASK##%ATTRIBUTE%'):= 'REMOVE_COLUMN';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8409',
      p_sig_id                 => 'ASO_QUOTE_ACCESSES',
      p_sig_sql                => 'select * from ASO_QUOTE_ACCESSES where quote_number = ##$$QUOTE_NUMBER$$##',
      p_title                  => 'Details of Quote Sales Team Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No quote access information for quote number '||mask_text(g_quote_number, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => '',
      p_success_msg            => 'Details of quote sales team information for quote number '||mask_text(g_quote_number, nvl( upper(''), 'NO_MASK') )||' from table ASO_QUOTE_ACCESSES.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ASO_QUOTE_ACCESSES');



debug('begin add_signature: ASO_SALES_CREDITS');
   l_info('##MASK##%ATTRIBUTE%'):= 'REMOVE_COLUMN';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8410',
      p_sig_id                 => 'ASO_SALES_CREDITS',
      p_sig_sql                => 'select * from ASO_SALES_CREDITS where quote_header_id in 
 (select quote_header_id from aso_quote_headers_all where quote_number = ##$$QUOTE_NUMBER$$##)',
      p_title                  => 'Details of Sales Credits Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No sales credits information for quote number '||mask_text(g_quote_number, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => '',
      p_success_msg            => 'Details of sales credits information for quote number '||mask_text(g_quote_number, nvl( upper(''), 'NO_MASK') )||' from table ASO_SALES_CREDITS.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ASO_SALES_CREDITS');



debug('begin add_signature: ASO_SHIPMENTS');
   l_info('##MASK##%ATTRIBUTE%'):= 'REMOVE_COLUMN';
   l_info('##MASK##PACKING_INSTRUCTIONS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SHIPPING_INSTRUCTIONS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8411',
      p_sig_id                 => 'ASO_SHIPMENTS',
      p_sig_sql                => 'select * from ASO_SHIPMENTS where quote_header_id in 
 (select quote_header_id from aso_quote_headers_all where quote_number = ##$$QUOTE_NUMBER$$##)',
      p_title                  => 'Details of Shipping Information at Header Level or Line Level',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No shipping information available for quote number '||mask_text(g_quote_number, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => '',
      p_success_msg            => 'Details of shipping information for quote number '||mask_text(g_quote_number, nvl( upper(''), 'NO_MASK') )||' at header level or line level from table ASO_SHIPMENTS.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ASO_SHIPMENTS');



debug('begin add_signature: ASO_TAX_DETAILS');
   l_info('##MASK##%ATTRIBUTES%'):= 'REMOVE_COLUMN';
   l_info('##MASK##TAX_EXEMPT_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8412',
      p_sig_id                 => 'ASO_TAX_DETAILS',
      p_sig_sql                => 'select * from ASO_TAX_DETAILS where quote_header_id in 
 (select quote_header_id from aso_quote_headers_all where quote_number = ##$$QUOTE_NUMBER$$##)',
      p_title                  => 'Tax Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No tax information for Quote Number '||mask_text(g_quote_number, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => '',
      p_success_msg            => 'Details of the tax details for quote number '||mask_text(g_quote_number, nvl( upper(''), 'NO_MASK') )||' from table ASO_TAX_DETAILS.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ASO_TAX_DETAILS');



debug('begin add_signature: ORDER_FEEDBACK_QUEUE_VIEW');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8630',
      p_sig_id                 => 'ORDER_FEEDBACK_QUEUE_VIEW',
      p_sig_sql                => 'select object_name , status from dba_objects where object_name = ''AQ$ASO_ORDER_FEEDBACK_T'' and object_type = ''VIEW''',
      p_title                  => 'Check If the AQ$ASO_ORDER_FEEDBACK_T Exists',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Please note that the Order Feedback Queue view does not exist. In order to determine the content of the queue, the view will need to be recreated manually.',
      p_solution               => 'Please create the view following the instructions from [2052670/KB315564] How To Create Missing View for ASO.AQ$ASO_ORDER_FEEDBACK_T? ',
      p_success_msg            => 'The Order Feedback Queue view exists and the content of the queue can be queried.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ORDER_FEEDBACK_QUEUE_VIEW');



debug('begin add_signature: ORDER_FEEDBACK_LOOKUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7414',
      p_sig_id                 => 'ORDER_FEEDBACK_LOOKUP',
      p_sig_sql                => 'select lookup_type, lookup_code, enabled_flag,  END_DATE_ACTIVE, language
from FND_LOOKUP_VALUES
where lookup_type = ''ASO_ORDER_FEEDBACK_CRM_APPS''
and enabled_flag = ''Y''',
      p_title                  => 'Applications Using the Order Feedback Queue',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No applications are using the ASO Order Feedback Queue. ',
      p_solution               => 'More details available in [181410/FAQ5287] Oracle Quoting/Order Capture Order Feedback Queue FAQ.',
      p_success_msg            => 'Complete list of all the applications that are currently enabled to use the Order Feedback Queue - more details available in [181410/FAQ5287] Oracle Quoting/Order Capture Order Feedback Queue FAQ.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ORDER_FEEDBACK_LOOKUP');



debug('begin add_signature: ORDER_FEEDBACK_QUEUE_CONTENT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7413',
      p_sig_id                 => 'ORDER_FEEDBACK_QUEUE_CONTENT',
      p_sig_sql                => 'select consumer_name, msg_state, count(*)
from (SELECT  q_name QUEUE, qt.msgid MSG_ID, corrid CORR_ID,  priority MSG_PRIORITY,  decode(s.subscriber_type,2,''UNDELIVERABLE'',
                 ...
                 enq_timestamp,   enq_uid ENQ_USER_ID,  qt.enq_tid
ENQ_TXN_ID,  decode(h.transaction_id, NULL, TO_DATE(NULL),  
                 ...
                 at time zone sessiontimezone as date)) DEQ_TIME,  decode(h.transaction_id, NULL, TO_TIMESTAMP(NULL),  
                        cast(FROM_TZ(h.dequeue_time, ''00:00'')
                 at time zone sessiontimezone as timestamp))
                 DEQ_TIMESTAMP,  h.dequeue_user DEQ_USER_ID,
 h.transaction_id DEQ_TXN_ID,  h.retry_count retry_count,  decode
(state, 0, exception_qschema,
                                1, exception_qschema,
                                2, exception_qschema,  
                                NULL) EXCEPTION_QUEUE_OWNER,  decode (state, 0, exception_queue,
                                1, exception_queue,
                                2, exception_queue, 
                                NULL) EXCEPTION_QUEUE,  user_data,
 h.propagated_msgid PROPAGATED_MSGID,  sender_name  SENDER_NAME,
sender_address  SENDER_ADDRESS, sender_protocol  SENDER_PROTOCOL,
dequeue_msgid ORIGINAL_MSGID,  decode (h.dequeue_time, NULL,
                 ...
                 EXPIRATION_REASON,  decode(h.subscriber#, 0, decode(h.name, ''0'', NULL, h.name), s.name) CONSUMER_NAME
                 ,  s.address ADDRESS,  s.protocol PROTOCOL
            FROM "ASO_ORDER_FEEDBACK_T" qt, "AQ$_ASO_ORDER_FEEDBACK_T_H" h, "AQ$_ASO_ORDER_FEEDBACK_T_S" s
            WHERE  qt.msgid = h.msgid
            AND  ((h.subscriber# != 0 AND h.subscriber# = s.subscriber_id)  OR (h.subscriber# = 0 AND h.address# = s.subscriber_id))
            AND (qt.state != 7 OR   qt.state != 9 )
            WITH READ ONLY)
group by consumer_name, msg_state',
      p_title                  => 'Order Feedback Queue Messages Count',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No messages available in the Order Feedback Queue.',
      p_solution               => '',
      p_success_msg            => 'Lists the count of messages and their status from the Order Feedback Queue for each of the applications using the queue. 

Further information related to Order Feedback Queue can be found in note Oracle Quoting/Order Capture Order Feedback Queue FAQ (Doc ID 181410.1). ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ORDER_FEEDBACK_QUEUE_CONTENT');



debug('begin add_signature: TRADE_MANAGEMENT_COUNT_OF_RECORDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7415',
      p_sig_id                 => 'TRADE_MANAGEMENT_COUNT_OF_RECORDS',
      p_sig_sql                => 'select count(*)  record_count , ''OZF_FUNDS_UTILIZED_ALL_B'' OZF_TABLE from ozf_funds_utilized_all_b
union
select count(*), ''OZF_FUNDS_ALL_B'' from  ozf_funds_all_b
union
select count(*), ''AMS_OFFERS'' from ams_offers',
      p_title                  => 'Check If Main TM Tables Have Actual Values in Them',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No lines available in the main OZF tables.',
      p_solution               => '',
      p_success_msg            => 'The main OZF tables and the count of records from each table. This can be used to determine if OZF is actually being used, in connection to data corruption in the ASO feedback queue.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: TRADE_MANAGEMENT_COUNT_OF_RECORDS');



debug('begin add_signature: DEFAULTING_RULES_CONDITIONS');
   l_info('##MASK##%ATTRIBUTE%'):= 'REMOVE_COLUMN';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8668',
      p_sig_id                 => 'DEFAULTING_RULES_CONDITIONS',
      p_sig_sql                => 'select database_object_display_name, attribute_display_name, description, display_name from oe_def_attr_condns_v 
where database_object_name in (''ASO_AK_QUOTE_HEADER_V'', ''ASO_AK_QUOTE_LINE_V'')',
      p_title                  => 'List of All Conditions Used in the Active Defaulting Rules',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No active defaulting rules defined.',
      p_solution               => 'Please make sure that the defaulting rules are enabled and the concurrent programs are run as per [746570/KB316080] .',
      p_success_msg            => 'List of all defaulting conditions for the enabled defaulting rules.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: DEFAULTING_RULES_CONDITIONS');



debug('begin add_signature: ASO_DEFAULTING_RULES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8667',
      p_sig_id                 => 'ASO_DEFAULTING_RULES',
      p_sig_sql                => 'select DECODE(database_object_name ,''ASO_AK_QUOTE_HEADER_V'',''Quote Header'',''ASO_AK_QUOTE_LINE_V'',''Quote Line'') L ,name , 
sequence_no, src_type as Source_type, src_api_pkg ||''.'' ||  src_api_FN as Package_Procedure, src_profile_option source_profile_option, src_constant_value, src_system_variable_expr, src_parameter_name, 
src_foreign_key_name, src_database_object_name ,  src_attribute_code  
from oe_def_attr_rules_v 
where database_object_name in (''ASO_AK_QUOTE_HEADER_V'', ''ASO_AK_QUOTE_LINE_V'')
order by L, name , sequence_no',
      p_title                  => 'List of all Quoting Defaulting Rules Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No defaulting rules are defined. ',
      p_solution               => 'Please make sure that the defaulting rules concurrent programs are run as per [746570/KB316080] .',
      p_success_msg            => 'Complete list of all Quoting defaulting rules and all the conditions used in them.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ASO_DEFAULTING_RULES');



debug('begin add_signature: QUOTES_STUCK_PENDING_APPR');
   l_info('##MASK##QUOTE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##APPROVAL_STATUS'):= ',,yellow,';
  add_signature(
      p_sig_repo_id            => '9790',
      p_sig_id                 => 'QUOTES_STUCK_PENDING_APPR',
      p_sig_sql                => 'select  headers.quote_number, headers.quote_version, headers.quote_name,  approvals.approval_status, details.approver_status intermediary_statuses 
from ASO_QUOTE_HEADERS_ALL headers, ASO_QUOTE_STATUSES_TL statuses, ASO_APR_OBJ_APPROVALS approvals, ASO_APR_APPROVAL_DETAILS details
where headers.max_version_flag = ''Y'' 
and headers.quote_status_id = statuses.quote_status_id 
and statuses.MEANING = ''Approval Pending'' 
and headers.QUOTE_HEADER_ID = approvals.OBJECT_ID 
and approvals.approval_status = ''PEND'' 
and approvals.object_approval_id = details.object_approval_id 
and not exists (select 1 from ASO_APR_APPROVAL_DETAILS where object_approval_id = approvals.object_approval_id and APPROVER_STATUS = ''PEND'')',
      p_title                  => 'Quotes Stuck in Pending Approval Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'You have a number of quotes that are stuck in Pending Approval. These quotes are no longer tied to an active approval process but the status of the quotes are stuck in Approval Pending.',
      p_solution               => 'Please review the list of quote numbers and raise a Service Request with Oracle Support to get assistance with them.<br>
Alternately you can attempt to use [1933912/KB312537] and data fix the affected quotes. Please note that this is not officially supported and it is recommended to be done under the supervision of a Support Analyst.',
      p_success_msg            => 'All the quote approval processes are correct and there are no quotes stuck in Approval Pending.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: QUOTES_STUCK_PENDING_APPR');
...
debug('begin add_signature: INV_ITEM_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7406',
      p_sig_id                 => 'INV_ITEM_DETAILS',
      p_sig_sql                => 'SELECT b.INVENTORY_ITEM_ID,
a.description,
c.CATEGORY_SET_ID,
c.CATEGORY_ID,
b.ORGANIZATION_ID,
...
a.primary_uom_code,
a.bom_item_type,
b.language, a.vendor_warranty_flag , a.start_date_active,
a.end_date_active
FROM mtl_system_items_b_kfv a ,
mtl_system_items_tl b ,
mtl_item_categories c
WHERE 
((''##$$ITEM_DESCRIPTION$$##'' IS NULL and 1=2) or ''##$$ITEM_DESCRIPTION$$##'' IS NOT NULL) and
b.INVENTORY_ITEM_ID = c.INVENTORY_ITEM_ID
and b.organization_id = c.organization_id
and c.INVENTORY_ITEM_ID = a.INVENTORY_ITEM_ID
and c.organization_id = a.organization_id
and (UPPER(b.description) like (upper(''%##$$ITEM_DESCRIPTION$$##%''))
OR (UPPER(a.concatenated_segments) like upper((''%##$$ITEM_DESCRIPTION$$##%''))))',
      p_title                  => 'Inventory Item Details for a Specific Inventory Item',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No item found based on the provided description.',
      p_solution               => '',
      p_success_msg            => 'Output from Inventory tables for an item. Information that can be used in case the item is not returned in the item search in Quoting.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: INV_ITEM_DETAILS');



debug('begin add_signature: ITEM_DETAILS_INTERMEDIA_TABLE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7399',
      p_sig_id                 => 'ITEM_DETAILS_INTERMEDIA_TABLE',
      p_sig_sql                => 'SELECT *
FROM ibe_ct_imedia_search
WHERE 
((''##$$ITEM_DESCRIPTION$$##'' IS NULL and 1=2) or ''##$$ITEM_DESCRIPTION$$##'' IS NOT NULL) and 
inventory_item_id IN
  (SELECT DISTINCT b.inventory_item_id
   ...
   AND(UPPER(b.description) LIKE(UPPER(''%##$$ITEM_DESCRIPTION$$##%'')) 
   OR(UPPER(a.concatenated_segments) LIKE UPPER((''%##$$ITEM_DESCRIPTION$$##%'')))))',
      p_title                  => 'Item Details from Intermedia Tables for a Specific Item',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Item is not available in the Intermedia Search table.',
      p_solution               => '',
      p_success_msg            => 'Complete output from the Intermedia Search table for the selected item.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_DETAILS_INTERMEDIA_TABLE');
...
BEGIN
  ...
  analyzer_title := 'Quoting Analyzer';
...
debug('begin section: PROACTIVE_PREVENTATIVE_RECOMMENDATIONS');
start_section('Proactive and Preventative Recommendations', 'PROACTIVE_PREVENTATIVE_RECOMMENDATIONS');
   set_item_result(check_rec_patches_1); /* Signature CHECK_RECOMMENDED_PATCHES */
   set_item_result(run_stored_sig('ASO_QOT_INVALIDS'));
   set_item_result(run_stored_sig('ENABLED_QUOTING_USER_HOOKS'));
   set_item_result(run_stored_sig('ENABLED_FORMS_CUSTOMIZATIONS'));
   set_item_result(run_stored_sig('EXISTING_FOLDERS_FORMS'));
   set_item_result(run_stored_sig('ORG_ID_QUOTING_PARAMETERS'));
   set_item_result(run_stored_sig('QUOTING_STATS_GATHERED'));
   set_item_result(run_stored_sig('ASO_DEBUG_PROFILES'));
   set_item_result(run_stored_sig('OM_DEBUG_LOG_LOCATION'));
   set_item_result(run_stored_sig('EBS_CRM_SC_GEN_MAX_SEQ'));
end_section;
debug('end section: PROACTIVE_PREVENTATIVE_RECOMMENDATIONS');

debug('begin section: SETUP_CHECKS');
start_section('Quoting Setup', 'SETUP_CHECKS');
   set_item_result(run_stored_sig('ASO_PROFILE_VALUES'));
   set_item_result(run_stored_sig('ASO_SECURITY_CHECK'));
   set_item_result(run_stored_sig('ASO_QUOTE_STATUSES'));
   set_item_result(run_stored_sig('ASO_QUOTE_STATUS_TRANSITIONS'));
   set_item_result(run_stored_sig('EBS_CRM_SM_QOT_OHD_FAIL'));
end_section;
debug('end section: SETUP_CHECKS');

debug('begin section: INTERMEDIA_SETUP');
start_section('Intermedia Setup', 'INTERMEDIA_SETUP');
   set_item_result(run_stored_sig('INTERMEDIA_PROFILES_SETUP'));
   set_item_result(run_stored_sig('OM_SYNONYMS_PRESENT'));
   set_item_result(run_stored_sig('AVAILABLE_CATEGORY_SETS'));
   set_item_result(run_stored_sig('INVENTORY_OPERATING_UNITS'));
   set_item_result(run_stored_sig('INTERMEDIA_TABLE_ORG_ID'));
   set_item_result(run_stored_sig('LANGUAGES_INTERMEDIA_TABLE'));
   set_item_result(run_stored_sig('DISTINCT_CATEGORY_SETS_INTERMEDIA'));
   set_item_result(run_stored_sig('WEB_STATUS_INTERMEDIA_TABLE'));
   IF g_sql_tokens('##$$ITEM_DESCRIPTION$$##') IS NOT NULL THEN
      set_item_result(run_stored_sig('INV_ITEM_DETAILS'));
      set_item_result(run_stored_sig('ITEM_DETAILS_INTERMEDIA_TABLE'));
   END IF;
end_section;
debug('end section: INTERMEDIA_SETUP');

debug('begin section: QUOTE_DATA_SNAPSHOT');
IF g_sql_tokens('##$$QUOTE_NUMBER$$##') IS NOT NULL THEN
   start_section('Quote Data Snapshot '||g_quote_number||'', 'QUOTE_DATA_SNAPSHOT');
      set_item_result(run_stored_sig('ASO_QUOTE_HEADERS_ALL'));
      set_item_result(run_stored_sig('ASO_QUOTE_LINES_ALL'));
      set_item_result(run_stored_sig('ASO_QUOTE_LINE_DETAILS'));
      set_item_result(run_stored_sig('ASO_PRICE_ADJUSTMENTS'));
      set_item_result(run_stored_sig('ASO_APR_OBJ_APPROVALS'));
      set_item_result(run_stored_sig('ASO_APR_APPROVAL_DETAILS'));
      set_item_result(run_stored_sig('ASO_PAYMENTS'));
      set_item_result(run_stored_sig('ASO_QUOTE_ACCESSES'));
      set_item_result(run_stored_sig('ASO_SALES_CREDITS'));
      set_item_result(run_stored_sig('ASO_SHIPMENTS'));
      set_item_result(run_stored_sig('ASO_TAX_DETAILS'));
   end_section;
END IF;
debug('end section: QUOTE_DATA_SNAPSHOT');

debug('begin section: ORDER_FEEDBACK_QUEUE');
start_section('Order Feedback Queue', 'ORDER_FEEDBACK_QUEUE');
   set_item_result(run_stored_sig('ORDER_FEEDBACK_QUEUE_VIEW'));
   set_item_result(run_stored_sig('ORDER_FEEDBACK_LOOKUP'));
   set_item_result(run_stored_sig('ORDER_FEEDBACK_QUEUE_CONTENT'));
   set_item_result(run_stored_sig('TRADE_MANAGEMENT_COUNT_OF_RECORDS'));
end_section;
debug('end section: ORDER_FEEDBACK_QUEUE');

debug('begin section: ASO_DEFAULTING_RULES_SETUP');
start_section('ASO Defaulting Rules Setup', 'ASO_DEFAULTING_RULES_SETUP');
   set_item_result(run_stored_sig('DEFAULTING_RULES_CONDITIONS'));
   set_item_result(run_stored_sig('ASO_DEFAULTING_RULES'));
end_section;
debug('end section: ASO_DEFAULTING_RULES_SETUP');

debug('begin section: ASO_APPROVALS_SETUP');
start_section('ASO Approvals Setup ', 'ASO_APPROVALS_SETUP');
   set_item_result(run_stored_sig('QUOTES_STUCK_PENDING_APPR'));
   ...
   set_item_result(run_stored_sig('RULE_ACTIONS'));
   ...
   set_item_result(run_stored_sig('RULE_CONDITIONS'));
   set_item_result(run_stored_sig('ACTIONS'));
   set_item_result(run_stored_sig('GROUP ITEMS'));
   set_item_result(run_stored_sig('ATTRIBUTES'));
end_section;
debug('end section: ASO_APPROVALS_SETUP');
