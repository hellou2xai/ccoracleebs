...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Install Base Analyzer                  |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE ib_analyzer_pkg AUTHID DEFINER AS
...
CREATE OR REPLACE PACKAGE BODY ib_analyzer_pkg AS
-- $Id: ib_txnerr_analyzer.sql, 200.52 2026/01/28 18:06:28 svedula Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(1597450.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'IB_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'IB_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>IB Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=1597450.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/iba_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,264,EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,264,EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},264,EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/3525587" class="blacklink" target="new">
...
<div class="ck-content"><div><p><strong>Version 200.52</strong></p><ul><li>Signature PREMIER_SUPPORT signatures updated</li>
...
<p>&nbsp;</p><p><strong>Version 200.51</strong></p><ul><li>Signature AC_TABLE_INDEXES has been updated</li>
<li>Signature EBS_ATG_UGLE_SEQUENCES_CLOSE_TO_MAXIMUM_VALUE has been updated</li>
</ul>
<p><strong>Version 200.36</strong></p><ul><li>Added signature &apos;Inactive BILL TO and SHIP TO sites&apos;</li>
</ul>
<p><strong>Version 200.35</strong></p><ul><li>Signature updates</li>
</ul>
<p>&nbsp;</p><p><strong>Version 200.34</strong></p><ul><li>Added a new signature EBS_CRM_SC_IB_INTGR_FIX_PRG</li>
</ul>
<p><strong>Version 200.33</strong></p><ul><li>Signature updates<br>
Modified Signature EBS_CRM_SC_IB_SFM_QUEUE_BYPASS_FLAG to use double quote instead of single quote in the fail condition.</li>
</ul>
<p>&nbsp;</p><p><strong>Version 200.32</strong></p><ul><li>Added signature&nbsp;<span class="display_only apex-item-display-only" id="P18_TITLE_DISPLAY">SFM_QUEUE_BYPASS_FLAG</span></li>
</ul>
<p>&nbsp;</p><p><strong>Version 200.31</strong></p><ul><li>Added a new signature: Sequences Reaching Maximum Value</li>
<li>Added Signature&nbsp;<span class="display_only apex-item-display-only" id="P18_TITLE_DISPLAY">WIP Issued Component Instances Not Found... Due to REQUIRED_QUANTITY Not Equaling the QUANTITY_ISSUED</span></li>
</ul>
<p><strong>Version 200.30</strong></p><ul><li>Included section Diagnostics: Apps Check</li>
</ul>
<p><strong>Version 200.29</strong>:</p><ul><li>New Analyzer Framework version 4.6.0.1 released with bug fixes.</li>
</ul>
<p><strong>Version 200.28</strong>: (supersedes prior versions)</p><ul><li>Performance issue fixed during runtime. Offending Signature &apos;<strong>SFM Missing Messages</strong>&apos; fixed, to limit number of rows returned.</li>
</ul>
<p><strong>Version 200.27</strong>: (supersedes prior versions)</p><ul><li>Performance issue fixed during runtime. Offending Signature &apos;<strong>Instances with Items that are no Longer IB Trackable</strong>&apos; removed for now.</li>
</ul>
<p><strong>Version 200.26</strong>:</p><ul><li>Lifetime Support Policy: Premier Support for R12.1.3 customers updated.</li>
</ul>
<p><strong>Version 200.25</strong>:</p><ol><li>Lifetime Support Policy</li>
<li>New Analyzer Framework version 4.5.7 released with these changes:</li>
</ol>
<ul><li>Summary of signatures that failed at the end of the log</li>
<li>Signature Version Reported in Analyzer Output</li>
<li>Remove unnecessary icons for signatures with no data</li>
<li>Fixed DB Name character string buffer too small</li>
</ul>
<p><strong>Version 200.24</strong>:</p><p>1. We have the following framework changes:</p><ul><li>Trim script and anchor URLs</li>
<li>Floating table header is now visible after sorting</li>
<li>Table header widths have been fixed</li>
<li>The DX summary now uses text for full result data</li>
<li>Restored the host to Execution Details</li>
<li>The Data Masking feature has been expanded.&nbsp;&nbsp;&nbsp;<ul><li>Select data is now pre-masked at the point of collection.</li>
<li>The masked information displayed will be just enough to permit effective review and troubleshooting of an issue.&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp; Example:&nbsp; A credit card number <strong>would</strong> be displayed as ****-****-****-1234&nbsp;<br>
&nbsp;&nbsp;<span style="font-family:Calibri;font-size:11.0pt;"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; An employee name would be displayed as D</span><span style="font-family:&apos;Segoe UI&apos;;font-size:10.5pt;">isplay first and last 25% per word (J**n S**w = John Snow)</span></li>
<li>The existing “Lock Icon” still provides customers the manual column scrambling capabilities, which can be used <strong>in addition to</strong> the newly introduced pre-masked data feature.&nbsp;</li>
</ul>
</li>
</ul>
<p>2. This version of the Install Base analyzer has the following changes:</p><ul><li>The analyzer is now executed as a Package instead of an Anonymous Block. Please see the instructions in Doc ID 2048039.1 for running the analyzer from Sql*Plus and from Concurrent Manager as a Concurrent Program.</li>
<li>Added a new section that contains signatures that will indicate the support policy associated with the instance the analyzer was generated on.</li>
<li>Signature was modified.</li>
</ul>
</div>
</div>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,264,'||p_sig.sigrepo_id||',EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,264,'||p_sig.sigrepo_id||',EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
...
FUNCTION check_rec_patches_1 RETURN VARCHAR2 IS
  /* Signature CHECK_IB_REC_PATCHES */
...
BEGIN
    ...
    print_log('Processing recommended patches signature: CHECK_IB_REC_PATCHES (check_rec_patches_1) "Recommended Patches" (version 15)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(1)(l_rows) := '23295519';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'ADDED NEW PROFILES FOR LAM IN CSI';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33607582';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'ORACLE INSTALLED BASE RECOMMENDED PATCH COLLECTION (NOV 2021)';
   l_col_rows(5)(l_rows) := '[2826786.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '34989850';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'RMA RECEIPT IS NOT INTERFACED TO INSTALL BASE';
   l_col_rows(5)(l_rows) := '[2937680.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21664603';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'ORACLE INSTALLED BASE RECOMMENDED PATCH COLLECTION (AUG 2015)';
   l_col_rows(5)(l_rows) := '[1606646.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '17479412';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Latest Recommended Patch Collection for Oracle Asset Tracking';
   l_col_rows(5)(l_rows) := '[1606649.1]';

END IF;

   l_extra_info('##SHOW_SQL##'):= 'Y';

   l_sig.sigrepo_id := '692';
   l_sig.title := 'Recommended Patches';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := 'There are development recommended '||g_rep_info('Apps Version')||' Installed Base patches that are not applied '||'on this instance.
';
...
';
   l_sig.success_msg := '<b>These are the development recommended patches for Install Base.</br>
...
';
  ...
  -- Register
  l_step := '60';
  g_signatures('CHECK_IB_REC_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'CHECK_IB_REC_PATCHES',     -- sig ID
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Material Transaction ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_mtl_txn_id,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/01/28 18:06:27 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'ib_txnerr_analyzer.sql';
...
debug('begin parameter validation: p_mtl_txn_id');
IF p_mtl_txn_id IS NOT NULL THEN
BEGIN
SELECT INV_MATERIAL_TRANSACTION_ID
INTO l_exists_val
FROM CSI_TXN_ERRORS, HR_OPERATING_UNITS O
WHERE INV_MATERIAL_TRANSACTION_ID = p_mtl_txn_id
 AND (mo_global.is_mo_init_done = 'N' or mo_global.check_access(o.organization_id) = 'Y')
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: The Material_Transaction_ID entered is not valid.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_mtl_txn_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_mtl_txn_id');
...
-- Subba added on 1st Mar 2024
select application_short_name
into g_app_name
from fnd_application_vl 
where application_id = 542;

SELECT COUNT(msi.serial_number_control_code) into l_sncc_cnt
FROM csi_txn_errors cte, mtl_material_transactions mmt, mtl_system_items_b msi
WHERE cte.processed_flag in ('R','E')
AND cte.inv_material_transaction_id = mmt.transaction_id
AND mmt.inventory_item_id = msi.inventory_item_id
AND mmt.organization_id = msi.organization_id
AND msi.serial_number_control_code in (1, 6);

SELECT count(distinct cte.TRANSACTION_ERROR_ID) into l_cmcc_cnt
FROM   mtl_system_items_b mtl, 
       csi_txn_errors cte
WHERE cte.SRC_SERIAL_NUM_CTRL_CODE = mtl.serial_number_control_code
and cte.error_text LIKE 'Instance Cannot be marked as Creation Complete%'
AND processed_flag in ('E', 'R');

SELECT count(*) into l_stcoc_cnt
FROM csi_txn_errors
WHERE processed_flag in ('E', 'R')
AND error_text like 'Either sub type has change owner code%'
AND source_type like 'CSISOSHP';

SELECT count(*) into l_ntts_cnt
FROM csi_txn_errors cte
WHERE cte.processed_flag in ('E', 'R')
AND cte.inv_material_transaction_id IS NOT NULL
AND (cte.source_type is null or cte.transaction_type_id is null);

Select count(*) into l_maif_cnt
from csi_txn_errors
where error_text like 'Multiple active instances found for the item attributes provided%'
and src_serial_num_ctrl_code <> 5;

SELECT  count(*) into l_rrarf_cnt
FROM csi_txn_errors cte
WHERE cte.processed_flag IN ('E', 'R')
AND ((cte.transaction_type_id = 53
AND inv_material_transaction_id IN (SELECT mmt.transaction_id
FROM mtl_material_transactions mmt, mtl_system_items msi
WHERE mmt.inventory_item_id = msi.inventory_item_id
AND mmt.organization_id = msi.organization_id
AND msi.serial_number_control_code = 1))
OR cte.transaction_type_Id = 54);

SELECT count(*) into l_diez_cnt
FROM csi_txn_errors
WHERE processed_flag in ('E', 'R')
AND error_text like '%ORA-01476%divisor is equal%';
...
BEGIN
  ...
  SELECT mmt.transaction_type_id,
   ...
   IF g_transaction_type_id in (33, 15) THEN

      g_line_id := l_trx_source_line_id; 

      SELECT header_id
        INTO g_header_id
        FROM oe_order_lines_all
       WHERE line_id = l_trx_source_line_id;

         debug('line id: '||g_line_id);
         debug('header id: '||g_header_id);
      
      BEGIN

         SELECT sub_type_id
           INTO g_sub_type_id
           FROM csi_t_transaction_lines cttl,
                csi_t_txn_line_details cttld
          WHERE cttl.source_transaction_id = l_trx_source_line_id
            AND cttl.transaction_line_id = cttld.transaction_line_id
            AND cttl.source_transaction_table = 'OE_ORDER_LINES_ALL'
            AND rownum = 1;

      
        debug('sub type id: '||g_sub_type_id);
    ...
    ELSIF g_transaction_type_id in (35, 44, 43) THEN

     g_header_id := l_transaction_source_id;
...
EXCEPTION
     ...
     WHEN no_data_found THEN
       ...
       debug('Invalid material transaction ID is entered');


END;

g_instance := l_instance; 
g_sncc_cnt := l_sncc_cnt;
g_cmcc_cnt := l_cmcc_cnt;
g_stcoc_cnt := l_stcoc_cnt;
g_ntts_cnt := l_ntts_cnt;
g_maif_cnt := l_maif_cnt;
g_rrarf_cnt := l_rrarf_cnt;
g_diez_cnt := l_diez_cnt;
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$MTLTXNID$$##') := p_mtl_txn_id;
   g_masked_tokens('##$$MTLTXNID$$##') := mask_text( g_sql_tokens('##$$MTLTXNID$$##'), 'NO_MASK');
   g_sql_tokens('##$$LINEID$$##') := g_line_id;
   g_masked_tokens('##$$LINEID$$##') := mask_text( g_sql_tokens('##$$LINEID$$##'), 'NO_MASK');
   g_sql_tokens('##$$HEADERID$$##') := g_header_id;
   g_masked_tokens('##$$HEADERID$$##') := mask_text( g_sql_tokens('##$$HEADERID$$##'), 'NO_MASK');
   g_sql_tokens('##$$SUBTYPEID$$##') := g_sub_type_id;
   g_masked_tokens('##$$SUBTYPEID$$##') := mask_text( g_sql_tokens('##$$SUBTYPEID$$##'), 'NO_MASK');
...
debug('begin add_signature: IB_INVALIDS');
   l_info('##MASK##TEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '691',
      p_sig_id                 => 'IB_INVALIDS',
    ...
    AND a.owner = ''APPS''
    AND a.object_name like ''CSI%''
    AND a.status = ''INVALID''',
      p_title                  => 'Install Base Related Invalid Objects',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are Installed Base Invalid objects.
',
...
<li>If you still have invalid objects, please review steps from [1325394/KB401905] Troubleshooting Guide - Invalid Objects in the E-Business Suite Environment 11i and 12</li>
      ...
      p_success_msg            => 'No Install Base related invalid objects exists in the database.',
   ...
   l_info.delete;
debug('end add_signature: IB_INVALIDS');



debug('begin add_signature: LOG_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '693',
      p_sig_id                 => 'LOG_CHECK',
      p_sig_sql                => 'SELECT fpovl.user_profile_option_name "Profile Option Name", decode(fpov.level_id, 10001, ''Site'', 10002, ''Application'' , 10003, ''Responsibility'', 10004, ''User'') "Profile Level",
       ((SELECT responsibility_name 
         ...
         UNION (SELECT user_name 
	        ...
	        AND fpovl.profile_option_name in (''CSI_DEBUG_LEVEL'', ''CSE_DEBUG_OPTION'',''CSI_LOGFILE_PATH'',''CSI_LOGFILE_NAME'')
ORDER BY  fpovl.profile_option_name, fpov.level_id',
      p_title                  => 'CSI Log Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'If the CSI: Debug Level profile option value is greater than ''0'' at any of the Profile Levels and if the value of CSE: Debug Option is set to ''Y'' then debugging is turned on. ',
      p_solution               => 'Ensure Debugging is turned off unless needed. Leaving debugging on could effect system performance. Refer to [239627/KB598838] for more detailed instructions on using CSI debugging.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: LOG_CHECK');



debug('begin add_signature: ERR_CORRECT_SCH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '694',
      p_sig_id                 => 'ERR_CORRECT_SCH',
      p_sig_sql                => 'select ''Y''
...
and a.hold_flag = ''N'' 
and b.user_concurrent_program_name = ''Install Base Error Correction and Synchronization Program'' 
and (select count(*) 
     from csi_transactions 
     where Transaction_Type_id = 8) > 0) a
where a.count > 0',
      p_title                  => 'Error Correction and Synchronization Program Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The Install Base Error Correction and Synchronization Program is scheduled to run in the future.
The Install Base Error Correction and Synchronization Program should be run only if suggested by Oracle after the review of an error backlog.',
      p_solution               => 'Please ensure this program is NOT scheduled to run on a regular basis as it may cause data corruption in the Install Base.  See [734933/KB682430] for more information.',
      p_success_msg            => 'The Install Base Error Correction and Synchronization Program is not scheduled to run.  Note: The Install Base Error Correction and Synchronization Program should be run only if suggested by Oracle after the review of an error backlog. See [734933/KB682430] for more information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ERR_CORRECT_SCH');



debug('begin add_signature: EBS_CRM_SC_IB_INTGR_FIX_PRG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29634',
      p_sig_id                 => 'EBS_CRM_SC_IB_INTGR_FIX_PRG',
      p_sig_sql                => 'select 
CASE WHEN count(*)>=1 THEN ''Program was submitted.''
     ELSE ''Program is not submitted.'' 
END AS STATUS
from fnd_concurrent_requests a,
fnd_concurrent_programs_tl b 
where status_code in (''Q'',''I'',''R'',''X'',''E'')
and phase_code in(''R'',''C'',''P'') 
and a.concurrent_program_id = b.concurrent_program_id 
and a.hold_flag = ''N''
and b.user_concurrent_program_name in(''Integration Fix - Non Serial or Serial at Sales Order Issue'', ''Integration Fix - IB Error Transaction'')',
      p_title                  => 'Integration Fix - IB Error Transaction Program Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Integration Fix - IB Error Transaction Program being run or is scheduled to run in the future.
Please hold running the Program Integration Fix - IB Error Transaction till the time we come up with new verison and update you.',
      p_solution               => 'Please ensure this program is NOT run or scheduled to run.',
      p_success_msg            => 'Integration Fix - IB Error Transaction Program is not being run or scheduled to run. Please hold running the Program Integration Fix - IB Error Transaction till the time we come up with new verison and update you.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_IB_INTGR_FIX_PRG');



debug('begin add_signature: SFM_THREAD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '695',
      p_sig_id                 => 'SFM_THREAD',
      p_sig_sql                => 'SELECT SUBSTR(service_parameters, INSTR(service_parameters, ''XDP_DQ_INIT_NUM_THREADS'')) Value
FROM fnd_concurrent_queues
WHERE concurrent_queue_name = ''XDP_Q_EVENT_SVC''',
      p_title                  => 'SFM Thread Parameter',
      p_fail_condition         => '[Value]<>[XDP_DQ_INIT_NUM_THREADS=1]',
      p_problem_descr          => 'The SFM Event Manager Queue Service manager is not set up correctly. This can result in data corruption.',
      p_solution               => 'The XDP_DQ_INIT_NUM_THREADS need to be changed.<br>
Review to the following documents for more information:<br>
[1243716/KB428850] Shipment CSISOSHP Error: Insert_row failed ORA-00001: unique constraint 
(CSI.CSI_T_TRANSACTION_LINES_U02)violated
[1528132/KB664925] Understand SFM Managers and How Oracle Installed Base Uses SFM Event Manager Queue Service',
   ...
   l_info.delete;
debug('end add_signature: SFM_THREAD');



debug('begin add_signature: EVENT_QUEUE_PROCESSED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '697',
      p_sig_id                 => 'EVENT_QUEUE_PROCESSED',
      p_sig_sql                => 'SELECT count(*) Processed
FROM xnp_msgs
WHERE msg_status = ''PROCESSED''',
      p_title                  => 'SFM Processed Messages',
      p_fail_condition         => '[Processed] > [10000]',
      p_problem_descr          => 'You have a large number of processed messages in the XNP table. This may affect interface performance to Install Base.',
      p_solution               => 'Consider running the XDP purge program to increase system performance. Refer to SFM Performance [1528132/KB664925#PERFORMANCE] for instructions.',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: EVENT_QUEUE_PROCESSED');



debug('begin add_signature: EVENT_QUEUE_READY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '701',
      p_sig_id                 => 'EVENT_QUEUE_READY',
      p_sig_sql                => 'SELECT count(*) Ready 
FROM xnp_msgs 
WHERE msg_status = ''READY''
',
      p_title                  => 'SFM Waiting Messages',
      p_fail_condition         => '[Ready] > [100]',
      p_problem_descr          => 'You have a large number of waiting messages in the XNP table. This could indicate an interface performance problem.',
      p_solution               => 'Please monitor your SFM performance. Refer to SFM performance [1528132/KB664925] for instructions.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EVENT_QUEUE_READY');



debug('begin add_signature: EVENT_QUEUE_FAILED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '702',
      p_sig_id                 => 'EVENT_QUEUE_FAILED',
      p_sig_sql                => 'select msg_id, msg_code, send_rcv_date, msg_status, SUBSTR(description, 1, 100)description
from xnp_msgs 
where msg_status = ''FAILED''',
      p_title                  => 'SFM Failed Messages',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'You have failed messages in the XNP table. This will prevent corresponding transactions from updating Install Base.',
      p_solution               => 'Please refer to [361568/KB474568] for instructions on how to resubmit failed messages.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EVENT_QUEUE_FAILED');



debug('begin add_signature: TRANSACTIONS_NOT_INTERFACED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '703',
      p_sig_id                 => 'TRANSACTIONS_NOT_INTERFACED',
      p_sig_sql                => 'SELECT mtt.transaction_type_name, mmt.transaction_type_id,  count(*)
  FROM mtl_material_transactions mmt,
       mtl_transaction_types mtt,
       mtl_system_items_b msi,
       csi_install_parameters cip
 WHERE msi.inventory_item_id = mmt.inventory_item_id
   AND msi.organization_id = mmt.organization_id
   AND mmt.creation_date > cip.freeze_date
   AND NVL (msi.comms_nl_trackable_flag, ''N'')= ''Y''
   AND mmt.transaction_type_id = mtt.transaction_type_id
   AND NOT EXISTS(SELECT ''X'' FROM csi_txn_errors cte2 
                   WHERE cte2.inv_material_transaction_id = mmt.transaction_id)
   AND NOT EXISTS(SELECT ''X'' FROM csi_transactions ct
                   WHERE ct.inv_material_transaction_id = mmt.transaction_id)
   AND(mmt.transaction_type_id not in (80, 24, 25, 26,  93, 94, 50, 51,52,53, 64, 2, 5, 9, 10008) 
        OR (mmt.transaction_type_id in (50, 51,52,53, 64, 2, 5, 9) and mmt.transaction_quantity > 0))
   AND exists (SELECT ''X'' FROM csi_txn_errors cte WHERE cte.inventory_item_id = mmt.inventory_item_id)
AND ROWNUM < 2001
  group by mtt.transaction_type_name, mmt.transaction_type_id',
      p_title                  => 'SFM Missing Messages',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'You have transaction messages that are missing from the Event queue. This will cause Install Base to be out of sync with Inventory.',
      p_solution               => 'Please refer to [1630893/KB515336] for instructions on how to resubmit these Inventory transactions into the Event queue for processing.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: TRANSACTIONS_NOT_INTERFACED');
...
debug('begin add_signature: INSTALL_PARAMETERS_12.1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5952',
      p_sig_id                 => 'INSTALL_PARAMETERS_12.1',
      p_sig_sql                => 'SELECT internal_party_id, 
                                          freeze_flag,
                                          freeze_date,
      ...
      p_title                  => 'Install Parameter',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Installed Base Install Parameters setup is a required setup in order to use the Oracle Installed Base product.',
      p_solution               => 'Please see [842400/KB218924] for guidance on how to set up Oracle Installed Base parameters',
      p_success_msg            => '<ul>
<li>Oracle Installed Base includes a set of customer-specific installation parameters defined in a table at setup time. Use [842400/KB218924] to define them.</li>
<li>After you define the parameters and select the Freeze check box, the fields cannot be updated.</li>
</ul>',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: INSTALL_PARAMETERS_12.1');



debug('begin add_signature: CSI_PROFILE_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6262',
      p_sig_id                 => 'CSI_PROFILE_OPTIONS',
      p_sig_sql                => 'SELECT n.user_profile_option_name,
       ...
       Decode(To_char(pov.level_id), ''10001'', ''Site'',
                                     ''10002'',
       Nvl(app.application_short_name, To_char(pov.level_value)),
                                     ''10003'', Nvl(rsp.responsibility_name,
                                              To_char(pov.level_value)),
                                     ''10005'', svr.node_name,
                                     ''10006'', org.name,
...
WHERE  ( po.profile_option_name LIKE ''CSI%''
          OR po.profile_option_name LIKE ''CSI%'' )
...
ORDER  BY 2,3',
   ...
   l_info.delete;
debug('end add_signature: CSI_PROFILE_OPTIONS');



debug('begin add_signature: INCONSISTENT_LOT_CONTROL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '826',
      p_sig_id                 => 'INCONSISTENT_LOT_CONTROL',
      p_sig_sql                => 'SELECT DISTINCT
    msi1.segment1                                            "Item Name",
     msi1.inventory_item_id,
    msi1.organization_id                                     "Organization Id",
    nvl(ood.organization_name, ''No Organization Name found'') "Organization Name"
FROM
    mtl_system_items_b           msi1,
    org_organization_definitions ood,
    mtl_material_transactions mmt
WHERE
    mmt.transaction_id = ##$$MTLTXNID$$##
    and mmt.INVENTORY_ITEM_ID = msi1.INVENTORY_ITEM_ID
    and mmt.ORGANIZATION_ID = msi1.ORGANIZATION_ID
    and nvl(msi1.comms_nl_trackable_flag, ''N'') = ''Y''
    AND msi1.lot_control_code = 2
    and msi1.enabled_flag = ''Y''
    and msi1.end_date_active is null
    ...
    AND EXISTS (
        ...
        WHERE
                msi2.inventory_item_id = msi1.inventory_item_id
            AND msi2.organization_id <> msi1.organization_id
            AND msi2.lot_control_code = 1
            AND nvl(msi2.comms_nl_trackable_flag, ''N'') = ''Y''
            and msi1.enabled_flag = msi1.enabled_flag
            and msi1.end_date_active is null
    )',
      p_title                  => 'Items With Inconsistent Lot Control',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'You have items in the system where the lot control is set up differently among inventory organizations. Earlier 11i and R12 code validation did not support a mixture of lot control settings for the same item across different organizations.',
      p_solution               => 'Please refer to [1455357/KB266214] for guidance on patches you should apply to avoid these validation errors.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: INCONSISTENT_LOT_CONTROL');



debug('begin add_signature: INCONSISTENT_REVISION_CONTROL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '827',
      p_sig_id                 => 'INCONSISTENT_REVISION_CONTROL',
      p_sig_sql                => 'SELECT DISTINCT msi1.segment1 "Item Name", msi1.organization_id "Organization Id", nvl(ood.organization_name, ''No Organization Name found'') "Organization Name"
FROM mtl_system_items_b msi1, mtl_onhand_items_v moi, org_organization_definitions ood
WHERE NVL(msi1.comms_nl_trackable_flag , ''N'') = ''Y''
...
AND EXISTS
          (SELECT ''X''
           ...
           AND msi2.organization_id <> msi1.organization_id
           AND msi2.revision_qty_control_code = 1)',
      p_title                  => 'Items With Inconsistent Revision Control',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'You have items in the system where the revision control item attribute is set up differently among inventory organizations.<br>
Earlier R12 code validation did not support a mixture of Revision control settings for the same item across different organizations.<br>
This may cause error transactions when the item is transferred across control and non-control organizations.',
      p_solution               => 'To avoid these validation errors please refer to [2134474/KB613053] Internal Sales Order Receipt Transaction Error When Transfer Item from a Revision Control to a Non-Revision Control.<br>
This note will provide guidance on patches you should apply so that mixed Revision control setup can be supported by Installed Base.
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: INCONSISTENT_REVISION_CONTROL');



debug('begin add_signature: INSTALL_PARAMETERS_12.2');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6326',
      p_sig_id                 => 'INSTALL_PARAMETERS_12.2',
      p_sig_sql                => 'SELECT internal_party_id, 
                                          freeze_flag,
                                          freeze_date,
                                          show_all_party_location,
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Installed Base Install Parameters setup is a required setup in order to use the Oracle Installed Base product.',
      p_solution               => 'Please see the Installed Base Installation Guide for your product version in section ''Set Up Installation Parameters''for Install Parameter setup instructions.

Review Doc ID 842400.1 - How to Set Up Installed Base Install Parameters for more information.',
      p_success_msg            => 'Oracle Installed Base includes a set of customer-specific installation parameters defined in a table at setup time. Use the Install Parameters page (Oracle Installed Base Administrator > Setups > Install Parameters) to define them. After you define the parameters and select the Freeze check box, the fields cannot be updated.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: INSTALL_PARAMETERS_12.2');



debug('begin add_signature: INCONSISTENT_REVISION_CONTROL_12_2_5');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10011',
      p_sig_id                 => 'INCONSISTENT_REVISION_CONTROL_12_2_5',
      p_sig_sql                => 'SELECT DISTINCT msi1.segment1 "Item Name", msi1.organization_id "Organization Id", nvl(ood.organization_name, ''No Organization Name found'') "Organization Name"
FROM mtl_system_items_b msi1, mtl_onhand_items_v moi, org_organization_definitions ood
WHERE NVL(msi1.comms_nl_trackable_flag , ''N'') = ''Y''
AND revision_qty_control_code = 2
...
Earlier R12 code validation did not support a mixture of Revision control settings for the same item across different organizations.<br>
This may cause error transactions when the item is transferred across control and non-control organizations.',
      p_solution               => 'To avoid these errors please refer to [2298971/KB456821] Internal requisition and internal sales order from a revision controlled org to non revision controlled org not interfaced.<br>

This note will provide guidance on patches you should apply so that Internal requisition and Internal sales orders from a revision controlled org to non revision controlled org will be supported.
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: INCONSISTENT_REVISION_CONTROL_12_2_5');



debug('begin add_signature: ERROR_COUNTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '831',
      p_sig_id                 => 'ERROR_COUNTS',
      p_sig_sql                => 'SELECT (SELECT count(*)
        FROM csi_txn_errors
        WHERE processed_flag in (''E'', ''R'')) "Total Error Count",
       (SELECT to_char(round(sysdate-(min(creation_date)),0))||''Days''
        FROM csi_txn_errors
        WHERE processed_flag in (''E'', ''R'')) "Oldest Unprocessed Error",
       (SELECT max(creation_date)
        FROM csi_txn_errors
        WHERE processed_flag in (''E'', ''R'')) "Latest Unprocessed Error",
       (SELECT count(*) 
        FROM csi_txn_errors cte, mtl_material_transactions mmt, mtl_system_items_b msi
        WHERE cte.processed_flag in (''E'', ''R'')
        AND cte.inv_material_transaction_id = mmt.transaction_id
        AND mmt.inventory_item_id = msi.inventory_item_id
        AND mmt.organization_id = msi.organization_id
        AND msi.serial_number_control_code in (2, 5)) "Total Serial Errors",
       (SELECT count(*)                                                                  
        FROM csi_txn_errors cte, mtl_material_transactions mmt, mtl_system_items_b msi
        WHERE cte.processed_flag in (''E'', ''R'')
        AND cte.inv_material_transaction_id = mmt.transaction_id
        AND mmt.inventory_item_id = msi.inventory_item_id
        AND mmt.organization_id = msi.organization_id
        AND msi.serial_number_control_code in (1, 6))"Total Non-Serial Errors"
FROM DUAL',
      p_title                  => 'Error Count Summary',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This summary of errors reflect transactions that have failed to update the Install Base and if not corrected results in   out of sync and incorrect data records. Please review below for more details.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: ERROR_COUNTS');



debug('begin add_signature: TOP_ITEM_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '836',
      p_sig_id                 => 'TOP_ITEM_ERRORS',
      p_sig_sql                => 'SELECT msi.segment1 "Item Number", msi.INVENTORY_ITEM_ID "Inventory Item ID", mmt.ORGANIZATION_ID "Organization ID",
								DECODE
                (msi.SERIAL_NUMBER_CONTROL_CODE,
                1, ''No Control'',
                2, ''Predefined'',
                5, ''At Receipt'',
                6, ''At Sales Order Issue'') "Serial Number Control Code",
								DECODE
                (msi.LOT_CONTROL_CODE,
                1, ''No Control'',
                2, ''Full Control'') "Lot Control Code",
								DECODE
                (msi.REVISION_QTY_CONTROL_CODE,
                1, ''No Control'', 
                2,''Controlled'') "Revision Quatity Contol Code",
count(*) "Error Count"
FROM mtl_material_transactions mmt, csi_txn_errors cte, mtl_system_items_b msi
WHERE mmt.transaction_id = cte.inv_material_transaction_id
AND mmt.inventory_item_id = msi.inventory_item_id
AND mmt.organization_id = msi.organization_id
AND cte.processed_flag in (''E'', ''R'')
GROUP BY msi.segment1, msi.INVENTORY_ITEM_ID, mmt.ORGANIZATION_ID, SERIAL_NUMBER_CONTROL_CODE, LOT_CONTROL_CODE,REVISION_QTY_CONTROL_CODE
ORDER BY "Error Count" DESC',
      p_title                  => 'Top Items with Most Error Transactions',
      p_fail_condition         => '[Error Count] > [0]',
      p_problem_descr          => 'There are transaction errors in the Install Base interface. The list below is sorted by number of errors per item. You can use Show SQL to see query used in case you want to run for a full listing of errors by item.',
      p_solution               => 'If solutions for the above errors are not provided in the Quick Fix section of this report please see:<br>
[2367965/KB669219] Understand Oracle Installed Base and Trouble Shooting Tools<br>
on how to troubleshoot errors that reside in the Transaction Error Processing Form.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: TOP_ITEM_ERRORS');



debug('begin add_signature: TOP_MOST_ERRORS');
   l_info('##MASK##ERROR_TEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MESSAGE_STRING'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '837',
      p_sig_id                 => 'TOP_MOST_ERRORS',
      p_sig_sql                => 'SELECT nvl(source_type,''No Source Type found'') "Source Type", nvl(substr(error_text, 1, 150),''No Error Text found'') "Error Text", count(*) "Error Count"
FROM csi_txn_errors 
WHERE processed_flag in (''E'', ''R'')
GROUP BY source_type, substr(error_text, 1, 150)
ORDER BY "Error Count" DESC',
      p_title                  => 'Transaction Errors by Source Type',
      p_fail_condition         => '[Errors] > [0]',
      p_problem_descr          => 'If solutions for the above errors are not provided in the Quick Fix section of this report please use the following resources for guidance/solutions on how to troubleshoot errors that reside in the Transaction Error Processing Form:
<ul>
<li><a target="_blank" href="https://support.oracle.com/">My Oracle Support or click on the Log a Service Request link at the bottom of this report</li>
<li><a target="_blank" href="https://community.oracle.com/community/support/oracle_e-business_suite/install_base">Install Base and Asset Tracking - EBS (MOSC) Community 
</ul> 
',
      p_solution               => '',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: TOP_MOST_ERRORS');



debug('begin add_signature: LATER_TXN_PROCESSED');
   l_info('##MASK##SERIAL_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6300',
      p_sig_id                 => 'LATER_TXN_PROCESSED',
      p_sig_sql                => 'SELECT DISTINCT citd.instance_id
FROM (SELECT DISTINCT mut.inventory_item_id ,
                      mut.serial_number ,
                      mmt.transaction_id,
                      mmt.creation_date
                 FROM mtl_material_transactions mmt,
       ...
       UNION
      SELECT DISTINCT mut.inventory_item_id,
                      mut.serial_number,
                      mmt.transaction_id,
                      mmt.creation_date
                 FROM mtl_material_transactions mmt,
                ...
                WHERE cte.processed_flag = ''E''
                  ...
                  AND msi.inventory_item_id = mut.inventory_item_id
                  AND msi.organization_id = mut.organization_id
                  AND msi.serial_number_control_code IN (2, 5)) err_sn,
     csi_inst_txn_details_v citd,
     mtl_material_transactions mmt2,
     csi_inst_txn_details_v citd2,
     mtl_material_transactions mmt1
 WHERE citd.inventory_item_id = err_sn.inventory_item_id
   AND citd.serial_number = err_sn.serial_number
   AND citd.inv_material_transaction_id IS NOT NULL
   AND citd.instance_id = citd2.instance_id
   AND citd2.inv_material_transaction_id = mmt1.transaction_id
   AND citd.inv_material_transaction_id = mmt2.transaction_id
   AND (mmt2.creation_date > err_sn.creation_date
        or (citd.transaction_id > citd2.transaction_id
            and mmt2.creation_date < mmt1.creation_date))',
      p_title                  => 'Error Transactions Caused by Bug 20975273',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Instance '||mask_text(g_instance, nvl( upper(''), 'NO_MASK') )||' is corrupted  due to bug {20975273} which causes follow-up transactions to error.

',
      p_solution               => 'Please refer to [2045353/KB466173] for guidance on patches you should apply. Also consider logging a data fix bug with support to correct the corrupted data.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: LATER_TXN_PROCESSED');



debug('begin add_signature: NULL_TXN_SOURCE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '839',
      p_sig_id                 => 'NULL_TXN_SOURCE',
      p_sig_sql                => 'SELECT inv_material_transaction_id "Material Transaction Id", source_type "Source Type", transaction_type_id "Transaction Type Id", transaction_error_date "Transaction Error Date"
FROM csi_txn_errors cte
WHERE cte.processed_flag in (''E'', ''R'')
AND cte.inv_material_transaction_id IS NOT NULL
AND (cte.source_type is null or cte.transaction_type_id is null)
order by transaction_error_date',
      p_title                  => ''||mask_text(g_ntts_cnt, nvl( upper(''), 'NO_MASK') )||' Errors With Null for Transaction Types and Source Types Found',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are '||mask_text(g_ntts_cnt, nvl( upper(''), 'NO_MASK') )||' error transactions with null transaction and/or source types.',
      p_solution               => 'See data fix solution provided in [1437601/KB240253]. ',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: NULL_TXN_SOURCE');



debug('begin add_signature: MULTI_ACTIVE_INST_FOUND');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '841',
      p_sig_id                 => 'MULTI_ACTIVE_INST_FOUND',
      p_sig_sql                => 'Select cte.source_type, count(*)
from csi_txn_errors cte,
     mtl_material_transactions mmt,
     mtl_system_items_b msi
where cte.error_text like ''Multiple active instances found for the item attributes provided%''
and mmt.transaction_id = cte.inv_material_transaction_id
and mmt.inventory_item_id = msi.inventory_item_id
and mmt.organization_id = msi.organization_id
and msi.serial_number_control_code in (6, 1)
group by cte.source_type',
      p_title                  => ''||mask_text(g_maif_cnt, nvl( upper(''), 'NO_MASK') )||' Multiple Active Instances Found for the Item Attributes Provided Errors Found',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are '||mask_text(g_maif_cnt, nvl( upper(''), 'NO_MASK') )||' errors indicating multiple active instances with the same item attributes.  Error message is "Multiple active instances found for the item attributes provided"',
      p_solution               => 'For troubleshooting and solution for these errors see [1495209/KB298736].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: MULTI_ACTIVE_INST_FOUND');



debug('begin add_signature: RMA_NON_SERIAL_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '842',
      p_sig_id                 => 'RMA_NON_SERIAL_ERRORS',
      p_sig_sql                => 'SELECT source_type "Transaction Source Type", count (source_type) Count
FROM csi_txn_errors cte
WHERE cte.processed_flag IN (''E'', ''R'')
AND ((cte.transaction_type_id = 53 
AND inv_material_transaction_id IN (SELECT mmt.transaction_id 
...
OR cte.transaction_type_Id = 54)
group by cte.source_type',
      p_title                  => ''||mask_text(g_rrarf_cnt, nvl( upper(''), 'NO_MASK') )||' Non-serialized Errors for RMAs Errors Found',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are '||mask_text(g_rrarf_cnt, nvl( upper(''), 'NO_MASK') )||' RMA receipt and RMA fulfillment transaction errors for non-serialized items.',
      p_solution               => 'See solution provided in [390035/KB421204].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: RMA_NON_SERIAL_ERRORS');



debug('begin add_signature: INST_CANNOT_BE_MARKED_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '843',
      p_sig_id                 => 'INST_CANNOT_BE_MARKED_ERRORS',
      p_sig_sql                => 'SELECT distinct cte.TRANSACTION_ERROR_ID, cte.inv_material_transaction_id "Material Transaction Id", cte.transaction_error_date "Error Date", cte.source_type "Source Type", cte.inventory_item_id "Inventory Item Id"   
FROM   mtl_system_items_b mtl, 
       csi_txn_errors cte
WHERE 
cte.SRC_SERIAL_NUM_CTRL_CODE = mtl.serial_number_control_code
and cte.error_text LIKE ''Instance Cannot be marked as Creation Complete%''
AND processed_flag in (''E'', ''R'')
ORDER BY cte.transaction_error_date',
      p_title                  => ''||mask_text(g_cmcc_cnt, nvl( upper(''), 'NO_MASK') )||' Instance Cannot be Marked as Creation Complete Errors Found',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are '||mask_text(g_cmcc_cnt, nvl( upper(''), 'NO_MASK') )||' error transactions with following error message: Instance Cannot be marked as Creation Complete, because one or all of the following mandatory params are not available: Serial Number (If Serialized), Lot Number (If Lot Controlled), Revision (If Rev Controlled), Instance Location, Instance Status.',
      p_solution               => 'See [1171526/KB768934] for possible solution.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: INST_CANNOT_BE_MARKED_ERRORS');



debug('begin add_signature: EITHER_SUB_TYPE_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '844',
      p_sig_id                 => 'EITHER_SUB_TYPE_ERRORS',
      p_sig_sql                => 'SELECT source_type "Source Type",inv_material_transaction_id "Inv Material Transaction Id" 
FROM csi_txn_errors
WHERE processed_flag in (''E'', ''R'')
AND error_text like ''Either sub type has change owner code%''
AND source_type like ''CSISOSHP''',
      p_title                  => ''||mask_text(g_stcoc_cnt, nvl( upper(''), 'NO_MASK') )||' Either Sub type has Change Owner Code as "E" Errors Found',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are '||mask_text(g_stcoc_cnt, nvl( upper(''), 'NO_MASK') )||' error transactions with following error message: Either sub type has change owner code as "E",so the external party_id: (xxx) cannot be same as the internal party_id: (xxx) OR the sub type change owner code is "I", so the external party_id: (xxx) has to be same as the internal party_id',
      p_solution               => 'See solution provided in [1547947/KB162619].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EITHER_SUB_TYPE_ERRORS');



debug('begin add_signature: DIVISOR_IS_ZERO');
   l_info('##MASK##ERROR_TEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MESSAGE_STRING'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '845',
      p_sig_id                 => 'DIVISOR_IS_ZERO',
      p_sig_sql                => 'SELECT source_type "Source Type", error_text "Error_Text", transaction_error_date "Transaction_Error_Date"
FROM csi_txn_errors
WHERE processed_flag in (''E'', ''R'')
AND error_text like ''%ORA-01476%divisor is equal%''',
      p_title                  => ''||mask_text(g_diez_cnt, nvl( upper(''), 'NO_MASK') )||' ORA-01476: Divisor is Equal to Zero Errors Found',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are '||mask_text(g_diez_cnt, nvl( upper(''), 'NO_MASK') )||' error transactions with following error message: ORA-01476: divisor is equal to zero.',
      p_solution               => 'See [1324296/KB440925] for possible solution.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: DIVISOR_IS_ZERO');



debug('begin add_signature: EBS_CRM_SC_IB_REQUIRED_QUANTITY_NOT_EQUALING_THE_QUANTITY_ISSUED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28174',
      p_sig_id                 => 'EBS_CRM_SC_IB_REQUIRED_QUANTITY_NOT_EQUALING_THE_QUANTITY_ISSUED',
      p_sig_sql                => 'select inventory_item_id, organization_id, wip_entity_id, REQUIRED_QUANTITY , QUANTITY_ISSUED
from wip_requirement_operations 
where REQUIRED_QUANTITY != QUANTITY_ISSUED',
      p_title                  => 'WIP Issued Component Instances Not Found... Due to REQUIRED_QUANTITY Not Equaling the QUANTITY_ISSUED',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'When processing Sales Order Fulfillment transactions (CSISOFUL), the the following errors occurred the Transaction Error Processing Form (csi_txn_errors table):

WIP Issued Component Instances Not Found For This Wip Job (WIP_ENTITY_ID : XX and Item XX)',
      p_solution               => 'Review note 1631942.1 for possible solutions.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_IB_REQUIRED_QUANTITY_NOT_EQUALING_THE_QUANTITY_ISSUED');



debug('begin add_signature: IB_TRACK_OFF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '828',
      p_sig_id                 => 'IB_TRACK_OFF',
      p_sig_sql                => 'SELECT distinct msi.segment1 "Item Name", cii.inventory_item_id "Inventory Item Id"
FROM csi_item_instances cii, mtl_system_items_b msi 
WHERE cii.instance_status_id <> 1 
AND NVL(cii.active_end_date,sysdate+1) < sysdate 
AND cii.inventory_item_id = msi.inventory_item_id 
AND NVL(cii.inv_organization_id,cii.inv_master_organization_id) = msi.organization_id 
AND NVL(msi.comms_nl_trackable_flag,''N'') = ''N''
AND cii.inventory_item_id in (select distinct inventory_item_id from csi_txn_errors)',
      p_title                  => 'Instances with Items that are no Longer IB Trackable',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'You have item instances in the system where the items are no longer IB Trackable. You may want to remove any related errors referenced in the Transaction Error Processing Form.',
      p_solution               => 'Please refer to [1275119/KB815241] for guidance on how to hide related transaction errors.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: IB_TRACK_OFF');



debug('begin add_signature: EBS_CRM_SC_IB_SFM_QUEUE_BYPASS_FLAG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28324',
      p_sig_id                 => 'EBS_CRM_SC_IB_SFM_QUEUE_BYPASS_FLAG',
      p_sig_sql                => 'SELECT sfm_queue_bypass_flag sfm_queue_bypass_flag
FROM csi_install_parameters',
      p_title                  => 'SFM_QUEUE_BYPASS_FLAG',
      p_fail_condition         => '[sfm_queue_bypass_flag] <> [X]',
      p_problem_descr          => 'Install Base Instance Is Not Getting Created From Sales Order On R12.2.5+',
      p_solution               => 'See [2194865/KB796045].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_IB_SFM_QUEUE_BYPASS_FLAG');



debug('begin add_signature: EBS_CRM_SC_IB_INACTIVE_BILL_SHIP_TO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30268',
      p_sig_id                 => 'EBS_CRM_SC_IB_INACTIVE_BILL_SHIP_TO',
      p_sig_sql                => 'SELECT DISTINCT hp.party_name, hca.account_number, hcua.site_use_code, hca.account_name, hps.party_site_number,
  hcua.org_id, hou.name, cte.error_text, cte.source_id, cte.source_type,hcua.location,hcua.site_use_code,cte.source_header_ref,cte.source_line_ref
FROM csi_txn_errors cte,
  ...
  hz_parties hp
WHERE cte.source_line_ref_id=oola.line_id
AND cte.processed_flag = ''E''
AND oola.ship_to_org_id = hcua.site_use_id
AND hcua.status=''I''
AND hcua.cust_acct_site_id = hcas.cust_acct_site_id
AND hca.cust_account_id = hcas.cust_account_id
AND hp.party_id = hca.party_id
AND hcas.party_site_id = hps.party_site_id
AND hcua.org_id = hou.organization_id
UNION
SELECT DISTINCT hp.party_name, hca.account_number, hcua.site_use_code, hca.account_name, hps.party_site_number,
  hcua.org_id, hou.name, cte.error_text, cte.source_id, cte.source_type,hcua.location,hcua.site_use_code,cte.source_header_ref,cte.source_line_ref
FROM csi_txn_errors cte,
  oe_order_lines_all oola ,
  hz_cust_site_uses_all hcua,
...
WHERE cte.source_line_ref_id=oola.line_id
AND cte.processed_flag = ''E''
AND oola.INVOICE_TO_ORG_ID = hcua.site_use_id
AND hcua.status=''I''
AND hcua.cust_acct_site_id = hcas.cust_acct_site_id
AND hca.cust_account_id = hcas.cust_account_id
AND hp.party_id = hca.party_id
AND hcas.party_site_id = hps.party_site_id
AND hcua.org_id = hou.organization_id
AND hcua.org_id IN ##$$VALID_ORGS$$##',
      p_title                  => 'Inactive BILL TO and SHIP TO sites',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'When attempting to process Sales Order transactions to Install Base, the following error occurs.

ERROR<br>
''OKC_CONTRACTS_REQUIRED_VALUE (COL_NAME=Bill to id is not Valid)''
<br>
''OKC_CONTRACTS_REQUIRED_VALUE (COL_NAME=Ship to id is not Valid)''',
      p_solution               => 'See [2066658/KB164203]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_IB_INACTIVE_BILL_SHIP_TO');



debug('begin add_signature: ERROR_TRANSACTION_DETAIL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6263',
      p_sig_id                 => 'ERROR_TRANSACTION_DETAIL',
      p_sig_sql                => 'select SOURCE_TYPE,                     
       SOURCE_ID, 
       TRANSACTION_TYPE_ID, 
       ERROR_TEXT, 
       PROCESSED_FLAG, 
       ...
       SOURCE_LINE_REF_id             
from csi_txn_errors
where inv_material_transaction_id = ##$$MTLTXNID$$##',
      p_title                  => 'Error Transaction Detail',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This provides details of error transaction.',
      p_solution               => 'See [577978/KB410902] for steps to re-process error transactions.<br>
<br>
See [1289858/KB821279] for common errors and solutions
',
      p_success_msg            => 'No errors found',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ERROR_TRANSACTION_DETAIL');



debug('begin add_signature: MATERIAL_TRANSACTION_DETAIL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6264',
      p_sig_id                 => 'MATERIAL_TRANSACTION_DETAIL',
 ...
 WHERE transaction_id = ##$$MTLTXNID$$##',
      p_title                  => 'Material Transaction Detail',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Inventory Transaction Details.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: MATERIAL_TRANSACTION_DETAIL');



debug('begin add_signature: ITEM_DETAIL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6316',
      p_sig_id                 => 'ITEM_DETAIL',
  ...
  FROM mtl_system_items_b msi,
       org_organization_definitions ood, 
       mtl_material_transactions mmt
 WHERE mmt.transaction_id = ##$$MTLTXNID$$##
   AND (mmt.organization_id = msi.organization_id
        or nvl(mmt.transfer_organization_id , mmt.organization_id)
          = msi.organization_id)
   AND mmt.inventory_item_id = msi.inventory_item_id
   AND msi.organization_id = ood.organization_id',
      p_title                  => 'Item Detail',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no inventory Item details.',
      p_solution               => '',
      p_success_msg            => 'Inventory Item details for item associated with the errored transaction.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_DETAIL');



debug('begin add_signature: INSTANCE_DETAIL_NSR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6317',
      p_sig_id                 => 'INSTANCE_DETAIL_NSR',
      p_sig_sql                => 'SELECT cii.instance_id ,                     
       cii.instance_number , 
  ...
  FROM csi_item_instances cii,
       mtl_material_transactions mmt
 WHERE cii.inventory_item_id = mmt.inventory_item_id
   AND cii.inv_organization_id = mmt.organization_id
   AND cii.inv_subinventory_name = mmt.subinventory_code
   AND cii.inv_locator_id = mmt.locator_id
   AND cii.location_type_code = ''INVENTORY''
   AND cii.instance_usage_code = ''IN_INVENTORY''
   AND mmt.transaction_id = ##$$MTLTXNID$$##',
      p_title                  => 'Instance Detail',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no instances associated to the errored transaction.',
      p_solution               => '',
      p_success_msg            => 'Instance details for instance(s) associated to the errored transaction.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: INSTANCE_DETAIL_NSR');



debug('begin add_signature: SERIAL_INV_TXN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6322',
      p_sig_id                 => 'SERIAL_INV_TXN',
      p_sig_sql                => 'SELECT mut.SERIAL_NUMBER,
NULL LOT_NUMBER,
mmt.transaction_id,
...
AND msi.organization_id = mmt.organization_id
AND (Mut.Inventory_Item_Id, Mut.Serial_Number ) IN
...
AND msi.organization_id = mmt.organization_id
AND (Mut.Inventory_Item_Id, Mut.Serial_Number ) IN
(SELECT mut2.inventory_item_id,
mut2.Serial_Number
FROM Mtl_Unit_Transactions mut2,
mtl_transaction_lot_numbers mtln
WHERE mtln.Transaction_Id = ##$$MTLTXNID$$##
AND mtln.serial_transaction_id = mut.transaction_id
)
...
AND Ct.Inv_Material_Transaction_Id (+) = Mmt.Transaction_Id
ORDER BY 1, 3',
      p_title                  => 'Inventory Transactions for Serial Number',
      p_fail_condition         => '[Processed] > [10000]',
      p_problem_descr          => 'There are over 10,000 inventory transactions.',
      p_solution               => '',
      p_success_msg            => 'Inventory transactions for serial number.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SERIAL_INV_TXN');



debug('begin add_signature: INSTANCE_DETAIL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6318',
      p_sig_id                 => 'INSTANCE_DETAIL',
      p_sig_sql                => 'SELECT cii.instance_id , 
cii.instance_number , 
cii.inventory_item_id, 
cii.serial_number, 
...
FROM csi_item_instances cii,
mtl_unit_transactions mut
WHERE cii.inventory_item_id = mut.inventory_item_id
AND cii.serial_number = mut.serial_number
AND mut.transaction_id = ##$$MTLTXNID$$##
UNION
...
AND cii.serial_number = mut.serial_number
AND mut.transaction_id = mtln.serial_transaction_id
AND mtln.transaction_id = ##$$MTLTXNID$$##
ORDER BY 10',
      p_title                  => 'Instance Detail',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no instances associated to the errored transaction.',
      p_solution               => '',
      p_success_msg            => 'Instance details for instances associated to the errored transaction.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: INSTANCE_DETAIL');



debug('begin add_signature: IPIA_DETAIL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6319',
      p_sig_id                 => 'IPIA_DETAIL',
      p_sig_sql                => 'SELECT cii.instance_id ,                     
       cip.instance_party_id,
       cip.relationship_type_code,
       cip.party_id,
       cip.active_start_date,
       cip.active_end_date,
       cip.contact_flag,
       cip.contact_ip_id,
       cia.ip_account_id,
...
SELECT cii.instance_id ,                     
 ...
 WHERE cii.inventory_item_id = mut.inventory_item_id
   ...
   AND cii.instance_id = cip.instance_id
   AND cip.instance_party_id = cia.instance_party_id (+)',
      p_title                  => 'Instance Party Account Detail',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no Instance Party Account Details.',
      p_solution               => '',
      p_success_msg            => 'Instance Party Account Details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: IPIA_DETAIL');



debug('begin add_signature: INST_RELATIONSHIP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6320',
      p_sig_id                 => 'INST_RELATIONSHIP',
      p_sig_sql                => 'SELECT cii.instance_id ,  
       cir.relationship_id,                    
       cir.object_id,
       cir.subject_id,  
       cir.active_start_date,
       cir.active_end_date  
  FROM csi_item_instances cii,
 ...
 WHERE cii.inventory_item_id = mut.inventory_item_id
   ...
   AND (cii.instance_id = cir.object_id 
       or cii.instance_id = subject_id)
   ORDER BY 1',
      p_title                  => 'Instance Relationship',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no relationships for the instance(s) associated to the errored transaction.',
      p_solution               => '',
      p_success_msg            => 'Relationship(s) for the instance(s) associated to the errored transaction.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: INST_RELATIONSHIP');



debug('begin add_signature: ORDER_DETAIL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6323',
      p_sig_id                 => 'ORDER_DETAIL',
      p_sig_sql                => 'SELECT to_char(a.line_number) || decode(a.shipment_number, null, null,
''.''
|| to_char(a.shipment_number))
|| decode(a.option_number, null, null, ''.''
|| to_char(a.option_number))
|| decode(a.component_number, null, null,
decode(a.option_number, null, ''.'',null)
|| ''.''
|| to_char(a.component_number)) line_number,
a.inventory_item_id,
line_id,
b.segment1,
b.bom_item_type,
...
a.sold_to_org_id, 
a.IB_OWNER,
a.IB_INSTALLED_AT_LOCATION,
a.IB_CURRENT_LOCATION,
nvl(a.END_CUSTOMER_ID,c.END_CUSTOMER_ID) end_customer_id,
nvl(a.END_CUSTOMER_CONTACT_ID,c.END_CUSTOMER_CONTACT_ID) end_customer_contact_id,
nvl(a.END_CUSTOMER_SITE_USE_ID,c.END_CUSTOMER_SITE_USE_ID) end_customer_site_use_id,
c.sold_to_site_use_id,
mmt.transaction_id inv_txn_id, 
mmt.transaction_type_id inv_txn_type, 
ct.transaction_id ib_txn_id,
ct.transaction_type_id ib_txn_type, 
cte.processed_flag, 
cte.error_text
...
and c.header_id = ##$$HEADERID$$##
and a.inventory_item_id = b.inventory_item_id
and a.ship_from_org_id = b.organization_id (+)
and nvl(b.comms_nl_trackable_flag, ''N'') = ''Y''
and ct.source_line_ref_id (+) = a.line_id
and cte.source_line_ref_id (+) = a.line_id
and mmt.trx_source_line_id (+) = a.line_id 
order by a.line_number, a.shipment_number, a.option_number, a.component_number',
      p_title                  => 'Order Detail',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no orders associated to the errored transaction.',
      p_solution               => '',
      p_success_msg            => 'Order details for order associated to the errored transaction.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ORDER_DETAIL');



debug('begin add_signature: INSTALLATION_DETAIL');
   l_info('##MASK##SERIAL_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6265',
      p_sig_id                 => 'INSTALLATION_DETAIL',
      p_sig_sql                => 'SELECT cttl.transaction_line_id, 
       cttl.source_transaction_table,
       cttl.source_transaction_id,
       cttl.source_transaction_type_id,
       cttld.txn_line_detail_id,
       cttld.instance_exists_flag,
       cttld.source_transaction_flag,
       cttld.instance_id,
       cttld.serial_number,
       cttld.inventory_item_id,
       cttld.lot_number,
       cttld.mfg_serial_number_flag,
       cttld.location_type_code,
       cttld.location_id,
       cttld.installation_date,
       cttld.sub_type_id,
       cttld.processing_status
 from csi_t_transaction_lines cttl,
    csi_t_txn_line_details cttld
where cttl.source_transaction_id =##$$LINEID$$##
  AND cttl.transaction_line_id = cttld.transaction_line_id
ORDER BY 1',
      p_title                  => 'INSTALLATION DETAIL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Installation Detail Info',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: INSTALLATION_DETAIL');



debug('begin add_signature: SUB_TYPE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6324',
      p_sig_id                 => 'SUB_TYPE',
      p_sig_sql                => 'SELECT DISTINCT ctst.sub_type_id,
        ctst.NAME,
        ctst.src_reference_reqd,
        ctst.src_change_owner,
        NVL(DECODE(ctst.src_change_owner_to_code,''E'',''External'',''I'',''Internal''),''-'') src_change_owner_to_code,
        ctst.src_status_id,
        scis.NAME src_status,
        ctst.src_return_reqd,
        ctst.non_src_reference_reqd,
        ctst.non_src_change_owner,
        ctst.non_src_status_id,
        ncis.NAME non_src_status,
        ctst.freeze_flag freeze_flag,
        ctst.seeded_flag seeded_flag
      FROM csi_txn_sub_types ctst, 
           csi_instance_statuses scis,
           csi_instance_statuses ncis
      WHERE ctst.sub_type_id = ##$$SUBTYPEID$$##
        AND ctst.src_status_id = scis.instance_status_id(+)
      AND ctst.non_src_status_id = ncis.instance_status_id(+)',
      p_title                  => 'IB Sub Type',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no transaction sub type details to display.',
      p_solution               => '',
      p_success_msg            => 'Transaction sub type details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SUB_TYPE');



debug('begin add_signature: WIP_JOB_DETAIL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6325',
      p_sig_id                 => 'WIP_JOB_DETAIL',
      p_sig_sql                => 'select mmt.transaction_id, mmt.inventory_item_id, mmt.organization_id,
       mmt.transaction_quantity, mmt.transaction_type_id, 
       msi.serial_number_control_code, msi.lot_control_code,
       ct.transaction_id, ct.transaction_date, ct.transaction_type_id,
       cte.processed_flag, cte.error_text, cte.source_type
from mtl_material_transactions mmt,
     mtl_system_items_b msi,
     csi_transactions ct,
     csi_txn_errors cte
where mmt.transaction_source_id = 	##$$HEADERID$$##
  and mmt.inventory_item_id = msi.inventory_item_id
  and mmt.organization_id = msi.organization_id
  and nvl(msi.comms_nl_trackable_flag, ''N'') = ''Y''
  and ct.inv_material_transaction_id (+) = mmt.transaction_id
  and cte.inv_material_transaction_id (+) = mmt.transaction_id',
      p_title                  => 'WIP Job Detail',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no WIP job details.',
      p_solution               => '',
      p_success_msg            => 'WIP job details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: WIP_JOB_DETAIL');
...
debug('begin add_signature: SFM_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '696',
      p_sig_id                 => 'SFM_STATUS',
      p_sig_sql                => 'SELECT concurrent_queue_name "Event Queue Running"
FROM fnd_concurrent_queues
WHERE concurrent_queue_name = ''XDP_Q_EVENT_SVC''
AND running_processes = 1 
AND max_processes = 1',
      p_title                  => 'SFM Status',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'ATTENTION:  Below issue DOES NOT apply to customers on 12.2.5 and above releases:

Your SFM Event Manager Queue Service appears to be deactivated.',
      p_solution               => 'ATTENTION:  Below solution DOES NOT apply to customers on 12.2.5 and above releases:

For the solution please refer to [2371027/KB219792] How to Restart the SFM Event Manager. 
...
',
   ...
   l_info.delete;
debug('end add_signature: SFM_STATUS');



debug('begin add_signature: INTERFACE_OM_LINE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6298',
      p_sig_id                 => 'INTERFACE_OM_LINE',
      p_sig_sql                => 'select count(*) count
from fnd_concurrent_requests a, fnd_concurrent_programs_tl b 
where status_code in (''Q'',''I'') 
and a.concurrent_program_id = b.concurrent_program_id 
and a.requested_start_date > SYSDATE 
and a.hold_flag = ''N''
and b.user_concurrent_program_name = ''Interface Install base Lines''',
      p_title                  => 'Interface OM Line',
      p_fail_condition         => 'NRS',
      p_problem_descr          => '''Interface Install Base Lines'' program is NOT scheduled to run.',
      p_solution               => 'Make sure you schedule concurrent program ''Interface Install Base Lines'' to run periodically.',
      p_success_msg            => '''Interface Install Base Lines'' program is up and running.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: INTERFACE_OM_LINE');



debug('begin add_signature: TRANSACTIONS_NOT_INTERFACED2');
   l_info('##MASK##RETURN_MESSAGE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6299',
      p_sig_id                 => 'TRANSACTIONS_NOT_INTERFACED2',
      p_sig_sql                => 'select inventory_item_id, order_type, processed_flag, mtl_transaction_id, return_message
from csi_transactions_interface
where processed_flag <> ''PC''',
      p_title                  => 'Transactions Are Still Pending in Interface Table',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'You have transaction messages that are still pending in interface table',
      p_solution               => 'Please make sure Interface Install Base Line concurrent program is up and running, in case it is failed, you can resubmit them through resubmit process form.

Review Doc ID 2169552.1 - 12.2.5+ Transactions are not interfaced into Installed Base for more information.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: TRANSACTIONS_NOT_INTERFACED2');



debug('begin add_signature: IB_TRACK_CUSTOMER_OWNED_ONLY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6169',
      p_sig_id                 => 'IB_TRACK_CUSTOMER_OWNED_ONLY',
      p_sig_sql                => 'select re_architectured_ib from csi_install_parameters where re_architectured_ib = ''CUSTIB''',
      p_title                  => 'IB Track Customer Owned Only',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The level of Install Base tracking is set to ‘Only Customer Owned Instances’.',
      p_solution               => 'Please see [2112730/KB556935] New IB Re-architecture: Non Dependency on SFM and Extended Support For Exclusive Customer Owned Instance Tracking.',
      p_success_msg            => 'The level of Install Base tracking is not set to ‘Only Customer Owned Instances’.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: IB_TRACK_CUSTOMER_OWNED_ONLY');



debug('begin add_signature: INTERFACE_INSTALL_BASE_LINES_PROGRAM_12.2.5');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6027',
      p_sig_id                 => 'INTERFACE_INSTALL_BASE_LINES_PROGRAM_12.2.5',
      p_sig_sql                => 'select count(*) count from fnd_concurrent_requests a, fnd_concurrent_programs_tl b where status_code in (''Q'',''I'') and a.concurrent_program_id = b.concurrent_program_id and a.requested_start_date > SYSDATE and a.hold_flag = ''N'' and b.user_concurrent_program_name = ''Interface Install base Lines''',
      p_title                  => 'Interface Install Base Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The ''Interface Install Base Lines'' program is not scheduled to run. ',
      p_solution               => 'Please see [2169552/KB487747] and [2914956/KB527415] to determine how frequently to schedule, Interface Install Base Lines, program.',
      p_success_msg            => 'This query is to check if the ''Interface Install Base Lines'' program is scheduled to run. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: INTERFACE_INSTALL_BASE_LINES_PROGRAM_12.2.5');
...
BEGIN
  ...
  analyzer_title := 'Install Base Analyzer';
...
IF substr(g_rep_info('Apps Version'),1,6) < '12.2.5' THEN
   start_section('Proactive Recommendations', 'PROACTIVE_RECOMMENDATIONS');
      IF substr(g_rep_info('Apps Version'),1,6) >= '12.2.4' THEN
         set_item_result(run_stored_sig('SFM_STATUS'));
      END IF;
      set_item_result(check_rec_patches_1); /* Signature CHECK_IB_REC_PATCHES */
      IF substr(g_rep_info('Apps Version'),1,6) >= '12.2.5' THEN
         set_item_result(run_stored_sig('IB_INVALIDS'));
         set_item_result(run_stored_sig('LOG_CHECK'));
         set_item_result(run_stored_sig('ERR_CORRECT_SCH'));
         set_item_result(run_stored_sig('EBS_CRM_SC_IB_INTGR_FIX_PRG'));
         set_item_result(run_stored_sig('INTERFACE_OM_LINE'));
         set_item_result(run_stored_sig('TRANSACTIONS_NOT_INTERFACED2'));
         set_item_result(run_stored_sig('IB_TRACK_CUSTOMER_OWNED_ONLY'));
         set_item_result(run_stored_sig('INTERFACE_INSTALL_BASE_LINES_PROGRAM_12.2.5'));
      ...
      set_item_result(run_stored_sig('ERR_CORRECT_SCH'));
      set_item_result(run_stored_sig('EBS_CRM_SC_IB_INTGR_FIX_PRG'));
      set_item_result(run_stored_sig('SFM_THREAD'));
      set_item_result(run_stored_sig('EVENT_QUEUE_PROCESSED'));
      set_item_result(run_stored_sig('EVENT_QUEUE_READY'));
      set_item_result(run_stored_sig('EVENT_QUEUE_FAILED'));
      set_item_result(run_stored_sig('TRANSACTIONS_NOT_INTERFACED'));
      set_item_result(run_stored_sig('EBS_CRM_SC_GEN_MAX_SEQ'));
   end_section;
END IF;
debug('end section: PROACTIVE_RECOMMENDATIONS');

debug('begin section: ITEM_SETUP');
IF substr(g_rep_info('Apps Version'),1,6) NOT IN  ( '12.2.5', '12.2.6') THEN
   start_section('General Checking', 'ITEM_SETUP');
      set_item_result(run_stored_sig('INSTALL_PARAMETERS_12.1'));
      set_item_result(run_stored_sig('CSI_PROFILE_OPTIONS'));
      set_item_result(run_stored_sig('INCONSISTENT_LOT_CONTROL'));
      set_item_result(run_stored_sig('INCONSISTENT_REVISION_CONTROL'));
   end_section;
END IF;
debug('end section: ITEM_SETUP');

debug('begin section: ITEM_SETUP_12_2_5');
IF substr(g_rep_info('Apps Version'),1,6)  IN  ( '12.2.5', '12.2.6') THEN
   start_section('General Checking', 'ITEM_SETUP_12_2_5');
      set_item_result(run_stored_sig('INSTALL_PARAMETERS_12.2'));
      set_item_result(run_stored_sig('CSI_PROFILE_OPTIONS'));
      set_item_result(run_stored_sig('INCONSISTENT_LOT_CONTROL'));
      set_item_result(run_stored_sig('INCONSISTENT_REVISION_CONTROL_12_2_5'));
   end_section;
END IF;
debug('end section: ITEM_SETUP_12_2_5');

debug('begin section: TRANSACTION_ERRORS_SUMMARY');
start_section('Transaction Errors Summary', 'TRANSACTION_ERRORS_SUMMARY');
   set_item_result(run_stored_sig('ERROR_COUNTS'));
   set_item_result(run_stored_sig('TOP_ITEM_ERRORS'));
   set_item_result(run_stored_sig('TOP_MOST_ERRORS'));
   set_item_result(run_stored_sig('LATER_TXN_PROCESSED'));
end_section;
debug('end section: TRANSACTION_ERRORS_SUMMARY');

debug('begin section: QUICK_FIXES');
start_section('Quick Fixes', 'QUICK_FIXES');
   set_item_result(run_stored_sig('NULL_TXN_SOURCE'));
   set_item_result(run_stored_sig('MULTI_ACTIVE_INST_FOUND'));
   set_item_result(run_stored_sig('RMA_NON_SERIAL_ERRORS'));
   set_item_result(run_stored_sig('INST_CANNOT_BE_MARKED_ERRORS'));
   set_item_result(run_stored_sig('EITHER_SUB_TYPE_ERRORS'));
   set_item_result(run_stored_sig('DIVISOR_IS_ZERO'));
   set_item_result(run_stored_sig('EBS_CRM_SC_IB_REQUIRED_QUANTITY_NOT_EQUALING_THE_QUANTITY_ISSUED'));
   set_item_result(run_stored_sig('IB_TRACK_OFF'));
   set_item_result(run_stored_sig('EBS_CRM_SC_IB_SFM_QUEUE_BYPASS_FLAG'));
   set_item_result(run_stored_sig('EBS_CRM_SC_IB_INACTIVE_BILL_SHIP_TO'));
end_section;
debug('end section: QUICK_FIXES');

debug('begin section: ERROR_TRANSACTION');
IF p_mtl_txn_id is not NULL and g_serial_number_control_code = 1 THEN
   start_section('Error Transaction', 'ERROR_TRANSACTION');
      set_item_result(run_stored_sig('ERROR_TRANSACTION_DETAIL'));
      set_item_result(run_stored_sig('MATERIAL_TRANSACTION_DETAIL'));
      set_item_result(run_stored_sig('ITEM_DETAIL'));
      set_item_result(run_stored_sig('INSTANCE_DETAIL_NSR'));
   end_section;
END IF;
debug('end section: ERROR_TRANSACTION');

debug('begin section: ERROR_TRANSACTION_SHP_RMA');
IF p_mtl_txn_id is not NULL and g_serial_number_control_code in (2, 5, 6) and g_transaction_type_id in (33, 15) THEN
   start_section('Error Transaction', 'ERROR_TRANSACTION_SHP_RMA');
      set_item_result(run_stored_sig('ERROR_TRANSACTION_DETAIL'));
      set_item_result(run_stored_sig('MATERIAL_TRANSACTION_DETAIL'));
      set_item_result(run_stored_sig('ITEM_DETAIL'));
      set_item_result(run_stored_sig('SERIAL_INV_TXN'));
      set_item_result(run_stored_sig('INSTANCE_DETAIL'));
      set_item_result(run_stored_sig('IPIA_DETAIL'));
      set_item_result(run_stored_sig('INST_RELATIONSHIP'));
      set_item_result(run_stored_sig('ORDER_DETAIL'));
      set_item_result(run_stored_sig('INSTALLATION_DETAIL'));
      set_item_result(run_stored_sig('SUB_TYPE'));
   end_section;
END IF;
debug('end section: ERROR_TRANSACTION_SHP_RMA');

debug('begin section: ERROR_TRANSACTION_WIP');
IF p_mtl_txn_id is not NULL and g_serial_number_control_code  in (2, 5, 6) and g_transaction_type_id  in (35, 44, 43) THEN
   start_section('Error Transaction', 'ERROR_TRANSACTION_WIP');
      set_item_result(run_stored_sig('ERROR_TRANSACTION_DETAIL'));
      set_item_result(run_stored_sig('MATERIAL_TRANSACTION_DETAIL'));
      set_item_result(run_stored_sig('ITEM_DETAIL'));
      set_item_result(run_stored_sig('INSTANCE_DETAIL'));
      ...
      set_item_result(run_stored_sig('INST_RELATIONSHIP'));
      set_item_result(run_stored_sig('SERIAL_INV_TXN'));
      set_item_result(run_stored_sig('WIP_JOB_DETAIL'));
   end_section;
END IF;
debug('end section: ERROR_TRANSACTION_WIP');

debug('begin section: ERROR_TRANSACTION_OTHER');
IF p_mtl_txn_id is not NULL and g_serial_number_control_code <> 1 and g_transaction_type_id not in (15, 33, 35, 43, 44) THEN
   start_section('Error Transaction', 'ERROR_TRANSACTION_OTHER');
      set_item_result(run_stored_sig('ERROR_TRANSACTION_DETAIL'));
      set_item_result(run_stored_sig('MATERIAL_TRANSACTION_DETAIL'));
      set_item_result(run_stored_sig('ITEM_DETAIL'));
      set_item_result(run_stored_sig('SERIAL_INV_TXN'));
   ...
   end_section;
END IF;
debug('end section: ERROR_TRANSACTION_OTHER');
