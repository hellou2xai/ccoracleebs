...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Incentive Compensation Analyzer        |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE cn_analyzer_pkg AUTHID DEFINER AS
...
PROCEDURE main
(            p_salesrep_id                  IN VARCHAR2    DEFAULT NULL
           ,p_period_id                    IN VARCHAR2    DEFAULT NULL
           ,p_org_id                       IN NUMBER      DEFAULT NULL
           ,p_section                      IN VARCHAR2    DEFAULT '1'
...
CREATE OR REPLACE PACKAGE BODY cn_analyzer_pkg AS
-- $Id: cn_analyzer.sql, 200.2 2025/12/11 12:34:44 vamuruge Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(3060115.1));
...
g_subledger_total number;
g_payment_total number;
g_commission_total number;
g_difference  number;

g_instance_name     VARCHAR2(100);
g_username VARCHAR2(100);
g_set_check VARCHAR2(100);
g_resp_id number;
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'CN_ANALYZER_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'CN_ANALYZER_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>CN_ANALYZER Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=3060115.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/cn_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,11658,EBS,EBS CRM,EBS - Sales/Marketing" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,11658,EBS,EBS CRM,EBS - Sales/Marketing" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},11658,EBS,EBS CRM,EBS - Sales/Marketing" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/mosc/discussion/4578299/coming-soon-ebs-incentive-compensation-analyzer/p1?new=1" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">11658</span>
...
<p><strong>28-01-2025: 200.2</strong></p><p>Introducing the NEW Incentive Compensation Analyzer.&nbsp; This gathers useful troubleshooting information and offers proactive data checks referencing solution KM notes.<br>
<br>
<strong><u>Important sections in this analyzer:</u></strong></p><p><strong>Compensation Setup :</strong> Collects all the Important setups relevant to the Incentive compensation Roles, Quotas, Compensations, SalesRep, Payment Plans and Assignments, Rate Tiers etc.</p><p><strong>Open Period &nbsp;Setup:</strong> Shares the information related to the Period Sets, Types, Status, Intervals, GL Periods</p><p><strong>Collection: </strong>Provides information related to Salesrep Pay Groups, Role Pay Groups and Corrupt OIC Compensation Periods</p><p><strong>Calculation:</strong> Collects details about the Plan Assignments, Quotas, Uncalculated Transactions, Formula Packages etc.</p><p><strong>Payment: </strong>Commission Headers, Lines, Lines API, Payment Worksheets, Posting details etc. are procured for payment calculation purposes.</p><p><strong>Payment Collection Script: </strong>Relevant Data to Resolve Payment Worksheet Errors are gathered.</p>
            <br><br>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,11658,'||l_sig.sigrepo_id||',EBS,EBS CRM,EBS - Sales/Marketing" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,11658,'||l_sig.sigrepo_id||',EBS,EBS CRM,EBS - Sales/Marketing" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},11658,'||l_sig.sigrepo_id||',EBS,EBS CRM,EBS - Sales/Marketing" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,11658,'||p_sig.sigrepo_id||',EBS,EBS CRM,EBS - Sales/Marketing" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,11658,'||p_sig.sigrepo_id||',EBS,EBS CRM,EBS - Sales/Marketing" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},11658,'||p_sig.sigrepo_id||',EBS,EBS CRM,EBS - Sales/Marketing" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
FUNCTION check_rec_patches_1 RETURN VARCHAR2 IS
  /* Signature EBS_CRM_SM_OIC_CHECK_REC_PATCHES */
...
BEGIN
    ...
    print_log('Processing recommended patches signature: EBS_CRM_SM_OIC_CHECK_REC_PATCHES (check_rec_patches_1) "Recommended Patches" (version 5)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26560437';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'CN:12.2+ Oracle Incentive Compensation Recommended Patch Collection (Aug 2017)';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37642697';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'NEED SQL QUERY OF PERIODVO.XML - 120.6 (12.1.3) ON R12.2.12';
   l_col_rows(5)(l_rows) := '[3075113.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37662124';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'PLAN ELEMENT NAMES ARE MISSING IN THE DROP-DOWN UNDER MANUAL PAYMENTS TAB';
   l_col_rows(5)(l_rows) := '[3077976.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25497160';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.1.3: Recommended or Minimum Patch for Oracle Incentive Compensation';
   l_col_rows(5)(l_rows) := '[2450612.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37341611';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Incentive Compensation Recommended Patch Collection (Dec/2024)';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37121038';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Incentive Compensaton Recommended Patch Collection (Oct/2024)';
   l_col_rows(5)(l_rows) := NULL;
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37121057';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.2 Oracle Incentive Compensation Recommended Patch Collection (Oct/2024)';
   l_col_rows(5)(l_rows) := NULL;
...
<li>[10940175] Patch Wizard FAQ</li>
  ...
  -- Register
  l_step := '60';
  g_signatures('EBS_CRM_SM_OIC_CHECK_REC_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'EBS_CRM_SM_OIC_CHECK_REC_PATCHES',     -- sig ID
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := '* Salesrep Id';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_salesrep_id,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Period Id';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_period_id,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Organization Id';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_org_id,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Section (All - 1, Open Period - 2, Collection - 3, Calculation - 4, Payment - 5)';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_section,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2025/12/11 12:34:43 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'cn_analyzer.sql';
...
debug('begin parameter validation: p_salesrep_id');
IF p_salesrep_id IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter * Salesrep Id is required.');
...
WHERE  S.SALESREP_ID  = p_salesrep_id
 AND re.resource_id = s.resource_id
and category <> 'TBH'
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Please enter Valid Salesrep Id');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_salesrep_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_salesrep_id');

debug('begin parameter validation: p_period_id');
IF p_period_id IS NOT NULL THEN
BEGIN
SELECT CPSA.PERIOD_ID
INTO l_exists_val
FROM CN_PERIOD_STATUSES_ALL CPSA
WHERE CPSA.PERIOD_ID = p_period_id
 AND cpsa.period_status='O'
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Please enter Valid Period Id');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_period_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_period_id');
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid organization id entered. Please enter a valid org id.');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
debug('begin parameter validation: p_section');
IF p_section IS NOT NULL AND p_section NOT IN ( '1','2','3','4','5') THEN
   print_error('INVALID ARGUMENT: Please select any value');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_section');
...
debug('Additional Code Validation After');

debug('Additional Code Validation: p_org_id=' || p_org_id);
debug('Additional Code Validation: p_period_id=' || p_period_id);
debug('Additional Code Validation: p_salesrep_id=' || p_salesrep_id);


debug('Additional Code Validation: g_org_id=' || g_org_id);
debug('Additional Code Validation: g_period_id=' || g_period_id);
debug('Additional Code Validation: g_salesrep_id=' || g_salesrep_id);
debug('Additional Code Validation: g_payrun_id=' || g_payrun_id);

BEGIN
	Select count(1) into g_srp_count
	FROM jtf.jtf_rs_salesreps cns
	WHERE cns.salesrep_id = g_salesrep_id;
	
	if (g_srp_count = 0) then
		debug('Please enter a valid Salesrep_id!.');	
                raise invalid_parameters;  
	End if;
...
if (p_period_id != 0) then
	...
	debug('In If Additional Code Validation p_period_id=' || p_period_id);

	BEGIN
		SELECT cns.salesrep_id, cnp.payrun_id, cnp.org_id
		INTO g_salesrep_id, g_payrun_id, g_org_id
		FROM jtf.jtf_rs_salesreps cns,
		cn.cn_payruns_all cnp,
		cn.cn_period_statuses_all cnps,
		cn.cn_srp_pay_groups_all cnspg
		WHERE cns.salesrep_id = g_salesrep_id 
		AND cns.salesrep_id = cnspg.salesrep_id
		and cns.org_id = cnspg.org_id
		AND cnspg.pay_group_id = cnp.pay_group_id
		and cnspg.org_id = cnp.org_id
		AND cnp.status = 'UNPAID'
		AND cnp.pay_period_id = cnps.period_id
		and cnp.org_id = cnps.org_id
		AND ((cnspg.start_date <= cnps.end_date)
		AND (cnps.start_date <= NVL(cnspg.end_date,cnps.start_date))) ;
	...
	debug('In Else Additional Code Validation p_period_id=' || p_period_id);

	BEGIN
		SELECT cns.salesrep_id, cnp.payrun_id, cnp.pay_period_id, cnp.org_id
		INTO g_salesrep_id, g_payrun_id, g_period_id, g_org_id
		FROM jtf.jtf_rs_salesreps cns,
		cn.cn_payruns_all cnp,
		cn.cn_period_statuses_all cnps,
		cn.cn_srp_pay_groups_all cnspg
...
debug('1 Additional Code Validation: g_period_id=' || g_period_id);
debug('1 Additional Code Validation: g_salesrep_id=' || g_salesrep_id);
debug('1 Additional Code Validation: g_payrun_id=' || g_payrun_id);
debug('1 Additional Code Validation: g_org_id=' || g_org_id);

debug('2 Additional Code Validation: p_org_id =' || p_org_id);
debug('2 Additional Code Validation: p_period_id =' || p_period_id);


Begin

	SELECT nvl(sum(nvl(srp.balance2_dtd,0) - nvl(srp.balance2_ctd,0) +
	nvl(srp.balance2_bbd,0) - nvl(srp.balance2_bbc,0)),0)
	INTO g_subledger_total
	FROM cn.cn_srp_periods_all srp
	WHERE srp.period_id = g_period_id
	AND srp.salesrep_id = g_salesrep_id
	AND srp.credit_type_id = -1000
	AND srp.org_id = g_org_id
...
debug('2.1 Additional Code Validation: g_subledger_total=' || g_subledger_total);

Begin

	SELECT nvl(sum(nvl(amount,0)),0)
	INTO g_payment_total
	FROM cn.cn_payment_transactions_all pmt
	WHERE pmt.pay_period_id <= g_period_id
	AND pmt.credited_salesrep_id = g_salesrep_id
	AND pmt.credit_type_id = -1000
	AND pmt.incentive_type_code in ('COMMISSION', 'BONUS')
	AND pmt.org_id = g_org_id
	AND (pmt.payrun_id IS NULL OR pmt.payrun_id = g_payrun_id );
...
debug('2.3 Additional Code Validation: g_payment_total=' || g_payment_total);

Begin

	SELECT Nvl(SUM(Nvl(commission_amount,0)),0)
	INTO g_commission_total
	FROM cn.cn_commission_lines_all ccl
	WHERE credited_salesrep_id = g_salesrep_id
	AND processed_period_id <= g_period_id
	AND credit_type_id = -1000
	AND status = 'CALC'
	AND Nvl(posting_status,'UNPOSTED') = 'UNPOSTED'
	AND srp_payee_assign_id IS NULL
	AND ccl.org_id = g_org_id
	...
	AND pmt.incentive_type_code IN ('COMMISSION', 'BONUS')
	AND pmt.org_id = g_org_id
	AND pmt.payrun_id = g_payrun_id );

exception
	When others then
	g_commission_total := 0;	
End;	

debug('2.5 Additional Code Validation: g_commission_total=' || g_commission_total);

g_difference := g_subledger_total - g_payment_total - g_commission_total;

debug('2.7 Additional Code Validation: g_difference=' || g_difference);

debug('Additional Code Validation 2.8 : g_salesrep_id=' || g_salesrep_id);

Begin
	select srp_plan_assign_id
	INTO g_srp_plan_assign_id
	from cn_srp_plan_assigns a, cn_comp_plans c
	where salesrep_id = g_salesrep_id
	and a.comp_plan_id = c.comp_plan_id
	AND ROWNUM < 2
	order by a.start_date;

exception
	When others then
	g_srp_plan_assign_id := 0;	
End;	

debug('2.8 Additional Code Validation: g_salesrep_id=' || g_salesrep_id || ' and   g_srp_plan_assign_id=' || g_srp_plan_assign_id);


debug('Additional Code Validation 2.9 : g_pay_group_id=' || g_pay_group_id);
...
Begin
	...
	where SALESREP_ID = g_salesrep_id
	and role_pay_group_id is not null;
exception
	When others then
	g_pay_group_id := 0;	
End;	

debug('2.9 Additional Code Validation: g_salesrep_id=' || g_salesrep_id || ' and  g_pay_group_id=' || g_pay_group_id);
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$SALESREP_ID$$##') := p_salesrep_id;
   g_masked_tokens('##$$SALESREP_ID$$##') := mask_text( g_sql_tokens('##$$SALESREP_ID$$##'), 'NO_MASK');
   ...
   g_sql_tokens('##$$PAYMENT_TOTAL$$##') := g_payment_total;
   g_masked_tokens('##$$PAYMENT_TOTAL$$##') := mask_text( g_sql_tokens('##$$PAYMENT_TOTAL$$##'), 'NO_MASK');
   g_sql_tokens('##$$PAYRUN_ID$$##') := g_payrun_id;
   g_masked_tokens('##$$PAYRUN_ID$$##') := mask_text( g_sql_tokens('##$$PAYRUN_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$SUBLEDGER_TOTAL$$##') := g_subledger_total;
   g_masked_tokens('##$$SUBLEDGER_TOTAL$$##') := mask_text( g_sql_tokens('##$$SUBLEDGER_TOTAL$$##'), 'NO_MASK');
   g_sql_tokens('##$$DIFFERENCE$$##') := g_difference;
   g_masked_tokens('##$$DIFFERENCE$$##') := mask_text( g_sql_tokens('##$$DIFFERENCE$$##'), 'NO_MASK');
   g_sql_tokens('##$$COMMISSION_TOTAL$$##') := g_commission_total;
   g_masked_tokens('##$$COMMISSION_TOTAL$$##') := mask_text( g_sql_tokens('##$$COMMISSION_TOTAL$$##'), 'NO_MASK');
   g_sql_tokens('##$$SRPPLANASSIGNID$$##') := g_srp_plan_assign_id;
   g_masked_tokens('##$$SRPPLANASSIGNID$$##') := mask_text( g_sql_tokens('##$$SRPPLANASSIGNID$$##'), 'NO_MASK');
   g_sql_tokens('##$$PAYGROUPID$$##') := g_pay_group_id;
   g_masked_tokens('##$$PAYGROUPID$$##') := mask_text( g_sql_tokens('##$$PAYGROUPID$$##'), 'NO_MASK');
   g_sql_tokens('##$$PERIOD_ID$$##') := g_period_id;
   g_masked_tokens('##$$PERIOD_ID$$##') := mask_text( g_sql_tokens('##$$PERIOD_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$ORG_ID$$##') := g_org_id;
   g_masked_tokens('##$$ORG_ID$$##') := mask_text( g_sql_tokens('##$$ORG_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$APP_NAME$$##') := g_app_name;
   g_masked_tokens('##$$APP_NAME$$##') := mask_text( g_sql_tokens('##$$APP_NAME$$##'), 'NO_MASK');
...
debug('begin add_signature: EBS_CRM_SM_VW_OBJ_MAX_FET_SIZE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30112',
      p_sig_id                 => 'EBS_CRM_SM_VW_OBJ_MAX_FET_SIZE',
      p_sig_sql                => 'SELECT
            a.profile_option_id,
            b.last_update_date,
            ...
            b.last_updated_by,
            decode(b.level_id, ''10001'', ''SITE'', ''10002'', ''APPLICATION'',
                   ''10003'', ''RESPONSIBILITY'', ''10004'', ''USER'')    levelid,
            b.level_value level_value,
            b.profile_option_value pov,
        ...
        WHERE
            ...
            AND c.user_profile_option_name LIKE ''FND: View Object Max Fetch Size%''',
      p_title                  => 'View Object Fetch Maximum Size',
      p_fail_condition         => '[pov] < [200]',
      p_problem_descr          => 'Displaying the  View Object Max fetch size for configuring additional columns in Oracle Incentive Compensation --> Warning - Query has exceeded 200 rows. Potentially more rows exists, please restrict your query',
      p_solution               => 'Please refer to Cannot Fetch More than 200 Records when Searching Tables & Columns, Revenue Classes [579268.1] for more information',
      p_success_msg            => 'Profile Option Setup Value',
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_VW_OBJ_MAX_FET_SIZE');



debug('begin add_signature: EBS_CRM_SM_CN_INVALIDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30216',
      p_sig_id                 => 'EBS_CRM_SM_CN_INVALIDS',
    ...
    AND a.owner = ''APPS''
    AND (a.object_name like ''CN%'')
    AND a.status = ''INVALID''',
      p_title                  => 'Invalid Objects Exist Related to Incentive Compensation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Checking if Invalid Objects exist related to Incentive Compensation',
...
<li>If you still have invalid objects, please review steps from [1325394.1] Troubleshooting Guide - Invalid Objects in the E-Business Suite Environment 11i and 12.</li>
      ...
      p_success_msg            => 'No invalid objects indicated. All objects beginning with CN_ were validated',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_INVALIDS');



debug('begin add_signature: EBS_CRM_SM_CN_FREEZE_DFF_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30217',
      p_sig_id                 => 'EBS_CRM_SM_CN_FREEZE_DFF_CHECK',
      p_sig_sql                => 'SELECT
...
WHERE
    ...
    AND EXISTS (
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are DFF definition in the instance which are not frozen.  Such DFF fields will not work correctly on the application and may encounter error. 

The descriptive flexfield with application name &APPLICATION_NAME (&APPLICATION_SHORT_NAME) and name &DESCRIPTIVE_FLEXFIELD_TITLE (&DESCRIPTIVE_FLEXFIELD_NAME) is not frozen. Please contact your system administrator.',
      p_solution               => 'See the  [989119.1] for solution.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_FREEZE_DFF_CHECK');



debug('begin add_signature: EBS_CRM_SM_PERF_DB_10_PER_MODIFIED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30704',
      p_sig_id                 => 'EBS_CRM_SM_PERF_DB_10_PER_MODIFIED',
...
Please refer to [1586374.1] Best Practices for Gathering Statistics with Oracle E-Business Suite.
',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_PERF_DB_10_PER_MODIFIED');



debug('begin add_signature: EBS_CRM_SM_PERF_DB_CBO_STATS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30705',
      p_sig_id                 => 'EBS_CRM_SM_PERF_DB_CBO_STATS',
      p_sig_sql                => 'SELECT
   owner  ,
...
For more information, please review Troubleshooting Oracle Applications Performance Issues [169935.1].
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_PERF_DB_CBO_STATS');
...
Oracle E-Business Suite requires several database initialization parameters to be set correctly in order to ensure optimal performance. Refer to My Oracle Support Knowledge [396009.1], and ensure that you have configured the parameters according to this note.<br><br>
...
debug('begin add_signature: EBS_CRM_SM_TBL_ROW_LOCK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31121',
      p_sig_id                 => 'EBS_CRM_SM_TBL_ROW_LOCK',
      p_sig_sql                => 'SELECT /*+ rule */
    S.USERNAME,
...
WHERE
    ...
    AND DECODE(L.TYPE, ''TM'', ''TABLE LOCK'', ''TX'',/*''ROW LOCK'',*/ NULL) IS NOT NULL',
      p_title                  => 'Table and Row level Locks',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are table and row level locks. Please review the object_names relevant to the module and check the SQLID
',
      p_solution               => '',
      p_success_msg            => 'There are no table and row level locks',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_TBL_ROW_LOCK');



debug('begin add_signature: EBS_CRM_SM_10_EXPENSIVE_BUFFER_GET');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31122',
      p_sig_id                 => 'EBS_CRM_SM_10_EXPENSIVE_BUFFER_GET',
      p_sig_sql                => 'SELECT ROWNUM AS rank, a.*
FROM (SELECT buffer_gets,
executions,
buffer_gets / decode(executions, 0, 1, executions) gets_per_exec,
hash_value,
SUBSTR(sql_text, 1, 100) as sql_text_val
FROM v$sqlarea
...
WHERE ROWNUM < 11',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Top 10 Most Expensive SQL (Buffer Gets), please review and check if there are any sql queries relevant to your module
',
      p_solution               => '',
      p_success_msg            => 'There are no expensive sql queries',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_10_EXPENSIVE_BUFFER_GET');



debug('begin add_signature: EBS_CRM_SM_SRP_BATCH_SIZE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29714',
      p_sig_id                 => 'EBS_CRM_SM_SRP_BATCH_SIZE',
      p_sig_sql                => 'select repository_id,status,NVL(SALESREP_BATCH_SIZE,0) "SALESREP BATCH SIZE",transfer_batch_size
from CN_REPOSITORIES_ALL
where org_id=  ##$$ORG_ID$$##
and status= ''A''
and NVL(SALESREP_BATCH_SIZE,0) <= 0',
      p_title                  => 'Salesrep Batch Size',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Salesrep Batch size is not set or has a zero value',
      p_solution               => 'Make sure you have Salesrep Batch Size value set to a value greater than zero.
Please follow the solution from the [3044265.1]',
      p_success_msg            => ' Salesrep Batch Size Check passed',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_SRP_BATCH_SIZE');



debug('begin add_signature: EBS_CRM_SM_TRX_BATCH_SIZE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29640',
      p_sig_id                 => 'EBS_CRM_SM_TRX_BATCH_SIZE',
      p_sig_sql                => 'SELECT REPOSITORY_ID,STATUS, NVL(SRP_BATCH_SIZE,0) "TRANSACTION BATCH SIZE",TRANSFER_BATCH_SIZE
FROM CN_REPOSITORIES_ALL
WHERE ORG_ID=  ##$$ORG_ID$$## 
AND STATUS= ''A''
AND NVL(SRP_BATCH_SIZE,0) <= 0',
      p_title                  => 'Transaction Batch Size',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transaction Batch size is not set or has zero value',
      p_solution               => 'Make sure you have Transaction Batch Size value set to a value greater than zero.
Please review guidelines from the KM [1600221.1]',
      p_success_msg            => ' ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_TRX_BATCH_SIZE');



debug('begin add_signature: EBS_CRM_SM_CN_DFF_DEFINED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30218',
      p_sig_id                 => 'EBS_CRM_SM_CN_DFF_DEFINED',
      p_sig_sql                => 'SELECT 
A.DESCRIPTIVE_FLEXFIELD_NAME
, B.TITLE
, B.APPLICATION_TABLE_NAME
, B.CONCATENATED_SEGS_VIEW_NAME
, B.FREEZE_FLEX_DEFINITION_FLAG
, A.DESCRIPTIVE_FLEX_CONTEXT_CODE CONTEXT_CODE
, A.DESCRIPTIVE_FLEX_CONTEXT_NAME CONTEXT_NAME
, A.ENABLED_FLAG CONTEXT_ENABLE_FLAG
, ATT.COLUMN_SEQ_NUM SEGMENT_NUMBER
, ATT.FORM_LEFT_PROMPT SEGMENT_NAME
, ATT.APPLICATION_COLUMN_NAME COLUMN_NAME
, FVS.FLEX_VALUE_SET_NAME VALUE_SET_NAME
, ATT.DISPLAY_FLAG DISPLAYED_FLAG
, ATT.ENABLED_FLAG ENABLED_FLAG
, ATT.REQUIRED_FLAG REQUIRED_FLAG
FROM
...
WHERE
1 = 1
AND A.APPLICATION_ID IN (##$$APPS_PARAM1$$##, ##$$APPS_PARAM2$$##, ##$$APPS_PARAM3$$##, ##$$APPS_PARAM4$$##, ##$$APPS_PARAM5$$##, 0)
AND A.APPLICATION_ID != 0
AND A.APPLICATION_ID=B.APPLICATION_ID
AND A.DESCRIPTIVE_FLEXFIELD_NAME = B.DESCRIPTIVE_FLEXFIELD_NAME
AND A.DESCRIPTIVE_FLEX_CONTEXT_CODE=ATT.DESCRIPTIVE_FLEX_CONTEXT_CODE
AND A.DESCRIPTIVE_FLEXFIELD_NAME = ATT.DESCRIPTIVE_FLEXFIELD_NAME
AND FVS.FLEX_VALUE_SET_ID(+)=ATT.FLEX_VALUE_SET_ID
AND B.TITLE NOT LIKE ''$SRS$%''
ORDER BY
DECODE(A.GLOBAL_FLAG, ''Y'', 1, 2),
A.DESCRIPTIVE_FLEX_CONTEXT_CODE,
ATT.COLUMN_SEQ_NUM
',
      p_title                  => 'DFF Defined in Incentive Compensation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying DFF Defined in Incentive Compensation',
      p_solution               => '',
      p_success_msg            => 'There are no Active DFF Defined in Incentive Compensation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_DFF_DEFINED');



debug('begin add_signature: EBS_CRM_SM_CN_DUP_SCA_RUL_ATTRIB_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30029',
      p_sig_id                 => 'EBS_CRM_SM_CN_DUP_SCA_RUL_ATTRIB_ID',
      p_sig_sql                => 'SELECT SCA_RULE_ATTRIBUTE_ID, ORG_ID, LANGUAGE, count(*)
FROM CN.CN_SCA_RULE_ATTRIBUTES_ALL_TL
WHERE ORG_ID IS NULL
GROUP BY SCA_RULE_ATTRIBUTE_ID, ORG_ID, LANGUAGE
HAVING count(*)>1',
      p_title                  => 'Duplicate SCA_RULE_ATTRIBUTE_ID in CN_SCA_RULE_ATTRIBUTES_ALL_TL ',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Duplicate SCA_RULE_ATTRIBUTE_ID in CN_SCA_RULE_ATTRIBUTES_ALL_TL due to orphaned records in the CN_SCA_RULE_ATTRIBUTES_ALL_TL table that do not have an ORG_ID',
      p_solution               => 'Please refer [1674721.1] in order to see a potential datafix',
      p_success_msg            => 'Check passed for duplicate SCA_RULE_ATTRIBUTE_ID which are having ORG_ID populated in CN_SCA_RULE_ATTRIBUTES_ALL_TL table',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_DUP_SCA_RUL_ATTRIB_ID');



debug('begin add_signature: EBS_CRM_SM_DUP_SALES_REP_IDS');
   l_info('##MASK##NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29715',
      p_sig_id                 => 'EBS_CRM_SM_DUP_SALES_REP_IDS',
      p_sig_sql                => 'select  salesrep_id, resource_id,name
from jtf_rs_Salesreps jrs
where status = ''A''
and NVL(end_date_active,sysdate+1) > sysdate
and salesrep_id =  ##$$SALESREP_ID$$##
group by salesrep_id,resource_id,name
having count(org_id) > 1
',
      p_title                  => 'Duplicate SALESREP_ID in JTF_RS_SALESREPS',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Duplicate SALESREP_ID''s are found in JTF_RS_SALESREPS table.',
      p_solution               => 'Please refer [3044241.1] in order to see a potential datafix.',
      p_success_msg            => 'Check passed for duplicate salesrep Id''s',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_DUP_SALES_REP_IDS');



debug('begin add_signature: EBS_CRM_SM_PAYMENT_RESOURCE_CHECK');
   l_info('##MASK##SOURCE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30108',
      p_sig_id                 => 'EBS_CRM_SM_PAYMENT_RESOURCE_CHECK',
...
r.user_id ,
p.PERSON_IDENTIFIER ,
b.name business_grp_name,
s.salesrep_id
from hz_parties p, per_people_f f, jtf_rs_resource_extns r,
hr_all_organization_units b, JTF_RS_SALESREPS s
where p.party_type = ''PERSON''
and p.person_identifier = to_char(f.person_id)
and ltrim(p.orig_system_reference,''PER:'') = to_char(r.source_id)
and r.resource_id = s.resource_id
and s.status= ''A''
and NVL(s.end_date_active,sysdate+1) > SYSDATE
and f.business_group_id = b.ORGANIZATION_ID
and s.salesrep_id= ##$$SALESREP_ID$$##
',
      p_title                  => 'Payment Resource Availability in HRMS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Payment resource does not exists in HRMS
',
      p_solution               => 'Please refer [1205043.1#aref_section32] for more details',
      p_success_msg            => 'Payment resource exists in HRMS',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_PAYMENT_RESOURCE_CHECK');



debug('begin add_signature: EBS_CRM_SM_PAYMENT_GROUP_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30110',
      p_sig_id                 => 'EBS_CRM_SM_PAYMENT_GROUP_CHECK',
      p_sig_sql                => 'select group_usage_id, group_id, usage, object_version_number,
created_by, creation_date, last_updated_by, last_update_date
from jtf_rs_group_usages
where usage = ''COMP_PAYMENT''',
      p_title                  => 'Payment Group Availability With Usage type COMP_PAYMENT',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Payment group exists with the usage type as ''COMP_PAYMENT''',
      p_solution               => 'Please refer [1205043.1#aref_section32] for more details',
      p_success_msg            => 'Payment group with usage type as ''COMP_PAYMENT'' exists',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_PAYMENT_GROUP_CHECK');



debug('begin add_signature: EBS_CRM_SM_PAY_ROLE_USAGE_TYPE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30109',
      p_sig_id                 => 'EBS_CRM_SM_PAY_ROLE_USAGE_TYPE',
      p_sig_sql                => 'select role_id, role_code, role_type_code, member_flag "Member Flag", admin_flag "Admin Flag", manager_flag "Manager Flag"
from jtf_rs_roles_b
where role_type_code = ''SALES_COMP_PAYMENT_ANALIST''
',
      p_title                  => 'Payment Role Availability With Role Type SALES_COMP_PAYMENT_ANALIST',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Payment Role exists with the  role_type_code as ''SALES_COMP_PAYMENT_ANALIST''',
      p_solution               => 'Please refer [1205043.1#aref_section32] for more details',
      p_success_msg            => 'Payment Role exists with the  role_type_code as ''SALES_COMP_PAYMENT_ANALIST''',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_PAY_ROLE_USAGE_TYPE');



debug('begin add_signature: EBS_CRM_SM_CN_SALESREPS');
   l_info('##MASK##RESOURCE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29848',
      p_sig_id                 => 'EBS_CRM_SM_CN_SALESREPS',
      p_sig_sql                => 'select re.resource_id,s.salesrep_id,re.resource_name,s.salesrep_number,re.category
from jtf_rs_resource_extns_vl re, jtf_rs_salesreps s
where re.resource_id = s.resource_id
AND s.salesrep_id = ##$$SALESREP_ID$$##
AND s.ORG_ID = ##$$ORG_ID$$##
and category <> ''TBH''',
      p_title                  => 'Salesrep Information',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  CN_SALESREPS details for the salesrep',
      p_solution               => '',
      p_success_msg            => 'There  are no records in table  CN_SALESREPS for the salesrep',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_SALESREPS');



debug('begin add_signature: EBS_CRM_SM_CN_SRP_ROLES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29849',
      p_sig_id                 => 'EBS_CRM_SM_CN_SRP_ROLES',
      p_sig_sql                => 'SELECT s.org_id, rr.role_relate_id, s.salesrep_id, (r.role_id || '' - '' || r.role_name) as RoleIdName, rr.start_date_active, rr.end_date_active
from jtf_rs_role_relations rr, jtf_rs_salesreps s,jtf_rs_roles_vl r
...
and s.salesrep_id = ##$$SALESREP_ID$$##',
      p_title                  => 'Salesrep Roles',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  CN_SRP_ROLES details for the salesrep',
      p_solution               => '',
      p_success_msg            => 'There  are no records in table  CN_SRP_ROLES for the salesrep',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_SRP_ROLES');



debug('begin add_signature: EBS_CRM_SM_CN_SRP_INTEL_PERIODS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29850',
      p_sig_id                 => 'EBS_CRM_SM_CN_SRP_INTEL_PERIODS',
      p_sig_sql                => 'select SRP_INTEL_PERIOD_ID,SALESREP_ID,PERIOD_ID,END_DATE,PROCESSING_STATUS_CODE
from cn_srp_intel_periods_all
where SALESREP_ID = ##$$SALESREP_ID$$##
order by org_id,to_number(period_id) desc',
      p_title                  => 'Salesrep Intel Periods',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  CN_SRP_INTEL_PERIODS details for the salesrep',
      p_solution               => '',
      p_success_msg            => 'There  are no records in table  CN_SRP_INTEL_PERIODS for the salesrep',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_SRP_INTEL_PERIODS');



debug('begin add_signature: EBS_CRM_SM_CN_SRP_PMT_PLANS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29851',
      p_sig_id                 => 'EBS_CRM_SM_CN_SRP_PMT_PLANS_ALL',
      p_sig_sql                => 'select SRP_PMT_PLAN_ID,PMT_PLAN_ID,ROLE_ID,SALESREP_ID,CREDIT_TYPE_ID,START_DATE,END_DATE,MAXIMUM_AMOUNT,
MINIMUM_AMOUNT,LOCK_FLAG,ROLE_PMT_PLAN_ID,SRP_ROLE_ID
from CN_SRP_PMT_PLANS_ALL
where SALESREP_ID = ##$$SALESREP_ID$$##
',
      p_title                  => 'Salesrep Payment Plans',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  CN_SRP_PMT_PLANS_ALL details for the salesrep',
      p_solution               => '',
      p_success_msg            => 'There  are no records in table  CN_SRP_PMT_PLANS_ALL for the salesrep',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_SRP_PMT_PLANS_ALL');



debug('begin add_signature: EBS_CRM_SM_CN_RES_PAYGROUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30194',
      p_sig_id                 => 'EBS_CRM_SM_CN_RES_PAYGROUP',
      p_sig_sql                => 'SELECT
   *
FROM
   (
       SELECT
           srppaygroupeo.org_id,
           srppaygroupeo.srp_pay_group_id,
           srppaygroupeo.salesrep_id,
           srppaygroupeo.pay_group_id,
           srppaygroupeo.start_date,
           srppaygroupeo.end_date,
           srppaygroupeo.lock_flag,
           srppaygroupeo.object_version_number,
           srppaygroupeo.role_pay_group_id,
           cs.name   AS salesrep_name,
           f.role_name,
           ''N''       AS select_text,
           ''N''       AS disable_check_box,
           0         AS read_only,
           decode(nvl(srppaygroupeo.role_pay_group_id, - 1),
                  - 1,
                  0,
                  1) AS role_link
       FROM
                cn_srp_pay_groups srppaygroupeo
           JOIN cn_salesreps cs ON srppaygroupeo.salesrep_id =
cs.salesrep_id
                                   AND srppaygroupeo.org_id = cs.org_id
           LEFT OUTER JOIN (
               SELECT
                   crpg.role_pay_group_id,
                   crpg.org_id,
                   cr.name AS role_name
               FROM
                   cn_role_pay_groups crpg,
                   cn_roles           cr
               WHERE
                   crpg.role_id = cr.role_id
           )            f ON srppaygroupeo.role_pay_group_id =
f.role_pay_group_id
                  AND srppaygroupeo.org_id = f.org_id
   ) qrslt
WHERE
...
ORDER BY
   salesrep_name ASC,
   start_date DESC',
      p_title                  => 'Resources Linked to the Paygroup',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying resources linked to the Paygroup',
      p_solution               => '',
      p_success_msg            => 'There  are no resources linked to the Paygroup',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_RES_PAYGROUP');



debug('begin add_signature: EBS_CRM_SM_CN_SRP_PLAN_ASSIGNS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29853',
      p_sig_id                 => 'EBS_CRM_SM_CN_SRP_PLAN_ASSIGNS_ALL',
      p_sig_sql                => 'SELECT SRP_PLAN_ASSIGN_ID,SALESREP_ID,COMP_PLAN_ID,ORG_ID,
ROLE_ID,SRP_ROLE_ID,START_DATE,END_DATE,ROLE_PLAN_ID,
CREATED_BY,CREATION_DATE
FROM CN_SRP_PLAN_ASSIGNS_ALL
WHERE SALESREP_ID = ##$$SALESREP_ID$$##',
      p_title                  => 'Salesrep Plan Assignments',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  CN_SRP_PLAN_ASSIGNS_ALL details for the salesrep',
      p_solution               => '',
      p_success_msg            => 'There  are no records in table  CN_SRP_PLAN_ASSIGNS_ALL for the salesrep',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_SRP_PLAN_ASSIGNS_ALL');



debug('begin add_signature: EBS_CRM_SM_CN_SPA_BY_SRP_PLAN_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29854',
      p_sig_id                 => 'EBS_CRM_SM_CN_SPA_BY_SRP_PLAN_ID',
      p_sig_sql                => 'SELECT SRP_PLAN_ASSIGN_ID,SALESREP_ID,COMP_PLAN_ID,ORG_ID,
ROLE_ID,SRP_ROLE_ID,START_DATE,END_DATE,ROLE_PLAN_ID,
CREATED_BY,CREATION_DATE
FROM CN_SRP_PLAN_ASSIGNS_ALL
WHERE SRP_PLAN_ASSIGN_ID = ##$$SRPPLANASSIGNID$$##
ORDER BY CREATION_DATE DESC',
      p_title                  => 'Plan Assignments by Salesrep Plan Id',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  CN_SRP_PLAN_ASSIGNS_ALL details for the salesrep by SRP Plan Id',
      p_solution               => '',
      p_success_msg            => 'There  are no records in table  CN_SRP_PLAN_ASSIGNS_ALL for the salesrep By SRP Plan Id',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_SPA_BY_SRP_PLAN_ID');



debug('begin add_signature: EBS_CRM_SM_CN_SQA_BY_SRP_PLAN_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29855',
      p_sig_id                 => 'EBS_CRM_SM_CN_SQA_BY_SRP_PLAN_ID',
      p_sig_sql                => 'select SRP_QUOTA_ASSIGN_ID,QUOTA_ID,PERIOD_TYPE_CODE,
RATE_SCHEDULE_ID,QUOTA_TYPE_CODE,CUSTOMIZED_FLAG,
TARGET,PAYMENT_AMOUNT,PERFORMANCE_GOAL,ORG_ID
from CN_SRP_QUOTA_ASSIGNS_ALL
WHERE SRP_PLAN_ASSIGN_ID = ##$$SRPPLANASSIGNID$$##',
      p_title                  => 'Quota Assignments by Salesrep Plan Id',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  CN_SRP_QUOTA_ASSIGNS_ALL details by SRP Plan Id',
      p_solution               => '',
      p_success_msg            => 'There  are no records in table  CN_SRP_QUOTA_ASSIGNS_ALL By SRP Plan Id',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_SQA_BY_SRP_PLAN_ID');



debug('begin add_signature: EBS_CRM_SM_CN_SPQ_BY_SRP_PLAN_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29856',
      p_sig_id                 => 'EBS_CRM_SM_CN_SPQ_BY_SRP_PLAN_ID',
      p_sig_sql                => 'select SRP_PERIOD_QUOTA_ID,SRP_QUOTA_ASSIGN_ID,QUOTA_ID,PERIOD_ID,
TARGET_AMOUNT,QUOTA_ACHIEVED_PTD,COMMISSION_PAYED_PTD, COMMISSION_PAYED_YTD,
QUOTA_ACHIEVED_YTD,org_id,Itd_Target,Itd_Payment,trx_amount_ptd,TRX_AMOUNT_YTD
from CN_SRP_PERIOD_QUOTAS_ALL where srp_plan_assign_id = ##$$SRPPLANASSIGNID$$##
order by QUOTA_ID,PERIOD_ID',
      p_title                  => 'Period Quotas by Salesrep Plan Id',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  CN_SRP_PERIOD_QUOTAS_ALL details by SRP Plan Id',
      p_solution               => '',
      p_success_msg            => 'There  are no records in table  CN_SRP_PERIOD_QUOTAS_ALL By SRP Plan Id',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_SPQ_BY_SRP_PLAN_ID');



debug('begin add_signature: EBS_CRM_SM_CN_SRA_BY_PLAN_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29857',
      p_sig_id                 => 'EBS_CRM_SM_CN_SRA_BY_PLAN_ID',
      p_sig_sql                => 'select SRP_RATE_ASSIGN_ID,SRP_QUOTA_ASSIGN_ID,QUOTA_ID,RATE_SCHEDULE_ID,RATE_TIER_ID,
RATE_SEQUENCE,COMMISSION_AMOUNT,org_id
from CN_SRP_RATE_ASSIGNS_ALL
where srp_plan_assign_id = ##$$SRPPLANASSIGNID$$##
order by QUOTA_ID,RATE_SCHEDULE_ID,RATE_SEQUENCE',
      p_title                  => 'Rate Assignments by Salesrep Plan Id',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  CN_SRP_RATE_ASSIGNS_ALL details by SRP Plan Id',
      p_solution               => '',
      p_success_msg            => 'There  are no records in table  CN_SRP_RATE_ASSIGNS_ALL By SRP Plan Id',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_SRA_BY_PLAN_ID');



debug('begin add_signature: EBS_CRM_SM_CN_RATE_TIERS_BY_PLAN_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30023',
      p_sig_id                 => 'EBS_CRM_SM_CN_RATE_TIERS_BY_PLAN_ID',
      p_sig_sql                => 'SELECT	
CRT.RATE_TIER_ID          
, CRT.RATE_SCHEDULE_ID      
, CRT.MINIMUM_PERCENT       
, CRT.MAXIMUM_PERCENT       
, CRT.COMMISSION_RATE       
...
, CRT.RATE_SEQUENCE         
FROM
    CN_SRP_RATE_ASSIGNS_ALL SRA,
    CN_RATE_TIERS_ALL       CRT
WHERE
        CRT.RATE_TIER_ID = SRA.RATE_TIER_ID
    AND SRA.SRP_PLAN_ASSIGN_ID = ##$$SRPPLANASSIGNID$$##
ORDER BY
    CRT.RATE_SEQUENCE ASC',
      p_title                  => 'Rate Tiers by Salesrep Plan Id',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  CN_SRP_RATE_TIERS_ALL details by SRP Plan Id',
      p_solution               => '',
      p_success_msg            => 'There  are no records in table  CN_SRP_RATE_TIERS_ALL By SRP Plan Id',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_RATE_TIERS_BY_PLAN_ID');



debug('begin add_signature: EBS_CRM_SM_CN_SQR_BY_PLAN_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29858',
      p_sig_id                 => 'EBS_CRM_SM_CN_SQR_BY_PLAN_ID',
      p_sig_sql                => 'select SRP_QUOTA_RULE_ID,SRP_QUOTA_ASSIGN_ID,QUOTA_RULE_ID,REVENUE_CLASS_ID,
TARGET,PAYMENT_AMOUNT,PERFORMANCE_GOAL,org_id
from CN_SRP_QUOTA_RULES_ALL where srp_plan_assign_id = ##$$SRPPLANASSIGNID$$##
order by SRP_QUOTA_ASSIGN_ID',
      p_title                  => 'Quota Rules by Salesrep Plan Id',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  CN_SRP_QUOTA_RULES_ALL details by SRP Plan Id',
      p_solution               => '',
      p_success_msg            => 'There  are no records in table  CN_SRP_QUOTA_RULES_ALL By SRP Plan Id',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_SQR_BY_PLAN_ID');



debug('begin add_signature: EBS_CRM_SM_CN_SQRU_BY_PLAN_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29859',
      p_sig_id                 => 'EBS_CRM_SM_CN_SQRU_BY_PLAN_ID',
      p_sig_sql                => 'select u.SRP_RULE_UPLIFT_ID,u.QUOTA_RULE_UPLIFT_ID,u.SRP_QUOTA_RULE_ID,u.PAYMENT_FACTOR,u.QUOTA_FACTOR
from cn_srp_rule_uplifts_all u,cn_srp_quota_rules_all r
where u.SRP_QUOTA_RULE_ID = r.SRP_QUOTA_RULE_ID
and r.srp_plan_assign_id = ##$$SRPPLANASSIGNID$$##
order by SRP_QUOTA_RULE_ID',
      p_title                  => 'Quota Rule Uplifts by Salesrep Plan Id',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  CN_SRP_QUOTA_RULE_UPLIFTS_ALL details by SRP Plan Id',
      p_solution               => '',
      p_success_msg            => 'There  are no records in table  CN_SRP_QUOTA_RULE_UPLIFTS_ALL By SRP Plan Id',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_SQRU_BY_PLAN_ID');



debug('begin add_signature: EBS_CRM_SM_CN_SPQR_BY_PLAN_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29860',
      p_sig_id                 => 'EBS_CRM_SM_CN_SPQR_BY_PLAN_ID',
      p_sig_sql                => 'SELECT SRP_PER_QUOTA_RC_ID,SRP_PERIOD_QUOTA_ID,SRP_PLAN_ASSIGN_ID,REVENUE_CLASS_ID,PERIOD_ID,
QUOTA_ID,SALESREP_ID,TARGET_AMOUNT,YEAR_TO_DATE,PERIOD_TO_DATE,QUARTER_TO_DATE,ORG_ID,
PERIOD_TO_DATE_F,YEAR_TO_DATE_F
FROM CN_SRP_PER_QUOTA_RC_ALL where SRP_PLAN_ASSIGN_ID = ##$$SRPPLANASSIGNID$$##
ORDER BY QUOTA_ID,REVENUE_CLASS_ID,PERIOD_ID',
      p_title                  => 'Quota Revenue Class by Salesrep Plan Id',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  CN_SRP_PER_QUOTA_RC_ALL details by SRP Plan Id',
      p_solution               => '',
      p_success_msg            => 'There  are no records in table  CN_SRP_PER_QUOTA_RC_ALL By SRP Plan Id',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_SPQR_BY_PLAN_ID');



debug('begin add_signature: EBS_CRM_SM_CN_SPQE_BY_PLAN_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29862',
      p_sig_id                 => 'EBS_CRM_SM_CN_SPQE_BY_PLAN_ID',
      p_sig_sql                => 'select SRP_PERIOD_QUOTA_EXT_ID,ext.SRP_PERIOD_QUOTA_ID,ext.INPUT_SEQUENCE,ext.INPUT_ACHIEVED_PTD
from cn_srp_period_quotas_ext_all ext,cn_srp_period_quotas_all spq
where spq.srp_period_quota_id = ext.srp_period_quota_id
and spq.srp_plan_assign_id = ##$$SRPPLANASSIGNID$$##
order by srp_period_quota_id,input_sequence',
      p_title                  => 'Period Quotas by Salesrep Plan Id',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  CN_SRP_PERIOD_QUOTAS_EXT_ALL details by SRP Plan Id',
      p_solution               => '',
      p_success_msg            => 'There  are no records in table  CN_SRP_PERIOD_QUOTAS_EXT_ALL By SRP Plan Id',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_SPQE_BY_PLAN_ID');



debug('begin add_signature: EBS_CRM_SM_CN_SPAYEE_BY_PLAN_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29863',
      p_sig_id                 => 'EBS_CRM_SM_CN_SPAYEE_BY_PLAN_ID',
      p_sig_sql                => 'select pa.SRP_PAYEE_ASSIGN_ID,pa.PAYEE_ID,pa.quota_id,pa.SALESREP_ID,pa.start_date,pa.end_date,qa.srp_quota_assign_id
from cn_srp_payee_assigns_all pa,cn_srp_quota_assigns_all qa
where pa.srp_quota_assign_id = qa.srp_quota_assign_id
and qa.srp_plan_assign_id = ##$$SRPPLANASSIGNID$$##
order by qa.srp_quota_assign_id,quota_id',
      p_title                  => 'Payee Assignments by Salesrep Plan Id',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  CN_SRP_PAYEE_ASSIGNS_ALL details by SRP Plan Id',
      p_solution               => '',
      p_success_msg            => 'There  are no records in table  CN_SRP_PAYEE_ASSIGNS_ALL By SRP Plan Id',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_SPAYEE_BY_PLAN_ID');



debug('begin add_signature: EBS_CRM_SM_CN_WF_ITEM_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30710',
      p_sig_id                 => 'EBS_CRM_SM_CN_WF_ITEM_TYPES',
 ...
 ORDER BY 1',
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_WF_ITEM_TYPES');



debug('begin add_signature: EBS_CRM_SM_CN_PERIOD_SETS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29754',
      p_sig_id                 => 'EBS_CRM_SM_CN_PERIOD_SETS_ALL',
      p_sig_sql                => 'SELECT   ORG_ID,PERIOD_SET_ID,PERIOD_SET_NAME   from CN_PERIOD_SETS_ALL
WHERE org_id=##$$ORG_ID$$##
order by period_set_id desc
',
      p_title                  => 'Period Sets',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Displaying the CN_PERIOD_SETS_ALL data ',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_PERIOD_SETS_ALL');



debug('begin add_signature: EBS_CRM_SM_CN_PERIOD_TYPES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29755',
      p_sig_id                 => 'EBS_CRM_SM_CN_PERIOD_TYPES_ALL',
      p_sig_sql                => 'SELECT  ORG_ID,PERIOD_TYPE_ID,PERIOD_TYPE FROM CN_PERIOD_TYPES_ALL
WHERE org_id=##$$ORG_ID$$##
order by period_type desc
',
      p_title                  => 'Period Types',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Displaying the CN_PERIOD_TYPES_ALL data for the Organization',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_PERIOD_TYPES_ALL');



debug('begin add_signature: EBS_CRM_SM_CN_REPOSITORIES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29756',
      p_sig_id                 => 'EBS_CRM_SM_CN_REPOSITORIES_ALL',
      p_sig_sql                => 'SELECT  * FROM CN_REPOSITORIES_ALL 
WHERE org_id=##$$ORG_ID$$##
order by period_set_id desc
',
      p_title                  => 'Repositories',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the CN_REPOSITORIES_ALL data for the Organization',
      p_solution               => '',
      p_success_msg            => ' There are no records in table CN_REPOSITORIES_ALL for ORG_ID '||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||'',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_REPOSITORIES_ALL');



debug('begin add_signature: EBS_CRM_SM_CN_PERIOD_STATUSES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29757',
      p_sig_id                 => 'EBS_CRM_SM_CN_PERIOD_STATUSES_ALL',
      p_sig_sql                => 'SELECT  *  FROM CN_PERIOD_STATUSES_ALL
WHERE org_id=##$$ORG_ID$$##
AND period_id=##$$PERIOD_ID$$##
order by period_id  desc
',
      p_title                  => 'Period Statuses',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Displaying CN_PERIOD_STATUSES_ALL data ',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_PERIOD_STATUSES_ALL');



debug('begin add_signature: EBS_CRM_SM_CN_CAL_PER_INT_TYPES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29758',
      p_sig_id                 => 'EBS_CRM_SM_CN_CAL_PER_INT_TYPES_ALL',
      p_sig_sql                => 'SELECT  ORG_ID,CAL_PER_INT_TYPE_ID,CAL_PERIOD_ID,INTERVAL_TYPE_ID,INTERVAL_NUMBER  FROM CN_CAL_PER_INT_TYPES_ALL
WHERE org_id=##$$ORG_ID$$##
AND cal_period_id  =##$$PERIOD_ID$$##
order by cal_period_id  desc
',
      p_title                  => 'Calendar Period Interval Types',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Displaying CN_CAL_PER_INT_TYPES_ALL data ',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_CAL_PER_INT_TYPES_ALL');



debug('begin add_signature: EBS_CRM_SM_GL_PERIOD_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29762',
      p_sig_id                 => 'EBS_CRM_SM_GL_PERIOD_TYPES',
      p_sig_sql                => 'SELECT PERIOD_TYPE,NUMBER_PER_FISCAL_YEAR,YEAR_TYPE_IN_NAME,USER_PERIOD_TYPE,CREATION_DATE,DESCRIPTION from GL_PERIOD_TYPES
order by CREATION_DATE desc',
      p_title                  => 'GL Period Types ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Displaying the GL_PERIOD_TYPES data ',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_GL_PERIOD_TYPES');



debug('begin add_signature: EBS_CRM_SM_GL_PERIOD_SETS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29763',
      p_sig_id                 => 'EBS_CRM_SM_GL_PERIOD_SETS',
      p_sig_sql                => 'SELECT  PERIOD_SET_NAME,DESCRIPTION,CREATION_DATE   from GL_PERIOD_SETS
order by CREATION_DATE desc',
      p_title                  => 'GL Period Sets ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Displaying the GL_PERIOD_SETS data ',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_GL_PERIOD_SETS');



debug('begin add_signature: EBS_CRM_SM_CN_ROLES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30193',
      p_sig_id                 => 'EBS_CRM_SM_CN_ROLES',
      p_sig_sql                => ' SELECT ROLE_ID, NAME, ROLE_CODE, MANAGER_FLAG FROM CN_ROLES WHERE ACTIVE_FLAG = ''Y'' ORDER BY ROLE_ID ASC',
      p_title                  => 'Active Roles',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying Active CN_ROLES details',
      p_solution               => '',
      p_success_msg            => 'There  are no Active CN_ROLES',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_ROLES');



debug('begin add_signature: EBS_CRM_SM_CN_ROLE_PAY_GRPS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30205',
      p_sig_id                 => 'EBS_CRM_SM_CN_ROLE_PAY_GRPS_ALL',
      p_sig_sql                => 'select ROLE_PAY_GROUP_ID, ROLE_ID, PAY_GROUP_ID, START_DATE, END_DATE, ORG_ID  from  CN_ROLE_PAY_GROUPS_ALL
where pay_group_id in (select pay_group_id   from CN_SRP_PAY_GROUPS_ALL 
where salesrep_id  in  (##$$SALESREP_ID$$##))',
      p_title                  => 'Salesrep Role Pay Groups',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the details of CN_ROLE_PAY_GROUPS_ALL',
      p_solution               => 'Collection Role Pay Groups ',
      p_success_msg            => 'There are no records in the CN_ROLE_PAY_GROUPS_ALL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_ROLE_PAY_GRPS_ALL');



debug('begin add_signature: EBS_CRM_SM_CORRUPT_OIC_PERIODS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30202',
      p_sig_id                 => 'EBS_CRM_SM_CORRUPT_OIC_PERIODS',
      p_sig_sql                => 'select gl.APPLICATION_ID,gl.SET_OF_BOOKS_ID,gl.PERIOD_NAME,gl.LAST_UPDATE_DATE,gl.LAST_UPDATED_BY,gl.CLOSING_STATUS,
gl.START_DATE,gl.END_DATE,gl.PERIOD_TYPE,gl.PERIOD_YEAR,gl.PERIOD_NUM,gl.QUARTER_NUM,gl.ADJUSTMENT_PERIOD_FLAG,gl.CREATION_DATE,
gl.YEAR_START_DATE,gl.QUARTER_START_DATE,gl.EFFECTIVE_PERIOD_NUM			
from gl_period_statuses gl, cn_period_statuses cn, cn_repositories r
WHERE gl.application_id = 283
            AND gl.adjustment_period_flag = ''N''
            AND gl.period_name = cn.period_name(+)
           AND cn.period_type_id = r.period_type_id(+)
            AND cn.period_set_id = r.period_set_id(+)
                         AND cn.org_id = r.org_id(+)
                 and gl.set_of_books_id = (select set_of_books_id from 
cn_repositories)
                 and (gl.closing_status in (''N'', ''F'', ''C'') OR
                      gl.closing_status = ''O'' and cn.processing_status_code = 
''FAILED'')
AND cn.period_id = ##$$PERIOD_ID$$##
         order by gl.period_year, gl.period_num',
      p_title                  => 'Corrupt OIC Compensation Periods',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the details of  Corrupt OIC Compensation Periods',
      p_solution               => '',
      p_success_msg            => 'There  are  no corrupt periods ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CORRUPT_OIC_PERIODS');



debug('begin add_signature: EBS_CRM_SM_CN_SRP_PAY_GROUPS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29852',
      p_sig_id                 => 'EBS_CRM_SM_CN_SRP_PAY_GROUPS_ALL',
      p_sig_sql                => 'select SPG.SRP_PAY_GROUP_ID,SPG.SALESREP_ID,SPG.PAY_GROUP_ID,spg.START_DATE SPG_ST_DATE,spg.END_DATE SPG_ED_DATE,SPG.LOCK_FLAG,SPG.ROLE_PAY_GROUP_ID,
pg.name,pg.period_set_name,pg.period_type,pg.START_DATE PG_START_DATE,pg.end_date PG_END_DATE
from CN_SRP_PAY_GROUPS_ALL spg,cn_pay_groups_all pg
where SALESREP_ID = ##$$SALESREP_ID$$##
and spg.pay_group_id = pg.pay_group_id',
      p_title                  => 'Salesrep Pay Groups',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  CN_SRP_PAY_GROUPS_ALL details for the salesrep',
      p_solution               => '',
      p_success_msg            => 'There  are no records in table  CN_SRP_PAY_GROUPS_ALL for the salesrep',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_SRP_PAY_GROUPS_ALL');



debug('begin add_signature: EBS_CRM_SM_CN_INTERVAL_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29492',
      p_sig_id                 => 'EBS_CRM_SM_CN_INTERVAL_TYPES',
      p_sig_sql                => 'SELECT
ORG_ID
, INTERVAL_TYPE_ID
, NAME
, DESCRIPTION
 ...
 ORDER BY
     CREATION_DATE DESC',
      p_title                  => 'Interval Types',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  CN_INTERVAL_TYPES dump',
      p_solution               => '',
      p_success_msg            => 'There  are no records in table  CN_INTERVAL_TYPES',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_INTERVAL_TYPES');



debug('begin add_signature: EBS_CRM_SM_CN_SRP_PLAN_ASSIGNS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29493',
      p_sig_id                 => 'EBS_CRM_SM_CN_SRP_PLAN_ASSIGNS',
      p_sig_sql                => 'SELECT
SRP_PLAN_ASSIGN_ID 
, SALESREP_ID        
, COMP_PLAN_ID       
...
ORDER BY CREATION_DATE DESC   ',
      p_title                  => 'Salesrep Plan Assignments',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  CN_SRP_PLAN_ASSIGNS dump for the salesrep',
      p_solution               => '',
      p_success_msg            => 'There  are no records in table  CN_SRP_PLAN_ASSIGNS for the salesrep',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_SRP_PLAN_ASSIGNS');



debug('begin add_signature: EBS_CRM_SM_CN_PERIOD_QUOTAS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29494',
      p_sig_id                 => 'EBS_CRM_SM_CN_PERIOD_QUOTAS_ALL',
      p_sig_sql                => 'SELECT
PERIOD_QUOTA_ID       
, PERIOD_ID             
, QUOTA_ID              
...
FROM  
CN_PERIOD_QUOTAS_ALL 
WHERE 
ORG_ID = ##$$ORG_ID$$## 
AND PERIOD_ID = ''##$$PERIOD_ID$$##'' 
ORDER BY CREATION_DATE DESC',
      p_title                  => 'Period Quotas',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  CN_PERIOD_QUOTAS_ALL dump for the period id',
      p_solution               => '',
      p_success_msg            => 'There  are no records in table  CN_PERIOD_QUOTAS_ALL for the period id',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_PERIOD_QUOTAS_ALL');



debug('begin add_signature: EBS_CRM_SM_CN_SRP_PERIOD_QUOTAS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29495',
      p_sig_id                 => 'EBS_CRM_SM_CN_SRP_PERIOD_QUOTAS_ALL',
      p_sig_sql                => 'SELECT
SRP_PERIOD_QUOTA_ID   
, SRP_PLAN_ASSIGN_ID    
, SRP_QUOTA_ASSIGN_ID   
...
, QUOTA_ACHIEVED_PTD_F  
, QUOTA_AMOUNT_PTD_F    
, QUOTA_AMOUNT_YTD_F    
, QUOTA_ACHIEVED_YTD_F  
, COMMISSION_PAYED_ITD_F
, COMMISSION_PAYED_PTD_F
, COMMISSION_PAYED_YTD_F
, TRX_AMOUNT_PTD_F      
, TRX_AMOUNT_YTD_F      
, QUANTITY_PTD_F        
, QUANTITY_YTD_F        
...
, LAST_RATE_TIER_ID     
, LAST_RATES            
, INPUT_ACHIEVED_PTD_F  
, INPUT_ACHIEVED_ITD_F  
, OUTPUT_ACHIEVED_PTD_F 
, OUTPUT_ACHIEVED_ITD_F 
, PERF_ACHIEVED_PTD_F   
, PERF_ACHIEVED_ITD_F   
, ROLLOVER              
, TOTAL_ROLLOVER        
, TRANSACTION_AMOUNT_PTD
, TRANSACTION_AMOUNT_ITD
FROM CN_SRP_PERIOD_QUOTAS_ALL   
WHERE  
ORG_ID = ##$$ORG_ID$$## AND
SALESREP_ID = ##$$SALESREP_ID$$## AND 
PERIOD_ID = ''##$$PERIOD_ID$$##''
ORDER BY CREATION_DATE DESC',
      p_title                  => 'Salesrep Period Quotas',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  CN_SRP_PERIOD_QUOTAS_ALL dump for the salesrep',
      p_solution               => '',
      p_success_msg            => 'There  are no records in table  CN_SRP_PERIOD_QUOTAS_ALL for the salesrep',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_SRP_PERIOD_QUOTAS_ALL');



debug('begin add_signature: EBS_CRM_SM_CN_SRP_INTEL_PERIODS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29496',
      p_sig_id                 => 'EBS_CRM_SM_CN_SRP_INTEL_PERIODS_ALL',
      p_sig_sql                => 'SELECT * FROM CN_SRP_INTEL_PERIODS_ALL
WHERE 
ORG_ID = ##$$ORG_ID$$## AND
SALESREP_ID = ##$$SALESREP_ID$$## AND 
PERIOD_ID = ''##$$PERIOD_ID$$##''
ORDER BY CREATION_DATE DESC    ',
      p_title                  => 'Salesrep Intel Periods',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  CN_SRP_INTEL_PERIODS_ALL dump for the salesrep',
      p_solution               => '',
      p_success_msg            => 'There  are no records in table  CN_SRP_INTEL_PERIODS_ALL for the salesrep',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_SRP_INTEL_PERIODS_ALL');



debug('begin add_signature: EBS_CRM_SM_CN_SRP_PRD_QUOTAS_EXT_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29497',
      p_sig_id                 => 'EBS_CRM_SM_CN_SRP_PRD_QUOTAS_EXT_ALL',
      p_sig_sql                => 'SELECT
ORG_ID                  
...
, INPUT_ACHIEVED_ITD      
FROM  
CN_SRP_PERIOD_QUOTAS_EXT_ALL WHERE 
ORG_ID = ##$$ORG_ID$$## ORDER BY CREATION_DATE DESC
',
      p_title                  => 'Salesrep Period Quotas Extensions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  CN_SRP_PERIOD_QUOTAS_EXT_ALL dump',
      p_solution               => '',
      p_success_msg            => 'There  are no records in table  CN_SRP_PERIOD_QUOTAS_EXT_ALL ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_SRP_PRD_QUOTAS_EXT_ALL');



debug('begin add_signature: EBS_CRM_SM_CN_SRP_PER_QUOTA_RC_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29498',
      p_sig_id                 => 'EBS_CRM_SM_CN_SRP_PER_QUOTA_RC_ALL',
      p_sig_sql                => 'SELECT
SRP_PER_QUOTA_RC_ID
, SRP_PERIOD_QUOTA_ID
, SRP_PLAN_ASSIGN_ID 
...
PERIOD_ID = ''##$$PERIOD_ID$$##''
ORDER BY CREATION_DATE DESC  ',
      p_title                  => 'Salesrep Per Quota Revenue Class',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  CN_SRP_PER_QUOTA_RC_ALL dump for the salesrep',
      p_solution               => '',
      p_success_msg            => 'There  are no records in table  CN_SRP_PER_QUOTA_RC_ALL for the sales rep.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_SRP_PER_QUOTA_RC_ALL');



debug('begin add_signature: EBS_CRM_SM_CN_UNCALC_TRX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30096',
      p_sig_id                 => 'EBS_CRM_SM_CN_UNCALC_TRX',
      p_sig_sql                => 'SELECT H.COMMISSION_HEADER_ID
, L.COMMISSION_LINE_ID
, H.DIRECT_SALESREP_ID
, H.PROCESSED_DATE
, H.PROCESSED_PERIOD_ID
, H.ROLLUP_DATE
, H.ORDER_NUMBER
, H.INVOICE_NUMBER
, H.TRANSACTION_AMOUNT
, L.CREDITED_SALESREP_ID
, L.COMMISSION_AMOUNT
, L.STATUS
FROM CN_COMMISSION_HEADERS_ALL H,
CN_COMMISSION_LINES_ALL L
WHERE H.COMMISSION_HEADER_ID = L.COMMISSION_HEADER_ID
AND H.ORG_ID = L.ORG_ID
AND L.STATUS IN (''XCLS'',''XROLL'',''XPOP'',''XCALC'',''XPAYEE'',''NCALC'')
AND H.ORG_ID = ##$$ORG_ID$$## 
AND H.DIRECT_SALESREP_ID = ##$$SALESREP_ID$$##
AND H.PROCESSED_PERIOD_ID = ##$$PERIOD_ID$$##
ORDER BY H.COMMISSION_HEADER_ID
, L.COMMISSION_LINE_ID',
      p_title                  => 'Uncalculated Transactions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the transactions which did not calculate, i.e., XPOP, XCALC, XCLS, XROLL, &
Unprocessed',
      p_solution               => '',
      p_success_msg            => 'All the Transactions are calculated successfully.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_UNCALC_TRX');



debug('begin add_signature: EBS_CRM_SM_CN_FORMULA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30100',
      p_sig_id                 => 'EBS_CRM_SM_CN_FORMULA',
      p_sig_sql                => 'select f.name as FormulaName, o.name as FormulaPackage from cn_calc_formulas_all f, cn_objects_all o
where 
''cn_formula_''||f.calc_formula_id||''_''||f.org_id||''_pkg'' = o.name
and f.org_id = o.org_id
and f.org_id = ##$$ORG_ID$$##
and o.object_type = ''PKB''
order by 1',
      p_title                  => 'Formula Packages',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the formula package associated with the formula',
      p_solution               => '',
      p_success_msg            => 'There are no formula packages associated with the formula.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_FORMULA');



debug('begin add_signature: EBS_CRM_SM_PERF_ISSUE_CON_REQ');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30111',
      p_sig_id                 => 'EBS_CRM_SM_PERF_ISSUE_CON_REQ',
      p_sig_sql                => '  SELECT
    ...
    status_code,
    completion_text,
    COUNT(1) RUNNING_COUNT,
    MIN(to_char(requested_start_date, ''DD-MON-YY HH24:MI:SS''))      start_time,
    MAX(to_char(actual_completion_date, ''DD-MON-YY HH24:MI:SS'')) end_time    
FROM
    fnd_concurrent_requests r,
    fnd_concurrent_programs p
WHERE
    r.program_application_id = 283
    AND r.concurrent_program_id = p.concurrent_program_id
    AND r.program_application_id = p.application_id
    AND p.concurrent_program_name IN ( ''BATCH_RUNNER'', ''CALCULATE_BATCH'', ''BATCH_PROCESSOR'' )
    AND r.phase_code = ''R''
    AND r.status_code = ''R''    
GROUP BY
    r.concurrent_program_id,
 ...
 HAVING COUNT(1) <=5   
ORDER BY
    MIN(to_char(requested_start_date, ''DD-MON-YY HH24:MI:SS''))',
      p_title                  => 'Long Running Concurrent Requests',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the long running concurrents of Incentive Compensation application to check on performance issue',
      p_solution               => 'To address performance issue on Long running concurrent requests',
      p_success_msg            => 'There  are no long running requests in Incentive Compensation application',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_PERF_ISSUE_CON_REQ');



debug('begin add_signature: EBS_CRM_SM_CN_COMM_LINES_API_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29438',
      p_sig_id                 => 'EBS_CRM_SM_CN_COMM_LINES_API_ALL',
      p_sig_sql                => 'SELECT  salesrep_id,processed_date,processed_period_id,transaction_amount,trx_type,revenue_class_id,
load_status,employee_number,comm_lines_api_id,conc_batch_id,process_batch_id,salesrep_number,
rollup_date,rollup_period_id,source_doc_id,source_doc_type,creation_date,transaction_currency_code,
exchange_rate,acctd_transaction_amount,trx_id,trx_line_id,trx_sales_line_id,org_id,quantity,
source_trx_number,discount_percentage,margin_percentage,pre_defined_rc_flag,
rollup_flag,forecast_id,upside_quantity,upside_amount,uom_code,source_trx_id,source_trx_line_id,
negated_flag,customer_id,inventory_item_id,order_number,booked_date,invoice_number,
invoice_date,bill_to_address_id,ship_to_address_id,bill_to_contact_id,ship_to_contact_id,
adj_comm_lines_api_id,adjust_date,revenue_type,adjust_rollup_flag,adjust_status,line_number,
reason_code,pre_processed_code,quota_id,srp_plan_assign_id,role_id,comp_group_id,
commission_amount,reversal_flag,reversal_header_id,sales_channel,split_status,
split_pct,imp_header_id,preserve_credit_override_flag
FROM cn_comm_lines_api_all
WHERE salesrep_id =  ##$$SALESREP_ID$$##
and org_id=##$$ORG_ID$$##
and processed_period_id=##$$PERIOD_ID$$##
order by processed_date desc

  ',
      p_title                  => 'Commission Lines API',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the CN_COMM_LINES_API_ALL records for sales rep',
      p_solution               => '',
      p_success_msg            => 'There  are no records in table cn_comm_lines_api_all for the sales rep ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_COMM_LINES_API_ALL');



debug('begin add_signature: EBS_CRM_SM_CN_PAYRUNS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29444',
      p_sig_id                 => 'EBS_CRM_SM_CN_PAYRUNS_ALL',
      p_sig_sql                => 'select * from CN_PAYRUNS_ALL
WHERE org_id=##$$ORG_ID$$##
...
',
      p_title                  => 'Payruns',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  CN_PAYRUNS_ALL details',
      p_solution               => '',
      p_success_msg            => 'There  are no records in table CN_PAYRUNS_ALL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_PAYRUNS_ALL');



debug('begin add_signature: EBS_CRM_SM_CN_PAYMENT_TRANSACTIONS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29441',
      p_sig_id                 => 'EBS_CRM_SM_CN_PAYMENT_TRANSACTIONS_ALL',
      p_sig_sql                => 'select recoverable_flag,posting_batch_id,posting_type,trx_type,payee_salesrep_id,role_id,incentive_type_code,credit_type_id,pay_period_id,amount,
commission_header_id,commission_line_id,srp_plan_assign_id,quota_id,processed_date,credited_salesrep_id,processed_period_id,quota_rule_id,
event_factor,payment_factor,quota_factor,input_achieved,rate_tier_id,payee_line_id,commission_rate,
creation_date,org_id,hold_flag,paid_flag,payment_amount,expense_ccid,liability_ccid,pay_element_type_id,
waive_flag,payment_transaction_id
from CN_PAYMENT_TRANSACTIONS_ALL
where payee_salesrep_id  = ##$$SALESREP_ID$$##
and org_id=##$$ORG_ID$$##
and pay_period_id =##$$PERIOD_ID$$##
order by processed_date desc

',
      p_title                  => 'Payment Transactions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  CN_PAYMENT_TRANSACTIONS_ALL dump for  this sales rep',
      p_solution               => '',
      p_success_msg            => 'There  are no records in table  CN_PAYMENT_TRANSACTIONS_ALL  for the sales rep',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_PAYMENT_TRANSACTIONS_ALL');



debug('begin add_signature: EBS_CRM_SM_CN_COMMISSION_HEADERS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29439',
      p_sig_id                 => 'EBS_CRM_SM_CN_COMMISSION_HEADERS_ALL',
      p_sig_sql                => 'select commission_header_id,direct_salesrep_id,processed_date,processed_period_id,rollup_date,transaction_amount,
quantity,discount_percentage,margin_percentage,orig_currency_code,transaction_amount_orig,trx_type,status,
pre_processed_code,comm_lines_api_id,source_doc_type,quota_id,srp_plan_assign_id,revenue_class_id,role_id,
comp_group_id,commission_amount,trx_batch_id,reversal_flag,reversal_header_id,reason_code,comments,
creation_date,org_id,exchange_rate,forecast_id,upside_quantity,upside_amount,uom_code,source_trx_id,
source_trx_line_id,source_trx_sales_line_id,negated_flag,customer_id,inventory_item_id,order_number,
booked_date,invoice_number,invoice_date,bill_to_address_id,ship_to_address_id,bill_to_contact_id,ship_to_contact_id,
adj_comm_lines_api_id,adjust_date,revenue_type,adjust_rollup_flag,adjust_status,line_number,
split_pct,split_status,parent_header_id from cn_commission_headers_all
where direct_salesrep_id = ##$$SALESREP_ID$$##
and org_id=##$$ORG_ID$$##
and processed_period_id=##$$PERIOD_ID$$##
order by processed_date desc

',
      p_title                  => 'Commission Headers',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  CN_COMMISSION_HEADERS_ALL dump for  this sales rep',
      p_solution               => '',
      p_success_msg            => 'There  are no records in table  CN_COMMISSION_HEADERS_ALL for the sales rep',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_COMMISSION_HEADERS_ALL');



debug('begin add_signature: EBS_CRM_SM_CN_COMMISSION_LINES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29440',
      p_sig_id                 => 'EBS_CRM_SM_CN_COMMISSION_LINES_ALL',
      p_sig_sql                => 'select commission_line_id,trx_sales_line_id,direct_salesrep_id,credited_salesrep_id,processed_period_id,processed_date,
quota_id,quota_rule_id,revenue_class_id,transaction_amount,event_factor,payment_factor,payment_flag,
quota_factor,commissionable_amount,commission_amount,commission_payed_ptd,quota_achieved_ptd,
rate_tier_id,sales_line_batch_id,quota_amount,commission_rate,payee_line_id,status,
trx_type,tier_split,exception_code,trial_adjustment_flag,reversed_adjustment_flag,trx_batch_id,
rollup_period_id,reason_code, created_during,comments,creation_date,transaction_amount_orig,
exchange_rate,org_id,comm_lines_api_id,quantity,source_doc_type,source_trx_number,discount_percentage,
margin_percentage,error_code,pre_defined_rc_flag,rollup_flag,rollup_date,upside_quantity,upside_amount,uom_code,commission_header_id,
srp_plan_assign_id,posting_status,input_achieved,output_achieved,perf_achieved,reversal_header_id,
error_reason,pay_period_id,pending_status,role_id,srp_payee_assign_id,pending_date,threshold_check_status,
credited_comp_group_id,pre_processed_code,credit_type_id,rollup_level
from cn_commission_lines_all
where credited_salesrep_id = ##$$SALESREP_ID$$##
and org_id=##$$ORG_ID$$##
and processed_period_id=##$$PERIOD_ID$$##
order by processed_date desc',
      p_title                  => 'Commission Lines',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  CN_COMMISSION_LINES_ALL dump for  this sales rep',
      p_solution               => '',
      p_success_msg            => 'There  are no records in table  CN_COMMISSION_LINES_ALL for the sales rep ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_COMMISSION_LINES_ALL');



debug('begin add_signature: EBS_CRM_SM_CN_PAYMENT_WORKSHEETS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29443',
      p_sig_id                 => 'EBS_CRM_SM_CN_PAYMENT_WORKSHEETS_ALL',
      p_sig_sql                => 'select salesrep_id,payrun_id,pay_cap,comm_due_bb,bonus_due_bb,
draw_recoverable_begin,comm_ptd,bonus_ptd,comm_draw,bonus_draw,comm_paid,
bonus_paid,draw_paid,cost_center_id,reason,bonus_reason,recovery_method,draw_ptd,bonus_given,
adjust_paid,org_id,payment_worksheet_id,role_id,credit_type_id,returned_funds_flag,post_subledger_flag,minimum_amount,
comm_nrec,reg_bonus_due_bb,reg_bonus_ptd,reg_bonus_rec,reg_bonus_to_rec,reg_bonus_paid,
payee_comm_due_bb,payee_comm_ptd,payee_bonus_due_bb,payee_bonus_ptd,payee_bonus_paid,
convert_to_type_id,credit_conv_fct_id,convert_to_paid,posting_status,creation_date,pmt_amount_calc,
pmt_amount_adj_rec,pmt_amount_adj_nrec,reviewed_by_analyst,current_earnings_due,pmt_amount_adj,
pmt_amount_recovery,quota_id,worksheet_status,current_earnings,bb_pmt_recovery_plans,
bb_prior_period_adj,held_amount  from CN_PAYMENT_WORKSHEETS_ALL
where salesrep_id  = ##$$SALESREP_ID$$##
and org_id=##$$ORG_ID$$##
order by payrun_id
',
      p_title                  => 'Payment Worksheets',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  CN_PAYMENT_WORKSHEETS_ALL dump for  this sales rep',
      p_solution               => '',
      p_success_msg            => 'There  are no records in table  CN_PAYMENT_WORKSHEETS_ALL  for the sales rep',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_PAYMENT_WORKSHEETS_ALL');



debug('begin add_signature: EBS_CRM_SM_CN_SRP_PERIODS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29442',
      p_sig_id                 => 'EBS_CRM_SM_CN_SRP_PERIODS_ALL',
      p_sig_sql                => 'select * from CN_SRP_PERIODS_ALL
where salesrep_id  = ##$$SALESREP_ID$$##
and org_id=##$$ORG_ID$$##
and period_id=##$$PERIOD_ID$$##
order by creation_date desc
...
',
      p_title                  => 'SRP Periods',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the CN_SRP_PERIODS_ALL dump for this sales rep',
      p_solution               => '',
      p_success_msg            => 'There are no records in table CN_SRP_PERIODS_ALL for the sales rep',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_SRP_PERIODS_ALL');



debug('begin add_signature: EBS_CRM_SM_SALEREP_UNPAID_PAYRUN_PERIOD_INFO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29446',
      p_sig_id                 => 'EBS_CRM_SM_SALEREP_UNPAID_PAYRUN_PERIOD_INFO',
      p_sig_sql                => 'SELECT cns.salesrep_id, cnp.payrun_id, cnp.pay_period_id, cnp.org_id
FROM jtf.jtf_rs_salesreps cns,
cn.cn_payruns_all cnp,
cn.cn_period_statuses_all cnps,
cn.cn_srp_pay_groups_all cnspg
WHERE cns.salesrep_id = ##$$SALESREP_ID$$##
AND cns.salesrep_id = cnspg.salesrep_id
and cns.org_id = cnspg.org_id
AND cnspg.pay_group_id = cnp.pay_group_id
and cnspg.org_id = cnp.org_id
...
AND (cnps.start_date <= NVL(cnspg.end_date,cnps.start_date))) 
',
      p_title                  => 'Salesrep,Period and Payrun Info For Unpaid Payruns',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  Salesrep,Period and Payrun Info For Unpaid Payruns',
      p_solution               => '',
      p_success_msg            => 'There  are no unpaid payrun records or the salesrep for the impacted period and organization',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_SALEREP_UNPAID_PAYRUN_PERIOD_INFO');



debug('begin add_signature: EBS_CRM_SM_PAYMENT_BATCH_PERIOD_LOV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30069',
      p_sig_id                 => 'EBS_CRM_SM_PAYMENT_BATCH_PERIOD_LOV',
      p_sig_sql                => 'select * from (select cnps.period_id, cnps.period_name ,cnps.end_date from cn_period_statuses cnps, cn_pay_groups cnpg where
cnpg.pay_group_id in  (select SPG.SRP_PAY_GROUP_ID
from CN_SRP_PAY_GROUPS_ALL spg,cn_pay_groups_all pg
where SALESREP_ID = ##$$SALESREP_ID$$##
and spg.pay_group_id = pg.pay_group_id
)
and cnpg.period_set_id = cnps.period_set_id
and cnpg.period_type_id = cnps.period_type_id
and cnps.period_id between
cn_api.get_acc_period_id_fo(cnpg.start_date,cnps.org_id)
and cn_api.get_acc_period_id(cnpg.end_date,cnps.org_id)
and cnps.period_status = ''O''
and cnps.org_id = ##$$ORG_ID$$##
and cnps.org_id = cnpg.org_id
and nvl(cnps.period_id,0) >= nvl(
(select max(pay_period_id) max_paid_period_id
from cn_payruns cnp where cnpg.pay_group_id = cnp.pay_group_id
and cnp.status = ''PAID'' ),0)
order by period_id asc)
 where period_id <= (select max(period_id) from cn_period_statuses where
  SYSDATE BETWEEN start_date and end_date)',
      p_title                  => 'Payment Batch Period LOV',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Payment batch Period LOV is empty',
      p_solution               => 'Period LOV in the "Create Payment Batch" page does not have any values while trying to create a payment batch.
Please refer to Create Payment Batch In OIC Is Showing An Old Period Instead Of The Current Period [2615196.1] for  more information',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_PAYMENT_BATCH_PERIOD_LOV');



debug('begin add_signature: EBS_CRM_SM_CN_POSTING_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30097',
      p_sig_id                 => 'EBS_CRM_SM_CN_POSTING_DETAILS',
      p_sig_sql                => 'SELECT
CPDA.POSTING_DETAIL_ID   
, CPDA.POSTING_BATCH_ID    
, CPDA.POSTING_TYPE        
, CPDA.TRX_TYPE            
, CPDA.PAYEE_SALESREP_ID   
, CPDA.ROLE_ID             
, CPDA.INCENTIVE_TYPE_CODE 
, CPDA.CREDIT_TYPE_ID      
, CPDA.PAY_PERIOD_ID       
, CPDA.AMOUNT              
, CPDA.COMMISSION_HEADER_ID
, CPDA.COMMISSION_LINE_ID  
, CPDA.SRP_PLAN_ASSIGN_ID  
, CPDA.QUOTA_ID            
, CPDA.STATUS              
, CPDA.LOADED_DATE         
, CPDA.PROCESSED_DATE      
, CPDA.CREDITED_SALESREP_ID
, CPDA.PROCESSED_PERIOD_ID 
, CPDA.QUOTA_RULE_ID       
, CPDA.EVENT_FACTOR        
, CPDA.PAYMENT_FACTOR      
, CPDA.QUOTA_FACTOR        
...
, CPDA.EXPENSE_CCID        
, CPDA.LIABILITY_CCID      
, CPDA.POSTING_BATCH_SUM_ID
, CPDA.PAY_ELEMENT_TYPE_ID 
FROM 
	CN_POSTING_DETAILS_ALL CPDA
	, CN_PAYRUNS_ALL CPA
WHERE 
	CPDA.PAYRUN_ID = CPA.PAYRUN_ID
	AND CPDA.ORG_ID = CPA.ORG_ID
	AND CPDA.CREDITED_SALESREP_ID = ##$$SALESREP_ID$$##
	AND CPDA.ORG_ID=##$$ORG_ID$$##
	AND CPDA.PAY_PERIOD_ID=##$$PERIOD_ID$$##
',
      p_title                  => 'Posting Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the CN_POSTING_DETAILS_ALL',
      p_solution               => '',
      p_success_msg            => 'There are no records in CN_POSTING_DETAILS_ALL for the Salesrep',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_POSTING_DETAILS');



debug('begin add_signature: EBS_CRM_SM_CN_POSTING_DETAILS_SUM');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30098',
      p_sig_id                 => 'EBS_CRM_SM_CN_POSTING_DETAILS_SUM',
      p_sig_sql                => 'SELECT
CPDSA.ORG_ID                
, CPDSA.POSTING_DETAIL_SUM_ID 
, CPDSA.POSTING_BATCH_SUM_ID  
, CPDSA.PAYEE_SALESREP_ID     
, CPDSA.CREDITED_SALESREP_ID  
, CPDSA.ROLE_ID               
, CPDSA.CREDIT_TYPE_ID        
, CPDSA.INCENTIVE_TYPE_CODE   
, CPDSA.PAY_PERIOD_ID         
, CPDSA.PAYRUN_ID             
, CPDSA.QUOTA_ID              
, CPDSA.PAY_ELEMENT_TYPE_ID   
, CPDSA.AMOUNT                
, CPDSA.PAYMENT_AMOUNT        
, CPDSA.EXPENSE_CCID          
, CPDSA.LIABILITY_CCID        
, CPDSA.HOLD_FLAG             
, CPDSA.PAID_FLAG             
FROM 
	CN_POSTING_DETAILS_SUM_ALL CPDSA
	, CN_PAYRUNS_ALL CPA
WHERE 
	CPDSA.PAYRUN_ID = CPA.PAYRUN_ID
	AND CPDSA.ORG_ID = CPA.ORG_ID
	AND CPDSA.CREDITED_SALESREP_ID = ##$$SALESREP_ID$$##
	AND CPDSA.ORG_ID=##$$ORG_ID$$##
	AND CPDSA.PAY_PERIOD_ID=##$$PERIOD_ID$$##',
      p_title                  => 'Posting Sum Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the CN_POSTING_DETAILS_SUM_ALL ',
      p_solution               => '',
      p_success_msg            => 'There are no records in CN_POSTING_DETAILS_SUM_ALL for the Salesrep',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_POSTING_DETAILS_SUM');



debug('begin add_signature: EBS_CRM_SM_CN_WORKSHEET_BONUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30099',
      p_sig_id                 => 'EBS_CRM_SM_CN_WORKSHEET_BONUS',
      p_sig_sql                => 'SELECT CWBA.* 
FROM 
	CN_WORKSHEET_BONUSES_ALL CWBA
	, CN_PAYRUNS_ALL CPA
WHERE 
	CWBA.PAYRUN_ID = CPA.PAYRUN_ID
	AND CWBA.ORG_ID = CPA.ORG_ID
	AND CWBA.SALESREP_ID =  ##$$SALESREP_ID$$##
	AND CWBA.ORG_ID=##$$ORG_ID$$##',
      p_title                  => 'Worksheet Bonus',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the CN_WORKSHEET_BONUSES_ALL ',
      p_solution               => '',
      p_success_msg            => 'There are no records in CN_WORKSHEET_BONUSES_ALL for the Salesrep',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_CN_WORKSHEET_BONUS');



debug('begin add_signature: EBS_CRM_SM_PAYRUN_PROFILES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29445',
      p_sig_id                 => 'EBS_CRM_SM_PAYRUN_PROFILES',
      p_sig_sql                => 'select s.user_profile_option_name,
''Site'' "LEVEL",
''Site'' "LEVEL_NAME",
v.profile_option_value "VALUE"
from fnd_profile_options_vl s,
fnd_profile_option_values v
where s.profile_option_name in (''CN_PAY_BY_TRANSACTION'', ''CN_RESET_BALANCES_EACH_YEAR'')
and s.profile_option_id = v.profile_option_id
and v.level_id = 10001
union
select o.user_profile_option_name,
''Appl'' "LEVEL",
a.application_short_name "LEVEL_NAME",
v.profile_option_value "VALUE"
from fnd_profile_options_vl o,
fnd_profile_option_values v,
fnd_application a
where o.profile_option_name in (''CN_PAY_BY_TRANSACTION'', ''CN_RESET_BALANCES_EACH_YEAR'')
and o.profile_option_id = v.profile_option_id
and v.level_id = 10002
and a.application_short_name = ''CN''
union
select o.user_profile_option_name,
''Resp'' "LEVEL",
r.responsibility_name "LEVEL_NAME",
v.profile_option_value "VALUE"
from fnd_profile_options_vl o,
fnd_profile_option_values v,
...
order by 1, 2 
  ...
  ',
      p_title                  => 'PaymentCollection.sql version 5.0 - Note: 862471.1 - Profiles',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Profiles',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_PAYRUN_PROFILES');



debug('begin add_signature: EBS_CRM_SM_WORKSHEET_SUMMARY');
   l_info('##SHOW_SQL##'):= 'N';
  add_signature(
      p_sig_repo_id            => '29712',
      p_sig_id                 => 'EBS_CRM_SM_WORKSHEET_SUMMARY',
      p_sig_sql                => 'select ''salesrep_id = ##$$SALESREP_ID$$## payrun_id = ##$$PAYRUN_ID$$##
period_id = ##$$PERIOD_ID$$##
subledger total = ##$$SUBLEDGER_TOTAL$$##
unprocessed payments total = ##$$PAYMENT_TOTAL$$##
unposted commission total = ##$$COMMISSION_TOTAL$$##
difference = ##$$DIFFERENCE$$## 
'' as " "
from dual',
      p_title                  => '#1. Worksheet Validation',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Report
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_WORKSHEET_SUMMARY');



debug('begin add_signature: EBS_CRM_SM_SUBLEDGER_BALANCES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29468',
      p_sig_id                 => 'EBS_CRM_SM_SUBLEDGER_BALANCES',
      p_sig_sql                => 'SELECT period_id, balance2_dtd, balance2_ctd, balance2_bbd, balance2_bbc,
(nvl(srp.balance2_dtd,0) - nvl(srp.balance2_ctd,0) +
nvl(srp.balance2_bbd,0) - nvl(srp.balance2_bbc,0)) "NET"
FROM cn.cn_srp_periods_all srp
WHERE srp.period_id <= ##$$PERIOD_ID$$##
AND srp.salesrep_id =##$$SALESREP_ID$$##
AND srp.credit_type_id = -1000
AND srp.quota_id is null
AND srp.org_id =##$$ORG_ID$$##
ORDER BY period_id 
',
      p_title                  => ' #2. Subledger Balances',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Subledger Balances',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_SUBLEDGER_BALANCES');



debug('begin add_signature: EBS_CRM_SM_SUBLEDGER_VS_COMMISSION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29469',
      p_sig_id                 => 'EBS_CRM_SM_SUBLEDGER_VS_COMMISSION',
      p_sig_sql                => 'SELECT p.period_id,
p.balance2_dtd "SUBLEDGER",
nvl(l.commission,0) "COMMISSION",
(CASE WHEN p.balance2_dtd - nvl(l.commission,0) = 0 THEN ''OK''
ELSE ''** Check calculation process.'' END) "CHECK"
FROM (select period_id,
balance2_dtd
from cn.cn_srp_periods_all
where salesrep_id = ##$$SALESREP_ID$$##
AND period_id <=##$$PERIOD_ID$$##
AND credit_type_id = -1000
AND org_id = ##$$ORG_ID$$##
AND quota_id is null) p,
(select processed_period_id,
...
AND org_id = ##$$ORG_ID$$##
AND srp_payee_assign_id IS NULL
group by processed_period_id ) l
WHERE p.period_id = l.processed_period_id (+)
ORDER BY p.period_id 
',
      p_title                  => '#3. Subledger vs Commission',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Subledger vs Commission',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_SUBLEDGER_VS_COMMISSION');



debug('begin add_signature: EBS_CRM_SM_COMMISSION_VS_PAYMENT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29471',
      p_sig_id                 => 'EBS_CRM_SM_COMMISSION_VS_PAYMENT',
      p_sig_sql                => 'SELECT l.period_id,
l.posting_status,
l.commission,
t.payment "PAYMENT",
(CASE WHEN (t.payment = 0 and l.posting_status= ''UNPOSTED'')
OR (t.payment is null and l.posting_status= ''UNPOSTED'')
OR (t.payment = l.commission and l.posting_status = ''POSTED'') THEN ''OK''
ELSE ''** Review this period.'' END) "CHECK"
FROM (select processed_period_id "PERIOD_ID",
nvl(posting_status, ''UNPOSTED'') "POSTING_STATUS",
sum(commission_amount) "COMMISSION"
from cn.cn_commission_lines_all
where credited_salesrep_id = ##$$SALESREP_ID$$##
AND processed_period_id <= ##$$PERIOD_ID$$##
...
AND org_id = ##$$ORG_ID$$##
AND srp_payee_assign_id IS NULL
group by processed_period_id, nvl(posting_status, ''UNPOSTED'') ) l ,
(select pay_period_id "PERIOD_ID",
sum(amount) "PAYMENT"
...
AND org_id = ##$$ORG_ID$$##
group by pay_period_id) t
WHERE l.period_id = t.period_id (+)
ORDER BY l.period_id ',
      p_title                  => '#4. Commission vs Payment',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Commission vs Payment',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_COMMISSION_VS_PAYMENT');



debug('begin add_signature: EBS_CRM_SM_SUBLEDGER_VS_PAYMENT_POSTED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29472',
      p_sig_id                 => 'EBS_CRM_SM_SUBLEDGER_VS_PAYMENT_POSTED',
      p_sig_sql                => 'SELECT p.period_id,
p.balance2_ctd "SUBLEDGER",
l.payment ,
(CASE WHEN p.balance2_ctd - l.payment = 0 THEN ''OK''
ELSE ''** Check payment batch.'' END) "CHECK"
FROM (select period_id,
balance2_ctd
from cn.cn_srp_periods_all
where salesrep_id = ##$$SALESREP_ID$$##
...
AND org_id =##$$ORG_ID$$##
AND quota_id is null) p,
(select r.pay_period_id,
sum(amount) "PAYMENT"
from cn.cn_payruns_all r,
cn.cn_payment_transactions_all t
where t.credited_salesrep_id = ##$$SALESREP_ID$$##
AND t.credit_type_id = -1000
AND t.incentive_type_code IN (''COMMISSION'', ''BONUS'')
AND t.paid_flag = ''Y''
AND t.org_id = ##$$ORG_ID$$##
AND t.payrun_id = r.payrun_id
AND r.pay_period_id <= ##$$PERIOD_ID$$##
group by r.pay_period_id ) l
WHERE p.period_id = l.pay_period_id
ORDER BY p.period_id 
',
      p_title                  => '#5. Subledger vs Payment Posted ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Subledger vs Payment Posted ',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_SUBLEDGER_VS_PAYMENT_POSTED');



debug('begin add_signature: EBS_CRM_SM_UNPAID_PAYMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29473',
      p_sig_id                 => 'EBS_CRM_SM_UNPAID_PAYMENTS',
      p_sig_sql                => 'SELECT t.pay_period_id, payrun_id, sum(amount),
(CASE WHEN (payrun_id is not null)
AND (payrun_id != ##$$PAYRUN_ID$$##) THEN ''** Check if payrun was deleted.''
WHEN (pay_period_id is null) THEN ''** Check detail why pay_period_id is null.''
ELSE ''OK'' END) "CHECK"
FROM cn_payment_transactions_all t
WHERE t.credited_salesrep_id = ##$$SALESREP_ID$$##
AND t.credit_type_id = -1000
AND t.incentive_type_code IN (''COMMISSION'', ''BONUS'')
AND t.paid_flag = ''N''
AND t.org_id = ##$$ORG_ID$$##
GROUP BY t.pay_period_id, payrun_id 
',
      p_title                  => '#6. Existing unpaid payment - checking for deleted payrun_id',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Unpaid Payment',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_UNPAID_PAYMENTS');
...
BEGIN
  ...
  IF (p_salesrep_id IS NOT NULL) THEN
    g_params_string := g_params_string || to_char(p_salesrep_id) || '_';
  END IF;
  ...
  analyzer_title := 'Incentive Compensation Analyzer';
...
start_section('Proactive Recommendations', 'ProactiveRecommendations');
   set_item_result(check_rec_patches_1); /* Signature EBS_CRM_SM_OIC_CHECK_REC_PATCHES */
   set_item_result(run_stored_sig('EBS_CRM_SM_VW_OBJ_MAX_FET_SIZE'));
   set_item_result(run_stored_sig('EBS_CRM_SM_CN_INVALIDS'));
   set_item_result(run_stored_sig('EBS_CRM_SM_CN_FREEZE_DFF_CHECK'));
   set_item_result(run_stored_sig('EBS_CRM_SM_PERF_DB_10_PER_MODIFIED'));
   set_item_result(run_stored_sig('EBS_CRM_SM_PERF_DB_CBO_STATS'));
   set_item_result(run_stored_sig('DBSTAT1_GSS'));
   set_item_result(run_stored_sig('EBS_CRM_SM_TBL_ROW_LOCK'));
   set_item_result(run_stored_sig('EBS_CRM_SM_10_EXPENSIVE_BUFFER_GET'));
end_section;
debug('end section: ProactiveRecommendations');

debug('begin section: Setup');
start_section('Compensation Setup', 'Setup');
   set_item_result(run_stored_sig('EBS_CRM_SM_SRP_BATCH_SIZE'));
   set_item_result(run_stored_sig('EBS_CRM_SM_TRX_BATCH_SIZE'));
   set_item_result(run_stored_sig('EBS_CRM_SM_CN_DFF_DEFINED'));
   set_item_result(run_stored_sig('EBS_CRM_SM_CN_DUP_SCA_RUL_ATTRIB_ID'));
   set_item_result(run_stored_sig('EBS_CRM_SM_DUP_SALES_REP_IDS'));
   set_item_result(run_stored_sig('EBS_CRM_SM_PAYMENT_RESOURCE_CHECK'));
   set_item_result(run_stored_sig('EBS_CRM_SM_PAYMENT_GROUP_CHECK'));
   set_item_result(run_stored_sig('EBS_CRM_SM_PAY_ROLE_USAGE_TYPE'));
   set_item_result(run_stored_sig('EBS_CRM_SM_CN_SALESREPS'));
   set_item_result(run_stored_sig('EBS_CRM_SM_CN_SRP_ROLES'));
   set_item_result(run_stored_sig('EBS_CRM_SM_CN_SRP_INTEL_PERIODS'));
   set_item_result(run_stored_sig('EBS_CRM_SM_CN_SRP_PMT_PLANS_ALL'));
   set_item_result(run_stored_sig('EBS_CRM_SM_CN_RES_PAYGROUP'));
   set_item_result(run_stored_sig('EBS_CRM_SM_CN_SRP_PLAN_ASSIGNS_ALL'));
   set_item_result(run_stored_sig('EBS_CRM_SM_CN_SPA_BY_SRP_PLAN_ID'));
   set_item_result(run_stored_sig('EBS_CRM_SM_CN_SQA_BY_SRP_PLAN_ID'));
   set_item_result(run_stored_sig('EBS_CRM_SM_CN_SPQ_BY_SRP_PLAN_ID'));
   set_item_result(run_stored_sig('EBS_CRM_SM_CN_SRA_BY_PLAN_ID'));
   set_item_result(run_stored_sig('EBS_CRM_SM_CN_RATE_TIERS_BY_PLAN_ID'));
   set_item_result(run_stored_sig('EBS_CRM_SM_CN_SQR_BY_PLAN_ID'));
   set_item_result(run_stored_sig('EBS_CRM_SM_CN_SQRU_BY_PLAN_ID'));
   set_item_result(run_stored_sig('EBS_CRM_SM_CN_SPQR_BY_PLAN_ID'));
   set_item_result(run_stored_sig('EBS_CRM_SM_CN_SPQE_BY_PLAN_ID'));
   set_item_result(run_stored_sig('EBS_CRM_SM_CN_SPAYEE_BY_PLAN_ID'));
   set_item_result(run_stored_sig('EBS_CRM_SM_CN_WF_ITEM_TYPES'));
end_section;
debug('end section: Setup');

debug('begin section: OpenPeriodSetup');
IF p_section = 1 or p_section=2 THEN
   start_section('Open Period Setup', 'OpenPeriodSetup');
      set_item_result(run_stored_sig('EBS_CRM_SM_CN_PERIOD_SETS_ALL'));
      set_item_result(run_stored_sig('EBS_CRM_SM_CN_PERIOD_TYPES_ALL'));
      set_item_result(run_stored_sig('EBS_CRM_SM_CN_REPOSITORIES_ALL'));
      set_item_result(run_stored_sig('EBS_CRM_SM_CN_PERIOD_STATUSES_ALL'));
      set_item_result(run_stored_sig('EBS_CRM_SM_CN_CAL_PER_INT_TYPES_ALL'));
      set_item_result(run_stored_sig('EBS_CRM_SM_GL_PERIOD_TYPES'));
      set_item_result(run_stored_sig('EBS_CRM_SM_GL_PERIOD_SETS'));
   end_section;
END IF;
debug('end section: OpenPeriodSetup');

debug('begin section: Collection');
IF p_section = 1 or p_section=3 THEN
   start_section('Collection', 'Collection');
      set_item_result(run_stored_sig('EBS_CRM_SM_CN_ROLES'));
      set_item_result(run_stored_sig('EBS_CRM_SM_CN_ROLE_PAY_GRPS_ALL'));
      set_item_result(run_stored_sig('EBS_CRM_SM_CORRUPT_OIC_PERIODS'));
      set_item_result(run_stored_sig('EBS_CRM_SM_CN_SRP_PAY_GROUPS_ALL'));
      set_item_result(run_stored_sig('EBS_CRM_SM_CN_SRP_ROLES'));
   end_section;
END IF;
debug('end section: Collection');

debug('begin section: Calculation');
IF p_section = 1 or p_section=4 THEN
   start_section('Calculation', 'Calculation');
      set_item_result(run_stored_sig('EBS_CRM_SM_CN_INTERVAL_TYPES'));
      set_item_result(run_stored_sig('EBS_CRM_SM_CN_SRP_PLAN_ASSIGNS'));
      set_item_result(run_stored_sig('EBS_CRM_SM_CN_PERIOD_QUOTAS_ALL'));
      set_item_result(run_stored_sig('EBS_CRM_SM_CN_SRP_PERIOD_QUOTAS_ALL'));
      set_item_result(run_stored_sig('EBS_CRM_SM_CN_SRP_INTEL_PERIODS_ALL'));
      set_item_result(run_stored_sig('EBS_CRM_SM_CN_SRP_PRD_QUOTAS_EXT_ALL'));
      set_item_result(run_stored_sig('EBS_CRM_SM_CN_SRP_PER_QUOTA_RC_ALL'));
      set_item_result(run_stored_sig('EBS_CRM_SM_CN_UNCALC_TRX'));
      set_item_result(run_stored_sig('EBS_CRM_SM_CN_FORMULA'));
      set_item_result(run_stored_sig('EBS_CRM_SM_PERF_ISSUE_CON_REQ'));
   end_section;
END IF;
debug('end section: Calculation');

debug('begin section: Payment');
IF (p_section = 1 or p_section=5)
and
g_payrun_id > 0 THEN
   start_section('Payment', 'Payment');
      set_item_result(run_stored_sig('EBS_CRM_SM_CN_COMM_LINES_API_ALL'));
      set_item_result(run_stored_sig('EBS_CRM_SM_CN_PAYRUNS_ALL'));
      set_item_result(run_stored_sig('EBS_CRM_SM_CN_PAYMENT_TRANSACTIONS_ALL'));
      set_item_result(run_stored_sig('EBS_CRM_SM_CN_COMMISSION_HEADERS_ALL'));
      set_item_result(run_stored_sig('EBS_CRM_SM_CN_COMMISSION_LINES_ALL'));
      set_item_result(run_stored_sig('EBS_CRM_SM_CN_PAYMENT_WORKSHEETS_ALL'));
      set_item_result(run_stored_sig('EBS_CRM_SM_CN_SRP_PERIODS_ALL'));
      set_item_result(run_stored_sig('EBS_CRM_SM_SALEREP_UNPAID_PAYRUN_PERIOD_INFO'));
      set_item_result(run_stored_sig('EBS_CRM_SM_PAYMENT_BATCH_PERIOD_LOV'));
      set_item_result(run_stored_sig('EBS_CRM_SM_CN_POSTING_DETAILS'));
      set_item_result(run_stored_sig('EBS_CRM_SM_CN_POSTING_DETAILS_SUM'));
      set_item_result(run_stored_sig('EBS_CRM_SM_CN_WORKSHEET_BONUS'));
   end_section;
END IF;
debug('end section: Payment');

debug('begin section: PaymentCollection');
IF (p_section = 1 or p_section=5)
and
g_payrun_id > 0 THEN
   start_section('Payment Collection Script', 'PaymentCollection');
      set_item_result(run_stored_sig('EBS_CRM_SM_PAYRUN_PROFILES'));
      set_item_result(run_stored_sig('EBS_CRM_SM_WORKSHEET_SUMMARY'));
      set_item_result(run_stored_sig('EBS_CRM_SM_SUBLEDGER_BALANCES'));
      set_item_result(run_stored_sig('EBS_CRM_SM_SUBLEDGER_VS_COMMISSION'));
      set_item_result(run_stored_sig('EBS_CRM_SM_COMMISSION_VS_PAYMENT'));
      set_item_result(run_stored_sig('EBS_CRM_SM_SUBLEDGER_VS_PAYMENT_POSTED'));
      set_item_result(run_stored_sig('EBS_CRM_SM_UNPAID_PAYMENTS'));
   end_section;
END IF;
debug('end section: PaymentCollection');
