...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Service Contracts Billing Analyzer     |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE oks_billing_analyzer_pkg AUTHID DEFINER AS
...
END oks_billing_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY oks_billing_analyzer_pkg AS
-- $Id: oks_billing_analyzer.sql, 200.23 2026/01/28 18:16:24 mantonyk Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(1987555.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'OKS_BILLING_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'OKS_BILLING_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>OKS_BILLING Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=1987555.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/oks_bill_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,4480,EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,4480,EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},4480,EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4027889" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">4480</span>
...
<div class="ck-content"><p>200.23</p><ul><li>Signature PREMIER_SUPPORT signatures updated</li>
...
<p>&nbsp;</p><p><strong>200.22 &lt;date&gt;</strong><br>
---------------</p><ul><li>Added signature &apos;<span class="display_only apex-item-display-only" data-escape="true" id="P18_TITLE_DISPLAY">OKC_K_VERS_NUMBERS and OKC_K_VERS_NUMBERS_H MINOR_VERSION Mismatch&apos;</span></li>
<li><span class="display_only apex-item-display-only" data-escape="true">Added signature &apos;</span><span class="display_only apex-item-display-only" data-escape="true" id="P18_TITLE_DISPLAY">There Are One or More Active Processes for the Contract&apos;</span></li>
</ul>
<p>&nbsp;</p><p><strong>200.21</strong><br>
---------------</p><ul><li>Signature updates</li>
</ul>
<p>&nbsp;</p><p><strong>Version 200.20</strong></p><p>----------------</p><ul><li>Signature updates</li>
</ul>
<p>&nbsp;</p><p><strong>Version 200.18</strong><br>
----------------<br>
Added the following new signatures:</p><p>a) Indexes with FAILED value for DOMIDX_OPSTATUS column<br>
b) DBA Objects reaching MAX of Extents</p><p><br>
<strong>Version 200.17</strong><br>
-----------------<br>
Added a new Signature: Service Contracts Sequences Reaching Maximum Value.<br>
<br>
<strong>Version 200.16</strong>:</p><ul><li>New Analyzer Framework version 4.6.0.1 released with bug fixes.</li>
</ul>
<p><strong>Version 200.15</strong>:</p><ul><li>Analyzer Framework 4.5.9.1 version released.</li>
</ul>
<p><strong>Version 200.14</strong>:</p><ul><li>Signatures enhanced.</li>
</ul>
<p><strong>Version 200.13</strong>:</p><ul><li>New signature(s) added.</li>
</ul>
<p><strong>Version 200.12</strong>:</p><ul><li>Lifetime Support Policy: Premier Support for R12.1.3 customers updated.</li>
</ul>
<p><strong>Version 200.11</strong>:</p><ol><li>New Analyzer Framework version 4.5.7 released with these changes:</li>
</ol>
...
<p><strong>Version 200.10</strong>:</p><p>A new and improved version of Service Contracts Billing Analyzer is built.<br>
Data collected in previous versions were more generic and&nbsp;was not always relevant for the input contract.<br>
This new&nbsp;analyzer is revamped to gather data specific to the contract.</p><p>New sections added:<br>
* Contracts Setup<br>
* Contract&nbsp;Data</p></div>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,4480,'||p_sig.sigrepo_id||',EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,4480,'||p_sig.sigrepo_id||',EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},4480,'||p_sig.sigrepo_id||',EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
FUNCTION check_rec_patches_1 RETURN VARCHAR2 IS
  /* Signature EBS_CRM_OKS_CHK_REC_PATCHES */
...
BEGIN
    ...
    print_log('Processing recommended patches signature: EBS_CRM_OKS_CHK_REC_PATCHES (check_rec_patches_1) "Recommended Patches" (version 1)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_col_rows(1)(l_rows) := '29304594';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OKS.B.delta.7';
   l_col_rows(5)(l_rows) := '[2506529.1]';

END IF;

   l_extra_info('##SHOW_SQL##'):= 'Y';

   l_sig.sigrepo_id := '19161';
...
<li>[10940175/KA580] Patch Wizard FAQ</li>
  ...
  -- Register
  l_step := '60';
  g_signatures('EBS_CRM_OKS_CHK_REC_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'EBS_CRM_OKS_CHK_REC_PATCHES',     -- sig ID
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Contract ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_contract_id,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/01/28 18:16:23 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'oks_billing_analyzer.sql';
...
debug('begin parameter validation: p_contract_id');
IF p_contract_id IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Contract ID is required.');
...
WHERE ID = p_contract_id
 AND SCS_CODE IN ('SERVICE','WARRANTY','SUBSCRIPTION')
AND TEMPLATE_YN = 'N'
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid contract id specified. Please verify the contract id from OKC_K_HEADERS_ALL_B table.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_contract_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_contract_id');
...
debug('begin add_signature: EBS_CRM_SC_OKS_BILLING_MAX_SEQ');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27708',
      p_sig_id                 => 'EBS_CRM_SC_OKS_BILLING_MAX_SEQ',
  ...
  FROM dba_sequences
 WHERE sequence_owner IN (''OKS'', ''OKC'')
...
If assistance is needed, log an SR with Sequence Owner product. ',
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_OKS_BILLING_MAX_SEQ');
...
debug('begin add_signature: EBS_CRM_SC_OKS_BILLING_IN_PROCESS_YN_EQUAL_Y');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30608',
      p_sig_id                 => 'EBS_CRM_SC_OKS_BILLING_IN_PROCESS_YN_EQUAL_Y',
      p_sig_sql                => 'select pdf_id
...
and IN_PROCESS_YN = ''Y''',
      p_title                  => 'There Are One or More Active Processes for the Contract',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This contract has one or more active processes. Attempting to terminate the contract may result in the following error:<br>
You cannot modify this contract now because a change request is active. Please retry later',
      p_solution               => 'See [1603417/KB255230] for the solution.',
      p_success_msg            => 'There are no active processes for this contract. See [1603417/KB255230] for details.',
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_OKS_BILLING_IN_PROCESS_YN_EQUAL_Y');



debug('begin add_signature: EBS_CRM_OKS_TRANS_TYPE_DEFN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17507',
      p_sig_id                 => 'EBS_CRM_OKS_TRANS_TYPE_DEFN',
      p_sig_sql                => 'select rcta1.org_id,
       rcta1.name transaction_name,
       rcta1.type transaction_type,
       rcta1.cust_trx_type_id,
       rcta1.status txn_type_status,
       rcta1.start_date txn_type_start_date,
       rcta1.end_date txn_type_end_date,
       rcta2.name credit_memo_transaction_name,
       rcta2.type cedit_transaction_type,
       rcta2.cust_trx_type_id credit_memo_type_id,
       rcta2.status credit_txn_type_status,
       rcta2.start_date credit_txn_type_start_date,
       rcta2.end_date credit_txn_type_end_date
  from ra_cust_trx_types_all rcta1,
       ra_cust_trx_types_all rcta2
 where rcta1.name in (''Invoice-OKS'')
   and SYSDATE between NVL(rcta1.start_date, SYSDATE - 1) and NVL(rcta1.end_date, SYSDATE+1)
   and NVL(rcta1.status, ''A'') = ''A''
   and rcta2.cust_trx_type_id (+) = rcta1.credit_memo_type_id
   and rcta2.org_id(+) = rcta1.org_id
   and SYSDATE between NVL(rcta2.start_date, SYSDATE - 1) and NVL(rcta2.end_date, SYSDATE+1)
   and NVL(rcta2.status, ''A'') = ''A''
   AND rcta1.org_id = ##$$ORGID$$##
 order by rcta1.org_id',
      p_title                  => 'Default Transaction Types',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The default transaction types that are used for Service Contracts invoices are not defined.',
      p_solution               => 'Define the default transaction types "<b>Invoice-OKS</b>" and "<b>Credit-OKS</b>" in Receivables.<br>
Please follow solution in: <br>
[473136/KB286371] - Autoinvoice from Contracts errors With ''Invalid Transaction Type Id (CUST_TRX_TYPE_ID)'' - Interface Line is created with no Transaction Type
',
      p_success_msg            => 'Displaying default transaction type and credit memo transaction type.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_OKS_TRANS_TYPE_DEFN');



debug('begin add_signature: EBS_CRM_OKS_BATCH_SRC_DEFN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17508',
      p_sig_id                 => 'EBS_CRM_OKS_BATCH_SRC_DEFN',
      p_sig_sql                => 'select * 
...
AND org_id = ##$$ORGID$$##
order by org_id',
      p_title                  => 'Batch Transaction Sources',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Batch transaction source used by Service Contracts module to interface transactions to Receivables is not defined.',
      p_solution               => 'Define the batch transaction source <b>OKS_CONTRACTS</b> for Service Contracts transactions.<br>
Please follow solution in: <br>
[2784910/KB599419] - How to setup Batch Transaction Source for Importing Service Contracts Invoices to Receivables',
      p_success_msg            => 'Displaying batch transaction source for Service Contracts transactions.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_OKS_BATCH_SRC_DEFN');



debug('begin add_signature: EBS_CRM_OKS_TXN_FLEXFIELDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19154',
      p_sig_id                 => 'EBS_CRM_OKS_TXN_FLEXFIELDS',
      p_sig_sql                => 'SELECT A.DESCRIPTIVE_FLEXFIELD_NAME,
       A.DESCRIPTIVE_FLEX_CONTEXT_CODE,  
       C.CONTEXT_COLUMN_NAME,
       D.APPLICATION_COLUMN_NAME,       
       D.END_USER_COLUMN_NAME,
       D.ENABLED_FLAG,
       D.REQUIRED_FLAG,
       D.DISPLAY_FLAG, 
 ...
 WHERE A.DESCRIPTIVE_FLEXFIELD_NAME = ''RA_INTERFACE_LINES''
   AND A.DESCRIPTIVE_FLEX_CONTEXT_CODE = ''OKS CONTRACTS''  
   AND A.ENABLED_FLAG = ''Y''
   AND C.DESCRIPTIVE_FLEXFIELD_NAME = A.DESCRIPTIVE_FLEXFIELD_NAME
   AND C.FREEZE_FLEX_DEFINITION_FLAG = ''Y''
   AND A.DESCRIPTIVE_FLEXFIELD_NAME = D.DESCRIPTIVE_FLEXFIELD_NAME 
   AND A.DESCRIPTIVE_FLEX_CONTEXT_CODE = D.DESCRIPTIVE_FLEX_CONTEXT_CODE
ORDER BY D.APPLICATION_COLUMN_NAME',
      p_title                  => 'Line Transaction Flexfield Segments',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Line Transaction Flexfield is not defined/compiled.',
      p_solution               => 'Define Line Transaction Flexfield. <br>
Please follow solution in: <br>
[139287/KB566603] - How To Verify Setup of the Line Transaction Flexfield in AR so Service Contracts will Invoice Properly',
      p_success_msg            => 'Displaying Line Transaction Flexfield setup.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_OKS_TXN_FLEXFIELDS');



debug('begin add_signature: EBS_CRM_OKS_GROUPING_RULE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17510',
      p_sig_id                 => 'EBS_CRM_OKS_GROUPING_RULE',
      p_sig_sql                => 'select batch.org_id ,
       batch.name batch_name,       
       batch.status batch_status, 
       g_rules.grouping_rule_id,
       g_rules.name rule_name,
       g_rules.description rule_description,
       gr.grouping_trx_type_id,
       gc.from_column_name grouping_column_name
  FROM ra_batch_sources_all batch,
       ra_grouping_rules g_rules,
       ra_grouping_trx_types gr,
       ra_group_bys gb,
       ra_group_by_columns gc
WHERE batch.NAME = ''OKS_CONTRACTS''
AND batch.org_id = ##$$ORGID$$##
AND sysdate BETWEEN nvl(batch.start_date, sysdate - 1) AND nvl(batch.end_date, sysdate+1)
AND nvl(batch.status, ''A'') = ''A'' 
AND g_rules.grouping_rule_id = batch.grouping_rule_id
AND sysdate BETWEEN nvl(g_rules.start_date, sysdate - 1) AND nvl(g_rules.end_date, sysdate+1)
AND gr.grouping_rule_id = g_rules.grouping_rule_id
AND gr.grouping_trx_type_id = gb.grouping_trx_type_id
AND gc.column_id  = gb.column_id
ORDER BY gc.from_column_name',
      p_title                  => 'Autoinvoice Grouping Rule Setup',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'AutoInvoice grouping rules are not defined.
',
      p_solution               => 'Grouping rules define how invoices will be grouped during AutoInvoice import. <br>
Please follow solution in:
<ul>
<li>
[143576/KB402641] - Multiple Service Contracts are Shown on One Invoice
</li>
<li>
[1067993/KB626338] - How To Use Grouping Rules With AutoInvoice
</li>
</ul>',
      p_success_msg            => 'Displaying AutoInvoice grouping rule for invoices generated from Service Contracts.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_OKS_GROUPING_RULE');



debug('begin add_signature: EBS_CRM_OKS_CURRENCY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17509',
      p_sig_id                 => 'EBS_CRM_OKS_CURRENCY',
...
ORDER BY CURRENCY_CODE',
      p_title                  => 'Contract Currency Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Currency used on the contract is disabled. This will cause billing to error.',
      p_solution               => 'Verify the currency setup and enable the currency.<br>
For more information, please review: <br>
[166579/KB775696] - How to Setup a New Currency In General Ledger?',
      p_success_msg            => 'Currency used on the contract is valid.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_OKS_CURRENCY');



debug('begin add_signature: EBS_CRM_OKS_ELIGIBLE_CATG_STS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17520',
      p_sig_id                 => 'EBS_CRM_OKS_ELIGIBLE_CATG_STS',
      p_sig_sql                => 'SELECT okcv.scs_code CATEGORY,
       okcv.ste_code STATUS_TYPE,
       okct.code STATUS_CODE,
       okct.meaning STATUS
  FROM okc_assents_v okcv,
       okc_statuses_v okct
 WHERE okcv.scs_code in (''SERVICE'', ''WARRANTY'', ''SUBSCRIPTION'')
   AND opn_code = ''INVOICE''
   AND okcv.sts_code = okct.code
   and okcv.allowed_yn =''Y''
ORDER BY CATEGORY, STATUS_TYPE, STATUS_CODE',
      p_title                  => 'Categories and Statuses Eligible for Billing',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no contract categories and statuses available for billing.',
      p_solution               => 'You can setup a status as "<b>Eligible for Invoicing</b>" or disable Invoicing operation for any status as required.<br>
Please follow solution in: <br>
[743634/KB775840] - How to Set Up Service Contract Statuses.',
      p_success_msg            => 'Displaying contract categories and statuses available for billing.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_OKS_ELIGIBLE_CATG_STS');



debug('begin add_signature: EBS_CRM_OKS_BILLING_COUNT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17519',
      p_sig_id                 => 'EBS_CRM_OKS_BILLING_COUNT',
      p_sig_sql                => 'SELECT status.scs_code CATEGORY,
       status.ste_code STATUS_TYPE,
       status.code STATUS_CODE,
       status.meaning STATUS_MEANING,
       COUNT(1) NUMBER_OF_CONTRACTS
  FROM okc_k_headers_all_b head,
       (
        SELECT okct.ste_code,
               okct.code, 
               okct.meaning,               
               okcv.scs_code
          FROM okc_assents_v      okcv,
               okc_statuses_v     okct
         WHERE okcv.sts_code = okct.code
           AND opn_code = ''INVOICE''
           AND allowed_yn = ''Y''
         ) status
  WHERE head.sts_code = status.code
    AND head.scs_code = status.scs_code
    AND head.scs_code IN ( ''SERVICE'', ''SUBSCRIPTION'', ''WARRANTY'' )
    AND EXISTS (
               SELECT 1
                 FROM oks_level_elements ole,
                      okc_k_lines_b oklb
                WHERE oklb.dnz_chr_id = head.id
                  AND oklb.id = ole.cle_id
                  AND ole.date_completed IS NULL
             )
 GROUP BY status.scs_code,
          status.ste_code,
          status.code,
          status.meaning
 ORDER BY status.scs_code,
          status.ste_code,
          status.code,
          status.meaning ',
      p_title                  => 'Contracts Available for Billing by Status',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no contracts available for billing as per status and operations definition.',
      p_solution               => '',
      p_success_msg            => 'Count of contracts available for billing as per status and operations definition.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_OKS_BILLING_COUNT');



debug('begin add_signature: EBS_CRM_OKS_HDR_DATA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17517',
      p_sig_id                 => 'EBS_CRM_OKS_HDR_DATA',
      p_sig_sql                => 'SELECT DISTINCT
    chrb.ID                         "ID",
    chrb.contract_number            "CONTRACT_NUMBER",
    chrb.contract_number_modifier   "CONTRACT_NUMBER_MODIFIER",
    chrt.short_description          "DESCRPTION",
    chrb.authoring_org_id           "OPERATING_UNIT",
    chrb.inv_organization_id        "INVENTORY_ORGANIZATION_ID",
    chrb.authoring_org_id           "AUTHORING_ORG_ID",
    chrb.sts_code                   "STATUS",
    scs_code                        "CATEGORY",
    chrb.currency_code              "CURRENCY",
    chrb.date_terminated            "DATE_TERMINATED",
    chrb.trn_code                   "TERMINATION_CODE",
    ...
    || chrb.price_list_id
    || '')'' "PRICE_LIST",
    chrb.BILL_TO_SITE_USE_ID,
    chrb.SHIP_TO_SITE_USE_ID,
    ra.name
    || '' (id = ''
    ...
    || khr.acct_rule_id
    || '')'' "ACCOUNTING_RULE",
    decode(chrb.inv_rule_id, - 2, ''Advance Invoice'', - 3, ''Arrears Invoice'') "INVOICING_RULE",
    khr.ar_interface_yn             "BILL_SERVICES",
    cls.meaning                     "CLASS_MEANING",
    chrb.template_yn          "TEMPLATE_YN",
    khr.hold_billing                "HOLD_BILLING",
    khr.period_type "PERIOD_TYPE",    
    khr.period_start "PERIOD_START",
    khr.price_uom "PRICE_UOM",
    (
    SELECT ROUND(SUM(oklb.price_NEGOTIATED),2)
      FROM okc_k_lines_b oklb
     WHERE oklb.chr_id = chrb.id 
    ) "CONTRACT_AMOUNT"
FROM
    ...
    oks_k_headers_b       khr,
    okc_statuses_v        sts,
    okc_subclasses_v      cls,
    ra_terms              ra,
    oe_ak_acc_rules_v     oa,
    qp_price_lists_v      qp
WHERE
    chrb.id = chrt.id
    ...
    AND ra.term_id(+) = chrb.payment_term_id
    AND oa.accounting_rule_id (+) = khr.acct_rule_id
    AND qp.price_list_id(+) = chrb.price_list_id
AND chrb.id = ##$$CTRID$$##',
      p_title                  => 'Contract Header Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Contract not found.',
      p_solution               => '',
      p_success_msg            => 'Displaying contract header data.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_OKS_HDR_DATA');



debug('begin add_signature: EBS_CRM_OKS_BILLING_FLAG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17478',
      p_sig_id                 => 'EBS_CRM_OKS_BILLING_FLAG',
      p_sig_sql                => 'SELECT
    okc_h.scs_code   AS "CATEGORY",
    okc_h.sts_code   AS "STATUS",
    okc_h.contract_number AS "CONTRACT_NUMBER",
    okc_h.contract_number_modifier AS "CONTRACT_NUMBER_MODIFIER",
    oks_h.ar_interface_yn "BILL_SERVICES_FLAG"
FROM
    okc_k_headers_all_b   okc_h,
    oks_k_headers_b       oks_h
WHERE
    okc_h.id = oks_h.chr_id
    AND oks_h.ar_interface_yn IS NOT NULL
    AND okc_h.template_yn = ''N''
        AND okc_h.id = ##$$CTRID$$##',
      p_title                  => 'Bill Services Flag',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Bill Services flag is not setup (column AR_INTERFACE_YN IS NULL).',
      p_solution               => '<b>Bill Services</b> should be set to either <b>Yes</b>, <b>No</b> or <b>At Renewal</b>.<br>
For more information, please review: <br>
[1468221/KB449839] - How Does the Setting of the ''Bill Services'' LOV on a Service Contract Affect Billing
',
      p_success_msg            => 'Bill Services flag is setup.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_OKS_BILLING_FLAG');



debug('begin add_signature: EBS_CRM_OKS_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19146',
      p_sig_id                 => 'EBS_CRM_OKS_LINES',
      p_sig_sql                => 'SELECT oklb1.id line_id,
       oklb1.line_number line_number,
       oklb1.lse_id line_lse_id,
       olsb1.lty_code line_lse_name,
       oklb1.sts_code line_sts_code,
       oklb1.start_date line_start_date,
       oklb1.end_date line_end_date,       
       oklb1.date_terminated line_date_terminated,
       oklb1.trn_code line_trn_code,
       oklb1.price_negotiated line_amount,
       osl1.ubt_amount line_ubt_amount,
       osl1.credit_amount line_credit_amount,
       osl1.suppressed_credit line_suppressed_credit,
       osl1.override_amount line_override_amount,
       oklb2.id subline_id,
       DECODE(oklb2.line_number, NULL, NULL, oklb1.line_number||''.''||oklb2.line_number) subline_number,
       oklb2.lse_id subline_lse_id,
       olsb2.lty_code subline_lse_name,
       oklb2.sts_code subline_sts_code,
       oklb2.start_date subline_start_date,
       oklb2.end_date subline_end_date,       
       oklb2.date_terminated subline_date_terminated,
       oklb2.trn_code subline_trn_code,
       oklb2.price_negotiated subline_amount,
       osl2.ubt_amount subline_ubt_amount,
       osl2.credit_amount subline_credit_amount,
       osl2.suppressed_credit subline_suppressed_credit,
       osl2.override_amount subline_override_amount      
  FROM okc_k_lines_b oklb1,
       ...
       oks_k_lines_b osl1,
       oks_k_lines_b osl2
 WHERE oklb1.chr_id = ##$$CTRID$$##
   AND oklb1.id = oklb2.cle_id(+)
   AND oklb1.lse_id = olsb1.id
   AND oklb2.lse_id = olsb2.id(+)
   AND oklb1.id = osl1.cle_id
   AND oklb2.id = osl2.cle_id(+)
 ORDER BY oklb1.id, oklb2.id  ',
      p_title                  => 'Contract Line Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Contract lines not found.',
      p_solution               => '',
      p_success_msg            => 'Displaying contract lines details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_OKS_LINES');



debug('begin add_signature: EBS_CRM_OKS_BILL_SCHEDULES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17518',
      p_sig_id                 => 'EBS_CRM_OKS_BILL_SCHEDULES',
      p_sig_sql                => 'SELECT (
       select DECODE(lvl.parent_cle_id, lvl.cle_id, oklb.line_number, oklb1.line_number||''.''|| oklb.line_number)
         from okc_k_lines_b oklb1
        where oklb1.id = lvl.parent_cle_id 
       ) line_number,
       oklb.lse_id,
       strm.sequence_no      STREAM_SEQ_NUMBER,
       lvl.sequence_number   SCHEDULE_SEQ_NUMBER,
       lvl.date_start        BILL_FROM,
       lvl.date_end          BILL_TO,
       lvl.amount            AMOUNT,
       lvl.date_transaction  INVOICE_DATE,
       lvl.date_to_interface INTERFACE_DATE,
       lvl.date_completed    COMPLETION_DATE,  
       lvl.id,
       lvl.parent_cle_id,
       lvl.cle_id
  FROM oks_stream_levels_b   strm,
       ...
       okc_k_lines_b         oklb
 WHERE oklb.dnz_chr_id = ##$$CTRID$$##      
   AND strm.cle_id = oklb.id
   AND strm.id = lvl.rul_id
ORDER BY parent_cle_id,
         cle_id,
         lvl.date_start',
      p_title                  => 'Billing Schedules',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Contract billing schedules are not yet generated.',
      p_solution               => '',
      p_success_msg            => 'Displaying contract billing schedule details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_OKS_BILL_SCHEDULES');



debug('begin add_signature: EBS_CRM_OKS_BILL_TERMINATE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17513',
      p_sig_id                 => 'EBS_CRM_OKS_BILL_TERMINATE',
      p_sig_sql                => 'SELECT *
FROM
(
SELECT oklb1.line_number
       || ''.''
       || oklb2.line_number line_number,
       oklb2.lse_id,
       oklb2.ID line_id,
       oklb2.date_terminated,
       ele.ID schedule_id,
       ele.date_start schedule_start_date,
       ele.date_end schedule_end_date,
       ele.amount              
  FROM oks_level_elements    ele,
       okc_k_lines_b         oklb1,
       okc_k_lines_b         oklb2
 WHERE oklb1.chr_id = ##$$CTRID$$##
   AND oklb1.lse_id IN (1,12 ,19)
   AND oklb1.ID = oklb2.cle_id
   AND oklb2.date_terminated IS NOT NULL
   AND oklb2.ID = ele.cle_id
   AND ele.date_completed IS NULL
   AND ele.date_end >= oklb2.date_terminated
UNION 
SELECT oklb1.line_number  line_number,
       oklb1.lse_id,
       oklb1.ID line_id,
 ...
 WHERE oklb1.chr_id = ##$$CTRID$$## 
   AND oklb1.lse_id = 46
   AND oklb1.date_terminated IS NOT NULL
   AND oklb1.ID = ele.cle_id
   AND ele.date_completed IS NULL
   AND ele.date_end >= oklb1.date_terminated
)
ORDER BY line_id, schedule_start_date',
      p_title                  => 'Billing Schedules After Termination Date',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found these unbilled schedules falling after termination date on terminated lines.',
      p_solution               => 'Please follow solution in:
<ul>
<li>
For 12.1: [1570172/KB252529] - Bill To on Billing Schedule not Adjusted When Contract Line is Terminated in Unbilled Period
 </li>
<li>
For 12.2: [2649970/KB317238] - Some Service Contracts Didn''t Delete the Future Billing Schedule Lines Upon Termination
</li>
</ul>
Please log a Service Request, for possible datafix for existing records having the issue.',
      p_success_msg            => 'No unbilled schedules outside termination date were found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_OKS_BILL_TERMINATE');



debug('begin add_signature: EBS_CRM_OKS_BILL_HISTORY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19148',
      p_sig_id                 => 'EBS_CRM_OKS_BILL_HISTORY',
      p_sig_sql                => 'SELECT oklb1.line_number,   
       oklb1.lse_id,
       obcl.id obcl_id,
       obcl.cle_id obcl_cle_id,       
       obcl.btn_id,
       obt.trx_number btn_trx_number,
       obcl.bill_action,       
       obcl.date_billed_from line_billed_from,
       obcl.date_billed_to line_billed_to,     
       obcl.amount line_billed_amount, 
       DECODE(oklb1.lse_id, 46, oklb1.line_number, oklb1.line_number||''.''||oklb2.line_number) subline_number, 
       DECODE(oklb1.lse_id, 46, oklb1.lse_id, oklb2.lse_id) subline_lse_id,
       obsl.id obsl_id,
       obsl.cle_id obsl_cle_id,
       obsl.date_billed_from subline_billed_from,
       obsl.date_billed_to subline_billed_to,
       obsl.amount subline_billed_amount,
       obsld.id obsld_id,
       obsld.unit_of_measure,
       obsld.amcv_yn,
       obsld.amount obsld_amount,
       obsld.fixed,
       obsld.actual,
       obsld.start_reading,
       obsld.end_reading,
 ...
 WHERE oklb1.chr_id = ##$$CTRID$$##
   AND oklb1.id = obcl.cle_id
   AND obcl.id = obsl.bcl_id
   AND obsl.cle_id = oklb2.id
   AND obsl.id = obsld.bsl_id
   AND obt.id(+) = obcl.btn_id
 ORDER BY obcl.cle_id,
       obsl.cle_id,
       obcl.date_billed_from,
       obcl.bill_action',
      p_title                  => 'Billing History',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Billing history not found.',
      p_solution               => 'Please run ''<b>Service Contracts Main Billing</b>'' to bill the contract.<br>
For more information, please review: <br>
[213916/KB570846#aref_section21] - Troubleshooting Why Invoice Numbers are Not Shown in the Service Contracts Billing History',
      p_success_msg            => 'Displaying billing history.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_OKS_BILL_HISTORY');



debug('begin add_signature: EBS_CRM_OKS_CREDIT_SUPPRESS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17506',
      p_sig_id                 => 'EBS_CRM_OKS_CREDIT_SUPPRESS',
      p_sig_sql                => 'SELECT oklb.line_number,
       oklb.id line_id,
       SUM(obcl.amount) SUPPRESSED_AMOUNT
FROM okc_k_lines_b oklb,
     oks_bill_cont_lines obcl
WHERE obcl.cle_id = oklb.id
  AND obcl.bill_action = ''TR''
  AND oklb.chr_id = ##$$CTRID$$##
  AND obcl.btn_id = -44
GROUP BY oklb.line_number,
         oklb.id  
ORDER BY oklb.id',
      p_title                  => 'Credit Suppressed on Contract',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Credit has been suppressed on the contract.',
      p_solution               => 'Check if this is still valid or if ''<b>Service Contracts Program to Process Suppress Credits</b>'' should be run to process the suppressed credits.<br>
For more information, please review: <br>
[292983/KB477152] - What is The Purpose of the Service Contracts Program to Process Suppressed Credits',
      p_success_msg            => 'No suppressed credit found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_OKS_CREDIT_SUPPRESS');



debug('begin add_signature: EBS_CRM_OKS_INTERFACE_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19150',
      p_sig_id                 => 'EBS_CRM_OKS_INTERFACE_LINES',
      p_sig_sql                => 'SELECT RA.ORG_ID,
       RA.INTERFACE_LINE_ID,
       RA.INTERFACE_LINE_ATTRIBUTE1 CONTRACT_NUMBER,
       RA.INTERFACE_LINE_ATTRIBUTE2 CONTRACT_NUMBER_MODIFIER,
       RA.SALES_ORDER_LINE LINE,
       RA.INTERFACE_LINE_ATTRIBUTE9 LINE_TYPE,
       RA.INTERFACE_LINE_ATTRIBUTE4 BILL_FROM,
       RA.INTERFACE_LINE_ATTRIBUTE5 BILL_TO,
       RA.AMOUNT,
       RA.TRX_DATE,
       RA.GL_DATE,
       RA.RULE_START_DATE
 ...
 WHERE OKHB.ID = ##$$CTRID$$##
   AND RA.INTERFACE_LINE_ATTRIBUTE1 = OKHB.CONTRACT_NUMBER
   AND RA.INTERFACE_LINE_ATTRIBUTE2 = NVL(OKHB.CONTRACT_NUMBER_MODIFIER, ''-'')
   AND RA.INTERFACE_LINE_CONTEXT = ''OKS CONTRACTS''
   AND RA.INTERFACE_LINE_ID IS NULL
 ORDER BY RA.SALES_ORDER_LINE,
       RA.INTERFACE_LINE_ATTRIBUTE4',
      p_title                  => 'Receivables Interface Lines',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found billing records pending in Receivables interface table.',
      p_solution               => 'Please run ''<b>Autoinvoice Import Program</b>'' to interface invoices/credit memos to Receivables.<br>
For more information, please review: <br>
[213916/KB570846#aref_section22] - Troubleshooting Why Invoice Numbers are Not Shown in the Service Contracts Billing History',
      p_success_msg            => 'No records found pending in Receivables interface.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_OKS_INTERFACE_LINES');



debug('begin add_signature: EBS_CRM_OKS_ERRORED_TRXNS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17522',
      p_sig_id                 => 'EBS_CRM_OKS_ERRORED_TRXNS',
      p_sig_sql                => 'SELECT RA.ORG_ID,
       RA.INTERFACE_LINE_ID,
       RA.INTERFACE_LINE_ATTRIBUTE1 CONTRACT_NUMBER,
       RA.INTERFACE_LINE_ATTRIBUTE2 CONTRACT_NUMBER_MODIFIER,
       ...
       RA.GL_DATE,
       RA.RULE_START_DATE,
       RAE.MESSAGE_TEXT  ERROR_MESSAGE        
  FROM RA_INTERFACE_LINES_ALL RA,
       RA_INTERFACE_ERRORS_ALL RAE,
       OKC_K_HEADERS_ALL_B OKHB
 WHERE OKHB.ID = ##$$CTRID$$##
  AND RA.INTERFACE_LINE_ATTRIBUTE1 = OKHB.CONTRACT_NUMBER
  AND RA.INTERFACE_LINE_ATTRIBUTE2 = NVL(OKHB.CONTRACT_NUMBER_MODIFIER, ''-'')
  AND RA.INTERFACE_LINE_CONTEXT = ''OKS CONTRACTS''
  AND RA.INTERFACE_LINE_ID = RAE.INTERFACE_LINE_ID
ORDER BY RA.SALES_ORDER_LINE,
      RA.INTERFACE_LINE_ATTRIBUTE4',
      p_title                  => 'Errors in Receivables Interface',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found records in Receivables interface errors table.',
      p_solution               => 'Billing record(s) have errored during Autoinvoice Import. Please review Autoinvoice Interface errors and action.<br>
To gather more details on the interface error(s) and steps to fix it, please review [1523525/KB627741] and run the Receivables AutoInvoice Analyzer.',
      p_success_msg            => 'No records found in the Receivables interface error table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_OKS_ERRORED_TRXNS');



debug('begin add_signature: EBS_CRM_OKS_INVOICES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19152',
      p_sig_id                 => 'EBS_CRM_OKS_INVOICES',
      p_sig_sql                => 'SELECT *
FROM
(
SELECT RCLA.SALES_ORDER_SOURCE BILLING_SOURCE,
       RCTA.ORG_ID,
       RAT.TYPE INVOICE_CLASS,
       ...
       RCLA.CUSTOMER_TRX_LINE_ID,
       RCLA.LINE_NUMBER,
       RCLA.INVENTORY_ITEM_ID,
       RCLA.DESCRIPTION,
       RCLA.SALES_ORDER,
       RCLA.SALES_ORDER_LINE,
       RCLA.QUANTITY_ORDERED,
       RCLA.UNIT_SELLING_PRICE,    
       RCLA.EXTENDED_AMOUNT,
       RCLA.PREVIOUS_CUSTOMER_TRX_ID,
       RCLA.PREVIOUS_CUSTOMER_TRX_LINE_ID,
       RCLA.RULE_START_DATE,
       RCLA.INTERFACE_LINE_ATTRIBUTE1,
       RCLA.INTERFACE_LINE_ATTRIBUTE2,
       RCLA.INTERFACE_LINE_ATTRIBUTE3,        
       RCLA.INTERFACE_LINE_ATTRIBUTE4,
       RCLA.INTERFACE_LINE_ATTRIBUTE5,
       RCLA.INTERFACE_LINE_ATTRIBUTE6
  FROM OKC_K_HEADERS_ALL_B OKHB,
       RA_CUSTOMER_TRX_ALL RCTA,
       RA_CUSTOMER_TRX_LINES_ALL  RCLA,
       RA_CUST_TRX_TYPES_ALL RAT       
 WHERE OKHB.ID = ##$$CTRID$$##
   AND RCTA.INTERFACE_HEADER_ATTRIBUTE1 = OKHB.CONTRACT_NUMBER
   AND RCTA.INTERFACE_HEADER_ATTRIBUTE2 = NVL(OKHB.CONTRACT_NUMBER_MODIFIER, ''-'')
   AND RCTA.INTERFACE_HEADER_CONTEXT = ''OKS CONTRACTS''
   AND RCTA.CUSTOMER_TRX_ID = RCLA.CUSTOMER_TRX_ID 
   AND RCLA.LINE_TYPE = ''LINE''
   AND RCTA.CUST_TRX_TYPE_ID = RAT.CUST_TRX_TYPE_ID
   AND RCTA.ORG_ID = RAT.ORG_ID
UNION
SELECT RCLA.SALES_ORDER_SOURCE BILLING_SOURCE,
       RCTA.ORG_ID,
       RAT.TYPE INVOICE_CLASS,
 ...
 WHERE OKHB.ID = ##$$CTRID$$##
   ...
   AND REL.CLE_ID = OKLB.ID
   AND REL.JTOT_OBJECT1_CODE = ''OKX_ORDERLINE''
   AND REL.OBJECT1_ID1 = OEL.LINE_ID
   AND OEL.HEADER_ID = OE.HEADER_ID
   AND RCLA.INTERFACE_LINE_ATTRIBUTE1 = TO_CHAR(OE.ORDER_NUMBER)  
   AND RCLA.SALES_ORDER = TO_CHAR(OE.ORDER_NUMBER)
   AND RCLA.INTERFACE_LINE_ATTRIBUTE6 = REL.OBJECT1_ID1 
   AND RCLA.INTERFACE_LINE_CONTEXT = ''ORDER ENTRY''
   AND RCLA.LINE_TYPE = ''LINE''
   AND RCTA.CUSTOMER_TRX_ID = RCLA.CUSTOMER_TRX_ID 
   AND RCTA.CUST_TRX_TYPE_ID = RAT.CUST_TRX_TYPE_ID
   AND RCTA.ORG_ID = RAT.ORG_ID
...
ORDER BY CUSTOMER_TRX_ID, 
      ...
      p_title                  => 'Contract Invoices',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Invoices not found for the contract.',
      p_solution               => '',
      p_success_msg            => 'Displaying contract invoice details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_OKS_INVOICES');



debug('begin add_signature: EBS_CRM_OKS_FETCH_RECEIVE_YN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17521',
      p_sig_id                 => 'EBS_CRM_OKS_FETCH_RECEIVE_YN',
      p_sig_sql                => 'SELECT oklb.line_number, 
       rcl.sales_order_line subline_number,
       obcl.date_billed_from,
       obcl.date_billed_to,
       obt.trx_number billing_invoice_number,
       rct.trx_number ar_invoice_number,
       rat.TYPE,
 ...
 WHERE okhb.ID = ##$$CTRID$$## 
   ...
   AND oklb.ID = obcl.cle_id
   AND obcl.btn_id = obt.ID
   AND obt.ID = obtl.btn_id
   AND obt.trx_number = -99
   AND rcl.interface_line_attribute1 = okhb.contract_number
   AND rcl.interface_line_attribute2 = nvl(okhb.contract_number_modifier,''-'')
   AND rcl.interface_line_attribute3 = to_char(obtl.bill_instance_number)
   AND rcl.interface_line_context = ''OKS CONTRACTS''
   AND rcl.line_type =''LINE''
   AND rcl.org_id = okhb.org_id
   AND rct.customer_trx_id = rcl.customer_trx_id
   AND rcl.org_id = rct.org_id
   AND rct.cust_trx_type_id = rat.cust_trx_type_id      
   AND rcl.org_id = rat.org_id
ORDER BY oklb.line_number ',
      p_title                  => 'Fetch Receivables Info for Billing',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Not all invoice data has been passed from Receivables to Service Contracts.',
      p_solution               => 'Please run <b>''Service Contracts Fetch Receivables Info for Billing''</b> concurrent program to populate invoice details in contract billing history.<br>
For more information, please review: <br>
[213916/KB570846#aref_section23] - Troubleshooting Why Invoice Numbers are Not Shown in the Service Contracts Billing History',
      p_success_msg            => 'Either all invoice numbers are fetched back to billing history or invoices are not generated yet.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_OKS_FETCH_RECEIVE_YN');



debug('begin add_signature: EBS_CRM_SC_OKS_BILLING_PERIODS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22887',
      p_sig_id                 => 'EBS_CRM_SC_OKS_BILLING_PERIODS',
      p_sig_sql                => 'SELECT okh.contract_number,
       okh.contract_number_modifier ,
       to_char(okc.dnz_chr_id) contract_id,
       to_char(okc.id) line_id,
       to_char(okc.cle_id) parent_line_id,
       okc.lse_id,
       le.date_start ,
       le.date_end ,
       le.id id,
       ...
       le.date_completed
  FROM oks_level_elements le,
       okc_k_lines_b okc,
       okc_k_headers_all_b okh
 WHERE okh.id = okc.dnz_chr_id
   AND le.date_completed IS NULL
   AND okc.id = le.cle_id
   AND EXISTS (select 1
      ...
      p_title                  => 'EBS CRM OKS Billing Periods',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Verifying Contract Billing Periods Data',
      p_solution               => 'Please log a Service Request, for possible datafix, referring to this internal [1933183/KB245831] - DATAFIX / ERROR: Failed in get next level of coverage leading to further Periods not being Billed<br>
and provide/upload any additional information in SR.
',
      p_success_msg            => 'Data corruption exists in the contract billing periods ',
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_OKS_BILLING_PERIODS');



debug('begin add_signature: EBS_CRM_SC_OKS_BILLING_MINOR_VERSION_MISMATCH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30307',
      p_sig_id                 => 'EBS_CRM_SC_OKS_BILLING_MINOR_VERSION_MISMATCH',
      p_sig_sql                => 'select b.id, b.contract_number, c.minor_version OKVNH_minor_version, a.minor_version OKVN_minor_version
from OKC_K_VERS_NUMBERS_H a, OKC_K_HEADERS_ALL_B b, OKC_K_VERS_NUMBERS c
where a.chr_id = c.chr_id
and c.minor_version -1 != a.minor_version
and a.chr_id = b.id
and b.id = ##$$CTRID$$##',
      p_title                  => 'OKC_K_VERS_NUMBERS and OKC_K_VERS_NUMBERS_H MINOR_VERSION Mismatch',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The minor version in table OKC_K_VERS_NUMBERS (for a contract) should be 1 more than the latest minor version in the table OKC_K_VERS_NUMBERS_H (for that contract).  
<br>
This mismatch can cause Error:<br>
The current operation failed as another user is updating this contract.
Please try this operation later.',
      p_solution               => 'See [978003/KB856940] for the solution.',
      p_success_msg            => 'There is no MINOR_VERSION mismatch.  See [978003/KB856940] for details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_OKS_BILLING_MINOR_VERSION_MISMATCH');
...
BEGIN
  ...
  analyzer_title := 'Service Contracts Billing Analyzer';
...
start_section('Proactive and Preventative Recommendations', 'Proactive_and_Preventative_Recommendations');
   set_item_result(check_rec_patches_1); /* Signature EBS_CRM_OKS_CHK_REC_PATCHES */
   set_item_result(run_stored_sig('EBS_CRM_SC_OKS_BILLING_MAX_SEQ'));
   set_item_result(run_stored_sig('EBS_CRM_SC_GEN_DOMIDX_FAILED'));
   set_item_result(run_stored_sig('EBS_CRM_SC_GEN_MAX_EXTENT_OBJ'));
   set_item_result(run_stored_sig('EBS_CRM_SC_OKS_BILLING_IN_PROCESS_YN_EQUAL_Y'));
end_section;
debug('end section: Proactive_and_Preventative_Recommendations');

debug('begin section: Setup_Check');
start_section('Contracts Setup', 'Setup_Check');
   set_item_result(run_stored_sig('EBS_CRM_OKS_TRANS_TYPE_DEFN'));
   set_item_result(run_stored_sig('EBS_CRM_OKS_BATCH_SRC_DEFN'));
   set_item_result(run_stored_sig('EBS_CRM_OKS_TXN_FLEXFIELDS'));
   set_item_result(run_stored_sig('EBS_CRM_OKS_GROUPING_RULE'));
   set_item_result(run_stored_sig('EBS_CRM_OKS_CURRENCY'));
   set_item_result(run_stored_sig('EBS_CRM_OKS_ELIGIBLE_CATG_STS'));
   set_item_result(run_stored_sig('EBS_CRM_OKS_BILLING_COUNT'));
end_section;
debug('end section: Setup_Check');

debug('begin section: Contract_Data');
start_section('Contract Data', 'Contract_Data');
   set_item_result(run_stored_sig('EBS_CRM_OKS_HDR_DATA'));
   set_item_result(run_stored_sig('EBS_CRM_OKS_BILLING_FLAG'));
   set_item_result(run_stored_sig('EBS_CRM_OKS_LINES'));
   set_item_result(run_stored_sig('EBS_CRM_OKS_BILL_SCHEDULES'));
   set_item_result(run_stored_sig('EBS_CRM_OKS_BILL_TERMINATE'));
   set_item_result(run_stored_sig('EBS_CRM_OKS_BILL_HISTORY'));
   set_item_result(run_stored_sig('EBS_CRM_OKS_CREDIT_SUPPRESS'));
   set_item_result(run_stored_sig('EBS_CRM_OKS_INTERFACE_LINES'));
   set_item_result(run_stored_sig('EBS_CRM_OKS_ERRORED_TRXNS'));
   set_item_result(run_stored_sig('EBS_CRM_OKS_INVOICES'));
   set_item_result(run_stored_sig('EBS_CRM_OKS_FETCH_RECEIVE_YN'));
   set_item_result(run_stored_sig('EBS_CRM_SC_OKS_BILLING_PERIODS'));
   set_item_result(run_stored_sig('EBS_CRM_SC_OKS_BILLING_MINOR_VERSION_MISMATCH'));
end_section;
debug('end section: Contract_Data');
