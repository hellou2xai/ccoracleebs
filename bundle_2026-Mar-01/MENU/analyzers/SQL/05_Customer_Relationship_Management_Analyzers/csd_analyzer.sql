...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Depot Repair Analyzer                  |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE csd_analyzer_pkg AUTHID DEFINER AS
...
PROCEDURE main
(            p_repair_number                IN VARCHAR2    DEFAULT NULL
...
END csd_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY csd_analyzer_pkg AS
-- $Id: csd_analyzer.sql, 200.22 2026/01/28 18:00:06 nkanumur Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2280570.1));
...
----------------------------------------------------------------
g_org_id       number;
g_app_name varchar(4);
g_repair_line_id   NUMBER        := NULL;   -- (REPAIR_LINE_ID)
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'CSD_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'CSD_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>CSD Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2280570.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/csd_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,4478,EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,4478,EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},4478,EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4089021" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">4478</span>
...
<div class="ck-content"><p>Verion 200.22 &nbsp;01/28/2026<br>
---</p><p>Signature PREMIER_SUPPORT signatures updated<br>
Signature AC_DB_PARAMETERS updated<br>
Signature EBS_ATG_UGLE_32BIT_SEQUENCES_CLOSE_TO_MAX updated<br>
Signature EBS_ATG_UGLE_SEQUENCES_CLOSE_TO_MAXIMUM_VALUE updated<br>
Signature AC_INVALID_TABLE_INDEXES updated</p><p>Version 200.21 11-Dec-2025<br>
----<br>
Signature AC_TABLE_INDEXES has been updated<br>
Signature EBS_ATG_UGLE_SEQUENCES_CLOSE_TO_MAXIMUM_VALUE has been updated</p><p>Version 200.20 22-Sep-2025<br>
----------------<br>
Added a new Signature: EBS_CRM_SC_CSD_INTERNAL_MOVE_ORDERS<br>
(Internal Move Orders output found in tab Repair Order Details)</p><p>Version 200.19 06-Feb-2025<br>
-------------<br>
Added a new Signature: EBS_CRM_SC_CSD_EXCLUDE_ENDECA<br>
&nbsp;</p><p>Version 200.18 26-SEP-2024<br>
---------------</p><p>Signature updates</p><p>Version 200.17 10-Jul-2024<br>
-------------------<br>
Added a new Signature: EBS_CRM_SC_UMX_ACCESS_ROLE<br>
<br>
Version 200.16<br>
--------------<br>
Added the following new signatures</p><p>EBS_CRM_SC_CSD_MAT_DBF: Repair Task Material Debrief Lines<br>
EBS_CRM_SC_CSD_LAB_DBF: Repair Task Labor Debrief Lines<br>
EBS_CRM_SC_CSD_EXP_DBF: Repair Task Expense Debrief Lines</p><p>Modified the Sql Queries behind the following signatures:<br>
EBS_CRM_CSD_ORDER_HEADER_DTLS<br>
EBS_CRM_CSD_ORDER_LINE_DTLS</p><p>-------------<br>
Version 200.15 &lt;date&gt;</p><ul><li>Added signature <span class="display_only apex-item-display-only" id="P18_TITLE_DISPLAY">Pricing Modifier In Across All Phases</span></li>
</ul>
<p>&nbsp;</p><p>Version 200.14&nbsp;<br>
----------------<br>
Added the following new signatures:</p><p>a) Estimate lines that have NOT been imported into Actuals<br>
b) WIP jobs shared across repair orders ineligible for importing of WIP debrief lines.</p><p>Version 200.13&nbsp;<br>
----------------<br>
Added the following new signatures:</p><p>a) Indexes with FAILED value for DOMIDX_OPSTATUS column<br>
b) DBA Objects reaching MAX# of Extents</p><p>Version 200.12<br>
-----------------<br>
Added a new Signature: Depot Repair Sequences Reaching Maximum Value.</p><p>Version 200.11<br>
-----------------<br>
New Signature added to show the details of Concurrent request: Create SR/SO From OM RMA Lines.</p><p>Version 200.10<br>
-----------------<br>
New Analyzer Framework version 4.6.0.1 released with bug fixes.</p><p>Version 200.9<br>
-----------------<br>
New section created Wip Entity Details along with new signatures. Signatures added to show the details of:</p><p>Wip Requirement Details&nbsp;<br>
Wip Operation Resources<br>
Wip Transaction Details&nbsp;<br>
Wip Discrete Jobs</p><p>Version 200.8<br>
-----------------<br>
Lifetime Support Policy: Premier Support for R12.1.3 customers updated.</p><p>Version 200.7<br>
-----------------<br>
New Signatures added to show following details:</p><p>Service Request<br>
Service/Repair Order<br>
Diagnostic Codes<br>
Service Codes<br>
Modified the Recommended Patches Signature by appending the latest Depot 12.2. RPC Patch.<br>
New Signature added to Validate Profile CSD: Default Service Order Organization in Repair Order Setup section<br>
New Signature added to capture CS_CHG_IB_TOO_MANY_SOURCES Error in Charges Section</p><p>Version 200.6<br>
-----------------<br>
New Analyzer Framework version 4.5.7 released with these changes:</p><p>Summary of signatures that failed at the end of the log<br>
Signature Version Reported in Analyzer Output<br>
Remove unnecessary icons for signatures with no data<br>
Fixed DB Name character string buffer too small</p><p>Version 200.5<br>
-----------------<br>
New Sections added for more clarity<br>
New data collection signatures added<br>
Redundant signatures removed/modified<br>
Filtering criteria added to fetch only specific data</p></div>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,4478,'||p_sig.sigrepo_id||',EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,4478,'||p_sig.sigrepo_id||',EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},4478,'||p_sig.sigrepo_id||',EBS,EBS CRM,EBS - Service and Contracts" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
FUNCTION check_rec_patches_1 RETURN VARCHAR2 IS
  /* Signature EBS_CRM_CSD_CHECK_REC_PATCHES */
...
BEGIN
    ...
    print_log('Processing recommended patches signature: EBS_CRM_CSD_CHECK_REC_PATCHES (check_rec_patches_1) "Recommended Patches" (version 7)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30223751';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'ORACLE DEPOT REPAIR RECOMMENDED PATCH COLLECTION (19-NOV-19)';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33126013';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'ORACLE DEPOT REPAIR RECOMMENDED PATCH COLLECTION 21-AUG-2021';
   l_col_rows(5)(l_rows) := '[1664631.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33181658';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'ORACLE DEPOT REPAIR RECOMMENDED PATCH COLLECTION 02-NOV-2021';
   l_col_rows(5)(l_rows) := '[1664631.1]';
...
<li>[10940175/KA580] Patch Wizard FAQ</li>
  ...
  -- Register
  l_step := '60';
  g_signatures('EBS_CRM_CSD_CHECK_REC_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'EBS_CRM_CSD_CHECK_REC_PATCHES',     -- sig ID
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Repair Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_repair_number,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/01/28 18:00:05 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'csd_analyzer.sql';
...
debug('begin parameter validation: p_repair_number');
IF p_repair_number IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Repair Number is required.');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_repair_number');
...
where application_id = 512;

--Naga added
--g_org_id := p_org_id;

select inventory_org_id into g_org_id  from apps.csd_repairs where repair_number = p_repair_number;

--Naga Added 27th May

SELECT repair_line_id    into g_repair_line_id   FROM apps.CSD_REPAIRS    WHERE repair_number = p_repair_number;


--Naga added 17th June

begin mo_global.set_policy_context('S',g_org_id); end;
...
debug('begin populate sql tokens hash table');
   ...
   g_sql_tokens('##$$RONUM$$##') := p_repair_number;
   g_masked_tokens('##$$RONUM$$##') := mask_text( g_sql_tokens('##$$RONUM$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPID$$##') := '512';
   g_masked_tokens('##$$APPID$$##') := mask_text( g_sql_tokens('##$$APPID$$##'), 'NO_MASK');
   g_sql_tokens('##$$A$$##') := 'csd_analyzer_pkg';
   ...
   g_sql_tokens('##$$REPAIR_LINE_ID$$##') := g_repair_line_id;
   g_masked_tokens('##$$REPAIR_LINE_ID$$##') := mask_text( g_sql_tokens('##$$REPAIR_LINE_ID$$##'), 'NO_MASK');
...
debug('begin add_signature: EBS_CRM_CSD_UPG_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16174',
      p_sig_id                 => 'EBS_CRM_CSD_UPG_ERRORS',
      p_sig_sql                => 'select * 
from CSD_UPG_ERRORS 
--where rownum <= 10
ORDER BY UPGRADE_DATETIME DESC',
      p_title                  => 'Upgrade / Migration Errors',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found these errors during an upgrade and/or migration of the Depot Repair module.',
      p_solution               => 'Please follow solution in [2787576/KB737175] -  How Depot Repair Application Handles Upgrade and Migration Errors?',
      p_success_msg            => 'There are no upgrade/Migration related errors.',
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_UPG_ERRORS');



debug('begin add_signature: EBS_CRM_CSD_LOG_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16159',
      p_sig_id                 => 'EBS_CRM_CSD_LOG_CHECK',
      p_sig_sql                => 'SELECT fpovl.user_profile_option_name "Profile Option Name", decode(fpov.level_id, 10001, ''Site'', 10002, ''Application'' , 10003, ''Responsibility'', 10004, ''User'') "Profile Level",
((SELECT responsibility_name 
FROM FND_RESPONSIBILITY_TL 
WHERE responsibility_id = fpov.level_value 
AND language = ''US'' 
AND fpov.level_id = 10003)
UNION (SELECT application_short_name 
...
AND fpov.level_id = 10004 )) "Level Name",fpov.profile_option_value "Profile Option Value" 
FROM fnd_profile_option_values fpov, fnd_profile_options_vl fpovl
WHERE fpovl.profile_option_id = fpov.profile_option_id
AND ((fpovl.profile_option_name =''CSD_DEBUG_LEVEL''
AND upper(fpov.profile_option_value) > ''0'') 
OR (fpovl.profile_option_name =''AFLOG_ENABLED''
AND upper(fpov.profile_option_value) = ''Y''))',
      p_title                  => 'FND: Debug Log and CSD Debug Level Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Either profile <b>CSD: Debug Level</b> has a Profile Option Value that is greater than "0" or profile <b>FND: Debug Log Enabled</b> is set to "Y." <br>
These settings would indicate that debugging is turned on, which may affect system performance.',
      p_solution               => 'Ensure debugging is turned off, based upon your business needs. To turn off debugging ensure the following profiles are not set at any level<br>
CSD: Debug Level<br>
FND: Debug Log Enabled<br>
For more detailed information on using the CSD debugging, please review [333658/KB791809] - Depot Repair Debug Log File Instructions. ',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_LOG_CHECK');
...
debug('begin add_signature: EBS_CRM_SC_CSD_EXCLUDE_ENDECA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30813',
      p_sig_id                 => 'EBS_CRM_SC_CSD_EXCLUDE_ENDECA',
      p_sig_sql                => 'SELECT distinct frv.responsibility_name,
       ...
       DECODE (frf.rule_type,
               ''F'', (SELECT USER_FUNCTION_NAME || '' - '' || FUNCTION_NAME
  ...
  FROM fnd_resp_functions frf,
       fnd_responsibility_tl frv
WHERE frf.responsibility_id = frv.responsibility_id
and frv.responsibility_name like ''Depot Repair Manager%''',
      p_title                  => 'Endeca functions excluded ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'When enabling the ECC for Depot Repair application, get the error: java.net.MalformedURLException: FND_ENDECA_PORTAL_URL profile option is not defined or has a null value!!',
      p_solution               => '''FND_ENDECA_PORTAL_URL profile option is not defined or has a null value'' Error While Enabling The ECC For Depot Repair [3064580/KB679899]',
      p_success_msg            => 'All Endeca related functions associated to the Depot Repair responsibility are excluded',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_CSD_EXCLUDE_ENDECA');



debug('begin add_signature: EBS_CRM_CSD_DEFAULT_REP_TYPE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19337',
      p_sig_id                 => 'EBS_CRM_CSD_DEFAULT_REP_TYPE',
      p_sig_sql                => 'SELECT b.profile_option_name,
       a.level_id,
       a.level_value,
       a.profile_option_value,
       a.level_value_application_id,
       a.level_value2
 FROM fnd_profile_option_values a,
      fnd_profile_options       b
WHERE a.application_id = 512
  AND a.profile_option_id = b.profile_option_id
  AND profile_option_name = ''CSD_DEFAULT_REPAIR_TYPE''',
      p_title                  => 'CSD: Default Repair Type Profile Setting',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The profile <b>CSD: Default Repair Type</b> has not been defined.',
      p_solution               => 'This profile controls the <b>Default Repair Type</b> to be used while creating repair order.<br>
When this is not set the following error can occur, while opening repair order form:<br><br>
ERROR<br>
-----------------------<br>
CSD_API_REPAIR_TYPE_ID (REPAIR_TYPE_ID=1)<br><br>

Please refer to the following solution:<br>
[560854/KB740355] - Repair Order Form: ''CSD_API_REPAIR_TYPE_ID'' Error While Opening Depot Repair Form',
      p_success_msg            => 'Displaying your settings for profile CSD: Default Repair Type.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_DEFAULT_REP_TYPE');



debug('begin add_signature: EBS_CRM_CSD_REP_INV_ORG_PROF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19309',
      p_sig_id                 => 'EBS_CRM_CSD_REP_INV_ORG_PROF',
      p_sig_sql                => 'SELECT n.user_profile_option_name,
...
DECODE(TO_CHAR(pov.level_id), ''10001'', ''Site'', ''10002'', NVL(app.application_short_name,TO_CHAR(pov.level_value)), ''10003'', NVL(rsp.responsibility_name,TO_CHAR(pov.level_value)), ''10005'', svr.node_name, ''10006'', org.name, ''10007'', pov.level_value
||'', ''
|| pov.level_value_application_id
||'', ''
|| pov.level_value2, ''10004'', ##$$A$$##.mask_text(NVL(usr.user_name,TO_CHAR(pov.level_value)), ''DISPLAY_BOTH_25_PCNT_WORD'') )"LEVEL_VALUE",
...
WHERE (po.profile_option_name like(''CSD_DEF_REP_INV_ORG%''))
...
AND n.language =''US''
ORDER BY 2,3',
      p_title                  => 'Validating Mandatory Profile  CSD: Default Service Order Inventory Org',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This profile option is not set for any level and is mandatory.  This will cause problems in creating repair orders and logistics lines.',
      p_solution               => 'For solution refer to [1644974/KB733509] -  Error: ''CSD: Default Service Order Inventory Org'' Does Not Have A Value When Opening The Repair Order Form. <br>
NOTE: After setting the value, logout and sign back in to test the functionality.
Review this profile to ensure the value is set for the business process used. <br>',
      p_success_msg            => 'Profile value for System profile CSD: Default Service Order Inventory Org is set.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_REP_INV_ORG_PROF');



debug('begin add_signature: EBS_CRM_CSD_DEF_COVERAGE_PROF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19308',
      p_sig_id                 => 'EBS_CRM_CSD_DEF_COVERAGE_PROF',
      p_sig_sql                => 'SELECT n.user_profile_option_name,
po.profile_option_name ,
DECODE(TO_CHAR(pov.level_id), ''10001'', ''Site'', ''10002'', ''Application'', ''10003'', ''Responsibility'', ''10005'', ''Server'', ''10006'', ''Org'', ''10007'', ''Servresp'', ''10004'', ''User'', ''???'') "LEVEL",
DECODE(TO_CHAR(pov.level_id), ''10001'', ''Site'', ''10002'', NVL(app.application_short_name,TO_CHAR(pov.level_value)), ''10003'', NVL(rsp.responsibility_name,TO_CHAR(pov.level_value)), ''10005'', svr.node_name, ''10006'', org.name, ''10007'', pov.level_value
...
fnd_nodes svr,
hr_operating_units org
WHERE (po.profile_option_name like(''CS_SR_DEFAULT_COVERAGE%''))
--AND pov.level_id = ''10003''
AND pov.application_id = po.application_id
AND po.profile_option_name = n.profile_option_name
AND pov.profile_option_id = po.profile_option_id
...
AND n.language =''US''
ORDER BY 2,3',
      p_title                  => 'Validating Mandatory Profile Service: Default Coverage for SLA',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This profile option is not set for any level and is mandatory.  You will receive <i>Error : Creation of Repair Order failed</i> when performing Depot Repair Bulk Receiving.',
      p_solution               => 'For solution refer to [1326153/KB746944] -  Depot Repair Bulk Receiving Error: ''Creation of Repair Order failed.''

',
      p_success_msg            => 'Profile value for System profile Service: Default Coverage for SLA is set.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_DEF_COVERAGE_PROF');



debug('begin add_signature: EBS_CRM_CSD_DEP_OP_PROFILE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19307',
      p_sig_id                 => 'EBS_CRM_CSD_DEP_OP_PROFILE',
      p_sig_sql                => 'SELECT n.user_profile_option_name,
po.profile_option_name ,
DECODE(TO_CHAR(pov.level_id), ''10001'', ''Site'', ''10002'', ''Application'', ''10003'', ''Responsibility'', ''10005'', ''Server'', ''10006'', ''Org'', ''10007'', ''Servresp'', ''10004'', ''User'', ''???'') "LEVEL",
DECODE(TO_CHAR(pov.level_id), ''10001'', ''Site'', ''10002'', NVL(app.application_short_name,TO_CHAR(pov.level_value)), ''10003'', NVL(rsp.responsibility_name,TO_CHAR(pov.level_value)), ''10005'', svr.node_name, ''10006'', org.name, ''10007'', pov.level_value
...
fnd_nodes svr,
hr_operating_units org
WHERE (po.profile_option_name like(''CSD_DEF_HV_OP_DEPT%''))
--AND pov.level_id = ''10003''
AND pov.application_id = po.application_id
AND po.profile_option_name = n.profile_option_name
AND pov.profile_option_id = po.profile_option_id
...
AND n.language =''US''
ORDER BY 2,3',
      p_title                  => 'Validating Mandatory Profile  CSD: Default Department for Operations',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'If this profile is not setup, you will receive a Java exception error.  This is mandatory if your Repair Jobs do not have Routing information.  <br>',
      p_solution               => 'This profile should be set to a department that is in the same organization.  <br>
For solution refer to [2060418/KB787815] - Java Exception Error When Trying to Complete the New Line in Execute Job.

',
      p_success_msg            => 'Profile value for System profile CSD: Default Department for Operations is set.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_DEP_OP_PROFILE');



debug('begin add_signature: EBS_CRM_CSD_ACCTPERIOD_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19245',
      p_sig_id                 => 'EBS_CRM_CSD_ACCTPERIOD_CHECK',
      p_sig_sql                => 'SELECT acct_period_id, organization_id, period_set_name, period_year, period_num, period_name, period_start_date, schedule_close_date, period_close_date, open_flag
...
AND oap.open_flag = ''Y''',
      p_title                  => 'Open Accounting Periods Check ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Currently there appears to be no open accounting periods  in Organization '||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||'. You may not be able to create Depot Repair Jobs or complete Bulk Receiving in Depot Module.',
      p_solution               => 'Open the current inventory accounting period:
Please refer to the following solutions:<br>
[1904983/KB755743] -  Depot Repair Error: WIP Mass Load request did not complete successfully When Creating WIP Job <br> [1158965/KB794699] -  Depot Repair Bulk Receiving: ''Error Occurred in receiving processor (rvtptcontrol failed).''
',
      p_success_msg            => 'There are open accounting periods in Organization '||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||'. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_ACCTPERIOD_CHECK');



debug('begin add_signature: EBS_CRM_SC_CSD_SRSO_FROM_OMRMA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27165',
      p_sig_id                 => 'EBS_CRM_SC_CSD_SRSO_FROM_OMRMA',
      p_sig_sql                => 'SELECT /*+ CHOOSE */
  ...
  AND rcv.organization_id in (##$$ORGID$$##)
  ...
  and ced.order_line_id = oel.line_id)',
      p_title                  => 'Can create SR/SO from OM RMA lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Create SR/SO From OM RMA Lines concurrent request is Run to create the Service Requests and Service Orders for the Order Header',
      p_solution               => 'Please refer to the: Conditions Under Which "Create SR/SO From OM RMA Lines" Concurrent Request Creates Service Requests And Service Orders. [2983881/KB787949]',
      p_success_msg            => 'The concurrent program can successfully create service requests and service orders.',
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_CSD_SRSO_FROM_OMRMA');



debug('begin add_signature: EBS_CRM_CSD_QUICK_MENU_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16154',
      p_sig_id                 => 'EBS_CRM_CSD_QUICK_MENU_CHECK',
      p_sig_sql                => 'select a.filter_id , a.filter_name , id_based_flag
from CS_QM_FILTERS a, CS_QM_FUNCTION_FILTERS b 
where a.filter_id = b.filter_id
and b.function_id = (select function_id from fnd_form_functions where function_name = ''CSDREPLN'') and Filter_name = ''Incident Number''',
      p_title                  => 'Quick Menu Filter',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The  FILTER_NAME (Incident Number) entry is missing in the CS_QM_FILTERS table. <br>When this is missing,the following error can occur in the Depot Repair Menu:<br><br>
ERROR<br>
-----------------------<br>
FRM-40735: SPECIAL18 trigger raised unhandled exception ORA-01403<br>',
      p_solution               => 'Please follow solution in [1267628/KB730851] - Quickmenu in Depot Repair Errors: FRM-40735: SPECIAL18 TRIGGER RAISED UNHANDLED EXCEPTION.',
      p_success_msg            => ' CS_QM_FILTERS table has no missing entries.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_QUICK_MENU_CHECK');



debug('begin add_signature: EBS_CRM_CSD_REPTYPE_SAC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16155',
      p_sig_id                 => 'EBS_CRM_CSD_REPTYPE_SAC',
      p_sig_sql                => 'SELECT name, description, repair_type_id, 
NVL(TO_CHAR(CPS_TXN_BILLING_TYPE_ID), ''** Missing **'') "CPS_TXN_BILLING_TYPE_ID", 
NVL(TO_CHAR(CPR_TXN_BILLING_TYPE_ID), ''** Missing **'') "CPR_TXN_BILLING_TYPE_ID", 
NVL(TO_CHAR(LS_TXN_BILLING_TYPE_ID), ''** Missing **'') "LS_TXN_BILLING_TYPE_ID", 
NVL(TO_CHAR(LR_TXN_BILLING_TYPE_ID), ''** Missing **'') "LR_TXN_BILLING_TYPE_ID",
mtl_txn_billing_type_id, lbr_txn_billing_type_id,  repair_type_ref, repair_mode, seeded_flag, business_process_id
FROM CSD_REPAIR_TYPES_VL csd
WHERE (cps_txn_billing_type_id IS NULL
AND cpr_txn_billing_type_id IS NULL
AND ls_txn_billing_type_id IS NULL
AND lr_txn_billing_type_id IS NULL)
order by name',
      p_title                  => 'Missing Service Activity Codes in Repair Type Setup ',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Service Activity Codes are missing in either Return or Ship Lines in Repair Type setup. Users will not be able to create Logistics Lines for those Repair Types as no SACs are available.',
      p_solution               => 'Please add proper Service Activity Codes in RMA/Ship section in either Pre-Service or Post-Service if you need to create Logistics Lines for those Repair Types. <br>
Please follow solution in [2356105/KB793378] - Not Able to Create Logistics Lines in Depot Repair as List of Values Contains No Entries in Service Activity Code Field.',
      p_success_msg            => 'Service Activity Codes are present in  Return and  Ship Lines in Repair Type setup. ',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_REPTYPE_SAC');



debug('begin add_signature: EBS_CRM_CSD_CONC_SCH_SHIPMENT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16156',
      p_sig_id                 => 'EBS_CRM_CSD_CONC_SCH_SHIPMENT',
      p_sig_sql                => 'select request_id, a.last_update_date, a.last_updated_by, a.request_date, a.requested_by, a.phase_code, a.status_code, a.requested_start_date, a.hold_flag, a.is_sub_request, 
a.queue_method_code, b.application_id, b.concurrent_program_id, b.user_concurrent_program_name
from fnd_concurrent_requests a, fnd_concurrent_programs_tl b
where status_code in (''Q'',''I'')
and a.concurrent_program_id = b.concurrent_program_id
and a.requested_start_date > SYSDATE
and a.hold_flag = ''N''
and b.user_concurrent_program_name = ''Depot Repair Shipment Update''
ORDER BY REQUEST_ID',
      p_title                  => 'Depot Repair Shipment Update',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The concurrent program ''<b>Depot Repair Shipment Update</b>'' is not scheduled to run. This may cause logistics ship lines statuses to not match the Order Line statuses.',
      p_solution               => 'It is recommended to schedule this program to run or manually update logistics in the Repair Orders. <br> 
For more information review [1957180/KB725396] - Understanding the Logic of the Depot Repair Shipment Update Concurrent Program.',
      p_success_msg            => 'The <b>Depot Repair Shipment Update</b> program is up and running.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_CONC_SCH_SHIPMENT');



debug('begin add_signature: EBS_CRM_CSD_CONC_SCH_RECEIPT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16158',
      p_sig_id                 => 'EBS_CRM_CSD_CONC_SCH_RECEIPT',
      p_sig_sql                => 'select request_id, a.last_update_date, a.last_updated_by, a.request_date, a.requested_by, a.phase_code, a.status_code, a.requested_start_date, a.hold_flag, a.is_sub_request, 
a.queue_method_code, b.application_id, b.concurrent_program_id, b.user_concurrent_program_name
from fnd_concurrent_requests a, fnd_concurrent_programs_tl b
where status_code in (''Q'',''I'')
...
and a.requested_start_date > SYSDATE
and a.hold_flag = ''N''
and b.user_concurrent_program_name = ''Depot Repair Receipt Update''
ORDER BY REQUEST_ID',
      p_title                  => 'Depot Repair Receipt Update',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The concurrent program ''<b>Depot Repair Receipt Update</b>'' is not scheduled to run. This may cause Logistics Return Lines statuses to not match the Order Line statuses.',
      p_solution               => 'It is recommended to schedule ''<b>Depot Repair Receipt Update</b>'' program to run or manually update logistics in the Repair Orders. <br>
For more information review [1958182/KB772197] - Understanding the Logic of Depot Repair Receipts Update Concurrent Program.',
      p_success_msg            => 'The <b>Depot Repair Receipt Update</b> program is up and running.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_CONC_SCH_RECEIPT');



debug('begin add_signature: EBS_CRM_CSD_OM_ORDER_SYNC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16164',
      p_sig_id                 => 'EBS_CRM_CSD_OM_ORDER_SYNC',
      p_sig_sql                => 'select repair_number , repair_line_id , 
 order_header_id , 
order_line_id ,order_number
from csd_repair_actual_lines_v  
where order_header_id is not null  
and order_line_id is null
and  (REPAIR_NUMBER  like ''##$$RONUM$$##\_%'' escape ''\'') 

UNION

SELECT REPAIR_NUMBER,REPAIR_LINE_ID,
ORDER_HEADER_ID,
ORDER_LINE_ID,
ORDER_NUMBER
FROM csd_product_txns_v
WHERE order_header_id IS NOT NULL and order_line_id is null
and  (REPAIR_NUMBER  like ''##$$RONUM$$##\_%'' escape ''\'') ',
      p_title                  => 'Depot Repair and OM Order Sync Check ',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are repair logistic/actual lines that have been interfaced to Order Management.  The ORDER_HEADER_ID has been generated, but the ORDER_LINE_ID does not exist. <br> 
This typically occurs when the logistics/actual  line was created and there was some error in creating the order line. This means it was not created, but the repair order logistic/actual  line was 
incorrectly stamped with the order number anyway.
',
      p_solution               => 'Open the repair orders/sales orders list in the results above and review the records that may need to be corrected. This may require either a patch fix and/or a datafix.
For more information review [456714/KB742354] Depot Repair Order Logistics Lines Show Order Number But Order Lines Do Not Exist.
',
      p_success_msg            => 'There are no repair logistic/actual lines that have not  been interfaced to Order Management.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_OM_ORDER_SYNC');



debug('begin add_signature: EBS_CRM_CSD_SYNC_OM_LOGIS_STS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16157',
      p_sig_id                 => 'EBS_CRM_CSD_SYNC_OM_LOGIS_STS',
...
and (cr.repair_number like ''##$$RONUM$$##\_%'' escape ''\'')
/*   AND  lin.line_id in ( Select line_id
 ...
 order by 5,6,7',
      p_title                  => 'Synchronizing Logistics Line Status With Order Line Status',
      p_fail_condition         => '[ro_line_status]<>[oe_line_st]',
      p_problem_descr          => 'Some logistics line statuses do not match the statuses in corresponding order lines. <br>
It is expected that the repair order (RO) logistics line status will be ''in sync'' with the associated sales order (SO) line. <br>
When it is not, this will cause an issue with users as they may not be aware of the correct status of repair order or sales orders and may process the orders incorrectly.',
      p_solution               => 'Follow the solution steps in  [2015555/KB759972] - Depot Repair: Generic Datafix for Synchronizing Logistics Line Status with Order Line Status.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_SYNC_OM_LOGIS_STS');



debug('begin add_signature: EBS_CRM_CSD_CID_NOMATCH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16169',
      p_sig_id                 => 'EBS_CRM_CSD_CID_NOMATCH',
      p_sig_sql                => 'select cr.repair_line_id, cr.repair_number, to_char(cr.contract_line_id), cpt.action_type, cpt.prod_txn_status, to_char(ced.contract_line_id)
from csd_repairs cr,
     csd_product_transactions cpt,
     cs_estimate_details ced
where cr.contract_line_id <> ced.contract_line_id
and cr.repair_line_id = cpt.repair_line_id
and ced.estimate_detail_id = cpt.estimate_detail_id
order by  cr.repair_line_id
',
      p_title                  => 'Invalid Contract Line Reference on the Charge Lines',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There is mismatch between CONTRACT_LINE_ID in the CS_ESTIMATE_DETAILS table and CONTRACT_LINE_ID in the CSD_REPAIRS table.<br>
This may cause the following error in Repair Logistics, when attempting to book a ship line on a Repair Order, if the CONTRACT_LINE_IDs are different. <br><br>
ERROR<br>
-----------------------<br>
<i>Caution: Invalid Contract with contract ID: 9.9900000000... <br>
Note: In when others exception 100501: non-ORACLE exception <br>
API Error (CS_CHARGE_DETAILS_PVT.UPdate_Charge_Details): &TEXT</i>',
      p_solution               => 'If the CONTRACT_LINE_ID values do not match, they will need to be synchronized.<br> 
Please log a Service Request, for possible datafix, referencing this [1935797/KB744848] - Depot Repair: Getting Error While Submitting Ship Order From Logistics',
      p_success_msg            => 'There is no  mismatch between CONTRACT_LINE_ID in the CS_ESTIMATE_DETAILS table and CONTRACT_LINE_ID in the CSD_REPAIRS table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_CID_NOMATCH');



debug('begin add_signature: EBS_CRM_CSD_REP_ORG_PROF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20616',
      p_sig_id                 => 'EBS_CRM_CSD_REP_ORG_PROF',
      p_sig_sql                => 'SELECT n.user_profile_option_name,
po.profile_option_name ,
DECODE(TO_CHAR(pov.level_id), ''10001'', ''Site'', ''10002'', ''Application'', ''10003'', ''Responsibility'', ''10005'', ''Server'', ''10006'', ''Org'', ''10007'', ''Servresp'', ''10004'', ''User'', ''???'') "LEVEL",
DECODE(TO_CHAR(pov.level_id), ''10001'', ''Site'', ''10002'', NVL(app.application_short_name,TO_CHAR(pov.level_value)), ''10003'', NVL(rsp.responsibility_name,TO_CHAR(pov.level_value)), ''10005'', svr.node_name, ''10006'', org.name, ''10007'', pov.level_value
...
fnd_nodes svr,
hr_operating_units org
WHERE (po.profile_option_name like(''CSD_DEFAULT_REPAIR_ORG%''))
--AND pov.level_id = ''10003''
AND pov.application_id = po.application_id
AND po.profile_option_name = n.profile_option_name
AND pov.profile_option_id = po.profile_option_id
...
AND n.language =''US''
ORDER BY 2,3',
      p_title                  => 'Validating Profile CSD: Default Service Order Organization',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This profile option is not set for any level .  This will lead to  not populating the owning organization details in CSD_REPAIRS table.',
      p_solution               => 'For solution refer to [2815807/KB745866] -  OWNING_ORGANIZATION_ID Not Populated In Table CSD_REPAIRS <br>
NOTE: After setting the value, logout and sign back in to test the functionality.
 <br>',
      p_success_msg            => 'Profile value for System profile CSD: Default Service Order Organization is set.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_REP_ORG_PROF');
...
debug('begin add_signature: EBS_CRM_CSD_LOGISTICS');
   l_info('##MASK##BILL_TO_ADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SHIP_TO_ADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19304',
      p_sig_id                 => 'EBS_CRM_CSD_LOGISTICS',
      p_sig_sql                => 'SELECT product_transaction_id ,
      action_type ,
       action_code,
       interface_to_om_flag "ENTER ORDER",
       book_sales_order_flag "BOOK ORDER",
      release_sales_order_flag "PICK RELEASE",
      ship_sales_order_flag "SHIP CONFIRM",
      auto_process_rma "AUTO ENTER AND BOOK RMA",
      repair_mode ,
      sub_inventory ,
      product ,
      product_description ,
      ...
      estimate_quantity "LOGISTICS QTY",
      repair_quantity ,
      quantity_in_wip ,
      quantity_rcvd , 
     quantity_shipped , 
     lot_number ,
      ...
      promise_date , 
     price_list  ,
      transaction_type "SERVICE ACTIVITY",
      txn_billing_type_id ,
      order_header_id ,
      order_line_id , 
      order_number , 
...
ORDER BY product_transaction_id',
      p_title                  => 'Logistics ',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the logistics for this repair order.',
      p_solution               => '',
      p_success_msg            => 'There are no logistic lines for this repair order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_LOGISTICS');



debug('begin add_signature: EBS_CRM_CSD_REPAIR_TYPE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19145',
      p_sig_id                 => 'EBS_CRM_CSD_REPAIR_TYPE',
      p_sig_sql                => 'SELECT repair_type_id,
   name ,
   description ,
   repair_type_ref,
   repair_mode ,
...
WHERE repair_type_id =
   (SELECT repair_type_id
    ...
    WHERE repair_line_id = ##$$REPAIR_LINE_ID$$## )',
      p_title                  => 'Repair Type',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the repair type for this repair order.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_REPAIR_TYPE');



debug('begin add_signature: EBS_CRM_CSD_ESTIMATE_HEADER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19147',
      p_sig_id                 => 'EBS_CRM_CSD_ESTIMATE_HEADER',
      p_sig_sql                => 'SELECT estimate_date ,
      estimate_status ,
      repair_quantity ,
      approval_required_flag ,
      approval_status ,
...
WHERE repair_line_id = ##$$REPAIR_LINE_ID$$##',
      p_title                  => 'Estimate Header',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the estimate header for this repair order.',
      p_solution               => '',
      p_success_msg            => 'There is no estimate header for this repair order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_ESTIMATE_HEADER');



debug('begin add_signature: EBS_CRM_CSD_ESTIMATE_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19149',
      p_sig_id                 => 'EBS_CRM_CSD_ESTIMATE_LINES',
      p_sig_sql                => 'SELECT estimate_detail_id ,
      auto_process_rma ,
      product ,
      description ,
      object_version_number ,
      ...
      resource_id ,
      resource_code ,
      billing_type_meaning "BILLING TYPE",
      est_line_source_type_code "SOURCE TYPE",
      est_line_source_desc "SOURCE TYPE DESC",
      est_line_source_id1 ,
...
WHERE repair_line_id = ##$$REPAIR_LINE_ID$$##
order BY repair_estimate_line_id',
      p_title                  => 'Estimate Lines',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the estimate lines for this repair order.
',
      p_solution               => '',
      p_success_msg            => 'There are no estimate lines for this repair order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_ESTIMATE_LINES');



debug('begin add_signature: EBS_CRM_CSD_REPAIR_JOBS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19151',
      p_sig_id                 => 'EBS_CRM_CSD_REPAIR_JOBS',
      p_sig_sql                => 'SELECT repair_job_xref_id ,
      wip_entity_id,
      ...
      source_name,
      ro_service_code_id ,
      allocated_created_quantity ,
      allocated_completed_quantity ,
      created_quantity ,
      completed_quantity ,
...
order BY repair_job_xref_id',
      p_title                  => 'Repair Jobs',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the repair jobs for this repair order.
',
      p_solution               => '',
      p_success_msg            => 'There are no repair jobs for this repair order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_REPAIR_JOBS');



debug('begin add_signature: EBS_CRM_CSD_REPAIR_TASKS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19153',
      p_sig_id                 => 'EBS_CRM_CSD_REPAIR_TASKS',
      ...
      escalation_level,
      parent_task_number    
FROM csd_repair_tasks_v    
WHERE source_object_id = ##$$REPAIR_LINE_ID$$##
AND source_object_type_code = ''DR''',
      p_title                  => 'Repair Tasks',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the repair tasks for this repair order.',
      p_solution               => '',
      p_success_msg            => 'There are no repair tasks for this repair order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_REPAIR_TASKS');



debug('begin add_signature: EBS_CRM_SC_CSD_MAT_DBF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29087',
      p_sig_id                 => 'EBS_CRM_SC_CSD_MAT_DBF',
      p_sig_sql                => 'SELECT 
	CDMV.CHANNEL_CODE,
...
FROM 
	...
	CSD_REPAIR_TASKS_V CRT
WHERE
	CDH.DEBRIEF_HEADER_ID = CDMV.DEBRIEF_HEADER_ID
	AND CDH.TASK_ID = CRT.TASK_ID
	AND CRT.SOURCE_OBJECT_ID = ##$$REPAIR_LINE_ID$$##
	AND CRT.SOURCE_OBJECT_TYPE_CODE = ''DR''
	ORDER BY CRT.CREATION_DATE DESC
	',
      p_title                  => 'Repair Task Material Debrief Lines',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying Repair Task Material Debrief Lines',
      p_solution               => '',
      p_success_msg            => 'No Repair Task Material Debrief Lines Exist.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_CSD_MAT_DBF');



debug('begin add_signature: EBS_CRM_SC_CSD_LAB_DBF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29088',
      p_sig_id                 => 'EBS_CRM_SC_CSD_LAB_DBF',
      p_sig_sql                => 'SELECT 
	CDLV.CHANNEL_CODE,
...
FROM 
	...
	CSD_REPAIR_TASKS_V CRT
WHERE
	CDH.DEBRIEF_HEADER_ID = CDLV.DEBRIEF_HEADER_ID
        AND CDH.TASK_ID = CRT.TASK_ID
	AND CRT.SOURCE_OBJECT_ID = ##$$REPAIR_LINE_ID$$##
	AND CRT.SOURCE_OBJECT_TYPE_CODE = ''DR''
	ORDER BY CRT.CREATION_DATE DESC
	',
      p_title                  => 'Repair Task Labor Debrief Lines',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying Repair Task Labor Debrief Lines',
      p_solution               => '',
      p_success_msg            => 'No Repair Task Labor Debrief Lines Exist.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_CSD_LAB_DBF');



debug('begin add_signature: EBS_CRM_SC_CSD_EXP_DBF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29089',
      p_sig_id                 => 'EBS_CRM_SC_CSD_EXP_DBF',
      p_sig_sql                => 'SELECT 
	CDEV.CHANNEL_CODE,
...
FROM 
	...
	CSD_REPAIR_TASKS_V CRT
WHERE
	CDH.DEBRIEF_HEADER_ID = CDEV.DEBRIEF_HEADER_ID
	AND CDH.TASK_ID = CRT.TASK_ID
	AND CRT.SOURCE_OBJECT_ID = ##$$REPAIR_LINE_ID$$##
	AND CRT.SOURCE_OBJECT_TYPE_CODE = ''DR''
	ORDER BY CRT.CREATION_DATE DESC',
      p_title                  => 'Repair Task Expense Debrief Lines',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying Repair Task Expense Debrief Lines',
      p_solution               => '',
      p_success_msg            => 'No Repair Task Expense Debrief Lines Exist.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_CSD_EXP_DBF');



debug('begin add_signature: EBS_CRM_CSD_REPAIR_ACTUALS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19155',
      p_sig_id                 => 'EBS_CRM_CSD_REPAIR_ACTUALS',
      p_sig_sql                => 'SELECT object_version_number,
      estimate_detail_id,
      override_charge_flag,
      actual_source_code,
      actual_source_id,
     ...
     contract_line_id,
      order_number,
      order_line_number,
      billing_category_meaning,
      lot_number,
      actual_source_meaning,
      locator_id,
      contract_discount_amount    
FROM csd_repair_actual_lines_v    
WHERE repair_line_id = ##$$REPAIR_LINE_ID$$## 
order BY repair_actual_line_id',
      p_title                  => 'Repair Actuals',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the actual lines  for this repair order.',
      p_solution               => '',
      p_success_msg            => 'There are no repair actual lines for this repair order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_REPAIR_ACTUALS');



debug('begin add_signature: EBS_CRM_CSD_REP_BUS_PROCESS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17302',
      p_sig_id                 => 'EBS_CRM_CSD_REP_BUS_PROCESS',
      p_sig_sql                => 'SELECT
    cbp.name          "BUSINESS PROCESS",
    cbp.description  
FROM
...
WHERE
    ...
    AND crt.business_process_id = cbp.business_process_id
    AND ( cbp.start_date_active <= sysdate
          OR cbp.start_date_active IS NULL )
    AND ( cbp.end_date_active > sysdate
          OR cbp.end_date_active IS NULL )
    AND cbp.depot_repair_flag = ''Y''',
      p_title                  => 'Repair Business Processes',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the business process for this repair order.',
      p_solution               => '',
      p_success_msg            => 'There are no business processes associated to this repair order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_REP_BUS_PROCESS');



debug('begin add_signature: EBS_CRM_CSD_REP_MAT_CODES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19313',
      p_sig_id                 => 'EBS_CRM_CSD_REP_MAT_CODES',
      p_sig_sql                => 'SELECT
    tt.name,                  
    tt.description,         
    tbt.txn_billing_type_id,
    tt.no_charge_flag,
    th.name                  "ORDER TYPE NAME",
    bh.order_category_code,
    tl.name                  "LINE TYPE NAME",
    bl.order_category_code   "LINE CATEGORY CODE",
    tbt.billing_type,
    cbtc.billing_category
FROM
    cs_transaction_types_vl      tt,
    cs_txn_billing_types         tbt,
    cs_bus_process_txns          bt,
    cs_txn_billing_oetxn_all     tb,
    oe_transaction_types_tl      th,
    oe_transaction_types_all     bh,
    oe_transaction_types_tl      tl,
    oe_transaction_types_all     bl,
    cs_billing_type_categories   cbtc,
    fnd_lookup_values            flv
WHERE bt.business_process_id = 
      ( SELECT business_process_id
        ...
        ( SELECT repair_type_id
          FROM csd_repairs
          WHERE repair_line_id = ##$$REPAIR_LINE_ID$$##))
AND bt.transaction_type_id = tbt.transaction_type_id
    AND tt.transaction_type_id = tbt.transaction_type_id
        AND tbt.txn_billing_type_id = tb.txn_billing_type_id
            AND bh.transaction_type_id = th.transaction_type_id
                AND th.language = userenv(''LANG'')
                    AND tb.order_type_id = bh.transaction_type_id
                        AND bl.transaction_type_id = tl.transaction_type_id
                            AND tl.language = userenv(''LANG'')
                                AND tb.line_type_id = bl.transaction_type_id
                                    AND nvl(tt.depot_repair_flag, ''N'') = ''Y''
                                        AND bl.order_category_code = ''ORDER''
                                            AND cbtc.billing_type = tbt.billing_type
                                                AND cbtc.billing_type = flv.lookup_code
                                                    AND flv.lookup_type = ''MTL_SERVICE_BILLABLE_FLAG''
                                                        AND sysdate BETWEEN nvl(cbtc.start_date_active, sysdate) AND nvl(cbtc.end_date_active
                                                        , sysdate)
                                                            AND sysdate BETWEEN nvl(bt.start_date_active, sysdate) AND nvl(bt.end_date_active
                                                            , sysdate)
                                                                AND sysdate BETWEEN nvl(tt.start_date_active, sysdate) AND nvl(tt
                                                                .end_date_active, sysdate)
                                                                    AND sysdate BETWEEN nvl(tbt.start_date_active, sysdate) AND nvl
                                                                    (tbt.end_date_active, sysdate)
                                                                        AND nvl(cbtc.billing_category, ''-999'') = ''M''
                                                                            AND nvl(''M'', tbt.billing_type) = tbt.billing_type
                                                                                AND flv.language = userenv(''LANG'')
ORDER by tt.name',
      p_title                  => 'Repair Material Service Activity Codes',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying material service activity codes associated to this repair order.',
      p_solution               => '',
      p_success_msg            => 'There are no material  service activity codes associated to this repair order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_REP_MAT_CODES');



debug('begin add_signature: EBS_CRM_CSD_REP_LABOR_CODES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19314',
      p_sig_id                 => 'EBS_CRM_CSD_REP_LABOR_CODES',
      p_sig_sql                => 'SELECT
    tt.name ,
    tt.description,         
    tbt.txn_billing_type_id,
                                                        ...
                                                        , sysdate)
                                                            ...
                                                            , sysdate)
                                                                ...
                                                                .end_date_active, sysdate)
                                                                    AND sysdate BETWEEN nvl(tbt.start_date_active, sysdate) AND nvl
                                                                    (tbt.end_date_active, sysdate)
                                                                        AND nvl(cbtc.billing_category, ''-999'') = ''L''
                                                                            AND nvl(''L'', tbt.billing_type) = tbt.billing_type
                                                                                AND flv.language = userenv(''LANG'')
ORDER by tt.name',
      p_title                  => 'Repair Labor Service Activity Codes',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the labor service activity codes for this repair order.',
      p_solution               => '',
      p_success_msg            => 'There are no labor service activity codes for this repair order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_REP_LABOR_CODES');



debug('begin add_signature: EBS_CRM_CSD_REP_EXPENSE_CODES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19315',
      p_sig_id                 => 'EBS_CRM_CSD_REP_EXPENSE_CODES',
      p_sig_sql                => 'SELECT tt.name ,
        tt.description ,
        tbt.txn_billing_type_id,
        tt.no_charge_flag,
        th.name "ORDER TYPE NAME",
...
WHERE bt.business_process_id =
      ...
      AND tb.line_type_id = bl.transaction_type_id
       ...
       AND cbtc.billing_type = flv.lookup_code
       AND flv.lookup_type = ''MTL_SERVICE_BILLABLE_FLAG''
       AND sysdate BETWEEN nvl(cbtc.start_date_active,   sysdate)
       AND nvl(cbtc.end_date_active,   sysdate)
       AND sysdate BETWEEN nvl(bt.start_date_active,   sysdate)
       AND nvl(bt.end_date_active,   sysdate)
       AND sysdate BETWEEN nvl(tt.start_date_active,   sysdate)
       AND nvl(tt.end_date_active,   sysdate)
       AND sysdate BETWEEN nvl(tbt.start_date_active,   sysdate)
       AND nvl(tbt.end_date_active,   sysdate)
       AND nvl(cbtc.billing_category,   ''-999'') = ''E'' 
      AND nvl(''E'',   tbt.billing_type) = tbt.billing_type
       AND flv.LANGUAGE = userenv(''LANG'')
      ORDER BY tt.name',
      p_title                  => 'Repair Expense Service Activity Codes',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the repair expense service activity codes for this repair order.',
      p_solution               => '',
      p_success_msg            => 'There are no repair expense service activity codes for this repair order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_REP_EXPENSE_CODES');



debug('begin add_signature: EBS_CRM_CSD_REPAIR_ORDER_DTLS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20630',
      p_sig_id                 => 'EBS_CRM_CSD_REPAIR_ORDER_DTLS',
      p_sig_sql                => 'SELECT repair_line_id,
repair_number,
incident_id,
inventory_item_id,
repair_type_id,
...
WHERE repair_line_id = ##$$REPAIR_LINE_ID$$## 
',
      p_title                  => 'Service/Repair Order ',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the generic details for this repair order.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_REPAIR_ORDER_DTLS');



debug('begin add_signature: EBS_CRM_CSD_REPAIR_SR_DTLS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20779',
      p_sig_id                 => 'EBS_CRM_CSD_REPAIR_SR_DTLS',
      p_sig_sql                => 'SELECT
incident_id,
org_id,
incident_number,
...
FROM CS_INCIDENTS_V 
WHERE 
incident_id =(SELECT incident_id
                       FROM CSD_REPAIRS
                       WHERE repair_line_id = ##$$REPAIR_LINE_ID$$## )',
      p_title                  => 'Service Request',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  service request  details for this repair order.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_REPAIR_SR_DTLS');



debug('begin add_signature: EBS_CRM_CSD_REPAIR_SERVICE_CODES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20815',
      p_sig_id                 => 'EBS_CRM_CSD_REPAIR_SERVICE_CODES',
      p_sig_sql                => 'SELECT 
repair_number,
service_code_id,
service_code_name,
service_code_active_from,
source_type_code,
service_item_id 
FROM CSD_RO_SERVICE_CODES_V
WHERE repair_line_id = ##$$REPAIR_LINE_ID$$## 
ORDER BY service_code_id
',
      p_title                  => 'Service Codes ',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  service code  details for this repair order.
',
      p_solution               => '',
      p_success_msg            => 'There are no service codes associated to  this repair order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_REPAIR_SERVICE_CODES');



debug('begin add_signature: EBS_CRM_CSD_REPAIR_DIAG_CODES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20816',
      p_sig_id                 => 'EBS_CRM_CSD_REPAIR_DIAG_CODES',
      p_sig_sql                => 'SELECT 
repair_number,
diagnostic_code_id,
diagnostic_code_name,
diagnostic_code_active_from,
diagnostic_item_id 
FROM CSD_RO_DIAGNOSTIC_CODES_V
WHERE repair_line_id = ##$$REPAIR_LINE_ID$$## 
ORDER BY diagnostic_code_id
',
      p_title                  => 'Diagnostic Codes',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the  diagnostic  code  details for this repair order.
',
      p_solution               => '',
      p_success_msg            => 'There are no repair diagnostic codes for this repair order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_REPAIR_DIAG_CODES');



debug('begin add_signature: EBS_CRM_SC_CSD_IMPORT_ACT_FROM_ESTIMATE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28176',
      p_sig_id                 => 'EBS_CRM_SC_CSD_IMPORT_ACT_FROM_ESTIMATE',
      p_sig_sql                => 'SELECT ESTL.repair_estimate_line_id,
    ...
    WHERE  CR.repair_line_id =  ##$$REPAIR_LINE_ID$$##
    ...
    AND    NOT EXISTS
           ...
           WHERE  ACTL.actual_source_code = ''ESTIMATE''
           AND    ACTL.actual_source_id = ESTL.repair_estimate_line_id
           )
    order by ESTL.estimate_detail_id',
      p_title                  => 'Estimate lines that have NOT been imported into Actuals',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Estimate lines that have NOT been imported into Actuals',
      p_solution               => '',
      p_success_msg            => 'Either all the estimate lines have been imported into actuals or there are no estimate lines to be imported.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_CSD_IMPORT_ACT_FROM_ESTIMATE');



debug('begin add_signature: EBS_CRM_SC_CSD_WIP_JOB_SHARED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28177',
      p_sig_id                 => 'EBS_CRM_SC_CSD_WIP_JOB_SHARED',
      p_sig_sql                => 'SELECT XREF.wip_entity_id,
  WENT.WIP_ENTITY_NAME JOB_NAME
FROM CSD_REPAIR_JOB_XREF XREF,
  WIP_ENTITIES WENT
WHERE XREF.repair_line_id = ##$$REPAIR_LINE_ID$$##
...
AND EXISTS
  ...
  HAVING COUNT(*)          > 1
      ...
      p_title                  => 'WIP jobs shared across repair orders ineligible for importing of WIP lines',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'WIP jobs shared across repair orders ineligible for importing of WIP debrief lines.',
      p_solution               => '',
      p_success_msg            => 'Either all the WIP jobs are imported into actuals or there are no WIP jobs to be imported.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_CSD_WIP_JOB_SHARED');



debug('begin add_signature: EBS_CRM_SC_CSD_INTERNAL_MOVE_ORDERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31281',
      p_sig_id                 => 'EBS_CRM_SC_CSD_INTERNAL_MOVE_ORDERS',
      p_sig_sql                => 'SELECT InternalMoveOrdersEO.PRODUCT_TRANSACTION_ID, 
       InternalMoveOrdersEO.REPAIR_LINE_ID, 
       InternalMoveOrdersEO.ACTION_TYPE, 
       InternalMoveOrdersEO.ACTION_CODE, 
       InternalMoveOrdersEO.INTERFACE_TO_OM_FLAG, 
       InternalMoveOrdersEO.BOOK_SALES_ORDER_FLAG, 
       InternalMoveOrdersEO.RELEASE_SALES_ORDER_FLAG, 
       InternalMoveOrdersEO.SHIP_SALES_ORDER_FLAG, 
       InternalMoveOrdersEO.SUB_INVENTORY, 
       InternalMoveOrdersEO.LOT_NUMBER, 
       InternalMoveOrdersEO.CREATED_BY, 
       InternalMoveOrdersEO.CREATION_DATE, 
       InternalMoveOrdersEO.LAST_UPDATED_BY, 
       InternalMoveOrdersEO.LAST_UPDATE_DATE, 
       InternalMoveOrdersEO.LAST_UPDATE_LOGIN, 
       InternalMoveOrdersEO.CONTEXT, 
       InternalMoveOrdersEO.ATTRIBUTE1, 
       InternalMoveOrdersEO.ATTRIBUTE2, 
       InternalMoveOrdersEO.ATTRIBUTE3, 
       InternalMoveOrdersEO.ATTRIBUTE4, 
       InternalMoveOrdersEO.ATTRIBUTE5, 
       InternalMoveOrdersEO.ATTRIBUTE6, 
       InternalMoveOrdersEO.ATTRIBUTE7, 
       InternalMoveOrdersEO.ATTRIBUTE8, 
       InternalMoveOrdersEO.ATTRIBUTE9, 
       InternalMoveOrdersEO.ATTRIBUTE10, 
       InternalMoveOrdersEO.ATTRIBUTE11, 
       InternalMoveOrdersEO.ATTRIBUTE12, 
       InternalMoveOrdersEO.ATTRIBUTE13, 
       InternalMoveOrdersEO.ATTRIBUTE14, 
       InternalMoveOrdersEO.ATTRIBUTE15, 
       InternalMoveOrdersEO.OBJECT_VERSION_NUMBER, 
       InternalMoveOrdersEO.PROD_TXN_STATUS, 
       InternalMoveOrdersEO.PROD_TXN_CODE, 
       InternalMoveOrdersEO.REQ_HEADER_ID, 
       InternalMoveOrdersEO.REQ_LINE_ID, 
       InternalMoveOrdersEO.ORDER_HEADER_ID, 
       InternalMoveOrdersEO.ORDER_LINE_ID, 
       nvl(InternalMoveOrdersEO.QUANTITY_RECEIVED,0) QUANTITY_RECEIVED, 
       nvl(InternalMoveOrdersEO.QUANTITY_SHIPPED,0) QUANTITY_SHIPPED, 
       InternalMoveOrdersEO.LOCATOR_ID, 
       InternalMoveOrdersEO.SUB_INVENTORY_RCVD, 
       InternalMoveOrdersEO.EXP_QUANTITY, 
       InternalMoveOrdersEO.INVENTORY_ITEM_ID, 
       InternalMoveOrdersEO.RCV_INTO_ORG, 
       InternalMoveOrdersEO.RCV_INTO_OU, 
       InternalMoveOrdersEO.SHIP_FROM_ORG, 
       InternalMoveOrdersEO.SHIP_FROM_OU,
       nvl(InternalMoveOrdersEO.QUANTITY_PICKED,0) QUANTITY_PICKED,
       --fl.meaning LineType,
       ooh.order_number,
       pr.segment1 requisition,
       ''N'' SelectFlag,
       msi.concatenated_Segments item,
       msi.description,
       msi.primary_unit_of_measure uom,
       msi.primary_uom_code,
       org1.name ship_from_ou_name,
       org2.name ship_from_org_name,
       org3.name rcv_into_ou_name,
       org4.name rcv_into_org_name,
       decode(InternalMoveOrdersEO.REQ_HEADER_ID, null,''false'',''true'')    
       itemGroupReadOnly,
       po_lookup.displayed_field ReqStatus,
       (CASE WHEN nvl(ooh.cancelled_flag,''N'') = ''Y''
		THEN ''Cancelled''
	    WHEN ooh.open_flag = ''N''
	        THEN ''Closed''
	    WHEN ooh.booked_flag = ''Y''
                THEN ''Booked''
	    ELSE ''Entered''
	END) OrderStatus,
       prl.need_by_date,
       prl.deliver_to_location_id rcvIntoDestinationId,
       (select hl.location_code from hr_locations hl
	where location_id = prl.deliver_to_location_id
	AND inventory_organization_id = InternalMoveOrdersEO.RCV_INTO_ORG 
       )locationCode,
       decode(nvl(InternalMoveOrdersEO.order_header_id,-1),-1,
''false'',''true'') shipFromReadOnly,
msi.serial_number_control_code,
decode(nvl(InternalMoveOrdersEO.req_header_id,-1),-1,''false'',''true'') RcvIntoReadOnly,
decode(InternalMoveOrdersEO.quantity_available,null,InternalMoveOrdersEO.exp_quantity,0,InternalMoveOrdersEO.quantity_picked,InternalMoveOrdersEO.quantity_available) Available_Quantity,
InternalMoveOrdersEO.delivery_detail_id,
decode(InternalMoveOrdersEO.quantity_available,null,InternalMoveOrdersEO.exp_quantity,InternalMoveOrdersEO.quantity_available) Available_To_Pick,
prl.source_subinventory Ship_From_Subinv,
prl.destination_subinventory Rcv_Into_Subinv,
to_number(''53'') Int_Order_Pick_Txn_Type,
to_number(''61'') Int_Order_Rcv_Txn_Type,
mil.concatenated_segments Rcv_into_Locator,
decode ( rcv_msi.RESTRICT_SUBINVENTORIES_CODE, 2, -1, InternalMoveOrdersEO.inventory_item_id) rcv_si_inventory_item_id,
decode ( rcv_msi.restrict_locators_code, 2, -1, InternalMoveOrdersEO.inventory_item_id )  rcv_locator_inventory_item_id,
rcv_msi.RESTRICT_SUBINVENTORIES_CODE,
rcv_msi.RESTRICT_LOCATORS_CODE,
rcv_mp.stock_locator_control_code rcv_org_stock_loc_cntl_code,
rcv_msin.locator_type rcv_subinv_locator_type, 
rcv_msi.location_control_code rcv_item_loc_cntl_code,
decode (decode (rcv_mp.stock_locator_control_code, 4, 
                  decode (rcv_msin.locator_type, 5, rcv_msi.location_control_code, rcv_msin.locator_type ), 
                 rcv_mp.stock_locator_control_code ) , 2 , 0 , 3 , 0 , 1 ) Rcv_Locator_Disabled
FROM   CSD_PRODUCT_TRANSACTIONS InternalMoveOrdersEO,
       --FND_lookups fl,
       OE_ORDER_HEADERS_ALL ooh,
       PO_REQUISITION_HEADERS_ALL pr,
       PO_REQUISITION_LINES_ALL prl,
       OE_ORDER_LINES_ALl ool,
       mtl_system_items_kfv msi,
       hr_all_organization_units org1,
       hr_all_organization_units org2,
       hr_all_organization_units org3,
       hr_all_organization_units org4,
       po_lookup_codes po_lookup,
       mtl_item_locations_kfv mil,
       mtl_parameters rcv_mp,
       mtl_system_items_kfv rcv_msi,
       mtl_secondary_inventories rcv_msin
WHERE InternalMoveOrdersEO.repair_line_id = NVL(##$$REPAIR_LINE_ID$$##,InternalMoveOrdersEO.repair_line_id)
/*AND   InternalMoveOrdersEO.action_type = fl.lookup_code
AND   fl.lookup_type = ''CSD_PROD_ACTION_TYPE''*/
AND   InternalMoveOrdersEO.order_header_id = ooh.header_id(+)
AND   InternalMoveOrdersEO.req_header_id = pr.requisition_header_id(+)
AND   InternalMoveOrdersEO.order_line_id = ool.line_id(+)
AND   InternalMoveOrdersEO.inventory_item_id = msi.inventory_item_id(+)
AND   msi.organization_id = fnd_profile.value(''CSD_DEF_REP_INV_ORG'')
AND   InternalMoveOrdersEO.ship_from_ou = org1.organization_id(+)
AND   InternalMoveOrdersEO.ship_from_org = org2.organization_id(+)
AND   InternalMoveOrdersEO.rcv_into_ou = org3.organization_id(+)
AND   InternalMoveOrdersEO.rcv_into_org = org4.organization_id(+)
AND   po_lookup.lookup_type = ''AUTHORIZATION STATUS''
AND   po_lookup.lookup_code = nvl(pr.authorization_status,''INCOMPLETE'')
AND   InternalMoveOrdersEO.req_header_id = prl.requisition_header_id(+)
AND  InternalMoveOrdersEO.req_line_id = prl.requisition_line_id(+)
AND  InternalMoveOrdersEO.locator_id = mil.inventory_location_id(+)
AND  InternalMoveOrdersEO.rcv_into_org = mil.organization_id(+)
AND  InternalMoveOrdersEO.rcv_into_org  = rcv_mp.organization_id  
AND  prl.destination_organization_id  = rcv_msin.organization_id(+)
AND  prl.destination_subinventory = rcv_msin.secondary_inventory_name(+)
and  InternalMoveOrdersEO.rcv_into_org = rcv_msi.organization_id(+)
AND  InternalMoveOrdersEO.inventory_item_id = rcv_msi.inventory_item_id(+)',
      p_title                  => 'Internal Move Orders',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the internal orders created for this service order',
      p_solution               => '',
      p_success_msg            => 'There are no internal move orders for this repair order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_CSD_INTERNAL_MOVE_ORDERS');



debug('begin add_signature: EBS_CRM_CSD_MLE_BILLING_TYPE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19331',
      p_sig_id                 => 'EBS_CRM_CSD_MLE_BILLING_TYPE',
      p_sig_sql                => 'SELECT txn_type_name "SERVICE ACTIVITY",
    txn_type_description "SERVICE ACTIVITY DESCRIPTION",
     billing_type "BILLING TYPE CODE",
      billing_type_meaning "BILLING TYPE",
...
WHERE repair_type_id =
      ...
      WHERE repair_line_id = ##$$REPAIR_LINE_ID$$## )
order by 6 desc',
      p_title                  => 'Material, Labor and Expense Billing Type',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the material, labor and expense billing type for this repair order.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_MLE_BILLING_TYPE');



debug('begin add_signature: EBS_CRM_CSD_PRE_RMA_OM_LTYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19333',
      p_sig_id                 => 'EBS_CRM_CSD_PRE_RMA_OM_LTYPES',
      p_sig_sql                => 'SELECT hr.name "OPERATING UNIT",
       ottht.name "ORDER TYPE",
      ottlt.name "LINE TYPE",
     otth.order_category_code "HEADER CATEGORY CODE" ,
     ottl.order_category_code  "LINE CATEGORY CODE",
      ctboa.txn_bill_order_id ,
      ctboa.txn_billing_type_id ,
     ctboa.org_id ,
     ctboa.order_type_id ,
     ctboa.line_type_id
FROM cs_txn_billing_oetxn_all ctboa,
     cs_txn_billing_types ctbt,
     hr_all_organization_units_tl hr,
     oe_transaction_types_all otth,
     oe_transaction_types_tl ottht,
     oe_transaction_types_all ottl,
     oe_transaction_types_tl ottlt
WHERE ctboa.txn_billing_type_id = ctbt.txn_billing_type_id
    AND hr.organization_id = ctboa.org_id
    AND hr.LANGUAGE = userenv(''LANG'')
    AND otth.transaction_type_id = ctboa.order_type_id
    AND otth.transaction_type_id = ottht.transaction_type_id
    AND ottht.LANGUAGE = userenv(''LANG'')
    AND ottl.transaction_type_id = ctboa.line_type_id
    AND ottl.transaction_type_id = ottlt.transaction_type_id
    AND ottlt.LANGUAGE = userenv(''LANG'')
    AND ctbt.transaction_type_id =
     (SELECT ctbt1.transaction_type_id
      FROM csd_repair_types_vl crtv,
        csd_repairs cr,
        cs_txn_billing_types ctbt1
      WHERE cr.repair_type_id = crtv.repair_type_id
      AND cr.repair_line_id = ##$$REPAIR_LINE_ID$$##
    AND ctbt1.txn_billing_type_id = crtv.cpr_txn_billing_type_id)
ORDER BY ctboa.txn_billing_type_id',
      p_title                  => 'Pre Repair RMA Order Management Header and Line Types',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the pre repair ship service activity and billing type for this repair order.
',
      p_solution               => '',
      p_success_msg            => 'There are no pre repair ship service activity and billing types for this repair order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_PRE_RMA_OM_LTYPES');



debug('begin add_signature: EBS_CRM_CSD_POST_RMA_OM_LTYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19332',
      p_sig_id                 => 'EBS_CRM_CSD_POST_RMA_OM_LTYPES',
      p_sig_sql                => 'SELECT hr.name "OPERATING UNIT",
       ottht.name "ORDER TYPE",
      ottlt.name "LINE TYPE",
     otth.order_category_code "HEADER CATEGORY CODE",
...
where ctboa.txn_billing_type_id = ctbt.txn_billing_type_id
    ...
    AND ctbt.transaction_type_id =
     (SELECT ctbt1.transaction_type_id
      ...
      WHERE cr.repair_type_id = crtv.repair_type_id
      AND cr.repair_line_id = ##$$REPAIR_LINE_ID$$##
    AND ctbt1.txn_billing_type_id = crtv.lr_txn_billing_type_id)
ORDER BY ctboa.txn_billing_type_id',
      p_title                  => 'Post Repair RMA Order Management Header and Line Types',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the post repair RMA order management header and line types for this repair order.
',
      p_solution               => '',
      p_success_msg            => 'There are no  post repair RMA order management header and line types for this repair order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_POST_RMA_OM_LTYPES');



debug('begin add_signature: EBS_CRM_CSD_CHARGE_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19334',
      p_sig_id                 => 'EBS_CRM_CSD_CHARGE_DETAILS',
      p_sig_sql                => 'SELECT estimate_detail_id,  original_source_code_meaning,SOURCE_ID "REPAIR NUMBER",
     incident_id,party_id,account_id,line_number,
inventory_item_id,serial_number,quantity_required,
unit_of_measure_code "UOM",AFTER_WARRANTY_COST,business_process_name,material_billable_flag,txn_billing_type_id,
order_header_id,order_line_id,interface_to_oe_flag,line_category_code,price_list_header_id,
price_list_name "PRICE LIST",CURRENCY_CODE,CHARGE_LINE_TYPE,LIST_PRICE,LINE_STATUS_MEANING "LINE STATUS"
from CS_CHARGE_DETAILS_V 
     where original_source_code_meaning like ''Depot Repair''
and source_code like ''DR''
and SOURCE_ID = ##$$REPAIR_LINE_ID$$##
ORDER BY estimate_detail_id',
      p_title                  => 'Repair Order Charges',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the charge line details  for this repair order.
',
      p_solution               => '',
      p_success_msg            => 'There are no  charge lines generated for this repair order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_CHARGE_DETAILS');



debug('begin add_signature: EBS_CRM_CSD_ORDER_HEADER_DTLS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19335',
      p_sig_id                 => 'EBS_CRM_CSD_ORDER_HEADER_DTLS',
      p_sig_sql                => 'SELECT
	HEADER_ID,
	ORG_ID,
	ORDER_TYPE_ID,
	...
	PRICE_LIST
FROM
	APPS.OE_ORDER_HEADERS_V
WHERE 
	HEADER_ID IN 
	(
		SELECT 
		ORDER_HEADER_ID FROM 
		CS_CHARGE_DETAILS_V 
		WHERE 
		SOURCE_CODE LIKE ''DR''
		AND SOURCE_ID = ##$$REPAIR_LINE_ID$$## 
	)',
      p_title                  => 'Repair OM Order Header',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displays the order header details of this repair order.',
      p_solution               => '',
      p_success_msg            => 'There are no orders for this repair order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_ORDER_HEADER_DTLS');



debug('begin add_signature: EBS_CRM_CSD_ORDER_LINE_DTLS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19336',
      p_sig_id                 => 'EBS_CRM_CSD_ORDER_LINE_DTLS',
      p_sig_sql                => 'SELECT
	LINE_ID,
	HEADER_ID,
	ORG_ID,
...
WHERE 
	...
	(
      ...
      p_title                  => 'Repair OM Order Line',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displays the order line  details of this repair order.',
      p_solution               => '',
      p_success_msg            => 'There are no orders for this repair order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_ORDER_LINE_DTLS');



debug('begin add_signature: EBS_CRM_CSD_CHG_IB_MANY_SOURCE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20620',
      p_sig_id                 => 'EBS_CRM_CSD_CHG_IB_MANY_SOURCE',
      p_sig_sql                => 'select a.transaction_type_id, b.sub_type_id, b.name, a.txn_billing_type_id, a.billing_type
from  (SELECT a.transaction_type_id, a.txn_billing_type_id, a.billing_type
       FROM   CS_TXN_BILLING_TYPES a,
              csi_txn_sub_types    b,
              csi_txn_types        c
       WHERE    a.transaction_type_id = b.cs_transaction_type_id
          AND   b.transaction_type_id = c.transaction_type_id
          AND   c.source_application_id = 660
          AND   c.source_transaction_type in (''RMA_RECEIPT'',''OM_SHIPMENT'')
       group by a.transaction_type_id, a.txn_billing_type_id, a.billing_type
       having count(*) > 1) a
       ,   csi_txn_sub_types    b
       ,   csi_txn_types        c
where  b.cs_transaction_type_id = a.transaction_type_id
 AND   b.transaction_type_id = c.transaction_type_id
 AND   c.source_transaction_type in (''RMA_RECEIPT'',''OM_SHIPMENT'')',
      p_title                  => 'CS_CHG_IB_TOO_MANY_SOURCES Error',
      p_fail_condition         => 'RSGT',
      p_problem_descr          => 'When attempting to submit or book an order from  Depot Repair (logistics or actuals) or Service Request Charges see error "CS_CHG_IB_TOO_MANY_SOURCES" ',
      p_solution               => 'Please follow solution in [1993908/KB740753] -  CS_CHG_IB_TOO_MANY_SOURCES Error When Trying to Submit or Book Orders  Depot Repair (logistics or actuals) or Service Request Charges',
      p_success_msg            => 'There are no records in table CSI_IB_TXN_TYPES  with same transaction_type_id  which is tied to more than one sub_type_id.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_CHG_IB_MANY_SOURCE');



debug('begin add_signature: EBS_CRM_SC_CSD_WIP_TRANSACTION_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25355',
      p_sig_id                 => 'EBS_CRM_SC_CSD_WIP_TRANSACTION_DETAILS',
      p_sig_sql                => 'SELECT
    a.*
FROM
    CSD_WIP_TRANSACTION_DETAILS  a,
    csd_repair_job_xref_v b
WHERE
        a.wip_entity_id = b.wip_entity_id
    AND b.repair_line_id = ##$$REPAIR_LINE_ID$$##
ORDER BY
    b.repair_job_xref_id
',
      p_title                  => 'CSD_WIP_TRANSACTION_DETAILS',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the CSD_WIP_TRANSACTION_DETAILS details  for this repair order.
',
      p_solution               => '',
      p_success_msg            => 'There are no wip transaction details  for this repair order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_CSD_WIP_TRANSACTION_DETAILS');



debug('begin add_signature: EBS_CRM_SC_CSD_WIP_REQUIREMENT_OPERATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25353',
      p_sig_id                 => 'EBS_CRM_SC_CSD_WIP_REQUIREMENT_OPERATION',
      p_sig_sql                => 'SELECT
    a.*
FROM
    WIP_REQUIREMENT_OPERATIONS  a,
    csd_repair_job_xref_v b
WHERE
        a.wip_entity_id = b.wip_entity_id
    AND b.repair_line_id = ##$$REPAIR_LINE_ID$$##
ORDER BY
    b.repair_job_xref_id',
      p_title                  => 'WIP_REQUIREMENT_OPERATIONS',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the WIP_REQUIREMENT_OPERATIONS details  for this repair order.
',
      p_solution               => '',
      p_success_msg            => 'There are no wip requirement operations for this repair order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_CSD_WIP_REQUIREMENT_OPERATION');



debug('begin add_signature: EBS_CRM_SC_CSD_WIP_OPERATION_RESOURCES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25354',
      p_sig_id                 => 'EBS_CRM_SC_CSD_WIP_OPERATION_RESOURCES',
      p_sig_sql                => 'SELECT
    a.*
FROM
    wip_operation_resources  a,
    csd_repair_job_xref_v     b
WHERE
        a.wip_entity_id = b.wip_entity_id
    AND b.repair_line_id = ##$$REPAIR_LINE_ID$$##
ORDER BY
    b.repair_job_xref_id
',
      p_title                  => 'WIP_OPERATION_RESOURCES',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the WIP_OPERATION_RESOURCES details  for this repair order.
',
      p_solution               => '',
      p_success_msg            => 'There are no wip operation resources for this repair order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_CSD_WIP_OPERATION_RESOURCES');



debug('begin add_signature: EBS_CRM_SC_CSD_WIP_JOBS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25145',
      p_sig_id                 => 'EBS_CRM_SC_CSD_WIP_JOBS',
      p_sig_sql                => 'SELECT
    a.*
FROM
    wip_discrete_jobs     a,
...
ORDER BY
    b.repair_job_xref_id
',
      p_title                  => 'WIP_DISCRETE_JOBS',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the WIP_DISCRETE_JOBS details  for this repair order.
',
      p_solution               => '',
      p_success_msg            => 'There are no wip discrete jobs  jobs for this repair order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SC_CSD_WIP_JOBS');
...
debug('begin add_signature: EBS_CRM_CSD_NEW_MESSAGE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16161',
      p_sig_id                 => 'EBS_CRM_CSD_NEW_MESSAGE_CHECK',
      p_sig_sql                => 'select message_name, message_text, application_id, description, type  from fnd_new_messages where message_name = ''CSD_SELECT_INT_ORD''',
      p_title                  => 'Internal Move Order New Message Check',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The Internal Order (CSD_SELECT_INT_ORD) does not exists in FND_NEW_MESSAGES. This may cause the following error message to occur, when users pick release the Internal Move Order in Depot Repair:<br>
<br>
ERROR<br>
-----------------------<br>
‘Message not found: Application: CSD, Message Name: CSD_SELECT_INT_ORD’',
      p_solution               => 'For solution refer to  [1947117/KB708774] - Depot Repair Error: "Message Not Found: Application: CSD, Message Name: CSD_SELECT_INT_ORD" When Pick Releasing an Unreserved Line From the Internal Move Order User Interface.',
      p_success_msg            => 'The Internal Order exists in FND_NEW_MESSAGES.<br>
This will avoid a known issue documented in [1947117/KB708774] - Depot Repair Error: "Message Not Found: Application: CSD, Message Name: CSD_SELECT_INT_ORD" When Pick Releasing an Unreserved Line From the Internal Move Order User Interface.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_CSD_NEW_MESSAGE_CHECK');
...
BEGIN
  ...
  analyzer_title := 'Depot Repair Analyzer';
...
start_section('Proactive and Preventative Recommendations', 'Proactive_and_Preventative_Recommendations');
   set_item_result(check_rec_patches_1); /* Signature EBS_CRM_CSD_CHECK_REC_PATCHES */
   set_item_result(run_stored_sig('EBS_CRM_CSD_UPG_ERRORS'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_LOG_CHECK'));
   ...
   set_item_result(run_stored_sig('EBS_CRM_SC_CSD_EXCLUDE_ENDECA'));
   IF   ((substr(g_rep_info('Apps Version'),1,6) = '12.2.3') OR 
      (substr(g_rep_info('Apps Version'),1,6) = '12.2.4')) THEN
      set_item_result(run_stored_sig('EBS_CRM_CSD_NEW_MESSAGE_CHECK'));
   END IF;
end_section;
debug('end section: Proactive_and_Preventative_Recommendations');

debug('begin section: RepairOrderSetup');
start_section('Repair Order Setup', 'RepairOrderSetup');
   set_item_result(run_stored_sig('EBS_CRM_CSD_DEFAULT_REP_TYPE'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_REP_INV_ORG_PROF'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_DEF_COVERAGE_PROF'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_DEP_OP_PROFILE'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_ACCTPERIOD_CHECK'));
   set_item_result(run_stored_sig('EBS_CRM_SC_CSD_SRSO_FROM_OMRMA'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_QUICK_MENU_CHECK'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_REPTYPE_SAC'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_CONC_SCH_SHIPMENT'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_CONC_SCH_RECEIPT'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_OM_ORDER_SYNC'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_SYNC_OM_LOGIS_STS'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_CID_NOMATCH'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_REP_ORG_PROF'));
   set_item_result(run_stored_sig('PRICING_MODIFIER_IN_ACROSS_ALL_PHASES'));
end_section;
debug('end section: RepairOrderSetup');

debug('begin section: OrderDetails');
start_section('Repair Order Details', 'OrderDetails');
   set_item_result(run_stored_sig('EBS_CRM_CSD_LOGISTICS'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_REPAIR_TYPE'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_ESTIMATE_HEADER'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_ESTIMATE_LINES'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_REPAIR_JOBS'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_REPAIR_TASKS'));
   set_item_result(run_stored_sig('EBS_CRM_SC_CSD_MAT_DBF'));
   set_item_result(run_stored_sig('EBS_CRM_SC_CSD_LAB_DBF'));
   set_item_result(run_stored_sig('EBS_CRM_SC_CSD_EXP_DBF'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_REPAIR_ACTUALS'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_REP_BUS_PROCESS'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_REP_MAT_CODES'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_REP_LABOR_CODES'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_REP_EXPENSE_CODES'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_REPAIR_ORDER_DTLS'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_REPAIR_SR_DTLS'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_REPAIR_SERVICE_CODES'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_REPAIR_DIAG_CODES'));
   set_item_result(run_stored_sig('EBS_CRM_SC_CSD_IMPORT_ACT_FROM_ESTIMATE'));
   set_item_result(run_stored_sig('EBS_CRM_SC_CSD_WIP_JOB_SHARED'));
   set_item_result(run_stored_sig('EBS_CRM_SC_CSD_INTERNAL_MOVE_ORDERS'));
end_section;
debug('end section: OrderDetails');

debug('begin section: Charges');
start_section('Charges', 'Charges');
   set_item_result(run_stored_sig('EBS_CRM_CSD_MLE_BILLING_TYPE'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_PRE_RMA_OM_LTYPES'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_POST_RMA_OM_LTYPES'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_CHARGE_DETAILS'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_ORDER_HEADER_DTLS'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_ORDER_LINE_DTLS'));
   set_item_result(run_stored_sig('EBS_CRM_CSD_CHG_IB_MANY_SOURCE'));
end_section;
debug('end section: Charges');

debug('begin section: Wip_entity_details');
start_section('Wip Entity Details', 'Wip_entity_details');
   set_item_result(run_stored_sig('EBS_CRM_SC_CSD_WIP_TRANSACTION_DETAILS'));
   set_item_result(run_stored_sig('EBS_CRM_SC_CSD_WIP_REQUIREMENT_OPERATION'));
   set_item_result(run_stored_sig('EBS_CRM_SC_CSD_WIP_OPERATION_RESOURCES'));
   set_item_result(run_stored_sig('EBS_CRM_SC_CSD_WIP_JOBS'));
end_section;
debug('end section: Wip_entity_details');
