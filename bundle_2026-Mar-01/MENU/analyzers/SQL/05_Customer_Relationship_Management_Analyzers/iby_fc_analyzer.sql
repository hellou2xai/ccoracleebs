...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Payments (IBY) Funds Capture Analyzer  |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE iby_fc_analyzer_pkg AUTHID DEFINER AS
...
PROCEDURE main
(            p_bep_suffix                   IN VARCHAR2    DEFAULT NULL
           ,p_batch_id                     IN VARCHAR2    DEFAULT NULL
           ,p_tangibleid                   IN VARCHAR2    DEFAULT NULL
...
END iby_fc_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY iby_fc_analyzer_pkg AS
-- $Id: iby_fc_analyzer.sql, 200.40 2026/01/28 16:41:17 palfonso Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(1602845.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'IBYFC_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'IBYFC_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>IBYFC Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=1602845.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/iby_fc_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,4481,EBS,EBS CRM,EBS - Sales/Marketing" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,4481,EBS,EBS CRM,EBS - Sales/Marketing" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},4481,EBS,EBS CRM,EBS - Sales/Marketing" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4151238" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">4481</span>
...
<p><strong>Version 200.40</strong></p><ul><li>Template Changes (4.8.4): View Confluence Page<br>
Minor Enhancements:<br>
- EBSAF-406 - EBS KB Article IDs Shown for Signature KM Links</li>
<li>Signature PREMIER_SUPPORT_12.0 has been changed.<br>
New Version: 14</li>
<li>Signature PREMIER_SUPPORT_11.5 has been changed.<br>
New Version: 12</li>
<li>Signature PREMIER_SUPPORT_12.1 has been changed.<br>
New Version: 13</li>
<li>Signature PREMIER_SUPPORT_DB_CHECK_11 has been changed.<br>
New Version: 10</li>
<li>Signature PREMIER_SUPPORT_DB_CHECK_12.1 has been changed.<br>
New Version: 10</li>
</ul>
<p>&nbsp;</p><p><strong>Version 200.39</strong></p><ul><li>The following signature has been changed:<ul><li>PREMIER_SUPPORT_DB_CHECK_12.1</li>
</ul>
</li>
</ul>
<p><strong>Version 200.38</strong></p><ul><li>The following signatures have been changed:<ul><li><p>AC_DB_PARAMETERS (new version: 11)</p><p>&nbsp;</p></li>
</ul>
</li>
</ul>
<p><strong>Version 200.37</strong></p><ul><li>The following signatures have been changed:<br>
&nbsp; &nbsp; - PREMIER_SUPPORT_DB_CHECK_12.1<br>
&nbsp; &nbsp; - PREMIER_SUPPORT_DB_CHECK_11&nbsp;<br>
&nbsp; &nbsp; - PREMIER_SUPPORT_12.1&nbsp;<br>
&nbsp; &nbsp; - PREMIER_SUPPORT_11.5&nbsp;<br>
&nbsp; &nbsp; - EBS_ATG_UGLE_32BIT_SEQUENCES_CLOSE_TO_MAX&nbsp;<br>
&nbsp; &nbsp; - EBS_ATG_UGLE_SEQUENCES_CLOSE_TO_MAXIMUM_VALUE&nbsp;<br>
&nbsp;</li>
</ul>
<p><strong>Version 200.36</strong></p><ul><li>Reference to the documentation has been updated during MOS2FS migration.</li>
</ul>
<p><strong>Version 200.34</strong></p><ul><li>Template Changes (4.8.2)<br>
&nbsp; &nbsp; Minor Enhancements:<br>
&nbsp; &nbsp; &nbsp; &nbsp;- EBSAF-405 Error: ORA-06502: PL/SQL: numeric or value error: character string buffer too small</li>
</ul>
<p><strong>Version 200.33</strong></p><ul><li>Template Changes (4.8):&nbsp;<br>
&nbsp; &nbsp; Minor Enhancements:<br>
&nbsp; &nbsp; &nbsp; &nbsp;- EBSAF-382 - Km notes links from analyzer output in cmos<br>
&nbsp; &nbsp; &nbsp; &nbsp;- EBSAF-399 - Change Thumbs up, Thumbs Down and Idea to point to Automation Factory page<br>
&nbsp; &nbsp; &nbsp; &nbsp;- EBSAF-404 - Remove Contact Us section from Analyzer footer</li>
</ul>
<p><strong>Version 200.32</strong></p><ul><li>Signature AC_TABLE_INDEXES has been changed. New Version: 14.</li>
</ul>
<p><strong>Version 200.31</strong></p><ul><li>Signature EBS_ATG_UGLE_SEQUENCES_CLOSE_TO_MAXIMUM_VALUE has been changed. New Version: 12</li>
</ul>
<p><strong>Version 200.24</strong></p><ul><li>Signature EBS_ATG_UGLE_32BIT_SEQUENCES_CLOSE_TO_MAX has been changed. New Version: 12</li>
</ul>
<p><strong>Version 200.23</strong></p><ul><li>Template Updated (25-APR-2025, Version 4.7.3).<br>
&nbsp;</li>
<li>Minor Enhancements:<br>
- EBSAF-393 - Ability to click to select rows in output tables<br>
Bug Fixes:<br>
- EBSAF-394 - The links on the Tiles in Home page of the analyzers are not working in Chrome and Edge<br>
&nbsp;</li>
</ul>
<p><strong>Version 200.22</strong></p><ul><li><p>New version of Parent Signature AC_FILE_VERISONS to include checking of MTL product:</p><p>select &apos;MTL&apos; as "##$$FK2$$##", &apos;MTL&apos; as APPLICATION_SHORT_NAME, fal.APPLICATION_NAME<br>
from dual, fnd_application_all_view fal<br>
where 401 in (##$$APPS_PARAM1$$##,##$$APPS_PARAM2$$##,##$$APPS_PARAM3$$##,##$$APPS_PARAM4$$##,##$$APPS_PARAM5$$##)<br>
and &apos;INV&apos; = fal.application_short_name<br>
&nbsp;</p></li>
</ul>
<p><strong>Version 200.21</strong></p><ul><li>New version (v13) of Parent Signature AC_APPLICATION_INSTALL_DETAILS to include installation status “Custom”</li>
</ul>
<p><strong>Version 200.20</strong></p><ul><li>The template has been updated.</li>
</ul>
<p><strong>Version 200.19</strong></p><ul><li>EBSAF-387 Add signature version to log during processing</li>
<li>EBSAF-389 Change message when signature output rows are limited</li>
<li>EBSAF-389 Add tool tip to Arrow when expanding collapsing result data</li>
</ul>
<p><strong>Version 200.18</strong></p><ul><li>Change to Signature Sequences With 32-bit Maximum Value and Large Cache Size: version changed from 10 to 11.</li>
<li>Change to Signature Sequences Above 70 Percent of Maximum Value : version changed from 10 to 11.</li>
</ul>
<p><strong>Version 200.17</strong></p><ul><li>Change to Signature Sequences With 32-bit Maximum Value and Large Cache Size: version changed from 9 to 10.</li>
<li>Change to Signature Sequences Above 70 Percent of Maximum Value : version changed from 9 to 10.</li>
</ul>
<p><strong>Version 200.16</strong></p><ul><li>Change to Signature EBS_CRM_IBY_BATCH_DETAILS. Recognizing failed batches (ie. batchstatus = 1).</li>
</ul>
<p><strong>Version 200.15</strong></p><ul><li>Change to Signature AC_DB_PARAMETERS.</li>
</ul>
<p><strong>Version 200.14</strong></p><ul><li>Template Changes (4.7).&nbsp;</li>
<li>Added 1 signature:<span style="background-color:var(--a-field-input-focus-background-color,var(--a-field-input-background-color));color:var(--a-field-input-focus-text-color,var(--a-field-input-text-color));"><span style="font-size:inherit;">&nbsp; &nbsp;Signature Charts</span></span></li>
<li>&nbsp;Minor Enhacement:<br>
&nbsp; &nbsp; &nbsp; - Set Number Width in SQL*Plus Wrapper Scripts</li>
</ul>
<p><strong>Version 200.13</strong></p><ul><li>Added signature &apos;Inconsistency Found Between the BEPKEY Used for Authorization and the One Used for Settlement&apos;</li>
<li>Renamed “Lifetime Support Policy” with “Critical Alerts”</li>
<li>Added 2 signatures:<span style="background-color:var(--a-field-input-focus-background-color,var(--a-field-input-background-color));color:var(--a-field-input-focus-text-color,var(--a-field-input-text-color));"><span style="font-size:inherit;">&nbsp;</span></span>&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;<br>
&nbsp; &nbsp; EBS_ATG_UGLE_32BIT_SEQUENCES_CLOSE_TO_MAX<br>
&nbsp; &nbsp; EBS_ATG_UGLE_SEQUENCES_CLOSE_TO_MAXIMUM_VALUE</li>
</ul>
<p><strong>Version 200.11</strong></p><ul><li>Analyzer Framework version 4.6.0.1 released.</li>
</ul>
<p><strong>Version 200.10</strong></p><ul><li>Analyzer Framework 4.5.9.1 version released.</li>
<li>Several signatures modified.</li>
</ul>
<p><strong>Version 200.9</strong></p><ul><li>Added new signature to verify profile option value IBY_HTTP_PROXY set to default dummy value .If this value is set to default dummy value causing Oracle Payments Authorization to fail.</li>
<li>Added signature to check if the Capture transactions previously failed with a communication error.</li>
<li>Added a patch in the Recommended Patches signature.</li>
</ul>
<p>&nbsp;</p><p><strong>Version 200.8</strong>:</p><ul><li>Lifetime Support Policy: Premier Support for R12.1.3 customers updated.</li>
</ul>
<p><strong>Version 200.7</strong>:</p><ol><li>New Analyzer Framework version 4.5.7 released with these changes:</li>
</ol>
...
<p><strong>Version 200.6</strong>:</p><ul><li><span style="font-family:&apos;Calibri&apos;,sans-serif;font-size:11pt;">Several signatures were modified and improved.</span></li>
<li><span style="font-family:&apos;Calibri&apos;,sans-serif;font-size:11pt;">Sensitive data has been masked as necessary.</span></li>
<li><span style="font-family:&apos;Calibri&apos;,sans-serif;font-size:11pt;">Removed unnecessary signatures which are not required for Funds Capture processing.</span></li>
<li><span style="font-family:&apos;Calibri&apos;,sans-serif;font-size:11pt;">Renamed analyzer sections to give proper name according to the data.</span></li>
</ul>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,4481,'||p_sig.sigrepo_id||',EBS,EBS CRM,EBS - Sales/Marketing" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,4481,'||p_sig.sigrepo_id||',EBS,EBS CRM,EBS - Sales/Marketing" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},4481,'||p_sig.sigrepo_id||',EBS,EBS CRM,EBS - Sales/Marketing" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
FUNCTION check_rec_patches_1 RETURN VARCHAR2 IS
  /* Signature EBS_CRM_IBY_REC_PATCHES */
...
BEGIN
    ...
    print_log('Processing recommended patches signature: EBS_CRM_IBY_REC_PATCHES (check_rec_patches_1) "Recommended Patches" (version 4)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(1)(l_rows) := '30837824';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'RECEIPT NOT MOVING TO CONFIRMED IF THERE IS FAILURE IN Perform All Actions';
   l_col_rows(5)(l_rows) := '[1262649.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30425797';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'RECEIPT NOT MOVING TO CONFIRMED IF THERE IS FAILURE IN SOT, RPC APPLIED';
   l_col_rows(5)(l_rows) := '[1262649.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '27256903';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'DUPLICATE CONFIRMED LINES IN AR_CASH_RECEIPT_HISTORY_ALL';
   l_col_rows(5)(l_rows) := '[2387031.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Payments Recommended Patch Collection (IBY RPC), Feb 2016';
   l_col_rows(5)(l_rows) := '[1481221.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '18053306';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'ISO DIRECT DEBIT: CONSOLIDATED PATCH';
   l_col_rows(5)(l_rows) := '[1608811.1]';

END IF;

   l_extra_info('##SHOW_SQL##'):= 'Y';

   l_sig.sigrepo_id := '16170';
   l_sig.title := 'Recommended Patches';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := 'You have not applied recommended patch(es) to this environment. Please expand the list above for the details.';
...
<li>[10940175/KA580] Patch Wizard FAQ</li>
  ...
  -- Register
  l_step := '60';
  g_signatures('EBS_CRM_IBY_REC_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'EBS_CRM_IBY_REC_PATCHES',     -- sig ID
...
----------------------------------------------------------------
l_bep_id   NUMBER;
l_bep_name   VARCHAR2(80);
l_mbatchid  NUMBER;
l_transactionid  NUMBER;
l_ibyecapp     VARCHAR2(255);
l_walletloc    VARCHAR2(255);
l_ssl          VARCHAR2(255);
l_ibyproxy     VARCHAR2(255);
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'BEP Suffix';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_bep_suffix,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Batch ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_batch_id,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Tangible ID of Transaction';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_tangibleid,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Receipt Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_receipt_number,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  l_revision := rtrim(replace('$Revision: 200.40  $','$',''));
  l_revision := ltrim(replace(l_revision,'Revision:',''));
  l_date_char := rtrim(replace('$Date: 2026/01/28 16:41:16 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'iby_fc_analyzer.sql';
...
debug('begin parameter validation: p_bep_suffix');
IF p_bep_suffix IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter BEP Suffix is required.');
   raise invalid_parameters;
END IF;
IF p_bep_suffix IS NOT NULL THEN
BEGIN
SELECT SUFFIX
INTO l_exists_val
FROM IBY_BEPINFO
WHERE SUFFIX = p_bep_suffix and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid BEP suffix specified');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_bep_suffix failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_bep_suffix');
...
debug('begin parameter validation: p_tangibleid');
IF p_tangibleid IS NOT NULL THEN
BEGIN
SELECT TANGIBLEID
INTO l_exists_val
FROM IBY_TRXN_SUMMARIES_ALL
WHERE TANGIBLEID = p_tangibleid
 AND REQTYPE='ORAPMTREQ'
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid tangibelid specified');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_tangibleid failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_tangibleid');

debug('begin parameter validation: p_receipt_number');
IF p_receipt_number IS NOT NULL THEN
BEGIN
SELECT RECEIPT_NUMBER
INTO l_exists_val
FROM AR_CASH_RECEIPTS_ALL
WHERE RECEIPT_NUMBER = p_receipt_number and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Receipt Number.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_receipt_number failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_receipt_number');
...
--Get BEPID
  if (p_bep_suffix is not null) then
    begin
      ...
      into l_bep_id
      from IBY_BEPINFO
      where SUFFIX = p_bep_suffix;
    exception
      when others then
        print_log('Invalid BEP Suffix number specified.'||sqlerrm);
        raise invalid_parameters;
    end;
  end if;
...
--Get MBATCHID from BATCHID
  if (p_batch_id is not null) then
    ...
    exception
      when others then
        print_log('Invalid BATCHID specified.'||sqlerrm);
        raise invalid_parameters;
    end;
  end if;

--Get TRANSACTIONID from TANGIBLEID
  if (p_tangibleid is not null) then
    begin
    ...
    exception
      when others then
        print_log('Invalid tangibleid specified.'||sqlerrm);
        raise invalid_parameters;
    end;
  end if;

--Get EC Servlet (ibyecapp) URL
--  if (p_bep_name is not null) then
    begin
     SELECT PROFILE_OPTION_VALUE
     INTO 	l_ibyecapp
     FROM 	fnd_profile_option_values
     WHERE 	APPLICATION_ID = 673 AND
        	PROFILE_OPTION_ID in (
      	      ...
      	      from 
            	  fnd_profile_options
	            Where
      		  PROFILE_OPTION_NAME = ('IBY_ECAPP_URL'));
    exception
      when others then
        print_log('IBY ECAPP URL Profile not set.'||sqlerrm);
        raise invalid_parameters;
    end;
-- end if;

--Get Value for Profile Database Wallet Directory
--  if (p_bep_name is not null) then
l_walletloc := 'file:'||l_walletloc;

    begin
     SELECT PROFILE_OPTION_VALUE
     INTO 	l_walletloc
     FROM 	fnd_profile_option_values
     WHERE 	APPLICATION_ID = 0 AND
        	PROFILE_OPTION_ID in (
            	Select 
	              PROFILE_OPTION_ID
      	      from 
            	  fnd_profile_options
	            Where
      		  PROFILE_OPTION_NAME = ('FND_DB_WALLET_DIR'));
    exception
      when others then
        print_log('Database Wallet Directory profile is not set'||sqlerrm);
        raise invalid_parameters;
    end;
--  end if;

-- Check if EC Servlet is using SSL protocol
--  if (p_bep_name is not null) then
    begin
     SELECT SUBSTR(PROFILE_OPTION_VALUE,5,1) 
     INTO  	l_ssl
     FROM 	fnd_profile_option_values
     WHERE 	profile_option_id in 
			...
			from 
				fnd_profile_options 
			where 
				profile_option_name in ('IBY_ECAPP_URL'));
    exception
      when others then
        print_log('IBY ECAPP URL profile is not set'||sqlerrm);
        raise invalid_parameters;
    end;
--  end if;
...
begin
     ...
     WHERE 	PROFILE_OPTION_ID in (
      	      ...
      	      from 
            	  fnd_profile_options
	            Where
      		  PROFILE_OPTION_NAME = ('IBY_HTTP_PROXY'))
     AND level_id = 10001;
      exception
          when NO_DATA_FOUND THEN
           l_ibyproxy := null;
...
--Get Receipt Number.
  if (p_receipt_number is not null) then
    ...
    exception
      when others then
        print_log('Invalid receipt specified.'||sqlerrm);
        raise invalid_parameters;
    end;
  end if;
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$BEPID$$##') := l_bep_id;
   g_masked_tokens('##$$BEPID$$##') := mask_text( g_sql_tokens('##$$BEPID$$##'), 'NO_MASK');
   g_sql_tokens('##$$MBATCHID$$##') := l_mbatchid;
   g_masked_tokens('##$$MBATCHID$$##') := mask_text( g_sql_tokens('##$$MBATCHID$$##'), 'NO_MASK');
   g_sql_tokens('##$$WALLETLOC$$##') := l_walletloc;
   g_masked_tokens('##$$WALLETLOC$$##') := mask_text( g_sql_tokens('##$$WALLETLOC$$##'), 'NO_MASK');
   g_sql_tokens('##$$TRXNID$$##') := l_transactionid;
   g_masked_tokens('##$$TRXNID$$##') := mask_text( g_sql_tokens('##$$TRXNID$$##'), 'NO_MASK');
   g_sql_tokens('##$$IBYECAPP$$##') := l_ibyecapp;
   g_masked_tokens('##$$IBYECAPP$$##') := mask_text( g_sql_tokens('##$$IBYECAPP$$##'), 'NO_MASK');
   g_sql_tokens('##$$SSL$$##') := l_ssl;
   g_masked_tokens('##$$SSL$$##') := mask_text( g_sql_tokens('##$$SSL$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM1$$##') := '673';
   ...
   g_sql_tokens('##$$BEPNAME$$##') := l_bep_name;
   g_masked_tokens('##$$BEPNAME$$##') := mask_text( g_sql_tokens('##$$BEPNAME$$##'), 'NO_MASK');
   g_sql_tokens('##$$BATCHID$$##') := p_batch_id;
   g_masked_tokens('##$$BATCHID$$##') := mask_text( g_sql_tokens('##$$BATCHID$$##'), 'NO_MASK');
   g_sql_tokens('##$$TANGIBLEID$$##') := p_tangibleid;
   g_masked_tokens('##$$TANGIBLEID$$##') := mask_text( g_sql_tokens('##$$TANGIBLEID$$##'), 'NO_MASK');
   g_sql_tokens('##$$BEP$$##') := upper(p_bep_suffix);
   g_masked_tokens('##$$BEP$$##') := mask_text( g_sql_tokens('##$$BEP$$##'), 'NO_MASK');
   g_sql_tokens('##$$IBYPROXY$$##') := l_ibyproxy;
   g_masked_tokens('##$$IBYPROXY$$##') := mask_text( g_sql_tokens('##$$IBYPROXY$$##'), 'NO_MASK');
   ...
   g_sql_tokens('##$$APPNAME$$##') := 'IBY';
   g_masked_tokens('##$$APPNAME$$##') := mask_text( g_sql_tokens('##$$APPNAME$$##'), 'NO_MASK');
   g_sql_tokens('##$$A$$##') := 'iby_fc_analyzer_pkg';
...
debug('begin add_signature: VERIFY_IBY_HTTP_PROXY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20065',
      p_sig_id                 => 'VERIFY_IBY_HTTP_PROXY',
      p_sig_sql                => 'SELECT SUBSTR(e.profile_option_name,1,25)
PROFILE,DECODE(a.level_id,10001,''Site'',10002,''Application'',10003,''Resp'',10004,''User'')
L,DECODE(a.level_id,10001,''Site'',10002,c.application_short_name,10003,b.responsibility_name,10004,d.user_name)
LValue,NVL(a.profile_option_value,''Is Null'')
Value,SUBSTR(a.last_update_date,1,25) UPDATED_DATE
FROM fnd_profile_option_values a, fnd_responsibility_tl b,
fnd_application c,fnd_user d, fnd_profile_options e
WHERE e.profile_option_name IN
(''IBY_HTTP_PROXY'')
AND e.profile_option_id = a.profile_option_id AND a.level_value =
b.responsibility_id (+)
AND a.level_value = c.application_id (+) AND a.level_value = d.user_id (+)
and a.profile_option_value like (''http%'')
ORDER BY profile_option_name',
      p_title                  => 'Verify profile option value IBY_HTTP_PROXY set to default dummy value ',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Profile "IBY: HTTP Proxy" value is set to default dummy value causing Oracle Payments Authorization to fail.',
      p_solution               => '<ul>
<li> The analyzer has detected the profile option "IBY: HTTP Proxy" value set to default dummy value described in [1114463/KB255430]. </li>
<li> Please review profile "IBY: HTTP Proxy" option setting and update it to a correct/valid value.</li>
<li> If you are not using proxy connection then set this profile value to BLANK (NULL).</li>
<li>If AutoConfig is setting Profile Option "IBY: HTTP Proxy" to invalid value then follow the [2661337/KB708259].</li>
</ul>',
      p_success_msg            => 'Profile "IBY: HTTP Proxy" value is not set to default dummy value (''http://:80'',''http://:'').',
   ...
   l_info.delete;
debug('end add_signature: VERIFY_IBY_HTTP_PROXY');



debug('begin add_signature: EBS_CRM_IBY_NETWORK_TIMEOUT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16064',
      p_sig_id                 => 'EBS_CRM_IBY_NETWORK_TIMEOUT',
      p_sig_sql                => 'SELECT SUBSTR(e.profile_option_name,1,25) PROFILE, 
decode(a.level_id,10001,''Site'',10002,
''Application'',10003,
''Resp'',10004,''User'') "Level Type", 
decode(a.level_id,10001,''Site'',10002,c.application_short_name, 
10003,b.responsibility_name,10004,##$$A$$##.mask_text(d.user_name,''##$$M$$##'')) "Level Value",
...
WHERE e.profile_option_name IN (''IBY_NETWORK_TIMEOUT'')
AND e.profile_option_id = a.profile_option_id 
AND a.level_value = b.responsibility_id (+)
AND a.level_value = c.application_id (+) 
AND a.level_value = d.user_id (+)
',
      p_title                  => 'IBY: Network Timeout Profile Setting',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Profile "IBY: Network Timeout" is not set.<br>This means that HTTP requests from Database to IBY Engine times out after 60 seconds of inactivity by default. ',
      p_solution               => 'You may change this timeout value by setting this profile option in milliseconds.<br>
Refer to  [1178666/KB304756]: Configuring Network Timeout for Oracle Payments ( IBY).',
      p_success_msg            => 'Verified profile is set to some value (is not null).<br>
Refer to [1178666/KB304756]: Configuring Network Timeout for Oracle Payments',
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_IBY_NETWORK_TIMEOUT');



debug('begin add_signature: EBS_CRM_IBY_ECAPP_SEC_FORCE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16180',
      p_sig_id                 => 'EBS_CRM_IBY_ECAPP_SEC_FORCE',
      p_sig_sql                => 'select
...
, FND_APPLICATION h
where
b.profile_option_name in (''IBY_ECAPP_SEC_FORCE'')
...
and c.PROFILE_OPTION_VALUE = ''N''',
      p_title                  => 'IBY: ECServlet Security Token Force Profile Setting',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Although this profile option is obsolete, it will cause an error if it is not set to "N".',
      p_solution               => 'Set the profile option "IBY: ECServlet Security Token Force" to N.<br>
NOTE: The profile will not have a List of Value (LOV) to choose the value. You will need to set the exact value to N (i.e. N not No).<br><br>
Refer to [754939/KB755050]: R12: ECServlet Security Token Rejected.',
      p_success_msg            => 'Verified profile is set to "N".',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_IBY_ECAPP_SEC_FORCE');



debug('begin add_signature: EBS_CRM_IBY_ENCRYPT_DATA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16207',
      p_sig_id                 => 'EBS_CRM_IBY_ENCRYPT_DATA',
      p_sig_sql                => 'SELECT 
	isso.CC_ENCRYPTION_MODE, 
	isso.EXT_BA_ENCRYPTION_MODE, 
	isso.SYS_KEY_FILE_LOCATION WALLET,
   ...
   FROM 
      ...
      p_title                  => 'Payment Data Encryption and Masking Setup',
      p_fail_condition         => '[WALLET] is null',
      p_problem_descr          => 'Payment data encryption is not enabled.<br>
It is recommended to have encryption enabled to encrypt sensitive payments data.',
      p_solution               => '<ul>
     <li>To enable encryption, please  refer to [1301337/KB728206] : How To Enable Oracle Payments Data Encryption Functionality.</li>
     <li>Before enabling payment data encryption, please review and understand contents of [1573912/KB752562] : All About Oracle Payments Release 12 Wallets and Data Encryption.</li>
     <li>After enabling encryption, ensure that a backup copy of self signed wallet file cwallet.sso is saved in secured location.</li>
      ...
      p_success_msg            => 'Verified a wallet is defined (SYS_KEY_FILE_LOCATION ''WALLET'' is populated).
<ul>
     <li>After enabling encryption, ensure that a backup copy of self signed wallet file cwallet.sso is saved in secured location.</li>
     <li>For detailed explanation of payment data encryption, please review and understand contents of [1573912/KB752562] All About Oracle Payments Release 12 Wallets and Data Encryption.</li>
     </ul>',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_IBY_ENCRYPT_DATA');



debug('begin add_signature: EBS_CRM_IBY_BEP_DETAILS');
   l_info('##MASK##ADMINURL'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##BEP_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRAN_SERVLET_URL'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16057',
      p_sig_id                 => 'EBS_CRM_IBY_BEP_DETAILS',
      p_sig_sql                => 'select 
ib.NAME BEP_Name,
ib.BEPID,
ib.SUFFIX BEP_Suffix,
ib.BASEURL Tran_Servlet_URL,
ib.BEP_TYPE,
ib.ADMINURL,
ib.MAX_BATCH_SIZE,
ib.LEADTIME,
ib.AUTH_REVERSAL_FLAG
 from IBY_BEPINFO ib
 where ib.bepid in (##$$BEPID$$##)',
      p_title                  => 'Payment System Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No such payment system exists.<br> Refer to [471418/KB719598#heading2] to perform payment system setup.
',
      p_solution               => '',
      p_success_msg            => 'Data showing details for the payment system.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_IBY_BEP_DETAILS');



debug('begin add_signature: EBS_CRM_IBY_BEP_ACCT');
   l_info('##MASK##KEY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16050',
      p_sig_id                 => 'EBS_CRM_IBY_BEP_ACCT',
      p_sig_sql                => 'select
ibk.BEPID,
ibk.KEY,
ibk.OWNERID,
ibk.BEP_ACCOUNT_ID
 from iby_bepkeys ibk
  where ibk.bepid in (##$$BEPID$$##)',
      p_title                  => 'Payment System Accounts',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no payment system accounts added to the payment system.
',
      p_solution               => 'You need to define payment system account  that the payment system requires for each transaction or settlement batch.<br>Refer to [471418/KB719598#heading2] to add payment system accounts to the payment system. ',
      p_success_msg            => 'Data showing account information for the payment system.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_IBY_BEP_ACCT');



debug('begin add_signature: EBS_CRM_IBY_BEP_ACCT_DETAILS');
   l_info('##MASK##ACCOUNT_OPTION_VALUE'):= 'DISPLAY_NONE';
   l_info('##MASK##KEY'):= 'DISPLAY_NONE';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16055',
      p_sig_id                 => 'EBS_CRM_IBY_BEP_ACCT_DETAILS',
      p_sig_sql                => 'select 
ibaon.BEPID,
ibaov.BEP_ACCOUNT_ID,
ibk.key,
ibaon.ACCOUNT_OPTION_NAME,
ibaon.ACCOUNT_OPTION_CODE,
ibaov.ACCOUNT_OPTION_VALUE,
ibaov.VAL_SEC_SEGMENT_ID
from 
    iby_bep_acct_opt_name_tl ibaon,
    iby_bep_acct_opt_vals ibaov,
    iby_bepkeys ibk
where
    ibaon.BEPID in (##$$BEPID$$##) and
    ibaon.ACCOUNT_OPTION_CODE = ibaov.ACCOUNT_OPTION_CODE and
    ibaon.BEPID = ibaov.BEPID  and
    ibaon.BEPID = ibk.bepid and
    ibaov.BEP_ACCOUNT_ID = ibk.BEP_ACCOUNT_ID 
order by BEP_ACCOUNT_ID',
      p_title                  => 'Payment System Account Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no payment system account details defined for the payment system account.
',
      p_solution               => 'You need to define payment system account details parameters that the payment system requires for each transaction or settlement batch.<br> 
When you define payment system accounts, need to provide the actual payment system provided values for these parameters.<br>Refer to [471418/KB719598#heading2] to define payment system account detail parameters. ',
      p_success_msg            => 'Data showing payment system account details for the payment system account.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_IBY_BEP_ACCT_DETAILS');



debug('begin add_signature: EBS_CRM_IBY_BEP_FORMATS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16189',
      p_sig_id                 => 'EBS_CRM_IBY_BEP_FORMATS',
      p_sig_sql                => 'select 
 	a.payment_format_code, 
	b.format_type_code, 
	b.format_template_code, 
	c.file_name,
	c.xdo_file_type, 
	c.file_status, 
	c.file_content_type,
    ...
    from 
	IBY_PMT_SYS_FORMATS a, 
   	IBY_FORMATS_B b, XDO_LOBS c
    where 
	b.format_code = a.payment_format_code and 
	a.payment_system_id in (##$$BEPID$$##) and 
	trunc(nvl(a.inactive_date,sysdate)) >= trunc(sysdate) and 
	b.format_template_code = c.lob_code',
      p_title                  => 'Payment System Format Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Payment instruction formats not attached to the payment system.',
      p_solution               => 'Update the payment system and attach payment instruction formats under the section "Format" in the payment system page.<br>
Refer to [471418/KB719598#heading2]: Oracle Payments Minimum/Dummy Setup For Direct Debit Funds Capture Processing.',
      p_success_msg            => 'Payment instruction formats have been defined for the payment system.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_IBY_BEP_FORMATS');



debug('begin add_signature: EBS_CRM_IBY_TRANS_CONFIG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16186',
      p_sig_id                 => 'EBS_CRM_IBY_TRANS_CONFIG',
      p_sig_sql                => 'select 
a.transmit_configuration_name, 
a.transmit_configuration_id,
b.transmit_protocol_code, 
b.tunneling_trans_config_id
from 
IBY_TRANSMIT_CONFIGS_TL a, 
IBY_TRANSMIT_CONFIGS_B b
where  
a.transmit_configuration_id = b.transmit_configuration_id and 
a.language = ''US'' and
b.transmit_protocol_code in 
(Select TRANSMIT_PROTOCOL_CODE
From IBY_PMT_SYS_TRANSMISSIONS
Where bepid in (##$$BEPID$$##))',
      p_title                  => 'Transmission Configuration Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no transmission configuration created for the payment system.',
      p_solution               => 'Create transmission configuration for the protocol to be used.
Refer to [471418/KB719598#heading1]: Oracle Payments Minimum/Dummy Setup For Direct Debit Funds Capture Processing.',
      p_success_msg            => 'Transmission configuration details has been defined for the payment system.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_IBY_TRANS_CONFIG');



debug('begin add_signature: EBS_CRM_IBY_TRANS_CONFIG_VAL');
   l_info('##MASK##TRANSMIT_VARCHAR2_VALUE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16188',
      p_sig_id                 => 'EBS_CRM_IBY_TRANS_CONFIG_VAL',
      p_sig_sql                => 'select 
itc.TRANSMIT_CONFIGURATION_ID,
itc.TUNNELING_TRANS_CONFIG_ID,
itc.TRANSMIT_PROTOCOL_CODE,
...
from 
IBY_TRANSMIT_CONFIGS_B itc,IBY_TRANSMIT_VALUES itv
where  
	itv.TRANSMIT_CONFIGURATION_ID = itc.TRANSMIT_CONFIGURATION_ID  AND
	itc.TRANSMIT_PROTOCOL_CODE in 
	(Select TRANSMIT_PROTOCOL_CODE From IBY_PMT_SYS_TRANSMISSIONS
	 Where bepid in (##$$BEPID$$##))',
      p_title                  => 'Transmission Configuration Values',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no transmission configuration created for the payment system.',
      p_solution               => 'Create transmission configuration for the protocol to be used.
Refer to [471418/KB719598#heading1]: Oracle Payments Minimum/Dummy Setup For Direct Debit Funds Capture Processing.',
      p_success_msg            => 'Transmission configuration values has been defined for the payment system.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_IBY_TRANS_CONFIG_VAL');



debug('begin add_signature: EBS_CRM_IBY_TRANS_PROT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16187',
      p_sig_id                 => 'EBS_CRM_IBY_TRANS_PROT',
      p_sig_sql                => 'select 
a.transmit_protocol_code, 
b.transmit_code_language, 
b.transmit_code_package||''.''||b.transmit_code_entry_point||''()'' code,
c.transmit_protocol_name
from 
IBY_PMT_SYS_TRANSMISSIONS a, 
IBY_TRANSMIT_PROTOCOLS_B b, 
IBY_TRANSMIT_PROTOCOLS_TL c
where 
a.transmit_protocol_code = b.transmit_protocol_code and 
c.transmit_protocol_code = b.transmit_protocol_code and 
a.bepid in (##$$BEPID$$##)',
      p_title                  => 'Transmission Protocol Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No transmission protocol is associated with the payment system.',
      p_solution               => 'Update payment system details and attach transmission protocols.
Refer to [471418/KB719598#heading1]: Oracle Payments Minimum/Dummy Setup For Direct Debit Funds Capture Processing.',
      p_success_msg            => 'Transmission protocol details has been defined for the payment system.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_IBY_TRANS_PROT');



debug('begin add_signature: EBS_CRM_IBY_DEFAULT_BEP');
   l_info('##MASK##BEP_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PAYEE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16059',
      p_sig_id                 => 'EBS_CRM_IBY_DEFAULT_BEP',
      p_sig_sql                => 'select 
ibi.name BEP_Name,
idb.bepid,
idb.instrtype, 
...
ip.payeeid,
idb.mpayeeid, 
idb.payment_channel_code, 
idb.fndcpt_user_profile_code, 
idb.bep_account_id
 from iby_default_bep idb,iby_bepinfo ibi,iby_payee ip
    Where
      idb.mpayeeid = ip.mpayeeid and
  	ibi.bepid = idb.bepid and
  	idb.bepid in (##$$BEPID$$##)',
      p_title                  => 'Default Payment System',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This payment system account was not listed as default for any payee.<br><br>
<b>Note:</b> For each processing type the default payment system will be used if a payment system is not found by the routing rules.
<br>Refer to [471418/KB719598#heading4] to configure default payment system for the payee.',
      p_solution               => '',
      p_success_msg            => 'Data showing the payee(s) for which the Payment system is associated as default.<br>
<b>Note:</b> For each processing type the default payment system will be used if a payment system is not found by the routing rules.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_IBY_DEFAULT_BEP');



debug('begin add_signature: EBS_CRM_IBY_FCPP_DETAILS_CC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16053',
      p_sig_id                 => 'EBS_CRM_IBY_FCPP_DETAILS_CC',
      p_sig_sql                => 'Select 
ifsc.PAYMENT_SYSTEM_ID,
ifuc.BEP_ACCOUNT_ID,
ifsc.SYS_CC_PROFILE_CODE,
ifuc.USER_CC_PROFILE_CODE,
ifuc.ONLINE_AUTH_TRANS_CONFIG_ID,
ifsc.ONLINE_AUTH_FORMAT_CODE,
ifsc.ONLINE_AUTH_TRANS_PRTCL_CODE,
ifsc.ONLINE_AUTH_ACK_RDR_CODE,
ifuc.SETTLEMENT_TRANS_CONFIG_ID,
ifsc.SETTLEMENT_FORMAT_CODE,         
ifsc.SETTLEMENT_TRANS_PRTCL_CODE,    
ifsc.SETTLEMENT_ACK_RDR_CODE,   
ifuc.QUERY_TRANS_CONFIG_ID,
ifsc.QUERY_FORMAT_CODE,              
ifsc.QUERY_TRANS_PRTCL_CODE,         
ifsc.QUERY_ACK_RDR_CODE,
ifsc.PAYER_NOTIFICATION_FORMAT,
ifsc.PAYER_NOTIFICATION_DEL_METHOD
 From IBY_FNDCPT_USER_CC_PF_B ifuc, IBY_FNDCPT_SYS_CC_PF_B ifsc
  Where
    ifsc.SYS_CC_PROFILE_CODE = ifuc.SYS_CC_PROFILE_CODE  
    AND ifsc.PAYMENT_SYSTEM_ID in (##$$BEPID$$##)',
      p_title                  => 'Funds Capture Process Profile Details for Credit Card',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Funds Capture Process Profile was found with the payment system for credit card payment method.<br>
<br><b>Note:</b>This setup is required for payment system of type "Processor" and optional for "Gateway" type.<br><br>
 Refer to [471418/KB719598#heading3] to define Funds Capture Process Profile.',
      p_solution               => '',
      p_success_msg            => 'Data showing the Funds Capture Process Profile details of the  payment system for credit card payment method.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_IBY_FCPP_DETAILS_CC');



debug('begin add_signature: EBS_CRM_IBY_FCPP_DETAILS_EFT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16047',
      p_sig_id                 => 'EBS_CRM_IBY_FCPP_DETAILS_EFT',
      p_sig_sql                => 'Select 
    ifsc.PAYMENT_SYSTEM_ID,
    ifuc.BEP_ACCOUNT_ID,
    ifsc.SYS_EFT_PROFILE_CODE,
    ifuc.USER_EFT_PROFILE_CODE,
    ifsc.VERIFY_FORMAT_CODE,
    ifsc.VERIFY_TRANS_PRTCL_CODE,        
    ifsc.VERIFY_ACK_RDR_CODE,            
    ifsc.FUNDS_XFER_FORMAT_CODE,         
    ifsc.FUNDS_XFER_TRANS_PRTCL_CODE,    
    ifsc.FUNDS_XFER_ACK_RDR_CODE,        
    ifsc.QUERY_FORMAT_CODE,              
    ifsc.QUERY_TRANS_PRTCL_CODE,
    ifsc.QUERY_ACK_RDR_CODE, 
    ifsc.PAYER_NOTIFICATION_FORMAT,
    ifsc.PAYER_NOTIFICATION_DEL_METHOD
From
    IBY_FNDCPT_USER_EFT_PF_B ifuc,
    IBY_FNDCPT_SYS_EFT_PF_B ifsc
Where
    ifsc.SYS_EFT_PROFILE_CODE = ifuc.SYS_EFT_PROFILE_CODE  AND
    ifsc.PAYMENT_SYSTEM_ID in (##$$BEPID$$##)',
      p_title                  => 'Funds Capture Process Profile Details for Bank Account',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Funds Capture Process Profile was found with the payment system for Bank Account payment method.<br><br><b>Note:</b>This setup is required for payment system of type "Processor" and optional for "Gateway" type.<br><br>
Refer to [471418/KB719598#heading3] to define Funds Capture Process Profile.',
      p_solution               => '',
      p_success_msg            => 'Data showing the Funds Capture Process Profile details of the payment system for Bank Account payment method.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_IBY_FCPP_DETAILS_EFT');



debug('begin add_signature: EBS_CRM_IBY_PAYEE_DETAILS');
   l_info('##MASK##PAYEE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16205',
      p_sig_id                 => 'EBS_CRM_IBY_PAYEE_DETAILS',
      p_sig_sql                => 'select 
ip.name Payee_Name,
ip.payeeid,
ip.MPAYEEID,
...
ip.RISK_ENABLED,
ip.SUPPORTEDOP
 from iby_default_bep idb, iby_payee ip
    Where
      idb.mpayeeid = ip.mpayeeid and
      idb.bepid in (##$$BEPID$$##) 
     order by Payee_Name',
      p_title                  => 'Payees Associated with Payment System',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Payment system is not attached to any payee.',
      p_solution               => 'Attach payee to the payment system.<br> 
Refer to [471418/KB719598#heading4]: Oracle Payments Minimum/Dummy Setup For Direct Debit Funds Capture Processing.',
      p_success_msg            => 'Verified payment system is attached to a payee.<br>
Data showing details of payee(s) for which the payment system is associated as default.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_IBY_PAYEE_DETAILS');



debug('begin add_signature: EBS_CRM_IBY_PAYEE_OU');
   l_info('##MASK##PAYEE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16203',
      p_sig_id                 => 'EBS_CRM_IBY_PAYEE_OU',
      p_sig_sql                => 'Select 
ip.name Payee_Name,
ip.payeeid,
ip.MPAYEEID,
ifpa.ORG_ID
 from IBY_FNDCPT_PAYEE_APPL ifpa, iby_payee ip
    Where
      ip.mpayeeid = ifpa.mpayeeid and
      ip.mpayeeid in 
	(select ip2.mpayeeid 
	from iby_payee ip2, iby_default_bep idb2 
	where 
	idb2.mpayeeid = ip2.mpayeeid and
        idb2.bepid in (##$$BEPID$$##)) order by ifpa.org_id desc',
      p_title                  => 'Organization Details for Payees Associated with Payment System',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Either payee does not exist or no organization is associated with this payee.',
      p_solution               => 'Check the payee to ensure that an organization is attached.
Refer to [471418/KB719598#heading4]: Oracle Payments Minimum/Dummy Setup For Direct Debit Funds Capture Processing.',
      p_success_msg            => 'Data showing the operating unit(s) attached to the payee.
<ul>
     <li>Only payees that have payment system associated with them are shown.</li>
       <li>Please note that an operating unit can only be assigned to 1 payee.</li>
     </ul>',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_IBY_PAYEE_OU');



debug('begin add_signature: EBS_CRM_IBY_BATCH_TRXN_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16192',
      p_sig_id                 => 'EBS_CRM_IBY_BATCH_TRXN_DETAILS',
      p_sig_sql                => 'Select 
	iba.MBATCHID,
	iba.BATCHID,
	iba.BATCHSTATUS BATCH_STATUS,
	iba.BATCHTOTAL,
	itsa.TRXNMID,
	itsa.TRANSACTIONID,
	itsa.TANGIBLEID,
	...
	itsa.BEPID,
	itsa.ECAPPID,
	itsa.PAYMENTMETHODNAME,
	itsa.AMOUNT,
	itsa.TRXNTYPEID,
	itsa.REQTYPE,
	itsa.STATUS TRXN_STATUS,
	itsa.BEPCODE,
	itsa.BEPMESSAGE,
	itsa.INSTRTYPE,
	itsa.BEPKEY,
	itsa.INSTRSUBTYPE,
	itsa.TRXNREF,
	itsa.INSTRNUM_SEC_SEGMENT_ID,
	itsa.PROCESS_PROFILE_CODE,
	itsa.INITIATOR_EXTENSION_ID
     From 
       	IBY_BATCHES_ALL iba,
		IBY_TRXN_SUMMARIES_ALL ITSA
     Where 
  		iba.mbatchid = itsa.mbatchid AND	
           iba.mbatchid in (##$$MBATCHID$$##)
order by itsa.TRXNMID',
      p_title                  => 'Settlement Batch Transaction Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found for provided batchid.',
      p_solution               => '',
      p_success_msg            => 'Data showing the transaction level data for settlement batchid.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_IBY_BATCH_TRXN_DETAILS');



debug('begin add_signature: EBS_CRM_IBY_BATCH_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16191',
      p_sig_id                 => 'EBS_CRM_IBY_BATCH_DETAILS',
      p_sig_sql                => 'Select 
MBATCHID,
BATCHID,
PAYEEID,
...
from IBY_BATCHES_ALL
Where mbatchid in (##$$MBATCHID$$##)',
      p_title                  => 'Settlement Batch Details',
      p_fail_condition         => '[BATCHSTATUS] = [1]',
      p_problem_descr          => 'No data found for provided batchid from table IBY_BATCHES_ALL. ',
      p_solution               => 'Please review, What is the expected Receipt status when a Settlement fails in IBY (Oracle Payments)? [1262649/KB465324]',
      p_success_msg            => 'Data showing for the settlement batchid from table IBY_BATCHES_ALL.<br>
Refer to [2254782/KB726659#heading5] for details of the different statuses that take place during execution.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_IBY_BATCH_DETAILS');



debug('begin add_signature: EBS_CRM_IBY_TRXN_EXTN_DETAILS');
   l_info('##MASK##VOICE_AUTHORIZATION_CODE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16177',
      p_sig_id                 => 'EBS_CRM_IBY_TRXN_EXTN_DETAILS',
      p_sig_sql                => 'Select 
TRXN_EXTENSION_ID,
...
from IBY_FNDCPT_TX_EXTENSIONS
 ...
 (Select TRXN_EXTENSION_ID 
   From IBY_FNDCPT_TX_OPERATIONS Where transactionid in (##$$TRXNID$$##))',
      p_title                  => 'Transaction Extension Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found for the provided Tangible ID from table IBY_FNDCPT_TX_EXTENSIONS.',
      p_solution               => '',
      p_success_msg            => 'Data showing the payment transaction extension details for the provided Tangible ID from table IBY_FNDCPT_TX_EXTENSIONS.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_IBY_TRXN_EXTN_DETAILS');



debug('begin add_signature: EBS_CRM_IBY_TRXN_OPERATIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16178',
      p_sig_id                 => 'EBS_CRM_IBY_TRXN_OPERATIONS',
      p_sig_sql                => 'Select *
from IBY_FNDCPT_TX_OPERATIONS
Where transactionid in (##$$TRXNID$$##)',
      p_title                  => 'Transaction Operation Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found for the provided Tangible ID from table IBY_FNDCPT_TX_OPERATIONS.',
      p_solution               => '',
      p_success_msg            => 'Data showing the payment transaction operation details for the provided Tangible ID from table IBY_FNDCPT_TX_OPERATIONS.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_IBY_TRXN_OPERATIONS');



debug('begin add_signature: EBS_CRM_IBY_TRXN_DETAILS');
   l_info('##MASK##BEPKEY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16176',
      p_sig_id                 => 'EBS_CRM_IBY_TRXN_DETAILS',
      p_sig_sql                => 'Select 
TRXNMID,
TRANSACTIONID,
TANGIBLEID,
...
from IBY_TRXN_SUMMARIES_ALL
Where transactionid in (##$$TRXNID$$##)',
      p_title                  => 'Transaction Summaries Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found for the provided Tangible ID from table IBY_TRXN_SUMMARIES_ALL.',
      p_solution               => '',
      p_success_msg            => 'Data showing the payment transaction details for Tangible ID from table IBY_TRXN_SUMMARIES_ALL.<br>
Refer to [2254782/KB726659#heading5] for details of the different statuses that take place during execution.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_IBY_TRXN_DETAILS');



debug('begin add_signature: EBS_CRM_IBY_TRXN_CORE');
   l_info('##MASK##AUTHCODE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##REFERENCECODE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16173',
      p_sig_id                 => 'EBS_CRM_IBY_TRXN_CORE',
      p_sig_sql                => 'Select 
TRXNMID,
AUTHTYPE,
AUTHCODE,
...
LAST_UPDATE_DATE
 from iby_trxn_core
where trxnmid in 
(select trxnmid from iby_trxn_summaries_all 
where transactionid in (##$$TRXNID$$##))',
      p_title                  => 'Transaction Core Authorization Details ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found for provided Tangible ID from table IBY_TRXN_CORE.',
      p_solution               => '',
      p_success_msg            => 'Data showing details for Tangible ID from table IBY_TRXN_CORE.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_IBY_TRXN_CORE');



debug('begin add_signature: EBS_CRM_IBY_VOICEAUTH_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16175',
      p_sig_id                 => 'EBS_CRM_IBY_VOICEAUTH_DETAILS',
      p_sig_sql                => 'Select TRXNMID, VOICEAUTHFLAG voiceauth, date_of_voice_authorization
from iby_trxn_core
where trxnmid in 
(select trxnmid from iby_trxn_summaries_all 
where transactionid in (##$$TRXNID$$##)
and REQTYPE=''ORAPMTREQ'')',
      p_title                  => 'Voice Authorization Flag',
      p_fail_condition         => '[voiceauth] = [Y]',
      p_problem_descr          => 'Provided Tangible ID is a Voice Authorization transaction.',
      p_solution               => '',
      p_success_msg            => 'Provided Tangible ID is not a Voice Authorization transaction.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_IBY_VOICEAUTH_DETAILS');



debug('begin add_signature: EBS_CRM_IBY_TRXN_EXT_AUTHS_V');
   l_info('##MASK##AUTHORIZATION_CODE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16179',
      p_sig_id                 => 'EBS_CRM_IBY_TRXN_EXT_AUTHS_V',
      p_sig_sql                => 'Select 
TRXN_EXTENSION_ID,
PAYMENT_CHANNEL_CODE,
...
INITIATOR_EXTENSION_ID,
REVERSAL_ALLOWED,
CAPTURE_EX_AUTH_ALLOWED
 from IBY_TRXN_EXT_AUTHS_V
Where AUTHORIZATION_ID in (##$$TRXNID$$##)
Order by authorization_id asc',
      p_title                  => 'Transaction Data From View IBY_TRXN_EXT_AUTHS_V ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found for the provided Tangible ID from view IBY_TRXN_EXT_AUTHS_V.',
      p_solution               => '',
      p_success_msg            => 'Data showing details for the provided Tangible ID from view IBY_TRXN_EXT_AUTHS_V.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_IBY_TRXN_EXT_AUTHS_V');



debug('begin add_signature: EBS_IBY_TRXN_SUMMARIES_ALL_PAYMENT_CHANNEL_CODE_NULL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22635',
      p_sig_id                 => 'EBS_IBY_TRXN_SUMMARIES_ALL_PAYMENT_CHANNEL_CODE_NULL',
      p_sig_sql                => 'select TANGIBLEID from iby_trxn_summaries_all where status = 1 and REQTYPE = ''ORAPMTCAPTURE'' and PAYMENT_CHANNEL_CODE IS NULL ',
      p_title                  => 'Capture transactions previously failed with a communication error',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'When running the Submit Offline Transactions program, some capture transactions may have previously failed with a communication error (status 1).
If version of file CreditCardProcessor.java is lower than 120.41.12020000.7 this may cause an error.',
      p_solution               => '<p>To resolve the issue, please follow [2853034/KB312153] Submit Offline Transactions program is failing on random basis with error: The credit or request operation that is being re-attempted is using a different payment system identifier.</p>',
      p_success_msg            => 'There are no ORAPMTCAPTURE transactions where PAYMENT_CHANNEL_CODE is NULL.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_IBY_TRXN_SUMMARIES_ALL_PAYMENT_CHANNEL_CODE_NULL');



debug('begin add_signature: EBS_CRM_SM_IBY_IBYFC_EBS_IBY_BEP_ACCT_OPT_VALS_ACCOUNT_OPTION_VALUE_NULL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23882',
      p_sig_id                 => 'EBS_CRM_SM_IBY_IBYFC_EBS_IBY_BEP_ACCT_OPT_VALS_ACCOUNT_OPTION_VALUE_NULL',
      p_sig_sql                => 'select  vals.account_option_value
 from  iby_trxn_summaries_all ts
       ,iby_bepkeys keys
       ,iby_bep_acct_opt_vals vals
       ,iby_payee payee
where  ts.transactionid in (##$$TRXNID$$##)
  ...
  and  vals.account_option_code = ''SEPA_INITIATING_PARTY_ID''
  and  ts.REQTYPE in (''ORAPMTBATCHREQ'',''ORAPMTEFTCLOSEBATCH'')
  and  vals.account_option_value is NULL',
      p_title                  => 'Payment System Account Option Value for SEPA Initiating Party ID',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Parameter SEPA_INITIATING_PARTY_ID was not defined for Tangible ID ##$$TANGIBLEID$$##',
      p_solution               => '<p>To resolve the issue, please follow [1539198/KB366967] Create Settlement Batches For SEPA Transaction Fails With: Initiating Party ID Is Required.</p>',
      p_success_msg            => 'Data showing an Initiating Party ID for Tangible ID ##$$TANGIBLEID$$##.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_IBY_IBYFC_EBS_IBY_BEP_ACCT_OPT_VALS_ACCOUNT_OPTION_VALUE_NULL');



debug('begin add_signature: EBS_CRM_IBY_DUP_BAN');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##MASKED_BANK_ACCOUNT_NUM'):= ',#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '16172',
      p_sig_id                 => 'EBS_CRM_IBY_DUP_BAN',
...
',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Duplicate bank account(s) found.',
      p_solution               => 'Refer to [1265353/KB627120]: R12: Generic Data Fix (GDF): Duplicate bank accounts in IBY_EXT_BANK_ACCOUNTS for data fix.',
      p_success_msg            => 'No duplicate bank account found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_IBY_DUP_BAN');



debug('begin add_signature: EBS_CRM_IBY_ORPH_BANK_ACC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16183',
      p_sig_id                 => 'EBS_CRM_IBY_ORPH_BANK_ACC',
      p_sig_sql                => 'SELECT ext_bank_account_id,masked_bank_account_num
     ...
     AND   NOT EXISTS (
      ...
      p_title                  => 'Orphan Bank Accounts Without Owner',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found bank accounts that have no owner, no assignments or are not upgraded. This will prevent external bank account from being recreated.',
      p_solution               => 'Refer to [1370214/KB689127]: R12: AP: Generic Data Fix (GDF) Patch For Orphan Bank Accounts.',
      p_success_msg            => 'No orphan bank accounts records were found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_IBY_ORPH_BANK_ACC');



debug('begin add_signature: EBS_CRM_ORPH_BANK_ACC_ASSIGN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16204',
      p_sig_id                 => 'EBS_CRM_ORPH_BANK_ACC_ASSIGN',
      ...
      p_title                  => 'Cash Management Orphan Bank Account Assignments',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found Cash Management(CE) orphan bank account assignments.',
      p_solution               => 'Refer to  [1370214/KB689127] : R12: AP: Generic Data Fix (GDF) Patch For Orphan Bank Accounts for data fix.',
      p_success_msg            => 'No Cash Management(CE) orphan bank account assignments were found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_ORPH_BANK_ACC_ASSIGN');



debug('begin add_signature: EBS_CRM_DUP_PRIMRY_ACC_OWNER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16196',
      p_sig_id                 => 'EBS_CRM_DUP_PRIMRY_ACC_OWNER',
	...
	WHERE ext_bank_account_id IN(SELECT ext_Bank_account_id 
		...
		HAVING count(*) >1)
	AND primary_flag=''Y''',
      p_title                  => 'Duplicate Primary Account Owner',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found duplicate primary account owners in table IBY_ACCOUNT_OWNERS.<br>
Bank accounts are shown duplicate in Supplier -> Entry -> Banking Details screen.',
      p_solution               => 'Please review the duplicate account owner records found. 
Refer to  [1370214/KB689127] : R12: AP: Generic Data Fix (GDF) Patch For Orphan Bank Accounts for data fix.',
      p_success_msg            => 'No duplicate primary account owner records were found in table IBY_ACCOUNT_OWNERS.<br>
Refer to: [1370214/KB689127] : R12 Generic Data Fix (GDF) Patch for Orphan Bank Accounts.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_DUP_PRIMRY_ACC_OWNER');



debug('begin add_signature: EBS_CRM_IBY_ORPH_ASSIGNMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16184',
      p_sig_id                 => 'EBS_CRM_IBY_ORPH_ASSIGNMENTS',
      p_sig_sql                => 'SELECT actown.ext_bank_account_id,
                   ibypye.ext_payee_id,
		   ibypye.payee_party_id,
		   actown.account_owner_party_id,
		   ...
		   AND NOT EXISTS ( SELECT 1
				   ...
				   WHERE ext_pmt_party_id = ibypye.ext_payee_id
				   AND instrument_id      = actown.ext_bank_account_id)',
      p_title                  => 'Account Receivables Orphan Bank Account Assignments',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found Account Receivables orphan bank account assignments.',
      p_solution               => 'Refer to  [1370214/KB689127]: R12: AP: Generic Data Fix (GDF) Patch For Orphan Bank Accounts.',
      p_success_msg            => 'No Account Receivables orphan bank account assignments were found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_IBY_ORPH_ASSIGNMENTS');



debug('begin add_signature: EBS_CRM_SM_IBY_IBYFC_EBS_IBY_TRXN_SUMMARIES_ALL_BEPKEY_MISMATCH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27990',
      p_sig_id                 => 'EBS_CRM_SM_IBY_IBYFC_EBS_IBY_TRXN_SUMMARIES_ALL_BEPKEY_MISMATCH',
      p_sig_sql                => 'select TS.BEPKEY, TS.PROCESS_PROFILE_CODE
from iby_trxn_summaries_all ts
where ts.status = 100 and ts.REQTYPE = ''ORAPMTBATCHREQ''
and ts.BEPKEY <>
  (select tx.BEPKEY from iby_trxn_summaries_all tx
   where tx.transactionid = ts.transactionid and 
         tx.STATUS = 0 and
         tx.REQTYPE = ''ORAPMTREQ'')',
      p_title                  => 'Inconsistency Found Between the BEPKEY Used for Authorization and the One Used for Settlement',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The authorization was successfully approved with a specific BepKey and Process Profile Code, while the settlement record used a different BepKey and Process Profile Code.',
      p_solution               => 'Verify the Prior Required Verified option is activated for Settlements. This ensures the BEPKEY from the settlements record will match the value stamped to the authorization record.<br>
Refer to [2279921/KB547486]: Settlements Are Routed To Wrong Process Profile And Bepkey.',
      p_success_msg            => 'No inconsistency was found between the authorization and settlement records.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_SM_IBY_IBYFC_EBS_IBY_TRXN_SUMMARIES_ALL_BEPKEY_MISMATCH');



debug('begin add_signature: EBS_CRM_IBY_PROFILES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16061',
      p_sig_id                 => 'EBS_CRM_IBY_PROFILES',
      p_sig_sql                => 'SELECT SUBSTR(e.profile_option_name,1,25) PROFILE, 
decode(a.level_id,10001,''Site'',10002,
''Application'',10003,
''Resp'',10004,''User'') Level_type, 
decode(a.level_id,10001,''Site'',10002,c.application_short_name, 
10003,b.responsibility_name,10004,d.user_name) level_value,
...
fnd_profile_options e
WHERE e.profile_option_name IN 
(''IBY_ECAPP_URL'',''IBY_HTTP_PROXY'',''IBY_NOPROXY_DOMAIN'',''ICX_PAY_SERVER'',''IBY_ECAPP_URL'',''IBY_WALLET_LOCATION'',''IBY_WALLET_PASSWD'',''FND_DB_WALLET_DIR'',''IBY_NETWORK_TIMEOUT'',''IBY_ECAPP_SEC_FORCE'',''IBY_JAVA_XML_LOG'',''IBY_XDO_DELIVERY_CFG_FILE'')
AND e.profile_option_id = a.profile_option_id(+)
AND a.level_value = b.responsibility_id (+)
AND a.level_value = c.application_id (+) 
AND a.level_value = d.user_id (+)
ORDER BY profile_option_name',
      p_title                  => 'IBY Related Important Profile Settings',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No profile has been set.',
      p_solution               => 'Listing profiles that are relevant to Payments Funds Capture.',
      p_success_msg            => 'Listing profiles that are relevant to Payments Funds Capture.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_CRM_IBY_PROFILES');
...
BEGIN
  ...
  analyzer_title := 'Payments (IBY) Funds Capture Analyzer';
  ...
  l_step := '15';
   validate_parameters(
    ...
    ,p_receipt_number               => UPPER(p_receipt_number)
...
start_section('Proactive and Preventative Recommendations', 'Proactive_and_Preventative_Recommendations');
   set_item_result(run_stored_sig('VERIFY_IBY_HTTP_PROXY'));
   set_item_result(run_stored_sig('EBS_CRM_IBY_NETWORK_TIMEOUT'));
   set_item_result(run_stored_sig('EBS_CRM_IBY_ECAPP_SEC_FORCE'));
   set_item_result(run_stored_sig('EBS_CRM_IBY_ENCRYPT_DATA'));
   set_item_result(check_rec_patches_1); /* Signature EBS_CRM_IBY_REC_PATCHES */
end_section;
debug('end section: Proactive_and_Preventative_Recommendations');

debug('begin section: Payment_System_Details');
start_section('Payment System Details', 'Payment_System_Details');
   set_item_result(run_stored_sig('EBS_CRM_IBY_BEP_DETAILS'));
   set_item_result(run_stored_sig('EBS_CRM_IBY_BEP_ACCT'));
   set_item_result(run_stored_sig('EBS_CRM_IBY_BEP_ACCT_DETAILS'));
   set_item_result(run_stored_sig('EBS_CRM_IBY_BEP_FORMATS'));
   set_item_result(run_stored_sig('EBS_CRM_IBY_TRANS_CONFIG'));
   set_item_result(run_stored_sig('EBS_CRM_IBY_TRANS_CONFIG_VAL'));
   set_item_result(run_stored_sig('EBS_CRM_IBY_TRANS_PROT'));
   set_item_result(run_stored_sig('EBS_CRM_IBY_DEFAULT_BEP'));
   set_item_result(run_stored_sig('EBS_CRM_IBY_FCPP_DETAILS_CC'));
   set_item_result(run_stored_sig('EBS_CRM_IBY_FCPP_DETAILS_EFT'));
end_section;
debug('end section: Payment_System_Details');

debug('begin section: Payee_Details');
start_section('Payee Setup Details', 'Payee_Details');
   set_item_result(run_stored_sig('EBS_CRM_IBY_PAYEE_DETAILS'));
   set_item_result(run_stored_sig('EBS_CRM_IBY_PAYEE_OU'));
end_section;
debug('end section: Payee_Details');

debug('begin section: Settlement_Batch_Details');
IF nvl(g_sql_tokens('##$$MBATCHID$$##'),'no batchid') <> 'no batchid' THEN
   start_section('Settlement Batch Details', 'Settlement_Batch_Details');
      set_item_result(run_stored_sig('EBS_CRM_IBY_BATCH_TRXN_DETAILS'));
      set_item_result(run_stored_sig('EBS_CRM_IBY_BATCH_DETAILS'));
   end_section;
END IF;
debug('end section: Settlement_Batch_Details');

debug('begin section: IBY_Transaction_Details');
IF nvl(g_sql_tokens('##$$TRXNID$$##'),'no transaction') <> 'no transaction' THEN
   start_section('IBY Transactions Details', 'IBY_Transaction_Details');
      set_item_result(run_stored_sig('EBS_CRM_IBY_TRXN_EXTN_DETAILS'));
      set_item_result(run_stored_sig('EBS_CRM_IBY_TRXN_OPERATIONS'));
      set_item_result(run_stored_sig('EBS_CRM_IBY_TRXN_DETAILS'));
      set_item_result(run_stored_sig('EBS_CRM_IBY_TRXN_CORE'));
      set_item_result(run_stored_sig('EBS_CRM_IBY_VOICEAUTH_DETAILS'));
      set_item_result(run_stored_sig('EBS_CRM_IBY_TRXN_EXT_AUTHS_V'));
      set_item_result(run_stored_sig('EBS_IBY_TRXN_SUMMARIES_ALL_PAYMENT_CHANNEL_CODE_NULL'));
      set_item_result(run_stored_sig('EBS_CRM_SM_IBY_IBYFC_EBS_IBY_BEP_ACCT_OPT_VALS_ACCOUNT_OPTION_VALUE_NULL'));
   end_section;
END IF;
debug('end section: IBY_Transaction_Details');

debug('begin section: Data_Corruption_Issues');
start_section('Data Corruption Issues', 'Data_Corruption_Issues');
   set_item_result(run_stored_sig('EBS_CRM_IBY_DUP_BAN'));
   set_item_result(run_stored_sig('EBS_CRM_IBY_ORPH_BANK_ACC'));
   set_item_result(run_stored_sig('EBS_CRM_ORPH_BANK_ACC_ASSIGN'));
   set_item_result(run_stored_sig('EBS_CRM_DUP_PRIMRY_ACC_OWNER'));
   set_item_result(run_stored_sig('EBS_CRM_IBY_ORPH_ASSIGNMENTS'));
   set_item_result(run_stored_sig('EBS_CRM_SM_IBY_IBYFC_EBS_IBY_TRXN_SUMMARIES_ALL_BEPKEY_MISMATCH'));
end_section;
debug('end section: Data_Corruption_Issues');

debug('begin section: AppsCheck');
start_section('Diagnostics: Apps Check', 'AppsCheck');
   set_item_result(run_stored_sig('EBS_CRM_IBY_PROFILES'));
