...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Channel Revenue Management (ChRM) SLA  |
REM | Unprocessed Transactions Analyzer                                         |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE ozf_sla_trx_analyzer_pkg AUTHID DEFINER AS
...
END ozf_sla_trx_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY ozf_sla_trx_analyzer_pkg AS
-- $Id: ozf_sla_unprocessed_trx_analyzer.sql, 200.23 2026/01/28 16:19:17 svedula Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2058083.1));
...
----------------------------------------------------------------
g_req_start_date DATE;
g_event_date_start DATE;
g_slam_start_date DATE;
g_gl_start_date DATE;
g_accounting_date DATE;
g_accounting_date_95325 DATE;
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'OZFSLA_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'OZFSLA_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>OZFSLA Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2058083.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/ozf_sla_Latest_Version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,283,EBS,EBS CRM,EBS - Sales/Marketing" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,283,EBS,EBS CRM,EBS - Sales/Marketing" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},283,EBS,EBS CRM,EBS - Sales/Marketing" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/3878063" class="blacklink" target="new">
...
<p>Version 200.15 26-SEP-2024</p><ul><li>Signature updates</li>
</ul>
<p>&nbsp;</p><p>Version 200.20 17-JUL-2024</p><ul><li>Signature updates</li>
</ul>
<p>&nbsp;</p><p>Version 200.18:</p><ul><li>Added new signature: Sequences Reaching Maximum Value</li>
</ul>
<p>Version 200.17:</p><ul><li>Add section &apos;Diagnostics: Apps Check&apos;</li>
<li>Framework update</li>
</ul>
<p>Version 200.16:</p><ul><li>Analyzer Framework 4.6.0.1 version released.</li>
</ul>
<p>Version 200.15:</p><ul><li>Analyzer Framework 4.5.9.1 version released.</li>
<li>Added Doc ID 2860870.1 as a solution for Unprocessed events.</li>
</ul>
<p>Version 200.14:</p><ul><li>Lifetime Support Policy: Premier Support for R12.1.3 customers updated.</li>
</ul>
<p>Version 200.13:</p><ol><li>Modified signature for SLAM Start Date</li>
<li>Lifetime Support Policy</li>
...
<p>Version 200.22</p><ul><li>Signature AC_TABLE_INDEXES has been updated</li>
<li>Signature EBS_ATG_UGLE_SEQUENCES_CLOSE_TO_MAXIMUM_VALUE has been updated</li>
</ul>
<p>Version 200.23</p><ul><li>Signature PREMIER_SUPPORT signatures updated</li>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,283,'||p_sig.sigrepo_id||',EBS,EBS CRM,EBS - Sales/Marketing" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,283,'||p_sig.sigrepo_id||',EBS,EBS CRM,EBS - Sales/Marketing" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},283,'||p_sig.sigrepo_id||',EBS,EBS CRM,EBS - Sales/Marketing" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
BEGIN
    ...
    print_log('Processing recommended patches signature: OZF_REC_PATCHES (check_rec_patches_1) "Recommended Patches" (version 6)');
...
IF substr(g_rep_info('Apps Version'),1,6) = '12.2.4' THEN
   ...
   l_col_rows(1)(l_rows) := '24582992';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Channel Revenue Management Recommended Patch Collection (SEP-1-2016)';
...
IF substr(g_rep_info('Apps Version'),1,6) = '12.1.3' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '22499955';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Channel Revenue Management Recommended Patch Collection (Jan. 2016)';
...
END IF;
   ...
   l_sig.solution := 'Above are the recommended patches for this product area.<br>
<br>
...
';
  ...
  -- Register
  l_step := '60';
  g_signatures('OZF_REC_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'OZF_REC_PATCHES',     -- sig ID
...
debug('begin populate parameters hash table');
   ...
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_end_date,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/01/28 16:19:16 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'ozf_sla_unprocessed_trx_analyzer.sql';
...
INTO l_exists_val
FROM GL_LEDGERS G
WHERE G.LEDGER_ID = p_ledger_id and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Ledger id');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
-- Get max request start date for Subledger Accounting program
BEGIN
   SELECT max(actual_start_date)
   INTO g_req_start_date
   FROM FND_CONCURRENT_REQUESTS fcr, FND_CONCURRENT_PROGRAMS fcp
   WHERE fcr.concurrent_program_id = fcp.concurrent_program_id  
   AND fcp.concurrent_program_name = 'OZFSLAAP';
EXCEPTION WHEN NO_DATA_FOUND THEN
   BEGIN
      SELECT sysdate - 365
      INTO g_req_start_date
...
-- Get first event date for any unprocessed event
BEGIN
   SELECT min(event_date)
   INTO g_event_date_start
   FROM xla_events xe
...
-- Get SLAM start date active 
BEGIN
   SELECT start_date_active
   INTO g_slam_start_date
...
-- Get first day of earliest open GL period for ledger
BEGIN
   SELECT MIN(start_date) "Start Date"
   INTO g_gl_start_date
   FROM   gl_period_statuses a, ozf_sys_parameters_all b
...
-- Get first accounting date for unprocessed events
BEGIN
...
-- Get first accounting date for unprocessed events with 95325 error
BEGIN
   SELECT min(xe.event_date) 
   INTO g_accounting_date_95325
   FROM xla_events xe, XLA_ACCOUNTING_ERRORS xae
   WHERE xe.event_id = xae.event_id 
   and xe.application_id =682
   and xe.event_date <= p_end_date
   and event_status_code   <> 'P'
   and process_status_code <> 'P'
...
debug('begin populate sql tokens hash table');
   ...
   g_sql_tokens('##$$end_date$$##') := p_end_date;
   g_masked_tokens('##$$end_date$$##') := mask_text( g_sql_tokens('##$$end_date$$##'), 'NO_MASK');
   g_sql_tokens('##$$REQ_START_DATE$$##') := g_req_start_date;
   g_masked_tokens('##$$REQ_START_DATE$$##') := mask_text( g_sql_tokens('##$$REQ_START_DATE$$##'), 'NO_MASK');
   g_sql_tokens('##$$EVENT_START_DATE$$##') := g_event_date_start;
   g_masked_tokens('##$$EVENT_START_DATE$$##') := mask_text( g_sql_tokens('##$$EVENT_START_DATE$$##'), 'NO_MASK');
   g_sql_tokens('##$$slam_start_date$$##') := g_slam_start_date;
   g_masked_tokens('##$$slam_start_date$$##') := mask_text( g_sql_tokens('##$$slam_start_date$$##'), 'NO_MASK');
   g_sql_tokens('##$$gl_start_date$$##') := g_gl_start_date;
   g_masked_tokens('##$$gl_start_date$$##') := mask_text( g_sql_tokens('##$$gl_start_date$$##'), 'NO_MASK');
   g_sql_tokens('##$$accounting_date$$##') := g_accounting_date;
   g_masked_tokens('##$$accounting_date$$##') := mask_text( g_sql_tokens('##$$accounting_date$$##'), 'NO_MASK');
   g_sql_tokens('##$$accounting_date_95325$$##') := g_accounting_date_95325;
   g_masked_tokens('##$$accounting_date_95325$$##') := mask_text( g_sql_tokens('##$$accounting_date_95325$$##'), 'NO_MASK');
...
debug('begin add_signature: OZF_INVALIDS');
   l_info('##MASK##TEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '846',
      p_sig_id                 => 'OZF_INVALIDS',
      p_sig_sql                => 'SELECT a.object_name,
        ...
        AND a.owner = ''APPS''
        AND a.object_name like ''OZF%''
        AND a.status = ''INVALID''',
      p_title                  => 'Channel Revenue Management Related Invalid Objects',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are Channel Revenue Management related invalid objects.',
...
- Review any error messages provided<br>
- Recompile the individual objects manually or recompile the entire APPS schema with adadmin utility<br>
- If you still have invalid objects, please review steps from [1325394/KB401905] Troubleshooting Guide - Invalid Objects in the E-Business Suite Environment 11i and 12',
      p_success_msg            => 'No Channel Revenue Management related invalid objects exists in the database.',
   ...
   l_info.delete;
debug('end add_signature: OZF_INVALIDS');
...
debug('begin add_signature: OZF_SLA_CONCURRENT_REQ_NOT RUN');
   l_info('##MASK##ARGUMENT_TEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMPLETION_TEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '848',
      p_sig_id                 => 'OZF_SLA_CONCURRENT_REQ_NOT RUN',
      p_sig_sql                => 'SELECT fcpt.user_concurrent_program_name, fcp.CONCURRENT_PROGRAM_NAME, fcr.COMPLETION_TEXT, fcr.REQUEST_ID, fcr.ACTUAL_START_DATE, fcr.ACTUAL_COMPLETION_DATE,   fcr.status_code, fcr.phase_code, fcr.outfile_name, fcr.logfile_name, fcr.argument_text, fcr.parent_request_id, fcr.LAST_UPDATE_DATE,   fcr.REQUESTED_BY, fcr.RESPONSIBILITY_ID, fcr.concurrent_program_id
FROM FND_CONCURRENT_REQUESTS fcr, FND_CONCURRENT_PROGRAMS fcp, FND_CONCURRENT_PROGRAMS_TL fcpt
WHERE fcr.concurrent_program_id = fcp.concurrent_program_id  
AND fcr.concurrent_program_id = fcpt.concurrent_program_id
AND fcp.concurrent_program_name = ''OZFSLAAP''
and fcr.actual_start_date > sysdate - 30
ORDER BY fcr.request_id',
      p_title                  => 'SLA Concurrent Requests',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Subledger Accounting Program has not run in the last 30 days for Channel Revenue Management.  ',
      p_solution               => '<p>From Release 12.1.3 Channel Revenue Management has been redesigned to run SubLedger Accounting Program which in turn calls Create Accounting & Accounting Programs.  The Create Accounting Program should not be run directly in Trade Management but submitted via running the Subledger Accounting Program.   Different applications have different requirements.</p>
<p>Run the Subledger Accounting Program Concurrent Request.</p>
<p>
<b>Responsibility:</b> Oracle Trade Management Administrator<br>
<b>Navigation:</b> Concurrent Requests > Run<br>
Query and submit concurrent request Subledger Accounting Program<br>
</p>
<p>Review [2055417/KB766352] How to Run the Subledger Accounting Program for Channel Revenue Management (ChRM) for more information.</p>',
      p_success_msg            => 'Subledger Accounting Program has been run in the last 30 days for Channel Revenue Management.',
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_CONCURRENT_REQ_NOT RUN');



debug('begin add_signature: OZF_SLA_CONCURRENT_REQ_CREATE_WARNING');
   l_info('##MASK##ARGUMENT_TEX'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMPLETION_TEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1140',
      p_sig_id                 => 'OZF_SLA_CONCURRENT_REQ_CREATE_WARNING',
      p_sig_sql                => 'SELECT fcpt.user_concurrent_program_name, fcp.CONCURRENT_PROGRAM_NAME, fcr.COMPLETION_TEXT, fcr.REQUEST_ID, fcr.ACTUAL_START_DATE, fcr.ACTUAL_COMPLETION_DATE,   fcr.status_code, fcr.phase_code, fcr.outfile_name, fcr.logfile_name, fcr.argument_text, fcr.parent_request_id, fcr.LAST_UPDATE_DATE,   fcr.REQUESTED_BY, fcr.RESPONSIBILITY_ID, fcr.concurrent_program_id
FROM FND_CONCURRENT_REQUESTS fcr, FND_CONCURRENT_PROGRAMS fcp, FND_CONCURRENT_PROGRAMS_TL fcpt
WHERE fcr.concurrent_program_id = fcp.concurrent_program_id  
AND fcr.concurrent_program_id = fcpt.concurrent_program_id
AND fcp.concurrent_program_name in (''OZFSLAAP'', ''XLAACCPB'',''XLAACCUP'')
and fcr.actual_start_date >= ''##$$REQ_START_DATE$$##''
and fcr.status_code <> ''C''
ORDER BY fcr.request_id',
      p_title                  => 'Subledger Accounting Programs Ended in Warning or Error',
      p_fail_condition         => '[status_code] <> [C]',
      p_problem_descr          => 'The Last run of the Subledger Accounting Programs completed with warnings or in error.<br>
Refer [152209/FAQ5014] (Concurrent Processing - What are the Meaning of the Codes in the STATUS_CODE and PHASE_CODE Columns of FND_CONCURRENT_REQUESTS Table?) for meanings of Status_code and Phase_Code columns.',
      p_solution               => '<p>Review the "Unprocessed Records Summary" and "Accounting Errors" section and use given solutions to resolve the errors for these records.</P>
<p>Once errors are resolved, re-run the Subledger Accounting Program Concurrent Request.<br>
<br>
<b>Responsibility:</b> Oracle Trade Management Administrator<br>
<b>Navigation:</b> Concurrent Requests > Run<br>
Query and submit concurrent request Subledger Accounting Program<br>
</p>
<p>Refer [2055417/KB766352] How to Run the Subledger Accounting Program for Channel Revenue Management (ChRM)</p>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_CONCURRENT_REQ_CREATE_WARNING');



debug('begin add_signature: OZF_SLA_EVENT_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '852',
      p_sig_id                 => 'OZF_SLA_EVENT_DETAILS',
      p_sig_sql                => 'select event_type_code Event_Code, count(*) "Number of Records", event_status_code Event_Status,       
process_status_code Process_Status
from xla_events 
       where application_id = 682
       and event_date <= ''##$$end_date$$##''
       and event_status_code <> ''P''
       and process_status_code <> ''P'' 
       group by event_type_code, process_status_code, 
       event_status_code',
      p_title                  => 'Number of Unprocessed Records by Event Code',
      p_fail_condition         => '[Process_Status] <> [P]',
      p_problem_descr          => 'Unprocessed Records exist.',
      p_solution               => '<p><b>Unprocessed Records with Process_Status of E (Error) or I (Invalid):</b><br>
These records have completed in error and will have a record in the XLA_ACCOUNTING_ERRORS table with details. Review the "Accounting Errors" section and use given solutions to resolve the errors for these records.
</P>
<p><b>Unprocessed Records with Process_Status of U (Unprocessed):</b><br>
These records have not be processed. Run the Subledger Accounting Program Concurrent Request.<br>
<br>
<b>Responsibility:</b> Oracle Trade Management Administrator<br>
<b>Navigation:</b> Concurrent Requests > Run<br>
Query and submit concurrent request Subledger Accounting Program<br>
...
<p>Refer [2055417/KB766352] How to Run the Subledger Accounting Program for Channel Revenue Management (ChRM)</p>
<p><b>If after running Create Accounting, these transactions are still Unprocessed, please refer to [2860870/KB757316] Claim Events Not Being Processed Create Accounting For Closed Claims</b></p>',
      p_success_msg            => 'There are no unprocessed records.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_EVENT_DETAILS');



debug('begin add_signature: OZF_SLA_UNPROCESSED_ERROR_SUMMARY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '982',
      p_sig_id                 => 'OZF_SLA_UNPROCESSED_ERROR_SUMMARY',
      p_sig_sql                => 'SELECT count (*) "Number of Records", xe.event_type_code, xe.event_status_code, xe.process_status_code, xae.message_number Message_Number, xae.encoded_msg 
FROM xla_events xe, XLA_ACCOUNTING_ERRORS xae
WHERE xe.event_id = xae.event_id 
and xe.application_id =682
and xe.event_date <= ''##$$end_date$$##''
and event_status_code   <> ''P''
and process_status_code <> ''P''
group by xe.event_type_code, xae.message_number, xae.encoded_msg, xe.event_status_code, xe.process_status_code',
      p_title                  => 'Accounting Error Summary',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Unprocessed Records with Errors exist.',
      p_solution               => '<p>Review the "Accounting Errors" section and use given solutions to resolve the errors for these records.</p>',
      p_success_msg            => 'No errors exist in the XLA_ACCOUNTING_ERRORS table for Channel Revenue Management XLA_EVENTS',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_UNPROCESSED_ERROR_SUMMARY');



debug('begin add_signature: OZF_SLA_ERROR_95274_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '976',
      p_sig_id                 => 'OZF_SLA_ERROR_95274_DETAILS',
      p_sig_sql                => 'SELECT xe.event_id, xe.event_type_code, xe.event_date, xe.entity_id, xe.event_status_code, xe.process_status_code, xae.accounting_error_id, xae.ledger_id, xae.accounting_batch_id, xae.message_number Message_Number, xae.encoded_msg, xae.ae_header_id, xae.ae_line_num, xae.error_source_code, xae.program_application_id, xae.program_id, xae.request_id
FROM xla_events xe, XLA_ACCOUNTING_ERRORS xae
WHERE xe.event_id = xae.event_id 
and xe.application_id = 682
and xe.event_date <= ''##$$end_date$$##''
and event_status_code   <> ''P''
and process_status_code <> ''P''
and xae.message_number = 95274',
      p_title                  => 'Unprocessed Accounting 95274 Errors',
      p_fail_condition         => '[Message_Number] = [95274]',
      p_problem_descr          => '<p>There are records that have Accounting Error 95274.</p>
<p>There is no application accounting definition available for the application Trade Management and the subledger accounting method Standard Accrual owned by Oracle. <br /><br />Either no application accounting definition is assigned to the subledger accounting method, or the GL date of the accounting event does not correspond to the effective date range of any application accounting definitions assigned to the subledger accounting method.</p>',
      p_solution               => '<p>The event date for the unprocessed records are earlier than the Subledger Accounting Methods (SLAM) start date. The SLAM start date is displayed in the next section.</p>
<p>Use this date to follow the steps given in [2057040/KB795226] ChRM Subledger Accounting - Create Accounting (XLAACCPB) Program Error: 95274 There is no application accounting definition available for the application Trade Management.</p>
<p>If solution provided does not solve the issue, please log a Service Request with Oracle Support. Upload this analyzer output and the output and log file for the Subledger Accounting, Create Accounting and Accounting Program concurrent requests to the Service Request when it is logged.</p>',
      p_success_msg            => 'There are no unprocessed records with Accounting Error 95274.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_ERROR_95274_DETAILS');



debug('begin add_signature: OZF_SLA_SLAM_START_DATE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1355',
      p_sig_id                 => 'OZF_SLA_SLAM_START_DATE',
      p_sig_sql                => 'SELECT start_date_active 
FROM xla_acctg_method_rules
WHERE application_id = 682 
...
AND accounting_method_code IN
    (SELECT sla_accounting_method_code 
     ...
     WHERE ledger_id = ##$$ledger_id$$##)',
      p_title                  => 'SLAM Start Date',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Subledger Accounting Methods (SLAM) Start Date',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_SLAM_START_DATE');



debug('begin add_signature: OZF_SLA_GL_OPEN_PERIODS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1428',
      p_sig_id                 => 'OZF_SLA_GL_OPEN_PERIODS',
      p_sig_sql                => 'SELECT CLOSING_STATUS,PERIOD_NAME,PERIOD_NUM,PERIOD_YEAR,START_DATE,END_DATE,
PERIOD_TYPE,QUARTER_NUM,ADJUSTMENT_PERIOD_FLAG
FROM   gl_period_statuses a, ozf_sys_parameters_all b
WHERE  a.application_id = 101
AND    a.set_of_books_id =  b.set_of_books_id
AND    b.set_of_books_id = ##$$ledger_id$$##
AND    nvl(a.adjustment_period_flag,''N'') = ''N''
AND    a.closing_status IN ( ''O'',''F'')',
      p_title                  => 'General Ledger Open or Future Enterable Periods',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'General Ledger Open or Future Enterable Periods',
      p_solution               => '',
      p_success_msg            => 'General Ledger Open or Future Enterable Periods',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_GL_OPEN_PERIODS');



debug('begin add_signature: OZF_SLA_ERROR_95325_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '977',
      p_sig_id                 => 'OZF_SLA_ERROR_95325_DETAILS',
      p_sig_sql                => 'SELECT xe.event_id, xe.event_type_code, xe.event_date Event_Date, xe.entity_id, xe.event_status_code, xe.process_status_code, xae.accounting_error_id, xae.ledger_id, xae.accounting_batch_id, xae.message_number Message_Number, xae.encoded_msg, xae.ae_header_id, xae.ae_line_num, xae.error_source_code, xae.program_application_id, xae.program_id, xae.request_id
FROM xla_events xe, XLA_ACCOUNTING_ERRORS xae
WHERE xe.event_id = xae.event_id 
and xe.application_id =682
and xe.event_date <= ''##$$end_date$$##''
...
and process_status_code <> ''P''
and xae.message_number = 95325',
      p_title                  => 'Unprocessed Accounting 95325 Errors',
      p_fail_condition         => '[Message_Number] = [95325]',
      p_problem_descr          => 'There are records that have Accounting Error <i>95325 The GL date DD-MON-YYYY is not in an open or a future enterable period.</i><br>
This issue will happen when periods are closed without processing events from Trade Management/Channel Revenue Management.
 ',
      p_solution               => '<p>The event (accounting date) for records in error are earlier than the first day of the earliest open GL Period for the Ledger.<br>
The First day of the earliest open GL Period for the Ledger is displayed in the next section.<br>
Use this date to follow the steps given in [1539581/KB716943] ChRM SubLedger Accounting Program Error: 95325 The GL date DD-MON-YYYY is not in an open or a future enterable period.</p>
<p>If solution provided does not solve the issue, please log a Service Request with Oracle Support.<br>
Upload this analyzer output and the output and log file for the Subledger Accounting, Create Accounting and Accounting Program concurrent requests to the Service Request when it is logged.</p>',
      p_success_msg            => 'There are no unprocessed records with Accounting Error 95325.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('OZF_SLA_GL_OPEN_PERIODS'),
      p_include_in_dx_summary  => nvl('Y','N'),
      p_version                => '5'
      );
   l_info.delete;
debug('end add_signature: OZF_SLA_ERROR_95325_DETAILS');



debug('begin add_signature: OZF_SLA_OPEN_GL_PERIOD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1285',
      p_sig_id                 => 'OZF_SLA_OPEN_GL_PERIOD',
      p_sig_sql                => 'SELECT MIN(start_date) "Start Date"
FROM   gl_period_statuses a, ozf_sys_parameters_all b
WHERE  a.application_id = 101
AND    a.set_of_books_id =  b.set_of_books_id
AND    b.set_of_books_id = ''##$$ledger_id$$##''
AND    nvl(a.adjustment_period_flag,''N'') = ''N''
AND    a.closing_status IN ( ''O'',''F'')',
      p_title                  => 'First Day of Earliest Open GL Period',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'First day of the earliest open GL Period for the Ledger.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_OPEN_GL_PERIOD');



debug('begin add_signature: OZF_SLA_ERROR_95333_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '978',
      p_sig_id                 => 'OZF_SLA_ERROR_95333_DETAILS',
      p_sig_sql                => 'SELECT xe.event_id, xe.event_type_code, xe.event_date, xe.entity_id, xe.event_status_code, xe.process_status_code, xae.accounting_error_id, xae.ledger_id, xae.accounting_batch_id, xae.message_number Message_Number, xae.encoded_msg, xae.ae_header_id, xae.ae_line_num, xae.error_source_code, xae.program_application_id, xae.program_id, xae.request_id
FROM xla_events xe, XLA_ACCOUNTING_ERRORS xae
WHERE xe.event_id = xae.event_id 
and xe.application_id =682
...
and event_status_code   <> ''P''
and process_status_code <> ''P''
and xae.message_number = 95333',
      p_title                  => 'Unprocessed Accounting 95333 Errors',
      p_fail_condition         => '[Message_Number] = [95333]',
      p_problem_descr          => 'There are records that have Accounting Error <i>95333 A conversion rate does not exist to convert YYY to ZZZ for the conversion type AAA and conversion date DD-MMM-YY for line ().</i><br>

This is due to the period rate(s) not setup for the currency being used.. ',
      p_solution               => '<p>Review and follow the steps given in [2057032/KB786510] ChRM Subledger Accounting - Create Accounting (XLAACCPB) Error: 95333 A conversion rate does not exist to convert YYY to ZZZ for the conversion type AAA and conversion date DD-MMM-YY for line ().</p>  
<p>If solution provided does not solve the issue, please log a Service Request with Oracle Support. Upload this analyzer output and the output and log file for the Subledger Accounting, Create Accounting and Accounting Program concurrent requests to the Service Request when it is logged.</p>
',
      p_success_msg            => 'There are no unprocessed records with Accounting Error 95333.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_ERROR_95333_DETAILS');



debug('begin add_signature: OZF_SLA_ERROR_95937_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '990',
      p_sig_id                 => 'OZF_SLA_ERROR_95937_DETAILS',
      p_sig_sql                => 'SELECT *
FROM XLA_ACCOUNTING_ERRORS
WHERE application_id = 682
and ledger_id = ##$$ledger_id$$##
and message_number = 95937',
      p_title                  => 'Unprocessed Accounting 95937 Errors',
      p_fail_condition         => '[Message_Number] = [95937]',
      p_problem_descr          => 'There are records that have Accounting Error <i>95937 There are either non-accountable events existing in the system, or events which could not be processed because no data could be found on transaction objects.</i><br>
This could mean there are orphan records in XLA_ACCOUNTING_ERRORS table where the EVENT_ID = null.
',
      p_solution               => '<p>Review and follow the corresponding steps given in [2067529/KB773740] ChRM Subledger Accounting - Create Accounting (XLAACCPB) Program Error: 95937 There are no eligible transactions to account.</p>  
<p>If solution provided does not solve the issue, please log a Service Request with Oracle Support. Upload this analyzer output and the output and log file for the Subledger Accounting, Create Accounting and Accounting Program concurrent requests to the Service Request when it is logged.</p>',
      p_success_msg            => 'There are no unprocessed records with Accounting Error 95937.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_ERROR_95937_DETAILS');



debug('begin add_signature: OZF_SLA_ERROR_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '945',
      p_sig_id                 => 'OZF_SLA_ERROR_DETAILS',
      p_sig_sql                => 'SELECT xe.event_id, xe.event_type_code, xe.event_date, xe.entity_id, xe.event_status_code, xe.process_status_code, xae.accounting_error_id, xae.ledger_id, xae.accounting_batch_id, xae.message_number, xae.encoded_msg, xae.ae_header_id, xae.ae_line_num, xae.error_source_code, xae.program_application_id, xae.program_id, xae.request_id
FROM xla_events xe, XLA_ACCOUNTING_ERRORS xae
WHERE xe.event_id = xae.event_id 
and xe.application_id =682
and xe.event_date <= ''##$$end_date$$##''
and event_status_code   <> ''P''
and process_status_code <> ''P''
and xae.message_number not in (95325, 95274, 95333, 95937)',
      p_title                  => 'Unprocessed Records with Other Accounting Errors',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are records that have an Accounting Error.',
      p_solution               => '<p>Review the Message Number column for the Error Number and follow the corresponding steps given in [2059935/KB546906].</P>
<p>If solution does not resolve issue, please log a Service Request with Oracle Support. Upload this analyzer output and the output and log file for the Subledger Accounting, Create Accounting and Accounting Program concurrent requests to Service Request when it is logged.</p>',
      p_success_msg            => 'There are no other unprocessed records with accounting errors.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_ERROR_DETAILS');



debug('begin add_signature: OZF_SLA_SETUP_APP_ACC_DEF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1043',
      p_sig_id                 => 'OZF_SLA_SETUP_APP_ACC_DEF',
      p_sig_sql                => 'SELECT PAH.PRODUCT_RULE_TYPE_CODE PRODUCT_RULE_TYPE_CODE
, PAH.ENTITY_CODE ENTITY_CODE, PAH.EVENT_CLASS_CODE EVENT_CLASS_CODE
, PAH.EVENT_TYPE_CODE EVENT_TYPE_CODE, ECL.NAME EVENT_CLASS_NAME
, ETL.NAME EVENT_TYPE_NAME, PAH.VALIDATION_STATUS_CODE VALIDATION_STATUS_CODE, PAH.ACCOUNTING_REQUIRED_FLAG ACCOUNTING_REQUIRED_FLAG, PAH.LOCKING_STATUS_FLAG LOCKING_STATUS_FLAG, PAH.CREATION_DATE CREATION_DATE
, PAH.CREATED_BY CREATED_BY
FROM XLA_PROD_ACCT_HEADERS PAH, XLA_EVENT_CLASSES_TL ECL, XLA_EVENT_TYPES_TL ETL
...
AND pah.application_id = 682',
      p_title                  => 'ChRM Application Accounting Definition Assigned to SLAM',
      p_fail_condition         => '[VALIDATION_STATUS_CODE] <> [Y]',
      p_problem_descr          => 'There are Invalid Event Classes for Application Accounting Definition assigned to Channel Revenue Management.',
      p_solution               => '<p>Run Validate Application Accounting Definitions program.</p>
<p><b>Responsibility:</b> Oracle Trade Management Administrator<br>
<b>Navigation:</b> Concurrent Requests > Run<br>
Query and run Validate Application Accounting Definitions program </p>

<p>Review [1388509/KB654640] ChRM Sub Ledger Setup Application Definitions Event Class and Event Assignments Not Validated for more information.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_SETUP_APP_ACC_DEF');



debug('begin add_signature: OZF_SLA_SETUP_ACC_METHODS_ERROR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '905',
      p_sig_id                 => 'OZF_SLA_SETUP_ACC_METHODS_ERROR',
      p_sig_sql                => 'SELECT  accounting_method_code, DECODE (accounting_method_type_code, ''S'', ''Oracle'', ''C'', ''User'', accounting_method_type_code) acctg_method_type, acctg_method_rule_id, product_rule_code, DECODE (product_rule_type_code, ''S'', ''Oracle'', ''C'', ''User'', product_rule_type_code) product_rule_type,amb_context_code, start_date_active, end_date_active            
FROM xla_acctg_method_rules            
WHERE application_id = 682
AND accounting_method_code IN 
    (SELECT sla_accounting_method_code 
     FROM gl_ledgers  
     WHERE ledger_id = ##$$ledger_id$$##)
AND start_date_active > ''##$$EVENT_START_DATE$$##''
ORDER BY accounting_method_code',
      p_title                  => 'Subledger Accounting Methods (SLAM)',
      p_fail_condition         => '[start_date_active] > [##$$EVENT_START_DATE$$##]',
      p_problem_descr          => 'There are Unprocessed Records that have an event_date prior to the Accounting Method start_date_active.',
      p_solution               => '<p>If the start_date_active is prior to the event_date for any unprocessed records in the XLA_EVENTS table then the system will display Error 95274 in the Create Accounting Output file after the Subledger Accounting Program has been run.</p>
<p>Review the "Accounting Errors" section and use given solutions to resolve the errors for these records.</p>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_SETUP_ACC_METHODS_ERROR');



debug('begin add_signature: OZF_SLA_EVENT_GL_PENDING_RECORDS');
   l_info('##MASK##%ATTRIBUTE%'):= 'REMOVE_COLUMN';
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '991',
      p_sig_id                 => 'OZF_SLA_EVENT_GL_PENDING_RECORDS',
      p_sig_sql                => 'SELECT *
    FROM XLA_ae_headers
    WHERE application_id = 682
    AND ledger_id = ##$$ledger_id$$##
    ...
    order by je_category_name',
      p_title                  => 'Records Waiting General Ledger Transfer',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are records pending transfer to General Ledger.',
      p_solution               => '<p>Run Transfer Journal Entries to GL concurrent request.</P>
<b>Responsibility:</b> Oracle Trade Management Administrator<br>
<b>Navigation:</b> Concurrent Requests > Run<br>
Query and submit concurrent request Transfer Journal Entries to GL<br>
</p>
<p>Review [459680/KB626042] How to Transfer Accounting to General Ledger in Release 12 When Records Are In Final Status In Subledger Report for more information.</p>',
      p_success_msg            => 'There are no records waiting transfer to General Ledger.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_EVENT_GL_PENDING_RECORDS');



debug('begin add_signature: OZF_SLA_PROCESSED_WAITING_GL_TRANSFER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '942',
      p_sig_id                 => 'OZF_SLA_PROCESSED_WAITING_GL_TRANSFER',
      p_sig_sql                => 'select xe.event_id, xe.event_date, xe.event_type_code Event_Code, xe.event_status_code, xe.process_status_code, gl_transfer_status_code,  je_category_name JE_CATEGORY, period_name PERIOD, accounting_entry_status_code
from xla_ae_headers xah, xla_events xe
where xah.gl_transfer_status_code = ''N''
and xe.event_status_code = ''P''
and xe.process_status_code = ''F''
and xah.application_id = 682
and xah.event_id = xe.event_id',
      p_title                  => 'Processed Event Records Waiting GL Transfer',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Processed event records exist that need to be manually transferred to General Ledger.',
      p_solution               => '<p>If an event has event_status_code = P (Processed) and process_status_code = F (Final) but is still in XLA_AE_HEADERS table with GL_Transfer = No, then the event has successfully processed and needs to be manually transferred to General Ledger.</P>
<p>Manual GL Transfer can be completed by running the Transfer Journal Entries to GL<br>
<b>Responsibility:</b> Oracle Trade Management Administrator<br>
<b>Navigation:</b> Concurrent Requests > Run<br>
Query and submit concurrent request Transfer Journal Entries to GL<br>
</p>
<p>Refer [459680/KB626042] How to Transfer Accounting to General Ledger in Release 12 When Records Are In Final Status In Subledger Report</p>',
      p_success_msg            => 'No processed event records exist that need to be manually transferred to General Ledger.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_PROCESSED_WAITING_GL_TRANSFER');



debug('begin add_signature: OZF_SLA_XLA_AE_HEADERS');
   l_info('##MASK##%ATTRIBUTES%'):= 'REMOVE_COLUMN';
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '994',
      p_sig_id                 => 'OZF_SLA_XLA_AE_HEADERS',
      p_sig_sql                => 'SELECT *
    FROM XLA_ae_headers
    WHERE application_id = 682
    AND ledger_id = ##$$ledger_id$$##
    AND event_id IN
      ...
      AND process_status_code <> ''P'')
    order by je_category_name',
      p_title                  => 'Unprocessed Records in XLA_AE_HEADERS Table',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no unprocessed records in the XLA_AE_HEADERS table.',
      p_solution               => '',
      p_success_msg            => 'Data from XLA_AE_HEADERS table for unprocessed records.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_XLA_AE_HEADERS');



debug('begin add_signature: OZF_SLA_XLA_TRAN_ENTITIES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '856',
      p_sig_id                 => 'OZF_SLA_XLA_TRAN_ENTITIES',
      p_sig_sql                => 'SELECT *
    ...
    AND entity_id IN
      (SELECT entity_id
       ...
       AND event_status_code   <> ''P''
       AND process_status_code <> ''P'')',
      p_title                  => 'Unprocessed Records in XLA_TRANSACTION_ENTITIES table',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no unprocessed records found in the XLA_TRANSACTION_ENTITIES table.',
      p_solution               => '',
      p_success_msg            => 'Data from XLA_TRANSACTION_ENTITIES table for unprocessed records.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_XLA_TRAN_ENTITIES');



debug('begin add_signature: OZF_SLA_XLA_CLAIM');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '857',
      p_sig_id                 => 'OZF_SLA_XLA_CLAIM',
      p_sig_sql                => 'SELECT *
    ...
    WHERE event_id IN
      (SELECT event_id
       ...
       AND event_status_code   <> ''P''
       AND process_status_code <> ''P'')',
      p_title                  => 'Unprocessed Records in OZF_XLA_CLAIM_HEADERS table',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no unprocessed data in the OZF_XLA_CLAIM_HEADERS table.',
      p_solution               => '',
      p_success_msg            => 'Data from OZF_XLA_CLAIM_HEADERS table for unprocessed records.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_XLA_CLAIM');



debug('begin add_signature: OZF_SLA_CLAIMS_DATA');
   l_info('##MASK##%ATTRIBUTE%'):= 'REMOVE_COLUMN';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##HISTORY_EVENT_DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '858',
      p_sig_id                 => 'OZF_SLA_CLAIMS_DATA',
      p_sig_sql                => 'SELECT xla.event_id, cla.*
    FROM OZF_XLA_CLAIM_HEADERS xla, OZF_CLAIMS_ALL cla
    WHERE xla.claim_id = cla.claim_id
      AND event_id IN
      (SELECT event_id
       FROM xla_events
       WHERE application_id = 682
       ...
       AND event_status_code   <> ''P''
       AND process_status_code <> ''P'')',
      p_title                  => 'Data from OZF_CLAIMS_ALL table',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no unprocessed data in the OZF_CLAIMS_ALL table.',
      p_solution               => '',
      p_success_msg            => 'Data from OZF_CLAIMS_ALL table for unprocessed records.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_CLAIMS_DATA');



debug('begin add_signature: OZF_SLA_XLA_ACCRUALS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '859',
      p_sig_id                 => 'OZF_SLA_XLA_ACCRUALS',
      p_sig_sql                => 'SELECT *
    ...
    WHERE event_id IN
      (SELECT event_id
       ...
       AND event_status_code   <> ''P''
       AND process_status_code <> ''P'')',
      p_title                  => 'Unprocessed Records in OZF_XLA_ACCRUALS table',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no unprocessed data in the OZF_XLA_ACCRUALS table.',
      p_solution               => '',
      p_success_msg            => 'Data from OZF_XLA_ACCRUALS tables for unprocessed records.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_XLA_ACCRUALS');



debug('begin add_signature: OZF_SLA_OZF_FUNDS_UTLIZED_ALL');
   l_info('##MASK##%ATTRIBUTES%'):= 'REMOVE_COLUMN';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '860',
      p_sig_id                 => 'OZF_SLA_OZF_FUNDS_UTLIZED_ALL',
      p_sig_sql                => 'SELECT xla.event_id, util.*
    FROM OZF_XLA_ACCRUALS xla, OZF_FUNDS_UTILIZED_ALL_B util
    WHERE xla.utilization_id = util.utilization_id
      AND event_id IN
      (SELECT event_id
       FROM xla_events
       WHERE application_id = 682
       ...
       AND event_status_code   <> ''P''
       AND process_status_code <> ''P'')',
      p_title                  => 'Data from OZF_FUNDS_UTILIZED_ALL_B table',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no unprocessed data in the OZF_FUNDS_UTLIZED_ALL table.',
      p_solution               => '',
      p_success_msg            => 'Data from OZF_FUNDS_UTILIZED_ALL_B table for unprocessed records.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_OZF_FUNDS_UTLIZED_ALL');



debug('begin add_signature: OZF_SLA_SETUP_LEDGER');
   l_info('##MASK##CRITERIA_SET_DESC'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '902',
      p_sig_id                 => 'OZF_SLA_SETUP_LEDGER',
      p_sig_sql                => 'select 
gll.ledger_id Ledger_ID,
gll.name Ledger_Name,
gll.short_name Ledger_Short_Name,
gll.description Ledger_Description,
gll.ledger_category_code Ledger_Category_code,
gll.configuration_id Primary_config_id ,
gll.chart_of_accounts_id Primary_Ledger_COAID,
gll.currency_code Primary_ledger_currency,
gll.Period_set_name Primary_Period_set_name,
gll.accounted_period_type Primary_priod_type,
gll.first_ledger_period_name Primary_First_ever_period,
gll.ret_earn_code_combination_id Primary_Retained_earnings_Acct,
gll.suspense_allowed_flag Primary_Suspense_flag,
gll.allow_intercompany_post_flag Primary_Intercompany_Flag,
gll.Track_rounding_imbalance_flag Primary_Imbalance_flag,
gll.ENABLE_AVERAGE_BALANCES_FLAG Average_balances_flag,
gll.CUM_TRANS_CODE_COMBINATION_ID Primary_CTA,
gll.criteria_set_id Journal_Reversal_Set_id,
glac.CRITERIA_SET_NAME Journal_Rev_Set_Name,
gll.res_encumb_code_combination_id Primary_Res_Encub_CCID,
gll.Net_income_code_combination_id Primary_net_income_ccid,
gll.rounding_code_combination_id Primary_rounding_ccid,
gll.Enable_budgetary_control_flag Primary_Budgetary_flag,
gll.require_budget_journals_flag Require_budget_journlas_flag,
gll.enable_je_approval_flag Primary_Jrl_Approval_flag,
gll.enable_automatic_tax_flag Primary_tax_enable_flg,
gll.consolidation_ledger_flag Primary_Avg_consolidation_flag,
gll.translate_EOD_FLAG Avg_EOD_Flag,
gll.translate_qatd_flag Avg_QTD_FLAG,
gll.translate_yatd_flag Avg_YTD_FLAG,
gll.transaction_calendar_id Avg_trans_cal_id,
gll.daily_translation_rate_type Avg_daily_rate_type,
gll.bal_seg_column_name Primary_Balance_segment,
gll.bal_seg_value_set_id Primary_balance_value_set_id,
gll.future_enterable_periods_limit Primary_future_periods_limit,
gll.latest_opened_period_name latest_opened_period_name,
gll.latest_encumbrance_year latest_encum_year,
gll.period_average_rate_type period_average_rate_type,
gldt1.user_conversion_type Avg_Conversion_name,
gll.period_end_rate_type period_end_rate_type,
gldt2.user_conversion_type EOD_Conversion_name,
gll.budget_period_avg_rate_type budget_period_avg_rate_type,
gldt3.user_conversion_type Budget_Avg_Conversion_name,
gll.budget_period_end_rate_type budget_period_end_rate_type,
gldt4.user_conversion_type Budget_EOD_Conversion_name,
gll.sla_accounting_method_code SLA_name,
gll.sla_accounting_method_code SLA_CODE,
gll.sla_entered_cur_bal_sus_ccid Primary_Entered_curr_bal_ccid,
gll.sla_bal_by_ledger_curr_flag Primary_ledger_curr_bal_ccid,
gll.enable_secondary_track_flag Primary_Secondary_track_flag,
gll.enable_reval_ss_track_flag Primary_reval_ss_track_flag,
gll.enable_reconciliation_flag Primary_Reconciliation_FLAG
from gl_ledgers gll , GL_AUTOREV_CRITERIA_SETS glac,gl_daily_conversion_types gldt1
,gl_daily_conversion_types gldt2,gl_daily_conversion_types gldt3,gl_daily_conversion_types gldt4
where gll.ledger_id= ##$$ledger_id$$##
...
and gldt4.conversion_type(+)=gll.budget_period_end_rate_type',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Ledger details exist',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_SETUP_LEDGER');



debug('begin add_signature: OZF_SLA_SETUP_LEGAL_ENTITY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '903',
      p_sig_id                 => 'OZF_SLA_SETUP_LEGAL_ENTITY',
      p_sig_sql                => 'select * 
from gl_ledger_le_bsv_specific_v 
where ledger_id = ##$$ledger_id$$##',
      p_title                  => 'Legal Entity Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no Legal Entity Information defined for this Ledger.<br>
Legal entities own the assets of the enterprise, record sales and pay taxes on those sales, make purchases and incur expenses, and make other transactions.',
      p_solution               => 'If you plan to record accounting transactions for one or more legal entities, you can use Oracle Legal Entity Configurator or the Legal Entities tab in Accounting Setup Manager to define your legal entities.<br>
Review [726522/KB718451] R12: Legal Entities Setup and Usage for more information.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_SETUP_LEGAL_ENTITY');



debug('begin add_signature: OZF_SLA_SETUP_SLA_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '904',
      p_sig_id                 => 'OZF_SLA_SETUP_SLA_OPTIONS',
      p_sig_sql                => 'SELECT NAME, application_id, ledger_category_code, chart_of_accounts_id, accounting_mode_code,           accounting_mode_override_flag, submit_transfer_to_gl_flag , processes, processing_unit_size,           transfer_to_gl_mode_code, acct_reversal_option_code, sla_entered_cur_bal_sus_ccid, relationship_enabled_flag, sla_bal_by_ledger_curr_flag, sla_ledger_cur_bal_sus_ccid, rounding_code_combination_id, enabled_flag ,           capture_event_flag, valuation_method_flag , suspense_allowed_flag           
FROM xla_subledger_options_v
WHERE ledger_id = ##$$ledger_id$$##
AND application_id = 682
ORDER BY ledger_id',
      p_title                  => 'Subledger Options',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Subledger Options Exist',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_SETUP_SLA_OPTIONS');



debug('begin add_signature: OZF_SLA_SETUP_SLA_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '906',
      p_sig_id                 => 'OZF_SLA_SETUP_SLA_DETAILS',
      p_sig_sql                => 'SELECT user_je_source_name, valuation_method_flag, drilldown_procedure_name, alc_enabled_flag           
FROM xla_subledgers_fvl           
WHERE application_id = 682',
      p_title                  => 'Subledger Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Subledger Details exist',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_SETUP_SLA_DETAILS');



debug('begin add_signature: OZF_SLA_SETUP_ENTITY_MAPPING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '908',
      p_sig_id                 => 'OZF_SLA_SETUP_ENTITY_MAPPING',
      p_sig_sql                => 'SELECT entity_code, transaction_id_col_name_1, transaction_id_col_name_2, transaction_id_col_name_3,           transaction_id_col_name_4, source_id_col_name_1, source_id_col_name_2, source_id_col_name_3,           source_id_col_name_4           
FROM xla_entity_id_mappings           
WHERE application_id = 682          
ORDER BY entity_code
',
      p_title                  => 'Entity Mapping for all Entities belonging to Channel Revenue Management',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Entity Mapping exists for Channel Revenue Management',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_SETUP_ENTITY_MAPPING');



debug('begin add_signature: OZF_SLA_SETUP_ENTITY_TYPES');
   l_info('##MASK##ZD_EDITION_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '907',
      p_sig_id                 => 'OZF_SLA_SETUP_ENTITY_TYPES',
      p_sig_sql                => 'SELECT *          
FROM xla_entity_types_b           
WHERE application_id = 682
ORDER BY entity_code',
      p_title                  => 'All available Entity Types for Channel Revenue Management',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Entity Types are setup for Channel Revenue Management',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_SETUP_ENTITY_TYPES');



debug('begin add_signature: OZF_SLA_SETUP_EVENT_CLASSES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '909',
      p_sig_id                 => 'OZF_SLA_SETUP_EVENT_CLASSES',
      p_sig_sql                => 'SELECT ec.entity_code, ec.event_class_code, ec.enabled_flag           
FROM xla_event_classes_b ec, xla_entity_types_b et           
WHERE et.application_id = 682                 
AND et.application_id = ec.application_id           
AND et.entity_code = ec.entity_code           
ORDER BY ec.entity_code,  ec.event_class_code',
      p_title                  => 'Event Classes',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Event Classes exist',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_SETUP_EVENT_CLASSES');



debug('begin add_signature: OZF_SLA_SETUP_EVENT_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '910',
      p_sig_id                 => 'OZF_SLA_SETUP_EVENT_TYPES',
      p_sig_sql                => 'SELECT ec.entity_code, ec.event_class_code, evt.event_type_code, evt.accounting_flag, evt.tax_flag, evt.enabled_flag              
FROM xla_event_types_b evt, xla_event_classes_b ec, xla_entity_types_b et              
WHERE et.application_id = 682                        
AND et.application_id = ec.application_id              
...
ORDER BY ec.entity_code,  event_class_code, event_type_code',
      p_title                  => 'Event Types',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Event Types exist',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_SETUP_EVENT_TYPES');



debug('begin add_signature: OZF_SLA_SETUP_TRAN_IDENTIFIER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '912',
      p_sig_id                 => 'OZF_SLA_SETUP_TRAN_IDENTIFIER',
      p_sig_sql                => 'SELECT ea.entity_code, ea.event_class_code, em.column_name, ea.reporting_view_name, ea.event_class_group_code, ea.je_category_name             
FROM xla_event_mappings_vl em, xla_event_class_attrs ea
WHERE em.application_id = 682
AND em.application_id = ea.application_id
AND em.event_class_code = ea.event_class_code
order by ea.entity_code,em.event_class_code',
      p_title                  => 'Transaction Identifiers and Reporting View ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No transaction identifiers exist',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_SETUP_TRAN_IDENTIFIER');



debug('begin add_signature: OZF_SLA_SETUP_EVENT_CLASS_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '913',
      p_sig_id                 => 'OZF_SLA_SETUP_EVENT_CLASS_OPTIONS',
      p_sig_sql                => 'SELECT entity_code,  event_class_code,  je_category_name,  user_je_category_name,  reporting_view_name,  calculate_acctd_amts_flag,  calculate_g_l_amts_flag,  allow_actuals_flag,  allow_budgets_flag,  allow_encumbrance_flag,  event_class_group_code,  event_class_group_name  
FROM xla_event_class_attrs_fvl  
WHERE application_id = 682  
ORDER BY entity_code,  event_class_code',
      p_title                  => 'Event Class Options',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Event Class Options are setup',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_SETUP_EVENT_CLASS_OPTIONS');



debug('begin add_signature: OZF_SLA_SETUP_JRNL_LINE_DEF_ACCT_DEF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '914',
      p_sig_id                 => 'OZF_SLA_SETUP_JRNL_LINE_DEF_ACCT_DEF',
      p_sig_sql                => 'SELECT ec.entity_code,lda.event_class_code, lda.event_type_code, lda.line_definition_code,        lda.amb_context_code,DECODE (lda.line_definition_owner_code, ''S'', ''Oracle'',''C'', ''User'',          lda.line_definition_owner_code ) owner, ld.validation_status_code, ld.enabled_flag, ld.transaction_coa_id, ld.accounting_coa_id, ld.object_version_number           
FROM xla_aad_line_defn_assgns lda, xla_line_definitions_b ld, xla_event_classes_b ec            
WHERE lda.application_id = 682            
...
FROM gl_ledgers             
WHERE ledger_id = ##$$ledger_id$$##))           
ORDER BY ec.entity_code,lda.event_class_code,lda.event_type_code',
      p_title                  => 'Journal Line Definitions Assigned to the Accounting Definition  ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Journal Line Definitions assigned to the accounting definition',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_SETUP_JRNL_LINE_DEF_ACCT_DEF');



debug('begin add_signature: OZF_SLA_SETUP_JRN_LINE_TYPE_ASSIGN_EVENT_CLASS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '915',
      p_sig_id                 => 'OZF_SLA_SETUP_JRN_LINE_TYPE_ASSIGN_EVENT_CLASS',
      p_sig_sql                => 'SELECT  xl.event_class_code, xl.line_definition_code,xa.accounting_line_code, accounting_line_type_dsp owner,           accounting_class_code, rounding_class_dsp, Decode(accounting_entry_type_code,''A'',''Actual'',''E'',''Encumbrance'', ''B'',''Budget'') balance_type, Decode(natural_side_code,''D'',''Debit'', ''C'',''Credit'', ''Gain/Loss'') side,           business_method_code, business_class_code,  mpa_option_code, encumbrance_type, encumbrance_type_id,          Decode(gain_or_loss_flag,''Y'',''Yes'',  ''N'',''No'') subledger_gain_loss_flag,           Decode(gl_transfer_mode_code,''D'',''Detail'',  ''S'',''Summary'') gl_transfer_mode, merge_duplicate_dsp,           Decode(switch_side_flag,''Y'',''Yes'', ''N'',''No'') switch_side_flag                    
FROM xla_acct_line_types_fvl xa,  xla_line_defn_jlt_assgns xl              
WHERE xa.application_id = 682             
...
AND xl.line_definition_code IN (SELECT line_definition_code              
FROM xla_aad_line_defn_assgns              
WHERE application_id = 682             
AND product_rule_code IN (SELECT product_rule_code FROM xla_acctg_method_rules              
WHERE application_id = 682             
AND accounting_method_code IN (SELECT sla_accounting_method_code              
FROM gl_ledgers  WHERE ledger_id = ##$$ledger_id$$##)))             
order by xl.event_class_code',
      p_title                  => 'Journal Line Types Assigned to Each Event Class',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Journal line types assigned to event class',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_SETUP_JRN_LINE_TYPE_ASSIGN_EVENT_CLASS');



debug('begin add_signature: OZF_SLA_SETUP_ACC_DEV_RULES_ASSOC_JRL_LINE_DEF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '917',
      p_sig_id                 => 'OZF_SLA_SETUP_ACC_DEV_RULES_ASSOC_JRL_LINE_DEF',
      p_sig_sql                => 'SELECT event_class_code,  event_type_code, line_definition_code, accounting_line_code, flexfield_segment_name, segment_rule_code, segment_rule_name, inherit_adr_flag, side_code
...
AND accounting_method_code IN 
    (SELECT sla_accounting_method_code 
     FROM gl_ledgers  
     WHERE ledger_id = ##$$ledger_id$$##))))             
ORDER BY event_class_code,line_definition_code,accounting_line_code',
      p_title                  => 'Account Derivation Rules Associated to the Journal Line Definitions ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No account derivation rules are associated to the journal line definitions',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_SETUP_ACC_DEV_RULES_ASSOC_JRL_LINE_DEF');



debug('begin add_signature: OZF_SLA_SETUP_ACC_DER_RULE_COND');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '918',
      p_sig_id                 => 'OZF_SLA_SETUP_ACC_DER_RULE_COND',
      p_sig_sql                => 'SELECT distinct xjt.event_class_code  ,xjt.SEGMENT_RULE_code ,xsr.user_sequence Priority, xla_conditions_pkg.Display_condition(xjt.application_id,''DEFAULT'',null,null,null,null,xc.segment_rule_detail_id,null,NULL,''S'') adr_condition          
FROM xla_line_defn_adr_assgns_f_v xjt, xla_seg_rule_details xsr , xla_conditions xc           
WHERE xjt.application_id = 682           
         ...
         (SELECT product_rule_code  
          ...
          AND accounting_method_code IN
              (SELECT sla_accounting_method_code  
               FROM gl_ledgers 
               WHERE ledger_id = ##$$ledger_id$$##)))           
order by  xjt.event_class_code, xjt.segment_rule_code, xsr.user_sequence',
      p_title                  => 'Account Derivation Rule Conditions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No account derivation rule conditions exist',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_SETUP_ACC_DER_RULE_COND');
...
debug('begin add_signature: OZF_SLA_SETUP_ACC_METHODS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1113',
      p_sig_id                 => 'OZF_SLA_SETUP_ACC_METHODS',
      p_sig_sql                => 'SELECT  accounting_method_code, DECODE (accounting_method_type_code, ''S'', ''Oracle'', ''C'', ''User'', accounting_method_type_code) acctg_method_type, acctg_method_rule_id, product_rule_code, DECODE (product_rule_type_code, ''S'', ''Oracle'', ''C'', ''User'', product_rule_type_code) product_rule_type,amb_context_code, start_date_active, end_date_active
FROM xla_acctg_method_rules
WHERE application_id = ''682''
AND accounting_method_code IN
...
ORDER BY accounting_method_code',
      p_title                  => 'Subledger Accounting Methods (SLAM)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The Subledger Accounting Methods (SLAM) does not exist.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_SETUP_ACC_METHODS');



debug('begin add_signature: OZF_SLA_CONCURRENT_REQ_DETAILS');
   l_info('##MASK##ARGUMENT_TEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMPLETION_TEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1284',
      p_sig_id                 => 'OZF_SLA_CONCURRENT_REQ_DETAILS',
      p_sig_sql                => 'SELECT fcpt.user_concurrent_program_name, fcp.CONCURRENT_PROGRAM_NAME, fcr.COMPLETION_TEXT, fcr.REQUEST_ID, fcr.ACTUAL_START_DATE, fcr.ACTUAL_COMPLETION_DATE,   fcr.status_code, fcr.phase_code, fcr.outfile_name, fcr.logfile_name, fcr.argument_text, fcr.parent_request_id, fcr.LAST_UPDATE_DATE,   fcr.REQUESTED_BY, fcr.RESPONSIBILITY_ID, fcr.concurrent_program_id
FROM FND_CONCURRENT_REQUESTS fcr, FND_CONCURRENT_PROGRAMS fcp, FND_CONCURRENT_PROGRAMS_TL fcpt
WHERE fcr.concurrent_program_id = fcp.concurrent_program_id  
AND fcr.concurrent_program_id = fcpt.concurrent_program_id
...
ORDER BY fcr.request_id desc',
      p_title                  => 'Subledger Accounting Concurrent Program Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Request details for the Subledger Accounting Programs run in the last 30 days.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OZF_SLA_CONCURRENT_REQ_DETAILS');
...
BEGIN
  ...
  analyzer_title := 'Channel Revenue Management (ChRM) SLA Unprocessed Transactions Analyzer';
...
start_section('Proactive Recommendations', 'PROACTIVE_RECOMMENDATIONS');
   set_item_result(check_rec_patches_1); /* Signature OZF_REC_PATCHES */
   set_item_result(run_stored_sig('OZF_INVALIDS'));
   set_item_result(run_stored_sig('EBS_CRM_SC_GEN_MAX_SEQ'));
end_section;
debug('end section: PROACTIVE_RECOMMENDATIONS');

debug('begin section: SLA_CONCURRENT_PROGRAM');
start_section('Subledger Accounting Program Details', 'SLA_CONCURRENT_PROGRAM');
   set_item_result(run_stored_sig('OZF_SLA_CONCURRENT_REQ_NOT RUN'));
   set_item_result(run_stored_sig('OZF_SLA_CONCURRENT_REQ_CREATE_WARNING'));
   IF g_req_start_date > (sysdate - 30) THEN
      set_item_result(run_stored_sig('OZF_SLA_CONCURRENT_REQ_DETAILS'));
   END IF;
end_section;
debug('end section: SLA_CONCURRENT_PROGRAM');

debug('begin section: UNPROCESSED_RECORD_SUMMARY');
start_section('Unprocessed Records Summary', 'UNPROCESSED_RECORD_SUMMARY');
   set_item_result(run_stored_sig('OZF_SLA_EVENT_DETAILS'));
   set_item_result(run_stored_sig('OZF_SLA_UNPROCESSED_ERROR_SUMMARY'));
end_section;
debug('end section: UNPROCESSED_RECORD_SUMMARY');

debug('begin section: ACCOUNTING_ERRORS');
start_section('Accounting  Errors', 'ACCOUNTING_ERRORS');
   set_item_result(run_stored_sig('OZF_SLA_ERROR_95274_DETAILS'));
   set_item_result(run_stored_sig('OZF_SLA_SLAM_START_DATE'));
   set_item_result(run_stored_sig('OZF_SLA_ERROR_95325_DETAILS'));
   set_item_result(run_stored_sig('OZF_SLA_OPEN_GL_PERIOD'));
   set_item_result(run_stored_sig('OZF_SLA_GL_OPEN_PERIODS'));
   set_item_result(run_stored_sig('OZF_SLA_ERROR_95333_DETAILS'));
   set_item_result(run_stored_sig('OZF_SLA_ERROR_95937_DETAILS'));
   set_item_result(run_stored_sig('OZF_SLA_ERROR_DETAILS'));
   set_item_result(run_stored_sig('OZF_SLA_SETUP_APP_ACC_DEF'));
   set_item_result(run_stored_sig('OZF_SLA_SETUP_ACC_METHODS_ERROR'));
end_section;
debug('end section: ACCOUNTING_ERRORS');

debug('begin section: GL_TRANSFER_DETAILS');
start_section('General Ledger Transfer Details', 'GL_TRANSFER_DETAILS');
   set_item_result(run_stored_sig('OZF_SLA_EVENT_GL_PENDING_RECORDS'));
   set_item_result(run_stored_sig('OZF_SLA_PROCESSED_WAITING_GL_TRANSFER'));
end_section;
debug('end section: GL_TRANSFER_DETAILS');

debug('begin section: SLA_XLA_TABLE_DATA');
start_section('SLA (XLA) Table Data', 'SLA_XLA_TABLE_DATA');
   set_item_result(run_stored_sig('OZF_SLA_XLA_AE_HEADERS'));
   set_item_result(run_stored_sig('OZF_SLA_XLA_TRAN_ENTITIES'));
end_section;
debug('end section: SLA_XLA_TABLE_DATA');

debug('begin section: UNPROCESSED_CLAIMS');
start_section('Unprocessed Claim Data', 'UNPROCESSED_CLAIMS');
   set_item_result(run_stored_sig('OZF_SLA_XLA_CLAIM'));
   set_item_result(run_stored_sig('OZF_SLA_CLAIMS_DATA'));
end_section;
debug('end section: UNPROCESSED_CLAIMS');

debug('begin section: UNPROCESSED_ACCRUALS');
start_section('Unprocessed Accrual Data', 'UNPROCESSED_ACCRUALS');
   set_item_result(run_stored_sig('OZF_SLA_XLA_ACCRUALS'));
   set_item_result(run_stored_sig('OZF_SLA_OZF_FUNDS_UTLIZED_ALL'));
end_section;
debug('end section: UNPROCESSED_ACCRUALS');

debug('begin section: SLA_SETUP');
start_section('Subledger Accounting Setup for ChRM (for information only)', 'SLA_SETUP');
   set_item_result(run_stored_sig('OZF_SLA_SETUP_LEDGER'));
   set_item_result(run_stored_sig('OZF_SLA_SETUP_LEGAL_ENTITY'));
   set_item_result(run_stored_sig('OZF_SLA_SETUP_SLA_OPTIONS'));
   IF g_slam_start_date < g_event_date_start THEN
      set_item_result(run_stored_sig('OZF_SLA_SETUP_ACC_METHODS'));
   END IF;
   set_item_result(run_stored_sig('OZF_SLA_SETUP_SLA_DETAILS'));
   set_item_result(run_stored_sig('OZF_SLA_SETUP_ENTITY_MAPPING'));
   set_item_result(run_stored_sig('OZF_SLA_SETUP_ENTITY_TYPES'));
   set_item_result(run_stored_sig('OZF_SLA_SETUP_EVENT_CLASSES'));
   set_item_result(run_stored_sig('OZF_SLA_SETUP_EVENT_TYPES'));
   set_item_result(run_stored_sig('OZF_SLA_SETUP_TRAN_IDENTIFIER'));
   set_item_result(run_stored_sig('OZF_SLA_SETUP_EVENT_CLASS_OPTIONS'));
   set_item_result(run_stored_sig('OZF_SLA_SETUP_JRNL_LINE_DEF_ACCT_DEF'));
   set_item_result(run_stored_sig('OZF_SLA_SETUP_JRN_LINE_TYPE_ASSIGN_EVENT_CLASS'));
   set_item_result(run_stored_sig('OZF_SLA_SETUP_ACC_DEV_RULES_ASSOC_JRL_LINE_DEF'));
   set_item_result(run_stored_sig('OZF_SLA_SETUP_ACC_DER_RULE_COND'));
end_section;
debug('end section: SLA_SETUP');
