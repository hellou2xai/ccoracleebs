...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Product Hub Analyzer                   |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE oph_analyzer_pkg AUTHID DEFINER AS
...
(            p_org_code                     IN VARCHAR2    DEFAULT NULL
           ,p_chg_ord_num                  IN VARCHAR2    DEFAULT NULL
...
END oph_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY oph_analyzer_pkg AS
-- $Id: oph_analyzer.sql, 200.14 2026/01/29 16:37:20 srayadur Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2272263.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'OPHANLY_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'OPHANLY_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>OPHANLY Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2272263.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/oph_analyzer_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1153,EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1153,EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1153,EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4050827" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">1153</span>
...
<div class="ck-content"><p>200.14 29-JAN-2026</p><ul><li>Updated link formats</li>
</ul>
<p>200.13 05-DEC-2025</p><ul><li>Signature updates</li>
<li>Framework updates</li>
</ul>
<p>&nbsp;</p><p>200.12 18-AUG-2025</p><ul><li>Signature updates</li>
<li>Parameter update for item</li>
</ul>
<p>&nbsp;</p><p>200.11 04-MAR-2025</p><ul><li>Signature updates</li>
<li>Framework updates</li>
</ul>
<p>&nbsp;</p><p>200.10 17-JUL-2024</p><ul><li>Signature updates</li>
</ul>
<p>&nbsp;</p><p>200.9 10-APR-2024</p><ul><li>Added signature &apos;<span class="display_only apex-item-display-only" id="P18_TITLE_DISPLAY">Sequence Percent Used&apos;</span></li>
...
<p>&nbsp;</p><p>200.8 26-JAN-2024</p><ul><li>Added signature ‘Incorrect Routing Sequence ID’</li>
<li>Signature updates</li>
</ul>
<p>&nbsp;</p><p>200.7 22-AUG-2023</p><ul><li>Added signature &apos;Lifecycle Pending Phase Change&apos;</li>
<li>Added signature ‘Duplicate Item Number/Description in Table MTL_SYSTEM_ITEMS_B’</li>
<li>Framework update</li>
</ul>
<p>&nbsp;</p><p>200.6 15-JUN-2023</p><ul><li>Signature updates</li>
</ul>
<p>&nbsp;</p><p>200.5 31-MAR-2023</p><ul><li>Framework update</li>
<li>Signature updates</li>
</ul>
<p>&nbsp;</p><p>200.4 FEB-2023</p><ul><li>Signature updates</li>
</ul>
<p>&nbsp;</p><p>200.2 OCT-2021</p><ul><li>Analyzer Framework update</li>
</ul>
<p>&nbsp;</p><p>The EBS Product Hub Analyzer gathers details and looks for problems relating to your Product Hub Item Master and includes data collected in the obsoleted EBS Product Hub Change Management Analyzer.&nbsp; The Product Hub Analyzer provides solutions and troubleshooting information on your Product Hub Items and Item Catalog Categories, as well as the following:</p><ul><li>Reports on out-of-date software in which known problems have been resolved</li>
<li>Details of commonly-encountered Data issues</li>
<li>Patching recommendations and Diagnostics Apps Check report information that includes file versions, profile settings, and many other details relevant for Product Hub</li>
</ul>
<p>The Analyzer is run for one specific Organization at a time with the option to review a specific Inventory Item and Engineering Change Order (ECO).</p><p>Use the Product Hub Analyzer to review, analyze and troubleshoot any Items issue.&nbsp; Please don&apos;t forget to provide feedback for improving the data content based on your needs.&nbsp; We look forward to hearing from you about your experience.</p></div>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1153,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1153,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1153,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
BEGIN
    ...
    print_log('Processing recommended patches signature: OPHANLY_RUPS (check_rec_patches_1) "Recommended Patches" (version 6)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(1)(l_rows) := '20235351';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'EGO RECOMMENDED PATCH COLLECTION ( FEB 2015)';
...
IF substr(g_rep_info('Apps Version'),1,6) = '12.1.3' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '16226394';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'PIM 12.1.3.2 RUP CONSOLIDATION.';
   l_col_rows(5)(l_rows) := NULL;
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21662615';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'EGO RECOMMENDED PATCH COLLECTION(Aug 2016)';
   l_col_rows(5)(l_rows) := NULL;
...
END IF;
   ...
   l_sig.sigrepo_id := '12448';
   l_sig.title := 'Recommended Patches';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := 'Recommended Oracle Product Hub patches that are not applied on this instance.';
...
ADADMIN: Maintain Snapshot Information was executed more than 30 days ago.  It is recommended that AD Utilities (Adadmin) "Maintain Snapshot Information" is run periodically as key tools (Patch Wizard, ADPatch,etc) rely on this information being accurate and up-to-date.';
   l_sig.success_msg := 'Recommended patches for this product area are current in your system.';
  ...
  -- Register
  l_step := '60';
  g_signatures('OPHANLY_RUPS') := l_sig;
...
debug('begin populate parameters hash table');
   ...
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Change Order Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_chg_ord_num,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Inventory Item Number';
...
-- Revision and date values can be populated by RCS
  l_revision := rtrim(replace('$Revision: 200.14  $','$',''));
  l_revision := ltrim(replace(l_revision,'Revision:',''));
  l_date_char := rtrim(replace('$Date: 2026/01/29 16:37:19 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'oph_analyzer.sql';
...
debug('begin parameter validation: p_chg_ord_num');
IF p_chg_ord_num IS NOT NULL THEN
BEGIN
SELECT EEC.CHANGE_NOTICE
INTO l_exists_val
FROM ENG_ENGINEERING_CHANGES EEC, MTL_PARAMETERS MP
WHERE EEC.CHANGE_NOTICE = p_chg_ord_num
 AND EEC.ORGANIZATION_ID = MP.ORGANIZATION_ID
and MP.ORGANIZATION_CODE = p_org_code
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Change Notice value.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_chg_ord_num failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_chg_ord_num');
...
debug('begin populate sql tokens hash table');
   ...
   g_sql_tokens('##$$CHGID$$##') := to_char(p_chg_ord_num);
   g_masked_tokens('##$$CHGID$$##') := mask_text( g_sql_tokens('##$$CHGID$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM6$$##') := '231';
...
debug('begin add_signature: INV_EGO_BOM_ENGR_INVALIDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5852',
      p_sig_id                 => 'INV_EGO_BOM_ENGR_INVALIDS',
    ...
    AND (a.object_name like ''INV%'' OR 
	     a.object_name like ''EGO%'' OR
         a.object_name like ''BOM%'' OR
         a.object_name like ''ENG%'' )
    AND a.status = ''INVALID''
    order by object_type, object_name',
      p_title                  => 'Product Hub Related Invalid Objects',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invalid objects in the EGO, BOM, ENG, and/or INV schemas.',
...
<li>If you still have invalid objects, please review steps from [1325394/KB401905] Troubleshooting Guide - Invalid Objects in the E-Business Suite Environment 11i and 12</li>
      ...
      p_success_msg            => 'No invalid objects were found in the EGO, BOM, ENG, or INV schemas.',
   ...
   l_info.delete;
debug('end add_signature: INV_EGO_BOM_ENGR_INVALIDS');



debug('begin add_signature: EBS_MFG_INV_OPHANLY_SEQ_PCTUSED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26188',
      p_sig_id                 => 'EBS_MFG_INV_OPHANLY_SEQ_PCTUSED',
      p_sig_sql                => 'SELECT ''MTL_SYSTEM_ITEMS_INTERFACE_S'' "Sequence Name", to_char(max_value, ''999,999,999,999'') "Max Value" 
  ,  to_char(last_number, ''999,999,999,999'')"Next Value" , to_char( last_number / max_value * 100 , ''999.999'') "Percent Used"
    FROM dba_sequences
    WHERE sequence_name = ''MTL_SYSTEM_ITEMS_INTERFACE_S'' 
Union
SELECT ''EGO_IUA_TRANSACTION_ID_S'' "Sequence Name", to_char(max_value, ''999,999,999,999'') "Max Value" 
  ,  to_char(last_number, ''999,999,999,999'')"Next Value" , to_char(  last_number / max_value * 100  , ''999.999'')  "Percent Used"
    FROM dba_sequences
    WHERE sequence_name = ''EGO_IUA_TRANSACTION_ID_S''
Union
SELECT ''EGO_IMPORT_ROW_SEQ_S'' "Sequence Name", to_char(max_value, ''999,999,999,999'') "Max Value" 
  ,  to_char(last_number, ''999,999,999,999'')"Next Value" , to_char(  last_number / max_value * 100  , ''999.999'')  "Percent Used"
    FROM dba_sequences
    WHERE sequence_name = ''EGO_IMPORT_ROW_SEQ_S''
',
      p_title                  => 'Sequence Percent Used',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displays percentage of the sequence range used for various Product Hub related processes',
      p_solution               => 'Review [2379380/KB746068] : How to reset sequence during INCOIN Error ORA-08004: sequence Mtl_System_Items_Interface_S.Nextval exceeds Maxvalue ?  OR  [2826249/KB609304]: 
ORA-08004: Sequence EGO_IUA_TRANSACTION_ID_S.NEXTVAL Exceeds MAXVALUE And Cannot Be Instantiated  OR
[2232358/KB527268] : Need To Increase Max Value Of EGO_IMPORT_ROW_SEQ_S
',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_OPHANLY_SEQ_PCTUSED');



debug('begin add_signature: EBS_MFG_INV_OPHANLY_PATCH_LEVEL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30706',
      p_sig_id                 => 'EBS_MFG_INV_OPHANLY_PATCH_LEVEL',
      p_sig_sql                => 'SELECT  abbreviation, name,  codelevel
FROM  ad_trackable_entities
WHERE abbreviation IN ( ''txk'', ''ad'', ''fwk'', ''fnd'', ''dna'', ''inv'', ''ego'', ''eng'', ''bom'' )
',
      p_title                  => 'Patch Levels',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Patch Level information',
      p_solution               => 'Patch Level information',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_OPHANLY_PATCH_LEVEL');



debug('begin add_signature: EBS_MFG_INV_OPHANLY_DNA_FILEVERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30707',
      p_sig_id                 => 'EBS_MFG_INV_OPHANLY_DNA_FILEVERSIONS',
      p_sig_sql                => 'SELECT DISTINCT   filename, version
FROM  (  SELECT af.filename, afv.version,  DENSE_RANK()
            OVER(PARTITION BY af.filename
        ...
        WHERE  afv.file_id = af.file_id
            AND af.filename IN ( ''dnaworkbenchmenu.ldt'', ''dnarole.ldt'',''dnagrant.ldt'' , ''dnajet_pwb.zip'',''dnajet_pwb_ver.js'' ) )
WHERE  order_rank = 1
ORDER BY 1  
',
      p_title                  => 'Product Workbench (HTML) File Versions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'These are the core file versions for the Product Workbench (HTML/OJET)',
      p_solution               => 'These are the core file versions for the Product Workbench (HTML/OJET). ',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_OPHANLY_DNA_FILEVERSIONS');



debug('begin add_signature: EBS_MFG_INV_OPHANLY_DNA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30708',
      p_sig_id                 => 'EBS_MFG_INV_OPHANLY_DNA',
      p_sig_sql                => 'SELECT name, display_name, description,   owner_tag
FROM wf_local_roles
WHERE   name = ''UMX|DNA_JET_WORKBENCH_ROLE'' 
    AND orig_system = ''UMX''
    AND orig_system_id =  0 ',
      p_title                  => 'Product Workbench Role Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Product Workbench Access Role Information',
      p_solution               => 'Product Workbench Access Role Information',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_OPHANLY_DNA');



debug('begin add_signature: EBS_MFG_INV_OPHANLY_DNA_GRANT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30709',
      p_sig_id                 => 'EBS_MFG_INV_OPHANLY_DNA_GRANT',
      p_sig_sql                => 'select grants.GRANTEE_KEY
, grants.NAME
, grants.DESCRIPTION
, grants.menu_id
, menu.MENU_NAME
...
, fnd_menus_vl menu
 where grants.name  like ''DNA JET Workbench Grant''
 AND grants.menu_id = menu.menu_id',
      p_title                  => 'Product Workbench Grant Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Product Workbench Access Grant Information',
      p_solution               => 'Product Workbench Access Grant Information',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_OPHANLY_DNA_GRANT');
...
debug('begin add_signature: INV_ORGANIZATIONS_FULL_OUTPUT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6145',
      p_sig_id                 => 'INV_ORGANIZATIONS_FULL_OUTPUT',
      p_sig_sql                => 'select * from (SELECT
decode(organization_id, ##$$ORGID$$##, '' * '' || organization_code || '' (Current Organization)'', organization_code) organization_code,
organization_id,
(select b.name from HR_ALL_ORGANIZATION_UNITS_TL b where b.organization_id = mp.organization_id and LANGUAGE = ''US'') organization_name,
NVL((select mp.master_organization_id || '' ('' ||b.organization_code || '')'' from mtl_parameters b where b.organization_id = mp.master_organization_id), mp.master_organization_id) master_organization_id,
NVL((select lookup_code || '' (''|| meaning || '')'' from mfg_lookups where lookup_type = ''MTL_PRIMARY_COST'' and lookup_code = primary_cost_method), primary_cost_method) primary_cost_method,
NVL((select lookup_code || '' (''|| meaning || '')'' from mfg_lookups where lookup_type = ''MTL_NEGATIVE_RECEIPT'' and lookup_code = negative_inv_receipt_code), negative_inv_receipt_code) negative_inv_receipt_code,
NVL((select lookup_code || '' (''|| meaning || '')'' from mfg_lookups where lookup_type = ''MTL_LOCATION_CONTROL'' and lookup_code = stock_locator_control_code), stock_locator_control_code) stock_locator_control_code,
NVL((select mp.cost_organization_id || '' ('' ||b.organization_code || '')'' from mtl_parameters b where b.organization_id = mp.cost_organization_id), mp.cost_organization_id) cost_organization_id,
decode(default_status_id, NULL, ''No'', ''Yes'') onhand_status_enabled,
wms_enabled_flag,
process_enabled_flag,
decode (project_reference_enabled, 1, ''1 (Yes)'', 2, ''2 (No)'', project_reference_enabled) project_reference_enabled,
decode (project_control_level, 1 , ''1 (Project)'', 2 , ''2 (Task)'' , project_control_level) project_control_level,
decode (pm_cost_collection_enabled,1, ''1 (Yes)'', 2, ''2 (No)'', pm_cost_collection_enabled) pm_cost_collection_enabled,
eam_enabled_flag,
lcm_enabled_flag,
wsm_enabled_flag,
wcs_enabled,
...
calendar_code,
decode( general_ledger_update_code, 1, ''1 (Yes)'', 2, ''2 (Yes)'', 3, ''3 (No)'', general_ledger_update_code) general_ledger_update_code,
NVL((select lookup_code || '' (''|| meaning || '')'' from mfg_lookups where lookup_type = ''MTL_INTER_INV_TRANSFER'' and lookup_code = matl_interorg_transfer_code), matl_interorg_transfer_code) matl_interorg_transfer_code,
interorg_transfer_cr_account,
interorg_trnsfr_charge_percent,
NVL((select lookup_code || '' (''|| meaning || '')'' from mfg_lookups where lookup_type = ''MTL_SOURCE_TYPES'' and lookup_code = source_type), source_type) source_type,
source_organization_id,
source_subinventory,
Decode(serial_number_type, ''4'', ''4 (Within inventory model and items)'', NVL((select lookup_code || '' (''|| meaning || '')'' from mfg_lookups where lookup_type = ''MTL_SERIAL_NUMBER_TYPE'' and lookup_code = serial_number_type), serial_number_type)) serial_number_type,
NVL((select lookup_code || '' (''|| meaning || '')'' from mfg_lookups where lookup_type = ''MTL_SERIAL_GENERATION'' and lookup_code = serial_number_generation), serial_number_generation) serial_number_generation,
auto_serial_alpha_prefix,
start_auto_serial_number,
allocate_serial_flag,
NVL((select lookup_code || '' (''|| meaning || '')'' from mfg_lookups where lookup_type = ''MTL_LOT_UNIQUENESS'' and lookup_code = lot_number_uniqueness), lot_number_uniqueness) lot_number_uniqueness,
NVL((select lookup_code || '' (''|| meaning || '')'' from mfg_lookups where lookup_type = ''MTL_LOT_GENERATION'' and lookup_code = lot_number_generation), lot_number_generation) lot_number_generation,
...
FROM mtl_parameters mp)
order by 1, 2',
      p_title                  => 'All Inventory Warehouses',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Provide a listing of organization details as a reference. Note : See "SERIAL_NUMBER_TYPE" column for the serial number uniqueness. ',
      p_solution               => 'Provide a listing of organization details as a reference with the current organization listed first marked with ( * ).  ',
      p_success_msg            => 'No organizations found. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: INV_ORGANIZATIONS_FULL_OUTPUT');
...
debug('begin add_signature: DUPLICATE_UDA_EGO_MSIB');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3372',
      p_sig_id                 => 'DUPLICATE_UDA_EGO_MSIB',
      p_sig_sql                => 'SELECT COUNT(*) AS V_COUNT ,
INVENTORY_ITEM_ID,
ORGANIZATION_ID,
REVISION_ID,
ATTR_GROUP_ID,
...
FROM EGO_FND_DSC_FLX_CTX_EXT B
...
PK2_VALUE
HAVING COUNT(*) > 1',
      p_title                  => 'Duplicate User-Defined Attributes in EGO_MTL_SY_ITEMS_EXT_B',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Duplicate User Defined Attribute (UDA) records were created in the EGO_MTL_SY_ITEMS_EXT_B Table. There are multiple records that were created with the same INVENTORY_ ITEM_ ID, ORGANIZATION_ID and ATTRIBUTE_GROUP_ID. Attribute Values are distributed across these multiple records. These are NOT multi-row attribute groups, so it is expected that only 1 attribute group would be defined per item.',
      p_solution               => 'Review [953449/KB261162] - Standard Datafix To Remove Duplicate User Defined Attribute (UDA) Records Created In EGO_MTL_SY_ITEMS_EXT_B, for full details.',
      p_success_msg            => 'There are no duplicate user-defined attributes in the EGO_MTL_SY_ITEMS_EXT_B Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: DUPLICATE_UDA_EGO_MSIB');



debug('begin add_signature: Orphan_UDA_EGO_MSIB');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3374',
      p_sig_id                 => 'Orphan_UDA_EGO_MSIB',
      p_sig_sql                => 'SELECT organization_id, inventory_item_id, item_catalog_group_id, attr_group_id,
c_ext_attr1, c_ext_attr2, c_ext_attr3, c_ext_attr4 FROM EGO_MTL_SY_ITEMS_EXT_B
WHERE ATTR_GROUP_ID IN
(SELECT ATTR_GROUP_ID
FROM EGO_MTL_SY_ITEMS_EXT_B
MINUS
SELECT ATTR_GROUP_ID FROM EGO_FND_DSC_FLX_CTX_EXT)',
      p_title                  => 'Orphaned User-Defined Attribute Records',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Orphan records exist in the EGO_MTL_SY_ITEMS_EXT_B Table for User-Defined Attributes which will result in the unique constraint EGO_MTL_SY_ITEMS_EXT_B_U2 failure.',
      p_solution               => 'Review [953449/KB261162] - Standard Datafix To Remove Duplicate Or Orphaned User Defined Attribute (UDA) Records Created In EGO_MTL_SY_ITEMS_EXT_B, for full details.',
      p_success_msg            => 'There are no orphaned user-defined attribute records found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: Orphan_UDA_EGO_MSIB');



debug('begin add_signature: OPHANLY_SIMPLE_SEARCH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12250',
      p_sig_id                 => 'OPHANLY_SIMPLE_SEARCH',
      p_sig_sql                => 'select ''Disabled triggers  '' Issue, ''Trigger: ''||trigger_name || '' On Table: ''||t.table_name|| '' Status: ''||status  Detail
from all_triggers t
where (t.table_name like ''MTL_SYSTEM_ITEMS_B%'' or table_name like ''EGO_ITEM_TEXT_TL%'')
and status <> ''ENABLED''
UNION
select ''Missing from MTL_SYSTEM_ITEMS_TL  '' Issue, ''Org ID: ''||to_char(a.organization_id) || '' Item: ''||a.segment1 Detail from mtl_system_items_b a
where   a.organization_id =  ##$$ORGID$$##
       AND nvl( ''##$$ITEMID$$##'',  a.inventory_item_id) = a.inventory_item_id  
       AND not exists (select 1 from mtl_system_items_tl msit
                    where msit.inventory_item_id = a.inventory_item_id
                    and language = ''US''
                    and msit.organization_id = a.organization_id )
UNION
select ''Missing from EGO_ITEM_TEXT_TL  '' Issue, ''Org ID: ''||to_char(a.organization_id) || '' Item: ''||a.segment1 Detail from mtl_system_items_b a
where   a.organization_id =  ##$$ORGID$$##
   AND nvl( ''##$$ITEMID$$##'',  a.inventory_item_id) = a.inventory_item_id  
   and not exists (SELECT 1 from ego_item_text_tl eitl
                where eitl.inventory_item_id = a.inventory_item_id
                and eitl.language = ''US''
                and eitl.org_id = a.organization_id )
UNION
select ''Missing from MTL_ITEM_REVISIONS_B  '' Issue, ''Org ID: ''||to_char(a.organization_id) || '' Item: ''||a.segment1  Detail from mtl_system_items_b a
where   a.organization_id =  ##$$ORGID$$##
   AND nvl( ''##$$ITEMID$$##'',  a.inventory_item_id) = a.inventory_item_id  
   and not exists (select 1 from mtl_item_revisions_b mirb
                where mirb.organization_id = a.organization_id
                and mirb.inventory_item_id = a.inventory_item_id  )',
      p_title                  => 'Item Simple Search Does Not Return Results',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'One or more conditions were found that may prevent the Item Simple Search from working as expected.',
      p_solution               => 'Review [1953747/KB208200] - PIM Item Simple Search Does Not Return Results to clear the condition(s), for full details.',
      p_success_msg            => 'No problem conditions were found preventing the Item Simple Search from working as expected.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OPHANLY_SIMPLE_SEARCH');



debug('begin add_signature: OPHANLY_ENABLED_BUSEVENT_SUBSCRS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12921',
      p_sig_id                 => 'OPHANLY_ENABLED_BUSEVENT_SUBSCRS',
      p_sig_sql                => 'select ws.rule_function, ws.Phase, ws.status subscription_status , ws.rule_data, 
ws.action_code, ws.on_error_code, ws.priority, ws.wf_process_type , ws.wf_process_name , ws.owner_name , ws.java_rule_func, ws.parameters 
from wf_event_subscriptions ws, wf_events we 
where ws.event_filter_guid = we.guid 
and we.STATUS=''ENABLED'' 
and  ws.status=''ENABLED'' 
and  we.NAME = ''##$$FK1$$##''',
      p_title                  => 'List of Business Event Subscriptions In Enabled Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'List of Subscriptions Enabled for Business Events in EGO, BOM, ENG. ',
      p_solution               => '',
      p_success_msg            => 'No business event subscriptions enabled.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OPHANLY_ENABLED_BUSEVENT_SUBSCRS');



debug('begin add_signature: OPHANLY_ENABLED_BUSEVENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12919',
      p_sig_id                 => 'OPHANLY_ENABLED_BUSEVENTS',
      p_sig_sql                => 'Select name "##$$FK1$$##", name business_event_name, licensed_flag ,type,owner_name  ,owner_tag  ,status   
from wf_events 
where (name like ''oracle.apps.ego%'' or ( name like ''oracle.apps.bom%'' ) or ( name like ''oracle.apps.eng%'') or ( name like ''oracle.apps.inv%''))  and status = ''ENABLED''',
      p_title                  => 'Business Events in Enabled Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'List of all the business events enabled for EGO, BOM, ENG and INV. ',
      p_solution               => '',
      p_success_msg            => 'No business events are enabled.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('OPHANLY_ENABLED_BUSEVENT_SUBSCRS'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '13'
      );
   l_info.delete;
debug('end add_signature: OPHANLY_ENABLED_BUSEVENTS');



debug('begin add_signature: OPHANLY_ECO_CUSTOM_WF_STEPS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12932',
      p_sig_id                 => 'OPHANLY_ECO_CUSTOM_WF_STEPS',
      p_sig_sql                => 'SELECT distinct s.wf_process_name 
FROM eng_lifecycle_statuses l, eng_change_route_steps_vl s , eng_change_statuses_vl st 
WHERE l.entity_id1 in (select change_id from eng_engineering_changes 
where change_notice =  ''##$$CHGID$$##'' 
and organization_id = ''##$$ORGID$$##'' 
and plm_or_erp_change = ''PLM'' ) 
AND l.change_wf_route_id = s.route_id (+) 
AND l.status_code = st.status_code  
AND s.wf_process_name not in (''REQUEST_DEFIINITION_AND_APPR'' ,''REQUEST_DEFINITION'' ,''REQUEST_COMMENT'' ,''REQUEST_APPROVAL'' ,''SEND_FYI'' ,''REQUEST_RESPONSE'')',
      p_title                  => 'Engineering Change Order (ECO) Custom Workflow Steps',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Identifies custom workflow steps on the Engineering Change Order (ECO) WorKflow.',
      p_solution               => 'The output identifies custom workflow steps on the given Engineering Change Order (ECO) Workflow.',
      p_success_msg            => 'No custom workflow steps exist on the given Engineering Change Order (ECO) Workflow.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OPHANLY_ECO_CUSTOM_WF_STEPS');



debug('begin add_signature: OPHANLY_STRUC_PENDING_ECN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12950',
      p_sig_id                 => 'OPHANLY_STRUC_PENDING_ECN',
      p_sig_sql                => 'Select eec.organization_id, eri.revised_item_id,  eec.change_notice  , eec.status_code as curr_eco_status, bsb.pending_from_ecn, imp.status_type as pending_ecn_status
from  eng_engineering_changes eec , eng_revised_items eri, bom_structures_b bsb , eng_engineering_changes imp
where  eec.change_notice = ''##$$CHGID$$##'' 
and eec.organization_id =  ''##$$ORGID$$##'' 
and eec.change_notice = eri.change_notice
and eec.organization_id = eri.organization_id
and eri.organization_id = bsb.organization_id
and eri.revised_item_id = bsb.assembly_item_id
and eri.change_notice <> bsb.pending_from_ecn
and bsb.pending_from_ecn = imp.change_notice',
      p_title                  => 'ENG_PENDING_BILL_EXIST Error',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Change Order cannot be implemented due to error ENG_PENDING_BILL_EXIST (Structure Header is pending from a different Change Order).',
      p_solution               => 'Refer to [1372973/KB468440] - Implementation failed: Change Order/Revised Item cannot be implemented as structure header is pending in CO-XXXXX. Please implement the structure header in CO-XXXXX first or [2166575/KB570697] - ENG_PENDING_BILL_EXIST Error in ''Engineering Change Order Implementation'' Program When Implementing an ECO, for full details.',
      p_success_msg            => 'No corruption on  Structure (BOM) Header. ',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OPHANLY_STRUC_PENDING_ECN');



debug('begin add_signature: OPHANLY_ECO_REV_OUT_OF_SEQ');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12951',
      p_sig_id                 => 'OPHANLY_ECO_REV_OUT_OF_SEQ',
      p_sig_sql                => 'select distinct eri.change_notice, old.revision as old_rev , to_char( old.effectivity_date, ''DD-MON-YYYY HH24:MI:SS'') as old_eff_date , new.revision  as new_rev , to_char( new.effectivity_date, ''DD-MON-YYYY HH24:MI:SS'') as new_eff_date,
new.revision_id as new_revision_id, old.revision_id old_revision_id, new.inventory_item_id, new.organization_id
from eng_revised_items eri, mtl_item_revisions_b old ,mtl_item_revisions_b new 
where old.inventory_item_id = new.inventory_item_id
and old.organization_id = new.organization_id
and (old.revision < new.revision and old.effectivity_date >= new.effectivity_date)
and  old.inventory_item_id = eri.revised_item_id
and old.organization_id = eri.organization_id
and  new.inventory_item_id = eri.revised_item_id
and new.organization_id = eri.organization_id
and eri.change_notice = ''##$$CHGID$$##'' 
and eri.organization_id = ''##$$ORGID$$##'' 
order by new.organization_id, new.inventory_item_id, new.revision',
      p_title                  => 'Revised Item Revisions out of Sequence for the Engineering Change Order (ECO)',
      p_fail_condition         => 'RSGT1',
      p_problem_descr          => 'Identifying if Revised Item Revisions on the Engineering Change Order (ECO) are out of sequence.',
      p_solution               => 'Review [388349/KB495868] - How To Correct Item Revisions Which Have Revision And Effectivity Date In Incorrect Alphabetical / Chronological Order?, for full details. ',
      p_success_msg            => 'Revised Item Revisions are in the correct sequence on the Engineering Change Order (ECO).',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OPHANLY_ECO_REV_OUT_OF_SEQ');



debug('begin add_signature: OPHANLY_ECO_STUCK_IN_PROGRESS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12929',
      p_sig_id                 => 'OPHANLY_ECO_STUCK_IN_PROGRESS',
      p_sig_sql                => 'select change_notice , change_name , change_id , organization_id , description , status_type , status_code , initiation_date , need_by_date , implementation_date
, cancellation_date , cancellation_comments , priority_code , reason_code , requestor_id , assignee_id , approval_status_type , approval_date , approval_list_id
, approval_request_date , responsible_organization_id , hierarchy_flag , organization_hierarchy , hierarchy_id , plm_or_erp_change , promote_status_code
, change_mgmt_type_code , change_order_type_id , project_id , task_id , implementation_req_id , request_id  , creation_date , created_by , last_update_date , last_updated_by
from eng_engineering_changes
where status_type = 10  
and change_notice = ''##$$CHGID$$##''
and organization_id = ''##$$ORGID$$##'' ',
      p_title                  => 'Change Order Stuck',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Identifies if the Engineering Change Order (ECO) is stuck in status Implementation Failed or Implementation In Progress.',
      p_solution               => 'The Engineering Change Order (ECO) has been identified as stuck in a status of Implementation Failed or Implementation In Progress. Review the datafix in [1072107/KB464045] - Change Order Stuck With Status Approved (Implementation In Progress).',
      p_success_msg            => 'The Engineering Change Order (ECO) is not stuck in a status of Implementation Failed or Implementation In Progress.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OPHANLY_ECO_STUCK_IN_PROGRESS');



debug('begin add_signature: OPHANLY_WEBAD_OUTOFMEMORY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12281',
      p_sig_id                 => 'OPHANLY_WEBAD_OUTOFMEMORY',
      p_sig_sql                => 'select execution_options, user_concurrent_program_name from fnd_concurrent_programs_vl where user_concurrent_program_name =
''EGO Spreadsheet Java Concurrent Program'' and instr(execution_options,''-Xmx2048m'') = 0',
      p_title                  => 'Standard WEBADI Program EGO Spreadsheet Concurrent Program Errors with Exception in thread main java.lang.OutOfMemoryError: Java heap space',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Memory allocation for the EGO Spreadsheet Java Concurrent Program may be set to a low value, which can cause Timeout errors.',
      p_solution               => 'Review [1672592/KB390462] - Standard WEBADI Program EGO Spreadsheet Concurrent Program Errors with Exception in thread ''main'' java.lang.OutOfMemoryError: Java heap space, for full details.',
      p_success_msg            => 'Memory settings for the EGO Spreadsheet Java Concurrent Program are at an acceptable level.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OPHANLY_WEBAD_OUTOFMEMORY');



debug('begin add_signature: EBS_MFG_INV_LIFECYCLE_PENDING_PHASE_CHANGE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26395',
      p_sig_id                 => 'EBS_MFG_INV_LIFECYCLE_PENDING_PHASE_CHANGE',
      p_sig_sql                => 'SELECT
    *
FROM
    ...
    ( inventory_item_id,
      ...
      phase_id ) IN (
        ...
        FROM
            ...
            mtl_parameters            mp
        WHERE
            mpis.inventory_item_id = msib.inventory_item_id
            AND mpis.lifecycle_id = msib.lifecycle_id
            AND mpis.phase_id = msib.current_phase_id
            AND msib.organization_id = mp.master_organization_id
            AND mpis.organization_id = mp.organization_id
            AND mp.organization_id = ''##$$ORGID$$##''
            AND mpis.inventory_item_id = nvl(''##$$ITEMID$$##'', mpis.inventory_item_id)
            AND pending_flag = ''Y''
    )
    AND pending_flag = ''Y''',
      p_title                  => 'Lifecycle Pending Phase Change',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'When attempting to Implement a Phase change of an Item, the following error occurs :
"A pending phase change already exists for item &ITEM_NUMBER in organization &ORG_NAME.  Please implement/cancel the pending phase change for the item before creating new phase changes".',
      p_solution               => 'Refer to the solution action plan from  [2873682/KB585521].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_LIFECYCLE_PENDING_PHASE_CHANGE');
...
debug('begin add_signature: DATABASE_INITIALIZATION_12_NO_QUOTES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10660',
      p_sig_id                 => 'DATABASE_INITIALIZATION_12_NO_QUOTES',
      p_sig_sql                => 'select name ParameterName, nvl(value,''null'') ParameterValue from v$parameter order by name',
      p_title                  => 'V$parameter settings (database initialization parameters from init.ora file)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Database Initialization Parameters',
      p_solution               => '',
      p_success_msg            => '<ul><li>If you have performance issue please ensure you have correct database initialization parameters as per [11158187/KA1002] Database Initialization Parameters for Oracle E-Business Suite Release 12</li>
<li>Use [2126712/KB627702] EBS Database Performance and Statistics Analyzer</li>
<li>This will help you to identify the difference between actual values and required values. Verify that all Mandatory Parameters - MP are set correctly</li></ul>',
   ...
   l_info.delete;
debug('end add_signature: DATABASE_INITIALIZATION_12_NO_QUOTES');
...
debug('begin add_signature: MSI_ATTRIBUTES_ORG_ITEM');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6148',
      p_sig_id                 => 'MSI_ATTRIBUTES_ORG_ITEM',
      p_sig_sql                => 'SELECT USER_GROUP_NAME,
  USER_ATTRIBUTE_NAME,
  SUBSTR(USER_ATTRIBUTE_VALUE,1,50) USER_ATTRIBUTE_VALUE,
  CONTROL_LEVEL_DSP
FROM MTL_ITEM_ATTRIBUTE_VALUES_V
WHERE organization_id = NVL(''##$$ORGID$$##'', organization_id)
  AND inventory_item_id = ''##$$ITEMID$$##''
ORDER BY USER_GROUP_NAME, SEQUENCE ASC',
      p_title                  => 'Specific Item Attributes',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This is reference data for item details but with translated values for each attribute from the attribute view (MTL_ITEM_ATTRIBUTE_VALUES_V) only when the item parameter is specified. Item details are only displayed if the item parameter is specified.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: MSI_ATTRIBUTES_ORG_ITEM');
...
debug('begin add_signature: EBS_MFG_INV_OPHANLY_ITM_STS_ATTRS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26189',
      p_sig_id                 => 'EBS_MFG_INV_OPHANLY_ITM_STS_ATTRS',
      p_sig_sql                => 'SELECT * FROM
( select sts.inventory_item_status_code, substr(sts.attribute_name, 18) Attribute_Name, sts.attribute_value
from mtl_status_attribute_values sts , mtl_system_items_b msi
where sts.inventory_item_status_code = msi.inventory_item_status_code  )
PIVOT ( MAX(attribute_value)
  FOR attribute_name
  IN   ( ''BOM_ENABLED_FLAG'' AS  "BOM_ENABLED_FLAG"  
        ,''BUILD_IN_WIP_FLAG'' AS "BUILD_IN_WIP_FLAG"  
        ,''INTERNAL_ORDER_ENABLED_FLAG'' AS "INTERNAL_ORDER_ENABLED_FLAG"  
        ,''INVOICE_ENABLED_FLAG'' AS "INVOICE_ENABLED_FLAG"  
        ,''MTL_TRANSACTIONS_ENABLED_FLAG'' AS "MTL_TRANSACTIONS_ENABLED_FLAG"  
        ,''PROCESS_EXECUTION_ENABLED_FLAG'' AS "PROCESS_EXECUTION_ENABLED_FLAG"  
      ...
      p_title                  => 'Item Status Attributes',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displays Item Status Controlled Attribute Values For Item ',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_OPHANLY_ITM_STS_ATTRS');
...
debug('begin add_signature: ITEM_ORG_PENDING_DEMAND');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11401',
      p_sig_id                 => 'ITEM_ORG_PENDING_DEMAND',
...
primary_uom_quantity, REQUIREMENT_DATE, completed_quantity, supply_source_type, supply_source_header_id, revision, lot_number, serial_number, subinventory, locator_id, n_column1
  FROM mtl_demand
WHERE inventory_item_id = ''##$$ITEMID$$##'' 
  AND organization_id = ''##$$ORGID$$##''',
      p_title                  => 'Pending Demand by Item and Organization (MTL_DEMAND)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are pending Demand records in the MTL_DEMAND Table for the Item and specific Organization. This can lead to incorrect display of Onhand Quantity and may interfere with Reservations.',
      p_solution               => 'The pending demand needs to be processed. To resolve:
<ul>
...
<li>Also see the additional [401342/KB769497] - Cycle Count Reservations Stuck In Mtl_reservations/Mtl_demand Tables, for more information</li>
</ul>',
   ...
   l_info.delete;
debug('end add_signature: ITEM_ORG_PENDING_DEMAND');
...
debug('begin add_signature: ITEM_ORPHAN_RECORDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7082',
      p_sig_id                 => 'ITEM_ORPHAN_RECORDS',
      p_sig_sql                => 'SELECT ''Expand subsections below to see which tables have Orphaned Records for all Items'' "Item Orphan Records Corruption" FROM dual',
      p_title                  => 'Item Orphan Records Data Corruption',
      p_fail_condition         => '[count]<[0]',
      p_problem_descr          => 'Records for an Item exist in at least one of the below tables but do not exist in the MTL_SYSTEM_ITEMS_B Table, and are considered as Orphaned Records. This check runs for all Inventory Items:
...
ENI_OLTP_ITEM_STAR
CST_ITEM_COSTS
Because of the issue, Users are not be able to assign the orphaned items to a child organization. 
The following error might occur when attempting to assign an item to an organization:
APP-INV-05479 Please commit or clear your changes first
',
      p_solution               => '<ul><li>Review [1065107/KB794567] - APP-INV-05479 Standard Datafix To Find Orphan Item Records.</li></ul>',
      p_success_msg            => 'If there is an error in one of the child checks, please review. Otherwise, no data returned.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('ITEM_ORPHAN_RECORDS_REV_B','ITEM_ORPHAN_RECORDS_REV_TL','ITEM_ORPHAN_RECORDS_CATEGORY','ITEM_ORPHAN_RECORDS_STATUS','ITEM_ORPHAN_RECORDS_TL','ITEM_ORPHAN_RECORDS_CST','ITEM_ORPHAN_RECORDS_ENI'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '104'
      );
   l_info.delete;
debug('end add_signature: ITEM_ORPHAN_RECORDS');
...
debug('begin add_signature: OPHANLY_ECO_EEC_DATA');
   l_info('##MASK##ATTRIBUTE_CATEGORY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CANCELLATION_COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12420',
      p_sig_id                 => 'OPHANLY_ECO_EEC_DATA',
      p_sig_sql                => 'select * from eng_engineering_changes where change_notice=''##$$CHGID$$##'' and organization_id=''##$$ORGID$$##''',
      p_title                  => 'ENG_ENGINEERING_CHANGES Data',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Information about the Engineering Change Order (ECO) from the ENG_ENGINEERING_CHANGES Table.',
      p_solution               => 'The ENG_ENGINEERING_CHANGES Table stores information about engineering change order headers. Each row includes the unique identifier of the ECO, the description, the change order type, the reason and priority codes, the status, the requestor, the approval list and approval status, the implementation costs, and any cancellation information.',
      p_success_msg            => 'No information exists for the provided Engineering Change Order (ECO) from the ENG_ENGINEERING_CHANGES Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OPHANLY_ECO_EEC_DATA');



debug('begin add_signature: OPHANLY_ECO_BSB');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12947',
      p_sig_id                 => 'OPHANLY_ECO_BSB',
      p_sig_sql                => 'select  bsb.pending_from_ecn , bsb.bill_sequence_id, bsb.assembly_item_id , bsb.organization_id , bsb.alternate_bom_designator,
bsb.common_assembly_item_id, bsb.common_bill_sequence_id, bsb.common_organization_id , bsb.source_bill_sequence_id ,
bsb.next_explode_date, bsb.structure_type_id, bsb.implementation_date, bsb.pk1_value, bsb.pk2_value,  bsb.pk3_value,  bsb.pk4_value, 
bsb.pk5_value, bsb.effectivity_control, bsb.is_preferred , bsb.specific_assembly_comment , bsb.assembly_type, 
bsb.last_update_date, bsb.last_updated_by, bsb.creation_date, bsb.created_by
from bom_structures_b bsb, eng_revised_items eri
where  bsb.assembly_item_id = eri.revised_item_id
and  bsb.organization_id = eri.organization_id
and eri.change_notice = ''##$$CHGID$$##'' 
and eri.organization_id = ''##$$ORGID$$##'' ',
      p_title                  => 'BOM Structure Header (ECO)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Information about Structure (BOM) for Revised Items on Change Order. ',
      p_solution               => '',
      p_success_msg            => 'No structure (BOM) associated to Change Order.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: OPHANLY_ECO_BSB');



debug('begin add_signature: OPHANLY_ECO_ERI');
   l_info('##MASK##CANCEL_COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COPY_TO_ITEM_DESC'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CREATED_BY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##LAST_UPDATED_BY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##NEW_REVISION_REASON'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##NEW_REV_DESRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ROUTING_COMMENT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12574',
      p_sig_id                 => 'OPHANLY_ECO_ERI',
      p_sig_sql                => 'select eri.change_notice , eri.organization_id , eri.revised_item_id , msi.concatenated_segments "Revised Item Number"
, eri.early_schedule_date , eri.scheduled_date , eri.implementation_date , eri.cancellation_date
, eri.cancel_comments , eri.disposition_type , eri.new_item_revision , eri.auto_implement_date , eri.status_type
, eri.status_code , eri.bill_sequence_id , eri.mrp_active , eri.update_wip , eri.use_up
, eri.use_up_item_id , eri.use_up_plan_name , eri.Completion_subinventory , eri.completion_locator_id
, eri.priority , eri.new_item_revision_id , eri.new_revision_label , eri.new_revision_reason , eri.new_rev_description
, eri.routing_sequence_id , eri.new_routing_revision , eri.routing_comment , eri.alternate_bom_designator
, eri.transfer_or_copy , eri.transfer_or_copy_item , eri.transfer_or_copy_bill , eri.transfer_or_copy_routing , eri.copy_to_item , eri.copy_to_item_Desc , eri.change_id , eri.current_item_revision_id , eri.current_lifecycle_state_id , eri.new_lifecycle_state_id , eri.eco_for_production , eri.revised_item_sequence_id , eri.implementation_req_id
, eri.request_id  , eri.creation_date , eri.created_by , eri.last_update_date , eri.last_updated_by
from eng_revised_items eri, mtl_system_items_kfv msi
where eri.change_notice =''##$$CHGID$$##''
and eri.organization_id = ''##$$ORGID$$##''  
and eri.revised_item_id = msi.inventory_item_id
and eri.organization_id = msi.organization_id',
      p_title                  => 'Revised Items on the Engineering Change Order (ECO)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Information about revised items on the Engineering Change Order (ECO).',
      p_solution               => '',
      p_success_msg            => 'No revised items exist on the Engineering Change Order (ECO).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OPHANLY_ECO_ERI');



debug('begin add_signature: OPHANLY_ECO_ITEM_DATA');
   l_info('##MASK##CREATED_BY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##LAST_UPDATED_BY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##LAST_UPDATE_LOGIN'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12637',
      p_sig_id                 => 'OPHANLY_ECO_ITEM_DATA',
      p_sig_sql                => 'select msi.* 
from mtl_system_items_b msi , eng_revised_items eri
where msi.inventory_item_id = eri.revised_item_id
and msi.organization_id = eri.organization_id
and eri.change_notice =  ''##$$CHGID$$##''
and eri.organization_id  =  ''##$$ORGID$$##''',
      p_title                  => 'Revised Item Attributes on the Engineering Change Order (ECO)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Information about Item Attributes on the Engineering Change Order (ECO).',
      p_solution               => '',
      p_success_msg            => 'No revised Item Attributes exist on the Engineering Change Order (ECO).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OPHANLY_ECO_ITEM_DATA');



debug('begin add_signature: OPHANLY_ECO_ITEM_REVS');
   l_info('##MASK##CREATED_BY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##LAST_UPDATED_BY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12638',
      p_sig_id                 => 'OPHANLY_ECO_ITEM_REVS',
      p_sig_sql                => 'select mir.inventory_item_id
, mir.organization_id
, mir.revision_id
, mir.revision
, mir.revision_label
...
, mir.last_updated_by
, mir.request_id
from mtl_item_revisions mir , eng_revised_items eri
where mir.inventory_item_id = eri.revised_item_id
and mir.organization_id = eri.organization_id 
and eri.change_notice = ''##$$CHGID$$##''
and eri.organization_id  = ''##$$ORGID$$##'' 
order by mir.effectivity_date',
      p_title                  => 'Items with Revisions on the Engineering Change Order (ECO)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Information about Item Revisions on the Engineering Change Order (ECO).',
      p_solution               => '',
      p_success_msg            => 'No Item Revisions exist on the Engineering Change Order (ECO).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OPHANLY_ECO_ITEM_REVS');



debug('begin add_signature: OPHANLY_ECO_BOM_COMPS');
   l_info('##MASK##CREATED_BY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##DELETE_GROUP_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##DG_DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##LAST_UPDATED_BY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12620',
      p_sig_id                 => 'OPHANLY_ECO_BOM_COMPS',
      p_sig_sql                => 'select 
bic.change_notice
...
, bic.creation_date
, bic.created_by
from bom_inventory_components bic, mtl_system_items_kfv msi
where bic.change_notice = ''##$$CHGID$$##''
and bic.pk2_value =  ''##$$ORGID$$##'' 
and bic.component_item_id = msi.inventory_item_id 
and bic.pk2_value = msi.organization_id',
      p_title                  => 'BOM Revised Components for the Engineering Change Order (ECO)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Information about revised components on the Engineering Change Order (ECO).',
      p_solution               => '',
      p_success_msg            => 'No revised components exist on the Engineering Change Order (ECO).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OPHANLY_ECO_BOM_COMPS');



debug('begin add_signature: OPHANLY_ECO_ERC');
   l_info('##MASK##CANCEL_COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CREATED_BY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##LAST_UPDATED_BY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12575',
      p_sig_id                 => 'OPHANLY_ECO_ERC',
      p_sig_sql                => 'select erc.revised_item_sequence_id , erc.component_item_id , msi.concatenated_segments as ComponentNumber
, erc.acd_type , erc.operation_sequence_num , erc.item_num , erc.bill_sequence_id , eec.change_notice
, erc.effectivity_date , erc.implementation_date , erc.disable_date , erc.component_quantity , erc.component_yield_factor
, erc.planning_factor , erc.cost_factor , erc.quantity_related , erc.so_basis , erc.optional , erc.mutually_exclusive_options
, erc.check_atp , erc.shipping_allowed , erc.required_to_ship , erc.required_for_revenue , erc.include_on_bill_docs
, erc.include_on_ship_docs , erc.include_in_cost_rollup , erc.pick_components , erc.component_sequence_id , erc.old_component_sequence_id , erc.common_component_sequence_id , erc.parent_bill_seq_id , erc.wip_supply_type , erc.supply_subinventory , erc.supply_locator_id , erc.component_item_revision_id , erc.component_remarks
, erc.cancellation_date , erc.cancel_comments , erc.eco_for_production , erc.enforce_int_requirements
, erc.optional_on_model , erc.plan_level , erc.auto_request_material , erc.from_object_revision_id , erc.to_object_revision_id
, erc.from_end_item_unit_number , to_end_item_unit_number , erc.request_id  , erc.creation_date , erc.created_by
, erc.last_update_date , erc.last_updated_by
from eng_revised_components erc, eng_engineering_changes eec, mtl_system_items_kfv msi
where eec.change_notice = ''##$$CHGID$$##''
and eec.organization_id = ''##$$ORGID$$##''
...
and eec.organization_id = msi.organization_id',
      p_title                  => 'ENG Revised Components for the Engineering Change Order (ECO)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Information about the Engineering Change Order (ECO) Order Revised Components.',
      p_solution               => '',
      p_success_msg            => 'No revised components exist on the Engineering Change Order (ECO).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OPHANLY_ECO_ERC');



debug('begin add_signature: OPHANLY_ECO_BOM_RDS');
   l_info('##MASK##CREATED_BY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##LAST_UPDATED_BY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##REF_DESIGNATOR_COMMENT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12621',
      p_sig_id                 => 'OPHANLY_ECO_BOM_RDS',
      p_sig_sql                => 'select 
brd.change_notice
...
, brd.last_update_date
, brd.last_updated_by
, brd.creation_date
, brd.created_by
from bom_reference_designators brd, bom_inventory_components bic
where brd.component_sequence_id = bic.component_sequence_id 
and brd.change_notice = bic.change_notice
and brd.change_notice = ''##$$CHGID$$##'' 
and bic.pk2_value =  ''##$$ORGID$$##''',
      p_title                  => 'BOM Reference Designators on the Engineering Change Order (ECO)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Information about reference designators on the Engineering Change Order (ECO).',
      p_solution               => '',
      p_success_msg            => 'No reference designators exist on the Engineering Change Order (ECO).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OPHANLY_ECO_BOM_RDS');



debug('begin add_signature: OPHANLY_ECO_BOM_SCS');
   l_info('##MASK##CREATED_BY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##LAST_UPDATED_BY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12622',
      p_sig_id                 => 'OPHANLY_ECO_BOM_SCS',
      p_sig_sql                => 'select 
...
, bsc.common_component_sequence_id
, bsc.last_update_date
, bsc.last_updated_by
, bsc.creation_date
, bsc.created_by
from bom_substitute_components bsc, bom_inventory_components bic
where bsc.component_sequence_id = bic.component_sequence_id 
and bsc.change_notice = bic.change_notice
and bsc.change_notice = ''##$$CHGID$$##'' 
and bic.pk2_value =  ''##$$ORGID$$##''',
      p_title                  => 'BOM Substitute Components on the Engineering Change Order (ECO)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Information about substitute components on the Engineering Change Order (ECO).',
      p_solution               => '',
      p_success_msg            => 'No substitute components exist on the Engineering Change Order (ECO).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OPHANLY_ECO_BOM_SCS');



debug('begin add_signature: OPHANLY_ECO_ORG_HRCHY');
   l_info('##MASK##NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12635',
      p_sig_id                 => 'OPHANLY_ECO_ORG_HRCHY',
      p_sig_sql                => 'select pos.organization_structure_id
, pos.name 
, posv.org_structure_version_id
, posv.date_from
, posv.date_to
from per_organization_structures_v pos , per_org_structure_versions posv
where pos.organization_structure_id in (select hierarchy_id from eng_engineering_changes eco where change_notice = ''##$$CHGID$$##'' and organization_id =  ''##$$ORGID$$##'' ) 
and pos.organization_structure_id = posv.organization_structure_id
and sysdate between posv.date_from  and nvl(posv.date_to, sysdate+1)',
      p_title                  => 'Organization Hierarchy on the Engineering Change Order (ECO)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Information about Organization Hierarchy on the Engineering Change Order (ECO).
',
      p_solution               => '',
      p_success_msg            => 'No Organization Hierarchy is defined for the Engineering Change Order (ECO).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OPHANLY_ECO_ORG_HRCHY');



debug('begin add_signature: OPHANLY_ECO_ORG_HRCHY_ORGS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12636',
      p_sig_id                 => 'OPHANLY_ECO_ORG_HRCHY_ORGS',
      p_sig_sql                => 'select posel.organization_id_parent
, posel.d_parent_name "Parent" 
, posel.org_structure_version_id
, posel.organization_id_child
, posel.d_child_name "Child"
from per_org_structure_elements_v posel , per_organization_structures_v pos , per_org_structure_versions posv
where posel.org_structure_version_id = posv.org_structure_version_id
and pos.organization_structure_id in (select hierarchy_id from eng_engineering_changes eco where change_notice = ''##$$CHGID$$##'' and organization_id = ''##$$ORGID$$##'') 
and pos.organization_structure_id = posv.organization_structure_id
and sysdate between posv.date_from  and nvl(posv.date_to, sysdate+1)',
      p_title                  => 'Organizations in the Organization Hierarchy for the Engineering Change Order (ECO)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Information about Organizations on Organization hierarchy on the Engineering Change Order (ECO).
',
      p_solution               => '',
      p_success_msg            => 'No Organizations exist on the Organization Hierarchy defined on the Engineering Change Order (ECO).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OPHANLY_ECO_ORG_HRCHY_ORGS');



debug('begin add_signature: OPHANLY_ECO_BOR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12948',
      p_sig_id                 => 'OPHANLY_ECO_BOR',
      p_sig_sql                => 'select bor.pending_from_ecn, bor.routing_sequence_id, bor.assembly_item_id,  bor.organization_id , bor.alternate_routing_designator,
bor.routing_type, bor.common_assembly_item_id, bor.common_routing_sequence_id, bor.routing_comment, bor.completion_subinventory, bor.completion_locator_id,
bor.line_id, bor.cfm_routing_flag, bor.mixed_model_map_flag, bor.priority, bor.total_product_cycle_time, bor.ctp_flag, bor.serialization_start_op,
bor.last_update_date, bor.last_updated_by, bor.creation_date, bor.created_by
from bom_operational_routings bor,  eng_revised_items eri
where bor.assembly_item_id = eri.revised_item_id
and bor.organization_id = eri.organization_id
and bor.pending_from_ecn = eri.change_notice 
and eri.change_notice = ''##$$CHGID$$##'' 
and eri.organization_id = ''##$$ORGID$$##'' ',
      p_title                  => 'BOM Routing Header (ECO)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Information about Routing Headers on Change Order. 
',
      p_solution               => '',
      p_success_msg            => 'No routing header associated to Change Order.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: OPHANLY_ECO_BOR');



debug('begin add_signature: OPHANLY_ECO_BOM_OPRES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12925',
      p_sig_id                 => 'OPHANLY_ECO_BOM_OPRES',
      p_sig_sql                => 'select bor.operation_sequence_id , bor.resource_seq_num , bor.resource_id , bor.change_notice , bor.acd_type , bor.activity_id , bor.standard_rate_flag , bor.assigned_units
, bor.usage_rate_or_amount , bor.usage_rate_or_amount_inverse , bor.basis_type , bor.schedule_flag , bor.resource_offset_percent , bor.autocharge_type , bor.setup_id
, bor.principle_flag , bor.schedule_seq_num , bor.last_update_date , bor.last_updated_by , bor.creation_date , bor.created_by 
from bom_operation_resources bor ,  bom_operation_sequences bos , eng_revised_items eri 
where  eri.change_notice =  ''##$$CHGID$$##''
and bos.revised_item_sequence_id = eri.revised_item_sequence_id
and bos.operation_sequence_id = bor.operation_sequence_id
and bos.change_notice = bor.change_notice
and bos.change_notice = eri.change_notice  
and eri.organization_id =''##$$ORGID$$##''',
      p_title                  => 'BOM Revised Operation Resources for the Engineering Change Order (ECO)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Identifies information about Revised Operation Resources on the Engineering Change Order (ECO).',
      p_solution               => '',
      p_success_msg            => 'No revised operation resources are present on the Engineering Change Order (ECO).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OPHANLY_ECO_BOM_OPRES');



debug('begin add_signature: OPHANLY_ECO_BOM_OPSEQ');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12924',
      p_sig_id                 => 'OPHANLY_ECO_BOM_OPSEQ',
      p_sig_sql                => 'select bos.operation_sequence_id , bos.routing_sequence_id , bos.operation_seq_num , bos.standard_operation_id  , bos.reference_flag , bos.department_id , bos.old_operation_sequence_id , bos.acd_type , bos.revised_item_sequence_id , bos.change_notice , bos.implementation_date , bos.eco_for_production
, bos.operation_description , bos.operation_lead_time_percent , bos.operation_type , bos.operation_yield_enabled , bos.include_in_rollup , bos.effectivity_date , bos.disable_date
, bos.backflush_flag , bos.count_point_type , bos.option_dependent_flag , bos.minimum_transfer_quantity , bos.last_update_date , bos.last_updated_by , bos.creation_date , bos.created_by
from bom_operation_sequences bos , eng_revised_items eri 
where eri.change_notice =  ''##$$CHGID$$##''
and bos.revised_item_sequence_id = eri.revised_item_sequence_id
and bos.change_notice = eri.change_notice 
and eri.organization_id = ''##$$ORGID$$##''',
      p_title                  => 'BOM Revised Operations on the Engineering Change Order (ECO)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Identifies information about Revised Operations on the Engineering Change Order (ECO).',
      p_solution               => '',
      p_success_msg            => 'No revised operations are present on the Engineering Change Order (ECO).
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: OPHANLY_ECO_BOM_OPSEQ');



debug('begin add_signature: OPHANLY_ECO_BOM_RTGREV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12927',
      p_sig_id                 => 'OPHANLY_ECO_BOM_RTGREV',
      p_sig_sql                => 'select mri.organization_id , mri.inventory_item_id , mri.process_revision , mri.change_notice , mri.ecn_initiation_date , mri.implementation_date
, mri.implemented_serial_number , mri.effectivity_date , mri.revised_item_sequence_id  , mri.last_update_date , mri.last_updated_by , mri.creation_date , mri.created_by
from mtl_rtg_item_revisions mri ,  eng_revised_items eri 
where eri.change_notice = ''##$$CHGID$$##''
and eri.revised_item_id = mri.inventory_item_id
and eri.organization_id = mri.organization_id
and eri.organization_id = ''##$$ORGID$$##'' ',
      p_title                  => 'Routing Revisions for the Engineering Change Order (ECO)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Identifies information about the Routing Revisions on the Engineering Change Order (ECO).',
      p_solution               => '',
      p_success_msg            => 'No routing revisions present on the Engineering Change Order (ECO).
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: OPHANLY_ECO_BOM_RTGREV');



debug('begin add_signature: OPHANLY_ECO_ROUTES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12930',
      p_sig_id                 => 'OPHANLY_ECO_ROUTES',
      p_sig_sql                => 'select l.entity_id1 as Change_id, l.sequence_number, l.status_code, st.status_name, l.start_date, l.completion_date
, l.change_wf_route_id  ,wf.route_name ,wf.route_type_code,  l.auto_promote_status , l.Auto_demote_status, l.start_workflow_flag, l.workflow_status
, l.change_editable_flag, l.iteration_number, l.active_flag, l.wf_sig_policy, l.change_wf_route_template_id ,wf.route_start_date  ,wf.route_end_date 
from eng_lifecycle_statuses l ,  eng_change_statuses_vl st , eng_change_routes_vl wf
where l.entity_id1 in (select change_id from eng_engineering_changes 
where change_notice =  ''##$$CHGID$$##'' 
and organization_id =  ''##$$ORGID$$##'' 
and plm_or_erp_change = ''PLM'')  
and l.status_code = st.status_code
and l.change_wf_route_id  = wf.route_id (+)
order by l.sequence_number',
      p_title                  => 'Engineering Change Order (ECO) Workflow Statuses',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Identifies the list of Workflow statuses on the given Engineering Change Order (ECO).',
      p_solution               => '',
      p_success_msg            => 'No workflow associated for the given Engineering Change Order (ECO).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OPHANLY_ECO_ROUTES');



debug('begin add_signature: OPHANLY_ECO_ROUTE_STEPS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12931',
      p_sig_id                 => 'OPHANLY_ECO_ROUTE_STEPS',
      p_sig_sql                => 'SELECT l.sequence_number,  l.status_code,  st.status_name, s.step_seq_num,  s.instruction,  l.start_date,   s.wf_item_type, s.wf_item_key, s.wf_process_name 
, s.condition_type_code , l.change_wf_route_id, s.step_id , s.route_id
FROM eng_lifecycle_statuses l, eng_change_route_steps_vl s  , eng_change_statuses_vl st 
WHERE  l.entity_id1 in (select change_id 
from eng_engineering_changes 
where change_notice = ''##$$CHGID$$##'' 
and organization_id = ''##$$ORGID$$##'' 
and plm_or_erp_change = ''PLM'' )
AND l.change_wf_route_id = s.route_id (+)
AND l.status_code = st.status_code
order by l.sequence_number, s.step_seq_num',
      p_title                  => 'Engineering Change Order (ECO) Workflow Steps',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'A list of all Engineering Change Order (ECO) Workflow Steps for the ECO.',
      p_solution               => '',
      p_success_msg            => 'No Engineering Change Order (ECO) Workflow Steps are associated to the ECO.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OPHANLY_ECO_ROUTE_STEPS');



debug('begin add_signature: EBS_MFG_INV_OPHANLY_INCORRECT_ROUTING_SEQ_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26826',
      p_sig_id                 => 'EBS_MFG_INV_OPHANLY_INCORRECT_ROUTING_SEQ_ID',
      p_sig_sql                => 'select change_notice, revised_item_id, organization_id,status_type, bill_sequence_id, routing_sequence_id,
revised_item_sequence_id,change_id, (select routing_sequence_id from BOM_OPERATIONAL_ROUTINGS b where b.organization_id= eri.organization_id
and b.assembly_item_id= eri.revised_item_id) correct_routing_seq
from eng_revised_items eri
where change_notice = ''##$$CHGID$$##'' 
and organization_id =  ''##$$ORGID$$##'' 
and routing_sequence_id IS NOT NULL
and not exists (select 1 from BOM_OPERATIONAL_ROUTINGS bor where bor.routing_sequence_id =eri.routing_sequence_id)',
      p_title                  => 'Incorrect Routing Sequence ID',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Engineering Change Order Implementation request completed with Error: ORA-01403: no data found
when routing sequence ID in eng_revised_items table is incorrect.',
      p_solution               => 'Refer to [1372973/KB468440] and please log a service request with Oracle Engineering for a datafix.',
      p_success_msg            => 'No corruption  in eng_revised_items table for a Change Notice',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_OPHANLY_INCORRECT_ROUTING_SEQ_ID');
...
BEGIN
  ...
  analyzer_title := 'Product Hub Analyzer';
...
debug('begin section: ProactiveRecommendations');
start_section('Proactive Recommendations', 'ProactiveRecommendations');
   set_item_result(run_stored_sig('INV_EGO_BOM_ENGR_INVALIDS'));
   set_item_result(check_rec_patches_1); /* Signature OPHANLY_RUPS */
   set_item_result(run_stored_sig('EBS_MFG_INV_OPHANLY_SEQ_PCTUSED'));
   set_item_result(run_stored_sig('EBS_MFG_INV_OPHANLY_PATCH_LEVEL'));
   set_item_result(run_stored_sig('EBS_MFG_INV_OPHANLY_DNA_FILEVERSIONS'));
   set_item_result(run_stored_sig('EBS_MFG_INV_OPHANLY_DNA'));
   set_item_result(run_stored_sig('EBS_MFG_INV_OPHANLY_DNA_GRANT'));
end_section;
debug('end section: ProactiveRecommendations');

debug('begin section: OrgDetails');
start_section('Organization Details', 'OrgDetails');
   set_item_result(run_stored_sig('INV_ORGANIZATIONS_FULL_OUTPUT_ORG'));
   set_item_result(run_stored_sig('INV_ORGANIZATIONS_FULL_OUTPUT'));
   set_item_result(run_stored_sig('OPHANLY_INACTIVE_ORGS'));
end_section;
debug('end section: OrgDetails');

debug('begin section: ItemDetails');
start_section('Item Details', 'ItemDetails');
   IF g_sql_tokens('##$$ITEMID$$##') IS NOT NULL THEN
      set_item_result(run_stored_sig('EBS_MFG_INV_INVTAZ_ITEMS_KFF'));
      set_item_result(run_stored_sig('MSI_ATTRIBUTES_ORG_ITEM'));
      set_item_result(run_stored_sig('ITEM_MTL_SYSTEM_ITEMS_B'));
      set_item_result(run_stored_sig('EBS_MFG_INV_OPHANLY_ITM_STS_ATTRS'));
      set_item_result(run_stored_sig('EBS_MFG_INV_OPHANLY_ITEM_STATUS_HISTORY'));
      set_item_result(run_stored_sig('ITEM_ORG_PENDING_DEMAND'));
      ...
      set_item_result(run_stored_sig('ITEM_ORPHAN_RECORDS'));
      set_item_result(run_stored_sig('ITEM_INVALID_DUAL_UOM_CONTROL'));
   END IF;
end_section;
debug('end section: ItemDetails');

debug('begin section: ChangeOrderDetails');
start_section('Change Order Details', 'ChangeOrderDetails');
   IF g_sql_tokens('##$$CHGID$$##') IS NOT NULL THEN
      set_item_result(run_stored_sig('OPHANLY_ECO_EEC_DATA'));
      set_item_result(run_stored_sig('OPHANLY_ECO_BSB'));
      set_item_result(run_stored_sig('OPHANLY_ECO_ERI'));
      set_item_result(run_stored_sig('OPHANLY_ECO_ITEM_DATA'));
      set_item_result(run_stored_sig('OPHANLY_ECO_ITEM_REVS'));
      set_item_result(run_stored_sig('OPHANLY_ECO_BOM_COMPS'));
      set_item_result(run_stored_sig('OPHANLY_ECO_ERC'));
      set_item_result(run_stored_sig('OPHANLY_ECO_BOM_RDS'));
      set_item_result(run_stored_sig('OPHANLY_ECO_BOM_SCS'));
      set_item_result(run_stored_sig('OPHANLY_ECO_ORG_HRCHY'));
      set_item_result(run_stored_sig('OPHANLY_ECO_ORG_HRCHY_ORGS'));
      set_item_result(run_stored_sig('OPHANLY_ECO_BOR'));
      set_item_result(run_stored_sig('OPHANLY_ECO_BOM_OPRES'));
      set_item_result(run_stored_sig('OPHANLY_ECO_BOM_OPSEQ'));
      set_item_result(run_stored_sig('OPHANLY_ECO_BOM_RTGREV'));
      set_item_result(run_stored_sig('OPHANLY_ECO_ROUTES'));
      set_item_result(run_stored_sig('OPHANLY_ECO_ROUTE_STEPS'));
      set_item_result(run_stored_sig('EBS_MFG_INV_OPHANLY_INCORRECT_ROUTING_SEQ_ID'));
   END IF;
end_section;
debug('end section: ChangeOrderDetails');

debug('begin section: DataValidations');
start_section('Data Validations', 'DataValidations');
   IF g_sql_tokens('##$$ITEMID$$##') IS NOT NULL THEN
      set_item_result(run_stored_sig('Duplicate_Item_Numbers_MSIB'));
   END IF;
   set_item_result(run_stored_sig('DUPLICATE_UDA_EGO_MSIB'));
   set_item_result(run_stored_sig('Orphan_UDA_EGO_MSIB'));
   set_item_result(run_stored_sig('OPHANLY_SIMPLE_SEARCH'));
   set_item_result(run_stored_sig('OPHANLY_ENABLED_BUSEVENTS'));
   set_item_result(run_stored_sig('OPHANLY_ECO_CUSTOM_WF_STEPS'));
   set_item_result(run_stored_sig('OPHANLY_STRUC_PENDING_ECN'));
   set_item_result(run_stored_sig('OPHANLY_ECO_REV_OUT_OF_SEQ'));
   set_item_result(run_stored_sig('OPHANLY_ECO_STUCK_IN_PROGRESS'));
   set_item_result(run_stored_sig('OPHANLY_WEBAD_OUTOFMEMORY'));
   set_item_result(run_stored_sig('EBS_MFG_INV_LIFECYCLE_PENDING_PHASE_CHANGE'));
end_section;
debug('end section: DataValidations');
...
start_section('Apps Check', 'AppsCheck');
   ...
   set_item_result(run_stored_sig('DATABASE_INITIALIZATION_12_NO_QUOTES'));
...
start_section('Lifetime Support Policy', 'LifetimeSupportPolicy_COPY');
