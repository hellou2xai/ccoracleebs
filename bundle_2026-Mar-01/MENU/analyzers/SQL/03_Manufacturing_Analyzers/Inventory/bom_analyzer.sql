...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Bills of Material Analyzer             |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE bom_analyzer_pkg AUTHID DEFINER AS
...
(            p_org_code                     IN VARCHAR2    DEFAULT NULL
           ...
           ,p_set_process_id               IN NUMBER      DEFAULT NULL
...
END bom_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY bom_analyzer_pkg AS
-- $Id: bom_analyzer.sql, 200.20 2026/01/29 16:43:00 rcastro Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2633472.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'BOMAZ_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'BOMAZ_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>BOMAZ Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2633472.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/bom_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,2596,EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,2596,EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},2596,EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/mosc/discussion/4479585" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">2596</span>
...
<p>200.20 29-JAN-2026</p><ul><li>Updated link format</li>
</ul>
<p>&nbsp;</p><p>200.19 05-DEC-2025</p><ul><li>Added signature ‘<span style="background-color:rgb(255,255,255);color:rgb(22,21,19);"><span style="-webkit-text-stroke-width:0px;display:inline !important;float:none;font-family:&quot;Oracle Sans&quot;, -apple-system, &quot;system-ui&quot;, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, Cantarell, &quot;Fira Sans&quot;, &quot;Droid Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif;font-size:14px;font-style:normal;font-variant-caps:normal;font-variant-ligatures:normal;font-weight:400;letter-spacing:normal;orphans:2;text-align:start;text-decoration-color:initial;text-decoration-style:initial;text-decoration-thickness:initial;text-indent:0px;text-transform:none;white-space:normal;widows:2;word-spacing:0px;">Leading / Trailing Spaces in BOM Tables’</span></span></li>
</ul>
<p>&nbsp;</p><p>200.18 18-AUG-2025</p><ul><li>Signature updates</li>
</ul>
<p>&nbsp;</p><p>200.17 24-MAR-2025</p><ul><li>Added signature ‘Key Current Warehouse Parameters’</li>
<li>Updated Apps Check section</li>
</ul>
<p>&nbsp;</p><p>200.16 04-MAR-2025</p><ul><li>Framework updates</li>
</ul>
<p>&nbsp;</p><p>200.15 27-NOV-2024</p><ul><li>Signature updates</li>
</ul>
<p>&nbsp;</p><p>200.14 26-SEP-2024</p><ul><li>Signature updates</li>
</ul>
<p>&nbsp;</p><p>200.13 17-JUL-2024</p><ul><li>signature updates</li>
</ul>
<p>&nbsp;</p><p>200.11 26-JAN-2024</p><ul><li>signature updates</li>
<li>Framework updates</li>
</ul>
<p>&nbsp;</p><p>200.10 22-AUG-2023</p><ul><li>Signature updates</li>
<li>Framework updates</li>
</ul>
<p>&nbsp;</p><p>200.9 15-Jun-2023</p><ul><li>Signature updates</li>
</ul>
<p>&nbsp;</p><p>200.8 31-Mar-2023</p><ul><li>Framework updates</li>
<li>signature updates</li>
</ul>
<p>&nbsp;</p><p>200.7 05-Dec-2022</p><ul><li>Analyzer Framework updates</li>
<li>Signature updates</li>
</ul>
<p>&nbsp;</p><p>200.6 30-Mar-2021</p><ul><li>Signature updates</li>
</ul>
<p>200.4 25-Oct-2021</p><ul><li>Analyzer framework update</li>
</ul>
<p>200.3 - 07-Apr-2021</p><ul><li>Signature updates</li>
<li>Added Lifetime Support Policy</li>
</ul>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,2596,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,2596,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},2596,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
debug('begin populate parameters hash table');
   ...
   g_parameters(g_parameters.LAST).pvalue := mask_text(upper(p_org_code),'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Assembly Item Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_item_number,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Batch ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_batch_id,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Set Process ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_set_process_id,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  l_revision := rtrim(replace('$Revision: 200.20  $','$',''));
  l_revision := ltrim(replace(l_revision,'Revision:',''));
  l_date_char := rtrim(replace('$Date: 2026/01/29 16:42:59 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'bom_analyzer.sql';
...
WHERE MP.ORGANIZATION_CODE = p_org_code and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: << Organization Code >> : Organization Code '|| p_org_code ||' is not valid. Please enter a valid organization code. Remember not to enter the organization id.');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
debug('begin parameter validation: p_item_number');
IF p_item_number IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Assembly Item Number is required.');
   raise invalid_parameters;
END IF;
...
WHERE MSIK.CONCATENATED_SEGMENTS = p_item_number
 AND MSIK.ORGANIZATION_ID = (SELECT ORGANIZATION_ID 
FROM MTL_PARAMETERS MP
WHERE MP.ORGANIZATION_CODE = p_org_code) 
AND EXISTS (SELECT 1
FROM BOM_STRUCTURES_B BOM
WHERE BOM.ASSEMBLY_ITEM_ID = MSIK.INVENTORY_ITEM_ID
AND BOM.ORGANIZATION_ID = MSIK.ORGANIZATION_ID)
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: <<Item Number>> : Please enter a valid Assembly Item Number. The value entered ' || p_item_number ||' is not valid or not exists in the entered organization ' || p_org_code ||'.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_item_number failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_item_number');
...
IF p_org_code is null THEN
    print_log('No organization code specified. '||'The organization code parameter is mandatory.');
    raise invalid_parameters;
ELSE
    BEGIN
...
IF p_item_number is not null THEN
    BEGIN
        ...
        INTO   l_item_id
        FROM   MTL_SYSTEM_ITEMS_KFV MTL, MTL_PARAMETERS MP
        WHERE  CONCATENATED_SEGMENTS = p_item_number
          AND  MP.ORGANIZATION_ID = MTL.ORGANIZATION_ID
          AND  MP.ORGANIZATION_ID = l_org_id;
    EXCEPTION 
        WHEN NO_DATA_FOUND THEN
            print_error('No Item exists for values '||to_char(p_item_number)||'/'||to_char(p_org_code));
            raise invalid_parameters;
        WHEN TOO_MANY_ROWS THEN
            print_error('This item '||to_char(p_item_number)||'is duplicate in this organization'||to_char(p_org_code));
            raise invalid_parameters;   
    END;
END IF;
...
IF p_batch_id is not null THEN
    BEGIN
         IF p_batch_id + 1 = p_batch_id + 1 then
             NULL;
         END IF;
    EXCEPTION 
        WHEN INVALID_NUMBER THEN
            print_error('IN: The value '||to_char(p_batch_id)||' passed for the batch_id parameter is invalid. Enter a numeric value only.');
            raise invalid_parameters;    
        WHEN OTHERS THEN   
            print_error('OTH: The value '||to_char(p_batch_id)||' passed for the batch_id parameter is invalid. Enter a numeric value only.');    
    END;
END IF;

/*

IF p_set_process_id is not null THEN
    BEGIN
        select to_number(p_set_process_id) from dual;
    EXCEPTION 
        WHEN INVALID_NUMBER THEN
            print_error('The value '||to_char(p_set_process_id)||' passed for the set_process_id parameter is invalid. Enter a numeric value only.');
            raise invalid_parameters;           
    END;
END IF;
*/
...
debug('begin populate sql tokens hash table');
   ...
   g_sql_tokens('##$$ITEMID$$##') := l_item_id;
   g_masked_tokens('##$$ITEMID$$##') := mask_text( g_sql_tokens('##$$ITEMID$$##'), 'NO_MASK');
   g_sql_tokens('##$$ITEMNUMBER$$##') := p_item_number;
   g_masked_tokens('##$$ITEMNUMBER$$##') := mask_text( g_sql_tokens('##$$ITEMNUMBER$$##'), 'NO_MASK');
   g_sql_tokens('##$$BATCHID$$##') := p_batch_id;
   g_masked_tokens('##$$BATCHID$$##') := mask_text( g_sql_tokens('##$$BATCHID$$##'), 'NO_MASK');
   g_sql_tokens('##$$SETPROCESSID$$##') := p_set_process_id;
   g_masked_tokens('##$$SETPROCESSID$$##') := mask_text( g_sql_tokens('##$$SETPROCESSID$$##'), 'NO_MASK');
   g_sql_tokens('##$$ORGCODE$$##') := p_org_code;
   g_masked_tokens('##$$ORGCODE$$##') := mask_text( g_sql_tokens('##$$ORGCODE$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM1$$##') := '702';
   g_masked_tokens('##$$APPS_PARAM1$$##') := mask_text( g_sql_tokens('##$$APPS_PARAM1$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM2$$##') := '703';
   g_masked_tokens('##$$APPS_PARAM2$$##') := mask_text( g_sql_tokens('##$$APPS_PARAM2$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM3$$##') := '431';
   g_masked_tokens('##$$APPS_PARAM3$$##') := mask_text( g_sql_tokens('##$$APPS_PARAM3$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM4$$##') := '401';
   ...
   g_sql_tokens('##$$RELEASE$$##') := g_rep_info('Apps Version');
   g_masked_tokens('##$$RELEASE$$##') := mask_text( g_sql_tokens('##$$RELEASE$$##'), 'NO_MASK');
...
debug('begin add_signature: EBS_MFG_INV_BOMAZ_BOM_OVERVIEW');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27857',
      p_sig_id                 => 'EBS_MFG_INV_BOMAZ_BOM_OVERVIEW',
      p_sig_sql                => 'select ''The BOM:  ##$$ITEMNUMBER$$## is a STANDARD BOM in organization: ##$$ORGCODE$$##'' 
as bom_general_overview
...
and assembly_item_id =  ''##$$ITEMID$$##''
union 
--Commoned Editable Bills (attributes update enabled - components copied to destination org)--
select ''The BOM:  ##$$ITEMNUMBER$$## is an EDITABLE COMMONED BOM in organization: ''|| (select organization_code from mtl_parameters where organization_id = bom.organization_id)
as bom_general_overview
from bom_structures_b bom
where bill_sequence_id = common_bill_sequence_id
and source_bill_sequence_id <> common_bill_sequence_id
and source_bill_sequence_id <> bill_sequence_id
and common_organization_id <> organization_id
and common_organization_id is not null
and assembly_item_id =  ''##$$ITEMID$$##''
union 
--Commoned Referencing Bills (attributes update not enabled - no components in destination org--
select ''The BOM:  ##$$ITEMNUMBER$$## is a REFERENCING COMMONED BOM in organization: ''|| (select organization_code from mtl_parameters where organization_id = bom.common_organization_id)
as bom_general_overview
from bom_structures_b bom
where bill_sequence_id <> common_bill_sequence_id
and source_bill_sequence_id = common_bill_sequence_id
...
and common_organization_id is not null
and assembly_item_id =  ''##$$ITEMID$$##''',
      p_title                  => 'Bill General Overview',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'We couldn''t find any bills of material for this item.',
      p_solution               => 'Please visit the Bills of Materials form and confirm the item has a structure defined.',
      p_success_msg            => 'Bill of Materials general description.',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_BOMAZ_BOM_OVERVIEW');



debug('begin add_signature: EBS_MFG_INV_BOMAZ_BOM_EVENTS_ENABLED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31914',
      p_sig_id                 => 'EBS_MFG_INV_BOMAZ_BOM_EVENTS_ENABLED',
      p_sig_sql                => 'select e.name, e.status "Event Status", scr.rule_function, scr.status "Subscr Status", scr.owner_name, scr.owner_tag, scr.description
from wf_events e, wf_event_subscriptions scr
where e.guid = scr.event_filter_guid
and e.status = ''ENABLED''
and e.name like ''oracle.apps.bom.%''
and scr.status = ''ENABLED''',
      p_title                  => 'Business Events in Enabled Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Business events / custom subscriptions could interfere with the working or the performance of the actual form.  For troubleshooting purposes, it is recommended to disable these and retest the original issue. ',
      p_solution               => 'Review [1962142/KB513775] -
BOMFDBOM: Errors ORA-01403: no data found FRM-40735: ON-INSERT trigger raised unhandled exception ORA-06510 When Creating Or Updating Bills Or Components ',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_BOMAZ_BOM_EVENTS_ENABLED');



debug('begin add_signature: BOM_ATO_ITEM_ACCESS_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15007',
      p_sig_id                 => 'BOM_ATO_ITEM_ACCESS_CHECK',
      p_sig_sql                => 'select ''BOM: Model Item Access'' profile, 
decode(pov.profile_option_value, 1, ''Yes (1)'', 2, ''No (2)'') value 
from fnd_profile_option_values pov
where pov.profile_option_id = (
select profile_option_id from fnd_profile_options
where profile_option_name = ''BOM:MODEL_ITEM_ACCESS'')
and pov.profile_option_value in (''1'', ''2'')',
      p_title                  => 'ATO Item Access',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The profile "BOM: Model Item Access" is not set. This may prevent you from viewing ATO Models and ATO Option Classes in the Bills of Materials form.',
      p_solution               => 'Refer to the following document for additional information:<br>
[763198/KB622117] - Bill Of Material: Does Not Recognize ATO Model And Option Class
',
      p_success_msg            => 'The ATO Model access has been set with this value.',
   ...
   l_info.delete;
debug('end add_signature: BOM_ATO_ITEM_ACCESS_CHECK');



debug('begin add_signature: BOM_BILLS_FORM_ACCESS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15011',
      p_sig_id                 => 'BOM_BILLS_FORM_ACCESS',
      p_sig_sql                => 'select p.profile_option_name SHORT_NAME,
...
and n.user_profile_option_name IN (''BOM: Model Item Access'',''BOM: Planning Item Access'',''BOM: Standard Item Access'')
and v.profile_option_value=''2''
order by short_name',
      p_title                  => 'BOM Bills Form Access',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The required profile options are not set to access the Bills of Material form for model, option class, planning and standard items.',
      p_solution               => 'Refer to the following documents for additional information:<br>
[2017908/KB484415] - Error APP-BOM-28282: You Do Not Have Access To Any Of The Item Types When Attempting To Access The Asset BOM form
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: BOM_BILLS_FORM_ACCESS');



debug('begin add_signature: BOM_CALENDAR_REBUILD_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14531',
      p_sig_id                 => 'BOM_CALENDAR_REBUILD_CHECK',
      p_sig_sql                => 'select * from (
SELECT 
           CASE 
           WHEN CAL_YEAR_START_DATES_MIN IS NULL
                    THEN ''Yes''
           WHEN LAST_UPDATE_DAYS_DIFFERENCE > 0 
                    THEN ''Yes''
           WHEN ABS(TOT_CALENDAR_MONTHS - TOT_CAL_YEAR_START_DATE_MONTHS) > 12 
                    THEN ''Yes''
           WHEN CALENDAR_START_DATE <> CAL_YEAR_START_DATES_MIN 
                    THEN ''Yes''
           ELSE ''No''
           END "POSSIBLE_REBUILD_NEEDED?"
           , CASE 
           WHEN CAL_YEAR_START_DATES_MIN IS NULL
                    THEN ''The calendar has not be built yet (no records in table BOM_CAL_YEAR_START_DATES)''
           WHEN LAST_UPDATE_DAYS_DIFFERENCE > 0 
                    THEN ''BOM_CALENDARS.LAST_UPDATE_DATE and BOM_CAL_YEAR_START_DATES.LAST_UPDATE_DATE differ by more than a day''
           WHEN ABS(TOT_CALENDAR_MONTHS - TOT_CAL_YEAR_START_DATE_MONTHS) > 12 
                    THEN ''The total defined months for the calendar may not in sync with the total months in table BOM_CAL_YEAR_START_DATES''
           WHEN CALENDAR_START_DATE <> CAL_YEAR_START_DATES_MIN 
                    THEN ''The BOM_CALENDARS.CALENDAR_START_DATE value does not equal the minimum date found in table BOM_CAL_YEAR_START_DATES''
           ELSE ''No''
           END "REASON"
           ,Y.*
           ,ABS(TOT_CALENDAR_MONTHS - TOT_CAL_YEAR_START_DATE_MONTHS) TOT_MONTHS_DIFFERENCE
FROM (
 SELECT X.*
 ,FLOOR(MONTHS_BETWEEN(CALENDAR_END_DATE, CALENDAR_START_DATE)) TOT_CALENDAR_MONTHS
 ,FLOOR(MONTHS_BETWEEN(CAL_YEAR_START_DATES_MAX, CAL_YEAR_START_DATES_MIN)) TOT_CAL_YEAR_START_DATE_MONTHS
 ,ABS(TRUNC(CALENDAR_LAST_UPD) - TRUNC(CAL_YEAR_START_DATES_LAST_UPD)) LAST_UPDATE_DAYS_DIFFERENCE
 FROM 
  (SELECT 
    BC.CALENDAR_CODE
   ,BC.CALENDAR_START_DATE
   ,BC.CALENDAR_END_DATE
   ,BC.LAST_UPDATE_DATE CALENDAR_LAST_UPD
   ,(
       SELECT MAX(LAST_UPDATE_DATE) FROM BOM_CAL_YEAR_START_DATES
       WHERE CALENDAR_CODE = BC.CALENDAR_CODE
    ) CAL_YEAR_START_DATES_LAST_UPD
   ,(
       SELECT MIN(YEAR_START_DATE) FROM BOM_CAL_YEAR_START_DATES
       WHERE CALENDAR_CODE = BC.CALENDAR_CODE
    ) CAL_YEAR_START_DATES_MIN
   ,(
       SELECT MAX(YEAR_START_DATE) FROM BOM_CAL_YEAR_START_DATES
       WHERE CALENDAR_CODE = BC.CALENDAR_CODE
    ) CAL_YEAR_START_DATES_MAX
  FROM  
   BOM_CALENDARS BC
  WHERE EXISTS 
    (SELECT 1 
...
where "POSSIBLE_REBUILD_NEEDED?" = ''Yes''
order by CALENDAR_CODE',
      p_title                  => 'Calendar Rebuild',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'One or more Calendars were found which may have been updated but not rebuilt.
This could affect manufacturing or planning if changes were made but the calendar was not rebuilt.',
      p_solution               => 'Refer to the following document for additional information:<br>
[105329/KB381324] - Workday Calendar Exceptions Not Recognized by Planning.<br>
<br>
Abstract:<br>
Rebuilding an existing workday calendar affects all organizations that reference the same calendar and exception template.  Changes to the workday settings impact Oracle Manufacturing material plans, capacity plans, scheduling, and any other functions in all organizations using the same workday calendar. If the calendar is not rebuilt, changes will not be reflected in the calendar.<br>
Review the calendar and verify if the calendar needs to be rebuilt.

',
      p_success_msg            => 'No calendars were found that require a rebuild.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_CALENDAR_REBUILD_CHECK');



debug('begin add_signature: BOM_COMPONENT_NULL_IMPLEMENTATION_DATE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15008',
      p_sig_id                 => 'BOM_COMPONENT_NULL_IMPLEMENTATION_DATE',
      p_sig_sql                => 'select 
mp.organization_id,
mp.organization_code,
bom.assembly_item_id,
mif1.item_number assembly_item,
bic.operation_seq_num,
bic.component_item_id,
mif2.item_number component_item,
bic.change_notice,
bic.implementation_date --this will always be null/just displaying
from 
...
and bom.assembly_item_id = mif1.inventory_item_id
and bom.organization_id = mif1.organization_id
and bom.organization_id = mif2.organization_id
and bic.component_item_id = mif2.inventory_item_id
and bom.organization_id = mp.organization_id
and bom.organization_id = ##$$ORGID$$##',
      p_title                  => 'Bill Components with Null Implementation Date',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are components added to the assemblies via change orders however the implementation_date is NULL for these components.
This may impact further updates on these components like delete groups or change orders.',
      p_solution               => 'Refer to the following document for additional information:<br>
[273731/KB207995] - An ECO Is Implemented But An Added Component Has a NULL Implementation Date
',
      p_success_msg            => 'The are no bill components with missing/null implementation date which were added to the assembly via change order.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_COMPONENT_NULL_IMPLEMENTATION_DATE');



debug('begin add_signature: BOM_COMPONENT_REMARKS_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14890',
      p_sig_id                 => 'BOM_COMPONENT_REMARKS_CHECK',
      p_sig_sql                => 'SELECT ''Yes'' component_remarks_with_spaces
  FROM bom_structures_b b,bom_components_b C
 WHERE 1=1
   AND b.organization_id=''##$$ORGID$$##''
   AND b.bill_sequence_id=c.bill_sequence_id
   AND c.component_remarks is not null
   AND nvl(LENGTH(c.component_remarks),0)!=nvl(LENGTH(LTRIM(RTRIM(c.component_remarks))),0)
   AND ROWNUM=1',
      p_title                  => 'Components Remarks with Leading/Trailing Spaces',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are one or more component records in this organization having a component remark value with leading or trailing space(s).<br>
This will prevent you from saving changes you make to the Component''s Bill.',
      p_solution               => 'Refer to the following document for additional information:<br>
[2087545/KB223593] - Bills of Material BOM Form: Try to Change the Quantity and it Gives the Error FRM-40654: Record Has been Updated Requery Block to See the Change',
      p_success_msg            => 'There are no component records in this organization having a component remark with leading or trailing spaces.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_COMPONENT_REMARKS_CHECK');



debug('begin add_signature: BOM_CREATE_COMMONED_BILL_ORG_HIERARCHY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15012',
      p_sig_id                 => 'BOM_CREATE_COMMONED_BILL_ORG_HIERARCHY',
      p_sig_sql                => 'select p.profile_option_name SHORT_NAME,
n.user_profile_option_name NAME,
decode(v.level_id,
10001, ''Site'',
...
and svr.node_id (+) = v.level_value
and org.organization_id (+) = v.level_value
and n.user_profile_option_name IN (''Enable Security Groups'')
and v.profile_option_value=''N''
order by short_name',
      p_title                  => 'Create Common BOM using Organization Hierarchy',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'You cannot create a common BOM using an organization hierarchy as the hierarchy will not show any values.',
      p_solution               => 'Refer to the following document for additional information:<br>
[1576823/KB411312] - Cannot Create Common BOM using Organization Hierarchy, Hierarchy Shows No List Of Value',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: BOM_CREATE_COMMONED_BILL_ORG_HIERARCHY');



debug('begin add_signature: BOM_DUAL_UOM_ITEM_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14892',
      p_sig_id                 => 'BOM_DUAL_UOM_ITEM_CHECK',
      p_sig_sql                => 'SELECT results.*,
decode(bill_exists,''Yes'',''Invalid bill configuration: dual UOM tracking enabled'',''Bill creation not possible: dual UOM tracking enabled'') opm_configuration_check
FROM (
SELECT mif.organization_id
      ,mif.inventory_item_id
      ,mif.item_number
      ,mif.bom_enabled_flag
      ,mif.tracking_quantity_ind
      ||'' (''
      ||decode(mif.tracking_quantity_ind,''P'',''Primary'',''PS'',''Primary and Secondary'',''Undefined'')
      ||'')'' tracking_quantity_ind
      ,mif.bom_item_type || '' ('' || lu.meaning || '')'' bom_item_type
      ,decode((SELECT 1 FROM bom_structures_b bs 
              WHERE bs.organization_id = mif.organization_id 
                AND bs.assembly_item_id = mif.inventory_item_id
                AND ROWNUM=1), 1, ''Yes'',''No'') bill_exists
  FROM mtl_item_flexfields mif, mfg_lookups lu
   WHERE 1=1
   AND organization_id = ''##$$ORGID$$##'' AND inventory_item_id = ''##$$ITEMID$$##''
   AND bom_enabled_flag=''Y''
   AND tracking_quantity_ind<>''P''
   AND bom_item_type <> ''5''
   AND ''BOM_ITEM_TYPE'' = lu.lookup_type (+)
   AND bom_item_type = lu.lookup_code (+)) results',
      p_title                  => 'Dual UOM Tracked Enabled',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'An item that is BOM enabled, cannot be created or exist if the item has dual UOM tracking enabled and this is not a Product Family Bill.
',
      p_solution               => 'Refer to the following document for additional information:<br>
[1313221/KB787273] - APP-BOM-30006 BOM Cannot Contain Items Tracked in Dual UOM',
      p_success_msg            => 'Dual UOM configuration check passed.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_DUAL_UOM_ITEM_CHECK');



debug('begin add_signature: BOM_DUPLICATE_BILL_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14530',
      p_sig_id                 => 'BOM_DUPLICATE_BILL_CHECK',
      p_sig_sql                => 'SELECT dbills.*,
    nvl2(
     (SELECT 1 FROM mtl_onhand_quantities_detail T
      WHERE T.organization_id = dbills.organization_id  
        AND T.inventory_item_id = dbills.assembly_item_id
        AND ROWNUM=1),''Yes'',''No'') has_onhand,
    nvl2(
      (SELECT 1 FROM mtl_material_transactions T
      WHERE T.organization_id = dbills.organization_id  
        AND T.inventory_item_id = dbills.assembly_item_id
        AND ROWNUM=1),''Yes'',''No'') has_transactions,
     decode(min_creation_date,
            max_creation_date, 
        decode(min_bill_sequence_id,
          max_bill_sequence_id,
       ''<==Created First AND Duplicate'',
       decode(bill_sequence_id,min_bill_sequence_id,''<==Created First'',''<==Duplicate'')),
            decode(min_creation_date, creation_date, ''<==Created First'', ''<==Duplicate'')
         ) duplicate_comment
  FROM (
    SELECT 
       dups.organization_id,
       dups.assembly_item_id,
       dups.alternate_bom_designator,
       b.creation_date,
       b.bill_sequence_id,
       I.item_number,
       decode(dups.alternate_bom_designator,NULL,''Primary'',''Alternate'') duplicate_bill_type,
       (SELECT MIN(creation_date) FROM bom_bill_of_materials b1
        WHERE b1.assembly_item_id = dups.assembly_item_id
          AND b1.organization_id = dups.organization_id
          AND nvl(b1.alternate_bom_designator,''+NULL+'') = 
              nvl(dups.alternate_bom_designator,''+NULL+'')) min_creation_date,
       (SELECT MAX(creation_date) FROM bom_bill_of_materials b1
        WHERE b1.assembly_item_id = dups.assembly_item_id
          AND b1.organization_id = dups.organization_id
          AND nvl(b1.alternate_bom_designator,''+NULL+'') = 
              nvl(dups.alternate_bom_designator,''+NULL+'')) max_creation_date,
       (SELECT MIN(bill_sequence_id) FROM bom_bill_of_materials b1
        WHERE b1.assembly_item_id = dups.assembly_item_id
          AND b1.organization_id = dups.organization_id
          AND nvl(b1.alternate_bom_designator,''+NULL+'') = 
              nvl(dups.alternate_bom_designator,''+NULL+'')) min_bill_sequence_id,
       (SELECT MAX(bill_sequence_id) FROM bom_bill_of_materials b1
        WHERE b1.assembly_item_id = dups.assembly_item_id
          AND b1.organization_id = dups.organization_id
          AND nvl(b1.alternate_bom_designator,''+NULL+'') = 
              nvl(dups.alternate_bom_designator,''+NULL+'')) max_bill_sequence_id
    FROM 
    (
    SELECT assembly_item_id,organization_id, alternate_bom_designator, COUNT(*)                                  
    ...
    WHERE 
      ...
      AND b.assembly_item_id = dups.assembly_item_id
      AND b.organization_id = dups.organization_id
      AND nvl(b.alternate_bom_designator,''+NULL+'') = 
          nvl(dups.alternate_bom_designator,''+NULL+'')
      AND b.assembly_item_id = I.inventory_item_id
      AND b.organization_id = I.organization_id  
      ) dbills',
      p_title                  => 'Duplicate Bills',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are two records for the same assembly_item_id in Table BOM_STRUCTURES_B having different bill_sequence_ids.
This can lead to errors when using the Bill in Bills of Material, Work in Process, or when applying certain<br>
patches that create a unique index on column BILL_SEQUENCE_ID.',
      p_solution               => 'Refer to the following document for additional information:<br>
[370841/KB708327] - Find Two Bills of Material (BOM) for the Same Item (BOMFDBOM) leading to ORA-01427 or SQL-02112 error',
      p_success_msg            => 'No duplicate bills detected.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_DUPLICATE_BILL_CHECK');



debug('begin add_signature: BOM_ECO_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14546',
      p_sig_id                 => 'BOM_ECO_CHECK',
      p_sig_sql                => 'SELECT 
       mp.organization_code
     , eec.change_notice
     , eec.status_type||'' (''||lu1.meaning||'')'' eco_status_type
     , mif.item_number revised_item
     , eri.status_type||'' (''||lu2.meaning||'')'' ri_status_type
     , eri.organization_id, eri.revised_item_id
     , CASE WHEN eec.status_type = 6 THEN 
                CASE WHEN eri.status_type NOT IN (5,6) THEN
                    ''This change notice is implemented but the revised item is not cancelled or implemented''
                END
            WHEN eec.status_type = 5 THEN 
                CASE WHEN eri.status_type NOT IN (5,6) THEN
                    ''This change notice is cancelled but the revised item is not cancelled or implemented''
                END    
            ELSE 
                CASE WHEN eri.status_type NOT IN (5,6) THEN
                       ''This item is pending on this change notice''
                END   
      END AS "MESSAGE"
  FROM eng_revised_items eri
     ...
     , mfg_lookups lu2
     , mtl_parameters mp
 WHERE eri.organization_id = ##$$ORGID$$##
   AND eri.revised_item_id = NVL(''##$$ITEMID$$##'', eri.revised_item_id)
   AND eri.organization_id = eec.organization_id
   AND eri.change_notice = eec.change_notice
   AND (
         (eec.status_type = 5 AND eri.status_type NOT IN (5,6))
         OR
         (eec.status_type = 6 AND eri.status_type NOT IN (5,6))
         OR
         (eec.status_type NOT IN (5,6) AND eri.status_type NOT IN (5,6))
       )
   AND eri.organization_id = mif.organization_id
   AND eri.revised_item_id = mif.inventory_item_id
   AND ''ECG_ECN_STATUS'' = lu1.lookup_type(+)
   AND eec.status_code = lu1.lookup_code(+) 
   AND ''ECG_ECN_STATUS'' = lu2.lookup_type(+)
   AND eri.status_code = lu2.lookup_code(+) 
   AND eri.organization_id = mp.organization_id
ORDER BY 1,2',
      p_title                  => 'Unimplemented Change Order/Revised Item',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The item appears on pending Change Orders (ECO) which may lead to errors when creating a new ECO<br>
for the item or making changes to the assembly in the Bills of Materials form.',
      p_solution               => 'For additional information please review the following note: <br>
[2551011/KB208159] - Mismatch Between an Engineering Change Order (ECO) Status and One or More Revised Item Statuses.',
      p_success_msg            => 'This item does not appear on any pending Change Order.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_ECO_CHECK');



debug('begin add_signature: BOM_FORM_PERSONALIZATIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15018',
      p_sig_id                 => 'BOM_FORM_PERSONALIZATIONS',
...
-- and (rules.form_name like ''INV%'' or rules.function_name  like ''INV%'')
and func1.application_id in (''##$$APPS_PARAM1$$##'', ''##$$APPS_PARAM2$$##'') -- BOM+ENG
...
order by rules.form_name, rules.sequence, actions.sequence',
      p_title                  => 'Forms Personalization Warning',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Check if forms personalizations exist and are enabled. When personalizations are enabled, a warning is raised.',
      p_solution               => 'Please refer to the following note for additional information: <br>
[2381259/KB211818] - Disable Trigger or Custom Code in Oracle',
      p_success_msg            => 'There are no personalizations detected in the Bills of Materials forms.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_FORM_PERSONALIZATIONS');



debug('begin add_signature: BOM_INVALID_UNIT_EFFECTIVE_COMPONENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14537',
      p_sig_id                 => 'BOM_INVALID_UNIT_EFFECTIVE_COMPONENTS',
      p_sig_sql                => 'select mif1.item_number      ASSEMBLY_ITEM,
   mp.organization_code         ,
   ...
   decode(bcb.from_end_item_unit_number,null,''*MISSING'',
          bcb.from_end_item_unit_number||'' (Invalid)'')  From_End_Item_Unit_Number,
      bcb.to_end_item_unit_number||'' (Invalid)''    To_End_Item_Unit_Number,
   bcb.component_quantity          ,
   to_char(bcb.effectivity_date,''DD-MON-YYYY HH24:MI:SS'') Effectivity_Date,
   to_char(bcb.disable_date,''DD-MON-YYYY HH24:MI:SS'') Disable_Date,
   bcb.change_notice       ,
  ...
  and    (   ( bcb.from_end_item_unit_number is null
   ...
   and ( bsb.organization_id = ''##$$ORGID$$##'')
  UNION
  select mif1.item_number assembly_item    ,
   mp.organization_code         ,
   bsb.alternate_bom_designator     ,
   bcb.operation_seq_num      ,
      bcb.item_num      ,
   ...
   and (bsb.organization_id = ''##$$ORGID$$##'')
  UNION
  select mif1.padded_item_number     assembly_item,
   mp.organization_code        ,
   bsb.alternate_bom_designator    ,
   bcb.operation_seq_num     ,
   bcb.item_num      , 
   mif2.padded_item_number     component_item,
   bcb.from_end_item_unit_number    ,
   bcb.to_end_item_unit_number||'' (Invalid)''  From_End_Item_Unit_Number,
   bcb.component_quantity     ,
   to_char(bcb.effectivity_date,''DD-MON-YYYY HH24:MI:SS'') Effectivity_Date,
   to_char(bcb.disable_date,''DD-MON-YYYY HH24:MI:SS'') Disable_Date,
   bcb.change_notice     ,
  ...
  and (bsb.organization_id = ''##$$ORGID$$##'')',
      p_title                  => 'Invalid Unit Effectivity Components',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Component records have been detected as having corrupt unit number data which may lead to error messages while querying the Bills.

',
      p_solution               => 'Please review the following note for the root cause fix for your release:<br>
[393085/KB710677] - ITM/BOM/ENG patches referred in the Diagnostic Tests<br><br>
Returned rows with missing/invalid ''From End Item Unit Number'' or ''To End Item Unit Number'' may require a data fix.<br>
Please create a Service Request with Oracle Support for assistance with this issue.
',
      p_success_msg            => 'There are no invalid unit number component records.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_INVALID_UNIT_EFFECTIVE_COMPONENTS');



debug('begin add_signature: BOM_ITM_REV_OUT_OF_SEQ');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15019',
      p_sig_id                 => 'BOM_ITM_REV_OUT_OF_SEQ',
      p_sig_sql                => 'SELECT DISTINCT 
     NEW.organization_id, NEW.inventory_item_id
    ,OLD.revision AS old_rev 
    ,to_char( OLD.effectivity_date, ''DD-MON-YYYY HH24:MI:SS'') AS old_eff_date 
    ,NEW.revision  AS new_rev 
    ,to_char( NEW.effectivity_date, ''DD-MON-YYYY HH24:MI:SS'') AS new_eff_date
    ,OLD.revision_id old_revision_id
    ,NEW.revision_id AS new_revision_id   
FROM eng_revised_items eri, mtl_item_revisions_b OLD ,mtl_item_revisions_b NEW 
WHERE 1=1
  AND OLD.organization_id = ''##$$ORGID$$##'' 
  AND OLD.inventory_item_id = ''##$$ITEMID$$##'' 
  AND OLD.inventory_item_id = NEW.inventory_item_id
  AND OLD.organization_id = NEW.organization_id
  AND (OLD.revision < NEW.revision AND OLD.effectivity_date >= NEW.effectivity_date)
ORDER BY NEW.organization_id, NEW.inventory_item_id, NEW.revision',
      p_title                  => 'Out of Sequence Item Revisions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Verify that Item Revisions are in sequence with respect to Revision Code and Effectivity date for the item.',
      p_solution               => 'Refer to the following document for additional information:<br>
[388349/KB495868] - How To Correct Item Revisions Which Have Revision And Effectivity Date In Incorrect Alphabetical / Chronological Order
 ',
      p_success_msg            => 'Item revisions are in the correct sequence.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_ITM_REV_OUT_OF_SEQ');



debug('begin add_signature: BOM_MISSING_ATTRIBUTE_CATEGORY_VALUE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14548',
      p_sig_id                 => 'BOM_MISSING_ATTRIBUTE_CATEGORY_VALUE_CHECK',
      p_sig_sql                => 'select ''Y'' MISSING_ATTRIBUTE_CATEGORY_VAL from dual
where exists (
             SELECT 1
           FROM FND_DESCRIPTIVE_FLEXS
          WHERE application_id = 702 
            and DESCRIPTIVE_FLEXFIELD_NAME = ''BOM_COMPONENTMGMT_GROUP''
            and FREEZE_FLEX_DEFINITION_FLAG = ''Y'')
  and exists (
          select 1 
            from bom_structures_b bs, bom_components_b bc    
          where bs.organization_id = nvl(''##$$ORGID$$##'',bs.organization_id)
            and bs.bill_sequence_id = bc.bill_sequence_id
            and bc.attribute_category is null
            and exists(select 1 from mtl_system_items_b msi 
                         where msi.organization_id = bs.organization_id 
                           and msi.inventory_item_id = bs.assembly_item_id 
                           and bom_enabled_flag = ''Y'')
            and rownum = 1
 )',
      p_title                  => 'Bills with Missing ATTRIBUTE_CATEGORY Value',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The BOM Descriptive Flexfield "BOM_COMPONENTMGMT_GROUP" is defined and one or more BOM component record(s) exist in this organization having a missing a BOM_COMPONENTS_B.ATTRIBUTE_CATEGORY value.<br>
This may prevent the component records from being updated when using the Mass Change concurrent program.',
      p_solution               => 'Refer to the following document for additional information:<br>
[2175029/KB698107] - Bills Of Material Mass Changes Program Not Implementing Changes',
      p_success_msg            => 'No issues were detected.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_MISSING_ATTRIBUTE_CATEGORY_VALUE_CHECK');



debug('begin add_signature: BOM_MISSING_DEPARTMENT_EMPLOYEES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14980',
      p_sig_id                 => 'BOM_MISSING_DEPARTMENT_EMPLOYEES',
      p_sig_sql                => 'select distinct bdri.department_id
,bd.department_code
,bd.description
,br.resource_id
,br.resource_code
...
and bd.organization_id = ''##$$ORGID$$##''
and not exists
(select 1
from 
bom_resource_employees bre
,bom_resources brs
  where bre.instance_id = bdri.instance_id
  and bre.resource_id = bdri.resource_id
  and bre.resource_id = brs.resource_id
  and brs.organization_id = ''##$$ORGID$$##'')',
      p_title                  => 'Missing Employees for Resource  Instances',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are missing employees assigned to resource instances which will cause errors in the BOM > Resources > Employees form.',
      p_solution               => 'Refer to the following document for additional information:<br>
[2413020/KB726263] - The Bills Of Material Resource Form Raise the following Error When Attempting to Query the Employee: The number of resource instances record should be equal to capacity units.',
      p_success_msg            => 'No missing employees for department resources detected.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_MISSING_DEPARTMENT_EMPLOYEES');



debug('begin add_signature: BOM_MISSING_OLD_OPERATION_SEQUENCE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15009',
      p_sig_id                 => 'BOM_MISSING_OLD_OPERATION_SEQUENCE',
      p_sig_sql                => 'select 
...
and (bos.operation_sequence_id = bos.old_operation_sequence_id
and bos.implementation_date is null)
or (bos.operation_sequence_id <> bos.old_operation_sequence_id
and not exists (
select 1 from bom_operation_sequences bos2
where bos2.operation_sequence_id = bos.old_operation_sequence_id))',
      p_title                  => 'Missing/Corrupted Routing Operation Sequences',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are Routing Operations in Bills that have a corrupted value for old_operation_sequence_id which may cause further issues while implementing change orders for this assembly.',
      p_solution               => 'Refer to the following document for additional information:<br>
[2242545/KB705231] - ECO Failure in enimpri_implement_revised_item: Revised Item XYZ, Operation NNN''s Old Operation has not been Implemented Yet.
',
      p_success_msg            => 'No corrupted operations were found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_MISSING_OLD_OPERATION_SEQUENCE');



debug('begin add_signature: BOM_MISSING_ROUTING_REVISION_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14572',
      p_sig_id                 => 'BOM_MISSING_ROUTING_REVISION_CHECK',
      p_sig_sql                => 'select organization_id, assembly_item_id from bom_operational_routings 
where alternate_routing_designator is null
minus
select organization_id, inventory_item_id from MTL_RTG_ITEM_REVISIONS',
      p_title                  => 'Missing Routing Revisions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are one or more Routings having a missing routing revision which will result in errors when creating a new WIP Job or copying a Maintenance Routing for this assembly.
',
      p_solution               => 'Refer to the following documents for additional information:<br>
[1395827/KB520360] - WIPDJMDF Error APP-BOM-20516 When Saving a Discrete Job And Save<br>
[284383/KB208453] - Error APP-BOM-20516 When Copying an Activity Routing',
      p_success_msg            => 'No routings were found having a missing routing revision.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_MISSING_ROUTING_REVISION_CHECK');



debug('begin add_signature: BOM_NULL_ASSEMBLY_ITEM_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15013',
      p_sig_id                 => 'BOM_NULL_ASSEMBLY_ITEM_ID',
      p_sig_sql                => 'select * from BOM_STRUCTURES_B bsb
where PK1_VALUE is null
and ASSEMBLY_ITEM_ID is null
and not exists (select *
from BOM_COMPONENTS_B bcb
where bsb.common_bill_sequence_id = bcb.bill_sequence_id)',
      p_title                  => 'Null ASSEMBLY_ITEM_ID in  BOM_STRUCTURES_B',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There is corrupted data for key columns in the table BOM_STRUCTURES_B that may lead to errors when applying a patch that may re-create the index BOM_STRUCTURES_B_U1.<br>',
      p_solution               => 'Refer to the following document for additional information:<br>
[553020/KB628011] - Unique Index BOM_STRUCTURES_B_U1 Creation Error Due To Duplicate Keys.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: BOM_NULL_ASSEMBLY_ITEM_ID');



debug('begin add_signature: BOM_OVERLAPPING_EFFECTIVITY_DATE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14538',
      p_sig_id                 => 'BOM_OVERLAPPING_EFFECTIVITY_DATE_CHECK',
      p_sig_sql                => 'SELECT P.ORGANIZATION_CODE
        , M1.ITEM_NUMBER ASSEMBLY_ITEM
        , M2.ITEM_NUMBER COMPONENT_ITEM
        , C.ORGANIZATION_ID
        , C.ASSEMBLY_ITEM_ID 
        , C.BILL_SEQUENCE_ID
        , A.COMPONENT_ITEM_ID
  ...
  FROM  BOM_COMPONENTS_B A
       ,BOM_STRUCTURES_B C
       ,MTL_ITEM_FLEXFIELDS       M1
       ,MTL_ITEM_FLEXFIELDS       M2
       ,MTL_PARAMETERS P
  WHERE  A.BILL_SEQUENCE_ID  = C.BILL_SEQUENCE_ID
  AND   M1.INVENTORY_ITEM_ID = C.ASSEMBLY_ITEM_ID
  AND   M1.ORGANIZATION_ID   = C.ORGANIZATION_ID
  AND   M2.INVENTORY_ITEM_ID = A.COMPONENT_ITEM_ID
  AND   M2.ORGANIZATION_ID   = C.ORGANIZATION_ID
  AND   M1.ORGANIZATION_ID   = P.ORGANIZATION_ID
  AND   A.ROWID >
        ( SELECT min(ROWID)
  ...
  ORDER BY 1,2',
      p_title                  => 'Bills with overlappting Effectivity Dates',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Component records have been found to have different effectivity date values that overlap with each other.',
      p_solution               => 'Refer to the following document for additional information:<br>
[2353686/KB208770] - After Implementing an ECO, the Following Message Occurs When Updating the Common Bill: The effectivity dates you have entered are overlapping with the existing dates.',
      p_success_msg            => 'There are no Bills having components with overlapping effectivity dates.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_OVERLAPPING_EFFECTIVITY_DATE_CHECK');



debug('begin add_signature: BOM_PENDING_FROM_ECN_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14547',
      p_sig_id                 => 'BOM_PENDING_FROM_ECN_CHECK',
      p_sig_sql                => 'SELECT 
       mp.organization_code
     , mif.item_number assembly_item
     , bs.organization_id
     , bs.assembly_item_id
     , bs.pending_from_ecn AS "PENDING_FROM_ECN(BILL)"
     , bs.implementation_date "IMPLEMENTATION_DATE(BILL)"
     , eec.status_type || ''-'' || lu_e.meaning "STATUS_TYPE(ECO)"
     , eec.cancellation_date "CANCELLATION_DATE(ECO)"
     , eec.implementation_date "IMPLEMENTATION_DATE(ECO)"
     , eec.plm_or_erp_change "PLS_OR_ERP_CHANGE(ECO)"
     , eri.status_type || ''-'' || lu_ri.meaning "STATUS_TYPE(RI)"
     , eri.cancellation_date "CANCELLATION_DATE(RI)"
     , eri.implementation_date "IMPLEMENTATION_DATE(RI)"
     , CASE WHEN eec.status_type = 5 THEN ''This bill is marked with a pending ECO but the ECO is cancelled''
            WHEN eri.status_type = 5 THEN ''This bill is marked with a pending ECO but the revised item is cancelled''   
            WHEN eec.status_type = 6 THEN ''This bill is marked with a pending ECO but the ECO is implemented''
            WHEN eri.status_type = 6 THEN ''This bill is marked with a pending ECO but the revised item is implemented'' 
            WHEN eec.status_type IS NULL THEN ''This bill is marked with a pending ECO but the ECO is missing''
            ELSE ''Unrecoginized pending_from_ecn check condition'' 
       END AS message
FROM  bom_structures_b bs
     ,mtl_parameters mp
     ,mtl_item_flexfields mif
     ,eng_engineering_changes eec
     ...
     ,mfg_lookups lu_ri
WHERE 1=1
  AND bs.pending_from_ecn IS NOT NULL
  AND bs.organization_id = mp.organization_id
  AND bs.organization_id = mif.organization_id
  AND bs.assembly_item_id = mif.inventory_item_id
  AND bs.organization_id = eec.organization_id(+)
  AND bs.pending_from_ecn = eec.change_notice(+)
  AND bs.organization_id = eri.organization_id(+)
  AND bs.pending_from_ecn = eri.change_notice(+)
  AND bs.assembly_item_id = eri.revised_item_id(+)
    AND eri.organization_id = nvl(''##$$ORGID$$##'',eri.organization_id)
    AND eri.revised_item_id = nvl(''##$$ITEMID$$##'',eri.revised_item_id)
  AND lu_e.lookup_code = eec.status_type
  AND lu_e.lookup_type = ''ECG_ECN_STATUS''
  AND lu_ri.lookup_code = eri.status_type
  AND lu_ri.lookup_type = ''ECG_ECN_STATUS''
  AND ( nvl(eec.status_type,-999) IN (5,6) OR nvl(eri.status_type,-999) IN (5,6))',
      p_title                  => 'Bills with Invalid PENDING_FROM_ECN Value',
      p_fail_condition         => 'RSGT1',
      p_problem_descr          => 'This item appears on existing change notice(s) where BOM_STRUCTURES_B.PENDING_FROM_ECN is erroneously populated.<br>
When BOM_STRUCTURES_B.PENDING_FROM_ECN is populated, you are unable to update the Bill in the Bill Define form.',
      p_solution               => 'Refer to the following documents for additional information:<br>
[2662118/KB208062] - Unable To Update A Bill Due To A Pending Change Notice<br>
[2166575/KB570697] - ENG_PENDING_BILL_EXIST Error in ''Engineering Change Order Implementation'' Program When Implementing an ECO.',
      p_success_msg            => 'There are no change notices marked with a BOM_STRUCTURES_B.PENDING_FROM_ECN value.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_PENDING_FROM_ECN_CHECK');



debug('begin add_signature: BOM_UPDATE_RESOURCE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14233',
      p_sig_id                 => 'BOM_UPDATE_RESOURCE',
      p_sig_sql                => 'SELECT r.resource_code,br.resource_id,tablename,COUNT(*)
FROM
(       SELECT ''CST_RESOURCE_OVERHEADS'' tablename,resource_id FROM cst_resource_overheads
  UNION SELECT ''CST_RESOURCE_COSTS'', resource_id FROM cst_resource_costs
  UNION SELECT ''BOM_OPERATION_RESOURCES'',resource_id FROM bom_operation_resources
  UNION SELECT ''WIP_TRANSACTIONS'',resource_id FROM wip_transactions
  UNION SELECT ''WIP_COST_TXN_INTERFACE'',resource_id FROM wip_cost_txn_interface
) X,
bom_op_resources_view r,
bom_resources br
WHERE 1 = 1
AND r.organization_id = br.organization_id
AND r.resource_code = br.resource_code
AND r.organization_id = ''##$$ORGID$$##''
AND r.assembly_item_id = ''##$$ITEMID$$##''
AND br.resource_id = X.resource_ID
GROUP BY tablename,r.resource_code,br.resource_id
ORDER BY r.resource_code asc',
      p_title                  => 'Control Resource Updates',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'If a row exists in any of the listed tables, users will not be able to change the Outside Processing or Costed checkboxes for a BOM Routings Resource.',
      p_solution               => 'Refer to the following document for additional information:<br>
[279142/KB208707] - BOMFDORS: Cannot Change the Outside Processing or Costed Fields for an Existing Resource - "FRM-40200 Field is protected against update".',
      p_success_msg            => 'You can change the Outside Processing or Costed checkboxes for Resources used in Routings belonging to this assembly.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_UPDATE_RESOURCE');



debug('begin add_signature: BOM_VALIDATE_PROFILE_BOM_WEEK_PERIOD_START_DAY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14887',
      p_sig_id                 => 'BOM_VALIDATE_PROFILE_BOM_WEEK_PERIOD_START_DAY',
    ...
    WHERE a.profile_option_id  = e.profile_option_id
      ...
      AND e.profile_option_name = ''BOM_WEEK_PERIOD_START_DAY''
	  AND ((a.level_id = 10003 AND a.level_value = null)
      OR   (a.level_id = 10004 AND d.user_name = ''null'')
      OR   (a.level_id = 10001 ))
      ORDER BY e.profile_option_name,
            a.level_id DESC',
      p_title                  => 'Validate Profile: BOM: Week and Period Start Day',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The required setup of profile option "BOM: Week and Period Start Day" has not been performed.<br>
This can cause errors when performing some tasks like creating internal orders as may prevent proper manufacturing calendar calculations.',
      p_solution               => 'Refer to the following document for additional information:<br>
[2553007/KB749550] - Error Building Workday Calendar APP-MRP-22132 Cannot Get Profile Option BOM_WEEK_PERIOD_START_DAY.',
      p_success_msg            => 'Profile option "BOM: Week and Period Start Day" is set.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_VALIDATE_PROFILE_BOM_WEEK_PERIOD_START_DAY');



debug('begin add_signature: BOM_VALIDATE_PROFILE_REPORT_QUANTITY_PRECISION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14888',
      p_sig_id                 => 'BOM_VALIDATE_PROFILE_REPORT_QUANTITY_PRECISION',
      p_sig_sql                => 'SELECT user_profile_option_name "Profile Option",
           a.profile_option_value "Profile Value",
           DECODE(a.level_id, 10001, ''Site'',
                              10002, ''Application'',
    ...
    WHERE a.profile_option_id  = e.profile_option_id
      ...
      AND t.LANGUAGE             = ''US''
      AND nvl(c.LANGUAGE,''US'') = ''US''
      AND e.profile_option_name = ''REPORT_QUANTITY_PRECISION''
	  AND ((a.level_id = 10003 AND a.level_value = null)
      OR   (a.level_id = 10004 AND d.user_name = ''null'')
      OR   (a.level_id = 10001 ))
      ORDER BY e.profile_option_name, a.level_id DESC',
      p_title                  => 'Validate Profile: INV: Dynamic Precision Option for Quantity on Reports',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The required setup of profile option "INV: Dynamic Precision Option for Quantity on Reports" has not been performed.<br>
This can cause errors when running some reports such as the BOM Item Where Used report.',
      p_solution               => 'Refer to the following document for additional information:<br>
[1285982/KB321736] - BOMRWUITG Item Where Used Report GUI Failing with Error MSG-02000: 101501: non-ORACLE exception REP-1825: Before Report trigger returned FALSE. REP-0069: Internal error REP-57054: In-process job terminated: Terminated with error: REP-1825: MSG-02000: 1015.',
      p_success_msg            => 'Profile option "INV: Dynamic Precision Option for Quantity on Reports" is set.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_VALIDATE_PROFILE_REPORT_QUANTITY_PRECISION');



debug('begin add_signature: BOM_ZERO_COMPONENT_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14549',
      p_sig_id                 => 'BOM_ZERO_COMPONENT_CHECK',
      p_sig_sql                => 'select ''Yes'' BILLS_WITH_ZERO_COMPONENTS from (
select common_bill_sequence_id 
from bom_structures_b 
where organization_id = ''##$$ORGID$$##''
minus 
select bill_sequence_id from bom_components_b 
)
where common_bill_sequence_id is not null and rownum=1',
      p_title                  => 'Bills with Zero Components',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are one or more Bills in this organization having no component records.',
      p_solution               => 'Refer to the following document for additional information:
[467341/KB428706] - Cannot Delete Corrupted Bill/Common Bill Because Discrete Job and Demand Exist.',
      p_success_msg            => 'No Bills exist having zero components.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_ZERO_COMPONENT_CHECK');



debug('begin add_signature: EBS_MFG_INV_BOMAZ_DELETE_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29566',
      p_sig_id                 => 'EBS_MFG_INV_BOMAZ_DELETE_ERRORS',
      p_sig_sql                => 'select 
bgroup.delete_group_name,
bgroup.description,
bgroup.date_last_submitted,
bgroup.organization_id,
decode(bent.delete_entity_type
,1, ''Item+''
,2, ''Bill''
,3, ''Routing''
,4, ''Component''
...
bent.item_concat_segments,
berror.sql_statement_name error_name, 
bsql.description, 
bsql.sql_statement
from bom_delete_errors berror, 
bom_delete_sql_statements bsql, 
bom_delete_groups bgroup, 
bom_delete_entities bent
where  berror.delete_entity_sequence_id = bent.delete_entity_sequence_id
and bent.delete_group_sequence_id = bgroup.delete_group_sequence_id
and berror.sql_statement_name = bsql.sql_statement_name
and bgroup.organization_id = ##$$ORGID$$##
and bent.inventory_item_id = ##$$ITEMID$$##',
      p_title                  => 'BOM Delete Errors',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The delete process ecountered errors. Use this data and review Note - BOM Delete Constraints: SQL Queries To Review Delete Constraint Failure [2680357/KB208513]',
      p_solution               => 'Review the sql query returning data which prevents the delete of the entity. Review  [2680357/KB208513] for additional details.',
      p_success_msg            => 'No delete error found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_BOMAZ_DELETE_ERRORS');



debug('begin add_signature: EBS_MFG_INV_BOMAZ_LEADING_TRAILING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '32217',
      p_sig_id                 => 'EBS_MFG_INV_BOMAZ_LEADING_TRAILING',
      p_sig_sql                => 'SELECT COUNT(1) leading_trailing_count,''BOM_OPERATIONAL_ROUTINGS - ALTERNATE_ROUTING_DESIGNATOR|COMPLETION_SUBINVENTORY|ATTRIBUTE'' "table - field" FROM BOM_OPERATIONAL_ROUTINGS
WHERE (LENGTH(ALTERNATE_ROUTING_DESIGNATOR)<> LENGTH(TRIM(ALTERNATE_ROUTING_DESIGNATOR))
OR LENGTH(COMPLETION_SUBINVENTORY) <> LENGTH(TRIM(COMPLETION_SUBINVENTORY))
OR LENGTH(ATTRIBUTE_CATEGORY) <> LENGTH(TRIM(ATTRIBUTE_CATEGORY))
OR LENGTH(attribute1) <> LENGTH(TRIM(attribute1))
OR LENGTH(attribute2) <> LENGTH(TRIM(attribute2))
OR LENGTH(attribute3) <> LENGTH(TRIM(attribute3))
OR LENGTH(attribute4) <> LENGTH(TRIM(attribute4))
OR LENGTH(attribute5) <> LENGTH(TRIM(attribute5))
OR LENGTH(attribute6) <> LENGTH(TRIM(attribute6))
OR LENGTH(attribute7) <> LENGTH(TRIM(attribute7))
OR LENGTH(attribute8) <> LENGTH(TRIM(attribute8))
OR LENGTH(attribute9) <> LENGTH(TRIM(attribute9))
OR LENGTH(attribute9) <> LENGTH(TRIM(attribute10))
OR LENGTH(attribute9) <> LENGTH(TRIM(attribute11))
OR LENGTH(attribute9) <> LENGTH(TRIM(attribute12))
OR LENGTH(attribute9) <> LENGTH(TRIM(attribute13))
OR LENGTH(attribute10) <> LENGTH(TRIM(attribute14)))
AND ORGANIZATION_ID = ''##$$ORGID$$##''
UNION
SELECT COUNT(1) leading_trailing_count,''BOM_INVENTORY_COMPONENTS - COMPONENT_REMARKS|CHANGE_NOTICE|ATTRIBUTE'' "table - field" FROM BOM_INVENTORY_COMPONENTS
WHERE (LENGTH(COMPONENT_REMARKS)<> LENGTH(TRIM(COMPONENT_REMARKS))
OR LENGTH(CHANGE_NOTICE) <> LENGTH(TRIM(CHANGE_NOTICE))
OR LENGTH(SUPPLY_SUBINVENTORY) <> LENGTH(TRIM(SUPPLY_SUBINVENTORY))
OR LENGTH(FROM_END_ITEM_UNIT_NUMBER) <> LENGTH(TRIM(FROM_END_ITEM_UNIT_NUMBER))
OR LENGTH(TO_END_ITEM_UNIT_NUMBER) <> LENGTH(TRIM(TO_END_ITEM_UNIT_NUMBER))
OR LENGTH(ORIGINAL_SYSTEM_REFERENCE) <> LENGTH(TRIM(ORIGINAL_SYSTEM_REFERENCE))
OR LENGTH(DELETE_GROUP_NAME) <> LENGTH(TRIM(DELETE_GROUP_NAME))
OR LENGTH(DG_DESCRIPTION) <> LENGTH(TRIM(DG_DESCRIPTION))
OR LENGTH(AUTO_REQUEST_MATERIAL) <> LENGTH(TRIM(AUTO_REQUEST_MATERIAL))
OR LENGTH(SUGGESTED_VENDOR_NAME) <> LENGTH(TRIM(SUGGESTED_VENDOR_NAME))
OR LENGTH(OBJ_NAME) <> LENGTH(TRIM(OBJ_NAME))
OR LENGTH(PK1_VALUE) <> LENGTH(TRIM(PK1_VALUE))
OR LENGTH(PK2_VALUE) <> LENGTH(TRIM(PK2_VALUE))
OR LENGTH(PK3_VALUE) <> LENGTH(TRIM(PK3_VALUE))
OR LENGTH(PK4_VALUE) <> LENGTH(TRIM(PK4_VALUE))
OR LENGTH(PK5_VALUE) <> LENGTH(TRIM(PK5_VALUE))
OR LENGTH(FROM_STRUCTURE_REVISION_CODE) <> LENGTH(TRIM(FROM_STRUCTURE_REVISION_CODE))
OR LENGTH(TO_STRUCTURE_REVISION_CODE) <> LENGTH(TRIM(TO_STRUCTURE_REVISION_CODE))
OR LENGTH(ATTRIBUTE_CATEGORY) <> LENGTH(TRIM(ATTRIBUTE_CATEGORY))
OR LENGTH(attribute1) <> LENGTH(TRIM(attribute1))
OR LENGTH(attribute2) <> LENGTH(TRIM(attribute2))
OR LENGTH(attribute3) <> LENGTH(TRIM(attribute3))
...
AND pk2_value =  ''##$$ORGID$$##''
UNION
SELECT COUNT(1) leading_trailing_count,''BOM_OPERATION_SEQUENCES - OPERATION_DESCRIPTION|ATTRIBUTE'' "table - field" FROM BOM_OPERATION_SEQUENCES
WHERE (LENGTH(OPERATION_DESCRIPTION)<> LENGTH(TRIM(OPERATION_DESCRIPTION))
OR LENGTH(ORIGINAL_SYSTEM_REFERENCE) <> LENGTH(TRIM(ORIGINAL_SYSTEM_REFERENCE))
OR LENGTH(CHANGE_NOTICE) <> LENGTH(TRIM(CHANGE_NOTICE))
OR LENGTH(SHUTDOWN_TYPE) <> LENGTH(TRIM(SHUTDOWN_TYPE))
OR LENGTH(CRITICAL_TO_QUALITY) <> LENGTH(TRIM(CRITICAL_TO_QUALITY))
OR LENGTH(VALUE_ADDED) <> LENGTH(TRIM(VALUE_ADDED))
OR LENGTH(LONG_DESCRIPTION) <> LENGTH(TRIM(LONG_DESCRIPTION))
OR LENGTH(ATTRIBUTE_CATEGORY) <> LENGTH(TRIM(ATTRIBUTE_CATEGORY))
OR LENGTH(attribute1) <> LENGTH(TRIM(attribute1))
OR LENGTH(attribute2) <> LENGTH(TRIM(attribute2))
OR LENGTH(attribute3) <> LENGTH(TRIM(attribute3))
...
OR LENGTH(attribute10) <> LENGTH(TRIM(attribute14)))
UNION
SELECT COUNT(1) leading_trailing_count,''BOM_ALTERNATE_DESIGNATORS - ALTERNATE_DESIGNATOR_CODE|DESCRIPTION|ATTRIBUTE'' "table - field" FROM BOM_ALTERNATE_DESIGNATORS
WHERE (LENGTH(ALTERNATE_DESIGNATOR_CODE)<> LENGTH(TRIM(ALTERNATE_DESIGNATOR_CODE))
OR LENGTH(DESCRIPTION) <> LENGTH(TRIM(DESCRIPTION))
OR LENGTH(IS_PREFERRED) <> LENGTH(TRIM(IS_PREFERRED))
OR LENGTH(ZD_EDITION_NAME) <> LENGTH(TRIM(ZD_EDITION_NAME))
OR LENGTH(ZD_SYNC) <> LENGTH(TRIM(ZD_SYNC))
OR LENGTH(ATTRIBUTE_CATEGORY) <> LENGTH(TRIM(ATTRIBUTE_CATEGORY))
OR LENGTH(attribute1) <> LENGTH(TRIM(attribute1))
OR LENGTH(attribute2) <> LENGTH(TRIM(attribute2))
OR LENGTH(attribute3) <> LENGTH(TRIM(attribute3))
...
AND ORGANIZATION_ID = ''##$$ORGID$$##''
UNION
SELECT COUNT(1) leading_trailing_count,''MTL_ITEM_LOCATIONS - DESCRIPTION|SEGMENT|ATTRIBUTE'' "table - field" FROM MTL_ITEM_LOCATIONS
WHERE (LENGTH(DESCRIPTION)<> LENGTH(TRIM(DESCRIPTION))
OR LENGTH(DESCRIPTIVE_TEXT) <> LENGTH(TRIM(DESCRIPTIVE_TEXT))
OR LENGTH(PHYSICAL_LOCATION_CODE) <> LENGTH(TRIM(PHYSICAL_LOCATION_CODE))
OR LENGTH(SUBINVENTORY_CODE) <> LENGTH(TRIM(SUBINVENTORY_CODE))
OR LENGTH(LOCATION_WEIGHT_UOM_CODE) <> LENGTH(TRIM(LOCATION_WEIGHT_UOM_CODE))
OR LENGTH(VOLUME_UOM_CODE) <> LENGTH(TRIM(VOLUME_UOM_CODE))
OR LENGTH(SEGMENT1) <> LENGTH(TRIM(SEGMENT1))
OR LENGTH(SEGMENT2) <> LENGTH(TRIM(SEGMENT2))
OR LENGTH(SEGMENT3) <> LENGTH(TRIM(SEGMENT3))
OR LENGTH(SEGMENT4) <> LENGTH(TRIM(SEGMENT4))
OR LENGTH(SEGMENT5) <> LENGTH(TRIM(SEGMENT5))
OR LENGTH(SEGMENT6) <> LENGTH(TRIM(SEGMENT6))
OR LENGTH(SEGMENT7) <> LENGTH(TRIM(SEGMENT7))
OR LENGTH(SEGMENT8) <> LENGTH(TRIM(SEGMENT8))
OR LENGTH(SEGMENT9) <> LENGTH(TRIM(SEGMENT9))
OR LENGTH(SEGMENT10) <> LENGTH(TRIM(SEGMENT10))
OR LENGTH(SEGMENT11) <> LENGTH(TRIM(SEGMENT11))
OR LENGTH(SEGMENT12) <> LENGTH(TRIM(SEGMENT12))
OR LENGTH(SEGMENT13) <> LENGTH(TRIM(SEGMENT13))
OR LENGTH(SEGMENT14) <> LENGTH(TRIM(SEGMENT14))
OR LENGTH(SEGMENT15) <> LENGTH(TRIM(SEGMENT15))
OR LENGTH(SEGMENT16) <> LENGTH(TRIM(SEGMENT16))
OR LENGTH(SEGMENT17) <> LENGTH(TRIM(SEGMENT17))
OR LENGTH(SEGMENT18) <> LENGTH(TRIM(SEGMENT18))
OR LENGTH(SEGMENT19) <> LENGTH(TRIM(SEGMENT19))
OR LENGTH(SEGMENT20) <> LENGTH(TRIM(SEGMENT20))
OR LENGTH(SUMMARY_FLAG) <> LENGTH(TRIM(SUMMARY_FLAG))
OR LENGTH(ENABLED_FLAG) <> LENGTH(TRIM(ENABLED_FLAG))
OR LENGTH(ATTRIBUTE_CATEGORY) <> LENGTH(TRIM(ATTRIBUTE_CATEGORY))
OR LENGTH(attribute1) <> LENGTH(TRIM(attribute1))
OR LENGTH(attribute2) <> LENGTH(TRIM(attribute2))
OR LENGTH(attribute3) <> LENGTH(TRIM(attribute3))
...
OR LENGTH(attribute9) <> LENGTH(TRIM(attribute12))
OR LENGTH(attribute9) <> LENGTH(TRIM(attribute13))
OR LENGTH(attribute9) <> LENGTH(TRIM(attribute14))
OR LENGTH(attribute10) <> LENGTH(TRIM(attribute15))
OR LENGTH(PICK_UOM_CODE) <> LENGTH(TRIM(PICK_UOM_CODE))
OR LENGTH(DIMENSION_UOM_CODE) <> LENGTH(TRIM(DIMENSION_UOM_CODE))
OR LENGTH(EMPTY_FLAG) <> LENGTH(TRIM(EMPTY_FLAG))
OR LENGTH(MIXED_ITEMS_FLAG) <> LENGTH(TRIM(MIXED_ITEMS_FLAG))
OR LENGTH(ALIAS) <> LENGTH(TRIM(ALIAS)))
AND ORGANIZATION_ID = ''##$$ORGID$$##''
UNION
SELECT COUNT(1) leading_trailing_count,''MTL_ITEM_SUB_INVENTORIES - SECONDARY_INVENTORY|SOURCE_SUBINVENTORY|ATTRIBUTE'' "table - field" FROM MTL_ITEM_SUB_INVENTORIES
WHERE (LENGTH(SECONDARY_INVENTORY)<> LENGTH(TRIM(SECONDARY_INVENTORY))
OR LENGTH(SOURCE_SUBINVENTORY) <> LENGTH(TRIM(SOURCE_SUBINVENTORY))
OR LENGTH(ATTRIBUTE_CATEGORY) <> LENGTH(TRIM(ATTRIBUTE_CATEGORY))
OR LENGTH(attribute1) <> LENGTH(TRIM(attribute1))
OR LENGTH(attribute2) <> LENGTH(TRIM(attribute2))
OR LENGTH(attribute3) <> LENGTH(TRIM(attribute3))
...
AND ORGANIZATION_ID = ''##$$ORGID$$##''
UNION
SELECT COUNT(1) leading_trailing_count,''MTL_SYSTEM_ITEMS_B - DESCRIPTION|SEGMENT|ATTRIBUTE'' "table - field" FROM mtl_system_items_b
WHERE (LENGTH(DESCRIPTION)<> LENGTH(TRIM(DESCRIPTION))
OR LENGTH(SEGMENT1) <> LENGTH(TRIM(SEGMENT1))
OR LENGTH(SEGMENT2) <> LENGTH(TRIM(SEGMENT2))
OR LENGTH(SEGMENT3) <> LENGTH(TRIM(SEGMENT3))
...
OR LENGTH(attribute8) <> LENGTH(TRIM(attribute8))
OR LENGTH(attribute9) <> LENGTH(TRIM(attribute9))
OR LENGTH(attribute10) <> LENGTH(TRIM(attribute10)))
AND inventory_item_id =  ''##$$ITEMID$$##''
UNION
SELECT COUNT(1) leading_trailing_count,''MTL_SYSTEM_ITEMS_TL - DESCRIPTION|LONG_DESCRIPTION'' "table - field"
FROM mtl_system_items_tl
WHERE (LENGTH(DESCRIPTION)  !=  LENGTH(LTRIM(RTRIM(DESCRIPTION))) 
  OR   LENGTH(long_description)  !=  LENGTH(LTRIM(RTRIM(long_description))) )
AND inventory_item_id =  ''##$$ITEMID$$##''',
      p_title                  => 'Leading / Trailing Spaces in BOM Tables',
      p_fail_condition         => '[leading_trailing_count] <> [0]',
      p_problem_descr          => ' Error:<br> 
"FRM-40654: Record has been updated. Requery block to see change" <br>
When Trying To Make A Change In BOMFDRTG/BOMFDRSO',
      p_solution               => 'Run script to remove leading/trailing spaces.  See [1170153/KB208095] for details.',
      p_success_msg            => 'There are no leading/trailing spaces in BOM tables.  See [1170153/KB208095] for details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_BOMAZ_LEADING_TRAILING');
...
debug('begin add_signature: BOM_PARAMETERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14885',
      p_sig_id                 => 'BOM_PARAMETERS',
      p_sig_sql                => 'SELECT * FROM (
      SELECT 1 seq,''Organization Id'' setting, ##$$ORGID$$## value from Dual
UNION SELECT 2    , ''Max Bill Levels'' , to_char(maximum_bom_level) FROM bom_parameters WHERE organization_id = ##$$ORGID$$##
UNION SELECT 3    , ''Inactive Status'', bom_delete_status_code FROM bom_parameters WHERE organization_id = ##$$ORGID$$##
UNION SELECT 4    , ''Numbering Segment'', config_segment_name FROM bom_parameters WHERE organization_id = ##$$ORGID$$##
UNION SELECT 5    , ''Numbering Method'', decode(config_number_method_type,
                            1,''Append with sequence'',
                            2,''Replace with Sequence'',
                            3,''Replace with order line number'',
                            4,''User Defined'',
                            NULL,''Undefined'',
                            config_number_method_type
                            ) FROM bom_parameters WHERE organization_id = ##$$ORGID$$##
UNION SELECT 6    , ''Create Lower Level Supply'', decode(enable_lower_level_supply,
                            1,''No'',
                            2,''Auto Created Configuration Items only'',
                            3,''Auto Created Configuration Items and ATO Items'',
                            NULL,''Undefined'',
                              ''ENABLE_LOWER_LEVEL_SUPPLY'') FROM bom_parameters WHERE organization_id = ##$$ORGID$$##
UNION SELECT 7    , ''Config BOM Creation Allowed'', create_config_bom FROM bom_parameters WHERE organization_id = ##$$ORGID$$##                              
UNION SELECT 8    , ''Include Model/Option Class Items in Lead Time Rollup'', include_models_in_rollup FROM bom_parameters WHERE organization_id = ##$$ORGID$$## 
UNION SELECT 9    , ''Use Phantom Routings'', include_models_in_rollup FROM bom_parameters WHERE organization_id = ##$$ORGID$$##
UNION SELECT 10   , ''Inherit Phantom Op Seq'', decode(inherit_phantom_op_seq,1,''Y'',''N'') FROM bom_parameters WHERE organization_id = ##$$ORGID$$##
) ORDER BY seq',
      p_title                  => 'BOM Parameters',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No BOM Parameters found for the specified organization.',
      p_solution               => '',
      p_success_msg            => 'BOM Parameters for the specified organization.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_PARAMETERS');



debug('begin add_signature: BOM_COMMON_BILL_LISTING_11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15435',
      p_sig_id                 => 'BOM_COMMON_BILL_LISTING_11I',
      p_sig_sql                => 'select
decode(bs.bill_sequence_id,bs.common_bill_sequence_id,''-'',''Common'') common_bill_type
,mp1.organization_code org
,mif1.item_number assembly_item
,bs.alternate_bom_designator
,mp2.organization_code commoned_org
,mif2.item_number commoned_assembly_item
,bs.organization_id
,bs.assembly_item_id
,bs.common_organization_id
,bs.common_assembly_item_id
,bs.bill_sequence_id
,bs.common_bill_sequence_id
,mif1.pick_components_flag pto
,mif2.pick_components_flag pto_common
,mif1.replenish_to_order_flag ato
,mif2.replenish_to_order_flag ato_common
,mif1.bom_item_type bit
,mif2.bom_item_type bit_common
,mif1.base_item_id base_id
,mif2.base_item_id base_id_common
,mif1.bom_enabled_flag bom_enabled_flag
,mif2.bom_enabled_flag bom_enabled_flag_common
,decode(mif1.bom_item_type,
1, decode(mif1.pick_components_flag,''Y'',''PTO Model'',decode(mif1.replenish_to_order_flag,''Y'',''ATO Model'',''Unrecognized Model Type'')),
2, decode(mif1.pick_components_flag,''Y'',''PTO Option Class'',decode(mif1.replenish_to_order_flag,''Y'',''ATO Option Class'',''Unrecognized Option Class Type'')),
3, ''Planning'',
4, decode(mif1.pick_components_flag
,''Y'',''PTO Item (kit)''
,''N'',decode(mif1.replenish_to_order_flag,
''Y'',decode(mif1.base_item_id,null,''ATO Item'',''Configuration Item'')
,''Standard Item''
)
,''Unrecognized Standard Item Type''
),
5, ''Planning (Product Family)'',
''Unrecongnized BOM Item Type''
) bom_validation_type
from
(
select bs.bill_sequence_id
,bs.common_bill_sequence_id
from bom_structures_b bs
where (bs.organization_id=''##$$FK2$$##'' and bs.assembly_item_id=''##$$FK3$$##'' and bs.common_bill_sequence_id=''##$$FK4$$##'')
) X ,
bom_structures_b bs
,mtl_parameters mp1
,mtl_parameters mp2
...
,mtl_item_flexfields mif2
where
(bs.bill_sequence_id = X.common_bill_sequence_id or bs.common_bill_sequence_id = X.common_bill_sequence_id)
and bs.organization_id = mp1.organization_id
and bs.organization_id = mif1.organization_id
and bs.assembly_item_id = mif1.inventory_item_id
and bs.common_organization_id = mp2.organization_id(+)
and bs.common_organization_id = mif2.organization_id(+)
and bs.common_assembly_item_id = mif2.inventory_item_id(+)
and decode(bs.bill_sequence_id,bs.common_bill_sequence_id,''-'',''Common'') <> ''-''
and (''##$$FK1$$##'' is null or bs.alternate_bom_designator = ''##$$FK1$$##'')
order by
bs.common_bill_sequence_id
,decode(bs.bill_sequence_id,bs.common_bill_sequence_id,''-'',''Common'')
,mp1.organization_code
,bs.alternate_bom_designator',
      p_title                  => 'Common Bills',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Common Bills defined for this Bill.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: BOM_COMMON_BILL_LISTING_11I');



debug('begin add_signature: BOM_COMMONED_BILL_LISTING_11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15436',
      p_sig_id                 => 'BOM_COMMONED_BILL_LISTING_11I',
      p_sig_sql                => 'select 
 decode(bs.bill_sequence_id,bs.common_bill_sequence_id,''-'',''Common'') common_bill_type
,mp1.organization_code org
,mif1.item_number assembly_item
,bs.alternate_bom_designator
,bs.alternate_bom_designator "##$$FK1$$##"
,mp2.organization_code commoned_org
,mif2.item_number commoned_assembly_item
,bs.organization_id
,bs.organization_id "##$$FK2$$##"
,bs.assembly_item_id
,bs.assembly_item_id "##$$FK3$$##"
,bs.common_organization_id
,bs.common_assembly_item_id
,bs.bill_sequence_id
,bs.common_bill_sequence_id
,bs.common_bill_sequence_id "##$$FK4$$##"
,mif1.pick_components_flag pto
,mif2.pick_components_flag pto_common
,mif1.replenish_to_order_flag ato
,mif2.replenish_to_order_flag ato_common
...
from bom_structures_b bs
where
(bs.organization_id=''##$$ORGID$$##'' and bs.assembly_item_id=''##$$ITEMID$$##'')
and exists (
select * from bom_structures_b common
where (
bs.bill_sequence_id = common.common_bill_sequence_id
or
bs.common_bill_sequence_id = common.bill_sequence_id
)
)
...
,mp1.organization_code
,bs.alternate_bom_designator',
      p_title                  => 'Commoned Bills',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Common Bills defined for this Item.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      ...
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('BOM_COMMON_BILL_LISTING_11I'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '11'
      );
   l_info.delete;
debug('end add_signature: BOM_COMMONED_BILL_LISTING_11I');



debug('begin add_signature: BOM_BILLS_HEADER_11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15437',
      p_sig_id                 => 'BOM_BILLS_HEADER_11I',
      p_sig_sql                => 'select mif1.item_number  item_number   
,bsb.assembly_item_id              
,mp1.organization_code         		
,bsb.organization_id             
,bsb.alternate_bom_designator
,bsb.bill_sequence_id      
,to_char(bsb.last_update_date,''DD-MON-YYYY HH24:MI:SS'')  last_update_date
,bsb.last_updated_by               
,to_char(bsb.creation_date,''DD-MON-YYYY HH24:MI:SS'') creation_date
,bsb.created_by                     
,bsb.last_update_login              
,bsb.specific_assembly_comment      
,bsb.pending_from_ecn               
,bsb.attribute_category             
,bsb.attribute1                     
,bsb.attribute2                     
,bsb.attribute3                     
,bsb.attribute4                     
...
,bsb.attribute14                    
,bsb.attribute15                    
,decode(bsb.assembly_type,null,null,1, ''Manufacturing (1)'',  2, ''Engineering (2)'',  ''other (''||bsb.assembly_type||'')'')  assembly_type      
,mif2.item_number common_assembly_item       
,nvl(bsb.common_assembly_item_id,bsb.assembly_item_id) common_assembly_item_id
,mp2.organization_code                          
,nvl(bsb.common_organization_id,bsb.organization_id) common_organization_id  
,bsb.common_bill_sequence_id        
,bsb.bill_sequence_id "##$$FK1$$##"              
,bsb.request_id                     
,bsb.program_application_id         
,bsb.program_id                     
,to_char(bsb.program_update_date,''DD-MON-YYYY HH24:MI:SS'') program_update_date
,bsb.next_explode_date              
,bsb.project_id                     
,bsb.task_id                        
,bsb.original_system_reference       
,bsb.structure_type_id              
,bsb.implementation_date            
,bsb.obj_name                       
,bsb.pk1_value                      
,bsb.pk2_value                      
,bsb.pk3_value                      
...
and bsb.organization_id =  ''##$$ORGID$$##''
and bsb.assembly_item_id =  ''##$$ITEMID$$##''
order by nvl2(alternate_bom_designator,2,1), alternate_bom_designator',
      p_title                  => 'Bill Header',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Bill Header data found for the entered organization/item parameters (BOM_STRUCTURES_B).',
      p_solution               => '',
      p_success_msg            => 'Bill Header data for the entered organization/item parameters (BOM_STRUCTURES_B).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_BILLS_HEADER_11I');



debug('begin add_signature: BOM_BILL_HEADER_ATTACHMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14972',
      p_sig_id                 => 'BOM_BILL_HEADER_ATTACHMENTS',
      p_sig_sql                => 'select bom.assembly_item_id
,bom.organization_id
...
,5, ''Web Page (5)''
,6, ''File (6)''
,7, ''Document Reference (7)''
,8, ''Oracle File (8)''
,9, ''Oracle Files Folder/Workspace''
,fd.datatype_id) data_type_id
,fdl.file_name 
from fnd_documents fd,
fnd_documents_tl fdl,
bom_structures_b bom,
fnd_attached_documents fad
where fd.document_id = fdl.document_id
and bom.assembly_item_id = ''##$$ITEMID$$##''
and bom.organization_id = ''##$$ORGID$$##''
and fd.document_id = fad.document_id
and fad.entity_name like ''BOM_BILL_OF_MATERIALS''
and fad.pk1_value = bom.bill_sequence_id
and fd.security_id = bom.organization_id',
      p_title                  => 'Bills Header Attachments',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'No attachments found for this Bill Header.',
      p_solution               => '',
      p_success_msg            => 'Attachments for this Bill Header.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_BILL_HEADER_ATTACHMENTS');



debug('begin add_signature: BOM_BILL_COMPONENTS_11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15438',
      p_sig_id                 => 'BOM_BILL_COMPONENTS_11I',
      p_sig_sql                => 'select mif1.item_number assembly_item_number
,bsb.assembly_item_id   
,mp1.organization_code  
,bsb.organization_id    
,bsb.alternate_bom_designator   
,bcb.bill_sequence_id           
,mif2.item_number  component_item_number   
,bcb.component_item_id          
,bcb.component_sequence_id        
,bcb.operation_seq_num          
,bcb.item_num                   
,nvl(bcb.component_quantity,0) component_quantity
,nvl(bcb.component_yield_factor,0) component_yield_factor     
,bcb.component_remarks                
,to_char(bcb.effectivity_date, ''DD-MON-YYYY HH24:MI:SS'') effectivity_date            
,bcb.change_notice                            
,to_char(bcb.implementation_date,''DD-MON-YYYY HH24:MI:SS'') implementation_date
,to_char(bcb.disable_date,''DD-MON-YYYY HH24:MI:SS'') disable_date             
,bcb.planning_factor           
,decode(bcb.quantity_related
,1,''(1) Yes''
,2,''(2) No''
,bcb.quantity_related ) quantity_related 
,decode(bcb.so_basis
,1,''(1) Option class''
,2,''(2) None''
,bcb.so_basis) so_basis  
,decode(bcb.optional
,1,''(1) Yes''
,2,''(2) No'' 
,bcb.optional) optional   
,decode(bcb.mutually_exclusive_options
,1,''(1) Yes''
,2,''(2) No''
,bcb.mutually_exclusive_options) mutually_exclusive_options
,decode(bcb.include_in_cost_rollup
,1,''(1) Yes''
,2,''(2) No''
,bcb.include_in_cost_rollup)  include_in_cost_rollup   
,decode(bcb.check_atp
,1,''(1) Yes''
,2,''(2) No''
,bcb.check_atp) check_atp              
,decode(bcb.shipping_allowed
,1,''(1) Yes''
,2,''(2) No''
,bcb.shipping_allowed)shipping_allowed          
,decode(bcb.required_to_ship
,1,''(1) Yes''
,2,''(2) No''
,bcb.required_to_ship) required_to_ship         
,decode(bcb.required_for_revenue
,1,''(1) Yes''
,2,''(2) No''
,bcb.required_for_revenue) required_for_revenue      
,decode(bcb.include_on_ship_docs
,1,''(1) Yes''
,2,''(2) No''
,bcb.include_on_ship_docs) include_on_ship_docs      
,decode(bcb.include_on_bill_docs
,1,''(1) Yes''
,2,''(2) No''
,bcb.include_on_bill_docs) include_on_bill_docs     
,bcb.low_quantity             
,bcb.high_quantity         
,decode(bcb.acd_type
,1,''(1)	Add''
,2,''(2)	Change''
,3,''(3)	Disable''
,bcb.acd_type) acd_type
,bcb.old_component_sequence_id    
...
,5,''(5)	Supplier''
,6,''(6)	Phantom''
,7,''(7)	Based on Bill'') wip_supply_type
,bcb.pick_components              
,bcb.supply_subinventory          
,bcb.supply_locator_id            
,bcb.operation_lead_time_percent  
,bcb.revised_item_sequence_id     
,bcb.cost_factor                  
,decode(bcb.bom_item_type
,1,''(1) Model''
,2,''(2) Option class''
,3,''(3) Planning''
,4,''(4) Standard''
,5,''(5) Product family''
,bcb.bom_item_type) bom_item_type              
,bcb.from_end_item_unit_number    
,bcb.to_end_item_unit_number      
,bcb.original_system_reference    
,bcb.eco_for_production           
,bcb.enforce_int_requirements     
,bcb.component_item_revision_id   
,bcb.delete_group_name            
,bcb.dg_description               
,bcb.optional_on_model            
,bcb.parent_bill_seq_id           
,bcb.model_comp_seq_id            
,bcb.plan_level                   
,bcb.from_bill_revision_id        
,bcb.to_bill_revision_id          
,bcb.auto_request_material        
,to_char(bcb.last_update_date,''DD-MON-YYYY HH24:MI:SS'') last_update_date        
,bcb.last_updated_by                            
,to_char(bcb.creation_date, ''DD-MON-YYYY HH24:MI:SS'')  creation_date            
,bcb.created_by                       
,bcb.last_update_login                
,bcb.request_id                       
,bcb.program_application_id           
,bcb.program_id                       
,to_char(bcb.program_update_date, ''DD-MON-YYYY HH24:MI:SS'') program_update_date     
,bcb.suggested_vendor_name         
,bcb.vendor_id                     
,bcb.unit_price                    
,bcb.obj_name                      
,bcb.pk1_value                     
...
,bcb.overlapping_changes           
,bcb.from_object_revision_id       
,bcb.from_minor_revision_id        
,bcb.to_object_revision_id         
,bcb.to_minor_revision_id          
,bcb.from_end_item_minor_rev_id    
,bcb.to_end_item_minor_rev_id      
,bcb.component_minor_revision_id   
,bcb.from_structure_revision_code  
,bcb.to_structure_revision_code    
,bcb.from_end_item_strc_rev_id     
,bcb.to_end_item_strc_rev_id       
...
and bsb.organization_id =  ''##$$ORGID$$##''
and bsb.assembly_item_id =  ''##$$ITEMID$$##''
order by nvl2(bsb.alternate_bom_designator,2,1)
       , bsb.alternate_bom_designator
       , bcb.operation_seq_num
       , bcb.item_num',
      p_title                  => 'Bill Components',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Bill Component data found for the entered organization/item parameters (BOM_COMPONENTS_B).',
      p_solution               => '',
      p_success_msg            => 'Bill Component data for the entered organization/item parameters (BOM_COMPONENTS_B).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_BILL_COMPONENTS_11I');



debug('begin add_signature: BOM_SUBS_COMPONEN_11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15441',
      p_sig_id                 => 'BOM_SUBS_COMPONEN_11I',
      p_sig_sql                => 'select           
mif1.item_number assembly_item
,bsb.assembly_item_id   
,mp1.organization_code  
...
,bcb.component_item_id     
,bcb.component_sequence_id 
,mif3.item_number substitute_item
,bsco.substitute_component_id       
,to_char(bsco.last_update_date, ''DD-MON-YYYY HH24:MI:SS'') last_update_date 
,bsco.last_updated_by                             
,to_char(bsco.creation_date, ''DD-MON-YYYY HH24:MI:SS'') creation_date  
,bsco.created_by                          
,bsco.last_update_login                   
,nvl(bsco.substitute_item_quantity,0)     
,bsco.component_sequence_id               
,decode(bsco.acd_type,1, ''Add (1)'', 2, ''Change (2)'', 3, ''Disable (3)'', bsco.acd_type) acd_type
,bsco.change_notice                      
,bsco.request_id                       
,bsco.program_application_id           
,bsco.program_id                       
,to_char(bsco.program_update_date, ''DD-MON-YYYY HH24:MI:SS'') program_update_date
,bsco.attribute_category                          
,bsco.original_system_reference    
,bsco.enforce_int_requirements     
from              
bom_components_b bcb         
,bom_structures_b bsb        
...
and bsb.organization_id =  ''##$$ORGID$$##''
and bsb.assembly_item_id =  ''##$$ITEMID$$##''',
      p_title                  => 'Bill Substitute Components',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Substitute Component data found for the entered organization/item parameters (BOM_SUBSTITUTE_COMPONENTS).',
      p_solution               => '',
      p_success_msg            => 'Bill Substitute Component data for the entered organization/item parameters (BOM_SUBSTITUTE_COMPONENTS).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_SUBS_COMPONEN_11I');



debug('begin add_signature: BOM_COMPONENT_OPERATION_11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15442',
      p_sig_id                 => 'BOM_COMPONENT_OPERATION_11I',
      p_sig_sql                => 'SELECT
     bs.bill_sequence_id
    ,bs.assembly_item_id
    ,bs.alternate_bom_designator
    ...
    ,bc.item_num
    ,bc.operation_seq_num component_op_seq_num
    ,bco.operation_sequence_id
	,BCO.operation_seq_num
	,BCO.operation_sequence_id
	,to_char(BCO.last_update_date,''DD-MON-YYYY HH24:MI:SS'') last_update_date
	,BCO.last_updated_by
	,to_char(BCO.creation_date,''DD-MON-YYYY HH24:MI:SS'') creation_date
	,BCO.created_by
	,BCO.last_update_login
	,BCO.component_sequence_id
	,BCO.bill_sequence_id
	,BCO.consuming_operation_flag
	,BCO.consumption_quantity
	,BCO.supply_subinventory
	,BCO.supply_locator_id
	,BCO.wip_supply_type
	...
	,BCO.attribute15
	,BCO.request_id
	,BCO.program_application_id
	,BCO.program_id
	,to_char(BCO.program_update_date,''DD-MON-YYYY HH24:MI:SS'') program_update_date
FROM bom_component_operations BCO
    ,bom_components_b  bc
    ,bom_structures_b bs
    ,bom_operation_sequences    bos
where 1=1
  and bs.organization_id = ''##$$ORGID$$##''
  and bs.assembly_item_id = ''##$$ITEMID$$##''
  and bco.component_sequence_id = bc.component_sequence_id
  and bc.bill_sequence_id = bs.bill_sequence_id
  and bco.component_sequence_id = bc.component_sequence_id 
  and bco.operation_sequence_id=bos.operation_sequence_id
order by 
     bs.bill_sequence_id
    ,bs.assembly_item_id
    ,bc.item_num
    ...
    ,bco.operation_seq_num',
      p_title                  => 'Bill Component Operations',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Bill Component Operations found for the entered organization/item parameters (BOM_COMPONENT_OPERATIONS).',
      p_solution               => '',
      p_success_msg            => 'Bill Component Operations data for the entered organization/item parameters (BOM_COMPONENT_OPERATIONS).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_COMPONENT_OPERATION_11I');



debug('begin add_signature: BOM_REF_DESIGNATOR_11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15443',
      p_sig_id                 => 'BOM_REF_DESIGNATOR_11I',
      p_sig_sql                => 'select mif1.item_number assembly_item
,bsb.assembly_item_id
,mp1.organization_code
,bsb.organization_id
...
,to_char(brd.last_update_date,''DD-MON-YYYY HH24:MI:SS'') last_update_date
,brd.last_updated_by
,to_char(brd.creation_date,''DD-MON-YYYY HH24:MI:SS'') creation_date
,brd.created_by
,brd.last_update_login
,brd.ref_designator_comment
,brd.change_notice
,brd.component_sequence_id
,decode(brd.acd_type,1,''Add (1)'',2,''Change (2)'',3,''Delete (3)'',brd.acd_type) acd_type
,brd.request_id
,brd.program_application_id
,brd.program_id
,to_char(brd.program_update_date,''DD-MON-YYYY HH24:MI:SS'') program_update_date
...
and bsb.organization_id =  ##$$ORGID$$##
and bsb.assembly_item_id =  ##$$ITEMID$$##',
      p_title                  => 'Bill Reference Designators',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Bill Reference Designators found for the entered organization/item parameters (BOM_REFERENCE_DESIGNATORS).',
      p_solution               => '',
      p_success_msg            => 'Bill Reference Designators data for the entered organization/item parameters (BOM_COMPONENT_OPERATIONS).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_REF_DESIGNATOR_11I');



debug('begin add_signature: BOM_BILL_EXPLOSIONS_11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15445',
      p_sig_id                 => 'BOM_BILL_EXPLOSIONS_11I',
      p_sig_sql                => 'SELECT
	...
	,operation_seq_num
	,item_num
	,to_char(effectivity_date,''DD-MON-YYYY HH24:MI:SS'') effectivity_date
	,to_char(disable_date,''DD-MON-YYYY HH24:MI:SS'') disable_date
	,to_char(implementation_date,''DD-MON-YYYY HH24:MI:SS'') implementation_date
	,rexplode_flag
	...
	,num_col2
	,num_col3
	,to_char(date_col1,''DD-MON-YYYY HH24:MI:SS'') date_col1
	,to_char(date_col2,''DD-MON-YYYY HH24:MI:SS'') date_col2
	,to_char(date_col3,''DD-MON-YYYY HH24:MI:SS'') date_col3
	,char_col1
	,char_col2
	,char_col3
	...
	,unit_price
FROM bom_explosions
WHERE  top_item_id = ''##$$ITEMID$$##''
ORDER BY organization_id, top_item_id, explosion_type, sort_order',
      p_title                  => 'BOM Explosions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Bill Explosions found for the entered organization/item parameters (BOM_EXPLOSIONS).',
      p_solution               => '',
      p_success_msg            => 'Bill Explosions data for the entered organization/item parameters (BOM_EXPLOSIONS).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_BILL_EXPLOSIONS_11I');



debug('begin add_signature: BOM_COMMON_ROUTING_LISTING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14574',
      p_sig_id                 => 'BOM_COMMON_ROUTING_LISTING',
      p_sig_sql                => 'SELECT 
        decode(bor2.routing_sequence_id,bor2.common_routing_sequence_id,''-'',''Common'') common_routing_type
       ,mp.organization_code
       ,mif1.item_number assembly_item
       ,bor2.alternate_routing_designator
       ,mif2.item_number common_assembly_item
       ,bor2.organization_id
       ,bor2.assembly_item_id
       ,bor2.common_assembly_item_id
       ,bor2.routing_sequence_id
       ,bor2.common_routing_sequence_id
 FROM 
      ...
      ,mtl_item_flexfields mif2
WHERE 1=1
    AND bor1.routing_sequence_id = ''##$$FK1$$##''
    AND bor1.common_routing_sequence_id = bor2.common_routing_sequence_id
AND bor2.routing_sequence_id <> bor2.common_routing_sequence_id 
    AND bor2.organization_id = mp.organization_id
    AND bor2.organization_id = mif1.organization_id
    AND bor2.assembly_item_id = mif1.inventory_item_id
    AND bor2.organization_id = mif2.organization_id(+)
    AND bor2.common_assembly_item_id = mif2.inventory_item_id(+)
ORDER BY 
      bor2.common_routing_sequence_id
     ,decode(bor2.routing_sequence_id,bor2.common_routing_sequence_id,''-'',''Common'')
     ,bor2.organization_id
     ,bor2.alternate_routing_designator',
      p_title                  => 'Common Routings',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Common Routings defined for this item.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: BOM_COMMON_ROUTING_LISTING');



debug('begin add_signature: BOM_COMMONED_ROUTING_LISTING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14573',
      p_sig_id                 => 'BOM_COMMONED_ROUTING_LISTING',
      p_sig_sql                => 'select 
        decode(bor2.routing_sequence_id,bor2.common_routing_sequence_id,''-'',''Common'') common_routing_type
       ,mp.organization_code
       ,mif1.item_number assembly_item
       ...
       ,bor2.routing_sequence_id
       ,bor2.common_routing_sequence_id
       ,bor2.common_routing_sequence_id "##$$FK1$$##"
 from 
       bom_operational_routings bor1
      ,bom_operational_routings bor2 
      ,mtl_parameters mp
      ...
      ,mtl_item_flexfields mif2
where 1=1
    and bor1.organization_id = ''##$$ORGID$$##'' and bor1.assembly_item_id = ''##$$ITEMID$$##''	
    and bor1.common_routing_sequence_id = bor2.common_routing_sequence_id
    and bor2.routing_sequence_id = bor2.common_routing_sequence_id  -- uncomment this one to just see the commoned routing
    and bor2.organization_id = mp.organization_id
    and bor2.organization_id = mif1.organization_id
    and bor2.assembly_item_id = mif1.inventory_item_id
    and bor2.organization_id = mif2.organization_id(+)
...
order by 
     ...
     ,bor2.organization_id
     ,bor2.alternate_routing_designator',
      p_title                  => 'Commoned Routings',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Routings defined for this item.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      ...
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('BOM_COMMON_ROUTING_LISTING'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '12'
      );
   l_info.delete;
debug('end add_signature: BOM_COMMONED_ROUTING_LISTING');



debug('begin add_signature: BOM_ROUTING_HEADER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14849',
      p_sig_id                 => 'BOM_ROUTING_HEADER',
      p_sig_sql                => 'select 
mif1.item_number assembly_item        
,bor1.assembly_item_id          
,mp1.organization_code           
,bor1.organization_id          
,bor1.alternate_routing_designator        
,bor1.routing_sequence_id           
,to_char(bor1.last_update_date, ''DD-MON-YYYY HH24:MI:SS'') last_update_date      
,bor1.last_updated_by            
,to_char(bor1.creation_date, ''DD-MON-YYYY HH24:MI:SS'') creation_date     
,bor1.created_by           
,bor1.last_update_login         
,decode(bor1.routing_type, 1, ''Manufacturing (1)'', 2, ''Engineering (2)'') routing_type
,mif2.item_number           
,nvl(bor1.common_assembly_item_id,bor1.assembly_item_id)  common_assembly_item_id     
,mp2.organization_code           
,nvl(mp2.organization_id,mp1.organization_id) organization_id      
,bor1.common_routing_sequence_id           
,bor1.routing_comment             
,bor1.completion_subinventory            
,bor1.completion_locator_id            
,bor1.attribute_category                             
,bor1.program_application_id        
,bor1.program_id         
,to_char(bor1.program_update_date, ''DD-MON-YYYY HH24:MI:SS'') program_update_date
,bor1.line_id               
,decode(bor1.cfm_routing_flag, 1, ''Yes (1)'', 2, ''No (2)'', bor1.cfm_routing_flag) cfm_routing_flag    
,decode(bor1.mixed_model_map_flag, 1, ''Yes (1)'', 2, ''No (2)'', bor1.mixed_model_map_flag) mixed_model_map_flag       
,bor1.priority            
,bor1.total_product_cycle_time           
,decode(bor1.ctp_flag, 1, ''Yes (1)'', 2, ''No (2)'', bor1.ctp_flag) ctp_flag
,bor1.project_id                  
,bor1.task_id             
,bor1.pending_from_ecn           
,bor1.original_system_reference         
,bor1.serialization_start_op           
from 
bom_operational_routings bor1             
,mtl_parameters mp1
,mtl_item_flexfields mif1
...
and bor2.organization_id =  mif2.organization_id           
and mif2.organization_id =  mp2.organization_id            
and bor1.organization_id =  ''##$$ORGID$$##''
and bor1.assembly_item_id =  ''##$$ITEMID$$##''',
      p_title                  => 'Routing Header',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Routing Headers found for the entered organization/item parameters (BOM_OPERATIONAL_ROUTINGS).',
      p_solution               => '',
      p_success_msg            => 'Routing Header data for the entered organization/item parameters (BOM_OPERATIONAL_ROUTINGS).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_ROUTING_HEADER');



debug('begin add_signature: BOM_ROUTING_OPERATIONS_11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15449',
      p_sig_id                 => 'BOM_ROUTING_OPERATIONS_11I',
      p_sig_sql                => 'select 
...
,to_char(bos.last_update_date, ''DD-MON-YYYY HH24:MI:SS'') last_update_date        
,bos.last_updated_by                    
,to_char(bos.creation_date,''DD-MON-YYYY HH24:MI:SS'') creation_date    
,bos.created_by                      
,bos.last_update_login               
,bos.standard_operation_id           
,bos.department_id                   
,bos.operation_lead_time_percent        
,bos.minimum_transfer_quantity        
,decode(bos.count_point_type,1, ''Yes-autocharge (1)'',2, ''No-autocharge (2)'',3, ''No-direct charge (3)'', bos.count_point_type) count_point_type   
,bos.operation_description 
,to_char(bos.effectivity_date,''DD-MON-YYYY HH24:MI:SS'') effectivity_date     
,to_char(bos.disable_date,''DD-MON-YYYY HH24:MI:SS'') disable_date        
,decode(bos.backflush_flag,1, ''Yes (1)'',2, ''No (2)'', bos.backflush_flag) backflush_flag       
,decode(bos.option_dependent_flag,1, ''Yes (1)'',2, ''No (2)'', bos.option_dependent_flag) option_dependent_flag
,bos.request_id            
,bos.program_application_id
,bos.program_id            
,to_char(bos.program_update_date,''DD-MON-YYYY HH24:MI:SS'')program_update_date   
,decode(bos.operation_type,1, ''Event (1)'',2, ''Process (2)'',3, ''Line operation (3)'', bos.operation_type) operation_type
,decode(bos.reference_flag, 1, ''Yes (1)'',2, ''No (2)'', bos.reference_flag) reference_flag
...
,bos.x_coordinate             
,bos.y_coordinate             
,decode(bos.include_in_rollup,1, ''Yes (1)'',2, ''No (2)'', bos.include_in_rollup) include_in_rollup 
,decode(bos.operation_yield_enabled,1, ''Yes (1)'',2, ''No (2)'', bos.operation_yield_enabled) operation_yield_enabled
,bos.old_operation_sequence_id
,decode(bos.acd_type,1, ''ADD (1)'',2, ''Change (2)'' ,3, ''Delete (3)'', bos.acd_type) acd_type    
,bos.revised_item_sequence_id  
,bos.original_system_reference 
,bos.change_notice            
,to_char(bos.implementation_date,''DD-MON-YYYY HH24:MI:SS'') implementation_date
,decode(bos.eco_for_production, 1, ''Yes (1)'',2, ''No (2)'', bos.eco_for_production)  eco_for_production
,decode(bos.shutdown_type, 1, ''Not Required (1)'', 2, ''Required (2)'', 3, ''Down (3)'', bos.shutdown_type) shutdown_type
,bos.actual_ipk                      
,bos.critical_to_quality             
,bos.value_added                     
,bos.machine_process_efficiency      
,bos.labor_process_efficiency        
,bos.total_process_efficiency        
,bos.long_description                
,bos.config_routing_id              
,bos.model_op_seq_id                               
from    
bom_operational_routings bor
,bom_operation_sequences bos
...
and bor.organization_id =  ''##$$ORGID$$##''
and bor.assembly_item_id =  ''##$$ITEMID$$##''',
      p_title                  => 'Routing Operations',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Routing Operations found for the entered organization/item parameters (BOM_OPERATION_SEQUENCES).',
      p_solution               => '',
      p_success_msg            => 'Routing Operation data for the entered organization/item parameters (BOM_OPERATION_SEQUENCES).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_ROUTING_OPERATIONS_11I');



debug('begin add_signature: BOM_BILL_OPERATION_ATTACHMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14979',
      p_sig_id                 => 'BOM_BILL_OPERATION_ATTACHMENTS',
      p_sig_sql                => 'select bor.assembly_item_id
    ,bor.organization_id
...
from fnd_documents fd,
     ...
     bom_operational_routings bor,
     fnd_attached_documents fad
where bor.assembly_item_id = ''##$$ITEMID$$##''
and bor.organization_id = ''##$$ORGID$$##''
and bos.routing_sequence_id = bor.routing_sequence_id
and fd.document_id = fdl.document_id
and fd.document_id = fad.document_id
and fad.entity_name = ''BOM_OPERATION_SEQUENCES''
and fad.pk1_value = bos.operation_sequence_id
and fd.security_id = bor.organization_id',
      p_title                  => 'Bill Routing Operation Attachments',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No operation sequence attachments found for this routing.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: BOM_BILL_OPERATION_ATTACHMENTS');



debug('begin add_signature: BOM_OPERATION_RESOURCES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14954',
      p_sig_id                 => 'BOM_OPERATION_RESOURCES',
      p_sig_sql                => 'select 
mif.item_number assembly_item
,bor.assembly_item_id
,mp.organization_code
...
,bor.routing_sequence_id
,bos.operation_seq_num
,bore.operation_sequence_id
,bore.resource_seq_num
,br.resource_code
,bore.resource_id
,br.description
,bore.activity_id
,decode(bore.standard_rate_flag,1,''Yes (1)'',2,''No (2)'',bore.standard_rate_flag) standard_rate_flag
,bore.assigned_units
,bore.usage_rate_or_amount
,bore.usage_rate_or_amount_inverse
,decode(bore.basis_type
,1, ''Item (1)''
,2, ''Lot (2)''
,3, ''Resource Units (3)''
,4, ''Resource Value (4)''
,5, ''Total Value (5)''
,6, ''Activity (6)''
,bore.basis_type) basis_type
,decode(bore.schedule_flag
,1, ''Yes (1)''
,2, ''No (2)''
,3, ''Prior (3)''
,4, ''Next (4)''
,bore.schedule_flag) schedule_flag
,to_char(bore.last_update_date,''DD-MON-YYYY HH24:MI:SS'') last_update_date
,bore.last_updated_by
,to_char(bore.creation_date,''DD-MON-YYYY HH24:MI:SS'') creation_date
,bore.created_by
,bore.last_update_login
,bore.resource_offset_percent
,decode(bore.autocharge_type
,1, ''WIP move (1)''
,2, ''Manual (2)''
,3, ''PO receipt (3)''
,4, ''PO move (4)''
,bore.autocharge_type) autocharge_type
,bore.program_application_id
,bore.program_id
,to_char(bore.program_update_date,''DD-MON-YYYY HH24:MI:SS'') program_update_date
,bore.schedule_seq_num
,bore.substitute_group_num
,decode(bore.principle_flag,1,''Yes (1)'',2,''No (2)'', bore.principle_flag) principle_flag
,bore.setup_id
,bore.change_notice
,decode(bore.acd_type
,1, ''Add (1)''
,2, ''Change (2)''
,3, ''Delete (3)''
, bore.acd_type) acd_type
,bore.original_system_reference
from 
bom_operational_routings bor
,bom_operation_sequences bos
...
and bor.organization_id = ''##$$ORGID$$##''
and bor.assembly_item_id = ''##$$ITEMID$$##''',
      p_title                  => 'Routing Operation Resources',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Routing Operation Resources found for the entered organization/item parameters (BOM_OPERATION_RESOURCES).',
      p_solution               => '',
      p_success_msg            => 'Routing Operation Resource data for the entered organization/item parameters (BOM_OPERATION_RESOURCES).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_OPERATION_RESOURCES');



debug('begin add_signature: BOM_OPER_SUB_RESOURCES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14955',
      p_sig_id                 => 'BOM_OPER_SUB_RESOURCES',
      p_sig_sql                => 'select 
mif.padded_item_number item_number
,bor.assembly_item_id
,mp.organization_code
,bor.organization_id
,bor.alternate_routing_designator
...
,bsor.activity_id
,decode(bsor.standard_rate_flag
,1,''Yes (1)''
,2,''No (2)''
...
,decode(bsor.schedule_flag
,1, ''Yes (1)''
,2, ''No (2)''
,3, ''Prior (3)''
,4, ''Next (4)''
,bsor.schedule_flag) schedule_flag
,to_char(bsor.last_update_date,''DD-MON-YYYY HH24:MI:SS'') last_update_date
,bsor.last_updated_by
,to_char(bsor.creation_date,''DD-MON-YYYY HH24:MI:SS'') creation_date
,bsor.created_by
,bsor.last_update_login
,bsor.resource_offset_percent
,decode(bsor.autocharge_type
,1, ''WIP move (1)''
,2, ''Manual (2)''
,3, ''PO receipt (3)''
,4, ''PO move (4)''
...
,bsor.program_id
,to_char(bsor.program_update_date,''DD-MON-YYYY HH24:MI:SS'') program_update_date
,decode(bsor.principle_flag
,1, ''Yes (1)''
,2, ''No (2)''
,bsor.principle_flag) principle_flag
,bsor.setup_id
,bsor.change_notice
,decode(bsor.acd_type
,1, ''Add (1)''
,2, ''Change (2)''
,3, ''Delete (3)''
,bsor.acd_type) acd_type
...
and bor.organization_id =  ''##$$ORGID$$##''
and bor.assembly_item_id =  ''##$$ITEMID$$##''',
      p_title                  => 'Routing Sub Operation Resources',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Routing Substitute Operation Resources found for the entered organization/item parameters (BOM_SUB_OPERATION_RESOURCES).',
      p_solution               => '',
      p_success_msg            => 'Routing Operation Substitute Resource data for the entered organization/item parameters (BOM_SUB_OPERATION_RESOURCES).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_OPER_SUB_RESOURCES');



debug('begin add_signature: BOM_OPER_NETWORK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14952',
      p_sig_id                 => 'BOM_OPER_NETWORK',
      p_sig_sql                => 'select
mif.padded_item_number
,bor.assembly_item_id
,mp.organization_code
,bor.organization_id
,bor.alternate_routing_designator
...
,bon.transition_type
,bon.planning_pct
,to_char(bon.effectivity_date,''DD-MON-YYYY HH24:MI:SS'') effectivity_date
,to_char(bon.disable_date,''DD-MON-YYYY HH24:MI:SS'') disable_date
,bon.created_by
,to_char(bon.creation_date,''DD-MON-YYYY HH24:MI:SS'') creation_date
,bon.last_updated_by
,to_char(bon.last_update_date,''DD-MON-YYYY HH24:MI:SS'') last_update_date
,bon.last_update_login
,bon.original_system_reference
,bon.request_id
,bon.program_application_id
,bon.program_id
,to_char(bon.program_update_date,''DD-MON-YYYY HH24:MI:SS'') program_update_date
from 
bom_operational_routings bor 
,bom_operation_sequences bos
...
and bor.organization_id = ''##$$ORGID$$##''
and bor.assembly_item_id = ''##$$ITEMID$$##''',
      p_title                  => 'Routing Operation Networks',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Routing Operation Networks found for the entered organization/item parameters (BOM_OPERATION_NETWORKS).',
      p_solution               => '',
      p_success_msg            => 'Routing Operation Network data for the entered organization/item parameters (BOM_OPERATION_NETWORKS).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_OPER_NETWORK');



debug('begin add_signature: BOM_DELETE_GROUPS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14826',
      p_sig_id                 => 'BOM_DELETE_GROUPS',
      p_sig_sql                => 'SELECT 
       mp.organization_id||'' (''||mp.organization_code||'')'' org
     , bdg.delete_group_name
     , decode(bdg.delete_org_type,1,''Current Organization'',2,''Organization Hierarchy'',3,''All Organizations'',''Unknown (''||bdg.delete_org_type||'')'') org_type
     , bdg.delete_type || '' ('' || lu1.meaning || '')'' delete_type
     , bdg.organization_hierarchy
     , bdg.date_last_submitted last_submitted
     , decode(bdg.delete_common_bill_flag,1,''Yes'',''No'') common_bills_only
     , decode(bdg.action_type,1,''Yes'',''No'') ARCHIVE
     , bdg.delete_group_sequence_id
     , bdg.delete_group_sequence_id "##$$FK1$$##"
     , decode(bdg.delete_type,1,''INV'',7,''INV'',decode(bdg.engineering_flag,2,''ENG'',''BOM'')) bom_or_eng_or_inv
FROM 
      bom_delete_groups bdg
    , mtl_parameters mp
    , mfg_lookups lu1
WHERE 1=1
    AND 
        (bdg.organization_id = ''##$$ORGID$$##'' OR bdg.organization_id = (SELECT master_organization_id FROM mtl_parameters WHERE organization_id = ''##$$ORGID$$##''))
    AND (
         EXISTS (SELECT 1 FROM bom_delete_entities bde WHERE bdg.delete_group_sequence_id = bde.delete_group_sequence_id AND bde.inventory_item_id = ''##$$ITEMID$$##'' AND ROWNUM=1)
         OR 
         EXISTS (SELECT 1 FROM bom_delete_entities bde, bom_delete_sub_entities bdse WHERE bdg.delete_group_sequence_id = bde.delete_group_sequence_id 
                 AND bde.delete_entity_sequence_id = bdse.delete_entity_sequence_id AND bdse.component_item_id = ''##$$ITEMID$$##'' AND ROWNUM=1) 
        )
  AND bdg.organization_id = mp.organization_id
  AND ''BOM_DELETE_TYPE'' = lu1.lookup_type(+)
  AND bdg.delete_type = lu1.lookup_code(+) 
  AND delete_type NOT IN (1,7)
ORDER BY mp.organization_code, bdg.delete_group_name',
      p_title                  => 'Delete Groups',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'No Delete Group Headers found for the entered organization/item parameters (BOM_DELETE_GROUPS).',
      p_solution               => 'Delete Group Header data for the entered organization/item parameters (BOM_DELETE_GROUPS).',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: BOM_DELETE_GROUPS');



debug('begin add_signature: BOM_OPER_NETWORK_INTERFACE_11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15462',
      p_sig_id                 => 'BOM_OPER_NETWORK_INTERFACE_11I',
      p_sig_sql                => 'select 
boni.ASSEMBLY_ITEM_ID
,boni.ALTERNATE_ROUTING_DESIGNATOR
,boni.ORGANIZATION_ID
,boni.ROUTING_SEQUENCE_ID
,boni.ORGANIZATION_CODE
,boni.ASSEMBLY_ITEM_NUMBER
,boni.ORIGINAL_SYSTEM_REFERENCE
,boni.NEW_FROM_OP_SEQ_NUMBER
,boni.NEW_TO_OP_SEQ_NUMBER
,boni.NEW_FROM_START_EFFECTIVE_DATE
,boni.NEW_TO_START_EFFECTIVE_DATE
,boni.TRANSACTION_ID
,boni.PROCESS_FLAG
,boni.TRANSACTION_TYPE
,boni.FROM_OP_SEQ_ID
,boni.TO_OP_SEQ_ID
,boni.TRANSITION_TYPE
,boni.PLANNING_PCT
,boni.OPERATION_TYPE
,boni.FROM_X_COORDINATE
,boni.TO_X_COORDINATE
,boni.FROM_Y_COORDINATE
,boni.TO_Y_COORDINATE
,boni.FROM_OP_SEQ_NUMBER
,boni.TO_OP_SEQ_NUMBER
,boni.FROM_START_EFFECTIVE_DATE
,boni.TO_START_EFFECTIVE_DATE
,boni.ATTRIBUTE_CATEGORY
,boni.ATTRIBUTE1
,boni.ATTRIBUTE2
,boni.ATTRIBUTE3
,boni.ATTRIBUTE4
...
,boni.ATTRIBUTE10
from  
 bom_op_networks_interface boni
where
(
(boni.organization_id is not null and boni.organization_id = ''##$$ORGID$$##'' )
or 
(boni.organization_code is not null and boni.organization_code = ''##$$ORGCODE$$##'' )
)
and 
(
(boni.assembly_item_id is not null and  boni.assembly_item_id = ''##$$ITEMID$$##'')
or
(boni.assembly_item_number is not null and boni.assembly_item_number = ''##$$ITEMNUMBER$$##'')
)
or (boni.routing_sequence_id is not null
    and exists (select 1 from bom_operational_routings bor
                where bor.routing_sequence_id = boni.routing_sequence_id
                  and bor.organization_id = ''##$$ORGID$$##''
                  and bor.assembly_item_id = ''##$$ITEMID$$##'')
    )',
      p_title                  => 'RTG Operation Networks Interface',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Routing Operation Network Interface data found for the entered organization/item parameters or interface id (BOM_OP_NETWORKS_INTERFACE).',
      p_solution               => '',
      p_success_msg            => 'Routing Operation Network Interface data for the entered organization/item parameters or interface id (BOM_OP_NETWORKS_INTERFACE).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_OPER_NETWORK_INTERFACE_11I');



debug('begin add_signature: BOM_ROUTING_REVISIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14893',
      p_sig_id                 => 'BOM_ROUTING_REVISIONS',
      p_sig_sql                => 'select
mif.item_number assembly_item
,mrir.inventory_item_id
,mp.organization_code
,mrir.organization_id
,mrir.process_revision
,to_char(mrir.last_update_date,''DD-MON-YYYY HH24:MI:SS'') last_update_date
,mrir.last_updated_by
,to_char(mrir.creation_date,''DD-MON-YYYY HH24:MI:SS'') creation_date
,mrir.created_by
,mrir.last_update_login
,mrir.change_notice
,to_char(mrir.ecn_initiation_date,''DD-MON-YYYY HH24:MI:SS'') ecn_initiation_date
,to_char(mrir.implementation_date,''DD-MON-YYYY HH24:MI:SS'') implementation_date
,mrir.implemented_serial_number
,to_char(mrir.effectivity_date,''DD-MON-YYYY HH24:MI:SS'') effectivity_date
,mrir.program_application_id
,mrir.program_id
,to_char(mrir.program_update_date,''DD-MON-YYYY HH24:MI:SS'') program_update_date
,mrir.revised_item_sequence_id
from
...
and mif.organization_id = mp.organization_id
and mrir.organization_id = ''##$$ORGID$$##''
and mrir.inventory_item_id = ''##$$ITEMID$$##''',
      p_title                  => 'Routing Revisions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Routing Item Revisions found for the entered organization/item parameters (MTL_RTG_ITEM_REVISIONS).',
      p_solution               => '',
      p_success_msg            => 'Routing Item Revision data for the entered organization/item parameters (MTL_RTG_ITEM_REVISIONS).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_ROUTING_REVISIONS');



debug('begin add_signature: BOM_DELETE_GROUP_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14829',
      p_sig_id                 => 'BOM_DELETE_GROUP_ERRORS',
      p_sig_sql                => 'SELECT 
     e.delete_entity_sequence_id
    ,m.message_text
    ,e.error_sequence_number
    ,e.component_sequence_id
    ,e.operation_sequence_id
    ,e.message_name
    ,e.sql_statement_name
  FROM bom_delete_errors_v e , fnd_new_messages m
 WHERE 1=1
   AND  e.delete_entity_sequence_id=''##$$FK1$$##''
   AND (''##$$FK2$$##'' = -1 OR e.component_sequence_id = ''##$$FK2$$##'')
   AND (''##$$FK3$$##'' = -1 OR e.operation_sequence_id = ''##$$FK3$$##'')
   AND m.language_code = ''US''
   AND m.application_id = 702
   AND e.message_name = m.message_name
 ORDER BY e.error_sequence_number',
      p_title                  => 'BOM Delete Group errors',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Output of BOM_DELETE_ERRORS for the entered Org/Item.',
      p_solution               => 'Refer to the following note for a list of delete constraints and queries to help troubleshoot:
<ul><li>[2680357/KB208513] - BOM Delete Contraints</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: BOM_DELETE_GROUP_ERRORS');



debug('begin add_signature: BOM_DELETE_ENTITIES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14827',
      p_sig_id                 => 'BOM_DELETE_ENTITIES',
      p_sig_sql                => 'SELECT
     bdg.delete_group_name
    ,bdg.delete_group_sequence_id
    ,bde.item_concat_segments item
    ,bde.inventory_item_id
    ,bde.organization_id||'' (''||bde.organization_code||'')'' ORGANIZATION
    ,bde.delete_entity_type||'' (''||delete_entity||'')'' delete_entity
    ,bde.alternate_designator
    ,nvl2(bde.delete_status,bde.delete_status_type||'' (''||bde.delete_status||'')'',NULL) delete_status
    ,bde.delete_date
    ,bde.delete_entity_sequence_id
    ,bde.delete_entity_sequence_id "##$$FK1$$##"
    ,bde.bill_sequence_id
    ,bde.routing_sequence_id
    ,bde.prior_process_flag
    ,bde.prior_commit_flag
    ,-1 "##$$FK2$$##"
    ,-1 "##$$FK3$$##"
FROM bom_delete_groups bdg, bom_delete_entities_v bde 
WHERE 1=1
  AND (bdg.organization_id = ''##$$ORGID$$##'' OR bdg.organization_id = (SELECT master_organization_id FROM mtl_parameters WHERE organization_id = ''##$$ORGID$$##''))
  AND bde.delete_entity_type NOT IN (1,7)
  AND bdg.delete_group_sequence_id = bde.delete_group_sequence_id
  AND 
  (
      bde.inventory_item_id = ''##$$ITEMID$$##''
      OR 
      EXISTS 
          (SELECT 1 FROM bom_delete_sub_entities bdse 
           WHERE bde.delete_entity_sequence_id = bdse.delete_entity_sequence_id
           AND bdse.component_item_id = ''##$$ITEMID$$##'' AND ROWNUM=1) 
  )
ORDER BY bdg.delete_group_name, bde.item_concat_segments',
      p_title                  => 'Delete Group Entities',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Delete Group Entities found for the entered organization/item parameters (BOM_DELETE_ENTITIES).',
      p_solution               => '',
      p_success_msg            => 'Delete Group Entities data for the entered organization/item parameters (BOM_DELETE_ENTITIES).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('BOM_DELETE_GROUP_ERRORS'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '18'
      );
   l_info.delete;
debug('end add_signature: BOM_DELETE_ENTITIES');



debug('begin add_signature: BOM_DELETE_SUB_ENTITIES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14828',
      p_sig_id                 => 'BOM_DELETE_SUB_ENTITIES',
      p_sig_sql                => 'SELECT  
     bdg.delete_group_name
   , bdg.delete_group_sequence_id
   , bdse.delete_entity_sequence_id "##$$FK1$$##"
   , bdse.component_concat_segments component_item
   , bdse.operation_seq_num
   , bdse.item_num
   , nvl2(bdse.delete_status_type,bdse.delete_status_type||'' (''||bdse.delete_status||'')'',NULL) delete_status
   , to_char(bdse.delete_date,''DD-MON-YYYY HH24:MI:SS'') delete_date
   , bdse.component_item_id
   , bdse.component_sequence_id 
   , nvl(bdse.component_sequence_id,-1) "##$$FK2$$##"
   , bdse.operation_sequence_id
   , nvl(bdse.operation_sequence_id,-1) "##$$FK3$$##"
   , bdse.operation_department_code
   , bdse.from_end_item_unit_number
   , bdse.to_end_item_unit_number 
   , to_char(bdse.effectivity_date,''DD-MON-YYYY HH24:MI:SS'') effectivity_date
   , to_char(bdse.disable_date,''DD-MON-YYYY HH24:MI:SS'') disable_date
   , to_char(bdse.last_update_date,''DD-MON-YYYY HH24:MI:SS'') last_update_date
FROM bom_delete_groups bdg, bom_delete_entities bde, bom_delete_sub_entities_v bdse
WHERE 1=1
      AND (bdg.organization_id = ''##$$ORGID$$##'' OR bdg.organization_id = (SELECT master_organization_id FROM mtl_parameters WHERE organization_id = ''##$$ORGID$$##''))
      AND bdse.component_item_id = ''##$$ITEMID$$##''
      AND bdse.delete_entity_sequence_id = bde.delete_entity_sequence_id
      AND bde.delete_group_sequence_id = bdg.delete_group_sequence_id
ORDER BY bdg.delete_group_name, bdse.delete_entity_sequence_id',
      p_title                  => 'Delete Group Sub Entities',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Delete Group Sub-Entities found for the entered organization/item parameters (BOM_DELETE_SUB_ENTITIES).',
      p_solution               => '',
      p_success_msg            => 'Delete Group Sub-Entity data for the entered organization/item parameters (BOM_DELETE_SUB_ENTITIES).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_DELETE_SUB_ENTITIES');



debug('begin add_signature: BOM_KEY_PROFILES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14886',
      p_sig_id                 => 'BOM_KEY_PROFILES',
      p_sig_sql                => 'SELECT user_profile_option_name "Profile Option",
           a.profile_option_value "Profile Value",
           DECODE(a.level_id, 10001, ''Site'',
                              10002, ''Application'',
    ...
    WHERE a.profile_option_id  = e.profile_option_id
      ...
      AND e.profile_option_name IN 
                            ...
                            ''INV_BATCH_SIZE'',
                            ''MRP_DEBUG'',                
                            ''BOM_WEEK_PERIOD_START_DAY'',
                            ''BOM:CONFIG_ITEM_TYPE'',
                            ''BOM:CUSTOM_MATCH'',
                            ''BOM:MANDATORY_ATO_IN_PTO'',
                            ''BOM:MATCH_CONFIG'',
                            ''BOM_WEEK_PERIOD_START_DAY'',  /* note 2553007.1 */
                            ''REPORT_QUANTITY_PRECISION'',  /* note 1285982.1 */
                            ''FND_DIAGNOSTICS''
                            )
	  AND ((a.level_id = 10003 AND a.level_value = null)
      OR   (a.level_id = 10004 AND d.user_name = ''null'')
      ...
      ORDER BY e.profile_option_name,
            a.level_id DESC',
      p_title                  => 'BOM Key Profiles',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No key Bills of Material profile options are defined.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: BOM_KEY_PROFILES');



debug('begin add_signature: BOM_COMMON_BILL_LISTING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14536',
      p_sig_id                 => 'BOM_COMMON_BILL_LISTING',
      p_sig_sql                => 'select 
        decode(bs.bill_sequence_id,bs.common_bill_sequence_id,(decode(bs.bill_sequence_id,bs.source_bill_sequence_id,''-'',''Editable Common'')),''Common'') common_bill_type
       ,mp1.organization_code org
       ,mif1.item_number assembly_item
       ,bs.alternate_bom_designator
       ,mp2.organization_code commoned_org
    ...
    from
        (
           select bs.bill_sequence_id
                 ...
                 ,bs.source_bill_sequence_id
             from bom_structures_b bs
            where  (bs.organization_id=''##$$FK2$$##'' and bs.assembly_item_id=''##$$FK3$$##'' and bs.source_bill_sequence_id=''##$$FK4$$##'')     
         ) X ,
         bom_structures_b bs
        ,mtl_parameters mp1
        ,mtl_parameters mp2
        ...
        ,mtl_item_flexfields mif2
    where    
    (bs.bill_sequence_id = X.source_bill_sequence_id or bs.source_bill_sequence_id = X.source_bill_sequence_id)
    and bs.organization_id = mp1.organization_id
    and bs.organization_id = mif1.organization_id
    and bs.assembly_item_id = mif1.inventory_item_id
    and bs.common_organization_id = mp2.organization_id(+)
    and bs.common_organization_id = mif2.organization_id(+)
    and bs.common_assembly_item_id = mif2.inventory_item_id(+)
    and decode(bs.bill_sequence_id,bs.common_bill_sequence_id,(decode(bs.bill_sequence_id,bs.source_bill_sequence_id,''-'',''Editable Common'')),''Common'') <> ''-''
    and (''##$$FK1$$##'' is null or bs.alternate_bom_designator = ''##$$FK1$$##'')
order by 
    bs.source_bill_sequence_id
   ,decode(bs.bill_sequence_id,bs.common_bill_sequence_id,(decode(bs.bill_sequence_id,bs.source_bill_sequence_id,''-'',''Editable Common'')),''Common'')
   ,mp1.organization_code
   ,bs.alternate_bom_designator',
      p_title                  => 'Common Bills',
      p_fail_condition         => 'NRS',
   ...
   l_info.delete;
debug('end add_signature: BOM_COMMON_BILL_LISTING');



debug('begin add_signature: BOM_COMMONED_BILL_LISTING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14535',
      p_sig_id                 => 'BOM_COMMONED_BILL_LISTING',
      p_sig_sql                => 'select 
        decode(bs.bill_sequence_id,bs.common_bill_sequence_id,(decode(bs.bill_sequence_id,bs.source_bill_sequence_id,''-'',''Editable Common'')),''Common'') common_bill_type
       ,mp1.organization_code org
       ,mif1.item_number assembly_item
       ...
       ,bs.common_bill_sequence_id
       ,bs.source_bill_sequence_id
       ,bs.source_bill_sequence_id "##$$FK4$$##"
       ,mif1.pick_components_flag pto
       ,mif2.pick_components_flag pto_common
       ,mif1.replenish_to_order_flag ato
       ,mif2.replenish_to_order_flag ato_common
        ...
        (
           select bs.bill_sequence_id
            ...
            where  
                 ...
                 select * from bom_structures_b common
                 where (
                       bs.bill_sequence_id = common.source_bill_sequence_id
                       or
                       bs.source_bill_sequence_id = common.bill_sequence_id
                         )
                       and common.bill_sequence_id <> common.source_bill_sequence_id
                 )
...
order by 
   ...
   ,bs.alternate_bom_designator',
      ...
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('BOM_COMMON_BILL_LISTING'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '17'
      );
   l_info.delete;
debug('end add_signature: BOM_COMMONED_BILL_LISTING');



debug('begin add_signature: BOM_BILLS_HEADER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14425',
      p_sig_id                 => 'BOM_BILLS_HEADER',
      p_sig_sql                => 'select mif1.item_number  item_number   
,bsb.assembly_item_id              
,mp1.organization_code         		
,bsb.organization_id             
...
order by nvl2(alternate_bom_designator,2,1), alternate_bom_designator',
   ...
   l_info.delete;
debug('end add_signature: BOM_BILLS_HEADER');



debug('begin add_signature: BOM_BILL_COMPONENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14581',
      p_sig_id                 => 'BOM_BILL_COMPONENTS',
      p_sig_sql                => 'select mif1.item_number assembly_item_number
,bsb.assembly_item_id   
,mp1.organization_code  
,bsb.organization_id    
...
,bcb.to_end_item_strc_rev_id       
,bcb.basis_type            
,bcb.common_component_sequence_id   
from bom_structures_b bsb          
,bom_components_b bcb          
,mtl_parameters mp1               
,mtl_item_flexfields mif1         
...
order by nvl2(bsb.alternate_bom_designator,2,1)
   ...
   l_info.delete;
debug('end add_signature: BOM_BILL_COMPONENTS');



debug('begin add_signature: BOM_SUBS_COMPONENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14848',
      p_sig_id                 => 'BOM_SUBS_COMPONENTS',
      p_sig_sql                => 'select           
mif1.item_number assembly_item
,bsb.assembly_item_id   
,mp1.organization_code  
...
,bsco.original_system_reference    
,bsco.enforce_int_requirements     
,bsco.common_component_sequence_id 
from              
bom_components_b bcb         
,bom_structures_b bsb        
,bom_substitute_components bsco        
...
and bsb.assembly_item_id =  ''##$$ITEMID$$##''',
   ...
   l_info.delete;
debug('end add_signature: BOM_SUBS_COMPONENTS');



debug('begin add_signature: BOM_COMPONENT_OPERATIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15094',
      p_sig_id                 => 'BOM_COMPONENT_OPERATIONS',
      p_sig_sql                => 'SELECT
     bs.bill_sequence_id
    ,bs.assembly_item_id
    ,bs.alternate_bom_designator
	...
	,BCO.attribute14
	,BCO.attribute15
	,BCO.common_component_sequence_id
	,BCO.request_id
	,BCO.program_application_id
	,BCO.program_id
	,to_char(BCO.program_update_date,''DD-MON-YYYY HH24:MI:SS'') program_update_date
...
order by 
   ...
   l_info.delete;
debug('end add_signature: BOM_COMPONENT_OPERATIONS');



debug('begin add_signature: BOM_REF_DESIGNATORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14953',
      p_sig_id                 => 'BOM_REF_DESIGNATORS',
      p_sig_sql                => 'select mif1.item_number assembly_item
,bsb.assembly_item_id
,mp1.organization_code
,bsb.organization_id
...
,to_char(brd.program_update_date,''DD-MON-YYYY HH24:MI:SS'') program_update_date
,brd.original_system_reference
,brd.common_component_sequence_id
from
bom_components_b bcb
,bom_structures_b bsb
,bom_reference_designators brd
...
and bsb.assembly_item_id =  ##$$ITEMID$$##',
   ...
   l_info.delete;
debug('end add_signature: BOM_REF_DESIGNATORS');



debug('begin add_signature: BOM_BILL_EXPLOSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14623',
      p_sig_id                 => 'BOM_BILL_EXPLOSIONS',
      p_sig_sql                => 'SELECT
	top_bill_sequence_id
	,bill_sequence_id
	,organization_id
...
ORDER BY organization_id, top_item_id, explosion_type, sort_order',
   ...
   l_info.delete;
debug('end add_signature: BOM_BILL_EXPLOSIONS');



debug('begin add_signature: BOM_ROUTING_OPERATIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14850',
      p_sig_id                 => 'BOM_ROUTING_OPERATIONS',
      p_sig_sql                => 'select 
mif.item_number item_number   
,bor.assembly_item_id    
,mp.organization_code    
...
and bor.assembly_item_id =  ''##$$ITEMID$$##''',
   ...
   l_info.delete;
debug('end add_signature: BOM_ROUTING_OPERATIONS');



debug('begin add_signature: BOM_MTL_INTERFACE_ERRORS_11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15450',
      p_sig_id                 => 'BOM_MTL_INTERFACE_ERRORS_11I',
      p_sig_sql                => 'SELECT
 organization_id
,mie.transaction_id
,mie.unique_id
,to_char(mie.creation_date,''DD-MON-YYYY HH24:MI:SS'') creation_date
,mie.table_name
,mie.message_name
,mie.column_name
,mie.request_id
,mie.program_application_id||'' (''||nvl(fa.application_short_name,''Unknown'')||'')'' program_application_id
,mie.program_id||'' (''||nvl(fcp.concurrent_program_name,''Unknown'')||'')'' program_id
,mie.error_message
,mie.entity_identifier
,mie.bo_identifier
FROM MTL_INTERFACE_ERRORS mie, fnd_concurrent_programs fcp, fnd_application fa
WHERE 1=1
  and mie.organization_id = ''##$$ORGID$$##''
  and mie.program_application_id = fcp.application_id(+)
  and mie.program_id = fcp.concurrent_program_id(+)
  and mie.program_application_id = fa.application_id(+)
order by transaction_id desc, mie.unique_id',
      p_title                  => 'Interface errors',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No interface errors found for the entered Organization/Item parameters or interface id (MTL_INTERFACE_ERRORS).',
      p_solution               => '',
      p_success_msg            => 'Interface Error data for the entered organization/item parameters or interface id (MTL_INTERFACE_ERRORS).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_MTL_INTERFACE_ERRORS_11I');



debug('begin add_signature: BOM_ITEM_INTERFACE_11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15452',
      p_sig_id                 => 'BOM_ITEM_INTERFACE_11I',
      p_sig_sql                => 'SELECT *
FROM mtl_system_items_interface
WHERE 
    (
         ''##$$SETPROCESSID$$##'' is not null
      and nvl(set_process_id,-999) = ''##$$SETPROCESSID$$##''
    )
    OR
    (
         ''##$$SETPROCESSID$$##'' is null
      and (nvl(organization_id,-999) = ''##$$ORGID$$##'' or nvl(organization_code,''~~XXX~~'') = ''##$$ORGCODE$$##'')
      and (nvl(inventory_item_id,''-999'') = ''##$$ITEMID$$##'' or nvl(item_number,''~~XXX~~'') = ''##$$ITEMNUMBER$$##'')
    )',
      p_title                  => 'INV Items Interface',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No System Items Interface data found for the entered organization/item parameters or interface id (MTL_SYSTEM_ITEMS_INTERFACE).',
      p_solution               => '',
      p_success_msg            => 'System Items Interface data for the entered organization/item parameters or interface id (MTL_SYSTEM_ITEMS_INTERFACE).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_ITEM_INTERFACE_11I');



debug('begin add_signature: BOM_ITEM_REV_INTERFACE_11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15439',
      p_sig_id                 => 'BOM_ITEM_REV_INTERFACE_11I',
      p_sig_sql                => 'SELECT
	inventory_item_id
	,organization_id
	,revision
	...
	,last_update_login
	,change_notice
	,to_char(ecn_initiation_date,''DD-MON-YYYY HH24:MI:SS'') ecn_initiation_date
	,to_char(implementation_date,''DD-MON-YYYY HH24:MI:SS'') implementation_date
	...
	,program_id
	,to_char(program_update_date,''DD-MON-YYYY HH24:MI:SS'') program_update_date
...
WHERE 
    ...
    (
      ...
      p_title                  => 'INV Item Revision Interface',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Item Revision Inteface data found for the entered organization/item parameters or interface id (MTL_ITEM_REVISIONS_INTERFACE).',
      p_solution               => '',
      p_success_msg            => 'Item Revision Inteface data for the entered organization/item parameters or interface id (MTL_ITEM_REVISIONS_INTERFACE).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_ITEM_REV_INTERFACE_11I');



debug('begin add_signature: BOM_BILLS_INTERFACE_11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15453',
      p_sig_id                 => 'BOM_BILLS_INTERFACE_11I',
      p_sig_sql                => 'SELECT
	assembly_item_id
	,organization_id
	...
	,item_number
	,common_item_number
	,to_char(next_explode_date,''DD-MON-YYYY HH24:MI:SS'') next_explode_date
	,revision
	,transaction_type
	,delete_group_name
	,dg_description
...
WHERE  
    (
          (nvl(organization_id,-999) = ''##$$ORGID$$##'' or nvl(organization_code,''~~XXX~~'') = ''##$$ORGCODE$$##'')
      and (nvl(assembly_item_id,''-999'') = ''##$$ITEMID$$##'' or nvl(item_number,''~~XXX~~'') = ''##$$ITEMNUMBER$$##'')
    )',
      p_title                  => 'BOM Header Interface',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No BOM Header Interface data found for the entered organization/item parameters or interface id (BOM_BILL_OF_MTLS_INTERFACE).',
      p_solution               => '',
      p_success_msg            => 'Item Revision Interface data for the entered organization/item parameters or interface id (BOM_BILL_OF_MTLS_INTERFACE).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_BILLS_INTERFACE_11I');



debug('begin add_signature: BOM_COMPS_INTERFACE_11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15454',
      p_sig_id                 => 'BOM_COMPS_INTERFACE_11I',
      p_sig_sql                => 'SELECT
	operation_seq_num
	,component_item_id
	,to_char(last_update_date,''DD-MON-YYYY HH24:MI:SS'') last_update_date
	...
	,to_char(new_effectivity_date,''DD-MON-YYYY HH24:MI:SS'') new_effectivity_date
	,to_char(old_effectivity_date,''DD-MON-YYYY HH24:MI:SS'') old_effectivity_date
	,assembly_type
	...
	,parent_revision_id
FROM bom_inventory_comps_interface i
WHERE 
   ( i.bill_sequence_id is null 
      and 
     (  
        (i.organization_id = ''##$$ORGID$$##'' or i.organization_code = ''##$$ORGCODE$$##'') 
        and 
        (i.assembly_item_id = ''##$$ITEMID$$##'' or i.assembly_item_number = ''##$$ITEMNUMBER$$##'')
     )
   )
   or 
   (
     i.bill_sequence_id is not null 
     and exists (select 1 from bom_structures_b bs 
                 where bs.assembly_item_id = ''##$$ITEMID$$##''
                   and bs.organization_id = ''##$$ORGID$$##''
                   and bs.bill_sequence_id = i.bill_sequence_id
                   and rownum=1
                 )
    )
    or
    (
      i.component_sequence_id is not null
      and exists (select 1 from bom_components_b bc, bom_structures_b bs
                   where bs.assembly_item_id = ''##$$ITEMID$$##'' 
                   and bs.organization_id = ''##$$ORGID$$##''
                   and bs.bill_sequence_id = bc.bill_sequence_id
                   and bc.component_sequence_id = i.component_sequence_id
                   and rownum=1
                  )
    )',
      p_title                  => 'BOM Components Interface',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No BOM Component Interface data found for the entered organization/item parameters or interface id (BOM_INVENTORY_COMPS_INTERFACE).',
      p_solution               => '',
      p_success_msg            => 'BOM Component Interface data for the entered organization/item parameters or interface id (BOM_INVENTORY_COMPS_INTERFACE).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_COMPS_INTERFACE_11I');



debug('begin add_signature: BOM_SUB_COMPS_INTERFACE_11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15455',
      p_sig_id                 => 'BOM_SUB_COMPS_INTERFACE_11I',
      p_sig_sql                => 'SELECT
	...
	,new_revised_item_revision
	,return_status
FROM bom_sub_comps_interface i
WHERE  
   (i.component_sequence_id is not null
    and exists (select 1 from bom_components_b bc, bom_structures_b bs
                   where bs.assembly_item_id = ''##$$ITEMID$$##'' 
      ...
      p_title                  => 'BOM Subcomponents Interface',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No BOM Subtitute Component Interface data found for the entered organization/item parameters or interface id (BOM_SUB_COMPS_INTERFACE).',
      p_solution               => '',
      p_success_msg            => 'BOM Subtitute Component Interface data for the entered organization/item parameters or interface id (BOM_SUB_COMPS_INTERFACE).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_SUB_COMPS_INTERFACE_11I');



debug('begin add_signature: BOM_REF_DESIGNATORS_INTERFACE_11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15457',
      p_sig_id                 => 'BOM_REF_DESIGNATORS_INTERFACE_11I',
      p_sig_sql                => 'SELECT
	substitute_component_id
	,to_char(last_update_date,''DD-MON-YYYY HH24:MI:SS'') last_update_date
	,last_updated_by
...
WHERE  
   ...
   l_info.delete;
debug('end add_signature: BOM_REF_DESIGNATORS_INTERFACE_11I');



debug('begin add_signature: BOM_DELETE_GROUP_INTERFACE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14632',
      p_sig_id                 => 'BOM_DELETE_GROUP_INTERFACE',
      p_sig_sql                => 'SELECT
	entity_name
	,delete_group_name
FROM bom_interface_delete_groups
WHERE delete_group_name IN (
      SELECT delete_group_name FROM bom_bill_of_mtls_interface
UNION SELECT delete_group_name FROM bom_inventory_comps_interface
UNION SELECT delete_group_name FROM bom_op_routings_interface
UNION SELECT delete_group_name FROM bom_op_sequences_interface
UNION SELECT delete_group_name FROM mtl_system_items_interface)',
      p_title                  => 'BOM Delete Group Interface',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No BOM Delete Group Interface data found for the entered organization/item parameters or interface id (BOM_INTERFACE_DELETE_GROUPS).',
      p_solution               => '',
      p_success_msg            => 'BOM Delete Group Interface data for the entered organization/item parameters or interface id (BOM_INTERFACE_DELETE_GROUPS).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_DELETE_GROUP_INTERFACE');



debug('begin add_signature: BOM_OPER_ROUTING_INTERFACE_11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15458',
      p_sig_id                 => 'BOM_OPER_ROUTING_INTERFACE_11I',
      p_sig_sql                => 'SELECT
	routing_sequence_id
	,I.assembly_item_id
	,I.organization_id
	,I.alternate_routing_designator
	,to_char(I.last_update_date,''DD-MON-YYYY HH24:MI:SS'') last_update_date
	,I.last_updated_by
	,to_char(I.creation_date,''DD-MON-YYYY HH24:MI:SS'') creation_date
	,I.created_by
	,I.last_update_login
	,decode(i.routing_type,NULL,NULL,1,''Manufacturing (1)'',2,''Engineering Bill(2)'') routing_type
	,I.common_assembly_item_id
	,I.common_routing_sequence_id
	,I.routing_comment
	...
	,I.program_id
	,to_char(I.program_update_date,''DD-MON-YYYY HH24:MI:SS'') program_update_date
	,I.demand_source_line
	,I.set_id
	,I.process_revision
	,I.demand_source_type
	,I.demand_source_header_id
	,I.organization_code
	,I.assembly_item_number
	,I.common_item_number
	,I.location_name
	,I.transaction_id
	,decode(I.process_flag,NULL,NULL,1, ''Pending (1)'',  2, ''Assigned Succeeded (2)'', 3, ''Assign/Validation Failed(3)'', 4 , ''Validation Succeeded(Import Failed)(4)'',7 ,''Import Succeeded(7)'')  process_flag
	,I.transaction_type
	,I.line_id
	,I.line_code
	...
	,I.PRIORITY
	,I.cfm_routing_flag
	,I.total_product_cycle_time
	,I.ctp_flag
	,I.original_system_reference
...
WHERE 
    (
        (
            (I.organization_id IS NOT NULL AND I.organization_id = ''##$$ORGID$$##'')
            OR 
            (I.organization_code IS NOT NULL AND I.organization_code = ''##$$ORGCODE$$##'')
        )
        AND 
        (
            (I.assembly_item_id IS NOT NULL AND  I.assembly_item_id = ''##$$ITEMID$$##'')
            OR
            (I.assembly_item_number IS NOT NULL AND I.assembly_item_number = ''##$$ITEMNUMBER$$##'')
        )
    )
    OR 
    (
        I.routing_sequence_id IS NOT NULL
        AND EXISTS (SELECT 1 FROM bom_operational_routings bor
                    WHERE bor.routing_sequence_id = I.routing_sequence_id
                      AND bor.organization_id = ''##$$ORGID$$##''
                      AND bor.assembly_item_id = ''##$$ITEMID$$##'')
     )',
      p_title                  => 'RTG Header Interface',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Routing Header Interface data found for the entered organization/item parameters or interface id (BOM_OPER_ROUTING_INTERFACE).
',
      p_solution               => '',
      p_success_msg            => 'Routing Header Interface data for the entered organization/item parameters or interface id (BOM_OPER_ROUTING_INTERFACE).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_OPER_ROUTING_INTERFACE_11I');



debug('begin add_signature: BOM_COMP_OPER_INTERFACE_11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15465',
      p_sig_id                 => 'BOM_COMP_OPER_INTERFACE_11I',
      p_sig_sql                => 'SELECT
	comp_operation_seq_id
	,operation_seq_num
	,additional_operation_seq_num
	,new_additional_op_seq_num
	...
	,transaction_type
	,return_status
FROM bom_component_ops_interface i
WHERE  
   ( i.bill_sequence_id is null 
      and 
     (  
   ...
   (
    ...
    (
      ...
      p_title                  => 'RTG Component Operations Interface',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Routing Operation Interface data found for the entered organization/item parameters or interface id (BOM_COMPONENT_OPS_INTERFACE).',
      p_solution               => '',
      p_success_msg            => 'Routing Operation Interface data for the entered organization/item parameters or interface id (BOM_COMPONENT_OPS_INTERFACE).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_COMP_OPER_INTERFACE_11I');



debug('begin add_signature: BOM_OP_SEQUENCES_INTERFACE_11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15459',
      p_sig_id                 => 'BOM_OP_SEQUENCES_INTERFACE_11I',
      p_sig_sql                => 'SELECT
	 operation_sequence_id
	,bosi.routing_sequence_id
	,bosi.operation_seq_num
	,to_char(bosi.last_update_date,''DD-MON-YYYY HH24:MI:SS'') last_update_date
	,bosi.last_updated_by
	,to_char(bosi.creation_date,''DD-MON-YYYY HH24:MI:SS'') creation_date
	,bosi.created_by
	,bosi.last_update_login
	,bosi.standard_operation_id
	,bosi.department_id
	,bosi.operation_lead_time_percent
	,bosi.run_time_overlap_percent
	,bosi.minimum_transfer_quantity
	,bosi.count_point_type
	,bosi.operation_description
	,to_char(bosi.effectivity_date,''DD-MON-YYYY HH24:MI:SS'') effectivity_date
	,bosi.change_notice
	,to_char(bosi.implementation_date,''DD-MON-YYYY HH24:MI:SS'') implementation_date
	,to_char(bosi.disable_date,''DD-MON-YYYY HH24:MI:SS'') disable_date
	,bosi.backflush_flag
	,bosi.option_dependent_flag
	,bosi.attribute_category
	,bosi.attribute1
	,bosi.attribute2
	,bosi.attribute3
	,bosi.attribute4
	...
	,bosi.attribute15
	,bosi.request_id
	,bosi.program_application_id
	,bosi.program_id
	,to_char(bosi.program_update_date,''DD-MON-YYYY HH24:MI:SS'') program_update_date
	,bosi.model_op_seq_id
	,bosi.assembly_item_id
	,bosi.organization_id
	,bosi.alternate_routing_designator
	,bosi.organization_code
	,bosi.assembly_item_number
	,bosi.department_code
	,bosi.operation_code
	,bosi.resource_id1
	,bosi.resource_id2
	,bosi.resource_id3
	...
	,bosi.resource_code2
	,bosi.resource_code3
	,bosi.instruction_code1
	,bosi.instruction_code2
	,bosi.instruction_code3
	,bosi.transaction_id
	,bosi.process_flag
	,bosi.transaction_type
	,bosi.new_operation_seq_num
	,to_char(bosi.new_effectivity_date,''DD-MON-YYYY HH24:MI:SS'') new_effectivity_date
	,bosi.assembly_type
	,bosi.operation_type
	,bosi.reference_flag
	,bosi.process_op_seq_id
	,bosi.line_op_seq_id
	,bosi.yield
	,bosi.cumulative_yield
	,bosi.reverse_cumulative_yield
	,bosi.labor_time_calc
	,bosi.machine_time_calc
	,bosi.total_time_calc
	,bosi.labor_time_user
	,bosi.machine_time_user
	,bosi.total_time_user
	,bosi.net_planning_percent
	,bosi.include_in_rollup
	,bosi.operation_yield_enabled
	,bosi.process_seq_number
	,bosi.process_code
	,bosi.line_op_seq_number
	,bosi.line_op_code
	,bosi.original_system_reference
	,bosi.shutdown_type
	,bosi.long_description
	,bosi.delete_group_name
	,bosi.dg_description
	,bosi.new_routing_revision
	,bosi.acd_type
	,to_char(bosi.old_start_effective_date,''DD-MON-YYYY HH24:MI:SS'') old_start_effective_date
	,bosi.cancel_comments
	,bosi.eng_changes_ifce_key
	,bosi.eng_revised_items_ifce_key
	,bosi.bom_rev_op_ifce_key
	,bosi.new_revised_item_revision
FROM BOM_OP_SEQUENCES_INTERFACE bosi
WHERE 
(
(bosi.organization_id is not null and bosi.organization_id = ''##$$ORGID$$##'' )
or 
(bosi.organization_code is not null and bosi.organization_code = ''##$$ORGCODE$$##'' )
)
and 
(
(bosi.assembly_item_id is not null and  bosi.assembly_item_id = ''##$$ITEMID$$##'')
or
(bosi.assembly_item_number is not null and bosi.assembly_item_number = ''##$$ITEMNUMBER$$##'')
)
or (bosi.routing_sequence_id is not null
    and exists (select 1 from bom_operational_routings bor
                where bor.routing_sequence_id = bosi.routing_sequence_id
                  and bor.organization_id = ''##$$ORGID$$##''
                  and bor.assembly_item_id = ''##$$ITEMID$$##'')
    )
or 
(bosi.operation_sequence_id is not null
    and exists (select 1 from bom_operation_sequences bos
                            , bom_operational_routings bor
                where bos.operation_sequence_id = bosi.operation_sequence_id
                  and bos.routing_sequence_id = bor.routing_sequence_id
                  and (bor.organization_id = ''##$$ORGID$$##'' 
                  and bor.assembly_item_id = ''##$$ITEMID$$##'')
               )
 )',
      p_title                  => 'RTG Operation Sequences Interface',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Routing Operation Sequence Interface data found for the entered organization/item parameters or interface id (BOM_OP_SEQUENCES_INTERFACE).',
      p_solution               => '',
      p_success_msg            => 'Routing Operation Sequence Interface data for the entered organization/item parameters or interface id (BOM_OP_SEQUENCES_INTERFACE).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_OP_SEQUENCES_INTERFACE_11I');



debug('begin add_signature: BOM_OPER_RESOURCE_INTERFACE_11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15460',
      p_sig_id                 => 'BOM_OPER_RESOURCE_INTERFACE_11I',
      p_sig_sql                => 'select 
borei.operation_seq_num
,borei.operation_sequence_id
,borei.routing_sequence_id
,borei.resource_seq_num
,borei.assembly_item_number
,borei.assembly_item_id
,borei.organization_code
,borei.organization_id
,decode(borei.process_flag,null,null,1, ''Pending (1)'',  2, ''Assigned Succeeded (2)'', 3, ''Assign/Validation Failed(3)'', 4 , ''Validation Succeeded(Import Failed)(4)'',7 ,''Import Succeeded(7)'')  process_flag_1      
,borei.new_resource_seq_num
,borei.operation_type
,borei.transaction_id
,borei.eco_name
,borei.acd_type
,borei.resource_code
,borei.resource_id
,borei.activity
,borei.activity_id
,borei.effectivity_date
,borei.alternate_routing_designator
,borei.standard_rate_flag
,borei.usage_rate_or_amount
,borei.usage_rate_or_amount_inverse
,borei.basis_type
,borei.schedule_flag
,borei.resource_offset_percent
,borei.new_revised_item_revision
from  
 bom_op_resources_interface borei
where
(
(borei.organization_id is not null and borei.organization_id = ''##$$ORGID$$##'' )
or 
(borei.organization_code is not null and borei.organization_code = ''##$$ORGCODE$$##'' )
)
and 
(
(borei.assembly_item_id is not null and  borei.assembly_item_id = ''##$$ITEMID$$##'')
or
(borei.assembly_item_number is not null and borei.assembly_item_number = ''##$$ITEMNUMBER$$##'')
)
or (borei.routing_sequence_id is not null
    and exists (select 1 from bom_operational_routings bor
                where bor.routing_sequence_id = borei.routing_sequence_id
                  and bor.organization_id = ''##$$ORGID$$##''
                  and bor.assembly_item_id = ''##$$ITEMID$$##'')
    )
or 
(borei.operation_sequence_id is not null --???
    and exists (select 1 from bom_operation_resources br
                            , bom_operation_sequences bos
                            , bom_operational_routings bor
                where br.operation_sequence_id = borei.operation_sequence_id
                  and borei.operation_sequence_id = bos.operation_sequence_id
                  and bos.routing_sequence_id = bor.routing_sequence_id
                  and bor.organization_id = ''##$$ORGID$$##'' 
                  and bor.assembly_item_id = ''##$$ITEMID$$##''
                  and rownum=1
      ...
      p_title                  => 'RTG Resources Interface',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Routing Operation Resource Interface data found for the entered organization/item parameters or interface id (BOM_OP_RESOURCES_INTERFACE).',
      p_solution               => '',
      p_success_msg            => 'Routing Operation Resource Interface data for the entered organization/item parameters or interface id (BOM_OP_RESOURCES_INTERFACE).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_OPER_RESOURCE_INTERFACE_11I');



debug('begin add_signature: BOM_SUB_OP_RESOURCE_INTERFACE_11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15461',
      p_sig_id                 => 'BOM_SUB_OP_RESOURCE_INTERFACE_11I',
      p_sig_sql                => 'select 
bsri.ASSEMBLY_ITEM_ID,
bsri.ALTERNATE_ROUTING_DESIGNATOR,
bsri.ORGANIZATION_ID,
bsri.OPERATION_SEQ_NUM,
bsri.EFFECTIVITY_DATE,
bsri.ROUTING_SEQUENCE_ID,
bsri.ORGANIZATION_CODE,
bsri.ASSEMBLY_ITEM_NUMBER,
bsri.SUB_RESOURCE_CODE,
bsri.ACTIVITY,
bsri.TRANSACTION_ID,
bsri.PROCESS_FLAG,
bsri.TRANSACTION_TYPE,
bsri.NEW_SUB_RESOURCE_CODE,
bsri.PRINCIPLE_FLAG,
bsri.ORIGINAL_SYSTEM_REFERENCE,
bsri.SETUP_CODE,
bsri.ECO_NAME,
bsri.NEW_REVISED_ITEM_REVISION,
bsri.NEW_ROUTING_REVISION,
bsri.NEW_REPLACEMENT_GROUP_NUM,
bsri.ENG_CHANGES_IFCE_KEY,
bsri.NEW_BASIS_TYPE,
bsri.OPERATION_SEQUENCE_ID,
bsri.SUBSTITUTE_GROUP_NUM,
bsri.SCHEDULE_SEQ_NUM,
bsri.REPLACEMENT_GROUP_NUM,
bsri.RESOURCE_ID,
bsri.ACTIVITY_ID,
bsri.OPERATION_TYPE,
bsri.STANDARD_RATE_FLAG,
bsri.ASSIGNED_UNITS,
bsri.USAGE_RATE_OR_AMOUNT,
bsri.USAGE_RATE_OR_AMOUNT_INVERSE,
bsri.BASIS_TYPE,
bsri.SCHEDULE_FLAG,
bsri.RESOURCE_OFFSET_PERCENT,
bsri.AUTOCHARGE_TYPE,
bsri.ATTRIBUTE_CATEGORY,
DECODE(bsri.acd_type,1,''1 (Add)'',2,''2(Change)'',3,''3(Disable)'',bsri.acd_type) ACTION
from  
 bom_sub_op_resources_interface bsri
where
(
(bsri.organization_id is not null and bsri.organization_id = ''##$$ORGID$$##'' )
or 
(bsri.organization_code is not null and bsri.organization_code = ''##$$ORGCODE$$##'' )
)
and 
(
(bsri.assembly_item_id is not null and  bsri.assembly_item_id = ''##$$ITEMID$$##'')
or
(bsri.assembly_item_number is not null and bsri.assembly_item_number = ''##$$ITEMNUMBER$$##'')
)
or (bsri.routing_sequence_id is not null
    and exists (select 1 from bom_operational_routings bor
                where bor.routing_sequence_id = bsri.routing_sequence_id
                  and bor.organization_id = ''##$$ORGID$$##''
                  and bor.assembly_item_id = ''##$$ITEMID$$##'')
    )
or 
(bsri.operation_sequence_id is not null --???
    and exists (select 1 from bom_operation_resources br
                            , bom_operation_sequences bos
                            , bom_operational_routings bor
                where br.operation_sequence_id = bsri.operation_sequence_id
                  and bsri.operation_sequence_id = bos.operation_sequence_id
                  and bos.routing_sequence_id = bor.routing_sequence_id
                  and bor.organization_id = ''##$$ORGID$$##'' 
                  and bor.assembly_item_id = ''##$$ITEMID$$##''
                  and rownum=1
      ...
      p_title                  => 'RTG Substitute Operation Resources Interface',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Routing Substitute Operation Resource Interface data found for the entered organization/item parameters or interface id (BOM_SUB_OP_RESOURCES_INTERFACE).',
      p_solution               => '',
      p_success_msg            => 'Routing Substitute Operation Resource Interface data for the entered organization/item parameters or interface id (BOM_SUB_OP_RESOURCES_INTERFACE).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_SUB_OP_RESOURCE_INTERFACE_11I');



debug('begin add_signature: BOM_ROUTING_ITM_REV_INTERFACE_11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15463',
      p_sig_id                 => 'BOM_ROUTING_ITM_REV_INTERFACE_11I',
      p_sig_sql                => 'select
mriri.inventory_item_number
,mriri.inventory_item_id
,mriri.organization_code
,mriri.organization_id
,mriri.process_revision
--,process_flag
,decode(mriri.process_flag,null,null,1, ''Pending (1)'',  2, ''Assigned Succeeded (2)'', 3, ''Assign/Validation Failed(3)'', 4 , ''Validation Succeeded(Import Failed)(4)'',7 ,''Import Succeeded(7)'')  process_flag_1      
,mriri.transaction_id
,mriri.transaction_type
,mriri.effectivity_date
,mriri.change_notice
,mriri.ecn_initiation_date
,mriri.implementation_date
from 
mtl_rtg_item_revs_interface mriri
where 
    (
         (nvl(mriri.organization_id,-999) = ''##$$ORGID$$##'' or nvl(mriri.organization_code,''~~XXX~~'') = ''##$$ORGCODE$$##'')
      and (nvl(mriri.inventory_item_id,''-999'') = ''##$$ITEMID$$##'' or nvl(mriri.inventory_item_number,''~~XXX~~'') = ''##$$ITEMNUMBER$$##'')
    )',
      p_title                  => 'RTG Revisions Interface',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Routing Item Revisions Interface data found for the entered organization/item parameters or interface id (MTL_RTG_ITEM_REVS_INTERFACE).',
      p_solution               => '',
      p_success_msg            => 'Routing Item Revisions Interface data for the entered organization/item parameters or interface id (MTL_RTG_ITEM_REVS_INTERFACE).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_ROUTING_ITM_REV_INTERFACE_11I');



debug('begin add_signature: BOM_MTL_INTERFACE_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15042',
      p_sig_id                 => 'BOM_MTL_INTERFACE_ERRORS',
      p_sig_sql                => 'SELECT
 organization_id
,mie.transaction_id
,mie.unique_id
...
order by transaction_id desc, mie.unique_id',
   ...
   l_info.delete;
debug('end add_signature: BOM_MTL_INTERFACE_ERRORS');



debug('begin add_signature: BOM_ITEM_INTERFACE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14625',
      p_sig_id                 => 'BOM_ITEM_INTERFACE',
      p_sig_sql                => 'SELECT *
FROM mtl_system_items_interface
WHERE 
    (
   ...
   l_info.delete;
debug('end add_signature: BOM_ITEM_INTERFACE');



debug('begin add_signature: BOM_ITEM_REV_INTERFACE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14627',
      p_sig_id                 => 'BOM_ITEM_REV_INTERFACE',
      p_sig_sql                => 'SELECT
	inventory_item_id
	,organization_id
	,revision
	...
	,template_id
	,template_name
	--,bundle_id  commented out for 12.1.3
FROM mtl_item_revisions_interface
WHERE 
    (
         ''##$$SETPROCESSID$$##'' is not null
   ...
   l_info.delete;
debug('end add_signature: BOM_ITEM_REV_INTERFACE');



debug('begin add_signature: BOM_BILLS_INTERFACE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14634',
      p_sig_id                 => 'BOM_BILLS_INTERFACE',
      p_sig_sql                => 'SELECT
	assembly_item_id
	,organization_id
	,alternate_bom_designator
...
WHERE  
   ...
   l_info.delete;
debug('end add_signature: BOM_BILLS_INTERFACE');



debug('begin add_signature: BOM_COMPS_INTERFACE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14628',
      p_sig_id                 => 'BOM_COMPS_INTERFACE',
      p_sig_sql                => 'SELECT
	operation_seq_num
	,component_item_id
	,to_char(last_update_date,''DD-MON-YYYY HH24:MI:SS'') last_update_date
...
FROM bom_inventory_comps_interface i
WHERE 
   (''##$$BATCHID$$##'' is not null and ''##$$BATCHID$$##''=i.batch_id)
   or
   ( i.bill_sequence_id is null 
      and 
     (  
   ...
   l_info.delete;
debug('end add_signature: BOM_COMPS_INTERFACE');



debug('begin add_signature: BOM_SUB_COMPS_INTERFACE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14629',
      p_sig_id                 => 'BOM_SUB_COMPS_INTERFACE',
      p_sig_sql                => 'SELECT
	substitute_component_id
	,to_char(last_update_date,''DD-MON-YYYY HH24:MI:SS'') last_update_date
	,last_updated_by
	...
	,comp_source_system_reference
	,parent_source_system_reference
	,subcom_source_system_reference
	,change_id
	,sub_comp_inverse_quantity
	,change_transaction_type
	,interface_table_unique_id
	,assembly_item_revision_code
	,assembly_item_revision_id
FROM bom_sub_comps_interface i
WHERE  
   (''##$$BATCHID$$##'' is not null and ''##$$BATCHID$$##''=i.batch_id)
   or
   ...
   l_info.delete;
debug('end add_signature: BOM_SUB_COMPS_INTERFACE');



debug('begin add_signature: BOM_CMP_USER_ATTR_INTERFACE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14624',
      p_sig_id                 => 'BOM_CMP_USER_ATTR_INTERFACE',
      p_sig_sql                => 'SELECT
	data_set_id
	,process_status
	,transaction_type
	...
	,attr_value_str
	,attr_value_num
	,to_char(attr_value_date,''DD-MON-YYYY HH24:MI:SS'') attr_value_date
	,attr_disp_value
	,request_id
	,program_application_id
	,program_id
...
WHERE 
    ...
    (
         ''##$$BATCHID$$##'' is null
      and (nvl(organization_id,-999) = ''##$$ORGID$$##'' or nvl(organization_code,''~~XXX~~'') = ''##$$ORGCODE$$##'')
      and (nvl(item_number,''~~XXX~~'') = ''##$$ITEMNUMBER$$##'' or nvl(assembly_item_number,''~~XXX~~'') = ''##$$ITEMNUMBER$$##'')
    )',
      p_title                  => 'BOM Component User Attribute Interface',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No BOM Component User Attribute Interface data found for the entered organization/item parameters or interface id (BOM_CMP_USER_ATTR_INTERFACE).',
      p_solution               => '',
      p_success_msg            => 'BOM Component User Attribute Interface data for the entered organization/item parameters or interface id (BOM_CMP_USER_ATTR_INTERFACE).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_CMP_USER_ATTR_INTERFACE');



debug('begin add_signature: BOM_REF_DESIGNATORS_INTERFACE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14630',
      p_sig_id                 => 'BOM_REF_DESIGNATORS_INTERFACE',
      p_sig_sql                => 'SELECT
	i.component_reference_designator
	,to_char(i.last_update_date,''DD-MON-YYYY HH24:MI:SS'') last_update_date
	,i.last_updated_by
	,to_char(creation_date,''DD-MON-YYYY HH24:MI:SS'') creation_date
	,i.created_by
	,i.last_update_login
	,i.ref_designator_comment
	,i.change_notice
	...
	,i.component_item_id
	,i.operation_seq_num
	,to_char(i.effectivity_date,''DD-MON-YYYY HH24:MI:SS'') effectivity_date
	,i.organization_code
	,i.assembly_item_number
	,i.component_item_number
	,i.transaction_id
	,i.process_flag
	,i.new_designator
	,i.interface_entity_type
	,i.transaction_type
	,i.bom_ref_desgs_ifce_key
	,i.bom_inventory_comps_ifce_key
	,i.eng_revised_items_ifce_key
	,i.eng_changes_ifce_key
	,i.from_end_item_unit_number
	,i.original_system_reference
	,i.new_revised_item_revision
	,i.return_status
	,i.batch_id
	,i.comp_source_system_reference
	,i.parent_source_system_reference
	,i.change_id
	,i.change_transaction_type
	,i.interface_table_unique_id
	,i.assembly_item_revision_code
	,i.assembly_item_revision_id
FROM bom_ref_desgs_interface i
WHERE  
    (
         ''##$$BATCHID$$##'' is not null
      AND nvl(i.batch_id,-999) = ''##$$BATCHID$$##''
    )
    OR
    (
          (nvl(i.organization_id,-999) = ''##$$ORGID$$##'' or nvl(i.organization_code,''~~XXX~~'') = ''##$$ORGCODE$$##'')
      AND 
          (nvl(i.assembly_item_id,''-999'') = ''##$$ITEMID$$##'' or nvl(i.assembly_item_number,''~~XXX~~'') = ''##$$ITEMNUMBER$$##'')
    )
    OR
    (
      i.component_sequence_id is not null
      ...
      p_title                  => 'BOM Reference Designators Interface',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No BOM Reference Designator Interface data found for the entered organization/item parameters or interface id (BOM_REF_DESGS_INTERFACE).',
      p_solution               => '',
      p_success_msg            => 'BOM Reference Designator Interface data for the entered organization/item parameters or interface id (BOM_REF_DESGS_INTERFACE).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_REF_DESIGNATORS_INTERFACE');



debug('begin add_signature: BOM_OPER_ROUTING_INTERFACE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14785',
      p_sig_id                 => 'BOM_OPER_ROUTING_INTERFACE',
      p_sig_sql                => 'SELECT
	routing_sequence_id
	,I.assembly_item_id
	,I.organization_id
...
',
   ...
   l_info.delete;
debug('end add_signature: BOM_OPER_ROUTING_INTERFACE');



debug('begin add_signature: BOM_COMP_OPER_INTERFACE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14633',
      p_sig_id                 => 'BOM_COMP_OPER_INTERFACE',
      p_sig_sql                => 'SELECT
	comp_operation_seq_id
	,operation_seq_num
	,additional_operation_seq_num
...
WHERE  
   ...
   l_info.delete;
debug('end add_signature: BOM_COMP_OPER_INTERFACE');



debug('begin add_signature: BOM_OP_SEQUENCES_INTERFACE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15040',
      p_sig_id                 => 'BOM_OP_SEQUENCES_INTERFACE',
      p_sig_sql                => 'SELECT
	 operation_sequence_id
	,bosi.routing_sequence_id
	,bosi.operation_seq_num
...
FROM BOM_OP_SEQUENCES_INTERFACE bosi
WHERE 
(''##$$BATCHID$$##'' is not null and ''##$$BATCHID$$##''=bosi.batch_id)
or 
(
(bosi.organization_id is not null and bosi.organization_id = ''##$$ORGID$$##'' )
or 
...
(bosi.operation_sequence_id is not null
   ...
   l_info.delete;
debug('end add_signature: BOM_OP_SEQUENCES_INTERFACE');



debug('begin add_signature: BOM_OPER_RESOURCE_INTERFACE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14786',
      p_sig_id                 => 'BOM_OPER_RESOURCE_INTERFACE',
      p_sig_sql                => 'select 
borei.operation_seq_num
,borei.operation_sequence_id
,borei.routing_sequence_id
...
from  
 bom_op_resources_interface borei
where
(''##$$BATCHID$$##'' is not null and ''##$$BATCHID$$##''=borei.batch_id)
or 
(
(borei.organization_id is not null and borei.organization_id = ''##$$ORGID$$##'' )
or 
...
(borei.operation_sequence_id is not null --???
   ...
   l_info.delete;
debug('end add_signature: BOM_OPER_RESOURCE_INTERFACE');



debug('begin add_signature: BOM_SUB_OP_RESOURCE_INTERFACE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14791',
      p_sig_id                 => 'BOM_SUB_OP_RESOURCE_INTERFACE',
      p_sig_sql                => 'select 
bsri.ASSEMBLY_ITEM_ID,
bsri.ALTERNATE_ROUTING_DESIGNATOR,
bsri.ORGANIZATION_ID,
...
bsri.ENG_CHANGES_IFCE_KEY,
bsri.NEW_BASIS_TYPE,
--bsri.NEW_SCHEDULE_FLAG,  commented out for 12.1.3
bsri.OPERATION_SEQUENCE_ID,
bsri.SUBSTITUTE_GROUP_NUM,
bsri.SCHEDULE_SEQ_NUM,
bsri.REPLACEMENT_GROUP_NUM,
...
from  
 bom_sub_op_resources_interface bsri
where
(''##$$BATCHID$$##'' is not null and ''##$$BATCHID$$##''=bsri.batch_id)
or 
(
(bsri.organization_id is not null and bsri.organization_id = ''##$$ORGID$$##'' )
or 
...
(bsri.operation_sequence_id is not null --???
   ...
   l_info.delete;
debug('end add_signature: BOM_SUB_OP_RESOURCE_INTERFACE');



debug('begin add_signature: BOM_OPER_NETWORK_INTERFACE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14792',
      p_sig_id                 => 'BOM_OPER_NETWORK_INTERFACE',
      p_sig_sql                => 'select 
boni.ASSEMBLY_ITEM_ID
,boni.ALTERNATE_ROUTING_DESIGNATOR
,boni.ORGANIZATION_ID
...
from  
 bom_op_networks_interface boni
where
(''##$$BATCHID$$##'' is not null and ''##$$BATCHID$$##''=boni.batch_id)
or 
(
(boni.organization_id is not null and boni.organization_id = ''##$$ORGID$$##'' )
or 
...
or (boni.routing_sequence_id is not null
   ...
   l_info.delete;
debug('end add_signature: BOM_OPER_NETWORK_INTERFACE');



debug('begin add_signature: BOM_ROUTING_ITM_REV_INTERFACE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14758',
      p_sig_id                 => 'BOM_ROUTING_ITM_REV_INTERFACE',
      p_sig_sql                => 'select
mriri.inventory_item_number
,mriri.inventory_item_id
,mriri.organization_code
...
where 
    (
         ''##$$BATCHID$$##'' is not null
      and nvl(mriri.batch_id,-999) = ''##$$BATCHID$$##''
    )
    OR
    (
          ''##$$BATCHID$$##'' is null
      and (nvl(mriri.organization_id,-999) = ''##$$ORGID$$##'' or nvl(mriri.organization_code,''~~XXX~~'') = ''##$$ORGCODE$$##'')
      and (nvl(mriri.inventory_item_id,''-999'') = ''##$$ITEMID$$##'' or nvl(mriri.inventory_item_number,''~~XXX~~'') = ''##$$ITEMNUMBER$$##'')
    )',
      p_title                  => 'RTG Revisions Interface',
      p_fail_condition         => 'NRS',
   ...
   l_info.delete;
debug('end add_signature: BOM_ROUTING_ITM_REV_INTERFACE');



debug('begin add_signature: BOM_ENG_ECO_11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15464',
      p_sig_id                 => 'BOM_ENG_ECO_11I',
      p_sig_sql                => 'SELECT change_notice,
  change_name,
  plm_or_erp_change,
  change_id,
  organization_id,
  description,
  -- status_type,
  DECODE(STATUS_TYPE,0,''0 (Draft)'',1,''1(Open)'',2, ''2(Hold)'', 4, ''4(Scheduled)'',5, ''5(Cancelled)'',6,''6(Implemented)'',7,''7(Released)'',8,''8(Approval)'',9,''9(Implementation in Progress)'', 10,''10(Implementation Failed)'',11,''11(Completed)'',12,''12(Review)'', STATUS_TYPE) STATUS_TYPE,
  -- status_code,
  TO_CHAR(initiation_date,''DD-MON-YYYY HH24:MI:SS'') initiation_date,
  need_by_date,
  TO_CHAR(implementation_date,''DD-MON-YYYY HH24:MI:SS'') implementation_date,
  cancellation_date,
  ...
  DECODE(APPROVAL_STATUS_TYPE,1,''1 (Not submitted for approval)'',2,''2(Ready to approve)'',3,''3(Approval requested)'', 4, ''4(Rejected)'',5,''5(Approved)'',6,''6(No approval needed)'',7,''7(Processing error)'',8,''8(Time out)'', APPROVAL_STATUS_TYPE) APPROVAL_STATUS_TYPE,
  -- approval_date,
  TO_CHAR(approval_date,''DD-MON-YYYY HH24:MI:SS'') approval_date,
  approval_list_id,
...
WHERE 1 =1
  and status_type not in (5,6)  --(not cancelled/implemented)
AND change_notice IN
  (SELECT change_notice
  FROM eng_revised_items
  WHERE 1             = 1
  AND revised_item_id = ''##$$ITEMID$$##''
  AND organization_id = ''##$$ORGID$$##'')',
      p_title                  => 'Change Order (Notice) Header',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No unprocessed Engineering Change Orders found for the entered organization/item parameters (ENG_ENGINEERING_CHANGES).',
      p_solution               => '',
      p_success_msg            => 'Unprocessed Engineering Change Order data for the entered organization/item parameters (ENG_ENGINEERING_CHANGES).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_ENG_ECO_11I');



debug('begin add_signature: BOM_ENG_ECO_REV_ITEMS_11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15451',
      p_sig_id                 => 'BOM_ENG_ECO_REV_ITEMS_11I',
      p_sig_sql                => 'select eri.change_notice ,
  eri.organization_id ,
  eri.revised_item_id ,
  msi.concatenated_segments "Revised Item Number" ,
...
DECODE(eri.disposition_type,1,''1(No change required)''
,2,''2(Scrap WIP and inventory)''
,3,''3(Scrap only inventory)''
,4,''4(Scrap only WIP)''
,5,''5(Rework inventory AND WIP)''
,6,''6(Rework only inventory)''  
,7,''7(Rework only WIP)''
,8,''8(Exhaust WIP AND inventory)''
,9,''9(Exhaust only WIP)'', disposition_type) disposition_type,
  eri.new_item_revision ,
  eri.auto_implement_date ,
  --eri.status_type ,
  DECODE(eri.STATUS_TYPE,0,''0 (Draft)'',1,''1(Open)'',2, ''2(Hold)'', 4, ''4(Scheduled)'',5, ''5(Cancelled)'',6,''6(Implemented)'',7,''7(Released)'',8,''8(Approval)'',9,''9(Implementation in Progress)'',
 10,''10(Implementation Failed)'',11,''11(Completed)'',12,''12(Review)'', STATUS_TYPE) STATUS_TYPE,
  --eri.status_code ,
  eri.bill_sequence_id ,
  --eri.mrp_active ,
  decode(eri.mrp_active,1,''Yes'',2,''No'',mrp_active) MRP_ACTIVE,
 -- eri.update_wip ,
  decode(eri.update_wip,1,''Yes'',2,''No'',eri.update_wip) UPDATE_JOBS_SCHEDULES,
  eri.use_up ,
  eri.use_up_item_id ,
  ...
  decode(eri.eco_for_production,1,''Yes'',2,''No'',eri.eco_for_production) UPDATE_JOBS_ONLY,
...
WHERE 1 = 1
AND eri.revised_item_id = ''##$$ITEMID$$##''
AND eri.organization_id = ''##$$ORGID$$##''
AND eri.status_type not in (5,6)
AND eri.revised_item_id = msi.inventory_item_id
AND eri.organization_id = msi.organization_id',
      p_title                  => 'Change Order Revised Items',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No unprocessed Change Order revised items found for the entered organization/item parameters (ENG_REVISED_ITEMS).',
      p_solution               => '',
      p_success_msg            => 'Unprocessed Change Order revised item data for the entered organization/item parameters (ENG_REVISED_ITEMS).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_ENG_ECO_REV_ITEMS_11I');



debug('begin add_signature: BOM_ENG_ECO_REV_COMPS_11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15444',
      p_sig_id                 => 'BOM_ENG_ECO_REV_COMPS_11I',
      p_sig_sql                => 'SELECT eec.change_notice,erc.revised_item_sequence_id ,
  erc.component_item_id ,
  msi.concatenated_segments AS ComponentNumber ,
  erc.acd_type ,
  DECODE(eri.STATUS_TYPE,0,''0 (Draft)'',1,''1(Open)'',2, ''2(Hold)'', 4, ''4(Scheduled)'',5, ''5(Cancelled)'',6,''6(Implemented)'',7,''7(Released)'',8,''8(Approval)'',9,''9(Implementation in Progress)'', 10,''10(Implementation Failed)'',11,''11(Completed)'',12,''12(Review)'') status_type, 
  DECODE(erc.acd_type,1,''1 (Add)'',2,''2(Change)'',3,''3(Disable)'',erc.acd_type) ACTION,
  --erc.operation_sequence_num ,
  erc.item_num ,
  erc.bill_sequence_id ,
  eec.change_notice ,
  TO_CHAR(erc.effectivity_date,''DD-MON-YYYY HH24:MI:SS'') effectivity_date,
  TO_CHAR(erc.implementation_date,''DD-MON-YYYY HH24:MI:SS'') implementation_date,
  TO_CHAR(erc.disable_date,''DD-MON-YYYY HH24:MI:SS'') disable_date,
  erc.component_quantity ,
  erc.component_yield_factor ,
  erc.planning_factor ,
  erc.cost_factor ,
  erc.quantity_related ,
  erc.so_basis ,
  erc.optional ,
  decode(erc.optional,1,''Yes'',2,''No'',erc.optional) Optional,
  erc.mutually_exclusive_options ,
  decode(erc.mutually_exclusive_options,1,''Yes'',2,''No'',erc.mutually_exclusive_options) Mutually_Exclusive,
  erc.check_atp ,
  decode(erc.check_atp,1,''Yes'',2,''No'',erc.check_atp) CHECK_ATP,
  erc.shipping_allowed ,
  erc.required_to_ship ,
  erc.required_for_revenue ,
  erc.include_on_bill_docs ,
  erc.include_on_ship_docs ,
  erc.include_in_cost_rollup ,
  erc.pick_components ,
  erc.component_sequence_id ,
  erc.old_component_sequence_id ,
  erc.parent_bill_seq_id ,
  erc.wip_supply_type ,
  erc.supply_subinventory ,
  erc.supply_locator_id ,
  erc.component_item_revision_id ,
  erc.component_remarks ,
  erc.cancellation_date ,
  erc.cancel_comments ,
  erc.eco_for_production ,
  erc.enforce_int_requirements ,
  erc.optional_on_model ,
  erc.plan_level ,
  erc.auto_request_material ,
  erc.from_object_revision_id ,
  erc.to_object_revision_id ,
  erc.from_end_item_unit_number ,
  to_end_item_unit_number ,
  erc.request_id 
...
WHERE 
1 = 1
AND erc.component_item_id = msi.inventory_item_id
AND erc.change_notice     = eec.change_notice
AND eec.organization_id   = msi.organization_id
--AND erc.implementation_date is null
AND eec.change_notice  = eri.change_notice
AND erc.revised_item_sequence_id=eri.revised_item_sequence_id
AND eri.status_type not in (5,6)
AND eri.revised_item_id = ''##$$ITEMID$$##''
AND eri.organization_id = ''##$$ORGID$$##''',
      p_title                  => 'Change Order Revised Components',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No unprocessed Change Notice revised components found for the entered organization/item parameters (ENG_REVISED_COMPONENTS).',
      p_solution               => '',
      p_success_msg            => 'Unprocessed Change Notice revised component data for the entered organization/item parameters (ENG_REVISED_COMPONENTS).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_ENG_ECO_REV_COMPS_11I');



debug('begin add_signature: BOM_ENG_CHANGES_INTERFACE_11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15448',
      p_sig_id                 => 'BOM_ENG_CHANGES_INTERFACE_11I',
      p_sig_sql                => 'SELECT
	change_notice
	,organization_id
	,to_char(last_update_date,''DD-MON-YYYY HH24:MI:SS'') last_update_date
	...
	,to_char(initiation_date,''DD-MON-YYYY HH24:MI:SS'') initiation_date
	,to_char(implementation_date,''DD-MON-YYYY HH24:MI:SS'') implementation_date
	,to_char(cancellation_date,''DD-MON-YYYY HH24:MI:SS'') cancellation_date
	,cancellation_comments
	,priority_code
	,reason_code
	,estimated_eng_cost
	...
	,responsible_organization_id
	,set_id
	,to_char(approval_request_date,''DD-MON-YYYY HH24:MI:SS'') approval_request_date
	,ddf_context
	,co_created
	,transaction_id
	,process_flag
	...
	,source_type_name
	,source_name
	,to_char(need_by_date,''DD-MON-YYYY HH24:MI:SS'') need_by_date
	,effort
	,change_name
...
where change_notice in
             (
             select distinct change_notice from eng_revised_items_interface i
              where
                 (
                     (
                         (i.organization_id is not null and i.organization_id = ''##$$ORGID$$##'' )
                     ...
                     and 
                     (
                         (i.revised_item_id is not null and  i.revised_item_id = ''##$$ITEMID$$##'')
                         or
                         (i.revised_item_number is not null and i.revised_item_NUMBER = ''##$$ITEMNUMBER$$##'')
                     )
                )
                or
                (
      ...
      p_title                  => 'Change Order Interface',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Change Order Interface Headers found for the entered Organization/Item parameters (ENG_ENG_CHANGES_INTERFACE).',
      p_solution               => '',
      p_success_msg            => 'Change Order Interface header data for the entered organization/item parameters (ENG_ENG_CHANGES_INTERFACE).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_ENG_CHANGES_INTERFACE_11I');



debug('begin add_signature: BOM_ENG_REVISED_ITEMS_INTERFACE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15100',
      p_sig_id                 => 'BOM_ENG_REVISED_ITEMS_INTERFACE',
      p_sig_sql                => 'SELECT
	change_notice
	,i.organization_id
	,i.revised_item_id
	,i.organization_code
	,i.revised_item_number
	,i.assembly_item_number
	...
	,i.created_by
	,i.last_update_login
	,to_char(i.implementation_date,''DD-MON-YYYY HH24:MI:SS'') implementation_date
	,i.descriptive_text
	,to_char(i.cancellation_date,''DD-MON-YYYY HH24:MI:SS'') cancellation_date
	,i.cancel_comments
	,i.disposition_type
	,i.new_item_revision
	,to_char(i.auto_implement_date,''DD-MON-YYYY HH24:MI:SS'') auto_implement_date
	,to_char(i.early_schedule_date,''DD-MON-YYYY HH24:MI:SS'') early_schedule_date
	,i.attribute_category
	,i.attribute1
	,i.attribute2
	,i.attribute3
	...
	,i.attribute15
	,i.status_type
	,to_char(i.scheduled_date,''DD-MON-YYYY HH24:MI:SS'') scheduled_date
	,i.mrp_active
	,i.request_id
	,i.program_application_id
	,i.program_id
	...
	,i.item_type
	,i.use_up_plan_name
	,i.alternate_selection_code
	,i.use_up_item_number
	...
	,i.from_end_item_number
	,i.from_end_item_revision
	,i.parent_revised_item_name
	,i.parent_alternate_name
	,i.updated_item_revision
	,to_char(i.new_scheduled_date,''DD-MON-YYYY HH24:MI:SS'') new_scheduled_date
	,i.from_item_revision
	,i.new_revision_label
	,i.new_revised_item_rev_desc
	,i.new_revision_reason
FROM eng_revised_items_interface i
WHERE 
  ( 
    (
        (i.organization_id is not null and i.organization_id = ''##$$ORGID$$##'' )
  ...
  (
     ...
     and exists (
                  select 1 from bom_structures_b 
                   where bill_sequence_id = i.bill_sequence_id
                     and organization_id = ''##$$ORGID$$##''
                     and assembly_item_id = ''##$$ITEMID$$##''
                     and rownum=1
                )
  )',
      p_title                  => 'Change Notice Revised Items Interface',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Change Order revised item interface data found for the entered organization/item parameters (ENG_REVISED_ITEMS_INTERFACE).',
      p_solution               => '',
      p_success_msg            => 'Change Order revised item interface data for the entered organization/item parameters (ENG_REVISED_ITEMS_INTERFACE).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_ENG_REVISED_ITEMS_INTERFACE');



debug('begin add_signature: BOM_ENG_ECO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14782',
      p_sig_id                 => 'BOM_ENG_ECO',
      p_sig_sql                => 'SELECT change_notice,
  change_name,
  plm_or_erp_change,
  change_id,
  ...
  TO_CHAR(creation_date,''DD-MON-YYYY HH24:MI:SS'') creation_date
FROM eng_engineering_changes
WHERE status_type not in (5,6)  --(not cancelled/implemented)
AND change_notice IN
      (SELECT change_notice
         FROM eng_revised_items
         WHERE 1             = 1
   ...
   l_info.delete;
debug('end add_signature: BOM_ENG_ECO');



debug('begin add_signature: BOM_ENG_ECO_REV_ITEMS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14783',
      p_sig_id                 => 'BOM_ENG_ECO_REV_ITEMS',
      p_sig_sql                => 'select eri.change_notice ,
  eri.organization_id ,
  eri.revised_item_id ,
  msi.concatenated_segments "Revised Item Number" ,
...
AND eri.organization_id = msi.organization_id',
   ...
   l_info.delete;
debug('end add_signature: BOM_ENG_ECO_REV_ITEMS');



debug('begin add_signature: BOM_ENG_ECO_REV_COMPS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14784',
      p_sig_id                 => 'BOM_ENG_ECO_REV_COMPS',
      p_sig_sql                => 'SELECT eec.change_notice,erc.revised_item_sequence_id ,
  erc.component_item_id ,
  msi.concatenated_segments AS ComponentNumber ,
  erc.acd_type ,
  ...
  erc.component_sequence_id ,
  erc.old_component_sequence_id ,
  erc.common_component_sequence_id ,
  erc.parent_bill_seq_id ,
  erc.wip_supply_type ,
  erc.supply_subinventory ,
  erc.supply_locator_id ,
...
AND eri.organization_id = ''##$$ORGID$$##''',
   ...
   l_info.delete;
debug('end add_signature: BOM_ENG_ECO_REV_COMPS');



debug('begin add_signature: BOM_ENG_CHANGES_INTERFACE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14626',
      p_sig_id                 => 'BOM_ENG_CHANGES_INTERFACE',
      p_sig_sql                => 'SELECT
	change_notice
	,organization_id
	,to_char(last_update_date,''DD-MON-YYYY HH24:MI:SS'') last_update_date
...
where change_notice in
   ...
   l_info.delete;
debug('end add_signature: BOM_ENG_CHANGES_INTERFACE');



debug('begin add_signature: INV_ORGANIZATIONS_FULL_OUTPUT_ORG_R11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12488',
      p_sig_id                 => 'INV_ORGANIZATIONS_FULL_OUTPUT_ORG_R11I',
...
SELECT 1.1 sequence, ''Organization Code'', organization_code || '' (ID: ''|| organization_id ||'')''  FROM mtl_parameters mp 
 where organization_id = ##$$ORGID$$##
union
select 1.2 sequence, ''Item Master Organization'', NVL((select mp.master_organization_id || '' ('' ||b.organization_code || '')'' from mtl_parameters b where b.organization_id = mp.master_organization_id), mp.master_organization_id) master_organization_id from mtl_parameters mp
where organization_id = ##$$ORGID$$##
union
...
order by sequence',
   ...
   l_info.delete;
debug('end add_signature: INV_ORGANIZATIONS_FULL_OUTPUT_ORG_R11I');



debug('begin add_signature: BOM_ORG_DETAILS_11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15446',
      p_sig_id                 => 'BOM_ORG_DETAILS_11I',
      p_sig_sql                => 'select 
organization_id,
organization_code,
...
,1,''1-Standard''
,2,''2-Average''
,3,''3-Periodic Average''
,4,''4-Periodic Incremental LIFO''
,5,''5-FIFO''
,6,''6-LIFO'') COST_METHOD,
wms_enabled_flag,
...
from mtl_parameters
where organization_id =##$$ORGID$$##',
      p_title                  => 'Organization Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No organizations were found for the given parameter.',
      p_solution               => 'Review the parameters and confirm the correct organization code is passed to the analyzer.',
      p_success_msg            => 'Inventory organization parameter data (MTL_PARAMETERS).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_ORG_DETAILS_11I');
...
debug('begin add_signature: BOM_ORG_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14766',
      p_sig_id                 => 'BOM_ORG_DETAILS',
      p_sig_sql                => 'select *
from mtl_parameters
...
order by 1 desc',
   ...
   l_info.delete;
debug('end add_signature: BOM_ORG_DETAILS');



debug('begin add_signature: EBS_MFG_INV_BOMAZ_WIP_PARAMETERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28524',
      p_sig_id                 => 'EBS_MFG_INV_BOMAZ_WIP_PARAMETERS',
      p_sig_sql                => 'select * from wip_parameters
where organization_id in (
select distinct organization_id 
from mtl_system_items_b
where inventory_item_id = ##$$ITEMID$$##)',
      p_title                  => 'WIP_PARAMETERS',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'WIP Parameters for all organizations where the item is assigned to.',
      p_solution               => 'WIP Parameters offer a view of setup related to Work In Process module.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_BOMAZ_WIP_PARAMETERS');



debug('begin add_signature: BOM_COMMONED_BILL_UPDATE_ATTRIBUTES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15010',
      p_sig_id                 => 'BOM_COMMONED_BILL_UPDATE_ATTRIBUTES',
      p_sig_sql                => 'select b.organization_code,C.CONCATENATED_SEGMENTS, c.inventory_item_id,a.common_bill_sequence_id,a.source_bill_sequence_id,a.bill_sequence_id
from bom_bill_of_materials a, mtl_parameters b, mtl_system_items_kfv c
where a.common_bill_sequence_id<>a.source_bill_sequence_id
and a.bill_sequence_id<>a.source_bill_sequence_id
and a.bill_sequence_id=a.common_bill_sequence_id
and a.assembly_item_id=c.inventory_item_id
and a.organization_id=c.organization_id
and a.organization_id=b.organization_id
and a.assembly_item_id=''##$$ITEMID$$##''
and a.organization_id=''##$$ORGID$$##''
Order by 1,2',
      p_title                  => 'Common Bills that allow Attribute updates',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Common Bills for the entered org/item that allow Attribute updates (Enable Item Attributes was unchecked for any created Common Bills).',
      p_solution               => '',
      p_success_msg            => 'The listed Common Bills allow Attribute updates (Enable Item Attributes was checked when the Common Bills were created).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_COMMONED_BILL_UPDATE_ATTRIBUTES');



debug('begin add_signature: BOM_ENABLED_FLAG_CHECK_11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15440',
      p_sig_id                 => 'BOM_ENABLED_FLAG_CHECK_11I',
      p_sig_sql                => 'SELECT * FROM (
SELECT 
 mp.organization_code org
, mif.item_number assembly_item
, null component_item
, ''N/A'' component_disable_date
, decode(mif.bom_enabled_flag,''N'',''Assembly item is not BOM Enabled even though a bill exists'') message
FROM bom_structures_b bs
,mtl_parameters mp
,mtl_item_flexfields mif
WHERE 1=1
AND bs.organization_id IN (''##$$ORGID$$##'', (SELECT master_organization_id FROM mtl_parameters X WHERE X.organization_id = ''##$$ORGID$$##''))
AND bs.organization_id = mp.organization_id
AND bs.organization_id = mif.organization_id
AND bs.assembly_item_id = ''##$$ITEMID$$##''
AND bs.assembly_item_id = mif.inventory_item_id
...
, mif1.item_number assembly_item
, mif2.item_number component_item
, to_char(bc.disable_date,''YYYY-MM-DD HH24:MI:SS'')
, decode(mif2.bom_enabled_flag,''N'',''Component item is not BOM Enabled but is still enabled on the bill'') message
FROM bom_structures_b bs
,mtl_item_flexfields mif1
,bom_components_b bc
,mtl_item_flexfields mif2
...
AND bs.assembly_item_id = ''##$$ITEMID$$##''
AND bs.assembly_item_id = mif1.inventory_item_id
AND bs.common_bill_sequence_id = bc.bill_sequence_id
AND bs.organization_id = mif2.organization_id
AND bc.component_item_id = mif2.inventory_item_id
) WHERE message IS NOT NULL
order by org, assembly_item, component_item',
      p_title                  => 'Bill Assembly or Components not BOM Enabled',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Check for assembly and/or component item(s) associated with this Bill that are not BOM enabled.',
      p_solution               => 'Refer to the following note for additional information:<br>
[2041875/KB382220] - Disabled/ Inactive Components Show On BOMs And Within WIP Material Requirements
',
      p_success_msg            => 'No issues found for this Bill and its Component(s).',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_ENABLED_FLAG_CHECK_11I');



debug('begin add_signature: BOM_ENABLED_FLAG_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15017',
      p_sig_id                 => 'BOM_ENABLED_FLAG_CHECK',
      p_sig_sql                => 'SELECT * FROM (
SELECT 
 mp.organization_code org
, mif.item_number assembly_item
...
AND bs.assembly_item_id = ''##$$ITEMID$$##''
AND bs.assembly_item_id = mif1.inventory_item_id
AND bs.source_bill_sequence_id = bc.bill_sequence_id
AND bs.organization_id = mif2.organization_id
AND bc.component_item_id = mif2.inventory_item_id
) WHERE message IS NOT NULL
order by org, assembly_item, component_item',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Check for assembly and/or component item(s) associated with this Bill that are not BOM enabled.',
      p_solution               => 'Refer to the following document for implications of this setup and how to correct it: <br>
[2041875/KB382220] - Disabled/ Inactive Components Show On BOMs And Within WIP Material Requirements
',
      p_success_msg            => 'No issues found for this Bill and its Component(s).',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: BOM_ENABLED_FLAG_CHECK');



debug('begin add_signature: BOM_ITEMS_DETAILS_11I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15447',
      p_sig_id                 => 'BOM_ITEMS_DETAILS_11I',
      p_sig_sql                => 'select decode(inventory_item_id,''##$$ITEMID$$##'', ''Main Assembly'', ''Component Item'') Item_Type
,inventory_item_id
,organization_id 
,description
...
select * from mtl_system_items_b
where organization_id = ##$$ORGID$$##
and inventory_item_id in (select bc.component_item_id
from bom_components_b bc, bom_bill_of_materials bo
where bc.bill_sequence_id = bo.bill_sequence_id
and bo.assembly_item_id = ##$$ITEMID$$##
and bc.pk2_value = ##$$ORGID$$##))
order by 1 desc',
      p_title                  => 'Items Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No items where found for the the entered item parameter value. Please enter a valid assembly item for this organization.',
      p_solution               => 'Review the parameters and confirm the correct organization code and assembly item number are passed to the analyzer.',
      p_success_msg            => 'Inventory item details for the entered item (MTL_SYSTEM_ITEMS_B).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BOM_ITEMS_DETAILS_11I');



debug('begin add_signature: BOM_ITEMS_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14767',
      p_sig_id                 => 'BOM_ITEMS_DETAILS',
      p_sig_sql                => 'select decode(inventory_item_id,''##$$ITEMID$$##'', ''Main Assembly'', ''Component Item'') Item_Type
,inventory_item_id
,segment1
,organization_id 
...
,base_warranty_service_id
,bom_enabled_flag
,decode (bom_item_type, 1,''Model''
,2,''Option class''
,3,''Planning''
,4,''Standard''
,5,''Product family'', bom_item_type) bom_item_type
,build_in_wip_flag
,bulk_picked_flag
,buyer_id
,carrying_cost
...
,serial_number_control_code
,serial_status_enabled
--,serial_tagging_flag  commented out for 12.1.3
,serviceable_component_flag
,serviceable_item_class_id
,serviceable_product_flag
,service_duration
...
order by 1 desc',
   ...
   l_info.delete;
debug('end add_signature: BOM_ITEMS_DETAILS');
...
BEGIN
  ...
  analyzer_title := 'Bills of Material Analyzer';
...
debug('begin section: BOM_DATA');
IF g_sql_tokens('##$$ITEMID$$##') IS NOT NULL THEN
   start_section('Bills of Material', 'BOM_DATA');
      IF ((substr(g_sql_tokens('##$$RELEASE$$##'),1,4) = '11.5')) THEN
         set_item_result(run_stored_sig('BOM_PARAMETERS'));
         set_item_result(run_stored_sig('BOM_COMMONED_BILL_LISTING_11I'));
         set_item_result(run_stored_sig('BOM_BILLS_HEADER_11I'));
         set_item_result(run_stored_sig('BOM_BILL_HEADER_ATTACHMENTS'));
         set_item_result(run_stored_sig('BOM_BILL_COMPONENTS_11I'));
         set_item_result(run_stored_sig('BOM_SUBS_COMPONEN_11I'));
         set_item_result(run_stored_sig('BOM_COMPONENT_OPERATION_11I'));
         set_item_result(run_stored_sig('BOM_REF_DESIGNATOR_11I'));
         set_item_result(run_stored_sig('BOM_BILL_EXPLOSIONS_11I'));
         set_item_result(run_stored_sig('BOM_COMMONED_ROUTING_LISTING'));
         set_item_result(run_stored_sig('BOM_ROUTING_HEADER'));
         set_item_result(run_stored_sig('BOM_ROUTING_OPERATIONS_11I'));
         set_item_result(run_stored_sig('BOM_BILL_OPERATION_ATTACHMENTS'));
         set_item_result(run_stored_sig('BOM_OPERATION_RESOURCES'));
         set_item_result(run_stored_sig('BOM_OPER_SUB_RESOURCES'));
         set_item_result(run_stored_sig('BOM_OPER_NETWORK'));
         set_item_result(run_stored_sig('BOM_OPER_NETWORK_INTERFACE_11I'));
         set_item_result(run_stored_sig('BOM_DELETE_GROUPS'));
         set_item_result(run_stored_sig('BOM_ROUTING_REVISIONS'));
         set_item_result(run_stored_sig('BOM_DELETE_ENTITIES'));
         set_item_result(run_stored_sig('BOM_DELETE_SUB_ENTITIES'));
         set_item_result(run_stored_sig('BOM_KEY_PROFILES'));
      END IF;
      set_item_result(run_stored_sig('EBS_MFG_INV_BOMAZ_BOM_OVERVIEW'));
      IF ((substr(g_sql_tokens('##$$RELEASE$$##'),1,2) = '12')) THEN
         set_item_result(run_stored_sig('BOM_PARAMETERS'));
         set_item_result(run_stored_sig('BOM_COMMONED_BILL_LISTING'));
         set_item_result(run_stored_sig('BOM_BILLS_HEADER'));
         set_item_result(run_stored_sig('BOM_BILL_HEADER_ATTACHMENTS'));
         set_item_result(run_stored_sig('BOM_BILL_COMPONENTS'));
         set_item_result(run_stored_sig('BOM_SUBS_COMPONENTS'));
         set_item_result(run_stored_sig('BOM_COMPONENT_OPERATIONS'));
         set_item_result(run_stored_sig('BOM_REF_DESIGNATORS'));
         set_item_result(run_stored_sig('BOM_BILL_EXPLOSIONS'));
         set_item_result(run_stored_sig('BOM_COMMONED_ROUTING_LISTING'));
         set_item_result(run_stored_sig('BOM_ROUTING_HEADER'));
         set_item_result(run_stored_sig('BOM_ROUTING_OPERATIONS'));
         set_item_result(run_stored_sig('BOM_BILL_OPERATION_ATTACHMENTS'));
         set_item_result(run_stored_sig('BOM_OPERATION_RESOURCES'));
         set_item_result(run_stored_sig('BOM_OPER_SUB_RESOURCES'));
         set_item_result(run_stored_sig('BOM_OPER_NETWORK'));
         ...
         set_item_result(run_stored_sig('BOM_KEY_PROFILES'));
      END IF;
      set_item_result(run_stored_sig('EBS_MFG_INV_BOMAZ_BOM_EVENTS_ENABLED'));
   end_section;
END IF;
debug('end section: BOM_DATA');

debug('begin section: BOM_INTERFACE');
start_section('BOM Related Interface', 'BOM_INTERFACE');
   IF ((substr(g_sql_tokens('##$$RELEASE$$##'),1,4) = '11.5')) THEN
      set_item_result(run_stored_sig('BOM_MTL_INTERFACE_ERRORS_11I'));
      set_item_result(run_stored_sig('BOM_ITEM_INTERFACE_11I'));
      set_item_result(run_stored_sig('BOM_ITEM_REV_INTERFACE_11I'));
      set_item_result(run_stored_sig('BOM_BILLS_INTERFACE_11I'));
      set_item_result(run_stored_sig('BOM_COMPS_INTERFACE_11I'));
      set_item_result(run_stored_sig('BOM_SUB_COMPS_INTERFACE_11I'));
      set_item_result(run_stored_sig('BOM_REF_DESIGNATORS_INTERFACE_11I'));
      set_item_result(run_stored_sig('BOM_DELETE_GROUP_INTERFACE'));
      set_item_result(run_stored_sig('BOM_OPER_ROUTING_INTERFACE_11I'));
      set_item_result(run_stored_sig('BOM_COMP_OPER_INTERFACE_11I'));
      set_item_result(run_stored_sig('BOM_OP_SEQUENCES_INTERFACE_11I'));
      set_item_result(run_stored_sig('BOM_OPER_RESOURCE_INTERFACE_11I'));
      set_item_result(run_stored_sig('BOM_SUB_OP_RESOURCE_INTERFACE_11I'));
      set_item_result(run_stored_sig('BOM_OPER_NETWORK_INTERFACE_11I'));
      set_item_result(run_stored_sig('BOM_ROUTING_ITM_REV_INTERFACE_11I'));
   END IF;
   IF substr(g_sql_tokens('##$$RELEASE$$##'),1,2) = '12' THEN
      set_item_result(run_stored_sig('BOM_MTL_INTERFACE_ERRORS'));
      set_item_result(run_stored_sig('BOM_ITEM_INTERFACE'));
      set_item_result(run_stored_sig('BOM_ITEM_REV_INTERFACE'));
      set_item_result(run_stored_sig('BOM_BILLS_INTERFACE'));
      set_item_result(run_stored_sig('BOM_COMPS_INTERFACE'));
      set_item_result(run_stored_sig('BOM_SUB_COMPS_INTERFACE'));
      set_item_result(run_stored_sig('BOM_CMP_USER_ATTR_INTERFACE'));
      set_item_result(run_stored_sig('BOM_REF_DESIGNATORS_INTERFACE'));
      set_item_result(run_stored_sig('BOM_DELETE_GROUP_INTERFACE'));
      set_item_result(run_stored_sig('BOM_OPER_ROUTING_INTERFACE'));
      set_item_result(run_stored_sig('BOM_COMP_OPER_INTERFACE'));
      set_item_result(run_stored_sig('BOM_OP_SEQUENCES_INTERFACE'));
      set_item_result(run_stored_sig('BOM_OPER_RESOURCE_INTERFACE'));
      set_item_result(run_stored_sig('BOM_SUB_OP_RESOURCE_INTERFACE'));
      set_item_result(run_stored_sig('BOM_OPER_NETWORK_INTERFACE'));
      set_item_result(run_stored_sig('BOM_ROUTING_ITM_REV_INTERFACE'));
   END IF;
end_section;
debug('end section: BOM_INTERFACE');

debug('begin section: ITEM_ORG_DATA');
start_section('Item/Organization', 'ITEM_ORG_DATA');
   IF ((substr(g_sql_tokens('##$$RELEASE$$##'),1,4) = '11.5')) THEN
      set_item_result(run_stored_sig('INV_ORGANIZATIONS_FULL_OUTPUT_ORG_R11I'));
      IF g_sql_tokens('##$$ITEMID$$##') IS NOT NULL THEN
         set_item_result(run_stored_sig('BOM_ITEMS_DETAILS_11I'));
      END IF;
      set_item_result(run_stored_sig('BOM_ORG_DETAILS_11I'));
   END IF;
   IF ((substr(g_sql_tokens('##$$RELEASE$$##'),1,2) = '12')) THEN
      set_item_result(run_stored_sig('INV_ORGANIZATIONS_FULL_OUTPUT_ORG'));
      IF g_sql_tokens('##$$ITEMID$$##') IS NOT NULL THEN
         set_item_result(run_stored_sig('BOM_ITEMS_DETAILS'));
      END IF;
      set_item_result(run_stored_sig('BOM_ORG_DETAILS'));
      set_item_result(run_stored_sig('EBS_MFG_INV_BOMAZ_WIP_PARAMETERS'));
   END IF;
end_section;
debug('end section: ITEM_ORG_DATA');

debug('begin section: ECO_DATA');
start_section('Engineering Change Orders', 'ECO_DATA');
   IF ((substr(g_sql_tokens('##$$RELEASE$$##'),1,4) = '11.5')) THEN
      set_item_result(run_stored_sig('BOM_ENG_ECO_11I'));
      set_item_result(run_stored_sig('BOM_ENG_ECO_REV_ITEMS_11I'));
      set_item_result(run_stored_sig('BOM_ENG_ECO_REV_COMPS_11I'));
      set_item_result(run_stored_sig('BOM_ENG_CHANGES_INTERFACE_11I'));
      set_item_result(run_stored_sig('BOM_ENG_REVISED_ITEMS_INTERFACE'));
   END IF;
   IF ((substr(g_sql_tokens('##$$RELEASE$$##'),1,2) = '12')) THEN
      set_item_result(run_stored_sig('BOM_ENG_ECO'));
      set_item_result(run_stored_sig('BOM_ENG_ECO_REV_ITEMS'));
      set_item_result(run_stored_sig('BOM_ENG_ECO_REV_COMPS'));
      set_item_result(run_stored_sig('BOM_ENG_CHANGES_INTERFACE'));
      set_item_result(run_stored_sig('BOM_ENG_REVISED_ITEMS_INTERFACE'));
   END IF;
end_section;
debug('end section: ECO_DATA');

debug('begin section: COMMON_DATA_ISSUES');
start_section('Common Data Issues', 'COMMON_DATA_ISSUES');
   set_item_result(run_stored_sig('BOM_ATO_ITEM_ACCESS_CHECK'));
   set_item_result(run_stored_sig('BOM_BILLS_FORM_ACCESS'));
   set_item_result(run_stored_sig('BOM_CALENDAR_REBUILD_CHECK'));
   IF substr(g_sql_tokens('##$$RELEASE$$##'),1,2) = '12' THEN
      set_item_result(run_stored_sig('BOM_COMMONED_BILL_UPDATE_ATTRIBUTES'));
   END IF;
   set_item_result(run_stored_sig('BOM_COMPONENT_NULL_IMPLEMENTATION_DATE'));
   set_item_result(run_stored_sig('BOM_COMPONENT_REMARKS_CHECK'));
   set_item_result(run_stored_sig('BOM_CREATE_COMMONED_BILL_ORG_HIERARCHY'));
   set_item_result(run_stored_sig('BOM_DUAL_UOM_ITEM_CHECK'));
   set_item_result(run_stored_sig('BOM_DUPLICATE_BILL_CHECK'));
   set_item_result(run_stored_sig('BOM_ECO_CHECK'));
   IF substr(g_sql_tokens('##$$RELEASE$$##'),1,4) = '11.5' THEN
      set_item_result(run_stored_sig('BOM_ENABLED_FLAG_CHECK_11I'));
   END IF;
   IF substr(g_sql_tokens('##$$RELEASE$$##'),1,2) = '12' THEN
      set_item_result(run_stored_sig('BOM_ENABLED_FLAG_CHECK'));
   END IF;
   set_item_result(run_stored_sig('BOM_FORM_PERSONALIZATIONS'));
   set_item_result(run_stored_sig('BOM_INVALID_UNIT_EFFECTIVE_COMPONENTS'));
   set_item_result(run_stored_sig('BOM_ITM_REV_OUT_OF_SEQ'));
   set_item_result(run_stored_sig('BOM_MISSING_ATTRIBUTE_CATEGORY_VALUE_CHECK'));
   set_item_result(run_stored_sig('BOM_MISSING_DEPARTMENT_EMPLOYEES'));
   set_item_result(run_stored_sig('BOM_MISSING_OLD_OPERATION_SEQUENCE'));
   set_item_result(run_stored_sig('BOM_MISSING_ROUTING_REVISION_CHECK'));
   set_item_result(run_stored_sig('BOM_NULL_ASSEMBLY_ITEM_ID'));
   set_item_result(run_stored_sig('BOM_OVERLAPPING_EFFECTIVITY_DATE_CHECK'));
   set_item_result(run_stored_sig('BOM_PENDING_FROM_ECN_CHECK'));
   set_item_result(run_stored_sig('BOM_UPDATE_RESOURCE'));
   set_item_result(run_stored_sig('BOM_VALIDATE_PROFILE_BOM_WEEK_PERIOD_START_DAY'));
   set_item_result(run_stored_sig('BOM_VALIDATE_PROFILE_REPORT_QUANTITY_PRECISION'));
   set_item_result(run_stored_sig('BOM_ZERO_COMPONENT_CHECK'));
   set_item_result(run_stored_sig('EBS_MFG_INV_BOMAZ_DELETE_ERRORS'));
   set_item_result(run_stored_sig('EBS_MFG_INV_BOMAZ_LEADING_TRAILING'));
end_section;
debug('end section: COMMON_DATA_ISSUES');

debug('begin section: APPSCHECK');
start_section('Diagnostics: Apps Check', 'APPSCHECK');
