...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Inventory Consignment Analyzer         |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE inv_consign_analyzer_pkg AUTHID DEFINER AS
...
END inv_consign_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY inv_consign_analyzer_pkg AS
-- $Id: inv_consignment_analyzer.sql, 200.31 2026/02/23 18:02:28 jphipps Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2048039.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'INVCAZ_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'INVCAZ_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>INVCAZ Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2048039.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/inv_consignment_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,405,EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,405,EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},405,EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/3788264" class="blacklink" target="new">
...
<div class="ck-content"><div>We’re listening to your feedback and made the following changes:</div>
<div>&nbsp;</div>
...
<div>&nbsp;</div>
<div>April 2025</div>
<div>&nbsp; &nbsp; &nbsp;Added signature ‘Unprocessed Consignment Records With Batch ID Populated’</div>
<div>&nbsp;</div>
<div>April 2025</div>
<div>&nbsp; &nbsp; &nbsp;Signature updates</div>
<div>&nbsp; &nbsp; &nbsp;Apps Check section updates</div>
<div>&nbsp;</div>
<div>March 2025</div>
<div>&nbsp; &nbsp; &nbsp;Signature update</div>
<div>&nbsp; &nbsp; &nbsp;Framework update</div>
<div>&nbsp;</div>
...
<div><ul><li>Signature updates</li>
...
<div>&nbsp;</div>
<div>March 2023</div>
<ul><li>Framework updates</li>
<li>Signature updates</li>
</ul>
<div>&nbsp;</div>
<div>December 2022</div>
<ul><li>Update signatures</li>
<li>Updated Framework</li>
</ul>
<div><br>
October 2021</div>
<ol><li>Analyzer framework update</li>
</ol>
<div>&nbsp;</div>
<div>November 2019<br>
1. New Framework version 4.4.4.<br>
<br>
September 2019<br>
1. The analyzer is now executed as a Package instead of an Anonymous Block. Please see the instructions in<strong> </strong>Doc ID 2048039.1 for running the analyzer as a Concurrent Request or in Sql*Plus.<br>
<br>
August 2019:<br>
1. New Analyzer Framework 4.4.3.<br>
<br>
July 2019:<br>
<span style="color:black;"><span style="font-family:Arial,Helvetica,sans-serif;font-size:12px;">The Data Masking feature has been expanded.&nbsp;&nbsp;&nbsp;</span></span><br>
<span style="color:black;"><span style="font-family:Arial,Helvetica,sans-serif;font-size:12px;">1.&nbsp; Select data is now pre-masked at the point of collection.</span></span><br>
<span style="color:black;"><span style="font-family:Arial,Helvetica,sans-serif;font-size:12px;">2.&nbsp; The masked information displayed will be just enough to permit effective review and troubleshooting of an issue.</span></span><br>
<span style="color:black;"><span style="font-family:Arial,Helvetica,sans-serif;font-size:12px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Example:&nbsp; A credit card number would be displayed as ****-****-****-1234</span></span><br>
<span style="color:black;"><span style="font-family:Arial,Helvetica,sans-serif;font-size:12px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; An employee name would be displayed as Display first and last 25% per word (J**n S**w = John Snow)</span></span><br>
<span style="color:black;"><span style="font-family:Arial,Helvetica,sans-serif;font-size:12px;">3.&nbsp;&nbsp; The existing “Lock Icon” still provides customers the manual column scrambling capabilities, which can be used in addition to the newly introduced pre-masked data feature.</span></span></div>
</div>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,405,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,405,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},405,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
BEGIN
    ...
    print_log('Processing recommended patches signature: INV_CON_CHECK_REC (check_rec_patches_1) "Recommended Patches" (version 10)');
...
Best Practice: Always ensure that you are on the latest code with all recommended patches applied. This will help avoid known issues, prevent potential data corruption and provide the latest features and functionality. Having a proactive patching plan and periodic proactive patching process in place are the best ways to stay current. ';
  ...
  -- Register
  l_step := '60';
  g_signatures('INV_CON_CHECK_REC') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'INV_CON_CHECK_REC',     -- sig ID
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/02/23 18:02:27 $','$',''));
...
WHERE KFV.CONCATENATED_SEGMENTS = p_item_num
 AND KFV.organization_id = (select organization_id from mtl_parameters where organization_code = p_org_code)
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: << Item Number >> : Please enter a valid item part number. The part entered '|| p_item_num || ' does not exist or is not assigned to the selected organization '|| p_org_code || '.');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
debug('begin add_signature: CONSIGNMENT_KEY_INVALIDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11419',
      p_sig_id                 => 'CONSIGNMENT_KEY_INVALIDS',
    ...
    AND a.owner = ''APPS''
    AND (a.object_name IN (''PO_INTERFACE_S'', ''INV_CONSUMPTION_ADVICE_PROC'', ''INV_THIRD_PARTY_STOCK_PVT'')  )
    AND a.status = ''INVALID''',
      p_title                  => 'Consignment Key Invalid Objects',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There exist key invalid Consignment objects',
      p_solution               => '<ul>
      <li>Note that the invalids directly affect consignment processing.</li>
...
See [2371665/KB476134] for more details. ',
      p_success_msg            => 'No Key Consignment invalid objects exists in the database',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CONSIGNMENT_KEY_INVALIDS');



debug('begin add_signature: CONSIGNMENT_INVALID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1644',
      p_sig_id                 => 'CONSIGNMENT_INVALID',
      p_sig_sql                => 'SELECT a.object_name,
           decode(a.object_type,
             ''PACKAGE'', ''Package Spec'',
             ''PACKAGE BODY'', ''Package Body'',
    ...
    AND a.status = ''INVALID''',
      p_title                  => 'Consignment Related Invalid Objects',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There exist invalid Consignment related objects',
      p_solution               => '<ul>
      <li>Note that invalids may not affect you currently.</li>
      <li>Recompile the individual objects manually or recompile the
          entire APPS schema with adadmin utility</li>
      <li>Review any error messages provided</li>
   </ul>
See [2371665/KB476134] for more details. ',
      p_success_msg            => 'No Consignment related invalid objects exists in the database',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CONSIGNMENT_INVALID');



debug('begin add_signature: CONSIGN_KEY_FILE_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1658',
      p_sig_id                 => 'CONSIGN_KEY_FILE_VERSIONS',
...
order by 1',
      ...
      p_problem_descr          => 'Information about consignment related packages. These packages are often a good version to check if you see incorrect behavior to ensure you have any recent patches and code-fixes:
<ul><li>INV_THIRD_PARTY_STOCK_PVT (INVVTPSB.pls): Creating consumption transactions</li>
<li>INV_CONSUMPTION_ADVICE_PROC (INVRCADB.pls): Creating consumption advise</li>
<li>PO_INTERFACE_S (POXBWP1B.pls): Called to find the related Purchase Order (PO) when creating transactions as well as used for creating PO releases as part of creating consumption advise.</li></ul>',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CONSIGN_KEY_FILE_VERSIONS');



debug('begin add_signature: Successful_Consignment');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1655',
      p_sig_id                 => 'Successful_Consignment',
      p_sig_sql                => 'SELECT a.* 
     ...
     WHERE a.transaction_id = b.transaction_id 
	   ...
	   AND b.organization_id = ##$$ORGID$$##
           AND b.inventory_item_id = NVL(''##$$ITEMID$$##'', b.inventory_item_id)
   ORDER BY a.transaction_id desc',
      p_title                  => 'Success Consignment',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Recent consumption transactions that were successful. Collecting data to review past successful transactions as a reference to see what was working. No past consignment means that this had not worked in the past. If there are no results, this section is flagged as a warning to let you know that no consumption advise has processed successfully in the past.',
      p_solution               => 'Collecting data to review past successful transactions but there were none found. No past consignment transactions means that the consignment process had not been successful in the past. You may want to validate basic setups as a starting point including the blanket purchase order/agreement (BPO/BPA), approved supplier list (ASL), and other setups discussed in the frequently asked questions (FAQ) -- See [406390/KB461375].',
      p_success_msg            => 'Consumption records were found. This section lets you know that consumption advise has processed successfully in the past. This is a reference only and may be helpful to review past records to see what had worked in the past. For more information on the setup and results see the frequently asked questions (FAQ) -- See [406390/KB461375].',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: Successful_Consignment');



debug('begin add_signature: Error_Consignment');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1657',
      p_sig_id                 => 'Error_Consignment',
      p_sig_sql                => 'SELECT a.ERROR_CODE, a.ERROR_EXPLANATION, a.* 
      FROM mtl_consumption_transactions a, mtl_material_transactions b
     WHERE a.transaction_id = b.transaction_id 
       ...
       AND b.inventory_item_id = NVL(''##$$ITEMID$$##'', b.inventory_item_id)
   ORDER BY a.transaction_id desc',
      p_title                  => 'Error Consignment',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Recent consumption transactions that were unsuccessful.',
      p_solution               => 'Review each error and see if more details are listed in the "Consignment Issues" section. The goal should be to clean up errors so that all consignment is successfully processed. For general tips on processing errors or for issues not in the "Consignment Issues" section, see the frequently asked questions (FAQ) -- See [406390/KB461375].',
      p_success_msg            => 'No unsuccessful consumption transactions were found. Refer to [406390/KB461375].',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: Error_Consignment');



debug('begin add_signature: Unprocessed_Consignment');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1656',
      p_sig_id                 => 'Unprocessed_Consignment',
      p_sig_sql                => 'SELECT a.* 
      FROM mtl_consumption_transactions a, mtl_material_transactions b
     WHERE a.transaction_id = b.transaction_id 
       ...
       AND b.inventory_item_id = NVL(''##$$ITEMID$$##'', b.inventory_item_id)
   ORDER BY a.transaction_id desc',
      p_title                  => 'Unprocessed Consignment',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This section lists unprocessed consumption transactions but where there are no errors yet. These could be recent consumption transactions where the "Create Consumption Process" has not yet been run. The transactions also could have been incorrectly left and need manual review. You can also see the setup section for the Billing Cycle Days. Some customers set the billing cycle to 30, 60, or 90 days so only process consumption after those time periods have elapsed.
',
      p_solution               => 'See [2371665/KB476134] for more information.',
      p_success_msg            => 'No pending, unprocessed consumption transactions were found. Refer to [2371665/KB476134].',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: Unprocessed_Consignment');



debug('begin add_signature: CONSUMPTION TRANSACTION PURCHASE ORDER DATA');
   l_info('##MASK##LAST_UPDATE_LOGIN'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##VENDOR_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11417',
      p_sig_id                 => 'CONSUMPTION TRANSACTION PURCHASE ORDER DATA',
      p_sig_sql                => 'SELECT mct.TRANSACTION_ID, mct.BATCH_ID, mct.PARENT_TRANSACTION_ID, mct.ERROR_CODE, mct.ERROR_EXPLANATION, mct.CONSUMPTION_PROCESSED_FLAG, mct.REQUEST_ID, mct.PO_LINE_ID
, pas.STATUS ASL_Status, pasl.DISABLE_FLAG
, msi.segment1 part_number, mp2.organization_code using_organization_code, mp1.organization_code owning_organization_code
, pv.VENDOR_NAME, pvs.VENDOR_SITE_CODE, pvs.create_debit_memo_flag, pvs.PAY_ON_CODE, pvs.PAY_ON_RECEIPT_SUMMARY_CODE
, pad.document_type_code, poh.segment1 BLANKET_NUMBER, pol.line_num
, poh.approved_flag,  poh.start_date, poh.end_date , poh.frozen_flag, poh.cancel_flag header_cancel_flag, pol.expiration_date line_expiration_date, pol.cancel_flag line_cancel_flag, pol.closed_code line_closed_code 
, poh.blanket_total_amount, pol.QUANTITY_COMMITTED, pol.COMMITTED_AMOUNT, pol.MIN_RELEASE_AMOUNT, pol.amount  
, paa.LAST_BILLING_DATE, paa.CONSIGNED_BILLING_CYCLE 
, poh.po_header_id, pol.po_line_id, pasl.ASL_ID, pasl.ASL_STATUS_ID, pasl.item_id, pasl.USING_ORGANIZATION_ID,  pasl.OWNING_ORGANIZATION_ID 
, pad.sequence_num, pad.document_header_id, pad.document_line_id 
, pasl.VENDOR_BUSINESS_TYPE, paa.VENDOR_ID, paa.VENDOR_SITE_ID, paa.ENABLE_VMI_FLAG, paa.VMI_MIN_QTY, paa.VMI_MAX_QTY, paa.ENABLE_VMI_AUTO_REPLENISH_FLAG, paa.VMI_REPLENISHMENT_APPROVAL, paa.CONSIGNED_FROM_SUPPLIER_FLAG 
, paa.CONSUME_ON_AGING_FLAG, paa.AGING_PERIOD 
, mct.CREATED_BY, mct.CREATION_DATE, mct.LAST_UPDATED_BY, mct.LAST_UPDATE_DATE, mct.LAST_UPDATE_LOGIN 
FROM mtl_consumption_transactions mct, mtl_material_transactions mmt
, po_asl_documents pad, po_headers_all poh, po_lines_all pol 
, mtl_system_items_b msi, mtl_parameters mp1, mtl_parameters mp2, PO_ASL_STATUSES pas
...
WHERE mct.transaction_id = mmt.transaction_id
  ...
  AND mmt.transaction_source_id = pad.document_header_id
  AND poh.po_header_id = pad.document_header_id
  AND pol.po_line_id = NVL(pad.document_line_id, pol.po_line_id)
  ...
  and pasl.owning_ORGANIZATION_ID = mp1.ORGANIZATION_ID
  and pasl.USING_ORGANIZATION_ID = mp2.ORGANIZATION_ID (+) 
  and pasl.ASL_status_id = pas.status_id
  and mmt.organization_id = ##$$ORGID$$## 
  and mmt.inventory_item_id = NVL(''##$$ITEMID$$##'', mmt.inventory_item_id)
ORDER BY mct.transaction_id desc',
      p_title                  => 'Consumption Transaction Purchase Order Data',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This section lists unprocessed consumption transactions with and without errors but includes additional lookup details to the related blanket purchase order, items, and approved supplier list (ASL). These transactions could be errors or recent consumption transactions where the "Create Consumption Process" has not yet been run. 
',
      p_solution               => 'These consumption transactions are in error or have not yet been processed. See [2371665/KB476134] for more information.',
      p_success_msg            => 'No pending, consumption transactions found. Refer to [2371665/KB476134].',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CONSUMPTION TRANSACTION PURCHASE ORDER DATA');



debug('begin add_signature: Consignment_Program');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1654',
      p_sig_id                 => 'Consignment_Program',
      p_sig_sql                => 'SELECT p.CONCURRENT_PROGRAM_NAME, ptl.USER_CONCURRENT_PROGRAM_NAME,
           r.REQUEST_ID, 
     ...
     ORDER BY request_id desc',
      p_title                  => 'Consignment program runs',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Listing of recent consumption program executions. This is a reference to show that you have had past consignment programs run. This is also a helpful reference along with the "Unprocessed Consignment" section to see if the program has run but still left unprocessed records. ',
      p_solution               => 'Review past consignment runs as a reference to see that consumption programs are scheduled and running. You could also see if any of the programs had completed in warning or error. If you see a recent program has run but you still have records in the "Unprocessed Consignment" section, review the program parameters to see if it included all suppliers and review the setup including the billing cycles in the setup section to confirm why records are not processing. See [2371665/KB476134] for more details. ',
      p_success_msg            => 'Consignment runs found. Refer to [2371665/KB476134]. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: Consignment_Program');



debug('begin add_signature: CONSIGNED STOCK ONHAND');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11410',
      p_sig_id                 => 'CONSIGNED STOCK ONHAND',
      p_sig_sql                => 'select moqd.ONHAND_QUANTITIES_ID
, msi.segment1 part_number, mp1.organization_code organization_code
, pv.VENDOR_NAME, pvs.VENDOR_SITE_CODE
, moqd.PRIMARY_TRANSACTION_QUANTITY, moqd.TRANSACTION_UOM_CODE, moqd.TRANSACTION_QUANTITY, moqd.SECONDARY_UOM_CODE, moqd.SECONDARY_TRANSACTION_QUANTITY
, moqd.SUBINVENTORY_CODE, moqd.REVISION, moqd.LOCATOR_ID
, moqd.CREATE_TRANSACTION_ID, moqd.UPDATE_TRANSACTION_ID, moqd.LOT_NUMBER
, moqd.PROJECT_ID, moqd.TASK_ID, moqd.LPN_ID, moqd.STATUS_ID
, moqd.INVENTORY_ITEM_ID, moqd.ORGANIZATION_ID
, moqd.OWNING_ORGANIZATION_ID, moqd.OWNING_TP_TYPE, moqd.PLANNING_ORGANIZATION_ID, moqd.PLANNING_TP_TYPE
, moqd.DATE_RECEIVED, moqd.LAST_UPDATE_DATE, moqd.LAST_UPDATED_BY, moqd.CREATION_DATE, moqd.CREATED_BY, moqd.LAST_UPDATE_LOGIN
from mtl_onhand_quantities_detail moqd 
,mtl_system_items_b msi, mtl_parameters mp1
, po_vendors pv, po_vendor_sites_all pvs 
where moqd.ORGANIZATION_ID != moqd.OWNING_ORGANIZATION_ID
and moqd.IS_CONSIGNED = 1 
and moqd.ORGANIZATION_ID = msi.ORGANIZATION_ID
and moqd.inventory_item_id = msi.inventory_item_id
and moqd.ORGANIZATION_ID = mp1.ORGANIZATION_ID
and moqd.owning_organization_id = pvs.vendor_site_id 
and pvs.vendor_id = pv.vendor_id 
and moqd.organization_id = ##$$ORGID$$## 
and moqd.inventory_item_id = NVL(''##$$ITEMID$$##'', moqd.inventory_item_id)
order by moqd.last_update_date desc',
      p_title                  => 'Consigned Onhand',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Information about consigned onhand quantity. Learn more about consigned quantity and consumption advise in the consignment frequently asked questions (FAQ). ',
      p_solution               => 'No consigned onhand found. Refer to [406390/KB461375] - FAQ: Using Consigned Inventory / Consumption Advice / Vendor Managed Inventory (VMI).',
      p_success_msg            => 'Consigned onhand found. Refer to [406390/KB461375] - FAQ: Using Consigned Inventory / Consumption Advice / Vendor Managed Inventory (VMI).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CONSIGNED STOCK ONHAND');



debug('begin add_signature: CONSIGNED APPROVED SUPPLIER LISTS ASLS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11409',
      p_sig_id                 => 'CONSIGNED APPROVED SUPPLIER LISTS ASLS',
      p_sig_sql                => 'select pasl.ASL_ID, pas.STATUS, pasl.DISABLE_FLAG
, msi.segment1 part_number, mp2.organization_code using_organization_code, mp1.organization_code owning_organization_code
, pv.VENDOR_NAME, pvs.VENDOR_SITE_CODE, pvs.create_debit_memo_flag, pvs.PAY_ON_CODE, pvs.PAY_ON_RECEIPT_SUMMARY_CODE
, pad.document_type_code, poh.segment1 BLANKET_NUMBER, pol.line_num
, poh.approved_flag,  poh.start_date, poh.end_date , poh.frozen_flag, poh.cancel_flag header_cancel_flag, pol.expiration_date line_expiration_date, pol.cancel_flag line_cancel_flag, pol.closed_code line_closed_code
, poh.blanket_total_amount, pol.QUANTITY_COMMITTED, pol.COMMITTED_AMOUNT, pol.MIN_RELEASE_AMOUNT, pol.amount 
, paa.LAST_BILLING_DATE, paa.CONSIGNED_BILLING_CYCLE
, poh.po_header_id, pol.po_line_id
, pasl.ASL_STATUS_ID, pasl.item_id, pasl.USING_ORGANIZATION_ID,  pasl.OWNING_ORGANIZATION_ID
, pad.sequence_num, pad.document_header_id, pad.document_line_id
, pasl.VENDOR_BUSINESS_TYPE, paa.VENDOR_ID, paa.VENDOR_SITE_ID, paa.ENABLE_VMI_FLAG, paa.VMI_MIN_QTY, paa.VMI_MAX_QTY, paa.ENABLE_VMI_AUTO_REPLENISH_FLAG, paa.VMI_REPLENISHMENT_APPROVAL, paa.CONSIGNED_FROM_SUPPLIER_FLAG
, paa.CONSUME_ON_AGING_FLAG, paa.AGING_PERIOD
, pasl.LAST_UPDATE_DATE, pasl.LAST_UPDATED_BY, pasl.CREATION_DATE, pasl.CREATED_BY
From po_asl_attributes paa, PO_APPROVED_SUPPLIER_LIST pasl, PO_ASL_DOCUMENTS pad, po_headers_all poh
, po_lines_all pol, mtl_system_items_b msi, mtl_parameters mp1, mtl_parameters mp2, PO_ASL_STATUSES pas
, po_vendors pv, po_vendor_sites_all pvs 
...
and pad.document_header_id = pol.po_header_id
...
and paa.vendor_id = pv.vendor_id
and paa.vendor_site_id = pvs.vendor_site_id 
and pasl.owning_ORGANIZATION_ID = ##$$ORGID$$## 
AND pasl.item_id = NVL(''##$$ITEMID$$##'', pasl.item_id)
order by pasl.LAST_UPDATE_DATE desc',
      p_title                  => 'Consigned Items Stuck During Ship Confirmation with Error',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Consigned Items getting stuck during ship confirmation. Below error appears in the interface.

There must be a valid blanket purchase agreement in effect for the item you wish to transact',
      p_solution               => 'See solution in [2792749/KB328812]',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: CONSIGNED APPROVED SUPPLIER LISTS ASLS');



debug('begin add_signature: MISSING_DISTRIBUTION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1645',
      p_sig_id                 => 'MISSING_DISTRIBUTION',
      p_sig_sql                => 'SELECT mmt.transaction_id "Transaction ID", 
    ...
    ORDER BY 1,2',
      p_title                  => 'Missing Distribution - Null Distribution ID',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The distribution information should be populated on the consignment record if a release was generated. Missing the value can cause incorrect calculations for invoices and tax.',
      p_solution               => '<ul><li>Review the results in the Transactions section
         for the documents.</li>
      <li>You will need a datafix and root cause patches as outlined in [1503175/KB223929].
         </li>
      <li>The note also contains additional SQL to get a full listing
         of impacted tranactions. See the note for more details.</li></ul>',
      p_success_msg            => 'No rows were found with the missing distribution issue. Refer to [1503175/KB223929].',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MISSING_DISTRIBUTION');



debug('begin add_signature: COMMINGLING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1646',
      p_sig_id                 => 'COMMINGLING',
      p_sig_sql                => 'SELECT  moqd.organization_id "Organization ID", 
	...
	having count(distinct(is_consigned)) > 1',
      p_title                  => 'Commingled Consigned Inventory',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Commingled inventory causes confusion for users who cannot easily transact regular stock that you already own before consigned material that you do not own. The mixing of consigned, supplier stock and regular, owned stock in the same location is sometimes called "Consignment Commingling" or "Commingled Inventory". Commingling causes confusion when using material and seeing unexpected "transfer to regular" or missing "transfer to regular" transactions. As an example, you might receive 1000 Each of Part A into a finished goods subinventory (FGI). You also add 100 Each of the same Part A that you already own. You now have 1100 Each in FGI of which you already own 100. You transfer 100 Each to stage and ship on a sales order. Users are confused when they see a "transfer to regular" for 100 Each of Part A because you already owned 100 of the Part A. The system picked the first available inventory using First-In-First-Out (FIFO) logic so the user actually had issued the supplier stock. This is type of the confusion caused by commingling.',
      p_solution               => 'To walk through steps to remove commingled inventory, see the following document.
Refer to [1346145/KB226275]',
      p_success_msg            => 'No rows were found with the commingled inventory issue. Refer to [1346145/KB226275].',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: COMMINGLING');



debug('begin add_signature: INV_SUP_CONS_NO_BPO_EXISTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1652',
      p_sig_id                 => 'INV_SUP_CONS_NO_BPO_EXISTS',
      p_sig_sql                => 'SELECT a.* 
      FROM mtl_consumption_transactions a, mtl_material_transactions b
     WHERE a.transaction_id = b.transaction_id 
       AND a.consumption_processed_flag  = ''E''
	   ...
	   AND b.inventory_item_id = NVL(''##$$ITEMID$$##'', b.inventory_item_id)
   ORDER BY a.transaction_id desc',
      p_title                  => 'No Blanket Exists (INV_SUP_CONS_NO_BPO_EXISTS)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The error indicates that the consignment process could not locate a valid, active blanket for the transaction.',
      p_solution               => 'Review the following document that details the common reasons and solutions to missing blanket errors. Solutions might include reopening a blanket, extending end dates, or using the profile option "PO: Release Creation Tolerance For Expired Blankets" to extend the blanket dates. Refer to [394123/KB494424#FIX]. ',
      p_success_msg            => 'No rows were found with the missing blanket error. Refer to [394123/KB494424]. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: INV_SUP_CONS_NO_BPO_EXISTS');



debug('begin add_signature: INV_SUP_CONS_AUTO_CREATE_FAIL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1653',
      p_sig_id                 => 'INV_SUP_CONS_AUTO_CREATE_FAIL',
      p_sig_sql                => 'SELECT a.* 
      FROM mtl_consumption_transactions a, mtl_material_transactions b
     WHERE a.transaction_id = b.transaction_id 
       AND a.consumption_processed_flag  = ''E''
	   ...
	   AND b.inventory_item_id = NVL(''##$$ITEMID$$##'', b.inventory_item_id)
   ORDER BY a.transaction_id desc',
      p_title                  => 'Purchasing Autocreate failed (INV_SUP_CONS_AUTO_CREATE_FAIL)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The Purchasing Autocreate process failed. 
This means that the processing of the inventory transaction to create the purchasing documents failed.',
      p_solution               => 'Review the following note that details the common reasons for the issue. Refer to [1326588/KB306902].',
      p_success_msg            => 'No rows were found where the Purchasing Autocreate process failed. Refer to [1326588/KB306902].',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: INV_SUP_CONS_AUTO_CREATE_FAIL');



debug('begin add_signature: CONSIGNED STOCK BUT NO ASL');
   l_info('##MASK##VENDOR_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##VENDOR_SITE_CODE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11408',
      p_sig_id                 => 'CONSIGNED STOCK BUT NO ASL',
      p_sig_sql                => 'select moqd.ONHAND_QUANTITIES_ID
, msi.segment1 part_number, mp1.organization_code organization_code
, pv.VENDOR_NAME, pvs.VENDOR_SITE_CODE
, moqd.PRIMARY_TRANSACTION_QUANTITY, moqd.TRANSACTION_UOM_CODE, moqd.TRANSACTION_QUANTITY, moqd.SECONDARY_UOM_CODE, moqd.SECONDARY_TRANSACTION_QUANTITY
...
and moqd.owning_organization_id = pvs.vendor_site_id 
and pvs.vendor_id = pv.vendor_id 
and not exists (select 1 from PO_APPROVED_SUPPLIER_LIST pasl 
where moqd.ORGANIZATION_ID = pasl.OWNING_ORGANIZATION_ID
and moqd.inventory_item_id = pasl.item_id)
and moqd.organization_id = ##$$ORGID$$## 
and moqd.inventory_item_id = NVL(''##$$ITEMID$$##'', moqd.inventory_item_id)
order by moqd.last_update_date desc',
      p_title                  => 'Consigned Stock But No ASL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Confirm if the consigned material is correct. Often you will setup consignment with Approved Supplier Lists (ASLs) but you can also use Blanket Purchase Agreements (BPA/BPO) with the autosourcing profile "PO: Automatic Document Sourcing". Sometimes consignment onhand is accidentally created. This check is a warning to look for consigned material when there is no approved supplier list (ASL). ',
      p_solution               => 'Be careful with accidentally creating consignment transactions when you are not using consigned inventory. If the consigned stock is valid, you can ignore this message. Refer to [2019008/KB463369] - Not Using Consigned, Still See Stuck Transactions In Transaction Open Interface With Error Ownership Transfer Error.',
      p_success_msg            => 'Consigned stock was not found or consigned stock was found and it relates to an approved supplier list. There is no action required. If you are interested in what this was checking, refer to [2019008/KB463369] - Not Using Consigned, Still See Stuck Transactions In Transaction Open Interface With Error Ownership Transfer Error.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CONSIGNED STOCK BUT NO ASL');



debug('begin add_signature: EBS_MFG_INV_INVCAZ_BATCH_ID_NOT_NULL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31243',
      p_sig_id                 => 'EBS_MFG_INV_INVCAZ_BATCH_ID_NOT_NULL',
      p_sig_sql                => 'SELECT a.* 
      FROM mtl_consumption_transactions a
     WHERE a.consumption_processed_flag  = ''N''
      AND batch_id is not null
       AND a.organization_id =  ##$$ORGID$$##
       AND a.inventory_item_id = NVL(''##$$ITEMID$$##'', a.inventory_item_id)
   ORDER BY a.transaction_id desc',
      p_title                  => 'Unprocessed Consignment Records With Batch ID Populated',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This section lists unprocessed consumption transactions having batch ID populated in the consumption table. These records are not picked even if Create Consumption Advise program is ran. These records need to be reset in order to get picked up. ',
      p_solution               => 'There are unprocessed consumption transactions having batch ID populated in the consumption table. These records are not picked even if Create Consumption Advise program is ran. These records need to be reset. 

See [3004777/KB663641] for more information.',
      p_success_msg            => 'No pending consumption transactions were found with batch ID populated. Refer to [3004777/KB663641].',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVCAZ_BATCH_ID_NOT_NULL');
...
debug('begin add_signature: CONSIGN_PROFILE_INV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1649',
      p_sig_id                 => 'CONSIGN_PROFILE_INV',
      p_sig_sql                => 'select a.profile_option_name, 
	 ...
	 where 
      ...
      p_title                  => 'Profile: INV: Supplier Consigned Enabled',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The Consignment profile option "INV: Supplier Consigned Enabled" for inventory is not enabled',
      p_solution               => 'Review the profile "INV: Supplier Consigned Enabled" and set to Yes. See [2371665/KB476134] for further details.',
      p_success_msg            => 'The Consignment profile option "INV: Supplier Consigned Enabled" for inventory is enabled.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CONSIGN_PROFILE_INV');



debug('begin add_signature: CONSIGN_PROFILE_PO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1650',
      p_sig_id                 => 'CONSIGN_PROFILE_PO',
      p_sig_sql                => 'select a.profile_option_name, 
           b.USER_PROFILE_OPTION_NAME, DECODE(c.PROFILE_OPTION_VALUE, ''Y'', ''Yes'', ''N'', ''No'', c.PROFILE_OPTION_VALUE) "Value"
     from 
        fnd_profile_options a
	 ...
	 where 
        ...
        and c.level_value = g.responsibility_id (+)
        and c.level_value = h.application_id (+)',
      p_title                  => 'Profile: PO: Supplier Consigned Enabled',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The Consignment profile option "PO: Supplier Consigned Enabled" for purchasing is not enabled.',
      p_solution               => 'Review the profile "PO: Supplier Consigned Enabled" and set to Yes. See [2371665/KB476134] for further details.',
      p_success_msg            => 'The Consignment profile option "PO: Supplier Consigned Enabled" for purchasing is enabled.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CONSIGN_PROFILE_PO');



debug('begin add_signature: CONSIGN_PROFILE_AP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1651',
      p_sig_id                 => 'CONSIGN_PROFILE_AP',
      p_sig_sql                => 'select a.profile_option_name, 
           b.USER_PROFILE_OPTION_NAME, DECODE(c.PROFILE_OPTION_VALUE, ''Y'', ''Yes'', ''N'', ''No'', c.PROFILE_OPTION_VALUE) "Value"
     from 
        fnd_profile_options a
	 ...
	 where 
        ...
        and c.level_value = g.responsibility_id (+)
        and c.level_value = h.application_id (+)',
      p_title                  => 'Profile: AP: Supplier Consigned Enabled',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The Consignment profile option "AP: Supplier Consigned Enabled" for payables is not enabled.',
      p_solution               => 'Review the profile "AP: Supplier Consigned Enabled" and set to Yes. See [2371665/KB476134] for more information.',
      p_success_msg            => 'The Consignment profile option "AP: Supplier Consigned Enabled" for payables is enabled.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CONSIGN_PROFILE_AP');



debug('begin add_signature: MULTI_ORG_ENABLED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1648',
      p_sig_id                 => 'MULTI_ORG_ENABLED',
      p_sig_sql                => 'SELECT applications_system_name, nvl(multi_org_flag, ''N'') "Multi-Organization (MOAC) Flag" FROM fnd_product_groups',
      p_title                  => 'Setup: Multi-Organization',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Confirm if the multi-organization setup is enabled.',
      p_solution               => 'This is information only and impacts the need to look at other profiles like the multi-organization and operating unit profiles.',
      p_success_msg            => 'This is information only and impacts the need to look at other profiles like the multi-organization and operating unit profiles.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MULTI_ORG_ENABLED');



debug('begin add_signature: Billing_Cycles');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1647',
      p_sig_id                 => 'Billing_Cycles',
      p_sig_sql                => 'select distinct paa.ASL_ID, paa.last_billing_date, paa.consigned_billing_cycle, paa.VENDOR_ID, paa.VENDOR_SITE_ID, paa.ITEM_ID
     ...
     where paa.last_billing_date IS NOT NULL 
       ...
       and paa.asl_id IN (
              ...
              and mmt.organization_id = ##$$ORGID$$##
              and mmt.inventory_item_id = NVL(''##$$ITEMID$$##'', mmt.inventory_item_id))',
      p_title                  => 'Setup: Billing Cycles',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Confirm if any billing cycles are set to greater than 0.',
      p_solution               => '<ul>
	  ...
	  <li>Refer to [2068566/KB271661]</li>
   </ul>',
      p_success_msg            => 'The billing cycle directly impacts running consumption advise especially when working on errors because a second run might not process rows.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: Billing_Cycles');



debug('begin add_signature: PO AUTOMATIC SOURCING PROFILE CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11413',
      p_sig_id                 => 'PO AUTOMATIC SOURCING PROFILE CHECK',
      p_sig_sql                => 'select a.profile_option_name, 
           b.USER_PROFILE_OPTION_NAME, DECODE(c.PROFILE_OPTION_VALUE, ''Y'', ''Yes'', ''N'', ''No'', c.PROFILE_OPTION_VALUE) "Value"
     from 
        fnd_profile_options a
        ...
        , FND_APPLICATION h
	 where 
            a.profile_option_name = ''PO_AUTO_SOURCE_DOC''
        and c.level_id = 10001 -- Site
	and c.PROFILE_OPTION_VALUE = ''Y'' -- Disabled
        and a.profile_option_name = b.profile_option_name
        and a.profile_option_id = c.profile_option_id
        and a.application_id = c.application_id
        and c.last_updated_by = d.user_id (+)
        ...
        and c.level_value = g.responsibility_id (+)
        and c.level_value = h.application_id (+)',
      p_title                  => 'Profile: PO: Automatic Document Sourcing',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The Purchasing profile option "PO: Automatic Document Sourcing" is enabled. As a result, the Approved Supplier List (ASL) will be ignored when using consigned material and the latest blanket will be selected. Note that the profile is checked at the site level and there could be different settings at other levels like user and responsibility. ',
      p_solution               => 'Review the profile "PO: Automatic Document Sourcing" that is set to Yes. This is a warning only and no actions are required as long as you are aware that the latest blanket will be selected and not necessarily the one that users setup on the approved supplier list (ASL). See [1077739/KB500214] for further details.',
      p_success_msg            => 'The Purchasing profile option "PO: Automatic Document Sourcing" is disabled. This means that the Approved Supplier List (ASL) will be used when selecting blankets for consumption advise and using consigned material. See [1077739/KB500214] for further details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PO AUTOMATIC SOURCING PROFILE CHECK');



debug('begin add_signature: RELEASE CREATION TOLERANCE PROFILE CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11414',
      p_sig_id                 => 'RELEASE CREATION TOLERANCE PROFILE CHECK',
      p_sig_sql                => 'select a.profile_option_name, 
           b.USER_PROFILE_OPTION_NAME, c.PROFILE_OPTION_VALUE "Value in Days"
     from 
        fnd_profile_options a
        , FND_PROFILE_OPTIONS_VL b
        , FND_PROFILE_OPTION_VALUES c
        ...
        , FND_APPLICATION h
	 where 
            a.profile_option_name = ''PO_REL_CREATE_TOLERANCE''
        and c.level_id = 10001 -- Site
	and c.PROFILE_OPTION_VALUE > 0 
        and a.profile_option_name = b.profile_option_name
        and a.profile_option_id = c.profile_option_id
        and a.application_id = c.application_id
        and c.last_updated_by = d.user_id (+)
        ...
        and c.level_value = g.responsibility_id (+)
        and c.level_value = h.application_id (+)',
      p_title                  => 'Profile: PO: Release Tolerance',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The Purchasing profile option "PO: Release Creation Tolerance For Expired Blankets; in Days" is enabled. As a result, closed blanket purchase orders (BPO/BPA) can still be used for consumption advice creation for a number of days even though the blankets are closed.',
      p_solution               => 'Review the Purchasing profile option "PO: Release Creation Tolerance For Expired Blankets; in Days" that is enabled. This is a warning only and no actions are required as long as you are aware that the closed blanket can still be used for consumption advice. See [2375360/KB628278] for further details.',
      p_success_msg            => 'The Purchasing profile option "PO: Release Creation Tolerance For Expired Blankets; in Days" is disabled. The profile either does not exist or is not set. This means that closed blanket cannot be used for consumption advice. See [2375360/KB628278] for further details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: RELEASE CREATION TOLERANCE PROFILE CHECK');



debug('begin add_signature: SUMMARIZE CONSUMPTION PROFILE CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11415',
      p_sig_id                 => 'SUMMARIZE CONSUMPTION PROFILE CHECK',
      p_sig_sql                => 'select a.profile_option_name, 
           b.USER_PROFILE_OPTION_NAME, DECODE(c.PROFILE_OPTION_VALUE, ''Y'', ''Yes'', ''N'', ''No'', c.PROFILE_OPTION_VALUE) "Value"
     from 
        fnd_profile_options a
        ...
        , FND_APPLICATION h
	 where 
            a.profile_option_name = ''INV_SUPPLIER_CONSIGNED_GROUPING''
        and c.level_id = 10001 -- Site
	and c.PROFILE_OPTION_VALUE = ''Y'' -- Enabled - If not found, then N or NULL
        and a.profile_option_name = b.profile_option_name
        and a.profile_option_id = c.profile_option_id
        and a.application_id = c.application_id
        and c.last_updated_by = d.user_id (+)
        ...
        and c.level_value = g.responsibility_id (+)
        and c.level_value = h.application_id (+)',
      p_title                  => 'Profile: INV: Summarize Consumption',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The Inventory profile option "INV: Summarize consumption releases by Need By Date" is either not set or set to No. The profile controls how consumption transactions are grouped. If the profile is set to No or not set, all the consumption transactions for a particular item will be grouped into a single shipment. The default value for this profile is ''No'' or NULL. The profile option is applicable ONLY for local blankets. For global blankets, irrespective of the value of this profile, a single shipment will be created for each day for an item. Note that the profile is checked at the site level and there could be different settings at other levels like user and responsibility. ',
      p_solution               => 'Review the Inventory profile option "INV: Summarize consumption releases by Need By Date". This is a warning only and no actions are required as long as you are aware that the consumption advices will not be grouped together. If this profile option is set to ''Yes'', a shipment line will be created for an item based on the consumption date. If set to ''No'' (or NULL), all the consumption transactions for a particular item will be grouped into a single shipment. See [414581/KB402216] for further details.',
      p_success_msg            => 'The Inventory profile option "INV: Summarize consumption releases by Need By Date" is enabled and set to Yes at the site level. If this profile option is set to ''Yes'', a shipment line will be created for an item based on the consumption date. If set to ''No'' (or NULL), all the consumption transactions for a particular item will be grouped into a single shipment. See [414581/KB402216] for further details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SUMMARIZE CONSUMPTION PROFILE CHECK');
...
BEGIN
  ...
  analyzer_title := 'Inventory Consignment Analyzer';
...
start_section('Proactive Recommendations', 'ProactiveRecommendations');
   set_item_result(check_rec_patches_1); /* Signature INV_CON_CHECK_REC */
   set_item_result(check_rec_patches_2); /* Signature INV_RUP_CHECK */
   set_item_result(run_stored_sig('INV_RUP_CHECK2_SQL_AD_BUGS'));
   set_item_result(run_stored_sig('CONSIGNMENT_KEY_INVALIDS'));
   set_item_result(run_stored_sig('CONSIGNMENT_INVALID'));
   set_item_result(run_stored_sig('CONSIGN_KEY_FILE_VERSIONS'));
end_section;
debug('end section: ProactiveRecommendations');

debug('begin section: ConsignmentOverview');
start_section('Consignment Overview', 'ConsignmentOverview');
   ...
   set_item_result(run_stored_sig('CONSUMPTION TRANSACTION PURCHASE ORDER DATA'));
   set_item_result(run_stored_sig('Consignment_Program'));
   set_item_result(run_stored_sig('CONSIGNED STOCK ONHAND'));
   set_item_result(run_stored_sig('CONSIGNED APPROVED SUPPLIER LISTS ASLS'));
end_section;
debug('end section: ConsignmentOverview');

debug('begin section: ConsignmentIssues');
start_section('Consignment Issues', 'ConsignmentIssues');
   ...
   set_item_result(run_stored_sig('CONSIGNED STOCK BUT NO ASL'));
   set_item_result(run_stored_sig('EBS_MFG_INV_INVCAZ_BATCH_ID_NOT_NULL'));
end_section;
debug('end section: ConsignmentIssues');
...
start_section('Setup', 'Setup');
   ...
   set_item_result(run_stored_sig('PO AUTOMATIC SOURCING PROFILE CHECK'));
   set_item_result(run_stored_sig('RELEASE CREATION TOLERANCE PROFILE CHECK'));
   set_item_result(run_stored_sig('SUMMARIZE CONSUMPTION PROFILE CHECK'));
end_section;
