...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Inventory Item Analyzer                |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE inv_item_analyzer_pkg AUTHID DEFINER AS
...
END inv_item_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY inv_item_analyzer_pkg AS
-- $Id: inventory_item_analyzer.sql, 200.31 2026/02/23 18:12:51 srayadur Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2047671.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'INVITMANALYZER_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'INVITMANALYZER_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>INVITMANALYZER Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2047671.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/inv_item_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,624,EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,624,EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},624,EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4061984" class="blacklink" target="new">
...
<div class="ck-content"><div><p>We’re listening to your feedback and made the following changes:</p><p>Version 200.31 23-FEB-2026</p><ul><li>Signature updates</li>
</ul>
<p>&nbsp;</p><p>Version 200.30 29-JAN-2026</p><ul><li>Updated link format</li>
</ul>
<p>&nbsp;</p><p>Version 200.29 05-DEC-2025</p><ul><li>Added signature ‘<strong>Forms Personalization Warning</strong>’</li>
</ul>
<p>&nbsp;</p><p>Version 200.28 18-AUG-2025</p><ul><li>Added signature ‘Key Current Warehouse Parameters’</li>
<li>Added signature ‘<span class="display_only apex-item-display-only" id="P18_TITLE_DISPLAY" data-escape="true">Item Records Missing in MTL_SYSTEM_ITEMS_TL</span>’</li>
<li>Added signature ‘<span class="display_only apex-item-display-only" id="P18_TITLE_DISPLAY" data-escape="true">BOM Delete Errors</span>’</li>
<li>Signature updates</li>
</ul>
<p>&nbsp;</p><p>Version 200.27 04-MAR-2025</p><ul><li>Signature updates</li>
<li>Framework updates</li>
</ul>
<p>&nbsp;</p><p>Version 200.26 27-NOV-2024</p><ul><li>Added signature ‘<span class="display_only apex-item-display-only" data-escape="true" id="P18_TITLE_DISPLAY">Related Items Details’</span></li>
<li>Added signature ‘<span class="display_only apex-item-display-only" data-escape="true" id="P18_TITLE_DISPLAY">Item Records Missing in MTL_SYSTEM_ITEMS_TL’</span></li>
</ul>
<p>&nbsp;</p><p>Version 200.25 26-SEP-2024</p><ul><li>Signature updates</li>
</ul>
<p>&nbsp;</p><p>Version 200.24 17-JUL-2024</p><ul><li>Added signature &apos;<span class="display_only apex-item-display-only" id="P18_TITLE_DISPLAY">Missing Child Category Assignments For Master Controlled Category Sets&apos;</span></li>
<li><span class="display_only apex-item-display-only">Added signature &apos;</span><span class="display_only apex-item-display-only" id="P18_TITLE_DISPLAY">Virtual Private Database Policies&apos;</span></li>
<li><span class="display_only apex-item-display-only">Added signature &apos;</span><span class="display_only apex-item-display-only" id="P18_TITLE_DISPLAY">Master Child Attribute Conflict While Doing Item Import&apos;</span></li>
</ul>
<p>&nbsp;</p><p>Version 200.23 10-APR-2024</p><p>&nbsp; &nbsp; Rename “Lifetime Support Policy” with “Critical Alerts”<br>
&nbsp; &nbsp; Add 2 signatures</p><p>&nbsp; &nbsp; EBS_ATG_UGLE_32BIT_SEQUENCES_CLOSE_TO_MAX<br>
&nbsp; &nbsp; EBS_ATG_UGLE_SEQUENCES_CLOSE_TO_MAXIMUM_VALUE</p><p>&nbsp;</p><p>Version 200.22 26-JAN-2024</p><ul><li>Added signature ‘Supply Referencing Non-Existent POs / Requisitions / Shipments’</li>
</ul>
<p>&nbsp;</p><p>Version 200.21 30-OCT-2023</p><ul><li>Added signature ‘DFF Definition Not Frozen’</li>
</ul>
<p>Version 200.20 August 2023</p><ul><li>Added signature ‘Duplicate Item Number/Description in Table MTL_SYSTEM_ITEMS_B’</li>
<li>Framework update</li>
</ul>
<p>&nbsp;</p><p>Version 200.19 July 2023</p><ul><li>Added signature ‘Mismatch of Lot Control Code and Shelf Life Control&apos;</li>
<li>Added signature ‘Flexfield Separator Within Item Number’</li>
<li>Signature updates</li>
</ul>
<p>&nbsp;</p><p>Version 200.17 March 2023</p><ul><li>Added Signature &apos;Item Can Not Be Queried in the Primary or Organization Items Form&apos;</li>
<li>Added Signature &apos;Duplicate Category Names&apos;</li>
</ul>
<p>&nbsp;</p><p>Version 200.16 December 2022</p><ul><li>Signature updates</li>
<li>Framework update</li>
</ul>
<p>&nbsp;</p><p>Version 200.15 August 2022</p><ul><li>New signature &apos;Invalid "N" Value for LOT_SUBSTITUTION_ENABLED or PLANNED_INV_POINT_FLAG&apos;</li>
</ul>
<p>&nbsp;</p><p>Version 200.14 January 2022</p><ul><li>Updated Lifetime Support policy</li>
<li>New signature checking for leading/trailing spaces from Items form.</li>
</ul>
<p><u>Version 200.12 October 2021:</u></p><ul><li>Analyzer Framework update</li>
</ul>
<p><u>Version 200.11 May 2021:</u></p><ul><li>Included new signature</li>
</ul>
<p><u>Version 200.10 April 2021:</u></p><ul><li>updated framework</li>
<li>improved performance of signatures</li>
</ul>
<p>&nbsp;</p><p><u>Version 200.9&nbsp;May&nbsp;2020:</u></p><ul><li>Created New Section -- Unit of Measure Details. This captures all UOM related data for the item and its conversions.</li>
<li>A new validation signature to check if any Item Attributes are Null - based on Doc ID 1959547.1 (Applicable in 12.1 and 12.2).</li>
<li>A new validation signature to check Shippable Attribute values based on Internal Order Flag - based on Doc ID 1676349.1.</li>
<li>Appscheck is now an Optional parameter.</li>
<li>Modified few existing signatures with latest patch details and missing conditions.</li>
</ul>
<p><u>Version 200.7 November 2019:</u></p><ul><li>The analyzer is now executed as a Package instead of an Anonymous Block. Please see the analyzer Doc ID 2047671.1 for running the analyzer as a Concurrent Request or in Sql*Plus.</li>
<li>New Analyzer Framework 4.4.4.</li>
</ul>
<p><u>Version 200.6 August 2019:</u></p><ul><li>Framework update to 4.4.3</li>
</ul>
<p><u>Version 200.3 and 200.4 July 2019:</u></p><p>The Data Masking feature has been expanded.&nbsp;&nbsp; &nbsp;</p><ul><li>Select data is now pre-masked at the point of collection.</li>
<li>The masked information displayed will be just enough to permit effective review and troubleshooting of an issue.</li>
</ul>
<p style="margin-left:40px;">Examples:<br>
-A credit card number would be displayed as ****-****-****-1234<br>
-An employee name would be displayed as Display first and last 25% per word (J**n S**w = John Snow)</p><ul><li>The existing “Lock Icon” still provides customers the manual column scrambling capabilities, which can be used in addition to the newly introduced pre-masked data feature.</li>
</ul>
<p><u>Version 200.2 June 2019:</u></p></div>
...
<p><u>Version 200.1 September 2017:</u></p><ul><li>Initial Release - The EBS Inventory Item Analyzer provides information on Inventory Item Set-up, Item Onhand Quantity, Pending Transactions related to the Item, and Solutions to known Inventory Item Issues.</li>
</ul>
</div>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,624,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,624,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},624,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
FUNCTION check_rec_patches_1 RETURN VARCHAR2 IS
  /* Signature INV_ITM_RECOMMENDED_PATCHES */
...
BEGIN
    ...
    print_log('Processing recommended patches signature: INV_ITM_RECOMMENDED_PATCHES (check_rec_patches_1) "Recommended Patches" (version 12)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21610837';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'ITEMS RECOMMENDED PATCH COLLECTION ( Aug 2015)';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26399295';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Inventory Consolidated RUP17 (VERSION 12.1.3 [RELEASE 12.1])';
   l_col_rows(5)(l_rows) := '[2283688/KB572861]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '17795054';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'PIM 12.1.3.3 RUP CONSOLIDATION';
   l_col_rows(5)(l_rows) := NULL;
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.0' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '8445429';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12 RUP7 PIM PATCHSET';
   l_col_rows(5)(l_rows) := NULL;
...
IF substr(g_rep_info('Apps Version'),1,7) = '11.5.10' THEN
   l_rel := '11i';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Inventory and Receiving (PO): Release 11.5.10, Rollup Patch 23';
   l_col_rows(5)(l_rows) := '[1281697/KB348029]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '10098682';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'ROLLUP PATCH : 11I.PLM_PF.E:CUMULATIVE ROLLUP PATCH E22';
   l_col_rows(5)(l_rows) := NULL;
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(5)(l_rows) := '[2495038/KB203487]';

END IF;

   l_extra_info('##SHOW_SQL##'):= 'Y';

   l_sig.sigrepo_id := '5033';
   l_sig.title := 'Recommended Patches';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := 'This signature contains list of recommended patches for Items';
...
Above are the recommended patches for this product area as of May 15 2017. For the most current recommendations, use the Patch Wizard or the Updates & Patches Tab in My Oracle Support. Further guidance can be found in the following documents:<br>
...
';
  ...
  -- Register
  l_step := '60';
  g_signatures('INV_ITM_RECOMMENDED_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'INV_ITM_RECOMMENDED_PATCHES',     -- sig ID
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Organization Code (not organization_id)';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_org_code,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Item (not inventory_item_id)';
...
-- Revision and date values can be populated by RCS
  l_revision := rtrim(replace('$Revision: 200.31  $','$',''));
  l_revision := ltrim(replace(l_revision,'Revision:',''));
  l_date_char := rtrim(replace('$Date: 2026/02/23 18:12:50 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'inventory_item_analyzer.sql';
...
IF p_org_code IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Organization Code (not organization_id) is required.');
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Organization Code specified is not valid. Please enter correct Organization Code.');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
IF p_item_num IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Item (not inventory_item_id) is required.');
   raise invalid_parameters;
END IF;
...
IF p_include_apps_check IS NOT NULL AND p_include_apps_check NOT IN ( 'N','Y') THEN
   print_error('INVALID ARGUMENT: Include Apps Check Information is invalid.  Valid values are Y or N.');
   raise invalid_parameters;
END IF;
...
IF p_item_num is not null THEN
   BEGIN
     ...
     EXCEPTION WHEN NO_DATA_FOUND THEN
       print_error('No Item exists for values '||to_char(p_item_num)||'/'||to_char(p_org_code));
       raise invalid_parameters;
     WHEN TOO_MANY_ROWS THEN
       print_error('This item '||to_char(p_item_num)||'is duplicate in this organization'||to_char(p_org_code));
       raise invalid_parameters;   
   END;
END IF;
...
debug('begin add_signature: INV_EGO_INVALIDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5034',
      p_sig_id                 => 'INV_EGO_INVALIDS',
      p_sig_sql                => 'select d.owner, d.object_name, d.object_type, d.status
from dba_objects d
where d.status = ''INVALID''
and (d.object_name like ''INV%'' or d.object_name like ''EGO%''or d.object_name like ''MTL%'')',
      p_title                  => 'Inventory Item Related Invalid Objects',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Check for Invalids in INV and EGO schema',
      p_solution               => '<ul>
The invalid objects are listed for information only. They may not impact your task, but it is advisable to review and address them as follows:<br>
...
<li>If you still have invalid objects, please review steps from [1527251/KB724238] Troubleshooting Guide - Invalid Objects in the E-Business Suite Environment 11i and 12.</li>
</ul>',
      p_success_msg            => 'Nice Work!!
There are no Invalid INV/EGO Objects found on your instance.',
   ...
   l_info.delete;
debug('end add_signature: INV_EGO_INVALIDS');



debug('begin add_signature: EBS_MFG_INV_INVITMANALYZER_ROW_MOVE_ENABLED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26197',
      p_sig_id                 => 'EBS_MFG_INV_INVITMANALYZER_ROW_MOVE_ENABLED',
      p_sig_sql                => '  select *
  from dba_tables
  where  table_name like ''MTL%'' and ROW_MOVEMENT = ''ENABLED''',
      p_title                  => 'MTL Tables With Row Movement Enabled',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Row movement enabled on few tables, This may cause issues during Item Import.',
      p_solution               => 'Review [2881696/KB388922] : Error INVPAGI2.assign_item_header_recs: ORA-08006: specified row no longer exists When Running Import Item Program (INCOIN) To Create Or Assign Items To Organizations ',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVITMANALYZER_ROW_MOVE_ENABLED');
...
debug('begin add_signature: FORMS_PERSONALIZATIONS2_WARNING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11494',
      p_sig_id                 => 'FORMS_PERSONALIZATIONS2_WARNING',
...
and func1.application_id = ''##$$APPS_PARAM1$$##''
...
If the issue is not occurring after performing above action plan, then it seems a personalization is the cause of the problem. Refer to [2381259/KB211818] for more details.',
      p_success_msg            => 'No forms personalizations detected on the related application''s forms. Refer to [2381259/KB211818] for more details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: FORMS_PERSONALIZATIONS2_WARNING');



debug('begin add_signature: EBS_MFG_INV_OPHANLY_ITEM_STATUS_HISTORY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29381',
      p_sig_id                 => 'EBS_MFG_INV_OPHANLY_ITEM_STATUS_HISTORY',
...
and inventory_item_id = ##$$ITEMID$$##',
      p_title                  => 'Item Status Update History',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Item has status changes',
      p_solution               => 'If item is attached to a lifecycle in Product Hub (lifecycle_id column), its status may not be changed in the Items form or in the item overview page.
Please review [2502009/KB207796] for more details.',
      p_success_msg            => 'There are no item status changes.  See [2502009/KB207796] for more details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_OPHANLY_ITEM_STATUS_HISTORY');



debug('begin add_signature: ITEM_MTL_SYSTEM_ITEMS_B');
   l_info('##MASK##PLANNER_CODE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6245',
      p_sig_id                 => 'ITEM_MTL_SYSTEM_ITEMS_B',
      p_sig_sql                => 'SELECT *
/* INVENTORY_ITEM_ID,      
ORGANIZATION_ID, LAST_UPDATE_DATE, LAST_UPDATED_BY,      
LAST_UPDATE_LOGIN, SUMMARY_FLAG, ENABLED_FLAG,      
START_DATE_ACTIVE, END_DATE_ACTIVE, DESCRIPTION,      
BUYER_ID, ACCOUNTING_RULE_ID, INVOICING_RULE_ID,      
SEGMENT1, SEGMENT2, SEGMENT3,      
SEGMENT4, SEGMENT5, SEGMENT19,      
SEGMENT20, ATTRIBUTE_CATEGORY, ATTRIBUTE1,      
ATTRIBUTE2, ATTRIBUTE3, ATTRIBUTE4,      
ATTRIBUTE5, PURCHASING_ITEM_FLAG, SHIPPABLE_ITEM_FLAG,      
CUSTOMER_ORDER_FLAG, INTERNAL_ORDER_FLAG, SERVICE_ITEM_FLAG,      
INVENTORY_ITEM_FLAG, ENG_ITEM_FLAG, INVENTORY_ASSET_FLAG,      
PURCHASING_ENABLED_FLAG, CUSTOMER_ORDER_ENABLED_FLAG, INTERNAL_ORDER_ENABLED_FLAG,      
SO_TRANSACTIONS_FLAG, MTL_TRANSACTIONS_ENABLED_FLAG, STOCK_ENABLED_FLAG,      
BOM_ENABLED_FLAG, BUILD_IN_WIP_FLAG, REVISION_QTY_CONTROL_CODE,      
ITEM_CATALOG_GROUP_ID, CATALOG_STATUS_FLAG, RETURNABLE_FLAG,      
DEFAULT_SHIPPING_ORG, COLLATERAL_FLAG, TAXABLE_FLAG,      
QTY_RCV_EXCEPTION_CODE, ALLOW_ITEM_DESC_UPDATE_FLAG, INSPECTION_REQUIRED_FLAG,      
RECEIPT_REQUIRED_FLAG, MARKET_PRICE, HAZARD_CLASS_ID,      
RFQ_REQUIRED_FLAG, QTY_RCV_TOLERANCE, LIST_PRICE_PER_UNIT,      
UN_NUMBER_ID, PRICE_TOLERANCE_PERCENT, ASSET_CATEGORY_ID,      
ROUNDING_FACTOR, UNIT_OF_ISSUE, ENFORCE_SHIP_TO_LOCATION_CODE,      
ALLOW_SUBSTITUTE_RECEIPTS_FLAG, ALLOW_UNORDERED_RECEIPTS_FLAG, ALLOW_EXPRESS_DELIVERY_FLAG,      
DAYS_EARLY_RECEIPT_ALLOWED, DAYS_LATE_RECEIPT_ALLOWED, RECEIPT_DAYS_EXCEPTION_CODE,      
...
SOURCE_ORGANIZATION_ID, SOURCE_SUBINVENTORY, EXPENSE_ACCOUNT,      
ENCUMBRANCE_ACCOUNT, RESTRICT_SUBINVENTORIES_CODE,      
UNIT_WEIGHT, WEIGHT_UOM_CODE, VOLUME_UOM_CODE,      
UNIT_VOLUME, RESTRICT_LOCATORS_CODE, LOCATION_CONTROL_CODE,      
SHRINKAGE_RATE, ACCEPTABLE_EARLY_DAYS, PLANNING_TIME_FENCE_CODE,      
DEMAND_TIME_FENCE_CODE, LEAD_TIME_LOT_SIZE, STD_LOT_SIZE,      
CUM_MANUFACTURING_LEAD_TIME, OVERRUN_PERCENTAGE, MRP_CALCULATE_ATP_FLAG,      
ACCEPTABLE_RATE_INCREASE, ACCEPTABLE_RATE_DECREASE, CUMULATIVE_TOTAL_LEAD_TIME,      
PLANNING_TIME_FENCE_DAYS, DEMAND_TIME_FENCE_DAYS, END_ASSEMBLY_PEGGING_FLAG,      
REPETITIVE_PLANNING_FLAG, PLANNING_EXCEPTION_SET, BOM_ITEM_TYPE,      
PICK_COMPONENTS_FLAG, REPLENISH_TO_ORDER_FLAG, BASE_ITEM_ID,      
ATP_COMPONENTS_FLAG, ATP_FLAG, FIXED_LEAD_TIME,      
VARIABLE_LEAD_TIME, WIP_SUPPLY_LOCATOR_ID, WIP_SUPPLY_TYPE,      
WIP_SUPPLY_SUBINVENTORY, PRIMARY_UOM_CODE, PRIMARY_UNIT_OF_MEASURE,      
ALLOWED_UNITS_LOOKUP_CODE, COST_OF_SALES_ACCOUNT, SALES_ACCOUNT,      
DEFAULT_INCLUDE_IN_ROLLUP_FLAG, INVENTORY_ITEM_STATUS_CODE, INVENTORY_PLANNING_CODE,      
PLANNER_CODE, PLANNING_MAKE_BUY_CODE, FIXED_LOT_MULTIPLIER,      
ROUNDING_CONTROL_TYPE, CARRYING_COST, POSTPROCESSING_LEAD_TIME,      
PREPROCESSING_LEAD_TIME, FULL_LEAD_TIME, ORDER_COST,      
MRP_SAFETY_STOCK_PERCENT, MRP_SAFETY_STOCK_CODE, MIN_MINMAX_QUANTITY,      
MAX_MINMAX_QUANTITY, MINIMUM_ORDER_QUANTITY, FIXED_ORDER_QUANTITY,      
FIXED_DAYS_SUPPLY, MAXIMUM_ORDER_QUANTITY, ATP_RULE_ID,      
PICKING_RULE_ID, RESERVABLE_TYPE, POSITIVE_MEASUREMENT_ERROR,      
NEGATIVE_MEASUREMENT_ERROR, ENGINEERING_ECN_CODE, ENGINEERING_ITEM_ID,      
...
TIME_BILLABLE_FLAG, MATERIAL_BILLABLE_FLAG, EXPENSE_BILLABLE_FLAG,      
PRORATE_SERVICE_FLAG, COVERAGE_SCHEDULE_ID, SERVICE_DURATION_PERIOD_CODE,      
SERVICE_DURATION, WARRANTY_VENDOR_ID, MAX_WARRANTY_AMOUNT,      
RESPONSE_TIME_PERIOD_CODE, RESPONSE_TIME_VALUE, NEW_REVISION_CODE,      
INVOICEABLE_ITEM_FLAG, TAX_CODE, INVOICE_ENABLED_FLAG,      
MUST_USE_APPROVED_VENDOR_FLAG, REQUEST_ID, PROGRAM_APPLICATION_ID,      
PROGRAM_ID, PROGRAM_UPDATE_DATE, OUTSIDE_OPERATION_FLAG,      
OUTSIDE_OPERATION_UOM_TYPE, SAFETY_STOCK_BUCKET_DAYS, AUTO_REDUCE_MPS,      
COSTING_ENABLED_FLAG, AUTO_CREATED_CONFIG_FLAG, CYCLE_COUNT_ENABLED_FLAG,      
...
RELEASE_TIME_FENCE_CODE, RELEASE_TIME_FENCE_DAYS, CONTAINER_ITEM_FLAG,      
VEHICLE_ITEM_FLAG, MAXIMUM_LOAD_WEIGHT, MINIMUM_FILL_PERCENT,      
CONTAINER_TYPE_CODE, INTERNAL_VOLUME, WH_UPDATE_DATE,      
PRODUCT_FAMILY_ITEM_ID, GLOBAL_ATTRIBUTE_CATEGORY, GLOBAL_ATTRIBUTE1,      
GLOBAL_ATTRIBUTE2, GLOBAL_ATTRIBUTE3, GLOBAL_ATTRIBUTE4,      
GLOBAL_ATTRIBUTE5, PURCHASING_TAX_CODE, OVERCOMPLETION_TOLERANCE_TYPE,      
OVERCOMPLETION_TOLERANCE_VALUE, EFFECTIVITY_CONTROL, CHECK_SHORTAGES_FLAG,      
OVER_SHIPMENT_TOLERANCE, UNDER_SHIPMENT_TOLERANCE, OVER_RETURN_TOLERANCE,      
UNDER_RETURN_TOLERANCE, EQUIPMENT_TYPE, RECOVERED_PART_DISP_CODE,      
DEFECT_TRACKING_ON_FLAG, USAGE_ITEM_FLAG, EVENT_FLAG,      
ELECTRONIC_FLAG, DOWNLOADABLE_FLAG, VOL_DISCOUNT_EXEMPT_FLAG,      
COUPON_EXEMPT_FLAG, COMMS_NL_TRACKABLE_FLAG, ASSET_CREATION_CODE,      
COMMS_ACTIVATION_REQD_FLAG, ORDERABLE_ON_WEB_FLAG,      
BACK_ORDERABLE_FLAG, WEB_STATUS, INDIVISIBLE_FLAG,      
DIMENSION_UOM_CODE, UNIT_LENGTH, UNIT_WIDTH,      
UNIT_HEIGHT, BULK_PICKED_FLAG, LOT_STATUS_ENABLED,      
DEFAULT_LOT_STATUS_ID, SERIAL_STATUS_ENABLED, DEFAULT_SERIAL_STATUS_ID,      
LOT_SPLIT_ENABLED, LOT_MERGE_ENABLED, INVENTORY_CARRY_PENALTY,      
OPERATION_SLACK_PENALTY, FINANCING_ALLOWED_FLAG, EAM_ITEM_TYPE,      
EAM_ACTIVITY_TYPE_CODE, EAM_ACTIVITY_CAUSE_CODE,  EAM_ACT_NOTIFICATION_FLAG,      
EAM_ACT_SHUTDOWN_STATUS, DUAL_UOM_CONTROL, SECONDARY_UOM_CODE,      
DUAL_UOM_DEVIATION_HIGH, DUAL_UOM_DEVIATION_LOW, CONTRACT_ITEM_TYPE_CODE,      
SUBSCRIPTION_DEPEND_FLAG, SERV_REQ_ENABLED_CODE, SERV_BILLING_ENABLED_FLAG,      
SERV_IMPORTANCE_LEVEL, PLANNED_INV_POINT_FLAG, LOT_TRANSLATE_ENABLED,      
DEFAULT_SO_SOURCE_TYPE, CREATE_SUPPLY_FLAG, SUBSTITUTION_WINDOW_CODE,      
SUBSTITUTION_WINDOW_DAYS, IB_ITEM_INSTANCE_CLASS, CONFIG_MODEL_TYPE,      
LOT_SUBSTITUTION_ENABLED, MINIMUM_LICENSE_QUANTITY, EAM_ACTIVITY_SOURCE_CODE,      
LIFECYCLE_ID, CURRENT_PHASE_ID, OBJECT_VERSION_NUMBER,      
TRACKING_QUANTITY_IND, ONT_PRICING_QTY_SOURCE, SECONDARY_DEFAULT_IND,      
OPTION_SPECIFIC_SOURCED, APPROVAL_STATUS, VMI_MINIMUM_UNITS,      
VMI_MINIMUM_DAYS, VMI_MAXIMUM_UNITS, VMI_MAXIMUM_DAYS,      
VMI_FIXED_ORDER_QUANTITY, SO_AUTHORIZATION_FLAG, CONSIGNED_FLAG,      
ASN_AUTOEXPIRE_FLAG, VMI_FORECAST_TYPE, FORECAST_HORIZON,      
EXCLUDE_FROM_BUDGET_FLAG, DAYS_TGT_INV_SUPPLY, DAYS_TGT_INV_WINDOW,      
DAYS_MAX_INV_SUPPLY, DAYS_MAX_INV_WINDOW, DRP_PLANNED_FLAG,      
CRITICAL_COMPONENT_FLAG, CONTINOUS_TRANSFER, CONVERGENCE,      
DIVERGENCE, CONFIG_ORGS, CONFIG_MATCH,      
CAS_NUMBER, CHILD_LOT_FLAG, CHILD_LOT_PREFIX,      
CHILD_LOT_STARTING_NUMBER, CHILD_LOT_VALIDATION_FLAG, COPY_LOT_ATTRIBUTE_FLAG,      
DEFAULT_GRADE, EXPIRATION_ACTION_CODE, EXPIRATION_ACTION_INTERVAL,      
GRADE_CONTROL_FLAG, HAZARDOUS_MATERIAL_FLAG, HOLD_DAYS,      
LOT_DIVISIBLE_FLAG, MATURITY_DAYS, PARENT_CHILD_GENERATION_FLAG,      
PROCESS_COSTING_ENABLED_FLAG, PROCESS_EXECUTION_ENABLED_FLAG, PROCESS_QUALITY_ENABLED_FLAG,      
PROCESS_SUPPLY_LOCATOR_ID, PROCESS_SUPPLY_SUBINVENTORY, PROCESS_YIELD_LOCATOR_ID,      
PROCESS_YIELD_SUBINVENTORY, RECIPE_ENABLED_FLAG, RETEST_INTERVAL,      
CHARGE_PERIODICITY_CODE, REPAIR_LEADTIME, REPAIR_YIELD,      
PREPOSITION_POINT, REPAIR_PROGRAM, SUBCONTRACTING_COMPONENT,      
OUTSOURCED_ASSEMBLY, EGO_MASTER_ITEMS_DFF_CTX, GDSN_OUTBOUND_ENABLED_FLAG,      
TRADE_ITEM_DESCRIPTOR, STYLE_ITEM_ID, STYLE_ITEM_FLAG,      
LAST_SUBMITTED_NIR_ID, DEFAULT_MATERIAL_STATUS_ID, SERIAL_TAGGING_FLAG */
FROM MTL_SYSTEM_ITEMS_B
WHERE INVENTORY_ITEM_ID = ##$$ITEMID$$##',
      p_title                  => 'Item Attribute Details from MTL_SYSTEM_ITEMS_B',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Output of MTL_SYSTEM_ITEMS_B for all organizations.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_MTL_SYSTEM_ITEMS_B');



debug('begin add_signature: ITEM_MTL_SYSTEM_ITEMS_TL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6246',
      p_sig_id                 => 'ITEM_MTL_SYSTEM_ITEMS_TL',
      p_sig_sql                => 'SELECT INVENTORY_ITEM_ID,      
ORGANIZATION_ID, LANGUAGE, SOURCE_LANG,      
DESCRIPTION, LAST_UPDATE_DATE, LAST_UPDATED_BY,      
CREATION_DATE, CREATED_BY, LAST_UPDATE_LOGIN,      
LONG_DESCRIPTION
FROM MTL_SYSTEM_ITEMS_TL 
WHERE INVENTORY_ITEM_ID = ##$$ITEMID$$##',
      p_title                  => 'Item Attribute Details from MTL_SYSTEM_ITEMS_TL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Output of MTL_SYSTEM_ITEMS_TL in all organizations for all languages.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_MTL_SYSTEM_ITEMS_TL');



debug('begin add_signature: EBS_MFG_INV_INVTAZ_ITEMS_KFF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25309',
      p_sig_id                 => 'EBS_MFG_INV_INVTAZ_ITEMS_KFF',
      p_sig_sql                => 'SELECT 
...
WHERE
    ...
    AND ( fifs.id_flex_code = ''MSTK'' ) -- MSTK : Items
ORDER BY
    fifs.id_flex_structure_code,
    to_number(seg.segment_num),
    seg.application_column_name',
      p_title                  => 'Item Key Flexfield',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This is reference data for item key flexfield structure including details like the frozen flag, segment names, value sets, required flag, and format.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVTAZ_ITEMS_KFF');



debug('begin add_signature: EBS_MFG_INV_INVTAZ_LOCATOR_KFF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25310',
      p_sig_id                 => 'EBS_MFG_INV_INVTAZ_LOCATOR_KFF',
      p_sig_sql                => 'SELECT 
    fifs.id_flex_structure_code,
    fifs.freeze_flex_definition_flag,
    fifs.enabled_flag,
...
WHERE
    ...
    AND seg.id_flex_code (+) = fifs.id_flex_code
    AND seg.id_flex_num (+) = fifs.id_flex_num
    AND ( fifs.id_flex_code = ''MTLL'' ) -- MTLL: Locators
ORDER BY
    fifs.id_flex_structure_code,
    to_number(seg.segment_num),
    seg.application_column_name',
      p_title                  => 'Locator Key Flexfield',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This is reference data for locator key flexfield structure including details like the frozen flag, segment names, value sets, required flag, and format.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVTAZ_LOCATOR_KFF');



debug('begin add_signature: ITEM_MTL_ITEM_REVISIONS_B');
   l_info('##MASK##ATTRIBUTE_CATEGORY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6489',
      p_sig_id                 => 'ITEM_MTL_ITEM_REVISIONS_B',
      p_sig_sql                => 'SELECT INVENTORY_ITEM_ID,      
ORGANIZATION_ID, REVISION, LAST_UPDATE_DATE,      
LAST_UPDATED_BY, CREATION_DATE, CREATED_BY,      
LAST_UPDATE_LOGIN, CHANGE_NOTICE, ECN_INITIATION_DATE,      
IMPLEMENTATION_DATE, IMPLEMENTED_SERIAL_NUMBER, EFFECTIVITY_DATE,      
ATTRIBUTE_CATEGORY, ATTRIBUTE1, ATTRIBUTE2,      
ATTRIBUTE3, ATTRIBUTE4, ATTRIBUTE5,      
REQUEST_ID, PROGRAM_APPLICATION_ID, PROGRAM_ID,      
PROGRAM_UPDATE_DATE, REVISED_ITEM_SEQUENCE_ID, DESCRIPTION,      
OBJECT_VERSION_NUMBER, REVISION_ID, REVISION_LABEL,      
REVISION_REASON, LIFECYCLE_ID, CURRENT_PHASE_ID
FROM MTL_ITEM_REVISIONS_B
WHERE INVENTORY_ITEM_ID = ##$$ITEMID$$##',
      p_title                  => 'Item Revision Details from MTL_ITEM_REVISIONS_B',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Output of MTL_ITEM_REVISIONS_B for all organizations.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_MTL_ITEM_REVISIONS_B');



debug('begin add_signature: ITEM_MTL_ITEM_REVISIONS_TL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6490',
      p_sig_id                 => 'ITEM_MTL_ITEM_REVISIONS_TL',
      p_sig_sql                => 'select * from MTL_ITEM_REVISIONS_TL where inventory_item_id = ##$$ITEMID$$##',
      p_title                  => 'Item Revision Details from MTL_ITEM_REVISIONS_TL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Output of MTL_ITEM_REVISIONS_TL for all organizations.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_MTL_ITEM_REVISIONS_TL');



debug('begin add_signature: ITEM_ATTRIBUTE_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6259',
      p_sig_id                 => 'ITEM_ATTRIBUTE_DETAILS',
      p_sig_sql                => 'SELECT user_group_name, user_attribute_name, user_attribute_value, control_level_dsp 
FROM MTL_ITEM_ATTRIBUTE_VALUES_V
WHERE organization_id = ##$$ORGID$$##  and
inventory_item_id = ##$$ITEMID$$##
order by user_group_name',
      p_title                  => 'Attribute Setup For Item In Organization',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This displays all attribute setup for this item in the organization.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_ATTRIBUTE_DETAILS');



debug('begin add_signature: ITEM_DESCRIPTIVE_ELEMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6524',
      p_sig_id                 => 'ITEM_DESCRIPTIVE_ELEMENTS',
      p_sig_sql                => 'select mdv.ELEMENT_SEQUENCE, mdv.ELEMENT_NAME, mde.DESCRIPTION, mdv.ELEMENT_VALUE, mde.REQUIRED_ELEMENT_FLAG, mde.DEFAULT_ELEMENT_FLAG
from mtl_descriptive_elements mde, mtl_descr_element_values mdv, mtl_system_items_b msi
where
msi.inventory_item_id = ##$$ITEMID$$## and
msi.organization_id = ##$$ORGID$$## and
msi.inventory_item_id = mdv.inventory_item_id and
mde.ITEM_CATALOG_GROUP_ID = msi.ITEM_CATALOG_GROUP_ID and
mde.ELEMENT_NAME = mdv.ELEMENT_NAME',
      p_title                  => 'Descriptive Element Values for an Item',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This displays Descriptive Element records for which element values are present.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_DESCRIPTIVE_ELEMENTS');



debug('begin add_signature: ITEM_LOTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6606',
      p_sig_id                 => 'ITEM_LOTS',
      p_sig_sql                => 'select 
mln.inventory_item_id , mln.organization_id , mln.lot_number , mln.creation_date
, mln.last_update_date , mln.expiration_date
,  decode (mln.disable_flag , 1 , ''1-Yes'', 2, ''2-No'' , mln.disable_flag) disable_flag
, mln.vendor_name , mln.supplier_lot_number , mln.grade_code , mln.origination_date
, mln.date_code
, (select msh.status_id||''-''||msh.status_code from mtl_material_statuses msh where msh.status_id = mln.status_id) Status_Code
, mln.change_date , mln.age , mln.retest_date , mln.maturity_date 
, mln.item_size , mln.color , mln.volume , mln.volume_uom , mln.place_of_origin
, mln.best_by_date , mln.length , mln.length_uom , mln.recycled_content
, mln.thickness , mln.thickness_uom , mln.width , mln.width_uom
, mln.vendor_id , mln.parent_lot_number , mln.origination_type , mln.availability_type
, mln.expiration_action_code , mln.expiration_action_date , mln.hold_date , mln.inventory_atp_code , mln.reservable_type , mln.gen_object_id 
from MTL_LOT_NUMBERS mln 
where mln.organization_id =  ##$$ORGID$$## 
and mln.inventory_item_id = ##$$ITEMID$$## 
and exists (select 1 from mtl_onhand_quantities_detail moqd
    where moqd.organization_id =  mln.organization_id
    and moqd.inventory_item_id =  mln.inventory_item_id ) ',
      p_title                  => 'Lot Numbers (MTL_LOT_NUMBERS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Lot numbers for this item.',
      p_solution               => '',
      p_success_msg            => 'Lot Numbers for this Item and Organization associated to onhand quantity.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_LOTS');



debug('begin add_signature: ITEM_SERIAL_NUMBERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6610',
      p_sig_id                 => 'ITEM_SERIAL_NUMBERS',
      p_sig_sql                => 'SELECT *
FROM (select * from MTL_SERIAL_NUMBERS where current_organization_id = ##$$ORGID$$## and inventory_item_id = ##$$ITEMID$$## ORDER BY creation_date DESC) Serials2
WHERE rownum <= 100',
      p_title                  => 'Serial Numbers(MTL_SERIAL_NUMBERS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no Serials for this item.',
      p_solution               => '',
      p_success_msg            => 'Display latest 100 Serial Numbers for this Item and Organization Combination.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_SERIAL_NUMBERS');



debug('begin add_signature: ITEM_TRANSACTION_DEFAULTS-SUBINVENTORIES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6618',
      p_sig_id                 => 'ITEM_TRANSACTION_DEFAULTS-SUBINVENTORIES',
      p_sig_sql                => 'select * from MTL_ITEM_SUB_DEFAULTS where inventory_item_id = ''##$$ITEMID$$##'' and organization_id = ''##$$ORGID$$##''',
      p_title                  => 'Subinventory Transaction Defaults (MTL_ITEM_SUB_DEFAULTS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Displays all the Item Transaction Defaults (Subinventories) for this item and organization combination.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_TRANSACTION_DEFAULTS-SUBINVENTORIES');



debug('begin add_signature: ITEM_TRANSACTION_DEFAULTS-LOCATORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6619',
      p_sig_id                 => 'ITEM_TRANSACTION_DEFAULTS-LOCATORS',
      p_sig_sql                => 'select * from MTL_ITEM_LOC_DEFAULTS where inventory_item_id = ''##$$ITEMID$$##'' and organization_id = ''##$$ORGID$$##''',
      p_title                  => 'Locator Transaction Defaults (MTL_ITEM_LOC_DEFAULTS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Displays all the Item Transaction Defaults (Locators) for this item and organization combination',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_TRANSACTION_DEFAULTS-LOCATORS');



debug('begin add_signature: ITEM_ONHAND_LOCATORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6600',
      p_sig_id                 => 'ITEM_ONHAND_LOCATORS',
      p_sig_sql                => 'select c.*, 
Decode(Reservable_type, ''1'', ''Reservable'', ''2'', ''Not reservable'', Reservable_type) Reservable_type_meaning
from mtl_item_locations c
where inventory_location_id 
in (select distinct locator_id 
from mtl_onhand_quantities_detail 
where inventory_item_id = ''##$$ITEMID$$##'') 
and organization_id = ''##$$ORGID$$##''',
      p_title                  => 'Locator Information where item has Onhand',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Output of mtl_item_locations in which there is onhand for this item and organization combination.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_ONHAND_LOCATORS');



debug('begin add_signature: ITEM_ONHAND_SUBINVENTORIES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6599',
      p_sig_id                 => 'ITEM_ONHAND_SUBINVENTORIES',
      p_sig_sql                => 'select c.*, Decode(Reservable_type, ''1'', ''Reservable'', ''2'', ''Not reservable'', Reservable_type) Reservable_type_meaning
from mtl_secondary_inventories c
where c.organization_id = ''##$$ORGID$$##'' and secondary_inventory_name in
(select distinct subinventory_code from mtl_onhand_quantities_detail where inventory_item_id = ''##$$ITEMID$$##''
and organization_id = ''##$$ORGID$$##'')',
      p_title                  => 'Subinventory Information where item has Onhand',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Output of mtl_secondary_inventories in which there is onhand for this item and organization combination.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_ONHAND_SUBINVENTORIES');



debug('begin add_signature: ITEM_MTL_ITEM_CATEGORIES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6491',
      p_sig_id                 => 'ITEM_MTL_ITEM_CATEGORIES',
      p_sig_sql                => 'select * from MTL_ITEM_CATEGORIES where inventory_item_id = ##$$ITEMID$$##',
      p_title                  => 'Categories Assigned to Item from MTL_ITEM_CATEGORIES',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Output of MTL_ITEM_CATEGORIES for all organizations.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_MTL_ITEM_CATEGORIES');



debug('begin add_signature: ITEM_MTL_ITEM_CATALOG_GROUPS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6493',
      p_sig_id                 => 'ITEM_MTL_ITEM_CATALOG_GROUPS',
      p_sig_sql                => 'SELECT DISTINCT msi.ITEM_CATALOG_GROUP_ID, micgv.CONCATENATED_SEGMENTS from 
mtl_system_items_b msi, mtl_item_catalog_groups_kfv micgv
where msi.inventory_item_id = ##$$ITEMID$$## and
msi.ITEM_CATALOG_GROUP_ID = micgv.ITEM_CATALOG_GROUP_ID',
      p_title                  => 'Item Catalog Group Details from MTL_ITEM_CATALOG_GROUPS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'All Item Catalog Groups assigned to the item.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_MTL_ITEM_CATALOG_GROUPS');



debug('begin add_signature: ITEM_RESTRICTED_SUBINVENTORIES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6601',
      p_sig_id                 => 'ITEM_RESTRICTED_SUBINVENTORIES',
      p_sig_sql                => 'select * from MTL_ITEM_SUB_INVENTORIES where inventory_item_id = ''##$$ITEMID$$##'' and organization_id = ''##$$ORGID$$##''',
      p_title                  => 'Subinventories that item is restricted',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The results of the MTL_ITEM_SUB_INVENTORIES shows if there are restricted list of subinventories for the organization.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_RESTRICTED_SUBINVENTORIES');



debug('begin add_signature: ITEM_RESTRICTED_LOCATORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6602',
      p_sig_id                 => 'ITEM_RESTRICTED_LOCATORS',
      p_sig_sql                => 'select * from mtl_secondary_locators where inventory_item_id = ''##$$ITEMID$$##'' and organization_id = ''##$$ORGID$$##''',
      p_title                  => 'Locators that item is restricted',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The results of the MTL_SECONDARY_LOCATORS shows if there a restricted list of locators for the organization and subinventory(s).',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_RESTRICTED_LOCATORS');



debug('begin add_signature: EBS_MFG_INV_INVTAZ_ITEM_FLAGS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25891',
      p_sig_id                 => 'EBS_MFG_INV_INVTAZ_ITEM_FLAGS',
      p_sig_sql                => 'select SUMMARY_FLAG,ENABLED_FLAG,PURCHASING_ITEM_FLAG,SHIPPABLE_ITEM_FLAG,CUSTOMER_ORDER_FLAG,INTERNAL_ORDER_FLAG,SERVICE_ITEM_FLAG,INVENTORY_ITEM_FLAG,ENG_ITEM_FLAG,INVENTORY_ASSET_FLAG,PURCHASING_ENABLED_FLAG,CUSTOMER_ORDER_ENABLED_FLAG,INTERNAL_ORDER_ENABLED_FLAG,SO_TRANSACTIONS_FLAG,MTL_TRANSACTIONS_ENABLED_FLAG,STOCK_ENABLED_FLAG,BOM_ENABLED_FLAG,BUILD_IN_WIP_FLAG,CATALOG_STATUS_FLAG,RETURNABLE_FLAG,COLLATERAL_FLAG,TAXABLE_FLAG,ALLOW_ITEM_DESC_UPDATE_FLAG,INSPECTION_REQUIRED_FLAG,RECEIPT_REQUIRED_FLAG,RFQ_REQUIRED_FLAG,ALLOW_SUBSTITUTE_RECEIPTS_FLAG,ALLOW_UNORDERED_RECEIPTS_FLAG,ALLOW_EXPRESS_DELIVERY_FLAG,MRP_CALCULATE_ATP_FLAG,END_ASSEMBLY_PEGGING_FLAG,REPETITIVE_PLANNING_FLAG,PLANNING_EXCEPTION_SET,BOM_ITEM_TYPE,PICK_COMPONENTS_FLAG,REPLENISH_TO_ORDER_FLAG,ATP_COMPONENTS_FLAG,ATP_FLAG,DEFAULT_INCLUDE_IN_ROLLUP_FLAG,VENDOR_WARRANTY_FLAG,SERVICEABLE_COMPONENT_FLAG,SERVICEABLE_PRODUCT_FLAG,PREVENTIVE_MAINTENANCE_FLAG,TIME_BILLABLE_FLAG,MATERIAL_BILLABLE_FLAG,EXPENSE_BILLABLE_FLAG,PRORATE_SERVICE_FLAG,INVOICEABLE_ITEM_FLAG,INVOICE_ENABLED_FLAG,MUST_USE_APPROVED_VENDOR_FLAG,OUTSIDE_OPERATION_FLAG,COSTING_ENABLED_FLAG,AUTO_CREATED_CONFIG_FLAG,CYCLE_COUNT_ENABLED_FLAG,SHIP_MODEL_COMPLETE_FLAG,CONTAINER_ITEM_FLAG,VEHICLE_ITEM_FLAG,CHECK_SHORTAGES_FLAG,DEFECT_TRACKING_ON_FLAG,USAGE_ITEM_FLAG,EVENT_FLAG,ELECTRONIC_FLAG,DOWNLOADABLE_FLAG,VOL_DISCOUNT_EXEMPT_FLAG,COUPON_EXEMPT_FLAG,COMMS_NL_TRACKABLE_FLAG,COMMS_ACTIVATION_REQD_FLAG,ORDERABLE_ON_WEB_FLAG,BACK_ORDERABLE_FLAG,INDIVISIBLE_FLAG,BULK_PICKED_FLAG,LOT_STATUS_ENABLED,DEFAULT_LOT_STATUS_ID,SERIAL_STATUS_ENABLED,LOT_SPLIT_ENABLED,LOT_MERGE_ENABLED,FINANCING_ALLOWED_FLAG,EAM_ACT_NOTIFICATION_FLAG,DUAL_UOM_CONTROL,SUBSCRIPTION_DEPEND_FLAG,SERV_BILLING_ENABLED_FLAG,PLANNED_INV_POINT_FLAG,LOT_TRANSLATE_ENABLED,LOT_SUBSTITUTION_ENABLED,SO_AUTHORIZATION_FLAG,CONSIGNED_FLAG,ASN_AUTOEXPIRE_FLAG,EXCLUDE_FROM_BUDGET_FLAG,DRP_PLANNED_FLAG,CRITICAL_COMPONENT_FLAG,CHILD_LOT_FLAG,CHILD_LOT_VALIDATION_FLAG,COPY_LOT_ATTRIBUTE_FLAG,GRADE_CONTROL_FLAG,HAZARDOUS_MATERIAL_FLAG,LOT_DIVISIBLE_FLAG,PARENT_CHILD_GENERATION_FLAG,PROCESS_COSTING_ENABLED_FLAG,PROCESS_EXECUTION_ENABLED_FLAG,PROCESS_QUALITY_ENABLED_FLAG,RECIPE_ENABLED_FLAG,GDSN_OUTBOUND_ENABLED_FLAG,STYLE_ITEM_FLAG,LOT_CONTROL_CODE
from mtl_system_items_b msi
where msi.organization_id = NVL( ''##$$ORGID$$##'' , msi.organization_id)
  and msi.inventory_item_id = ''##$$ITEMID$$##''',
      p_title                  => 'Item Flags',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Item Flags',
      p_solution               => '',
      p_success_msg            => 'This is reference data for item details including key attributes from the item table (MTL_SYSTEM_ITEMS_B).',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVTAZ_ITEM_FLAGS');



debug('begin add_signature: EBS_MFG_INV_INVITMANALYZER_RELATED_ITEMS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30114',
      p_sig_id                 => 'EBS_MFG_INV_INVITMANALYZER_RELATED_ITEMS',
      p_sig_sql                => 'select  ORGANIZATION_ID, INVENTORY_ITEM_ID, INVENTORY_ITEM_DESCRIPTION, RELATED_ITEM_ID, RELATED_ITEM_DESCRIPTION, RELATIONSHIP_TYPE_ID, RECIPROCAL_FLAG, START_DATE, END_DATE,     PLANNING_ENABLED_FLAG
from MTL_RELATED_ITEMS_ALL_V mri
where mri.inventory_item_id =  ##$$ITEMID$$##',
      p_title                  => 'Related Items Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are related items existing for this item. ',
      p_solution               => 'Review the related items. Existing related items will not allow to add other related items. ',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVITMANALYZER_RELATED_ITEMS');



debug('begin add_signature: EBS_MFG_INV_INVITMANALYZER_MSII_FOR_ITEM');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28761',
      p_sig_id                 => 'EBS_MFG_INV_INVITMANALYZER_MSII_FOR_ITEM',
      p_sig_sql                => 'select  
inventory_item_id
,organization_id
,last_update_date
...
where  inventory_item_id =  ''##$$ITEMID$$##''  ',
      p_title                  => 'MTL_SYSTEM_ITEMS_INTERFACE',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are records present for this item in MTL_SYSTEM_ITEMS_INTERFACE.',
      p_solution               => 'See [1347604/KB638670] to review if these are pending (Process_flag = 1) or can be cleared out.
',
      p_success_msg            => 'No records present for this item in MTL_SYSTEM_ITEMS_INTERFACE.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVITMANALYZER_MSII_FOR_ITEM');



debug('begin add_signature: EBS_MFG_INV_INVITMANALYZER_INTRFC_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28762',
      p_sig_id                 => 'EBS_MFG_INV_INVITMANALYZER_INTRFC_ERRORS',
      p_sig_sql                => 'select * from mtl_interface_errors
where table_name = ''MTL_SYSTEM_ITEMS_INTERFACE''
and transaction_id in (select transaction_id from mtl_system_items_interface where inventory_item_id =  ''##$$ITEMID$$##'' )',
      p_title                  => 'MTL_INTERFACE_ERRORS',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are records present for this item in MTL_INTERFACE_ERRORS.',
      p_solution               => 'Review [552683/KB378206] for resolving any errors in MTL_INTERFACE_ERRORS for items that failed processing in MTL_SYSTEM_ITEMS_INTERFACE. ',
      p_success_msg            => 'No records present for this item in MTL_INTERFACE_ERRORS.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVITMANALYZER_INTRFC_ERRORS');
...
debug('begin add_signature: OPHANLY_INACTIVE_ORGS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12949',
      p_sig_id                 => 'OPHANLY_INACTIVE_ORGS',
      p_sig_sql                => 'SELECT mp.organization_id, mp.organization_code, org.date_from, org.date_to
from mtl_parameters mp , hr_organization_units_v org 
WHERE  org.organization_id = mp.organization_id
and org.date_to <= SYSDATE ',
      p_title                  => 'Inactive Organizations',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Identifies inactive organizations. Items in these organizations should also pass any validations to maintain data integrity.  ',
      p_solution               => 'Inactive organizations have been identified. Items in inactive organizations should also pass any validations to maintain item master data integrity. Review [2366062/KB398040] - Master Child Conflict On Attributes -- Validations Happening In Inactive Organizations?, for full details.',
      p_success_msg            => 'No inactive organizations exist. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OPHANLY_INACTIVE_ORGS');



debug('begin add_signature: ITEM_UOM_ATTRIBUTES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14750',
      p_sig_id                 => 'ITEM_UOM_ATTRIBUTES',
      p_sig_sql                => 'SELECT inventory_item_id,
organization_id,
PRIMARY_UOM_CODE,
PRIMARY_UNIT_OF_MEASURE,
DECODE(DUAL_UOM_CONTROL,2, ''Y'',''N'') DUAL_UOM_CONTROL,
TRACKING_QUANTITY_IND,
SECONDARY_UOM_CODE,
decode(SECONDARY_DEFAULT_IND,''D'',''Default'',''F'',''Default'',''N'',''No Default'',SECONDARY_DEFAULT_IND) SECONDARY_DEFAULT_IND,
DUAL_UOM_DEVIATION_HIGH,
DUAL_UOM_DEVIATION_LOW,
DECODE(ONT_PRICING_QTY_SOURCE,''P'',''Primary'',''S'',''Secondary'',ONT_PRICING_QTY_SOURCE) ONT_PRICING_QTY_SOURCE,
DECODE(ALLOWED_UNITS_LOOKUP_CODE,1,''Item Specific'',2,''Standard'',3,''Both'',ALLOWED_UNITS_LOOKUP_CODE) ALLOWED_UNITS_LOOKUP_CODE,
...
WHERE inventory_item_id = ##$$ITEMID$$##  
AND ORGANIZATION_ID     = ##$$ORGID$$##',
      p_title                  => 'ITEM UOM ATTRIBUTES',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'List of all UOM related attributes in Item Definition (mtl_system_items_b)',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_UOM_ATTRIBUTES');



debug('begin add_signature: ITEM_LEADING_TRAILING_SPACES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '21218',
      p_sig_id                 => 'ITEM_LEADING_TRAILING_SPACES',
      p_sig_sql                => 'SELECT COUNT(1) leading_trailing_count,''MTL_SYSTEM_ITEMS_B - DESCRIPTION|SEGMENT|ATTRIBUTE'' "table - field" FROM mtl_system_items_b
...
AND inventory_item_id =  ##$$itemid$$##
UNION
SELECT COUNT(1) leading_trailing_count,''MTL_MFG_PART_NUMBERS - MFG_PART_NUM|DESCRIPTION'' "table - field"
FROM mtl_mfg_part_numbers
WHERE (LENGTH(mfg_part_num) <> LENGTH(TRIM(mfg_part_num)) 
  OR LENGTH(description) <> LENGTH(TRIM(description)) )
AND inventory_item_id = ##$$itemid$$## 
UNION
SELECT  COUNT(1) leading_trailing_count,''MTL_DESCR_ELEMENT_VALUES - ELEMENT_VALUE|DESCRIPTION''  "table - field" FROM mtl_descr_element_values
WHERE ( nvl(LENGTH(element_value),0) <> nvl(LENGTH(TRIM(element_value)),0)
  OR LENGTH(element_name) <> LENGTH(TRIM(element_name)) )
AND inventory_item_id = ##$$itemid$$##',
      p_title                  => 'Item Leading or Trailing Spaces from Form INVIDITM.fmb',
      p_fail_condition         => '[LEADING_TRAILING_COUNT] > [0]',
      p_problem_descr          => 'FRM-40735 and FRM-40654 errors in Item form INVIDITM.fmb.

Normally these errors are caused by data issues in the following tables:
MTL_SYSTEM_ITEMS_B
MTL_SYSTEM_ITEMS_TL
FND_FLEX_VALUES_TL
MTL_DESCR_ELEMENT_VALUES',
      p_solution               => '[1933028/KB159361]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_LEADING_TRAILING_SPACES');



debug('begin add_signature: ITEM_ONHAND');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5418',
      p_sig_id                 => 'ITEM_ONHAND',
      p_sig_sql                => 'SELECT (SELECT organization_code FROM mtl_parameters mp WHERE mp.organization_id = moqd.organization_id) organization_code,  organization_id 
, inventory_item_id , subinventory_code, locator_id, lot_number, revision, cost_group_id, containerized_flag, project_id, task_id 
,  primary_transaction_quantity ,  secondary_transaction_quantity , date_received , owning_organization_id, is_consigned, lpn_id
, status_id, mcc_code , creation_date
FROM mtl_onhand_quantities_detail moqd
where inventory_item_id = ##$$ITEMID$$## ',
      p_title                  => 'Onhand Records in MTL_ONHAND_QUANTITIES_DETAIL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Onhand records exist in MTL_ONHAND_QUANTITIES_DETAIL Table.',
      p_solution               => 'The MTL_ONHAND_QUANTITIES_DETAIL Table is showing Onhand Quantities exist. Items with Onhand Quantity cannot have the status changed or attributes updated.
<ul><li>See the solution at Section 4 in [1932995/KB627831#aref_section25] - Receive Message ''You Cannot Update This Field When...'' Or ''This Field Can not Be Updated...'' In The Item Form INVIDITM.fmb, for more details</li></ul>',
      p_success_msg            => 'There are no Onhand records in the MTL_ONHAND_QUANTITIES_DETAIL Table.<br>
This will allow you to change or inactivate an item.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_ONHAND');



debug('begin add_signature: ITEM_PENDING_COST_RECORDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5793',
      p_sig_id                 => 'ITEM_PENDING_COST_RECORDS',
      p_sig_sql                => 'select transaction_id, inventory_item_id, organization_id, costed_flag, primary_quantity, actual_cost, prior_cost, new_cost FROM MTL_MATERIAL_TRANSACTIONS WHERE INVENTORY_ITEM_ID = ##$$ITEMID$$## AND COSTED_FLAG IS NOT NULL',
      p_title                  => 'Pending Cost Records (MTL_MATERIAL_TRANSACTIONS - COSTED_FLAG)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Uncosted records exist in the Material Transactions MTL_MATERIAL_TRANSACTIONS Table.',
      p_solution               => 'Uncosted transactions will prevent making status changes to an Item and will present problems with Period Close, as well as other issues.
<ul>
<li>See section 3 in [1932995/KB627831#Section3]. Specifically review resolution "How to Re-Submit Uncosted Records".</li>
</ul>',
      p_success_msg            => 'All transactions are costed.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_PENDING_COST_RECORDS');



debug('begin add_signature: ITEM_PENDING_DELIVERY_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5794',
      p_sig_id                 => 'ITEM_PENDING_DELIVERY_DETAILS',
      p_sig_sql                => 'select  wdd.source_header_number , wdd.source_line_number, wdd.delivery_detail_id, wdd.inventory_item_id, wdd.organization_id, wdd.pickable_flag
, wdd.inv_interfaced_flag, wdd.oe_interfaced_flag, wdd.released_status,  wdd.source_code, wdd.source_header_id, wdd.source_line_id
, wdd.requested_quantity, wdd.picked_quantity, wdd.shipped_quantity, wdd.move_order_line_id ,  wdd.INV_INTERFACED_FLAG
, (select organization_code from mtl_parameters mp where mp.organization_id = wdd.organization_id) organization_code
, wdd.creation_date
from WSH_DELIVERY_DETAILS wdd
where  wdd.INVENTORY_ITEM_ID = ##$$ITEMID$$## 
AND wdd.PICKABLE_FLAG = ''Y'' 
AND wdd.INV_INTERFACED_FLAG IN (''N'',''P'')
AND wdd.RELEASED_STATUS <> ''D''',
      p_title                  => 'Pending Delivery Details (WSH_DELIVERY_DETAILS)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Unprocessed Shipping records exist in the WSH_DELIVERY_DETAILS Table which are Picked but not yet inventory (INV) interfaced, and have Delivery Details which are not processed or cancelled.',
      p_solution               => 'Pending Delivery Details can prevent an Items status from being changed and can cause problems with Onhand counts and may result in lack of ability to reserve Items in Inventory. Review the following solution:<br>
<ul>
<li>Review Section 7 in [1932995/KB627831#aref_section28] - Receive Message ''You Cannot Update This Field When...'' Or ''This Field Can not Be Updated...'' In The Item Form INVIDITM.fmb, for full details.</li>
</ul>',
      p_success_msg            => 'There are no records in the WSH_DELIVERY_DETAILS Table which are pending the inventory (INV) interface.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_PENDING_DELIVERY_DETAILS');



debug('begin add_signature: ITEM_PENDING_DEMAND');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5788',
      p_sig_id                 => 'ITEM_PENDING_DEMAND',
      p_sig_sql                => 'select demand_id, organization_id, inventory_item_id, demand_source_type, demand_source_header_id, demand_source_line,
primary_uom_quantity from mtl_demand where inventory_item_id = ##$$ITEMID$$##',
      p_title                  => 'Pending Demand by Item for all Organizations (MTL_DEMAND)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are pending Demand records in the MTL_DEMAND Table for the Item and listed Organizations. This can lead to incorrect display of Onhand Quantity and may interfere with Reservations.',
      p_solution               => 'The pending demand needs to be shipped or cancelled. To resolve:<br>
<ul>
<li>Review the solution at Section 5b in [1932995/KB627831#Section5] - Receive Message ''You Cannot Update This Field When...'' Or ''This Field Can not Be Updated...'' In The Item Form INVIDITM.fmb </li>
<li>Also see [401342/KB769497] - Cycle Count Reservations Stuck In Mtl_reservations/Mtl_demand Tables, for more information</li>
</ul>',
      p_success_msg            => 'There are no unprocessed or stuck records in the MTL_DEMAND Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_PENDING_DEMAND');



debug('begin add_signature: ITEM_PENDING_MOVE_ORDERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6198',
      p_sig_id                 => 'ITEM_PENDING_MOVE_ORDERS',
      p_sig_sql                => 'SELECT
    (SELECT request_number FROM mtl_txn_request_headers a WHERE a.header_id = c.header_id) move_order_number,
    c.header_id,
    (select a.move_order_type || '' ('' || meaning ||'')'' from mfg_lookups, mtl_txn_request_headers a
                     WHERE a.header_id = c.header_id
                       AND lookup_type = ''MOVE_ORDER_TYPE''
                       AND lookup_code = a.move_order_type) move_order_type,
    c.line_number,
    c.line_id,
    (select c.LINE_STATUS || '' ('' || meaning ||'')'' from mfg_lookups  where lookup_type = ''MTL_TXN_REQUEST_STATUS'' and lookup_code = c.LINE_STATUS) line_status,
    (select mp.organization_code from mtl_parameters mp where mp.organization_id = c.organization_id )
    ||''(''||c.organization_id ||'')''  organization_code ,
    c.inventory_item_id,
    c.revision,
    c.from_subinventory_code,
    c.from_locator_id,
    c.to_subinventory_code,
    c.to_locator_id,
    c.to_account_id,
    c.lot_number,
    c.serial_number_start,
    c.serial_number_end,
    c.uom_code,
    c.quantity,
    ...
    c.created_by,
    c.creation_date
 FROM mtl_txn_request_lines c
WHERE inventory_item_id = ##$$ITEMID$$## 
  AND LINE_STATUS IN (3, 7) ',
      p_title                  => 'Open Move Order Lines (MTL_TXN_REQUEST_LINES)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are pre-approved move order lines in the MTL_TXN_REQUEST_LINES Table. This will prevent changing Item Status for this item, and could result in incorrect Onhand quantities being displayed.',
      p_solution               => 'Move orders cannot be in a pre-approved status (status_id = 7) when inactivating or changing an item. To resolve the issue:<br>
<ul>
<li>Review Section 13 in [1932995/KB627831#Section13] - Receive Message ''You Cannot Update This Field When...'' Or ''This Field Can not Be Updated...'' In The Item Form INVIDITM.fmb </li>
</ul>',
      p_success_msg            => 'There are no open move order records found in the MTL_TXN_REQUEST_LINES Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_PENDING_MOVE_ORDERS');



debug('begin add_signature: ITEM_PENDING_RESERVATIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5792',
      p_sig_id                 => 'ITEM_PENDING_RESERVATIONS',
      p_sig_sql                => 'select reservation_id, organization_id, inventory_item_id, demand_source_type_id, demand_source_header_id, demand_source_line_id, primary_reservation_quantity, reservation_quantity,SUBINVENTORY_CODE, LOCATOR_ID, LOT_NUMBER, SERIAL_NUMBER
FROM MTL_RESERVATIONS 
WHERE INVENTORY_ITEM_ID = ##$$ITEMID$$## 
AND RESERVATION_QUANTITY > 0',
      p_title                  => 'Pending Reservations (MTL_RESERVATIONS)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are open reservation records in the MTL_RESERVATIONS Table. This can cause problems with period close, may lead to inaccurate Onhand quantity being displayed, and will prevent changing an items status.',
      p_solution               => 'All the pending reservations should be relieved before changing or inactivating the item. To resolve:<br>
<ul>
<li>Review Section 5b in [1932995/KB627831#Section5] - Receive Message ''You Cannot Update This Field When...'' Or ''This Field Can not Be Updated...'' In The Item Form INVIDITM.fmb, for full details.</li>
</ul>',
      p_success_msg            => 'There are no pending reservation records in the MTl_RESERVATIONS Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_PENDING_RESERVATIONS');



debug('begin add_signature: ITEM_PENDING_SALES_ORDER_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5789',
      p_sig_id                 => 'ITEM_PENDING_SALES_ORDER_LINES',
      p_sig_sql                => 'SELECT
    oeh.order_number , oel.ship_from_org_id, 
    (select mp.organization_code from mtl_parameters mp where mp.organization_id = oel.ship_from_org_id) organization_code,
    oel.line_id,  oel.line_number, oel.org_id, oel.header_id, oel.ordered_item, oel.inventory_item_id, 
    oel.ordered_quantity, oel.shipped_quantity, oel.open_flag, oel.booked_flag, oel.cancelled_flag, oel.shipping_interfaced_flag,
    oel.item_type_code, oel.flow_status_code
  FROM
    oe_order_lines_all oel , oe_order_headers_all oeh 
  where  oel.inventory_item_id = ##$$ITEMID$$##
  and oel.header_id = oeh.header_id
  AND oel.open_flag = ''Y''',
      p_title                  => 'Pending Sales Order Lines (OE_ORDER_LINES_ALL)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'One or more Open Sales Order Lines exist against this item in the Sales Order Lines Table (OE_ORDER_LINES_ALL). This can prevent users from updating Item Status and can cause incorrect display of Onhand quantity.',
      p_solution               => 'The sales order lines need to be processed or cancelled. To resolve:<br>
<ul>
<li>See the solution at Section 6 in [1932995/KB627831#Section6] - Receive Message ''You Cannot Update This Field When...'' Or ''This Field Can not Be Updated...'' In The Item Form INVIDITM.fmb, for full details.</li>
</ul>',
      p_success_msg            => 'No open sales order lines exist for the item in OE_ORDER_LINES_ALL Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_PENDING_SALES_ORDER_LINES');



debug('begin add_signature: ITEM_PENDING_SUPPLY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5783',
      p_sig_id                 => 'ITEM_PENDING_SUPPLY',
      p_sig_sql                => 'select item_id, from_organization_id, to_organization_id, supply_type_code, supply_source_id, 
req_header_id, req_line_id, 
...
Unit_of_measure, To_org_primary_quantity, To_org_primary_UOM,
RECEIPT_DATE, NEED_BY_DATE, EXPECTED_DELIVERY_DATE , 
creation_date, last_update_date 
from mtl_supply 
where item_id = ##$$ITEMID$$##',
      p_title                  => 'Pending/Orphan Supply Records (MTL_SUPPLY)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Supply records exist for the item in the MTL_SUPPLY Table. This can lead to problems at Period Close, may cause inaccurate display of On-Hand quantity information, and will stop users from being able to change this Item''s Status.',
      p_solution               => 'Review the following documents for more information and resolution:<br>
<ul>
<li>Section 5a in [1932995/KB627831#Section5] - Receive Message ''You Cannot Update This Field When...'' Or ''This Field Can not Be Updated...'' In The Item Form INVIDITM.fmb</li>
<li>[402217/KB229819] - How to Remove Supply/Demand Showing for Closed or Cancelled POs/Releases? </li>
<li>[415151/KB775383] - How to Remove Supply / Demand for Requisition Lines Which are Canceled or do not Exist in System?</li>
</ul>',
      p_success_msg            => 'No Supply records exist or are stuck for the item in MTL_SUPPLY table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_PENDING_SUPPLY');



debug('begin add_signature: ITEM_PENDING_TRANSACTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5782',
      p_sig_id                 => 'ITEM_PENDING_TRANSACTIONS',
      p_sig_sql                => 'select TRANSACTION_SOURCE_TYPE_ID,TRANSACTION_TEMP_ID, INVENTORY_ITEM_ID, ORGANIZATION_ID, SUBINVENTORY_CODE, LOCATOR_ID, TRANSACTION_QUANTITY, PROCESS_FLAG, TRANSACTION_STATUS, TRANSACTION_TYPE_ID, 
TRANSACTION_ACTION_ID, ERROR_CODE, ERROR_EXPLANATION from MTL_MATERIAL_TRANSACTIONS_TEMP where inventory_item_id = ##$$ITEMID$$##',
      p_title                  => 'Pending Transactions (MTL_MATERIAL_TRANSACTIONS_TEMP)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'One or more transactions are stuck or unprocessed for the item, in the pending transactions MTL_MATERIAL_TRANSACTIONS_TEMP Table. This can lead to problems with Period Close, may cause incorrect display of On-Hand quantity, and will prevent users from making changes to Item Status for the affected item.',
      p_solution               => 'The pending transaction records need to be processed. To resolve:</li>
<ul>
<li>Review the solution at Section 3b in [1932995/KB627831#Section3] - Receive Message ''You Cannot Update This Field When...'' Or ''This Field Can not Be Updated...'' In The Item Form INVIDITM.fmb </li>
</ul>',
      p_success_msg            => 'No records exist or are stuck for the item in the MTL_MATERIAL_TRANSACTIONS_TEMP Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_PENDING_TRANSACTIONS');



debug('begin add_signature: ITEM_OPEN_CYCLE_COUNT_ENTRIES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5790',
      p_sig_id                 => 'ITEM_OPEN_CYCLE_COUNT_ENTRIES',
      p_sig_sql                => 'SELECT
     mcce.cycle_count_entry_id   ,  mcch.cycle_count_header_name     ,  mcch.cycle_count_header_id 
  ,  mcch.disable_date    ,  mcce.inventory_item_id
  ,  decode ( mcce.entry_status_code , 1, ''1-Uncounted'', 2, ''2-Pending Approval'', 3 , ''3-Recount'', 
     4 , ''4-Rejected'',  5, ''5-Completed''   ) entry_status_code
  , mcce.organization_id
  , (select organization_code from mtl_parameters where organization_id = mcce.organization_id)organization_code
  ,  mcce.count_quantity_first   ,  mcce.count_quantity_current   ,  mcce.subinventory   ,  mcce.locator_id
  ,  mcce.count_due_date   ,  mcce.creation_date
  FROM  mtl_cycle_count_entries mcce , mtl_cycle_count_headers mcch
 WHERE  mcce.inventory_item_id =  ##$$ITEMID$$## 
 ...
 AND mcch.organization_Id = mcce.organization_Id',
      p_title                  => 'Open Cycle Count Entries (MTL_CYCLE_COUNT_ENTRIES)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'One or more open Cycle Count entries exist for the Item in the MTL_CYCLE_COUNT_ENTRIES Table. This can prevent users from changing the Item status and cause incorrect display of On-Hand Quantities and interfere with Period Close.',
      p_solution               => 'All the open Cycle Count entries should be reviewed and addressed. To resolve:<br>
<ul>
<li>Review the solution at Section 9 in [1932995/KB627831#Section9] - Receive Message You Cannot Update This Field When... Or This Field Can not Be Updated... In The Item Form INVIDITM.fmb </li>
</ul>',
      p_success_msg            => 'No open Cycle Count entries exist for the item in the MTL_CYCLE_COUNT_ENTRIES Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_OPEN_CYCLE_COUNT_ENTRIES');



debug('begin add_signature: ITEM_OPEN_PHYSICAL_ADJUSTMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5791',
      p_sig_id                 => 'ITEM_OPEN_PHYSICAL_ADJUSTMENTS',
      p_sig_sql                => 'SELECT  adjustment_id   , organization_id
  , (SELECT organization_code FROM mtl_parameters WHERE organization_id = mpa.organization_id) organization_code
  , physical_inventory_id
  , (SELECT physical_inventory_name FROM  mtl_physical_inventories WHERE physical_inventory_id = mpa.physical_inventory_id AND organization_id = mpa.organization_id) physical_inventory_name
  , inventory_item_id   , decode ( approval_status , 1, ''1-Approved'', 2, ''2-Rejected'',  NULL) approval_status 
  , subinventory_name  , system_quantity   , adjustment_quantity
  FROM mtl_physical_adjustments mpa
  WHERE  mpa.inventory_item_id = ##$$ITEMID$$##
  AND (mpa.approval_status IS NULL OR mpa.approval_status = 1) AND mpa.adjustment_quantity <> 0',
      p_title                  => 'Open Physical Adjustments (MTL_PHYSICAL_ADJUSTMENTS)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are pending Physical Inventory Adjustment records for the Item in the MTL_PHYSICAL_ADJUSTMENTS table, that are Approved and not posted.<br>
This can prevent users from changing the Item status and cause inaccurate display of Onhand Quantities, and interfere with other counting tasks.',
      p_solution               => 'All the pending Physical Inventory Adjustment records should be processed as soon as possible to avoid issues. To resolve:<br>
<ul>
<li>Review the solution in Section 8 in [1932995/KB627831#aref_section29] - Receive Message You Cannot Update This Field When... Or This Field Can not Be Updated... In The Item Form INVIDITM.fmb, for full details.</li>
</ul>',
      p_success_msg            => 'There are no pending Physical Inventory Adjustment records for the item in the MTL_PHYSICAL_ADJUSTMENTS Table.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_OPEN_PHYSICAL_ADJUSTMENTS');



debug('begin add_signature: ITEM_CQL_RECORDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5796',
      p_sig_id                 => 'ITEM_CQL_RECORDS',
      p_sig_sql                => 'select cql.layer_id, cql.organization_id, cql.inventory_item_id, cql.layer_quantity, mp.primary_cost_method FROM CST_QUANTITY_LAYERS cql, mtl_parameters mp
WHERE cql.INVENTORY_ITEM_ID = ##$$ITEMID$$##
AND cql.LAYER_QUANTITY <> 0
AND cql.organization_id = mp.organization_id
and mp.primary_cost_method in (2,5,6)',
      p_title                  => 'Records from CST_QUANTITY_LAYERS',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Records are present for the item in the CST_QUANTITY_LAYERS Table for validations on updating INVENTORY_ASSET_FLAG and COSTING_ENABLED_FLAG in MTL_SYSTEM_ITEMS_B table.',
      p_solution               => '<ul>
<li>For an Average/FIFO/LIFO costing methods there should be no records in in the CST_QUANTITY_LAYERS table with Non Zero Layer Quantity. If you are trying to change the INVENTORY_ASSET_FLAG and COSTING_ENABLED_FLAG settings for the item, it cannot be done with records in CST_QUANTITY_LAYERS. See [2102706/KB730153] for more information and a solution</li>
</ul>',
      p_success_msg            => 'No records are present for the item in the CST_QUANTITY_LAYERS Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_CQL_RECORDS');



debug('begin add_signature: ITEM_WIP_REPITITIVE_RECORDS');
   l_info('##MASK##ATTRIBUTE_CATEGORY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6208',
      p_sig_id                 => 'ITEM_WIP_REPITITIVE_RECORDS',
      p_sig_sql                => 'SELECT * FROM WIP_REPETITIVE_ITEMS WRI WHERE WRI.PRIMARY_ITEM_ID = ##$$ITEMID$$## AND WRI.ORGANIZATION_ID IN (SELECT MP.ORGANIZATION_ID FROM MTL_PARAMETERS MP WHERE MP.MASTER_ORGANIZATION_ID = ##$$ORGID$$##)',
      p_title                  => 'Open Records from WIP_REPETITIVE_ITEMS',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Checking if a repetitive schedule exists for any of the items Bill of Materials (BOM).',
      p_solution               => '<ul>
<li>There should not be any repetitive schedules exists for the item BOM.</li>
<li>See the solution in Section 12 in [1932995/KB627831#Section12] - Receive Message ''You Cannot Update This Field When...'' Or ''This Field Can not Be Updated...'' In The Item Form INVIDITM.fmb</li>
</ul>',
      p_success_msg            => 'No Bill of Materials (BOM) repetitive schedule exists for any of the items BOMs in the WIP_REPETITIVE_ITEMS Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_WIP_REPITITIVE_RECORDS');
...
debug('begin add_signature: ITEM_ORPHAN_RECORDS_CATEGORY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7085',
      p_sig_id                 => 'ITEM_ORPHAN_RECORDS_CATEGORY',
      p_sig_sql                => 'SELECT ''Orphan Records exists in MTL_ITEM_CATEGORIES'' STATUS
from dual
where exists
(SELECT * 
...
and cat.organization_id = ##$$ORGID$$##  
and cat.inventory_item_id = ##$$ITEMID$$##)',
      p_title                  => 'Item Orphan Records Data Corruption in MTL_ITEM_CATEGORIES Table',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Item orphan records are present in the MTL_ITEM_CATEGORIES table but not present in MTL_SYSTEM_ITEMS_B table.
This issue will prevent users from assigning orphaned items to a child organization.',
      p_solution               => 'Review [1065107/KB794567#aref_section26] - APP-INV-05479 Standard Datafix To Find Orphan Item Records, for all steps to resolve the issue.',
      p_success_msg            => 'There are no orphaned records in MTL_ITEM_CATEGORIES table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_ORPHAN_RECORDS_CATEGORY');



debug('begin add_signature: ITEM_ORPHAN_RECORDS_CST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7088',
      p_sig_id                 => 'ITEM_ORPHAN_RECORDS_CST',
      p_sig_sql                => 'SELECT ''Orphan Records exists in CST_ITEM_COSTS'' STATUS
from dual
where exists
(select *
...
and cic.organization_id =   ##$$ORGID$$##  
and cic.inventory_item_id =  ##$$ITEMID$$##)',
      p_title                  => 'Item Orphan Records Data Corruption in  CST_ITEM_COSTS Table',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Item orphan records exist in the CST_ITEM_COSTS table but are not present in MTL_SYSTEM_ITEMS_B table.',
      p_solution               => 'This issue will prevent users from assigning orphaned items to a child organization. To resolve:<br>
<ul>
<li>Review [1065107/KB794567] - APP-INV-05479 Standard Datafix To Find Orphan Item Records, for all steps to resolve the issue.</li>
</ul>',
      p_success_msg            => 'There are no orphaned records in CST_ITEM_COSTS table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_ORPHAN_RECORDS_CST');



debug('begin add_signature: ITEM_ORPHAN_RECORDS_ENI');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7089',
      p_sig_id                 => 'ITEM_ORPHAN_RECORDS_ENI',
      p_sig_sql                => 'SELECT ''Orphan Records exists in ENI_OLTP_ITEM_STAR'' STATUS
from dual
where exists
(select * from eni_oltp_item_star eois
...
and eois.organization_id = ##$$ORGID$$##  
and eois.inventory_item_id = ##$$ITEMID$$##)',
      p_title                  => 'Item Orphan Records Data Corruption in the ENI_OLTP_ITEM_STAR Table',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Item orphan records are present in the ENI_OLTP_ITEM_STAR table but not present in the MTL_SYSTEM_ITEMS_B table.<br>
This issue will prevent users from assigning orphaned items to a child organization. ',
      p_solution               => 'Review [1065107/KB794567] - APP-INV-05479 Standard Datafix To Find Orphan Item Records, for all steps to resolve the issue.',
      p_success_msg            => 'There are no orphaned records in the ENI_OLTP_ITEM_STAR table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_ORPHAN_RECORDS_ENI');



debug('begin add_signature: ITEM_ORPHAN_RECORDS_REV_B');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7083',
      p_sig_id                 => 'ITEM_ORPHAN_RECORDS_REV_B',
      p_sig_sql                => 'SELECT ''Orphan Records exists in MTL_ITEM_REVISIONS_B'' STATUS from dual
where exists (select * from mtl_item_revisions_b rev 
where not exists (select ''X'' from mtl_system_items_b item 
where item.inventory_item_id = rev.inventory_item_id
and item.organization_id = rev.organization_id)
and rev.organization_id =  ##$$ORGID$$##  
and rev.inventory_item_id =  ##$$ITEMID$$##) 
',
      p_title                  => 'Item Orphan Records Data Corruption in MTL_ITEM_REVISIONS_B Table',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Item orphan records present in MTL_ITEM_REVISIONS_B table but not present in MTL_SYSTEM_ITEMS_B table.
Because of the issue, users are not be able to assign orphaned items to a child organization.',
      p_solution               => 'Review [1065107/KB794567#aref_section26] - APP-INV-05479 Standard Datafix To Find Orphan Item Records, for all steps to resolve the issue.',
      p_success_msg            => 'There are no orphaned records in MTL_ITEM_REVISIONS_B table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_ORPHAN_RECORDS_REV_B');



debug('begin add_signature: ITEM_ORPHAN_RECORDS_REV_TL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7084',
      p_sig_id                 => 'ITEM_ORPHAN_RECORDS_REV_TL',
      p_sig_sql                => 'SELECT ''Orphan Records exists in mtl_item_revisions_tl'' STATUS
from dual
where exists
(select *
from mtl_item_revisions_tl rev 
where not exists (select ''X'' from mtl_system_items_b item 
where item.inventory_item_id = rev.inventory_item_id 
and  item.organization_id = rev.organization_id)
and rev.organization_id =   ##$$ORGID$$##  
and rev.inventory_item_id =  ##$$ITEMID$$##)',
      p_title                  => 'Item Orphan Records Data Corruption in the MTL_ITEM_REVISIONS_TL Table',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Item orphan records are present in the MTL_ITEM_REVISIONS_TL table but not present in MTL_SYSTEM_ITEMS_B table.',
      p_solution               => 'This issue will prevent users from assigning orphaned items to a child organization. To resolve:<br>
<ul>
<li> Review [1065107/KB794567] - APP-INV-05479 Standard Datafix To Find Orphan Item Records, for all steps to resolve the issue.</li>
</ul>',
      p_success_msg            => 'There are no orphaned records in the MTL_ITEM_REVISIONS_TL table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_ORPHAN_RECORDS_REV_TL');



debug('begin add_signature: ITEM_ORPHAN_RECORDS_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7086',
      p_sig_id                 => 'ITEM_ORPHAN_RECORDS_STATUS',
      p_sig_sql                => 'SELECT ''Orphan Records exists in MTL_PENDING_ITEM_STATUS'' STATUS from dual
where exists (select * from Mtl_Pending_Item_Status mpis
...
and mpis.organization_id =  ##$$ORGID$$##  
and mpis.inventory_item_id =  ##$$ITEMID$$##) ',
      p_title                  => 'Item Orphan Records Data Corruption in the MTL_PENDING_ITEM_STATUS Table',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Item orphan records present in the MTL_PENDING_ITEM_STATUS table but not present in the MTL_SYSTEM_ITEMS_B table.
This issue will prevent users from assigning orphaned items to a child organization. ',
      p_solution               => 'Review [1065107/KB794567#aref_section26] - APP-INV-05479 Standard Datafix To Find Orphan Item Records, for all steps to resolve the issue.',
      p_success_msg            => 'There are no orphaned records in the MTL_PENDING_ITEM_STATUS table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_ORPHAN_RECORDS_STATUS');



debug('begin add_signature: ITEM_ORPHAN_RECORDS_TL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7087',
      p_sig_id                 => 'ITEM_ORPHAN_RECORDS_TL',
      p_sig_sql                => 'select *
from mtl_system_items_tl msit
where not exists (select ''X'' from mtl_system_items_b item 
where item.inventory_item_id = msit.inventory_item_id 
and item.organization_id = msit.organization_id)
and msit.organization_id = ##$$ORGID$$##  
and msit.inventory_item_id = ##$$ITEMID$$##
',
      p_title                  => 'Item Orphan Records Data Corruption in the MTL_SYSTEM_ITEMS_TL Table',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Item orphan records present in MTL_SYSTEM_ITEMS_TL table but not present in MTL_SYSTEM_ITEMS_B table.',
      p_solution               => 'This issue will prevent users from assigning orphaned items to a child organization. To resolve:<br>
<ul>
<li>Review [1065107/KB794567] - APP-INV-05479 Standard Datafix To Find Orphan Item Records, for all steps to resolve the issue.</li>
</ul>
',
      p_success_msg            => 'There are no orphaned records in the MTL_SYSTEM_ITEMS_TL table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_ORPHAN_RECORDS_TL');



debug('begin add_signature: ITEM_INVALID_DUAL_UOM_CONTROL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7451',
      p_sig_id                 => 'ITEM_INVALID_DUAL_UOM_CONTROL',
      p_sig_sql                => 'SELECT INVENTORY_ITEM_ID,
ORGANIZATION_ID,
DUAL_UOM_CONTROL,
TRACKING_QUANTITY_IND,
...
from mtl_system_items_b
where DUAL_UOM_CONTROL <> DECODE(NVL(TRACKING_QUANTITY_IND,''P''),''P'',1, DECODE(NVL(SECONDARY_DEFAULT_IND,''X''),''F'',2,''D'',3, 4))
and inventory_item_id = ##$$ITEMID$$##
and organization_id = ##$$ORGID$$##',
      p_title                  => 'Item Dual UOM Control Data Corruption in  MTL_SYSTEM_ITEMS_B',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The item is not having valid value for DUAL_UOM_CONTROL.',
      p_solution               => 'Please execute the datafix present at Section G in [1933028/KB159361] - FRM-40654 or FRM-40735 20001 Errors In The Item Master Or Item Child Organizations Form INVIDITM.fmb',
      p_success_msg            => 'DUAL_UOM_CONTROL is valid for this item and organization combination.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_INVALID_DUAL_UOM_CONTROL');



debug('begin add_signature: ITEM_SHIPPABLE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14754',
      p_sig_id                 => 'ITEM_SHIPPABLE_CHECK',
      p_sig_sql                => 'SELECT INVENTORY_ITEM_ID, ORGANIZATION_ID, INTERNAL_ORDER_FLAG, SHIPPABLE_ITEM_FLAG, CONTRACT_ITEM_TYPE_CODE
FROM   MTL_SYSTEM_ITEMS_B
WHERE  INTERNAL_ORDER_FLAG =''Y''  AND SHIPPABLE_ITEM_FLAG =''N''
AND    NVL(CONTRACT_ITEM_TYPE_CODE, ''SUBSCRIPTION'') NOT IN (''WARRANTY'',''SERVICE'',''USAGE'')
AND INVENTORY_ITEM_ID = ##$$ITEMID$$##
AND ORGANIZATION_ID = ##$$ORGID$$##',
      p_title                  => 'Shippable Item Attribute Validation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'If Internal Ordered flag is "Yes", then Shippable Flag has to be "Yes"',
      p_solution               => 'This incorrect attribute setup might result in unable to update Items. To resolve:
<ul>
<li>Review [1676349/KB657412] - Invalid Combination Of SHIPPABLE_ITEM_FLAG, INTERNAL_ORDER_ENABLED_FLAG, INTERNAL_ORDER_FLAG Item Attributes</li>
</ul>',
      p_success_msg            => 'Shippable Item Attribute setup correctly.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_SHIPPABLE_CHECK');



debug('begin add_signature: ITEM_MILK_NULL_PHYSICAL_LOCATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18393',
      p_sig_id                 => 'ITEM_MILK_NULL_PHYSICAL_LOCATION',
      p_sig_sql                => 'SELECT INVENTORY_LOCATION_ID,ORGANIZATION_ID,CONCATENATED_SEGMENTS,PADDED_CONCATENATED_SEGMENTS,REQUEST_ID,PROGRAM_APPLICATION_ID,PROGRAM_ID,PROGRAM_UPDATE_DATE,PROJECT_ID,TASK_ID,PHYSICAL_LOCATION_ID,PICK_UOM_CODE,DIMENSION_UOM_CODE,LENGTH,WIDTH,HEIGHT,LOCATOR_STATUS,STATUS_ID
FROM   MTL_ITEM_LOCATIONS_KFV
WHERE  PROJECT_ID IS NOT NULL
AND    PHYSICAL_LOCATION_ID IS NULL
AND    ORGANIZATION_ID = ##$$ORGID$$##
ORDER BY 1',
      p_title                  => 'Locations which PHYSICAL_LOCATION_ID is Null',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are locations where physical_location_id is null',
      p_solution               => 'See note, There Are Locations For Which PHYSICAL_LOCATION_ID Is Null [2408362/KB626313]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_MILK_NULL_PHYSICAL_LOCATION');



debug('begin add_signature: EBS_MFG_INV_INVITMANALYZER_DUPLICATE_CAT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24957',
      p_sig_id                 => 'EBS_MFG_INV_INVITMANALYZER_DUPLICATE_CAT',
      p_sig_sql                => 'SELECT structure_id,
  segment1 seg1,
  NVL(segment2,''x'') seg2,
  NVL(segment3,''x'') seg3,
  NVL(segment4,''x'') seg4,
...
WHERE EXISTS (SELECT 1 FROM mtl_item_categories i
WHERE i.CATEGORY_ID = mcb.CATEGORY_ID
AND inventory_item_id=''##$$ITEMID$$##''
AND organization_id = ''##$$ORGID$$##'' )
HAVING COUNT(*) > 1
GROUP BY structure_id,
  ...
  NVL(segment7,''x'') ,
  NVL(segment8,''x'')',
      p_title                  => 'Duplicate Category Names',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Duplicate Item categories exist and are assigned to the item. ',
      p_solution               => 'Please review [1488122/KB208088] and apply the relevant solution to clean up duplicate categories. ',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVITMANALYZER_DUPLICATE_CAT');



debug('begin add_signature: EBS_MFG_INV_INVITMANALYZER_FLXSEPAR_IN_ITMNUM');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25840',
      p_sig_id                 => 'EBS_MFG_INV_INVITMANALYZER_FLXSEPAR_IN_ITMNUM',
      p_sig_sql                => ' SELECT msi.segment1, msi.segment2,  msi.segment3, msi.organization_id
 FROM mtl_system_items_b msi, fnd_id_flex_structures  FLEX
 WHERE (application_id=401) AND (id_flex_code=''MSTK'')
 AND  (instr( msi.segment1, FLEX.concatenated_segment_delimiter) > 0
         or  instr( msi.segment2, FLEX.concatenated_segment_delimiter) > 0
         or  instr( msi.segment3, FLEX.concatenated_segment_delimiter) > 0) 
 AND inventory_item_id = ##$$ITEMID$$## 
 AND organization_id = ##$$ORGID$$##',
      p_title                  => 'Flexfield Separator Within Item Number',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Item Key Flexfield Separator is part of the item number segments. This could cause issues with searching the item on various forms or making changes to them. ',
      p_solution               => 'Review [987417/KB761091] - Unable To Transact, Search, Create Items with Period (.) Or Dot; Significance of Item Flexfield Segment Separator',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVITMANALYZER_FLXSEPAR_IN_ITMNUM');



debug('begin add_signature: Duplicate_Item_Numbers_MSIB');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3368',
      p_sig_id                 => 'Duplicate_Item_Numbers_MSIB',
      p_sig_sql                => 'SELECT ORGANIZATION_ID, SEGMENT1, SEGMENT2, SEGMENT3, SEGMENT4, SEGMENT5,
...
COUNT(1)
FROM MTL_SYSTEM_ITEMS_B
WHERE INVENTORY_ITEM_ID = NVL(##$$ITEMID$$## , -1)
GROUP BY ORGANIZATION_ID, SEGMENT1, SEGMENT2, SEGMENT3, SEGMENT4, SEGMENT5,
SEGMENT6, SEGMENT7, SEGMENT8, SEGMENT9, SEGMENT10, SEGMENT11, SEGMENT12,
SEGMENT13, SEGMENT14, SEGMENT15, SEGMENT16, SEGMENT17, SEGMENT18, SEGMENT19, SEGMENT20
HAVING COUNT(1) > 1',
      p_title                  => 'Duplicate Item Number/Description in Table MTL_SYSTEM_ITEMS_B',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Duplicate item numbers with different INVENTORY_ITEM_IDS',
      p_solution               => 'Review [809291/KB455990] - INVIDITM - Duplicate Item Numbers Causing APP-FND-00906 When Querying Items.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: Duplicate_Item_Numbers_MSIB');



debug('begin add_signature: EBS_MFG_INV_INVITMANALYZER_SUPPLY_NONEXS_SRCDOC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27257',
      p_sig_id                 => 'EBS_MFG_INV_INVITMANALYZER_SUPPLY_NONEXS_SRCDOC',
      p_sig_sql                => 'select supply_type_code  , count(1)
  from mtl_supply ms
  where supply_type_code =''PO''
  and not exists (select ''x''
      from po_headers_all ph
      where ms.po_header_id = ph.po_header_id)
  and ms.to_organization_id = ##$$ORGID$$##
  and ms.item_id = ##$$ITEMID$$##
  group by supply_type_code  
UNION
 select supply_type_code,count(1)
  from mtl_supply ms
...
where supply_type_code = ''REQ''
 and not exists (select ''x''
  ...
  and ms.item_id = ##$$ITEMID$$##
group by supply_type_code',
      p_title                  => 'Supply Referencing Non-Existent POs / Requisitions / Shipments',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'MTL_SUPPLY table has rows referencing either one or more of the below cases for this item  -
-   Purchase Orders which do not exist in PO_HEADERS_ALL table
-  Requisitions which do not exist PO_REQUISTION_HEADERS_ALL
- Shipments which do not exist in RCV_SHIPMENT_HEADERS table

These are corrupted records and will require a datafix.',
      p_solution               => 'For a possible solution, Review [2287578/KB760375] : Orphan Data in MTL_SUPPLY Table ',
      p_success_msg            => 'There are no records in Mtl_Supply for non-existent source documents for this item.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVITMANALYZER_SUPPLY_NONEXS_SRCDOC');



debug('begin add_signature: EBS_MFG_INV_INVITMANALYZER_INV_IOI_MASTER_CHILD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28410',
      p_sig_id                 => 'EBS_MFG_INV_INVITMANALYZER_INV_IOI_MASTER_CHILD',
      p_sig_sql                => 'SELECT M.ORGANIZATION_ID MASTERORG,
...
WHERE MESSAGE_NAME IN (''INV_IOI_MASTER_CHILD_1A'',
...
AND M.ORGANIZATION_ID = NVL(''##$$ORGID$$##'', M.ORGANIZATION_ID)
AND M.INVENTORY_ITEM_ID = NVL (''##$$ITEMID$$##'', M.INVENTORY_ITEM_ID)',
      p_title                  => 'Error INV_IOI_MASTER_CHILD for Item across all organizations',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Determine by failed item which attribute(s) has values that are different between the master organization item and the child organization item.',
      p_solution               => 'See the details in [429924/KB586901] Understanding Item Import and Debugging Problems with Item Import',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVITMANALYZER_INV_IOI_MASTER_CHILD');



debug('begin add_signature: ITEM_MISSING_CHILD_CATEGORY_ASSIGNMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10388',
      p_sig_id                 => 'ITEM_MISSING_CHILD_CATEGORY_ASSIGNMENTS',
      p_sig_sql                => 'SELECT ORGANIZATION_ID,
  INVENTORY_ITEM_ID,
  CATEGORY_SET_ID,
  CATEGORY_ID
FROM MTL_ITEM_CATEGORIES C
WHERE C.CATEGORY_SET_ID IN
  (SELECT CATEGORY_SET_ID FROM MTL_CATEGORY_SETS_B WHERE CONTROL_LEVEL = 1
  )
AND C.ORGANIZATION_ID = ##$$MASTERORGID$$##
AND NOT EXISTS
  (SELECT ''X''
  FROM MTL_ITEM_CATEGORIES D
  WHERE D.ORGANIZATION_ID IN
    (SELECT MP.ORGANIZATION_ID
    FROM MTL_PARAMETERS MP
    WHERE MP.MASTER_ORGANIZATION_ID = ##$$MASTERORGID$$##
  ...
  AND D.INVENTORY_ITEM_ID = C.INVENTORY_ITEM_ID
      ...
      p_title                  => 'Missing Child Category Assignments For Master Controlled Category Sets',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'For Master Controlled Category Sets, there are category assignments in the master organization for which there is no corresponding child organization category assignment.',
      p_solution               => '<ul>
<li>Please execute the datafix to insert categories that are not present in the child organization</li>
<li>See the solution in [1064556/KB246088] - Standard Datafix To Rectify Master Controlled Category Assignment Errors</li>
</ul>',
      p_success_msg            => 'There are no missing child category assignments for master controlled category sets',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_MISSING_CHILD_CATEGORY_ASSIGNMENTS');



debug('begin add_signature: EBS_MFG_INV_INVITMANALYZER_MASTER_CHILD_CONFLICT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29403',
      p_sig_id                 => 'EBS_MFG_INV_INVITMANALYZER_MASTER_CHILD_CONFLICT',
      p_sig_sql                => 'WITH attribute_info AS (
    SELECT
        msi.segment1,msi.inventory_item_id,msi.organization_id,mp.organization_code,mp.master_organization_id,
        (SELECT organization_code
            FROM mtl_parameters mp2
            WHERE mp2.organization_id = mp.master_organization_id) master_org_code,
        decode(mp.master_organization_id, msi.organization_id, ''Master'', ''Child'') master_child_org,
        (SELECT  mfg1.meaning user_group_name
            FROM mfg_lookups mfg1
            WHERE mfg1.lookup_type = ''ITEM_CHOICES_GUI''
             AND mfg1.lookup_code = mia.attribute_group_id_gui)user_group_name,
        attribute_name,
        ...
        (SELECT mfg2.meaning
            ...
            AND mfg2.lookup_code = mia.control_level ) control_level_meaning,
        decode(replace(attribute_name,''MTL_SYSTEM_ITEMS.'',''''),
''DESCRIPTION'',to_char(msi.description),
''ALLOWED_UNITS_LOOKUP_CODE'',to_char(msi.allowed_units_lookup_code),
''ITEM_TYPE'',to_char(msi.item_type),
''BASE_ITEM_ID'',to_char(msi.base_item_id),
''BOM_ITEM_TYPE'',to_char(msi.bom_item_type),
''ENGINEERING_ECN_CODE'',to_char(msi.engineering_ecn_code),
''DEFAULT_INCLUDE_IN_ROLLUP_FLAG'',to_char(msi.default_include_in_rollup_flag),
''BUYER_ID'',to_char(msi.buyer_id),
''EXPENSE_ACCOUNT'',to_char(msi.expense_account),
''MARKET_PRICE'',to_char(msi.market_price),
''MUST_USE_APPROVED_VENDOR_FLAG'',to_char(msi.must_use_approved_vendor_flag),
''PRICE_TOLERANCE_PERCENT'',to_char(msi.price_tolerance_percent),
''PURCHASING_ITEM_FLAG'',to_char(msi.purchasing_item_flag),
''RFQ_REQUIRED_FLAG'',to_char(msi.rfq_required_flag),
''TAXABLE_FLAG'',to_char(msi.taxable_flag),
''UNIT_OF_ISSUE'',to_char(msi.unit_of_issue),
''ALLOW_EXPRESS_DELIVERY_FLAG'',to_char(msi.allow_express_delivery_flag),
''ALLOW_SUBSTITUTE_RECEIPTS_FLAG'',to_char(msi.allow_substitute_receipts_flag),
''INVOICE_CLOSE_TOLERANCE'',to_char(msi.invoice_close_tolerance),
''QTY_RCV_TOLERANCE'',to_char(msi.qty_rcv_tolerance),
''RECEIPT_DAYS_EXCEPTION_CODE'',to_char(msi.receipt_days_exception_code),
''RECEIPT_REQUIRED_FLAG'',to_char(msi.receipt_required_flag),
''AUTO_LOT_ALPHA_PREFIX'',to_char(msi.auto_lot_alpha_prefix),
''AUTO_SERIAL_ALPHA_PREFIX'',to_char(msi.auto_serial_alpha_prefix),
''CYCLE_COUNT_ENABLED_FLAG'',to_char(msi.cycle_count_enabled_flag),
''INVENTORY_ITEM_FLAG'',to_char(msi.inventory_item_flag),
''MTL_TRANSACTIONS_ENABLED_FLAG'',to_char(msi.mtl_transactions_enabled_flag),
''NEGATIVE_MEASUREMENT_ERROR'',to_char(msi.negative_measurement_error),
''RESERVABLE_TYPE'',to_char(msi.reservable_type),
''RESTRICT_LOCATORS_CODE'',to_char(msi.restrict_locators_code),
''RESTRICT_SUBINVENTORIES_CODE'',to_char(msi.restrict_subinventories_code),
''REVISION_QTY_CONTROL_CODE'',to_char(msi.revision_qty_control_code),
''SERIAL_NUMBER_CONTROL_CODE'',to_char(msi.serial_number_control_code),
''SHELF_LIFE_CODE'',to_char(msi.shelf_life_code),
''SHELF_LIFE_DAYS'',to_char(msi.shelf_life_days),
''UNIT_WEIGHT'',to_char(msi.unit_weight),
''VOLUME_UOM_CODE'',to_char(msi.volume_uom_code),
''FIXED_DAYS_SUPPLY'',to_char(msi.fixed_days_supply),
''MAXIMUM_ORDER_QUANTITY'',to_char(msi.maximum_order_quantity),
''MAX_MINMAX_QUANTITY'',to_char(msi.max_minmax_quantity),
''ORDER_COST'',to_char(msi.order_cost),
''PLANNER_CODE'',to_char(msi.planner_code),
''SAFETY_STOCK_BUCKET_DAYS'',to_char(msi.safety_stock_bucket_days),
''SOURCE_SUBINVENTORY'',to_char(msi.source_subinventory),
''ACCEPTABLE_EARLY_DAYS'',to_char(msi.acceptable_early_days),
''ACCEPTABLE_RATE_DECREASE'',to_char(msi.acceptable_rate_decrease),
''ACCEPTABLE_RATE_INCREASE'',to_char(msi.acceptable_rate_increase),
''AUTO_REDUCE_MPS'',to_char(msi.auto_reduce_mps),
''DEMAND_TIME_FENCE_CODE'',to_char(msi.demand_time_fence_code),
''MRP_PLANNING_CODE'',to_char(msi.mrp_planning_code),
''PLANNING_EXCEPTION_SET'',to_char(msi.planning_exception_set),
''PLANNING_TIME_FENCE_DAYS'',to_char(msi.planning_time_fence_days),
''REPETITIVE_PLANNING_FLAG'',to_char(msi.repetitive_planning_flag),
''ROUNDING_CONTROL_TYPE'',to_char(msi.rounding_control_type),
''CUMULATIVE_TOTAL_LEAD_TIME'',to_char(msi.cumulative_total_lead_time),
''FIXED_LEAD_TIME'',to_char(msi.fixed_lead_time),
''PREPROCESSING_LEAD_TIME'',to_char(msi.preprocessing_lead_time),
''BUILD_IN_WIP_FLAG'',to_char(msi.build_in_wip_flag),
''WIP_SUPPLY_LOCATOR_ID'',to_char(msi.wip_supply_locator_id),
''ATP_FLAG'',to_char(msi.atp_flag),
''ATP_RULE_ID'',to_char(msi.atp_rule_id),
''CUSTOMER_ORDER_FLAG'',to_char(msi.customer_order_flag),
''DEFAULT_SHIPPING_ORG'',to_char(msi.default_shipping_org),
''PICKING_RULE_ID'',to_char(msi.picking_rule_id),
''RETURN_INSPECTION_REQUIREMENT'',to_char(msi.return_inspection_requirement),
''SHIPPABLE_ITEM_FLAG'',to_char(msi.shippable_item_flag),
''SO_TRANSACTIONS_FLAG'',to_char(msi.so_transactions_flag),
''INVOICE_ENABLED_FLAG'',to_char(msi.invoice_enabled_flag),
''INVOICING_RULE_ID'',to_char(msi.invoicing_rule_id),
''SALES_ACCOUNT'',to_char(msi.sales_account),
''MATERIAL_BILLABLE_FLAG'',to_char(msi.material_billable_flag),
''SERVICE_DURATION'',to_char(msi.service_duration),
''VEHICLE_ITEM_FLAG'',to_char(msi.vehicle_item_flag),
''MAXIMUM_LOAD_WEIGHT'',to_char(msi.maximum_load_weight),
''MINIMUM_FILL_PERCENT'',to_char(msi.minimum_fill_percent),
''SERVICEABLE_PRODUCT_FLAG'',to_char(msi.serviceable_product_flag),
''INVENTORY_ASSET_FLAG'',to_char(msi.inventory_asset_flag),
''DAYS_LATE_RECEIPT_ALLOWED'',to_char(msi.days_late_receipt_allowed),
''QTY_RCV_EXCEPTION_CODE'',to_char(msi.qty_rcv_exception_code),
''LOT_CONTROL_CODE'',to_char(msi.lot_control_code),
''CARRYING_COST'',to_char(msi.carrying_cost),
''SOURCE_ORGANIZATION_ID'',to_char(msi.source_organization_id),
''CONTAINER_ITEM_FLAG'',to_char(msi.container_item_flag),
''RELEASE_TIME_FENCE_CODE'',to_char(msi.release_time_fence_code),
''RELEASE_TIME_FENCE_DAYS'',to_char(msi.release_time_fence_days),
''CONTAINER_TYPE_CODE'',to_char(msi.container_type_code),
''SERVICE_STARTING_DELAY'',to_char(msi.service_starting_delay),
''PURCHASING_TAX_CODE'',to_char(msi.purchasing_tax_code),
''OVERCOMPLETION_TOLERANCE_TYPE'',to_char(msi.overcompletion_tolerance_type),
''OVERCOMPLETION_TOLERANCE_VALUE'',to_char(msi.overcompletion_tolerance_value),
''EFFECTIVITY_CONTROL'',to_char(msi.effectivity_control),
''OVER_SHIPMENT_TOLERANCE'',to_char(msi.over_shipment_tolerance),
''UNDER_SHIPMENT_TOLERANCE'',to_char(msi.under_shipment_tolerance),
''RECOVERED_PART_DISP_CODE'',to_char(msi.recovered_part_disp_code),
''DEFECT_TRACKING_ON_FLAG'',to_char(msi.defect_tracking_on_flag),
''EVENT_FLAG'',to_char(msi.event_flag),
''COMMS_ACTIVATION_REQD_FLAG'',to_char(msi.comms_activation_reqd_flag),
''BACK_ORDERABLE_FLAG'',to_char(msi.back_orderable_flag),
''WEB_STATUS'',to_char(msi.web_status),
''CHECK_SHORTAGES_FLAG'',to_char(msi.check_shortages_flag),
''INDIVISIBLE_FLAG'',to_char(msi.indivisible_flag),
''DEFAULT_LOT_STATUS_ID'',to_char(msi.default_lot_status_id),
''SERIAL_STATUS_ENABLED'',to_char(msi.serial_status_enabled),
''DEFAULT_SERIAL_STATUS_ID'',to_char(msi.default_serial_status_id),
''LOT_SPLIT_ENABLED'',to_char(msi.lot_split_enabled),
''LOT_MERGE_ENABLED'',to_char(msi.lot_merge_enabled),
''UNIT_LENGTH'',to_char(msi.unit_length),
''UNIT_WIDTH'',to_char(msi.unit_width),
''INVENTORY_CARRY_PENALTY'',to_char(msi.inventory_carry_penalty),
''OPERATION_SLACK_PENALTY'',to_char(msi.operation_slack_penalty),
''FINANCING_ALLOWED_FLAG'',to_char(msi.financing_allowed_flag),
''LONG_DESCRIPTION'',to_char(msit.long_description),
''PRIMARY_UOM_CODE'',to_char(msi.primary_uom_code),
''SECONDARY_UOM_CODE'',to_char(msi.secondary_uom_code),
''DUAL_UOM_DEVIATION_HIGH'',to_char(msi.dual_uom_deviation_high),
''DUAL_UOM_DEVIATION_LOW'',to_char(msi.dual_uom_deviation_low),
''EAM_ITEM_TYPE'',to_char(msi.eam_item_type),
''EAM_ACTIVITY_CAUSE_CODE'',to_char(msi.eam_activity_cause_code),
''EAM_ACT_NOTIFICATION_FLAG'',to_char(msi.eam_act_notification_flag),
''CONTRACT_ITEM_TYPE_CODE'',to_char(msi.contract_item_type_code),
''LOT_TRANSLATE_ENABLED'',to_char(msi.lot_translate_enabled),
''CREATE_SUPPLY_FLAG'',to_char(msi.create_supply_flag),
''SUBSTITUTION_WINDOW_DAYS'',to_char(msi.substitution_window_days),
''DEFAULT_SO_SOURCE_TYPE'',to_char(msi.default_so_source_type),
''LOT_SUBSTITUTION_ENABLED'',to_char(msi.lot_substitution_enabled),
''CONFIG_MODEL_TYPE'',to_char(msi.config_model_type),
''EAM_ACTIVITY_SOURCE_CODE'',to_char(msi.eam_activity_source_code),
''IB_ITEM_INSTANCE_CLASS'',to_char(msi.ib_item_instance_class),
''MINIMUM_LICENSE_QUANTITY'',to_char(msi.minimum_license_quantity),
''TRACKING_QUANTITY_IND'',to_char(msi.tracking_quantity_ind),
''ONT_PRICING_QTY_SOURCE'',to_char(msi.ont_pricing_qty_source),
''SECONDARY_DEFAULT_IND'',to_char(msi.secondary_default_ind),
''AUTO_CREATED_CONFIG_FLAG'',to_char(msi.auto_created_config_flag),
''CONFIG_ORGS'',to_char(msi.config_orgs),
''CONFIG_MATCH'',to_char(msi.config_match),
''VMI_MINIMUM_UNITS'',to_char(msi.vmi_minimum_units),
''VMI_MINIMUM_DAYS'',to_char(msi.vmi_minimum_days),
''VMI_MAXIMUM_UNITS'',to_char(msi.vmi_maximum_units),
''VMI_MAXIMUM_DAYS'',to_char(msi.vmi_maximum_days),
''VMI_FIXED_ORDER_QUANTITY'',to_char(msi.vmi_fixed_order_quantity),
''SO_AUTHORIZATION_FLAG'',to_char(msi.so_authorization_flag),
''CONSIGNED_FLAG'',to_char(msi.consigned_flag),
''VMI_FORECAST_TYPE'',to_char(msi.vmi_forecast_type),
''FORECAST_HORIZON'',to_char(msi.forecast_horizon),
''ASN_AUTOEXPIRE_FLAG'',to_char(msi.asn_autoexpire_flag),
''CRITICAL_COMPONENT_FLAG'',to_char(msi.critical_component_flag),
''EXCLUDE_FROM_BUDGET_FLAG'',to_char(msi.exclude_from_budget_flag),
''DRP_PLANNED_FLAG'',to_char(msi.drp_planned_flag),
''DAYS_MAX_INV_SUPPLY'',to_char(msi.days_max_inv_supply),
''DAYS_MAX_INV_WINDOW'',to_char(msi.days_max_inv_window),
''DAYS_TGT_INV_SUPPLY'',to_char(msi.days_tgt_inv_supply),
''DAYS_TGT_INV_WINDOW'',to_char(msi.days_tgt_inv_window),
''CONTINOUS_TRANSFER'',to_char(msi.continous_transfer),
''CONVERGENCE'',to_char(msi.convergence),
''DIVERGENCE'',to_char(msi.divergence),
''LOT_DIVISIBLE_FLAG'',to_char(msi.lot_divisible_flag),
''GRADE_CONTROL_FLAG'',to_char(msi.grade_control_flag),
''DEFAULT_GRADE'',to_char(msi.default_grade),
''CHILD_LOT_FLAG'',to_char(msi.child_lot_flag),
''PARENT_CHILD_GENERATION_FLAG'',to_char(msi.parent_child_generation_flag),
''CHILD_LOT_PREFIX'',to_char(msi.child_lot_prefix),
''CHILD_LOT_STARTING_NUMBER'',to_char(msi.child_lot_starting_number),
''CHILD_LOT_VALIDATION_FLAG'',to_char(msi.child_lot_validation_flag),
''RETEST_INTERVAL'',to_char(msi.retest_interval),
''EXPIRATION_ACTION_INTERVAL'',to_char(msi.expiration_action_interval),
''EXPIRATION_ACTION_CODE'',to_char(msi.expiration_action_code),
''MATURITY_DAYS'',to_char(msi.maturity_days),
''HOLD_DAYS'',to_char(msi.hold_days),
''COPY_LOT_ATTRIBUTE_FLAG'',to_char(msi.copy_lot_attribute_flag),
''OUTSOURCED_ASSEMBLY'',to_char(msi.outsourced_assembly),
''SUBCONTRACTING_COMPONENT'',to_char(msi.subcontracting_component),
''REPAIR_PROGRAM'',to_char(msi.repair_program),
''REPAIR_LEADTIME'',to_char(msi.repair_leadtime),
''REPAIR_YIELD'',to_char(msi.repair_yield),
''PREPOSITION_POINT'',to_char(msi.preposition_point),
''CHARGE_PERIODICITY_CODE'',to_char(msi.charge_periodicity_code),
''RECIPE_ENABLED_FLAG'',to_char(msi.recipe_enabled_flag),
''PROCESS_QUALITY_ENABLED_FLAG'',to_char(msi.process_quality_enabled_flag),
''PROCESS_EXECUTION_ENABLED_FLAG'',to_char(msi.process_execution_enabled_flag),
''PROCESS_COSTING_ENABLED_FLAG'',to_char(msi.process_costing_enabled_flag),
''PROCESS_SUPPLY_SUBINVENTORY'',to_char(msi.process_supply_subinventory),
''PROCESS_SUPPLY_LOCATOR_ID'',to_char(msi.process_supply_locator_id),
''PROCESS_YIELD_LOCATOR_ID'',to_char(msi.process_yield_locator_id),
''HAZARDOUS_MATERIAL_FLAG'',to_char(msi.hazardous_material_flag),
''CAS_NUMBER'',to_char(msi.cas_number),
''ENGINEERING_ITEM_ID'',to_char(msi.engineering_item_id),
''COSTING_ENABLED_FLAG'',to_char(msi.costing_enabled_flag),
''EAM_ACT_SHUTDOWN_STATUS'',to_char(msi.eam_act_shutdown_status),
''ALLOW_ITEM_DESC_UPDATE_FLAG'',to_char(msi.allow_item_desc_update_flag),
''INSPECTION_REQUIRED_FLAG'',to_char(msi.inspection_required_flag),
''UN_NUMBER_ID'',to_char(msi.un_number_id),
''HAZARD_CLASS_ID'',to_char(msi.hazard_class_id),
''LIST_PRICE_PER_UNIT'',to_char(msi.list_price_per_unit),
''ASSET_CATEGORY_ID'',to_char(msi.asset_category_id),
''ROUNDING_FACTOR'',to_char(msi.rounding_factor),
''IB_ITEM_TRACKING_LEVEL'',to_char(msi.ib_item_tracking_level),
''START_AUTO_SERIAL_NUMBER'',to_char(msi.start_auto_serial_number),
''LOCATION_CONTROL_CODE'',to_char(msi.location_control_code),
''POSITIVE_MEASUREMENT_ERROR'',to_char(msi.positive_measurement_error),
''DEFAULT_MATERIAL_STATUS_ID'',to_char(msi.default_material_status_id),
''LOT_STATUS_ENABLED'',to_char(msi.lot_status_enabled),
''BULK_PICKED_FLAG'',to_char(msi.bulk_picked_flag),
''MCC_CLASSIFICATION_TYPE'',to_char(msi.mcc_classification_type),
''ENG_ITEM_FLAG'',to_char(msi.eng_item_flag),
''COST_OF_SALES_ACCOUNT'',to_char(msi.cost_of_sales_account),
''STD_LOT_SIZE'',to_char(msi.std_lot_size),
''EAM_ACTIVITY_TYPE_CODE'',to_char(msi.eam_activity_type_code),
''RECEIVE_CLOSE_TOLERANCE'',to_char(msi.receive_close_tolerance),
''OUTSIDE_OPERATION_FLAG'',to_char(msi.outside_operation_flag),
''BOM_ENABLED_FLAG'',to_char(msi.bom_enabled_flag),
''STOCK_ENABLED_FLAG'',to_char(msi.stock_enabled_flag),
''INVENTORY_ITEM_STATUS_CODE'',to_char(msi.inventory_item_status_code),
''OUTSIDE_OPERATION_UOM_TYPE'',to_char(msi.outside_operation_uom_type),
''ENCUMBRANCE_ACCOUNT'',to_char(msi.encumbrance_account),
''RECEIVING_ROUTING_ID'',to_char(msi.receiving_routing_id),
''ENFORCE_SHIP_TO_LOCATION_CODE'',to_char(msi.enforce_ship_to_location_code),
''ALLOW_UNORDERED_RECEIPTS_FLAG'',to_char(msi.allow_unordered_receipts_flag),
''DAYS_EARLY_RECEIPT_ALLOWED'',to_char(msi.days_early_receipt_allowed),
''WEIGHT_UOM_CODE'',to_char(msi.weight_uom_code),
''UNIT_VOLUME'',to_char(msi.unit_volume),
''INTERNAL_VOLUME'',to_char(msi.internal_volume),
''COLLATERAL_FLAG'',to_char(msi.collateral_flag),
''EQUIPMENT_TYPE'',to_char(msi.equipment_type),
''ELECTRONIC_FLAG'',to_char(msi.electronic_flag),
''DOWNLOADABLE_FLAG'',to_char(msi.downloadable_flag),
''DIMENSION_UOM_CODE'',to_char(msi.dimension_uom_code),
''UNIT_HEIGHT'',to_char(msi.unit_height),
''INVENTORY_PLANNING_CODE'',to_char(msi.inventory_planning_code),
''PLANNING_MAKE_BUY_CODE'',to_char(msi.planning_make_buy_code),
''MIN_MINMAX_QUANTITY'',to_char(msi.min_minmax_quantity),
''MRP_SAFETY_STOCK_PERCENT'',to_char(msi.mrp_safety_stock_percent),
''MRP_SAFETY_STOCK_CODE'',to_char(msi.mrp_safety_stock_code),
''FIXED_ORDER_QUANTITY'',to_char(msi.fixed_order_quantity),
''MINIMUM_ORDER_QUANTITY'',to_char(msi.minimum_order_quantity),
''FIXED_LOT_MULTIPLIER'',to_char(msi.fixed_lot_multiplier),
''SOURCE_TYPE'',to_char(msi.source_type),
''ATO_FORECAST_CONTROL'',to_char(msi.ato_forecast_control),
''SHRINKAGE_RATE'',to_char(msi.shrinkage_rate),
''END_ASSEMBLY_PEGGING_FLAG'',to_char(msi.end_assembly_pegging_flag),
''PLANNED_INV_POINT_FLAG'',to_char(msi.planned_inv_point_flag),
''MRP_CALCULATE_ATP_FLAG'',to_char(msi.mrp_calculate_atp_flag),
''OVERRUN_PERCENTAGE'',to_char(msi.overrun_percentage),
''PLANNING_TIME_FENCE_CODE'',to_char(msi.planning_time_fence_code),
''DEMAND_TIME_FENCE_DAYS'',to_char(msi.demand_time_fence_days),
''SUBSTITUTION_WINDOW_CODE'',to_char(msi.substitution_window_code),
''FULL_LEAD_TIME'',to_char(msi.full_lead_time),
''PURCHASING_ENABLED_FLAG'',to_char(msi.purchasing_enabled_flag),
''POSTPROCESSING_LEAD_TIME'',to_char(msi.postprocessing_lead_time),
''VARIABLE_LEAD_TIME'',to_char(msi.variable_lead_time),
''CUM_MANUFACTURING_LEAD_TIME'',to_char(msi.cum_manufacturing_lead_time),
''LEAD_TIME_LOT_SIZE'',to_char(msi.lead_time_lot_size),
''WIP_SUPPLY_TYPE'',to_char(msi.wip_supply_type),
''WIP_SUPPLY_SUBINVENTORY'',to_char(msi.wip_supply_subinventory),
''CUSTOMER_ORDER_ENABLED_FLAG'',to_char(msi.customer_order_enabled_flag),
''INTERNAL_ORDER_FLAG'',to_char(msi.internal_order_flag),
''INTERNAL_ORDER_ENABLED_FLAG'',to_char(msi.internal_order_enabled_flag),
''PICK_COMPONENTS_FLAG'',to_char(msi.pick_components_flag),
''REPLENISH_TO_ORDER_FLAG'',to_char(msi.replenish_to_order_flag),
''ATP_COMPONENTS_FLAG'',to_char(msi.atp_components_flag),
''SHIP_MODEL_COMPLETE_FLAG'',to_char(msi.ship_model_complete_flag),
''RETURNABLE_FLAG'',to_char(msi.returnable_flag),
''OVER_RETURN_TOLERANCE'',to_char(msi.over_return_tolerance),
''UNDER_RETURN_TOLERANCE'',to_char(msi.under_return_tolerance),
''INVOICEABLE_ITEM_FLAG'',to_char(msi.invoiceable_item_flag),
''ACCOUNTING_RULE_ID'',to_char(msi.accounting_rule_id),
''TAX_CODE'',to_char(msi.tax_code),
''PAYMENT_TERMS_ID'',to_char(msi.payment_terms_id),
''SERVICE_DURATION_PERIOD_CODE'',to_char(msi.service_duration_period_code),
''COVERAGE_SCHEDULE_ID'',to_char(msi.coverage_schedule_id),
''SERV_REQ_ENABLED_CODE'',to_char(msi.serv_req_enabled_code),
''SERV_BILLING_ENABLED_FLAG'',to_char(msi.serv_billing_enabled_flag),
''COMMS_NL_TRACKABLE_FLAG'',to_char(msi.comms_nl_trackable_flag),
''ASSET_CREATION_CODE'',to_char(msi.asset_creation_code),
''ORDERABLE_ON_WEB_FLAG'',to_char(msi.orderable_on_web_flag),
''PROCESS_YIELD_SUBINVENTORY'',to_char(msi.process_yield_subinventory),
''START_AUTO_LOT_NUMBER'',to_char(msi.start_auto_lot_number)) attribute_val
    FROM
        mtl_item_attributes mia,mtl_system_items_b  msi,
        mtl_system_items_tl msit,mtl_parameters      mp
    WHERE
        user_attribute_name_gui IS NOT NULL
        AND attribute_name NOT IN ( ''GLOBAL_DESC_FLEX'', ''DESC_FLEX'' )
        AND msi.inventory_item_id=''##$$ITEMID$$##''
        AND msit.inventory_item_id = msi.inventory_item_id
        AND msit.organization_id = msi.organization_id
        AND msi.organization_id = mp.organization_id
        AND msit.language = userenv(''LANG''))
SELECT m.segment1,m.inventory_item_id,m.user_group_name,m.attribute_name,m.user_attribute_name_gui,
    m.organization_code master_org,m.organization_id   master_org_id,c.organization_code child_org,
    c.organization_id child_org_id,m.attribute_val master_org_attribute_value,c.attribute_val child_org_attribute_value
FROM attribute_info m,attribute_info c
WHERE  m.master_child_org = ''Master''
    AND c.master_child_org = ''Child''
    AND c.master_organization_id = m.organization_id
    AND m.control_level_meaning = ''Master''
    AND m.attribute_name = c.attribute_name
    AND m.inventory_item_id = c.inventory_item_id
    AND nvl(c.attribute_val, ''XXXX'') <> nvl(m.attribute_val, ''XXXX'')',
      p_title                  => 'Master Child Attribute Conflict While Doing Item Import',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Determine by failed item which attribute(s) has values that are different between the master organization item and the child organization item.',
      p_solution               => 'See the details in [429924/KB586901] Understanding Item Import and Debugging Problems with Item Import',
      p_success_msg            => 'No issues detected.  See [429924/KB586901] for full details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVITMANALYZER_MASTER_CHILD_CONFLICT');



debug('begin add_signature: EBS_MFG_INV_INVITMANALYZER_ITEMS_MISSING_MSITL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30969',
      p_sig_id                 => 'EBS_MFG_INV_INVITMANALYZER_ITEMS_MISSING_MSITL',
      p_sig_sql                => 'SELECT A.inventory_item_id, A.organization_id, A.description, A.last_update_date, A.last_updated_by, A.creation_date, A.created_by 
FROM mtl_system_items_b A
WHERE  A.inventory_item_id =   ''##$$ITEMID$$##'' 
and  A.organization_id =    ''##$$ORGID$$##''
AND not exists (select ''x'' from mtl_system_items_tl B
where A.organization_id = B.organization_id
and A.inventory_item_id = B.inventory_item_id) ',
      p_title                  => 'Item Records Missing in MTL_SYSTEM_ITEMS_TL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Item records missing in MTL_SYSTEM_ITEMS_TL. This may cause errors like APP-INV-5479 APP-FND-01934 ORA-01403  when querying for item on the Items form. ',
      p_solution               => 'To resolve this data corruption, please review [388325/KB732520] - APP-INV-5479 APP-FND-01934 ORA-01403 Errors in INVIDITM, Missing Records in MTL_SYSTEM_ITEMS_TL Table.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVITMANALYZER_ITEMS_MISSING_MSITL');
...
debug('begin add_signature: PROFILE_OPTIONS_INV_BOM_ENG_PIM');
   l_info('##MASK##D.USER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7450',
      p_sig_id                 => 'PROFILE_OPTIONS_INV_BOM_ENG_PIM',
...
WHERE e.application_id in (401, 431, 702, 703)
...
a.level_id DESC',
      p_title                  => 'Profile Options For Inventory, Bills of Material, Engineering and Product Hub modules',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Displays Profile Options For Inventory, Bills of Material, Engineering and Product Hub modules for all users and at all levels',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PROFILE_OPTIONS_INV_BOM_ENG_PIM');



debug('begin add_signature: EBS_MFG_INV_OPHANLY_BNE_PROFILES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30703',
      p_sig_id                 => 'EBS_MFG_INV_OPHANLY_BNE_PROFILES',
      p_sig_sql                => 'SELECT user_profile_option_name "Profile Option",
a.profile_option_value "Profile Value",
DECODE(a.level_id, 10001, ''Site'',
10002, ''Application'',
...
fnd_profile_options e,
fnd_profile_options_tl t
WHERE e.application_id like 231
AND a.profile_option_id = e.profile_option_id
AND a.level_value = b.application_id(+)
AND a.level_value = c.responsibility_id(+)
AND a.level_value = d.user_id(+)
...
ORDER BY e.profile_option_name,a.level_id DESC',
      p_title                  => 'WebADI Profiles',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Profile values for WebADI',
      p_solution               => ' Profile values for WebADI (BNE)',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_OPHANLY_BNE_PROFILES');
...
debug('begin add_signature: ITM_PIM_CODE_LEVEL_12_0');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5419',
      p_sig_id                 => 'ITM_PIM_CODE_LEVEL_12_0',
      p_sig_sql                => 'SELECT distinct(bug_number), decode((bug_number),
''4440000'',''Release 12.0.0 - ORACLE APPLICATIONS RELEASE 12'',
''5082400'',''Release 12.0.1 : RUP1 FOR ORACLE APPLICATIONS RELEASE 12'',
''5484000'',''Release 12.0.2 : ORACLE E-BUSINESS SUITE 12.0.2 RELEASE UPDATE PACK (RUP2)'',
''6141000'',''Release 12.0.3 : ORACLE E-BUSINESS SUITE 12.0.3 RELEASE UPDATE PACK (RUP3)'',
''6435000'',''Release 12.0.4 :	ORACLE E-BUSINESS SUITE 12.0.4 RELEASE UPDATE PACK (RUP4)'',
''7282993'',''Release 12.0.5'',
''6728000'',''Release 12.0.6 : ORACLE E-BUSINESS SUITE 12.0.6 RELEASE UPDATE PACK (RUP6)'',
''8478486'',''Release 12.0.* : R12 INV/RCV RUP7 Oracle Inventory and Receiving (PO): Release 12.0, Rollup Patch 7'',
''8445429'',''Release 12.0.6 : R12 PIM RUP7 PATCHSET - Standalone patch only on top of 12.0.6 (6728000)'',
''Other'') "Description"
FROM ad_bugs
WHERE bug_number IN
(''4440000'',''5082400'',''5484000'',''6141000'',''6435000'',''7282993'',''6728000'',''8478486'',''8445429'')
ORDER BY 2',
      p_title                  => 'Patches Applied',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Signature gives list of Roll UP patches applied in 12.0 release in INV and PIM (EGO) modules.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ITM_PIM_CODE_LEVEL_12_0');



debug('begin add_signature: ITM_PIM_CODE_LEVEL_12_1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5420',
      p_sig_id                 => 'ITM_PIM_CODE_LEVEL_12_1',
      p_sig_sql                => 'SELECT distinct(bug_number), decode((bug_number),
''6646600'',''Release 12.1.0 : ORACLE E-BUSINESS SUITE 12.1'',
''7303030'',''Release 12.1.1 : 12.1.1 Maintenance Pack'',
''7303033'',''Release 12.1.2 : ORACLE E-BUSINESS SUITE 12.1.2 RELEASE UPDATE PACK (RUP2)'',
''9239090'',''Release 12.1.3 : ORACLE E-BUSINESS SUITE 12.1.3 RELEASE UPDATE PACK (RUP3)'',
''7587155'',''Release 12.1.1 : R12.1.1 OPM-INV Consolidated May-2009'',
''12345554'',''Release 12.1.3 : R12.1.3 OPM-INV Consolidated Apr-2011'',
''12916273'',''Release 12.1.* : R12.1+ INV Dual UOM related fixes 3'',
''13885374'',''Release 12.1.* : R12.1+INV Dual UOM related fixes 4'',
''14586882'',''Release 12.1.* : R12.1+ INV RUP 5'',
''16328540'',''Release 12.1.* : R12.1+ INV RUP 6'',
''16826285'',''Release 12.1.* : R12.1+ INV RUP 7 (Requires RUP6)'',
''17512558'',''Release 12.1.* : R12.1+ INV RUP 7 Consolidated'',
''18076740'',''Release 12.1.* : R12.1+ INV RUP 8'',
''18615837'',''Release 12.1.* : R12.1+ INV RUP 9'',
''19447776'',''Release 12.1.* : R12.1+ INV RUP 10'',
''20187255'',''Release 12.1.* : R12.1+ INV RUP 11'',
''21218468'',''Release 12.1.* : R12.1+ INV RUP 12'',
''22086747'',''Release 12.1.* : R12.1+ INV RUP 13'',
''22598102'',''Release 12.1.* : R12.1+ INV RUP 14'',
''24011188'',''Release 12.1.* : R12.1+ INV RUP 15'',
''13385260'',''Release 12.1.3 : PIM Rollup patch 12.1.3.1 only on top of 12.1.3'',
''16226394'',''Release 12.1.3 : PIM Rollup patch 12.1.3.2 only on top of 12.1.3'',
''17795054'',''Release 12.1.3 : PIM Rollup patch 12.1.3.3 only on top of 12.1.3'',
''Other'') "Description"
FROM ad_bugs
WHERE bug_number IN
(''6646600'',''7303030'',''7303033'',''9239090'',''7587155'',''12345554'',''12916273'',''13885374'',''14586882'',''16328540'',''16826285'',
''17512558'',''18076740'',''18615837'',''19447776'',''20187255'',''21218468'',''22086747'',''22598102'',''24011188'',''13385260'',''16226394'',
''17795054'')
ORDER BY 2',
      p_title                  => 'Patches Applied',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Signature gives list of Roll UP patches applied in 12.1 release in INV and PIM (EGO) modules.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ITM_PIM_CODE_LEVEL_12_1');



debug('begin add_signature: ITM_PIM_CODE_LEVEL_12_2');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5421',
      p_sig_id                 => 'ITM_PIM_CODE_LEVEL_12_2',
      p_sig_sql                => 'SELECT distinct(bug_number), decode((bug_number),
''10079002'',''Release 12.2.0 : ORACLE E-BUSINESS SUITE RELEASE 12.2.0 [R12.2] MAINTENANCE PACK'',
''14222221'',''Release 12.2.1 : ORACLE E-BUSINESS SUITE 12.2.1 RELEASE UPDATE PACK (RUP1)'',
''16207672'',''Release 12.2.2 : ORACLE E-BUSINESS SUITE 12.2.2 RELEASE UPDATE PACK (RUP2)'',
''17020683'',''Release 12.2.3 : ORACLE E-BUSINESS SUITE 12.2.3 RELEASE UPDATE PACK (RUP3)'',
''17919161'',''Release 12.2.4 : ORACLE E-BUSINESS SUITE 12.2.4 RELEASE UPDATE PACK (RUP4)'',
''19676458'',''Release 12.2.5 : ORACLE E-BUSINESS SUITE 12.2.5 RELEASE UPDATE PACK (RUP5)'',
''21900901'',''Release 12.2.6 : ORACLE E-BUSINESS SUITE 12.2.6 RELEASE UPDATE PACK (RUP6)'',
''24690690'',''Release 12.2.7 : ORACLE E-BUSINESS SUITE 12.2.7 RELEASE UPDATE PACK (RUP7)'',
''26787767'',''Release 12.2.8 : ORACLE E-BUSINESS SUITE 12.2.8 RELEASE UPDATE PACK (RUP8)'',
''28840850'',''Release 12.2.9 : ORACLE E-BUSINESS SUITE 12.2.9 RELEASE UPDATE PACK (RUP9)'',
''Other'') "Description"
FROM ad_bugs
WHERE bug_number IN
(''10079002'',''14222221'',''16207672'',''17020683'',''17919161'',''19676458'',''21900901'',''24690690'',''26787767'',''28840850'')
ORDER BY 2',
      p_title                  => 'Patches Applied',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Signature gives list of Roll UP patches applied in 12.2 release in INV and PIM (EGO) modules.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ITM_PIM_CODE_LEVEL_12_2');



debug('begin add_signature: ITEM_OPM_BATCH_NOT_POSTED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5795',
      p_sig_id                 => 'ITEM_OPM_BATCH_NOT_POSTED',
      p_sig_sql                => 'select D.INVENTORY_ITEM_ID, D.ORGANIZATION_ID, D.BATCH_ID, H.BATCH_NO, D.MATERIAL_DETAIL_ID, D.PLAN_QTY, D.ACTUAL_QTY, H.GL_POSTED_IND, H.BATCH_STATUS from GME_MATERIAL_DETAILS D, GME_BATCH_HEADER H
WHERE D.INVENTORY_ITEM_ID = ##$$ITEMID$$## AND 
D.BATCH_ID = H.BATCH_ID AND 
(NVL(H.GL_POSTED_IND, 0) = 0 
AND H.BATCH_STATUS IN (1, 2, 3, 4))',
      p_title                  => 'OPM Batch Records Not yet Posted to GL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are one or more batch records for the item in the GME_BATCH_HEADER Table which have not been posted to GL, which can prevent an Inventory Item from being updated or modified.',
      p_solution               => '<ul>
<li>All the pending batch records in GME_BATCH_HEADER should be posted to the GL before inactivating or updating an item</li>
<li>See the solution in Section 15 of [1932995/KB627831#Section15] to resolve the issue. 
</ul>',
      p_success_msg            => 'No records exist for the item in the GME_MATERIAL_DETAILS and GME_BATCH_HEADER Tables that are pending for posting to the GL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_OPM_BATCH_NOT_POSTED');



debug('begin add_signature: ITEM_ACTIVE_FORMULA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6209',
      p_sig_id                 => 'ITEM_ACTIVE_FORMULA',
      p_sig_sql                => 'SELECT msi.segment1 item_number, ffm.FORMULA_NO,FORMULA_DESC1,GD.MEANING FORMULA_STATUS, 
FFM.LAST_UPDATE_DATE LAST_UPDATED_IN_FORMULA_TABLE
FROM FM_MATL_DTL FMD,FM_form_mst ffm,GMD_STATUS_TL GD,mtl_system_items_b msi
...
and FFM.FORMULA_STATUS=GD.STATUS_CODE
AND GD.LANGUAGE=''US''
AND ffm.formula_status <> 1000
AND fmd.INVENTORY_ITEM_ID = ##$$ITEMID$$## AND fmd.ORGANIZATION_ID = ##$$ORGID$$##',
      p_title                  => 'Items Associated to Formula',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Checking if an OPM formula exists for the item.',
      p_solution               => 'If you are trying to inactivated or change the item, it has to be inactivated from the OPM formula first. If you want to continue using the formula, you will have to inactivate the item from the formula and add another ingredient in its place.',
      p_success_msg            => 'No OPM formula exists with this item.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_ACTIVE_FORMULA');



debug('begin add_signature: ITEM_OPEN_CO');
   l_info('##MASK##ATTRIBUTE_CATEGORY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CANCEL_COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##DESCRIPTIVE_TEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##NEW_REVISION_REASON'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ROUTING_COMMENT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8369',
      p_sig_id                 => 'ITEM_OPEN_CO',
      p_sig_sql                => 'SELECT *
FROM eng_revised_items eri
WHERE eri.revised_item_id = ##$$ITEMID$$##  
AND eri.status_type NOT IN (5, 6)
AND ( eri.NEW_ITEM_REVISION_ID IS NOT null 
OR EXISTS                            
(SELECT NULL
...
AND ROWNUM =1',
      p_title                  => 'Open Change Orders',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are Pending Change Orders for the Item.',
      p_solution               => 'There are pending Engineering Change Orders for the Item.  The catalog for items with open change orders, cannot be changed. To resolve:
<ul>
<li>Review [2303119/KB793787] - INV_INVALID_CATALOG_SETUP - Following items have unimplemented/uncancelled change objects and new item catalog category is not a child of the items current Item Catalog Category, for full details</li>
</ul>',
      p_success_msg            => 'There are No Pending Change Orders for the Item.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_OPEN_CO');



debug('begin add_signature: EBS_MFG_INV_INVITMANALYZER_FRM_40350');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24753',
      p_sig_id                 => 'EBS_MFG_INV_INVITMANALYZER_FRM_40350',
      p_sig_sql                => 'SELECT INVENTORY_ITEM_ID, ORGANIZATION_ID, ENG_ITEM_FLAG 
FROM (SELECT * FROM MTL_SYSTEM_ITEMS_B 
WHERE INVENTORY_ITEM_ID = ##$$ITEMID$$##)
WHERE ENG_ITEM_FLAG = ''Y'' ',
      p_title                  => 'Item Can Not Be Queried in the Primary or Organization Items Form',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'An item cannot be queried in the Primary Items Form, if any of the following are true:

ENG_ITEM_FLAG = Y',
      p_solution               => 'For solutions steps see [413104/KB263919].',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVITMANALYZER_FRM_40350');



debug('begin add_signature: ITEM_COLMN_NUL_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14755',
      p_sig_id                 => 'ITEM_COLMN_NUL_CHECK',
      p_sig_sql                => 'SELECT ATTRIBUTE, VALUE FROM (SELECT inventory_item_id,  bom_enabled_flag,
  bulk_picked_flag,
  catalog_status_flag,
  collateral_flag,
  container_item_flag,
  downloadable_flag,
  to_char(drp_planned_flag) drp_planned_flag,
  electronic_flag,
  to_char(equipment_type) equipment_type,
  event_flag,
  indivisible_flag,
  lot_divisible_flag,
  lot_merge_enabled,
...
AND ( bom_enabled_flag    IS NULL
OR bulk_picked_flag       IS NULL
OR catalog_status_flag    IS NULL
OR collateral_flag        IS NULL
OR container_item_flag    IS NULL
OR downloadable_flag      IS NULL
OR drp_planned_flag       IS NULL
OR electronic_flag        IS NULL
OR equipment_type         IS NULL
OR event_flag             IS NULL
OR indivisible_flag       IS NULL
OR lot_divisible_flag     IS NULL
OR lot_merge_enabled      IS NULL
OR lot_split_enabled      IS NULL
OR lot_status_enabled     IS NULL
OR lot_substitution_enabled IS NULL
OR lot_translate_enabled  IS NULL
OR mrp_calculate_atp_flag IS NULL
OR recipe_enabled_flag    IS NULL
OR serial_status_enabled  IS NULL
OR serial_tagging_flag    IS NULL
OR vehicle_item_flag      IS NULL )
)
UNPIVOT INCLUDE NULLS
(
VALUE FOR (ATTRIBUTE) IN
(
  bom_enabled_flag AS          ''bom_enabled_flag'',    
  bulk_picked_flag AS          ''bulk_picked_flag'',
  catalog_status_flag AS       ''catalog_status_flag'',
  collateral_flag AS           ''collateral_flag'',
  container_item_flag AS       ''container_item_flag'',
  downloadable_flag AS         ''downloadable_flag'',
  drp_planned_flag AS          ''drp_planned_flag'',
  electronic_flag AS           ''electronic_flag'',
  equipment_type AS            ''equipment_type'',
  event_flag AS                ''event_flag'',
  indivisible_flag AS          ''indivisible_flag'',
  lot_divisible_flag AS        ''lot_divisible_flag'',
  lot_merge_enabled AS         ''lot_merge_enabled'',
  lot_split_enabled AS         ''lot_split_enabled'',
  lot_status_enabled AS        ''lot_status_enabled'',
  lot_substitution_enabled  AS  ''lot_substitution_enabled'',
  lot_translate_enabled AS     ''lot_translate_enabled'',
  mrp_calculate_atp_flag AS    ''mrp_calculate_atp_flag'',
  recipe_enabled_flag AS       ''recipe_enabled_flag'',
  serial_status_enabled AS     ''serial_status_enabled'',
  serial_tagging_flag AS       ''serial_tagging_flag'',
  vehicle_item_flag AS         ''vehicle_item_flag''
))',
      p_title                  => 'Check for Specific Null Value Columns in Item',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'For listed attributes the default value in 11i was NULL, new default in R12 is ''N'' OR Not Null',
      p_solution               => 'This incorrect attribute value might result in INV_IOI_MASTER_CHILD Errors. To resolve:
<ul>
<li>Review [1959547/KB252056] - Data Fix To Correct INV_IOI_MASTER_CHILD Errors After Upgrade from 11i to R12</li>
</ul>',
      p_success_msg            => 'Values for related attributes is correct',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_COLMN_NUL_CHECK');



debug('begin add_signature: EBS_MFG_INV_INVITMANALYZER_SHELF_LIFE_MISMATCH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25681',
      p_sig_id                 => 'EBS_MFG_INV_INVITMANALYZER_SHELF_LIFE_MISMATCH',
      p_sig_sql                => 'SELECT LOT_CONTROL_CODE, SHELF_LIFE_CODE, inventory_item_id, organization_id, segment1 item_number
from MTL_SYSTEM_ITEMS_B a
where LOT_CONTROL_CODE = 1
and SHELF_LIFE_CODE = 4 
AND INVENTORY_ITEM_ID = ''##$$ITEMID$$##''
AND ORGANIZATION_ID = ''##$$ORGID$$##''',
      p_title                  => 'Mismatch of Lot Control Code and Shelf Life Control',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There is a mismatch of shelf life control and lot control attributes for the item which may prevent any update on the item and may result in error like below.

Shelf Life Days can not be specified when Shelf Life Code is no control',
      p_solution               => 'See [2797159/KB754689] for solution.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVITMANALYZER_SHELF_LIFE_MISMATCH');



debug('begin add_signature: ITEM_UOM_DETAILS_11');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14797',
      p_sig_id                 => 'ITEM_UOM_DETAILS_11',
      p_sig_sql                => 'SELECT distinct ALL_UOM.UOM_CODE UOM_CODE,
ALL_UOM.SOURCE_LANG UOM_SOURCE_LANG,
ALL_UOM.UNIT_OF_MEASURE UNIT_OF_MEASURE,
ALL_UOM.LANGUAGE UOM_LANG,
ALL_UOM.UNIT_OF_MEASURE_TL UNIT_OF_MEASURE_TL,
ALL_UOM.BASE_UOM_FLAG,
ALL_UOM.DISABLE_DATE UOM_DISABLE_DATE,
ALL_UOM.UOM_CLASS UOM_CLASS
FROM MTL_UNITS_OF_MEASURE_TL ITM_UOM,
MTL_UNITS_OF_MEASURE_TL ALL_UOM,
MTL_UOM_CLASS_CONVERSIONS uc,
MTL_SYSTEM_ITEMS_B MSI
WHERE MSI.INVENTORY_ITEM_ID =  ##$$ITEMID$$##  
AND MSI.ORGANIZATION_ID = ##$$ORGID$$##
AND ITM_UOM.UOM_CODE      IN (MSI.PRIMARY_UOM_CODE,MSI.SECONDARY_UOM_CODE)
AND uc.INVENTORY_ITEM_ID (+) = MSI.INVENTORY_ITEM_ID 
AND ALL_UOM.UOM_CLASS In ( ITM_UOM.UOM_CLASS, uc.TO_UOM_CLASS)
order by ALL_UOM.UOM_CLASS,ALL_UOM.UNIT_OF_MEASURE',
      p_title                  => 'ITEM UOM DETAILS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'List details of UOMs in Primary UOM Class, Secondary UOM Class and Convertibles classes',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_UOM_DETAILS_11');



debug('begin add_signature: ITEM_UOM_CLASS_DETAILS_11');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14798',
      p_sig_id                 => 'ITEM_UOM_CLASS_DETAILS_11',
      p_sig_sql                => 'SELECT distinct UOM_CLASSES.UOM_CLASS UOM_CLASS,
UOM_CLASSES.SOURCE_LANG CLASS_SOURCE_LANG,
UOM_CLASSES.UOM_CLASS_TL UOM_CLASS_TL,
UOM_CLASSES.LANGUAGE UOM_CLASS_LANG,
UOM_CLASSES.DISABLE_DATE CLASS_DISABLE_DATE
FROM MTL_UNITS_OF_MEASURE_TL ITM_UOM,
MTL_UOM_CLASSES_TL UOM_CLASSES,
MTL_UOM_CLASS_CONVERSIONS uc,
MTL_SYSTEM_ITEMS_B MSI
WHERE MSI.INVENTORY_ITEM_ID =  ##$$ITEMID$$##   
AND MSI.ORGANIZATION_ID = ##$$ORGID$$##
AND ITM_UOM.UOM_CODE      IN (MSI.PRIMARY_UOM_CODE,MSI.SECONDARY_UOM_CODE)
AND uc.INVENTORY_ITEM_ID (+) = MSI.INVENTORY_ITEM_ID 
AND UOM_CLASSES.UOM_CLASS In ( ITM_UOM.UOM_CLASS, uc.TO_UOM_CLASS)
order by UOM_CLASSES.UOM_CLASS',
      p_title                  => 'ITEM UOM CLASS DETAILS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'List details of Primary UOM Class, Secondary UOM Class and Convertibles classes',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_UOM_CLASS_DETAILS_11');



debug('begin add_signature: ITEM_UOM_CONVERSIONS_11');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14799',
      p_sig_id                 => 'ITEM_UOM_CONVERSIONS_11',
      p_sig_sql                => 'select conv.conversion conversion_type, 
''1 '' || conv.to_uom ||'' (''|| conv.to_uom_CLASS ||''.''||conv.to_uom_CODE||'') = ''||
conv.CONVERSION_RATE ||'' ''||
conv.from_uom ||'' (''|| conv.from_uom_CLASS||''.''||conv.from_uom_CODE||'')'' conversion ,
conv.DISABLE_DATE conv_disable_date,
conv.inventory_item_id conv_item_id, conv.ORGANIZATION_ID conv_org_id
from 
(
-- All Standard Conversions
select ''Standard'' conversion,
muc.unit_of_measure to_uom, muc.uom_code to_uom_code, muc.uom_class to_uom_class, 
mum.unit_of_measure from_uom, mum.uom_code from_uom_code, muc.uom_class from_uom_class,  
muc.conversion_rate,  muc.disable_date ,
0 INVENTORY_ITEM_ID, 
0 ORGANIZATION_ID
from MTL_UOM_CONVERSIONS muc, mtl_units_of_measure mum
where muc.inventory_item_id = 0
AND muc.uom_class=mum.uom_class
AND mum.BASE_UOM_FLAG=''Y''

UNION

-- All Intra-class Conversions      
select ''Intra-Class'' conversion,
muc.unit_of_measure to_uom, muc.uom_code to_uom_code, muc.uom_class to_uom_class, 
mum.unit_of_measure from_uom, mum.uom_code from_uom_code, muc.uom_class from_uom_class,  
muc.conversion_rate,  muc.disable_date ,inventory_item_id, 
0 ORGANIZATION_ID
from MTL_UOM_CONVERSIONS muc, mtl_units_of_measure mum
where muc.inventory_item_id <> 0
AND muc.uom_class=mum.uom_class
...
-- All Inter-class Conversions          
select ''Inter-Class'' conversion ,
TO_UNIT_OF_MEASURE to_uom, TO_UOM_CODE to_uom_code, TO_UOM_CLASS to_uom_class, 
FROM_UNIT_OF_MEASURE from_uom, FROM_UOM_CODE from_uom_code, FROM_UOM_CLASS from_uom_class,  
conversion_rate,  disable_date, inventory_item_id,0 ORGANIZATION_ID
...
where msi.inventory_item_id = ##$$ITEMID$$##
AND msi.ORGANIZATION_ID= ##$$ORGID$$##  
AND msi.PRIMARY_UOM_CODE = puom.uom_code
AND msi.SECONDARY_UOM_CODE  = suom.UOM_CODE (+)
AND conv.ORGANIZATION_ID in (0,msi.ORGANIZATION_ID)
AND conv.inventory_item_id in (0,msi.inventory_item_id)
AND (conv.from_uom_class in (puom.UOM_CLASS,suom.UOM_CLASS)  OR conv.inventory_item_id = msi.inventory_item_id )
order by conversion_type,from_uom_class,from_uom_CODE',
      p_title                  => 'ITEM UOM CONVERSIONS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'List details of all conversions to Item''s primary/secondary UOM',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_UOM_CONVERSIONS_11');



debug('begin add_signature: ITEM_UOM_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14751',
      p_sig_id                 => 'ITEM_UOM_DETAILS',
      p_sig_sql                => 'SELECT distinct ALL_UOM.UOM_CODE UOM_CODE,
ALL_UOM.SOURCE_LANG UOM_SOURCE_LANG,
ALL_UOM.UNIT_OF_MEASURE UNIT_OF_MEASURE,
ALL_UOM.LANGUAGE UOM_LANG,
...
MTL_UNITS_OF_MEASURE_TL ALL_UOM,
MTL_UOM_CLASS_CONVERSIONS uc,
MTL_LOT_UOM_CLASS_CONVERSIONS luc,  				
MTL_SYSTEM_ITEMS_B MSI
WHERE MSI.INVENTORY_ITEM_ID =  ##$$ITEMID$$##  
AND MSI.ORGANIZATION_ID = ##$$ORGID$$##
AND ITM_UOM.UOM_CODE      IN (MSI.PRIMARY_UOM_CODE,MSI.SECONDARY_UOM_CODE)
AND uc.INVENTORY_ITEM_ID (+) = MSI.INVENTORY_ITEM_ID 
AND luc.INVENTORY_ITEM_ID (+) = MSI.INVENTORY_ITEM_ID    
AND luc.ORGANIZATION_ID (+) = MSI.ORGANIZATION_ID      			
AND ALL_UOM.UOM_CLASS In ( ITM_UOM.UOM_CLASS, uc.TO_UOM_CLASS, luc.TO_UOM_CLASS)
order by ALL_UOM.UOM_CLASS,ALL_UOM.UNIT_OF_MEASURE',
      p_title                  => 'ITEM UOM DETAILS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'List details of UOMs in Primary UOM Class, Secondary UOM Class and Convertibles classes',
   ...
   l_info.delete;
debug('end add_signature: ITEM_UOM_DETAILS');



debug('begin add_signature: ITEM_UOM_CLASS_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14752',
      p_sig_id                 => 'ITEM_UOM_CLASS_DETAILS',
      p_sig_sql                => 'SELECT distinct UOM_CLASSES.UOM_CLASS UOM_CLASS,
UOM_CLASSES.SOURCE_LANG CLASS_SOURCE_LANG,
UOM_CLASSES.UOM_CLASS_TL UOM_CLASS_TL,
UOM_CLASSES.LANGUAGE UOM_CLASS_LANG,
...
AND luc.INVENTORY_ITEM_ID (+) = MSI.INVENTORY_ITEM_ID    
AND luc.ORGANIZATION_ID (+) = MSI.ORGANIZATION_ID  			
AND UOM_CLASSES.UOM_CLASS In ( ITM_UOM.UOM_CLASS, uc.TO_UOM_CLASS, luc.TO_UOM_CLASS)
order by UOM_CLASSES.UOM_CLASS',
      p_title                  => 'ITEM UOM CLASS DETAILS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'List details of Primary UOM Class, Secondary UOM Class and Convertibles classes ',
   ...
   l_info.delete;
debug('end add_signature: ITEM_UOM_CLASS_DETAILS');



debug('begin add_signature: ITEM_UOM_CONVERSIONS');
   l_info('##MASK##LOT_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14753',
      p_sig_id                 => 'ITEM_UOM_CONVERSIONS',
      p_sig_sql                => 'select conv.conversion conversion_type, 
''1 '' || conv.to_uom ||'' (''|| conv.to_uom_CLASS ||''.''||conv.to_uom_CODE||'') = ''||
conv.CONVERSION_RATE ||'' ''||
conv.from_uom ||'' (''|| conv.from_uom_CLASS||''.''||conv.from_uom_CODE||'')'' conversion ,
conv.DISABLE_DATE conv_disable_date,
conv.inventory_item_id conv_item_id, conv.ORGANIZATION_ID conv_org_id, conv.lot_number conv_lot_num
from 
(
-- All Standard Conversions
select ''Standard'' conversion,
...
TO_UNIT_OF_MEASURE to_uom, TO_UOM_CODE to_uom_code, TO_UOM_CLASS to_uom_class, 
FROM_UNIT_OF_MEASURE from_uom, FROM_UOM_CODE from_uom_code, FROM_UOM_CLASS from_uom_class,  
conversion_rate,  disable_date, inventory_item_id,0 ORGANIZATION_ID, ''NO LOT'' lot_number 
from mtl_uom_class_conversions 
where FROM_UOM_CODE <> TO_UOM_CODE

UNION

-- All Lot Specific Conversions 
select ''Lot Specific'' conversion , TO_UNIT_OF_MEASURE to_uom, TO_UOM_CODE to_uom_code, TO_UOM_CLASS to_uom_class, 
FROM_UNIT_OF_MEASURE from_uom, FROM_UOM_CODE from_uom_code, FROM_UOM_CLASS from_uom_class,  
conversion_rate,  disable_date , inventory_item_id,ORGANIZATION_ID, lot_number
...
',
   ...
   l_info.delete;
debug('end add_signature: ITEM_UOM_CONVERSIONS');
...
BEGIN
  ...
  analyzer_title := 'Inventory Item Analyzer';
...
start_section('Proactive Recommendations', 'Proactive_Recommendations');
   set_item_result(check_rec_patches_1); /* Signature INV_ITM_RECOMMENDED_PATCHES */
   set_item_result(run_stored_sig('INV_EGO_INVALIDS'));
   set_item_result(run_stored_sig('EBS_MFG_INV_INVITMANALYZER_ROW_MOVE_ENABLED'));
   set_item_result(run_stored_sig('EBS_MFG_INV_INVTAZ_FREEZE_DFF_CHECK'));
   set_item_result(run_stored_sig('FORMS_PERSONALIZATIONS2_WARNING'));
end_section;
debug('end section: Proactive_Recommendations');

debug('begin section: Item_PIM_Code_Level');
IF g_sql_tokens('##$$RELEASE$$##') IS NOT NULL THEN
   start_section('Item and PIM Code Level', 'Item_PIM_Code_Level');
      IF substr(g_sql_tokens('##$$RELEASE$$##'),1,4) = '12.0' THEN
         set_item_result(run_stored_sig('ITM_PIM_CODE_LEVEL_12_0'));
      END IF;
      IF substr(g_sql_tokens('##$$RELEASE$$##'),1,4) = '12.1' THEN
         set_item_result(run_stored_sig('ITM_PIM_CODE_LEVEL_12_1'));
      END IF;
      IF substr(g_sql_tokens('##$$RELEASE$$##'),1,4) = '12.2' THEN
         set_item_result(run_stored_sig('ITM_PIM_CODE_LEVEL_12_2'));
      END IF;
   end_section;
END IF;
debug('end section: Item_PIM_Code_Level');

debug('begin section: Item_Information');
start_section('Item Information', 'Item_Information');
   set_item_result(run_stored_sig('EBS_MFG_INV_OPHANLY_ITEM_STATUS_HISTORY'));
   set_item_result(run_stored_sig('ITEM_MTL_SYSTEM_ITEMS_B'));
   set_item_result(run_stored_sig('ITEM_MTL_SYSTEM_ITEMS_TL'));
   set_item_result(run_stored_sig('EBS_MFG_INV_INVTAZ_ITEMS_KFF'));
   set_item_result(run_stored_sig('EBS_MFG_INV_INVTAZ_LOCATOR_KFF'));
   set_item_result(run_stored_sig('ITEM_MTL_ITEM_REVISIONS_B'));
   set_item_result(run_stored_sig('ITEM_MTL_ITEM_REVISIONS_TL'));
   set_item_result(run_stored_sig('ITEM_ATTRIBUTE_DETAILS'));
   set_item_result(run_stored_sig('ITEM_DESCRIPTIVE_ELEMENTS'));
   set_item_result(run_stored_sig('ITEM_LOTS'));
   set_item_result(run_stored_sig('ITEM_SERIAL_NUMBERS'));
   set_item_result(run_stored_sig('ITEM_TRANSACTION_DEFAULTS-SUBINVENTORIES'));
   set_item_result(run_stored_sig('ITEM_TRANSACTION_DEFAULTS-LOCATORS'));
   set_item_result(run_stored_sig('ITEM_ONHAND_LOCATORS'));
   set_item_result(run_stored_sig('ITEM_ONHAND_SUBINVENTORIES'));
   set_item_result(run_stored_sig('ITEM_MTL_ITEM_CATEGORIES'));
   set_item_result(run_stored_sig('ITEM_MTL_ITEM_CATALOG_GROUPS'));
   set_item_result(run_stored_sig('ITEM_RESTRICTED_SUBINVENTORIES'));
   set_item_result(run_stored_sig('ITEM_RESTRICTED_LOCATORS'));
   set_item_result(run_stored_sig('EBS_MFG_INV_INVTAZ_ITEM_FLAGS'));
   set_item_result(run_stored_sig('EBS_MFG_INV_INVITMANALYZER_RELATED_ITEMS'));
   set_item_result(run_stored_sig('EBS_MFG_INV_INVITMANALYZER_MSII_FOR_ITEM'));
   set_item_result(run_stored_sig('EBS_MFG_INV_INVITMANALYZER_INTRFC_ERRORS'));
end_section;
debug('end section: Item_Information');
...
start_section('Organization Details', 'Organization_Details');
   ...
   set_item_result(run_stored_sig('OPHANLY_INACTIVE_ORGS'));
end_section;
debug('end section: Organization_Details');

debug('begin section: Unit_Of_Measure_Details');
start_section('Unit of Measure Details', 'Unit_Of_Measure_Details');
   set_item_result(run_stored_sig('ITEM_UOM_ATTRIBUTES'));
   IF substr(g_sql_tokens('##$$RELEASE$$##'),1,2) = '11' THEN
      set_item_result(run_stored_sig('ITEM_UOM_DETAILS_11'));
      set_item_result(run_stored_sig('ITEM_UOM_CLASS_DETAILS_11'));
      set_item_result(run_stored_sig('ITEM_UOM_CONVERSIONS_11'));
   END IF;
   IF substr(g_sql_tokens('##$$RELEASE$$##'),1,2) = '12' THEN
      set_item_result(run_stored_sig('ITEM_UOM_DETAILS'));
      set_item_result(run_stored_sig('ITEM_UOM_CLASS_DETAILS'));
      set_item_result(run_stored_sig('ITEM_UOM_CONVERSIONS'));
   END IF;
end_section;
debug('end section: Unit_Of_Measure_Details');

debug('begin section: Common_Data_Issues');
start_section('Common Data Issues', 'Common_Data_Issues');
   IF substr(g_sql_tokens('##$$RELEASE$$##'),1,2) = '12' THEN
      set_item_result(run_stored_sig('ITEM_OPM_BATCH_NOT_POSTED'));
      set_item_result(run_stored_sig('ITEM_ACTIVE_FORMULA'));
      set_item_result(run_stored_sig('ITEM_OPEN_CO'));
      set_item_result(run_stored_sig('EBS_MFG_INV_INVITMANALYZER_FRM_40350'));
      set_item_result(run_stored_sig('EBS_MFG_INV_INVITMANALYZER_ITEMS_MISSING_MSITL'));
   END IF;
   IF substr(g_sql_tokens('##$$RELEASE$$##'),1,4) = '12.1'
or
substr(g_sql_tokens('##$$RELEASE$$##'),1,4) = '12.2'
 THEN
      set_item_result(run_stored_sig('ITEM_COLMN_NUL_CHECK'));
      set_item_result(run_stored_sig('EBS_MFG_INV_INVITMANALYZER_SHELF_LIFE_MISMATCH'));
   END IF;
   set_item_result(run_stored_sig('ITEM_LEADING_TRAILING_SPACES'));
   set_item_result(run_stored_sig('ITEM_ONHAND'));
   set_item_result(run_stored_sig('ITEM_PENDING_COST_RECORDS'));
   set_item_result(run_stored_sig('ITEM_PENDING_DELIVERY_DETAILS'));
   set_item_result(run_stored_sig('ITEM_PENDING_DEMAND'));
   set_item_result(run_stored_sig('ITEM_PENDING_MOVE_ORDERS'));
   set_item_result(run_stored_sig('ITEM_PENDING_RESERVATIONS'));
   set_item_result(run_stored_sig('ITEM_PENDING_SALES_ORDER_LINES'));
   set_item_result(run_stored_sig('ITEM_PENDING_SUPPLY'));
   set_item_result(run_stored_sig('ITEM_PENDING_TRANSACTIONS'));
   set_item_result(run_stored_sig('ITEM_OPEN_CYCLE_COUNT_ENTRIES'));
   set_item_result(run_stored_sig('ITEM_OPEN_PHYSICAL_ADJUSTMENTS'));
   set_item_result(run_stored_sig('ITEM_CQL_RECORDS'));
   set_item_result(run_stored_sig('ITEM_WIP_REPITITIVE_RECORDS'));
   set_item_result(run_stored_sig('EBS_MFG_INV_BOMAZ_DELETE_ERRORS'));
   set_item_result(run_stored_sig('ITEM_ORPHAN_RECORDS_CATEGORY'));
   set_item_result(run_stored_sig('ITEM_ORPHAN_RECORDS_CST'));
   set_item_result(run_stored_sig('ITEM_ORPHAN_RECORDS_ENI'));
   set_item_result(run_stored_sig('ITEM_ORPHAN_RECORDS_REV_B'));
   set_item_result(run_stored_sig('ITEM_ORPHAN_RECORDS_REV_TL'));
   set_item_result(run_stored_sig('ITEM_ORPHAN_RECORDS_STATUS'));
   set_item_result(run_stored_sig('ITEM_ORPHAN_RECORDS_TL'));
   set_item_result(run_stored_sig('ITEM_INVALID_DUAL_UOM_CONTROL'));
   set_item_result(run_stored_sig('ITEM_SHIPPABLE_CHECK'));
   set_item_result(run_stored_sig('ITEM_MILK_NULL_PHYSICAL_LOCATION'));
   set_item_result(run_stored_sig('EBS_MFG_INV_INVITMANALYZER_DUPLICATE_CAT'));
   set_item_result(run_stored_sig('EBS_MFG_INV_INVITMANALYZER_FLXSEPAR_IN_ITMNUM'));
   set_item_result(run_stored_sig('Duplicate_Item_Numbers_MSIB'));
   set_item_result(run_stored_sig('EBS_MFG_INV_INVITMANALYZER_SUPPLY_NONEXS_SRCDOC'));
   set_item_result(run_stored_sig('EBS_MFG_INV_INVITMANALYZER_INV_IOI_MASTER_CHILD'));
   set_item_result(run_stored_sig('ITEM_MISSING_CHILD_CATEGORY_ASSIGNMENTS'));
   set_item_result(run_stored_sig('EBS_MFG_INV_INVITMANALYZER_MASTER_CHILD_CONFLICT'));
   set_item_result(run_stored_sig('EBS_MFG_INV_INVITMANALYZER_ITEMS_MISSING_MSITL'));
end_section;
debug('end section: Common_Data_Issues');

debug('begin section: Diag_Apps_Check');
IF g_sql_tokens('##$$APPS_CHECK$$##') = 'Y' THEN
   start_section('Diagnostics: Apps Check', 'Diag_Apps_Check');
      ...
      set_item_result(run_stored_sig('PROFILE_OPTIONS_INV_BOM_ENG_PIM'));
      set_item_result(run_stored_sig('EBS_MFG_INV_OPHANLY_BNE_PROFILES'));
      set_item_result(run_stored_sig('AC_PATCHES_APPLIED'));
      set_item_result(run_stored_sig('BOM_VPD_POLICY_CHECK'));
   end_section;
END IF;
debug('end section: Diag_Apps_Check');
