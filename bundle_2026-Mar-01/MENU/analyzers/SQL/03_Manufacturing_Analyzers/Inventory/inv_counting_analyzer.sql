...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Inventory Counting Analyzer            |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE inv_counting_analyzer_pkg AUTHID DEFINER AS
...
(            p_org_code                     IN VARCHAR2    DEFAULT NULL
           ,p_count_type                   IN VARCHAR2    DEFAULT NULL
           ,p_cc_name                      IN VARCHAR2    DEFAULT NULL
           ,p_pi_name                      IN VARCHAR2    DEFAULT NULL
           ,p_cc_date                      IN VARCHAR2    DEFAULT NULL
...
END inv_counting_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY inv_counting_analyzer_pkg AS
-- $Id: inv_counting_analyzer.sql, 200.20 2026/02/23 18:06:09 rcastro Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2820764.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'INVCOUNTING_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'INVCOUNTING_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>INVCOUNTING Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2820764.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/inv_counting_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1114,EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1114,EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1114,EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4037523" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">1114</span>
...
<div class="ck-content"><p>Version 200.20 23-FEB-2026</p><p>&nbsp; &nbsp; &nbsp;Signature updates</p><p>&nbsp;</p><p>Version 200.19 29-JAN-2026</p><p>&nbsp; &nbsp; &nbsp;Updated link format</p><p>&nbsp;</p><p>Version 200.18 06-JAN-2026<br>
&nbsp; &nbsp; &nbsp;Signature updates</p><p>&nbsp;</p><p>Version 200.17 05-DEC-2025</p><p>&nbsp; &nbsp; &nbsp;Added signature ‘<span class="display_only apex-item-display-only" id="P18_TITLE_DISPLAY" data-escape="true">Forms Personalization Warning’</span></p><p>&nbsp;</p><p>Version 200.16 18-AUG-2025</p><p>&nbsp; &nbsp; &nbsp;Signature updates</p><p>&nbsp;</p><p>Version 200.15 24-MAR-2025</p><p>&nbsp; &nbsp; Added signature ‘<span class="display_only apex-item-display-only" id="P18_TITLE_DISPLAY" data-escape="true">Classes Associated With Cycle Count Header</span>’<br>
&nbsp; &nbsp; Added signature ‘<span class="display_only apex-item-display-only" id="P18_TITLE_DISPLAY" data-escape="true">Subinventory Associated With Cycle Count Header</span>’<br>
&nbsp; &nbsp; Added signature ‘’<span class="display_only apex-item-display-only" id="P18_TITLE_DISPLAY" data-escape="true">Assignment Group Associated With Cycle Count Header</span><br>
&nbsp; &nbsp; Updated Apps Check section</p><p>&nbsp;</p><p>Version 200.14 04-MAR-2025</p><p>&nbsp; &nbsp; &nbsp;Signature updates</p><p>&nbsp; &nbsp; &nbsp;Framework updates</p><p>&nbsp;</p><p>Version 200.13 27-NOV-2024</p><p>&nbsp;&nbsp;&nbsp;&nbsp; Added signature &apos;<span class="display_only apex-item-display-only" data-escape="true" id="P18_TITLE_DISPLAY">Open Cycle Count Entries for the Item&apos;</span></p><p>Version 200.12 26-SEP-2024</p><p>&nbsp;&nbsp;&nbsp;&nbsp; Signature updates</p><p>&nbsp;</p><p>Version 200.11 17-JUL-2024</p><p>&nbsp;&nbsp;&nbsp;&nbsp; Added signature &apos;<span class="display_only apex-item-display-only" id="P18_TITLE_DISPLAY">Virtual Private Database Policies&apos;</span><br>
<span class="display_only apex-item-display-only" id="P18_TITLE_DISPLAY">&nbsp;&nbsp;&nbsp;&nbsp; Added signature &apos;Issued Out or Moved Serial Count Data&apos;</span><br>
&nbsp;</p><p>Version 200.10 10-APR-2024</p><p>&nbsp; &nbsp; Rename “Lifetime Support Policy” with “Critical Alerts”<br>
&nbsp; &nbsp; Add 2 signatures</p><p>&nbsp; &nbsp; EBS_ATG_UGLE_32BIT_SEQUENCES_CLOSE_TO_MAX<br>
&nbsp; &nbsp; EBS_ATG_UGLE_SEQUENCES_CLOSE_TO_MAXIMUM_VALUE</p><p>&nbsp;</p><p>Version 200.9 26-JAN-2024</p><ul><li>Signature updates</li>
<li>Framework updates</li>
</ul>
<p>&nbsp;</p><p>Version 200.8 22-August-2023</p><ul><li>Signature updates</li>
<li>Framework updates</li>
</ul>
<p>Version 200.7 July 2023</p><ul><li>Signature updates: &nbsp;</li>
<li>Removed Item as optional parameter</li>
</ul>
<p>Version 200.6 June 2023</p><ul><li>Signature updates</li>
</ul>
<p>&nbsp;</p><p>Version 200.5 March 2023</p><ul><li>Framework update</li>
<li>Signature updates</li>
</ul>
<p>&nbsp;</p><p>Version 200.4 February 2023:</p><ul><li>Added signature &apos;Open Cycle Count Entries for the Item&apos;</li>
</ul>
<p>&nbsp;</p><p><u>Version 200.3 December 2022:</u></p><ul><li>Signature updates</li>
<li>Framework update</li>
</ul>
<p>&nbsp;</p><p><u>Version 200.2 November 2022:</u></p><p>Signature updates</p><p>&nbsp;</p><p><u>Version 200.1&nbsp; July 2022:</u></p><ul><li>Initial Release - The EBS Inventory Counting Analyzer provide<span style="font-size:small;"> immediate analysis and output of basic Physical Inventory and Cycle Count data.</span></li>
<li><span style="font-size:small;">Identifies Inventory system setup and configurations, collects the Required Data of Inventory tables for Counts, Items and Calendar File.</span></li>
<li>C<span style="font-size:small;">ollects the apps check file versions of INV and WMS products.</span></li>
<li><span style="font-size:small;">Collects data of indexes, profiles, invalid packages, recommended patches to be applied, one off patches that are already applied.</span><br>
&nbsp;</li>
</ul>
</div>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1114,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1114,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1114,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
BEGIN
    ...
    print_log('Processing recommended patches signature: INV_CHECK_REC (check_rec_patches_1) "Recommended Patches" (version 11)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_col_rows(4)(l_rows) := 'Logistics Consolidated RUP17 (VERSION 12.1.3 [RELEASE 12.1])';
   ...
   l_col_rows(5)(l_rows) := '[2129023/KB370724]';
...
Best Practice: Always ensure that you are on the latest code with all recommended patches applied. This will help avoid known issues, prevent potential data corruption and provide the latest features and functionality. Having a proactive patching plan and periodic proactive patching process in place are the best ways to stay current.';
  ...
  -- Register
  l_step := '60';
  g_signatures('INV_CHECK_REC') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'INV_CHECK_REC',     -- sig ID
...
BEGIN
    ...
    print_log('Processing recommended patches signature: INV_RUP_CHECK (check_rec_patches_2) "Inventory Rollup Patch Status" (version 15)');
...
IF substr(g_rep_info('Apps Version'),1,3) = '11i' THEN
   ...
   l_col_rows(5)(l_rows) := '[417530/KB303776]';
   ...
   l_col_rows(5)(l_rows) := '[601407/KB506585]';
   ...
   l_col_rows(5)(l_rows) := '[726406/KB336853]';
   ...
   l_col_rows(5)(l_rows) := '[733954/KB773446]';
   ...
   l_col_rows(5)(l_rows) := '[754457/KB613804]';
   ...
   l_col_rows(5)(l_rows) := '[764201/KB242073]';
   ...
   l_col_rows(5)(l_rows) := '[794662/KB551560]';
   ...
   l_col_rows(5)(l_rows) := '[824999/KB383204]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_col_rows(5)(l_rows) := '[752619/KB842895]';
   ...
   l_col_rows(5)(l_rows) := '[949406/KB280481]';
   ...
   l_col_rows(5)(l_rows) := '[1080973/KB187682]';
   ...
   l_col_rows(5)(l_rows) := '[1392179/KB232247]';
   ...
   l_col_rows(5)(l_rows) := '[1461579/KB262919]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(5)(l_rows) := '[2958934/KB203605]';
   ...
   l_col_rows(5)(l_rows) := '[3012829/KB203617]';
...
debug('begin populate parameters hash table');
   ...
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Count Type';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_count_type,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Cycle Count Name';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_cc_name,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Physical Inventory Name';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_pi_name,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Cycle Count Date';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_cc_date,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Item (Item Name / Part Number - Optional)';
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/02/23 18:06:08 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'inv_counting_analyzer.sql';
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Please enter the correct organization code. Remember not to use the organization id.
');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
debug('begin parameter validation: p_count_type');
IF p_count_type IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Count Type is required.');
   raise invalid_parameters;
END IF;
IF p_count_type IS NOT NULL AND p_count_type NOT IN ( 'CC','PI') THEN
   print_error('INVALID ARGUMENT: The Count Type entered is not valid.');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_count_type');

debug('begin parameter validation: p_cc_name');
IF p_cc_name IS NOT NULL THEN
BEGIN
SELECT CYCLE_COUNT_HEADER_NAME
INTO l_exists_val
FROM MTL_CYCLE_COUNT_HEADERS
WHERE CYCLE_COUNT_HEADER_NAME = p_cc_name
 AND ORGANIZATION_ID =  (select ORGANIZATION_ID from mtl_parameters where  mtl_parameters.organization_code = p_org_code)
AND p_count_type = 'CC'

 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: A cycle count name must be selected ');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_cc_name failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_cc_name');

debug('begin parameter validation: p_pi_name');
IF p_pi_name IS NOT NULL THEN
BEGIN
SELECT PHYSICAL_INVENTORY_NAME
INTO l_exists_val
FROM MTL_PHYSICAL_INVENTORIES 
WHERE PHYSICAL_INVENTORY_NAME = p_pi_name
 AND ORGANIZATION_ID =  (select ORGANIZATION_ID from mtl_parameters where  mtl_parameters.organization_code = p_org_code)
and p_count_type = 'PI'
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Physical Inventory Name given does not exist. Please enter correct Physical Inventory Name.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_pi_name failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_pi_name');
...
-- Validating at least one counting parameter is passed:
IF (p_pi_name is null) AND (p_cc_name is null) THEN
    print_log('No counting parameter specified. '||
      'At least one counting parameter is required.');
    print_error('No counting parameter specified.');
    raise invalid_parameters;
END IF;

-- Physical header id  from the  header name  
 IF  p_pi_name is not null THEN
...
-- cc header id  from the  header name  
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$PIID$$##') := l_pi_id;
   g_masked_tokens('##$$PIID$$##') := mask_text( g_sql_tokens('##$$PIID$$##'), 'NO_MASK');
   ...
   g_sql_tokens('##$$CCHEADERID$$##') := l_cc_header_id;
   g_masked_tokens('##$$CCHEADERID$$##') := mask_text( g_sql_tokens('##$$CCHEADERID$$##'), 'NO_MASK');
...
debug('begin add_signature: EBS_MFG_INV_INVPICC_HEADER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24784',
      p_sig_id                 => 'EBS_MFG_INV_INVPICC_HEADER',
      p_sig_sql                => 'SELECT CYCLE_COUNT_HEADER_ID
,ORGANIZATION_ID
,CREATION_DATE
,CREATED_BY
...
,decode (SERIAL_COUNT_OPTION,
1, ''1 / not allowed'',
2,''2 / one per request'',
3,''3 / multiple per request'', SERIAL_COUNT_OPTION) SERIAL_COUNT_OPTION
,decode (SERIAL_DETAIL_OPTION, 
1,''1 / Quantity and Serial Numbers'',
2,''2 / Quantity Only'', SERIAL_DETAIL_OPTION) SERIAL_DETAIL_OPTION
,decode (SERIAL_ADJUSTMENT_OPTION,
1,''1 / Adjust if Possible'',
2,''2 / Review all Adjustments'', SERIAL_ADJUSTMENT_OPTION) SERIAL_ADJUSTMENT_OPTION
,decode (SERIAL_DISCREPANCY_OPTION,
1,''1 / Allowed'',
2,''2 / Not Allowed'', SERIAL_DISCREPANCY_OPTION) SERIAL_DISCREPANCY_OPTION
...
FROM MTL_CYCLE_COUNT_HEADERS
WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##',
      p_title                  => 'Cycle Count Header',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is some data corruption since we couldn''t find the Header record for this Cycle Count.',
      p_solution               => 'Please create a Service Request to review the data closely.',
      p_success_msg            => 'This is the Cycle Count Header record.',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVPICC_HEADER');



debug('begin add_signature: EBS_MFG_INV_INVPICC_ABC_COMPILE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26065',
      p_sig_id                 => 'EBS_MFG_INV_INVPICC_ABC_COMPILE',
      p_sig_sql                => 'SELECT
mach.compile_id,
mach.compile_name,
mach.description,
mach.organization_id,
mach.last_update_date,
mach.creation_date,
decode(mach.compile_type, 1, ''1-Current on hand quantity'', 2, ''2-Current on hand value'',
3, ''3-Historical usage value'', 4, ''4-Historical usage quantity'', 5,
''5-Historical number of transactions'', 6, ''6-Forecasted usage value'', 7, ''7-Forecasted usage quantity'',
8, ''8-Previous cycle count adjustment value'', 10, ''10-MRP demand usage quantity'', 11,
''11-MRP demand usage value'', 12, ''12-DRP demand usage quanity'', 13, ''13-DRP demand usage value'',
14, ''14-MPS demand usage quantity'', 15, ''15-MPS demand usage value'', 16,
''16-Item unit cost'', mach.compile_type) compile_type,
decode(mach.compile_status, 1, ''1-None'', 2, ''2-Complete'',
3, ''3-Running'', 4, ''4-Error'') compile_status,
mach.secondary_inventory,
decode(mach.item_scope_code, 1, ''1-Organization'', 2, ''2-Subinventory'') item_scope,
mach.compile_items,
mach.compile_date,
mach.cost_type
|| ''-''|| (
...
cst_cost_types cct
WHERE
mach.cost_type = cct.cost_type_id
)  cost_type,
mach.cumulative_quantity,
mach.cumulative_value,
mach.mrp_plan_name,
mach.start_date,
mach.cutoff_date
FROM
mtl_abc_compile_headers mach
WHERE MACH.COMPILE_ID IN (
SELECT COMPILE_ID FROM mtl_abc_assignment_groups
where assignment_group_id in (
select max(assignment_group_id) from MTL_ABC_ASSGN_GROUP_CLASSES
where abc_class_id in (
select abc_class_id from MTL_CYCLE_COUNT_CLASSES
where organization_id = ##$$ORGID$$##
and cycle_count_header_id = ##$$CCHEADERID$$## ) ) )
',
      p_title                  => 'ABC Compile Setup',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No ABC Compile found for this Cycle Count. <br>
This is not an issue since item class assignment can been done manually without the ABC Descending Value Report.',
      p_solution               => '--',
      p_success_msg            => '--',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVPICC_ABC_COMPILE');



debug('begin add_signature: EBS_MFG_INV_INVPICC_ITEM_CC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24781',
      p_sig_id                 => 'EBS_MFG_INV_INVPICC_ITEM_CC',
      p_sig_sql                => '-- Item records for open CC entries
...
WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
AND ENTRY_STATUS_CODE NOT IN (4,5)) -- Pending CC Entries',
      p_title                  => 'Item Setup for Open Cycle Count Entries',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Open Cycle Count Entries found.',
      p_solution               => 'Check if the Cycle Count Scheduler has run for this Cycle Count.',
      p_success_msg            => 'Items setup for open cycle count entries.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVPICC_ITEM_CC');
...
debug('begin add_signature: INV_CC_SCORE_CARD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18736',
      p_sig_id                 => 'INV_CC_SCORE_CARD',
      p_sig_sql                => 'SELECT attribute,
  value
FROM
  (SELECT 1 ,
    ''-- CYCLE COUNT SCORE CARD--'' Attribute,
    ''RESULTS/COUNTS TOTALS'' Value
  FROM dual
  UNION
  SELECT 1.1 ,
    ''Organization Code'',
  ...
  UNION
  SELECT 1.2 ,
    ''CYCLE_COUNT_HEADER_NAME'' Attribute ,
    CYCLE_COUNT_HEADER_NAME value
  FROM MTL_CYCLE_COUNT_HEADERS_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
  UNION
   SELECT 1.3 ,
  ...
  SELECT 1.4 ,
    ''Calendar '' Attribute ,
   CYCLE_COUNT_CALENDAR value
  FROM MTL_CYCLE_COUNT_HEADERS_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
  UNION
  SELECT 1.5 ,
    ''Calendar Start Date'' Attribute ,
   to_char(CALENDAR_START_DATE) value
  FROM BOM_CALENDARS 
where calendar_code in (select cycle_count_calendar 
                        from mtl_cycle_count_headers 
                        where cycle_count_header_id = ##$$CCHEADERID$$##
                        )
  UNION
  SELECT 1.6 ,
    ''Calendar End Date'' Attribute ,
   to_char(CALENDAR_END_DATE) value
  FROM BOM_CALENDARS 
where calendar_code in (select cycle_count_calendar 
                        from mtl_cycle_count_headers 
                        where cycle_count_header_id = ##$$CCHEADERID$$##
  ...
  UNION
      SELECT 1.7,
      ''Number of Working days in this calendar year'' Attribute,
      to_char(count(1)) value
  FROM BOM_CALENDAR_DATES
  WHERE CALENDAR_CODE =
    (SELECT cycle_count_calendar
    FROM mtl_cycle_count_headers
    WHERE cycle_count_header_id = ##$$CCHEADERID$$##
    )
  AND seq_num                      IS NOT NULL
  AND TO_CHAR(CALENDAR_DATE,''YYYY'') =
    (SELECT SUBSTR(TO_CHAR(sysdate,''DD-MON-YYYY''),8,11) FROM dual
    )
  UNION
  SELECT 1.8 ,
  ''Adjustment Account'' attribute ,
 -- TO_CHAR(mccv.INVENTORY_ADJUSTMENT_ACCOUNT) value,
(SELECT TO_CHAR(segment1
  ||''-''
  || segment2
  ||''-''
  || segment3
...
WHERE glcc.code_combination_id=mccv.INVENTORY_ADJUSTMENT_ACCOUNT)value 
FROM MTL_CYCLE_COUNT_HEADERS_V mccv
WHERE mccv.CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
UNION
SELECT 1.9 ,
    ''Inactive On'' Attribute ,
   to_char(DISABLE_DATE) value
  FROM MTL_CYCLE_COUNT_HEADERS_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
UNION
SELECT 2.0 ,
    ''Late Days'' Attribute ,
   to_char(DAYS_UNTIL_LATE) value
  FROM MTL_CYCLE_COUNT_HEADERS_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
  UNION
SELECT 2.1 ,
    ''Starting Seq'' Attribute ,
   to_char(NEXT_USER_COUNT_SEQUENCE) value
  FROM MTL_CYCLE_COUNT_HEADERS_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
  UNION
SELECT 2.2 ,
    ''Unscheduled Entries'' Attribute ,
   Decode(UNSCHEDULED_COUNT_ENTRY,1,''Yes'',2,''No'') value
  FROM MTL_CYCLE_COUNT_HEADERS_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$## 
    UNION
SELECT 2.3 ,
    ''Display System Qty'' Attribute ,
   Decode(ONHAND_VISIBLE_FLAG,1,''Yes'',2,''No'') value
  FROM MTL_CYCLE_COUNT_HEADERS_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
   UNION
SELECT 2.4 ,
    ''Automatic Recounts'' Attribute ,
   Decode(AUTOMATIC_RECOUNT_FLAG,1,''Yes'',2,''No'') value
  FROM MTL_CYCLE_COUNT_HEADERS_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
   UNION
SELECT 2.5 ,
    ''Maximum number of recounts'' Attribute ,
   to_char(MAXIMUM_AUTO_RECOUNTS) value
  FROM MTL_CYCLE_COUNT_HEADERS_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
  UNION
SELECT 2.6 ,
    ''Count Subinventories'' Attribute ,
   Decode(ORIENTATION_CODE,1,''At Organization Level'',2,''Specific to Subinventory'') value
  FROM MTL_CYCLE_COUNT_HEADERS_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
  UNION
SELECT 2.7 ,
    ''Subinventory'' Attribute ,
   SUBINVENTORY value
  FROM MTL_CC_SUBINVENTORIES WHERE  DISABLE_FLAG = 2 AND CYCLE_COUNT_HEADER_ID=##$$CCHEADERID$$##
    UNION
SELECT 2.8 ,
    ''Serial Count Option - Count'' Attribute ,
   SERIAL_COUNT_OPTION_MEANING value
  FROM MTL_CYCLE_COUNT_HEADERS_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
  UNION
SELECT 2.9 ,
    ''Serial Count Option - Detail'' Attribute ,
   SERIAL_DETAIL_OPTION_MEANING value
  FROM MTL_CYCLE_COUNT_HEADERS_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
  UNION
SELECT 3.0 ,
    ''Serial Count Option - Adjustment'' Attribute ,
   SERIAL_ADJ_OPTION_MEANING value
  FROM MTL_CYCLE_COUNT_HEADERS_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
  UNION
SELECT 3.1 ,
    ''Serial Count Option - Discrepancy'' Attribute ,
   SERIAL_DIS_OPTION_MEANING value
  FROM MTL_CYCLE_COUNT_HEADERS_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
  UNION
SELECT 3.2 ,
    ''Auto Schedule'' Attribute ,
   Decode(AUTOSCHEDULE_ENABLED_FLAG,1,''Yes'',2,''No'') value
  FROM MTL_CYCLE_COUNT_HEADERS_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
    UNION
SELECT 3.3 ,
    ''Auto Schedule Frequency'' Attribute ,
   SCHEDULE_INTERVAL value
  FROM MTL_CYCLE_COUNT_HEADERS_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
   UNION
SELECT 3.4 ,
    ''Count Zero Quantity'' Attribute ,
    Decode(ZERO_COUNT_FLAG,1,''Yes'',2,''No'') value
  FROM MTL_CYCLE_COUNT_HEADERS_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
  UNION
SELECT 3.5 ,
    ''Auto Schedule Last Date'' Attribute ,
   to_char(HEADER_LAST_SCHEDULE_DATE) value
  FROM MTL_CYCLE_COUNT_HEADERS_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
  UNION
SELECT 3.6 ,
    ''Auto Schedule Next Date'' Attribute ,
   to_char(HEADER_NEXT_SCHEDULE_DATE) value
  FROM MTL_CYCLE_COUNT_HEADERS_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
  UNION
SELECT 3.7 ,
    ''Adjustments Approval'' Attribute ,
   APPROVAL_OPTION value
  FROM MTL_CYCLE_COUNT_HEADERS_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
   UNION
SELECT 3.8 ,
    ''Adjustments Quantity Positive Tolerances Percentage'' Attribute ,
   to_char(APPROVAL_TOLERANCE_POSITIVE) value
  FROM MTL_CYCLE_COUNT_HEADERS_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
     UNION
SELECT 3.9 ,
    ''Adjustments Quantity Negative Tolerances Percentage'' Attribute ,
   to_char(APPROVAL_TOLERANCE_NEGATIVE) value
  FROM MTL_CYCLE_COUNT_HEADERS_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
  UNION
SELECT 4.0 ,
    ''Adjustments Value Positive Tolerances Percentage'' Attribute ,
   to_char(COST_TOLERANCE_POSITIVE) value
  FROM MTL_CYCLE_COUNT_HEADERS_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
  UNION
SELECT 4.1 ,
    ''Adjustments Value Negative Tolerances Percentage'' Attribute ,
   to_char(COST_TOLERANCE_NEGATIVE) value
  FROM MTL_CYCLE_COUNT_HEADERS_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
    UNION
SELECT 4.2 ,
    ''Adjustments Hit/Miss Analysis Positive Tolerances Percentage'' Attribute ,
   to_char(HIT_MISS_TOLERANCE_POSITIVE) value
  FROM MTL_CYCLE_COUNT_HEADERS_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
   UNION
SELECT 4.3 ,
    ''Adjustments Hit/Miss Analysis Negative Tolerances Percentage'' Attribute ,
   to_char(HIT_MISS_TOLERANCE_NEGATIVE) value
  FROM MTL_CYCLE_COUNT_HEADERS_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
  UNION
SELECT 4.4 ,
    ''ABC Initilization Group'' Attribute ,
   ABC_ASSIGNMENT_GROUP value
  FROM MTL_CYCLE_COUNT_HEADERS_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
  UNION
SELECT 4.5 ,
    ''ABC Initilization Status'' Attribute ,
   ABC_INITIALIZATION_DUMMY  value
  FROM MTL_CYCLE_COUNT_HEADERS_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
   UNION
SELECT 4.6 ,
    ''ABC Classes'' Attribute ,
   CC_CLASS_NAME value
  FROM MTL_CYCLE_COUNT_CLASSES_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
  UNION
SELECT 4.7 ,
    ''Counts Per Year'' || ''-''|| CC_CLASS_NAME Attribute ,
   to_char(NUM_COUNTS_PER_YEAR) value
  FROM MTL_CYCLE_COUNT_CLASSES_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
  UNION
SELECT 4.8 ,
    CC_CLASS_NAME ||''-''||''Counts Per Class - Adjustments Value +ve Tolerances%'' Attribute ,
   to_char(APPROVAL_TOLERANCE_POSITIVE) value
  FROM MTL_CYCLE_COUNT_CLASSES_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
  UNION
SELECT 4.9 ,
  ...
  UNION
SELECT 5.0 ,
    CC_CLASS_NAME ||''-''||''Counts Per Class - Adj Qty +ve Tolerances%'' Attribute ,
   to_char(COST_TOLERANCE_POSITIVE) value
  FROM MTL_CYCLE_COUNT_CLASSES_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
  UNION
SELECT 5.1 ,
  ...
  UNION
SELECT 5.2 ,
    CC_CLASS_NAME ||''-''||''Counts Per Class - Hit/Miss +ve Tolerances%'' Attribute ,
   to_char(HIT_MISS_TOLERANCE_POSITIVE) value
  FROM MTL_CYCLE_COUNT_CLASSES_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
  UNION
SELECT 5.3 ,
  ...
  UNION
SELECT 5.4 ,
''Number of Items Per Class'' ||''-''||CC_CLASS_NAME Attribute,
to_char(count(inventory_item_id)) value
from MTL_CYCLE_COUNT_ITEMS_V 
where CYCLE_COUNT_HEADER_ID=##$$CCHEADERID$$## group by CC_CLASS_NAME
UNION
SELECT 5.5 ,
''Specific to WMS Org - Container Adjustment Option'' Attribute ,
    Decode(CONTAINER_ADJUSTMENT_OPTION,1,''Adjust if Possible'',2,''Review All Adjustments'') value
  FROM MTL_CYCLE_COUNT_HEADERS_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
 UNION
SELECT 5.6 ,
''Specific to WMS Org - Container Discrepancy Option'' Attribute ,
    Decode(CONTAINER_ADJUSTMENT_OPTION,1,''Allow'',2,''Do not Allow'') value
  FROM MTL_CYCLE_COUNT_HEADERS_V
  WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$## 
  )',
      p_title                  => 'Inventory Cycle Count Score Card',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'A general overview of the Cycle Count Inventory.
This section covers cycle count name to sub inventories, different classes, calendar details, tolerant percentages and number of items per class etc.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: INV_CC_SCORE_CARD');
...
debug('begin add_signature: EBS_MFG_INV_INVPICC_ASG_GROUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31010',
      p_sig_id                 => 'EBS_MFG_INV_INVPICC_ASG_GROUP',
      p_sig_sql                => 'select
ASSIGNMENT_GROUP_ID        
...
WHERE
     cycle_count_header_id = ##$$CCHEADERID$$## )',
      p_title                  => 'Assignment Group Associated With Cycle Count Header',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no Assignment Group associated with the cycle count header',
      p_solution               => '',
      p_success_msg            => 'Assignment Group associated with the cycle count header',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVPICC_ASG_GROUP');



debug('begin add_signature: EBS_MFG_INV_INVPICC_CLASS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31008',
      p_sig_id                 => 'EBS_MFG_INV_INVPICC_CLASS',
      p_sig_sql                => 'SELECT
    cc_class_name,
    num_counts_per_year,
    cost_tolerance_positive,
...
ORDER BY
    cc_class_name',
      p_title                  => 'Classes Associated With Cycle Count Header',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no classes associated with the cycle count header',
      p_solution               => '',
      p_success_msg            => 'Following are the classes associated with the cycle count header',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVPICC_CLASS');



debug('begin add_signature: EBS_MFG_INV_INVPICC_SUBINV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31009',
      p_sig_id                 => 'EBS_MFG_INV_INVPICC_SUBINV',
      p_sig_sql                => ' SELECT
     subinventory,
    disable_flag,
    cycle_count_header_id,
...
ORDER BY
    subinventory',
      p_title                  => 'Subinventory Associated With Cycle Count Header',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no Subinventory associated with the cycle count header',
      p_solution               => '',
      p_success_msg            => 'Subinventory associated with the cycle count header',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVPICC_SUBINV');



debug('begin add_signature: EBS_MFG_INV_INVPICC_OPEN_ENTRIES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24783',
      p_sig_id                 => 'EBS_MFG_INV_INVPICC_OPEN_ENTRIES',
      p_sig_sql                => 'SELECT
...
AND ENTRY_STATUS_CODE NOT IN (4,5)',
      p_title                  => 'Cycle Count Open Entries',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no Open Cycle Count Entries for this Cycle Count.',
      p_solution               => 'You might generate this analyzer again, entering a specific Item Number for which to retrieve the Cycle Count Entries to display.',
      p_success_msg            => 'These are the Open Cycle Count Entries for this Cycle Count.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVPICC_OPEN_ENTRIES');



debug('begin add_signature: EBS_MFG_INV_INVPICC_ONHAND');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26062',
      p_sig_id                 => 'EBS_MFG_INV_INVPICC_ONHAND',
      p_sig_sql                => 'SELECT
organization_id,
inventory_item_id,
subinventory_code,
...
inventory_item_id ASC',
      p_title                  => 'Onhand for Pending CC Entries',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No records returned.',
      p_solution               => '',
      p_success_msg            => 'On hand records for items in pending cycle count entries.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVPICC_ONHAND');



debug('begin add_signature: EBS_MFG_INV_INVPICC_ITEM_RESERVATIONS_OPEN_ENTRIES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24782',
      p_sig_id                 => 'EBS_MFG_INV_INVPICC_ITEM_RESERVATIONS_OPEN_ENTRIES',
      p_sig_sql                => 'SELECT RESERVATION_ID
,REQUIREMENT_DATE
,ORGANIZATION_ID
,INVENTORY_ITEM_ID
...
WHERE CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
AND ENTRY_STATUS_CODE NOT IN (4,5))',
      p_title                  => 'Reservations for Items in Open Cycle Count Entries',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Reservations exist for items in open cycle count entries for this cycle count.',
      p_solution               => 'Verify if these are Cycle Count reservations or not.',
      p_success_msg            => 'No reservations found for items in open cycle count entries.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVPICC_ITEM_RESERVATIONS_OPEN_ENTRIES');



debug('begin add_signature: EBS_MFG_INV_INVPICC_SCHEDULE_REQUESTS_OPEN_ENTRIES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24785',
      p_sig_id                 => 'EBS_MFG_INV_INVPICC_SCHEDULE_REQUESTS_OPEN_ENTRIES',
      p_sig_sql                => 'SELECT S.CYCLE_COUNT_HEADER_ID
,S.CYCLE_COUNT_SCHEDULE_ID
,S.CREATION_DATE
,S.REQUEST_SOURCE_TYPE
,S.ZERO_COUNT_FLAG
,S.SCHEDULE_DATE
,S.COUNT_DUE_DATE
,S.COUNT_REQUESTS_GENERATED_FLAG
,S.SCHEDULE_STATUS
,S.SCHEDULE_COMPLETION_DATE
,S.INVENTORY_ITEM_ID
,S.SUBINVENTORY
,S.LOCATOR_ID
,S.REVISION
...
,S.PROCESS_FLAG
,S.SERIAL_NUMBER
FROM MTL_CC_SCHEDULE_REQUESTS S,
MTL_CC_SCHED_COUNT_XREFS X,
MTL_CYCLE_COUNT_ENTRIES C
WHERE C.CYCLE_COUNT_ENTRY_ID = X.CYCLE_COUNT_ENTRY_ID
AND X.CYCLE_COUNT_SCHEDULE_ID = S.CYCLE_COUNT_SCHEDULE_ID
AND C.ORGANIZATION_ID = ##$$ORGID$$##
AND C.CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
AND C. ENTRY_STATUS_CODE NOT IN (4,5)',
      p_title                  => 'Schedule Request for Open Cycle Counts',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No schedule Requests found for the Open Cycle Count Entries.',
      p_solution               => 'There might be some data corruption. Please create a Service Request to review the data more closely.',
      p_success_msg            => 'These are the Cycle Count Requests records for the Open Cycle Count Entries.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVPICC_SCHEDULE_REQUESTS_OPEN_ENTRIES');



debug('begin add_signature: EBS_MFG_INV_INVPICC_CC_INTERFACE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29123',
      p_sig_id                 => 'EBS_MFG_INV_INVPICC_CC_INTERFACE',
      p_sig_sql                => 'select 
...
,cycle_count_entry_id
,decode(action_code, 11, ''G_VALIDATE''
,12, ''G_CREATE''
,13, ''G_VALSIM''
,14, ''G_PROCESS'') action_code
,cycle_count_header_id
,cycle_count_header_name
,count_list_sequence
,inventory_item_id
...
,valid_flag
,delete_flag
,decode(status_flag, 0, ''Successful completed''
,1, ''Successful completed with warnings''
,2, ''Processed with errors''
,3, ''Marked for recounting'' 
,4, ''Marked for reprocessing'') status_flag
,error_flag
,project_id
,task_id
,system_quantity
...
where cycle_count_header_id = ##$$CCHEADERID$$##',
      p_title                  => 'Cycle Count Entries Interface',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Cycle Count entries exist in the interface table.',
      p_solution               => 'Verify if these entries are being imported or not. 
Refer to [2486215/KB749328] - How To Execute Cycle Counting Entry Via Interface (MTL_CC_ENTRIES_INTERFACE) ',
      p_success_msg            => 'No Cycle Count entries exist in the interface table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVPICC_CC_INTERFACE');



debug('begin add_signature: EBS_MFG_INV_INVTAZ_PENDING_CYCLE_COUNT_ENTRIES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30304',
      p_sig_id                 => 'EBS_MFG_INV_INVTAZ_PENDING_CYCLE_COUNT_ENTRIES',
      p_sig_sql                => 'select MCCH.CYCLE_COUNT_HEADER_NAME,MCCH.CYCLE_COUNT_HEADER_ID, MCCE.cycle_count_entry_id, MCCE.inventory_item_id, MCCE.entry_status_code, MCCE.organization_id, MCCE.count_quantity_first, MCCE.count_quantity_current,
MCCE.COUNT_DUE_DATE,mcch.DISABLE_DATE
...
and MCCE.INVENTORY_ITEM_ID= ''##$$ITEMID$$##''
and MCCH.ORGANIZATION_ID=''##$$ORGID$$##''',
      p_title                  => 'Open Cycle Count Entries for the Item',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'System will not allow to change item status when there are open cycle count entries on the item. Following error message can be seen if status change is attempted.

You cannot disable this cycle_count_enabled_flag field when there is active cycle count record exist',
      p_solution               => 'Review [2455097/KB208336] -Error Message "You cannot disable this cycle_count_enabled_flag field when there is active cycle count record exist" Received When Trying to Update Attributes or Inactivating Item.',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVTAZ_PENDING_CYCLE_COUNT_ENTRIES');
...
debug('begin add_signature: INV_CC_SCHEDULE_NO_ITEM');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19163',
      p_sig_id                 => 'INV_CC_SCHEDULE_NO_ITEM',
      p_sig_sql                => 'SELECT * FROM MTL_CC_SCHEDULE_REQUESTS mcsr 
WHERE mcsr.CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
AND mcsr.INVENTORY_ITEM_ID IS NULL',
      p_title                  => 'Manual Cycle Count Entries Created Without an Item',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Manual cycle count entries created without an item.
This causes an unexpected large number of cycle count for a given day.  This query checks back 32 days.',
      p_solution               => 'Refer to the following document for additional information:<br>
[2786904/KB746633] - Why Were so Many Cycle Count Entries Created',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: INV_CC_SCHEDULE_NO_ITEM');



debug('begin add_signature: INV_CC_MTL_CCEOI_ACTION_PUB_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20369',
      p_sig_id                 => 'INV_CC_MTL_CCEOI_ACTION_PUB_ERRORS',
      p_sig_sql                => 'SELECT MCCEI.CC_ENTRY_INTERFACE_ID, MCCEI.CC_ENTRY_INTERFACE_GROUP_ID,MCCEI.ITEM_SEGMENT1,MCCEI.CYCLE_COUNT_ENTRY_ID,MCCEI.ACTION_CODE,MCCEI.CYCLE_COUNT_HEADER_ID,MCCEI.CYCLE_COUNT_HEADER_NAME, MCCIE.INTERFACE_ERROR_ID, MCCIE.PROGRAM_APPLICATION_ID,MCCIE.PROGRAM_ID,MCCIE.PROGRAM_UPDATE_DATE,MCCIE.ERROR_MESSAGE,MCCIE.ERROR_COLUMN_NAME,MCCIE.ERROR_TABLE_NAME,MCCIE.MESSAGE_NAME
FROM MTL_CC_ENTRIES_INTERFACE MCCEI, mtl_cc_interface_errors MCCIE
WHERE MCCEI.CC_ENTRY_INTERFACE_ID=MCCIE.CC_ENTRY_INTERFACE_ID
and MCCEI.CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##',
      p_title                  => 'Cycle Count Request API (MTL_CCEOI_ACTION_PUB) Errors',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are records in error in the MTL_CC_INTERFACE_ERRORS table.',
      p_solution               => 'How To Execute Cycle Counting Entry Via Interface MTL_CC_ENTRIES_INTERFACE) [2486215/KB749328]',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: INV_CC_MTL_CCEOI_ACTION_PUB_ERRORS');



debug('begin add_signature: INV_CC_INTERFACE_ERROR_NO_SERIAL_NUMBER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20370',
      p_sig_id                 => 'INV_CC_INTERFACE_ERROR_NO_SERIAL_NUMBER',
      p_sig_sql                => 'SELECT MCCEI.CC_ENTRY_INTERFACE_ID, MCCEI.CC_ENTRY_INTERFACE_GROUP_ID,MCCEI.CYCLE_COUNT_ENTRY_ID,MCCEI.ACTION_CODE,MCCEI.CYCLE_COUNT_HEADER_ID,MCCEI.CYCLE_COUNT_HEADER_NAME, MCCIE.INTERFACE_ERROR_ID, MCCIE.PROGRAM_APPLICATION_ID,MCCIE.PROGRAM_ID,MCCIE.PROGRAM_UPDATE_DATE,MCCIE.ERROR_MESSAGE,MCCIE.ERROR_COLUMN_NAME,MCCIE.ERROR_TABLE_NAME,MCCIE.MESSAGE_NAME
FROM MTL_CC_ENTRIES_INTERFACE MCCEI, mtl_cc_interface_errors MCCIE
WHERE MCCEI.CC_ENTRY_INTERFACE_ID=MCCIE.CC_ENTRY_INTERFACE_ID
and MCCEI.CYCLE_COUNT_HEADER_ID = ##$$CCHEADERID$$##
and MCCIE.ERROR_MESSAGE LIKE ''The specified item is under serial control and no serial numbers were entered for this count''
OR MCCIE.MESSAGE_NAME LIKE ''The specified item is under serial control and no serial numbers were entered for this count''
                                                                                     ...
                                                                                     ',
      p_title                  => 'Cycle Count Request API Error - The Specified Item Is Under Serial Control and No Serial Numbers Were Entered for This Count',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are records in error in the MTL_CC_INTERFACE_ERRORS table with the following error:
The specified item is under serial control and no serial numbers were entered for this count',
      p_solution               => 'Cycle Count Request Import (MTL_CCEOI_ACTION_PUB API) Fails When Using Serial Number Multiple Per Request [1468453/KB714417]',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: INV_CC_INTERFACE_ERROR_NO_SERIAL_NUMBER');



debug('begin add_signature: EBS_MFG_INV_INVPICC_ISSUED_OUT_SERIAL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29404',
      p_sig_id                 => 'EBS_MFG_INV_INVPICC_ISSUED_OUT_SERIAL',
      p_sig_sql                => ' select mp.organization_code,mp.organization_id, msi.segment1, mch.cycle_count_header_name , COUNT_LIST_SEQUENCE,mce.entry_Status_Code,
mce.serial_number ,COUNT_QUANTITY_CURRENT,SYSTEM_QUANTITY_CURRENT,mce.SUBINVENTORY,mce.locator_id, mce.adjustment_quantity, adjustment_Date,ADJUSTMENT_AMOUNT,
mce.creation_Date, mce.last_update_date ,
msn.current_organization_id current_Serial_org,
msn.CURRENT_SUBINVENTORY_CODE current_Serial_subinv,
msn.CURRENT_LOCATOR_ID current_Serial_locator,
msn.current_status
...
and msi.inventory_item_id= mce.inventory_item_id
and msi.inventory_item_id= msn.inventory_item_id
and mch.organization_id= msi.organization_id
AND mp.organization_id = msi.organization_id
AND mp.organization_id = ''##$$ORGID$$##''
and mch.cycle_count_header_id = ''##$$CCHEADERID$$##''
and mce.serial_number is not null
AND mce.serial_number= msn.serial_number
AND (NVL(msn.current_locator_id, -1)<> mce.locator_id
OR msn.current_organization_id <> mch.organization_id
OR msn.CURRENT_SUBINVENTORY_CODE <> mce.SUBINVENTORY
OR msn.current_status not IN (1,4,5,7))
AND mce.entry_Status_Code NOT IN (1,4,5)
                                                                                     ...
                                                                                     ',
      p_title                  => 'Issued Out or Moved Serial Count Data',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Getting below error while approving the cycle count for a serial controlled item.

You are trying to perform cycle count adjustment for 0 Ea of item XXXXX. However Reservation/Allocations exists for 0 Ea of this item which is grater than the counted qty. Please update or cancel the existing reservation/allocation before a cycle count adjustment can be performed on this item.',
      p_solution               => 'See the solution section under [1468453/KB714417]',
      p_success_msg            => 'No issues found.  See [1468453/KB714417] for full details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVPICC_ISSUED_OUT_SERIAL');



debug('begin add_signature: INV_PI_HEADER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16208',
      p_sig_id                 => 'INV_PI_HEADER',
      p_sig_sql                => 'SELECT
    ...
    m.created_by,
    m.last_update_login,
    m.physical_inventory_date,
    m.last_adjustment_date,
    m.total_adjustment_value,
    m.description,
    m.freeze_date,
    m.physical_inventory_name,
    decode (  m.approval_required , 1 , '' 1 = Always'' ,  2 , ''2= Never'' , 3 ,  ''3 = If out of Tolerence'') Approval_Required ,
    decode (m.all_subinventories_flag, 1, ''1 - inclued all SubInventories '' , 2 , ''2 = Specific list of Sub Inventories'' )all_subinventories_flag,
    decode(m.freeze_date, NULL, 2 || '' = Snapshot not completed'' , 1 || '' = Snapshot Complete '') snapshot_complete,
    decode(m.last_adjustment_date, NULL, 2  || ''= ADJ not POSTED'' , 1 || '' = ADJ  Posted'' ) adjustments_posted,
    m.next_tag_number,
    m.tag_number_increments,
    m.default_gl_adjust_account,
    m.approval_tolerance_pos,
    m.approval_tolerance_neg,
    m.cost_variance_pos,
    m.cost_variance_neg,
    m.number_of_skus,
    decode  (m.dynamic_tag_entry_flag , 1 ,  '' 1 = Dymanic tags allowed'', 2  ,'' 2 = Dynamic tags Not allowed '' ) Dynamic_Tags,
    decode (m.exclude_zero_balance, null , ''N = Include''  , ''Y'' , ''Y= Exclude'' )  exclude_zero_balance,
    decode (m.exclude_negative_balance , null , ''N = Include'' , ''Y'' , ''Y= Exclude'' ) exclude_negative_balance,
    m.request_id,
    ...
    m.attribute14,
    m.attribute15
    FROM     mtl_physical_inventories m , mtl_parameters mp
    WHERE m.physical_inventory_id =  ##$$PIID$$## 
    and  m.organization_id = mp.organization_id',
      p_title                  => 'Physical Inventory Header Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Physical Inventory Header Information ',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: INV_PI_HEADER');



debug('begin add_signature: INV_PI_SCORE_CARD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15998',
      p_sig_id                 => 'INV_PI_SCORE_CARD',
      p_sig_sql                => 'select attribute, value from
(SELECT 1, ''-- PHYSICAL INVENTORY ADJUSTMENT SCORE CARD--'' Attribute, ''RESULTS/COUNTS TOTALS'' Value from dual
UNION
SELECT 1.1, ''Organization Code'', organization_code || '' (ID: ''|| organization_id ||'')'' FROM mtl_parameters mp
where organization_id = ##$$ORGID$$##
UNION  select 1.2, ''PHYSICAL_INVENTORY_NAME'' Attribute ,  PHYSICAL_INVENTORY_NAME value 
 from  MTL_PHYSICAL_INVENTORIES_V 
                                                             WHERE physical_inventory_id = ##$$PIID$$##
UNION 
select 1.3, ''1. ADJUSTMENTS_POSTED '' Attribute ,  decode ( ADJUSTMENTS_POSTED ,  1 , ''1 - The results have been posted'', 
                                                                              2 , ''2 - The results have not been posted'' ) value  
                                                           from  MTL_PHYSICAL_INVENTORIES_V 
                                                             WHERE physical_inventory_id = ##$$PIID$$##
UNION
Select  1.4, ''2. TOTAL NUMBER RECORDS'' attribute , to_char(count(*))  value FROM mtl_physical_adjustments
WHERE physical_inventory_id = ##$$PIID$$##
UNION
select  1.5, ''3. Approved and Posted '' attribute, to_char(count(*)) || ''( Approval Status = 3) '' value FROM mtl_physical_adjustments
WHERE physical_inventory_id = ##$$PIID$$##
AND  approval_status = 3
UNION
Select  1.6, ''4. Approved No Adj   '' attribute , to_char(count(*)) || '' ( Approval Status 1 Adj Qty 0 )'' value  from mtl_physical_adjustments
where physical_inventory_id =##$$PIID$$##
and adjustment_quantity = 0
UNION
select  1.7, ''5. Approval Rejected'' attribute, to_char(count(*)) || ''( Approval Status 2 Rejected )''  value FROM mtl_physical_adjustments
WHERE physical_inventory_id = ##$$PIID$$##
AND  approval_status = 2
UNION 
SELECT 1.8, ''6. Completed  Material Transaction '' attribute, to_char(count(*)) || '' ( Posted to Material Trx)''  value 
FROM mtl_material_transactions
WHERE   transaction_type_id = 8
AND transaction_source_id = ##$$PIID$$##
UNION
select  1.9, ''7. Approved Adj Needed   '' attribute, to_char(count(*)) || ''( Approval Status 1 Adj Qty != 0)''   value FROM mtl_physical_adjustments
WHERE physical_inventory_id = ##$$PIID$$##
AND adjustment_quantity != 0
AND  approval_status = 1
UNION 
SELECT 2, ''8. Errored  Pending Transaction '' attribute, to_char(count(*)) || '' ( Ref: note 1942897.1 ) '' value 
FROM mtl_material_transactions_temp
WHERE   transaction_type_id = 8
AND transaction_source_id = ##$$PIID$$##
and ERROR_CODE is not Null 
UNION
select  2.1, ''9. Not Approved '' attribute , to_char(count(*)) || '' ( Still Need approval)''  value FROM mtl_physical_adjustments
WHERE physical_inventory_id = ##$$PIID$$##
AND adjustment_quantity != 0
AND  approval_status is null 
)
',
      p_title                  => 'Physical Inventory Score Card ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'A general overview  of the Physical Inventory.
1. ADJUSTMENTS_POSTED  - Is the Physical Inventory Complete  
2. TOTAL NUMBER RECORDS   should equal  3. Approved and Posted  +4. Approved No Adj   +5. Approval Rejected 
6. Completed  Material Transaction should equal  3. Approved and Posted  
7. Approved Adj Needed  if 1. ADJUSTMENTS_POSTED  is true the Misc transaction or cycle count the remaining adjustments 
8. Errored  Pending Transaction  . Ref:[1942897/KB732048] reject the  error record.  If inventory transactions continued after the  snap shot you may have to do this step several time 
9. Not Approved  -  Approve and Proceed if the Physical Inventory is not Complete   ',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: INV_PI_SCORE_CARD');



debug('begin add_signature: EBS_MFG_INV_INVPICC_FROZEN_INV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26120',
      p_sig_id                 => 'EBS_MFG_INV_INVPICC_FROZEN_INV',
      p_sig_sql                => 'select 
request_id,
phase_code,
status_code,
...
from fnd_concurrent_programs
where concurrent_program_name = ''INCAPF'')
and argument1 = ''PHYSICAL_INVENTORY_ID=''||##$$PIID$$##',
      p_title                  => 'Freeze Physical Inventory Concurrent Program',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Freeze Physical Inventory Concurrent Program has not been executed for this Physical Inventory or the Concurrent Request has been purged.',
      p_solution               => 'Validate if the User must FREEZE this Physical Inventory to start the counts.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVPICC_FROZEN_INV');



debug('begin add_signature: EBS_MFG_INV_INVPICC_PHSYSICAL_ADJUSTMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26121',
      p_sig_id                 => 'EBS_MFG_INV_INVPICC_PHSYSICAL_ADJUSTMENTS',
      p_sig_sql                => 'select organization_id,
physical_inventory_id,
adjustment_id,
decode(nvl(approval_status,0),
0,''NULL-Pending'',
1, ''1-Approved'', 
2, ''2-Rejected'', 
3, ''3-Posted'') approval_status,
inventory_item_id,
(select concatenated_segments from mtl_system_items_kfv b where b.inventory_item_id = a.inventory_item_id and rownum = 1) item_num,
uom,
adjustment_quantity,
value,
pct,
...
cost_group_id,
cost_group_name
from mtl_physical_adjustments_v a
where physical_inventory_id = ##$$PIID$$##
order by inventory_item_id asc',
      p_title                  => 'Physical Adjustments',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No adjustments have been created for this Physical Inventory.',
      p_solution               => 'Freeze this Physical Inventory.',
      p_success_msg            => 'These are the Physical Adjustments created for this Physical Inventory.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVPICC_PHSYSICAL_ADJUSTMENTS');



debug('begin add_signature: EBS_MFG_INV_INVPICC_COUNT_TAGS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26122',
      p_sig_id                 => 'EBS_MFG_INV_INVPICC_COUNT_TAGS',
      p_sig_sql                => 'select organization_id,
tag_id,
tag_number,
physical_inventory_id,
...
order by tag_number asc',
      p_title                  => 'Physical Count Tags',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No tags has been created for this Physical Inventory.',
      p_solution               => 'Generate Physical Inventory Tags.',
      p_success_msg            => 'These are the Physical Inventory Tags created for this Physical Inventory.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVPICC_COUNT_TAGS');



debug('begin add_signature: EBS_MFG_INV_INVPICC_MMTT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26123',
      p_sig_id                 => 'EBS_MFG_INV_INVPICC_MMTT',
      p_sig_sql                => 'select transaction_temp_id,
organization_id,
transaction_mode,
lock_flag,
creation_date,
...
where physical_inventory_id = ##$$PIID$$##)
order by physical_adjustment_id asc',
      p_title                  => 'Physical Adjustments Pending Transactions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No pending transactions found.',
      p_solution               => 'Count tasks have not been generated.',
      p_success_msg            => 'These are the pending transactions for this Physical Inventory.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVPICC_MMTT');



debug('begin add_signature: PI_STUCK_MMTT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6962',
      p_sig_id                 => 'PI_STUCK_MMTT',
      p_sig_sql                => 'SELECT mmtt.transaction_source_id phy_inv_id,
  mmtt.transaction_reference trx_ref,
  TO_CHAR(transaction_date, ''YYYY-MM'') Month_Year,
  COUNT(*)
FROM mtl_material_transactions_temp mmtt
WHERE transaction_temp_id IN
  (SELECT mmtt.transaction_temp_id
  FROM -- Serial Controlled Item
    mtl_material_transactions_temp mmtt,
    mtl_serial_numbers msn,
    mtl_serial_numbers_temp msnt,
    mtl_physical_adjustments mpa
  WHERE mmtt.physical_adjustment_id IS NOT NULL
  AND mpa.adjustment_id = mmtt.physical_adjustment_id
  AND mpa.physical_inventory_id = ##$$PIID$$##
  AND mmtt.transaction_action_id     = 8
  ...
  AND msn.current_subinventory_code <> mmtt.subinventory_code
  UNION -- Lot and Serial Controlled Item
  SELECT mmtt.transaction_temp_id
  FROM mtl_material_transactions_temp mmtt,
    mtl_serial_numbers msn,
    mtl_lot_numbers mlt,
  ...
  AND msn.lot_number                 =mlt.lot_number
  AND msn.serial_number              = msnt.fm_serial_number
  AND msn.current_subinventory_code <> mmtt.subinventory_code
  UNION -- Lot controlled item
  SELECT mmtt.transaction_temp_id
  FROM mtl_material_transactions_temp mmtt,
    mtl_lot_numbers mln,
    mtl_transaction_lots_temp mtlt,
  ...
  AND mmtt.lot_number               <> mtlt.lot_number
  UNION -- Plain Item
  SELECT mmtt.transaction_temp_id
  FROM mtl_material_transactions_temp mmtt,
    mtl_secondary_inventories mss,
    mtl_physical_adjustments mpa
  WHERE mmtt.transaction_action_id = 8
  AND mmtt.physical_adjustment_id IS NOT NULL
  AND mpa.adjustment_id = mmtt.physical_adjustment_id
  AND mpa.physical_inventory_id = ##$$PIID$$##
  AND mmtt.subinventory_code       =mss.secondary_inventory_name
  AND mmtt.organization_id         =mss.organization_id
  )
GROUP BY mmtt.transaction_source_id ,
  mmtt.transaction_reference ,
  TO_CHAR(transaction_date, ''YYYY-MM'')',
      p_title                  => 'Old Physical Inventory Adjustments(MMTT)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This signature is to identify Physical Inventory Adjustments that remain in the pending transactions table (MTL_MATERIAL_TRANSACTIONS_TEMP). This is not necessarily a data corruption but is often a critical, urgent issue preventing period close. ',
      p_solution               => 'Physical Inventory Adjustments remain in the Pending Transactions table MTL_MATERIAL_TRANSACTIONS_TEMP MMTT. This is data corruption and needs to be resolved. Please follow the steps at [1942897/KB732048#aref_section29] to resolve the issue.',
      p_success_msg            => 'There are no existing Physical Inventory Adjustment records in the Pending Transactions table MTL_MATERIAL_TRANSACTIONS_TEMP MMTT.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PI_STUCK_MMTT');



debug('begin add_signature: INV_PI_INCORRECT_APPROVAL_STATUS_PIID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17560',
      p_sig_id                 => 'INV_PI_INCORRECT_APPROVAL_STATUS_PIID',
      p_sig_sql                => 'SELECT P.ADJUSTMENT_ID,
  P.ORGANIZATION_ID,
  P.PHYSICAL_INVENTORY_ID,
  P.INVENTORY_ITEM_ID,
  P.ADJUSTMENT_QUANTITY,
  P.APPROVAL_STATUS
FROM MTL_PHYSICAL_ADJUSTMENTS P,
...
AND M.TRANSACTION_TYPE_ID   = 8
AND P.PHYSICAL_INVENTORY_ID = M.TRANSACTION_SOURCE_ID
AND P.ADJUSTMENT_ID         = M.PHYSICAL_ADJUSTMENT_ID
AND P.organization_id            = ##$$ORGID$$##
AND P.physical_inventory_id   =##$$PIID$$##
ORDER BY P.ORGANIZATION_ID,
  P.PHYSICAL_INVENTORY_ID,
  P.INVENTORY_ITEM_ID
',
      p_title                  => 'Incorrect Approval Status specific to Physical Inventory ID',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Identification of Physical Inventory Adjustments that have processed but still show APPROVAL_STATUS = 1 (Approved, instead of Posted) in the MTL_PHYSICAL_ADJUSTMENTS (MPA) Table.',
      p_solution               => 'Physical Inventory Adjustments have been identified that are in APPROVAL_STATUS = 1 (Approved, instead of Posted) in the MTL_PHYSICAL_ADJUSTMENTS (MPA) Table. Follow the steps detailed in [2093233/KB709918] to fix the approval_Status.',
      p_success_msg            => 'All adjustments have the correct approval status in the MTL_PHYSICAL_ADJUSTMENTS (MPA) Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: INV_PI_INCORRECT_APPROVAL_STATUS_PIID');



debug('begin add_signature: PI_INCORRECT_APPROVAL_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6965',
      p_sig_id                 => 'PI_INCORRECT_APPROVAL_STATUS',
      p_sig_sql                => 'SELECT P.ADJUSTMENT_ID, P.ORGANIZATION_ID,
P.PHYSICAL_INVENTORY_ID, P.INVENTORY_ITEM_ID,
P.ADJUSTMENT_QUANTITY, P.APPROVAL_STATUS
FROM MTL_PHYSICAL_ADJUSTMENTS P, MTL_MATERIAL_TRANSACTIONS M
WHERE (P.APPROVAL_STATUS = 1 OR P.APPROVAL_STATUS IS NULL)
AND P.ADJUSTMENT_QUANTITY != 0
AND P.ORGANIZATION_ID = M.ORGANIZATION_ID
AND P.INVENTORY_ITEM_ID = M.INVENTORY_ITEM_ID
AND M.TRANSACTION_TYPE_ID = 8
AND P.PHYSICAL_INVENTORY_ID = M.TRANSACTION_SOURCE_ID
AND P.ADJUSTMENT_ID = M.PHYSICAL_ADJUSTMENT_ID
ORDER BY P.ORGANIZATION_ID, P.PHYSICAL_INVENTORY_ID, P.INVENTORY_ITEM_ID',
      p_title                  => 'Incorrect Approval Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Identification of Physical Inventory Adjustments that have processed but still show APPROVAL_STATUS = 1 (Approved, instead of Posted) in the MTL_PHYSICAL_ADJUSTMENTS (MPA) Table.',
      p_solution               => 'Physical Inventory Adjustments have been identified that are in APPROVAL_STATUS = 1 (Approved, instead of Posted) in the MTL_PHYSICAL_ADJUSTMENTS (MPA) Table. Follow the steps detailed in [2093233/KB709918] to fix the approval_Status.',
      p_success_msg            => 'All adjustments have the correct approval status in the MTL_PHYSICAL_ADJUSTMENTS (MPA) Table.',
   ...
   l_info.delete;
debug('end add_signature: PI_INCORRECT_APPROVAL_STATUS');



debug('begin add_signature: PI_RESERVATIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6963',
      p_sig_id                 => 'PI_RESERVATIONS',
      p_sig_sql                => 'select * from (
...
mr.reservation_id REFERENCE_ID,
mr.subinventory_code,
mr.reservation_quantity QUANTITY
from mtl_physical_adjustments mpa,
mtl_reservations mr
where mpa.organization_id = mr.organization_id
and mpa.inventory_item_id = mr.inventory_item_id
and mpa.subinventory_name = mr.subinventory_code
and nvl(mpa.locator_id,0) = nvl(mr.locator_id,0)
and mpa.physical_inventory_id = ##$$PIID$$##
and nvl(mpa.approval_status,0) = 0
union
select mpa.adjustment_id,
mpa.organization_id,
mpa.inventory_item_id,
...
mmtt.transaction_temp_id REFERENCE_ID,
mmtt.subinventory_code,
mmtt.transaction_quantity QUANTITY
from mtl_physical_adjustments mpa,
mtl_material_transactions_temp mmtt
where mpa.organization_id = mmtt.organization_id
and mpa.inventory_item_id = mmtt.inventory_item_id
and mpa.subinventory_name = mmtt.subinventory_code
and nvl(mpa.locator_id,0)= nvl(mmtt.locator_id,0)
and mpa.physical_inventory_id = ##$$PIID$$##
and nvl(mpa.approval_status,0) = 0) x
order by adjustment_id asc',
      p_title                  => 'Physical Inventory Adjustments For Item With Reservations / Allocations Against It',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Identification of Physical Inventory Adjustment records which may cause error "You are trying to perform Physical Inventory Adjustment for material that has reservations / allocations against it"',
      p_solution               => 'Physical Inventory Adjustment records exist for material that has reservations / allocations against it. Follow the steps detailed in [1544752/KB627545] to remove the reservations and/or allocations.',
      p_success_msg            => 'No Physical Inventory Adjustment records exist with pending reservations or allocations against them.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PI_RESERVATIONS');



debug('begin add_signature: PI_NO_LOT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6973',
      p_sig_id                 => 'PI_NO_LOT',
...
WHERE mpa.physical_inventory_id = ##$$PIID$$##
AND mpa.organization_id         = ##$$ORGID$$##
...
OR mpa.approval_status         IS NULL )',
      p_title                  => 'List of Adjustments Without Lot for Lot-Controlled Item',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Display of adjustments which are lot controlled but for which lot number is not populated.',
      p_solution               => 'Follow the steps documented in Trouble Shooting Guide For Physical Inventory (PI) Adjustment Processing Transactions [133419/KB708520#error1], go to Sql6 ''This Sql is to find out the which adjustments which are lot controlled but for which lot number is not populated.''',
      p_success_msg            => 'All the adjustments which contain lot controlled items are populated with lot numbers',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PI_NO_LOT');



debug('begin add_signature: PI_NO_SERIAL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6975',
      p_sig_id                 => 'PI_NO_SERIAL',
      p_sig_sql                => 'SELECT mpa.adjustment_id adj_id,
  mpa.inventory_item_id itm_id,
  msi.segment1 item_name,
  mpa.subinventory_name sub,
  mpa.revision rev,
  mpa.locator_id loc,
  mpa.lot_number lot,
  mpa.serial_number ser,
  mpa.approval_status astat,
  mpa.adjustment_quantity adj_qty
FROM mtl_physical_adjustments mpa,
  mtl_system_items msi
WHERE mpa.physical_inventory_id     = ##$$PIID$$##
AND mpa.organization_id             = ##$$ORGID$$##
...
AND (mpa.approval_status            = 1
OR mpa.approval_status             IS NULL )',
      p_title                  => 'List of Adjustments Without Serial For Serial-Controlled Item',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Adjustments exist which are serial controlled, but for which serial number is not populated.
Check for items with serial number control IN 2 (Predefined) or 5 (At Receipt).',
      p_solution               => 'Review the detailed steps in Trouble Shooting Guide For Physical Inventory (PI) Adjustment Processing Transactions [133419/KB708520], refer to section APP-05581:Total serial numbers does not match the transaction quantity, SQLs 1-10. ',
      p_success_msg            => 'All the adjustments which contain lot controlled items are populated with lot numbers.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: PI_NO_SERIAL');



debug('begin add_signature: PI_INVALID_SERIAL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6976',
      p_sig_id                 => 'PI_INVALID_SERIAL',
      p_sig_sql                => 'SELECT mpa.adjustment_id,
  mpa.serial_number,
  mpa.inventory_item_id
FROM mtl_serial_numbers msn,
  mtl_physical_adjustments mpa
WHERE msn.current_organization_id = mpa.organization_id
AND msn.inventory_item_id         = mpa.inventory_item_id
AND msn.current_status            = 4
AND mpa.physical_inventory_id     = ##$$PIID$$##
AND msn.serial_number             = mpa.serial_number
...
AND ( APPROVAL_STATUS NOT IN (2,3) OR APPROVAL_STATUS IS NULL )
AND adjustment_quantity           > 0',
      p_title                  => 'List of Adjustments with Problem Serial Number(s)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Serial number has a current status that is invalid for this transaction.',
      p_solution               => 'Review the steps documented in Trouble Shooting Guide For Physical Inventory (PI) Adjustment Processing Transactions [133419/KB708520#error4]. Goto Section Error 4: APP-5599: Serial number <serial number> is not available for this transaction - See details with Sql5 and Sql6.',
      p_success_msg            => 'There are no adjustments where serial numbers have an unusable status.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PI_INVALID_SERIAL');



debug('begin add_signature: PI_DUPLICATE_MMT_MMTT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6964',
      p_sig_id                 => 'PI_DUPLICATE_MMT_MMTT',
      p_sig_sql                => 'SELECT *
FROM mtl_material_transactions_temp mmtt
WHERE physical_adjustment_id  IS NOT NULL
...
AND EXISTS
  ...
  FROM mtl_material_transactions
  WHERE physical_adjustment_id  IS NOT NULL
  AND physical_adjustment_id     = mmtt.physical_adjustment_id
  AND transaction_source_id      = mmtt.transaction_source_id
  AND transaction_action_id      = mmtt.transaction_action_id
  AND transaction_reference      = mmtt.transaction_reference
  AND transaction_source_type_id = mmtt.transaction_source_type_id
  AND organization_id            = mmtt.organization_id
  )',
      p_title                  => 'Duplicate Adjustments in MMT and MMTT',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Identification of duplicate Physical Inventory adjustments in the MTL_MATERIAL_TRANSACTIONS (MMT) and MTL_MATERIAL_TRANSACTIONS_TEMP (MMTT) Tables.',
      p_solution               => 'It has been identified that there are duplicate Physical Inventory adjustments in the MTL_MATERIAL_TRANSACTIONS (MMT) and MTL_MATERIAL_TRANSACTIONS_TEMP (MMTT) Tables. 

Please log a service request with Oracle Inventory Management and reference [1616316/KB758018] for a datafix to remove the duplicates.',
      p_success_msg            => 'There are no Duplicate Physical Inventory adjustments in the MTL_MATERIAL_TRANSACTIONS (MMT) and MTL_MATERIAL_TRANSACTIONS_TEMP (MMTT) Tables.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PI_DUPLICATE_MMT_MMTT');



debug('begin add_signature: PI_TAG_COUNT_INCORRECT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6966',
      p_sig_id                 => 'PI_TAG_COUNT_INCORRECT',
      p_sig_sql                => 'SELECT MPA.ORGANIZATION_ID,
  MPA.INVENTORY_ITEM_ID,
  MPA.SUBINVENTORY_NAME,
  MPA.LOCATOR_ID,
  MPA.REVISION,
...
WHERE MPA.PHYSICAL_INVENTORY_ID  = ##$$PIID$$##
AND MPA.ADJUSTMENT_ID            = MPT.ADJUSTMENT_ID
AND NVL(MPA.COUNT_QUANTITY,999) != NVL(MPT.TAG_QUANTITY,999)
AND  MPA.INVENTORY_ITEM_ID = MSIB.INVENTORY_ITEM_ID',
      p_title                  => 'Physical Inventory Tag Counts Are Recorded Incorrectly In Physical  Adjustments',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Identification of records where MTL_PHYSICAL_INVENTORY_TAGS.TAG_COUNT does not equal 
MTL_PHYSICAL_ADJUSTMENTS.COUNT_QUANTITY.',
      p_solution               => 'MTL_PHYSICAL_INVENTORY_TAGS.TAG_COUNT does not equal 
MTL_PHYSICAL_ADJUSTMENTS.COUNT_QUANTITY. Review [168263/KB790696] for explanation for why there is a difference and follow the detailed steps for resolution.',
      p_success_msg            => 'Physical Inventory Tag Counts are Recorded correctly in Physical Adjustments',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PI_TAG_COUNT_INCORRECT');



debug('begin add_signature: PI_DUP_POSTED_MMT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7004',
      p_sig_id                 => 'PI_DUP_POSTED_MMT',
      p_sig_sql                => 'SELECT organization_id,
...
GROUP BY organization_id,
  ...
  transaction_uom
HAVING COUNT(*) > 1',
      p_title                  => 'Duplicate Adjustment Posted In MMT',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Identification of duplicate postings of Physical Inventory adjustments in the MTL_MATERIAL_TRANSACTIONS (MMT) Table.',
      p_solution               => 'To resolve the issue, see the solution in Section 4 in Physical Inventory [2257524/FAQ4735#aref_section24].',
      p_success_msg            => 'There are no duplicate postings of Physical Inventory adjustments in Material Transactions.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PI_DUP_POSTED_MMT');



debug('begin add_signature: INV_PI_ITEMS_IN_PHYSICAL_INVENTORY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18189',
      p_sig_id                 => 'INV_PI_ITEMS_IN_PHYSICAL_INVENTORY',
      p_sig_sql                => 'SELECT moqd.organization_id,
    ...
    moqd.lot_number,
    moqd.lpn_id,
    SUM(primary_transaction_quantity) qty
  FROM MTL_ONHAND_QUANTITIES_DETAIL moqd 
  where moqd.inventory_item_id in ( select distinct(inventory_item_id) from  MTL_PHYSICAL_ADJUSTMENTS 
                                where  physical_inventory_id = ##$$PIID$$##
                                 and organization_id =  ##$$ORGID$$##) 
  and      moqd.subinventory_code in (select     MSI.SECONDARY_INVENTORY_NAME   from MTL_SECONDARY_INVENTORIES MSI,  MTL_PHYSICAL_INVENTORIES MPI
                                                                                         where MPI.physical_inventory_id =  ##$$PIID$$##
                                                                                          and MPI.ALL_SUBINVENTORIES_FLAG = 1  
                                                                                          and  MSI.organization_id = ##$$ORGID$$##
                                                                                          and MPI.organization_id = MSI.organization_id
                                                                                          and MPI.physical_inventory_id =   ##$$PIID$$##    )
                                                                                          
   or     moqd.subinventory_code  in     (Select SUBINVENTORY  from MTL_PHYSICAL_SUBINVENTORIES MPS ,MTL_PHYSICAL_INVENTORIES MPI
                                                                                                       where MPI.physical_inventory_id =  ##$$PIID$$## 
                                                                                                       and MPI.ALL_SUBINVENTORIES_FLAG = 2                                                                                                   
                                                                                                    and MPS.physical_inventory_id = MPI.physical_inventory_id )                                                                                    
  ...
  GROUP BY moqd.organization_id,
    ...
    moqd.lpn_id,
    moqd.lot_number
  HAVING moqd.organization_id = ##$$ORGID$$##',
      p_title                  => 'Onhand for Items in Physical Inventory',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The onhand quantity for item in the physical inventory',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: INV_PI_ITEMS_IN_PHYSICAL_INVENTORY');
...
BEGIN
  ...
  IF (p_count_type IS NOT NULL) THEN
    g_params_string := g_params_string || to_char(p_count_type) || '_';
  END IF;
  ...
  analyzer_title := 'Inventory Counting Analyzer';
...
debug('begin section: CC_SETUP');
IF p_count_type = 'CC'
and g_sql_tokens('##$$CCHEADERID$$##') IS NOT NULL THEN
   start_section('Cycle Count Setup', 'CC_SETUP');
      set_item_result(run_stored_sig('EBS_MFG_INV_INVPICC_HEADER'));
      set_item_result(run_stored_sig('EBS_MFG_INV_INVPICC_ABC_COMPILE'));
      set_item_result(run_stored_sig('EBS_MFG_INV_INVPICC_ITEM_CC'));
      set_item_result(run_stored_sig('BOM_ORG_DETAILS_11I'));
      set_item_result(run_stored_sig('INV_CC_SCORE_CARD'));
      set_item_result(run_stored_sig('INV_ORGANIZATIONS_FULL_OUTPUT_ORG'));
      set_item_result(run_stored_sig('EBS_MFG_INV_INVPICC_ASG_GROUP'));
      set_item_result(run_stored_sig('EBS_MFG_INV_INVPICC_CLASS'));
      set_item_result(run_stored_sig('EBS_MFG_INV_INVPICC_SUBINV'));
   end_section;
END IF;
debug('end section: CC_SETUP');

debug('begin section: CC_DATA');
IF g_sql_tokens('##$$CCHEADERID$$##') IS NOT NULL 
and p_count_type = 'CC' THEN
   start_section('Cycle Count Data For Open Entries', 'CC_DATA');
      set_item_result(run_stored_sig('EBS_MFG_INV_INVPICC_OPEN_ENTRIES'));
      set_item_result(run_stored_sig('EBS_MFG_INV_INVPICC_ONHAND'));
      set_item_result(run_stored_sig('EBS_MFG_INV_INVPICC_ITEM_RESERVATIONS_OPEN_ENTRIES'));
      set_item_result(run_stored_sig('EBS_MFG_INV_INVPICC_SCHEDULE_REQUESTS_OPEN_ENTRIES'));
      set_item_result(run_stored_sig('EBS_MFG_INV_INVPICC_CC_INTERFACE'));
      set_item_result(run_stored_sig('EBS_MFG_INV_INVTAZ_PENDING_CYCLE_COUNT_ENTRIES'));
   end_section;
END IF;
debug('end section: CC_DATA');

debug('begin section: CC_COMMON_DATA_ISSUES');
IF g_sql_tokens('##$$CCHEADERID$$##') IS NOT NULL THEN
   start_section('Cycle Count Common Data Issues', 'CC_COMMON_DATA_ISSUES');
      set_item_result(run_stored_sig('BOM_CALENDAR_REBUILD_CHECK'));
      set_item_result(run_stored_sig('INV_CC_SCHEDULE_NO_ITEM'));
      set_item_result(run_stored_sig('INV_CC_MTL_CCEOI_ACTION_PUB_ERRORS'));
      set_item_result(run_stored_sig('INV_CC_INTERFACE_ERROR_NO_SERIAL_NUMBER'));
      set_item_result(run_stored_sig('EBS_MFG_INV_INVPICC_ISSUED_OUT_SERIAL'));
   end_section;
END IF;
debug('end section: CC_COMMON_DATA_ISSUES');

debug('begin section: PI_SETUP');
IF p_count_type = 'PI'
and g_sql_tokens('##$$PIID$$##') IS NOT NULL THEN
   start_section('Physical Inventory Setup', 'PI_SETUP');
      set_item_result(run_stored_sig('INV_PI_HEADER'));
      set_item_result(run_stored_sig('INV_PI_SCORE_CARD'));
      set_item_result(run_stored_sig('EBS_MFG_INV_INVPICC_FROZEN_INV'));
      set_item_result(run_stored_sig('BOM_ORG_DETAILS_11I'));
      set_item_result(run_stored_sig('INV_ORGANIZATIONS_FULL_OUTPUT_ORG'));
   end_section;
END IF;
debug('end section: PI_SETUP');

debug('begin section: PI_DATA');
IF p_count_type = 'PI'
and g_sql_tokens('##$$PIID$$##') IS NOT NULL THEN
   start_section('Physical Inventory Data', 'PI_DATA');
      set_item_result(run_stored_sig('EBS_MFG_INV_INVPICC_PHSYSICAL_ADJUSTMENTS'));
      set_item_result(run_stored_sig('EBS_MFG_INV_INVPICC_COUNT_TAGS'));
      set_item_result(run_stored_sig('EBS_MFG_INV_INVPICC_MMTT'));
   end_section;
END IF;
debug('end section: PI_DATA');

debug('begin section: PI_COMMON_DATA_ISSUES');
IF g_sql_tokens('##$$PIID$$##') IS NOT NULL THEN
   start_section('Physical Inventory Common Data Issues', 'PI_COMMON_DATA_ISSUES');
      set_item_result(run_stored_sig('PI_STUCK_MMTT'));
      set_item_result(run_stored_sig('INV_PI_INCORRECT_APPROVAL_STATUS_PIID'));
      set_item_result(run_stored_sig('PI_INCORRECT_APPROVAL_STATUS'));
      set_item_result(run_stored_sig('PI_RESERVATIONS'));
      set_item_result(run_stored_sig('PI_NO_LOT'));
      set_item_result(run_stored_sig('PI_NO_SERIAL'));
      set_item_result(run_stored_sig('PI_INVALID_SERIAL'));
      set_item_result(run_stored_sig('PI_DUPLICATE_MMT_MMTT'));
      set_item_result(run_stored_sig('PI_TAG_COUNT_INCORRECT'));
      set_item_result(run_stored_sig('PI_DUP_POSTED_MMT'));
      set_item_result(run_stored_sig('INV_PI_ITEMS_IN_PHYSICAL_INVENTORY'));
   end_section;
END IF;
debug('end section: PI_COMMON_DATA_ISSUES');

debug('begin section: Proactive_Recommendations');
start_section('Proactive Recommendations', 'Proactive_Recommendations');
   set_item_result(check_rec_patches_1); /* Signature INV_CHECK_REC */
   set_item_result(check_rec_patches_2); /* Signature INV_RUP_CHECK */
