...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Inventory Intercompany AR and AP       |
REM | Invoicing Analyzer                                                        |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE inv_intercomp_analyzer_pkg AUTHID DEFINER AS
...
END inv_intercomp_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY inv_intercomp_analyzer_pkg AS
-- $Id: inv_intercomp_analyzer.sql, 200.21 2026/01/29 16:53:46 tchavez Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2220141.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'INVICI_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'INVICI_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>INVICI Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2220141.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/inv_intercomp_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,933,EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,933,EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},933,EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4006033" class="blacklink" target="new">
...
<div class="ck-content"><div><div><span style="font-size:12px;">We’re listening to your feedback and made the following changes:</span></div>
<div>&nbsp;</div>
<div>Version 200.21</div>
<div>&nbsp; &nbsp;Updated link format</div>
<div>&nbsp;</div>
<div>Version 200.20 05-DEC-2025</div>
<div>&nbsp; &nbsp;Removed signature ‘Key Current Warehouse Parameters’ Analyzer uses required token in a different context</div>
<div>&nbsp;</div>
<div>Version 200.19 18-AUG-2025</div>
<div>&nbsp; &nbsp;Added signature ‘Key Current Warehouse Parameters’</div>
<div>&nbsp; &nbsp;Signature updates</div>
<div>&nbsp;</div>
<div>Version 200.18 04-MAR-2025</div>
<div>&nbsp; &nbsp; &nbsp;Signature updates</div>
<div>&nbsp; &nbsp; &nbsp;Framework updates</div>
<div>&nbsp;</div>
<div>Version 200.17 27-NOV-2024</div>
<div>&nbsp;&nbsp;&nbsp;&nbsp; Signature updates</div>
<div>&nbsp;</div>
<div>Version 200.16 26-SEP-2024</div>
<div>&nbsp;&nbsp;&nbsp;&nbsp; Signature updates</div>
<div>&nbsp;</div>
<div>Version 200.15 17-JUL-2024</div>
<div>&nbsp;&nbsp;&nbsp;&nbsp; Added signature &apos;<span class="display_only apex-item-display-only" id="P18_TITLE_DISPLAY">Virtual Private Database Policies&apos;</span></div>
<div>&nbsp;</div>
<div>Version 200.14 10-APR-2024</div>
<div><p>&nbsp; &nbsp; Rename “Lifetime Support Policy” with “Critical Alerts”<br>
&nbsp; &nbsp; Add 2 signatures</p><p>&nbsp; &nbsp; EBS_ATG_UGLE_32BIT_SEQUENCES_CLOSE_TO_MAX<br>
&nbsp; &nbsp; EBS_ATG_UGLE_SEQUENCES_CLOSE_TO_MAXIMUM_VALUE</p></div>
<div>&nbsp;</div>
<div>Version 200.13 26-JAN-2024</div>
<ul><li>Added signature ‘Inventory Account Generator Workflow Process Name’</li>
<li>Framework updates</li>
</ul>
<div>&nbsp;</div>
<div>Version 200.12 22-August-2023</div>
<ul><li>Signature updates</li>
<li>Framework updates</li>
</ul>
<div>&nbsp;</div>
<div><span style="font-size:12px;">Version 200.11 June 2023</span></div>
<ul><li><span style="font-size:12px;">Added signature for database Information and Languages Installed</span></li>
</ul>
<div>&nbsp;</div>
<div>Version 200.8 September 2022</div>
<ul><li>Updated variable &apos;<span style="background-color:#f9f9f9;color:#262626;"><span style="font-family:&apos;Oracle Sans&apos;,-apple-system,&apos;system-ui&apos;,&apos;Segoe UI&apos;,Roboto,Oxygen,Ubuntu,Cantarell,&apos;Fira Sans&apos;,&apos;Droid Sans&apos;,&apos;Helvetica Neue&apos;,sans-serif;font-size:12px;">P_SO_OR_ISO&apos; to take 5 digits</span></span></li>
</ul>
<div>&nbsp;</div>
<div><span style="font-size:12px;">Version 200.7 October 2021</span></div>
<ul><li><span style="font-size:12px;">Added several new signatures</span></li>
<li><span style="font-size:12px;">Updated existing signatures</span></li>
<li><span style="font-size:12px;">Analyzer Framework update</span></li>
</ul>
<div><br>
<span style="font-size:12px;">Version 200.6 November 2019:</span></div>
<ul><li>The analyzer is now executed as a Package instead of an Anonymous Block. Please see the analyzer Doc ID 2220141.1 for running the analyzer as a Concurrent Request or in Sql*Plus.</li>
<li>New Analyzer Framework 4.4.4.</li>
</ul>
<div><span style="font-size:12px;">Version 200.5 August 2019:</span></div>
<ul><li><span style="font-size:12px;">Framework upgrade to 4.4.3.</span></li>
<li><span style="font-size:12px;">New page from the Execution Summary showing all Passed Checks that are not printed in the main report</span></li>
<li><span style="font-size:12px;">Enhanced Search to make it easier to find results found</span></li>
<li><span style="font-size:12px;">Back to top link</span></li>
<li><span style="font-size:12px;">Modified icons but same functionality for easier ease of use</span></li>
</ul>
<p><span style="font-size:12px;">Fix of all known bugs</span><br>
<br>
Version 200.2 October 2018:</p><ul><li><span style="font-size:12px;">Release of additional sections listed below</span></li>
<li><span style="font-size:12px;">Pricing</span><br>
<span style="font-size:12px;">-Intercompany Price List</span><br>
<span style="font-size:12px;">-Customer Bill-To Location Price list</span><br>
<span style="font-size:12px;">-Advance Pricing IBATCH Setup</span><br>
<span style="font-size:12px;">-Advance Pricing INTCOM Enabled Flag</span></li>
<li><span style="font-size:12px;">Errors</span><br>
<span style="font-size:12px;">&nbsp;- APP_INV_05700</span><br>
<span style="font-size:12px;">&nbsp;-APP_INV_05706</span><br>
&nbsp;<span style="font-size:12px;">-ALL</span></li>
<li>Setup<br>
-Organization Parameters Details of Warehouses In Internal Sales Order<br>
-Organization Definition of Warehouses in Internal Sales Order<br>
-Operating Unit Details Present In Internal Sales Order</li>
</ul>
<p>Version 200.1 July 2019:</p><ul><li>The Data Masking feature has been expanded.<br>
-Select data is now pre-masked at the point of collection.<br>
-The masked information displayed will be just enough to permit effective review and troubleshooting of an issue.</li>
</ul>
<p style="margin-left:40px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Example:&nbsp; A credit card number would be displayed as ****-****-****-1234<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; An employee name would be displayed as Display first and last 25% per word (J**n S**w = John Snow)</p><p style="margin-left:40px;">-The existing “Lock Icon” still provides customers the manual column scrambling capabilities, which can be used in addition to the newly introduced pre-masked data feature.</p></div>
</div>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,933,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,933,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},933,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Inventory" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
BEGIN
    ...
    print_log('Processing recommended patches signature: INV_RUP_CHECK (check_rec_patches_1) "Inventory Rollup Patch Status" (version 14)');
...
IF substr(g_rep_info('Apps Version'),1,3) = '11i' THEN
   l_rel := '11i';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '4042499';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Supply Chain Management Family Pack J Rollup Patch 1';
   l_col_rows(5)(l_rows) := '[295456.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '4231215';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Supply Chain Management Family Pack J Rollup Patch 2';
   l_col_rows(5)(l_rows) := '[302065.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '4734840';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Inventory, Warehouse Management, Mobile Application Server (MWA), and Receiving (PO): Release 11.5.10, Rollup Patch 3 (INV/WMS/MWA/RCV 11.5.10 RUP3)';
   l_col_rows(5)(l_rows) := '[352825.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '5739724';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Inventory and Receiving (PO): Release 11.5.10, Rollup Patch 4 (INV/RCV 11.5.10 RUP4)';
   l_col_rows(5)(l_rows) := '[417530.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '6449139';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Inventory and Receiving (PO): Release 11.5.10, Rollup Patch 5 (INV/RCV 11.5.10 RUP5)';
   l_col_rows(5)(l_rows) := '[468892.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '6461517';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Inventory and Receiving (PO): Release 11.5.10, Rollup Patch 6 (INV/RCV 11.5.10 RUP6)';
   l_col_rows(5)(l_rows) := '[554434.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '6461519';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Inventory and Receiving (PO): Release 11.5.10, Rollup Patch 7 (INV/RCV 11.5.10 RUP7)';
   l_col_rows(5)(l_rows) := '[564558.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '6461522';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Inventory and Receiving (PO): Release 11.5.10, Rollup Patch 8';
   l_col_rows(5)(l_rows) := '[601407.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '6870030';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Inventory and Receiving (PO): Release 11.5.10, Rollup Patch 9';
   l_col_rows(5)(l_rows) := '[726406.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '7258620';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Inventory and Receiving (PO): Release 11.5.10, Rollup Patch 10';
   l_col_rows(5)(l_rows) := '[733954.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '7258624';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Inventory and Receiving (PO): Release 11.5.10, Rollup Patch 11';
   l_col_rows(5)(l_rows) := '[741890.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '7258629';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Inventory and Receiving (PO): Release 11.5.10, Rollup Patch 12';
   l_col_rows(5)(l_rows) := '[754457.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '7581431';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Inventory and Receiving (PO): Release 11.5.10, Rollup Patch 13';
   l_col_rows(5)(l_rows) := '[764201.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '7666112';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Inventory and Receiving (PO): Release 11.5.10, Rollup Patch 14';
   l_col_rows(5)(l_rows) := '[794662.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '8403245';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Inventory and Receiving (PO): Release 11.5.10, Rollup Patch 15';
   l_col_rows(5)(l_rows) := '[824999.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '8403254';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Inventory and Receiving (PO): Release 11.5.10, Rollup Patch 16';
   l_col_rows(5)(l_rows) := '[864888.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '8403258';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Inventory and Receiving (PO): Release 11.5.10, Rollup Patch 17';
   l_col_rows(5)(l_rows) := '[889694.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '11.5' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '9063156';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Inventory and Receiving (PO): Release 11.5.10, Rollup Patch 18';
   l_col_rows(5)(l_rows) := '[978053.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '9265857';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Inventory and Receiving (PO): Release 11.5.10, Rollup Patch 19';
   l_col_rows(5)(l_rows) := '[1059569.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '9466436';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Inventory and Receiving (PO): Release 11.5.10, Rollup Patch 20';
   l_col_rows(5)(l_rows) := '[1086420.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '9649124';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Inventory and Receiving (PO): Release 11.5.10, Rollup Patch 21';
   l_col_rows(5)(l_rows) := '[1139759.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '9878808';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Inventory and Receiving (PO): Release 11.5.10, Rollup Patch 22';
   l_col_rows(5)(l_rows) := '[1211515.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.0' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Release 12.0.0 - provides R12 baseline code (Oracle Applications Release 12)';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.0.1 : RUP1 FOR ORACLE APPLICATIONS RELEASE 12';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle E-Business Suite 12.0.2 Release Update Pack (RUP2)';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle E-Business Suite 12.0.3 Release Update Pack (RUP3)';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'ORACLE E-BUSINESS SUITE 12.0.4 RELEASE UPDATE PACK (RUP4)';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'ORACLE E-BUSINESS SUITE 12.0.6 RELEASE UPDATE PACK (RUP6)';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle E-Business Suite 12.1.2 Release Update Pack (RUP2)';
   l_col_rows(5)(l_rows) := '[949406.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle E-Business Suite 12.1.3 Release Update Pack';
   l_col_rows(5)(l_rows) := '[1080973.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '12916273';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.1+ INV Dual UOM related fixes 3';
   l_col_rows(5)(l_rows) := '[1392179.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '13885374';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.1+ INV Dual UOM related fixes 4';
   l_col_rows(5)(l_rows) := '[1461579.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '14586882';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'INV/RCV RUP5 (Version 12.1.1 To 12.1.3 [Release 12.1])';
   l_col_rows(5)(l_rows) := '[1519548.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '16328540';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'INV/RCV RUP6 (Version 12.1.1 To 12.1.3 [Release 12.1])';
   l_col_rows(5)(l_rows) := '[1549938.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '16826285';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Inventory RUP7 (Version 12.1.1 To 12.1.3 [Release 12.1])';
   l_col_rows(5)(l_rows) := '[1578818.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '17512558';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Inventory Consolidated RUP7 (Version 12.1.1 To 12.1.3 [Release 12.1])';
   l_col_rows(5)(l_rows) := '[1593314.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '18076740';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Inventory Consolidated RUP8 (Version 12.1.1 To 12.1.3 [Release 12.1])';
   l_col_rows(5)(l_rows) := '[1614267.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '18615837';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Inventory Consolidated RUP9 (Version 12.1.1 To 12.1.3 [Release 12.1])';
   l_col_rows(5)(l_rows) := '[1662875.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19447776';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Inventory Consolidated RUP10 (Version 12.1.1 To 12.1.3 [Release 12.1])';
   l_col_rows(5)(l_rows) := '[1917252.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '20187255';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Inventory Consolidated RUP11 (Version 12.1.1 To 12.1.3 [Release 12.1])';
   l_col_rows(5)(l_rows) := '[1951281.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21218468';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Inventory Consolidated RUP12 (Version 12.1.1 To 12.1.3 [Release 12.1])';
   l_col_rows(5)(l_rows) := '[2018001.1]';
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '22598102';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Inventory Consolidated RUP14 (Version 12.1.1 To 12.1.3 [Release 12.1])';
   l_col_rows(5)(l_rows) := '[2099866.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '24011188';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Inventory Consolidated RUP15 (Version 12.1.1 To 12.1.3 [Release 12.1])';
   l_col_rows(5)(l_rows) := '[2158764.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '24843312';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Inventory Consolidated RUP16 (Version 12.1.1 To 12.1.3 [Release 12.1])';
   l_col_rows(5)(l_rows) := '[2192972.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.2.2 - Oracle E-Business Suite 12.2.2 Release Update Pack';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.2.3 - Oracle E-Business Suite 12.2.3 Release Update Pack';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.2.4 -Oracle E-Business Suite 12.2.4 Release Update Pack';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.2.5 -Oracle E-Business Suite 12.2.5 Release Update Pack';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.2.6 -Oracle E-Business Suite 12.2.6 Release Update Pack';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.2.7 -Oracle E-Business Suite 12.2.7 Release Update Pack';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Inventory Consolidated Rup17 (Version 12.1.1 To 12.1.3 [Release 12.1])';
   l_col_rows(5)(l_rows) := '[2283688.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.2.8 -Oracle E-Business Suite 12.2.8 Release Update Pack';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.2.9 - Oracle E-Business Suite 12.2.9 Release Update Pack';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.2.10 - Oracle E-Business Suite 12.2.10 Release Update Pack';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.2.11 - Oracle E-Business Suite 12.2.11 Release Update Pack';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.2.12 - Oracle E-Business Suite 12.2.12 Release Update Pack';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.2.13 - Oracle E-Business Suite 12.2.13 Release Update Pack';
   l_col_rows(5)(l_rows) := '[2958934.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.2.14 - Oracle E-Business Suite 12.2.14 Release Update Pack';
   l_col_rows(5)(l_rows) := '[3012829.1]';

END IF;

   l_extra_info('##SHOW_SQL##'):= 'Y';

   l_sig.sigrepo_id := '5991';
   l_sig.title := 'Inventory Rollup Patch Status';
...
<li>Having a proactive patching plan and periodic proactive patching process in place are the best ways to stay current.</li>
  ...
  -- Register
  l_step := '60';
  g_signatures('INV_RUP_CHECK') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'INV_RUP_CHECK',     -- sig ID
...
FUNCTION get_P_SO_OR_ISO
   return VARCHAR2 IS
BEGIN
debug('begin sql token function: P_SO_OR_ISO');
DECLARE
so_or_iso  VARCHAR2(5); 
BEGIN

SELECT to_char(OOHA.order_source_id) INTO so_or_iso   
  FROM OE_ORDER_HEADERS_ALL OOHA
  WHERE OOHA.HEADER_ID = p_header_id;

IF  nvl(so_or_iso , '-1') = '10' THEN
so_or_iso  :=  'ISO' ; 
ELSE 
so_or_iso := 'SO' ; 
END IF; 

debug('p_so_or_iso is ' || so_or_iso  );
RETURN so_or_iso  ; 

EXCEPTION
 WHEN NO_DATA_FOUND THEN
   debug('P_SO_OR_ISO cannot be determined.');
   raise_application_error(-20001, 'ERROR: P_SO_OR_ISO  could not be determined for this sales order. Execute again with correct parameters.');
END; 
debug('end sql token function: P_SO_OR_ISO');
END get_P_SO_OR_ISO;

FUNCTION get_ORDERNO
   return VARCHAR2 IS
BEGIN
debug('begin sql token function: ORDERNO');
BEGIN
 SELECT order_number
 INTO l_system_function_var
 FROM OE_ORDER_HEADERS_ALL ORD
...
EXCEPTION WHEN NO_DATA_FOUND THEN
 return NULL;
END;
debug('end sql token function: ORDERNO');
END get_ORDERNO;
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Organization Id (Operating Unit) - Obsolete';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_org_id,'NO_MASK');
   IF g_is_concurrent THEN 
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Order Number';
   ...
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Include Diagnostics Apps Check (Default is Y)';
...
-- Revision and date values can be populated by RCS
  l_revision := rtrim(replace('$Revision: 200.21  $','$',''));
  l_revision := ltrim(replace(l_revision,'Revision:',''));
  l_date_char := rtrim(replace('$Date: 2026/01/29 16:53:45 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'inv_intercomp_analyzer.sql';
...
WHERE O.ORGANIZATION_ID = p_org_id
 AND (fnd_global.resp_id = -1 or fnd_global.org_id = o.organization_id)
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: No Organization ID specified.
The Organization ID parameter is mandatory.');
...
SELECT HEADER_ID
INTO l_exists_val
FROM OE_ORDER_HEADERS_ALL H, HR_OPERATING_UNITS O, OE_TRANSACTION_TYPES_TL OT
WHERE HEADER_ID = p_header_id
 AND H.ORDER_NUMBER = NVL(p_order_number, H.ORDER_NUMBER )
...
IF p_include_apps_check IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Include Diagnostics Apps Check (Default is Y) is required.');
   raise invalid_parameters;
END IF;
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$HEADER_ID$$##') := p_header_id;
   g_masked_tokens('##$$HEADER_ID$$##') := mask_text( g_sql_tokens('##$$HEADER_ID$$##'), 'NO_MASK');
   ...
   g_sql_tokens('##$$P_SO_OR_ISO$$##') := get_P_SO_OR_ISO();
   l_system_function_var := null;
   g_masked_tokens('##$$P_SO_OR_ISO$$##') := mask_text( g_sql_tokens('##$$P_SO_OR_ISO$$##'), 'NO_MASK');
   g_sql_tokens('##$$ORDERNO$$##') := get_ORDERNO();
   l_system_function_var := null;
   g_masked_tokens('##$$ORDERNO$$##') := mask_text( g_sql_tokens('##$$ORDERNO$$##'), 'NO_MASK');
...
debug('begin add_signature: INVICI_PROFILE_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6922',
      p_sig_id                 => 'INVICI_PROFILE_OPTIONS',
      p_sig_sql                => 'SELECT v.profile_option_name "Profile Option",
V.USER_PROFILE_OPTION_NAME "User Profile Name",
DECODE(A.LEVEL_ID, ''10001'', '''', ''10002'', ''Application'', ''10003'', ''Responsibility'', ''10004'', ''User'', A.LEVEL_ID) ||''>''||
NVL(DECODE(A.LEVEL_ID, 10001, ''Site'', 10002, B.APPLICATION_SHORT_NAME, 10003, C.RESPONSIBILITY_NAME, 10004, D.USER_NAME),''Not Set'') "Profile Level",
NVL(DECODE(A.PROFILE_OPTION_VALUE, ''1'', ''Yes'', ''2'', ''No'', A.PROFILE_OPTION_VALUE), ''Not Set'') "Profile Value"
FROM FND_PROFILE_OPTION_VALUES A,
FND_APPLICATION B,
FND_RESPONSIBILITY_TL C,
FND_USER D,
FND_PROFILE_OPTIONS_VL V
WHERE V.PROFILE_OPTION_ID = A.PROFILE_OPTION_ID (+)
AND A.LEVEL_VALUE = B.APPLICATION_ID (+)
AND A.LEVEL_VALUE = C.RESPONSIBILITY_ID (+)
AND A.LEVEL_VALUE = D.USER_ID (+)
--AND A.LEVEL_ID IN (10001)
AND V.PROFILE_OPTION_NAME IN (
''INV_INTERCOMPANY_INVOICE_INTERNAL_ORDER'',
''INV_USE_MODEL_PRICING'',
''INV_USE_QP_FOR_INTERCOMPANY'',
''INV_INTERCOMPANY_TRANSFER_PRICE_DATE'',
''IC_CURRENCY_CONVERSION_TYPE'',
''ZX_INVENTORY_ITEM_FOR_FREIGHT'',
''ZX_INVOICE_FREIGHT_AS_LINE'',
''ZX_ALLOW_TAX_CLASSIF_OVERRIDE'',
--''QP_ORGANIZATION_ID'',
''QP_MULTI_CURRENCY_INSTALLED'',
''QP_PATTERN_SEARCH'',
''QP_SECURITY_CONTROL'',
''QP_PRICING_TRANSACTION_ENTITY'',
''QP_SOURCE_SYSTEM_CODE'',
''CST_TRANSFER_PRICING_OPTION'',
--''XLA_MO_SECURITY_PROFILE_LEVEL'',
''OE_INVENTORY_ITEM_FOR_FREIGHT'',
''ONT_VIEW_INTERCOMPANY_INVOICE'')
ORDER BY
V.USER_PROFILE_OPTION_NAME,
A.LEVEL_ID DESC',
      p_title                  => 'Intercompany Profile Options',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Profile options for Intercompany transactions are not set

',
      p_solution               => 'Review [2249071/FAQ6905] FAQ Intercompany Profile Options<br>for available profile option values and related functionality',
      p_success_msg            => 'Displaying profile options that will have an impact on the intercompany processing.
For further details on available values and related functionality please refer to [2249071/FAQ6905]',
   ...
   l_info.delete;
debug('end add_signature: INVICI_PROFILE_OPTIONS');



debug('begin add_signature: INVICI_INVOICE_FREIGHT_AS_REVENUE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6924',
      p_sig_id                 => 'INVICI_INVOICE_FREIGHT_AS_REVENUE',
      p_sig_sql                => 'SELECT OSPA.ORG_ID,
  OSPA.PARAMETER_VALUE
FROM OE_SYS_PARAMETERS_ALL OSPA,
  OE_ORDER_HEADERS_ALL OOHA
WHERE OSPA.PARAMETER_CODE = ''OE_INVOICE_FREIGHT_AS_LINE''
AND OSPA.ORG_ID           = OOHA.ORG_ID
AND OOHA.HEADER_ID        = ##$$HEADER_ID$$##',
      p_title                  => 'Invoice Freight as Revenue Parameter Validation',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Intercompany AR Invoice will fail for IR/ISO flow if this parameter is not set.',
      p_solution               => 'Review [1295447/KB725915] and setup this parameter appropriately for IR/ISO flow in Intercompany Transactions.',
      p_success_msg            => 'Invoice ''Freight as Revenue'' parameter has been set for the given organization.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_INVOICE_FREIGHT_AS_REVENUE');



debug('begin add_signature: EBS_MFG_INV_INVICI_ACCT_GEN_WF_NAME');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27258',
      p_sig_id                 => 'EBS_MFG_INV_INVICI_ACCT_GEN_WF_NAME',
      p_sig_sql                => 'SELECT  flex.application_id, flex.id_flex_code, flex.id_flex_num, flex.wf_item_type, flex.wf_process_name
FROM fnd_flex_workflow_processes flex ,  GL_SETS_OF_BOOKS sob, HR_ORGANIZATION_information hra
WHERE flex.id_flex_code = ''GL#'' 
AND flex.application_id = 101
AND flex.wf_item_type = ''INVFLXWF''
AND flex.id_flex_num =  sob.chart_of_accounts_id 
AND sob.set_of_books_id = hra.org_information1
and hra.org_information_context = ''Accounting Information''
AND hra.ORGANIZATION_ID = ##$$ORGID$$##    ',
      p_title                  => 'Inventory Account Generator Workflow Process Name',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displays the Inventory Account Generator Workflow Process Name used for Intercompany orders. If using the seeded workflow, the Workflow Process Name will appear as DEFAULT_ACCOUNT_GENERATION. 

',
      p_solution               => 'If there are any errors in COGS account generation using a custom workflow process name, review 
[2429077/KB757904] : Troubleshooting Custom Account Generator Workflow (INVFLXWF) Errors When Running Interface Trip Stop (Intercompany Orders) ?  ',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVICI_ACCT_GEN_WF_NAME');



debug('begin add_signature: INVICI_ITEM_COST_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8535',
      p_sig_id                 => 'INVICI_ITEM_COST_DETAILS',
      p_sig_sql                => 'SELECT cic.inventory_item_id,
  cic.Organization_Id,
  cic.cost_type_id,
  cct.COST_TYPE,
  cic.pl_item_cost,
...
AND cic.inventory_item_id IN
  ...
  WHERE header_id = ##$$HEADER_ID$$##
      ...
      p_title                  => 'Item Cost Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Item cost information from CST_ITEM_COSTS table for all items present in the Sales Order across all organizations',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_ITEM_COST_DETAILS');



debug('begin add_signature: INVICI_ITEM_INFO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8534',
      p_sig_id                 => 'INVICI_ITEM_INFO',
...
WHERE inventory_item_id IN
  ...
  WHERE header_id = ##$$HEADER_ID$$##
      ...
      p_title                  => 'Item Information From MTL_SYSTEM_ITEMS_B',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displays important Item Information from MTL_SYSTEM_ITEMS_B for all organizations',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_ITEM_INFO');



debug('begin add_signature: INVICI_PATCHSET_LEVELS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6910',
      p_sig_id                 => 'INVICI_PATCHSET_LEVELS',
      p_sig_sql                => 'SELECT FA.APPLICATION_ID ID,
  FA.APPLICATION_SHORT_NAME CODE,
  FAT.APPLICATION_NAME,
  NVL(FPI.PATCH_LEVEL, ''NO PATCHSET'') PATCHSET
FROM FND_PRODUCT_INSTALLATIONS FPI,
  FND_APPLICATION FA, 
  FND_APPLICATION_TL FAT
WHERE FA.APPLICATION_ID = FPI.APPLICATION_ID(+)
AND FA.APPLICATION_ID = FAT.APPLICATION_ID
AND FA.APPLICATION_ID  IN (##$$APPS_PARAM1$$##, 
                           ##$$APPS_PARAM2$$##,
                           ##$$APPS_PARAM3$$##,
                           ##$$APPS_PARAM4$$##,
                           ##$$APPS_PARAM5$$##)',
      p_title                  => 'Intercompany Patch Set Levels',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Patchset levels for Intercompany products 
',
      p_solution               => '',
      p_success_msg            => '<ul><strong>Patchset levels for:</strong>
  <li>Inventory</li>
  <li>Payables</li>
  <li>Receivables</li>
  <li>Advanced Pricing</li>
  <li>Cost Management</li></ul>',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_PATCHSET_LEVELS');



debug('begin add_signature: INVICI_INVALIDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7132',
      p_sig_id                 => 'INVICI_INVALIDS',
...
A.OBJECT_NAME LIKE ''AP_%'' OR 
A.OBJECT_NAME LIKE ''RA_%'' OR
A.OBJECT_NAME LIKE ''QP_%'' OR
A.OBJECT_NAME LIKE ''CST_%''OR
A.OBJECT_NAME LIKE ''OM_%'') 
AND A.STATUS = ''INVALID''',
      p_title                  => 'Intercompany Related Invalid Objects',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Check Invalids for the Inventory, Costing, Account Payable, Account Receivable, Advanced Pricing and Order Management',
      p_solution               => '<ul>
...
<li>If you still have invalid objects, please review steps from [1325394/KB401905] Troubleshooting Guide - Invalid Objects in the E-Business Suite Environment 11i and 12</li>
      ...
      p_success_msg            => 'No invalid objects found for Intercompany related products.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_INVALIDS');



debug('begin add_signature: INVICI_PRICE_LIST_FROM_SO_HEADER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7249',
      p_sig_id                 => 'INVICI_PRICE_LIST_FROM_SO_HEADER',
      p_sig_sql                => 'SELECT SPL.PRICE_LIST_ID,
  SPL.NAME,
  SPL.DESCRIPTION,
  SPL.CREATION_DATE,
  SPL.CURRENCY_CODE,
  SPL.START_DATE_ACTIVE,
  SPL.END_DATE_ACTIVE,
  SPL.COMMENTS
FROM SO_PRICE_LISTS SPL
WHERE SPL.PRICE_LIST_ID IN
  (SELECT OOLA.PRICE_LIST_ID
  FROM OE_ORDER_LINES_ALL OOLA
  WHERE OOLA.HEADER_ID = ##$$HEADER_ID$$##)',
      p_title                  => 'Price List from Internal Order Line',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Internal Order Price List',
      p_solution               => '',
      p_success_msg            => 'NO',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_PRICE_LIST_FROM_SO_HEADER');



debug('begin add_signature: INVICI_CST_BILLTO_PRICE_LIST_VALID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8573',
      p_sig_id                 => 'INVICI_CST_BILLTO_PRICE_LIST_VALID',
      p_sig_sql                => 'SELECT DISTINCT OEL.SOLD_TO_ORG_ID CUSTOMER_ACCOUNT_NUMBER,
CSU.CUST_ACCT_SITE_ID SITE_NUMBER,
CSU.SITE_USE_CODE SITE_USE_CODE,
CSU.SITE_USE_ID SITE_USE_ID,
CSU.LOCATION LOCATION,
DECODE(SPL.PRICE_LIST_ID,'''',9999999,SPL.PRICE_LIST_ID) PRICE_LIST_ID,
SPL.NAME PRICE_LIST_NAME,
SPL.DESCRIPTION PRICE_LIST_DESCRIPTION,
SPL.CURRENCY_CODE PRICE_LIST_CURRENCY
FROM HZ_CUST_SITE_USES_ALL CSU,
SO_PRICE_LISTS SPL,
OE_ORDER_LINES_ALL OEL
WHERE CSU.SITE_USE_ID =OEL.INVOICE_TO_ORG_ID
AND CSU.PRICE_LIST_ID =SPL.PRICE_LIST_ID (+)
AND OEL.HEADER_ID = ##$$HEADER_ID$$##',
      p_title                  => 'Customer Bill-To Location Price list',
      p_fail_condition         => '[PRICE_LIST_ID] = [9999999]',
      p_problem_descr          => 'No price list is assigned at the Customer bill-to location.',
      p_solution               => '<ul>
<li> A price list needs to be assigned to the customer Bill-to location. Follow the instructions in [2330041/KB754921]
</li>
<li> If an OPM Org is used, ensure a price list is included in the shipping network. Follow instructions in [2791951/KB718128] </li>
</ul>',
      p_success_msg            => 'Price list is attached.  ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_CST_BILLTO_PRICE_LIST_VALID');



debug('begin add_signature: INVICI_ADVANCE_PRICING_IBATCH_QP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10405',
      p_sig_id                 => 'INVICI_ADVANCE_PRICING_IBATCH_QP',
      p_sig_sql                => 'select seeded_flag "Seeded Flag", nvl(user_search_flag,''Y'') "User Search Flag"
from qp_event_phases
where pricing_phase_id = 1
and pricing_event_code = ''ICBATCH''',
      p_title                  => 'Intercompany Pricing Event Search Flags',
      p_fail_condition         => '[User Search Flag] = [N]',
      p_problem_descr          => 'For phase ''List Line Base Price'' one has set the user search flag to an inappropriate value 
for the event ''INV: Batch Processing for Intercompany Transfer Pricing.'' 
',
      p_solution               => 'User Search Flag needs to be Y. Review Troubleshooting pricing issues in Intercompany Invoicing when Advanced Pricing is used [782177/KB626102#aref_section25], Section E. ',
      p_success_msg            => 'The Intercompany pricing phase is setup correctly. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_ADVANCE_PRICING_IBATCH_QP');



debug('begin add_signature: INVICI_ADVANCE_PRICING_INTCOM_QP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10404',
      p_sig_id                 => 'INVICI_ADVANCE_PRICING_INTCOM_QP',
      p_sig_sql                => 'select application_short_name, enabled_flag
 from qp_pte_source_systems
 where pte_code = ''INTCOM''',
      p_title                  => 'Intercompany Source Systems',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Provides source systems association for Intercompany Transactions',
      p_solution               => 'Review [782177/KB626102#aref_section21] section A "Check the Intercompany Source Systems" ',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_ADVANCE_PRICING_INTCOM_QP');



debug('begin add_signature: INVICI_ADVANCE_PRICING_STATUS_QP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10403',
      p_sig_id                 => 'INVICI_ADVANCE_PRICING_STATUS_QP',
      p_sig_sql                => 'SELECT decode(fpi.status, ''I'', ''Advanced Pricing is installed'',
''S'', ''Basic Pricing is installed'',
...
AND fpi.application_id = ''661''',
      p_title                  => 'Advance Pricing Setup Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Determine if Advanced Pricing or Basic Pricing is installed and being used.<br>
If neither is installed you will not be able to process any pricing
.',
      p_solution               => 'Please follow installation instructions in How to Fully Install Advanced Pricing and/or Determine if Pricing is Basic Pricing or Advanced Pricing [412663/KB561222]',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_ADVANCE_PRICING_STATUS_QP');



debug('begin add_signature: INVICI_CUSTOM_HOOK_CHECK_TRANSFER_PRICE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10378',
      p_sig_id                 => 'INVICI_CUSTOM_HOOK_CHECK_TRANSFER_PRICE',
      p_sig_sql                => 'select line, text from all_source
where name in upper(''MTL_INTERCOMPANY_INVOICES'')
and type = ''PACKAGE BODY''',
      p_title                  => 'Custom Hook for Transfer Price Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There is potentially a custom hook designed in MTL_INTERCOMPANY_INVOICES package to fetch Transfer Price that should be reviewed.',
      p_solution               => '<ul>
 <li> Please review the custom code to fetch the transfer price within file $INV_TOP/patch/115/sql/INVICIVB.pls
</li>
 <li> One may refer to the technical brief Diagnosing Intercompany Processing GET_TRANSFER_PRICE Error CST_XFER_PRICE_ERROR When Using Advanced Pricing [1372245/KB766747] </li>
 </ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_CUSTOM_HOOK_CHECK_TRANSFER_PRICE');



debug('begin add_signature: INVICI_AR_INV_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6941',
      p_sig_id                 => 'INVICI_AR_INV_ALL',
      p_sig_sql                => 'SELECT 
...
WHERE RCTA.CUSTOMER_TRX_ID IN
  ...
  WHERE RCTLA.INTERFACE_LINE_CONTEXT   = ''INTERCOMPANY''
  AND RCTLA.INTERFACE_LINE_ATTRIBUTE6 IN
    (SELECT TO_CHAR(OOLA.LINE_ID)
    FROM OE_ORDER_LINES_ALL OOLA
    WHERE OOLA.HEADER_ID = ##$$HEADER_ID$$##
    AND OOLA.ORG_ID =  ##$$ORGID$$##
    )
  )',
      p_title                  => 'Intercompany AR Invoice Header (RA_CUSTOMER_TRX_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The Intercompany AR Invoice Header is not generated successfully. No such record exists in RA_CUSTOMER_TRX_ALL table for corresponding sales order header_id',
      p_solution               => '<ul>
<li>There are no records in RA_CUSTOMER_TRX_ALL table.<br>
It means either ''Auto Invoice Master'' program or ''Create Intercompany AR Invoices'' program are not executed.<br>
Please refer to Section 1a) in [2157627/KB783201#aref_section210] - Logistics Brownbag: Troubleshooting Intercompany Issues.</ul>',
      p_success_msg            => 'Intercompany AR Invoice Header is generated successfully',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_AR_INV_ALL');



debug('begin add_signature: INVICI_AR_INV_LINES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6954',
      p_sig_id                 => 'INVICI_AR_INV_LINES_ALL',
      p_sig_sql                => 'SELECT 
...
WHERE OOLA.HEADER_ID = ##$$HEADER_ID$$##
 AND OOLA.ORG_ID =  ##$$ORGID$$##
      ...
      p_title                  => 'Intercompany AR Invoice Lines (RA_CUSTOMER_TRX_LINES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The Intercompany AR Invoice Line(s) is not generated successfully. No such record exists in RA_CUSTOMER_TRX_LINES_ALL table for corresponding sales order header_id.',
      p_solution               => '<ul>
<li>There are no records in RA_CUSTOMER_TRX_LINES_ALL table.<br>
It means Either ''Auto Invoice Master'' program or ''Create Intercompany AR Invoices'' program are not executed.<br>
Please refer to Section 1a) in [2157627/KB783201#aref_section210] - Logistics Brownbag: Troubleshooting Intercompany Issues.
</ul>
',
      p_success_msg            => 'Intercompany AR Invoice Line(s) is generated successfully.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_AR_INV_LINES_ALL');



debug('begin add_signature: INVICI_AR_INV_DIST_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6955',
      p_sig_id                 => 'INVICI_AR_INV_DIST_ALL',
      p_sig_sql                => 'SELECT 
RADIST.CUST_TRX_LINE_GL_DIST_ID,
RADIST.CUSTOMER_TRX_LINE_ID,
RADIST.CODE_COMBINATION_ID,
RADIST.CREATION_DATE,
RADIST.AMOUNT,
RADIST.GL_DATE,
RADIST.CUSTOMER_TRX_ID,
RADIST.ACCTD_AMOUNT,
RADIST.ORG_ID
FROM RA_CUST_TRX_LINE_GL_DIST_ALL RADIST
WHERE RADIST.CUSTOMER_TRX_LINE_ID IN
(SELECT TO_CHAR(RCTLA.CUSTOMER_TRX_LINE_ID)
FROM RA_CUSTOMER_TRX_LINES_ALL RCTLA
WHERE RCTLA.INTERFACE_LINE_CONTEXT = ''INTERCOMPANY''
AND RCTLA.INTERFACE_LINE_ATTRIBUTE6 IN
(SELECT TO_CHAR(OOLA.LINE_ID)
...
AND OOLA.ORG_ID =  ##$$ORGID$$##
      ...
      p_title                  => 'Intercompany AR Invoice Distributions (RA_CUST_TRX_LINE_GL_DIST_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The Intercompany AR Invoice Distribution(S) is not generated successfully. No such record exists in RA_CUST_TRX_LINE_GL_DIST_ALL table for corresponding sales order header_id.',
      p_solution               => '<ul>
<li>There are no records in RA_CUST_TRX_LINE_GL_DIST_ALL table.<br>
It means Either ''Auto Invoice Master'' program or ''Create Intercompany AR Invoices'' program are not executed.<br>
Please refer to Section 1a) in [2157627/KB783201#aref_section210] - Logistics Brownbag: Troubleshooting Intercompany Issues.
</ul>',
      p_success_msg            => 'Intercompany AR Invoice Distribution(S) is generated successfully.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_AR_INV_DIST_ALL');



debug('begin add_signature: INVICI_AR_INV_LINES_INTF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6956',
      p_sig_id                 => 'INVICI_AR_INV_LINES_INTF',
      p_sig_sql                => 'SELECT  decode(RILA.INTERFACE_STATUS , ''P'', ''Processed'' , ''Unprocessed/Error'') Status,
...
RILA.BATCH_SOURCE_NAME,RILA.LINE_TYPE,
...
RILA.ORG_ID,
RILA.WAREHOUSE_ID,
RILA.SOURCE_EVENT_CLASS_CODE
FROM RA_INTERFACE_LINES_ALL RILA
WHERE RILA.INTERFACE_LINE_CONTEXT = ''INTERCOMPANY'' 
AND RILA.INTERFACE_LINE_ATTRIBUTE6 IN
(SELECT TO_CHAR(OOLA.LINE_ID)
FROM OE_ORDER_LINES_ALL OOLA
WHERE OOLA.HEADER_ID = ##$$HEADER_ID$$##
AND OOLA.ORG_ID = ##$$ORGID$$## )',
      p_title                  => 'Intercompany AR Invoice Interface Lines (RA_INTERFACE_LINES_ALL)',
      p_fail_condition         => '[STATUS]!= [Processed]',
      p_problem_descr          => 'Records are returned user needs to review status.',
      p_solution               => 'Please run ''Auto Invoice Master'' program to import the records from this interface table. 
 <br>
Please refer to Section 1a in [2157627/KB783201#aref_section210] - Logistics Brownbag: Troubleshooting Intercompany Issues
<br>
',
      p_success_msg            => 'Intercompany AR Invoice Line(s) should have been generated successfully. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_AR_INV_LINES_INTF');



debug('begin add_signature: INVICI_AR_INV_DIST_INTF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6957',
      p_sig_id                 => 'INVICI_AR_INV_DIST_INTF',
      p_sig_sql                => 'SELECT decode(RILA.INTERFACE_STATUS , ''P'', ''Processed'' , ''Unprocessed/Error'')  As  Status  
...
WHERE OOLA.HEADER_ID = ##$$HEADER_ID$$##
 AND OOLA.ORG_ID =  ##$$ORGID$$## )',
      p_title                  => 'Intercompany AR Invoice Interface Distributions (RA_INTERFACE_DISTRIBUTIONS_ALL)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The Intercompany AR Invoice is not generated successfully. There exist record(s) in RA_INTERFACE_DISTRIBUTIONS_ALL table for corresponding sales order header_id.',
      p_solution               => 'There are records in RA_INTERFACE_DISTRIBUTIONS_ALL table.<br>
Please execute ''Auto Invoice Master'' program in order to import the records from this interface table. Please review [1075757/KB626233] - Troubleshooting AutoInvoice for Oracle Receivables Release 11.5 Through 12.',
      p_success_msg            => 'Intercompany AR Invoice Distribution(s) is generated successfully OR Users have chosen to allow the AutoAccounting feature to dynamically build the invoice distributions.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_AR_INV_DIST_INTF');



debug('begin add_signature: INVICI_AR_INV_ERR_INTF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6959',
      p_sig_id                 => 'INVICI_AR_INV_ERR_INTF',
      p_sig_sql                => 'SELECT  RIEA.INTERFACE_LINE_ID,
RIEA.INTERFACE_SALESCREDIT_ID,
RIEA.INTERFACE_DISTRIBUTION_ID,
RIEA.MESSAGE_TEXT,
RIEA.INVALID_VALUE,
RIEA.LINK_TO_LINE_ID,
RIEA.ORG_ID,
RIEA.INTERFACE_CONTINGENCY_ID FROM RA_INTERFACE_ERRORS_ALL RIEA,
  RA_INTERFACE_LINES_ALL RILA
WHERE RILA.INTERFACE_LINE_ID        = RIEA.INTERFACE_LINE_ID
AND RILA.INTERFACE_LINE_CONTEXT     = ''INTERCOMPANY'' 
AND NVL(RILA.INTERFACE_STATUS, ''N'')  NOT  IN (''P'')
AND RILA.INTERFACE_LINE_ATTRIBUTE6 IN
  (SELECT TO_CHAR(OOLA.LINE_ID)
  FROM OE_ORDER_LINES_ALL OOLA
  WHERE OOLA.HEADER_ID = ##$$HEADER_ID$$##  AND OOLA.ORG_ID =  ##$$ORGID$$## )',
      p_title                  => 'Intercompany AR Invoice Interface Errors (RA_INTERFACE_ERRORS_ALL)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The Intercompany AR Invoice is not generated successfully. There are error record(S) in RA_INTERFACE_ERRORS_ALL table for corresponding sales order header_id.',
      p_solution               => '<ul>
<li>There are error records in RA_INTERFACE_ERRORS_ALL table.<br>
Please review [1075757/KB626233] - Troubleshooting AutoInvoice for Oracle Receivables Release 11.5 Through 12.<br>
If you still need assistance, Please log a Service Request with the Oracle Receivables team.<li>
</ul>',
      p_success_msg            => 'There are no errors records in RA_INTERFACE_ERRORS_ALL table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_AR_INV_ERR_INTF');



debug('begin add_signature: INVICI_AP_INV_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6913',
      p_sig_id                 => 'INVICI_AP_INV_ALL',
...
WHERE REFERENCE_1 IN
 (SELECT TO_CHAR(CUSTOMER_TRX_ID) FROM RA_CUSTOMER_TRX_LINES_ALL WHERE INTERFACE_LINE_ATTRIBUTE6 IN
   (SELECT TO_CHAR(LINE_ID) FROM OE_ORDER_LINES_ALL WHERE HEADER_ID = ##$$HEADER_ID$$## AND ORG_ID =  ##$$ORGID$$##
)  )',
      p_title                  => 'Intercompany AP Invoice Header Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The AP Invoice was not generated successfully.<br>
No such record exists in the AP_INVOICES_ALL table for corresponding sales order header_id.',
      p_solution               => '<ul>
<li>There are no records created in AP_INVOICES_ALL table. </li>
<li>It means either ''Payable Open Interface'' program or ''Intercompany AP Invoice'' program has not been executed.<br> 
Please refer to Section 1b) in [2157627/KB783201#aref_section211]</li>
</ul>',
      p_success_msg            => 'The AP Invoice is generated successfully',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_AP_INV_ALL');



debug('begin add_signature: INVICI_AP_INV_LINE_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6914',
      p_sig_id                 => 'INVICI_AP_INV_LINE_ALL',
      p_sig_sql                => 'SELECT INVOICE_ID,
LINE_NUMBER,
...
(SELECT INVOICE_ID FROM AP_INVOICES_ALL
   WHERE REFERENCE_1 IN
    (SELECT TO_CHAR(CUSTOMER_TRX_ID) FROM RA_CUSTOMER_TRX_LINES_ALL WHERE INTERFACE_LINE_ATTRIBUTE6 IN
      ...
      p_title                  => 'Intercompany AP Invoice Line Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The AP Invoice Line were not generated successfully for corresponding lines in RA_CUSTOMER_TRX_LINES_ALL.',
      p_solution               => '<ul>
<li>There are no records created in ap_invoice_lines_all table.</li>
<li>It means Either ''Payable Open Interface'' program or ''Intercompany AP Invoice'' program is not executed or they got completed in error.<br>
Please refer to Section 1b) in [2157627/KB783201#aref_section211] - Logistics Brownbag: Troubleshooting Intercompany Issues.</li>
</ul>',
      p_success_msg            => 'AP Invoice Lines were imported successfully.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_AP_INV_LINE_ALL');



debug('begin add_signature: INVICI_AP_INV_INTF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6915',
      p_sig_id                 => 'INVICI_AP_INV_INTF',
      p_sig_sql                => 'SELECT INVOICE_ID,
INVOICE_NUM,
INVOICE_TYPE_LOOKUP_CODE,
INVOICE_DATE,
...
WHERE REFERENCE_1 IN
   (SELECT TO_CHAR(CUSTOMER_TRX_ID) FROM RA_CUSTOMER_TRX_LINES_ALL WHERE INTERFACE_LINE_ATTRIBUTE6 IN
      ...
      p_title                  => 'Intercompany AP Invoice Interface Header Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The AP Invoice was not generated successfully. No such record exists from AP_INVOICES_INTERFACE table for corresponding sales order header_id.',
      p_solution               => '<ul>
<li>There are no records created in ap_invoices_interface table.</li>
<li>It means ''Create Intercompany AP Invoice'' program is not executed or errored.<br>
Please refer to Section 1b) in [2157627/KB783201#aref_section211] - Logistics Brownbag: Troubleshooting Intercompany Issues.</li>
</ul>',
      p_success_msg            => 'The data has been successfully inserted into the AP_INVOICES_INTERFACE table.<br> 
Please check the STATUS column to determine the import status.<br> 
If the Status is REJECTED, please review the Payables Open Interface Import output file. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_AP_INV_INTF');



debug('begin add_signature: INVICI_AP_INV_LINES_INTF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6916',
      p_sig_id                 => 'INVICI_AP_INV_LINES_INTF',
      p_sig_sql                => 'SELECT INVOICE_ID,
INVOICE_LINE_ID,
LINE_NUMBER,
LINE_TYPE_LOOKUP_CODE,
...
WHERE REFERENCE_1 IN
  (SELECT TO_CHAR(CUSTOMER_TRX_ID) FROM RA_CUSTOMER_TRX_LINES_ALL WHERE INTERFACE_LINE_ATTRIBUTE6 IN
   (SELECT TO_CHAR(LINE_ID) FROM OE_ORDER_LINES_ALL WHERE HEADER_ID = ##$$HEADER_ID$$## AND ORG_ID = ##$$ORGID$$## 
      ...
      p_title                  => 'Intercompany AP Invoice Interface Line Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The AP Invoice Interface Lines are not generated successfully for corresponding lines in RA_CUSTOMER_TRX_LINES_ALL.',
      p_solution               => '<ul>
<li>There are no records created in ap_invoice_lines_interface table.</li>
<li>It means ''Create Intercompany AP Invoice'' program is not executed or errored.<br>
Please refer to Section 1b) in [2157627/KB783201#aref_section211] - Logistics Brownbag: Troubleshooting Intercompany Issues.</li>
</ul>',
      p_success_msg            => 'Create Intercompany AP Invoice program executed successfully. Please run ''Payables Open Interface Program'' to generate the AP Invoice.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_AP_INV_LINES_INTF');



debug('begin add_signature: INVICI_AP_INTERFACE_REJECTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19283',
      p_sig_id                 => 'INVICI_AP_INTERFACE_REJECTIONS',
      p_sig_sql                => 'SELECT
    parent_id,
    parent_table,
    reject_lookup_code
FROM
    ap_interface_rejections WHERE parent_id IN (                       
SELECT invoice_id FROM ap_invoices_interface WHERE reference_1 
        IN ( SELECT  to_char(customer_trx_id) FROM  ra_customer_trx_lines_all WHERE interface_line_attribute6 
        IN ( SELECT to_char(line_id) FROM oe_order_lines_all WHERE header_id = ##$$HEADER_ID$$## AND ORG_ID =  ##$$ORGID$$## ) )
UNION                                         
SELECT invoice_line_id
FROM AP_INVOICE_LINES_INTERFACE WHERE invoice_id 
     IN ( SELECT  invoice_id FROM ap_invoices_all WHERE reference_1 
     IN ( SELECT   to_char(customer_trx_id)  FROM ra_customer_trx_lines_all WHERE interface_line_attribute6
     IN ( SELECT  to_char(line_id)  FROM  oe_order_lines_all WHERE header_id = ##$$HEADER_ID$$## AND ORG_ID =  ##$$ORGID$$## ) ) ) )',
      p_title                  => 'Intercompany AP Invoice Errors (AP_INTERFACE_REJECTIONS)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displays errors in creating AP Invoices',
      p_solution               => 'The AP Invoice Line were not generated successfully for corresponding lines in RA_CUSTOMER_TRX_LINES_ALL. Please review the errors . Please refer to Section 1b) in [2157627/KB783201#aref_section211]',
      p_success_msg            => 'The AP Invoice is generated successfully',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_AP_INTERFACE_REJECTIONS');



debug('begin add_signature: INVICI_SALES_ORDER_HEADER_INFORMATION_DISPLAY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11436',
      p_sig_id                 => 'INVICI_SALES_ORDER_HEADER_INFORMATION_DISPLAY',
  ...
  AND WFS.item_key           = TO_CHAR( ##$$HEADER_ID$$## )
  ...
  ORD.PAYMENT_TERM_ID  "Payment Term",
  ORD.SHIPPING_METHOD_CODE  "Ship Method",
  ORD.FREIGHT_TERMS_CODE   "Freight Term",
  ORD.PRICE_LIST_ID "Price List ID",
  PRC.NAME "Price List Name",
  ORD.TRANSACTIONAL_CURR_CODE "Currency",
...
AND TYP.LANGUAGE         = FLA.LANGUAGE_CODE',
   ...
   l_info.delete;
debug('end add_signature: INVICI_SALES_ORDER_HEADER_INFORMATION_DISPLAY');



debug('begin add_signature: INVICI_OEL_FOR_TRX_SO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18324',
      p_sig_id                 => 'INVICI_OEL_FOR_TRX_SO',
      p_sig_sql                => 'select lin.line_id
,(select min(det.delivery_detail_id)
from   wsh_delivery_details det
where  lin.line_id = det.source_line_id) delivery_detail_id
,lin.inventory_item_id
,substr(itm.segment1, 1, 80) segment1
,substr(lin.flow_status_code, 1, 22) flow_status_code
,nvl(lin.open_flag, ''N'') open_flag
,nvl(lin.booked_flag, ''N'') booked_flag
,nvl(lin.shippable_flag, ''N'') shippable_flag
,nvl(lin.cancelled_flag, ''N'') cancelled_flag
,nvl(lin.visible_demand_flag, ''N'') visible_demand_flag
,nvl(lin.shipping_interfaced_flag, ''N'') shipping_interfaced_flag
,nvl(lin.fulfilled_flag, ''N'') fulfilled_flag
,decode(nvl(lin.ato_line_id, 0), 0, ''N'') ato_line_id
,nvl(lin.ship_model_complete_flag, ''N'') ship_model_complete_flag
,nvl(lin.ordered_quantity, 0) ordered_quantity
,lin.order_quantity_uom
,lin.unit_selling_price
,lin.unit_list_price
,lin.calculate_price_flag
,( select sum(r.primary_reservation_quantity) 
from mtl_reservations r
where r.demand_source_line_id = lin.line_id
and r.demand_source_type_id in (2,8,9,21,22)) primary_reservation_qty
,nvl(lin.shipping_quantity, 0) shipping_quantity
,nvl(lin.shipped_quantity, 0) shipped_quantity
,nvl(fulfilled_quantity, 0) fulfilled_quantity
,nvl(lin.cancelled_quantity, 0) cancelled_quantity
,nvl(lin.invoiced_quantity, 0) invoiced_quantity
,substr(lin.schedule_status_code, 1, 5) schedule_status_code
,lin.org_id
,lin.ship_from_org_id
,lin.subinventory
,lin.override_atp_date_code
,to_char(lin.promise_date, ''DD-MON-RR_HH24:MI:SS'') promise_date
,to_char(lin.latest_acceptable_date, ''DD-MON-RR_HH24:MI:SS'') latest_acceptable_date
,to_char(lin.creation_date, ''DD-MON-RR_HH24:MI:SS'') creation_date
,to_char(lin.request_date, ''DD-MON-RR_HH24:MI:SS'') request_date
,to_char(lin.schedule_ship_date, ''DD-MON-RR_HH24:MI:SS'') schedule_ship_date
,to_char(lin.schedule_arrival_date, ''DD-MON-RR_HH24:MI:SS'') schedule_arrival_date
,to_char(lin.actual_shipment_date, ''DD-MON-RR_HH24:MI:SS'') actual_shipment_date
,to_char(lin.fulfillment_date, ''DD-MON-RR_HH24:MI:SS'') fulfillment_date
,lin.line_type_id
,(select name from oe_transaction_types_tl
where transaction_type_id = lin.line_type_id
and language = ''US'') transaction_type_id
,lin.line_category_code
,lin.item_type_code
,lin.ordered_item_id
,substr(lin.ordered_item, 1, 45) ordered_item
,lin.source_type_code
,lin.price_list_id
,lin.pricing_quantity
,lin.pricing_quantity_uom
,to_char(lin.pricing_date, ''DD-MON-RR_HH24:MI:SS'') pricing_date
,lin.tax_code
,lin.demand_class_code
,nvl(lin.option_flag, ''N'') option_flag
,lin.top_model_line_id
,lin.ato_line_id
,lin.model_remnant_flag
,lin.link_to_line_id
,lin.split_by
,lin.split_from_line_id
,lin.config_header_id
,nvl(lin.invoice_interface_status_code, ''N'') invoice_interface_status_code
,lin.ship_tolerance_above
,lin.ship_tolerance_below
,lin.ship_set_id
,lin.line_set_id
,lin.arrival_set_id
,nvl(lin.ordered_quantity2, 0) sec_ordered_qty
,lin.ordered_quantity_uom2 sec_ordered_uom
,nvl(lin.shipped_quantity2, 0) sec_shipped_qty
,nvl(lin.shipping_quantity2, 0) sec_shipping_qty
,nvl(lin.shipping_quantity_uom2, 0) sec_shipping_uom
,nvl(fulfilled_quantity2, 0) sec_fulfilled_qty
,nvl(lin.cancelled_quantity2, 0) sec_cancelled_qty
,lin.payment_term_id
,lin.shipping_method_code
,lin.freight_terms_code
,to_char(lin.last_update_date, ''DD-MON-RR_HH24:MI:SS'') last_update_date
,lin.order_source_id
,(select name
from   oe_order_sources
where  order_source_id = lin.order_source_id) order_source
,lin.orig_sys_document_ref
,lin.orig_sys_line_ref
,lin.source_document_id
,lin.source_document_line_id
,lin.accepted_by
,lin.accepted_quantity
,lin.service_start_date
,lin.service_duration
,lin.service_period
,lin.reference_header_id
,lin.reference_line_id
from oe_order_lines_all lin,
mtl_system_items itm
where  lin.header_id = ''##$$HEADER_ID$$##''
and nvl('''',0) in (0, lin.line_id,
lin.top_model_line_id,
lin.ato_line_id,
lin.link_to_line_id,
...
nvl(lin.service_number, -1)',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The corresponding order line for this Sales Order Transaction cannot be found.',
      p_solution               => 'Create a Service Request referencing this data.',
      p_success_msg            => 'This are the sales order lines for the given sales order number passed to this analyzer.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_OEL_FOR_TRX_SO');



debug('begin add_signature: INVICI_WDD_TRX_FOR_SO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18323',
      p_sig_id                 => 'INVICI_WDD_TRX_FOR_SO',
      p_sig_sql                => 'select det.delivery_detail_id,
decode(nvl(det.released_status, ''N''),
''B'', ''(B) Backordered'',
''C'', ''(C) Shipped'',
''D'', ''(D) Cancelled'',
''E'', ''(E) Replenishment Requested'',
''F'', ''(F) Replenishment Completed'',
''I'', ''(I) Interfaced'',
''K'', ''(K) Planned for Crossdocking'',
''N'', ''(N) Not Staged/Not Pick Confirmed'',
''O'', ''(O) Not Shipped'',
''R'', ''(R) Ready to Release'',
''S'', ''(S) Released to Warehouse'',
''X'', ''(X) Not Applicable'',
''Y'', ''(Y) Staged/Pick Confirmed'',
''Unknown'')released_status,
decode(nvl(det.oe_interfaced_flag, ''N''),
''Y'', ''(Y) Yes'',
''N'', ''(N) No'',
''P'', ''(P) Pending'',
''X'', ''(X) Not Applicable'',
''Unknown'')oe_interfaced_flag,
decode(nvl(det.inv_interfaced_flag, ''N''),
''Y'', ''(Y) Yes'',
''N'', ''(N) No'',
''P'', ''(P) Pending'',
''X'', ''(X) Not Applicable'',
''Unknown'') inv_interfaced_flag
...
,itm.segment1
,det.container_flag
,nvl(det.src_requested_quantity,0) src_requested_quantity
,det.src_requested_quantity_uom
,nvl(det.requested_quantity,0) requested_quantity
,det.requested_quantity_uom
,nvl(det.picked_quantity,0) picked_quantity
,nvl(det.shipped_quantity,0) shipped_quantity
,nvl(det.cycle_count_quantity,0) cycle_count_quantity
,nvl(det.delivered_quantity,0) delivered_quantity
,nvl(det.cancelled_quantity,0) cancelled_quantity
,nvl(det.received_quantity,0) received_quantity
,nvl(det.quality_control_quantity,0)quality_control_quantity
,nvl(det.returned_quantity,0) returned_quantity
,det.pickable_flag
,det.ship_tolerance_above
,det.ship_tolerance_below
,det.ship_from_location_id
...
,det.lot_number
,det.serial_number
,det.transaction_temp_id
,det.locator_id
,det.ship_method_code
,det.sublot_number
,to_char(det.date_requested,''DD-MON-RR_HH24:MI:SS'') date_requested
,to_char(det.date_scheduled,''DD-MON-RR_HH24:MI:SS'') date_scheduled
,det.source_line_set_id
,det.split_from_delivery_detail_id
,det.ship_set_id
,det.ship_model_complete_flag
,det.top_model_line_id
,det.dep_plan_required_flag
,det.preferred_grade
,det.replenishment_status
,det.shipment_priority_code
,nvl(det.src_requested_quantity2,0) sec_surce_requested_qty
,det.src_requested_quantity_uom2 sec_requested_uom
,nvl(det.requested_quantity2,0) sec_requested_qty
,det.requested_quantity_uom2  secondary_uom
,nvl(det.picked_quantity2,0) sec_picked_qty
,nvl(det.shipped_quantity2,0) sec_shipped_qty
,nvl(det.cycle_count_quantity2,0) sec_cc_qty
,nvl(det.delivered_quantity2,0) sec_delivered_qty
,nvl(det.cancelled_quantity2,0) sec_cancelled_qty
,nvl(det.received_quantity2,0) sec_received_qty
,nvl(det.quality_control_quantity2,0) sec_qa_control_qty
,nvl(det.returned_quantity2,0) sec_returned_qty
,to_char(det.creation_date,''DD-MON-RR_HH24:MI:SS'') creation_date
,to_char(det.last_update_date,''DD-MON-RR_HH24:MI:SS'') last_update_date
from
...
lin.reference_line_id,
lin.service_reference_line_id)
order by det.source_line_id, det.delivery_detail_id',
      p_title                  => 'Delivery Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no delivery details associated to the Sales Order Transaction. This seems to be a data corruption issue.',
      p_solution               => 'Please create a Service Request referencing this data.',
      p_success_msg            => 'These are the delivery details for the Sales Order Number entered on this analyzer.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_WDD_TRX_FOR_SO');



debug('begin add_signature: INVICI_TRX_FOR_SO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18202',
      p_sig_id                 => 'INVICI_TRX_FOR_SO',
      p_sig_sql                => 'select 
transaction_id,
creation_date,
costed_flag,
...
where header_id = ##$$HEADER_ID$$##)
and transaction_action_id not in (2, 28) /*exclude staging transfer transactions*/',
      p_title                  => 'Material Transactions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no material transactions for this sales order.',
      p_solution               => 'Make sure the Sales Order has been ship confirmed.',
      p_success_msg            => 'These are the material transactions for this sales order.

<br> If Intercompany invoices have not been generated after running INCIAR, check if these transactions are eligible per [2157627/KB783201#aref_section210]<br> 
<ul> <li> Sales order issue transactions should be costed (costed_flag is NULL) 
</li> <li> Internal orders with Expense Destination (transaction_type_id = 34 / transaction_source_type_id = 8 / transaction_action_id = 1) are ineligible. 
</li> <li> Internal orders with transfer type = Direct (Transaction type id = 54 / transaction_action_Id = 3 ) are ineligible.
</li> <li> Transaction is still eligible for Intercompany Invoices (Invoiced_flag = ''N'') , but program has not been run, or it errored out.
</li>
</ul>',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_TRX_FOR_SO');



debug('begin add_signature: INVICI_TRX_FLOW_HDRS_VALD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8574',
      p_sig_id                 => 'INVICI_TRX_FLOW_HDRS_VALD',
      p_sig_sql                => 'SELECT  MMT.transaction_id, MMT.organization_id , MMT.TRANSACTION_DATE,  mmt.trx_flow_header_id  
  ,ship_org.org_information3 SHIP_OU,   sell_org.org_information3 SELL_OU 
  ,MTFH.START_DATE,   MTFH.END_DATE, mmt.transaction_type_id
FROM mtl_material_transactions mmt ,
  hr_organization_information ship_org,
  hr_organization_information sell_org,
  MTL_TRANSACTION_FLOW_HEADERS MTFH,
  oe_order_lines_all oel
WHERE TRANSACTION_ACTION_ID  = 1
AND oel.line_id                      = mmt.trx_source_line_id
AND OEL.HEADER_ID                    =  ##$$HEADER_ID$$## 
and oel.org_id                       =  ##$$ORGID$$##
AND ship_org.ORGANIZATION_ID         = mmt.organization_id
AND sell_org.ORGANIZATION_ID         = oel.org_id
AND MTFH.START_ORG_ID                = ship_org.org_information3
AND MTFH.END_ORG_ID                  = sell_org.org_information3
AND MTFH.FLOW_TYPE                   = 1
AND (MMT.TRANSACTION_DATE            < MTFH.START_DATE or  MMT.TRANSACTION_DATE > NVL(MTFH.END_DATE,MMT.TRANSACTION_DATE))
AND ship_org.org_information_context = ''Accounting Information''
AND sell_org.org_information_context = ''Accounting Information'' 
Union
SELECT  MMT.transaction_id, MMT.organization_id , MMT.TRANSACTION_DATE,  mmt.trx_flow_header_id
  , NULL , NULL 
  , NULL , NULL ,  mmt.transaction_type_id
FROM mtl_material_transactions mmt ,
  oe_order_lines_all oel
...
AND OEL.HEADER_ID          =  ##$$HEADER_ID$$## 
and oel.org_id                       =  ##$$ORGID$$##
AND mmt.trx_flow_header_id is NULL
Union
select   MMT.transaction_id, MMT.organization_id , MMT.TRANSACTION_DATE,  mmt.trx_flow_header_id
  ,ship_org.org_information3 SHIP_OU,   sell_org.org_information3 SELL_OU 
  ,MTFH.START_DATE,   MTFH.END_DATE, mmt.transaction_type_id
...
AND sell_org.ORGANIZATION_ID          =PRL.DESTINATION_ORGANIZATION_ID
AND ship_org.ORGANIZATION_ID         = oel.ship_from_org_id 
AND MTFH.START_ORG_ID                   = ship_org.org_information3
AND MTFH.END_ORG_ID                      = sell_org.org_information3
AND MTFH.FLOW_TYPE                         = 1
AND (MMT.TRANSACTION_DATE   < MTFH.START_DATE or  MMT.TRANSACTION_DATE > NVL(MTFH.END_DATE, MMT.TRANSACTION_DATE))
...
AND sell_org.org_information_context = ''Accounting Information''
',
      p_title                  => 'Transaction Date Validation against Intercompany Flow Start Date',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'No Intercompany Transaction Flow defined for the transaction date . Either transaction flow header is not stamped on Material Transaction or the shipment transaction date is outside the Intercompany transaction flow header start / end dates.
',
      p_solution               => '<ul>
<li> This is the similar issue described in [1112425/KB746847] and [2157627/KB783201]</li>
<li> Please follow the solution present in Section 2 under Common Issues in Intercompany from Note - Logistics Brownbag: Troubleshooting Intercompany Issues [2157627/KB783201#aref_section25] </li>
</ul>',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: INVICI_TRX_FLOW_HDRS_VALD');



debug('begin add_signature: INVICI_MTI_FULL_OUTPUT_ORDER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20502',
      p_sig_id                 => 'INVICI_MTI_FULL_OUTPUT_ORDER',
      p_sig_sql                => 'select TRANSACTION_INTERFACE_ID, 
TRANSACTION_HEADER_ID, 
decode(PROCESS_FLAG, 1, ''1 (Yes)'', 2, ''2 (No)'', 3, ''3 (Error)'', PROCESS_FLAG) PROCESS_FLAG, 
ERROR_CODE, 
ERROR_EXPLANATION, 
decode(VALIDATION_REQUIRED, 1, ''1 (Yes)'', 2, ''2 (No)'', VALIDATION_REQUIRED) VALIDATION_REQUIRED, 
decode(TRANSACTION_MODE, 1, ''1 (Online)'', 2, ''2 (Concurrent)'', 3, ''3 (Background)'', 8, ''8 (Internal Processing)'', TRANSACTION_MODE) TRANSACTION_MODE, 
decode(LOCK_FLAG, 1, ''1 (Yes)'', 2, ''2 (No)'', LOCK_FLAG) LOCK_FLAG, 
INVENTORY_ITEM_ID, 
ITEM_SEGMENT1, 
REVISION, 
to_char(TRANSACTION_DATE, ''DD-MON-YYYY HH24:MI:SS'') TRANSACTION_DATE,
ACCT_PERIOD_ID, 
NVL((select transaction_type_id || '' (''|| TRANSACTION_TYPE_NAME || '')'' from MTL_TRANSACTION_TYPES a where a.transaction_type_id = mti.transaction_type_id), mti.transaction_type_id) transaction_type_id, 
NVL((select TRANSACTION_ACTION_ID || '' (''|| meaning || '')'' from mfg_lookups where lookup_type = ''MTL_TRANSACTION_ACTION'' and lookup_code = TRANSACTION_ACTION_ID), TRANSACTION_ACTION_ID) TRANSACTION_ACTION_ID,
NVL((select transaction_source_type_id || '' (''|| transaction_source_type_name || '')'' from mtl_txn_source_types a where a.transaction_source_type_id = mti.transaction_source_type_id), mti.transaction_type_id) transaction_source_type_id, 
PRIMARY_QUANTITY, 
TRANSACTION_QUANTITY, 
TRANSACTION_UOM, 
SECONDARY_TRANSACTION_QUANTITY, 
SECONDARY_UOM_CODE, 
NVL((select mti.ORGANIZATION_ID || '' ('' ||b.organization_code || '')'' from mtl_parameters b where b.organization_id = mti.ORGANIZATION_ID), mti.ORGANIZATION_ID) ORGANIZATION_ID,
SUBINVENTORY_CODE, 
NVL((select mti.locator_id || '' ('' ||b.concatenated_segments || '')'' from mtl_item_locations_kfv b where b.inventory_location_id = mti.locator_id and b.organization_id = mti.ORGANIZATION_ID), mti.LOCATOR_ID) LOCATOR_ID,
LOC_SEGMENT1, 
LOC_SEGMENT2, 
LOC_SEGMENT3, 
LOC_SEGMENT19, 
LOC_SEGMENT20, 
COST_GROUP_ID, 
NVL((select mti.TRANSFER_ORGANIZATION || '' ('' ||b.organization_code || '')'' from mtl_parameters b where b.organization_id = mti.TRANSFER_ORGANIZATION), mti.TRANSFER_ORGANIZATION) TRANSFER_ORGANIZATION,
TRANSFER_SUBINVENTORY, 
NVL((select mti.TRANSFER_LOCATOR || '' ('' ||b.concatenated_segments || '')'' from mtl_item_locations_kfv b where b.inventory_location_id = mti.TRANSFER_LOCATOR and b.organization_id = mti.TRANSFER_ORGANIZATION), mti.TRANSFER_LOCATOR) TRANSFER_LOCATOR,
XFER_LOC_SEGMENT1, 
XFER_LOC_SEGMENT2, 
XFER_LOC_SEGMENT3, 
XFER_LOC_SEGMENT19, 
XFER_LOC_SEGMENT20, 
TRANSFER_COST_GROUP_ID, 
NVL((select mti.LPN_ID || '' ('' ||b.license_plate_number || '')'' from wms_license_plate_numbers b where b.organization_id = mti.LPN_ID), mti.LPN_ID) LPN_ID,
TRANSFER_LPN_ID, 
CONTENT_LPN_ID, 
SOURCE_CODE, 
SOURCE_LINE_ID, 
...
where mti.source_header_id = ##$$HEADER_ID$$##
order by TRANSACTION_DATE desc',
      p_title                  => 'Open Interface Transactions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are unprocessed transactions in the Transactions Interface (MTL_TRANSACTIONS_INTERFACE MTI). These may be valid transactions that simply need to be processed by the transactions manager before Intercompany Invoices can be created. Problem transactions typically have ERROR_CODE and ERROR_EXPLANATION. This displays all columns for the MTL_TRANSACTIONS_INTERFACE Table.',
      p_solution               => 'See the Solutions in [1063689/KB559654] - Transactions Interface MTL_TRANSACTIONS_INTERFACE MTI Error Messages, Meanings, and Solutions',
      p_success_msg            => 'There are no unprocessed transactions in the Transactions Interface (MTL_TRANSACTIONS_INTERFACE MTI).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_MTI_FULL_OUTPUT_ORDER');
...
debug('begin add_signature: INVICI_OPERATING_UNITS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11044',
      p_sig_id                 => 'INVICI_OPERATING_UNITS',
      p_sig_sql                => 'SELECT Distinct
   decode ( hov.organization_id, oola.ship_from_org_id , ''Start OU (Ship OU)'',  ''End OU (Sell OU)''  )  OU_Type ,
    hov.organization_Id, hov.org_information3 operating_unit, hou.name, hou.date_from, hou.date_to 
FROM
     hr_organization_information_v hov, hr_all_organization_units hou , oe_order_lines_all oola
WHERE  hov.org_information_context = ''Accounting Information'' 
  and  hov.org_information3 = hou.organization_id  
    AND ( hov.organization_id = oola.ship_from_org_id
          OR   hov.organization_id = ( SELECT  organization_id FROM  po_location_associations_all pla WHERE   pla.site_use_id = oola.ship_to_org_id ) )
    AND oola.order_source_id = 10
and oola.header_id =  ##$$HEADER_ID$$## 
and oola.org_id =  ##$$ORGID$$##',
      p_title                  => 'Operating Unit Details Present in Internal Sales Order',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The details displayed are from hr_operating_units table for both the Source and Destination Operating Units associated to the Internal Sales Order that was entered in the analyzer.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_OPERATING_UNITS');



debug('begin add_signature: INVICI_MTL_PARAMETERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11042',
      p_sig_id                 => 'INVICI_MTL_PARAMETERS',
      p_sig_sql                => 'SELECT distinct MTP.* FROM MTL_PARAMETERS MTP ,  oe_order_lines_all oola
WHERE (MTP.ORGANIZATION_ID = oola.SHIP_FROM_ORG_ID
       OR MTP.ORGANIZATION_ID = (SELECT ORGANIZATION_ID FROM PO_LOCATION_ASSOCIATIONS_ALL PLA WHERE PLA.SITE_USE_ID = oola.SHIP_TO_ORG_ID)
	  )
AND oola.ORDER_SOURCE_ID = 10
and oola.header_id = ##$$HEADER_ID$$## 
and oola.org_id = ##$$ORGID$$## ',
      p_title                  => 'Inventory Organization On Internal Sales Order',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The details displayed are Organization Parameters Information for both the Ship From and Ship To Organizations associated to the Internal Sales Order that was entered in the analyzer.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_MTL_PARAMETERS');



debug('begin add_signature: INVICI_INTERCOMPANY_PARAMS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8805',
      p_sig_id                 => 'INVICI_INTERCOMPANY_PARAMS',
      p_sig_sql                => 'SELECT MIP.SHIP_ORGANIZATION_ID,
  MIP.SELL_ORGANIZATION_ID,
  DECODE (MIP.FLOW_TYPE,1,''Shipping'',2,''Procuring'',''None'') FLOW_TYPE,
  MIP.CUSTOMER_ID,
  MIP.ADDRESS_ID,
  MIP.CUSTOMER_SITE_ID,
  MIP.CUST_TRX_TYPE_ID,
  MIP.VENDOR_ID,
  MIP.VENDOR_SITE_ID,
  MIP.REVALUE_AVERAGE_FLAG,
  DECODE(MIP.INV_CURRENCY_CODE,1,''Currency Code of From Operating Unit'',2,''Currency Code of To Operating Unit'',3,''Currency Code of Order'',''None'') CURRENCY_CODE,
  cogs_ac.CONCATENATED_SEGMENTS COGS_ACCOUNT,
  invac_ac.CONCATENATED_SEGMENTS INV_ACCRUAL_ACCOUNT,
  exp_ac.CONCATENATED_SEGMENTS EXPENSE_ACCOUNT,
  frt_ac.CONCATENATED_SEGMENTS FREIGHT_ACCOUNT
FROM MTL_INTERCOMPANY_PARAMETERS MIP,
  GL_CODE_COMBINATIONS_KFV cogs_ac,
  GL_CODE_COMBINATIONS_KFV invac_ac,
  GL_CODE_COMBINATIONS_KFV exp_ac,
  GL_CODE_COMBINATIONS_KFV frt_ac
WHERE MIP.SHIP_ORGANIZATION_ID      =  ''##$$FK2$$##''
AND MIP.SELL_ORGANIZATION_ID        =  ''##$$FK3$$##''
AND cogs_ac.code_combination_id (+) = MIP.INTERCOMPANY_COGS_ACCOUNT_ID
AND exp_ac.code_combination_id (+)  = MIP.EXPENSE_ACCRUAL_ACCOUNT_ID
AND invac_ac.code_combination_id (+)= MIP.INVENTORY_ACCRUAL_ACCOUNT_ID
AND frt_ac.code_combination_id (+)  = MIP.FREIGHT_CODE_COMBINATION_ID',
      p_title                  => 'Intercompany Relations',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Intercompany Relations defined',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_INTERCOMPANY_PARAMS');



debug('begin add_signature: INVICI_TRX_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8804',
      p_sig_id                 => 'INVICI_TRX_LINES',
      p_sig_sql                => 'SELECT
    mtfl.from_org_id              "##$$FK2$$##",
    mtfl.to_org_id                "##$$FK3$$##",
    mtfl.line_number,
    mtfl.from_org_id              from_operating_unit_id,
    mtfl.from_org_name           from_operating_unit_name,
    mtfl.from_organization_id,
    mtfl.from_organization_code,
    mtfl.to_org_id                to_operating_unit_id,
    mtfl.to_org_name             to_operating_unit_name,
    mtfl.to_organization_id,
    mtfl.to_organization_code      to_organization_code
FROM
    MTL_TRANSACTION_FLOW_LINES_V    mtfl 
WHERE
        mtfl.header_id =  ''##$$FK1$$##'' 
ORDER BY
    line_number',
      p_title                  => ' Intercompany Transaction Flow Lines',
      p_fail_condition         => 'RSGT1',
      p_problem_descr          => 'There is more than one transaction flow definition between the start and end operating units. This will work fine with external drop ship as it supports multi nodes, however this setup does not work for internal orders because it does not support multi node intercompany transaction flow. ',
      p_solution               => 'Review -
INCIAR: More Than One Transaction Flow Exists. Wrong IC Transaction Flow Selected  [1535915/KB791643]',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('INVICI_INTERCOMPANY_PARAMS'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '11'
      );
   l_info.delete;
debug('end add_signature: INVICI_TRX_LINES');



debug('begin add_signature: INVICI_INTERORG_PARAMETERS_ISO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19232',
      p_sig_id                 => 'INVICI_INTERORG_PARAMETERS_ISO',
      p_sig_sql                => 'select distinct mp_f.organization_code || ''(''||decode(mp_f.process_enabled_flag, ''Y'', ''Process'', ''Discrete'') ||'')'' "From Organization Code", 
mp_to.organization_code || ''(''||decode(mp_to.process_enabled_flag, ''Y'', ''Process'', ''Discrete'') ||'')'' "To Organization Code"   ,
mip.from_organization_id, mip.to_organization_id, 
decode(mip.intransit_type, 1, ''1 (Direct)'', 2, ''2 (Intransit)'') intransit_type ,
decode(mip.fob_point , 1, ''1 (Shipment)'' , 2,''2 (Receipt)'' ) fob_point, 
decode(mip.internal_order_required_flag  , 1, ''1 (Required)'' , 2,''2 (Not Required)'' ) internal_order_required_flag ,
decode(mip.routing_header_id, 1, ''1 (Standard)'', 2, ''2 (Inspection)'', 3, ''3 (Direct)'') routing_header_id,
mip.ELEMENTAL_VISIBILITY_ENABLED ,mip.MANUAL_RECEIPT_EXPENSE
 ,prc.name || ''(''||mip.PRICELIST_ID ||'')'' PRICELIST_NAME ,mip.INTERORG_TRNSFR_CHARGE_PERCENT
,mip.INTRANSIT_INV_ACCOUNT ,mip.INTERORG_TRANSFER_CR_ACCOUNT 
,mip.INTERORG_RECEIVABLES_ACCOUNT ,mip.INTERORG_PAYABLES_ACCOUNT     
,mip.INTERORG_PRICE_VAR_ACCOUNT ,mip.PROFIT_IN_INV_ACCOUNT
 ,mip.INTERORG_PROFIT_ACCOUNT ,mip.SUBCONTRACTING_TYPE   
,mip.creation_date
from mtl_interorg_parameters mip, mtl_parameters mp_f , mtl_parameters mp_to , MTL_TRANSACTION_FLOW_LINES MTFL  , QP_PRICE_LISTS_V prc
where mip.from_organization_id = mp_f.organization_id 
and mip.to_organization_id = mp_to.organization_id
and  prc.price_list_id (+) =  mip.PRICELIST_ID  
and MTFL.FROM_ORGANIZATION_ID = mp_f.ORGANIZATION_ID (+) 
AND MTFL.TO_ORGANIZATION_ID = mp_to.ORGANIZATION_ID (+)
AND MTFL.HEADER_ID =  ''##$$FK1$$##''',
      p_title                  => 'Shipping Networks',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This query displays information about Inter org shipping networks involved in the Intercompany Flow.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_INTERORG_PARAMETERS_ISO');



debug('begin add_signature: INVICI_TRX_HDRS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8803',
      p_sig_id                 => 'INVICI_TRX_HDRS',
      p_sig_sql                => 'SELECT  oel.line_id, mtfh.header_id  "##$$FK1$$##" ,  oel.org_id ship_org_id, mtfh.start_org_name ship_ou_name, prl.org_id  sell_org_id
, mtfh.end_org_name  sell_ou_name, mtfh.header_id, mtfh.start_date, mtfh.end_date, decode(mtfh.flow_type, 1, ''1-Shipping'', 2, ''2-Procuring'') flow_type
, mtfh.organization_id, mtfh.organization_code, mtfh.qualifier_code, mtfh.qualifier_value_id, mtfh.asset_item_pricing_option
, mtfh.expense_item_pricing_option, mtfh.new_accounting_flag
FROM  mtl_transaction_flow_headers_v  mtfh, oe_order_lines_all  oel, po_requisition_lines_all  prl
WHERE  oel.source_document_line_id = prl.requisition_line_id
AND oel.header_id = ##$$HEADER_ID$$## AND oel.org_id = ##$$ORGID$$##
AND oel.source_document_type_id = 10
AND mtfh.start_org_id = oel.org_id
AND mtfh.end_org_id = prl.org_id
AND mtfh.flow_type = 1 ',
      p_title                  => 'Intercompany Transaction Flow Headers (ISO)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Intercompany Transaction Flow Header defined',
      p_solution               => 'For defining Intercompany  transaction flow,  Please refer to Section 1 on [2157627/KB783201#aref_section24]- Logistics Brownbag: Troubleshooting Intercompany Issues',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('INVICI_TRX_LINES','INVICI_INTERORG_PARAMETERS_ISO'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '23'
      );
   l_info.delete;
debug('end add_signature: INVICI_TRX_HDRS');



debug('begin add_signature: INVICI_OPER_UNIT_DETAILS_FOR_SO_HEADER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6909',
      p_sig_id                 => 'INVICI_OPER_UNIT_DETAILS_FOR_SO_HEADER',
      p_sig_sql                => 'SELECT distinct 
 decode ( hov.organization_id, oola.ship_from_org_id , ''Start OU (Ship OU)'', oola.org_id , ''End OU (Sell OU)''  )  OU_Type,
 hov.org_information3 operating_unit, hou.name, hou.date_from, hou.date_to 
FROM 
      hr_organization_information_v hov, hr_all_organization_units hou , oe_order_lines_all oola
where hov.org_information_context = ''Accounting Information'' 
and  hov.org_information3 = hou.organization_id  
and (  ( hov.organization_id = oola.ship_from_org_id ) 
       OR  (   hov.organization_id = oola.org_id ) )  
AND oola.header_id =  ##$$HEADER_ID$$## 
and oola.org_id =  ##$$ORGID$$##',
      p_title                  => 'Operating Unit Details (SO)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The details displayed are for Ship and Sell Operating Units on each of the Sales Order Lines. ',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_OPER_UNIT_DETAILS_FOR_SO_HEADER');



debug('begin add_signature: EBS_MFG_INV_INVICI_MTL_PARAMS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25033',
      p_sig_id                 => 'EBS_MFG_INV_INVICI_MTL_PARAMS',
      p_sig_sql                => 'SELECT distinct MTP.* FROM MTL_PARAMETERS MTP ,  oe_order_lines_all oola
WHERE MTP.ORGANIZATION_ID = oola.SHIP_FROM_ORG_ID
and oola.header_id = ##$$HEADER_ID$$## 
and oola.org_id = ##$$ORGID$$## ',
      p_title                  => 'Inventory Organization On Sales Order',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The details displayed are Organization Parameters Information for the Ship From Organization associated to the Sales Order .',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_INV_INVICI_MTL_PARAMS');



debug('begin add_signature: INVICI_INTERCOMPANY_PARAMS_SO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19479',
      p_sig_id                 => 'INVICI_INTERCOMPANY_PARAMS_SO',
      p_sig_sql                => 'SELECT MIP.SHIP_ORGANIZATION_ID,
  MIP.SELL_ORGANIZATION_ID,
  DECODE (MIP.FLOW_TYPE,1,''Shipping'',2,''Procuring'',''None'') FLOW_TYPE,
  MIP.CUSTOMER_ID,
...
AND frt_ac.code_combination_id (+)  = MIP.FREIGHT_CODE_COMBINATION_ID',
   ...
   l_info.delete;
debug('end add_signature: INVICI_INTERCOMPANY_PARAMS_SO');



debug('begin add_signature: INVICI_TRX_LINES_SO');
   l_info('##MASK##SELL_ORG.ORGANIZATION_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SHIP_ORG.ORGANIZATION_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19478',
      p_sig_id                 => 'INVICI_TRX_LINES_SO',
      p_sig_sql                => 'SELECT
    mtfl.from_org_id              "##$$FK2$$##",
    mtfl.to_org_id                "##$$FK3$$##",
    mtfl.line_number,
...
ORDER BY
    line_number',
      p_title                  => 'Intercompany Transaction Flow Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Intercompany Transaction Flow Lines',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      ...
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('INVICI_INTERCOMPANY_PARAMS_SO'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '4'
      );
   l_info.delete;
debug('end add_signature: INVICI_TRX_LINES_SO');



debug('begin add_signature: INVICI_INTERORG_PARAMETERS_SO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19231',
      p_sig_id                 => 'INVICI_INTERORG_PARAMETERS_SO',
      p_sig_sql                => 'select distinct mp_f.organization_code || ''(''||decode(mp_f.process_enabled_flag, ''Y'', ''Process'', ''Discrete'') ||'')'' "From Organization Code", 
mp_to.organization_code || ''(''||decode(mp_to.process_enabled_flag, ''Y'', ''Process'', ''Discrete'') ||'')'' "To Organization Code"   ,
mip.from_organization_id, mip.to_organization_id, 
decode(mip.intransit_type, 1, ''1 (Direct)'', 2, ''2 (Intransit)'') intransit_type ,
...
AND MTFL.HEADER_ID =  ''##$$FK1$$##''',
   ...
   l_info.delete;
debug('end add_signature: INVICI_INTERORG_PARAMETERS_SO');



debug('begin add_signature: INVICI_TRX_HDRS_SO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19201',
      p_sig_id                 => 'INVICI_TRX_HDRS_SO',
      p_sig_sql                => 'SELECT oel.line_id , mtfh.header_id "##$$FK1$$##",                   
ship_org.org_information3 ship_org_id,                          
mtfh.start_org_name  ,                         
oel.org_id   sell_org_id,                          
mtfh.end_org_name  ,                         
mtfh.header_id,                                                 
mtfh.start_date,                                                
mtfh.end_date,                                                  
decode (mtfh.flow_type , 1, ''1-Shipping'', 2, ''2-Procuring'') FLOW_TYPE,                                                 
mtfh.organization_id,  
mtfh.organization_code,
mtfh.qualifier_code,                                            
mtfh.qualifier_value_id,                                        
mtfh.asset_item_pricing_option,                                 
mtfh.expense_item_pricing_option,                               
mtfh.new_accounting_flag                                        
FROM hr_organization_information ship_org,                      
...
AND ship_org.organization_id = oel.ship_from_org_id              
AND mtfh.start_org_id = ship_org.org_information3 
AND mtfh.end_org_id = oel.org_id
AND ship_org.org_information_context = ''Accounting Information'' 
AND mtfh.flow_type = 1',
      p_title                  => 'Intercompany Transaction Flow Headers (SO)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Intercompany Transaction Flow Header defined',
      p_solution               => 'For defining Intercompany  transaction flow,  Please refer to [2157627/KB783201#aref_section24] - Logistics Brownbag: Troubleshooting Intercompany Issues',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('INVICI_TRX_LINES_SO','INVICI_INTERORG_PARAMETERS_SO'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '18'
      );
   l_info.delete;
debug('end add_signature: INVICI_TRX_HDRS_SO');
...
BEGIN
  ...
  IF (p_order_number IS NOT NULL) THEN
    g_params_string := g_params_string || to_char(p_order_number) || '_';
  END IF;
  IF (p_header_id IS NOT NULL) THEN
    g_params_string := g_params_string || to_char(p_header_id) || '_';
  END IF;
  ...
  analyzer_title := 'Inventory Intercompany AR and AP Invoicing Analyzer';
...
debug('begin section: INVICI_SETUP');
start_section('Setup', 'INVICI_SETUP');
   set_item_result(run_stored_sig('INVICI_PROFILE_OPTIONS'));
   set_item_result(run_stored_sig('INVICI_INVOICE_FREIGHT_AS_REVENUE'));
   IF g_sql_tokens('##$$P_SO_OR_ISO$$##')  = 'ISO'
 THEN
      set_item_result(run_stored_sig('INVICI_OPERATING_UNITS'));
      set_item_result(run_stored_sig('INVICI_MTL_PARAMETERS'));
      set_item_result(run_stored_sig('INVICI_TRX_HDRS'));
   END IF;
   set_item_result(run_stored_sig('EBS_MFG_INV_INVICI_ACCT_GEN_WF_NAME'));
   IF g_sql_tokens('##$$P_SO_OR_ISO$$##')  = 'SO'
 THEN
      set_item_result(run_stored_sig('INVICI_OPER_UNIT_DETAILS_FOR_SO_HEADER'));
      set_item_result(run_stored_sig('EBS_MFG_INV_INVICI_MTL_PARAMS'));
      set_item_result(run_stored_sig('INVICI_TRX_HDRS_SO'));
   END IF;
end_section;
debug('end section: INVICI_SETUP');

debug('begin section: INVICI_ITEM_DETAILS');
start_section('Item Details', 'INVICI_ITEM_DETAILS');
   set_item_result(run_stored_sig('INVICI_ITEM_COST_DETAILS'));
   set_item_result(run_stored_sig('INVICI_ITEM_INFO'));
end_section;
debug('end section: INVICI_ITEM_DETAILS');

debug('begin section: INVICI_PROACTIVE_ACTIONS');
start_section('Proactive Recommendations', 'INVICI_PROACTIVE_ACTIONS');
   set_item_result(run_stored_sig('INVICI_PATCHSET_LEVELS'));
   set_item_result(run_stored_sig('INVICI_INVALIDS'));
   set_item_result(check_rec_patches_1); /* Signature INV_RUP_CHECK */
end_section;
debug('end section: INVICI_PROACTIVE_ACTIONS');

debug('begin section: INVICI_PRICING_SETUP_DETAILS');
start_section('Pricing Details', 'INVICI_PRICING_SETUP_DETAILS');
   set_item_result(run_stored_sig('INVICI_PRICE_LIST_FROM_SO_HEADER'));
   set_item_result(run_stored_sig('INVICI_CST_BILLTO_PRICE_LIST_VALID'));
   set_item_result(run_stored_sig('INVICI_ADVANCE_PRICING_IBATCH_QP'));
   set_item_result(run_stored_sig('INVICI_ADVANCE_PRICING_INTCOM_QP'));
   set_item_result(run_stored_sig('INVICI_ADVANCE_PRICING_STATUS_QP'));
   set_item_result(run_stored_sig('INVICI_CUSTOM_HOOK_CHECK_TRANSFER_PRICE'));
end_section;
debug('end section: INVICI_PRICING_SETUP_DETAILS');

debug('begin section: INVICI_AR_INVOICE_DETAILS');
start_section('AR Invoice Details', 'INVICI_AR_INVOICE_DETAILS');
   set_item_result(run_stored_sig('INVICI_AR_INV_ALL'));
   set_item_result(run_stored_sig('INVICI_AR_INV_LINES_ALL'));
   set_item_result(run_stored_sig('INVICI_AR_INV_DIST_ALL'));
   set_item_result(run_stored_sig('INVICI_AR_INV_LINES_INTF'));
   set_item_result(run_stored_sig('INVICI_AR_INV_DIST_INTF'));
   set_item_result(run_stored_sig('INVICI_AR_INV_ERR_INTF'));
end_section;
debug('end section: INVICI_AR_INVOICE_DETAILS');

debug('begin section: INVICI_AP_INVOICE_DETAILS');
start_section('AP Invoice Details', 'INVICI_AP_INVOICE_DETAILS');
   set_item_result(run_stored_sig('INVICI_AP_INV_ALL'));
   set_item_result(run_stored_sig('INVICI_AP_INV_LINE_ALL'));
   set_item_result(run_stored_sig('INVICI_AP_INV_INTF'));
   set_item_result(run_stored_sig('INVICI_AP_INV_LINES_INTF'));
   set_item_result(run_stored_sig('INVICI_AP_INTERFACE_REJECTIONS'));
end_section;
debug('end section: INVICI_AP_INVOICE_DETAILS');

debug('begin section: INVICI_TRANSACTION_DETAILS');
start_section('Transaction Details', 'INVICI_TRANSACTION_DETAILS');
   set_item_result(run_stored_sig('INVICI_SALES_ORDER_HEADER_INFORMATION_DISPLAY'));
   set_item_result(run_stored_sig('INVICI_OEL_FOR_TRX_SO'));
   set_item_result(run_stored_sig('INVICI_WDD_TRX_FOR_SO'));
   set_item_result(run_stored_sig('INVICI_TRX_FOR_SO'));
end_section;
debug('end section: INVICI_TRANSACTION_DETAILS');

debug('begin section: INVICI_STANDARD_ERRORS');
start_section('Intercompany Standard Errors', 'INVICI_STANDARD_ERRORS');
   set_item_result(run_stored_sig('INVICI_TRX_FLOW_HDRS_VALD'));
   set_item_result(run_stored_sig('INVICI_MTI_FULL_OUTPUT_ORDER'));
end_section;
debug('end section: INVICI_STANDARD_ERRORS');

debug('begin section: Diag_Apps_Check_COPY');
IF g_sql_tokens('##$$APPS_CHECK$$##') ='Y' THEN
   start_section('Diagnostics: Apps Check', 'Diag_Apps_Check_COPY');
   ...
   end_section;
END IF;
debug('end section: Diag_Apps_Check_COPY');
