...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for ASCP Performance Analyzer              |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE ascp_perf_analyzer_pkg AUTHID DEFINER AS
...
PROCEDURE main
(            p_max_output_rows              IN NUMBER      DEFAULT 40
...
END ascp_perf_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY ascp_perf_analyzer_pkg AS
-- $Id: ascp_perf_analyzer.sql, 200.102 2026/01/28 13:47:23 oracle Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(1554183.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'ASCP_PERFORMANCE_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'ASCP_PERFORMANCE_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>ASCP_PERFORMANCE Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=1554183.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/ascp_perf_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,811,EBS,EBS MFG,EBS - Value Chain Planning" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,811,EBS,EBS MFG,EBS - Value Chain Planning" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},811,EBS,EBS MFG,EBS - Value Chain Planning" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/mosc/discussion/3870019" class="blacklink" target="new">
...
<div><strong>Version 200.101</strong></div>
<p>Template Changes (4.8.2):&nbsp;<br>
&nbsp; &nbsp; &nbsp;KM notes links from analyzer output in CMOS<br>
<br>
<strong>We’re listening to your feedback and made the following changes:</strong></p><ul><li>Regenerate to accommodate multi-organization framework.</li>
...
<p style="margin-left:.375in;"><strong>The Data Masking feature has been expanded.&nbsp;&nbsp;&nbsp;&nbsp;</strong></p><ol><li>Select data is now pre-masked at the point of collection.</li>
<li>The masked information displayed will be just enough to permit effective review and troubleshooting of an issue.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Example:&nbsp; A credit card number <strong>would</strong> be displayed as ****-****-****-1234. &nbsp;&nbsp;<span style="font-family:Calibri;font-size:11.0pt;"> An employee name would be displayed as D</span><span style="font-family:&apos;Segoe UI&apos;;font-size:10.5pt;">isplay first and last 25% per word (J**n S**w = John Snow)</span></li>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,811,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Value Chain Planning" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,811,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Value Chain Planning" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},811,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Value Chain Planning" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Maximum Rows to Display Defaulted to 40';
...
-- Revision and date values can be populated by RCS
  l_revision := rtrim(replace('$Revision: 200.102  $','$',''));
  l_revision := ltrim(replace(l_revision,'Revision:',''));
  l_date_char := rtrim(replace('$Date: 2026/01/28 13:47:22 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'ascp_perf_analyzer.sql';
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$MYSCHEMA$$##') := g_my_schema;
...
debug('begin add_signature: ASCP_INVALIDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5216',
      p_sig_id                 => 'ASCP_INVALIDS',
    ...
    AND a.status = ''INVALID''',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invalid objects exist that are related to VCP schema',
      p_solution               => 'See [1325394/KB401905] Troubleshooting Guide - Invalid Objects in the E-Business Suite Environment 11i and 12',
   ...
   l_info.delete;
debug('end add_signature: ASCP_INVALIDS');



debug('begin add_signature: CLUSTER_ENABLED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5231',
      p_sig_id                 => 'CLUSTER_ENABLED',
      p_sig_sql                => 'select name "Parameter Name",
value "Parameter Value"
from v$parameter
where name = ''cluster_database''',
      p_title                  => 'Cluster Enabled Parameter as selected from v$parameter',
      p_fail_condition         => '[Parameter Value] = [TRUE]',
      p_problem_descr          => 'Cluster Enabled Parameter as selected from v$parameter.',
      p_solution               => 'The Value of cluster_database is set to TRUE <br>

Your RDBMS is RAC install enabled.  RAC install can cause ATP failures (ATP Processing Error) and requires setup by the DBA.<br>
See [266125/KB322921] RAC install can cause failures in Planning and Data Collections.<br>
See [810394/KB141201] RAC and Oracle Clusterware Best Practices and Starter Kit (Platform Independent)<br>
Your database is NOT cluster enabled.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLUSTER_ENABLED');



debug('begin add_signature: ENVIRONMENT_REPORT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5230',
      p_sig_id                 => 'ENVIRONMENT_REPORT',
      p_sig_sql                => 'select name "Parameter Name",
value "Parameter Value"
from v$parameter
...
See [1081971/KB571183] Value Chain Planning, Discrete and Process Manufacturing Product Resource Guide',
      p_success_msg            => 'select name "Parameter Name",
value "Parameter Value"
from v$parameter
where name in (''control_files'', ''db_block_size'', ''audit_trail'', ''max_dump_file_size'', ''timed_statistics'', ''db_files'', ''dml_locks'', ''cursor_sharing'', ''open_cursors'', ''sql_trace'', ''utl_file_dir'', ''optimizer_mode'', ''db_file_multiblock_read_count'',''processes'', ''sessions'',''cpu_count'', ''disk_asynch_io'',''service_names'')',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: ENVIRONMENT_REPORT');



debug('begin add_signature: INSTANCE_REPORT2');
   l_info('##MASK##2'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5229',
      p_sig_id                 => 'INSTANCE_REPORT2',
   ...
   from v$instance, fnd_product_groups',
      ...
      p_solution               => 'Status reveals the open - close status of the database.  RDBMS Status reveals if the instance is active.<br>
RDBMS Settings, for Oracle Apps, can be checked for each RDBMS release:<br>
For 11i see [216205.1] Database Initialization Parameters for Oracle Applications 11i<br>
For R12 see [396009.1] Database Initialization Parameters for Oracle Applications Release 12',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: INSTANCE_REPORT2');



debug('begin add_signature: NLS_DATE_FORMAT_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5224',
      p_sig_id                 => 'NLS_DATE_FORMAT_CHECK',
      p_sig_sql                => 'SELECT trim(value) "NLS_DATE_FORMAT" 
from v$parameter
where name = ''nls_date_format''',
      p_title                  => 'NLS_DATE_FORMAT Check',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Verify the NLS_DATE_FORMAT',
      p_solution               => 'See [1591800/KB793339] New Material/Resourc Plan Date Format (days/week/Period) Does Not Match With Classic Horizontal Plan<br>
For Demantra, see [1466420/KB644030], The dm User Default Password No Longer Works.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: NLS_DATE_FORMAT_CHECK');
...
debug('begin add_signature: ASCP_PERFORMANCE_PROFILES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5241',
      p_sig_id                 => 'ASCP_PERFORMANCE_PROFILES',
...
and    fpov.profile_option_id in (select fpo.profile_option_id poi from fnd_profile_options_vl fpo
                                 ...
                                 (''MRP:Debug Mode'', ''MRP:Trace Mode'', ''MRP:Planning Manager Batch Size'',
...
order  by fpov.level_id desc',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'ASCP Performance Related Profiles',
      p_solution               => 'Please review performance related profile documents <br>
<br> 
MOS Notes Related to Profile Options: <br>
[111955.1] MRP and ASCP Performance Profile Setup <br>
[209996/KB198429] - Advanced Supply Chain Planning ASCP Performance TIPS Profile Options',
   ...
   l_info.delete;
debug('end add_signature: ASCP_PERFORMANCE_PROFILES');



debug('begin add_signature: MAXIMUM_DEMANDS_PER_SLICE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5240',
      p_sig_id                 => 'MAXIMUM_DEMANDS_PER_SLICE',
      p_sig_sql                => 'select fav.application_name "Application Name", 
       fpo1.user_profile_option_name "Profile Option",
       fpov.profile_option_value "Value",
       decode(fpov.level_id, 10001, ''Site'', 10002, ''Appl'', 10003, ''Resp'', 10004, ''User'', ''None'') "Level"
...
or    (fpov.level_id = 10004 and fpov.level_value = (select fnd_profile.value(''USER_ID'') from dual)))
order  by fpov.level_id desc',
      p_title                  => 'ASCP Maximum Demands Per Slice Profile',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This determines the number of demands in a slice',
      p_solution               => '- A slice is a part of the plan that is scheduled at a time.<br>
- This option enables the scheduling engine to better resolve the interactions of demands on each other within a slice.<br>
- In particular, the supplies shared between demands are scheduled better when the demands are in the same slice.<br>
- Making slices too large causes the scheduling engine to be slower and consume more memory.<br>
- This profile option canR be defined at the site level. The default value is 100 demands.<br>
- If the number of shared supplies is low, try setting this value to a lower number such as 2.<br>
See [209996/KB198429] Advanced Supply Chain Planning ASCP Performance TIPS Profile Option',
      p_success_msg            => 'No issue found. This means Success',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: MAXIMUM_DEMANDS_PER_SLICE');



debug('begin add_signature: MAXIMUM_PULL_OPERATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5237',
      p_sig_id                 => 'MAXIMUM_PULL_OPERATION',
      p_sig_sql                => 'select fav.application_name "Application Name", 
       fpo1.user_profile_option_name "Profile Option",
       fpov.profile_option_value "Value",
       decode(fpov.level_id, 10001, ''Site'', 10002, ''Appl'', 10003, ''Resp'', 10004, ''User'', ''None'') "Level"
...
or    (fpov.level_id = 10004 and fpov.level_value = (select fnd_profile.value(''USER_ID'') from dual)))
order  by fpov.level_id desc',
      p_title                  => 'MSO: Maximum Number of Pull for Operation - for Constrained Planning only',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'MSO: Maximum Number of Pull for Operation - for Constrained Planning only',
      p_solution               => '- When an operation cannot be scheduled on a certain day, the scheduling engine attempts to schedule it on an earlier date.<br>
        - Used for backward scheduling.<br>
        - This profile option controls how many days are checked for availability.<br>
        - This should be larger than 0 and has a default of 8.<br>
        - A large number of days result in degraded performance.<br>
        - Monitor the performance with this profile set to 1 or 2.<br>
          See [209996/KB198429] Advanced Supply Chain Planning ASCP Performance TIPS Profile Options',
      p_success_msg            => 'No issue found. This means Success',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: MAXIMUM_PULL_OPERATION');



debug('begin add_signature: MAXIMUM_NBR_PREPONES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5239',
      p_sig_id                 => 'MAXIMUM_NBR_PREPONES',
      p_sig_sql                => 'select fav.application_name "Application Name", 
       fpo1.user_profile_option_name "Profile Option",
       fpov.profile_option_value "Value",
       decode(fpov.level_id, 10001, ''Site'', 10002, ''Appl'', 10003, ''Resp'', 10004, ''User'', ''None'') "Level"
...
and    fpov.profile_option_id in (select fpo.profile_option_id poi from fnd_profile_options_vl fpo
                                  where fpo.user_profile_option_name in 
                                 (''MSO: Maximum Number of Prepones'')
                                  and fpo.start_date_active <= sysdate
                                  and (nvl(fpo.end_date_active,sysdate) >= sysdate))
and    ((fpov.level_id = 10001 and fpov.level_value = 0)
or    (fpov.level_id = 10002 and fpov.level_value = fpo1.application_id)
...
or    (fpov.level_id = 10004 and fpov.level_value = (select fnd_profile.value(''USER_ID'') from dual)))
order  by fpov.level_id desc',
      p_title                  => 'MSO: Maximum Number of Prepones - for Constrained Planning only',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This is an important scalability factor for the scheduling engine',
      p_solution               => '- The scheduling engine will try to schedule the operations in different orders to find a solution.<br>
- As the number of order can be very large, this parameter limits the number of times the scheduling engine tries to schedule an operation.<br>
- If there are many components for some items, or many small supplies answering a demand, the number of orders between components and supplies become larger.<br>
- Try executing with this value at 2.<br>
See [209996/KB198429] Advanced Supply Chain Planning ASCP Performance TIPS Profile Options',
      p_success_msg            => 'No issue found. This means Success',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: MAXIMUM_NBR_PREPONES');



debug('begin add_signature: MSC_SEQ_CACHE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5236',
      p_sig_id                 => 'MSC_SEQ_CACHE',
      p_sig_sql                => 'select fav.application_name "Application Name", 
       fpo1.user_profile_option_name "Profile Option",
       fpov.profile_option_value "Value",
       decode(fpov.level_id, 10001, ''Site'', 10002, ''Appl'', 10003, ''Resp'', 10004, ''User'', ''None'') "Level"
...
or    (fpov.level_id = 10004 and fpov.level_value = (select fnd_profile.value(''USER_ID'') from dual)))
order  by fpov.level_id desc',
      p_title                  => 'MSC: Sequence Cache Size',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option determines the size of the sequence cache',
      p_solution               => 'For very large plans, system performance may be marginally improved by increasing this integer value (up to 5% of the estimated number of planned orders).<br>
- The default value of 500 is typically adequate and is used when this is not defined.<br>
- manually define the profile in Applications Developer - Profile<br>
NAME - MSC_SEQ_CACHE<br>
Application - Advanced Supply Chain Planning<br>
User Profile Name - MSC: Sequence Cache Size<br>
Description - optional - suggest - Used for Determining Cache of sequence numbers - user defined<br>
set active date as sysdate<br>
Hierarchy Type - Security<br>
Hierarchy type access level - ONLY check Site for Visible - Updatable<br>
User Access - do NOT check at all. - This means only visible in Sys Admin responsibility<br>
SQL validation - nothing here.<br>
See [209996/KB198429] - Advanced Supply Chain Planning ASCP Performance TIPS Profile Options.',
      p_success_msg            => 'No issue found. This means Success',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: MSC_SEQ_CACHE');



debug('begin add_signature: SEGMENT_TABLESPACE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5212',
      p_sig_id                 => 'SEGMENT_TABLESPACE_CHECK',
      p_sig_sql                => 'select owner, segment_name, segment_type, extents, max_extents
from dba_segments
where max_extents-extents <= 2
and owner = ''MSC''',
      p_title                  => 'Potential Space and Extents Issues.  MSC segment extents available < 2.',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The objects listed above are either approaching their maximum number or extents, or have a next extent <br> size that is larger than the largest available block of free space in the tablespace.',
...
See the following notes: <br>
[121259/KB150109] Using DBA_FREE_SPACE <br>
[1019553/KB813650] Script to Show Which Tables Cannot Extend On Dictionary Manged Tablespaces',
      p_success_msg            => 'No issue found. This means Success',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: SEGMENT_TABLESPACE_CHECK');
...
debug('begin add_signature: ASCP_CHAIN_ROWS_PERCENT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5219',
      p_sig_id                 => 'ASCP_CHAIN_ROWS_PERCENT',
      p_sig_sql                => 'select substr(table_name,1,15) "Table",
...
order by table_name',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The presence of migrated or chained rows can severely affect performance. <br>
Any statements that query, update or create chained rows will be adding I/O overhead to the system, <br>
impacting performance. Development suggests that you quickly identify and rectify situations <br>
involving chained rows. <br>
Chained rows can also add overhead to the performance of indexes and full-table scans.',
      p_solution               => 'See [122020/KB149706] Row Chaining and Row Migration',
      p_success_msg            => 'No issue found. This means Success',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: ASCP_CHAIN_ROWS_PERCENT');



debug('begin add_signature: OPTIMIZER_INDEX_CACHING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5220',
      p_sig_id                 => 'OPTIMIZER_INDEX_CACHING',
   ...
   where lower(name) = ''optimizer_index_caching'' and nvl(value,''0'') not between ''74'' and ''101''',
      p_title                  => 'Verify optimizer_index_caching',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This is the output of the parameter OPTIMIZER_INDEX_CACHING.  Default is 100%.',
      p_solution               => '50% makes the index access path look half as expensive.<br>
We are checking the value < 75 or > 100.<br>
See [1474966/KB81126] Potential Ramifications of OPTIMIZER_INDEX_CACHING parameter<br>
See [62286.1] Init.ora Parameter "OPTIMIZER_INDEX_CACHING" Reference Note ',
      p_success_msg            => 'No issue found. This means Success',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: OPTIMIZER_INDEX_CACHING');



debug('begin add_signature: OPTIMIZER_INDEX_COST_ADJ');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5211',
      p_sig_id                 => 'OPTIMIZER_INDEX_COST_ADJ',
      p_sig_sql                => 'select value "Not set to recommendation"
from v$parameter
where lower(name) = ''optimizer_index_cost_adj'' and nvl(value,0) not between ''24'' and ''51''',
      p_title                  => 'Verify optimizer_index_cost_adj',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Default 100% - the optimizer evaluates index access at the regular cost.',
      p_solution               => '50% makes the index access path look half as expensive. Normal is between 25 and 50.<br>
We are checking the value < 25 or > 50.<br>
See [62285/KB563613] Init.ora Parameter OPTIMIZER_INDEX_COST_ADJ Reference Note',
      p_success_msg            => 'No issue found. This means Success',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: OPTIMIZER_INDEX_COST_ADJ');



debug('begin add_signature: _B_TREE_BITMAP_PLANS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5223',
      p_sig_id                 => '_B_TREE_BITMAP_PLANS',
      p_sig_sql                => 'select value "Not set to recommendation"
from v$parameter
where lower(name) = ''_b_tree_bitmap_plans'' and trim(nvl(value, null)) != ''FALSE''',
      p_title                  => 'Verify _b_tree_bitmap_plans',
      p_fail_condition         => '[Not set to recommendation] != ['']',
      p_problem_descr          => 'Verify _b_tree_bitmap_plans',
      p_solution               => 'Default TRUE.  We recommend FALSE. <br>
<br>
See [174605/KB707933] bde_chk_cbo.sql - EBS initialization parameters - Healthcheck',
      p_success_msg            => 'No issue found. This means Success',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: _B_TREE_BITMAP_PLANS');



debug('begin add_signature: ASCP_LOCKED_DATABASE_OBJECTS');
   l_info('##MASK##1'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5225',
      p_sig_id                 => 'ASCP_LOCKED_DATABASE_OBJECTS',
      p_sig_sql                => 'SELECT a.username,
       a.sid,
       a.serial#,
       b.id1,
       c.sql_text
...
WHERE b.id1 IN (SELECT DISTINCT e.id1 FROM v$session d, v$lock e
   ...
   AND b.request =0',
      p_title                  => 'Locked Database Objects',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This is the output of the indentify locks SQL',
      p_solution               => 'See [18245/KB186543], OERR: ORA-54 resource busy and acquire with NOWAIT specified.<br>
...
alter system set events = ''54 trace name errorstack forever, level 10''',
      p_success_msg            => 'There are no locked database objects at this time',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ASCP_LOCKED_DATABASE_OBJECTS');



debug('begin add_signature: TABLE_HEALTH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5226',
      p_sig_id                 => 'TABLE_HEALTH',
      p_sig_sql                => 'SELECT table_name "Table Name",
   ...
   AND    owner = ''##$$MYSCHEMA$$##''
   AND    table_name in (''MSC_SYSTEM_ITEMS'', ''MSC_ITEM_CATEGORIES'', ''MSC_ITEM_CATEGORIES'', ''MSC_COMPONENT_SUBSTITUTES'', ''MSC_COMPONENT_SUBSTITUTES'', ''MSC_BOMS'', ''MSC_BOM_COMPONENTS'', ''MSC_ROUTINGS'', ''MSC_OPERATION_COMPONENTS'', ''MSC_ROUTING_OPERATIONS'', ''MSC_PROCESS_EFFECTIVITY'', ''MSC_OPERATION_RESOURCES'', ''MSC_DEMANDS'', ''MSC_SUPPLIES'', ''MSC_SALES_ORDERS'', ''MSC_SOURCING_RULES'', ''MSC_ASSIGNMENT_SETS'', ''MSC_TRADING_PARTNERS'', ''MSC_TRADING_PARTNER_SITES'', ''MSC_INSTANCE_ORGS'')
   ...
   AND    table_name <> ''MDP_LOAD_ASSIST''',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Table Health Report',
      p_solution               => 'If statistics are not current, this data may be flawed. <br>
<br>
If you are using Automatic Segment Space Management (ASSM), the database ignores attempts to change the PCTFREE and PCTUSED setting. <br>
If the chain count is greater that 20% consider analyzing the table.<br> 
<br>
See [1187723/KB150487] Master Note for Automatic Storage Management (ASM)<br>
<br>
...
See [1958707/KB197392] Proactive Services Known VCP / ASCP Implementation Procedures: Collections, Profiles, Performance, Hooks, Continuous Collections, Snapshot MLOG$ Maintenance and Management',
   ...
   l_info.delete;
debug('end add_signature: TABLE_HEALTH');



debug('begin add_signature: CLUSTER_FACTOR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5217',
      p_sig_id                 => 'CLUSTER_FACTOR',
      p_sig_sql                => 'SELECT ui.index_name "Index Name",
...
rows are ordered according to the PK. Lower percent values indicate a need to reorder the table in PK order.',
      p_solution               => 'Please see [1459344.1] Get Proactive with Oracle Database Diagnostic Tools',
      p_success_msg            => 'No issue found. This means Success',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLUSTER_FACTOR');



debug('begin add_signature: FRAGMENTATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5233',
      p_sig_id                 => 'FRAGMENTATION',
      p_sig_sql                => 'select table_name "Table Name",
round((blocks*8),2)||''kb'' "Fragmented size",
round((num_rows*avg_row_len/1024),2)||''kb'' "Actual size",
round((blocks*8),2)-round((num_rows*avg_row_len/1024),2)||''kb'' "Reclaim Size",
round(((round((blocks*8),2)-round((num_rows*avg_row_len/1024),2))/round((blocks*8),2))*100 -10, 2) "Space Save PCT"
from dba_tables
where upper(table_name) in (''MSC_SYSTEM_ITEMS'', ''MSC_ITEM_CATEGORIES'', ''MSC_ITEM_CATEGORIES'', ''MSC_COMPONENT_SUBSTITUTES'',
''MSC_COMPONENT_SUBSTITUTES'', ''MSC_BOMS'', ''MSC_BOM_COMPONENTS'', ''MSC_ROUTINGS'', ''MSC_OPERATION_COMPONENTS'',
''MSC_ROUTING_OPERATIONS'',''MSC_PROCESS_EFFECTIVITY'', ''MSC_OPERATION_RESOURCES'', ''MSC_DEMANDS'', ''MSC_SUPPLIES'', ''MSC_SALES_ORDERS'', ''MSC_SOURCING_RULES'', 
''MSC_ASSIGNMENT_SETS'', ''MSC_TRADING_PARTNERS'', ''MSC_TRADING_PARTNER_SITES'', ''MSC_INSTANCE_ORGS'')',
      p_title                  => 'ASCP Database Objects Monitoring and RDBMS Overall Health',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'ASCP Database Objects Monitoring and RDBMS Overall Health.',
      p_solution               => 'Do you have space that can be recovered?<br>
See [186826/KB81602] Various Aspects of Fragmentation',
      p_success_msg            => 'No issue found. This means Success',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: FRAGMENTATION');



debug('begin add_signature: EXTENT_MANAGEMENT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5234',
      p_sig_id                 => 'EXTENT_MANAGEMENT',
      p_sig_sql                => 'select extent_management "Ext_Manage",
       allocation_type "Alloc_Type",
       segment_space_management "SPC_Manage",
       substr(c.tablespace_name,1,25) "Name",
       nvl(GB_alloc,0) "Gbytes", 
       round((nvl(GB_alloc,0) - nvl(GB_free,0)),2) "Used",
       nvl(GB_free,0) "Free",
       round(((nvl(GB_alloc,0) - nvl(GB_free,0))/ nvl(GB_alloc,0))*100, 2) "PCT_Used",
       nvl(largest_GB,0) "Largest",
       nvl(GB_max, nvl(GB_alloc,0)) "Max_Size"
   ...
   order by 1',
      p_title                  => 'Value Chain Planning Freespace by Tablespace',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Value Chain Planning Freespace by Tablespace',
      p_solution               => 'See [181272/KB149857] DB_FILE_MULTIBLOCK_READ_COUNT AND EXTENTS MANAGEMENT
See [1493350/KB91037] Master Note: Overview of Oracle Tablespace Management',
      p_success_msg            => 'No issue found. This means Success',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EXTENT_MANAGEMENT');



debug('begin add_signature: DBA_TAB_PRIVS');
   l_info('##MASK##1'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##2'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5228',
      p_sig_id                 => 'DBA_TAB_PRIVS',
      p_sig_sql                => 'select GRANTEE,
          OWNER,
          PRIVILEGE,
          GRANTABLE
   FROM DBA_TAB_PRIVS 
   where grantee = ''##$$MYSCHEMA$$##''',
      p_title                  => 'Verify Privileges Granted',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Verify Privileges Granted',
      p_solution               => 'Review the privileges granted.<br>
See [1081971/KB571183] Value Chain Planning, Discrete and Process Manufacturing Product Resource Guide',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: DBA_TAB_PRIVS');



debug('begin add_signature: LOG_SWITCH_PROFILE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5277',
      p_sig_id                 => 'LOG_SWITCH_PROFILE',
      p_sig_sql                => 'SELECT
...
ORDER BY SUBSTR(TO_CHAR(first_time, ''MM/DD/RR HH:MI:SS''),1,5) desc',
      p_title                  => 'Log Switch Profile',
      p_fail_condition         => 'RS',
      p_problem_descr          => ' ',
      p_solution               => 'Please review performance related profile documents. <br>
<br>
A checkpoint is when the database writes changed data to disk.  Until the write occurs the data is stored in the log.  TLOG_CHECKPOINT_INTERVAL, LOG_CHECKPOINT_TIMEOUT and redo log size<br>
and quantity regulate how often this activity occurs.  If the checkpoint occurs infrequently it will take longer to recover the database in the event of a crash.  This is because the<br>
recovery process would have to apply more data from the redo logs.  If the checkpoint occurs too often the database can be overwhelmed with various background processes that become a<br>
bottleneck.  Oracle recommends 4-5 log switches per hour.wo LOG_CHECKPOINT parameters you mention govern how often this activity occurs.<br>
Please see [1035935.6] Example of How To Resize the Online Redo Logfiles',
   ...
   l_info.delete;
debug('end add_signature: LOG_SWITCH_PROFILE');



debug('begin add_signature: REFRESH_COLLECTIONS_SNAPSHOTS');
   l_info('##MASK##2'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5246',
      p_sig_id                 => 'REFRESH_COLLECTIONS_SNAPSHOTS',
      p_sig_sql                => 'select fcr.request_id "Request ID",
          fcr.requested_by "Requested By",
...
from (select fcr1.request_id 
         ...
         where 1=1          start with fcr1.request_id in (select request_id 
                                      ...
                                      where trunc(cr.request_date) >=trunc(sysdate)-30
                                        ...
                                        and  fcpt.user_concurrent_program_name =''Refresh Collection Snapshots'')
 ...
 where fcr.request_id = x.request_id    and fcr.concurrent_program_id = fcp.concurrent_program_id
   ...
   Order by 1',
      p_title                  => 'Details of Refresh Collections Snapshots at SYSDATE - 30 Days',
      p_fail_condition         => 'RS',
      p_problem_descr          => ' ',
   ...
   l_info.delete;
debug('end add_signature: REFRESH_COLLECTIONS_SNAPSHOTS');
...
debug('begin add_signature: NET CHANGE SIMULATION PLANNER 64-BIT - 15 DAYS');
   l_info('##MASK##2'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7068',
      p_sig_id                 => 'NET CHANGE SIMULATION PLANNER 64-BIT - 15 DAYS',
      p_sig_sql                => 'select fcr.request_id "Request ID",
          fcr.requested_by "Requested By",
 substr(DECODE (FCR.DESCRIPTION, NULL, FCPTL.USER_CONCURRENT_PROGRAM_NAME, (FCR.DESCRIPTION||'' ''||FCPTL.USER_CONCURRENT_PROGRAM_NAME)),1,80) "Program Name",
round((fcr.actual_completion_date - fcr.actual_start_date)*1440,2) "Time Comp",
...
fcr.status_code "Status",
to_char(fcr.request_date,''DD-MON-YYYY HH24:MI:SS'') "Request Date",
round((fcr.actual_start_date - fcr.request_date)*1440,2) "Start Date",
to_char(fcr.actual_start_date,''DD-MON-YYYY HH24:MI:SS'') "Start Date",
to_char(fcr.actual_completion_date, ''DD-MON-YYYY HH24:MI:SS'') "Comp Date",
fcr.argument_text "Arguments"
from (select fcr1.request_id
         ...
         where 1=1          start with fcr1.request_id in (select request_id
                                      ...
                                      where trunc(cr.request_date) >=trunc(sysdate)-15
                                         and cr.concurrent_program_id=cp.concurrent_program_id
                                        and cp.concurrent_program_id=fcpt.concurrent_program_id
                                        and  fcpt.user_concurrent_program_name like ''Net Change Simulation Planner 64-bit%'')
      connect by prior fcr1.request_id = fcr1.parent_request_id) x,
       fnd_concurrent_requests fcr, fnd_concurrent_programs fcp,fnd_concurrent_programs_tl fcptl
 where fcr.request_id = x.request_id    and fcr.concurrent_program_id = fcp.concurrent_program_id
   and fcr.program_application_id = fcp.application_id  and fcp.application_id = fcptl.application_id
   and fcp.concurrent_program_id = fcptl.concurrent_program_id and fcptl.language = ''US''
   Order by 1',
      p_title                  => 'Verify Net Change Simulation Planner 64-bit runtime for last 15 days',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Verify Net Change Simulation Planner 64-bit runtime for last 15 days.
MSCNCPS64 module: Net Change Simulation Planner 64-bit SUN
MSONCPL64 module: Net Change Simulation Planner 64-bit Linux
',
      p_solution               => 'See [1361221/FAQ2366] Release 12.2.x Oracle Value Chain Planning Installation Notes - Known Issues, FAQ and Latest Patch Information
and [1943946/KB632721] Net Change Simulation Planner 64-bit Linux Planning Processes Errors Out After Update From Material Plan',
      p_success_msg            => 'See [1361221/FAQ2366] Release 12.2.x Oracle Value Chain Planning Installation Notes - Known Issues, FAQ and Latest Patch Information
and [1943946/KB632721] Net Change Simulation Planner 64-bit Linux Planning Processes Errors Out After Update From Material Plan',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: NET CHANGE SIMULATION PLANNER 64-BIT - 15 DAYS');



debug('begin add_signature: NET CHANGE SIMULATION PLANNER 64-BIT - 30 DAYS');
   l_info('##MASK##2'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7069',
      p_sig_id                 => 'NET CHANGE SIMULATION PLANNER 64-BIT - 30 DAYS',
      p_sig_sql                => 'select fcr.request_id "Request ID",
          fcr.requested_by "Requested By",
 substr(DECODE (FCR.DESCRIPTION, NULL, FCPTL.USER_CONCURRENT_PROGRAM_NAME, (FCR.DESCRIPTION||'' ''||FCPTL.USER_CONCURRENT_PROGRAM_NAME)),1,80) "Program Name",
round((fcr.actual_completion_date - fcr.actual_start_date)*1440,2) "Time Comp",
...
from (select fcr1.request_id
 ...
 where fcr.request_id = x.request_id    and fcr.concurrent_program_id = fcp.concurrent_program_id
   ...
   and fcp.concurrent_program_id = fcptl.concurrent_program_id and fcptl.language = ''US''
   Order by 1',
      p_title                  => 'Verify Net Change Simulation Planner 64-bit runtime for last 30 days',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Verify Net Change Simulation Planner 64-bit runtime for last 30 days.
MSCNCPS64 module: Net Change Simulation Planner 64-bit SUN
MSONCPL64 module: Net Change Simulation Planner 64-bit Linux
',
      p_solution               => 'See [1361221/FAQ2366] Release 12.2.x Oracle Value Chain Planning Installation Notes - Known Issues, FAQ and Latest Patch Information
...
and [1943946/KB632721] Net Change Simulation Planner 64-bit Linux Planning Processes Errors Out After Update From Material Plan',
   ...
   l_info.delete;
debug('end add_signature: NET CHANGE SIMULATION PLANNER 64-BIT - 30 DAYS');
...
debug('begin add_signature: REALIGN_OPERATIONAL_DATA_STORES_DATES');
   l_info('##MASK##2'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5266',
      p_sig_id                 => 'REALIGN_OPERATIONAL_DATA_STORES_DATES',
      p_sig_sql                => 'select fcr.request_id "Request ID",
          fcr.requested_by "Requested By",
 substr(DECODE (FCR.DESCRIPTION, NULL, FCPTL.USER_CONCURRENT_PROGRAM_NAME, (FCR.DESCRIPTION||'' ''||FCPTL.USER_CONCURRENT_PROGRAM_NAME)),1,80) "Program Name", 
round((fcr.actual_completion_date - fcr.actual_start_date)*1440,2) "Time Comp",
...
from (select fcr1.request_id 
         ...
         where 1=1          start with fcr1.request_id in (select request_id 
                                      ...
                                      where trunc(cr.request_date) >=trunc(sysdate)-30
                                         and cr.concurrent_program_id=cp.concurrent_program_id
                                        and cp.concurrent_program_id=fcpt.concurrent_program_id
                                        and  fcpt.user_concurrent_program_name =''Realign Operational Data Stores Dates'')
      connect by prior fcr1.request_id = fcr1.parent_request_id) x,
       fnd_concurrent_requests fcr, fnd_concurrent_programs fcp,fnd_concurrent_programs_tl fcptl
 where fcr.request_id = x.request_id    and fcr.concurrent_program_id = fcp.concurrent_program_id
   and fcr.program_application_id = fcp.application_id  and fcp.application_id = fcptl.application_id
   and fcp.concurrent_program_id = fcptl.concurrent_program_id and fcptl.language = ''US''
   Order by 1',
      p_title                  => 'Verify Launch of Realign Operational Data Stores Dates Concurrent Programs runtime for last 30 days',
      p_fail_condition         => 'RS',
      p_problem_descr          => ' ',
      p_solution               => 'See [137293/KB742426] How to Manage APS Partitions in the MSC Schema <br>
and [145419/KB679714] How to Setup and Run Data Collections',
   ...
   l_info.delete;
debug('end add_signature: REALIGN_OPERATIONAL_DATA_STORES_DATES');
...
debug('begin add_signature: COPY_STAGING_TO_RAPID_PLANNING_INSTANCE');
   l_info('##MASK##2'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5271',
      p_sig_id                 => 'COPY_STAGING_TO_RAPID_PLANNING_INSTANCE',
      p_sig_sql                => 'select fcr.request_id "Request ID",
          fcr.requested_by "Requested By",
 substr(DECODE (FCR.DESCRIPTION, NULL, FCPTL.USER_CONCURRENT_PROGRAM_NAME, (FCR.DESCRIPTION||'' ''||FCPTL.USER_CONCURRENT_PROGRAM_NAME)),1,80) "Program Name", 
round((fcr.actual_completion_date - fcr.actual_start_date)*1440,2) "Time Comp",
...
from (select fcr1.request_id 
         ...
         where 1=1          start with fcr1.request_id in (select request_id 
                                      ...
                                      where trunc(cr.request_date) >=trunc(sysdate)-30
                                         and cr.concurrent_program_id=cp.concurrent_program_id
                                        and cp.concurrent_program_id=fcpt.concurrent_program_id
                                        and  fcpt.user_concurrent_program_name =''Copy Staging tables to Rapid Planning instance'')
      connect by prior fcr1.request_id = fcr1.parent_request_id) x,
       fnd_concurrent_requests fcr, fnd_concurrent_programs fcp,fnd_concurrent_programs_tl fcptl
 where fcr.request_id = x.request_id    and fcr.concurrent_program_id = fcp.concurrent_program_id
   and fcr.program_application_id = fcp.application_id  and fcp.application_id = fcptl.application_id
   and fcp.concurrent_program_id = fcptl.concurrent_program_id and fcptl.language = ''US''
   Order by 1',
      p_title                  => 'Verify Launch of Copy Staging tables to Rapid Planning instance Concurrent Programs runtime for last 30 days',
      p_fail_condition         => 'RS',
      p_problem_descr          => ' ',
      p_solution               => 'See [137293/KB742426] How to Manage APS Partitions in the MSC Schema <br>
and [145419/KB679714] How to Setup and Run Data Collections',
   ...
   l_info.delete;
debug('end add_signature: COPY_STAGING_TO_RAPID_PLANNING_INSTANCE');
...
BEGIN
  ...
  analyzer_title := 'ASCP Performance Analyzer';
...
debug('begin section: Your_Environment');
start_section('Your Environment', 'Your_Environment');
   set_item_result(run_stored_sig('ASCP_INVALIDS'));
   set_item_result(run_stored_sig('CLUSTER_ENABLED'));
   set_item_result(run_stored_sig('ENVIRONMENT_REPORT'));
   set_item_result(run_stored_sig('INSTANCE_REPORT2'));
   set_item_result(run_stored_sig('NLS_DATE_FORMAT_CHECK'));
   set_item_result(run_stored_sig('UNUSABLE_PLAN_PARTITIONS'));
end_section;
debug('end section: Your_Environment');

debug('begin section: Source_Instance_Data');
start_section('Source and Destination Data Check', 'Source_Instance_Data');
...
end_section;
debug('end section: Source_Instance_Data');

debug('begin section: Parameters');
start_section('Parameters', 'Parameters');
   set_item_result(run_stored_sig('ASCP_PERFORMANCE_PROFILES'));
   set_item_result(run_stored_sig('MAXIMUM_DEMANDS_PER_SLICE'));
   set_item_result(run_stored_sig('MAXIMUM_PULL_OPERATION'));
   set_item_result(run_stored_sig('MAXIMUM_NBR_PREPONES'));
   set_item_result(run_stored_sig('MSC_SEQ_CACHE'));
end_section;
debug('end section: Parameters');

debug('begin section: RDBMS');
start_section('RDBMS', 'RDBMS');
   set_item_result(run_stored_sig('SEGMENT_TABLESPACE_CHECK'));
   set_item_result(run_stored_sig('DEFRAG_CHECK'));
   set_item_result(run_stored_sig('ASCP_CHAIN_ROWS_PERCENT'));
   ...
   set_item_result(run_stored_sig('ASCP_LOCKED_DATABASE_OBJECTS'));
   set_item_result(run_stored_sig('TABLE_HEALTH'));
   set_item_result(run_stored_sig('CLUSTER_FACTOR'));
   set_item_result(run_stored_sig('FRAGMENTATION'));
   set_item_result(run_stored_sig('EXTENT_MANAGEMENT'));
   set_item_result(run_stored_sig('DBA_TAB_PRIVS'));
   set_item_result(run_stored_sig('LOG_SWITCH_PROFILE'));
end_section;
debug('end section: RDBMS');

debug('begin section: Collections');
start_section('Collections', 'Collections');
   set_item_result(run_stored_sig('REFRESH_COLLECTIONS_SNAPSHOTS'));
...
end_section;
debug('end section: Collections');

debug('begin section: Planning');
start_section('Planning', 'Planning');
   ...
   set_item_result(run_stored_sig('NET CHANGE SIMULATION PLANNER 64-BIT - 15 DAYS'));
   set_item_result(run_stored_sig('NET CHANGE SIMULATION PLANNER 64-BIT - 30 DAYS'));
...
end_section;
debug('end section: Planning');

debug('begin section: Miscellaneous');
start_section('Miscellaneous', 'Miscellaneous');
   ...
   set_item_result(run_stored_sig('REALIGN_OPERATIONAL_DATA_STORES_DATES'));
   set_item_result(run_stored_sig('PURGE_COLLAB_HISTORY'));
   set_item_result(run_stored_sig('SUPPLY_CHAIN_EVENT_MANAGER'));
   set_item_result(run_stored_sig('COPY_STAGING_TO_RAPID_PLANNING_INSTANCE'));
end_section;
debug('end section: Miscellaneous');
