...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Cost Management COGS/DCOGS Analyzer    |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE CST_COGS_analyzer_pkg AUTHID DEFINER AS
...
PROCEDURE main
(            p_COGS_issue                   IN VARCHAR2    DEFAULT NULL
           ...
           ,p_max_output_rows              IN NUMBER      DEFAULT 300
...
END CST_COGS_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY CST_COGS_analyzer_pkg AS
-- $Id: cst_cogs_trx_analyzer.sql, 200.15 2026/01/27 14:25:25 sothman Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2453170.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'CSTCOGS_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'CSTCOGS_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>CSTCOGS Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2453170.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/cogs_trx_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1174,EBS,EBS MFG,EBS - Discrete MFG Execution and Financials" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1174,EBS,EBS MFG,EBS - Discrete MFG Execution and Financials" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1174,EBS,EBS MFG,EBS - Discrete MFG Execution and Financials" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4189035" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">1174</span>
...
<p>Enhanced Row Selection and Scrolling Functionality<br>
We are pleased to announce the introduction of a new feature designed to improve the user experience when interacting with large datasets. This enhancement allows for seamless scrolling and highlighting of selected rows, even when dealing with tables containing many columns.<br>
Key Benefits:<br>
•&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; Improved readability: When selecting a row, the highlighted selection will remain visible as you scroll horizontally, enabling you to easily read and analyze the data.<br>
•&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; Enhanced navigation: This feature facilitates efficient navigation through large datasets, allowing you to quickly identify and focus on specific information.<br>
•&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; Streamlined data analysis: By maintaining the highlighted selection as you scroll, you can effortlessly compare and analyze data across multiple columns.<br>
This new feature is designed to provide a more intuitive and user-friendly experience, enabling you to work more efficiently with your data.</p><p>Other improvements:<br>
•&nbsp;&nbsp;&nbsp;&nbsp;Improved Identification Signatures: We have made several adjustments to our identification signatures to ensure that the rows returned are accurate and reliable. These updates will help to reduce errors and improve overall data quality.<br>
•&nbsp;&nbsp;&nbsp;&nbsp;Enhanced Solution Clarity: We have also made improvements to several solutions to provide clearer, step-by-step instructions for resolving data conditions. These updates will help to simplify the process of addressing data issues and improve overall user experience.</p>
            <br><br>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1174,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Discrete MFG Execution and Financials" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1174,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Discrete MFG Execution and Financials" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
...
BEGIN
    ...
    print_log('Processing recommended patches signature: CST_REC_PATCHS (check_rec_patches_1) "Recommended Patches" (version 7)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(1)(l_rows) := '24426019';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'PERFORMANCE ISSUE DURING EXECUTION OF GENERATE COGS RECOG EVENTS';
   l_col_rows(5)(l_rows) := '[1213663.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '24411619';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'VERY BAD PERFORMANCE IN PERIOD CLOSE RECONCILIATION REPORT';
   l_col_rows(5)(l_rows) := '[1213663.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21948003';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'BOM:RECOMMENDED PATCH COLLECTION ON 12.2.X UPTO OCT/2015';
   l_col_rows(5)(l_rows) := '[1213663.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25981806';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'BOM:12.1.3+ RECOMMENDED PATCHES TO BE ADDED TO THE PRODUCT RPC AS OF MAY-1-2017';
   l_col_rows(5)(l_rows) := '[1213663.1]';
...
Best Practice: Always ensure that you are on the latest code with all recommended patches applied. This will help avoid known issues, prevent potential data corruption and provide the latest features and functionality. Having a proactive patching plan and periodic proactive patching process in place are the best ways to stay current.';
   l_sig.success_msg := 'All checks passed. All recommended patches applied.';
  ...
  -- Register
  l_step := '60';
  g_signatures('CST_REC_PATCHS') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'CST_REC_PATCHS',     -- sig ID
...
FUNCTION get_Ledger_id
   return VARCHAR2 IS
BEGIN
debug('begin sql token function: Ledger_id');
...
END IF;
debug('end sql token function: Ledger_id');
END get_Ledger_id;
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'COGS Issue';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_COGS_issue,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Sales Order Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_order_number,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Start Date';
   g_parameters(g_parameters.LAST).pvalue := mask_text(to_char(p_from_date,'DD-MON-YYYY'),'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'End Date';
   g_parameters(g_parameters.LAST).pvalue := mask_text(to_char(p_to_date,'DD-MON-YYYY'),'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/01/27 14:25:24 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'cst_cogs_trx_analyzer.sql';
...
debug('begin parameter validation: p_COGS_issue');
IF p_COGS_issue IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter COGS Issue is required.');
   raise invalid_parameters;
END IF;
IF p_COGS_issue IS NOT NULL AND p_COGS_issue NOT IN ( 'N','Y') THEN
   print_error('INVALID ARGUMENT: Incorrect "COGS Issue" Check Parameter.
Values should be either Y or N.');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_COGS_issue');
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Sales Order Number parameter provided. Process cannot continue.
Please enter a valid Sales Order number and rerun the analyzer.');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
WHERE SP.ORGANIZATION_ID = p_organization_id and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Please enter a valid Organization ID (MTL_PARAMETERS.organization_id). ');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
INTO l_exists_val
FROM GL_LEDGERS L
WHERE L.LEDGER_ID = P_LEDGER_ID2 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Ledger ID specified. Please re-run this analyzer and provide a valid Ledger ID for the Org ID specified. ');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
-- Gather Organization_id entered
l_step := '40';
  IF p_organization_id is null THEN
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$ORDERNUM$$##') := p_order_number;
   g_masked_tokens('##$$ORDERNUM$$##') := mask_text( g_sql_tokens('##$$ORDERNUM$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM1$$##') := '602';
   g_masked_tokens('##$$APPS_PARAM1$$##') := mask_text( g_sql_tokens('##$$APPS_PARAM1$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM2$$##') := '707';
   ...
   g_sql_tokens('##$$Start_Date$$##') := p_from_date;
   g_masked_tokens('##$$Start_Date$$##') := mask_text( g_sql_tokens('##$$Start_Date$$##'), 'NO_MASK');
   g_sql_tokens('##$$End_Date$$##') := p_to_date;
   g_masked_tokens('##$$End_Date$$##') := mask_text( g_sql_tokens('##$$End_Date$$##'), 'NO_MASK');
   g_sql_tokens('##$$COGS_Issues$$##') := p_COGS_issue;
   g_masked_tokens('##$$COGS_Issues$$##') := mask_text( g_sql_tokens('##$$COGS_Issues$$##'), 'NO_MASK');
   g_sql_tokens('##$$Ledger_id$$##') := get_Ledger_id();
   l_system_function_var := null;
   g_masked_tokens('##$$Ledger_id$$##') := mask_text( g_sql_tokens('##$$Ledger_id$$##'), 'NO_MASK');
   g_sql_tokens('##$$Organization_id$$##') := to_char(p_organization_id);
   g_masked_tokens('##$$Organization_id$$##') := mask_text( g_sql_tokens('##$$Organization_id$$##'), 'NO_MASK');
...
debug('begin add_signature: CST_INVENTORY_ORGANIZATIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8436',
      p_sig_id                 => 'CST_INVENTORY_ORGANIZATIONS',
      p_sig_sql                => 'SELECT organization_id org_id, 
       ...
       master_organization_id master_org,
       default_cost_group_id cost_group,
       decode(general_ledger_update_code,
              1, ''Yes'',
              2, ''No'')GL_T,
       ...
       decode(wms_enabled_flag,
              ''Y'', ''Yes'',
              ''N'', ''No'') Warehouse_Management,
       to_char(cost_cutoff_date,''dd-mon-rrrr'') cost_cutoff_date,
       decode(eam_enabled_flag,
              ''Y'',''Yes'',
              ''N'',''No'') Enterprise_Asset_Mgmt,
       ...
       decode(NEGATIVE_INV_RECEIPT_CODE,
              1, ''Yes'',
              2, ''No'') Neg_MOQ,
       decode(PROCESS_ENABLED_FLAG,
              ''Y'', ''Yes'',
              ''N'', ''No'') Process_MFG,
       decode(lcm_enabled_flag,
              ''Y'', ''Yes'',
              ''N'', ''No'') Landed_Cost,
  ...
  ORDER BY organization_id',
      p_title                  => 'Inventory Organizations',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the organization details from the MTL_PARAMETERS table, with the corresponding costing method.',
      p_solution               => '',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: CST_INVENTORY_ORGANIZATIONS');



debug('begin add_signature: CST_ORGANIZATION_ACCOUNTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8443',
      p_sig_id                 => 'CST_ORGANIZATION_ACCOUNTS',
      p_sig_sql                => 'select organization_code Org_Code,
 ...
 order by organization_code',
      p_title                  => 'Inventory Organizations Account',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the organization accounts detail. ',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CST_ORGANIZATION_ACCOUNTS');



debug('begin add_signature: CST_PROFILE_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8437',
      p_sig_id                 => 'CST_PROFILE_OPTIONS',
      p_sig_sql                => 'select fpo.user_profile_option_name Profile,fpv.profile_option_value Value 
  ...
  order by fpv.application_id , fpo.user_profile_option_name',
      p_title                  => 'Costing & BOM Profile Options',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the Costing (CST) and Bill of Material (BOM) profile options. 
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: CST_PROFILE_OPTIONS');



debug('begin add_signature: CST_ORG_ACCT_PERIODS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8438',
      p_sig_id                 => 'CST_ORG_ACCT_PERIODS',
      p_sig_sql                => 'select ACCT_PERIOD_ID,ORGANIZATION_ID, LAST_UPDATE_DATE,PERIOD_YEAR, PERIOD_NUM, PERIOD_NAME, PERIOD_START_DATE, 
 SCHEDULE_CLOSE_DATE, PERIOD_CLOSE_DATE, OPEN_FLAG, SUMMARIZED_FLAG
from org_acct_periods 
where PERIOD_START_DATE > sysdate - 365
Order by ORGANIZATION_ID,PERIOD_START_DATE',
      p_title                  => 'Organization Accounting Periods',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the organization periods for the last 365 days.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: CST_ORG_ACCT_PERIODS');



debug('begin add_signature: CST_COST_MANAGER_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9970',
      p_sig_id                 => 'CST_COST_MANAGER_STATUS',
      p_sig_sql                => 'SELECT
  x.PROCESS_TYPE "Name",
  decode((select ''1''
...
FROM (
  ...
  FROM
  MTL_INTERFACE_PROC_CONTROLS MIPC,
  MFG_LOOKUPS A
  WHERE
...
ORDER BY 1',
      p_title                  => 'Process Transaction Interface Managers',
      p_fail_condition         => '[Status]=[Inactive]',
      p_problem_descr          => 'There are inactive Inventory related transaction managers.  
',
      p_solution               => 'You need to process the inactive managers.<br>
Review the following documents for more information:<br>
[1631453/KB328431] - INCTCM / INCTCW : How to Schedule Inventory Transaction Manager (Process Transaction Interface)<br>
[304313/KB197216] Understanding Cost Manager.
',
      p_success_msg            => 'All Inventory related Transaction Managers are active.',
   ...
   l_info.delete;
debug('end add_signature: CST_COST_MANAGER_STATUS');



debug('begin add_signature: CST_SHIPPING_NETWORK_PARAMETERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8442',
      p_sig_id                 => 'CST_SHIPPING_NETWORK_PARAMETERS',
      p_sig_sql                => 'select a.FROM_ORGANIZATION_ID, b.organization_code "FROM_ORG_CODE"
, a.TO_ORGANIZATION_ID, c.organization_code "TO_ORG_CODE"
,a.INTRANSIT_TYPE, decode(a.INTRANSIT_TYPE, NULL, ''Blank'', ''1'', ''Direct'', ''2'', ''Intransit'', a.INTRANSIT_TYPE) "INTRANSIT_TYPE_TEXT" -- 2 Intransit, 1 Direct
,a.FOB_POINT, decode(a.FOB_POINT, NULL, ''Blank'', ''1'', ''Shipment'', ''2'', ''Receipt'', a.FOB_POINT) "FOB_POINT_TEXT"-- 2 Receipt, 1 Shipment
,a.ROUTING_HEADER_ID, decode(a.ROUTING_HEADER_ID, NULL, ''Blank'', ''1'', ''Standard'', ''2'', ''Inspection'', ''3'', ''Direct'', a.ROUTING_HEADER_ID) "ROUTING_TEXT" -- 1 Standard, 2 Inspection, 3 Direct
, decode (a.INTERNAL_ORDER_REQUIRED_FLAG, NULL, ''Blank'', ''1'', ''Y'', ''2'', ''N'', a.INTERNAL_ORDER_REQUIRED_FLAG) "INTERNAL_ORDER_REQUIRED_FLAG"
,a.ELEMENTAL_VISIBILITY_ENABLED, a.MANUAL_RECEIPT_EXPENSE,
    ...
    a.PROFIT_IN_INV_ACCOUNT
from MTL_INTERORG_PARAMETERS a, MTL_PARAMETERS b, MTL_PARAMETERS c
where a.FROM_ORGANIZATION_ID = b.organization_id
and a.TO_ORGANIZATION_ID = c.organization_id
order by 1, 3',
      p_title                  => 'Inter-Organization Shipping Network',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the shipping networks (also called the inter-organization parameters) for the organization.<br>
The Shipping Network defines the existing relationships between the shipping and destination organizations.<br><br>
Review the following documents for more information:<br>
<ul>
	  <li>[1664917/KB628074] IR-ISO and Drop Shipment Dataflow and Diagnostics</li>
          <li>[463472/FAQ6406]  FAQ-Intracompany Balancing in Release 12</li>
          <li>[1990679/KB721603] Manufacturing transactions and accounting in Discrete Manufacturing from cost management perspective -IR/ISO </li></ul>
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: CST_SHIPPING_NETWORK_PARAMETERS');



debug('begin add_signature: CST_PJM_ENABLED_ORGS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8439',
      p_sig_id                 => 'CST_PJM_ENABLED_ORGS',
      p_sig_sql                => 'SELECT organization_id, organization_code
FROM mtl_parameters
WHERE project_reference_enabled = ''1''
Order By organization_id',
      p_title                  => 'Project Manufacturing (PJM) Enabled Organizations',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the organizations enabled for Project Manufacturing (PJM)',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CST_PJM_ENABLED_ORGS');



debug('begin add_signature: CST_PJM_ORG_PARAMETERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8440',
      p_sig_id                 => 'CST_PJM_ORG_PARAMETERS',
      p_sig_sql                => 'Select ORGANIZATION_ID, CREATION_DATE, LAST_UPDATE_DATE, PROJECT_REFERENCE_ENABLED PJM_Enabled,
PROJECT_CONTROL_LEVEL, COMMON_PROJECT_ID, ALLOW_CROSS_PROJ_ISSUES Cross_Project, ALLOW_CROSS_UNITNUM_ISSUES Cross_Unit_Num,
PAYBACK_MAT_VAR_ACCOUNT, 
PAYBACK_MOH_VAR_ACCOUNT,PAYBACK_RES_VAR_ACCOUNT, 
...
Order By ORGANIZATION_ID',
      p_title                  => 'Project Manufacturing (PJM) Organization Parameters',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the project organization parameters with information of the project enabled organizations.<br>
The details include how projects and tasks are included in transactions, as well as cross project transfers and picking.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: CST_PJM_ORG_PARAMETERS');



debug('begin add_signature: CST_WIP_ORG_PARAMETERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8441',
      p_sig_id                 => 'CST_WIP_ORG_PARAMETERS',
      p_sig_sql                => 'Select ORGANIZATION_ID, LAST_UPDATE_DATE, CREATION_DATE, DEFAULT_PULL_SUPPLY_SUBINV,
DEFAULT_DISCRETE_CLASS, 
decode (AUTO_COMPUTE_FINAL_COMPLETION,''1'',''Yes'',''2'',''No'') AUTO_COMPUTE_FINAL_COMPLETION,
COMPLETION_COST_SOURCE, 
COST_TYPE_ID,
SYSTEM_OPTION_ID,
INCLUDE_COMPONENT_YIELD
from WIP_PARAMETERS
Order By ORGANIZATION_ID',
      p_title                  => 'Work In Process (WIP) Organization Parameters',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the Work in Process (WIP) organization parameters.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CST_WIP_ORG_PARAMETERS');



debug('begin add_signature: CST_MTL_TRANSACTION_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13288',
      p_sig_id                 => 'CST_MTL_TRANSACTION_TYPES',
      p_sig_sql                => 'SELECT a.transaction_type_id,
...
DECODE(a.STATUS_CONTROL_FLAG, 1, ''Yes'', 2, ''No'', NULL, ''Blank'', ''Other'') status_flag_text
...
ORDER BY a.transaction_type_id',
      p_title                  => 'Related Transaction Types',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the transaction types related to the interface and pending data.<br>
Review [2524551/KB493492] Transaction Type Listing And SQL for more information on how these are used.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: CST_MTL_TRANSACTION_TYPES');



debug('begin add_signature: CST_COGS_SALES_ORDER_HEADER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11307',
      p_sig_id                 => 'CST_COGS_SALES_ORDER_HEADER',
 ...
 where ORD.ORDER_NUMBER =  ##$$ORDERNUM$$##
   ...
   and ORD.ORDER_TYPE_ID = TYP.TRANSACTION_TYPE_ID(+)',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Sales Order Header Details Information.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CST_COGS_SALES_ORDER_HEADER');



debug('begin add_signature: CST_COGS_ SALES ORDER LINE DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11154',
      p_sig_id                 => 'CST_COGS_ SALES ORDER LINE DETAILS',
      p_sig_sql                => 'SELECT ool.line_id,
       ool.org_id,
       ool.header_id,
       ool.line_number,
       ...
       substr(ool.ordered_item,1,50) ordered_item,
       to_char(ool.request_date,''DD-MON-YYYY HH24 : MI : SS'') request_date,
       to_char(ool.promise_date,''DD-MON-YYYY HH24 : MI : SS'') promise_date,
       to_char(ool.schedule_ship_date,''DD-MON-YYYY HH24 : MI : SS'') schedule_ship_date,
       ool.invoice_interface_status_code,
       ...
       ool.price_list_id,
       to_char(ool.pricing_date,''DD-MON-YYYY HH24 : MI : SS'') pricing_date,
       ool.shipment_number,
       ...
       ool.unit_list_price,
       ool.context,
       to_char(ool.last_update_date,''DD-MON-YYYY HH24 : MI : SS'') last_update_date,
       to_char(ool.creation_date,''DD-MON-YYYY HH24 : MI : SS'') creation_date,
       ool.request_id,
       ool.item_type_code,
       to_char(ool.actual_shipment_date,''DD-MON-YYYY HH24 : MI : SS'') actual_shipment_date,
       ool.customer_trx_line_id,
       ool.return_context,
       to_char(ool.actual_arrival_date,''DD-MON-YYYY HH24 : MI : SS'') actual_arrival_date,
       ool.return_reason_code,
       ool.invoiced_quantity,
       ool.reference_customer_trx_line_id,
       ool.revenue_amount,
       to_char(ool.fulfillment_date,''DD-MON-YYYY HH24 : MI : SS'') fulfillment_date,
       ool.subinventory,
       ool.original_inventory_item_id,
       ool.original_ordered_item_id,
       substr(ool.original_ordered_item,1,50) ORIGINAL_ORDERED_ITEM,
       ool.unit_cost,
       ool.original_list_price
  FROM oe_order_lines_all ool 
 where header_id in (select header_id from oe_order_headers_all where order_number=##$$ORDERNUM$$##)
 ORDER BY ool.header_id, ool.line_number',
      p_title                  => 'Sales Order Line Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'These are the sales order line details.',
      p_solution               => '1.Refer Column "Invoice_Interface_Status_Code".<br>
  ''Yes'' signifies Standard Sales Order and ''Not_Eligible'' signifies Ship Only sales order.<br><br>
2. Refer Column "REFERENCE_LINE_ID" and "REFERENCE_HEADER_ID".<br>
   If Reference line id and reference header id is NOT null, then it means there is a referenced RMA attached tho this specific Sales order.<br><br>
3.Refer Column "Flow Status".<br>
  If it is Closed, then it means the ship only sales order is closed.<br> 
...
',
   ...
   l_info.delete;
debug('end add_signature: CST_COGS_ SALES ORDER LINE DETAILS');



debug('begin add_signature: CST_COGS MMT DATA FOR COGS ISSUE');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##so_issue_account_type'):= 'left,#333333,#ffd6cc,bold';
  add_signature(
      p_sig_repo_id            => '11061',
      p_sig_id                 => 'CST_COGS MMT DATA FOR COGS ISSUE',
      p_sig_sql                => 'SELECT mmt.trx_source_line_id,
       mmt.transaction_id,
       mmt.so_issue_account_type,
       to_char(mmt.creation_date,''DD-MON-YYYY HH24 : MI : SS'') creation_date,
       to_char(mmt.last_update_date,''DD-MON-YYYY HH24 : MI : SS'') last_update_date,
       mmt.request_id,
       ...
       mmt.variance_amount,
       mmt.acct_period_id,
       substr(mmt.transaction_reference,1,50) transaction_reference,
       ...
       substr(mmt.error_code,1,80) error_code,
 ...
 WHERE mmt.trx_source_line_id IN
       (SELECT ool.line_id
          FROM oe_order_lines_all ool
         where header_id in (select header_id from oe_order_headers_all where order_number=##$$ORDERNUM$$##))
 ORDER BY mmt.trx_source_line_id, mmt.transaction_type_id',
      p_title                  => 'Transaction Details of Sales Order Issue and COGS Recognition',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transaction Details of Sales Order Issue and COGS Recognition are created
',
      p_solution               => 'MMT.SO_ISSUE_ACCOUNT_TYPE = 2, indicates Deferred COGS functionality is used.<br>
MMT.SO_ISSUE_ACCOUNT_TYPE = 1, indicates Deferred COGS functionality is not used.<br>
MMT.SO_ISSUE_ACCOUNT_TYPE = 1 can exists only for inventory transactions created in 11i where there is no concept of DCOGS.


',
      p_success_msg            => 'Transaction Details of Sales Order Issue and COGS Recognition are created.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CST_COGS MMT DATA FOR COGS ISSUE');



debug('begin add_signature: CST_COGS MTA DATA FOR COGS RECOGNITION ISSUE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11062',
      p_sig_id                 => 'CST_COGS MTA DATA FOR COGS RECOGNITION ISSUE',
      p_sig_sql                => 'SELECT mta.transaction_id,
       mta.reference_account,
       to_char(mta.last_update_date,''DD-MON-YYYY HH24 : MI : SS'') last_update_date,
       to_char(mta.creation_date,''DD-MON-YYYY HH24 : MI : SS'') creation_date,
       ...
       mta.rate_or_amount,
       mta.cost_element_id,
       to_char(mta.currency_conversion_date,''DD-MON-YYYY HH24 : MI : SS'') currency_conversion_date,
       mta.request_id,
       mta.gl_sl_link_id,
...
and header_id in (select header_id from oe_order_headers_all where order_number=##$$ORDERNUM$$##)))
  ORDER BY mta.transaction_id',
      p_title                  => 'Accounting Entries for Sales Order Issue and COGS Transactions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Sales Order inventory accounting details.


',
      p_solution               => 'For more information about the impact of the Revenue / COGS Matching cycle in inventory accounting please review [1307906/KB627708] COGS Dataflow and Diagnostics [Video].',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: CST_COGS MTA DATA FOR COGS RECOGNITION ISSUE');



debug('begin add_signature: CST_COGS CST_REVENUE_COGS_MATCH_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11064',
      p_sig_id                 => 'CST_COGS CST_REVENUE_COGS_MATCH_LINES',
      p_sig_sql                => 'SELECT crcml.cogs_om_line_id,
       crcml.revenue_om_line_id,
       crcml.original_shipped_qty,
       crcml.unit_cost,
       crcml.inventory_item_id,
       crcml.deferred_cogs_acct_id,
       crcml.cogs_acct_id,
       to_char(crcml.sales_order_issue_date,''DD-MON-YYYY HH24 : MI : SS'') sales_order_issue_date,
       crcml.pac_cost_type_id,
       crcml.ledger_id,
       ...
       to_char(crcml.creation_date,''DD-MON-YYYY HH24 : MI : SS'') creation_date,
       to_char(crcml.last_update_date,''DD-MON-YYYY HH24 : MI : SS'') last_update_date
  FROM cst_revenue_cogs_match_lines crcml
 WHERE crcml.cogs_om_line_id IN
       (SELECT ool.line_id
          FROM oe_order_lines_all ool
         where header_id in (select header_id from oe_order_headers_all where order_number=##$$ORDERNUM$$##))
 ORDER BY crcml.cogs_om_line_id',
      p_title                  => 'The Deferred COGS Account and COGS Account Information',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The relationship between COGS and revenue lines
',
      p_solution               => 'This table stores the relationship between COGS and revenue lines.<br>
Also stores the elemental and total unit costs for the item that is shipped originally by the sales order issue, as well as the COGS and deferred COGS accounts.<br><br>
1.DEFERRED_COGS_ACCT_ID = CCID of the Deferred COGS account which applies to this order line.<br>
2.COGS_ACCT_ID = CCID of the COGS account which applies to this order line.<br>',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: CST_COGS CST_REVENUE_COGS_MATCH_LINES');



debug('begin add_signature: CST_COGS CST_COGS_EVENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11065',
      p_sig_id                 => 'CST_COGS CST_COGS_EVENTS',
      p_sig_sql                => 'SELECT cce.event_id,
       cce.cogs_om_line_id,
       Decode(cce.event_type,
              1,
              ''SO Issue'',
              2,
              ''RMA Receipt'',
              ...
              ''COGS Recognition'',
              4,
              ''COGS Rec. Percentage Adjustment'',
              5,
              ''COGS Recognition Qty Adjustment'',
              6,
              ''RMA Placeholder'') Event_Type,
       cce.event_om_line_id,
       to_char(cce.event_date,''DD-MON-YYYY HH24 : MI : SS'') event_date,
       ...
       cce.parent_event_id,
       cce.event_quantity,
       Nvl(cce.costed,''Yes'') Costed,
       to_char(cce.creation_date,''DD-MON-YYYY HH24 : MI : SS'') creation_date,
       to_char(cce.last_update_date,''DD-MON-YYYY HH24 : MI : SS'') last_update_date,
       cce.request_id,
       cce.program_id
  FROM cst_cogs_events cce
 WHERE cce.cogs_om_line_id IN
       (SELECT ool.line_id
          FROM oe_order_lines_all ool
         where header_id in (select header_id from oe_order_headers_all where order_number=##$$ORDERNUM$$##))
 ORDER BY cce.cogs_om_line_id, cce.event_type',
      p_title                  => 'COGS Events Information',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'COGS Events related information.',
      p_solution               => 'COGS Events related information:<br><br>

1.Refer to Column ''MMT_TRANSACTION_ID''.<br>     
  This is the same as TRANSACTION_ID in MTL_MATERIAL_TRANSACTIONS table.<br><br>

2. Refer to Column ''COGS_PERCENTAGE'' and ''PRIOR_COGS_PERCENTAGE''.<br>
   0 Signifies  COGS Not Recognized.<br>
   1 Signifies  100% Recognized.<br><br>

  If Both the COGS % and Prior COGS % are same (0 or any value) , then distributions will not be created.<br>

  Distribution will not be created for COGS Transaction under the following scenarios:-<br>
  i.The Sales Order Issue quantity and RMA quantity are equal and are in same or different period. [SO ISSUE > RMA > COGS]<br>
  ii.The Item costs is "ZERO" check the new cost in CST_REVENUE_COGS_MATCH_LINES table. It will be "Null".<br>
  iii.Both the COGS % and Prior COGS % are same (0 or any value) in CST_COGS_EVENTS table.<br><br>

4.Refer to Column ''COSTED''<br>
COSTED =YES when the transaction is costed and Distributions are Generated.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: CST_COGS CST_COGS_EVENTS');



debug('begin add_signature: CST_COGS_CST_REVENUE_RECOGNITION_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11485',
      p_sig_id                 => 'CST_COGS_CST_REVENUE_RECOGNITION_LINES',
      p_sig_sql                => 'SELECT crrl.revenue_om_line_id,
 crrl.acct_period_num,
 Nvl(crrl.potentially_unmatched_flag,''Processed'') potentially_unmatched_flag,
 crrl.revenue_recognition_percent,
 to_char(crrl.last_event_date,''DD-MON-YYYY HH24 : MI : SS'') last_event_date,
 crrl.operating_unit_id,
 crrl.ledger_id,
 crrl.inventory_item_id,
 crrl.customer_trx_line_id,
 to_char(crrl.creation_date,''DD-MON-YYYY HH24 : MI : SS'') creation_date,
 to_char(crrl.last_update_date,''DD-MON-YYYY HH24 : MI : SS'') last_update_date
FROM cst_revenue_recognition_lines crrl
WHERE crrl.revenue_om_line_id IN 
(SELECT crcml.revenue_om_line_id FROM cst_revenue_cogs_match_lines crcml
  WHERE crcml.cogs_om_line_id IN 
   (SELECT ool.line_id
          FROM oe_order_lines_all ool
         WHERE header_id  in (select header_id from oe_order_headers_all where order_number=##$$ORDERNUM$$##) ))
 ORDER BY crrl.revenue_om_line_id, crrl.acct_period_num',
      p_title                  => 'COGS Revenue Recognition Information',
      p_fail_condition         => 'RS',
      p_problem_descr          => '<br>
This table is populated with data from Order Management (OM) and Oracle Receivables (AR) about the Revenue Recognition Percentage for a given OM line.<br>
The main purpose of the table is to store a Revenue Recognition Percent for each OM line and accounting period.<br>
The Generate COGS Recognition Events program will compare the information in this table with the latest percentage in CST_COGS_EVENTS for each period, and use any differences to build COGS Recognition events.',
      p_solution               => 'Table CST_REVENUE_RECOGNITION_LINES is populated after Collect Revenue Recognition Information program is run:<br><br>
 
1. CST_REVENUE_RECOGNITION_LINES.POTENTIALLY_UNMATCHED_FLAG = ''Y''.<br>These records would be be processed by Generate COGS Recognition Events program.<br>
   After Generate COGS Recognition Events is run CST_REVENUE_RECOGNITION_LINES.POTENTIALLY_UNMATCHED_FLAG would be NULL.<br>
2. CST_REVENUE_RECOGNITION_LINES.POTENTIALLY_UNMATCHED_FLAG= ''P''  means pending transactions.Ideally when the Generate COGS Recognition Events program is run these should be picked and processed.<br>
3. CST_REVENUE_RECOGNITION_LINES.REVENUE_RECOGNITION_PERCENT= ''1'' [Revenue Recognition percentage of 1 signifies 100% revenue has been recognized in AR].<br>
',
      p_success_msg            => ' ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CST_COGS_CST_REVENUE_RECOGNITION_LINES');



debug('begin add_signature: CST_COGS RA_CUST_TRX_LINE_GL_DIST_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11068',
      p_sig_id                 => 'CST_COGS RA_CUST_TRX_LINE_GL_DIST_ALL',
      p_sig_sql                => 'SELECT rctlgd.CUST_TRX_LINE_GL_DIST_ID,
       rctlgd.CUSTOMER_TRX_LINE_ID,
       rctlgd.CODE_COMBINATION_ID,
       rctlgd.SET_OF_BOOKS_ID,
       to_char(rctlgd.LAST_UPDATE_DATE, ''DD-MON-YYYY HH24 : MI : SS'') LAST_UPDATE_DATE,
       to_char(rctlgd.CREATION_DATE, ''DD-MON-YYYY HH24 : MI : SS'') CREATION_DATE,
       rctlgd.PERCENT,
       rctlgd.AMOUNT,
       to_char(rctlgd.GL_DATE, ''DD-MON-YYYY HH24 : MI : SS'') GL_DATE,
       to_char(rctlgd.GL_POSTED_DATE, ''DD-MON-YYYY HH24 : MI : SS'') GL_POSTED_DATE,
       rctlgd.REQUEST_ID,
       rctlgd.PROGRAM_APPLICATION_ID,
       to_char(rctlgd.PROGRAM_UPDATE_DATE, ''DD-MON-YYYY HH24 : MI : SS'') PROGRAM_UPDATE_DATE,
       rctlgd.ACCOUNT_SET_FLAG,
       to_char(rctlgd.ORIGINAL_GL_DATE, ''DD-MON-YYYY HH24 : MI : SS'') ORIGINAL_GL_DATE,
       rctlgd.ACCOUNT_CLASS,
       rctlgd.CUSTOMER_TRX_ID,
       rctlgd.ACCTD_AMOUNT,
       rctlgd.ORG_ID,
       rctlgd.REVENUE_ADJUSTMENT_ID,
       rctlgd.EVENT_ID,
       rctlgd.COGS_REQUEST_ID
               ...
               (SELECT order_number
                 ...
                 WHERE header_id IN
                       (SELECT header_id
                         ...
                         where header_id in (select header_id from oe_order_headers_all where order_number=##$$ORDERNUM$$##))))',
      p_title                  => 'Revenue Recognition and Revenue Recognition Date Information',
      p_fail_condition         => 'RS',
      p_problem_descr          => '<br>
1.After Revenue Recognition and Revenue Accounting is run from AR responsibility, Column "ACCOUNT_SET_FLAG will be updated.<br><br>

ACCOUNT_SET_FLAG = ''N'' signifies, Revenue recognition is run.<br>
ACCOUNT_SET_FLAG  =''Y'' signifies, Revenue recognition is not run.<br>

Unless Revenue is Recognized, COGS will not be Recognized.<br><br>

2.Column name ''GL_DATE'' is the Revenue Recognition date. <br>
The TRANSACTION_DATE in MTL_MATERIAL_TRANSACTIONS table for COGS transaction is the Revenue Recognition Date.<br>
 ...
 ',
   ...
   l_info.delete;
debug('end add_signature: CST_COGS RA_CUST_TRX_LINE_GL_DIST_ALL');



debug('begin add_signature: CST_COGS_AR_INVOICE_HEADER_INFORMATIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11529',
      p_sig_id                 => 'CST_COGS_AR_INVOICE_HEADER_INFORMATIONS',
      p_sig_sql                => 'select RAH.CUSTOMER_TRX_ID CUST_TRX_ID,
       RAH.TRX_NUMBER TRX_NUMBER,
       RAH.CUST_TRX_TYPE_ID TRX_TYPE_ID,
       to_char(RAH.TRX_DATE, ''DD-MON- HH24:MI:SS'') TRX_DATE,
       ...
       to_char(RAH.CREATION_DATE, ''DD-MON-YYYY HH24 : MI : SS'') CREATE_DT,
       to_char(RAH.LAST_UPDATE_DATE, ''DD-MON-YYYY HH24 : MI : SS'') UPDATE_DT,
       RAH.REQUEST_ID REQUEST_ID
 ...
 WHERE customer_trx_id IN
               ...
               (SELECT order_number
                 ...
                 WHERE header_id IN
                       (SELECT header_id
                          FROM oe_order_lines_all
                         WHERE header_id in (select header_id from oe_order_headers_all where order_number=##$$ORDERNUM$$##)
                            OR reference_header_id in (select header_id from oe_order_headers_all where order_number=##$$ORDERNUM$$##))))',
      p_title                  => 'COGS AR Invoice Header Information',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'AR transaction header information.',
      p_solution               => 'If there are records returned it means that Sales Order has been invoiced.<br>',
      p_success_msg            => ' ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: CST_COGS_AR_INVOICE_HEADER_INFORMATIONS');



debug('begin add_signature: CST_COGS_AR_INVOICE_LINE _INFORMATIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11530',
      p_sig_id                 => 'CST_COGS_AR_INVOICE_LINE _INFORMATIONS',
      p_sig_sql                => 'select RCTL.CUSTOMER_TRX_LINE_ID TRX_LINE_ID,
       RCTL.LINK_TO_CUST_TRX_LINE_ID LINK_TO_ID,
       RCTL.CUSTOMER_TRX_ID CUST_TRX_ID,
       RCTL.SALES_ORDER_SOURCE SOURCE,
       RCTL.LINE_NUMBER LINE_NUM,
       RCTL.INVENTORY_ITEM_ID ITEM_ID,
       RCTL.QUANTITY_ORDERED ORD_Q,
       RCTL.QUANTITY_INVOICED INV_Q,
       RCTL.QUANTITY_CREDITED CRD_Q,
       RCTL.UOM_CODE UOM,
       RCTL.UNIT_SELLING_PRICE PRICE,
       RCTL.EXTENDED_AMOUNT EXTD_AMT,
       RCTL.REVENUE_AMOUNT REV_AMT,
       RCTL.SALES_ORDER,
       TRIM(RCTL.SALES_ORDER_LINE) SO_LIN,
       RCTL.LINE_TYPE LINE_TYPE,
       RCTL.INTERFACE_LINE_ATTRIBUTE1 Order_Num_1,
       RCTL.INTERFACE_LINE_ATTRIBUTE2 Order_Type_2,
       RCTL.INTERFACE_LINE_ATTRIBUTE3 Delivery_3,
       RCTL.INTERFACE_LINE_ATTRIBUTE4 WayBill_4,
       RCTL.INTERFACE_LINE_ATTRIBUTE6 Line_ID_5,
       to_char(RCTL.CREATION_DATE, ''DD-MON-YYYY HH24 : MI : SS'') CREATE_DT,
       to_char(RCTL.LAST_UPDATE_DATE, ''DD-MON-YYYY HH24 : MI : SS'') UPDATE_DT,
       RCTL.REQUEST_ID REQUEST_ID
  FROM ra_customer_trx_lines_all rctl
 WHERE rctl.interface_line_context = ''ORDER ENTRY''
   AND TO_NUMBER(rctl.interface_line_attribute1) IN
       (SELECT order_number
         ...
         WHERE header_id IN
               (SELECT header_id
                 ...
                 WHERE header_id in (select header_id from oe_order_headers_all where order_number=##$$ORDERNUM$$##)
                    OR reference_header_id in (select header_id from oe_order_headers_all where order_number=##$$ORDERNUM$$##)))',
      p_title                  => 'COGS AR Invoice Line Information',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'AR transaction line information.',
      p_solution               => 'If there are records returned it means that Sales Order has been invoiced.',
      p_success_msg            => ' ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: CST_COGS_AR_INVOICE_LINE _INFORMATIONS');



debug('begin add_signature: CST_COGS MTL_TRANSACTIONS_INTERFACE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11063',
      p_sig_id                 => 'CST_COGS MTL_TRANSACTIONS_INTERFACE',
      p_sig_sql                => 'SELECT transaction_interface_id,
        ...
        primary_quantity,
        transaction_uom,
        to_char(transaction_date,''DD-MON-YYYY HH24 : MI : SS'') transaction_date,
        acct_period_id,
        subinventory_code,
  ...
  WHERE mti.trx_source_line_id IN
        (SELECT ool.line_id
           FROM oe_order_lines_all ool
          WHERE header_id in (select header_id from oe_order_headers_all where order_number=##$$ORDERNUM$$##))',
      p_title                  => 'Transactions Stuck in MTL_TRANSACTIONS_INTERFACE Table',
      p_fail_condition         => 'RS',
      p_problem_descr          => '<br>
If data is stuck in MTL TRANSACTIONS INTERFACE Table, then COGS will not be recognized.<br>
Also,Check cst_revenue_recognition_lines table Column "potentially_unmatched_flag". It will be ''P'' meaning Processed but not successful.<br><br>

Case 1: If revenue is before sales order issue, even you run Generate COGS Recognition Events, COGS Recognition transaction won''t be created, so the flag will be updated from ''Y'' to ''P''. <br>
Till after shipping  the item, then you run Generate COGS Recognition Events again, ''P'' will be updated to ''Y'' to further process.<br><br> 

Case 2. If a om line has multiple sales order issue, COGS Recognition will be only happened when the full quantity issued. <br>
If partial quantity issued, still updated to ''P'' from ''Y'' and waiting for next COGS Recognition
',
      p_solution               => 'There are stuck transactions in the MTL_TRANSACTIONS_INTERFACE table. This means the COGS will not be recognized. Need to process these records.<br>
Please verify that the Process transaction interface program is active.<br>
For other troubleshooting issues please review [1063689/KB559654] Transactions Interface MTL_TRANSACTIONS_INTERFACE MTI Error Messages, Meanings, and Solutions.',
      p_success_msg            => 'There are no unprocessed transactions in the table MTL_TRANSACTIONS_INTERFACE.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CST_COGS MTL_TRANSACTIONS_INTERFACE');



debug('begin add_signature: EBS_MFG_DM_CSTCOGS_CST_COGS_TXN_DATA_CORRUPTION_AR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23561',
      p_sig_id                 => 'EBS_MFG_DM_CSTCOGS_CST_COGS_TXN_DATA_CORRUPTION_AR',
      p_sig_sql                => ' SELECT   *  FROM     ra_cust_trx_line_gl_dist_all gld ,RA_CUSTOMER_TRX_LINES_ALL CTL_OUT 
WHERE  CTL_OUT.customer_trx_id = gld.customer_trx_id    
AND  CTL_OUT.customer_trx_LINE_id = gld.customer_trx_LINE_id      AND gld.account_class = ''REV''     AND gld.cogs_request_id IS NOT NULL     AND gld.account_set_flag = ''N''    
 AND CTL_OUT.sales_order  IN (''##$$ORDERNUM$$##'') 
 AND NOT EXISTS (   SELECT    1   FROM   cst_revenue_recognition_lines   WHERE  revenue_om_line_id IN 
(  SELECT   interface_line_attribute6   FROM   ra_customer_trx_lines_all ctl    WHERE  gld.customer_trx_line_id = ctl.customer_trx_line_id  ) )',
      p_title                  => 'Transaction Related with Sales Order has Data Corruption',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Check if the Transaction Related with Sales Order has Data Corruption',
      p_solution               => 'Assign to AR support team.This is data issue in Receivables data prod 505  Data fix provided in <br>
[2675252/KB720976] COGS Entries Are Being Reversed For Transactions With 0 Dollar Scheduled Revenue Lines. 

',
      p_success_msg            => ' No AR Data Corruption for this Sales Order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_DM_CSTCOGS_CST_COGS_TXN_DATA_CORRUPTION_AR');



debug('begin add_signature: EBS_MFG_DM_CSTCOGS_CST_COGS_CST_REVENUE_RECOGNITION_LINES_NO_DATA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23562',
      p_sig_id                 => 'EBS_MFG_DM_CSTCOGS_CST_COGS_CST_REVENUE_RECOGNITION_LINES_NO_DATA',
      p_sig_sql                => 'SELECT  * FROM    CST_REVENUE_RECOGNITION_LINES 
WHERE   REVENUE_OM_LINE_ID IN  (   SELECT  INTERFACE_LINE_ATTRIBUTE6   
 FROM    RA_CUSTOMER_TRX_LINES_ALL   WHERE   sales_order   IN (''##$$ORDERNUM$$##'') )',
      p_title                  => 'CST_REVENUE_RECOGNITION_LINES No Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data exists in CST_REVENUE_RECOGNITION_LINES CRRL table.',
      p_solution               => 'Please re-run the program "Collect Revenue Recognition Information" with valid parameters,<br>
after re-running the program if the query still does not return records,  engage Account Receivables AR Prod 505 team.<br> 
Refer to [2887164/KB747594] When And How To Contact Account Receivables For COGS Issue ?

',
      p_success_msg            => 'CST_REVENUE_RECOGNITION_LINES display data.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_DM_CSTCOGS_CST_COGS_CST_REVENUE_RECOGNITION_LINES_NO_DATA');



debug('begin add_signature: EBS_MFG_DM_CSTCOGS_CST_COGS_RECOGNITION_INVALID_ITEM');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22846',
      p_sig_id                 => 'EBS_MFG_DM_CSTCOGS_CST_COGS_RECOGNITION_INVALID_ITEM',
      p_sig_sql                => 'SELECT OOD.ORGANIZATION_CODE ORG,
...
(SELECT CRTT.INVENTORY_ITEM_ID FROM CST_REVENUE_COGS_MATCH_LINES CRTT 
WHERE CRTT.INVENTORY_ITEM_ID = MSI.INVENTORY_ITEM_ID 
AND CRTT.ORGANIZATION_ID = MSI.ORGANIZATION_ID) 
ORDER BY MSI.SEGMENT1',
      p_title                  => 'Generate COGS Recognition Events Error Inventory Item ID is Invalid Match_RevenueCOGS ',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Generate COGS Recognition Events, the following error occurs: Inventory item ID is invalid or does not have the flags enabled correctly to be processed by material processor Error in CST_RevenueCogsMatch_PVT . Match_RevenueCOGS ( 50 )<br>

',
      p_solution               => 'Please review  [971355/KB779556] Generate COGS Recognition Events Error Inventory item ID is invalid Match_RevenueCOGS<br>

 ',
      p_success_msg            => 'There are no error in Generate COGS Recognition Events.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_DM_CSTCOGS_CST_COGS_RECOGNITION_INVALID_ITEM');



debug('begin add_signature: EBS_MFG_DM_CSTCOGS_CST_COGS_COGS_REQUEST_ID_NULL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23563',
      p_sig_id                 => 'EBS_MFG_DM_CSTCOGS_CST_COGS_COGS_REQUEST_ID_NULL',
      p_sig_sql                => 'SELECT   *  FROM     ra_cust_trx_line_gl_dist_all gld , RA_CUSTOMER_TRX_LINES_ALL CTL_OUT 
WHERE  CTL_OUT.customer_trx_id = gld.customer_trx_id      AND  CTL_OUT.customer_trx_LINE_id = gld.customer_trx_LINE_id      AND gld.account_class = ''REV''     
AND gld.cogs_request_id IS NULL     AND gld.account_set_flag = ''N''    
AND CTL_OUT.sales_order  IN (''##$$ORDERNUM$$##'') 
AND NOT EXISTS ( SELECT  1   FROM    cst_revenue_recognition_lines  
WHERE  revenue_om_line_id IN ( SELECT   interface_line_attribute6  
FROM  ra_customer_trx_lines_all ctl   
WHERE  gld.customer_trx_line_id = ctl.customer_trx_line_id ))',
      p_title                  => 'Check if COGS_REQUEST_ID is null',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Check if COGS_REQUEST_ID is null
If the SQL does not returns the record then there is a problem. ',
      p_solution               => 'Please re run the program "Collect Revenue Recognition Information" with valid parameters, After re running the program if the query still return the records,  engage Account Receivables Prod 505 team.
Refer to [2887164/KB747594] When And How To Contact Account Receivables For COGS Issue ?',
      p_success_msg            => 'COGS_REQUEST_ID is not null.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_DM_CSTCOGS_CST_COGS_COGS_REQUEST_ID_NULL');



debug('begin add_signature: EBS_MFG_DM_CSTCOGS_CSTRCMVB_VERSION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23564',
      p_sig_id                 => 'EBS_MFG_DM_CSTCOGS_CSTRCMVB_VERSION',
      p_sig_sql                => 'SELECT subdir,  filename,   VERSION  
FROM (SELECT a.filename,  v.VERSION, a.subdir,  ROW_NUMBER () OVER (PARTITION BY a.subdir, a.filename
 ORDER BY v.version_segment1 DESC,  v.version_segment2 DESC, v.version_segment3 DESC, v.version_segment4 DESC,                 v.version_segment5 DESC, v.version_segment6 DESC,  v.version_segment6 DESC,  v.version_segment7 DESC,                 v.version_segment8 DESC,  v.version_segment9 DESC, v.version_segment10 DESC) num  
FROM apps.ad_file_versions v,  apps.ad_files a   
WHERE v.file_id = a.file_id  AND ( (a.filename like (''CSTRCMVB%'') and substr(VERSION,17)  >= ''67'' )  ) )  WHERE num = 1',
      p_title                  => 'CSTRCMVB.pls Latest File Version',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Check if Customer is on the Latest File CSTRCMVB.pls Version.',
      p_solution               => 'Apply the latest Patch. Apply Patch 34055423:R12.BOM.D  or higher to update to latest file version
 CSTRCMVB.pls 120.83.12020000.67 or higher.
 You can use the commands like the following:
 Strings -a $BOM_TOP/patch/115/sql/CSTRCMVB.pls | grep ''$Header''
 Refer to [2887164/KB747594] When And How To Contact Account Receivables For COGS Issue ?',
      p_success_msg            => 'File CSTRCMVB.pls is on the latest file version',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_DM_CSTCOGS_CSTRCMVB_VERSION');



debug('begin add_signature: EBS_MFG_DM_CSTCOGS_ARCGSRVB_VERSION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23565',
      p_sig_id                 => 'EBS_MFG_DM_CSTCOGS_ARCGSRVB_VERSION',
      p_sig_sql                => 'SELECT subdir,        filename,        VERSION   FROM (SELECT a.filename,                v.VERSION,                a.subdir,                ROW_NUMBER () OVER (PARTITION BY a.subdir, a.filename ORDER BY v.version_segment1 DESC,                 v.version_segment2 DESC,                 v.version_segment3 DESC,                 v.version_segment4 DESC,                 v.version_segment5 DESC,                 v.version_segment6 DESC,                 v.version_segment6 DESC,                 v.version_segment7 DESC,                 v.version_segment8 DESC,                 v.version_segment9 DESC,                 v.version_segment10 DESC) num           FROM apps.ad_file_versions v,                apps.ad_files a          WHERE v.file_id = a.file_id            AND ((a.filename like (''ARCGSRVB.pls%'') and substr(VERSION,17)  >= 19 ) ) )  WHERE num = 1',
      p_title                  => 'ARCGSRVB.pls Latest File Version',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Check if Customer is on the Latest File ARCGSRVB.pls Version. ',
      p_solution               => 'Apply the latest Patch. Apply Patch 33632498:R12.AR.C  or higher to update to latest file version
 ARCGSRVB.pls 120.41.12020000.19 or higher.
 You can use the commands like the following:
 Strings -a $AR_TOP/patch/115/sql/ARCGSRVB.pls | grep ''$Header''
 Refer to [2879254/KB793547] COGS Is Not Calculating Properly For All Transactions',
      p_success_msg            => 'File ARCGSRVB.pls  is on the latest file version',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_DM_CSTCOGS_ARCGSRVB_VERSION');



debug('begin add_signature: EBS_MFG_DMEF_CSTCOGS_RMA_BEF_COGS_REC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30028',
      p_sig_id                 => 'EBS_MFG_DMEF_CSTCOGS_RMA_BEF_COGS_REC',
      p_sig_sql                => 'SELECT
    ooh.order_number,
    ool.line_number,
    ool.shipment_number,
...
WHERE
    ...
    AND EXISTS (
        ...
        WHERE
                mmt1.transaction_type_id = 10008
            AND mmt1.trx_source_line_id = mmt.trx_source_line_id
    )
    AND ooh.order_number=##$$ORDERNUM$$##',
      p_title                  => 'RMA performed before COGS Recognition',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'COGS transaction(s) accounting is not getting generated. The RMA transaction is created before  COGS Recognition transaction is generated for the Sales Order Issue transaction, so there is no accounting since net quantity issued is zero.',
      p_solution               => 'Review the solution in point 24 of [1607921/FAQ5978] - FAQ in COGS / DCOGS. 
',
      p_success_msg            => 'There are no RMA performed before COGS Recognition',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_DMEF_CSTCOGS_RMA_BEF_COGS_REC');



debug('begin add_signature: EBS_MFG_DMEF_CSTCOGS_ZERO_COST_TXN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30027',
      p_sig_id                 => 'EBS_MFG_DMEF_CSTCOGS_ZERO_COST_TXN',
      p_sig_sql                => 'SELECT
    ooh.order_number,
    ool.line_number,
    ool.shipment_number,
...
WHERE
    ...
    AND ooh.order_number=##$$ORDERNUM$$##',
      p_title                  => 'No Accounting for COGS Recognition Transaction',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'COGS transaction(s) accounting is not getting generated. The Sales Order transaction is costed at zero cost and the corresponding COGS Recognition transaction that is created will not have any accounting since there is no value.',
      p_solution               => 'Review the solution steps in point 17 of  [1607921/FAQ5978]  FAQ in COGS / DCOGS.',
      p_success_msg            => 'There are no Sales Order transactions with zero cost',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_DMEF_CSTCOGS_ZERO_COST_TXN');



debug('begin add_signature: CST_COGS POTENTIALLY_UNMATCHED_FLAG IS P');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11235',
      p_sig_id                 => 'CST_COGS POTENTIALLY_UNMATCHED_FLAG IS P',
      p_sig_sql                => 'SELECT crrl.revenue_om_line_id,
crrl.acct_period_num,
Nvl(crrl.potentially_unmatched_flag,''Processed'') potentially_unmatched_flag,
crrl.revenue_recognition_percent,
...
WHERE crrl.potentially_unmatched_flag = ''P''',
      p_title                  => 'COGS Not Getting Recognized with Pending Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are COGS records not recognized, due to records stuck in CST_REVENUE_RECOGNITION_LINES table with pending status(ie CST_REVENUE_RECOGNITION_LINES.POTENTIALLY_UNMATCHED_FLAG=''P'').<br>',
      p_solution               => 'Review [2434291/KB737864] - Potentially Unmatched Flag is "P" ( Pending status) in CST_REVENUE_RECOGNITION_LINES.
',
      p_success_msg            => 'COGS transaction is successfully processed.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: CST_COGS POTENTIALLY_UNMATCHED_FLAG IS P');



debug('begin add_signature: CST_COGS POTENTIALLY_UNMATCHED_FLAG IS I');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11236',
      p_sig_id                 => 'CST_COGS POTENTIALLY_UNMATCHED_FLAG IS I',
      p_sig_sql                => 'SELECT crrl.revenue_om_line_id,
crrl.acct_period_num,
Nvl(crrl.potentially_unmatched_flag,''Processed'') potentially_unmatched_flag,
crrl.revenue_recognition_percent,
...
to_char(crrl.last_update_date,''DD-MON-YYYY HH24 : MI : SS'') last_update_date
FROM cst_revenue_recognition_lines crrl
WHERE crrl.potentially_unmatched_flag = ''I''',
      p_title                  => 'COGS Not Getting Recognized with Investigate Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Refer to Column POTENTIALLY_UNMATCHED_FLAG.<br>

POTENTIALLY_UNMATCHED_FLAG= ''I'' signifies Investigation. This is an abnormal situation.<br>

There is no possibility from the application to see such cases or to resubmit the records. It can be seen only from back-end and always needs a data-fix or re submission.

',
      p_solution               => 'See the Solutions in [2031695/KB738243] - COGS Not Generated - Cst_revenue_recognition_lines.potentially_unmatched_flag = ''I''. <br>

The datafix is included in the patch - No need for additional datafix/resubmission script.
',
      p_success_msg            => 'COGS transaction is successfully processed.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: CST_COGS POTENTIALLY_UNMATCHED_FLAG IS I');



debug('begin add_signature: CST_COGS COGS NOT GETTING RECOGNSIED FOR SHIP ONLY SALES ORDER.');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10617',
      p_sig_id                 => 'CST_COGS COGS NOT GETTING RECOGNSIED FOR SHIP ONLY SALES ORDER.',
      p_sig_sql                => 'SELECT ool.org_id,
ool.line_id,
mmt.inventory_item_id,
crcml.revenue_om_line_id
FROM mtl_material_transactions mmt,
...
AND EXISTS
(SELECT 1 FROM cst_cogs_events
WHERE cogs_om_line_id= ool.line_id
AND event_type=1)
AND NOT EXISTS
(SELECT 1 FROM cst_cogs_events
WHERE event_type=3
AND cogs_om_line_id=ool.line_id)
AND NOT EXISTS
(SELECT 1 FROM cst_revenue_recognition_lines crrl,
cst_revenue_cogs_match_lines crcml
WHERE crcml.revenue_om_line_id=crrl.revenue_om_line_id
AND crcml.cogs_om_line_id=ool.line_id)',
      p_title                  => 'COGS Events Not Generated for Ship Only Sales Order',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'A Sales Order has lines with items, which are neither invoicable nor shippable but are inventory interfaced, then a deferred COGS account is generated.<br> 
Costing is never notified to move the Deferred COGS to COGS, since the current code notifies costing only when there is shipped or invoiced quantity.<br>
You will need to apply a patch and maybe need a datafix.

',
      p_solution               => 'Review [1347343/KB163156] - COGS Events Not Generated For Ship Only Order for more information. 
',
      p_success_msg            => 'COGS Events Generated for Ship Only Sales Order.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CST_COGS COGS NOT GETTING RECOGNSIED FOR SHIP ONLY SALES ORDER.');



debug('begin add_signature: CST_COGS_INVOICED SALES ORDERS BUT DATA NOT MOVED TO AR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10609',
      p_sig_id                 => 'CST_COGS_INVOICED SALES ORDERS BUT DATA NOT MOVED TO AR',
      p_sig_sql                => 'SELECT HEADER_ID,
        ORG_ID,
        ORDER_NUMBER,
        ORDER_SOURCE_ID,
        ORDERED_DATE,
   ...
   FROM (SELECT /*+ use_nl (a,b)*/
                ...
                B.ORDERED_QUANTITY,
                B.INVOICE_INTERFACE_STATUS_CODE
           FROM OE_ORDER_HEADERS_ALL A,
                OE_ORDER_LINES_ALL   B,
                WSH_DELIVERY_DETAILS C
          WHERE A.HEADER_ID = B.HEADER_ID
            AND A.ORG_ID = B.ORG_ID
            AND B.SHIP_FROM_ORG_ID = ##$$Organization_id$$##
            AND C.SOURCE_HEADER_NUMBER = A.ORDER_NUMBER
            AND A.HEADER_ID = C.SOURCE_HEADER_ID
            AND B.SHIP_FROM_ORG_ID = C.ORGANIZATION_ID
            AND C.INV_INTERFACED_FLAG = ''Y''
            AND a.ORDERED_DATE between ''##$$Start_Date$$##'' AND ''##$$End_Date$$##''
         ...
         SELECT /*+ use_nl (a,b)*/
          ...
          (SELECT 1
                  ...
                  WHERE INVOICEABLE_ITEM_FLAG = ''Y''
                    AND INVOICE_ENABLED_FLAG = ''Y''
                    AND INVENTORY_ITEM_ID = B.INVENTORY_ITEM_ID))
  WHERE INVOICE_INTERFACE_STATUS_CODE = ''YES''
    AND NOT EXISTS
  (SELECT 1
           FROM RA_CUSTOMER_TRX_LINES_ALL RAL
          WHERE RAL.INTERFACE_LINE_CONTEXT = ''ORDER ENTRY''
            AND RAL.INTERFACE_LINE_ATTRIBUTE6 = TO_CHAR(LINE_ID)
            AND RAL.SALES_ORDER = ORDER_NUMBER)
 ORDER BY ORDER_NUMBER, LINE_ID',
      p_title                  => 'Invoiced Sales Orders But Data Not Moved to AR',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are sales orders that are showing as invoiced, but the data has not been moved to AR.  ',
      p_solution               => 'You will need to run the Collect Revenue Recognition Information to process these records.<br> 
For additional information refer to [1307906/KB627708] COGS Dataflow and Diagnostics [Video] provides COGS data flow information.',
      p_success_msg            => 'Invoiced Sales Orders moved to AR.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CST_COGS_INVOICED SALES ORDERS BUT DATA NOT MOVED TO AR');



debug('begin add_signature: CST_COGS_INV_DISTRIBUTIONS_SO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11321',
      p_sig_id                 => 'CST_COGS_INV_DISTRIBUTIONS_SO',
      p_sig_sql                => 'SELECT distinct
E.SALES_ORDER "Sales Order",
E.SALES_ORDER_LINE "Order Line",
(select distinct segment1 from mtl_system_items_b where inventory_item_id = MTA.INVENTORY_ITEM_ID) "Item",
MTA.TRANSACTION_DATE "Transaction date",
MTA.PRIMARY_QUANTITY "Quantity",
MTA.BASE_TRANSACTION_VALUE "Transaction value",
decode(MTA.ACCOUNTING_LINE_TYPE,1,''Inventory Valuation'',35,''Deferred COGS'',36,''COGS'') "Accounting line type",
(select concatenated_segments from gl_code_combinations_kfv where code_combination_id = MTA.REFERENCE_ACCOUNT) "Account",
MTA.TRANSACTION_ID
FROM CST_COGS_EVENTS A,
...
AND B.SHIP_FROM_ORG_ID = C.ORGANIZATION_ID
AND C.INV_INTERFACED_FLAG = ''Y''
AND a.ORDERED_DATE between ''##$$Start_Date$$##'' AND
''##$$End_Date$$##''
AND B.LINE_CATEGORY_CODE = ''ORDER''
AND EXISTS
(SELECT 1
...
AND INVOICE_ENABLED_FLAG = ''Y''
AND INVENTORY_ITEM_ID = B.INVENTORY_ITEM_ID))
WHERE RAL.INTERFACE_LINE_ATTRIBUTE6 = TO_CHAR(LINE_ID)
AND RAL.SALES_ORDER = ORDER_NUMBER
AND INVOICE_INTERFACE_STATUS_CODE = ''YES'')) E,
MTL_MATERIAL_TRANSACTIONS MMT,
MTL_TRANSACTION_ACCOUNTS MTA
WHERE A.COGS_OM_LINE_ID = B.COGS_OM_LINE_ID
AND B.REVENUE_OM_LINE_ID = C.REVENUE_OM_LINE_ID
AND E.INTERFACE_LINE_ATTRIBUTE6 = A.COGS_OM_LINE_ID
AND MMT.TRANSACTION_ID = A.MMT_TRANSACTION_ID
AND MTA.TRANSACTION_ID = MMT.TRANSACTION_ID
AND EXISTS
(SELECT 1
FROM RA_CUST_TRX_LINE_GL_DIST_ALL RDL
WHERE E.CUSTOMER_TRX_LINE_ID = RDL.CUSTOMER_TRX_LINE_ID
AND EXISTS
(SELECT 1
FROM (SELECT CUSTOMER_TRX_LINE_ID,
CUSTOMER_TRX_ID,
INVENTORY_ITEM_ID,
DESCRIPTION,
SALES_ORDER,
...
AND A.ORG_ID = B.ORG_ID
AND B.SHIP_FROM_ORG_ID = ##$$Organization_id$$##
AND C.SOURCE_HEADER_NUMBER =
A.ORDER_NUMBER
AND A.HEADER_ID = C.SOURCE_HEADER_ID
AND B.SHIP_FROM_ORG_ID =
C.ORGANIZATION_ID
AND C.INV_INTERFACED_FLAG = ''Y''
AND a.ORDERED_DATE between
...
AND INVENTORY_ITEM_ID =
B.INVENTORY_ITEM_ID))
WHERE RAL.INTERFACE_LINE_ATTRIBUTE6 =
TO_CHAR(LINE_ID)
AND RAL.SALES_ORDER = ORDER_NUMBER
AND INVOICE_INTERFACE_STATUS_CODE = ''YES''))
WHERE CUSTOMER_TRX_ID = RDL.CUSTOMER_TRX_ID
AND CUSTOMER_TRX_LINE_ID = RDL.CUSTOMER_TRX_LINE_ID))
ORDER BY E.SALES_ORDER,e.SALES_ORDER_LINE,MTA.TRANSACTION_ID',
      p_title                  => 'Inventory Distributions for Sales Orders',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Inventory Distributions for Sales Orders.',
      p_solution               => 'Accounting Entries:<br>
After COGS Recognition is generated:<br>
COGS Account is Debited and DCOGS Account is Credited.<br><br>

Accounting Line Type ''35'' signifies ''COGS'' in table mtl_transaction_accounts.<br>
Accounting Line Type ''36'' signifies ''DCOGS'' in table mtl_transaction_accounts.<br>',
      p_success_msg            => 'This script displays the inventory accounting for the sales orders in the given period.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: CST_COGS_INV_DISTRIBUTIONS_SO');



debug('begin add_signature: CST_COGS_INV_NOT_CREATED_FOR_SO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11311',
      p_sig_id                 => 'CST_COGS_INV_NOT_CREATED_FOR_SO',
      p_sig_sql                => 'SELECT distinct
ord.HEADER_ID "Header ID",
ord.ORG_ID "Organization ID",
mp.organization_code "Organization code",
ord.ORDER_NUMBER "Sales order",
ord.ORDER_SOURCE_ID "Source line ID",
ord.ORDERED_DATE "Ordered Date",
ord.LINE_ID "Line ID",
ord.INVENTORY_ITEM_ID "Item ID",
msi.segment1 "Item name",
ord.INVOICE_INTERFACE_STATUS_CODE "Interface status code"
FROM (SELECT /*+ use_nl (a,b)*/
A.HEADER_ID,
A.ORG_ID,
A.ORDER_NUMBER,
...
WHERE INVOICEABLE_ITEM_FLAG = ''Y''
AND INVOICE_ENABLED_FLAG = ''Y''
AND INVENTORY_ITEM_ID = B.INVENTORY_ITEM_ID)) ord,
mtl_parameters mp,
mtl_system_items_b msi
WHERE ord.inventory_item_id = msi.inventory_item_id
and ord.org_id = msi.organization_id
and ord.org_id = mp.organization_id
and INVOICE_INTERFACE_STATUS_CODE <> ''YES''
ORDER BY ORDER_NUMBER, LINE_ID',
      p_title                  => 'Invoice Not Created for Sales Orders',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There is an invoice that has not created for sales orders.  The order will not have COGS recognition without it.',
      p_solution               => 'For these Sales Orders you should create the Invoice in order to have COGS recognition.<br> 
Review [1307906/KB627708]COGS Dataflow and Diagnostics [Video] provides COGS data flow information. ',
      p_success_msg            => 'All the Sales Orders have Invoice created.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CST_COGS_INV_NOT_CREATED_FOR_SO');



debug('begin add_signature: CST_COGS_INV_SO_TO_AR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11301',
      p_sig_id                 => 'CST_COGS_INV_SO_TO_AR',
      p_sig_sql                => 'SELECT SALES_ORDER "Order number",
...
segment1 "Inventory item",
DESCRIPTION "Description",
LINE_TYPE "Line type"
FROM (SELECT ral.CUSTOMER_TRX_LINE_ID,
ral.CUSTOMER_TRX_ID,
...
FROM RA_CUSTOMER_TRX_LINES_ALL RAL,
mtl_system_items_b msi
WHERE msi.inventory_item_id = ral.inventory_item_id
and msi.organization_id = ral.org_id
...
AND INVOICE_INTERFACE_STATUS_CODE = ''YES''))
ORDER BY 1,2',
      p_title                  => 'Invoiced Sales Orders Moved to AR',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invoiced Sales Orders Moved to AR.',
      p_solution               => 'These are all the Sales Orders in the given dates for which invoice has been created. ',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: CST_COGS_INV_SO_TO_AR');



debug('begin add_signature: CST_COGS_INV_TRANS_SO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11274',
      p_sig_id                 => 'CST_COGS_INV_TRANS_SO',
      p_sig_sql                => 'SELECT DISTINCT E.SALES_ORDER "Order number",
E.SALES_ORDER_DATE "Order date",
E.SALES_ORDER_LINE "Order line",
E.INTERFACE_LINE_ATTRIBUTE6 AS "Sales order line ID",
MMT.RMA_LINE_ID "RMA line ID", 
oap.period_name "Period name",
MMT.TRANSACTION_ID "Transaction ID",
MMT.INVENTORY_ITEM_ID "Inventory item ID",
...
null,
''Costed'') "Costed flag",
MMT.COGS_RECOGNITION_PERCENT "COGS recognition percent"
FROM CST_COGS_EVENTS A,
mtl_system_items_b msi,
...
and mtt.transaction_source_type_id = mtt.transaction_source_type_id
...
AND CUSTOMER_TRX_LINE_ID = RDL.CUSTOMER_TRX_LINE_ID))
ORDER BY 1, 2, 3, 7',
      p_title                  => 'Inventory Transactions for Sales Orders',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Inventory Transactions For Sales Orders.',
      p_solution               => 'These are all the Sales Orders created for the Organization and the period selected.<br>
Please check that all the transactions are costed and the COGS recognition is created.<br>
For RMA please check which is the quantity returned and if the COGS recognition has been created also.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: CST_COGS_INV_TRANS_SO');



debug('begin add_signature: CST_COGS_REV_RECOGNITION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10604',
      p_sig_id                 => 'CST_COGS_REV_RECOGNITION',
      p_sig_sql                => 'SELECT CUSTOMER_TRX_LINE_ID "Customer transaction line ID",
       CUSTOMER_TRX_ID "Customer transaction ID",
       INVENTORY_ITEM_ID "Inventory item ID",
       DESCRIPTION "Description",
       ...
       LINE_TYPE "Line type",
       ral.quantity_invoiced "Quantity invoiced",
       ral.uom_code "Unit of measure",
       ral.unit_selling_price "Unit selling price",
       ral.revenue_amount "Revenue amount"
  FROM RA_CUSTOMER_TRX_LINES_ALL RAL
 WHERE RAL.INTERFACE_LINE_CONTEXT = ''ORDER ENTRY''
   AND EXISTS
 (SELECT 1
         ...
         WHERE RAL.INTERFACE_LINE_ATTRIBUTE6 = TO_CHAR(LINE_ID)
           AND RAL.SALES_ORDER = ORDER_NUMBER
           AND INVOICE_INTERFACE_STATUS_CODE = ''YES'')',
      p_title                  => 'Revenue Recognition for Sales Orders in a Given Period',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'These are the revenue recognized for the Sales Orders in the given period for the selected organization.',
      p_solution               => '',
      p_success_msg            => 'These are the revenue recognized for the Sales Orders in the given period for the selected organization.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CST_COGS_REV_RECOGNITION');



debug('begin add_signature: CST_COGS_SO_CREATED_OR_SHIPPED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11312',
      p_sig_id                 => 'CST_COGS_SO_CREATED_OR_SHIPPED',
      p_sig_sql                => 'SELECT distinct ord.Header_ID,
ord.ORG_ID "Operating Unit",
mp.organization_code "Organization Code",
ord.ORDER_NUMBER "Sales Order",
ord.Ordered_Date,
ord.Line_ID,
...
msi.segment1 "Inventory Item",
ord.Invoice_Interface_Status_Code
FROM (SELECT /*+ use_nl (a,b) */
A.HEADER_ID,
A.ORG_ID,
A.ORDER_NUMBER,
...
mtl_system_items_b msi
WHERE ord.inventory_item_id = msi.inventory_item_id
and ord.ship_from_org_id = msi.organization_id
and ord.ship_from_org_id = mp.organization_id
and INVOICE_INTERFACE_STATUS_CODE = ''YES''
ORDER BY ORDER_NUMBER, LINE_ID',
      p_title                  => 'Sales Orders Created/Shipped within a Given Period',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Sales Orders Created/Shipped within given period and from the Organization selected.',
      p_solution               => 'These are the Sales Orders created or shipped in the given period for the selected organization.  ',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: CST_COGS_SO_CREATED_OR_SHIPPED');



debug('begin add_signature: CST_COGS_SO_WITHIN_PERIOD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11313',
      p_sig_id                 => 'CST_COGS_SO_WITHIN_PERIOD',
      p_sig_sql                => 'SELECT /*+ use_nl (a,b) */
distinct A.HEADER_ID "Header ID",
(select Organization_Code from mtl_parameters where organization_id = A.Ship_From_Org_Id) "Organization Code",
A.ORDER_NUMBER "Sales Order",
A.ORDERED_DATE "Order date",
B.LINE_NUMBER "Line Number",
B.ORDERED_QUANTITY "Ordered Quantity",
(select distinct segment1 from mtl_system_items_b where inventory_item_id = B.INVENTORY_ITEM_ID) "Item",
B.INVOICE_INTERFACE_STATUS_CODE "Interface Status"
FROM OE_ORDER_HEADERS_ALL A, OE_ORDER_LINES_ALL B, WSH_DELIVERY_DETAILS C
WHERE A.HEADER_ID = B.HEADER_ID
AND A.ORG_ID = B.ORG_ID
AND B.SHIP_FROM_ORG_ID = ##$$Organization_id$$##
AND C.SOURCE_HEADER_NUMBER = A.ORDER_NUMBER
...
AND INVENTORY_ITEM_ID = B.INVENTORY_ITEM_ID)
order by 3,5',
      p_title                  => 'Sales Orders from a Given Period and Organization',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'These are all the Sales Orders from the given Period and Organization selected.',
      p_solution               => 'These are all the Sales Orders from the current Period. ',
      p_success_msg            => 'These are all the Sales Orders from the given period and organization selected.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CST_COGS_SO_WITHIN_PERIOD');



debug('begin add_signature: CST_COGS_SO_WITH_REV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11300',
      p_sig_id                 => 'CST_COGS_SO_WITH_REV',
      p_sig_sql                => 'SELECT E.SALES_ORDER "Order Number",
E.SALES_ORDER_DATE "Order Date",
E.SALES_ORDER_LINE "Order Line",
E.INTERFACE_LINE_ATTRIBUTE6 "Line ID",
RDL.CUSTOMER_TRX_ID "Customer Transaction ID",
RDL.CUSTOMER_TRX_LINE_ID "Customer Transaction Line ID",
RDL.CUST_TRX_LINE_GL_DIST_ID "GL Distribution Line ID",
RDL.CODE_COMBINATION_ID "Code Combination ID",
RDL.SET_OF_BOOKS_ID "Ledger ID",
RDL.PERCENT "Percent",
AMOUNT "Amount",
GL_DATE "GL Date",
GL_POSTED_DATE "GL Posted Date",
ACCOUNT_CLASS "Account Class",
ACCOUNT_SET_FLAG "Account Set Flag",
ACCTD_AMOUNT "Revenue Recognized",
EVENT_ID "Event ID",
COGS_REQUEST_ID "COGS Request ID",
RDL.REQUEST_ID "AR Request ID"
FROM RA_CUST_TRX_LINE_GL_DIST_ALL RDL,
(SELECT CUSTOMER_TRX_LINE_ID,
CUSTOMER_TRX_ID,
INVENTORY_ITEM_ID,
...
AND RAL.SALES_ORDER = ORDER_NUMBER
AND INVOICE_INTERFACE_STATUS_CODE = ''YES'')) E
WHERE E.CUSTOMER_TRX_ID = RDL.CUSTOMER_TRX_ID
AND E.CUSTOMER_TRX_LINE_ID = RDL.CUSTOMER_TRX_LINE_ID
ORDER BY 1,3',
      p_title                  => 'Sales Orders with Revenue Recognition',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Sales Orders which are Revenue Recognized.',
      p_solution               => '',
      p_success_msg            => 'This is the amount recognized for each Sales Order. <br><br>
You need to check if this revenue has been posted in GL and which is the Percent (the same percent will be used for COGS recognition).<br><br>
Also need to check COGS_REQUEST_ID to see if Collect Revenue Recognition Information was run or not.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CST_COGS_SO_WITH_REV');



debug('begin add_signature: CST_COGS_SO_WITH_COGS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11275',
      p_sig_id                 => 'CST_COGS_SO_WITH_COGS',
      p_sig_sql                => 'SELECT distinct
E.SALES_ORDER "Order Number",
E.SALES_ORDER_DATE "Order Date",
E.SALES_ORDER_LINE "Order Line",
A.EVENT_DATE "Event Date",
A.MMT_TRANSACTION_ID "Inventory Transaction",
MSI.SEGMENT1 "Item Name",
decode(A.COGS_PERCENTAGE,0,''0%'',1,''100%'',A.COGS_PERCENTAGE*100) "COGS Percentage",
decode(A.COSTED,''N'',''Not costed'',''E'',''Error'',null,''Costed'') "Costed Status",
DECODE(C.POTENTIALLY_UNMATCHED_FLAG,''Y'',''Only Revenue Recognized'',''P'',''Unprocessed'',''I'',''Investigation required'',null,''COGS recognized'') "COGS Recognition Status",
decode(C.REVENUE_RECOGNITION_PERCENT,1,''100%'',0,''0%'',C.REVENUE_RECOGNITION_PERCENT*100) "Revenue Recognition Percentage"
FROM CST_COGS_EVENTS A,
CST_REVENUE_COGS_MATCH_LINES B,
CST_REVENUE_RECOGNITION_LINES C,
MTL_SYSTEM_ITEMS_B MSI,
...
AND CUSTOMER_TRX_LINE_ID = RDL.CUSTOMER_TRX_LINE_ID))
ORDER BY 1,3,5',
      p_title                  => 'Sales Orders with COGS Recognition',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Sales Orders which are COGS Recognized.',
      p_solution               => '',
      p_success_msg            => 'For these Sales Orders COGS has been recognized. <br><br>
Need to check Costed status and COGS recognition status.<br><br>
COGS recognition status will be null if Generate COGS Recognition events program is run successfully. If it is Only Revenue Recognized then only Collect Revenue <br><br> Recognition program has been run from AR Responsibility , but Generate COGS Recognition Events program has not been run. If the status is Unprocessed then these are <br><br> unprocessed records.<br><br>
COGS_Percentage = ''1''[COGS Percentage ''1'' signifies 100%].',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CST_COGS_SO_WITH_COGS');



debug('begin add_signature: CST_COGS_EVENTS UNPROCESSED OR FAILED IN SLA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11374',
      p_sig_id                 => 'CST_COGS_EVENTS UNPROCESSED OR FAILED IN SLA',
      p_sig_sql                => 'SELECT count (*), xe.event_type_code, xe.event_date, xe.event_status_code,decode(xe.process_status_code, ''U'', ''Unprocessed'', ''I'',''Error'', ''Unprocessable'')Process_status_code
, xte.security_id_int_1 organization_id, xte.ledger_id 
FROM xla_events xe, xla_transaction_entities_upg xte
WHERE xe.application_id = 707
AND xte.application_id = 707
AND xe.event_type_code IN ( select EVENT_TYPE_CODE from xla_event_types_vl
    where application_id=707 
    and entity_code=''MTL_ACCOUNTING_EVENTS''
    and event_class_code=''SALES_ORDER'')
 AND xe.event_status_code in (''I'', ''U'')
 AND xe.process_status_code !=''P''  
 AND xe.entity_id = xte.entity_id
 AND xte.ledger_id=##$$Ledger_id$$##
 AND xe.event_date <= sysdate
 AND EXISTS
   (SELECT 1 FROM mtl_transaction_accounts mta
    WHERE mta.transaction_id = xte.source_id_int_1)
    group by xe.event_type_code, xe.event_date, xe.event_status_code, xe.process_status_code, xte.security_id_int_1 , xte.ledger_id
    order by xe.event_date asc',
      p_title                  => 'COGS Events Unprocessed or Failed in SLA',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are COGS Events Unprocessed or Failed in SLA.
',
      p_solution               => 'Refer to [1457611/KB752540] What is the Meaning of EVENT_STATUS_CODE and PROCESS_STATUS_CODE in XLA_EVENTS Table.<br><br>

If the EVENT_STATUS_CODE is Unprocessed and PROCESS_STATUS_CODE is Unprocessed, then Please run Create Accounting - Cost Management Program.<br>
If the EVENT_STATUS_CODE is Unprocessed and PROCESS_STATUS_CODE is Invalid, then please run the Create Accounting - Cost Management Program <br>
with FND debug enabled and provide the accounting program FND debug log for further analysis.
',
      p_success_msg            => 'There are no unprocessed or failed COGS Events.<br>
xla_events.event_status_code = Processed.<br>
xla_events.process_status_code = Processed.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CST_COGS_EVENTS UNPROCESSED OR FAILED IN SLA');



debug('begin add_signature: CST_COGS_EVENTS UNTRANSFERRED OR NOT TRANSFERABLE FROM SLA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11375',
      p_sig_id                 => 'CST_COGS_EVENTS UNTRANSFERRED OR NOT TRANSFERABLE FROM SLA',
      p_sig_sql                => 'select xe. EVENT_TYPE_CODE, gps.effective_period_num, xah.accounting_entry_status_code, xah.gl_transfer_status_code,  
xah.ledger_id "LEDGER", xah.period_name XLA_PERIOD, gps.period_name GL_PERIOD, gps.closing_status GL_PERIOD_CLOSING_STATUS
, count(1)
...
and  xe.event_type_code IN ( select EVENT_TYPE_CODE from XLA_EVENT_TYPES_B
    where application_id=707 
    and entity_code=''MTL_ACCOUNTING_EVENTS''
    and event_class_code=''SALES_ORDER'')
...
and gps.set_of_books_id= xah.ledger_id
and xah.accounting_date between gps.start_Date and gps.end_Date
group by  xe.EVENT_TYPE_CODE, xah.accounting_entry_status_code,xah.gl_transfer_status_code, xah.ledger_id, gps.period_name , xah.period_name,
gps.effective_period_num,gps.closing_status
order by   gps.effective_period_num ,xe.EVENT_TYPE_CODE , xah.ledger_id',
      p_title                  => 'COGS Events Untransferred or Non-Transferable from SLA',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are COGS Events which have not been transferred to GL or cannot be transferred to GL.',
      p_solution               => 'Run Transfer Journal Entries to GL - Cost Management process and verify if the records are getting processed.<br>
If the records are not getting processed, please refer to [951233/KB339228] Errors while running Journal Import from SLA/Create Accounting Or Transfer to GL does not pick rows/Fails<br>
for specific error condition and follow the steps. ',
      p_success_msg            => 'There are no COGS Events which have not been transferred to GL or cannot be transferred to GL.<br>
xla_ae_headers.gl_transfer_status_code = ''Y''<br>
xla_ae_headers.gl_transfer_date is Not Null',
   ...
   l_info.delete;
debug('end add_signature: CST_COGS_EVENTS UNTRANSFERRED OR NOT TRANSFERABLE FROM SLA');



debug('begin add_signature: CST_COGS_DUPLICATE_ACCOUNTING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11421',
      p_sig_id                 => 'CST_COGS_DUPLICATE_ACCOUNTING',
      p_sig_sql                => 'SELECT transaction_id, transaction_date , organization_id, primary_quantity, 
transaction_type_id, transaction_action_id, transaction_source_type_id, trx_source_line_id om_line_id FROM mtl_material_transactions WHERE transaction_id IN
...
having count(mta.inv_sub_ledger_id) > 1 )',
      p_title                  => 'COGS Transactions with Duplicate Accounting',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'COGS transaction(s) with duplicate accounting exists. Due to this issue, the DCOGS/COGS Accounts might be affected.
',
      p_solution               => 'May need to create GL manual adjustments, and may need to apply a patch.  Please review the following documents for more information:<br>
[1227963/KB786363] Duplicate Accounting Is Created Against COGS Recognition Transactions.<br>
[1103513/KB764577] DUPLICATE COGS RECOGNITIONS TRANSACTIONS

',
      p_success_msg            => 'There are no COGS Transactions with Duplicate Accounting.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CST_COGS_DUPLICATE_ACCOUNTING');



debug('begin add_signature: CST_COGS_TRANSACTIONS_WITH_MISSING_XLA_EVENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11422',
      p_sig_id                 => 'CST_COGS_TRANSACTIONS_WITH_MISSING_XLA_EVENTS',
      p_sig_sql                => 'SELECT mmt.transaction_id, mmt.organization_id
  from mtl_material_transactions mmt
  ,    cst_acct_info_v           caiv
  where mmt.transaction_type_id = 10008
  and mmt.transaction_date between ''##$$Start_Date$$##'' AND ''##$$End_Date$$##''
  and exists (select null from mtl_transaction_accounts mta
              where mta.transaction_id = mmt.transaction_id)
  and not exists (select null from xla.xla_transaction_entities n
                 where n.application_id = 707
                 and n.ledger_id =##$$Ledger_id$$##
                 and n.entity_code = ''MTL_ACCOUNTING_EVENTS''
                 and NVL(n.source_id_int_1,-99) = mmt.transaction_id)
  and caiv.organization_id = mmt.organization_id',
      p_title                  => 'COGS Transactions without XLA Events',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'COGS Transaction(s) without XLA Events exists. Due to this issue, the DCOGS/COGS Accounts might be affected.
',
      p_solution               => 'Need to log an SR with Support to get the datafix for existing COGS transactions which do not have XLA events.<br>
Reference unpublished [1669783/KB723490] XLA Accounting Events Missing For COGS Recognition for assistance.




',
      p_success_msg            => 'All COGS Transaction(s) have XLA Events.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CST_COGS_TRANSACTIONS_WITH_MISSING_XLA_EVENTS');



debug('begin add_signature: CST_COGS_TRANSACTIONS_WITHOUT_DISTRIBUTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11418',
      p_sig_id                 => 'CST_COGS_TRANSACTIONS_WITHOUT_DISTRIBUTIONS',
      p_sig_sql                => 'SELECT event_id ,cogs_om_line_id, event_date, mmt_transaction_id, cogs_percentage,prior_cogs_percentage, prior_event_id, event_type, event_quantity, costed, parent_event_id, last_update_date, creation_date
  FROM cst_cogs_events
 WHERE event_type = 3
   AND (costed = ''N'' OR
        (costed IS NULL AND
         cogs_percentage = prior_cogs_percentage))
   AND cogs_om_line_id IN (
   SELECT cce.cogs_om_line_id
     FROM cst_cogs_events cce,
          mtl_transaction_accounts mta
    WHERE cce.mmt_transaction_id = mta.transaction_id
      AND mta.accounting_line_type = 36
      AND mta.transaction_date >=''##$$Start_Date$$##'' /* The date in first period   which has DCOGS balance. If need, remove this condition.*/
      GROUP BY cce.cogs_om_line_id
      HAVING Sum(mta.base_transaction_value) > 0)',
      p_title                  => 'COGS Recognition Events are Generated but no Distributions found in Material Distributions Window',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Data corruption in CST_COGS_EVENTS and MTL_MATERIAL_TRANSACTIONS tables. No accounting distributions in MTL_TRANSACTION_ACCOUNTS table.<br>

',
      p_solution               => 'Need a data fix. Please review  [2251408/KB756840] Costed flag is N for COGS transaction in CST_COGS_EVENTS table.<br>

 ',
      p_success_msg            => 'There are no COGS Recognition Events without distributions in Material Distributions Window. ',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: CST_COGS_TRANSACTIONS_WITHOUT_DISTRIBUTIONS');



debug('begin add_signature: CST_COGS TRANSACTIONS COSTED TWICE OR MORE BY COST MANAGER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11377',
      p_sig_id                 => 'CST_COGS TRANSACTIONS COSTED TWICE OR MORE BY COST MANAGER',
      p_sig_sql                => 'SELECT  ent.source_id_int_1 transaction_id ,ent.source_id_int_2 organization_id, ev.event_type_code
...
and ev.event_type_code IN ( select EVENT_TYPE_CODE from XLA_EVENT_TYPES_B
where application_id=707
and entity_code=''MTL_ACCOUNTING_EVENTS''
and event_class_code=''SALES_ORDER'')
AND ent.entity_id       = ev.entity_id
AND NVL(ev.budgetary_control_flag,''N'') = ''N''
AND ev.process_status_code = ''P''
GROUP BY ent.source_id_int_1 ,ent.source_id_int_2, ev.event_type_code
HAVING count(*) > 1',
      p_title                  => 'COGS Related Transactions Costed Twice or More by Cost Manager',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'COGS related transactions which have been costed twice or more by Cost Manager and the accounting data has been already processed by Create Accounting.<br>
Due to this issue, the DCOGS/COGS Accounts might be affected.
',
      p_solution               => 'See the Solutions in [1617589/KB794361] Duplicate Entries found in Material Transaction Distribution Form Error CSTPSISC.INS_STD_COST (75): ORA-00001.
',
      p_success_msg            => 'There are no COGS related transactions which have been costed twice or more by Cost Manager.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: CST_COGS TRANSACTIONS COSTED TWICE OR MORE BY COST MANAGER');
...
debug('begin add_signature: CST_SLA_INVALIDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7104',
      p_sig_id                 => 'CST_SLA_INVALIDS',
      p_sig_sql                => 'SELECT
    a.object_name   object_name,
    decode(a.object_type, ''PACKAGE'', ''Package Spec'', ''PACKAGE BODY'', ''Package Body'',
           a.object_type) type,
    substr(ltrim(rtrim(substr(substr(s.text, instr(s.text, ''Header: '')), instr(substr(s.text, instr(s.text, ''Header: '')), '' '', 1,
    1), instr(substr(s.text, instr(s.text, ''Header: '')), '' '', 1, 2) - instr(substr(s.text, instr(s.text, ''Header: '')), '' '', 1, 1)
    ))), 1, 25)
    || substr(ltrim(rtrim(substr(substr(s.text, instr(s.text, ''Header: '')), instr(substr(s.text, instr(s.text, ''Header: '')), '' '',
    1, 2), instr(substr(s.text, instr(s.text, ''Header: '')), '' '', 1, 3) - instr(substr(s.text, instr(s.text, ''Header: '')), '' '', 1,
    2)))), 1, 30) "File version",
    b.text          "Error Text"
FROM
    user_objects   a,
...
WHERE
    ...
    AND s.line (+) = 2
    AND ( a.object_name LIKE ''CST%''
          OR a.object_name LIKE ''MTL_%''
          OR a.object_name LIKE ''XLA%''
          OR a.object_name LIKE ''WIP_%''
          OR a.object_name LIKE ''RCV_%'' )
    AND a.status = ''INVALID''',
      p_title                  => 'Cost Management Related Invalid Objects',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Cost Management Related Invalid Objects',
...
',
      p_success_msg            => 'No Cost Management related invalid objects exists in the database.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CST_SLA_INVALIDS');
...
BEGIN
  ...
  analyzer_title := 'Cost Management COGS/DCOGS Analyzer';
...
debug('begin section: Organizations_Costing_Info_Details');
start_section('Organizations & Costing Information ', 'Organizations_Costing_Info_Details');
   set_item_result(run_stored_sig('CST_INVENTORY_ORGANIZATIONS'));
   set_item_result(run_stored_sig('CST_ORGANIZATION_ACCOUNTS'));
   set_item_result(run_stored_sig('CST_PROFILE_OPTIONS'));
   set_item_result(run_stored_sig('CST_ORG_ACCT_PERIODS'));
   set_item_result(run_stored_sig('CST_COST_MANAGER_STATUS'));
   set_item_result(run_stored_sig('CST_SHIPPING_NETWORK_PARAMETERS'));
   set_item_result(run_stored_sig('CST_PJM_ENABLED_ORGS'));
   set_item_result(run_stored_sig('CST_PJM_ORG_PARAMETERS'));
   set_item_result(run_stored_sig('CST_WIP_ORG_PARAMETERS'));
   set_item_result(run_stored_sig('CST_MTL_TRANSACTION_TYPES'));
end_section;
debug('end section: Organizations_Costing_Info_Details');

debug('begin section: COGS_Issues');
IF g_sql_tokens('##$$COGS_Issues$$##') = 'Y' THEN
   start_section('COGS Sales Order Related Information', 'COGS_Issues');
      set_item_result(run_stored_sig('CST_COGS_SALES_ORDER_HEADER'));
      set_item_result(run_stored_sig('CST_COGS_ SALES ORDER LINE DETAILS'));
      set_item_result(run_stored_sig('CST_COGS MMT DATA FOR COGS ISSUE'));
      set_item_result(run_stored_sig('CST_COGS MTA DATA FOR COGS RECOGNITION ISSUE'));
      set_item_result(run_stored_sig('CST_COGS CST_REVENUE_COGS_MATCH_LINES'));
      set_item_result(run_stored_sig('CST_COGS CST_COGS_EVENTS'));
      set_item_result(run_stored_sig('CST_COGS_CST_REVENUE_RECOGNITION_LINES'));
      set_item_result(run_stored_sig('CST_COGS RA_CUST_TRX_LINE_GL_DIST_ALL'));
      set_item_result(run_stored_sig('CST_COGS_AR_INVOICE_HEADER_INFORMATIONS'));
      set_item_result(run_stored_sig('CST_COGS_AR_INVOICE_LINE _INFORMATIONS'));
      set_item_result(run_stored_sig('CST_COGS MTL_TRANSACTIONS_INTERFACE'));
      set_item_result(run_stored_sig('EBS_MFG_DM_CSTCOGS_CST_COGS_TXN_DATA_CORRUPTION_AR'));
      set_item_result(run_stored_sig('EBS_MFG_DM_CSTCOGS_CST_COGS_CST_REVENUE_RECOGNITION_LINES_NO_DATA'));
      set_item_result(run_stored_sig('EBS_MFG_DM_CSTCOGS_CST_COGS_RECOGNITION_INVALID_ITEM'));
      set_item_result(run_stored_sig('EBS_MFG_DM_CSTCOGS_CST_COGS_COGS_REQUEST_ID_NULL'));
      set_item_result(run_stored_sig('EBS_MFG_DM_CSTCOGS_CSTRCMVB_VERSION'));
      set_item_result(run_stored_sig('EBS_MFG_DM_CSTCOGS_ARCGSRVB_VERSION'));
      set_item_result(run_stored_sig('EBS_MFG_DMEF_CSTCOGS_RMA_BEF_COGS_REC'));
      set_item_result(run_stored_sig('EBS_MFG_DMEF_CSTCOGS_ZERO_COST_TXN'));
   end_section;
END IF;
debug('end section: COGS_Issues');

debug('begin section: DCOGS_Issues');
IF g_sql_tokens('##$$COGS_Issues$$##') = 'N' THEN
   start_section('DCOGS Issues', 'DCOGS_Issues');
      set_item_result(run_stored_sig('CST_COGS POTENTIALLY_UNMATCHED_FLAG IS P'));
      set_item_result(run_stored_sig('CST_COGS POTENTIALLY_UNMATCHED_FLAG IS I'));
      set_item_result(run_stored_sig('CST_COGS COGS NOT GETTING RECOGNSIED FOR SHIP ONLY SALES ORDER.'));
      set_item_result(run_stored_sig('CST_COGS_INVOICED SALES ORDERS BUT DATA NOT MOVED TO AR'));
      set_item_result(run_stored_sig('CST_COGS_INV_DISTRIBUTIONS_SO'));
      set_item_result(run_stored_sig('CST_COGS_INV_NOT_CREATED_FOR_SO'));
      set_item_result(run_stored_sig('CST_COGS_INV_SO_TO_AR'));
      set_item_result(run_stored_sig('CST_COGS_INV_TRANS_SO'));
      set_item_result(run_stored_sig('CST_COGS_REV_RECOGNITION'));
      set_item_result(run_stored_sig('CST_COGS_SO_CREATED_OR_SHIPPED'));
      set_item_result(run_stored_sig('CST_COGS_SO_WITHIN_PERIOD'));
      set_item_result(run_stored_sig('CST_COGS_SO_WITH_REV'));
      set_item_result(run_stored_sig('CST_COGS_SO_WITH_COGS'));
      set_item_result(run_stored_sig('CST_COGS_EVENTS UNPROCESSED OR FAILED IN SLA'));
      set_item_result(run_stored_sig('CST_COGS_EVENTS UNTRANSFERRED OR NOT TRANSFERABLE FROM SLA'));
      set_item_result(run_stored_sig('CST_COGS_DUPLICATE_ACCOUNTING'));
      set_item_result(run_stored_sig('CST_COGS_TRANSACTIONS_WITH_MISSING_XLA_EVENTS'));
      set_item_result(run_stored_sig('CST_COGS_TRANSACTIONS_WITHOUT_DISTRIBUTIONS'));
      set_item_result(run_stored_sig('CST_COGS TRANSACTIONS COSTED TWICE OR MORE BY COST MANAGER'));
      set_item_result(run_stored_sig('EBS_MFG_DM_CSTCOGS_CST_COGS_RECOGNITION_INVALID_ITEM'));
   end_section;
END IF;
debug('end section: DCOGS_Issues');
...
start_section('Proactive Recommendations', 'Proactive_Recommendations');
   set_item_result(run_stored_sig('CST_SLA_INVALIDS'));
   set_item_result(check_rec_patches_1); /* Signature CST_REC_PATCHS */
end_section;
