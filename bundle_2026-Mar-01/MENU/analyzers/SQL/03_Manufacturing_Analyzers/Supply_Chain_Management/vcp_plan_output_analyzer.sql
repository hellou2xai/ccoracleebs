...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for VCP Planning Output Setup Analyzer     |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE vcp_plan_output_analyzer_pkg AUTHID DEFINER AS
...
END vcp_plan_output_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY vcp_plan_output_analyzer_pkg AS
-- $Id: vcp_plan_output_analyzer.sql, 200.92 2026/01/28 14:17:06 oracle Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2315022.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'VCP_PLAN_OUTPUT_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'VCP_PLAN_OUTPUT_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>VCP_PLAN_OUTPUT Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2315022.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/vcp_plan_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1254,EBS,EBS MFG,EBS - Value Chain Planning" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1254,EBS,EBS MFG,EBS - Value Chain Planning" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1254,EBS,EBS MFG,EBS - Value Chain Planning" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/mosc/discussion/4090257" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">1254</span>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1254,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Value Chain Planning" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1254,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Value Chain Planning" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1254,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Value Chain Planning" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Instance Code';
...
-- Revision and date values can be populated by RCS
  l_revision := rtrim(replace('$Revision: 200.92  $','$',''));
  l_revision := ltrim(replace(l_revision,'Revision:',''));
  l_date_char := rtrim(replace('$Date: 2026/01/28 14:17:05 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'vcp_plan_output_analyzer.sql';
...
debug('begin parameter validation: p_instance_code');
IF p_instance_code IS NOT NULL THEN
BEGIN
SELECT INSTANCE_CODE
INTO l_exists_val
FROM MSC_APPS_INSTANCES
WHERE INSTANCE_CODE = p_instance_code and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Instance Code is not valid.  Enter a valid Instance Code or press Enter to skip if you use MRP ONLY.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_instance_code failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_instance_code');
...
SELECT decode(substr(m2a_dblink,1,50), null, 'zzz', substr(m2a_dblink,1,50))
into l_remote_schema
...
debug('begin populate sql tokens hash table');
   ...
   g_sql_tokens('##$$MYSCHEMA$$##') := g_remote_schema;
...
debug('begin add_signature: MSC_VIOLATE_ORDER_MODIFIER_SS_PROFILE_CHECK');
   l_info('##MASK##USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7679',
      p_sig_id                 => 'MSC_VIOLATE_ORDER_MODIFIER_SS_PROFILE_CHECK',
...
and fpo.profile_option_name LIKE (''%MSC_VIOLATE_ORDER_MODIFIER_SS%'')
and fpov.profile_option_value != ''1''
 order by 1,3',
      p_title                  => 'MSC: Split Planned Order to perform safety stock pegging',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is set to split planned orders',
      p_solution               => 'Please follow the solution steps outlined in:<BR>
<BR>
[2344610/KB753295] When using Safety Stock with ASCP Plans, Planned Orders are Split Unexpectedly',
      p_success_msg            => 'The profile is not set to split planned orders.',
   ...
   l_info.delete;
debug('end add_signature: MSC_VIOLATE_ORDER_MODIFIER_SS_PROFILE_CHECK');



debug('begin add_signature: MSO_SCO_MRP_SS_LOGIC_PROFILE_CHECK');
   l_info('##MASK##USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7694',
      p_sig_id                 => 'MSO_SCO_MRP_SS_LOGIC_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
 fpo.profile_option_name Profile,
        fpov.profile_option_value Value,
        decode(fpov.level_id,10001,
 ...
 and fu.user_id(+)=fpov.level_value
 and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_SCO_MRP_SS_LOGIC%'')
and fpov.profile_option_value IS NOT NULL
 order by 1,3',
      p_title                  => 'MSO: Number of LP Phases for Safety Stock Calculation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is NOT set to NULL',
      p_solution               => 'Please follow the steps outlined in: <BR>
<BR>
[2344693/KB760520#MSO_Number_of_LP_Phases_for_Safety_Stock_Calculation] ASCP Plan is not Behaving As Expected',
      p_success_msg            => 'This profile option is set to NULL (it is blank).  This is the correct setting unless requested otherwise by Oracle Development.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSO_SCO_MRP_SS_LOGIC_PROFILE_CHECK');



debug('begin add_signature: MSO_TRANS_SS_SUPPLY_CHOICE_PROFILE_CHECK');
   l_info('##MASK##USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7735',
      p_sig_id                 => 'MSO_TRANS_SS_SUPPLY_CHOICE_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE ''%MSO_TRANS_SS_SUPPLY_CHOICE%''
and fpov.profile_option_value = ''1''
order by 1,3',
      p_title                  => 'MSO: Supplies used for satisfying transient safety stock',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is set to "Supplies pegging to lower priority demands" (Value = 1).  This is known to cause high Projected Available Balance (PAB).  Be sure this is the proper setting, based upon your business requirements.',
      p_solution               => 'Follow the solution steps in:<BR>
<BR>
[2344611/KB771317] When Running an ASCP Plan, the Plan Output Shows High Project Available Balance (PAB)',
      p_success_msg            => 'The profile option is set to "Closest pegged supplies" (Value = 2).  This setting helps relieve high Projected Available Balance (PAB).',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSO_TRANS_SS_SUPPLY_CHOICE_PROFILE_CHECK');



debug('begin add_signature: MSO_SS_WINDOW_SIZE_PROFILE_CHECK');
   l_info('##MASK##USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7736',
      p_sig_id                 => 'MSO_SS_WINDOW_SIZE_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE ''%MSO_SS_WINDOW_SIZE%''
and fpov.profile_option_value IS NULL
order by 1,3',
      p_title                  => 'MSO: Supply Reschedule Window Size for Safety Stock Pegging',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is set to NULL (it is blank).  If this profile option is not set, it could lead to high Project Available Balance (PAB) in the plan output.',
      p_solution               => 'Refer to the following note for the proposed solution:<BR>
<BR>
[2344612/KB759339] When Running an ASCP Plan, high Project Available Balance (PAB) occurs in the Plan Output',
      p_success_msg            => 'This profile option is NOT NULL.  If high Projected Available Balanace (PAB) is a concern, this is the correct setting.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSO_SS_WINDOW_SIZE_PROFILE_CHECK');



debug('begin add_signature: MSC_SS_INTERVAL_DAYS_PROFILE_CHECK');
   l_info('##MASK##USER1'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##USER2'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7791',
      p_sig_id                 => 'MSC_SS_INTERVAL_DAYS_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile1,
fpov.profile_option_value Value1,
decode(fpov.level_id,10001,
''SITE'',10002,
''APPLICATION'',10003,
''RESPONSIBILITY'',
10004,''USER'')"LEVEL1",
fu.user_name "USER1",
fpo1.user_profile_option_name,
fpo1.profile_option_name Profile2,
fpov1.profile_option_value Value2,
decode(fpov1.level_id,10001,
''SITE'',10002,
''APPLICATION'',10003,
''RESPONSIBILITY'',
10004,''USER'')"LEVEL2",
fu1.user_name "USER2",
fa.application_short_name App1,
fa1.application_short_name App2,
fr.responsibility_name Responsibility1,
fr1.responsibility_name Responsibility2
from fnd_profile_option_values fpov, -- FND_PROFILE_OPTIONS_VL
fnd_profile_option_values fpov1,
fnd_profile_options_vl fpo,
fnd_profile_options_vl fpo1,
fnd_application fa,
fnd_application fa1,
fnd_responsibility_vl fr,
fnd_responsibility_vl fr1,
fnd_user fu,
fnd_user fu1,
fnd_logins fl,
fnd_logins fl1
where fpo.profile_option_id=fpov.profile_option_id(+)
and fpo1.profile_option_id=fpov1.profile_option_id(+)
and fa.application_id(+)=fpov.level_value
and fa1.application_id(+)=fpov1.level_value
and fr.application_id(+)=fpov.level_value_application_id
and fr1.application_id(+)=fpov1.level_value_application_id
and fr.responsibility_id(+)=fpov.level_value
and fr1.responsibility_id(+)=fpov1.level_value
and fu.user_id(+)=fpov.level_value
and fu1.user_id(+)=fpov1.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fl1.login_id(+) = fpov1.LAST_UPDATE_LOGIN
and NOT (fpov.level_id = ''10004'' and fpov1.level_id = ''10004'' and fu.user_name <> fu1.user_name)
and (fpo.profile_option_name LIKE ''%MSC_USE_FIFO_PEGGING%'' and fpov.profile_option_value = ''Y'')
and (fpo1.profile_option_name LIKE ''%MSC_SS_INTERVAL_DAYS%'' and to_number(regexp_substr(fpov1.profile_option_value,''([[:digit:]])+'')) > 0)',
      p_title                  => 'MSC: Safety stock change interval (Days) versus MSC: Use FIFO Pegging',
      p_fail_condition         => 'RS',
      p_problem_descr          => '"MSC: Safety stock change interval (Days)" is set to something greater than zero, indicating that you are trying to use safety stock smoothing.  However, "MSC: Use FIFO Pegging" is set to "Yes" which cancels out any smoothing.',
      p_solution               => 'Refer to the following note for the proposed solution:<BR>
<BR>
[2344626/KB727599] Safety Stock Smoothing Profile Options Are Not Working Properly When Running ASCP Plans',
      p_success_msg            => 'The Safety Stock smoothing profile option "MSC: Safety stock change interval (Days)" is set to something greater than zero, and "MSC: Use FIFO Pegging" is set to "No". <BR>
<BR>
This is the correct combination of settings for these two profile options if you want to use the Safety Stock smoothing functionality.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSC_SS_INTERVAL_DAYS_PROFILE_CHECK');



debug('begin add_signature: MSC_SS_SMOOTHING_METHOD_PROFILE_CHECK');
   l_info('##MASK##USER1'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##USER2'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8239',
      p_sig_id                 => 'MSC_SS_SMOOTHING_METHOD_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile1,
fpov.profile_option_value Value1,
decode(fpov.level_id,10001,
...
and NOT (fpov.level_id = ''10004'' and fpov1.level_id = ''10004'' and fu.user_name <> fu1.user_name)
and (fpo.profile_option_name LIKE ''%MSC_USE_FIFO_PEGGING%'' and fpov.profile_option_value = ''Y'')
and (fpo1.profile_option_name LIKE ''%MSC_SS_SMOOTHING_METHOD%'' and fpov1.profile_option_value IS NOT NULL)',
      p_title                  => 'MSC: Smoothing method to calculate Safety stock within Change interval versus MSC: Use FIFO Pegging',
      p_fail_condition         => 'RS',
      p_problem_descr          => '"MSC: Smoothing method to calculate Safety stock within Change interval" is NOT NULL indicating that you are trying to use Safety Stock smoothing.  However, "MSC: Use FIFO Pegging" is set to "Yes", which cancels any safety stock smoothing.',
      p_solution               => 'Refer to the following note for the proposed solution:<BR>
<BR>
[2344626/KB727599] Safety Stock Smoothing Profile Options Are Not Working Properly When Running ASCP Plans',
      p_success_msg            => '"MSC: Use FIFO Pegging" is set to "No" and the Safety Stock smoothing profile option "MSC: Smoothing method to calculate Safety stock within Change interval" is set to one of the following values: <BR>
<BR>
1 - Minimum<BR>
2 - Average (Default)<BR>
3 - Maximum<BR>
<BR>
This is the correct combination of settings for these two profile options if you want to use the Safety Stock smoothing functionality.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: MSC_SS_SMOOTHING_METHOD_PROFILE_CHECK');



debug('begin add_signature: MSC_SS_MIN_VARIATION_PROFILE_CHECK');
   l_info('##MASK##USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8372',
      p_sig_id                 => 'MSC_SS_MIN_VARIATION_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE ''%MSC_SS_MIN_VARIATION%''
and fpov.profile_option_value = ''0''',
      p_title                  => 'MSC: Minimum Percentage variation in safety stock values',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The profile is set to 0 or default.  When this profile option is set to 0 all deviations to safety stock will be ignored.  If this is the desired behavior from the plan output, this warning may be ignored.',
      p_solution               => 'Refer to the following note for the proposed solution:<BR>
<BR>
[2344641/KB778114] When Running an ASCP Plan, all deviations to Safety Stock are being ignored',
      p_success_msg            => 'This profile option is set to a value greater than 0.  Deviations to safety stock will be smoothed to withing this percentage.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSC_SS_MIN_VARIATION_PROFILE_CHECK');



debug('begin add_signature: MSC_SS_MAX_VARIATION_PROFILE_CHECK');
   l_info('##MASK##USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8376',
      p_sig_id                 => 'MSC_SS_MAX_VARIATION_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE ''%MSC_SS_MAX_VARIATION%''
and fpov.profile_option_value is NULL',
      p_title                  => 'MSC: Maximum Percentage variation in safety stock values',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The profile is set to NULL (it is blank).  When this profile option is set to NULL, it allows any deviation to safety stock.  If this is the desired behavior from the plan output, this warning may be ignored.',
      p_solution               => 'Refer to the following note for the proposed solution:<BR>
<BR>
[2344629/KB750481] Safety Stock is Deviating More Than Expected In Plan Output',
      p_success_msg            => 'This profile option is set to a non-NULL value.  This is the correct setting.  <br>
The safety stock is not allowed to deviate by more than the profile option setting between two adjacent time intervals.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSC_SS_MAX_VARIATION_PROFILE_CHECK');



debug('begin add_signature: MSC_SS_SMOOTH_NON_MRP_PROFILE_CHECK');
   l_info('##MASK##USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7895',
      p_sig_id                 => 'MSC_SS_SMOOTH_NON_MRP_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE ''%MSC_SS_SMOOTH_NON_MRP%''
and fpov.profile_option_value = ''N''',
      p_title                  => 'MSC: Apply Safety Stock Change interval to non MRP Planned Safety Stock',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is set to "No" in the application (it will appear as "N" in the backend and the SQL results above). With this setting, smoothing applies only to MRP planned safety stock. <br>
Verify this is the desired behavior per your business requirements.',
      p_solution               => 'Refer to the following note for the proposed solution:<BR>
<BR>
[2344662/KB786476] Safety Stock Smoothing Only Applies to MRP Planned Safety Stock Instead of All Safety Stock',
      p_success_msg            => 'This profile option is set to "Yes" in the application.  This will apply smoothing to all safety stock.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSC_SS_SMOOTH_NON_MRP_PROFILE_CHECK');



debug('begin add_signature: MSO_DEFAULT_TIMESTAMP_SFTSTC_PROFILE_CHECK');
   l_info('##MASK##USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7893',
      p_sig_id                 => 'MSO_DEFAULT_TIMESTAMP_SFTSTC_PROFILE_CHECK',
      p_sig_sql                => 'select COMPILE_DESIGNATOR, CURR_PLAN_TYPE from MSC_PLANS
where CURR_PLAN_TYPE = 4
and exists (select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
''SITE'',10002,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE ''%MSO_DEFAULT_TIMESTAMP_SFTSTC%''
and fpov.profile_option_value = ''E'')',
      p_title                  => 'MSO: Default Timestamp Safety Stocks',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is set to "End of Day" and you have Inventory Optimization Plans.  This setting is not recommended if you are using Inventory Optimization (IO).  Make sure this is the proper setting per your business requirements.',
      p_solution               => 'Refer to the following note for the proposed solution:<BR>
<BR>
[2344670/KB479998] For Inventory Optimization Plans, the Time Stamps for Supplies do not match the Time Stamps for Safety Stock Requirements',
      p_success_msg            => 'This profile option is set to "Beginning of Day."  This is the correct setting when using Inventory Optimization.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSO_DEFAULT_TIMESTAMP_SFTSTC_PROFILE_CHECK');



debug('begin add_signature: MSC_IGNORE_SS_IN_LEAD_TIME_PROFILE_CHECK');
   l_info('##MASK##USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8380',
      p_sig_id                 => 'MSC_IGNORE_SS_IN_LEAD_TIME_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSC_IGNORE_SS_IN_LEAD_TIME%'')
and fpov.profile_option_value = ''Y''
and exists (select * from fnd_profile_options_vl
where PROFILE_OPTION_NAME = ''MSC_IGNORE_SS_IN_LEAD_TIME'')',
      p_title                  => 'MSC: Ignore Safety Stock calculation inside Time Fence',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is set to "Yes" in the application (it will appear as "Y" in the backend and the SQL results above).  The plan does not create planned orders for Safety Stock, inside item lead time, when this is set to "Yes".<br>
Verify this is the desired behavior per your business requirements.',
      p_solution               => 'Refer to the following note for the proposed solution:<BR>
<BR>
[2344672/KB745768] ASCP Plan is not Creating Planned Orders for Safety Stock Inside of Item Lead Time',
      p_success_msg            => 'This profile option is set to "No" in the application.  This is the recommended setting.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSC_IGNORE_SS_IN_LEAD_TIME_PROFILE_CHECK');



debug('begin add_signature: MSC_MAKE_SS_TRANSIENT_PROFILE_CHECK');
   l_info('##MASK##USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8381',
      p_sig_id                 => 'MSC_MAKE_SS_TRANSIENT_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSC_MAKE_SS_TRANSIENT%'')
and fpov.profile_option_value = ''Y''
and exists (select * from fnd_profile_options_vl
where PROFILE_OPTION_NAME = ''MSC_MAKE_SS_TRANSIENT'')',
      p_title                  => 'MSC: Make Safety Stock Transient',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'You have the profile option "MSC: Make Safety Stock Transient" set to "Yes" in the application (it will appear as "Y" in the backend and the SQL results above). <br>
This setting can cause high Projected Available Balance (PAB) in the sense that MBP pulls in all the lower priority future planned orders <br>
to peg to the current Transient Safety Stock, even when there is Supply in the form of Onhand or<br>
Purchase Orders available.  Make sure this is the desired behavior per your business requirements.',
      p_solution               => 'Refer to the following note for the solution to this issue:<BR>
<BR>
[2344658/KB738258] High Projected Available Balance (PAB) When Using Transient Safety Stock',
      p_success_msg            => 'This profile option is set to "No" in the application.  This is the recommended setting.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: MSC_MAKE_SS_TRANSIENT_PROFILE_CHECK');



debug('begin add_signature: MRP_FIRM_OE_XFERRED_INTERNAL_REQ_PROFILE_CHECK');
   l_info('##MASK##USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8320',
      p_sig_id                 => 'MRP_FIRM_OE_XFERRED_INTERNAL_REQ_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MRP_FIRM_OE_XFERRED_INTERNAL_REQ%'')
and fpov.profile_option_value = ''Y''
order by 1,3',
      p_title                  => 'MRP: Firm Internal Req Transferred to OE',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is set to "Yes" (it will appear as "Y" in the backend and the SQL results above).  This is known to cause time fence issues, planned order creation issues, and overloaded resources in ECC plans.  Verify this is the desired behavior per your business requirements.',
      p_solution               => 'Please follow the solution steps outlined in:<BR>
<BR>
[2345037/KB777194] Unusual Planned Order Behavior and/or Resources Overloaded In An ECC Plan',
      p_success_msg            => 'This profile option is set to "Yes" in the application.  That is the correct setting to avoid issues with planned orders and time fences.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MRP_FIRM_OE_XFERRED_INTERNAL_REQ_PROFILE_CHECK');



debug('begin add_signature: MRP_FIRM_REQS_WITHIN_TF_PROFILE_CHECK');
   l_info('##MASK##USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8321',
      p_sig_id                 => 'MRP_FIRM_REQS_WITHIN_TF_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MRP_FIRM_REQS_WITHIN_TF%'')
and fpov.profile_option_value = ''N''
order by 1,3',
      p_title                  => 'MRP: Net All Purchase Orders Prior To Requisitions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is set to "No" (it will appear as "N" in the backend and the SQL results above).  This setting is known to cause the plan to recommend a new planned order instead of netting existing supplies.  Verify this is the desired behavior per your business requirements.',
      p_solution               => 'Please follow the solution steps outlined in:<BR>
<BR>
[554012/KB228662] ASCP is Ignoring a PO and Creating a New Planned Order',
      p_success_msg            => 'This profile option is set to "Yes" in the application.  This will net existing supplies prior to netting purchase requisitions.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MRP_FIRM_REQS_WITHIN_TF_PROFILE_CHECK');



debug('begin add_signature: MSC_APPLY_OM_TO_START_QTY_PROFILE_CHECK');
   l_info('##MASK##USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8322',
      p_sig_id                 => 'MSC_APPLY_OM_TO_START_QTY_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSC_APPLY_OM_TO_START_QTY%'')
and fpov.profile_option_value = ''Y''
order by 1,3',
      p_title                  => 'MSC: Apply Order Modifier To Start Quantity',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is set to "Yes" (it will appear as "Y" in the backend and the SQL results above).  With this setting, order start quantities can be inflated when using routings with operation yield.  Verify this is the desired behavior per your business requirements.',
      p_solution               => 'Please follow the solution steps outlined in:<BR>
<BR>
[2345090/KB716942] In ASCP Planning, When Using Routings With Operation Yield, Order Start Quantities Appear to be Inflated',
      p_success_msg            => 'This profile option is set to "No" in the application.  This will apply order modifiers to the end quantity.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSC_APPLY_OM_TO_START_QTY_PROFILE_CHECK');



debug('begin add_signature: MSC_APPLY_TOL_PLAN_ORD_PROFILE_CHECK');
   l_info('##MASK##USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8323',
      p_sig_id                 => 'MSC_APPLY_TOL_PLAN_ORD_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSC_APPLY_TOL_PLAN_ORD%'')
and fpov.profile_option_value = ''N''
order by 1,3',
      p_title                  => 'MSC: Apply shortage and excess tolerance to planned orders',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is set to "No" (it will appear as "N" in the backend and the SQL results above). With this setting, the shortage tolerance and excess percentages are applied only to firm existing supplies (such as Onhand, WIP), instead of ALL supplies.  Verify this is the desired behavior per your business requirements.',
      p_solution               => 'Please follow the solution steps outlined in:<BR>
<BR>
[2345111/KB776088] When Running an ASCP Plan, the Shortage Tolerance and Excess Percentages Are Applied Only to Firm Existing Supplies',
      p_success_msg            => 'This profile option is set to "Yes" in the application.  This setting will apply the shortage tolerance and excess percentages to ALL supplies including Planned Orders.  This is the default behavior.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSC_APPLY_TOL_PLAN_ORD_PROFILE_CHECK');



debug('begin add_signature: MSC_BKT_REFERENCE_CALENDAR_PROFILE_CHECK');
   l_info('##MASK##USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8324',
      p_sig_id                 => 'MSC_BKT_REFERENCE_CALENDAR_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSC_BKT_REFERENCE_CALENDAR%'')
and fpov.profile_option_value IS NOT NULL
order by 1,3',
      p_title                  => 'MSC: Calendar Reference for Bucketing',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This profile option is not set (it is blank). When this is not set, the plan owning organization calendar is used for the plan bucketing.  Verify this is the desired behavior per your business requirements.  Note that NOT having this set is also known to cause plan failures and Signal 11 errors.',
      p_solution               => 'Please follow the solution steps outlined in:<BR>
<BR>
[2263407/KB643404] Unconstrained ASCP Plan Pushing Out Sales Order Demand In The Future In Daily Buckets<br>
<br>
Additional References:<br>
[1186856/KB399236] MSC: Calendar Reference For Bucketing is not used in Aggregation Setting in Plan Options<br>
[2060883/KB751129] Period Dates In Horizontal Plan Buckets Do Not Agree With Inventory Accounting Period Dates',
      p_success_msg            => 'This profile option is set.  If this profile option points to a valid calendar, then the plan will use that calendar for bucketing.  
',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: MSC_BKT_REFERENCE_CALENDAR_PROFILE_CHECK');



debug('begin add_signature: MSC_CONSOL_INTERPLANT_DEM_PROFILE_CHECK');
   l_info('##MASK##USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8325',
      p_sig_id                 => 'MSC_CONSOL_INTERPLANT_DEM_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSC_CONSOL_INTERPLANT_DEM%'')
and fpov.profile_option_value = ''2''
order by 1,3',
      p_title                  => 'MSC: Consolidate Interplant Demands',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is set to "By Demand Schedule Supply." With this setting, on a given day the plan will aggregate the dependent demands from one supply.  Interorganization Demand are aggregated into a single demand.  Make sure this is the desired behavior per your business requirements.',
      p_solution               => 'Please follow the solution steps outlined in:<BR>
<BR>
[2345121/KB708051] After Running the ASCP Plan, Interorganization Demands are Aggregated on a Given Day in the Plan Output',
      p_success_msg            => 'This profile option is set to "By End Pegged Demand."<br>
This will retain the default behavior of creating a demand for each end pegged demand.<br>
Interorganization Demand lines will be shown for each individual demand.<br>',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSC_CONSOL_INTERPLANT_DEM_PROFILE_CHECK');



debug('begin add_signature: MSC_DEMAND_SA_PER_THRESHHOLD_PROFILE_CHECK');
   l_info('##MASK##USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8327',
      p_sig_id                 => 'MSC_DEMAND_SA_PER_THRESHHOLD_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSC_DEMAND_SA_PER_THRESHHOLD%'')
and to_binary_float(fpov.profile_option_value) <= 99.9
order by 1,3',
      p_title                  => 'MSC: Demand Satisfied Percent Threshold for Pegging',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is set to a value less than or equal to "99.9."  This is known to play a role in excess planned order creation.',
      p_solution               => 'Please follow the solution steps outlined in:<BR>
<BR>
[2345411/KB723550] The ASCP Plan is Generating Excess Planned Orders',
      p_success_msg            => 'This profile option is set to a value greater than 99.9.  This is the proper setting.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSC_DEMAND_SA_PER_THRESHHOLD_PROFILE_CHECK');



debug('begin add_signature: MSC_INCLUDE_FPO_IN_FAW_PROFILE_CHECK');
   l_info('##MASK##USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8328',
      p_sig_id                 => 'MSC_INCLUDE_FPO_IN_FAW_PROFILE_CHECK',
      p_sig_sql                => 'select COMPILE_DESIGNATOR, CURR_PRIORITY_PEGGING from MSC_PLANS where CURR_PRIORITY_PEGGING = ''1''
and COMPILE_DESIGNATOR like ''ES%''
and exists (select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSC_INCLUDE_FPO_IN_FAW%'')
and fpov.profile_option_value = ''Y'')',
      p_title                  => 'MSC: Include Firm Planned Orders In Firm Allocation Window',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is set to "Yes" in the application and you have one or more ASCP Plans that use Priority Pegging (See the SQL results for a list of plans).<br>
<br> 
For plans with Priority Pegging, when the profile option is set to "Yes", firm planned orders are included in the firm allocation window (along with scheduled receipts). They are eligible for pegging during the first phase of priority pegging.  This is not the default behavior.  If the current behavior meets your business requirements, this warning may be ignored.',
      p_solution               => 'Please follow the solution steps outlined in:<BR>
<BR>
[2345423/KB784263] In an ASCP Plan with Priority Pegging, Firm Planned Orders are Included in the Firm Allocation Window Along with Scheduled Receipts',
      p_success_msg            => 'You may or may not be using Priority Pegging in your ASCP Plans, but the profile option is set to "No" in the application.  When priority pegging is being used in conjunction with this profile option setting, firm planned orders will not be included in the firm allocation window (along with scheduled receipts). They are eligible for pegging during the second phase of priority pegging.  This is the default behavior.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSC_INCLUDE_FPO_IN_FAW_PROFILE_CHECK');



debug('begin add_signature: MSC_INCLUDE_SS_IN_PRIORITY_PROFILE_CHECK');
   l_info('##MASK##USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8363',
      p_sig_id                 => 'MSC_INCLUDE_SS_IN_PRIORITY_PROFILE_CHECK',
      p_sig_sql                => 'select COMPILE_DESIGNATOR, CURR_PRIORITY_PEGGING from MSC_PLANS where CURR_PRIORITY_PEGGING = ''1''
and exists (select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSC_INCLUDE_SS_IN_PRIORITY%'')
and fpov.profile_option_value = ''N'')',
      p_title                  => 'MSC: Include Safety Stocks in Priority Based Pegging',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'You have plans with Priority Based Pegging enabled (listed in the SQL results above) and you have the "MSC: Include Safety Stocks in Priority Based Pegging" profile option set to "No" in the application.  <br> With this setting, the planning engine gives preference to non-transient safety stock levels in priority-based pegging. <br>It first pegs them to non-firm planned orders. Then it pegs the demands to the other supplies. <br>Make sure this is the desired behavior per your business requirements.',
      p_solution               => 'Please follow the solution steps outlined in:<BR>
<BR>
[2345432/KB767266] In Plans with Priority Based Pegging Enabled, the Planning Engine gives Preference to Non-Transient Safety Stock Causing High PAB and Resource Overloads',
      p_success_msg            => 'This profile option is set to "Yes" in the application.  This will apply smoothing to all safety stock.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: MSC_INCLUDE_SS_IN_PRIORITY_PROFILE_CHECK');



debug('begin add_signature: MSC_MIN_SUP_DEM_PER_PEG_PROFILE_CHECK');
   l_info('##MASK##USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8364',
      p_sig_id                 => 'MSC_MIN_SUP_DEM_PER_PEG_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSC_MIN_SUP_DEM_PER_PEG%'')
and to_binary_float(fpov.profile_option_value) >= 1',
      p_title                  => 'MSC: Minimum Supply/Demand Percent for Pegging',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option has a value greater than or equal to 1.   Incorrect plan results or plan failures can occur if this profile option is not set correctly.<br>
The profile says percent, but it is actually a ratio and needs to be set to a fractional value, 0.0 is the default, .01 = 1%.',
      p_solution               => 'Please follow the solution steps outlined in:<BR>
<BR>
[2345437/KB757069] After an ASCP Plan run, Tiny Supplies are being Pegged to Huge Demands',
      p_success_msg            => 'This profile option is set to a value < 1.  This is the correct setting as this profile needs to be set to a decimal value.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSC_MIN_SUP_DEM_PER_PEG_PROFILE_CHECK');



debug('begin add_signature: MSC_NEW_PLANNER_BACK_COMPATIBILITY_PROFILE_CHECK');
   l_info('##MASK##USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8365',
      p_sig_id                 => 'MSC_NEW_PLANNER_BACK_COMPATIBILITY_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSC_NEW_PLANNER_BACK_COMPATIBILITY%'')
and fpov.profile_option_value = ''N''',
      p_title                  => 'MSC: New Planner Backward Compatibility',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is set to "No" in the application (it will appear as "N" in the backend and the SQL results above).  Per Oracle Development this needs to be set to "Yes" in 12.1.3 and above to avoid a performance issue in constrained plans.',
      p_solution               => 'Please follow the solution steps outlined in:<BR>
<BR>
<i>[2345470/KB664028] On a 12.1.3 Instance, There is a Performance Issue when running Constrained Plans</i>',
      p_success_msg            => 'This profile option is set to "Yes" in the application.  This is the correct setting per Oracle Development.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSC_NEW_PLANNER_BACK_COMPATIBILITY_PROFILE_CHECK');



debug('begin add_signature: MSC_PREF_FOR_BUCKET_CHECK');
   l_info('##MASK##USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8510',
      p_sig_id                 => 'MSC_PREF_FOR_BUCKET_CHECK',
      p_sig_sql                => 'select COMPILE_DESIGNATOR, decode(FORECAST_ALLOCATION_METHOD,1,''Do Not Spread Forecast'',2,''Spread Forecast Evenly'')  "Forecast Allocation Method", decode(FORECAST_CONSUMPTION_METHOD,1,''Checked'',2,''Unchecked'') "Consume By Forecast Bucket" from MSC_PLANS
where 
FORECAST_ALLOCATION_METHOD = 2
and FORECAST_CONSUMPTION_METHOD = 2
and exists (select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE ''%MSC_PREF_FOR_BUCKET%''
and fpov.profile_option_value = ''Y'')',
      p_title                  => 'MSC: Prefer Consumption within Forecast Bucket',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is set to "Yes" in the application, the Forecast Allocation Method is set to "Spread Forecast Evenly," and "Consume By Forecast Bucket" is unchecked.
For the plan shown in the SQL results above, the forecasts would be consumed in the following fashion:
<br>
<br>
1. First, Spread the forecasts. <br>
2. The first round of consumption begins by walking backwards for the number of backward days mentioned from the date of the sales order, considering any forecast entry as eligible only if the sales order falls in the same bucket as the forecast. <br>
3. Once you find no more entries backward you walk forward for the forward number of days mentioned, checking for eligible forecasts as mentioned above. <br>
4. If you still need forecast entries, you start walking backward; this time trying to consume all the forecast entries within the backward time fence. <br>
5. Finally, you go forward in the same fashion if required. <BR>
NOTE: This is not the default behavior.<BR>
If you are satisfied with the current behavior for the plans listed in the SQL output above, this warning can be ignored and no change is required.',
      p_solution               => 'If you prefer the default behavior, follow the solution steps outlined in:<BR>
<BR>
[395804/KB452407] Information On Profile MSC: Prefer Consumption Within Forecast Bucket',
      p_success_msg            => 'The profile option is set to "No" in the application and/or you do not have any plans with "Spread Forecast Evenly" enabled and "Consume by Forecast Bucket" disabled.  The current setup is correct.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSC_PREF_FOR_BUCKET_CHECK');



debug('begin add_signature: MSC_USE_FIFO_PEGGING_CHECK');
   l_info('##MASK##USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8624',
      p_sig_id                 => 'MSC_USE_FIFO_PEGGING_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE ''MSC_USE_FIFO_PEGGING%''
and fpov.profile_option_value = ''Y''',
      p_title                  => 'MSC: Use FIFO Pegging',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is set to "Yes" in the application (it will appear as "Y" in the backend and the SQL results above).  This may cause issues with other plan setups.<br>
For example, it will cancel out the Safety Stock Smoothing profile option settings, or it can cause unexpected results when using dynamic safety stock.<br>
NOTE: This is not the default behavior.<br>
<br>
If you are satisfied with your current plan output, this warning may be ignored and no changes are required.',
      p_solution               => 'Refer to the following note for the proposed solution:<BR>
<BR>
[2344626/KB727599] Safety Stock Smoothing Profile Options Are Not Working Properly When Running ASCP Plans',
      p_success_msg            => 'This profile option is set to "No" in the application.  This is the default setting.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSC_USE_FIFO_PEGGING_CHECK');



debug('begin add_signature: MSC_USE_SCO_DATE_PROFILE_CHECK');
   l_info('##MASK##USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8626',
      p_sig_id                 => 'MSC_USE_SCO_DATE_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE ''MSC_USE_SCO_DATE%''
and fpov.profile_option_value = ''Y''',
      p_title                  => 'MSC: Use Optimization Phase Supply Due Dates for Pegging',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is set to "Yes" in the application (it will appear as "Y" in the backend and the SQL results above).  With this setting, Pegging uses the optimization recommended supply date for planned orders and scheduled receipts.  Having this set to "Yes" is known to cause excess Planned Orders.',
      p_solution               => 'Refer to the following note for the proposed solution:<BR>
<BR>
[1278452/KB649525] ASCP is Creating Excess Planned Orders for ATO Sales Orders',
      p_success_msg            => 'This profile option is set to "No" in the application.  That is the correct setting.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSC_USE_SCO_DATE_PROFILE_CHECK');



debug('begin add_signature: MSC_PREVENT_NSJOB_LOOP_PROFILE_CHECK');
   l_info('##MASK##USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8628',
      p_sig_id                 => 'MSC_PREVENT_NSJOB_LOOP_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE ''MSC_PREVENT_NSJOB_LOOP%''
and fpov.profile_option_value = ''N''',
      p_title                  => 'MSC: Prevent Loops when pegging Non-Standard Jobs',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is set to "No" (it will appear as "N" in the backend and the SQL results above).  With this setting, ASCP makes the optimistic assumption that loops will not exist after pegging and proceeds to peg supply of the top level item to the nonstandard job demand. ',
      p_solution               => 'Refer to the following note for the proposed solution:<BR>
<BR>
[2345476/KB743343] Pegging for Non-Standard Jobs is Not Correct in the ASCP Plan Output or the Plan is Failing Due to Loops Involving Non-Standard jobs',
      p_success_msg            => 'This profile option is set to "Yes" in the application.  That is the correct setting.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSC_PREVENT_NSJOB_LOOP_PROFILE_CHECK');



debug('begin add_signature: MSO_EDD_SCHEDULING_WINDOW_CONTROL_PROFILE_CHECK');
   l_info('##MASK##USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8632',
      p_sig_id                 => 'MSO_EDD_SCHEDULING_WINDOW_CONTROL_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
fnd_user fu,
fnd_logins fl
where fpov.profile_option_value != ''.5''
and fpov.profile_option_value != ''0.5''
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE ''MSO_EDD_SCHEDULING_WINDOW_CONTROL%''',
      p_title                  => 'MSO: EDD Scheduling Window Control',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option setting is not set to the default value of 0.5.  If the current setting is valid per your business requirements, this warning may be ignored and no changes are necessary.',
      p_solution               => 'Refer to the following note for the proposed solution:<BR>
<BR>
[1920817/KB727804] Huge Pull In ASCP Plan For Parts Whose Demand Is 3 Months Away',
      p_success_msg            => 'This profile option is set to the default value of 0.5.  This is the optimal setting.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSO_EDD_SCHEDULING_WINDOW_CONTROL_PROFILE_CHECK');



debug('begin add_signature: MSC_FIRM_SUPPLY_FWD_FENCE_PROFILE_CHECK');
   l_info('##MASK##USER1'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##USER2'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8637',
      p_sig_id                 => 'MSC_FIRM_SUPPLY_FWD_FENCE_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile1,
fpov.profile_option_value Value1,
decode(fpov.level_id,10001,
...
and fl1.login_id(+) = fpov1.LAST_UPDATE_LOGIN
and NOT (fpov.level_id = ''10004'' and fpov1.level_id = ''10004'' and fu.user_name <> fu1.user_name)
and (fpo.profile_option_name LIKE ''%MSO_FIRM_B4_PO%'' and fpov.profile_option_value <> ''No'')
and (fpo1.profile_option_name LIKE ''%MSC_FIRM_SUPPLY_FWD_FENCE%'' and fpov1.profile_option_value = ''0'')',
      p_title                  => 'MSO: Firm Supply Allocation Window (Forward days)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'When "MSO: Net All Firm Supplies Before Creating Planned Orders" is set to an option other than "No" in the application, the profile option "MSO: Firm Supply
Allocation Window (Forward days)" is considered.
<br>
"MSO: Firm Supply Allocation Window (Forward days)" is set to "0," meaning that any firm supply even one day after the demand date cannot be used to satisfy the particular demand.<br>
<BR>
If you are satisfied with the current plan results, this warning may be ignored and no changes are necessary.',
      p_solution               => 'Refer to the following note for the proposed solution:<BR>
<BR>
[2345835/KB724557] Firm Supply With A Date Just One Day After the Demand Date Cannot be Used to Satisfy the Particular Demand',
      p_success_msg            => 'This profile option is set to a value greater than "0."  That is the correct setting when "MSO: Net All Firm Supplies Before Creating Planned Orders" is set to an option other than "No" in the application.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSC_FIRM_SUPPLY_FWD_FENCE_PROFILE_CHECK');



debug('begin add_signature: MSO_PEG_BYPROD_SUPP_PROFILE_CHECK');
   l_info('##MASK##USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8639',
      p_sig_id                 => 'MSO_PEG_BYPROD_SUPP_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE ''MSO_PEG_BYPROD_SUPP%''
and fpov.profile_option_value = ''Y''',
      p_title                  => 'MSO: Peg By-product Supplies',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The profile is set to "Yes" in the application (it will appear as "Y" in the backend and the SQL results above).  This may cause the Memory Based Planner (MBP) to fail with a signal 11 error, if the ASCP plan is being used in a co/by-product scenario.<BR>
<BR>
If you are satisfied with current plan results, then this warning may be ignored and no changes are necessary. 
',
      p_solution               => 'Refer to the following note for the proposed solution:<BR>
<BR>
[957490.1] Health Check Alert: Set the profile ''MSO: Peg By-product Supplies'' to No',
      p_success_msg            => 'This profile option is set to "No" in the application.  That is the correct setting to prevent Signal 11 errors from occurring when the ASCP plan is being used in a co/by-product scenario. ',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSO_PEG_BYPROD_SUPP_PROFILE_CHECK');



debug('begin add_signature: MSC_ENABLE_GROUP_BASED_NETTING_PROFILE_CHECK');
   l_info('##MASK##USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8533',
      p_sig_id                 => 'MSC_ENABLE_GROUP_BASED_NETTING_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSC_ENABLE_GROUP_BASED_NETTING%'')
and fpov.profile_option_value = ''N''',
      p_title                  => 'MSC: Enable Group Based Netting',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is set to "No" in the application (it will appear as "N" in the backend and the SQL results above).  This setting is known to cause planned orders for supply that are too high with a significant quantity pegged to excess.  This setting is also known to cause Signal 11 errors.',
      p_solution               => 'Refer to the following note for the proposed solution:<BR>
<BR>
[1359942/KB218764] ASCP Creates Planned Orders Pegging To Excess With No Order Modifiers Profile MSC: Enable Group Based Netting',
      p_success_msg            => 'This profile option is set to "Yes" in the application.  This is the setting recommended by Oracle Development.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSC_ENABLE_GROUP_BASED_NETTING_PROFILE_CHECK');



debug('begin add_signature: MSO_SCO_ALT_PROCESS_PENALTY_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7928',
      p_sig_id                 => 'MSO_SCO_ALT_PROCESS_PENALTY_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_SCO_ALT_PROCESS_PENALTY%'')
and fpov.profile_option_value IS NOT NULL
order by 1,3',
      p_title                  => 'MSO: Alternate Process Penalty',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is NOT NULL (it is set to a value).  The current setting changes the plan behavior.',
      p_solution               => 'Please follow the steps outlined in: <BR>
<BR>
[2344693/KB760520#MSO_Alternate_Process_Penalty] ASCP Plan is not Behaving As Expected',
      p_success_msg            => 'This profile option is set to NULL (it is blank). This is the correct setting unless Oracle Development has suggested a different setting to satisfy your specific planning requirement.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSO_SCO_ALT_PROCESS_PENALTY_PROFILE_CHECK');



debug('begin add_signature: MSO_SCO_ALT_RESOURCE_PENALTY_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7929',
      p_sig_id                 => 'MSO_SCO_ALT_RESOURCE_PENALTY_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_SCO_ALT_RESOURCE_PENALTY%'')
and fpov.profile_option_value IS NOT NULL
order by 1,3',
      p_title                  => 'MSO: Alternate Resource Penalty',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is NOT NULL (it is set to a value).  The current setting changes the plan behavior.
',
      p_solution               => 'Please follow the steps outlined in: <BR>
<BR>
[2344693/KB760520#MSO_Alternate_Resource_Penalty] ASCP Plan is not Behaving As Expected',
      p_success_msg            => 'This profile option is set to NULL (it is blank).  This is the correct setting unless Oracle Development has suggested a different setting to satisfy your specific planning requirement.
',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: MSO_SCO_ALT_RESOURCE_PENALTY_PROFILE_CHECK');



debug('begin add_signature: MSO_SCO_ALT_SOURCE_PENALTY_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7930',
      p_sig_id                 => 'MSO_SCO_ALT_SOURCE_PENALTY_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_SCO_ALT_SOURCE_PENALTY%'')
and fpov.profile_option_value IS NOT NULL
order by 1,3',
      p_title                  => 'MSO: Alternate Source Penalty',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is NOT NULL (it is set to a value).  The current setting changes the plan behavior.
...
',
      p_solution               => 'Please follow the steps outlined in: <BR>
<BR>
[2344693/KB760520#MSO_Alternate_Source_Penalty] ASCP Plan is not Behaving As Expected',
      p_success_msg            => 'This profile option is set to NULL (it is blank).  This is the correct setting unless Oracle Development has suggested a different setting to satisfy your specific planning requirement.
',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: MSO_SCO_ALT_SOURCE_PENALTY_PROFILE_CHECK');



debug('begin add_signature: MSO_CPX_PARAM_CRAIND_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7932',
      p_sig_id                 => 'MSO_CPX_PARAM_CRAIND_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_CPX_PARAM_CRAIND%'')
and fpov.profile_option_value IS NOT NULL
order by 1,3',
      p_title                  => 'MSO: CPLEX Crash Parameter',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is NOT NULL (it is set to a value).  The current setting changes the plan behavior.
',
      p_solution               => 'Please follow the steps outlined in: <BR>
<BR>
[2344693/KB760520#MSO_CPLEX_Crash_Parameter] ASCP Plan is not Behaving As Expected',
      p_success_msg            => 'This profile option is set to NULL (it is blank).  This is the correct setting unless Oracle Development has suggested a different setting to satisfy your specific planning requirement.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: MSO_CPX_PARAM_CRAIND_PROFILE_CHECK');



debug('begin add_signature: MSO_CPX_PARAM_DEPIND_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7931',
      p_sig_id                 => 'MSO_CPX_PARAM_DEPIND_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_CPX_PARAM_DEPIND%'')
and fpov.profile_option_value IS NOT NULL
order by 1,3',
      p_title                  => 'MSO: Check Redundant Constraints',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is NOT NULL (it is set to a value).  The current setting changes the plan behavior.
...
',
      p_solution               => 'Please follow the steps outlined in: <BR>
<BR>
[2344693/KB760520#MSO_Check_Redundant_Constraints] ASCP Plan is not Behaving As Expected',
      p_success_msg            => 'This profile option is set to NULL (it is blank).  This is the correct setting unless Oracle Development has suggested a different setting to satisfy your specific planning requirement.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: MSO_CPX_PARAM_DEPIND_PROFILE_CHECK');



debug('begin add_signature: MSO_CPX_PARAM_REINV_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7933',
      p_sig_id                 => 'MSO_CPX_PARAM_REINV_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_CPX_PARAM_REINV%'')
and fpov.profile_option_value IS NOT NULL
order by 1,3',
      p_title                  => 'MSO: CPLEX Refactor Rate',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is NOT NULL (it is set to a value).  The current setting changes the plan behavior.',
      p_solution               => 'Please follow the steps outlined in: <BR>
<BR>
[2344693/KB760520#MSO_CPLEX_Refactor_Rate] ASCP Plan is not Behaving As Expected',
      p_success_msg            => 'This profile option is set to NULL (it is blank).  This is the correct setting unless Oracle Development has suggested a different setting to satisfy your specific planning requirement.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: MSO_CPX_PARAM_REINV_PROFILE_CHECK');



debug('begin add_signature: MSO_CPX_PARAM_SCAIND_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7934',
      p_sig_id                 => 'MSO_CPX_PARAM_SCAIND_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_CPX_PARAM_SCAIND%'')
and fpov.profile_option_value IS NOT NULL
order by 1,3',
      p_title                  => 'MSO: CPLEX Scaling Factor',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is NOT NULL (it is set to a value).  The current setting changes the plan behavior.
',
      p_solution               => 'Please follow the steps outlined in: <BR>
<BR>
[2344693/KB760520#MSO_CPLEX_Scaling_Factor] ASCP Plan is not Behaving As Expected',
      p_success_msg            => 'This profile option is set to NULL (it is blank).  This is the correct setting unless Oracle Development has suggested a different setting to satisfy your specific planning requirement.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: MSO_CPX_PARAM_SCAIND_PROFILE_CHECK');



debug('begin add_signature: MSO_CPX_PARAM_DPRIIND_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7935',
      p_sig_id                 => 'MSO_CPX_PARAM_DPRIIND_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_CPX_PARAM_DPRIIND%'')
and fpov.profile_option_value IS NOT NULL
order by 1,3',
      p_title                  => 'MSO: Dual Simplex Parameter',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is NOT NULL (it is set to a value).  The current setting changes the plan behavior.',
      p_solution               => 'Please follow the steps outlined in: <BR>
<BR>
[2344693/KB760520#MSO_Dual_Simplex_Parameter] ASCP Plan is not Behaving As Expected',
      p_success_msg            => 'This profile option is set to NULL (it is blank).  This is the correct setting unless Oracle Development has suggested a different setting to satisfy your specific planning requirement.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: MSO_CPX_PARAM_DPRIIND_PROFILE_CHECK');



debug('begin add_signature: MSO_CPX_PARAM_TILIM_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7936',
      p_sig_id                 => 'MSO_CPX_PARAM_TILIM_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_CPX_PARAM_TILIM%'')
and fpov.profile_option_value IS NOT NULL
order by 1,3',
      p_title                  => 'MSO: Global Time Limit',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is NOT NULL (it is set to a value).  The current setting changes the plan behavior.
',
      p_solution               => 'Please follow the steps outlined in: <BR>
<BR>
[2344693/KB760520#MSO_Global_Time_Limit] ASCP Plan is not Behaving As Expected',
      p_success_msg            => 'This profile option is set to NULL (it is blank).  This is the correct setting unless Oracle Development has suggested a different setting to satisfy your specific planning requirement.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: MSO_CPX_PARAM_TILIM_PROFILE_CHECK');



debug('begin add_signature: MSO_CPX_PARAM_PRICELIM_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7937',
      p_sig_id                 => 'MSO_CPX_PARAM_PRICELIM_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_CPX_PARAM_PRICELIM%'')
and fpov.profile_option_value IS NOT NULL
order by 1,3',
      p_title                  => 'MSO: List Size for Pricing Candidates',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is NOT NULL (it is set to a value).  The current setting changes the plan behavior.',
      p_solution               => 'Please follow the steps outlined in: <BR>
<BR>
[2344693/KB760520#MSO_List_Size_for_Pricing_Candidates] ASCP Plan is not Behaving As Expected',
      p_success_msg            => 'This profile option is set to NULL (it is blank).  This is the correct setting unless Oracle Development has suggested a different setting to satisfy your specific planning requirement.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: MSO_CPX_PARAM_PRICELIM_PROFILE_CHECK');



debug('begin add_signature: MSO_CPX_DUAL_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8180',
      p_sig_id                 => 'MSO_CPX_DUAL_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_CPX_DUAL%'')
and fpov.profile_option_value IS NOT NULL
order by 1,3',
      p_title                  => 'MSO: Solve Dual Problem',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is NOT NULL (it is set to a value).  The current setting changes the plan behavior.',
      p_solution               => 'Please follow the steps outlined in: <BR>
<BR>
[2344693/KB760520#MSO_Solve_Dual_Problem] ASCP Plan is not Behaving As Expected',
      p_success_msg            => 'This profile option is set to NULL (it is blank).  This is the correct setting unless Oracle Development has suggested a different setting to satisfy your specific planning requirement.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: MSO_CPX_DUAL_PROFILE_CHECK');



debug('begin add_signature: MSO_CPX_PARAM_AGGFILL_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8169',
      p_sig_id                 => 'MSO_CPX_PARAM_AGGFILL_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_CPX_PARAM_AGGFILL%'')
and fpov.profile_option_value IS NOT NULL
order by 1,3',
      p_title                  => 'MSO: Preprocessing Aggregator Fill',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is NOT NULL (it is set to a value).  The current setting changes the plan behavior.',
      p_solution               => 'Please follow the steps outlined in: <BR>
<BR>
[2344693/KB760520#MSO_Preprocessing_Aggregator_Fill] ASCP Plan is not Behaving As Expected',
      p_success_msg            => 'This profile option is set to NULL (it is blank).  This is the correct setting unless Oracle Development has suggested a different setting to satisfy your specific planning requirement.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: MSO_CPX_PARAM_AGGFILL_PROFILE_CHECK');



debug('begin add_signature: MSO_CPX_PARAM_AGGIND_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8170',
      p_sig_id                 => 'MSO_CPX_PARAM_AGGIND_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_CPX_PARAM_AGGIND%'')
and fpov.profile_option_value IS NOT NULL
order by 1,3',
      p_title                  => 'MSO: Preprocessing Aggregator Limit',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is NOT NULL (it is set to a value).  The current setting changes the plan behavior.',
      p_solution               => 'Please follow the steps outlined in: <BR>
<BR>
[2344693/KB760520#MSO_Preprocessing_Aggregator_Limit] ASCP Plan is not Behaving As Expected',
      p_success_msg            => 'This profile option is set to NULL (it is blank).  This is the correct setting unless Oracle Development has suggested a different setting to satisfy your specific planning requirement.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: MSO_CPX_PARAM_AGGIND_PROFILE_CHECK');



debug('begin add_signature: MSO_CPX_PARAM_EPMRK_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8166',
      p_sig_id                 => 'MSO_CPX_PARAM_EPMRK_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_CPX_PARAM_EPMRK%'')
and fpov.profile_option_value IS NOT NULL
order by 1,3',
      p_title                  => 'MSO: LP Markowitz Coefficient',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is NOT NULL (it is set to a value).  The current setting changes the plan behavior.',
      p_solution               => 'Please follow the steps outlined in: <BR>
<BR>
[2344693/KB760520#MSO_LP_Markowitz_Coefficient] ASCP Plan is not Behaving As Expected',
      p_success_msg            => 'This profile option is set to NULL (it is blank).  This is the correct setting unless Oracle Development has suggested a different setting to satisfy your specific planning requirement.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: MSO_CPX_PARAM_EPMRK_PROFILE_CHECK');



debug('begin add_signature: MSO_CPX_PARAM_EPOPT_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8177',
      p_sig_id                 => 'MSO_CPX_PARAM_EPOPT_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_CPX_PARAM_EPOPT%'')
and fpov.profile_option_value IS NOT NULL
order by 1,3',
      p_title                  => 'MSO: Simplex Optimality Tolerance',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is NOT NULL (it is set to a value).  The current setting changes the plan behavior.',
      p_solution               => 'Please follow the steps outlined in: <BR>
<BR>
[2344693/KB760520#MSO_Simplex_Optimality_Tolerance] ASCP Plan is not Behaving As Expected',
      p_success_msg            => 'This profile option is set to NULL (it is blank).  This is the correct setting unless Oracle Development has suggested a different setting to satisfy your specific planning requirement.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: MSO_CPX_PARAM_EPOPT_PROFILE_CHECK');



debug('begin add_signature: MSO_CPX_PARAM_EPPER_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8173',
      p_sig_id                 => 'MSO_CPX_PARAM_EPPER_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_CPX_PARAM_EPPER%'')
and fpov.profile_option_value IS NOT NULL
order by 1,3',
      p_title                  => 'MSO: Simplex Perturbation Constant',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is NOT NULL (it is set to a value).  The current setting changes the plan behavior.',
      p_solution               => 'Please follow the steps outlined in: <BR>
<BR>
[2344693/KB760520#MSO_Simplex_Perturbation_Constant] ASCP Plan is not Behaving As Expected',
      p_success_msg            => 'This profile option is set to NULL (it is blank).  This is the correct setting unless Oracle Development has suggested a different setting to satisfy your specific planning requirement.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: MSO_CPX_PARAM_EPPER_PROFILE_CHECK');



debug('begin add_signature: MSO_CPX_PARAM_EPRHS_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8176',
      p_sig_id                 => 'MSO_CPX_PARAM_EPRHS_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_CPX_PARAM_EPRHS%'')
and fpov.profile_option_value IS NOT NULL
order by 1,3',
      p_title                  => 'MSO: Simplex Feasibility Tolerance',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is NOT NULL (it is set to a value).  The current setting changes the plan behavior.',
      p_solution               => 'Please follow the steps outlined in: <BR>
<BR>
[2344693/KB760520#MSO_Simplex_Feasibility_Tolerance] ASCP Plan is not Behaving As Expected',
      p_success_msg            => 'This profile option is set to NULL (it is blank).  This is the correct setting unless Oracle Development has suggested a different setting to satisfy your specific planning requirement.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: MSO_CPX_PARAM_EPRHS_PROFILE_CHECK');



debug('begin add_signature: MSO_CPX_PARAM_ITLIM_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8168',
      p_sig_id                 => 'MSO_CPX_PARAM_ITLIM_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_CPX_PARAM_ITLIM%'')
and fpov.profile_option_value IS NOT NULL
order by 1,3',
      p_title                  => 'MSO: Maximum Simplex Iterations',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is NOT NULL (it is set to a value).  The current setting changes the plan behavior.',
      p_solution               => 'Please follow the steps outlined in: <BR>
<BR>
[2344693/KB760520#MSO_Maximum_Simplex_Iterations] ASCP Plan is not Behaving As Expected',
      p_success_msg            => 'This profile option is set to NULL (it is blank).  This is the correct setting unless Oracle Development has suggested a different setting to satisfy your specific planning requirement.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: MSO_CPX_PARAM_ITLIM_PROFILE_CHECK');



debug('begin add_signature: MSO_CPX_PARAM_PERIND_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8179',
      p_sig_id                 => 'MSO_CPX_PARAM_PERIND_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_CPX_PARAM_PERIND%'')
and fpov.profile_option_value IS NOT NULL
order by 1,3',
      p_title                  => 'MSO: Simplex Perturbation Parameter',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is NOT NULL (it is set to a value).  The current setting changes the plan behavior.
',
      p_solution               => 'Please follow the steps outlined in: <BR>
<BR>
[2344693/KB760520#MSO_Simplex_Perturbation_Parameter] ASCP Plan is not Behaving As Expected',
      p_success_msg            => 'This profile option is set to NULL (it is blank).  This is the correct setting unless Oracle Development has suggested a different setting to satisfy your specific planning requirement.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: MSO_CPX_PARAM_PERIND_PROFILE_CHECK');



debug('begin add_signature: MSO_CPX_PARAM_PERLIM_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8178',
      p_sig_id                 => 'MSO_CPX_PARAM_PERLIM_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_CPX_PARAM_PERLIM%'')
and fpov.profile_option_value IS NOT NULL
order by 1,3',
      p_title                  => 'MSO: Simplex Perturbation Limit',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is NOT NULL (it is set to a value).  The current setting changes the plan behavior.
...
',
      p_solution               => 'Please follow the steps outlined in: <BR>
<BR>
[2344693/KB760520#MSO_Simplex_Perturbation_Limit] ASCP Plan is not Behaving As Expected',
      p_success_msg            => 'This profile option is set to NULL (it is blank).  This is the correct setting unless Oracle Development has suggested a different setting to satisfy your specific planning requirement.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: MSO_CPX_PARAM_PERLIM_PROFILE_CHECK');



debug('begin add_signature: MSO_CPX_PARAM_PREIND_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8171',
      p_sig_id                 => 'MSO_CPX_PARAM_PREIND_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_CPX_PARAM_PREIND%'')
and fpov.profile_option_value IS NOT NULL
order by 1,3',
      p_title                  => 'MSO: Preprocessing Flag for LP Matrix',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is NOT NULL (it is set to a value).  The current setting changes the plan behavior.
',
      p_solution               => 'Please follow the steps outlined in: <BR>
<BR>
[2344693/KB760520#MSO_Preprocessing_Flag_for_LP_Matrix] ASCP Plan is not Behaving As Expected',
      p_success_msg            => 'This profile option is set to NULL (it is blank).  This is the correct setting unless Oracle Development has suggested a different setting to satisfy your specific planning requirement.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: MSO_CPX_PARAM_PREIND_PROFILE_CHECK');



debug('begin add_signature: MSO_CPX_PARAM_PREPASS_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8174',
      p_sig_id                 => 'MSO_CPX_PARAM_PREPASS_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_CPX_PARAM_PREPASS%'')
and fpov.profile_option_value IS NOT NULL
order by 1,3',
      p_title                  => 'MSO: Simplex Presolve Limit',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is NOT NULL (it is set to a value).  The current setting changes the plan behavior.
...
',
      p_solution               => 'Please follow the steps outlined in: <BR>
<BR>
[2344693/KB760520#MSO_Simplex_Presolve_Limit] ASCP Plan is not Behaving As Expected',
      p_success_msg            => 'This profile option is set to NULL (it is blank).  This is the correct setting unless Oracle Development has suggested a different setting to satisfy your specific planning requirement.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: MSO_CPX_PARAM_PREPASS_PROFILE_CHECK');



debug('begin add_signature: MSO_CPX_PARAM_SINGLIM_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8175',
      p_sig_id                 => 'MSO_CPX_PARAM_SINGLIM_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_CPX_PARAM_SINGLIM%'')
and fpov.profile_option_value IS NOT NULL
order by 1,3',
      p_title                  => 'MSO: Simplex Singularity Repair Limit',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is NOT NULL (it is set to a value).  The current setting changes the plan behavior.',
      p_solution               => 'Please follow the steps outlined in: <BR>
<BR>
[2344693/KB760520#MSO_Simplex_Singularity_Repair_Limit] ASCP Plan is not Behaving As Expected',
      p_success_msg            => 'This profile option is set to NULL (it is blank).  This is the correct setting unless Oracle Development has suggested a different setting to satisfy your specific planning requirement.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: MSO_CPX_PARAM_SINGLIM_PROFILE_CHECK');



debug('begin add_signature: MSO_HLS_ACTIVITY_DURATION_MAX_PROFILE_CHECK');
   l_info('##MASK##7'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8167',
      p_sig_id                 => 'MSO_HLS_ACTIVITY_DURATION_MAX_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_HLS_ACTIVITY_DURATION_MAX%'')
and fpov.profile_option_value IS NOT NULL
order by 1,3',
      p_title                  => 'MSO: Maximum Activity Duration',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is NOT NULL (it is set to a value).  The current setting changes the plan behavior.',
      p_solution               => 'Please follow the steps outlined in: <BR>
<BR>
[2344693/KB760520#MSO_Maximum_Activity_Duration] ASCP Plan is not Behaving As Expected',
      p_success_msg            => 'This profile option is set to NULL (it is blank).  This is the correct setting unless Oracle Development has suggested a different setting to satisfy your specific planning requirement.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: MSO_HLS_ACTIVITY_DURATION_MAX_PROFILE_CHECK');



debug('begin add_signature: MSO_PARAM_PPRIIND_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8172',
      p_sig_id                 => 'MSO_PARAM_PPRIIND_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_PARAM_PPRIIND%'')
and fpov.profile_option_value IS NOT NULL
order by 1,3',
      p_title                  => 'MSO: Primal Simplex Parameter',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is NOT NULL (it is set to a value).  The current setting changes the plan behavior.',
      p_solution               => 'Please follow the steps outlined in: <BR>
<BR>
[2344693/KB760520#MSO_Primal_Simplex_Parameter] ASCP Plan is not Behaving As Expected',
      p_success_msg            => 'This profile option is set to NULL (it is blank).  This is the correct setting unless Oracle Development has suggested a different setting to satisfy your specific planning requirement.
',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: MSO_PARAM_PPRIIND_PROFILE_CHECK');



debug('begin add_signature: MSO_SCO_PREPROC_REDUCTION_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8181',
      p_sig_id                 => 'MSO_SCO_PREPROC_REDUCTION_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_SCO_PREPROC_REDUCTION%'')
and fpov.profile_option_value IS NOT NULL
order by 1,3',
      p_title                  => 'MSO: Primal/Dual Preprocessing Reduction',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is NOT NULL (it is set to a value).  The current setting changes the plan behavior.',
      p_solution               => 'Please follow the steps outlined in: <BR>
<BR>
[2344693/KB760520#MSO_Primal_Dual_Preprocessing_Reduction] ASCP Plan is not Behaving As Expected',
      p_success_msg            => 'This profile option is set to NULL (it is blank).  This is the correct setting unless Oracle Development has suggested a different setting to satisfy your specific planning requirement.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: MSO_SCO_PREPROC_REDUCTION_PROFILE_CHECK');



debug('begin add_signature: MSO_MAX_EXCESS_RESOURCE_UNITS_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8259',
      p_sig_id                 => 'MSO_MAX_EXCESS_RESOURCE_UNITS_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_MAX_EXCESS_RESOURCE_UNITS%'')
and fpov.profile_option_value <> ''5''
order by 1,3',
      p_title                  => 'MSO: Maximum Resource Over-capacity',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is not set to the default value of "5".  The current setting changes the plan behavior.',
      p_solution               => 'Please follow the steps outlined in: <BR>
<BR>
[2344693/KB760520#MSO_Maximum_Resource_Over_capacity] ASCP Plan is not Behaving As Expected',
      p_success_msg            => 'This profile option is set to "5." This is the correct setting unless Oracle Development has suggested a different setting to satisfy your specific planning requirement.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSO_MAX_EXCESS_RESOURCE_UNITS_PROFILE_CHECK');



debug('begin add_signature: MSO_MAX_PULL_OPERATION_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8257',
      p_sig_id                 => 'MSO_MAX_PULL_OPERATION_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_MAX_PULL_OPERATION%'')
and fpov.profile_option_value <> ''8''
order by 1,3',
      p_title                  => 'MSO: Maximum Number of Pull for Operation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is not set to the default value of "8".  The current setting changes the plan behavior.',
      p_solution               => 'Please follow the steps outlined in: <BR>
<BR>
[2344693/KB760520#MSO_Maximum_Number_of_Pull_for_Operation] ASCP Plan is not Behaving As Expected',
      p_success_msg            => 'This profile option is set to "8". This is the correct setting unless Oracle Development has suggested a different setting to satisfy your specific planning requirement.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSO_MAX_PULL_OPERATION_PROFILE_CHECK');



debug('begin add_signature: MSO_MAXIMUM_PREPONES_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8256',
      p_sig_id                 => 'MSO_MAXIMUM_PREPONES_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_MAXIMUM_PREPONES%'')
and fpov.profile_option_value <> ''10''
order by 1,3',
      p_title                  => 'MSO: Maximium Number of Prepones',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is not set to the default value of "10".  The current setting changes the plan behavior.',
      p_solution               => 'Please follow the steps outlined in: <BR>
<BR>
[2344693/KB760520#MSO_Maximium_Number_of_Prepones] ASCP Plan is not Behaving As Expected',
      p_success_msg            => 'This profile option is set to "10." This is the correct setting unless Oracle Development has suggested a different setting to satisfy your specific planning requirement.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSO_MAXIMUM_PREPONES_PROFILE_CHECK');



debug('begin add_signature: MSO_LP_ALGORITHM_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8255',
      p_sig_id                 => 'MSO_LP_ALGORITHM_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_LP_ALGORITHM%'')
and fpov.profile_option_value <> ''0''
order by 1,3',
      p_title                  => 'MSO: LP Optimization Algorithm',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is not set to the default value of "0".  The current setting changes the plan behavior.',
      p_solution               => 'Please follow the steps outlined in: <BR>
<BR>
[2344693/KB760520#MSO_LP_Optimization_Algorithm] ASCP Plan is not Behaving As Expected',
      p_success_msg            => 'This profile option is set to "0." This is the correct setting unless Oracle Development has suggested a different setting to satisfy your specific planning requirement.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSO_LP_ALGORITHM_PROFILE_CHECK');



debug('begin add_signature: CALENDAR_LT_PLAN_HORIZON');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11767',
      p_sig_id                 => 'CALENDAR_LT_PLAN_HORIZON',
      p_sig_sql                => 'SELECT /* CALENDAR_LT_PLAN_HORIZON */ UNIQUE mpo.organization_id,
       mpo.ORGANIZATION_CODE,     
       mp.COMPILE_DESIGNATOR "Plan Name",
       mp.plan_id,
       mc.calendar_code,
       mp.curr_cutoff_date,
       mc.calendar_end_date
FROM   apps.MSC_PLAN_ORGANIZATIONS mpo,
       apps.msc_plans mp,
       apps.msc_trading_partners mtp,
       apps.msc_calendars mc
WHERE  mpo.plan_id = mp.plan_id   
AND    mpo.organization_code = mtp.organization_code
AND    mtp.calendar_code = mc.calendar_code
AND    ((mp.curr_cutoff_date) > mc.calendar_end_date
or sysdate + 1825 > mc.calendar_end_date)',
      p_title                  => 'Returns plans that have calendar end dates less than an existing plan horizon.',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This SQL returns plans that have calendar end dates less than a plan horizon OR calendar end date < 5 years into the future.  Oracle recommends calendar end date to be 7 years past the plan horizon.
',
      p_solution               => 'If this returns row, please extend the calendar.  See the following note:

[2485721/KB198274] Signal 6, Signal 9, Signal 11, APP-MRP-22086 or APP-MRP-22064 error in Memory Based Planner

Functional steps:
Any calendars that have are not extended properly may cause errors or output issues in planning or ATP.  We recommend extending calendars at least 7 years into the future and at least 2 years into the past.
...
5. Rerun the ASCP plan',
      p_success_msg            => 'There are no calendars where the end date is less than plan horizon date.',
   ...
   l_info.delete;
debug('end add_signature: CALENDAR_LT_PLAN_HORIZON');
...
debug('begin add_signature: CHANGED_PROFILES_IN_LAST_30_DAYS');
   l_info('##MASK##4'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##6'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8532',
      p_sig_id                 => 'CHANGED_PROFILES_IN_LAST_30_DAYS',
      p_sig_sql                => 'SELECT PO.USER_PROFILE_OPTION_NAME "Profile Option",
POV.profile_option_value "Profile Option Value",
DECODE(POV.level_id, 10001, ''Site'',
10002, ''Application'',
10003, ''Responsibility'',
10004, ''User'') "Level",
DECODE(POV.level_id, 10001, ''Site'', 10002, APPL.APPLICATION_NAME, 10003, RESP.responsibility_name, 10004, USR.user_name) "Level Value",
...
and (
PO.application_id in (724, 704, 723, 722, 726)
/* 401 INV - removed,724 MSC, 704 MRP, 723 MSO, 722 MSD, 554 GMP - removed, 726 MSR , BOM 702 removed, ONT 660 removed)*/
OR
PO.PROFILE_OPTION_NAME in (''BOM:HOUR_UOM_CODE'', ''CRP_SPREAD_LOAD'',''CSD_DEFAULT_REPAIR_ORDER'', ''CSD_DEFAULT_REPAIR_ORG'',''CSD_DEFAULT_REPAIR_TYPE'',''CSD_IRO_DEFAULT_SR_SEVERITY'', ''CSD_IRO_DEFAULT_SR_TYPE'',''CSD_REPAIR_MODE'',''CSD_IRO_REPAIR_TYPE'',''CSP_REPAIR_SUP_ORG_DEFECT_SUBINV'',''CSP_REPAIR_SUP_ORG_USABLE_SUBINV'',''GMP_APS_CONFIG_LEVEL'',''INV_CTP'',''POR_SYNC_NEEDBYDATE_OM'',''WIP_JOB_PREFIX'',''WSM_CREATE_LBJ_COPY_ROUTING'')
)
...
AND POV.last_update_date >SYSDATE-30
order by 1',
      p_title                  => 'Profiles changed in the last 30 days',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The below profiles have been changed in the last 30 days.  This could have caused recent and unexpected changes in the plan output. ',
      p_solution               => 'Please follow the solution steps outlined in:<BR>
<BR>
[2345006/KB762754] ASCP Plan Output Suddenly Changed and/or Memory Based Planner and/or Other Programs Are Suddenly Failing with No Apparent Setup Changes',
      p_success_msg            => 'No profiles have been changed in the last 30 days',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CHANGED_PROFILES_IN_LAST_30_DAYS');



debug('begin add_signature: DIFFERENT_PROFILE_VALUE_SITE_VS_APPL');
   l_info('##MASK##7'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##8'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8540',
      p_sig_id                 => 'DIFFERENT_PROFILE_VALUE_SITE_VS_APPL',
      p_sig_sql                => 'SELECT PO.USER_PROFILE_OPTION_NAME "Profile Option",
POV.profile_option_value "Value at Site",
POV_U.profile_option_value "Value at Application",
APPL.APPLICATION_NAME "For Application",
to_char(POV.last_update_date,'' dd-Mon-YYYY HH24:mi:ss'') "Last Updated at Site",
to_char(POV_U.last_update_date,'' dd-Mon-YYYY HH24:mi:ss'') "Last Updated at Application",
...
/* 401 INV - removed,724 MSC, 704 MRP, 723 MSO, 722 MSD, 554 GMP - removed, 726 MSR , BOM 702 removed, ONT 660 removed)*/
OR PO.PROFILE_OPTION_NAME in (''BOM:HOUR_UOM_CODE'', ''CRP_SPREAD_LOAD'',''CSD_DEFAULT_REPAIR_ORDER'', ''CSD_DEFAULT_REPAIR_ORG'',''CSD_DEFAULT_REPAIR_TYPE'',''CSD_IRO_DEFAULT_SR_SEVERITY'', ''CSD_IRO_DEFAULT_SR_TYPE'',''CSD_REPAIR_MODE'',''CSD_IRO_REPAIR_TYPE'',''CSP_REPAIR_SUP_ORG_DEFECT_SUBINV'',''CSP_REPAIR_SUP_ORG_USABLE_SUBINV'',''GMP_APS_CONFIG_LEVEL'',''INV_CTP'',''POR_SYNC_NEEDBYDATE_OM'',''WIP_JOB_PREFIX'',''WSM_CREATE_LBJ_COPY_ROUTING''))
...
AND (POV.PROFILE_OPTION_ID = POV_U.PROFILE_OPTION_ID AND POV.level_id <> POV_U.level_id AND POV.profile_option_value <> POV_U.profile_option_value(+))
order by 1',
      p_title                  => 'Profile options having a different application value than site value',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'You have Profile Options that are set differently at the Application and Site Levels.  This can cause different plan behavior at the application level.
',
      p_solution               => 'Please follow the solution steps outlined in:<BR>
<BR>
[2345006/KB762754] ASCP Plan Output Suddenly Changed and/or Memory Based Planner and/or Other Programs Are Suddenly Failing with No Apparent Setup Changes',
      p_success_msg            => 'All profiles, at the Application and Site level values are the same. The analyzer verified the following applications:
<ul>
<li>724 MSC</li>
<li>704 MRP</li>
<li>723 MSO</li>
...
<li>554 GMP</li>
   ...
   l_info.delete;
debug('end add_signature: DIFFERENT_PROFILE_VALUE_SITE_VS_APPL');



debug('begin add_signature: DIFFERENT_PROFILE_VALUE_SITE_VS_RESP');
   l_info('##MASK##7'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##8'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8541',
      p_sig_id                 => 'DIFFERENT_PROFILE_VALUE_SITE_VS_RESP',
      p_sig_sql                => 'SELECT PO.USER_PROFILE_OPTION_NAME "Profile Option",
POV.profile_option_value "Value at Site",
POV_U.profile_option_value "Value at Resp",
RESP.RESPONSIBILITY_NAME "For Responsibility",
to_char(POV.last_update_date,'' dd-Mon-YYYY HH24:mi:ss'') "Last Updated at Site",
to_char(POV_U.last_update_date,'' dd-Mon-YYYY HH24:mi:ss'') "Last Updated at Resp",
USR_S.user_name "For Site , Updated By",
...
AND (POV.PROFILE_OPTION_ID = POV_U.PROFILE_OPTION_ID AND POV.level_id <> POV_U.level_id AND POV.profile_option_value <> POV_U.profile_option_value(+))
order by 1',
      p_title                  => 'Profile options having a different responsibility value than site value',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'You have Profile options that are set differently at the Responsibility Level compared to the Site Level value.  This can cause application behavior issues between Responsibilities.',
      p_solution               => 'Please follow the solution steps outlined in:<BR>
<BR>
[2345006/KB762754] ASCP Plan Output Suddenly Changed and/or Memory Based Planner and/or Other Programs Are Suddenly Failing with No Apparent Setup Changes',
      p_success_msg            => 'All profile options are set the same at the Responsibility and Site level.  The analyzer verified the following applications:
<ul>
<li>724 MSC</li>
<li>704 MRP</li>
<li>723 MSO</li>
...
<li>554 GMP</li>
   ...
   l_info.delete;
debug('end add_signature: DIFFERENT_PROFILE_VALUE_SITE_VS_RESP');



debug('begin add_signature: DIFFERENT_PROFILE_VALUE_SITE_VS_USER');
   l_info('##MASK##4'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##7'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##8'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8539',
      p_sig_id                 => 'DIFFERENT_PROFILE_VALUE_SITE_VS_USER',
      p_sig_sql                => 'SELECT PO.USER_PROFILE_OPTION_NAME "Profile Option",
POV.profile_option_value "Value at Site",
POV_U.profile_option_value "Value at User",
USR.user_name "For User",
to_char(POV.last_update_date,'' dd-Mon-YYYY HH24:mi:ss'') "Last Updated at Site",
to_char(POV_U.last_update_date,'' dd-Mon-YYYY HH24:mi:ss'') "Last Updated at User",
USR_S.user_name "For Site , Updated By",
...
AND (POV.PROFILE_OPTION_ID = POV_U.PROFILE_OPTION_ID AND POV.level_id <> POV_U.level_id AND POV.profile_option_value <> POV_U.profile_option_value(+))
order by 1',
      p_title                  => 'Profile options having a different user value than site value',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'You have Profile Options having a different USER VALUE than SITE VALUE.  This can have an impact on the application behavior and can lead to confusion with the plan output.',
      p_solution               => 'Please follow the solution steps outlined in:<BR>
<BR>
[2345006/KB762754] ASCP Plan Output Suddenly Changed and/or Memory Based Planner and/or Other Programs Are Suddenly Failing with No Apparent Setup Changes',
      p_success_msg            => 'There aren''t any profile options having a different User level value compared to the Site value.
All profiles, at the Application and Site level values are the same. The analyzer verified the following applications:
<ul>
<li>724 MSC</li>
<li>704 MRP</li>
<li>723 MSO</li>
...
<li>554 GMP</li>
   ...
   l_info.delete;
debug('end add_signature: DIFFERENT_PROFILE_VALUE_SITE_VS_USER');



debug('begin add_signature: MSC_PTF_DATES_EARLIER_THAN_PLAN_ANCHOR_DATE_CHECK');
   l_info('##MASK##3'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8679',
      p_sig_id                 => 'MSC_PTF_DATES_EARLIER_THAN_PLAN_ANCHOR_DATE_CHECK',
      p_sig_sql                => 'select (select mp.compile_designator from msc_plans mp where mp.plan_id = msi.plan_id and mp.constrained_mode = 0) plan,
msi.organization_code, item_name, planning_time_fence_date
from msc_system_items msi
where planning_time_fence_date < sysdate-1
and exists (select 1
from msc_supplies ms
where ms.order_type = 5
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE ''MRP_FIRM_ORDER_TF%''
and fpov.profile_option_value = ''Y'')
and exists 
(select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE ''MRP_FIRM_PO_TF%''
and fpov.profile_option_value = ''Y'')
and exists 
(select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE ''MSC_FIRM_PURCH_REQ_TF%''
and fpov.profile_option_value = ''Y'')',
      p_title                  => 'Planning Time Fence Dates That Are Earlier Than Plan Anchor Date',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'You have Unconstrained Plans where planning time fence dates have been generated for planned orders that are earlier than the anchor date of the plan.  In addition, the following profiles are all set to "Yes" in the application:<br>
<br>
MRP:Firm Planned Order Time Fence<br>
MRP:Create Time fence<br>
MSC: Firm Internal Requisition Time Fence<br>
<br>
If you are not concerned by the incorrect dates and you are satisfied with the current plan behavior, this warning may be ignored; no changes are necessary.',
      p_solution               => 'The steps to resolve this issue may be found in:<BR>
<BR>
[2203986/KB400724] In The ASCP Workbench Some Orders Are Showing Some Planned Orders With A Planning Time Fence Date Which Is Past Due To The Anchor Date Of The Plan',
      p_success_msg            => 'You do not have any planning time fence dates generated for planned orders that are earlier than the anchor date of the plan.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSC_PTF_DATES_EARLIER_THAN_PLAN_ANCHOR_DATE_CHECK');



debug('begin add_signature: MSC_FIRM_PURCH_REQ_AND_CREATE_TIME_FENCE_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8793',
      p_sig_id                 => 'MSC_FIRM_PURCH_REQ_AND_CREATE_TIME_FENCE_PROFILE_CHECK',
      p_sig_sql                => 'select COMPILE_DESIGNATOR, decode(CONSTRAINED_MODE,0,''Unconstrained'',1,''Constrained Classic'',2,''Constrained (Without Detailed Scheduling)'',3,''Constrained (With Detailed Scheduling)'') "Constrained Mode" from MSC_PLANS
where CONSTRAINED_MODE <> 0
and exists (select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fpo.profile_option_name LIKE ''%MRP_FIRM_ORDER_TF%''
and fpov.profile_option_value = ''Y'')',
      p_title                  => 'MRP:Create Time fence and MSC: Firm Internal Requisition Time Fence versus Constrained Plans',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'You have Constrained Plans and both of the following profile options are set to "Yes" in the application:<br>
MRP: Create Time Fence<br>
MSC: Firm Internal Requisition Time Fence<br>
<br>
If you have long intransit times, you can run into an issue where planned order start and completion dates are later than expected vs. demand on items which are ordered via internal requisitions/internal sales orders.  If you are satisfied with the current plan behavior, then this warning can be ignored; no changes are required.',
      p_solution               => 'Please follow the steps outlined in the note below to resolve the issue:<br>
<br>
[603918/KB427715] Constrained Plan - Planned Orders and Internal Requisitions Suggested To Start Shipping After Planning Time Fence Instead Of When They Are Ready For Shipment',
      p_success_msg            => 'The current profile option settings are correct.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSC_FIRM_PURCH_REQ_AND_CREATE_TIME_FENCE_PROFILE_CHECK');



debug('begin add_signature: MSO_FIRM_PURCHASE_ORDER_WITHIN_PTF_PROFILE_CHECK');
   l_info('##MASK##7'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8794',
      p_sig_id                 => 'MSO_FIRM_PURCHASE_ORDER_WITHIN_PTF_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_FIRM_PURCHASE_ORDER_WITHIN_PTF%'')
and fpov.profile_option_value = ''Y''',
      p_title                  => 'MSO: Firm Purchase Orders Within Time Fence',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is set to "Yes".  This is known to cause the following issues:<br><br>
<li>ASCP is scheduling a planned order well before the demand date that will consume it, and recommends a quantity that exceeds the demand</li>
<li>Past due Purchase Orders are seen moved up to the plan run date and are pegged to the early demand even though there is enough on-hand to cover it</li>
<li>Purchase Order partially pegs to excess while a new planned order is generated</li>
<li>ASCP is suggesting planned orders in some time buckets when there is no Demand</li>
<li>ASCP Plan is not considering the scheduled PO receipts that are due today, instead to meet the demand that is in the current bucket, it is creating a fresh Planned Order with an immediate need-by date.</li>
<br>
If you are satisfied with the current plan behavior, this warning may be ignored.  No changes necessary.',
      p_solution               => 'Follow the steps in the note below to resolve this issue:<br>
<br>
[2339805/KB785513] Unexpected Planned Order behavior and/or past due Purchase Orders scheduled earlier even when on-hand is available ',
      p_success_msg            => 'This profile option is set to the correct value.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSO_FIRM_PURCHASE_ORDER_WITHIN_PTF_PROFILE_CHECK');



debug('begin add_signature: MSO_FIRM_REQ_WITHIN_PTF_PROFILE_CHECK');
   l_info('##MASK##7'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8837',
      p_sig_id                 => 'MSO_FIRM_REQ_WITHIN_PTF_PROFILE_CHECK',
      p_sig_sql                => 'select fpo.user_profile_option_name,
fpo.profile_option_name Profile,
fpov.profile_option_value Value,
decode(fpov.level_id,10001,
...
and fu.user_id(+)=fpov.level_value
and fl.login_id(+) = fpov.LAST_UPDATE_LOGIN
and fpo.profile_option_name LIKE (''%MSO_FIRM_REQ_WITHIN_PTF%'')
and fpov.profile_option_value = ''Y''',
      p_title                  => 'MSO: Firm Requisitions Within Time Fence',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This profile option is set to "Yes".<br>
It is not recommended that this profile option be set to "Yes" unless there is a critical business reason to firm purchase requisitions.<br>
There may be other implications to consider by doing this.&nbsp; For example, this setting is known to cause or play a role in the following issues:
<br>
<br>
<li>ASCP is scheduling a planned order well before the demand date that will consume it, and recommends a quantity that exceeds the demand.</li>
<li>Internal requisitions are not being considered by ASCP Plan. The plan is ignoring them and is creating fresh planned orders.  The internal requisitions are pegged to excess.</li>',
      p_solution               => 'If you are satisfied with the current plan output, then this warning may be ignored and no changes are necessary.<br>
Otherwise, follow the solution steps mentioned in:<br>
<br>
[1113615/KB432511] Internal Requisitions Are Not Being Considered By ASCP. New Supplies Are Generated<br>
<br>
Additional References Include:<br>
[1484474/KB610704] ASCP Planned Order Scheduled Early And Exceeds Demand<br>
[2035089/KB794116] EDD Constrained Plan Unfirms Purchase Requisitions',
      p_success_msg            => 'This profile option is set to "No".  This is the recommended setting.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MSO_FIRM_REQ_WITHIN_PTF_PROFILE_CHECK');
...
BEGIN
  ...
  analyzer_title := 'VCP Planning Output Setup Analyzer';
...
debug('begin section: SAFETY_STOCK');
start_section('Safety Stock Profiles', 'SAFETY_STOCK');
   set_item_result(run_stored_sig('MSC_VIOLATE_ORDER_MODIFIER_SS_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_SCO_MRP_SS_LOGIC_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_TRANS_SS_SUPPLY_CHOICE_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_SS_WINDOW_SIZE_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSC_SS_INTERVAL_DAYS_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSC_SS_SMOOTHING_METHOD_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSC_SS_MIN_VARIATION_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSC_SS_MAX_VARIATION_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSC_SS_SMOOTH_NON_MRP_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_DEFAULT_TIMESTAMP_SFTSTC_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSC_IGNORE_SS_IN_LEAD_TIME_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSC_MAKE_SS_TRANSIENT_PROFILE_CHECK'));
end_section;
debug('end section: SAFETY_STOCK');

debug('begin section: PEGGING');
start_section('Pegging Profiles', 'PEGGING');
   set_item_result(run_stored_sig('MRP_FIRM_OE_XFERRED_INTERNAL_REQ_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MRP_FIRM_REQS_WITHIN_TF_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSC_APPLY_OM_TO_START_QTY_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSC_APPLY_TOL_PLAN_ORD_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSC_BKT_REFERENCE_CALENDAR_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSC_CONSOL_INTERPLANT_DEM_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSC_DEMAND_SA_PER_THRESHHOLD_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSC_INCLUDE_FPO_IN_FAW_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSC_INCLUDE_SS_IN_PRIORITY_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSC_MIN_SUP_DEM_PER_PEG_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSC_NEW_PLANNER_BACK_COMPATIBILITY_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSC_PREF_FOR_BUCKET_CHECK'));
   set_item_result(run_stored_sig('MSC_USE_FIFO_PEGGING_CHECK'));
   set_item_result(run_stored_sig('MSC_USE_SCO_DATE_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSC_PREVENT_NSJOB_LOOP_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_EDD_SCHEDULING_WINDOW_CONTROL_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSC_FIRM_SUPPLY_FWD_FENCE_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_PEG_BYPROD_SUPP_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSC_ENABLE_GROUP_BASED_NETTING_PROFILE_CHECK'));
end_section;
debug('end section: PEGGING');

debug('begin section: AUTOMATIC_PROFILES');
start_section('Profiles That Override Plan Default Parameters', 'AUTOMATIC_PROFILES');
   set_item_result(run_stored_sig('MSO_SCO_ALT_PROCESS_PENALTY_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_SCO_ALT_RESOURCE_PENALTY_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_SCO_ALT_SOURCE_PENALTY_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_CPX_PARAM_CRAIND_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_CPX_PARAM_DEPIND_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_CPX_PARAM_REINV_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_CPX_PARAM_SCAIND_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_CPX_PARAM_DPRIIND_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_CPX_PARAM_TILIM_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_CPX_PARAM_PRICELIM_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_CPX_DUAL_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_CPX_PARAM_AGGFILL_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_CPX_PARAM_AGGIND_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_CPX_PARAM_EPMRK_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_CPX_PARAM_EPOPT_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_CPX_PARAM_EPPER_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_CPX_PARAM_EPRHS_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_CPX_PARAM_ITLIM_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_CPX_PARAM_PERIND_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_CPX_PARAM_PERLIM_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_CPX_PARAM_PREIND_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_CPX_PARAM_PREPASS_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_CPX_PARAM_SINGLIM_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_HLS_ACTIVITY_DURATION_MAX_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_PARAM_PPRIIND_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_SCO_PREPROC_REDUCTION_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_MAX_EXCESS_RESOURCE_UNITS_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_MAX_PULL_OPERATION_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_MAXIMUM_PREPONES_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_LP_ALGORITHM_PROFILE_CHECK'));
end_section('When the Default Value of a profile option states that it is automatically calculated, this means that the Planning Engine determines the default value of that particular profile option.  If you must change these profile option values, do so only after consulting Oracle Development and Oracle Support

See Automatic Calculations in ASCP User Guide page A-1 for additional details.');
debug('end section: AUTOMATIC_PROFILES');

debug('begin section: CALENDAR_CHECKS');
start_section('Calendar Checks', 'CALENDAR_CHECKS');
   set_item_result(run_stored_sig('CALENDAR_LT_PLAN_HORIZON'));
...
end_section;
debug('end section: CALENDAR_CHECKS');

debug('begin section: PROFILE_OPTION_MANAGEMENT');
start_section('Profile Differences Between Site, User, Application', 'PROFILE_OPTION_MANAGEMENT');
   set_item_result(run_stored_sig('CHANGED_PROFILES_IN_LAST_30_DAYS'));
   set_item_result(run_stored_sig('DIFFERENT_PROFILE_VALUE_SITE_VS_APPL'));
   set_item_result(run_stored_sig('DIFFERENT_PROFILE_VALUE_SITE_VS_RESP'));
   set_item_result(run_stored_sig('DIFFERENT_PROFILE_VALUE_SITE_VS_USER'));
end_section;
debug('end section: PROFILE_OPTION_MANAGEMENT');

debug('begin section: PLANNING_TIME_FENCE');
start_section('Planning Time Fence Profiles', 'PLANNING_TIME_FENCE');
   set_item_result(run_stored_sig('MSC_PTF_DATES_EARLIER_THAN_PLAN_ANCHOR_DATE_CHECK'));
   set_item_result(run_stored_sig('MSC_FIRM_PURCH_REQ_AND_CREATE_TIME_FENCE_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_FIRM_PURCHASE_ORDER_WITHIN_PTF_PROFILE_CHECK'));
   set_item_result(run_stored_sig('MSO_FIRM_REQ_WITHIN_PTF_PROFILE_CHECK'));
end_section;
debug('end section: PLANNING_TIME_FENCE');

debug('begin section: SEQUENCES');
start_section('Sequences', 'SEQUENCES');
   IF g_remote_schema = 'zzz' THEN
   ...
   END IF;
end_section;
debug('end section: SEQUENCES');

debug('begin section: DATA_VERIFY');
start_section('Data Verification, Duplicates, Missing, etc', 'DATA_VERIFY');
   set_item_result(run_stored_sig('GLOBAL_ASL_FOR_SAME_ITEM_AND_SUPPLIER'));
end_section;
debug('end section: DATA_VERIFY');
