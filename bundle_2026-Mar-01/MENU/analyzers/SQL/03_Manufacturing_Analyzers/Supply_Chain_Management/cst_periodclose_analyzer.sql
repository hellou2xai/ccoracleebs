...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Cost Management Period Close Analyzer  |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE cst_periodclose_analyzer_pkg AUTHID DEFINER AS
...
END cst_periodclose_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY cst_periodclose_analyzer_pkg AS
-- $Id: cst_periodclose_analyzer.sql, 200.36 2026/01/27 14:50:06 sothman Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2315206.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'CSTPERIODCLOSE_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'CSTPERIODCLOSE_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>CSTPERIODCLOSE Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2315206.1#feedback");
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4087493" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">1053</span>
...
<ul><li><strong>Version 200.33 28.04.2025</strong>&nbsp;</li>
<li><strong>Enhanced Row Selection and Scrolling Functionality</strong></li>
<li>We are pleased to announce the introduction of a new feature designed to improve the user experience when interacting with large datasets. This enhancement allows for seamless scrolling and highlighting of selected rows, even when dealing with tables containing many columns.</li>
<li><strong>Key Benefits</strong>:</li>
<li>&nbsp; &nbsp;<strong>Improved readability</strong>: When selecting a row, the highlighted selection will remain visible as you scroll horizontally, enabling you to easily read and analyze the data.</li>
...
<li>This new feature is designed to provide a more intuitive and user-friendly experience, enabling you to work more efficiently with your data.</li>
<li><strong>Improved Identification Signatures</strong>: We have made several adjustments to our identification signatures to ensure that the rows returned are accurate and reliable. These updates will help to reduce errors and improve overall data quality.</li>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1053,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Discrete MFG Execution and Financials" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1053,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Discrete MFG Execution and Financials" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1053,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Discrete MFG Execution and Financials" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/01/27 14:50:05 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'cst_periodclose_analyzer.sql';
...
--Accomodations for 19 c DB ('end Additional Validation');
...
debug('begin add_signature: UNCOSTED_TXNS_COUNT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8379',
      p_sig_id                 => 'UNCOSTED_TXNS_COUNT',
      p_sig_sql                => 'Select count(*),Organization_Id,
decode(costed_flag,
       ''E'',''Error'',
       ''N'',''No'',''Z'') costed_flag,Error_Code,Error_Explanation
From MTL_MATERIAL_TRANSACTIONS
Where COSTED_FLAG is NOT NULL
Group by Organization_Id,costed_flag,Error_Code,Error_Explanation
Order by Organization_Id',
      p_title                  => 'Uncosted Transactions Count',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found uncosted transactions on the MTL_MATERIAL_TRANSACTIONS.<br>
There are transactions that need review in Material Transactions table (MTL_MATERIAL_TRANSACTIONS MMT).<br> 
Problem transactions typically have ERROR_CODEs and ERROR_EXPLANATIONS.<br>
An uncosted transaction will prevent period close if not processed.<br>
For more details, please reference the "Error Transactions Detail" section of the analyzer output. ',
      p_solution               => '<ul><li>See the Solutions in [1069492/KB734522] Resolving Period Close Pending Transaction R12</li></ul>
',
      p_success_msg            => 'There are no transactions that need review in Material Transactions table (MTL_MATERIAL_TRANSACTIONS MMT)
...
',
   ...
   l_info.delete;
debug('end add_signature: UNCOSTED_TXNS_COUNT');



debug('begin add_signature: CST_WIP_INTERFACE_ERR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6730',
      p_sig_id                 => 'CST_WIP_INTERFACE_ERR',
      p_sig_sql                => 'Select transaction_id, decode(process_status,
       ''1'',''Pending'',
       ''3'',''Error'') process_status,organization_id, organization_code , wip_entity_id, wip_entity_name, transaction_date, acct_period_id 
from wip_cost_txn_interface 
Order By Organization_Id',
      p_title                  => 'Pending WIP Cost Interface WIP_COST_TXN_INTERFACE',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are WIP Cost transactions pending to get costed.<br>
For more details, please reference the "Error Transactions Detail" section of the analyzer output.',
      p_solution               => 'See the Solutions in Resolving Period Close Pending Transaction R12 [1069492/KB734522#WIP].',
      p_success_msg            => 'There are no WIP pending transactions that need review in WIP Transactions table (wip_cost_txn_interface WCTI).',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CST_WIP_INTERFACE_ERR');



debug('begin add_signature: CST_LC_ADJ_INTERFACE_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8447',
      p_sig_id                 => 'CST_LC_ADJ_INTERFACE_ERRORS',
      p_sig_sql                => 'select TRANSACTION_ID,GROUP_ID,ERROR_COLUMN,ERROR_MESSAGE,CREATION_DATE,LAST_UPDATE_DATE,REQUEST_ID,PROGRAM_APPLICATION_ID,PROGRAM_ID,PROGRAM_UPDATE_DATE
from cst_lc_adj_interface_errors',
      p_title                  => 'Costing cst_lc_adj_interface_errors',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are transactions that need review in LCM Interface Error table (cst_lc_adj_interface_errors).',
      p_solution               => '<ul><li>See the Solutions in [1069492/KB734522] Resolving Period Close Pending Transaction R12 </li></ul>
',
      p_success_msg            => 'There are no transactions that need review in LCM Interface Error table (cst_lc_adj_interface_errors)
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: CST_LC_ADJ_INTERFACE_ERRORS');



debug('begin add_signature: CST_LC_ADJ_INTERFACE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8446',
      p_sig_id                 => 'CST_LC_ADJ_INTERFACE',
      p_sig_sql                => 'select distinct ce.error_message, ce.error_column, c.*, o.*
from cst_lc_adj_interface c, org_acct_periods o,
cst_lc_adj_interface_errors ce
where c.transaction_id = ce.transaction_id
and c.organization_id = o.organization_id
and rownum < 1000',
      p_title                  => 'Costing LCM Interface Errors (CST_LC_ADJ_INTERFACE)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are transactions that need review in LCM Interface table (CST_LC_ADJ_INTERFACE).',
      p_solution               => '<ul><li>See the Solutions in [1069492/KB734522] Resolving Period Close Pending Transaction R12 </li></ul>
',
      p_success_msg            => 'There are no transactions that need review in LCM Interface table (cst_lc_adj_interface)',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('CST_LC_ADJ_INTERFACE_ERRORS'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '7'
      );
   l_info.delete;
debug('end add_signature: CST_LC_ADJ_INTERFACE');



debug('begin add_signature: CST_MTI_TRANS_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8384',
      p_sig_id                 => 'CST_MTI_TRANS_ERRORS',
      p_sig_sql                => 'Select *
from MTL_TRANSACTIONS_INTERFACE
where error_code is not null or error_explanation is not null',
      p_title                  => 'Transactions Interface (MTL_TRANSACTIONS_INTERFACE MTI)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are unprocessed transactions in the Transactions Interface (MTL_TRANSACTIONS_INTERFACE MTI). These may be valid transactions that simply need to be processed by the transactions manager. Problem transactions typically have ERROR_CODEs and ERROR_EXPLANATIONS',
      p_solution               => '<ul><li>See the Solutions in [1063689/KB559654] - Transactions Interface MTL_TRANSACTIONS_INTERFACE MTI Error Messages, Meanings, and Solutions</li></ul>',
   ...
   l_info.delete;
debug('end add_signature: CST_MTI_TRANS_ERRORS');



debug('begin add_signature: CST_MMTT_TRANS_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8385',
      p_sig_id                 => 'CST_MMTT_TRANS_ERRORS',
      p_sig_sql                => 'Select *
from mtl_material_transactions_temp
where error_code is not null or error_explanation is not null',
      p_title                  => 'Pending Transactions (MTL_MATERIAL_TRANSACTIONS_TEMP MMTT)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are unprocessed transactions in Pending Transactions (MTL_MATERIAL_TRANSACTIONS_TEMP MMTT). These may be valid transactions that simply need to be processed by the transactions manager. Problem transactions typically have ERROR_CODEs and ERROR_EXPLANATIONS',
      p_solution               => '<ul><li>See the Solutions in [1070343/KB159414] - Pending Transactions MTL_MATERIAL_TRANSACTIONS_TEMP MMTT Error Messages, Meanings and Solutions</li></ul>',
      p_success_msg            => 'There are no unprocessed transactions in Pending Transactions (MTL_MATERIAL_TRANSACTIONS_TEMP MMTT).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CST_MMTT_TRANS_ERRORS');



debug('begin add_signature: PJM_ERROR_TRANSACTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13556',
      p_sig_id                 => 'PJM_ERROR_TRANSACTIONS',
      p_sig_sql                => 'select transaction_id, last_update_date, request_id, program_application_id, program_id, transaction_date, acct_period_id, error_code, error_explanation
from mtl_material_transactions
where PM_COST_COLLECTED = ''E''
and transaction_date >= sysdate-90',
      p_title                  => 'Error transactions in Project Cost Collection',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'After running the Cost Collection Manager program to transfer misc issues to Projects, some transactions were marked with pm_cost_collected = E.',
      p_solution               => 'How To Reset Transactions That Have Erred in Project Cost Collection [422044/KB198291]',
      p_success_msg            => 'There are no transactions in error.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PJM_ERROR_TRANSACTIONS');



debug('begin add_signature: CST_NULL_COST_MMT_TABLE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13822',
      p_sig_id                 => 'CST_NULL_COST_MMT_TABLE',
      p_sig_sql                => 'select TRANSACTION_ID,ORGANIZATION_ID,COST_ELEMENT_ID,LEVEL_TYPE,LAST_UPDATE_DATE,CREATION_DATE,REQUEST_ID,PROGRAM_APPLICATION_ID,PROGRAM_ID,PROGRAM_UPDATE_DATE,INVENTORY_ITEM_ID,TRANSACTION_COST,NEW_AVERAGE_COST,PERCENTAGE_CHANGE,VALUE_CHANGE
...
and percentage_change is null',
      p_title                  => 'NULL cost values in MMT table',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'When checking the material transactions the following error occurs.

ERROR
-----------------------
CSTPACIN.COST_INV_TXN:CSTPAVCP.average_cost_update (40): ORA-01400: cannot insert NULL into...',
      p_solution               => 'Costed Flag Error In Mtl_material_transactions,cannot insert NULL into ("BOM"."CST_LAYER_COST_DETAILS"."ITEM_COST") [1440923/KB334718]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CST_NULL_COST_MMT_TABLE');



debug('begin add_signature: UNCOSTED_MMT_WITH_MTA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12626',
      p_sig_id                 => 'UNCOSTED_MMT_WITH_MTA',
      p_sig_sql                => 'SELECT mmt.TRANSACTION_ID,mmt.CREATION_DATE,mmt.INVENTORY_ITEM_ID,mmt.ORGANIZATION_ID,mmt.TRANSACTION_TYPE_ID,mmt.TRANSACTION_DATE,
DECODE(COSTED_FLAG, ''E'',''Error'', ''N'',''No'') COSTED_FLAG, mmt.ERROR_CODE, mmt.ERROR_EXPLANATION, mmt.TRANSACTION_GROUP_ID, mmt.TRANSACTION_SET_ID
FROM MTL_MATERIAL_TRANSACTIONS mmt
WHERE mmt.costed_flag in (''N'',''E'')
AND EXISTS ( SELECT 1 FROM MTL_TRANSACTION_ACCOUNTS MTA WHERE MMT.TRANSACTION_ID = MTA.TRANSACTION_ID)',
      p_title                  => 'Uncosted MTL_MATERIAL_TRANSACTIONS Has MTL_TRANSACTION_ACCOUNTS',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'MTL_TRANSACTION_ACCOUNTS has already been generated due to data corruption although the costed_flag of MTL_MATERIAL_TRANSACTIONS is set to N.',
      p_solution               => 'For the solution, refer to Uncosted Material Transaction Has Distribution [2528419/KB726271]',
      p_success_msg            => 'There are no transactions that need review in Material Transactions table (MTL_MATERIAL_TRANSACTIONS MMT)
',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: UNCOSTED_MMT_WITH_MTA');



debug('begin add_signature: EBS_MFG_DM_CSTPERIODCLOSE_COST_MANAGER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26804',
      p_sig_id                 => 'EBS_MFG_DM_CSTPERIODCLOSE_COST_MANAGER',
      p_sig_sql                => 'select count(*) as Active_Cost_Managers,fcp.concurrent_program_name
from fnd_concurrent_requests fcr,
fnd_concurrent_programs fcp
where fcr.concurrent_program_id = fcp.concurrent_program_id
and fcp.concurrent_program_name in ( ''CMCTCM'')
and fcr.phase_code <> ''C''
group by fcp.concurrent_program_name
having count(*)<>1',
      p_title                  => 'Cost Manager Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Uncosted transactions exist and the Cost Manager is not Active.',
      p_solution               => 'Please review [304313/KB197216] Understanding Cost Manager.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_DM_CSTPERIODCLOSE_COST_MANAGER');



debug('begin add_signature: EBS_MFG_DMEF_WSM_PENDING_MOVE_FC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29991',
      p_sig_id                 => 'EBS_MFG_DMEF_WSM_PENDING_MOVE_FC',
      p_sig_sql                => 'select interface_id,
       transaction_id,
       creation_date,
       last_update_date,
       request_id,
       ...
       entity_type,
       primary_item_id,
       fm_operation_seq_num from_op,
       fm_intraoperation_step_type from_step,
 ...
 where status < 4',
      p_title                  => 'Pending WSM - Lot Job Move Transactions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Pending move transactions in the interface WSM_LOT_MOVE_TXN_INTERFACE. Unable to Close Inventory Accounting Period Due to Pending WSM transactions.',
      p_solution               => 'Review [1967981/KB402745] for solution steps.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_DMEF_WSM_PENDING_MOVE_FC');



debug('begin add_signature: EBS_MFG_DMEF_WSM_PENDING_WLSMI_FC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29992',
      p_sig_id                 => 'EBS_MFG_DMEF_WSM_PENDING_WLSMI_FC',
      p_sig_sql                => 'select wlsmi.header_id,
       wlsmi.transaction_id,
       wlsmi.group_id,
       ...
       wlsmi.split_flag,
       wlsmi.creation_date,
       wlsmi.last_update_date,
       wlsmi.transaction_date,
       wlsmi.request_id,
       wlsmi.process_status,
       wlsmi.error_message,
       wsli.lot_number starting_lot,
       wsli.inventory_item_id start_item_id,
       wsli.quantity start_quantity,
       wsli.subinventory_code start_subinventory,
       wsli.locator_id start_locator_id,
       wsli.component_issue_quantity,
       wsli.representative_flag,
       wrli.lot_number resulting_lot,
       wrli.inventory_item_id result_item_id,
       wrli.wip_entity_id,
       wrli.quantity result_quantity,
       wrli.subinventory_code result_subinventory,
       wrli.locator_id result_locator_id
  from WSM_LOT_SPLIT_MERGES_INTERFACE wlsmi,
       WSM_STARTING_LOTS_INTERFACE wsli,
       WSM_RESULTING_LOTS_INTERFACE wrli,
       mtl_organizations mp
where wlsmi.header_id = wsli.header_id(+)
   and wlsmi.header_id = wrli.header_id(+)
   and wlsmi.organization_id = mp.organization_id(+)
   and wlsmi.process_status < 4',
      p_title                  => 'Pending WSM - Shop Floor Lot Transactions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Pending records in WSM Lot Transactions Interface WSM_LOT_SPLIT_MERGES_INTERFACE. Unable to Close Inventory Accounting Period Due to Pending WSM transactions.',
      p_solution               => 'Please review [1967981/KB402745].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_DMEF_WSM_PENDING_WLSMI_FC');



debug('begin add_signature: EBS_MFG_DMEF_WSM_PENDING_WSMTI_FC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29990',
      p_sig_id                 => 'EBS_MFG_DMEF_WSM_PENDING_WSMTI_FC',
      p_sig_sql                => 'select wsmti.header_id,
       wsmti.transaction_type_id,
       wsmti.transaction_date,
       mp.organization_code,
       wsmti.group_id sm_group_id,
       wsmti.process_status sm_process_status,
       wsmti.transaction_id,
       wsmti.error_message sm_error_message,
       wsmti.creation_date,
       wsmti.last_update_date,
       wsmti.request_id,
       wsji.wip_entity_id start_job_id,
       wsji.wip_entity_name start_job_number,
       wsji.operation_seq_num sj_start_operation,
       wsji.intraoperation_step start_step,
       wsji.representative_flag,
       wsji.primary_item_id starting_item,
       wsji.error_message sj_error_message,
       wrji.wip_entity_name result_job_number,
       wrji.primary_item_id resulting_item,
       wrji.start_quantity result_quantity,
       wrji.completion_subinventory result_comp_subinv,
       wrji.starting_operation_seq_num rj_start_operation,
       wrji.starting_intraoperation_step result_step,
       wrji.starting_wip_entity_rename,
       wrji.process_status rj_process_status,
       wrji.error_message rj_error_message
...
where wsmti.header_id = wsji.header_id(+)
   ...
   and wsmti.organization_id = mp.organization_id(+)
   and wsmti.process_status < 4',
      p_title                  => 'Pending WSM - Shop Floor Split Merge Bonus Job Transactions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Pending records in WSM Split Merge Bonus TXN Interface WSM_SPLIT_MERGE_TXN_INTERFACE. Unable to Close Inventory Accounting Period Due to Pending WSM transactions.',
      p_solution               => 'Review [1967981/KB402745] for solution steps.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_DMEF_WSM_PENDING_WSMTI_FC');



debug('begin add_signature: EBS_MFG_DMEF_CSTPERIODCLOSE_CST_WTI_TRANSACTION_PENDING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30303',
      p_sig_id                 => 'EBS_MFG_DMEF_CSTPERIODCLOSE_CST_WTI_TRANSACTION_PENDING',
      p_sig_sql                => 'SELECT
    wtie.error_column,
    wtie.error_message,
    wmti.transaction_id,
...
WHERE
    wmti.transaction_id = wtie.transaction_id (+)
    AND EXISTS (
        SELECT
            ''x''
        FROM
      ...
      p_title                  => 'Pending Move Transactions in WIP_MOVE_TXN_INTERFACE',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are Pending/Error transactions in the WIP Move Transactions Interface (WIP_MOVE_TXN_INTERFACE WTI).
These stuck transactions in WTI is causing issue for costing the transactions since dependent transactions are not yet costed in the system.
Problem transactions typically have ERROR_COLUMN and ERROR_MESSAGE to check and process it further.
',
      p_solution               => '<ul><li>Review solution steps in the below documents to clear the error from the WIP_MOVE_TXN_INTERFACE.

[1069492/KB734522] Resolving Period Close Pending Transaction R12 ( Topic :Pending Shop Floor Move)
[457066/KB627612] WIP_MOVE_TXN_INTERFACE Common Errors In Pending Move Transactions With Possible Causes And Action Plan To Process Them.</li></ul>',
      p_success_msg            => 'There are no pending/Stuck Move order transaction is exists in the system
',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_DMEF_CSTPERIODCLOSE_CST_WTI_TRANSACTION_PENDING');



debug('begin add_signature: CST_INVALID_ACCT_ALIAS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6480',
      p_sig_id                 => 'CST_INVALID_ACCT_ALIAS',
      p_sig_sql                => 'Select TRANSACTION_ID,CREATION_DATE,INVENTORY_ITEM_ID,ORGANIZATION_ID,SUBINVENTORY_CODE,TRANSACTION_TYPE_ID, 
TRANSACTION_SOURCE_ID,TRANSACTION_DATE,ACCT_PERIOD_ID,decode(COSTED_FLAG,
       ''E'',''Error'',
       ''N'',''No'') COSTED_FLAG,ERROR_CODE,ERROR_EXPLANATION,COST_GROUP_ID
from MTL_MATERIAL_TRANSACTIONS
where costed_flag = ''E''
and upper(error_code) like ''%CST_INVALID_ACCT_ALIAS%''
Order by Organization_Id',
      p_title                  => 'CST_INVALID_ACCT_ALIAS The Account Alias is not Defined For this Organization',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Records returned indicate the following error may have been received:
Error Code: CST_INVALID_ACCT_ALIAS
Error Explanation: The account alias is not defined for this organization

',
      p_solution               => '<ul><li>See the Solutions in [428403/KB163417] Uncosted Transaction Error: CST_INVALID_ACCT_ALIAS / The Account Alias Is Not Defined For This Org</li></ul>
',
      p_success_msg            => 'There are no transactions that need review in Material Transactions table (MTL_MATERIAL_TRANSACTIONS MMT)
',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: CST_INVALID_ACCT_ALIAS');



debug('begin add_signature: CST_INVALID_INTERORG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6476',
      p_sig_id                 => 'CST_INVALID_INTERORG',
      p_sig_sql                => 'Select TRANSACTION_ID,CREATION_DATE,INVENTORY_ITEM_ID,ORGANIZATION_ID,SUBINVENTORY_CODE,TRANSACTION_TYPE_ID, 
TRANSACTION_SOURCE_ID,TRANSACTION_DATE,ACCT_PERIOD_ID,decode(COSTED_FLAG,
       ''E'',''Error'',
       ''N'',''No'') COSTED_FLAG,ERROR_CODE,ERROR_EXPLANATION,COST_GROUP_ID
from MTL_MATERIAL_TRANSACTIONS
where costed_flag = ''E''
and upper(error_code) like ''%CST_INVALID_INTERORG%''
Order by Organization_Id',
      p_title                  => 'CST_INVALID_INTERORG: The Inter-Organization Transaction is From and to The Same Organization',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Records returned indicate the following error may have been received:
Error Code: CST_INVALID_INTERORG
Error Explanation: The inter-organization transaction is from and to the same organization

',
      p_solution               => '<ul><li>See the Solutions in [1461380/KB783182] CST_INVALID_INTERORG: Error On Costing Material Transactions: Inter-organization transfer transaction is from and to the same organization</li></ul>
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: CST_INVALID_INTERORG');



debug('begin add_signature: CST_INVALID_JOB_DATE_TRANSACTION_DATE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6487',
      p_sig_id                 => 'CST_INVALID_JOB_DATE_TRANSACTION_DATE',
      p_sig_sql                => 'select TRANSACTION_ID,
       ...
       TRANSACTION_DATE,
       ACCT_PERIOD_ID,
       decode(COSTED_FLAG, ''E'', ''Error'', ''N'', ''No'') COSTED_FLAG,
       ERROR_CODE,
       ERROR_EXPLANATION,
       COST_GROUP_ID
  from MTL_MATERIAL_TRANSACTIONS mmt
 WHERE mmt.COSTED_FLAG = ''E''
      ...
      p_title                  => 'Invalid Job Date: Transaction Date Precedes the Release Date of the Job or Schedule',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Records returned indicate the following error may have been received:
Error Code: CST_INVALID_JOB_DATE
Error Explanation: The transaction date precedes the release date of the job or schedule

',
      p_solution               => '<ul><li>See the Solutions in [1461855/KB372321] [Data Fix] Resource [WIP_COST_TXN_INTERFACE (WCTI)]/ Material [MTL_MATERIAL_TRANSACTIONS (MMT)] Transactions Having Error CST_INVALID_JOB_DATE - Transaction Date Precedes Release Date For The Job/schedule</li></ul>
...
',
   ...
   l_info.delete;
debug('end add_signature: CST_INVALID_JOB_DATE_TRANSACTION_DATE');



debug('begin add_signature: CST_INVALID_WIP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6484',
      p_sig_id                 => 'CST_INVALID_WIP',
      p_sig_sql                => 'select TRANSACTION_ID,
       CREATION_DATE,
       INVENTORY_ITEM_ID,
       ORGANIZATION_ID,
  ...
  from MTL_MATERIAL_TRANSACTIONS
 where costed_flag = ''E''
   and upper(error_code) IN
       (''WIP_NO_BALANCE'', ''CST_NO_BALANCE_ROW'', ''CST_INVALID_WIP'')
   and nvl(flow_schedule, ''N'') != ''Y''    
 Order by Organization_Id',
      p_title                  => 'CST_INVALID_WIP  WIP Entity is Either not Defined or Does not Have a Period Balance Entry',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Records returned indicate any of the following error may have been received:

ERROR CODE: CST_INVALID_WIP
ERROR_EXPLANATION: The wip entity is either not defined or does not have a period balance entry
or
ERROR CODE: CST_NO_BALANCE_ROW
ERROR_EXPLANATION: Record not found in WIP_PERIOD_BALANCE.
or
ERROR CODE: WIP_NO_BALANCE
ERROR_EXPLANATION: No balance exists for the appropriate period for the job/schedule


',
      p_solution               => '<ul><li>See solution in [2052420/KB325716] [Data Fix] Resource [WIP_COST_TXN_INTERFACE (WCTI)]/ Material Transactions [MTL_MATERIAL_TRANSACTIONS (MMT)] Having Errors Related to WIP_PERIOD_BALANCES Table</li></ul>
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: CST_INVALID_WIP');



debug('begin add_signature: CST_MATCH_DATE_PERIOD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6448',
      p_sig_id                 => 'CST_MATCH_DATE_PERIOD',
      p_sig_sql                => 'Select TRANSACTION_ID,CREATION_DATE,INVENTORY_ITEM_ID,ORGANIZATION_ID,SUBINVENTORY_CODE,TRANSACTION_TYPE_ID, 
TRANSACTION_SOURCE_ID,TRANSACTION_DATE,ACCT_PERIOD_ID,decode(COSTED_FLAG,
       ''E'',''Error'',
       ''N'',''No'') COSTED_FLAG,ERROR_CODE,ERROR_EXPLANATION,COST_GROUP_ID
from MTL_MATERIAL_TRANSACTIONS
where costed_flag = ''E''
and upper(error_code) like ''%CST_MATCH_DATE_PERIOD%''
Order by Organization_Id',
      p_title                  => 'CST_MATCH_DATE_PERIOD Transaction Date is Not Within the Accounting Period Specified',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Records returned indicate the following error may have been received:
...
',
      p_solution               => '<ul><li>See the Solutions in [360117/KB197383] Error Txn CST_MATCH_DATE_PERIOD ''The transaction date is not within the accounting period specified''.</li></ul>
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: CST_MATCH_DATE_PERIOD');



debug('begin add_signature: CST_MATCH_TXFR_CG_ORG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6469',
      p_sig_id                 => 'CST_MATCH_TXFR_CG_ORG',
      p_sig_sql                => 'Select TRANSACTION_ID,CREATION_DATE,INVENTORY_ITEM_ID,ORGANIZATION_ID,SUBINVENTORY_CODE,TRANSACTION_TYPE_ID, 
TRANSACTION_SOURCE_ID,TRANSACTION_DATE,ACCT_PERIOD_ID,decode(COSTED_FLAG,
       ''E'',''Error'',
       ''N'',''No'') COSTED_FLAG,ERROR_CODE,ERROR_EXPLANATION,COST_GROUP_ID
from MTL_MATERIAL_TRANSACTIONS
where costed_flag = ''E''
and upper(error_code) like ''%CST_MATCH_TXFR_CG%''
Order by Organization_Id',
      p_title                  => 'CSTPACIN.COST_INV_TXN There are no Accounts Defined For The Cost  Group Associated With This Transaction',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Records returned indicate the following error may have been received:
Error Code: CST_MATCH_TXFR_CG_ORG or CST_MATCH_TXFR_CG_TXFR_ORG
Error Explanation: CSTPACIN.COST_INV_TXN:There are no accounts defined for the cost group associated with this transaction

',
      p_solution               => '<ul><li>See the Solutions in [453138/KB721156] Errors CST_MATCH_TXFR_CG_ORG or CST_MATCH_TXFR_CG_TXFR_ORG No Accounts Defined for the Cost Group in Material Transactions</li></ul>
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: CST_MATCH_TXFR_CG_ORG');



debug('begin add_signature: CST_NO_TXN_INVALID_ACCOUNT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6470',
      p_sig_id                 => 'CST_NO_TXN_INVALID_ACCOUNT',
      p_sig_sql                => 'Select TRANSACTION_ID,CREATION_DATE,INVENTORY_ITEM_ID,ORGANIZATION_ID,SUBINVENTORY_CODE,TRANSACTION_TYPE_ID, 
TRANSACTION_SOURCE_ID,TRANSACTION_DATE,ACCT_PERIOD_ID,decode(COSTED_FLAG,
       ''E'',''Error'',
       ''N'',''No'') COSTED_FLAG,ERROR_CODE,ERROR_EXPLANATION,COST_GROUP_ID
from MTL_MATERIAL_TRANSACTIONS
where costed_flag = ''E''
and upper(error_code) like ''%CST_NO_TXN_INVALID_ACCOUNT%''
Order by Organization_Id',
      p_title                  => 'CSTPACIN.COST_INV_TXN An Invalid Account is Associated With The Item Being Transacted',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Records returned indicate the following error may have been received:
Error Code: CST_NO_TXN_INVALID_ACCOUNT
Error Explanation: CSTPACIN.COST_INV_TXN:An invalid account is associated with the item being transacted.

',
      p_solution               => '<ul><li>See the Solutions in [1941726/KB856585] CST_NO_TXN_INVALID_ACCOUNT - CSTPACIN.COST_INV_TXN:An invalid account is associated with the item being transacted</li></ul>
',
      p_success_msg            => 'There are no transactions that need review in Material Transactions table (MTL_MATERIAL_TRANSACTIONS MMT)
',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: CST_NO_TXN_INVALID_ACCOUNT');



debug('begin add_signature: CST_REVENUECOGSMATCH_PVT.PROCESS_RMARECEIPT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6475',
      p_sig_id                 => 'CST_REVENUECOGSMATCH_PVT.PROCESS_RMARECEIPT',
      p_sig_sql                => 'Select TRANSACTION_ID,CREATION_DATE,INVENTORY_ITEM_ID,ORGANIZATION_ID,SUBINVENTORY_CODE,TRANSACTION_TYPE_ID, 
TRANSACTION_SOURCE_ID,TRANSACTION_DATE,ACCT_PERIOD_ID,decode(COSTED_FLAG,
       ''E'',''Error'',
       ''N'',''No'') COSTED_FLAG,ERROR_CODE,ERROR_EXPLANATION,COST_GROUP_ID
from MTL_MATERIAL_TRANSACTIONS
where costed_flag = ''E''
and error_explanation like ''%CSTPACIN.COST_INV_TXN%Failure in procedure CST_RevenueCogsMatch_PVT.Process_RmaReceipt%''
Order by Organization_Id',
      p_title                  => 'CSTPACIN.COST_INV_TXN:Failure in procedure CST_RevenueCogsMatch_PVT.Process_RmaReceipt',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Records returned indicate the following error may have been received:
Error Code: No Error
Error Explanation: CSTPACIN.COST_INV_TXN:Failure in procedure CST_RevenueCogsMatch_PVT.Process_RmaReceipt

',
      p_solution               => '<ul><li>See the Solutions in [733275/KB755346] CSTPACIN.COST_INV_TXN:Failure in procedure CST_RevenueCogsMatch_PVT.Process_RmaReceipt </li></ul>
',
      p_success_msg            => 'There are no transactions that need review in Material Transactions table (MTL_MATERIAL_TRANSACTIONS MMT)
',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: CST_REVENUECOGSMATCH_PVT.PROCESS_RMARECEIPT');



debug('begin add_signature: CSTPLCIN.COST_INV_TXN CSTPACDP.INV_COST_TXN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6473',
      p_sig_id                 => 'CSTPLCIN.COST_INV_TXN CSTPACDP.INV_COST_TXN',
      p_sig_sql                => 'Select TRANSACTION_ID,CREATION_DATE,INVENTORY_ITEM_ID,ORGANIZATION_ID,SUBINVENTORY_CODE,TRANSACTION_TYPE_ID, 
TRANSACTION_SOURCE_ID,TRANSACTION_DATE,ACCT_PERIOD_ID,decode(COSTED_FLAG,
       ''E'',''Error'',
       ''N'',''No'') COSTED_FLAG,ERROR_CODE,ERROR_EXPLANATION,COST_GROUP_ID
from MTL_MATERIAL_TRANSACTIONS
where costed_flag = ''E''
and upper (error_explanation) like ''%CSTPACIN.COST_INV_TXN%CSTPACDP.INV_COST_TXN (10)%''
Order by Organization_Id',
      p_title                  => 'CSTPACIN.COST_INV_TXN:CSTPACDP.inv_cost_txn (10): ORA-01403: no data found',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Records returned indicate the following error may have been received:
CSTPACIN.COST_INV_TXN:CSTPACDP.inv_cost_txn (10): ORA-01403: no data found


',
      p_solution               => '<ul><li>See the Solutions in [246762/KB198112] Uncosted Transaction Error: CSTPACIN.COST_INV_TXN:CSTPACDP.inv_cost_txn (10): ORA-01403: no data found </li></ul>
',
      p_success_msg            => 'There are no transactions that need review in Material Transactions table (MTL_MATERIAL_TRANSACTIONS MMT)
...
',
   ...
   l_info.delete;
debug('end add_signature: CSTPLCIN.COST_INV_TXN CSTPACDP.INV_COST_TXN');



debug('begin add_signature: CST_INVALID_CG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7471',
      p_sig_id                 => 'CST_INVALID_CG',
      p_sig_sql                => 'Select TRANSACTION_ID,CREATION_DATE,INVENTORY_ITEM_ID,ORGANIZATION_ID,SUBINVENTORY_CODE,TRANSACTION_TYPE_ID, 
TRANSACTION_SOURCE_ID,TRANSACTION_DATE,ACCT_PERIOD_ID,decode(COSTED_FLAG,
       ''E'',''Error'',
       ''N'',''No'') COSTED_FLAG,ERROR_CODE,ERROR_EXPLANATION,COST_GROUP_ID
from MTL_MATERIAL_TRANSACTIONS
where costed_flag = ''E''
and upper(error_code) like ''% CST_INVALID_CG %''
Order by Organization_Id',
      p_title                  => 'CST_INVALID_CG The Cost Group is Either Null or Does Not Have Accounts Defined in Association With The Organization',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found transactions on the MTL_MATERIAL_TRANSACTIONS with a COSTED_FLAG of "E".The following error occurs:
ERROR
-----------------------
Error Code: CST_INVALID_CG
Error Explanation: The cost group is either null or does not have accounts defined in association with the organization',
      p_solution               => 'See the Solutions in [1941239/KB734273] Physical Inventory Adjustment transaction failed with Error Code: CST_INVALID_CG in Mtl_Material_Transactions table ',
      p_success_msg            => 'There are no transactions that need review in Material Transactions table (MTL_MATERIAL_TRANSACTIONS MMT) 
...
',
   ...
   l_info.delete;
debug('end add_signature: CST_INVALID_CG');



debug('begin add_signature: CSTPACDP.LOGICAL_COST_TXN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7531',
      p_sig_id                 => 'CSTPACDP.LOGICAL_COST_TXN',
      p_sig_sql                => 'Select TRANSACTION_ID,CREATION_DATE,INVENTORY_ITEM_ID,ORGANIZATION_ID,SUBINVENTORY_CODE,TRANSACTION_TYPE_ID, 
TRANSACTION_SOURCE_ID,TRANSACTION_DATE,ACCT_PERIOD_ID,decode(COSTED_FLAG,
       ''E'',''Error'',
       ''N'',''No'') COSTED_FLAG,ERROR_CODE,ERROR_EXPLANATION,COST_GROUP_ID
from MTL_MATERIAL_TRANSACTIONS
where costed_flag = ''E''
and error_explanation like ''%CSTPACDP%logical_cost_txn%User-Defined Exception%''
Order by Organization_Id',
      p_title                  => 'COST_ACCT_EVENTS:(50):CSTPACDP.logical_cost_txn (70)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found transactions on the MTL_MATERIAL_TRANSACTIONS with a COSTED_FLAG of "E". The following error occurs:

ERROR
-----------------------
ERROR_EXPLANATION: CSTPAVCP.COST_ACCT_EVENTS:(50):CSTPACDP.logical_cost_txn (70): User-Defined Exception

',
      p_solution               => '<ul><li>See the Solutions in [1364998/KB733881] Cost Manager Generating Error "Cstpavcp.Cost_acct_events:(50):Cstpacdp.Logical_cost_txn (70): User-Defined Exception"</li></ul>',
      p_success_msg            => 'There are no transactions that need review in Material Transactions table (MTL_MATERIAL_TRANSACTIONS MMT) 
...
',
   ...
   l_info.delete;
debug('end add_signature: CSTPACDP.LOGICAL_COST_TXN');



debug('begin add_signature: CSTPAVCP.COST_ACCT_EVENTS ORA-00001 UNIQUE CONSTRAINT MTL_CST_ACTUAL_COST_DETAIL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7530',
      p_sig_id                 => 'CSTPAVCP.COST_ACCT_EVENTS ORA-00001 UNIQUE CONSTRAINT MTL_CST_ACTUAL_COST_DETAIL',
      p_sig_sql                => 'Select TRANSACTION_ID,CREATION_DATE,INVENTORY_ITEM_ID,ORGANIZATION_ID,SUBINVENTORY_CODE,TRANSACTION_TYPE_ID, 
TRANSACTION_SOURCE_ID,TRANSACTION_DATE,ACCT_PERIOD_ID,decode(COSTED_FLAG,
       ''E'',''Error'',
       ''N'',''No'') COSTED_FLAG,ERROR_CODE,ERROR_EXPLANATION,COST_GROUP_ID
from MTL_MATERIAL_TRANSACTIONS
where costed_flag = ''E''
and error_explanation like ''%CSTPAVCP.COST_ACCT_EVENTS:(41):ORA-00001: unique constraint (INV.MTL_CST_ACTUAL_COST_DETAILS_U1)%''
Order by Organization_Id',
      p_title                  => 'Cstpavcp.Cost_acct_events ORA-00001 Unique Constraint MTL_CST_ACTUAL_COST_DETAILS_U1',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found transactions on the MTL_MATERIAL_TRANSACTIONS with a COSTED_FLAG of "E". The following error occurs:

ERROR
-----------------------
ERROR_EXPLANATION - CSTPAVCP.COST_ACCT_EVENTS:(41):ORA-00001: unique constraint (INV.MTL_CST_ACTUAL_COST_DETAILS_U1) violated

',
      p_solution               => '<ul><li>See the Solutions in [1386349/KB789937] Costing Error: Cstpavcp.Cost_acct_events ORA-00001 Unique Constraint MTL_CST_ACTUAL_COST_DETAILS_U1</li></ul>',
      p_success_msg            => 'There are no transactions that need review in Material Transactions table (MTL_MATERIAL_TRANSACTIONS MMT) 
...
',
   ...
   l_info.delete;
debug('end add_signature: CSTPAVCP.COST_ACCT_EVENTS ORA-00001 UNIQUE CONSTRAINT MTL_CST_ACTUAL_COST_DETAIL');



debug('begin add_signature: CSTPAVCP.COMPUTE_MCACD_COSTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7529',
      p_sig_id                 => 'CSTPAVCP.COMPUTE_MCACD_COSTS',
      p_sig_sql                => 'Select TRANSACTION_ID,CREATION_DATE,INVENTORY_ITEM_ID,ORGANIZATION_ID,SUBINVENTORY_CODE,TRANSACTION_TYPE_ID, 
TRANSACTION_SOURCE_ID,TRANSACTION_DATE,ACCT_PERIOD_ID,decode(COSTED_FLAG,
       ''E'',''Error'',
       ''N'',''No'') COSTED_FLAG,ERROR_CODE,ERROR_EXPLANATION,COST_GROUP_ID
from MTL_MATERIAL_TRANSACTIONS
where costed_flag = ''E''
and error_explanation like ''%CSTPAVCP.COMPUTE_MCACD_COSTS:(30)%User-Defined Exception%''
Order by Organization_Id',
      p_title                  => 'CSTPAVCP.COMPUTE_MCACD_COSTS:(30)::User-Defined Exception',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found transactions on the MTL_MATERIAL_TRANSACTIONS with a COSTED_FLAG of "E". The following error occurs:

ERROR
-----------------------
ERROR_EXPLANATION - CSTPAVCP.COST_ACCT_EVENTS:(35):CSTPAVCP.COMPUTE_MCACD_COSTS:(30)::User-Defined Exception

',
      p_solution               => '<ul><li>See the Solutions in [1680235/KB706891] Material Transactions Err CSTPAVCP.COST_ACCT_EVENTS:(35):CSTPAVCP.COMPUTE_MCACD_COSTS:(30)::User-Defined Exception</li></ul>',
      p_success_msg            => 'There are no transactions that need review in Material Transactions (MTL_MATERIAL_TRANSACTIONS MMT) table
...
',
   ...
   l_info.delete;
debug('end add_signature: CSTPAVCP.COMPUTE_MCACD_COSTS');



debug('begin add_signature: CST_REVENUECOGSMATCH_PVT.INSERT_ONESOISSUE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7488',
      p_sig_id                 => 'CST_REVENUECOGSMATCH_PVT.INSERT_ONESOISSUE',
      p_sig_sql                => 'Select TRANSACTION_ID,CREATION_DATE,INVENTORY_ITEM_ID,ORGANIZATION_ID,SUBINVENTORY_CODE,TRANSACTION_TYPE_ID, 
TRANSACTION_SOURCE_ID,TRANSACTION_DATE,ACCT_PERIOD_ID,decode(COSTED_FLAG,
       ''E'',''Error'',
       ''N'',''No'') COSTED_FLAG,ERROR_CODE,ERROR_EXPLANATION,COST_GROUP_ID
from MTL_MATERIAL_TRANSACTIONS
where costed_flag = ''E''
and error_explanation like ''%CST_RevenueCogsMatch_PVT%Insert_OneSoIssue%''
Order by Organization_Id',
      p_title                  => 'CST_RevenueCogsMatch_PVT . Insert_OneSoIssue',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found transactions on the MTL_MATERIAL_TRANSACTIONS with a COSTED_FLAG of "E". The following error occurs:
...
-----------------------
ERROR_CODE: Null
ERROR_EXPLANATION: Unexpected error in CST_RevenueCogsMatch_PVT . Insert_OneSoIssue',
      p_solution               => '<ul><li>See the Solution in [1304185/KB766102] Unexpected error in CST_RevenueCogsMatch_PVT . Insert_OneSoIssue</li></ul>
',
      p_success_msg            => 'There are no transactions that need review in Material Transactions table (MTL_MATERIAL_TRANSACTIONS MMT) 
...
',
   ...
   l_info.delete;
debug('end add_signature: CST_REVENUECOGSMATCH_PVT.INSERT_ONESOISSUE');



debug('begin add_signature: ERROR IN OBTAINING THE INTERCOMPANY ACCOUNT FROM INVENTORY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7489',
      p_sig_id                 => 'ERROR IN OBTAINING THE INTERCOMPANY ACCOUNT FROM INVENTORY',
      p_sig_sql                => 'Select TRANSACTION_ID,CREATION_DATE,INVENTORY_ITEM_ID,ORGANIZATION_ID,SUBINVENTORY_CODE,TRANSACTION_TYPE_ID, 
TRANSACTION_SOURCE_ID,TRANSACTION_DATE,ACCT_PERIOD_ID,decode(COSTED_FLAG,
       ''E'',''Error'',
       ''N'',''No'') COSTED_FLAG,ERROR_CODE,ERROR_EXPLANATION,COST_GROUP_ID
from MTL_MATERIAL_TRANSACTIONS
where costed_flag = ''E''
and ERROR_EXPLANATION like ''%Error in obtaining the intercompany account from Inventory Workflow%''
and ERROR_CODE like ''%CST_TPRICE_INV_ACCT_ERROR%''
Order by Organization_Id',
      p_title                  => 'CSTPACIN.COST_INV_TXN Error in Obtaining the Intercompany Account From Inventory Workflow',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found transactions on the MTL_MATERIAL_TRANSACTIONS with a COSTED_FLAG of "E". The following error occurs:
...
-----------------------
ERROR_CODE: No Error
ERROR_EXPLANATION - CSTPACIN.COST_INV_TXN:Error in obtaining the intercompany account from Inventory Workflow',
      p_solution               => '<ul><li>See the Solutions in [577619/KB766660] Inter Org txn CSTPACIN.COST_INV_TXN Error In Obtaining The Intercompany Account From Inventory Workflow</li></ul>
',
      p_success_msg            => 'There are no transactions that need review in Material Transactions table (MTL_MATERIAL_TRANSACTIONS MMT) 
...
',
   ...
   l_info.delete;
debug('end add_signature: ERROR IN OBTAINING THE INTERCOMPANY ACCOUNT FROM INVENTORY');



debug('begin add_signature: CSTPAVCP.COST_LOGICALRECEIPT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7527',
      p_sig_id                 => 'CSTPAVCP.COST_LOGICALRECEIPT',
      p_sig_sql                => 'Select TRANSACTION_ID,CREATION_DATE,INVENTORY_ITEM_ID,ORGANIZATION_ID,SUBINVENTORY_CODE,TRANSACTION_TYPE_ID, 
TRANSACTION_SOURCE_ID,TRANSACTION_DATE,ACCT_PERIOD_ID,decode(COSTED_FLAG,
       ''E'',''Error'',
       ''N'',''No'') COSTED_FLAG,ERROR_CODE,ERROR_EXPLANATION,COST_GROUP_ID
from MTL_MATERIAL_TRANSACTIONS
where costed_flag = ''E''
and ERROR_EXPLANATION like ''%CSTPAVCP.Cost_Processor (160): Error in CSTPAVCP.Cost_LogicalReceipt%''
or ERROR_EXPLANATION like ''%CSTPAVCP.Cost_LogicalSOReceipt:(170)%''
Order by Organization_Id',
      p_title                  => 'CSTPACIN.COST_INV_TXN:LogicalReceipt',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found transactions on the MTL_MATERIAL_TRANSACTIONS with a COSTED_FLAG of "E". The following error occurs:
...
-----------------------
ERROR_CODE: No Error
ERROR_EXPLANATION - CSTPACIN.COST_INV_TXN:CSTPAVCP.Cost_Processor (160): Error in CSTPAVCP.Cost_LogicalReceipt 

or 
ERROR_CODE: No Error
ERROR_EXPLANATION - CSTPAVCP.Cost_LogicalSOReceipt:(170): Error raising SLA Event for transaction
',
      p_solution               => '<ul><li>See the Solutions in [1070911/KB722416] CSTPACIN.COST_INV_TXN USER-DEFINED EXCEPTION CSTPAVCP.Cost_LogicalReceipt</li></ul>',
      p_success_msg            => 'There are no transactions that need review in Material Transactions table (MTL_MATERIAL_TRANSACTIONS MMT) 
...
',
   ...
   l_info.delete;
debug('end add_signature: CSTPAVCP.COST_LOGICALRECEIPT');



debug('begin add_signature: CST_MAT_OVERHEAD CSTPACIN.COST_INV_TXN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7528',
      p_sig_id                 => 'CST_MAT_OVERHEAD CSTPACIN.COST_INV_TXN',
      p_sig_sql                => 'Select TRANSACTION_ID,CREATION_DATE,INVENTORY_ITEM_ID,ORGANIZATION_ID,SUBINVENTORY_CODE,TRANSACTION_TYPE_ID, 
TRANSACTION_SOURCE_ID,TRANSACTION_DATE,ACCT_PERIOD_ID,decode(COSTED_FLAG,
       ''E'',''Error'',
       ''N'',''No'') COSTED_FLAG,ERROR_CODE,ERROR_EXPLANATION,COST_GROUP_ID
from MTL_MATERIAL_TRANSACTIONS
where costed_flag = ''E''
and upper(error_code) like ''%CST_MAT_OVERHEAD%''
Order by Organization_Id',
      p_title                  => 'CST_MAT_OVERHEAD CSTPACIN.COST_INV_TXN Cannot Apply Material Overhead Because This Level Material Overhead Subelements Already Exist',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found transactions on the MTL_MATERIAL_TRANSACTIONS with a COSTED_FLAG of "E". The following error occurs:
...
',
      p_solution               => '<ul><li>See the Solutions in [1516310/KB733582] Error Transaction CST_MAT_OVERHEAD CSTPACIN.COST_INV_TXN Cannot apply material overhead because this level material overhead subelements already exist</li></ul>',
      p_success_msg            => 'There are no transactions that need review in Material Transactions table (MTL_MATERIAL_TRANSACTIONS MMT) 
...
',
   ...
   l_info.delete;
debug('end add_signature: CST_MAT_OVERHEAD CSTPACIN.COST_INV_TXN');



debug('begin add_signature: CSTPSISC_INS_STD_COST_100');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7462',
      p_sig_id                 => 'CSTPSISC_INS_STD_COST_100',
      p_sig_sql                => 'Select TRANSACTION_ID,CREATION_DATE,INVENTORY_ITEM_ID,ORGANIZATION_ID,SUBINVENTORY_CODE,TRANSACTION_TYPE_ID, 
TRANSACTION_SOURCE_ID,TRANSACTION_DATE,ACCT_PERIOD_ID,decode(COSTED_FLAG,
       ''E'',''Error'',
       ''N'',''No'') COSTED_FLAG,ERROR_CODE,ERROR_EXPLANATION,COST_GROUP_ID
from MTL_MATERIAL_TRANSACTIONS
where costed_flag = ''E''
and error_explanation like ''%cannot insert NULL into ("INV"."MTL_ACTUAL_COST_SUBELEMENT"."RESOURCE_ID")%''
Order by Organization_Id',
      p_title                  => 'CSTPSISC.INS_STD_COST (100): ORA-01400 Cannot Insert NULL Into ("INV"."MTL_ACTUAL_COST_SUBELEMENT"."RESOURCE_ID")',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found transactions on the MTL_MATERIAL_TRANSACTIONS with a COSTED_FLAG of "E".The following error occurs:
ERROR
-----------------------
CSTPSISC.INS_STD_COST (100): ORA-01400: cannot insert NULL into ("INV"."MTL_ACTUAL_COST_SUBELEMENT"."RESOURCE_ID")',
      p_solution               => '<ul><li>See the Solutions in [1562808/KB721017] CSTPSISC.INS_STD_COST (100): ORA-01400: Cannot Insert NULL Into ("INV"."MTL_ACTUAL_COST_SUBELEMENT".</li></ul>',
      p_success_msg            => 'There are no transactions that need review in Material Transactions (MTL_MATERIAL_TRANSACTIONS MMT) table
...
',
   ...
   l_info.delete;
debug('end add_signature: CSTPSISC_INS_STD_COST_100');



debug('begin add_signature: CSTPSISC_INS_STD_COST_75');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7461',
      p_sig_id                 => 'CSTPSISC_INS_STD_COST_75',
      p_sig_sql                => 'Select TRANSACTION_ID,CREATION_DATE,INVENTORY_ITEM_ID,ORGANIZATION_ID,SUBINVENTORY_CODE,TRANSACTION_TYPE_ID, 
TRANSACTION_SOURCE_ID,TRANSACTION_DATE,ACCT_PERIOD_ID,decode(COSTED_FLAG,
       ''E'',''Error'',
       ''N'',''No'') COSTED_FLAG,ERROR_CODE,ERROR_EXPLANATION,COST_GROUP_ID
from MTL_MATERIAL_TRANSACTIONS
where costed_flag = ''E''
and upper(error_explanation) like ''%CSTPSISC%INS_STD_COST%75%ORA%00001%''
Order by Organization_Id',
      p_title                  => 'CSTPSISC.ins_std_cost CSTPSISC.INS_STD_COST (73): ORA-20100:File o0211330.tmp creation for FND_FILE failed',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found transactions on the MTL_MATERIAL_TRANSACTIONS with a COSTED_FLAG of "E".The following error occurs:
ERROR
-----------------------
CSTPSISC.INS_STD_COST (75): ORA-00001: unique contraint',
      p_solution               => '<ul><li>See the Solutions in [1617589/KB794361] Duplicate Entries found in Material Transaction Distribution Form Error CSTPSISC.INS_STD_COST (75): ORA-00001 </li></ul>',
      p_success_msg            => 'There are no transactions that need review in Material Transactions table (MTL_MATERIAL_TRANSACTIONS MMT) 
...
',
   ...
   l_info.delete;
debug('end add_signature: CSTPSISC_INS_STD_COST_75');



debug('begin add_signature: CSTPLCIN_CSTPLENG_40');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7459',
      p_sig_id                 => 'CSTPLCIN_CSTPLENG_40',
      p_sig_sql                => 'Select TRANSACTION_ID,CREATION_DATE,INVENTORY_ITEM_ID,ORGANIZATION_ID,SUBINVENTORY_CODE,TRANSACTION_TYPE_ID, 
TRANSACTION_SOURCE_ID,TRANSACTION_DATE,ACCT_PERIOD_ID,decode(COSTED_FLAG,
       ''E'',''Error'',
       ''N'',''No'') COSTED_FLAG,ERROR_CODE,ERROR_EXPLANATION,COST_GROUP_ID
from MTL_MATERIAL_TRANSACTIONS
where costed_flag = ''E''
and error_explanation like ''%CSTPLCIN%COST_INV_TXN%CSTPLENG%LAYER_COST_UPDATE%40%ORA-01400%''
Order by Organization_Id',
      p_title                  => 'CSTPLCIN.COST_INV_TXN:CSTPLENG.LAYER_COST_UPDATE (40): ORA-01400',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found transactions on the MTL_MATERIAL_TRANSACTIONS with a COSTED_FLAG of "E".The following error occurs:
ERROR
-----------------------
CSTPLCIN.COST_INV_TXN:CSTPLENG.layer_cost_update (40): ORA-01400: cannot insert NULL into ("BOM"."CST_INV_LAYER_COST_DETAILS"."LAYER_COST")',
      p_solution               => '<ul><li>See the Solutions in [1322126/KB761507] Layer Cost Update Fails With: Cstplcin.Cost_inv_txn:Cstpleng.Layer_cost_update (40): Ora-01400 to solve this type of transaction</li></ul>',
      p_success_msg            => 'There are no transactions that need review in Material Transactions table (MTL_MATERIAL_TRANSACTIONS MMT) 
...
',
   ...
   l_info.delete;
debug('end add_signature: CSTPLCIN_CSTPLENG_40');



debug('begin add_signature: CST_CSTPLCIN_CSTPACDP_30');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7458',
      p_sig_id                 => 'CST_CSTPLCIN_CSTPACDP_30',
      p_sig_sql                => 'Select TRANSACTION_ID,CREATION_DATE,INVENTORY_ITEM_ID,ORGANIZATION_ID,SUBINVENTORY_CODE,TRANSACTION_TYPE_ID, 
TRANSACTION_SOURCE_ID,TRANSACTION_DATE,ACCT_PERIOD_ID,decode(COSTED_FLAG,
       ''E'',''Error'',
       ''N'',''No'') COSTED_FLAG,ERROR_CODE,ERROR_EXPLANATION,COST_GROUP_ID
from MTL_MATERIAL_TRANSACTIONS
where costed_flag = ''E''
and error_explanation = ''CSTPLCIN.COST_INV_TXN:CSTPACDP.cost_txn30User-Defined Exception''
Order by Organization_Id',
      p_title                  => 'CSTPLCIN.COST_INV_TXN:CSTPACDP.cost_txn30User-Defined Exception',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found transactions on the MTL_MATERIAL_TRANSACTIONS with a COSTED_FLAG of "E".The following error occurs:
ERROR
-----------------------
CSTPLCIN.COST_INV_TXN:CSTPACDP.cost_txn30User-Defined Exception',
      p_solution               => '<ul><li>See the Solutions in [1603289/KB772086] Layer Cost Worker fail with CSTPLCIN.COST_INV_TXN:CSTPACDP.cost_txn30User-Defined Exception in FIFO costing to solve this type of transaction</li></ul>',
      p_success_msg            => 'There are no transactions that need review in Material Transactions table (MTL_MATERIAL_TRANSACTIONS MMT) 
...
',
   ...
   l_info.delete;
debug('end add_signature: CST_CSTPLCIN_CSTPACDP_30');



debug('begin add_signature: CST_NO_MAT_OVHDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12577',
      p_sig_id                 => 'CST_NO_MAT_OVHDS',
      p_sig_sql                => 'Select TRANSACTION_ID,CREATION_DATE,INVENTORY_ITEM_ID,ORGANIZATION_ID,SUBINVENTORY_CODE,TRANSACTION_TYPE_ID, 
TRANSACTION_SOURCE_ID,TRANSACTION_DATE,ACCT_PERIOD_ID,decode(COSTED_FLAG,
''E'',''Error'',
''N'',''No'') COSTED_FLAG,ERROR_CODE,ERROR_EXPLANATION,COST_GROUP_ID
from MTL_MATERIAL_TRANSACTIONS
where costed_flag = ''E''
and error_code like ''%CST_NO_MAT_OVHDS%''
Order by Organization_Id',
      p_title                  => 'CST_NO_MAT_OVHDS no material overhead subelements defined',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Records returned indicate the following error may have been received:
Error Code: CST_NO_MAT_OVHDS',
      p_solution               => '<ul><li>See the Solutions in [1537229/KB713235] CST_NO_MAT_OVHDS There Are No Material Overhead Subelements Defined</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: CST_NO_MAT_OVHDS');



debug('begin add_signature: CST_CSTPAVCP.CALC_AVERAGE_COST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12578',
      p_sig_id                 => 'CST_CSTPAVCP.CALC_AVERAGE_COST',
      p_sig_sql                => 'Select TRANSACTION_ID,CREATION_DATE,INVENTORY_ITEM_ID,ORGANIZATION_ID,SUBINVENTORY_CODE,TRANSACTION_TYPE_ID, 
TRANSACTION_SOURCE_ID,TRANSACTION_DATE,ACCT_PERIOD_ID,decode(COSTED_FLAG,
''E'',''Error'',
''N'',''No'') COSTED_FLAG,ERROR_CODE,ERROR_EXPLANATION,COST_GROUP_ID
from MTL_MATERIAL_TRANSACTIONS
where costed_flag = ''E''
and error_explanation like ''%CSTPAVCP.calc_average_cost (30): ORA-01426: numeric overflow%''
Order by Organization_Id',
      p_title                  => 'CST_CSTPAVCP.calc_average_cost (30): ORA-01426: numeric overflow',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Records returned indicate the following error may have been received:
Error Code: CSTPAVCP.calc_average_cost ORA-1426 Numeric Overflow',
      p_solution               => '<ul><li>See the Solutions in [415072/KB197009] Transaction in MMT with Error CSTPAVCP.calc_average_cost ORA-1426 Numeric Overflow</li></ul>',
      p_success_msg            => 'There are no transactions that need review in Material Transactions table (MTL_MATERIAL_TRANSACTIONS MMT)',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: CST_CSTPAVCP.CALC_AVERAGE_COST');



debug('begin add_signature: CST_ORA-20100 ERROR FND_FILE FAILURE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12579',
      p_sig_id                 => 'CST_ORA-20100 ERROR FND_FILE FAILURE',
      p_sig_sql                => 'Select TRANSACTION_ID,CREATION_DATE,INVENTORY_ITEM_ID,ORGANIZATION_ID,SUBINVENTORY_CODE,TRANSACTION_TYPE_ID, 
TRANSACTION_SOURCE_ID,TRANSACTION_DATE,ACCT_PERIOD_ID,decode(COSTED_FLAG,
''E'',''Error'',
''N'',''No'') COSTED_FLAG,ERROR_CODE,ERROR_EXPLANATION,COST_GROUP_ID
from MTL_MATERIAL_TRANSACTIONS
where costed_flag = ''E''
and error_explanation like ''%ORA-20100%FND_FILE%failure%''
Order by Organization_Id',
      p_title                  => 'CST_CSTPACDP.INV_COST_TXN (11): ORA-20100: ERROR: FND_FILE FAILURE',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Records returned indicate the following error may have been received:
Error Explanation: CSTPACIN.COST_INV_TXN:CSTPACDP.inv_cost_txn (11): ORA-20100: Error: FND_FILE failure',
      p_solution               => '<ul><li>See the Solutions in [2486908/KB732613] and [261693/KB627197] </li></ul>',
      p_success_msg            => 'There are no transactions that need review in Material Transactions table (MTL_MATERIAL_TRANSACTIONS MMT)',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: CST_ORA-20100 ERROR FND_FILE FAILURE');



debug('begin add_signature: CST_ERROR_ORA-01653 EXTEND TABLE INV.MTL_TRANSACTION_ACCOUNTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12580',
      p_sig_id                 => 'CST_ERROR_ORA-01653 EXTEND TABLE INV.MTL_TRANSACTION_ACCOUNTS',
      p_sig_sql                => 'Select TRANSACTION_ID,CREATION_DATE,INVENTORY_ITEM_ID,ORGANIZATION_ID,SUBINVENTORY_CODE,TRANSACTION_TYPE_ID, 
TRANSACTION_SOURCE_ID,TRANSACTION_DATE,ACCT_PERIOD_ID,decode(COSTED_FLAG,
''E'',''Error'',
''N'',''No'') COSTED_FLAG,ERROR_CODE,ERROR_EXPLANATION,COST_GROUP_ID
from MTL_MATERIAL_TRANSACTIONS
where costed_flag = ''E''
and error_explanation like ''%ORA-01653: unable to extend table INV.MTL_TRANSACTION_ACCOUNTS by 16%''
Order by Organization_Id',
      p_title                  => 'ORA-01653: Unable to Extend Table INV.MTL_TRANSACTION_ACCOUNTS',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Records returned indicate the following error may have been received:
Error Code: No Error
Error Explanation: ORA-01653: unable to extend table INV.MTL_TRANSACTION_ACCOUNTS ',
      p_solution               => '<ul><li>See the Solutions in [1613079/KB781261] ORA-01653: Unable To Extend Table INV.MTL_TRANSACTION_ACCOUNTS By 16 ORA-01654: Unable To Extend Index INV.MTL_TRANSACTION_ACCOUNTS_N3 By 16 In Tablespace APPS_TS_TX_IDX</li></ul>',
      p_success_msg            => 'There are no transactions that need review in Material Transactions table (MTL_MATERIAL_TRANSACTIONS MMT)',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: CST_ERROR_ORA-01653 EXTEND TABLE INV.MTL_TRANSACTION_ACCOUNTS');



debug('begin add_signature: CST_ERROR_ORA-01654 EXTEND INDEX INV.MTL_TRANSACTION_ACCOUNTS_N3');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12581',
      p_sig_id                 => 'CST_ERROR_ORA-01654 EXTEND INDEX INV.MTL_TRANSACTION_ACCOUNTS_N3',
      p_sig_sql                => 'Select TRANSACTION_ID,CREATION_DATE,INVENTORY_ITEM_ID,ORGANIZATION_ID,SUBINVENTORY_CODE,TRANSACTION_TYPE_ID, 
TRANSACTION_SOURCE_ID,TRANSACTION_DATE,ACCT_PERIOD_ID,decode(COSTED_FLAG,
''E'',''Error'',
''N'',''No'') COSTED_FLAG,ERROR_CODE,ERROR_EXPLANATION,COST_GROUP_ID
from MTL_MATERIAL_TRANSACTIONS
where costed_flag = ''E''
and error_explanation like ''%ORA-01654: unable to extend index INV.MTL_TRANSACTION_ACCOUNTS%''
Order by Organization_Id',
      p_title                  => 'ORA-01654: Unable to Extend Index INV.MTL_TRANSACTION_ACCOUNTS_N3',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Records returned indicate the following error may have been received:
Error Code: No Error
Error Explanation: ORA-01654: unable to extend index INV.MTL_TRANSACTION_ACCOUNTS',
      p_solution               => '<ul><li>See the Solutions in [1613079/KB781261] ORA-01653: Unable To Extend Table INV.MTL_TRANSACTION_ACCOUNTS By 16 ORA-01654: Unable To Extend Index INV.MTL_TRANSACTION_ACCOUNTS_N3 By 16 In Tablespace APPS_TS_TX_IDX</li></ul>',
      p_success_msg            => 'There are no transactions that need review in Material Transactions table (MTL_MATERIAL_TRANSACTIONS MMT)',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: CST_ERROR_ORA-01654 EXTEND INDEX INV.MTL_TRANSACTION_ACCOUNTS_N3');



debug('begin add_signature: CST_SLA_UNPROCESSED_EVENTS_INV_WIP_NO_DISTRIBUTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13670',
      p_sig_id                 => 'CST_SLA_UNPROCESSED_EVENTS_INV_WIP_NO_DISTRIBUTIONS',
      p_sig_sql                => 'SELECT a.event_id
,b.event_type_code
FROM xla_events a,
xla_event_types_b b,
xla_transaction_entities_upg c
WHERE a.event_date <= SYSDATE
AND a.application_id = 707
AND a.event_status_code = ''U''
AND a.process_status_code = ''U''
AND b.application_id = 707
AND a.transaction_date >= sysdate-60
...
WHERE transaction_id = c.source_id_int_1))
      ...
      p_title                  => 'Unprocessed Events on the Subledger Period Close Exception Report for WIP and INV transaction with no distributions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Some WIP and INV accounting events are not accountable because the distributions are not created.',
      p_solution               => 'Data fix and possible code fix [738529/KB712266]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CST_SLA_UNPROCESSED_EVENTS_INV_WIP_NO_DISTRIBUTIONS');



debug('begin add_signature: CST_ITEM_COSTS_DO_NOT_EXIST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13784',
      p_sig_id                 => 'CST_ITEM_COSTS_DO_NOT_EXIST',
      p_sig_sql                => 'SELECT DISTINCT msi.inventory_item_id inventory_item_id,
msi.organization_id organization_id,
msi.planning_make_buy_code make_buy_id,
mp.avg_rates_cost_type_id cost_type_id
...
WHERE cicd.inventory_item_id = msi.inventory_item_id
AND cicd.organization_id = msi.organization_id
AND cicd.cost_type_id = 2)',
      p_title                  => 'Cost details are not populated in the CST_ITEM_COSTS table',
      p_fail_condition         => 'RS',
      p_problem_descr          => '''Item cost should be defined before you transact'' occurs while transacting the items.',
      p_solution               => 'See, How To Build Data In CST_ITEM_COSTS Table Based On CST_ITEM_COSTS_DETAILS Table? Err ''Item cost should be defined before you transact'' [2095737/KB711821]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CST_ITEM_COSTS_DO_NOT_EXIST');



debug('begin add_signature: COMPONENTS_ERRED_BUT_ASSEMBLY_TXNS_COSTED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13001',
      p_sig_id                 => 'COMPONENTS_ERRED_BUT_ASSEMBLY_TXNS_COSTED',
...
from   mtl_material_transactions mmt
where  mmt.transaction_action_id not in (30, 31, 32)
and    mmt.transaction_source_type_id = 5 
...
order by transaction_source_id, transaction_action_id',
      p_title                  => 'Components Erred but Assembly Txns Costed',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Components erred but Assembly txns costed. These are BAD transactions that needs to be manually adjusted.',
      p_solution               => '<ul><li>See the Solutions in [2074923/KB662905] WIP Issue Transactions Stuck In Uncosted With No Error Indicated </li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: COMPONENTS_ERRED_BUT_ASSEMBLY_TXNS_COSTED');



debug('begin add_signature: OTHER_ERROR_MSGS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8277',
      p_sig_id                 => 'OTHER_ERROR_MSGS',
      p_sig_sql                => 'Select  TRANSACTION_ID, REQUEST_ID, CREATION_DATE,LAST_UPDATE_DATE, INVENTORY_ITEM_ID, ORGANIZATION_ID, SUBINVENTORY_CODE,
LOCATOR_ID, TRANSACTION_TYPE_ID, TRANSACTION_ACTION_ID, TRANSACTION_SOURCE_TYPE_ID, TRANSACTION_SOURCE_ID,
TRANSACTION_UOM, PRIMARY_QUANTITY, TRANSACTION_QUANTITY,  TRANSACTION_DATE,ACCT_PERIOD_ID,TRANSACTION_REFERENCE, DISTRIBUTION_ACCOUNT_ID,
COSTED_FLAG, ACTUAL_COST, TRANSACTION_COST , PRIOR_COST, NEW_COST, CURRENCY_CODE, currency_conversion_date,currency_conversion_rate,
currency_conversion_type, trx_source_line_id,TRANSFER_TRANSACTION_ID, TRANSFER_ORGANIZATION_ID, RCV_TRANSACTION_ID, SOURCE_CODE,
SOURCE_LINE_ID,TRANSPORTATION_COST, COST_GROUP_ID, TRANSFER_COST_GROUP_ID,ERROR_CODE, ERROR_EXPLANATION
From MTL_MATERIAL_TRANSACTIONS
Where COSTED_FLAG = ''E''',
      p_title                  => 'Other Error Messages Summary',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found Error transactions on the MTL_MATERIAL_TRANSACTIONS with a COSTED_FLAG of "E".
There are transactions that need review in Material Transactions table (MTL_MATERIAL_TRANSACTIONS MMT). 
Problem transactions typically have ERROR_CODEs and ERROR_EXPLANATIONS. 
An uncosted transaction will prevent period close if not processed.',
      p_solution               => '<ul><li>See the Solutions in [748704/KB627721] How to resolve Pending or Erred Cost Manager or Cost Workers</li></ul>
',
      p_success_msg            => 'There are no transactions that need review in Material Transactions table (MTL_MATERIAL_TRANSACTIONS MMT)
...
',
   ...
   l_info.delete;
debug('end add_signature: OTHER_ERROR_MSGS');



debug('begin add_signature: CST_LC_ADJ_INTERFACE_COLUMN CANNOT HAVE NEGATIVE VALUE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19965',
      p_sig_id                 => 'CST_LC_ADJ_INTERFACE_COLUMN CANNOT HAVE NEGATIVE VALUE',
      p_sig_sql                => 'select distinct ce.error_message, ce.error_column, c.*, o.*
from cst_lc_adj_interface c, org_acct_periods o, cst_lc_adj_interface_errors ce 
where c.transaction_id = ce.transaction_id and c.organization_id = o.organization_id and ce.error_message like ''%The column cannot have negative value%'' and rownum < 1000',
      p_title                  => 'Costing cst_lc_adj_interface_errors_Column_cannot_have_negative_value',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are transactions in LCM Interface Error table (cst_lc_adj_interface_errors) with error: Column cannot have negative value.',
      p_solution               => 'Please review solution steps in [1675724/KB761856] Error "The column cannot have negative value" in CST_LC_ADJ_INTERFACE.NEW_LANDED_COST or PRIOR_LANDED_COST.
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: CST_LC_ADJ_INTERFACE_COLUMN CANNOT HAVE NEGATIVE VALUE');



debug('begin add_signature: CSTPACIN.COST_INV_TXN 190 USER-DEFINED EXCEPTION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '21127',
      p_sig_id                 => 'CSTPACIN.COST_INV_TXN 190 USER-DEFINED EXCEPTION',
      p_sig_sql                => 'Select TRANSACTION_ID,CREATION_DATE,INVENTORY_ITEM_ID,ORGANIZATION_ID,SUBINVENTORY_CODE,TRANSACTION_TYPE_ID,
TRANSACTION_SOURCE_ID,TRANSACTION_DATE,ACCT_PERIOD_ID,decode(COSTED_FLAG,
       ''E'',''Error'',
       ''N'',''No'') COSTED_FLAG,ERROR_CODE,ERROR_EXPLANATION,COST_GROUP_ID
from MTL_MATERIAL_TRANSACTIONS
where costed_flag = ''E''
and error_explanation like ''%CSTPACIN.COST_INV_TXN%(190)%User-Defined Exception%''
Order by Organization_Id',
      p_title                  => 'CSTPACIN.COST_INV_TXN: (190): User-Defined Exception',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found transactions on the MTL_MATERIAL_TRANSACTIONS with a COSTED_FLAG of "E". The following error occurs:
...
-----------------------
ERROR_CODE: Null
ERROR_EXPLANATION: CSTPACIN.COST_INV_TXN: (190): User-Defined Exception
',
      p_solution               => 'See the Solution in [1311958/KB788853] Cstpacin.Cost_inv_txn: (190): User-Defined Exception Create_INVXLAEvent 130 : ORA-20001
',
      p_success_msg            => 'There are no transactions that need review in Material Transactions table (MTL_MATERIAL_TRANSACTIONS MMT) 
...
',
   ...
   l_info.delete;
debug('end add_signature: CSTPACIN.COST_INV_TXN 190 USER-DEFINED EXCEPTION');



debug('begin add_signature: EBS_MFG_CSTPERIODCLOSE_PURCHASING_PERIOD_CLOSED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22603',
      p_sig_id                 => 'EBS_MFG_CSTPERIODCLOSE_PURCHASING_PERIOD_CLOSED',
      p_sig_sql                => 'select distinct ce.error_message, ce.error_column, c.*, o.*
from cst_lc_adj_interface c, org_acct_periods o, cst_lc_adj_interface_errors ce 
where c.transaction_id = ce.transaction_id and c.organization_id = o.organization_id and ce.error_message like ''%Purchasing Period is Closed or in the Future%'' and rownum < 1000',
      p_title                  => 'COSTING_ERROR_PURCHASING_PERIOD_IS_CLOSED_OR_IN_FUTURE',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are transactions in LCM Interface Error table (cst_lc_adj_interface_errors) with error: Purchasing Period is Closed or in the Future.',
      p_solution               => 'Open the Purchasing Period in Purchasing>Setup>Financials>Control Purchasing Periods. Once the period is open, then resubmit the stuck records in LCM Interface (CST_LC_ADJ_INTERFACE ). Refer to  [1997799/KB622846] for details.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_CSTPERIODCLOSE_PURCHASING_PERIOD_CLOSED');



debug('begin add_signature: EBS_MFG_DM_CSTPERIODCLOSE_CST_NO_PROFIT_INV_ACCT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23635',
      p_sig_id                 => 'EBS_MFG_DM_CSTPERIODCLOSE_CST_NO_PROFIT_INV_ACCT',
      p_sig_sql                => 'select mmt.TRANSACTION_ID,mmt.CREATION_DATE,mmt.INVENTORY_ITEM_ID,mmt.ORGANIZATION_ID,mmt.TRANSACTION_TYPE_ID,mmt.TRANSACTION_DATE, mmt.COSTED_FLAG, mmt.ERROR_CODE, mmt.ERROR_EXPLANATION, mmt.TRANSACTION_GROUP_ID, mmt.TRANSACTION_SET_ID
FROM MTL_MATERIAL_TRANSACTIONS mmt where mmt.costed_flag=''E'' and mmt.error_code like ''%CST_NO_PROFIT_INV_ACCT%''',
      p_title                  => 'Transactions with error CST_NO_PROFIT_INV_ACCT',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transactions with error CST_NO_PROFIT_INV_ACCT in table MTL_MATERIAL_TRANSACTIONS.',
      p_solution               => 'Refer to [2250301/KB766329].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_DM_CSTPERIODCLOSE_CST_NO_PROFIT_INV_ACCT');



debug('begin add_signature: EBS_MFG_DM_CSTPERIODCLOSE_CSTPAVCP_INTERORG_ORA_01403_NO_DATA_FOUND');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24079',
      p_sig_id                 => 'EBS_MFG_DM_CSTPERIODCLOSE_CSTPAVCP_INTERORG_ORA_01403_NO_DATA_FOUND',
      p_sig_sql                => 'Select TRANSACTION_ID,CREATION_DATE,INVENTORY_ITEM_ID,ORGANIZATION_ID,TRANSFER_ORGANIZATION_ID,TRANSACTION_TYPE_ID,TRANSACTION_DATE,decode(COSTED_FLAG,
       ''E'',''Error'',
       ''N'',''No'') COSTED_FLAG,ERROR_CODE,ERROR_EXPLANATION,COST_GROUP_ID
from MTL_MATERIAL_TRANSACTIONS
where costed_flag = ''E''
and error_explanation like ''%CSTPAVCP.interorg%ORA-01403%''
Order by Organization_Id',
      p_title                  => 'COST_INV_TXN:CSTPAVCP.interorg ORA-01403 no data found',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found transactions on the MTL_MATERIAL_TRANSACTIONS with a COSTED_FLAG of "E". The following error occurs:
...
-----------------------
ERROR_CODE: Null
ERROR_EXPLANATION: CSTPACIN.COST_INV_TXN:CSTPAVCP.interorg ORA-01403 no data found
',
      p_solution               => 'See the Solution in [1365142/KB787806] CSTPACIN.COST_INV_TXN:CSTPAVCP.interorg ORA-01403 no data found',
      p_success_msg            => 'There are no transactions that need review in Material Transactions table (MTL_MATERIAL_TRANSACTIONS MMT) 
...
',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_DM_CSTPERIODCLOSE_CSTPAVCP_INTERORG_ORA_01403_NO_DATA_FOUND');



debug('begin add_signature: EBS_MFG_DM_CSTPERIODCLOSE_CSTPTPHK_TXF_PRI_GET_TRANSFER_PRICE_90_ORA_06550');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24460',
      p_sig_id                 => 'EBS_MFG_DM_CSTPERIODCLOSE_CSTPTPHK_TXF_PRI_GET_TRANSFER_PRICE_90_ORA_06550',
      p_sig_sql                => 'Select TRANSACTION_ID,CREATION_DATE,INVENTORY_ITEM_ID,ORGANIZATION_ID,TRANSFER_ORGANIZATION_ID,TRANSACTION_TYPE_ID,TRANSACTION_DATE,decode(COSTED_FLAG,
       ''E'',''Error'',
       ''N'',''No'') COSTED_FLAG,ERROR_CODE,ERROR_EXPLANATION,COST_GROUP_ID
from MTL_MATERIAL_TRANSACTIONS
where costed_flag = ''E''
and error_explanation like ''%get_transfer_price%ORA-06550%CSTPTPHK.TXF_PRI%''
Order by Organization_Id',
      p_title                  => 'CSTPTPHK.TXF_PRI get_transfer_price( 90 ): ORA-06550',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found transactions on the MTL_MATERIAL_TRANSACTIONS with a COSTED_FLAG of "E". The following error occurs:

ERROR
-----------------------
Error code: ORA-06550: line 1, column 226:
PLS-00201: identifier ''CSTPTPHK.TXF_PRI
Error Explanation:
get_transfer_price( 90 ): ORA-06550: line 1, column 226:
PLS-00201: identifier ''CSTPTPHK.TXF_PRI
',
      p_solution               => 'See the Solution in [2726093/KB753097] CMCMCW Material Cost Transaction Worker Err Get_transfer_price CSTPTPHK.TXF_PRI ORA-06550
',
      p_success_msg            => 'There are no transactions that need review in Material Transactions table (MTL_MATERIAL_TRANSACTIONS MMT) 
...
',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_DM_CSTPERIODCLOSE_CSTPTPHK_TXF_PRI_GET_TRANSFER_PRICE_90_ORA_06550');



debug('begin add_signature: EBS_MFG_DM_CSTPERIODCLOSE_FLM_CST_INVALID_WIP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24608',
      p_sig_id                 => 'EBS_MFG_DM_CSTPERIODCLOSE_FLM_CST_INVALID_WIP',
      p_sig_sql                => 'select TRANSACTION_ID,
       CREATION_DATE,
       INVENTORY_ITEM_ID,
       ORGANIZATION_ID,
 ...
 where costed_flag = ''E''
   ...
   and flow_schedule = ''Y''
 Order by Organization_Id',
      p_title                  => 'Error CST_INVALID_WIP for WOLC - Work OrderLess Completions And WIP Flow Schedules',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Records returned indicate any of the following error may have been received:
...
',
      p_solution               => 'See solution in [2134831/KB726699] WIP_FLOW_SCHEDULES with records in MTL_MATERIAL_TRANSACTIONS tables with Error Record not found in WIP_PERIOD_BALANCES Table.
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_DM_CSTPERIODCLOSE_FLM_CST_INVALID_WIP');



debug('begin add_signature: EBS_MFG_DM_CSTPERIODCLOSE_UPDATE_ITEM_COST_ORA_01426');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24656',
      p_sig_id                 => 'EBS_MFG_DM_CSTPERIODCLOSE_UPDATE_ITEM_COST_ORA_01426',
      p_sig_sql                => 'select TRANSACTION_ID, ORGANIZATION_ID, INVENTORY_ITEM_ID, TRANSACTION_TYPE_ID, COSTED_FLAG, ERROR_CODE, ERROR_EXPLANATION from MTL_MATERIAL_TRANSACTIONS
where COSTED_FLAG = ''E'' AND  error_explanation LIKE ''%CSTPAVCP%ORA-01426: numeric overflow%''',
      p_title                  => 'Material Transaction with error CSTPACIN.COST_INV_TXN:CSTPAVCP.update_item_cost: ORA-01426: numeric overflow',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Records returned indicate the following error may have been received:
CSTPACIN.COST_INV_TXN:CSTPAVCP.update_item_cost (30): ORA-01426: numeric overflow',
      p_solution               => '<ul><li>See the Solutions in [1982517/KB772661] [Data Fix] Cycle Count Stuck transaction failed with error CSTPACIN.COST_INV_TXN:CSTPAVCP.update_item_cost (30): ORA-01426: numeric overflow</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_DM_CSTPERIODCLOSE_UPDATE_ITEM_COST_ORA_01426');
...
debug('begin add_signature: DMEF RES TXN - USER NAME NOT VALID. PLEASE RE-ENTER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '21008',
      p_sig_id                 => 'DMEF RES TXN - USER NAME NOT VALID. PLEASE RE-ENTER',
      p_sig_sql                => 'SELECT WE.WIP_ENTITY_NAME,
       MP.ORGANIZATION_CODE,
       DECODE(WCTI.PROCESS_STATUS,
              1, ''PENDING'',
              2, ''RUNNING'',
              3, ''ERROR'',
              4, ''COMPLETED'',
              5, ''WARNING'',
              WCTI.PROCESS_STATUS) PROCESS_STATUS,
       WTIE.ERROR_COLUMN, 
       WTIE.ERROR_MESSAGE, 
       WCTI.*
 ...
 WHERE WCTI.TRANSACTION_ID = WTIE.TRANSACTION_ID(+)
   ...
   AND WE.ORGANIZATION_ID = MP.ORGANIZATION_ID',
      p_title                  => 'Resource Transactions with Error "User name not valid. Please re-enter"',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Resource transactions failed due to mismatch between User Id and User Name.',
      p_solution               => 'Review solution in [2363193/KB719860][Data Fix] WIP_COST_TXN_INTERFACE (WCTI) Table with Error "User name not valid. Please re-enter"',
      p_success_msg            => 'No Resource transactions failed due to mismatch between User Id and User Name.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: DMEF RES TXN - USER NAME NOT VALID. PLEASE RE-ENTER');



debug('begin add_signature: EBS_MFG_DMEF_CSTPERIODCLOSE_HOLD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '32456',
      p_sig_id                 => 'EBS_MFG_DMEF_CSTPERIODCLOSE_HOLD',
      p_sig_sql                => 'SELECT
...
WHERE
    ...
    AND fcr.phase_code <> ''C''
    AND fcr.hold_flag = ''Y''',
      p_title                  => 'Concurrent Requests is on HOLD',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The Cost Manager/Cost Worker program has been put on hold.',
      p_solution               => 'Review STEP1: Verify if the cost manager is active or not in [2901817/KB418087].
',
      p_success_msg            => 'There is no Cost Manager/Worker program is in  Hold.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_DMEF_CSTPERIODCLOSE_HOLD');
...
debug('begin add_signature: CONCURRENT_REQUESTS_NOT_COMPLETED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13731',
      p_sig_id                 => 'CONCURRENT_REQUESTS_NOT_COMPLETED',
      p_sig_sql                => 'SELECT request_id RequestId,
...
fnd_concurrent_requests fcr,
fnd_concurrent_programs fcp
WHERE fcp.application_id IN (##$$APPS_PARAM1$$##, ##$$APPS_PARAM2$$##, ##$$APPS_PARAM3$$##, ##$$APPS_PARAM4$$##, ##$$APPS_PARAM5$$##)
AND fcr.concurrent_program_id = fcp.concurrent_program_id 
AND fcr.program_application_id IN (##$$APPS_PARAM1$$##, ##$$APPS_PARAM2$$##, ##$$APPS_PARAM3$$##, ##$$APPS_PARAM4$$##, ##$$APPS_PARAM5$$##)
AND fcr.phase_code <> ''C''
AND request_date >= sysdate-60',
      p_title                  => 'Concurrent Request Not Completed',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are concurrent request that have not completed.',
      p_solution               => 'How to resolve Pending or Erred Cost Manager or Cost Workers [748704/KB627721]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CONCURRENT_REQUESTS_NOT_COMPLETED');



debug('begin add_signature: BACKDATED TRANSACTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8654',
      p_sig_id                 => 'BACKDATED TRANSACTIONS',
      p_sig_sql                => 'SELECT 
		MMT.TRANSACTION_ID, 
		MMT.CREATION_DATE, 
		...
		TRUNC(MMT.CREATION_DATE)-TRUNC(MMT.TRANSACTION_DATE) DAYS_DIFFERENCE
FROM 
		MTL_MATERIAL_TRANSACTIONS MMT,
...
WHERE 
  ...
  AND 	TRUNC(MMT.CREATION_DATE) > TRUNC(MMT.TRANSACTION_DATE)
  AND 	MMT.TRANSACTION_DATE	>=sysdate-90
  AND 	MMT.TRANSACTION_DATE	<=sysdate
ORDER BY 
		DAYS_DIFFERENCE DESC,
		TRANSACTION_DATE DESC,
		INVENTORY_ITEM',
      p_title                  => 'Backdated Transaction list in Mtl_Material_Transactions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are transactions which have transaction date earlier than creation date.  Those transactions are backdated.',
      p_solution               => 'Please review [1578694/KB546849] Identifying Inventory Backdated Transactions, to understand the impact of backdating transactions in Cost Management',
      p_success_msg            => 'There are no backdated transactions
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: BACKDATED TRANSACTIONS');



debug('begin add_signature: CST_BACKDATED_TRANS_DETIALS_MTL_TRANS_ACCT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13790',
      p_sig_id                 => 'CST_BACKDATED_TRANS_DETIALS_MTL_TRANS_ACCT',
      p_sig_sql                => 'SELECT 	transaction_id, reference_account, organization_id, inventory_item_id, accounting_line_type, base_transaction_value,
		transaction_source_type_id, transaction_value, creation_date, last_update_date, transaction_date, inv_sub_ledger_id
  FROM 	mtl_transaction_accounts mta
 WHERE 	--mta.organization_id		=	:v_org_id
    	mta.transaction_date	>=	sysdate-90
   AND 	mta.transaction_date	<=	sysdate
   AND EXISTS 	 (SELECT 	1  
					FROM 
							MTL_MATERIAL_TRANSACTIONS MMT,
							MTL_SYSTEM_ITEMS MSI
      ...
      p_title                  => 'Backdated Transaction Details in MTL_TRANSACTION_ACCOUNTS table',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Backdated transactions are allowed by Oracle but the Inventory reports will not match.
<br>
Reports like Period Close Reconciliation Report, Inventory Value report will be affected by backdated transactions.
<br>
Subledger and Gl mismatch is caused by backdated transactions.',
      p_solution               => 'See, Identifying Inventory Backdated Transactions [1578694/KB546849]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CST_BACKDATED_TRANS_DETIALS_MTL_TRANS_ACCT');
...
BEGIN
  ...
  analyzer_title := 'Cost Management Period Close Analyzer';
...
debug('begin section: Transactions_Summary');
start_section('Transactions Summary', 'Transactions_Summary');
   set_item_result(run_stored_sig('UNCOSTED_TXNS_COUNT'));
   set_item_result(run_stored_sig('CST_WIP_INTERFACE_ERR'));
   set_item_result(run_stored_sig('CST_LC_ADJ_INTERFACE'));
   set_item_result(run_stored_sig('CST_MTI_TRANS_ERRORS'));
   set_item_result(run_stored_sig('CST_MMTT_TRANS_ERRORS'));
   set_item_result(run_stored_sig('PJM_ERROR_TRANSACTIONS'));
   set_item_result(run_stored_sig('CST_NULL_COST_MMT_TABLE'));
   set_item_result(run_stored_sig('UNCOSTED_MMT_WITH_MTA'));
   set_item_result(run_stored_sig('EBS_MFG_DM_CSTPERIODCLOSE_COST_MANAGER'));
   set_item_result(run_stored_sig('EBS_MFG_DMEF_WSM_PENDING_MOVE_FC'));
   set_item_result(run_stored_sig('EBS_MFG_DMEF_WSM_PENDING_WLSMI_FC'));
   set_item_result(run_stored_sig('EBS_MFG_DMEF_WSM_PENDING_WSMTI_FC'));
   set_item_result(run_stored_sig('EBS_MFG_DMEF_CSTPERIODCLOSE_CST_WTI_TRANSACTION_PENDING'));
end_section;
debug('end section: Transactions_Summary');

debug('begin section: Transactions_Detail');
start_section('Transactions Detail', 'Transactions_Detail');
   set_item_result(run_stored_sig('CST_INVALID_ACCT_ALIAS'));
   set_item_result(run_stored_sig('CST_INVALID_INTERORG'));
   set_item_result(run_stored_sig('CST_INVALID_JOB_DATE_TRANSACTION_DATE'));
   set_item_result(run_stored_sig('CST_INVALID_WIP'));
   set_item_result(run_stored_sig('CST_MATCH_DATE_PERIOD'));
   set_item_result(run_stored_sig('CST_MATCH_TXFR_CG_ORG'));
   set_item_result(run_stored_sig('CST_NO_TXN_INVALID_ACCOUNT'));
   set_item_result(run_stored_sig('CST_REVENUECOGSMATCH_PVT.PROCESS_RMARECEIPT'));
   set_item_result(run_stored_sig('CSTPLCIN.COST_INV_TXN CSTPACDP.INV_COST_TXN'));
   set_item_result(run_stored_sig('CST_INVALID_CG'));
   set_item_result(run_stored_sig('CSTPACDP.LOGICAL_COST_TXN'));
   set_item_result(run_stored_sig('CSTPAVCP.COST_ACCT_EVENTS ORA-00001 UNIQUE CONSTRAINT MTL_CST_ACTUAL_COST_DETAIL'));
   set_item_result(run_stored_sig('CSTPAVCP.COMPUTE_MCACD_COSTS'));
   set_item_result(run_stored_sig('CST_REVENUECOGSMATCH_PVT.INSERT_ONESOISSUE'));
   set_item_result(run_stored_sig('ERROR IN OBTAINING THE INTERCOMPANY ACCOUNT FROM INVENTORY'));
   set_item_result(run_stored_sig('CSTPAVCP.COST_LOGICALRECEIPT'));
   set_item_result(run_stored_sig('CST_MAT_OVERHEAD CSTPACIN.COST_INV_TXN'));
   set_item_result(run_stored_sig('CSTPSISC_INS_STD_COST_100'));
   set_item_result(run_stored_sig('CSTPSISC_INS_STD_COST_75'));
   set_item_result(run_stored_sig('CSTPLCIN_CSTPLENG_40'));
   set_item_result(run_stored_sig('CST_CSTPLCIN_CSTPACDP_30'));
   set_item_result(run_stored_sig('CST_NO_MAT_OVHDS'));
   set_item_result(run_stored_sig('CST_CSTPAVCP.CALC_AVERAGE_COST'));
   set_item_result(run_stored_sig('CST_ORA-20100 ERROR FND_FILE FAILURE'));
   set_item_result(run_stored_sig('CST_ERROR_ORA-01653 EXTEND TABLE INV.MTL_TRANSACTION_ACCOUNTS'));
   set_item_result(run_stored_sig('CST_ERROR_ORA-01654 EXTEND INDEX INV.MTL_TRANSACTION_ACCOUNTS_N3'));
   set_item_result(run_stored_sig('CST_SLA_UNPROCESSED_EVENTS_INV_WIP_NO_DISTRIBUTIONS'));
   set_item_result(run_stored_sig('CST_ITEM_COSTS_DO_NOT_EXIST'));
   set_item_result(run_stored_sig('COMPONENTS_ERRED_BUT_ASSEMBLY_TXNS_COSTED'));
   set_item_result(run_stored_sig('OTHER_ERROR_MSGS'));
   set_item_result(run_stored_sig('CST_LC_ADJ_INTERFACE_COLUMN CANNOT HAVE NEGATIVE VALUE'));
   set_item_result(run_stored_sig('CSTPACIN.COST_INV_TXN 190 USER-DEFINED EXCEPTION'));
   set_item_result(run_stored_sig('EBS_MFG_CSTPERIODCLOSE_PURCHASING_PERIOD_CLOSED'));
   set_item_result(run_stored_sig('EBS_MFG_DM_CSTPERIODCLOSE_CST_NO_PROFIT_INV_ACCT'));
   set_item_result(run_stored_sig('EBS_MFG_DM_CSTPERIODCLOSE_CSTPAVCP_INTERORG_ORA_01403_NO_DATA_FOUND'));
   set_item_result(run_stored_sig('EBS_MFG_DM_CSTPERIODCLOSE_CSTPTPHK_TXF_PRI_GET_TRANSFER_PRICE_90_ORA_06550'));
   set_item_result(run_stored_sig('EBS_MFG_DM_CSTPERIODCLOSE_FLM_CST_INVALID_WIP'));
   set_item_result(run_stored_sig('EBS_MFG_DM_CSTPERIODCLOSE_UPDATE_ITEM_COST_ORA_01426'));
   set_item_result(run_stored_sig('EBS_MFG_DM_CSTPERIODCLOSE_COST_CUTOFF_DATE_UNCOSTED'));
   set_item_result(run_stored_sig('DMEF RES TXN - USER NAME NOT VALID. PLEASE RE-ENTER'));
   set_item_result(run_stored_sig('EBS_MFG_DMEF_CSTPERIODCLOSE_HOLD'));
end_section;
debug('end section: Transactions_Detail');
...
start_section('Proactive Recommendations', 'Proactive_Recommendations');
   ...
   set_item_result(run_stored_sig('CONCURRENT_REQUESTS_NOT_COMPLETED'));
   set_item_result(run_stored_sig('BACKDATED TRANSACTIONS'));
   set_item_result(run_stored_sig('CST_BACKDATED_TRANS_DETIALS_MTL_TRANS_ACCT'));
end_section;
