...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Cost Management Periodic Average       |
REM | Costing (PAC) Analyzer                                                    |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE CST_PAC_analyzer_pkg AUTHID DEFINER AS
...
PROCEDURE main
(            p_Item_issue                   IN VARCHAR2    DEFAULT 'N'
           ,p_PO_issue                     IN VARCHAR2    DEFAULT 'N'
           ,p_WIP_issue                    IN VARCHAR2    DEFAULT 'N'
           ,p_LCM_issue                    IN VARCHAR2    DEFAULT 'N'
           ,p_organization_id              IN NUMBER      DEFAULT NULL
           ,p_Category_Set_ID              IN NUMBER      DEFAULT NULL
           ,p_Inventory_Item_ID            IN NUMBER      DEFAULT NULL
           ,p_PAC_Cost_Type_ID             IN NUMBER      DEFAULT NULL
           ,p_PAC_Cost_Group_ID            IN NUMBER      DEFAULT NULL
           ,p_TRANSACTION_ID               IN NUMBER      DEFAULT NULL
           ,p_POrct                        IN NUMBER      DEFAULT NULL
           ,p_OSP_txn                      IN NUMBER      DEFAULT NULL
...
END CST_PAC_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY CST_PAC_analyzer_pkg AS
-- $Id: cst_pac_analyzer.sql, 200.13 2026/01/28 11:35:44 sothman Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2535197.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'CSTPAC_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'CSTPAC_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>CSTPAC Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2535197.1#feedback");
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4265799" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">1175</span>
...
<p><strong>Version 200.11 </strong>28-APR-2025&nbsp;</p><p><strong>Enhanced Row Selection and Scrolling Functionality</strong></p><p>We are pleased to announce the introduction of a new feature designed to improve the user experience when interacting with large datasets. This enhancement allows for seamless scrolling and highlighting of selected rows, even when dealing with tables containing many columns.</p><p><strong>Key Benefits</strong>:</p><ul><li>&nbsp; &nbsp;<strong>Improved readability</strong>: When selecting a row, the highlighted selection will remain visible as you scroll horizontally, enabling you to easily read and analyze the data.</li>
<li>&nbsp; &nbsp;<strong>Enhanced navigation:</strong> This feature facilitates efficient navigation through large datasets, allowing you to quickly identify and focus on specific information.</li>
<li>&nbsp; &nbsp;<strong>Streamlined data analysis:</strong> By maintaining the highlighted selection as you scroll, you can effortlessly compare and analyze data across multiple columns.</li>
</ul>
<p>This new feature is designed to provide a more intuitive and user-friendly experience, enabling you to work more efficiently with your data.</p><ul><li><strong>Improved Identification Signatures</strong>: We have made several adjustments to our identification signatures to ensure that the rows returned are accurate and reliable. These updates will help to reduce errors and improve overall data quality.</li>
<li><strong>Enhanced Solution Clarity</strong>: We have also made improvements to several solutions to provide clearer, step-by-step instructions for resolving data conditions. These updates will help to simplify the process of addressing data issues and improve overall user experience.</li>
</ul>
<p>&nbsp;</p><p>&nbsp;</p>
            <br><br>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1175,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Discrete MFG Execution and Financials" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1175,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Discrete MFG Execution and Financials" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1175,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Discrete MFG Execution and Financials" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Item Issue';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_Item_issue,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'PO Issue';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_PO_issue,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'WIP Issue';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_WIP_issue,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'LCM Issues';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_LCM_issue,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Organization_ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_organization_id,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Category_Set_ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_Category_Set_ID,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Inventory_Item_ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_Inventory_Item_ID,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'PAC_Cost_Type_ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_PAC_Cost_Type_ID,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'PAC_Cost_Group_ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_PAC_Cost_Group_ID,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Transaction_ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_TRANSACTION_ID,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'PO_Receipt_Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_POrct,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'OSP_Transaction_ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_OSP_txn,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'WIP_ENTITY_ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_Job_ID,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'PO_Header_ID';
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/01/28 11:35:42 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'cst_pac_analyzer.sql';
...
debug('begin parameter validation: p_Item_issue');
IF p_Item_issue IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Item Issue is required.');
   raise invalid_parameters;
END IF;
IF p_Item_issue IS NOT NULL AND p_Item_issue NOT IN ( 'N','Y') THEN
   print_error('INVALID ARGUMENT: Incorrect "Item Issue" Check Parameter.
Values should be either Y or N.');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_Item_issue');

debug('begin parameter validation: p_PO_issue');
IF p_PO_issue IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter PO Issue is required.');
   raise invalid_parameters;
END IF;
IF p_PO_issue IS NOT NULL AND p_PO_issue NOT IN ( 'N','Y') THEN
   print_error('INVALID ARGUMENT: Incorrect "PO Issue" Check Parameter.
Values should be either Y or N.');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_PO_issue');

debug('begin parameter validation: p_WIP_issue');
IF p_WIP_issue IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter WIP Issue is required.');
   raise invalid_parameters;
END IF;
IF p_WIP_issue IS NOT NULL AND p_WIP_issue NOT IN ( 'N','Y') THEN
   print_error('INVALID ARGUMENT: Incorrect "WIP Issue" Check Parameter.
Values should be either Y or N.');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_WIP_issue');

debug('begin parameter validation: p_LCM_issue');
IF p_LCM_issue IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter LCM Issues is required.');
   raise invalid_parameters;
END IF;
IF p_LCM_issue IS NOT NULL AND p_LCM_issue NOT IN ( 'N','Y') THEN
   print_error('INVALID ARGUMENT: Incorrect "LCM Issue" Check Parameter.
Values should be either Y or N.');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_LCM_issue');

debug('begin parameter validation: p_organization_id');
IF p_organization_id IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Organization_ID is required.');
   raise invalid_parameters;
END IF;
...
debug('begin parameter validation: p_Category_Set_ID');
IF p_Category_Set_ID IS NOT NULL THEN
BEGIN
SELECT CS.CATEGORY_SET_ID
INTO l_exists_val
FROM MTL_DEFAULT_CATEGORY_SETS CS
WHERE CS.CATEGORY_SET_ID = p_Category_Set_ID and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Please enter a valid category_set_id.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_Category_Set_ID failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_Category_Set_ID');

debug('begin parameter validation: p_Inventory_Item_ID');
IF p_Inventory_Item_ID IS NOT NULL THEN
BEGIN
SELECT MMT.INVENTORY_ITEM_ID 
INTO l_exists_val
FROM MTL_MATERIAL_TRANSACTIONS MMT
WHERE MMT.INVENTORY_ITEM_ID  = p_Inventory_Item_ID and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Please enter a valid MMT.INVENTORY_ITEM_ID .');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_Inventory_Item_ID failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_Inventory_Item_ID');

debug('begin parameter validation: p_PAC_Cost_Type_ID');
IF p_PAC_Cost_Type_ID IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter PAC_Cost_Type_ID is required.');
   raise invalid_parameters;
END IF;
IF p_PAC_Cost_Type_ID IS NOT NULL THEN
BEGIN
SELECT CT.COST_TYPE_ID
INTO l_exists_val
FROM CST_LE_COST_TYPES  CT
WHERE CT.COST_TYPE_ID = p_PAC_Cost_Type_ID and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Please enter a valid Cost Type ID.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_PAC_Cost_Type_ID failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_PAC_Cost_Type_ID');

debug('begin parameter validation: p_PAC_Cost_Group_ID');
IF p_PAC_Cost_Group_ID IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter PAC_Cost_Group_ID is required.');
   raise invalid_parameters;
END IF;
IF p_PAC_Cost_Group_ID IS NOT NULL THEN
BEGIN
SELECT CG.COST_GROUP_ID 
INTO l_exists_val
FROM CST_COST_GROUPS_V CG
WHERE CG.COST_GROUP_ID  = p_PAC_Cost_Group_ID and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Please enter a valid Cost Group ID.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_PAC_Cost_Group_ID failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_PAC_Cost_Group_ID');
...
WHERE RT.TRANSACTION_ID  = p_TRANSACTION_ID and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Please enter a valid RT.TRANSACTION_ID.');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
debug('begin parameter validation: p_Job_ID');
IF p_Job_ID IS NOT NULL THEN
BEGIN
SELECT WE.WIP_ENTITY_ID 
INTO l_exists_val
FROM WIP_ENTITIES WE
WHERE WE.WIP_ENTITY_ID  = p_Job_ID and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Please enter a valid WE.WIP_ENTITY_ID.
');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_Job_ID failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_Job_ID');
...
INTO l_exists_val
FROM RCV_TRANSACTIONS RT
WHERE RT.PO_HEADER_ID  = p_po_header_id and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Please enter a valid RT.PO_HEADER_ID.');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
--accommodations for 19c database
...
--accommodations for 19c database end
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$ORGANIZATIONID$$##') := p_organization_id;
   g_masked_tokens('##$$ORGANIZATIONID$$##') := mask_text( g_sql_tokens('##$$ORGANIZATIONID$$##'), 'NO_MASK');
   g_sql_tokens('##$$TRANSACTIONID$$##') := p_TRANSACTION_ID;
   g_masked_tokens('##$$TRANSACTIONID$$##') := mask_text( g_sql_tokens('##$$TRANSACTIONID$$##'), 'NO_MASK');
   g_sql_tokens('##$$INVENTORYITEMID$$##') := p_Inventory_Item_ID;
   g_masked_tokens('##$$INVENTORYITEMID$$##') := mask_text( g_sql_tokens('##$$INVENTORYITEMID$$##'), 'NO_MASK');
   g_sql_tokens('##$$COSTGROUPID$$##') := p_PAC_Cost_Group_ID;
   g_masked_tokens('##$$COSTGROUPID$$##') := mask_text( g_sql_tokens('##$$COSTGROUPID$$##'), 'NO_MASK');
   ...
   g_sql_tokens('##$$category_set_id$$##') := p_Category_Set_ID;
   g_masked_tokens('##$$category_set_id$$##') := mask_text( g_sql_tokens('##$$category_set_id$$##'), 'NO_MASK');
   g_sql_tokens('##$$COSTTYPEID$$##') := p_PAC_Cost_Type_ID;
   g_masked_tokens('##$$COSTTYPEID$$##') := mask_text( g_sql_tokens('##$$COSTTYPEID$$##'), 'NO_MASK');
   g_sql_tokens('##$$POrct$$##') := p_POrct;
   g_masked_tokens('##$$POrct$$##') := mask_text( g_sql_tokens('##$$POrct$$##'), 'NO_MASK');
   g_sql_tokens('##$$osp_txn$$##') := p_OSP_txn;
   g_masked_tokens('##$$osp_txn$$##') := mask_text( g_sql_tokens('##$$osp_txn$$##'), 'NO_MASK');
   g_sql_tokens('##$$JOBID$$##') := p_Job_ID;
   g_masked_tokens('##$$JOBID$$##') := mask_text( g_sql_tokens('##$$JOBID$$##'), 'NO_MASK');
   g_sql_tokens('##$$Item_Issue$$##') := p_Item_issue;
   g_masked_tokens('##$$Item_Issue$$##') := mask_text( g_sql_tokens('##$$Item_Issue$$##'), 'NO_MASK');
   g_sql_tokens('##$$PO_Issue$$##') := p_PO_issue;
   g_masked_tokens('##$$PO_Issue$$##') := mask_text( g_sql_tokens('##$$PO_Issue$$##'), 'NO_MASK');
   g_sql_tokens('##$$WIP_Issue$$##') := p_WIP_issue;
   g_masked_tokens('##$$WIP_Issue$$##') := mask_text( g_sql_tokens('##$$WIP_Issue$$##'), 'NO_MASK');
   g_sql_tokens('##$$PO_Header_ID$$##') := p_po_header_id;
   g_masked_tokens('##$$PO_Header_ID$$##') := mask_text( g_sql_tokens('##$$PO_Header_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$LCM_Issue$$##') := p_LCM_issue;
   g_masked_tokens('##$$LCM_Issue$$##') := mask_text( g_sql_tokens('##$$LCM_Issue$$##'), 'NO_MASK');
...
debug('begin add_signature: PAC LEGAL ENTITIES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8739',
      p_sig_id                 => 'PAC LEGAL ENTITIES',
      p_sig_sql                => 'SELECT legal_entity LEGAL_ENTITY_ID, substr(name,1,30) LEGAL_ENTITY_NAME,
       substr(set_of_books_id,1,30) SET_OF_BOOKS_ID, DATE_FROM,DATE_TO
  FROM cst_pac_legal_entities_v
  order by LEGAL_ENTITY_ID',
      p_title                  => 'Legal Entities',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the setup of the Periodic Average Costing (PAC) legal entities. ',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PAC LEGAL ENTITIES');



debug('begin add_signature: COST GROUP ACCOUNTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8762',
      p_sig_id                 => 'COST GROUP ACCOUNTS',
      p_sig_sql                => 'SELECT legal_entity_id , cost_type_id ,cost_group_id,
inventory_offset_account ,cost_variance_account,
RETRO_PRICE_ADJ_ACCOUNT, 
LANDED_COST_VAR_ACCOUNT, 
LANDED_COST_ABS_ACCOUNT
FROM cst_org_cost_group_accounts
WHERE (legal_entity_id, cost_type_id) IN 
       (SELECT legal_entity ,cost_type_id 
          FROM cst_le_cost_types)
 order by legal_entity_id , cost_type_id , cost_group_id',
      p_title                  => 'Cost Group Accounts',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the setup of the Periodic Average Costing (PAC) cost group accounts.<br>
For additional information review [1460062/KB783091] Periodic Average Costing (PAC) - setup and workflow.',
      p_solution               => '',
      p_success_msg            => 'Displaying the setup of the Periodic Average Costing (PAC) cost group accounts.<br>
For additional information review [1460062/KB783091] Periodic Average Costing (PAC) - setup and workflow.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: COST GROUP ACCOUNTS');



debug('begin add_signature: CST COST TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8765',
      p_sig_id                 => 'CST COST TYPES',
      p_sig_sql                => 'select cost_type_id , cost_type , description 
from cst_cost_types
where cost_type_id in (select cost_type_id from cst_le_cost_types)
order by cost_type_id',
      p_title                  => 'CST Cost Types',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the setup of the Periodic Average Costing (PAC) Cost Types.<br>
For additional information review [1460062/KB783091] Periodic Average Costing (PAC) - setup and workflow.


',
      p_solution               => '',
      p_success_msg            => 'Displaying the setup of the Periodic Average Costing (PAC) Cost Types.<br>
For additional information review [1460062/KB783091] Periodic Average Costing (PAC) - setup and workflow.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: CST COST TYPES');



debug('begin add_signature: FISCAL ACCOUNTS SETUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8763',
      p_sig_id                 => 'FISCAL ACCOUNTS SETUP',
      p_sig_sql                => 'SELECT legal_entity_id , cost_type_id ,
       cost_group_id ,category_id,
       material_account , material_overhead_account , 
       resource_account , outside_processing_account , 
       overhead_account , expense_account, bridging_account 
 ...
 order by legal_entity_id, cost_type_id, cost_group_id
/*
PROMPT PAC Process phase
SELECT PAC_PERIOD_ID , COST_GROUP_ID  ,
       PROCESS_PHASE , PROCESS_STATUS,
       PROCESS_DATE  , PROCESS_UPTO_DATE
  FROM cst_pac_process_phases
  order by PAC_PERIOD_ID, COST_GROUP_ID, PROCESS_PHASE */',
      p_title                  => 'Fiscal Accounts',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the setup of the Periodic Average Costing (PAC) Fiscal Accounts.<br>
For additional information review [1460062/KB783091] Periodic Average Costing (PAC) - setup and workflow.


',
      p_solution               => '',
      p_success_msg            => 'Displaying the setup of the Periodic Average Costing (PAC) Fiscal Accounts.<br>
For additional information review [1460062/KB783091] Periodic Average Costing (PAC) - setup and workflow.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: FISCAL ACCOUNTS SETUP');



debug('begin add_signature: MTL PARAMETERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8764',
      p_sig_id                 => 'MTL PARAMETERS',
      p_sig_sql                => 'select mp.organization_id , mp.organization_code , 
mp.master_organization_id , mp.cost_organization_id ,mp.primary_cost_method 
from mtl_parameters mp
where (mp.organization_id in (select organization_id 
                             from cst_cost_groups
                             WHERE legal_entity IS NOT NULL)
  or mp.organization_id in (select organization_id
 ...
 WHERE cost_group_id IN 
       (SELECT cost_group_id 
         ...
         WHERE legal_entity IS NOT NULL)))
order by organization_id',
      p_title                  => 'Inventory Organization Parameters',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the setup of the Periodic Average Costing (PAC) MTL Parameters.<br>
For additional information review [1460062/KB783091] Periodic Average Costing (PAC) - setup and workflow.


',
      p_solution               => '',
      p_success_msg            => 'Displaying the setup of the Periodic Average Costing (PAC) MTL Parameters.<br>
For additional information review [1460062/KB783091] Periodic Average Costing (PAC) - setup and workflow.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: MTL PARAMETERS');



debug('begin add_signature: PAC LE COST TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8756',
      p_sig_id                 => 'PAC LE COST TYPES',
      p_sig_sql                => 'SELECT legal_entity ,cost_type_id,set_of_books_id,primary_cost_method,
pac_rates_cost_type_id,create_acct_entries,accounting_library_id,post_to_gl,
gl_transfer_allow_override,gl_transfer_mode,gl_transfer_submit_journal_imp,restrict_doc_flag,            
creation_date,last_update_date,material_relief_algorithm,TRANSFER_COST_FLAG 
FROM cst_le_cost_types
order by legal_entity ,cost_type_id',
      p_title                  => 'Legal Entity Cost Types',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the setup of the Periodic Average Costing (PAC) Legal Entity Cost Types.<br>
For additional information review [1324701/FAQ6743] How to Identify PAC Setup Issues 
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: PAC LE COST TYPES');



debug('begin add_signature: PAC ORG COST GROUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8752',
      p_sig_id                 => 'PAC ORG COST GROUP',
      p_sig_sql                => 'SELECT ccg.cost_group_id , ccg.cost_group ,
       ccg.organization_id , mp.organization_code ,
       legal_entity, cost_group_type,
       ccg.disable_date, ccg.creation_date
  FROM cst_cost_groups ccg, mtl_parameters mp
 WHERE mp.organization_id(+) = ccg.organization_id
   AND legal_entity IS NOT NULL
   order by legal_entity, cost_group_id',
      p_title                  => 'Organization Cost Group',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the setup of the Periodic Average Costing (PAC) Organization Cost Group.<br>
For additional information review [1324701/FAQ6743] How to Identify PAC Setup Issues.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: PAC ORG COST GROUP');



debug('begin add_signature: PAC ORG COST GROUP ASSIGNMENT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8753',
      p_sig_id                 => 'PAC ORG COST GROUP ASSIGNMENT',
      p_sig_sql                => 'SELECT cost_group_id, organization_id ,
       creation_date
  FROM cst_cost_group_assignments
 WHERE cost_group_id IN 
       (SELECT cost_group_id 
          FROM cst_cost_groups
         WHERE legal_entity IS NOT NULL)
 order by cost_group_id, organization_id',
      p_title                  => 'Organization Cost Group Assignment',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the setup of the Periodic Average Costing (PAC) cos group assignment.<br>
For additional information review [1460062/KB783091] Periodic Average Costing (PAC) - Setup and Workflow',
      p_solution               => '',
      p_success_msg            => 'Displaying the setup of the Periodic Average Costing (PAC) cos group assignment.<br>
For additional information review [1460062/KB783091] Periodic Average Costing (PAC) - Setup and Workflow',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: PAC ORG COST GROUP ASSIGNMENT');



debug('begin add_signature: PAC PERIODS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8759',
      p_sig_id                 => 'PAC PERIODS',
      p_sig_sql                => 'SELECT pac_period_id , legal_entity ,
       cost_type_id , period_name ,
       period_start_date, period_end_date,
       open_flag
  FROM cst_pac_periods
 WHERE (legal_entity, cost_type_id) IN 
       (SELECT legal_entity ,cost_type_id 
          FROM cst_le_cost_types)
 order by legal_entity ,cost_type_id, period_start_date',
      p_title                  => 'PAC Periods',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the setup of the Periodic Average Costing (PAC) periods.<br>
For additional information review [1460062/KB783091] Periodic Average Costing (PAC) - Setup and Workflow.
...
',
   ...
   l_info.delete;
debug('end add_signature: PAC PERIODS');



debug('begin add_signature: PAC_INV_ITEM_TXNS-CAL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9216',
      p_sig_id                 => 'PAC_INV_ITEM_TXNS-CAL',
      p_sig_sql                => 'SELECT accounting_event_id, ae_header_id,
       set_of_books_id, organization_id, legal_entity_id, cost_group_id, cost_type_id,
       acct_event_source_table, ae_category,
       period_id, period_name, accounting_date,
       gl_transfer_flag, gl_transfer_run_id, gl_transfer_error_code,
       accounting_error_code, creation_date
FROM cst_ae_headers
WHERE accounting_event_id IN (SELECT transaction_id
  FROM mtl_material_transactions mmt
WHERE  mmt.inventory_item_id = ##$$INVENTORYITEMID$$##
     and exists (select ''assigned to cg''
	    	       from cst_cost_group_assignments ccga,
                               mtl_parameters mp
                     where mp.organization_id = ccga.organization_id
			and (mp.organization_id = mmt.organization_id or 
                                mp.organization_id = mmt.transfer_organization_id or 
	                        mp.master_organization_id = mmt.organization_id)))
order by period_id, accounting_date',
      p_title                  => 'Item Distribution Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the Periodic Item Cost for Specific Item (multiple items) after running PAC Distribution Process.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: PAC_INV_ITEM_TXNS-CAL');



debug('begin add_signature: PAC_INV_ITEM_TXNS-CAL-LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9217',
      p_sig_id                 => 'PAC_INV_ITEM_TXNS-CAL-LINES',
      p_sig_sql                => 'SELECT ae_line_id, ae_header_id, ae_line_number,
       ae_line_type_code, code_combination_id, cost_element_id,
       entered_dr, entered_cr,
       accounted_dr, accounted_cr, rate_or_amount,
       source_table, source_id,
       currency_code,
       gl_sl_link_id, accounting_error_code, gl_transfer_error_code,
       repetitive_schedule_id, po_distribution_id, wip_entity_id,
  ...
  WHERE mmt.inventory_item_id = ##$$INVENTORYITEMID$$##
     and exists (select ''assigned to cg''
			...
			and (mp.organization_id = mmt.organization_id or 
	                        ...
	                        mp.master_organization_id = mmt.organization_id))))
order by 1',
      p_title                  => 'Item Distribution Detail Lines',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the periodic item cost distribution lines for specific item (multiple items) after running PAC Distribution Process.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PAC_INV_ITEM_TXNS-CAL-LINES');



debug('begin add_signature: PAC_INV_ITEM_TXNS-CPIC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9214',
      p_sig_id                 => 'PAC_INV_ITEM_TXNS-CPIC',
      p_sig_sql                => 'SELECT cost_layer_id,pac_period_id ,
       cost_group_id ,inventory_item_id ,
       buy_quantity , make_quantity ,
       issue_quantity , total_layer_quantity ,
       item_cost , item_buy_cost ,
       item_make_cost , begin_item_cost ,
       material_cost ,material_overhead_cost ,
       resource_cost ,overhead_cost ,
...
order by pac_period_id',
      p_title                  => 'Item Detail',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the periodic item cost detail for one or more items. 
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: PAC_INV_ITEM_TXNS-CPIC');



debug('begin add_signature: PAC_INV_ITEM_TXNS-CPICD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9215',
      p_sig_id                 => 'PAC_INV_ITEM_TXNS-CPICD',
      p_sig_sql                => 'SELECT cost_layer_id, cost_element_id, level_type,
       item_cost, item_buy_cost, item_make_cost,
       creation_date,
     ITEM_BALANCE,
    BUY_BALANCE,
    MAKE_BALANCE
  FROM cst_pac_item_cost_details
 WHERE cost_layer_id IN
       (SELECT cost_layer_id
          FROM cst_pac_item_costs
         WHERE cost_group_id = ##$$COSTGROUPID$$##
           AND inventory_item_id = ##$$INVENTORYITEMID$$##)
order by creation_date',
      p_title                  => 'Item Line Detail',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the periodic item cost line detail for one or more items. ',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PAC_INV_ITEM_TXNS-CPICD');



debug('begin add_signature: PAC_INV_ITEM_TXNS-CPQL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9213',
      p_sig_id                 => 'PAC_INV_ITEM_TXNS-CPQL',
      p_sig_sql                => 'SELECT quantity_layer_id, cost_layer_id,
       pac_period_id, cost_group_id,
       inventory_item_id, layer_quantity ,
       begin_layer_quantity 
  FROM cst_pac_quantity_layers
 WHERE cost_group_id = ##$$COSTGROUPID$$##
   AND inventory_item_id = ##$$INVENTORYITEMID$$##',
      p_title                  => 'Layer Header Detail',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the periodic item cost layer header detail for one or more items. ',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PAC_INV_ITEM_TXNS-CPQL');



debug('begin add_signature: PAC_INV_ITEM_TXNS-CPTH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9212',
      p_sig_id                 => 'PAC_INV_ITEM_TXNS-CPTH',
      p_sig_sql                => 'SELECT pac_period_id,cost_group_id,transaction_id,process_seq
	     process_group,inventory_item_id,txn_master_qty,
	     prior_costed_master_qty,actual_cost,new_cost,prior_cost
FROM cst_pc_txn_history
 WHERE cost_group_id = ##$$COSTGROUPID$$##
   AND inventory_item_id = ##$$INVENTORYITEMID$$##
order by pac_period_id, transaction_id',
      p_title                  => 'Transaction History',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the periodic item cost transaction history for one or more items. ',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PAC_INV_ITEM_TXNS-CPTH');



debug('begin add_signature: PAC_INV_ITEM_TXNS-CRAC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8951',
      p_sig_id                 => 'PAC_INV_ITEM_TXNS-CRAC',
      p_sig_sql                => 'SELECT header_id, cost_group_id,
       cost_type_id, period_id, rcv_transaction_id,
       net_quantity_received, total_quantity_invoiced, quantity_at_po_price
       total_invoice_amount, amount_at_po_price, total_amount
       costed_quantity, acquisition_cost,
       po_line_location_id, po_unit_price,
       primary_uom, rec_exchg_rate
  FROM cst_rcv_acq_costs
 WHERE rcv_transaction_id IN (SELECT rcv_transaction_id
  FROM mtl_material_transactions mmt
WHERE  mmt.inventory_item_id = ##$$INVENTORYITEMID$$##
  AND (mmt.transaction_source_type_id = 1
       OR
       (mmt.transaction_source_type_id = 13 AND mmt.transaction_action_id = 6))
     and exists (select ''assigned to cg''
	    	       from cst_cost_group_assignments ccga,
                               mtl_parameters mp
                     where mp.organization_id = ccga.organization_id
			and (mp.organization_id = mmt.organization_id or 
                                mp.organization_id = mmt.transfer_organization_id or 
	                        mp.master_organization_id = mmt.organization_id)))',
      p_title                  => 'Receiving Information',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the periodic item cost receiving information for one or more items. 
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: PAC_INV_ITEM_TXNS-CRAC');



debug('begin add_signature: PAC_INV_ITEM_TXNS-MCTCD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8949',
      p_sig_id                 => 'PAC_INV_ITEM_TXNS-MCTCD',
      p_sig_sql                => 'SELECT transaction_id ,
       organization_id ,
       cost_element_id ,
       level_type ,
       transaction_cost ,
  ...
  WHERE mmt.inventory_item_id = ##$$INVENTORYITEMID$$##
     and exists (select ''assigned to cg''
			...
			and (mp.organization_id = mmt.organization_id or 
                                mp.organization_id = mmt.transfer_organization_id or 
	                        mp.master_organization_id = mmt.organization_id)))',
      p_title                  => 'Transactions Cost Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the periodic transactions cost details for one or more items. 
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: PAC_INV_ITEM_TXNS-MCTCD');



debug('begin add_signature: PAC_INV_ITEM_TXNS-MMT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8947',
      p_sig_id                 => 'PAC_INV_ITEM_TXNS-MMT',
      p_sig_sql                => 'SELECT mmt.transaction_date ,
       mmt.transaction_id , mmt.organization_id ,
       mmt.cost_group_id ,   mmt.transfer_transaction_id ,
       mmt.transfer_organization_id , mmt.transfer_cost_group_id ,
       mmt.transaction_action_id ,    mmt.transaction_source_type_id ,
       mmt.transaction_source_id ,
       mmt.transaction_type_id , mmt.inventory_item_id ,
       mmt.subinventory_code ,  mmt.transfer_subinventory ,
       mmt.primary_quantity ,  mmt.distribution_account_id ,
       substr(mmt.shipment_number,1,12) ,
       msi.inventory_asset_flag ,
       mse.asset_inventory ai, mmt.shipment_costed ,
       mmt.costed_flag, mmt.transaction_cost ,
       mmt.transportation_cost , mmt.transfer_cost ,
       mmt.actual_cost , mmt.new_cost ,
       mmt.prior_costed_quantity ,
       mmt.completion_transaction_id ,
       mmt.move_transaction_id ,
       mmt.flow_schedule, mmt.acct_period_id ,
...
WHERE  mmt.inventory_item_id = ##$$INVENTORYITEMID$$##
  ...
  and exists (select ''assigned to cg''
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the periodic item cost material transactions for one or more items. ',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PAC_INV_ITEM_TXNS-MMT');



debug('begin add_signature: PAC_INV_ITEM_TXNS-MPACD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9210',
      p_sig_id                 => 'PAC_INV_ITEM_TXNS-MPACD',
      p_sig_sql                => 'SELECT cost_group_id , cost_type_id ,
       pac_period_id , transaction_id ,
       cost_element_id ,level_type ,
       cost_layer_id, actual_cost ,
       prior_buy_cost , new_buy_cost ,
       prior_make_cost , new_make_cost ,
       prior_cost , new_cost ,
       inventory_item_id ,
       insertion_flag ,variance_amount ,
 ...
 WHERE cost_group_id = ##$$COSTGROUPID$$##
 AND inventory_item_id = ##$$INVENTORYITEMID$$##',
      p_title                  => 'Transactions Actual Cost Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the periodic transactions actual cost details for one or more items. ',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PAC_INV_ITEM_TXNS-MPACD');



debug('begin add_signature: PAC_INV_ITEM_TXNS-MPACS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9211',
      p_sig_id                 => 'PAC_INV_ITEM_TXNS-MPACS',
      p_sig_sql                => 'SELECT transaction_id, cost_group_id, pac_period_id,
       cost_type_id, cost_element_id, resource_id,
       level_type, actual_cost, user_entered,
       creation_date
  FROM mtl_pac_cost_subelements
 WHERE (cost_group_id, transaction_id) IN
       (SELECT cost_group_id, transaction_id
          FROM mtl_pac_actual_cost_details
         WHERE cost_group_id = ##$$COSTGROUPID$$##
           AND inventory_item_id = ##$$INVENTORYITEMID$$##)
order by 1',
      p_title                  => 'Cost Transactions Subelements',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the periodic item cost transactions subelements for one or more items. 
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: PAC_INV_ITEM_TXNS-MPACS');



debug('begin add_signature: PAC_INV_ITEM_TXNS-MPTCD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8950',
      p_sig_id                 => 'PAC_INV_ITEM_TXNS-MPTCD',
      p_sig_sql                => 'SELECT cost_group_id , cost_type_id ,
       pac_period_id ,transaction_id ,
       cost_element_id ,  level_type ,
       inventory_item_id ,
       transaction_cost , new_periodic_cost  ,
       percentage_change ,value_change,
    WIP_VARIANCE,
    CREATION_DATE
  FROM mtl_pac_txn_cost_details
 WHERE cost_group_id = ##$$COSTGROUPID$$##
   AND inventory_item_id = ##$$INVENTORYITEMID$$##',
      p_title                  => 'Transactions Cost Element',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the periodic item transactions cost element for one or more items. 
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: PAC_INV_ITEM_TXNS-MPTCD');



debug('begin add_signature: PAC_INV_ITEM_TXNS-CPPB');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14771',
      p_sig_id                 => 'PAC_INV_ITEM_TXNS-CPPB',
      p_sig_sql                => 'SELECT PAC_PERIOD_ID,COST_GROUP_ID,INVENTORY_ITEM_ID,COST_LAYER_ID, 
       QUANTITY_LAYER_ID,COST_ELEMENT_ID,LEVEL_TYPE,TXN_CATEGORY,TXN_CATEGORY_QTY,
       TXN_CATEGORY_VALUE,PERIOD_QUANTITY,PERIODIC_COST,PERIOD_BALANCE
FROM cst_pac_period_balances 
WHERE inventory_item_id = ##$$INVENTORYITEMID$$##
AND cost_group_id = ##$$COSTGROUPID$$##
ORDER BY PAC_PERIOD_ID,COST_ELEMENT_ID,LEVEL_TYPE,TXN_CATEGORY',
      p_title                  => 'Item Cost Change',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the periodic item cost change. ',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PAC_INV_ITEM_TXNS-CPPB');



debug('begin add_signature: PAC_PO_AIDA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9491',
      p_sig_id                 => 'PAC_PO_AIDA',
      p_sig_sql                => 'select unit_price, inventory_transfer_status, invoice_distribution_id, 
rcv_transaction_id, org_id, quantity_variance, base_quantity_variance,
req_distribution_id, je_batch_id, posted_flag, match_status_flag, po_distribution_id, 
invoice_price_variance, final_match_flag, creation_date, batch_id, amount,
set_of_books_id, invoice_id, dist_code_combination_id, accrual_posted_flag, accounting_date, price_var_code_combination_id,
        AMOUNT_ENCUMBERED ,            
...
from 	rcv_transactions po
where 	exists (select 	''X''
from 	rcv_transactions
where 	po_header_id = po.po_header_id
and 	transaction_id = ##$$TRANSACTIONID$$##))',
      p_title                  => 'PO Receipt or Outside Processing OSP',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the AP invoice distributions associated to a PO Receipt or an Outside Processing OSP transaction. <br>
When Periodic item cost not calculated correctly deliver_txn, PO Receipt, OSP.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PAC_PO_AIDA');



debug('begin add_signature: PAC_PO_CAH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9504',
      p_sig_id                 => 'PAC_PO_CAH',
      p_sig_sql                => 'select 	AE_HEADER_ID, ACCOUNTING_EVENT_ID, SET_OF_BOOKS_ID, LEGAL_ENTITY_ID,         
COST_GROUP_ID,COST_TYPE_ID, AE_CATEGORY,PERIOD_NAME, ACCOUNTING_DATE,GL_TRANSFER_FLAG  
from 	cst_ae_headers
where 	COST_GROUP_ID = ##$$COSTGROUPID$$##
and  	COST_TYPE_ID = ##$$COSTTYPEID$$##
and	accounting_event_id IN
(SELECT rt6.transaction_id
FROM	rcv_transactions rt6
WHERE 	rt6.transaction_type in (''RECEIVE'',''MATCH'')
START WITH rt6.transaction_id = ##$$TRANSACTIONID$$##
CONNECT BY rt6.transaction_id = prior rt6.parent_transaction_id)',
      p_title                  => 'Transaction Header cst_ae_headers',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the PAC header associated to a PO receipt or an outside processing transaction Header. <br>
When periodic item cost not calculated correctly deliver_txn, PO Receipt, OSPn.
',
      p_solution               => '',
      p_success_msg            => 'Displaying the PAC header associated to a PO receipt or an outside processing transaction Header. <br>
When periodic item cost not calculated correctly deliver_txn, PO Receipt, OSPn.
',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PAC_PO_CAH');



debug('begin add_signature: PAC_PO_CAL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9530',
      p_sig_id                 => 'PAC_PO_CAL',
      p_sig_sql                => 'select 	AE_LINE_ID, AE_HEADER_ID ,AE_LINE_NUMBER,AE_LINE_TYPE_CODE,CODE_COMBINATION_ID,  
CURRENCY_CODE,ENTERED_DR,ENTERED_CR,PO_DISTRIBUTION_ID,WIP_ENTITY_ID  
from 	cst_ae_lines
...
START WITH rt6.transaction_id = ##$$TRANSACTIONID$$##
CONNECT BY rt6.transaction_id = prior rt6.parent_transaction_id))',
      p_title                  => 'Transaction Lines  cst_ae_lines',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the PAC lines associated to a PO receipt or an outside processing transaction Lines. <br>
When periodic item cost not calculated correctly deliver_txn, PO Receipt, OSP.
',
      p_solution               => 'Displaying the PAC lines associated to a PO receipt or an outside processing transaction Lines. <br>
When periodic item cost not calculated correctly deliver_txn, PO Receipt, OSP.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PAC_PO_CAL');



debug('begin add_signature: PAC_PO_CRAC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9480',
      p_sig_id                 => 'PAC_PO_CRAC',
      p_sig_sql                => 'select 	HEADER_ID,COST_GROUP_ID ,COST_TYPE_ID,PERIOD_ID,RCV_TRANSACTION_ID,     
NET_QUANTITY_RECEIVED,TOTAL_QUANTITY_INVOICED,QUANTITY_AT_PO_PRICE,         
TOTAL_INVOICE_AMOUNT,AMOUNT_AT_PO_PRICE,TOTAL_AMOUNT, COSTED_QUANTITY,ACQUISITION_COST 
from cst_rcv_acq_costs
where COST_GROUP_ID = ##$$COSTGROUPID$$##
and  COST_TYPE_ID = ##$$COSTTYPEID$$##
and rcv_transaction_id 
in (SELECT rt6.transaction_id
FROM	rcv_transactions rt6
WHERE 	rt6.transaction_type in (''RECEIVE'',''MATCH'')
START WITH rt6.transaction_id = ##$$TRANSACTIONID$$##
CONNECT BY rt6.transaction_id = prior rt6.parent_transaction_id)',
      p_title                  => 'Receiving Acquisition Cost',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the Receiving Acquisition Cost associated to a PO receipt or a Outside Processing transaction.<br>
 When periodic item cost not calculated correctly deliver_txn, PO Receipt, OSP.
',
      p_solution               => '',
      p_success_msg            => 'Displaying the Receiving Acquisition Cost associated to a PO receipt or a Outside Processing transaction.<br>
 When periodic item cost not calculated correctly deliver_txn, PO Receipt, OSP.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: PAC_PO_CRAC');



debug('begin add_signature: PAC_PO_CRACD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9481',
      p_sig_id                 => 'PAC_PO_CRACD',
      p_sig_sql                => 'select 	HEADER_ID , DETAIL_ID  , SOURCE_TYPE  ,PO_LINE_LOCATION_ID,PARENT_DISTRIBUTION_ID ,          
DISTRIBUTION_NUM,LEVEL_NUM,INVOICE_DISTRIBUTION_ID, PARENT_INVOICE_DIST_ID, ALLOCATED_AMOUNT,
PARENT_AMOUNT,
AMOUNT,
QUANTITY,
PRICE,
LINE_TYPE
from cst_rcv_acq_cost_details
where header_id in
(select header_id
from cst_rcv_acq_costs
where COST_GROUP_ID = ##$$COSTGROUPID$$##
...
START WITH rt6.transaction_id = ##$$TRANSACTIONID$$## 
CONNECT BY rt6.transaction_id = prior rt6.parent_transaction_id))',
      p_title                  => 'Receiving Acquisition Cost Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the receiving acquisition cost details associated to a PO receipt or a Outside Processing transaction. <br>
When periodic item cost not calculated correctly deliver_txn, PO Receipt, OSP.
',
      p_solution               => '',
      p_success_msg            => 'Displaying the receiving acquisition cost details associated to a PO receipt or a Outside Processing transaction. <br>
When periodic item cost not calculated correctly deliver_txn, PO Receipt, OSP.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: PAC_PO_CRACD');



debug('begin add_signature: PAC_PO_MMT_RCV_WIP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9478',
      p_sig_id                 => 'PAC_PO_MMT_RCV_WIP',
      p_sig_sql                => 'select rcv_transaction_id deliver_txn
from mtl_material_transactions
where (transaction_id = ##$$POrct$$## or transaction_id = ##$$osp_txn$$##)
and rcv_transaction_id IS NOT NULL
union all
select rcv_transaction_id deliver_txn
from wip_transactions
where transaction_type in (3,17)
and rcv_transaction_id IS NOT NULL
and transaction_id = ##$$POrct$$##
or transaction_id = ##$$osp_txn$$##',
      p_title                  => 'Periodic Item Cost not Calculated Correctly',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the material transactions associated to a PO receipt or an outside processing transaction.<br>

',
      p_solution               => '',
      p_success_msg            => 'Displaying the material transactions associated to a PO receipt or a outside processing transaction.<br>
',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: PAC_PO_MMT_RCV_WIP');



debug('begin add_signature: PAC_PO_POD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9489',
      p_sig_id                 => 'PAC_PO_POD',
      p_sig_sql                => 'select 	PO_DISTRIBUTION_ID, LAST_UPDATE_DATE, LAST_UPDATED_BY,PO_HEADER_ID,PO_LINE_ID,        
LINE_LOCATION_ID,SET_OF_BOOKS_ID,CODE_COMBINATION_ID,QUANTITY_ORDERED,                     
LAST_UPDATE_LOGIN, PO_RELEASE_ID , QUANTITY_DELIVERED ,QUANTITY_BILLED, QUANTITY_CANCELLED,
...
where 	exists (select 	''X''
		...
		where 	po_header_id = po.po_header_id
		and 	transaction_id = ##$$TRANSACTIONID$$##)',
      p_title                  => 'PO Distributions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the PO distributions associated to a PO receipt or an outside processing transaction.<br> 
When periodic item cost not calculated correctly deliver_txn, PO Receipt, OSP.
',
      p_solution               => '',
      p_success_msg            => 'Displaying the PO distributions associated to a PO receipt or an outside processing transaction.<br> 
When periodic item cost not calculated correctly deliver_txn, PO Receipt, OSP.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: PAC_PO_POD');



debug('begin add_signature: PAC_PO_POH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9484',
      p_sig_id                 => 'PAC_PO_POH',
      p_sig_sql                => 'select 	PO_HEADER_ID, AGENT_ID , TYPE_LOOKUP_CODE , SEGMENT1 , SUMMARY_FLAG ,   
ENABLED_FLAG ,SEGMENT2 ,SEGMENT3 ,SEGMENT4 ,SEGMENT5 , ORG_ID,
SHIP_TO_LOCATION_ID,         
    BILL_TO_LOCATION_ID,         
    CURRENCY_CODE,               
    RATE_TYPE,                 
...
where 	exists (select 	''X''
      ...
      p_title                  => 'PO Header',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the PO header associated to a PO receipt or an outside processing transaction.<br>
When periodic item cost not calculated correctly (deliver_txn, PO Receipt, OSP).',
      p_solution               => '',
      p_success_msg            => 'Displaying the PO header associated to a PO receipt or an outside processing transaction.<br>
When periodic item cost not calculated correctly (deliver_txn, PO Receipt, OSP).',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: PAC_PO_POH');



debug('begin add_signature: PAC_PO_POL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9486',
      p_sig_id                 => 'PAC_PO_POL',
      p_sig_sql                => 'SELECT PO_LINE_ID, PO_HEADER_ID ,LINE_TYPE_ID , LINE_NUM , CREATION_DATE,            
ITEM_ID , ITEM_DESCRIPTION, UNIT_PRICE,QUANTITY , CLOSED_FLAG , CLOSED_DATE , ORG_ID,
AMOUNT,
BASE_UOM,                 
BASE_QTY,                 
BASE_UNIT_PRICE, 
CATEGORY_ID         
FROM po_lines_all
WHERE po_line_id IN (SELECT po_line_id FROM rcv_transactions
where transaction_id = ##$$TRANSACTIONID$$##)',
      p_title                  => 'PO Lines',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the PO Lines associated to a PO receipt or an outside processing transaction Header.<br> 
When periodic item cost not calculated correctly deliver_txn, PO Receipt, OSP.
',
      p_solution               => '',
      p_success_msg            => 'Displaying the PO Lines associated to a PO receipt or an outside processing transaction Header.<br> 
When periodic item cost not calculated correctly deliver_txn, PO Receipt, OSP.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: PAC_PO_POL');



debug('begin add_signature: PAC_PO_POLL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9488',
      p_sig_id                 => 'PAC_PO_POLL',
      p_sig_sql                => 'SELECT LINE_LOCATION_ID, PO_HEADER_ID , PO_LINE_ID , LAST_UPDATE_LOGIN, CREATION_DATE,                           
 QUANTITY, QUANTITY_RECEIVED , QUANTITY_ACCEPTED , QUANTITY_REJECTED , QUANTITY_BILLED,
QUANTITY_CANCELLED ,          
...
FROM rcv_transactions
WHERE transaction_id = ##$$TRANSACTIONID$$##)',
      p_title                  => 'PO Line Locations',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the PO line locations associated to a PO receipt or an outside processing transaction Header.<br> 
When periodic item cost not calculated correctly deliver_txn, PO Receipt, OSP.


',
      p_solution               => '',
      p_success_msg            => 'Displaying the PO line locations associated to a PO receipt or an outside processing transaction Header.<br> 
When periodic item cost not calculated correctly deliver_txn, PO Receipt, OSP.
...
',
   ...
   l_info.delete;
debug('end add_signature: PAC_PO_POLL');



debug('begin add_signature: PAC_PO_RCV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9490',
      p_sig_id                 => 'PAC_PO_RCV',
      p_sig_sql                => 'select po_header_id, transaction_id, quantity, organization_id, creation_date,
    TRANSACTION_TYPE,               
    TRANSACTION_DATE ,                                     
    UNIT_OF_MEASURE ,               
    SHIPMENT_HEADER_ID ,            
...
where po_header_id = po.po_header_id
and transaction_id = ##$$TRANSACTIONID$$##)',
      p_title                  => 'PO Receiving',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the PO receiving associated to a PO receipt or an outside processing transaction Header.<br> 
When periodic item cost not calculated correctly deliver_txn, PO Receipt, OSP.
',
      p_solution               => '',
      p_success_msg            => 'Displaying the PO receiving associated to a PO receipt or an outside processing transaction Header.<br> 
When periodic item cost not calculated correctly deliver_txn, PO Receipt, OSP.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: PAC_PO_RCV');



debug('begin add_signature: PAC_PO_RRSL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9503',
      p_sig_id                 => 'PAC_PO_RRSL',
      p_sig_sql                => 'SELECT RCV_TRANSACTION_ID, CURRENCY_CODE, ACTUAL_FLAG  , JE_SOURCE_NAME , JE_CATEGORY_NAME ,    
SET_OF_BOOKS_ID , ACCOUNTING_DATE , CODE_COMBINATION_ID, ACCOUNTED_DR , ACCOUNTED_CR ,                                    
TRANSACTION_DATE,PERIOD_NAME , CHART_OF_ACCOUNTS_ID , DATE_CREATED_IN_GL,                     
JE_BATCH_NAME ,  JE_BATCH_DESCRIPTION , JE_HEADER_NAME, GL_SL_LINK_ID,
ENTERED_DR ,                   
ENTERED_CR , 
...
WHERE reference2 IN (SELECT po_header_id
FROM rcv_transactions
WHERE transaction_id = ##$$TRANSACTIONID$$##)',
      p_title                  => 'PO Receiving Sub-Ledger',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the PO receiving sub-ledger associated to a PO receipt or an outside processing transaction Header.<br> 
When periodic item cost not calculated correctly deliver_txn, PO Receipt, OSP.

',
      p_solution               => '',
      p_success_msg            => 'Displaying the PO receiving sub-ledger associated to a PO receipt or an outside processing transaction Header.<br> 
When periodic item cost not calculated correctly deliver_txn, PO Receipt, OSP.
',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PAC_PO_RRSL');



debug('begin add_signature: PAC_PO__RCV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9479',
      p_sig_id                 => 'PAC_PO__RCV',
      p_sig_sql                => 'SELECT 
rt6.transaction_id
FROM 
...
START WITH 
rt6.transaction_id = ##$$TRANSACTIONID$$##
CONNECT BY 
rt6.transaction_id = prior rt6.parent_transaction_id',
      p_title                  => 'Receiving for Transaction_type (RECEIVE,MATCH)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the receiving item cost for PO transactions (Outside Processing , PO Receipt).',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PAC_PO__RCV');



debug('begin add_signature: PAC_WIP_MMT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9531',
      p_sig_id                 => 'PAC_WIP_MMT',
      p_sig_sql                => 'SELECT  transaction_id txnid,
transaction_date txndate,
acct_period_id acct,
transaction_group_id group_id,
organization_id orgid,
transaction_action_id txnaction,
transaction_source_type_id sourcetype,
transaction_source_id txnsource,
flow_schedule flowschedule,
inventory_item_id itemid,
operation_seq_num opseqnum,
completion_transaction_id compltxn,
move_transaction_id move_txn,
cost_group_id costgroup,
costed_flag ,
primary_quantity p_qty,
actual_cost ac,
repetitive_line_id line_id,
final_completion_flag fg
 FROM   mtl_material_transactions
WHERE   organization_id = ##$$ORGANIZATIONID$$## 
  AND   transaction_source_type_id = 5
  AND   transaction_source_id = ##$$JOBID$$##',
      p_title                  => 'MMT Data Transaction',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the material transactions associated to WIP job when periodic item cost not calculated correctly for a Job ID (WIP entity id), organization ID, and cost type.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: PAC_WIP_MMT');



debug('begin add_signature: PAC_WIP_WT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9532',
      p_sig_id                 => 'PAC_WIP_WT',
      p_sig_sql                => 'SELECT transaction_id txn_id,
       organization_id org_id,
       wip_entity_id we_id,
       transaction_date txn_dte,
       acct_period_id period,
       transaction_type ttype,
       primary_quantity p_qty,
       actual_resource_rate arr,
       basis_type bt,
       standard_rate_flag srf,
       standard_resource_rate srr,
       usage_rate_or_amount ura,
       group_id,
       currency_code cc,
       currency_conversion_rate ccr,
       currency_actual_resource_rate carr,
       operation_seq_num op_seq,
       resource_id rid,
       resource_seq_num res_seq,
       employee_id emp_id,
       rcv_transaction_id rcv_txn,
       move_transaction_id move_txn,
       completion_transaction_id comp_txn,
       cost_update_id cu_id,
       project_id,
       task_id,
       pm_cost_collected pmcc,
       pm_cost_collector_group_id pmcc_gid,
       department_id dept
  FROM wip_transactions
 WHERE organization_id = ##$$ORGANIZATIONID$$##
   AND wip_entity_id = ##$$JOBID$$##',
      p_title                  => 'WT Data WIP Transactions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the PAC WIP transactions associated to WIP job when periodic item cost not calculated correctly for a Job ID (WIP entity id), organization ID, and cost type.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: PAC_WIP_WT');



debug('begin add_signature: PAC_WIP_MCTCD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9533',
      p_sig_id                 => 'PAC_WIP_MCTCD',
      p_sig_sql                => 'SELECT transaction_id ,
organization_id ,
cost_element_id ,
inventory_item_id ,
...
AND transaction_source_type_id = 5
AND transaction_source_id = ##$$JOBID$$##)',
      p_title                  => 'MCTCD Data Transaction Cost',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the material transaction cost details associated to WIP job when periodic item cost not calculated correctly for a Job ID (WIP entity id), organization ID, and cost type.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: PAC_WIP_MCTCD');



debug('begin add_signature: PAC_WIP_MPTCD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9534',
      p_sig_id                 => 'PAC_WIP_MPTCD',
      p_sig_sql                => 'SELECT cost_group_id , cost_type_id ,
pac_period_id period,transaction_id txn_id,
cost_element_id ,  level_type ,
...
AND transaction_source_type_id = 5
AND transaction_source_id = ##$$JOBID$$##)',
      p_title                  => 'MPTCD Data PAC Transaction Cost',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Checking PAC issue associated to wip job
When periodic item cost not calculated correctly
Job ID (wip entity id)
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: PAC_WIP_MPTCD');



debug('begin add_signature: PAC_WIP_MPACD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9535',
      p_sig_id                 => 'PAC_WIP_MPACD',
      p_sig_sql                => 'SELECT cost_group_id , cost_type_id ,
pac_period_id period, transaction_id ,
cost_element_id ,level_type ,
cost_layer_id, actual_cost ,
prior_cost , new_cost ,
prior_buy_cost , new_buy_cost ,
...
AND transaction_source_type_id = 5
AND transaction_source_id = ##$$JOBID$$##)',
      p_title                  => 'MPACD Data PAC Actual Cost',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the PAC actual cost details associated to WIP job when periodic item cost not calculated correctly for a Job ID (WIP entity id), organization ID, and cost type.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: PAC_WIP_MPACD');



debug('begin add_signature: PAC_WIP_CPTH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9536',
      p_sig_id                 => 'PAC_WIP_CPTH',
      p_sig_sql                => 'SELECT process_group,inventory_item_id,txn_master_qty,
prior_costed_master_qty,actual_cost,new_cost,prior_cost
FROM cst_pc_txn_history
WHERE cost_group_id = ##$$COSTGROUPID$$##
AND transaction_id IN
...
AND transaction_source_type_id = 5
AND transaction_source_id = ##$$JOBID$$##)',
      p_title                  => 'CPTH Data PAC Transaction History',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the PAC transaction history associated to WIP job when periodic item cost not calculated correctly for a Job ID (WIP entity id), organization ID, and cost type.
...
',
   ...
   l_info.delete;
debug('end add_signature: PAC_WIP_CPTH');



debug('begin add_signature: PAC_WIP_CRAC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9537',
      p_sig_id                 => 'PAC_WIP_CRAC',
      p_sig_sql                => 'SELECT header_id, cost_group_id,
       cost_type_id, period_id, rcv_transaction_id,
       net_quantity_received, total_quantity_invoiced, quantity_at_po_price
       total_invoice_amount, amount_at_po_price, total_amount
 ...
 WHERE transaction_type IN (3, 17)
   ...
   AND wip_entity_id = ##$$JOBID$$##)',
      p_title                  => 'CRAC Data PAC Acquisition Cost',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the PAC acquisition cost associated to WIP job when periodic item cost not calculated correctly for a Job ID (WIP entity id), organization ID, and cost type.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: PAC_WIP_CRAC');



debug('begin add_signature: PAC_WIP_CAH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9538',
      p_sig_id                 => 'PAC_WIP_CAH',
      p_sig_sql                => 'SELECT cah.accounting_event_id, cah.ae_header_id,
       cah.set_of_books_id, cah.organization_id, cah.legal_entity_id, cah.cost_group_id, cah.cost_type_id,
       cah.acct_event_source_table, cah.ae_category,
       cah.period_id, cah.period_name, cah.accounting_date,
       cah.gl_transfer_flag, cah.gl_transfer_run_id, cah.gl_transfer_error_code,
       cah.accounting_error_code, cah.creation_date
FROM cst_ae_headers cah
WHERE cah.accounting_event_id IN
(SELECT mmt.transaction_id
   FROM mtl_material_transactions mmt
  WHERE mmt.organization_id = ##$$ORGANIZATIONID$$##
...
UNION ALL
 SELECT wt.transaction_id
  ...
  WHERE wt.organization_id = ##$$ORGANIZATIONID$$##
    and  cah.ACCT_EVENT_SOURCE_TABLE = ''WT''  
    AND wt.wip_entity_id = ##$$JOBID$$## )
 AND cah.cost_type_id = ##$$COSTTYPEID$$##',
      p_title                  => 'CAH Data PAC Distribution',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the PAC distributions associated to WIP job when periodic item cost not calculated correctly for a Job ID (WIP entity id), organization ID, and cost type.',
      p_solution               => '',
      p_success_msg            => 'Displaying the PAC distributions associated to WIP job when periodic item cost not calculated correctly for a Job ID (WIP entity id), organization ID, and cost type.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PAC_WIP_CAH');



debug('begin add_signature: PAC_WIP_CAL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9539',
      p_sig_id                 => 'PAC_WIP_CAL',
      p_sig_sql                => 'SELECT ae_line_id, ae_header_id, ae_line_number,
       ae_line_type_code, code_combination_id, cost_element_id,
       entered_dr, entered_cr,
       accounted_dr, accounted_cr, rate_or_amount,
...
(SELECT transaction_id
   FROM mtl_material_transactions
  WHERE organization_id = ##$$ORGANIZATIONID$$##
    and  ACCT_EVENT_SOURCE_TABLE = ''MMT''  
    AND transaction_source_type_id = 5
    AND transaction_source_id = ##$$JOBID$$## 
UNION ALL
 SELECT transaction_id
   FROM wip_transactions
  WHERE organization_id = ##$$ORGANIZATIONID$$##
    and  ACCT_EVENT_SOURCE_TABLE = ''WT''  
    AND wip_entity_id = ##$$JOBID$$##))',
      p_title                  => 'CAL Data PAC Distribution Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the PAC distribution details associated to WIP job when periodic item cost not calculated correctly for a Job ID (WIP entity id), organization ID, and cost type.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: PAC_WIP_CAL');



debug('begin add_signature: PAC_WIP_WPACD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9541',
      p_sig_id                 => 'PAC_WIP_WPACD',
      p_sig_sql                => 'SELECT pac_period_id ,cost_group_id , cost_type_id , transaction_id , 	
level_type , cost_element_id , transaction_costed_date , actual_cost , actual_value , 	
last_update_date , creation_date , program_id
FROM wip_pac_actual_cost_details
WHERE transaction_id in  (SELECT transaction_id
   FROM wip_transactions
  WHERE organization_id = ##$$ORGANIZATIONID$$##
    AND wip_entity_id = ##$$JOBID$$##)',
      p_title                  => 'WPACD Data WIP PAC Actual Cost',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Checking PAC issue associated to wip job
When periodic item cost not calculated correctly
Job ID (wip entity id)
...
',
   ...
   l_info.delete;
debug('end add_signature: PAC_WIP_WPACD');



debug('begin add_signature: PAC_WIP_WPPB');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9542',
      p_sig_id                 => 'PAC_WIP_WPPB',
      p_sig_sql                => 'SELECT 
pac_period_id , 	
cost_group_id , 	
cost_type_id , 	
...
tl_resource_in tri, 	
tl_resource_out tro, 	
tl_outside_processing_in tospi, 	
tl_outside_processing_out tospo, 	
tl_overhead_in toi, 	
tl_overhead_out too, 	
pl_material_in pmi, 	
pl_material_out pmo, 	
...
pl_overhead_in poi, 	
pl_overhead_out poo, 	
pl_outside_processing_in pospi, 	
pl_outside_processing_out pospo, 	
pl_material_overhead_in pmoi, 	
pl_material_overhead_out pmoo, 	
tl_resource_var trv, 	
tl_outside_processing_var tospv, 	
tl_overhead_var tov, 	
pl_material_var pmv, 	
pl_material_overhead_var pmov, 	
pl_resource_var prv, 	
pl_outside_processing_var pospv, 	
pl_overhead_var pov, 	
last_update_date lupd_dte, 	
creation_date cr_dte, 	
program_id prg_id, 	
wip_entity_type we_typ,
    TL_RESOURCE_TEMP,
...
WHERE cost_group_id = ##$$COSTGROUPID$$##
AND wip_entity_id = ##$$JOBID$$##',
      p_title                  => 'WPPB Data Period Balances',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the PAC period balances associated to WIP job when periodic item cost not calculated correctly for a Job ID (WIP entity id), organization ID, and cost type.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: PAC_WIP_WPPB');



debug('begin add_signature: PAC_WIP_CPROCD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9540',
      p_sig_id                 => 'PAC_WIP_CPROCD',
      p_sig_sql                => 'SELECT pac_period_id, 
cost_group_id, 
wip_entity_id, 
line_id, 
operation_seq_num, 
...
WHERE cost_group_id = ##$$COSTGROUPID$$##
AND wip_entity_id = ##$$JOBID$$##',
      p_title                  => 'CPROCD Data PAC WIP Balance Within a Cost Group by Period',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the PAC WIP balance associated to WIP job when periodic item cost not calculated correctly for a Job ID (WIP entity id), organization ID, and cost type.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: PAC_WIP_CPROCD');



debug('begin add_signature: LCM_PAC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13518',
      p_sig_id                 => 'LCM_PAC',
      p_sig_sql                => 'select SHIPMENT_HEADER_ID, ORGANIZATION_ID , SHIPMENT_NUM , RECEIPT_NUM  , SHIPPED_DATE ,
...
where shipment_header_id in
 (select distinct shipment_header_id
  from rcv_transactions where po_header_id = ##$$PO_Header_ID$$##)',
      p_title                  => 'LCM Costs Based on a PO not Absorbed by PAC',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'LCM costs based on a PO not absorbed by PAC.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: LCM_PAC');



debug('begin add_signature: LCM_PAC_INL_ALLOCATIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13579',
      p_sig_id                 => 'LCM_PAC_INL_ALLOCATIONS',
      p_sig_sql                => 'select * from inl_allocations where ship_header_id in (select ship_header_id 
 from inl_ship_headers_all where interface_source_table = 
 ''RCV_SHIPMENT_HEADERS'' and interface_source_line_id in (select distinct 
 shipment_header_id from rcv_transactions where po_header_id = ##$$PO_Header_ID$$##)) order 
 by ship_header_id, adjustment_num',
      p_title                  => 'Shipment Allocation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the LCM shipment allocation.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: LCM_PAC_INL_ALLOCATIONS');



debug('begin add_signature: LCM_PAC_INL_MATCHES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13578',
      p_sig_id                 => 'LCM_PAC_INL_MATCHES',
      p_sig_sql                => 'select * 
from inl_matches 
where ship_header_id in (select ship_header_id 
from inl_ship_headers_all where interface_source_table = ''RCV_SHIPMENT_HEADERS'' 
and interface_source_line_id in (select distinct shipment_header_id 
from rcv_transactions where po_header_id = ##$$PO_Header_ID$$##)) 
order by ship_header_id,adjustment_num',
      p_title                  => 'Shipment Match',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the LCM shipment match.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: LCM_PAC_INL_MATCHES');



debug('begin add_signature: LCM_PAC_INL_SHIP_H');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13576',
      p_sig_id                 => 'LCM_PAC_INL_SHIP_H',
      p_sig_sql                => 'select * 
from inl_ship_headers_all 
where interface_source_table = ''RCV_SHIPMENT_HEADERS'' 
and interface_source_line_id in (select distinct 
shipment_header_id from rcv_transactions where po_header_id = ##$$PO_Header_ID$$##)',
      p_title                  => 'Shipment Header',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the LCM shipment header. ',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: LCM_PAC_INL_SHIP_H');



debug('begin add_signature: LCM_PAC_INL_SHIP_LANDED_H');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13580',
      p_sig_id                 => 'LCM_PAC_INL_SHIP_LANDED_H',
      p_sig_sql                => 'select * 
from inl_shipln_landed_costs_v 
where ship_header_id in (select 
ship_header_id from inl_ship_headers_all
where interface_source_table = ''RCV_SHIPMENT_HEADERS'' 
and interface_source_line_id in (select distinct shipment_header_id 
from rcv_transactions where po_header_id = ##$$PO_Header_ID$$##)) 
order by ship_header_id, ship_line_num, adjustment_num',
      p_title                  => 'Shipment Lines',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the LCM shipment line.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: LCM_PAC_INL_SHIP_LANDED_H');



debug('begin add_signature: LCM_PAC_INL_SHIP_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13577',
      p_sig_id                 => 'LCM_PAC_INL_SHIP_LINES',
      p_sig_sql                => 'select * 
from inl_ship_lines_all 
where ship_header_id in (select ship_header_id from inl_ship_headers_all 
where interface_source_table = ''RCV_SHIPMENT_HEADERS'' and interface_source_line_id 
in (select distinct shipment_header_id from rcv_transactions 
where po_header_id = ##$$PO_Header_ID$$##)) 
order by ship_header_id, ship_line_num, adjustment_num',
      p_title                  => 'Shipment Lines Detail',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the LCM shipment lines detail. ',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: LCM_PAC_INL_SHIP_LINES');



debug('begin add_signature: LCM_PAC__AP_INVOICES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13573',
      p_sig_id                 => 'LCM_PAC__AP_INVOICES',
      p_sig_sql                => 'select  INVOICE_ID,LAST_UPDATE_DATE,VENDOR_ID,INVOICE_NUM,INVOICE_AMOUNT,
 INVOICE_DATE,CREATION_DATE,ORG_ID
SET_OF_BOOKS_ID ,              
...
from ap_invoice_lines_all where rcv_transaction_id 
in (select transaction_id 
from rcv_transactions where po_header_id = ##$$PO_Header_ID$$##))',
      p_title                  => 'AP Invoices',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the AP invoice header.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: LCM_PAC__AP_INVOICES');



debug('begin add_signature: LCM_PAC__AP_INVOICES_DISTRIBUTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13575',
      p_sig_id                 => 'LCM_PAC__AP_INVOICES_DISTRIBUTIONS',
      p_sig_sql                => 'select ACCOUNTING_DATE , DISTRIBUTION_LINE_NUMBER ,INVOICE_ID  ,PERIOD_NAME ,
AMOUNT,FINAL_MATCH_FLAG,MATCH_STATUS_FLAG,PO_DISTRIBUTION_ID
from ap_invoice_distributions_all 
where invoice_id in (select distinct invoice_id from ap_invoice_lines_all where rcv_transaction_id in 
(select transaction_id from rcv_transactions where po_header_id = ##$$PO_Header_ID$$##)) 
order by invoice_id',
      p_title                  => 'AP Invoice Distributions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the AP invoice distributions.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: LCM_PAC__AP_INVOICES_DISTRIBUTIONS');



debug('begin add_signature: LCM_PAC__AP_INVOICES_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13574',
      p_sig_id                 => 'LCM_PAC__AP_INVOICES_LINES',
      p_sig_sql                => 'select INVOICE_ID,LINE_NUMBER,LINE_TYPE_LOOKUP_CODE,DESCRIPTION,ORG_ID,
MATCH_TYPE,ACCOUNTING_DATE,PERIOD_NAME,AMOUNT,QUANTITY_INVOICED,
    INVENTORY_ITEM_ID ,             
    SET_OF_BOOKS_ID ,                                        
    BASE_AMOUNT ,                  
    ROUNDING_AMT ,                  
...
from ap_invoice_lines_all
 where invoice_id in (select distinct 
invoice_id from ap_invoice_lines_all where rcv_transaction_id in (select 
...
order by invoice_id, line_number',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the AP invoice lines. ',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: LCM_PAC__AP_INVOICES_LINES');



debug('begin add_signature: LCM_PAC__LC_ADJUSTMENT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13581',
      p_sig_id                 => 'LCM_PAC__LC_ADJUSTMENT',
      p_sig_sql                => 'select * 
from cst_lc_adj_transactions
where rcv_transaction_id in (select transaction_id from rcv_transactions 
where po_header_id = ##$$PO_Header_ID$$##)
order by rcv_transaction_id, creation_date',
      p_title                  => 'Adjustment Transactions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the LCM adjustment transactions. ',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: LCM_PAC__LC_ADJUSTMENT');



debug('begin add_signature: LCM_PAC__PO_H');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13572',
      p_sig_id                 => 'LCM_PAC__PO_H',
      p_sig_sql                => 'select SHIPMENT_HEADER_ID  ,RECEIPT_SOURCE_CODE ,VENDOR_ID ,
ORGANIZATION_ID , SHIPMENT_NUM , RECEIPT_NUM,
CREATION_DATE ,           
    RECEIPT_SOURCE_CODE ,                   
    SHIP_TO_LOCATION_ID ,                    
    CURRENCY_CODE  ,           
...
from rcv_shipment_headers
where shipment_header_id in (select distinct shipment_header_id from rcv_transactions where po_header_id = ##$$PO_Header_ID$$##)',
      p_title                  => 'Receiving Shipment Headers',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the receiving shipment headers. ',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: LCM_PAC__PO_H');



debug('begin add_signature: LCM_PAC__PO_L');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13570',
      p_sig_id                 => 'LCM_PAC__PO_L',
      p_sig_sql                => 'select SHIPMENT_LINE_ID,CREATION_DATE,SHIPMENT_HEADER_ID,LINE_NUM,
QUANTITY_SHIPPED,QUANTITY_RECEIVED,ITEM_DESCRIPTION,ITEM_ID,
SHIPMENT_LINE_STATUS_CODE,PO_HEADER_ID,PO_LINE_ID,PO_DISTRIBUTION_ID,
CATEGORY_ID ,             
    UNIT_OF_MEASURE  ,        
    UOM_CONVERSION_RATE ,     
    PO_RELEASE_ID ,           
...
where shipment_header_id in (select distinct 
shipment_header_id from rcv_transactions where po_header_id = ##$$PO_Header_ID$$##)
order by shipment_header_id, shipment_line_id',
      p_title                  => 'Receiving Shipment Lines',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the receiving shipment lines.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: LCM_PAC__PO_L');



debug('begin add_signature: PAC_CSTPPINV_CSTPPCLM.LAYER_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14154',
      p_sig_id                 => 'PAC_CSTPPINV_CSTPPCLM.LAYER_ID',
      p_sig_sql                => 'SELECT QUANTITY_LAYER_ID, COST_LAYER_ID, PAC_PERIOD_ID         
COST_GROUP_ID, INVENTORY_ITEM_ID, LAYER_QUANTITY, BEGIN_LAYER_QUANTITY 
...
AND inventory_item_id = cpql.inventory_item_id)',
      p_title                  => 'Periodic Actual Cost Worker Error CSTPPINV.COST_INV_TXN:CSTPPCLM.LAYER_ID Layers Inconsistency',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'When running CMCPAW:Periodic Actual Cost Worker, the following error occur:<br>

txn id : XXXXXXXXXXX<br>
CSTPPINV.COST_INV_TXN:CSTPPCLM.LAYER_ID: layers inconsistency<br>
phase 5',
      p_solution               => 'Review [430533/KB767523] CMCPAW - Error Cstppinv.Cost_Inv_Txn:Cstppclm.Layer_ID:Layers Inconsistency-Phase 5
...
',
   ...
   l_info.delete;
debug('end add_signature: PAC_CSTPPINV_CSTPPCLM.LAYER_ID');



debug('begin add_signature: PAC_UNABLE_TO_ CLOSE_PAC_PERIOD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14191',
      p_sig_id                 => 'PAC_UNABLE_TO_ CLOSE_PAC_PERIOD',
      p_sig_sql                => 'SELECT TRANSACTION_ID,to_char(CREATION_DATE, ''ddmonyy hh24:mi:ss'') CREATION_DATE,
to_char(TRANSACTION_DATE, ''ddmonyy hh24:mi:ss'') TRANSACTION_DATE,INVENTORY_ITEM_ID,ORGANIZATION_ID,SUBINVENTORY_CODE,
TRANSACTION_TYPE_ID,TRANSACTION_SOURCE_ID,ACCT_PERIOD_ID,
COSTED_FLAG,ERROR_CODE,ERROR_EXPLANATION,COST_GROUP_ID
FROM MTL_MATERIAL_TRANSACTIONS MMT
WHERE MMT.CREATION_DATE > (SELECT MIN(CPPP.PROCESS_DATE)
FROM CST_PAC_PROCESS_PHASES CPPP
WHERE ((CPPP.PROCESS_PHASE <= 5 AND CPPP.PROCESS_UPTO_DATE IS NOT NULL )
OR (CPPP.PROCESS_PHASE = 6 AND EXISTS (SELECT CREATE_ACCT_ENTRIES
FROM CST_LE_COST_TYPES WHERE COST_TYPE_ID = ##$$COSTTYPEID$$##
 AND PRIMARY_COST_METHOD > 2
AND NVL(CREATE_ACCT_ENTRIES,''N'') = ''Y'' )
AND CPPP.PROCESS_UPTO_DATE IS NOT NULL )))
AND MMT.ORGANIZATION_ID IN (SELECT CCGA.ORGANIZATION_ID
FROM CST_COST_GROUP_ASSIGNMENTS CCGA
WHERE CCGA.COST_GROUP_ID = ##$$COSTGROUPID$$##)',
      p_title                  => 'PAC Period Close Error Cost Manager Run was Prior to the Period Ending Date',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Closing PAC period, the following error occur:<br>
	
Last Cost Manager run was before the period ending date. ',
      p_solution               => 'Review [2708016/KB724673] Periodic Accounting Period Can Not Be Closed Due To Error <br>
Re-run cost manager to completely process all proceeding transactions.
...
',
   ...
   l_info.delete;
debug('end add_signature: PAC_UNABLE_TO_ CLOSE_PAC_PERIOD');



debug('begin add_signature: ERROR RECEIVED WHEN TRYING TO CLOSE PAC PERIOD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14112',
      p_sig_id                 => 'ERROR RECEIVED WHEN TRYING TO CLOSE PAC PERIOD',
      p_sig_sql                => 'select process_phase, process_status,
to_char(process_date, ''ddmonyy hh24:mi:ss'') process_date,
to_char(process_upto_date, ''ddmonyy hh24:mi:ss'') process_upto_date,
to_char(creation_date, ''ddmonyy hh24:mi:ss'') creation_date,
to_char(last_update_date, ''ddmonyy hh24:mi:ss'') last_update_date
from cst_pac_process_phases
where round (process_upto_date) <> round (last_update_date)
and process_date > sysdate-365',
      p_title                  => 'Close PAC Period Error Backdated Transactions Exist in the System',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Getting error when closing PAC Period: <<Backdated transactions exist in the system which may not have been processed for periodic costing>>.

The issue occurs when the Periodic Processors were not run in order.',
      p_solution               => 'Review [782679/KB736583] Error Received when Trying to Close PAC Period - backdated transactions exist in the system which may not have been processed for periodic costing.',
      p_success_msg            => 'PAC Period has been closed successfully.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ERROR RECEIVED WHEN TRYING TO CLOSE PAC PERIOD');



debug('begin add_signature: PERIODIC ACTUAL COST WORKER ERROR  NUMERIC OVERFLOW');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14113',
      p_sig_id                 => 'PERIODIC ACTUAL COST WORKER ERROR  NUMERIC OVERFLOW',
      p_sig_sql                => 'select  cost_layer_id , ITEM_COST , ITEM_BUY_COST, ITEM_MAKE_COST
from cst_pac_item_cost_details
WHERE
ITEM_COST != round(ITEM_COST, 30) or
ITEM_BUY_COST != round(ITEM_BUY_COST, 30) or
ITEM_MAKE_COST != round(ITEM_MAKE_COST, 30)
and cost_layer_id IN
(SELECT cost_layer_id
FROM cst_pac_item_costs
where inventory_item_id = ##$$INVENTORYITEMID$$##
and cost_group_id = ##$$COSTGROUPID$$##)',
      p_title                  => 'Periodic Actual Cost Worker Numeric Overflow Error',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'CMCPAW: Periodic Actual Cost Worker Error: CSTPPWAC.insert_into_cppb (30): ORA-01426 Numeric Overflow',
      p_solution               => 'Review[2292058/KB730487] CMCPAW: Periodic Actual Cost Worker-CSTPPWAC.insert_into_cppb (30): ORA-01426: Numeric Overflow
...
',
   ...
   l_info.delete;
debug('end add_signature: PERIODIC ACTUAL COST WORKER ERROR  NUMERIC OVERFLOW');
...
debug('begin add_signature: PAC_CSTPDPPC_1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8547',
      p_sig_id                 => 'PAC_CSTPDPPC_1',
      p_sig_sql                => 'SELECT msi.inventory_item_id,
msi.organization_id
...
AND mic.category_set_id = ##$$category_set_id$$##))',
      p_title                  => 'Periodic Cost Distributions Processor Error CSTPAPBR.create_acct_lines  ORA-01403',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'When attempting to Run Periodic Cost Distributions Processor - CSTPDPPC  the following error occurs:<br>
CSTPAPBR.create_acct_lines : 60:ORA-01403.',
      p_solution               => 'Review [1390817/KB198411] CSTPDPPC Periodic Cost Distributions Processor Error CSTPAPBR.Create_Acct_Lines:60:ORA-01403
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: PAC_CSTPDPPC_1');
...
BEGIN
  ...
  analyzer_title := 'Cost Management Periodic Average Costing (PAC) Analyzer';
...
start_section('Organizations Setup  ', 'Organizations_Costing_Info_Details');
...
debug('begin section: PAC_Setup');
start_section('Setup', 'PAC_Setup');
   set_item_result(run_stored_sig('PAC LEGAL ENTITIES'));
   set_item_result(run_stored_sig('COST GROUP ACCOUNTS'));
   set_item_result(run_stored_sig('CST COST TYPES'));
   set_item_result(run_stored_sig('FISCAL ACCOUNTS SETUP'));
   set_item_result(run_stored_sig('MTL PARAMETERS'));
   set_item_result(run_stored_sig('PAC LE COST TYPES'));
   set_item_result(run_stored_sig('PAC ORG COST GROUP'));
   set_item_result(run_stored_sig('PAC ORG COST GROUP ASSIGNMENT'));
   set_item_result(run_stored_sig('PAC PERIODS'));
end_section;
debug('end section: PAC_Setup');

debug('begin section: PAC_Inventory_Item');
IF g_sql_tokens('##$$Item_Issue$$##') = 'Y' THEN
   start_section('Inventory Item', 'PAC_Inventory_Item');
      set_item_result(run_stored_sig('PAC_INV_ITEM_TXNS-CAL'));
      set_item_result(run_stored_sig('PAC_INV_ITEM_TXNS-CAL-LINES'));
      set_item_result(run_stored_sig('PAC_INV_ITEM_TXNS-CPIC'));
      set_item_result(run_stored_sig('PAC_INV_ITEM_TXNS-CPICD'));
      set_item_result(run_stored_sig('PAC_INV_ITEM_TXNS-CPQL'));
      set_item_result(run_stored_sig('PAC_INV_ITEM_TXNS-CPTH'));
      set_item_result(run_stored_sig('PAC_INV_ITEM_TXNS-CRAC'));
      set_item_result(run_stored_sig('PAC_INV_ITEM_TXNS-MCTCD'));
      set_item_result(run_stored_sig('PAC_INV_ITEM_TXNS-MMT'));
      set_item_result(run_stored_sig('PAC_INV_ITEM_TXNS-MPACD'));
      set_item_result(run_stored_sig('PAC_INV_ITEM_TXNS-MPACS'));
      set_item_result(run_stored_sig('PAC_INV_ITEM_TXNS-MPTCD'));
      set_item_result(run_stored_sig('PAC_INV_ITEM_TXNS-CPPB'));
   end_section;
END IF;
debug('end section: PAC_Inventory_Item');

debug('begin section: PAC_PO');
IF g_sql_tokens('##$$PO_Issue$$##') = 'Y' THEN
   start_section('Purchase Order', 'PAC_PO');
      set_item_result(run_stored_sig('PAC_PO_AIDA'));
      set_item_result(run_stored_sig('PAC_PO_CAH'));
      set_item_result(run_stored_sig('PAC_PO_CAL'));
      set_item_result(run_stored_sig('PAC_PO_CRAC'));
      set_item_result(run_stored_sig('PAC_PO_CRACD'));
      set_item_result(run_stored_sig('PAC_PO_MMT_RCV_WIP'));
      set_item_result(run_stored_sig('PAC_PO_POD'));
      set_item_result(run_stored_sig('PAC_PO_POH'));
      set_item_result(run_stored_sig('PAC_PO_POL'));
      set_item_result(run_stored_sig('PAC_PO_POLL'));
      set_item_result(run_stored_sig('PAC_PO_RCV'));
      set_item_result(run_stored_sig('PAC_PO_RRSL'));
      set_item_result(run_stored_sig('PAC_PO__RCV'));
   end_section;
END IF;
debug('end section: PAC_PO');

debug('begin section: PAC_WIP');
IF g_sql_tokens('##$$WIP_Issue$$##') = 'Y' THEN
   start_section('Work Order', 'PAC_WIP');
      set_item_result(run_stored_sig('PAC_WIP_MMT'));
      set_item_result(run_stored_sig('PAC_WIP_WT'));
      set_item_result(run_stored_sig('PAC_WIP_MCTCD'));
      set_item_result(run_stored_sig('PAC_WIP_MPTCD'));
      set_item_result(run_stored_sig('PAC_WIP_MPACD'));
      set_item_result(run_stored_sig('PAC_WIP_CPTH'));
      set_item_result(run_stored_sig('PAC_WIP_CRAC'));
      set_item_result(run_stored_sig('PAC_WIP_CAH'));
      set_item_result(run_stored_sig('PAC_WIP_CAL'));
      set_item_result(run_stored_sig('PAC_WIP_WPACD'));
      set_item_result(run_stored_sig('PAC_WIP_WPPB'));
      set_item_result(run_stored_sig('PAC_WIP_CPROCD'));
   end_section;
END IF;
debug('end section: PAC_WIP');

debug('begin section: PAC_LCM');
IF g_sql_tokens('##$$LCM_Issue$$##') = 'Y' THEN
   start_section('Landed Cost Management', 'PAC_LCM');
      set_item_result(run_stored_sig('LCM_PAC'));
      set_item_result(run_stored_sig('LCM_PAC_INL_ALLOCATIONS'));
      set_item_result(run_stored_sig('LCM_PAC_INL_MATCHES'));
      set_item_result(run_stored_sig('LCM_PAC_INL_SHIP_H'));
      set_item_result(run_stored_sig('LCM_PAC_INL_SHIP_LANDED_H'));
      set_item_result(run_stored_sig('LCM_PAC_INL_SHIP_LINES'));
      set_item_result(run_stored_sig('LCM_PAC__AP_INVOICES'));
      set_item_result(run_stored_sig('LCM_PAC__AP_INVOICES_DISTRIBUTIONS'));
      set_item_result(run_stored_sig('LCM_PAC__AP_INVOICES_LINES'));
      set_item_result(run_stored_sig('LCM_PAC__LC_ADJUSTMENT'));
      set_item_result(run_stored_sig('LCM_PAC__PO_H'));
      set_item_result(run_stored_sig('LCM_PAC__PO_L'));
   end_section;
END IF;
debug('end section: PAC_LCM');

debug('begin section: PAC_Errors');
start_section('Errors', 'PAC_Errors');
   IF p_Category_Set_ID IS NOT NULL THEN
      set_item_result(run_stored_sig('PAC_CSTPDPPC_1'));
   END IF;
   set_item_result(run_stored_sig('PAC_CSTPPINV_CSTPPCLM.LAYER_ID'));
   set_item_result(run_stored_sig('PAC_UNABLE_TO_ CLOSE_PAC_PERIOD'));
   set_item_result(run_stored_sig('ERROR RECEIVED WHEN TRYING TO CLOSE PAC PERIOD'));
   set_item_result(run_stored_sig('PERIODIC ACTUAL COST WORKER ERROR  NUMERIC OVERFLOW'));
end_section;
debug('end section: PAC_Errors');
