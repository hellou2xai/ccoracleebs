...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Configurator Analyzer                  |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE cz_analyzer_pkg AUTHID DEFINER AS
...
CREATE OR REPLACE PACKAGE BODY cz_analyzer_pkg AS
-- $Id: configurator_analyzer.sql, 200.31 2026/01/27 20:44:36 cschmehl Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2255449.1));
...
----------------------------------------------------------------
g_bom_url   varchar2(150);
g_batch_validation_passed BOOLEAN := FALSE;
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'CZ_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'CZ_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>CZ Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2255449.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/cz_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,785,EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,785,EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},785,EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4036883" class="blacklink" target="new">
...
&nbsp; &nbsp; &nbsp;Error: ORA-06502: PL/SQL: numeric or value error: character string buffer too small</p><p>Added CVW patch check signature - EBS_ATG_CT_SECURITY_ALERT_CVE_PATCHES&nbsp;<br>
Sequence signatures updated<br>
EBS_ATG_UGLE_SEQUENCES_CLOSE_TO_MAXIMUM_VALUE_BELOW_12C<br>
EBS_ATG_UGLE_SEQUENCES_CLOSE_TO_MAXIMUM_VALUE</p>
            <br><br>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,785,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,785,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},785,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
----------------------------------------------------------------
PROCEDURE check_batch_validation IS
  cz_url varchar2(2000) := fnd_profile.value('CZ_UIMGR_URL'); 
  final_url varchar2(2000); 
  altbatchvalidateurl varchar(2000);
  servlet_agent varchar2(2000) := fnd_profile.value('APPS_SERVLET_AGENT'); 
  wallet_dir varchar2(2000) := fnd_profile.value('FND_DB_WALLET_DIR'); 
  wallet_pwd varchar2(2000) := NULL; 
  results UTL_HTTP.HTML_PIECES; 
  stringresults varchar(2000);
  p_index number; 
  resultcount number;
BEGIN
    SELECT COUNT(*) INTO resultcount FROM CZ_DB_SETTINGS WHERE UPPER(SETTING_ID) ='ALTBATCHVALIDATEURL';
    IF (resultcount) > 0 THEN
      SELECT VALUE INTO altbatchvalidateurl FROM CZ_DB_SETTINGS WHERE UPPER(SETTING_ID) ='ALTBATCHVALIDATEURL';
      final_url := altbatchvalidateurl || '?test=version';
      stringresults := '';
      results := utl_http.request_pieces(final_url);
    ELSIF upper(servlet_agent) like '%HTTPS%' THEN
      final_url := cz_url || '?test=version'; 
      results := utl_http.request_pieces(url => final_url, wallet_path => 'file:'||wallet_dir, wallet_password => wallet_pwd);
    ELSE
      final_url := cz_url || '?test=version';
      results := utl_http.request_pieces(final_url);
    END IF;
    ...
    for i in 1 .. results.count loop
        stringresults := stringresults || results(i);
    end loop;
    
    IF INSTR(stringresults, 'software build', 1, 1) > 0 THEN
      g_batch_validation_passed := TRUE;
    END IF;

    EXCEPTION
       WHEN OTHERS THEN
          dbms_output.put_line('Exception occurred, batch validation test failed');
end check_batch_validation;
...
FUNCTION check_rec_patches_1 RETURN VARCHAR2 IS
  /* Signature EBS_ATG_CT_SECURITY_ALERT_CVE_PATCHES */
...
BEGIN
    ...
    print_log('Processing recommended patches signature: EBS_ATG_CT_SECURITY_ALERT_CVE_PATCHES (check_rec_patches_1) "Recommended EBS Security Alert CVE Mitigation Patches" (version 19)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_col_rows(1)(l_rows) := '38507994';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'For <b style="color: red;">Security Alert : CVE-2025-61882</b> - Apply Patch 38507994:R12.TXK.B in hotpatch mode.';
   l_col_rows(5)(l_rows) := '[3106344.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '38564469';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'For <b style="color: red;">Security Alert : CVE-2025-61882</b> - Apply Patch 38564469:R12.TXK.B in hotpatch mode';
   l_col_rows(5)(l_rows) := '[3106344.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '38523311';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'For <b style="color: red;">Security Alert : CVE-2025-61882</b> - Apply Patch 338523311:R12.CAC.B in hotpatch mode';
   l_col_rows(5)(l_rows) := '[3106344.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '38523302';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'For <b style="color: red;">Security Alert : CVE-2025-61882</b> - Apply Patch 38523302:R12.CAC.B in hotpatch mode';
   l_col_rows(5)(l_rows) := '[3106344.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '38500628';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'For <b style="color: red;">Security Alert : CVE-2025-61882</b> - Apply Patch 38500628:R12.XDO.B in hotpatch mode - Fix for Bug 38500628';
   l_col_rows(5)(l_rows) := '[3106344.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '38501757';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'For <b style="color: red;">Security Alert : CVE-2025-61882</b> - Apply Patch 38501757:R12.XDO.B in hotpatch mode - XDO DIAGNOSTIC PATCH';
   l_col_rows(5)(l_rows) := '[3106344.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37614922';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'For <b style="color: red;">Security Alert : CVE-2025-61884</b> - Apply Patch 37614922:R12.IES.B';
   l_col_rows(5)(l_rows) := '[3107176.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '38512809';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'For <b style="color: red;">Security Alert : CVE-2025-61884</b> - Apply Patch 38512809:R12.CZ.B';
   l_col_rows(5)(l_rows) := '[3107176.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'For <b style="color: red;">Security Alert : CVE-2025-61882</b> - Apply Patch 38507994:R12.TXK.C in hotpatch mode';
   l_col_rows(5)(l_rows) := '[3106344.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '38518258';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'For <b style="color: red;">Security Alert : CVE-2025-61882</b> - Apply Patch 38518258:R12.CAC.C in hotpatch mode';
   l_col_rows(5)(l_rows) := '[3106344.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'For <b style="color: red;">Security Alert : CVE-2025-61882</b> - Apply Patch 38523311:R12.CAC.C in hotpatch mode';
   l_col_rows(5)(l_rows) := '[3106344.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'For <b style="color: red;">Security Alert : CVE-2025-61882</b> - Apply Patch 38523302:R12.CAC.C in hotpatch mode';
   l_col_rows(5)(l_rows) := '[3106344.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'For <b style="color: red;">Security Alert : CVE-2025-61882</b> - For R12.ATG_PF.C.delta.13 or later, apply Patch 38500628:R12.XDO.C in hotpatch mode - Fix for Bug 38500628';
   l_col_rows(5)(l_rows) := '[3106344.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '38510732';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'For <b style="color: red;">Security Alert : CVE-2025-61882</b> - For R12.ATG_PF.C.delta.12 or earlier, apply Patch 38510732:R12.XDO.C in hotpatch mode - Fix for Bug 38510732';
   l_col_rows(5)(l_rows) := '[3106344.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'For <b style="color: red;">Security Alert : CVE-2025-61882</b> - Apply Patch 38501757:R12.XDO.C in hotpatch mode - XDO DIAGNOSTIC PATCH';
   l_col_rows(5)(l_rows) := '[3106344.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'For <b style="color: red;">Security Alert : CVE-2025-61884</b> - Apply Patch 37614922:R12.IES.C';
   l_col_rows(5)(l_rows) := '[3107176.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'For <b style="color: red;">Security Alert : CVE-2025-61884</b> - Apply Patch 38512809:R12.CZ.C';
   l_col_rows(5)(l_rows) := '[3107176.1]';

END IF;

   l_extra_info('##SHOW_SQL##'):= 'Y';
   l_extra_info('##STYLE##Name'):= ',#CC0000,,bold';

   l_sig.sigrepo_id := '32345';
   l_sig.title := 'Recommended EBS Security Alert CVE Mitigation Patches';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := 'You have recommended EBS Security Alert CVE Mitigation patch(es) not applied to this '||mask_text(g_apps_version, nvl( upper(''), 'NO_MASK') )||' instance '||mask_text(g_instance, nvl( upper(''), 'NO_MASK') )||'. Please expand the list above for the details.';
   l_sig.solution := 'Above are the recommended EBS Security Alert CVE Mitigation patches for E-Business Suite. <br> 
Please follow the patch installation instructions in the Docunment ID listed for any patch not applied in the table above.<br><br>
For the full list of current EBS Security Alert CVE Mitigation  recommendations, please review <a href="https://www.oracle.com/security-alerts/public-vuln-to-advisory-mapping.html" target="_blank">Map of CVE to Advisory/Alert</a>.<br><br>
...
<li>[10940175/KA580] Patch Wizard FAQ</li>
   ...
   l_sig.success_msg := 'Congratulations!  You have the latest EBS Security Alert CVE Mitigation patches applied for E-Business Suite.';
  ...
  -- Register
  l_step := '60';
  g_signatures('EBS_ATG_CT_SECURITY_ALERT_CVE_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'EBS_ATG_CT_SECURITY_ALERT_CVE_PATCHES',     -- sig ID
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/01/27 20:44:35 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'configurator_analyzer.sql';
...
IF p_include_apps_check IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Include Diagnostic Apps Check (Default is Y) is required.');
...
debug('begin add_signature: CZ1_CONFIGURATOR_BUILD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6731',
      p_sig_id                 => 'CZ1_CONFIGURATOR_BUILD',
      p_sig_sql                => 'SELECT VALUE from CZ_DB_SETTINGS WHERE SETTING_ID = ''FREEZE_REVISION''',
      p_title                  => 'Configurator Build',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Please review [131088/PALRT2478] - Oracle Configurator Patch Matrix to determine if you are running the latest Configurator Build.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CZ1_CONFIGURATOR_BUILD');



debug('begin add_signature: CZ1_BATCH_VALIDATION_BOM_URL');
   l_info('##MASK##USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7020',
      p_sig_id                 => 'CZ1_BATCH_VALIDATION_BOM_URL',
      p_sig_sql                => 'Select fpo.user_profile_option_name Profile_Name,
fpov.profile_option_id,
fpo.profile_option_name Prof_Name,
...
and upper(fpo.profile_option_name) = ''CZ_UIMGR_URL''
order by 1,3',
      p_title                  => 'Configurator URL of UI Manager',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The profile option BOM:Configurator URL of UI Manager indicates the Oracle Configurator Servlet URL, which is where the Oracle Configurator Servlet resides. This profile option must be set correctly for the host application to locate the Oracle Configurator Servlet.  ',
      p_solution               => 'The person installing Oracle Applications supplies this URL when running Oracle Rapid Install. Oracle Rapid Install uses this information as the default value for BOM:Configurator URL of UI Manager.',
      p_success_msg            => 'The value(s) returned will verify the setup of the profile BOM:Configurator URL of UI Manager at various levels.</br></br> Verify if this is the same value as seen in UIMANAGER URL string in the OM Debug Log gathered when encountering batch validation issues.  If the profile option is using Secure Socket Layer (https://) and you encounter a Batch Validation error you may have a Wallet setup issue. </br></br>Refer to [1584974/KB726708] - How to Troubleshoot Configuration Validation Resulted in Error(s) While Booking and run the anonymous SQL block under step C for more details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: CZ1_BATCH_VALIDATION_BOM_URL');



debug('begin add_signature: CZ1_BATCH_VALIDATION_TIMEOUT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6707',
      p_sig_id                 => 'CZ1_BATCH_VALIDATION_TIMEOUT',
      p_sig_sql                => 'SELECT VALUE FROM cz_db_settings where SETTING_ID = ''UtlHttpTransferTimeout''',
      p_title                  => 'Batch Validation Timeout Test',
      p_fail_condition         => '[VALUE] < [1000]',
      p_problem_descr          => 'The value of UtHttpTranserTimeout is set to a value less than 1000 seconds.  If you are experiencing Batch Validation errors, then the value may need to be increased.',
      p_solution               => 'See [358164/KB775716] - Configuration Validation Resulted In Error(s) While Booking for more details.',
      p_success_msg            => 'The value of UtHttpTranserTimeout is set to a value greater than 1000 seconds.  It is less likely that this is the source of batch validation issues.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: CZ1_BATCH_VALIDATION_TIMEOUT');



debug('begin add_signature: CZ1_FAIL_BV_IF_MODEL_PUBLICATION_CHANGED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8664',
      p_sig_id                 => 'CZ1_FAIL_BV_IF_MODEL_PUBLICATION_CHANGED',
...
AND e.profile_option_name IN (''CZ_BV_DELTA'')
AND  (a.level_id = 10001 )
AND a.profile_option_value = ''N''
ORDER BY e.profile_option_name,
         a.level_id DESC',
      p_title                  => 'Fail Batch Validation If Model Publication Has Changed',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Profile Option CZ: Fail BV if Configuration Changed is set to No.

After changes are made to a model and the model is republished, it is possible that users may complete a configuration and save the configuration without being alerted to the fact that the configuration is invalid. If the profile option is set to Y, then users will be alerted with a message like ''Configuration validation resulted in error(s). Configuration of ''ModelXXX'' is incomplete.''',
      p_solution               => 'See [2041206/KB710971] - Configuration Validation In OM Resulting In Order Lines Being Cancelled ',
      p_success_msg            => 'Profile Option CZ: Fail BV if Configuration Changed is set to Yes.

After changes are made to a model and the model is republished, then is users attempt to complete a configuration and save the configuration they will be alerted to the fact that the configuration is invalid with a message like ''Configuration validation resulted in error(s). Configuration of ''ModelXXX'' is incomplete.''

See [2041206/KB710971] - Configuration Validation In OM Resulting In Order Lines Being Cancelled ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: CZ1_FAIL_BV_IF_MODEL_PUBLICATION_CHANGED');



debug('begin add_signature: CZ1_MULTIPLE_PUBLICATION_SOURCES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5300',
      p_sig_id                 => 'CZ1_MULTIPLE_PUBLICATION_SOURCES',
      p_sig_sql                => 'SELECT DISTINCT(SERVER_ID) FROM CZ_MODEL_PUBLICATIONS WHERE DELETED_FLAG = 0 AND SYSDATE > APPLICABLE_FROM AND SYSDATE < APPLICABLE_UNTIL AND SOURCE_TARGET_FLAG = ''T'' GROUP BY SERVER_ID',
      p_title                  => 'Check Multiple Publication Sources',
      p_fail_condition         => 'RSGT1',
      p_problem_descr          => 'This checks to ensure that there are no models that have been published on a publication target from more than one publication source.  If there is more than one publication source, you will likely see errors.',
      p_solution               => 'This issue is described in [2103120/KB726894] - Post Clone Steps for an Oracle Configurator Instance.  Since this is a data issue, please log an SR with Oracle Support and provide this Analyzer output.',
      p_success_msg            => 'You have one publication source which is correct setup.',
   ...
   l_info.delete;
debug('end add_signature: CZ1_MULTIPLE_PUBLICATION_SOURCES');



debug('begin add_signature: CZ1_BOM_MULTIPLE_IMPORT_SOURCES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5301',
      p_sig_id                 => 'CZ1_BOM_MULTIPLE_IMPORT_SOURCES',
      p_sig_sql                => 'select count(*), source_server from cz_xfr_project_bills where deleted_flag = ''0'' group by source_server',
      p_title                  => 'Check Imported BOM Sources',
      p_fail_condition         => 'RSGT1',
      p_problem_descr          => 'This check verifies that only one server has been used to import Bill of Material data into Configurator developer. Multiple import sources may cause data corruptions during the BOM populate and refresh processes and is not supported by Configurator.',
      p_solution               => '[804838/KB772413] - Steps that can be taken when Import Server is cloned over after populating Configurator Data',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CZ1_BOM_MULTIPLE_IMPORT_SOURCES');



debug('begin add_signature: CZ1_CHECK_LOCAL_SERVER_DEFINITION_CHILD');
   l_info('##MASK##HOST_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8927',
      p_sig_id                 => 'CZ1_CHECK_LOCAL_SERVER_DEFINITION_CHILD',
      p_sig_sql                => 'SELECT HOST_NAME FROM V$Instance',
      p_title                  => 'Check Server Local Hostname',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This check verifies that the LOCAL record in the CZ_Servers table which represents this instance has the correct host name as defined in the V$Instance table.',
      p_solution               => 'Use the Hostname returned in the concurrent program Modify Server Definition to update the LOCAL record with the correct host name information.

More details can be found in the Oracle Configurator Implementation Guide.',
      p_success_msg            => 'Use the Hostname returned in the concurrent program Modify Server Definition to update the LOCAL record with the correct host name information.
...
More details can be found in the Oracle Configurator Implementation Guide.',
   ...
   l_info.delete;
debug('end add_signature: CZ1_CHECK_LOCAL_SERVER_DEFINITION_CHILD');



debug('begin add_signature: CZ1_CHECK_LOCAL_SERVER_DEFINITION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5299',
      p_sig_id                 => 'CZ1_CHECK_LOCAL_SERVER_DEFINITION',
      p_sig_sql                => 'SELECT COUNT(*) FROM CZ_SERVERS serv WHERE LOCAL_NAME = ''LOCAL'' AND HOSTNAME = (SELECT HOST_NAME FROM V$Instance WHERE HOST_NAME = serv.HOSTNAME)',
      p_title                  => 'Check Server Local Setup',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This check verifies that the LOCAL record in the CZ_Servers table which represents this instance has the correct host name as defined in the V$Instance table.',
      p_solution               => 'Refer to the output below and use the Hostname in the concurrent program Modify Server Definition to update the LOCAL record with the correct Hostname information.

More details can be found in the Oracle Configurator Implementation Guide.',
      p_success_msg            => 'The LOCAL row in the CZ_Servers table has the host name set as expected, and matches the V$Instance table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('CZ1_CHECK_LOCAL_SERVER_DEFINITION_CHILD'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '7'
      );
   l_info.delete;
debug('end add_signature: CZ1_CHECK_LOCAL_SERVER_DEFINITION');



debug('begin add_signature: CZ1_MULTIPLE_IMPORT_SOURCES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5298',
      p_sig_id                 => 'CZ1_MULTIPLE_IMPORT_SOURCES',
      p_sig_sql                => 'SELECT * FROM CZ_SERVERS WHERE IMPORT_ENABLED = 1',
      p_title                  => 'Multiple Import Sources',
      p_fail_condition         => 'RSGT1',
      p_problem_descr          => 'More than one import source server is defined for this instance. There should only be one record set as the source server for a Configurator Developer instance.',
      p_solution               => 'Using the concurrent program Modify Server Definition, please update so only the correct instance is set as the publication source. If more than one import source exists, there are likely to be refresh and publication errors.  Please refer to [2111854/KB735498] - 	CZ_IMP_SINGLE.IMPORTSINGLEBILL.XFRPROJECTS ORA-01403: no data found which shows the steps for running the Modify Server Definition Concurrent Program. ',
      p_success_msg            => 'There is just one import source server defined for this instance.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: CZ1_MULTIPLE_IMPORT_SOURCES');



debug('begin add_signature: CZ1_MULTIPLE_SOURCE_SERVERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5119',
      p_sig_id                 => 'CZ1_MULTIPLE_SOURCE_SERVERS',
      p_sig_sql                => 'SELECT * FROM CZ_SERVERS WHERE SOURCE_SERVER_FLAG = 1',
      p_title                  => 'Multiple Source Servers',
      p_fail_condition         => 'RSGT1',
      p_problem_descr          => 'There are currently more than one rows set as a source server in the CZ_Servers table. Configurator only supports a single source server per publication target.',
      p_solution               => 'Review the CZ_Servers table and verify that only one server is marked as the source for model publications. See [2103120/KB726894].',
      p_success_msg            => 'Source servers are correct.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: CZ1_MULTIPLE_SOURCE_SERVERS');



debug('begin add_signature: CZ1_DESCRIPTIONS_NOT_REFRESHED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8457',
      p_sig_id                 => 'CZ1_DESCRIPTIONS_NOT_REFRESHED',
      p_sig_sql                => 'SELECT order_seq, xfr_group, dst_field, noupdate FROM CZ_XFR_FIELDS WHERE order_seq = 4 AND dst_field IN (''DESC_TEXT'') AND NOUPDATE = (''1'')',
      p_title                  => 'Descriptions Not Updated After Model Refresh',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'When refreshing models the "Refresh Configuration Models" Concurrent Program completes normally and models can be seen in Oracle Configurator Developer (OCD) but the descriptions are not updated. The descriptions are different from those in the Bills of Material and inventory organization.  This is described in [1313696/KB760395] - Descriptions Not Getting Updated in Configurator When Using Refresh Model Option.',
      p_solution               => '[1313696/KB760395] - Descriptions Not Getting Updated in Configurator When Using Refresh Model Option.',
      p_success_msg            => 'Descriptions will be updated when refreshing a model.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CZ1_DESCRIPTIONS_NOT_REFRESHED');



debug('begin add_signature: CZ1_DUPLICATE_RECORDS_IN_CZ_MODEL_REF_EXPLS_TABLE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8458',
      p_sig_id                 => 'CZ1_DUPLICATE_RECORDS_IN_CZ_MODEL_REF_EXPLS_TABLE',
      p_sig_sql                => 'SELECT model_id,count(*) FROM CZ_MODEL_REF_EXPLS
WHERE parent_expl_node_id IS NULL
AND deleted_flag=0
group by model_id
having count(*) > 1',
      p_title                  => 'Refresh Fails Due To Duplicate Records in CZ_MODEL_REF_EXPLS table',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Occasionally when running the Refresh a Single Configuration Model Concurrent Program the following error will occur:  ORA-01422 EXACT FETCH RETURNS MORE THAN REQUESTED NUMBER OF ROWS.  This issue can happen after changes have been made to the Bill of Material.',
      p_solution               => '[404722/KB788313] Refresh Of A Single Configurator Model Not Working.',
      p_success_msg            => 'There are no Duplicate Records in CZ_MODEL_REF_EXPLS table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CZ1_DUPLICATE_RECORDS_IN_CZ_MODEL_REF_EXPLS_TABLE');



debug('begin add_signature: CZ1_DUPLICATE_CHILD_MODELS_DURING_REFRESH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8470',
      p_sig_id                 => 'CZ1_DUPLICATE_CHILD_MODELS_DURING_REFRESH',
      p_sig_sql                => 'select count(*) "Count" from cz_model_ref_expls e, cz_ps_nodes n
where e.deleted_flag = ''0'' and n.deleted_flag = ''0''
and model_id in (select devl_project_id from cz_devl_projects d where d.deleted_flag = ''0''
...
and e.referring_node_id = n.ps_node_id
and e.component_id <> n.reference_id',
      p_title                  => 'Refresh Creating Duplicate Child Models',
      p_fail_condition         => '[Count] > [0]',
      p_problem_descr          => 'The Refresh Model Concurrent Program is creating duplicates when multiple child copies are maintained.  This issue can happen when some of the child models are already existing in the CZ schema as a result of previous import or usage of model migration or model copy functionality.  ',
      p_solution               => 'Refer to [1354529/KB774497] Refresh Model creating duplicates when Multiple child copies are maintained.',
      p_success_msg            => 'There are no duplicate child models copied in the database.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CZ1_DUPLICATE_CHILD_MODELS_DURING_REFRESH');



debug('begin add_signature: CZ1_DUPLICATE_CHILD_MODELS_DURING_IMPORT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8610',
      p_sig_id                 => 'CZ1_DUPLICATE_CHILD_MODELS_DURING_IMPORT',
      p_sig_sql                => 'SELECT value FROM cz_db_settings WHERE setting_id =''DisableMultipleCopyImport''',
      p_title                  => 'Duplicate Child Models Will Be Create When Imported',
      p_fail_condition         => '[VALUE] =  [NO]',
      p_problem_descr          => 'DisableMultipleCopyImport is set to No.  When populating or refreshing a new model into the Oracle Configurator Developer, new copies of existing child models will be generated. If set to yes, then reference/child models will not be refreshed and Configurator will reuse existing models. 
',
      p_solution               => 'See [1354529/KB774497] - Refresh Model creating duplicates when Multiple child copies are maintained for a description of the DisableMultipleCopyImport setting found in the CZ_DB_SETTINGS table.  ',
      p_success_msg            => 'DisableMultipleCopyImport is set to Yes.  When populating or refreshing a new model into the Oracle Configurator Developer, reference/child models will not be generated and Configurator will reuse existing models.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: CZ1_DUPLICATE_CHILD_MODELS_DURING_IMPORT');
...
debug('begin add_signature: CZ1_CONFIGURATOR_DATABASE_SETTINGS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9945',
      p_sig_id                 => 'CZ1_CONFIGURATOR_DATABASE_SETTINGS',
      p_sig_sql                => 'SELECT * FROM CZ_DB_SETTINGS',
      p_title                  => 'Configurator Database Settings',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Gathering the CZ_DB_SETTINGS table output shows the various database settings used by Configurator. See the Oracle Configurator Implementation Guide for details.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: CZ1_CONFIGURATOR_DATABASE_SETTINGS');
...
debug('begin add_signature: BATCH_VALIDATION_CHECK_FAILED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12714',
      p_sig_id                 => 'BATCH_VALIDATION_CHECK_FAILED',
      p_sig_sql                => 'SELECT ''Batch Validation UTL_HTTP Request Check has Failed, Sales Order Booking Expected to Fail'' AS CHECKRESULT FROM DUAL',
      p_title                  => 'Batch Validation Check Failed',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This signature is defined in such a way that it always fails, but this check is performed as the condition on when the signature will be displayed. A test to verify that an UTL_HTTP request can reach your Configurator servlet from the database has failed. If this signature is displayed, it is expected that attempting to book orders through Oracle Order Management will similarly fail as this functionality relies on a similar UTL_HTTP request from the database to the Configurator servlet on the middle tier.',
      p_solution               => 'There are multiple setups that can be enabled in order to resolve this issue, which are documented through [458587/KB739335]. The first check should be to confirm that the value provided through the profile option BOM: Configurator URL of UI Manager is a valid address to your Configurator servlet. This can be validated by appending ?test=version to the URL and pasting it into your browser.

If this is an SSL enabled URL for the above profile option, it will be necessary to either define a non secure URL through the AltBatchValidateURL setting in CZ_DB_SETTINGS, or define a valid database wallet for the Configurator servlet. This issue can also be caused by network changes such as SSL certificate failures or failing to include the hostname for the middle tier in the database hostnames file. More investigation is warranted, please review [458587/KB739335] for a more detailed version of the script that generated this message as well as suggestions to troubleshoot and resolve this issue.',
      p_success_msg            => 'This message should never display.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BATCH_VALIDATION_CHECK_FAILED');
...
BEGIN
  ...
  analyzer_title := 'Configurator Analyzer';
...
debug('begin section: CZ1_ServersCheck');
start_section('Version Information', 'CZ1_ServersCheck');
   set_item_result(run_stored_sig('EBS_VERSION_19C'));
   set_item_result(run_stored_sig('CZ1_CONFIGURATOR_BUILD'));
end_section;
debug('end section: CZ1_ServersCheck');

debug('begin section: CZ1_BATCH_VALIDATION');
start_section('Batch Validation', 'CZ1_BATCH_VALIDATION');
   set_item_result(run_stored_sig('CZ1_BATCH_VALIDATION_BOM_URL'));
   set_item_result(run_stored_sig('CZ1_BATCH_VALIDATION_TIMEOUT'));
   set_item_result(run_stored_sig('CZ1_FAIL_BV_IF_MODEL_PUBLICATION_CHANGED'));
check_batch_validation;
   if not g_batch_validation_passed  then
      set_item_result(run_stored_sig('BATCH_VALIDATION_CHECK_FAILED'));
   end if;
end_section;
debug('end section: CZ1_BATCH_VALIDATION');

debug('begin section: CZ1_Repository_Checks');
start_section('Publish, Refresh and Populate Setup', 'CZ1_Repository_Checks');
   set_item_result(run_stored_sig('CZ1_MULTIPLE_PUBLICATION_SOURCES'));
   set_item_result(run_stored_sig('CZ1_BOM_MULTIPLE_IMPORT_SOURCES'));
   set_item_result(run_stored_sig('CZ1_CHECK_LOCAL_SERVER_DEFINITION'));
   set_item_result(run_stored_sig('CZ1_MULTIPLE_IMPORT_SOURCES'));
   set_item_result(run_stored_sig('CZ1_MULTIPLE_SOURCE_SERVERS'));
   set_item_result(run_stored_sig('CZ1_DESCRIPTIONS_NOT_REFRESHED'));
   set_item_result(run_stored_sig('CZ1_DUPLICATE_RECORDS_IN_CZ_MODEL_REF_EXPLS_TABLE'));
   set_item_result(run_stored_sig('CZ1_DUPLICATE_CHILD_MODELS_DURING_REFRESH'));
   set_item_result(run_stored_sig('CZ1_DUPLICATE_CHILD_MODELS_DURING_IMPORT'));
end_section;
debug('end section: CZ1_Repository_Checks');

debug('begin section: CZ1_PERFORMANCE');
start_section('Performance', 'CZ1_PERFORMANCE');
...
end_section;
debug('end section: CZ1_PERFORMANCE');
...
start_section('Critical Alerts', 'LifetimeSupportPolicy');
   ...
   set_item_result(check_rec_patches_1); /* Signature EBS_ATG_CT_SECURITY_ALERT_CVE_PATCHES */
...
debug('begin section: CZ_DB_SETTINGS');
start_section('Configurator Database Settings', 'CZ_DB_SETTINGS');
   set_item_result(run_stored_sig('CZ1_CONFIGURATOR_DATABASE_SETTINGS'));
end_section;
debug('end section: CZ_DB_SETTINGS');

debug('begin section: Diag_Apps_Check');
IF g_sql_tokens('##$$APPS_CHECK$$##') = 'Y' THEN
   start_section('Application Checks', 'Diag_Apps_Check');
