...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Sales Agreement Analyzer               |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE om_agreement_analyzer_pkg AUTHID DEFINER AS
...
CREATE OR REPLACE PACKAGE BODY om_agreement_analyzer_pkg AS
-- $Id: om_agreement_analyzer.sql, 200.39 2026/01/28 15:32:26 cschmehl Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2295096.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'ONTBLSO_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'ONTBLSO_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2295096.1#feedback");
...
-- page title
    ...
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1194,EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1194,EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1194,EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">1194</span>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1194,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1194,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1194,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
debug('begin populate parameters hash table');
   IF g_is_concurrent THEN 
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Agreement Number';
   ...
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_line_id,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  l_revision := rtrim(replace('$Revision: 200.39  $','$',''));
  l_revision := ltrim(replace(l_revision,'Revision:',''));
  l_date_char := rtrim(replace('$Date: 2026/01/28 15:32:25 $','$',''));
...
SELECT HEADER_ID
INTO l_exists_val
FROM OE_BLANKET_HEADERS_ALL H, HR_OPERATING_UNITS O, OE_TRANSACTION_TYPES_TL OT
...
EXCEPTION
   ...
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_line_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
...
debug('begin populate sql tokens hash table');
   ...
   g_masked_tokens('##$$ORDERNUMBER$$##') := mask_text( g_sql_tokens('##$$ORDERNUMBER$$##'), 'NO_MASK');
...
debug('begin add_signature: AGREEMENT_WF_NOTIFICATIONS');
   l_info('##MASK##TO_USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22145',
      p_sig_id                 => 'AGREEMENT_WF_NOTIFICATIONS',
...
where WFS.ITEM_TYPE          in (''OEOH'',''OENH'',''OEBH'')
 and  WFS.item_key           = to_char(##$$HEADERID$$##)
...
order by WFS.ITEM_KEY, 
         WFS.BEGIN_DATE, 
         EXECUTION_TIME',
      p_title                  => 'Workflow Agreement Notification Information (WFN)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Workflow Notifications for this agreement.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AGREEMENT_WF_NOTIFICATIONS');



debug('begin add_signature: AGREEMENT_HEADER_NO_WORKFLOW');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22146',
      p_sig_id                 => 'AGREEMENT_HEADER_NO_WORKFLOW',
      p_sig_sql                => 'select bla.org_id "Org ID",
     bla.order_number "Order Number",
     bla.header_id "Header ID",
     bla.flow_status_code "Flow Status",
     bla.creation_date "Creation Date",
     bla.order_type_id "Order Type ID",
     bla.order_category_code "Order Category",
     to_char(bla.header_id)  "Item Key"
from oe_blanket_headers_all bla
where bla.header_id = ##$$HEADERID$$##
and bla.open_flag = ''Y'' and nvl(bla.cancelled_flag, ''N'') = ''N''
and not exists(
              select 1 from wf_items itm
              where itm.item_type in (''OEOH'',''OENH'',''OEBH'')
              and itm.item_key = to_char(bla.header_id))',
      p_title                  => 'Agreement Header No Associated Workflow',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Open agreement header exist with no associated workflow.  Open header must have workflow in order for it to progress.',
      p_solution               => '<ul>
<li>Refer to [2226124/KB450158] Missing Order Header Or Order Line Workflows to progress lines in BOOKED status that are missing Workflow assignment / activity.
</li>
</ul>',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: AGREEMENT_HEADER_NO_WORKFLOW');



debug('begin add_signature: AGREEMENT_HEADER_WF_ACTIVITY_ORDER_ERROR');
   l_info('##MASK##ASSIGNED_USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22144',
      p_sig_id                 => 'AGREEMENT_HEADER_WF_ACTIVITY_ORDER_ERROR',
...
where 
  ...
  and  LKP.LOOKUP_TYPE = ''WFENG_STATUS''
  and  LKP.LOOKUP_CODE = WFS.ACTIVITY_STATUS
  and  WFI.PARENT_ITEM_TYPE in (''OEOH'',''OENH'',''OEBH'')
  and  WFI.PARENT_ITEM_KEY  = to_char(##$$HEADERID$$##)
  and  WFI.ITEM_TYPE in (select WFAE.ERROR_ITEM_TYPE
                         ...
                         where 
                                WFSE.ITEM_TYPE in (''OEOH'',''OENH'',''OEBH'')
                           and  WFSE.ITEM_KEY  = to_char(##$$HEADERID$$##)
  ...
  order by WFS.ITEM_KEY, WFS.BEGIN_DATE, EXECUTION_TIME',
      p_title                  => 'Workflow Activity Status for Agreement Error Process',
      p_fail_condition         => 'RSGT1',
      p_problem_descr          => 'Review Workflow Activity Status for Agreement Error Process.',
      p_solution               => '',
      p_success_msg            => 'No Agreement Workflow Activity Errors for this order.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AGREEMENT_HEADER_WF_ACTIVITY_ORDER_ERROR');



debug('begin add_signature: AGREEMENT_HEADER_WF_ORDER_LEVEL_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22143',
      p_sig_id                 => 'AGREEMENT_HEADER_WF_ORDER_LEVEL_ERRORS',
...
from WF_ITEM_ACTIVITY_STATUSES WFS,
     ...
     WF_LOOKUPS                LKP
where 
     WFS.ITEM_TYPE          in (''OEOH'',''OENH'',''OEBH'')
and  WFS.item_key           = to_char(##$$HEADERID$$##)
and  WFS.PROCESS_ACTIVITY   = WFP.INSTANCE_ID
and  WFP.PROCESS_ITEM_TYPE  = WFA.ITEM_TYPE
and  WFP.PROCESS_NAME       = WFA.NAME
...
order by WFS.ITEM_KEY, WFS.BEGIN_DATE, EXECUTION_TIME',
      p_title                  => 'Agreement Workflow Header Level Errors',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Review Agreement Workflow Header Level Errors for this agreement.',
      p_solution               => 'Run the "Retry Activities in Error" concurrent process.  Refer to [1951700/KB772399].  If issue is not resolved, a Data Fix bug will need to be logged.
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: AGREEMENT_HEADER_WF_ORDER_LEVEL_ERRORS');
...
order by "Line Number"',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Line(s) on this Agreement.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
...
debug('begin add_signature: AGREEMENT_HEADER_RELEASES');
  ...
  add_signature(
      ...
      p_sig_sql                => 'select 
BLE.START_DATE_ACTIVE "Start Date",       
BLE.END_DATE_ACTIVE "End Date",
...
BLE.START_DATE_ACTIVE "Start Date",       
BLE.END_DATE_ACTIVE "End Date",      
BLE.BLANKET_LINE_MAX_AMOUNT "Line Max",   
BLE.BLANKET_LINE_MIN_AMOUNT "Line Min",
...
Refer to [2067610/KB627422] for additional details.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
...
debug('begin add_signature: EBS_MFG_OM_ONT_ONTSO_BSA_WORKFLOW_NULL_NOTIFICATION_FROM_ROLE_ATTRIBUTE_VALUE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27683',
      p_sig_id                 => 'EBS_MFG_OM_ONT_ONTSO_BSA_WORKFLOW_NULL_NOTIFICATION_FROM_ROLE_ATTRIBUTE_VALUE',
      p_sig_sql                => 'SELECT
    text_value, item_key
FROM
    wf_item_attribute_values
WHERE
      name = ''NOTIFICATION_FROM_ROLE''
    AND item_type = ''OEBH''
    AND item_key = ##$$HEADERID$$## 
    AND text_value is Null',
      p_title                  => 'Blanket header workflow entity having null NOTIFICATION_FROM_ROLE attribute value',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The associated Blanket header workflow entity having no specified ''NOTIFICATION_FROM_ROLE'' attribute value. With no specification for the ''NOTIFICATION_FROM_ROLE'' for these associated Blanket headers the workflow is unable to identify a suitable contact role/person for the delivery of notifications.  

In this case the "Blanket Pre-Expiration Notification" is sent to the user with error "3120: Activity ''OEBH/XXXXX has no performer".',
      p_solution               => 'Refer to [1060972/KB706801]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_ONT_ONTSO_BSA_WORKFLOW_NULL_NOTIFICATION_FROM_ROLE_ATTRIBUTE_VALUE');



debug('begin add_signature: AGREEMENT_HEADER_APPROVALS');
   l_info('##MASK##CUSTOMER_SIGNATURE'):= 'DISPLAY_LAST_25_PCNT';
   l_info('##MASK##SUPPLIER_SIGNATURE'):= 'DISPLAY_LAST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7545',
...
Verify that the Agreement has a status of Active.  If Agreement is Active, then verify Approval setups by reviewing [363517/KB627501].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
...
debug('begin add_signature: AGREEMENT_HEADER_EXPIRED');
  ...
  add_signature(
     ...
     wias.error_message "Error Message",
     obha.order_number "Agreement Number",
     obha.expiration_date "Expiration Date",   
     obha.header_id "Agreement Header ID",
     obha.created_by "Agreement Created By",
     (SELECT end_date
        FROM fnd_user
       WHERE user_id = obha.created_by) "User End Date",
     obha.org_id "Org ID"
 ...
 AND obha.header_id = to_char(''##$$HEADERID$$##'')
 AND wias.activity_status = ''ERROR''
 AND wpa.activity_name = ''BLANKET_EXPIRED_NTF''
 AND trunc(obha.expiration_date) < trunc(sysdate)
 AND obha.flow_status_code= ''ACTIVE''',
      p_title                  => 'Agreement Header Expired But Workflow Is In Error',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Agreement Header has expired but Workflow activity is in Error',
      p_solution               => 'Refer to [2140916/KB793737]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
...
Review returned output to determine discrepancy, a Datafix may be required.  Refer to [2221988/KB626738]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
...
debug('begin add_signature: EBS_MFG_OM_ONT_ONTBLSO_ATTR_VAL_ON_ORD_DOES_NOT_MATCH_AGREEMENT_ATTR_VAL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27665',
      p_sig_id                 => 'EBS_MFG_OM_ONT_ONTBLSO_ATTR_VAL_ON_ORD_DOES_NOT_MATCH_AGREEMENT_ATTR_VAL',
      p_sig_sql                => 'SELECT
obha.order_number "Agreement Number",
obha.header_id "Agreement Header ID",
obla.line_number "Agreement Line Number",
obha.sold_to_org_id "Header Sold To Org Id",
obla.sold_to_org_id "Line Sold To Org Id"
FROM
oe_blanket_headers_all obha,
oe_blanket_lines_all obla
WHERE 
obha.header_id = obla.header_id
AND obha.HEADER_ID              = ##$$HEADERID$$##
AND NVL(''##$$LINEID$$##'',0) in (0,obla.LINE_ID)
AND nvl(obla.sold_to_org_id, - 9999) <> obha.sold_to_org_id',
      p_title                  => 'Attribute Value on Sales Agreement Line Does Not Match with Sales Agreement Header Attribute Value',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Attribute Value on Sales Agreement Line Does Not Match with Sales Agreement Header Attribute Value',
      p_solution               => 'Review [2052891/KB747892] for details.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_ONT_ONTBLSO_ATTR_VAL_ON_ORD_DOES_NOT_MATCH_AGREEMENT_ATTR_VAL');



debug('begin add_signature: EBS_MFG_OM_ONT_ONTBLSO_EXPIRED_AGREEMENT_STILL_IN_ACTIVE_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27674',
      p_sig_id                 => 'EBS_MFG_OM_ONT_ONTBLSO_EXPIRED_AGREEMENT_STILL_IN_ACTIVE_STATUS',
      p_sig_sql                => 'SELECT
obha.order_number "Agreement Number",
obha.header_id "Agreement Header ID",
obha.order_number "Order No",
NULL "Line Number"
FROM
oe_blanket_headers_all obha,
oe_order_headers_all ooh
WHERE
obha.flow_status_code = ''ACTIVE''
AND nvl(obha.expiration_date, sysdate + 1) < sysdate
AND ooh.blanket_number = obha.order_number
AND ooh.open_flag = ''Y''
AND obha.HEADER_ID = ##$$HEADERID$$##
union 
SELECT
obha.order_number "Agreement Number",
obha.header_id "Agreement Header ID",
ooh.order_number "Order No",
substr(to_char(ool.line_number) ||
decode(ool.shipment_number, null, null, ''.'' || to_char(ool.shipment_number))||
decode(ool.option_number, null, null, ''.'' || to_char(ool.option_number)) ||
decode(ool.component_number, null, null,
decode(ool.option_number, null, ''.'',null)||
''.''||to_char(ool.component_number))||decode(ool.service_number,null,null,
decode(ool.component_number, null, ''.'' , null) ||
decode(ool.option_number, null, ''.'', null ) ||
''.''|| to_char(ool.service_number)),1,10) "Line Number"
FROM
oe_order_lines_all ool,
oe_order_headers_all ooh,
oe_blanket_headers_all obha
WHERE
ool.blanket_number = obha.order_number
AND ool.open_flag = ''Y''
AND ooh.header_id = ool.header_id
AND obha.flow_status_code = ''ACTIVE''
AND nvl(obha.expiration_date, sysdate + 1) < sysdate
AND obha.HEADER_ID = ##$$HEADERID$$##',
      p_title                  => 'Expired Agreement is Still in Active Status ',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Sales Agreement is Expired, but status Is Active.',
      p_solution               => 'Review [1958390/KB783595] for details.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_ONT_ONTBLSO_EXPIRED_AGREEMENT_STILL_IN_ACTIVE_STATUS');
...
BEGIN
  ...
  analyzer_title := 'Sales Agreement Analyzer';
...
debug('begin section: Agreement_Header');
start_section('Header Information', 'Agreement_Header');
   ...
   set_item_result(run_stored_sig('AGREEMENT_WF_NOTIFICATIONS'));
   set_item_result(run_stored_sig('AGREEMENT_HEADER_NO_WORKFLOW'));
   set_item_result(run_stored_sig('AGREEMENT_HEADER_WF_ACTIVITY_ORDER_ERROR'));
   set_item_result(run_stored_sig('AGREEMENT_HEADER_WF_ORDER_LEVEL_ERRORS'));
...
end_section;
debug('end section: Agreement_Header');

debug('begin section: Agreement_Lines');
start_section('Line Information', 'Agreement_Lines');
...
end_section;
debug('end section: Agreement_Lines');
...
start_section('Agreement Validations', 'Validations');
   ...
   set_item_result(run_stored_sig('EBS_MFG_OM_ONT_ONTSO_BSA_WORKFLOW_NULL_NOTIFICATION_FROM_ROLE_ATTRIBUTE_VALUE'));
   ...
   set_item_result(run_stored_sig('EBS_MFG_OM_ONT_ONTBLSO_ATTR_VAL_ON_ORD_DOES_NOT_MATCH_AGREEMENT_ATTR_VAL'));
   set_item_result(run_stored_sig('EBS_MFG_OM_ONT_ONTBLSO_EXPIRED_AGREEMENT_STILL_IN_ACTIVE_STATUS'));
end_section;
