...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Advanced Pricing Analyzer              |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE qp_all_analyzer_pkg AUTHID DEFINER AS
...
PROCEDURE main
(            p_include_performance          IN VARCHAR2    DEFAULT 'Y'
           ,p_include_data_analysis        IN VARCHAR2    DEFAULT 'Y'
           ,p_include_security             IN VARCHAR2    DEFAULT 'N'
           ,p_include_bulk_loader          IN VARCHAR2    DEFAULT 'N'
...
END qp_all_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY qp_all_analyzer_pkg AS
-- $Id: qp_all_analyzer.sql, 200.27 2026/01/27 18:46:13 cschmehl Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2676826.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'QPALL_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'QPALL_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>QPALL Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2676826.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/qp_all_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,2615,EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,2615,EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},2615,EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4341408" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">2615</span>
...
<p>Version 200.27<br>
Template Changes (4.8.4)<br>
&nbsp; &nbsp;EBS KB Article IDs Shown for Signature KM Links<br>
<br>
Version 200.26<br>
Template Changes (4.8.3): View Confluence Page<br>
&nbsp; &nbsp; &nbsp;EBSAF-403 Patches links in analyzers output to CMOS</p><p>Version 200.25<br>
Template Changes (4.8.2):&nbsp;<br>
...
Signature AC_TABLE_INDEXES has been changed.<br>
&nbsp;</p><p>&nbsp;</p>
            <br><br>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,2615,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,2615,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},2615,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Include Performance Analysis Information (Default = Y)';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_include_performance,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Include Pricing Data Analysis (Default =Y)';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_include_data_analysis,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Include Pricing Security Details (Default = Y)';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_include_security,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Include Bulk Loader Information (Default =Y)';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_include_bulk_loader,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Include Apps Check Information (Default=Y)';
...
-- Revision and date values can be populated by RCS
  l_revision := rtrim(replace('$Revision: 200.27  $','$',''));
  l_revision := ltrim(replace(l_revision,'Revision:',''));
  l_date_char := rtrim(replace('$Date: 2026/01/27 18:46:12 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'qp_all_analyzer.sql';
...
debug('begin parameter validation: p_include_performance');
IF p_include_performance IS NOT NULL AND p_include_performance NOT IN ( 'N','Y') THEN
   print_error('INVALID ARGUMENT: Incorrect Include Performance Parameter. Value should be Y or N.');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_include_performance');

debug('begin parameter validation: p_include_data_analysis');
IF p_include_data_analysis IS NOT NULL AND p_include_data_analysis NOT IN ( 'N','Y') THEN
   print_error('INVALID ARGUMENT: Incorrect Include Pricing Data Analysis Parameter. Value should be Y or N.');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_include_data_analysis');

debug('begin parameter validation: p_include_security');
IF p_include_security IS NOT NULL AND p_include_security NOT IN ( 'N','Y') THEN
   print_error('INVALID ARGUMENT: Incorrect Include Pricing Security Parameter. Value should be Y or N.');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_include_security');

debug('begin parameter validation: p_include_bulk_loader');
IF p_include_bulk_loader IS NOT NULL AND p_include_bulk_loader NOT IN ( 'N','Y') THEN
   print_error('INVALID ARGUMENT: Incorrect Include Bulk Loader Information Parameter. Value should be Y or N.');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_include_bulk_loader');
...
SELECT MIN(to_number(value)) into l_degree
  FROM   v$parameter
...
print_log('g_degree = '||l_degree);

SELECT Count(*) cnt into l_blind
FROM   QP_LIST_LINES
WHERE  PRICING_PHASE_ID > 1
       AND QUALIFICATION_IND = 0;

g_blind := l_blind;

print_log('g_blind = '||l_blind);
...
debug('begin populate sql tokens hash table');
   ...
   g_sql_tokens('##$$PERFORMANCE_ANALYSIS$$##') := p_include_performance;
   g_masked_tokens('##$$PERFORMANCE_ANALYSIS$$##') := mask_text( g_sql_tokens('##$$PERFORMANCE_ANALYSIS$$##'), 'NO_MASK');
   g_sql_tokens('##$$PRICING_SECURITY$$##') := p_include_security;
   g_masked_tokens('##$$PRICING_SECURITY$$##') := mask_text( g_sql_tokens('##$$PRICING_SECURITY$$##'), 'NO_MASK');
   g_sql_tokens('##$$PRICE_LIST_BULK_LOADER$$##') := p_include_bulk_loader;
   g_masked_tokens('##$$PRICE_LIST_BULK_LOADER$$##') := mask_text( g_sql_tokens('##$$PRICE_LIST_BULK_LOADER$$##'), 'NO_MASK');
   g_sql_tokens('##$$PRICING_DATA_ANALYSIS$$##') := p_include_data_analysis;
   g_masked_tokens('##$$PRICING_DATA_ANALYSIS$$##') := mask_text( g_sql_tokens('##$$PRICING_DATA_ANALYSIS$$##'), 'NO_MASK');
   g_sql_tokens('##$$MAX_ROWS$$##') := p_max_output_rows;
   g_masked_tokens('##$$MAX_ROWS$$##') := mask_text( g_sql_tokens('##$$MAX_ROWS$$##'), 'NO_MASK');
...
debug('begin add_signature: PRICING_ENGINE_VERSION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14010',
      p_sig_id                 => 'PRICING_ENGINE_VERSION',
      p_sig_sql                => 'SELECT TEXT
FROM   DBA_SOURCE
WHERE  OWNER IN (SELECT ORACLE_USERNAME
                 FROM   FND_ORACLE_USERID
                 WHERE  READ_ONLY_FLAG = ''U'')
       AND LINE = 2
       AND NAME = ''QP_PREQ_GRP''',
      p_title                  => 'Pricing Engine Version',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No values are shown.',
      p_solution               => 'Ensure username = apps has access to tables DBA_SOURCE and FND_ORACLE_USERID.',
      p_success_msg            => 'No actions needed.',
   ...
   l_info.delete;
debug('end add_signature: PRICING_ENGINE_VERSION');



debug('begin add_signature: PRICING_BASIC_OR_ADVANCED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14012',
      p_sig_id                 => 'PRICING_BASIC_OR_ADVANCED',
      p_sig_sql                => 'SELECT decode(STATUS, ''I'', ''Advanced Pricing'',
                      ''S'', ''Basic Pricing'',
                      ''N'', '' Not Installed'') "Installation Status"
FROM   FND_PRODUCT_INSTALLATIONS
WHERE  APPLICATION_ID = 661',
      p_title                  => 'Basic Pricing or Advanced Pricing',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No records are present.',
      p_solution               => 'No actions needed.  ',
      p_success_msg            => 'This data is for understanding the data distribution with analysis.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_BASIC_OR_ADVANCED');



debug('begin add_signature: PRICING_ENGINE_TYPE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14011',
      p_sig_id                 => 'PRICING_ENGINE_TYPE',
      p_sig_sql                => 'SELECT Nvl(Decode(a.PROFILE_OPTION_VALUE, ''B'', ''Pattern Search Engine'',
                                          ''M'', ''Pattern Search Engine'',
                                          ''P'', ''Pattern Search Engine'',
                                          ''Traditional Search Engine''),
              ''Traditional Search Engine'') "Type"
FROM   FND_PROFILE_OPTION_VALUES a,
       FND_PROFILE_OPTIONS e
WHERE  e.PROFILE_OPTION_ID = a.PROFILE_OPTION_ID(+)
       AND e.PROFILE_OPTION_NAME = ''QP_PATTERN_SEARCH''',
      p_title                  => 'Pricing Search Engine Type',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No search engine is found.',
      p_solution               => 'No actions needed. One will default to using the traditional pricing search engine.',
      p_success_msg            => 'Provides type of search engine used by Pricing.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_ENGINE_TYPE');



debug('begin add_signature: PRICING_ROUNDING_PROFILES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14316',
      p_sig_id                 => 'PRICING_ROUNDING_PROFILES',
      p_sig_sql                => 'SELECT
    fpot.user_profile_option_name "Profile Name",
    fpov.profile_option_value "Value",
    DECODE(fpov.level_id,
      10001,''Site'',
      10002,''Application'',
      10003,''Responsibility'',
      10004,''User'') "Set at Level",
    DECODE( fpov.level_id,
      10002,fat.application_name,
      10003,fr.responsibility_name,
      10004,rpad(substr(fu.user_name, 1, ceil(length(fu.user_name)*0.25) ),length(fu.user_name), ''*'')) "Level Value"
FROM
    ...
    fnd_user fu
WHERE
    fpo.profile_option_name in (''ONT_UNIT_PRICE_PRECISION_TYPE'', 
                                ''QP_UNIT_PRICE_PRECISION_TYPE'', 
                                ''QP_SELLING_PRICE_ROUNDING_OPTIONS'', 
                                ''QP_PRICE_ROUNDING'')
...
ORDER
    by 1, fpov.level_id, 4',
      p_title                  => 'Pricing Rounding Profiles',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no values set for pricing rounding profile options.',
      p_solution               => 'No records were returned. Records should be returned regarding pricing rounding profile options. </br>|
Please log a service request with Oracle Support - Advanced Pricing to report this issue. </br>
Upload a copy of this analyzer''s output to the service request. </br>',
      p_success_msg            => 'Values are shown for the pricing rounding profile options.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_ROUNDING_PROFILES');



debug('begin add_signature: PRICING_EVENT_PHASES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14015',
      p_sig_id                 => 'PRICING_EVENT_PHASES',
      p_sig_sql                => 'SELECT PRICING_EVENT_CODE "Event",
       PRICING_PHASE_ID   "Phase",
       START_DATE_ACTIVE  "Start Date",
       END_DATE_ACTIVE    "End Date",
       SEARCH_FLAG        "Search Flag",
       USER_SEARCH_FLAG   "User Search Flag",
       SEEDED_FLAG        "Seeded Flag"
FROM   QP_EVENT_PHASES
order by PRICING_EVENT_CODE, PRICING_PHASE_ID',
      p_title                  => 'Event Phase Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No pricing phases are found.',
      p_solution               => 'No pricing phases are present. 
',
      p_success_msg            => 'Data shows the event phase details.<br><br>
No actions needed. Data is used when doing detailed performance analysis by Support and/or Development.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_EVENT_PHASES');



debug('begin add_signature: PRICING_PHASES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14016',
      p_sig_id                 => 'PRICING_PHASES',
      p_sig_sql                => 'SELECT PRICING_PHASE_ID           "Phase",
       NAME                       "Name",
       FREEZE_OVERRIDE_FLAG       "Freeze - Seeded",
       USER_FREEZE_OVERRIDE_FLAG  "Freeze - User",
       INCOMPAT_RESOLVE_CODE      "Incomp Res - Seeded",
       USER_INCOMPAT_RESOLVE_CODE "Incomp Res - User",
       LINE_GROUP_EXISTS          "Line Group Exists",
       OID_EXISTS                 "OID Exists",
       RLTD_EXISTS                "RLTD Exists",
       FREIGHT_EXISTS             "Freight Exists"
FROM   QP_PRICING_PHASES
ORDER BY PRICING_PHASE_ID',
      p_title                  => 'All Pricing Phases',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No records are present.',
      p_solution               => 'No actions needed.',
      p_success_msg            => 'This data is for understanding the data distribution with analysis.',
   ...
   l_info.delete;
debug('end add_signature: PRICING_PHASES');



debug('begin add_signature: PRICING_INTERCOMPANY_PHASES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14018',
      p_sig_id                 => 'PRICING_INTERCOMPANY_PHASES',
      p_sig_sql                => 'SELECT pp.NAME                      "Phase",
       e.PRICING_EVENT_CODE         "Event",
       e.START_DATE_ACTIVE          "Start Date",
       e.END_DATE_ACTIVE            "End Date",
       e.SEARCH_FLAG                "Search",
       Nvl(e.USER_SEARCH_FLAG, ''Y'') "Usearch",
       e.SEEDED_FLAG                "Seeded"
FROM   QP_EVENT_PHASES e,
       QP_PRICING_PHASES pp
WHERE  e.PRICING_EVENT_CODE = ''ICBATCH''
       AND e.PRICING_PHASE_ID = pp.PRICING_PHASE_ID
ORDER  BY 1,
          2',
      p_title                  => 'Intercompany Processing Pricing Phases',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No intercompany pricing phase(s) records found.',
      p_solution               => 'Review [782177/KB626102#INTCOM_Event_Phase], Section E - Troubleshooting pricing issues in intercompany invoicing ',
      p_success_msg            => 'Data is validated; The intercompany pricing phase is setup correctly.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_INTERCOMPANY_PHASES');



debug('begin add_signature: DBSTAT1_FND_STATS_VERSION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4204',
      p_sig_id                 => 'DBSTAT1_FND_STATS_VERSION',
      p_sig_sql                => 'select distinct ltrim(text) "FND_STATS Version" from dba_source where name = ''FND_STATS'' and line=2',
      p_title                  => 'FND_STATS Version',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There was a problem identifying the FND_STATS version.',
      p_solution               => 'Make sure the FND_STATS package exists.<br>
If not, run AFSTATSS.pls and AFSTATSB.pls to create the FND_STATS Package.
<br><br>
For more details, please review [419728/KB627293] - How To Gather Statistics On Oracle Applications Release 11i and/or Release 12',
      p_success_msg            => 'The FND_STATS package exists as expected!<br><br>
Oracle E-Business Suite Best Practices for Gathering Optimizer Statistics is to use the Gather Statistics concurrent program which calls the FND_STATS package.<br>
FND_STATS is a wrapper around the DBMS_STATS package and provides several PL/SQL procedures for gathering statistics at the table, schema, or database level. The FND_STATS package also supports histograms, table exclusions and the new database 11G features such as extended stats, incremental stats gathering for partitioned tables and concurrent stats gathering.

For more details, please review : 
[419728/KB627293] - How To Gather Statistics On Oracle Applications Release 11i and/or Release 12
[1586374/KB859100] - Best Practices for Gathering Statistics with Oracle E-Business Suite ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: DBSTAT1_FND_STATS_VERSION');



debug('begin add_signature: DBSTAT1_GET_PREFS_OF_DATABASE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7713',
      p_sig_id                 => 'DBSTAT1_GET_PREFS_OF_DATABASE',
      p_sig_sql                => 'select
...
decode (dbms_stats.get_prefs(''INCREMENTAL''), ''FALSE'',0,1) +
decode (dbms_stats.get_prefs(''CONCURRENT''), ''OFF'',0,1) +
decode (dbms_stats.get_prefs(''DEGREE''), ''NULL'',0,1) +
decode (dbms_stats.get_prefs(''ESTIMATE_PERCENT''), ''DBMS_STATS.AUTO_SAMPLE_SIZE'',0,1) "ALL"
from dual',
      p_title                  => 'Display Database Level Preferences',
      p_fail_condition         => '[ALL]!=[0]',
      p_problem_descr          => 'SQL did not return FALSE , OFF , NULL and DBMS_STATS.AUTO_SAMPLE_SIZE . Other values are not recommended.',
      p_solution               => 'Make sure database version is 10G and above.<br><br>

To correct run following command :

   exec DBMS_STATS.RESET_GLOBAL_PREF_DEFAULTS();

For more details, please review : [419728/KB627293] - How To Gather Statistics On Oracle Applications Release 11i and/or Release 12.',
      p_success_msg            => 'Following values are expected from the script : <br>
<br>
FALSE  FALSE  NULL  DBMS_STATS.AUTO_SAMPLE_SIZE<br><b>
For more details, please review : [419728/KB627293] - How To Gather Statistics On Oracle Applications Release 11i and/or Release 12.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: DBSTAT1_GET_PREFS_OF_DATABASE');



debug('begin add_signature: DBSTAT1_10_PERCENT_MODIFIED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4208',
      p_sig_id                 => 'DBSTAT1_10_PERCENT_MODIFIED',
      p_sig_sql                => 'select 
table_owner,
    ''<NSG_table_''||rownum||''>''||table_name "TABLE_NAME",
    partition_name,
    "Number of DMLs",
     "Total Number of Rows", "LAST UPDATED"
    from (    
SELECT dtm.table_owner, dtm.table_name , dtm.partition_name,
to_char(NVL(dtm.inserts,0)+NVL(dtm.updates,0)+NVL(dtm.deletes,0),''999,999,999,999'') "Number of DMLs",
to_char(NVL(dt.num_rows,0),''999,999,999,999'') "Total Number of Rows",
dt.LAST_ANALYZED ||'' (''||round(sysdate-dt.LAST_ANALYZED,0)||'' Days ago)'' "LAST UPDATED"
FROM sys.dba_tab_modifications dtm, sys.dba_tables dt, fnd_oracle_userid ui
WHERE dt.owner =dtm.table_owner
and dt.owner=ui.oracle_username
AND dt.table_name=dtm.table_name
AND dt.table_name not like ''DR$%''
AND dt.table_name not like ''DR#%''
AND dt.temporary <> ''Y''
AND   ( dt.iot_type <> ''IOT_OVERFLOW''  OR dt.iot_type IS NULL   )
AND NOT EXISTS
                        (SELECT NULL
...
AND (NVL(dtm.inserts,0)+NVL(dtm.updates,0)+NVL(dtm.deletes,0) > 10*(NVL(dt.num_rows,0)/100))
AND NVL(dt.num_rows,0) > 1000
ORDER BY "Number of DMLs" desc
)',
      p_title                  => 'Tables With More Than 10% Modifications',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Rows are found when identifying Tables with more than 10% of modifications. Only tables with more than 1000 rows are listed.',
      p_solution               => '- It is highly suggested to gather fresh statistics on the tables listed for signature Tables With More Than 10% Modifications in Section Database Overview of the Database Performance and Statistics analyzer. <br>
- Run either "Gather Table Statistics" or "Gather Schema Statistics" program. <br>
Please refer to [1586374/KB859100] Best Practices for Gathering Statistics with Oracle E-Business Suite.
',
      p_success_msg            => 'There are no tables with stale statistics.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: DBSTAT1_10_PERCENT_MODIFIED');



debug('begin add_signature: DBSTAT1_GSS');
   l_info('##MASK##USER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4210',
      p_sig_id                 => 'DBSTAT1_GSS',
      p_sig_sql                => 'select r.REQUEST_ID, u.user_name, p.USER_CONCURRENT_PROGRAM_NAME "PROGRAM", decode(c.CONCURRENT_PROGRAM_NAME, ''FNDGACST'', ''Deprecated'',''FNDGCLST'',''Deprecated'',''OK'') "VALID",
DECODE(r.STATUS_CODE, ''A'',''Waiting'',''B'',''B=Resuming'',''C'',''C=Normal'',
''D'',''D=Cancelled'',''E'',''E=Error'',''G'',''G=Warning'',
''H'',''H=On Hold'',''I'',''I=Normal'',''M'',''M=No Manager'', ''P'',''P=Scheduled'',''Q'',''Q=Standby'',''R'',''R=Normal'',
''S'',''S=Suspended'',''T'',''T=Terminating'',''U'',''U=Disabled'',
''W'',''W=Paused'',''X'',''X=Terminated'',''Z'',''Z=Waiting'') "STATUS",
DECODE(r.PHASE_CODE,
''C'',''Completed'',''I'',''I=Inactive'',''P'',''P=Pending'',''R'',''R=Running'') "PHASE",
to_char(r.ACTUAL_START_DATE, ''DD-MON-YYYY HH:MM:SS'')"START_TIME",to_char(r.ACTUAL_COMPLETION_DATE, ''DD-MON-YYYY HH:MM:SS'') "FINISH_TIME",
ROUND((r.actual_completion_date - r.actual_start_date)*1440, 2) "TOOK", FLOOR(((r.actual_completion_date-r.actual_start_date)*24*60*60)/3600)||'':hrs
''||
FLOOR((((r.actual_completion_date-r.actual_start_date)*24*60*60)-FLOOR(((r.actual_completion_date-r.actual_start_date)*24*60*60)/3600)*3600)/60)|
|'':Mins ''||
ROUND((((r.actual_completion_date-r.actual_start_date)*24*60*60)-FLOOR(((r.actual_completion_date-r.actual_start_date)*24*60*60)/3600)*3600-(FLOOR((((r.actual_completion_date-r.actual_start_date)*24*60*60)-FLOOR(((r.actual_completion_date-r.actual_start_date)*24*60*60)/3600)*3600)/60)*60)))||'':Secs'' "TIME",
r.ARGUMENT_TEXT, r.logfile_name || ''@'' || r.logfile_node_name "LOGFILE"
FROM fnd_concurrent_requests r, FND_CONCURRENT_PROGRAMS_TL p, fnd_concurrent_programs c, fnd_user u WHERE r.CONCURRENT_PROGRAM_ID = p.CONCURRENT_PROGRAM_ID and r.requested_by = u.user_id and p.CONCURRENT_PROGRAM_ID = c.CONCURRENT_PROGRAM_ID and c.CONCURRENT_PROGRAM_NAME in
(''FNDGACST'',''FNDGCLST'',''FNDGSCST'',''FNDGTST'')
AND p.LANGUAGE = ''US''
and r.ACTUAL_COMPLETION_DATE is not null order by r.ACTUAL_START_DATE desc',
      p_title                  => 'Last Gather Schema Statistics (GSS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No rows found when identifying the latest Gather Schema Statistics (GSS).',
      p_solution               => 'Please schedule a concurrent request to run Gather Schema Statistics.<br><br>

Currently using a degree of '||mask_text(g_degree, nvl( upper(''), 'NO_MASK') )||'.<br><br>

Oracle E-Business Suite Release 12 uses cost-based optimization in order to choose the most efficient execution plan for SQL statements. Using this approach, the optimizer determines the most optimal execution plan by costing available access paths and factoring information based on statistics for the schema objects accessed by the SQL statement.<br><br>

Oracle E-Business Suite requires several database initialization parameters to be set correctly in order to ensure optimal performance. Refer to My Oracle Support Knowledge [11158187/KA1002], and ensure that you have configured the parameters according to this note.<br><br>

For the query optimizer to produce an optimal execution plan, the statistics in the data dictionary should accurately reflect the volume and data distribution of the tables and indexes. To this end, database statistics should be refreshed periodically. However, that does not necessarily imply that you should gather statistics frequently. Systems that are close to going live typically experience inserts of a large amount of data, as data from legacy systems is migrated. In that scenario, the statistics would probably need to be refreshed quite frequently (for instance, after each major load), as large loads could change the data distribution significantly. Once the system reaches steady state, the frequency of statistics collection at the schema/database level should be reduced to something like once a month. However, statistics on some volatile tables can be gathered as frequently as required.<br><br>

Oracle E-Business Suite provides a set of procedures in the FND_STATS package to facilitate collection of these statistics. FND_STATS uses the DBMS_STATS package to gather statistics.<br><br>

<strong>Warning: You should not run DBMS_STATS directly.</strong><br><br>
...
FND_STATS.GATHER_SCHEMA_STATS uses a parameter called OPTIONS. If set to GATHER AUTO, this option allows FND_STATS to determine automatically the tables for which statistics should be gathered, based on the change threshold. The Modifications Threshold can be adjusted by the user by passing a value for modpercent, which by default is equal to 10. GATHER AUTO uses a database feature called Table Monitoring, which needs to be enabled for all the tables. A procedure called ENABLE_SCHEMA_MONITORING has been provided to enable monitoring on all tables for a given schema or all Applications schemas.',
      p_success_msg            => 'Gather Schema Statistics is being run as expected, using a degree of '||mask_text(g_degree, nvl( upper(''), 'NO_MASK') )||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: DBSTAT1_GSS');



debug('begin add_signature: DBSTAT1_CBO_STATS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5725',
      p_sig_id                 => 'DBSTAT1_CBO_STATS',
      p_sig_sql                => 'SELECT
   owner  ,  
''<div align="right">''||to_char(SUM(tlann),''999,999,999,999'')||''</div>'' "Tables CBO Stats",
''<div align="right">''||to_char(SUM(taa),''999,999,999,999'')||''</div>'' "Avg CBO Stats Age (days)",
''<div align="right">''||to_char(SUM(tlan),''999,999,999,999'')||''</div>'' "Tables without CBO Stats",
''<div align="right">''||to_char(SUM(ilann),''999,999,999,999'')||''</div>'' "Indexes with CBO Stats",
''<div align="right">''||to_char(SUM(iaa),''999,999,999,999'')||''</div>'' "Ind Avg CBO Stats Age (days)",
''<div align="right">''||to_char(SUM(ilan),''999,999,999,999'')||''</div>'' "Indexes without CBO Stats"
FROM (
   SELECT owner, COUNT(last_analyzed) tlann, ROUND(AVG(SYSDATE - 
last_analyzed)) taa, SUM(DECODE(last_analyzed, NULL, 1, 0)) tlan,
        0 ilann, 0 iaa, 0 ilan
   FROM dba_tables
   GROUP BY owner
     UNION ALL
   SELECT owner, 0 tlann, 0 taa, 0 tlan, COUNT(last_analyzed) ilann, 
ROUND(AVG(SYSDATE - last_analyzed)) iaa,
       SUM(DECODE(last_analyzed, NULL, 1, 0)) ilan
   FROM dba_indexes
   GROUP BY owner
) temp
GROUP BY owner
ORDER BY "Avg CBO Stats Age (days)" desc',
      p_title                  => 'CBO Statistics Age per Schema Owner',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No rows found when identifying CBO Statistics Age per Schema Owner.',
      p_solution               => '<strong>bde_last_analyzed.sql</strong> is available from Note [163208/KB730278], and verifies the CBO statistics in the data dictionary for all tables, indexes, and partitions. It also validates the statistics on tables and indexes owned by ''SYS''. <br>Due to CBO use of statistics to generate optimal execution plans, verifying that CBO stats are current is the first step to troubleshoot an overall performance issue.<br><br>

If some modules have not been analyzed or they are stale, then use FND_STATS package for e-Business Suite database schemas.<br><br>

For more information, please review Troubleshooting Oracle Applications Performance Issues [169935/KB711566].',
      p_success_msg            => 'List of CBO Statistics Age per Schema Owner<br><br>
<strong>bde_last_analyzed.sql</strong> is available from Note [163208/KB730278], and verifies the CBO statistics in the data dictionary for all tables, indexes, and partitions. It also validates the statistics on tables and indexes owned by ''SYS''. <br>Due to CBO use of statistics to generate optimal execution plans, verifying that CBO stats are current is the first step to troubleshoot an overall performance issue.<br><br>
...
For more information, please review Troubleshooting Oracle Applications Performance Issues [169935/KB711566].',
   ...
   l_info.delete;
debug('end add_signature: DBSTAT1_CBO_STATS');



debug('begin add_signature: INVICI_DB_REL_TOOLS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6759',
      p_sig_id                 => 'INVICI_DB_REL_TOOLS',
      p_sig_sql                => 'SELECT ''Hostname = '' || HOST_NAME "Details" FROM V$INSTANCE
UNION
SELECT ''Platform = ''
  ||SUBSTR(REPLACE(REPLACE(PCV1.PRODUCT, ''TNS for ''), '':'' )
  ||PCV2.STATUS, 1, 80)
...
AND ROWNUM = 1
UNION
SELECT ''Instance Name = '' ||  ''   ''||  sys_context(''USERENV'',''DB_NAME'') "Instance" from v$instance
UNION
SELECT '||mask_text(g_DBbanner, nvl( upper(''), 'NO_MASK') )||' db_version from v$version where rownum = 1
UNION
SELECT ''Language = ''
  ||VALUE
...
FROM V$DATABASE',
      p_title                  => 'Database, Release and Tools Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This information is used to identify the instance where the analyzer script was executed and provide details on the configuration, database identification name, database version, current language and OS platform among others.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: INVICI_DB_REL_TOOLS');



debug('begin add_signature: PRICING_DBASE_SIZES_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14005',
      p_sig_id                 => 'PRICING_DBASE_SIZES_CHECK',
      p_sig_sql                => 'SELECT NAME,
       Substr(VALUE, 1, 30) "Value"
FROM   V$PARAMETER
WHERE  NAME IN ( ''db_block_buffers'', ''db_block_size'', ''shared_pool_size'',
                 ''cpu_count'',
                 ''_optimizer_autostats_job'', ''optimizer_adaptive_features'' )',
      p_title                  => 'Database Parameter Check',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No records are present.',
      p_solution               => 'No actions needed.',
      p_success_msg            => 'Informational. Data is for internal use with analysis.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_DBASE_SIZES_CHECK');



debug('begin add_signature: PRICING_TOP5_HIGH_LOAD_STATEMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14007',
      p_sig_id                 => 'PRICING_TOP5_HIGH_LOAD_STATEMENTS',
      p_sig_sql                => 'SELECT ROWNUM AS rank, a.*
...
WHERE  ROWNUM < 11',
      p_title                  => 'Top 10 Most Expensive SQL (Buffer Gets)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No records are present.',
      p_solution               => 'No actions needed. ',
      p_success_msg            => 'Informational. For use with analysis.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_TOP5_HIGH_LOAD_STATEMENTS');



debug('begin add_signature: PRICING_TEMP_TABLESPACE_PARAMS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14006',
      p_sig_id                 => 'PRICING_TEMP_TABLESPACE_PARAMS',
      p_sig_sql                => 'SELECT TABLESPACE_NAME,
       INITIAL_EXTENT,
       NEXT_EXTENT,
       LOGGING,
       EXTENT_MANAGEMENT
...
WHERE  TABLESPACE_NAME IN (SELECT TEMPORARY_TABLESPACE
                           FROM   DBA_USERS
                           WHERE  USERNAME = QP_UTIL.get_schema)',
      p_title                  => 'Pricing Temporary Tablespace Parameters',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Details about pricing temporary tablespace parameters.',
      p_solution               => 'Records should be returned regarding temporary tablespace parameters. </br>
Please log a service request with Oracle Support - Advanced Pricing to report this issue. </br>
Upload a copy of this analyzer''s output to the service request. </br>',
      p_success_msg            => 'This data provides temporary tablespace parameter details. 
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_TEMP_TABLESPACE_PARAMS');



debug('begin add_signature: PRICING_ALL_DEBUG_VALUES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14009',
      p_sig_id                 => 'PRICING_ALL_DEBUG_VALUES',
      p_sig_sql                => 'SELECT fpot.user_profile_option_name "Profile Name",
       decode(fpo.profile_option_name, 
         ''QP_DEBUG'',        (SELECT meaning FROM qp_lookups  WHERE lookup_type = ''QP_REQUEST_VIEWER_OPTIONS'' AND lookup_code = fpov.profile_option_value),
         ''INV_DEBUG_TRACE'', (SELECT meaning FROM mfg_lookups WHERE lookup_type = ''SYS_YES_NO'' AND lookup_code = fpov.profile_option_value),
         ''WSH_DEBUG_MODE'',  (SELECT meaning FROM wsh_lookups WHERE lookup_type = ''WSH_DEBUG_ENABLED'' AND lookup_code = fpov.profile_option_value),
         ''MRP_DEBUG'',       (SELECT meaning FROM fnd_lookups WHERE lookup_type = ''YES_NO'' AND lookup_code = fpov.profile_option_value),
         ''POR_DEBUG'',       (SELECT meaning FROM fnd_lookups WHERE lookup_type = ''YES_NO'' AND lookup_code = fpov.profile_option_value),
         ''RCV_DEBUG_MODE'',  (SELECT meaning FROM fnd_lookups WHERE lookup_type = ''YES_NO'' AND lookup_code = fpov.profile_option_value),
         fpov.profile_option_value) "Value",
       decode(fpov.level_id, 10001, ''Site'',
                             10002, ''Application'',
                             10003, ''Responsibility'',
                             10004, ''User'') "Set at Level",
       decode(fpov.level_id, 10002, fat.application_name,
                             10003, fr.responsibility_name,
                             10004,rpad(substr(fu.user_name, 1, ceil(length(fu.user_name)*0.25) ),length(fu.user_name), ''*'')) "Level Value"
FROM   fnd_profile_options_tl fpot,
       ...
       fnd_user fu
WHERE  
       fpo.profile_option_name IN ( ''ONT_DEBUG_LEVEL'', 
                                    ''QP_DEBUG'',
                                    ''POR_DEBUG'',
                                    ''WSH_DEBUG_MODE'',
                                    ''MRP_DEBUG'', ''MSC_ATP_DEBUG'',
                                    ''RCV_DEBUG_MODE'',
                                    ''INV_DEBUG_TRACE'',
                                    ''INV_DEBUG_LEVEL'' )
       AND fpo.profile_option_name = fpot.profile_option_name
...
ORDER  BY 1, fpov.level_id, 4',
      p_title                  => 'Pricing Debug Setting on All Levels',
      p_fail_condition         => '[Level Value] is not null',
      p_problem_descr          => 'Pricing Debug Settings are shown for all levels.',
      p_solution               => 'Debug profiles being enabled can impact performance. <br>
If possible, one should disable these profile options.  Refer to: [1335892/KB713607] - How to Improve Pricing Performance anchor Other_Debug_Profiles',
      p_success_msg            => 'Debug profiles being enabled can impact performance. <br>
If possible, one should disable these profile options.  Refer to: [1335892/KB713607] - How to Improve Pricing Performance anchor Other_Debug_Profiles',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_ALL_DEBUG_VALUES');



debug('begin add_signature: PRICING_INSTALL_OR_UPGRADE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14013',
      p_sig_id                 => 'PRICING_INSTALL_OR_UPGRADE',
      p_sig_sql                => 'SELECT Count(*)
FROM   QP_DISCOUNT_MAPPING',
      p_title                  => 'Count of Upgraded Records',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Count of upgraded records.',
      p_solution               => 'No action needed. This table stores mapping information between the obsolete Order Entry pricing tables and the new pricing tables. It is used for upgrade purposes. ',
      p_success_msg            => 'The QP_DISCOUNT_MAPPING table stores mapping information between the obsolete Order Entry pricing tables and the new pricing tables. It is used for upgrade purposes. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_INSTALL_OR_UPGRADE');



debug('begin add_signature: PRICING_LIST_HEADERS_BY_ACTIVE_LIST_TYPE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14067',
      p_sig_id                 => 'PRICING_LIST_HEADERS_BY_ACTIVE_LIST_TYPE',
      p_sig_sql                => 'SELECT LIST_TYPE_CODE,
       ACTIVE_FLAG "ACTIVE",
       Count(*)
FROM   QP_LIST_HEADERS_B
GROUP  BY ACTIVE_FLAG,
          LIST_TYPE_CODE',
      p_title                  => 'Count of Pricing List Headers by Type',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Count of Pricing List Headers by Type',
      p_solution               => 'No solution needed. This is for internal use with analysis.',
      p_success_msg            => 'Data is validated.  Count of Pricing List Headers by Type needed for analysis.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_LIST_HEADERS_BY_ACTIVE_LIST_TYPE');



debug('begin add_signature: PRICING_LIST_HEADERS_BY_ASK_FOR_FLAG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14068',
      p_sig_id                 => 'PRICING_LIST_HEADERS_BY_ASK_FOR_FLAG',
      p_sig_sql                => 'SELECT LIST_TYPE_CODE,
       ACTIVE_FLAG "ACTIVE",
       ASK_FOR_FLAG,
       Count(*)
...
GROUP  BY ACTIVE_FLAG,
          ...
          LIST_TYPE_CODE
ORDER BY 1,2,3',
      p_title                  => 'Count of Pricing List Headers by Ask For Flag',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Count of price list header records by ask-for flag.',
      p_solution               => 'There are no price List Header records by ask for flag.',
      p_success_msg            => 'There are no price List Header records by ask for flag.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_LIST_HEADERS_BY_ASK_FOR_FLAG');



debug('begin add_signature: PRICING_COUNT_EXPIRED_ENTITIES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14069',
      p_sig_id                 => 'PRICING_COUNT_EXPIRED_ENTITIES',
      p_sig_sql                => 'SELECT LIST_TYPE_CODE,
       Count(*)
FROM   QP_LIST_HEADERS_B
WHERE  ACTIVE_FLAG = ''Y''
...
ORDER BY 1',
      p_title                  => 'Count of Expired Active List Headers',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Count of expired active list headers ',
      p_solution               => 'Even though these entities are expired, they still impact performance since they are active the pricing engine has to evaluate its data to determine it is expired. <br>
If possible, one should inactivate these pricing entities. <br>
Refer to: [1335892/KB713607#Expired_Pricing_Entities] - How to Improve Pricing Performance anchor Expired_Pricing_Entities 
',
      p_success_msg            => 'Data is validated; No expired pricing entities are present. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_COUNT_EXPIRED_ENTITIES');



debug('begin add_signature: PRICING_LIST_LINES_BY_QUAL_IND_AND_TYPE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14071',
      p_sig_id                 => 'PRICING_LIST_LINES_BY_QUAL_IND_AND_TYPE',
      p_sig_sql                => 'SELECT LIST_LINE_TYPE_CODE,
       QUALIFICATION_IND,
       PRICING_PHASE_ID "Phase",
       Count(*)
FROM   QP_LIST_LINES
GROUP  BY LIST_LINE_TYPE_CODE,
          QUALIFICATION_IND,
          PRICING_PHASE_ID
ORDER BY 1,2,3',
      p_title                  => 'List Line Distribution by Type, Qual, Phase',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'List line distributions count by type, qualification index and phase. ',
      p_solution               => 'No actions needed. This is to understand data distribution with analysis.',
      p_success_msg            => 'List line distributions count by type, qualification index and phase. <br><br>
...
No actions needed. Data is used when doing detailed performance analysis by Support and/or Development.',
   ...
   l_info.delete;
debug('end add_signature: PRICING_LIST_LINES_BY_QUAL_IND_AND_TYPE');



debug('begin add_signature: PRICING_LIST_LINES_COUNT_BY_LEVEL_AND_TYPE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14072',
      p_sig_id                 => 'PRICING_LIST_LINES_COUNT_BY_LEVEL_AND_TYPE',
      p_sig_sql                => 'SELECT MODIFIER_LEVEL_CODE,
       LIST_LINE_TYPE_CODE,
       Count(*)
FROM   QP_LIST_LINES
GROUP  BY MODIFIER_LEVEL_CODE,
          LIST_LINE_TYPE_CODE
ORDER BY 1,2',
      p_title                  => 'List Line Distribution by Modifier Level Code, List Line Type',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'List line distribution by modifier level code, list line type',
      p_solution               => 'One has Line Group, Header level modifiers which need more processing time since they require all of the order lines to be sent to the pricing engine.
',
      p_success_msg            => 'List line distribution by modifier level code, list line type.<br><br>
One has Line Group, Header level modifiers which need more processing time since they require all of the order lines to be sent to the pricing engine.<br><br>
No actions needed. Data is used when doing detailed performance analysis by Support and/or Development.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_LIST_LINES_COUNT_BY_LEVEL_AND_TYPE');



debug('begin add_signature: PRICING_LIST_LINES_COUNT_BY_LEVEL_AND_INCOMPATIBILITIY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14073',
      p_sig_id                 => 'PRICING_LIST_LINES_COUNT_BY_LEVEL_AND_INCOMPATIBILITIY',
      p_sig_sql                => 'SELECT LIST_LINE_TYPE_CODE,
...
GROUP  BY LIST_LINE_TYPE_CODE,
          INCOMPATIBILITY_GRP_CODE
ORDER BY 1,2',
      p_title                  => 'List Lines By Incompatibility Code',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Records are shown.',
      p_solution               => 'This data is for use with analysis.',
      p_success_msg            => 'No actions needed.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_LIST_LINES_COUNT_BY_LEVEL_AND_INCOMPATIBILITIY');



debug('begin add_signature: PRICING_ATTRIBUTES_COUNT_BY_PHASE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14074',
      p_sig_id                 => 'PRICING_ATTRIBUTES_COUNT_BY_PHASE',
      p_sig_sql                => 'SELECT PRICING_PHASE_ID "Phase",
       Count(*)
FROM   QP_PRICING_ATTRIBUTES
GROUP  BY PRICING_PHASE_ID
ORDER BY 1',
      p_title                  => 'Pricing Attributes Grouping by Phase',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Pricing Attributes Grouping by Phase ',
      p_solution               => 'No pricing attributes are present.',
      p_success_msg            => 'This query identifies which cursors are getting executed.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_ATTRIBUTES_COUNT_BY_PHASE');



debug('begin add_signature: PRICING_ATTRIBUTE_COUNT_DISTINCT_PHASES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14075',
      p_sig_id                 => 'PRICING_ATTRIBUTE_COUNT_DISTINCT_PHASES',
      p_sig_sql                => 'SELECT PRICING_PHASE_ID          "Phase",
       PRICING_ATTRIBUTE_CONTEXT "Pr Context",
       PRICING_ATTRIBUTE,
       Count(*)
FROM   QP_PRICING_ATTRIBUTES
GROUP  BY PRICING_PHASE_ID,
          ...
          PRICING_ATTRIBUTE
ORDER BY 1,2,3',
      p_title                  => 'Distinct Pricing Attributes per Phase',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Count of distinct pricing attributes grouped by phase ',
      p_solution               => 'This data is for internal use with analysis.',
      p_success_msg            => 'No actions needed. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_ATTRIBUTE_COUNT_DISTINCT_PHASES');



debug('begin add_signature: PRICING_QUALIFIER_COUNT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14076',
      p_sig_id                 => 'PRICING_QUALIFIER_COUNT',
      p_sig_sql                => 'SELECT Count(*)
FROM   QP_QUALIFIERS',
      p_title                  => 'Qualifier Total Count',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Qualifier Total Count',
      p_solution               => 'This is for understanding the data distribution during analysis.',
      p_success_msg            => 'No actions needed. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_QUALIFIER_COUNT');



debug('begin add_signature: PRICING_QUALIFIERS_COUNT_BY_DISTINCT_CONTEXT_AND_ATTRIBUTE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14077',
      p_sig_id                 => 'PRICING_QUALIFIERS_COUNT_BY_DISTINCT_CONTEXT_AND_ATTRIBUTE',
      p_sig_sql                => 'SELECT QUALIFIER_CONTEXT,
       QUALIFIER_ATTRIBUTE,
       Count(*)
FROM   QP_QUALIFIERS
GROUP  BY QUALIFIER_CONTEXT,
          QUALIFIER_ATTRIBUTE
ORDER BY 1,2',
      p_title                  => 'Distinct Qualifiers',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Distinct Qualifiers',
      p_solution               => 'No actions needed. ',
      p_success_msg            => 'The count of distinct qualifiers is to understand data distribution. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_QUALIFIERS_COUNT_BY_DISTINCT_CONTEXT_AND_ATTRIBUTE');



debug('begin add_signature: PRICING_QUALIFIERS_HIGHEST_NON_SELECTIVE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14082',
      p_sig_id                 => 'PRICING_QUALIFIERS_HIGHEST_NON_SELECTIVE',
      p_sig_sql                => 'SELECT QUALIFIER_CONTEXT,
       QUALIFIER_ATTRIBUTE,
...
HAVING Count(*) > 50
ORDER BY 1,2,3,4',
      p_title                  => 'Highest Non-Selective Qualifiers',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Data for understanding selectivity of qualifiers with a count greater than 50.  No rows returned shows selectivity of all qualifiers is less than 50.',
      p_solution               => 'This should be considered while evaluating performance issues. ',
      p_success_msg            => 'No actions needed. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_QUALIFIERS_HIGHEST_NON_SELECTIVE');



debug('begin add_signature: PRICING_QUALIFIERS_COUNT_BY_CUSTOMER_AND_SITE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14078',
      p_sig_id                 => 'PRICING_QUALIFIERS_COUNT_BY_CUSTOMER_AND_SITE',
      p_sig_sql                => 'SELECT Count(*)
FROM   QP_QUALIFIERS a
WHERE  a.QUALIFIER_CONTEXT = ''CUSTOMER''
       AND a.QUALIFIER_ATTRIBUTE = ''QUALIFIER_ATTRIBUTE2''
       AND EXISTS (SELECT ''x''
                   FROM   QP_QUALIFIERS b
                   WHERE  b.LIST_HEADER_ID = a.LIST_HEADER_ID
                          AND Nvl(b.LIST_LINE_ID, 1) = Nvl(a.LIST_LINE_ID, 1)
                          AND b.QUALIFIER_GROUPING_NO = a.QUALIFIER_GROUPING_NO
                          AND b.QUALIFIER_CONTEXT = ''CUSTOMER''
                          AND QUALIFIER_ATTRIBUTE = ''QUALIFIER_ATTRIBUTE5'')',
      p_title                  => 'Qualifiers with Customer and Customer Site in the Same Group',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'These redundant qualifiers are another enemy of performance.',
      p_solution               => 'Performance of the Pricing engine can be boosted by avoiding qualifiers that are redundant. <br>
Here is an example of a redundant qualifier:<br>
Customer = XYZ AND Customer Site = ABC<br>
<br>
For purposes of the Pricing engine selecting the proper price list or modifiers, <br>
customer site is sufficiently specific to act as a qualifier, <br> 
as it is more specific than customer.  Adding customer qualifier causes the <br>
Pricing Engine to evaluate the customer condition unnecessarily.  <br>
Eliminating such redundant qualifiers will act to speed the Pricing engine on its way.<br>',
      p_success_msg            => 'No actions needed.
...
',
   ...
   l_info.delete;
debug('end add_signature: PRICING_QUALIFIERS_COUNT_BY_CUSTOMER_AND_SITE');



debug('begin add_signature: PRICING_COUNT_MODIFIERS_WITH_ONLY_PRICE_LIST_QUALIFIER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14079',
      p_sig_id                 => 'PRICING_COUNT_MODIFIERS_WITH_ONLY_PRICE_LIST_QUALIFIER',
      p_sig_sql                => 'SELECT Count(*)
FROM   QP_QUALIFIERS a,
       QP_LIST_HEADERS_B qlh
WHERE  a.LIST_HEADER_ID = qlh.LIST_HEADER_ID
       AND qlh.LIST_TYPE_CODE NOT IN ( ''PRL'', ''AGR'' )
       AND a.QUALIFIER_CONTEXT = ''MODLIST''
       AND a.QUALIFIER_ATTRIBUTE = ''QUALIFIER_ATTRIBUTE4''
       AND NOT EXISTS (SELECT ''x''
                       FROM   QP_QUALIFIERS b
                       WHERE  b.LIST_HEADER_ID = a.LIST_HEADER_ID
                              AND Nvl(b.LIST_LINE_ID, 1) =
                                  Nvl(a.LIST_LINE_ID, 1)
                              AND b.QUALIFIER_ID <> a.QUALIFIER_ID)',
      p_title                  => 'Modifiers with Price List as the Only Qualifier',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Modifiers which have only one qualifier and that qualifier is for the price list. ',
      p_solution               => 'No actions needed. This data is for internal use with analysis.',
      p_success_msg            => 'Modifiers which have only one qualifier and that qualifier is for the price list.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_COUNT_MODIFIERS_WITH_ONLY_PRICE_LIST_QUALIFIER');



debug('begin add_signature: PRICING_QUALIFIERS_COUNT_LINE_LEVEL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14080',
      p_sig_id                 => 'PRICING_QUALIFIERS_COUNT_LINE_LEVEL',
      p_sig_sql                => 'SELECT Count(*)
FROM   QP_QUALIFIERS
WHERE  LIST_LINE_ID <> -1',
      p_title                  => 'Line Level Qualifiers',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Line Level Qualifiers count for instance.  ',
      p_solution               => 'No actions needed. Data is used when doing detailed performance analysis by Support and/or Development.',
      p_success_msg            => 'Line Level Qualifiers count for instance.  <br><br>
No actions needed.  Data is used when doing detailed performance analysis by Support and/or Development.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_QUALIFIERS_COUNT_LINE_LEVEL');



debug('begin add_signature: PRICING_QUALIFIERS_COUNT_QUALIFIER_GROUP_NOT_NEG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14175',
      p_sig_id                 => 'PRICING_QUALIFIERS_COUNT_QUALIFIER_GROUP_NOT_NEG',
      p_sig_sql                => 'SELECT Count(*)
FROM   QP_QUALIFIERS
WHERE  QUALIFIER_GROUPING_NO <> -1',
      p_title                  => 'Count of Qualifiers Not in Grouping Number -1',
      p_fail_condition         => 'RSGT1',
      p_problem_descr          => 'One has Qualifiers that are not in Grouping Number -1.',
      p_solution               => 'No actions are needed.',
      p_success_msg            => 'One has qualifiers assigned that are not in grouping number = -1. No actions needed.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_QUALIFIERS_COUNT_QUALIFIER_GROUP_NOT_NEG');



debug('begin add_signature: PRICING_QUALIFIERS_COUNT_BY_OPERATOR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14081',
      p_sig_id                 => 'PRICING_QUALIFIERS_COUNT_BY_OPERATOR',
      p_sig_sql                => 'SELECT Count(*),
       COMPARISON_OPERATOR_CODE
FROM   QP_QUALIFIERS
GROUP  BY COMPARISON_OPERATOR_CODE',
      p_title                  => 'Qualifiers Grouped by Operator',
      p_fail_condition         => 'RSGT1',
      p_problem_descr          => 'Qualifiers with One or More Operators',
      p_solution               => 'Please note that pricing engine will take additional processing time to evaluate NOT= operator in qualifiers. <br>
If you have a very high volume of setup data then it is recommended that you use caution when implementing this operator.
',
      p_success_msg            => 'No actions needed.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_QUALIFIERS_COUNT_BY_OPERATOR');



debug('begin add_signature: PRICING_QUALIFIERS_NON_SELECTIVE_WITH_SEARCH_IND1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14083',
      p_sig_id                 => 'PRICING_QUALIFIERS_NON_SELECTIVE_WITH_SEARCH_IND1',
      p_sig_sql                => 'SELECT Max(DISTINCT_ROW_COUNT)
FROM   QP_QUALIFIERS
WHERE  SEARCH_IND = 1',
      p_title                  => 'Non-Selective Qualifiers with Search Ind = 1',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No non-selective qualifier records are present.  ',
      p_solution               => 'No actions needed.  Data is used when doing detailed performance analysis by Support and/or Development.',
      p_success_msg            => 'Non-selective qualifiers are present.  Pricing performance can occur using search patterns in qualifiers.<br><br>
...
No actions needed.  Data is used when doing detailed performance analysis by Support and/or Development.',
   ...
   l_info.delete;
debug('end add_signature: PRICING_QUALIFIERS_NON_SELECTIVE_WITH_SEARCH_IND1');



debug('begin add_signature: PRICING_QUALIFIERS_COUNT_DISTINCT_ATTR_VALUE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14084',
      p_sig_id                 => 'PRICING_QUALIFIERS_COUNT_DISTINCT_ATTR_VALUE',
      p_sig_sql                => 'SELECT Count(DISTINCT QUALIFIER_ATTR_VALUE)
FROM   QP_QUALIFIERS',
      p_title                  => 'Count of Distinct Qualifiers',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Count of Distinct Qualifiers',
      p_solution               => 'No actions needed. Data collected to understand customers data distribution.

',
      p_success_msg            => 'Count of Distinct Qualifiers.<br><br>
No actions needed. Data collected is to understand customers data distribution.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_QUALIFIERS_COUNT_DISTINCT_ATTR_VALUE');



debug('begin add_signature: PRICING_MANUAL_ORDER_ADJUSTMENTS_COUNT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14103',
      p_sig_id                 => 'PRICING_MANUAL_ORDER_ADJUSTMENTS_COUNT',
      p_sig_sql                => 'SELECT AUTOMATIC_FLAG,
       Count(*)
FROM   OE_PRICE_ADJUSTMENTS
GROUP  BY AUTOMATIC_FLAG',
      p_title                  => 'Number of Manual Price Adjustments',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Number of manual price adjustments.',
      p_solution               => 'No actions needed.  This is to understand data distribution with analysis.',
      p_success_msg            => 'Number of manual price adjustments.<br><br>
No actions needed. Data is used when doing detailed performance analysis by Support and/or Development.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_MANUAL_ORDER_ADJUSTMENTS_COUNT');



debug('begin add_signature: PRICING_RLTD_MODIFIERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14090',
      p_sig_id                 => 'PRICING_RLTD_MODIFIERS',
      p_sig_sql                => 'SELECT RLTD_MODIFIER_GRP_TYPE,
       Count(*)
FROM   QP_RLTD_MODIFIERS
GROUP  BY RLTD_MODIFIER_GRP_TYPE',
      p_title                  => 'Count of PRICING_RLTD_MODIFIERS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No records are present.',
      p_solution               => 'No actions needed. ',
      p_success_msg            => 'Informational. Table QP_RLTD_MODIFIERS stores the relationship between modifier lines.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_RLTD_MODIFIERS');



debug('begin add_signature: PRICING_PRODUCT_ATTRIBUTES_SELECTIVITY_GREATER100');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14085',
      p_sig_id                 => 'PRICING_PRODUCT_ATTRIBUTES_SELECTIVITY_GREATER100',
      p_sig_sql                => 'SELECT PRICING_PHASE_ID   "Phase",
       PRODUCT_ATTRIBUTE  "Prod Type",
       PRODUCT_ATTR_VALUE "Prod Value",
       Count(*)
FROM   QP_PRICING_ATTRIBUTES
GROUP  BY PRICING_PHASE_ID,
          PRODUCT_ATTRIBUTE,
...
HAVING Count(*) > 100
ORDER BY 1,2,3',
      p_title                  => 'Product Attribute Selectivity > 100',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Product Attribute Selectivity > 100 ',
      p_solution               => 'No actions needed. This query gathered data to understand customers data distribution. <br>
It has no impact on performance.',
      p_success_msg            => 'Product Attribute Selectivity > 100 .<br><br>
No actions needed. This query gathered data to understand customers data distribution. <br>',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_PRODUCT_ATTRIBUTES_SELECTIVITY_GREATER100');



debug('begin add_signature: PRICING_ATTRIBUTES_SELECTIVITY_GREATER100');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14086',
      p_sig_id                 => 'PRICING_ATTRIBUTES_SELECTIVITY_GREATER100',
      p_sig_sql                => 'SELECT PRICING_PHASE_ID          "Phase",
       PRODUCT_ATTRIBUTE         "Prod Type",
       PRODUCT_ATTR_VALUE        "Prod Value",
       PRICING_ATTRIBUTE_CONTEXT "Pr Context",
       PRICING_ATTRIBUTE         "Pr Attr",
       PRICING_ATTR_VALUE_FROM   "Pr Attr Value",
       Count(*)
FROM   QP_PRICING_ATTRIBUTES
GROUP  BY PRICING_PHASE_ID,
          PRODUCT_ATTRIBUTE,
...
ORDER BY 1,2,3,4,5,6',
      p_title                  => 'Pricing Attribute Selectivity > 100',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Records to consider with performance analysis.',
      p_solution               => 'For internal use with analysis.',
      p_success_msg            => 'No action needed. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_ATTRIBUTES_SELECTIVITY_GREATER100');



debug('begin add_signature: PRICING_COUNT_DISTINCT_PRICING_ATTRIBUTES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14087',
      p_sig_id                 => 'PRICING_COUNT_DISTINCT_PRICING_ATTRIBUTES',
      p_sig_sql                => 'SELECT Count(DISTINCT PRICING_ATTR_VALUE_FROM) "Distinct Count Pr Attr Value"
FROM   QP_PRICING_ATTRIBUTES',
      p_title                  => 'Distinct Pricing Attribute Values',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Distinct pricing attribute values are present.',
      p_solution               => 'This data is for internal use with analysis.',
      p_success_msg            => 'No actions needed. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_COUNT_DISTINCT_PRICING_ATTRIBUTES');



debug('begin add_signature: PRICING_COUNT_FORMULAS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14088',
      p_sig_id                 => 'PRICING_COUNT_FORMULAS',
      p_sig_sql                => 'SELECT Count(*) Formula_Headers
FROM   QP_PRICE_FORMULAS',
      p_title                  => 'Count of Formulas',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Formula count.',
      p_solution               => 'This is to understand the data distribution during analysis.',
      p_success_msg            => 'No actions needed. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_COUNT_FORMULAS');



debug('begin add_signature: PRICING_COUNT_FORMULA_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14089',
      p_sig_id                 => 'PRICING_COUNT_FORMULA_LINES',
      p_sig_sql                => 'SELECT PRICE_FORMULA_LINE_TYPE_CODE,
       Count(*)
FROM   QP_PRICE_FORMULA_LINES
GROUP  BY PRICE_FORMULA_LINE_TYPE_CODE',
      p_title                  => 'Count of Formula Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No records are present.',
      p_solution               => 'No actions needed. ',
      p_success_msg            => 'This is for understanding the data distribution during analysis.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_COUNT_FORMULA_LINES');



debug('begin add_signature: PRICING_SALES_ORDER_COUNT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14100',
      p_sig_id                 => 'PRICING_SALES_ORDER_COUNT',
      p_sig_sql                => 'SELECT to_char((SELECT count(*) FROM oe_order_headers_all), ''999,999,999,999'') "Number of Orders",
       to_char((SELECT count(*) FROM oe_order_lines_all), ''999,999,999,999'') "Number of Lines",
       to_char((SELECT count(*) FROM oe_price_adjustments), ''999,999,999,999'') "Number of Price Adjustments"
FROM sys.dual',
      p_title                  => 'Number of Orders, Order Lines, Price Adjustments',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Number of Orders, Order Lines, Price Adjustments.',
      p_solution               => 'No actions needed. Query shows number of Orders, Order Lines, Price Adjustments',
      p_success_msg            => 'Number of Orders, Order Lines, Price Adjustments.<br><br>
No actions needed. Data is used when doing detailed performance analysis by Support and/or Development.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_SALES_ORDER_COUNT');



debug('begin add_signature: PRICING_MODIFIERS_COUNT_BY_AUTO_FLAG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14097',
      p_sig_id                 => 'PRICING_MODIFIERS_COUNT_BY_AUTO_FLAG',
      p_sig_sql                => 'SELECT AUTOMATIC_FLAG,
       Count(*)
FROM   QP_LIST_LINES
WHERE  LIST_LINE_TYPE_CODE IN ( ''DIS'', ''SUR'' )
GROUP  BY AUTOMATIC_FLAG',
      p_title                  => 'Count Modifiers Grouped by Automatic Flag',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Count of modifiers grouped by automatic flag.',
      p_solution               => 'No actions needed. This is to understand data distribution when doing detailed performance analysis.',
      p_success_msg            => 'Count of modifiers grouped by automatic flag.<br><br>
No actions needed. This information is to understand data distribution when doing detailed performance analysis.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_MODIFIERS_COUNT_BY_AUTO_FLAG');



debug('begin add_signature: PRICING_BLIND_MODIFIERS_SAMPLE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14099',
      p_sig_id                 => 'PRICING_BLIND_MODIFIERS_SAMPLE',
      p_sig_sql                => 'SELECT DISTINCT a.LIST_HEADER_ID,
                DESCRIPTION,
                NAME
...
WHERE  b.LIST_HEADER_ID = a.LIST_HEADER_ID
       ...
       AND ROWNUM < ##$$MAX_ROWS$$##
ORDER BY 1,2',
      p_title                  => 'Active Blind Modifiers',
      p_fail_condition         => 'RSGT1',
      p_problem_descr          => 'Blind modifiers exist. These records can hinder performance.',
      p_solution               => 'Count of Blind Modifiers: '||mask_text(g_blind, nvl( upper(''), 'NO_MASK') )||' <br><br>
To display more names of these modifiers set this report''s parameter "Maximum Rows to Display :" to the same value (or higher) than the count and then re-run this report. <br><br>
To improve performance, please refer to the solution provided in <br>
[435422/KB771044] : How to Identify Blind Modifiers and Make Changes to Setup for Improving Performance 
',
      p_success_msg            => 'No blind modifiers are present. ',
   ...
   l_info.delete;
debug('end add_signature: PRICING_BLIND_MODIFIERS_SAMPLE');



debug('begin add_signature: PRICING_TEMP_TABLES_INDEXES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14065',
      p_sig_id                 => 'PRICING_TEMP_TABLES_INDEXES',
      p_sig_sql                => 'SELECT TABLE_NAME,
       INDEX_NAME,
       COLUMN_NAME
FROM   ALL_IND_COLUMNS
WHERE  TABLE_OWNER = QP_UTIL.get_schema
       AND TABLE_NAME LIKE ''QP_PREQ%''
ORDER  BY 1,
          2,
          COLUMN_POSITION',
      p_title                  => 'Indexes on Temp Table(s)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No records are present.',
      p_solution               => 'No actions needed.',
      p_success_msg            => 'This data is to understand index(s) in place.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_TEMP_TABLES_INDEXES');



debug('begin add_signature: PRICING_COUNT_ ADVANCED_MODIFIERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14091',
      p_sig_id                 => 'PRICING_COUNT_ ADVANCED_MODIFIERS',
      p_sig_sql                => 'SELECT Count(*) "Active adv modlist count "
FROM   QP_LIST_HEADERS_B lh
WHERE  lh.LIST_TYPE_CODE = ''PRO''
       AND lh.ACTIVE_FLAG = ''Y''
       AND EXISTS(SELECT ''Y''
                  FROM   QP_LIST_LINES ll
                  WHERE  ll.LIST_HEADER_ID = lh.LIST_HEADER_ID
                         AND ll.LIST_LINE_TYPE_CODE IN (
                             ''OID'', ''PRG'', ''TSN'', ''IUE'',
                             ''CIE'', ''RLTD'' ))',
      p_title                  => 'Count of Advanced Modifiers',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No records are present.',
      p_solution               => 'No actions needed. ',
      p_success_msg            => 'This data is for internal use with analysis.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_COUNT_ ADVANCED_MODIFIERS');



debug('begin add_signature: PRICING_COUNT_ ACTIVE_MODIFIERS_WITH_LIMITS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14092',
      p_sig_id                 => 'PRICING_COUNT_ ACTIVE_MODIFIERS_WITH_LIMITS',
      p_sig_sql                => 'SELECT Count(*) "Active limit count"
FROM   QP_LIST_HEADERS_B lh
WHERE  lh.ACTIVE_FLAG = ''Y''
       AND EXISTS(SELECT ''Y''
                  FROM   QP_LIMITS lim
                  WHERE  lim.LIST_HEADER_ID = lh.LIST_HEADER_ID)',
      p_title                  => 'Count of Active Modifier Lists Having Limits',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No records are present.',
      p_solution               => 'No actions needed. ',
      p_success_msg            => 'This data is for internal use with analysis.',
   ...
   l_info.delete;
debug('end add_signature: PRICING_COUNT_ ACTIVE_MODIFIERS_WITH_LIMITS');



debug('begin add_signature: PRICING_SAMPLE_ADVANCED_MODIFIER_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14093',
      p_sig_id                 => 'PRICING_SAMPLE_ADVANCED_MODIFIER_DETAILS',
      p_sig_sql                => 'SELECT lh.list_header_id,
       lh.NAME
...
AND    EXISTS
       (
              ...
              FROM   qp_list_lines ll
              WHERE  ll.list_header_id = lh.list_header_id
              AND    ll.list_line_type_code IN (''OID'',
                                                ''PRG'',
                                                ''TSN'',
                                                ''IUE'',
                                                ''CIE'',
                                                ''RLTD''))
AND ROWNUM < ##$$MAX_ROWS$$##',
      p_title                  => 'Advanced Modifier Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No records are present.',
      p_solution               => 'No actions needed.',
      p_success_msg            => 'This data is to show the data distribution and to provide a sample of an Advanced Modifier.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_SAMPLE_ADVANCED_MODIFIER_DETAILS');



debug('begin add_signature: PRICING_SAMPLE_LIMITS_MODIFIER_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14094',
      p_sig_id                 => 'PRICING_SAMPLE_LIMITS_MODIFIER_DETAILS',
      p_sig_sql                => 'SELECT lh.LIST_HEADER_ID,
       lh.NAME
FROM   QP_LIST_HEADERS_VL lh
WHERE  lh.ACTIVE_FLAG = ''Y''
       AND EXISTS(SELECT ''Y''
                  ...
                  WHERE  lim.LIST_HEADER_ID = lh.LIST_HEADER_ID)
       AND ROWNUM < ##$$MAX_ROWS$$##',
      p_title                  => 'Samples of Limits Modifier Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No records are present.',
      p_solution               => 'No actions needed.',
      p_success_msg            => 'This data is shown to illustrate the data distribution and to provide a sample of limits modifier usage.
...
',
   ...
   l_info.delete;
debug('end add_signature: PRICING_SAMPLE_LIMITS_MODIFIER_DETAILS');



debug('begin add_signature: PRICING_CHANGED_LINES_ADVANCED_MODIFIER_COUNT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14095',
      p_sig_id                 => 'PRICING_CHANGED_LINES_ADVANCED_MODIFIER_COUNT',
      p_sig_sql                => 'select pricing_phase_id "Phase", 
       count(product_attr_value) "Prod Value Count"
from qp_adv_mod_products
group by pricing_phase_id',
      p_title                  => 'Count of Changed Lines of Advanced Modifier Product',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Records are present.',
      p_solution               => 'No actions needed.',
      p_success_msg            => 'This data is for internal use with analysis.',
   ...
   l_info.delete;
debug('end add_signature: PRICING_CHANGED_LINES_ADVANCED_MODIFIER_COUNT');



debug('begin add_signature: PRICING_CHANGED_LINES_ADVANCED_MODIFIER_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14096',
      p_sig_id                 => 'PRICING_CHANGED_LINES_ADVANCED_MODIFIER_DETAILS',
      p_sig_sql                => 'SELECT PRICING_PHASE_ID   "Phase",
       PRODUCT_ATTRIBUTE  "Prod Type",
       PRODUCT_ATTR_VALUE "Prod Value"
FROM   QP_ADV_MOD_PRODUCTS
ORDER  BY 1,
          2,
          3',
      p_title                  => 'Changed Lines of Advanced Modifier Product Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No records are present.',
      p_solution               => 'No actions needed. ',
      p_success_msg            => 'Informational. Provides data distribution for use with analysis.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_CHANGED_LINES_ADVANCED_MODIFIER_DETAILS');



debug('begin add_signature: PRICING_PRICE_LIST_BIG_SEARCH_OR_NOT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14017',
      p_sig_id                 => 'PRICING_PRICE_LIST_BIG_SEARCH_OR_NOT',
      p_sig_sql                => 'SELECT pp.NAME                      "Phase",
       e.PRICING_EVENT_CODE         "Event",
       e.START_DATE_ACTIVE          "Start Date",
       e.END_DATE_ACTIVE            "End Date",
       e.SEARCH_FLAG                "Search Flag",
       Nvl(e.USER_SEARCH_FLAG, ''Y'') "User Search Flag",
       e.SEEDED_FLAG                "Seeded Flag"
FROM   QP_EVENT_PHASES e,
       QP_PRICING_PHASES pp
WHERE  pp.NAME = ''List Line Base Price''
       AND e.PRICING_PHASE_ID = pp.PRICING_PHASE_ID
ORDER  BY 1,
          2',
      p_title                  => 'Verify if the Big Search for Price Lists is Enabled or Disabled',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No details are shown for the Big Search for Price Lists. 
',
      p_solution               => 'Please review [464624/KB777986] - How To Verify if the Big Search for Price Lists is Enabled or Disabled ',
      p_success_msg            => 'Details shown regarding the Big Search for Price Lists.  <br>
For more information, refer to [464624/KB777986] - How To Verify if the Big Search for Price Lists is Enabled or Disabled ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_PRICE_LIST_BIG_SEARCH_OR_NOT');



debug('begin add_signature: PRICING_SECURITY_DEBUG_VALUES');
   l_info('##MASK##UPDATED BY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14014',
      p_sig_id                 => 'PRICING_SECURITY_DEBUG_VALUES',
...
WHERE b.user_profile_option_name in (
''QP: Security Control'',
...
,to_char (c.level_value))
,''Unknown'')',
      p_title                  => 'Pricing Security Profiles',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No records are returned',
      p_solution               => 'If one desires to have pricing security enabled, implement solution located within [578620/KB413260] - Pricing Security Enabled At Operating Unit <br>
Allows Other Operating Units To View And Update Which is Incorrect <br>
<br>
If one desires to also use Multi Org Access Control, refer to [393634/KB750589] - R12: How To Setup Multi Org Access Control (MOAC) for Order Management?  
',
      p_success_msg            => 'When pricing security is enabled, MOAC is used if HR: Security Profile is set. <br>
If so, ensure it includes organization in question. <br>
Refer to [393634/KB750589] - R12: How To Setup Multi Org Access Control (MOAC) for Order Management? ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_SECURITY_DEBUG_VALUES');



debug('begin add_signature: PRICING_SECURITY_PACKAGE_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14317',
      p_sig_id                 => 'PRICING_SECURITY_PACKAGE_VERSIONS',
      p_sig_sql                => 'SELECT TEXT,
       NAME
FROM   ALL_SOURCE
WHERE  NAME IN ( ''QP_SECURITY'', ''QP_SECU_CTRL_PVT'' )
       AND LINE = 2
ORDER  BY 2,
          1',
      p_title                  => 'Pricing Security Package Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Version for Pricing Packages',
      p_solution               => 'No records were returned. Records should be returned regarding pricing security package versions. <br>|
Please log a service request with Oracle Support - Advanced Pricing to report this issue. <br>
Upload a copy of this analyzer''s output to the service request. <br>',
      p_success_msg            => 'The version is shown for the pricing security packages.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_SECURITY_PACKAGE_VERSIONS');



debug('begin add_signature: PRICING_SECURITY_VIEW_DEF_QP_SECU_LIST_HEADERS_V');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14320',
      p_sig_id                 => 'PRICING_SECURITY_VIEW_DEF_QP_SECU_LIST_HEADERS_V',
      p_sig_sql                => 'SELECT text
FROM    all_views
WHERE view_name = ''QP_SECU_LIST_HEADERS_V''',
      p_title                  => 'QP_SECU_LIST_HEADERS_V View Definition',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'View Definition for QP_SECU_LIST_HEADERS_V',
      p_solution               => 'If one desires to have pricing security enabled, implement solution located within <br>
[578620/KB413260] - Pricing Security Enabled At Operating Unit Allows Other Operating Units To View And Update Which is Incorrect. ',
      p_success_msg            => 'This is the definition for creating view QP_SECU_LIST_HEADERS_V.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_SECURITY_VIEW_DEF_QP_SECU_LIST_HEADERS_V');



debug('begin add_signature: PRICING_SECURITY_VIEW_DEF_QP_SECU_LIST_HEADERS_VL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14321',
      p_sig_id                 => 'PRICING_SECURITY_VIEW_DEF_QP_SECU_LIST_HEADERS_VL',
      p_sig_sql                => 'SELECT TEXT
FROM   ALL_VIEWS
WHERE  VIEW_NAME = ''QP_SECU_LIST_HEADERS_VL''',
      p_title                  => 'QP_SECU_LIST_HEADERS_VL View Definition',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'View Definition for QP_SECU_LIST_HEADERS_VL',
      p_solution               => 'If one desires to have pricing security enabled, implement solution located within <br>
[578620/KB413260] - Pricing Security Enabled At Operating Unit Allows Other Operating Units To View And Update Which is Incorrect ',
      p_success_msg            => 'This is the definition for creating view QP_SECU_LIST_HEADERS_VL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_SECURITY_VIEW_DEF_QP_SECU_LIST_HEADERS_VL');



debug('begin add_signature: PRICING_SECURITY_FND_FORM_FUNCTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14328',
      p_sig_id                 => 'PRICING_SECURITY_FND_FORM_FUNCTIONS',
      p_sig_sql                => 'SELECT *
FROM   FND_FORM_FUNCTIONS
WHERE  FUNCTION_NAME IN ( ''QP_SECU_VIEW'', ''QP_SECU_UPDATE'' )',
      p_title                  => 'Pricing Security with table FND_FORM_FUNCTIONS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No pricing security records found within table FND_FORM_FUNCTIONS',
      p_solution               => 'This query provides details about pricing security within table FND_FORM_FUNCTIONS.<br>
No solution needed as details are being collected for informational purposes.
',
      p_success_msg            => 'Shows pricing security within table FND_FORM_FUNCTIONS. <br>
Each row provides information about function grouping in forms.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_SECURITY_FND_FORM_FUNCTIONS');



debug('begin add_signature: PRICING_SECURITY_FND_COMPILED_MENU_FUNCTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14329',
      p_sig_id                 => 'PRICING_SECURITY_FND_COMPILED_MENU_FUNCTIONS',
      p_sig_sql                => 'SELECT *
FROM   FND_COMPILED_MENU_FUNCTIONS
WHERE  FUNCTION_ID IN (SELECT FUNCTION_ID
                       FROM   FND_FORM_FUNCTIONS
                       WHERE  FUNCTION_NAME IN (
                              ''QP_SECU_VIEW'', ''QP_SECU_UPDATE'' ))',
      p_title                  => 'Pricing Security with table FND_COMPILED_MENU_FUNCTIONS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No records found for pricing security from table FND_COMPILED_MENU_FUNCTIONS.',
      p_solution               => 'This query provides details about pricing security within table FND_COMPILED_MENU_FUNCTIONS.<br>
No solution needed as details are being collected for informational purposes.',
      p_success_msg            => 'Shows details about pricing security with table FND_COMPILED_MENU_FUNCTIONS <br>
which compiles the information from FND_MENU_ENTRIES to facilitate runtime lookups of which functions are on which menus. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_SECURITY_FND_COMPILED_MENU_FUNCTIONS');



debug('begin add_signature: PRICING_SECURITY_FND_GRANTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14330',
      p_sig_id                 => 'PRICING_SECURITY_FND_GRANTS',
      p_sig_sql                => 'SELECT *
FROM   FND_GRANTS
WHERE  OBJECT_ID = (SELECT OBJECT_ID
                    FROM   FND_OBJECTS
                    WHERE  APPLICATION_ID = 661)',
      p_title                  => 'Pricing Security with table FND_GRANTS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No rows are present in table FND_GRANTS. ',
      p_solution               => 'If one wishes to use pricing security, <br>
Ensure privileges have been assigned before enabling pricing security. <br>
Implement solution located within [827703/KB584314] - Pricing Security Privileges Setup In R12 

',
      p_success_msg            => 'Records are displayed for pricing security on table FND_GRANTS.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_SECURITY_FND_GRANTS');



debug('begin add_signature: PRICING_SECURITY_FND_OBJECT_INSTANCE_SETS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14331',
      p_sig_id                 => 'PRICING_SECURITY_FND_OBJECT_INSTANCE_SETS',
      p_sig_sql                => 'SELECT *
FROM   FND_OBJECT_INSTANCE_SETS
WHERE  INSTANCE_SET_ID IN (SELECT INSTANCE_SET_ID
                           FROM   FND_GRANTS
                           WHERE  OBJECT_ID = (SELECT OBJECT_ID
                                               FROM   FND_OBJECTS
                                               WHERE  APPLICATION_ID = 661))',
      p_title                  => 'Pricing Security with table FND_OBJECT_INSTANCE_SETS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'One has no entity sets defined.',
      p_solution               => 'No actions needed.',
      p_success_msg            => 'No actions needed. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_SECURITY_FND_OBJECT_INSTANCE_SETS');



debug('begin add_signature: EBS_MFG_OM_QPALL_PRICING_SECURITY_PRIVILEGES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25202',
      p_sig_id                 => 'EBS_MFG_OM_QPALL_PRICING_SECURITY_PRIVILEGES',
      p_sig_sql                => ' SELECT *
FROM   (SELECT DISTINCT qpgrant.grant_id,
                        qpgrant.instance_id       object_id,
                        qplistheaderstl.NAME      object_name,
                        qplistheaderstl.description,
                        qplistheadersb.list_type_code,
                        qpgrant.grantee_type,
                        qpgrant.grantee_id,
                        NULL                      AS grantee_name,
                        qpgrant.menu_id,
                        fndmenustl.user_menu_name access_role,
                        qpgrant.start_date,
                        qpgrant.end_date
        FROM   QP_GRANTS qpgrant,
               QP_LIST_HEADERS_TL qplistheaderstl,
               QP_LIST_HEADERS_B qplistheadersb,
               FND_MENUS_TL fndmenustl,
               FND_OBJECTS fndobjects
        WHERE  qpgrant.object_id = fndobjects.object_id
               AND fndobjects.database_object_name = ''QP_LIST_HEADERS_B''
               AND qpgrant.instance_id = qplistheaderstl.list_header_id
               AND qplistheaderstl.language = Userenv(''LANG'')
               AND qpgrant.instance_type IN ( ''PRL'', ''MOD'' )
               AND qpgrant.grantee_type = ''GLOBAL''
               AND fndmenustl.menu_id = qpgrant.menu_id
               AND fndmenustl.language = Userenv(''LANG'')
               AND qplistheaderstl.list_header_id =
                   qplistheadersb.list_header_id
        UNION ALL
        SELECT DISTINCT qpgrant.grant_id,
                        qpgrant.instance_id       object_id,
                        qplistheaderstl.NAME      object_name,
                        qplistheaderstl.description,
                        qplistheadersb.list_type_code,
                        qpgrant.grantee_type,
                        qpgrant.grantee_id,
                        hroperatingunits.NAME     grantee_name,
                        qpgrant.menu_id,
                        fndmenustl.user_menu_name access_role,
                        qpgrant.start_date,
                        qpgrant.end_date
        FROM   QP_GRANTS qpgrant,
               QP_LIST_HEADERS_TL qplistheaderstl,
               QP_LIST_HEADERS_B qplistheadersb,
               HR_OPERATING_UNITS hroperatingunits,
               FND_MENUS_TL fndmenustl,
               FND_OBJECTS fndobjects
        WHERE  qpgrant.object_id = fndobjects.object_id
               AND fndobjects.database_object_name = ''QP_LIST_HEADERS_B''
               ...
               AND qplistheaderstl.list_header_id =
                   qplistheadersb.list_header_id
               AND qpgrant.instance_type IN ( ''PRL'', ''MOD'' )
               AND qpgrant.grantee_type = ''OU''
               AND hroperatingunits.organization_id = qpgrant.grantee_id
               AND fndmenustl.menu_id = qpgrant.menu_id
               AND fndmenustl.language = Userenv(''LANG'')
        UNION ALL
        SELECT DISTINCT qpgrant.grant_id,
                        ...
                        qpgrant.grantee_type,
                        qpgrant.grantee_id,
                        fndresponsibilitytl.responsibility_name grantee_name,
                        qpgrant.menu_id,
                        fndmenustl.user_menu_name               access_role,
                        qpgrant.start_date,
                        qpgrant.end_date
        FROM   QP_GRANTS qpgrant,
               QP_LIST_HEADERS_TL qplistheaderstl,
               QP_LIST_HEADERS_B qplistheadersb,
               FND_RESPONSIBILITY_TL fndresponsibilitytl,
               FND_MENUS_TL fndmenustl,
               FND_OBJECTS fndobjects
        WHERE  qpgrant.object_id = fndobjects.object_id
               AND fndobjects.database_object_name = ''QP_LIST_HEADERS_B''
               ...
               AND qplistheaderstl.list_header_id =
                   qplistheadersb.list_header_id
               AND qpgrant.instance_type IN ( ''PRL'', ''MOD'' )
               AND qpgrant.grantee_type = ''RESP''
               AND fndresponsibilitytl.responsibility_id = qpgrant.grantee_id
               AND fndresponsibilitytl.language = Userenv(''LANG'')
               AND fndmenustl.menu_id = qpgrant.menu_id
               AND fndmenustl.language = Userenv(''LANG'')
        UNION ALL
        SELECT DISTINCT qpgrant.grant_id,
                        ...
                        qpgrant.grantee_type,
                        qpgrant.grantee_id,
                        fnduser.user_name         grantee_name,
                        qpgrant.menu_id,
                        fndmenustl.user_menu_name access_role,
                        qpgrant.start_date,
                        qpgrant.end_date
        ...
        WHERE  qpgrant.object_id = fndobjects.object_id
               ...
               AND qplistheaderstl.list_header_id =
                   qplistheadersb.list_header_id
               AND qpgrant.instance_type IN ( ''PRL'', ''MOD'' )
               AND qpgrant.grantee_type = ''USER''
               AND fnduser.user_id = qpgrant.grantee_id
               AND fndmenustl.menu_id = qpgrant.menu_id
               AND fndmenustl.language = Userenv(''LANG'')) qrslt
ORDER  BY object_name ASC,
          grantee_name',
      p_title                  => 'Pricing Security Privileges',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No records for Pricing Security Privileges are assigned.',
      p_solution               => 'Please review and assign privileges as needed.
',
      p_success_msg            => 'Please review the list to determine if applicable privileges are assigned.
This list may be limited based on value entered for parameter "Maximum Rows to Display".  ',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_QPALL_PRICING_SECURITY_PRIVILEGES');



debug('begin add_signature: PRICING_BULK_LOADER_PROFILES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14319',
      p_sig_id                 => 'PRICING_BULK_LOADER_PROFILES',
      p_sig_sql                => 'SELECT
    fpot.user_profile_option_name "Profile Name",
    fpov.profile_option_value "Value",
    DECODE(fpov.level_id,
...
FROM
    ...
    fnd_user fu
WHERE
    fpo.profile_option_name in (''QP_BATCH_SIZE_FOR_BULK_IMPORT'')
    AND fpo.profile_option_name = fpot.profile_option_name
    AND fpot.LANGUAGE (+) = ''US''
    AND fpov.profile_option_id = fpo.profile_option_id
    AND fa.application_id (+) = fpov.level_value
...
ORDER
    by 1, fpov.level_id, 4',
      p_title                  => 'Pricing Bulk Loader Profiles',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'No records returned for profiles used with QP: Bulk Import of Price Lists.',
      p_solution               => 'For details about the settings for this profile options, one may <br>
refer to [553399/KB161082#Bulk_Profile] - How to Set Profile Options for Use With Advanced Pricing',
      p_success_msg            => 'Profiles Used with QP: Bulk Import of Price Lists.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_BULK_LOADER_PROFILES');



debug('begin add_signature: PRICING_BULK_LOADER_PACKAGE_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14318',
      p_sig_id                 => 'PRICING_BULK_LOADER_PACKAGE_VERSIONS',
      p_sig_sql                => 'SELECT TEXT,
       NAME
FROM   ALL_SOURCE
WHERE  NAME IN ( ''QP_MAINTAIN_DENORMALIZED_DATA'', ''QP_BULK_VALIDATE'',
                        ''QP_BULK_LOADER_PUB'',
                                ''QP_COPY_PRICELIST_PVT'',
                 ''QP_BULK_MSG'', ''QP_BULK_VALUE_TO_ID'', ''QP_ADD_ITEM_PRCLIST_PVT''
               )
       AND LINE = 2
ORDER  BY 2,
          1',
      p_title                  => 'Bulk Load Price List Package Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No bulk loader packages found.',
      p_solution               => '',
      p_success_msg            => 'These are the version on the environment for these packages.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_BULK_LOADER_PACKAGE_VERSIONS');



debug('begin add_signature: PRICING_HEADER_MISSING_ORIG_SYSTEM_HEADER_REF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14192',
      p_sig_id                 => 'PRICING_HEADER_MISSING_ORIG_SYSTEM_HEADER_REF',
      p_sig_sql                => 'SELECT Count(*) "Record Count"
FROM   QP_LIST_HEADERS_B
WHERE  LIST_TYPE_CODE = ''PRL''
       AND ORIG_SYSTEM_HEADER_REF IS NULL',
      p_title                  => 'Record Count with NULL ORIG_SYSTEM_HEADER_REF in Table QP_LIST_HEADERS.',
      p_fail_condition         => '[Record Count] > [0]',
      p_problem_descr          => 'NULL ORIG_SYSTEM_HEADER_REF in Table QP_LIST_HEADERS.',
      p_solution               => 'Refer to the solution through [2644343/KB770130] - R12 How to ReSet Orig_sys% values For Running Bulk Import of Price Lists
<br> This solution will reset ALL orig_sys% values.<br>
<br>For any issues, please log a  Datafix Service Request with Oracle Support.<br>
When creating the Service Request, upload the output of this analyzer and <br>
refer to  [2644343/KB770130] - R12 How to ReSet Orig_sys% values For Running Bulk Import of Price Lists',
      p_success_msg            => 'NULL is not present in this data.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_HEADER_MISSING_ORIG_SYSTEM_HEADER_REF');



debug('begin add_signature: PRICING_HEADER_MISSING_ORIG_SYS_LINE_REF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14193',
      p_sig_id                 => 'PRICING_HEADER_MISSING_ORIG_SYS_LINE_REF',
      p_sig_sql                => 'SELECT Count(*) "Record Count"
FROM   QP_LIST_LINES
WHERE  LIST_LINE_TYPE_CODE = ''PLL''
       AND ORIG_SYS_LINE_REF IS NULL',
      p_title                  => 'Record Count with NULL ORIG_SYS_LINE_REF in Table QP_LIST_LINES.',
      p_fail_condition         => '[Record Count] > [0]',
      p_problem_descr          => 'Count of NULL ORIG_SYS_LINE_REF in Table QP_LIST_LINES.',
      p_solution               => 'Refer to the solution through [2644343/KB770130] - R12 How to ReSet Orig_sys% values For Running Bulk Import of Price Lists
<br> This solution will reset ALL orig_sys% values.<br>
<br><br>For any issues, please log a  Datafix Service Request with Oracle Support.<br>
When creating the Service Request, upload the output of this analyzer and <br>
refer to  [2644343/KB770130] - R12 How to ReSet Orig_sys% values For Running Bulk Import of Price Lists',
      p_success_msg            => 'NULL is not present in this data.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_HEADER_MISSING_ORIG_SYS_LINE_REF');



debug('begin add_signature: PRICING_LIST_LINES_MISSING_ORIG_SYSTEM_HEADER_REF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14194',
      p_sig_id                 => 'PRICING_LIST_LINES_MISSING_ORIG_SYSTEM_HEADER_REF',
      p_sig_sql                => 'SELECT Count(*) "Record Count"
FROM   QP_LIST_LINES
WHERE  LIST_LINE_TYPE_CODE = ''PLL''
       AND ORIG_SYS_HEADER_REF IS NULL',
      p_title                  => 'Record Count with NULL ORIG_SYSTEM_HEADER_REF in Table QP_LIST_LINES.',
      p_fail_condition         => '[Record Count] > [0]',
      p_problem_descr          => 'NULL ORIG_SYSTEM_HEADER_REF in Table QP_LIST_LINES.',
      p_solution               => 'Refer to the solution through [2644343/KB770130] - R12 How to ReSet Orig_sys% values For Running Bulk Import of Price Lists
<br> This solution will reset ALL orig_sys% values.<br>
<br><br>For any issues, please log a  Datafix Service Request with Oracle Support.<br>
When creating the Service Request, upload the output of this analyzer and <br>
refer to  [2644343/KB770130] - R12 How to ReSet Orig_sys% values For Running Bulk Import of Price Lists',
   ...
   l_info.delete;
debug('end add_signature: PRICING_LIST_LINES_MISSING_ORIG_SYSTEM_HEADER_REF');



debug('begin add_signature: PRICING_ATTRIBUTES_MISSING_ORIG_SYS_HEADER_REF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14195',
      p_sig_id                 => 'PRICING_ATTRIBUTES_MISSING_ORIG_SYS_HEADER_REF',
      p_sig_sql                => 'SELECT Count(*) "Record Count"
FROM   QP_PRICING_ATTRIBUTES qpa
WHERE  qpa.ORIG_SYS_HEADER_REF IS NULL
       AND qpa.LIST_LINE_ID IN (SELECT qll.LIST_LINE_ID
                                FROM   QP_LIST_LINES qll
                                WHERE  qll.LIST_LINE_TYPE_CODE = ''PLL'')',
      p_title                  => 'Record Count with NULL ORIG_SYS_HEADER_REF in Table QP_PRICING_ATTRIBUTES.',
      p_fail_condition         => '[Record Count] > [0]',
      p_problem_descr          => 'NULL ORIG_SYS_HEADER_REF in Table QP_PRICING_ATTRIBUTES.',
      p_solution               => 'Refer to the solution through [2644343/KB770130] - R12 How to ReSet Orig_sys% values For Running Bulk Import of Price Lists
<br> This solution will reset ALL orig_sys% values.<br>
<br><br>For any issues, please log a  Datafix Service Request with Oracle Support.<br>
When creating the Service Request, upload the output of this analyzer and <br>
refer to  [2644343/KB770130] - R12 How to ReSet Orig_sys% values For Running Bulk Import of Price Lists',
   ...
   l_info.delete;
debug('end add_signature: PRICING_ATTRIBUTES_MISSING_ORIG_SYS_HEADER_REF');



debug('begin add_signature: PRICING_ATTRIBUTES_MISSING_ORIG_SYS_LINE_REF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14196',
      p_sig_id                 => 'PRICING_ATTRIBUTES_MISSING_ORIG_SYS_LINE_REF',
      p_sig_sql                => 'select count(*) "Record Count"
from qp_pricing_attributes qpa
where qpa.orig_sys_line_ref is null
and qpa.list_line_id in 
   (select qll.list_line_id from qp_list_lines qll where qll.list_line_type_code = ''PLL'')',
      p_title                  => 'Record Count with NULL ORIG_SYS_LINE_REF in Table QP_PRICING_ATTRIBUTES.',
      p_fail_condition         => '[Record Count] > [0]',
      p_problem_descr          => 'NULL ORIG_SYS_LINE_REF in Table QP_PRICING_ATTRIBUTES.',
      p_solution               => 'Refer to the solution through [2644343/KB770130] - R12 How to ReSet Orig_sys% values For Running Bulk Import of Price Lists
<br> This solution will reset ALL orig_sys% values.<br>
<br><br>For any issues, please log a  Datafix Service Request with Oracle Support.<br>
When creating the Service Request, upload the output of this analyzer and <br>
refer to  [2644343/KB770130] - R12 How to ReSet Orig_sys% values For Running Bulk Import of Price Lists',
   ...
   l_info.delete;
debug('end add_signature: PRICING_ATTRIBUTES_MISSING_ORIG_SYS_LINE_REF');



debug('begin add_signature: PRICING_ATTRIBUTES_MISSING_ORIG_SYS_PRICING_ATTR_REF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14197',
      p_sig_id                 => 'PRICING_ATTRIBUTES_MISSING_ORIG_SYS_PRICING_ATTR_REF',
      p_sig_sql                => 'SELECT Count(*) "Record Count"
FROM   QP_PRICING_ATTRIBUTES qpa
WHERE  qpa.ORIG_SYS_PRICING_ATTR_REF IS NULL
       AND qpa.LIST_LINE_ID IN (SELECT qll.LIST_LINE_ID
                                FROM   QP_LIST_LINES qll
                                WHERE  qll.LIST_LINE_TYPE_CODE = ''PLL'')',
      p_title                  => 'Record Count with NULL ORIG_SYS_PRICING_ATTR_REF in Table QP_PRICING_ATTRIBUTES',
      p_fail_condition         => '[Record Count] > [0]',
      p_problem_descr          => 'NULL ORIG_SYS_PRICING_ATTR_REF in Table QP_PRICING_ATTRIBUTES.',
      p_solution               => 'Refer to the solution through [2644343/KB770130] - R12 How to ReSet Orig_sys% values For Running Bulk Import of Price Lists
<br> This solution will reset ALL orig_sys% values.<br>
<br><br>For any issues, please log a  Datafix Service Request with Oracle Support.<br>
When creating the Service Request, upload the output of this analyzer and <br>
refer to  [2644343/KB770130] - R12 How to ReSet Orig_sys% values For Running Bulk Import of Price Lists',
   ...
   l_info.delete;
debug('end add_signature: PRICING_ATTRIBUTES_MISSING_ORIG_SYS_PRICING_ATTR_REF');



debug('begin add_signature: PRICING_QUALIFIERS_MISSING_ORIG_SYS_QUALIFER_REF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14199',
      p_sig_id                 => 'PRICING_QUALIFIERS_MISSING_ORIG_SYS_QUALIFER_REF',
      p_sig_sql                => 'SELECT Count(*) "Record Count",
       LIST_HEADER_ID,
       QUALIFIER_ID
FROM   QP_QUALIFIERS qq
WHERE  qq.ORIG_SYS_QUALIFIER_REF IS NULL
       AND qq.LIST_HEADER_ID IN (SELECT qlh.LIST_HEADER_ID
                                 FROM   QP_LIST_HEADERS_B qlh
                                 WHERE  qlh.LIST_TYPE_CODE = ''PRL'')
GROUP  BY LIST_HEADER_ID,
          QUALIFIER_ID
ORDER  BY LIST_HEADER_ID',
      p_title                  => 'Record Count with NULL ORIG_SYS_QUALIFIER_REF in Table QP_QUALIFIERS.',
      p_fail_condition         => '[Record Count] > [0]',
      p_problem_descr          => 'NULL ORIG_SYS_PRICING_ATTR_REF in Table QP_PRICING_ATTRIBUTES.',
      p_solution               => 'Refer to the solution through [2644343/KB770130] - 12 How to ReSet Orig_sys% values For Running Bulk Import of Price Lists
<br> This solution will reset ALL orig_sys% values.
<br><br>For any issues, please log a  Datafix Service Request with Oracle Support.<br>
When creating the Service Request, upload the output of this analyzer and refer to  [2644343/KB770130] .
',
      p_success_msg            => 'NULL is not present in this data.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_QUALIFIERS_MISSING_ORIG_SYS_QUALIFER_REF');



debug('begin add_signature: PRICING_QP_INTERFACE_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14200',
      p_sig_id                 => 'PRICING_QP_INTERFACE_ERRORS',
      p_sig_sql                => 'SELECT CREATION_DATE,
       ENTITY_TYPE,
       TABLE_NAME,
       COLUMN_NAME,
       ERROR_MESSAGE,
...
FROM   QP_INTERFACE_ERRORS',
      p_title                  => 'Pricing Interface Records with Error',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Records With Error Messages That Are Present in Table QP_INTERFACE_ERRORS.',
      p_solution               => 'Please review My Oracle Support based on the error messages shown. <br>
For additional assistance, one may log a service request <br>
with Oracle Support - Advanced Pricing.',
      p_success_msg            => 'NULL is not present in this data.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_QP_INTERFACE_ERRORS');
...
debug('begin add_signature: PRICING_MODIFIER_PRIMARY_UOM_FLAG_VALIDATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15192',
      p_sig_id                 => 'PRICING_MODIFIER_PRIMARY_UOM_FLAG_VALIDATION',
      p_sig_sql                => 'SELECT qll.LIST_HEADER_ID,
       qll.LIST_LINE_ID,
...
WHERE  qlh.LIST_HEADER_ID = qll.LIST_HEADER_ID
       AND qlh.LIST_TYPE_CODE IN ( ''CHARGES'', ''DLT'', ''PRO'', ''AGR'',
                                   ''SLT'', ''PML'' )
       AND ( qll.PRIMARY_UOM_FLAG IS NOT NULL )',
      p_title                  => 'Modifier Record(s) Which Have an Incorrect Primary UOM Flag Value',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The primary_uom_flag is incorrectly populated in table QP_LIST_LINES for a modifier line.',
      p_solution               => 'Please refer to the solution provided within [1272658/KB436396] - Getting Oe_lock_row_changed On Modifier Line Update ',
      p_success_msg            => 'Data is correctly populated for primary_uom_flag on modifier lines.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_MODIFIER_PRIMARY_UOM_FLAG_VALIDATION');



debug('begin add_signature: PRICING_MODIFIER_REPRICE_FLAG_VALIDATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15193',
      p_sig_id                 => 'PRICING_MODIFIER_REPRICE_FLAG_VALIDATION',
      p_sig_sql                => 'SELECT qlht.name,
       qll.list_header_id,
       qll.list_line_id,
       qll.reprice_flag,
       qll.list_line_type_code
...
WHERE qlht.list_header_id = qlh.list_header_id
      ...
      AND qlh.list_type_code IN ( ''CHARGES'', ''DLT'', ''PRO'', ''AGR'', ''SLT'', ''PML'' )
      AND ( qll.reprice_flag IS NOT NULL )',
      p_title                  => 'Modifier Record(s) Which Have an Incorrect Reprice Flag Value',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The reprice_flag is incorrectly populated in table QP_LIST_LINES.',
      p_solution               => 'Please refer to the solution provided within [352548/KB437854] - QPXPRMLS Modifier Form: Cannot Update Modifier Line, OE_LOCK_ROW_CHANGED',
      p_success_msg            => 'Data is correctly populated for this column.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_MODIFIER_REPRICE_FLAG_VALIDATION');



debug('begin add_signature: PRICING_MODIFIER_REVISION_DATE_VALIDATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15194',
      p_sig_id                 => 'PRICING_MODIFIER_REVISION_DATE_VALIDATION',
      p_sig_sql                => 'SELECT qll.LIST_HEADER_ID,
       qll.LIST_LINE_ID,
       qll.REVISION_DATE,
       qll.LIST_LINE_TYPE_CODE
...
WHERE  qlh.LIST_HEADER_ID = qll.LIST_HEADER_ID
       ...
       AND qlh.LIST_TYPE_CODE IN ( ''CHARGES'', ''DLT'', ''PRO'', ''AGR'',
                                   ''SLT'', ''PML'' )
       AND ( qll.REVISION_DATE IS NOT NULL )',
      p_title                  => 'Modifier Record(s) Which Have an Incorrect Revision Date Value',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The revision_date should not be populated in table QP_LIST_LINES for a modifier line.',
      p_solution               => 'Please refer to the solution provided within 
[386418/KB313083] QPXPRMLS.FMB: Error OE_LOCK_ROW_CHANGED When Trying To End Date the Modifier Line',
      p_success_msg            => 'Data is validated.  No revision_dates populated in table QP_LIST_LINES for a modifier line.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_MODIFIER_REVISION_DATE_VALIDATION');



debug('begin add_signature: EBS_MFG_OM_QPALL_PRICING_INACTIVE_QUALIFIERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24645',
      p_sig_id                 => 'EBS_MFG_OM_QPALL_PRICING_INACTIVE_QUALIFIERS',
      p_sig_sql                => 'SELECT t.NAME,
       Decode(b.list_type_code, ''PRL'', ''Price List'',
                                ''AGR'', ''Agreement'',
                                ''Modifier'')      "Pricing Entity",
       Decode(a.list_line_id, -1, ''List Qualifier'',
                              ''Line Qualifier'')  "Qualifier Type",
       a.active_flag                             "Qualifier Active Flag",
       b.active_flag                             "Entity Header Active Flag",
       a.qualifier_precedence                    "Qualifier Precedence",
       a.qualifier_grouping_no                   "Qualifier Grouping Number",
       a.qualifier_context,
       Substr(qp_qp_form_pricing_attr.Get_segment_name(''QP_ATTR_DEFNS_QUALIFIER''
                     , a.qualifier_context, a.qualifier_attribute), 1, 15)
       || '' (''
       || a.qualifier_attribute
       || '')''                                    "Qualifier Attribute",
       a.comparison_operator_code                "Comparison Operator Code",
       a.qualifier_attr_value                    "Qualifier Attribute Value",
       Decode(a.comparison_operator_code, ''BETWEEN'', ''->'',
                                          '' '')   "Comparison Operator",
       a.qualifier_attr_value_to                 "Qualifier Attribute Value To",
       To_char(a.start_date_active, ''DD-MON-YY'') "Start Date Active",
       To_char(a.end_date_active, ''DD-MON-YY'')   "End Date Active",
       a.search_ind                              "Search Indicator",
       a.list_type_code                          "List Type Code",
       a.qualifier_group_cnt                     "Qualifier Group Count",
       a.header_quals_exist_flag                 "Header Qual Exists Flag"
FROM   QP_QUALIFIERS a,
       QP_LIST_HEADERS_B b,
       QP_LIST_HEADERS_TL t
WHERE  a.active_flag <> b.active_flag
       AND a.active_flag = ''N''
       AND b.list_header_id = a.list_header_id
       AND b.list_header_id = t.list_header_id
ORDER  BY 1,2,3,5',
      p_title                  => 'Inactive Qualifiers',
      p_fail_condition         => 'RSGT1',
      p_problem_descr          => 'Inactive Qualifiers are present and can impact functionality of pricing entities',
      p_solution               => 'There is a mismatch between the header records active_flag and the active_flag on a qualifier.  This pricing entity may not work as needed, until this issue is resolved. Please refer to the solution needed in
 [2915888/KB547674]',
      p_success_msg            => 'all qualifiers are active',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_QPALL_PRICING_INACTIVE_QUALIFIERS');



debug('begin add_signature: PRICING_BLANK_QP_LIST_HEADERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14670',
      p_sig_id                 => 'PRICING_BLANK_QP_LIST_HEADERS',
      p_sig_sql                => 'SELECT ''ATTRIBUTE1'' "COLUMN NAME",
       Count(*)     "COUNT"
FROM   QP_LIST_HEADERS
WHERE  ATTRIBUTE1 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE2'' "COLUMN NAME",
       Count(*)     "COUNT"
FROM   QP_LIST_HEADERS
WHERE  ATTRIBUTE2 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE3'' "COLUMN NAME",
       Count(*)     "COUNT"
FROM   QP_LIST_HEADERS
WHERE  ATTRIBUTE3 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE4'' "COLUMN NAME",
       Count(*)     "COUNT"
FROM   QP_LIST_HEADERS
WHERE  ATTRIBUTE4 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE5'' "COLUMN NAME",
       Count(*)     "COUNT"
FROM   QP_LIST_HEADERS
WHERE  ATTRIBUTE5 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE6'' "COLUMN NAME",
       Count(*)     "COUNT"
FROM   QP_LIST_HEADERS
WHERE  ATTRIBUTE6 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE7'' "COLUMN NAME",
       Count(*)     "COUNT"
FROM   QP_LIST_HEADERS
WHERE  ATTRIBUTE7 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE8'' "COLUMN NAME",
       Count(*)     "COUNT"
FROM   QP_LIST_HEADERS
WHERE  ATTRIBUTE8 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE9'' "COLUMN NAME",
       Count(*)     "COUNT"
FROM   QP_LIST_HEADERS
WHERE  ATTRIBUTE9 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE10'' "COLUMN NAME",
       Count(*)      "COUNT"
FROM   QP_LIST_HEADERS
WHERE  ATTRIBUTE10 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE11'' "COLUMN NAME",
       Count(*)      "COUNT"
FROM   QP_LIST_HEADERS
WHERE  ATTRIBUTE11 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE12'' "COLUMN NAME",
       Count(*)      "COUNT"
FROM   QP_LIST_HEADERS
WHERE  ATTRIBUTE12 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE13'' "COLUMN NAME",
       Count(*)      "COUNT"
FROM   QP_LIST_HEADERS
WHERE  ATTRIBUTE13 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE14'' "COLUMN NAME",
       Count(*)      "COUNT"
FROM   QP_LIST_HEADERS
WHERE  ATTRIBUTE14 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE15'' "COLUMN NAME",
       Count(*)      "COUNT"
FROM   QP_LIST_HEADERS
WHERE  ATTRIBUTE15 LIKE ''% ''',
      p_title                  => 'Count of Records with Columns in Table QP_LIST_HEADERS with Trailing Spaces.',
      p_fail_condition         => '[COUNT] > [0]',
      p_problem_descr          => 'Trailing spaces in table QP_LIST_HEADERS.',
      p_solution               => 'Data can result in error OE_LOCK_ROW_CHANGED.<br> 
A data fix Service Request will need to be logged with Oracle Support - Advanced Pricing.<br> 
When creating the Service Request, upload the output of this analyzer and refer to [2601430/KB691095] - Price List Line Shows Error OE_LOCK_ROW_CHANGED ',
      p_success_msg            => 'No trailing spaces are present in this data.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_BLANK_QP_LIST_HEADERS');



debug('begin add_signature: PRICING_BLANK_QP_LIST_HEADERS_SAMPLE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14662',
      p_sig_id                 => 'PRICING_BLANK_QP_LIST_HEADERS_SAMPLE',
      p_sig_sql                => 'SELECT LIST_HEADER_ID,
       ''ATTRIBUTE1'' "COLUMN NAME"
FROM   QP_LIST_HEADERS
WHERE  ATTRIBUTE1 LIKE ''% ''
UNION
SELECT LIST_HEADER_ID,
       ''ATTRIBUTE2'' "COLUMN NAME"
FROM   QP_LIST_HEADERS
WHERE  ATTRIBUTE2 LIKE ''% ''
UNION
SELECT LIST_HEADER_ID,
       ''ATTRIBUTE3'' "COLUMN NAME"
FROM   QP_LIST_HEADERS
WHERE  ATTRIBUTE3 LIKE ''% ''
UNION
SELECT LIST_HEADER_ID,
       ''ATTRIBUTE4'' "COLUMN NAME"
FROM   QP_LIST_HEADERS
WHERE  ATTRIBUTE4 LIKE ''% ''
UNION
SELECT LIST_HEADER_ID,
       ''ATTRIBUTE5'' "COLUMN NAME"
FROM   QP_LIST_HEADERS
WHERE  ATTRIBUTE5 LIKE ''% ''
UNION
SELECT LIST_HEADER_ID,
       ''ATTRIBUTE6'' "COLUMN NAME"
FROM   QP_LIST_HEADERS
WHERE  ATTRIBUTE6 LIKE ''% ''
UNION
SELECT LIST_HEADER_ID,
       ''ATTRIBUTE7'' "COLUMN NAME"
FROM   QP_LIST_HEADERS
WHERE  ATTRIBUTE7 LIKE ''% ''
UNION
SELECT LIST_HEADER_ID,
       ''ATTRIBUTE8'' "COLUMN NAME"
FROM   QP_LIST_HEADERS
WHERE  ATTRIBUTE8 LIKE ''% ''
UNION
SELECT LIST_HEADER_ID,
       ''ATTRIBUTE9'' "COLUMN NAME"
FROM   QP_LIST_HEADERS
WHERE  ATTRIBUTE9 LIKE ''% ''
UNION
SELECT LIST_HEADER_ID,
       ''ATTRIBUTE10'' "COLUMN NAME"
FROM   QP_LIST_HEADERS
WHERE  ATTRIBUTE10 LIKE ''% ''
UNION
SELECT LIST_HEADER_ID,
       ''ATTRIBUTE11'' "COLUMN NAME"
FROM   QP_LIST_HEADERS
WHERE  ATTRIBUTE11 LIKE ''% ''
UNION
SELECT LIST_HEADER_ID,
       ''ATTRIBUTE12'' "COLUMN NAME"
FROM   QP_LIST_HEADERS
WHERE  ATTRIBUTE12 LIKE ''% ''
UNION
SELECT LIST_HEADER_ID,
       ''ATTRIBUTE13'' "COLUMN NAME"
FROM   QP_LIST_HEADERS
WHERE  ATTRIBUTE13 LIKE ''% ''
UNION
SELECT LIST_HEADER_ID,
       ''ATTRIBUTE14'' "COLUMN NAME"
FROM   QP_LIST_HEADERS
WHERE  ATTRIBUTE14 LIKE ''% ''
UNION
SELECT LIST_HEADER_ID,
       ''ATTRIBUTE15'' "COLUMN NAME"
FROM   QP_LIST_HEADERS
WHERE  ATTRIBUTE15 LIKE ''% ''',
      p_title                  => 'Records With Trailing Spaces That Are Present in Table QP_LIST_HEADERS.',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Trailing spaces in table QP_LIST_HEADERS.
',
      p_solution               => 'Data can result in price list setup form/modifier setup form error OE_LOCK_ROW_CHANGED.<br> 
A data fix Service Request will need to be logged with Oracle Support.<br>
When creating the Service Request, upload the output of this analyzer and refer to [2601430/KB691095] - Price List Line Shows Error OE_LOCK_ROW_CHANGED.',
      p_success_msg            => 'No trailing spaces are present in this data.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_BLANK_QP_LIST_HEADERS_SAMPLE');



debug('begin add_signature: PRICING_BLANK_QP_LIST_HEADERS_B');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13936',
      p_sig_id                 => 'PRICING_BLANK_QP_LIST_HEADERS_B',
      p_sig_sql                => 'SELECT ''ATTRIBUTE1'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_HEADERS_B
WHERE ATTRIBUTE1 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE2'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_HEADERS_B
WHERE ATTRIBUTE2 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE3'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_HEADERS_B
WHERE ATTRIBUTE3 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE4'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_HEADERS_B
WHERE ATTRIBUTE4 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE5'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_HEADERS_B
WHERE ATTRIBUTE5 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE6'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_HEADERS_B
WHERE ATTRIBUTE6 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE7'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_HEADERS_B
WHERE ATTRIBUTE7 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE8'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_HEADERS_B
WHERE ATTRIBUTE8 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE9'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_HEADERS_B
WHERE ATTRIBUTE9 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE10'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_HEADERS_B
WHERE ATTRIBUTE10 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE11'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_HEADERS_B
WHERE ATTRIBUTE11 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE12'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_HEADERS_B
WHERE ATTRIBUTE12 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE13'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_HEADERS_B
WHERE ATTRIBUTE13 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE14'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_HEADERS_B
WHERE ATTRIBUTE14 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE15'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_HEADERS_B
WHERE ATTRIBUTE15 LIKE ''% ''
UNION
SELECT ''COMMENTS'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_HEADERS_B
WHERE COMMENTS LIKE ''% ''',
      p_title                  => 'Count of Records with Columns in Table QP_LIST_HEADERS_B with Trailing Spaces.',
      p_fail_condition         => '[COUNT] > [0]',
      p_problem_descr          => 'Trailing spaces in table QP_LIST_HEADERS_B.',
      p_solution               => 'This data could result in Error OE_LOCK_ROW_CHANGED on the price list setup and/or modifier setup forms.<br> 
A data fix Service Request will need to be logged with Oracle Support.<br>
When creating the Service Request, upload the output of this analyzer and refer to [2601430/KB691095].',
      p_success_msg            => 'No trailing spaces are present in this data.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_BLANK_QP_LIST_HEADERS_B');



debug('begin add_signature: PRICING_BLANK_QP_LIST_HEADERS_B_SAMPLE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14967',
      p_sig_id                 => 'PRICING_BLANK_QP_LIST_HEADERS_B_SAMPLE',
      p_sig_sql                => 'SELECT LIST_HEADER_ID,
       ''ATTRIBUTE1'' "COLUMN NAME"
FROM   QP_LIST_HEADERS_B
WHERE  ATTRIBUTE1 LIKE ''% ''
...
WHERE COMMENTS LIKE ''% ''
order by 1,2',
      p_title                  => 'Records With Trailing Spaces That Are Present in Table QP_LIST_HEADERS_B',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Trailing spaces in table QP_LIST_HEADERS_B.

',
      p_solution               => 'This data can result in price list setup form/modifier setup form error OE_LOCK_ROW_CHANGED.<br> 
A data fix service request will need to be logged with Oracle support.<br>
When creating the service request, upload the output of this analyzer and refer to [2601430/KB691095]
',
      p_success_msg            => 'No trailing spaces are present in this data.',
   ...
   l_info.delete;
debug('end add_signature: PRICING_BLANK_QP_LIST_HEADERS_B_SAMPLE');



debug('begin add_signature: PRICING_BLANK_QP_LIST_HEADERS_TL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13937',
      p_sig_id                 => 'PRICING_BLANK_QP_LIST_HEADERS_TL',
      p_sig_sql                => 'SELECT ''LANGUAGE'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_HEADERS_TL
WHERE LANGUAGE LIKE ''% ''
UNION
SELECT ''SOURCE_LANG'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_HEADERS_TL
WHERE SOURCE_LANG LIKE ''% ''
UNION
SELECT ''NAME'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_HEADERS_TL
WHERE NAME LIKE ''% ''
UNION
SELECT ''DESCRIPTION'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_HEADERS_TL
WHERE DESCRIPTION LIKE ''% ''',
      p_title                  => 'Count of Records with Columns in Table QP_LIST_HEADERS_TL with Trailing Spaces.',
      p_fail_condition         => '[COUNT] > [0]',
      p_problem_descr          => 'Trailing spaces in table QP_LIST_HEADERS_TL.',
      p_solution               => 'This data could result in Error OE_LOCK_ROW_CHANGED on the price list setup and/or modifier setup forms. <br>
A data fix Service Request will need to be logged with Oracle Support.<br>
When creating the Service Request, upload the output of this analyzer and refer to [2601430/KB691095].<br>
...
',
   ...
   l_info.delete;
debug('end add_signature: PRICING_BLANK_QP_LIST_HEADERS_TL');



debug('begin add_signature: PRICING_BLANK_QP_LIST_HEADERS_TL_SAMPLE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14968',
      p_sig_id                 => 'PRICING_BLANK_QP_LIST_HEADERS_TL_SAMPLE',
      p_sig_sql                => 'SELECT LIST_HEADER_ID,
       ''LANGUAGE''
...
FROM   QP_LIST_HEADERS_TL
WHERE  DESCRIPTION LIKE ''% ''',
      p_title                  => 'Records With Trailing Spaces That Are Present in Table QP_LIST_HEADERS _TL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Trailing spaces in table QP_LIST_HEADERS_TL. 
...
',
   ...
   l_info.delete;
debug('end add_signature: PRICING_BLANK_QP_LIST_HEADERS_TL_SAMPLE');



debug('begin add_signature: PRICING_BLANK_QP_LIST_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13938',
      p_sig_id                 => 'PRICING_BLANK_QP_LIST_LINES',
      p_sig_sql                => 'SELECT ''ATTRIBUTE1'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_LINES
WHERE ATTRIBUTE1 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE2'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_LINES
WHERE ATTRIBUTE2 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE3'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_LINES
WHERE ATTRIBUTE3 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE4'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_LINES
WHERE ATTRIBUTE4 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE5'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_LINES
WHERE ATTRIBUTE5 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE6'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_LINES
WHERE ATTRIBUTE6 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE7'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_LINES
WHERE ATTRIBUTE7 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE8'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_LINES
WHERE ATTRIBUTE8 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE9'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_LINES
WHERE ATTRIBUTE9 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE10'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_LINES
WHERE ATTRIBUTE10 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE11'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_LINES
WHERE ATTRIBUTE11 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE12'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_LINES
WHERE ATTRIBUTE12 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE13'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_LINES
WHERE ATTRIBUTE13 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE14'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_LINES
WHERE ATTRIBUTE14 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE15'' "COLUMN NAME", count(*) "COUNT" FROM QP_LIST_LINES
WHERE ATTRIBUTE15 LIKE ''% ''',
      p_title                  => 'Count of Records with Columns in Table QP_LIST_LINES with Trailing Spaces.',
      p_fail_condition         => '[COUNT] > [0]',
      p_problem_descr          => 'Trailing spaces in table QP_LIST_LINES.',
      p_solution               => 'This data could result in Error OE_LOCK_ROW_CHANGED on the price list setup and/or modifier setup forms. <br>
A data fix Service Request will need to be logged with Oracle Support.<br>
When creating the Service Request, upload the output of this analyzer and refer to [2601430/KB691095].<br>
...
',
   ...
   l_info.delete;
debug('end add_signature: PRICING_BLANK_QP_LIST_LINES');



debug('begin add_signature: PRICING_BLANK_QP_LIST_LINES_SAMPLE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14663',
      p_sig_id                 => 'PRICING_BLANK_QP_LIST_LINES_SAMPLE',
      p_sig_sql                => 'SELECT LIST_LINE_ID,
       ''ATTRIBUTE1'' "COLUMN NAME"
FROM   QP_LIST_LINES
WHERE  ATTRIBUTE1 LIKE ''% ''
UNION
...
FROM   QP_LIST_LINES
WHERE  ATTRIBUTE15 LIKE ''% ''',
      p_title                  => 'Records With Trailing Spaces That Are Present in Table QP_LIST_LINES.',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Trailing spaces in table QP_LIST_LINES.
',
      p_solution               => 'This data could result in Error OE_LOCK_ROW_CHANGED on the price list setup and/or modifier setup forms. <br>
...
',
   ...
   l_info.delete;
debug('end add_signature: PRICING_BLANK_QP_LIST_LINES_SAMPLE');



debug('begin add_signature: PRICING_BLANK_QP_PRICING_ATTRIBUTES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13939',
      p_sig_id                 => 'PRICING_BLANK_QP_PRICING_ATTRIBUTES',
      p_sig_sql                => 'SELECT ''ATTRIBUTE1'' "COLUMN NAME", count(*) "COUNT" FROM QP_PRICING_ATTRIBUTES
WHERE ATTRIBUTE1 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE2'' "COLUMN NAME", count(*) "COUNT" FROM QP_PRICING_ATTRIBUTES
WHERE ATTRIBUTE2 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE3'' "COLUMN NAME", count(*) "COUNT" FROM QP_PRICING_ATTRIBUTES
WHERE ATTRIBUTE3 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE4'' "COLUMN NAME", count(*) "COUNT" FROM QP_PRICING_ATTRIBUTES
WHERE ATTRIBUTE4 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE5'' "COLUMN NAME", count(*) "COUNT" FROM QP_PRICING_ATTRIBUTES
WHERE ATTRIBUTE5 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE6'' "COLUMN NAME", count(*) "COUNT" FROM QP_PRICING_ATTRIBUTES
WHERE ATTRIBUTE6 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE7'' "COLUMN NAME", count(*) "COUNT" FROM QP_PRICING_ATTRIBUTES
WHERE ATTRIBUTE7 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE8'' "COLUMN NAME", count(*) "COUNT" FROM QP_PRICING_ATTRIBUTES
WHERE ATTRIBUTE8 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE9'' "COLUMN NAME", count(*) "COUNT" FROM QP_PRICING_ATTRIBUTES
WHERE ATTRIBUTE9 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE10'' "COLUMN NAME", count(*) "COUNT" FROM QP_PRICING_ATTRIBUTES
WHERE ATTRIBUTE10 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE11'' "COLUMN NAME", count(*) "COUNT" FROM QP_PRICING_ATTRIBUTES
WHERE ATTRIBUTE11 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE12'' "COLUMN NAME", count(*) "COUNT" FROM QP_PRICING_ATTRIBUTES
WHERE ATTRIBUTE12 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE13'' "COLUMN NAME", count(*) "COUNT" FROM QP_PRICING_ATTRIBUTES
WHERE ATTRIBUTE13 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE14'' "COLUMN NAME", count(*) "COUNT" FROM QP_PRICING_ATTRIBUTES
WHERE ATTRIBUTE14 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE15'' "COLUMN NAME", count(*) "COUNT" FROM QP_PRICING_ATTRIBUTES
WHERE ATTRIBUTE15 LIKE ''% ''',
      p_title                  => 'Count of Records with Columns in Table QP_PRICING_ATTRIBUTES with Trailing Spaces.',
      p_fail_condition         => '[COUNT] > [0]',
      p_problem_descr          => 'Trailing spaces in table QP_PRICING_ATTRIBUTES.',
      p_solution               => 'This data could result in Error OE_LOCK_ROW_CHANGED on the price list setup and/or modifier setup forms. <br>
A data fix Service Request will need to be logged with Oracle Support.<br>
When creating the Service Request, upload the output of this analyzer and refer to [2601430/KB691095].<br>
...
',
   ...
   l_info.delete;
debug('end add_signature: PRICING_BLANK_QP_PRICING_ATTRIBUTES');



debug('begin add_signature: PRICING_BLANK_QP_PRICING_ATTRIBUTES_SAMPLE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14664',
      p_sig_id                 => 'PRICING_BLANK_QP_PRICING_ATTRIBUTES_SAMPLE',
      p_sig_sql                => 'SELECT LIST_LINE_ID,
       ''ATTRIBUTE1'' "COLUMN NAME"
FROM   QP_PRICING_ATTRIBUTES
WHERE  ATTRIBUTE1 LIKE ''% ''
...
FROM   QP_PRICING_ATTRIBUTES
WHERE  ATTRIBUTE15 LIKE ''% ''',
      p_title                  => 'Records With Trailing Spaces That Are Present in Table QP_PRICING_ATTRIBUTES.',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Trailing spaces in table QP_PRICING_ATTRIBUTES.
...
',
   ...
   l_info.delete;
debug('end add_signature: PRICING_BLANK_QP_PRICING_ATTRIBUTES_SAMPLE');
...
debug('begin add_signature: PRICING_BLANK_QP_QUALIFIERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13940',
      p_sig_id                 => 'PRICING_BLANK_QP_QUALIFIERS',
      p_sig_sql                => 'SELECT ''ATTRIBUTE1'' "COLUMN NAME", count(*) "COUNT" FROM QP_QUALIFIERS
WHERE ATTRIBUTE1 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE2'' "COLUMN NAME", count(*) "COUNT" FROM QP_QUALIFIERS
WHERE ATTRIBUTE2 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE3'' "COLUMN NAME", count(*) "COUNT" FROM QP_QUALIFIERS
WHERE ATTRIBUTE3 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE4'' "COLUMN NAME", count(*) "COUNT" FROM QP_QUALIFIERS
WHERE ATTRIBUTE4 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE5'' "COLUMN NAME", count(*) "COUNT" FROM QP_QUALIFIERS
WHERE ATTRIBUTE5 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE6'' "COLUMN NAME", count(*) "COUNT" FROM QP_QUALIFIERS
WHERE ATTRIBUTE6 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE7'' "COLUMN NAME", count(*) "COUNT" FROM QP_QUALIFIERS
WHERE ATTRIBUTE7 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE8'' "COLUMN NAME", count(*) "COUNT" FROM QP_QUALIFIERS
WHERE ATTRIBUTE8 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE9'' "COLUMN NAME", count(*) "COUNT" FROM QP_QUALIFIERS
WHERE ATTRIBUTE9 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE10'' "COLUMN NAME", count(*) "COUNT" FROM QP_QUALIFIERS
WHERE ATTRIBUTE10 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE11'' "COLUMN NAME", count(*) "COUNT" FROM QP_QUALIFIERS
WHERE ATTRIBUTE11 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE12'' "COLUMN NAME", count(*) "COUNT" FROM QP_QUALIFIERS
WHERE ATTRIBUTE12 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE13'' "COLUMN NAME", count(*) "COUNT" FROM QP_QUALIFIERS
WHERE ATTRIBUTE13 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE14'' "COLUMN NAME", count(*) "COUNT" FROM QP_QUALIFIERS
WHERE ATTRIBUTE14 LIKE ''% ''
UNION
SELECT ''ATTRIBUTE15'' "COLUMN NAME", count(*) "COUNT" FROM QP_QUALIFIERS
WHERE ATTRIBUTE15 LIKE ''% ''',
      p_title                  => 'Count of Records with Columns in Table QP_QUALIFIERS with Trailing Spaces.',
      p_fail_condition         => '[COUNT] > [0]',
      p_problem_descr          => 'Trailing spaces in table QP_QUALIFIERS. 
',
      p_solution               => 'This could result in Error OE_LOCK_ROW_CHANGED on the price list setup and/or modifier setup forms. <br>
A data fix Service Request will need to be logged with Oracle Support.<br>
When creating the Service Request, upload the output of this analyzer and refer to [2601430/KB691095].
',
      p_success_msg            => 'No trailing spaces are present in this data.',
   ...
   l_info.delete;
debug('end add_signature: PRICING_BLANK_QP_QUALIFIERS');



debug('begin add_signature: PRICING_BLANK_QP_QUALIFIERS_SAMPLE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14665',
      p_sig_id                 => 'PRICING_BLANK_QP_QUALIFIERS_SAMPLE',
      p_sig_sql                => 'SELECT QUALIFIER_ID,
       ''ATTRIBUTE1'' "COLUMN NAME"
FROM   QP_QUALIFIERS
WHERE  ATTRIBUTE1 LIKE ''% ''
UNION
...
FROM   QP_QUALIFIERS
WHERE  ATTRIBUTE15 LIKE ''% ''',
      p_title                  => 'Records With Trailing Spaces That Are Present in Table QP_QUALIFIERS.',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Trailing spaces in table QP_QUALIFIERS.
',
      p_solution               => 'Data can result in price list setup form/modifier setup form error OE_LOCK_ROW_CHANGED. <br> 
A data fix service request(SR) will need to be logged with Oracle Support.<br> 
When creating the service request, upload the output of this analyzer <br>
and refer to [2601430/KB691095] - Price List Line Shows Error OE_LOCK_ROW_CHANGED',
      p_success_msg            => 'No trailing spaces are present in this data.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_BLANK_QP_QUALIFIERS_SAMPLE');



debug('begin add_signature: PRICING_PLL_QUALIFICATION_IND_IS_NULL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14971',
      p_sig_id                 => 'PRICING_PLL_QUALIFICATION_IND_IS_NULL',
      p_sig_sql                => 'SELECT LIST_LINE_ID,
       LIST_HEADER_ID,
       LIST_LINE_TYPE_CODE
FROM   QP_LIST_LINES
WHERE  QUALIFICATION_IND IS NULL
       AND LIST_LINE_TYPE_CODE = ''PLL''',
      p_title                  => 'Records with Missing Value for  Column QUALIFICATION_IND  in Table QP_LIST_LINES',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Price list lines which are missing their QUALIFICATION_IND value.',
      p_solution               => 'Please refer to the solution in [466320/KB233864] - Cannot Add Item To Price List as it Errors <br>
With ORA-00001: unique constraint (QP.QP_LIST_LINES_U1) <br>
violated in Package QP_Price_List_line_Util Procedures Insert_Row ',
      p_success_msg            => 'The QUALIFICATION_IND value is populated in table QP_LIST_LINES.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_PLL_QUALIFICATION_IND_IS_NULL');



debug('begin add_signature: PRICING_INDEX_POSITIONS_QP_LIST_LINES_U1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14969',
      p_sig_id                 => 'PRICING_INDEX_POSITIONS_QP_LIST_LINES_U1',
      p_sig_sql                => 'SELECT INDEX_NAME,
       COLUMN_NAME,
       COLUMN_POSITION
FROM   ALL_IND_COLUMNS
WHERE  TABLE_NAME = ''QP_LIST_LINES''
       AND INDEX_NAME = ''QP_LIST_LINES_U1''
ORDER  BY COLUMN_POSITION',
      p_title                  => 'Columns For Index QP_LIST_LINES_U1',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Reviewing the columns and their positions as defined for index QP_LIST_LINES_U1.',
      p_solution               => 'One should have the definition for index QP_LIST_LINES_U1. <br>
Please log a Service Request with Oracle Support.<br>
When creating the Service Request, upload the output of this analyzer and refer to [466320/KB233864] 
',
      p_success_msg            => 'Columns with their position as defined on index QP_LIST_LINES_U1.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_INDEX_POSITIONS_QP_LIST_LINES_U1');



debug('begin add_signature: PRICING_MAX_LIST_LINE_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14970',
      p_sig_id                 => 'PRICING_MAX_LIST_LINE_ID',
      p_sig_sql                => 'SELECT Max(LIST_LINE_ID)
FROM   QP_LIST_LINES',
      p_title                  => 'Highest  LIST_LINE_ID Value Stored in Table QP_LIST_LINES.',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Largest list_line_id value from table QP_LIST_LINES.',
      p_solution               => 'Create a test modifier or price list, then re-run this analyzer to see the highest list_line_id value.
',
      p_success_msg            => 'No action needed. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_MAX_LIST_LINE_ID');



debug('begin add_signature: PRICING_DUPLICATE_ATTRIBUTES_COUNT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14189',
      p_sig_id                 => 'PRICING_DUPLICATE_ATTRIBUTES_COUNT',
      p_sig_sql                => 'SELECT qll.LIST_LINE_ID,
       Count(*) "Dup_Count"
FROM   QP_PRICING_ATTRIBUTES qpa,
       QP_LIST_LINES qll
WHERE  1 = 1
       ...
       AND qll.LIST_LINE_TYPE_CODE IN ( ''PLL'', ''PBH'' )
       AND PRICING_ATTRIBUTE_CONTEXT IS NULL
       AND PRICING_ATTRIBUTE IS NULL
       AND EXCLUDER_FLAG = ''N''
GROUP  BY qll.LIST_LINE_ID
HAVING Count(*) > 1
ORDER BY 1',
      p_title                  => 'Duplicate Pricing Attributes',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Duplicate pricing attribute records are present.',
      p_solution               => 'A data fix Service Request will need to be logged with Oracle Support.  When creating the Service Request, upload the output of this analyzer and refer to [2195557/KB790578] - Finding Item on Price List Errors with ORA-01427 : Single-row Subquery Returns More Than One Row.',
      p_success_msg            => 'Data validated; No duplicate pricing attribute records.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_DUPLICATE_ATTRIBUTES_COUNT');



debug('begin add_signature: PRICING_ORPHANED_PRICING_ATTRIBUTES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14666',
      p_sig_id                 => 'PRICING_ORPHANED_PRICING_ATTRIBUTES',
      p_sig_sql                => 'SELECT PRICING_ATTRIBUTE_ID,
       LIST_LINE_ID,
       LIST_HEADER_ID
FROM   QP_PRICING_ATTRIBUTES
WHERE  LIST_LINE_ID NOT IN (SELECT LIST_LINE_ID
                            FROM   QP_LIST_LINES)',
      p_title                  => 'Orphaned Pricing Attribute Records',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Records shown are for orphaned pricing attribute records.',
      p_solution               => 'A data fix Service Request will need to be logged with Oracle Support. <br>
When creating the Service Request, upload the output of this analyzer <br>
and refer to [2121055/KB780803] - Unable to Update End Date of Price List Line <br>
"The effective dates for a price list line overlap with another line having effective start date" ',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_ORPHANED_PRICING_ATTRIBUTES');



debug('begin add_signature: PRICING_COUNT_TRANSACTION_TYPE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14169',
      p_sig_id                 => 'PRICING_COUNT_TRANSACTION_TYPE',
      p_sig_sql                => 'SELECT COUNT(*), A.TRANSACTION_TYPE_CODE, A.ENFORCE_LINE_PRICES_FLAG
FROM OE_TRANSACTION_TYPES_TL B,
     OE_TRANSACTION_TYPES_ALL A
WHERE B.TRANSACTION_TYPE_ID = A.TRANSACTION_TYPE_ID
GROUP BY A.TRANSACTION_TYPE_CODE, A.ENFORCE_LINE_PRICES_FLAG
ORDER BY A.TRANSACTION_TYPE_CODE DESC, A.ENFORCE_LINE_PRICES_FLAG DESC',
      p_title                  => 'Count By Transaction Types and Enforce List Price Flag That Are Assigned to Order Management Order Headers and Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Count of transaction types.',
      p_solution               => 'Verify the setting for the transaction type you are using for your issue.',
      p_success_msg            => 'Data is validated; Count of transaction types by enforce list price flag value.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_COUNT_TRANSACTION_TYPE');



debug('begin add_signature: PRICING_COUNT_TRANSACTION_TYPE_ENFORCE_PRICE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14170',
      p_sig_id                 => 'PRICING_COUNT_TRANSACTION_TYPE_ENFORCE_PRICE',
      p_sig_sql                => 'SELECT B.NAME,
       A.TRANSACTION_TYPE_CODE
FROM   OE_TRANSACTION_TYPES_TL B,
       OE_TRANSACTION_TYPES_ALL A
WHERE  B.TRANSACTION_TYPE_ID = A.TRANSACTION_TYPE_ID
       AND A.ENFORCE_LINE_PRICES_FLAG = ''Y''
ORDER  BY 2,
          1',
      p_title                  => 'OM Transaction Type Names Which Have Enforce List Price Enabled on Headers or Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Transaction Type Names with Enforce List Price Enabled ',
      p_solution               => 'Verify if one of these transaction types are used on your issue. 
',
      p_success_msg            => 'These transaction types enforce the list price.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_COUNT_TRANSACTION_TYPE_ENFORCE_PRICE');



debug('begin add_signature: PRICING_TRANSACTION_TYPE_NULL_ENFORCE_PRICE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14171',
      p_sig_id                 => 'PRICING_TRANSACTION_TYPE_NULL_ENFORCE_PRICE',
      p_sig_sql                => 'SELECT distinct B.NAME,
       A.TRANSACTION_TYPE_CODE
FROM   OE_TRANSACTION_TYPES_TL B,
       OE_TRANSACTION_TYPES_ALL A
WHERE  B.TRANSACTION_TYPE_ID = A.TRANSACTION_TYPE_ID
       AND A.ENFORCE_LINE_PRICES_FLAG IS NULL',
      p_title                  => 'Transaction Types with a NULL Enforce List Price',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'OM Transaction Types with a NULL assigned to ''Enforce List Price'' exist.
',
      p_solution               => 'Potential issue is shown with this data. <br>  
Refer to [2641789/KB742314#OnlineDisc] - APP-ONT-250271 Online Discounting is Not Allowed Order Type Enforces List Prices Even When Enforce List Price is NOT Enabled ',
      p_success_msg            => 'No actions needed.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_TRANSACTION_TYPE_NULL_ENFORCE_PRICE');



debug('begin add_signature: PRICING_CONTINUOUS_PRICE_BREAK_FLAG_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17061',
      p_sig_id                 => 'PRICING_CONTINUOUS_PRICE_BREAK_FLAG_CHECK',
      p_sig_sql                => 'SELECT count(*), continuous_price_break_flag
FROM   QP_LIST_LINES
WHERE  list_line_type_code = ''PBH''
AND pricing_phase_id = 1
AND continuous_price_break_flag is not null
GROUP BY continuous_price_break_flag',
      p_title                  => 'Continuous Price Break Flag Count',
      p_fail_condition         => 'RSGT1',
      p_problem_descr          => 'There is an issue shown in the data. One should not have the continuous price break flag set to multiple values.
The value should be based off of profile option QP: Continuous Price Breaks.',
      p_solution               => 'Please refer to the solution posted within [2751435/KB780981]',
   ...
   l_info.delete;
debug('end add_signature: PRICING_CONTINUOUS_PRICE_BREAK_FLAG_CHECK');



debug('begin add_signature: PRICING_CONTINUOUS_PRICE_BREAK_FLAG_NOT_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17247',
      p_sig_id                 => 'PRICING_CONTINUOUS_PRICE_BREAK_FLAG_NOT_CHECK',
      p_sig_sql                => 'SELECT list_header_id,
       list_line_id,
...
WHERE  list_line_type_code = ''PBH''
       AND pricing_phase_id = 1
       AND continuous_price_break_flag IS NOT NULL
       AND Rtrim(Ltrim(continuous_price_break_flag)) NOT IN
           (SELECT fpov.profile_option_value Value
            FROM
               FND_PROFILE_OPTION_VALUES fpov,
               FND_PROFILE_OPTIONS_VL fpo
            WHERE
               fpo.profile_option_id = fpov.profile_option_id
               AND fpo.profile_option_name = ''QP_CONTINUOUS_PB'')
       AND ROWNUM < ##$$MAX_ROWS$$##',
      p_title                  => 'Continuous Price Break Flag Count Exceptions Marked Yes',
      p_fail_condition         => 'RSGT1',
      p_problem_descr          => 'There is an issue shown in the data. One should not have data with the continuous price break flag set to multiple values.
The value should be based off of profile option QP: Continuous Price Breaks and consistent throughout the data.',
      p_solution               => 'Please refer to the solution posted within [2751435/KB780981]',
      p_success_msg            => 'No issues found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_CONTINUOUS_PRICE_BREAK_FLAG_NOT_CHECK');



debug('begin add_signature: EBS_MFG_OM_QPALL_DUP_MULTICURRENCY_HEADER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28638',
      p_sig_id                 => 'EBS_MFG_OM_QPALL_DUP_MULTICURRENCY_HEADER',
      p_sig_sql                => 'SELECT currency_header_id,
       Count(base_rounding_factor)
FROM   qp_currency_lists_vl
GROUP  BY currency_header_id
HAVING Count(base_rounding_factor) > 1',
      p_title                  => 'Duplicate Multi-Currency Records',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Duplicate multi-currency records are found.',
      p_solution               => 'Please provide this analyzer and open a Service Request with Oracle Pricing Support to request a data fix script.  Refer to [2300090/KB736762]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_QPALL_DUP_MULTICURRENCY_HEADER');
...
BEGIN
  ...
  analyzer_title := 'Advanced Pricing Analyzer';
...
debug('begin section: SETUP_DETAILS');
start_section('Setup Details', 'SETUP_DETAILS');
   set_item_result(run_stored_sig('PRICING_ENGINE_VERSION'));
   set_item_result(run_stored_sig('PRICING_BASIC_OR_ADVANCED'));
   set_item_result(run_stored_sig('PRICING_ENGINE_TYPE'));
   set_item_result(run_stored_sig('PRICING_ROUNDING_PROFILES'));
   set_item_result(run_stored_sig('PRICING_EVENT_PHASES'));
   set_item_result(run_stored_sig('PRICING_PHASES'));
   set_item_result(run_stored_sig('PRICING_INTERCOMPANY_PHASES'));
end_section;
debug('end section: SETUP_DETAILS');

debug('begin section: PERFORMANCE_AND_STATS');
IF g_sql_tokens('##$$PERFORMANCE_ANALYSIS$$##') = 'Y' THEN
   start_section('Performance and Statistics', 'PERFORMANCE_AND_STATS');
      set_item_result(run_stored_sig('DBSTAT1_FND_STATS_VERSION'));
      set_item_result(run_stored_sig('DBSTAT1_GET_PREFS_OF_DATABASE'));
      set_item_result(run_stored_sig('DBSTAT1_10_PERCENT_MODIFIED'));
      set_item_result(run_stored_sig('DBSTAT1_GSS'));
      set_item_result(run_stored_sig('DBSTAT1_CBO_STATS'));
      set_item_result(run_stored_sig('INVICI_DB_REL_TOOLS'));
      set_item_result(run_stored_sig('PRICING_DBASE_SIZES_CHECK'));
      set_item_result(run_stored_sig('PRICING_TOP5_HIGH_LOAD_STATEMENTS'));
      set_item_result(run_stored_sig('PRICING_TEMP_TABLESPACE_PARAMS'));
      set_item_result(run_stored_sig('PRICING_ALL_DEBUG_VALUES'));
      set_item_result(run_stored_sig('PRICING_BASIC_OR_ADVANCED'));
      set_item_result(run_stored_sig('PRICING_INSTALL_OR_UPGRADE'));
      set_item_result(run_stored_sig('PRICING_LIST_HEADERS_BY_ACTIVE_LIST_TYPE'));
      set_item_result(run_stored_sig('PRICING_LIST_HEADERS_BY_ASK_FOR_FLAG'));
      set_item_result(run_stored_sig('PRICING_COUNT_EXPIRED_ENTITIES'));
      set_item_result(run_stored_sig('PRICING_LIST_LINES_BY_QUAL_IND_AND_TYPE'));
      set_item_result(run_stored_sig('PRICING_LIST_LINES_COUNT_BY_LEVEL_AND_TYPE'));
      set_item_result(run_stored_sig('PRICING_LIST_LINES_COUNT_BY_LEVEL_AND_INCOMPATIBILITIY'));
      set_item_result(run_stored_sig('PRICING_ATTRIBUTES_COUNT_BY_PHASE'));
      set_item_result(run_stored_sig('PRICING_ATTRIBUTE_COUNT_DISTINCT_PHASES'));
      set_item_result(run_stored_sig('PRICING_QUALIFIER_COUNT'));
      set_item_result(run_stored_sig('PRICING_QUALIFIERS_COUNT_BY_DISTINCT_CONTEXT_AND_ATTRIBUTE'));
      set_item_result(run_stored_sig('PRICING_QUALIFIERS_HIGHEST_NON_SELECTIVE'));
      set_item_result(run_stored_sig('PRICING_QUALIFIERS_COUNT_BY_CUSTOMER_AND_SITE'));
      set_item_result(run_stored_sig('PRICING_COUNT_MODIFIERS_WITH_ONLY_PRICE_LIST_QUALIFIER'));
      set_item_result(run_stored_sig('PRICING_QUALIFIERS_COUNT_LINE_LEVEL'));
      set_item_result(run_stored_sig('PRICING_QUALIFIERS_COUNT_QUALIFIER_GROUP_NOT_NEG'));
      set_item_result(run_stored_sig('PRICING_QUALIFIERS_COUNT_BY_OPERATOR'));
      set_item_result(run_stored_sig('PRICING_QUALIFIERS_NON_SELECTIVE_WITH_SEARCH_IND1'));
      set_item_result(run_stored_sig('PRICING_QUALIFIERS_COUNT_DISTINCT_ATTR_VALUE'));
      set_item_result(run_stored_sig('PRICING_MANUAL_ORDER_ADJUSTMENTS_COUNT'));
      set_item_result(run_stored_sig('PRICING_RLTD_MODIFIERS'));
      set_item_result(run_stored_sig('PRICING_PRODUCT_ATTRIBUTES_SELECTIVITY_GREATER100'));
      set_item_result(run_stored_sig('PRICING_ATTRIBUTES_SELECTIVITY_GREATER100'));
      set_item_result(run_stored_sig('PRICING_COUNT_DISTINCT_PRICING_ATTRIBUTES'));
      set_item_result(run_stored_sig('PRICING_COUNT_FORMULAS'));
      set_item_result(run_stored_sig('PRICING_COUNT_FORMULA_LINES'));
      set_item_result(run_stored_sig('PRICING_SALES_ORDER_COUNT'));
      set_item_result(run_stored_sig('PRICING_MODIFIERS_COUNT_BY_AUTO_FLAG'));
      set_item_result(run_stored_sig('PRICING_BLIND_MODIFIERS_SAMPLE'));
      set_item_result(run_stored_sig('PRICING_EVENT_PHASES'));
      set_item_result(run_stored_sig('PRICING_PHASES'));
      set_item_result(run_stored_sig('PRICING_TEMP_TABLES_INDEXES'));
      set_item_result(run_stored_sig('PRICING_COUNT_ ADVANCED_MODIFIERS'));
      set_item_result(run_stored_sig('PRICING_COUNT_ ACTIVE_MODIFIERS_WITH_LIMITS'));
      set_item_result(run_stored_sig('PRICING_SAMPLE_ADVANCED_MODIFIER_DETAILS'));
      set_item_result(run_stored_sig('PRICING_SAMPLE_LIMITS_MODIFIER_DETAILS'));
      set_item_result(run_stored_sig('PRICING_CHANGED_LINES_ADVANCED_MODIFIER_COUNT'));
      set_item_result(run_stored_sig('PRICING_CHANGED_LINES_ADVANCED_MODIFIER_DETAILS'));
      set_item_result(run_stored_sig('PRICING_PRICE_LIST_BIG_SEARCH_OR_NOT'));
   end_section;
END IF;
debug('end section: PERFORMANCE_AND_STATS');

debug('begin section: PRICING_SECURITY');
IF g_sql_tokens('##$$PRICING_SECURITY$$##') = 'Y' THEN
   start_section('Pricing Security', 'PRICING_SECURITY');
      set_item_result(run_stored_sig('PRICING_SECURITY_DEBUG_VALUES'));
      set_item_result(run_stored_sig('PRICING_SECURITY_PACKAGE_VERSIONS'));
      set_item_result(run_stored_sig('PRICING_SECURITY_VIEW_DEF_QP_SECU_LIST_HEADERS_V'));
      set_item_result(run_stored_sig('PRICING_SECURITY_VIEW_DEF_QP_SECU_LIST_HEADERS_VL'));
      set_item_result(run_stored_sig('PRICING_SECURITY_FND_FORM_FUNCTIONS'));
      set_item_result(run_stored_sig('PRICING_SECURITY_FND_COMPILED_MENU_FUNCTIONS'));
      set_item_result(run_stored_sig('PRICING_SECURITY_FND_GRANTS'));
      set_item_result(run_stored_sig('PRICING_SECURITY_FND_OBJECT_INSTANCE_SETS'));
      set_item_result(run_stored_sig('EBS_MFG_OM_QPALL_PRICING_SECURITY_PRIVILEGES'));
   end_section;
END IF;
debug('end section: PRICING_SECURITY');

debug('begin section: PRICING_BULK_LOADER_DATA_EVALUATION');
IF g_sql_tokens('##$$PRICE_LIST_BULK_LOADER$$##') = 'Y' THEN
   start_section('Price List Bulk Load Data Evaluation', 'PRICING_BULK_LOADER_DATA_EVALUATION');
      set_item_result(run_stored_sig('PRICING_BULK_LOADER_PROFILES'));
      set_item_result(run_stored_sig('PRICING_BULK_LOADER_PACKAGE_VERSIONS'));
      set_item_result(run_stored_sig('PRICING_HEADER_MISSING_ORIG_SYSTEM_HEADER_REF'));
      set_item_result(run_stored_sig('PRICING_HEADER_MISSING_ORIG_SYS_LINE_REF'));
      set_item_result(run_stored_sig('PRICING_LIST_LINES_MISSING_ORIG_SYSTEM_HEADER_REF'));
      set_item_result(run_stored_sig('PRICING_ATTRIBUTES_MISSING_ORIG_SYS_HEADER_REF'));
      set_item_result(run_stored_sig('PRICING_ATTRIBUTES_MISSING_ORIG_SYS_LINE_REF'));
      set_item_result(run_stored_sig('PRICING_ATTRIBUTES_MISSING_ORIG_SYS_PRICING_ATTR_REF'));
      set_item_result(run_stored_sig('PRICING_QUALIFIERS_MISSING_ORIG_SYS_QUALIFER_REF'));
      set_item_result(run_stored_sig('PRICING_QP_INTERFACE_ERRORS'));
   end_section;
END IF;
debug('end section: PRICING_BULK_LOADER_DATA_EVALUATION');

debug('begin section: APPS_CHECK');
IF g_sql_tokens('##$$APPS_CHECK$$##') = 'Y' THEN
   start_section('Diagnostic Apps Check', 'APPS_CHECK');
...
debug('begin section: PRICING_DATA_VALIDATION');
IF g_sql_tokens('##$$PRICING_DATA_ANALYSIS$$##') = 'Y' THEN
   start_section('Data Validation', 'PRICING_DATA_VALIDATION');
      set_item_result(run_stored_sig('PRICING_MODIFIER_PRIMARY_UOM_FLAG_VALIDATION'));
      set_item_result(run_stored_sig('PRICING_MODIFIER_REPRICE_FLAG_VALIDATION'));
      set_item_result(run_stored_sig('PRICING_MODIFIER_REVISION_DATE_VALIDATION'));
      set_item_result(run_stored_sig('EBS_MFG_OM_QPALL_PRICING_INACTIVE_QUALIFIERS'));
      set_item_result(run_stored_sig('PRICING_BLANK_QP_LIST_HEADERS'));
      set_item_result(run_stored_sig('PRICING_BLANK_QP_LIST_HEADERS_SAMPLE'));
      set_item_result(run_stored_sig('PRICING_BLANK_QP_LIST_HEADERS_B'));
      set_item_result(run_stored_sig('PRICING_BLANK_QP_LIST_HEADERS_B_SAMPLE'));
      set_item_result(run_stored_sig('PRICING_BLANK_QP_LIST_HEADERS_TL'));
      set_item_result(run_stored_sig('PRICING_BLANK_QP_LIST_HEADERS_TL_SAMPLE'));
      set_item_result(run_stored_sig('PRICING_BLANK_QP_LIST_LINES'));
      set_item_result(run_stored_sig('PRICING_BLANK_QP_LIST_LINES_SAMPLE'));
      set_item_result(run_stored_sig('PRICING_BLANK_QP_PRICING_ATTRIBUTES'));
      set_item_result(run_stored_sig('PRICING_BLANK_QP_PRICING_ATTRIBUTES_SAMPLE'));
      set_item_result(run_stored_sig('PRICING_MODIFIER_IN_ACROSS_ALL_PHASES'));
      set_item_result(run_stored_sig('PRICING_BLANK_QP_QUALIFIERS'));
      set_item_result(run_stored_sig('PRICING_BLANK_QP_QUALIFIERS_SAMPLE'));
      set_item_result(run_stored_sig('PRICING_PLL_QUALIFICATION_IND_IS_NULL'));
      set_item_result(run_stored_sig('PRICING_INDEX_POSITIONS_QP_LIST_LINES_U1'));
      set_item_result(run_stored_sig('PRICING_MAX_LIST_LINE_ID'));
      set_item_result(run_stored_sig('PRICING_DUPLICATE_ATTRIBUTES_COUNT'));
      set_item_result(run_stored_sig('PRICING_ORPHANED_PRICING_ATTRIBUTES'));
      set_item_result(run_stored_sig('PRICING_COUNT_TRANSACTION_TYPE'));
      set_item_result(run_stored_sig('PRICING_COUNT_TRANSACTION_TYPE_ENFORCE_PRICE'));
      set_item_result(run_stored_sig('PRICING_TRANSACTION_TYPE_NULL_ENFORCE_PRICE'));
      set_item_result(run_stored_sig('PRICING_CONTINUOUS_PRICE_BREAK_FLAG_CHECK'));
      set_item_result(run_stored_sig('PRICING_CONTINUOUS_PRICE_BREAK_FLAG_NOT_CHECK'));
      set_item_result(run_stored_sig('EBS_MFG_OM_QPALL_DUP_MULTICURRENCY_HEADER'));
   end_section('Pricing Data is Validated.');
END IF;
debug('end section: PRICING_DATA_VALIDATION');
