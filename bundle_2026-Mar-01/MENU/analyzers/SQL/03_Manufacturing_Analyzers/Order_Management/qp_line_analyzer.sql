...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Advanced Pricing List Line Analyzer    |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE qp_line_analyzer_pkg AUTHID DEFINER AS
...
END qp_line_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY qp_line_analyzer_pkg AS
-- $Id: qp_line_analyzer.sql, 200.51 2026/01/27 20:26:07 cschmehl Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2096583.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'QPLINE_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'QPLINE_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>QPLINE Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2096583.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/qp_line_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,543,EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,543,EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},543,EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/3899941" class="blacklink" target="new">
...
EBS_ATG_UGLE_SEQUENCES_CLOSE_TO_MAXIMUM_VALUE_BELOW_12C</p><p>Signature Formula Information, PRICE_LIST_FORMULA_INFO, was updated to provide the details of the Formula if Formula is associated to the "Related List Line Information" section.</p>
            <br><br>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,543,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,543,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},543,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
FUNCTION get_HEADERID
   return VARCHAR2 IS
BEGIN
debug('begin sql token function: HEADERID');
BEGIN
...
EXCEPTION WHEN NO_DATA_FOUND THEN
     return null;
END;
debug('end sql token function: HEADERID');
END get_HEADERID;

FUNCTION get_PHASEID
   return VARCHAR2 IS
BEGIN
debug('begin sql token function: PHASEID');
BEGIN
     select distinct pricing_phase_id
     into l_system_function_var
     from  qp_list_lines
     where list_line_id = p_list_line_id;
     return l_system_function_var;
EXCEPTION WHEN NO_DATA_FOUND THEN
     return null;
END;
debug('end sql token function: PHASEID');
END get_PHASEID;
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'List Line ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_list_line_id,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  l_revision := rtrim(replace('$Revision: 200.51  $','$',''));
  l_revision := ltrim(replace(l_revision,'Revision:',''));
  l_date_char := rtrim(replace('$Date: 2026/01/27 20:26:06 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'qp_line_analyzer.sql';
...
debug('begin parameter validation: p_list_line_id');
IF p_list_line_id IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter List Line ID is required.');
...
INTO l_exists_val
FROM QP_LIST_LINES
WHERE LIST_LINE_ID = p_list_line_id and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid List Line ID provided.  Process cannot continue.  list_line_id can be found by position the cursor on list line in the pricelist / modifierlist form menu Help > Diagnostics > Examine > Field List_Line_Id value.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_list_line_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_list_line_id');
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$HEADERID$$##') := get_HEADERID();
   l_system_function_var := null;
   g_masked_tokens('##$$HEADERID$$##') := mask_text( g_sql_tokens('##$$HEADERID$$##'), 'NO_MASK');
   g_sql_tokens('##$$LISTLINEID$$##') := p_list_line_id;
   g_masked_tokens('##$$LISTLINEID$$##') := mask_text( g_sql_tokens('##$$LISTLINEID$$##'), 'NO_MASK');
   g_sql_tokens('##$$PHASEID$$##') := get_PHASEID();
   l_system_function_var := null;
   g_masked_tokens('##$$PHASEID$$##') := mask_text( g_sql_tokens('##$$PHASEID$$##'), 'NO_MASK');
...
debug('begin add_signature: PRICE_LIST_LINE_HEADER_INFO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2563',
      p_sig_id                 => 'PRICE_LIST_LINE_HEADER_INFO',
      p_sig_sql                => 'SELECT a.list_header_id        "List Header ID",
       b.description          "Name",
       b.name                  "Number",
       a.global_flag           "Global Flag",
       a.orig_org_id           "Org ID",
       a.sold_to_org_id        "Sold To Org ID",
       a.list_type_code        "List Type Code",
       (select meaning from qp_lookups where lookup_type=''LIST_TYPE_CODE'' and lookup_code=a.list_type_code) "List Type",
       a.active_flag           "Active Flag",
       a.automatic_flag        "Automatic Flag",
       to_char(a.start_date_active,''DD-MON-YY'' ) "Active Start Date",
       to_char(a.end_date_active,''DD-MON-YY'') "Active End Date",
       a.source_system_code    "Source System Code",
       a.pte_code              "PTE Code",
       a.currency_code         "Currency Code",
       a.currency_header_id    "Currency Header ID",
       a.gsa_indicator         "GSA Indicator",
       a.limit_exists_flag     "Limit Exists Flag",
       a.orig_system_header_ref   "Orig Sys Header Ref"
FROM qp_list_headers_b   a,
     qp_list_headers_tl  b
WHERE a.list_header_id = b.list_header_id
  AND b.language=''US''
  AND a.list_header_id = ##$$HEADERID$$##',
      p_title                  => 'List Header Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Unable to locate the Price List Line Header.',
      p_solution               => '<ul>
<li>List Type - verify it is the list type you are expecting, PRL for Pricelist, SLT, DLT, PRO... for modifier.</li>
<li>Active - verify it is ''Y''.</li>
<li>Start Date, End Date - verify pricing date is between Start Date and End Date, blank means no restrictions.</li>
<li>Currency - should match the currency in the sales order.</li>
<li>Ask For - if ''Y'' for promotion, then promotion will not be applied until it is ''asked for'' from calling program.</li>
</ul>',
      p_success_msg            => '<ul>
<li>List Type - verify it is the list type you are expecting, PRL for Pricelist, SLT, DLT, PRO... for modifier.</li>
<li>Active - verify it is ''Y''.</li>
...
<li>Ask For - if ''Y'' for promotion, then promotion will not be applied until it is ''asked for'' from calling program.</li>
   ...
   l_info.delete;
debug('end add_signature: PRICE_LIST_LINE_HEADER_INFO');



debug('begin add_signature: PRICE_LIST_LINE_HEADER_CURRENCY_CONVERSION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2919',
      p_sig_id                 => 'PRICE_LIST_LINE_HEADER_CURRENCY_CONVERSION',
      p_sig_sql                => 'select qpa.currency_header_id    "Currency Header ID"
  , qpa.currency_detail_id       "Currency Detail ID"
  , qpa.to_currency_code         "To Currency Code"
  , qpa.conversion_type          "Conversion Type"
  , qpa.start_date_active        "Start Date Active"
  , qpa.end_date_active          "End Date Active"
  , qpa.creation_date            "Creation Date"
from qp_currency_details qpa, qp_list_headers_b a
where a.list_header_id = ##$$HEADERID$$##
and a.currency_header_id = qpa.currency_header_id
and a.list_type_code = ''PRL''
order by qpa.start_date_active DESC',
      p_title                  => 'Multi-Currency Conversion Detail',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No details of Multi-Currency Pricing found.',
      p_solution               => '<ul>
<li>No details of Multi-Currency Pricing found.</li>
<li>If Multi-Currency is needed, refer to Multi-Currency Conversion Setup [787912/KB625910].</li>
</ul>',
      p_success_msg            => 'Multi-Currency Pricing Details',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICE_LIST_LINE_HEADER_CURRENCY_CONVERSION');



debug('begin add_signature: PRICE_LIST_LINE_HEADER_MODIFERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2567',
      p_sig_id                 => 'PRICE_LIST_LINE_HEADER_MODIFERS',
      p_sig_sql                => 'select  a.list_header_id      "List Header ID"
	 , b.name              "Name"
	 , b.language		"Language"
	 , a.parent_list_header_id	"Parent List Header ID"
	 , a.ask_for_flag        ask_for_flag
	 , a.active_date_first_type	"First Active Date Type"
	 , to_char(a.start_date_active_first, ''DD-MON-YY'')||'' - ''|| to_char(a.end_date_active_first, ''DD-MON-YY'') "First Active Date"
	 , a.active_date_second_type "Second Active Date Type"
	 , to_char(a.start_date_active_second, ''DD-MON-YY'')||'' - ''|| to_char(a.end_date_active_second, ''DD-MON-YY'') "Second Active Date"
from  qp_list_headers_b a , qp_list_headers_tl b
where a.list_header_id = b.list_header_id
  and a.list_header_id = ##$$HEADERID$$##
  and a.list_type_code <> ''PRL''',
      p_title                  => 'List Header Information - Modifiers List',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Modifiers found for this Price List Header.',
      p_solution               => 'Price List Header Modifiers',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PRICE_LIST_LINE_HEADER_MODIFERS');



debug('begin add_signature: PRICE_LIST_LINE_HEADER_MOBILE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2568',
      p_sig_id                 => 'PRICE_LIST_LINE_HEADER_MOBILE',
      p_sig_sql                => 'select  a.list_header_id      "List Header ID"
	 , b.name              "Name" 
	 , b.language		"Language"
	 , a.mobile_download "Mobile Download"
	 , a.rounding_factor	"Rounding Factor"
	 , a.terms_id      "Payment Terms"
	 , a.freight_terms_code	"Freight Terms"
	 , a.ship_method_code "Freight Carrier"
from  qp_list_headers_b a , qp_list_headers_tl b
where a.list_header_id = b.list_header_id
  and a.list_header_id = ##$$HEADERID$$##
  and a.list_type_code = ''PRL''',
      p_title                  => 'List Header Information - Mobile',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Mobile information for this Price List Header.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PRICE_LIST_LINE_HEADER_MOBILE');



debug('begin add_signature: QP_PRICING_ATTRIBUTES_DUP_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9638',
      p_sig_id                 => 'QP_PRICING_ATTRIBUTES_DUP_CHECK',
...
AND qll.list_header_id         =##$$HEADERID$$##
...
HAVING COUNT(*)>1',
      p_title                  => 'Duplicate Pricing Attribute Check',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Duplicate pricing attribute exist for this List Header ID.',
      p_solution               => '<p>A Datafix Service Request will need to be logged with Oracle Support.<br />When creating the Service Request, upload the output of this analyzer and refer to [2195557/KB790578].</p>',
      p_success_msg            => 'No duplicate pricing attribute exist for this List Header ID.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: QP_PRICING_ATTRIBUTES_DUP_CHECK');



debug('begin add_signature: EBS_MFG_OM_QPLINE_EBS_MFG_OM_QPLIST_PRICING_SECURITY_PRIVILEGES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25621',
      p_sig_id                 => 'EBS_MFG_OM_QPLINE_EBS_MFG_OM_QPLIST_PRICING_SECURITY_PRIVILEGES',
      p_sig_sql                => 'SELECT *
FROM   (SELECT DISTINCT qpgrant.grant_id,
        ...
        WHERE  qpgrant.object_id = fndobjects.object_id
               ...
               AND qpgrant.instance_id =  ##$$HEADERID$$##  
...
ORDER  BY object_name ASC, grantee_name',
      p_title                  => 'Pricing Entity Privileges',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'List of Pricing Security Privileges Assigned',
      p_solution               => 'Please review the list to determine if applicable privileges are assigned.
',
      p_success_msg            => 'Privileges assigned to the pricing entity',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_QPLINE_EBS_MFG_OM_QPLIST_PRICING_SECURITY_PRIVILEGES');



debug('begin add_signature: PRICE_LIST_LINE_INFO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2588',
      p_sig_id                 => 'PRICE_LIST_LINE_INFO',
      p_sig_sql                => 'SELECT decode(greatest(a.list_line_id, 9999999999), 9999999999, '' '',''%'')
       || substr(a.list_line_id, greatest(length(a.list_line_id) - 10, 1), 10) "List Line ID",
       a.list_header_id                                 "List Header ID",
       a.list_line_type_code                            "List Line Type Code",
       (SELECT meaning 
        FROM   qp_lookups 
        WHERE  lookup_type = ''LIST_LINE_TYPE_CODE''
          AND lookup_code = a.list_line_type_code)      "List Line Type",
       to_char(a.start_date_active, ''DD-MON-YY'')        "Active Start Date",
       to_char(a.end_date_active, ''DD-MON-YY'')          "Active End Date",
       a.modifier_level_code                            "Modifier Level Code",
       substr(b.name, 1, 50)                            "Pricing Phase",
       a.pricing_phase_id                               "Pricing Phase ID",
       a.incompatibility_grp_code                       "Incompatibility Group Code",
       a.price_break_type_code                          "Price Break Type",
       a.operand                                        "Operand",
       a.arithmetic_operator                            "Arithmetic Operator",
       a.price_by_formula_id                            "Price By Formula ID",
       a.qualification_ind                              "Qualification Ind",
       a.product_precedence                             "Product Precedence",
       a.automatic_flag                                 "Automatic Flag",
       a.override_flag                                  "Override Flag",
       a.substitution_context                           "Terms Substitution",
       a.substitution_attribute                         "Terms Attribute",
       a.substitution_value                             "Terms Value",
       a.include_on_returns_flag                        "Include on Returns Flag",
       a.pricing_group_sequence                         "Bucket",
       a.orig_sys_header_ref                            "Orig Sys Header Ref",
       a.orig_sys_line_ref                              "Orig Sys Line Ref",
       a.creation_date  "Creation Date"
FROM   qp_list_lines a,
       qp_pricing_phases b
WHERE a.list_line_id = ##$$LISTLINEID$$##
  AND a.pricing_phase_id = b.pricing_phase_id',
      p_title                  => 'List Line Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'List Line was not found',
      p_solution               => '<ul> 
 <li>List Line Type - verify it is the line type you are expecting. PLL- pricelist, PBH - price break header, SUR, DIS... - modifier list. </li>
<li>Start Date, End Date - verify Pricing Date from sales order is between Start Date and End Date, blank means no restrictions.</li>
<li>Modifier Level - modifier level code could be Line (line level adjustment), Line Group(group of lines), Order(order level adjustment).</li>
<li>Pricing Phase - verify phase is attached to the correct event, event can be PRICE, LINE, ORDER, BATCH..., each event may have several phases.</li>
<li>Incompatibility Group Code - modifiers should be in the same incompatibility level and pricing phase for the engine to utilize incompatibility processing so that only one modifier is applied.</li>
 <li>Price Break Type - can be point, range, recurring.</li>
 <li>Operand - the unit price based on UOM, if null then formula may be used.</li>
<li>Price By Formula ID  - id of the formula used to calculate price.</li>
<li>Product Precedence - product precedence assigned to the modifier or price list line</li>
<li>Automatic Flag - automatic or manual.</li>
</ul>',
      p_success_msg            => '<ul> 
 <li>List Line Type - verify it is the line type you are expecting. PLL- pricelist, PBH - price break header, SUR, DIS... - modifier list. </li>
<li>Start Date, End Date - verify Pricing Date from sales order is between Start Date and End Date, blank means no restrictions.</li>
...
<li>Automatic Flag - automatic or manual.</li>
   ...
   l_info.delete;
debug('end add_signature: PRICE_LIST_LINE_INFO');



debug('begin add_signature: PRICE_LIST_LINE_RELATED_INFO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2602',
      p_sig_id                 => 'PRICE_LIST_LINE_RELATED_INFO',
      p_sig_sql                => 'select   
	decode(greatest(a.list_line_id,9999999999),9999999999,'' '',''%'') || substr(a.list_line_id,greatest(length(a.list_line_id)-10,1),10) "List Line ID"
	  , a.list_header_id  "Related List Header ID"
	  , a.list_line_type_code "List Line Type Code"
	  , to_char(a.start_date_active, ''DD-MON-YY'') "Active Start Date"
	  , to_char(a.end_date_active, ''DD-MON-YY'') "Active End Date"
	  , a.modifier_level_code "Modifier Level Code"
      , a.pricing_phase_id "New Pricing Phase ID"
	  , a.incompatibility_grp_code "Incompatibility Group Code"
	  , a.price_break_type_code "Price Break Type Code"
      , a.operand "Operand"
	  , a.arithmetic_operator "Arithmetic Operator"
	  , a.qualification_ind "Qualification Ind"
	  , a.product_precedence "Product Precedence"
...
where b.from_rltd_modifier_id = ##$$LISTLINEID$$## and a.list_line_id = b.to_rltd_modifier_id',
      p_title                  => 'Related List Line Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Related List Line Information found.',
      p_solution               => 'Related List Line Details',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PRICE_LIST_LINE_RELATED_INFO');



debug('begin add_signature: PRICE_LIST_LINE_PRICING_ATTRIBUTE_INFO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2677',
      p_sig_id                 => 'PRICE_LIST_LINE_PRICING_ATTRIBUTE_INFO',
      p_sig_sql                => 'select	decode(greatest(a.list_line_id,9999999999),9999999999,'' '',''%'') || substr(a.list_line_id,greatest(length(a.list_line_id)-10,1),10) "List Line ID"
	 , a.list_header_id "List Header ID"
	 , a.pricing_phase_id "Pricing Phase"
	 , a.excluder_flag "Excluder Flag"
	 , a.product_attribute_context "Pricing Attribute Context"
	 , substr(QP_QP_Form_Pricing_Attr.Get_Segment_Name(''QP_ATTR_DEFNS_PRICING'' , a.product_attribute_context , a.product_attribute),1,15) ||'' (''||a.product_attribute||'')'' "Product Attribute"
	 , a.product_attr_value "Product Attribute Value"
         , a.pricing_attribute_context "Pricing Context"
         , a.pricing_attribute "Pricing Attribute"
	 , a.comparison_operator_code "Comparison Operator Code"
	 , a.pricing_attr_value_from "Pricing Attribute From"
	 , a.pricing_attr_value_to "Pricing Attribute To"
	 , a.product_uom_code "Product UOM"
	 , a.attribute_grouping_no "Attribute Grouping No"
	 , a.qualification_ind "Qualifier Indicator"
        , a.ORIG_SYS_HEADER_REF "Orig Sys Header Ref"
	 , a.ORIG_SYS_LINE_REF "Orig Sys Line Ref"
	 , a.ORIG_SYS_PRICING_ATTR_REF "Orig Sys Pricing Attr Ref"
from  qp_pricing_attributes a
where a.list_line_id = ##$$LISTLINEID$$##
order by a.excluder_flag desc',
      p_title                  => 'Pricing Attribute Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Pricing Attribute Information found for this List Line ID.',
      p_solution               => 'Phase - make sure this phase is attached to the called event in the "Phase Information". <br> <br>
Prod Context - should always be ''Item''.  <br>
Prompt * Prod Attr - signifies item hierarchy element, PA1 is item number, PA2 is item category. <br>
Prod Attr Value - internal id of item hierarchy element. <br>
The Product and pricing attribute names are truncated to 15 characters in this report. <br>
UOM - verify if this is the same as ordered UOM, if not, verify if primary flag is checked in the pricelist line and conversion is defined in Inventory.  <br>
<br>Price Attribute Context, Price Attribute - check dbg file and verify these entries are passed to the engine, if not run Build Sourcing Rules concurrent program.
<br>
Value From - verify this value is equal to the value passed to the engine (other than Volume context). <br>
Value To - For Volume context, the value passed to the engine should be between Value From and Value To. <br>
Exclude Flag - if ''Y'' the product is excluded. <br>
The Qualifier Indicator value should be the summation of the following: <br>
  1  - rltd modifiers <br>
  2  - parent record from qp_list_headers_b has a header level qualifier  <br>
  4  - qp_list_line_rec has a child product attribute <br>>
  8  - line rec has a line level qualifier <br>
  16 - child pricing attributes< <br>',
      p_success_msg            => 'Pricing Attribute Information found for this List Line ID.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICE_LIST_LINE_PRICING_ATTRIBUTE_INFO');



debug('begin add_signature: PRICE_LIST_LINE_RELATED_PRICING_ATTRIBUTE_INFO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2678',
      p_sig_id                 => 'PRICE_LIST_LINE_RELATED_PRICING_ATTRIBUTE_INFO',
      p_sig_sql                => 'select decode(greatest(a.list_line_id,9999999999),9999999999,'' '',''%'') || substr(a.list_line_id,greatest(length(a.list_line_id)-10,1),10) "List Line ID"
, a.list_header_id "List Header ID"
, a.pricing_phase_id "Pricing Phase"
, a.product_attribute_context "Pricing Attribute Context"
, substr(QP_QP_Form_Pricing_Attr.Get_Segment_Name(''QP_ATTR_DEFNS_PRICING'' , a.product_attribute_context , a.product_attribute),1,15) ||'' (''||a.product_attribute||'')'' "Product Attribute"
, a.product_attr_value "Product Attribute Value"
, a.pricing_attribute_context "Pricing Attribute Context"
, substr(QP_QP_Form_Pricing_Attr.Get_Segment_Name(''QP_ATTR_DEFNS_PRICING'' , a.pricing_attribute_context , a.pricing_attribute),1,15) ||'' (''||a.pricing_attribute||'')'' "Product Attribute"
, a.comparison_operator_code "Comparison Operator Code"
, a.pricing_attr_value_from "Pricing Attribute From"
, a.pricing_attr_value_to "Pricing Attribute To"
, a.product_uom_code "Product UOM"
...
, a.qualification_ind "Qualifier Indicator"
, a.excluder_flag "Excluder Flag"
from  qp_pricing_attributes a,  qp_rltd_modifiers d
where d.from_rltd_modifier_id = ##$$LISTLINEID$$##
and a.list_line_id = d.to_rltd_modifier_id',
      p_title                  => 'Related Line Pricing Attribute Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Related Pricing Attributes for this List Line ID.',
      p_solution               => ' Related Pricing Attributes for this List Line ID.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PRICE_LIST_LINE_RELATED_PRICING_ATTRIBUTE_INFO');



debug('begin add_signature: PRICE_LIST_LINE_HEADER_QUALIFIER_-1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2680',
      p_sig_id                 => 'PRICE_LIST_LINE_HEADER_QUALIFIER_-1',
      p_sig_sql                => 'select a.active_flag "Active Flag"
	 , a.list_type_code "List Type Code"
	 , a.qualifier_context
	 , substr(QP_QP_Form_Pricing_Attr.Get_Segment_Name(''QP_ATTR_DEFNS_QUALIFIER'' ,a.qualifier_context,a.qualifier_attribute),1,15) ||'' (''||a.qualifier_attribute||'')'' "Qualifier Attribute"
	 , a.comparison_operator_code "Comparison Operator Code"
	 , a.qualifier_attr_value "Qualifier Attribute Value"
	 , decode(a.comparison_operator_code, ''BETWEEN'', ''->'', '' '') "Comparison Operator"
...
where a.list_header_id = ##$$HEADERID$$##
  and a.list_line_id in ( -1)
  and a.qualifier_grouping_no = ''-1''
order by 8,3,4,5',
      p_title                  => 'Header Qualifier  -1 Grouping Number',
      p_fail_condition         => '[Active Flag] = [N]',
      p_problem_descr          => '<P>There are inactive Qualifiers. </P>',
      p_solution               => '<P>One will need to activate the inactive qualifiers for these qualifiers to be considered.</P>
<p>Refer to [2915888/KB547674] for details.</p>',
      p_success_msg            => '<P>These qualifiers are ANDED to each qualifier group</P>
<p>Refer to [289697/KB773901] for details.</p>',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICE_LIST_LINE_HEADER_QUALIFIER_-1');



debug('begin add_signature: EBS_MFG_OM_QPLINE_SOURCING_OF_PRICE_LIST_LINE_HEADER_QUALIFIER_1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27543',
      p_sig_id                 => 'EBS_MFG_OM_QPLINE_SOURCING_OF_PRICE_LIST_LINE_HEADER_QUALIFIER_1',
      p_sig_sql                => 'select 
     QP_ATTRIBUTE_SOURCING.request_type_code "Req Type"
     , QP_ATTRIBUTE_SOURCING.attribute_sourcing_level "Level"
     , QP_QUALIFIERS.qualifier_context "Qual Context"
     , QP_QP_Form_Pricing_Attr.Get_Segment_Name(''QP_ATTR_DEFNS_QUALIFIER'' ,QP_QUALIFIERS.qualifier_context,QP_QUALIFIERS.qualifier_attribute)"Qualifier Attr"
     , QP_QUALIFIERS.qualifier_attribute "Column Mapped"
     , QP_ATTRIBUTE_SOURCING.seeded_sourcing_type
     , QP_ATTRIBUTE_SOURCING.seeded_value_string
     , QP_ATTRIBUTE_SOURCING.user_sourcing_type
     , QP_ATTRIBUTE_SOURCING.user_value_string
     , QP_ATTRIBUTE_SOURCING.enabled_flag
FROM   QP_PRC_CONTEXTS_B ,
       QP_SEGMENTS_B ,
       QP_ATTRIBUTE_SOURCING,
       QP_QUALIFIERS 
where QP_QUALIFIERS.list_header_id = ##$$HEADERID$$##
  AND QP_QUALIFIERS.list_line_id = -1
  AND QP_QUALIFIERS.qualifier_grouping_no = ''-1''
  and qp_qualifiers.qualifier_context = QP_PRC_CONTEXTS_B.prc_context_code
  AND QP_SEGMENTS_B.prc_context_id = QP_PRC_CONTEXTS_B.prc_context_id
  AND QP_ATTRIBUTE_SOURCING.segment_id = QP_SEGMENTS_B.segment_id
  AND QP_QUALIFIERS.qualifier_attribute = QP_SEGMENTS_B.segment_mapping_column
  AND QP_PRC_CONTEXTS_B.PRC_CONTEXT_TYPE IN (''PRODUCT'', ''QUALIFIER'', ''PRICING_ATTRIBUTE'')
order by     QP_ATTRIBUTE_SOURCING.request_type_code DESC,
             QP_ATTRIBUTE_SOURCING.attribute_sourcing_level ASC,
             QP_QUALIFIERS.qualifier_context,
             QP_QUALIFIERS.qualifier_attribute DESC',
      p_title                  => 'Sourcing of Header Qualifier -1 Grouping Number',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No sourcing rules found. ',
      p_solution               => 'Sourcing rules for qualifiers require detailed review. ',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_QPLINE_SOURCING_OF_PRICE_LIST_LINE_HEADER_QUALIFIER_1');



debug('begin add_signature: PRICE_LIST_LINE_HEADER_QUALIFIER_NOT_-1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2682',
      p_sig_id                 => 'PRICE_LIST_LINE_HEADER_QUALIFIER_NOT_-1',
      p_sig_sql                => 'select a.active_flag "Active Flag"
	 , a.list_type_code "List Type Code"
	 , a.qualifier_context "Qualifier Context"
	 , QP_QP_Form_Pricing_Attr.Get_Segment_Name(''QP_ATTR_DEFNS_QUALIFIER'' ,a.qualifier_context,a.qualifier_attribute) || ''(''||a.qualifier_attribute||'')'' "Qualifier Attribute"
	 , a.comparison_operator_code "Comparison Operator Code"
	 , a.qualifier_attr_value "Qualifier Attribute Value"
	 , decode(a.comparison_operator_code, ''BETWEEN'', ''->'', '' '') "Comparison Operator"
	 , a.qualifier_attr_value_to "Qualifier Attribute Value To"
...
and a.qualifier_grouping_no <> ''-1''
order by 8,3,4,5',
      p_title                  => 'Header Qualifier Not -1 Grouping Number',
      p_fail_condition         => '[Active Flag] = [N]',
      p_problem_descr          => '<P>There are inactive Qualifiers.</P>',
      p_solution               => '<P>One will need to activate the inactive qualifiers for these qualifiers to be considered.</P>
<p>Refer to [2915888/KB547674] for details.</p>',
      p_success_msg            => '<P>At least one of the non -1 groups
must be satisfied for a success candidate</P>
<p>Refer to [289697/KB773901] for details.</p>',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PRICE_LIST_LINE_HEADER_QUALIFIER_NOT_-1');



debug('begin add_signature: PRICING_LIST_QUALIFIERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12109',
      p_sig_id                 => 'PRICING_LIST_QUALIFIERS',
      p_sig_sql                => 'select a.active_flag "Qualifier Active Flag",
                 b.active_flag "Entity Header Active Flag"
               , a.qualifier_precedence "Qualifier Precedence"
                 , a.qualifier_grouping_no "Qualifier Grouping Number"
                 , a.qualifier_context
                 , substr(QP_QP_Form_Pricing_Attr.Get_Segment_Name(''QP_ATTR_DEFNS_QUALIFIER''
                   ,a.qualifier_context,a.qualifier_attribute),1,15) ||'' (''||a.qualifier_attribute||'')'' "Qualifier Attribute"
                 , a.comparison_operator_code "Comparison Operator Code"
                 , a.qualifier_attr_value "Qualifier Attribute Value"
                 , decode(a.comparison_operator_code, ''BETWEEN'', ''->'', '' '') "Comparison Operator"
                 , a.qualifier_attr_value_to "Qualifier Attribute Value To"
...
AND a.list_line_id in ( -1)
order by 1,3,4,5',
      p_title                  => 'Inactive List Qualifiers',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Qualifier is showing as inactive',
 ...
 [2915888/KB547674]',
   ...
   l_info.delete;
debug('end add_signature: PRICING_LIST_QUALIFIERS');



debug('begin add_signature: EBS_MFG_OM_QPLINE_SOURCING_OF_PRICE_LIST_LINE_HEADER_QUALIFIER_NOT_1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27544',
      p_sig_id                 => 'EBS_MFG_OM_QPLINE_SOURCING_OF_PRICE_LIST_LINE_HEADER_QUALIFIER_NOT_1',
      p_sig_sql                => 'select 
     QP_ATTRIBUTE_SOURCING.request_type_code "Req Type"
     , QP_ATTRIBUTE_SOURCING.attribute_sourcing_level "Level"
     , QP_QUALIFIERS.qualifier_context "Qual Context"
...
',
      p_title                  => 'Sourcing Of Header qualifier Not -1 Grouping Number',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No sourcing rules found. ',
      p_solution               => 'Sourcing rules for qualifiers require detailed review. ',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_QPLINE_SOURCING_OF_PRICE_LIST_LINE_HEADER_QUALIFIER_NOT_1');



debug('begin add_signature: PRICE_LIST_LINE_QUALIFIER_-1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2685',
      p_sig_id                 => 'PRICE_LIST_LINE_QUALIFIER_-1',
      p_sig_sql                => 'select a.active_flag "Active Flag"
	 , a.list_type_code "List Type Code"
	 , a.qualifier_context "Qualifier Context"
	 , substr(QP_QP_Form_Pricing_Attr.Get_Segment_Name(''QP_ATTR_DEFNS_QUALIFIER'' ,a.qualifier_context,a.qualifier_attribute),1,15) ||'' (''||a.qualifier_attribute||'')'' "Qualifier Attribute"
...
from  qp_qualifiers a
where a.list_header_id = ##$$HEADERID$$##
  and a.list_line_id in (##$$LISTLINEID$$##)
  and a.qualifier_grouping_no = ''-1''
order by 8,3,4,5',
      p_title                  => 'Line Qualifier -1 Grouping Number',
      p_fail_condition         => '[Active Flag] = [N]',
      p_problem_descr          => '<P>There are inactive Qualifiers.  </P>',
      p_solution               => '<P>One will need to activate the inactive qualifiers for these qualifiers to be considered.</P>
<p>Refer to [2915888/KB547674] for details.</p>',
      p_success_msg            => '<P>These qualifier are ANDED to each qualifier group.</P>
<p>Refer to [289697/KB773901] for details.</p>',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PRICE_LIST_LINE_QUALIFIER_-1');



debug('begin add_signature: EBS_MFG_OM_QPLINE_SOURCING_OF_PRICE_LIST_LINE_QUALIFIER_1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27545',
      p_sig_id                 => 'EBS_MFG_OM_QPLINE_SOURCING_OF_PRICE_LIST_LINE_QUALIFIER_1',
      p_sig_sql                => 'select 
     QP_ATTRIBUTE_SOURCING.request_type_code "Req Type"
     , QP_ATTRIBUTE_SOURCING.attribute_sourcing_level "Level"
     , QP_QUALIFIERS.qualifier_context "Qual Context"
...
FROM   QP_PRC_CONTEXTS_B ,
       ...
       QP_QUALIFIERS 
where QP_QUALIFIERS.list_header_id = ##$$HEADERID$$##
  AND QP_QUALIFIERS.list_line_id = ##$$LISTLINEID$$## 
  AND QP_QUALIFIERS.qualifier_grouping_no = ''-1''
  and qp_qualifiers.qualifier_context = QP_PRC_CONTEXTS_B.prc_context_code
  AND QP_SEGMENTS_B.prc_context_id = QP_PRC_CONTEXTS_B.prc_context_id
  AND QP_ATTRIBUTE_SOURCING.segment_id = QP_SEGMENTS_B.segment_id
...
',
      p_title                  => 'Sourcing Rule for Line qualifier -1 Grouping Number',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No sourcing rules found. ',
      p_solution               => 'Sourcing Rules for Qualifiers Require Detailed Review',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_QPLINE_SOURCING_OF_PRICE_LIST_LINE_QUALIFIER_1');



debug('begin add_signature: PRICE_LIST_LINE_QUALIFIER_NOT_-1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2687',
      p_sig_id                 => 'PRICE_LIST_LINE_QUALIFIER_NOT_-1',
      p_sig_sql                => 'select a.active_flag "Active Flag"
	 , a.list_type_code "List Type Code"
	 , a.qualifier_context "Qualifier Context"
	 , substr(QP_QP_Form_Pricing_Attr.Get_Segment_Name(''QP_ATTR_DEFNS_QUALIFIER'' ,a.qualifier_context,a.qualifier_attribute),1,15) ||'' (''||a.qualifier_attribute||'')'' "Qualifier Attribute"
...
where a.list_header_id = ##$$HEADERID$$##
  ...
  and a.qualifier_grouping_no <> ''-1''
order by 9,3,4,5',
      p_title                  => 'Line Qualifier Not -1 Grouping Number',
      p_fail_condition         => '[Active Flag] = [N]',
      p_problem_descr          => '<P>There are inactive Qualifiers.</P>',
      p_solution               => '<P>One will need to activate the inactive qualifiers for these qualifiers to be considered.</P>
<p>Refer to [2915888/KB547674] for details.</p>
',
      p_success_msg            => '<P>These qualfiiers are logical ORed to qualify for the candidate.</P> 
<p>Refer to [289697/KB773901] for details.</p>
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: PRICE_LIST_LINE_QUALIFIER_NOT_-1');



debug('begin add_signature: EBS_MFG_OM_QPLINE_SOURCING_OF_PRICE_LIST_LINE_QUALIFIER_NOT_1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27546',
      p_sig_id                 => 'EBS_MFG_OM_QPLINE_SOURCING_OF_PRICE_LIST_LINE_QUALIFIER_NOT_1',
      p_sig_sql                => 'select 
     QP_ATTRIBUTE_SOURCING.request_type_code "Req Type"
     , QP_ATTRIBUTE_SOURCING.attribute_sourcing_level "Level"
     , QP_QUALIFIERS.qualifier_context "Qual Context"
...
where QP_QUALIFIERS.list_header_id = ##$$HEADERID$$##
  ...
  AND QP_PRC_CONTEXTS_B.PRC_CONTEXT_TYPE IN (''PRODUCT'', ''QUALIFIER'', ''PRICING_ATTRIBUTE'')
       order by     QP_ATTRIBUTE_SOURCING.request_type_code DESC,
                    ...
                    QP_QUALIFIERS.qualifier_context,
                    QP_QUALIFIERS.qualifier_attribute DESC',
      p_title                  => 'Sourcing Of Line Qualifier Not -1 Grouping Number',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No sourcing rules found. ',
      p_solution               => 'Sourcing Rules for Qualifiers Require Detailed Review',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_QPLINE_SOURCING_OF_PRICE_LIST_LINE_QUALIFIER_NOT_1');



debug('begin add_signature: PRICING_LINE_QUALIFIERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12110',
      p_sig_id                 => 'PRICING_LINE_QUALIFIERS',
      p_sig_sql                => 'select a.active_flag "Qualifier Active Flag",
                 b.active_flag "Entity Header Active Flag"
               , a.qualifier_precedence "Qualifier Precedence"
                 , a.qualifier_grouping_no "Qualifier Grouping Number"
...
order by 1,3,4,5',
      p_title                  => 'Inactive Line Qualifiers',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Line Qualifier(s) marked as inactive',
      p_solution               => 'There is a mismatch between the header records active_flag and the active_flag on a qualifier.  This pricing entity may not work as needed, until this issue is resolved. Please refer to the solution needed in
 [2915888/KB547674]',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: PRICING_LINE_QUALIFIERS');



debug('begin add_signature: PRICE_LIST_LINE_END_DATE_CONFLICT_RESULTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2705',
      p_sig_id                 => 'PRICE_LIST_LINE_END_DATE_CONFLICT_RESULTS',
      p_sig_sql                => 'select unique a.list_header_id, a.list_line_id, a.qualifier_grouping_no
from qp_qualifiers a
where a.list_header_id = ##$$HEADERID$$##
  and exists ( 
    select 1 
    from qp_qualifiers b 
    where b.qualifier_grouping_no = a.qualifier_grouping_no 
      and b.list_line_id = ##$$LISTLINEID$$##
      and b.list_header_id = ##$$HEADERID$$##
      and b.end_date_active is not null)
  and exists ( 
    select 1 
    from qp_qualifiers b 
    where b.qualifier_grouping_no = a.qualifier_grouping_no 
...
order by 1,2,3',
      p_title                  => 'End Date Conflict Check Results',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'End Date Check',
      p_solution               => '<ul>
<li>If you have an end-dated qualifier in a group with non-end-dated qualifiers, the group will never qualify even if the other qualifiers are all satisfied. </li>
<li>It is recommended to either remove the end-dated qualifier or put it in a separate group.</li>
<li>Refer to Concept of Grouping Numbers for Qualifiers in Oracle Advanced Pricing [289697/KB773901].</li>
</ul>',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: PRICE_LIST_LINE_END_DATE_CONFLICT_RESULTS');



debug('begin add_signature: PRICE_LIST_LINE_END_DATE_CONFLICT_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2704',
      p_sig_id                 => 'PRICE_LIST_LINE_END_DATE_CONFLICT_CHECK',
      p_sig_sql                => 'select count(*) CONFLICTS 
from qp_qualifiers a
where a.list_header_id = ##$$HEADERID$$##
  and exists ( 
    select 1 
  ...
  and exists ( 
    ...
    where b.qualifier_grouping_no = a.qualifier_grouping_no 
      ...
      and b.list_header_id = ##$$HEADERID$$##
      and b.end_date_active is null)',
      p_title                  => 'End Date Conflict Check',
      p_fail_condition         => '[CONFLICTS] > [0]',
      p_problem_descr          => 'End Date Conflict found. ',
      p_solution               => '<ul>
<li>If you have an end-dated qualifier in a group with non-end-dated qualifiers, the group will never qualify even if the other qualifiers are all satisfied. </li>
<li>It is recommended to either remove the end-dated qualifier or put it in a separate group.</li>
<li>Refer to [289697/KB773901] for details.</li>
</ul>',
      p_success_msg            => 'No end-dated qualifiers exist for this List Line ID.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('PRICE_LIST_LINE_END_DATE_CONFLICT_RESULTS'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '18'
      );
   l_info.delete;
debug('end add_signature: PRICE_LIST_LINE_END_DATE_CONFLICT_CHECK');



debug('begin add_signature: PRICE_LIST_PHASE_INFO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2829',
      p_sig_id                 => 'PRICE_LIST_PHASE_INFO',
      p_sig_sql                => 'select	 pricing_phase_id "Phase ID"
         , name "Name"
         , freeze_override_flag "Freeze Override - Seeded"          
         , user_freeze_override_flag "Freeze Override - User"
         , incompat_resolve_code "Incompatibility - Seeded"
         , user_incompat_resolve_code "Incompatibility - User"
from	 qp_pricing_phases
where	 pricing_phase_id = ##$$PHASEID$$##',
      p_title                  => 'Phases Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No phases found.',
      p_solution               => '<ul>
<li>Refer to What are the seeded Event Phases for Advanced Pricing? [742242/FAQ5501].</li>
</ul>',
      p_success_msg            => '<ul>
<li>Phase - verify the expected list line is in the phase associated with the event executed by the engine.</li>
<li>Pricing Event - verify if the expected phase is attached to this event.</li>
</ul>',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PRICE_LIST_PHASE_INFO');



debug('begin add_signature: PRICE_LIST_PRICE_EVENT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2835',
      p_sig_id                 => 'PRICE_LIST_PRICE_EVENT',
      p_sig_sql                => 'select	 pricing_phase_id "Phase ID"
	 , pricing_event_code "Pricing Event Code"
	 , user_search_flag "User Search Flag"
         , start_date_active "Start Date"
         , end_date_active "End Date"
from	 qp_event_phases
where	 pricing_phase_id = ##$$PHASEID$$##',
      p_title                  => 'Pricing Event',
      p_fail_condition         => '[End Date] <> [NULL]',
      p_problem_descr          => 'Pricing Events have an end date assigned.
',
      p_solution               => '<ul>
<li>Phase - verify the expected list line is in the phase associated with the event executed by the engine.</li>
<li>Pricing Event - verify if the expected phase is attached to this event.</li>
<li>Search Flag - engine will perform the extended search if the search flag is ''Y''.</li>
<li>Refer to What are the seeded Event Phases for Advanced Pricing? [742242/FAQ5501].</li
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: PRICE_LIST_PRICE_EVENT');



debug('begin add_signature: PRICE_LIST_PHASE_HEADER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2836',
      p_sig_id                 => 'PRICE_LIST_PHASE_HEADER',
      p_sig_sql                => 'select	 list_header_id "List Header ID"
	 , pricing_phase_id "Price Phase ID"
from	 qp_list_header_phases
where	 list_header_id = ##$$HEADERID$$##',
      p_title                  => 'Pricing Phase',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No pricing phases are found.',
      p_solution               => 'Only applicable for modifiers, needs record(s) if there are any header level or line level qualifiers attached to the line.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PRICE_LIST_PHASE_HEADER');



debug('begin add_signature: PRICE_LIST_PHASE_REQUEST_TYPE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2837',
      p_sig_id                 => 'PRICE_LIST_PHASE_REQUEST_TYPE',
      p_sig_sql                => 'select	 request_type_code "Request Type Code"
	 , source_system_code "Source System Code"
from	 qp_price_req_sources 
where	 request_type_code = ''ONT''',
      p_title                  => 'Request Type - Source System Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Request Type - Source System Information for Order Management',
      p_solution               => '<ul>
<li>Request Type Code - calling application transaction being priced. ONT - Order Management, ASO - istore/order capture, FTE - Logistics.</li>
<li>Source System Code - source system code should have a row for QP</li>
</ul>',
      p_success_msg            => '<ul>
<li>Request Type Code - calling application transaction being priced. ONT - Order Management, ASO - istore/order capture, FTE - Logistics.</li>
<li>Source System Code - source system code should have a row for QP</li>
   ...
   l_info.delete;
debug('end add_signature: PRICE_LIST_PHASE_REQUEST_TYPE');
...
debug('begin add_signature: PRICE_LIST_FORMULA_INFO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2838',
      p_sig_id                 => 'PRICE_LIST_FORMULA_INFO',
      p_sig_sql                => 'select b.price_formula_id "Price Formula ID"
  , b.name "Name"
  , b.formula "Formula"
  , b.price_formula_no "Price Formula Number"
  , b.seeded_flag "Seeded Flag"
  , b.start_date_active "Start Date Active"
  , b.end_date_active "End Date Active"
from qp_list_lines a
  , qp_price_formulas b
where b.price_formula_id = a.price_by_formula_id
  and a.list_line_id = ##$$LISTLINEID$$##
UNION
SELECT b.price_formula_id  "Price Formula ID"
  , b.name "Name"
  , b.formula "Formula"
  , b.price_formula_no "Price Formula Number"
  , b.seeded_flag "Seeded Flag"
...
FROM   QP_LIST_LINES a,
       ...
       QP_PRICE_BREAKS_V c
WHERE  b.price_formula_id = a.price_by_formula_id
       AND c.parent_list_line_id = ##$$LISTLINEID$$##
       AND c.list_header_id = a.list_header_id
       AND b.price_formula_id = c.price_by_formula_id  
ORDER BY 1,2 ASC',
      p_title                  => 'Formula Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Formula found
',
      p_solution               => '<li>For additional considerations, refer to Formula Setup [787913/KB374820]</li>
</ul>',
      p_success_msg            => '<ul>
<li>Verify Formula Start Date and End Date are applicable.</li>',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PRICE_LIST_FORMULA_INFO');



debug('begin add_signature: PRICE_LIST_FORMULA_INFO_DETAIL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2839',
      p_sig_id                 => 'PRICE_LIST_FORMULA_INFO_DETAIL',
      p_sig_sql                => 'SELECT b.price_formula_id                 "Price Formula ID",
       b.step_number                                "Step Number",
       b.price_formula_line_type_code "Formula Line Type Code",
       b.pricing_attribute_context          "Pricing Attribute Context",
       b.pricing_attribute                         "Pricing Attribute",
       b.numeric_constant                      "Number Constant",
       b.price_list_line_id                         "Price List Line ID",
       b.price_modifier_list_id                "Price Modifier List ID",
       b.start_date_active                        "Start Date Active",
       b.end_date_active                         "End Date Active"
FROM   QP_LIST_LINES a,
       QP_PRICE_FORMULA_LINES b
WHERE  b.price_formula_id = a.price_by_formula_id
       AND a.list_line_id = ##$$LISTLINEID$$##
UNION
SELECT b.price_formula_id                "Price Formula ID",
...
',
      p_title                  => 'Formula Detail Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No associated formula details found
',
      p_solution               => 'If Formulas are expected and/or required, refer to Formula Setup [787913/KB374820]',
      p_success_msg            => 'Formulas defined for this List Line ID
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PRICE_LIST_FORMULA_INFO_DETAIL');



debug('begin add_signature: PRICE_LIST_SECONDARY_PRICE_LIST_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2997',
      p_sig_id                 => 'PRICE_LIST_SECONDARY_PRICE_LIST_ID',
      p_sig_sql                => 'SELECT distinct qph.list_header_id "Secondary Price List Header ID"
 FROM 
 ...
 WHERE 
 	qpq.qualifier_context = ''MODLIST''
 	AND qpq.qualifier_attribute = ''QUALIFIER_ATTRIBUTE4''
 	AND qpq.qualifier_attr_value = to_char(##$$HEADERID$$##) --primary pricelist
 	AND qpq.list_type_code = ''PRL''
 	AND qpq.list_header_id = qpa.list_header_id
 	AND qpa.list_line_id = qpl.list_line_id
 	AND qpl.list_header_id = qph.list_header_id',
      p_title                  => 'Secondary Price List Header ID',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No secondary price lists found.',
      p_solution               => '<ul>
<li>Verify if a Secondary Price List is being used.</li>
<li>If a Secondary Price List is expected and/or required, refer to [750875/KB625487]</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PRICE_LIST_SECONDARY_PRICE_LIST_ID');



debug('begin add_signature: PRICE_LIST_SECONDARY_NAME_PRECEDENCE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3129',
      p_sig_id                 => 'PRICE_LIST_SECONDARY_NAME_PRECEDENCE',
      p_sig_sql                => 'select name "Name"
, precedence "Precedence"
  from qp_secondary_price_lists_v
  where parent_price_list_id = ''##$$HEADERID$$##''
  order by precedence',
      p_title                  => 'Secondary Price List Name and Precedence',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No secondary price lists found.',
      p_solution               => '<ul>
<li>If a Secondary Price List is expected and/or required, refer to [750875/KB625487]</li>
   ...
   l_info.delete;
debug('end add_signature: PRICE_LIST_SECONDARY_NAME_PRECEDENCE');
...
BEGIN
  ...
  analyzer_title := 'Advanced Pricing List Line Analyzer';
...
debug('begin section: List_Header');
start_section('List Header Information', 'List_Header');
   set_item_result(run_stored_sig('PRICE_LIST_LINE_HEADER_INFO'));
   set_item_result(run_stored_sig('PRICE_LIST_LINE_HEADER_CURRENCY_CONVERSION'));
   set_item_result(run_stored_sig('PRICE_LIST_LINE_HEADER_MODIFERS'));
   set_item_result(run_stored_sig('PRICE_LIST_LINE_HEADER_MOBILE'));
   set_item_result(run_stored_sig('QP_PRICING_ATTRIBUTES_DUP_CHECK'));
   set_item_result(run_stored_sig('EBS_MFG_OM_QPLINE_EBS_MFG_OM_QPLIST_PRICING_SECURITY_PRIVILEGES'));
end_section;
debug('end section: List_Header');

debug('begin section: Line');
start_section('List Line Information', 'Line');
   set_item_result(run_stored_sig('PRICE_LIST_LINE_INFO'));
   set_item_result(run_stored_sig('PRICE_LIST_LINE_RELATED_INFO'));
end_section;
debug('end section: Line');

debug('begin section: Pricing_Attributes');
start_section('Pricing Attributes', 'Pricing_Attributes');
   set_item_result(run_stored_sig('PRICE_LIST_LINE_PRICING_ATTRIBUTE_INFO'));
   set_item_result(run_stored_sig('PRICE_LIST_LINE_RELATED_PRICING_ATTRIBUTE_INFO'));
end_section;
debug('end section: Pricing_Attributes');

debug('begin section: Qualifiers');
start_section('Qualifier Information', 'Qualifiers');
   set_item_result(run_stored_sig('PRICE_LIST_LINE_HEADER_QUALIFIER_-1'));
   set_item_result(run_stored_sig('EBS_MFG_OM_QPLINE_SOURCING_OF_PRICE_LIST_LINE_HEADER_QUALIFIER_1'));
   set_item_result(run_stored_sig('PRICE_LIST_LINE_HEADER_QUALIFIER_NOT_-1'));
   set_item_result(run_stored_sig('PRICING_LIST_QUALIFIERS'));
   set_item_result(run_stored_sig('EBS_MFG_OM_QPLINE_SOURCING_OF_PRICE_LIST_LINE_HEADER_QUALIFIER_NOT_1'));
   set_item_result(run_stored_sig('PRICE_LIST_LINE_QUALIFIER_-1'));
   set_item_result(run_stored_sig('EBS_MFG_OM_QPLINE_SOURCING_OF_PRICE_LIST_LINE_QUALIFIER_1'));
   set_item_result(run_stored_sig('PRICE_LIST_LINE_QUALIFIER_NOT_-1'));
   set_item_result(run_stored_sig('EBS_MFG_OM_QPLINE_SOURCING_OF_PRICE_LIST_LINE_QUALIFIER_NOT_1'));
   set_item_result(run_stored_sig('PRICING_LINE_QUALIFIERS'));
   set_item_result(run_stored_sig('PRICE_LIST_LINE_END_DATE_CONFLICT_CHECK'));
end_section;
debug('end section: Qualifiers');

debug('begin section: Phases');
start_section('Phase Information', 'Phases');
   set_item_result(run_stored_sig('PRICE_LIST_PHASE_INFO'));
   set_item_result(run_stored_sig('PRICE_LIST_PRICE_EVENT'));
   set_item_result(run_stored_sig('PRICE_LIST_PHASE_HEADER'));
   set_item_result(run_stored_sig('PRICE_LIST_PHASE_REQUEST_TYPE'));
   set_item_result(run_stored_sig('PRICING_MODIFIER_IN_ACROSS_ALL_PHASES'));
end_section;
debug('end section: Phases');

debug('begin section: Formula');
start_section('Formula Information', 'Formula');
   set_item_result(run_stored_sig('PRICE_LIST_FORMULA_INFO'));
   set_item_result(run_stored_sig('PRICE_LIST_FORMULA_INFO_DETAIL'));
end_section;
debug('end section: Formula');

debug('begin section: Secondary');
start_section('Secondary Price List', 'Secondary');
   set_item_result(run_stored_sig('PRICE_LIST_SECONDARY_PRICE_LIST_ID'));
   set_item_result(run_stored_sig('PRICE_LIST_SECONDARY_NAME_PRECEDENCE'));
end_section;
debug('end section: Secondary');
