...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Order Management Analyzer              |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE om_analyzer_pkg AUTHID DEFINER AS
...
(            p_org_code                     IN VARCHAR2    DEFAULT NULL
           ,p_s_date                       IN DATE        DEFAULT NULL
           ,p_e_date                       IN DATE        DEFAULT NULL
...
PROCEDURE main_cp (
           ...
           ,p_org_code                     IN VARCHAR2    DEFAULT NULL
           ,p_s_date                       IN VARCHAR2    DEFAULT NULL
           ,p_e_date                       IN VARCHAR2    DEFAULT NULL
           ,p_include_apps_check           IN VARCHAR2    DEFAULT 'N'
           ,p_max_output_rows              IN NUMBER      DEFAULT 1000
           ,p_debug_mode                   IN VARCHAR2    DEFAULT 'Y'
);
...
-- $Id: om_analyzer.sql, 200.65 2026/01/28 17:05:48 cschmehl Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(1665244.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'ONTSO_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'ONTSO_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=1665244.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/om_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,243,EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,243,EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},243,EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/3551026" class="blacklink" target="new">
...
EBS_ATG_UGLE_SEQUENCES_CLOSE_TO_MAXIMUM_VALUE_BELOW_12C</p><p>Template Changes (4.7.3):<br>
Minor Enhancements:<br>
- EBSAF-393 - Ability to click to select rows in output tables<br>
Bug Fixes:<br>
- EBSAF-394 - The links on the Tiles in Home page of the analyzers are not working in Chrome and Edge</p>
            <br><br>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,243,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,243,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},243,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
l_utlfiledir VARCHAR2(4000);

-- Accommodations for 19C DB
l_DBbanner VARCHAR2(255);

FUNCTION val_p_s_date
   return VARCHAR2 IS
BEGIN
debug('begin parameter validation function: p_s_date');
IF p_s_date > sysdate 
THEN
    return 'N';
ELSE
    return 'Y';
END IF; 
debug('end parameter validation function: p_s_date');
END val_p_s_date;

FUNCTION val_p_e_date
   return VARCHAR2 IS
BEGIN
debug('begin parameter validation function: p_e_date');
IF  p_e_date > sysdate
OR p_s_date > p_e_date THEN
    return 'N';
ELSE
    return 'Y';
END IF;
debug('end parameter validation function: p_e_date');
END val_p_e_date;
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Organization (warehouse) Code';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_org_code,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Start Date';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_s_date,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'End Date';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_e_date,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Include Diagnostic Apps Check (Default is N)';
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/01/28 17:05:47 $','$',''));
...
INTO l_exists_val
FROM MTL_PARAMETERS
WHERE ORGANIZATION_CODE = p_org_code and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Organization Code not found, invalid Organization Code.  ');
...
debug('begin parameter validation: p_s_date');
IF p_s_date IS NOT NULL AND val_p_s_date()='N' THEN
   print_error('INVALID ARGUMENT: Invalid Start Date. Date must be before End Date.');
   raise invalid_parameters;
END IF;
l_system_function_var := null;
debug('end parameter validation: p_s_date');

debug('begin parameter validation: p_e_date');
IF p_e_date IS NOT NULL AND val_p_e_date()='N' THEN
   print_error('INVALID ARGUMENT: Invalid date.  End Date must be after Start Date and not in the future.');
   raise invalid_parameters;
END IF;
l_system_function_var := null;
debug('end parameter validation: p_e_date');

debug('begin parameter validation: p_include_apps_check');
IF p_include_apps_check IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Include Diagnostic Apps Check (Default is N) is required.');
   raise invalid_parameters;
END IF;
...
SELECT value into l_utlfiledir
FROM   v$parameter
WHERE  name = 'utl_file_dir';

g_utlfiledir := l_utlfiledir;

print_log('g_utlfiledir = '||l_utlfiledir);
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$SDATE$$##') := p_s_date;
   g_masked_tokens('##$$SDATE$$##') := mask_text( g_sql_tokens('##$$SDATE$$##'), 'NO_MASK');
   g_sql_tokens('##$$EDATE$$##') := p_e_date;
   g_masked_tokens('##$$EDATE$$##') := mask_text( g_sql_tokens('##$$EDATE$$##'), 'NO_MASK');
...
debug('begin add_signature: ORDER_MGMT_ORPHAN_FULFILLMENT_SET');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15136',
      p_sig_id                 => 'ORDER_MGMT_ORPHAN_FULFILLMENT_SET',
      p_sig_sql                => 'SELECT
    os.set_id    "Set ID",
    os.set_name  "Set Name",
    os.set_type  "Set Type",
    os.header_id "Header ID",
    ols.line_id  "Line ID",
    ols.system_required_flag
FROM
    oe_sets os,
    oe_line_sets ols
WHERE
    os.set_id = ols.set_id
    AND NOT EXISTS (
        SELECT
            1
        FROM
        ...
        WHERE
            ol.line_id = ols.line_id
    )',
      p_title                  => 'Orphan Fulfillment Set',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Orphan Fulfillment Set(s) is Found',
      p_solution               => 'Log a Service Request with Oracle Order Management.  For more information regarding this issue, review [2286095/KB719441] for instructions and details.',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: ORDER_MGMT_ORPHAN_FULFILLMENT_SET');



debug('begin add_signature: EBS_MFG_OM_ONT_ONTSO_CREDIT_HOLD_ENABLED_SITE_LEVEL_ORDERS_NOT_GETTING_HELD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27533',
      p_sig_id                 => 'EBS_MFG_OM_ONT_ONTSO_CREDIT_HOLD_ENABLED_SITE_LEVEL_ORDERS_NOT_GETTING_HELD',
      p_sig_sql                => 'SELECT HCA.ACCOUNT_NUMBER,
        hcp.site_use_id,
        hcsu.org_id
 FROM hz_cust_site_uses_all hcsu ,
      hz_customer_profiles hcp,
      HZ_CUST_ACCOUNTS HCA
 WHERE NVL(hcp.credit_hold,''N'') = ''Y''
         AND NOT EXISTS
            (SELECT 1
             FROM oe_hold_sources_all OHS
             WHERE OHS.hold_id        =1
                AND OHS.hold_entity_code = ''B''
                AND OHS.hold_entity_id   = HCP.site_use_id
                AND RELEASED_FLAG         =''N''
      ...
      AND hcsu.status      = ''A''',
      p_title                  => 'Credit Hold is enabled at Site level but orders are not getting held',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Cannot release a Customer from Hold. Users are trying to release the Customer from Credit Hold.  First uncheck the credit hold and after users save the changes, the credit hold flag appears back.
...
',
      p_solution               => 'Refer to [2047372/KB200464]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_ONT_ONTSO_CREDIT_HOLD_ENABLED_SITE_LEVEL_ORDERS_NOT_GETTING_HELD');



debug('begin add_signature: EBS_MFG_OM_ONT_ONTSO_CREDIT_HOLD_ENABLED_CUSTOMER_LEVEL_ORDERS_NOT_GETTING_HELD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27532',
      p_sig_id                 => 'EBS_MFG_OM_ONT_ONTSO_CREDIT_HOLD_ENABLED_CUSTOMER_LEVEL_ORDERS_NOT_GETTING_HELD',
      p_sig_sql                => 'SELECT DISTINCT HCA.ACCOUNT_NUMBER, HCP.CUST_ACCOUNT_ID, HCAS.ORG_ID
 FROM HZ_CUSTOMER_PROFILES HCP, HZ_CUST_ACCT_SITES_ALL HCAS, HZ_CUST_ACCOUNTS HCA
 WHERE NVL(hcp.credit_hold,''N'') = ''Y''
 AND NOT EXISTS
 (SELECT 1
   FROM oe_hold_sources_all OHS
 WHERE OHS.hold_id        =1
 AND OHS.hold_entity_code = ''C''
 AND OHS.hold_entity_id   = HCP.CUST_ACCOUNT_ID
 AND RELEASED_FLAG         =''N''   
 AND HOLD_RELEASE_ID      IS NULL
 )
 AND HCAS.CUST_ACCOUNT_ID = HCP.CUST_ACCOUNT_ID
   AND HCP.CUST_ACCOUNT_ID = HCA.CUST_ACCOUNT_ID
 AND HCAS.STATUS          = ''A''',
      p_title                  => 'Credit Hold enabled at Customer level but orders are not getting held',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Cannot release a Customer from Hold. Users are trying to release the Customer from Credit Hold.  First uncheck the credit hold and after users save the changes, the credit hold flag appears back.
...
',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_ONT_ONTSO_CREDIT_HOLD_ENABLED_CUSTOMER_LEVEL_ORDERS_NOT_GETTING_HELD');



debug('begin add_signature: EBS_MFG_OM_ONT_ONTSO_ERROR_CANCEL_DROP_SHIP_LINE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27606',
      p_sig_id                 => 'EBS_MFG_OM_ONT_ONTSO_ERROR_CANCEL_DROP_SHIP_LINE',
      p_sig_sql                => 'SELECT
    oeh.order_number    "ORDER NUMBER",
    oeh.header_id       "HEADER ID",
    oel.line_id         "LINE ID",
    oel.flow_status_code "LINE STATUS",
    d2.drop_ship_source_id "DROP SHIP SOURCE ID",
    d2.requisition_header_id "REQN HEADER ID",
    d2.requisition_line_id "REQN LINE ID"
FROM
    po_lines_all          p,
...
WHERE
    ...
    AND oel.line_id = d2.line_id
    AND p.po_line_id (+) = d2.po_line_id
ORDER BY
    d2.line_id ASC,
    p.po_line_id ASC',
      p_title                  => 'ORA-01422 Error Due To  Duplicate Drop Ship Sources',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'ORA-01422 Error as Multiple records in oe_drop_ship_sources table for a single sales order line. Ideally one sales order line should have only one corresponding entry in that table.
',
      p_solution               => 'A data fix script will need to be provided from Support / Development to delete the unwanted multiple records. Refer to [739699/KB626728] for additional details on the issue. Refer to signature: Sales Order Drop Ship Sources, for additional data details.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_ONT_ONTSO_ERROR_CANCEL_DROP_SHIP_LINE');



debug('begin add_signature: EBS_MFG_OM_ONT_ONTSO_CREDITCHECK_HOLD_DEFINITION_ENDDATED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28322',
      p_sig_id                 => 'EBS_MFG_OM_ONT_ONTSO_CREDITCHECK_HOLD_DEFINITION_ENDDATED',
      p_sig_sql                => ' SELECT name, start_date_active, end_date_active
   FROM OE_HOLD_DEFINITIONS
  WHERE HOLD_ID = 1
    AND end_date_active <= SYSDATE',
      p_title                  => 'Credit Check Failure hold definition has been end dated',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'User is unable to save credit hold checkbox on customer level profile for any customer account. Found that “Credit Check Failure” hold definition has been end dated.',
      p_solution               => 'Refer to [2728387/KB768439]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_ONT_ONTSO_CREDITCHECK_HOLD_DEFINITION_ENDDATED');
...
debug('begin add_signature: BOOKED_SO_HEADERS_NONBOOKED_LINES_DETAILS');
  ...
  add_signature(
    ...
    AND   h.last_update_date between ''##$$SDATE$$##'' and ''##$$EDATE$$##''
    ...
    order by h.last_update_date DESC',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The output shows Sales Orders that have Booked Headers with non-booked lines. Non-booked sales order lines cannot progress. Their workflow is stalled.',
      p_solution               => 'If this is a reoccurring issue, check if there is any kind of custom code.  If yes, verify commit or rollback are not being used within the custom code.

To progress the stalled lines, refer to [2226124/KB450158] to progress the lines missing Workflow assignment / activity .',
...
debug('begin add_signature: CANCELLED_SO_HEADER_INVALID_OPEN_FLAG_DETAILS');
  ...
  add_signature(
    ...
    AND ooh.last_update_date between ''##$$SDATE$$##'' and ''##$$EDATE$$##''
    ...
    order by ooh.last_update_date DESC',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Cancelled Sales Order(s) with an improperly set Open Flag.',
      p_solution               => 'Cancelled Sales Orders with their Open Flag still set to Yes may cause issues during Month End closing.  

Refer to [416276/KB625897] for assistance in completely cancelling the Sales Order(s).',
      p_success_msg            => 'No issues found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
...
debug('begin add_signature: CANCELLED_CLOSED_SO_HEADERS_OPEN_LINES_DETAILS');
  ...
  add_signature(
    ...
    FROM oe_order_headers_all h, 
        ...
        hr_operating_units ou
    WHERE h.last_update_date between ''##$$SDATE$$##'' and ''##$$EDATE$$##''
    AND   l.header_id = h.header_id
    AND   h.org_id = ou.organization_id
    AND   h.open_flag = ''N''
    AND   l.open_flag = ''Y''
    order by h.last_update_date DESC',
      p_title                  => 'Cancelled or Closed SO Headers with Open Lines',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Closed Sales Order Header(s) with open Sales Order Line(s).',
      p_solution               => '<p>This check has found one or more line(s) open on Closed Sales Orders, but Sales Order Lines owned by a Closed Sales Order Header can still be processed. </p>

<p>Try progressing the line(s) through their workflow to Closure, or if no longer needed try cancelling the line(s).</p>

<p>Refer to [343338/KB793444] for details.</p>
',
      p_success_msg            => 'No issues found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
       ...
       (
         SELECT decode(wi.end_date, NULL, ''PENDING'', ''CLOSED'')
          ...
          WHERE item_type = ''OEOL''
            AND item_key = to_char(oel1.line_id)
       ) "WF STATUS",
       (
         SELECT COUNT(1)
          ...
          WHERE dd.source_line_id = oel1.line_id
            ...
            AND released_status NOT IN ( ''D'', ''X'' )
       ) "No of Del Dtls",
       to_char(oel1.last_update_date, ''DD-MON-RR'') "LAST UPDATE",
       (SELECT name FROM hr_all_organization_units ou WHERE h.org_id = ou.organization_id) "OPERATING UNIT"
  FROM oe_order_lines_all oel1,
       oe_order_headers_all h
 WHERE oel1.open_flag = ''Y''
   AND oel1.cancelled_flag = ''Y'' 
   AND oel1.last_update_date between ''##$$SDATE$$##'' and ''##$$EDATE$$##''
   AND oel1.header_id = h.header_id
 ORDER BY oel1.last_update_date DESC',
      p_title                  => 'Cancelled SO Lines with invalid Open Flag',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Sales Order Line(s) with improperly set Cancelled and Open Flags.  ',
      p_solution               => 'If the reported rows are current, check for errors in the Workflow Cancel activity via output of Sales Order Analyzer [2038363/KB552468] of the order(s).

Refer to [416276/KB625897] for assistance in completely cancelling the Sales Order Line(s).',
      p_success_msg            => 'No issues found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
...
debug('begin add_signature: INTERNAL_ORDER_SHIPMENTS_MISSING_REQUISITION_DETAILS');
  ...
  add_signature(
    ...
    FROM   wsh_delivery_details wdd,
           oe_order_lines_all ol,
           hr_operating_units ou
    WHERE  ol.last_update_date between ''##$$SDATE$$##'' and ''##$$EDATE$$##''
    AND    NVL(''##$$ORGID$$##'',0) = wdd.ORGANIZATION_ID  
    ...
    order by wdd.creation_date DESC',
      p_title                  => 'Internal Order Shipment with Missing Requisition',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'These Internal Orders may cause the Inventory Interface/Interface Trip Stop processes to fail with "Requisition Line not found" message.',
      p_solution               => 'Verify actual issue / error of the Sales Order Line(s) via output of Sales Order Analyzer [2038363/KB552468] of the order(s).',
      p_success_msg            => 'No issues found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
...
debug('begin add_signature: RMA_RECEIVING_STUCK');
  ...
  add_signature(
    ...
    WHERE oh.last_update_date between ''##$$SDATE$$##'' and ''##$$EDATE$$##''
    ...
    AND  (( ol.ordered_quantity = 
      ...
      p_title                  => 'RMA with Stuck Receiving Transaction',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Open SO Lines which are related to Receiving Transactions that are stuck.',
      p_solution               => 'Refer to [378221/KB627858] for assistance in progressing the RMA Receipt(s).',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
...
debug('begin add_signature: ORDER_MGMT_MISSING_DOC_SEQUENCE_ASSIGNMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15412',
      p_sig_id                 => 'ORDER_MGMT_MISSING_DOC_SEQUENCE_ASSIGNMENTS',
      p_sig_sql                => 'SELECT
    t.org_id,
    t.transaction_type_id,
    DECODE(t.sales_document_type_code,''O'',''Sales Order'',''B'',''Sales Agreement'',t.sales_document_type_code) "Transaction Type Code",
    tl.name   "Transaction Type",
    g.name    "Ledger",
    ar2.set_of_books_id
FROM
    oe_transaction_types_all t,
    oe_transaction_types_tl tl,
    ar_system_parameters_all ar2,
    gl_sets_of_books g
WHERE
    t.transaction_type_id = tl.transaction_type_id
    AND ar2.org_id = t.org_id
    AND ar2.set_of_books_id = g.set_of_books_id
    AND tl.language = ''US''
    ...
    AND NOT EXISTS (
        SELECT
            *
        FROM
            fnd_doc_sequence_assignments a,
            ar_system_parameters_all ar
        WHERE
            a.category_code = TO_CHAR(t.transaction_type_id)
            AND ar.org_id = t.org_id
            AND ar.set_of_books_id = a.set_of_books_id
...
ORDER BY
    ...
    2,
    3',
      p_title                  => 'Missing Active Document Sequence Assignment For Order Types',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Active Order Type(s) are missing Document Sequence Assignments.',
      p_solution               => '<ul>
<li>Set correct Document Sequence Assignments for the Order Types</li>
<li>For more information regarding this issue, review [2031743/KB709874] for instructions and details.</li>
</ul>',
      p_success_msg            => 'No Active Order Type(s) are missing Document Sequence Assignments.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ORDER_MGMT_MISSING_DOC_SEQUENCE_ASSIGNMENTS');



debug('begin add_signature: SALES_ORDER_DEBUG_OPTIONS_ENABLED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15300',
      p_sig_id                 => 'SALES_ORDER_DEBUG_OPTIONS_ENABLED',
      p_sig_sql                => 'select p.profile_option_name PROFILE_OPTION_NAME,
       ...
       decode(to_char(v.level_id),
               ...
               ''10003'', (select rsp_t.responsibility_name from fnd_responsibility_tl rsp_t where rsp.responsibility_id = rsp_t.responsibility_id and rsp_t.language = ''US''),
               ''10004'', usr.user_name,
               ''10005'', svr.node_name,
               ''10006'', org.name,
...
where p.profile_option_id = v.profile_option_id (+)
  ...
  and n.language = ''US''
  and (
         upper(p.profile_option_name) = ''ACCOUNT_GENERATOR:DEBUG_MODE'' and nvl(v.profile_option_value,''N'') != ''N'' -- Account Generator:Run in Debug Mode
      or upper(p.profile_option_name) = ''INV_DEBUG_LEVEL'' and nvl(v.profile_option_value,0) <> ''0'' -- INV:Debug Level
      or upper(p.profile_option_name) = ''INV_DEBUG_TRACE'' and nvl(v.profile_option_value,2) <> 2 -- INV: Debug Trace
      or upper(p.profile_option_name) = ''MRP_DEBUG'' and nvl(v.profile_option_value,''N'') != ''N'' -- MRP:Debug Mode
      or upper(p.profile_option_name) = ''MSC_ATP_DEBUG'' and nvl(v.profile_option_value,''N'') != ''N'' -- MSC: ATP Debug Mode
      or upper(p.profile_option_name) = ''ONT_DEBUG_LEVEL'' and nvl(v.profile_option_value,0) <> ''0'' -- OM: Debug Level
      or upper(p.profile_option_name) = ''QP_DEBUG'' and nvl(v.profile_option_value,''N'') != ''N'' -- QP: Debug
      or upper(p.profile_option_name) = ''WSH_DEBUG_MODE'' and nvl(v.profile_option_value,''F'') != ''F'' -- WSH: Debug Enabled
      or upper(p.profile_option_name) = ''AFLOG_ENABLED'' and nvl(v.profile_option_value,''N'') != ''N'' -- FND: Debug Log Enabled
      or upper(p.profile_option_name) = ''RCV_DEBUG_MODE'' and nvl(v.profile_option_value,''N'') != ''N'' -- RCV: Debug Mode
  )
  ...
  order by profile_option_name, level_id, level_set',
      p_title                  => 'Sales Order Debug Options Enabled',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Sales Order Process Related Debug Profile Options are Enabled.',
      p_solution               => '<ul>
<li>Turn off unnecessary sales order process related debug profile options which may lead to performance issue</li>
<li>For more information regarding this issue, review [2703834/KB713784] for instructions and details.</li>
</ul>',
      p_success_msg            => 'No sales order process related debug profile options enabled',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SALES_ORDER_DEBUG_OPTIONS_ENABLED');



debug('begin add_signature: SALES_ORDER_LINES_STUCK_BOOKED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15101',
      p_sig_id                 => 'SALES_ORDER_LINES_STUCK_BOOKED',
      p_sig_sql                => 'SELECT
    l.line_id                 "Line ID",
    l.line_number             "Line Number",
    nvl(l.shipped_quantity,0) "Shipped QTY",
    nvl(l.open_flag,''N'')      "Open",
    l.flow_status_code        "Workflow Status"
FROM
    oe_order_lines_all l
WHERE
    l.last_update_date between ''##$$SDATE$$##'' and ''##$$EDATE$$##''
    ...
    AND EXISTS (
      ...
      p_title                  => 'Order Line stuck as Booked',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Order Line(s) are stuck as Booked not Awaiting Shipping',
      p_solution               => '<ul>
<li>Log a Service Request with Oracle Order Management</li>
<li>For more information regarding this issue, review [2173870/KB749639] for instructions and details.</li>
</ul>',
      p_success_msg            => 'No data found of "Order Line(s) are stuck as Booked not Awaiting Shipping"',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SALES_ORDER_LINES_STUCK_BOOKED');



debug('begin add_signature: EBS_MFG_OM_ONT_ONTSO_DUPLICATE_DOC_SEQUENCE_ASSIGNMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27599',
      p_sig_id                 => 'EBS_MFG_OM_ONT_ONTSO_DUPLICATE_DOC_SEQUENCE_ASSIGNMENTS',
      p_sig_sql                => 'SELECT
    ot.name "Transaction Type",
    seq.doc_sequence_id,
    seq.type,
    seq.name,
    COUNT(*)
...
WHERE
        seq.doc_sequence_id = sa.doc_sequence_id
    AND sa.application_id = 660
    AND sa.category_code = to_char(ot.transaction_type_id)
    AND nvl(sa.end_date, sysdate + 1) > sysdate
GROUP BY
    ot.name,
    seq.doc_sequence_id,
    seq.type,
...
HAVING
    COUNT(*) > 1',
      p_title                  => 'Duplicate Document Sequence Assignment For Order Types',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Error ORA-01422 during Order Entry due to Duplicate Document Sequence Assignment For Order Types',
      p_solution               => 'Refer To [2273929/KB627221] DATAFIX To Avoid Duplicate Document Sequence Assignment Records Caused by User Incorrect Setup 
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_ONT_ONTSO_DUPLICATE_DOC_SEQUENCE_ASSIGNMENTS');



debug('begin add_signature: EBS_MFG_OM_ONT_ONTSO_INVALID_DATA_IN_OE_SYS_PARAMETERS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27680',
      p_sig_id                 => 'EBS_MFG_OM_ONT_ONTSO_INVALID_DATA_IN_OE_SYS_PARAMETERS_ALL',
      p_sig_sql                => 'SELECT
    org_id,parameter_code
FROM
    oe_sys_parameters_all osp
WHERE parameter_code in (''OE_DISCOUNT_DETAILS_ON_INVOICE'', ''OE_INVOICE_FREIGHT_AS_LINE'')
AND NOT EXISTS (
        SELECT
            1
        FROM
            hr_operating_units hou
        WHERE
            hou.organization_id = osp.org_id)',
      p_title                  => 'Invalid Data In OE_SYS_PARAMETERS_ALL table',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are multiple  records in OE_SYS_PARAMETERS_ALL table with parameter names as OE_DISCOUNT_DETAILS_ON_INVOICE and OE_INVOICE_FREIGHT_AS_LINE for org_id, But relevant data has no operating unit defined with the same org_id.',
      p_solution               => 'Refer to [1453508/KB795995]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_ONT_ONTSO_INVALID_DATA_IN_OE_SYS_PARAMETERS_ALL');



debug('begin add_signature: EBS_MFG_OM_ONT_ONTSO_ERROR_PROGRESS_DROP_SHIP_LINE');
   l_info('##MASK##USER NAME'):= 'DISPLAY_FIRST_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27607',
      p_sig_id                 => 'EBS_MFG_OM_ONT_ONTSO_ERROR_PROGRESS_DROP_SHIP_LINE',
      p_sig_sql                => 'SELECT ooh.order_number "Order Number",
       ooh.header_id "Header Id",
       ool.line_id "Line Id",
       ooh.created_by "Created By",
       fu.user_id "User Id",
 ...
 WHERE ooh.header_id = ool.header_id
   ...
   AND ool.source_type_code=''EXTERNAL''',
      p_title                  => 'User-Defined Exception Error While Progressing The Dropship Sales Order Line',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'User-Defined Exception Error Populates When attempting to progress the drop ship sales order line Due to Inactive User.
',
      p_solution               => 'Refer To [339474/KB793876] for details',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_ONT_ONTSO_ERROR_PROGRESS_DROP_SHIP_LINE');
...
debug('begin add_signature: ATO_PTO_MODEL_LINES_INCORRECT_LINK_PARENT_DETAILS');
  ...
  add_signature(
    ...
    order by l.last_update_date DESC',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'One or more of the Linking IDs (Top / Link_To / ATO) in each row shown is broken.',
      p_solution               => 'A Datafix SR will need to be logged with Oracle Support. Upload the output of Sales Order Analyzer [2038363/KB552468] of the order(s) to help administer faster processing of the issue.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
...
debug('begin add_signature: CANCELLED_MODEL_LINES_NONCANCELLED_CHILDREN_DETAILS');
  ...
  add_signature(
    ...
    AND    exists ( select ''open options exists''
      ...
      p_problem_descr          => 'This query shows the count of ATO or PTO Model Lines which are Cancelled, but where at least one Child Line is not Cancelled''. ',
      p_solution               => 'Possible problems have been found which may require a datafix.  A Datafix SR will need to be logged with Oracle Support. Upload the output of Sales Order Analyzer [2038363/KB552468] of the order(s) to help administer faster processing of the issue.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
...
debug('begin add_signature: MODEL_COMPONENTS_REMANTS_NOT_FLAGGED_DETAILS');
  ...
  add_signature(
    ...
    order by l.last_update_date DESC',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Model Components which are Remnants, but not flagged as Details.',
      p_solution               => 'A Datafix SR will need to be logged with Oracle Support. Upload the output of Sales Order Analyzer [2038363/KB552468] of the order(s) to help administer faster processing of the issue.
',
      p_success_msg            => 'No issues found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
...
debug('begin add_signature: MODELS_STATUS_CREATE_CONFIG_ITEM_EXISTS_DETAILS');
  ...
  add_signature(
    ...
    order by l.last_update_date DESC',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Models in Status Create Config, but Config Item already exists.',
      p_solution               => 'A Datafix SR will need to be logged with Oracle Support. Upload the output of Sales Order Analyzer [2038363/KB552468] of the order(s) to help administer faster processing of the issue.',
      p_success_msg            => 'No issues found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
...
debug('begin add_signature: SHIPPABLE_KITS_MODELS_NOT_OM_INTERFACED_COMPONENTS_ARE_DETAILS');
  ...
  add_signature(
    ...
    WHERE l.last_update_date between ''##$$SDATE$$##'' and ''##$$EDATE$$##''
    AND l.org_id = hou.organization_id
    AND wdd.source_code = ''OE''
    ...
    order by wdd.last_update_date DESC',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Shippable Kit Models not OM Interfaced, but its'' components are interfaced.',
      p_solution               => 'A Datafix SR will need to be logged with Oracle Support. Upload the output of Sales Order Analyzer [2038363/KB552468] of the order(s) to help administer faster processing of the issue.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
...
debug('begin add_signature: CANCELLED_DROPSHIP_LINES_OPEN_PO_LINES_DETAILS');
  ...
  add_signature(
    ...
    WHERE oeh.last_update_date between ''##$$SDATE$$##'' and ''##$$EDATE$$##''
    ...
    order by oel1.last_update_date DESC',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Cancelled Dropship Line(s) have associated open PO Line(s).',
      p_solution               => 'Possible problems have been found which may require a data fix - review the Detail Rows and refer to [566616/KB716156] for resolution.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
...
debug('begin add_signature: DUPLICATED_DROPSHIP_SOURCES_DETAILS');
  ...
  add_signature(
      ...
      p_sig_sql                => 'SELECT  oh.order_number "ORDER NUMBER",
        oh.header_id "HEADER ID",
        ol.line_id "LINE ID",
          COUNT(*)
   ...
   WHERE odss.last_update_date between ''##$$SDATE$$##'' and ''##$$EDATE$$##''
     AND odss.line_id = ol.line_id
...
GROUP BY oh.order_number,
  ...
  HAVING COUNT(*) > 1',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Duplicated dropship source(s) have been found.',
      p_solution               => 'Possible problems have been found which may require a data fix - review the Detail Rows and refer to [739699/KB626728] for additional diagnostics.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
...
debug('begin add_signature: SALES_ORDER_LINES_MULTIPLE_DROPSHIP_SOURCES_DETAILS');
  ...
  add_signature(
      ...
      p_title                  => 'Sales Order Lines with Multiple Dropship Sources',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Sales Order Line(s) with Multiple Dropship Sources have been located.',
      p_solution               => 'Possible problems have been found which may require a data fix - please review the Detail Rows and refer to [566616/KB716156]  for resolution.',
      p_success_msg            => 'No issues found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
...
debug('begin add_signature: BOOKED_DROPSHIP_LINES_NULL_SCHEDULED_SHIP_DATE_DETAILS');
  ...
  add_signature(
    ...
    order by oel1.last_update_date DESC',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Booked Dropship Line(s) With Null Scheduled Ship Dates have been found.',
      p_solution               => 'Possible problems have been found which may require a data fix - review the Detail Rows and refer to [566616/KB716156] for resolution.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
...
debug('begin add_signature: RECEIVED_DROPSHIP_LINES_STUCK_IN_AWAITING_RECEIPT_DETAILS');
  ...
  add_signature(
    ...
    order by l.last_update_date DESC',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Received Dropship Line(s) Stuck in Awaiting Receipt have been found.',
      p_solution               => 'Possible problems have been found which may require a data fix - review the Detail Rows and refer to [566616/KB716156] for resolution.',
      p_success_msg            => 'No issues found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
...
debug('begin add_signature: DROPSHIP_LINES_STUCK_IN_AWAITING_RETURN_DETAILS');
  ...
  add_signature(
    ...
    order by ol.last_update_date DESC',
      p_title                  => 'Dropship Lines Stuck Awaiting Return or Awaiting Return Disposition',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Dropship Line(s) stuck in Awaiting Return or Awaiting Return Disposition have been found.',
      p_solution               => 'Possible problems have been found which may require a data fix - review the Detail Rows and refer to [566616/KB716156] for resolution.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
...
debug('begin add_signature: ORDER_MGMT_EXPENSE_DROP_SHIPS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15357',
      p_sig_id                 => 'ORDER_MGMT_EXPENSE_DROP_SHIPS',
      p_sig_sql                => 'SELECT
    rcv.transaction_id,
    oel.line_id
FROM
...
WHERE
    ...
    AND oel.last_update_date between ''##$$SDATE$$##'' and ''##$$EDATE$$##''
    AND nvl(oel.shipped_quantity,0) = 0
    AND oed.line_id = oel.line_id
    ...
    AND EXISTS (
        ...
        WHERE
            rcv_transaction_id = rcv.transaction_id
    )
   ...
   AND msib.inventory_asset_flag = ''N''',
      p_title                  => 'Expense Drop Ship Stuck Awaiting Receipt',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Expense Drop Ship Line is Stuck in Awaiting Receipt.',
      p_solution               => '<ul>
<li>Log a Service Request to obtain datafix for the line.</li>
<li>For more information regarding this issue, review [2110685/KB763202] for instructions and details.</li>
</ul>',
      p_success_msg            => 'No Expense Drop Ship Line is Stuck in Awaiting Receipt.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ORDER_MGMT_EXPENSE_DROP_SHIPS');



debug('begin add_signature: ORDER_MGMT_PO_REQUISITIONS_INTERFACE_ALL_IN_PROCESS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16354',
      p_sig_id                 => 'ORDER_MGMT_PO_REQUISITIONS_INTERFACE_ALL_IN_PROCESS',
      p_sig_sql                => 'Select
     HDR.ORDER_NUMBER                       "Order Number",
     HDR.ORG_ID                             "Org ID",
     LIN.HEADER_ID                          "Order Header ID",
     RQI.INTERFACE_SOURCE_LINE_ID           "Drop Ship ID",
     om_order_analyzer_pkg.line_shipment_option(lin.line_number, lin.shipment_number, lin.option_number, lin.component_number, lin.service_number) "Line Number",
     RQI.PROCESS_FLAG                       "Process Flag",
     RQI.REQUEST_ID                         "Request ID",
     RQI.AUTHORIZATION_STATUS               "Authorization Status",   
     RQI.DELIVER_TO_LOCATION_ID             "Delivery To Loc",
     RQI.PREPARER_ID                        "Preparer ID",
...
where  SRC.LINE_ID                      = LIN.LINE_ID
  ...
  and  RQI.INTERFACE_SOURCE_CODE        = ''ORDER ENTRY'' 
  and  RQI.PROCESS_FLAG                 = ''IN PROCESS''
  and  RQI.REQUEST_ID IS NOT NULL 
  and  SRC.DROP_SHIP_SOURCE_ID          = RQI.INTERFACE_SOURCE_LINE_ID
  and  LIN.LAST_UPDATE_DATE BETWEEN ''##$$SDATE$$##'' and ''##$$EDATE$$##''
order by
     ...
     LIN.LINE_ID',
      p_title                  => 'PO Requisitions Interface is IN PROCESS',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'In process data for the drop ship line exists in PO_REQUISITIONS_INTERFACE_ALL',
      p_solution               => 'Log a Service Request to obtain datafix for the line.  For more information regarding this issue, review [2100484/KB773225] for instructions and details.
',
      p_success_msg            => 'No issues found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: ORDER_MGMT_PO_REQUISITIONS_INTERFACE_ALL_IN_PROCESS');



debug('begin add_signature: ORDER_MGMT_WF_COUNT_SUMMARY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11516',
      p_sig_id                 => 'ORDER_MGMT_WF_COUNT_SUMMARY',
      p_sig_sql                => 'select wi.item_type "Item Type", 
wit.display_name "Display Name", 
wi.PARENT_ITEM_TYPE "Parent Item Type", 
nvl(to_char(wi.end_date, ''YYYY''),''OPEN'') "Closed",
...
order by to_char(wi.end_date, ''YYYY'')',
      p_title                  => 'Summary OM Workflow Processes By Item Type and Parent',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Summary of All Order Management Workflow Processes By Item Type & Parent',
      p_solution               => '',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: ORDER_MGMT_WF_COUNT_SUMMARY');



debug('begin add_signature: ORDER_MGMT_CP_CHK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11517',
      p_sig_id                 => 'ORDER_MGMT_CP_CHK',
      p_sig_sql                => 'select r.REQUEST_ID "REQUEST_ID",
r.PHASE_CODE "PHASE", 
r.ACTUAL_START_DATE "STARTED",
c.CONCURRENT_PROGRAM_NAME "INTERNAL NAME", 
...
r.RESUBMIT_END_DATE "RESUBMIT_END_DATE"
...
order by c.CONCURRENT_PROGRAM_NAME, r.ARGUMENT_TEXT',
      p_title                  => 'OM Workflow Concurrent Process Schedule',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no Workflow Background Processes (FNDWFBG) scheduled to run for ALL Item_Types.',
      p_solution               => 'Schedule the concurrent request "Workflow Background Process" to process deferred, timed-out, and identify stuck activities for ALL item_types using development''s recommendations.<br><br>
For detailed recommendations refer to [466535/KB795366] - How to run the Workflow Background Engine per developments recommendations.
...
',
   ...
   l_info.delete;
debug('end add_signature: ORDER_MGMT_CP_CHK');
...
debug('begin add_signature: COUNT_WORKFLOW_JOBS_DEFERRED_STATUS');
  ...
  add_signature(
    ...
    group by s.item_type, process_name, instance_label, process_version',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No OEOH or OEOL Workflow Activities  are in a Status of DEFERRED.',
      p_solution               => 'Refer to [971925/KB625940] for recommendations on how to run and how often to run the Workflow Background Process in order to progress DEFERRED Workflow Activities.',
      p_success_msg            => 'No issues found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
...
debug('begin add_signature: COUNT_WORKFLOW_JOBS_ERRORED_STATUS_CHILD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11490',
      p_sig_id                 => 'COUNT_WORKFLOW_JOBS_ERRORED_STATUS_CHILD',
      p_sig_sql                => 'SELECT s.item_type "ITEM TYPE",
           s.item_key "ITEM KEY",
           s.BEGIN_DATE "BEGIN DATE",
           s.END_DATE "END DATE",
...
WHERE s.activity_status = ''ERROR'' 
    AND s.process_activity = p.instance_id
    AND s.BEGIN_DATE between ''##$$SDATE$$##'' and ''##$$EDATE$$##''
    AND s.item_type = ''##$$FK1$$##''
    AND p.process_name = ''##$$FK2$$##''',
      p_title                  => 'Details WorkFlow Jobs in ##$$FK2$$## Errored Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This query shows the detail of OE Workflow ''##$$FK2$$##'' Activities which are in a Status of ERROR.  ',
      p_solution               => 'Retry the errant transation(s):
1. Go into the responsibility: Order Management Super User
2. Navigate to Requests,Reports
3. Run Retry Activities in Error concurrent program [376040/KB716382] in ''Execute'' mode with debug profile ''OM:Debug Level'' set to 5.

Verify that the line(s) progressed or not.  If not, you can review the Debug for additional details and/or refer to [255045/KB648581] for details on reviewing Workflow Errors and resolving / progressing them. ',
      p_success_msg            => 'No issues found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: COUNT_WORKFLOW_JOBS_ERRORED_STATUS_CHILD');
...
debug('begin add_signature: COUNT_WORKFLOW_JOBS_ERRORED_STATUS');
  ...
  add_signature(
    ...
    group by s.item_type, s.activity_result_code, p.process_name, p.instance_label, p.process_version',
      p_title                  => 'WorkFlow Jobs in Errored Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This query shows the count of OE Workflow Activities which are in a Status of ERROR.  These transaction will not progress without correction to their error(s).',
      p_solution               => 'Retry the errant transation(s):
1. Go into the responsibility: Order Management Super User
2. Navigate to Requests,Reports
3. Run Retry Activities in Error concurrent program [376040/KB716382] in ''Execute'' mode with debug profile ''OM:Debug Level'' set to 5.
...
Verify that the line(s) progressed or not.  If not, you can review the Debug for additional details and/or refer to [255045/KB648581] for details on reviewing Workflow Errors and resolving / progressing them. ',
      ...
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('COUNT_WORKFLOW_JOBS_ERRORED_STATUS_CHILD'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '17'
      );
   l_info.delete;
...
debug('begin add_signature: WORKFLOW_ITEMS_PASSED_PURGE_DATE');
  ...
  add_signature(
      ...
      p_sig_sql                => 'SELECT wi.item_type,
       COUNT(*)
  FROM wf_items wi,
       wf_item_types wit
 WHERE wi.item_type = wit.name
   AND wi.end_date + nvl(wit.persistence_days, 0) <= sysdate
   AND wi.end_date IS NOT NULL
   AND wi.item_type IN ( ''OEOH'', ''OEOL'', ''OENH'', ''OEBH'', ''OMERROR'', ''OEAME'' )
 GROUP BY wi.item_type
',
      p_title                  => 'Workflow Items which are ready for Purge',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Workflow Items shown are ready for Purge.  ',
      p_solution               => 'Refer to [878032/KB626917] for additional information / solutions on Purging Workflow activities no longer required.',
      p_success_msg            => 'No issues found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
...
debug('begin add_signature: CLOSED_SO_HEADERS_PENDING_WF_ACTIVITY_DETAILS');
  ...
  add_signature(
    ...
    AND   h.open_flag = ''N''
    order by h.last_update_date DESC',
      p_title                  => 'Closed SO Headers with Pending Workflow Activity',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Closed Sales Order(s) with pending Workflow Activity Details have been found.',
      p_solution               => 'Review the Pending Workflow Activities.  <br><br>

Try running the Concurrent Process "Workflow Background Process" for the Pending Workflow Activities. <br><br>

If needed a Datafix SR can be logged with Oracle Support. Upload the output of Sales Order Analyzer [2038363/KB552468] of the order(s) to help administer faster processing of the issue.',
      p_success_msg            => 'No issues found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
...
debug('begin add_signature: CLOSED_SO_LINES_PENDING_WF_ACTIVITY_DETAILS');
  ...
  add_signature(
      ...
      p_sig_sql                => 'SELECT h.order_number "Order No",
       ...
       l.cancelled_flag "Cancelled Flag",
       l.flow_status_code "Status",
 ...
 WHERE l.header_id = h.header_id
   ...
   AND l.last_update_date >= sysdate - 30
   AND EXISTS (
  SELECT 1
    FROM wf_items wfi
   WHERE wfi.item_type = ''OEOL''
     AND wfi.end_date IS NULL
     AND l.line_id = TO_NUMBER(wfi.item_key) )
 ORDER BY l.last_update_date DESC',
      p_title                  => 'Closed SO Lines with Pending Worflow Activity',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Closed Sales Order Line(s) with pending Workflow Activity Details have been found',
      p_solution               => 'Review the Pending Workflow Activities. <br><br>
...
debug('begin add_signature: OPEN_SO_HEADERS_WF_FLOW_MISSING_CLOSED_DETAILS');
  ...
  add_signature(
    ...
    AND not exists (select 1 from wf_items wi   
                    where to_number(wi.item_key) = h.header_id
                    and wi.item_type = ''OEOH'' )
    AND nvl(h.transaction_phase_code, ''F'') = ''F''
    order by h.last_update_date DESC',
      p_title                  => 'Open SO Headers Where Workflow is Missing',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are open Sales Order Header(s) which have missing header workflow',
      p_solution               => 'Refer to [1319652/KB156909] for details. ',
      p_success_msg            => 'No issues found.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
...
debug('begin add_signature: OPEN_SO_LINES_WF_FLOW_MISSING_CLOSED_DETAILS');
  ...
  add_signature(
      ...
      p_sig_sql                => 'SELECT nvl(to_char(h.order_number), ''** Missing Record **'') "ORDER NO",
           ...
           l.flow_status_code "STATUS",
           to_char(h.last_update_date, ''DD-MON-RR'') "HEADER LAST UPDATED",
           to_char(l.last_update_date, ''DD-MON-RR'') "LINE LAST UPDATED",
           hou.name "OPERATING UNIT"
    FROM oe_order_headers_all h, 
         oe_order_lines_all l, 
    ...
    AND   l.org_id               = hou.organization_id
    AND   l.open_flag = ''Y''
    AND   l.last_update_date between ''##$$SDATE$$##'' and ''##$$EDATE$$##''
   ...
   AND NVL(''##$$ORGID$$##'',0) in (0, l.ship_from_org_id)	
    order by h.last_update_date DESC',
      p_title                  => 'Open SO Lines where Workflow is Missing',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are open Sales Order Line(s) which have no line workflow',
      p_solution               => 'Review [2200940/KB769001] for details.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
...
debug('begin add_signature: OPEN_SO_HEADERS_WF_FLOW_INITIATED_NOT_STARTED_DETAILS');
  ...
  add_signature(
    ...
    AND nvl(h.transaction_phase_code, ''F'') = ''F''
    order by h.last_update_date DESC',
      p_title                  => 'Open SO Headers where Workflow is Initiated but not Started',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'All Sales Order Headers must have associated workflow and the workflow must be started in order to progress the sales order.',
      p_solution               => 'Refer to [2226124/KB450158] to assist with Sales Order Header(s) that do not have workflow or the workflow has not been started.',
      p_success_msg            => 'No issues found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
...
debug('begin add_signature: OPEN_SO_LINES_WF_FLOW_INITIATED_NOT_STARTED_DETAILS');
  ...
  add_signature(
    ...
    AND nvl(l.transaction_phase_code, ''F'') = ''F''
    order by l.last_update_date DESC',
      p_title                  => 'Open SO Lines where Workflow is Initiated but not Started',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'All Sales Order Line(s) must have associated workflow which has started in order to progress the line(s).  These line(s) do not have associated started workflows.',
      p_solution               => 'Refer to [2226124/KB450158] to assist with Sales Order Header(s) that do not have workflow or the workflow has not been started.',
      p_success_msg            => 'No issues found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
...
debug('begin add_signature: OPEN_SO_HEADERS_WF_FLOW_PENDING_NO_OPEN_LINES_DETAILS');
  ...
  add_signature(
    ...
    AND not exists (
          ...
          and    open_flag = ''Y'')
    order by h.last_update_date DESC',
      p_title                  => 'Open SO Headers with Pending Workflow but no Open Lines',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Sales Order Headers having pending Workflow but do not have any open sales order line(s).',
      p_solution               => 'Review the data to determine if the Pending Workflow Activity is valid.  <br><br>

Try running the Concurrent Process "Workflow Background Process" for the Pending Workflow Activities.<br><br>

If the workflow is not valid and cannot be progressed, a Datafix SR will need to be logged with Oracle Support. Upload the output of Sales Order Analyzer [2038363/KB552468] of the order(s) to help administer faster processing of the issue.',
      p_success_msg            => 'No issues found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
...
debug('begin add_signature: ORDER_MGMT_ORPH_HDRS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11518',
      p_sig_id                 => 'ORDER_MGMT_ORPH_HDRS',
      p_sig_sql                => 'select item_type "ITEM TYPE",
item_key "ITEM KEY",
...
order by begin_date',
      p_title                  => 'Orphaned OEOH Workflows',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are Order Management header ids that exist in WF_ITEMS but not found in OE_ORDER_HEADERS_ALL.  These may cause performance issues.',
      p_solution               => 'Refer to [398822/KB628170] - Order Management Suite - Some Data Fix Patches and Scripts, for a Data Fix:  Abort Orphan Line/Header Workflows.',
      p_success_msg            => 'There are no Order Management header ids that exist in WF_items but not found in OE_ORDER_HEADERS_ALL.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ORDER_MGMT_ORPH_HDRS');



debug('begin add_signature: ORDER_MGMT_ORPH_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11519',
      p_sig_id                 => 'ORDER_MGMT_ORPH_LINES',
      p_sig_sql                => 'select item_type "ITEM TYPE",
item_key "ITEM KEY",
begin_date "BEGIN DATE",
end_date "END DATE",
...
order by begin_date',
      p_title                  => 'Orphaned OEOL Workflows',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are Order Management header ids that exist in WF_ITEMS but not found in OE_ORDER_HEADERS_ALL.  These may cause performance issues.',
      p_solution               => 'Refer to [398822/KB628170] - Order Management Suite - Some Data Fix Patches and Scripts, for a Data Fix:  Abort Orphan Line/Header Workflows.',
      p_success_msg            => 'There are no Order Management header ids that exist in WF_items but not found in OE_ORDER_HEADERS_ALL.',
   ...
   l_info.delete;
debug('end add_signature: ORDER_MGMT_ORPH_LINES');



debug('begin add_signature: ORDER_MGMT_WF_LOOPING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11520',
      p_sig_id                 => 'ORDER_MGMT_WF_LOOPING',
      p_sig_sql                => 'select sta.item_type "ITEM_TYPE",
sta.item_key "ITEM_KEY",
to_char(COUNT(*),''999,999,999,999'') "COUNT",
TO_CHAR(wfi.begin_date, ''YYYY-MM-DD'') "OPENED",
TO_CHAR(wfi.end_date, ''YYYY-MM-DD'') "CLOSED",
...
HAVING COUNT(*) > 500
ORDER BY COUNT(*) DESC',
      p_title                  => 'OM Workflow with Excessive Looping',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'It is normal for Workflow to use WAITS and other looping acitivities to process delayed responses and other criteria. <br><br>
Each revisit of a node replaces the previous data with the current activities status and stores the old activity information into a activities history table.<br><br>
Looking at this history table (WF_ITEM_ACTIVITY_STATUSES_H) can help to identify possible long running Order Management Workflows that appear to be stuck in a loop over a long time, or a poorly designed workflow that is looping excessively and can cause performance issues. ',
      p_solution               => 'Refer to [144806/KB790386] - A Detailed Approach To Purging Oracle Workflow Runtime Data on how to drill down and discover how to purge this workflow data. ',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: ORDER_MGMT_WF_LOOPING');



debug('begin add_signature: ORDER_MGMT_WF_ERR_CANCEL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11522',
      p_sig_id                 => 'ORDER_MGMT_WF_ERR_CANCEL',
      p_sig_sql                => 'SELECT e.item_type "ITEM TYPE", 
e.parent_item_type "PARENT ITEM TYPE",
...
order by count(e.item_type) desc',
      p_title                  => 'Workflow Error processes to cancel',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Dangling Order Management Workflow Error processes that should be closed.  These may cause performance issues.',
      p_solution               => 'Run the bde_wf_process_tree.sql script found in [1378954/KB593006] - bde_wf_process_tree.sql - For analyzing the Root Parent, Children, Grandchildren Associations of a Single Workflow Process.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: ORDER_MGMT_WF_ERR_CANCEL');



debug('begin add_signature: ORDER_MGMT_HEADERS_WITH_NO_OPEN_LINE_NO_HEADER_WORKFLOW_AND_NO_LINE_WORKFLOW');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15097',
      p_sig_id                 => 'ORDER_MGMT_HEADERS_WITH_NO_OPEN_LINE_NO_HEADER_WORKFLOW_AND_NO_LINE_WORKFLOW',
      p_sig_sql                => 'SELECT
...
AND i.end_date IS NULL)
order by h.last_update_date DESC',
      p_title                  => 'Order Headers With No Open Line, No Header Workflow and No Line Workflow',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Sales Order Headers are stuck in an open status with no associated open lines, order header workflow or order line workflows.',
      p_solution               => 'Refer to solution in [397565/KB746001].

Patch 31806934:R12.ONT.B provides a datafix script, ontd0074.sql, that will close open sales order headers that
exist with no associated open lines, order header workflow or order line workflows.  For all such order headers,
the script contained in this patch sets Open Flag to N and Flow Status Code to Closed or Cancelled.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: ORDER_MGMT_HEADERS_WITH_NO_OPEN_LINE_NO_HEADER_WORKFLOW_AND_NO_LINE_WORKFLOW');



debug('begin add_signature: ORDER_MGMT_BOOKED_HDR_NONBOOKED_LIN_PROGRESSED_WF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15628',
      p_sig_id                 => 'ORDER_MGMT_BOOKED_HDR_NONBOOKED_LIN_PROGRESSED_WF',
      p_sig_sql                => 'SELECT 
    oh.order_number "Order Number",
    oh.header_id "Header ID",
    ...
    || decode(lin.component_number,NULL, NULL, decode(lin.option_number, NULL, ''.'', NULL)||''.''||to_char(lin.component_number))
    || decode(lin.service_number, NULL, NULL, decode(lin.component_number, NULL, ''.''||decode(lin.option_number,NULL,''.'',NULL),NULL)|| ''.''|| to_char(lin.service_number)),1,10) "Line Number",
    lin.line_id "Line ID",
    lin.flow_status_code "Flow Status Code",
    lin.booked_flag "Booked Flag",
    lin.shipping_interfaced_flag "Shipping Interfaced Flag"
FROM
    oe_order_headers_all oh,
    oe_order_lines_all lin,
    wf_item_activity_statuses wfs,
    wf_process_activities wfp
WHERE    oh.header_id = lin.header_id  
    AND  oh.booked_flag = ''Y''        
    AND  oh.open_flag = ''Y''          
    AND  lin.booked_flag = ''N''       
    AND lin.open_flag = ''Y''         
    AND  lin.last_update_date between ''##$$SDATE$$##'' and ''##$$EDATE$$##''
    AND  lin.shipping_interfaced_flag != ''Y''
    AND wfs.item_key = TO_CHAR(lin.line_id)
    AND wfs.item_type = ''OEOL''
    AND wfp.process_name = ''SHIP_CONFIRM''
    AND wfs.process_activity = wfp.instance_id',
      p_title                  => 'Header Booked, Line Not Booked and Line Workflow Progressed',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Header Booked, Line Not Booked and Line Workflow Progressed',
      p_solution               => '<ul>
<li>Log a Service Request to obtain datafix for the line.</li>
<li>For more information regarding this issue, review [2495581/KB714561] for instructions and details.</li>
</ul>',
      p_success_msg            => 'No issues found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: ORDER_MGMT_BOOKED_HDR_NONBOOKED_LIN_PROGRESSED_WF');



debug('begin add_signature: ORDER_MGMT_BOOKED_HDR_BOOKED_LIN_PROGRESSED_WF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20536',
      p_sig_id                 => 'ORDER_MGMT_BOOKED_HDR_BOOKED_LIN_PROGRESSED_WF',
      p_sig_sql                => 'SELECT
    h.order_number "Order Number",
    h.header_id "Header ID",
    l.line_number "Line Number",
...
order by l.line_number, 
         nvl(l.shipment_number, -1),
         nvl(l.option_number, -1),
         nvl(l.component_number, -1),
         nvl(l.service_number, -1)',
      p_title                  => 'Order Line(s) stuck as Booked',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Order Line(s) are stuck as Booked not Awaiting Shipping',
      p_solution               => '<ul>
<li>Log a Service Request with Oracle Order Management</li>
<li>For more information regarding this issue, review [2173870/KB749639] for instructions and details.</li>
   ...
   l_info.delete;
debug('end add_signature: ORDER_MGMT_BOOKED_HDR_BOOKED_LIN_PROGRESSED_WF');
...
debug('begin add_signature: CANCELLED_ORDER_LINES_PENDING_DELIVERIES_DETAILS');
  ...
  add_signature(
    ...
    order by l.last_update_date DESC',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Sales Order Line(s) has been Cancelled, yet Delivery Detail Line is still open.',
      p_solution               => 'Since the Sales Order Line(s) has been Cancelled, all associated Delivery Detail Line(s) should no longer be open.

Log an SR with Oracle Support requesting a Datafix to close open Delivery Detail Line(s) against a Cancelled Sales Order Line. Upload the output of Sales Order Analyzer [2038363/KB552468] of the order(s) to the SR.',
      p_success_msg            => 'No issues found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
...
debug('begin add_signature: CLOSED_ORDER_LINES_NOT_ALL_DELIVERY_DETAILS_INTERFACED_DETAILS');
  ...
  add_signature(
    ...
    order by l.last_update_date DESC',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The order line is closed, while the delivery detail is not interfaced to Order Management.',
      p_solution               => 'The open Delivery Details may cause an issue during Month End Closing.  

Run the Interface Trip Stop for the Deliveries not interfaced with Debug enabled.  If the Deliveries do not interface, a Datafix SR will need to be logged with Oracle Support.  Upload the output of Sales Order Analyzer [2038363/KB552468] of the order(s) along with the Debug Log of ITS to help administer faster processing of the issue.',
      p_success_msg            => 'No issues found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
...
debug('begin add_signature: OPEN_ORDER_LINES_DELIVERY_DETAILS_MISSING_DETAILS');
  ...
  add_signature(
    ...
    order by l.last_update_date DESC',
      p_title                  => 'Open Order Lines with missing Delivery Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The order line(s) is open, but no associated delivery detail exists for the line(s).',
      p_solution               => 'In order to ship the line(s), an associated delivery detail must exist.

Per [2327404/KB777517] a datafix will need to be provided from Oracle Support. Log an SR and upload the output of Sales Order Analyzer [2038363/KB552468] of the order(s) to help administer faster processing of the issue.
...
debug('begin add_signature: RELEASED_DELIVERY_DETAILS_MOVE_ORDER_CLOSED_DETAILS');
  ...
  add_signature(
    ...
    WHERE  wdd.last_update_date between ''##$$SDATE$$##'' and ''##$$EDATE$$##''
    AND    wdd.source_code = ''OE''
    ...
    order by wdd.last_update_date DESC',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'After Pick Release the status of the Delivery Detail is "Released To Warehouse" but Move Order Does Not Exist.
',
      p_solution               => 'Since the move order does not exist, user cannot transact it and therefore the Delivery Detail is stuck in "Released To Warehouse" status and cannot be processed.

Refer to [1583914/KB627141] for assistance in progressing the Delivery Detail.',
      p_success_msg            => 'No issues found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
...
debug('begin add_signature: SO_LINE_DELIVERY_DETAIL_SCHEDULED_DATE_MISMATCH_DETAILS');
  ...
  add_signature(
      ...
      p_sig_sql                => 'SELECT oeh.order_number "ORDER NO",
           ...
           oel1.line_number "LINE NO",
           oel1.line_id "LINE ID",
           wsh.delivery_detail_id "DETAIL_ID",
           oel1.item_type_code "ITEM TYPE",
           ...
           to_char(oel1.request_date,''DD-MON-RR HH24:MI:SS'') "LINE REQUEST DATE",
           to_char(wsh.date_requested,''DD-MON-RR HH24:MI:SS'') "DEL DTL REQUEST DATE",
    ...
    AND    ( nvl(oel1.schedule_ship_date,sysdate) <> nvl(wsh.date_scheduled,sysdate)
                  OR nvl(oel1.request_date,sysdate) <> nvl(wsh.date_requested,sysdate)
                )
    AND    wsh.source_code = ''OE''
    order by oel1.last_update_date DESC',
      p_title                  => 'SO Line / Delivery Detail Scheduled Date/Request Date Mismatch',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There is a mismatch between Date Scheduled/Date Requested on Delivery Detail and Schedule Ship Date/Request Date on Sales Order Line.',
      p_solution               => 'Refer to [2885723/KB755027] for details.
',
      p_success_msg            => 'No issues found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
...
debug('begin add_signature: DELIVERY_TRIP_STOP_ACTUAL_SHIP_DATE_MISMATCH_DETAILS');
  ...
  add_signature(
    ...
    AND wts.last_update_date between ''##$$SDATE$$##'' and ''##$$EDATE$$##''
    ...
    order by wts.last_update_date DESC',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Delivery Departure Date should match the actual Departure Date.',
      p_solution               => 'A Datafix SR will need to be logged with Oracle Support. Upload the output of Sales Order Analyzer [2038363/KB552468] to help administer faster processing of the issue.
',
      p_success_msg            => 'No issues found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
...
debug('begin add_signature: DELIVERY_DETAILS_ERRORED_WF_SHIP_ACTIVITIES_DETAILS');
  ...
  add_signature(
    ...
    order by wdd.last_update_date DESC',
      p_title                  => 'Delivery Details with Errored Workflow Ship Activities',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The Ship Line Activity on the order line(s) has erred.',
      p_solution               => '<p>Retry the Workflow for the erred line(s):</p>

<p>a) For retrying the workflow activity for a specific order line, please query order in the sales order and select the stuck line.  Then right mouse click and select “Retry Activities in Error” from the list and select activity ‘Ship’ from the LOV.</p>

<p>b) For retrying the workflow activity for more than one order line, submit the "Retry Activities in Error" concurrent program with the following parameters:</p>
<ul>
  <li>
  Item Type = OM Order Line</li>
  <li>Activity in Error = Ship</li>
  <li>Activity Error Date From = < Start date when table space issue occurred ></li>
  <li>Activity Error Date To = < End date when table space issue was resolved ></li>
  <li>Mode = Execute </li>
</ul>
<p>If this does not resolve the issue then a Datafix SR will need to be logged with Oracle Support. Upload the output of Sales Order Analyzer [2038363/KB552468] of the order(s) along with the Debug Log of Retry Activity to help administer faster processing of the issue.</p>',
      p_success_msg            => 'No issues found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
    ...
    AND not exists 
     (select 1
      ...
      where  was.item_type = ''OEOL''
       ...
       and    was.end_date is null)
    order by wdd.last_update_date DESC',
      p_title                  => 'Open Delivery Details with Missing or Completed Workflow Ship Activities',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Open Deliveries with no Workflow cannot progress to close.',
      p_solution               => 'Unprocessed open deliveries that cannot progress, may cause issues during Month End closing.

A Datafix SR will need to be logged with Oracle Support. Upload the output of Sales Order Analyzer [2038363/KB552468] of the order(s) to help administer faster processing of the issue.',
      p_success_msg            => 'No issues found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
...
debug('begin add_signature: SHIPPED_DELIVERY_DETAILS_OWNED_OPEN_DELIVERY_DETAILS');
  ...
  add_signature(
      ...
      AND wdd.last_update_date between ''##$$SDATE$$##'' and ''##$$EDATE$$##''
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Shipped Deliveries still show as open.',
      p_solution               => 'Shipped deliveries that still show as open, may cause issues during Month End closing.
...
debug('begin add_signature: SHIPPED_DELIVERY_DETAILS_NOT_ELIGIBLE_FOR_OM_INV_INTERFACING_DETAILS');
  ...
  add_signature(
    ...
    order by wdd.last_update_date DESC',
      p_title                  => 'Shipped Delivery Details not eligible for Interfacing',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Shipped Deliveries are not interfacing to Order Management and/or Inventory.  ',
      p_solution               => 'If the shipped Deliveries are to be interfaced and are not, then Invoicing and Inventory will not be updated. 
...
debug('begin add_signature: SHIPPED_DELIVERY_DETAILS_SHIPPED_QUANTITY_ZERO_DETAILS');
  ...
  add_signature(
    ...
    order by wdd.last_update_date DESC',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'These are Shipped Delivery Line(s) with the quantity equal to zero.',
      p_solution               => 'Review the returned information.  If the Shipped Delivery Line(s) should not have a quantitiy of zero, a Datafix SR will need to be logged with Oracle Support. Upload the output of Sales Order Analyzer [2038363/KB552468] of the order(s) to help administer faster processing of the issue.',
      p_success_msg            => 'No issues found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
  ...
  add_signature(
    ...
    AND exists (select ''Other line in the ship set not yet shipped'' 
        	from oe_order_lines_all oel2 
                ...
                and nvl(oel2.shipped_quantity,0) = 0)
    order by l.last_update_date DESC',
      p_title                  => 'Ship Set stuck with some of it Shipped and some not Shipped',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Ship Set(s) found that have one line(s) shipped and one line(s) not shipped.',
      p_solution               => 'In order for lines in a Ship Set to progress, all lines within the Ship Set must be shipped at the same time. 

A Datafix SR will need to be logged with Oracle Support to progress the stuck Ship Set. Upload the output of Sales Order Analyzer [2038363/KB552468] of the order(s)  to help administer faster processing of the issue.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
...
debug('begin add_signature: SCRIPT_LINE_CANCELLED_NOT_DELIVERY_DETAIL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9462',
      p_sig_id                 => 'SCRIPT_LINE_CANCELLED_NOT_DELIVERY_DETAIL',
      p_sig_sql                => 'select wdd.source_header_number "Order Number",
       wdd.source_line_id,
       wdd.delivery_detail_id,
       wda.delivery_id,
       wdd.released_status,wdd.creation_date,
       ol.flow_status_code,
 ...
 WHERE wdd.source_line_id = ol.line_id
       and wdd.delivery_detail_id = wda.delivery_detail_id
       and wdd.delivery_detail_id in (select wdd.delivery_detail_id from wsh_delivery_details wdd, oe_order_lines_all ol where wdd.source_code = ''OE'' 
       and wdd.released_status in (''S'',''R'',''B'',''N'') and wdd.source_line_id = ol.line_id and ol.open_flag = ''N'' and ol.cancelled_flag = ''Y'')
       AND ol.last_update_date between ''##$$SDATE$$##'' and ''##$$EDATE$$##''
       AND NVL(''##$$ORGID$$##'',0) = ol.org_id ',
      p_title                  => 'Line Cancelled Not Cascade To Detail Line',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are active detail line(s) not cancelled whose associated main line(s) has been cancelled. <br><br>

The cancellation of the order line did not cascade to the delivery detail line level. As a result, even though the order line shows a status of "Cancelled", the associated detail line may reflect a status of "Ready to Release", "Released to Warehouse" or any other non-cancellation status. <br>

This may potentially lead users to attempt to process detail lines that are inactive due to main line being cancelled.',
      p_solution               => 'Execute the script from [2346819/KB721732] - Script to Cancel Delivery Detail Line Within Shipping. <br>',
      p_success_msg            => 'There are no non-cancelled detail line(s) found whose associated main line(s) has been cancelled.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: SCRIPT_LINE_CANCELLED_NOT_DELIVERY_DETAIL');



debug('begin add_signature: ORDER_MGMT_MISSING_WSH_DELIVERY_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15561',
      p_sig_id                 => 'ORDER_MGMT_MISSING_WSH_DELIVERY_DETAILS',
      p_sig_sql                => 'SELECT
    oeh.order_number,
    oel.line_number
    || ''.''
    || oel.shipment_number lin_number,
    oel.header_id,
    oel.line_id,
...
ORDER BY
    1 ASC',
      p_title                  => 'Delivery Details do not exist for Shipping Interfaced Line(s)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Missing WSH_DELIVERY_DETAILS Data for Shipping Interfaced Line(s). ',
      p_solution               => 'Log a Service Request to obtain datafix for the line.  For more information regarding this issue, review [2851213/KB723286] for instructions and details.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: ORDER_MGMT_MISSING_WSH_DELIVERY_DETAILS');



debug('begin add_signature: EBS_MFG_OM_ONT_ONTONESO_DELIVERY_SEQUENCE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23858',
      p_sig_id                 => 'EBS_MFG_OM_ONT_ONTONESO_DELIVERY_SEQUENCE',
  ...
  FROM dba_sequences
 WHERE sequence_owner IN ( ''WSH'', ''WMS'' )
   AND round((100 / max_value) * last_number, 2) >= 70
   AND cycle_flag <> ''Y''
 ORDER BY 5 DESC, 2',
      p_title                  => 'Shipping Sequences Max Value Checks',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'ID is getting close (=>70%) to Max Value defined in sequences.


',
      p_solution               => 'Refer to [2989870/KA1025] for additional details.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_ONT_ONTONESO_DELIVERY_SEQUENCE');



debug('begin add_signature: OM_TAX_CODE_DEFAULT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7493',
      p_sig_id                 => 'OM_TAX_CODE_DEFAULT',
      p_sig_sql                => 'select
   c.ATTRIBUTE_CODE
   , c.attr_def_condition_id
   , c.enabled_flag
   , c.SYSTEM_FLAG
   , c.last_updated_by
   , c.created_by
   from oe_def_attr_condns c    
 where c.ATTRIBUTE_CODE = ''TAX_CODE''
 and c.SYSTEM_FLAG = ''Y''
 and c.enabled_flag = ''N''',
      p_title                  => 'Tax Code Defaulting',
      p_fail_condition         => 'RSGT1',
      p_problem_descr          => 'Tax Code not defaulting properly.',
      p_solution               => 'A non seeded Tax Code defaulting rule is being used.  You will need to verify your Tax Code Defaulting Record to determine where the codes are being derived from.  <br><br>

(N) Order Management > Setup > Rules > Defaulting  <br><br>

For standing defaulting of the Tax Code, review [2281749/KB762393].',
      p_success_msg            => 'A seeded Tax Code defaulting rule is being used. Standard Tax Code defaulting comes from Application Tax Options for the Operating Unit and Receivables application. <br><br>
(N) Tax Manager > Defaults and Controls > Application Tax Options. 

<br><br>Also ensure "Default tax classification" check box is checked on the AR Transaction Type. (N) AR > Setup > Transactions > Transaction Type

Review [2281749/KB762393] for additional details.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: OM_TAX_CODE_DEFAULT');



debug('begin add_signature: OM_TAX_FREIGHT');
   l_info('##MASK##LEVEL_ID'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7497',
      p_sig_id                 => 'OM_TAX_FREIGHT',
      ...
      WHERE e.application_id like 660
        AND user_profile_option_name like ''%Invoice Freight as Revenue%''
     ...
     ORDER BY e.profile_option_name',
      p_title                  => 'Tax Freight Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'It is not possible to calculate tax on Freight Charge in the Sales Order form. <br><br>

If you want Order Management (OM) to send freight line(s) as revenue lines to Accounts Receivables (AR) for taxing, then the profile ''TAX: Invoice Freight as Revenue'' must be set to Yes.  This will allow you to tax the freight lines in AR as these are passed as revenue lines.<br><br>

For most scenarios, one may use the setup described in [289816/KB746435] How to Tax Freight Charges Sent From Order Management to Receivables. TAX: Invoice Freight as Revenue.<br><br>

For more information from the OM side, refer to [363934/KB784430].',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OM_TAX_FREIGHT');



debug('begin add_signature: OM_TAX_FREIGHT_CODE');
   l_info('##MASK##LEVEL_ID'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7498',
      p_sig_id                 => 'OM_TAX_FREIGHT_CODE',
      p_sig_sql                => 'SELECT user_profile_option_name "Profile Option",
             a.profile_option_value "Profile Value",
             DECODE(a.level_id, 10001, ''Site'',
                                10002, ''Application'',
      ...
      FROM fnd_profile_option_values a,
           ...
           fnd_profile_options_tl t
      WHERE e.application_id like 660
        AND user_profile_option_name like ''%Interface freight tax classification code from line%''
        AND a.profile_option_id  = e.profile_option_id
        AND a.level_value          = b.application_id(+)
        AND a.level_value          = c.responsibility_id(+)
        AND a.level_value          = d.user_id(+)
        ...
        AND nvl(c.LANGUAGE,''US'') = ''US''
     ORDER BY e.profile_option_name',
      p_title                  => 'Tax Freight Code Used',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Determining what Tax Code is used on Freight sales order lines.<br><br>
The profile option "OM: Interface freight tax classification code from line" allows additional flexibility to users with regard to treating Freight Charge as revenue and taxing Freight Charge.<br><br>
If it is set to ''No'', the system does not interface Tax Code to AR and it is up to the Tax Engine to decide what Tax Code to apply. <br>
If it is set to ''Yes'', it will inherit the Freight Charge''s Tax Code from the Sales Order Line.<br><br>

Refer to [1459894/KB760495] for additional details.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: OM_TAX_FREIGHT_CODE');



debug('begin add_signature: OM_TAX_HEADER_ROUNDING');
   l_info('##MASK##LEVEL_ID'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7494',
      p_sig_id                 => 'OM_TAX_HEADER_ROUNDING',
      p_sig_sql                => 'SELECT user_profile_option_name "Profile Option",
             a.profile_option_value "Profile Value",
             DECODE(a.level_id, 10001, ''Site'',
                                10002, ''Application'',
      ...
      FROM fnd_profile_option_values a,
           ...
           fnd_profile_options_tl t
      WHERE e.application_id like 660
        AND user_profile_option_name like ''%Delay Tax Calculation%''
        AND a.profile_option_id  = e.profile_option_id
        AND a.level_value          = b.application_id(+)
        AND a.level_value          = c.responsibility_id(+)
        AND a.level_value          = d.user_id(+)
        ...
        AND nvl(c.LANGUAGE,''US'') = ''US''
     ORDER BY e.profile_option_name',
      p_title                  => 'Tax Header Rounding',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Total Tax Amount on the Sales Order is different than that on the AR Invoice and the difference is due to rounding.',
      p_solution               => 'Refer to [2281752/KB771599] for additional details regarding profile option OM: Delay Tax Calculation.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: OM_TAX_HEADER_ROUNDING');



debug('begin add_signature: OM_TAX_UNIQUE_RECORD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7492',
      p_sig_id                 => 'OM_TAX_UNIQUE_RECORD',
...
FROM zx_lines_det_factors WHERE application_id = 660',
      p_title                  => 'Unique Tax Record',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'While mass updating Unit Selling Price for lines from multiple orders, record(s) were being retained for the line(s) of the order causing a unique constraint error.',
      p_solution               => 'Refer to [2003560/KB627951] for the datafix; as well as, a patch that can be applied to resolve the issue in the future.',
      p_success_msg            => 'No retained tax records found, unit selling price updates should occur normally.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OM_TAX_UNIQUE_RECORD');
...
BEGIN
  ...
  analyzer_title := 'Order Management Analyzer';
...
debug('begin section: Sales_Order_Headers_and_Lines');
start_section('Sales Order Headers and Lines', 'Sales_Order_Headers_and_Lines');
   set_item_result(run_stored_sig('ORDER_MGMT_ORPHAN_FULFILLMENT_SET'));
   set_item_result(run_stored_sig('EBS_MFG_OM_ONT_ONTSO_CREDIT_HOLD_ENABLED_SITE_LEVEL_ORDERS_NOT_GETTING_HELD'));
   set_item_result(run_stored_sig('EBS_MFG_OM_ONT_ONTSO_CREDIT_HOLD_ENABLED_CUSTOMER_LEVEL_ORDERS_NOT_GETTING_HELD'));
   set_item_result(run_stored_sig('EBS_MFG_OM_ONT_ONTSO_ERROR_CANCEL_DROP_SHIP_LINE'));
   set_item_result(run_stored_sig('EBS_MFG_OM_ONT_ONTSO_CREDITCHECK_HOLD_DEFINITION_ENDDATED'));
   set_item_result(run_stored_sig('BOOKED_SO_HEADERS_NONBOOKED_LINES_DETAILS'));
   set_item_result(run_stored_sig('CANCELLED_SO_HEADER_INVALID_OPEN_FLAG_DETAILS'));
   set_item_result(run_stored_sig('CANCELLED_CLOSED_SO_HEADERS_OPEN_LINES_DETAILS'));
   set_item_result(run_stored_sig('CANCELLED_SO_LINES_INVALID_OPEN_FLAG_DETAILS'));
   set_item_result(run_stored_sig('INTERNAL_ORDER_SHIPMENTS_MISSING_REQUISITION_DETAILS'));
   set_item_result(run_stored_sig('RMA_RECEIVING_STUCK'));
   set_item_result(run_stored_sig('ORDER_MGMT_MISSING_DOC_SEQUENCE_ASSIGNMENTS'));
   set_item_result(run_stored_sig('SALES_ORDER_DEBUG_OPTIONS_ENABLED'));
   set_item_result(run_stored_sig('SALES_ORDER_LINES_STUCK_BOOKED'));
   set_item_result(run_stored_sig('EBS_MFG_OM_ONT_ONTSO_DUPLICATE_DOC_SEQUENCE_ASSIGNMENTS'));
   set_item_result(run_stored_sig('EBS_MFG_OM_ONT_ONTSO_INVALID_DATA_IN_OE_SYS_PARAMETERS_ALL'));
   set_item_result(run_stored_sig('EBS_MFG_OM_ONT_ONTSO_ERROR_PROGRESS_DROP_SHIP_LINE'));
end_section;
debug('end section: Sales_Order_Headers_and_Lines');

debug('begin section: Models');
start_section('Models', 'Models');
   set_item_result(run_stored_sig('ATO_PTO_MODEL_LINES_INCORRECT_LINK_PARENT_DETAILS'));
   set_item_result(run_stored_sig('CANCELLED_MODEL_LINES_NONCANCELLED_CHILDREN_DETAILS'));
   set_item_result(run_stored_sig('MODEL_COMPONENTS_REMANTS_NOT_FLAGGED_DETAILS'));
   set_item_result(run_stored_sig('MODELS_STATUS_CREATE_CONFIG_ITEM_EXISTS_DETAILS'));
   set_item_result(run_stored_sig('SHIPPABLE_KITS_MODELS_NOT_OM_INTERFACED_COMPONENTS_ARE_DETAILS'));
end_section;
debug('end section: Models');

debug('begin section: Drop_Ship_Orders');
start_section('Drop Ship Orders', 'Drop_Ship_Orders');
   set_item_result(run_stored_sig('CANCELLED_DROPSHIP_LINES_OPEN_PO_LINES_DETAILS'));
   set_item_result(run_stored_sig('DUPLICATED_DROPSHIP_SOURCES_DETAILS'));
   set_item_result(run_stored_sig('SALES_ORDER_LINES_MULTIPLE_DROPSHIP_SOURCES_DETAILS'));
   set_item_result(run_stored_sig('BOOKED_DROPSHIP_LINES_NULL_SCHEDULED_SHIP_DATE_DETAILS'));
   set_item_result(run_stored_sig('RECEIVED_DROPSHIP_LINES_STUCK_IN_AWAITING_RECEIPT_DETAILS'));
   set_item_result(run_stored_sig('DROPSHIP_LINES_STUCK_IN_AWAITING_RETURN_DETAILS'));
   set_item_result(run_stored_sig('ORDER_MGMT_EXPENSE_DROP_SHIPS'));
   set_item_result(run_stored_sig('ORDER_MGMT_PO_REQUISITIONS_INTERFACE_ALL_IN_PROCESS'));
end_section;
debug('end section: Drop_Ship_Orders');

debug('begin section: OM_Workflow_Checks');
start_section('OM Specific Workflow', 'OM_Workflow_Checks');
   set_item_result(run_stored_sig('ORDER_MGMT_WF_COUNT_SUMMARY'));
   set_item_result(run_stored_sig('ORDER_MGMT_CP_CHK'));
   ...
   set_item_result(run_stored_sig('CLOSED_SO_HEADERS_PENDING_WF_ACTIVITY_DETAILS'));
   set_item_result(run_stored_sig('CLOSED_SO_LINES_PENDING_WF_ACTIVITY_DETAILS'));
   set_item_result(run_stored_sig('OPEN_SO_HEADERS_WF_FLOW_MISSING_CLOSED_DETAILS'));
   set_item_result(run_stored_sig('OPEN_SO_LINES_WF_FLOW_MISSING_CLOSED_DETAILS'));
   set_item_result(run_stored_sig('OPEN_SO_HEADERS_WF_FLOW_INITIATED_NOT_STARTED_DETAILS'));
   set_item_result(run_stored_sig('OPEN_SO_LINES_WF_FLOW_INITIATED_NOT_STARTED_DETAILS'));
   set_item_result(run_stored_sig('OPEN_SO_HEADERS_WF_FLOW_PENDING_NO_OPEN_LINES_DETAILS'));
   set_item_result(run_stored_sig('ORDER_MGMT_ORPH_HDRS'));
   set_item_result(run_stored_sig('ORDER_MGMT_ORPH_LINES'));
   set_item_result(run_stored_sig('ORDER_MGMT_WF_LOOPING'));
   set_item_result(run_stored_sig('ORDER_MGMT_WF_ERR_CANCEL'));
   set_item_result(run_stored_sig('ORDER_MGMT_HEADERS_WITH_NO_OPEN_LINE_NO_HEADER_WORKFLOW_AND_NO_LINE_WORKFLOW'));
   set_item_result(run_stored_sig('ORDER_MGMT_BOOKED_HDR_NONBOOKED_LIN_PROGRESSED_WF'));
   set_item_result(run_stored_sig('ORDER_MGMT_BOOKED_HDR_BOOKED_LIN_PROGRESSED_WF'));
end_section;
debug('end section: OM_Workflow_Checks');

debug('begin section: Deliveries__Delivery_Details');
start_section('Deliveries / Delivery Details', 'Deliveries__Delivery_Details');
   set_item_result(run_stored_sig('CANCELLED_ORDER_LINES_PENDING_DELIVERIES_DETAILS'));
   set_item_result(run_stored_sig('CLOSED_ORDER_LINES_NOT_ALL_DELIVERY_DETAILS_INTERFACED_DETAILS'));
   set_item_result(run_stored_sig('OPEN_ORDER_LINES_DELIVERY_DETAILS_MISSING_DETAILS'));
   set_item_result(run_stored_sig('RELEASED_DELIVERY_DETAILS_MOVE_ORDER_CLOSED_DETAILS'));
   set_item_result(run_stored_sig('SO_LINE_DELIVERY_DETAIL_SCHEDULED_DATE_MISMATCH_DETAILS'));
   set_item_result(run_stored_sig('DELIVERY_TRIP_STOP_ACTUAL_SHIP_DATE_MISMATCH_DETAILS'));
   set_item_result(run_stored_sig('DELIVERY_DETAILS_ERRORED_WF_SHIP_ACTIVITIES_DETAILS'));
   set_item_result(run_stored_sig('OPEN_DELIVERY_DETAILS_MISSING_COMPLETED_WF_SHIP_ACTIVITIES_DETAILS'));
   set_item_result(run_stored_sig('SHIPPED_DELIVERY_DETAILS_OWNED_OPEN_DELIVERY_DETAILS'));
   set_item_result(run_stored_sig('SHIPPED_DELIVERY_DETAILS_NOT_ELIGIBLE_FOR_OM_INV_INTERFACING_DETAILS'));
   set_item_result(run_stored_sig('SHIPPED_DELIVERY_DETAILS_SHIPPED_QUANTITY_ZERO_DETAILS'));
   set_item_result(run_stored_sig('SHIP_SET_STUCK_ONE_LINE_SHIPPED_ONE_NOT_DETAILS'));
   set_item_result(run_stored_sig('SCRIPT_LINE_CANCELLED_NOT_DELIVERY_DETAIL'));
   set_item_result(run_stored_sig('ORDER_MGMT_MISSING_WSH_DELIVERY_DETAILS'));
   set_item_result(run_stored_sig('EBS_MFG_OM_ONT_ONTONESO_DELIVERY_SEQUENCE'));
end_section;
debug('end section: Deliveries__Delivery_Details');

debug('begin section: TAX');
start_section('Tax Setups', 'TAX');
   set_item_result(run_stored_sig('OM_TAX_CODE_DEFAULT'));
   set_item_result(run_stored_sig('OM_TAX_FREIGHT'));
   set_item_result(run_stored_sig('OM_TAX_FREIGHT_CODE'));
   set_item_result(run_stored_sig('OM_TAX_HEADER_ROUNDING'));
   set_item_result(run_stored_sig('OM_TAX_UNIQUE_RECORD'));
end_section;
debug('end section: TAX');
...
BEGIN
  ...
  g_errbuf := null;
   ...
   main(
     p_org_code                     => p_org_code
    ,p_s_date                       => FND_DATE.canonical_to_date(p_s_date)
    ,p_e_date                       => FND_DATE.canonical_to_date(p_e_date)
    ,p_include_apps_check           => upper(p_include_apps_check)
    ,p_max_output_rows              => p_max_output_rows
    ,p_debug_mode                   => p_debug_mode
  );
