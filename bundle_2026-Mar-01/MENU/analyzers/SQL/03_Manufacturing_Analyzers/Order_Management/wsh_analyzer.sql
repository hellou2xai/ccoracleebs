...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for WSH Shipping Analyzer                  |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE wsh_analyzer_pkg AUTHID DEFINER AS
...
(            p_org_code                     IN VARCHAR2    DEFAULT NULL
           ...
           ,p_trailing                     IN VARCHAR2    DEFAULT 'Y'
...
END wsh_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY wsh_analyzer_pkg AS
-- $Id: wsh_analyzer.sql, 200.43 2026/01/28 17:18:56 cschmehl Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(1947935.1));
...
g_trips_dynamic_SQL             varchar2(8000);
g_stops_dynamic_SQL             varchar2(8000);
g_deliveries_dynamic_SQL        varchar2(8000);
g_details_dynamic_SQL           varchar2(8000);
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'SEWSHANL_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'SEWSHANL_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>SEWSHANL Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=1947935.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/wsh_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,244,EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,244,EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},244,EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/3674967" class="blacklink" target="new">
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,244,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,244,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},244,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
----------------------------------------------------------------
------------------------------------------------------
-- Custom procedure to return dynamic sql comprised --
-- of columns with leading or trailing spaces in    --
-- WSH_TRIPS                                        --
------------------------------------------------------

PROCEDURE chk_trip_trail_space IS 
...
BEGIN
  ...
  LOOP
    ...
    SELECT count(i.column_name) INTO l_count
      FROM WSH_TRIPS 
    ...
    IF l_count > 0 THEN
       IF l_counter = 0  THEN
          l_counter := 1;
       ELSE
          g_trips_dynamic_SQL := g_trips_dynamic_SQL || ' UNION ';
       END IF;   
    END IF;

    IF l_count > 0 THEN   
       g_trips_dynamic_SQL := g_trips_dynamic_SQL || 'SELECT '''|| i.column_name ||''', COUNT(*) FROM WSH_TRIPS ';
       g_trips_dynamic_SQL := g_trips_dynamic_SQL || 'WHERE NVL(LENGTH(LTRIM(RTRIM(' || i.column_name || '))), 0) <> ';
       g_trips_dynamic_SQL := g_trips_dynamic_SQL || 'LENGTH(' || i.column_name || ')'; 
    END IF;

  END LOOP; 

  IF g_trips_dynamic_SQL IS NULL THEN  
       g_trips_dynamic_SQL := 'SELECT 0 FROM DUAL WHERE 1=0';
  END IF;

   
END chk_trip_trail_space;
...
PROCEDURE chk_stop_trail_space IS 
   ...
   CURSOR C1 is
       select column_name
         from dba_tab_columns
        where table_name = 'WSH_TRIP_STOPS'
          and data_type = 'VARCHAR2'
          and data_length > 2
     order by column_name;
  ...
  LOOP
    ...
    IF l_count > 0 THEN
       IF l_counter = 0  THEN
          l_counter := 1;
       ELSE
          g_stops_dynamic_SQL := g_stops_dynamic_SQL || ' UNION ';
       END IF;   
    END IF;

    IF l_count > 0 THEN   
       g_stops_dynamic_SQL := g_stops_dynamic_SQL || 'SELECT '''|| i.column_name ||''', COUNT(*) FROM WSH_TRIP_STOPS ';
       g_stops_dynamic_SQL := g_stops_dynamic_SQL || 'WHERE NVL(LENGTH(LTRIM(RTRIM(' || i.column_name || '))), 0) <> ';
       g_stops_dynamic_SQL := g_stops_dynamic_SQL || 'LENGTH(' || i.column_name || ')'; 
    END IF;

  END LOOP; 

  IF g_stops_dynamic_SQL IS NULL THEN  
       g_stops_dynamic_SQL := 'SELECT 0 FROM DUAL WHERE 1=0';
  END IF;

   
END chk_stop_trail_space;
...
PROCEDURE chk_del_trail_space IS 
   ...
   CURSOR C1 is
       select column_name
         from dba_tab_columns
        where table_name = 'WSH_NEW_DELIVERIES'
          and data_type = 'VARCHAR2'
          and data_length > 2
     order by column_name;
  ...
  LOOP
    ...
    IF l_count > 0 THEN
       IF l_counter = 0  THEN
          l_counter := 1;
       ELSE
          g_deliveries_dynamic_SQL := g_deliveries_dynamic_SQL || ' UNION ';
       END IF;   
    END IF;

    IF l_count > 0 THEN   
       g_deliveries_dynamic_SQL := g_deliveries_dynamic_SQL || 'SELECT '''|| i.column_name ||''', COUNT(*) FROM WSH_NEW_DELIVERIES ';
       g_deliveries_dynamic_SQL := g_deliveries_dynamic_SQL || 'WHERE NVL(LENGTH(LTRIM(RTRIM(' || i.column_name || '))), 0) <> ';
       g_deliveries_dynamic_SQL := g_deliveries_dynamic_SQL || 'LENGTH(' || i.column_name || ')'; 
    END IF;

  END LOOP; 

  IF g_deliveries_dynamic_SQL IS NULL THEN  
       g_deliveries_dynamic_SQL := 'SELECT 0 FROM DUAL WHERE 1=0';
  END IF;

   
END chk_del_trail_space;
...
PROCEDURE chk_detail_trail_space IS 
...
BEGIN
  ...
  LOOP
    ...
    SELECT count(i.column_name) INTO l_count
     ...
     WHERE NVL(LENGTH(LTRIM(RTRIM(i.column_name))), 0) <> LENGTH(i.column_name)
       AND released_status not in ('C','D','X');
    ...
    IF l_count > 0 THEN
       IF l_counter = 0  THEN
          l_counter := 1;
       ELSE
          g_details_dynamic_SQL := g_details_dynamic_SQL || ' UNION ';
       END IF;   
    END IF;

    IF l_count > 0 THEN   
       g_details_dynamic_SQL := g_details_dynamic_SQL || 'SELECT '''|| i.column_name ||''', COUNT(*) FROM WSH_DELIVERY_DETAILS ';
       g_details_dynamic_SQL := g_details_dynamic_SQL || 'WHERE NVL(LENGTH(LTRIM(RTRIM(' || i.column_name || '))), 0) <> ';
       g_details_dynamic_SQL := g_details_dynamic_SQL || 'LENGTH(' || i.column_name || ')'; 
    END IF;

  END LOOP; 

  IF g_details_dynamic_SQL IS NULL THEN  
       g_details_dynamic_SQL := 'SELECT 0 FROM DUAL WHERE 1=0';
  END IF;

   
END chk_detail_trail_space;
...
FUNCTION val_p_from_date
   return VARCHAR2 IS
BEGIN
debug('begin parameter validation function: p_from_date');
IF p_from_date < sysdate-366
OR p_from_date > sysdate THEN
    return 'N';
ELSE
    return 'Y';
END IF; 
debug('end parameter validation function: p_from_date');
END val_p_from_date;

FUNCTION val_p_to_date
   return VARCHAR2 IS
BEGIN
debug('begin parameter validation function: p_to_date');
IF p_to_date < sysdate-365
OR p_to_date > sysdate
OR p_from_date > p_to_date THEN
    return 'N';
ELSE
    return 'Y';
END IF;
debug('end parameter validation function: p_to_date');
END val_p_to_date;
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Org (warehouse) Code';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_org_code,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'From Date (DD-MON-YYYY)';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_from_date,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'To Date (DD-MON-YYYY)';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_to_date,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Test for Trailing Spaces (Y/N)';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_trailing,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  l_revision := rtrim(replace('$Revision: 200.43  $','$',''));
  l_revision := ltrim(replace(l_revision,'Revision:',''));
  l_date_char := rtrim(replace('$Date: 2026/01/28 17:18:55 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'wsh_analyzer.sql';
...
IF p_org_code IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Org (warehouse) Code is required.');
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: No Org Code (warehouse) specified. The Org Code parameter is mandatory.');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
debug('begin parameter validation: p_from_date');
IF p_from_date IS NOT NULL AND val_p_from_date()='N' THEN
   print_error('INVALID ARGUMENT: Invalid From Date. Date entered may be more than 1 year ago or after today.');
   raise invalid_parameters;
END IF;
l_system_function_var := null;
debug('end parameter validation: p_from_date');

debug('begin parameter validation: p_to_date');
IF p_to_date IS NOT NULL AND val_p_to_date()='N' THEN
   print_error('INVALID ARGUMENT: Invalid To Date. Date entered may be more than 1 year ago or after today. Or date entered may have been prior to From Date.');
   raise invalid_parameters;
END IF;
l_system_function_var := null;
debug('end parameter validation: p_to_date');

debug('begin parameter validation: p_trailing');
IF p_trailing IS NOT NULL AND p_trailing NOT IN ( 'N','Y') THEN
   print_error('INVALID ARGUMENT: Test for Trailing Spaces is invalid. Value must be Y (yes) or N (no) ');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_trailing');
...
-- For trailing space check
 IF  p_trailing = 'Y' THEN
   chk_trip_trail_space;
   chk_stop_trail_space;
   chk_del_trail_space;
   chk_detail_trail_space;
 END If;
...
debug('begin populate sql tokens hash table');
   ...
   g_masked_tokens('##$$FDATE$$##') := mask_text( g_sql_tokens('##$$FDATE$$##'), 'NO_MASK');
   g_sql_tokens('##$$TDATE$$##') := p_to_date;
   g_masked_tokens('##$$TDATE$$##') := mask_text( g_sql_tokens('##$$TDATE$$##'), 'NO_MASK');
   g_sql_tokens('##$$PRTRAIL$$##') := p_trailing;
   g_masked_tokens('##$$PRTRAIL$$##') := mask_text( g_sql_tokens('##$$PRTRAIL$$##'), 'NO_MASK');
...
debug('begin add_signature: CLOSED_TRIPS_OPEN_STOPS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '582',
      p_sig_id                 => 'CLOSED_TRIPS_OPEN_STOPS',
      p_sig_sql                => 'SELECT trip_id, 
           name, 
           creation_date, 
           planned_flag
    FROM wsh_trips t
    WHERE t.status_code = ''CL''
    AND trip_id IN (select ts.trip_id
                    from wsh_trip_stops ts
                    where ts.status_code <> ''CL'')
    AND last_update_date >= ''##$$FDATE$$##''
    AND last_update_date <= ''##$$TDATE$$##''
    ORDER BY creation_date desc',
      p_title                  => 'Closed Trips with Open Stops',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Possible problems have been found which may require a datafix.',
      p_solution               => 'Review any data that has been provided.  Run the Shipping Execution Interface Trip Stop Analyzer [2380643/KB157800] against the stops listed for additional information.',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: CLOSED_TRIPS_OPEN_STOPS');



debug('begin add_signature: OPEN_TRIPS_OPEN_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '583',
      p_sig_id                 => 'OPEN_TRIPS_OPEN_ERRORS',
      p_sig_sql                => 'SELECT trip_id, 
           trip_name, 
           exception_name, 
           status
    FROM wsh_exceptions 
    WHERE status IN (''OPEN'', ''ERROR'', ''IN_PROGRESS'')
      and severity = ''ERROR''
      AND creation_date >= ''##$$FDATE$$##''
      AND creation_date <= ''##$$TDATE$$##''
      and trip_id IN (select trip_id 
                        from wsh_trips
                      where status_code <> ''CL'')
    ORDER BY creation_date desc',
      p_title                  => 'Open Trips with Open Error Exceptions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'One or more open Exceptions have been found.',
      p_solution               => 'Follow the solution instructions provided in [1576170/KB626443].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: OPEN_TRIPS_OPEN_ERRORS');



debug('begin add_signature: CLOSED_TRIP_STOPS_OPEN_DEL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '584',
      p_sig_id                 => 'CLOSED_TRIP_STOPS_OPEN_DEL',
      p_sig_sql                => 'SELECT ts.stop_id, 
          ts.stop_sequence_number, 
          ts.trip_id, 
          ts.creation_date, 
          nd.name, 
          nd.planned_flag, 
    ...
    WHERE ts.actual_departure_date >= ''##$$FDATE$$##''
          and ts.actual_departure_date <= ''##$$TDATE$$##'' 
	  and (ts.stop_id = dl.pick_up_stop_id
           or ts.stop_id = dl.drop_off_stop_id)
      and dl.delivery_id = nd.delivery_id
      and ts.status_code = ''CL''
      and nd.status_code <> ''CL''
      and nd.ORGANIZATION_ID = ##$$ORGID$$##
    ORDER BY nd.delivery_id, ts.stop_id, ts.stop_sequence_number',
      p_title                  => 'Closed Trip Stop with Open Deliveries',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Possible problems have been found which may require a datafix.',
      p_solution               => 'Refer to [299197/KB735857] for Details.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLOSED_TRIP_STOPS_OPEN_DEL');



debug('begin add_signature: OPEN_TRIP_STOPS_OPEN_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '626',
      p_sig_id                 => 'OPEN_TRIP_STOPS_OPEN_ERRORS',
      p_sig_sql                => 'SELECT e.trip_stop_id, 
           ts.stop_sequence_number, 
           e.exception_name, 
           e.status
    FROM wsh_exceptions e,
         wsh_trip_stops ts         
    WHERE e.trip_stop_id = ts.stop_id
      and e.status IN (''OPEN'', ''ERROR'', ''IN_PROGRESS'')
      and severity = ''ERROR''
      and ts.status_code <> ''CL''
      and ts.creation_date >= ''##$$FDATE$$##''
      and ts.creation_date <= ''##$$TDATE$$##''',
      p_title                  => 'Open Trip Stops with Open Error Exceptions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'One or more open Exceptions have been found.',
      p_solution               => 'Follow the solution instructions provided in [1576170/KB626443].',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: OPEN_TRIP_STOPS_OPEN_ERRORS');



debug('begin add_signature: SALES_ORDER_LINE_ADJUSTMENT_NULL_ADJUSTED_AMOUNT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17085',
      p_sig_id                 => 'SALES_ORDER_LINE_ADJUSTMENT_NULL_ADJUSTED_AMOUNT',
      p_sig_sql                => 'SELECT ADJ.price_adjustment_id,
       ADJ.header_id,
       ADJ.line_id,
...
AND    LIN.OPEN_FLAG = ''Y''
AND    ADJ.list_line_type_code IN ( ''TAX'', ''FREIGHT_CHARGE'' )
AND    ADJ.adjusted_amount IS NULL  ',
...
For solution needed, refer to  [1343924/KB743566]',
   ...
   l_info.delete;
debug('end add_signature: SALES_ORDER_LINE_ADJUSTMENT_NULL_ADJUSTED_AMOUNT');



debug('begin add_signature: CLOSED_DELIVERIES_UNSHIPPED_DELIVERY_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '585',
      p_sig_id                 => 'CLOSED_DELIVERIES_UNSHIPPED_DELIVERY_DETAILS',
      p_sig_sql                => 'SELECT  wnd.delivery_id, 
            wnd.name, 
            ...
            decode(wdd.RELEASED_STATUS,
                  ...
                  ''B'',''B=Backorder'',
                  ''P'',''P=Pending Inv'',
                  ''N'',''N=Not Ready'',''Unknown: ''||wdd.RELEASED_STATUS) REL_STATUS
    ...
    AND wnd.ORGANIZATION_ID = ##$$ORGID$$##
    AND wnd.initial_pickup_date >= ''##$$FDATE$$##''
    AND wnd.initial_pickup_date <= ''##$$TDATE$$##''
    AND wdd.RELEASED_STATUS NOT IN (''C'',''X'',''D'',''L'')
    order by wnd.delivery_id, wdd.delivery_detail_id',
      p_title                  => 'Closed Deliveries with Unshipped Delivery Details Lines',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Possible problems have been found which may require a datafix.',
      p_solution               => 'Review any data that has been provided.  Refer to [299197/KB735857].  If it cannot be resolved, log a Service Request with Oracle Shipping for a Data fix.  ',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLOSED_DELIVERIES_UNSHIPPED_DELIVERY_DETAILS');



debug('begin add_signature: OPEN_DELIVERIES_OPEN_ERROR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '586',
      p_sig_id                 => 'OPEN_DELIVERIES_OPEN_ERROR',
      p_sig_sql                => 'SELECT  delivery_id, 
            delivery_name, 
            EXCEPTION_NAME, 
            status, 
            severity
    ...
    order by creation_date desc',
      p_title                  => 'Open Deliveries with Open Error Exceptions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'One or more open Exceptions have been found',
      p_solution               => 'Follow the solution instructions provided in [1576170/KB626443]',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: OPEN_DELIVERIES_OPEN_ERROR');



debug('begin add_signature: DELIVERY_TRIP_STOP_SHIP_DATE_MISMATCH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '587',
      p_sig_id                 => 'DELIVERY_TRIP_STOP_SHIP_DATE_MISMATCH',
      p_sig_sql                => 'SELECT wnd.name, 
           wnd.delivery_id, 
           wnd.initial_pickup_date, 
           wts.actual_departure_date,
           wts.creation_date, 
           wts.last_update_date
    FROM wsh_new_deliveries wnd, 
    ...
    AND wts.actual_departure_date >= ''##$$FDATE$$##''
    AND wts.actual_departure_date <= ''##$$TDATE$$##''
    AND to_char(wts.actual_departure_date, ''DD-MON-YYYY'') <> to_char(wnd.initial_pickup_date, ''DD-MON-YYYY'')',
      p_title                  => 'Delivery and Trip Stop Actual Ship Date Mismatch',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Possible problems have been found which may require a datafix.',
      p_solution               => 'Review any data that has been provided.  Run the Shipping Execution Interface Trip Stop Analyzer [2380643/KB157800] against the stops listed for additional information.  Please contact the Oracle Shipping Execution Support team if the issue relates to current data for a datafix.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: DELIVERY_TRIP_STOP_SHIP_DATE_MISMATCH');



debug('begin add_signature: OPEN_DELIVERIES_NO_DELIVERY_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '588',
      p_sig_id                 => 'OPEN_DELIVERIES_NO_DELIVERY_LINES',
      p_sig_sql                => 'SELECT wnd.organization_ID,
           wnd.name,
           wnd.creation_date, 
           wnd.planned_flag, 
           wnd.initial_pickup_date           
    ...
    AND ( (wnd.initial_pickup_date >= ''##$$FDATE$$##''
           AND wnd.initial_pickup_date <= ''##$$TDATE$$##'' )
          OR (wnd.initial_pickup_date is null
	     AND  ( wnd.creation_date >= ''##$$FDATE$$##''
                AND wnd.creation_date <= ''##$$TDATE$$##'')) )
    AND not exists (SELECT ''x'' from wsh_delivery_assignments wda
                    WHERE wnd.delivery_id = wda.delivery_id)',
      p_title                  => 'Open Deliveries with No Delivery Lines',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Open Deliveries with No Delivery Lines exist',
      p_solution               => '<p>Open Deliveries with no assigned lines can occur when:</p>
Delivery is manually created and no lines are assigned. <br />
All lines for the Delivery are backordered as this removes the lines from the Delivery.
<p>Run the Shipping Purge concurrent program with Parameters:<br /> Delete Empty Records = Yes<br />Execution Mode first in View to review before in Purge mode.</p>
<p>Refer to [1419324/KB627804] for details.</p>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: OPEN_DELIVERIES_NO_DELIVERY_LINES');



debug('begin add_signature: WSH_INTRANSIT_DELIVERY_NO_TRIPS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22464',
      p_sig_id                 => 'WSH_INTRANSIT_DELIVERY_NO_TRIPS',
      p_sig_sql                => 'SELECT wnd.*
FROM wsh_new_deliveries wnd
WHERE  wnd.status_code = ''IT''
AND wnd.ORGANIZATION_ID = ##$$ORGID$$##
...
',
      p_title                  => 'Trip Details are Missing Against Delivery',
      p_fail_condition         => 'RS',
      p_problem_descr          => ' Invalid / incorrect data for Delivery in status = In Transit, without a Trip.
 ',
      p_solution               => 'A datafix will be necessary to resolve this issue.
Refer to [2596474/KB771054]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: WSH_INTRANSIT_DELIVERY_NO_TRIPS');



debug('begin add_signature: RELEASED_WAREHOUSE_LINES_CLOSED_MOVE_ORDER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '589',
      p_sig_id                 => 'RELEASED_WAREHOUSE_LINES_CLOSED_MOVE_ORDER',
      p_sig_sql                => 'SELECT wdd.source_header_number, 
           wdd.delivery_detail_id, 
           wdd.move_order_line_id, 
           mtrl.last_update_date mtl_updt_date, 
           wdd.creation_date, 
           wdd.last_update_date del_updt_date           
    FROM wsh_delivery_details wdd, 
         mtl_txn_request_lines mtrl 
    WHERE wdd.source_code = ''OE''
    AND wdd.ORGANIZATION_ID = ##$$ORGID$$##
    AND wdd.released_status = ''S''
    AND wdd.creation_date >= ''##$$FDATE$$##''
    AND wdd.creation_date <= ''##$$TDATE$$##''
    AND wdd.move_order_line_id = mtrl.line_id
    AND mtrl.line_status = 5',
      p_title                  => 'Released to Warehouse Lines with Closed Move Order',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Possible problems have been found which may require a datafix.',
      p_solution               => 'Review any data that has been provided.  Refer to [1583914/KB627141].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: RELEASED_WAREHOUSE_LINES_CLOSED_MOVE_ORDER');



debug('begin add_signature: PICK_RELEASED_LINE_NO_MOVE_ORDER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '590',
      p_sig_id                 => 'PICK_RELEASED_LINE_NO_MOVE_ORDER',
    ...
    order by organization_id, source_header_number, source_line_number',
      p_title                  => 'Pick Released Lines with No Move Order',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Possible problems have been found which may require a datafix.',
      p_solution               => 'Review any data that has been provided.  Refer to [1165324/KB732682].
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: PICK_RELEASED_LINE_NO_MOVE_ORDER');



debug('begin add_signature: OPEN_LINES_OPEN_ERROR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '591',
      p_sig_id                 => 'OPEN_LINES_OPEN_ERROR',
      p_sig_sql                => 'SELECT delivery_detail_id, 
           delivery_name, 
           EXCEPTION_NAME, 
           status, 
           severity          
    ...
    WHERE status IN (''OPEN'', ''ERROR'', ''IN_PROGRESS'')
              ...
              AND creation_date >= ''##$$FDATE$$##''
              AND creation_date <= ''##$$TDATE$$##''
              AND delivery_detail_id IN (select delivery_detail_id 
                                         from wsh_delivery_details
                                         where released_status <> ''C''
                                           AND ORGANIZATION_ID = ##$$ORGID$$##)
    order by creation_date desc',
      p_title                  => 'Open Lines with Open Error Exceptions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'One or more open Exceptions have been found',
      p_solution               => 'Follow the solution instructions provided in [1576170/KB626443]',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: OPEN_LINES_OPEN_ERROR');



debug('begin add_signature: SHIPPED_LINES_OVER_30_DAYS_OLD_OPEN_DELIVERY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '592',
      p_sig_id                 => 'SHIPPED_LINES_OVER_30_DAYS_OLD_OPEN_DELIVERY',
      p_sig_sql                => 'SELECT wdd.SOURCE_HEADER_NUMBER, 
    ...
    AND wnd.status_code not in (''IT'', ''CL'')',
      p_title                  => 'Shipped Lines More than 30 Days Old Owned by an Open Delivery',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no Shipped Lines More than 30 Days Old, Owned by an Open Delivery',
      p_solution               => '',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: SHIPPED_LINES_OVER_30_DAYS_OLD_OPEN_DELIVERY');



debug('begin add_signature: SHIPPED_LINES_NOT_OM_INTERFACED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '595',
      p_sig_id                 => 'SHIPPED_LINES_NOT_OM_INTERFACED',
      p_sig_sql                => 'SELECT wdd.SOURCE_HEADER_NUMBER, 
           wdd.source_header_id, 
           wdd.source_line_id, 
           wnd.delivery_id, 
    ...
    AND nvl(wts.pending_interface_flag,''X'') <> ''Y''',
      p_title                  => 'Shipped Lines Not OM Interfaced',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'One or more shipped lines have not been OM interfaced',
      p_solution               => 'Follow the solution instructions provided in [885949/KB745367].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: SHIPPED_LINES_NOT_OM_INTERFACED');



debug('begin add_signature: SHIPPED_LINES_NOT_INV_INTERFACED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '597',
      p_sig_id                 => 'SHIPPED_LINES_NOT_INV_INTERFACED',
      p_sig_sql                => 'SELECT wdd.organization_id, 
    ...
    WHERE wdd.source_code = ''OE''
        ...
        AND wts.actual_departure_date <= ''##$$TDATE$$##''
        and wdl.pick_up_stop_id = wts.stop_id
      order by organization_id, wnd.delivery_id',
      p_title                  => 'Shipped Lines Not INV Interfaced',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'One or more shipped lines have not been INV interfaced',
      p_solution               => 'Follow the solution instructions provided in [1338335/KB626356].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: SHIPPED_LINES_NOT_INV_INTERFACED');



debug('begin add_signature: SHIPPED_LINES_SHIPPED_QTY_ZERO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '599',
      p_sig_id                 => 'SHIPPED_LINES_SHIPPED_QTY_ZERO',
      p_sig_sql                => 'SELECT wdd.source_code, 
           wdd.SOURCE_HEADER_NUMBER, 
           wdd.source_header_id, 
           wdd.source_line_id, 
           wdd.delivery_detail_id, 
    ...
    AND wdd.ORGANIZATION_ID = ##$$ORGID$$##
    AND wdd.last_update_date >= ''##$$FDATE$$##''
    AND wdd.last_update_date <= ''##$$TDATE$$##''
    AND nvl(wdd.shipped_quantity,0) = 0',
      p_title                  => 'Shipped Lines Where Shipped Quantity is Zero',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Possible datafix may be required.',
      p_solution               => 'Follow the solution instructions provided in [1637504/KB628038].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: SHIPPED_LINES_SHIPPED_QTY_ZERO');



debug('begin add_signature: INTERFACED_LINES_TRIP_NOT_CLOSED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '609',
      p_sig_id                 => 'INTERFACED_LINES_TRIP_NOT_CLOSED',
      p_sig_sql                => 'SELECT wdd.delivery_detail_id, 
           wdd.item_description, 
           wdd.organization_id, 
           wt.trip_id, 
           wt.name tname, 
           wt.status_code tstatus, 
           wdl.drop_off_stop_id, 
           wts.status_code sstatus, 
           wnd.name dname, 
           wnd.status_code dstatus       
    FROM wsh_delivery_details wdd,
         wsh_delivery_assignments wda,
         wsh_new_deliveries wnd,
         wsh_delivery_legs wdl,
    ...
    AND ( ( wts.actual_arrival_date >= ''##$$FDATE$$##''
            AND wts.actual_arrival_date <= ''##$$TDATE$$##'' )
         OR (wts.actual_arrival_date is null
	    AND ( wts.planned_arrival_date >= ''##$$FDATE$$##''
                  AND wts.planned_arrival_date <= ''##$$TDATE$$##'') ) )',
      p_title                  => 'Interfaced Lines with Trip not Closed',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Possible datafix may be required.',
      p_solution               => 'Follow the solution instructions provided in [1509294/KB626004]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: INTERFACED_LINES_TRIP_NOT_CLOSED');



debug('begin add_signature: WSH_INCOMPLETE_DELIVERY_SHIP_MODEL_COMPLETE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22360',
      p_sig_id                 => 'WSH_INCOMPLETE_DELIVERY_SHIP_MODEL_COMPLETE',
...
ORDER  BY wda.delivery_id,
          ...
          wdd.delivery_detail_id',
      p_title                  => 'Multiple Deliveries for One Model/Kit Flagged as Ship Model Complete',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Model or Kit having its component and/or included item lines assigned to more than one delivery with the Ship Model Complete flag set to Yes(Y).
',
      p_solution               => 'This issue requires a datafix.  Please refer to [2408028/KB707612]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: WSH_INCOMPLETE_DELIVERY_SHIP_MODEL_COMPLETE');



debug('begin add_signature: EBS_MFG_OM_SEWSHANL_SOLINE_DEL_DETAIL_SSD_RD_MISMATCH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28629',
      p_sig_id                 => 'EBS_MFG_OM_SEWSHANL_SOLINE_DEL_DETAIL_SSD_RD_MISMATCH',
      p_sig_sql                => 'SELECT oeh.order_number "ORDER NO",
          ...
          wsh.ORGANIZATION_ID "ORGANIZATION_ID",
    ...
    AND    wsh.creation_date between ''##$$FDATE$$##'' and ''##$$TDATE$$##''
    AND    wsh.ORGANIZATION_ID = ##$$ORGID$$##
...
',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_SEWSHANL_SOLINE_DEL_DETAIL_SSD_RD_MISMATCH');



debug('begin add_signature: ENABLED_SHIP_METHOD_NOT_ASSIGNED_TO_CARRIER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '613',
      p_sig_id                 => 'ENABLED_SHIP_METHOD_NOT_ASSIGNED_TO_CARRIER',
      p_sig_sql                => 'SELECT wcsm.carrier_ship_method_id, 
           ...
           wcsm.enabled_flag, 
           wcsm.creation_date, 
           wcsm.last_update_date,
           wcsm.last_updated_by, 
           wcsm.last_update_login       
    FROM wsh_carrier_ship_methods wcsm, 
         fnd_lookup_values_vl fl
    WHERE fl.lookup_type = ''SHIP_METHOD'' 
    AND wcsm.ORGANIZATION_ID = ##$$ORGID$$##
    AND fl.lookup_code = wcsm.ship_method_code
    AND fl.view_application_id = 3 
    AND wcsm.enabled_flag = ''Y'' 
    AND not exists (select ''x'' 
		    from wsh_carrier_services wcs1
                    where wcs1.ship_method_code = wcsm.ship_method_code)',
      p_title                  => 'Enabled Ship Method not Assigned to a Carrier',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Determine whether the Ship Method should be assigned to a Carrier. If not, it is recommended to disable the Ship Method.',
      p_solution               => 'Follow the solution instructions provided in [1589874/KB627298].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: ENABLED_SHIP_METHOD_NOT_ASSIGNED_TO_CARRIER');



debug('begin add_signature: MISSING_CARRIER_SERVICE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '614',
      p_sig_id                 => 'MISSING_CARRIER_SERVICE',
      p_sig_sql                => 'SELECT wcsm.carrier_ship_method_id, 
           wcsm.ship_method_code, 
           fl.meaning, wcsm.web_enabled, 
           wcsm.service_level,
           fl.meaning ship_method_meaning, 
           wcsm.organization_id, 
    ...
    AND fl.view_application_id = 3
    AND wcsm.ORGANIZATION_ID = ##$$ORGID$$##
    AND mp.organization_id = wcsm.organization_id
    AND exists (select ''x''
                from wsh_carrier_services wcs1
		where wcs1.ship_method_code = wcsm.ship_method_code)
    AND not exists (select ''x''
                    from wsh_carrier_services wcs, wsh_org_carrier_services wocs
                    where wcs.ship_method_code = wcsm.ship_method_code   
                    and wcs.carrier_service_id = wocs.carrier_service_id
		    and wocs.organization_id = wcsm.organization_id)',
      p_title                  => 'Missing Carrier Service',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Possible problems have been found which may require a datafix.',
      p_solution               => 'Follow the solution instructions provided in [730693/KB625550].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: MISSING_CARRIER_SERVICE');



debug('begin add_signature: CARRIER_NOT_ASSIGNED_TO_ANY_ORG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '616',
      p_sig_id                 => 'CARRIER_NOT_ASSIGNED_TO_ANY_ORG',
      p_sig_sql                => 'SELECT wocs.organization_id, 
           car.freight_code, 
           car.CARRIER_NAME, 
           car.carrier_id, 
           car.active, 
    ...
    FROM wsh_carriers_v car, 
         wsh_carrier_services wcs, 
         wsh_org_carrier_services wocs
    WHERE car.carrier_id = wcs.carrier_id 
    AND wcs.carrier_service_id = wocs.carrier_service_id
    AND wocs.ORGANIZATION_ID = ##$$ORGID$$##
    AND not exists (select ''x'' 
                    from org_freight_tl org
                    where car.freight_code = org.freight_code
                    and org.organization_id = wocs.organization_id)
    order by car.freight_code, car.carrier_name, wocs.organization_id',
      p_title                  => 'Carrier not Assigned to any Organization',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Possible problems have been found.',
      p_solution               => '<p>Determine whether the Carrier should be assigned to an Organization. If not, it is recommended to disable it by going to:</p>
<p>Shipping > Setup > Freight Carriers, Cost Types > Freight Carriers and unchecking the Active box.</p>
<p>Refer to [1917400/KB738013] for details.</p>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CARRIER_NOT_ASSIGNED_TO_ANY_ORG');



debug('begin add_signature: OPEN_ACCOUNTING_PERIODS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '620',
      p_sig_id                 => 'OPEN_ACCOUNTING_PERIODS',
      p_sig_sql                => 'select 
       (select mtl.organization_code from mtl_parameters mtl where mtl.organization_id = p.organization_id) as "ORGANIZATION_CODE", 
       (select o.name from hr_all_organization_units o where o.organization_id = p.organization_id) as "NAME",
       count(p.open_flag) "NUMBER OF OPEN PERIODS", 
       to_char(min(p.period_start_date),''MM/DD/YYYY HH24:MI:SS'') "EARLIST PERIOD START DATE", 
       to_char(max(p.schedule_close_date),''MM/DD/YYYY HH24:MI:SS'') "LATEST PERIOD SCHED CLOSE DATE"
  from org_acct_periods p, hr_all_organization_units o, mtl_parameters mtl
      where o.organization_id = p.organization_id
        and mtl.organization_id = p.organization_id
        AND mtl.ORGANIZATION_ID = ##$$ORGID$$##
	...
	and p.open_flag = ''Y''
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Possible problems have been found.',
      p_solution               => '<p>Accounting Periods have not been opened. Open the appropriate period(s) by going to:</p>
<ul>
<li>Inventory > Accounting Close Cycle > Inventory Accounting Period</li>
<li>Select appropriate warehouse</li>
<li>Select Change Status</li>
</ul>
<p>If the period cannot be opened, refer to [1675813/KB456502] for steps to change the transaction details.</p>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: OPEN_ACCOUNTING_PERIODS');



debug('begin add_signature: WMS_ENABLED_WAREHOUSE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '622',
      p_sig_id                 => 'WMS_ENABLED_WAREHOUSE',
      p_sig_sql                => 'select p.organization_code "ORGANIZATION CODE", 
           p.organization_id "ORGANIZATION ID", 
           o.name "NAME", 
           m.name "MASTER ORGANIZATION",
           o.type "ORG.TYPE",
           to_char(o.date_from,''MM/DD/YYYY HH24:MI:SS'') "FROM DATE",
           to_char(o.date_to,''MM/DD/YYYY HH24:MI:SS'') "TO DATE"
       from mtl_parameters p, hr_all_organization_units o, hr_all_organization_units m 
      where p.organization_id = o.organization_id
        and m.organization_id = p.master_organization_id
        AND p.ORGANIZATION_ID = ##$$ORGID$$##
        and p.wms_enabled_flag = ''Y''
     order by p.organization_code',
      p_title                  => 'WMS Enabled Warehouses',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no WMS enabled warehouses.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: WMS_ENABLED_WAREHOUSE');



debug('begin add_signature: OPM_ENABLED_WAREHOUSE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '625',
      p_sig_id                 => 'OPM_ENABLED_WAREHOUSE',
      p_sig_sql                => 'select 
        p.organization_code "ORGANIZATION CODE", 
        p.organization_id "ORGANIZATION ID", 
        o.name "NAME", 
        o.type "ORG.TYPE",
        (select hr.name from hr_all_organization_units hr where hr.organization_id = p.master_organization_id) as "MASTER ORGANIZATION",
        o.date_from "FROM DATE", 
        o.date_to "TO DATE"
       from mtl_parameters p, hr_all_organization_units o
      where p.organization_id = o.organization_id
        AND p.ORGANIZATION_ID = ##$$ORGID$$##
        and p.process_enabled_flag = ''Y''
     order by p.organization_code',
      p_title                  => 'OPM Enabled Warehouses',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no OPM enabled warehouses.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OPM_ENABLED_WAREHOUSE');



debug('begin add_signature: WSH_INVALID_TPDATES EXCEPTION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14028',
      p_sig_id                 => 'WSH_INVALID_TPDATES EXCEPTION',
      p_sig_sql                => 'SELECT ''x''
FROM dual
WHERE EXISTS (
    SELECT ''x''
    FROM wsh_exceptions
    WHERE exception_name = ''WSH_INVALID_TPDATES''
          AND ROWNUM = 1 )
AND EXISTS (
    SELECT ''x''
    ...
    WHERE fav.application_id = fpi.application_id
          AND fav.application_short_name = ''FTE''
          AND fpi.status <> ''I'')',
      p_title                  => 'WSH_INVALID_TPDATES Shipping Exception',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'When Oracle Transportation Execution is not installed, the Exception WSH_INVALID_TPDATES can be disabled.',
      p_solution               => '[339363/KB722959]
If the Transportation module is not used, the Exception WSH_INVALID_TPDATES message can be disabled:

1. Navigate to Shipping / Setup/ Define  Exceptions .
2. Query the Exception WSH_INVALID_TPDATES. 
3. Uncheck the Enable box.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: WSH_INVALID_TPDATES EXCEPTION');
...
debug('begin add_signature: OPEN_TRIPS_LEADING_TRAILING_SPACES');
   l_info('##COMPLEX_TYPE##'):= 'U';
 add_signature(
   '667',
   'OPEN_TRIPS_LEADING_TRAILING_SPACES',
    g_trips_dynamic_SQL,
   'Open Trips with Leading or Trailing Spaces',
   'RS',
   'One or more problem rows have been found and need to be corrected',
   '<ul>
       <li>There is a standard script in $FND_TOP/sql/afchrchk.sql for this purpose.
      If you do not already have this script, please see [960115/KB771922] for details</li>
   </ul>',
   'No rows found',
   'ALWAYS',
   'E',
  ...
  l_info.delete;
   l_info.delete;
debug('end add_signature: OPEN_TRIPS_LEADING_TRAILING_SPACES');



debug('begin add_signature: OPEN_STOPS_LEADING_TRAILING_SPACES_CX');
   l_info('##COMPLEX_TYPE##'):= 'U';
add_signature(
'5405',
'OPEN_STOPS_LEADING_TRAILING_SPACES_CX',
g_stops_dynamic_SQL,
'Open Stops with Leading or Trailing Spaces',
'RS',
'One or more problem rows have been found and need to be corrected',
'<ul>
<li>There is a standard script in $FND_TOP/sql/afchrchk.sql for this purpose.
...
l_info.delete;
   l_info.delete;
debug('end add_signature: OPEN_STOPS_LEADING_TRAILING_SPACES_CX');



debug('begin add_signature: OPEN_DELIVERIES_LEADING_TRAILING_SPACES_CX');
   l_info('##COMPLEX_TYPE##'):= 'U';
add_signature(
'5406',
'OPEN_DELIVERIES_LEADING_TRAILING_SPACES_CX',
g_deliveries_dynamic_SQL,
'Open Deliveries with Leading or Trailing Spaces',
'RS',
'One or more problem rows have been found and need to be corrected',
'<ul>
<li>There is a standard script in $FND_TOP/sql/afchrchk.sql for this purpose.
...
l_info.delete;
   l_info.delete;
debug('end add_signature: OPEN_DELIVERIES_LEADING_TRAILING_SPACES_CX');



debug('begin add_signature: OPEN_DETAILS_LEADING_TRAILING_SPACES_CX');
   l_info('##COMPLEX_TYPE##'):= 'U';
add_signature(
'5407',
'OPEN_DETAILS_LEADING_TRAILING_SPACES_CX',
g_details_dynamic_SQL,
'Open Deliveries with Leading or Trailing Spaces',
'RS',
'One or more problem rows have been found and need to be corrected',
...
l_info.delete;
   ...
   l_info.delete;
debug('end add_signature: OPEN_DETAILS_LEADING_TRAILING_SPACES_CX');
...
BEGIN
  ...
  analyzer_title := 'WSH Shipping Analyzer';
...
debug('begin section: Trips');
start_section('Trips', 'Trips');
   set_item_result(run_stored_sig('CLOSED_TRIPS_OPEN_STOPS'));
   set_item_result(run_stored_sig('OPEN_TRIPS_OPEN_ERRORS'));
   IF p_trailing = 'Y'  THEN
      set_item_result(run_stored_sig('OPEN_TRIPS_LEADING_TRAILING_SPACES'));
   END IF;
end_section;
debug('end section: Trips');

debug('begin section: Trip_Stops');
start_section('Trip Stops', 'Trip_Stops');
   set_item_result(run_stored_sig('CLOSED_TRIP_STOPS_OPEN_DEL'));
   set_item_result(run_stored_sig('OPEN_TRIP_STOPS_OPEN_ERRORS'));
   IF p_trailing = 'Y' THEN
      set_item_result(run_stored_sig('OPEN_STOPS_LEADING_TRAILING_SPACES_CX'));
   END IF;
   set_item_result(run_stored_sig('SALES_ORDER_LINE_ADJUSTMENT_NULL_ADJUSTED_AMOUNT'));
end_section;
debug('end section: Trip_Stops');

debug('begin section: Deliveries_Assignments');
start_section('Deliveries and Assignments', 'Deliveries_Assignments');
   set_item_result(run_stored_sig('CLOSED_DELIVERIES_UNSHIPPED_DELIVERY_DETAILS'));
   set_item_result(run_stored_sig('OPEN_DELIVERIES_OPEN_ERROR'));
   set_item_result(run_stored_sig('DELIVERY_TRIP_STOP_SHIP_DATE_MISMATCH'));
   set_item_result(run_stored_sig('OPEN_DELIVERIES_NO_DELIVERY_LINES'));
   set_item_result(run_stored_sig('WSH_INTRANSIT_DELIVERY_NO_TRIPS'));
   IF p_trailing = 'Y' THEN
      set_item_result(run_stored_sig('OPEN_DELIVERIES_LEADING_TRAILING_SPACES_CX'));
   END IF;
end_section;
debug('end section: Deliveries_Assignments');

debug('begin section: Deliveries_Details');
start_section('Deliveries Detail Checks', 'Deliveries_Details');
   set_item_result(run_stored_sig('RELEASED_WAREHOUSE_LINES_CLOSED_MOVE_ORDER'));
   set_item_result(run_stored_sig('PICK_RELEASED_LINE_NO_MOVE_ORDER'));
   set_item_result(run_stored_sig('OPEN_LINES_OPEN_ERROR'));
   set_item_result(run_stored_sig('SHIPPED_LINES_OVER_30_DAYS_OLD_OPEN_DELIVERY'));
   set_item_result(run_stored_sig('SHIPPED_LINES_NOT_OM_INTERFACED'));
   set_item_result(run_stored_sig('SHIPPED_LINES_NOT_INV_INTERFACED'));
   set_item_result(run_stored_sig('SHIPPED_LINES_SHIPPED_QTY_ZERO'));
   set_item_result(run_stored_sig('INTERFACED_LINES_TRIP_NOT_CLOSED'));
   set_item_result(run_stored_sig('WSH_INCOMPLETE_DELIVERY_SHIP_MODEL_COMPLETE'));
   IF p_trailing = 'Y' THEN
      set_item_result(run_stored_sig('OPEN_DETAILS_LEADING_TRAILING_SPACES_CX'));
   END IF;
   set_item_result(run_stored_sig('EBS_MFG_OM_SEWSHANL_SOLINE_DEL_DETAIL_SSD_RD_MISMATCH'));
end_section;
debug('end section: Deliveries_Details');

debug('begin section: Freight');
start_section('Freight Setup', 'Freight');
   set_item_result(run_stored_sig('ENABLED_SHIP_METHOD_NOT_ASSIGNED_TO_CARRIER'));
   set_item_result(run_stored_sig('MISSING_CARRIER_SERVICE'));
   set_item_result(run_stored_sig('CARRIER_NOT_ASSIGNED_TO_ANY_ORG'));
end_section;
debug('end section: Freight');

debug('begin section: Inventory');
start_section('Inventory', 'Inventory');
   set_item_result(run_stored_sig('OPEN_ACCOUNTING_PERIODS'));
   set_item_result(run_stored_sig('WMS_ENABLED_WAREHOUSE'));
   set_item_result(run_stored_sig('OPM_ENABLED_WAREHOUSE'));
end_section;
debug('end section: Inventory');

debug('begin section: Setup');
start_section('Setup', 'Setup');
   set_item_result(run_stored_sig('WSH_INVALID_TPDATES EXCEPTION'));
end_section;
...
BEGIN
  ...
  g_errbuf := null;
   ...
   main(
     p_org_code                     => p_org_code
    ,p_from_date                    => to_char(FND_DATE.canonical_to_date(p_from_date),'DD-MON-YYYY') 
    ,p_to_date                      => to_char(FND_DATE.canonical_to_date(p_to_date),'DD-MON-YYYY') 
    ,p_trailing                     => upper(p_trailing)
    ,p_include_apps_check           => upper(p_include_apps_check)
    ,p_max_output_rows              => p_max_output_rows
    ,p_debug_mode                   => p_debug_mode
