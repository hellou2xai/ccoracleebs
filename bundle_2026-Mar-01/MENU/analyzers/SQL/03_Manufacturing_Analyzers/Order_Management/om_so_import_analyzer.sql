...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Sales Order Import Analyzer            |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE om_so_import_analyzer_pkg AUTHID DEFINER AS
...
END om_so_import_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY om_so_import_analyzer_pkg AS
-- $Id: om_so_import_analyzer.sql, 200.23 2026/01/28 14:39:47 cschmehl Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2720783.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'OMSOIMPORT_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'OMSOIMPORT_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>OMSOIMPORT Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2720783.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/om_import_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,3355,EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,3355,EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},3355,EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/mosc/discussion/4478098/ebs-sales-order-import-analyzer-doc-id-2720783-1#latest" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">3355</span>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,3355,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,3355,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},3355,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
FUNCTION get_ORDSRCNAME
   return VARCHAR2 IS
BEGIN
debug('begin sql token function: ORDSRCNAME');
BEGIN
  select name
    into l_system_function_var 
  from   OE_ORDER_SOURCES oos
  where 
     OOS.order_source_ID = p_order_source_id;
  return l_system_function_var;
EXCEPTION WHEN NO_DATA_FOUND THEN
      return null;
END;
debug('end sql token function: ORDSRCNAME');
END get_ORDSRCNAME;
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Order Source Id';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_order_source_id,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Orig Sys Document Reference';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_orig_sys_document_ref,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Orig Sys Line Ref';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_orig_sys_line_ref,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/01/28 14:39:46 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'om_so_import_analyzer.sql';
...
debug('begin parameter validation: p_order_source_id');
IF p_order_source_id IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Order Source Id is required.');
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid value for parameter Order_source_Id provided. Process cannot continue');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_order_source_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_order_source_id');

debug('begin parameter validation: p_orig_sys_document_ref');
IF p_orig_sys_document_ref IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Orig Sys Document Reference is required.');
   raise invalid_parameters;
END IF;
...
INTO l_exists_val
FROM (SELECT ORIG_SYS_DOCUMENT_REF , ORDER_SOURCE_ID, ORG_ID FROM OE_HEADERS_IFACE_ALL UNION SELECT ORIG_SYS_DOCUMENT_REF, ORDER_SOURCE_ID, ORG_ID FROM OE_LINES_IFACE_ALL)
WHERE ORIG_SYS_DOCUMENT_REF = p_orig_sys_document_ref
 AND order_source_id = p_order_source_id
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid value entered for parameter Orig Sys Document Ref. Process cannot continue.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_orig_sys_document_ref failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_orig_sys_document_ref');

debug('begin parameter validation: p_orig_sys_line_ref');
IF p_orig_sys_line_ref IS NOT NULL THEN
BEGIN
SELECT ORIG_SYS_LINE_REF
INTO l_exists_val
FROM OE_LINES_IFACE_ALL
WHERE ORIG_SYS_LINE_REF = p_orig_sys_line_ref and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid value entered for parameter Orig_sys_line_ref. Process cannot continue.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_orig_sys_line_ref failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_orig_sys_line_ref');
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$ORDSRCID$$##') := p_order_source_id;
   g_masked_tokens('##$$ORDSRCID$$##') := mask_text( g_sql_tokens('##$$ORDSRCID$$##'), 'NO_MASK');
   g_sql_tokens('##$$ORIGSYSDOCREF$$##') := p_orig_sys_document_ref;
   g_masked_tokens('##$$ORIGSYSDOCREF$$##') := mask_text( g_sql_tokens('##$$ORIGSYSDOCREF$$##'), 'NO_MASK');
   g_sql_tokens('##$$ORIGSYSLINEREF$$##') := p_orig_sys_line_ref;
   g_masked_tokens('##$$ORIGSYSLINEREF$$##') := mask_text( g_sql_tokens('##$$ORIGSYSLINEREF$$##'), 'NO_MASK');
   ...
   g_sql_tokens('##$$APPS_PARAM5$$##') := '702';
   g_masked_tokens('##$$APPS_PARAM5$$##') := mask_text( g_sql_tokens('##$$APPS_PARAM5$$##'), 'NO_MASK');
   g_sql_tokens('##$$ORDSRCNAME$$##') := get_ORDSRCNAME();
   l_system_function_var := null;
   g_masked_tokens('##$$ORDSRCNAME$$##') := mask_text( g_sql_tokens('##$$ORDSRCNAME$$##'), 'NO_MASK');
...
debug('begin add_signature: SOIMPORT_SOHDRS_IFACE_FULL');
   l_info('##MASK##CREDIT_CARD_EXPIRATION_DATE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   ...
   l_info('##MASK##DELIVER_TO_CUSTOMER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##END_CUSTOMER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##END_CUSTOMER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##IB_OWNER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##INVOICE_CUSTOMER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SALESREP'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SHIP_TO_CUSTOMER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SUPPLIER_SIGNATURE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##CREATED_BY'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##CREATION_DATE'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##LAST_UPDATED_BY'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##LAST_UPDATE_DATE'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##ORDER_SOURCE_ID'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##ORIG_SYS_DOCUMENT_REF'):= 'center,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '19425',
      p_sig_id                 => 'SOIMPORT_SOHDRS_IFACE_FULL',
      p_sig_sql                => 'select 
    CASE 
...
from oe_headers_iface_all ohif
where ohif.order_source_id = ##$$ORDSRCID$$##
  and ohif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''',
      p_title                  => 'Sales Order Header',
      p_fail_condition         => '[Required Columns populated?] = [No]',
      p_problem_descr          => 'Full Sales Order Headers Interface Data ',
      p_solution               => '',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_SOHDRS_IFACE_FULL');



debug('begin add_signature: SOIMPORT_SOLINES_IFACE_FULL');
   l_info('##MASK##CREATED_BY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##DELIVER_TO_CUSTOMER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##END_CUSTOMER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##IB_OWNER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##INVOICE_TO_CUSTOMER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##LAST_UPDATED_BY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##LAST_UPDATE_LOGIN'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SALESREP'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SHIP_TO_CUSTOMER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##CREATED_BY'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##CREATION_DATE'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##DELIVERY_LEAD_TIME'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##INVENTORY_ITEM'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##LAST_UPDATED_BY'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##LAST_UPDATE_DATE'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##OPERATION_CODE'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##ORDERED_QUANTITY'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##ORDER_QUANTITY_UOM'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##ORDER_SOURCE_ID'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##ORIG_SYS_LINE_REF'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##ORIG_SYS_SHIPMENT_REF'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##REQUEST_DATE'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##RIG_SYS_DOCUMENT_REF'):= 'center,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '19427',
      p_sig_id                 => 'SOIMPORT_SOLINES_IFACE_FULL',
      p_sig_sql                => 'select 
    CASE 
...
, ACTUAL_FULFILLMENT_DATE, IB_OWNER_CODE, IB_CURRENT_LOCATION_CODE  , IB_INSTALLED_AT_LOCATION_CODE
 ...
 where olif.order_source_id = ##$$ORDSRCID$$##
   and olif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
   and olif.orig_sys_line_ref = NVL( ''##$$ORIGSYSLINEREF$$##'' , olif.orig_sys_line_ref)',
      p_title                  => 'Sales Order Lines',
      p_fail_condition         => '[Required Columns populated?] = [No]',
      p_problem_descr          => 'Full Sales Order Lines Interface Data',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_SOLINES_IFACE_FULL');



debug('begin add_signature: SOIMPORT_ACTIONS_IFACE');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##ORDER_SOURCE_ID'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##ORIG_SYS_DOCUMENT_REF'):= 'center,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '18362',
      p_sig_id                 => 'SOIMPORT_ACTIONS_IFACE',
      p_sig_sql                => 'select
    CASE 
        WHEN (ORDER_SOURCE_ID IS NULL) OR (ORIG_SYS_DOCUMENT_REF IS NULL) then ''No''
        ELSE ''Yes''
    END AS "Required Columns populated?",
order_source_id, orig_sys_document_ref, orig_sys_line_ref, orig_sys_shipment_ref, change_sequence ,org_id, sold_to_org_id, sold_to_org,
hold_id, hold_type_code, hold_type_id, hold_until_date, release_reason_code, request_id, operation_code, error_flag, status_flag, interface_status, fulfillment_set_name
from oe_actions_iface_all oaia
where oaia.order_source_id = ##$$ORDSRCID$$##
   and oaia.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
   and nvl(oaia.orig_sys_line_ref,''x'') = NVL( ''##$$ORIGSYSLINEREF$$##'' , nvl(oaia.orig_sys_line_ref,''x'')) ',
      p_title                  => 'Sales Order Actions',
      p_fail_condition         => '[Required Columns populated?] = [No]',
      p_problem_descr          => 'Sales Order Actions Interface Data',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_ACTIONS_IFACE');



debug('begin add_signature: SOIMPORT_PRICE_ADJS_IFACE');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##CREATED_BY'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##CREATION_DATE'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##LAST_UPDATED_BY'):= 'center,#333333,#FFE864,bold';
   ...
   l_info('##STYLE##OPERATION_CODE'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##ORDER_SOURCE_ID'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##ORIG_SYS_DISCOUNT_REF'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##ORIG_SYS_DOCUMENT_REF'):= 'center,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '18363',
      p_sig_id                 => 'SOIMPORT_PRICE_ADJS_IFACE',
      p_sig_sql                => 'select
    CASE 
        WHEN (ORDER_SOURCE_ID IS NULL) OR (ORIG_SYS_DOCUMENT_REF IS NULL) OR (OPERATION_CODE IS NULL) 
        OR( CREATED_BY IS NULL) OR (ORIG_SYS_DISCOUNT_REF IS NULL)
             OR (CREATION_DATE IS NULL) OR (LAST_UPDATED_BY IS NULL) OR( LAST_UPDATE_DATE IS NULL) then ''No''
        ELSE ''Yes''
    END AS "Required Columns populated?",
order_source_id, orig_sys_document_ref, orig_sys_line_ref, orig_sys_shipment_ref,orig_sys_discount_ref, change_sequence, change_request_code, org_id,
request_id, automatic_flag, list_header_id, list_name, list_line_id, list_line_type_code, updated_flag, update_allowed, applied_flag,
discount_id, discount_line_id, discount_name, percent, operation_code, error_flag, status_flag, operand, arithmetic_operator, pricing_phase_id, adjusted_amount
from oe_price_adjs_iface_all opai
where opai.order_source_id = ##$$ORDSRCID$$##
   and opai.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
   and opai.orig_sys_line_ref = NVL( ''##$$ORIGSYSLINEREF$$##'' , opai.orig_sys_line_ref) ',
      p_title                  => 'Price Adjustments',
      p_fail_condition         => '[Required Columns populated?] = [No]',
      p_problem_descr          => 'Price Adjustments Interface Data',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_PRICE_ADJS_IFACE');



debug('begin add_signature: SOIMPORT_PRICE_ATTS_IFACE');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##CREATED_BY'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##CREATION_DATE'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##LAST_UPDATED_BY'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##LAST_UPDATE_DATE'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##OPERATION_CODE'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##ORDER_SOURCE_I'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##ORIG_SYS_CREDIT_REF'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##ORIG_SYS_DOCUMENT_REF'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##PERCENT'):= 'center,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '18364',
      p_sig_id                 => 'SOIMPORT_PRICE_ATTS_IFACE',
      p_sig_sql                => 'select
    CASE 
        WHEN (ORDER_SOURCE_ID IS NULL) OR (ORIG_SYS_DOCUMENT_REF IS NULL) OR (OPERATION_CODE IS NULL) 
        OR( CREATED_BY IS NULL) OR (ORIG_SYS_CREDIT_REF IS NULL) OR ( PERCENT IS NULL)
             OR (CREATION_DATE IS NULL) OR (LAST_UPDATED_BY IS NULL) OR( LAST_UPDATE_DATE IS NULL) then ''No''
        ELSE ''Yes''
    END AS "Required Columns populated?", 
order_source_id, orig_sys_document_ref, orig_sys_line_ref, orig_sys_shipment_ref,orig_sys_credit_ref, change_sequence, change_request_code, org_id,
request_id, operation_code, error_flag, status_flag, salesrep_id, salesrep, sales_credit_type_id, sales_credit_type, percent
from oe_credits_iface_all oci
where oci.order_source_id = ##$$ORDSRCID$$##
   and oci.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
   and nvl(oci.orig_sys_line_ref,''-x'') = NVL( ''##$$ORIGSYSLINEREF$$##'' , nvl(oci.orig_sys_line_ref,''-x'')) ',
      p_title                  => 'Pricing Attributes',
      p_fail_condition         => '[Required Columns populated?] = [No]',
      p_problem_descr          => 'Pricing Attributes Interface Data',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_PRICE_ATTS_IFACE');



debug('begin add_signature: SOIMPORT_CREDITS_IFACE');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##(ORIG_SYS_CREDIT_REF'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##CREATED_BY'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##CREATION_DATE'):= 'center,#333333,#FFE864,bold';
  ...
  add_signature(
      p_sig_repo_id            => '18370',
      p_sig_id                 => 'SOIMPORT_CREDITS_IFACE',
      p_sig_sql                => 'select 
    CASE 
        WHEN (ORDER_SOURCE_ID IS NULL) OR (ORIG_SYS_DOCUMENT_REF IS NULL) OR (OPERATION_CODE IS NULL) 
        OR( CREATED_BY IS NULL) OR (ORIG_SYS_CREDIT_REF IS NULL) OR ( PERCENT IS NULL)
...
',
      p_title                  => 'Sales Credits',
      p_fail_condition         => '[Required Columns populated?] = [No]',
      p_problem_descr          => 'Sales Credits Interface Data',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_CREDITS_IFACE');



debug('begin add_signature: SOIMPORT_PAYMENTS_IFACE');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##CREATED_BY'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##CREATION_DATE'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##LAST_UPDATED_BY'):= 'center,#333333,#FFE864,bold';
   ...
   l_info('##STYLE##ORDER_SOURCE_ID'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##ORIG_SYS_DOCUMENT_REF'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##PAYMENT_TYPE_CODE'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##orig_sys_payment_ref'):= 'center,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '18371',
      p_sig_id                 => 'SOIMPORT_PAYMENTS_IFACE',
      p_sig_sql                => 'select 
    CASE 
        WHEN (ORDER_SOURCE_ID IS NULL) OR (ORIG_SYS_DOCUMENT_REF IS NULL) OR (OPERATION_CODE IS NULL) 
        OR( CREATED_BY IS NULL) OR (PAYMENT_TYPE_CODE IS NULL) OR ( orig_sys_payment_ref IS NULL)
             OR (CREATION_DATE IS NULL) OR (LAST_UPDATED_BY IS NULL) OR( LAST_UPDATE_DATE IS NULL) then ''No''
        ELSE ''Yes''
    END AS "Required Columns populated?",
order_source_id, orig_sys_document_ref, orig_sys_line_ref, orig_sys_shipment_ref,orig_sys_payment_ref, change_sequence, change_request_code, org_id,
request_id, operation_code, error_flag, status_flag, payment_type_code, commitment, payment_trx_id, payment_method, receipt_method_id, payment_collection_event,
payment_set_id, prepaid_amount, credit_card_expiration_date, credit_card_code, credit_card_approval_date, check_number, payment_amount,payment_percentage
from oe_payments_iface_all opi
where  opi.order_source_id = ##$$ORDSRCID$$##
   and opi.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
   and nvl(opi.orig_sys_line_ref,''-x'') = NVL( ''##$$ORIGSYSLINEREF$$##'' , nvl(opi.orig_sys_line_ref,''-x''))',
      p_title                  => 'Payments',
      p_fail_condition         => '[Required Columns populated?] = [No]',
      p_problem_descr          => 'Payments Interface Data',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_PAYMENTS_IFACE');



debug('begin add_signature: SOIMPORT_LOTSERIALS_IFACE');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##CREATED_BY'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##CREATION_DATE'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##LAST_UPDATED_BY'):= 'center,#333333,#FFE864,bold';
   ...
   l_info('##STYLE##ORDER_SOURCE_ID'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##ORIG_SYS_DOCUMENT_REF'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##ORIG_SYS_LOTSERIAL_REF'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##QUANTITY'):= 'center,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '18372',
      p_sig_id                 => 'SOIMPORT_LOTSERIALS_IFACE',
      p_sig_sql                => 'select 
    CASE 
        WHEN (ORDER_SOURCE_ID IS NULL) OR (ORIG_SYS_DOCUMENT_REF IS NULL) OR (OPERATION_CODE IS NULL) 
        OR( CREATED_BY IS NULL) OR (ORIG_SYS_LOTSERIAL_REF IS NULL) OR ( QUANTITY IS NULL)
             OR (CREATION_DATE IS NULL) OR (LAST_UPDATED_BY IS NULL) OR( LAST_UPDATE_DATE IS NULL) then ''No''
        ELSE ''Yes''
    END AS "Required Columns populated?",
order_source_id, orig_sys_document_ref, orig_sys_line_ref, orig_sys_shipment_ref,orig_sys_lotserial_ref, change_sequence, change_request_code, org_id,
request_id, operation_code, error_flag, status_flag, lot_number, from_serial_number, to_serial_number, quantity, sublot_number,quantity2, sold_to_org,sold_to_org_id
from oe_lotserials_iface_all olsi
where olsi.order_source_id = ##$$ORDSRCID$$##
   and olsi.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
   and nvl(olsi.orig_sys_line_ref,''-x'') = NVL( ''##$$ORIGSYSLINEREF$$##'' , nvl(olsi.orig_sys_line_ref,''-x''))',
      p_title                  => 'Lot Serial Numbers ',
      p_fail_condition         => '[Required Columns populated?] = [No]',
      p_problem_descr          => 'Lot Serials Interface Data',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_LOTSERIALS_IFACE');



debug('begin add_signature: SOIMPORT_RESERVTNS_IFACE');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##INVENTORY_ITEM_ID'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##OPERATION_CODE'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##ORDER_SOURCE_ID'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##ORIG_SYS_DOCUMENT_REF'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##ORIG_SYS_LINE_REF'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##ORIG_SYS_RESERVATION_REF'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##QUANTITY'):= 'center,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '18373',
      p_sig_id                 => 'SOIMPORT_RESERVTNS_IFACE',
      p_sig_sql                => 'select 
    CASE 
        WHEN (ORDER_SOURCE_ID IS NULL) OR (ORIG_SYS_DOCUMENT_REF IS NULL) OR (OPERATION_CODE IS NULL) 
        OR (ORIG_SYS_LINE_REF IS NULL) OR ( ORIG_SYS_RESERVATION_REF IS NULL)
        OR ( INVENTORY_ITEM_ID IS NULL) OR ( QUANTITY IS NULL)   then ''No''
        ELSE ''Yes''
    END AS "Required Columns populated?",
order_source_id, orig_sys_document_ref, orig_sys_line_ref, orig_sys_shipment_ref,orig_sys_reservation_ref, change_sequence,
request_id, operation_code, error_flag,  inventory_item_id  ,revision, lot_number_id, lot_number, subinventory_id,subinventory_code, 
locator_id, quantity,  quantity2, sold_to_org,sold_to_org_id
from oe_reservtns_iface_all ori
where  ori.order_source_id = ##$$ORDSRCID$$##
   and ori.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
   and nvl(ori.orig_sys_line_ref,''-x'') = NVL( ''##$$ORIGSYSLINEREF$$##'' , nvl(ori.orig_sys_line_ref,''-x'')) ',
      p_title                  => 'Reservations',
      p_fail_condition         => '[Required Columns populated?] = [No]',
      p_problem_descr          => 'Reservations Interface Data',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_RESERVTNS_IFACE');



debug('begin add_signature: SOIMPORT_PROCESSING_MSGS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18374',
      p_sig_id                 => 'SOIMPORT_PROCESSING_MSGS',
      p_sig_sql                => 'select transaction_id, request_id, entity_code, entity_id, header_id, line_id, original_sys_document_ref, original_sys_document_line_ref, orig_sys_shipment_ref, 
change_sequence, order_source_id, org_id, message_text, message_status_code 
from OE_PROCESSING_MSGS_VL opm
where  opm.order_source_id = ##$$ORDSRCID$$##
   and opm.original_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
   and nvl(opm.original_sys_document_line_ref,''-x'') = NVL( ''##$$ORIGSYSLINEREF$$##'' , nvl(opm.original_sys_document_line_ref,''-x'')) ',
      p_title                  => 'Processing Messages',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Processing Messages Data',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_PROCESSING_MSGS');



debug('begin add_signature: SOIMPORT_SO_HEADER_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18734',
      p_sig_id                 => 'SOIMPORT_SO_HEADER_DETAILS',
      p_sig_sql                => ' 
SELECT
    order_source_id, 
orig_sys_document_ref,
...
WHERE  order_source_id = ##$$ORDSRCID$$##
 AND decode(order_source_id, 10, to_char(source_document_id),orig_sys_document_ref)= ''##$$ORIGSYSDOCREF$$##''',
      p_title                  => 'Sales Order Headers (Base Table)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Sales Order Header Details',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_SO_HEADER_DETAILS');



debug('begin add_signature: SOIMPORT_SO_LINE_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18735',
      p_sig_id                 => 'SOIMPORT_SO_LINE_DETAILS',
      p_sig_sql                => 'SELECT
    order_source_id,
    orig_sys_document_ref,
    org_id,
...
FROM
    oe_order_lines_all
WHERE order_source_id =##$$ORDSRCID$$##
AND DECODE(order_source_id, 10, to_char(source_document_id), orig_sys_document_ref
    ) = ''##$$ORIGSYSDOCREF$$##''
and DECODE(order_source_id, 10, to_char(source_document_line_id), orig_sys_line_ref) = NVL(''##$$ORIGSYSLINEREF$$##'', DECODE(order_source_id, 10, to_char(source_document_line_id), orig_sys_line_ref))',
      p_title                  => 'Sales Order Lines (Base Table) ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Sales Order Line Details ',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_SO_LINE_DETAILS');



debug('begin add_signature: EBS_MFG_OM_ONT_OMSOIMPORT_REQ_HDR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22827',
      p_sig_id                 => 'EBS_MFG_OM_ONT_OMSOIMPORT_REQ_HDR',
   ...
   porh.summary_flag,
   porh.enabled_flag,
   porh.transferred_to_oe_flag,
   porh.approved_date,
   porh.interface_source_code,
   porh.interface_source_line_id,
   porh.org_id
FROM oe_headers_iface_all ohif,
...
WHERE ohif.order_source_id = ##$$ORDSRCID$$##
  and ohif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
  and ohif.orig_sys_document_ref = TO_CHAR (porh.requisition_header_id)',
      p_title                  => 'Associated Requisition Header',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Corresponding Requisition Header Data ',
      p_solution               => '',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_ONT_OMSOIMPORT_REQ_HDR');



debug('begin add_signature: EBS_MFG_OM_ONT_OMSOIMPORT_REQ_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22828',
      p_sig_id                 => 'EBS_MFG_OM_ONT_OMSOIMPORT_REQ_LINES',
      p_sig_sql                => 'SELECT distinct 
...
FROM oe_lines_iface_all oli,
  po_requisition_lines_all porl
WHERE oli.order_source_id = ##$$ORDSRCID$$##
  and oli.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
  and oli.orig_sys_line_ref = NVL( ''##$$ORIGSYSLINEREF$$##'' , oli.orig_sys_line_ref)
  and oli.orig_sys_document_ref = TO_CHAR (porl.requisition_header_id)',
      p_title                  => 'Associated Requisition Line(s)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Corresponding Requisition Line(s) Data ',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_ONT_OMSOIMPORT_REQ_LINES');



debug('begin add_signature: EBS_MFG_OM_ONT_OMSOIMPORT_NULL_SHIP_TO_ORG_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23308',
      p_sig_id                 => 'EBS_MFG_OM_ONT_OMSOIMPORT_NULL_SHIP_TO_ORG_ID',
      p_sig_sql                => 'select ''OE_HEADERS_IFACE_ALL'' Table_Name, operation_code, org_id, order_source_id, orig_sys_document_ref, sold_to_org_id, sold_to_org, change_sequence , ''Not Applicable'' orig_sys_line_ref, ''Not Applicable'' orig_sys_shipment_ref, ship_to_org, ship_to_org_id
  from oe_headers_iface_all ohif
 where ohif.order_source_id = ##$$ORDSRCID$$##
   and ohif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
   and ohif.ship_to_org_id is null
union all                 
  select ''OE_LINES_IFACE_ALL'' Table_Name, operation_code, org_id, order_source_id, orig_sys_document_ref , sold_to_org_id, sold_to_org, change_sequence ,orig_sys_line_ref, orig_sys_shipment_ref, ship_to_org, ship_to_org_id
  from oe_lines_iface_all olif
 where olif.order_source_id = ##$$ORDSRCID$$##
   and olif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
   and olif.orig_sys_line_ref = NVL( ''##$$ORIGSYSLINEREF$$##'' , olif.orig_sys_line_ref)
   and olif.ship_to_org_id is null
',
      p_title                  => 'Ship To Org Id is NULL in the Interfaces Tables',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Ship To Org Id is not populated in the interface table.  This can result in improper Customer Relationship issue / error.',
      p_solution               => 'Review [2508224/KB742503] Orders Stuck In Order Import Interface With Customer Relationship Not Defined And No Permission To Create Relationship',
      p_success_msg            => 'There is no issue with the Ship To Org Id  Populated  in the Interfaces Tables.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_ONT_OMSOIMPORT_NULL_SHIP_TO_ORG_ID');



debug('begin add_signature: SOIMPORT_INVALID_SHIP_TO_ORG_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18262',
      p_sig_id                 => 'SOIMPORT_INVALID_SHIP_TO_ORG_ID',
      p_sig_sql                => 'select ''OE_HEADERS_IFACE_ALL'' Table_Name, operation_code, org_id, order_source_id, orig_sys_document_ref, sold_to_org_id, sold_to_org, change_sequence , ''Not Applicable'' orig_sys_line_ref, ''Not Applicable'' orig_sys_shipment_ref, ship_to_org, ship_to_org_id
  from oe_headers_iface_all ohif
 where ohif.order_source_id = ##$$ORDSRCID$$##
   and ohif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
   and ohif.ship_to_org_id is not null
   and ohif.org_id is not null
  and not exists ( select 1
                    from hz_cust_site_uses_all hcsu
                   where hcsu.site_use_id = ohif.ship_to_org_id
                     and hcsu.site_use_code = ''SHIP_TO''
                     and hcsu.org_id = ohif.org_id
                     and hcsu.status = ''A''
                 )
union all                 
  select ''OE_LINES_IFACE_ALL'' Table_Name, operation_code, org_id, order_source_id, orig_sys_document_ref , sold_to_org_id, sold_to_org, change_sequence ,orig_sys_line_ref, orig_sys_shipment_ref, ship_to_org, ship_to_org_id
 ...
 where olif.order_source_id = ##$$ORDSRCID$$##
   and olif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
   and olif.orig_sys_line_ref = NVL( ''##$$ORIGSYSLINEREF$$##'' , olif.orig_sys_line_ref)
   and olif.ship_to_org_id is not null
   and olif.org_id is not null
   and not exists ( select 1
                    from hz_cust_site_uses_all hcsu
                   where hcsu.site_use_id = olif.ship_to_org_id
                     and hcsu.site_use_code = ''SHIP_TO''
                     and hcsu.org_id = olif.org_id
                     and hcsu.status = ''A''
                 )',
      p_title                  => 'Invalid Ship To Org Id Populated in the Interfaces Tables',
      p_fail_condition         => '[ship_to_org_id] is not null',
      p_problem_descr          => 'Ship To Org Id populated in the interface table is not valid.',
      p_solution               => 'Review [1537147/KB742709] R12 Upgrade: Ship-to Is Invalid In Sales Order Interface, But Can Be Selected In SO Entry Form.',
      p_success_msg            => 'There is no issue with the Ship To Org Id  Populated  in the Interfaces Tables.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_INVALID_SHIP_TO_ORG_ID');



debug('begin add_signature: SOIMPORT_INVALID_SHIP_TO_ISO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18275',
      p_sig_id                 => 'SOIMPORT_INVALID_SHIP_TO_ISO',
      p_sig_sql                => '  select ''OE_LINES_IFACE_ALL'' Table_Name, operation_code, org_id, order_source_id, orig_sys_document_ref , sold_to_org_id, sold_to_org, change_sequence ,orig_sys_line_ref, orig_sys_shipment_ref, ship_to_org, ship_to_org_id
  from oe_lines_iface_all olif
 where olif.order_source_id = ##$$ORDSRCID$$##
   and olif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
   and olif.orig_sys_line_ref = NVL( ''##$$ORIGSYSLINEREF$$##'' , olif.orig_sys_line_ref)
   ...
   and  not exists ( select 1
                   ...
                   where hcsu.site_use_id = pla.site_use_id
                     and prl.deliver_to_location_id = pla.location_id
                     and prl.destination_organization_id = pla.organization_id
                     and prl.requisition_header_id = olif.orig_sys_document_ref
                     and prl.requisition_line_id = olif.orig_sys_line_ref
                     and hcsu.site_use_id = olif.ship_to_org_id
                     and hcsu.site_use_code = ''SHIP_TO''
                     and hcsu.status = ''A''
                     and rownum < 2
                 )',
      p_title                  => 'Invalid Ship To for Internal Customer',
      p_fail_condition         => '[ship_to_org_id] is not null',
      p_problem_descr          => 'Ship to associated with internal customer is not valid.',
      p_solution               => 'Review [782048/KB748503] Internal Orders Are Stuck In Interface Table With Error Validation failed for the field - Ship To.',
      p_success_msg            => 'There is no issue with the ship to site use of the internal customer.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_INVALID_SHIP_TO_ISO');



debug('begin add_signature: SOIMPORT_NO_MATCH_SOLD_TO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18276',
      p_sig_id                 => 'SOIMPORT_NO_MATCH_SOLD_TO',
      p_sig_sql                => '  select ''OE_LINES_IFACE_ALL'' Table_Name, operation_code, org_id, order_source_id, orig_sys_document_ref , sold_to_org_id, sold_to_org, change_sequence ,orig_sys_line_ref, orig_sys_shipment_ref
  from oe_lines_iface_all olif
 where olif.order_source_id = ##$$ORDSRCID$$##
   and olif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
   and olif.orig_sys_line_ref = NVL( ''##$$ORIGSYSLINEREF$$##'' , olif.orig_sys_line_ref)
   and not exists ( select 1
                    from oe_headers_iface_all ohif
                   where ohif.order_source_id = olif.order_source_id
                     and ohif.orig_sys_document_ref = olif.orig_sys_document_ref
                     and ohif.sold_to_org_id = olif.sold_to_org_id
                     and nvl(ohif.org_id,-1) = NVL(olif.org_id,-1)
                 )
   and exists ( select 1
                  from fnd_profile_option_values fpov,
                       fnd_profile_options_vl fpo
                 where fpo.profile_option_id=fpov.profile_option_id
                   and fpo.profile_option_name in ( ''ONT_INCLUDE_CUST_IN_OI_KEY'')
                   and fpov.profile_option_value = ''Y''
               )',
      p_title                  => 'Line Level Sold to Does Not Match Header Record in the Interface Tables',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Sold to values of line and header Interface records are not matching.',
      p_solution               => 'Review [1358701/KB766051] Order Import Error: You Are Entering A Duplicate Orig_sys_line_ref For The Same Order.',
      p_success_msg            => 'There is no issue with the sold to values populated in the header and line Interface tables.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_NO_MATCH_SOLD_TO');



debug('begin add_signature: SOIMPORT_INVALID_INVOICE_TO_ORG_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18263',
      p_sig_id                 => 'SOIMPORT_INVALID_INVOICE_TO_ORG_ID',
      p_sig_sql                => 'select ''OE_HEADERS_IFACE_ALL'' Table_Name, operation_code, org_id, order_source_id, orig_sys_document_ref, sold_to_org_id, sold_to_org, change_sequence , ''Not Applicable'' orig_sys_line_ref, ''Not Applicable'' orig_sys_shipment_ref, invoice_to_org, invoice_to_org_id
  from oe_headers_iface_all ohif
 where ohif.order_source_id = ##$$ORDSRCID$$##
   and ohif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
   and ohif.invoice_to_org_id is not null
   and ohif.org_id is not null
  and not exists ( select 1
                    from hz_cust_site_uses_all hcsu
                   where hcsu.site_use_id = ohif.invoice_to_org_id
                     and hcsu.site_use_code = ''BILL_TO''
                     and hcsu.org_id = ohif.org_id
                     and hcsu.status = ''A''
                 )
union all                 
  select ''OE_LINES_IFACE_ALL'' Table_Name, operation_code, org_id, order_source_id, orig_sys_document_ref , sold_to_org_id, sold_to_org, change_sequence ,orig_sys_line_ref, orig_sys_shipment_ref, invoice_to_org, invoice_to_org_id
  from oe_lines_iface_all olif
 where olif.order_source_id = ##$$ORDSRCID$$##
   and olif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
   and olif.orig_sys_line_ref = NVL( ''##$$ORIGSYSLINEREF$$##'' , olif.orig_sys_line_ref)
   and olif.invoice_to_org_id is not null
   and olif.org_id is not null
   and not exists ( select 1
                    from hz_cust_site_uses_all hcsu
                   where hcsu.site_use_id = olif.invoice_to_org_id
                     and hcsu.site_use_code = ''BILL_TO''
                     and hcsu.org_id = olif.org_id
                     and hcsu.status = ''A''
                 )',
      p_title                  => 'Invalid Invoice To Org Id Populated in the Interfaces Tables',
      p_fail_condition         => '[invoice_to_org_id] is not null',
      p_problem_descr          => 'Invoice to org Id populated in the interface table is not valid.',
      p_solution               => 'Review [1397424/KB774945] OEOIMP : Order Import Fails With Error User-Defined Exception in Package OE_Order_GRP Procedure Automatic_Account_Creation.',
      p_success_msg            => 'There is no issue with the Invoice To Org Id  Populated  in the Interfaces Tables.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_INVALID_INVOICE_TO_ORG_ID');



debug('begin add_signature: SOIMPORT_WH_SUBINV_INVALID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16837',
      p_sig_id                 => 'SOIMPORT_WH_SUBINV_INVALID',
      p_sig_sql                => 'Select olif.order_source_id,
olif.org_id,
olif.orig_sys_document_ref,
olif.orig_sys_line_ref,
olif.ship_from_org_id,
olif.inventory_item_id,
olif.subinventory
from 
OE_LINES_IFACE_ALL olif
where olif.order_source_id = ##$$ORDSRCID$$##
and olif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
and olif.orig_sys_line_ref = NVL( ''##$$ORIGSYSLINEREF$$##'' , olif.orig_sys_line_ref ) 
and olif.subinventory is not null 
and exists 
( SELECT 1 
    FROM MTL_SUBINVENTORIES_TRK_VAL_V mstv
   WHERE olif.ship_from_org_id= mstv.organization_id
     and olif.subinventory = mstv.secondary_inventory_name)
and exists 
( select 1 from MTL_ITEM_SUB_INVENTORIES misi, 
MTL_SYSTEM_ITEMS_B msib
where 
olif.ship_from_org_id= msib.organization_id
and olif.inventory_item_id = msib.inventory_item_id
and msib.inventory_item_id = misi.inventory_item_id
and msib.RESTRICT_SUBINVENTORIES_CODE=1
and olif.subinventory <> misi.secondary_inventory)',
      p_title                  => 'Invalid Subinventory - Restricted Subinventory ',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Restrict subinventories flag is enabled for the item and subinventory used is not listed.
',
      p_solution               => 'Refer to [853235/KB744285] for details',
      p_success_msg            => 'There is no issue with Subinventory Populated.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_WH_SUBINV_INVALID');



debug('begin add_signature: SOIMPORT_INVALID_ORDER_TYPE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18274',
      p_sig_id                 => 'SOIMPORT_INVALID_ORDER_TYPE',
      p_sig_sql                => '            
  select ''OE_HEADERS_IFACE_ALL'' Table_Name, operation_code, org_id, order_source_id, orig_sys_document_ref, sold_to_org_id, sold_to_org, change_sequence ,to_char(ordered_date, ''DD-MON-YYYY HH24:MI:SS''),order_type_id
  from oe_headers_iface_all ohif
 where ohif.order_source_id = ##$$ORDSRCID$$##
   and ohif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
   and ohif.order_type_id is not null
   and ohif.ordered_date is not null
   and not exists ( select 1
                    from oe_transaction_types_all ott
                   where ott.transaction_type_id = ohif.order_type_id
                     and ohif.ordered_date between ott.start_date_active and NVL(ott.end_date_active, sysdate+1)
                 )',
      p_title                  => 'Invalid Order Type Populated in the Interface Tables',
      p_fail_condition         => '[order_type_id] is not null',
      p_problem_descr          => 'Order type populated in the interface table is invalid or not active.',
      p_solution               => 'Review [2062178/KB778142] Order Import Is Failing: Validation Failed for the Field - Order Type.',
      p_success_msg            => 'There is no issue  with Order Type Populated.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_INVALID_ORDER_TYPE');



debug('begin add_signature: SOIMPORT_IO_NOT_ENABLED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16838',
      p_sig_id                 => 'SOIMPORT_IO_NOT_ENABLED',
      p_sig_sql                => 'Select olif.order_source_id,
olif.org_id,
olif.ship_from_org_id,
olif.orig_sys_document_ref,
...
MTL_SYSTEM_ITEMS_B msib
Where 
olif.order_source_id = ##$$ORDSRCID$$##
and olif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
and olif.orig_sys_line_ref = NVL( ''##$$ORIGSYSLINEREF$$##'' , olif.orig_sys_line_ref ) 
and msib.organization_id = olif.ship_from_org_id
and olif.inventory_item_id= msib.inventory_item_id
and olif.order_source_id = 10
and olif.inventory_item_id is not null
and nvl(msib.internal_order_enabled_flag, ''N'') <>''Y''',
      p_title                  => 'Internal Ordered Flag Not Enabled',
      p_fail_condition         => '[internal_order_enabled_flag] is not null',
      p_problem_descr          => 'The item specified is invalid or does not exist in the warehouse you specified.  This occurs as Internal Ordered flag is not enabled  for the item.',
      p_solution               => 'Review [813433/KB708208] Order Import Error For Internal Order: The item specified is invalid or does not exist in the warehouse you specified.',
      p_success_msg            => 'There is no issue with Internal Ordered flag.
',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_IO_NOT_ENABLED');



debug('begin add_signature: SOIMPORT_ORG_SYS_SHIPMENT_REF_NULL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18354',
      p_sig_id                 => 'SOIMPORT_ORG_SYS_SHIPMENT_REF_NULL',
      p_sig_sql                => 'select  operation_code, org_id, order_source_id, orig_sys_document_ref , sold_to_org_id, sold_to_org, orig_sys_line_ref, orig_sys_shipment_ref
  from oe_lines_iface_all olif
 where olif.order_source_id = ##$$ORDSRCID$$## 
and olif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##'' 
and olif.orig_sys_line_ref = NVL( ''##$$ORIGSYSLINEREF$$##'' , olif.orig_sys_line_ref ) 
   and olif.orig_sys_shipment_ref is null
   and olif.operation_code = ''INSERT''
      and not exists ( select 1
                  from fnd_profile_option_values fpov,
                       fnd_profile_options_vl fpo
                 where fpo.profile_option_id=fpov.profile_option_id
                   and fpo.profile_option_name in ( ''ONT_IMP_MULTIPLE_SHIPMENTS'')
                   and fpov.profile_option_value = ''Y''
               )',
      p_title                  => 'Import Multiple Shipments Enabled but orig_sys_shipment_ref Is NULL',
      p_fail_condition         => '[orig_sys_shipment_ref] is null',
      p_problem_descr          => 'Import multiple shipments is enabled but ORIG_SYS_SHIPMENT_REF is NULL.',
      p_solution               => 'Review[742482/KB770078] OEOIMP Trying To Update Or Delete An Existing Line But That Line Does Not Exist.
',
      p_success_msg            => 'There is no issue with orig_sys_shipment_ref.
',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_ORG_SYS_SHIPMENT_REF_NULL');



debug('begin add_signature: SOIMPORT_INVALID_RMA_REF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18272',
      p_sig_id                 => 'SOIMPORT_INVALID_RMA_REF',
      p_sig_sql                => ' select ''OE_LINES_IFACE_ALL'' Table_Name, operation_code, org_id, order_source_id, orig_sys_document_ref , sold_to_org_id, sold_to_org, change_sequence ,orig_sys_line_ref, orig_sys_shipment_ref, return_context, return_attribute1, return_attribute2
   from oe_lines_iface_all olif
 where olif.order_source_id = ##$$ORDSRCID$$##
   and olif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
   and olif.orig_sys_line_ref = NVL( ''##$$ORIGSYSLINEREF$$##'' , olif.orig_sys_line_ref)
   and NOT EXISTS ( SELECT 1
                    FROM oe_order_sources oos
                    WHERE oos.order_source_id = olif.order_source_id )
',
      p_title                  => 'Invalid Order Source or Reference for RMA',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Order source or reference populated for RMA is not valid.',
      p_solution               => 'Review [1644412/KB781711] Error With RMA Created Via Order Import.',
      p_success_msg            => 'There is no issue  with Order Source or Reference populated for RMA.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_INVALID_RMA_REF');



debug('begin add_signature: SOIMPORT_INVALID_LINEID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18271',
      p_sig_id                 => 'SOIMPORT_INVALID_LINEID',
      p_sig_sql                => '  select ''OE_LINES_IFACE_ALL'' Table_Name, operation_code, org_id, order_source_id, orig_sys_document_ref , sold_to_org_id, sold_to_org, change_sequence ,orig_sys_line_ref, orig_sys_shipment_ref, line_id
   from oe_lines_iface_all olif
 where olif.order_source_id = ##$$ORDSRCID$$##
   and olif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
   and olif.orig_sys_line_ref = NVL( ''##$$ORIGSYSLINEREF$$##''  , olif.orig_sys_line_ref)
   and olif.line_id is not null',
      p_title                  => 'Line Id Populated in the Interfaces Tables',
      p_fail_condition         => '[ line_id] is not null',
      p_problem_descr          => 'The Line_id has been populated in the OE_LINES_IFACE_ALL table. This id is system generated and should not be populated.',
      p_solution               => 'Review [848871/KB713224] Why does Order Import fail with - ORA-00001: unique constraint (ONT.OE_ORDER_LINES_U1) violated in Package oe_line_util Procedure Insert_Row.',
      p_success_msg            => 'There is no issue  Line Id data in the Interfaces Tables.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_INVALID_LINEID');



debug('begin add_signature: SOIMPORT_MANDATORY_DFFS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18285',
      p_sig_id                 => 'SOIMPORT_MANDATORY_DFFS',
      p_sig_sql                => 'SELECT descriptive_flexfield_name , descriptive_flex_context_code ,
application_column_name , end_user_column_name , required_flag
FROM fnd_descr_flex_column_usages
WHERE APPLICATION_ID = 660
  AND DESCRIPTIVE_FLEXFIELD_NAME in (''OE_HEADER_ATTRIBUTES'',''OE_HEADER_GLOBAL_ATTRIBUTE'',''OE_HEADER_TP_ATTRIBUTES'', ''OE_LINE_ATTRIBUTES'',''OE_LINE_INDUSTRY_ATTRIBUTE'',''OE_LINE_PRICING_ATTRIBUTE'',''OE_LINE_RETURN_ATTRIBUTE'',''OE_LINE_TP_ATTRIBUTES'')
  AND ENABLED_FLAG = ''Y''
  AND required_flag = ''Y''',
      p_title                  => 'Mandatory Attributes (Flex Field Segments) Exists',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'One or more required DFF segments exist, verify values are populated for the required attributes.',
      p_solution               => 'Review [563948/KB714293] Order Import Errors with Values have not been entered for one or more required DFF segments.',
      p_success_msg            => 'There are No required DFF segments exists.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_MANDATORY_DFFS');



debug('begin add_signature: SOIMPORT_INVALID_BOM_CALENDAR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18265',
      p_sig_id                 => 'SOIMPORT_INVALID_BOM_CALENDAR',
      p_sig_sql                => 'select ''OE_LINES_IFACE_ALL'' Table_Name, operation_code, org_id, order_source_id, orig_sys_document_ref , sold_to_org_id, sold_to_org, change_sequence ,orig_sys_line_ref, orig_sys_shipment_ref, ship_from_org, ship_from_org_id
   from oe_lines_iface_all olif
 where olif.order_source_id = ##$$ORDSRCID$$##
   and olif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
   and olif.orig_sys_line_ref = NVL( ''##$$ORIGSYSLINEREF$$##'' , olif.orig_sys_line_ref)
   and  olif.ship_from_org_id is not null
   and not exists ( select 1
                    from mtl_parameters mp,
                         BOM_CALENDARS bc
                   where bc.calendar_code = mp.calendar_code
                     and mp.organization_id = olif.ship_from_org_id
                     and sysdate between bc.calendar_start_date and bc.calendar_end_date
                 )',
      p_title                  => 'Invalid BOM Calendar',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Bill of material calendar associated with ship from org is not active.',
      p_solution               => 'Review [762429/KB715797] Order Import Err ORA-20001: APP-MRP-22050: Date falls outside the boundaries of the workday calendar.',
      p_success_msg            => 'There is no issue with the BOM Calendar Associated with Ship From Org.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_INVALID_BOM_CALENDAR');



debug('begin add_signature: SOIMPORT_INVALID_IB_VALUES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18351',
      p_sig_id                 => 'SOIMPORT_INVALID_IB_VALUES',
      p_sig_sql                => 'select  operation_code, org_id, order_source_id, orig_sys_document_ref, sold_to_org_id, sold_to_org, change_sequence ,''Not Applicable'' orig_sys_line_ref, ''Not Applicable'' orig_sys_shipment_ref, ib_owner,ib_installed_at_location
  from oe_headers_iface_all ohif
 where ohif.order_source_id = ##$$ORDSRCID$$##
  and ohif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
and ohif.ib_owner is not null
  and ohif.operation_code = ''INSERT''
   and not exists ( select 1
                    from oe_lookups olk
                   where olk.lookup_type=''ITEM_OWNER''
                   and lookup_code=''END_CUSTOMER''
                   and olk.meaning = ohif.ib_owner
                             )
    union all
    select operation_code, org_id, order_source_id, orig_sys_document_ref, sold_to_org_id, sold_to_org, change_sequence ,''Not Applicable'' orig_sys_line_ref, ''Not Applicable'' orig_sys_shipment_ref,ib_owner,ib_installed_at_location
  from oe_headers_iface_all ohif
 where  ohif.order_source_id = ##$$ORDSRCID$$##
  and ohif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
   and ohif.ib_installed_at_location is not null
   and ohif.operation_code = ''INSERT''
   and not exists ( select 1
                    from oe_lookups olk
                   where olk.lookup_type=''ITEM_INSTALL_LOCATION''
                   and lookup_code=''END_CUSTOMER''
                   and olk.meaning = ohif.ib_installed_at_location
                             )',
      p_title                  => 'Invalid IB Attributes',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Incorrect IB owner or IB installed at location values are populated.
',
      p_solution               => 'Review [2178662/KB772291] Order Import Error Due To IB Owner, IB Installed At Location And IB Current Location.
',
      p_success_msg            => 'There is no InstallBase data or no issue with InstallBase fields that are populated.
',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_INVALID_IB_VALUES');



debug('begin add_signature: EBS_MFG_OM_ONT_OMSOIMPORT_ORPHAN_RECORDS_IN_LINE_INTERFACE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27514',
      p_sig_id                 => 'EBS_MFG_OM_ONT_OMSOIMPORT_ORPHAN_RECORDS_IN_LINE_INTERFACE',
      p_sig_sql                => ' select ''OE_LINES_IFACE_ALL'' Table_Name, operation_code, org_id, order_source_id, orig_sys_document_ref , sold_to_org_id, sold_to_org, change_sequence ,orig_sys_line_ref, orig_sys_shipment_ref
  from oe_lines_iface_all olif
 where olif.order_source_id = ##$$ORDSRCID$$##
   and olif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
   ...
   and not exists ( select 1
      ...
      p_title                  => 'Orphan Records Exists In Line Interface With Reference To a Header But Does Not Exist In Header interface Table',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'SO Lines data exists in interface with reference to a header but header does not exist in interface table.',
      p_solution               => 'Refer To [1391902/KB751327] Orphan Records Are In Oe_lines_iface_all And Unable To Query It In The OI Correction Form .',
      p_success_msg            => 'There is no issue with the records populated in the header and line Interface tables.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_ONT_OMSOIMPORT_ORPHAN_RECORDS_IN_LINE_INTERFACE');



debug('begin add_signature: EBS_MFG_OM_ONT_OMSOIMPORT_INDEX_CREATION_ERROR_ON_HEADER_INTERFACE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27598',
      p_sig_id                 => 'EBS_MFG_OM_ONT_OMSOIMPORT_INDEX_CREATION_ERROR_ON_HEADER_INTERFACE',
      p_sig_sql                => 'SELECT
    ''OE_HEADERS_IFACE_ALL'' Table_Name,
    ohif.order_source_id,
    ohif.orig_sys_document_ref,
	ohif.sold_to_org_id, 
	ohif.sold_to_org, 
	ohif.change_sequence,
    count(1) "Number of Records"
 from
    oe_headers_iface_all    ohif
WHERE   ohif.order_source_id = ##$$ORDSRCID$$##
  and ohif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
 group by ohif.order_source_id,ohif.orig_sys_document_ref,ohif.sold_to_org_id, ohif.sold_to_org, ohif.change_sequence
 having count(1)>1',
      p_title                  => 'ORA-01452 Error While Creating Index On Headers Interface Table',
      p_fail_condition         => '[Number of Records] > [1]',
      p_problem_descr          => 'ORA-01452 Error While Creating Index On OE_HEADERS_IFACE_ALL table due to duplicate records',
      p_solution               => 'Refer To [1283190/KB748786] Error While Creating Index On OE_HEADERS_IFACE_ALL "ORA-01452: cannot CREATE UNIQUE INDEX ONT.OE_HEADERS_IFACE_ALL_U1 ON ONT.OE_HEADERS_IFACE_ALL ; duplicate keys found".
',
      p_success_msg            => 'There is no issue while creating the index on headers interface table
',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_ONT_OMSOIMPORT_INDEX_CREATION_ERROR_ON_HEADER_INTERFACE');



debug('begin add_signature: EBS_MFG_OM_ONT_OMSOIMPORT_SUBINV_WAREHOUSE_NOTEXISTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28445',
      p_sig_id                 => 'EBS_MFG_OM_ONT_OMSOIMPORT_SUBINV_WAREHOUSE_NOTEXISTS',
      p_sig_sql                => 'Select olif.order_source_id,
OLIF.ORG_ID,
olif.ship_from_org_id,
olif.ship_from_org,
...
( SELECT 1 
   ...
   WHERE olif.ship_from_org_id= mstv.organization_id
     and olif.subinventory = mstv.secondary_inventory_name)',
      p_title                  => 'Warehouse and Subinventory Combination is Invalid',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Either Sub-inventory or Warehouse or both ( populated in the interface) are not valid ',
      p_solution               => 'Refer to [732632/KB234970] for details.',
      p_success_msg            => 'There is no issue with Sub-inventory/ Warehouse values Populated.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_ONT_OMSOIMPORT_SUBINV_WAREHOUSE_NOTEXISTS');



debug('begin add_signature: SOIMPORT_INVALID_SOLD_TO_ORG_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18264',
      p_sig_id                 => 'SOIMPORT_INVALID_SOLD_TO_ORG_ID',
      p_sig_sql                => 'select ''OE_HEADERS_IFACE_ALL'' Table_Name, operation_code, org_id, order_source_id, orig_sys_document_ref, sold_to_org_id, sold_to_org, change_sequence , ''Not Applicable'' orig_sys_line_ref, ''Not Applicable'' orig_sys_shipment_ref
  from oe_headers_iface_all ohif
 where ohif.order_source_id = ##$$ORDSRCID$$##
   and ohif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
   and ohif.sold_to_org_id is not null
   and ohif.operation_code = ''UPDATE''
   and not exists ( select 1
                    from oe_order_headers_all ooh
                   where ooh.orig_sys_document_ref = ohif.orig_sys_document_ref
                     and ooh.order_source_id = ohif.order_source_id
                     and ooh.sold_to_org_id = ohif.sold_to_org_id
                 )
union all                 
  select ''OE_LINES_IFACE_ALL'' Table_Name, operation_code, org_id, order_source_id, orig_sys_document_ref , sold_to_org_id, sold_to_org, change_sequence ,orig_sys_line_ref, orig_sys_shipment_ref
  from oe_lines_iface_all olif
 where olif.order_source_id = ##$$ORDSRCID$$##
   and olif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
   and olif.orig_sys_line_ref = NVL( ''##$$ORIGSYSLINEREF$$##'' , olif.orig_sys_line_ref)
   and olif.sold_to_org_id is not null
   and olif.operation_code = ''UPDATE''
   and not exists ( select 1
                    from oe_order_lines_all ool
                   where ool.orig_sys_document_ref = olif.orig_sys_document_ref
                     and ool.orig_sys_line_ref = olif.orig_sys_line_ref
                     and ool.order_source_id = olif.order_source_id
                     and ool.sold_to_org_id = olif.sold_to_org_id
                 )',
      p_title                  => 'Invalid Sold To Org Id Populated in the Interfaces Tables',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Sold to org Id populated in the Interface table is not valid.',
      p_solution               => 'Review [1574178/KB793707] Order Import Errors With "You Are Trying To Insert An Existing Order Or Update An Order That Does Not Exist. Enter Correct Operation Code.',
      p_success_msg            => 'There is no issue with the Sold To Org Id  Populated  in the Interfaces Tables.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_INVALID_SOLD_TO_ORG_ID');



debug('begin add_signature: SOIMPORT_ATP_OVERRIDE_NO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18349',
      p_sig_id                 => 'SOIMPORT_ATP_OVERRIDE_NO',
      p_sig_sql                => 'select operation_code, org_id, order_source_id, orig_sys_document_ref , sold_to_org_id, sold_to_org, change_sequence ,orig_sys_line_ref, orig_sys_shipment_ref, schedule_ship_date
  from oe_lines_iface_all olif, 
        mtl_system_items msi
 where  olif.order_source_id = ##$$ORDSRCID$$## 
and olif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
and olif.orig_sys_line_ref = NVL( ''##$$ORIGSYSLINEREF$$##'' , olif.orig_sys_line_ref ) 
   and olif.schedule_ship_date is not null
   and olif.operation_code = ''UPDATE''
   and olif.inventory_item_id = msi.inventory_item_id
   and olif.ship_from_org_id = msi.organization_id
   and msi.atp_flag <> ''N''
            and not exists ( select 1
                  from fnd_profile_option_values fpov,
                       fnd_profile_options_vl fpo
                 where fpo.profile_option_id=fpov.profile_option_id
                   and fpo.profile_option_name in ( ''ONT_OVERRIDE_ATP'')
                   and fpov.profile_option_value = ''Y''
               )
',
      p_title                  => 'Cannot Override the Schedule Ship Date or Arrival Date',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'User will not be able to override the schedule ship date or arrival date on Lines with ATP enabled items.
',
      p_solution               => 'Review [958232/KB765890] Order Import Errors With You Are Not Authorized To Override The Line.
',
      p_success_msg            => 'There is no issue with Rescheduling the Order line.
',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_ATP_OVERRIDE_NO');



debug('begin add_signature: SOIMPORT_STUCK_DATA_INTERFACE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18733',
      p_sig_id                 => 'SOIMPORT_STUCK_DATA_INTERFACE',
      p_sig_sql                => 'SELECT
    ''OE_HEADERS_IFACE_ALL'' table_name,
    ohif.order_source_id,
    ohif.orig_sys_document_ref,
    ''not applicable'' orig_sys_line_ref,
    ohif.request_id,
    ohif.error_flag
FROM
    oe_headers_iface_all ohif
WHERE ohif.order_source_id = ##$$ORDSRCID$$##
  AND ohif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
 AND (ohif.Request_id is not null or ohif.Error_flag is not null)
UNION ALL
    SELECT
  ''OE_LINES_IFACE_ALL'' Table_Name,
    olif.order_source_id,
    olif.orig_sys_document_ref,
    olif.orig_sys_line_ref,
    olif.Request_id,
    olif.Error_flag
...
AND olif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
 AND olif.orig_sys_line_ref = nvl(''##$$ORIGSYSLINEREF$$##'', olif.orig_sys_line_ref)
  AND ( olif.request_id IS NOT NULL
          OR olif.error_flag IS NOT NULL )',
      p_title                  => 'Stuck Records in Order Import Interface',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Stuck records (Sales Orders) in the Order Import interface tables.',
      p_solution               => 'Review [737243/KB625668] How Does One Re-process Record in the Order Import Interface Tables ? ',
      p_success_msg            => 'There are no stuck records in Interface Tables.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_STUCK_DATA_INTERFACE');



debug('begin add_signature: SOIMPORT_INVALID_OPERATION_CODES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18261',
      p_sig_id                 => 'SOIMPORT_INVALID_OPERATION_CODES',
      p_sig_sql                => 'select ''OE_HEADERS_IFACE_ALL'' Table_Name, operation_code, org_id, order_source_id, orig_sys_document_ref, sold_to_org_id, sold_to_org, change_sequence , ''Not Applicable'' orig_sys_line_ref, ''Not Applicable'' orig_sys_shipment_ref, ''Not Applicable'' orig_sys_credit_ref
from OE_HEADERS_IFACE_ALL ohif
where ohif.order_source_id = ##$$ORDSRCID$$##
  and ohif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
  and ohif.operation_code not in (''INSERT'',''CREATE'',''UPDATE'',''DELETE'')
union all
select ''OE_LINES_IFACE_ALL'' Table_Name, operation_code, org_id, order_source_id, orig_sys_document_ref , sold_to_org_id, sold_to_org, change_sequence ,orig_sys_line_ref, orig_sys_shipment_ref, ''Not Applicable'' orig_sys_credit_ref
from OE_LINES_IFACE_ALL olif
where olif.order_source_id = ##$$ORDSRCID$$##
  and olif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
  and olif.orig_sys_line_ref = NVL( ''##$$ORIGSYSLINEREF$$##'' , olif.orig_sys_line_ref)
  and olif.operation_code  not in (''INSERT'',''CREATE'',''UPDATE'',''DELETE'')
union all
select ''OE_PRICE_ADJS_IFACE_ALL'' Table_Name, operation_code, org_id, order_source_id, orig_sys_document_ref , sold_to_org_id, sold_to_org, change_sequence ,orig_sys_line_ref, orig_sys_shipment_ref, ''Not Applicable'' orig_sys_credit_ref
from OE_PRICE_ADJS_IFACE_ALL opaif
where opaif.order_source_id = ##$$ORDSRCID$$##
  and opaif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
  and opaif.orig_sys_line_ref = NVL( ''##$$ORIGSYSLINEREF$$##'' , opaif.orig_sys_line_ref)
  and opaif.operation_code not in (''INSERT'',''CREATE'',''UPDATE'',''DELETE'')
union all
select ''OE_CREDITS_IFACE_ALL'' Table_Name, operation_code, org_id, order_source_id, orig_sys_document_ref , sold_to_org_id, sold_to_org, change_sequence ,orig_sys_line_ref, orig_sys_shipment_ref, orig_sys_credit_ref
from OE_CREDITS_IFACE_ALL ocif
where ocif.order_source_id = ##$$ORDSRCID$$##
  and ocif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
  and ocif.orig_sys_line_ref = NVL( ''##$$ORIGSYSLINEREF$$##'' , ocif.orig_sys_line_ref)
  and ocif.operation_code  not in (''INSERT'',''CREATE'',''UPDATE'',''DELETE'')',
      p_title                  => 'Invalid Operation Code in the Interfaces Tables',
      p_fail_condition         => '[operation_code] is not null',
      p_problem_descr          => 'Operation code specified in the interfaces table is not valid.',
      p_solution               => 'Review [2215156/KB781946] ORA-06502: PL/SQL: Numeric Or Value Error: During Order Import.',
      p_success_msg            => 'There is no issue with the Operation Codes specified in the Interfaces Tables.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_INVALID_OPERATION_CODES');



debug('begin add_signature: SOIMPORT_INSERT_EXISTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18352',
      p_sig_id                 => 'SOIMPORT_INSERT_EXISTS',
      p_sig_sql                => 'select ''OE_HEADERS_IFACE_ALL'' Table_Name, operation_code, org_id, order_source_id, orig_sys_document_ref, sold_to_org_id, sold_to_org, change_sequence ,''Not Applicable'' orig_sys_line_ref, ''Not Applicable'' orig_sys_shipment_ref
  from oe_headers_iface_all ohif
 where  ohif.order_source_id = ##$$ORDSRCID$$##
  and ohif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
...
and olif.orig_sys_line_ref = NVL( ''##$$ORIGSYSLINEREF$$##'' , olif.orig_sys_line_ref ) 
   ...
   and exists ( select 1
                   ...
                   where ool.orig_sys_document_ref= olif.orig_sys_document_ref
                     and ool.orig_sys_line_ref  = olif.orig_sys_line_ref
                     and ool.order_source_id = olif.order_source_id
                     and ool.org_id = olif.org_id
                 )',
      p_title                  => 'Inserting an Order That  Already Exists',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'You are trying to insert an existing order.
',
      p_solution               => 'Review[205661/KB737112]OEOIMP - Order Will Not Update Via Order Import(PKG_NAME=OE_Order_GRP) .
',
      p_success_msg            => 'Order that is being inserted is new.
',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_INSERT_EXISTS');



debug('begin add_signature: SOIMPORT_UPDATE_NOT_EXISTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18353',
      p_sig_id                 => 'SOIMPORT_UPDATE_NOT_EXISTS',
      p_sig_sql                => 'select ''OE_HEADERS_IFACE_ALL'' Table_Name, operation_code, org_id, order_source_id, orig_sys_document_ref, sold_to_org_id, sold_to_org, change_sequence ,''Not Applicable'' orig_sys_line_ref, ''Not Applicable'' orig_sys_shipment_ref
  from oe_headers_iface_all ohif
 where  ohif.order_source_id = ##$$ORDSRCID$$##
  and ohif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
...
',
      p_title                  => 'Updating an Order That Does Not Exist',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'You are trying to update an order that does not exist.
',
      p_solution               => 'Review[205661/KB737112]OEOIMP - Order Will Not Update Via Order Import(PKG_NAME=OE_Order_GRP) .
',
      p_success_msg            => 'Order that is being updated exists .
',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_UPDATE_NOT_EXISTS');



debug('begin add_signature: SOIMPORT_ISO_INSERT_EXISTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18283',
      p_sig_id                 => 'SOIMPORT_ISO_INSERT_EXISTS',
      p_sig_sql                => 'select ''OE_HEADERS_IFACE_ALL'' Table_Name, operation_code, org_id, order_source_id, orig_sys_document_ref, sold_to_org_id, sold_to_org, change_sequence ,''Not Applicable'' orig_sys_line_ref, ''Not Applicable'' orig_sys_shipment_ref
  from oe_headers_iface_all ohif
 where ohif.order_source_id = ##$$ORDSRCID$$##
   and ohif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
   and ohif.operation_code = ''INSERT''
   and ohif.order_source_id =10
   and exists ( select 1
                    from oe_order_headers_all ooh
                   where ooh.source_document_id = ohif.orig_sys_document_ref
                     and ooh.order_source_id = ohif.order_source_id
                     and ooh.org_id = ohif.org_id
                 )
union all
 ...
 where olif.order_source_id = ##$$ORDSRCID$$##
   ...
   and exists ( select 1
                    from oe_order_lines_all ool
                   where ool.source_document_id = olif.orig_sys_document_ref
                     and ool.source_document_line_id = olif.orig_sys_line_ref
                     and ool.order_source_id = olif.order_source_id
                     and ool.org_id = olif.org_id
                 )',
      p_title                  => 'Inserting an Existing Internal Sales Order',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'You are trying to insert an existing order.',
      p_solution               => 'Review [1486960/KB765563] Order Import Errors with: You Are Trying to Insert an Existing Order or Update an Order That Does Not Exist.',
      p_success_msg            => 'There is no issue with the data Inserted.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_ISO_INSERT_EXISTS');



debug('begin add_signature: SOIMPORT_ISO_UPDATE_NOT_EXISTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18284',
      p_sig_id                 => 'SOIMPORT_ISO_UPDATE_NOT_EXISTS',
      p_sig_sql                => 'select ''OE_HEADERS_IFACE_ALL'' Table_Name, operation_code, org_id, order_source_id, orig_sys_document_ref, sold_to_org_id, sold_to_org, change_sequence ,''Not Applicable'' orig_sys_line_ref, ''Not Applicable'' orig_sys_shipment_ref
  from oe_headers_iface_all ohif
 where ohif.order_source_id = ##$$ORDSRCID$$##
   and ohif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
...
union all
 ...
 where olif.order_source_id = ##$$ORDSRCID$$##
   ...
   and NOT exists ( select 1
      ...
      p_title                  => 'Updating an ISO Order That Does Not Exist',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Internal sales order being updated does not exist.',
      p_solution               => 'Review [1486960/KB765563] Order Import Errors with: You Are Trying to Insert an Existing Order or Update an Order That Does Not Exist.',
      p_success_msg            => 'ISO Order being updated does exists.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_ISO_UPDATE_NOT_EXISTS');



debug('begin add_signature: SOIMPORT_PRICE_LIST_NULL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15903',
      p_sig_id                 => 'SOIMPORT_PRICE_LIST_NULL',
      p_sig_sql                => 'select org_id, order_source_id, orig_sys_document_ref, orig_sys_line_ref, calculate_price_flag, price_list_id, price_list, unit_list_price, unit_selling_price
from oe_lines_iface_all olif
where olif.order_source_id = ##$$ORDSRCID$$##
  and olif.orig_sys_document_ref = NVL(''##$$ORIGSYSDOCREF$$##'', olif.orig_sys_document_ref)
  and olif.orig_sys_line_ref = NVL( ''##$$ORIGSYSLINEREF$$##'' , olif.orig_sys_line_ref)
and  olif.CALCULATE_PRICE_FLAG = ''N''
 and ( (olif.PRICE_LIST_ID is null  and olif.price_list is null)
        or ( olif.UNIT_LIST_PRICE is null OR olif.UNIT_SELLING_PRICE is null)
     )',
      p_title                  => 'Price List and Price Details Are Not Populated but Calculate Price Flag Is No',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Calculate_price_flag is set to No, and price list and price details are NULL.',
      p_solution               => 'Review [1221623/KB743354] Order Import Fail If Passing Null Value On List Price and calculate_price_flag is set to ''N''.',
      p_success_msg            => 'There is no issue with Calculate_price_flag, Price_list and Price details are populated.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_PRICE_LIST_NULL');



debug('begin add_signature: SOIMPORT_INTORD_NO_PRICE_LIST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18259',
      p_sig_id                 => 'SOIMPORT_INTORD_NO_PRICE_LIST',
      p_sig_sql                => 'select operation_code, org_id, order_source_id, orig_sys_document_ref, sold_to_org_id, sold_to_org, change_sequence, order_type_id, ordered_date, price_list_id, price_list, transactional_curr_code
from oe_headers_iface_all ohif
where ohif.order_source_id = ##$$ORDSRCID$$##
  and ohif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
and ohif.order_source_id = 10
  and (ohif.PRICE_LIST_ID is null  and ohif.price_list is null)
and not exists ( select 1
              from oe_transaction_types_all ott1,
                   oe_transaction_types_all ott2
             where ohif.order_type_id = ott1.transaction_type_id
               and ohif.org_id = ott1.org_id
               and ott1.default_outbound_line_type_id = ott2.transaction_type_id(+)
               and (ott1.price_list_id is not null or ott2.price_list_id is not null)
            )',
      p_title                  => 'Price List Is Not Defined on the Transaction Type Used for the Internal Order',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There is no price list specified on the Transaction Type used for the Internal Order or its default line type.',
      p_solution               => 'Review [1501690/KB776533] Price List is Not Defaulting onto Internal Sales Order Line during Order Import.',
      p_success_msg            => 'There is no issue with Price List association to the Transaction Type used for the Internal Order or its Default Line Type.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_INTORD_NO_PRICE_LIST');



debug('begin add_signature: SOIMPORT_INTORD_NO_MULTI_CUR_PRICE_LIST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18260',
      p_sig_id                 => 'SOIMPORT_INTORD_NO_MULTI_CUR_PRICE_LIST',
      p_sig_sql                => 'select operation_code, org_id, order_source_id, orig_sys_document_ref, sold_to_org_id, sold_to_org, change_sequence, order_type_id, ordered_date, price_list_id, price_list, transactional_curr_code
from oe_headers_iface_all ohif
where ohif.order_source_id = ##$$ORDSRCID$$##
  and ohif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
...
and exists ( select 1
              from oe_transaction_types_all ott
             where ohif.order_type_id = ott.transaction_type_id
               and ohif.org_id = ott.org_id
               and ott.price_list_id is not null
               and exists ( select 1
                              from  qp_secu_list_headers_v qlh                                    
                              where qlh.list_header_id = ott.price_list_id
                               and qlh.currency_code <> ohif.transactional_curr_code
                               and not exists ( select 1
                                              from qp_currency_lists_vl qcl,
                                                   qp_currency_details qcd
                                             where qlh.currency_header_id = qcl.currency_header_id
                                               and qcl.currency_header_id = qcd.currency_header_id
                                               and qcd.to_currency_code = ohif.transactional_curr_code
                                           )
                              )
                )',
      p_title                  => 'Multi-currency Price List Not Defined on Internal Order Transaction Type',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There is no price list which has multi-currency conversions defined, nor specified on the transaction type used for the internal order or its default line type.',
      p_solution               => 'Review [2151726/KB747269] Internal Orders Error: Price List Currency (AAA) Must Match Order Currency (BBB). Please Also Verify If Pricing Date.',
      p_success_msg            => 'There is no issue with Price List which has multi-currency conversions defined association, to the Transaction Type used for the Internal Order or its Default Line Type.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_INTORD_NO_MULTI_CUR_PRICE_LIST');



debug('begin add_signature: SOIMPORT_DUP_ORIG_SYS_DOCUMENT_REF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17024',
      p_sig_id                 => 'SOIMPORT_DUP_ORIG_SYS_DOCUMENT_REF',
      p_sig_sql                => 'SELECT
    ''OE_HEADERS_IFACE_ALL'' Table_Name,
    ohif.order_source_id,
    ohif.orig_sys_document_ref,
...
WHERE   ohif.order_source_id = ##$$ORDSRCID$$##
  and ohif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
 group by ohif.order_source_id,ohif.orig_sys_document_ref
 having count(1)>1
union all 
  SELECT
  ''OE_LINES_IFACE_ALL'' Table_Name,
...
WHERE  olif.order_source_id = ##$$ORDSRCID$$##
  and olif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
  and olif.orig_sys_line_ref = NVL( ''##$$ORIGSYSLINEREF$$##'' , olif.orig_sys_line_ref) 
 group by olif.order_source_id, olif.orig_sys_document_ref,olif.orig_sys_line_ref
 having count(1)>1
',
      p_title                  => 'SO Header Interface Table Contains Duplicate Records',
      p_fail_condition         => '[Number of Records] > [1]',
      p_problem_descr          => 'Sales order header interface table contains more than one record with same ORIG_SYS_DOCUMENT_REF.',
      p_solution               => 'Review [2686481/KB766548] Getting Error While Importing Internal Sales Order from Internal Requisition.',
      p_success_msg            => 'There is no issue of Duplicate records in headers  interface table.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_DUP_ORIG_SYS_DOCUMENT_REF');



debug('begin add_signature: SOIMPOT_DUPLICATE_SEQ_ASSIGNMENT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18282',
      p_sig_id                 => 'SOIMPOT_DUPLICATE_SEQ_ASSIGNMENT',
      p_sig_sql                => 'select ''OE_HEADERS_IFACE_ALL'' Table_Name, operation_code, org_id, order_source_id, orig_sys_document_ref, sold_to_org_id, sold_to_org, change_sequence ,''Not Applicable'' orig_sys_line_ref, ''Not Applicable'' orig_sys_shipment_ref
  from oe_headers_iface_all ohif
 where ohif.order_source_id = ##$$ORDSRCID$$##
   and ohif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##'' 
   and ohif.operation_code = ''INSERT''
   and ohif.order_type_id is NOT NULL
   and exists (  select sa.doc_sequence_assignment_id, count(1)
                  ...
                  where SEQ.DOC_SEQUENCE_ID = SA.DOC_SEQUENCE_ID 
                    and SA.APPLICATION_ID = 660 
                    and SA.CATEGORY_CODE = to_char(ohif.order_type_id) 
                    and   ar.org_id = ohif.org_id
                    and   (SA.SET_OF_BOOKS_ID = ar.set_of_books_id or SA.SET_OF_BOOKS_ID is NULL ) 
                    and  SYSDATE between SA.START_DATE and nvl( SA.END_DATE + .9999, SYSDATE + .9999 )
               group by sa.doc_sequence_assignment_id
               having count(1)>1
               )',
      p_title                  => 'Duplicate Document Sequence Assignment Exists',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are duplicate Document Sequences defined for the given Order Type',
      p_solution               => 'Review [866163/KB759232] Unable To Import Or Enter Sale Order - ORA-20001: APP-FND-01564: ORACLE error - 1422 in get_seq_info.',
      p_success_msg            => 'There is no issue with the Document Sequence Assignment',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPOT_DUPLICATE_SEQ_ASSIGNMENT');



debug('begin add_signature: SOIMPORT_DUP_CUS_PO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18281',
      p_sig_id                 => 'SOIMPORT_DUP_CUS_PO',
      p_sig_sql                => ' select ''OE_HEADERS_IFACE_ALL'' Table_Name, operation_code, org_id, order_source_id, orig_sys_document_ref, sold_to_org_id, sold_to_org, change_sequence ,''Not Applicable'' orig_sys_line_ref, ''Not Applicable'' orig_sys_shipment_ref, customer_po_number
      from oe_headers_iface_all ohif
     where ohif.order_source_id = ##$$ORDSRCID$$##
       and ohif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
       and ohif.customer_po_number is not null
       and ohif.operation_code = ''INSERT''
       and exists ( select 1
                        from oe_order_headers_all ooh
                       where ooh.cust_po_number = ohif.customer_po_number
                     )
       and exists ( select 1
                      from fnd_profile_option_values fpov,
                           fnd_profile_options_vl fpo
                     where fpo.profile_option_id=fpov.profile_option_id
                       and fpo.profile_option_name in ( ''ONT_ENFORCE_DUP_PO'')
                       and fpov.profile_option_value = ''Y''
                   )
    union all
      select ''OE_LINES_IFACE_ALL'' Table_Name, operation_code, org_id, order_source_id, orig_sys_document_ref , sold_to_org_id, sold_to_org, change_sequence ,orig_sys_line_ref, orig_sys_shipment_ref, customer_po_number
      from oe_lines_iface_all olif
     where olif.order_source_id = ##$$ORDSRCID$$##
       and olif.orig_sys_document_ref = ''##$$ORIGSYSDOCREF$$##''
       and olif.orig_sys_line_ref = NVL( ''##$$ORIGSYSLINEREF$$##'' , olif.orig_sys_line_ref)
       and olif.customer_po_number is not null
       and olif.operation_code = ''INSERT''
       and exists ( select 1
                        from oe_order_lines_all ool
                       where ool.cust_po_number = olif.customer_po_number
                     )
       and exists ( select 1
                      from fnd_profile_option_values fpov,
                           fnd_profile_options_vl fpo
      ...
      p_title                  => 'Duplicate Customer PO Number',
      p_fail_condition         => '[customer_po_number] is not null',
      p_problem_descr          => 'Customer purchase order number provided already exists.',
      p_solution               => 'Review [778895/KB706366] Order Import Fails With Error Customer Po Number Referenced By Another Order.',
      p_success_msg            => 'There is no issue with the Customer PO number populated in the interface table.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SOIMPORT_DUP_CUS_PO');
...
BEGIN
  ...
  IF (p_order_source_id IS NOT NULL) THEN
    g_params_string := g_params_string || to_char(p_order_source_id) || '_';
  END IF;
  IF (p_orig_sys_document_ref IS NOT NULL) THEN
    g_params_string := g_params_string || to_char(p_orig_sys_document_ref) || '_';
  END IF;
  ...
  analyzer_title := 'Sales Order Import Analyzer';
...
debug('begin section: SOIMPORT_INTERFACE_DATA');
start_section('Sales Order Interface Data', 'SOIMPORT_INTERFACE_DATA');
   set_item_result(run_stored_sig('SOIMPORT_SOHDRS_IFACE_FULL'));
   set_item_result(run_stored_sig('SOIMPORT_SOLINES_IFACE_FULL'));
   set_item_result(run_stored_sig('SOIMPORT_ACTIONS_IFACE'));
   set_item_result(run_stored_sig('SOIMPORT_PRICE_ADJS_IFACE'));
   set_item_result(run_stored_sig('SOIMPORT_PRICE_ATTS_IFACE'));
   set_item_result(run_stored_sig('SOIMPORT_CREDITS_IFACE'));
   set_item_result(run_stored_sig('SOIMPORT_PAYMENTS_IFACE'));
   set_item_result(run_stored_sig('SOIMPORT_LOTSERIALS_IFACE'));
   set_item_result(run_stored_sig('SOIMPORT_RESERVTNS_IFACE'));
   set_item_result(run_stored_sig('SOIMPORT_PROCESSING_MSGS'));
   set_item_result(run_stored_sig('SOIMPORT_SO_HEADER_DETAILS'));
   set_item_result(run_stored_sig('SOIMPORT_SO_LINE_DETAILS'));
   set_item_result(run_stored_sig('EBS_MFG_OM_ONT_OMSOIMPORT_REQ_HDR'));
   set_item_result(run_stored_sig('EBS_MFG_OM_ONT_OMSOIMPORT_REQ_LINES'));
end_section;
debug('end section: SOIMPORT_INTERFACE_DATA');

debug('begin section: INTERFACE_DATA_VALIDATIONS');
start_section('Interface Data Validations', 'INTERFACE_DATA_VALIDATIONS');
   set_item_result(run_stored_sig('EBS_MFG_OM_ONT_OMSOIMPORT_NULL_SHIP_TO_ORG_ID'));
   set_item_result(run_stored_sig('SOIMPORT_INVALID_SHIP_TO_ORG_ID'));
   set_item_result(run_stored_sig('SOIMPORT_INVALID_SHIP_TO_ISO'));
   set_item_result(run_stored_sig('SOIMPORT_NO_MATCH_SOLD_TO'));
   set_item_result(run_stored_sig('SOIMPORT_INVALID_INVOICE_TO_ORG_ID'));
   set_item_result(run_stored_sig('SOIMPORT_WH_SUBINV_INVALID'));
   set_item_result(run_stored_sig('SOIMPORT_INVALID_ORDER_TYPE'));
   set_item_result(run_stored_sig('SOIMPORT_IO_NOT_ENABLED'));
   set_item_result(run_stored_sig('SOIMPORT_ORG_SYS_SHIPMENT_REF_NULL'));
   set_item_result(run_stored_sig('SOIMPORT_INVALID_RMA_REF'));
   set_item_result(run_stored_sig('SOIMPORT_INVALID_LINEID'));
   set_item_result(run_stored_sig('SOIMPORT_MANDATORY_DFFS'));
   set_item_result(run_stored_sig('SOIMPORT_INVALID_BOM_CALENDAR'));
   set_item_result(run_stored_sig('SOIMPORT_INVALID_IB_VALUES'));
   set_item_result(run_stored_sig('EBS_MFG_OM_ONT_OMSOIMPORT_ORPHAN_RECORDS_IN_LINE_INTERFACE'));
   set_item_result(run_stored_sig('EBS_MFG_OM_ONT_OMSOIMPORT_INDEX_CREATION_ERROR_ON_HEADER_INTERFACE'));
   set_item_result(run_stored_sig('EBS_MFG_OM_ONT_OMSOIMPORT_SUBINV_WAREHOUSE_NOTEXISTS'));
   set_item_result(run_stored_sig('SOIMPORT_INVALID_SOLD_TO_ORG_ID'));
   set_item_result(run_stored_sig('SOIMPORT_ATP_OVERRIDE_NO'));
   set_item_result(run_stored_sig('SOIMPORT_STUCK_DATA_INTERFACE'));
end_section;
debug('end section: INTERFACE_DATA_VALIDATIONS');

debug('begin section: OPERATION_VERIFCATIONS');
start_section('Operation Verifications', 'OPERATION_VERIFCATIONS');
   set_item_result(run_stored_sig('SOIMPORT_INVALID_OPERATION_CODES'));
   set_item_result(run_stored_sig('SOIMPORT_INSERT_EXISTS'));
   set_item_result(run_stored_sig('SOIMPORT_UPDATE_NOT_EXISTS'));
   set_item_result(run_stored_sig('SOIMPORT_ISO_INSERT_EXISTS'));
   set_item_result(run_stored_sig('SOIMPORT_ISO_UPDATE_NOT_EXISTS'));
end_section;
debug('end section: OPERATION_VERIFCATIONS');

debug('begin section: PRICING_VERIFICATIONS');
start_section('Pricing Verifications', 'PRICING_VERIFICATIONS');
   set_item_result(run_stored_sig('SOIMPORT_PRICE_LIST_NULL'));
   set_item_result(run_stored_sig('SOIMPORT_INTORD_NO_PRICE_LIST'));
   set_item_result(run_stored_sig('SOIMPORT_INTORD_NO_MULTI_CUR_PRICE_LIST'));
end_section;
debug('end section: PRICING_VERIFICATIONS');

debug('begin section: DUPLICATION_VERIFICATIONS');
start_section('Duplication Verifications', 'DUPLICATION_VERIFICATIONS');
   set_item_result(run_stored_sig('SOIMPORT_DUP_ORIG_SYS_DOCUMENT_REF'));
   set_item_result(run_stored_sig('SOIMPOT_DUPLICATE_SEQ_ASSIGNMENT'));
   set_item_result(run_stored_sig('SOIMPORT_DUP_CUS_PO'));
end_section;
debug('end section: DUPLICATION_VERIFICATIONS');
