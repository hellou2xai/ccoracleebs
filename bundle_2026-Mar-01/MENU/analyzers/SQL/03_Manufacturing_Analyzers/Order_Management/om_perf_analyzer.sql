...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Order Management Suite Performance     |
REM | Analyzer                                                                  |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE om_perf_analyzer_pkg AUTHID DEFINER AS
...
PROCEDURE main
(            p_include_ont                  IN VARCHAR2    DEFAULT 'Y'
           ,p_include_wsh                  IN VARCHAR2    DEFAULT 'Y'
           ,p_include_qp                   IN VARCHAR2    DEFAULT 'Y'
           ,p_include_cz                   IN VARCHAR2    DEFAULT 'Y'
           ,p_include_wf                   IN VARCHAR2    DEFAULT 'Y'
           ,p_include_db                   IN VARCHAR2    DEFAULT 'Y'
...
END om_perf_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY om_perf_analyzer_pkg AS
-- $Id: om_perf_analyzer.sql, 200.15 2026/01/27 21:04:59 cschmehl Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2968687.1));
...
----------------------------------------------------------------
--  Accommodations for Database Tile
  g_degree          number;
  g_apps_version    FND_PRODUCT_GROUPS.RELEASE_NAME%TYPE;

--  Accommodations for Advanced Pricing Tile
g_blind           number;

--  Accommodations for Workflow Tile
g_orphline			number;
g_orphhdr			number;
...
g_wsh_otm_dlvy_multi_leg  VARCHAR2(1);

-- variables for messaging only
--g_so_org_id  VARCHAR2(240);
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'ONTPERF_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'ONTPERF_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>ONTPERF Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2968687.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/om_perf_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,9924,EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,9924,EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},9924,EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/mosc/discussion/4548036/ebs-om-suite-performance-analyzer-coming-soon/p1?new=1" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">9924</span>
...
<p>Template Changes (4.8.4): View Confluence Page<br>
...
Signature AC_TABLE_INDEXES has been changed.</p><p>Minimal changes to the following Signatures:<br>
EBS_ATG_UGLE_SEQUENCES_CLOSE_TO_MAXIMUM_VALUE&nbsp;<br>
EBS_ATG_UGLE_SEQUENCES_CLOSE_TO_MAXIMUM_VALUE_BELOW_12C&nbsp;</p><p>&nbsp;</p>
            <br><br>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,9924,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,9924,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},9924,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
l_wsh_otm_dlvy_multi_leg  VARCHAR2(1);

-- variables for messaging only
--l_so_org_id    VARCHAR2(240);
--l_so_org_name  VARCHAR2(240);
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Include Order Management (Y/N)';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_include_ont,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Include Shipping Information (Y/N)';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_include_wsh,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Include Advanced Pricing Information (Y/N)';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_include_qp,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Include Configurator Information (Y/N)';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_include_cz,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Include Workflow Information (Y/N)';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_include_wf,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Include Database Information (Y/N)';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_include_db,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Include Diagnostic Apps Check (Default is Y)';
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/01/27 21:04:58 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'om_perf_analyzer.sql';
...
debug('begin parameter validation: p_include_ont');
IF p_include_ont IS NOT NULL AND p_include_ont NOT IN ( 'N','Y') THEN
   print_error('INVALID ARGUMENT: Gather and Include Order Management Information is invalid.  Valid values are Y or N.');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_include_ont');

debug('begin parameter validation: p_include_wsh');
IF p_include_wsh IS NOT NULL AND p_include_wsh NOT IN ( 'N','Y') THEN
   print_error('INVALID ARGUMENT: Gather and Include Shipping Information is invalid.  Valid values are Y or N.');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_include_wsh');

debug('begin parameter validation: p_include_qp');
IF p_include_qp IS NOT NULL AND p_include_qp NOT IN ( 'N','Y') THEN
   print_error('INVALID ARGUMENT: Gather and Include Advanced Pricing Information is invalid.  Valid values are Y or N.');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_include_qp');

debug('begin parameter validation: p_include_cz');
IF p_include_cz IS NOT NULL AND p_include_cz NOT IN ( 'N','Y') THEN
   print_error('INVALID ARGUMENT: Gather and Include Configurator Information is invalid.  Valid values are Y or N.');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_include_cz');

debug('begin parameter validation: p_include_wf');
IF p_include_wf IS NOT NULL AND p_include_wf NOT IN ( 'N','Y') THEN
   print_error('INVALID ARGUMENT: Gather and Include Workflow Information is invalid.  Valid values are Y or N.');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_include_wf');

debug('begin parameter validation: p_include_db');
IF p_include_db IS NOT NULL AND p_include_db NOT IN ( 'N','Y') THEN
   print_error('INVALID ARGUMENT: Gather and Include Database Information is invalid.  Valid values are Y or N.');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_include_db');
...
l_wsh_otm_dlvy_multi_leg := NVL(fnd_profile.value('WSH_OTM_DLVY_MULTI_LEG'), 'N');
g_wsh_otm_dlvy_multi_leg := l_wsh_otm_dlvy_multi_leg;
print_log('g_wsh_otm_dlvy_multi_leg = '||l_wsh_otm_dlvy_multi_leg);
...
-- needed for DBSTAT1_GSS signature
...
debug('begin populate sql tokens hash table');
   ...
   g_sql_tokens('##$$WSH_PERF$$##') := p_include_wsh;
   g_masked_tokens('##$$WSH_PERF$$##') := mask_text( g_sql_tokens('##$$WSH_PERF$$##'), 'NO_MASK');
   g_sql_tokens('##$$QP_PERF$$##') := p_include_qp;
   g_masked_tokens('##$$QP_PERF$$##') := mask_text( g_sql_tokens('##$$QP_PERF$$##'), 'NO_MASK');
   g_sql_tokens('##$$OM_PERF$$##') := p_include_ont;
   g_masked_tokens('##$$OM_PERF$$##') := mask_text( g_sql_tokens('##$$OM_PERF$$##'), 'NO_MASK');
   g_sql_tokens('##$$CZ_PERF$$##') := p_include_cz;
   g_masked_tokens('##$$CZ_PERF$$##') := mask_text( g_sql_tokens('##$$CZ_PERF$$##'), 'NO_MASK');
   g_sql_tokens('##$$WF_PERF$$##') := p_include_wf;
   g_masked_tokens('##$$WF_PERF$$##') := mask_text( g_sql_tokens('##$$WF_PERF$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM2$$##') := '660';
   g_masked_tokens('##$$APPS_PARAM2$$##') := mask_text( g_sql_tokens('##$$APPS_PARAM2$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM3$$##') := '665';
   ...
   g_sql_tokens('##$$APPS_PARAM5$$##') := '708';
   g_masked_tokens('##$$APPS_PARAM5$$##') := mask_text( g_sql_tokens('##$$APPS_PARAM5$$##'), 'NO_MASK');
   g_sql_tokens('##$$DB_PERF$$##') := p_include_db;
   g_masked_tokens('##$$DB_PERF$$##') := mask_text( g_sql_tokens('##$$DB_PERF$$##'), 'NO_MASK');
...
debug('begin add_signature: EBS_MFG_OM_PERF_PURGE_ELIGIBLE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26324',
      p_sig_id                 => 'EBS_MFG_OM_PERF_PURGE_ELIGIBLE',
      p_sig_sql                => 'SELECT owner "Owner",
       table_name "Table Name",
       to_char(om_perf_analyzer_pkg.tabcount(table_name), ''999,999,999,999'') "Count",
       to_char(num_rows, ''999,999,999,999'') "Num Rows",
       to_char(sample_size, ''999,999,999,999'') "Sample Size",
       to_char( decode(num_rows, 0, 0, sample_size/num_rows*100), ''999.9'')  "Percent",       
       last_analyzed "Last Analyzed",
       global_stats "Global Stats",
       user_stats "User Stats",
       stale_stats "Stale Stats"
  FROM dba_tab_statistics
 WHERE owner in (''BOM'', ''CZ'', ''ONT'')
   AND num_rows > 0
   AND table_name IN (
   ''BOM_CTO_ORDER_DEMAND'', ''BOM_CTO_ORDER_LINES'', ''BOM_CTO_SRC_ORGS_B'', 
   ''CZ_CONFIG_ATTRIBUTES'', ''CZ_CONFIG_EXT_ATTRIBUTES'', ''CZ_CONFIG_HDRS'', ''CZ_CONFIG_INPUTS'', ''CZ_CONFIG_ITEMS'', ''CZ_CONFIG_MESSAGES'', 
   --''FND_ATTACHED_DOCUMENTS '', ''FND_DOCUMENTS'', ''FND_DOCUMENTS_LONG_RAW'', 
   --''FND_DOCUMENTS_LONG_TEXT'', ''FND_DOCUMENTS_SHORT_TEXT'', ''FND_DOCUMENTS_TL'', ''FND_LOBS'', 
   ''OE_AUDIT_ATTR_HISTORY'', ''OE_BILLING_PLAN_HEADERS_ALL'', ''OE_BILLING_PLAN_LINES_ALL'', ''OE_BILLING_PLAN_USAGE_TIERS'',
   ''OE_DROP_SHIP_SOURCES'', ''OE_HEADER_ACKS'', ''OE_HOLD_RELEASES'', ''OE_HOLD_SOURCES_ALL'', ''OE_LINE_ACKS'',
   ''OE_LINE_SETS'', ''OE_LOT_SERIAL_NUMBERS'', ''OE_ORDER_HEADERS_ALL'', ''OE_ORDER_HEADERS_ALL_EXT_B'', ''OE_ORDER_HEADERS_ALL_EXT_TL'',
   ''OE_ORDER_HEADER_HISTORY'', ''OE_ORDER_HOLDS_ALL'', ''OE_ORDER_LINES_ALL'', ''OE_ORDER_LINES_ALL_EXT_B'', ''OE_ORDER_LINES_ALL_EXT_TL'',
   ''OE_ORDER_LINES_HISTORY'', ''OE_ORDER_PRICE_ATTRIBS'', ''OE_PAYMENTS'', ''OE_PRICE_ADJS_HISTORY'', ''OE_PRICE_ADJUSTMENTS'',
   ''OE_PRICE_ADJ_ASSOCS'', ''OE_PRICE_ADJ_ATTRIBS'', ''OE_PROCESSING_MSGS'', ''OE_PROCESSING_MSGS_TL'', ''OE_SALES_CREDITS'',
   ''OE_SALES_CREDIT_HISTORY'', ''OE_SETS'', ''OE_SETS_HISTORY '' 
   --''WF_COMMENTS'', ''WF_ITEMS'', ''WF_ITEM_ACTIVITY_STATUSES_H'', ''WF_ITEM_ATTRIBUTE_VALUES'', 
   --''WF_ITEM_ACTITY_STATUSES'', ''WF_NOTIFICATIONS'', ''WF_NOTIFICATION_ATTRIBUTES'', ''WF_PROV_REQUESTS''  
   )
 ORDER BY 3 DESC',
      p_title                  => 'Tables Affected by Order Purge Program',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no Tables Affected by Order Purge Program',
      p_solution               => '',
      p_success_msg            => 'List of tables which records can be purged by Order Purge program.<br>
The output sorted by number of records on the table.
<br>
Count: COUNT(*) from the table<br>
Num Rows: Number of rows in the table based on optimizer statistics<br>
Sample Size: Sample size used in analyzing the table<br>
Percent: Sampling Percentage ( Sample Size / Num Rows )<br>
Last Analyzed: Date of the most recent time the table was analyzed<br>
Global Stats: YES if statistics are gathered or incrementally maintained, otherwise it will be NO<br>
User Stats: Indicates whether statistics were entered directly by the user (YES) or not (NO)<br>
Stale Stats: Indicates whether statistics for the object are stale (YES) or not (NO) <br>
<br>
Purging old data creates space in your database and can improve performance of transactions and maintenance. <br>
<br>
Refer to [337467/KB776440] for details on how to purge sales orders records.<br>
and [1586374/KB859100] for best practices for gathering statistics.<br>
',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_PURGE_ELIGIBLE');



debug('begin add_signature: EBS_MFG_OM_PERF_ENABLED_DEBUG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26338',
      p_sig_id                 => 'EBS_MFG_OM_PERF_ENABLED_DEBUG',
      p_sig_sql                => 'SELECT fpot.user_profile_option_name "Profile Name",
       decode(fpo.profile_option_name, 
              ''ACCOUNT_GENERATOR:DEBUG_MODE'', (SELECT meaning FROM fnd_lookups WHERE lookup_type = ''YES_NO'' AND lookup_code = fpov.profile_option_value), 
              ''AFLOG_ENABLED'',   (SELECT meaning FROM fnd_lookups WHERE lookup_type = ''YES_NO'' AND lookup_code = fpov.profile_option_value),
              ...
              ''MSC_ATP_DEBUG'',   (SELECT meaning FROM fnd_lookups WHERE lookup_type = ''MSC_ATP_DEBUG_FLAG_VALUES'' AND lookup_code = fpov.profile_option_value),
              ...
              ''WSH_PROFILER_ENABLED'', (SELECT meaning FROM wsh_lookups WHERE lookup_type = ''WSH_DEBUG_ENABLED'' AND lookup_code = fpov.profile_option_value),
       ...
       decode(fpov.level_id, 
               10001, '''', 
               10002, (select application_short_name from fnd_application where application_id=fpov.level_value), 
               10003, (select responsibility_name from fnd_responsibility_vl where responsibility_id=fpov.level_value), 
               10004, (select rpad(substr(user_name, 1, ceil(length(user_name)*0.25) ), length(user_name), ''*'') from fnd_user where user_id=fpov.level_value)) "Level Value" 
...
WHERE fpov.profile_option_id = fpo.profile_option_id 
  ...
  AND fpo.profile_option_name IN (
        ...
        ''RCV_DEBUG_MODE'', 
        ''WSH_DEBUG_MODE'', 
        ''WSH_PROFILER_ENABLED'' )
  AND ( (fpo.profile_option_name = ''ACCOUNT_GENERATOR:DEBUG_MODE'' and fpov.profile_option_value=''Y'') OR
        (fpo.profile_option_name = ''AFLOG_ENABLED'' and fpov.profile_option_value=''Y'') OR
        (fpo.profile_option_name = ''INV_DEBUG_LEVEL'' and fpov.profile_option_value<>0) OR
        (fpo.profile_option_name = ''INV_DEBUG_TRACE'' and fpov.profile_option_value=1) OR
        (fpo.profile_option_name = ''MRP_DEBUG'' and fpov.profile_option_value=''Y'') OR
        (fpo.profile_option_name = ''MSC_ATP_DEBUG'' and fpov.profile_option_value<>''N'') OR
        (fpo.profile_option_name = ''ONT_DEBUG_LEVEL'' and fpov.profile_option_value<>0) OR
        (fpo.profile_option_name = ''RCV_DEBUG_MODE'' and fpov.profile_option_value=''Y'') OR
        (fpo.profile_option_name = ''WSH_DEBUG_MODE'' and fpov.profile_option_value=''T'') OR
        (fpo.profile_option_name = ''WSH_PROFILER_ENABLED'' and fpov.profile_option_value=''Y'') )
ORDER BY fpo.application_id,
         fpo.profile_option_name, 
         fpov.level_id,
         fpov.level_value
		 ',
      p_title                  => 'Enabled Debug Profile Options',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Debug profile option(s) are enabled which affects system performance.<br>
Make sure to review and set to the appropriate setting.',
      p_solution               => 'Refer to [2703834/KB713784] for details',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_ENABLED_DEBUG');



debug('begin add_signature: EBS_MFG_OM_PERF_AUDIT_TRAIL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26454',
      p_sig_id                 => 'EBS_MFG_OM_PERF_AUDIT_TRAIL',
      p_sig_sql                => 'SELECT oepcc.constraint_id "ID",
       (select entity_display_name from oe_pc_entities_v where entity_id = oepcc.entity_id) "Entity",
       (select meaning from oe_lookups where lookup_type=''PC_OPERATION'' and lookup_code=oepcc.constrained_operation) "Operation",
       oepcc.column_name          "Attribute",
       (select meaning from oe_lookups where lookup_type=''PC_ON_OPERATION_ACTION'' and lookup_code=oepcc.on_operation_action) "User Action",
       oepcc.qualifier_attribute  "Qualifier",
       oepcc.system_flag          "System"
FROM oe_pc_constraints oepcc
WHERE oepcc.enabled_flag = ''Y''
  AND oepcc.on_operation_action <> 0
ORDER BY oepcc.entity_id,
         oepcc.constrained_operation,
         oepcc.column_name',
      p_title                  => 'Enabled Audit Trail',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Enabled Processing Constraints with Audit Trail / Versioning.',
      p_solution               => 'Versioning and Audit Trail affects performance.<br>
Consider limit use and set up processing constraints for specific attribute or phase.<br>
<br>
Refer to [411879/KB342097] for details',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_AUDIT_TRAIL');
...
debug('begin add_signature: EBS_MFG_OM_PRICING_DEBUG_VALUES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27483',
      p_sig_id                 => 'EBS_MFG_OM_PRICING_DEBUG_VALUES',
      p_sig_sql                => 'SELECT fpot.user_profile_option_name "Profile Name",
       decode(fpo.profile_option_name, 
...
FROM   fnd_profile_options_tl fpot,
       ...
       fnd_user fu
WHERE  
      fpo.profile_option_name = ''QP_DEBUG'' 
       AND fpo.profile_option_name = fpot.profile_option_name
       AND fpot.LANGUAGE (+) = ''US''
...
If possible, one should disable these profile options.  Refer to: [1335892/KB713607] - How to Improve Pricing Performance anchor Other_Debug_Profiles',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PRICING_DEBUG_VALUES');
...
debug('begin add_signature: EBS_MFG_OM_PERF_WSH_PURGE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26373',
      p_sig_id                 => 'EBS_MFG_OM_PERF_WSH_PURGE',
      p_sig_sql                => 'SELECT owner "Owner",
       table_name "Table Name",
       to_char(om_perf_analyzer_pkg.tabcount(table_name), ''999,999,999,999'') "Count",
       to_char(num_rows, ''999,999,999,999'') "Num Rows",
       ...
       stale_stats "Stale Stats"
  FROM dba_tab_statistics
 WHERE owner in (''FTE'', ''WSH'')
   AND num_rows > 0
   AND table_name IN ( 
''FTE_DELIVERY_PROOF'', ''FTE_SHIPMENT_STATUS_HEADERS'', ''FTE_FAILURE_REASONS'', ''FTE_INVOICE_LINES'', ''FTE_INVOICE_HISTORY'', 
''FTE_INVOICE_HEADERS'', ''FTE_MESSAGE_ADDRESS'', ''FTE_MESSAGE_CONTACT'', ''FTE_MESSAGE_LOCATION'', ''FTE_MESSAGE_PARTNER'', 
''FTE_MESSAGE_PARTNER'', ''FTE_MESSAGE_CONTACT'', ''FTE_MESSAGE_LOCATION'', ''FTE_SHIPMENT_STATUS_DETAILS'', ''FTE_SHIPMENT_STATUS_DETAILS'', 
''FTE_SHIPMENT_STATUS_EXCEPTIONS'', ''FTE_SHIPMENT_STATUS_EXCEPTIONS'', ''WSH_DELIVERY_ASSIGNMENTS_V'', ''WSH_DELIVERY_DETAILS'', ''WSH_DELIVERY_LEG_DETAILS'', 
''WSH_DELIVERY_LEGS'', ''WSH_DOCUMENT_INSTANCES'', ''WSH_EXCEPTIONS'', ''WSH_EXCEPTIONS'', ''WSH_FREIGHT_COSTS'', 
''WSH_DOCUMENT_INSTANCES'', ''WSH_TRIPS'', ''WSH_EXCEPTIONS'', ''WSH_FREIGHT_COSTS'', ''WSH_TRIP_STOPS'', 
''WSH_EXCEPTIONS'', ''WSH_TRANSACTIONS_HISTORY'', ''WSH_DOCUMENT_INSTANCES'', ''WSH_FREIGHT_COSTS'', ''WSH_FREIGHT_COSTS'', 
''WSH_DOCUMENT_INSTANCES'', ''WSH_DELIVERY_LEG_ACTIVITIES'', ''WSH_FREIGHT_COSTS'', ''WSH_SERIAL_NUMBERS'', ''WSH_EXCEPTIONS'', 
''WSH_INBOUND_TXN_HISTORY'', ''WSH_ITM_RESPONSE_LINES'', ''WSH_ITM_RESPONSE_HEADERS'', ''WSH_ITM_REQUEST_CONTROL'', ''WSH_TRIPS'', 
''WSH_TRIP_STOPS'' )
ORDER BY 3 DESC',
      p_title                  => 'Tables Affected by Shipping Purge Program',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no Tables Affected by Shipping Purge Program',
      p_solution               => '',
      p_success_msg            => 'List of tables which records can be purged by Shipping Purge program.<br>
The output sorted by number of records on the table.<br>
<br>
Count: COUNT(*) from the table<br>
Num Rows: Number of rows in the table based on optimizer statistics<br>
Sample Size: Sample size used in analyzing the table<br>
...
Purging old data creates space in your database and can improve performance of transactions and maintenance. <br>
<br>
Refer to the following documents for details:<br>
[1419324/KB627804] for details on Shipping Purge program.<br>
[1576170/KB626443] on how to purge Shipping Exceptions WSH_EXCEPTIONS.<br>
[1586374/KB859100] for best practices for gathering statistics.<br>
...
',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_WSH_PURGE');



debug('begin add_signature: EBS_MFG_OM_PERF_CZ_PURGE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26383',
      p_sig_id                 => 'EBS_MFG_OM_PERF_CZ_PURGE',
      p_sig_sql                => 'SELECT owner "Owner",
       table_name "Table Name",
       to_char(om_perf_analyzer_pkg.tabcount(table_name), ''999,999,999,999'') "Count",
       to_char(num_rows, ''999,999,999,999'') "Num Rows",
       ...
       stale_stats "Stale Stats"
  FROM dba_tab_statistics
 WHERE owner in (''BOM'', ''CZ'')
   AND num_rows > 0
   AND (table_name like ''CZ_IMP%''
        OR
		table_name IN (
''CZ_ARCHIVES'', ''CZ_ARCHIVE_REFS'', ''CZ_CONFIG_HDRS'', ''CZ_DB_LOGS'', ''CZ_DES_CHART_CELLS'', 
''CZ_DES_CHART_FEATURES'', ''CZ_DEVL_PROJECTS'', ''CZ_EXPRESSION_NODES'', ''CZ_FILTER_SETS'', ''CZ_FUNC_COMP_SPECS'', 
''CZ_JRAD_CHUNKS'', ''CZ_LCE_HEADERS'', ''CZ_LCE_TEXTS'', ''CZ_LOCALIZED_TEXTS'', ''CZ_MODEL_PUBLICATIONS'', 
''CZ_MODEL_REF_EXPLS'', ''CZ_MODEL_USAGES'', ''CZ_MODEL_USAGES_TL'', ''CZ_PB_CLIENT_APPS'', ''CZ_PB_LANGUAGES'', 
''CZ_PB_MODEL_EXPORTS'', ''CZ_POPULATORS'', ''CZ_PS_NODES'', ''CZ_PS_PROP_VALS'', ''CZ_PUBLICATION_USAGES'', 
''CZ_RP_ENTRIES'', ''CZ_RULES'', ''CZ_RULE_FOLDERS'', ''CZ_SIGNATURES'', ''CZ_SIGNATURE_ARGUMENTS'', 
''CZ_UI_ACTIONS'', ''CZ_UI_CONT_TYPE_TEMPLS'', ''CZ_UI_DEFS'', ''CZ_UI_IMAGES'', ''CZ_UI_NODES'', 
''CZ_UI_NODE_PROPS'', ''CZ_UI_PAGES'', ''CZ_UI_PAGE_ELEMENTS'', ''CZ_UI_PAGE_REFS'', ''CZ_UI_PAGE_SETS'', 
''CZ_UI_PROPERTIES'', ''CZ_UI_REFS'', ''CZ_UI_REF_TEMPLATES'', ''CZ_UI_TEMPLATE_ELEMENTS'', ''CZ_XFR_RUN_INFOS'', 
''CZ_XFR_RUN_RESULTS'') )
ORDER BY 3 DESC',
      p_title                  => 'Tables Affected by Configurator Purge Program',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no Tables Affected by Configurator Purge Program.
',
      p_solution               => '',
      p_success_msg            => 'Configurator Tables Which Records Can be Purged.<br>
The output sorted by number of records on the table.<br>
<br>
Count: COUNT(*) from the table<br>
Num Rows: Number of rows in the table based on optimizer statistics<br>
...
<br>
Purging old data creates space in your database and can improve performance of transactions and maintenance. <br>
You can run these programs to purge the records:<br>
Purge Configurator Tables - This program physically removes all logically deleted records in the tables and subschemas of the CZ schema.<br>
Purge Configurator Import Tables - This program deletes data in all CZ_IMP tables and improves import performance.<br>
<br>
Refer to the following documents for details:<br>
[1361542/KB782547] for steps to run Purge programs.<br>
[752322.1] for details on the strategies and approaches for purging and reclaiming space.<br>
[1586374/KB859100] for best practices for gathering statistics.<br>',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_CZ_PURGE');



debug('begin add_signature: CZ1_CZPURGE_PERFORMANCE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8538',
      p_sig_id                 => 'CZ1_CZPURGE_PERFORMANCE',
      p_sig_sql                => 'SELECT value FROM cz_db_settings WHERE setting_id =''BatchSize''',
      p_title                  => 'Configurator Purge Tables Performance Issues',
      p_fail_condition         => '[VALUE] < [300000]',
      p_problem_descr          => 'The value of ''BatchSize'' in CZ_DB_SETTINGS Table is set to less than 300K.<br>
If you are experiencing performance issues when executing the Purge Configurator Tables Concurrent Program, changing this setting could improve performance.
',
      p_solution               => 'See [2319891/KB717679] - How To Improve Performance of the Configurator Purge Tables Concurrent Program for a description of this issue.
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: CZ1_CZPURGE_PERFORMANCE');



debug('begin add_signature: CZ1_BOM_EXPLOSIONS_GENERATE_STATS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8576',
      p_sig_id                 => 'CZ1_BOM_EXPLOSIONS_GENERATE_STATS',
      p_sig_sql                => 'SELECT value FROM cz_db_settings WHERE setting_id =''GenStatisticsBOM''',
      p_title                  => 'Enable Generate Statistics on BOM_EXPLOSIONS Table',
      p_fail_condition         => '[VALUE] =  [N]',
      p_problem_descr          => 'GenStatisticsBOM is set to N (or No). Statistics will not be generated on the BOM_EXPLOSIONS table. <br>
This may have a negative impact on performance.',
      p_solution               => 'See [2387731/KB740815] - How does one improve Configurator performance?<br>
or Oracle Configurator Implementation Guide for a description of the setting GenStatisticsBOM found in the CZ_DB_SETTINGS table. <br>
Setting GenStatisticsBOM to Y (or Yes) forces the optimizer to update the internal statistics on the BOM_EXPLOSIONS table before running queries in the CZ schema. Generating statistics allows the optimizer to choose a better execution plan based on the current data structure in a table.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CZ1_BOM_EXPLOSIONS_GENERATE_STATS');



debug('begin add_signature: CZ1_GENERATE_STATS_ON_CZ_SCHEMA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8577',
      p_sig_id                 => 'CZ1_GENERATE_STATS_ON_CZ_SCHEMA',
      p_sig_sql                => 'SELECT value FROM cz_db_settings WHERE setting_id =''GenStatisticsCZ''',
      p_title                  => 'Enable Generate Statistics on the CZ Schema',
      p_fail_condition         => '[VALUE] =  [N]',
      p_problem_descr          => 'GenStatisticsCZ is set to N (or No). Statistics will not be generated on the CZ Schema. This may have an impact on performance. 
',
      p_solution               => 'Setting  GenStatisticsCZ to Y (or Yes) forces the optimizer to update the internal statistics on the entire CZ Schema before running queries in the CZ schema.<br>
See [2387731/KB740815] - How does one improve Configurator performance? or the Oracle Configurator Implementation Guide for a description of the setting GenStatisticsCZ found in the CZ_DB_SETTINGS table. <br>
Generating statistics allows the optimizer to choose a better execution plan based on the current data structure in a table.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CZ1_GENERATE_STATS_ON_CZ_SCHEMA');



debug('begin add_signature: CZ1_PUBLICATION_PERFORMANCE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8536',
      p_sig_id                 => 'CZ1_PUBLICATION_PERFORMANCE',
      p_sig_sql                => 'SELECT VALUE FROM cz_db_settings where SETTING_ID = ''PublishingCopyRules''',
      p_title                  => 'Publication Performance May Be Improved',
      p_fail_condition         => '[VALUE] = [YES]',
      p_problem_descr          => 'The value of PublishingCopyRules is set to a value of YES. If you are experiencing Publication performance issues, changing this setting to NO could improve performance.
',
      p_solution               => 'See [2319083/KB709177] - How Does One Improve Publication Performance? for a description of this issue.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: CZ1_PUBLICATION_PERFORMANCE');



debug('begin add_signature: CZ1_LOGIC_GENERATION_PERFORMANCE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8537',
      p_sig_id                 => 'CZ1_LOGIC_GENERATION_PERFORMANCE',
      p_sig_sql                => 'select value from cz_db_settings where setting_id = ''GenerateUpdatedOnly'' and section_name = ''LogicGen''',
      p_title                  => 'Logic Generation Performance May Be Improved',
      p_fail_condition         => '[VALUE] = [YES]',
      p_problem_descr          => 'The value of ''GenerateUpdatedOnly'' is set to a value of YES.  If you are experiencing performance issues when generating logic, changing this setting to NO could improve performance.
',
      p_solution               => 'See [727147/KB353571] - When Publishing Models the following is encountered: Failure in resolving REASONID for a description of this and a related issue.
...
',
   ...
   l_info.delete;
debug('end add_signature: CZ1_LOGIC_GENERATION_PERFORMANCE');



debug('begin add_signature: EBS_MFG_OM_PERF_WF_ITEM_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26360',
      p_sig_id                 => 'EBS_MFG_OM_PERF_WF_ITEM_TYPES',
      p_sig_sql                => 'SELECT wit.name "Item Type",
       wtl.display_name "Display Name",
       wtl.description "Description",
       wit.persistence_type "Persistence",
       to_char(wit.persistence_days,''99999'') "Days"
  FROM wf_item_types wit,
       wf_item_types_tl wtl
 WHERE wit.name IN (''OEAME'', ''OEBH'', ''OECHGORD'', ''OECOGS'', ''OENH'',
                    ''OEOA'', ''OEOH'', ''OEOI'', ''OEOL'', ''OMERROR'',
                    ''WSHDEL'', ''WSHSTD'', ''WSHTRIP'')
   AND wtl.name = wit.name
   AND wtl.language = ''US''
 ORDER BY 1
',
      p_title                  => 'Workflow Item Types',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no Workflow Item Types',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_WF_ITEM_TYPES');



debug('begin add_signature: EBS_MFG_OM_PERF_CLOSED_WF_ITEM_TYPE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26362',
      p_sig_id                 => 'EBS_MFG_OM_PERF_CLOSED_WF_ITEM_TYPE',
      p_sig_sql                => 'SELECT wi.item_type "Item Type",
       to_char (COUNT (*), ''999,999,999,999'') "# Closed",
       to_char (wf_purge.getpurgeablecount (wi.item_type), ''999,999,999,999'') "Purgeable",
       to_char (AVG (end_date - begin_date),''99,999'') "Avg Life",
       to_char (STDDEV (end_date - begin_date), ''99,999'') "Std Dev",
       to_char (MIN (end_date - begin_date), ''99,999'') "Min Life",
       to_char (MAX (end_date - begin_date), ''99,999'') "Max Life",
       case 
        when wf_purge.getpurgeablecount (wi.item_type) > 0 then ''Helpful''
        else NULL
       end as "Run Purge OM WF"
  FROM wf_items wi,
       wf_item_types wit
 WHERE wi.end_date IS NOT NULL
   AND wit.name = wi.item_type
   AND wi.item_type IN (''OEAME'', ''OEBH'', ''OECHGORD'', ''OECOGS'', ''OENH'',
                        ''OEOA'', ''OEOH'', ''OEOI'', ''OEOL'', ''OMERROR'')
 GROUP BY wi.item_type
 ORDER BY 1',
      p_title                  => 'Closed Workflow Item Types',
      p_fail_condition         => '[Run Purge OM WF] = [Helpful]',
      p_problem_descr          => 'Order Management Closed Workflow Item Types that may need to be purged.',
      p_solution               => 'Refer to [878032/KB626917] for details on how to Purge Order Management Workflow.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_CLOSED_WF_ITEM_TYPE');



debug('begin add_signature: EBS_MFG_OM_PERF_ALL_WF_ITEMS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26363',
      p_sig_id                 => 'EBS_MFG_OM_PERF_ALL_WF_ITEMS',
      p_sig_sql                => 'SELECT wi.item_type "Item Type",
       to_char(COUNT (*), ''999,999,999,999'') "# Records",
       to_char(AVG (end_date - begin_date), ''99,999'') "Avg Life",
       to_char(STDDEV (end_date - begin_date), ''99,999'') "Std Dev",
       to_char(MIN (end_date - begin_date), ''99,999'') "Min Life",
       to_char(MAX (end_date - begin_date), ''99,999'') "Max Life"
 ...
 GROUP BY wi.item_type
 ORDER BY 1',
      p_title                  => 'Open and Closed Workflow Items',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no Open and Closed Workflow Items',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_ALL_WF_ITEMS');



debug('begin add_signature: EBS_MFG_OM_PERF_CLOSED_WF_ACTIVITY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26364',
      p_sig_id                 => 'EBS_MFG_OM_PERF_CLOSED_WF_ACTIVITY',
      p_sig_sql                => 'SELECT sta.item_type "Item Type",
       to_char(COUNT (*), ''999,999,999,999'') "# Closed"
 ...
 WHERE sta.item_type = wfi.item_type
   ...
   AND wfi.item_type IN (''OEAME'', ''OEBH'', ''OECHGORD'', ''OECOGS'', ''OENH'',
                         ''OEOA'', ''OEOH'', ''OEOI'', ''OEOL'', ''OMERROR'')
 GROUP BY sta.item_type
 ORDER BY 1',
      p_title                  => 'Closed Workflow Activity Statuses ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no Closed Workflow Activity Statuses ',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_CLOSED_WF_ACTIVITY');



debug('begin add_signature: EBS_MFG_OM_PERF_ALL_WF_ACTIVITY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26365',
      p_sig_id                 => 'EBS_MFG_OM_PERF_ALL_WF_ACTIVITY',
      p_sig_sql                => 'SELECT sta.item_type "Item Type",
       to_char(COUNT (*), ''999,999,999,999'') "# Records"
  FROM wf_item_activity_statuses sta,
       wf_items wfi
 ...
 GROUP BY sta.item_type
 ORDER BY 1',
      p_title                  => 'Open and Closed Activity Statuses',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no Open and Closed Activity Statuses',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_ALL_WF_ACTIVITY');



debug('begin add_signature: EBS_MFG_OM_PERF_WF_LARGE_ACTIVITY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26366',
      p_sig_id                 => 'EBS_MFG_OM_PERF_WF_LARGE_ACTIVITY',
      p_sig_sql                => 'SELECT *
  FROM (SELECT sta.item_type "Item Type",
               sta.item_key "Item Key",
               to_char(COUNT (*), ''999,999,999,999'') "# Records",
               wfi.begin_date "Begin Date",
               wfi.end_date "End Date"
        FROM wf_item_activity_statuses sta,
             wf_items wfi
        WHERE sta.item_type = wfi.item_type
          AND sta.item_key = wfi.item_key
 ...
 WHERE ROWNUM <= 20',
      p_title                  => 'Large Activity Status Item Keys',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no Large Activity Status Item Keys',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_WF_LARGE_ACTIVITY');



debug('begin add_signature: EBS_MFG_OM_PERF_WF_CLOSED_ACTIVITY_HIST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26367',
      p_sig_id                 => 'EBS_MFG_OM_PERF_WF_CLOSED_ACTIVITY_HIST',
      p_sig_sql                => 'SELECT sta.item_type "Item Type",
       to_char (COUNT (*), ''999,999,999,999'') "# Records"
 ...
 GROUP BY sta.item_type
 ORDER BY 1',
      p_title                  => 'Closed Activity History Statuses ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no Closed Activity History Statuses.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_WF_CLOSED_ACTIVITY_HIST');



debug('begin add_signature: EBS_MFG_OM_PERF_WF_LARGE_ACTIVITY_HIST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26368',
      p_sig_id                 => 'EBS_MFG_OM_PERF_WF_LARGE_ACTIVITY_HIST',
      p_sig_sql                => 'SELECT *
  FROM (SELECT sta.item_type "Item Type",
               sta.item_key "Item Key",
               to_char(COUNT (*), ''999,999,999,999'') "# Records",
 ...
 WHERE ROWNUM <= 20 
',
      p_title                  => 'Large Activity History Status Item Keys',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no Large Activity History Status Item Keys',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_WF_LARGE_ACTIVITY_HIST');



debug('begin add_signature: EBS_MFG_OM_PERF_WF_NOTIF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26369',
      p_sig_id                 => 'EBS_MFG_OM_PERF_WF_NOTIF',
      p_sig_sql                => 'SELECT wn.message_type "Item Type",
       to_char(COUNT (*), ''999,999,999,999'') "# Records"
  FROM wf_notifications wn
 WHERE wn.message_type LIKE ''OE%''
 GROUP BY wn.message_type
 ORDER BY 1',
      p_title                  => 'Notification Totals',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no Notification Totals',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_WF_NOTIF');



debug('begin add_signature: EBS_MFG_OM_PERF_CLOSED_WF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26336',
      p_sig_id                 => 'EBS_MFG_OM_PERF_CLOSED_WF',
      p_sig_sql                => 'SELECT wi.item_type "Item Type",
       witt.display_name "Item Name",
       to_char(wi.end_date, ''YYYY'') "Closed in Year",       
       to_char(count(*), ''999,999,999,999'') "# Records",
    case 
        when to_char(wi.end_date, ''YYYY'') < to_char(sysdate, ''YYYY'') then ''Prior Year'' 
        else ''Current Year''
    end as "Closed In"
  FROM wf_items wi,
       wf_item_types_tl witt
 WHERE witt.name=wi.item_type
   and witt.language=''US''
   and wi.end_date IS NOT NULL
   AND wi.item_type IN ( ''OEOH'', ''OEOL'', ''OENH'', ''OEBH'', ''OMERROR'', ''OEAME'' )
 GROUP BY item_type,
          witt.display_name,
          to_char(wi.end_date, ''YYYY'')
ORDER BY 1,3
',
      p_title                  => 'Closed Order Management Workflow',
      p_fail_condition         => '[Closed In] = [Prior Year]',
      p_problem_descr          => 'List of closed Order Management workflow which can be purged.<br>
The highlighted rows are closed in prior years.


',
      p_solution               => 'Refer to [878032/KB626917] for details on how to purge closed workflows specific to Order Management. ',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_CLOSED_WF');



debug('begin add_signature: EBS_MFG_OM_PERF_WF_NOTIF_UNREF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26370',
      p_sig_id                 => 'EBS_MFG_OM_PERF_WF_NOTIF_UNREF',
      p_sig_sql                => 'SELECT wn.message_type "Item Type",
       to_char(COUNT (*), ''999,999,999,999'') "# Records",
       ''N'' "History"
  FROM wf_notifications wn
 ...
 GROUP BY wn.message_type
UNION ALL
SELECT wn.message_type "Item Type",
       to_char(COUNT (*), ''999,999,999,999'') "# Records",
       ''Y'' "History"
  FROM wf_notifications wn
 WHERE wn.message_type LIKE ''OE%''
 ...
 GROUP BY wn.message_type
 ORDER BY 1,3',
      p_title                  => 'Unreferenced Notifications',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Order Management Unreferenced Notifications that may need purging.',
      p_solution               => 'Review [2378812/KB755866] on how to purge orphan notifications.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_WF_NOTIF_UNREF');



debug('begin add_signature: EBS_MFG_OM_PERF_LOOPING_WF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26337',
      p_sig_id                 => 'EBS_MFG_OM_PERF_LOOPING_WF',
      p_sig_sql                => 'SELECT sta.item_type "Item Type",
       sta.item_key "Item Key",
       to_char (COUNT (*), ''999,999,999,999'') "Count",
       to_char (wfi.begin_date, ''YYYY-MM-DD'') "Opened Date",
       to_char (wfi.end_date, ''YYYY-MM-DD'') "Closed Date",
       wfi.user_key "Description"
  FROM wf_item_activity_statuses_h sta,
       wf_items wfi
 WHERE sta.item_type = wfi.item_type
   AND sta.item_key = wfi.item_key
   AND wfi.item_type IN ( ''OEOH'', ''OEOL'', ''OENH'', ''OEBH'', ''OEAME'', ''OEOI'', ''OECOGS'', ''OEOA'', ''OECHGORD'')
 GROUP BY sta.item_type,
          sta.item_key,
          wfi.user_key,
          wfi.begin_date,
...
HAVING COUNT (*) > 500
 ORDER BY COUNT (*) DESC
',
      p_title                  => 'Excessive Looping Order Management Workflow Activities',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Excessive Looping Order Management Workflow Activities',
      p_solution               => 'Refer to [402144/FAQ5963] on how to avoid Infinite loop',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_LOOPING_WF');



debug('begin add_signature: EBS_MFG_OM_ONT_PERF_ORPHAN_NOTIF_CLOSED_SO_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28455',
      p_sig_id                 => 'EBS_MFG_OM_ONT_PERF_ORPHAN_NOTIF_CLOSED_SO_LINES',
      p_sig_sql                => 'SELECT
    ooh.order_number "Order Number",
    ooh.flow_status_code   "Order Status",
    ooh.header_id "Header Id",
    ol.line_number "SO Line Num",       
    ol.line_id "Line Id",
    ol.flow_status_code    "Line Status",
    itm.item_type "WF Item Type",
    count(1)
FROM
    wf_item_activity_statuses   act,
    wf_notifications            n,
    wf_items                    itm,
    oe_order_lines_all          ol,
    oe_order_headers_all        ooh
WHERE
    act.notification_id = n.notification_id
    AND n.status = ''OPEN''
    AND act.item_type = itm.item_type
    AND act.item_key = itm.item_key
    AND act.item_type = ''OMERROR''
    AND itm.item_type = ''OMERROR''
    AND itm.parent_item_type = ''OEOL''
    AND itm.parent_item_key = ol.line_id
    AND ol.open_flag = ''N''
    ...
    AND EXISTS (
        ...
        WHERE
            wf.item_type = ''OEOL''
            AND wf.item_key = to_char(ol.line_id)
...
group by 
    ...
    ol.flow_status_code   ,
    itm.item_type',
      p_title                  => 'Orphaned OMERROR Notifications Present for Closed Sales Order Lines ',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are Order Management OMERROR Notifications Present for Closed Sales Order Lines. It might Cause Performance Issues.',
      p_solution               => 'Refer to [2681584/KB606584] for details.',
      p_success_msg            => 'There are Orphan OMERROR Notifications Associated with Closed Order Lines.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_ONT_PERF_ORPHAN_NOTIF_CLOSED_SO_LINES');
...
debug('begin add_signature: EBS_MFG_OM_PERF_DB_PARAM');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26443',
      p_sig_id                 => 'EBS_MFG_OM_PERF_DB_PARAM',
      p_sig_sql                => 'SELECT ''Common'' "Parameter Type",
       name "Name",
       substr(value, 1, 30) "Value"
  FROM v$parameter
 WHERE name IN ( ''cpu_count'', ''db_block_size'', ''audit_trail'', ''plsql_code_type'', ''processes'',
                 ''sessions'', ''db_files'', ''dml_locks'', ''cursor_sharing'', ''open_cursors'',
                 ''session_cached_cursors'', ''sga_target'', ''db_block_checking'', ''db_block_checksum'', ''shared_pool_size'',
                 ''shared_pool_reserved_size'', ''aq_tm_processes'', ''job_queue_processes'', ''_sort_elimination_cost_ratio'', ''_like_with_bind_as_equality'',
                 ''_fast_full_scan_enabled'', ''_b_tree_bitmap_plans'', ''optimizer_secure_view_merging'', ''_optimizer_autostats_job'', ''parallel_max_servers'',
                 ''parallel_min_servers'', ''parallel_degree_policy'', ''parallel_force_local'', ''cluster_database'', ''pga_aggregate_target'',
                 ''workarea_size_policy'', ''filesystemio_options'' )
UNION ALL
SELECT ''Release Specific'' "Parameter Type",
       name "Name",
       substr(value, 1, 30) "Value"
  FROM v$parameter
 WHERE name IN ( ''olap_page_pool_size'', ''optimizer_adaptive_features'', ''pga_aggregate_limit'', ''temp_undo_enabled'',
                 ''optimizer_adaptive_plans'', ''optimizer_adaptive_statistics'', ''_pdb_name_case_sensitive'',
                 ''_optimizer_gather_stats_on_conventional_dml'', ''_optimizer_use_stats_on_conventional_dml'', ''optimizer_real_time_statistics'')
UNION ALL
...
SELECT ''Release Specific'' "Parameter Type",
  ...
  FROM v$parameter
 WHERE name = ''event''
   AND value LIKE ''10946%''
UNION ALL
SELECT ''Additional'' "Parameter Type",
       name "Name",
       substr(value, 1, 30) "Value"
  FROM v$parameter
 WHERE name IN ( ''result_cache_max_size'' )
 ',
      p_title                  => 'Database Performance Parameters',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no Database Performance Parameters.',
      p_solution               => '',
      p_success_msg            => 'List of Oracle Database initialization parameters for use with Oracle E-Business Suite (EBS) Release 12<br>
For details refer to [396009.1]',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_DB_PARAM');



debug('begin add_signature: EBS_MFG_OM_PERF_DB_CBO_STATS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26318',
      p_sig_id                 => 'EBS_MFG_OM_PERF_DB_CBO_STATS',
      p_sig_sql                => 'SELECT
   owner  ,
...
FROM (
   SELECT owner, 
          COUNT(last_analyzed) tlann, 
          ROUND(AVG(SYSDATE - last_analyzed)) taa, 
          SUM(DECODE(last_analyzed, NULL, 1, 0)) tlan,
          0 ilann, 
          0 iaa, 
          0 ilan
   FROM dba_tables
   WHERE owner IN (''ONT'', ''QP'', ''WSH'', ''CZ'')
   GROUP BY owner
     UNION ALL
   SELECT owner, 
          0 tlann, 
...
For more information, please review Troubleshooting Oracle Applications Performance Issues [169935/KB711566].',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_DB_CBO_STATS');
...
debug('begin add_signature: EBS_MFG_OM_PERF_DB_10_PERCENT_MODIFIED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26317',
      p_sig_id                 => 'EBS_MFG_OM_PERF_DB_10_PERCENT_MODIFIED',
      p_sig_sql                => 'SELECT table_owner "Table Owner",
       ''<NSG_table_'' ||ROWNUM ||''>'' || table_name "Table Name",
       partition_name,
       "Number of DMLs",
       "Total Number of Rows"
  FROM (SELECT dtm.table_owner,
               dtm.table_name,
               dtm.partition_name,
       ...
       WHERE dt.owner = dtm.table_owner
         ...
         AND table_owner IN (''ONT'', ''QP'', ''WSH'', ''CZ'')
...
',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_DB_10_PERCENT_MODIFIED');
...
debug('begin add_signature: OM_DEBUG_PROFILES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15473',
      p_sig_id                 => 'OM_DEBUG_PROFILES',
      p_sig_sql                => 'SELECT fpot.user_profile_option_name "Profile Name",
       decode(fpo.profile_option_name, 
              ''QP_DEBUG'',        (SELECT meaning FROM qp_lookups  WHERE lookup_type = ''QP_REQUEST_VIEWER_OPTIONS'' AND lookup_code = fpov.profile_option_value),
              ''WSH_DEBUG_MODE'',  (SELECT meaning FROM wsh_lookups WHERE lookup_type = ''WSH_DEBUG_ENABLED'' AND lookup_code = fpov.profile_option_value),
       ...
       decode(fpov.level_id, 
               ...
               10002, (select application_short_name from fnd_application where application_id=fpov.level_value), 
               10003, (select responsibility_name from fnd_responsibility_vl where responsibility_id=fpov.level_value), 
               10004, (select user_name from fnd_user where user_id=fpov.level_value)) "Level Value" 
FROM   fnd_profile_option_values fpov,
       fnd_profile_options fpo,
       fnd_profile_options_tl fpot
WHERE fpov.profile_option_id = fpo.profile_option_id 
  ...
  AND fpot.language = ''US''
  AND fpo.profile_option_name IN (
        ''OE_DEBUG_LOG_DIRECTORY'', ''ONT_DEBUG_LEVEL'', 
        ''QP_DEBUG'',
        ''WSH_DEBUG_FILE_PREFIX'', ''WSH_DEBUG_LEVEL'', ''WSH_DEBUG_LOG_DIRECTORY'', ''WSH_DEBUG_MODE'', ''WSH_DEBUG_MODULE'',
        ''INV_DEBUG_FILE'', ''INV_DEBUG_LEVEL'', ''INV_DEBUG_TRACE'' )
ORDER BY fpo.application_id,
         fpo.profile_option_name, 
         fpov.level_id,
         fpov.level_value',
      p_title                  => 'Order Management Debug Profile Options Values',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no order management debug profile options values.',
      p_solution               => 'You may review [121054/KB627730] to generate a debug file in OM for assistance.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: OM_DEBUG_PROFILES');



debug('begin add_signature: OM_UTLFILEDIR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15979',
      p_sig_id                 => 'OM_UTLFILEDIR',
      p_sig_sql                => 'SELECT name "Parameter",
       value "Value"
  FROM v$parameter2
 WHERE name = ''utl_file_dir''
UNION ALL
SELECT directory_name "Parameter",
       directory_path "Directory Path"
  FROM all_directories
 WHERE directory_name LIKE ''EBS_UTL_FILE_DIR%''
ORDER BY 1
',
      p_title                  => 'UTL_FILE_DIR Directories',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no UTL_FILE_DIR directories',
      p_solution               => 'Shows directories set in UTL_FILE_DIR Database Initialization Parameter and Directory objects.<br>
Refer to [11156165/KA987] to set up UTL_FILE_DIR or Database Directories ',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: OM_UTLFILEDIR');
...
debug('begin add_signature: EBS_MFG_OM_AC_PROFILE_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27986',
      p_sig_id                 => 'EBS_MFG_OM_AC_PROFILE_OPTIONS',
      ...
      WHERE b.application_id in (##$$APPS_PARAM1$$##,##$$APPS_PARAM2$$##,##$$APPS_PARAM3$$##,##$$APPS_PARAM4$$##,##$$APPS_PARAM5$$##)
        ...
        AND tl.language = ''US''',
      p_title                  => 'OM Suite Profile Options',
      p_fail_condition         => 'RS',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_AC_PROFILE_OPTIONS');
...
debug('begin add_signature: EBS_MFG_OM_AC_FILE_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24513',
      p_sig_id                 => 'EBS_MFG_OM_AC_FILE_VERSIONS',
...
order by 1',
      p_title                  => 'OM Suite File Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => '  ',
      p_solution               => '',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_AC_FILE_VERSIONS');



debug('begin add_signature: EBS_MFG_OM_ONT_ONTONESO_WF_VER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26033',
      p_sig_id                 => 'EBS_MFG_OM_ONT_ONTONESO_WF_VER',
      p_sig_sql                => 'SELECT us.name "Package Name",
       us.type "Type",
       substr(ltrim(rtrim(substr(substr(us.text, instr(us.text,''Header: '')),
                                    instr(substr(us.text, instr(us.text,''Header: '')), '' '', 1, 1),
                                    instr(substr(us.text, instr(us.text,''Header: '')), '' '', 1, 2) -
                                    instr(substr(us.text, instr(us.text,''Header: '')), '' '', 1, 1) ))), 1, 25) "File Name",
       substr(ltrim(rtrim(substr(substr(us.text, instr(us.text,''Header: '')),
                                    instr(substr(us.text, instr(us.text,''Header: '')), '' '', 1, 2),
                                    instr(substr(us.text, instr(us.text,''Header: '')), '' '', 1, 3) -
                                    instr(substr(us.text, instr(us.text,''Header: '')), '' '', 1, 2) ))), 1, 30) "File Version",
       uo.status "Status"
  FROM user_source us,
       user_objects uo
 WHERE us.name = uo.object_name
   ...
   AND (us.name LIKE ''WF%''
        OR us.name LIKE ''ECX%''
        OR us.name LIKE ''FND_SVC_%'')
   AND us.type IN (''PACKAGE'', ''PACKAGE BODY'')
   AND us.text LIKE ''%$Header%''
 ORDER BY 1, 2
',
      p_title                  => 'Workflow Packages',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no workflow package.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_ONT_ONTONESO_WF_VER');
...
debug('begin add_signature: EBS_MFG_OM_SEQUENCE_THRESHOLD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27399',
      p_sig_id                 => 'EBS_MFG_OM_SEQUENCE_THRESHOLD',
      p_sig_sql                => 'SELECT sequence_owner "Owner",
       sequence_name "Name",
       cycle_flag "Cycle Flag",
       last_number "Last Number",
  ...
  FROM dba_sequences
 WHERE sequence_owner IN (''ONT'', ''WSH'', ''INV'', ''PO'', ''WMS'', ''QP'',''BOM'')
   AND last_number between ( 2147483647 * .7) and 2147483647
 ORDER BY 5 DESC, 2',
      p_title                  => 'ONT WSH QP INV PO WMS BOM Thresholds',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Highlighted lines are getting close (=>70%) to the database max threshold.<br>
If assistance is needed, log an SR with Sequence Owner product. 


',
      p_solution               => 'Refer to [2253727/KB750996] for details.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_SEQUENCE_THRESHOLD');
...
debug('begin add_signature: EBS_MFG_OM_PERF_WSHFSTRX_TAB');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26376',
      p_sig_id                 => 'EBS_MFG_OM_PERF_WSHFSTRX_TAB',
      p_sig_sql                => 'SELECT "Filename",
       "Current Version",
       "Fixed Version"
  FROM ((SELECT af1.filename "Filename",
                afv1.version "Current Version",
                ''120.0.12020000.18'' "Fixed Version",
                RANK ()
                OVER (PARTITION BY af1.filename
                      ORDER BY afv1.version_segment1 DESC, afv1.version_segment2 DESC, afv1.version_segment3 DESC, 
                               afv1.version_segment4 DESC, afv1.version_segment5 DESC, afv1.version_segment6 DESC, 
                               afv1.version_segment7 DESC, afv1.version_segment8 DESC, afv1.version_segment9 DESC, 
                               afv1.version_segment10 DESC, afv1.translation_level DESC) AS rankus
                FROM ad_files af1,
                     ad_file_versions afv1
        WHERE af1.file_id = afv1.file_id
          AND af1.filename = ''WSHYMSIB.pls'' ))
 WHERE rankus = 1
   AND (fnd_irep_loader_private.compare_versions ("Current Version", "Fixed Version") = ''<'')         ',
      p_title                  => 'Performance issue in Shipping Transactions Form when an Order is queried and clicked on Delivery/Trip/Stop tabs',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Performance issue in Shipping Transactions Form when an Order is queried and clicked on Delivery/Trip/Stop tabs',
      p_solution               => 'Because you have a lower version of WSH_YMS_INTEGRATION_PVT package body you will experience this performance issue.<br>
Refer to [2175181/KB726371] for details to apply patch {24348694}',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_WSHFSTRX_TAB');



debug('begin add_signature: EBS_MFG_OM_PERF_WSHFSTRX_SHIP_TO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26377',
      p_sig_id                 => 'EBS_MFG_OM_PERF_WSHFSTRX_SHIP_TO',
      p_sig_sql                => 'SELECT "Filename",
       "Current Version",
       "Fixed Version"
  FROM ((SELECT af1.filename "Filename",
                afv1.version "Current Version",
                ''120.83.12020000.64'' "Fixed Version",
                RANK ()
                OVER (PARTITION BY af1.filename
                      ORDER BY afv1.version_segment1 DESC, afv1.version_segment2 DESC, afv1.version_segment3 DESC, 
                               afv1.version_segment4 DESC, afv1.version_segment5 DESC, afv1.version_segment6 DESC, 
...
SELECT "Filename",
  ...
  FROM ((SELECT af1.filename "Filename",
                afv1.version "Current Version",
                ''120.35.12020000.31'' "Fixed Version",
                RANK ()
                OVER (PARTITION BY af1.filename
                      ORDER BY afv1.version_segment1 DESC, afv1.version_segment2 DESC, afv1.version_segment3 DESC, 
                               afv1.version_segment4 DESC, afv1.version_segment5 DESC, afv1.version_segment6 DESC, 
...
SELECT "Filename",
  ...
  FROM ((SELECT af1.filename "Filename",
                afv1.version "Current Version",
                ''120.162.12020000.102'' "Fixed Version",
                RANK ()
                OVER (PARTITION BY af1.filename
                      ORDER BY afv1.version_segment1 DESC, afv1.version_segment2 DESC, afv1.version_segment3 DESC, 
                               afv1.version_segment4 DESC, afv1.version_segment5 DESC, afv1.version_segment6 DESC, 
                ...
                FROM ad_files af1,
                     ad_file_versions afv1
        WHERE af1.file_id = afv1.file_id
          AND af1.filename = ''WSHSTREF.fmb'' ))
 WHERE rankus = 1
   AND (fnd_irep_loader_private.compare_versions ("Current Version", "Fixed Version") = ''<'')            ',
      p_title                  => 'Performance Issue in Shipping Transaction form',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Performance Issue in Shipping Transaction form.
',
      p_solution               => 'You have lower version of <br>
WSHFSTRX.fmb<br>
WSHQSSUI.fmb<br>
WSHSTREF.fmb<br>
<br>
Refer to [2945652/KB777659] for details to apply patch {35142043}<br>
<br>
This Patch includes fix in:<br>
{34780454} Performance is poor when placing a cursor in "Consignee" field in Query Manager of Shipping Transactions form<br>
{34391414} Poor Performance on Quick Ship form while select Order Number from LOV<br>
{34361203} Performance issue in Shipping Transactions Form while selecting multiple delivery details records<br>
{34344097} POOR PERFORMANCE QUERYING BY ITEM NUMBER IN SHIPPING TRANSACTION FORM<br>
{33269755} PERFORMANCE ISSUE IN ORDER NUMBER FIELD IN STF AFTER OPERTING UNIT ER<br>
{32352987} DEV : 12211 PERFORMANCE ISSUE FOR FEW LOV QUERIES IN SHIPPING TRANSACTION FORM AND RELEASE SALES ORDER FORM<br>
{20613927} Performance issue when trying to query for customer in consignee field in Query Manager Window in Shipping Transactions Form<br>
{17282998} Performance issue in LOV of ''Pick Release Batch'' field in Query Window of Shipping Transactions Form<br>
{16026796} Shipping Transactions Form Performance is slow when querying with "From Initial Pickup Date" and "To Initial Pickup Date" parameters<br>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_WSHFSTRX_SHIP_TO');



debug('begin add_signature: EBS_MFG_OM_PERF_WSH_DELIVERIES_PUB');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26378',
      p_sig_id                 => 'EBS_MFG_OM_PERF_WSH_DELIVERIES_PUB',
      p_sig_sql                => 'SELECT "Filename",
       "Current Version",
       "Fixed Version"
  FROM ((SELECT af1.filename "Filename",
                afv1.version "Current Version",
                ''120.35.12020000.20'' "Fixed Version",
                RANK ()
                OVER (PARTITION BY af1.filename
                      ORDER BY afv1.version_segment1 DESC, afv1.version_segment2 DESC, afv1.version_segment3 DESC, 
                               afv1.version_segment4 DESC, afv1.version_segment5 DESC, afv1.version_segment6 DESC, 
                ...
                FROM ad_files af1,
                     ad_file_versions afv1
        WHERE af1.file_id = afv1.file_id
          AND af1.filename = ''WSHDEVLB.pls'' ))
 WHERE rankus = 1
   AND (fnd_irep_loader_private.compare_versions ("Current Version", "Fixed Version") = ''<'')         ',
      p_title                  => 'Public API WSH_DELIVERIES_PUB.DELIVERY_ACTION is having performance issue when called for Ship confirm action',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Public API WSH_DELIVERIES_PUB.DELIVERY_ACTION is having performance issue when called for Ship confirm action.',
      p_solution               => 'Because you have a lower version of WSH_DELIVERY_VALIDATIONS package body you will experience this performance issue.<br>
Refer to [2473042/KB766374] for details to apply patch {31107466}',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_WSH_DELIVERIES_PUB');



debug('begin add_signature: EBS_MFG_OM_PERF_WSHTAB');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26379',
      p_sig_id                 => 'EBS_MFG_OM_PERF_WSHTAB',
      p_sig_sql                => 'SELECT "Filename",
       "Current Version",
       "Fixed Version"
  FROM ((SELECT af1.filename "Filename",
                afv1.version "Current Version",
                ''120.29.12020000.35'' "Fixed Version",
                RANK ()
                OVER (PARTITION BY af1.filename
                      ORDER BY afv1.version_segment1 DESC, afv1.version_segment2 DESC, afv1.version_segment3 DESC, 
                               afv1.version_segment4 DESC, afv1.version_segment5 DESC, afv1.version_segment6 DESC, 
                ...
                FROM ad_files af1,
                     ad_file_versions afv1
        WHERE af1.file_id = afv1.file_id
          AND af1.filename = ''wshtab.odf'' ))
 WHERE rankus = 1
   AND (fnd_irep_loader_private.compare_versions ("Current Version", "Fixed Version") = ''<'')         
',
      p_title                  => 'Shipping transaction form has performance issue while searching by delivery',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Shipping transaction form has performance issue while searching by delivery',
      p_solution               => 'You have lower version of wshtab.odf.<br>
Refer to [2637987/KB752584] for details to apply patch {30958789}',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_WSHTAB');



debug('begin add_signature: EBS_MFG_OM_PERF_DELIVERY_TAB');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26380',
      p_sig_id                 => 'EBS_MFG_OM_PERF_DELIVERY_TAB',
      p_sig_sql                => 'SELECT "Filename",
       "Current Version",
       "Fixed Version"
  FROM ((SELECT af1.filename "Filename",
                afv1.version "Current Version",
                ''120.5.12020000.4'' "Fixed Version",
                RANK ()
                OVER (PARTITION BY af1.filename
                      ORDER BY afv1.version_segment1 DESC, afv1.version_segment2 DESC, afv1.version_segment3 DESC, 
                               afv1.version_segment4 DESC, afv1.version_segment5 DESC, afv1.version_segment6 DESC, 
                ...
                FROM ad_files af1,
                     ad_file_versions afv1
        WHERE af1.file_id = afv1.file_id
          AND af1.filename = ''WSHXCPGB.pls'' ))
 WHERE rankus = 1
   AND (fnd_irep_loader_private.compare_versions ("Current Version", "Fixed Version") = ''<'')         ',
      p_title                  => 'Performance issue while opening Delivery tab on Shipping Transaction Form',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Performance issue while opening Delivery tab on Shipping Transaction Form',
      p_solution               => 'Because you have a lower version of WSH_EXCEPTIONS_GRP package body you will experience this performance issue.<br>
Refer to [2692991/KB782497] for details to apply patch {30770268}',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_DELIVERY_TAB');



debug('begin add_signature: EBS_MFG_OM_PERF_WSH_PR_CRITERIA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26381',
      p_sig_id                 => 'EBS_MFG_OM_PERF_WSH_PR_CRITERIA',
      p_sig_sql                => 'SELECT "Filename",
       "Current Version",
       "Fixed Version"
  FROM ((SELECT af1.filename "Filename",
                afv1.version "Current Version",
                ''120.26.12020000.10'' "Fixed Version",
                RANK ()
                OVER (PARTITION BY af1.filename
                      ORDER BY afv1.version_segment1 DESC, afv1.version_segment2 DESC, afv1.version_segment3 DESC, 
                               afv1.version_segment4 DESC, afv1.version_segment5 DESC, afv1.version_segment6 DESC, 
                ...
                FROM ad_files af1,
                     ad_file_versions afv1
        WHERE af1.file_id = afv1.file_id
          AND af1.filename = ''WSHPRCRB.pls'' ))
 WHERE rankus = 1
   AND (fnd_irep_loader_private.compare_versions ("Current Version", "Fixed Version") = ''<'')         ',
      p_title                  => 'Pick List Generation Program Runs for a Long Time unless Statistics Gathered on WSH_DELIVERY_DETAILS',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Pick Release program has performance issue unless stats are gathered on WSH_DELIVERY_DETAILS table (or) if no organization is selected in ''Change Organization'' form.',
      p_solution               => 'Because you have a lower version of WSH_PR_CRITERIA package body you will experience this performance issue.<br>
Refer to [2535238/KB778066] for details to apply patch {28937301}',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_WSH_PR_CRITERIA');



debug('begin add_signature: EBS_MFG_OM_PERF_OE_ADV_PRICE_PVT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26382',
      p_sig_id                 => 'EBS_MFG_OM_PERF_OE_ADV_PRICE_PVT',
      p_sig_sql                => 'SELECT "Filename",
       "Current Version",
       "Fixed Version"
  FROM ((SELECT af1.filename "Filename",
                afv1.version "Current Version",
                ''120.16.12020000.18'' "Fixed Version",
                RANK ()
                OVER (PARTITION BY af1.filename
                      ORDER BY afv1.version_segment1 DESC, afv1.version_segment2 DESC, afv1.version_segment3 DESC, 
                               afv1.version_segment4 DESC, afv1.version_segment5 DESC, afv1.version_segment6 DESC, 
...
SELECT "Filename",
  ...
  FROM ((SELECT af1.filename "Filename",
                afv1.version "Current Version",
                ''120.48.12020000.16'' "Fixed Version",
                RANK ()
                OVER (PARTITION BY af1.filename
                      ORDER BY afv1.version_segment1 DESC, afv1.version_segment2 DESC, afv1.version_segment3 DESC, 
                               afv1.version_segment4 DESC, afv1.version_segment5 DESC, afv1.version_segment6 DESC, 
                ...
                FROM ad_files af1,
                     ad_file_versions afv1
        WHERE af1.file_id = afv1.file_id
          AND af1.filename = ''OEXVOPRB.pls'' ))
 WHERE rankus = 1
   AND (fnd_irep_loader_private.compare_versions ("Current Version", "Fixed Version") = ''<'')     ',
      p_title                  => 'Interface Trip Stop Process Running Long For Large Deliveries',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Interface Trip Stop Process Running Long For Large Deliveries',
      p_solution               => 'Because you have a lower version of OE_ADV_PRICE_PVT package body you will experience this performance issue.<br>
Refer to [1988388/KB748511] for details to apply patch {20246697}',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_OE_ADV_PRICE_PVT');



debug('begin add_signature: EBS_MFG_OM_PERF_FND_GRANTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26348',
      p_sig_id                 => 'EBS_MFG_OM_PERF_FND_GRANTS',
      p_sig_sql                => 'SELECT "Filename",
       "Current Version",
       "Fixed Version"
  FROM ((SELECT af1.filename "Filename",
                afv1.version "Current Version",
                ''120.22.12020000.15'' "Fixed Version",
                RANK ()
                OVER (PARTITION BY af1.filename
                      ORDER BY afv1.version_segment1 DESC, afv1.version_segment2 DESC, afv1.version_segment3 DESC, 
                               afv1.version_segment4 DESC, afv1.version_segment5 DESC, afv1.version_segment6 DESC, 
                ...
                FROM ad_files af1,
                     ad_file_versions afv1
        WHERE af1.file_id = afv1.file_id
          AND af1.filename = ''AFSCDSCB.pls'' ))
 WHERE rankus = 1
   AND (fnd_irep_loader_private.compare_versions ("Current Version", "Fixed Version") = ''<'')         ',
      p_title                  => 'Saving or Booking Sales Order Performance Issue ',
      p_fail_condition         => 'RS',
      p_problem_descr          => ' Performance issues have been identified while booking or saving a Sales Order with the query on table FND_GRANTS.',
      p_solution               => 'Because you have a lower version of FND_DATA_SECURITY package body you will experience this performance issue. <br>
Refer to [2953614/KB785212] for details to apply Patch {34110249}.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_FND_GRANTS');



debug('begin add_signature: EBS_MFG_OM_PERF_MASSCHANGE_SSD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26354',
      p_sig_id                 => 'EBS_MFG_OM_PERF_MASSCHANGE_SSD',
      p_sig_sql                => 'SELECT "Filename",
       "Current Version",
       "Fixed Version"
  FROM ((SELECT af1.filename "Filename",
                afv1.version "Current Version",
                ''120.117.12020000.132'' "Fixed Version",
                RANK ()
                OVER (PARTITION BY af1.filename
                      ORDER BY afv1.version_segment1 DESC, afv1.version_segment2 DESC, afv1.version_segment3 DESC, 
                               afv1.version_segment4 DESC, afv1.version_segment5 DESC, afv1.version_segment6 DESC, 
                ...
                FROM ad_files af1,
                     ad_file_versions afv1
        WHERE af1.file_id = afv1.file_id
          AND af1.filename = ''OEXUSCHB.pls'' ))
 WHERE rankus = 1
   AND (fnd_irep_loader_private.compare_versions ("Current Version", "Fixed Version") = ''<'')   ',
      p_title                  => 'Performance Issue While Updating Request Date Using Mass Change',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Performance Issue While Updating Request Date Using Mass Change',
      p_solution               => 'Because you have a lower version of OE_SCHEDULE_UTIL package body you will experience this performance issue while updating Request Date using Mass Change.<br>
Refer to [2959455/KB763936] for details to apply Patch {35066468}',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_MASSCHANGE_SSD');



debug('begin add_signature: EBS_MFG_OM_PERF_REFRESH_OM_MATERIAL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26355',
      p_sig_id                 => 'EBS_MFG_OM_PERF_REFRESH_OM_MATERIAL',
      p_sig_sql                => 'SELECT "Filename",
       "Current Version",
       "Fixed Version"
  FROM ((SELECT af1.filename "Filename",
                afv1.version "Current Version",
                ''120.9.12020000.16'' "Fixed Version",
                RANK ()
                OVER (PARTITION BY af1.filename
                      ORDER BY afv1.version_segment1 DESC, afv1.version_segment2 DESC, afv1.version_segment3 DESC, 
                               afv1.version_segment4 DESC, afv1.version_segment5 DESC, afv1.version_segment6 DESC, 
                ...
                FROM ad_files af1,
                     ad_file_versions afv1
        WHERE af1.file_id = afv1.file_id
          AND af1.filename = ''OEITORDB.pls'' ))
 WHERE rankus = 1
   AND (fnd_irep_loader_private.compare_versions ("Current Version", "Fixed Version") = ''<'')  ',
      p_title                  => 'Refresh Order Management Materialized Views Poor Performance',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Refresh Order Management Materialized View has poor performance and errors with: <br>
 FDPSTP Failed Due to ORA-12008: Error in Materialized View Refresh Path',
      p_solution               => 'Because you have a lower version of OE_ITORD_UTIL package body you will experience this performance issue.<br>
Refer to [2801719/KB728363] for details to apply Patch {32564332}',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_REFRESH_OM_MATERIAL');



debug('begin add_signature: EBS_MFG_OM_PERF_CLOSED_LINE_TAX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26356',
      p_sig_id                 => 'EBS_MFG_OM_PERF_CLOSED_LINE_TAX',
      p_sig_sql                => 'SELECT "Filename",
       "Current Version",
       "Fixed Version"
  FROM ((SELECT af1.filename "Filename",
                afv1.version "Current Version",
                ''120.48.12020000.35'' "Fixed Version",
                RANK ()
                OVER (PARTITION BY af1.filename
                      ORDER BY afv1.version_segment1 DESC, afv1.version_segment2 DESC, afv1.version_segment3 DESC, 
                               afv1.version_segment4 DESC, afv1.version_segment5 DESC, afv1.version_segment6 DESC, 
 ...
 WHERE rankus = 1
   AND (fnd_irep_loader_private.compare_versions ("Current Version", "Fixed Version") = ''<'')',
      p_title                  => 'Poor Performance When Updating Order Line Quantity',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'When we update quantity on an existing line and save the changes, closed lines belongs to the same order also being sent to EB Tax during batch event. It is same case with Price Order as well.',
      p_solution               => 'You have lower version of OE_ORDER_PRICE_PVT package body.<br>
Refer to [2801753/KB744204] for details to apply patch {32969417}',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_CLOSED_LINE_TAX');



debug('begin add_signature: EBS_MFG_OM_PERF_ORDER_PURGE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26357',
      p_sig_id                 => 'EBS_MFG_OM_PERF_ORDER_PURGE',
      p_sig_sql                => 'SELECT "Filename",
       "Current Version",
       "Fixed Version"
  FROM ((SELECT af1.filename "Filename",
                afv1.version "Current Version",
                ''120.19.12020000.10'' "Fixed Version",
                RANK ()
                OVER (PARTITION BY af1.filename
                      ORDER BY afv1.version_segment1 DESC, afv1.version_segment2 DESC, afv1.version_segment3 DESC, 
                               afv1.version_segment4 DESC, afv1.version_segment5 DESC, afv1.version_segment6 DESC, 
                ...
                FROM ad_files af1,
                     ad_file_versions afv1
        WHERE af1.file_id = afv1.file_id
          AND af1.filename = ''OEXVPURB.pls'' ))
 WHERE rankus = 1
   AND (fnd_irep_loader_private.compare_versions ("Current Version", "Fixed Version") = ''<'') ',
      p_title                  => 'Order Purge Performance Is Poor While Purging Hold Sources',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Order Purge program is having performance issue while purging the hold sources since the seeded index on hold_entity_id id not being used.',
      p_solution               => 'You have lower version of OE_ORDER_PURGE_PVT package body.<br>
Refer to [2679931/KB716386] for details to apply patch {30792792}',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_ORDER_PURGE');



debug('begin add_signature: EBS_MFG_OM_PERF_EXPAND_UI');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26384',
      p_sig_id                 => 'EBS_MFG_OM_PERF_EXPAND_UI',
      p_sig_sql                => 'SELECT "Filename",
       "Current Version",
       "Fixed Version"
  FROM ((SELECT af1.filename "Filename",
                afv1.version "Current Version",
                ''120.7.12020000.2'' "Fixed Version",
                RANK ()
                OVER (PARTITION BY af1.filename
                      ORDER BY afv1.version_segment1 DESC, afv1.version_segment2 DESC, afv1.version_segment3 DESC, 
                               afv1.version_segment4 DESC, afv1.version_segment5 DESC, afv1.version_segment6 DESC, 
                ...
                FROM ad_files af1,
                     ad_file_versions afv1
        WHERE af1.file_id = afv1.file_id
          AND af1.filename = ''MdlNodePickerVO.xml'' 
          AND af1.subdir = ''java/developer/model/rules/server'' ))
 WHERE rankus = 1
   AND (fnd_irep_loader_private.compare_versions ("Current Version", "Fixed Version") = ''<'')         
UNION ALL   
SELECT "Filename",
  ...
  FROM ((SELECT af1.filename "Filename",
                afv1.version "Current Version",
                ''120.8.12020000.2'' "Fixed Version",
                RANK ()
                OVER (PARTITION BY af1.filename
                      ORDER BY afv1.version_segment1 DESC, afv1.version_segment2 DESC, afv1.version_segment3 DESC, 
                               afv1.version_segment4 DESC, afv1.version_segment5 DESC, afv1.version_segment6 DESC, 
                ...
                FROM ad_files af1,
                     ad_file_versions afv1
        WHERE af1.file_id = afv1.file_id
          AND af1.filename = ''ModelHgridSearchwEffCriVO.xml'' ))
 WHERE rankus = 1
   AND (fnd_irep_loader_private.compare_versions ("Current Version", "Fixed Version") = ''<'')            
UNION ALL      
SELECT "Filename",
  ...
  FROM ((SELECT af1.filename "Filename",
                ...
                FROM ad_files af1,
                     ad_file_versions afv1
        WHERE af1.file_id = afv1.file_id
          AND af1.filename = ''ModelHgridVO.xml'' ))
 WHERE rankus = 1
   AND (fnd_irep_loader_private.compare_versions ("Current Version", "Fixed Version") = ''<'')     
UNION ALL      
SELECT "Filename",
  ...
  FROM ((SELECT af1.filename "Filename",
                afv1.version "Current Version",
                ''120.3.12020000.2'' "Fixed Version",
                RANK ()
                OVER (PARTITION BY af1.filename
                      ORDER BY afv1.version_segment1 DESC, afv1.version_segment2 DESC, afv1.version_segment3 DESC, 
                               afv1.version_segment4 DESC, afv1.version_segment5 DESC, afv1.version_segment6 DESC, 
                ...
                FROM ad_files af1,
                     ad_file_versions afv1
        WHERE af1.file_id = afv1.file_id
          AND af1.filename = ''UIElementMdlNodePickerVO.xml''
          ))
 WHERE rankus = 1
   AND (fnd_irep_loader_private.compare_versions ("Current Version", "Fixed Version") = ''<'')   ',
      p_title                  => 'Configurator Developer Performance Issue When Expanding UI Structure',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'When expanding the UI Structure below the page level in Configurator Developer brings on Performance Issues.',
      p_solution               => 'You have lower version of<br>
MdlNodePickerVO.xml<br>
ModelHgridSearchwEffCriVO.xml<br>
ModelHgridVO.xml<br>
UIElementMdlNodePickerVO.xml<br>
<br>
Refer to [2923120/KB730104] for details to apply patch {34042921}',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_OM_PERF_EXPAND_UI');
...
BEGIN
  ...
  analyzer_title := 'Order Management Suite Performance Analyzer';
...
debug('begin section: OM_Perf');
IF g_sql_tokens('##$$OM_PERF$$##') = 'Y' THEN
   start_section('Order Management', 'OM_Perf');
      set_item_result(run_stored_sig('EBS_MFG_OM_PERF_PURGE_ELIGIBLE'));
      set_item_result(run_stored_sig('EBS_MFG_OM_PERF_ENABLED_DEBUG'));
      set_item_result(run_stored_sig('EBS_MFG_OM_PERF_AUDIT_TRAIL'));
      IF ((substr(g_rep_info('Apps Version'),1,4) = '12.2')) THEN
         set_item_result(run_stored_sig('EBS_MFG_OM_PERF_FND_GRANTS'));
         set_item_result(run_stored_sig('EBS_MFG_OM_PERF_MASSCHANGE_SSD'));
         set_item_result(run_stored_sig('EBS_MFG_OM_PERF_REFRESH_OM_MATERIAL'));
         set_item_result(run_stored_sig('EBS_MFG_OM_PERF_CLOSED_LINE_TAX'));
         set_item_result(run_stored_sig('EBS_MFG_OM_PERF_ORDER_PURGE'));
      END IF;
   end_section;
END IF;
debug('end section: OM_Perf');

debug('begin section: QP_Perf');
IF g_sql_tokens('##$$QP_PERF$$##') = 'Y' THEN
   start_section('Advanced Pricing', 'QP_Perf');
      set_item_result(run_stored_sig('PRICING_TEMP_TABLESPACE_PARAMS'));
      set_item_result(run_stored_sig('EBS_MFG_OM_PRICING_DEBUG_VALUES'));
   ...
   end_section;
END IF;
debug('end section: QP_Perf');

debug('begin section: WSH_Perf');
IF g_sql_tokens('##$$WSH_PERF$$##') = 'Y' THEN
   start_section('Shipping', 'WSH_Perf');
      set_item_result(run_stored_sig('EBS_MFG_OM_PERF_WSH_PURGE'));
      IF ((substr(g_rep_info('Apps Version'),1,4) = '12.2')) THEN
         set_item_result(run_stored_sig('EBS_MFG_OM_PERF_WSHFSTRX_TAB'));
         set_item_result(run_stored_sig('EBS_MFG_OM_PERF_WSHFSTRX_SHIP_TO'));
         set_item_result(run_stored_sig('EBS_MFG_OM_PERF_WSH_DELIVERIES_PUB'));
         set_item_result(run_stored_sig('EBS_MFG_OM_PERF_WSHTAB'));
         set_item_result(run_stored_sig('EBS_MFG_OM_PERF_DELIVERY_TAB'));
         set_item_result(run_stored_sig('EBS_MFG_OM_PERF_WSH_PR_CRITERIA'));
         set_item_result(run_stored_sig('EBS_MFG_OM_PERF_OE_ADV_PRICE_PVT'));
      END IF;
   end_section;
END IF;
debug('end section: WSH_Perf');

debug('begin section: CZ_Perf');
IF g_sql_tokens('##$$CZ_PERF$$##') = 'Y' THEN
   start_section('Configurator', 'CZ_Perf');
      set_item_result(run_stored_sig('EBS_MFG_OM_PERF_CZ_PURGE'));
      set_item_result(run_stored_sig('CZ1_CZPURGE_PERFORMANCE'));
      set_item_result(run_stored_sig('CZ1_BOM_EXPLOSIONS_GENERATE_STATS'));
      set_item_result(run_stored_sig('CZ1_GENERATE_STATS_ON_CZ_SCHEMA'));
      set_item_result(run_stored_sig('CZ1_PUBLICATION_PERFORMANCE'));
      set_item_result(run_stored_sig('CZ1_LOGIC_GENERATION_PERFORMANCE'));
      IF ((substr(g_rep_info('Apps Version'),1,4) = '12.2')) THEN
         set_item_result(run_stored_sig('EBS_MFG_OM_PERF_EXPAND_UI'));
      END IF;
   end_section;
END IF;
debug('end section: CZ_Perf');

debug('begin section: WF_Perf');
IF g_sql_tokens('##$$WF_PERF$$##') = 'Y' THEN
   start_section('Workflow', 'WF_Perf');
      set_item_result(run_stored_sig('EBS_MFG_OM_PERF_WF_ITEM_TYPES'));
      set_item_result(run_stored_sig('EBS_MFG_OM_PERF_CLOSED_WF_ITEM_TYPE'));
      set_item_result(run_stored_sig('EBS_MFG_OM_PERF_ALL_WF_ITEMS'));
      set_item_result(run_stored_sig('EBS_MFG_OM_PERF_CLOSED_WF_ACTIVITY'));
      set_item_result(run_stored_sig('EBS_MFG_OM_PERF_ALL_WF_ACTIVITY'));
      set_item_result(run_stored_sig('EBS_MFG_OM_PERF_WF_LARGE_ACTIVITY'));
      set_item_result(run_stored_sig('EBS_MFG_OM_PERF_WF_CLOSED_ACTIVITY_HIST'));
      set_item_result(run_stored_sig('EBS_MFG_OM_PERF_WF_LARGE_ACTIVITY_HIST'));
      set_item_result(run_stored_sig('EBS_MFG_OM_PERF_WF_NOTIF'));
      set_item_result(run_stored_sig('EBS_MFG_OM_PERF_CLOSED_WF'));
      set_item_result(run_stored_sig('EBS_MFG_OM_PERF_WF_NOTIF_UNREF'));
      set_item_result(run_stored_sig('EBS_MFG_OM_PERF_LOOPING_WF'));
      set_item_result(run_stored_sig('EBS_MFG_OM_ONT_PERF_ORPHAN_NOTIF_CLOSED_SO_LINES'));
   end_section;
END IF;
debug('end section: WF_Perf');

debug('begin section: DB_Perf');
IF g_sql_tokens('##$$DB_PERF$$##') = 'Y' THEN
   start_section('Database', 'DB_Perf');
      set_item_result(run_stored_sig('AC_DB_INFO'));
      set_item_result(run_stored_sig('EBS_MFG_OM_PERF_DB_PARAM'));
      set_item_result(run_stored_sig('EBS_MFG_OM_PERF_DB_CBO_STATS'));
      ...
      set_item_result(run_stored_sig('EBS_MFG_OM_PERF_DB_10_PERCENT_MODIFIED'));
      set_item_result(run_stored_sig('DBSTAT1_GSS'));
   end_section;
END IF;
debug('end section: DB_Perf');
...
IF g_sql_tokens('##$$APPS_CHECK$$##') = 'Y' THEN
   start_section('Apps Check', 'Apps_Check');
      ...
      set_item_result(run_stored_sig('OM_DEBUG_PROFILES'));
      set_item_result(run_stored_sig('OM_UTLFILEDIR'));
      set_item_result(run_stored_sig('ONT_SYSTEM_PARAMETERS'));
      set_item_result(run_stored_sig('EBS_MFG_OM_AC_PROFILE_OPTIONS'));
      set_item_result(run_stored_sig('EBS_MFG_OM_AC_FILE_VERSIONS'));
      set_item_result(run_stored_sig('EBS_MFG_OM_ONT_ONTONESO_WF_VER'));
      ...
      set_item_result(run_stored_sig('EBS_MFG_OM_SEQUENCE_THRESHOLD'));
