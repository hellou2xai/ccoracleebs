...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Release Management (RLM) Schedule      |
REM | Analyzer                                                                  |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE rlm_schedule_analyzer_pkg AUTHID DEFINER AS
...
(            p_schedule_number              IN VARCHAR2    DEFAULT NULL
           ...
           ,p_customer_item                IN VARCHAR2    DEFAULT NULL
...
END rlm_schedule_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY rlm_schedule_analyzer_pkg AS
-- $Id: rlm_schedule_analyzer.sql, 200.17 2026/01/28 16:23:01 cschmehl Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2794745.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'RLMSCHED_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'RLMSCHED_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>RLMSCHED Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2794745.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/rlm_sched_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,5189,EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,5189,EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},5189,EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/mosc/discussion/4500065/ebs-release-management-rlm-schedule-analyzer" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">5189</span>
...
&nbsp; &nbsp;EBS KB Article IDs Shown for Signature KM Links</p><p>Template Changes (4.8.3):&nbsp;<br>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,5189,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,5189,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},5189,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Order Management" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
FUNCTION get_REL_SCH_HDR_ID
   return VARCHAR2 IS
BEGIN
debug('begin sql token function: REL_SCH_HDR_ID');
BEGIN
  SELECT schedule_header_id
    INTO l_system_function_var
  FROM rlm_interface_headers_all
  WHERE schedule_reference_num =  p_schedule_number
  AND HEADER_ID = p_header_id;
    RETURN l_system_function_var;
EXCEPTION WHEN NO_DATA_FOUND THEN
  SELECT header_id
    INTO l_system_function_var
  FROM rlm_schedule_headers_all
  WHERE schedule_reference_num = p_schedule_number 
  AND INTERFACE_HEADER_ID = p_header_id;
    RETURN l_system_function_var;
END;

debug('end sql token function: REL_SCH_HDR_ID');
END get_REL_SCH_HDR_ID;

FUNCTION get_REL_CUST_ID
   return VARCHAR2 IS
BEGIN
debug('begin sql token function: REL_CUST_ID');
BEGIN
  select customer_id
    into l_system_function_var
  from rlm_schedule_headers_all
...
debug('end sql token function: REL_CUST_ID');
END get_REL_CUST_ID;
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Schedule Reference Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_schedule_number,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Interface Header ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_header_id,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Customer Item Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_customer_item,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  l_revision := rtrim(replace('$Revision: 200.17  $','$',''));
  l_revision := ltrim(replace(l_revision,'Revision:',''));
  l_date_char := rtrim(replace('$Date: 2026/01/28 16:23:00 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'rlm_schedule_analyzer.sql';
...
debug('begin parameter validation: p_schedule_number');
IF p_schedule_number IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Schedule Reference Number is required.');
...
INTO l_exists_val
FROM ( SELECT DISTINCT ( SCHEDULE_REFERENCE_NUM ) FROM RLM_SCHEDULE_HEADERS_ALL UNION SELECT DISTINCT ( SCHEDULE_REFERENCE_NUM ) FROM RLM_INTERFACE_HEADERS_ALL ) 
WHERE SCHEDULE_REFERENCE_NUM = p_schedule_number and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Schedule Reference Number');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_schedule_number failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_schedule_number');

debug('begin parameter validation: p_header_id');
IF p_header_id IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Interface Header ID is required.');
   raise invalid_parameters;
END IF;
...
SELECT HEADER_ID
INTO l_exists_val
FROM ( SELECT HEADER_ID FROM RLM_INTERFACE_HEADERS_ALL WHERE SCHEDULE_REFERENCE_NUM = P_SCHEDULE_NUMBER UNION SELECT INTERFACE_HEADER_ID FROM RLM_SCHEDULE_HEADERS_ALL WHERE SCHEDULE_REFERENCE_NUM = P_SCHEDULE_NUMBER )
WHERE HEADER_ID = p_header_id and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Header ID');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
debug('begin populate sql tokens hash table');
   ...
   g_sql_tokens('##$$APPS_PARAM1$$##') := '662';
   g_masked_tokens('##$$APPS_PARAM1$$##') := mask_text( g_sql_tokens('##$$APPS_PARAM1$$##'), 'NO_MASK');
   g_sql_tokens('##$$REL_ORGID$$##') := p_org_id;
   g_masked_tokens('##$$REL_ORGID$$##') := mask_text( g_sql_tokens('##$$REL_ORGID$$##'), 'NO_MASK');
   g_sql_tokens('##$$REL_SCH_HDR_ID$$##') := get_REL_SCH_HDR_ID();
   l_system_function_var := null;
   g_masked_tokens('##$$REL_SCH_HDR_ID$$##') := mask_text( g_sql_tokens('##$$REL_SCH_HDR_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$SCHED_REF$$##') := p_schedule_number;
   g_masked_tokens('##$$SCHED_REF$$##') := mask_text( g_sql_tokens('##$$SCHED_REF$$##'), 'NO_MASK');
   g_sql_tokens('##$$REL_CUST_ID$$##') := get_REL_CUST_ID();
   l_system_function_var := null;
   g_masked_tokens('##$$REL_CUST_ID$$##') := mask_text( g_sql_tokens('##$$REL_CUST_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$REL_INT_HDR_ID$$##') := p_header_id;
   g_masked_tokens('##$$REL_INT_HDR_ID$$##') := mask_text( g_sql_tokens('##$$REL_INT_HDR_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$REL_CUST_ITEM$$##') := p_customer_item;
   g_masked_tokens('##$$REL_CUST_ITEM$$##') := mask_text( g_sql_tokens('##$$REL_CUST_ITEM$$##'), 'NO_MASK');
...
debug('begin add_signature: RLM_INTERFACE_HDR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19563',
      p_sig_id                 => 'RLM_INTERFACE_HDR',
      p_sig_sql                => 'SELECT
rih.header_id                  "HEADER ID",         
rih.schedule_header_id         "SCHEDULE HEADER ID",         
rih.schedule_reference_num     "SCHEDULE  REFERENCE NUM",          
rih.schedule_source            "SCHEDULE SOURCE",         
rih.sched_generation_date      " ISSUE DATE",          
rih.sched_horizon_start_date   "HORIZON START DATE",          
rih.sched_horizon_end_date     "HORIZON END DATE",          
fv1.meaning                    "SCHEDULE TYPE",          
rih.process_status             "PROCESS STATUS",
fv2.meaning                    "PROCESS STATUS DESC",        
fv3.meaning                    "PURPOSE CODE",          
rih.ece_tp_translator_code     "TP CODE",         
rih.ece_tp_location_code_ext   "TP LOCATION",         
rih.edi_control_num_1          "CONTROL NUM1",         
rih.edi_control_num_2          "CONTROL NUM2",         
rih.edi_control_num_3          "CONTROL NUM3",                
rih.customer_id                "CUSTOMER ID",          
rih.creation_date              "CREATION DATE"  
FROM  rlm_interface_headers_all rih ,
          fnd_lookups fv1,
          fnd_lookups fv2,
          fnd_lookups fv3   
WHERE  fv1.lookup_type = ''RLM_SCHEDULE_TYPE''
    AND  fv2.lookup_type = ''RLM_PROCESS_STATUS''
    AND  fv3.lookup_type = ''RLM_SCHEDULE_PURPOSE''
    AND  rih.schedule_type = fv1.lookup_code
    AND  rih.process_status = fv2.lookup_code
    AND  rih.schedule_purpose = fv3.lookup_code
    AND  rih.header_id = ##$$REL_INT_HDR_ID$$## 
ORDER BY rih.sched_generation_date 
',
      p_title                  => 'Interface Header',
      p_fail_condition         => '[Process Status] IN [4,7]',
      p_problem_descr          => 'Release Management Interface Header Information.  Process Status will highlight if the schedule has been unsuccessfully processed.',
      p_solution               => 'Schedule has error(s).  These must be corrected and resubmitted for processing via the Demand Stream Processor. Refer to [2801167/KB216686#resubmit]',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: RLM_INTERFACE_HDR');



debug('begin add_signature: RLM_INTERFACE_LINE');
   l_info('##HYPERLINK##'):= 'INTERFACE LINE ID,RLM_EXCEPTION,INTERFACE LINE ID';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19564',
      p_sig_id                 => 'RLM_INTERFACE_LINE',
      p_sig_sql                => 'SELECT 
ril.line_id                                          "LINE ID" ,          
ril.schedule_line_id                                 "INTERFACE LINE ID" ,          
(SELECT organization_code                       
FROM  org_organization_definitions o           
WHERE o.organization_id = ril.ship_from_org_id)       "SHIP FROM" ,
cust_ship_from_org_ext                                "SHIP FROM EXT" ,         
(SELECT ece_tp_location_code                   
FROM  ra_addresses_all a                       
WHERE a.address_id = ril.ship_to_address_id)          "SHIP TO" ,         
cust_ship_to_ext                                      "SHIP TO EXT" ,         
(SELECT customer_item_number                    
FROM   mtl_customer_items m                    
WHERE  m.customer_item_id = ril.customer_item_id)    "CUSTOMER ITEM NUMBER" ,          
customer_item_ext                                    "CUSTOMER ITEM EXT" ,         
(SELECT (mif.item_number )                      
FROM mtl_item_flexfields mif                   
WHERE ril.inventory_item_id = mif.inventory_item_id            
AND ril.ship_from_org_id  = mif.organization_id )    "INVENTORY ITEM" ,          
ril.ship_from_org_id                                 "SHIP FROM ORG ID" ,          
ril.ship_to_address_id                               "SHIP TO ADDRESS ID" ,          
ril.customer_item_id                                 "CUSTOMER ITEM ID" ,          
ril.inventory_item_id                                "INVENTORY ITEM ID" ,          
fv1.meaning                                          "DETAIL TYPE" ,          
fv2.meaning                                          "SUB TYPE" ,          
fv3.meaning                                          "QTY TYPE" ,          
ril.uom_code                                         "UOM" ,          
ril.item_detail_quantity                             "QUANTITY" ,          
fv4.meaning                                          "DATE TYPE" ,          
ril.start_date_time                                  "START DATE TIME" ,          
ril.order_header_id                                  "ORDER HEADER ID" ,          
ril.process_status                                   "PROCESS STATUS" , 
fv5.meaning                                          "PPROCESS STATUS DESC" ,        
ril.customer_dock_code                               "CUNSTER DOCK CODE" ,          
ril.cust_model_serial_number                         "MODEL SERIEL NUM" ,          
ril.customer_job                                     "CUSTOMER JOB NUM" ,          
ril.cust_po_number                                   "PURCHASE ORDER NUM" ,          
ril.creation_date                                    "CREATION DATE" ,          
ril.last_update_date                                 "LAST UPDATE DATE" ,          
ril.last_updated_by                                  "LAST UPDATE BY"
    FROM   rlm_interface_lines_all ril,
           fnd_lookups fv1 ,
          fnd_lookups fv2 ,
          fnd_lookups fv3 ,
          fnd_lookups fv4 ,
          fnd_lookups fv5
  WHERE  fv1.lookup_type = ''RLM_DETAIL_TYPE_CODE''
  AND  fv1.lookup_code = ril.item_detail_type
  AND  fv2.lookup_type = ''RLM_DETAIL_SUBTYPE_CODE''
  AND  fv2.lookup_code = ril.item_detail_subtype
  AND  fv3.lookup_type = ''RLM_QTY_TYPE_CODE''
  AND  fv3.lookup_code = ril.qty_type_code 
  AND  fv4.lookup_type = ''RLM_DATE_TYPE_CODE''
  AND  fv4.lookup_code = ril.date_type_code
  AND  fv5.lookup_type = ''RLM_PROCESS_STATUS''
  AND  fv5.lookup_code =  ril.process_status
  AND  ril.header_id  =  ##$$REL_INT_HDR_ID$$## 
  AND NVL(''##$$REL_CUST_ITEM$$##'',''0'') in (''0'',ril.CUSTOMER_ITEM_EXT)
ORDER BY ship_from_org_id, ship_to_address_id, customer_item_id ',
      p_title                  => 'Interface Line(s)',
      p_fail_condition         => '[Process Status] IN [4,7]',
      p_problem_descr          => 'Release Management interface line information.  Process Status will highlight if the schedule line has been unsuccessfully processed.',
      p_solution               => 'Schedule lines with errors must be corrected and resubmitted for processing using the Release Management Workbench. Errors must be corrected and Demand Stream Processor resubmitted. Refer to [2801167/KB216686#resubmit]',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: RLM_INTERFACE_LINE');



debug('begin add_signature: RLM_SCHEDULE_HDR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19565',
      p_sig_id                 => 'RLM_SCHEDULE_HDR',
      p_sig_sql                => 'SELECT 
rih.header_id                  "HEADER ID",      
rih.interface_header_id        "INTERFACE HEADER ID",         
rih.schedule_reference_num     "SCHEDULE REFERENCE NUM",         
rih.schedule_source            "SCHEDULE SOURCE",         
rih.sched_generation_date      "ISSUE DATE",         
rih.sched_horizon_start_date   "HORIZON START DATE",         
...
rih.edi_control_num_2          "CONTROL NUM2",         
rih.edi_control_num_3          "CONTROL NUM3",         
acc.account_number             "CUSTOMER NUMBER ",         
rih.customer_id                "CUSTOMER ID",         
rih.creation_date              "CREATION DATE",         
rih.last_update_date           "LAST UPDATE DATE",         
rih.last_updated_by            "LAST UPDATE BY"    
FROM  rlm_schedule_headers_all rih ,
        hz_cust_accounts acc,
         hz_parties par,
         fnd_lookups fv1,
        fnd_lookups fv2,
        fnd_lookups fv3   
WHERE  acc.party_id = par.party_id
     AND  acc.cust_account_id = rih.customer_id
     AND  par.status = ''A''
     AND  acc.status = ''A''
     AND  fv1.lookup_type = ''RLM_SCHEDULE_TYPE''
    AND  fv2.lookup_type = ''RLM_PROCESS_STATUS''
    AND  fv3.lookup_type = ''RLM_SCHEDULE_PURPOSE''
    AND  rih.schedule_type = fv1.lookup_code
     AND  rih.process_status = fv2.lookup_code
    AND  rih.schedule_purpose = fv3.lookup_code 
    AND  rih.header_id = ##$$REL_SCH_HDR_ID$$##
    AND  NOT EXISTS ( SELECT schedule_header_id FROM rlm_interface_headers_all rinth WHERE rinth.schedule_header_id = rih.header_id)    
ORDER BY rih.sched_generation_date',
      p_title                  => 'Schedule Header',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Release Management schedule header information.  If schedule header does not return, then part of the schedule is still in the interface tables. ',
      p_solution               => 'Release Management schedule header information will only display if the complete schedule has been processed successfully.  If schedule header does not return, then part of the schedule is still in the interface tables.  Use the Interface Header signature to review details.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: RLM_SCHEDULE_HDR');



debug('begin add_signature: RLM_SCHEDULE_LINE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19566',
      p_sig_id                 => 'RLM_SCHEDULE_LINE',
      p_sig_sql                => 'SELECT 
ril.line_id                                          "LINE ID" ,          
ril.interface_line_id                                "INTERFACE LINE ID" ,        
ril.order_header_id                                  "ORDER HEADER ID" ,   
(SELECT organization_code FROM  org_organization_definitions o WHERE o.organization_id = ril.ship_from_org_id)       "SHIP FROM" ,         
cust_ship_from_org_ext                                "SHIP FROM EXT" ,         
(SELECT ece_tp_location_code FROM  ra_addresses_all a WHERE a.address_id = ril.ship_to_address_id)          "SHIP TO" ,         
cust_ship_to_ext                                      "SHIP TO EXT" ,         
(SELECT customer_item_number FROM mtl_customer_items m WHERE  m.customer_item_id = ril.customer_item_id)    "CUSTOMER ITEM NUMBER" ,         
customer_item_ext                                     "CUSTOMER ITEM EXT" ,          
mif.item_number                                       "INVENTORY ITEM" ,          
...
fv4.meaning                                          "DATE TYPE" ,          
ril.start_date_time                                  "START DATE TIME" ,         
fv5.meaning                                          "PROCESS STATUS" ,          
ril.customer_dock_code                               "CUSTOMER DOCK CODE" ,          
ril.cust_model_serial_number                         "MODEL SERIAL NUMBER" ,          
ril.customer_job                                     "CUSTOMER JOB NUMBER" ,          
ril.cust_po_number                                   "PURCHASE ORDER NUMBER" ,          
ril.creation_date                                    "CREATION DATE" ,          
ril.last_update_date                                 "LAST UPDATE DATE" ,          
ril.last_updated_by                                  "LAST UPDATE BY"  
FROM  rlm_schedule_lines_all ril,
         rlm_schedule_headers_all  rih,
       ...
       fnd_lookups fv3 ,
        ...
        fnd_lookups fv5   
WHERE ril.inventory_item_id = mif.inventory_item_id
     AND ril.ship_from_org_id  = mif.organization_id
     AND rih.header_id = ril.header_id
     AND  fv1.lookup_type = ''RLM_DETAIL_TYPE_CODE''
     AND  fv1.lookup_code = ril.item_detail_type
     AND  fv2.lookup_type = ''RLM_DETAIL_SUBTYPE_CODE''
     AND  fv2.lookup_code = ril.item_detail_subtype
     AND  fv3.lookup_type = ''RLM_QTY_TYPE_CODE''
    ...
    AND  fv4.lookup_code = ril.date_type_code
    AND  fv5.lookup_type = ''RLM_PROCESS_STATUS''
    AND  ril.header_id = ##$$REL_SCH_HDR_ID$$##
    AND  NOT EXISTS ( SELECT schedule_header_id FROM rlm_interface_headers_all rinth WHERE rinth.schedule_header_id = rih.header_id)
    AND  fv5.lookup_code = ril.process_status  
    AND NVL(''##$$REL_CUST_ITEM$$##'',''0'') in (''0'',ril.CUSTOMER_ITEM_EXT)
UNION  SELECT      
...
WHERE ril.inventory_item_id = mif.inventory_item_id
     AND ril.ship_from_org_id  = mif.organization_id
     AND ril.header_id =    rih.schedule_header_id
     AND  fv1.lookup_type = ''RLM_DETAIL_TYPE_CODE''
     AND  fv1.lookup_code = ril.item_detail_type
     AND  fv2.lookup_type = ''RLM_DETAIL_SUBTYPE_CODE''
     AND  fv2.lookup_code = ril.item_detail_subtype
    ...
    AND  rih.header_id = ##$$REL_INT_HDR_ID$$##
    AND  fv5.lookup_code = ril.process_status
    AND  ril.process_status = 5   
   AND NVL(''##$$REL_CUST_ITEM$$##'',''0'') in (''0'',ril.CUSTOMER_ITEM_EXT)
ORDER BY 12, 13, 14 ',
      p_title                  => 'Schedule Line(s)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Release Management schedule line(s) information.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: RLM_SCHEDULE_LINE');



debug('begin add_signature: RLM_EXCEPTION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19567',
      p_sig_id                 => 'RLM_EXCEPTION',
      p_sig_sql                => 'SELECT 
interface_header_id      "INTERFACE HEADER ID" ,     
interface_line_id        "INTERFACE LINE ID" ,     
schedule_header_id       "SCHEDULE HEADER ID" ,     
schedule_line_id         "SCHEDULE LINE ID" ,     
order_header_id          "ORDER HEADER ID" ,     
order_line_id            "ORDER LINE ID" ,     
schedule_reference_num   "SCHEDULE REFERENCE NUM" ,     
exception_id      "EXCEPTION ID" ,     
request_id               "REQUEST ID" ,     
fv1.meaning              "SEVERITY" ,     
message_name             "MESSAGE NAME" ,     
message_text             "MESSAGE TEXT" ,     
ece_tp_translator_code   "TP CODE" ,     
ece_tp_location_code_ext "TP LCOATION CODE" ,     
sched_generation_date    "ISSUE DATE" ,     
horizon_start_date       "HORIZON START DATE" ,     
horizon_end_date         "HORIZON END DATE" ,     
fv2.meaning              "SCHEDULE TYPE"
FROM rlm_demand_exceptions rde,
        fnd_lookups fv1 ,
        fnd_lookups fv2   
WHERE fv1.lookup_type = ''RLM_EXCEPTION_SEVERITY''
   AND  fv1.lookup_code =rde.exception_level
    AND  fv2.lookup_type = ''RLM_SCHEDULE_TYPE''
   AND  fv2.lookup_code = rde.schedule_type
   AND (rde.schedule_header_id = ##$$REL_SCH_HDR_ID$$##  OR  rde.interface_header_id = ##$$REL_INT_HDR_ID$$##)  
ORDER BY exception_id 
',
      p_title                  => 'Schedule Exception(s)',
      p_fail_condition         => '[Severity] IN [Error]',
      p_problem_descr          => 'Release Management schedule exception information.',
      p_solution               => 'Schedule and / or schedule line(s) have warning(s) or error(s). There is no need to act upon a warning unless the warning does not seem feasible.  Errors must be corrected and resubmitted for processing via the Demand Stream Processor.  Refer to [2803412/KB405946]',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: RLM_EXCEPTION');



debug('begin add_signature: RLM_ORDER_LINE');
   l_info('##MASK##CUSTOMER NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SHIP TO'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19568',
      p_sig_id                 => 'RLM_ORDER_LINE',
      p_sig_sql                => 'SELECT (SELECT oeh.order_number FROM oe_order_headers_all oeh WHERE oeh.header_id = oel.header_id)         "ORDER NUMBER" ,          
oel.blanket_number                          "BLANKET NUMBER" ,        
oel.header_id                                "HEADER ID" ,          
oel.line_id                                  "LINE ID" ,          
oel.flow_status_code                         "FLOW STATUS" ,          
oel.open_flag                                "OPEN FLAG" ,         
(SELECT organization_code           FROM  org_organization_definitions o          WHERE o.organization_id = oel.ship_from_org_id ) "SHIP FROM" ,         
oel.ship_from_org_id                        "SHIP FROM ORG ID" ,    
(SELECT location          FROM hz_cust_site_uses_all hzc          WHERE hzc.site_use_id = oel.ship_to_org_id) "SHIP TO" ,              
oel.ship_to_org_id                          "SHIP TO ORG ID" ,    
oel.ordered_item                            "ORDERED ITEM" ,          
oel.ordered_item_id                         "ORDERED ITEM ID" ,     
mif.item_number                             "INVENTORY ITEM" ,          
oel.inventory_item_id                       "INVENTORY ITEM ID" ,     
mif.description                             "ITEM DESCRIPTION" ,                     
acc.account_number                          "CUSTOMER NUMBER" ,          
par.party_name                              "CUSTOMER NAME" ,          
acc.cust_account_id                         "CUSTOMER ID" ,              
oel.invoice_to_org_id                       "INVOICE TO ORG ID" ,          
oel.intmed_ship_to_org_id                   "INTERMEDIATE SHIP TO ID" ,          
fv1.meaning                                 "BUCKET TYPE" ,          
oel.demand_bucket_type_code                 "BUCKET TYPE CODE" ,          
fv2.meaning                                 "SCHEDULE TYPE " ,          
oel.rla_schedule_type_code                  "SCHEDULE TYPE CODE" ,          
oel.authorized_to_ship_flag                 "AUTHORIZE SHIP TO FLAG" ,          
oel.ordered_quantity                        "ORDER QTY" ,          
oel.order_quantity_uom                      "ORDER UOM" ,          
oel.Shipped_quantity                        "SHIPPED QTY" ,          
oel.shipping_quantity                       "SHIPPING QTY" ,          
oel.shipping_quantity_uom                   "SHIPPING QTY UOM" ,            
oel.request_date                            "REQUEST DATE" ,          
oel.schedule_ship_date                      "SCHEDULE SHIP DATE" ,          
oel.veh_cus_item_cum_key_id                 "CUM KEY ID" ,          
oel.customer_line_number                    "CUSTOEMR LINE NUM" ,          
oel.customer_production_line                "CUSTOMER PRODUCTION LINE" ,          
oel.customer_dock_code                      "CUSTOMER DOCK CODE" ,          
oel.cust_po_number                          "CUSTOMER PO NUM" ,          
oel.item_revision                           "ITEM REVISION" ,          
oel.customer_job                            "CUSTOMER JOB" ,          
oel.cust_model_serial_number                "MODEL SERIAL NUM" ,          
oel.cust_production_seq_num                 "PRODUCTION SEQUENCE NUM" ,          
oel.industry_attribute1                     "IND ATTR 1" ,          
oel.industry_attribute2                     "START DATE TIME" ,          
oel.industry_attribute3                     "SCHEDULE REFERENCE NUM" ,          
oel.industry_attribute4                     "IND ATTR 4" ,          
oel.industry_attribute5                     "IND ATTR 5" ,          
oel.industry_attribute6                     "IND ATTR 6" ,          
oel.industry_attribute7                     "IND ATTR 7" ,          
oel.industry_attribute8                     "IND ATTR 8" ,          
oel.industry_attribute9                     "IIND ATTR 9" ,          
oel.industry_attribute10                    "IND ATTR 10" ,          
oel.industry_attribute11                    "IIND ATTR 11" ,          
oel.industry_attribute12                    "IND ATTR 12" ,          
oel.industry_attribute13                    "IND ATTR 13" ,          
oel.industry_attribute14                    "IND ATTR 14" ,          
oel.industry_attribute15                    "SHIP FROM"   
FROM  oe_order_lines_all oel,
       hz_cust_accounts acc,
        ...
        fnd_lookups fv1,
        fnd_lookups fv2  
WHERE oel.source_document_type_id = 5    
AND acc.party_id = par.party_id
    AND acc.cust_account_id = oel.sold_to_org_id
    AND par.status = ''A''
    AND acc.status = ''A''
    AND fv1.lookup_type = ''RLM_DETAIL_TYPE_CODE''
    AND fv1.lookup_code = oel.demand_bucket_type_code
    AND fv2.lookup_type =''RLM_SCHEDULE_TYPE''
    AND fv2.lookup_code = oel.rla_schedule_type_code
    AND mif.organization_id = oel.ship_from_org_id
    AND mif.inventory_item_id = oel.inventory_item_id
    AND ((oel.source_document_id = 1)
          OR  (oel.source_document_id IN 
                    (SELECT schedule_header_id                                   
                     FROM rlm_interface_headers_all                                   
                     WHERE header_id = ##$$REL_INT_HDR_ID$$##                               
                     AND   process_status = 7 )))    
AND oel.source_document_type_id = 5  
AND NVL(''##$$REL_CUST_ITEM$$##'',''0'') in (''0'',oel.ordered_item)
ORDER BY header_id,ship_from_org_id, ship_to_org_id, ordered_item_id ',
      p_title                  => 'Sales Order Line(s)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Order Line information updated by Release Management.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: RLM_ORDER_LINE');



debug('begin add_signature: RLM_PR_CUSTOMER_LEVEL');
   l_info('##MASK##CUSTOMER NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19569',
      p_sig_id                 => 'RLM_PR_CUSTOMER_LEVEL',
      p_sig_sql                => 'SELECT orgdef.organization_name        "SHIP FROM",         
orgdef.organization_code         "SHIP FROM CODE",    
party.party_name         "CUSTOMER NAME" ,         
cust_acct.account_number "CUSTOMER NUMBER" ,           
terms.CUST_SHIPTO_TERMS_ID        "CUST SHIP TO TERMS ID",         
terms.ADDRESS_ID "ADDRESS ID" ,         
terms.CUSTOMER_ID "CUSTOMER ID" ,         
terms.SHIP_FROM_ORG_ID  "SHIP FROM ORG ID" ,        
fv1.meaning                       "CCUM CONTROL CODE MEANING",         
terms.CUM_CONTROL_CODE            "CUM CONTROL CODE",         
terms.INTRANSIT_TIME             "INTRANSIT TIME",        
fv2.meaning                       "TIME UOM MEANING",        
terms.TIME_UOM_CODE               "TIME UOM CODE",        
shdel.description "SHIP DELIVERY RULE DESC" ,         
terms.SHIP_DELIVERY_RULE_NAME "SHIP DELIVERY RULE NAME" ,                
terms.CUM_CURRENT_RECORD_YEAR     "CUM CURRENT RECORD YEAR",        
terms.CUM_PREVIOUS_RECORD_YEAR    "CUM PREVIOUS RECORD YEAR",        
terms.CUM_CURRENT_START_DATE    "CUM CURRENT START DATE" ,         
terms.CUM_PREVIOUS_START_DATE   "CUM PREVIOUS START DATE" ,       
(SELECT fv5.meaning FROM FND_LOOKUPS fv5 WHERE fv5.LOOKUP_CODE = terms.CUM_ORG_LEVEL_CODE AND fv5.LOOKUP_TYPE = ''RLM_CUM_ORG_LEVEL'')  " CUM ORG LEVEL DESC",         
terms.CUM_ORG_LEVEL_CODE        "CUM ORG LEVEL CODE",        
(SELECT fv6.meaning FROM FND_LOOKUPS fv6 WHERE fv6.LOOKUP_CODE = terms.CUM_SHIPMENT_RULE_CODE AND  fv6.LOOKUP_TYPE = ''RLM_CUM_SHIPMENT_RULE'')  "CUM ORG RULE DESC",        
terms.CUM_SHIPMENT_RULE_CODE     "CUM SHIPMENT RULE CODE",        
terms.CUM_YESTERD_TIME_CUTOFF    "CUM YESTERDAY TIME CUTOFF",        
terms.CUST_ASSIGN_SUPPLIER_CD    "ASSIGNED SUPPLIER CODE",        
terms.CUSTOMER_RCV_CALENDAR_CD   "CUSTOMER CALENDAR",        
terms.UNSHIP_FIRM_CUTOFF_DAYS    "UNSHIP FIRM CUTOFF DAYS",        
fv3.meaning                      "UNSHIP FIRM DISP DESC",        
terms.UNSHIPPED_FIRM_DISP_CD     "UNSHIP FIRM DISP CODE",        
(SELECT fv7.meaning FROM FND_LOOKUPS fv7 WHERE fv7.LOOKUP_CODE = terms.USE_EDI_SDP_CODE_FLAG AND  fv7.LOOKUP_TYPE = ''YES_NO'')  "USE EDI SDP FLAG DESC",        
terms.USE_EDI_SDP_CODE_FLAG      "USE EDI SDP FLAG",        
terms.INACTIVE_DATE              "INACTIVE DATE",        
terms.MATCH_ACROSS_KEY           "MATCH ACROSS",        
terms.MATCH_WITHIN_KEY           "MATCH WITHIN",       
(SELECT oeh.order_number FROM  oe_order_headers_all oeh WHERE oeh.header_id =terms.header_id)  "ORDER NUMBER",        
terms.HEADER_ID                  "HEADER ID",        
terms.PRICE_LIST_ID              "PRICE LIST ID",        
terms.CRITICAL_ATTRIBUTE_KEY     "CRITICAL ATTRIBUTE KEY",        
terms.PLN_FROZEN_DAY_FROM       "PLAN FROZEN DAY FROM " ,        
terms.PLN_FROZEN_DAY_TO         "PLAN FROZEN DAY TO" ,        
terms.PLN_FROZEN_FLAG           "PLAN FROZEN FLAG" ,        
terms.PLN_FIRM_DAY_FROM         "PLAN FIRM DAY FROM " ,        
terms.PLN_FIRM_DAY_TO           "PLAN FIRM DAY TO " ,        
terms.PLN_FORECAST_DAY_FROM     "PLAN FORECAST DAY FROM " ,        
terms.PLN_FORECAST_DAY_TO       "PLAN FORECAST DAY TO " ,        
terms.PLN_MRP_FORECAST_DAY_FROM "PLAN MRP FORECAST DAY FROM" ,        
terms.PLN_MRP_FORECAST_DAY_TO   "PLAN MRP FORECAST DAY TO " ,        
terms.SHP_FROZEN_DAY_FROM       "SHIP FROZEN DAY FROM" ,        
terms.SHP_FROZEN_DAY_TO         "SHIP FROZEN DAY TO" ,        
terms.SHP_FROZEN_FLAG           "SHIP FROZEN  FLAG" ,        
terms.SHP_FIRM_DAY_FROM         "SHIP FIRM DAY FROM " ,        
terms.SHP_FIRM_DAY_TO           "SHIP FIRM DAY TO " ,        
terms.SHP_FORECAST_DAY_FROM     "SHIP FORCEAST DAY FROM" ,        
terms.SHP_FORECAST_DAY_TO       "HIP FORCEAST DAY TO " ,        
terms.SHP_MRP_FORECAST_DAY_FROM "SHIP MRP FORECAST DAY FROM" ,        
terms.SHP_MRP_FORECAST_DAY_TO   "SHIP MRP FORECAST DAY TO " ,        
terms.SEQ_FROZEN_DAY_FROM       "SEQ FROZEN DAY FROM " ,        
terms.SEQ_FROZEN_DAY_TO         "SEQ FROZEN DAYTO" ,        
terms.SEQ_FROZEN_FLAG           "SEQ FROZEN FLAG " ,        
terms.SEQ_FIRM_DAY_FROM         "SEQ FRIM DAY FROM " ,        
terms.SEQ_FIRM_DAY_TO           "SEQ FRIM DAY TO " ,        
terms.SEQ_FORECAST_DAY_FROM     "SEQ FORCAST DAY FROM " ,        
terms.SEQ_FORECAST_DAY_TO       "SEQ FORCAST DAY TO " ,        
terms.SEQ_MRP_FORECAST_DAY_FROM "SEQ MRP FORECAST DAY FROM " ,        
terms.SEQ_MRP_FORECAST_DAY_TO    "SEQ MRP FORECAST DAY TO" ,         
(SELECT fv8.meaning FROM FND_LOOKUPS fv8 WHERE fv8.LOOKUP_CODE = terms.ROUND_TO_STD_PACK_FLAG AND  fv8.LOOKUP_TYPE = ''YES_NO'')  "ROUND TO STANDARD PACK DESC",        
terms.ROUND_TO_STD_PACK_FLAG     "ROUND TO STANDARD PACK " ,         
terms.STD_PACK_QTY               "STANDARD PACK " ,                
fv4.meaning                       "SCHEDULE HIERARCHY MEANING",        
terms.SCHEDULE_HIERARCHY_CODE     "SCHEDULE HIERARCHY CODE",        
terms.LAST_UPDATED_BY            "LAST UPDATED BY" ,         
terms.LAST_UPDATE_DATE           "LAST UPDATED DATE" ,         
terms.CREATION_DATE              "CREATION DATE" ,               
terms.INTRANSIT_CALC_BASIS        "INTRANSIT CALULATION BASIS",        
terms.DEFAULT_SHIP_FROM          "DEFAULT SHIP FROM" ,         
terms.ISSUE_WARNING_DROP_PARTS_FLAG "WARNING FOR DROPPED PARTS" ,         
terms.ORG_ID                      "ORG ID" ,         
terms.BLANKET_NUMBER              "BLANKET NUMBER" ,                
(SELECT fv9.meaning FROM FND_LOOKUPS fv9 WHERE fv9.LOOKUP_CODE = terms.RELEASE_RULE AND  fv9.LOOKUP_TYPE =''RLM_BLANKET_RELEASE_RULE'')  "RLEASE RULE DESC",       
terms.RELEASE_RULE               "RELEASE RULE" ,        
terms.RELEASE_TIME_FRAME         "RELEASE TIME FRAME" ,        
(SELECT fv10.meaning FROM FND_LOOKUPS fv10 WHERE fv10.LOOKUP_CODE = terms.RELEASE_TIME_FRAME_UOM AND  fv10.LOOKUP_TYPE = ''RLM_BLANKET_TIMEUOM'')  "RELEASE TIME UOM DESC",       
terms.RELEASE_TIME_FRAME_UOM     "Release Time UOM"     , 
(SELECT fv11.meaning FROM FND_LOOKUPS fv11 WHERE fv11.LOOKUP_CODE = terms.EXCLUDE_NON_WORKDAYS_FLAG AND fv11.LOOKUP_TYPE = ''YES_NO'')  "EXCLUDE NON WORKDAYS DESC",      
terms.EXCLUDE_NON_WORKDAYS_FLAG   "EXCLUDE NON WORKDAYS FLAG" ,        
terms.DISABLE_CREATE_CUM_KEY_FLAG  "DISABLE CREATE CUM KEY"  
FROM hz_parties  party,
             hz_cust_accounts_all cust_acct,
          rlm_cust_shipto_terms_all terms,
            org_organization_definitions orgdef,
           rlm_ship_delivery_codes shdel,
          fnd_lookups fv1,
           fnd_lookups fv2,
           fnd_lookups fv3,
           fnd_lookups fv4       
WHERE cust_acct.cust_account_id = terms.customer_id
        AND  party.party_id = cust_acct.party_id
        AND cust_acct.status = ''A'' 
       AND orgdef.organization_id = terms.ship_from_org_id
        AND fv1.lookup_type = ''RLM_CUM_CONTROL_CODE''
        AND fv1.lookup_code = terms.cum_control_code
        AND fv2.lookup_type = ''RLM_TIME_UOM''
        AND fv2.lookup_code = terms.TIME_UOM_CODE
        AND fv3.lookup_type = ''RLM_FIRM_DISP_CODE''
        AND fv3.lookup_code = terms.UNSHIPPED_FIRM_DISP_CD 
       AND fv4.lookup_type = ''RLM_SCHEDULE_HIERARCHY''
        AND fv4.lookup_code = terms.SCHEDULE_HIERARCHY_CODE
        AND shdel.ship_delivery_rule_name = terms.ship_delivery_rule_name 
       AND terms.address_id IS NULL
       AND NVL(''##$$REL_ORGID$$##'',0) in (0, terms.SHIP_FROM_ORG_ID)
       AND terms.customer_id  = ##$$REL_CUST_ID$$## ',
      p_title                  => 'Customer Processing Rule(s)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Processing Rule Customer Level information.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: RLM_PR_CUSTOMER_LEVEL');



debug('begin add_signature: RLM_PR_CUSTOMER_ITEM_LEVEL');
   l_info('##MASK##CUSTOMER NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19571',
      p_sig_id                 => 'RLM_PR_CUSTOMER_ITEM_LEVEL',
      p_sig_sql                => 'SELECT orgdef.organization_name  "SHIP FROM" ,         
orgdef.organization_code  "SHIP FROM CODE" ,         
party.party_name         "CUSTOMER NAME" ,         
cust_acct.account_number "CUSTOMER NUMBER" ,         
mci.customer_item_number "CUSTOMER ITEM NUMBER " ,         
mci.customer_item_desc   "CUSTOMER ITEM DESC " ,         
mcc.commodity_code       "COMMODITY CODE " ,         
terms.CUST_ITEM_TERMS_ID "CUST SHIP TO TERMS ID" ,         
terms.ADDRESS_ID "ADDRESS ID" ,         
terms.CUSTOMER_ID "CUSTOMER ID" ,         
terms.SHIP_FROM_ORG_ID  "SHIP FROM ORG ID" ,         
terms.INTRANSIT_TIME "INTRANSIT TIME" ,         
fv1.meaning "TIME UOM CODE MEANING" ,         
terms.TIME_UOM_CODE  "TIME UOF CODE" ,          
shdel.description "SHIP DELIVERY RULE DESC" ,         
terms.SHIP_DELIVERY_RULE_NAME "SHIP DELIVERY RULE NAME" ,         
terms.CUM_CURRENT_START_DATE    "CUM CURRENT START DATE" ,         
terms.CUM_PREVIOUS_START_DATE   "CUM PREVIOUS START DATE" ,         
(SELECT fv2.meaning FROM FND_LOOKUPS fv2 WHERE fv2.LOOKUP_CODE = terms.USE_EDI_SDP_CODE_FLAG AND fv2.LOOKUP_TYPE = ''YES_NO'') "USE EDI SDP FLAG DESC" ,         
terms.USE_EDI_SDP_CODE_FLAG     "USE EDI SDP FLAG" ,         
terms.INACTIVE_DATE             "INACTIVE DATE" ,        
(SELECT oeh.order_number FROM OE_ORDER_HEADERS_ALL oeh WHERE oeh.header_id =terms.header_id) "ORDER NUMBER" ,        
terms.HEADER_ID                 "HEADER ID" ,        
...
terms.SEQ_MRP_FORECAST_DAY_FROM "SEQ MRP FORECAST DAY FROM " ,        
terms.SEQ_MRP_FORECAST_DAY_TO    "SEQ MRP FORECAST DAY TO" ,        
(SELECT fv3.meaning FROM FND_LOOKUPS fv3 WHERE fv3.LOOKUP_CODE = terms.ROUND_TO_STD_PACK_FLAG AND  fv3.LOOKUP_TYPE = ''YES_NO'') "ROUND TO STANDARD PACK DESC" ,         
terms.ROUND_TO_STD_PACK_FLAG     "ROUND TO STANDARD PACK " ,         
terms.STD_PACK_QTY               "STANDARD PACK " ,         
terms.LAST_UPDATED_BY            "LAST UPDATED BY" ,         
terms.LAST_UPDATE_DATE           "LAST UPDATED DATE" ,         
...
terms.ORG_ID                      "ORG ID" ,         
terms.BLANKET_NUMBER              "BLANKET NUMBER" ,        
(SELECT fv4.meaning FROM FND_LOOKUPS fv4 WHERE fv4.LOOKUP_CODE = terms.RELEASE_RULE AND  fv4.LOOKUP_TYPE =''RLM_BLANKET_RELEASE_RULE'') "RLEASE RULE DESC" ,        
terms.RELEASE_RULE               "RELEASE RULE" ,        
terms.RELEASE_TIME_FRAME         "RELEASE TIME FRAME" ,       
(SELECT fv5.meaning FROM FND_LOOKUPS fv5 WHERE fv5.LOOKUP_CODE = terms.RELEASE_TIME_FRAME_UOM AND  fv5.LOOKUP_TYPE = ''RLM_BLANKET_TIMEUOM'') "RELEASE TIME UOM DESC" ,        
terms.RELEASE_TIME_FRAME_UOM    "RELEASE TIME UOM"    ,    
(SELECT fv6.meaning FROM FND_LOOKUPS fv6 WHERE fv6.LOOKUP_CODE = terms.EXCLUDE_NON_WORKDAYS_FLAG AND  fv6.LOOKUP_TYPE = ''YES_NO'') "EXCLUDE NON WORKDAYS DESC" ,        
terms.EXCLUDE_NON_WORKDAYS_FLAG   "EXCLUDE NON WORKDAYS FLAG" ,        
terms.DISABLE_CREATE_CUM_KEY_FLAG  "DISABLE CREATE CUM KEY"         
FROM hz_parties  party,
              hz_cust_accounts_all cust_acct,
           ...
           mtl_commodity_codes mcc,
               rlm_cust_item_terms_all terms,
               org_organization_definitions orgdef,
               rlm_ship_delivery_codes shdel,
              fnd_lookups fv1         
WHERE cust_acct.cust_account_id = terms.customer_id
         AND   terms.customer_item_id = mci.customer_item_id
         AND  mci.commodity_code_id = mcc.commodity_code_id
         AND  party.party_id = cust_acct.party_id
         AND cust_acct.status = ''A''
         AND orgdef.organization_id = terms.ship_from_org_id
         AND fv1.lookup_type = ''RLM_TIME_UOM''
        AND fv1.lookup_code = terms.TIME_UOM_CODE
        AND shdel.ship_delivery_rule_name = terms.ship_delivery_rule_name
        AND terms.address_id IS NULL
        AND NVL(''##$$REL_ORGID$$##'',0) in (0, terms.SHIP_FROM_ORG_ID)
        AND terms.customer_id  = ##$$REL_CUST_ID$$## 
        AND NVL(''##$$REL_CUST_ITEM$$##'',''0'') in (''0'',mci.customer_item_number)',
      p_title                  => 'Customer Item Processing Rule(s)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Processing Rule Customer Item Level information.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: RLM_PR_CUSTOMER_ITEM_LEVEL');



debug('begin add_signature: RLM_PR_ADDRESS_LEVEL');
   l_info('##MASK##ADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19570',
      p_sig_id                 => 'RLM_PR_ADDRESS_LEVEL',
      p_sig_sql                => 'SELECT orgdef.organization_name  "SHIP FROM" ,         
orgdef.organization_code  "SHIP FROM CODE" ,         
party.party_name         "CUSTOMER NAME" ,         
cust_acct.account_number "CUSTOMER NUMBER" ,       
acct_site.ece_tp_location_code   "ECE LOCATION CODE",      
loc.city                         "CITY",      
...
terms.CUSTOMER_ID 		"CUSTOMER ID" ,             
terms.SHIP_FROM_ORG_ID             "SHIP FROM ORG ID",      
fv1.meaning                       "CUM CONTROL CODE MEANING",      
terms.CUM_CONTROL_CODE            "CUM CONTROL CODE",       
terms.INTRANSIT_TIME             "INTRANSIT TIME",      
fv2.meaning                       "TIME UOM  MEANING",      
terms.TIME_UOM_CODE               "TIME UOM CODE",      
...
(SELECT fv6.meaning FROM FND_LOOKUPS fv6  WHERE fv6.LOOKUP_CODE = terms.CUM_SHIPMENT_RULE_CODE AND  fv6.LOOKUP_TYPE = ''RLM_CUM_SHIPMENT_RULE'')  "CUM ORG RULE DESC",      
terms.CUM_SHIPMENT_RULE_CODE     "CUM SHIPMENT RULE CODE",      
terms.CUM_YESTERD_TIME_CUTOFF    "CUM YESRDAY TIME CUTOFF",      
terms.CUST_ASSIGN_SUPPLIER_CD    "ASSIGN SUPPLIER CODE",      
terms.CUSTOMER_RCV_CALENDAR_CD   "CUSTOMER CALENDAR",      
terms.UNSHIP_FIRM_CUTOFF_DAYS    "UNSHIP FRIM CUTOFF DAYS",      
fv3.meaning                      "UNSHIP FRIM DISP DESC",      
terms.UNSHIPPED_FIRM_DISP_CD     "UNSHIP FRIM DISP CODE",      
(SELECT fv7.meaning FROM FND_LOOKUPS fv7 WHERE fv7.LOOKUP_CODE = terms.USE_EDI_SDP_CODE_FLAG AND  fv7.LOOKUP_TYPE = ''YES_NO'')  "USE EDI SDP FLAG DESC",      
terms.USE_EDI_SDP_CODE_FLAG      "USE EDI SDP FLAG",       
terms.INACTIVE_DATE              "INACTIVE DATE",       
terms.MATCH_ACROSS_KEY           "MATCH ACROSS",       
...
terms.SHP_MRP_FORECAST_DAY_TO   "SHIP MRP FORECAST DAY TO " ,        
terms.SEQ_FROZEN_DAY_FROM       "SEQ FROZEN DAY FROM " ,        
terms.SEQ_FROZEN_DAY_TO         "SEQ FROZEN DAY TO" ,        
terms.SEQ_FROZEN_FLAG           "SEQ FROZEN FLAG " ,        
terms.SEQ_FIRM_DAY_FROM         "SEQ FRIM DAY FROM " ,        
terms.SEQ_FIRM_DAY_TO           "SEQ FRIM DAY TO " ,        
terms.SEQ_FORECAST_DAY_FROM     "SEQ FORCAST DAY FROM " ,        
...
terms.LAST_UPDATE_DATE           "LAST UPDATED DATE" ,         
terms.CREATION_DATE              "CREATION DATE" ,       
terms.INTRANSIT_CALC_BASIS        "INTRANSIT CALCULATION BASIS",      
terms.DEFAULT_SHIP_FROM           "DEFAULT SHIP FROM",      
terms.ISSUE_WARNING_DROP_PARTS_FLAG  "WARNING FOR DROPPED PARTS",      
terms.ORG_ID                       "ORG ID" ,         
terms.BLANKET_NUMBER              "BLANKET NUMBER" ,        
...
WHERE cust_acct.cust_account_id = terms.customer_id
   ...
   AND acct_site.cust_acct_site_id = terms.address_id
    ...
    AND NVL(''##$$REL_ORGID$$##'',0) in (0, terms.SHIP_FROM_ORG_ID)
   AND terms.customer_id  = ##$$REL_CUST_ID$$##',
      p_title                  => 'Address Processing Rule(s)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Processing Rule Customer Address Level information.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: RLM_PR_ADDRESS_LEVEL');



debug('begin add_signature: RLM_PR_ADDRESS_ITEM_LEVEL');
   l_info('##MASK##ADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19572',
      p_sig_id                 => 'RLM_PR_ADDRESS_ITEM_LEVEL',
      p_sig_sql                => 'SELECT 
orgdef.organization_name  "SHIP FROM" ,        
orgdef.organization_code  "SHIP FROM CODE" ,        
party.party_name         "CUSTOMER NAME" ,        
cust_acct.account_number "CUSTOMER NUMBER" ,        
acct_site.ece_tp_location_code   "ECE LOCATION CODE",        
...
terms.CUM_PREVIOUS_START_DATE   "CUM PREVIOUS START DATE" ,        
(SELECT fv2.meaning FROM FND_LOOKUPS fv2 WHERE fv2.LOOKUP_CODE = terms.USE_EDI_SDP_CODE_FLAG AND fv2.LOOKUP_TYPE = ''YES_NO'') "USE EDI SDP FLAG DESC" ,        
terms.USE_EDI_SDP_CODE_FLAG     "USE EDI SDP FLAGg" ,        
terms.INACTIVE_DATE             "INACTIVE DATE" ,        
(SELECT oeh.order_number FROM OE_ORDER_HEADERS_ALL oeh WHERE oeh.header_id =terms.header_id) "ORDER NUMBER" ,        
terms.HEADER_ID                 "HEADER ID" ,
terms.PRICE_LIST_ID             "PRICE LIST ID " ,        
...
terms.SHP_FIRM_DAY_TO           "SHIP FIRM DAY TO " ,        
terms.SHP_FORECAST_DAY_FROM     "SHIP FORCEAST DAY FROM" ,        
terms.SHP_FORECAST_DAY_TO       "SHIP FORCEAST DAY TO " ,        
terms.SHP_MRP_FORECAST_DAY_FROM "SHIP MRP FORECAST DAY FROM" ,        
terms.SHP_MRP_FORECAST_DAY_TO   "SHIP MRP FORECAST DAY TO " ,        
terms.SEQ_FROZEN_DAY_FROM       "SEQ FROZEN DAY FROM " ,        
terms.SEQ_FROZEN_DAY_TO         "SEQ FROZEN DAY TO" ,        
...
terms.ROUND_TO_STD_PACK_FLAG     "ROUND TO STANDARD PACK" ,         
terms.STD_PACK_QTY               "STANDARD PACK" ,         
terms.LAST_UPDATED_BY            "LAST UPDATE BY" ,         
terms.LAST_UPDATE_DATE           "LAST UPDATE DATE" ,         
terms.CREATION_DATE              "CREATION DATE" ,         
terms.DEFAULT_SHIP_FROM          "DEFAULT SHIP FROM" ,         
terms.ISSUE_WARNING_DROP_PARTS_FLAG "WARNING FOR DROPPED PARTS" ,         
terms.ORG_ID                      "ORG ID" ,         
terms.BLANKET_NUMBER              "BLANKET NUMBER" ,        
(SELECT fv4.meaning FROM FND_LOOKUPS fv4 WHERE fv4.LOOKUP_CODE = terms.RELEASE_RULE AND fv4.LOOKUP_TYPE =''RLM_BLANKET_RELEASE_RULE'') "RELEASE RULE DESC" ,        
terms.RELEASE_RULE               "RELEASE RULE" ,        
terms.RELEASE_TIME_FRAME         "RELEASE TIME FRAME" ,       
(SELECT fv5.meaning FROM FND_LOOKUPS fv5 WHERE fv5.LOOKUP_CODE = terms.RELEASE_TIME_FRAME_UOM AND  fv5.LOOKUP_TYPE = ''RLM_BLANKET_TIMEUOM'') "RELEASE TIME FRAME DESC" ,        
terms.RELEASE_TIME_FRAME_UOM    "RELEASE TIME UOM"    ,    
(SELECT fv6.meaning FROM FND_LOOKUPS fv6 WHERE fv6.LOOKUP_CODE = terms.EXCLUDE_NON_WORKDAYS_FLAG AND fv6.LOOKUP_TYPE = ''YES_NO'') "EXCLUDE NON WORKDAYS DESC" ,        
terms.EXCLUDE_NON_WORKDAYS_FLAG   "EXCLUDE NON WORKDAYS FLAG" ,        
terms.DISABLE_CREATE_CUM_KEY_FLAG  "DISABLE CREATE CUM KEY"  
...
WHERE cust_acct.cust_account_id = terms.customer_id
     ...
     AND terms.customer_id  = ##$$REL_CUST_ID$$##
AND NVL(''##$$REL_CUST_ITEM$$##'',''0'') in (''0'',mci.customer_item_number)',
      p_title                  => 'Address Item Processing Rule(s)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Processing Rule Address Item Level information.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: RLM_PR_ADDRESS_ITEM_LEVEL');



debug('begin add_signature: RLM_MATCHING_ATTRIBUTES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19573',
      p_sig_id                 => 'RLM_MATCHING_ATTRIBUTES',
      p_sig_sql                => 'SELECT SUBSTR(lookup_code,INSTR(lookup_code, '','')+1) "MATCH CODE" ,         
meaning  "MATCH MEANING"   
FROM   fnd_lookups  
WHERE  lookup_type = ''RLM_OPTIONAL_MATCH_ATTRIBUTES''   
AND   enabled_flag = ''Y''  
ORDER BY 1 ',
      p_title                  => 'Matching Attributes ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Matching Attribute Codes and Meaning',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: RLM_MATCHING_ATTRIBUTES');



debug('begin add_signature: RLM_PROFILE_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19616',
      p_sig_id                 => 'RLM_PROFILE_OPTIONS',
      p_sig_sql                => 'select
 fpo.profile_option_name "PROFILE OPTION NAME",
 substrb(fpot.user_profile_option_name, 1, 50) "USER PROFILE OPTION NAME" ,
 decode(fpov.level_id, 10001,''Site'', 10004,''User'', 10003, ''Responsibility'')"LEVEL",
 fpov.profile_option_value "VALUE"
from  fnd_profile_options fpo, fnd_profile_options_tl fpot, (select pro.profile_option_id, pro.level_id,
 pro.profile_option_value,
 pro.creation_date,
 pro.last_update_date from fnd_profile_option_values pro where ( level_id = 10001 and level_value = 0 ) or (level_id = 10003 and level_value = 21622 ) or (level_id = 10004 and level_value = 6 )) fpov where fpov.profile_option_id (+) = fpo.profile_option_id and fpot.language = userenv(''LANG'') and fpot.profile_option_name = fpo.profile_option_name and (fpo.application_id in (662,663) OR (fpo.application_id = 660 and fpot.user_profile_option_name like ''OM%bug%'')) 
order by fpo.application_id,fpov.level_id',
      p_title                  => 'Profile Options (RLM and VEA)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Profile Options (RLM and VEA)',
      p_solution               => 'Profile Options (RLM and VEA)',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: RLM_PROFILE_OPTIONS');
...
BEGIN
  ...
  analyzer_title := 'Release Management (RLM) Schedule Analyzer';
...
debug('begin section: INTERFACE_RECORDS');
start_section('Interface Tables', 'INTERFACE_RECORDS');
   set_item_result(run_stored_sig('RLM_INTERFACE_HDR'));
   set_item_result(run_stored_sig('RLM_INTERFACE_LINE'));
end_section;
debug('end section: INTERFACE_RECORDS');

debug('begin section: SCHEDULES');
start_section('Schedule Tables', 'SCHEDULES');
   set_item_result(run_stored_sig('RLM_SCHEDULE_HDR'));
   set_item_result(run_stored_sig('RLM_SCHEDULE_LINE'));
   set_item_result(run_stored_sig('RLM_EXCEPTION'));
end_section;
debug('end section: SCHEDULES');

debug('begin section: ORDERLINES');
start_section('Sales Order Line(s)', 'ORDERLINES');
   set_item_result(run_stored_sig('RLM_ORDER_LINE'));
end_section;
debug('end section: ORDERLINES');

debug('begin section: SETUP');
start_section('Setup', 'SETUP');
   set_item_result(run_stored_sig('RLM_PR_CUSTOMER_LEVEL'));
   set_item_result(run_stored_sig('RLM_PR_CUSTOMER_ITEM_LEVEL'));
   set_item_result(run_stored_sig('RLM_PR_ADDRESS_LEVEL'));
   set_item_result(run_stored_sig('RLM_PR_ADDRESS_ITEM_LEVEL'));
   set_item_result(run_stored_sig('RLM_MATCHING_ATTRIBUTES'));
   set_item_result(run_stored_sig('RLM_PROFILE_OPTIONS'));
end_section;
