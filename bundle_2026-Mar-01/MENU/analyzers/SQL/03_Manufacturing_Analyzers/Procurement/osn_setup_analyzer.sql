...
REM |                                                                           |
REM | FILENAME                                                                  |
REM |    osn_setup_analyzer.sql                                                 |
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Procurement OBN Analyzer               |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE osn_setup_analyzer_pkg AUTHID DEFINER AS
...
----------------------------------------------------------------
FUNCTION ping (pHostName VARCHAR2, pPort NUMBER DEFAULT 1000) RETURN VARCHAR2;

FUNCTION p_cert_check(v_cert VARCHAR2) RETURN VARCHAR2;

FUNCTION get_file_ver(p_fileid NUMBER) RETURN VARCHAR2;


END osn_setup_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY osn_setup_analyzer_pkg AS
-- $Id: osn_setup_analyzer.sql, 200.31 2026/01/28 16:52:36 dfelton Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2104923.1));
...
-- OSN Specific
  ...
  g_cert                       VARCHAR2(250);
  path1                        VARCHAR2(250);
  g_cert_url                   VARCHAR2(240);



-- Variables for messaging only
  g_por_proxy_server_name      VARCHAR2(240);
  g_por_proxy_server_port      VARCHAR2(240);
  g_por_ca_cert_file_name      VARCHAR2(240);  
  g_RUNNING                    VARCHAR2(7);
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'OSNSET_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'OSNSET_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>OSNSET Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2104923.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/osn_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,584,EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,584,EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},584,EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/3896068" class="blacklink" target="new">
...
<div>&nbsp;</div>
<p>Version 200.31<br>
- Fix a Knowledge Article link to match Fusion Service reference (in the check for invalid index signature)</p><p>Version 200.30<br>
- Fix Knowledge Article links to match Fusion Service references<br>
- Include Framework improvements</p><p>Version 200.29<br>
- Updated sequence checks<br>
- Include Framework improvements for move to Fusion Service</p><p>Version 200.28<br>
- Updated leaf certificate checks per latest certificates active in Sep 2025 on OBN site<br>
- Include improved max sequence checks</p><p>Version 200.27<br>
- Include Apps Check and Framework improvements</p><div>Version 200.26<br>
- Updated patch checks for latest RUP patches<br>
- Include framework improvements</div>
<div>&nbsp;</div>
<div>Version 200.25<br>
- Improve sequence checks<br>
- Include framework improvements</div>
<div>&nbsp;</div>
<div>Version 200.24<br>
- Improve sequence checks in "Lifetime Support Policy" to check differently in 12c vs 11g<br>
- Add NOTE advising that the ping may not work for an instance that uses a proxy server<br>
- Improve PUNCHOUT setup check to include the specific prod and test urls for https://businessnetwork... and https://osn... as acceptable setup for the punchout content zone setup</div>
<div>&nbsp;</div>
<div>Version 200.23<br>
- Renamed "Lifetime Support Policy” section as “Critical Alerts” and added sequence checks<br>
- Include apps check and framework improvements</div>
<div><br>
Version 200.22<br>
- Updated the SQL in AC_PATCHES_APPLIED to include Language, Applied Flag is Y and truncated creation date to eliminate duplicates.<br>
- Improved other signature used across multiple analyzers<br>
- Implemented Analyzer framework improvements</div>
<div>&nbsp;</div>
<div>Version 200.21<br>
- Remove tablespace check for tablespace nearing max extents. &nbsp;DBAs have other tools to monitor for this, and this check is causing performance issues for some customers when running the analyzer - analyzer never completes. &nbsp;Therefore we are removing this from the analyzer.</div>
<div>&nbsp;</div>
<div>Version 200.20<br>
- Updated LEAF certificate check to match new OBN Prod Leaf certificate (September 2023)<br>
- Added new LEAF certificate check for OBN test (Non-Prod) to check new OBN Test Leaf certificate (September 2023)<br>
- Implemented Analyzer framework improvements<br>
<br>
Version 200.19<br>
- Analyzer framework updates<br>
<br>
Version 200.18<br>
- Added signature to show status of ECX Agent Listeners.&nbsp; Both of these listeners should have COMPONENT_STATUS = RUNNING, or show a Warning if not RUNNING.<br>
- Updated LEAF and INTERMEDIATE certificate checks to match the new certificates (September 2022) per Doc ID 2901206.1</div>
<div><br>
Version 200.17</div>
<div>1. Updated patch level checks</div>
<div>&nbsp;</div>
<div>Version 200.16</div>
<div>1. Framework and Apps Check improvements</div>
<div>&nbsp;</div>
<div>Version 200.15</div>
<div>1. Updated Root, Intermediate, Leaf certificate checks to match new certificates installed&nbsp;on OBN on 21-OCT-2021</div>
<div>2.&nbsp;Implemented Analyzer Framework updates and a few other improvements to signatures.&nbsp;</div>
<div>&nbsp;</div>
<div>Version 200.14</div>
<ul><li>New Signature to provide you the Java version that is supported under the OBN Connectivity Tile. Ensure you are on the supported version for the migration to the Cloud.</li>
<li>OBN re-branding of signature messaging.</li>
</ul>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,584,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,584,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},584,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
----------------------------------------------------------------
--------------------------------------------------
-- Custom function to ping server               -- 
--------------------------------------------------

FUNCTION ping (pHostName VARCHAR2, pPort NUMBER DEFAULT 1000) RETURN VARCHAR2 IS
...
--------------------------------------------------
-- Custom function to read cert file            -- 
--------------------------------------------------

FUNCTION p_cert_check (v_cert VARCHAR2) RETURN VARCHAR2 IS
  v_file                    UTL_FILE.FILE_TYPE;
  v_line                    VARCHAR2(32000);
  v_ok                      CONSTANT VARCHAR2(9) := 'INSTALLED';
  v_fail                    CONSTANT VARCHAR2(13) := 'NOT INSTALLED';
...
--  dbms_output.put_line('v_filename: ' || v_filename);
  ...
  -- Assign the cert filename to variable
   v_file       := UTL_FILE.FOPEN('OSN_SETUP_ANALYZER_DIRECTORY',''||v_filename||'','r');

 
  BEGIN
  LOOP
   UTL_FILE.GET_LINE(v_file, v_line);
   EXIT WHEN v_cert = v_line; 
  END LOOP; 
  END; 
...
BEGIN
    ...
    print_log('Processing recommended patches signature: OSN_PATCHES (check_rec_patches_1) "Recommended Patches" (version 7)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(1)(l_rows) := '20559497';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Fix for Bug 20559497';
   l_col_rows(5)(l_rows) := '[1943414.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19835592';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Fix for Bug 19835592';
   l_col_rows(5)(l_rows) := '[1937220.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19909850';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '1OFF:12.1.3:CVE-2014-3566 POODLE: XML GATEWAY AND SSLV3 VULNERABILITY';
   l_col_rows(5)(l_rows) := '[1943414.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.0' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '20488329';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Fix for Bug 20488329';
   l_col_rows(5)(l_rows) := '[1943414.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '11.5' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21610285';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '1OFF:11.5.10:CVE-2014-3566 POODLE: XML GATEWAY AND SSLV3 VULNERABILITY';
   l_col_rows(5)(l_rows) := '[1943414.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19866324';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Fix for Bug 19866324';
   l_col_rows(5)(l_rows) := '[1937220.1]';
...
END IF;
   ...
   l_sig.sigrepo_id := '3269';
   l_sig.title := 'Recommended Patches';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := 'There are recommended '||mask_text(g_apps_version, nvl( upper(''), 'NO_MASK') )||' patches that are not applied on this instance.';
...
Best Practice: Always ensure that you are on the latest code with all recommended patches applied. This will help avoid known issues, prevent potential data corruption and provide the latest features and functionality. Having a proactive patching plan and periodic proactive patching process in place are the best ways to stay current. ';
  ...
  -- Register
  l_step := '60';
  g_signatures('OSN_PATCHES') := l_sig;
...
BEGIN
    ...
    print_log('Processing recommended patches signature: PUNCHOUT_PATCHES (check_rec_patches_2) "Recommended Patches" (version 4)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21473055';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'This patch fixes the issue of punchout to supplier site not working with Java version less than 8 when the supplier site does not support TLSv1';
   l_col_rows(5)(l_rows) := '[2044734.1]';

END IF;

   l_extra_info('##SHOW_SQL##'):= 'Y';

   l_sig.sigrepo_id := '12566';
   l_sig.title := 'Recommended Patches';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := 'There are recommended '||mask_text(g_apps_version, nvl( upper(''), 'NO_MASK') )||' patches that are not applied on this instance.';
   l_sig.solution := '<ul><li>Please review list above and schedule to apply any unappplied patches as soon as possible.</li><li>Refer to the Knowledge Article indicated for more information about each patch.</li></ul>
...
Best Practice: Always ensure that you are on the latest code with all recommended patches applied. This will help avoid known issues, prevent potential data corruption and provide the latest features and functionality. Having a proactive patching plan and periodic proactive patching process in place are the best ways to stay current. ';
  ...
  -- Register
  l_step := '60';
  g_signatures('PUNCHOUT_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'PUNCHOUT_PATCHES',     -- sig ID
    l_sig,                              -- signature information
    l_col_rows,                         -- data
    l_hdr);                             -- headers
...
BEGIN
    ...
    print_log('Processing recommended patches signature: RUP_PROC_CODE_LEVEL_12_0 (check_rec_patches_3) "Recommended Procurement RUP Patches" (version 15)');
...
BEGIN
    ...
    print_log('Processing recommended patches signature: RUP_PROC_CODE_LEVEL_12_1 (check_rec_patches_4) "Recommended Procurement RUP Patches" (version 28)');
...
BEGIN
    ...
    print_log('Processing recommended patches signature: RUP_PROC_CODE_LEVEL_12_2 (check_rec_patches_5) "Recommended Procurement RUP Patches" (version 22)');
...
----------------------------------------------------------------
-- OSN Specific
  l_cert_profile                VARCHAR2(255);
  l_supplier_name               VARCHAR2(240);
  l_cert_url                    VARCHAR2(240);

-- variables for messaging only
  l_por_proxy_server_name       VARCHAR2(240);
  l_por_proxy_server_port       VARCHAR2(240);
  l_por_ca_cert_file_name       VARCHAR2(240);  
...
FUNCTION get_PUNCHOUTURL
   return VARCHAR2 IS
BEGIN
debug('begin sql token function: PUNCHOUTURL');
IF upper(p_supplier_name) is NOT NULL THEN
BEGIN
 SELECT url
 into l_cert_url
 ...
 WHERE zone_id in (select zone_id 
                   ...
                   where upper(supplier_name) like upper(p_supplier_name)
                   and rownum = 1);
return l_cert_url;
EXCEPTION WHEN NO_DATA_FOUND THEN
/* bug with returning null, first assign then return */
      l_cert_url := null;
     return l_cert_url;
END;
ELSE 
...
RETURN 'SELECT '||
		    ...
		    'FROM '||
			   'icx_cat_content_zones_b '||
                    'WHERE '||
			   'zone_id in (select zone_id '||
                            'from ICX_CAT_PUNCHOUT_ZONE_DETAILS '||
                            'where supplier_name like '||upper('p_supplier_name')||' '||
                            'and rownum = 1)';
ELSE 
      RETURN null;
END IF; 
*/
debug('end sql token function: PUNCHOUTURL');
END get_PUNCHOUTURL;
...
debug('begin populate parameters hash table');
   ...
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Supplier Name';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_supplier_name,'DISPLAY_FIRST_4_CHAR');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/01/28 16:52:35 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'osn_setup_analyzer.sql';
...
debug('begin parameter validation: p_supplier_name');
IF p_supplier_name IS NOT NULL THEN
BEGIN
SELECT UPPER(SUPPLIER_NAME)
INTO l_exists_val
FROM ICX_CAT_PUNCHOUT_ZONE_DETAILS
WHERE UPPER(SUPPLIER_NAME) = p_supplier_name and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Supplier Name');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_supplier_name failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_supplier_name');
...
l_step := '20';
    BEGIN
        ...
        AND e.profile_option_name IN ('POR_CACERT_FILE_NAME')
        AND  (a.level_id = 10001 )
        AND a.profile_option_value IS NOT NULL;
              EXCEPTION WHEN NO_DATA_FOUND THEN
              print_error('No value found for POR : CA Certificate File Name');
              raise invalid_parameters;
              l_por_ca_cert_file_name:= NULL;
    END;
...
-- Gather the proxy server name
l_step := '100';
    BEGIN
        SELECT
        a.profile_option_value "Profile Value"
        INTO l_por_proxy_server_name
        FROM fnd_profile_option_values a,
        fnd_application b,
        fnd_responsibility_tl c,
        fnd_user d,
        ...
        AND t.LANGUAGE = 'US'
        AND nvl(c.LANGUAGE,'US') = 'US'
        AND e.profile_option_name IN ('POR_PROXY_SERVER_NAME')
        AND a.level_id = 10001;
     /*   AND a.profile_option_value IS NOT NULL; */
              EXCEPTION WHEN NO_DATA_FOUND THEN
              l_por_proxy_server_name:= NULL;
    END;


-- Gather the proxy server port
l_step := '110';
    BEGIN
        SELECT
        a.profile_option_value "Profile Value"
        INTO l_por_proxy_server_port
        FROM fnd_profile_option_values a,
        fnd_application b,
        fnd_responsibility_tl c,
        fnd_user d,
        ...
        AND t.LANGUAGE = 'US'
        AND nvl(c.LANGUAGE,'US') = 'US'
        AND e.profile_option_name IN ('POR_PROXY_SERVER_PORT')
        AND a.level_id = 10001;
/*        AND a.profile_option_value IS NOT NULL; */
              EXCEPTION WHEN NO_DATA_FOUND THEN
              l_por_proxy_server_port := NULL;
    END;
...
g_por_proxy_server_name:= l_por_proxy_server_name;
g_por_proxy_server_port:= l_por_proxy_server_port;
g_por_ca_cert_file_name:= l_por_ca_cert_file_name;  
--g_user_name:= p2_user_name;
--g_responsibility_id:= p2_responsibility_id;
g_include_apps_check := p_include_apps_check;
g_cert_url := l_cert_url;
...
print_log('g_por_proxy_server_name= '||g_por_proxy_server_name);
print_log('g_por_proxy_server_port= '||g_por_proxy_server_port);
print_log('g_por_ca_cert_file_name= '||g_por_ca_cert_file_name);
...
print_log('g_cert_url = '||g_cert_url);
print_log('g_RUNNING = '||g_RUNNING);
...
debug('begin populate sql tokens hash table');
   ...
   g_sql_tokens('##$$PUNCHOUTURL$$##') := get_PUNCHOUTURL();
   l_system_function_var := null;
   g_masked_tokens('##$$PUNCHOUTURL$$##') := mask_text( g_sql_tokens('##$$PUNCHOUTURL$$##'), 'NO_MASK');
   g_sql_tokens('##$$SUPPLIER_NAME$$##') := p_supplier_name;
   g_masked_tokens('##$$SUPPLIER_NAME$$##') := mask_text( g_sql_tokens('##$$SUPPLIER_NAME$$##'), 'DISPLAY_FIRST_4_CHAR');
...
debug('begin add_signature: OSN_CERT_PROFILE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3271',
      p_sig_id                 => 'OSN_CERT_PROFILE',
...
ORDER BY e.profile_option_name,
         a.level_id DESC',
      p_title                  => 'POR Certificate Profile',
      p_fail_condition         => 'NRS',
      p_problem_descr          => '<p>Profile <strong>POR : CA Certificate File Name</strong> does not point to a valid file that includes the certificates your company''s server accepts</p>',
      p_solution               => '<p>Profile <strong>POR : CA Certificate File Name</strong> must point to a valid file that includes the certificates your company''s server accepts.</p><br>
See [1433185/FAQ2717#pocacert] FAQ : iProcurement Profile Options',
      p_success_msg            => '<p>Profile<strong> POR : CA Certificate File Name</strong> points to a valid file.</p>
<p>This profile option that punchout and transparent punchout content zones use when those catalogs reside on a secure site.</p>
<p>It specifies the file name that includes the certificates your company''s server accepts. <br />This file should be readable and should be accessible from the middle tier. If you have multiple JVMs, then this directory <br />should be accessible from all the JVMs.</p>
<p>By default, use the file $APACHE_TOP/Apache/conf/ssl.crt/ca-bundle.crt, where $APACHE_TOP is the root directory <br />where the Oracle Internet Application Server (iAS) is installed. The ca-bundle.crt file includes certificates from various <br />signing authorities. For more information, see the Oracle Procurement Buyer''s Guide to Punchout and Transparent Punchout.</p>
...
',
   ...
   l_info.delete;
debug('end add_signature: OSN_CERT_PROFILE');



debug('begin add_signature: OSN_PROFILES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3307',
      p_sig_id                 => 'OSN_PROFILES',
      p_sig_sql                => 'SELECT user_profile_option_name "Profile Option",
a.profile_option_value "Profile Value",
DECODE(a.level_id, 10001, ''Site'',
10002, ''Application'',
...
ORDER BY e.profile_option_name,
a.level_id DESC',
      p_title                  => 'POR Proxy Profiles',
      p_fail_condition         => 'NRS',
      p_problem_descr          => '<p>No proxy profile values have been defined.</p>
<p><strong>POR : Proxy Server Name</strong> - Used for punchout and transparent punchout catalogs. <br />It specifies the proxy server (Web Server) name if your Oracle iProcurement implementation has a proxy setup. <br />The proxy server is typically the same as the proxy server that is set up in users'' browsers in your company--for example, <br />www-proxy.company.com. <br />For more information, see the Oracle Procurement Buyer''s Guide to Punchout and Transparent Punchout.</p>
<p><strong>POR : Proxy Server Port -</strong>&nbsp;Used for punchout and transparent punchout catalogs. <br />It specifies the port on which the proxy server listens if your Oracle iProcurement implementation has a proxy setup. <br />The port is typically the same as the port that is set up in users'' browsers in your company--for example, 80. <br />For more information, see the Oracle Procurement Buyer''s Guide to Punchout and Transparent Punchout.</p>',
      p_solution               => '<p>See [1433185/FAQ2717#proxy] - FAQ : iProcurement Profile Options</p>
',
      p_success_msg            => '<p>The Proxy Profiles are setup with values.</p>
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: OSN_PROFILES');



debug('begin add_signature: OSN_PUNCHOUT_STORE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3306',
      p_sig_id                 => 'OSN_PUNCHOUT_STORE',
      p_sig_sql                => 'SELECT
...
WHERE
   contents.ZONE_ID = ##$$FK2$$##
   AND  stores.store_id = storecontent.store_id 
   AND  storecontent.content_id = contents.ZONE_ID 
   and  storecontent. content_TYPE <> ''SMART_FORM''',
      p_title                  => 'OBN Punchout Store',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Store has been setup to punchout to OBN.',
      p_solution               => '<p>A store must be defined with the punchout content zone assigned to it in order to be able to punchout to OBN.</p>
<ol>
<li>Navigate to iProcurement Catalog Administration responsibility</li>
<li>Click on the stores tab</li>
<li>click on the Create Stores button</li>
<li>Enter the Store name</li>
<li>Click Add Content Zone button and choose the Content Zone for the OBN Punchout</li>
<li>click Continue and then apply</li></ol>
See [2104442/KB156726] for detailed instructions with screenshots.',
      p_success_msg            => 'A required store has been found with a content zone setup for OBN',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OSN_PUNCHOUT_STORE');



debug('begin add_signature: OSN_PUNCHOUT_CONTENT_ZONE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3270',
      p_sig_id                 => 'OSN_PUNCHOUT_CONTENT_ZONE',
      p_sig_sql                => 'SELECT IcxCatContentZoneEO.ZONE_ID,
       IcxCatContentZoneEO.ZONE_ID "##$$FK2$$##",
       IcxCatContentZoneEO.TYPE,
       IcxCatContentZoneEO.NAME,
       IcxCatContentZoneEO.DESCRIPTION,
       IcxCatContentZoneEO.URL "PUNCHOUT URL",
       IcxCatContentZoneEO.IMAGE,
       PunchoutDetails.COMPANY_NAME "COMPANY NAME",
       PunchoutDetails.COMPANY_NUMBER "COMPANY ID",
       PunchoutDetails.ECGATEWAY_MAP_KEY1 "KEY 1",
       ...
       DECODE(TYPE, ''LOCAL'', ''Y'', ''N'') IS_LOCAL_ZONE,
       DECODE(TYPE, ''PUNCHOUT'', ''Y'', ''N'') IS_PUNCHOUT_ZONE,
       DECODE(TYPE, ''TRANSPARENT_PUNCHOUT'', ''Y'', ''N'') IS_TRANSPARENT_PUNCHOUT_ZONE,
       DECODE(TYPE, ''INFORMATIONAL'', ''Y'', ''N'') IS_INFORMATIONAL_ZONE,
       DECODE(TYPE, ''PUNCHOUT'', DECODE(PROTOCOL_SUPPORTED,''VIA_EXCHANGE'',''N'', ''Y''),''TRANSPARENT_PUNCHOUT'', ''Y'', ''N'')   IS_PUNCHOUT_OR_TRANSPUNCH_ZONE,
       DECODE(PROTOCOL_SUPPORTED, ''CXML_SUPPLIER'', ''Y'', ''TRANSPARENT_EXCHANGE'', ''Y'', ''TRANSPARENT_SUPPLIER'', ''Y'', ''N'') IS_COMMUNICATION_MODE_cXML,
       DECODE(PROTOCOL_SUPPORTED, ''CXML_SUPPLIER'', ''N'', ''TRANSPARENT_EXCHANGE'', ''N'', ''TRANSPARENT_SUPPLIER'', ''N'', ''Y'') IS_COMMUNICATION_MODE_XML,
       DECODE(PROTOCOL_SUPPORTED, ''XML_SUPPLIER'', ''Y'',''CXML_SUPPLIER'', ''Y'', ''TRANSPARENT_SUPPLIER'', ''Y'',''VIA_EXCHANGE'', ''Y'', ''N'') IS_ZONE_FOR_SUPPLIER_SITE,
       DECODE(TYPE, ''PUNCHOUT'', DECODE(PROTOCOL_SUPPORTED, ''CXML_SUPPLIER'', ''Y'', ''N''), ''TRANSPARENT_PUNCHOUT'', DECODE(PROTOCOL_SUPPORTED,''TRANSPARENT_SUPPLIER'',''Y'', ''N''), ''N'') IS_SUPPLIER_MODE_cXML,
       DECODE(TYPE, ''LOCAL'', ''N'',''PUNCHOUT'', DECODE(PROTOCOL_SUPPORTED,''VIA_EXCHANGE'',''N'', ''Y''),  ''Y'') IS_PUNCH_OR_TRANS_OR_INFO_ZONE,
       DECODE(TYPE, ''PUNCHOUT'', ''Y'', ''INFORMATIONAL'', ''Y'', ''N'') IS_PUNCH_OR_INFO_ZONE,
DECODE(IcxCatContentZoneEO.SUPPLIER_ATTRIBUTE_ACTION_FLAG, ''INCLUDE_ALL'', ''N'', ''EXCLUDE_ALL'', ''N'', ''Y'') IS_SPECIFIC_SUPPL_ATTACHED,
       DECODE(IcxCatContentZoneEO.CATEGORY_ATTRIBUTE_ACTION_FLAG, ''INCLUDE_ALL'', ''N'', ''Y'') IS_SPECIFIC_CATG_ATTACHED,
       DECODE(IcxCatContentZoneEO.SECURITY_ASSIGNMENT_FLAG, ''OU_SECURED'', ''Y'', ''N'') IS_SPECIFIC_OU_ATTACHED,
PunchoutDetails.NEGOTIATED_FLAG,
       DECODE(PROTOCOL_SUPPORTED,''EXCHANGE'',''Y'',''TRANSPARENT_EXCHANGE'', 1, ''TRANSPARENT_SUPPLIER'', ''Y'', ''N'') IS_USER_NAME_REQUIRED,
       DECODE(PROTOCOL_SUPPORTED, ''XML_SUPPLIER'', ''Y'', ''N'') IS_SUPPLIER_MODE_XML,
       DECODE(PROTOCOL_SUPPORTED, ''XML_SUPPLIER'', ''Y'',''TRANSPARENT_SUPPLIER'', ''Y'', ''N'') IS_COMP_INFO_REQUIRED,
       DECODE(PROTOCOL_SUPPORTED, ''TRANSPARENT_EXCHANGE'', ''Y'', ''N'' ) IS_EXCHANGE_NAME_REQUIRED,
       DECODE(PROTOCOL_SUPPORTED,''TRANSPARENT_SUPPLIER'',''Y'', ''N'') IS_SUPPLEMENTAL_INFO_REQUIRED,
       DECODE(PROTOCOL_SUPPORTED, ''EXCHANGE'', ''Y'',''TRANSPARENT_EXCHANGE'', ''Y'', ''N'') IS_ZONE_FOR_EXCHANGE_SITE,
       DECODE(IcxCatContentZoneEO.SECURITY_ASSIGNMENT_FLAG, ''RESP_SECURED'', ''Y'', ''N'') IS_SPECIFIC_RESP_ATTATCHED,
       DECODE(PROTOCOL_SUPPORTED, ''VIA_EXCHANGE'', ''Y'', ''N'') IS_VIA_EXCHANGE,
...
AND    IcxCatContentZoneEO.TYPE LIKE ''PUNCHOUT''
AND PunchoutDetails.protocol_supported like ''%EXCHANGE%''
AND    (UPPER(IcxCatContentZoneEO.URL) NOT LIKE ''HTTPS://BUSINESSNETWORK-PROD.ORACLE.COM/PUNCHOUT/PUNCHOUTLOGINSERVER%''
     AND UPPER(IcxCatContentZoneEO.URL) NOT LIKE ''HTTPS://BUSINESSNETWORK.ORACLE.COM/PUNCHOUT/PUNCHOUTLOGINSERVER%'' 
     AND UPPER(IcxCatContentZoneEO.URL) NOT LIKE ''HTTPS://OSN-PROD.ORACLE.COM/PUNCHOUT/PUNCHOUTLOGINSERVER%''
     AND UPPER(IcxCatContentZoneEO.URL) NOT LIKE ''HTTPS://OSN.ORACLE.COM/PUNCHOUT/PUNCHOUTLOGINSERVER%'')
',
      p_title                  => 'OBN Punchout setup',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'OBN Punchout is not pointing to a valid OBN URL',
      p_solution               => '<p>Please ensure that your punchout url is pointing to a valid url</p>
<p>see [435317/FAQ6446#aref_section22] for detailed steps</p>
<p>NOTE: acceptable url values are as follows:</p>
<ul>
<li>Production - <a href="https://businessnetwork-prod.oracle.com/punchout/punchoutloginserver">https://businessnetwork-prod.oracle.com/punchout/punchoutloginserver</a></li>
<li>Production - <a href="https://osn-prod.oracle.com/punchout/punchoutloginserver">https://osn-prod.oracle.com/punchout/punchoutloginserver</a></li>
<li>Test - <a href="https://businessnetwork.oracle.com/punchout/punchoutloginserver">https://businessnetwork.oracle.com/punchout/punchoutloginserver</a></li>
<li>Test - <a href="https://osn.oracle.com/punchout/punchoutloginserver">https://osn.oracle.com/punchout/punchoutloginserver</a></li>
</ul>
',
      p_success_msg            => 'OBN Punchout is pointing to the correct url',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('OSN_PUNCHOUT_STORE'),
      p_include_in_dx_summary  => nvl('Y','N'),
      p_version                => '18'
      );
   l_info.delete;
debug('end add_signature: OSN_PUNCHOUT_CONTENT_ZONE');



debug('begin add_signature: OSN_PRODUCTION_PING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3272',
      p_sig_id                 => 'OSN_PRODUCTION_PING',
      p_sig_sql                => 'select osn_setup_analyzer_pkg.ping(''osn-prod.oracle.com'', 80) STATUS from dual',
      p_title                  => 'OBN Production Connectivity',
      p_fail_condition         => '[STATUS] <> [OK]',
      p_problem_descr          => '<p><a href="https://osn-prod.oracle.com/">https://osn-prod.oracle.com/</a> is not reachable.</p>
<p>We have attempted to ping the <strong>OBN Production server</strong> from your instance without success.</p>
<p>A ping is where the analyzer has sent a data packet to the&nbsp;<strong>OBN Production server</strong>&nbsp;and if it receives a data packet back, then you have a connection. If it does not receive a packet back then there is no connectivity.</p>
<p>Note: This ping may not work if the instance uses a proxy server.</p>',
      p_solution               => 'See [1620906/FAQ5933#aref_section225] for the IP addresses that should be allowed passage thru the firewall.',
      p_success_msg            => '<p><a href="https://osn-prod.oracle.com/">https://osn-prod.oracle.com/</a> is accessible.</p>
<p>We have sent a ping to the <strong>OBN Production server</strong> from your instance with success.</p>
<p>A ping is where the analyzer has sent a data packet to the&nbsp;<strong>OBN Production server</strong>&nbsp;and if it receives a data packet back, then you have a connection. If it does not receive a packet back then there is no connectivity.</p>',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: OSN_PRODUCTION_PING');



debug('begin add_signature: EBS_MFG_PO_OSNSET_ECX_AGENT_LISTENER_STATUSES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24001',
      p_sig_id                 => 'EBS_MFG_PO_OSNSET_ECX_AGENT_LISTENER_STATUSES',
      p_sig_sql                => 'SELECT fcq.USER_CONCURRENT_QUEUE_NAME Container_Name, DECODE(fcp.OS_PROCESS_ID,NULL,''Not Running'',fcp.OS_PROCESS_ID) PROCID,
...
AND (component_name = ''ECX Inbound Agent Listener'' or component_name = ''ECX Transaction Agent Listener'')
...
',
      p_title                  => 'Status of  ECX Agent Listeners',
      p_fail_condition         => '[COMPONENT_STATUS] <> ['||mask_text(g_RUNNING, nvl( upper(''), 'NO_MASK') )||']',
      p_problem_descr          => 'Status of  ECX Inbound Agent Listener and ECX Transaction Agent Listener',
      p_solution               => 'The ECX agent listeners are not ''RUNNING''.  Both of the ECX agent listeners should have COMPONENT_STATUS = ''RUNNING'' for OBN transaction processing.  Review [562880/KB563984] - How To Diagnose Issues Related to OBN.',
      p_success_msg            => 'The agent listeners required for OBN transaction processing are ''RUNNING'' as expected, and as described in [562880/KB563984] - How To Diagnose Issues Related to OBN.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_OSNSET_ECX_AGENT_LISTENER_STATUSES');



debug('begin add_signature: AC_JAVA_VERSION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13207',
      p_sig_id                 => 'AC_JAVA_VERSION',
      p_sig_sql                => 'SELECT  dbms_java.get_ojvm_property(PROPSTRING=>''java.version'') "Java Version" FROM dual',
      p_title                  => 'Java Version',
      p_fail_condition         => 'RS',
      p_problem_descr          => '<p>The Java Version returned above is from the database and not the middle tier. To get the java version from the middle tier please run the command: java -version.</p>
<p>The trading partners will only be able to send documents to OSuN using TLS 1.2 as the TLS 1.0 &amp; 1.1 protocols will no longer be supported.</p>
<ul>
<li>Java 5 and below are not supported</li>
<li>Java 6 must be at Update 181 or higher</li>
<li>Java 7 must be at Update 131 or higher</li>
<li>Java 8 fully supports TLS 1.2.Whilst Java 8 fully supports TLS 1.2, it is not recommended as it has not yet been fully certified with E-Business Suite</li>
</ul>',
      p_solution               => '<p>See [2471318/FAQ4856] Oracle Supplier Network - Migration to New Oracle Cloud Infrastructure for details on the required setup and java version.</p>
<p>Also please review [2576810/KB105500] - TLS 1.2 Compliance For Punchout And XML/cXML Transactions</p>',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AC_JAVA_VERSION');



debug('begin add_signature: OSN_DUNS');
   l_info('##MASK##ORGANIZATION_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PARTY_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3308',
      p_sig_id                 => 'OSN_DUNS',
      p_sig_sql                => 'SELECT ORGANIZATION_PROFILE_ID,
       PARTY_ID,
       PARTY_NUMBER,
       ORGANIZATION_NAME,
       PARTY_NAME,
       DUNS_NUMBER_C
FROM   HZ_ORG_PROFILES_CPUI_V 
WHERE  length(rtrim(DUNS_NUMBER_C)) > 9 
OR     regexp_like(DUNS_NUMBER_C,''[^0-9]+'')',
      p_title                  => 'D-U-N-S Number',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The D-U-N-S Number is larger than 9 digits long, contains letters or special characters.',
      p_solution               => 'The D-U-N-S Number must be 9 numerical digits long and not contain any letters or special characters to work with OBN.</br>
To fix this:
<ol>
  <li>Navigate to the purchasing responsibility > Supply Base > Suppliers.</li>
  <li>Query the Supplier</li>
  <li>Click on Organization</li>
  <li>Enter the corrected D-U-N-S Number</li>
</ol> 

See [2189290/KB786920] - Searching for "D-U-N-S Number" with more than 9 Characters in Customer Form does not return results',
      p_success_msg            => 'All D-U-N-S Number are 9 digits long and do not contain any letters or special characters.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OSN_DUNS');



debug('begin add_signature: OSN_INTERMEDIATE_CERT_BUNDLE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3327',
      p_sig_id                 => 'OSN_INTERMEDIATE_CERT_BUNDLE',
      p_sig_sql                => 'select osn_setup_analyzer_pkg.p_cert_check(''MIIEvjCCA6agAwIBAgIQBtjZBNVYQ0b2ii+nVCJ+xDANBgkqhkiG9w0BAQsFADBh'') STATUS from dual',
      p_title                  => 'Intermediate OBN Certificate Bundle',
      p_fail_condition         => '[STATUS] <> [INSTALLED]',
      p_problem_descr          => 'OBN Intermediate Certificate is not in the Bundle file used for iProcurement punchout.</p>
<p>The OBN certificate needs to be added to the certificate bundle file in the server which is SSL enabled.&nbsp;</p>
<p><strong>For XML Transactions in OBN</strong>&nbsp;the OBN certificates are added in a different file, the EBS certificate wallet file, and allows the instance to receive the inbound messages from OBN. Usually, the wallet file is NOT the same as the file pointed to by profile option [ POR : CA Certificate File Name ] used for punchout.</p>
<p>For Oracle E-Business Suite, check notes below to see where the certificates are stored (wallet):</p>
<p>
[376700/KB837684] - Enabling SSL in Oracle E-Business Suite Release 12<br>
[123718/KB858097] - A Guide to Understanding and Implementing SSL with Oracle Applications 11i<br>
[2143101/KB848810] Enabling SSL or TLS in Oracle E-Business Suite Release 12.2 (KB848810)<br>
</p>
',
      p_solution               => 'Review [2901206/KB635462] Oracle Business Network - Renewal of SSL Certificates - September 2022, which contains instructions for updating the OBN Intermediate Certificate in the file pointed to by profile option [ POR : CA Certificate File Name ] used for punchout.</p>

Please note that the leaf and intermediate certificates are renewed in September 2022. Root level certificates are the same as before. <p><strong>If you are following the best practices of SSL and not maintaining leaf and intermediate level certificate of OBN in your trust store, you might not be affected.</strong>&nbsp; Review the above document for complete details.',
      p_success_msg            => 'OBN Intermediate Certificate is installed in the bundle file specified in profile option [ POR : CA Certificate File Name ] used for iProcurement punchout.
<p><strong>For XML Transactions in OBN</strong>&nbsp;the OBN certificates are added in a different file, the EBS certificate wallet file, and allows the instance to receive the inbound messages from OBN. Usually, the wallet file is NOT the same as the file pointed to by profile option [ POR : CA Certificate File Name ] used for punchout.</p>
<p>For Oracle E-Business Suite, check notes below to see where the certificates are stored (wallet):</p>
<p>
[376700/KB837684] - Enabling SSL in Oracle E-Business Suite Release 12<br>
...
',
   ...
   l_info.delete;
debug('end add_signature: OSN_INTERMEDIATE_CERT_BUNDLE');



debug('begin add_signature: OSN_LEAF_CERT_BUNDLE');
   l_info('##SHOW_SQL##'):= 'N';
  add_signature(
      p_sig_repo_id            => '3328',
      p_sig_id                 => 'OSN_LEAF_CERT_BUNDLE',
      p_sig_sql                => 'select osn_setup_analyzer_pkg.p_cert_check(''MIIG9TCCBd2gAwIBAgIQAV33NJCagAUur29ntxlUFTANBgkqhkiG9w0BAQsFADBP'') STATUS from dual',
      p_title                  => 'Leaf OBN Certificate Bundle',
      p_fail_condition         => '[STATUS] <> [INSTALLED]',
      p_problem_descr          => 'OBN Leaf Certificate is not in the Bundle file used for iProcurement punchout.</p>
<p>The OBN certificate needs to be added to the certificate bundle file in the server which is SSL enabled.&nbsp;</p>
<p><strong>For XML Transactions in OBN</strong>&nbsp;the OBN certificates are added in a different file, the EBS certificate wallet file, and allows the instance to receive the inbound messages from OBN. Usually, the wallet file is NOT the same as the file pointed to by profile option [ POR : CA Certificate File Name ] used for punchout.</p>
<p>For Oracle E-Business Suite, check notes below to see where the certificates are stored (wallet):</p>
<p>
...
[2143101/KB848810] Enabling SSL or TLS in Oracle E-Business Suite Release 12.2 (KB848810)<br>
      ...
      p_solution               => 'Review [2364367/FAQ6722] FAQ - Certificates in OBN, which contains the latest certificates for updating the OBN Leaf Certificate in the file pointed to by profile option [ POR : CA Certificate File Name ] used for punchout.</p>

Please note that the leaf certificate is renewed in September 2025. Root level and Intermediate certificates are the same as before. <p><strong>If you are following the best practices of SSL and not maintaining leaf level certificate of OBN in your trust store, you might not be affected.</strong>&nbsp; Review the above document for complete details.  FYI - You may also review [2901206/KB635462] for related information regarding certificate updates, although the latest certificate update occurred in September 2025.

Latest certificates available from https://businessnetwork.oracle.com/obn/vp/shell/help',
      p_success_msg            => 'OBN Leaf Certificate is installed in the bundle file specified in profile option [ POR : CA Certificate File Name ] used for iProcurement punchout.
<p><strong>For XML Transactions in OBN</strong>&nbsp;the OBN certificates are added in a different file, the EBS certificate wallet file, and allows the instance to receive the inbound messages from OBN. Usually, the wallet file is NOT the same as the file pointed to by profile option [ POR : CA Certificate File Name ] used for punchout.</p>
<p>For Oracle E-Business Suite, check notes below to see where the certificates are stored (wallet):</p>
<p>
[376700/KB837684] - Enabling SSL in Oracle E-Business Suite Release 12<br>
...
',
   ...
   l_info.delete;
debug('end add_signature: OSN_LEAF_CERT_BUNDLE');



debug('begin add_signature: OSN_ROOT_CERT_BUNDLE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3309',
      p_sig_id                 => 'OSN_ROOT_CERT_BUNDLE',
      p_sig_sql                => 'select osn_setup_analyzer_pkg.p_cert_check(''MIIDrzCCApegAwIBAgIQCDvgVpBCRrGhdWrJWZHHSjANBgkqhkiG9w0BAQUFADBh'') STATUS from dual',
      p_title                  => 'Root OBN Certificate Bundle',
      p_fail_condition         => '[STATUS] <> [INSTALLED]',
      p_problem_descr          => 'OBN Root Certificate is not in the Bundle file used for iProcurement punchout.</p>
<p>The OBN certificate needs to be added to the certificate bundle file in the server which is SSL enabled.&nbsp;</p>
<p><strong>For XML Transactions in OBN</strong>&nbsp;the OBN certificates are added in a different file, the EBS certificate wallet file, and allows the instance to receive the inbound messages from OBN. Usually, the wallet file is NOT the same as the file pointed to by profile option [ POR : CA Certificate File Name ] used for punchout.</p>
<p>For Oracle E-Business Suite, check notes below to see where the certificates are stored (wallet):</p>
<p>
...
[2143101/KB848810] Enabling SSL or TLS in Oracle E-Business Suite Release 12.2 (KB848810)<br>
      ...
      p_solution               => 'Review [2901206/KB635462] Oracle Business Network - Renewal of SSL Certificates - September 2022, which contains instructions for updating the OBN Root Certificate in the file pointed to by profile option [ POR : CA Certificate File Name ] used for punchout.</p>

Please note that the leaf and intermediate certificates are renewed in September 2022. The Root level certificate is the same as before.',
      p_success_msg            => 'OBN Root Certificate is installed in the bundle file specified in profile option [ POR : CA Certificate File Name ] used for iProcurement punchout.
<p><strong>For XML Transactions in OBN</strong>&nbsp;the OBN certificates are added in a different file, the EBS certificate wallet file, and allows the instance to receive the inbound messages from OBN. Usually, the wallet file is NOT the same as the file pointed to by profile option [ POR : CA Certificate File Name ] used for punchout.</p>
<p>For Oracle E-Business Suite, check notes below to see where the certificates are stored (wallet):</p>
<p>
[376700/KB837684] - Enabling SSL in Oracle E-Business Suite Release 12<br>
...
[2143101/KB848810] Enabling SSL or TLS in Oracle E-Business Suite Release 12.2 (KB848810)<br>
   ...
   l_info.delete;
debug('end add_signature: OSN_ROOT_CERT_BUNDLE');



debug('begin add_signature: EBS_MFG_PO_OSNSET_OBN_TEST_LEAF_CERT_BUNDLE');
   l_info('##SHOW_SQL##'):= 'N';
  add_signature(
      p_sig_repo_id            => '26807',
      p_sig_id                 => 'EBS_MFG_PO_OSNSET_OBN_TEST_LEAF_CERT_BUNDLE',
      p_sig_sql                => 'select osn_setup_analyzer_pkg.p_cert_check(''MIIG4zCCBcugAwIBAgIQBokEUrTOBJwa96gMyDEVYjANBgkqhkiG9w0BAQsFADBP'') STATUS from dual',
      p_title                  => 'Leaf OBN Certificate Bundle (for OBN Test / Non Prod)',
      p_fail_condition         => '[STATUS] <> [INSTALLED]',
      p_problem_descr          => 'OBN (Test) Leaf Certificate is not in the Bundle file used for iProcurement punchout.</p>
<p>If you use OBN Test (non-Prod) The OBN (Test) certificate needs to be added to the certificate bundle file in the server which is SSL enabled.&nbsp;</p>
<p><strong>For XML Transactions in OBN</strong>&nbsp;the OBN certificates are added in a different file, the EBS certificate wallet file, and allows the instance to receive the inbound messages from OBN. Usually, the wallet file is NOT the same as the file pointed to by profile option [ POR : CA Certificate File Name ] used for punchout.</p>
<p>For Oracle E-Business Suite, check notes below to see where the certificates are stored (wallet):</p>
<p>
[376700/KB837684] - Enabling SSL in Oracle E-Business Suite Release 12<br>
...
[2143101/KB848810] Enabling SSL or TLS in Oracle E-Business Suite Release 12.2 (KB848810)<br>
      ...
      p_solution               => 'Review [2364367/FAQ6722] FAQ - Certificates in OBN, which contains the latest certificates for updating the OBN Test Leaf Certificate in the file pointed to by profile option [ POR : CA Certificate File Name ] used for punchout.</p>

Please note that the leaf certificate is renewed in September 2025. Root level and Intermediate certificates are the same as before. <p><strong>If you are following the best practices of SSL and not maintaining leaf level certificate of OBN in your trust store, you might not be affected.</strong>&nbsp; Review the above document for complete details.  FYI - You may also review [2901206/KB635462] for related information regarding certificate updates, although the latest certificate update occurred in September 2025.

Latest certificates available from https://businessnetwork.oracle.com/obn/vp/shell/help',
      p_success_msg            => 'OBN Test Leaf Certificate is installed in the bundle file specified in profile option [ POR : CA Certificate File Name ] used for iProcurement punchout.
<p><strong>For XML Transactions in OBN</strong>&nbsp;the OBN certificates are added in a different file, the EBS certificate wallet file, and allows the instance to receive the inbound messages from OBN. Usually, the wallet file is NOT the same as the file pointed to by profile option [ POR : CA Certificate File Name ] used for punchout.</p>
<p>For Oracle E-Business Suite, check notes below to see where the certificates are stored (wallet):</p>
<p>
[376700/KB837684] - Enabling SSL in Oracle E-Business Suite Release 12<br>
...
',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_OSNSET_OBN_TEST_LEAF_CERT_BUNDLE');



debug('begin add_signature: PUNCHOUT_SUPPLIER_DETAILS');
   l_info('##MASK##VENDOR_NAME'):= 'DISPLAY_FIRST_4_CHAR';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11319',
      p_sig_id                 => 'PUNCHOUT_SUPPLIER_DETAILS',
      p_sig_sql                => 'SELECT VENDOR_ID,
VENDOR_NAME,
VENDOR_NAME_ALT,
SEGMENT1,
SUMMARY_FLAG,
...
HOLD_BY,
HOLD_DATE
FROM AP_SUPPLIERS WHERE 
   upper(vendor_name) LIKE ''##$$SUPPLIER_NAME$$##''',
      p_title                  => 'Punchout Supplier Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Please ensure an internal supplier exists for Punchout.',
      p_solution               => '<p>Refer [382890/KB718581]: Supplier and Supplier Site Not Populated On The Requisition From Punchout</p>',
      p_success_msg            => 'Internal Supplier is defined for Punchout.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PUNCHOUT_SUPPLIER_DETAILS');



debug('begin add_signature: OSN_SUP_PUNCHOUT_EDI_MAPPING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11318',
      p_sig_id                 => 'OSN_SUP_PUNCHOUT_EDI_MAPPING',
      p_sig_sql                => 'select XREF_DATA_ID "CROSS REFERENCE DATA ID", 
XREF_CATEGORY_ID "CATEGORY ID", 
DESCRIPTION, 
DIRECTION, 
XREF_CATEGORY_CODE "CATEGORY CODE", 
XREF_INT_VALUE	"Internal Value",
XREF_EXT_VALUE1	"External 1",
XREF_KEY1	KEY1,
XREF_KEY2	KEY2,
XREF_KEY3	KEY3,
XREF_KEY4	KEY4,
XREF_KEY5	KEY5,
XREF_EXT_VALUE2	"External 2",
XREF_EXT_VALUE3	"External 3",
XREF_EXT_VALUE4	"External 4",
XREF_EXT_VALUE5	"External 5"
from ece_xref_data 
   where xref_key1 in (select ECGATEWAY_MAP_KEY1 
      from ICX_CAT_PUNCHOUT_ZONE_DETAILS 
         where upper(supplier_name) like ''##$$SUPPLIER_NAME$$##'')',
      p_title                  => 'Punchout EDI Mapping',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Supplier EDI Mapping not defined.',
      p_solution               => '<p>Refer the following documents to verify EDI mapping setup:</p>
<ul>
<li>[438669/KB745933]: iProcurement Punchout Gives Error Indicating Unit Of Measure Is Not Configured For Purchasing (or Category is Invalid or Not Configured For Purchasing)</li>
<li>[434969/KB197264]: Category XYZ Is Not Configured For Punchout</li>
</ul>',
      p_success_msg            => 'EDI Mapping Setup is done.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OSN_SUP_PUNCHOUT_EDI_MAPPING');



debug('begin add_signature: OSN_SUP_PUNCHOUT_CONNECTIVITY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11372',
      p_sig_id                 => 'OSN_SUP_PUNCHOUT_CONNECTIVITY',
      p_sig_sql                => 'select osn_setup_analyzer_pkg.ping(''##$$PUNCHOUTURL$$##'', 80) STATUS from dual',
      p_title                  => 'Punchout Connectivity Test',
      p_fail_condition         => '[STATUS] <> [OK]',
      p_problem_descr          => 'Supplier connectivity test failed.',
      p_solution               => '<p>Refer the following document to verify Supplier Connectivity Setup.</p>
<p>[317606/KB757391]: Error Code: 201 Unable To Reach Supplier Site: UnknownHostException</p>
',
      p_success_msg            => 'Supplier connectivity test success.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OSN_SUP_PUNCHOUT_CONNECTIVITY');



debug('begin add_signature: PUNCHOUT_PROFILE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11317',
      p_sig_id                 => 'PUNCHOUT_PROFILE',
      p_sig_sql                => 'SELECT user_profile_option_name "Profile Option",
           a.profile_option_value "Profile Value",
           DECODE(a.level_id, 10001, ''Site'',
                              10002, ''Application'',
...
AND t.LANGUAGE             = ''US''
AND nvl(c.LANGUAGE,''US'') = ''US''
AND e.profile_option_name IN (''FND_SEC_ALLOW_UNRESTRICTED_REDIRECT'')
AND  (a.level_id = 10001 )
AND a.profile_option_value IS NOT NULL
AND a.profile_option_value = ''Y''
ORDER BY e.profile_option_name,
         a.level_id DESC',
      p_title                  => 'Allow Unrestricted Redirects',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Profile "Allow Unrestricted Redirects" is set to NO.',
      p_solution               => '<p>Please ensure that profile "Allow Unrestricted Redirects" is set to Yes</p>

<p>Refer the following document in this case: iProcurement Punchout Errors: [2286677/KB786587] An invalid redirect has been blocked</p>',
      p_success_msg            => 'Profile "Allow Unrestricted Redirects" setup is correct.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PUNCHOUT_PROFILE');



debug('begin add_signature: OSN_SUP_PUNCHOUT_STORE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11316',
      p_sig_id                 => 'OSN_SUP_PUNCHOUT_STORE',
...
WHERE stores.store_id = storecontent.store_id AND
      ...
      contents.ZONE_ID = storecontent.CONTENT_ID AND
      contents.ZONE_ID in (select zone_id 
      from ICX_CAT_PUNCHOUT_ZONE_DETAILS 
         where upper(supplier_name) like ''##$$SUPPLIER_NAME$$##'')
UNION ALL
...
AND stores.store_id in (select store_id 
      from ICX_CAT_STORE_CONTENTS 
         where content_id in (select zone_id 
            from ICX_CAT_PUNCHOUT_ZONE_DETAILS 
               where upper(supplier_name) like ''##$$SUPPLIER_NAME$$##'')) 
ORDER BY "Store Name"',
      p_title                  => 'Supplier Punchout Store Setup',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Valid Supplier Name not provided to fetch store setup or store setup not done for the Supplier.',
      p_solution               => 'Please ensure to provide valid supplier name.',
      p_success_msg            => 'A required store setup has been found for the supplier.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OSN_SUP_PUNCHOUT_STORE');



debug('begin add_signature: PUNCHOUT_SUPPLIER_SITE_DETAILS');
   l_info('##MASK##ADDRESS_LINE%'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##CITY'):= 'DISPLAY_FIRST_4_CHAR';
   l_info('##MASK##CUSTOMER_NUM'):= 'DISPLAY_FIRST_4_CHAR';
   l_info('##MASK##PHONE'):= 'DISPLAY_NONE';
   l_info('##MASK##TELEX'):= 'DISPLAY_FIRST_4_CHAR';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11320',
      p_sig_id                 => 'PUNCHOUT_SUPPLIER_SITE_DETAILS',
      p_sig_sql                => 'SELECT VENDOR_SITE_ID
,      VENDOR_ID
,      VENDOR_SITE_CODE
...
WHERE vendor_id IN
  (SELECT vendor_id FROM ap_suppliers WHERE upper(vendor_name) LIKE ''##$$SUPPLIER_NAME$$##'')',
      p_title                  => 'Punchout Supplier Site Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Please ensure an internal supplier and site exists for Punchout.',
      p_solution               => '<p>Refer following document: [382890/KB718581]: Supplier and Supplier Site Not Populated On The Requisition From Punchout</p>',
      p_success_msg            => 'Internal Supplier and Site is defined for Punchout.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PUNCHOUT_SUPPLIER_SITE_DETAILS');



debug('begin add_signature: OSN_SUP_PUNCHOUT_CONTENT_ZONE_SETUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11332',
      p_sig_id                 => 'OSN_SUP_PUNCHOUT_CONTENT_ZONE_SETUP',
      p_sig_sql                => 'SELECT IcxCatContentZoneEO.ZONE_ID,
       IcxCatContentZoneEO.TYPE,
       IcxCatContentZoneEO.NAME,
       IcxCatContentZoneEO.DESCRIPTION,
...
FROM   ICX_CAT_CONTENT_ZONES_VL IcxCatContentZoneEO,
       ICX_CAT_PUNCHOUT_ZONE_DETAILS PunchoutDetails
WHERE  IcxCatContentZoneEO.ZONE_ID = PunchoutDetails.ZONE_ID (+)
AND    IcxCatContentZoneEO.ZONE_ID in (select zone_id 
      from ICX_CAT_PUNCHOUT_ZONE_DETAILS 
         where upper(supplier_name) like ''##$$SUPPLIER_NAME$$##'')',
      p_title                  => 'Supplier Punchout Content Zone Setup',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Valid Supplier Name not provided to fetch content zone setup or Content Zone setup not done for the Supplier.',
      p_solution               => 'Please ensure to provide valid supplier name.',
      p_success_msg            => 'A required content zone setup has been found for the supplier.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OSN_SUP_PUNCHOUT_CONTENT_ZONE_SETUP');



debug('begin add_signature: OSN_SUP_PUNCHOUT_CONTENT_ZONE');
   l_info('##MASK##AUTHENTICATED_KEY'):= 'DISPLAY_NONE';
   l_info('##MASK##COMPANY_NAME'):= 'DISPLAY_FIRST_4_CHAR';
   l_info('##MASK##SUPPLIER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##USER_NAME'):= 'DISPLAY_NONE';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11315',
      p_sig_id                 => 'OSN_SUP_PUNCHOUT_CONTENT_ZONE',
      p_sig_sql                => 'SELECT ZONE_ID "Punchout Zone ID",
  PROTOCOL_SUPPORTED "Protocol Supported",
  USER_NAME "User Name",
  COMPANY_NAME "Buyer Company Name",
  COMPANY_NUMBER "Buyer Company Identity Key",
  SUPPLIER_NAME "Supplier Name",
  SUPPLIER_NUMBER "Supplier Identification",
  ECGATEWAY_MAP_KEY1 "Key1 of EC Gateway Mapping",
  VENDOR_ID "Supplier ID",
  VENDOR_SITE_ID "Supplier Site ID",
  ENCODING Encoding,
  PARTY_SITE_ID "Supplier''s Trading Partner ID",
  PARENT_ZONE_ID "Parent Content Zone ID",
  AUTHENTICATED_KEY "Authentication Key",
  USER_INFO_FLAG "User Info",
  LOCK_ITEM_FLAG "Are changes allowed",
  RETAIN_SESSION_FLAG "Retain Session",
  OPERATION_ALLOWED "Re-punchout Allowed",
  NEGOTIATED_FLAG "Negotiated"
FROM ICX_CAT_PUNCHOUT_ZONE_DETAILS
WHERE upper(supplier_name) LIKE ''##$$SUPPLIER_NAME$$##''',
      p_title                  => 'Supplier Punchout Setup',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Valid Supplier Name not provided to fetch content zone setup or Content Zone setup not done for the Supplier.',
      p_solution               => 'Please ensure to provide valid supplier name.',
      p_success_msg            => 'A required content zone setup has been found for the supplier.',
   ...
   l_info.delete;
debug('end add_signature: OSN_SUP_PUNCHOUT_CONTENT_ZONE');
...
debug('begin add_signature: ECX_PROFILES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5376',
      p_sig_id                 => 'ECX_PROFILES',
      p_sig_sql                => 'SELECT user_profile_option_name "Profile Option", 
a.profile_option_value "Profile Value", 
DECODE(a.level_id, 10001, ''Site'', 
10002, ''Application'', 
10003, ''Responsibility'', 
10004, ''User'',''Undefined'') "Level", 
DECODE(a.level_id, 10001, ''Site'', 
10002, b.application_short_name, 
10003, c.responsibility_name, 
10004, d.user_name, ''Undefined'') "Level Value", 
c.responsibility_id 
FROM fnd_profile_option_values a, 
fnd_application b, 
fnd_responsibility_tl c, 
...
AND t.LANGUAGE = ''US'' 
AND nvl(c.LANGUAGE,''US'') = ''US'' 
AND e.profile_option_name IN (''ECX_UTL_XSLT_DIR'', 
''ECX_OAG_LOGICALID'', 
''ECX_SERVER_TIMEZONE'', 
''ECX_SYS_ADMIN_EMAIL'', 
''ECX_XML_VALIDATE_FLAG'', 
''ECX_XML_MAXIMUM_SIZE'',
''ECX_UTL_LOG_DIR'') 
ORDER BY e.profile_option_name, 
a.level_id DESC',
      p_title                  => 'ECX System Specific Profiles',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'ECX System Specific Profiles',
      p_solution               => 'Verify the ECX System Specific Profile Settings',
      p_success_msg            => 'ECX System Specific Profile Settings',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ECX_PROFILES');



debug('begin add_signature: ECX_UTL_FILE_DIR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5377',
      p_sig_id                 => 'ECX_UTL_FILE_DIR',
      p_sig_sql                => 'select name,value
from   v$parameter
where  name = ''utl_file_dir''',
      p_title                  => 'UTL_FILE_DIR',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No UTL_FILE_DIR defined',
      p_solution               => 'The physical directories associated with the ECX_UTL_XSLT_DIR and ECX_UTL_LOG_DIR system profiles must be assigned to the utl_file_dir parameter in the INIT.ORA file. Also, make sure the physical directories are write-enabled. If necessary, make the changes and bounce the database. 

See [167474/KB784455] - Oracle XML Gateway Troubleshooting Guide ',
      p_success_msg            => 'UTL_FILE_DIR has been defined',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ECX_UTL_FILE_DIR');



debug('begin add_signature: ECX_MESSAGES_OUTBOUND');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5378',
      p_sig_id                 => 'ECX_MESSAGES_OUTBOUND',
      p_sig_sql                => 'select nvl(eq.corrid,''NULL'') as CORRID, count(*)
from APPLSYS.ecx_outqueue eq,all_queues uq
where eq.q_name = uq.name
and uq.queue_type = ''NORMAL_QUEUE''
and uq.owner = ''APPLSYS''
group by eq.corrid',
      p_title                  => 'Total Messages on Outbound Queue',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Total Messages on Outbound Queue ',
      p_solution               => 'Number reported represents the number of messages on the outbound queue awaiting processing by OTA or webMethods. If number is unusually high, check the individual totals in the OTA and webMethods queues. 
<br><br>
See [167474/KB784455#ECX_MESSAGE] - Oracle XML Gateway Troubleshooting Guide ',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: ECX_MESSAGES_OUTBOUND');



debug('begin add_signature: OTA_MESSAGES_OUTBOUND');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5379',
      p_sig_id                 => 'OTA_MESSAGES_OUTBOUND',
      p_sig_sql                => 'select nvl(eq.corrid,''NULL'') as CORRID, count(*)
from APPLSYS.ecx_outqueue eq,all_queues uq
where eq.q_name = uq.name
and uq.queue_type = ''NORMAL_QUEUE''
...
and uq.owner = ''APPLSYS''
group by eq.corrid',
      p_title                  => 'OTA_MESSAGES_OUTBOUND',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'OTA Msgs on Outbound Queue ',
      p_solution               => 'Number reported represents the number of messages on the outbound queue awaiting processing by OTA. This is a subset of the total. If number is unusually high, ensure OTA is running.
<br><br>
See [167474/KB784455#ECX_MESSAGE] - Oracle XML Gateway Troubleshooting Guide ',
      p_success_msg            => 'There are no messages in the outbound queue <br><br>
See [167474/KB784455#ECX_MESSAGE] - Oracle XML Gateway Troubleshooting Guide',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: OTA_MESSAGES_OUTBOUND');



debug('begin add_signature: WEBMETHODS_MESSAGES_OUTBOUND');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5380',
      p_sig_id                 => 'WEBMETHODS_MESSAGES_OUTBOUND',
      p_sig_sql                => 'select nvl(eq.corrid,''NULL'') as CORRID, count(*)
from APPLSYS.ecx_outqueue eq,all_queues uq
where eq.q_name = uq.name
and uq.queue_type = ''NORMAL_QUEUE''
and eq.corrid not in (''WEBMETHODS'',''OXTA'')
and uq.owner = ''APPLSYS''
group by eq.corrid',
      p_title                  => 'webMethods Messages on Outbound Queue',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'webMethods Messages on Outbound Queue ',
      p_solution               => 'Number reported represents the number of messages on the outbound queue awaiting processing by webMethods. This is a subset of the total. If number is unusually high, ensure webMethods is running. 
<br><br>
See [167474/KB784455#ECX_MESSAGE] - Oracle XML Gateway Troubleshooting Guide ',
      p_success_msg            => 'There are no messages on the outbound queue awaiting processing by webMethods.<br><br>
See [167474/KB784455#ECX_MESSAGE] - Oracle XML Gateway Troubleshooting Guide ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: WEBMETHODS_MESSAGES_OUTBOUND');



debug('begin add_signature: MESSAGES_INBOUND_QUEUE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5381',
      p_sig_id                 => 'MESSAGES_INBOUND_QUEUE',
      p_sig_sql                => 'select nvl(eq.corrid,''NULL'') as CORRID, count(*)
from APPLSYS.ecx_inqueue eq,all_queues uq
where eq.q_name = uq.name
and uq.queue_type = ''NORMAL_QUEUE''
and uq.owner = ''APPLSYS''
group by eq.corrid',
      p_title                  => 'Messages on Inbound Queue',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Messages on Inbound Queue  ',
      p_solution               => 'Number of messages on inbound queue (informational). As long as the agent for the inbound queue is enabled, the agent listener is running, and OTA/webMethods is running, these messages will be processed. See Start Agent Listeners in the following note for information on enabling agents and starting agent listeners. 
<br><br>
See [167474/KB784455#ECX_MESSAGE] - Oracle XML Gateway Troubleshooting Guide ',
      p_success_msg            => 'There are no messages in the inbound queue <br><br>
See [167474/KB784455#ECX_MESSAGE] - Oracle XML Gateway Troubleshooting Guide ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: MESSAGES_INBOUND_QUEUE');



debug('begin add_signature: XML_VERSION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5382',
      p_sig_id                 => 'XML_VERSION',
      p_sig_sql                => 'select ecx_utils.XMLVersion from dual',
      p_title                  => 'XML Version',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'XML Version',
      p_solution               => '<p>If value displayed is "FAIL", upgrade XML Parser to version 2.0.2.9 or higher.</p>
<p>The XML Parser version mentioned here is from the java component. This value is used to find out only whether the previous version is installed in the environment. The versions of plxml parser (plsql component of XML Parser) and corresponding PL/SQL wrappers created by load.sql could not be determined. Therefore, please check for any invalid XML Parser objects and invalid ECX objects. Oracle XML Gateway will not function properly, if the installation of XML Parser is not correct.</p>
<p>If you get "ORA-00932: inconsistent datatypes" error, then you need to reinstall XML Parser (java component and PL/SQL component) in the environment. Only XML Parser 2.0.2.9 is certified by Oracle E-Business Suite.</p>',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: XML_VERSION');



debug('begin add_signature: IS_WORKFLOW_EMBEDDED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5383',
      p_sig_id                 => 'IS_WORKFLOW_EMBEDDED',
      p_sig_sql                => 'select wf_core.translate(''WF_INSTALL'') "Install Mode" from dual',
      p_title                  => 'Is workflow Embedded',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Workflow installation type',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: IS_WORKFLOW_EMBEDDED');



debug('begin add_signature: OTA_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5384',
      p_sig_id                 => 'OTA_STATUS',
      p_sig_sql                => 'select decode(count(*),0,''Not Running'',''Running'') as OTA_STATUS
from gv$session vs
where vs.inst_id = userenv(''INSTANCE'')
and action like ''%OXTA%''',
      p_title                  => 'OTA Status',
      p_fail_condition         => '[OTA_STATUS] = [Not Running]',
      p_problem_descr          => 'OTA is Not Running',
      p_solution               => 'Restart OTA Server per [1087499/KB742187] - Cannot Start OXTA After Upgrade To R12.1.x 
<br><br>
Resources: </br>
[167474/KB784455] - Oracle XML Gateway Troubleshooting Guide</br>
[1087499/KB742187] - How to Configure OTA For XML Gateway in Release 12.1',
      p_success_msg            => 'OTA is Running',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: OTA_STATUS');



debug('begin add_signature: ECX_TRANSPORT_SOFTWARE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5385',
      p_sig_id                 => 'ECX_TRANSPORT_SOFTWARE',
      p_sig_sql                => 'SELECT /*+ ALL_ROWS */ substr(decode(vs.module,''SQL*Plus'',''Txn Delivery'', 
        decode(vs.program,''JDBC Thin Client'',''OTA'')),1,19 ) "Component" , 
        substr(ao.object_name,1,19) object_name, 
        substr(decode(vo.locked_mode, 
        ''2'',''Normal'',3,''Dead Lock''),1,9)   locked_mode 
FROM all_objects     ao, 
            v$locked_object vo, 
            gv$session       vs 
WHERE 
	 vs.inst_id = userenv(''INSTANCE'')            
AND	 ao.object_id = vo.object_id 
AND     vo.session_id = vs.sid 
AND     ( (ao.object_name like ''%ECX%'') OR ( ao.object_name like ''%HTTP%'')) 
AND ao.owner IN (''APPS'',''APPLSYS'',''APPS_MRC'',''AURORA$JIS$UTILITY$'',''ECX'',''MDSYS'',''ORDPLUGINS'',''OSE$HTTP$ADMIN'',''PORTAL30'',''PORTAL30_SSO'',''PUBLIC'',''RDW'',''SYS'',''SYSTEM'')
ORDER BY 1',
      p_title                  => 'ECX Transport Software',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'ECX Transport Software',
      p_solution               => 'The "LOCKED_MODE" value should be "Normal", but may appear as "DEADLOCK". Deadlocks are normal if they remain for a short period of time. If a deadlock persists for more than 10 minutes, there may be a serious problem. Note: webMethods is used in Oracle Exchange environments only. It is not used in ERP environments 
<br><br>
For further details see the documentation at <a href="https://docs.oracle.com/cd/E18727_01/doc.121/e12954/T319774T319791.htm" target="_blank">Oracle XML Gateway User''s Guide</a> 
',
      p_success_msg            => 'No Deadlock detected in webMethods ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ECX_TRANSPORT_SOFTWARE');



debug('begin add_signature: ECX_INVALIDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5386',
      p_sig_id                 => 'ECX_INVALIDS',
...
AND a.owner = ''APPS''
AND (a.object_name like ''ECX%'' OR
     (((a.object_name like ''%XML%'') OR
     (a.object_name like ''%xml%'')) AND
      (a.object_type = ''JAVA CLASS'') or (a.object_type = ''JAVA RESOURCE''))
     )
AND a.status = ''INVALID''',
      p_title                  => 'ECX Invalid Objects',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invalid ECX Objects exist',
      p_solution               => '<ul>
...
<li>See [167474/KB784455] - Oracle XML Gateway Troubleshooting Guide for an additional resource .</li>
</ul>
',
      p_success_msg            => 'No Invalid ECX Objects exist',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ECX_INVALIDS');



debug('begin add_signature: ECX_SERVICE_SUBSCRIPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7440',
      p_sig_id                 => 'ECX_SERVICE_SUBSCRIPTIONS',
      p_sig_sql                => 'SELECT e.name EVENT_NAME, DECODE(sub.guid, NULL, ''Subscription Not Defined'',
                                           DECODE(sub.rule_function, NULL, ''Not  Defined'', sub.rule_function || ''@'' || s.name)) RULE_FUNCTION,
...
WHERE  e.NAME IN  (''oracle.apps.ecx.processing.message.callback'',
...
ORDER BY e.name',
      p_title                  => 'Service Component Control Event Subscriptions',
      p_fail_condition         => '[STATUS] = [DISABLED]',
      p_problem_descr          => 'Disabled Service Component Control Event Subscriptions have been found',
      p_solution               => '<p><strong>To Enable the subscription:</strong></p>
<ol>
<li>As Workflow Administrator (SYSADMIN usually) navigate to Workflow Administrator Web responsibility.</li>
<li>Choose Business Events menu.</li>
<li>Go to Events tab and Search for&nbsp;the disabled subscription.</li>
<li>Press on Subscription pencil and change the status to Enabled.</li>
</ol>
<p>See [728015/KB565470] -&nbsp;Workflow Mailer Remains in Starting Status but does not Start</p>',
      p_success_msg            => 'Service Component Control Event Subscriptions are enabled.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ECX_SERVICE_SUBSCRIPTIONS');
...
debug('begin add_signature: ECX_APPLICATION_INSTALL_DETAILS');
   l_info('##SHOW_SQL##'):= 'N';
  add_signature(
      p_sig_repo_id            => '6997',
      p_sig_id                 => 'ECX_APPLICATION_INSTALL_DETAILS',
      p_sig_sql                => 'SELECT fav.application_name app_name, 
fav.application_short_name app_s_name, 
decode(fpi.status, ''I'', ''Yes'', 
''S'', ''Shared'', 
...
FROM fnd_application_vl fav, fnd_product_installations fpi
WHERE fav.application_id = fpi.application_id
AND fav.application_id = 174
order by 3',
      p_title                  => 'XML Gateway Application Installation Details',
      p_fail_condition         => '[inst_status] in ['||mask_text(g_c_shared, nvl( upper(''), 'NO_MASK') )||','||mask_text(g_c_no, nvl( upper(''), 'NO_MASK') )||']',
      p_problem_descr          => 'XML Gateway is set as Shared installed or Not installed',
      p_solution               => '',
      p_success_msg            => 'XML Gateway Installation Status',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ECX_APPLICATION_INSTALL_DETAILS');
...
BEGIN
  ...
  analyzer_title := 'Procurement OBN Analyzer';
  ...
  l_step := '15';
   validate_parameters(
    ...
    ,p_org_id                       => p_org_id
    ,p_supplier_name                => upper(p_supplier_name)
...
start_section('Recommended Patches', 'Recommended_Patches');
   set_item_result(check_rec_patches_1); /* Signature OSN_PATCHES */
   set_item_result(check_rec_patches_2); /* Signature PUNCHOUT_PATCHES */
end_section;
debug('end section: Recommended_Patches');

debug('begin section: Profiles');
start_section('Profiles', 'Profiles');
   set_item_result(run_stored_sig('OSN_CERT_PROFILE'));
   set_item_result(run_stored_sig('OSN_PROFILES'));
end_section;
debug('end section: Profiles');

debug('begin section: Content_Zone');
start_section('Content Zone', 'Content_Zone');
   set_item_result(run_stored_sig('OSN_PUNCHOUT_CONTENT_ZONE'));
end_section;
debug('end section: Content_Zone');

debug('begin section: OBN_Connectivity');
start_section('OBN Connectivity', 'OBN_Connectivity');
   set_item_result(run_stored_sig('OSN_PRODUCTION_PING'));
   set_item_result(run_stored_sig('EBS_MFG_PO_OSNSET_ECX_AGENT_LISTENER_STATUSES'));
   set_item_result(run_stored_sig('AC_JAVA_VERSION'));
end_section;
debug('end section: OBN_Connectivity');

debug('begin section: Supplier_Checks');
start_section('Supplier Setup / Configuration', 'Supplier_Checks');
   set_item_result(run_stored_sig('OSN_DUNS'));
...
debug('begin section: OBN_Certificates');
BEGIN    
      g_cert := g_sql_tokens('##$$CERT_NAME$$##');
      SELECT SUBSTR(g_cert, 0, INSTR(g_cert,'/', -1)-1) 
      INTO v_url 
      FROM dual; 
END;  
    print_log(g_sql_tokens('##$$CERT_NAME$$##'));
    print_log(v_url);
       
    
BEGIN        
      SELECT regexp_substr(g_cert,  '[^/]+$') 
      INTO v_filename 
      FROM dual;  
END;  
print_log(v_filename);

-- MUST create directory outside of FUNCTION p_cert_check
BEGIN
   path1 :='CREATE or REPLACE DIRECTORY OSN_SETUP_ANALYZER_DIRECTORY AS ''' || v_url || '''';
--   dbms_output.put_line('path1: ' || path1);
   execute immediate path1;
--   print_log(path1);
   execute immediate 'GRANT READ ON DIRECTORY OSN_SETUP_ANALYZER_DIRECTORY TO PUBLIC';
END;


start_section('OBN Certificates');
   set_item_result(run_stored_sig('OSN_ROOT_CERT_BUNDLE'));
   set_item_result(run_stored_sig('OSN_INTERMEDIATE_CERT_BUNDLE'));
   set_item_result(run_stored_sig('OSN_LEAF_CERT_BUNDLE'));
   set_item_result(run_stored_sig('EBS_MFG_PO_OSNSET_OBN_TEST_LEAF_CERT_BUNDLE'));
--   set_item_result(run_stored_sig('OSN_LEAF_CERT_BUNDLE_JUNE232017'));
--   set_item_result(run_stored_sig('SHA2_OSN_CERT'));
end_section;
debug('end section: OBN_Certificates');

debug('begin section: Punchout');
IF upper(p_supplier_name) is NOT NULL  THEN
   start_section('Punchout', 'Punchout');
      set_item_result(run_stored_sig('PUNCHOUT_SUPPLIER_DETAILS'));
      set_item_result(run_stored_sig('OSN_SUP_PUNCHOUT_EDI_MAPPING'));
      set_item_result(run_stored_sig('OSN_SUP_PUNCHOUT_CONNECTIVITY'));
      set_item_result(run_stored_sig('PUNCHOUT_PROFILE'));
      set_item_result(run_stored_sig('OSN_SUP_PUNCHOUT_STORE'));
      set_item_result(run_stored_sig('PUNCHOUT_SUPPLIER_SITE_DETAILS'));
      set_item_result(run_stored_sig('OSN_SUP_PUNCHOUT_CONTENT_ZONE_SETUP'));
      set_item_result(run_stored_sig('OSN_SUP_PUNCHOUT_CONTENT_ZONE'));
   end_section;
END IF;
debug('end section: Punchout');
...
debug('begin section: ecxver_sql');
start_section('ecxver.sql', 'ecxver_sql');
   set_item_result(run_stored_sig('ECX_PROFILES'));
   set_item_result(run_stored_sig('ECX_UTL_FILE_DIR'));
   set_item_result(run_stored_sig('ECX_MESSAGES_OUTBOUND'));
   set_item_result(run_stored_sig('OTA_MESSAGES_OUTBOUND'));
   set_item_result(run_stored_sig('WEBMETHODS_MESSAGES_OUTBOUND'));
   set_item_result(run_stored_sig('MESSAGES_INBOUND_QUEUE'));
   set_item_result(run_stored_sig('XML_VERSION'));
   set_item_result(run_stored_sig('IS_WORKFLOW_EMBEDDED'));
   set_item_result(run_stored_sig('OTA_STATUS'));
   set_item_result(run_stored_sig('ECX_TRANSPORT_SOFTWARE'));
   set_item_result(run_stored_sig('ECX_INVALIDS'));
   set_item_result(run_stored_sig('ECX_SERVICE_SUBSCRIPTIONS'));
end_section;
debug('end section: ecxver_sql');
...
IF g_sql_tokens('##$$APPS_CHECK$$##') = 'Y' THEN
   start_section('Diagnostic Apps Check', 'Diagnostic_Apps_Check');
      ...
      set_item_result(run_stored_sig('ECX_APPLICATION_INSTALL_DETAILS'));
   end_section;
END IF;
...
IF g_sql_tokens('##$$REL$$##') IS NOT NULL THEN
   start_section('Procurement Code Level', 'Procurement_Code_Level');
      IF substr(g_sql_tokens('##$$REL$$##'),1,4) = '12.0' THEN
         set_item_result(check_rec_patches_3); /* Signature RUP_PROC_CODE_LEVEL_12_0 */
      END IF;
      IF substr(g_sql_tokens('##$$REL$$##'),1,4) = '12.1' THEN
         set_item_result(check_rec_patches_4); /* Signature RUP_PROC_CODE_LEVEL_12_1 */
      END IF;
      IF substr(g_sql_tokens('##$$REL$$##'),1,4) = '12.2' THEN
         set_item_result(check_rec_patches_5); /* Signature RUP_PROC_CODE_LEVEL_12_2 */
      END IF;
   end_section;
END IF;
