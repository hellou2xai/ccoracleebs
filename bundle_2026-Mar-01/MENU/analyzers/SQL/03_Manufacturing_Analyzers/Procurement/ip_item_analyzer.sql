...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for iProcurement Item Analyzer             |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE ip_item_analyzer_pkg AUTHID DEFINER AS
...
PROCEDURE main
(            p_include_apps_check           IN VARCHAR2    DEFAULT NULL
...
END ip_item_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY ip_item_analyzer_pkg AS
-- $Id: ip_item_analyzer.sql, 200.34 2026/01/28 15:17:35 dfelton Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(1586248.1));
...
-- variables for messaging only
  g_org_name           VARCHAR2(240);
  g_org_id             NUMBER;
  g_item_num           VARCHAR2(40);
  g_line_id            NUMBER;
  g_line_num           NUMBER;
...
--Constants for use in 'fails when' in sig repo
g_c_shared  VARCHAR2(6);
g_c_no      VARCHAR2(2);
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'IPI_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'IPI_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>IPI Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=1586248.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/ip_item_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,366,EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,366,EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},366,EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/3435897" class="blacklink" target="new">
...
<div>&nbsp;</div>
<div>Version 200.34</div>
<ul><li>Fix Knowledge Article links to match Fusion Service references</li>
<li>Include Framework improvements</li>
</ul>
<div>Version 200.33</div>
<ul><li>Apps Check improvements</li>
<li>Sequence check improvements</li>
<li>Include Framework improvements for move to Fusion Service</li>
</ul>
<div>Version 200.32</div>
<ul><li>Include Apps Check and Framework improvements</li>
<li>For [ Blanket Agreement Status Not Approved Results in Blanket Items Showing Old Values in iProcurement Search Results ], improve the display text, problem description, and solution text to mention - Old Values - rather than Old Price, since this applies for any changed value (not just price) on the updated doc which is not yet approved</li>
<li>Check if the iProcurement category associated of the item / po line (iProcurement category corresponding to the po category) is included in the category browsing hierarchy tree or not.</li>
</ul>
<div>Version 200.31</div>
<div><ul><li>Added several new signatures in Specific Item Checks to show inventory org setup information including:<ul><li>Details from the MTL_PARAMETERS Table for all organizations in which this item is assigned</li>
<li>Full definition of all organizations from ORG_ORGANIZATION_DEFINITIONS Table in which this item is assigned</li>
<li>Full information on all the operating units from the HR_OPERATING_UNITS Table for all inventory organizations in which this item is assigned</li>
</ul>
</li>
<li>Added a few more Item image relate profile values to IP_SPECIFIC_PROFILES (iProcurement Specific Profile Values) shown in Proactive Recommendations</li>
<li>Include framework updates and minor changes to a few other signatures&nbsp;</li>
</ul>
</div>
<div>Version 200.30</div>
<div><ul><li>Include MTL_PARAMETERS for the org in the Setup Related data section</li>
<li>Improve the max sequence checks</li>
<li>Include framework updates</li>
<li>Include Image related profile options</li>
<li>Add image related columns to the Attribute Values displayed for PO Line Item</li>
</ul>
</div>
<div>Version 200.29</div>
<div><ul><li>Fix variable definition to avoid error when running for item number &gt; 20 characters</li>
<li>Add Description column to list of data shown from &nbsp;ICX_CAT_ATTRIBUTE_VALUES_TLP</li>
<li>Improve sequence checks in "Lifetime Support Policy" to check differently in 12c vs 11g</li>
</ul>
</div>
<div>Version 200.28</div>
<div><ul><li>Renamed "Lifetime Support Policy” section as “Critical Alerts” and added sequence checks</li>
<li>Include framework and apps check improvements</li>
</ul>
</div>
<p>Version 200.27</p><ul><li>Updated the SQL in AC_PATCHES_APPLIED to include Language, Applied Flag is Y and truncated creation date to eliminate duplicates.</li>
<li>Eliminate duplicate rows from Document Types</li>
<li>Implement Framework improvements and Patching updates</li>
</ul>
<p>&nbsp;</p>
            <br><br>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,366,'||l_sig.sigrepo_id||',EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,366,'||l_sig.sigrepo_id||',EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},366,'||l_sig.sigrepo_id||',EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,366,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,366,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},366,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
FUNCTION check_rec_patches_1 RETURN VARCHAR2 IS
  /* Signature IP_RECOMMENDED_PATCHES */
...
BEGIN
    ...
    print_log('Processing recommended patches signature: IP_RECOMMENDED_PATCHES (check_rec_patches_1) "Recommended Patches" (version 10)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_col_rows(1)(l_rows) := '19565629';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'CONSOLIDATED PATCH WITHOUT POPULATE_ICX_ENDECA.SQL';
   l_col_rows(5)(l_rows) := '[1674452.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '18381792';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Internal Item Not Available In iProcurement';
   l_col_rows(5)(l_rows) := '[1954984.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '18174751';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Inability To View A New Item In Iprocurement Associated To Quote';
   l_col_rows(5)(l_rows) := '[1918683.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '17862028';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Item not found in IP when BPA line set to expired and BPA PRE-APPROVED';
   l_col_rows(5)(l_rows) := '[1588653.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '16690524';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'This patch fixed the issue of valid items from approved quotations are not able to be searched for in iProcurement if quotations are created and approved in different dates.';
   l_col_rows(5)(l_rows) := '[1466184.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '16374319';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'This patch fixes the issue of new added bpa line can be searched for in iProcurement after performing cancel a line, even though the bpa status is requires reapproval.';
   l_col_rows(5)(l_rows) := '[1586524.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '13864366';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'This patch ships the concurrent request to diagnose the item search issues';
   l_col_rows(5)(l_rows) := '[1452360.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '11823557';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Searching iProcurement By Item Number Does Not Return Any Results From The BPA';
   l_col_rows(5)(l_rows) := '[1318651.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '9146994';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'When attempting to search for items, inactive items appear and when they are added to the cart, error was thrown. This is rectified after applying this patch';
   l_col_rows(5)(l_rows) := '[822733.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '9140891';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'iProcurement Users Cannot Search and Find Newly Defined Master Items Which are Associated to Existing Mapped Categories When Using RDBMS 11.2.0.1';
   l_col_rows(5)(l_rows) := '[1633427.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '8866249';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Items created in Item Open Interface not transferring to iProcurement.';
   l_col_rows(5)(l_rows) := '[1327431.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.0' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '16805850';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Source document not showing when searching catalog with modified internal item number';
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '12530695';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'This patch fixes the performance issue when re-extracing large GBPAs';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '9251059';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Items created in Item Open Interface not transferring to iProcurement';
   l_col_rows(5)(l_rows) := '[985766.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '9237356';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'This patch resolves the issue of items created in item open interface not appearing in iProc';
   l_col_rows(5)(l_rows) := '[985766.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26645256';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'This patch fixes the issue of user able to create content zone with empty data by clicking the Apply button multiple times even after patch 25912323:R12.ICX.B';
   l_col_rows(5)(l_rows) := '[2380864.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30378377';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'PUNCHOUT CALLBACK ITEMID VALUE + TURNING TO SPACE';
   l_col_rows(5)(l_rows) := '[2620879.1]';

END IF;

   l_extra_info('##SHOW_SQL##'):= 'Y';

   l_sig.sigrepo_id := '1278';
   l_sig.title := 'Recommended Patches';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := 'There are recommended '||mask_text(g_apps_version, nvl( upper(''), 'NO_MASK') )||' patches that are not applied on this '||mask_text(g_instance, nvl( upper(''), 'NO_MASK') )||' instance';
   l_sig.solution := '<ul><li>Please review list above and schedule to apply any unappplied patches as soon as possible.</li><li>Refer to the Knowledge Article indicated for more information about each patch.</li></ul>
For the most current recommendations, use the Patch Wizard or the Updates & Patches Tab in My Oracle Support. Further guidance can be found in the following documents:<br>
<ul>
<li>[222339/KB370175] Procurement Family Patch Release History (Including Latest Available Rollups)(KB370175)</li>
<li>[11086538/KA747] How to Find E-Business & E-Business Suite Technology Stack Patches (KA747)</li>
<li>[976188/KB739927] Patch Wizard Utility (KB739927)</li>
<li>[10940175/KA580] Patch Wizard FAQ (KA580)</li>
<li>[1077813/KB627816] Patch Wizard Overview Videos (KB627816)</li>
</ul>
...
Best Practice: Always ensure that you are on the latest code with all recommended patches applied. This will help avoid known issues, prevent potential data corruption and provide the latest features and functionality. Having a proactive patching plan and periodic proactive patching process in place are the best ways to stay current.';
   l_sig.success_msg := 'All recommended patches have been applied';
  ...
  -- Register
  l_step := '60';
  g_signatures('IP_RECOMMENDED_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'IP_RECOMMENDED_PATCHES',     -- sig ID
...
BEGIN
    ...
    print_log('Processing recommended patches signature: FWK_B (check_rec_patches_2) "Recommended Framework  Patches" (version 8)');
...
IF substr(g_rep_info('Apps Version'),1,6) = '12.1.3' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '22284589';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'FWK RELEASE B.DELTA.5';
   l_col_rows(5)(l_rows) := '[1931412.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '18936791';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'FWK RELEASE B.DELTA.4';
   l_col_rows(5)(l_rows) := '[1931412.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '15880118';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'OA FRAMEWORK 12.1.3.2';
   l_col_rows(5)(l_rows) := '[1931412.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '11894708';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'OA FRAMEWORK 12.1.3.1';
   l_col_rows(5)(l_rows) := '[1931412.1]';
...
END IF;
   ...
   l_sig.sigrepo_id := '10850';
   l_sig.title := 'Recommended Framework  Patches';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := 'There are recommended Framework patch(es) not applied to this '||mask_text(g_apps_version, nvl( upper(''), 'NO_MASK') )||' environment. <br>Please expand the list above for the details.';
   l_sig.solution := 'Above are the recommended Framework Codelevel ['||mask_text(g_fwk_level, nvl( upper(''), 'NO_MASK') )||'] patches for this '||mask_text(g_apps_version, nvl( upper(''), 'NO_MASK') )||' instance '||mask_text(g_instance, nvl( upper(''), 'NO_MASK') )||'.<br><br>

		For the most current recommended Framework patches, use [2300940/KB163512] - How to Identify what is the Framework Bundle Level Applied in 12.1 and 12.2 Installations.<br><br>
		For the most current EBS recommended patches, use Patch Wizard or the Updates & Patches Tab in My Oracle Support.<br>
   ...
   l_sig.success_msg := 'Congratulations!!<br>
		The latest recommended Framework Codelevel ['||mask_text(g_fwk_level, nvl( upper(''), 'NO_MASK') )||'] patches for this '||mask_text(g_apps_version, nvl( upper(''), 'NO_MASK') )||' instance '||mask_text(g_instance, nvl( upper(''), 'NO_MASK') )||' have been applied.<br><br>';
   l_sig.print_condition := 'ALWAYS';
   l_sig.fail_type := 'W';
   l_sig.print_sql_output := 'Y';
   l_sig.limit_rows := 'Y';
...
BEGIN
    ...
    print_log('Processing recommended patches signature: FWK_C4 (check_rec_patches_3) "Recommended Framework  Patches" (version 22)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.ATG_PF.C.delta.4 sets Framework 12.2.4 (C.4) codelevel';
   l_col_rows(5)(l_rows) := '[11186345]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.2.4 RUP (1617458.1) sets Framework 12.2.4 (C.4) codelevel';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21420257';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.4 (C.4) Bundle 1 (Obsoleted)';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21420272';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.4 (C.4) Bundle 2 (Obsoleted)';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21564727';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.4 (C.4) Bundle 3 (Obsoleted)';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21760224';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.4 (C.4) Bundle 4';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21981732';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.4 (C.4) Bundle 5 (Obsoleted)';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '22263785';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.4 (C.4) Bundle 6 (Obsoleted)';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '22544086';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.4 (C.4) Bundle 7';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '22730127';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.4 (C.4) Bundle 8';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '22892369';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.4 (C.4) Bundle 9';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '23119976';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.4 (C.4) Bundle 10';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '23329010';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.4 (C.4) Bundle 11';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '24007747';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.4 (C.4) Bundle 12';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '24618945';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.4 (C.4) Bundle 13';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '24911652';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.4 (C.4) Bundle 14';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25145239';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.4 (C.4) Bundle 15';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25582065';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.4 (C.4) Bundle 16';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26026963';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.4 (C.4) Bundle 17';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26924548';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.4 (C.4) Bundle 18';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '27252629';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.4 (C.4) Bundle 19';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '28034418';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.4 (C.4) Bundle 20';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '28948407';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.4 (C.4) Bundle 21';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30309169';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.4 (C.4) Bundle 22';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '20128685';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OTA.C TST1225:ATGUI:MODEL WINDOW OPENS WITH NPE ERROR MSG WHILE DELETETEST SEC, QB';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '18458856';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIE.C TST1224:WHILE MASS UPDATED BY PERCENT/AMOUNT, ENDING UP WITH AN ERROR PAGE';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '20075524';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.BEN.C TST1225:TCS DELETE STATEMENT MODAL POPUP NOT SHOWING NAME OF STATEMENT';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '20099840';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.BEN.C TST1225: POP UP FOR ICD TRANSACTION DETAILS TABLE DISPLAYS ERROR';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '31874491';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.4 (C.4) Bundle 23';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33650745';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.4 (C.4) Bundle 24';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35092100';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.4 (C.4) Bundle 25';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35661866';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.4 (C.4) Bundle 26';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36398995';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.4 (C.4) Bundle 27';
   l_col_rows(5)(l_rows) := '[11186345]';
...
END IF;
   ...
   l_sig.sigrepo_id := '10853';
   l_sig.title := 'Recommended Framework  Patches';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := 'There are recommended Framework patch(es) not applied to this '||mask_text(g_apps_version, nvl( upper(''), 'NO_MASK') )||' environment. <br>Please expand the list above for the details.';
   l_sig.solution := 'Above are the recommended Framework Codelevel ['||mask_text(g_fwk_level, nvl( upper(''), 'NO_MASK') )||'] patches for this '||mask_text(g_apps_version, nvl( upper(''), 'NO_MASK') )||' instance '||mask_text(g_instance, nvl( upper(''), 'NO_MASK') )||'.<br><br>

For the most current recommended Framework patches, use [2300940/KB163512] - How to Identify what is the Framework Bundle Level Applied in 12.1 and 12.2 Installations.<br><br> For the most current EBS recommended patches, use Patch Wizard or the Updates & Patches Tab in My Oracle Support.<br> 
Further guidance can be found in the following documents: 
<ul>
 <li>[11086538/KA747] How to Find EBS Patches and EBS Technology Patches</li>
 <li>[976188/KB739927] Patch Wizard Utility</li> <li>[10940175/KA580] Patch Wizard FAQ</li> 
</ul>
';
   l_sig.success_msg := 'Congratulations!!<br> 
The latest recommended Framework Codelevel ['||mask_text(g_fwk_level, nvl( upper(''), 'NO_MASK') )||'] patches for this '||mask_text(g_apps_version, nvl( upper(''), 'NO_MASK') )||' instance '||mask_text(g_instance, nvl( upper(''), 'NO_MASK') )||' have been applied.<br><br>';
...
BEGIN
    ...
    print_log('Processing recommended patches signature: FWK_C5 (check_rec_patches_4) "Recommended Framework  Patches" (version 26)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.ATG_PF.C.delta.5 sets Framework 12.2.5 (C.5) codelevel';
   l_col_rows(5)(l_rows) := '[11186345]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.2.5 RUP (1983050.1) sets Framework 12.2.5 (C.5) codelevel';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '22745072';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.5 (C.5) Bundle 2';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '22892644';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.5 (C.5) Bundle 3';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '23179558';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.5 (C.5) Bundle 4';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '23597151';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.5 (C.5) Bundle 5';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '24329530';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.5 (C.5) Bundle 6';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '24561446';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.5 (C.5) Bundle 7';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '24813943';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.5 (C.5) Bundle 8';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25124879';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.5 (C.5) Bundle 9';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25264693';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.5 (C.5) Bundle 10';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25633876';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.5 (C.5) Bundle 11';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25805309';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.5 (C.5) Bundle 12';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25964634';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.5 (C.5) Bundle 13';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26244104';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.5 (C.5) Bundle 14';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26440798';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.5 (C.5) Bundle 15';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26648248';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.5 (C.5) Bundle 16';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26823961';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.5 (C.5) Bundle 17';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '27014320';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.5 (C.5) Bundle 18';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '27256875';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.5 (C.5) Bundle 19';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '27476539';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.5 (C.5) Bundle 20';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '28183924';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.5 (C.5) Bundle 21';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '29582468';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.5 (C.5) Bundle 22';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30552929';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.5 (C.5) Bundle 23';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '31571414';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.5 (C.5) Bundle 24';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '32451763';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.5 (C.5) Bundle 25';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33279929';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.5 (C.5) Bundle 26';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35034874';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.5 (C.5) Bundle 27';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35661861';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.5 (C.5) Bundle 28';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36539792';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.5 (C.5) Bundle 29';
   l_col_rows(5)(l_rows) := NULL;
...
BEGIN
    ...
    print_log('Processing recommended patches signature: FWK_C6 (check_rec_patches_5) "Recommended Framework  Patches" (version 35)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.ATG_PF.C.delta.6 sets Framework 12.2.6 (C.6) codelevel';
   l_col_rows(5)(l_rows) := '[11186345]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.2.6 RUP (2114016.1) sets Framework 12.2.6 (C.6) codelevel';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '24301236';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 1';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25805360';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 2';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25958203';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 3';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26127158';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 4';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26382210';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 5';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26543378';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 6';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26792877';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 7';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26953578';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 8';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '27113797';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 9';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '27308923';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 10';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '27529582';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 11';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '27675364';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 12';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '27948803';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 13';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '28183913';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 14';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '28739010';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 15';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '28649181';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 16';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '28805689';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 17';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '28970079';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 18';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '29438310';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 19';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '29679234';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 20';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30095623';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 21';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30339377';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 22';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30543303';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 23';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30901459';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 24';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '31625670';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 25';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '31831920';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 26';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '32241515';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 27';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33194232';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 28';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33650713';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 29';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33869142';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 30';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '34160253';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 31';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '34500373';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 32';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '34702477';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 33';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35586016';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 34';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36236787';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 35';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36444299';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.6 (C.6) Bundle 36';
   l_col_rows(5)(l_rows) := '[11186345]';
...
BEGIN
    ...
    print_log('Processing recommended patches signature: FWK_C7 (check_rec_patches_6) "Recommended Framework Patches" (version 34)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.ATG_PF.C.delta.7 sets Framework 12.2.7 (C.7) codelevel';
   l_col_rows(5)(l_rows) := '[11186345]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.2.7 RUP (2230783.1) sets Framework 12.2.7 (C.7) codelevel';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '28830603';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.7 (C.7) Bundle 1';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '28963259';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.7 (C.7) Bundle 2';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '29232729';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.7 (C.7) Bundle 3';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '29679229';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.7 (C.7) Bundle 4';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '29880879';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.7 (C.7) Bundle 5';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30139276';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.7 (C.7) Bundle 6';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30369165';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.7 (C.7) Bundle 7';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30720143';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.7 (C.7) Bundle 8';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '31154508';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.7 (C.7) Bundle 9';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '31445005';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.7 (C.7) Bundle 10';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '31667105';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.7 (C.7) Bundle 11';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '31883479';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.7 (C.7) Bundle 12';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '32418566';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.7 (C.7) Bundle 13';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '32842344';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.7 (C.7) Bundle 14';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33137827';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.7 (C.7) Bundle 15';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33668766';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.7 (C.7) Bundle 16';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '34163479';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.7 (C.7) Bundle 17';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '34416999';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.7 (C.7) Bundle 18';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '34750181';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.7 (C.7) Bundle 19';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35211386';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.7 (C.7) Bundle 20';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35586029';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.7 (C.7) Bundle 21';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35726362';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.7 (C.7) Bundle 22';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36007453';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.7 (C.7) Bundle 23';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36556320';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.7 (C.7) Bundle 24';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37166190';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.7 (C.7) Bundle 25';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37490073';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.7 (C.7) Bundle 26';
   l_col_rows(5)(l_rows) := '[11186345]';
...
BEGIN
    ...
    print_log('Processing recommended patches signature: FWK_C8 (check_rec_patches_7) "Recommended Framework Patches" (version 23)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.ATG_PF.C.delta.8 sets Framework 12.2.9 (C.8) codelevel';
   l_col_rows(5)(l_rows) := '[11186345]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.2.9 RUP (2495027.1) sets Framework 12.2.9 (C.8) codelevel';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30098489';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.9 (C.8) Consolidated Patch';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30908501';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.9 (C.8) Bundle 1';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30980514';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.9 (C.8) Bundle 2';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '31189388';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.9 (C.8) Bundle 3';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '31466879';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.9 (C.8) Bundle 4';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '31829822';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.9 (C.8) Bundle 5';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '31943873';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.9 (C.8) Bundle 6';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '32130874';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.9 (C.8) Bundle 7';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '32308701';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.9 (C.8) Bundle 8';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '32642088';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.9 (C.8) Bundle 9';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '32856251';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.9 (C.8) Bundle 10';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33144986';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.9 (C.8) Bundle 11';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33506648';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.9 (C.8) Bundle 12';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '34257059';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.9 (C.8) Bundle 13';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '34459670';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.9 (C.8) Bundle 14';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '34771522';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.9 (C.8) Bundle 15';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35186320';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.9 (C.8) Bundle 16';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35726363';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.9 (C.8) Bundle 17';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36111379';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.9 (C.8) Bundle 18';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36539787';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.9 (C.8) Bundle 19';
   l_col_rows(5)(l_rows) := '[11186345]';
...
END IF;
   ...
   l_sig.sigrepo_id := '11930';
   l_sig.title := 'Recommended Framework Patches';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := 'There are recommended Framework patch(es) not applied to this '||mask_text(g_apps_version, nvl( upper(''), 'NO_MASK') )||' environment. <br>
Please expand the list above for the details.';
   l_sig.solution := 'Above are the recommended Framework Codelevel ['||mask_text(g_fwk_level, nvl( upper(''), 'NO_MASK') )||'] patches for this '||mask_text(g_apps_version, nvl( upper(''), 'NO_MASK') )||' instance '||mask_text(g_instance, nvl( upper(''), 'NO_MASK') )||'.<br><br>
...
BEGIN
    ...
    print_log('Processing recommended patches signature: FWK_C9 (check_rec_patches_8) "Recommended Framework Patches" (version 24)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.ATG_PF.C.delta.9 sets Framework 12.2.10 (C.9) codelevel';
   l_col_rows(5)(l_rows) := '[11186345]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.2.10 RUP (2666934.1) sets Framework 12.2.10 (C.9) codelevel';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '31947046';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.10 (C.9) Bundle 1';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33659063';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Image Patch for 12.2.10 Post Consolidated Patch Product Oracle Application Framework, replaces 32223114';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '32223114';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Image Patch for 12.2.10 Post Consolidated Patch Product Oracle Application Framework';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '32130969';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.10 (C.9) Bundle 2';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '32642176';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.10 (C.9) Bundle 3';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '32996407';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.10 (C.9) Bundle 4';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33193360';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.10 (C.9) Bundle 5';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33502107';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.10 (C.9) Bundle 6';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33584098';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.10 (C.9) Bundle 7';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33803987';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.10 (C.9) Bundle 8';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '34005885';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.10 (C.9) Bundle 9';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '34224460';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.10 (C.9) Bundle 10';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '34428198';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.10 (C.9) Bundle 11';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '34617585';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.10 (C.9) Bundle 12';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '34831430';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.10 (C.9) Bundle 13';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35061557';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.10 (C.9) Bundle 14';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35348157';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.10 (C.9) Bundle 15';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35563923';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.10 (C.9) Bundle 16';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35803698';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.10 (C.9) Bundle 17';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36050949';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.10 (C.9) Bundle 18';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36210696';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.10 (C.9) Bundle 19';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36499051';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.10 (C.9) Bundle 20';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36967243';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.10 (C.9) Bundle 21';
   l_col_rows(5)(l_rows) := '[11186345]';
...
BEGIN
    ...
    print_log('Processing recommended patches signature: FWK_C10 (check_rec_patches_9) "Recommended Framework Patches" (version 12)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.ATG_PF.C.delta.10 sets Framework 12.2.11 (C.10) codelevel';
   l_col_rows(5)(l_rows) := '[11186345]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.2.11 RUP (2758997.1) sets Framework 12.2.11 (C.10) codelevel';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33203715';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework POST-12.2.11 (C.10) CONSOLIDATED PATCH';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '34080121';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.11 (C.10) Bundle 1';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '34178812';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.11 (C.10) Bundle 2';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '34378600';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.11 (C.10) Bundle 3';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '34608422';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.11 (C.10) Bundle 4';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35009162';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.11 (C.10) Bundle 5';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35179004';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.11 (C.10) Bundle 6';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35396575';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.11 (C.10) Bundle 7';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35573634';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.11 (C.10) Bundle 8';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35812870';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.11 (C.10) Bundle 9';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36236796';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.11 (C.10) Bundle 10';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36526024';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.11 (C.10) Bundle 11';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36796062';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.11 (C.10) Bundle 12';
   l_col_rows(5)(l_rows) := '[11186345]';
...
BEGIN
    ...
    print_log('Processing recommended patches signature: FWK_C11 (check_rec_patches_10) "Recommended Framework Patches" (version 13)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33527666';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.ATG_PF.C.delta.11 sets Framework 12.2.12 (C.11) codelevel';
   l_col_rows(5)(l_rows) := '[11186345]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.2.12 RUP (2876726.1) sets Framework 12.2.12 (C.11) codelevel';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '34521952';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework (Fwk) Post-12.2.12 (C.11) Consolidated Patch';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35110825';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.12 (C.11) Bundle 1';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35413664';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.12 (C.11) Bundle 2';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35586004';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.12 (C.11) Bundle 3';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35837304';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.12 (C.11) Bundle 4';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36044545';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.12 (C.11) Bundle 5';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36239588';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.12 (C.11) Bundle 6';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36480621';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.12 (C.11) Bundle 7';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36715100';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.12 (C.11) Bundle 8';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37179039';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.12 (C.11) Bundle 9';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37392549';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.12 (C.11) Bundle 10';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37615353';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.12 (C.11) Bundle 11';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37920492';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.12 (C.11) Bundle 12';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '38211887';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Framework 12.2.12 (C.11) Bundle 13';
   l_col_rows(5)(l_rows) := '[11186345]';
...
BEGIN
    ...
    print_log('Processing recommended patches signature: EBS_ATG_FWK_C12 (check_rec_patches_11) "Recommended Framework Patches" (version 8)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '34776645';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.ATG_PF.C.delta.12 sets Framework 12.2.13 (C.12) codelevel';
   l_col_rows(5)(l_rows) := '[11186345]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.2.13 RUP (2958077.1) sets Framework 12.2.13 (C.12) codelevel';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35706446';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Application Framework (FWK) Post-12.2.13 (C.12) Consolidated Patch';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36336844';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Application Framework (FWK) Release 12.2.13 (C.12) Bundle 1';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36526022';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Application Framework (FWK) Release 12.2.13 (C.12) Bundle 2';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37166157';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Application Framework (FWK) Release 12.2.13 (C.12) Bundle 3';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37421868';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Application Framework (FWK) Release 12.2.13 (C.12) Bundle 4';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37944329';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Application Framework (FWK) Release 12.2.13 (C.12) Bundle 5';
   l_col_rows(5)(l_rows) := '[11186345]';
...
Further guidance can be found in the following documents:
  ...
  -- Register
  l_step := '60';
  g_signatures('EBS_ATG_FWK_C12') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'EBS_ATG_FWK_C12',     -- sig ID
    l_sig,                              -- signature information
    l_col_rows,                         -- data
    l_hdr);                             -- headers
...
BEGIN
    ...
    print_log('Processing recommended patches signature: EBS_ATG_FWK_C13 (check_rec_patches_12) "Recommended Framework Patches" (version 7)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36034949';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.ATG_PF.C.delta.13 sets Framework 12.2.14 (C.13) codelevel';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36470037';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Application Framework (FWK) Post-12.2.14 (C.13) Consolidated Patch';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37423078';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Application Framework (FWK) Release 12.2.14 (C.13) Bundle 1';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37510766';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Application Framework (FWK) Release 12.2.14 (C.13) Bundle 2';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37907177';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Application Framework (FWK) Release 12.2.14 (C.13) Bundle 3';
   l_col_rows(5)(l_rows) := '[11186345]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '38221859';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Application Framework (FWK) Release 12.2.14 (C.13) Bundle 4';
   l_col_rows(5)(l_rows) := '[11186345]';
...
Further guidance can be found in the following documents:
  ...
  -- Register
  l_step := '60';
  g_signatures('EBS_ATG_FWK_C13') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'EBS_ATG_FWK_C13',     -- sig ID
    l_sig,                              -- signature information
    l_col_rows,                         -- data
    l_hdr);                             -- headers
...
FUNCTION check_rec_patches_13 RETURN VARCHAR2 IS
  /* Signature RUP_PROC_CODE_LEVEL_12_0 */
  l_col_rows   COL_LIST_TBL := col_list_tbl(); -- Row values
  l_rel_rows   COL_LIST_TBL := col_list_tbl(); -- Row release
  l_hdr        VARCHAR_TBL  := varchar_tbl(); -- Column headings
  l_app_date   DATE;         -- Patch applied date
...
BEGIN
    ...
    print_log('Processing recommended patches signature: RUP_PROC_CODE_LEVEL_12_0 (check_rec_patches_13) "Recommended Procurement RUP Patches" (version 15)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.0' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '4440000';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Release 12.0.0 - provides R12 baseline code for PRC_PF';
   l_col_rows(5)(l_rows) := '[222339.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Release 12.0.1';
   l_col_rows(5)(l_rows) := '[417917.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Release 12.0.2 - provides R12.PRC_PF.A.delta.2';
   l_col_rows(5)(l_rows) := '[430114.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Release 12.0.3 - provides R12.PRC_PF.A.delta.3';
   l_col_rows(5)(l_rows) := '[445192.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Release 12.0.4 - provides R12.PRC_PF.A.delta.4';
   l_col_rows(5)(l_rows) := '[465776.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Release 12.0.6 - provides R12.PRC_PF.A.delta.6';
   l_col_rows(5)(l_rows) := '[743368.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '7015582';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Procurement Release 12.0 Rollup Patch 5';
   l_col_rows(5)(l_rows) := '[580386.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '7218243';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Procurement R12.0 Update July 2008';
   l_col_rows(5)(l_rows) := '[727083.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '7291462';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Procurement R12.0 Update August 2008';
   l_col_rows(5)(l_rows) := '[732559.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '7355145';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Procurement R12.0 Update Sept 2008';
   l_col_rows(5)(l_rows) := '[737468.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '7433336';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Procurement R12.0 Update Oct 2008';
   l_col_rows(5)(l_rows) := '[743039.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '7505241';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Procurement R12.0 Update Nov 2008';
   l_col_rows(5)(l_rows) := '[749869.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '7600636';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Procurement R12.0 Update Dec 2008';
   l_col_rows(5)(l_rows) := '[755787.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '7691702';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Procurement R12.0 Update Jan 2009';
   l_col_rows(5)(l_rows) := '[764231.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '8298073';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Procurement R12.0 Update Mar 2009';
   l_col_rows(5)(l_rows) := '[790825.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '8392570';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Procurement R12.0 Update Apr 2009';
   l_col_rows(5)(l_rows) := '[810234.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '8474052';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Procurement R12.0 Update May 2009';
   l_col_rows(5)(l_rows) := '[832715.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '8555479';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Procurement R12.0 Update Jun 2009';
   l_col_rows(5)(l_rows) := '[852125.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '8658242';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Procurement R12.0 Update Jul 2009';
   l_col_rows(5)(l_rows) := '[863072.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '8781255';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Procurement R12.0 Update Aug 2009';
   l_col_rows(5)(l_rows) := '[876026.1]';

END IF;

   l_extra_info('##SHOW_SQL##'):= 'Y';

   l_sig.sigrepo_id := '7452';
   l_sig.title := 'Recommended Procurement RUP Patches';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := '<p>There are recommended Procurement RUP patches that are not applied on this '||mask_text(g_instance, nvl( upper(''), 'NO_MASK') )||' instance.</p>';
   l_sig.solution := '<ul>
<li>Please review list above and schedule to apply any unappplied recommended Procurement RUP patches as soon as possible</li>
<li>Refer to the Knowledge article indicated for more information about each patch</li>
<li>See [222339/KB370175] Procurement Family Patch Release History (Including Latest Available Rollups) (KB370175)</li>
</ul>
</br> For the most current recommendations, use the Patch Wizard or the Updates & Patches Tab in My Oracle Support. Further guidance can be found in the following documents:<br>
<ul><li>[11086538/KA747] How to Find E-Business & E-Business Suite Technology Stack Patches (KA747)</li>
<li>[976188/KB739927] Patch Wizard Utility (KB739927)</li>
<li>[10940175/KA580] Patch Wizard FAQ (KA580)</li>
<li>[1077813/KB627816] Patch Wizard Overview Videos (KB627816)</li>
</ul>
Best Practice: Always ensure that you are on the latest code with all recommended patches applied. This will help avoid known issues, prevent potential data corruption and provide the latest features and functionality. Having a proactive patching plan and periodic proactive patching process in place are the best ways to stay current.';
   l_sig.success_msg := '<p><strong>All known recommended EBS Procurement RUP patches for release '||mask_text(g_apps_version, nvl( upper(''), 'NO_MASK') )||' have been applied.</strong><br /><br /> For the most current recommendations, use the Patch Wizard or the Updates & Patches Tab in My Oracle Support. Further guidance can be found in the following documents:<br> 
<ul><li>[11086538/KA747] How to Find E-Business & E-Business Suite Technology Stack Patches (KA747)</li>
<li>[976188/KB739927] Patch Wizard Utility (KB739927)</li>
<li>[10940175/KA580] Patch Wizard FAQ (KA580)</li>
<li>[1077813/KB627816] Patch Wizard Overview Videos (KB627816)</li>
...
Best Practice: Always ensure that you are on the latest code with all recommended patches applied. This will help avoid known issues, prevent potential data corruption and provide the latest features and functionality. Having a proactive patching plan and periodic proactive patching process in place are the best ways to stay current.';
  ...
  -- Register
  l_step := '60';
  g_signatures('RUP_PROC_CODE_LEVEL_12_0') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'RUP_PROC_CODE_LEVEL_12_0',     -- sig ID
    l_sig,                              -- signature information
    l_col_rows,                         -- data
    l_hdr);                             -- headers
...
FUNCTION check_rec_patches_14 RETURN VARCHAR2 IS
  /* Signature RUP_PROC_CODE_LEVEL_12_1 */
  l_col_rows   COL_LIST_TBL := col_list_tbl(); -- Row values
  l_rel_rows   COL_LIST_TBL := col_list_tbl(); -- Row release
  l_hdr        VARCHAR_TBL  := varchar_tbl(); -- Column headings
  l_app_date   DATE;         -- Patch applied date
...
BEGIN
    ...
    print_log('Processing recommended patches signature: RUP_PROC_CODE_LEVEL_12_1 (check_rec_patches_14) "Recommended Procurement RUP Patches" (version 28)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Release 12.1.1 - provides R12.1 baseline code for PRC_PF';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Release 12.1.2 - provides R12.PRC_PF.B.delta.2';
   l_col_rows(5)(l_rows) := '[949451.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Release 12.1.3 - provides R12.PRC_PF.B.delta.3';
   l_col_rows(5)(l_rows) := '[1081431.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '8522002';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.PRC_PF.B.delta.2';
   l_col_rows(5)(l_rows) := '[222339.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '9249354';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.PRC_PF.B.delta.3';
   l_col_rows(5)(l_rows) := '[222339.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '11817843';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Procurement R12.1.3 Update 2011/04 April 2011';
   l_col_rows(5)(l_rows) := '[1317150.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '10417963';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Procurement R12.1.3 Update 2011/02 February 2011';
   l_col_rows(5)(l_rows) := '[1294872.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '12661793';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Procurement R12.1.3 Update 2011/11 November 2011';
   l_col_rows(5)(l_rows) := '[1381130.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '13984450';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Procurement R12.1.3 Update 2012/06 June 2012';
   l_col_rows(5)(l_rows) := '[1469475.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '14254641';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Procurement R12.1.3 Update 2012/09 September 2012';
   l_col_rows(5)(l_rows) := '[1546504.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '15843459';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Procurement R12.1.3 Update 2013/03 March 2013';
   l_col_rows(5)(l_rows) := '[1538152.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '17525552';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Consolidated RUP covering iSupplier Portal Bug Fixes, Sourcing Bug Fixes post 12.1.3 and SLM new features';
   l_col_rows(5)(l_rows) := '[1591198.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '18120913';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Procurement R12.1.3 Update 2014/01 January 2014';
   l_col_rows(5)(l_rows) := '[1613481.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '17774755';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle E-Business Suite Release 12.1.3+ Recommended Patch Collection 1 [RPC1]';
   l_col_rows(5)(l_rows) := '[222339.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '18911810';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Procurement R12.1.3 Update 2014/07 July 2014';
   l_col_rows(5)(l_rows) := '[1613481.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19030202';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle E-Business Suite Release 12.1.3+ Recommended Patch Collection 2 [RPC2]';
   l_col_rows(5)(l_rows) := '[1920628.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19602627';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Procurement R12.1.3 Update 2015/03 March 2015 OBSOLETED';
   l_col_rows(5)(l_rows) := '[1468883.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '20203366';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle E-Business Suite Release 12.1.3+ Recommended Patch Collection 3 [RPC3]';
   l_col_rows(5)(l_rows) := '[222339.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '20224883';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle iSupplier Portal Latest Recommend Patch Consolidation (March 2015)';
   l_col_rows(5)(l_rows) := '[222339.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21198991';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Procurement R12.1.3 Update 2015/03 March 2015';
   l_col_rows(5)(l_rows) := '[1468883.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21236633';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle E-Business Suite Release 12.1.3+ Recommended Patch Collection 4 [RPC4]';
   l_col_rows(5)(l_rows) := '[2053709.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21669991';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Consolidation patch including bug fixes and new features for Sourcing, iSupplier Portal and Supplier Lifecycle Management';
   l_col_rows(5)(l_rows) := '[222339.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '22138765';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '22138765:R12.ICX.B - Oracle iProcurement Recommended Patch Collection (Nov. 2015)';
   l_col_rows(5)(l_rows) := '[222339.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '22254174';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '22254174:R12.ICX.B - Oracle iProcurement Consolidation Patch for 12.1.3 - Feb 2016';
   l_col_rows(5)(l_rows) := '[2108006.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '22254592';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '22254592:R12.PO.B - Oracle Purchasing Consolidation Patch for 12.1.3 - Feb 2016';
   l_col_rows(5)(l_rows) := '[2105677.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle E-Business Suite Release 12.1.3+ Recommended Patch Collection 5 [RPC5]';
   l_col_rows(5)(l_rows) := '[2152266.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '22779630';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '22779630:R12.PO.B - Oracle Purchasing Consolidation Patch for 12.1.3 - Apr 2016';
   l_col_rows(5)(l_rows) := '[2129056.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '22779803';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '22779803:R12.ICX.B - Oracle iProcurement Consolidation Patch for 12.1.3 - Apr 2016';
   l_col_rows(5)(l_rows) := '[2129058.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '23256401';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '23256401:R12.PO.B - Oracle Purchasing Consolidation Patch for 12.1.3 - Jun 2016';
   l_col_rows(5)(l_rows) := '[2161091.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '23295577';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '23295577:R12.ICX.B - Oracle iProcurement Consolidation Patch for 12.1.3 - Jun 2016';
   l_col_rows(5)(l_rows) := '[2161150.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '24286939';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle iSupplier Portal Latest Recommend Patch Consolidation (July 2016)';
   l_col_rows(5)(l_rows) := '[222339.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '24287284';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Sourcing Recommended Patch Collection July 2016';
   l_col_rows(5)(l_rows) := '[222339.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '24311118';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '24311118:R12.PO.B - Oracle Purchasing Consolidation Patch for 12.1.3 - October 2016';
   l_col_rows(5)(l_rows) := '[2200755.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '24596485';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '24596485:R12.ICX.B - Oracle iProcurement Consolidation Patch for 12.1.3 - Oct 2016';
   l_col_rows(5)(l_rows) := '[2200778.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25110937';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '25110937:R12.PRC_PF.B - Oracle Sourcing, iSupplier Portal, Supplier Lifecycle Management, Supplier Hub Consolidation Patch for 12.1.3 - Nov 2016';
   l_col_rows(5)(l_rows) := '[2214131.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25140095';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '25140095:R12.ICX.B - Oracle iProcurement Consolidation Patch for 12.1.3 - Jan 2017';
   l_col_rows(5)(l_rows) := '[2229253.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25141263';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '25141263:R12.PO.B - Oracle Purchasing Consolidation Patch for 12.1.3 - January 2017';
   l_col_rows(5)(l_rows) := '[2229232.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25687666';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '25687666:R12.ICX.B - Oracle iProcurement Consolidation Patch for 12.1.3 - Apr 2017';
   l_col_rows(5)(l_rows) := '[2259875.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25680268';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '25680268:R12.PO.B - Oracle Purchasing Consolidation Patch for 12.1.3 - April 2017';
   l_col_rows(5)(l_rows) := '[2259833.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25982732';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Purchasing Consolidation Patch for 12.1.3 - June 2017';
   l_col_rows(5)(l_rows) := '[2308900.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26035964';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle iProcurement Consolidation Patch for 12.1.3 - June 2017';
   l_col_rows(5)(l_rows) := '[2287222.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26483540';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Purchasing Consolidation Patch for 12.1.3 - September 2017';
   l_col_rows(5)(l_rows) := '[1468883.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26521974';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle iProcurement Consolidation Patch for 12.1.3 - September 2017';
   l_col_rows(5)(l_rows) := '[2308950.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26877060';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Purchasing Consolidation Patch for 12.1.3 - November 2017';
   l_col_rows(5)(l_rows) := '[2334706.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26831773';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle iProcurement Consolidation Patch for 12.1.3 - November 2017';
   l_col_rows(5)(l_rows) := '[2334741.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '27217455';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Purchasing Consolidation Patch for 12.1.3 - January 2018';
   l_col_rows(5)(l_rows) := '[2356088.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '27246982';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle iProcurement Consolidation Patch for 12.1.3 - January 2018';
   l_col_rows(5)(l_rows) := '[2356100.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '27513560';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Purchasing Consolidation Patch for 12.1.3 - April 2018';
   l_col_rows(5)(l_rows) := '[2381911.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '27503898';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle iProcurement Consolidation Patch for 12.1.3 - April 2018';
   l_col_rows(5)(l_rows) := '[2381906.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '27852024';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Purchasing Consolidation Patch for 12.1.3 - June 2018';
   l_col_rows(5)(l_rows) := '[2410663.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '27851844';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle iProcurement Consolidation Patch for 12.1.3 - June 2018';
   l_col_rows(5)(l_rows) := '[2410667.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '28224872';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle iProcurement Consolidation Patch for 12.1.3 - August 2018';
   l_col_rows(5)(l_rows) := '[2434558.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '28225238';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Purchasing Consolidation Patch for 12.1.3 - August 2018';
   l_col_rows(5)(l_rows) := '[2434557.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '28581280';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Purchasing Consolidation Patch for 12.1.3 - October 2018';
   l_col_rows(5)(l_rows) := '[1468883.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '28883314';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle iProcurement Consolidation Patch for 12.1.3 - December 2018';
   l_col_rows(5)(l_rows) := '[2489807.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '28883549';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Purchasing Consolidation Patch for 12.1.3 - December 2018';
   l_col_rows(5)(l_rows) := '[2489793.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '29197834';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Purchasing Consolidation Patch for 12.1.3 - February 2019';
   l_col_rows(5)(l_rows) := '[1468883.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '29480188';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Purchasing Consolidation Patch for 12.1.3 - May 2019';
   l_col_rows(5)(l_rows) := '[2549896.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '29931278';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Purchasing Consolidation Patch for 12.1.3 - August 2019';
   l_col_rows(5)(l_rows) := '[2585722.1]';

END IF;

   l_extra_info('##SHOW_SQL##'):= 'Y';

   l_sig.sigrepo_id := '7453';
   l_sig.title := 'Recommended Procurement RUP Patches';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := '<p>There are recommended Procurement RUP patches that are not applied on this '||mask_text(g_instance, nvl( upper(''), 'NO_MASK') )||' instance.</p>';
   l_sig.solution := '<ul>
...
Best Practice: Always ensure that you are on the latest code with all recommended patches applied. This will help avoid known issues, prevent potential data corruption and provide the latest features and functionality. Having a proactive patching plan and periodic proactive patching process in place are the best ways to stay current.';
  ...
  -- Register
  l_step := '60';
  g_signatures('RUP_PROC_CODE_LEVEL_12_1') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'RUP_PROC_CODE_LEVEL_12_1',     -- sig ID
    l_sig,                              -- signature information
    l_col_rows,                         -- data
    l_hdr);                             -- headers
...
FUNCTION check_rec_patches_15 RETURN VARCHAR2 IS
  /* Signature RUP_PROC_CODE_LEVEL_12_2 */
  l_col_rows   COL_LIST_TBL := col_list_tbl(); -- Row values
  l_rel_rows   COL_LIST_TBL := col_list_tbl(); -- Row release
  l_hdr        VARCHAR_TBL  := varchar_tbl(); -- Column headings
  l_app_date   DATE;         -- Patch applied date
...
BEGIN
    ...
    print_log('Processing recommended patches signature: RUP_PROC_CODE_LEVEL_12_2 (check_rec_patches_15) "Recommended Procurement RUP Patches" (version 22)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '16910001';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.PRC_PF.C.DELTA.2 - included in R12.2.2';
   l_col_rows(5)(l_rows) := '[1506669.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '17036666';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.PRC_PF.C.DELTA.3 - included in R12.2.3';
   l_col_rows(5)(l_rows) := '[1586214.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '17947999';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.PRC_PF.C.DELTA.4 - included in R12.2.4';
   l_col_rows(5)(l_rows) := '[1644360.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19684688';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.PRC_PF.C.DELTA.5 - included in R12.2.5';
   l_col_rows(5)(l_rows) := '[1983012.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '22112200';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.PRC_PF.C.DELTA.6 - included in R12.2.6';
   l_col_rows(5)(l_rows) := '[2113999.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '24715299';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.PRC_PF.C.DELTA.7 - included in R12.2.7';
   l_col_rows(5)(l_rows) := '[2230779.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26954044';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.PRC_PF.C.DELTA.8 - included in R12.2.8';
   l_col_rows(5)(l_rows) := '[2393210.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '28800002';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.PRC_PF.C.DELTA.9 - included in R12.2.9';
   l_col_rows(5)(l_rows) := '[2495097.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30682300';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.PRC_PF.C.DELTA.10 - included in R12.2.10';
   l_col_rows(5)(l_rows) := '[2666926.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '32100000';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.PRC_PF.C.DELTA.11 - included in R12.2.11';
   l_col_rows(5)(l_rows) := '[2788574.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33583001';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.PRC_PF.C.DELTA.12 - included in R12.2.12';
   l_col_rows(5)(l_rows) := '[2894556.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '34800000';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.PRC_PF.C.DELTA.13 - included in R12.2.13';
   l_col_rows(5)(l_rows) := '[2959352.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36052001';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.PRC_PF.C.DELTA.14 - included in R12.2.14';
   l_col_rows(5)(l_rows) := '[3012987.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.2.2 - ORACLE E-BUSINESS SUITE 12.2.2 RELEASE UPDATE PACK';
   l_col_rows(5)(l_rows) := '[1506669.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.2.3 - ORACLE E-BUSINESS SUITE 12.2.3 RELEASE UPDATE PACK';
   l_col_rows(5)(l_rows) := '[1586214.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.2.4 - ORACLE E-BUSINESS SUITE 12.2.4 RELEASE UPDATE PACK';
   l_col_rows(5)(l_rows) := '[1644360.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.2.5 - ORACLE E-BUSINESS SUITE 12.2.5 RELEASE UPDATE PACK';
   l_col_rows(5)(l_rows) := '[1983050.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.2.6 - ORACLE E-BUSINESS SUITE 12.2.6 RELEASE UPDATE PACK';
   l_col_rows(5)(l_rows) := '[2114016.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.2.7 - ORACLE E-BUSINESS SUITE 12.2.7 RELEASE UPDATE PACK';
   l_col_rows(5)(l_rows) := '[2230783.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.2.8 - ORACLE E-BUSINESS SUITE 12.2.8 RELEASE UPDATE PACK';
   l_col_rows(5)(l_rows) := '[2393248.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.2.9 - ORACLE E-BUSINESS SUITE 12.2.9 RELEASE UPDATE PACK';
   l_col_rows(5)(l_rows) := '[2495027.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.2.10 - ORACLE E-BUSINESS SUITE 12.2.10 RELEASE UPDATE PACK';
   l_col_rows(5)(l_rows) := '[2666934.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.2.11 - ORACLE E-BUSINESS SUITE 12.2.11 RELEASE UPDATE PACK';
   l_col_rows(5)(l_rows) := '[2758997.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.2.12 - ORACLE E-BUSINESS SUITE 12.2.12 RELEASE UPDATE PACK';
   l_col_rows(5)(l_rows) := '[2876726.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.2.13 - ORACLE E-BUSINESS SUITE 12.2.13 RELEASE UPDATE PACK';
   l_col_rows(5)(l_rows) := '[2958077.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.2.14 - ORACLE E-BUSINESS SUITE 12.2.14 RELEASE UPDATE PACK';
   l_col_rows(5)(l_rows) := '[3011520.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '22575334';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Consolidate checkin for 12.2.4+';
   l_col_rows(5)(l_rows) := '[2183357.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '23705442';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Consolidated Patch for CLM 12.2.4 - November 2016';
   l_col_rows(5)(l_rows) := '[222339.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30406044';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle iProcurement Consolidation Patch for 12.2.4 - February 2020';
   l_col_rows(5)(l_rows) := '[2587902.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30654559';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Sourcing, iSP, SLM, Supplier Hub Consolidation Patch for 12.2.4 - February 2020';
   l_col_rows(5)(l_rows) := '[2587902.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30295885';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Purchasing Consolidation Patch for 12.2.4 - February 2020';
   l_col_rows(5)(l_rows) := '[2587902.1]';
...
END IF;
   ...
   l_sig.sigrepo_id := '7454';
   l_sig.title := 'Recommended Procurement RUP Patches';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := '<p>There are recommended Procurement RUP patches that are not applied on this '||mask_text(g_instance, nvl( upper(''), 'NO_MASK') )||' instance.</p>';
   l_sig.solution := '<ul>
<li>Please review list above and schedule to apply any unapplied recommended Procurement RUP patches as soon as possible</li>
...
Best Practice: Always ensure that you are on the latest code with all recommended patches applied. This will help avoid known issues, prevent potential data corruption and provide the latest features and functionality. Having a proactive patching plan and periodic proactive patching process in place are the best ways to stay current.';
  ...
  -- Register
  l_step := '60';
  g_signatures('RUP_PROC_CODE_LEVEL_12_2') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'RUP_PROC_CODE_LEVEL_12_2',     -- sig ID
    l_sig,                              -- signature information
    l_col_rows,                         -- data
    l_hdr);                             -- headers
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Include Diagnostic Apps Check';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_include_apps_check,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Organization ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(l_org_name || ' ('||  p_org_id ||')' ,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Item Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_item_num,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Purchase Order Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_trx_num,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Purchase Order Line Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_line_num,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  l_revision := rtrim(replace('$Revision: 200.34  $','$',''));
  l_revision := ltrim(replace(l_revision,'Revision:',''));
  l_date_char := rtrim(replace('$Date: 2026/01/28 15:17:34 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'ip_item_analyzer.sql';
...
IF p_include_apps_check IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Include Diagnostic Apps Check is required.');
   raise invalid_parameters;
END IF;
IF p_include_apps_check IS NOT NULL AND p_include_apps_check NOT IN ( 'N','Y') THEN
   print_error('INVALID ARGUMENT: Incorrect Include Diagnostic Apps Check Parameter.
...
IF p_org_id IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Organization ID is required.');
   raise invalid_parameters;
END IF;
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: No operating unit organization ID specified.
The org_id parameter is mandatory.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_org_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_org_id');

debug('begin parameter validation: p_item_num');
IF p_item_num IS NOT NULL THEN
BEGIN
SELECT CONCATENATED_SEGMENTS
INTO l_exists_val
FROM MTL_SYSTEM_ITEMS_KFV MTL, FINANCIALS_SYSTEM_PARAMS_ALL FSP
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Item Not Found');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_item_num failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_item_num');

debug('begin parameter validation: p_trx_num');
IF p_trx_num IS NOT NULL THEN
BEGIN
SELECT SEGMENT1
INTO l_exists_val
FROM (SELECT SEGMENT1,ORG_ID,TYPE_LOOKUP_CODE  FROM PO_HEADERS_ALL WHERE TYPE_LOOKUP_CODE NOT LIKE '%Q%')
WHERE SEGMENT1 = p_trx_num
 AND ORG_ID = p_org_id
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Purchase Order Not Found');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_trx_num failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_trx_num');

debug('begin parameter validation: p_line_num');
IF p_line_num IS NOT NULL THEN
BEGIN
SELECT R.LINE_NUM
INTO l_exists_val
FROM PO_LINES_ALL R, PO_HEADERS_ALL H
WHERE R.LINE_NUM = p_line_num
 AND h.po_header_id = r.po_header_id and
h.segment1 = p_trx_num and
h.org_id = p_org_id and 
h.TYPE_LOOKUP_CODE NOT LIKE '%Q%'

 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Purchase Order Line Number not found');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_line_num failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_line_num');
...
--Constants for use in -fails when- clause of sigs
g_c_shared := 'Shared';
g_c_no := 'No';

-- Get organization name and set organization context
l_step := '10';
  IF p_org_id is not null THEN
    BEGIN
      SELECT u.name
    ...
    EXCEPTION WHEN NO_DATA_FOUND THEN
    print_log('Invalid operating unit organization ID specified. '||
      'The org_id parameter is mandatory.');
      raise invalid_parameters;
    END;    
...
-- Gather the responsibility name of the responsibility_id entered
/* removed as we no longer use the responsibility name
l_step := '20';
IF (p_include_apps_check = 'Y') THEN
    ...
    EXCEPTION WHEN NO_DATA_FOUND THEN
    print_log('Invalid responsibility id specified. '||
      'The responsibility_id parameter is mandatory when parameter Include Apps Check is Y.');
    raise invalid_parameters; 
    END;
    ELSE
    print_error('No responsibility id specified. ');
    print_error('The responsibility_id parameter is mandatory when parameter Include Apps Check is Y.');
    raise invalid_parameters; 
    END IF; 
END IF; 
*/

-- Gather the full name of the user_name entered
/* removed as we no longer use the username
l_step := '30';
IF (p_include_apps_check = 'Y') THEN
    ...
    EXCEPTION WHEN NO_DATA_FOUND THEN
        print_log('User Name not found. '||
          'The User Name parameter is mandatory when parameter Include Apps Check is Y.');
        raise invalid_parameters;
    END;
    ELSE
    print_error('No user name specified. ');
    print_error('The user name parameter is mandatory when parameter Include Apps Check is Y.');
    END IF;
END IF;
*/
...
IF p_responsibility_id is not null THEN 
  ...
  EXCEPTION WHEN NO_DATA_FOUND THEN
    print_log('Invalid responsibility id specified. '||
      'The responsibility_id parameter is mandatory.');
    raise invalid_parameters; 

  END;
  ELSE

--Set default value when no responsibility_id is provided
l_responsibility_name := ''; 

   print_log('No responsibility id specified. '||
      'The responsibility_id parameter is mandatory.');
    raise invalid_parameters; 
 END IF;   */


/* Development Approved start */
l_step := '40';
IF p_item_num is not null THEN
   BEGIN
       ...
       FROM   MTL_SYSTEM_ITEMS_KFV MTL, FINANCIALS_SYSTEM_PARAMS_ALL FSP
WHERE concatenated_segments = p_item_num
/* ability to have concatenated item numbers
SEGMENT1 = p_item_num
*/
AND FSP.INVENTORY_ORGANIZATION_ID = mtl.organization_id
AND FSP.ORG_ID = p_org_id;
   EXCEPTION WHEN NO_DATA_FOUND THEN
     print_error('No Item exists for values '||
     to_char(p_item_num)||'/'||to_char(p_org_id));
     raise invalid_parameters;
   END;
END If;

/* Development Approved end */
...
IF (p_trx_num is not null and p_line_num is null) THEN
	...
	AND    h.org_id = p_org_id
        AND    h.type_lookup_code != 'QUOTATION';

/* Old - removed l_created by as it is not yet used
	SELECT DISTINCT h.po_header_id, r.created_by
...
*/
    EXCEPTION WHEN NO_DATA_FOUND THEN
      print_error('Invalid PO and org_id combination');
      print_error('No PO document exists for values '||
      to_char(p_line_num)||'/'||p_trx_num||'/'||to_char(p_org_id));
      raise invalid_parameters;
    END;
END If;
...
IF(p_trx_num is not null and p_line_num is not null) THEN
    BEGIN
	SELECT h.po_header_id, r.line_num, r.po_line_id 
	INTO   l_doc_id, l_line_num, l_line_id 
	FROM   po_headers_all h, po_lines_all r
	WHERE  h.segment1 = p_trx_num
	AND    h.org_id = p_org_id
	AND    r.org_id = h.org_id
	...
	AND    r.line_num = p_line_num
        AND    h.type_lookup_code != 'QUOTATION';  
/* Old - removed l_created by as it is not yet used
	SELECT h.po_header_id, r.line_num, r.po_line_id, r.created_by
	INTO   l_doc_id, l_line_num, l_line_id , l_created_by
	FROM   po_headers_all h, po_lines_all r
	WHERE  h.segment1 = p_trx_num
	AND    h.org_id = p_org_id
	AND    r.org_id = h.org_id
...
*/
    EXCEPTION WHEN NO_DATA_FOUND THEN
      print_error('Invalid line, PO and org_id combination');
...
-- Obtain FWK level
select codelevel into l_fwk_level
from AD_TRACKABLE_ENTITIES where abbreviation = ('fwk');


-- Set Global Variables for Messaging
g_org_name:= l_org_name;
g_org_id:=   p_org_id;
g_item_num:= p_item_num;
g_line_id:=  l_line_id;
g_line_num:= p_line_num;
--g_user_name:= p2_user_name;
--g_responsibility_id:= p2_responsibility_id;
--g_include_apps_check := p_include_apps_check;
g_fwk_level := l_fwk_level;

-- Debug code for log file
print_log('g_org_name= '||g_org_name);
print_log('g_org_id= '||g_org_id);
print_log('g_item_num= '||g_item_num);
print_log('g_line_id= '||g_line_id);
print_log('g_line_num= '||g_line_num);
--print_log('g_user_name= '||g_user_name);
--print_log('g_responsibility_id= '||g_responsibility_id);
--print_log('g_include_apps_check = '||g_include_apps_check );
print_log('g_fwk_level = '||g_fwk_level);
...
debug('begin populate sql tokens hash table');
   ...
   g_masked_tokens('##$$ITEMNUM$$##') := mask_text( g_sql_tokens('##$$ITEMNUM$$##'), 'NO_MASK');
   g_sql_tokens('##$$ITEMID$$##') := l_inventory_item_id;
   g_masked_tokens('##$$ITEMID$$##') := mask_text( g_sql_tokens('##$$ITEMID$$##'), 'NO_MASK');
   g_sql_tokens('##$$SUBTP$$##') := l_doc_subtype;
   g_masked_tokens('##$$SUBTP$$##') := mask_text( g_sql_tokens('##$$SUBTP$$##'), 'NO_MASK');
   ...
   g_masked_tokens('##$$DOCID$$##') := mask_text( g_sql_tokens('##$$DOCID$$##'), 'NO_MASK');
   g_sql_tokens('##$$DOCHEADID$$##') := l_doc_id;
   g_masked_tokens('##$$DOCHEADID$$##') := mask_text( g_sql_tokens('##$$DOCHEADID$$##'), 'NO_MASK');
   g_sql_tokens('##$$DOCLINEID$$##') := l_line_id;
   g_masked_tokens('##$$DOCLINEID$$##') := mask_text( g_sql_tokens('##$$DOCLINEID$$##'), 'NO_MASK');
   g_sql_tokens('##$$RELID$$##') := nvl(to_char(p_line_num),'NULL');
   g_masked_tokens('##$$RELID$$##') := mask_text( g_sql_tokens('##$$RELID$$##'), 'NO_MASK');
   g_sql_tokens('##$$REL$$##') := g_rep_info('Apps Version');
   g_masked_tokens('##$$REL$$##') := mask_text( g_sql_tokens('##$$REL$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM1$$##') := '178';
   g_masked_tokens('##$$APPS_PARAM1$$##') := mask_text( g_sql_tokens('##$$APPS_PARAM1$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM2$$##') := '201';
   ...
   g_sql_tokens('##$$PERZ_PARAM1$$##') := 'ICX';
   g_masked_tokens('##$$PERZ_PARAM1$$##') := mask_text( g_sql_tokens('##$$PERZ_PARAM1$$##'), 'NO_MASK');
   g_sql_tokens('##$$PERZ_PARAM2$$##') := 'PO';
   g_masked_tokens('##$$PERZ_PARAM2$$##') := mask_text( g_sql_tokens('##$$PERZ_PARAM2$$##'), 'NO_MASK');
   g_sql_tokens('##$$PERZ_PARAM3$$##') := 'null';
   g_masked_tokens('##$$PERZ_PARAM3$$##') := mask_text( g_sql_tokens('##$$PERZ_PARAM3$$##'), 'NO_MASK');
   g_sql_tokens('##$$PERZ_PARAM4$$##') := 'null';
   g_masked_tokens('##$$PERZ_PARAM4$$##') := mask_text( g_sql_tokens('##$$PERZ_PARAM4$$##'), 'NO_MASK');
   g_sql_tokens('##$$PERZ_PARAM5$$##') := 'null';
   g_masked_tokens('##$$PERZ_PARAM5$$##') := mask_text( g_sql_tokens('##$$PERZ_PARAM5$$##'), 'NO_MASK');
   g_sql_tokens('##$$FWK$$##') := l_fwk_level;
   g_masked_tokens('##$$FWK$$##') := mask_text( g_sql_tokens('##$$FWK$$##'), 'NO_MASK');
   g_sql_tokens('##$$ORG_ID$$##') := to_char(p_org_id);
   g_masked_tokens('##$$ORG_ID$$##') := mask_text( g_sql_tokens('##$$ORG_ID$$##'), 'NO_MASK');
...
debug('begin add_signature: IP_SPECIFIC_PROFILES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1164',
      p_sig_id                 => 'IP_SPECIFIC_PROFILES',
...
AND e.profile_option_name IN (''POR_AUTO_CREATE_SHOPPING_CAT'',
			      ...
			      ''XLA_MO_SECURITY_PROFILE_LEVEL'',
                              ...
                              ''POR_HOSTED_IMAGES_DIR'',
                              ''POR_SHOW_THUMBNAIL_IMAGES'',
                              ''PO_LEGAL_REQ_TYPE'')
AND (a.level_id = 10001 )
ORDER BY e.profile_option_name,
         a.level_id DESC',
      p_title                  => 'iProcurement Specific Profile Options',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Specific profiles that should be reviewed when items do not appear in iProcurement.',
      p_solution               => 'See [1433185/FAQ2717] FAQ : iProcurement Profile Options.
',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: IP_SPECIFIC_PROFILES');



debug('begin add_signature: IP_MOAC_PROFILE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1165',
      p_sig_id                 => 'IP_MOAC_PROFILE',
      p_sig_sql                => 'SELECT user_profile_option_name "Profile Option",
a.profile_option_value "Profile Value",
...
AND c.responsibility_name like ''%rocurement%''
AND a.profile_option_value IS NOT NULL)
ORDER BY e.profile_option_name,a.level_id DESC',
      p_title                  => 'iProcurement Responsibility Incorrectly Setup To Use Multi-Org Access Control (MOAC)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The profile (MO: Security Profile)  that controls Multi-Org Access Control (MOAC) is incorrectly set for an iProcurement responsibility(s). iProcurement is not designed to use MOAC, so the responsibility level profile value for MO: Security Profile should always be null for iProcurement responsibilities.',
      p_solution               => '<p>Remove the responsibility level profile value for profile option MO: Security Profile for the listed iProcurement responsibilities.</p>
See [579900/KB162433] Is iProcurement Enabled For Multiple Operating Units (MOAC)?
',
      p_success_msg            => 'The Profile MO: Security Profile is correctly set to NULL at responsibility level for iProcurement Responsibilities.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: IP_MOAC_PROFILE');



debug('begin add_signature: PORCUSTB_CUSTDEFAULTREQHEAD');
   l_info('##MASK##CUSTDEFAULTREQHEAD'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7048',
      p_sig_id                 => 'PORCUSTB_CUSTDEFAULTREQHEAD',
      p_sig_sql                => 'select text CUSTDEFAULTREQHEAD
from all_source,
(select max(line) begin_line
from all_source
where (text like ''BEGIN%'')
and line >= (select max(line)
from all_source allsa where (text like ''PROCEDURE CUSTOM_VALIDATE_REQ_%'' or text like ''PROCEDURE CUSTOM_DEFAULT_REQ_%'' or text like ''PROCEDURE CUSTOM_UPDATE_CHARGE_ACCOUNT%'')
and type = ''PACKAGE BODY'' and name = ''POR_CUSTOM_PKG'' and rownum <= 1)
and line < (select max(line)
from all_source allsb where (text like ''PROCEDURE CUSTOM_VALIDATE_REQ_%'' or text like ''PROCEDURE CUSTOM_DEFAULT_REQ_%'' or text like ''PROCEDURE CUSTOM_UPDATE_CHARGE_ACCOUNT%'')
and type = ''PACKAGE BODY'' and name = ''POR_CUSTOM_PKG'' and rownum <= 2)
and type = ''PACKAGE BODY'' and name = ''POR_CUSTOM_PKG'') c,
(select max(line) end_line
from all_source
where (text like ''END;%'' or text like ''END CUSTOM_DEFAULT_REQ_HEADER;%'' or text like ''END CUSTOM_VALIDATE_REQ_HEADER;%'')
and line >= (select max(line)
from all_source allsa where (text like ''PROCEDURE CUSTOM_VALIDATE_REQ_%'' or text like ''PROCEDURE CUSTOM_DEFAULT_REQ_%'' or text like ''PROCEDURE CUSTOM_UPDATE_CHARGE_ACCOUNT%'')
and type = ''PACKAGE BODY'' and name = ''POR_CUSTOM_PKG'' and rownum <= 1)
and line < (select max(line)
from all_source allsb where (text like ''PROCEDURE CUSTOM_VALIDATE_REQ_%'' or text like ''PROCEDURE CUSTOM_DEFAULT_REQ_%'' or text like ''PROCEDURE CUSTOM_UPDATE_CHARGE_ACCOUNT%'')
and type = ''PACKAGE BODY'' and name = ''POR_CUSTOM_PKG'' and rownum <= 2)
and type = ''PACKAGE BODY'' and name = ''POR_CUSTOM_PKG'') b
where line < c.begin_line + 50
and line >= c.begin_line and line <= b.end_line
and type = ''PACKAGE BODY'' and name = ''POR_CUSTOM_PKG''
and ''##$$FK1$$##'' = ''POR: Enable Req Header Customization''
and exists
(select text CUSTDEFAULTREQHEAD, length(text), c.begin_line, b.end_line, all_source.line
from all_source,
(select max(line) begin_line
from all_source
where (text like ''BEGIN%'')
...
and type = ''PACKAGE BODY'' and name = ''POR_CUSTOM_PKG'' and rownum <= 2)
and type = ''PACKAGE BODY'' and name = ''POR_CUSTOM_PKG'') b
where (line = c.begin_line and substr(text,1,5) <> ''BEGIN'' 
or line = c.begin_line + 1 and substr(text,4,17) <> ''X_RETURN_CODE:=0;''
or line = c.begin_line + 2 and substr(text,4,16) <> ''X_ERROR_MSG:='''''''';''
or line = c.begin_line + 3 and substr(text,1,30) <> ''END CUSTOM_DEFAULT_REQ_HEADER;''
or line >= c.begin_line + 4 and line <= b.end_line
)
and line >= c.begin_line and line <= b.end_line
and type = ''PACKAGE BODY'' and name = ''POR_CUSTOM_PKG''
and ''##$$FK1$$##'' = ''POR: Enable Req Header Customization''
)',
      p_title                  => 'Active Customization Detected In Package POR_CUSTOM_PKG Procedure CUSTOM_DEFAULT_REQ_HEADER',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Package POR_CUSTOM_PKG from file PORCUSTB.pls has active Customizations in PROCEDURE CUSTOM_DEFAULT_REQ_HEADER',
      p_solution               => 'PORCUSTB_CUSTDEFAULTREQHEAD  Profile ''POR: Enable Req Header Customization'' is enabled and customizations are detected.  Review the customizations in porcustb.pls (POR_CUSTOM_PKG) PROCEDURE CUSTOM_DEFAULT_REQ_HEADER for possible impact.',
      p_success_msg            => 'Custom package PROCEDURE CUSTOM_DEFAULT_REQ_HEADER not in use or not customized.',
   ...
   l_info.delete;
debug('end add_signature: PORCUSTB_CUSTDEFAULTREQHEAD');



debug('begin add_signature: PORCUSTB_CUSTVALIDATEREQHEAD');
   l_info('##MASK##CUSTVALIDATEREQHEAD'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7049',
      p_sig_id                 => 'PORCUSTB_CUSTVALIDATEREQHEAD',
      p_sig_sql                => 'select text CUSTVALIDATEREQHEAD
from all_source,
(select max(line) begin_line
from all_source
where (text like ''BEGIN%'')
...
and line < (select max(line)
from all_source allsb where (text like ''PROCEDURE CUSTOM_VALIDATE_REQ_%'' or text like ''PROCEDURE CUSTOM_DEFAULT_REQ_%'' or text like ''PROCEDURE CUSTOM_UPDATE_CHARGE_ACCOUNT%'')
and type = ''PACKAGE BODY'' and name = ''POR_CUSTOM_PKG'' and rownum <= 3)
and type = ''PACKAGE BODY'' and name = ''POR_CUSTOM_PKG'') c,
(select max(line) end_line
from all_source
where (text like ''END;%'' or text like ''END CUSTOM_DEFAULT_REQ_HEADER;%'' or text like ''END CUSTOM_VALIDATE_REQ_HEADER;%'')
...
and exists
(
select text CUSTVALIDATEREQHEAD
from all_source,
(select max(line) begin_line
from all_source
where (text like ''BEGIN%'')
...
and type = ''PACKAGE BODY'' and name = ''POR_CUSTOM_PKG'') b
where 
(line = c.begin_line and substr(text,1,5) <> ''BEGIN'' 
or line = c.begin_line + 1 and substr(text,4,17) <> ''X_RETURN_CODE:=0;''
or line = c.begin_line + 2 and substr(text,4,16) <> ''X_ERROR_MSG:='''''''';''
or line = c.begin_line + 3 and substr(text,1,31) <> ''END CUSTOM_VALIDATE_REQ_HEADER;''
or line >= c.begin_line + 4 and line <= b.end_line
)
and line >= c.begin_line and line <= b.end_line
and type = ''PACKAGE BODY'' and name = ''POR_CUSTOM_PKG''
and ''##$$FK1$$##'' = ''POR: Enable Req Header Customization''
      ...
      p_title                  => 'Active Customization Detected In Package POR_CUSTOM_PKG Procedure CUSTOM_VALIDATE_REQ_HEADER',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Package POR_CUSTOM_PKG from file PORCUSTB.pls has active Customizations in PROCEDURE CUSTOM_VALIDATE_REQ_HEADER
',
      p_solution               => 'PORCUSTB_CUSTVALIDATEREQHEAD Profile ''POR: Enable Req Header Customization'' is enabled and customizations are detected.  Review the customizations in porcustb.pls (POR_CUSTOM_PKG) PROCEDURE CUSTOM_VALIDATE_REQ_HEADER for possible impact.',
      p_success_msg            => 'Custom package PROCEDURE CUSTOM_VALIDATE_REQ_HEADER not in use or not customized.
',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PORCUSTB_CUSTVALIDATEREQHEAD');



debug('begin add_signature: PORCUSTB_CUSTDEFAULTREQLINE');
   l_info('##MASK##CUSTDEFAULTREQLINE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7050',
      p_sig_id                 => 'PORCUSTB_CUSTDEFAULTREQLINE',
      p_sig_sql                => 'select text CUSTDEFAULTREQLINE
from all_source,
(select max(line) begin_line
from all_source
where (text like ''BEGIN%'')
...
and line < (select max(line)
from all_source allsb where (text like ''PROCEDURE CUSTOM_VALIDATE_REQ_%'' or text like ''PROCEDURE CUSTOM_DEFAULT_REQ_%'' or text like ''PROCEDURE CUSTOM_UPDATE_CHARGE_ACCOUNT%'')
and type = ''PACKAGE BODY'' and name = ''POR_CUSTOM_PKG'' and rownum <= 4)
and type = ''PACKAGE BODY'' and name = ''POR_CUSTOM_PKG'') c,
(select max(line) end_line
from all_source
where (text like ''END;%'' or text like ''END CUSTOM_DEFAULT_REQ_HEADER;%'' or text like ''END CUSTOM_VALIDATE_REQ_HEADER;%'')
...
and line >= c.begin_line and line <= b.end_line
and type = ''PACKAGE BODY'' and name = ''POR_CUSTOM_PKG''
and ''##$$FK1$$##'' = ''POR: Enable Requisition Line Customization''
and exists
(select text CUSTDEFAULTREQLINE
from all_source,
(select max(line) begin_line
from all_source
where (text like ''BEGIN%'')
...
or line = c.begin_line + 1 and substr(text,4,17) <> ''X_RETURN_CODE:=0;''
or line = c.begin_line + 2 and substr(text,4,16) <> ''X_ERROR_MSG:='''''''';''
or line = c.begin_line + 3 and substr(text,1,4) <> ''END;''
or line >= c.begin_line + 4 and line <= b.end_line
)
and line >= c.begin_line and line <= b.end_line
and type = ''PACKAGE BODY'' and name = ''POR_CUSTOM_PKG''
and ''##$$FK1$$##'' = ''POR: Enable Requisition Line Customization''
      ...
      p_title                  => 'Active Customization Detected In Package POR_CUSTOM_PKG Procedure CUSTOM_DEFAULT_REQ_LINE',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Package POR_CUSTOM_PKG from file PORCUSTB.pls has active Customizations in PROCEDURE CUSTOM_DEFAULT_REQ_LINE',
      p_solution               => 'PORCUSTB_CUSTDEFAULTREQLINE  Profile ''POR: Enable Req Line Customization'' is enabled and customizations are detected.  Review the customizations in PORCUSTB.pls (POR_CUSTOM_PKG) PROCEDURE CUSTOM_DEFAULT_REQ_LINE for possible impact.',
      p_success_msg            => 'Custom package PROCEDURE CUSTOM_DEFAULT_REQ_LINE not in use or not customized.
',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PORCUSTB_CUSTDEFAULTREQLINE');



debug('begin add_signature: PORCUSTB_CUSTVALIDATEREQLINE');
   l_info('##MASK##CUSTVALIDATEREQLINE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7056',
      p_sig_id                 => 'PORCUSTB_CUSTVALIDATEREQLINE',
      p_sig_sql                => 'select text CUSTVALIDATEREQLINE
from all_source,
(select max(line) begin_line
from all_source
where (text like ''BEGIN%'')
...
and line < (select max(line)
from all_source allsb where (text like ''PROCEDURE CUSTOM_VALIDATE_REQ_%'' or text like ''PROCEDURE CUSTOM_DEFAULT_REQ_%'' or text like ''PROCEDURE CUSTOM_UPDATE_CHARGE_ACCOUNT%'')
and type = ''PACKAGE BODY'' and name = ''POR_CUSTOM_PKG'' and rownum <= 5)
and type = ''PACKAGE BODY'' and name = ''POR_CUSTOM_PKG'') c,
(select max(line) end_line
from all_source
where (text like ''END;%'' or text like ''END CUSTOM_DEFAULT_REQ_HEADER;%'' or text like ''END CUSTOM_VALIDATE_REQ_HEADER;%'')
...
and exists
(
select text CUSTVALIDATEREQLINE
from all_source,
(select max(line) begin_line
from all_source
where (text like ''BEGIN%'')
...
and ''##$$FK1$$##'' = ''POR: Enable Requisition Line Customization''
      ...
      p_title                  => 'Active Customization Detected In Package POR_CUSTOM_PKG Procedure CUSTOM_VALIDATE_REQ_LINE',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Package POR_CUSTOM_PKG from file PORCUSTB.pls has active Customizations in PROCEDURE CUSTOM_VALIDATE_REQ_LINE
',
      p_solution               => 'PORCUSTB_CUSTVALIDATEREQLINE Profile ''POR: Enable Req Line Customization'' is enabled and customizations are detected.  Review the customizations in PORCUSTB.pls (POR_CUSTOM_PKG) PROCEDURE CUSTOM_VALIDATE_REQ_LINE for possible impact.',
      p_success_msg            => 'Custom package not in use.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PORCUSTB_CUSTVALIDATEREQLINE');



debug('begin add_signature: PORCUSTB_CUSTDEFAULTREQDIST');
   l_info('##MASK##CUSTDEFAULTREQDIST'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7057',
      p_sig_id                 => 'PORCUSTB_CUSTDEFAULTREQDIST',
      p_sig_sql                => 'select text CUSTDEFAULTREQDIST
from all_source,
(select max(line) begin_line
from all_source
where (text like ''BEGIN%'')
...
and line < (select max(line)
from all_source allsb where (text like ''PROCEDURE CUSTOM_VALIDATE_REQ_%'' or text like ''PROCEDURE CUSTOM_DEFAULT_REQ_%'' or text like ''PROCEDURE CUSTOM_UPDATE_CHARGE_ACCOUNT%'')
and type = ''PACKAGE BODY'' and name = ''POR_CUSTOM_PKG'' and rownum <= 6)
and type = ''PACKAGE BODY'' and name = ''POR_CUSTOM_PKG'') c,
(select max(line) end_line
from all_source
where (text like ''END;%'' or text like ''END CUSTOM_DEFAULT_REQ_HEADER;%'' or text like ''END CUSTOM_VALIDATE_REQ_HEADER;%'')
...
and line >= c.begin_line and line <= b.end_line
and type = ''PACKAGE BODY'' and name = ''POR_CUSTOM_PKG''
and ''##$$FK1$$##'' = ''POR: Enable Req Distribution Customization''
and exists
(select text CUSTDEFAULTREQDIST
from all_source,
(select max(line) begin_line
from all_source
where (text like ''BEGIN%'')
...
where 
(line = c.begin_line and substr(text,1,5) <> ''BEGIN'' 
or line = c.begin_line + 1 and substr(text,1,1) <> ''''
or line = c.begin_line + 2 and substr(text,4,15) <> ''RESULT_CODE:=0;''
or line = c.begin_line + 3 and substr(text,4,16) <> ''X_ERROR_MSG:='''''''';''
or line = c.begin_line + 4 and substr(text,1,1) <> ''''
or line = c.begin_line + 5 and substr(text,1,4) <> ''END;''
or line >= c.begin_line + 6 and line <= b.end_line
)
and line >= c.begin_line and line <= b.end_line
and type = ''PACKAGE BODY'' and name = ''POR_CUSTOM_PKG''
and ''##$$FK1$$##'' = ''POR: Enable Req Distribution Customization''
)',
      p_title                  => 'Active Customization Detected In Package POR_CUSTOM_PKG Procedure CUSTOM_DEFAULT_REQ_DIST',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Package POR_CUSTOM_PKG from file PORCUSTB.pls has active Customizations in PROCEDURE CUSTOM_DEFAULT_REQ_DIST',
      p_solution               => 'PORCUSTB_CUSTDEFAULTREQDIST  Profile ''POR: Enable Req Distribution Customization'' is enabled and customizations are detected.  Review the customizations in PORCUSTB.pls (POR_CUSTOM_PKG) PROCEDURE CUSTOM_DEFAULT_REQ_DIST for possible impact.
',
      p_success_msg            => 'Custom package PROCEDURE CUSTOM_DEFAULT_REQ_DIST not in use or not customized.
',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PORCUSTB_CUSTDEFAULTREQDIST');



debug('begin add_signature: PORCUSTB_CUSTVALIDATEREQDIST');
   l_info('##MASK##CUSTVALIDATEREQDIST'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7058',
      p_sig_id                 => 'PORCUSTB_CUSTVALIDATEREQDIST',
      p_sig_sql                => 'select text CUSTVALIDATEREQDIST
from all_source,
(select max(line) begin_line
from all_source
where (text like ''BEGIN%'')
...
and line < (select max(line)
from all_source allsb where (text like ''PROCEDURE CUSTOM_VALIDATE_REQ_%'' or text like ''PROCEDURE CUSTOM_DEFAULT_REQ_%'' or text like ''PROCEDURE CUSTOM_UPDATE_CHARGE_ACCOUNT%'')
and type = ''PACKAGE BODY'' and name = ''POR_CUSTOM_PKG'' and rownum <= 7)
and type = ''PACKAGE BODY'' and name = ''POR_CUSTOM_PKG'') c,
(select max(line) end_line
from all_source
where (text like ''END;%'' or text like ''END CUSTOM_DEFAULT_REQ_HEADER;%'' or text like ''END CUSTOM_VALIDATE_REQ_HEADER;%'')
...
and exists
(
select text CUSTVALIDATEREQDIST
from all_source,
(select max(line) begin_line
from all_source
where (text like ''BEGIN%'')
...
where
(line = c.begin_line and substr(text,1,5) <> ''BEGIN'' 
or line = c.begin_line + 1 and substr(text,4,15) <> ''RESULT_CODE:=0;''
or line = c.begin_line + 2 and substr(text,4,16) <> ''X_ERROR_MSG:='''''''';''
or line = c.begin_line + 3 and substr(text,1,1) <> ''''
or line = c.begin_line + 4 and substr(text,1,4) <> ''END;''
or line >= c.begin_line + 5 and line <= b.end_line
)
and  line >= c.begin_line and line <= b.end_line
and type = ''PACKAGE BODY'' and name = ''POR_CUSTOM_PKG''
and ''##$$FK1$$##'' = ''POR: Enable Req Distribution Customization''
)',
      p_title                  => 'Active Customization Detected In Package POR_CUSTOM_PKG Procedure CUSTOM_VALIDATE_REQ_DIST',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Package POR_CUSTOM_PKG from file PORCUSTB.pls has active Customizations in PROCEDURE CUSTOM_VALIDATE_REQ_DIST',
      p_solution               => 'PORCUSTB_CUSTDEFAULTREQDIST  Profile ''POR: Enable Req Distribution Customization'' is enabled and customizations are detected.  Review the customizations in PORCUSTB.pls (POR_CUSTOM_PKG) PROCEDURE CUSTOM_VALIDATE_REQ_DIST for possible impact.
',
      p_success_msg            => 'Custom package PROCEDURE CUSTOM_VALIDATE_REQ_DIST is not in use or not customized.
',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PORCUSTB_CUSTVALIDATEREQDIST');



debug('begin add_signature: IP_CUSTOM_PROFILE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1161',
      p_sig_id                 => 'IP_CUSTOM_PROFILE',
      p_sig_sql                => 'SELECT user_profile_option_name "Profile Option",
user_profile_option_name "##$$FK1$$##" ,
a.profile_option_value "Profile Value",
DECODE(a.level_id, 10001, ''Site'',
10002, ''Application'',
10003, ''Responsibility'',
...
AND t.LANGUAGE = ''US''
AND nvl(c.LANGUAGE,''US'') = ''US''
AND e.profile_option_name IN (''POR_ENABLE_REQ_LINE_CUST'',
...
ORDER BY SUBSTR(e.profile_option_name,18,1),
a.level_id DESC',
      p_title                  => 'iProcurement Custom Profile Option',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'One or more of the customization profiles are enabled. ',
      p_solution               => '<p>If there is an issue it is recommended to disable all custom code and reproduce on seeded code. Setting the profile values to No and then bouncing the oc4j (iAS/Apache) for these profiles to take effect.</p>
See [1942913/FAQ2688] FAQ: POR_CUSTOM_PKG (PORCUSTB.pls) For Implementing Default and Validate Customizations in iProcurement Requisition Headers, Lines, and Distributions',
      p_success_msg            => 'The custom profiles are set to NULL for iProcurement Responsibility. Custom package is not engaged.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('PORCUSTB_CUSTDEFAULTREQHEAD','PORCUSTB_CUSTVALIDATEREQHEAD','PORCUSTB_CUSTDEFAULTREQLINE','PORCUSTB_CUSTVALIDATEREQLINE','PORCUSTB_CUSTDEFAULTREQDIST','PORCUSTB_CUSTVALIDATEREQDIST'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '65'
      );
   l_info.delete;
debug('end add_signature: IP_CUSTOM_PROFILE');



debug('begin add_signature: POR_AUTO_CREATE_SHOPPING_CAT_PROFILE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3161',
      p_sig_id                 => 'POR_AUTO_CREATE_SHOPPING_CAT_PROFILE',
      p_sig_sql                => 'SELECT user_profile_option_name "Profile Option",
a.profile_option_value "Profile Value",
DECODE(a.level_id, 10001, ''Site'',
10002, ''Application'',
...
AND nvl(c.LANGUAGE,''US'') = ''US''
AND e.profile_option_name IN (''POR_AUTO_CREATE_SHOPPING_CAT'')
AND (a.profile_option_value = ''N'' or a.profile_option_value is null)
ORDER BY e.profile_option_name,
a.level_id DESC',
      p_title                  => 'POR: Autocreate Shopping Category and Mapping',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Profile POR: Autocreate Shopping Category and Mapping should be set to Yes unless all categories are manually mapped.',
      p_solution               => 'See [1370859/KB748749] How Category Mapping Works. Some Shopping Categories Are Not Displayed To Be Mapped To A PO Category.',
      p_success_msg            => 'POR: Autocreate Shopping Category and Mapping is set to Yes, the shopping categories are mapped to the purchasing categories automatically.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: POR_AUTO_CREATE_SHOPPING_CAT_PROFILE');



debug('begin add_signature: IP_PROFILE_PO_LEGAL_REQ_TYPE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7059',
      p_sig_id                 => 'IP_PROFILE_PO_LEGAL_REQ_TYPE',
      p_sig_sql                => 'SELECT user_profile_option_name "Profile Option",
a.profile_option_value "Profile Value",
DECODE(a.level_id, 10001, ''Site'',
10002, ''Application'',
...
AND t.LANGUAGE = ''US''
AND nvl(c.LANGUAGE,''US'') = ''US''
AND e.profile_option_name IN (''REQUISITION_TYPE'')
AND a.profile_option_value <> ''BOTH''
AND ((a.level_id = 10003 AND a.level_value = nvl(fnd_profile.value(''resp_id''), a.level_value))
OR (a.level_id = 10004 AND a.level_value = nvl(fnd_profile.value(''user_id''), a.level_value))
OR (a.level_id = 10001 ))
ORDER BY e.profile_option_name,a.level_id DESC',
      p_title                  => 'PO: Legal Requisition Type',
      p_fail_condition         => 'RS',
      p_problem_descr          => '<p>
Check the profile PO: Legal Requisition Type, as this impacts which items are shown in search results, and therefore may affect whether an image is displayed for the item. Images can only be shown for external Supplier items, as the image can only be added to the Source Document (BPA / Quotation). Images cannot be shown for internal sourced items, because these items do not have a source document and there is no place to specify an image value for internal sourced items.</p>
<OL TYPE="a">
<li>If PO: Legal Requisition Type = INTERNAL, this prevents showing any external supplier sourced items in search results, and therefore prevents displaying item images since there is no source document for internal items.</li>
<li>If PO: Legal Requisition Type = EXTERNAL, null, or BOTH then the images can be shown based on the requirements mentioned above, where there is an image defined for the item on the external source document.</li>
</ol>',
      p_solution               => 'See [983568/KB758676] What Are Possible Causes For Item Images Missing From iProcurement Search Results? ',
      p_success_msg            => 'PO: Legal Requisition Type is set to BOTH. All items will be shown.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: IP_PROFILE_PO_LEGAL_REQ_TYPE');



debug('begin add_signature: OAF_PERSONALIZATIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10654',
      p_sig_id                 => 'OAF_PERSONALIZATIONS',
      p_sig_sql                => 'SELECT
jp.path_docid ,
...
AND (upper(jdr_mds_internal.getdocumentname(jp.path_docid)) LIKE upper(''%/ORACLE/APPS/##$$PERZ_PARAM1$$##/%'') or 
    upper(jdr_mds_internal.getdocumentname(jp.path_docid)) LIKE upper(''%/ORACLE/APPS/##$$PERZ_PARAM2$$##/%'')  or
    upper(jdr_mds_internal.getdocumentname(jp.path_docid)) LIKE upper(''%/ORACLE/APPS/##$$PERZ_PARAM3$$##/%'')  or
    upper(jdr_mds_internal.getdocumentname(jp.path_docid)) LIKE upper(''%/ORACLE/APPS/##$$PERZ_PARAM4$$##/%'')  or
    upper(jdr_mds_internal.getdocumentname(jp.path_docid)) LIKE upper(''%/ORACLE/APPS/##$$PERZ_PARAM5$$##/%''))
order by 2',
      p_title                  => 'OAF Personalizations',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'OAF personalizations have been detected. These can cause issues in the application. If you are having application issues it is suggested to disable all personalizations and to retest.',
      p_solution               => 'See [602996/KB198123#aref_section23] setup section on how to temporarily disable personalizations to ensure these are not causing any issues with the application.',
      p_success_msg            => 'No OAF personalizations have been detected.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: OAF_PERSONALIZATIONS');



debug('begin add_signature: IP_NONCATALOG_LINE_TYPE_PROFILE_VALUES_NOT_DISTINCT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11309',
      p_sig_id                 => 'IP_NONCATALOG_LINE_TYPE_PROFILE_VALUES_NOT_DISTINCT',
      p_sig_sql                => 'SELECT fpot.user_profile_option_name, fpov.profile_option_value, DECODE(ProfileValueCount.Occurrences,1,''Yes'',2,''No'',3,''No'') DistinctValue
  FROM  fnd_profile_option_values fpov,
  fnd_profile_options fpo,
  fnd_profile_options_tl fpot,
    (SELECT count(fpov.profile_option_value) Occurrences, fpov.profile_option_value
      FROM  fnd_profile_option_values fpov, fnd_profile_options fpo, fnd_profile_options_tl fpot
      WHERE  
      fpo.profile_option_id = fpov.profile_option_id AND
      fpo.profile_option_name = fpot.profile_option_name AND
      fpov.application_id = 178 AND
      fpov.level_id IN (10001) AND
      TRUNC(fpo.start_date_active) <= SYSDATE AND
      UPPER(fpot.user_profile_option_name) in (UPPER(''POR : Rate Based Services Line Type''), UPPER(''POR : Goods Line Type''), UPPER(''POR : Amount Based Services Line Type'')) AND
      fpot.language = ''US''
      group by profile_option_value) ProfileValueCount
  WHERE
  DECODE(ProfileValueCount.Occurrences,1,''Yes'',2,''No'',3,''No'') = ''No'' AND
  ProfileValueCount.profile_option_value = fpov.profile_option_value AND
  fpo.profile_option_id = fpov.profile_option_id AND
  fpo.profile_option_name = fpot.profile_option_name AND
  fpov.application_id = 178 AND
  fpov.level_id IN (10001) AND
  ...
  UPPER(fpot.user_profile_option_name) in (UPPER(''POR : Rate Based Services Line Type''), UPPER(''POR : Goods Line Type''), UPPER(''POR : Amount Based Services Line Type'')) AND
  fpot.language = ''US''',
      p_title                  => 'iProcurement Non-Catalog Line Type Profile Values Are Not Distinct',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The line type profile are used for iProcurement Non-Catalog requests, and the SITE level profile values must be distinct (unique) for these profiles.  Currently the listed profiles are using the same value (not distinct values) at the SITE level, and must be changed to avoid issues with non-catalog requisition lines.',
      p_solution               => '1. Navigate to System Administrator / Profiles / System<br>
2. Query for the listed SITE level profiles<br>
3. Set the profiles to distinct (unique) values at the SITE level

NOTE: Review [382696/KB197294] for additional clarification.',
      p_success_msg            => 'iProcurement Non-Catalog Line Type Profile Values Are Distinct',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: IP_NONCATALOG_LINE_TYPE_PROFILE_VALUES_NOT_DISTINCT');



debug('begin add_signature: ORG_DOC_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1547',
      p_sig_id                 => 'ORG_DOC_TYPES',
      p_sig_sql                => 'SELECT distinct dt.type_name document_type,
           dt.org_id,
    ...
    FROM po_document_types_all dt,
         ...
         wf_item_types_tl wfit,
         wf_runnable_processes_v wfrp
    WHERE dt.org_id = ##$$ORGID$$##
    AND   dt.default_approval_path_id = s.position_structure_id(+)
AND  wfit.language = ''US''
    AND   dt.wf_approval_itemtype = wfit.name(+)
    AND   dt.wf_approval_process = wfrp.process_name(+)',
      p_title                  => 'Organization Document Types Setup',
      p_fail_condition         => 'RS',
      p_problem_descr          => '<p>Organization Document Types Setup.</p>
<p>Use the Document Types window to define access, security, and control specifications for all Purchasing documents. You cannot enter new document types; you can enter new document subtypes only for RFQs and quotations.</p>
<p>To define document types please see&nbsp;</p>
<p><a href="https://docs.oracle.com/cd/E18727_01/doc.121/e13410/T446883T443950.htm#4021156" target="_blank" rel="noopener">Oracle&amp;reg; Purchasing User''s Guide Release 12.1 Part No. E13410-05 - page 1-68</a></p>',
      p_solution               => 'See [135136/KB359839] PO Setup - Purchasing Options for additional information.',
      p_success_msg            => 'No Data Found for organization document types setup.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ORG_DOC_TYPES');



debug('begin add_signature: ORG_LINE_TYPES_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1549',
      p_sig_id                 => 'ORG_LINE_TYPES_DETAILS',
      p_sig_sql                => 'SELECT
    ...
    WHERE
      ...
      p_title                  => 'Organization Line Types Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Organization Line Types Details',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ORG_LINE_TYPES_DETAILS');



debug('begin add_signature: ORG_LINE_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1548',
      p_sig_id                 => 'ORG_LINE_TYPES',
      p_sig_sql                => 'SELECT
       * 
    FROM
       (SELECT
    ...
    ORDER BY
       LINE_TYPE',
      p_title                  => 'Organization Line Types Setup',
      p_fail_condition         => 'RS',
      p_problem_descr          => '<p>When you enter a line on a purchasing document and choose a line type, Purchasing automatically displays the default information that you define here for the line type. <br />Line types let you distinguish their value basis between quantity and amount based line items. If Oracle Services Procurement is implemented, fixed price and rate value based line types are also possible.</p>
<ul>
<li>You use quantity based line items when you know the quantity and price of the line you are ordering</li>
<li>You use fixed price based line items when you are ordering a service with a set fee</li>
<li>You use rate based line types when you are ordering services on a fee per unit basis</li>
</ul>
Review data for organization line types.',
      p_solution               => 'See [135136/KB359839] PO Setup - Purchasing Options for additional information.',
      p_success_msg            => 'Review organization line types setup.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('ORG_LINE_TYPES_DETAILS'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '18'
      );
   l_info.delete;
debug('end add_signature: ORG_LINE_TYPES');



debug('begin add_signature: FINANCIAL_OPTIONS_SETUP');
   l_info('##MASK##NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1272',
      p_sig_id                 => 'FINANCIAL_OPTIONS_SETUP',
      p_sig_sql                => 'SELECT hr.name,
       fsp.ORG_ID org_id,
       fsp.SET_OF_BOOKS_ID SOB_ID,
       (select currency_code from gl_sets_of_books gl where gl.set_of_books_id = fsp.set_of_books_id) "Set of Books Currency",
       fsp.business_group_id, 
       fsp.INVENTORY_ORGANIZATION_ID,
       (select mtl.organization_code from mtl_parameters mtl where fsp.inventory_organization_id = mtl.organization_id) inv_org_code,
       ...
       fsp.LAST_UPDATE_DATE fsp_last_update_date
FROM financials_system_params_all fsp,
     hr_operating_units hr
WHERE fsp.ORG_ID = hr.ORGANIZATION_ID
AND org_id       = ##$$ORGID$$##',
      p_title                  => 'Financial Options Setup',
      p_fail_condition         => 'RS',
      p_problem_descr          => '<p>Review data for detail setup of the Financial Options of the Operating Unit.</p>
<p>Use the Financials Options window to define the options and defaults that you use for your Oracle Financial Application(s). Values you enter in this window are shared by Oracle Payables, Oracle Purchasing, and Oracle Assets. You can define defaults in this window to simplify supplier entry, requisition entry, purchase order entry, invoice entry, and automatic payments. Depending on your application, you may not be required to enter all fields.</p>
<p>Although you only need to define these options and defaults once, you can update them at any time. If you change an option and it is used as a default value elsewhere in the system, it will only be used as a default for subsequent transactions. For example, if you change the Payment Terms from Immediate to Net 30, Net 30 will be used as a default for any new suppliers you enter, but the change will not affect the Payment Terms of existing suppliers.</p>
<ul>
<li><strong>Attention Oracle Payables Users:</strong> You are required to enter defaults for the Accounting Financials Options in the Accounting region. If you do not use encumbrance accounting or budgetary control, you do not need to enter defaults in the Encumbrance region. If you do not also have Oracle Purchasing installed, you do not need to enter defaults in the Supplier- Purchasing region. If you do not have Oracle Human Resources installed, you are not required to enter defaults in the Human Resources region. If your enterprise does not need to record a VAT registration number, you don''t need to enter defaults in the Tax region. To see the default hierarchy for Payables review the Account Default Hierarchy Chart: page E - 11.<br /><br /></li>
<li><strong>Attention Oracle Purchasing Users:</strong> If Purchasing is the only Oracle application installed at your site, you are only required to enter information in the following regions: Accounting and Supplier Purchasing.<br /><br /></li>
<li><strong>Attention Oracle Assets Users:</strong> If Oracle Assets is the only product you use, you are only required to enter information in the following regions: Supplier, Human Resources, and Accounting. Attention Encumbrance Accounting Users: If you use encumbrance accounting, and you have Oracle Payables, Oracle Purchasing, and Oracle General Ledger installed, define your encumbrance options in the Encumbrance Financials Options region.</li>
</ul>
<p><a href="https://docs.oracle.com/cd/E18727_01/doc.121/e12795/T434884T434887.htm#2875267" target="_blank" rel="noopener">Oracle&reg; Payables Implementation Guide Release 12.1 Part No. E12795-04 - page 1-35</a></p>',
      p_solution               => 'See [135136/KB359839] PO Setup - Purchasing Options for additional information.
',
      p_success_msg            => 'No Data Found for financials options setup.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: FINANCIAL_OPTIONS_SETUP');



debug('begin add_signature: RECEIVING_OPTIONS_SETUP');
   l_info('##MASK##NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1559',
      p_sig_id                 => 'RECEIVING_OPTIONS_SETUP',
      p_sig_sql                => 'SELECT hr.name, 
rp.ORGANIZATION_ID, 
...
rp.RECEIVING_ACCOUNT_ID "Receiving Account", 
rp.RETROPRICE_ADJ_ACCOUNT_ID "Retroprice Adjustment Account", 
rp.CLEARING_ACCOUNT_ID "Clearing Account", 
rp.INV_VARIANCE_ACCOUNT_ID "Invoice Variance Account", 
rp.LCM_ACCOUNT_ID "Landed Cost Management Account", 
rp.EXCHANGE_VARIANCE_ACCOUNT_ID "Exchange Variance Account", 
rp.TAX_VARIANCE_ACCOUNT_ID "Tax Variance Account", 
rp.DEF_CHARGES_ACCOUNT_ID "Def Charges Account" 
FROM rcv_parameters rp, 
hr_operating_units hr 
WHERE rp.ORGANIZATION_ID = hr.ORGANIZATION_ID 
AND rp.ORGANIZATION_ID = ##$$ORG_ID$$## 
',
      p_title                  => 'Receiving Options Setup',
      p_fail_condition         => 'RS',
      p_problem_descr          => '<p>Review data for detail setup of the Receiving Options of the Operating Unit.</p>
<p>Use the Receiving Options window to define options that govern receipts in your
system. Most of the options that you set here can be overridden for specific suppliers,
items, and purchase orders.</p>

<p><a href="https://docs.oracle.com/cd/E18727_01/doc.121/e13410/T446883T443950.htm#4021102" target="_blank" rel="noopener">Oracle&reg; Purchasing User''s Guide Release 12.1 Part No. E13410-05 - page 1-42</a></p>',
      p_solution               => 'See [135136/KB359839] PO Setup - Purchasing Options for additional information.',
      p_success_msg            => 'No Data Found for Receiving options setup.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: RECEIVING_OPTIONS_SETUP');



debug('begin add_signature: EBS_MFG_PO_IPI_MTL_PARAMETERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30016',
      p_sig_id                 => 'EBS_MFG_PO_IPI_MTL_PARAMETERS',
      p_sig_sql                => 'SELECT DISTINCT decode(mp.primary_cost_method, 1,''1-Standard'', 2,''2-Average'', 3, ''3-Periodic Average'', 4, ''4-Periodic Incremental'', 5, ''5-FIFO'', 6, ''6-LIFO'') CST_TYP, MP.*
FROM MTL_PARAMETERS MP
WHERE  mp.ORGANIZATION_ID = ##$$ORG_ID$$##',
      p_title                  => 'MTL_PARAMETERS',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'MTL_PARAMETERS for the Org',
      p_solution               => 'MTL_PARAMETERS and Cost Type based on PRIMARY_COST_METHOD',
      p_success_msg            => 'No rows found in MTL_PARAMETERS for this org',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_IPI_MTL_PARAMETERS');



debug('begin add_signature: UOM_MISSING_IN_MTL_UOM_CLASS_CONVERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11344',
      p_sig_id                 => 'UOM_MISSING_IN_MTL_UOM_CLASS_CONVERSIONS',
      p_sig_sql                => 'select UNIT_OF_MEASURE, UOM_CODE, UOM_CLASS, BASE_UOM_FLAG
from mtl_units_of_measure mum
where base_uom_flag = ''Y''
and not exists 
(select ''exists'' from MTL_UOM_CLASS_CONVERSIONS mucc where inventory_item_id=0 and mucc.from_unit_of_measure = mum.unit_of_measure)',
      p_title                  => 'Unit of Measure Has Incomplete Setup for UOM Conversion',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'For any base unit, there should be one row in MTL_UOM_CLASS_CONVERSIONS with inventory_item_id = 0.  If this is missing, it will prevent these Units of Measure (UOM) from appearing in iProcurement UOM list of values.  The UOMs are defined and available for use in core purchasing, but not in iProcurement.',
      p_solution               => 'Review the following documents and implement the recommended fix.  If additional assistance is required the Inventory team can provide further support.
[1631964/KB732717]
[804663/KB777172]
',
      p_success_msg            => 'The Unit of Measure Class Conversions are setup correctly to allow access to the Unit of Measure values in iProcurement UOM list of values.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: UOM_MISSING_IN_MTL_UOM_CLASS_CONVERSIONS');



debug('begin add_signature: IP_IPROC_NOT_INSTALLED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13785',
      p_sig_id                 => 'IP_IPROC_NOT_INSTALLED',
...
and fav.application_short_name = ''ICX''',
      p_title                  => 'iProcurement Application is NOT set as Installed in License Manager',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The iProcurement Application is NOT set as Installed in License Manager.  While some features of iProcurement may function, many other features will not function if the application is not installed.',
      p_solution               => 'Obtain proper license for iProcurement (via your Sales Representative), and use License Manager to set the iProcurement application as Installed per [1181223/KB740082] .<br>
<br>
1. As System Administrator navigate to Oracle Applications Manager > License Manager<br>
2. Click on Products<br>
3. Select License Applications Product and click on Continue<br>
4. Select ''Oracle iProcurement'' (abbreviation: ICX) and click Next<br>
5. Submit the change<br>
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: IP_IPROC_NOT_INSTALLED');



debug('begin add_signature: IP_SPECIFIC_ITEM_EXTRACT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1166',
      p_sig_id                 => 'IP_SPECIFIC_ITEM_EXTRACT',
...
AND    INVENTORY_ITEM_ID = ##$$ITEMID$$##',
      p_title                  => 'Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' details from organization '||mask_text(g_org_name, nvl( upper(''), 'NO_MASK') )||' ('||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||').',
      p_solution               => 'All inventory-related fields for item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' from organization '||mask_text(g_org_name, nvl( upper(''), 'NO_MASK') )||' ('||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||').',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: IP_SPECIFIC_ITEM_EXTRACT');



debug('begin add_signature: IP_SPECIFIC_ITEM_EXTRACT_case1');
   l_info('##MASK##SUPPLIER'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1168',
      p_sig_id                 => 'IP_SPECIFIC_ITEM_EXTRACT_case1',
      p_sig_sql                => 'SELECT invitems.segment1, icxitems.*
...
AND invitems.inventory_item_id = ##$$ITEMID$$##
AND fsp.inventory_organization_id = invitems.organization_id
AND fsp.org_id = icxitems.org_id      
AND fsp.org_id = ##$$ORGID$$##',
      p_title                  => 'Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' iProcurement Shopping Category Mapping',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' in organization '||mask_text(g_org_name, nvl( upper(''), 'NO_MASK') )||' ('||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||') has an ip_category_id = -2.',
      p_solution               => '<ul>
   <li>An ip_category of -2 indicates that the mapping may not be correct between the purchasing and iProcurement shopping categories. However the item may still appear in the search results if the content zone allows items without shopping categories.</li>
   <li>See [1336169/KB737699] FAQ for Map Purchasing Category, Map Shopping Category, and Category Hierarchy in R12.</li>
</ul>',
      p_success_msg            => 'Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' has a mapping between the shopping and purchasing categories in organization '||mask_text(g_org_name, nvl( upper(''), 'NO_MASK') )||' ('||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||').',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: IP_SPECIFIC_ITEM_EXTRACT_case1');



debug('begin add_signature: IP_SPECIFIC_ITEM_EXTRACT_case2');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1167',
      p_sig_id                 => 'IP_SPECIFIC_ITEM_EXTRACT_case2',
      p_sig_sql                => 'SELECT INVENTORY_ITEM_ID, 
       CONCATENATED_SEGMENTS, 
       ORGANIZATION_ID,
       INVENTORY_ITEM_STATUS_CODE,
...
AND    INVENTORY_ITEM_STATUS_CODE = ''Inactive''',
      p_title                  => 'Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' from organization '||mask_text(g_org_name, nvl( upper(''), 'NO_MASK') )||' ('||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||') is not an active inventory item. ',
      p_solution               => '<ul>
   <li>The item must be an active item to appear in iProcurement.</li>
   <li>See [880285/KB787645] Rel 12, 12.1, 12.2 - Items Are Not Visible in iProcurement.</li>
</ul>',
      p_success_msg            => 'Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' Status is ACTIVE from organization '||mask_text(g_org_name, nvl( upper(''), 'NO_MASK') )||' ('||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||').',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: IP_SPECIFIC_ITEM_EXTRACT_case2');



debug('begin add_signature: IP_SPECIFIC_ITEM_EXTRACT_case3');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1169',
      p_sig_id                 => 'IP_SPECIFIC_ITEM_EXTRACT_case3',
      p_sig_sql                => 'SELECT INVENTORY_ITEM_ID, 
       CONCATENATED_SEGMENTS, 
       ORGANIZATION_ID,
       INVENTORY_ITEM_STATUS_CODE,
...
AND    PURCHASING_ITEM_FLAG = ''N''',
      p_title                  => 'Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' Purchased Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' is not a purchased inventory item in organization '||mask_text(g_org_name, nvl( upper(''), 'NO_MASK') )||' ('||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||'). ',
      p_solution               => '<ul>
   <li>Ensure the Purchased checkbox is selected under the purchasing tab of the item. The item must be a purchased item to appear in iProcurement.</li>
   <li>See [880285/KB787645] Rel 12, 12.1, 12.2 - Items Are Not Visible in iProcurement.</li>
</ul>',
      p_success_msg            => 'Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' from organization '||mask_text(g_org_name, nvl( upper(''), 'NO_MASK') )||' ('||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||') is purchased. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: IP_SPECIFIC_ITEM_EXTRACT_case3');



debug('begin add_signature: IP_SPECIFIC_ITEM_EXTRACT_case4');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1170',
      p_sig_id                 => 'IP_SPECIFIC_ITEM_EXTRACT_case4',
      p_sig_sql                => 'SELECT INVENTORY_ITEM_ID, 
       CONCATENATED_SEGMENTS, 
       ORGANIZATION_ID,
       INVENTORY_ITEM_STATUS_CODE,
...
AND    PURCHASING_ENABLED_FLAG = ''N''',
      p_title                  => 'Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' Purchasable Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' from organization '||mask_text(g_org_name, nvl( upper(''), 'NO_MASK') )||' ('||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||') is not a purchasable inventory item. ',
      p_solution               => '<ul>
   <li>Ensure the Purchasable checkbox is selected under the purchasing tab of the item. The item must be a purchasable item to appear in iProcurement.</li>
   <li>See [880285/KB787645] Rel 12, 12.1, 12.2 - Items Are Not Visible in iProcurement.</li>
</ul>',
      p_success_msg            => 'Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' from organization '||mask_text(g_org_name, nvl( upper(''), 'NO_MASK') )||' ('||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||') is purchasable.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: IP_SPECIFIC_ITEM_EXTRACT_case4');



debug('begin add_signature: IP_SPECIFIC_ITEM_EXTRACT_case5');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1171',
      p_sig_id                 => 'IP_SPECIFIC_ITEM_EXTRACT_case5',
      p_sig_sql                => 'SELECT INVENTORY_ITEM_ID, 
       CONCATENATED_SEGMENTS, 
       LIST_PRICE_PER_UNIT
       ORGANIZATION_ID,
...
AND    LIST_PRICE_PER_UNIT is null',
      p_title                  => 'Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' List Price',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' from organization '||mask_text(g_org_name, nvl( upper(''), 'NO_MASK') )||' ('||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||') has no list price.  ',
      p_solution               => '<ul>
   <li>Ensure there is a list price greater than 0 under the purchasing tab of the item. The item must have a list price to appear in iProcurement.</li>
   <li>See [880285/KB787645] Rel 12, 12.1, 12.2 - Items Are Not Visible in iProcurement.</li>
</ul>',
      p_success_msg            => 'Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' from organization '||mask_text(g_org_name, nvl( upper(''), 'NO_MASK') )||' ('||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||') has a valid list price.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: IP_SPECIFIC_ITEM_EXTRACT_case5');



debug('begin add_signature: IP_ITEM_LINE_PO_DOCUMENT_NOT_SHOWING_BLANKET_UNAPPROVED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11322',
      p_sig_id                 => 'IP_ITEM_LINE_PO_DOCUMENT_NOT_SHOWING_BLANKET_UNAPPROVED',
      p_sig_sql                => 'SELECT POH.org_id, POH.po_header_id, POH.SEGMENT1 PO_NUMBER, poh.authorization_status AUTHORIZATION_STATUS, poh.acceptance_required_flag, poh.revision_num, count(POL.po_line_id) LINES_NOT_EXPIRED_OR_CANCELED
FROM PO_HEADERS_ALL POH,
PO_LINES_ALL POL,
MTL_SYSTEM_ITEMS_B MTL,
FINANCIALS_SYSTEM_PARAMS_ALL FSP
WHERE POL.cancel_flag <> ''Y'' and NVL(POL.expiration_date,sysdate+10) > sysdate
AND (POL.item_id = NVL(''##$$ITEMID$$##'',POL.item_id) and (POL.po_line_id = NVL(''##$$DOCLINEID$$##'',POL.po_line_id)) AND POH.po_header_id = NVL(##$$DOCID$$##,poh.po_header_id))
AND (''##$$ITEMID$$##'' is not null or ''##$$DOCLINEID$$##'' is not null or ##$$DOCID$$## is not null)
AND POH.org_id = ##$$ORGID$$##
AND POH.po_header_id = POL.po_header_id
AND POH.org_id = FSP.ORG_ID
AND FSP.INVENTORY_ORGANIZATION_ID = mtl.organization_id
AND mtl.inventory_item_id = pol.item_id 
AND NOT (poh.authorization_status = ''PRE-APPROVED'' and poh.acceptance_required_flag = ''S'' and poh.revision_num > 0)
AND POH.authorization_status <> ''APPROVED''
AND TYPE_LOOKUP_CODE = ''BLANKET''
group by POH.org_id, POH.po_header_id, POH.segment1, poh.authorization_status, poh.acceptance_required_flag, poh.revision_num
order by po_header_id desc',
      p_title                  => 'Blanket Agreement Status Not Approved Results in Blanket Items Showing Old Values in iProcurement Search Results',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The listed Blanket Agreement(s) is not Approved, and as a result the items on the Blanket Agreement(s) will appear with the previous revision values (e.g. price, description, and etc) in iProcurement search results.',
      p_solution               => 'Approve the Blanket Agreement (or get it to Pre-Approved if Signature acceptance required) to get the items to appear in iProcurement search results with the new values (e.g. price, decription, and etc).  If the items still show the old values, run this iProcurement Item Analyzer again for the specific Blanket / Line to find other possible causes.

[1368534/KB753155]',
      p_success_msg            => 'There are no Blanket Agreement(s) not Approved (matching the Item/PO/Line input parameter values for the analyzer) that would result in the Blanket Line Items showing old values in search results.
',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: IP_ITEM_LINE_PO_DOCUMENT_NOT_SHOWING_BLANKET_UNAPPROVED');



debug('begin add_signature: IP_BLANKET_LINE_EXPIRED_ITEM_NOT_SHOWING');
   l_info('##MASK##VENDOR_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11347',
      p_sig_id                 => 'IP_BLANKET_LINE_EXPIRED_ITEM_NOT_SHOWING',
      p_sig_sql                => 'SELECT POH.org_id, aps.vendor_name, POH.po_header_id, POH.last_update_date, POH.SEGMENT1 PO_NUMBER, poh.authorization_status AUTHORIZATION_STATUS, poh.acceptance_required_flag, poh.revision_num, POL.line_num LINE_NUMBER, MTL.SEGMENT1 ITEM_NUMBER, POL.item_description, POL.expiration_date LINE_EXPIRATION_DATE
FROM PO_HEADERS_ALL POH,
PO_LINES_ALL POL,
MTL_SYSTEM_ITEMS_B MTL,
FINANCIALS_SYSTEM_PARAMS_ALL FSP,
...
order by pol.expiration_date desc',
      p_title                  => 'Blanket Agreement Line Expired Results in Blanket Item Not Appearing in iProcurement Search Results',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The listed Blanket Agreement line(s) is expired, and as a result the line item will not appear in iProcurement search results.',
      p_solution               => 'Extend the line expiration date to a future date, and reapprove the Blanket Agreement (or get it to Pre-Approved if Signature acceptance required) to get the items to appear again in iProcurement search results.  If the item still does not appear, run this iProcurement Item Analyzer again for the specific Blanket / Line to find other possible causes for the item missing from search results.

REFERENCE
[2414866/KB720850]',
      p_success_msg            => 'There are no Blanket Agreement(s) lines expired (matching the Item/PO/Line input parameter values for the analyzer) that would result in the Blanket Line Items missing from search results.
',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: IP_BLANKET_LINE_EXPIRED_ITEM_NOT_SHOWING');



debug('begin add_signature: IP_MASTER_ITEM_MISSING_PO_ATTRIBUTE_VALUES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17056',
      p_sig_id                 => 'IP_MASTER_ITEM_MISSING_PO_ATTRIBUTE_VALUES',
      p_sig_sql                => 'SELECT ctx.inventory_item_id, ctx.org_id, ctx.po_category_id, ip_category_id, creation_date, Round(sysdate - creation_date) DaysSinceCreate, last_update_date, Round(sysdate - last_update_date) DaysSinceUpdate
...
--    AND ctx.creation_date > sysdate - 365
    AND ctx.org_id = ##$$ORGID$$##
    AND ctx.inventory_item_id = ##$$ITEMID$$##
...
ORDER BY INVENTORY_ITEM_ID',
      p_title                  => 'Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' is Missing in iProcurement Because of Missing PO Attribute Values',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The master Item should be available in iProcurement, but it is not available because of missing data in PO Attribute Values tables.',
      p_solution               => 'Review and apply the b6892753.sql script described in the workaround section of [454694/KB788722] .  This script will populate the required PO attribute values and make the item available in iProcurement search results.',
      p_success_msg            => 'The master item has the required entries in PO Attribute Values tables, and does not require the workaround mentioned in [454694/KB788722]',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: IP_MASTER_ITEM_MISSING_PO_ATTRIBUTE_VALUES');



debug('begin add_signature: ITEM - INTERNAL SOURCES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '21090',
      p_sig_id                 => 'ITEM - INTERNAL SOURCES',
      p_sig_sql                => 'SELECT msi.organization_id src_org_id,
msi.primary_unit_of_measure unit_of_measure,
ood.organization_name src_org_name,
msi.list_price_per_unit,
sob.currency_code foreign_currency_code
FROM
mtl_system_items msi,
org_organization_definitions ood,
gl_sets_of_books sob
WHERE msi.inventory_item_id = ##$$ITEMID$$## --&inventory_item_id
and msi.organization_id = ##$$ORGID$$## --&procuring_organization_id
...
gl_sets_of_books sob
WHERE msi.inventory_item_id = ##$$ITEMID$$## --&inventory_item_id
and mip.to_organization_id = ##$$ORGID$$## --&procuring_organization_id
and mip.from_organization_id = msi.organization_id
...
and NVL(msi.mtl_transactions_enabled_flag,''N'') = ''Y''
',
      p_title                  => 'Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' Internal Sources',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Internal Sources for this item',
      p_solution               => 'No Internal Sources Found for this item',
      p_success_msg            => 'Internal Sources found',
   ...
   l_info.delete;
debug('end add_signature: ITEM - INTERNAL SOURCES');



debug('begin add_signature: ITEM_ORGANIZATIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6615',
      p_sig_id                 => 'ITEM_ORGANIZATIONS',
      p_sig_sql                => 'select mp.ORGANIZATION_CODE ||''(''||mp.ORGANIZATION_ID||'')'' "ORGANIZATION_CODE (ID)" , mpm.ORGANIZATION_CODE ||''(''||mp.MASTER_ORGANIZATION_ID||'')'' "MASTER_ORGANIZATION_CODE (ID)" 
, DECODE(mp.primary_cost_method,1,''1-Standard'',  2,''2-Average'', 3,''3-Periodic Average'', 4,''4-Periodic Incremental LIFO'', 5,''5-FIFO'',6,''6-LIFO'', mp.primary_cost_method) PRIMARY_COST_METHOD
, mp.COST_ORGANIZATION_ID
, mp.DEFAULT_COST_GROUP_ID
, mp.DEFAULT_STATUS_ID
, mp.AUTO_DEL_ALLOC_FLAG
, DECODE(mp.NEGATIVE_INV_RECEIPT_CODE,1,''Yes'',''No'') NEGATIVE_INV_RECEIPT_CODE
, DECODE(mp.stock_locator_control_code,1,''1-None'', 2,''2-Prespecified'',   3,''3-Dynamic entry'',  4,''4-At subinventory level'', 
     5,''5-At item level'', mp.stock_locator_control_code) STOCK_LOCATOR_CONTROL_CODE
, DECODE (mp.PROJECT_REFERENCE_ENABLED , ''1'', ''Yes'', ''2'', ''No'' ) PROJECT_REFERENCE_ENABLED
, DECODE (mp.PM_COST_COLLECTION_ENABLED , ''1'', ''Yes'', ''2'', ''No'' ) PM_COST_COLLECTION_ENABLED
...
, mp.LABOR_MANAGEMENT_ENABLED_FLAG 
, mp.LCM_ENABLED_FLAG
, mp.YARD_MANAGEMENT_ENABLED_FLAG
, mp.TRADING_PARTNER_ORG_FLAG
, DECODE(mp.serial_number_type,1,''1-Unique within inventory items'', 2,''2-Unique within organization'', 3,''3-Unique across organizations''
   , 4, ''4-Unique within model and item'',  mp.serial_number_type) SERIAL_NUMBER_TYPE
, DECODE(mp.serial_number_generation,1,''1-At organization level'', 2,''2-At item level'',  3,''3-User Defined'', mp.serial_number_generation) SERIAL_NUMBER_GENERATION
, mp.AUTO_SERIAL_ALPHA_PREFIX
, mp.START_AUTO_SERIAL_NUMBER
, mp.AUTO_LOT_ALPHA_PREFIX
, DECODE(mp.lot_number_uniqueness,1,''1-Unique for item'',  2,''2-No uniqueness'', mp.lot_number_uniqueness) LOT_NUMBER_UNIQUENESS
, DECODE(mp.lot_number_generation,1,''1-At organization level'',  2,''2-At item level'',   3,''3-User Defined'', mp.lot_number_generation) LOT_NUMBER_GENERATION
, mp.LOT_NUMBER_ZERO_PADDING
, mp.LOT_NUMBER_LENGTH
, mp.CHILD_LOT_ALPHA_PREFIX
, mp.CHILD_LOT_NUMBER_LENGTH
, mp.CHILD_LOT_VALIDATION_FLAG
, mp.CHILD_LOT_ZERO_PADDING_FLAG
, mp.COPY_LOT_ATTRIBUTE_FLAG
, mp.ALLOCATE_LOT_FLAG
, mp.ALLOCATE_SERIAL_FLAG 
, decode(mp.ALLOW_DIFFERENT_STATUS , 1, ''1-Yes'', 2, ''2-No'', 3, ''Yes- With Exception''  ) ALLOW_DIFFERENT_STATUS
, mp.STARTING_REVISION
, mp.CALENDAR_CODE
, mp.CALENDAR_EXCEPTION_SET_ID
, mp.DEFAULT_ATP_RULE_ID
, mp.DEFAULT_PICKING_RULE_ID
, mp.DEFAULT_LOCATOR_ORDER_VALUE
, mp.DEFAULT_SUBINV_ORDER_VALUE
, mp.DEFAULT_MATERIAL_COST_ID
, mp.MAT_OVHD_COST_TYPE_ID
...
, mp.GENERAL_LEDGER_UPDATE_CODE
, mp.COST_CUTOFF_DATE
, mp.ENABLE_COSTING_BY_CATEGORY
, mp.COST_GROUP_ACCOUNTING
, mp.LCM_VAR_ACCOUNT
, mp.DEFERRED_COGS_ACCOUNT
, mp.SOURCE_ORGANIZATION_ID
, mp.SOURCE_SUBINVENTORY
, decode (mp.SOURCE_TYPE , 1, ''1-Inventory'', 2, ''2-Supplier'') SOURCE_TYPE
, mp.ORG_MAX_WEIGHT
, mp.ORG_MAX_WEIGHT_UOM_CODE
, mp.ORG_MAX_VOLUME
, mp.ORG_MAX_VOLUME_UOM_CODE
, mp.TXN_APPROVAL_TIMEOUT_PERIOD
, mp.MO_SOURCE_REQUIRED
, decode (mp.MO_PICK_CONFIRM_REQUIRED , ''1'', ''Yes'', ''2'', ''No'' ) MO_PICK_CONFIRM_REQUIRED
, decode (mp.MO_APPROVAL_TIMEOUT_ACTION , 1, ''1-Approve automatically'', 2, ''2-Reject automatically'') MO_APPROVAL_TIMEOUT_ACTION
, decode (mp.WIP_OVERPICK_ENABLED  , ''1'', ''Yes'', ''2'', ''No'' ) WIP_OVERPICK_ENABLED
, decode (mp.OVPK_TRANSFER_ORDERS_ENABLED , ''1'', ''Yes'', ''2'', ''No'' ) OVPK_TRANSFER_ORDERS_ENABLED
, mp.PROCESS_ORGN_CODE
, mp.DEFAULT_DEMAND_CLASS
, mp.ENCUMBRANCE_REVERSAL_FLAG
, mp.MAINTAIN_FIFO_QTY_STACK_TYPE
, mp.LPN_PREFIX
, mp.LPN_SUFFIX
, mp.LPN_STARTING_NUMBER
, mp.PREGEN_PUTAWAY_TASKS_FLAG
, mp.REGENERATION_INTERVAL
, mp.TIMEZONE_ID
, mp.MAX_PICKS_BATCH
, mp.DEFAULT_WMS_PICKING_RULE_ID
, mp.DEFAULT_PUT_AWAY_RULE_ID
, mp.DEFAULT_TASK_ASSIGN_RULE_ID
, mp.DEFAULT_LABEL_COMP_RULE_ID
, mp.DEFAULT_CARTON_RULE_ID
, mp.DEFAULT_CYC_COUNT_HEADER_ID
, mp.DEFAULT_PICK_TASK_TYPE_ID
, mp.DEFAULT_CC_TASK_TYPE_ID
, mp.DEFAULT_PUTAWAY_TASK_TYPE_ID
, mp.DEFAULT_REPL_TASK_TYPE_ID
, mp.DEFAULT_MOXFER_TASK_TYPE_ID
, mp.DEFAULT_MOISSUE_TASK_TYPE_ID
, mp.DEFAULT_CROSSDOCK_LOCATOR_ID
, mp.DEFAULT_MATL_OVHD_COST_ID
, mp.CROSSDOCK_FLAG
, mp.PRIORITIZE_WIP_JOBS
, mp.DEFAULT_CROSSDOCK_SUBINVENTORY
, mp.SKIP_TASK_WAITING_MINUTES
, mp.DISTRIBUTED_ORGANIZATION_FLAG
, mp.CARRIER_MANIFESTING_FLAG
, mp.QA_SKIPPING_INSP_FLAG
, mp.DISTRIBUTION_ACCOUNT_ID
, mp.DIRECT_SHIPPING_ALLOWED
, mp.DEFAULT_PICK_OP_PLAN_ID
, mp.MAX_CLUSTERS_ALLOWED
, mp.CONSIGNED_FLAG
, mp.CARTONIZATION_FLAG
, mp.CARTONIZE_SALES_ORDERS
, mp.CARTONIZE_MANUFACTURING
, mp.DEFER_LOGICAL_TRANSACTIONS
, mp.TOTAL_LPN_LENGTH
, mp.UCC_128_SUFFIX_FLAG
, mp.RFID_VERIF_PCNT_THRESHOLD
, mp.CREATE_LOT_UOM_CONVERSION
, mp.GENEALOGY_FORMULA_SECURITY
, mp.PARENT_CHILD_GENERATION_FLAG
, mp.RULES_OVERRIDE_LOT_RESERVATION
, mp.DEFAULT_CROSSDOCK_CRITERIA_ID
, mp.ENFORCE_LOCATOR_ALIS_UNQ_FLAG 
, mp.YARD_ORG_ID
, mp.YMS_COSTING_ENABLED
, mp.YMS_DEFAULT_SUBINV
, mp.YMS_DEFAULT_LOCATOR
, mp.DAILY_CAL_START_TIME
, mp.DAILY_CAL_END_TIME
, mp.TRADING_PARTNER_ORG_TYPE
, mp.DISPATCH_INBOUND_TASK
--, mp.ENABLE_EKANBAN
--, mp.PICK_VERIFY_SO_ENABLED
--, mp.PICK_VERIFY_MO_ENABLED
--, mp.PICK_VERIFY_CATEGORY_SET_ID
--, mp.PICK_VERIFY_WT_TOLERANCE_POS
--, mp.PICK_VERIFY_WT_TOLERANCE_NEG
--, mp.CC_WORKFLOW_ENABLED_FLAG
--, mp.CC_APPROVAL_TIMEOUT_PERIOD
--, mp.CC_APPROVAL_TIMEOUT_ACTION
, mp.LAST_UPDATE_DATE
, mp.CREATION_DATE
from mtl_parameters mp , mtl_parameters mpm
where mp.master_organization_id = mpm.organization_id
AND mp.organization_id IN  
    ( SELECT distinct msi.organization_id 
        FROM mtl_system_items_b msi
        WHERE msi.inventory_item_id =  ##$$ITEMID$$## ) 
ORDER BY mp.organization_id',
      p_title                  => 'Organization Information from MTL_PARAMETERS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Displays details from the MTL_PARAMETERS Table for all organizations in which this item is assigned.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_ORGANIZATIONS');



debug('begin add_signature: ITEM_ORG_DEFINITION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7490',
      p_sig_id                 => 'ITEM_ORG_DEFINITION',
      p_sig_sql                => 'select * from org_organization_definitions where organization_id in (select organization_id from mtl_system_items_b where inventory_item_id = ##$$ITEMID$$##)',
      p_title                  => 'Organization Definition from ORG_ORGANIZATION_DEFINITIONS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Displays the full definition of all organizations from ORG_ORGANIZATION_DEFINITIONS Table in which this item is assigned.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_ORG_DEFINITION');



debug('begin add_signature: ITEM_OPERATING_UNITS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7491',
      p_sig_id                 => 'ITEM_OPERATING_UNITS',
      p_sig_sql                => 'select * from hr_operating_units where organization_id in (
select operating_unit from org_organization_definitions where organization_id in (select organization_id from mtl_system_items_b where inventory_item_id = ##$$ITEMID$$##))',
      p_title                  => 'Operating Unit Information from HR_OPERATING_UNITS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Displays full information on all the operating units from the HR_OPERATING_UNITS Table for all inventory organizations in which this item is assigned.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_OPERATING_UNITS');



debug('begin add_signature: MTL_SYSTEM_ITEMS_B');
   l_info('##HYPERLINK##'):= 'INVENTORY_ITEM_ID,MTL_SYSTEM_ITEMS_TL,INVENTORY_ITEM_ID';
   l_info('##MASK##PLANNER_CODE'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1279',
      p_sig_id                 => 'MTL_SYSTEM_ITEMS_B',
      p_sig_sql                => 'SELECT invitems.*
FROM   mtl_system_items_b invitems,
       financials_system_params_all fsp
WHERE  invitems.inventory_item_id = ##$$ITEMID$$## 
AND fsp.inventory_organization_id = invitems.organization_id    
AND fsp.org_id = ##$$ORGID$$##',
      p_title                  => 'MTL_SYSTEM_ITEMS_B',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'MTL_SYSTEM_ITEMS_B table level data for item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' in organization '||mask_text(g_org_name, nvl( upper(''), 'NO_MASK') )||' ('||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||').',
      p_solution               => '',
      p_success_msg            => 'Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' in organization '||mask_text(g_org_name, nvl( upper(''), 'NO_MASK') )||' ('||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||') does not exist in MTL_SYSTEM_ITEMS_B  table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MTL_SYSTEM_ITEMS_B');



debug('begin add_signature: MTL_SYSTEM_ITEMS_TL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1173',
      p_sig_id                 => 'MTL_SYSTEM_ITEMS_TL',
      p_sig_sql                => 'SELECT invitems.*
FROM   mtl_system_items_tl invitems,
       financials_system_params_all fsp
WHERE  invitems.inventory_item_id = ##$$ITEMID$$##  
AND fsp.inventory_organization_id = invitems.organization_id    
AND fsp.org_id = ##$$ORGID$$##',
      p_title                  => 'MTL_SYSTEM_ITEMS_TL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'MTL_SYSTEM_ITEMS_TL table level data for item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' in organization '||mask_text(g_org_name, nvl( upper(''), 'NO_MASK') )||' ('||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||').',
      p_solution               => '',
      p_success_msg            => 'Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' in organization '||mask_text(g_org_name, nvl( upper(''), 'NO_MASK') )||' ('||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||') does not exist in MTL_SYSTEM_ITEMS_TL table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MTL_SYSTEM_ITEMS_TL');



debug('begin add_signature: ICX_CAT_ITEMS_CTX_HDRS_TLP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1174',
      p_sig_id                 => 'ICX_CAT_ITEMS_CTX_HDRS_TLP',
      p_sig_sql                => 'SELECT *
FROM icx_cat_items_ctx_hdrs_tlp
WHERE inventory_item_id = ##$$ITEMID$$##
AND org_id = ##$$ORGID$$##',
      p_title                  => 'ICX_CAT_ITEMS_CTX_HDRS_TLP',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'ICX_CAT_ITEMS_CTX_HDRS_TLP table level data for item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' in organization id '||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => '',
      p_success_msg            => 'Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' in organization id '||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||' does not exist in ICX_CAT_ITEMS_CTX_HDRS_TLP table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ICX_CAT_ITEMS_CTX_HDRS_TLP');



debug('begin add_signature: ICX_CAT_ITEMS_CTX_DTLS_TLP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1175',
      p_sig_id                 => 'ICX_CAT_ITEMS_CTX_DTLS_TLP',
      p_sig_sql                => 'SELECT INVENTORY_ITEM_ID
      ,PO_LINE_ID
...
WHERE inventory_item_id = ##$$ITEMID$$##
AND org_id = ##$$ORGID$$##',
      p_title                  => 'ICX_CAT_ITEMS_CTX_DTLS_TLP',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'ICX_CAT_ITEMS_CTX_DTLS_TLP table level data for item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' in organization id '||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => '',
      p_success_msg            => 'Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' in organization id '||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||' does not exist in ICX_CAT_ITEMS_CTX_DTLS_TLP table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ICX_CAT_ITEMS_CTX_DTLS_TLP');



debug('begin add_signature: ICX_CAT_ATTRIBUTE_VALUES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1176',
      p_sig_id                 => 'ICX_CAT_ATTRIBUTE_VALUES',
      p_sig_sql                => 'SELECT ATTRIBUTE_VALUES_ID
      ,PO_LINE_ID
      , picture, thumbnail_image, last_update_date
      ,REQ_TEMPLATE_LINE_NUM
      ,IP_CATEGORY_ID
      ,ORG_ID
      ,LEAD_TIME
      ,REBUILD_SEARCH_INDEX_FLAG
FROM   ICX_CAT_ATTRIBUTE_VALUES
WHERE inventory_item_id = ##$$ITEMID$$##
AND org_id = ##$$ORGID$$##
order by last_update_date desc',
      p_title                  => 'ICX_CAT_ATTRIBUTE_VALUES',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'ICX_CAT_ATTRIBUTE_VALUES table level data for item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' in organization id '||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => '',
      p_success_msg            => 'Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' in organization id '||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||' does not exist in ICX_CAT_ATTRIBUTE_VALUES table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ICX_CAT_ATTRIBUTE_VALUES');



debug('begin add_signature: ICX_CAT_ATTRIBUTE_VALUES_TLP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1177',
      p_sig_id                 => 'ICX_CAT_ATTRIBUTE_VALUES_TLP',
      p_sig_sql                => 'SELECT ATTRIBUTE_VALUES_TLP_ID
      ,PO_LINE_ID
      ,REQ_TEMPLATE_LINE_NUM
      ,INVENTORY_ITEM_ID
      ,ORG_ID
...
WHERE inventory_item_id = ##$$ITEMID$$##
AND org_id = ##$$ORGID$$##',
      p_title                  => 'ICX_CAT_ATTRIBUTE_VALUES_TLP',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'ICX_CAT_ATTRIBUTE_VALUES_TLP table level data for item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' in organization id '||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => '',
      p_success_msg            => 'Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' in organization id '||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||' does not exist in ICX_CAT_ATTRIBUTE_VALUES_TLP table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ICX_CAT_ATTRIBUTE_VALUES_TLP');



debug('begin add_signature: PO_LINE_ATTRIBUTE_VALUES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1275',
      p_sig_id                 => 'PO_LINE_ATTRIBUTE_VALUES',
      p_sig_sql                => 'SELECT ATTRIBUTE_VALUES_ID
      ,PO_LINE_ID
      ,REQ_TEMPLATE_LINE_NUM
      ,IP_CATEGORY_ID
...
WHERE inventory_item_id = ##$$ITEMID$$##
AND org_id = ##$$ORGID$$##',
      p_title                  => 'PO_ATTRIBUTE_VALUES',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'PO_ATTRIBUTE_VALUES table level data for item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' in organization id '||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => '',
      p_success_msg            => 'Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' in organization id '||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||' does not exist in PO_ATTRIBUTE_VALUES table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PO_LINE_ATTRIBUTE_VALUES');



debug('begin add_signature: PO_LINE_ATTRIBUTE_VALUES_TLP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1276',
      p_sig_id                 => 'PO_LINE_ATTRIBUTE_VALUES_TLP',
      p_sig_sql                => 'SELECT ATTRIBUTE_VALUES_TLP_ID
      ,PO_LINE_ID
      ,REQ_TEMPLATE_LINE_NUM
      ,IP_CATEGORY_ID
...
WHERE inventory_item_id = ##$$ITEMID$$##
AND org_id = ##$$ORGID$$##',
      p_title                  => 'PO_ATTRIBUTE_VALUES_TLP',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'PO_ATTRIBUTE_VALUES_TLP table level data for item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' in organization id '||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => '',
      p_success_msg            => 'Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' in organization in '||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||' does not exist in PO_ATTRIBUTE_VALUES_TLP table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PO_LINE_ATTRIBUTE_VALUES_TLP');



debug('begin add_signature: EBS_MFG_IPI_VERIFY_CATEGORY_IN_CATEGORY_BROWSING_TREE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30981',
      p_sig_id                 => 'EBS_MFG_IPI_VERIFY_CATEGORY_IN_CATEGORY_BROWSING_TREE',
      p_sig_sql                => 'SELECT Hierarchy1.parent_category_id Parent_Category_Id, --Categories2.category_name ParentCategoryName, 
LookupValues.meaning AS TYPE, Categories.RT_CATEGORY_ID, Categories.CATEGORY_NAME, Categories.LANGUAGE,
DECODE(Categories.TYPE, 1, 1, 0) Delete_Enabled, DECODE(Categories.TYPE, 1, 1, 0) Edit_Enabled, DECODE(Categories.TYPE, 1, 1, 2, 1, 0) Remove_Enabled, 
Categories.Description, DECODE(Categories.TYPE, 2, ''Y'', ''N'') Is_Genus
FROM ICX_CAT_CATEGORIES_TL Categories, fnd_lookup_values LookupValues, icx_cat_browse_trees Hierarchy1 --, icx_cat_browse_trees Hierarchy2, ICX_CAT_CATEGORIES_TL Categories2
WHERE Categories.LANGUAGE= ''US''
AND LookupValues.LANGUAGE=Categories.LANGUAGE AND LookupValues.lookup_code=TO_CHAR(Categories.TYPE)
AND LookupValues.lookup_type=''ICX_CAT_TYPE_POPLIST_VALUES''
AND Hierarchy1.child_category_id(+) = Categories.rt_category_id
AND Categories.rt_category_id in
  ( --- based on ICX_CAT_ITEMS_CTX_HDRS_TLP    when analyzer is run for Item)
  SELECT distinct ip_category_id
    FROM icx_cat_items_ctx_hdrs_tlp
    WHERE inventory_item_id = NVL(##$$ITEMID$$##,0)
    AND org_id = ##$$ORGID$$##
    ) 
order by type, Categories.rt_category_id',
      p_title                  => 'Check if Category is in Category Browsing Hierarchy',
      p_fail_condition         => '[Parent_Category_Id] is null',
      p_problem_descr          => 'The category of the item is not in the category browsing tree hierarchy, so users will not be able to browse the category hierarchy to find this item.',
      p_solution               => 'If you wish to show the category in the category hierarchy<br>, include the Item Category in the Category Hierarchy tree.<br>
Navigate to iProcurement Catalog Administrator responsibility<br>
Choose Schema -> Catalog Hierarchy<br>
Add the add item category from ''Insert Existing Child''
Reference [3068539/KB728155]',
      p_success_msg            => 'Category of the item is in the category browsing tree hierarchy.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_IPI_VERIFY_CATEGORY_IN_CATEGORY_BROWSING_TREE');



debug('begin add_signature: ITEM_ATTACHMENT');
   l_info('##MASK##FILE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10871',
      p_sig_id                 => 'ITEM_ATTACHMENT',
      p_sig_sql                => 'select ATT.CATEGORY_ID, 
       ATT.ATTACHED_DOCUMENT_ID,
       ATT.DOCUMENT_ID,
       ATT.CREATION_DATE,
       ...
       ATT.PK4_VALUE,
       ATT.PK5_VALUE,
       ATT.AUTOMATICALLY_ADDED_FLAG,
       ATT.STATUS,
       ATT.ORIG_ATTACH_DOC_ID,
       dtl.description, 
       dtl.file_name, 
       dtl.media_id, 
       dtl.datatype_name, 
       dtl.publish_flag, 
       dtl.usage_type_descr
from FND_ATTACHED_DOCUMENTS att, fnd_documents_vl dtl
where pk2_value=''##$$ITEMID$$##''
and entity_name like ''MTL_SYSTEM_ITEMS''
and att.DOCUMENT_ID = dtl.document_id',
      p_title                  => 'Item Attachments',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no attachments on the item.',
      p_solution               => '',
      p_success_msg            => 'The item has attachments.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_ATTACHMENT');



debug('begin add_signature: EBS_MFG_PO_IPI_IPROC_ITEM_BASE_DESCRIPTORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30245',
      p_sig_id                 => 'EBS_MFG_PO_IPI_IPROC_ITEM_BASE_DESCRIPTORS',
      p_sig_sql                => 'SELECT * FROM 
(SELECT IcxCatAttributesTlEO.ATTRIBUTE_ID, IcxCatAttributesTlEO.ATTRIBUTE_NAME, IcxCatAttributesTlEO.LANGUAGE, IcxCatAttributesTlEO.RT_CATEGORY_ID,
IcxCatAttributesTlEO.DESCRIPTION, IcxCatAttributesTlEO.SEQUENCE, IcxCatAttributesTlEO.KEY AS KEY1, IcxCatAttributesTlEO.SEARCHABLE, IcxCatAttributesTlEO.REQUEST_ID, 
IcxCatAttributesTlEO.STORED_IN_TABLE, IcxCatAttributesTlEO.STORED_IN_COLUMN, lookup1.meaning AS TranslatedSEARCHABLE, lookup2.meaning AS SEARCHRESULTSVISIBLE, 
lookup3.meaning AS ITEMDETAILVISIBLE, lookup4.meaning AS TYPE, 
(case when IcxCatAttributesTlEO.ATTRIBUTE_ID > 100 then 1 else 0 end) as delete_enabled, 
(case when IcxCatAttributesTlEO.ATTRIBUTE_ID > 100 then 0 else 1 end) as delete_disabled, 
lookup5.meaning as RestrictAccess, lookup6.meaning as ICON_INDICATOR, IcxCatAttributesTlEO.PROMOTION_FACTOR 
FROM ICX_CAT_ATTRIBUTES_TL IcxCatAttributesTlEO, fnd_lookup_values lookup1, fnd_lookup_values lookup2, fnd_lookup_values lookup3, fnd_lookup_values lookup4, fnd_lookup_values lookup5, fnd_lookup_values lookup6 
where IcxCatAttributesTlEO.LANGUAGE = USERENV(''lang'') 
and IcxCatAttributesTlEO.RT_CATEGORY_ID = 0 
and lookup1.lookup_type=''ICX_CAT_ATTRIB_VISIBILITY'' 
and lookup1.lookup_code = IcxCatAttributesTlEO.SEARCHABLE and lookup1.language = USERENV(''lang'') and lookup2.lookup_type=''ICX_CAT_ATTRIB_VISIBILITY'' 
and lookup2.lookup_code = IcxCatAttributesTlEO.SEARCH_RESULTS_VISIBLE and lookup2.language = USERENV(''lang'') and lookup3.lookup_type=''ICX_CAT_ATTRIB_VISIBILITY'' 
and lookup3.lookup_code = IcxCatAttributesTlEO.ITEM_DETAIL_VISIBLE and lookup3.language = USERENV(''lang'') and lookup4.lookup_type=''ICX_CAT_ATTRIB_TYPE_POPLIST'' 
and lookup4.lookup_code = IcxCatAttributesTlEO.Type and lookup4.language = USERENV(''lang'') and lookup5.lookup_type=''ICX_CAT_ATTRB_USG_TYPE'' 
and lookup5.lookup_code = nvl(IcxCatAttributesTlEO.restrict_access,''N'') and lookup5.language = USERENV(''lang'') and lookup6.lookup_type=''ICX_CAT_ATTRIB_VISIBILITY'' 
and lookup6.lookup_code = NVL(IcxCatAttributesTlEO.ICON_INDICATOR, 0) and lookup6.language = USERENV(''lang'')) QRSLT ORDER BY SEQUENCE',
      p_title                  => 'Base Descriptors',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'iProcurement Base Descriptors',
      p_solution               => 'Base Descriptor Details',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_IPI_IPROC_ITEM_BASE_DESCRIPTORS');



debug('begin add_signature: IP_ITEMS_BPA_ICX_CAT_ITEM_CTX_HDRS_TLP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '21592',
      p_sig_id                 => 'IP_ITEMS_BPA_ICX_CAT_ITEM_CTX_HDRS_TLP',
      p_sig_sql                => 'SELECT * FROM icx_cat_items_ctx_hdrs_tlp WHERE po_line_id = ##$$FK1$$##',
      p_title                  => 'BPA, Template, or Quotation Line Item Details in iProcurement',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no row in the iProcurement table ICX_CAT_ITEM_CTX_HDRS_TLP for the BPA / Line parameter values entered when running the analyzer.',
      p_solution               => 'Review [2708151/KB785207] and [880285/KB787645] for possible causes.',
      p_success_msg            => 'The BPA, Template, or Quotation line item is in the iProcurement ICX_CAT_ITEM_CTX_HDRS_TLP table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: IP_ITEMS_BPA_ICX_CAT_ITEM_CTX_HDRS_TLP');



debug('begin add_signature: EBS_MFG_IPI_ITEMS_BPA_ICX_CAT_ITEM_CTX_DTLS_TLP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31056',
      p_sig_id                 => 'EBS_MFG_IPI_ITEMS_BPA_ICX_CAT_ITEM_CTX_DTLS_TLP',
      p_sig_sql                => 'SELECT * FROM icx_cat_items_ctx_dtls_tlp WHERE po_line_id = ##$$FK1$$##',
      p_title                  => 'BPA, Template, or Quotation Line Item ICX_CAT_ITEM_CTX_DTLS_TLP',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no row in the iProcurement table ICX_CAT_ITEM_CTX_DTLS_TLP for the BPA / Line parameter values entered when running the analyzer.',
      p_solution               => 'Review [2708151/KB785207] and [880285/KB787645] for possible causes.',
      p_success_msg            => 'The BPA, Template, or Quotation line item is in the iProcurement ICX_CAT_ITEM_CTX_DTLS_TLP table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_IPI_ITEMS_BPA_ICX_CAT_ITEM_CTX_DTLS_TLP');



debug('begin add_signature: IP_ITEMS_BPA_PO_ATTRIBUTE_VALUES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '21593',
      p_sig_id                 => 'IP_ITEMS_BPA_PO_ATTRIBUTE_VALUES',
      p_sig_sql                => 'Select attribute_values_id, po_line_id, req_template_name, req_template_line_num,
ip_category_id, inventory_item_id, org_id, manufacturer_part_num, picture, thumbnail_image, 
supplier_url, manufacturer_url, attachment_url, unspsc, availability, lead_time, 
last_update_login, last_updated_by, last_update_date, created_by, creation_date, 
request_id, program_application_id, program_id, program_update_date, last_updated_program, 
rebuild_search_index_flag
from po_attribute_values WHERE po_line_id = ##$$FK1$$##
',
      p_title                  => 'BPA, Template, or Quotation Line Attribute Values',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no row in the table PO_ATTRIBUTE_VALUES for the BPA / Line parameter values entered when running the analyzer.',
      p_solution               => 'Review [454694/KB788722] and consider using the b6892753.sql script provided in this document.',
      p_success_msg            => 'The BPA, Template, or Quotation line item is in the PO_ATTRIBUTE_VALUES table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: IP_ITEMS_BPA_PO_ATTRIBUTE_VALUES');



debug('begin add_signature: IP_ITEMS_BPA_PO_ATTRIBUTE_VALUES_TLP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '21594',
      p_sig_id                 => 'IP_ITEMS_BPA_PO_ATTRIBUTE_VALUES_TLP',
      p_sig_sql                => 'Select attribute_values_id, po_line_id, req_template_name, req_template_line_num,
ip_category_id, inventory_item_id, org_id, manufacturer_part_num, picture, thumbnail_image, 
supplier_url, manufacturer_url, attachment_url, unspsc, availability, lead_time, 
last_update_login, last_updated_by, last_update_date, created_by, creation_date, 
...
from po_attribute_values WHERE po_line_id = ##$$FK1$$##
',
      p_title                  => 'BPA, Template, or Quotation Line Attribute Values Translation',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no row in the table PO_ATTRIBUTE_VALUES_TLP for the BPA / Line parameter values entered when running the analyzer.',
      p_solution               => 'Use the script b6892753.sql from [454694/KB788722] to get a row populated in this table.

If  you use multiple languages and expect additional translations are needed<p>
1.  Login with the desired language preference<p>
2. Query the blanket line<p>
3. Use the globe icon to translate the item to the session language.  <p>
<p>
Also review [1916797/KB430542] for information about related profile options, and patching recommendations.

To mass update many items, use the script from the following document:<p>
<p>
[2216967/KB626853]',
      p_success_msg            => 'The BPA, Template, or Quotation line item is in the PO_ATTRIBUTE_VALUES_TLP table.<p>
<p>
If  you use multiple languages and expect additional translations are needed<p>
1.  Login with the desired language preference<p>
2. Query the blanket line<p>
...
[2216967/KB626853]',
   ...
   l_info.delete;
debug('end add_signature: IP_ITEMS_BPA_PO_ATTRIBUTE_VALUES_TLP');



debug('begin add_signature: EBS_MFG_IPI_PO_LINE_LOC_DETAILS');
   l_info('##MASK##%ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CLOSED_REASON'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##CONTRACTOR%NAME%'):= 'DISPLAY_FIRST_4_CHAR';
   l_info('##MASK##NOTE_TO_%'):= 'DISPLAY_NONE';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30388',
      p_sig_id                 => 'EBS_MFG_IPI_PO_LINE_LOC_DETAILS',
      p_sig_sql                => 'SELECT ll.*, ll.line_location_id "##$$FK1$$##", ll.ship_to_organization_id "##$$FK2$$##"
FROM po_line_locations_all ll, po_lines_all l,
     po_line_types lt,
     mtl_system_items msi,
     financials_system_params_all fsp,
     mtl_categories_kfv mca
WHERE l.po_header_id =  ##$$DOCHEADID$$##
AND l.po_line_id = NVL(##$$FK1$$##,''%'')
...
ORDER BY l.line_num, ll.shipment_num',
      p_title                  => 'Purchasing Line Location Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No document Line Locations (Shipments) found for Purchase Order / Line',
      p_solution               => 'Verify that the document exists in operating unit ##$$ORGID$$##',
      p_success_msg            => 'Line Locations (Shipments) records for Purchase Order / Line',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_IPI_PO_LINE_LOC_DETAILS');



debug('begin add_signature: EBS_MFG_IPI_VERIFY_CATEGORY_POLINE_IN_CATEGORY_BROWSING_TREE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30982',
      p_sig_id                 => 'EBS_MFG_IPI_VERIFY_CATEGORY_POLINE_IN_CATEGORY_BROWSING_TREE',
      p_sig_sql                => 'SELECT Hierarchy1.parent_category_id Parent_Category_Id, --Categories2.category_name ParentCategoryName, 
LookupValues.meaning AS TYPE, Categories.RT_CATEGORY_ID, Categories.CATEGORY_NAME, Categories.LANGUAGE,
DECODE(Categories.TYPE, 1, 1, 0) Delete_Enabled, DECODE(Categories.TYPE, 1, 1, 0) Edit_Enabled, DECODE(Categories.TYPE, 1, 1, 2, 1, 0) Remove_Enabled, 
Categories.Description, DECODE(Categories.TYPE, 2, ''Y'', ''N'') Is_Genus
...
AND Hierarchy1.child_category_id(+) = Categories.rt_category_id
AND Categories.rt_category_id in
  (   -- based on IP_ITEMS_BPA_ICX_CAT_ITEM_CTX_HDRS_TLP   when analyzer is run for BPA/Template/Quotation Line
  SELECT distinct ip_category_id
    FROM icx_cat_items_ctx_hdrs_tlp
    WHERE po_line_id = NVL(##$$DOCLINEID$$##,0)
    )
order by type, Categories.rt_category_id',
      p_title                  => 'Check if PO Line Category is in Category Browsing Hierarchy',
      p_fail_condition         => '[Parent_Category_Id] is null',
      p_problem_descr          => 'The category of the PO Line Item is not in the category browsing tree hierarchy, so users will not be able to browse the category hierarchy to find this item.',
      p_solution               => 'If you wish to show the category in the category hierarchy<br>, include the Item Category in the Category Hierarchy tree.<br>
Navigate to iProcurement Catalog Administrator responsibility<br>
Choose Schema -> Catalog Hierarchy<br>
Add the add item category from ''Insert Existing Child''
Reference [3068539/KB728155]',
      p_success_msg            => 'Category of the PO Line item is in the category browsing tree hierarchy.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_IPI_VERIFY_CATEGORY_POLINE_IN_CATEGORY_BROWSING_TREE');



debug('begin add_signature: PO_LINE_DETAILS');
   l_info('##MASK##%ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CLOSED_REASON'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##CONTRACTOR%NAME%'):= 'DISPLAY_FIRST_4_CHAR';
   l_info('##MASK##NOTE_TO_%'):= 'DISPLAY_NONE';
  ...
  add_signature(
      p_sig_repo_id            => '1274',
      p_sig_id                 => 'PO_LINE_DETAILS',
      p_sig_sql                => 'SELECT l.*, l.po_line_id "##$$FK1$$##"
FROM po_lines_all l,
     po_line_types lt,
     mtl_system_items msi,
     financials_system_params_all fsp,
     mtl_categories_kfv mca
WHERE l.po_header_id =  ##$$DOCHEADID$$##
AND l.po_line_id = NVL(##$$DOCLINEID$$##,''%'')
AND   fsp.org_id = l.org_id
AND   msi.inventory_item_id (+) = l.item_id
AND   nvl(msi.organization_id, fsp.inventory_organization_id) =
         fsp.inventory_organization_id
...
AND   mca.category_id  = l.category_id
ORDER BY l.line_num',
      p_title                  => 'Purchasing Line Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No document lines found for Purchase Order Number ##$$DOCID$$##',
      p_solution               => 'Verify that the document exists in operating unit ##$$ORGID$$##',
      p_success_msg            => 'Lines record for Purchase Order Number ##$$DOCID$$##',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('IP_ITEMS_BPA_ICX_CAT_ITEM_CTX_HDRS_TLP','EBS_MFG_IPI_ITEMS_BPA_ICX_CAT_ITEM_CTX_DTLS_TLP','IP_ITEMS_BPA_PO_ATTRIBUTE_VALUES','IP_ITEMS_BPA_PO_ATTRIBUTE_VALUES_TLP','EBS_MFG_IPI_PO_LINE_LOC_DETAILS','EBS_MFG_IPI_VERIFY_CATEGORY_POLINE_IN_CATEGORY_BROWSING_TREE'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '13'
      );
   l_info.delete;
debug('end add_signature: PO_LINE_DETAILS');



debug('begin add_signature: PO_HEADER_DETAILS');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##CLM_SUPPLIER_NAME'):= 'REMOVE_COLUMN';
  ...
  add_signature(
      p_sig_repo_id            => '1273',
      p_sig_id                 => 'PO_HEADER_DETAILS',
      p_sig_sql                => 'SELECT *
FROM po_headers_all
WHERE po_header_id = ##$$DOCHEADID$$##
AND   org_id = ##$$ORGID$$##
AND   authorization_status = ''APPROVED''',
      p_title                  => 'Purchase Order Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Header record found for Purchase Order Number ##$$DOCID$$## in organization '||mask_text(g_org_name, nvl( upper(''), 'NO_MASK') )||' ('||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||').',
      p_solution               => 'Verify that the document exists in the in organization '||mask_text(g_org_name, nvl( upper(''), 'NO_MASK') )||' ('||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||').
',
      p_success_msg            => 'Details for Purchase Order Number ##$$DOCID$$## in organization '||mask_text(g_org_name, nvl( upper(''), 'NO_MASK') )||' ('||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||').',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('PO_LINE_DETAILS'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '16'
      );
   l_info.delete;
debug('end add_signature: PO_HEADER_DETAILS');



debug('begin add_signature: PO_HEADER_ATTACHMENT');
   l_info('##MASK##FILE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10873',
      p_sig_id                 => 'PO_HEADER_ATTACHMENT',
      p_sig_sql                => 'select ATT.CATEGORY_ID, 
       ATT.ATTACHED_DOCUMENT_ID,
       ATT.DOCUMENT_ID,
       ATT.CREATION_DATE,
       ...
       dtl.usage_type_descr
from FND_ATTACHED_DOCUMENTS att, fnd_documents_vl dtl
where pk1_value=''##$$DOCHEADID$$##''
and entity_name like ''PO_HEAD''
and att.DOCUMENT_ID = dtl.document_id',
      p_title                  => 'Purchase Order Header Attachments',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no attachments on the purchase order header.',
      p_solution               => '',
      p_success_msg            => 'The purchase order header has attachments.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PO_HEADER_ATTACHMENT');



debug('begin add_signature: PO_LINE_ATTACHMENT');
   l_info('##MASK##FILE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10872',
      p_sig_id                 => 'PO_LINE_ATTACHMENT',
      p_sig_sql                => 'select ATT.CATEGORY_ID, 
       ATT.ATTACHED_DOCUMENT_ID,
       ATT.DOCUMENT_ID,
       ATT.CREATION_DATE,
       ...
       dtl.usage_type_descr
from FND_ATTACHED_DOCUMENTS att, fnd_documents_vl dtl
where pk1_value=''##$$DOCLINEID$$##''
and entity_name like ''PO_LINES''
and att.DOCUMENT_ID = dtl.document_id',
      p_title                  => 'Purchase Order Line Attachments',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no attachments on the purchase order line.',
      p_solution               => '',
      p_success_msg            => 'The purchase order line has attachments.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PO_LINE_ATTACHMENT');



debug('begin add_signature: FND_LANGUAGES_TD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1263',
      p_sig_id                 => 'FND_LANGUAGES_TD',
      ...
      ,ISO_LANGUAGE_3
FROM fnd_languages',
      p_title                  => 'FND_LANGUAGES',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No languages installed.',
      p_solution               => '',
      p_success_msg            => '<p>FND_LANGUAGES table shows which languages are installed, and which is the base language and which are non-base languages (Installed Languages)</p>
<ul>
<li>INSTALLED_FLAG of I means the language has been installed.</li>
<li>INSTALLED_FLAG of B means the base language. </li>
</ul>
<p><em>* By default, language_code of US is the base language.</em></p>',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: FND_LANGUAGES_TD');



debug('begin add_signature: FND_LANGUAGES_TD_STANDARD');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##INSTALLED_FLAG'):= ',333333,FFE864,bold';
  add_signature(
      p_sig_repo_id            => '1264',
      p_sig_id                 => 'FND_LANGUAGES_TD_STANDARD',
      p_sig_sql                => 'SELECT LANGUAGE_CODE,
       LANGUAGE_ID,
       NLS_LANGUAGE,
       NLS_TERRITORY,
...
WHERE installed_flag IN (''B'',''I'')',
      p_title                  => 'Installed and Base Languages',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No languages installed',
      p_solution               => '',
      p_success_msg            => '<p>FND_LANGUAGES table shows which languages are installed, and which is the base language and which are non-base languages (Installed Languages)</p>
...
<p><em>* By default, language_code of US is the base language.</em></p>',
   ...
   l_info.delete;
debug('end add_signature: FND_LANGUAGES_TD_STANDARD');



debug('begin add_signature: IP_ALL_PO_DOCUMENT_ITEMS_NOT_SHOWING_BLANKET_EXPIRED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1191',
      p_sig_id                 => 'IP_ALL_PO_DOCUMENT_ITEMS_NOT_SHOWING_BLANKET_EXPIRED',
      p_sig_sql                => 'SELECT POH.SEGMENT1, 
       POL.po_line_id,
       mtl.segment1 "Item Number", 
       pol.item_description, pol.expiration_date
FROM PO_HEADERS_ALL POH, 
     PO_LINES_ALL POL, 
     MTL_SYSTEM_ITEMS_B MTL, 
     FINANCIALS_SYSTEM_PARAMS_ALL FSP
...
AND pol.expiration_date < trunc(sysdate)',
      p_title                  => 'Items From Blanket Orders Not Showing Due To Expired Line',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Item details for expired blanket lines in organization '||mask_text(g_org_name, nvl( upper(''), 'NO_MASK') )||' ('||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||').',
      p_solution               => 'Remove the expiration date for the one time item to be seen in iProcurement in organization '||mask_text(g_org_name, nvl( upper(''), 'NO_MASK') )||' ('||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||').
',
      p_success_msg            => 'There are no expired blanket orders that contain one time items in organization '||mask_text(g_org_name, nvl( upper(''), 'NO_MASK') )||' ('||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||').',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: IP_ALL_PO_DOCUMENT_ITEMS_NOT_SHOWING_BLANKET_EXPIRED');



debug('begin add_signature: IP_ALL_PO_DOCUMENT_NOT_SHOWING_BLANKET_UNAPPROVED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1193',
      p_sig_id                 => 'IP_ALL_PO_DOCUMENT_NOT_SHOWING_BLANKET_UNAPPROVED',
      p_sig_sql                => 'SELECT POH.last_update_date, POH.SEGMENT1 PO_Number, POL.line_num PO_Line,
mtl.segment1 "Item Number",
pol.item_description,
POH.org_id, POH.po_header_id, POL.po_line_id,
...
AND FSP.INVENTORY_ORGANIZATION_ID = mtl.organization_id
AND mtl.inventory_item_id = pol.item_id
  AND NOT (poh.authorization_status = ''PRE-APPROVED'' and poh.acceptance_required_flag = ''S'')
  AND poh.revision_num = 0
AND POH.authorization_status <> ''APPROVED''
AND TYPE_LOOKUP_CODE = ''BLANKET''
UNION ALL
SELECT POH.last_update_date, POH.SEGMENT1 PO_Number, POL.line_num PO_Line,
null "Item Number",
pol.item_description,
POH.org_id, POH.po_header_id, POL.po_line_id,
poh.authorization_status,
...
AND POH.authorization_status <> ''APPROVED''
AND TYPE_LOOKUP_CODE = ''BLANKET''
order by last_update_date desc, po_header_id desc',
      p_title                  => 'Items From Blanket Orders Not Showing Due To Un-Approved Purchase Order',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Item details for all un-approved blanket orders in organization '||mask_text(g_org_name, nvl( upper(''), 'NO_MASK') )||' ('||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||').',
      p_solution               => 'Approve the purchase order for the item(s) to be seen in iProcurement.',
      p_success_msg            => 'All blanket orders in organization '||mask_text(g_org_name, nvl( upper(''), 'NO_MASK') )||' ('||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||') are approved.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: IP_ALL_PO_DOCUMENT_NOT_SHOWING_BLANKET_UNAPPROVED');



debug('begin add_signature: IP_DOCUMENT_ITEMS_NOT_SHOWING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1194',
      p_sig_id                 => 'IP_DOCUMENT_ITEMS_NOT_SHOWING',
      p_sig_sql                => 'SELECT poh.segment1, pol.line_num, 
       pol.po_line_id, 
       NVL (icxm.shopping_category_id, NULL) ip_cat_id, 
       mtl.segment1 "Item Number",
       pol.item_description, 
       pol.expiration_date
FROM   po_lines_all pol, 
       ...
       financials_system_params_all fsp
WHERE  poh.po_header_id = pol.po_header_id
AND pol.po_header_id in (SELECT DISTINCT pha.po_header_id 
                         FROM po_headers_all pha, po_lines_all pla
                         WHERE pha.po_header_id = pla.po_header_id 
                         AND pla.ip_category_id = -2 
...
order by po_line_id desc',
      p_title                  => 'Items from Blanket Orders Not Showing Due to No Mapped Shopping Category',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Item details for an invalid shopping category mapping in organization '||mask_text(g_org_name, nvl( upper(''), 'NO_MASK') )||' ('||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||').',
      p_solution               => 'See [579294/KB197490] BPA Lines Created With One Time Item Before Associated Category Mapping , Can Not Be Seen In iProcurement Catalog for the solution and data fix.

',
      p_success_msg            => 'No issues detected with category mappings for these items from blanket purchase agreements in organization '||mask_text(g_org_name, nvl( upper(''), 'NO_MASK') )||' ('||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||').',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: IP_DOCUMENT_ITEMS_NOT_SHOWING');



debug('begin add_signature: IP_DOCUMENT_ITEMS_NOT_SHOWING_SPECIFIC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11460',
      p_sig_id                 => 'IP_DOCUMENT_ITEMS_NOT_SHOWING_SPECIFIC',
      p_sig_sql                => 'SELECT poh.segment1, poh.po_header_id, pol.line_num, 
pol.po_line_id, 
NVL (icxm.shopping_category_id, NULL) ip_cat_id, 
mtl.segment1 "Item Number",
pol.item_description, 
...
financials_system_params_all fsp
WHERE poh.po_header_id = pol.po_header_id
AND POL.po_line_id = NVL(''##$$DOCLINEID$$##'',POL.po_line_id) 
AND POH.po_header_id = NVL(''##$$DOCID$$##'',poh.po_header_id) 
AND pol.po_header_id in (SELECT DISTINCT pha.po_header_id 
FROM po_headers_all pha, po_lines_all pla
WHERE pha.po_header_id = pla.po_header_id 
AND pla.ip_category_id = -2 
...
',
   ...
   l_info.delete;
debug('end add_signature: IP_DOCUMENT_ITEMS_NOT_SHOWING_SPECIFIC');



debug('begin add_signature: IP_ALL_PO_DOCUMENT_NOT_SHOWING_BLANKET_UNAPPROVED_SPECIFIC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11461',
      p_sig_id                 => 'IP_ALL_PO_DOCUMENT_NOT_SHOWING_BLANKET_UNAPPROVED_SPECIFIC',
      p_sig_sql                => 'SELECT POH.SEGMENT1,poh.po_header_id, 
POL.po_line_id,
mtl.segment1 "Item Number", 
pol.item_description, 
poh.authorization_status, 
...
AND TYPE_LOOKUP_CODE = ''BLANKET''',
   ...
   l_info.delete;
debug('end add_signature: IP_ALL_PO_DOCUMENT_NOT_SHOWING_BLANKET_UNAPPROVED_SPECIFIC');



debug('begin add_signature: IP_ALL_PO_DOCUMENT_ITEMS_NOT_SHOWING_BLANKET_EXPIRED_SPECIFIC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11462',
      p_sig_id                 => 'IP_ALL_PO_DOCUMENT_ITEMS_NOT_SHOWING_BLANKET_EXPIRED_SPECIFIC',
      p_sig_sql                => 'SELECT POH.SEGMENT1, poh.po_header_id,
POL.po_line_id,
mtl.segment1 "Item Number", 
pol.item_description, pol.expiration_date
...
',
   ...
   l_info.delete;
debug('end add_signature: IP_ALL_PO_DOCUMENT_ITEMS_NOT_SHOWING_BLANKET_EXPIRED_SPECIFIC');



debug('begin add_signature: IP_NON_MAPPED_PO_CATEGORIES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1179',
      p_sig_id                 => 'IP_NON_MAPPED_PO_CATEGORIES',
      p_sig_sql                => 'SELECT purchcategories.category_id purchasing_category_key,
       purchcategories.concatenated_segments purchasing_category_segments,
...
AND NOT EXISTS (SELECT 1
                FROM icx.icx_por_category_data_sources purchasingcatmapping
                WHERE To_char(purchcategories.category_id) =  purchasingcatmapping.external_source_key)
AND purchcategoriestl.category_id = purchcategories.category_id',
      p_title                  => 'All Non-Mapped Purchasing Categories',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Purchasing categories that are currently not mapped to an iProcurement category (Shopping Category).',
      p_solution               => '<ul>
	...
	<li> See [1370859/KB748749] How Category Mapping Works. Some Shopping Categories Are Not Displayed To Be Mapped To A PO Category.</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: IP_NON_MAPPED_PO_CATEGORIES');



debug('begin add_signature: IP_ALL_ITEM');
   l_info('##MASK##SUPPLIER'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1172',
      p_sig_id                 => 'IP_ALL_ITEM',
      p_sig_sql                => 'SELECT invitems.segment1, 
       icxitems.*
FROM   icx_cat_items_ctx_hdrs_tlp icxitems,
       mtl_system_items_b invitems,
       financials_system_params_all fsp
...
AND fsp.org_id = icxitems.org_id      
AND fsp.org_id = ##$$ORGID$$##',
      p_title                  => 'All Items With Non-Mapped Shopping Categories',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'All item details with ip_category_id = -2. This means these items <strong>MAY</strong> not appear in iProcurement.',
      p_solution               => '<ul>
	...
	<li> However the item may still appear in the search results if the content zone <strong>allows items without shopping categories</strong></li>
	<li>See [1336169/KB737699] FAQ for Map Purchasing Category, Map Shopping Category, and Category Hierarchy in R12</li>
<br>
	<li>If you intend these items to have a shopping category (iProcurement category), review and implement the <strong>Workaround for ip_category_id -2</strong> provided in [454694/KB788722].  Implement the workaround in a <strong>TEST</strong> instance first</li>
</ul>',
      p_success_msg            => 'Item has a valid shopping category mapped to a purchasing category.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: IP_ALL_ITEM');



debug('begin add_signature: EXPENSE_ACCOUNT_ITEM_CATEGORY_RULES_SETUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10673',
      p_sig_id                 => 'EXPENSE_ACCOUNT_ITEM_CATEGORY_RULES_SETUP',
      p_sig_sql                => 'select mcb.category_id, mcb.segment1, mcb.segment2, 
nvl(prea.account_rule_id,0) RuleID, nvl(prea.rule_value_id,0), 
nvl(prea.segment_num,''SEGMENT0''), nvl(prea.segment_value,0), nvl(prea.org_id,0) 
from po_rule_expense_accounts prea, 
( 
select mcb.category_id, mcb.segment1, mcb.segment2 
from MTL_CATEGORY_SETS mcs, MTL_DEFAULT_CATEGORY_SETS mdcs, MFG_LOOKUPS mfl, 
MTL_CATEGORIES_B MCB 
where 
MCB.STRUCTURE_ID = mcs.STRUCTURE_ID 
and mcs.CATEGORY_SET_ID = mdcs.CATEGORY_SET_ID 
and mdcs.FUNCTIONAL_AREA_ID = mfl.LOOKUP_CODE 
and mfl.LOOKUP_TYPE = ''MTL_FUNCTIONAL_AREAS'' 
and mfl.MEANING = ''Purchasing'' 
order by category_id 
) mcb 
where prea.rule_type = ''ITEM CATEGORY'' 
and prea.org_id = ##$$ORGID$$##
and prea.rule_value_id = mcb.category_id 
order by rule_value_id, segment_num',
      p_title                  => 'Expense Account Item Category Rules That Are Setup',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'These are the current categories that have expense account rules setup. ',
      p_solution               => 'See [374579/KB198535] Charge Account Is Invalid At FND_FLEX_SERVER Validation When Using Expense Account Rules (Includes SELECT query for Expense Account Rules) for more information.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EXPENSE_ACCOUNT_ITEM_CATEGORY_RULES_SETUP');



debug('begin add_signature: ITEM_CATEGORY_VALUES_NO_EXPENSE_ACCOUNT_RULE_SETUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10674',
      p_sig_id                 => 'ITEM_CATEGORY_VALUES_NO_EXPENSE_ACCOUNT_RULE_SETUP',
      p_sig_sql                => 'select mcb.category_id, mcb.segment1, mcb.segment2 
from 
( 
select mcb.category_id, mcb.segment1, mcb.segment2 
...
where mcb.category_id not in 
( 
select prea.rule_value_id 
from po_rule_expense_accounts prea 
where prea.rule_type = ''ITEM CATEGORY'' 
and prea.org_id = ##$$ORGID$$##
and prea.rule_value_id = mcb.category_id)',
      p_title                  => 'Categories That Do Not Have An Expense Account Rule Setup',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'These are the current categories that do not have expense account rules setup. This can cause users to intermittently receive a charge account error, FND_FLEX_SERVER validation encountered a null or negative combination.',
      p_solution               => 'See [293046/KB198555] - How to Set Up and Use Category-based Account Default in Purchasing.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_CATEGORY_VALUES_NO_EXPENSE_ACCOUNT_RULE_SETUP');



debug('begin add_signature: IP_LIST_STORES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1225',
      p_sig_id                 => 'IP_LIST_STORES',
      p_sig_sql                => 'SELECT stores.store_id "Store Id",
...
ORDER BY "Store Name"',
      p_title                  => 'Store With No Smart Forms Or Content Zones',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Stores that have neither a smart form nor a content zone assigned.',
      p_solution               => 'No action is needed as this is only informational.
',
      p_success_msg            => 'All stores have either a smart form or a content zone assigned.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: IP_LIST_STORES');



debug('begin add_signature: IP_STORES_MULTIPLE_CONTENT_ZONE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3222',
      p_sig_id                 => 'IP_STORES_MULTIPLE_CONTENT_ZONE',
      p_sig_sql                => 'SELECT stores.store_id "Store Id",
       stores.name "Store Name",
       stores.description "Store Description",
...
WHERE stores.store_id = storecontent.store_id AND
      storecontent. content_TYPE <> ''SMART_FORM'' AND
      contents.ZONE_ID = storecontent.CONTENT_ID
      and stores.store_id in ( select store_id from ICX_CAT_STORE_CONTENTS where content_TYPE <> ''SMART_FORM'' GROUP BY store_id HAVING COUNT(*) >1)',
      p_title                  => 'Stores with Multiple Content Zones',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Restricted items may appear in the store due to multiple content zones being assigned to the store.',
      p_solution               => 'See [1307593/KB747309] Why Do Items In Category Restricted Content Zone Still Show In Catalog Search Results?',
      p_success_msg            => 'No stores exist with multiple content zones assigned.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: IP_STORES_MULTIPLE_CONTENT_ZONE');



debug('begin add_signature: IP_STORES_WITH_DATA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1226',
      p_sig_id                 => 'IP_STORES_WITH_DATA',
      p_sig_sql                => 'SELECT stores.store_id "Store Id",
       stores.name "Store Name",
       stores.description "Store Description",
       contents.name "Content ZONE Name",
...
WHERE stores.store_id = storecontent.store_id 
AND storecontent. content_TYPE = ''SMART_FORM'' 
AND contents.TEMPLATE_ID = storecontent.CONTENT_ID
ORDER BY "Store Name"',
      p_title                  => 'Store Related Information',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'All stores that have either a smart form or a content zone assigned to them.',
      p_solution               => 'No action is needed as this is only informational.
',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: IP_STORES_WITH_DATA');



debug('begin add_signature: IP_DETAILED_CONTENT_ZONE');
   l_info('##MASK##IMAGE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##URL'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1227',
      p_sig_id                 => 'IP_DETAILED_CONTENT_ZONE',
      p_sig_sql                => 'SELECT IcxCatContentZoneEO.ZONE_ID,
       ...
       DECODE(TYPE, ''LOCAL'', ''Yes'',''No'') IS_LOCAL_ZONE,
       DECODE(TYPE, ''PUNCHOUT'', ''Yes'',''No'') IS_PUNCHOUT_ZONE,
       DECODE(TYPE, ''TRANSPARENT_PUNCHOUT'', ''Yes'',''No'') IS_TRANSPARENT_PUNCHOUT_ZONE,
       DECODE(TYPE, ''INFORMATIONAL'', ''Yes'',''No'') IS_INFORMATIONAL_ZONE,
       DECODE(TYPE, ''PUNCHOUT'', DECODE(PROTOCOL_SUPPORTED,''VIA_EXCHANGE'',''No'',''Yes''),''TRANSPARENT_PUNCHOUT'', ''Yes'',''No'')   IS_PUNCHOUT_OR_TRANSPUNCH_ZONE,
       DECODE(PROTOCOL_SUPPORTED, ''CXML_SUPPLIER'', ''Yes'', ''TRANSPARENT_EXCHANGE'', ''Yes'', ''TRANSPARENT_SUPPLIER'', ''Yes'',''No'') IS_COMMUNICATION_MODE_cXML,
       DECODE(PROTOCOL_SUPPORTED, ''CXML_SUPPLIER'', ''No'', ''TRANSPARENT_EXCHANGE'', ''No'', ''TRANSPARENT_SUPPLIER'', ''No'', ''Yes'') IS_COMMUNICATION_MODE_XML,
       DECODE(PROTOCOL_SUPPORTED, ''XML_SUPPLIER'', ''Yes'',''CXML_SUPPLIER'', ''Yes'', ''TRANSPARENT_SUPPLIER'', ''Yes'',''VIA_EXCHANGE'', ''Yes'', ''No'') IS_ZONE_FOR_SUPPLIER_SITE,
       DECODE(TYPE, ''PUNCHOUT'', DECODE(PROTOCOL_SUPPORTED, ''CXML_SUPPLIER'',''Yes'', ''No''), ''TRANSPARENT_PUNCHOUT'', DECODE(PROTOCOL_SUPPORTED,''TRANSPARENT_SUPPLIER'',''Yes'',''No''), ''No'') IS_SUPPLIER_MODE_cXML,
       DECODE(TYPE, ''LOCAL'', ''No'',''PUNCHOUT'', DECODE(PROTOCOL_SUPPORTED,''VIA_EXCHANGE'',''No'',''Yes''), ''Yes'') IS_PUNCH_OR_TRANS_OR_INFO_ZONE,
       DECODE(TYPE, ''PUNCHOUT'', ''Yes'', ''INFORMATIONAL'', ''Yes'', ''No'') IS_PUNCH_OR_INFO_ZONE,
DECODE(IcxCatContentZoneEO.SUPPLIER_ATTRIBUTE_ACTION_FLAG, ''INCLUDE_ALL'', ''No'', ''EXCLUDE_ALL'', ''No'', ''Yes'') IS_SPECIFIC_SUPPL_ATTACHED,
       DECODE(IcxCatContentZoneEO.CATEGORY_ATTRIBUTE_ACTION_FLAG, ''INCLUDE_ALL'', ''No'', ''Yes'') IS_SPECIFIC_CATG_ATTACHED,
       DECODE(IcxCatContentZoneEO.SECURITY_ASSIGNMENT_FLAG, ''OU_SECURED'', ''Yes'', ''No'') IS_SPECIFIC_OU_ATTACHED,
       PunchoutDetails.NEGOTIATED_FLAG,
       DECODE(PROTOCOL_SUPPORTED,''EXCHANGE'',''Yes'',''TRANSPARENT_EXCHANGE'', ''Yes'', ''TRANSPARENT_SUPPLIER'', ''Yes'',''No'') IS_USER_NAME_REQUIRED,
       DECODE(PROTOCOL_SUPPORTED, ''XML_SUPPLIER'', ''Yes'', ''No'') IS_SUPPLIER_MODE_XML,
       DECODE(PROTOCOL_SUPPORTED, ''XML_SUPPLIER'', ''Yes'',''TRANSPARENT_SUPPLIER'', ''Yes'',''No'') IS_COMP_INFO_REQUIRED,
       DECODE(PROTOCOL_SUPPORTED, ''TRANSPARENT_EXCHANGE'', ''Yes'', ''No'' ) IS_EXCHANGE_NAME_REQUIRED,
       DECODE(PROTOCOL_SUPPORTED,''TRANSPARENT_SUPPLIER'',''Yes'',''No'') IS_SUPPLEMENTAL_INFO_REQUIRED,
       DECODE(PROTOCOL_SUPPORTED, ''EXCHANGE'', ''Yes'',''TRANSPARENT_EXCHANGE'', ''Yes'', ''No'') IS_ZONE_FOR_EXCHANGE_SITE,
       DECODE(IcxCatContentZoneEO.SECURITY_ASSIGNMENT_FLAG, ''RESP_SECURED'', ''Yes'', ''No'') IS_SPECIFIC_RESP_ATTATCHED,
       DECODE(PROTOCOL_SUPPORTED, ''VIA_EXCHANGE'', ''Yes'', ''No'') IS_VIA_EXCHANGE,
       IcxCatContentZoneEO.ITEMS_WITHOUT_SUPPLIER_FLAG,
       IcxCatContentZoneEO.SQE_SEQUENCE
FROM   ICX_CAT_CONTENT_ZONES_VL IcxCatContentZoneEO,
       ICX_CAT_PUNCHOUT_ZONE_DETAILS PunchoutDetails
WHERE  IcxCatContentZoneEO.ZONE_ID = PunchoutDetails.ZONE_ID (+)',
      p_title                  => 'Content Zone Detailed Information',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This shows content zone detailed information.',
      p_solution               => 'No action is needed as this is only informational.
',
      p_success_msg            => 'This shows content zone detailed information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: IP_DETAILED_CONTENT_ZONE');



debug('begin add_signature: INTERMEDIA_INDEX_HARD_LIMIT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15417',
      p_sig_id                 => 'INTERMEDIA_INDEX_HARD_LIMIT',
      p_sig_sql                => 'select /*+ INDEX(a) */ (4294967295 - IDX_DOCID_COUNT) gap  
from CTXSYS.DR$INDEX a 
where IDX_ID in (select idx_id from  ctxsys.ctx_indexes
                 where IDX_OWNER = ''ICX''
                 and idx_name = ''ICX_CAT_ITEMSCTXDESC_HDRS'')',
      p_title                  => 'Intermedia Index Size',
      p_fail_condition         => '[gap] < [1000000000]',
      p_problem_descr          => 'InterMedia Index is reaching the <strong>hard limit of of 2^32-1 (4294967295)</strong>.',
      p_solution               => 'GAP - Remaining number of DOCIDs before reaching hard limit.  Items created/updated after reaching the hard limit will not show in iProcurement search results.</br>

See [2708151/KB785207] Items Not Showing In the Search Results In iProcurement Due To InterMedia Index Issues.
',
      p_success_msg            => 'Intermedia index limit is ok. A gap under 1,000,000,000 would require attention. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: INTERMEDIA_INDEX_HARD_LIMIT');



debug('begin add_signature: INTERMEDIA_INDEX_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15418',
      p_sig_id                 => 'INTERMEDIA_INDEX_ERRORS',
      p_sig_sql                => 'SELECT *
           FROM ctxsys.CTX_INDEX_ERRORS
           where ERR_INDEX_OWNER = ''ICX''
           and ERR_INDEX_NAME = ''ICX.ICX_CAT_ITEMSCTXDESC_HDRS''',
      p_title                  => 'Intermedia Index Errors',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'InterMedia Index has errors.',
      p_solution               => 'See [2708151/KB785207] Items Not Showing In the Search Results In iProcurement Due To InterMedia Index Issues.
',
      p_success_msg            => 'Intermedia index is ok.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: INTERMEDIA_INDEX_ERRORS');



debug('begin add_signature: INTERMEDIA_INDEX_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15419',
      p_sig_id                 => 'INTERMEDIA_INDEX_STATUS',
      p_sig_sql                => 'select /*+ INDEX(a) */ IDX_DOCID_COUNT, IDX_NEXTID, IDX_STATUS 
from CTXSYS.DR$INDEX a 
where IDX_ID in 
   (select idx_id from  ctxsys.ctx_indexes 
    where IDX_OWNER = ''ICX'' 
    and idx_name = ''ICX_CAT_ITEMSCTXDESC_HDRS'')',
      p_title                  => 'Intermedia Index Total',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'InterMedia Index Total and Status.',
      p_solution               => 'See [2708151/KB785207] Items Not Showing In the Search Results In iProcurement Due To InterMedia Index Issues.
',
      p_success_msg            => 'InterMedia Index Total and Status.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: INTERMEDIA_INDEX_STATUS');
...
debug('begin add_signature: ICX_APPLICATION_INSTALL_DETAILS');
   l_info('##SHOW_SQL##'):= 'N';
  add_signature(
      p_sig_repo_id            => '7506',
      p_sig_id                 => 'ICX_APPLICATION_INSTALL_DETAILS',
      p_sig_sql                => 'SELECT fav.application_name app_name, 
fav.application_short_name app_s_name, 
decode(fpi.status, ''I'', ''Yes'', 
''S'', ''Shared'', 
...
FROM fnd_application_vl fav, fnd_product_installations fpi
WHERE fav.application_id = fpi.application_id
AND fav.application_id = 178
order by 3',
      p_title                  => 'iProcurement Application Installation Details',
      p_fail_condition         => '[inst_status] in ['||mask_text(g_c_shared, nvl( upper(''), 'NO_MASK') )||','||mask_text(g_c_no, nvl( upper(''), 'NO_MASK') )||']',
      p_problem_descr          => 'Oracle iProcurement (ICX) is set as Shared installed or Not installed',
      p_solution               => '',
      p_success_msg            => 'iProcurement Installation Status',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ICX_APPLICATION_INSTALL_DETAILS');



debug('begin add_signature: PO_APPLICATION_INSTALL_DETAILS');
   l_info('##SHOW_SQL##'):= 'N';
  add_signature(
      p_sig_repo_id            => '6995',
      p_sig_id                 => 'PO_APPLICATION_INSTALL_DETAILS',
      p_sig_sql                => 'SELECT fav.application_name app_name, 
fav.application_short_name app_s_name, 
decode(fpi.status, ''I'', ''Yes'', 
''S'', ''Shared'', 
...
FROM fnd_application_vl fav, fnd_product_installations fpi
WHERE fav.application_id = fpi.application_id
AND fav.application_id = 201
order by 3',
      p_title                  => 'Purchasing Application Installation Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Products installed',
      p_solution               => '',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: PO_APPLICATION_INSTALL_DETAILS');



debug('begin add_signature: CHECK_WORKFLOW_HOT_FIX_FILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22242',
      p_sig_id                 => 'CHECK_WORKFLOW_HOT_FIX_FILE_CHECK',
      p_sig_sql                => 'select * from (
(select ''$FND_TOP/''||lower(af1.APP_SHORT_NAME)||substr(af1.subdir,5)||''/''||af1.filename "Filename",
     afv1.version "Current Version", ''120.8.12020000.5'' "Fixed Version",
...
where af1.file_id = afv1.file_id
  and af1.filename in (''wfldrb.pls'')
  and af1.subdir = ''patch/115/sql''
  )
union all
(select ''$FND_TOP/''||lower(af1.APP_SHORT_NAME)||substr(af1.subdir,5)||''/''||af1.filename "Filename",
     afv1.version "Current Version", ''120.6.12020000.2'' "Fixed Version",
	   rank()over(partition by af1.filename
	     order by afv1.version_segment1 desc,
	     afv1.version_segment2 desc,afv1.version_segment3 desc,
	     afv1.version_segment4 desc,afv1.version_segment5 desc,
  ...
  from ad_files af1, ad_file_versions afv1
where af1.file_id = afv1.file_id
  and af1.filename in (''wfldrs.pls'')
  and af1.subdir = ''patch/115/sql''
  )
 ) 
where rankUS = 1
...
order by 3 desc',
      p_title                  => 'Check files for Critical Workflow issue in Release 12.2',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are specific file versions identified that are below recommended versions to avoid known stuck Workflow issues in Release 12.2
',
      p_solution               => 'Workflow activities associated with the item type that was upgraded may cause date changes that could result in a stuck workflow process.
<br><br>
Please follow the steps in [2367572/KB229271] - to apply Development Recommended Critical Patch {27911576} and verify if there are any stuck transactions 12.2.
',
      p_success_msg            => 'The version of files wfldrb.pls, wfldrs.pls are correctly installed on this R12.2 instance.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CHECK_WORKFLOW_HOT_FIX_FILE_CHECK');



debug('begin add_signature: POA_TABLESPACE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1693',
      p_sig_id                 => 'POA_TABLESPACE_CHECK',
      p_sig_sql                => 'SELECT s.segment_name object_name,
           s.owner,
    ...
    AND   (s.segment_name like ''PO\_%'' escape ''\'' OR s.segment_name like ''ICX\_%'' escape ''\'')
    ...
    ORDER BY extents desc',
      p_title                  => 'Potential Space and Extents Issues',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The objects listed above are either approaching their
     ...
     free space in the tablespace.',
      p_solution               => '<ul> <li>Review items indicated and increase the max extents or add
   ...
   l_info.delete;
debug('end add_signature: POA_TABLESPACE_CHECK');



debug('begin add_signature: IP_PO_DOCUMENT_ITEMS_NOT_SHOWING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1180',
      p_sig_id                 => 'IP_PO_DOCUMENT_ITEMS_NOT_SHOWING',
      p_sig_sql                => 'SELECT POH.SEGMENT1, POL.po_line_id,
       NVL(ICXM.SHOPPING_CATEGORY_ID, NULL) ip_cat_id, mtl.segment1 "Item Number", 
       pol.item_description, pol.expiration_date
FROM PO_HEADERS_ALL POH, 
     PO_LINES_ALL POL, 
     PO_ATTRIBUTE_VALUES_TLP TLP,
     ICX_CAT_PURCHASING_CAT_MAP_V ICXM, 
     MTL_SYSTEM_ITEMS_B MTL
WHERE   POH.po_header_id = ##$$DOCHEADID$$##
AND POL.CATEGORY_ID = ICXM.po_category_id
AND POH.po_header_id = POL.po_header_id
AND TLP.language = ''US''
AND POH.org_id = ##$$ORGID$$##
...
order by pol.line_num ASC',
      p_title                  => 'Items From Blanket Orders Not Showing',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Item details for an invalid category mapping.',
      p_solution               => 'See [579294/KB197490] BPA Lines Created With One Time Item Before Associated Category Mapping, Can Not Be Seen In iProcurement Catalog for the solution and data fix.',
      p_success_msg            => 'There appears to be no issues with category mappings for these blanket purchase agreements.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: IP_PO_DOCUMENT_ITEMS_NOT_SHOWING');



debug('begin add_signature: IP_PO_DOCUMENT_NOT_SHOWING_BLANKET_UNAPPROVED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1189',
      p_sig_id                 => 'IP_PO_DOCUMENT_NOT_SHOWING_BLANKET_UNAPPROVED',
      p_sig_sql                => 'SELECT POH.last_update_date, POH.SEGMENT1 PO_Number, POL.line_num PO_Line,
       mtl.segment1 "Item Number",
       pol.item_description,
       POH.org_id, POH.po_header_id, POL.po_line_id,
...
AND TYPE_LOOKUP_CODE = ''BLANKET''
  order by last_update_date desc, po_header_id desc',
      p_title                  => 'Items From Blanket Orders Not Showing Due To Un-Approved Purchase Order',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Item details for a un-approved blanket order.',
      p_solution               => 'Approve the Purchase Order for the item(s) to be seen.
',
      p_success_msg            => 'The blanket order is approved.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: IP_PO_DOCUMENT_NOT_SHOWING_BLANKET_UNAPPROVED');



debug('begin add_signature: IP_PO_DOCUMENT_ITEMS_NOT_SHOWING_BLANKET_EXPIRED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1182',
      p_sig_id                 => 'IP_PO_DOCUMENT_ITEMS_NOT_SHOWING_BLANKET_EXPIRED',
      p_sig_sql                => 'SELECT POH.SEGMENT1, POL.po_line_id,
       mtl.segment1 "Item Number", 
       pol.item_description, 
       pol.expiration_date
FROM PO_HEADERS_ALL POH, 
     ...
     FINANCIALS_SYSTEM_PARAMS_ALL FSP
WHERE POH.po_header_id = POL.po_header_id  
AND POH.po_header_id = ##$$DOCHEADID$$##
AND POH.org_id = ##$$ORGID$$##
AND POH.org_id = FSP.ORG_ID
AND FSP.INVENTORY_ORGANIZATION_ID = mtl.organization_id
AND pol.item_id = mtl.inventory_item_id
...
AND pol.expiration_date < trunc(sysdate)',
      p_title                  => 'Item From Blanket Orders Not Showing Due To Expired Line',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Item details for expired blanket ##$$DOCID$$##,  line ##$$RELID$$## in organization '||mask_text(g_org_name, nvl( upper(''), 'NO_MASK') )||' ('||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||').',
      p_solution               => 'Remove the expiration date for the one time item to be seen.',
      p_success_msg            => 'The blanket ##$$DOCID$$##,  line ##$$RELID$$## in organization '||mask_text(g_org_name, nvl( upper(''), 'NO_MASK') )||' ('||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||') is not expired.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: IP_PO_DOCUMENT_ITEMS_NOT_SHOWING_BLANKET_EXPIRED');



debug('begin add_signature: PO_ATTRIBUTE_VALUES_ITEM_PO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1183',
      p_sig_id                 => 'PO_ATTRIBUTE_VALUES_ITEM_PO',
      p_sig_sql                => 'SELECT ATTRIBUTE_VALUES_ID
      ,PO_LINE_ID
      ,REQ_TEMPLATE_LINE_NUM
      ,IP_CATEGORY_ID
      ...
      ,REBUILD_SEARCH_INDEX_FLAG
FROM po_attribute_values
WHERE inventory_item_id = Nvl(##$$ITEMID$$##, inventory_item_id)
AND po_line_id = Nvl(##$$DOCLINEID$$##, po_line_id)',
      p_title                  => 'PO_ATTRIBUTE_VALUES',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'PO_ATTRIBUTE_VALUES are not present for the item/purchase order line ID.',
      p_solution               => '',
      p_success_msg            => 'PO_ATTRIBUTE_VALUES are present for the item/purchase order line ID.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PO_ATTRIBUTE_VALUES_ITEM_PO');



debug('begin add_signature: PO_ATTRIBUTE_VALUES_TLP_ITEM_PO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1184',
      p_sig_id                 => 'PO_ATTRIBUTE_VALUES_TLP_ITEM_PO',
      p_sig_sql                => 'SELECT ATTRIBUTE_VALUES_TLP_ID
      ,PO_LINE_ID
      ,REQ_TEMPLATE_LINE_NUM
      ,IP_CATEGORY_ID
...
AND po_line_id = Nvl(##$$DOCLINEID$$##, po_line_id)',
      p_title                  => 'PO_ATTRIBUTE_VALUES_TLP',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'PO_ATTRIBUTE_VALUES_TLP are not present for the item/purchase order line ID.',
      p_solution               => '',
      p_success_msg            => 'PO_ATTRIBUTE_VALUES_TLP are present for the item/purchase order line ID.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PO_ATTRIBUTE_VALUES_TLP_ITEM_PO');



debug('begin add_signature: ICX_CAT_ATTRIBUTE_VALUES_ITEM_PO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1185',
      p_sig_id                 => 'ICX_CAT_ATTRIBUTE_VALUES_ITEM_PO',
      p_sig_sql                => 'SELECT ATTRIBUTE_VALUES_ID
      ,PO_LINE_ID
      , picture, thumbnail_image, last_update_date
      ,REQ_TEMPLATE_LINE_NUM
...
AND po_line_id = Nvl(##$$DOCLINEID$$##, po_line_id)',
      p_title                  => 'ICX_CAT_ATTRIBUTE_VALUES',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'ICX_CAT_ATTRIBUTE_VALUES are not present for the item/purchase order line ID.',
      p_solution               => '',
      p_success_msg            => 'ICX_CAT_ATTRIBUTE_VALUES are present for the item/purchase order line ID.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ICX_CAT_ATTRIBUTE_VALUES_ITEM_PO');



debug('begin add_signature: ICX_CAT_ATTRIBUTE_VALUES_TLP_ITEM_PO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1187',
      p_sig_id                 => 'ICX_CAT_ATTRIBUTE_VALUES_TLP_ITEM_PO',
      p_sig_sql                => 'SELECT ATTRIBUTE_VALUES_TLP_ID
      ,PO_LINE_ID
      ,REQ_TEMPLATE_LINE_NUM
      ,IP_CATEGORY_ID
...
AND po_line_id = Nvl(##$$DOCLINEID$$##, po_line_id)',
      p_title                  => 'ICX_CAT_ATTRIBUTE_VALUES_TLP',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'ICX_CAT_ATTRIBUTE_VALUES_TLP are not present for the item/purchase order line ID.',
      p_solution               => '',
      p_success_msg            => 'ICX_CAT_ATTRIBUTE_VALUES_TLP are present for the item/purchase order line ID.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ICX_CAT_ATTRIBUTE_VALUES_TLP_ITEM_PO');



debug('begin add_signature: ICX_CAT_ATTRIBUTE_VALUES_TLP_ITEM');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1266',
      p_sig_id                 => 'ICX_CAT_ATTRIBUTE_VALUES_TLP_ITEM',
      p_sig_sql                => 'SELECT DISTINCT language 
FROM icx_cat_attribute_values_tlp 
...
AND req_template_line_num = -2',
      p_title                  => 'Languages For Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' That Have Attributes Created For A PO_LINE_ID',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The attributes are not created for a PO_LINE_ID in iProcurement in any language.',
      p_solution               => '',
      p_success_msg            => 'Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' attributes are created for a PO_LINE_ID in iProcurement in the above languages.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ICX_CAT_ATTRIBUTE_VALUES_TLP_ITEM');



debug('begin add_signature: MTL_SYSTEM_ITEMS_TL_BLANKET');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1267',
      p_sig_id                 => 'MTL_SYSTEM_ITEMS_TL_BLANKET',
      p_sig_sql                => 'SELECT DISTINCT LANGUAGE, 
                source_lang 
...
AND LANGUAGE = source_lang',
      p_title                  => 'Languages That Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' Is Translated For',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' is not translated.',
      p_solution               => '',
      p_success_msg            => 'Item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' is translated to the above languages.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: MTL_SYSTEM_ITEMS_TL_BLANKET');



debug('begin add_signature: ITEM_NOT_TRANSLATED_FOR_INSTALLED_LANGUAGES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15487',
      p_sig_id                 => 'ITEM_NOT_TRANSLATED_FOR_INSTALLED_LANGUAGES',
      p_sig_sql                => 'SELECT icht.org_id, msit.inventory_item_id, icht.source_type, po_header_id, po_line_id, document_number, line_num, msit.source_lang, msit.LANGUAGE Needs_Translation_To
FROM mtl_system_items_tl msit, ICX_CAT_ITEMS_CTX_HDRS_TLP icht
WHERE
msit.LANGUAGE <> msit.source_lang
AND msit.source_lang = icht.language
AND msit.LANGUAGE IN (SELECT language_code FROM fnd_languages WHERE installed_flag IN (''B'',''I''))
AND msit.organization_id = icht.org_id
AND msit.inventory_item_id = icht.inventory_item_id
AND icht.inventory_item_id = ##$$ITEMID$$## AND icht.org_id = ##$$ORGID$$##
order by msit.inventory_item_id, icht.language, source_type, po_header_id desc, po_line_id, msit.language',
      p_title                  => 'Item Does Not Appear in Search Results for Some Languages',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Item does not appear in iProcurement for some languages.  Search for the item and the search results returns 0 records for some languages.',
      p_solution               => 'Review [330310/KB198211] Why Are iProcurement Search Results Different for Different Language Preference?<br>
Also consider - How To Mass Translate / Update Items In iProcurement Only Visible In Base Language Catalog [1484588/KB197741]',
      p_success_msg            => 'Item is translated for all languages and will therefore show in iProcurement search results for all languages.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ITEM_NOT_TRANSLATED_FOR_INSTALLED_LANGUAGES');



debug('begin add_signature: ICX_CAT_ATTRIBUTE_VALUES_TLP_BLANKET');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1269',
      p_sig_id                 => 'ICX_CAT_ATTRIBUTE_VALUES_TLP_BLANKET',
      p_sig_sql                => 'SELECT DISTINCT language 
FROM icx_cat_attribute_values_tlp 
WHERE LANGUAGE IN (SELECT language_code FROM fnd_languages WHERE installed_flag IN (''B'',''I''))
AND po_line_id = ##$$DOCLINEID$$##
AND req_template_name = ''-2''
AND req_template_line_num = -2',
      p_title                  => 'Languages For Purchase Order Line # '||mask_text(g_line_num, nvl( upper(''), 'NO_MASK') )||' Where The Attributes Are Created In iProcurement',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No languages installed for purchase order line # '||mask_text(g_line_num, nvl( upper(''), 'NO_MASK') )||' where the attributes are created in iProcurement.',
      p_solution               => '',
      p_success_msg            => 'Purchase order line # '||mask_text(g_line_num, nvl( upper(''), 'NO_MASK') )||' has attributes that are created in iProcurement for the above languages.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ICX_CAT_ATTRIBUTE_VALUES_TLP_BLANKET');



debug('begin add_signature: PO_ATTRIBUTE_VALUES_TLP_BLANKET');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1270',
      p_sig_id                 => 'PO_ATTRIBUTE_VALUES_TLP_BLANKET',
      p_sig_sql                => 'SELECT DISTINCT language 
FROM po_attribute_values_tlp  
WHERE LANGUAGE IN (SELECT language_code FROM fnd_languages WHERE installed_flag IN (''B'',''I''))
AND po_line_id = ##$$DOCLINEID$$##
AND req_template_name = ''-2''
AND req_template_line_num = -2',
      p_title                  => 'Languages For Purchase Order Line # '||mask_text(g_line_num, nvl( upper(''), 'NO_MASK') )||' Where The Attributes Are Created In Purchasing',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No languages installed for purchase order line # '||mask_text(g_line_num, nvl( upper(''), 'NO_MASK') )||' where the attributes are created in Purchasing.',
      p_solution               => '',
      p_success_msg            => 'Purchase order line # '||mask_text(g_line_num, nvl( upper(''), 'NO_MASK') )||' has attributes that are created in Purchasing for the above languages.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PO_ATTRIBUTE_VALUES_TLP_BLANKET');



debug('begin add_signature: IP_ITEM_SPECIFIC_CATEGORY_DOES_NOT_MATCH_LATEST_CATEGORY_MAPPING_NOTE2072353');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10676',
      p_sig_id                 => 'IP_ITEM_SPECIFIC_CATEGORY_DOES_NOT_MATCH_LATEST_CATEGORY_MAPPING_NOTE2072353',
      p_sig_sql                => 'select distinct mck.category_id, mck.segment1, mck.segment2, ctxh.ip_category_name Actual_iProc_Category_Name, icxmapping.category_name Expected_iProc_Category_Name, ctxh.ip_category_id Actual_iProc_Category_Id, icxmapping.rt_category_id Expected_iProc_Category_Id, icxmapping.language, ctxh.inventory_item_id, ctxh.org_id, ctxh.description iProc_Item_Description, msib.description Inv_Item_description, msib.segment1 Inv_Item_Number
      ...
      where msib.organization_id(+) = ctxh.org_id
        ...
        and ctxh.inventory_item_id = ##$$ITEMID$$##
 ...
 and ctxh.org_id = ##$$ORGID$$##
order by ctxh.org_id, msib.segment1',
      p_title                  => 'The Category for This Item Does Not Match the Latest Category Mapping',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This item has an old category rather than the current / new mapped shopping category. After changing the mapping of the purchasing category to a new shopping category, all the affected items should reflect the new shopping category automatically. However, this item does not reflect the newly mapped shopping category. This can cause issues such as the item not appearing in search results, or appearing with the wrong (old) value displayed for category.',
      p_solution               => 'See [2072353/KB744416] Shopping Category Does Not Map In Existing Items When Changing Or Creating New Shopping Category For A Purchasing Category',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: IP_ITEM_SPECIFIC_CATEGORY_DOES_NOT_MATCH_LATEST_CATEGORY_MAPPING_NOTE2072353');



debug('begin add_signature: IP_ITEMS_CATEGORY_DOES_NOT_MATCH_LATEST_CATEGORY_MAPPING_NOTE2072353_1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10658',
      p_sig_id                 => 'IP_ITEMS_CATEGORY_DOES_NOT_MATCH_LATEST_CATEGORY_MAPPING_NOTE2072353_1',
      p_sig_sql                => 'select distinct mck.category_id, mck.segment1, mck.segment2, ctxh.ip_category_name Actual_iProc_Category_Name, icxmapping.category_name Expected_iProc_Category_Name, ctxh.ip_category_id Actual_iProc_Category_Id, icxmapping.rt_category_id Expected_iProc_Category_Id, icxmapping.language, ctxh.inventory_item_id, ctxh.org_id, ctxh.description iProc_Item_Description, msib.description Inv_Item_description, msib.segment1 Inv_Item_Number
       from mtl_categories_kfv mck,
            mtl_category_set_valid_cats mcsvc,
            icx_por_category_data_sources purchmapping,
 ...
 and ctxh.org_id = ##$$ORGID$$##
order by ctxh.org_id, msib.segment1',
      p_title                  => 'iProcurement Items Having Category Value That Does Not Match Latest Category Mapping',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The listed items still have an old category rather than the current / new mapped shopping category. After changing the mapping of the purchasing category to a new shopping category, all the affected items should reflect the new shopping category automatically. However, the items listed here do not reflect the newly mapped shopping category. This can cause issues such as these items not appearing in search results, or appearing with the wrong (old) value displayed for category.',
      p_solution               => 'See [2072353/KB744416] Shopping Category Does Not Map In Existing Items When Changing Or Creating New Shopping Category For A Purchasing Category',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: IP_ITEMS_CATEGORY_DOES_NOT_MATCH_LATEST_CATEGORY_MAPPING_NOTE2072353_1');



debug('begin add_signature: IP_CATEGORY_DOES_NOT_MATCH_LATEST_CATEGORY_MAPPING_NOTE2072353_1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10657',
      p_sig_id                 => 'IP_CATEGORY_DOES_NOT_MATCH_LATEST_CATEGORY_MAPPING_NOTE2072353_1',
      p_sig_sql                => 'select distinct mck.category_id, mck.segment1, mck.segment2, ctxh.ip_category_name Actual_iProc_Category_Name, icxmapping.category_name Expected_iProc_Category_Name, ctxh.ip_category_id Actual_iProc_Category_Id, icxmapping.rt_category_id Expected_iProc_Category_Id, icxmapping.language
       from mtl_categories_kfv mck,
            mtl_category_set_valid_cats mcsvc,
            icx_por_category_data_sources purchmapping,
            icx_cat_categories_tl icxmapping,
            icx_cat_items_ctx_hdrs_tlp ctxh,
            (select distinct category_set_id, structure_id from mtl_default_sets_view where functional_area_id = 2) mtdsv
      where mck.structure_id = mtdsv.structure_id
        and mcsvc.category_set_id = mtdsv.category_set_id
        and mcsvc.category_id = mck.category_id
        and purchmapping.external_source_key = to_char(mck.category_id)
        and purchmapping.external_source = ''Oracle''
 ...
 ctxh.ip_category_name <> icxmapping.category_name)
and ctxh.org_id = ##$$ORGID$$##',
      p_title                  => 'iProcurement Categories Having Category Value Does Not Match Latest Category Mapping',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Items associated to these Categories reflect an old category mapping rather than the current / new mapped shopping category.  After changing the mapping of the purchasing category to a new shopping category, all the affected items should reflect the new shopping category automatically.  However, the items associated to these categories do not reflect the newly mapped shopping category.  This can cause issues such as items not appearing in search results, or appearing with the wrong (old) value displayed for category.',
      p_solution               => 'See [2072353/KB744416] Shopping Category Does Not Map In Existing Items When Changing Or Creating New Shopping Category For A Purchasing Category',
      p_success_msg            => 'Latest Category mapping updates are reflected for all categories in iProcurement',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: IP_CATEGORY_DOES_NOT_MATCH_LATEST_CATEGORY_MAPPING_NOTE2072353_1');



debug('begin add_signature: PURCHASING_OPTIONS_DOCUMENT_CONTROL_SETUP_12_1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1553',
      p_sig_id                 => 'PURCHASING_OPTIONS_DOCUMENT_CONTROL_SETUP_12_1',
      p_sig_sql                => 'SELECT
           PoSystemParameterEO.PRICE_CHANGE_ALLOWANCE "Price Tolerance (%)",
           PoSystemParameterEO.PRICE_CHANGE_AMOUNT "Price Tolerance Amount",
      ...
      p_title                  => 'Document Control Setup',
      p_fail_condition         => 'RS',
      p_problem_descr          => '<p>Review data for detail setup of the Purchasing Options of the Operating Unit.</P>
<p>Use the Purchasing Options window to define default values and controls for functions
throughout Purchasing. You can often override purchasing options when you are
creating documents.</p>
<li><b>Document Control</b></li>
<li><b>Document Defaults</b></li>
<li><b>Accounting setup</b></li>
<li><b>Document Numbering</b></li></p>

<p><a href="https://docs.oracle.com/cd/E18727_01/doc.121/e13410/T446883T443950.htm#4021096" target="_blank" rel="noopener">Oracle&reg; Purchasing User''s Guide Release 12.1 Part No. E13410-05 - page 1-34</a></p>',
      p_solution               => 'See [429105/KB627998] Impact of R12 Design in Procure To Pay Accounting Flow for additional information.
',
      p_success_msg            => 'No Data Found for purchasing options setup.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PURCHASING_OPTIONS_DOCUMENT_CONTROL_SETUP_12_1');



debug('begin add_signature: PURCHASING_OPTIONS_DOCUMENT_DEFAULTS_12_1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1555',
      p_sig_id                 => 'PURCHASING_OPTIONS_DOCUMENT_DEFAULTS_12_1',
      p_sig_sql                => 'SELECT
       ...
       decode(PoSystemParameterEO.ACCEPTANCE_REQUIRED_FLAG,''D'',''Document'',''N'',''None'',''P'',''Proxy Signature'',''S'',''Signature'',''Y'',''Document or Shipment'') "Acceptance Required Flag",
    ...
    where
        ...
        and PoSystemParameterEO.LINE_TYPE_ID = pltv.line_type_id (+) 
        and PoSystemParameterEO.SECURITY_POSITION_STRUCTURE_ID = pps.position_structure_id (+)',
      p_title                  => 'Document Defaults Setup',
      p_fail_condition         => 'RS',
      p_problem_descr          => '<p>Review data for detail setup of the Purchasing Options of the Operating Unit.</P>
<p>Use the Purchasing Options window to define default values and controls for functions
throughout Purchasing. You can often override purchasing options when you are
...
<p><a href="https://docs.oracle.com/cd/E18727_01/doc.121/e13410/T446883T443950.htm#t_dpodef" target="_blank" rel="noopener">Oracle&reg; Purchasing User''s Guide Release 12.1 Part No. E13410-05 - page 1-34</a></p>',
      p_solution               => 'See [429105/KB627998] Impact of R12 Design in Procure To Pay Accounting Flow for additional information.
',
      p_success_msg            => 'No Data Found for purchasing options setup.
',
   ...
   l_info.delete;
debug('end add_signature: PURCHASING_OPTIONS_DOCUMENT_DEFAULTS_12_1');



debug('begin add_signature: PURCHASING_OPTIONS_RECEIPT_ACCOUNTING_12_1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1557',
      p_sig_id                 => 'PURCHASING_OPTIONS_RECEIPT_ACCOUNTING_12_1',
      p_sig_sql                => 'SELECT
       PoSystemParameterEO.EXPENSE_ACCRUAL_CODE "Accrue Expense Items",
       PoSystemParameterEO.ACCRUED_CODE_COMBINATION_ID "Default Expense Accrual AcctID",
       PoSystemParameterEO.INVENTORY_ACCRUAL_CODE "Accrue Inventory Items",
       PoSystemParameterEO.AUTO_OFFSET_METHOD "Automatic Offset Method"
    FROM
           PO_SYSTEM_PARAMETERS_ALL PoSystemParameterEO,
           oe_transaction_types ot,
           po_line_types_val_v pltv,
...
<p><a href="https://docs.oracle.com/cd/E18727_01/doc.121/e13410/T446883T443950.htm#t_dpoacc" target="_blank" rel="noopener">Oracle&reg; Purchasing User''s Guide Release 12.1 Part No. E13410-05 - page 1-34</a></p>',
      p_solution               => 'See [429105/KB627998] Impact of R12 Design in Procure To Pay Accounting Flow for additional information.
',
      p_success_msg            => 'No Data Found for purchasing options setup.
',
   ...
   l_info.delete;
debug('end add_signature: PURCHASING_OPTIONS_RECEIPT_ACCOUNTING_12_1');



debug('begin add_signature: PURCHASING_OPTIONS_DOCUMENT_NUMBERING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1558',
      p_sig_id                 => 'PURCHASING_OPTIONS_DOCUMENT_NUMBERING',
      p_sig_sql                => 'SELECT decode(PoUniqueIdentifierContEO.TABLE_NAME,''PO_HEADERS_RFQ'',''RFQ Number'') "Document",
...
UNION
  SELECT decode(PoUniqueIdentifierContEO.TABLE_NAME,''PO_REQUISITION_HEADERS'',''Requisition Number'') "Document",
      ...
      p_title                  => 'Document Numbering Setup',
      p_fail_condition         => 'RS',
      p_problem_descr          => '<p>Review data for detail setup of the Purchasing Options of the Operating Unit.</P>
<p>Use the Purchasing Options window to define default values and controls for functions
throughout Purchasing. You can often override purchasing options when you are
...
<p><a href="https://docs.oracle.com/cd/E18727_01/doc.121/e13410/T446883T443950.htm#t_dponum" target="_blank" rel="noopener">Oracle&reg; Purchasing User''s Guide Release 12.1 Part No. E13410-05 - page 1-34</a></p>',
      p_solution               => 'See [429105/KB627998] Impact of R12 Design in Procure To Pay Accounting Flow for additional information.
',
      p_success_msg            => 'No Data Found for purchasing options setup.
',
   ...
   l_info.delete;
debug('end add_signature: PURCHASING_OPTIONS_DOCUMENT_NUMBERING');



debug('begin add_signature: PURCHASING_OPTIONS_SETUP_12_1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1550',
      p_sig_id                 => 'PURCHASING_OPTIONS_SETUP_12_1',
      p_sig_sql                => 'SELECT ''Expand subsections below to see the PO Options.'' "PO Options"
FROM dual',
      p_title                  => 'Purchasing Options Setup',
      p_fail_condition         => '[PO Options]<[0]',
      p_problem_descr          => 'Review data for detail setup of the Purchasing Options of the Operating Unit.',
      p_solution               => 'Review data for detail setup of the Purchasing Options of the Operating Unit.',
      p_success_msg            => 'Review data for detail setup of the Purchasing Options of the Operating Unit.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('PURCHASING_OPTIONS_DOCUMENT_CONTROL_SETUP_12_1','PURCHASING_OPTIONS_DOCUMENT_DEFAULTS_12_1','PURCHASING_OPTIONS_RECEIPT_ACCOUNTING_12_1','PURCHASING_OPTIONS_DOCUMENT_NUMBERING'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '47'
      );
   l_info.delete;
debug('end add_signature: PURCHASING_OPTIONS_SETUP_12_1');



debug('begin add_signature: PURCHASING_OPTIONS_DOCUMENT_CONTROL_SETUP_12_2');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1552',
      p_sig_id                 => 'PURCHASING_OPTIONS_DOCUMENT_CONTROL_SETUP_12_2',
      p_sig_sql                => 'SELECT
           PoSystemParameterEO.PRICE_CHANGE_ALLOWANCE "Price Tolerance (%)",
           PoSystemParameterEO.PRICE_CHANGE_AMOUNT "Price Tolerance Amount",
           PoSystemParameterEO.ENFORCE_FULL_LOT_QUANTITIES "Enforce Full Lot Quantity",   
           ...
           PoSystemParameterEO.RFQ_REQUIRED_FLAG "RFQ Required",
           PoSystemParameterEO.group_shipments_flag "Group Shipments",
           PoSystemParameterEO.LAST_UPDATE_DATE "LAST_UPDATE_DATE"
...
<p><a href="https://docs.oracle.com/cd/E26401_01/doc.122/e48931/T446883T443950.htm#t_dpocon" target="_blank" rel="noopener">Oracle&reg; Purchasing User''s Guide Release 12.2
Part Number E48931-08</a></p>',
      p_solution               => 'See [429105/KB627998] Impact of R12 Design in Procure To Pay Accounting Flow for additional information.
',
      p_success_msg            => 'No Data Found for purchasing options setup.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: PURCHASING_OPTIONS_DOCUMENT_CONTROL_SETUP_12_2');



debug('begin add_signature: PURCHASING_OPTIONS_DOCUMENT_DEFAULTS_12_2');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1554',
      p_sig_id                 => 'PURCHASING_OPTIONS_DOCUMENT_DEFAULTS_12_2',
      p_sig_sql                => 'SELECT
       PoSystemParameterEO.REQIMPORT_GROUP_BY_CODE "Requisition Import Group-By",
       PoSystemParameterEO.ORDER_TYPE_ID "Internal Req Order Type",
       PoSystemParameterEO.ORDER_SOURCE_ID "Internal Req Order Source",
...
<p><a href="https://docs.oracle.com/cd/E26401_01/doc.122/e48931/T446883T443950.htm#t_dpodef" target="_blank" rel="noopener">Oracle&reg; Purchasing User''s Guide Release 12.2
Part Number E48931-08</a></p>',
      p_solution               => 'See [429105/KB627998] Impact of R12 Design in Procure To Pay Accounting Flow for additional information.
',
      p_success_msg            => 'No Data Found for purchasing options setup.
',
   ...
   l_info.delete;
debug('end add_signature: PURCHASING_OPTIONS_DOCUMENT_DEFAULTS_12_2');



debug('begin add_signature: PURCHASING_OPTIONS_RECEIPT_ACCOUNTING_12_2');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1556',
      p_sig_id                 => 'PURCHASING_OPTIONS_RECEIPT_ACCOUNTING_12_2',
      p_sig_sql                => 'SELECT
       PoSystemParameterEO.EXPENSE_ACCRUAL_CODE "Accrue Expense Items",
       PoSystemParameterEO.ACCRUED_CODE_COMBINATION_ID "Default Expense Accrual AcctID",
       PoSystemParameterEO.INVENTORY_ACCRUAL_CODE "Accrue Inventory Items",
...
<p><a href="https://docs.oracle.com/cd/E26401_01/doc.122/e48931/T446883T443950.htm#t_dpoacc" target="_blank" rel="noopener">Oracle&reg; Purchasing User''s Guide Release 12.2
Part Number E48931-08</a></p>',
      p_solution               => 'See [429105/KB627998] Impact of R12 Design in Procure To Pay Accounting Flow for additional information.',
      p_success_msg            => 'No Data Found for purchasing options setup.
',
   ...
   l_info.delete;
debug('end add_signature: PURCHASING_OPTIONS_RECEIPT_ACCOUNTING_12_2');



debug('begin add_signature: PURCHASING_OPTIONS_SETUP_12_2');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1551',
      p_sig_id                 => 'PURCHASING_OPTIONS_SETUP_12_2',
      p_sig_sql                => 'SELECT ''Expand subsections below to see the PO Options.'' "PO Options"
FROM dual',
      p_title                  => 'Purchasing Options Setup',
      p_fail_condition         => '[count]<[0]',
      p_problem_descr          => 'Review data for detail setup of the Purchasing Options of the Operating Unit.',
      p_solution               => 'Review - Impact of R12 Design in Procure To Pay Accounting Flow [429105/KB627998] for additional information.
',
      p_success_msg            => 'Review data for detail setup of the Purchasing Options of the Operating Unit.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      ...
      p_limit_rows             => nvl('N','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('PURCHASING_OPTIONS_DOCUMENT_CONTROL_SETUP_12_2','PURCHASING_OPTIONS_DOCUMENT_DEFAULTS_12_2','PURCHASING_OPTIONS_RECEIPT_ACCOUNTING_12_2','PURCHASING_OPTIONS_DOCUMENT_NUMBERING'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '46'
      );
   l_info.delete;
debug('end add_signature: PURCHASING_OPTIONS_SETUP_12_2');



debug('begin add_signature: DOC_PO_STYLE_HEADER');
   l_info('##MASK##STYLE_DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2211',
      p_sig_id                 => 'DOC_PO_STYLE_HEADER',
      p_sig_sql                => 'SELECT *
    FROM po_doc_style_headers
    ORDER BY style_name',
      p_title                  => 'PO Style Header Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The style header table data could not be retrieved!',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: DOC_PO_STYLE_HEADER');



debug('begin add_signature: EBS_MFG_PO_IPI_INTERMEDIA_INDEX_NO_COMMITTED_OR_MINREL_COLUMN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25965',
      p_sig_id                 => 'EBS_MFG_PO_IPI_INTERMEDIA_INDEX_NO_COMMITTED_OR_MINREL_COLUMN',
      p_sig_sql                => 'SELECT INVENTORY_ITEM_ID
      ,PO_LINE_ID
      ,REQ_TEMPLATE_LINE_NUM
      ,ORG_ID
...
--      ,COMMITTED_AMOUNT
FROM icx_cat_items_ctx_hdrs_tlp 
WHERE contains(ctx_desc, ''##$$ITEMNUM$$##'') > 1
and org_id = ##$$ORGID$$##',
      p_title                  => 'Intermedia Index',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Intermedia index needs to be rebuilt for item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' from organization id '||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => 'See [729400/KB770999] How To Refresh The iProcurement Search (Intermedia) Index In Release 12.
',
      p_success_msg            => 'Intermedia index is valid for item '||mask_text(g_item_num, nvl( upper(''), 'NO_MASK') )||' from organization id '||mask_text(g_org_id, nvl( upper(''), 'NO_MASK') )||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_IPI_INTERMEDIA_INDEX_NO_COMMITTED_OR_MINREL_COLUMN');



debug('begin add_signature: INTERMEDIA_INDEX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1271',
      p_sig_id                 => 'INTERMEDIA_INDEX',
      p_sig_sql                => 'SELECT INVENTORY_ITEM_ID
      ,PO_LINE_ID
      ,REQ_TEMPLATE_LINE_NUM
      ,ORG_ID
...
',
   ...
   l_info.delete;
debug('end add_signature: INTERMEDIA_INDEX');
...
BEGIN
  ...
  analyzer_title := 'iProcurement Item Analyzer';
...
start_section('Proactive Recommendations', 'Proactive_Recommendations');
   IF substr(g_sql_tokens('##$$REL$$##'),1,4) = '12.2' THEN
      set_item_result(run_stored_sig('CHECK_WORKFLOW_HOT_FIX_FILE_CHECK'));
   END IF;
   set_item_result(check_rec_patches_1); /* Signature IP_RECOMMENDED_PATCHES */
   IF substr(g_sql_tokens('##$$FWK$$##'),1,1) = 'B'	 THEN
      set_item_result(check_rec_patches_2); /* Signature FWK_B */
   END IF;
   IF substr(g_sql_tokens('##$$FWK$$##'),1,3) = 'C.4'	 THEN
      set_item_result(check_rec_patches_3); /* Signature FWK_C4 */
   END IF;
   IF substr(g_sql_tokens('##$$FWK$$##'),1,3) = 'C.5'	 THEN
      set_item_result(check_rec_patches_4); /* Signature FWK_C5 */
   END IF;
   IF substr(g_sql_tokens('##$$FWK$$##'),1,3) = 'C.6'	 THEN
      set_item_result(check_rec_patches_5); /* Signature FWK_C6 */
   END IF;
   IF substr(g_sql_tokens('##$$FWK$$##'),1,3) = 'C.7'	 THEN
      set_item_result(check_rec_patches_6); /* Signature FWK_C7 */
   END IF;
   IF substr(g_sql_tokens('##$$FWK$$##'),1,3) = 'C.8' THEN
      set_item_result(check_rec_patches_7); /* Signature FWK_C8 */
   END IF;
   IF substr(g_sql_tokens('##$$FWK$$##'),1,3) = 'C.9' THEN
      set_item_result(check_rec_patches_8); /* Signature FWK_C9 */
   END IF;
   IF substr(g_sql_tokens('##$$FWK$$##'),1,3) = 'C.10' THEN
      set_item_result(check_rec_patches_9); /* Signature FWK_C10 */
   END IF;
   IF substr(g_sql_tokens('##$$FWK$$##'),1,3) = 'C.11' THEN
      set_item_result(check_rec_patches_10); /* Signature FWK_C11 */
   END IF;
   IF substr(g_sql_tokens('##$$FWK$$##'),1,3) = 'C.12' THEN
      set_item_result(check_rec_patches_11); /* Signature EBS_ATG_FWK_C12 */
   END IF;
   IF substr(g_sql_tokens('##$$FWK$$##'),1,3) = 'C.13' THEN
      set_item_result(check_rec_patches_12); /* Signature EBS_ATG_FWK_C13 */
   END IF;
   set_item_result(run_stored_sig('IP_SPECIFIC_PROFILES'));
   set_item_result(run_stored_sig('IP_MOAC_PROFILE'));
   set_item_result(run_stored_sig('IP_CUSTOM_PROFILE'));
   set_item_result(run_stored_sig('POR_AUTO_CREATE_SHOPPING_CAT_PROFILE'));
   set_item_result(run_stored_sig('IP_PROFILE_PO_LEGAL_REQ_TYPE'));
   set_item_result(run_stored_sig('OAF_PERSONALIZATIONS'));
   set_item_result(run_stored_sig('IP_NONCATALOG_LINE_TYPE_PROFILE_VALUES_NOT_DISTINCT'));
   IF substr(g_sql_tokens('##$$REL$$##'),1,4) = '12.4' THEN
      set_item_result(run_stored_sig('POA_TABLESPACE_CHECK'));
   END IF;
end_section;
debug('end section: Proactive_Recommendations');

debug('begin section: Setup');
start_section('Setup Related Data', 'Setup');
   ...
   set_item_result(run_stored_sig('EBS_MFG_PO_IPI_MTL_PARAMETERS'));
   IF g_use_ame THEN
      set_item_result(run_stored_sig('DOC_PO_STYLE_HEADER'));
   END IF;
   set_item_result(run_stored_sig('UOM_MISSING_IN_MTL_UOM_CLASS_CONVERSIONS'));
   set_item_result(run_stored_sig('IP_IPROC_NOT_INSTALLED'));
end_section;
debug('end section: Setup');

debug('begin section: Specific_Item_Checks');
IF p_item_num IS NOT NULL  THEN
   start_section('Specific Item Checks', 'Specific_Item_Checks');
      ...
      set_item_result(run_stored_sig('IP_ITEM_LINE_PO_DOCUMENT_NOT_SHOWING_BLANKET_UNAPPROVED'));
      set_item_result(run_stored_sig('IP_BLANKET_LINE_EXPIRED_ITEM_NOT_SHOWING'));
      set_item_result(run_stored_sig('IP_MASTER_ITEM_MISSING_PO_ATTRIBUTE_VALUES'));
      set_item_result(run_stored_sig('ITEM - INTERNAL SOURCES'));
      set_item_result(run_stored_sig('ITEM_ORGANIZATIONS'));
      set_item_result(run_stored_sig('ITEM_ORG_DEFINITION'));
      set_item_result(run_stored_sig('ITEM_OPERATING_UNITS'));
   end_section;
END IF;
debug('end section: Specific_Item_Checks');

debug('begin section: Item_Related_Table_Details');
IF p_item_num IS NOT NULL  THEN
   start_section('Item Related Table Details', 'Item_Related_Table_Details');
      set_item_result(run_stored_sig('MTL_SYSTEM_ITEMS_B'));
      set_item_result(run_stored_sig('MTL_SYSTEM_ITEMS_TL'));
      set_item_result(run_stored_sig('ICX_CAT_ITEMS_CTX_HDRS_TLP'));
      set_item_result(run_stored_sig('ICX_CAT_ITEMS_CTX_DTLS_TLP'));
      set_item_result(run_stored_sig('ICX_CAT_ATTRIBUTE_VALUES'));
      set_item_result(run_stored_sig('ICX_CAT_ATTRIBUTE_VALUES_TLP'));
      set_item_result(run_stored_sig('PO_LINE_ATTRIBUTE_VALUES'));
      set_item_result(run_stored_sig('PO_LINE_ATTRIBUTE_VALUES_TLP'));
      set_item_result(run_stored_sig('EBS_MFG_IPI_VERIFY_CATEGORY_IN_CATEGORY_BROWSING_TREE'));
      set_item_result(run_stored_sig('ITEM_ATTACHMENT'));
      set_item_result(run_stored_sig('EBS_MFG_PO_IPI_IPROC_ITEM_BASE_DESCRIPTORS'));
   end_section;
END IF;
debug('end section: Item_Related_Table_Details');

debug('begin section: Purchase_Order_Related_Table_Details');
IF p_trx_num IS NOT NULL THEN
   start_section('Purchase Order Related Table Details', 'Purchase_Order_Related_Table_Details');
      ...
      END IF;
      IF p_line_num IS NOT NULL and p_item_num IS NOT NULL THEN
         set_item_result(run_stored_sig('IP_PO_DOCUMENT_ITEMS_NOT_SHOWING_BLANKET_EXPIRED'));
         set_item_result(run_stored_sig('PO_ATTRIBUTE_VALUES_ITEM_PO'));
         set_item_result(run_stored_sig('PO_ATTRIBUTE_VALUES_TLP_ITEM_PO'));
         set_item_result(run_stored_sig('ICX_CAT_ATTRIBUTE_VALUES_ITEM_PO'));
         set_item_result(run_stored_sig('ICX_CAT_ATTRIBUTE_VALUES_TLP_ITEM_PO'));
      END IF;
      set_item_result(run_stored_sig('PO_HEADER_ATTACHMENT'));
      set_item_result(run_stored_sig('PO_LINE_ATTACHMENT'));
   end_section;
END IF;
debug('end section: Purchase_Order_Related_Table_Details');

debug('begin section: Language_Translations');
start_section('Language / Translations', 'Language_Translations');
   set_item_result(run_stored_sig('FND_LANGUAGES_TD'));
   set_item_result(run_stored_sig('FND_LANGUAGES_TD_STANDARD'));
   IF p_item_num IS NOT NULL THEN
      set_item_result(run_stored_sig('ICX_CAT_ATTRIBUTE_VALUES_TLP_ITEM'));
      set_item_result(run_stored_sig('MTL_SYSTEM_ITEMS_TL_BLANKET'));
      set_item_result(run_stored_sig('ITEM_NOT_TRANSLATED_FOR_INSTALLED_LANGUAGES'));
   END IF;
   IF p_line_num IS NOT NULL THEN
      set_item_result(run_stored_sig('ICX_CAT_ATTRIBUTE_VALUES_TLP_BLANKET'));
      set_item_result(run_stored_sig('PO_ATTRIBUTE_VALUES_TLP_BLANKET'));
   END IF;
end_section;
debug('end section: Language_Translations');

debug('begin section: General_Purchase_Order_Documents_Details');
IF p_trx_num IS NULL THEN
   start_section('General Purchase Order Documents Details', 'General_Purchase_Order_Documents_Details');
   ...
   end_section;
END IF;
debug('end section: General_Purchase_Order_Documents_Details');

debug('begin section: Specific_Purchase_Order_Documents_Details');
IF p_trx_num IS NOT NULL THEN
   start_section('Specific Purchase Order Documents Details', 'Specific_Purchase_Order_Documents_Details');
      set_item_result(run_stored_sig('IP_ITEM_LINE_PO_DOCUMENT_NOT_SHOWING_BLANKET_UNAPPROVED'));
      set_item_result(run_stored_sig('IP_DOCUMENT_ITEMS_NOT_SHOWING_SPECIFIC'));
      set_item_result(run_stored_sig('IP_ALL_PO_DOCUMENT_NOT_SHOWING_BLANKET_UNAPPROVED_SPECIFIC'));
      set_item_result(run_stored_sig('IP_ALL_PO_DOCUMENT_ITEMS_NOT_SHOWING_BLANKET_EXPIRED_SPECIFIC'));
   end_section;
END IF;
debug('end section: Specific_Purchase_Order_Documents_Details');

debug('begin section: Category_Setup');
start_section('Category Setup', 'Category_Setup');
   set_item_result(run_stored_sig('IP_NON_MAPPED_PO_CATEGORIES'));
   IF p_item_num is not null THEN
      set_item_result(run_stored_sig('IP_ITEM_SPECIFIC_CATEGORY_DOES_NOT_MATCH_LATEST_CATEGORY_MAPPING_NOTE2072353'));
   END IF;
   IF p_item_num is null THEN
      set_item_result(run_stored_sig('IP_ITEMS_CATEGORY_DOES_NOT_MATCH_LATEST_CATEGORY_MAPPING_NOTE2072353_1'));
      set_item_result(run_stored_sig('IP_CATEGORY_DOES_NOT_MATCH_LATEST_CATEGORY_MAPPING_NOTE2072353_1'));
   END IF;
   set_item_result(run_stored_sig('IP_ALL_ITEM'));
   set_item_result(run_stored_sig('EXPENSE_ACCOUNT_ITEM_CATEGORY_RULES_SETUP'));
   set_item_result(run_stored_sig('ITEM_CATEGORY_VALUES_NO_EXPENSE_ACCOUNT_RULE_SETUP'));
end_section;
debug('end section: Category_Setup');

debug('begin section: Stores_Content_Zones');
start_section('Stores / Content Zones', 'Stores_Content_Zones');
   set_item_result(run_stored_sig('IP_LIST_STORES'));
   set_item_result(run_stored_sig('IP_STORES_MULTIPLE_CONTENT_ZONE'));
   set_item_result(run_stored_sig('IP_STORES_WITH_DATA'));
   set_item_result(run_stored_sig('IP_DETAILED_CONTENT_ZONE'));
end_section;
debug('end section: Stores_Content_Zones');

debug('begin section: Intermedia_Index');
start_section('Intermedia Index', 'Intermedia_Index');
   IF g_sql_tokens('##$$ITEMNUM$$##') IS NOT NULL THEN
      IF g_apps_version >= '12.1'  and g_apps_version < '12.2.9' THEN
         set_item_result(run_stored_sig('EBS_MFG_PO_IPI_INTERMEDIA_INDEX_NO_COMMITTED_OR_MINREL_COLUMN'));
      END IF;
      IF g_apps_version >= '12.2.9' THEN
         set_item_result(run_stored_sig('INTERMEDIA_INDEX'));
      END IF;
   END IF;
   set_item_result(run_stored_sig('INTERMEDIA_INDEX_HARD_LIMIT'));
   set_item_result(run_stored_sig('INTERMEDIA_INDEX_ERRORS'));
   set_item_result(run_stored_sig('INTERMEDIA_INDEX_STATUS'));
end_section;
debug('end section: Intermedia_Index');
...
debug('begin section: Diagnostic_Apps_Check');
IF g_sql_tokens('##$$APPS_CHECK$$##') = 'Y' THEN
   start_section('Diagnostic Apps Check', 'Diagnostic_Apps_Check');
      ...
      set_item_result(run_stored_sig('ICX_APPLICATION_INSTALL_DETAILS'));
      set_item_result(run_stored_sig('PO_APPLICATION_INSTALL_DETAILS'));
   end_section;
END IF;
debug('end section: Diagnostic_Apps_Check');

debug('begin section: Procurement_Code_Level');
IF g_sql_tokens('##$$REL$$##') IS NOT NULL THEN
   start_section('Procurement Code Level', 'Procurement_Code_Level');
      IF substr(g_sql_tokens('##$$REL$$##'),1,4) = '12.0' THEN
         set_item_result(check_rec_patches_13); /* Signature RUP_PROC_CODE_LEVEL_12_0 */
      END IF;
      IF substr(g_sql_tokens('##$$REL$$##'),1,4) = '12.1' THEN
         set_item_result(check_rec_patches_14); /* Signature RUP_PROC_CODE_LEVEL_12_1 */
      END IF;
      IF substr(g_sql_tokens('##$$REL$$##'),1,4) = '12.2' THEN
         set_item_result(check_rec_patches_15); /* Signature RUP_PROC_CODE_LEVEL_12_2 */
      END IF;
   end_section;
END IF;
debug('end section: Procurement_Code_Level');
