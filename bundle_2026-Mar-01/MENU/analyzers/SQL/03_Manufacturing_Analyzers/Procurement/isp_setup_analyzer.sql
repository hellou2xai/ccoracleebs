...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Procurement iSupplier Analyzer         |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE isp_setup_analyzer_pkg AUTHID DEFINER AS
...
END isp_setup_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY isp_setup_analyzer_pkg AS
-- $Id: isp_setup_analyzer.sql, 200.28 2026/01/28 14:56:45 dfelton Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2101059.1));
...
----------------------------------------------------------------
-- needed for verify approver function
  g_curr_empid         NUMBER;
  g_vendor_id          NUMBER;
  g_vendor_name        VARCHAR2(240);
  g_reg_supplier_id    NUMBER;
  g_reg_supplier_name  VARCHAR2(240);
  g_supplier_type      VARCHAR2(10);
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'ISPGS_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'ISPGS_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>ISPGS Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2101059.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/isp_setup_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,344,EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,344,EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},344,EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/3903806" class="blacklink" target="new">
...
<div><br>
Version 200.28</div>
<p>- Fix Knowledge Article links to match Fusion Service references<br>
- Include Framework improvements</p><p>Version 200.27<br>
- Added new signature to check for duplicate suppliers with same employee per Doc ID 2793686.1<br>
- Improve data for supplier, sites, contacts, responsibilities<br>
- Updated sequence checks<br>
- Include Framework improvements for move to Fusion Service</p><p>Version 200.26<br>
- Include Apps Check and Framework improvements<br>
- Include check for Registered Supplier pending approval<br>
- Add Supplier Registration Action History<br>
- Add Warning signature to show when there are POs created for the supplier but none are archived yet (and will therefore not be shown on the external supplier view / responsibility.</p><div>Version 200.25<br>
- Improve AME rules and groups<br>
- Improve Organization Document Types list<br>
- Add some details for UDA setup at Supplier level. &nbsp;This will display in the Supplier Setup / Configuration section of the analyzer.</div>
<div>&nbsp;</div>
<div>Version 200.24<br>
1. Improve sequence checks in "Lifetime Support Policy" to check differently in 12c vs 11g<br>
2. In the workflow section show if the supplier registration status is Pending Approval<br>
3. Add hz_party_sites.created_by_module to the output for Supplier Address Details<br>
4. Add Supplier Onboarding information in the Supplier Setup section</div>
<div>&nbsp;</div>
<div>Version 200.23<br>
1. Renamed "Lifetime Support Policy” section as “Critical Alerts” and added sequence checks<br>
2. In AME Information section, under AME Rules / AME Rule Actions, list the AME Approval Groups for AME Rule + Approval Group Items. &nbsp;This will show the Rules and approval groups, and approvers for this specific transaction.<br>
3. Include framework and apps check updates</div>
<div>&nbsp;</div>
<div>Version 200.22</div>
<div>1.&nbsp;Added checks to verify AME condition and attribute descriptions do not exceed 100 character limit</div>
<p>Version 200.21<br>
1. Updated the SQL in AC_PATCHES_APPLIED to include Language, Applied Flag is Y and truncated creation date to eliminate duplicates.<br>
2. Show PO Details even when PO is in status REQUIRES REAPPROVAL, along with APPROVED or IN PROCESS<br>
3. Improved Document Types to not show duplicate rows<br>
4. Implement analyzer framework improvements and patching updates</p><p>Version 200.20<br>
1. Remove tablespace check for tablespace nearing max extents. &nbsp;DBAs have other tools to monitor for this, and this check is causing performance issues for some customers when running the analyzer - analyzer never completes. &nbsp;Therefore we are removing this from the analyzer.</p><p>Version 200.19<br>
1. Add EBS_MFG_PO_AME_NON_MANDATORY_ATTR to show non-mandatory AME attributes<br>
2. Add approval_group_id to the data displayed for AME Rule Actions<br>
3. Include Apps Check improvements<br>
4. Include Analyzer framework updates</p><p>Version 200.18<br>
1. Replace - Recommended Critical Workflow Patch - signature with new and improved signature<br>
2. Improve supplier users and supplier contacts info</p><div>Version 200.17</div>
<div>1. Implemented framework improvements as well as internal improvements to some information signatures</div>
<div>&nbsp;</div>
<div>Version 200.16<br>
1. Improve Securing Attributes checks at responsibility level in Supplier Setup / Configuration section<br>
2. Improve Supplier User Responsibilities to show more rows and better sorting of rows.&nbsp; The up arrow / down arrow and export options are still available to sort in a different order if needed.<br>
3. Reduce number of null value rows returned by External Web Access Profiles signature.&nbsp; Do not show null value rows for APPS_SERVLET_AGENT, APPS_FRAMEWORK_AGENT, or ICX_FORMS_LAUNCHER, but show null value rows for the other profiles.<br>
4. Added some details to Receiving Options Setup, Financial Options Setup, and Organization Line Types Setup<br>
5. Improved Orphaned profiles query to not show duplicate rows<br>
6. Improved DMZ Specific Profiles to not show rows with null value, and improved the order by clause<br>
&nbsp;</div>
<div>Version 200.15<br>
1. Updated Procurement RUP patch check to included 12.2.11<br>
2. Improve profile value masking<br>
3. Improve DMZ orphaned profiles signature<br>
4. Improve Stuck Change Requests signatures by using Doc ID rather than Document Number<br>
5. Include Framework updates</div>
<div><br>
Version 200.14</div>
<div>1. Updated patch level checks</div>
<div>&nbsp;</div>
<div>Version 200.13</div>
<div>1. Framework and Apps Check improvements</div>
<p>&nbsp;</p>
            <br><br>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,344,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,344,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},344,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
BEGIN
    ...
    print_log('Processing recommended patches signature: ISP_CHECK_REC (check_rec_patches_1) "Recommended Patches" (version 8)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(1)(l_rows) := '20233904';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'This patch resolves the issue of null pointer exception while creating employee type suppliers';
   l_col_rows(5)(l_rows) := '[1999863.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19730463';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'This patch is Fix for pos_upg_usr.sql required on R12.2 code branch';
   l_col_rows(5)(l_rows) := '[308271.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19297000';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'This Patch Resolves The Issue Of Exception Occurs While Clicking On Order Link';
   l_col_rows(5)(l_rows) := '[1608312.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '18095918';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'iSupplier portal allows change order if open ASN exists';
   l_col_rows(5)(l_rows) := '[1678312.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '14472482';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Internal Server Error When Clicking On Product And Services';
   l_col_rows(5)(l_rows) := '[1493885.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '12983048';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'This Patch resolves the issue of Error When Trying to Assign Address to a Contact';
   l_col_rows(5)(l_rows) := '[1684626.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '11880088';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'SLM:SH: Oracle Supplier Management Post 12.1.3 Consolidated Updates till May 2011';
   l_col_rows(5)(l_rows) := '[1371568.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '11659917';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'This patch resolves the issue of wrong approval chain after added an approver edit checkout';
   l_col_rows(5)(l_rows) := '[1317301.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '9654468';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'In Oracle iSupplier Portal, this patch resolves the issue of DFF information for supplier sites not getting saved';
   l_col_rows(5)(l_rows) := '[1096268.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '8890863';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'In Oracle iSupplier Portal, this patch resolves the issue of Oracle JBO 25013 error obtained during registration of supplier user';
   l_col_rows(5)(l_rows) := '[954423.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25036197';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'This patch resolves the issue of throwing sql statement error when cancel button is used in Update Address in New Address Requests page';
   l_col_rows(5)(l_rows) := '[2240280.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '16580039';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'AIRTEL DR SITE : ERRORS IN THE ACCESS LOG WHEN ATTEMPTING TO LOG ONTO EBS SUITE';
   l_col_rows(5)(l_rows) := '[1567248.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '24821509';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'The Supplier is still in pending approval status, even it was approved';
   l_col_rows(5)(l_rows) := '[2213885.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '18919808';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'In Oracle iSupplier Portal, This patch resolves the issue of Able to submit work confirmation, when supplier org and it is active';
   l_col_rows(5)(l_rows) := '[1950994.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21893402';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'This Patch Resolves The Issue Of Supplier User is able to see other suppliers ASN in home page';
   l_col_rows(5)(l_rows) := '[2061502.1]';

END IF;

   l_extra_info('##SHOW_SQL##'):= 'Y';

   l_sig.sigrepo_id := '1674';
...
Best Practice: Always ensure that you are on the latest code with all recommended patches applied. This will help avoid known issues, prevent potential data corruption and provide the latest features and functionality. Having a proactive patching plan and periodic proactive patching process in place are the best ways to stay current. ';
  ...
  -- Register
  l_step := '60';
  g_signatures('ISP_CHECK_REC') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'ISP_CHECK_REC',     -- sig ID
...
BEGIN
    ...
    print_log('Processing recommended patches signature: RUP_PROC_CODE_LEVEL_12_0 (check_rec_patches_2) "Recommended Procurement RUP Patches" (version 15)');
...
BEGIN
    ...
    print_log('Processing recommended patches signature: RUP_PROC_CODE_LEVEL_12_1 (check_rec_patches_3) "Recommended Procurement RUP Patches" (version 28)');
...
BEGIN
    ...
    print_log('Processing recommended patches signature: RUP_PROC_CODE_LEVEL_12_2 (check_rec_patches_4) "Recommended Procurement RUP Patches" (version 22)');
...
-- iSP Specific
  ...
  l_counter             NUMBER;
  l_sql                 VARCHAR2(4000);
  l_reg_supplier_id     NUMBER;
  l_reg_supplier_name   VARCHAR2(240);
  l_supplier_type       VARCHAR2(10);
  l_ame_app_id          NUMBER;


-- Change Request flag
  l_change_active_flag  VARCHAR2(1);
...
-- Release  
  l_release_id          NUMBER;
  l_release_subtype     VARCHAR2(25);
  l_release_created_by  NUMBER; 
  l_release_item_type   WF_ITEMS.ITEM_TYPE%TYPE;
  l_release_item_key    WF_ITEMS.ITEM_KEY%TYPE;
...
debug('begin populate parameters hash table');
   ...
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Supplier Type';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_supplier_type,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Supplier ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_supplier_id,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/01/28 14:56:44 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'isp_setup_analyzer.sql';
...
debug('begin parameter validation: p_supplier_type');
IF p_supplier_type IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Supplier Type is required.');
   raise invalid_parameters;
END IF;
IF p_supplier_type IS NOT NULL AND p_supplier_type NOT IN ( 'EXISTING','REGISTERED') THEN
   print_error('INVALID ARGUMENT: Invalid supplier type specified.
value should be one of EXISTING or REGISTERED.');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_supplier_type');

debug('begin parameter validation: p_supplier_id');
IF p_supplier_id IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Supplier ID is required.');
   raise invalid_parameters;
END IF;
...
SELECT VENDOR_ID
INTO l_exists_val
FROM (SELECT VENDOR_ID,VENDOR_NAME  FROM PO_VENDORS  WHERE UPPER(P_SUPPLIER_TYPE) = 'EXISTING' UNION ALL  SELECT SUPPLIER_REG_ID, SUPPLIER_NAME  FROM POS_SUPPLIER_REGISTRATIONS  WHERE UPPER(P_SUPPLIER_TYPE) = 'REGISTERED')
WHERE VENDOR_ID = p_supplier_id and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid supplier_id');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_supplier_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_supplier_id');
...
-- Set variable to max lines allowed
l_step := '5';
...
-- Check for valid supplier or vendor name

/*
IF p_supplier_type is null OR p_supplier_type = 'ANY' THEN
      print_error('You must specify the supplier type.');
      raise invalid_parameters;
ELSIF p_supplier_name is not null THEN
l_step := '20';
BEGIN
IF upper(p_supplier_type) = 'EXISTING' THEN
l_step := '22';
 l_sql :=
  'SELECT vendor_id,vendor_name
   ...
   USING IN p_supplier_name;
ELSIF upper(p_supplier_type) = 'REGISTERED' THEN
l_step := '25';
 l_sql :=

     'SELECT supplier_reg_id, supplier_name
   FROM pos_supplier_registrations
   WHERE upper(supplier_name) = upper(:1)'; 
  ...
  'SELECT supplier_reg_id, supplier_name
   ...
   FROM pos_supplier_registrations
   WHERE upper(supplier_name) = upper(:1)
   order by supplier_reg_id desc)
   where rownum = 1';	        
   EXECUTE IMMEDIATE l_sql
   INTO l_reg_supplier_id, l_reg_supplier_name 			 
   USING IN p_supplier_name;	  
END IF; 
EXCEPTION WHEN NO_DATA_FOUND THEN
   print_log('Supplier Name does not match any supplier registration or existing supplier. '||
       'The Supplier Name parameter is mandatory and must match an existing supplier or a supplier registration request.');
   raise invalid_parameters;
END;
END IF;
...
END IF;
EXCEPTION WHEN NO_DATA_FOUND THEN
   print_log('Supplier ID does not match any supplier registration or existing supplier. '||
       'The Supplier ID parameter is mandatory and must match an existing supplier or a supplier registration request.');
   raise invalid_parameters;
END;



-- Get AME information for Registered suppliers

l_step := '27';
g_use_ame := 'false';
l_ame_app_id := 0;

IF upper(p_supplier_type) = 'REGISTERED' or upper(p_supplier_type) = 'EXISTING' THEN
 BEGIN
   ...
   AND (UPPER(fpot.user_profile_option_name) like UPPER('POS: Use AME for Supplier Approval')  
   AND fpot.language = 'US') 
   AND (fpov.level_id IN (10001));
EXCEPTION WHEN NO_DATA_FOUND THEN
   print_log('AME being used:'||g_use_ame);
   raise invalid_parameters;
 END;
END IF; 
...
IF g_use_ame = 'true' THEN
      print_log('AME: Site level profile POS: Use AME for Supplier Approval = Y.');
  BEGIN 
      SELECT aca.application_id 
      INTO l_ame_app_id
      FROM ame_calling_apps aca
      WHERE aca.fnd_application_id = 177
      AND rownum = 1;
      print_log('AME: Application ID is '||l_ame_app_id||' for FND_APPLICATION 177 (iSupplier Portal).');
    EXCEPTION WHEN NO_DATA_FOUND THEN
        print_log('AME: Could not find AME Application ID for FND_APPLICATION 177');
        raise invalid_parameters;
        l_ame_app_id := 0; 
        g_use_ame := 'false';
...
--   g_use_ame := 'false';
--   l_ame_app_id := 0;
     print_log('Supplier is not pending Registration, so AME setup will not be checked.');
--   raise invalid_parameters;
  END IF;
...
/* removed as we no longer use the responsibility_id
l_step := '40';
IF (p_include_apps_check = 'Y') THEN
...
/* removed as we no longer ned to check for this
IF (p_include_apps_check = 'Y') THEN
...
g_vendor_name:=  l_vendor_name;
g_reg_supplier_id:= l_reg_supplier_id;
g_reg_supplier_name:= l_reg_supplier_name;
...
print_log('g_vendor_id= '||g_vendor_id);
--print_log('g_vendor_name= '||g_vendor_name);
print_log('g_reg_supplier_id= '||g_reg_supplier_id);
--print_log('g_reg_supplier_name= '||g_reg_supplier_name);
...
-- Check for a valid Change request document 
/*
IF p_po_num is not null THEN
l_step := '40';
    BEGIN
        SELECT distinct poc1.change_active_flag
        INTO   l_change_active_flag
        FROM   PO_CHANGE_REQUESTS poc1
        WHERE  poc1.document_num = 'p_po_num'
        AND     poc1.document_type = 'PO'
        AND    rownum = 1; 
      EXCEPTION WHEN NO_DATA_FOUND THEN
        print_error('No Change Request document exists for Purchase Order '||p_po_num||' in org id '||to_char(p_org_id));
      --  print_error('No Change Request exists for values '||p_po_num);
        raise invalid_parameters;
    END; 
END IF; 
...
l_step := '50';
    BEGIN
        ...
        INTO   l_po_id, l_po_subtype, l_created_by,
      ...
      EXCEPTION WHEN NO_DATA_FOUND THEN
        ...
        print_error('No document exists for values '||p_po_num||'/'||to_char(p_org_id));
        raise invalid_parameters;
    END; 
...
BEGIN
   ...
   INTO l_vendor_id,
        l_vendor_name 
   FROM po_supplier_users_v
   WHERE fnd_user_name = p_user_name;
EXCEPTION WHEN NO_DATA_FOUND THEN
    print_log('User Name not found. '||
      'The User Name parameter is mandatory.');
    raise invalid_parameters;
END;
END IF;
*/
...
debug('begin populate sql tokens hash table');
   ...
   g_sql_tokens('##$$SUPPLIERNAME$$##') := l_vendor_name;
   g_masked_tokens('##$$SUPPLIERNAME$$##') := mask_text( g_sql_tokens('##$$SUPPLIERNAME$$##'), 'DISPLAY_FIRST_4_CHAR');
   g_sql_tokens('##$$SUPPLIERID$$##') := nvl(to_char(l_vendor_id),'0');
   g_masked_tokens('##$$SUPPLIERID$$##') := mask_text( g_sql_tokens('##$$SUPPLIERID$$##'), 'NO_MASK');
   g_sql_tokens('##$$POID$$##') := nvl(to_char(l_po_id),'NULL');
   g_masked_tokens('##$$POID$$##') := mask_text( g_sql_tokens('##$$POID$$##'), 'NO_MASK');
   g_sql_tokens('##$$POITMKEY$$##') := l_po_item_key;
   g_masked_tokens('##$$POITMKEY$$##') := mask_text( g_sql_tokens('##$$POITMKEY$$##'), 'NO_MASK');
   g_sql_tokens('##$$POITMTYPE$$##') := l_po_item_type;
   g_masked_tokens('##$$POITMTYPE$$##') := mask_text( g_sql_tokens('##$$POITMTYPE$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPATH$$##') := nvl(to_char(l_app_path_id),'NULL');
   g_masked_tokens('##$$APPATH$$##') := mask_text( g_sql_tokens('##$$APPATH$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM1$$##') := '177';
   ...
   g_sql_tokens('##$$REGSUPPLIERID$$##') := NVL(to_char(l_reg_supplier_id),to_char(p_supplier_id));
   g_masked_tokens('##$$REGSUPPLIERID$$##') := mask_text( g_sql_tokens('##$$REGSUPPLIERID$$##'), 'NO_MASK');
   g_sql_tokens('##$$REGSUPPLIERNAME$$##') := l_reg_supplier_name;
   g_masked_tokens('##$$REGSUPPLIERNAME$$##') := mask_text( g_sql_tokens('##$$REGSUPPLIERNAME$$##'), 'DISPLAY_FIRST_4_CHAR');
...
debug('begin add_signature: ISP_INVALID_OBJECTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2327',
      p_sig_id                 => 'ISP_INVALID_OBJECTS',
...
AND a.owner = ''APPS''
AND (a.object_name like ''POS%'' OR
a.object_name like ''PO%'' OR
a.object_name like ''FND%'')
AND a.status = ''INVALID''',
      p_title                  => 'iSupplier Related Invalid Objects',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invalid objects exist that are related to iSupplier.',
      p_solution               => '<ul>
      ...
      p_success_msg            => 'No invalid objects for schemas POS, PO and FND were found.',
   ...
   l_info.delete;
debug('end add_signature: ISP_INVALID_OBJECTS');
...
debug('begin add_signature: ISP_SHARED_INSTALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14744',
      p_sig_id                 => 'ISP_SHARED_INSTALL',
...
AND fpi.status = ''N''
order by 3',
      p_title                  => 'iSupplier Install Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The iSupplier Portal product is not setup as Installed, and this can cause errors and exceptions with SLM (Supplier Lifecycle Management) and Supplier Hub. They require iSupplier to be installed or shared installed.',
      p_solution               => 'Review [1133413/KB757523] - How To Use License Manager in R12?',
      p_success_msg            => 'iSupplier Portal is installed as installed or shared install.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: ISP_SHARED_INSTALL');
...
debug('begin add_signature: ISP_SUPPLIER_DETAILS');
   l_info('##MASK##VENDOR_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1045',
      p_sig_id                 => 'ISP_SUPPLIER_DETAILS',
      p_sig_sql                => 'SELECT
   vendor_id,
   vendor_name,
   party_id,
...
WHERE
   vendor_id = ##$$SUPPLIERID$$##',
      p_title                  => 'Supplier Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Supplier Details',
      p_solution               => 'Invalid Supplier As There Are No Details',
      p_success_msg            => 'Supplier Details Exist',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ISP_SUPPLIER_DETAILS');



debug('begin add_signature: ISP_SUPPLIER_SITES');
   l_info('##MASK##ADDRESS_LINE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##EMAIL_ADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ORG_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##VENDOR_SITE_CODE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1046',
      p_sig_id                 => 'ISP_SUPPLIER_SITES',
      p_sig_sql                => 'SELECT
   pvsa.vendor_site_id,
   ...
   pvsa.province,
   pvsa.country ,
   pvsa.created_by, pvsa.last_update_date, pvsa.last_updated_by
FROM
   po_vendor_sites_all pvsa,
   ap_suppliers vendor,
   hr_all_organization_units org 
WHERE
   pvsa.vendor_id = vendor.vendor_id 
   AND vendor.vendor_id = ##$$SUPPLIERID$$## 
   AND org.organization_id = pvsa.org_id 
ORDER BY
   vendor_site_code,
   org_id',
      p_title                  => 'Supplier Sites',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Supplier Sites Exist',
      p_solution               => 'Create a site for this supplier',
      p_success_msg            => 'Supplier Sites Exist',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ISP_SUPPLIER_SITES');



debug('begin add_signature: ISP_SUPPLIER_ADDRESSES');
   l_info('##MASK##ADDRESS%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PARTY_SITE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1675',
      p_sig_id                 => 'ISP_SUPPLIER_ADDRESSES',
      p_sig_sql                => 'SELECT
   hps.party_site_id,
   hps.party_site_name,
hps.created_by_module,
   ...
   loc.country,
   loc.postal_code ,
   vendor.created_by, vendor.last_update_date, vendor.last_updated_by
FROM
   hz_party_sites hps,
   ap_suppliers vendor,
   hz_locations loc    
WHERE
   vendor.party_id = hps.party_id    
   AND hps.location_id = loc.location_id    
   AND vendor.vendor_id = ##$$SUPPLIERID$$##
ORDER BY
   party_site_name',
      p_title                  => 'Supplier Address Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No supplier addresses exist',
      p_solution               => 'No supplier addresses exist',
      p_success_msg            => 'Supplier Addresses Exist',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ISP_SUPPLIER_ADDRESSES');



debug('begin add_signature: ISP_SUPPLIER_CONTACTS');
   l_info('##MASK##CONTACT_PARTY_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PARTY_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##VENDOR_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1676',
      p_sig_id                 => 'ISP_SUPPLIER_CONTACTS',
      p_sig_sql                => 'SELECT vendor.vendor_name, contact.party_id AS contact_party_id,
    contact.party_name AS contact_party_name, hzr.start_date, hzr.end_date, hzr.status,
    contact.created_by, contact.last_update_date, contact.last_updated_by
  ...
  AND EXISTS
    (SELECT 1
     ...
     AND party_usage_code = ''SUPPLIER_CONTACT'')',
      p_title                  => 'Supplier Contacts',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Supplier Contacts Exist',
      p_solution               => 'Create a Supplier Contact',
      p_success_msg            => 'Supplier Contacts Exist',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ISP_SUPPLIER_CONTACTS');



debug('begin add_signature: ISP_SUPPLIER_USERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1677',
      p_sig_id                 => 'ISP_SUPPLIER_USERS',
...
ORDER BY PERSON_PARTY_ID',
      p_title                  => 'Supplier Users',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Supplier Users Exist',
      p_solution               => 'Register a supplier user',
      p_success_msg            => 'Supplier Users Exist',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ISP_SUPPLIER_USERS');



debug('begin add_signature: ISP_SUPPLIER_USER_RESPONSIBILITIES');
   l_info('##MASK##USER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11045',
      p_sig_id                 => 'ISP_SUPPLIER_USER_RESPONSIBILITIES',
      p_sig_sql                => 'Select resp.language, suser.USER_ID, suser.USER_NAME,resp.RESPONSIBILITY_NAME,
usrresp.created_by, usrresp.last_update_date, usrresp.last_updated_by
from FND_USER_RESP_GROUPS_DIRECT usrresp,
POS_SUPPLIER_USERS_V suser,
FND_RESPONSIBILITY_TL resp,
AP_SUPPLIERS SUP
WHERE
usrresp.USER_ID = suser.USER_ID AND
usrresp.RESPONSIBILITY_ID = resp.RESPONSIBILITY_ID AND
suser.VENDOR_ID = SUP.VENDOR_ID AND
SUP.VENDOR_ID= ##$$SUPPLIERID$$##
and rownum < 1000
ORDER BY language, suser.USER_NAME, responsibility_name',
      p_title                  => 'Supplier User Responsibilities',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No External Responsibilities attached to Supplier Users',
      p_solution               => 'Only External Responsibilities should be assigned to Supplier Users',
      p_success_msg            => 'Responsibilities Data Exist For Supplier Users.  

NOTE: Only the first 1000 rows are shown.  Use the ''i'' icon to see the sql query used.  You may modify and run the sql query manually in SQL Developer or sqlplus to see all the rows and unmasked values.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ISP_SUPPLIER_USER_RESPONSIBILITIES');



debug('begin add_signature: POS_SUPPLIER_REGISTRATIONS');
   l_info('##MASK##ADDRESS_LINE1'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ADDRESS_LINE2'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ADDRESS_LINE3'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ADDRESS_LINE4'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ADDRESS_NICKNAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CITY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COUNTRY'):= 'REMOVE_COLUMN';
   l_info('##MASK##COUNTY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##NI_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##POSTAL_CODE'):= 'REMOVE_COLUMN';
   l_info('##MASK##PROVINCE'):= 'REMOVE_COLUMN';
   l_info('##MASK##STATE'):= 'REMOVE_COLUMN';
   l_info('##MASK##SUPPLIER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SUPPLIER_NAME_ALT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TAXPAYER_ID'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10737',
      p_sig_id                 => 'POS_SUPPLIER_REGISTRATIONS',
      p_sig_sql                => 'select psr.* from pos_supplier_registrations psr
where psr.supplier_reg_id = ##$$REGSUPPLIERID$$##',
      p_title                  => 'Supplier Registrations',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Supplier Registration details',
...
',
      p_success_msg            => 'No Supplier Registrations found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: POS_SUPPLIER_REGISTRATIONS');



debug('begin add_signature: ERROR_CREATING_CONTACT_IN_ISUPPLIER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10152',
      p_sig_id                 => 'ERROR_CREATING_CONTACT_IN_ISUPPLIER',
      p_sig_sql                => 'SELECT adf.Filename, adfv.Version CustomerFileVersion, 
''Null VENDOR_TYPE_LOOKUP_CODE values exist in AP_SUPPLIERS and the Patch fix from Note 2287960.1 is not applied'' Note2287960_1
FROM   ad_files adf, ad_file_versions adfv
WHERE  ((( (adfv.Version_segment4 <> 0 and adfv.Version_segment3 <> 0) and
(  ( (adfv.Version_Segment4 < 15 or adfv.Version_Segment2 < 4 ) and adfv.Version_Segment3 = 12000000 and adfv.Version_Segment1 = 120 and Filename = ''po_vendor_contacts.xdf'')
or ( (adfv.Version_Segment4 < 15 or adfv.Version_Segment2 < 4 ) and adfv.Version_Segment3 = 12010000 and adfv.Version_Segment1 = 120 and Filename = ''po_vendor_contacts.xdf'')
or ( (adfv.Version_Segment4 <  3 or adfv.Version_Segment2 < 15) and adfv.Version_Segment3 = 12020000 and adfv.Version_Segment1 = 120 and Filename = ''po_vendor_contacts.xdf'')
))
or 
((adfv.Version_segment4 = 0 and adfv.Version_segment3 = 0) and ((adfv.Version_Segment2 <= 15 and adfv.Version_Segment1 = 120)))
)
and adfv.file_version_id = (select max(adfv.file_version_id) from ad_files adf, ad_file_versions adfv where adfv.file_id = adf.file_id and adf.app_short_name = ''SQLAP'' and adf.filename = ''po_vendor_contacts.xdf'' group by adfv.file_id)
and adfv.file_id = adf.file_id
and adf.app_short_name = ''SQLAP''
and upper(adf.filename) = upper(''po_vendor_contacts.xdf'')
)
and exists
(SELECT 1
FROM   ap_suppliers
WHERE  vendor_type_lookup_code IS  NULL
)',
      p_title                  => 'Error Will Occur in iSupplier When Creating Supplier Contact for Some Suppliers',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The following error will occur when attempting to create a new Supplier Contact for a supplier that has null VENDOR_TYPE_LOOKUP_CODE

ERROR
Failed to assign addresses to contact: FNDFND_AS_UNEXPECTED_ERRORNPKG_NAMEAP_VENDOR_PUB_PKGNPROCEDURE_NAMECreate_Vendor_ContactNERROR_TEXTORA-20001:',
      p_solution               => 'Apply the Patch fix relevant for your release to avoid the issue.  The patch fixes the view used by iSupplier Portal to create the Contact, and allows creation of a new supplier contact without error even if the VENDOR_TYPE_LOOKUP_CODE is null for the supplier.  There is no need to fix the VENDOR_TYPE_LOOKUP_CODE; only the patch fix is required to fix the view definition PO_VENDOR_CONTACTS as described in [2287960/KB373326].<br>
<br>
For 12.2.X, apply Patch 22779111:R12.AP.C<br>
- Fixed in po_vendor_contacts.xdf   120.15.12020000.3<br>
<br>
For 12.1.X, apply Patch 22779111:R12.AP.B<br>
- Fixed in po_vendor_contacts.xdf    120.4.12010000.15<br>
<br>
For 12.0.X, apply Patch 22779111:R12.AP.A<br>
- Fixed in po_vendor_contacts.xdf    120.4.12000000.15<br>
<br>
REFERENCE: [2287960/KB373326]<br>
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: ERROR_CREATING_CONTACT_IN_ISUPPLIER');



debug('begin add_signature: EBS_MFG_ISPGS_DUPLICATE_SUPPLIERS_WITH_SAME_EMPLOYEE_ID');
   l_info('##MASK##%NAME%'):= 'DISPLAY_FIRST_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31829',
      p_sig_id                 => 'EBS_MFG_ISPGS_DUPLICATE_SUPPLIERS_WITH_SAME_EMPLOYEE_ID',
      p_sig_sql                => 'SELECT aps.vendor_id , aps.employee_id, aps.vendor_name, papf.full_name, papf.party_id, aps.party_id 
FROM ap_suppliers aps, per_all_people_f papf 
...
AND aps.vendor_id = ##$$SUPPLIERID$$##',
      p_title                  => 'Duplicate Suppliers With Same Employee ID',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This Employee ID is already assigned to another supplier. Re-enter.',
      p_solution               => 'Please log an SR with the output of this analyzer to request a data fix from Payables Support for [2793686/KB605064].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_ISPGS_DUPLICATE_SUPPLIERS_WITH_SAME_EMPLOYEE_ID');



debug('begin add_signature: ISP_EXTERNAL_RESPONSIBILTY');
   l_info('##MASK##VALUE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1665',
      p_sig_id                 => 'ISP_EXTERNAL_RESPONSIBILTY',
      p_sig_sql                => 'select
   ...
   decode(to_char(v.level_id),  ''10001'',  '''',  ''10002'',  app.application_short_name,  ''10003'',  rsp.responsibility_key,  ''10004'',  usr.user_name,  ''10005'',  svr.node_name,  ''10006'',  org.name,  ''10007'',
      (select n.node_name  
       from   fnd_nodes n 
       where  n.node_id=level_value2) ||''/''||  (decode(v.level_value, -1, ''Default'',
        (select responsibility_key  
         from   fnd_responsibility 
         where  responsibility_id=level_value))), v.level_id) CONTEXT,
...
where
   ...
   and  p.profile_option_name in  (
        ''NODE_TRUST_LEVEL'',''APPL_SERVER_TRUST_LEVEL'',''POS_EXTERNAL_URL''  
   )  
...
order by
   ...
   v.level_id,
   context',
      p_title                  => 'External Responsibility Not Visible',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Supplier Unable To See External Responsibility: There Are No Active Responsibilities Available For This User
',
      p_solution               => 'See [741751/KB493644] - Supplier Unable To See External Responsibility: There Are No Active Responsibilities Available For This User',
      p_success_msg            => 'External Responsibility will be visible',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ISP_EXTERNAL_RESPONSIBILTY');



debug('begin add_signature: ISP_POS_EMPLOYMENT_INACTIVE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1666',
      p_sig_id                 => 'ISP_POS_EMPLOYMENT_INACTIVE',
      p_sig_sql                => 'SELECT RELATIONSHIP_TYPE_ID
       , RELATIONSHIP_TYPE
       , STATUS
FROM HZ_RELATIONSHIP_TYPES
WHERE RELATIONSHIP_TYPE = ''POS_EMPLOYMENT''
AND FORWARD_REL_CODE = ''EMPLOYEE_OF''
AND SUBJECT_TYPE = ''PERSON''
AND OBJECT_TYPE = ''ORGANIZATION''
AND STATUS = ''A''',
      p_title                  => 'Inactivated Relationship Type',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The customer relationship type is not active',
      p_solution               => 'See [752402/KB356077] - Cannot Register Supplier User Account',
      p_success_msg            => 'Seeded relationship Type is active',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ISP_POS_EMPLOYMENT_INACTIVE');



debug('begin add_signature: ISP_INCORRECT_RESPONSIBILITY_BUYER');
   l_info('##MASK##USER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11046',
      p_sig_id                 => 'ISP_INCORRECT_RESPONSIBILITY_BUYER',
      p_sig_sql                => 'Select usr.USER_ID, usr.USER_NAME, resp.RESPONSIBILITY_NAME 
from FND_USER_RESP_GROUPS_DIRECT usrresp, 
FND_USER usr,
FND_RESPONSIBILITY_TL resp
WHERE
usrresp.USER_ID = usr.USER_ID AND
usrresp.RESPONSIBILITY_ID = resp.RESPONSIBILITY_ID AND
resp.RESPONSIBILITY_NAME = ''iSupplier Portal Full Access'' AND
usr.USER_ID NOT IN (SELECT USER_ID from POS_SUPPLIER_USERS_V)',
      p_title                  => 'External iSupplier Responsibility assigned to Internal Buyers',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'External responsibility assigned to internal user(s).  iSupplier Portal Full Access responsibility should only be assigned to external supplier users.',
      p_solution               => 'iSupplier Portal Full Access Responsibility should not be assigned to Buyer Users.
Please review the following note
See [2121824/KB423467] - Unexpected Error When Accessing iSupplier Portal as Internal User ',
      p_success_msg            => 'Buyer does not have external responsibility ',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ISP_INCORRECT_RESPONSIBILITY_BUYER');



debug('begin add_signature: ISP_GUEST_RESPONSIBILITY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1679',
      p_sig_id                 => 'ISP_GUEST_RESPONSIBILITY',
      p_sig_sql                => 'select responsibility_id,
responsibility_key,
responsibility_name,
description,
start_date,
end_date
from fnd_responsibility_vl
where responsibility_name like ''POS Supplier Guest User''
and (end_date is null or end_date > sysdate)',
      p_title                  => 'Supplier Guest User Responsibility',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Supplier Guest User Responsibility Is End Dated',
      p_solution               => 'see [308271/KB198328] - Enable Web Access By External Supplier Users to Oracle iSupplier Portal and Oracle Sourcing

Make sure that the end date of the responsibility is NULL. If not, set it to NULL and save.',
      p_success_msg            => 'Supplier guest responsibility is not end-dated',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ISP_GUEST_RESPONSIBILITY');



debug('begin add_signature: ISP_GUEST_USER_RESPONSIBILITY');
   l_info('##MASK##USER_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1685',
      p_sig_id                 => 'ISP_GUEST_USER_RESPONSIBILITY',
      p_sig_sql                => 'SELECT fu.user_name,
...
And frv.responsibility_key           = ''POS_SUPPLIER_GUEST_USER''
...
AND NVL(frv.end_date, sysdate + 1)   > sysdate',
      p_title                  => 'Supplier Guest User Responsibility Not Assigned',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Responsibility POS Supplier Guest User is not assigned to the GUEST user.',
      p_solution               => 'See [308271/KB198328] - Enable Web Access By External Supplier Users to Oracle iSupplier Portal and Oracle Sourcing',
      p_success_msg            => 'Responsibility POS Supplier Guest User is assigned to the GUEST user.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ISP_GUEST_USER_RESPONSIBILITY');



debug('begin add_signature: ISP_ARCHIVE_ON_APPROVE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1686',
      p_sig_id                 => 'ISP_ARCHIVE_ON_APPROVE',
      p_sig_sql                => 'SELECT dt.type_name document_type,
           dt.org_id,
           dt.document_type_code,
           dt.document_subtype,
           dt.can_preparer_approve_flag "Preparer Can Approve",
    ...
    AND   dt.wf_approval_itemtype = wfit.name(+)
    AND   dt.wf_approval_process = wfrp.process_name(+)
    AND   dt.document_type_code IN (''PO'',''PA'',''RELEASE'')
    AND   dt.archive_external_revision_code = ''APPROVE''',
      p_title                  => 'Archive On Approve',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Archive On is not set to Approve',
      p_solution               => '',
      p_success_msg            => 'Purchase orders will only be found in iSupplier for these document types after they are approved',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ISP_ARCHIVE_ON_APPROVE');



debug('begin add_signature: ISP_ARCHIVE_ON_PRINT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1687',
      p_sig_id                 => 'ISP_ARCHIVE_ON_PRINT',
      p_sig_sql                => 'SELECT dt.type_name document_type,
           dt.org_id,
           dt.document_type_code,
           dt.document_subtype,
    ...
    AND   dt.wf_approval_process = wfrp.process_name(+)
    AND   dt.document_type_code IN (''PO'',''PA'',''RELEASE'')
    AND   dt.archive_external_revision_code = ''PRINT''',
      p_title                  => 'Archive On Print',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Archive On is not set to Print',
      p_solution               => '',
      p_success_msg            => 'Purchase orders will only be found in iSupplier for these document types after they are printed',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ISP_ARCHIVE_ON_PRINT');



debug('begin add_signature: EBS_MFG_ISPGS_ARCHIVED_PO_COUNT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31698',
      p_sig_id                 => 'EBS_MFG_ISPGS_ARCHIVED_PO_COUNT',
      p_sig_sql                => 'select * from 
(select poha.vendor_id, count(poha.po_header_id) PO_COUNT, NVL(count(pohaa.po_header_id),0) ARCHIVED_COUNT
from PO_HEADERS_ALL poha, PO_HEADERS_ARCHIVE_ALL pohaa
where pohaa.vendor_id(+) = poha.vendor_id
and poha.vendor_id = 47179
group by poha.vendor_id
)',
      p_title                  => 'Number of Purchase Orders (POs) Created vs Archived in PO_HEADERS_ARCHIVE_ALL',
      p_fail_condition         => '[ARCHIVED_COUNT]=[0]',
      p_problem_descr          => 'There exists Purchase Orders (POs) for this Supplier, but none of the POs are archived, so none will be shown in iSupplier Portal Full Access responsibility when the Supplier User logs in to view Purchase Orders.',
      p_solution               => 'The purchase Orders must be Archived in order for them to show in the external supplier responsibility such as iSupplier Portal Full Access.  Depending whether the Purchase Order Document Type is setup for ''Archive on Print'' or ''Archive on Approve'' the documents for this supplier will need to be either Approved or Printed before they will show in the external Supplier responsibility view.  <br>
Review [1322060/KB534580] Purchase Orders Are Not Displaying In iSupplier Portal for additional details.',
      p_success_msg            => 'There exists Purchase Orders (POs) for this Supplier.  At least some of the POs are archived, so these which are archived should be shown in the iSupplier Portal Full Access or other external supplier reponsibility.  Depending whether the Purchase Order Document Type is setup for ''Archive on Print'' or ''Archive on Approve'' the other purchase order documents for this supplier will need to be either Approved or Printed before they will show in the external Supplier responsibility view.<br>
Review [1322060/KB534580] Purchase Orders Are Not Displaying In iSupplier Portal for additional details.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_ISPGS_ARCHIVED_PO_COUNT');



debug('begin add_signature: ISP_EXTERNAL_PROFILES');
   l_info('##MASK##CONTEXT'):= 'DISPLAY_FIRST_WORD';
   l_info('##MASK##USER_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1663',
      p_sig_id                 => 'ISP_EXTERNAL_PROFILES',
      p_sig_sql                => 'select
   ''(''||language||'')-''||n.user_profile_option_name NAME,
   p.profile_option_name,
   decode(v.level_id, 10001, ''Site'',  10002,  ''Application'',  10003,  ''Responsibility'',  10004,  ''User'',  10005,  ''Server'',  10006,  ''Organization'',  10007,  ''ServResp'',  ''Undefined'') LEVEL_SET,
...
where
   ...
   and p.profile_option_name = n.profile_option_name  
   and  p.profile_option_name in  (
      ''APPS_WEB_AGENT'',''APPS_SERVLET_AGENT'',''APPS_JSP_AGENT'',''APPS_FRAMEWORK_AGENT'',  ''ICX_FORMS_LAUNCHER'', ''FND_FUNCTION_VALIDATION_LEVEL'',  ''NODE_TRUST_LEVEL'',''APPL_SERVER_TRUST_LEVEL'',''POS_EXTERNAL_URL'',''POS_INTERNAL_URL'',  ''POS_EXTERNAL_LOGON_PATH'', ''PON_DEFAULT_EXT_USER_RESP'', ''PON_EXT_APPS_FRAMEWORK_AGENT''  
   )  
   and usr.user_id (+) = v.level_value 
   and rsp.application_id (+) = v.level_value_application_id  
   and rsp.responsibility_id (+) = v.level_value 
   ...
   and org.organization_id (+) = v.level_value  
   and language = ''US''
   and (decode(v.level_id, 10001, ''Site'',  10002,  ''Application'',  10003,  ''Responsibility'',  10004,  ''User'',  10005,  ''Server'',  10006,  ''Organization'',  10007,  ''ServResp'',  ''Undefined'') <> ''Undefined'') 
AND ((v.level_id = 10003 AND v.level_value = nvl(fnd_profile.value(''resp_id''), v.level_value))
OR (v.level_id = 10004 AND v.level_value = nvl(fnd_profile.value(''user_id''), v.level_value))
  or   (v.level_id = 10001 )
  or   (v.level_id = 10002 )
  or   (v.level_id = 10005 )
  or   (v.level_id = 10006 )
...
and ( (p.profile_option_name in (''APPS_SERVLET_AGENT'',''APPS_FRAMEWORK_AGENT'', ''ICX_FORMS_LAUNCHER'') and v.profile_option_value is not null)
        or
      (p.profile_option_name not in (''APPS_SERVLET_AGENT'',''APPS_FRAMEWORK_AGENT'', ''ICX_FORMS_LAUNCHER''))
     )
order by
   name,
   v.level_id,
   context',
      p_title                  => 'External Web Access Profiles',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'In order to allow external suppliers access to the application these profiles need to be reviewed to ensure the settings are correct.</p>

(US)-Node Trust Level NODE_TRUST_LEVEL Site 2 SYSADMIN</br>
(US)-Responsibility Trust Level APPL_SERVER_TRUST_LEVEL Site 2 SYSADMIN</br>
(US)-Responsibility Trust Level APPL_SERVER_TRUST_LEVEL Responsibility ISUPPLIER_PORTAL_RESP 3 </p>
Trust level profile value 2 indicates INTERNAL node or responsibility, and value 3 indicates EXTERNAL node or responsibility',
      p_solution               => 'See [308271/KB198328] - Enable Web Access By External Supplier Users to Oracle iSupplier Portal and Oracle Sourcing',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ISP_EXTERNAL_PROFILES');



debug('begin add_signature: ISP_UNDEFINED_EXTERNAL_PROFILES');
   l_info('##MASK##USER_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4811',
      p_sig_id                 => 'ISP_UNDEFINED_EXTERNAL_PROFILES',
      p_sig_sql                => 'select
   ''(''||language||'')-''||n.user_profile_option_name NAME,
   p.profile_option_name,
   decode(v.level_id, 10001, ''Site'',  10002,  ''Application'',  10003,  ''Responsibility'',  10004,  ''User'',  10005,  ''Server'',  10006,  ''Organization'',  10007,  ''ServResp'',  ''Undefined'') LEVEL_SET,
...
order by
   ...
   v.level_id,
   context',
      p_title                  => 'Undefined External Web Access Profiles',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'In order to allow external suppliers access to the application these profiles need to be reviewed as they are currently not set.',
      p_solution               => 'See [308271/KB198328] - Enable Web Access By External Supplier Users to Oracle iSupplier Portal and Oracle Sourcing',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: ISP_UNDEFINED_EXTERNAL_PROFILES');



debug('begin add_signature: ISP_RESP_SECURING_ATTRIBUTES_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1670',
      p_sig_id                 => 'ISP_RESP_SECURING_ATTRIBUTES_DETAILS',
      p_sig_sql                => 'SELECT a.RESPONSIBILITY_ID
, a.ATTRIBUTE_CODE
, a.RESP_APPLICATION_ID
, arsav.NUMBER_VALUE 
from
  (select ak.responsibility_id, ak.resp_application_id, ak.attribute_code, v.level_value --, fnd.*, v.*
    from
    AK.AK_RESP_SECURITY_ATTRIBUTES ak,
    fnd_responsibility_vl fnd,
    fnd_profile_option_values v
    where ak.responsibility_id = fnd.responsibility_id
    and (fnd.end_date is null or (sysdate > fnd.start_date and sysdate < fnd.end_date))
    and v.level_id = ''10003'' and v.application_id = 177
    and fnd.responsibility_id = nvl(fnd_profile.value(''resp_id''),v.level_value)
    and fnd.responsibility_id = ##$$FK1$$##) a,
  ak_resp_security_attr_values arsav, fnd_responsibility_tl frt
where frt.responsibility_id = a.responsibility_id and frt.language = ''US''
and a.attribute_code in (''ICX_SUPPLIER_ORG_ID'', ''ICX_SUPPLIER_CONTACT_ID'', ''ICX_SUPPLIER_SITE_ID'')
/*   (
  (a.attribute_code = ''ICX_SUPPLIER_ORG_ID'')
  or
  (a.attribute_code in (''ICX_SUPPLIER_CONTACT_ID'', ''ICX_SUPPLIER_SITE_ID'') and arsav.number_value = -9999)
    )
 */
and a.attribute_code = arsav.attribute_code(+)
and arsav.responsibility_id(+) = a.responsibility_id
and a.responsibility_id = ##$$FK1$$##
order by arsav.attribute_code
...
,NUMBER_VALUE
from 
(select ak.responsibility_id, ak.attribute_code
from 
AK.AK_RESP_SECURITY_ATTRIBUTES ak, 
fnd_responsibility_vl fnd,
fnd_profile_option_values v
where ak.responsibility_id = fnd.responsibility_id
and fnd.responsibility_id = nvl(fnd_profile.value(''resp_id''),v.level_value)) a,
ak_resp_security_attr_values
where ak_resp_security_attr_values.responsibility_id(+) = a.responsibility_id
and a.attribute_code = ak_resp_security_attr_values.attribute_code(+)
--and a.responsibility_id = nvl(fnd_profile.value(''resp_id''),v.level_value)
order by ak_resp_security_attr_values.ATTRIBUTE_CODE
*/',
      p_title                  => 'Responsibility Level Securing Attributes',
      p_fail_condition         => '[count(*)] < [3]',
      p_problem_descr          => '3 expected responsibility level Securing Attributes and values<br>
ICX_SUPPLIER_CONTACT_ID should have a value of -9999<br>
ICX_SUPPLIER_ORG_ID should have a null value<br>
ICX_SUPPLIER_SITE_ID should have a value of -9999<br>
<br>',
      p_solution               => 'Expand the row above to see the securing attribute values that are set for this responsibility.  The values should be as follows, but they are not:<br>
ICX_SUPPLIER_CONTACT_ID = -9999<br>
ICX_SUPPLIER_ORG_ID = <blank / null value><br>
ICX_SUPPLIER_SITE_ID = -9999<br>
<br>

1. Query for the responsibility in System Administrator / Security / Responsibility / Define.<br>
2. Add and/or set the values for the following 3 required Securing Attributes for this supplier responsibility:<br>
ICX_SUPPLIER_CONTACT_ID = -9999<br>
ICX_SUPPLIER_ORG_ID = <blank / null value><br>
ICX_SUPPLIER_SITE_ID = -9999<br>
<br>
REFERENCE<br>
[311231/KB594524] - iSupplier Portal Responsibility Does Not Display Any PO''s<br>',
      p_success_msg            => 'Expand the row above and verify these securing attribute values are set for this responsibility:<br>
ICX_SUPPLIER_CONTACT_ID = -9999<br>
ICX_SUPPLIER_ORG_ID = <blank / null value><br>
ICX_SUPPLIER_SITE_ID = -9999<br>
<br>
If they are not set as shown above, <br>
1. Query for the responsibility in System Administrator / Security / Responsibility / Define.<br>
2. Set these Securing Attribute values for the responsibility:<br>
ICX_SUPPLIER_CONTACT_ID = -9999<br>
ICX_SUPPLIER_ORG_ID = <blank / null value><br>
ICX_SUPPLIER_SITE_ID = -9999<br>
3. Save the change<br><br>
NOTE:  Supplier users should clear cache and start a new login session to the application for these changes to take affect.<br>
<br>
REFERENCE<br>
[311231/KB594524] - iSupplier Portal Responsibility Does Not Display Any PO''s<br>',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: ISP_RESP_SECURING_ATTRIBUTES_DETAILS');



debug('begin add_signature: ISP_RESP_SECURING_ATTRIBUTES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1664',
      p_sig_id                 => 'ISP_RESP_SECURING_ATTRIBUTES',
      p_sig_sql                => 'SELECT responsibility_name, a.responsibility_id, a.responsibility_id "##$$FK1$$##", count(*) "No_Of_Lines" 
from
  (select ak.responsibility_id, ak.attribute_code, v.level_value --, fnd.*, v.*
    from
    AK.AK_RESP_SECURITY_ATTRIBUTES ak,
    fnd_responsibility_vl fnd,
    fnd_profile_option_values v
...
and a.attribute_code = arsav.attribute_code(+)
group by frt.responsibility_name, a.responsibility_id

--SELECT count(*) "No_Of_Lines"
--FROM AK_RESP_SECURITY_ATTRIBUTES ARSA,
--fnd_profile_option_values a,
--FND_RESPONSIBILITY_VL RF
--WHERE ARSA.RESPONSIBILITY_ID = nvl(fnd_profile.value(''resp_id''),a.level_value)
--AND ARSA.RESPONSIBILITY_ID = RF.RESPONSIBILITY_ID
',
      p_title                  => 'Responsibility Level Securing Attributes',
      p_fail_condition         => '[No_of_Lines] < [3]',
      p_problem_descr          => 'Not all securing attributes are defined at the responsibility level</p>

When a supplier is registered, And only the supplier name is given the following securing Attribute is
Set on the Login: ICX_SUPPLIER_ORG_ID.</p>

This leaves the other two securing attributes, not set.</p>
<ol>
 <li>ICX_SUPPLIER_SITE_ID</li>
 <li>ICX_SUPPLIER_CONTACT_ID</li>
</ol>
This raises the need for a default value - which in this case should be -9999 set on the
new responsibility that was created. When using the New iSupplier responsibility</p>

<b>Note:</b> When the securing attributes are not set on the login - then the system drives off of the responsibility setting for the securing attributes.',
      p_solution               => 'See [311231/KB594524] - iSupplier Portal Responsibility Does Not Display Any PO''s',
      p_success_msg            => 'All responsibility level securing attributes are set.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('ISP_RESP_SECURING_ATTRIBUTES_DETAILS'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '16'
      );
   l_info.delete;
debug('end add_signature: ISP_RESP_SECURING_ATTRIBUTES');



debug('begin add_signature: EBS_MFG_ISPGS_SUPPLIER_ONBOARDING_CONFIGURATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30118',
      p_sig_id                 => 'EBS_MFG_ISPGS_SUPPLIER_ONBOARDING_CONFIGURATION',
      p_sig_sql                => 'SELECT Tag, Language, Org_id, DECODE(ORG_ID, -1, ''Global'', ''Operating Unit'') ConfigProfileScope, Profile_name, 
internal_view, supplier_view, creation_date, last_update_date
FROM (SELECT LookupCodes.LANGUAGE, SupOnboardConfigEO.PROFILE_MODULE, SupOnboardConfigEO.ORG_ID, SupOnboardConfigEO.INTERNAL_VIEW, nvl(SupOnboardConfigEO.SUPPLIER_VIEW,''Y'') SUPPLIER_VIEW, 
SupOnboardConfigEO.CREATED_BY, SupOnboardConfigEO.CREATION_DATE, SupOnboardConfigEO.LAST_UPDATED_BY, SupOnboardConfigEO.LAST_UPDATE_DATE, SupOnboardConfigEO.LAST_UPDATE_LOGIN, 
LookupCodes.MEANING PROFILE_NAME, LookupCodes.TAG 
FROM POS_SUP_ONBOARD_CONFIG SupOnboardConfigEO, FND_LOOKUP_VALUES LookupCodes 
WHERE LookupCodes.LOOKUP_TYPE = ''POS_ONBOARD_STD_PROFILES'' 
AND LookupCodes.LOOKUP_CODE = SupOnboardConfigEO.PROFILE_MODULE 
AND LookupCodes.LANGUAGE = USERENV(''LANG'')) QRSLT 
WHERE (ORG_ID = -1 or ORG_ID = ##$$ORGID$$##)
order by language, tag, org_id',
      p_title                  => 'Supplier Onboarding Configuration',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Supplier Onboarding Configuration found',
      p_solution               => 'Supplier Onboarding Configuration [2308208/KB296914] (Step 6)',
      p_success_msg            => 'Supplier Onboarding Configuration Setup<br>
Reference:  [2308208/KB296914] (Step 6)<br>',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_ISPGS_SUPPLIER_ONBOARDING_CONFIGURATION');



debug('begin add_signature: EBS_MFG_ISPGS_SUPPLIER_ONBOARDING_ATTRIBUTE_PAGE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30124',
      p_sig_id                 => 'EBS_MFG_ISPGS_SUPPLIER_ONBOARDING_ATTRIBUTE_PAGE',
      p_sig_sql                => 'SELECT org_id, DECODE(ORG_ID, -999, ''Global'', ''Operating Unit'') ConfigProfileScope, Page_Name, Supplier_Update_Flag, Internal_Update_Flag, Last_update_date
FROM (SELECT OnboardAttrPgConfigEO.CONFIG_ID, OnboardAttrPgConfigEO.ORG_ID, OnboardAttrPgConfigEO.PAGE_ID, OnboardAttrPgConfigEO.SUPPLIER_UPDATE_FLAG, 
OnboardAttrPgConfigEO.INTERNAL_UPDATE_FLAG, OnboardAttrPgConfigEO.CREATED_BY, OnboardAttrPgConfigEO.CREATION_DATE, OnboardAttrPgConfigEO.LAST_UPDATED_BY, 
OnboardAttrPgConfigEO.LAST_UPDATE_DATE, OnboardAttrPgConfigEO.LAST_UPDATE_LOGIN, ego.display_name page_name, ego.data_level_int_name data_level_int_name 
FROM POS_ATTRPG_CONFIG OnboardAttrPgConfigEO, ego_pages_v ego 
WHERE OnboardAttrPgConfigEO.page_id = ego.page_id) QRSLT 
WHERE (org_id = -999 or org_id = ##$$ORGID$$##)
order by page_name, org_id',
      p_title                  => 'Supplier Onboarding Attributes',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Supplier Onboarding Configuration Attributes Found',
      p_solution               => 'Supplier Onboarding Attributes<br>
<br>
To see the detalis of the Attribute Groups<br>
1. Navigate to Supplier Management Administrator / Supplier Home / Administration (Profile Extension) / Common / Attribute Page<br>
2. For the Page names listed above in the analyzer output, find the page name in the Attribute Pages list and click to see the Attribute Groups for that page<br>
3. Click Attribute Groups from the application left menu, and search for the Attribute Groups found above in step 2, to see the Attribute Group details<br>
<br>
See additional details in [2308208/KB296914]',
      p_success_msg            => 'Supplier Onboarding Configuration - Attributes<br>
<br>
To see the detalis of the Attribute Groups<br>
1. Navigate to Supplier Management Administrator / Supplier Home / Administration (Profile Extension) / Common / Attribute Page<br>
2. For the Page names listed above in the analyzer output, find the page name in the Attribute Pages list and click to see the Attribute Groups for that page<br>
3. Click Attribute Groups from the application left menu, and search for the Attribute Groups found above in step 2, to see the Attribute Group details<br>
<br>
See additional details in [2308208/KB296914]<br>',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_ISPGS_SUPPLIER_ONBOARDING_ATTRIBUTE_PAGE');



debug('begin add_signature: EBS_MFG_ISPGS_SUPPLIER_ONBOARDING_RFI_TEMPLATE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30125',
      p_sig_id                 => 'EBS_MFG_ISPGS_SUPPLIER_ONBOARDING_RFI_TEMPLATE',
      p_sig_sql                => 'SELECT org_id, DECODE(ORG_ID, -999, ''Global'', ''Operating Unit'') ConfigProfileScope, 
template_status, auction_header_id, auction_title, template_org_id
FROM (SELECT PosRFITempConfigEO.AUCTION_HEADER_ID, PosRFITempConfigEO.ORG_ID, PosRFITempConfigEO.CREATED_BY, PosRFITempConfigEO.CREATION_DATE, 
PosRFITempConfigEO.LAST_UPDATED_BY, PosRFITempConfigEO.LAST_UPDATE_DATE, PosRFITempConfigEO.LAST_UPDATE_LOGIN, AuctionHeaders.AUCTION_TITLE, 
AuctionHeaders.TEMPLATE_STATUS, AuctionHeaders.ORG_ID TEMPLATE_ORG_ID 
FROM POS_RFI_TEMPLATE_CONFIG PosRFITempConfigEO, PON_AUCTION_HEADERS_ALL AuctionHeaders 
WHERE PosRFITempConfigEO.AUCTION_HEADER_ID = AuctionHeaders.AUCTION_HEADER_ID and (PosRFITempConfigEO.org_id = -999 or PosRFITempConfigEO.org_id = ##$$ORG_ID$$##))
order by template_status, Auction_header_id desc, org_id',
      p_title                  => 'Supplier Onboarding RFI Template',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Supplier Onboarding RFI Template found',
      p_solution               => 'Navigate to Sourcing and query the RFI shown above to see the details<br>
or<br>
Run the Sourcing Analyzer to gather details about the RFI<br>
Review [2308208/KB296914] for more information
',
      p_success_msg            => 'Supplier Onboarding RFI Template<br>
Navigate to Sourcing and query the RFI shown above to see the details<br>
or<br>
Run the Sourcing Analyzer to gather details about the RFI<br>
Review [2308208/KB296914] for more information<br>
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_ISPGS_SUPPLIER_ONBOARDING_RFI_TEMPLATE');



debug('begin add_signature: EBS_MFG_ISPGS_SUPPLIER_ONBOARDING_SURVEY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30126',
      p_sig_id                 => 'EBS_MFG_ISPGS_SUPPLIER_ONBOARDING_SURVEY',
      p_sig_sql                => 'SELECT org_name, org_id, DECODE(ORG_ID, -999, ''Global'', ''Operating Unit'') ConfigProfileScope, Deployment_Name, Survey_Cycle_Name, Survey_Name, Supplier_update_flag, Internal_update_flag
FROM (SELECT PosSurveyConfigEO.CONFIG_ID, PosSurveyConfigEO.ORG_ID, PosSurveyConfigEO.SURVEY_DEPLOYMENT_ID, PosSurveyConfigEO.SUPPLIER_UPDATE_FLAG, 
PosSurveyConfigEO.INTERNAL_UPDATE_FLAG, PosSurveyConfigEO.CREATED_BY, PosSurveyConfigEO.CREATION_DATE, PosSurveyConfigEO.LAST_UPDATED_BY, 
PosSurveyConfigEO.LAST_UPDATE_DATE, PosSurveyConfigEO.LAST_UPDATE_LOGIN, org.name org_name, d.deployment_name, c.survey_cycle_name, s.survey_name, q.dscript_name 
FROM POS_SURVEY_CONFIG PosSurveyConfigEO, hr_organization_units org, ies_svy_deplyments_all d, ies_svy_cycles_all c, ies_svy_surveys_all s, ies_deployed_scripts q 
where DECODE(PosSurveyConfigEO.org_id, -999, null, PosSurveyConfigEO.org_id) = org.organization_id (+) 
and PosSurveyConfigEO.survey_deployment_id = d.survey_deployment_id and d.survey_cycle_id = c.survey_cycle_id and c.survey_id = s.survey_id 
and s.dscript_id = q.dscript_id) QRSLT WHERE (org_id = -999 or org_id = ##$$ORGID$$##)
order by last_update_date desc, org_id, Survey_name',
      p_title                  => 'Supplier Onboarding Survey',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Supplier Onboarding Surveys found',
      p_solution               => 'Supplier Onboarding Surveys<br>
<br>
[1589371/KB731322] provides screenshots and a video about the Survey feature for Supplier Onboarding Configuration<br>
',
      p_success_msg            => 'Supplier Onboarding Surveys<br>
<br>
[1589371/KB731322] provides screenshots and a video about the Survey feature for Supplier Onboarding Configuration<br>',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_ISPGS_SUPPLIER_ONBOARDING_SURVEY');



debug('begin add_signature: EBS_MFG_ISPGS_UDA_INFO_PROSPECTIVE_SUPPLIER');
   l_info('##MASK##C_EXT_ATTR%'):= 'DISPLAY_FIRST_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30555',
      p_sig_id                 => 'EBS_MFG_ISPGS_UDA_INFO_PROSPECTIVE_SUPPLIER',
      p_sig_sql                => 'select psr.supplier_reg_id, psr.supplier_name, psr.ou_id, psr.po_vendor_id, psr.vendor_party_id, psr.registration_type, psr.registration_status, 
psp_ext_b.extension_id, psp_ext_b.party_id, psp_ext_b.attr_group_id, psp_ext_b.data_level_id, psp_ext_b.is_prospect, psp_ext_b.last_update_date, psp_ext_b.creation_date, 
psp_ext_b.PK1_VALUE, psp_ext_b.PK2_VALUE, psp_ext_b.PK3_VALUE, psp_ext_b.PK4_VALUE, psp_ext_b.PK5_VALUE, eagv.attr_group_disp_name, eagv. description, 
psp_ext_b.C_EXT_ATTR1, psp_ext_b.C_EXT_ATTR2, psp_ext_b.C_EXT_ATTR3, psp_ext_b.C_EXT_ATTR4, psp_ext_b.C_EXT_ATTR5, psp_ext_b.C_EXT_ATTR6, psp_ext_b.C_EXT_ATTR7, psp_ext_b.C_EXT_ATTR8, psp_ext_b.C_EXT_ATTR9, psp_ext_b.C_EXT_ATTR10,
psp_ext_b.N_EXT_ATTR1, psp_ext_b.N_EXT_ATTR2, psp_ext_b.N_EXT_ATTR3, psp_ext_b.N_EXT_ATTR4, psp_ext_b.N_EXT_ATTR5,
psp_ext_b.UOM_EXT_ATTR1, psp_ext_b.UOM_EXT_ATTR2, psp_ext_b.UOM_EXT_ATTR3, psp_ext_b.UOM_EXT_ATTR4, psp_ext_b.UOM_EXT_ATTR5,
psp_ext_b.D_EXT_ATTR1, psp_ext_b.D_EXT_ATTR2, psp_ext_b.D_EXT_ATTR3, psp_ext_b.D_EXT_ATTR4, psp_ext_b.D_EXT_ATTR5,
psp_ext_b.CLASSIFICATION_CODE, psp_ext_b.REQUEST_ID
-- C_EXT_ATTR1 ... C_EXT_ATTR40 -- N_EXT_ATTR1 ... N_EXT_ATTR20 -- UOM_EXT_ATTR1 ... UOM_EXT_ATTR20 -- D_EXT_ATTR1 ... D_EXT_ATTR10
from POS_SUPP_PROF_EXT_B psp_ext_b -- extension_id, party_id, attr_group_id, data_level_id, is_prospect, last_update_date, creation_date, PK1_VALUE, PK2_VALUE, PK3_VALUE, PK4_VALUE, PK5_VALUE
, EGO_ATTR_GROUPS_V eagv, pos_supplier_registrations psr --hz_parties hzp
where psp_ext_b.data_level_id = 17701 --17701 is SUPP_LEVEL, 17702 is SUPP_ADDR_LEVEL, 17703 is SUPP_ADDR_SITE_LEVEL
-- pk1-5 PK1_VALUE Party Site ID for SUPP_ADDR_LEVEL attributes - PK2_VALUE Supplier Site ID for SUPP_ADDR_SITE_LEVEL attributes
and psp_ext_b.attr_group_id = eagv.attr_group_id and eagv.application_id = 177
and psp_ext_b.is_prospect = ''Y'' and psp_ext_b.party_id = psr.supplier_reg_id  and psr.supplier_reg_id = ##$$REGSUPPLIERID$$##
order by psp_ext_b.party_id, eagv.attr_group_disp_name
',
      p_title                  => 'UDA Information for Prospective Supplier',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'User Defined Attributes (UDA) at the Supplier Level for Prospective Supplier',
      p_solution               => 'This is for informational purpose only',
      p_success_msg            => 'There is no UDA data found for the prospective supplier',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_ISPGS_UDA_INFO_PROSPECTIVE_SUPPLIER');



debug('begin add_signature: EBS_MFG_ISPGS_UDA_INFO_REGISTERED_SUPPLIER');
   l_info('##MASK##C_EXT_ATTR%'):= 'DISPLAY_FIRST_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30554',
      p_sig_id                 => 'EBS_MFG_ISPGS_UDA_INFO_REGISTERED_SUPPLIER',
      p_sig_sql                => 'select hzp.party_name, hzp.party_type, psp_ext_b.extension_id, psp_ext_b.party_id, psp_ext_b.attr_group_id, psp_ext_b.data_level_id, psp_ext_b.is_prospect, psp_ext_b.last_update_date, psp_ext_b.creation_date, 
psp_ext_b.PK1_VALUE, psp_ext_b.PK2_VALUE, psp_ext_b.PK3_VALUE, psp_ext_b.PK4_VALUE, psp_ext_b.PK5_VALUE, eagv.attr_group_disp_name, eagv. description, 
psp_ext_b.C_EXT_ATTR1, psp_ext_b.C_EXT_ATTR2, psp_ext_b.C_EXT_ATTR3, psp_ext_b.C_EXT_ATTR4, psp_ext_b.C_EXT_ATTR5, psp_ext_b.C_EXT_ATTR6, psp_ext_b.C_EXT_ATTR7, psp_ext_b.C_EXT_ATTR8, psp_ext_b.C_EXT_ATTR9, psp_ext_b.C_EXT_ATTR10,
psp_ext_b.N_EXT_ATTR1, psp_ext_b.N_EXT_ATTR2, psp_ext_b.N_EXT_ATTR3, psp_ext_b.N_EXT_ATTR4, psp_ext_b.N_EXT_ATTR5,
psp_ext_b.UOM_EXT_ATTR1, psp_ext_b.UOM_EXT_ATTR2, psp_ext_b.UOM_EXT_ATTR3, psp_ext_b.UOM_EXT_ATTR4, psp_ext_b.UOM_EXT_ATTR5,
...
psp_ext_b.CLASSIFICATION_CODE, psp_ext_b.REQUEST_ID
-- C_EXT_ATTR1 ... C_EXT_ATTR40  -- N_EXT_ATTR1 ... N_EXT_ATTR20  -- UOM_EXT_ATTR1 ... UOM_EXT_ATTR20   -- D_EXT_ATTR1 ... D_EXT_ATTR10
from POS_SUPP_PROF_EXT_B psp_ext_b, EGO_ATTR_GROUPS_V eagv, hz_parties hzp
where psp_ext_b.data_level_id = 17701 --17701 is SUPP_LEVEL, 17702 is SUPP_ADDR_LEVEL, 17703 is SUPP_ADDR_SITE_LEVEL
-- pk1-5 PK1_VALUE Party Site ID for SUPP_ADDR_LEVEL attributes - PK2_VALUE Supplier Site ID for SUPP_ADDR_SITE_LEVEL attributes
and psp_ext_b.attr_group_id = eagv.attr_group_id and eagv.application_id = 177
and psp_ext_b.is_prospect = ''N'' and psp_ext_b.party_id = hzp.party_id and hzp.party_type = ''ORGANIZATION'' 
and hzp.party_id = (select party_id from po_vendors where vendor_id = ##$$SUPPLIERID$$##)
order by psp_ext_b.party_id, eagv.attr_group_disp_name',
      p_title                  => 'UDA Information for Registered Supplier',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'User Defined Attributes (UDA) at the Supplier Level for Registered Supplier',
      p_solution               => 'This is for informational purpose only',
      p_success_msg            => 'There is no UDA data found for the supplier',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_ISPGS_UDA_INFO_REGISTERED_SUPPLIER');



debug('begin add_signature: ISP_DMZ_ENABLED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1849',
      p_sig_id                 => 'ISP_DMZ_ENABLED',
      p_sig_sql                => 'select unique profile_option_name,
  hierarchy_type "Type",
  WRITE_ALLOWED_FLAG,
  READ_ALLOWED_FLAG,
...
order by hierarchy_type,profile_option_name',
      p_title                  => 'Enabled Level',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Profiles are enabled',
      p_solution               => 'As described in the following Knowledge articles, R12 requires that certain specific profile options need to be enabled at the server level and some at the new ServResp level. <br><br>

The output shows key profile options that need adjustment.

See [364439/KB219834] Tips and Queries for Troubleshooting Advanced Topologies (KB219834)<br>
<br>
Reference<br>
<ul>
<li>[364439/KB219834] Tips and Queries for Troubleshooting Advanced Topologies (KB219834)</li>
<li>[380490/KB816603] Oracle E-Business Suite R12 Configuration in a DMZ (KB816603)</li>
<li>[11172164/KA1036] Oracle E-Business Suite Release 12.2 Configuration in a DMZ (KA1036)</li>
<li>[287176/KB850752] DMZ Configuration with Oracle E-Business Suite 11i (KB850752)</li>
</ul>',
      p_success_msg            => 'As described in the following Knowledge articles, R12 requires that certain specific profile options need to be enabled at the server level and some at the new ServResp level. <br><br>

The output shows key profile options that have been set to the appropriate hierarchy and that the flags are correctly set to allow updates.<br><br>
...
<li>[287176/KB850752] DMZ Configuration with Oracle E-Business Suite 11i (KB850752)</li>
   ...
   l_info.delete;
debug('end add_signature: ISP_DMZ_ENABLED');



debug('begin add_signature: ISP_DMZ_FND_NODES');
   l_info('##MASK##DOMAIN'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##NODE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SERVER_ADDRESS'):= 'DISPLAY_1_3_OCTET';
   l_info('##MASK##VIRTUAL_IP'):= 'DISPLAY_FIRST_4_CHAR';
   l_info('##MASK##WEBHOST'):= 'DISPLAY_1_3_OCTET';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1846',
      p_sig_id                 => 'ISP_DMZ_FND_NODES',
      p_sig_sql                => 'select
  node_id,
  platform_code,
  support_db D,
...
order by node_id',
      p_title                  => 'FND Nodes',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Nodes defined',
      p_solution               => 'See [364439/KB219834] - Tips and Queries for Troubleshooting Advanced Topologies',
      p_success_msg            => '<ul><p>Per [364439/KB219834] The FND_NODES table is the primary source of information used by AutoConfig in determining the names and types of nodes that make up the release 11i and 12 instance and therefore the FND_NODES table is often the best, first place to look. You can quickly tell how many servers a customer has and what they are configured to do and this should match their topology diagram. If it doesn''t match the diagram, this is the first hint at a configuration error.</p>

<p>Important Columns</p>

<p><b>Node_Id</b> - a unique number for identifying the node.
This is used by the profile options tables to identify the server when using Server and/or ServResp profile options as discussed later in this note.</p>

<p><b>Platform_Code</b> - 2=HPUX, 46=Linux, 319=AIX 32-bit, 453=Solaris, 912-Windows, etc.</p>

<p>The Node type columns - each node can be a combination of these</p>
<ul><dt>  D support_db -- this node has a database </dt>
<dt>  C support_cp -- this node hosts the concurrent managers</dt> 
<dt>  A support_admin -- this is an administration tier </dt>
<dt>  F support_forms -- this is a forms server tier (and likely a web tier as well)</dt> 
<dt>  W support_web -- this is a web tier (Apache)</dt></ul>

<p><b>Node_Name</b> - Node/Machine Name.</p>
<p>This may also be "Authentication" which is a dummy row to support server_id authentication, but typically this is just the server''s hostname. This should not be an IP address.</p>

<p><b>Server_ID</b> - this is a semi-randomly generated string created by the AdminAppServer utility to uniquely identify the server when node_name is a valid server name. The exception to this rule is when node_name is the dummy row for authentication and then the value of server_id for the authentication row may be ON, OFF, or SECURE. If Authentication is set to SECURE then this string must match the server_id string in each server''s DBC files. The DBC file location is defined by the environment variable FND_SECURE and is typically $FND_TOP/secure.</p>

<p><b>Server_Address</b> - the IP address of the server or, optionally, the IP address of the relevant reverse proxy server. This is normally determined automatically by AutoConfig, but can be overridden and specified manually by the AutoConfig parameter "s_server_ip_address" in the AutoConfig XML context file. This new variable first appeared in patch "4709948 - TXK (FND) AutoConfig Template Rollup Patch M (April 2006)".</p>

<p>A common error is to have an incorrectly formatted /etc/hosts file that has only the loopback address. Since this table has the very reasonable uniqueness constraint on server_address, you cannot use "127.0.0.1" here. If another server tries to use 127.0.0.1, it will have only a partially formed (invalid) entry in this table.</p>

<p>Similarly, only a partially formed (invalid) entry will be formed when creating a virtually external tier and attempting to use the same IP address for both the internal server and the virtually external server. For more information of virtually external tiers, see [438744/KB686684] -Case History: Implementing a Reverse Proxy Alone in a DMZ Configuration</p>

<p><b>Domain</b> - the TCP/IP domain of the server</p>

<p><b>Webhost</b> - the fully qualified domain name of the server. Required for iRecruitment (Bug:3725573) and others.</p></ul>',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ISP_DMZ_FND_NODES');



debug('begin add_signature: ISP_DMZ_ORPHANED_PROFILES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1856',
      p_sig_id                 => 'ISP_DMZ_ORPHANED_PROFILES',
...
order by p.Profile_option_name',
      p_title                  => 'Orphaned Profiles',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The node_id is present at the Server level_value or ServResp level_value2 that is NOT tied to a value in FND_NODES. This is likely caused in a cloned instance',
      p_solution               => 'See the Orphaned Profile Options section of [364439/KB219834] - Tips and Queries for Troubleshooting Advanced Topologies',
      p_success_msg            => 'Per [364439/KB219834] Ideally the above query will return "no rows selected" and indicate that the instance has no orphaned profile options. Otherwise, it will show the node_id that is present at the Server level_value or ServResp level_value2 that is NOT tied to a value in FND_NODES',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ISP_DMZ_ORPHANED_PROFILES');



debug('begin add_signature: ISP_DMZ_SERVER_LOGGED_INTO');
   l_info('##MASK##NODE_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##SERVER_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##USER_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1857',
      p_sig_id                 => 'ISP_DMZ_SERVER_LOGGED_INTO',
      p_sig_sql                => 'select
...
order by first_connect',
      p_title                  => 'Server Logged Into',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Users are logged in',
      p_solution               => 'See [364439/KB219834] - Tips and Queries for Troubleshooting Advanced Topologies',
      p_success_msg            => 'Per [364439/KB219834] This shows the users that are logged in.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ISP_DMZ_SERVER_LOGGED_INTO');



debug('begin add_signature: ISP_DMZ_TRUST_PROFILES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1847',
      p_sig_id                 => 'ISP_DMZ_TRUST_PROFILES',
      p_sig_sql                => 'select
...
order by 1,2,3 desc',
      p_title                  => 'DMZ Trust Profiles',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Trust Profiles not Set',
      p_solution               => 'See [364439/KB219834] Tips and Queries for Troubleshooting Advanced Topologies (KB219834)<br><br>

Update the Trust profiles per these Knowledge Articles.
...
<li>[287176/KB850752] DMZ Configuration with Oracle E-Business Suite 11i (KB850752)</li>
      ...
      p_success_msg            => 'Trust profiles are set correctly.  <br><br>
As described in the following Knowledge articles, in R12 each node listed in the fnd_nodes table can be set to be an External, Normal, or Administrative tier using the system profile option "Node Trust Level" (internal name NODE_TRUST_LEVEL). Similarly, you can set externally available responsibilities at the responsibility level using the system profile option "Responsibility Trust Level" (internal name APPL_SERVER_TRUST_LEVEL).<br><br>
...
<li>[287176/KB850752] DMZ Configuration with Oracle E-Business Suite 11i (KB850752)</li>
   ...
   l_info.delete;
debug('end add_signature: ISP_DMZ_TRUST_PROFILES');



debug('begin add_signature: ISP_DMZ_SPECIFC_PROFILES');
   l_info('##MASK##USER_NAME'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1852',
      p_sig_id                 => 'ISP_DMZ_SPECIFC_PROFILES',
      p_sig_sql                => 'select distinct * from
(select
  ''(''||language||'')-''||n.user_profile_option_name NAME,
    decode(v.level_id,
           10001, ''Site'',
    ...
    decode(to_char(v.level_id),
           ...
           ''10004'', (rpad(
substr(usr.user_name, 1, ceil(length(usr.user_name)*0.25) ),
length(usr.user_name), ''*'')),
           ''10005'', svr.node_name,
           ''10006'', org.name,
           ''10007'', (select n.node_name
                  ...
                  v.level_id) "CONTEXT",
     v.profile_option_value VALUE, v.level_id
  from
    fnd_profile_options p,
    fnd_profile_option_values v,
    fnd_profile_options_tl n,
...
order by name, level_id, context, value',
      p_title                  => 'DMZ Specific Profiles',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No DMZ Profiles Set',
      p_solution               => 'See [364439/KB219834] - Tips and Queries for Troubleshooting Advanced Topologies (KB219834)<br>
<br>
Reference<br>
<ul>
<li>[364439/KB219834] Tips and Queries for Troubleshooting Advanced Topologies (KB219834)</li>
...
<li>[287176/KB850752] DMZ Configuration with Oracle E-Business Suite 11i (KB850752)</li>
      ...
      p_success_msg            => '<ul><p>Per [364439/KB219834] - Tips and Queries for Troubleshooting Advanced Topologies (KB219834)<br>
In the above profile options query example, each row is a specific value of a specific profile option at a specific level explained by each of the four columns:</p>

<p><b>NAME</b> - The name of the profile option prefixed with the NLS language code. <p>

<dt>    LANG NLS_LANGUAGE</dt><br>
    <dt>---- ------------------------</dt><br>
<dt>    AR   ARABIC</dt>
<dt>    D    GERMAN</dt>
<dt>    E    SPANISH</dt>
<dt>    EG   EGYPTIAN</dt>
<dt>    ESA  LATIN AMERICAN SPANISH</dt>
<dt>    F    FRENCH</dt>
<dt>    FRC  CANADIAN FRENCH</dt>
<dt>    GB   ENGLISH</dt>
<dt>    IW   HEBREW</dt>
<dt>    JA   JAPANESE</dt>
<dt>    KO   KOREAN</dt>
<dt>    US   AMERICAN</dt>
<dt>    ZHS  SIMPLIFIED CHINESE</dt>
<dt>    ZHT  TRADITIONAL CHINESE</dt>
    (This is a short version of select language_code, nls_language from fnd_languages;)

<p>As written, the profiles query grabs all that is readily apparent to be important for DMZ and hardware load balancing.  It currently shows all of the profile values of the profiles mentioned by [287176/KB850752] and every profile option set at a server and ServResp level.</p>

<p><b>LEVEL_SET</b> - The level where the specific value of the specific profile option comes from i.e.; site, application, responsibility, user, server, org, ServResp.</p>

<p><b>CONTEXT</b> - The context of the level_set.  For example, if the level_set is responsibility, this column will show the specific responsibility and for server it will show the server''s name.  In the more complex case of ServResp, this column will show the name of the server plus the responsibility it is tied to for the ServResp evaluation explained above.</p>

<p><b>VALUE</b> - The raw value of the profile option.  As an example, the query result shows "Node Trust Level", which can be a value of 1, 2, or 3.  The meaningful value of "Node Trust Level" is attainable from the above Trust query which translates the 1, 2, 3 to admin, normal, external.</p></ul>
...
<li>[287176/KB850752] DMZ Configuration with Oracle E-Business Suite 11i (KB850752)</li>
   ...
   l_info.delete;
debug('end add_signature: ISP_DMZ_SPECIFC_PROFILES');



debug('begin add_signature: POS_SUPPLIER_WF_ITEM_ACTIVITY_STATUSES_ERROR');
   l_info('##MASK##ASSIGNED_USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SUPPLIER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11050',
      p_sig_id                 => 'POS_SUPPLIER_WF_ITEM_ACTIVITY_STATUSES_ERROR',
      p_sig_sql                => 'select wfias.item_type, wfias.item_key, wfias.assigned_user,
regexp_replace(substr(wfias.error_message,1,100), ''(.*?\w*)(\.\w*\@\w*\.\w*)(.*)'',  ''\1_ _ _ _\3'' ) ERROR_MESSAGE_PARTIAL_MASKED, 
regexp_replace(substr(wfias.error_stack,1,100),   ''(.*?\w*)(\.\w*\@\w*\.\w*)(.*)'',  ''\1_ _ _ _\3'' ) ERROR_STACK_PARTIAL_MASKED,
wfias.process_activity, wfias.activity_result_code, wfias.begin_date, wfias.end_date, wfias.error_name
from wf_item_activity_statuses wfias
where wfias.activity_status = ''ERROR''
and wfias.item_key = ''##$$FK2$$##'' and wfias.item_type = ''##$$FK1$$##''',
      p_title                  => 'WF_ITEM_ACTIVITY_STATUSES with ERROR for Supplier',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are workflow activities in status ERROR for the Supplier or Supplier User, but a specific solution is not identified by the Analyzer.',
      p_solution               => 'Review the following documents for more details about workflow issues and approval setup for Suppliers:<br>
  [2437249/KB286506] Approval List Could Not Be Generated and POSSPM1 Workflow Error - not a valid role or user name - While Registering A New Supplier
  [2019356/KB197186] Supplier Registration With Approval, How to Setup - Step by Step Process
...
Alternatively, Oracle Support can assist with providing a solution for the issue(s).  Log an SR with Support and attach the complete output from this Procurement iSupplier Analyzer to the new Service Request.  If multiple workflow errors are detected, separate SRs are usually required for each error type.',
      p_success_msg            => 'No workflow activities found in status ERROR (having no defined solution in the Analyzer) for Supplier or Supplier User.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: POS_SUPPLIER_WF_ITEM_ACTIVITY_STATUSES_ERROR');



debug('begin add_signature: POS_WORKFLOW_POSSPM1');
   l_info('##MASK##SUPPLIER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10689',
      p_sig_id                 => 'POS_WORKFLOW_POSSPM1',
      p_sig_sql                => 'Select ''POSSPM1'' pos_item_type, wfi.item_key pos_item_key, 
''EXISTING'' vendor_type, REGEXP_SUBSTR(wfi.item_key, ''(\d\d+)'',1,1) VENDORID_OR_SUPPLIERREGID, 
wfi.item_type "##$$FK1$$##", wfi.item_key "##$$FK2$$##",
aps.vendor_name SUPPLIER_NAME
from wf_items wfi, ap_suppliers aps
where aps.vendor_id = ##$$SUPPLIERID$$##
and aps.vendor_id = REGEXP_SUBSTR(wfi.item_key, ''(\d\d+)'',1,1)
and wfi.item_key not like ''%_REG%'' and wfi.item_key not like ''POSSPM1_PSUPPLIER_APPROVED%''
and wfi.item_type = ''POSSPM1''
UNION ALL
Select ''POSSPM1'' pos_item_type, wfi.item_key pos_item_key, 
''REGISTERED'' vendor_type, REGEXP_SUBSTR(wfi.item_key, ''(\d\d+)'',1,1) VENDORID_OR_SUPPLIERREGID, 
wfi.item_type "##$$FK1$$##", wfi.item_key "##$$FK2$$##",
psr.supplier_name SUPPLIER_NAME
from wf_items wfi, pos_supplier_registrations psr
where psr.supplier_reg_id = ##$$REGSUPPLIERID$$##
and psr.supplier_reg_id = REGEXP_SUBSTR(wfi.item_key, ''(\d\d+)'',1,1)
and (wfi.item_key like ''%_REG%'' or wfi.item_key like ''POSSPM1_PSUPPLIER_APPROVED%'')
and wfi.item_type = ''POSSPM1''
order by pos_item_key

',
      p_title                  => 'Supplier Registration and Profile Management Workflow (POSSPM1)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Supplier Registration and Profile Management workflow (POSSPM1) details',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Supplier Registration and Profile Management workflow (POSSPM1) details found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('POS_SUPPLIER_WF_ITEM_ACTIVITY_STATUSES_ERROR'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '14'
      );
   l_info.delete;
debug('end add_signature: POS_WORKFLOW_POSSPM1');



debug('begin add_signature: POS_WORKFLOW_POSSPM1_WFSTAT');
   l_info('##MASK##SUPPLIER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10692',
      p_sig_id                 => 'POS_WORKFLOW_POSSPM1_WFSTAT',
      p_sig_sql                => 'select posspm1.supplier_name, WFS.item_key, WFA.DISPLAY_NAME Process, WFA1.DISPLAY_NAME Activity, WF_CORE.ACTIVITY_RESULT(WFA1.RESULT_TYPE,WFS.ACTIVITY_RESULT_CODE) Result,
LKP.MEANING Act_status, WFS.NOTIFICATION_ID Notif, WFP.PROCESS_NAME I_process, WFP.ACTIVITY_NAME I_activity, WFS.ACTIVITY_RESULT_CODE I_Act_Res_code,
to_char(WFS.BEGIN_DATE,''DD-MON-RR_HH24:MI:SS'') Begin_d, to_char(WFS.END_DATE,''DD-MON-RR_HH24:MI:SS'') End_d, WFS.ERROR_NAME error_name
from WF_ITEM_ACTIVITY_STATUSES WFS, WF_PROCESS_ACTIVITIES WFP, WF_ACTIVITIES_VL WFA, WF_ACTIVITIES_VL WFA1, WF_LOOKUPS LKP, wf_items wfi, 
(Select ''POSSPM1'' pos_item_type, ''EXISTING'' vendor_type, REGEXP_SUBSTR(wfi.item_key, ''(\d\d+)'',1,1) VENDORID_OR_SUPPLIERREGID, 
wfi.item_key pos_item_key, aps.vendor_name SUPPLIER_NAME
from wf_items wfi, ap_suppliers aps
where aps.vendor_id = ##$$SUPPLIERID$$##
and aps.vendor_id = REGEXP_SUBSTR(wfi.item_key, ''(\d\d+)'',1,1)
and wfi.item_key not like ''%_REG%'' and wfi.item_key not like ''POSSPM1_PSUPPLIER_APPROVED%''
and wfi.item_type = ''POSSPM1''
UNION ALL
Select ''POSSPM1'' pos_item_type, ''REGISTERED'' vendor_type, REGEXP_SUBSTR(wfi.item_key, ''(\d\d+)'',1,1) VENDORID_OR_SUPPLIERREGID, 
wfi.item_key pos_item_key, psr.supplier_name SUPPLIER_NAME
from wf_items wfi, pos_supplier_registrations psr
where psr.supplier_reg_id = ##$$REGSUPPLIERID$$##
and psr.supplier_reg_id = REGEXP_SUBSTR(wfi.item_key, ''(\d\d+)'',1,1)
and (wfi.item_key like ''%_REG%'' or wfi.item_key like ''POSSPM1_PSUPPLIER_APPROVED%'')
and wfi.item_type = ''POSSPM1'') posspm1
where
WFS.PROCESS_ACTIVITY = WFP.INSTANCE_ID and WFP.PROCESS_ITEM_TYPE = WFA.ITEM_TYPE and WFP.PROCESS_NAME = WFA.NAME and WFP.PROCESS_VERSION = WFA.VERSION
...
and wfs.item_key = wfi.item_key and WFS.ITEM_TYPE = wfi.item_type
and wfi.item_key = posspm1.pos_item_key and wfi.item_type = posspm1.pos_item_type
order by WFS.ITEM_KEY, WFS.BEGIN_DATE, EXECUTION_TIME',
      p_title                  => 'Supplier Registration and Profile Management Workflow (POSSPM1) WFSTAT',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Supplier Registration and Profile Management workflow (POSSPM1) wfstat details',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Supplier Registration and Profile Management workflow (POSSPM1) wfstat details found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: POS_WORKFLOW_POSSPM1_WFSTAT');



debug('begin add_signature: POS_WORKFLOW_POSSPM1_NOTIF');
  ...
  add_signature(
      p_sig_repo_id            => '11052',
      p_sig_id                 => 'POS_WORKFLOW_POSSPM1_NOTIF',
      p_sig_sql                => 'Select posspm1.SUPPLIER_NAME SUPPLIER_NAME,
wfn.notification_id, REGEXP_SUBSTR(wfn.subject, ''(Supplier Collaboration Network.*|.*for|.*from|.*to.*|.*of.*)'',1,1) PartialSubject, wfn.language, wfn.message_type, wfn.item_key,
wfn.message_name, wfn.recipient_role, wfn.original_recipient, wfn.to_user, wfn.status, wfn.mail_status, wfn.begin_date, wfn.end_date,
wfn.callback, wfn.context
from wf_items wfi, wf_notifications wfn, (Select ''POSSPM1'' pos_item_type, ''EXISTING'' vendor_type, REGEXP_SUBSTR(wfi.item_key, ''(\d\d+)'',1,1) VENDORID_OR_SUPPLIERREGID, 
wfi.item_key pos_item_key, aps.vendor_name SUPPLIER_NAME
from wf_items wfi, ap_suppliers aps
where aps.vendor_id = NVL(to_char(''##$$SUPPLIERID$$##''),''0'')
and aps.vendor_id = REGEXP_SUBSTR(wfi.item_key, ''(\d\d+)'',1,1)
and wfi.item_key not like ''%_REG%'' and wfi.item_key not like ''POSSPM1_PSUPPLIER_APPROVED%''
and wfi.item_type = ''POSSPM1''
UNION ALL
...
wfi.item_key pos_item_key, psr.supplier_name SUPPLIER_NAME
from wf_items wfi, pos_supplier_registrations psr
where psr.supplier_reg_id = NVL(to_char(''##$$REGSUPPLIERID$$##''),''0'')
and psr.supplier_reg_id = REGEXP_SUBSTR(wfi.item_key, ''(\d\d+)'',1,1)
and (wfi.item_key like ''%_REG%'' or wfi.item_key like ''POSSPM1_PSUPPLIER_APPROVED%'')
and wfi.item_type = ''POSSPM1'') posspm1
where wfn.message_type = wfi.item_type and wfn.item_key = wfi.item_key
and wfi.item_key = posspm1.pos_item_key and wfi.item_type = posspm1.pos_item_type',
      p_title                  => 'Supplier Registration and Profile Management Workflow (POSSPM1) Notifications',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Supplier Registration and Profile Management workflow (POSSPM1) notifications',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Supplier Registration and Profile Management workflow (POSSPM1) notifications found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: POS_WORKFLOW_POSSPM1_NOTIF');



debug('begin add_signature: POS_WORKFLOW_POSSPAPP');
   l_info('##MASK##ORIGINAL_RECIPIENT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SUBJECT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SUPPLIER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TO_USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10690',
      p_sig_id                 => 'POS_WORKFLOW_POSSPAPP',
      p_sig_sql                => 'Select psr.SUPPLIER_REG_ID, psr.SUPPLIER_NAME, 
wfi.item_type, wfi.item_type "##$$FK1$$##", wfi.item_key , wfi.item_key "##$$FK2$$##",
wfn.notification_id, wfn.context, wfn.original_recipient, wfn.to_user, wfn.subject
from wf_items wfi, wf_notifications wfn, pos_supplier_registrations psr
where wfn.message_type(+) = wfi.item_type and wfn.item_key(+) = wfi.item_key
and wfi.item_key like concat(psr.SUPPLIER_REG_ID,''%'')
and wfi.item_type = ''POSSPAPP''
and psr.supplier_reg_id = ##$$REGSUPPLIERID$$##',
      p_title                  => 'POS: Supplier Approval Management Workflow (POSSPAPP)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'POS: Supplier Approval Management workflow (POSSPAPP)',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No POS: Supplier Approval Management workflow (POSSPAPP) found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: POS_WORKFLOW_POSSPAPP');



debug('begin add_signature: POS_WORKFLOW_POSSPAPP_WFSTAT');
   l_info('##MASK##SUPPLIER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10693',
      p_sig_id                 => 'POS_WORKFLOW_POSSPAPP_WFSTAT',
      p_sig_sql                => 'select psr.supplier_name, WFS.item_key, WFA.DISPLAY_NAME Process, WFA1.DISPLAY_NAME Activity, WF_CORE.ACTIVITY_RESULT(WFA1.RESULT_TYPE,WFS.ACTIVITY_RESULT_CODE) Result, 
LKP.MEANING Act_status, WFS.NOTIFICATION_ID Notif, WFP.PROCESS_NAME I_process, WFP.ACTIVITY_NAME I_activity, WFS.ACTIVITY_RESULT_CODE I_Act_Res_code, 
to_char(WFS.BEGIN_DATE,''DD-MON-RR_HH24:MI:SS'') Begin_d, to_char(WFS.END_DATE,''DD-MON-RR_HH24:MI:SS'') End_d, WFS.ERROR_NAME error_name 
from WF_ITEM_ACTIVITY_STATUSES WFS, WF_PROCESS_ACTIVITIES WFP, WF_ACTIVITIES_VL WFA, WF_ACTIVITIES_VL WFA1, WF_LOOKUPS LKP, wf_items wfi, pos_supplier_registrations Psr
where 
WFS.PROCESS_ACTIVITY = WFP.INSTANCE_ID and WFP.PROCESS_ITEM_TYPE = WFA.ITEM_TYPE and WFP.PROCESS_NAME = WFA.NAME and WFP.PROCESS_VERSION = WFA.VERSION 
and WFP.ACTIVITY_ITEM_TYPE = WFA1.ITEM_TYPE and WFP.ACTIVITY_NAME = WFA1.NAME 
and WFA1.VERSION = (select max(VERSION) from WF_ACTIVITIES WF2 where WF2.ITEM_TYPE = WFP.ACTIVITY_ITEM_TYPE and WF2.NAME = WFP.ACTIVITY_NAME)
and LKP.LOOKUP_TYPE = ''WFENG_STATUS'' and LKP.LOOKUP_CODE = WFS.ACTIVITY_STATUS 
and wfs.item_key = wfi.item_key and WFS.ITEM_TYPE = wfi.item_type
and wfi.item_key like concat(psr.SUPPLIER_REG_ID,''%'') and wfi.item_type = ''POSSPAPP''
and psr.supplier_reg_id = ##$$REGSUPPLIERID$$##
order by WFS.ITEM_KEY, WFS.BEGIN_DATE, EXECUTION_TIME',
      p_title                  => 'POS: Supplier Approval Management Workflow (POSSPAPP) WFSTAT',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'POS: Supplier Approval Management workflow (POSSPAPP) wfstat details',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No POS Supplier Approval Management workflow (POSSPAPP) wfstat details found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: POS_WORKFLOW_POSSPAPP_WFSTAT');



debug('begin add_signature: POS_WORKFLOW_POSSPAPP_NOTIF');
   l_info('##MASK##ORIGINAL_RECIPIENT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##RECIPIENT_ROLE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SUBJECT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SUPPLIER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '11053',
      p_sig_id                 => 'POS_WORKFLOW_POSSPAPP_NOTIF',
      p_sig_sql                => 'Select psr.supplier_reg_id SUPPLIER_REG_ID, wfi.item_key, concat(to_char(psr.SUPPLIER_REG_ID),''%''), NVL(psr.SUPPLIER_NAME,''Unknown'') SUPPLIER_NAME,
wfn.notification_id, REGEXP_SUBSTR(wfn.subject, ''(Registration request from prospective supplier)'',1,1) PartialSubject, wfn.language, wfn.message_type, wfn.item_key, 
wfn.message_name, wfn.recipient_role, wfn.original_recipient, wfn.to_user, wfn.status, wfn.mail_status, wfn.begin_date, wfn.end_date, 
wfn.callback, wfn.context
from wf_items wfi, wf_notifications wfn, pos_supplier_registrations psr 
where wfn.notification_id is not null
and wfn.message_type(+) = wfi.item_type and wfn.item_key(+) = wfi.item_key 
and wfi.item_key like concat(to_char(psr.SUPPLIER_REG_ID),''%'') and wfi.item_type = ''POSSPAPP''
and psr.supplier_reg_id = NVL(to_char(''##$$REGSUPPLIERID$$##''),''0'')',
      p_title                  => 'POS: Supplier Approval Management Workflow (POSSPAPP) Notifications',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'POS: Supplier Approval Management workflow (POSSPAPP) notifications',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No POS Supplier Approval Management workflow (POSSPAPP) notifications found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: POS_WORKFLOW_POSSPAPP_NOTIF');



debug('begin add_signature: POS_WORKFLOW_POSREGV2_WFSTAT');
   l_info('##MASK##ASSIGNED_USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PERSON_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SUPPLIER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TO_USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11049',
      p_sig_id                 => 'POS_WORKFLOW_POSREGV2_WFSTAT',
      p_sig_sql                => 'select WFS.item_key, WFA.DISPLAY_NAME Process, WFA1.DISPLAY_NAME Activity, REGEXP_SUBSTR(WF_CORE.ACTIVITY_RESULT(WFA1.RESULT_TYPE,WFS.ACTIVITY_RESULT_CODE), ''(Y\:http|.*)'',1,1) Result_Partial,
LKP.MEANING Act_status, WFS.NOTIFICATION_ID Notif, WFP.PROCESS_NAME I_process, WFP.ACTIVITY_NAME I_activity, REGEXP_SUBSTR(wfs.activity_result_code, ''(Y\:http|.*)'',1,1) I_Act_Res_code_Partial,
to_char(WFS.BEGIN_DATE,''DD-MON-RR_HH24:MI:SS'') Begin_d, to_char(WFS.END_DATE,''DD-MON-RR_HH24:MI:SS'') End_d, WFS.ERROR_NAME error_name
FROM WF_ITEM_ACTIVITY_STATUSES WFS, WF_PROCESS_ACTIVITIES WFP, WF_ACTIVITIES_VL WFA, WF_ACTIVITIES_VL WFA1, WF_LOOKUPS LKP, wf_items wfiWHERE
WFS.PROCESS_ACTIVITY = WFP.INSTANCE_ID and WFP.PROCESS_ITEM_TYPE = WFA.ITEM_TYPE and WFP.PROCESS_NAME = WFA.NAME and WFP.PROCESS_VERSION = WFA.VERSION
and WFP.ACTIVITY_ITEM_TYPE = WFA1.ITEM_TYPE and WFP.ACTIVITY_NAME = WFA1.NAME
and WFA1.VERSION = (select max(VERSION) from WF_ACTIVITIES WF2 where WF2.ITEM_TYPE = WFP.ACTIVITY_ITEM_TYPE and WF2.NAME = WFP.ACTIVITY_NAME)
and LKP.LOOKUP_TYPE = ''WFENG_STATUS'' and LKP.LOOKUP_CODE = WFS.ACTIVITY_STATUS
and wfs.item_key = wfi.item_key and WFS.ITEM_TYPE = wfi.item_type
and wfi.item_key = ''##$$FK2$$##'' and wfi.item_type = ''##$$FK1$$##''
order by WFS.ITEM_KEY, WFS.BEGIN_DATE, EXECUTION_TIME',
      p_title                  => 'Supplier User Registration Workflow Version 2 (POSREGV2) wfstat',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Supplier User Registration workflow version 2 for R12 (POSREGV2).',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Supplier User Registration workflow version 2 for R12 (POSREGV2) found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: POS_WORKFLOW_POSREGV2_WFSTAT');



debug('begin add_signature: POS_WORKFLOW_POSREGV2_NOTIF');
   l_info('##MASK##ORIGINAL_RECIPIENT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##RECIPIENT_ROLE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SUPPLIER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TO_USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '11051',
      p_sig_id                 => 'POS_WORKFLOW_POSREGV2_NOTIF',
      p_sig_sql                => 'Select distinct 
wfn.notification_id, wfn.subject, wfn.language, wfn.message_type, wfn.item_key,
wfn.message_name, wfn.recipient_role, wfn.original_recipient, wfn.to_user, wfn.status, wfn.mail_status, wfn.begin_date, wfn.end_date,
wfn.callback, wfn.context
FROM wf_items wfi, wf_notifications wfnWHERE wfn.message_type = wfi.item_type and wfn.item_key = wfi.item_key
and wfi.item_key = ''##$$FK2$$##'' and wfi.item_type = ''##$$FK1$$##''',
      p_title                  => 'Supplier User Registration Workflow Version 2 (POSREGV2) Notifications',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Supplier User Registration workflow version 2 for R12 (POSREGV2) notifications.',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Supplier User Registration workflow version 2 for R12 (POSREGV2) notifications found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: POS_WORKFLOW_POSREGV2_NOTIF');



debug('begin add_signature: POS_WORKFLOW_POSREGV2');
   l_info('##MASK##ASSIGNED_USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PERSON_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SUPPLIER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TO_USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '10691',
      p_sig_id                 => 'POS_WORKFLOW_POSREGV2',
      p_sig_sql                => 'select distinct 
pos_item_type, pos_item_type "##$$FK1$$##", pos_item_key, pos_item_key "##$$FK2$$##", assigned_user, notification_id,
status, to_user, PERSON_NAME, SUPPLIER_NAME, SUPPLIER_NAME "##$$FK3$$##"
from
(
select wfias.item_type pos_item_type, wfias.item_key pos_item_key, wfias.assigned_user, wfias.notification_id,
wfn.status, wfn.to_user, hzpperson.party_name PERSON_NAME, aps.vendor_name SUPPLIER_NAME
from wf_item_activity_statuses wfias, wf_notifications wfn, fnd_user fndu, hz_parties hzpperson, hz_relationships hzr, hz_parties hzpsupplier, ap_suppliers aps
where 
--and wfias.assigned_user is not null and 
wfn.notification_id = wfias.notification_id
and wfias.item_type = ''POSREGV2''
and wfias.assigned_user = fndu.user_name
and fndu.customer_id = hzpperson.party_id
and hzpperson.party_id = hzr.object_id
and hzr.subject_id = hzpsupplier.party_id
and hzpsupplier.party_id = aps.party_id
and aps.vendor_id = ##$$SUPPLIERID$$##
UNION
select wfias.item_type, wfias.item_key, wfias.assigned_user, wfias.notification_id,
wfn.status, wfn.to_user, HzpPerson.party_name PERSON_NAME, aps.vendor_name
from ap_suppliers aps, pos_supplier_mappings psm, hz_contact_points Hzcp, hz_parties HzpOrg, hz_parties HzpPerson, hz_relationships Hzr, wf_item_activity_statuses wfias, wf_notifications wfn
where wfn.notification_id = wfias.notification_id
and wfn.recipient_role = wfias.assigned_user
and wfias.item_type = ''POSREGV2''
and UPPER(wfias.assigned_user) = UPPER(hzcp.email_address)
AND Hzcp.owner_table_name = ''HZ_PARTIES''
and Hzcp.owner_table_id = HzpOrg.party_id
AND HzpOrg.party_id = Hzr.party_id and HzpPerson.party_id = Hzr.subject_id and Hzr.subject_type = ''PERSON'' AND Hzr.object_type = ''ORGANIZATION'' AND Hzr.relationship_code = ''CONTACT_OF''
and hzr.object_id = psm.party_id
and psm.party_id = aps.party_id
and aps.vendor_id = ##$$SUPPLIERID$$##
UNION 
select wfias.item_type, wfias.item_key, wfias.assigned_user, wfias.notification_id,
''null'' status, ''null'' to_user, hzp.party_name, aps.vendor_name
from wf_item_activity_statuses wfias, --wf_notifications wfn, 
fnd_user fndu, hz_parties hzp, hz_relationships hzr, ap_suppliers aps
where 
--and wfn.notification_id = wfias.notification_id and 
wfias.activity_status = ''ERROR''
and wfias.item_type = ''POSREGV2''
and (REGEXP_SUBSTR(wfias.item_key, ''(\d\d+)'',1,1)) = fndu.user_id
and fndu.customer_id = hzp.party_id
and hzp.party_id = hzr.object_id
and hzr.subject_id = aps.party_id
and aps.vendor_id = ##$$SUPPLIERID$$##
UNION
select wfias.item_type, wfias.item_key, wfias.assigned_user, wfias.notification_id,
wfn.status, wfn.to_user, hzp.party_name, aps.vendor_name
from wf_item_activity_statuses wfias, wf_notifications wfn, 
fnd_user fndu, hz_parties hzp, hz_relationships hzr, ap_suppliers aps
where 
wfias.activity_status = ''ERROR''
...
order by notification_id desc',
      p_title                  => 'Supplier User Registration Workflow Version 2 (POSREGV2)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Supplier User Registration workflow version 2 for R12 (POSREGV2)',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Supplier User Registration workflow version 2 for R12 (POSREGV2) found.',
      ...
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('POS_WORKFLOW_POSREGV2_WFSTAT','POS_WORKFLOW_POSREGV2_NOTIF','POS_SUPPLIER_WF_ITEM_ACTIVITY_STATUSES_ERROR'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '26'
      );
   l_info.delete;
debug('end add_signature: POS_WORKFLOW_POSREGV2');



debug('begin add_signature: 2439127.1 SUPPLIER REGISTRATION APPROVAL ERROR 3146 COMMIT');
   l_info('##MASK##SUPPLIER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16327',
      p_sig_id                 => '2439127.1 SUPPLIER REGISTRATION APPROVAL ERROR 3146 COMMIT',
      p_sig_sql                => 'select pw.pos_item_type item_type, pw.pos_item_key item_key, pw.supplier_name, error_message, wfias.error_stack
from wf_item_activity_statuses wfias,
(Select ''POSSPAPP'' pos_item_type, wfi.item_key pos_item_key, NVL(psr.SUPPLIER_NAME,''Unknown'') SUPPLIER_NAME
from wf_items wfi, wf_notifications wfn, pos_supplier_registrations psr
where wfn.message_type(+) = wfi.item_type and wfn.item_key(+) = wfi.item_key and wfi.item_key like concat(psr.SUPPLIER_REG_ID,''%'') and wfi.item_type = ''POSSPAPP''
and psr.supplier_reg_id = ##$$REGSUPPLIERID$$##
) pw
where pw.pos_item_key = wfias.item_key
and pw.pos_item_type = wfias.item_type
and wfias.error_stack like ''Wf_Engine_Util.Function_Call(POS_SUPP_APPR.PROCESS_APPROVE_WF_WRAPPER, POSSPAPP,''
and wfias.error_message like ''3146: Commit happened in activity/function ''''PARALLEL_APPROVAL_PROCESS:AME_PROCESS_APPROVE/POS_SUPP_APPR.PROCESS_APPROVE_WF_WRAPPER%''
and (wfias.activity_status = ''ERROR'' or wfias.error_name is not null)
and wfias.item_type in (''POSSPAPP'')
and exists
  (select Filename, FileVersion CustomerFileVersion from (select name PackageName, type PackageType, 
  REGEXP_SUBSTR(text, ''\$Header\: (PO\w+?\.\w\w\w)\s'', 1, 1, ''i'', 1) Filename, REGEXP_SUBSTR(text, ''.\w\w\w (\d+\.\d+\.\d+\.\d+|\d+\.\d+)'', 1, 1, ''i'', 1) FileVersion, 
  REGEXP_SUBSTR(text, ''.\w\w\w (\d+)\.'', 1, 1, ''i'', 1) VersionSegment1, REGEXP_SUBSTR(text, ''.\w\w\w \d+\.(\d+)'', 1, 1, ''i'', 1) VersionSegment2, 
  REGEXP_SUBSTR(text, ''.\w\w\w \d+\.\d+\.(\d+)'', 1, 1, ''i'', 1) VersionSegment3, REGEXP_SUBSTR(text, ''.\w\w\w \d+\.\d+\.\d+\.(\d+)'', 1, 1, ''i'', 1) VersionSegment4, 
  text from all_source where (type = ''PACKAGE BODY'' and line = 2 and name = ''POS_SUPP_APPR'') ) LowerFileVersions 
  where ((VersionSegment4 < 8 or VersionSegment2 < 10) and VersionSegment3 = 12020000 and VersionSegment1 = 120 and Filename = ''POSSPAPB.pls'') )',
      p_title                  => 'Supplier Approval Workflow Error 3146: Commit at AME Process POS_SUPP_APPR.PROCESS_APPROVE_WF_WRAPPER',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Supplier registration approval workflow POSSAPP encounters error - 3146: Commit happened in activity/function ''PARALLEL_APPROVAL_PROCESS:AME_PROCESS_APPROVE/POS_SUPP_APPR.PROCESS_APPROVE_WF_WRAPPER',
      p_solution               => 'Review and apply the patching solution from [2439127/KB397122]',
      p_success_msg            => 'There is no occurrence of the error shown in [2439127/KB397122]',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: 2439127.1 SUPPLIER REGISTRATION APPROVAL ERROR 3146 COMMIT');



debug('begin add_signature: EBS_MFG_ISPGS_SUPPLIER_REGISTRATION_STATUS_PENDING_APPROVAL');
   l_info('##MASK##ADDRESS%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CITY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COUNTRY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COUNTY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##POSTAL%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PROVINCE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##STATE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SUPPLIER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TAX%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29743',
      p_sig_id                 => 'EBS_MFG_ISPGS_SUPPLIER_REGISTRATION_STATUS_PENDING_APPROVAL',
      p_sig_sql                => 'select * from pos_supplier_registrations PSR
where PSR.REGISTRATION_STATUS = ''PENDING_APPROVAL'' and SUPPLIER_REG_ID = ##$$REGSUPPLIERID$$##
',
      p_title                  => 'Supplier has REGISTRATION_STATUS = PENDING_APPROVAL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There was identified some data corruption during supplier registration in supplier registration tables
pos_supplier_mappings psm, pos_supplier_registrations ',
      p_solution               => '1. One way to fix this issue is to delete the corrupted supplier request record and request supplier registration again.

For this, please check : [2096492/KB465431]

2. A datafix to update supplier REGISTRATION_STATUS = ''PENDING_APPROVAL'' and associated  action_code from  pos_action_history to be set to ''REJECTED''

For this, please check : [2160708/KB294260]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_ISPGS_SUPPLIER_REGISTRATION_STATUS_PENDING_APPROVAL');



debug('begin add_signature: POS_REG_ADDR_REQUESTS');
   l_info('##MASK##ADDRESS_LINE1'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ADDRESS_LINE2'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ADDRESS_LINE3'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ADDRESS_LINE4'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   ...
   l_info('##MASK##COUNTRY'):= 'REMOVE_COLUMN';
   l_info('##MASK##EMAIL_ADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FAX_AREA_CODE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FAX_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PARTY_SITE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PHONE_AREA_CODE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PHONE_EXTENSION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PHONE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '10683',
      p_sig_id                 => 'POS_REG_ADDR_REQUESTS',
      p_sig_sql                => 'select par.* from pos_address_requests par, pos_supplier_mappings psm, pos_supplier_registrations psr
where par.mapping_id = psm.mapping_id
and psm.supplier_reg_id = psr.supplier_reg_id
and psr.supplier_reg_id = ##$$REGSUPPLIERID$$##',
      p_title                  => 'Registration Address Requests',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Address Requests',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Address Requests found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: POS_REG_ADDR_REQUESTS');



debug('begin add_signature: POS_REG_CONTACT_REQUESTS');
   l_info('##MASK##ALT_AREA_CODE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ALT_CONTACT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ALT_PHONE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##EMAIL_ADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FAX_AREA_CODE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FAX_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FIRST_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##LAST_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MIDDLE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PHONE_AREA_CODE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PHONE_EXTENSION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PHONE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##URL'):= 'DISPLAY_NONE';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10684',
      p_sig_id                 => 'POS_REG_CONTACT_REQUESTS',
      p_sig_sql                => 'select pcr.* from pos_contact_requests pcr, pos_supplier_mappings psm, pos_supplier_registrations psr
where pcr.mapping_id = psm.mapping_id
and psm.supplier_reg_id = psr.supplier_reg_id
and psr.supplier_reg_id = ##$$REGSUPPLIERID$$##',
      p_title                  => 'Registration Contact Requests',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Contact Requests',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Contact Requests found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: POS_REG_CONTACT_REQUESTS');



debug('begin add_signature: POS_REG_CONT_ADDR_REQUESTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10682',
      p_sig_id                 => 'POS_REG_CONT_ADDR_REQUESTS',
      p_sig_sql                => 'select pcar.* from pos_cont_addr_requests pcar, pos_supplier_mappings psm, pos_supplier_registrations psr
where pcar.mapping_id = psm.mapping_id
and psm.supplier_reg_id = psr.supplier_reg_id
and psr.supplier_reg_id = ##$$REGSUPPLIERID$$##',
      p_title                  => 'Registration Contact Address Requests',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Contact Address Requests',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Contact Address Requests found',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: POS_REG_CONT_ADDR_REQUESTS');



debug('begin add_signature: POS_REG_BUSINESS_CLASS_REQUESTS');
   l_info('##MASK##CERTIFICATION_NO'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10687',
      p_sig_id                 => 'POS_REG_BUSINESS_CLASS_REQUESTS',
      p_sig_sql                => 'select pbcr.* from pos_bus_class_reqs pbcr, pos_supplier_mappings psm, pos_supplier_registrations psr
where pbcr.mapping_id = psm.mapping_id
and psm.supplier_reg_id = psr.supplier_reg_id
and psr.supplier_reg_id = ##$$REGSUPPLIERID$$##',
      p_title                  => 'Registration Business Classification Requests',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Business Classification requests',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.
',
      p_success_msg            => 'No Business Classification requests found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: POS_REG_BUSINESS_CLASS_REQUESTS');



debug('begin add_signature: POS_REG_BANK_ACCOUNT_REQUESTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10686',
      p_sig_id                 => 'POS_REG_BANK_ACCOUNT_REQUESTS',
      p_sig_sql                => 'select count(*) Bank_Account_Requests  from pos_acnt_gen_req pagr, pos_supplier_mappings psm, pos_supplier_registrations psr
where pagr.mapping_id = psm.mapping_id
and psm.supplier_reg_id = psr.supplier_reg_id
and psr.supplier_reg_id = ##$$REGSUPPLIERID$$##
having count(*) > 0',
      p_title                  => 'Registration Bank Account Requests',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Bank Account Requests exist.  The details are not shown; only the number of bank account requests is shown.',
      p_solution               => 'Click the heading to view or hide the results.  Only one row is displayed showing the count of bank account requests if any exist.',
      p_success_msg            => 'No Bank Acount requests found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: POS_REG_BANK_ACCOUNT_REQUESTS');



debug('begin add_signature: POS_REG_PRODUCT_SERVICE_REQUESTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10685',
      p_sig_id                 => 'POS_REG_PRODUCT_SERVICE_REQUESTS',
      p_sig_sql                => 'select ppsr.* from pos_product_service_requests ppsr, pos_supplier_mappings psm, pos_supplier_registrations psr
where ppsr.mapping_id = psm.mapping_id
and psm.supplier_reg_id = psr.supplier_reg_id
and psr.supplier_reg_id = ##$$REGSUPPLIERID$$##',
      p_title                  => 'Registration Product and Service Requests',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Product and Service Requests',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.
',
      p_success_msg            => 'No Product and Service requests found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: POS_REG_PRODUCT_SERVICE_REQUESTS');



debug('begin add_signature: EBS_MFG_ISPGS_REGISTRATION_POS_ACTION_HISTORY');
   l_info('##MASK##NOTE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31182',
      p_sig_id                 => 'EBS_MFG_ISPGS_REGISTRATION_POS_ACTION_HISTORY',
      p_sig_sql                => 'select * from apps.pos_action_history
where object_id =  ##$$REGSUPPLIERID$$##',
      p_title                  => 'Supplier Registration Action History',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Supplier Registration Action History details',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.
',
      p_success_msg            => 'No Supplier Registration Action History found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_ISPGS_REGISTRATION_POS_ACTION_HISTORY');



debug('begin add_signature: ISP_REG_SUPPLIER_SURVEY_REQUESTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13037',
      p_sig_id                 => 'ISP_REG_SUPPLIER_SURVEY_REQUESTS',
      p_sig_sql                => 'SELECT 
PST.TRANSACTION_ID,         
PST.SUPPLIER_MAPPING_ID,    
PST.SURVEY_TRANSACTION_ID,  
PST.CREATED_BY ,            
PST.CREATION_DATE,          
PST.RESPONDENT_TABLE_NAME,  
PST.RESPONDENT_ID ,         
PST.SUPPLIER_UPDATE_FLAG  
FROM 
POS_SURVEY_TRANSACTIONS PST,
POS_SUPPLIER_MAPPINGS PSM,
POS_SUPPLIER_REGISTRATIONS PSR
WHERE 
PST.SUPPLIER_MAPPING_ID = PSM.MAPPING_ID
AND PSM.SUPPLIER_REG_ID = PSR.SUPPLIER_REG_ID
AND PSR.SUPPLIER_REG_ID =  ##$$REGSUPPLIERID$$##',
      p_title                  => 'Supplier Survey Requests',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Lists the survey requests created during supplier registration',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      ...
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL(),
      p_include_in_dx_summary  => nvl('D','N'),
      p_version                => '2'
      );
   l_info.delete;
debug('end add_signature: ISP_REG_SUPPLIER_SURVEY_REQUESTS');



debug('begin add_signature: ISP_REG_SUPPLIER_PROFILE_ATTRIBUTES');
   l_info('##MASK##C_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13038',
      p_sig_id                 => 'ISP_REG_SUPPLIER_PROFILE_ATTRIBUTES',
      p_sig_sql                => 'SELECT PSB.EXTENSION_ID, PSB.PARTY_ID, PSB.ATTR_GROUP_ID, 
PSB.DATA_LEVEL_ID, PSB.IS_PROSPECT,         
PSB.CREATED_BY, PSB.CREATION_DATE, 
PSBTL.SOURCE_LANG, PSBTL.LANGUAGE,
PSB.PK1_VALUE, PSB.PK2_VALUE, PSB.PK3_VALUE, PSB.PK4_VALUE, PSB.PK5_VALUE,          
PSB.C_EXT_ATTR1,PSB.C_EXT_ATTR2, PSB.C_EXT_ATTR3, PSB.C_EXT_ATTR4, PSB.C_EXT_ATTR5,        
PSB.C_EXT_ATTR6,PSB.C_EXT_ATTR7, PSB.C_EXT_ATTR8, PSB.C_EXT_ATTR9, PSB.C_EXT_ATTR10 
FROM 
POS_SUPP_PROF_EXT_B PSB,
POS_SUPP_PROF_EXT_TL PSBTL,
POS_SUPPLIER_MAPPINGS PSM,
POS_SUPPLIER_REGISTRATIONS PSR
WHERE 
PSB.PARTY_ID = PSR.SUPPLIER_REG_ID
AND PSM.SUPPLIER_REG_ID = PSR.SUPPLIER_REG_ID
AND PSB.EXTENSION_ID = PSBTL.EXTENSION_ID
AND PSB.IS_PROSPECT = ''Y''
AND PSR.SUPPLIER_REG_ID = ##$$REGSUPPLIERID$$##',
      p_title                  => 'Supplier Profile Attributes (UDA) During Supplier Registration',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'List of Supplier Profile Attributes (UDA) created during supplier registration process',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ISP_REG_SUPPLIER_PROFILE_ATTRIBUTES');



debug('begin add_signature: AME_CONFIG_VARS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2291',
      p_sig_id                 => 'AME_CONFIG_VARS',
   ...
   l_info.delete;
debug('end add_signature: AME_CONFIG_VARS');



debug('begin add_signature: AME_MANDATORY_ATTR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2279',
      p_sig_id                 => 'AME_MANDATORY_ATTR',
   ...
   l_info.delete;
debug('end add_signature: AME_MANDATORY_ATTR');



debug('begin add_signature: EBS_MFG_PO_AME_NON_MANDATORY_ATTR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26391',
      p_sig_id                 => 'EBS_MFG_PO_AME_NON_MANDATORY_ATTR',
      p_sig_sql                => 'SELECT atr.attribute_id,
          atr.name,
          atu.query_string,
          atr.description,
   ...
   AND   atr.attribute_id NOT IN (
           ...
           AND   sysdate between man.start_date AND
                   nvl(man.end_date - (1/86400),sysdate))
   ORDER BY atr.name',
      p_title                  => 'AME Non-Mandatory Attributes',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No non-mandatory attributes found',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_AME_NON_MANDATORY_ATTR');



debug('begin add_signature: AME_ITEM_CLASSES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2280',
      p_sig_id                 => 'AME_ITEM_CLASSES',
      p_sig_sql                => 'SELECT icu.item_class_order_number "Order Number",
          ic.name,
          ic.item_class_id,
          icu.item_id_query,
   ...
   ORDER BY icu.item_class_order_number',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No item classes found for this this transaction type',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AME_ITEM_CLASSES');



debug('begin add_signature: AME_IC_ATTR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2281',
      p_sig_id                 => 'AME_IC_ATTR',
      p_sig_sql                => 'SELECT ic.name "Item Class",
          a.attribute_id,
          a.name,
          a.attribute_type,
          au.query_string,
   ...
   l_info.delete;
debug('end add_signature: AME_IC_ATTR');



debug('begin add_signature: EBS_MFG_PO_APPRVL_AME_ATTRIBUTE_DESC_GT_100_CHARS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27870',
      p_sig_id                 => 'EBS_MFG_PO_APPRVL_AME_ATTRIBUTE_DESC_GT_100_CHARS',
      p_sig_sql                => 'SELECT ic.name "Item Class",
          a.attribute_id,
          a.name,
          a.attribute_type,
   ...
   ORDER BY decode(ic.name,''header'',1,''line item'',2,''distribution'',3,4),
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Attribute description exceeds the 100 character limit',
      p_solution               => 'Shorten the attribute description to not exceed the 100 character limit, and to avoid error as described in [1195715/KB240619].',
      p_success_msg            => 'All attribute descriptions are within the 100 character limit',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_APPRVL_AME_ATTRIBUTE_DESC_GT_100_CHARS');
...
debug('begin add_signature: AME_APPR_GROUPS');
   l_info('##MASK##DESCRIPTION'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2289',
      p_sig_id                 => 'AME_APPR_GROUPS',
...
--           agr.description,
   ...
   l_info.delete;
debug('end add_signature: AME_APPR_GROUPS');
...
debug('begin add_signature: AME_RULES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2282',
      p_sig_id                 => 'AME_RULES',
   ...
   l_info.delete;
debug('end add_signature: AME_RULES');
...
debug('begin add_signature: AME_ACTION_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2286',
      p_sig_id                 => 'AME_ACTION_TYPES',
      p_sig_sql                => 'SELECT atc.order_number,
           at.name,
   ...
   l_info.delete;
debug('end add_signature: AME_ACTION_TYPES');
...
debug('begin add_signature: ISP_APPLICATION_INSTALL_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1756',
      p_sig_id                 => 'ISP_APPLICATION_INSTALL_DETAILS',
      p_sig_sql                => 'SELECT fav.application_name app_name, 
       fav.application_short_name app_s_name, 
       decode(fpi.status, ''I'', ''Yes'', 
                          ''S'', ''Shared'', 
...
AND fav.application_id = 177
order by 3',
      p_title                  => 'iSupplier Application Installation Details',
      p_fail_condition         => '[inst_status] in ['||mask_text(g_c_shared, nvl( upper(''), 'NO_MASK') )||','||mask_text(g_c_no, nvl( upper(''), 'NO_MASK') )||']',
      p_problem_descr          => 'iSupplier Portal is set as Shared installed or Not installed',
      p_solution               => '',
   ...
   l_info.delete;
debug('end add_signature: ISP_APPLICATION_INSTALL_DETAILS');



debug('begin add_signature: AP_APPLICATION_INSTALL_DETAILS');
   l_info('##SHOW_SQL##'):= 'N';
  add_signature(
      p_sig_repo_id            => '7231',
      p_sig_id                 => 'AP_APPLICATION_INSTALL_DETAILS',
      p_sig_sql                => 'SELECT fav.application_name app_name, 
fav.application_short_name app_s_name, 
decode(fpi.status, ''I'', ''Yes'', 
''S'', ''Shared'', 
...
FROM fnd_application_vl fav, fnd_product_installations fpi
WHERE fav.application_id = fpi.application_id
AND fav.application_id = 200
order by 3',
      p_title                  => 'Accounts Payable Application Installation Details',
      p_fail_condition         => '[inst_status] in ['||mask_text(g_c_shared, nvl( upper(''), 'NO_MASK') )||','||mask_text(g_c_no, nvl( upper(''), 'NO_MASK') )||']',
      p_problem_descr          => 'Accounts Payable (AP) is set as Shared installed or Not installed',
      p_solution               => '',
      p_success_msg            => 'Accounts Payable (AP) application installation status',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AP_APPLICATION_INSTALL_DETAILS');



debug('begin add_signature: ISP_USER_SECURING_ATTRIBUTES');
   l_info('##MASK##USER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1667',
      p_sig_id                 => 'ISP_USER_SECURING_ATTRIBUTES',
      p_sig_sql                => 'select  fu.user_name, ak.web_user_id, ak.attribute_code, ak.number_value, ak.created_by, ak.creation_date
  FROM ak_web_user_sec_attr_values ak, fnd_user fu
  where web_user_id in
(SELECT web_user_id
FROM ak_web_user_sec_attr_values
WHERE web_user_id in (SELECT user_id
FROM pos_supplier_users_v
WHERE vendor_id in (SELECT vendor_id
FROM ap_suppliers
WHERE vendor_id = ##$$SUPPLIERID$$##))
AND ak_web_user_sec_attr_values.ATTRIBUTE_APPLICATION_ID = 177
AND attribute_code  IN ( ''ICX_SUPPLIER_SITE_ID'' ,''ICX_SUPPLIER_CONTACT_ID'',''ICX_SUPPLIER_ORG_ID'')
and web_user_id not in (select web_user_id from ak_web_user_sec_attr_values where attribute_code = ''ICX_SUPPLIER_ORG_ID'')
GROUP BY web_user_id 
HAVING COUNT(*) < 3)
AND ak.ATTRIBUTE_APPLICATION_ID = 177
AND ak.web_user_id = fu.user_id',
      p_title                  => 'User level Securing Attributes',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Incorrect securing attributes defined at the User level.</br>
This setup could cause the Error:</br>
The set-up for the current user allows access beyond a single supplier hierarchy or its sites or contacts</p>

It is required that the following are assigned with values corresponding to the supplier:</p>

ICX_SUPPLIER_ORG_ID   MANDATORY / REQUIRED - This restricts the user to only the specific Supplier (and its child suppliers)</br>
ICX_SUPPLIER_SITE_ID   OPTIONAL - This restricts the user to only the specific Supplier Site(s) of this Supplier</br>
ICX_SUPPLIER_CONTACT_ID    OPTIONAL - This restricts the user to only transaction by the specified Supplier Contact(s) of this Supplier</p>

User <b>must</b> be created via the Supplier Registration process and cannot be created manually via System Administrator responsibility and then have the securing attributes added. This will not work and result in the same error reported above.',
      p_solution               => 'See [734466/KB307465] - Error Message At Login For Supplier User',
      p_success_msg            => 'The securing attributes are set correctly for all users for the supplier',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ISP_USER_SECURING_ATTRIBUTES');



debug('begin add_signature: ISP_QUERY_EXCEEDED_200_ROWS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4760',
      p_sig_id                 => 'ISP_QUERY_EXCEEDED_200_ROWS',
      p_sig_sql                => 'SELECT user_profile_option_name "Profile Option",
a.profile_option_value "Profile Value",
...
AND t.LANGUAGE = ''US''
AND c.language = ''US''
AND e.profile_option_name IN (''VO_MAX_FETCH_SIZE'')
AND (a.level_id = 10003 AND a.level_value = nvl(fnd_profile.value(''resp_id''), a.level_value))
AND a.profile_option_value IS NOT NULL
AND TO_NUMBER(REGEXP_SUBSTR(a.profile_option_value, ''^\d+'')) is not null
AND TO_NUMBER(REGEXP_SUBSTR(a.profile_option_value, ''^\d+'')) < 200
ORDER BY e.profile_option_name,a.level_id DESC',
      p_title                  => 'Query Has Exceeded 200 Rows',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Currently the profile FND: View Object Max Fetch Size is set to less than 200. The default value at installation time is 200. By increasing or decreasing the value for this profile will result in more or less records being displayed. It is suggested to only increase value in small increments as this profile can have a direct effect on system performance if increased dramatically.
',
      p_solution               => 'See [1241395/KB627117] How To Solve Error Query Has Exceeded 200 Rows, Potentially More Rows Exists, Please Restrict Your Query',
      p_success_msg            => 'Profile is set to seeded value of 200',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ISP_QUERY_EXCEEDED_200_ROWS');
...
BEGIN
  ...
  analyzer_title := 'Procurement iSupplier Analyzer';
...
start_section('Proactive Recommendations', 'Proactive_Recommendations');
   IF g_sql_tokens('##$$APPS_CHECK$$##') = 'Y' THEN
      set_item_result(run_stored_sig('ISP_QUERY_EXCEEDED_200_ROWS'));
   END IF;
   IF (substr(g_sql_tokens('##$$REL$$##'),1,4) = '12.2') THEN
      set_item_result(run_stored_sig('CHECK_WORKFLOW_HOT_FIX_FILE_CHECK'));
   END IF;
   set_item_result(check_rec_patches_1); /* Signature ISP_CHECK_REC */
   set_item_result(run_stored_sig('ISP_INVALID_OBJECTS'));
   set_item_result(run_stored_sig('OAF_PERSONALIZATIONS'));
   set_item_result(run_stored_sig('ISP_SHARED_INSTALL'));
...
debug('begin section: Document_Setup');
start_section('Document Setup', 'Document_Setup');
...
end_section;
debug('end section: Document_Setup');

debug('begin section: Supplier_Details');
IF p_supplier_id is not null and P_SUPPLIER_TYPE = 'EXISTING' THEN
   start_section('Supplier Details', 'Supplier_Details');
      set_item_result(run_stored_sig('ISP_SUPPLIER_DETAILS'));
      set_item_result(run_stored_sig('ISP_SUPPLIER_SITES'));
      set_item_result(run_stored_sig('ISP_SUPPLIER_ADDRESSES'));
      set_item_result(run_stored_sig('ISP_SUPPLIER_CONTACTS'));
      set_item_result(run_stored_sig('ISP_SUPPLIER_USERS'));
      set_item_result(run_stored_sig('ISP_SUPPLIER_USER_RESPONSIBILITIES'));
      set_item_result(run_stored_sig('POS_SUPPLIER_REGISTRATIONS'));
      set_item_result(run_stored_sig('ERROR_CREATING_CONTACT_IN_ISUPPLIER'));
      set_item_result(run_stored_sig('EBS_MFG_ISPGS_DUPLICATE_SUPPLIERS_WITH_SAME_EMPLOYEE_ID'));
   end_section;
END IF;
debug('end section: Supplier_Details');

debug('begin section: Supplier_Checks');
start_section('Supplier Setup / Configuration', 'Supplier_Checks');
   set_item_result(run_stored_sig('ISP_EXTERNAL_RESPONSIBILTY'));
   set_item_result(run_stored_sig('ISP_POS_EMPLOYMENT_INACTIVE'));
   IF p_supplier_id is not null THEN
      set_item_result(run_stored_sig('ISP_USER_SECURING_ATTRIBUTES'));
   END IF;
   set_item_result(run_stored_sig('ISP_INCORRECT_RESPONSIBILITY_BUYER'));
   set_item_result(run_stored_sig('ISP_GUEST_RESPONSIBILITY'));
   set_item_result(run_stored_sig('ISP_GUEST_USER_RESPONSIBILITY'));
   set_item_result(run_stored_sig('ISP_ARCHIVE_ON_APPROVE'));
   set_item_result(run_stored_sig('ISP_ARCHIVE_ON_PRINT'));
   set_item_result(run_stored_sig('EBS_MFG_ISPGS_ARCHIVED_PO_COUNT'));
   set_item_result(run_stored_sig('ISP_EXTERNAL_PROFILES'));
   set_item_result(run_stored_sig('ISP_UNDEFINED_EXTERNAL_PROFILES'));
   set_item_result(run_stored_sig('ISP_RESP_SECURING_ATTRIBUTES'));
   set_item_result(run_stored_sig('EBS_MFG_ISPGS_SUPPLIER_ONBOARDING_CONFIGURATION'));
   set_item_result(run_stored_sig('EBS_MFG_ISPGS_SUPPLIER_ONBOARDING_ATTRIBUTE_PAGE'));
   set_item_result(run_stored_sig('EBS_MFG_ISPGS_SUPPLIER_ONBOARDING_RFI_TEMPLATE'));
   set_item_result(run_stored_sig('EBS_MFG_ISPGS_SUPPLIER_ONBOARDING_SURVEY'));
   set_item_result(run_stored_sig('EBS_MFG_ISPGS_UDA_INFO_PROSPECTIVE_SUPPLIER'));
   set_item_result(run_stored_sig('EBS_MFG_ISPGS_UDA_INFO_REGISTERED_SUPPLIER'));
end_section;
debug('end section: Supplier_Checks');

debug('begin section: DMZ');
start_section('DMZ', 'DMZ');
   set_item_result(run_stored_sig('ISP_DMZ_ENABLED'));
   set_item_result(run_stored_sig('ISP_DMZ_FND_NODES'));
   set_item_result(run_stored_sig('ISP_DMZ_ORPHANED_PROFILES'));
   set_item_result(run_stored_sig('ISP_DMZ_SERVER_LOGGED_INTO'));
   set_item_result(run_stored_sig('ISP_DMZ_TRUST_PROFILES'));
   set_item_result(run_stored_sig('ISP_DMZ_SPECIFC_PROFILES'));
end_section;
debug('end section: DMZ');

debug('begin section: Workflow');
IF p_supplier_id is not null THEN
   start_section('Workflow', 'Workflow');
      set_item_result(run_stored_sig('POS_WORKFLOW_POSSPM1'));
      set_item_result(run_stored_sig('POS_WORKFLOW_POSSPM1_WFSTAT'));
      set_item_result(run_stored_sig('POS_WORKFLOW_POSSPM1_NOTIF'));
      set_item_result(run_stored_sig('POS_WORKFLOW_POSSPAPP'));
      set_item_result(run_stored_sig('POS_WORKFLOW_POSSPAPP_WFSTAT'));
      set_item_result(run_stored_sig('POS_WORKFLOW_POSSPAPP_NOTIF'));
      set_item_result(run_stored_sig('POS_WORKFLOW_POSREGV2'));
      set_item_result(run_stored_sig('2439127.1 SUPPLIER REGISTRATION APPROVAL ERROR 3146 COMMIT'));
      set_item_result(run_stored_sig('EBS_MFG_ISPGS_SUPPLIER_REGISTRATION_STATUS_PENDING_APPROVAL'));
   end_section;
END IF;
debug('end section: Workflow');

debug('begin section: Registration');
IF p_supplier_id is not null and P_SUPPLIER_TYPE = 'REGISTERED' THEN
   start_section('Registration', 'Registration');
      set_item_result(run_stored_sig('POS_REG_ADDR_REQUESTS'));
      set_item_result(run_stored_sig('POS_REG_CONTACT_REQUESTS'));
      set_item_result(run_stored_sig('POS_REG_CONT_ADDR_REQUESTS'));
      set_item_result(run_stored_sig('POS_REG_BUSINESS_CLASS_REQUESTS'));
      set_item_result(run_stored_sig('POS_REG_BANK_ACCOUNT_REQUESTS'));
      set_item_result(run_stored_sig('POS_REG_PRODUCT_SERVICE_REQUESTS'));
      set_item_result(run_stored_sig('POS_SUPPLIER_REGISTRATIONS'));
      set_item_result(run_stored_sig('EBS_MFG_ISPGS_REGISTRATION_POS_ACTION_HISTORY'));
      set_item_result(run_stored_sig('ISP_REG_SUPPLIER_SURVEY_REQUESTS'));
      set_item_result(run_stored_sig('ISP_REG_SUPPLIER_PROFILE_ATTRIBUTES'));
   end_section;
END IF;
debug('end section: Registration');
...
IF g_use_ame = 'true' THEN
   start_section('AME', 'AME');
      ...
      set_item_result(run_stored_sig('EBS_MFG_PO_AME_NON_MANDATORY_ATTR'));
      set_item_result(run_stored_sig('AME_ITEM_CLASSES'));
      set_item_result(run_stored_sig('AME_IC_ATTR'));
      set_item_result(run_stored_sig('EBS_MFG_PO_APPRVL_AME_ATTRIBUTE_DESC_GT_100_CHARS'));
...
IF g_sql_tokens('##$$APPS_CHECK$$##') = 'Y' THEN
   start_section('Diagnostic Apps Check', 'Diagnostic_Apps_Check');
      ...
      set_item_result(run_stored_sig('ISP_APPLICATION_INSTALL_DETAILS'));
      set_item_result(run_stored_sig('AP_APPLICATION_INSTALL_DETAILS'));
   end_section;
END IF;
...
IF (g_sql_tokens('##$$REL$$##') IS NOT NULL) THEN
   start_section('Procurement Code Level', 'Procurement_Code_Level');
      IF (substr(g_sql_tokens('##$$REL$$##'),1,4) = '12.0') THEN
         set_item_result(check_rec_patches_2); /* Signature RUP_PROC_CODE_LEVEL_12_0 */
      END IF;
      IF (substr(g_sql_tokens('##$$REL$$##'),1,4) = '12.1') THEN
         set_item_result(check_rec_patches_3); /* Signature RUP_PROC_CODE_LEVEL_12_1 */
      END IF;
      IF (substr(g_sql_tokens('##$$REL$$##'),1,4) = '12.2') THEN
         set_item_result(check_rec_patches_4); /* Signature RUP_PROC_CODE_LEVEL_12_2 */
      END IF;
   end_section;
END IF;
