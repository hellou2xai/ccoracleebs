...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Procurement Sourcing Analyzer          |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE pon_sourcing_analyzer_pkg AUTHID DEFINER AS
...
PROCEDURE main
(            p_negotiation_number           IN NUMBER      DEFAULT NULL
           ,p_round_number                 IN NUMBER      DEFAULT NULL
           ,p_line_number                  IN NUMBER      DEFAULT NULL
           ,p_bid_number                   IN NUMBER      DEFAULT NULL
           ,p_bid_line_number              IN NUMBER      DEFAULT NULL
           ,p_bidding_supplier             IN VARCHAR2    DEFAULT NULL
...
END pon_sourcing_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY pon_sourcing_analyzer_pkg AS
-- $Id: pon_sourcing_analyzer.sql, 200.24 2026/01/27 13:34:25 dfelton Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2327735.1));
...
-- Needed for AME functionality
  g_use_ame            VARCHAR2(5);

-- Check if table PON_BID_PO_HISTORY exists
  g_ponbidpohistory    VARCHAR2(5);
-- Check if column AME_TRANSACTION_ID exists in PON_AUCTION_HEADERS_ALL
  g_ponametransid   VARCHAR2(5);
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'POPONANALYZER_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'POPONANALYZER_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>POPONANALYZER Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2327735.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/pon_sourcing_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1395,EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1395,EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1395,EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4097751" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">1395</span>
...
<p>Version 200.24</p><ul><li>Fix Knowledge Article links to match Fusion Service references</li>
<li>Include Framework improvements</li>
</ul>
<p>Version 200.23</p><ul><li>Updated sequence checks</li>
<li>Include Framework improvements for move to Fusion Service</li>
</ul>
<p>Version 200.22</p><ul><li>Added check for - Multiple Terms and Conditions exist for Operating Unit per issue described in Doc ID 1524152.1</li>
<li>Include framework and other general updates</li>
</ul>
<p>Version200.21</p><ul><li>Updated code to retrieve application_id from ame_calling_applications for only the latest active record, to avoid ORA-01422: exact fetch returns more than requested number of rows when validating parameters entered</li>
<li>Include Framework improvements and sequence check improvements</li>
</ul>
<p>Version 200.20</p><ul><li>Added an ERROR check signature for WF_ITEM_ATTRIBUTE_VALUES missing for PONAUCT workflow per Doc ID 2566992.1</li>
<li>Added Terms and Conditions (from PON_CONTRACTS and PON_CONTRACTS_TL tables) in Sourcing Related Setups section</li>
<li>Added Check for Need By Date on Awarded PO is different than Need By Date on backing Requisition Lines (All PO Shipments have same Need By Date rather than different Need By Dates per the corresponding backing requisition Line)</li>
<li>Include Apps Check and Framework improvements</li>
</ul>
<p>Version 200.19</p><ul><li>Improve the AME Details</li>
<li>Improve Team Members data checks</li>
<li>Improve sequence checks in "Lifetime Support Policy" to check differently in 12c vs 11g</li>
<li>Include Apps Check and Framework updates</li>
</ul>
<p>Version 200.18</p><ul><li>Renamed "Lifetime Support Policy” section as “Critical Alerts” and added sequence checks</li>
<li>In AME Information section, under AME Rules / AME Rule Actions, list the AME Approval Groups for AME Rule + Approval Group Items. &nbsp;This will show the Rules and approval groups, and approvers for this specific transaction.</li>
<li>Include Apps Check and Framework updates</li>
</ul>
<p>Version 200.17</p><ul><li>Added checks to verify AME condition and attribute descriptions do not exceed 100 character limit</li>
</ul>
<p>Version 200.16</p><ul><li>Updated the SQL in AC_PATCHES_APPLIED to include Language, Applied Flag is Y and truncated creation date to eliminate duplicates.</li>
<li>Improve AME Approval Groups details</li>
<li>Implement improvements to signatures shared across multiple analyzers</li>
<li>Implement analyzer framework updates</li>
</ul>
<p>Version 200.15</p><ul><li>Remove tablespace check for tablespace nearing max extents. &nbsp;DBAs have other tools to monitor for this, and this check is causing performance issues for some customers when running the analyzer - analyzer never completes. &nbsp;Therefore we are removing this from the analyzer.</li>
</ul>
<p>Version 200.14</p><ul><li>Add ame approval group id to AME Rule Actions</li>
<li>Include Analyzer Framework updates</li>
</ul>
<p>Version 200.13</p><ul><li>Add AME exception log data for Negotiation Approval</li>
<li>Expand all AME signatures to gather data for both Award Approval (as in previous versions) as well as Negotiation Approval (introduced in Apps release 12.2.9)</li>
<li>Replace - Recommended Critical Workflow Patch - signature with new and improved signature</li>
</ul>
<p>Version 200.12</p><ul><li>Implemented framework improvements as well as internal improvements to some information signatures</li>
</ul>
<p>&nbsp;</p><p>&nbsp;</p>
            <br><br>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1395,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1395,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1395,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
FUNCTION check_rec_patches_1 RETURN VARCHAR2 IS
  /* Signature PON_RECOMMENDED_PATCHES_CREATE_PO_OR_BPA_FROM_NEGOTIATION */
...
BEGIN
    ...
    print_log('Processing recommended patches signature: PON_RECOMMENDED_PATCHES_CREATE_PO_OR_BPA_FROM_NEGOTIATION (check_rec_patches_1) "Recommended Patches for Sourcing - Create Purchasing Document From Negotiation" (version 5)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(1)(l_rows) := '26234576';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'In Sourcing BPAs are created using staggered award the lines from the first award also added to the BPA created for the second award';
   l_col_rows(5)(l_rows) := '[2395671.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '23495191';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'In Oracle Sourcing this patch resolved the issue of delegated approval, does not change the document to approved';
   l_col_rows(5)(l_rows) := '[2395671.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25514126';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'In Oracle Purchasing, Complex PO with Schedules Style Award Created from RFQ had incorrect data.';
   l_col_rows(5)(l_rows) := '[2395671.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '24651449';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R.TST1224AUG16RUP:GETTING ERROR ON COMPLETE AWARD';
   l_col_rows(5)(l_rows) := '[2395671.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25799075';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'In Oracle Sourcing, this patch fixes the issue of error in completing award with alternate line and staggered awarding';
   l_col_rows(5)(l_rows) := '[2395671.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21821882';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'In Oracle Sourcing this patch resolves the issue of BPA creation failing';
   l_col_rows(5)(l_rows) := '[2395671.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26708807';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'In Sourcing this patch fixes the issue of Timeout reminder notifications are delivered to removed approvers';
   l_col_rows(5)(l_rows) := '[2395671.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21878033';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'In Oracle Purchasing , Autocreating a requisition having more number of lines is ending with internal server error';
   l_col_rows(5)(l_rows) := '[2395671.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '27646037';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'In Sourcing this patch fixes the issue of PO creation failure for negotiation with requirements and when the system language is multibyte like Arabic';
   l_col_rows(5)(l_rows) := '[2395671.1]';
...
END IF;
   ...
   l_sig.sigrepo_id := '10648';
   l_sig.title := 'Recommended Patches for Sourcing - Create Purchasing Document From Negotiation';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := 'There are recommended patches for Sourcing that are not applied to this environment.  These patches fix issues that occur when attempting to create an awarded Negotiation onto a Purchase Order or Agreement, such as Purchase Order could not be initiated and other related errors and issues. Please expand the list above for the details.';
   l_sig.solution := 'Above are the recommended patches for this specific functional area within Sourcing of creating awarded Negotiations into Purchase Orders and Agreements.  For the most current general patching recommendations, use the Patch Wizard or the Updates & Patches Tab in My Oracle Support.  Further guidance can be found in the following documents:
<ul>
...
This will help avoid known issues, prevent potential data corruption and provide the latest features and functionality. Having a proactive patching plan and periodic proactive patching process in place are the best ways to stay current.<br>

</ul>';
   l_sig.success_msg := 'There are no patches recommended patches for your release of Sourcing related to creating awarded Negotiations into Purchase Orders and Agreements.';
  ...
  -- Register
  l_step := '60';
  g_signatures('PON_RECOMMENDED_PATCHES_CREATE_PO_OR_BPA_FROM_NEGOTIATION') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'PON_RECOMMENDED_PATCHES_CREATE_PO_OR_BPA_FROM_NEGOTIATION',     -- sig ID
...
FUNCTION check_rec_patches_2 RETURN VARCHAR2 IS
  /* Signature PON_RECOMMENDED_PATCHES_PRC */
  l_col_rows   COL_LIST_TBL := col_list_tbl(); -- Row values
  l_rel_rows   COL_LIST_TBL := col_list_tbl(); -- Row release
  l_hdr        VARCHAR_TBL  := varchar_tbl(); -- Column headings
  l_app_date   DATE;         -- Patch applied date
...
BEGIN
    ...
    print_log('Processing recommended patches signature: PON_RECOMMENDED_PATCHES_PRC (check_rec_patches_2) "Recommended Patches for Procurement" (version 30)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.PRC_PF.C.delta.4 - included in 12.2.5 and higher';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.PRC_PF.C.delta.12 - included in R12.2.12 and higher';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Procurement Recommended Patch Collection (March 2015)';
   l_col_rows(5)(l_rows) := '[1984257.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.0' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '7291081';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.PRC_PF.A.delta.6';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.0 PRC Update Aug 2009';
...
END IF;
   ...
   l_sig.sigrepo_id := '9554';
   l_sig.title := 'Recommended Patches for Procurement';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := 'There are recommended update patches or new release patches for Procurement that are not applied to this environment. Please expand the list above for the details.';
   l_sig.solution := 'Above are the recommended update patches or new release patches for this product area.  For the most current recommendations, use the Patch Wizard or the Updates & Patches Tab in My Oracle Support.  Further guidance can be found in the following documents:
<ul>
<li>[222339/KB370175] Procurement Family Patch Release History (Including Latest Available Rollups)(KB370175)</li>
<li>[11086538/KA747] How to Find E-Business & E-Business Suite Technology Stack Patches (KA747)</li>
<li>[976188/KB739927] Patch Wizard Utility (KB739927)</li>
...
Best Practice: Always ensure that you are on the latest code with all recommended patches applied. <br>
This will help avoid known issues, prevent potential data corruption and provide the latest features and functionality. Having a proactive patching plan and periodic proactive patching process in place are the best ways to stay current.<br>';
   l_sig.success_msg := 'There are no update patches or new release patches recommended for Procurement at this time.';
   l_sig.print_condition := 'FAILURE';
   l_sig.fail_type := 'W';
   l_sig.print_sql_output := 'RS';
   l_sig.limit_rows := 'Y';
  ...
  -- Register
  l_step := '60';
  g_signatures('PON_RECOMMENDED_PATCHES_PRC') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'PON_RECOMMENDED_PATCHES_PRC',     -- sig ID
    l_sig,                              -- signature information
    l_col_rows,                         -- data
    l_hdr);                             -- headers
...
FUNCTION check_rec_patches_3 RETURN VARCHAR2 IS
  /* Signature PON_RECOMMENDED_PATCHES_FND */
  l_col_rows   COL_LIST_TBL := col_list_tbl(); -- Row values
  l_rel_rows   COL_LIST_TBL := col_list_tbl(); -- Row release
  l_hdr        VARCHAR_TBL  := varchar_tbl(); -- Column headings
  l_app_date   DATE;         -- Patch applied date
...
BEGIN
    ...
    print_log('Processing recommended patches signature: PON_RECOMMENDED_PATCHES_FND (check_rec_patches_3) "Recommended Patches for E-Business Suite" (version 23)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle E-Business Suite 12.2.4 Release Update Pack - included in 12.2.5 and higher';
   l_col_rows(5)(l_rows) := '[1617458.1]';
...
END IF;
   ...
   l_sig.sigrepo_id := '9555';
   l_sig.title := 'Recommended Patches for E-Business Suite';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := 'There are recommended update patches or new release patches for E-Business Suite that are not applied to this environment. Please expand the list above for the details.';
   l_sig.solution := 'Above are the recommended update patches or new release patches for this product area.  For the most current recommendations, use the Patch Wizard or the Updates & Patches Tab in My Oracle Support.  Further guidance can be found in the following documents:
<ul>
<li>[11086538/KA747] How to Find E-Business & E-Business Suite Technology Stack Patches (KA747)</li>
<li>[976188/KB739927] Patch Wizard Utility (KB739927)</li>
...
Best Practice: Always ensure that you are on the latest code with all recommended patches applied. <br>
This will help avoid known issues, prevent potential data corruption and provide the latest features and functionality. Having a proactive patching plan and periodic proactive patching process in place are the best ways to stay current.<br>';
   l_sig.success_msg := 'There are no update patches or new release patches recommended for E-Business Suite at this time.';
   l_sig.print_condition := 'FAILURE';
   l_sig.fail_type := 'W';
   l_sig.print_sql_output := 'RS';
   l_sig.limit_rows := 'Y';
  ...
  -- Register
  l_step := '60';
  g_signatures('PON_RECOMMENDED_PATCHES_FND') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'PON_RECOMMENDED_PATCHES_FND',     -- sig ID
    l_sig,                              -- signature information
    l_col_rows,                         -- data
    l_hdr);                             -- headers
...
FUNCTION check_rec_patches_4 RETURN VARCHAR2 IS
  /* Signature PON_RECOMMENDED_PATCHES */
  l_col_rows   COL_LIST_TBL := col_list_tbl(); -- Row values
  l_rel_rows   COL_LIST_TBL := col_list_tbl(); -- Row release
  l_hdr        VARCHAR_TBL  := varchar_tbl(); -- Column headings
  l_app_date   DATE;         -- Patch applied date
...
BEGIN
    ...
    print_log('Processing recommended patches signature: PON_RECOMMENDED_PATCHES (check_rec_patches_4) "Recommended Patches for Sourcing" (version 16)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'SOURCING ISP SLM RUP NOV 2016';
...
END IF;
   ...
   l_sig.sigrepo_id := '9506';
   l_sig.title := 'Recommended Patches for Sourcing';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := 'There are recommended update patches or new release patches for Sourcing that are not applied to this environment. Please expand the list above for the details.';
   l_sig.solution := 'Above are the recommended update patches or new release patches for this product area.  For the most current recommendations, use the Patch Wizard or the Updates & Patches Tab in My Oracle Support.  Further guidance can be found in the following documents:
<ul>
<li>[222339/KB370175] Procurement Family Patch Release History (Including Latest Available Rollups)(KB370175)</li>
<li>[11086538/KA747] How to Find E-Business & E-Business Suite Technology Stack Patches (KA747)</li>
...
This will help avoid known issues, prevent potential data corruption and provide the latest features and functionality. Having a proactive patching plan and periodic proactive patching process in place are the best ways to stay current.<br>
   ...
   l_sig.success_msg := 'There are no update patches or new release patches recommended for Sourcing at this time.';
   l_sig.print_condition := 'FAILURE';
   l_sig.fail_type := 'W';
   l_sig.print_sql_output := 'RS';
   l_sig.limit_rows := 'Y';
  ...
  -- Register
  l_step := '60';
  g_signatures('PON_RECOMMENDED_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'PON_RECOMMENDED_PATCHES',     -- sig ID
    l_sig,                              -- signature information
    l_col_rows,                         -- data
    l_hdr);                             -- headers
...
----------------------------------------------------------------
  l_negotiation_number NUMBER;
  l_org_id NUMBER;
  l_round_number NUMBER;
  l_line_number NUMBER;
  l_bid_number NUMBER;
  l_bid_line_number NUMBER;
  l_bidding_supplier VARCHAR2(200);
  l_app_path_id       NUMBER;

l_DBbanner                      VARCHAR2(255);

-- Needed for AME functionality
  l_ame_app_id          NUMBER; -- for AWARD approval AME_TRANSACTION_TYPE from pon_auction_headers_all = PON_NEGOTIATION_AWARD
  l_ame_trx_id          VARCHAR2(50); -- for AWARD_APPR_AME_TRANS_ID from pon_auction_headers_all
-- Added below two on 10-JUL-2023 for version 200.13
  l_ame_app_id2NEG          NUMBER; -- for Negotiation approval AME_TRANSACTION_TYPE from pon_auction_headers_all = NEGOTIATION_APPRV
  l_ame_trx_id2NEG          VARCHAR2(50); -- for AME_TRANSACTION_ID from pon_auction_headers_all
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Negotiation number (without Round or Amendment suffix)';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_negotiation_number,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Round number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_round_number,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Negotiation Line number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_line_number,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Bid / Quote number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_bid_number,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Bid / Quote Line number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_bid_line_number,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Supplier (partial or full supplier name)';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_bidding_supplier,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/01/27 13:34:24 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'pon_sourcing_analyzer.sql';
...
debug('begin parameter validation: p_negotiation_number');
IF p_negotiation_number IS NOT NULL THEN
BEGIN
SELECT AUCTION_HEADER_ID_ORIG_ROUND
INTO l_exists_val
FROM PON_AUCTION_HEADERS_ALL, HR_OPERATING_UNITS
WHERE AUCTION_HEADER_ID_ORIG_ROUND = p_negotiation_number
 AND PON_AUCTION_HEADERS_ALL.org_id = HR_OPERATING_UNITS.organization_id
and (mo_global.is_mo_init_done = 'N' or mo_global.check_access(HR_OPERATING_UNITS.organization_id) = 'Y')
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Negotiation number not found, or does not belong to organization accessible from the current responsibility');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_negotiation_number failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_negotiation_number');

debug('begin parameter validation: p_round_number');
IF p_round_number IS NOT NULL THEN
BEGIN
SELECT AUCTION_ROUND_NUMBER
INTO l_exists_val
FROM PON_AUCTION_HEADERS_ALL
WHERE AUCTION_ROUND_NUMBER = p_round_number
 AND auction_header_id_orig_round = p_negotiation_number
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Specified Round number does not exist for this Negotiation.  Leave blank if Round is not applicable or to see data for all rounds for the Negotiation.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_round_number failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_round_number');

debug('begin parameter validation: p_line_number');
IF p_line_number IS NOT NULL THEN
BEGIN
SELECT LINE_NUMBER
INTO l_exists_val
FROM PON_AUCTION_ITEM_PRICES_ALL PAIPA, PON_AUCTION_HEADERS_ALL PAHA
WHERE LINE_NUMBER = p_line_number
 AND PAIPA.auction_header_id = PAHA.auction_header_id
and PAHA.auction_header_id_orig_round = p_negotiation_number
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Negotiation line number not found for this negotiation number');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_line_number failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_line_number');

debug('begin parameter validation: p_bid_number');
IF p_bid_number IS NOT NULL THEN
BEGIN
SELECT BID_NUMBER
INTO l_exists_val
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Bid number not found for this negotiation');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_bid_number failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_bid_number');

debug('begin parameter validation: p_bid_line_number');
IF p_bid_line_number IS NOT NULL THEN
BEGIN
SELECT LINE_NUMBER
INTO l_exists_val
FROM PON_BID_ITEM_PRICES PBIP, PON_AUCTION_HEADERS_ALL PAHA
WHERE LINE_NUMBER = p_bid_line_number
 AND PBIP.bid_number = p_bid_number
and PBIP.auction_header_id = PAHA.auction_header_id 
and PAHA.auction_header_id_orig_round = p_negotiation_number
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Bid / Quote Line number not found for this Negotiation');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_bid_line_number failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_bid_line_number');
...
IF p_negotiation_number is not null then
  BEGIN
      SELECT distinct auction_header_id_orig_round, org_id
      INTO   l_negotiation_number, l_org_id
      FROM   PON_AUCTION_HEADERS_ALL
      WHERE  auction_header_id_orig_round = p_negotiation_number;
  EXCEPTION WHEN NO_DATA_FOUND THEN
    print_log('Invalid Negotiation Number specified. '||
      'The Negotiation Number parameter is not a valid Negotiation Number.');
      l_negotiation_number := 0;
    raise invalid_parameters; 
  END;
  ELSE
    print_log('No Negotiation Number specified. '||
      'Negotiation Number is optional.');
    l_negotiation_number := 0;
  END IF;
...
IF p_round_number is not null then
  BEGIN
      SELECT distinct auction_round_number
      INTO   l_round_number
      FROM   PON_AUCTION_HEADERS_ALL
      WHERE  auction_round_number = p_round_number
             and auction_header_id_orig_round = p_negotiation_number;
  EXCEPTION WHEN NO_DATA_FOUND THEN
    print_log('Invalid Negotiation Round number specified. '||
      'The Negotiation Round number parameter is not a valid Round number for this Negotiation.');
    raise invalid_parameters; 
  END;
  ELSE
    print_log('No Negotiation Round number specified. '||
      'Negotiation Round number is optional.');
  END IF;

l_step := '40';
IF p_line_number is not null then
  BEGIN
      SELECT distinct PAIPA.line_number
      INTO l_line_number
      FROM   PON_AUCTION_ITEM_PRICES_ALL PAIPA, PON_AUCTION_HEADERS_ALL PAHA
      WHERE  PAIPA.line_number = p_line_number
      and PAIPA.auction_header_id = PAHA.auction_header_id
      and PAHA.auction_header_id_orig_round = p_negotiation_number;
  EXCEPTION WHEN NO_DATA_FOUND THEN
    print_log('Invalid Negotiation Line Number specified. '||
      'The Negotiation Line Number parameter is not valid for the specified Negotiation Number.');
    raise invalid_parameters; 
  END;
  ELSE
    print_log('No Negotiation Line Number specified. '||
      'Negotiation Line Number is optional.');
  END IF;
...
IF p_bid_number is not null then
  BEGIN
      ...
      and PAHA.auction_header_id_orig_round = p_negotiation_number;
  EXCEPTION WHEN NO_DATA_FOUND THEN
    print_log('Invalid Bid / Quote Number specified. '||
      'The Bid / Quote Number parameter is not valid for the specified Negotiation Number.');
    raise invalid_parameters; 
  END;
  ELSE
    print_log('No Bid / Quote Number specified. '||
      'Bid / Quote Number is optional.');
  END IF;

l_step := '55';
IF p_bidding_supplier is not null then
  BEGIN
      SELECT concat(concat('%',upper(p_bidding_supplier)),'%')
      INTO   l_bidding_supplier
      FROM   PON_BID_HEADERS PBH, PON_AUCTION_HEADERS_ALL PAHA
      WHERE  upper(pbh.trading_partner_name) like concat(concat('%',upper(p_bidding_supplier)),'%')
      and PBH.auction_header_id = PAHA.auction_header_id 
      and PAHA.auction_header_id_orig_round = p_negotiation_number;
  EXCEPTION WHEN NO_DATA_FOUND THEN
    print_log('There is no Bid / Quote submitted by any similar Supplier Name for this Negotiation. '||
      'There is no Bid / Quote submitted by any similar Supplier Name for this Negotiation / Line.');
    raise invalid_parameters; 
  END;
  ELSE
    print_log('No Bidding Supplier specified. '||
      'Bidding Supplier is optional.');
  END IF;
...
IF p_bid_line_number is not null then
  BEGIN
      ...
      INTO   l_bid_line_number
      FROM   PON_BID_ITEM_PRICES PBIP, PON_AUCTION_HEADERS_ALL PAHA
      WHERE  PBIP.line_number = p_bid_line_number
      and PBIP.bid_number = p_bid_number
      and PBIP.auction_header_id = PAHA.auction_header_id 
      and PAHA.auction_header_id_orig_round = p_negotiation_number;
  EXCEPTION WHEN NO_DATA_FOUND THEN
    print_log('Invalid Bid / Quote Line Number specified. '||
      'The Bid / Quote Line Number parameter is not valid for the specified Negotiation / Line / Bid.');
    raise invalid_parameters; 
  END;
  ELSE
    print_log('No Bid / Quote Line Number specified. '||
      'Bid / Quote Line Number is optional.');
  END IF;



-- Get AME information for Sourcing

l_step := '70';
g_use_ame := 'true';
l_ame_app_id := 0;

IF l_ame_app_id = 0 THEN
 BEGIN
   SELECT DECODE(fpov.profile_option_value,'Y','true','N','false') use_ame_profile 
   INTO g_use_ame
   ...
   AND TRUNC(fpo.start_date_active) <= SYSDATE 
   AND (UPPER(fpot.user_profile_option_name) like UPPER('PON: Enable Sourcing Award Approval')  
   AND fpot.language = 'US') 
   AND (fpov.level_id IN (10001));
   print_log('PON: Enable Sourcing Award Approval = '||g_use_ame||'.');
 EXCEPTION WHEN NO_DATA_FOUND THEN
   g_use_ame := 'false';
 END;
END IF; 
...
BEGIN
 SELECT aca.application_id 
      ...
      where aca.fnd_application_id = 396 and aca.transaction_type_id = 'PON_NEGOTIATION_AWARD';
      print_log('AME: Application ID is '||l_ame_app_id||' for FND_APPLICATION 396 (Sourcing) transaction type PON_NEGOTIATION_AWARD.');
 EXCEPTION WHEN NO_DATA_FOUND THEN
   l_ame_app_id:= 0;
END;
IF l_ame_app_id = 0
THEN
  BEGIN
        print_log('AME: Could not find AME Application ID for FND_APPLICATION 396 transaction type PON_NEGOTIATION_AWARD.') ;
        g_use_ame := 'false';     
  END;
END IF;
...
BEGIN
 SELECT aca.application_id 
      INTO l_ame_app_id2NEG
      FROM ame_calling_apps aca
      where aca.fnd_application_id = 396 and aca.transaction_type_id = 'NEGOTIATION_APPRV' 
      and aca.end_date > sysdate; -- AF request id 229887
      print_log('AME: Application ID is '||l_ame_app_id2NEG||' for FND_APPLICATION 396 (Sourcing) transaction type NEGOTIATION_APPRV.');
 EXCEPTION WHEN NO_DATA_FOUND THEN
   l_ame_app_id2NEG := 0;
END;
...
-- added 6/6/2023
l_step := '76';
IF l_negotiation_number is not null and l_ame_app_id <> 0 then
  BEGIN
      SELECT substr(NVL(max(AWARD_APPR_AME_TRANS_ID),'0'),1,50) award_appr_ame_trans_id INTO   l_ame_trx_id
      FROM   PON_AUCTION_HEADERS_ALL
      WHERE  auction_header_id_orig_round = p_negotiation_number;
  END;
END IF;
...
g_ponametransid := 'false';
print_log('Checking if column AME_TRANSACTION_ID exists in table PON_AUCTION_HEADERS_ALL');

BEGIN
 SELECT 'true'
    INTO g_ponametransid
    FROM dba_tab_cols where column_name = 'AME_TRANSACTION_ID' and table_name = 'PON_AUCTION_HEADERS_ALL';
  EXCEPTION WHEN NO_DATA_FOUND THEN
    g_ponametransid := 'false';
    print_log('Column AME_TRANSACTION_ID for AME Negotiation Approval does not exist in PON_AUCTION_HEADERS_ALL table - usually because 12.2.8 and lower');
END;

l_ame_trx_id2NEG := 0;
l_step := '79';
IF l_negotiation_number is not null and l_ame_app_id2NEG <> 0 and g_ponametransid = 'true' then
  BEGIN
      execute immediate 
      ('SELECT substr(NVL(max(AME_TRANSACTION_ID),''0''),1,50)
      FROM   PON_AUCTION_HEADERS_ALL
      WHERE  auction_header_id_orig_round = ' || p_negotiation_number) INTO l_ame_trx_id2NEG;
      EXCEPTION WHEN NO_DATA_FOUND THEN
      print_log('No value for AME_TRANSACTION_ID for this Negotiation for AME based Negotiation Approval');
  END;
END IF;

IF l_ame_trx_id > 1 or l_ame_trx_id2NEG > 1
THEN
  g_use_ame := 'true';
END IF;
...
BEGIN
 SELECT 'true'
    INTO g_ponbidpohistory
    FROM dba_tables where table_name = 'PON_BID_PO_HISTORY';
    print_log('Checking if PON_BID_PO_HISTORY table exists');
  EXCEPTION WHEN NO_DATA_FOUND THEN
    g_ponbidpohistory := 'false';
    print_log('PON_BID_PO_HISTORY table does not exist - usually because 12.2.7 and lower');
END;
...
debug('begin populate sql tokens hash table');
   ...
   g_sql_tokens('##$$AUCTION_HEADER_ID$$##') := l_negotiation_number;
   g_masked_tokens('##$$AUCTION_HEADER_ID$$##') := mask_text( g_sql_tokens('##$$AUCTION_HEADER_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$LINE_NUMBER$$##') := l_line_number;
   g_masked_tokens('##$$LINE_NUMBER$$##') := mask_text( g_sql_tokens('##$$LINE_NUMBER$$##'), 'NO_MASK');
   g_sql_tokens('##$$BID_NUMBER$$##') := l_bid_number;
   g_masked_tokens('##$$BID_NUMBER$$##') := mask_text( g_sql_tokens('##$$BID_NUMBER$$##'), 'NO_MASK');
   g_sql_tokens('##$$BID_LINE_NUMBER$$##') := l_bid_line_number;
   g_masked_tokens('##$$BID_LINE_NUMBER$$##') := mask_text( g_sql_tokens('##$$BID_LINE_NUMBER$$##'), 'NO_MASK');
   g_sql_tokens('##$$BIDDING_SUPPLIER$$##') := l_bidding_supplier;
   g_masked_tokens('##$$BIDDING_SUPPLIER$$##') := mask_text( g_sql_tokens('##$$BIDDING_SUPPLIER$$##'), 'NO_MASK');
   g_sql_tokens('##$$ROUND_NUMBER$$##') := l_round_number;
   g_masked_tokens('##$$ROUND_NUMBER$$##') := mask_text( g_sql_tokens('##$$ROUND_NUMBER$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPATH$$##') := nvl(to_char(l_app_path_id),'NULL');
   g_masked_tokens('##$$APPATH$$##') := mask_text( g_sql_tokens('##$$APPATH$$##'), 'NO_MASK');
   ...
   g_masked_tokens('##$$AMETRXID$$##') := mask_text( g_sql_tokens('##$$AMETRXID$$##'), 'NO_MASK');
   g_sql_tokens('##$$AMETRXID2NEG$$##') := nvl(to_char(l_ame_trx_id2neg),'NULL');
   g_masked_tokens('##$$AMETRXID2NEG$$##') := mask_text( g_sql_tokens('##$$AMETRXID2NEG$$##'), 'NO_MASK');
   g_sql_tokens('##$$AMEAPPID2NEG$$##') := nvl(to_char(l_ame_app_id2neg),'NULL');
   g_masked_tokens('##$$AMEAPPID2NEG$$##') := mask_text( g_sql_tokens('##$$AMEAPPID2NEG$$##'), 'NO_MASK');
   g_sql_tokens('##$$ORGID$$##') := l_org_id;
...
debug('begin add_signature: PON_PATCHING_LEVELS_PROCUREMENT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9568',
      p_sig_id                 => 'PON_PATCHING_LEVELS_PROCUREMENT',
      p_sig_sql                => 'SELECT language, (bug_number), decode((bug_number),
  ''16910001'',''R12.PRC_PF.C.delta.2 - included in R12.2.2'',
  ''17036666'',''R12.PRC_PF.C.delta.3 - included in R12.2.3'',
  ''17947999'',''R12.PRC_PF.C.delta.4 - included in R12.2.4'',
  ''19684688'',''R12.PRC_PF.C.delta.5 - included in R12.2.5'',
  ''22112200'',''R12.PRC_PF.C.delta.6 - included in R12.2.6'',
  ''24715299'',''R12.PRC_PF.C.delta.7 - included in R12.2.7'',
  ''26954044'',''R12.PRC_PF.C.delta.8 - included in R12.2.8'',
  ''28800002'',''R12.PRC_PF.C.delta.9 - included in R12.2.9'',
  ''16207672'',''R12.2.2 - ORACLE E-BUSINESS SUITE 12.2.2 RELEASE UPDATE PACK'',
  ''17020683'',''R12.2.3 - ORACLE E-BUSINESS SUITE 12.2.3 RELEASE UPDATE PACK'',
  ''17919161'',''R12.2.4 - ORACLE E-BUSINESS SUITE 12.2.4 RELEASE UPDATE PACK'',
  ''19676458'',''R12.2.5 - ORACLE E-BUSINESS SUITE 12.2.5 RELEASE UPDATE PACK'',
  ''21900901'',''R12.2.6 - ORACLE E-BUSINESS SUITE 12.2.6 RELEASE UPDATE PACK'',
  ''24690690'',''R12.2.7 - ORACLE E-BUSINESS SUITE 12.2.7 RELEASE UPDATE PACK'',
  ''26787767'',''R12.2.8 - ORACLE E-BUSINESS SUITE 12.2.8 RELEASE UPDATE PACK'',
  ''28840850'',''R12.2.9 - ORACLE E-BUSINESS SUITE 12.2.9 RELEASE UPDATE PACK'',
  ''22575334'',''Consolidate checkin for 12.2.4+'',
  ''23705442'',''Consolidated Patch for CLM 12.2.4 - November 2016'',
  ''26439996'',''Consolidated Patch for CLM 12.2.4 - August 2017'',
  ''27352300'',''Consolidated Patch for CLM 12.2.4 - October 2018'',
  ''Other'') "Description", adb.creation_date
FROM ad_bugs adb, FND_PRODUCT_INSTALLATIONS fpi
WHERE bug_number IN
  (''16910001'',''17036666'',''17947999'',''19684688'',''22112200'',''24715299'',
   ''26954044'',''28800002'',''16207672'',''17020683'',''17919161'',''19676458'',
   ''21900901'',''24690690'',''26787767'',''28840850'',''22575334'',''23705442'',
   ''26439996'',''27352300'')
and fpi.patch_level like ''R12.FND.C%''

UNION ALL --SQL For Release 12.1.x (R12.1):

SELECT language, (bug_number), decode((bug_number),
  ...
  ''10105744'',''Contract Lifecycle Management - Rollup Patch 1 (RUP1)'',
  ''14116688'',''Contract Lifecycle Management - Rollup Patch 3 (RUP3)'',
  ''17826276'',''Contract Lifecycle Management - Rollup Patch 4 (RUP4)'',
  ''17525552'',''Consolidated RUP covering iSupplier Portal Bug Fixes, Sourcing Bug Fixes post 12.1.3 and SLM new features'',
  ''18911810'',''Oracle Procurement Recommended Patch Collection (July 2014)'',
  ...
  ''19602627'',''Procurement R12.1.3 Update 2015/03 March 2015 OBSOLETED'',
  ''20203366'',''Oracle E-Business Suite Release 12.1.3+ Recommended Patch Collection 3 [RPC3]'',
  ''20224883'',''Oracle iSupplier Portal Latest Recommend Patch Consolidation (March 2015)'',
  ...
  ''21669991'',''Consolidation patch including bug fixes and new features for Sourcing, iSupplier Portal and Supplier Lifecycle Management'',
  ''22138765'',''22138765:R12.ICX.B - Oracle iProcurement Recommended Patch Collection (Nov. 2015)'',
  ''22254174'',''22254174:R12.ICX.B - Oracle iProcurement Consolidation Patch for 12.1.3 - Feb 2016'',
  ''22254592'',''22254592:R12.PO.B - Oracle Purchasing Consolidation Patch for 12.1.3 - Feb 2016'',
  ''22644544'',''Oracle E-Business Suite Release 12.1.3+ Recommended Patch Collection 5 [RPC5]'',
  ''22779630'',''22779630:R12.PO.B - Oracle Purchasing Consolidation Patch for 12.1.3 - Apr 2016'',
  ''22779803'',''22779803:R12.ICX.B - Oracle iProcurement Consolidation Patch for 12.1.3 - Apr 2016'',
  ''23256401'',''23256401:R12.PO.B - Oracle Purchasing Consolidation Patch for 12.1.3 - Jun 2016'',
  ''23295577'',''23295577:R12.ICX.B - Oracle iProcurement Consolidation Patch for 12.1.3 - Jun 2016'',
  ''24286939'',''Oracle iSupplier Portal Latest Recommend Patch Consolidation (July 2016)'',
  ''24287284'',''Oracle Sourcing Recommended Patch Collection July 2016'',
  ''24311118'',''24311118:R12.PO.B - Oracle Purchasing Consolidation Patch for 12.1.3 - October 2016'',
  ''24596485'',''24596485:R12.ICX.B - Oracle iProcurement Consolidation Patch for 12.1.3 - Oct 2016'',
  ''25110937'',''25110937:R12.PRC_PF.B - Oracle Sourcing, iSupplier Portal, Supplier Lifecycle Management, Supplier Hub Consolidation Patch for 12.1.3 - Nov 2016'',
  ''25140095'',''25140095:R12.ICX.B - Oracle iProcurement Consolidation Patch for 12.1.3 - Jan 2017'',
  ''25141263'',''25141263:R12.PO.B - Oracle Purchasing Consolidation Patch for 12.1.3 - January 2017'',
  ''25687666'',''25687666:R12.ICX.B - Oracle iProcurement Consolidation Patch for 12.1.3 - Apr 2017'',
  ''25680268'',''25680268:R12.PO.B - Oracle Purchasing Consolidation Patch for 12.1.3 - April 2017'',
  ''25982732'',''25982732:R12.PO.B - Oracle Purchasing Consolidation Patch for 12.1.3 - June 2017'',
  ''26035964'',''26035964:R12.ICX.B - Oracle iProcurement Consolidation Patch for 12.1.3 - June 2017'',
  ''26483540'',''26483540:R12.PO.B - Oracle Purchasing Consolidation Patch for 12.1.3 - September 2017'',
  ''26521974'',''26521974:R12.ICX.B - Oracle iProcurement Consolidation Patch for 12.1.3 - September 2017'',
  ''26831773'',''26521974:R12.ICX.B - Oracle iProcurement Consolidation Patch for 12.1.3 - November 2017'',
  ''26877060'',''26477060:R12.PO.B - Oracle Purchasing Consolidation Patch for 12.1.3 - November 2017'',
  ''27217455'',''27217455:R12.PO.B - Oracle Purchasing Consolidation Patch for 12.1.3 - January 2018'',
  ''27246982'',''27246982:R12.ICX.B - Oracle iProcurement Consolidation Patch for 12.1.3 - January 2018'',
  ''27503898'',''27503898:R12.ICX.B - Oracle iProcurement Consolidation Patch for 12.1.3 - April 2018'',
  ''27513560'',''27513560:R12.PO.B - Oracle Purchasing Consolidation Patch for 12.1.3 - April 2018'',
  ''27851844'',''27851844:R12.ICX.B - Oracle iProcurement Consolidation Patch for 12.1.3 - June 2018'',
  ''27852024'',''27852024:R12.PO.B - Oracle Purchasing Consolidation Patch for 12.1.3 - June 2018'',
  ''28224872'',''28224872:R12.ICX.B - Oracle iProcurement Consolidation Patch for 12.1.3 - August 2018'',
  ''28225238'',''28225238:R12.PO.B - Oracle Purchasing Consolidation Patch for 12.1.3 - August 2018'',
  ''28581280'',''28581280:R12.PO.B - Oracle Purchasing Consolidation Patch for 12.1.3 - October 2018'',
  ''28883314'',''28883314:R12.ICX.B - Oracle iProcurement Consolidation Patch for 12.1.3 - December 2018'',
  ''28883549'',''28883549:R12.PO.B - Oracle Purchasing Consolidation Patch for 12.1.3 - December 2018'',
  ''29197834'',''29197834:R12.PO.B - Oracle Purchasing Consolidation Patch for 12.1.3 - February 2019'',
  ''29480188'',''29480188:R12.PO.B - Oracle Purchasing Consolidation Patch for 12.1.3 - May 2019'',
  ''Other'') "Description", adb.creation_date
FROM ad_bugs adb, FND_PRODUCT_INSTALLATIONS fpi
WHERE bug_number IN
  (''7303030'',''7303033'',''9239090'',''8522002'',''9249354'',
   ''10417963'',''11817843'',''12661793'',''13984450'',''14254641'',
   ''15843459'',''10105744'',''14116688'',''17826276'',''17525552'',
   ''18911810'',''18120913'',''17774755'',''18911810'',''19030202'',
   ''19602627'',''20203366'',''20224883'',''21198991'',''21236633'',
   ''21669991'',''22138765'',''22254174'',''22254592'',''22644544'',
   ''22779630'',''22779803'',''23256401'',''23295577'',''24286939'',
   ''24287284'',''24311118'',''24596485'',''25110937'',''25140095'',
   ''25141263'',''25687666'',''25680268'',''25982732'',''26035964'',
   ''26483540'',''26521974'',''26831773'',''26877060'',''27217455'',
   ''27246982'',''27503898'',''27513560'',''27851844'',''27852024'',
   ''28224872'',''28225238'',''28581280'',''28883314'',''28883549'',
   ''29197834'',''29480188'')
and fpi.patch_level like ''R12.FND.B%''

UNION ALL --SQL For Release 12.0.x (R12.0):
...
and fpi.patch_level like ''R12.FND.A%''

UNION ALL --SQL For Release 11.5.x (11i):

SELECT language, (bug_number), decode((bug_number),
  ''1350136'',''11i.PO.A'',''1425942'',''11i.PO.B'',''1554100'',''11i.PRC_PF.D'',
  ''1745369'',''11i.PRC_PF.E'',''1891381'',''11i.PRC_PF.F'',''2141229'',''11i.PRC_PF.G'',
  ''2320032'',''11i.PRC_PF.H'',''2700001'',''11i.PRC_PF.I'',''3384350'',''11i.SCM_PF.J'',
  ''4042499'',''11i.SCM_PF.J Rollup Patch 1'',''4231215'',''11i.SCM_PF.J Rollup Patch 2'',
  ''1354512'',''Release 11.5.2 - provides 11i.PO.A'',
  ''1475319'',''Release 11.5.3 - provides 11i.PO.B'',
  ''1622303'',''Release 11.5.4 - provides 11i.PRC_PF.D'',
  ''1808429'',''Release 11.5.5 - provides 11i.PRC_PF.E'',
  ''1939818'',''Release 11.5.6 - provides 11i.PRC_PF.F'',
  ''2123967'',''Release 11.5.7 - provides 11i.PRC_PF.G'',
  ''2293243'',''Release 11.5.8 - provides 11i.PRC_PF.H'',
  ''2669606'',''Release 11.5.9 - provides 11i.PRC_PF.I'',
  ''3140000'',''Release 11.5.10 - provides 11i.SCM_PF.J'',
  ''3240000'',''Release 11.5.10.1CU - provides 11i.SCM_PF.J and SCM RUP1'',
  ''3460000'',''Release 11.5.10.2CU - provides 11i.SCM_PF.J and SCM RUP2'',
  ''3480000'',''Release 11.5.10.2 - provides 11i.SCM_PF.J and SCM RUP2'',
  ''4028294'',''Oracle Sourcing J Rollup 1'',
  ''5150810'',''Oracle Sourcing J Rollup 2'',
  ''4017300'',''ATG Release 11.5.10 Rollup Patch 1'',
  ''4125550'',''ATG Release 11.5.10 Rollup Patch 2'',
  ''4334965'',''ATG Release 11.5.10 Rollup Patch 3'',
  ''4676589'',''ATG Release 11.5.10 Rollup Patch 4'',
  ''5473858'',''ATG Release 11.5.10 Rollup Patch 5'',
  ''5903765'',''ATG Release 11.5.10 Rollup Patch 6'',
  ''6241631'',''ATG Release 11.5.10 Rollup Patch 7'',
  ''6505228'',''Procurement Release 11.5.10 Rollup Patch 3'',
  ''6778767'',''Procurement Release 11.5.10 Rollup Patch 4'',
  ''7168377'',''Procurement Release 11.5.10 Rollup Patch 5'',
  ''7291444'',''Procurement Release 11.5.10 Rollup Patch 6'',
  ''7433314'',''Procurement Release 11.5.10 Rollup Patch 7'',
  ''7600643'',''Procurement Release 11.5.10 Rollup Patch 8'',
  ''8238546'',''Procurement Release 11.5.10 Rollup Patch 9'',
  ''8392569'',''Procurement Release 11.5.10 Rollup Patch 10'',
  ''8555411'',''Procurement Release 11.5.10 Rollup Patch 11'',
  ''8791241'',''Procurement Release 11.5.10 Rollup Patch 12'',
  ''Other'') "Description", adb.creation_date
FROM ad_bugs adb, FND_PRODUCT_INSTALLATIONS fpi
WHERE bug_number IN
  (''1350136'',''1425942'',''1554100'',''1745369'',''1891381'',''2141229'',
   ''2320032'',''2700001'',''3384350'',''4042499'',''4231215'',''1354512'',
   ''1475319'',''1622303'',''1808429'',''1939818'',''2123967'',''2293243'',
   ''2669606'',''3140000'',''3240000'',''3460000'',''3480000'',''4028294'',
   ''5150810'',''4017300'',''4125550'',''4334965'',''4676589'',''5473858'',
   ''5903765'',''6241631'',''6505228'',''6778767'',''7168377'',''7291444'',
   ''7433314'',''7600643'',''8238546'',''8392569'',''8555411'',''8791241'')
and fpi.patch_level like ''11i.FND%''
order by 1, 3 desc',
      p_title                  => 'Current Patching Levels for Procurement',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Current patching levels for Procurement',
      p_solution               => 'Review the Recommended Patches sections above for information about the latest Procurement and related code level recommendations for your instance.',
      p_success_msg            => 'These are the Procurement and related consolidated patches that are already applied in the instance.<br>
Review the Recommended Patches sections above for information about the latest Procurement and related code level recommendations for your instance.<br>',
   ...
   l_info.delete;
debug('end add_signature: PON_PATCHING_LEVELS_PROCUREMENT');



debug('begin add_signature: WF_OVERALL_HEALTH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1691',
      p_sig_id                 => 'WF_OVERALL_HEALTH',
      p_sig_sql                => 'SELECT (
    ...
    FROM DUAL',
      p_title                  => 'Overall Workflow Health',
      p_fail_condition         => '[Oldest Closed WF Item] > [365]',
      p_problem_descr          => 'The Overall Workflow Health status requires action. There are closed workflow items over 1 year old. Although this should not be a showstopper, for the PO Approval process, keeping
very old items in the Workflow could lead to performance issues and slow down the environment.
',
      p_solution               => '<ul>
   <li>Run the "Purge Obsolete Workflow Runtime Data" process as indicated in step 1 of [458886/KB189542#aref_section21].</li>
   <li>If the counts are not reduced, after running the purge process, continue with the subsequent steps in [458886/KB189542#aref_section22].</li>
   <li>Run the Workflow Analyzer Tool found in [1369938/KB730195] to determine if there are items for additional workflows that should bee purged and what other steps you can take to review your overall workflow footprint.</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: WF_OVERALL_HEALTH');



debug('begin add_signature: PON_SOURCING_NOT_INSTALLED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10652',
      p_sig_id                 => 'PON_SOURCING_NOT_INSTALLED',
...
and fav.application_short_name = ''PON''',
      p_title                  => 'Sourcing Application is NOT set as Installed in License Manager',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The Sourcing Application is NOT set as Installed in License Manager.  While some features of Sourcing will function, many other features will not function if the application is not installed.',
      p_solution               => 'Obtain proper license for Sourcing (via your Sales Representative), and use License Manager to set the Sourcing application as Installed.<br>
<br>
...
4. Select ''Sourcing'' (abbreviation: PON) and click Next<br>
...
',
   ...
   l_info.delete;
debug('end add_signature: PON_SOURCING_NOT_INSTALLED');



debug('begin add_signature: PON_AUCTION_HEADERS_ALL');
   l_info('##MASK##EXT_ATTRIBUTE1'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##EXT_ATTRIBUTE10'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##EXT_ATTRIBUTE11'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##EXT_ATTRIBUTE12'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##EXT_ATTRIBUTE13'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##EXT_ATTRIBUTE14'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##EXT_ATTRIBUTE15'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##EXT_ATTRIBUTE2'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##EXT_ATTRIBUTE3'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##EXT_ATTRIBUTE4'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##EXT_ATTRIBUTE5'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##EXT_ATTRIBUTE6'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##EXT_ATTRIBUTE7'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##EXT_ATTRIBUTE8'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##EXT_ATTRIBUTE9'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##INT_ATTRIBUTE1'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##INT_ATTRIBUTE10'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##INT_ATTRIBUTE11'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##INT_ATTRIBUTE12'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##INT_ATTRIBUTE13'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##INT_ATTRIBUTE14'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##INT_ATTRIBUTE15'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##INT_ATTRIBUTE2'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##INT_ATTRIBUTE3'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##INT_ATTRIBUTE4'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##INT_ATTRIBUTE5'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##INT_ATTRIBUTE6'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##INT_ATTRIBUTE7'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##INT_ATTRIBUTE8'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##INT_ATTRIBUTE9'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##TRADING_PARTNER_CONTACT_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##TRADING_PARTNER_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##TRADING_PARTNER_NAME_UPPER'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8676',
      p_sig_id                 => 'PON_AUCTION_HEADERS_ALL',
      p_sig_sql                => 'SELECT PAHA.auction_header_id_orig_round "Negotiation Number",
PAHA.auction_round_number "Round", PAHA.document_number "Document Number",
paha.* 
FROM pon_auction_headers_all paha
WHERE NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'')
and
paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'PON_AUCTION_HEADERS_ALL for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Document Headers for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Document Headers found for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_AUCTION_HEADERS_ALL');



debug('begin add_signature: PON_AUCTION_ITEM_PRICES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8696',
      p_sig_id                 => 'PON_AUCTION_ITEM_PRICES_ALL',
      p_sig_sql                => 'SELECT PAHA.auction_header_id_orig_round "Negotiation Number",
PAHA.auction_round_number "Round", PAHA.document_number "Document Number", PAIP.line_number "Line", PAIP.*
FROM PON_AUCTION_ITEM_PRICES_ALL PAIP, PON_AUCTION_HEADERS_ALL PAHA
WHERE paip.line_number like NVL(''##$$LINE_NUMBER$$##'',''%'')
and paip.auction_header_id = PAHA.auction_header_id
and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'')
and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'PON_AUCTION_ITEM_PRICES_ALL for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Line Item Prices for Negotiation / Line(s)',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Line Item Prices found for Negotiation / Line(s).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_AUCTION_ITEM_PRICES_ALL');



debug('begin add_signature: PON_AUCTION_SHIPMENTS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8706',
      p_sig_id                 => 'PON_AUCTION_SHIPMENTS_ALL',
      p_sig_sql                => 'select pas.*
FROM pon_auction_shipments_all  pas, pon_auction_headers_all paha
where (pas.line_number = ''-1'' or pas.line_number like NVL(''##$$LINE_NUMBER$$##'',''%''))
and pas.auction_header_id = PAHA.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'PON_AUCTION_SHIPMENTS_ALL for Negotiation / Line(s)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Negotiation Shipments for Negotiation / Line(s)',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Negotiation Shipments found for Negotiation / Line(s).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_AUCTION_SHIPMENTS_ALL');



debug('begin add_signature: PON_PRICING_ELEMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8709',
      p_sig_id                 => 'PON_PRICING_ELEMENTS',
      p_sig_sql                => 'select ppe.*
FROM PON_PRICE_ELEMENTS ppe, pon_auction_headers_all paha
where (ppe.line_number = ''-1'' or ppe.line_number like NVL(''##$$LINE_NUMBER$$##'',''%''))
and ppe.auction_header_id = PAHA.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'PON_PRICE_ELEMENTS for Negotiation / Line(s)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Price Elements for Negotiation / Line(s)',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Price Elements found for Negotiation / Line(s).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_PRICING_ELEMENTS');



debug('begin add_signature: PON_PRICE_ELEMENT_TYPES_VL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8712',
      p_sig_id                 => 'PON_PRICE_ELEMENT_TYPES_VL',
      p_sig_sql                => 'select ppet.*
FROM PON_PRICE_ELEMENT_TYPES_VL ppet
where price_element_type_id in
(select distinct ppe.price_element_type_id
FROM PON_PRICE_ELEMENTS ppe, pon_auction_headers_all paha
where (ppe.line_number = ''-1'' or ppe.line_number like NVL(''##$$LINE_NUMBER$$##'',''%''))
and ppe.auction_header_id = PAHA.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##)',
      p_title                  => 'PON_PRICE_ELEMENT_TYPES_VL for Negotiation / Line(s)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Price Element Types for Negotiation / Line(s)',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Price Element Types found for Negotiation / Line(s).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_PRICE_ELEMENT_TYPES_VL');



debug('begin add_signature: PON_AUCTION_ATTRIBUTES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8704',
      p_sig_id                 => 'PON_AUCTION_ATTRIBUTES',
      p_sig_sql                => 'SELECT paa.*
FROM pon_auction_attributes paa, pon_auction_headers_all paha
where (paa.line_number = ''-1'' or paa.line_number like NVL(''##$$LINE_NUMBER$$##'',''%''))
and paa.auction_header_id = PAHA.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'PON_AUCTION_ATTRIBUTES for Negotiation / Line(s)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Negotiation Attributes for Negotiation / Line(s)',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Negotiation Attributes found for Negotiation / Line(s).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_AUCTION_ATTRIBUTES');



debug('begin add_signature: PON_NEG_TEAM_MEMBERS');
   l_info('##MASK##FULL_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##USER_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8780',
      p_sig_id                 => 'PON_NEG_TEAM_MEMBERS',
      p_sig_sql                => 'select pecx.full_name, pnt.*
from PON_NEG_TEAM_MEMBERS pnt,
fnd_user fndu, per_employees_current_x pecx, pon_auction_headers_all paha
where pecx.employee_id = fndu.employee_id and pnt.user_id = fndu.user_id and pnt.auction_header_id = paha.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'PON_NEG_TEAM_MEMBERS for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Collaboration Team Members for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Collaboration Team Members found for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_NEG_TEAM_MEMBERS');



debug('begin add_signature: EBS_MFG_PO_PON_TEAM_MEMBERS_DATA_ISSUE_01');
   l_info('##MASK##USER_NAME'):= 'DISPLAY_FIRST_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23326',
      p_sig_id                 => 'EBS_MFG_PO_PON_TEAM_MEMBERS_DATA_ISSUE_01',
      p_sig_sql                => 'Select auction_header_id, list_id, user_name, menu_name, member_type, approver_flag,approval_status, task_name, target_date, completion_date, creation_date, last_update_date, user_id 
FROM pon_neg_team_members A 
WHERE ROWID > 
 ( SELECT MIN(ROWID) 
   FROM pon_neg_team_members B 
   WHERE A.auction_header_id =B.auction_header_id AND A.user_id = B.user_id 
   GROUP BY auction_header_id , user_id HAVING COUNT(user_id) >1 ) ',
      p_title                  => 'Negotiation Team Members Data Corruption',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There is corruption with team members on the negotiation(s) listed.  This can result in "You have encountered an unexpected error" and SQLStmtException: ORA-01422, when trying to use the ''Full List'' button on the Sourcing Buyer Home Page.',
      p_solution               => 'Request a datafix from Support for the issue described in [1934010/KB480063]',
      p_success_msg            => 'There is no corruption of team members for the negotiations in this instance.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_PON_TEAM_MEMBERS_DATA_ISSUE_01');



debug('begin add_signature: PON_BACKING_REQUISITIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8864',
      p_sig_id                 => 'PON_BACKING_REQUISITIONS',
      p_sig_sql                => 'select pbr.*
from pon_backing_requisitions pbr, pon_auction_headers_all paha
where pbr.line_number like NVL(''##$$LINE_NUMBER$$##'',''%'') and pbr.auction_header_id = PAHA.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'PON_BACKING_REQUISITIONS for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Backing Requisitions for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Backing Requisitions found for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_BACKING_REQUISITIONS');



debug('begin add_signature: PON_PO_REQUISITION_HEADERS_ALL');
   l_info('##MASK##ATTRIBUTE1'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE10'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE11'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE12'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE13'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE14'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE15'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE2'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE3'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE4'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE5'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE6'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE7'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE8'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE9'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9277',
      p_sig_id                 => 'PON_PO_REQUISITION_HEADERS_ALL',
      p_sig_sql                => 'select distinct prha.* from po_requisition_headers_all prha, pon_backing_requisitions pbr, pon_auction_headers_all paha 
where prha.requisition_header_id = pbr.REQUISITION_HEADER_ID and pbr.AUCTION_HEADER_ID = paha.auction_header_id 
and (pbr.line_number like NVL(''##$$LINE_NUMBER$$##'',''%''))
and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'PO_REQUISITION_HEADERS_ALL for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Backing Requisition Headers for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No backing Requisition Headers found for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_PO_REQUISITION_HEADERS_ALL');



debug('begin add_signature: PON_PO_REQUISITION_LINES_ALL');
   l_info('##MASK##ATTRIBUTE1'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE10'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE11'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE12'):= 'DISPLAY_FIRST_25_PCNT';
   ...
   l_info('##MASK##ATTRIBUTE8'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE9'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##CANDIDATE_FIRST_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##CANDIDATE_FULL_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##CANDIDATE_LAST_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##CONTACT_INFORMATION'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##GLOBAL_ATTRIBUTE1'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##GLOBAL_ATTRIBUTE10'):= 'DISPLAY_LAST_25_PCNT';
   l_info('##MASK##GLOBAL_ATTRIBUTE11'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##GLOBAL_ATTRIBUTE12'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##GLOBAL_ATTRIBUTE13'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##GLOBAL_ATTRIBUTE14'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##GLOBAL_ATTRIBUTE15'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##GLOBAL_ATTRIBUTE16'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##GLOBAL_ATTRIBUTE17'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##GLOBAL_ATTRIBUTE18'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##GLOBAL_ATTRIBUTE19'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##GLOBAL_ATTRIBUTE2'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##GLOBAL_ATTRIBUTE20'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##GLOBAL_ATTRIBUTE3'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##GLOBAL_ATTRIBUTE4'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##GLOBAL_ATTRIBUTE5'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##GLOBAL_ATTRIBUTE6'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##GLOBAL_ATTRIBUTE7'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##GLOBAL_ATTRIBUTE8'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##GLOBAL_ATTRIBUTE9'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##MANUFACTURER_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##REQUESTER_EMAIL'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##REQUESTER_FAX'):= 'DISPLAY_LAST_25_PCNT';
   l_info('##MASK##REQUESTER_PHONE'):= 'DISPLAY_LAST_25_PCNT';
   l_info('##MASK##SUGGESTED_VENDOR_CONTACT'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##SUGGESTED_VENDOR_CONTACT_EMAIL'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##SUGGESTED_VENDOR_CONTACT_FAX'):= 'DISPLAY_LAST_25_PCNT';
   l_info('##MASK##SUGGESTED_VENDOR_LOCATION'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##SUGGESTED_VENDOR_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##SUGGESTED_VENDOR_PHONE'):= 'DISPLAY_LAST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9278',
      p_sig_id                 => 'PON_PO_REQUISITION_LINES_ALL',
      p_sig_sql                => 'select prla.* from po_requisition_lines_all prla, pon_backing_requisitions pbr, pon_auction_headers_all paha
where prla.requisition_line_id = pbr.REQUISITION_LINE_ID
and pbr.AUCTION_HEADER_ID = paha.auction_header_id
and (pbr.line_number like NVL(''##$$LINE_NUMBER$$##'',''%''))
and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'PO_REQUISITION_LINES_ALL for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Backing Requisition Lines for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No backing Requisition Lines found for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_PO_REQUISITION_LINES_ALL');



debug('begin add_signature: PON_EMD_TRANSACTIONS');
   l_info('##MASK##ATTRIBUTE1'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE10'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE11'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE12'):= 'DISPLAY_FIRST_25_PCNT';
   ...
   l_info('##MASK##BANK_BRANCH_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##BANK_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##CARD_ISSUER_CODE'):= 'DISPLAY_NONE';
   l_info('##MASK##CREDIT_CARD_NUM'):= 'DISPLAY_LAST_4_CHAR';
   l_info('##MASK##CUST_TRX_NUMBER'):= 'DISPLAY_LAST_25_PCNT';
   l_info('##MASK##EXPIRY_DATE'):= 'DISPLAY_NONE';
   l_info('##MASK##NAME_ON_CARD'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8797',
      p_sig_id                 => 'PON_EMD_TRANSACTIONS',
      p_sig_sql                => 'select pet.*
from PON_EMD_TRANSACTIONS pet, pon_auction_headers_all paha
where pet.auction_header_id = paha.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'PON_EMD_TRANSACTIONS for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Earnest Money Deposit (EMD) Transactions for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Earnest Money Deposit (EMD) Transactions found for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_EMD_TRANSACTIONS');



debug('begin add_signature: PON_DISCUSSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8781',
      p_sig_id                 => 'PON_DISCUSSIONS',
      p_sig_sql                => 'select PD.*
from PON_DISCUSSIONS PD, pon_threads pt, pon_auction_headers_all paha
where pt.discussion_id = pd.discussion_id
AND PD.ENTITY_NAME = ''PON_AUCTION_HEADERS_ALL'' 
AND PD.pk1_value = paha.auction_header_id
and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'PON_DISCUSSIONS for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Discussions for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Discussions found for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_DISCUSSIONS');



debug('begin add_signature: PON_THREADS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9035',
      p_sig_id                 => 'PON_THREADS',
      p_sig_sql                => 'select pt.* from pon_threads pt, pon_discussions pd, pon_auction_headers_all paha
where pt.discussion_id = pd.discussion_id
and pd.pk1_value = paha.auction_header_id
and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'PON_THREADS for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Discussion Threads for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Discussion Threads found for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_THREADS');



debug('begin add_signature: PON_THREAD_ENTRIES');
   l_info('##MASK##FROM_COMPANY_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FROM_FIRST_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##FROM_LAST_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9036',
      p_sig_id                 => 'PON_THREAD_ENTRIES',
      p_sig_sql                => 'select pte.* from pon_thread_entries pte, pon_discussions pd, pon_auction_headers_all paha
where pte.discussion_id = pd.discussion_id and pd.pk1_value = paha.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'PON_THREAD_ENTRIES for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Discussion Thread Entries for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Discussion Thread Entries found for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_THREAD_ENTRIES');



debug('begin add_signature: EBS_MFG_PO_PON_AUC_CURRENCY_RATES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24302',
      p_sig_id                 => 'EBS_MFG_PO_PON_AUC_CURRENCY_RATES',
      p_sig_sql                => 'select pacr.* 
from pon_auction_currency_rates pacr, pon_auction_headers_all paha
where pacr.auction_header_id = paha.auction_header_id
and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##
order by auction_currency_code, bid_currency_code',
      p_title                  => 'Currency Rates',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Auction and Bid Currency Rates',
      p_solution               => 'Currency Rates for the Sourcing Negotiation',
      p_success_msg            => 'No Currency Rates found for this Sourcing Negotiation',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_PON_AUC_CURRENCY_RATES');



debug('begin add_signature: PON_INTERFACE_ERRORS_FND_NEW_MESSAGES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9600',
      p_sig_id                 => 'PON_INTERFACE_ERRORS_FND_NEW_MESSAGES',
      p_sig_sql                => 'select fnm.message_name, message_text from PON_INTERFACE_ERRORS pie, pon_auction_headers_all paha, fnd_new_messages fnm
where fnm.message_name = pie.error_message_name
and pie.auction_header_id = paha.auction_header_id
and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'FND_NEW_MESSAGE Message Details for PON_INTERFACE_ERRORS for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This is the message text detail for the message name shown above, and it provides more information about the issue detected when the import was attempted.',
      p_solution               => '1. Expand the row to see the message text.<br>
2. Review the message text for the cause and recommended action to avoid the error as described in [2368667/KB277126#aref_section210] How to Diagnose Issues With Sourcing Open Interface.<br>
3. Log a Service Request with support and include this analyzer output for further assistance with resolving the issue.<br>',
      p_success_msg            => 'No PON_INTERFACE_ERRORS records found for Negotiation.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_INTERFACE_ERRORS_FND_NEW_MESSAGES');



debug('begin add_signature: PON_INTERFACE_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9174',
      p_sig_id                 => 'PON_INTERFACE_ERRORS',
      p_sig_sql                => 'select paha.auction_header_id_orig_round, pie.auction_header_id, pie.* from PON_INTERFACE_ERRORS pie, pon_auction_headers_all paha 
where pie.auction_header_id = paha.auction_header_id
and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$## 
order by pie.auction_header_id desc',
      p_title                  => 'PON_INTERFACE_ERRORS for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The Sourcing interface errors table (PON_INTERFACE_ERRORS) has records that need to be addressed for the Negotiation.',
      p_solution               => 'Expand the section and review the INTERFACE_TYPE, COLUMN_NAME, and TABLE_NAME for the context of the error, as well as the corresponding data values you specified that resulted in the error.<br>
The message detail contains the corresponding error text.<br>
Modify the incorrect values, and repeat the import process as described in [2368667/KB277126#aref_section210] How to Diagnose Issues With Sourcing Open Interface<br>',
      p_success_msg            => 'No Sourcing interface errors found for Negotiation.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('PON_INTERFACE_ERRORS_FND_NEW_MESSAGES'),
      p_include_in_dx_summary  => nvl('Y','N'),
      p_version                => '33'
      );
   l_info.delete;
debug('end add_signature: PON_INTERFACE_ERRORS');



debug('begin add_signature: PON_DATA_MISSING_LINK_MANAGE_COLLABORATION_TEAM');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9433',
      p_sig_id                 => 'PON_DATA_MISSING_LINK_MANAGE_COLLABORATION_TEAM',
      p_sig_sql                => 'SELECT distinct paha.AUCTION_HEADER_ID, paha.DOCUMENT_NUMBER
FROM PON_AUCTION_HEADERS_ALL paha
WHERE paha.AUCTION_HEADER_ID_ORIG_AMEND <> paha.AUCTION_HEADER_ID
AND paha.AUCTION_STATUS = ''DRAFT''
AND NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$## 
UNION ALL
SELECT distinct paha.AUCTION_HEADER_ID, paha.DOCUMENT_NUMBER
FROM PON_AUCTION_HEADERS_ALL paha, pon_bid_headers pbh
WHERE paha.AUCTION_HEADER_ID_ORIG_AMEND <> paha.AUCTION_HEADER_ID
AND paha.AUCTION_STATUS = ''DRAFT''
AND (pbh.bid_number like NVL(''##$$BID_NUMBER$$##'',''%'')) 
and ((pbh.bid_number like NVL(''##$$BID_NUMBER$$##'',''%'')) 
      or (pbh.bid_number in (select distinct bid_number 
                          from pon_bid_headers pbh, pon_auction_headers_all paha
                          where upper(pbh.trading_partner_name) like concat(concat(''%'',upper(''##$$BIDDING_SUPPLIER$$##'')),''%'') 
                          and pbh.auction_header_id = paha.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') 
                          and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##)))
and pbh.auction_header_id = paha.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'Missing Link for Manage Collaboration Team for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The Manage Collaboration Team link is missing for the Negotiation, and this will prevent users from maintaining the Collaboration Team on the Negotiation.',
      p_solution               => 'The link for Manage Collaboration Team will not appear for this Negotiation because there is an amendment in DRAFT status.<br>
<br>
Use the following steps to remove the draft amendment and then the Manage Collaboration Team feature will be available again.<br>
<br>
REFERENCE<br>
[2104714/KB557834]<br>
<br>
1. Navigate to Sourcing Super User / Sourcing Buyer<br>
2. Choose Manage Drafts<br>
3. Search for the negotiation<br>
4. Complete and Publish the draft amendment.  Otherwise, delete this amendment (if there is no approval), or cancel the amendment (if it is approved)<br>
5. View the negotiation and see the action "Manage Collaboration Team" is now available<br>
<br>',
      p_success_msg            => 'There are no amendments in DRAFT status for this Negotiation, so the Manage Collaboration Team link should be available.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_DATA_MISSING_LINK_MANAGE_COLLABORATION_TEAM');



debug('begin add_signature: PON_BIDDING_PARTIES');
   l_info('##MASK##ACK_PARTNER_CONTACT_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ADDITIONAL_CONTACT_EMAIL'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##NEW_SUPPLIER_CONTACT_FNAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##NEW_SUPPLIER_CONTACT_LNAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##NEW_SUPPLIER_EMAIL'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##NEW_SUPPLIER_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##REQUESTED_SUPPLIER_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##REQUESTED_SUPP_CONTACT_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##TRADING_PARTNER_CONTACT_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##TRADING_PARTNER_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##VENDOR_SITE_CODE'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##WF_USER_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8779',
      p_sig_id                 => 'PON_BIDDING_PARTIES',
      p_sig_sql                => 'SELECT pbp.* 
FROM PON_BIDDING_PARTIES pbp, pon_auction_headers_all paha
WHERE pbp.auction_header_id = PAHA.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'PON_BIDDING_PARTIES for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Bidding / Quoting Suppliers for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Bidding / Quoting Suppliers found for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_BIDDING_PARTIES');



debug('begin add_signature: PON_BID_HEADERS');
   l_info('##MASK##AUCTIONEER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##AUCTION_CONTACT'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##CONTACT'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##TRADING_PARTNER_CONTACT_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##TRADING_PARTNER_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8798',
      p_sig_id                 => 'PON_BID_HEADERS',
      p_sig_sql                => 'select b.bid_number, b.trading_partner_contact_name contact,
paha.trading_partner_contact_name auction_contact, paha.trading_partner_name auctioneer,
paha.auction_title, b.bid_status,b.*
from PON_BID_HEADERS b, 
pon_auction_headers_all paha 
where (b.bid_number like NVL(''##$$BID_NUMBER$$##'',''%''))
and ((b.bid_number like NVL(''##$$BID_NUMBER$$##'',''%'')) 
      or (b.bid_number in (select distinct bid_number 
                          from pon_bid_headers pbh, pon_auction_headers_all paha
                          where upper(pbh.trading_partner_name) like concat(concat(''%'',upper(''##$$BIDDING_SUPPLIER$$##'')),''%'') 
                          and pbh.auction_header_id = paha.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') 
                          and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##)))
and b.auction_header_id = PAHA.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'PON_BID_HEADERS for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Bid / Quote Headers for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Bid / Quote Headers found for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_BID_HEADERS');



debug('begin add_signature: PON_BID_ATTRIBUTE_VALUES');
   l_info('##MASK##ATTRIBUTE_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##OLD_VALUE'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##VALUE'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8802',
      p_sig_id                 => 'PON_BID_ATTRIBUTE_VALUES',
      p_sig_sql                => 'select pbav.* 
from PON_BID_ATTRIBUTE_VALUES pbav, pon_auction_headers_all paha
where (pbav.line_number = ''-1'' or pbav.line_number like NVL(''##$$BID_LINE_NUMBER$$##'',''%''))
and (pbav.auction_line_number = ''-1'' or pbav.auction_line_number like NVL(''##$$LINE_NUMBER$$##'',''%'')) 
and (pbav.bid_number like NVL(''##$$BID_NUMBER$$##'',''%''))
and ((pbav.bid_number like NVL(''##$$BID_NUMBER$$##'',''%'')) 
      or (pbav.bid_number in (select distinct bid_number 
                          from pon_bid_headers pbh, pon_auction_headers_all paha
                          where upper(pbh.trading_partner_name) like concat(concat(''%'',upper(''##$$BIDDING_SUPPLIER$$##'')),''%'') 
                          and pbh.auction_header_id = paha.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') 
                          and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##)))
and pbav.auction_header_id = PAHA.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'PON_BID_ATTRIBUTE_VALUES for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Bid / Quote Attribute Values for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Bid / Quote Attribute Values found for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_BID_ATTRIBUTE_VALUES');



debug('begin add_signature: PON_BID_PRICE_ELEMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8801',
      p_sig_id                 => 'PON_BID_PRICE_ELEMENTS',
      p_sig_sql                => 'select pbpe.* 
from PON_BID_PRICE_ELEMENTS pbpe,
pon_bid_headers pbh, pon_auction_headers_all paha
where (pbpe.line_number like NVL(''##$$LINE_NUMBER$$##'',''%''))
and pbpe.bid_number = pbh.bid_number
and pbh.auction_header_id = PAHA.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'PON_BID_PRICE_ELEMENTS for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Bid / Quote Price Elements for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Bid / Quote Price Elements found for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_BID_PRICE_ELEMENTS');



debug('begin add_signature: PON_BID_SHIPMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8800',
      p_sig_id                 => 'PON_BID_SHIPMENTS',
      p_sig_sql                => 'select pbs.* 
from pon_bid_shipments pbs,
pon_bid_headers pbh, pon_auction_headers_all paha
where (pbs.line_number like NVL(''##$$BID_LINE_NUMBER$$##'',''%''))
and (pbs.auction_line_number like NVL(''##$$LINE_NUMBER$$##'',''%''))
and pbs.bid_number = pbh.bid_number
and (pbh.bid_number like NVL(''##$$BID_NUMBER$$##'',''%''))
and ((pbh.bid_number like NVL(''##$$BID_NUMBER$$##'',''%'')) 
      or (pbh.bid_number in (select distinct bid_number 
                          from pon_bid_headers pbh, pon_auction_headers_all paha
                          ...
                          and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##)))
and pbh.auction_header_id = PAHA.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'PON_BID_SHIPMENTS for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Bid / Quote Shipments for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Bid / Quote Shipments found for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_BID_SHIPMENTS');



debug('begin add_signature: PON_BID_ITEM_PRICES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8799',
      p_sig_id                 => 'PON_BID_ITEM_PRICES',
      p_sig_sql                => 'select pip.*
from PON_BID_ITEM_PRICES pip, pon_auction_headers_all paha 
where (pip.line_number like NVL(''##$$BID_LINE_NUMBER$$##'',''%''))
and (pip.bid_number like NVL(''##$$BID_NUMBER$$##'',''%''))
and ((pip.bid_number like NVL(''##$$BID_NUMBER$$##'',''%'')) 
      or (pip.bid_number in (select distinct bid_number 
                          from pon_bid_headers pbh, pon_auction_headers_all paha
                          where upper(pbh.trading_partner_name) like concat(concat(''%'',upper(''##$$BIDDING_SUPPLIER$$##'')),''%'') 
                          and pbh.auction_header_id = paha.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') 
                          and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##)))
and (pip.auction_line_number like NVL(''##$$LINE_NUMBER$$##'',''%''))
and pip.auction_header_id = PAHA.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'PON_BID_ITEM_PRICES for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Bid / Quote Item Prices for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Bid / Quote Item Prices found for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_BID_ITEM_PRICES');



debug('begin add_signature: PON_DATA_MULTIPLE_DRAFT_BIDS_FROM_SAME_SUPPLIER_SITE');
   l_info('##MASK##TRADING_PARTNER_CONTACT_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##TRADING_PARTNER_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##VENDOR_SITE_CODE'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9434',
      p_sig_id                 => 'PON_DATA_MULTIPLE_DRAFT_BIDS_FROM_SAME_SUPPLIER_SITE',
      p_sig_sql                => 'select pbh.bid_number, pbh.auction_header_id, pbh.trading_partner_name, pbh.trading_partner_id, pbh.vendor_site_code, pbh.trading_partner_contact_name 
from pon_bid_headers pbh, pon_auction_headers_all paha
where paha.auction_header_id in 
   (select auction_header_id from (
     select pbh.auction_header_id, count(pbh.bid_number) 
           from pon_auction_headers_all paha, pon_bid_headers pbh
           where pbh. bid_status = ''DRAFT''
           and pbh.auction_header_id = paha.auction_header_id
           group by pbh.auction_header_id, pbh.trading_partner_id, pbh.vendor_site_id
           having count(pbh.bid_number) > 1) a
   )
and 
(pbh.bid_number in (select distinct bid_number from pon_bid_headers pbh, pon_auction_headers_all paha 
       where upper(pbh.trading_partner_name) like concat(concat(''%'',upper(''##$$BIDDING_SUPPLIER$$##'')),''%'') 
       and pbh.auction_header_id = paha.auction_header_id 
       and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') 
       and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##)) 
and pbh.auction_header_id = paha.auction_header_id 
and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'Multiple Bids from the Same Supplier Site in Draft Status for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Multiple bids exist from the same supplier site in DRAFT status for the Negotiation.  There should be no more than one bid from each supplier site in DRAFT status for a negotiation at any time.',
      p_solution               => 'Delete unwanted DRAFT bids, and complete and submit the valid bid.<br>
1. Navigate to Manage Drafts.<br>
2. Query by Negotiation or Bid number.<br>
3. Delete the unwanted bid(s).<br>
4. Complete and submit the valid bid.<br>
If you have difficulty with these actions, request assistance from Oracle Support by opening a Service Request with this analyzer output and reference Document [2299134/KB407746]<vr>',
      p_success_msg            => 'There are no occurrences of multiple bids from the same supplier site in DRAFT status for Negotiation.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_DATA_MULTIPLE_DRAFT_BIDS_FROM_SAME_SUPPLIER_SITE');



debug('begin add_signature: PON_AWARD_ALLOCATIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9037',
      p_sig_id                 => 'PON_AWARD_ALLOCATIONS',
      p_sig_sql                => 'select paa.*
 from pon_award_allocations paa, pon_auction_headers_all paha
where 
(paa.bid_line_number like NVL(''##$$BID_LINE_NUMBER$$##'',''%'')) 
and (paa.bid_number like NVL(''##$$BID_NUMBER$$##'',''%'')) 
and ((paa.bid_number like NVL(''##$$BID_NUMBER$$##'',''%'')) 
      or (paa.bid_number in (select distinct bid_number 
                          from pon_bid_headers pbh, pon_auction_headers_all paha
                          where upper(pbh.trading_partner_name) like concat(concat(''%'',upper(''##$$BIDDING_SUPPLIER$$##'')),''%'') 
                          and pbh.auction_header_id = paha.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') 
                          and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##)))
and paa.auction_header_id = PAHA.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'PON_AWARD_ALLOCATIONS for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Award Allocations for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Award Allocations found for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_AWARD_ALLOCATIONS');



debug('begin add_signature: PON_PO_HEADERS_ALL');
   l_info('##MASK##ATTRIBUTE1'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE10'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE11'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE12'):= 'DISPLAY_FIRST_25_PCNT';
   ...
   l_info('##MASK##EMAIL_ADDRESS'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##FAX'):= 'DISPLAY_LAST_25_PCNT';
   l_info('##MASK##GLOBAL_ATTRIBUTE1'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##GLOBAL_ATTRIBUTE10'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##GLOBAL_ATTRIBUTE11'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##GLOBAL_ATTRIBUTE12'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##GLOBAL_ATTRIBUTE13'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##GLOBAL_ATTRIBUTE14'):= 'DISPLAY_FIRST_25_PCNT';
   ...
   l_info('##MASK##GLOBAL_ATTRIBUTE8'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##GLOBAL_ATTRIBUTE9'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##LOCK_OWNER_ROLE'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9082',
      p_sig_id                 => 'PON_PO_HEADERS_ALL',
      p_sig_sql                => 'select poha.*
from po_lines_all pola, po_headers_all poha, pon_auction_headers_all paha
where (pola.line_num like NVL(''##$$BID_LINE_NUMBER$$##'',''%'')) 
and (pola.bid_number like NVL(''##$$BID_NUMBER$$##'',''%'')) 
and ((pola.bid_number like NVL(''##$$BID_NUMBER$$##'',''%'')) 
      or (pola.bid_number in (select distinct bid_number 
                          from pon_bid_headers pbh, pon_auction_headers_all paha
                          where upper(pbh.trading_partner_name) like concat(concat(''%'',upper(''##$$BIDDING_SUPPLIER$$##'')),''%'') 
                          and pbh.auction_header_id = paha.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') 
                          and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##)))
and (pola.auction_line_number like NVL(''##$$LINE_NUMBER$$##'',''%'')) 
and pola.po_header_id = poha.po_header_id
and pola.auction_header_id = paha.auction_header_id
and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'PO_HEADERS_ALL for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Purchase Order, Blanket Agreement, or Contract Agreement document Header created from Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Purchase Order, Blanket Agreement, or Contract Agreement document Header found created from Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_PO_HEADERS_ALL');



debug('begin add_signature: PON_PO_LINES_ALL');
   l_info('##MASK##ATTRIBUTE1'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE10'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE11'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE12'):= 'DISPLAY_FIRST_25_PCNT';
  ...
  add_signature(
      p_sig_repo_id            => '9279',
      p_sig_id                 => 'PON_PO_LINES_ALL',
      p_sig_sql                => 'select pola.*
from po_lines_all pola, pon_auction_headers_all paha
where (pola.line_num like NVL(''##$$BID_LINE_NUMBER$$##'',''%''))
and (pola.bid_number like NVL(''##$$BID_NUMBER$$##'',''%'')) 
and ((pola.bid_number like NVL(''##$$BID_NUMBER$$##'',''%'')) 
      or (pola.bid_number in (select distinct bid_number 
...
and pola.auction_header_id = paha.auction_header_id
and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'PO_LINES_ALL for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Purchase Order Lines created from Negotiation Lines',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Purchase Order Lines found created from Negotiation Lines.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_PO_LINES_ALL');



debug('begin add_signature: PON_AWARDCOMPLETE_OUTCOMENOTCOMPLETE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9289',
      p_sig_id                 => 'PON_AWARDCOMPLETE_OUTCOMENOTCOMPLETE',
      p_sig_sql                => 'select paha.auction_header_id, paha.award_complete_date, paha.outcome_status 
from pon_auction_headers_all paha
where outcome_status <> ''OUTCOME_COMPLETED'' and award_complete_date is not null
and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##
order by auction_header_id desc',
      p_title                  => 'Award Complete but Outcome Not Complete for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Award is complete but the Purchase Order or Blanket Agreement outcome is not complete for the Negotiation.',
      p_solution               => 'Review these documents for possible causes and solutions.  Alternatively, log an SR with this analyzer output to request assistance from Support on the issue.<br>
[2043734/KB640613] Sourcing RFQ Award to Create A Blanket Purchase Agreement Ends in System Error<br>
[2100153/KB542924] Error: Purchase Order Creation Could Not Be Initiated, When SHIP_TO_LOCATION_ID is Null in RFQ and Quote Line Prices Tables<br>
[2056843/KB430230] PO Gets Stuck In Status IN PROCESS When Created From RFQ<br>
',
      p_success_msg            => 'Award is complete and the Purchase Order or Blanket Agreement outcome is also complete for Negotiation.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_AWARDCOMPLETE_OUTCOMENOTCOMPLETE');



debug('begin add_signature: PON_AWARDEDLINE_NOPOLINECREATED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9299',
      p_sig_id                 => 'PON_AWARDEDLINE_NOPOLINECREATED',
      p_sig_sql                => 'select auction_header_id, auction_line_number, bid_number, line_number, award_status, award_date, po_header_id, po_line_id
from
(
select pbip.auction_header_id, pbip.auction_line_number, pbip.bid_number, pbip.line_number, pbip.award_status, pbip.award_date, pola.po_header_id, pola.po_line_id
from pon_bid_item_prices pbip, po_lines_all pola, pon_auction_headers_all paha
where pola.po_line_id is null and pola.po_header_id is null and pbip.award_status = ''AWARDED''
and pola.auction_line_number(+) = pbip.auction_line_number and pola.auction_header_id(+) = pbip.auction_header_id
and (pbip.auction_line_number like NVL(''##$$LINE_NUMBER$$##'',''%''))
and pbip.auction_header_id = paha.auction_header_id
and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##
order by auction_header_id desc, auction_line_number
) PoLineNotFound',
      p_title                  => 'Negotiation Line AWARDED but No Purchase Order Line Created',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Negotiation Line is AWARDED but there is no Purchase Order Line created yet for this Negotiation Line.  Typically there is a Purchase Order(s) and Purchase Order Line(s) created when a Negotiation is awarded.  If you expected a document created review the Solution recommendations below.',
      p_solution               => 'Review these documents for possible causes and solutions. Alternatively, log and SR with this analyzer output to request assistance from Support on the issue.<br>
[2043734/KB640613] Sourcing RFQ Award to Create A Blanket Purchase Agreement end in System Error<br>
[2100153/KB542924] Error: Purchase Order Creation Could Not Be Initiated, When ship_to_location_id is Null in RFQ and Quote Line Prices Tables<br>
[2056843/KB430230] RFQ TO PO CREATION COULD NOT BE INITIATED: FAILING WHEN HAVE MULTIPLE ATTACHMENT<br>',
      p_success_msg            => 'Negotiation Line is AWARDED and there is a PO Line created for the Negotiation Line.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_AWARDEDLINE_NOPOLINECREATED');



debug('begin add_signature: PON_ACCEPTANCES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9038',
      p_sig_id                 => 'PON_ACCEPTANCES',
      p_sig_sql                => 'select pa.* from pon_acceptances pa, pon_auction_headers_all paha
where (pa.line_number like NVL(''##$$BID_LINE_NUMBER$$##'',''%'')) 
and (pa.bid_number like NVL(''##$$BID_NUMBER$$##'',''%'')) 
and ((pa.bid_number like NVL(''##$$BID_NUMBER$$##'',''%'')) 
      or (pa.bid_number in (select distinct bid_number 
                          from pon_bid_headers pbh, pon_auction_headers_all paha
                          where upper(pbh.trading_partner_name) like concat(concat(''%'',upper(''##$$BIDDING_SUPPLIER$$##'')),''%'') 
                          and pbh.auction_header_id = paha.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') 
                          and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##)))
and (pa.auction_line_number like NVL(''##$$LINE_NUMBER$$##'',''%'')) and pa.auction_header_id = PAHA.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'PON_ACCEPTANCES for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Supplier Acceptances for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Supplier Acceptances found for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_ACCEPTANCES');



debug('begin add_signature: PON_SCORING_TEAMS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8725',
      p_sig_id                 => 'PON_SCORING_TEAMS',
      p_sig_sql                => 'select pst.*
FROM PON_SCORING_TEAMS pst, pon_auction_headers_all paha
WHERE pst.auction_header_id = PAHA.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'PON_SCORING_TEAMS for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Scoring Teams for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Scoring Teams found for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_SCORING_TEAMS');



debug('begin add_signature: PON_SCORING_TEAM_MEMBERS');
   l_info('##MASK##FULL_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8726',
      p_sig_id                 => 'PON_SCORING_TEAM_MEMBERS',
      p_sig_sql                => 'select pstm.auction_header_id, pstm.team_id, pecx.full_name, pstm.creation_date, pstm.created_by, pstm.last_update_date, pstm.last_updated_by, pstm.last_update_login
from PON_SCORING_TEAM_MEMBERS pstm, fnd_user fndu, per_employees_current_x pecx, pon_auction_headers_all paha
WHERE pecx.employee_id = fndu.employee_id
and fndu.user_id = pstm.user_id
and pstm.auction_header_id = PAHA.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'PON_SCORING_TEAM_MEMBERS for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Scoring Team Members for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Scoring Team Members found for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_SCORING_TEAM_MEMBERS');



debug('begin add_signature: PON_SCORING_TEAM_SECTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8727',
      p_sig_id                 => 'PON_SCORING_TEAM_SECTIONS',
      p_sig_sql                => 'select pas.section_name, psts.*
from PON_SCORING_TEAM_SECTIONS psts, PON_AUCTION_SECTIONS pas, PON_AUCTION_HEADERS_ALL paha
WHERE pas.section_id = psts.section_id 
and pas.auction_header_id = psts.auction_header_id
and psts.auction_header_id = PAHA.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'PON_SCORING_TEAM_SECTIONS for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Scoring Team Sections for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Scoring Team Sections found for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_SCORING_TEAM_SECTIONS');



debug('begin add_signature: EBS_MFG_PON_NEED_BY_DATE_VALIDATION_REQ_PO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30759',
      p_sig_id                 => 'EBS_MFG_PON_NEED_BY_DATE_VALIDATION_REQ_PO',
      p_sig_sql                => 'SELECT
    pah.document_number "Negotiation Number",
    paip.line_number       "Negotiation Line Num",
    pbip.bid_number        "Bid Number",
    pbip.line_number       "Bid Line Num",
    prh.segment1           "Requisition Number",
    prl.line_num           "Requisition Line Num",
    prl.need_by_date       "Requisition Line Need By Date",
    poh.segment1           "PO Number",
    pla.line_num           "PO Line Num",
    poll.shipment_num      "PO Shipment Num",
    poll.need_by_date      "PO Shipment Need By Date",
...
WHERE
    ...
    AND poll.po_line_id = pla.po_line_id
    AND poll.po_header_id = pla.po_header_id
    AND pah.auction_header_id = paip.auction_header_id
    AND paip.auction_header_id = prl.auction_header_id
    AND prl.auction_line_number = paip.line_number
    AND pbh.auction_header_id = pah.auction_header_id
and pbh.bid_number like NVL(''##$$BID_NUMBER$$##'',''%'')
    AND pbh.bid_number = prl.bid_number
    AND pbh.auction_header_id = pbip.auction_header_id
and prl.bid_line_number like NVL(''##$$BID_LINE_NUMBER$$##'',''%'')
    AND pbip.line_number = prl.bid_line_number
    AND paip.line_number = pbip.auction_line_number
    AND paip.auction_header_id = pbip.auction_header_id
    AND nvl(prl.on_rfq_flag, ''N'') = ''Y''
    AND prl.need_by_date <> poll.need_by_date
    AND nvl(poh.revision_num, 0) = 0
and  NVL(pah.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') 
    AND pah.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##
ORDER BY
    prl.line_num',
      p_title                  => 'Need By Date Validation Between Requisition Line(s) and Corresponding PO Shipments',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'For one or more of the backing requisition line(s), Need-By Date is different on the corresponding PO Shipment.  If this was manually changed intentionally you may ignore this warning.  However, if you expect the PO Shipments should have used the same Need-By Dates as specified on the individual backing requisition lines review the Solution recommendations here.',
      p_solution               => 'Please review [3062150/KB513859] for the Solution details.',
      p_success_msg            => 'No action is needed. 
There are no requisition lines with Need-By Date different from corresponding PO shipment.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PON_NEED_BY_DATE_VALIDATION_REQ_PO');



debug('begin add_signature: PON_FND_ATTACHED_DOCUMENTS_AUCTION_HEADERS');
   l_info('##MASK##ATTRIBUTE1'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE10'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE11'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE12'):= 'DISPLAY_FIRST_25_PCNT';
  ...
  add_signature(
      p_sig_repo_id            => '9052',
      p_sig_id                 => 'PON_FND_ATTACHED_DOCUMENTS_AUCTION_HEADERS',
      p_sig_sql                => 'select paha.auction_header_id, fdt.language, fdt.file_name, fdt.media_id, fad.* 
from fnd_attached_documents fad, fnd_documents_tl fdt, pon_auction_headers_all paha
where fdt.document_id = fad.document_id
and fad.entity_name = ''PON_AUCTION_HEADERS_ALL'' 
and fad.pk1_value = paha.auction_header_id
and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'FND_ATTACHED_DOCUMENTS for PON_AUCTION_HEADERS_ALL for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Attachments for Negotiation Header',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No attachments found for Negotiation Header.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_FND_ATTACHED_DOCUMENTS_AUCTION_HEADERS');



debug('begin add_signature: PON_FND_ATTACHED_DOCUMENTS_AUCTION_ITEM_PRICES');
   l_info('##MASK##ATTRIBUTE1'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE10'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE11'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE12'):= 'DISPLAY_FIRST_25_PCNT';
  ...
  add_signature(
      p_sig_repo_id            => '9400',
      p_sig_id                 => 'PON_FND_ATTACHED_DOCUMENTS_AUCTION_ITEM_PRICES',
      p_sig_sql                => 'select paip.auction_header_id, paip.line_number, fdt.language, fdt.file_name, fdt.media_id, fad.* 
from fnd_attached_documents fad, fnd_documents_tl fdt, pon_auction_item_prices_all paip, pon_auction_headers_all paha
where fdt.document_id = fad.document_id and fad.entity_name in (''PON_AUCTION_ITEM_PRICES_ALL'') 
and fad.pk2_value = paip.line_number and fad.pk1_value = paip.auction_header_id
and paip.line_number like NVL(''##$$LINE_NUMBER$$##'',''%'') and paip.auction_header_id = PAHA.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'FND_ATTACHED_DOCUMENTS for PON_AUCTION_ITEM_PRICES_ALL for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Attachments for Negotiation Lines',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No attachments found for Negotiation Lines.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_FND_ATTACHED_DOCUMENTS_AUCTION_ITEM_PRICES');



debug('begin add_signature: PON_FND_ATTACHED_DOCUMENTS_BID_HEADERS');
   l_info('##MASK##ATTRIBUTE1'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE10'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE11'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE12'):= 'DISPLAY_FIRST_25_PCNT';
  ...
  add_signature(
      p_sig_repo_id            => '9402',
      p_sig_id                 => 'PON_FND_ATTACHED_DOCUMENTS_BID_HEADERS',
      p_sig_sql                => 'select pbh.auction_header_id, pbh.bid_number, fdt.language, fdt.file_name, fdt.media_id, fad.* 
from fnd_attached_documents fad, fnd_documents_tl fdt , pon_bid_headers pbh, pon_auction_headers_all paha
where fdt.document_id = fad.document_id and fad.entity_name in (''PON_BID_HEADERS'')
and fad.pk2_value = pbh.bid_number
and fad.pk1_value = pbh.auction_header_id
and (pbh.bid_number like NVL(''##$$BID_NUMBER$$##'',''%'')) 
and ((pbh.bid_number like NVL(''##$$BID_NUMBER$$##'',''%'')) 
      or (pbh.bid_number in (select distinct bid_number 
                          from pon_bid_headers pbh, pon_auction_headers_all paha
                          ...
                          and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##)))
and pbh.auction_header_id = paha.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'FND_ATTACHED_DOCUMENTS for PON_BID_HEADERS for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Attachments for Bids / Quotes for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No attachments found for Bids / Quotes for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_FND_ATTACHED_DOCUMENTS_BID_HEADERS');



debug('begin add_signature: PON_FND_ATTACHED_DOCUMENTS_BID_ITEM_PRICES');
   l_info('##MASK##ATTRIBUTE1'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE10'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE11'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE12'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE13'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE14'):= 'DISPLAY_NONE';
   l_info('##MASK##ATTRIBUTE15'):= 'DISPLAY_NONE';
   l_info('##MASK##ATTRIBUTE2'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE3'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE4'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE5'):= 'DISPLAY_FIRST_25_PCNT';
  ...
  add_signature(
      p_sig_repo_id            => '9403',
      p_sig_id                 => 'PON_FND_ATTACHED_DOCUMENTS_BID_ITEM_PRICES',
      p_sig_sql                => 'select pbip.auction_header_id, pbip.bid_number, pbip.line_number, fdt.language, fdt.file_name, fdt.media_id, fad.* 
from fnd_attached_documents fad, fnd_documents_tl fdt , pon_bid_item_prices pbip, pon_auction_headers_all paha
where fdt.document_id = fad.document_id and fad.entity_name in (''PON_BID_ITEM_PRICES'')
and fad.pk3_value = pbip.line_number
and fad.pk2_value = pbip.bid_number
and fad.pk1_value = pbip.auction_header_id
and (pbip.line_number like NVL(''##$$BID_LINE_NUMBER$$##'',''%'')) 
and (pbip.bid_number like NVL(''##$$BID_NUMBER$$##'',''%'')) 
and ((pbip.bid_number like NVL(''##$$BID_NUMBER$$##'',''%'')) 
      or (pbip.bid_number in (select distinct bid_number 
                          from pon_bid_headers pbh, pon_auction_headers_all paha
                          where upper(pbh.trading_partner_name) like concat(concat(''%'',upper(''##$$BIDDING_SUPPLIER$$##'')),''%'') 
                          and pbh.auction_header_id = paha.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') 
                          and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##)))
...
and pbip.auction_header_id = PAHA.auction_header_id 
and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'FND_ATTACHED_DOCUMENTS for PON_BID_ITEM_PRICES for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Attachments for Bid Item Prices for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No attachments found for Bid Item Prices for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_FND_ATTACHED_DOCUMENTS_BID_ITEM_PRICES');



debug('begin add_signature: PON_FND_ATTACHED_DOCUMENTS_OKC_CONTRACT_DOCS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9404',
      p_sig_id                 => 'PON_FND_ATTACHED_DOCUMENTS_OKC_CONTRACT_DOCS',
      p_sig_sql                => 'SELECT cdoc.business_document_id, cdoc.business_document_type, cdoc.business_document_id, contract_source_code, otu.document_id, 
 cdoc.business_document_id, cdoc.business_document_type, cdoc.attached_document_id, 
 fad.DOCUMENT_ID "FAD.DOCUMENT_ID", fad.creation_date, fad.created_by, fad.last_update_date, fad.last_updated_by, fad.last_update_login, fad.seq_num, fad.PK1_value, fad.PK2_value, fad.automatically_added_flag, fad.program_id, fad.program_update_date, fad.category_id, fad.orig_attach_doc_id
  FROM okc_template_usages otu, pon_auction_headers_all paha, okc_contract_docs cdoc, fnd_attached_documents fad
  WHERE (fad.entity_name like ''OKC_CONTRACT_DOCS'' and fad.pk1_value = otu.document_type and fad.pk2_value = otu.document_id)
    and (cdoc.business_document_type in (''AUCTION'', ''RFI'', ''RFQ'', ''SOLICITATION''))
  AND cdoc.business_document_type  = otu.document_type
  AND cdoc.business_document_id  = otu.document_id
  AND otu.document_id = paha.auction_header_id
  AND NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##
UNION
 SELECT cdoc.business_document_id, cdoc.business_document_type, cdoc.business_document_id, contract_source_code, otu.document_id, 
 cdoc.business_document_id, cdoc.business_document_type, cdoc.attached_document_id, 
  fad.DOCUMENT_ID "FAD.DOCUMENT_ID", fad.creation_date, fad.created_by, fad.last_update_date, fad.last_updated_by, fad.last_update_login, fad.seq_num, fad.PK1_value, fad.PK2_value, fad.automatically_added_flag, fad.program_id, fad.program_update_date, fad.category_id, fad.orig_attach_doc_id
  FROM okc_template_usages otu, pon_bid_headers pbh, pon_auction_headers_all paha, okc_contract_docs cdoc, fnd_attached_documents fad
  WHERE (fad.entity_name like ''OKC_CONTRACT_DOCS'' and fad.pk1_value = otu.document_type and fad.pk2_value = otu.document_id)
  AND (cdoc.business_document_type IN (''AUCTION_RESPONSE'', ''RFQ_RESPONSE'', ''RFI_RESPONSE'', ''SOLICITATION_RESPONSE''))
  AND cdoc.business_document_type  = otu.document_type
  AND cdoc.business_document_id  = otu.document_id  
  AND otu.document_id = pbh.bid_number
  AND (pbh.bid_number like NVL(''##$$BID_NUMBER$$##'',''%'')) 
  and ((pbh.bid_number like NVL(''##$$BID_NUMBER$$##'',''%'')) 
      or (pbh.bid_number in (select distinct bid_number 
                          from pon_bid_headers pbh, pon_auction_headers_all paha
...
and pbh.auction_header_id = paha.auction_header_id 
and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'FND_ATTACHED_DOCUMENTS for OKC_CONTRACT_DOCS for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Attachments for Contract Documents for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Attachments found for Contract Documents for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_FND_ATTACHED_DOCUMENTS_OKC_CONTRACT_DOCS');



debug('begin add_signature: PON_OKC_TEMPLATE_USAGES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9408',
      p_sig_id                 => 'PON_OKC_TEMPLATE_USAGES',
      p_sig_sql                => 'select paha.auction_header_id_orig_round, otu.* from OKC_TEMPLATE_USAGES otu, pon_auction_headers_all paha
where otu.document_type in (''AUCTION'', ''RFI'', ''RFQ'', ''SOLICITATION'')
and otu.document_id = paha.auction_header_id
AND NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$## 
UNION ALL
select pbh.bid_number, otu.* from OKC_TEMPLATE_USAGES otu, pon_bid_headers pbh, pon_auction_headers_all paha
where otu.document_type in (''AUCTION_RESPONSE'', ''RFI_RESPONSE'', ''RFQ_RESPONSE'', ''SOLICITATION_RESPONSE'')
and otu.document_id = pbh.bid_number
AND (pbh.bid_number like NVL(''##$$BID_NUMBER$$##'',''%'')) 
and ((pbh.bid_number like NVL(''##$$BID_NUMBER$$##'',''%'')) 
      or (pbh.bid_number in (select distinct bid_number 
...
and pbh.auction_header_id = paha.auction_header_id 
and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'OKC_TEMPLATE_USAGES for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Contract Template Usages for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Contract Template Usages found for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_OKC_TEMPLATE_USAGES');



debug('begin add_signature: PON_FND_ATTACHED_DOCUMENTS_OKC_TEMPLATE_USAGES');
   l_info('##MASK##ATTRIBUTE1'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE10'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE11'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE12'):= 'DISPLAY_FIRST_25_PCNT';
  ...
  add_signature(
      p_sig_repo_id            => '9409',
      p_sig_id                 => 'PON_FND_ATTACHED_DOCUMENTS_OKC_TEMPLATE_USAGES',
      p_sig_sql                => 'select distinct otta.template_id, otta.template_name, otu.document_type, otu.document_id, otu.document_number, 
wfiav.item_type, wfiav.item_key, wfiav.name, fdt.language, fdt.file_name, fdt.media_id, fad.*
from fnd_attached_documents fad, fnd_documents_tl fdt, okc_terms_templates_all otta, wf_item_attribute_values wfiav, okc_template_usages otu, pon_auction_headers_all paha
where REGEXP_SUBSTR(wfiav.text_value, ''pk1value=(\d+)'', 1, 1, ''i'', 1) = otu.template_id
and wfiav.item_type (+) = ''OKCTPAPP''
and fdt.document_id = fad.document_id and fad.entity_name in (''OKC_TERMS_TEMPLATES'')
and fad.pk1_value = otta.template_id
and otta.template_id = otu.template_id
and otu.document_type in (''AUCTION'', ''RFI'', ''RFQ'', ''SOLICITATION'') and otu.document_id = paha.auction_header_id
AND NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$## 
UNION ALL
select distinct otta.template_id, otta.template_name, otu.document_type, otu.document_id, otu.document_number, 
wfiav.item_type, wfiav.item_key, wfiav.name, fdt.language, fdt.file_name, fdt.media_id, fad.*
from fnd_attached_documents fad, fnd_documents_tl fdt, okc_terms_templates_all otta, wf_item_attribute_values wfiav, okc_template_usages otu, pon_bid_headers pbh, pon_auction_headers_all paha
where REGEXP_SUBSTR(wfiav.text_value, ''pk1value=(\d+)'', 1, 1, ''i'', 1) = otu.template_id
and wfiav.item_type (+) = ''OKCTPAPP''
and fdt.document_id = fad.document_id and fad.entity_name in (''OKC_TERMS_TEMPLATES'')
and fad.pk1_value = otta.template_id
and otta.template_id = otu.template_id
and otu.document_type in (''AUCTION_RESPONSE'', ''RFI_RESPONSE'', ''RFQ_RESPONSE'', ''SOLICITATION_RESPONSE'') and otu.document_id = pbh.bid_number
AND (pbh.bid_number like NVL(''##$$BID_NUMBER$$##'',''%'')) 
and ((pbh.bid_number like NVL(''##$$BID_NUMBER$$##'',''%'')) 
      or (pbh.bid_number in (select distinct bid_number 
                          from pon_bid_headers pbh, pon_auction_headers_all paha
...
and pbh.auction_header_id = paha.auction_header_id 
and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'FND_ATTACHED_DOCUMENTS for OKC_TEMPLATE_USAGES for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Attachments for Contract Template Usages for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No attachments found for Contract Template Usages for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_FND_ATTACHED_DOCUMENTS_OKC_TEMPLATE_USAGES');



debug('begin add_signature: PON_OKC_TERMS_DEVIATIONS_T');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9410',
      p_sig_id                 => 'PON_OKC_TERMS_DEVIATIONS_T',
      p_sig_sql                => 'select otdt.* from OKC_TERMS_DEVIATIONS_T otdt, pon_auction_headers_all paha
where otdt.document_type in (''AUCTION'', ''RFI'', ''RFQ'', ''SOLICITATION'') and otdt.document_id = paha.auction_header_id
AND NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##
UNION ALL
select otdt.* from OKC_TERMS_DEVIATIONS_T otdt, pon_bid_headers pbh, pon_auction_headers_all paha
where otdt.document_type in (''AUCTION_RESPONSE'', ''RFI_RESPONSE'', ''RFQ_RESPONSE'', ''SOLICITATION_RESPONSE'') and otdt.document_id = pbh.bid_number
AND (pbh.bid_number like NVL(''##$$BID_NUMBER$$##'',''%'')) 
and ((pbh.bid_number like NVL(''##$$BID_NUMBER$$##'',''%'')) 
      or (pbh.bid_number in (select distinct bid_number 
                          from pon_bid_headers pbh, pon_auction_headers_all paha
...
and pbh.auction_header_id = paha.auction_header_id 
and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'OKC_TERMS_DEVIATIONS_T for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Contract Terms Deviations for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Contract Terms Deviations found for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_OKC_TERMS_DEVIATIONS_T');



debug('begin add_signature: PON_OKC_DELIVERABLES');
   l_info('##MASK##ATTRIBUTE1'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE10'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE11'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE12'):= 'DISPLAY_FIRST_25_PCNT';
  ...
  add_signature(
      p_sig_repo_id            => '9411',
      p_sig_id                 => 'PON_OKC_DELIVERABLES',
      p_sig_sql                => 'select od.* from OKC_DELIVERABLES od, pon_auction_headers_all paha
where od.business_document_type in (''AUCTION'', ''RFI'', ''RFQ'', ''SOLICITATION'') and od.business_document_id = paha.auction_header_id
AND NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$## 
UNION ALL
select od.* from OKC_DELIVERABLES od, pon_bid_headers pbh, pon_auction_headers_all paha
where od.business_document_type in (''AUCTION_RESPONSE'', ''RFI_RESPONSE'', ''RFQ_RESPONSE'', ''SOLICITATION_RESPONSE'') and od.business_document_id = pbh.bid_number
AND (pbh.bid_number like NVL(''##$$BID_NUMBER$$##'',''%'')) 
and ((pbh.bid_number like NVL(''##$$BID_NUMBER$$##'',''%'')) 
      or (pbh.bid_number in (select distinct bid_number 
                          from pon_bid_headers pbh, pon_auction_headers_all paha
...
and pbh.auction_header_id = paha.auction_header_id 
and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'OKC_DELIVERABLES for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Contract Deliverables for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Contract Deliverables found for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_OKC_DELIVERABLES');



debug('begin add_signature: PON_ACTION_HISTORY');
   l_info('##MASK##USER_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##USER_NAME1'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8782',
      p_sig_id                 => 'PON_ACTION_HISTORY',
      p_sig_sql                => 'select fndu.user_name, PAH.*
 from PON_ACTION_HISTORY PAH, fnd_user fndu, pon_auction_headers_all paha
WHERE fndu.user_id = PAH.action_user_id
and PAH.object_id = paha.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##
order by object_id, object_id2, sequence_num',
      p_title                  => 'PON_ACTION_HISTORY for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Action History for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Action History found for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_ACTION_HISTORY');



debug('begin add_signature: PON_WFSTAT_PONAPPRV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9056',
      p_sig_id                 => 'PON_WFSTAT_PONAPPRV',
      p_sig_sql                => 'select PAHA.Auction_header_id AuctionHeaderId, PAHA.document_number, WFS.item_key, 
...
from WF_ITEM_ACTIVITY_STATUSES WFS,
     ...
     PON_AUCTION_HEADERS_ALL   PAHA
where 
     WFS.ITEM_TYPE          = ''PONAPPRV''
and  WFS.item_key         = paha.wf_approval_item_key 
and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$## 
...
order by WFS.ITEM_KEY, 
         WFS.BEGIN_DATE, 
         EXECUTION_TIME',
      p_title                  => 'WFSTAT for Negotiation PONAPPRV Workflow',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'WFSTAT for Negotiation Approval workflow',
      p_solution               => 'All records are shown.',
      p_success_msg            => 'No WFSTAT output generated for Negotiation Approval workflow.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_WFSTAT_PONAPPRV');



debug('begin add_signature: PON_WF_NOTIFICATIONS_PONAPPRV');
   l_info('##MASK##FROM_ROLE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FROM_USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MORE_INFO_ROLE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ORIGINAL_RECIPIENT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##RECIPIENT_ROLE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TO_USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9085',
      p_sig_id                 => 'PON_WF_NOTIFICATIONS_PONAPPRV',
      p_sig_sql                => 'select wfn.NOTIFICATION_ID, wfn.GROUP_ID, wfn.MESSAGE_TYPE, wfn.MESSAGE_NAME, wfn.RECIPIENT_ROLE, wfn.STATUS, wfn.ACCESS_KEY, wfn.MAIL_STATUS, wfn.PRIORITY, wfn.BEGIN_DATE, wfn.END_DATE, wfn.DUE_DATE, wfn.RESPONDER, wfn.USER_COMMENT, wfn.CALLBACK, wfn.CONTEXT, wfn.ORIGINAL_RECIPIENT, wfn.FROM_USER, wfn.TO_USER, wfn.SUBJECT, wfn.LANGUAGE, wfn.MORE_INFO_ROLE, wfn.FROM_ROLE, wfn.SECURITY_GROUP_ID, wfn.USER_KEY, wfn.ITEM_KEY 
from wf_notifications wfn
where wfn.notification_id in (select distinct WFS.NOTIFICATION_ID
from WF_ITEM_ACTIVITY_STATUSES WFS,
     WF_PROCESS_ACTIVITIES     WFP,
     WF_ACTIVITIES_VL          WFA,
     WF_ACTIVITIES_VL          WFA1,
...
order by wfn.notification_id desc',
      p_title                  => 'WF_NOTIFICATIONS for Negotiation PONAPPRV Workflow',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Notifications for Negotiation Approval workflow',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Notifications found for Negotiation Approval workflow.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_WF_NOTIFICATIONS_PONAPPRV');



debug('begin add_signature: PON_WFSTAT_PONAUCT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9055',
      p_sig_id                 => 'PON_WFSTAT_PONAUCT',
      p_sig_sql                => 'select PAHA.Auction_header_id AuctionHeaderId, PAHA.document_number, WFS.item_key, 
       WFA.DISPLAY_NAME      Process,
       WFA1.DISPLAY_NAME     Activity,
       WF_CORE.ACTIVITY_RESULT(WFA1.RESULT_TYPE,WFS.ACTIVITY_RESULT_CODE) Result,
...
from WF_ITEM_ACTIVITY_STATUSES WFS,
     ...
     PON_AUCTION_HEADERS_ALL   PAHA
where 
     WFS.ITEM_TYPE          = ''PONAUCT''
and  WFS.item_key         like concat(paha.auction_header_id, ''-%'')
and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##
and  WFS.PROCESS_ACTIVITY   = WFP.INSTANCE_ID
and  WFP.PROCESS_ITEM_TYPE  = WFA.ITEM_TYPE
and  WFP.PROCESS_NAME       = WFA.NAME
...
order by WFS.ITEM_KEY, 
         WFS.BEGIN_DATE, 
         EXECUTION_TIME',
      p_title                  => 'WFSTAT for Negotiation PONAUCT Workflow',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'WFSTAT for main Negotiation workflow',
      p_solution               => 'All records are shown.',
      p_success_msg            => 'No WFSTAT output generated for main Negotiation workflow.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_WFSTAT_PONAUCT');



debug('begin add_signature: PON_WF_NOTIFICATIONS_PONAUCT');
   l_info('##MASK##FROM_ROLE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FROM_USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MORE_INFO_ROLE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ORIGINAL_RECIPIENT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##RECIPIENT_ROLE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##RESPONDER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TO_USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9177',
      p_sig_id                 => 'PON_WF_NOTIFICATIONS_PONAUCT',
      p_sig_sql                => 'select wfn.NOTIFICATION_ID, wfn.GROUP_ID, wfn.MESSAGE_TYPE, wfn.MESSAGE_NAME, wfn.RECIPIENT_ROLE, wfn.STATUS, wfn.ACCESS_KEY, wfn.MAIL_STATUS, wfn.PRIORITY, wfn.BEGIN_DATE, wfn.END_DATE, wfn.DUE_DATE, wfn.RESPONDER, wfn.USER_COMMENT, wfn.CALLBACK, wfn.CONTEXT, wfn.ORIGINAL_RECIPIENT, wfn.FROM_USER, wfn.TO_USER, wfn.SUBJECT, wfn.LANGUAGE, wfn.MORE_INFO_ROLE, wfn.FROM_ROLE, wfn.SECURITY_GROUP_ID, wfn.USER_KEY, wfn.ITEM_KEY
from wf_notifications wfn
where wfn.notification_id in (select distinct WFS.NOTIFICATION_ID
from WF_ITEM_ACTIVITY_STATUSES WFS,
...
and LKP.LOOKUP_CODE = WFS.ACTIVITY_STATUS)
order by wfn.notification_id desc',
      p_title                  => 'WF_NOTIFICATIONS for Negotiation PONAUCT Workflow',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Notifications for main Negotiation workflow that manages activities such as start, rounds, and close.',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Notifications found for main Negotiation workflow that manages activities such as start, rounds, and close.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_WF_NOTIFICATIONS_PONAUCT');



debug('begin add_signature: EBS_MFG_PON_WF_ITEM_ATTRIBUTE_VALUES_MISSING_FOR_WF_PONAUCT_VAL_AUCTION_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30663',
      p_sig_id                 => 'EBS_MFG_PON_WF_ITEM_ATTRIBUTE_VALUES_MISSING_FOR_WF_PONAUCT_VAL_AUCTION_ID',
      p_sig_sql                => 'select paha.auction_header_id, paha.auction_header_id_orig_round, paha.auction_round_number, paha.auction_type, paha.auction_status, 
WFIAV.ITEM_TYPE item_type, WFIAV.ITEM_KEY item_key, WFIAV.NAME name, WFIAV.NUMBER_VALUE value
from WF_ITEM_ATTRIBUTE_VALUES WFIAV, pon_auction_headers_all paha
where NVL(WFIAV.ITEM_TYPE,''PONAUCT'') = ''PONAUCT''
and NVL(WFIAV.NAME,''AUCTION_ID'') = ''AUCTION_ID''
and WFIAV.NUMBER_VALUE(+) = paha.auction_header_id
and paha.auction_status NOT IN (''DRAFT'',''DELETED'')
and WFIAV.item_key(+) like concat(paha.auction_header_id, ''-%'')
and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') 
  and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'Workflow Attribute Values missing for PONAUCT workflow',
      p_fail_condition         => '[item_key] is null',
      p_problem_descr          => 'PONAUCT workflow data is found for the negotiation.  However, there is no corresponding data in WF_ITEMS_ATTRIBUTE_VALUES for this workflow item_type / item_key combination where the WF_ITEM_ATTRIBUTE_VALUES.NAME = ''AUCTION_ID''
and WF_ITEM_ATTRIBUTE_VALUES.NUMBER_VALUE = Auction_Header_Id value.',
      p_solution               => 'Review [2566992/KB602026] for solution options to solve this issue.',
      p_success_msg            => 'Workflow Item Attribute Values are present as expected.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PON_WF_ITEM_ATTRIBUTE_VALUES_MISSING_FOR_WF_PONAUCT_VAL_AUCTION_ID');



debug('begin add_signature: PON_WFSTAT_PONPBLSH');
   l_info('##MASK##TRADING_PARTNER_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9057',
      p_sig_id                 => 'PON_WFSTAT_PONPBLSH',
      p_sig_sql                => 'select PAHA.Auction_header_id AuctionHeaderId, PAHA.document_number, WFS.item_key, PBP.TRADING_PARTNER_NAME, WFS.ITEM_TYPE, WFS.ITEM_KEY, WFA.DISPLAY_NAME      Process,
        WFA1.DISPLAY_NAME     Activity,
        WF_CORE.ACTIVITY_RESULT(WFA1.RESULT_TYPE,WFS.ACTIVITY_RESULT_CODE) Result,
        LKP.MEANING           Act_status,
        WFS.NOTIFICATION_ID   Notif,
 ...
 from WF_ITEM_ACTIVITY_STATUSES WFS,
      ...
      PON_AUCTION_HEADERS_ALL   PAHA
 where 
      WFS.ITEM_TYPE          = ''PONPBLSH''
      and WFS.ITEM_KEY = PBP.WF_ITEM_KEY
...
and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##
 ...
 order by WFS.ITEM_KEY, 
          WFS.BEGIN_DATE, 
          EXECUTION_TIME',
      p_title                  => 'WFSTAT for Negotiation PONPBLSH Workflow',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'WFSTAT for Negotiation Publish workflow',
      p_solution               => 'All records are shown.',
      p_success_msg            => 'No WFSTAT output generated for Negotiation Publish workflow.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_WFSTAT_PONPBLSH');



debug('begin add_signature: PON_WF_NOTIFICATIONS_PONPBLSH');
   l_info('##MASK##FROM_ROLE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FROM_USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MORE_INFO_ROLE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ORIGINAL_RECIPIENT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '9081',
      p_sig_id                 => 'PON_WF_NOTIFICATIONS_PONPBLSH',
      p_sig_sql                => 'select wfn.NOTIFICATION_ID, wfn.GROUP_ID, wfn.MESSAGE_TYPE, wfn.MESSAGE_NAME, wfn.RECIPIENT_ROLE, wfn.STATUS, wfn.ACCESS_KEY, wfn.MAIL_STATUS, wfn.PRIORITY, wfn.BEGIN_DATE, wfn.END_DATE, wfn.DUE_DATE, wfn.RESPONDER, wfn.USER_COMMENT, wfn.CALLBACK, wfn.CONTEXT, wfn.ORIGINAL_RECIPIENT, wfn.FROM_USER, wfn.TO_USER, wfn.SUBJECT, wfn.LANGUAGE, wfn.MORE_INFO_ROLE, wfn.FROM_ROLE, wfn.SECURITY_GROUP_ID, wfn.USER_KEY, wfn.ITEM_KEY from wf_notifications wfn
where wfn.notification_id in
(
select distinct WFS.NOTIFICATION_ID
from WF_ITEM_ACTIVITY_STATUSES WFS,
WF_PROCESS_ACTIVITIES WFP,
WF_ACTIVITIES_VL WFA,
WF_ACTIVITIES_VL WFA1,
...
order by notification_id',
      p_title                  => 'WF_NOTIFICATIONS for Negotiation PONPBLSH Workflow',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Notifications for Negotiation Publish workflow',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Notifications found for Negotiation Publish workflow.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_WF_NOTIFICATIONS_PONPBLSH');



debug('begin add_signature: PON_WFSTAT_PONAWAPR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9058',
      p_sig_id                 => 'PON_WFSTAT_PONAWAPR',
      p_sig_sql                => 'select PAHA.Auction_header_id AuctionHeaderId, PAHA.document_number, WFS.item_key, WFA.DISPLAY_NAME      Process,
          WFA1.DISPLAY_NAME     Activity,
          WF_CORE.ACTIVITY_RESULT(WFA1.RESULT_TYPE,WFS.ACTIVITY_RESULT_CODE) Result,
          LKP.MEANING           Act_status,
          WFS.NOTIFICATION_ID   Notif,
   ...
   from WF_ITEM_ACTIVITY_STATUSES WFS,
        ...
        PON_AUCTION_HEADERS_ALL   PAHA
   where 
        WFS.ITEM_TYPE          = ''PONAWAPR''
   and  WFS.item_key         = paha.wf_award_approval_item_key
   and  NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##
   and  WFS.PROCESS_ACTIVITY   = WFP.INSTANCE_ID
   and  WFP.PROCESS_ITEM_TYPE  = WFA.ITEM_TYPE
   and  WFP.PROCESS_NAME       = WFA.NAME
   ...
   order by WFS.ITEM_KEY, 
            WFS.BEGIN_DATE, 
            EXECUTION_TIME',
      p_title                  => 'WFSTAT for Negotiation PONAWAPR Workflow',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'WFSTAT for Negotiation Award Approval workflow',
      p_solution               => 'All records are shown.',
      p_success_msg            => 'No WFSTAT output generated for Negotiation Award Approval workflow.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_WFSTAT_PONAWAPR');



debug('begin add_signature: PON_WF_NOTIFICATIONS_PONAWAPR');
   l_info('##MASK##FROM_ROLE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FROM_USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MORE_INFO_ROLE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ORIGINAL_RECIPIENT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '9178',
      p_sig_id                 => 'PON_WF_NOTIFICATIONS_PONAWAPR',
      p_sig_sql                => 'select wfn.NOTIFICATION_ID, wfn.GROUP_ID, wfn.MESSAGE_TYPE, wfn.MESSAGE_NAME, wfn.RECIPIENT_ROLE, wfn.STATUS, wfn.ACCESS_KEY, wfn.MAIL_STATUS, wfn.PRIORITY, wfn.BEGIN_DATE, wfn.END_DATE, wfn.DUE_DATE, wfn.RESPONDER, wfn.USER_COMMENT, wfn.CALLBACK, wfn.CONTEXT, wfn.ORIGINAL_RECIPIENT, wfn.FROM_USER, wfn.TO_USER, wfn.SUBJECT, wfn.LANGUAGE, wfn.MORE_INFO_ROLE, wfn.FROM_ROLE, wfn.SECURITY_GROUP_ID, wfn.USER_KEY, wfn.ITEM_KEY
from wf_notifications wfn
where wfn.notification_id in (select distinct WFS.NOTIFICATION_ID
from WF_ITEM_ACTIVITY_STATUSES WFS,
...
and LKP.LOOKUP_CODE = WFS.ACTIVITY_STATUS)
order by wfn.notification_id desc',
      p_title                  => 'WF_NOTIFICATIONS for Negotiation PONAWAPR Workflow',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Notifications for Negotiation Award Approval workflow',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Notifications found for Negotiation Award Approval workflow.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_WF_NOTIFICATIONS_PONAWAPR');



debug('begin add_signature: PON_WFSTAT_PONCOMPL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9059',
      p_sig_id                 => 'PON_WFSTAT_PONCOMPL',
      p_sig_sql                => 'select PAHA.Auction_header_id AuctionHeaderId, PAHA.document_number, WFS.item_key, WFA.DISPLAY_NAME      Process,
            WFA1.DISPLAY_NAME     Activity,
            WF_CORE.ACTIVITY_RESULT(WFA1.RESULT_TYPE,WFS.ACTIVITY_RESULT_CODE) Result,
            LKP.MEANING           Act_status,
     ...
     from WF_ITEM_ACTIVITY_STATUSES WFS,
          ...
          PON_AUCTION_HEADERS_ALL   PAHA
     where 
          WFS.ITEM_TYPE          = ''PONCOMPL''
     and  WFS.item_key         = paha.wf_poncompl_item_key
     and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##
     and  WFS.PROCESS_ACTIVITY   = WFP.INSTANCE_ID
     and  WFP.PROCESS_ITEM_TYPE  = WFA.ITEM_TYPE
     and  WFP.PROCESS_NAME       = WFA.NAME
     ...
     order by WFS.ITEM_KEY, 
              WFS.BEGIN_DATE, 
              EXECUTION_TIME',
      p_title                  => 'WFSTAT for Negotiation PONCOMPL Workflow',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'WFSTAT for Negotiation Completion workflow',
      p_solution               => 'All records are shown.',
      p_success_msg            => 'No WFSTAT output generated for Negotiation Completion workflow.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_WFSTAT_PONCOMPL');



debug('begin add_signature: PON_WF_NOTIFICATIONS_PONCOMPL');
   l_info('##MASK##FROM_ROLE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FROM_USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MORE_INFO_ROLE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ORIGINAL_RECIPIENT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '9083',
      p_sig_id                 => 'PON_WF_NOTIFICATIONS_PONCOMPL',
      p_sig_sql                => 'select wfn.NOTIFICATION_ID, wfn.GROUP_ID, wfn.MESSAGE_TYPE, wfn.MESSAGE_NAME, wfn.RECIPIENT_ROLE, wfn.STATUS, wfn.ACCESS_KEY, wfn.MAIL_STATUS, wfn.PRIORITY, wfn.BEGIN_DATE, wfn.END_DATE, wfn.DUE_DATE, wfn.RESPONDER, wfn.USER_COMMENT, wfn.CALLBACK, wfn.CONTEXT, wfn.ORIGINAL_RECIPIENT, wfn.FROM_USER, wfn.TO_USER, wfn.SUBJECT, wfn.LANGUAGE, wfn.MORE_INFO_ROLE, wfn.FROM_ROLE, wfn.SECURITY_GROUP_ID, wfn.USER_KEY, wfn.ITEM_KEY 
from wf_notifications wfn where wfn.notification_id in (select distinct WFS.NOTIFICATION_ID from WF_ITEM_ACTIVITY_STATUSES WFS, WF_PROCESS_ACTIVITIES WFP, WF_ACTIVITIES_VL WFA, WF_ACTIVITIES_VL WFA1, WF_LOOKUPS LKP, PON_AUCTION_HEADERS_ALL PAHA where WFS.ITEM_TYPE = ''PONCOMPL'' and WFS.item_key = paha.wf_poncompl_item_key and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$## and WFS.PROCESS_ACTIVITY = WFP.INSTANCE_ID and WFP.PROCESS_ITEM_TYPE = WFA.ITEM_TYPE and WFP.PROCESS_NAME = WFA.NAME and WFP.PROCESS_VERSION = WFA.VERSION and WFP.ACTIVITY_ITEM_TYPE = WFA1.ITEM_TYPE and WFP.ACTIVITY_NAME = WFA1.NAME and WFA1.VERSION = (select max(VERSION) from WF_ACTIVITIES WF2 where WF2.ITEM_TYPE = WFP.ACTIVITY_ITEM_TYPE and WF2.NAME = WFP.ACTIVITY_NAME) and LKP.LOOKUP_TYPE = ''WFENG_STATUS'' and LKP.LOOKUP_CODE = WFS.ACTIVITY_STATUS) 
order by wfn.notification_id',
      p_title                  => 'WF_NOTIFICATIONS for Negotiation PONCOMPL Workflow',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Notifications for Negotiation Completion workflow that creates Purchase documents for an awarded negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Notifications found for Negotiation Completion workflow that creates Purchase documents for an awarded negotiation',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_WF_NOTIFICATIONS_PONCOMPL');



debug('begin add_signature: PON_WFSTAT_PONTEVAL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13140',
      p_sig_id                 => 'PON_WFSTAT_PONTEVAL',
      p_sig_sql                => 'select pbh.bid_number, pbh.auction_header_id, WFS.item_type, WFS.item_key,
       WFA.DISPLAY_NAME      Process,
       WFA1.DISPLAY_NAME     Activity,
       WF_CORE.ACTIVITY_RESULT(WFA1.RESULT_TYPE,WFS.ACTIVITY_RESULT_CODE) Result,
       LKP.MEANING           Act_status,
...
from WF_ITEM_ACTIVITY_STATUSES WFS,
     ...
     PON_BID_HEADERS   PBH, PON_AUCTION_HEADERS_ALL PAHA
where
     WFS.ITEM_TYPE          = ''PONTEVAL''
and  WFS.item_key         like concat(pbh.bid_number, ''-%'')
...
order by WFS.ITEM_KEY,
         ...
         EXECUTION_TIME
',
      p_title                  => 'WFSTAT for Negotiation PONTEVAL Workflow',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'WFSTAT for Negotiation Technical Evaluation workflow For Technical Stage of Two-Stage Negotiations',
      p_solution               => 'All records are shown.',
      p_success_msg            => 'No WFSTAT output generated for Negotiation Technical Evaluation workflow.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_WFSTAT_PONTEVAL');



debug('begin add_signature: PON_WF_NOTIFICATIONS_PONTEVAL');
   l_info('##MASK##FROM_ROLE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FROM_USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MORE_INFO_ROLE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ORIGINAL_RECIPIENT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '13141',
      p_sig_id                 => 'PON_WF_NOTIFICATIONS_PONTEVAL',
      p_sig_sql                => 'select wfn.NOTIFICATION_ID, wfn.GROUP_ID, wfn.MESSAGE_TYPE, wfn.MESSAGE_NAME, wfn.RECIPIENT_ROLE, wfn.STATUS, wfn.ACCESS_KEY, wfn.MAIL_STATUS, wfn.PRIORITY, wfn.BEGIN_DATE, wfn.END_DATE, wfn.DUE_DATE, wfn.RESPONDER, wfn.USER_COMMENT, wfn.CALLBACK, wfn.CONTEXT, wfn.ORIGINAL_RECIPIENT, wfn.FROM_USER, wfn.TO_USER, wfn.SUBJECT, wfn.LANGUAGE, wfn.MORE_INFO_ROLE, wfn.FROM_ROLE, wfn.SECURITY_GROUP_ID, wfn.USER_KEY, wfn.ITEM_KEY
from wf_notifications wfn
where wfn.notification_id in (select distinct WFS.NOTIFICATION_ID
from WF_ITEM_ACTIVITY_STATUSES WFS,
...
order by wfn.notification_id desc',
      p_title                  => 'WF_NOTIFICATIONS for Negotiation PONTEVAL Workflow',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Notifications for Negotiation Technical Evaluation workflow For Technical Stage of Two-Stage Negotiation',
      p_solution               => 'Click the heading to view or hide the results. Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Notifications found for Negotiation Technical Evaluation workflow For Technical Stage of Two-Stage Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_WF_NOTIFICATIONS_PONTEVAL');



debug('begin add_signature: PON_WFSTAT_PONWDRAW');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13142',
      p_sig_id                 => 'PON_WFSTAT_PONWDRAW',
      p_sig_sql                => 'select pbh.bid_number, pbh.auction_header_id, WFS.item_type, WFS.item_key,
       WFA.DISPLAY_NAME      Process,
       WFA1.DISPLAY_NAME     Activity,
       WF_CORE.ACTIVITY_RESULT(WFA1.RESULT_TYPE,WFS.ACTIVITY_RESULT_CODE) Result,
...
order by WFS.ITEM_KEY,
         WFS.BEGIN_DATE,
         EXECUTION_TIME',
      p_title                  => 'WFSTAT for Negotiation PONWDRAW Workflow',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'WFSTAT for Negotiation Response Withdraw workflow',
      p_solution               => 'All records are shown.',
      p_success_msg            => 'No WFSTAT output generated for Negotiation Response Withdraw workflow.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_WFSTAT_PONWDRAW');



debug('begin add_signature: PON_WF_NOTIFICATIONS_PONWDRAW');
   l_info('##MASK##FROM_ROLE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FROM_USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MORE_INFO_ROLE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ORIGINAL_RECIPIENT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '13143',
      p_sig_id                 => 'PON_WF_NOTIFICATIONS_PONWDRAW',
      p_sig_sql                => 'select wfn.NOTIFICATION_ID, wfn.GROUP_ID, wfn.MESSAGE_TYPE, wfn.MESSAGE_NAME, wfn.RECIPIENT_ROLE, wfn.STATUS, wfn.ACCESS_KEY, wfn.MAIL_STATUS, wfn.PRIORITY, wfn.BEGIN_DATE, wfn.END_DATE, wfn.DUE_DATE, wfn.RESPONDER, wfn.USER_COMMENT, wfn.CALLBACK, wfn.CONTEXT, wfn.ORIGINAL_RECIPIENT, wfn.FROM_USER, wfn.TO_USER, wfn.SUBJECT, wfn.LANGUAGE, wfn.MORE_INFO_ROLE, wfn.FROM_ROLE, wfn.SECURITY_GROUP_ID, wfn.USER_KEY, wfn.ITEM_KEY
from wf_notifications wfn
where wfn.notification_id in (select distinct WFS.NOTIFICATION_ID
from WF_ITEM_ACTIVITY_STATUSES WFS,
...
and LKP.LOOKUP_CODE = WFS.ACTIVITY_STATUS)
order by wfn.notification_id desc',
      p_title                  => 'WF_NOTIFICATIONS for Negotiation PONWDRAW Workflow',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Notifications for Negotiation Response Withdraw workflow',
      p_solution               => 'Click the heading to view or hide the results. Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Notifications found for Negotiation Response Withdraw workflow.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_WF_NOTIFICATIONS_PONWDRAW');



debug('begin add_signature: EBS_MFG_PO_PON_WFSTAT_PONCNCT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23811',
      p_sig_id                 => 'EBS_MFG_PO_PON_WFSTAT_PONCNCT',
      p_sig_sql                => 'select PAHA.Auction_header_id AuctionHeaderId, PAHA.document_number, 
WFS.item_key, 
       WFA.DISPLAY_NAME      Process,
       WFA1.DISPLAY_NAME     Activity,
       WF_CORE.ACTIVITY_RESULT(WFA1.RESULT_TYPE,WFS.ACTIVITY_RESULT_CODE) Result,
...
from WF_ITEM_ACTIVITY_STATUSES WFS,
     ...
     PON_AUCTION_HEADERS_ALL   PAHA
where 
     WFS.ITEM_TYPE          = ''PONCNCT''
and  WFS.item_key         like concat(paha.auction_header_id_orig_round,''%'') 
and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') 
and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$## 
and  WFS.PROCESS_ACTIVITY   = WFP.INSTANCE_ID
and  WFP.PROCESS_ITEM_TYPE  = WFA.ITEM_TYPE
...
order by WFS.ITEM_KEY, 
         WFS.BEGIN_DATE, 
         EXECUTION_TIME',
      p_title                  => 'WFSTAT for Negotiation PONCNCT Workflow',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'WFSTAT for Negotiation Concurrent workflow - (This workflow is not intended to by run by the users, but is run automatically by the system for certain Sourcing concurrent requests)',
      p_solution               => 'All records are shown.',
      p_success_msg            => 'No WFSTAT output generated for Negotiation Concurrent workflow.  (This workflow is not intended to by run by the users, but is run automatically by the system for certain Sourcing concurrent requests)',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_PON_WFSTAT_PONCNCT');



debug('begin add_signature: EBS_MFG_PO_PON_WF_NOTIFICATIONS_PONCNCT');
   l_info('##MASK##FROM_ROLE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FROM_USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MORE_INFO_ROLE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ORIGINAL_RECIPIENT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '23812',
      p_sig_id                 => 'EBS_MFG_PO_PON_WF_NOTIFICATIONS_PONCNCT',
      p_sig_sql                => 'select wfn.NOTIFICATION_ID, wfn.GROUP_ID, wfn.MESSAGE_TYPE, wfn.MESSAGE_NAME, wfn.RECIPIENT_ROLE, wfn.STATUS, wfn.ACCESS_KEY, wfn.MAIL_STATUS, wfn.PRIORITY, 
wfn.BEGIN_DATE, wfn.END_DATE, wfn.DUE_DATE, wfn.RESPONDER, wfn.USER_COMMENT, wfn.CALLBACK, wfn.CONTEXT, wfn.ORIGINAL_RECIPIENT, wfn.FROM_USER, wfn.TO_USER, 
wfn.SUBJECT, wfn.LANGUAGE, wfn.MORE_INFO_ROLE, wfn.FROM_ROLE, wfn.SECURITY_GROUP_ID, wfn.USER_KEY, wfn.ITEM_KEY 
from wf_notifications wfn 
where wfn.notification_id in 
  (select distinct WFS.NOTIFICATION_ID 
  from WF_ITEM_ACTIVITY_STATUSES WFS, WF_PROCESS_ACTIVITIES WFP, WF_ACTIVITIES_VL WFA, WF_ACTIVITIES_VL WFA1, WF_LOOKUPS LKP, PON_AUCTION_HEADERS_ALL PAHA 
  where 
  WFS.ITEM_TYPE = ''PONCNCT'' and WFS.item_key = paha.wf_poncompl_item_key 
  and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') 
  and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$## 
  and WFS.PROCESS_ACTIVITY = WFP.INSTANCE_ID and WFP.PROCESS_ITEM_TYPE = WFA.ITEM_TYPE and WFP.PROCESS_NAME = WFA.NAME and WFP.PROCESS_VERSION = WFA.VERSION 
  and WFP.ACTIVITY_ITEM_TYPE = WFA1.ITEM_TYPE and WFP.ACTIVITY_NAME = WFA1.NAME 
  and WFA1.VERSION = (select max(VERSION) from WF_ACTIVITIES WF2 where WF2.ITEM_TYPE = WFP.ACTIVITY_ITEM_TYPE and WF2.NAME = WFP.ACTIVITY_NAME) 
  and LKP.LOOKUP_TYPE = ''WFENG_STATUS'' and LKP.LOOKUP_CODE = WFS.ACTIVITY_STATUS) 
order by wfn.notification_id desc
',
      p_title                  => 'WF_NOTIFICATIONS for Negotiation PONCNCT Workflow',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Notifications for Negotiation Concurrent workflow (This workflow is not run by the users, but is run by the system for certain Sourcing concurrent requests.  Refer to [2101833/KB504457] for a list of the concurrent requests)',
      p_solution               => 'Click the heading to view or hide the results.  Only the most recent '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Notifications found for Negotiation Concurrent workflow.  (This workflow is not run by the users, but is run by the system for certain Sourcing concurrent requests)',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_PON_WF_NOTIFICATIONS_PONCNCT');



debug('begin add_signature: EBS_MFG_PO_PON_WF_NOTIFICATION_PONCNCT_2101833_1');
   l_info('##MASK##FROM_ROLE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FROM_USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MORE_INFO_ROLE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ORIGINAL_RECIPIENT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '23814',
      p_sig_id                 => 'EBS_MFG_PO_PON_WF_NOTIFICATION_PONCNCT_2101833_1',
      p_sig_sql                => 'select wfn.NOTIFICATION_ID, wfn.GROUP_ID, wfn.MESSAGE_TYPE, wfn.MESSAGE_NAME, wfn.RECIPIENT_ROLE, wfn.STATUS, wfn.ACCESS_KEY, wfn.MAIL_STATUS, wfn.PRIORITY, 
wfn.BEGIN_DATE, wfn.END_DATE, wfn.DUE_DATE, wfn.RESPONDER, wfn.USER_COMMENT, wfn.CALLBACK, wfn.CONTEXT, wfn.ORIGINAL_RECIPIENT, wfn.FROM_USER, wfn.TO_USER, 
wfn.SUBJECT, wfn.LANGUAGE, wfn.MORE_INFO_ROLE, wfn.FROM_ROLE, wfn.SECURITY_GROUP_ID, wfn.USER_KEY, wfn.ITEM_KEY 
from wf_notifications wfn 
where wfn.notification_id in 
  ...
  from WF_ITEM_ACTIVITY_STATUSES WFS, WF_PROCESS_ACTIVITIES WFP, WF_ACTIVITIES_VL WFA, WF_ACTIVITIES_VL WFA1, WF_LOOKUPS LKP, PON_AUCTION_HEADERS_ALL PAHA 
  where 
  subject like ''%Error in Workflow PONCNCT%is not a valid role or user name%'' 
  and WFS.ITEM_TYPE = ''PONCNCT'' --and WFS.item_key = paha.wf_poncompl_item_key 
  and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') 
  and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##
  and WFS.PROCESS_ACTIVITY = WFP.INSTANCE_ID and WFP.PROCESS_ITEM_TYPE = WFA.ITEM_TYPE and WFP.PROCESS_NAME = WFA.NAME and WFP.PROCESS_VERSION = WFA.VERSION 
  and WFP.ACTIVITY_ITEM_TYPE = WFA1.ITEM_TYPE and WFP.ACTIVITY_NAME = WFA1.NAME 
...
order by wfn.notification_id desc
',
      p_title                  => 'Workflow PONCNCT Error - Username Is Not a Valid Role or User Name',
      p_fail_condition         => 'RS',
      p_problem_descr          => '<p>Notifications for Negotiation Concurrent workflow encountered an error.</p>
<p>The concurrent requests that run this  workflow are not intended to be run by the users.  This workflow is intended to only be run by the system when processing certain Sourcing concurrent requests.</p>
<p>Refer to [2101833/KB504457] for a list of the Sourcing concurrent requests which automatically run this workflow.  If executed manually by a user, the concurrent request will be missing some of the input parameters, and the workflow process will error out as described in [2101833/KB504457].  To avoid this error, do not run these concurrent requests manually.  These should only be run automatically by the Sourcing application, not by the user.</p>

',
      p_solution               => 'Click the heading to view or hide the results.  Only the most recent '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows with this error are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No PONCNCT workflow errors occurred like the error described in [2101833/KB504457].  (NOTE: This workflow is not intended to be run by the users, but is run by the system for certain Sourcing concurrent requests.  No error is expected for this workflow if it is run by the system.  However, it will error out if one of the corresponding concurrent requests is run by a user.)',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_PON_WF_NOTIFICATION_PONCNCT_2101833_1');



debug('begin add_signature: PON_WF_ITEM_ACTIVITY_STATUSES_ERROR');
   l_info('##MASK##ASSIGNED_USER'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9176',
      p_sig_id                 => 'PON_WF_ITEM_ACTIVITY_STATUSES_ERROR',
      p_sig_sql                => 'select pw.pon_item_type item_type, pw.pon_item_key item_key, pw.auction_header_id auction_header_id, pw.document_number document_number, wfias.*
from wf_item_activity_statuses wfias, (select pon_item_type, pon_item_key, auction_header_id, document_number
from 
  (select ''PONAPPRV'' pon_item_type, paha.wf_approval_item_key pon_item_key, paha.auction_header_id auction_header_id, paha.document_number document_number
  from PON_AUCTION_HEADERS_ALL PAHA
  where NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##)
  UNION ALL
  (select ''PONAUCT'' pon_item_type, paha.wf_item_key pon_item_key, paha.auction_header_id auction_header_id, paha.document_number document_number
  from PON_AUCTION_HEADERS_ALL PAHA
  where NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##)
  UNION ALL
  (select distinct ''PONPBLSH'' pon_item_type, pbp.wf_item_key pon_item_key, paha.auction_header_id auction_header_id, paha.document_number document_number
  from PON_BIDDING_PARTIES PBP, PON_AUCTION_HEADERS_ALL PAHA
  where pbp.auction_header_id = paha.auction_header_id
  and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##)
  UNION ALL
  (select ''PONAWAPR'' pon_item_type, paha.wf_award_approval_item_key pon_item_key, paha.auction_header_id auction_header_id, paha.document_number document_number
  from PON_AUCTION_HEADERS_ALL PAHA
  where NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##)
  UNION ALL
  (select ''PONCOMPL'' pon_item_type, paha.wf_poncompl_item_key pon_item_key, paha.auction_header_id auction_header_id, paha.document_number document_number
  from PON_AUCTION_HEADERS_ALL PAHA
  where NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##)
) pw
where 
not error_message like ''9004: An error has occurred in workflow processing: 3835: Error%ORA-20002: 2018: Unable to generate the notification XML. Caused by: 2020: Error when getting notification content%ORA-06502: PL/SQL: numeric or value error: character string buffer too small%GEN_INVITE_ADD_CONT_RESP_BODY%PON_INV_RESP_ADD_CONT_BODY%WF_XML.Generate%''
and not (error_message like ''3124: Process%PUBLISH_MAIN%for item%PONPBLSH%is not active.%'' and error_stack like ''%Wf_Engine.AbortProcess(PONPBLSH,%Wf_Engine_Util.Function_Call(PON_AUCTION_PKG.NOTIFY_BIDDER_LIST_REMINDER%RUN)%'')
and not (error_message = ''ORA-06502: PL/SQL: numeric or value error: character string buffer too small'' and error_stack like ''%Wf_Engine_Util.Function_Call(PON_AUCTION_PKG.NOTIFY_BIDDERS_OF_CLOSEEARLY, PONAUCT%'')
and wfias.item_type = pw.pon_item_type
and wfias.item_key = pw.pon_item_key
and item_type like ''PON%''
and activity_status = ''ERROR''',
      p_title                  => 'WF_ITEM_ACTIVITY_STATUSES with ERROR for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are workflow activities in status ERROR for the Negotiation, but a specific solution is not identified by the Analyzer.',
      p_solution               => 'The following documents give more details about workflow issues for Sourcing:<br>
  [399980/KB384175#aref_section26] How To Diagnose An Issue Within Negotiation Creation
  [399346/KB560833#aref_section26] How To Diagnose An Issue In Responding To and Awarding Sourcing Negotiations
Research the Oracle Support knowledge base for similar known issues and solutions.<br>
If a solution is found, use the feedback feature in the Analyzer to request the solution included in a future version of the Analyzer.<br>
Alternatively, Oracle Support can assist with providing a solution for the issue(s).  Log an SR with Support and attach the complete output from this Sourcing Analyzer to the new Service Request.  If multiple workflow errors are detected, separate SRs are usually required for each error type.',
      p_success_msg            => 'No workflow activities found in status ERROR (having no defined solution in the Analyzer) for Negotiation.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_WF_ITEM_ACTIVITY_STATUSES_ERROR');



debug('begin add_signature: PON_NOTIFICATION_SUBSCRIPTIONS_BUYER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13035',
      p_sig_id                 => 'PON_NOTIFICATION_SUBSCRIPTIONS_BUYER',
      p_sig_sql                => 'SELECT
LOOKUPS.lookup_type,
NOTIFS.NOTIF_GROUP_CODE,
NOTIFS.NOTIF_GROUP_TYPE,
NOTIFS.AUCTION_SUBSCRIPTION_FLAG,
NOTIFS.RFQ_SUBSCRIPTION_FLAG,
NOTIFS.RFI_SUBSCRIPTION_FLAG,
NOTIFS.CUSTOMIZED_FLAG,
NOTIFS.CREATION_DATE,
NOTIFS.CREATED_BY,
NOTIFS.LAST_UPDATE_DATE,
NOTIFS.LAST_UPDATED_BY,
NOTIFS.LAST_UPDATE_LOGIN,
NOTIFS.SLM_SUBSCRIPTION_FLAG,
LOOKUPS.MEANING NOTIF_GROUP_MEANING,
DECODE(NOTIF_GROUP_CODE,''B_AWARD_APPROVAL_APPROVED'',1,''B_AWARD_APPROVAL_REJECTED'',1,0) DISABLED
FROM
PON.PON_NOTIF_SUBSCRIPTION_GROUPS NOTIFS, FND_LOOKUP_VALUES LOOKUPS
WHERE
NOTIFS.NOTIF_GROUP_TYPE = ''TO_BUYER''
AND NOTIFS.NOTIF_GROUP_CODE = LOOKUPS.LOOKUP_CODE
AND LOOKUPS.LANGUAGE = USERENV(''LANG'')
ORDER BY LOOKUPS.lookup_type, NOTIFS.SEQUENCE_NUMBER',
      p_title                  => 'Notification Subscription for Buyer',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Notification Subscription Details for Buyer in Oracle Sourcing and Supplier Lifecycle Management (SLM)',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PON_NOTIFICATION_SUBSCRIPTIONS_BUYER');



debug('begin add_signature: PON_NOTIFICATION_SUBSCRIPTIONS_SUPPLIER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13036',
      p_sig_id                 => 'PON_NOTIFICATION_SUBSCRIPTIONS_SUPPLIER',
      p_sig_sql                => 'SELECT
LOOKUPS.lookup_type,
NOTIFS.NOTIF_GROUP_CODE,
NOTIFS.NOTIF_GROUP_TYPE,
...
NOTIFS.SLM_SUBSCRIPTION_FLAG,
LOOKUPS.MEANING NOTIF_GROUP_MEANING,
DECODE(NOTIF_GROUP_CODE,''S_AWARD_DECISION'',1,0) DISABLED
FROM
PON.PON_NOTIF_SUBSCRIPTION_GROUPS NOTIFS, FND_LOOKUP_VALUES LOOKUPS
WHERE
NOTIFS.NOTIF_GROUP_TYPE = ''TO_SUPPLIER''
AND NOTIFS.NOTIF_GROUP_CODE = LOOKUPS.LOOKUP_CODE
AND LOOKUPS.LANGUAGE = USERENV(''LANG'')
ORDER BY LOOKUPS.lookup_type, NOTIFS.SEQUENCE_NUMBER',
      p_title                  => 'Notification Subscriptions for Supplier',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'List of Notification Subscriptions defined for Supplier in Oracle Sourcing and Supplier Lifecycle Management (SLM)',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PON_NOTIFICATION_SUBSCRIPTIONS_SUPPLIER');



debug('begin add_signature: PON_NEGOTIATION_STYLES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8716',
      p_sig_id                 => 'PON_NEGOTIATION_STYLES',
      p_sig_sql                => 'select PNSV.*
from pon_negotiation_styles_vl PNSV, pon_auction_headers_all paha
where PNSV.style_id = paha.style_id 
and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'PON_NEGOTIATION_STYLES for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Negotiation Styles for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Negotiation Styles found for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_NEGOTIATION_STYLES');



debug('begin add_signature: PON_DOCTYPE_STYLES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8718',
      p_sig_id                 => 'PON_DOCTYPE_STYLES',
      p_sig_sql                => 'select fl.meaning doctype_name,
PNS.style_name,
pad.internal_name,
PDS.*
from PON_DOCTYPE_STYLES PDS,
pon_auc_doctypes PAD,
pon_negotiation_styles_vl PNS,
fnd_lookups fl,
pon_auction_headers_all paha
where PNS.style_id = PDS.style_id
AND PAD.doctype_id = PDS.doctype_id
AND pad.internal_name = fl.lookup_code
and fl.lookup_type = ''PON_AUCTION_DOC_TYPES''
AND PNS.style_id = paha.style_id
AND NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'PON_DOCTYPE_STYLES for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Sourcing Document Type Styles for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Sourcing Document Type Styles found for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_DOCTYPE_STYLES');



debug('begin add_signature: PON_FORMS_SECTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8714',
      p_sig_id                 => 'PON_FORMS_SECTIONS',
      p_sig_sql                => 'select pfs.* from PON_FORMS_SECTIONS pfs
where PFS.FORM_ID IN 
(SELECT pfi.form_id 
FROM PON_FORMS_INSTANCES pfi, pon_auction_headers_all paha
WHERE pfi.ENTITY_CODE = ''PON_AUCTION_HEADERS_ALL''
and pfi.entity_pk1 = PAHA.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##)',
      p_title                  => 'PON_FORMS_SECTIONS for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Forms Sections for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Forms Sections found for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_FORMS_SECTIONS');



debug('begin add_signature: PON_FORMS_SECTIONS_TL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8715',
      p_sig_id                 => 'PON_FORMS_SECTIONS_TL',
      p_sig_sql                => 'select pfst.* from PON_FORMS_SECTIONS_tl pfst
where PFST.FORM_ID IN 
(SELECT pfi.form_id 
FROM PON_FORMS_INSTANCES pfi, pon_auction_headers_all paha
WHERE pfi.ENTITY_CODE = ''PON_AUCTION_HEADERS_ALL''
and pfi.entity_pk1 = PAHA.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##)',
      p_title                  => 'PON_FORMS_SECTIONS_TL for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Forms Translated Sections for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Forms Translated Sections found for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_FORMS_SECTIONS_TL');



debug('begin add_signature: PON_FORMS_INSTANCES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8713',
      p_sig_id                 => 'PON_FORMS_INSTANCES',
      p_sig_sql                => 'select pfi.* from PON_FORMS_INSTANCES pfi, pon_auction_headers_all paha
WHERE pfi.ENTITY_CODE = ''PON_AUCTION_HEADERS_ALL''
and pfi.entity_pk1 = PAHA.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'PON_FORMS_INSTANCES for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Forms Instances for Negotiation',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Forms Instances found for Negotiation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_FORMS_INSTANCES');



debug('begin add_signature: PON_AUCTION_TEMPLATES');
   l_info('##MASK##TRADING_PARTNER_CONTACT_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##TRADING_PARTNER_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##TRADING_PARTNER_NAME_UPPER'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9405',
      p_sig_id                 => 'PON_AUCTION_TEMPLATES',
      p_sig_sql                => 'select * from pon_auction_templates',
      p_title                  => 'PON_AUCTION_TEMPLATES for Sourcing',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Negotiation Templates for Sourcing',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Negotiation Templates found for Sourcing.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_AUCTION_TEMPLATES');



debug('begin add_signature: PON_FND_ATTACHED_DOCUMENTS_PON_TEMPLATES');
   l_info('##MASK##ATTRIBUTE1'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE10'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE11'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE12'):= 'DISPLAY_FIRST_25_PCNT';
  ...
  add_signature(
      p_sig_repo_id            => '9401',
      p_sig_id                 => 'PON_FND_ATTACHED_DOCUMENTS_PON_TEMPLATES',
      p_sig_sql                => 'select pat.template_id, fdt.language, fdt.file_name, fdt.media_id, fad.* 
from fnd_attached_documents fad, fnd_documents_tl fdt , pon_auction_templates pat
where fdt.document_id = fad.document_id and fad.entity_name in (''PON_AUCTION_TEMPLATES'')
and fad.pk1_value = pat.template_id',
      p_title                  => 'FND_ATTACHED_DOCUMENTS for PON_AUCTION_TEMPLATES for Sourcing',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Attachments for Negotiation Templates for Sourcing',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No attachments found for Negotiation Templates for Sourcing.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_FND_ATTACHED_DOCUMENTS_PON_TEMPLATES');



debug('begin add_signature: PON_OKC_TERMS_TEMPLATES_ALL');
   l_info('##MASK##ATTRIBUTE1'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE10'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE11'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE12'):= 'DISPLAY_FIRST_25_PCNT';
  ...
  add_signature(
      p_sig_repo_id            => '9406',
      p_sig_id                 => 'PON_OKC_TERMS_TEMPLATES_ALL',
      p_sig_sql                => 'select distinct otta.*
from okc_terms_templates_all otta, okc_template_usages otu
where otta.template_id = otu.template_id
and otu.document_type in (''AUCTION'', ''AUCTION_RESPONSE'', ''RFI'', ''RFI_RESPONSE'', ''RFQ'', ''RFQ_RESPONSE'', ''SOLICITATION'', ''SOLICITATION_RESPONSE'')',
      p_title                  => 'OKC_TERMS_TEMPLATES_ALL for Sourcing Document Types',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Contract Terms Templates for Sourcing Document Types',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Contract Terms Templates found for Sourcing Document Types.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_OKC_TERMS_TEMPLATES_ALL');



debug('begin add_signature: PON_FND_ATTACHED_DOCUMENTS_OKC_TERMS_TEMPLATES');
   l_info('##MASK##ATTRIBUTE1'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE10'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE11'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE12'):= 'DISPLAY_FIRST_25_PCNT';
  ...
  add_signature(
      p_sig_repo_id            => '9407',
      p_sig_id                 => 'PON_FND_ATTACHED_DOCUMENTS_OKC_TERMS_TEMPLATES',
      p_sig_sql                => 'select fad.document_id, fdt.language, fdt.file_name, fdt.media_id, fad.*
from fnd_attached_documents fad, fnd_documents_tl fdt
where fdt.document_id = fad.document_id and fad.entity_name in (''OKC_TERMS_TEMPLATES'')
and fad.pk1_value in
(select distinct template_id from OKC_TEMPLATE_USAGES
where document_type in (''AUCTION'', ''AUCTION_RESPONSE'', ''RFI'', ''RFI_RESPONSE'', ''RFQ'', ''RFQ_RESPONSE'', ''SOLICITATION'', ''SOLICITATION_RESPONSE''))',
      p_title                  => 'FND_ATTACHED_DOCUMENTS for OKC_TERMS_TEMPLATES for Sourcing Document Types',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Attachments for Contract Terms Templates for Sourcing Document Types',
      p_solution               => 'Click the heading to view or hide the results.  Only the first '||mask_text(g_max_rows, nvl( upper(''), 'NO_MASK') )||' rows are displayed, based on the max rows parameter value.',
      p_success_msg            => 'No Attachments found for Contract Terms Templates for Sourcing Document Types.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_FND_ATTACHED_DOCUMENTS_OKC_TERMS_TEMPLATES');



debug('begin add_signature: EBS_MFG_PON_CONTRACTS_AND_CONTRACTS_TL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30809',
      p_sig_id                 => 'EBS_MFG_PON_CONTRACTS_AND_CONTRACTS_TL',
      p_sig_sql                => 'select pc.org_id, pctl.contract_id, pctl.version_num, pcs.start_date, pcs.end_date, pcs.enabled_flag, pctl.* 
from pon_contracts_tl pctl, pon_contracts pcs,
  (select org_id, contract_id, max(version_num) max_version_num
  from pon_contracts where contract_status = ''ACTIVE'' and (org_id = -1 or org_id = ##$$ORGID$$##) 
  group by org_id, contract_id ) pc
where pcs.contract_id = pc.contract_id and pcs.version_num = pc.max_version_num and pcs.org_id = pc.org_id
and pctl.contract_id = pc.contract_id and pctl.version_num = pc.max_version_num and pctl.org_id = pc.org_id
and pctl.language = ''US''',
      p_title                  => 'Terms and Conditions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Terms and Conditions from PON_CONTRACTS and PON_CONTRACTS_TL',
      p_solution               => 'Active Terms and Conditions for the Organization',
      p_success_msg            => 'No ACTIVE Terms and Conditions found in PON_CONTRACTS and PON_CONTRACTS_TL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PON_CONTRACTS_AND_CONTRACTS_TL');



debug('begin add_signature: EBS_MFG_PON_MULTIPLE_T_AND_C_EXIST_FOR_OU');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '32269',
      p_sig_id                 => 'EBS_MFG_PON_MULTIPLE_T_AND_C_EXIST_FOR_OU',
      p_sig_sql                => 'Select * from pon_contracts_tl pc
WHERE pc.rowid <
(SELECT MAX(rowid)
FROM pon_contracts_tl pc1
WHERE pc.CONTRACT_ID = pc1.CONTRACT_ID
AND pc.VERSION_NUM = pc1.VERSION_NUM
AND pc.LANGUAGE = pc1.LANGUAGE
AND nvl(pc.org_id, -1) = nvl(pc1.org_id, -1))
and pc.org_id =  ##$$ORGID$$##',
      p_title                  => 'Multiple Terms and Conditions Exist for the Operating Unit',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Multiple Terms and Conditions Exist for the Operating Unit Specified, as described in [1524152/KB267936]',
      p_solution               => 'Multiple Terms and Conditions exist for the Operating Unit.  Per [1524152/KB267936] there should be only a single Terms and Conditions at Operating Unit level for the Operating Unit.  Apply the recommended patch fix (if not already applied), and request a datafix from Support to fix the Terms and Conditions.',
      p_success_msg            => 'Terms and Conditions check passed for Operating Unit.  There are NOT multiple Terms and Conditions (T&C) at Operating Unit level per  [1524152/KB267936].  The T&C setup is valid for this Operating unit.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PON_MULTIPLE_T_AND_C_EXIST_FOR_OU');



debug('begin add_signature: EBS_MFG_PO_PON_AME_CONFIG_VARS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26128',
      p_sig_id                 => 'EBS_MFG_PO_PON_AME_CONFIG_VARS',
      p_sig_sql                => 'SELECT cfg.application_id, aca.application_name, cfg.variable_name,
          cfg.variable_value 
   FROM ame_config_vars cfg, ame_calling_apps aca
   WHERE aca.application_id(+) = cfg.application_id
   AND cfg.application_id IN (0, ##$$AMEAPPID$$##, ##$$AMEAPPID2NEG$$##)
   AND   sysdate BETWEEN cfg.start_date AND
           nvl(cfg.end_date - (1/86400),sysdate)
   ORDER BY application_id desc, cfg.variable_name',
      p_title                  => 'AME Configuration Variables',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No configuration variables found',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_PON_AME_CONFIG_VARS');



debug('begin add_signature: EBS_MFG_PO_PON_AME_MANDATORY_ATTR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26129',
      p_sig_id                 => 'EBS_MFG_PO_PON_AME_MANDATORY_ATTR',
      p_sig_sql                => 'SELECT atu.application_id, aca.application_name, atr.attribute_id,
          atr.name,
          atu.query_string,
          atr.description,
          atu.is_static
   FROM ame_attributes atr,
        ame_attribute_usages atu, ame_calling_apps aca
   WHERE aca.application_id(+) = atu.application_id
   AND   atr.attribute_id = atu.attribute_id
   AND   atu.application_id in (##$$AMEAPPID$$##, ##$$AMEAPPID2NEG$$## ) 
   ...
   ORDER BY atu.application_id desc, atr.name
',
      p_title                  => 'AME Mandatory Attributes',
      p_fail_condition         => 'NRS',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_PON_AME_MANDATORY_ATTR');



debug('begin add_signature: EBS_MFG_PO_PON_AME_ITEM_CLASSES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26133',
      p_sig_id                 => 'EBS_MFG_PO_PON_AME_ITEM_CLASSES',
      p_sig_sql                => 'SELECT icu.application_id, aca.application_name, icu.item_class_order_number "Order Number",
          ic.name,
          ic.item_class_id,
          icu.item_id_query,
   ...
   WHERE aca.application_id(+) = icu.application_id
   AND   ic.item_class_id = icu.item_class_id
   AND   icu.application_id in (##$$AMEAPPID$$##, ##$$AMEAPPID2NEG$$## )
   ...
   ORDER BY aca.application_id desc, icu.item_class_order_number',
      p_title                  => 'AME Item Classes',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No item classes found for Oracle Sourcing transaction types',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_PON_AME_ITEM_CLASSES');



debug('begin add_signature: EBS_MFG_PO_PON_AME_IC_ATTR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26134',
      p_sig_id                 => 'EBS_MFG_PO_PON_AME_IC_ATTR',
      p_sig_sql                => 'SELECT au.application_id, aca.application_name, ic.name "Item Class",
          a.attribute_id,
          a.name,
          a.attribute_type,
          au.query_string,
   ...
   FROM ame_attributes a,
        ...
        ame_item_classes ic,
        ame_calling_apps aca
   WHERE aca.application_id(+) = au.application_id
   AND   a.attribute_id = au.attribute_id
   AND   au.application_id in (##$$AMEAPPID$$##, ##$$AMEAPPID2NEG$$## )
   ...
   ORDER BY au.application_id desc, decode(ic.name,''header'',1,''line item'',2,''distribution'',3,4),
            a.name',
      p_title                  => 'AME Item Class Attributes',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No attributes these item classes',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_PON_AME_IC_ATTR');



debug('begin add_signature: EBS_MFG_PON_AME_ATTR_DESC_GT_100_CHARS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27871',
      p_sig_id                 => 'EBS_MFG_PON_AME_ATTR_DESC_GT_100_CHARS',
      p_sig_sql                => 'SELECT au.application_id, aca.application_name, ic.name "Item Class",
          a.attribute_id,
          a.name,
          a.attribute_type,
          a.description, length(a.description) "Attribute Description Length",
          au.is_static
   FROM ame_attributes a,
        ame_attribute_usages au,
        ame_item_classes ic,
        ame_calling_apps aca
   WHERE length(a.description) > 100
   AND   aca.application_id(+) = au.application_id
   AND   a.attribute_id = au.attribute_id
   AND   au.application_id in (##$$AMEAPPID$$##, ##$$AMEAPPID2NEG$$## )
   AND   a.item_class_id = ic.item_class_id
   AND   sysdate BETWEEN ic.start_date AND nvl(ic.end_date - (1/86400),sysdate)
   ...
   ORDER BY au.application_id desc, decode(ic.name,''header'',1,''line item'',2,''distribution'',3,4),
            a.name',
      p_title                  => 'AME Attribute Description Exceeds 100 Character Limit',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Attribute Description Length exceeds the 100 character limit.',
      p_solution               => 'Shorten the Attribute Description length to not exceed the 100 character limit, and to avoid errors as described in [1195715/KB240619]',
      p_success_msg            => 'Attribute Descriptions do not exceed the 100 character limit.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PON_AME_ATTR_DESC_GT_100_CHARS');



debug('begin add_signature: EBS_MFG_PO_PON_AME_CONDITIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26135',
      p_sig_id                 => 'EBS_MFG_PO_PON_AME_CONDITIONS',
      p_sig_sql                => 'SELECT atu.application_id, aca.application_name, aco.condition_key, aco.condition_id ,
...
ORDER BY atu.application_id desc, condition_id',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_PON_AME_CONDITIONS');



debug('begin add_signature: AME_APPR_GROUP_ITEMS');
   l_info('##MASK##NAME'):= 'NO_MASK';
   l_info('##MASK##PARAMETER'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2290',
      p_sig_id                 => 'AME_APPR_GROUP_ITEMS',
      p_sig_sql                => '(SELECT agi.order_number,
           ...
           rpad(substr(agi.parameter, 1, ceil(length(agi.parameter)*0.6) ), length(agi.parameter), ''*'') parameter, agi.start_date, agi.end_date,
           ''NA'' name, 
           ''NA'' wfr_orig_system, 99999999 wfr_orig_system_id, ''NA'' wfr_status, ''NA'' wfr_start_date,  ''NA'' wfr_expiration_date
    FROM ame_approval_group_items agi
    WHERE agi.parameter_name <> ''wf_roles_name''
    AND agi.approval_group_id = ##$$FK1$$##
...
SELECT agi.order_number,
           ...
           decode(agi.parameter_name,
             ...
             agi.parameter_name) "Parameter Name",
           rpad(substr(agi.parameter, 1, ceil(length(agi.parameter)*0.6) ), length(agi.parameter), ''*'') parameter, agi.start_date, agi.end_date,
           rpad(substr(wfr.name, 1, ceil(length(wfr.name)*0.60) ), length(wfr.name), ''*'') name,
           wfr.orig_system wfr_orig_system, wfr.orig_system_id wfr_orig_system_id, wfr.status wfr_status, to_char(wfr.start_date, ''DD-MON-YY'') wfr_start_date, to_char(wfr.expiration_date, ''DD-MON-YY'') wfr_expiration_date
    FROM ame_approval_group_items agi, wf_roles wfr
    WHERE agi.parameter_name = ''wf_roles_name'' and wfr.name(+) = agi.parameter
    AND agi.approval_group_id = ##$$FK1$$##
    AND   sysdate BETWEEN agi.start_date AND nvl(agi.end_date - (1/86400),sysdate)
UNION ALL
SELECT agi.order_number,
           ...
           decode(agi.parameter_name,
             ...
             ''wf_roles_name'', ''WF Role'',
             agi.parameter_name) "Parameter Name",
           agi.parameter, agi.start_date, agi.end_date,
           aag.name,
           ''NA'' wfr_orig_system, 99999999 wfr_orig_system_id, ''NA'' wfr_status, ''NA'' wfr_start_date,  ''NA'' wfr_expiration_date
           --rpad(substr(aag.name, 1, ceil(length(aag.name)*0.60) ), length(aag.name), ''*'') name
    FROM ame_approval_group_items agi, ame_approval_groups aag
    where agi.approval_group_item_id = ##$$FK1$$## and aag.approval_group_id(+) = agi.parameter and agi.parameter_name = ''OAM_group_id'' 
   ...
   l_info.delete;
debug('end add_signature: AME_APPR_GROUP_ITEMS');



debug('begin add_signature: EBS_MFG_PO_PON_AME_APPR_GROUPS');
   l_info('##MASK##DESCRIPTION'):= 'NO_MASK';
   l_info('##MASK##NAME'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26136',
      p_sig_id                 => 'EBS_MFG_PO_PON_AME_APPR_GROUPS',
      p_sig_sql                => 'SELECT agf.application_id, aca.application_name, agf.order_number,
           agr.approval_group_id, agr.approval_group_id "##$$FK1$$##",
--           agr.name,
           rpad(substr(agr.name, 1, ceil(length(agr.name)*0.60) ), length(agr.name), ''*'') name,
...
--           agr.description,
           rpad(substr(agr.description, 1, ceil(length(agr.description)*0.50) ), length(agr.description), ''*'') description,
           agr.query_string,
           agr.is_static
    FROM ame_approval_group_config agf,
         ame_approval_groups agr,
         ame_calling_apps aca
    WHERE aca.application_id(+) = agf.application_id
    AND   agf.application_id in (##$$AMEAPPID$$##, ##$$AMEAPPID2NEG$$## )
    ...
    ORDER BY aca.application_id desc, agf.order_number, agr.approval_group_id
',
      p_title                  => 'AME Approval Groups',
      p_fail_condition         => 'NRS',
      ...
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('AME_APPR_GROUP_ITEMS'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '2'
      );
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_PON_AME_APPR_GROUPS');



debug('begin add_signature: EBS_MFG_PO_APPRVL_AME_RULE_CONDITION_GT_100_CHARS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27869',
      p_sig_id                 => 'EBS_MFG_PO_APPRVL_AME_RULE_CONDITION_GT_100_CHARS',
      p_sig_sql                => 'SELECT c.condition_id,
           decode(c.condition_type,
             ...
             LENGTH(ame_condition_pkg.getDescription(c.condition_id)) "Condition Description Length"
    FROM 
         ame_conditions c
    WHERE LENGTH(ame_condition_pkg.getDescription(c.condition_id)) > 100
    AND   c.condition_id = ##$$FK3$$##
    AND   sysdate between c.start_date AND nvl(c.end_date - (1/86400),sysdate)
',
      p_title                  => 'AME Rule Condition Description Exceeds 100 Character Limit',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Condition Description exceeds 100 character limit',
      p_solution               => 'Shorten the Condition Description to not exceed 100 characters long to avoid errors as described in [1195715/KB240619]',
      p_success_msg            => 'Condition Description does not exceed 100 character limit',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_APPRVL_AME_RULE_CONDITION_GT_100_CHARS');



debug('begin add_signature: AME_RULE_CONDITIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2283',
      p_sig_id                 => 'AME_RULE_CONDITIONS',
      p_sig_sql                => 'SELECT c.condition_id, c.condition_id  "##$$FK3$$##",
           decode(c.condition_type,
             ''auth'','' '',
             ''pre'', ''Exception : '',
             ''post'', ''List-Modification : '') "Condition Type",
    ...
    AND   (sysdate between cu.start_date AND nvl(cu.end_date - (1/86400),sysdate) OR
      ...
      p_limit_rows             => nvl('N','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('EBS_MFG_PO_APPRVL_AME_RULE_CONDITION_GT_100_CHARS'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '10'
      );
   l_info.delete;
debug('end add_signature: AME_RULE_CONDITIONS');



debug('begin add_signature: EBS_MFG_PO_APPRVL_AME_APPROVAL_GROUPS_FOR_THIS_RULE');
   l_info('##MASK##DESCRIPTION'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28514',
      p_sig_id                 => 'EBS_MFG_PO_APPRVL_AME_APPROVAL_GROUPS_FOR_THIS_RULE',
      p_sig_sql                => 'SELECT agf.order_number,
           agr.approval_group_id, agr.approval_group_id "##$$FK1$$##",
--           agr.name,
           rpad(substr(agr.name, 1, ceil(length(agr.name)*0.50) ), length(agr.name), ''*'') name,
           decode(agf.voting_regime,
             ''S'',''Serial'',
             ''C'', ''Consensus'',
             ''F'', ''First Responder Wins'',
...
--           agr.description,
    ...
    FROM ame_approval_group_config agf,
         ame_approval_groups agr
    WHERE agf.approval_group_id = ##$$FK1$$##
    AND   agr.approval_group_id = agf.approval_group_id
    AND   sysdate BETWEEN agr.start_date AND nvl(agr.end_date - (1/86400),sysdate)
    AND   sysdate BETWEEN agf.start_date AND nvl(agf.end_date - (1/86400),sysdate)
    ORDER BY agf.order_number, agr.approval_group_id',
      p_title                  => 'AME Approval Groups For AME Rule',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No approval groups found for this AME Rule',
      p_solution               => 'Review the Rule setup in AME Setup if you expect there should be an approval group(s) shown.',
      p_success_msg            => 'Approval Groups for this AME Rule',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_APPRVL_AME_APPROVAL_GROUPS_FOR_THIS_RULE');



debug('begin add_signature: AME_RULE_ACTIONS');
   l_info('##MASK##APPR_GROUP_DESC'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2284',
      p_sig_id                 => 'AME_RULE_ACTIONS',
      p_sig_sql                => '
select action_id, approval_group_id, approval_group_id "##$$FK1$$##", appr_group_descr_prefix, 
rpad(substr(Appr_Group_Descr_suffix, 1, ceil(length(Appr_Group_Descr_suffix)*0.55) ), length(Appr_Group_Descr_suffix), ''*'') Appr_Group_Descr_suffix
from
(
select act.action_id, agr.approval_group_id, 
rpad(substr(act.descr, 1, ceil(length(act.descr)*0.75) ), length(act.descr), ''*'') Appr_Group_Descr_prefix,
substr(act.Descr,instr(act.Descr, ''Require approval from '',1,1)+22,length(act.Descr)) Appr_Group_Descr_suffix
from ame_approval_groups agr,
(SELECT ame_action_pkg.getDescription(a.action_id) "DESCR", a.action_id
    FROM ame_action_usages au,
         ame_actions a
    WHERE au.rule_id = 52241 --##$$FK1$$##
...
where substr(act.Descr,instr(act.Descr, ''from '',1,1)+5,length(act.Descr)) = agr.description
)',
      p_title                  => 'AME Rule Actions',
      p_fail_condition         => 'NRS',
      ...
      p_limit_rows             => nvl('N','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('EBS_MFG_PO_APPRVL_AME_APPROVAL_GROUPS_FOR_THIS_RULE'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '10'
      );
   l_info.delete;
debug('end add_signature: AME_RULE_ACTIONS');



debug('begin add_signature: AME_LINE_RULE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2285',
      p_sig_id                 => 'AME_LINE_RULE',
...
(SELECT ic.name item_class,
    ...
    r.rule_type, 
    r.rule_id) rules
    where item_class = ''line item''',
      p_title                  => 'AME Line Item Rule',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Line Item Rule detected!',
      p_solution               => 'Oracle Purchasing does not support Line item Rules in AME. Please review the above rule and move the Rule to Header level.<br>
As a workaround, you may consider the following<br>
- Create a Header level rule that uses Line item conditions as described in [1474402/KB435063]<br>
- Create a custom attribute that uses a dynamic query as described in [960944/KB727313]<br>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AME_LINE_RULE');



debug('begin add_signature: EBS_MFG_PO_PON_AME_RULES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26137',
      p_sig_id                 => 'EBS_MFG_PO_PON_AME_RULES',
      p_sig_sql                => 'SELECT ic.application_id, ic.application_name, ic.name item_class,
           ic.name "##$$FK2$$##",
          decode(r.rule_type,
                 0, ''Combination'',
                 1, ''List Creation'',
    ...
    FROM ame_rules r,
         ame_rule_usages ru,
         (
           SELECT icu.application_id, aca.application_name, ic.name, ic.item_class_id,
                  icu.item_class_order_number, icu.item_class_id item_clsid
            FROM ame_item_classes ic,
                 ame_item_class_usages icu,
                 ame_calling_apps aca
    ...
    AND   (r.rule_type IN (3, 4) OR
           ic.item_class_id is not null)
    AND   r.rule_id = ru.rule_id
    AND   ru.item_id = ic.application_id --##$$AMEAPPID$$##
    AND   (sysdate between r.start_date AND nvl(r.end_date - (1/86400),sysdate) OR
           (r.start_date > sysdate AND
             (r.end_date is null OR r.end_date > r.start_date)))
    AND   (sysdate between ru.start_date AND nvl(ru.end_date - (1/86400),sysdate) OR
           (ru.start_date > sysdate AND
             (ru.end_date is null OR ru.end_date > ru.start_date)))
    ORDER BY ic.application_id desc, ic.item_class_order_number,
    item_clsid,
    r.rule_type, 
    r.rule_id',
      p_title                  => 'AME Rules',
      ...
      p_limit_rows             => nvl('N','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('AME_RULE_CONDITIONS','AME_RULE_ACTIONS','AME_LINE_RULE'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '12'
      );
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_PON_AME_RULES');



debug('begin add_signature: AME_ACTION_TP_REQ_ATTR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2287',
      p_sig_id                 => 'AME_ACTION_TP_REQ_ATTR',
    ...
    AND   atr.attribute_id IN (
            ...
            AND   sysdate BETWEEN ma.start_date AND
                    nvl(ma.end_date - (1/86400),sysdate))',
      p_title                  => 'AME Action Type Required Attributes',
      p_fail_condition         => 'NRS',
   ...
   l_info.delete;
debug('end add_signature: AME_ACTION_TP_REQ_ATTR');



debug('begin add_signature: AME_ACTION_TP_ACTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2288',
      p_sig_id                 => 'AME_ACTION_TP_ACTIONS',
    ...
    AND   act.created_by NOT IN (1,120)',
      p_title                  => 'AME Action Type Actions',
      p_fail_condition         => 'NRS',
   ...
   l_info.delete;
debug('end add_signature: AME_ACTION_TP_ACTIONS');



debug('begin add_signature: EBS_MFG_PO_PON_AME_ACTION_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26138',
      p_sig_id                 => 'EBS_MFG_PO_PON_AME_ACTION_TYPES',
      p_sig_sql                => 'SELECT atc.application_id, aca.application_name, atc.order_number,
           at.name,
    ...
    FROM ame_action_type_config atc,
         ...
         ame_calling_apps aca
    WHERE aca.application_id(+) = atc.application_id
    AND   atc.application_id in (##$$AMEAPPID$$##, ##$$AMEAPPID2NEG$$## ) 
    ...
    ORDER BY atc.application_id desc, atu.rule_type,atc.order_number',
      p_title                  => 'AME Action Types',
      p_fail_condition         => 'NRS',
      ...
      p_limit_rows             => nvl('N','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('AME_ACTION_TP_REQ_ATTR','AME_ACTION_TP_ACTIONS'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '1'
      );
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_PON_AME_ACTION_TYPES');



debug('begin add_signature: EBS_MFG_PON_AWARD_APPR_AME_EXCEPTION_LOG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25906',
      p_sig_id                 => 'EBS_MFG_PON_AWARD_APPR_AME_EXCEPTION_LOG',
      p_sig_sql                => 'SELECT LOG_ID, TRANSACTION_ID, PACKAGE_NAME, ROUTINE_NAME, EXCEPTION_NUMBER, EXCEPTION_STRING, SECURITY_GROUP_ID
FROM AME_EXCEPTIONS_LOG WHERE APPLICATION_ID = ''##$$AMEAPPID$$##'' AND TRANSACTION_ID = ''##$$AMETRXID$$##''
ORDER BY LOG_ID desc',
      p_title                  => 'AME Exception Log Data - Award Approval',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Log messages from AME_EXCEPTIONS_LOG for Sourcing Award Approval',
      p_solution               => 'Exceptions occurred in AME.  This usually indicates the AME setup is not correct or patching may be required.  Review the detailed exception message in EXCEPTION_STRING and research in Oracle Support / Knowledge to find possible solutions.
</br></br>One Example </br>[2833698/KB347908] </br>
Contact Oracle Support for more specific advice.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PON_AWARD_APPR_AME_EXCEPTION_LOG');



debug('begin add_signature: EBS_MFG_PO_PON_NEG_APPR_AME_EXCEPTION_LOG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26127',
      p_sig_id                 => 'EBS_MFG_PO_PON_NEG_APPR_AME_EXCEPTION_LOG',
      p_sig_sql                => 'SELECT LOG_ID, TRANSACTION_ID, 
PACKAGE_NAME, ROUTINE_NAME, EXCEPTION_NUMBER, 
EXCEPTION_STRING, SECURITY_GROUP_ID
FROM AME_EXCEPTIONS_LOG 
WHERE APPLICATION_ID = ''##$$AMEAPPID2NEG$$##'' AND TRANSACTION_ID = ''##$$AMETRXID2NEG$$##''
ORDER BY LOG_ID desc',
      p_title                  => 'AME Exception Log Data - Negotiation Approval',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Log messages from AME_EXCEPTIONS_LOG for Sourcing Negotiation Approval',
      p_solution               => 'Exceptions occurred in AME Sourcing Negotiation Approval.  This usually indicates the AME setup is not correct or patching may be required.  Review the detailed exception message in EXCEPTION_STRING and research in Oracle Support / Knowledge to find possible solutions.<br><br>One Example </br>[2833698/KB347908] </br>
Contact Oracle Support for more specific advice.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_PON_NEG_APPR_AME_EXCEPTION_LOG');
...
debug('begin add_signature: PON_APPLICATION_INSTALL_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9505',
      p_sig_id                 => 'PON_APPLICATION_INSTALL_DETAILS',
      p_sig_sql                => 'SELECT fav.application_name app_name,
fav.application_short_name app_s_name,
decode(fpi.status, ''I'', ''Yes'',
''S'', ''Shared'',
...
FROM fnd_application_vl fav, fnd_product_installations fpi
WHERE fav.application_id = fpi.application_id
AND fav.application_id in (396, 177, 398, 201)
order by 3',
      p_title                  => 'Sourcing and Related Procurement Applications Installed Status',
      p_fail_condition         => '[inst_status] in ['||mask_text(g_c_shared, nvl( upper(''), 'NO_MASK') )||','||mask_text(g_c_no, nvl( upper(''), 'NO_MASK') )||']',
      p_problem_descr          => 'Sourcing or one of the related Procurement applications (Purchasing or iSupplier Portal) is either Not Installed or is Shared Installed.  If an application is not set as Installed in License Manager, many features of that application are not available to use.',
      p_solution               => 'Verify that the application installation status is correct for your instance for Sourcing, Purchasing, and iSupplier Portal, based on the licenses you have purchased and intend to use in the instance.  Otherwise, update the installation status using License Manager if the installation status not correct for your instance.',
      p_success_msg            => 'Sourcing and related Procurement application installation statuses are set as Installed, so all the application features should be available for Sourcing, Purchasing, and iSupplier Portal.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_APPLICATION_INSTALL_DETAILS');
...
debug('begin add_signature: POS_APPLICATION_INSTALL_DETAILS');
   l_info('##SHOW_SQL##'):= 'N';
  add_signature(
      p_sig_repo_id            => '7230',
      p_sig_id                 => 'POS_APPLICATION_INSTALL_DETAILS',
      p_sig_sql                => 'SELECT fav.application_name app_name, 
fav.application_short_name app_s_name, 
decode(fpi.status, ''I'', ''Yes'', 
''S'', ''Shared'', 
...
FROM fnd_application_vl fav, fnd_product_installations fpi
WHERE fav.application_id = fpi.application_id
AND fav.application_id = 177
order by 3',
      p_title                  => 'Purchasing Application Installation Details',
      p_fail_condition         => '[inst_status] in ['||mask_text(g_c_shared, nvl( upper(''), 'NO_MASK') )||','||mask_text(g_c_no, nvl( upper(''), 'NO_MASK') )||']',
      p_problem_descr          => 'iSupplier Portal application is set as Shared installed or Not installed',
      p_solution               => '',
      p_success_msg            => 'iSupplier Portal application install status',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: POS_APPLICATION_INSTALL_DETAILS');



debug('begin add_signature: PON_BID_PO_HISTORY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15199',
      p_sig_id                 => 'PON_BID_PO_HISTORY',
      p_sig_sql                => 'select pbph.* 
from PON_BID_PO_HISTORY pbph, pon_auction_headers_all paha 
where (pbph.bid_number like NVL(''##$$BID_NUMBER$$##'',''%'')) and ((pbph.bid_number like NVL(''##$$BID_NUMBER$$##'',''%'')) or (pbph.bid_number in 
(select distinct bid_number from pon_bid_headers pbh, pon_auction_headers_all paha where upper(pbh.trading_partner_name) like concat(concat(''%'',upper(''##$$BIDDING_SUPPLIER$$##'')),''%'') 
and pbh.auction_header_id = paha.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##))) 
and pbph.auction_header_id = PAHA.auction_header_id and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'PON_BID_PO_HISTORY for Negotiation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'PON_BID_PO_HISTORY records indicate the Reaward feature is used on the Negotiation to re-open or re-award the negotiation.',
      p_solution               => 'Review the Reaward / Reopen feature details described in [2545194/KB615072] Reopen Award feature (KB615072)',
      p_success_msg            => 'No Reaward / Reopen records found for this Negotiation.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_BID_PO_HISTORY');



debug('begin add_signature: PON_WF_ITEM_ACTIVITY_STATUSES_ERROR_2241469.1');
   l_info('##MASK##ASSIGNED_USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9572',
      p_sig_id                 => 'PON_WF_ITEM_ACTIVITY_STATUSES_ERROR_2241469.1',
      p_sig_sql                => 'select pw.pon_item_type item_type, pw.pon_item_key item_key, pw.auction_header_id auction_header_id, pw.document_number document_number, wfias.*
from wf_item_activity_statuses wfias, (select pon_item_type, pon_item_key, auction_header_id, auction_round_number, document_number
from 
  (select ''PONAUCT'' pon_item_type, paha.wf_item_key pon_item_key, paha.auction_header_id auction_header_id, paha.auction_round_number, paha.document_number document_number
  from PON_AUCTION_HEADERS_ALL PAHA
  where NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##)
) pw
where
exists 
   (select Filename, FileVersion CustomerFileVersion 
   from 
   (select name PackageName, type PackageType,  
   REGEXP_SUBSTR(text, ''\$Header\: (PON\w+?\.\w\w\w)\s'', 1, 1, ''i'', 1) Filename, 
   REGEXP_SUBSTR(text, ''.\w\w\w (\d+\.\d+\.\d+\.\d+|\d+\.\d+)'', 1, 1, ''i'', 1) FileVersion,
   REGEXP_SUBSTR(text, ''.\w\w\w (\d+)\.'', 1, 1, ''i'', 1) VersionSegment1,
   REGEXP_SUBSTR(text, ''.\w\w\w \d+\.(\d+)'', 1, 1, ''i'', 1) VersionSegment2,
   REGEXP_SUBSTR(text, ''.\w\w\w \d+\.\d+\.(\d+)'', 1, 1, ''i'', 1) VersionSegment3,
   REGEXP_SUBSTR(text, ''.\w\w\w \d+\.\d+\.\d+\.(\d+)'', 1, 1, ''i'', 1) VersionSegment4,
   text 
   from all_source
   where 
   (type = ''PACKAGE BODY'' and line = 2 and name = ''PON_AUCTION_APPROVAL_PKG'')
   or (type = ''PACKAGE BODY'' and line = 2 and name = ''PON_AUCTION_PKG'')
   or (type = ''PACKAGE'' and line = 2 and name = ''PON_AUCTION_PKG'')
   or (type = ''PACKAGE BODY'' and line = 2 and name = ''PON_SLM_UTIL_PKG'')
   or (type = ''PACKAGE BODY'' and line = 2 and name = ''PON_WF_UTL_PKG'')
   )
   LowerFileVersions
   where 
   ((VersionSegment4 < 9 or VersionSegment2 < 28) and VersionSegment3 = 12020000 and VersionSegment1 = 120 and Filename = ''PONAPPRB.pls'')
   or ((VersionSegment4 < 31 or VersionSegment2 < 125) and VersionSegment3 = 12020000 and VersionSegment1 = 120 and Filename = ''PONAUCTB.pls'')
   or ((VersionSegment4 < 7 or VersionSegment2 < 28) and VersionSegment3 = 12020000 and VersionSegment1 = 120 and Filename = ''PONAUCTS.pls'')
   or ((VersionSegment4 < 7 or VersionSegment2 < 0) and VersionSegment3 = 12020000 and VersionSegment1 = 120 and Filename = ''PONSLMUTLB.pls'')
   or ((VersionSegment4 < 9 or VersionSegment2 < 23) and VersionSegment3 = 12020000 and VersionSegment1 = 120 and Filename = ''PONWFUTB.pls'')
 or ((VersionSegment4 < 22 or VersionSegment2 < 11) and VersionSegment3 = 12010000 and VersionSegment1 = 120 and Filename = ''PONAPPRB.pls'')
 or ((VersionSegment4 < 78 or VersionSegment2 < 93) and VersionSegment3 = 12010000 and VersionSegment1 = 120 and Filename = ''PONAUCTB.pls'')
 or ((VersionSegment4 < 9 or VersionSegment2 < 21) and VersionSegment3 = 12010000 and VersionSegment1 = 120 and Filename = ''PONAUCTS.pls'')
 or ((VersionSegment4 < 4 or VersionSegment2 < 0) and VersionSegment3 = 12010000 and VersionSegment1 = 120 and Filename = ''PONSLMUTLB.pls'')
 or ((VersionSegment4 < 16 or VersionSegment2 < 20) and VersionSegment3 = 12010000 and VersionSegment1 = 120 and Filename = ''PONWFUTB.pls'')
   )
and error_stack like ''%Wf_Engine_Util.Function_Call(PON_AUCTION_PKG.NOTIFY_BIDDERS_OF_CLOSEEARLY, PONAUCT,%''
and error_message = ''ORA-06502: PL/SQL: numeric or value error: character string buffer too small''
and wfias.item_type = pw.pon_item_type
and wfias.item_key = pw.pon_item_key
and item_type like ''PON%''
and activity_status = ''ERROR''
and NVL(auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and auction_header_id = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'Workflow Errors in PON_AUCTION_PKG.NOTIFY_BIDDERS_OF_CLOSEEARLY When Trying to Close RFQ Early',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Workflow errors occurred in PON_AUCTION_PKG.NOTIFY_BIDDERS_OF_CLOSEEARLY when the RFQ was closed early.  Due to the errors, the bidders are not aware the negotiation was closed early.
',
      p_solution               => 'This Negotiation has errors the same as described in [2241469/KB374987] Workflow Errors in PON_AUCTION_PKG.NOTIFY_BIDDERS_OF_CLOSEEARLY When Trying to Close RFQ Early.<br>
Since some of your file versions are lower than the fixed versions, implement the solution from the document to solve the issue.',
      p_success_msg            => 'The negotiation does not have this issue.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PON_WF_ITEM_ACTIVITY_STATUSES_ERROR_2241469.1');



debug('begin add_signature: PON_WF_ITEM_ACTIVITY_STATUSES_ERROR_2138321.1');
   l_info('##MASK##ASSIGNED_USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9632',
      p_sig_id                 => 'PON_WF_ITEM_ACTIVITY_STATUSES_ERROR_2138321.1',
      p_sig_sql                => 'select pw.pon_item_type item_type, pw.pon_item_key item_key, pw.auction_header_id auction_header_id, pw.document_number document_number, wfias.*
from wf_item_activity_statuses wfias, (select pon_item_type, pon_item_key, auction_header_id, auction_round_number, document_number
from
  (select distinct ''PONPBLSH'' pon_item_type, pbp.wf_item_key pon_item_key, paha.auction_header_id auction_header_id, paha.auction_round_number auction_round_number, paha.document_number document_number
   from PON_BIDDING_PARTIES PBP, PON_AUCTION_HEADERS_ALL PAHA
   where pbp.auction_header_id = paha.auction_header_id
   and NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##)
) pw
...
exists
   ...
   from all_source
   where
   (type = ''PACKAGE BODY'' and line = 2 and name = ''PON_AUCTION_PKG'')
   )
   LowerFileVersions
   where
   ((VersionSegment4 < 71 or VersionSegment2 < 93) and VersionSegment3 = 12010000 and VersionSegment1 = 120 and Filename = ''PONAUCTB.pls'')
   or ((VersionSegment4 < 33 or VersionSegment2 < 125) and VersionSegment3 = 12020000 and VersionSegment1 = 120 and Filename = ''PONAUCTB.pls'')
   )
and error_message like ''%3835: Error%ORA-20002: 2018: Unable to generate the notification XML. Caused by: 2020: Error when getting notification content%ORA-06502: PL/SQL: numeric or value error: character string buffer too small%GEN_INVITE_ADD_CONT_RESP_BODY%PON_INV_RESP_ADD_CONT_BODY%WF_XML.Generate%''
and wfias.item_type = pw.pon_item_type
and wfias.item_key = pw.pon_item_key
and item_type like ''PON%''
and activity_status = ''ERROR''
and NVL(auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and auction_header_id = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'Workflow Errors in PONPBLSH like ERROR_MESSAGE=3835: Error -20002 - ORA-20002:2018:Unable to generate the notification',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Workflow Errors occurred in PONPBLSH like ERROR_MESSAGE=3835: Error ''-20002 - ORA-20002:2018:Unable to generate the notification.  This prevents the workflow from delivering the corresponding notification to the user.',
      p_solution               => 'This Negotiation has errors the same as described in [2138321/KB604693] Workflow Error When Additional Contact Email Field for Supplier is Entered in RFQ.<br>
Since some of your file versions are lower than the fixed versions, implement the solution from the document to solve the issue.',
      p_success_msg            => 'The negotiation does not have this issue.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: PON_WF_ITEM_ACTIVITY_STATUSES_ERROR_2138321.1');



debug('begin add_signature: PON_WF_ITEM_ACTIVITY_STATUSES_ERROR_2086580.1');
   l_info('##MASK##ASSIGNED_USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9631',
      p_sig_id                 => 'PON_WF_ITEM_ACTIVITY_STATUSES_ERROR_2086580.1',
      p_sig_sql                => 'select pw.pon_item_type item_type, pw.pon_item_key item_key, pw.auction_header_id auction_header_id, pw.document_number document_number, wfias.*
from wf_item_activity_statuses wfias, (select pon_item_type, pon_item_key, auction_header_id, auction_round_number, document_number
from 
  (select ''PONAUCT'' pon_item_type, paha.wf_item_key pon_item_key, paha.auction_header_id auction_header_id, paha.auction_round_number auction_round_number, paha.document_number document_number
  from PON_AUCTION_HEADERS_ALL PAHA
  where NVL(paha.auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and paha.auction_header_id_orig_round = ##$$AUCTION_HEADER_ID$$##)
) pw
where
exists 
   ...
   LowerFileVersions
   where
   ((VersionSegment4 < 68 or VersionSegment2 < 93) and VersionSegment3 = 12010000 and VersionSegment1 = 120 and Filename = ''PONAUCTB.pls'')
   or ((VersionSegment4 < 26 or VersionSegment2 < 125) and VersionSegment3 = 12020000 and VersionSegment1 = 120 and Filename = ''PONAUCTB.pls'')
   )
and error_stack like ''%Wf_Engine.AbortProcess(PONPBLSH,%Wf_Engine_Util.Function_Call(PON_AUCTION_PKG.NOTIFY_BIDDER_LIST_REMINDER%RUN)%''
and error_message like ''3124: Process%PUBLISH_MAIN%for item%PONPBLSH%is not active.%''
and wfias.item_type = pw.pon_item_type
and wfias.item_key = pw.pon_item_key
and item_type like ''PON%''
and activity_status = ''ERROR''
and NVL(auction_round_number,1) like NVL(''##$$ROUND_NUMBER$$##'',''%'') and auction_header_id = ##$$AUCTION_HEADER_ID$$##',
      p_title                  => 'Workflow Errors in PON_AUCTION_PKG.NOTIFY_BIDDER_LIST_REMINDER Prevent Notifications From Being Sent to Suppliers When Negotiation Is Canceled',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Workflow Errors in PON_AUCTION_PKG.NOTIFY_BIDDER_LIST_REMINDER prevent notifications from being sent to suppliers when the negotiation is canceled.  Notifications need to be sent to suppliers, so they are aware the negotiation has been canceled and no longer allows their participation or response.',
      p_solution               => 'This negotiation has errors the same as described in [2086580/KB463728] Canceled RFQ in Sourcing Not Sending Notification to Suppliers.<br>
Since some of your file versions are lower than the fixed versions, implement the solution from the document to solve the issue.',
      p_success_msg            => 'The negotiation does not have this issue.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: PON_WF_ITEM_ACTIVITY_STATUSES_ERROR_2086580.1');
...
BEGIN
  ...
  analyzer_title := 'Procurement Sourcing Analyzer';
...
start_section('Proactive Recommendations', 'PROACTIVE_RECOMMENDATIONS');
   IF (substr(g_rep_info('Apps Version'),1,4) = '12.1') THEN
      set_item_result(check_rec_patches_4); /* Signature PON_RECOMMENDED_PATCHES */
   END IF;
   set_item_result(check_rec_patches_1); /* Signature PON_RECOMMENDED_PATCHES_CREATE_PO_OR_BPA_FROM_NEGOTIATION */
   set_item_result(check_rec_patches_2); /* Signature PON_RECOMMENDED_PATCHES_PRC */
   set_item_result(check_rec_patches_3); /* Signature PON_RECOMMENDED_PATCHES_FND */
   set_item_result(run_stored_sig('PON_PATCHING_LEVELS_PROCUREMENT'));
   set_item_result(run_stored_sig('WF_OVERALL_HEALTH'));
   IF ((substr(g_rep_info('Apps Version'),1,4) = '12.2')) THEN
      set_item_result(run_stored_sig('CHECK_WORKFLOW_HOT_FIX_FILE_CHECK'));
   END IF;
   set_item_result(run_stored_sig('PON_SOURCING_NOT_INSTALLED'));
   IF ((substr(g_rep_info('Apps Version'),1,4) = '12.4')) THEN
      set_item_result(run_stored_sig('POA_TABLESPACE_CHECK'));
   END IF;
end_section;
debug('end section: PROACTIVE_RECOMMENDATIONS');

debug('begin section: Negotiation');
IF p_negotiation_number <> 0 THEN
   start_section('Negotiation (Auction/RFQ/RFI)', 'Negotiation');
      set_item_result(run_stored_sig('PON_AUCTION_HEADERS_ALL'));
      set_item_result(run_stored_sig('PON_AUCTION_ITEM_PRICES_ALL'));
      set_item_result(run_stored_sig('PON_AUCTION_SHIPMENTS_ALL'));
      set_item_result(run_stored_sig('PON_PRICING_ELEMENTS'));
      set_item_result(run_stored_sig('PON_PRICE_ELEMENT_TYPES_VL'));
      set_item_result(run_stored_sig('PON_AUCTION_ATTRIBUTES'));
      set_item_result(run_stored_sig('PON_NEG_TEAM_MEMBERS'));
      set_item_result(run_stored_sig('EBS_MFG_PO_PON_TEAM_MEMBERS_DATA_ISSUE_01'));
      set_item_result(run_stored_sig('PON_BACKING_REQUISITIONS'));
      set_item_result(run_stored_sig('PON_PO_REQUISITION_HEADERS_ALL'));
      set_item_result(run_stored_sig('PON_PO_REQUISITION_LINES_ALL'));
      set_item_result(run_stored_sig('PON_EMD_TRANSACTIONS'));
      set_item_result(run_stored_sig('PON_DISCUSSIONS'));
      set_item_result(run_stored_sig('PON_THREADS'));
      set_item_result(run_stored_sig('PON_THREAD_ENTRIES'));
      set_item_result(run_stored_sig('EBS_MFG_PO_PON_AUC_CURRENCY_RATES'));
      set_item_result(run_stored_sig('PON_INTERFACE_ERRORS'));
      set_item_result(run_stored_sig('PON_DATA_MISSING_LINK_MANAGE_COLLABORATION_TEAM'));
   end_section('Negotiation details');
END IF;
debug('end section: Negotiation');

debug('begin section: Bids');
IF p_negotiation_number <> 0  THEN
   start_section('Bids Quotes and RFI Supplier Responses', 'Bids');
      set_item_result(run_stored_sig('PON_BIDDING_PARTIES'));
      set_item_result(run_stored_sig('PON_BID_HEADERS'));
      set_item_result(run_stored_sig('PON_BID_ATTRIBUTE_VALUES'));
      set_item_result(run_stored_sig('PON_BID_PRICE_ELEMENTS'));
      set_item_result(run_stored_sig('PON_BID_SHIPMENTS'));
      set_item_result(run_stored_sig('PON_BID_ITEM_PRICES'));
      IF g_ponbidpohistory = 'true' THEN
         set_item_result(run_stored_sig('PON_BID_PO_HISTORY'));
      END IF;
      set_item_result(run_stored_sig('PON_DATA_MULTIPLE_DRAFT_BIDS_FROM_SAME_SUPPLIER_SITE'));
   end_section;
END IF;
debug('end section: Bids');

debug('begin section: Awards');
IF p_negotiation_number <> 0  THEN
   start_section('Analysis and Award Details', 'Awards');
      set_item_result(run_stored_sig('PON_AWARD_ALLOCATIONS'));
      set_item_result(run_stored_sig('PON_PO_HEADERS_ALL'));
      set_item_result(run_stored_sig('PON_PO_LINES_ALL'));
      set_item_result(run_stored_sig('PON_AWARDCOMPLETE_OUTCOMENOTCOMPLETE'));
      set_item_result(run_stored_sig('PON_AWARDEDLINE_NOPOLINECREATED'));
      set_item_result(run_stored_sig('PON_ACCEPTANCES'));
      set_item_result(run_stored_sig('PON_SCORING_TEAMS'));
      set_item_result(run_stored_sig('PON_SCORING_TEAM_MEMBERS'));
      set_item_result(run_stored_sig('PON_SCORING_TEAM_SECTIONS'));
      set_item_result(run_stored_sig('EBS_MFG_PON_NEED_BY_DATE_VALIDATION_REQ_PO'));
   end_section;
END IF;
debug('end section: Awards');

debug('begin section: AttachmentsContracts');
IF p_negotiation_number <> 0 THEN
   start_section('Attachments and Contracts', 'AttachmentsContracts');
      set_item_result(run_stored_sig('PON_FND_ATTACHED_DOCUMENTS_AUCTION_HEADERS'));
      set_item_result(run_stored_sig('PON_FND_ATTACHED_DOCUMENTS_AUCTION_ITEM_PRICES'));
      set_item_result(run_stored_sig('PON_FND_ATTACHED_DOCUMENTS_BID_HEADERS'));
      set_item_result(run_stored_sig('PON_FND_ATTACHED_DOCUMENTS_BID_ITEM_PRICES'));
      set_item_result(run_stored_sig('PON_FND_ATTACHED_DOCUMENTS_OKC_CONTRACT_DOCS'));
      set_item_result(run_stored_sig('PON_OKC_TEMPLATE_USAGES'));
      set_item_result(run_stored_sig('PON_FND_ATTACHED_DOCUMENTS_OKC_TEMPLATE_USAGES'));
      set_item_result(run_stored_sig('PON_OKC_TERMS_DEVIATIONS_T'));
      set_item_result(run_stored_sig('PON_OKC_DELIVERABLES'));
   end_section('Attachments and Contracts for Negotiation / Response');
END IF;
debug('end section: AttachmentsContracts');

debug('begin section: Workflow');
IF p_negotiation_number is not null THEN
   start_section('Workflow', 'Workflow');
      set_item_result(run_stored_sig('PON_ACTION_HISTORY'));
      set_item_result(run_stored_sig('PON_WFSTAT_PONAPPRV'));
      set_item_result(run_stored_sig('PON_WF_NOTIFICATIONS_PONAPPRV'));
      set_item_result(run_stored_sig('PON_WFSTAT_PONAUCT'));
      set_item_result(run_stored_sig('PON_WF_NOTIFICATIONS_PONAUCT'));
      set_item_result(run_stored_sig('EBS_MFG_PON_WF_ITEM_ATTRIBUTE_VALUES_MISSING_FOR_WF_PONAUCT_VAL_AUCTION_ID'));
      set_item_result(run_stored_sig('PON_WFSTAT_PONPBLSH'));
      set_item_result(run_stored_sig('PON_WF_NOTIFICATIONS_PONPBLSH'));
      set_item_result(run_stored_sig('PON_WFSTAT_PONAWAPR'));
      set_item_result(run_stored_sig('PON_WF_NOTIFICATIONS_PONAWAPR'));
      set_item_result(run_stored_sig('PON_WFSTAT_PONCOMPL'));
      set_item_result(run_stored_sig('PON_WF_NOTIFICATIONS_PONCOMPL'));
      set_item_result(run_stored_sig('PON_WFSTAT_PONTEVAL'));
      set_item_result(run_stored_sig('PON_WF_NOTIFICATIONS_PONTEVAL'));
      set_item_result(run_stored_sig('PON_WFSTAT_PONWDRAW'));
      set_item_result(run_stored_sig('PON_WF_NOTIFICATIONS_PONWDRAW'));
      set_item_result(run_stored_sig('EBS_MFG_PO_PON_WFSTAT_PONCNCT'));
      set_item_result(run_stored_sig('EBS_MFG_PO_PON_WF_NOTIFICATIONS_PONCNCT'));
      set_item_result(run_stored_sig('EBS_MFG_PO_PON_WF_NOTIFICATION_PONCNCT_2101833_1'));
      IF ((substr(g_rep_info('Apps Version'),1,4) = '12.1') OR (substr(g_rep_info('Apps Version'),1,4) = '12.2')) THEN
         set_item_result(run_stored_sig('PON_WF_ITEM_ACTIVITY_STATUSES_ERROR_2241469.1'));
         set_item_result(run_stored_sig('PON_WF_ITEM_ACTIVITY_STATUSES_ERROR_2138321.1'));
         set_item_result(run_stored_sig('PON_WF_ITEM_ACTIVITY_STATUSES_ERROR_2086580.1'));
      END IF;
      set_item_result(run_stored_sig('PON_WF_ITEM_ACTIVITY_STATUSES_ERROR'));
      set_item_result(run_stored_sig('PON_NOTIFICATION_SUBSCRIPTIONS_BUYER'));
      set_item_result(run_stored_sig('PON_NOTIFICATION_SUBSCRIPTIONS_SUPPLIER'));
   end_section('Workflow data for Negotiation');
END IF;
debug('end section: Workflow');

debug('begin section: SourcingSetups');
start_section('Sourcing Related Setups', 'SourcingSetups');
   set_item_result(run_stored_sig('PON_NEGOTIATION_STYLES'));
   set_item_result(run_stored_sig('PON_DOCTYPE_STYLES'));
   set_item_result(run_stored_sig('PON_FORMS_SECTIONS'));
   set_item_result(run_stored_sig('PON_FORMS_SECTIONS_TL'));
   set_item_result(run_stored_sig('PON_FORMS_INSTANCES'));
   set_item_result(run_stored_sig('PON_AUCTION_TEMPLATES'));
   set_item_result(run_stored_sig('PON_FND_ATTACHED_DOCUMENTS_PON_TEMPLATES'));
   set_item_result(run_stored_sig('PON_OKC_TERMS_TEMPLATES_ALL'));
   set_item_result(run_stored_sig('PON_FND_ATTACHED_DOCUMENTS_OKC_TERMS_TEMPLATES'));
   set_item_result(run_stored_sig('EBS_MFG_PON_CONTRACTS_AND_CONTRACTS_TL'));
   set_item_result(run_stored_sig('EBS_MFG_PON_MULTIPLE_T_AND_C_EXIST_FOR_OU'));
end_section;
debug('end section: SourcingSetups');

debug('begin section: AME');
IF g_use_ame = 'true' THEN
   start_section('AME', 'AME');
      set_item_result(run_stored_sig('EBS_MFG_PO_PON_AME_CONFIG_VARS'));
      set_item_result(run_stored_sig('EBS_MFG_PO_PON_AME_MANDATORY_ATTR'));
      set_item_result(run_stored_sig('EBS_MFG_PO_PON_AME_ITEM_CLASSES'));
      set_item_result(run_stored_sig('EBS_MFG_PO_PON_AME_IC_ATTR'));
      set_item_result(run_stored_sig('EBS_MFG_PON_AME_ATTR_DESC_GT_100_CHARS'));
      set_item_result(run_stored_sig('EBS_MFG_PO_PON_AME_CONDITIONS'));
      set_item_result(run_stored_sig('EBS_MFG_PO_PON_AME_APPR_GROUPS'));
      set_item_result(run_stored_sig('EBS_MFG_PO_PON_AME_RULES'));
      set_item_result(run_stored_sig('EBS_MFG_PO_PON_AME_ACTION_TYPES'));
      set_item_result(run_stored_sig('EBS_MFG_PON_AWARD_APPR_AME_EXCEPTION_LOG'));
      set_item_result(run_stored_sig('EBS_MFG_PO_PON_NEG_APPR_AME_EXCEPTION_LOG'));
   end_section;
END IF;
debug('end section: AME');
...
start_section('Diagnostic Apps Check', 'Diagnostic_Apps_Check');
   ...
   set_item_result(run_stored_sig('PON_APPLICATION_INSTALL_DETAILS'));
   ...
   set_item_result(run_stored_sig('POS_APPLICATION_INSTALL_DETAILS'));
end_section;
