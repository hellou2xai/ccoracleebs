...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Procure To Pay Analyzer                |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE p2p_analyzer_pkg AUTHID DEFINER AS
...
FUNCTION chk_pkg_body_version(p_package_name IN VARCHAR2, p_expected_version IN VARCHAR2) RETURN NUMBER;
...
FUNCTION verify_approver(p_empid IN NUMBER) return VARCHAR2;
...
-- $Id: p2p_analyzer.sql, 200.26 2026/01/28 16:21:22 dfelton Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2040474.1));
...
g_sql_result      VARCHAR2(1);
g_dynamic_sql     VARCHAR2(8000);
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'P2P_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'P2P_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>P2P Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2040474.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/p2p_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,526,EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,526,EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},526,EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/3800635" class="blacklink" target="new">
...
<p>We’re listening to your feedback and made the following changes</p><p>Version 200.26</p><ul><li>Fix a Knowledge Article link to match Fusion Service reference (in the check for invalid index signature)</li>
</ul>
<p>Version 200.25</p><ul><li>Fix Knowledge Article links to match Fusion Service references</li>
<li>Include Framework improvements</li>
</ul>
<p>Version 200.24</p><ul><li>Updated sequence checks</li>
<li>Include Framework improvements for move to Fusion Service</li>
</ul>
<p>Version 200.23</p><ul><li>Added warnings for the following<ul><li>Quick Matched Invoices Populated with Multiple Precision on Invoice Lines and Distributions Causing Hold with Reason Quantity Billed Is More than Quantity Accepted</li>
<li>GDF per [1094274.1] - R12 Generic Data Fix (GDF) Patch for Bug 9231247 - Error APP-PO-14144: PO_ACTIONS-065 On Validating Payables Invoice Matched to Blanket or Planned PO.</li>
</ul>
</li>
<li>Update Procurement code level checks</li>
<li>Include Framework improvements</li>
</ul>
<p>Version 200.22</p><ul><li>Improve Purchasing Options</li>
<li>Improve Document Types</li>
<li>Include framework improvements</li>
</ul>
<p>Version 200.21</p><ul><li>Include improvements to sequence checks in "Lifetime Support Policy"</li>
<li>Improve Receiving Transaction Manager processes check</li>
<li>Improve database sequence checks</li>
<li>Include framework improvements</li>
</ul>
<p>Version 200.20</p><ul><li>Display PO Header/Line/Line Location/Distribution data at same level, no longer using drilldown or hierarchical structure - allows improved format for downloaded data and allows user to review without drilling into each line or shipment to see distribution data</li>
<li>Display Requisition Header/Line/Distribution data at same level (similar to above for PO)</li>
<li>Improve sequence checks in "Lifetime Support Policy" to check differently in 12c vs 11g</li>
</ul>
<p>Version 200.19</p><ul><li>Renamed "Lifetime Support Policy” section as “Critical Alerts” and added sequence checks</li>
<li>Include framework updates</li>
</ul>
<p>Version 200.18</p><ul><li>Updated the SQL in AC_PATCHES_APPLIED to include Language, Applied Flag is Y and truncated creation date to eliminate duplicates.</li>
<li>Update Organization Document Types signature with distinct condition to avoid duplicate rows being displayed&apos;</li>
</ul>
<p>Version 200.17</p><ul><li>Implemented Analyzer framework improvements&nbsp;</li>
</ul>
<p>Version 200.16</p><ul><li>Replace - Recommended Critical Workflow Patch - signature with new and improved signature</li>
<li>Added - Various Invoice Matching Related Issues - with GDF recommendations</li>
</ul>
<p>Version 200.15</p><ul><li>Added signatures<ul><li>In PO section:&nbsp; Shipment Distribution has Null AMOUNT_ORDERED Using Amount Type Matching (based on Po Header ID)</li>
<li>In Invoice section:&nbsp; Shipment Distribution has Null AMOUNT_ORDERED Using Amount Type Matching (based on Invoice ID)</li>
</ul>
</li>
<li>Implemented framework improvements as well as internal improvements to some of the information signatures</li>
</ul>
<p>Version 200.14</p><ul><li>Improved Purchasing Options, Financial Options, 12.2 patching levels, and Workflow Hot Fix Patch signatures</li>
<li>Add value basis and matching basis to the PO Line Locations data</li>
<li>Added some details to Receiving Options Setup data</li>
<li>Added check for 12.2.12 patching</li>
</ul>
<p>Version 200.13</p><ul><li>Updated patch level checks</li>
</ul>
<p>Version 200.12</p><ul><li>Updated PREMIER_SUPPORT_12.1</li>
</ul>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,526,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,526,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},526,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
FUNCTION verify_approver(p_empid IN NUMBER) return VARCHAR2 IS
...
/* Added AND owner = 'PO' due to bug where ORA-00904 error would occur on rowid */
...
/* Added FROM PO. due to bug where ORA-00904 error would occur on rowid */
         
         dyn_cursor := DBMS_SQL.OPEN_CURSOR;
         DBMS_SQL.PARSE
           (dyn_cursor,
               'SELECT COUNT(*) ' ||
               'FROM PO.' || l_tables_tbl(i) ||
...
PROCEDURE populate_p2p_globals (p_req_id NUMBER, p_org_id NUMBER) IS 

---------------------------------------------------------------
-- Custom cursor to return the all related purchase orders   -- 
---------------------------------------------------------------
CURSOR purchase_order_ids_c (p_req_id IN VARCHAR2, p_org_id IN NUMBER) IS
 ...
 -- AND     r.requisition_header_id =  g_sql_tokens('##$$REQID$$##') 
  AND     r.requisition_header_id = p_req_id 
...
OPEN purchase_order_ids_c (p_req_id, p_org_id);   
...
FUNCTION check_rec_patches_1 RETURN VARCHAR2 IS
  /* Signature P2P_RECOMMENDED_PATCHES */
  l_col_rows   COL_LIST_TBL := col_list_tbl(); -- Row values
...
BEGIN
    ...
    print_log('Processing recommended patches signature: P2P_RECOMMENDED_PATCHES (check_rec_patches_1) "Recommended Patches" (version 8)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '17755570';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.1.3 OKC RUP2';
   l_col_rows(5)(l_rows) := '[1612432.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.0' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Procurement R12.0 Update Aug 2009 (12.0.x)';
   l_col_rows(5)(l_rows) := '[1122052.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'RPC-FEB16: PAYABLES RECOMMENDED PATCH COLLECTION (CORE AP)';
   l_col_rows(5)(l_rows) := '[1397581.1]';

END IF;

   l_extra_info('##SHOW_SQL##'):= 'Y';

   l_sig.sigrepo_id := '2679';
...
Best Practice: Always ensure that you are on the latest code with all recommended patches applied. This will help avoid known issues, prevent potential data corruption and provide the latest features and functionality. Having a proactive patching plan and periodic proactive patching process in place are the best ways to stay current. ';
  ...
  -- Register
  l_step := '60';
  g_signatures('P2P_RECOMMENDED_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'P2P_RECOMMENDED_PATCHES',     -- sig ID
    l_sig,                              -- signature information
    l_col_rows,                         -- data
    l_hdr);                             -- headers
...
FUNCTION get_CVIEW
   return VARCHAR2 IS
BEGIN
debug('begin sql token function: CVIEW');
...
debug('end sql token function: CVIEW');
END get_CVIEW;

FUNCTION get_DOCTYPESHORT
   return VARCHAR2 IS
BEGIN
debug('begin sql token function: DOCTYPESHORT');
  ...
  ELSE
      return l_trx_type;
  END IF; 
debug('end sql token function: DOCTYPESHORT');
END get_DOCTYPESHORT;
...
debug('begin populate parameters hash table');
   ...
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Requisition number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_req_num,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Document Type';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_trx_type,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Purchase Order Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_po_num,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Release Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_release_num,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Invoice Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_invoice_num,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  l_revision := rtrim(replace('$Revision: 200.26  $','$',''));
  l_revision := ltrim(replace(l_revision,'Revision:',''));
  l_date_char := rtrim(replace('$Date: 2026/01/28 16:21:21 $','$',''));
...
debug('begin parameter validation: p_req_num');
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: No Requisition number found');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_req_num failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_req_num');

debug('begin parameter validation: p_trx_type');
IF p_trx_type IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Document Type is required.');
   raise invalid_parameters;
END IF;
IF p_trx_type IS NOT NULL AND p_trx_type NOT IN ( 'PA','PO','RELEASE') THEN
   print_error('INVALID ARGUMENT: Invalid trx type specified.
Value should be one of PA, PO or RELEASE');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_trx_type');

debug('begin parameter validation: p_po_num');
IF p_po_num IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Purchase Order Number is required.');
   raise invalid_parameters;
END IF;
...
SELECT SEGMENT1
INTO l_exists_val
FROM (SELECT SEGMENT1   FROM PO_HEADERS_ALL  WHERE P_TRX_TYPE IN ('PO','PA','RELEASE')    AND ORG_ID = P_ORG_ID AND TYPE_LOOKUP_CODE NOT IN ('QUOTATION','RFQ')) 
WHERE SEGMENT1 = p_po_num and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid purchase order number specified.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_po_num failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_po_num');

debug('begin parameter validation: p_release_num');
IF p_release_num IS NOT NULL THEN
BEGIN
SELECT R.RELEASE_NUM
INTO l_exists_val
FROM PO_RELEASES_ALL R, PO_HEADERS_ALL H
WHERE R.RELEASE_NUM = p_release_num
 AND r.po_header_id = h.po_header_id 
and p_trx_type = 'RELEASE' 
and h.segment1 = p_po_num
and h.org_id = p_org_id
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid release, PO and org_id combination.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_release_num failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_release_num');

debug('begin parameter validation: p_invoice_num');
IF p_invoice_num IS NOT NULL THEN
BEGIN
SELECT APIA.INVOICE_NUM
INTO l_exists_val
FROM AP_INVOICES_ALL APIA,PO_HEADERS_ALL POH,AP_INVOICE_DISTRIBUTIONS_ALL APIDA,PO_DISTRIBUTIONS_ALL POD,PO_LINES_ALL POL
WHERE APIA.INVOICE_NUM = p_invoice_num
 AND apia.invoice_id=apida.invoice_id 
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid invoice number');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_invoice_num failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_invoice_num');
...
*/
 ...
 l_step := '40';
  IF upper(nvl(p_trx_type,'XXX')) NOT IN ('PA','PO','RELEASE') THEN
  ...
  l_step := '45';
  IF (p_po_num IS NULL OR p_po_num='') THEN
...
print_log('g_apps_version = '||g_apps_version);
...
debug('begin populate sql tokens hash table');
   ...
   g_masked_tokens('##$$REQSUBTP$$##') := mask_text( g_sql_tokens('##$$REQSUBTP$$##'), 'NO_MASK');
   g_sql_tokens('##$$REQID$$##') := nvl(to_char(l_req_id),'NULL');
   g_masked_tokens('##$$REQID$$##') := mask_text( g_sql_tokens('##$$REQID$$##'), 'NO_MASK');
   g_sql_tokens('##$$REQITMTYPE$$##') := l_req_item_type;
   g_masked_tokens('##$$REQITMTYPE$$##') := mask_text( g_sql_tokens('##$$REQITMTYPE$$##'), 'NO_MASK');
   g_sql_tokens('##$$REQITMKEY$$##') := l_req_item_key;
   g_masked_tokens('##$$REQITMKEY$$##') := mask_text( g_sql_tokens('##$$REQITMKEY$$##'), 'NO_MASK');
   g_sql_tokens('##$$PONUM$$##') := l_po_num;
   g_masked_tokens('##$$PONUM$$##') := mask_text( g_sql_tokens('##$$PONUM$$##'), 'NO_MASK');
   g_sql_tokens('##$$POSUBTP$$##') := l_po_subtype;
   g_masked_tokens('##$$POSUBTP$$##') := mask_text( g_sql_tokens('##$$POSUBTP$$##'), 'NO_MASK');
   ...
   g_masked_tokens('##$$PORELID$$##') := mask_text( g_sql_tokens('##$$PORELID$$##'), 'NO_MASK');
   g_sql_tokens('##$$PORELNUM$$##') := p_release_num;
   g_masked_tokens('##$$PORELNUM$$##') := mask_text( g_sql_tokens('##$$PORELNUM$$##'), 'NO_MASK');
   g_sql_tokens('##$$RVIEW$$##') := 'SELECT transaction_id '||
               'FROM rcv_transactions '||
               'WHERE po_header_id = '||l_po_id||' '|| 
               'AND transaction_type in (''RECEIVE'',''MATCH'')';
   g_masked_tokens('##$$RVIEW$$##') := mask_text( g_sql_tokens('##$$RVIEW$$##'), 'NO_MASK');
   ...
   g_sql_tokens('##$$CVIEW$$##') := get_CVIEW();
   l_system_function_var := null;
   g_masked_tokens('##$$CVIEW$$##') := mask_text( g_sql_tokens('##$$CVIEW$$##'), 'NO_MASK');
   g_sql_tokens('##$$INVOICEID$$##') := l_invoice_id;
   g_masked_tokens('##$$INVOICEID$$##') := mask_text( g_sql_tokens('##$$INVOICEID$$##'), 'NO_MASK');
   g_sql_tokens('##$$INVOICEUM$$##') := p_invoice_num;
   g_masked_tokens('##$$INVOICEUM$$##') := mask_text( g_sql_tokens('##$$INVOICEUM$$##'), 'NO_MASK');
   ...
   g_sql_tokens('##$$RELID$$##') := nvl(to_char(l_po_rel_id),'NULL');
   g_masked_tokens('##$$RELID$$##') := mask_text( g_sql_tokens('##$$RELID$$##'), 'NO_MASK');
   g_sql_tokens('##$$PREPID$$##') := nvl(to_char(l_preparer_id),'NULL');
   g_masked_tokens('##$$PREPID$$##') := mask_text( g_sql_tokens('##$$PREPID$$##'), 'NO_MASK');
   g_sql_tokens('##$$AMETRXTP$$##') := l_ame_trx_type;
   g_masked_tokens('##$$AMETRXTP$$##') := mask_text( g_sql_tokens('##$$AMETRXTP$$##'), 'NO_MASK');
   ...
   g_masked_tokens('##$$CREATEDOC$$##') := mask_text( g_sql_tokens('##$$CREATEDOC$$##'), 'NO_MASK');
   g_sql_tokens('##$$DOCTYPESHORT$$##') := get_DOCTYPESHORT();
   l_system_function_var := null;
   g_masked_tokens('##$$DOCTYPESHORT$$##') := mask_text( g_sql_tokens('##$$DOCTYPESHORT$$##'), 'NO_MASK');
...
debug('begin add_signature: P2P_INVALIDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2511',
      p_sig_id                 => 'P2P_INVALIDS',
    ...
    AND a.object_name <> '' XLA_00200_AAD_S_000012_PKG''
    AND a.status = ''INVALID''',
      p_title                  => 'Procure to Pay Related Invalid Objects',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invalid purchasing / payments/ payables related objects exist.',
      p_solution               => '<ul>
...
for details on compiling these invalid objects</li>
   ...
   l_info.delete;
debug('end add_signature: P2P_INVALIDS');



debug('begin add_signature: P2P_FND_DEVELOPER_MODE_PROFILE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2512',
      p_sig_id                 => 'P2P_FND_DEVELOPER_MODE_PROFILE',
...
a.level_id DESC',
      p_title                  => 'Profile FND: Developer Mode',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Profile FND: Developer Mode is NULL.',
      p_solution               => 'See [393180/KB247435] Purchasing Forms Opening With Error APP-FND-1388: Routine &ROUTINE Cannot Read Value For Profile Option Fnd_developer_mode.
',
      p_success_msg            => 'Profile FND: Developer Mode is set to a value other than NULL.
',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: P2P_FND_DEVELOPER_MODE_PROFILE');



debug('begin add_signature: P2P_TABLESPACE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2513',
      p_sig_id                 => 'P2P_TABLESPACE_CHECK',
  ...
  order  by ((a.BYTES-b.BYTES)/a.BYTES) desc',
      ...
      p_solution               => 'Review items indicated and add additional datafiles to the tablespace as required.',
   ...
   l_info.delete;
debug('end add_signature: P2P_TABLESPACE_CHECK');



debug('begin add_signature: P2P_XLA_00200_INVALID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5182',
      p_sig_id                 => 'P2P_XLA_00200_INVALID',
      p_sig_sql                => 'SELECT a.object_name,
           decode(a.object_type,
             ''PACKAGE'', ''Package Spec'',
             ''PACKAGE BODY'', ''Package Body'',
    ...
    AND a.object_name = ''XLA_00200_AAD_S_000012_PKG''
    AND a.status = ''INVALID''',
      p_title                  => 'XLA_00200_AAD_S_000012_PKG',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invalid XLA_00200_AAD_S_000012_PKG exists.',
      p_solution               => '<ul>     
      <li>Review any error messages provided and see [1320222/KB486902]
          for general details on compiling these invalid object.</li>
</ul>',
      p_success_msg            => 'XLA_00200_AAD_S_000012_PKG is valid',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_XLA_00200_INVALID');
...
debug('begin add_signature: P2P_REQUISITION_HEADER_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2514',
      p_sig_id                 => 'P2P_REQUISITION_HEADER_DETAILS',
      p_sig_sql                => 'SELECT segment1 "Doc Number",
    ...
    AND   org_id = ##$$ORGID$$##',
      p_title                  => 'Requisition Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No requisition details found.',
      p_solution               => 'Verify that the document exists in this operating unit.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: P2P_REQUISITION_HEADER_DETAILS');



debug('begin add_signature: P2P_REQUISITION_LINE_DETAILS');
   l_info('##MASK##FULL_NAME'):= 'DISPLAY_FIRST_4_CHAR';
   l_info('##MASK##REQUESTOR'):= 'DISPLAY_FIRST_4_CHAR';
   l_info('##MASK##SUGGESTED_BUYER'):= 'DISPLAY_FIRST_4_CHAR';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2515',
      p_sig_id                 => 'P2P_REQUISITION_LINE_DETAILS',
      p_sig_sql                => 'SELECT rl.line_num,
    ...
    ORDER BY rl.line_num',
      p_title                  => 'Requisition Line Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No document lines found for this document.',
      p_solution               => 'Verify that the document exists in this operating unit.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: P2P_REQUISITION_LINE_DETAILS');



debug('begin add_signature: P2P_REQUISITION_DIST_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2516',
      p_sig_id                 => 'P2P_REQUISITION_DIST_DETAILS',
      p_sig_sql                => 'SELECT d.requisition_line_id,
           d.distribution_num,
           d.req_line_quantity,
    ...
    WHERE d.requisition_line_id in (select requisition_line_id from po_requisition_lines_all where requisition_header_id = ##$$REQID$$##)
    AND   d.code_combination_id = g.code_combination_id(+)
    ORDER BY d.requisition_line_id, d.distribution_num',
      p_title                  => 'Requisition Distribution Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No distributions found for this document.',
      p_solution               => 'Verify that the document exists in this operating unit.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: P2P_REQUISITION_DIST_DETAILS');



debug('begin add_signature: P2P_REQUISITION_APPROVAL_HISTORY');
   l_info('##MASK##FULL_NAME'):= 'DISPLAY_FIRST_4_CHAR';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2517',
      p_sig_id                 => 'P2P_REQUISITION_APPROVAL_HISTORY',
      p_sig_sql                => 'SELECT distinct(ppf.full_name), pah.*
    ...
    AND object_type_code = ''REQUISITION''',
      p_title                  => 'Requisition Approval History',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No approval history found for this document.',
      p_solution               => 'Verify that the document exists in this operating unit.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: P2P_REQUISITION_APPROVAL_HISTORY');



debug('begin add_signature: P2P_PODATACORRUPTION_05');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2518',
      p_sig_id                 => 'P2P_PODATACORRUPTION_05',
      p_sig_sql                => 'SELECT    prl.requisition_header_id,
    ...
    AND       nvl(prl.quantity_delivered,0) >= prl.quantity',
      p_title                  => 'Outstanding Supply/Demand for Requisition Lines',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Pending supply for fully received internal requisition lines exist.',
      p_solution               => 'See [1220964/KB350248] Fully Received Internal Requisitions Continue To Show As Pending Supply - MTL_SUPPLY.',
      p_success_msg            => 'No pending supply for fully received internal requisition lines. ',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_PODATACORRUPTION_05');



debug('begin add_signature: P2P_PODATACORRUPTION_06');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2519',
      p_sig_id                 => 'P2P_PODATACORRUPTION_06',
      p_sig_sql                => 'SELECT prha.requisition_header_id req_header_id
    ...
    AND prla.line_location_id NOT IN (SELECT line_location_id FROM po_line_locations_all)',
      p_title                  => 'Missing Requisitions In Autocreate',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found approved requisitions not available in autocreate form after associated purchase order is deleted.',
      p_solution               => 'See [1432915/KB316515] Datafix: Approved Requisition Is Not Available In The Autocreate Form After Purchase Order Deleted.',
      p_success_msg            => 'All approved requisition(s) are available in autocreate form.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_PODATACORRUPTION_06');



debug('begin add_signature: P2P_PODATACORRUPTION_14');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2520',
      p_sig_id                 => 'P2P_PODATACORRUPTION_14',
      p_sig_sql                => 'SELECT  podc.req_distribution_id,
        pd2.po_header_id,
    ...
    where pd2.req_distribution_id = podc.req_distribution_id',
      p_title                  => 'Requisition Distribution Line Associated to Multiple Purchase Order Distribution Lines',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found requisition distribution line(s) associated to multiple purchase order distribution line(s). This can cause encumbrance to fail.',
      p_solution               => 'See [1068077/KB328993] Unable To Cancel Blanket Release, Form Error APP-PO-14056 #PO_REQUEST_ACTION.',
      p_success_msg            => 'No multiple requisition distribution line(s) associated to multiple purchase order distribution line(s) found. ',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_PODATACORRUPTION_14');



debug('begin add_signature: P2P_PODATACORRUPTION_18');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2523',
      p_sig_id                 => 'P2P_PODATACORRUPTION_18',
   ...
   AND NOT EXISTS (SELECT ''exists''
      ...
      p_title                  => 'Missing Supply for Requisition Lines',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found missing supply for requisition lines.',
      p_solution               => 'Log a service request to get a datafix for this issue.',
      p_success_msg            => 'No missing supply found. ',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_PODATACORRUPTION_18');



debug('begin add_signature: P2P_DFF_UNFROZEN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2524',
      p_sig_id                 => 'P2P_DFF_UNFROZEN',
...
AND freeze_flex_definition_flag = ''N''',
      p_title                  => 'Requisition and Purchasing Descriptive Flexfields (DFF)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found requisition and/or purchasing descriptive flexfield(s) (DFF) that are not frozen. Before a DFF can be used it must be frozen.',
      p_solution               => '<p>Freeze the returned DFF''s.</p>
<p>See [1078882/KB761615] - Error JBO-27122 When Trying To Create Requisitions In iProcurement.</p>',
      p_success_msg            => 'All descriptive flexfield(s) (DFF) are frozen. ',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_DFF_UNFROZEN');



debug('begin add_signature: P2P_CANCELLED_REQ_LINE_AUTOCREATE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2525',
      p_sig_id                 => 'P2P_CANCELLED_REQ_LINE_AUTOCREATE',
      p_sig_sql                => 'SELECT prh.segment1,
           prl.requisition_header_id,
           prl.line_num,
    ...
    AND   prl.CANCEL_FLAG = ''Y''',
      p_title                  => 'Data Corruption with Requisition Line and Autocreate',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The requisition line listed is cancelled but will appear in the autocreate screen.',
      p_solution               => 'See [1492372/KB384959] - Autocreate Is Displaying Cancelled Requisition Lines for the solution.',
      p_success_msg            => 'No potential issues detected.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_CANCELLED_REQ_LINE_AUTOCREATE');



debug('begin add_signature: P2P_PO_HEADER_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2526',
      p_sig_id                 => 'P2P_PO_HEADER_DETAILS',
      p_sig_sql                => 'SELECT po_header_id header_id,
           po_header_id "##$$FK1$$##",
           segment1 po_number,
           approved_flag,
           approved_date,
    ...
    AND   org_id = ##$$ORGID$$##',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No purchase order details found.',
      p_solution               => 'Verify that the document exists in this operating unit.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: P2P_PO_HEADER_DETAILS');



debug('begin add_signature: P2P_PO_LINE_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2527',
      p_sig_id                 => 'P2P_PO_LINE_DETAILS',
      p_sig_sql                => 'SELECT l.line_num,
           l.line_num "##$$FK4$$##",
           l.po_line_id,
           l.po_line_id "##$$FK5$$##",
           l.item_id,
   ...
   l_info.delete;
debug('end add_signature: P2P_PO_LINE_DETAILS');



debug('begin add_signature: P2P_PO_LINE_LOCATIONS');
   l_info('##MASK##CANCEL_REASON'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CLOSED_REASON'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2528',
      p_sig_id                 => 'P2P_PO_LINE_LOCATIONS',
      p_sig_sql                => 'SELECT l.line_num po_line_num, l.po_line_id,
           ll.line_location_id,
           ll.shipment_num,
           ll.shipment_type,
           ll.quantity,
    ...
    AND ll.po_release_id = NVL(##$$PORELID$$##,ll.po_release_id)
--    AND   l.line_num  = ##$$FK4$$##
   /* AND ll.line_location_id in (
    ...
    ORDER BY l.line_num',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No line location records found for this document.',
      p_solution               => 'Verify that the document exists in this operating unit.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: P2P_PO_LINE_LOCATIONS');



debug('begin add_signature: P2P_PO_DIST_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2529',
      p_sig_id                 => 'P2P_PO_DIST_DETAILS',
      p_sig_sql                => 'SELECT d.po_line_id,
           d.line_location_id,
           d.distribution_num, d.po_distribution_id, 
           d.quantity_ordered,
           d.code_combination_id,
           substr(rtrim(g.segment1||''-''||g.segment2||''-''||
             g.segment3||''-''||g.segment4||''-''||
...
AND po_release_id = NVL(##$$PORELID$$##,po_release_id)
--    AND   d.po_line_id  = ##$$FK5$$##
   ...
   l_info.delete;
debug('end add_signature: P2P_PO_DIST_DETAILS');



debug('begin add_signature: P2P_PO_APPROVAL_HISTORY');
   l_info('##MASK##FULL_NAME'):= 'DISPLAY_FIRST_4_CHAR';
   l_info('##MASK##NOTE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2530',
      p_sig_id                 => 'P2P_PO_APPROVAL_HISTORY',
      p_sig_sql                => 'SELECT  ppf.full_name, 
    ...
    order by poa.sequence_num asc',
      p_title                  => 'Purchase Order Approval History',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No approval history found for this document.',
      p_solution               => 'Verify that the document exists in this operating unit.',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: P2P_PO_APPROVAL_HISTORY');



debug('begin add_signature: P2P_PODATACORRUPTION_01');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2533',
      p_sig_id                 => 'P2P_PODATACORRUPTION_01',
      p_sig_sql                => 'SELECT poll.po_line_id,
      ...
      p_title                  => 'Quantity/Amount Billed Mismatch on Shipment/Distribution',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found mismatch of quantity billed or amount billed between the shipment and distribution.',
      p_solution               => 'See [427917/KB563402] - Quantity Billed / Amount Billed Mismatch In Purchase Order Shipments And Distributions.',
      p_success_msg            => 'No mismatch found with the quantity billed or amount billed between the shipment and distribution.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_PODATACORRUPTION_01');



debug('begin add_signature: P2P_PODATACORRUPTION_02');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2534',
      p_sig_id                 => 'P2P_PODATACORRUPTION_02',
      p_sig_sql                => 'select
		apd.po_release_id,
    ...
    from (
     ...
     AND aid.invoice_id = ai.invoice_id
      ...
      p_title                  => 'Purchase Order/Accounts Payable Quantity/Amount Mismatch',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Mismatch of quantity billed or amount billed between the shipment or distribution and the account payables invoice distribution.',
      p_solution               => 'See [454060/KB761838] - Mismatch of Quantity billed / Amount Billed on Purchase Order Distribution / Shipment and Payable Invoice Distribution.',
      p_success_msg            => 'No mismatch found. ',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_PODATACORRUPTION_02');



debug('begin add_signature: P2P_PODATACORRUPTION_03');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2535',
      p_sig_id                 => 'P2P_PODATACORRUPTION_03',
      p_sig_sql                => 'select poll.po_line_id
   from   po_line_locations_all poll,
   ...
   where poll.shipment_type in (''STANDARD'',''BLANKET'') 
     ...
     and nvl(poll.closed_code,''OPEN'') IN (''OPEN'',''CLOSED FOR RECEIVING'',
                                          ''CLOSED FOR INVOICE'')',
      p_title                  => 'Purchase Order Shipments Eligible to Be Closed',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found purchase order shipment lines eligible for closing. Data corruption exists.',
      p_solution               => 'See [465068/KB283108] - Generic Datafix For Closing Open PO Shipments Which Are Eligible To Be Closed.',
      p_success_msg            => 'No eligible shipment lines found. ',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_PODATACORRUPTION_03');



debug('begin add_signature: P2P_PODATACORRUPTION_04');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2536',
      p_sig_id                 => 'P2P_PODATACORRUPTION_04',
      p_sig_sql                => 'SELECT   pd.po_line_id,
         pd.line_location_id,
         pd.po_release_id,
  ...
  AND  EXISTS 
      ...
      p_title                  => 'Outstanding Supply for Closed Documents',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Purchase Order Supply exists for Purchase Order whose closed code is in ''CLOSED'',''CLOSED FOR RECEIVING'',''FINALLY CLOSED'' and Purchase Order is cancelled for following document types, Standard PO, Planned PO, Blanket Release, Scheduled Release.',
      p_solution               => 'See [402217/KB229819] - How to Remove Supply/Demand Showing for Closed or Cancelled POs/Releases ? ',
      p_success_msg            => 'No outstanding demand found. ',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_PODATACORRUPTION_04');



debug('begin add_signature: P2P_PODATACORRUPTION_07');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2537',
      p_sig_id                 => 'P2P_PODATACORRUPTION_07',
      p_sig_sql                => 'SELECT DISTINCT ph.po_header_id,  ph.type_lookup_code, pl.po_line_id, pll.line_location_id, pl.unit_meas_lookup_code, pll.unit_meas_lookup_code
    FROM   po_line_locations_all pll,
             po_lines_all pl,
             po_headers_all ph
    ...
    AND ( ( ph.type_lookup_code = ''BLANKET''
      ...
      p_title                  => 'Purchase Order UOM Mismatch',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found purchase order documents with UOM mismatch between lines and shipments.',
      p_solution               => 'See [1419114/KB346526] - Purchase Order Unit Of Measure Is Not Matching Between The Line And Shipment - PO Line Has Different UOM Than Shipment.',
      p_success_msg            => 'No UOM mismatch found for purchase order documents.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_PODATACORRUPTION_07');



debug('begin add_signature: P2P_PODATACORRUPTION_08');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2538',
      p_sig_id                 => 'P2P_PODATACORRUPTION_08',
      p_sig_sql                => 'SELECT   po_header_id, 
         segment1, 
         org_id, 
         cancel_flag,
         authorization_status
    ...
    and authorization_status = ''REQUIRES REAPPROVAL''',
      p_title                  => 'Canceled Purchase Order in Requires Re-approval Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The status of a Purchase order shows requires-reapproval even though it has been completely canceled.',
      p_solution               => 'See [1379274/KB277593] - Purchase Order Is Cancelled At Header Level - Still Status Is Showing As Requires Reapproval - No Actions Possible.',
      p_success_msg            => 'Purchase order is in correct status. ',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_PODATACORRUPTION_08');



debug('begin add_signature: P2P_PODATACORRUPTION_09');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2539',
      p_sig_id                 => 'P2P_PODATACORRUPTION_09',
      p_sig_sql                => 'SELECT PLL.LINE_LOCATION_ID,
       PLL.SHIPMENT_NUM,
    ...
    WHERE PLL.PO_HEADER_ID = ##$$POID$$##
      ...
      p_title                  => 'Tax Exception 023 When Approving Document',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Tax exception 023 (ORA-00001: unique constraint (ZX.ZX_LINES_DET_FACTORS_U1) violated") when approving document.',
      p_solution               => 'See [1346647/KB721767] - R12: Tax Calculation Error When Trying To Approve Foreign Currency Purchase Order.',
      p_success_msg            => 'No invalid tax constraint issue found. ',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_PODATACORRUPTION_09');



debug('begin add_signature: P2P_PODATACORRUPTION_10');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2540',
      p_sig_id                 => 'P2P_PODATACORRUPTION_10',
      p_sig_sql                => 'SELECT PH.PO_HEADER_ID,
       PH.SEGMENT1,   
       PH.AUTHORIZATION_STATUS
    FROM  po_headers_all PH
    where ph.PO_HEADER_ID = ##$$POID$$##
    and authorization_status = ''REQUIRES_REAPPROVAL''',
      p_title                  => 'Incorrect Requires Re-approval Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This Purchase order has incorrect requires re-approval status.',
      p_solution               => 'See [1269228/KB795101] - Java Error Occurs When Querying Specific Agreement or Supplier in the Buyer Work Center.',
      p_success_msg            => 'Purchase order has the correct status.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_PODATACORRUPTION_10');



debug('begin add_signature: P2P_PODATACORRUPTION_11');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2541',
      p_sig_id                 => 'P2P_PODATACORRUPTION_11',
      p_sig_sql                => 'select distinct pha.po_header_id, 
     ...
     and pha.currency_code = prla.currency_code',
      p_title                  => 'Foreign Currency Purchase Order(s) with Inverse Rate',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Foreign currency autocreated purchase order(s) have an inverse rate.',
      p_solution               => 'See [756627/KB650423] - Foreign Currency Autocreated Purchase Orders Have Inverse Rate.',
      p_success_msg            => 'No invalid rate found. ',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_PODATACORRUPTION_11');



debug('begin add_signature: P2P_PODATACORRUPTION_12');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2543',
      p_sig_id                 => 'P2P_PODATACORRUPTION_12',
     ...
     and nvl(poll.closed_code,''OPEN'') != ''FINALLY CLOSED''
     and nvl(poll.cancel_flag,''N'') != ''Y''',
      p_title                  => 'Ship to Organization Does Not Match Distribution Deliver To Organization',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Shipment ship to organization does not match distribution deliver to organization.',
      p_solution               => 'See [1280061/KB566661] - Purchase Order Ship To Organization Does Not Match Distribution Deliver To Organization After Location Update In Buyer Work Center. ',
      p_success_msg            => 'No mismatch found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: P2P_PODATACORRUPTION_12');



debug('begin add_signature: P2P_PODATACORRUPTION_13');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2544',
      p_sig_id                 => 'P2P_PODATACORRUPTION_13',
      p_sig_sql                => 'select poll.po_header_id,
        poll.line_location_id,
        poll.ship_to_organization_id,
     ...
     and nvl(poll.closed_code,''OPEN'') != ''FINALLY CLOSED''
     and nvl(poll.cancel_flag,''N'') != ''Y''',
      p_title                  => 'Ship to Organization Does Not Match Supply To Organization',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Shipment ship to organization does not match supply to organization.',
      p_solution               => 'See [1280061/KB566661] - Purchase Order Ship To Organization Does Not Match Distribution Deliver To Organization After Location Update In Buyer Work Center.',
      p_success_msg            => 'No mismatch found. ',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: P2P_PODATACORRUPTION_13');



debug('begin add_signature: P2P_PODATACORRUPTION_19');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2547',
      p_sig_id                 => 'P2P_PODATACORRUPTION_19',
      p_sig_sql                => 'SELECT  h.authorization_status,
            h.org_id,
            l.line_num,
            l.po_line_id,
            l.last_update_date,
      ...
      p_title                  => 'Quantity_commited Wrongly Defaulted',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found lines with quantity_committed wrongly defaulted for SPO instead of leaving it NULL.',
      p_solution               => 'See [2041404/KB401541] - FRM-40654 Error Caused by QUANTITY_COMMITTED Incorrectly Populated by PDOI (Purchase Document Open Interface) When Trying to Update the Purchase Order Line or Shipment.',
   ...
   l_info.delete;
debug('end add_signature: P2P_PODATACORRUPTION_19');



debug('begin add_signature: P2P_PODATACORRUPTION_20');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2548',
      p_sig_id                 => 'P2P_PODATACORRUPTION_20',
      p_sig_sql                => 'SELECT
     PO.PO_LINE_ID,
     PO.LINE_LOCATION_ID,
     ...
     and PLL.LINE_LOCATION_ID = POD.LINE_LOCATION_ID
      ...
      p_title                  => 'Zero Stamped Amount or Quantity Purchase Order Distributions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found distribution lines with quantity or amount stamped with zero.',
      p_solution               => '<ul>
<li> A datafix will be needed. Please log a Service request for support to review your data.</li>
<li> INTERNAL [2049185/KB379410] - Unexpected error when creating a receipt or during tax calculation in Purchasing or Payables.</li> 
</ul>',
      p_success_msg            => 'No issue found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: P2P_PODATACORRUPTION_20');



debug('begin add_signature: P2P_DOC_STANDARD_CLAUSES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2550',
      p_sig_id                 => 'P2P_DOC_STANDARD_CLAUSES',
      p_sig_sql                => 'SELECT art.article_number "Clause Number"
      ...
      AND kart.document_id = ##$$POID$$##',
      p_title                  => 'Standard Clauses',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Document standard clauses.',
      p_solution               => '',
      p_success_msg            => 'Document standard clauses list.',
   ...
   l_info.delete;
debug('end add_signature: P2P_DOC_STANDARD_CLAUSES');



debug('begin add_signature: P2P_DOC_NON_STANDARD_CLAUSES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2551',
      p_sig_id                 => 'P2P_DOC_NON_STANDARD_CLAUSES',
      p_sig_sql                => 'SELECT art.article_number "Clause Number"
          ,art.article_title  "Clause Title"
          ,ver.display_name   "Clause Name"
          ,NVL(edited_in_word, ''No'')     "Edited in Word?"
    ...
    AND (kart.document_type   = ''PO_STANDARD'' or kart.document_type   = ''PA_BLANKET'')
    AND kart.document_id = ##$$POID$$##',
      p_title                  => 'Non Standard Clauses',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Document non standard clauses.',
      p_solution               => '',
      p_success_msg            => 'List of document non standard clauses.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_DOC_NON_STANDARD_CLAUSES');



debug('begin add_signature: P2P_2WAY_COUNT_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2532',
      p_sig_id                 => 'P2P_2WAY_COUNT_DETAILS',
      p_sig_sql                => 'SELECT l.line_num po_line_num,
           ll.line_location_id,
           ll.shipment_num,
           ll.shipment_type,
           ...
           ll.closed_reason,
           ll.match_option,
           ll.inspection_required_flag,
           ll.receipt_required_flag
    FROM po_line_locations_all ll,
         po_line_locations_all ll2,
         po_lines_all l,
         ap_terms apt,
  ...
  /* removed in case no req #   
    ...
    and   ((ll.inspection_required_flag=''N'' and ll.receipt_required_flag =''N'') 
          or (ll.inspection_required_flag is null and ll.receipt_required_flag =''Y''))  /* 2-way*/
    ORDER BY l.line_num',
      p_title                  => '2 Way Matching with Receipt Close Tolerance < 100%',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Purchase order lines with 2 way matching with receipt close tolerance < 100% detected.',
      p_solution               => '<ul>The solution is to set the receipt close tolerance to 100% and then follow the solution from [465068/KB283108] - Generic Datafix For closing open purchase order Shipments Which Are Eligible To Be Closed. This contains the generic datafix to close the line after the tolerance is set to 100%. The invoice must be validated if the datafix does not close the line. The invoice entry screen is where the invoice can be validated.</ul>

<ul> For Reference in understanding the setups<ul>
<li>[95429/KB532243] - PO Shipment is Closed For Invoicing , 2-Way Match, PO Header And Line Open</li>
<li>[1265680/KB524660] - How Are Purchase Orders Closed Automatically? Closed Status Rolled Up? PO''s Are Not Closing? for the detailed setup as this note explains multiple scenarios</li>',
      p_success_msg            => 'No possible problems found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_2WAY_COUNT_DETAILS');



debug('begin add_signature: P2P_2WAY_COUNT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2531',
      p_sig_id                 => 'P2P_2WAY_COUNT',
    ...
    WHERE ll.po_header_id = ##$$POID$$##
    AND   l.po_line_id = ll.po_line_id
   /* removed in case there is no req #
    AND ll.line_location_id in (
                         select rl.line_location_id from po_requisition_lines_all rl
                         where requisition_header_id in (
                                               select requisition_header_id
    ...
    ORDER BY l.line_num)',
      ...
      p_problem_descr          => 'Purchase order lines with 2 way matching with receipt close tolerance < 100% detected.',
      p_solution               => 'Expand the output to see the line details.',
      p_success_msg            => 'No possible problems found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('P2P_2WAY_COUNT_DETAILS'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '11'
      );
   l_info.delete;
debug('end add_signature: P2P_2WAY_COUNT');



debug('begin add_signature: P2P_AUTOCREATE_NUMBERING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2549',
      p_sig_id                 => 'P2P_AUTOCREATE_NUMBERING',
      p_sig_sql                => 'SELECT decode(PoUniqueIdentifierContEO.TABLE_NAME,''PO_HEADERS'',''PO Number'') "Document",
     ...
     AND PoSystemParameterEO.MANUAL_PO_NUM_TYPE = ''NUMERIC''',
      p_title                  => 'Incorrect Purchasing Numbering Setup for Autocreate',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found incorrect purchasing numbering setup for autocreate to be successful.',
      p_solution               => 'See [1409466/KB484489] - Using Autocreate The Requisition Is Not Created Into A Purchase Order And No Errors Are Encountered.',
      p_success_msg            => 'No issue found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: P2P_AUTOCREATE_NUMBERING');



debug('begin add_signature: EBS_FIN_AP_AP_INV_INT_INVALID_PO_NUM');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23742',
      p_sig_id                 => 'EBS_FIN_AP_AP_INV_INT_INVALID_PO_NUM',
      p_sig_sql                => 'SELECT HEAD.po_header_id, LINE.po_line_id, SHIP.line_location_id, DIST.po_distribution_id,
       DIST.distribution_num DIST_NO, SHIP.matching_basis, DIST.amount_ordered      
  FROM po_headers_all HEAD, po_lines_all LINE, po_line_locations_all SHIP, po_distributions_all DIST
 WHERE HEAD.po_header_id = LINE.po_header_id
   AND LINE.po_line_id = SHIP.po_line_id
   AND SHIP.line_location_id = DIST.line_location_id
   AND SHIP.matching_basis = ''AMOUNT''
   AND DIST.amount_ordered IS NULL
and HEAD.po_header_id in (##$$POID$$##)
',
      p_title                  => 'Shipment Distribution has Null AMOUNT_ORDERED Using Amount Type Matching',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The imported invoice is matching to a PO with a shipment that is set up for Amount type matching and one of the distributions associated the the shipment has a NULL value for Amount_Ordered.',
      p_solution               => 'Log an SR with Oracle Purchasing Support as detailed in [2524936/KB735352].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_AP_INV_INT_INVALID_PO_NUM');



debug('begin add_signature: P2P_MISMATCH_SHIPMENT_HEADER_ID');
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2571',
      p_sig_id                 => 'P2P_MISMATCH_SHIPMENT_HEADER_ID',
      p_sig_sql                => 'SELECT distinct rsh1.*
    ...
    AND   rsh.receipt_source_code <> decode (rsl.source_document_code,''RMA'',''CUSTOMER'',''PO'',''VENDOR'')',
      p_title                  => 'Corrupted Records with Mismatched shipment_header_id',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Corrupted records with mismatched shipment_header_id have been found.',
      p_solution               => 'For the datafix see [1198144/KB486431] - RCVTXERT APP-PO-14094 FRM-40212 Multiple Receipt For Intransit Shipment Gives Corrupted Shipment_Header_ID / Receipt Record Cannot be seen RCVRCVRC / Duplicate Shipment Number RCVTXERT.',
      p_success_msg            => 'No corrupted records with mismatched shipment_header_id found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_MISMATCH_SHIPMENT_HEADER_ID');



debug('begin add_signature: P2P_MATCHING_BASIS_AMOUNT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2573',
      p_sig_id                 => 'P2P_MATCHING_BASIS_AMOUNT',
      p_sig_sql                => 'SELECT PLL.PO_HEADER_ID,
    ...
    AND PLL.MATCHING_BASIS = ''AMOUNT''',
      p_title                  => 'Receipts/Return/Correction for Services',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Receipts/Return/Correction for services have been found.',
      p_solution               => '<ul>
      ...
      <li>See [399153/KB772516] - APP-PO-14094: Not Able To Enter Receipts / Returns / Corrections For Amount Based Line Types or Rate Based Temp Labor PO</li> 
   </ul>',
      p_success_msg            => 'No receipts/return/correction for services records found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_MATCHING_BASIS_AMOUNT');



debug('begin add_signature: P2P_PO_DESTINATION_ORG_ID_NULL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2584',
      p_sig_id                 => 'P2P_PO_DESTINATION_ORG_ID_NULL',
      p_sig_sql                => 'SELECT destination_organization_id 
    FROM po_distributions_all
    WHERE po_header_id = ##$$POID$$##
    AND destination_organization_id = ''''',
      p_title                  => 'Purchase Order destination_organization_id Is NULL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Purchase order destination_organization_id is NULL.',
      p_solution               => '<ul>
      <li> A datafix will be needed. Please log a Service request for support to review your data</li>
      <li> INTERNAL [1275159/KB336641] - Possible Causes For Pre-Approved POs With The Error POXDM-280: RVSRQ-125: RVSUT-080: ORA-01403</li> 
   </ul>',
      p_success_msg            => 'Purchase order destination_organization_id is not NULL.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_PO_DESTINATION_ORG_ID_NULL');



debug('begin add_signature: P2P_PO_SHIP_TO_ORGANIZATION_ID_NULL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2585',
      p_sig_id                 => 'P2P_PO_SHIP_TO_ORGANIZATION_ID_NULL',
      p_sig_sql                => 'SELECT ship_to_organization_id 
    FROM po_line_locations_all
    WHERE po_header_id = ##$$POID$$##
    AND ship_to_organization_id = ''''',
      p_title                  => 'Purchase Order ship_to_organization_id Is NULL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Purchase Order ship_to_organization_id is NULL.',
      p_solution               => '<ul>
      <li> A datafix will be needed. Please log a Service request for support to review your data</li>
      <li> INTERNAL [1275159/KB336641] - Possible Causes For Pre-Approved POs With The Error POXDM-280: RVSRQ-125: RVSUT-080: ORA-01403</li> 
   </ul>',
      p_success_msg            => 'Purchase order ship_to_organization_id is not NULL.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_PO_SHIP_TO_ORGANIZATION_ID_NULL');



debug('begin add_signature: P2P_PO_ITEM_NO_SHIP_TO_ORGANIZATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2586',
      p_sig_id                 => 'P2P_PO_ITEM_NO_SHIP_TO_ORGANIZATION',
      p_sig_sql                => 'SELECT pol.item_id
    FROM po_headers poh,
         po_lines pol,
    ...
    AND not exists (SELECT ''1'' 
      ...
      p_title                  => 'Purchase Order Item Is Not Assigned to ship_to_organization_id',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Purchase order item is not assigned to ship to org.',
      p_solution               => '<ul>
      <li> A datafix will be needed. Please log a Service request for support to review your data</li>
      <li> INTERNAL [1275159/KB336641] - Possible Causes For Pre-Approved POs With The Error POXDM-280: RVSRQ-125: RVSUT-080: ORA-01403</li> 
   </ul>',
      p_success_msg            => 'Purchase order item is assigned to ship_to_organization_id.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_PO_ITEM_NO_SHIP_TO_ORGANIZATION');



debug('begin add_signature: P2P_RCV_TRANSACTION_MGR_PROCESSES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2587',
      p_sig_id                 => 'P2P_RCV_TRANSACTION_MGR_PROCESSES',
      p_sig_sql                => 'SELECT fdg.data_group_name,
    ...
    AND FCP.CONCURRENT_PROCESSOR_NAME = ''RCVOLTM''',
      p_title                  => 'Number of Receiving Transaction Manager Processes Are Low',
      p_fail_condition         => '[max_processes] < [10]',
      p_problem_descr          => 'Number of receiving transaction manager processes are low.',
      p_solution               => '<ul>
      <li>There is no specific value to suggest for MAX_PROCESSES, rather the value must be calculated</li>  
      <li>It is suggested to set to a minimum of 10 for production or high fidelity environments, MAX_PROCESSES should be AT LEAST 3</li>
      <li>See [404336/KB559648] - How Many Processes Should Be Set For The Receiving Transaction Manager</li> 
   </ul>',
      p_success_msg            => 'Number of receiving transaction manager processes are acceptable.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_RCV_TRANSACTION_MGR_PROCESSES');



debug('begin add_signature: P2P_1_MISMATCH_AP_PO_DISTRIBUTION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2619',
      p_sig_id                 => 'P2P_1_MISMATCH_AP_PO_DISTRIBUTION',
      p_sig_sql                => 'SELECT /*+ ordered use_nl(ai2, aid2, pod2) */
            ai2.invoice_id,
            ai2.invoice_num,
            pod2.po_header_id,
     ...
     AND   EXISTS (
             ...
             HAVING ((round(nvl(apd.po_quantity,0),15) <>
                      ...
                      ((round(sum(nvl(apd.aid_quan,0)),15) >= 0 AND
                        round(sum(nvl(apd.aid_amt,0)),15) >= 0) OR
                       apd.process_flag <> ''N'')))',
      p_title                  => 'All Purchase Order Distributions That Have a Mismatch with Accounts Payable Distributions for Quantity/Amount Billed Quantity/Amount Financed and Quantity/Amount Recouped',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Purchase order distributions that have a mismatch with accounts payable distributions for quantity/amount billed quantity/amount financed and quantity/amount recouped.',
      p_solution               => 'Apply the GDF patch(s) following the instructions provided in [1543361/KB159901] - R12 Generic Data Fix (GDF) patch for Quantity Billed / Amount Billed Mismatch between Payables and Purchasing.',
      p_success_msg            => 'Purchase order distribution is in sync with accounts payable distribution.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_1_MISMATCH_AP_PO_DISTRIBUTION');



debug('begin add_signature: P2P_2_MISMATCH_PO_LOC_DISTRIBUTION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2620',
      p_sig_id                 => 'P2P_2_MISMATCH_PO_LOC_DISTRIBUTION',
      p_sig_sql                => 'SELECT /*+ ordered use_nl(pll, pod) */
            pll.po_header_id,
            pll.org_id,
            pll.line_location_id,
     ...
     HAVING  (nvl(pll.quantity_billed,0) <> sum(nvl(pod.quantity_billed,0)) OR
      ...
      p_title                  => 'Purchase Order Shipments With Incorrect Quantity or Amount values',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Identified purchase order shipments having mismatched quantity/amount with values on the distribution. This results in corruption in purchase order matched invoices. ',
      p_solution               => 'Apply the GDF patch following the instructions provided in [1322280/KB215717] - R12: Generic Data Fix (GDF) patch - Mismatch in Values Between PO_DISTRIBUTIONS_ALL and PO_LINE_LOCATIONS_ALL related to Invoice Matching.',
      p_success_msg            => 'Purchase order distribution is in sync with purchase order shipments.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_2_MISMATCH_PO_LOC_DISTRIBUTION');



debug('begin add_signature: P2P_3_UNMATCHED_PO_WITH_INVOICE_QTY_AMT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2621',
      p_sig_id                 => 'P2P_3_UNMATCHED_PO_WITH_INVOICE_QTY_AMT',
      p_sig_sql                => 'SELECT /*+ parallel(pod,8) */
            ''MAT1.1'' category,
            pod.po_header_id,
            pod.po_line_id,
            pod.line_location_id,
    ...
    AND NOT EXISTS (
     ...
     AND   (nvl(pod.quantity_recouped,0) <> 0 OR
      ...
      p_title                  => 'Unmatched Purchase Orders with Invoice Related Quantities and Amounts',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Unmatched purchase orders with invoice related quantities and amounts.',
      p_solution               => 'Apply the GDF patch following the instructions provided in [1543361/KB159901] - R12 Generic Data Fix (GDF) patch for Quantity Billed / Amount Billed Mismatch between Payables and Purchasing.',
      p_success_msg            => 'No unmatched purchase order with invoice related quantities or amounts exist.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_3_UNMATCHED_PO_WITH_INVOICE_QTY_AMT');



debug('begin add_signature: P2P_3_UNMATCHED_RECEIPT_WITH_INVOICE_QTY_AMT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2622',
      p_sig_id                 => 'P2P_3_UNMATCHED_RECEIPT_WITH_INVOICE_QTY_AMT',
      p_sig_sql                => 'SELECT /*+ parallel(rt,8) */
              ''MAT5'',
              rt.po_header_id,
              rt.po_line_id,
  ...
  AND NOT EXISTS (
      ...
      p_title                  => 'Unmatched Receipts with Invoice Related Quantities and Amounts',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Unmatched receipts with invoice related quantities and amounts.',
      p_solution               => 'Apply the GDF patch following the instructions provided in [1543361/KB159901] - R12 Generic Data Fix (GDF) patch for Quantity Billed / Amount Billed Mismatch between Payables and Purchasing.',
      p_success_msg            => 'No unmatched receipt with invoice related quantities or amounts exists.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_3_UNMATCHED_RECEIPT_WITH_INVOICE_QTY_AMT');



debug('begin add_signature: P2P_4_AP_NOT_NULL_QTY_INV_SEL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2623',
      p_sig_id                 => 'P2P_4_AP_NOT_NULL_QTY_INV_SEL',
      p_sig_sql                => 'SELECT ail.invoice_id,
            ail.org_id,
            ail.line_number,
            ail.historical_flag,
     ...
     AND   ail.invoice_id = invs.invoice_id',
      p_title                  => 'Canceled and Discarded Invoice Lines Where the Quantity Invoiced Has Not Been Set To 0',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Canceled and discarded invoice lines where the quantity invoiced has not been set to 0.',
      p_solution               => 'Apply the GDF patch following the instructions provided in [1543361/KB159901] - R12 Generic Data Fix (GDF) patch for Quantity Billed / Amount Billed Mismatch between Payables and Purchasing.',
      p_success_msg            => 'Canceled and discarded invoice lines having quantity invoiced set to 0.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_4_AP_NOT_NULL_QTY_INV_SEL');



debug('begin add_signature: P2P_APP_PO_14144');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2624',
      p_sig_id                 => 'P2P_APP_PO_14144',
      p_sig_sql                => 'SELECT line_location_id,shipment_num	
     ...
     WHERE ail.po_header_id=pol.po_header_id)',
      p_title                  => 'Invoice Matched to Planned Purchase Order Shipment Cannot Be Validated Because of Error APP-PO-14144',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The invoice(s) matched to above shipments can not be validated because of Error APP-PO-14144.',
      p_solution               => 'See [1579786/KB723650] - Cannot Validate Invoice Matched to Planned PO Shipment Error APP-PO-14144: PO_ACTIONS-065 and apply the solution.',
      p_success_msg            => 'No invoice matched to planned shipments for which shipment releases were not created exists.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_APP_PO_14144');



debug('begin add_signature: P2P_AP_SYNC_PO_QTY_AMT_SEL_RCV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2625',
      p_sig_id                 => 'P2P_AP_SYNC_PO_QTY_AMT_SEL_RCV',
      p_sig_sql                => 'SELECT /*+  ordered use_nl(aid, rcv) */	
            aid.invoice_id,	
     ...
     AND   EXISTS (	
      ...
      p_title                  => 'Receiving Distributions out of Synch with Accounts Payable Distributions for Quantity or Amount Billed',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Receiving distributions out of synch with accounts payable distributions for quantity or amount billed.',
      p_solution               => 'See [1543361/KB159901] - R12 Generic Data Fix (GDF) patch for Quantity Billed / Amount Billed Mismatch between Payables and Purchasing and apply the solution.',
      p_success_msg            => 'No receiving distributions out of synch with accounts payable distributions for quantity or amount billed exists.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_AP_SYNC_PO_QTY_AMT_SEL_RCV');



debug('begin add_signature: P2P_5_PO_FINALLY_CLOSED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2626',
      p_sig_id                 => 'P2P_5_PO_FINALLY_CLOSED',
      p_sig_sql                => 'SELECT ail.invoice_id,ail.org_id,ail.po_line_location_id,ail.po_line_id,ail.po_header_id
          FROM   ap_invoice_lines_all AIL,
    ...
    AND    PL.closed_code = ''FINALLY CLOSED''',
      p_title                  => 'Invoice Is Matched to a Finally Closed Purchase Order',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The above invoice(s) Can not be cancelled since invoice is matched to a finally closed purchase order.',
      p_solution               => 'You need to enter a Credit Memo with the same charge accounts that of invoice matched to Finally Closed Purchase Order and make a Zero payment selecting Credit memo and the invoice.
If the standard invoice is already paid enter a Credit memo with the same charge accounts that of invoice matched to Finally Closed Purchase Order and take a Refund of the Payment. 

Refer [1561331/KB775744#C7] - Troubleshooting and Technical Reference on Payables Invoice Cancellation and Discard related Issues and follow Section C7 of CheckList for cancellation',
      p_success_msg            => 'The invoice is not matched to the finally closed purchase order.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_5_PO_FINALLY_CLOSED');



debug('begin add_signature: P2P_6_PO_NEGATIVE_BILLED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2627',
      p_sig_id                 => 'P2P_6_PO_NEGATIVE_BILLED',
      p_sig_sql                => 'SELECT aiv.invoice_id,AIV.invoice_type_lookup_code,AID.po_distribution_id,count(*)	
   FROM ap_invoice_distributions_all AID,	
   ...
   HAVING (DECODE(AIV.invoice_type_lookup_code,''PREPAYMENT'',	
    ...
    GROUP BY aiv.invoice_id,AIV.invoice_type_lookup_code,AID.po_distribution_id',
      p_title                  => 'Invoice Cancelling Will Cause Negative Billing or Not in the Respective Purchase Order',
      p_fail_condition         => '[count(*)] > [0]',
      p_problem_descr          => 'The above invoice(s) can not be cancelled since it will cause quantity billed or amount billed to less than 0.',
      p_solution               => 'You need to find all the invoices matched to the same purchase order. If there exists the credit memo you need to cancel the credit memo first and then try to cancel the standard invoice.	
  
See [1561331/KB775744#C8] - Troubleshooting and Technical Reference on Payables Invoice Cancellation and Discard related Issues.',
      p_success_msg            => 'The invoice cancellation activity will not cause negative billing.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_6_PO_NEGATIVE_BILLED');



debug('begin add_signature: P2P_7_ENC_UNAPPROVED_PO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2628',
      p_sig_id                 => 'P2P_7_ENC_UNAPPROVED_PO',
      p_sig_sql                => 'select aid.invoice_id,aid.po_distribution_id	
          ...
          and    rownum = 1',
      p_title                  => 'Invoice Is Matched to an Unapproved Purchase Order Whereas the Encumbrance Is On',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The above invoice(s) can not be canceled since invoice is matched to an unapproved purchase order whereas the encumbrance is on.',
      p_solution               => '<p>You need to approve the purchase order and then try to cancel the invoice.</p>
<p>See [1561331/KB775744#C9] - Troubleshooting and Technical Reference on Payables Invoice Cancellation and Discard related Issues.</p>',
      p_success_msg            => 'The invoice is not matched to the unapproved purchase order while encumbrance is on and can be canceled.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_7_ENC_UNAPPROVED_PO');



debug('begin add_signature: P2P_AP_PO_PRICE_ADJ_FLG_SEL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2630',
      p_sig_id                 => 'P2P_AP_PO_PRICE_ADJ_FLG_SEL',
      p_sig_sql                => 'SELECT aid.invoice_id,
         ...
         AND   aid.invoice_id = invs.invoice_id',
      p_title                  => 'Invoice Distributions Linked to Purchase Order Distributions Which Are Flagged as Selected for Price Adjustment',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invoice distributions linked to purchase order distributions which are flagged as selected for price adjustment.',
      p_solution               => '<p>Generate the APLIST output for affected invoices and log a Service Request.</p>
<p>To generate the APLIST, see [148388/KB695404] Standalone APList - Payables Data Collection Test.</p>',
      p_success_msg            => 'No invoice distributions linked to purchase order distributions which are flagged as selected for price adjustment exists.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_AP_PO_PRICE_ADJ_FLG_SEL');



debug('begin add_signature: P2P_10_PO_MATCHING_REQUIRED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2629',
      p_sig_id                 => 'P2P_10_PO_MATCHING_REQUIRED',
      p_sig_sql                => 'SELECT api.invoice_id,''PO REQUIRED''	
  ...
  AND   api.org_id = pov.org_id AND   api.invoice_id = invs.invoice_id',
      p_title                  => 'Invoice Needs to Be Matched or Not',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The above invoice(s) can not be validated since it is not matched to purchase order receipt.',
      p_solution               => 'See [1472606/KB625541#aref_section29] - R12: Invoice HOLDS: Causes and Troubleshooting and follow the Hold Removal(Fix) for MATCHING REQUIRED.',
      p_success_msg            => 'The invoice should not have PO REQUIRED or MATCHING REQUIRED Hold.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_10_PO_MATCHING_REQUIRED');



debug('begin add_signature: P2P_RCV_SHPMT_MISS_SEL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2631',
      p_sig_id                 => 'P2P_RCV_SHPMT_MISS_SEL',
      p_sig_sql                => 'SELECT ada.invoice_id  ada_inv_id,
              ada.org_id,
       ...
       AND   ail.invoice_id = invs.invoice_id',
      p_title                  => 'Upgraded Invoices with Missing rcv_shipment_line_id Values on Invoice Lines',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Upgraded invoices with missing rcv_shipment_line_id values on invoice lines.',
      p_solution               => '<p>Generate the APLIST output for affected invoices and log a Service Request.</p>
<p>To generate the APLIST, see [148388/KB695404] Standalone APList - Payables Data Collection Test.</p>',
      p_success_msg            => 'No upgraded invoices with missing rcv_shipment_line_id values on invoice lines exists.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_RCV_SHPMT_MISS_SEL');



debug('begin add_signature: P2P_AP_NULL_UNITPRICE_SEL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2632',
      p_sig_id                 => 'P2P_AP_NULL_UNITPRICE_SEL',
      p_sig_sql                => 'SELECT aid.invoice_id,
      ...
      p_title                  => 'Invoices Having Unit Price Null on Distributions Though It Exists on the Lines Which Can Result in Incorrect Invoice Price Variance (IPV)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invoices having unit price null on distributions though it exists on the lines which can result in incorrect invoice price variance (IPV).',
      p_solution               => '<p>Generate the APLIST output for affected invoices and log a Service Request.</p>
<p>To generate the APLIST, see [148388/KB695404] Standalone APList - Payables Data Collection Test.</p>',
      p_success_msg            => 'No invoices having unit price null on distributions though it exists on the lines which can result in incorrect invoice price variance (IPV) exists.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_AP_NULL_UNITPRICE_SEL');



debug('begin add_signature: P2P_AP_RCPT_NUM_CORR_INV_SEL');
   l_info('##MASK##INVOICE_NUM'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2633',
      p_sig_id                 => 'P2P_AP_RCPT_NUM_CORR_INV_SEL',
      p_sig_sql                => 'SELECT ai.invoice_id,
       ...
       AND   ail.rcv_shipment_line_id is null
       AND   ail.rcv_transaction_id is not null',
      p_title                  => 'Receipt Number Does Not Show up on Correction Lines of Invoices Correcting Price Quantity or Amount',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Receipt number does not show up on correction lines of invoices correcting price quantity or amount.',
      p_solution               => 'Apply the root cause fix from {15946088} if you have not done so and log a Service Request to obtain the data fix.',
      p_success_msg            => 'Receipt number shows up on correction lines of invoices correcting price quantity or amount.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_AP_RCPT_NUM_CORR_INV_SEL');



debug('begin add_signature: P2P_AP_QUICK_PO_UPDATE_SEL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2634',
      p_sig_id                 => 'P2P_AP_QUICK_PO_UPDATE_SEL',
      p_sig_sql                => 'SELECT /*+ leading(invs) */
              ai.invoice_id,
              ai.org_id,
              ai.invoice_amount,
      ...
      p_title                  => 'Invoices Which Have Been Matched to a Purchase Order Are Not Showing the Purchase Order Number in Purchase Order Number Field Due to Missing Value for Quick_po_header_id',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invoices which have been matched to a purchase order are not showing the purchase order number in the purchase order number field due to missing value for quick_po_header_id.',
      p_solution               => 'Apply the root cause fix from {9508416} if you have not done so and log a Service Request to obtain the data fix.',
      p_success_msg            => 'No invoices which have been matched to a purchase order are not showing the purchase order Number in purchase order number field exists.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_AP_QUICK_PO_UPDATE_SEL');



debug('begin add_signature: P2P_QUICK_MATCH_QTY_RND_SEL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2635',
      p_sig_id                 => 'P2P_QUICK_MATCH_QTY_RND_SEL',
      p_sig_sql                => 'SELECT ai.invoice_id,
              ai.invoice_amount,
              ai.invoice_num,
              ai.vendor_id,
       ...
       AND   EXISTS (
               ...
               AND   decode(instr(pod.quantity_billed, ''.'', 1, 1),
                       ...
                       length(substr(pod.quantity_billed,
                        ...
                        > fnc.precision)',
      p_title                  => 'Quick Matched Invoices Populated with Multiple Precision on Invoice Lines and Distributions Causing Hold with Reason Quantity Billed Is More than Quantity Accepted',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Quick matched invoices populated with multiple precision on invoice lines and distributions causing hold with reason quantity billed is more than quantity accepted.',
      p_solution               => 'Apply the root cause fix from {8973086} if you have not done so, and log a Service Request to obtain the data fix.',
      p_success_msg            => 'No invoices populated with multiple precision on invoice lines and distributions causing hold with reason quantity billed is more than quantity accepted exists.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_QUICK_MATCH_QTY_RND_SEL');



debug('begin add_signature: P2P_AP_SYNC_PO_RELEASE_ID_SEL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2636',
      p_sig_id                 => 'P2P_AP_SYNC_PO_RELEASE_ID_SEL',
      p_sig_sql                => 'SELECT
              ai.invoice_id,
              ai.invoice_num,
              ai.org_id,
       ...
       AND   ail.po_release_id is null
       AND   ai.invoice_id = invs.invoice_id',
      p_title                  => 'Invoice Lines Matched to Blanket or Planned Purchase Order with Missing Po_release_id Causing APP-PO-14144 When Trying to Cancel or Validate the Invoice',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invoice lines matched to blanket or planned purchase order with missing PO_RELEASE_ID causing APP-PO-14144 when trying to cancel or validate the invoice.',
      p_solution               => 'Apply the GDF patch following the instructions provided in [1094274/KB519941] - R12 Generic Data Fix (GDF) Patch for Bug 9231247 - Error APP-PO-14144: PO_ACTIONS-065 On Validating Payables Invoice Matched to Blanket or Planned PO.',
      p_success_msg            => 'No invoice lines matched to blanket or planned purchase order with missing PO_RELEASE_ID causing APP-PO-14144 when trying to cancel or validate the invoice exists.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_AP_SYNC_PO_RELEASE_ID_SEL');



debug('begin add_signature: P2P_AP_ONE_OFF_SCRIPTS_SEL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2637',
      p_sig_id                 => 'P2P_AP_ONE_OFF_SCRIPTS_SEL',
      p_sig_sql                => 'SELECT /*+ ordered */
              ''MAT2'' Category,
              aid.invoice_id,
              aid.org_id,
              aid.invoice_line_number,
      ...
      AND   ail.invoice_id = invs.invoice_id
       ...
       AND   ail.invoice_id = invs.invoice_id',
      p_title                  => 'Various Invoice Matching Related Issues',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Various invoice matching related issues. See problem description for each row and see [1489862/KB611407] - R12 Generic Data Fix (GDF) Patch for COMMON INVOICE ISSUES for description of all issues covered.',
      p_solution               => 'Apply the GDF patch following the instructions provided in [1543361/KB159901] - R12 Generic Data Fix (GDF) patch for Quantity Billed / Amount Billed Mismatch between Payables and Purchasing.',
      p_success_msg            => 'No matching related issues found mentioned in [1489862/KB611407] - R12 Generic Data Fix (GDF) Patch for COMMON INVOICE ISSUES.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_AP_ONE_OFF_SCRIPTS_SEL');



debug('begin add_signature: P2P_AP_SYNC_MATCH_TYPE_SEL');
   l_info('##MASK##INVOICE_NUM'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3477',
      p_sig_id                 => 'P2P_AP_SYNC_MATCH_TYPE_SEL',
      p_sig_sql                => 'SELECT ai.invoice_id,
            ai.invoice_num,
            ai.invoice_date,
            pll.match_option,
     ...
     AND   ail.po_line_id is null
     AND   ail.po_line_location_id is null',
      p_title                  => 'Match Type And Dist Type Not In Sync',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The values of match_type and dist_match_type are not in sync between invoice lines and distributions.  This results in issues with quantities and amounts billed which can cause issues when matching or cancelling the invoice.',
      p_solution               => 'See [1906407/KB318210] R12: Generic DataFix (GDF) Patch to Synchronize Match_Type At Invoice Lines and Distributions Level.',
      p_success_msg            => 'The values of match_type and dist_match_type are in sync between invoice lines and distributions.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_AP_SYNC_MATCH_TYPE_SEL');



debug('begin add_signature: EBS_FIN_AP_INV_INVALID_PO_NUM_INV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23902',
      p_sig_id                 => 'EBS_FIN_AP_INV_INVALID_PO_NUM_INV',
      p_sig_sql                => 'SELECT HEAD.po_header_id, LINE.po_line_id, SHIP.line_location_id, DIST.po_distribution_id, DIST.distribution_num DIST_NO, SHIP.matching_basis, DIST.amount_ordered, aid.invoice_id
FROM po_headers_all HEAD, po_lines_all LINE, po_line_locations_all SHIP, po_distributions_all DIST, ap_invoice_distributions_all aid
WHERE HEAD.po_header_id = LINE.po_header_id
AND LINE.po_line_id = SHIP.po_line_id
AND SHIP.line_location_id = DIST.line_location_id
AND SHIP.matching_basis = ''AMOUNT''
AND DIST.amount_ordered IS NULL
and dist.po_distribution_id=aid.po_distribution_id
and aid.invoice_id in (##$$INVS$$##)',
      p_title                  => 'Shipment Distribution has Null AMOUNT_ORDERED Using Amount Type Matching',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invoice matched to PO with a shipment that is set up for Amount type matching and one of the distributions associated with the shipment has a NULL value for Amount_Ordered.',
      p_solution               => 'Log an SR with Oracle Purchasing Support as detailed in [2524936/KB735352].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_INV_INVALID_PO_NUM_INV');



debug('begin add_signature: P2P_AP_PAYMENT_METHOD_NULL_SEL');
   l_info('##MASK##CHECK_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##VENDOR_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2653',
      p_sig_id                 => 'P2P_AP_PAYMENT_METHOD_NULL_SEL',
     ...
     AND   ac.check_id in (chks.check_id)',
      p_title                  => 'NULL Payment_method_code in Ap_checks_all Resulting out of Sync with IBY (Results in FRM-40735 Errors)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'NULL payment_method_code in ap_checks_all and thus out of sync with IBY (results in FRM-40735 errors).',
      p_solution               => 'See [985615/KB528936] - R12 Generic Data Fix (GDF) Patch for Null Payment Method Code Causes FRM-40735 and apply the solution.',
      p_success_msg            => 'There is no record having NULL payment_method_code in ap_checks_all.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_AP_PAYMENT_METHOD_NULL_SEL');



debug('begin add_signature: P2P_AP_RATE_MISS_SEL');
   l_info('##MASK##CHECK_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##VENDOR_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2654',
      p_sig_id                 => 'P2P_AP_RATE_MISS_SEL',
      p_sig_sql                => 'SELECT ac.check_id,
            ac.check_number,
            ac.vendor_name,
            ac.check_date,
     ...
     AND   /* pmt created exchange rate */
           ((ph.transaction_type in (''PAYMENT CREATED'', ''REFUND RECORDED'',
             ...
             ph.pmt_to_base_xrate is null and ((coalesce(ph.posted_flag,''N'') <> ''Y''
                        and (decode(ph.pmt_to_base_xrate_type, ''User'', null
                                       , ph.pmt_to_base_xrate_type) is null 
                                or ph.pmt_to_base_xrate_date is null OR
               EXISTS (
     ...
     AND   ac.check_id in (chks.check_id)',
      p_title                  => 'Foreign Currency Checks That Are Missing Exchange Rates Maturity Exchange Rates or Clearing Exchange Rates',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Foreign currency checks that are missing exchange rates maturity exchange rates or clearing exchange rates.',
      p_solution               => 'See [1125533/KB627007] - R12 Generic Data Fix (GDF) Patch for Missing Exchange Rates and apply the solution.',
      p_success_msg            => 'No foreign currency check that are missing exchange rates maturity exchange rates or clearing exchange rates exists.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_AP_RATE_MISS_SEL');



debug('begin add_signature: P2P_AP_WRGCHKSTS_SEL');
   l_info('##MASK##CHECK_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2655',
      p_sig_id                 => 'P2P_AP_WRGCHKSTS_SEL',
      p_sig_sql                => 'SELECT /*+ leading(chks) */
            ac.check_id,
            ac.check_number,
            ac.org_id,
            ac.check_date,
     ...
     FROM (
          ...
          ap_checks_all ac
     WHERE ac.check_id in (chks.check_id)
     ...
     AND   NOT EXISTS (
      ...
      p_title                  => 'Incorrect Check Statuses When Payables Accounting Option Account for Payment When Payment Clears Is Disabled. Payments Are Accounted but Appear as Unreconciled',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Incorrect check statuses when payables accounting option account for payment when payment clears is disabled. Payments are accounted but appear as unreconciled.',
      p_solution               => '<p>You need to enter a credit memo with the same charge accounts that of invoice matched to finally closed PO and make a zero payment selecting credit memo and the invoice.</p>
<p>If the standard invoice is already paid enter a credit memo with the same charge accounts that of invoice matched to finally closed PO and take a refund of the payment. </p>
See [1154813/KB716355] - R12 Generic Data Fix (GDF) Patch Accounted Payments Still Appearing As Unreconciled and apply the solution.',
      p_success_msg            => 'Correct check statuses exist.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_AP_WRGCHKSTS_SEL');



debug('begin add_signature: P2P_AP_NEGOTIABLE_IBY_VOID_SEL');
  ...
  add_signature(
      p_sig_repo_id            => '2656',
      p_sig_id                 => 'P2P_AP_NEGOTIABLE_IBY_VOID_SEL',
      p_sig_sql                => 'SELECT ac.check_id,
            ac.check_number,
            ac.org_id,
            ac.vendor_name,
     ...
     AND   ac.check_id in (chks.check_id)',
      p_title                  => 'Checks Voided in Payments but Still Negotiable in Payables',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Checks voided in payments but still negotiable in payables.',
      p_solution               => 'See [1206075/KB361783] - R12 Generic Data Fix (GDF) Patch for CHECK VOIDED IN PAYMENTS BUT NEGOTIABLE IN PAYABLES and apply the solution.',
      p_success_msg            => 'Checks voided successfully.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_AP_NEGOTIABLE_IBY_VOID_SEL');



debug('begin add_signature: P2P_AP_CHECKS_MISC_SEL_CHECK_1');
   l_info('##MASK##CHECK_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2657',
      p_sig_id                 => 'P2P_AP_CHECKS_MISC_SEL_CHECK_1',
      p_sig_sql                => 'SELECT ac.check_id,
            ac.check_number,
            ac.org_id,
            ac.currency_code,
     ...
     AND   (aph.pmt_to_base_xrate is not null OR
            ac.exchange_rate is not null OR ac.exchange_rate_type is not null)
     AND   ac.check_id in (chks.check_id)',
      p_title                  => 'Checks in Functional Currency with Exchange Rate Information Populated in ap_checks_all or ap_payment_history_all',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Checks in functional currency with exchange rate information populated in ap_checks_all or ap_payment_history_all.',
      p_solution               => 'See [1264221/KB159306] - R12 Generic Data Fix (GDF) patch for LOW-IMPACT/INFREQUENT FIXES ON CHECKS and apply the solution.',
      p_success_msg            => 'Functional currency checks having no exchange rate populated.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_AP_CHECKS_MISC_SEL_CHECK_1');



debug('begin add_signature: P2P_AP_CHECKS_MISC_SEL_CHECK_2');
   l_info('##MASK##CHECK_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2658',
      p_sig_id                 => 'P2P_AP_CHECKS_MISC_SEL_CHECK_2',
      p_sig_sql                => 'SELECT ac.check_id,
            ac.check_number,
            ac.org_id,
            ac.status_lookup_code,
     ...
     AND   ac.check_id in (chks.check_id)',
      p_title                  => 'Voided Checks with Incorrect Statuses in ap_checks_all',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Voided checks with incorrect statuses in ap_checks_all.',
      p_solution               => 'See [1264221/KB159306] - R12 Generic Data Fix (GDF) patch for LOW-IMPACT/INFREQUENT FIXES ON CHECKS and apply the solution.',
      p_success_msg            => 'Voided checks with correct statuses in ap_checks_all.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_AP_CHECKS_MISC_SEL_CHECK_2');



debug('begin add_signature: P2P_AP_CHECKS_MISC_SEL_CHECK_3');
   l_info('##MASK##CHECK_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2659',
      p_sig_id                 => 'P2P_AP_CHECKS_MISC_SEL_CHECK_3',
      p_sig_sql                => 'SELECT ac.check_id,
            ac.check_number,
            ac.org_id,
            ac.status_lookup_code,
     ...
     AND   ac.check_id in (chks.check_id)',
      p_title                  => 'Refund Checks with Maturity Rate Information Populated',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Refund checks with maturity rate information populated.',
      p_solution               => 'See [1264221/KB159306] - R12 Generic Data Fix (GDF) patch for LOW-IMPACT/INFREQUENT FIXES ON CHECKS and apply the solution.',
      p_success_msg            => 'Refund checks without maturity rate information.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_AP_CHECKS_MISC_SEL_CHECK_3');



debug('begin add_signature: P2P_AP_CHECK_STAT_INCORRECT_SEL');
   l_info('##MASK##CHECK_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##VENDOR_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2660',
      p_sig_id                 => 'P2P_AP_CHECK_STAT_INCORRECT_SEL',
      p_sig_sql                => 'SELECT ac.check_id,
            ac.check_number,
            ac.org_id,
            ac.check_date,
     ...
     AND   ac.check_id in (chks.check_id)',
      p_title                  => 'Checks Which Have Been Reconciled but Which Have a Status of Negotiable in ap_checks_all',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Checks which have been reconciled but which have a status of NEGOTIABLE in ap_checks_all.',
      p_solution               => 'See [1315138/KB750731] - R12: Generic Data Fix (GDF) Patch for INCORRECT CHECK STATUS AS "NEGOTIABLE" THOUGH PAYMENT HAS BEEN CLEARED and apply the solution.',
      p_success_msg            => 'Checks successfully reconciled.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_AP_CHECK_STAT_INCORRECT_SEL');



debug('begin add_signature: P2P_AP_MISSING_MAT_EVENT_SEL');
   l_info('##MASK##CHECK_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2661',
      p_sig_id                 => 'P2P_AP_MISSING_MAT_EVENT_SEL',
      p_sig_sql                => 'SELECT ac.check_id ,
            ac.check_number,
            ac.org_id,
            ac.status_lookup_code,
     ...
     AND   ac.check_id in (chks.check_id)',
      p_title                  => 'Checks with Bills Payable but Missing Payment Maturity Event',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Checks with bills payable but missing payment maturity event.',
      p_solution               => 'See [1309501/KB157043] - R12: Enhance GDF 10334634 patches to address issues when maturity event is missing for Bills Payables whose status Not Equal to ''ISSUED'' and FUTURE_PAY_DUE_DATE is not null and apply the solution.',
      p_success_msg            => 'Checks with bills payable having payment maturity event.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_AP_MISSING_MAT_EVENT_SEL');



debug('begin add_signature: PLSQL_FILE_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1232',
      p_sig_id                 => 'PLSQL_FILE_VERSIONS',
...
order by 1, 3 desc, 5 desc',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Package versions.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PLSQL_FILE_VERSIONS');



debug('begin add_signature: OTHER_FILE_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1233',
      p_sig_id                 => 'OTHER_FILE_VERSIONS',
      p_sig_sql                => 'select distinct af.filename,
...
order by af.filename',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Could not find other file versions.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OTHER_FILE_VERSIONS');



debug('begin add_signature: P2P_FILE_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2662',
      p_sig_id                 => 'P2P_FILE_VERSIONS',
      ...
      p_limit_rows             => nvl('N','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('PLSQL_FILE_VERSIONS','OTHER_FILE_VERSIONS'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '9'
      );
   l_info.delete;
debug('end add_signature: P2P_FILE_VERSIONS');



debug('begin add_signature: P2P_PRODUCT_PROFILE_VALUES');
   l_info('##MASK##LEVEL_VALUE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2936',
      p_sig_id                 => 'P2P_PRODUCT_PROFILE_VALUES',
      p_sig_sql                => 'SELECT user_profile_option_name "Profile Option",
             a.profile_option_value "Profile Value",
             DECODE(a.level_id, 10001, ''Site'',
                                10002, ''Application'',
   ...
   l_info.delete;
debug('end add_signature: P2P_PRODUCT_PROFILE_VALUES');



debug('begin add_signature: P2P_PROFILE_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2663',
      p_sig_id                 => 'P2P_PROFILE_OPTIONS',
      p_sig_sql                => 'SELECT tl.Application_name, b.application_short_name,
            b.application_id "##$$FK1$$##",
            b.product_code "##$$FK2$$##"
       FROM fnd_application_tl tl, fnd_application b
      ...
      p_limit_rows             => nvl('N','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('P2P_PRODUCT_PROFILE_VALUES'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '5'
      );
   l_info.delete;
debug('end add_signature: P2P_PROFILE_OPTIONS');



debug('begin add_signature: APPLICATION_INSTALL_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1258',
      p_sig_id                 => 'APPLICATION_INSTALL_DETAILS',
...
order by 3, 1',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Application Install Details not found',
      p_solution               => 'Verify whether you have purchased a license for applications that are currently set to Shared installed or Not installed.  After verifying through your Oracle Sales Representative that you have purchased a license for an application, you may use license manager to change applications from Shared or Not installed to Installed.',
      p_success_msg            => 'Application Install statuses

Verify whether you have purchased a license for applications that are currently set to Shared installed or Not installed.  After verifying through your Oracle Sales Representative that you have purchased a license for an application, you may use license manager to change applications from Shared or Not installed to Installed.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: APPLICATION_INSTALL_DETAILS');



debug('begin add_signature: P2P_DATABASE_TRIGGERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2664',
      p_sig_id                 => 'P2P_DATABASE_TRIGGERS',
    ...
    ORDER BY atrg.table_owner, atrg.table_name, atrg.trigger_type',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Database triggers.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: P2P_DATABASE_TRIGGERS');
...
debug('begin add_signature: P2P_TABLE_INDEXES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2665',
      p_sig_id                 => 'P2P_TABLE_INDEXES',
    ...
    ORDER BY iu.name, io.name, o.name',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Table Indexes',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: P2P_TABLE_INDEXES');
...
debug('begin add_signature: ALL_TRAILING_SPACES');
   l_info('##COMPLEX_TYPE##'):= 'U';
 IF (substr(g_sql_tokens('##$$REL$$##'),1,4) = '12.0') OR (substr(g_sql_tokens('##$$REL$$##'),1,4) = '12.1') THEN
  ...
  add_signature(
   ...
   'SELECT ''Expand subsections below to see the trailing space data corruption.'' "Trailing Space Data Corruption"
	...
	'Review [1203796/KB626046] - How To Troubleshoot FRM-40654 Errors On Purchasing Documents?',
        'Review data for details related to the Procure to Pay Flow.',
	'ALWAYS',
	'I',
        'RS',
  ...
  -------------------------------------------  
   ...
   '2884',
     ...
     'Trailing Spaces in Table PO_HEADERS_ALL',
     'RS',
     'Column(s) in table PO_HEADERS_ALL have trailing spaces.',
      'Review [1203796/KB626046] - How To Troubleshoot FRM-40654 Errors On Purchasing Documents?',
     NULL,
     'FAILURE',
     'E',
  ...
  ----------------------------------------   
   ...
   '2884',
     ...
     'Trailing Spaces in Table PO_LINES_ALL',
     'RS',
     'Column(s) in table PO_LINES_ALL have trailing spaces.',
      'Review [1203796/KB626046] - How To Troubleshoot FRM-40654 Errors On Purchasing Documents?',
     NULL,
     'FAILURE',
     'E',
  ...
  -------------------------------------------------     
   ...
   '2884',
     ...
     'Trailing Spaces in Table PO_LINE_LOCATIONS_ALL',
     'RS',
     'Column(s) in table PO_LINE_LOCATIONS_ALL have trailing spaces.',
      'Review [1203796/KB626046] - How To Troubleshoot FRM-40654 Errors On Purchasing Documents?',
     NULL,
     'FAILURE',
     'E',
  ...
  -------------------------------------------------    
   ...
   '2884',
     ...
     'Trailing Spaces in Table PO_DISTRIBUTIONS_ALL',
     'RS',
     'Column(s) in table PO_DISTRIBUTIONS_ALL have trailing spaces',
      'Review [1203796/KB626046] - How To Troubleshoot FRM-40654 Errors On Purchasing Documents?',
     NULL,
     'FAILURE',
     'E',
  ...
  -------------------------------------------------------   
   ...
   '2884',
     ...
     'Trailing Spaces in Table PO_REQUISITION_HEADERS_ALL',
     'RS',
     'Column(s) in table PO_REQUISITION_HEADERS_ALL have trailing spaces.',
      'Review [1203796/KB626046] - How To Troubleshoot FRM-40654 Errors On Purchasing Documents?',
     NULL,
     'FAILURE',
     'E',
  ...
  -------------------------------------------------------   
   ...
   '2884',
     ...
     'RS',
     'Column(s) in table PO_REQUISITION_LINES_ALL have trailing spaces.',
      'Review [1203796/KB626046] - How To Troubleshoot FRM-40654 Errors On Purchasing Documents?',
     NULL,
     'FAILURE',
     'E',
  ...
  -------------------------------------------------------      
   ...
   '2884',
     ...
     'RS',
     'Column(s) in table PO_REQ_DISTRIBUTIONS_ALL have trailing spaces.',
      'Review [1203796/KB626046] - How To Troubleshoot FRM-40654 Errors On Purchasing Documents?',
     NULL,
     'FAILURE',
     'E',
    ...
    END IF;
   l_info.delete;
debug('end add_signature: ALL_TRAILING_SPACES');



debug('begin add_signature: REL- PO_RELEASES_ALL');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##%FIRST_NAME%'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##%LAST_NAME%'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##%NOTE_TO%'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##%USER%'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11628',
      p_sig_id                 => 'REL- PO_RELEASES_ALL',
      p_sig_sql                => 'SELECT prl.org_id, poh.segment1,prl.release_num, prl.*
FROM po_releases_all prl,po_headers_all poh
WHERE prl.po_header_id=poh.po_header_id
AND prl.po_release_id = ##$$RELID$$##',
      p_title                  => 'PO_RELEASES_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of PO_RELEASES_ALL Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of PO_RELEASES_ALL Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: REL- PO_RELEASES_ALL');



debug('begin add_signature: REL- PO_LINE_LOCATIONS_ALL');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##%FIRST_NAME%'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##%LAST_NAME%'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##%NOTE_TO%'):= 'DISPLAY_FIRST_25_PCNT';
  ...
  add_signature(
      p_sig_repo_id            => '11633',
      p_sig_id                 => 'REL- PO_LINE_LOCATIONS_ALL',
      p_sig_sql                => 'select poll.org_id,poh.segment1,prl.release_num, pol.line_num, poll.shipment_num, poll.* 
from po_line_locations_all poll, po_lines_all pol, po_releases_all prl,po_headers_all poh
where poll.po_line_id=pol.po_line_id
and poll.po_release_id=prl.po_release_id
and poh.po_header_id=poll.PO_HEADER_ID
and poll.po_release_id=##$$RELID$$##
and poll.line_location_id like NVL(''##$$LINEID$$##'',''%'')
order by poll.shipment_num',
      p_title                  => 'PO_LINE_LOCATIONS_ALL - For Release',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of PO_LINE_LOCATIONS_ALL Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of PO_LINE_LOCATIONS_ALL Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: REL- PO_LINE_LOCATIONS_ALL');



debug('begin add_signature: P2P_CREATEPO_ATTRIBUTES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2553',
      p_sig_id                 => 'P2P_CREATEPO_ATTRIBUTES',
      p_sig_sql                => 'SELECT              rtrim(w.name) name, 
                  ...
                  and item_type = ''CREATEPO''',
      p_title                  => 'CREATEPO Attributes Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'CREATEPO Attributes not all set to yes.',
      p_solution               => '<ul>
...
See [460003/KB273172] and [830933/KB269563] for further details.',
      p_success_msg            => 'All CREATEPO attributes have been defined.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_CREATEPO_ATTRIBUTES');



debug('begin add_signature: P2P_CREATEPO_ATTRIBUTES_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2552',
      p_sig_id                 => 'P2P_CREATEPO_ATTRIBUTES_CHECK',
      p_sig_sql                => 'SELECT  count (*) "NO_OF_ATTRIBUTES_SET_TO_YES"
    FROM (        select rtrim(w.name) name, 
                        w.text_default Value, 
                        rtrim(w.item_type) item_type, 
                        ''Should Workflow Create The Release?'' Attribute
                  from   wf_item_attributes w
                  ...
                  and item_type = ''CREATEPO''
                  and w.text_default = ''Y'')',
      p_title                  => 'CREATEPO Attributes Check',
      p_fail_condition         => '[NO_OF_ATTRIBUTES_SET_TO_YES] < [3]',
      p_problem_descr          => 'CREATEPO attributes not all set to yes.',
      p_solution               => '<ul>
<li>See [404424/KB161449]- How To Check How Relevant Workflow Attributes For Create Documents (CREATEPO) Workflow Are Set?</li>
<li>For in depth settings, run the Procurement Autocreate analyzer from [2101058/KB550631] and review the CREATEPO.sql tile</li>
</ul>',
      p_success_msg            => 'Currently your setup will allow for automatic purchase order creation/approval as all CREATEPO attributes have been enabled and the autocreate workflow is setup for purchase order create documents',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('P2P_CREATEPO_ATTRIBUTES'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '15'
      );
   l_info.delete;
debug('end add_signature: P2P_CREATEPO_ATTRIBUTES_CHECK');



debug('begin add_signature: P2P_RECEIPT_DETAILS_REL_12_1');
   l_info('##MASK##RECEIPT_LOCATION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2566',
      p_sig_id                 => 'P2P_RECEIPT_DETAILS_REL_12_1',
      p_sig_sql                => 'SELECT *
      ...
      p_title                  => 'Receipt Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No receipt details found.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: P2P_RECEIPT_DETAILS_REL_12_1');



debug('begin add_signature: P2P_ENCUMBRANCE_AFTER_PO_APPROVAL_REL');
   l_info('##MASK##NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2581',
      p_sig_id                 => 'P2P_ENCUMBRANCE_AFTER_PO_APPROVAL_REL',
      p_sig_sql                => 'SELECT HOU.name,
  ...
  -- WHERE POH.TYPE_LOOKUP_CODE = ''STANDARD''  -- Comment if for a Release
   ...
   ORDER BY POH.ORG_ID, POH.PO_HEADER_ID, POL.PO_LINE_ID, PLL.LINE_LOCATION_ID, POD.PO_DISTRIBUTION_ID',
      p_title                  => 'Encumbrance Enabled after Purchase Order Approval - Release',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Encumbrance enabled after purchase order approval - release.',
      p_solution               => 'This issue can occur when:
    ...
    See [958816/KB593792] - Receiving Forms (RCVTXERT RCVTXECO RCVTXERE) Return APP-PO-14094: No Record Meet Your Search Criteria',
      p_success_msg            => 'Encumbrance was not enabled after purchase order approval.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_ENCUMBRANCE_AFTER_PO_APPROVAL_REL');



debug('begin add_signature: P2P_PO_RCV_FORM_REL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2583',
      p_sig_id                 => 'P2P_PO_RCV_FORM_REL',
      p_sig_sql                => 'SELECT ph.segment1 PO_NUMBER, 
           ph.type_lookup_code, 
           pr.release_num, 
           pr.po_release_id, 
           pl.line_num, 
    ...
    AND nvl(pll.closed_code,''N'') = ''FINALLY CLOSED''',
      p_title                  => 'Purchase Order Cannot Be Retrieved in Receiving Form',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Purchase order shipment in status affecting receiving.',
      p_solution               => '<ul>
      ...
      <li> See [551232/KB754685] - Find PO - PO Status Affects Receiving Transactions (Receive, Deliver, Correct, Return, ASN) Error: APP-PO-14094 / FRM-40212 </li> 
   </ul>',
      p_success_msg            => 'Purchase order can be retrieved in receiving form.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: P2P_PO_RCV_FORM_REL');



debug('begin add_signature: P2P_RECEIPT_DETAILS_REL_12_2');
   l_info('##MASK##RECEIPT_LOCATION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2554',
      p_sig_id                 => 'P2P_RECEIPT_DETAILS_REL_12_2',
      p_sig_sql                => 'SELECT *
      FROM   (SELECT rsh.receipt_num,
...
/*              rsl.comments                                  shipment_receiver_notes,*/
   ...
   l_info.delete;
debug('end add_signature: P2P_RECEIPT_DETAILS_REL_12_2');



debug('begin add_signature: P2P_RECEIPT_DETAILS_STD_12_1');
   l_info('##MASK##RECEIPT_LOCATION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2570',
      p_sig_id                 => 'P2P_RECEIPT_DETAILS_STD_12_1',
      p_sig_sql                => 'SELECT *
    FROM   (SELECT  rsh.receipt_num,
                    rsl.shipment_header_id,
                    rsl.shipment_line_id,
   ...
   l_info.delete;
debug('end add_signature: P2P_RECEIPT_DETAILS_STD_12_1');



debug('begin add_signature: P2P_ENCUMBRANCE_AFTER_PO_APPROVAL_STD');
   l_info('##MASK##NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2578',
      p_sig_id                 => 'P2P_ENCUMBRANCE_AFTER_PO_APPROVAL_STD',
      p_sig_sql                => 'SELECT HOU.name,
          FSP.PURCH_ENCUMBRANCE_FLAG,
          POH.SEGMENT1,
          POH.PO_HEADER_ID,
   ...
   AND PLL.ENCUMBERED_FLAG = ''N''
   ORDER BY POH.ORG_ID, POH.PO_HEADER_ID, POL.PO_LINE_ID, PLL.LINE_LOCATION_ID, POD.PO_DISTRIBUTION_ID',
      p_title                  => 'Encumbrance Enabled After Purchase Order Approval - Standard Purchase Order',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Encumbrance enabled after purchase order approval.',
      p_solution               => 'This issue can occur when:
        <ol><li>Deliver a Purchase Order in Receiving Transactions form (RCVTXERT)</li>
            <li>Correct a Receiving Transaction using the Receiving Corrections form (RCVTXECO)</li>
            <li>Return an item in the Receiving Returns form (RCVTXERE)</li></ol>
   ...
   l_info.delete;
debug('end add_signature: P2P_ENCUMBRANCE_AFTER_PO_APPROVAL_STD');



debug('begin add_signature: P2P_PO_RCV_FORM_STD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2582',
      p_sig_id                 => 'P2P_PO_RCV_FORM_STD',
      p_sig_sql                => 'SELECT ph.segment1 PO_NUMBER, 
  ...
  AND nvl(pll.closed_code,''N'') = ''FINALLY CLOSED''',
   ...
   l_info.delete;
debug('end add_signature: P2P_PO_RCV_FORM_STD');



debug('begin add_signature: P2P_RECEIPT_DETAILS_STD_12_2');
   l_info('##MASK##RECEIPT_LOCATION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2569',
      p_sig_id                 => 'P2P_RECEIPT_DETAILS_STD_12_2',
      p_sig_sql                => 'SELECT *
    FROM   (SELECT rsh.receipt_num,
                      rsl.shipment_header_id,
                      rsl.shipment_line_id,
   ...
   l_info.delete;
debug('end add_signature: P2P_RECEIPT_DETAILS_STD_12_2');



debug('begin add_signature: P2P_INVOICE_DETAILS_REL');
  ...
  add_signature(
      p_sig_repo_id            => '2617',
      p_sig_id                 => 'P2P_INVOICE_DETAILS_REL',
      p_sig_sql                => 'SELECT *
  FROM   (SELECT DISTINCT AI.invoice_id,
      ...
      p_title                  => 'Invoice Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No invoice exists.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: P2P_INVOICE_DETAILS_REL');



debug('begin add_signature: P2P_INVOICE_DETAILS_STD');
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ORG_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##REMIT_TO_SUPPLIER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##VENDOR_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '2618',
      p_sig_id                 => 'P2P_INVOICE_DETAILS_STD',
      p_sig_sql                => 'SELECT *  
 FROM   (select
...
ORDER BY INVOICE_DATE DESC',
   ...
   l_info.delete;
debug('end add_signature: P2P_INVOICE_DETAILS_STD');



debug('begin add_signature: P2P_PAYMENT_DETAILS_REL');
  ...
  add_signature(
      p_sig_repo_id            => '2651',
      p_sig_id                 => 'P2P_PAYMENT_DETAILS_REL',
      p_sig_sql                => 'SELECT *
    FROM   (SELECT AC.check_number,  
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No payment details found.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: P2P_PAYMENT_DETAILS_REL');



debug('begin add_signature: P2P_PAYMENT_DETAILS_STD');
   l_info('##MASK##ADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##BANK_ACCOUNT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ORG_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##REMIT_TO_SUPPLIER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '2652',
      p_sig_id                 => 'P2P_PAYMENT_DETAILS_STD',
      p_sig_sql                => 'SELECT *
   ...
   l_info.delete;
debug('end add_signature: P2P_PAYMENT_DETAILS_STD');
...
BEGIN
  ...
  analyzer_title := 'Procure To Pay Analyzer';
...
start_section('Proactive Recommendations', 'Proactive_Recommendations');
   set_item_result(check_rec_patches_1); /* Signature P2P_RECOMMENDED_PATCHES */
   IF (substr(g_sql_tokens('##$$REL$$##'),1,4) = '12.2') THEN
      set_item_result(run_stored_sig('CHECK_WORKFLOW_HOT_FIX_FILE_CHECK'));
   END IF;
   set_item_result(run_stored_sig('P2P_INVALIDS'));
   set_item_result(run_stored_sig('P2P_FND_DEVELOPER_MODE_PROFILE'));
   IF (substr(g_sql_tokens('##$$REL$$##'),1,4) = '12.0') OR (substr(g_sql_tokens('##$$REL$$##'),1,4) = '12.1') THEN
      set_item_result(run_stored_sig('ALL_TRAILING_SPACES'));
   END IF;
   set_item_result(run_stored_sig('P2P_TABLESPACE_CHECK'));
   set_item_result(run_stored_sig('P2P_XLA_00200_INVALID'));
...
debug('begin section: Requisition_Details');
IF g_sql_tokens('##$$REQNUM$$##') IS NOT NULL THEN
   start_section('Requisition Details', 'Requisition_Details');
      set_item_result(run_stored_sig('P2P_REQUISITION_HEADER_DETAILS'));
      set_item_result(run_stored_sig('P2P_REQUISITION_LINE_DETAILS'));
      set_item_result(run_stored_sig('P2P_REQUISITION_DIST_DETAILS'));
      set_item_result(run_stored_sig('P2P_REQUISITION_APPROVAL_HISTORY'));
      set_item_result(run_stored_sig('P2P_PODATACORRUPTION_05'));
      set_item_result(run_stored_sig('P2P_PODATACORRUPTION_06'));
      set_item_result(run_stored_sig('P2P_PODATACORRUPTION_14'));
      set_item_result(run_stored_sig('P2P_PODATACORRUPTION_18'));
      set_item_result(run_stored_sig('P2P_DFF_UNFROZEN'));
      set_item_result(run_stored_sig('P2P_CANCELLED_REQ_LINE_AUTOCREATE'));
   end_section;
END IF;
debug('end section: Requisition_Details');

debug('begin section: Purchase_Order_Details');
IF g_sql_tokens('##$$PONUM$$##') IS NOT NULL THEN
   start_section('Purchase Order Details', 'Purchase_Order_Details');
      set_item_result(run_stored_sig('P2P_PO_HEADER_DETAILS'));
      set_item_result(run_stored_sig('P2P_PO_LINE_DETAILS'));
      set_item_result(run_stored_sig('P2P_PO_LINE_LOCATIONS'));
      set_item_result(run_stored_sig('P2P_PO_DIST_DETAILS'));
      IF g_sql_tokens('##$$PORELID$$##') IS NOT NULL THEN
         set_item_result(run_stored_sig('REL- PO_RELEASES_ALL'));
         set_item_result(run_stored_sig('REL- PO_LINE_LOCATIONS_ALL'));
      END IF;
      set_item_result(run_stored_sig('P2P_PO_APPROVAL_HISTORY'));
      set_item_result(run_stored_sig('P2P_PODATACORRUPTION_01'));
      set_item_result(run_stored_sig('P2P_PODATACORRUPTION_02'));
      set_item_result(run_stored_sig('P2P_PODATACORRUPTION_03'));
      set_item_result(run_stored_sig('P2P_PODATACORRUPTION_04'));
      set_item_result(run_stored_sig('P2P_PODATACORRUPTION_07'));
      set_item_result(run_stored_sig('P2P_PODATACORRUPTION_08'));
      set_item_result(run_stored_sig('P2P_PODATACORRUPTION_09'));
      set_item_result(run_stored_sig('P2P_PODATACORRUPTION_10'));
      set_item_result(run_stored_sig('P2P_PODATACORRUPTION_11'));
      set_item_result(run_stored_sig('P2P_PODATACORRUPTION_12'));
      set_item_result(run_stored_sig('P2P_PODATACORRUPTION_13'));
      set_item_result(run_stored_sig('P2P_PODATACORRUPTION_19'));
      set_item_result(run_stored_sig('P2P_PODATACORRUPTION_20'));
      set_item_result(run_stored_sig('P2P_DOC_STANDARD_CLAUSES'));
      set_item_result(run_stored_sig('P2P_DOC_NON_STANDARD_CLAUSES'));
      set_item_result(run_stored_sig('P2P_2WAY_COUNT'));
      set_item_result(run_stored_sig('P2P_AUTOCREATE_NUMBERING'));
      set_item_result(run_stored_sig('EBS_FIN_AP_AP_INV_INT_INVALID_PO_NUM'));
      IF g_sql_tokens('##$$CREATEDOC$$##') = 'CREATEPO' THEN
         set_item_result(run_stored_sig('P2P_CREATEPO_ATTRIBUTES_CHECK'));
      END IF;
   end_section;
END IF;
debug('end section: Purchase_Order_Details');

debug('begin section: Receipt_Details');
start_section('Receipt Details', 'Receipt_Details');
   IF g_sql_tokens('##$$PORELNUM$$##') IS NOT NULL THEN
      IF substr(g_sql_tokens('##$$REL$$##'),1,4) = '12.1' THEN
         set_item_result(run_stored_sig('P2P_RECEIPT_DETAILS_REL_12_1'));
         set_item_result(run_stored_sig('P2P_ENCUMBRANCE_AFTER_PO_APPROVAL_REL'));
         set_item_result(run_stored_sig('P2P_PO_RCV_FORM_REL'));
      END IF;
      IF substr(g_sql_tokens('##$$REL$$##'),1,4) = '12.2' THEN
         set_item_result(run_stored_sig('P2P_RECEIPT_DETAILS_REL_12_2'));
         set_item_result(run_stored_sig('P2P_ENCUMBRANCE_AFTER_PO_APPROVAL_REL'));
         set_item_result(run_stored_sig('P2P_PO_RCV_FORM_REL'));
      END IF;
   END IF;
   IF g_sql_tokens('##$$PORELNUM$$##') IS NULL THEN
      IF substr(g_sql_tokens('##$$REL$$##'),1,4) = '12.1' THEN
         set_item_result(run_stored_sig('P2P_RECEIPT_DETAILS_STD_12_1'));
         set_item_result(run_stored_sig('P2P_ENCUMBRANCE_AFTER_PO_APPROVAL_STD'));
         set_item_result(run_stored_sig('P2P_PO_RCV_FORM_STD'));
      END IF;
      IF substr(g_sql_tokens('##$$REL$$##'),1,4) = '12.2' THEN
         set_item_result(run_stored_sig('P2P_RECEIPT_DETAILS_STD_12_2'));
         set_item_result(run_stored_sig('P2P_ENCUMBRANCE_AFTER_PO_APPROVAL_STD'));
         set_item_result(run_stored_sig('P2P_PO_RCV_FORM_STD'));
      END IF;
   END IF;
   set_item_result(run_stored_sig('P2P_MISMATCH_SHIPMENT_HEADER_ID'));
   set_item_result(run_stored_sig('P2P_MATCHING_BASIS_AMOUNT'));
   set_item_result(run_stored_sig('P2P_PO_DESTINATION_ORG_ID_NULL'));
   set_item_result(run_stored_sig('P2P_PO_SHIP_TO_ORGANIZATION_ID_NULL'));
   set_item_result(run_stored_sig('P2P_PO_ITEM_NO_SHIP_TO_ORGANIZATION'));
   set_item_result(run_stored_sig('P2P_RCV_TRANSACTION_MGR_PROCESSES'));
end_section;
debug('end section: Receipt_Details');
...
IF g_sql_tokens('##$$INVOICEUM$$##') IS NOT NULL THEN
   start_section('Invoice Details', 'Invoice_Details');
      IF g_sql_tokens('##$$PORELNUM$$##') IS NOT NULL THEN
         set_item_result(run_stored_sig('P2P_INVOICE_DETAILS_REL'));
      END IF;
      IF g_sql_tokens('##$$PORELNUM$$##') IS NULL THEN
         set_item_result(run_stored_sig('P2P_INVOICE_DETAILS_STD'));
      END IF;
      set_item_result(run_stored_sig('P2P_1_MISMATCH_AP_PO_DISTRIBUTION'));
      set_item_result(run_stored_sig('P2P_2_MISMATCH_PO_LOC_DISTRIBUTION'));
      set_item_result(run_stored_sig('P2P_3_UNMATCHED_PO_WITH_INVOICE_QTY_AMT'));
      set_item_result(run_stored_sig('P2P_3_UNMATCHED_RECEIPT_WITH_INVOICE_QTY_AMT'));
      set_item_result(run_stored_sig('P2P_4_AP_NOT_NULL_QTY_INV_SEL'));
      set_item_result(run_stored_sig('P2P_APP_PO_14144'));
      set_item_result(run_stored_sig('P2P_AP_SYNC_PO_QTY_AMT_SEL_RCV'));
      set_item_result(run_stored_sig('P2P_5_PO_FINALLY_CLOSED'));
      set_item_result(run_stored_sig('P2P_6_PO_NEGATIVE_BILLED'));
      set_item_result(run_stored_sig('P2P_7_ENC_UNAPPROVED_PO'));
      set_item_result(run_stored_sig('P2P_AP_PO_PRICE_ADJ_FLG_SEL'));
      set_item_result(run_stored_sig('P2P_10_PO_MATCHING_REQUIRED'));
      set_item_result(run_stored_sig('P2P_RCV_SHPMT_MISS_SEL'));
      set_item_result(run_stored_sig('P2P_AP_NULL_UNITPRICE_SEL'));
      set_item_result(run_stored_sig('P2P_AP_RCPT_NUM_CORR_INV_SEL'));
      set_item_result(run_stored_sig('P2P_AP_QUICK_PO_UPDATE_SEL'));
      set_item_result(run_stored_sig('P2P_QUICK_MATCH_QTY_RND_SEL'));
      set_item_result(run_stored_sig('P2P_AP_SYNC_PO_RELEASE_ID_SEL'));
      set_item_result(run_stored_sig('P2P_AP_ONE_OFF_SCRIPTS_SEL'));
      set_item_result(run_stored_sig('P2P_AP_SYNC_MATCH_TYPE_SEL'));
      set_item_result(run_stored_sig('EBS_FIN_AP_INV_INVALID_PO_NUM_INV'));
   end_section;
END IF;
debug('end section: Invoice_Details');

debug('begin section: Payment_Details');
IF g_sql_tokens('##$$INVOICEUM$$##') IS NOT NULL THEN
   start_section('Payment Details', 'Payment_Details');
      IF g_sql_tokens('##$$PORELNUM$$##') IS NOT NULL THEN
         set_item_result(run_stored_sig('P2P_PAYMENT_DETAILS_REL'));
      END IF;
      IF g_sql_tokens('##$$PORELNUM$$##') IS NULL THEN
         set_item_result(run_stored_sig('P2P_PAYMENT_DETAILS_STD'));
      END IF;
      set_item_result(run_stored_sig('P2P_AP_PAYMENT_METHOD_NULL_SEL'));
      set_item_result(run_stored_sig('P2P_AP_RATE_MISS_SEL'));
      set_item_result(run_stored_sig('P2P_AP_WRGCHKSTS_SEL'));
      set_item_result(run_stored_sig('P2P_AP_NEGOTIABLE_IBY_VOID_SEL'));
      set_item_result(run_stored_sig('P2P_AP_CHECKS_MISC_SEL_CHECK_1'));
      set_item_result(run_stored_sig('P2P_AP_CHECKS_MISC_SEL_CHECK_2'));
      set_item_result(run_stored_sig('P2P_AP_CHECKS_MISC_SEL_CHECK_3'));
      set_item_result(run_stored_sig('P2P_AP_CHECK_STAT_INCORRECT_SEL'));
      set_item_result(run_stored_sig('P2P_AP_MISSING_MAT_EVENT_SEL'));
   end_section;
END IF;
debug('end section: Payment_Details');

debug('begin section: Diagnostic_Apps_Check');
start_section('Diag Apps Check', 'Diagnostic_Apps_Check');
   set_item_result(run_stored_sig('P2P_FILE_VERSIONS'));
   set_item_result(run_stored_sig('P2P_PROFILE_OPTIONS'));
   set_item_result(run_stored_sig('APPLICATION_INSTALL_DETAILS'));
   set_item_result(run_stored_sig('P2P_DATABASE_TRIGGERS'));
   set_item_result(run_stored_sig('AC_CUSTOM_DATABASE_TRIGGERS'));
   set_item_result(run_stored_sig('P2P_TABLE_INDEXES'));
