...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for CLM Analyzer                           |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE clm_analyzer_pkg AUTHID DEFINER AS
...
(            p_org_id                       IN NUMBER      DEFAULT NULL
           ...
           ,p_award_num                    IN VARCHAR2    DEFAULT NULL
           ,p_sol_num                      IN VARCHAR2    DEFAULT NULL
           ,p_mod_num                      IN VARCHAR2    DEFAULT NULL
           ,p_par_num                      IN VARCHAR2    DEFAULT NULL
           ,p_amend_num                    IN VARCHAR2    DEFAULT NULL
           ,p_include_gl                   IN VARCHAR2    DEFAULT 'Y'
           ,p_pull_ext                     IN VARCHAR2    DEFAULT 'N'
...
END clm_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY clm_analyzer_pkg AS
-- $Id: clm_analyzer.sql, 200.41 2026/01/28 14:41:47 loinonen Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2398956.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'CLM_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'CLM_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>CLM Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2398956.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/clm_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,973,EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,973,EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},973,EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4169792" class="blacklink" target="new">
...
<p>We are listening to your feedback and made the following changes:</p><p>Version 200.40 contains the following new and or updated features:</p><ul><li>Updated Signature AC_TABLE_INDEXES</li>
</ul>
<p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>
            <br><br>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,973,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,973,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},973,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
BEGIN
     ...
     l_step := '20';
     LOOP
         FETCH c_file_version into l_temp_version;
         EXIT WHEN c_file_version%NOTFOUND;
...
FUNCTION check_rec_patches_1 RETURN VARCHAR2 IS
  /* Signature CLM_RECOMMENDED_PATCHES */
...
BEGIN
    ...
    print_log('Processing recommended patches signature: CLM_RECOMMENDED_PATCHES (check_rec_patches_1) "Recommended Patches" (version 5)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(1)(l_rows) := '9858587';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'This patch provides the FPDS-NG Functionality';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '10144355';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'CLM DEV : CHANGES TO ADD USAGE PAGE';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '10348977';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'CLMDEV: DELETING A USAGE DELETES ALL ACTIONS';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '9742694';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'CLM DEV : ISSUES IN TEMPLATE PAGE';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '12810660';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'In Oracle Purchasing, Edit Document link was present in the approval notification even when Approver can modify was set to No.';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '12810693';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'In Oracle Purchasing, for document type - Solicitation, values in security level poplist were not restriced.';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '18592550';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.PO.D - CONSOLIDATED PATCH FOR DAI';
   l_col_rows(5)(l_rows) := NULL;
...
Best Practice: Always ensure that you are on the latest code with all recommended patches applied. This will help avoid known issues, prevent potential data corruption and provide the latest features and functionality. Having a proactive patching plan and periodic proactive patching process in place are the best ways to stay current.';
  ...
  -- Register
  l_step := '60';
  g_signatures('CLM_RECOMMENDED_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'CLM_RECOMMENDED_PATCHES',     -- sig ID
...
BEGIN
    ...
    print_log('Processing recommended patches signature: EBS_ATG_FWK_C12 (check_rec_patches_2) "Recommended Framework Patches" (version 8)');
...
BEGIN
    ...
    print_log('Processing recommended patches signature: FWK_B (check_rec_patches_3) "Recommended Framework  Patches" (version 8)');
...
BEGIN
    ...
    print_log('Processing recommended patches signature: FWK_C10 (check_rec_patches_4) "Recommended Framework Patches" (version 12)');
...
BEGIN
    ...
    print_log('Processing recommended patches signature: FWK_C11 (check_rec_patches_5) "Recommended Framework Patches" (version 13)');
...
BEGIN
    ...
    print_log('Processing recommended patches signature: FWK_C4 (check_rec_patches_6) "Recommended Framework  Patches" (version 22)');
...
BEGIN
    ...
    print_log('Processing recommended patches signature: FWK_C5 (check_rec_patches_7) "Recommended Framework  Patches" (version 26)');
...
BEGIN
    ...
    print_log('Processing recommended patches signature: FWK_C6 (check_rec_patches_8) "Recommended Framework  Patches" (version 35)');
...
BEGIN
    ...
    print_log('Processing recommended patches signature: FWK_C7 (check_rec_patches_9) "Recommended Framework Patches" (version 34)');
...
BEGIN
    ...
    print_log('Processing recommended patches signature: FWK_C8 (check_rec_patches_10) "Recommended Framework Patches" (version 23)');
...
BEGIN
    ...
    print_log('Processing recommended patches signature: FWK_C9 (check_rec_patches_11) "Recommended Framework Patches" (version 24)');
...
debug('begin populate parameters hash table');
   ...
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Login Name';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_user_name,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Responsibility ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(l_responsibility_name || ' ('||  p_responsibility_id ||')','NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'CLM Requisition Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_req_num,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Award Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_award_num,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'CLM Solicitation Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_sol_num,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'CLM Modification Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_mod_num,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'PAR Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_par_num,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'CLM Amendment Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_amend_num,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'CLM Include GL Information';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_include_gl,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'CLM Extrinsic Attributes Tables';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_pull_ext,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  l_revision := rtrim(replace('$Revision: 200.41  $','$',''));
  l_revision := ltrim(replace(l_revision,'Revision:',''));
  l_date_char := rtrim(replace('$Date: 2026/01/28 14:41:46 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'clm_analyzer.sql';
...
IF p_user_name IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Login Name is required.');
   raise invalid_parameters;
END IF;
...
INTO l_exists_val
FROM FND_USER
WHERE USER_NAME = p_user_name and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: User was not found.');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
debug('begin parameter validation: p_responsibility_id');
...
BEGIN
SELECT SP.RESPONSIBILITY_ID
INTO l_exists_val
FROM FND_RESPONSIBILITY SP, FND_RESPONSIBILITY_VL U
WHERE SP.RESPONSIBILITY_ID = p_responsibility_id
 AND u.responsibility_id = sp.responsibility_id
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Responsibility Not Found');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_responsibility_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_responsibility_id');
...
SELECT SEGMENT1
INTO l_exists_val
FROM (SELECT DISTINCT(SEGMENT1), ORG_ID FROM PO_REQUISITION_HEADERS_ALL)
WHERE SEGMENT1 = p_req_num
 AND ORG_ID = p_org_id
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Requisition Number specified.');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
debug('begin parameter validation: p_award_num');
IF p_award_num IS NOT NULL THEN
BEGIN
SELECT CLM_DOCUMENT_NUMBER
INTO l_exists_val
FROM (SELECT DISTINCT(POH.CLM_DOCUMENT_NUMBER),  POH.ORG_ID FROM PO_HEADERS_ALL POH)
WHERE CLM_DOCUMENT_NUMBER = p_award_num
 AND ORG_ID = p_org_id
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Award Number specified. ');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_award_num failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_award_num');

debug('begin parameter validation: p_sol_num');
IF p_sol_num IS NOT NULL THEN
BEGIN
SELECT DOCUMENT_NUMBER
INTO l_exists_val
FROM (SELECT DISTINCT(DOCUMENT_NUMBER), ORG_ID FROM PON_AUCTION_HEADERS_ALL)
WHERE DOCUMENT_NUMBER = p_sol_num
 AND org_id = p_org_id
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Solicitation Specified.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_sol_num failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_sol_num');

debug('begin parameter validation: p_mod_num');
IF p_mod_num IS NOT NULL THEN
BEGIN
SELECT MODIFICATION_NUMBER
INTO l_exists_val
FROM (SELECT DISTINCT(MODIFICATION_NUMBER), POH.ORG_ID FROM PO_DRAFTS POD, PO_HEADERS_ALL POH WHERE POD.DOCUMENT_ID = POH.PO_HEADER_ID AND POD.DRAFT_TYPE =  'MOD')
WHERE MODIFICATION_NUMBER = p_mod_num
 AND ORG_ID = p_org_id
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Modification Number specified. ');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_mod_num failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_mod_num');

debug('begin parameter validation: p_par_num');
IF p_par_num IS NOT NULL THEN
BEGIN
SELECT MODIFICATION_NUMBER
INTO l_exists_val
FROM (SELECT DISTINCT(MODIFICATION_NUMBER), POH.ORG_ID FROM PO_DRAFTS POD, PO_HEADERS_ALL POH WHERE POD.DOCUMENT_ID = POH.PO_HEADER_ID AND POD.DRAFT_TYPE = 'PAR')
WHERE MODIFICATION_NUMBER = p_par_num
 AND ORG_ID = p_org_id
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid PAR Number specified.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_par_num failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_par_num');

debug('begin parameter validation: p_amend_num');
IF p_amend_num IS NOT NULL THEN
BEGIN
SELECT SEGMENT1
INTO l_exists_val
FROM (SELECT DISTINCT(SEGMENT1), ORG_ID FROM PO_REQUISITION_HEADERS_ALL WHERE REVISION_NUM > 0)
WHERE SEGMENT1 = p_amend_num
 AND ORG_ID = p_org_id
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Amendment specified.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_amend_num failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_amend_num');

debug('begin parameter validation: p_include_gl');
IF p_include_gl IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter CLM Include GL Information is required.');
   raise invalid_parameters;
END IF;
IF p_include_gl IS NOT NULL AND p_include_gl NOT IN ( 'N','Y') THEN
   print_error('INVALID ARGUMENT: Please choose Y or N');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_include_gl');

debug('begin parameter validation: p_pull_ext');
IF p_pull_ext IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter CLM Extrinsic Attributes Tables is required.');
   raise invalid_parameters;
END IF;
IF p_pull_ext IS NOT NULL AND p_pull_ext NOT IN ( 'N','Y') THEN
   print_error('INVALID ARGUMENT: Please choose Y or N');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_pull_ext');
...
l_step := '5';
  -- verify the code level of podft.odf - if below 120.52.12010100.1, the table does not include column MODIFICATION_NUMBER
   IF compare_versions(max_file_version('podft.odf'), '120.52.12010100.1') <= 1 THEN
      g_clm_installed := true;
      g_count := 1;
      Print_log('CLM is installed.');
   END IF; 
...
IF p_req_num is not null then
  BEGIN
          SELECT requisition_header_id INTO l_req_hdr_id
          FROM po_requisition_headers_all 
          WHERE org_id = p_org_id
          AND conformed_header_id is null
          AND segment1 = to_char(p_req_num)       
          AND rownum = 1;
  EXCEPTION WHEN NO_DATA_FOUND THEN
    print_log('Invalid Requisition Number specified. '|| 'The Requisition Number parameter is not a valid Requisition.');
      l_req_hdr_id := 0;
    raise invalid_parameters; 
  END;
  ELSE
    print_log('No Requisition Number was specified. '|| 'Requisition Number is optional.');
    l_req_hdr_id := 0;
  END IF;
...
IF p_sol_num is not null then
  BEGIN
           SELECT auction_header_id INTO l_auchdr_id
           FROM pon_auction_headers_all
           WHERE document_number = to_char(p_sol_num) 
           AND org_id =  p_org_id
           AND rownum = 1;
  EXCEPTION WHEN NO_DATA_FOUND THEN
    print_log('Invalid Solicitation Number specified. '|| 'The Solicitation Number parameter is not a valid Solicitation.');
      l_auchdr_id := 0;
    raise invalid_parameters; 
  END;
  ELSE
    print_log('No Solicitation Number was specified. '|| 'Solicitation Number is optional.');
    l_auchdr_id := 0;
  END IF;
...
IF p_award_num is not null then
  BEGIN
	       ...
	       INTO l_award_id
	       FROM po_headers_all
	       WHERE clm_document_number = to_char(p_award_num) 
	       AND org_id =  p_org_id
               AND rownum = 1;
  EXCEPTION WHEN NO_DATA_FOUND THEN
    print_log('Invalid Award Number specified. '|| 'The Award Number parameter is not a valid Award.');
      l_award_id := 0;
    raise invalid_parameters; 
  END;
  ELSE
    print_log('No Award Number was specified. '|| 'Award Number is optional.');
    l_award_id := 0;
  END IF; 


-- Step 40 and Step 50 are now dynamic sql and will only be utilized if CLM is installed. 
-- These steps also will allow the analyzer to install without causing any error.

l_step := '40';
If g_clm_installed then 
l_step := '41';
BEGIN
 IF p_par_num is not null then
  l_sql :=
   'SELECT document_id
   FROM po_drafts pod
   WHERE modification_number = to_char(:p_par_num)
   AND rownum = 1';
  EXECUTE IMMEDIATE l_sql
   INTO l_par_id
 USING IN p_par_num;
 ELSE
    print_log('No PAR Number was specified. '|| 'PAR Number is optional.');
    l_par_id := 0;
END IF;
  EXCEPTION WHEN NO_DATA_FOUND THEN
    print_log('Invalid PAR Number was specified. '|| 'The PAR Number parameter is not a valid PAR.');
      l_par_id := 0;
    raise invalid_parameters;
  END; 
END IF; 
...
IF p_mod_num is not null then
  l_sql :=
   'SELECT draft_id 
   FROM po_drafts
   WHERE modification_number = to_char(:p_mod_num)
   AND rownum = 1';
  print_log(l_sql);
  EXECUTE IMMEDIATE l_sql
   INTO l_draft_id
  USING IN p_mod_num;
  ELSE
    print_log('No Modification Number was specified. '|| 'Modification Number is optional.');
    l_draft_id := 0;
END IF;
  EXCEPTION WHEN NO_DATA_FOUND THEN
    print_log('Invalid Modification Number was specified. '|| 'The Modification Number parameter is not a valid Modification.');
      l_draft_id := 0;
    raise invalid_parameters; 
  END;
END IF;
...
IF p_mod_num is not null then
  BEGIN
   SELECT draft_id into l_draft_id
   FROM po_drafts
   WHERE modification_number = to_char(p_mod_num) 
   AND rownum = 1;
  EXCEPTION WHEN NO_DATA_FOUND THEN
    print_log('Invalid PAR Number was specified. '|| 'The Modification Number parameter is not a valid Modification.');
      l_draft_id := 0;
    raise invalid_parameters; 
  END;
  ELSE
...
IF p_amend_num is not null then
  BEGIN
   ...
   into l_amend_id
   from po_requisition_headers_all
   where segment1 = to_char(p_amend_num)
   AND rownum = 1;
  EXCEPTION WHEN NO_DATA_FOUND THEN
    print_log('Invalid Amendment Number was specified. '|| 'The Amendment Number parameter is not a valid Amendment.');
      l_amend_id := 0;
    raise invalid_parameters; 
  END;
  ELSE
    print_log('No Amendment Number was specified. '|| 'Amendment Number is optional.');
    l_amend_id := 0;
END IF;
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$p_req_num$$##') := p_req_num;
   g_masked_tokens('##$$p_req_num$$##') := mask_text( g_sql_tokens('##$$p_req_num$$##'), 'NO_MASK');
   g_sql_tokens('##$$ORG_ID$$##') := p_org_id;
   g_masked_tokens('##$$ORG_ID$$##') := mask_text( g_sql_tokens('##$$ORG_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$REQHDRID$$##') := l_req_hdr_id;
   g_masked_tokens('##$$REQHDRID$$##') := mask_text( g_sql_tokens('##$$REQHDRID$$##'), 'NO_MASK');
   g_sql_tokens('##$$AUCHDRID$$##') :=  l_auchdr_id;
   g_masked_tokens('##$$AUCHDRID$$##') := mask_text( g_sql_tokens('##$$AUCHDRID$$##'), 'NO_MASK');
   g_sql_tokens('##$$AWARDID$$##') := l_award_id;
   g_masked_tokens('##$$AWARDID$$##') := mask_text( g_sql_tokens('##$$AWARDID$$##'), 'NO_MASK');
   g_sql_tokens('##$$p_sol_num$$##') := p_sol_num;
   g_masked_tokens('##$$p_sol_num$$##') := mask_text( g_sql_tokens('##$$p_sol_num$$##'), 'NO_MASK');
   g_sql_tokens('##$$p_award_num$$##') := p_award_num;
   g_masked_tokens('##$$p_award_num$$##') := mask_text( g_sql_tokens('##$$p_award_num$$##'), 'NO_MASK');
   g_sql_tokens('##$$MODDRAFTID$$##') := l_draft_id;
   g_masked_tokens('##$$MODDRAFTID$$##') := mask_text( g_sql_tokens('##$$MODDRAFTID$$##'), 'NO_MASK');
   g_sql_tokens('##$$p_mod_num$$##') := p_mod_num;
   g_masked_tokens('##$$p_mod_num$$##') := mask_text( g_sql_tokens('##$$p_mod_num$$##'), 'NO_MASK');
   g_sql_tokens('##$$PARHDRID$$##') := l_par_id;
   g_masked_tokens('##$$PARHDRID$$##') := mask_text( g_sql_tokens('##$$PARHDRID$$##'), 'NO_MASK');
   g_sql_tokens('##$$p_par_num$$##') := p_par_num;
   g_masked_tokens('##$$p_par_num$$##') := mask_text( g_sql_tokens('##$$p_par_num$$##'), 'NO_MASK');
   g_sql_tokens('##$$AMENDID$$##') := l_amend_id;
   g_masked_tokens('##$$AMENDID$$##') := mask_text( g_sql_tokens('##$$AMENDID$$##'), 'NO_MASK');
   g_sql_tokens('##$$p_amend_num$$##') := p_amend_num;
   g_masked_tokens('##$$p_amend_num$$##') := mask_text( g_sql_tokens('##$$p_amend_num$$##'), 'NO_MASK');
   g_sql_tokens('##$$p_include_gl$$##') := p_include_gl;
   g_masked_tokens('##$$p_include_gl$$##') := mask_text( g_sql_tokens('##$$p_include_gl$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM1$$##') := '201';
   g_masked_tokens('##$$APPS_PARAM1$$##') := mask_text( g_sql_tokens('##$$APPS_PARAM1$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM2$$##') := '178';
...
debug('begin add_signature: CLM_SETUP_COMPILE_ATTRIBUTE_TEMPLATES');
   l_info('##MASK##CREATED_BY'):= 'MASK_ALPHANUMERIC';
   l_info('##MASK##DISPLAY_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10703',
      p_sig_id                 => 'CLM_SETUP_COMPILE_ATTRIBUTE_TEMPLATES',
      p_sig_sql                => 'SELECT display_name, document_level, document_type
FROM
  (SELECT TemplateEO.TEMPLATE_ID,
    TemplateEO.COMMENTS,
    TemplateEO.COMPILED_FLAG,
    TemplateEO.CREATED_BY,
    TemplateEO.CREATION_DATE,
    TemplateEO.DATABASE_VIEW_NAME,
    TemplateEO.DISPLAY_NAME,
    TemplateEO.DOCUMENT_LEVEL,
    TemplateEO.DOCUMENT_STYLE_ID,
    TemplateEO.DOCUMENT_TYPE,
    TemplateEO.REVISION,
      STYLE.DISPLAY_NAME       AS DOCUMENT_STYLE
  FROM PO_UDA_AG_TEMPLATES_VL TemplateEO,
    (SELECT dummy.data_level_name data_level_name ,
      realone.USER_data_level_name user_data_level_name
    FROM ego_data_level_vl dummy,
      ego_data_level_vl realone
    WHERE realone.attr_group_type = dummy.data_level_name
    AND realone.data_level_name NOT LIKE ''%ARCHIVE''
    ) ET,
    PO_DOC_STYLE_LINES_VL STYLE
  WHERE TemplateEO.ENTITY_CODE  = ET.DATA_LEVEL_NAME
  AND STYLE.STYLE_ID(+)         = TEMPLATEEO.DOCUMENT_STYLE_ID
  AND STYLE.DOCUMENT_SUBTYPE(+) = TEMPLATEEO.DOCUMENT_TYPE
  AND TemplateEO.DATABASE_VIEW_NAME is null
  ) QRSLT',
      p_title                  => 'CLM Compile Attributes',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are Attribute Templates which have not been generated.  ',
      p_solution               => '<ul>
<li>Review the following note to confirm that all related tasks for compiling attribute templates have been taken.</li>
<li>[1452011/KB337220] - CLM Setup - Basic Steps to Execute At The Start </li>
<li>Please navigate to the Attribute Setup Workbench and compile the templates.</li>
</ul>',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: CLM_SETUP_COMPILE_ATTRIBUTE_TEMPLATES');



debug('begin add_signature: CLM_SETUP_DOC_TYPE_ARCHIVE_METHOD_MISSING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10738',
      p_sig_id                 => 'CLM_SETUP_DOC_TYPE_ARCHIVE_METHOD_MISSING',
      p_sig_sql                => 'select pdt.document_type_code, pdt.type_name, pdt.ARCHIVE_EXTERNAL_REVISION_CODE archive_method
from 
po_doc_style_headers pdh,
po_doc_style_lines_tl pdl, 
PO_DOCUMENT_TYPES_ALL_VL pdt
where
pdh.style_id = pdl.style_id and
pdh.org_id = pdt.org_id and
pdl.document_subtype = pdt.document_subtype and
pdt.document_type_code in (''PO'',''PA'') and
pdh.clm_flag = ''Y'' and
pdl.language = ''US'' and
pdl.language = ''US'' and
pdh.style_id > 0 and
pdt.ARCHIVE_EXTERNAL_REVISION_CODE is null and
pdt.ORG_ID  = ##$$ORG_ID$$## ',
      p_title                  => 'CLM Document Types Archive Method',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The Archiving method has not been set for the CLM Document Types.',
      p_solution               => '<ul>
<li>Review the following note to confirm that the Archiving methods have been properly selected on the Document Types.</li>
<li>Note [807454/KB374995] - Purchasing and CLM Documents are failing to Generate PDF Output - Error "getArchiveOn(): null" </li>
</ul>',
      p_success_msg            => 'The Archiving method has been set for the CLM Document Types.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: CLM_SETUP_DOC_TYPE_ARCHIVE_METHOD_MISSING');



debug('begin add_signature: CLM_SETUP_ENABLED_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10702',
      p_sig_id                 => 'CLM_SETUP_ENABLED_PROFILE_CHECK',
 ...
 WHERE fpot.user_profile_option_name like ''%FND%Industry%''
   ...
   AND fpov.level_id in (10001,10003)
   AND fpot.language = ''US''',
      p_title                  => 'CLM Install and Enabled',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The primary profiles which enable the CLM product are possibly not setup or enabled.',
      p_solution               => '<ul>
<li>Review the following manual, Oracle Contract Lifecycle Management for Public Sector, Chapter 9, Profile Options</li>
<li>[1306980/KB198467] - Where Are The CLM (Contract Lifecycle Managegment) Manuals" </li>
</ul>',
      p_success_msg            => 'All mandatory profiles to enable the Contract Lifecyle Management application have been setup.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CLM_SETUP_ENABLED_PROFILE_CHECK');



debug('begin add_signature: CLM_SETUP_FPDS_CHECKS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10701',
      p_sig_id                 => 'CLM_SETUP_FPDS_CHECKS',
      p_sig_sql                => 'SELECT *  
FROM
  (select 
nvl(fpdsng_awd_mod_xml_source, ''XML Source for Award is not defined in the Purchasing Options.'') XML_Source
from po_system_parameters_all
where org_id =  ##$$ORG_ID$$##
and enable_fpds_reporting = ''Y''
and fpdsng_awd_mod_xml_source is null
  UNION
select 
nvl(fpdsng_awd_xml_source, ''XML Source for Solicitation is not defined in the Purchasing Options.'') 
from po_system_parameters_all
where org_id =  ##$$ORG_ID$$##
and enable_fpds_reporting = ''Y''
and fpdsng_awd_xml_source is null
 UNION
select 
nvl(fpdsng_idv_mod_xml_source, ''XML Source for IDV Modification is not defined in the Purchasing Options.'') 
from po_system_parameters_all
where org_id =  ##$$ORG_ID$$##
and enable_fpds_reporting = ''Y''
and fpdsng_idv_mod_xml_source is null
 UNION
select 
nvl(fpds_approv_notif_type, ''XML Source for IDV is not defined in the Purchasing Options.'') 
from po_system_parameters_all
where org_id =  ##$$ORG_ID$$##
and enable_fpds_reporting = ''Y''
and fpds_approv_notif_type is null)',
      p_title                  => 'FPDS Validation Checks',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'FPDS-NG Reporting is enabled without having all XML Sources Defined.',
      p_solution               => '<ul>
Review the following note to confirm that all related FPDS setups have been completed.</li>
<li>[2176563/KB441642] - Minimum Required Setup for Public Sector Federal Procurement Data System Next Generation (FPDS-NG) </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: CLM_SETUP_FPDS_CHECKS');



debug('begin add_signature: CLM_SETUP_LOOKUP_CODE');
   l_info('##MASK##LOOKUP_TYPE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10747',
      p_sig_id                 => 'CLM_SETUP_LOOKUP_CODE',
      p_sig_sql                => 'select * from 
(select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_AGENCY_IDENTIFIER''),''PO_CLM_AGENCY_IDENTIFIER is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_ALLOWED_RANGE''),''PO_CLM_ALLOWED_RANGE is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_CUSTOMER_PROJECT_CODE''),''PO_CLM_CUSTOMER_PROJECT_CODE is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_HAZMAT''),''PO_CLM_HAZMAT is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_AWARD_STD_FORM''),''PO_AWARD_STD_FORM is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CHG_SUMM_OUTPUT_FORMAT''),''PO_CHG_SUMM_OUTPUT_FORMAT is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_ADMIN_S''),''PO_CLM_ADMIN_S is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_AUTH_OTR_FULL_OPEN_COMP''),''PO_CLM_AUTH_OTR_FULL_OPEN_COMP is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_AWD_TYPE_BPA''),''PO_CLM_AWD_TYPE_BPA is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_AWD_TYPE_CPA''),''PO_CLM_AWD_TYPE_CPA is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_AWD_TYPE_ORD_OFF_IDV''),''PO_CLM_AWD_TYPE_ORD_OFF_IDV is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_AWD_TYPE_SPO''),''PO_CLM_AWD_TYPE_SPO is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_BOND_REQUIRED_YN''),''PO_CLM_BOND_REQUIRED_YN is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_CAR_ACTIONS''),''PO_CLM_CAR_ACTIONS is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_CAR_EXEMPT_REASON''),''PO_CLM_CAR_EXEMPT_REASON is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_CAR_TXN_TYPES''),''PO_CLM_CAR_TXN_TYPES is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_CCR_EXP_REASON''),''PO_CLM_CCR_EXP_REASON is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_CONTRACT_CATEGORY''),''PO_CLM_CONTRACT_CATEGORY is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_DOC_FORMAT''),''PO_CLM_DOC_FORMAT is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_DPAS_RATING''),''PO_CLM_DPAS_RATING is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_EFT_EXCLUSION_REASON''),''PO_CLM_EFT_EXCLUSION_REASON is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_EFT_INDICATOR''),''PO_CLM_EFT_INDICATOR is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_FOB_VALUES''),''PO_CLM_FOB_VALUES is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_FPDS_AWARD_TYPE''),''PO_CLM_FPDS_AWARD_TYPE is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_FPDS_IDV_TYPE''),''PO_CLM_FPDS_IDV_TYPE is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_INSPECTION_LOC''),''PO_CLM_INSPECTION_LOC is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_PRECIOUS_METAL_CODE''),''PO_CLM_PRECIOUS_METAL_CODE is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_PRIORITY_CODE''),''PO_CLM_PRIORITY_CODE is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_PROGRAM_CODES''),''PO_CLM_PROGRAM_CODES is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_SECURITY_CLR_REQ_INDIC''),''PO_CLM_SECURITY_CLR_REQ_INDIC is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_SET_ASIDE_STATUS''),''PO_CLM_SET_ASIDE_STATUS is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_SHIPMENT_MODES''),''PO_CLM_SHIPMENT_MODES is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_SIZE_STANDARD''),''PO_CLM_SIZE_STANDARD is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_VENDOR_SIZE''),''PO_CLM_VENDOR_SIZE is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_DEL_ORD_STD_FORM''),''PO_DEL_ORD_STD_FORM is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''CLM_ASSIGNMENT_ACTION_STATUSES''),''CLM_ASSIGNMENT_ACTION_STATUSES is not defined '') lookup_code from dual union
select nvl((select lookup_type from fnd_lookup_types where lookup_type = ''PO_CLM_CAR_REL_WO_REP_REASON''),''PO_CLM_CAR_REL_WO_REP_REASON is not defined '') lookup_code from dual)
where lookup_code like ''%defined%''',
      p_title                  => 'Defined Lookup Codes',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Mandatory lookup codes have not been defined for the application.',
      p_solution               => '<ul>
<li>Review the Oracle Contract Lifecycle Management for Public Sector Implementation Guide, Appendix A</li>
<li>[1306980/KB198467] - Where Are The CLM (Contract Lifecycle Managegment) Manuals</li>
</ul>',
      p_success_msg            => 'All recommended lookup codes have been defined.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CLM_SETUP_LOOKUP_CODE');



debug('begin add_signature: CLM_DC_REQ_REQ_HDR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8520',
      p_sig_id                 => 'CLM_DC_REQ_REQ_HDR',
      p_sig_sql                => 'select prh.conformed_header_id, prh.*
from po_requisition_headers_all prh
where prh.requisition_header_id = ##$$REQHDRID$$##',
      p_title                  => 'PO_REQUISITION_HEADERS_ALL for Requisition',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Requisition data from PO_REQUISITION_HEADERS_ALL. 
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_REQ_REQ_HDR');



debug('begin add_signature: CLM_DC_REQ_REQ_LINES');
   l_info('##MASK##REQUESTER_EMAIL'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##REQUESTER_PHONE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8521',
      p_sig_id                 => 'CLM_DC_REQ_REQ_LINES',
      p_sig_sql                => 'select prl.*
from po_requisition_lines_all prl,
po_requisition_headers_all prh
where prl.requisition_header_id = ##$$REQHDRID$$##
and prh.requisition_header_id = prl.requisition_header_id',
      p_title                  => 'PO_REQUISITION_LINES_ALL for Requisition',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Requisition data from PO_REQUISITION_LINES_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_REQ_REQ_LINES');



debug('begin add_signature: CLM_DC_REQ_REQ_DISTRIBUTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8522',
      p_sig_id                 => 'CLM_DC_REQ_REQ_DISTRIBUTIONS',
      p_sig_sql                => 'select prd.*
from po_req_distributions_all prd,
po_requisition_lines_all prl, 
po_requisition_headers_all prh
where prh.requisition_header_id = prl.requisition_header_id
and prh.requisition_header_id =  ##$$REQHDRID$$##
and prl.requisition_line_id = prd.requisition_line_id',
      p_title                  => 'PO_REQ_DISTRIBUTIONS_ALL for Requisition',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only. ',
      p_solution               => '',
      p_success_msg            => 'Requisition data from PO_REQ_DISTRIBUTIONS_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_REQ_REQ_DISTRIBUTIONS');



debug('begin add_signature: CLM_DC_REQ_ACTION_HISTORY_1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8523',
      p_sig_id                 => 'CLM_DC_REQ_ACTION_HISTORY_1',
      p_sig_sql                => 'select pah.*
from po_action_history pah, 
per_all_people_f ppf
where pah.employee_id = ppf.person_id
and object_id = ##$$REQHDRID$$##
and object_type_code = ''REQUISITION''
order by pah.sequence_num asc',
      p_title                  => 'PO_ACTION_HISTORY for Requisition',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Requisition data from PO_ACTION_HISTORY.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_REQ_ACTION_HISTORY_1');



debug('begin add_signature: CLM_DC_REQ_PON_HDR');
   l_info('##MASK##AUCTION_TITLE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRADING_PARTNER_CONTACT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRADING_PARTNER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRADING_PARTNER_NAME_UPPER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8525',
      p_sig_id                 => 'CLM_DC_REQ_PON_HDR',
      p_sig_sql                => 'select pon.*
from 
po_requisition_headers_all porh,
po_requisition_lines_all porl,
pon_auction_headers_all pon
where  porh.requisition_header_id = porl.requisition_header_id
and porl.auction_header_id = pon.auction_header_id 
and porl.requisition_header_id = ##$$REQHDRID$$##',
      p_title                  => 'PON_AUCTION_HEADERS_ALL for Requisition',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Requisition data from PON_AUCTION_HEADERS_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_REQ_PON_HDR');



debug('begin add_signature: CLM_DC_REQ_PON_LINE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8526',
      p_sig_id                 => 'CLM_DC_REQ_PON_LINE',
      p_sig_sql                => 'select poni.*
from 
po_requisition_headers_all porh,
po_requisition_lines_all porl,
pon_auction_headers_all pon,
pon_auction_item_prices_all poni
where  porh.requisition_header_id = porl.requisition_header_id
and pon.auction_header_id = poni.auction_header_id
and porl.auction_header_id = pon.auction_header_id 
and porl.requisition_header_id = ##$$REQHDRID$$##',
      p_title                  => 'PON_AUCTION_LINES_ALL for Requisition',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Requisition data from PON_AUCTION_LINES_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_REQ_PON_LINE');



debug('begin add_signature: CLM_DC_REQ_AWARD_PO_HEADERS');
   l_info('##MASK##EMAIL_ADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FAX'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8603',
      p_sig_id                 => 'CLM_DC_REQ_AWARD_PO_HEADERS',
      p_sig_sql                => 'select poh.* 
from po_headers_all poh,
po_requisition_lines_all porl, 
po_line_locations_all pll
where
poh.po_header_id = pll.po_header_id
and porl.line_location_id = pll.line_location_id
and porl.requisition_header_id = ##$$REQHDRID$$##',
      p_title                  => 'PO_HEADERS_ALL for Requisition Award',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.
',
      p_solution               => '',
      p_success_msg            => 'Requisition data from PO_HEADERS_ALL.
No action is required, informational purposes only.
...
',
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_REQ_AWARD_PO_HEADERS');



debug('begin add_signature: CLM_DC_REQ_AWARD_PO_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8604',
      p_sig_id                 => 'CLM_DC_REQ_AWARD_PO_LINES',
      p_sig_sql                => 'select pol.* 
from po_headers_all poh,
po_lines_all pol,
po_requisition_lines_all porl, 
po_line_locations_all pll
...
and porl.line_location_id = pll.line_location_id
and porl.requisition_header_id = ##$$REQHDRID$$##',
      p_title                  => 'PO_LINES_ALL for Requisition Award',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Requisition data from PO_LINES_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_REQ_AWARD_PO_LINES');



debug('begin add_signature: CLM_DC_REQ_AWARD_PO_LINE_LOCATIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8605',
      p_sig_id                 => 'CLM_DC_REQ_AWARD_PO_LINE_LOCATIONS',
      p_sig_sql                => 'select pll.* 
from po_headers_all poh,
po_lines_all pol,
po_requisition_lines_all porl, 
po_line_locations_all pll
...
and porl.line_location_id = pll.line_location_id
and porl.requisition_header_id = ##$$REQHDRID$$##',
      p_title                  => 'PO_LINE_LOCATIONS_ALL for Requisition Award',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Requisition data from PO_LINE_LOCATIONS_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_REQ_AWARD_PO_LINE_LOCATIONS');



debug('begin add_signature: CLM_DC_REQ_AWARD_PO_DISTRIBUTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8606',
      p_sig_id                 => 'CLM_DC_REQ_AWARD_PO_DISTRIBUTIONS',
      p_sig_sql                => 'select pod.*
from po_headers_all poh,
po_lines_all pol,
po_requisition_lines_all porl, 
po_line_locations_all pll,
...
and porl.line_location_id = pll.line_location_id
and porl.requisition_header_id = ##$$REQHDRID$$##',
      p_title                  => 'PO_DISTRIBUTIONS_ALL for Requisition Award',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Requisition data from PO_DISTRIBUTIONS_ALL. 
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_REQ_AWARD_PO_DISTRIBUTIONS');



debug('begin add_signature: CLM_DC_SOL_PON_HDR');
   l_info('##MASK##TRADING_PARTNER_CONTACT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRADING_PARTNER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRADING_PARTNER_NAME_UPPER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8657',
      p_sig_id                 => 'CLM_DC_SOL_PON_HDR',
      p_sig_sql                => 'select pon.*
from pon_auction_headers_all pon
where auction_header_id = ##$$AUCHDRID$$##',
      p_title                  => 'PON_AUCTION_HEADERS_ALL for Solicitation',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Solicitation data from PON_AUCTION_HEADERS_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_SOL_PON_HDR');



debug('begin add_signature: CLM_DC_SOL_PON_AUCTION_ITEM_PRICES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8660',
      p_sig_id                 => 'CLM_DC_SOL_PON_AUCTION_ITEM_PRICES',
      p_sig_sql                => 'select * 
from pon_auction_item_prices_all 
where auction_header_id = ##$$AUCHDRID$$##',
      p_title                  => 'PON_AUCTION_ITEM_PRICES_ALL for Solicitation',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found.
No action is required, informational purposes only.
',
      p_solution               => '',
      p_success_msg            => 'Solicitation data from PON_AUCTION_ITEM_PRICES_ALL.
No action is required, informational purposes only.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_SOL_PON_AUCTION_ITEM_PRICES');



debug('begin add_signature: CLM_DC_SOL_PON_AUCTION_HEADERS_EXT');
   ...
   l_info('##MASK##TL_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##UOM_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8736',
      p_sig_id                 => 'CLM_DC_SOL_PON_AUCTION_HEADERS_EXT',
      p_sig_sql                => 'select * 
from pon_auction_headers_ext_vl 
where auction_header_id = ##$$AUCHDRID$$##',
      p_title                  => 'PON_AUCTION_HEADERS_EXT_VL for Solicitation',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Solicitation data from PON_AUCTION_HEADERS_EXT_VL.
No action is required, informational purposes only.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_SOL_PON_AUCTION_HEADERS_EXT');



debug('begin add_signature: CLM_DC_SOL_PON_AUCTION_ITEM_PRICES_EXT');
   l_info('##MASK##C_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##D_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##N_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TL_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '8737',
      p_sig_id                 => 'CLM_DC_SOL_PON_AUCTION_ITEM_PRICES_EXT',
      p_sig_sql                => 'select * 
from pon_auction_item_prices_ext_vl 
where auction_header_id = ##$$AUCHDRID$$##',
      p_title                  => 'PON_AUCTION_ITEM_PRICES_EXT_VL for Solicitation',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Solicitation data from PON_AUCTION_ITEM_PRICES_EXT_VL.
No action is required, informational purposes only.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_SOL_PON_AUCTION_ITEM_PRICES_EXT');



debug('begin add_signature: CLM_DC_SOL_PO_REQ_HDRS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8738',
      p_sig_id                 => 'CLM_DC_SOL_PO_REQ_HDRS',
      p_sig_sql                => 'select porh.* 
from po_requisition_headers_all porh,
po_requisition_lines_all porl
where  porh.requisition_header_id = porl.requisition_header_id
and porl.auction_header_id = ##$$AUCHDRID$$##',
      p_title                  => 'PO_REQUISITION_HEADERS_ALL for Solicitation',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Solicitation data from PO_REQUISITION_HEADERS_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_SOL_PO_REQ_HDRS');



debug('begin add_signature: CLM_DC_SOL_PO_REQ_LINES');
   l_info('##MASK##REQUESTER_EMAIL'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##REQUESTER_PHONE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8740',
      p_sig_id                 => 'CLM_DC_SOL_PO_REQ_LINES',
      p_sig_sql                => 'select porl.* 
from 
po_requisition_headers_all porh,
po_requisition_lines_all porl
where  porh.requisition_header_id = porl.requisition_header_id
and porl.auction_header_id = ##$$AUCHDRID$$##',
      p_title                  => 'PO_REQUISITION_LINES_ALL for Solicitation',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Solicitation data from PO_REQUISITION_LINES_ALL. 
No action is required, informational purposes only.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_SOL_PO_REQ_LINES');



debug('begin add_signature: CLM_DC_SOL_PO_REQ_DIST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8741',
      p_sig_id                 => 'CLM_DC_SOL_PO_REQ_DIST',
      p_sig_sql                => 'select  
pord.* 
from 
...
and porl.auction_header_id = ##$$AUCHDRID$$##',
      p_title                  => 'PO_REQ_DISTRIBUTIONS_ALL for Solicitation',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Solicitation data from PO_REQ_DISTRIBUTIONS_ALL.
No action is required, informational purposes only.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_SOL_PO_REQ_DIST');



debug('begin add_signature: CLM_DC_SOL_PO_HDRS');
   l_info('##MASK##EMAIL_ADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FAX'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8742',
      p_sig_id                 => 'CLM_DC_SOL_PO_HDRS',
      p_sig_sql                => 'select poh.*
from po_headers_all poh,
po_lines_all pol
where poh.po_header_id = pol.po_header_id
and pol.auction_header_id = ##$$AUCHDRID$$##',
      p_title                  => 'PO_HEADERS_ALL for Solicitation',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Solicitation data from PO_HEADERS_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_SOL_PO_HDRS');



debug('begin add_signature: CLM_DC_SOL_PO_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8744',
      p_sig_id                 => 'CLM_DC_SOL_PO_LINES',
      p_sig_sql                => 'select pol.*
from po_headers_all poh,
po_lines_all pol
where poh.po_header_id = pol.po_header_id
and pol.auction_header_id = ##$$AUCHDRID$$##',
      p_title                  => 'PO_LINES_ALL for Solicitation',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.
',
      p_solution               => '',
      p_success_msg            => 'Solicitation data from PO_LINES_ALL. 
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_SOL_PO_LINES');



debug('begin add_signature: CLM_DC_SOL_PO_LINE_LOCATIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8745',
      p_sig_id                 => 'CLM_DC_SOL_PO_LINE_LOCATIONS',
      p_sig_sql                => 'select poll.*
from po_headers_all poh,
po_lines_all pol,
po_line_locations_all poll
where poh.po_header_id = pol.po_header_id and
pol.po_line_id = poll.po_line_id and
pol.auction_header_id = ##$$AUCHDRID$$##',
      p_title                  => 'PO_LINE_LOCATIONS_ALL for Solicitation',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Solicitation data from PO_LINE_LOCATIONS_ALL.
No action is required, informational purposes only.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_SOL_PO_LINE_LOCATIONS');



debug('begin add_signature: CLM_DC_SOL_PO_DIST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8746',
      p_sig_id                 => 'CLM_DC_SOL_PO_DIST',
      p_sig_sql                => 'select pod.*
from po_headers_all poh,
po_lines_all pol,
po_line_locations_all poll,
...
pol.auction_header_id = ##$$AUCHDRID$$##',
      p_title                  => 'PO_DISTRIBUTIONS_ALL for Solicitation',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Solicitation data from PO_DISTRIBUTIONS_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_SOL_PO_DIST');



debug('begin add_signature: CLM_DC_AWD_PO_HEADERS_ALL');
   l_info('##MASK##EMAIL_ADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FAX'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8748',
      p_sig_id                 => 'CLM_DC_AWD_PO_HEADERS_ALL',
      p_sig_sql                => 'select * from po_headers_all
where po_header_id = ##$$AWARDID$$##',
      p_title                  => 'PO_HEADERS_ALL for Award',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Award data from PO_HEADERS_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_AWD_PO_HEADERS_ALL');



debug('begin add_signature: CLM_DC_AWD_PO_LINES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8749',
      p_sig_id                 => 'CLM_DC_AWD_PO_LINES_ALL',
      p_sig_sql                => 'select * from po_lines_all
where po_header_id = ##$$AWARDID$$##',
      p_title                  => 'PO_LINES_ALL for Award',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found.
No action is required, informational purposes only.
',
      p_solution               => '',
      p_success_msg            => 'Award data from PO_LINES_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_AWD_PO_LINES_ALL');



debug('begin add_signature: CLM_DC_AWD_PO_LINE_LOCATIONS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8750',
      p_sig_id                 => 'CLM_DC_AWD_PO_LINE_LOCATIONS_ALL',
      p_sig_sql                => 'select * from po_line_locations_all
where po_header_id = ##$$AWARDID$$##',
      p_title                  => 'PO_LINE_LOCATIONS_ALL for Award',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.
',
      p_solution               => '',
      p_success_msg            => 'Award data for PO_LINE_LOCATIONS_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_AWD_PO_LINE_LOCATIONS_ALL');



debug('begin add_signature: CLM_DC_AWD_PO_DISTRIBUTIONS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8751',
      p_sig_id                 => 'CLM_DC_AWD_PO_DISTRIBUTIONS_ALL',
      p_sig_sql                => 'select * from po_distributions_all
where po_header_id = ##$$AWARDID$$##',
      p_title                  => 'PO_DISTRIBUTIONS_ALL for Award',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Award data from PO_DISTRIBUTIONS_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_AWD_PO_DISTRIBUTIONS_ALL');



debug('begin add_signature: EBS_MFG_PO_CLM_DC_AWD_ACTION_HISTORY_1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27060',
      p_sig_id                 => 'EBS_MFG_PO_CLM_DC_AWD_ACTION_HISTORY_1',
      p_sig_sql                => 'select pah.*
from po_action_history pah, 
per_all_people_f ppf
where pah.employee_id = ppf.person_id
and object_id = ##$$AWARDID$$##
and object_type_code = ''PO''
order by pah.sequence_num asc',
      p_title                  => 'PO_ACTION_HISTORY for Award',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found.
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Award data from PO_ACTION_HISTORY.
No action is required, informational only.',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_CLM_DC_AWD_ACTION_HISTORY_1');



debug('begin add_signature: CLM_DC_AWD_PO_HEADERS_ARCHIVE_ALL');
   l_info('##MASK##EMAIL_ADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FAX'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8824',
      p_sig_id                 => 'CLM_DC_AWD_PO_HEADERS_ARCHIVE_ALL',
      p_sig_sql                => 'select * from po_headers_archive_all
where po_header_id = ##$$AWARDID$$##',
      p_title                  => 'PO_HEADERS_ARCHIVE_ALL for Award',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.
',
      p_solution               => '',
      p_success_msg            => 'Award data from PO_HEADERS_ARCHIVE_ALL.
No action is required, informational purposes only.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_AWD_PO_HEADERS_ARCHIVE_ALL');



debug('begin add_signature: CLM_DC_AWD_PO_LINES_ARCHIVE_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8825',
      p_sig_id                 => 'CLM_DC_AWD_PO_LINES_ARCHIVE_ALL',
      p_sig_sql                => 'select * from po_lines_archive_all
where po_header_id = ##$$AWARDID$$##',
      p_title                  => 'PO_LINES_ARCHIVE_ALL for Award',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Award data from PO_LINES_ARCHIVE_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_AWD_PO_LINES_ARCHIVE_ALL');



debug('begin add_signature: CLM_DC_AWD_PO_LINE_LOCATIONS_ARCHIVE_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8827',
      p_sig_id                 => 'CLM_DC_AWD_PO_LINE_LOCATIONS_ARCHIVE_ALL',
      p_sig_sql                => 'select * from po_line_locations_archive_all
where po_header_id = ##$$AWARDID$$##',
      p_title                  => 'PO_LINE_LOCATIONS_ARCHIVE_ALL for Award',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Award data from PO_LINE_LOCATIONS_ARCHIVE_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_AWD_PO_LINE_LOCATIONS_ARCHIVE_ALL');



debug('begin add_signature: CLM_DC_AWD_PO_DISTRIBUTIONS_ARCHIVE_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8826',
      p_sig_id                 => 'CLM_DC_AWD_PO_DISTRIBUTIONS_ARCHIVE_ALL',
      p_sig_sql                => 'select * from po_distributions_archive_all
where po_header_id = ##$$AWARDID$$##',
      p_title                  => 'PO_DISTRIBUTIONS_ARCHIVE_ALL for Award',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Award data from PO_DISTRIBUTIONS_ARCHIVE_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_AWD_PO_DISTRIBUTIONS_ARCHIVE_ALL');



debug('begin add_signature: CLM_DC_AWD_PO_HEADERS_ALL_EXT_B');
   l_info('##MASK##C_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##D_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##N_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##UOM_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '8821',
      p_sig_id                 => 'CLM_DC_AWD_PO_HEADERS_ALL_EXT_B',
      p_sig_sql                => 'select * 
from PO_HEADERS_ALL_EXT_B
where po_header_id = ##$$AWARDID$$##',
      p_title                  => 'PO_HEADERS_ALL_EXT_B  for Award',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Award data for PO_HEADERS_ALL_EXT_B.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_AWD_PO_HEADERS_ALL_EXT_B');



debug('begin add_signature: CLM_DC_AWD_PO_LINES_ALL_EXT_B');
   l_info('##MASK##C_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##D_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##N_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##UOM_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '8822',
      p_sig_id                 => 'CLM_DC_AWD_PO_LINES_ALL_EXT_B',
      p_sig_sql                => 'select pb.* 
from po_lines_all_ext_b pb, 
po_lines_all pl
where pl.po_line_id = pb.po_line_id
and pl.po_header_id = ##$$AWARDID$$##',
      p_title                  => 'PO_LINES_ALL_EXT_B for Award',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.
',
      p_solution               => '',
      p_success_msg            => 'Award data from PO_LINES_ALL_EXT_B.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_AWD_PO_LINES_ALL_EXT_B');



debug('begin add_signature: CLM_DC_AWD_PO_LINES_LOCATIONS_ALL_EXT_B');
   l_info('##MASK##C_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##D_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##N_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##UOM_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '8823',
      p_sig_id                 => 'CLM_DC_AWD_PO_LINES_LOCATIONS_ALL_EXT_B',
      p_sig_sql                => 'select pb.* 
from po_line_locations_all_ext_b pb,
po_line_locations_all pll
where  pb.line_location_id = pll.line_location_id
and pll.po_header_id = ##$$AWARDID$$##',
      p_title                  => 'PO_LINES_LOCATIONS_ALL_EXT_B for Award',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.
',
      p_solution               => '',
      p_success_msg            => 'Award data from PO_LINE_LOCATIONS_ALL_EXT_B.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_AWD_PO_LINES_LOCATIONS_ALL_EXT_B');



debug('begin add_signature: EBS_MFG_PO_CLM_DC_AWD_PO_DIST_ALL_EXT_B');
   l_info('##MASK##C_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##D_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##N_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##UOM_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '27945',
      p_sig_id                 => 'EBS_MFG_PO_CLM_DC_AWD_PO_DIST_ALL_EXT_B',
      p_sig_sql                => 'select pb.* 
from po_distributions_all_ext_b pb,
po_distributions_all pd
where  pb.po_distribution_id = pd.po_distribution_id
and pd.po_header_id = ##$$AWARDID$$##',
      p_title                  => 'PO_DISTRIBUTIONS_ALL_EXT_B for Award',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.
',
      p_solution               => '',
      p_success_msg            => 'Award data from PO_DISRIBUTIONS_ALL_EXT_B.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_CLM_DC_AWD_PO_DIST_ALL_EXT_B');



debug('begin add_signature: CLM_DC_AWD_PO_HEADERS_DRAFT_ALL');
   l_info('##MASK##EMAIL_ADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FAX'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8828',
      p_sig_id                 => 'CLM_DC_AWD_PO_HEADERS_DRAFT_ALL',
      p_sig_sql                => 'select * from po_headers_draft_all
where po_header_id = ##$$AWARDID$$##',
      p_title                  => 'PO_HEADERS_DRAFT_ALL for Award',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Award data from PO_HEADERS_DRAFT_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_AWD_PO_HEADERS_DRAFT_ALL');



debug('begin add_signature: CLM_DC_AWD_PO_LINES_DRAFT_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8829',
      p_sig_id                 => 'CLM_DC_AWD_PO_LINES_DRAFT_ALL',
      p_sig_sql                => 'select * from po_lines_draft_all
where po_header_id = ##$$AWARDID$$##',
      p_title                  => 'PO_LINES_DRAFT_ALL for Award',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Award data from PO_LINES_DRAFT_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_AWD_PO_LINES_DRAFT_ALL');



debug('begin add_signature: CLM_DC_AWD_PO_LINE_LOCATIONS_DRAFT_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8830',
      p_sig_id                 => 'CLM_DC_AWD_PO_LINE_LOCATIONS_DRAFT_ALL',
      p_sig_sql                => 'select * from po_line_locations_draft_all
where po_header_id = ##$$AWARDID$$##',
      p_title                  => 'PO_LINE_LOCATIONS_DRAFT_ALL for Award',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found.
No action is required, informational purposes only.
',
      p_solution               => '',
      p_success_msg            => 'Award data from PO_LINE_LOCATIONS_DRAFT_ALL. 
No action is required, informational purposes only.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_AWD_PO_LINE_LOCATIONS_DRAFT_ALL');



debug('begin add_signature: CLM_DC_AWD_PO_DISTRIBUTIONS_DRAFT_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8831',
      p_sig_id                 => 'CLM_DC_AWD_PO_DISTRIBUTIONS_DRAFT_ALL',
      p_sig_sql                => 'select * from po_distributions_draft_all
where po_header_id = ##$$AWARDID$$##',
      p_title                  => 'PO_DISTRIBUTIONS_DRAFT_ALL for Award',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Award data from PO_DISTRIBUTIONS_DRAFT_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_AWD_PO_DISTRIBUTIONS_DRAFT_ALL');



debug('begin add_signature: CLM_DC_AWD_PO_REQUISITION_HEADERS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8818',
      p_sig_id                 => 'CLM_DC_AWD_PO_REQUISITION_HEADERS_ALL',
      p_sig_sql                => 'select porh.* 
from po_requisition_headers_all porh,
po_requisition_lines_all porl, 
po_line_locations_all pll
...
and porl.line_location_id = pll.line_location_id
and pll.po_header_id= ##$$AWARDID$$##',
      p_title                  => 'PO_REQUISITION_HEADERS_ALL for Award',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Award data for PO_REQUISITION_HEADERS_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_AWD_PO_REQUISITION_HEADERS_ALL');



debug('begin add_signature: CLM_DC_AWD_PO_REQUISITION_LINES_ALL');
   l_info('##MASK##REQUESTER_EMAIL'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##REQUESTER_PHONE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8819',
      p_sig_id                 => 'CLM_DC_AWD_PO_REQUISITION_LINES_ALL',
      p_sig_sql                => 'select porl.* 
from po_requisition_headers_all porh,
po_requisition_lines_all porl, 
po_line_locations_all pll
...
and porl.line_location_id = pll.line_location_id
and pll.po_header_id= ##$$AWARDID$$##',
      p_title                  => 'PO_REQUISITION_LINES_ALL for Award',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Award data for PO_REQUISITION_LINES_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_AWD_PO_REQUISITION_LINES_ALL');



debug('begin add_signature: CLM_DC_AWD_PO_REQ_DISTRIBUTIONS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8820',
      p_sig_id                 => 'CLM_DC_AWD_PO_REQ_DISTRIBUTIONS_ALL',
      p_sig_sql                => 'select pord.* from 
po_req_distributions_all pord, 
po_requisition_lines_all porl,
po_line_locations_all pll
...
and porl.line_location_id = pll.line_location_id 
and pll.po_header_id = ##$$AWARDID$$##',
      p_title                  => 'PO_REQ_DISTRIBUTIONS_ALL for Award',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Award data from PO_REQ_DISTRIBUTIONS_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_AWD_PO_REQ_DISTRIBUTIONS_ALL');



debug('begin add_signature: CLM_DC_PAR_PO_DRAFTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8931',
      p_sig_id                 => 'CLM_DC_PAR_PO_DRAFTS',
      p_sig_sql                => 'select *
from po_drafts
where document_id = ##$$PARHDRID$$##',
      p_title                  => 'PO_DRAFTS for PAR',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'PAR data from PO_DRAFTS.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_PAR_PO_DRAFTS');



debug('begin add_signature: CLM_DC_PAR_PO_LINES_DRAFT_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8952',
      p_sig_id                 => 'CLM_DC_PAR_PO_LINES_DRAFT_ALL',
      p_sig_sql                => 'select pold.*
from po_lines_draft_all pold,
 po_drafts pod
where pold.draft_id = pod.draft_id
and pod.document_id = ##$$PARHDRID$$##
and pod.draft_type = ''PAR''
order by pold.draft_id',
      p_title                  => 'PO_LINES_DRAFT_ALL for PAR',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'PAR data from PO_LINES_DRAFT_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_PAR_PO_LINES_DRAFT_ALL');



debug('begin add_signature: CLM_DC_MOD_PO_DRAFTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8934',
      p_sig_id                 => 'CLM_DC_MOD_PO_DRAFTS',
      p_sig_sql                => 'select * from po_drafts
where draft_id = ##$$MODDRAFTID$$##',
      p_title                  => 'PO_DRAFTS for Modification',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Modification data from PO_DRAFTS.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_MOD_PO_DRAFTS');



debug('begin add_signature: CLM_DC_MOD_PO_HDR_DRAFTS_ALL');
   l_info('##MASK##EMAIL_ADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FAX'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8932',
      p_sig_id                 => 'CLM_DC_MOD_PO_HDR_DRAFTS_ALL',
      p_sig_sql                => 'select * from po_headers_draft_all
where draft_id = ##$$MODDRAFTID$$##',
      p_title                  => 'PO_HEADERS_DRAFT_ALL for Modification',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Modification data from PO_HEADERS_DRAFT_ALL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_MOD_PO_HDR_DRAFTS_ALL');



debug('begin add_signature: CLM_DC_MOD_PO_LINES_DRAFT_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8933',
      p_sig_id                 => 'CLM_DC_MOD_PO_LINES_DRAFT_ALL',
      p_sig_sql                => 'select * from po_lines_draft_all
where draft_id = ##$$MODDRAFTID$$##',
      p_title                  => 'PO_LINES_DRAFT_ALL for Modification',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Modification data from PO_LINES_DRAFT_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_MOD_PO_LINES_DRAFT_ALL');



debug('begin add_signature: CLM_DC_MOD_PO_LINE_LOCATIONS_DRAFT_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8935',
      p_sig_id                 => 'CLM_DC_MOD_PO_LINE_LOCATIONS_DRAFT_ALL',
      p_sig_sql                => 'select * from po_line_Locations_draft_ALL
where draft_id = ##$$MODDRAFTID$$##',
      p_title                  => 'PO_LINE_LOCATIONS_DRAFT_ALL for Modification',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Modification data from PO_LINE_LOCATIONS_DRAFT_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_MOD_PO_LINE_LOCATIONS_DRAFT_ALL');



debug('begin add_signature: CLM_DC_MOD_PO_DISTRIBUTIONS_DRAFTS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8936',
      p_sig_id                 => 'CLM_DC_MOD_PO_DISTRIBUTIONS_DRAFTS_ALL',
      p_sig_sql                => 'select * from po_distributions_draft_ALL
where draft_id = ##$$MODDRAFTID$$##',
      p_title                  => 'PO_DISTRIBUTIONS_DRAFTS_ALL for Modification',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Modification data from PO_DISTRIBUTIONS_DRAFTS_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_MOD_PO_DISTRIBUTIONS_DRAFTS_ALL');



debug('begin add_signature: CLM_DC_MOD_PO_HEADERS_ALL_EXT_B');
   l_info('##MASK##C_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##D_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##N_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##UOM_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '8937',
      p_sig_id                 => 'CLM_DC_MOD_PO_HEADERS_ALL_EXT_B',
      p_sig_sql                => 'select phb.* 
from PO_HEADERS_ALL_EXT_B phb,
po_headers_draft_all phd,
po_drafts pod
where phd.draft_id = ##$$MODDRAFTID$$##
and pod.draft_id = phd.draft_id
and phd.uda_template_id = phb.uda_template_id
and phb.draft_id = pod.draft_id
and pod.draft_id = ##$$MODDRAFTID$$##
and phb.po_header_id = pod.document_id',
      p_title                  => 'PO_HEADERS_ALL_EXT_B for  Modification',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Modification data for PO_HEADERS_ALL_EXT_B.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_MOD_PO_HEADERS_ALL_EXT_B');



debug('begin add_signature: CLM_DC_MOD_PO_LINES_ALL_EXT_B');
   l_info('##MASK##C_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##D_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##N_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##UOM_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '8938',
      p_sig_id                 => 'CLM_DC_MOD_PO_LINES_ALL_EXT_B',
      p_sig_sql                => 'select pb.* 
from po_lines_all_ext_b pb, 
po_lines_draft_all pl
where pl.po_line_id = pb.po_line_id
and pl.draft_id = ##$$MODDRAFTID$$##',
      p_title                  => 'PO_LINES_ALL_EXT_B for Modification',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.
',
      p_solution               => '',
      p_success_msg            => 'Modification data from PO_LINES_ALL_EXT_B.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_MOD_PO_LINES_ALL_EXT_B');



debug('begin add_signature: CLM_DC_MOD_PO_LINE_LOCATIONS_ALL_EXT_B');
   l_info('##MASK##C_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##D_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##N_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##UOM_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '8939',
      p_sig_id                 => 'CLM_DC_MOD_PO_LINE_LOCATIONS_ALL_EXT_B',
      p_sig_sql                => 'select pb.* 
from po_line_locations_all_ext_b pb,
po_line_locations_draft_all pll
where  pb.line_location_id = pll.line_location_id
and pll.draft_id = ##$$MODDRAFTID$$##',
      p_title                  => 'PO_LINE_LOCATIONS_ALL_EXT_B for Modification',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Modification data from PO_LINE_LOCATIONS_ALL_EXT_B.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_MOD_PO_LINE_LOCATIONS_ALL_EXT_B');



debug('begin add_signature: CLM_DC_AMEND_PO_REQUISITION_HEADERS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8956',
      p_sig_id                 => 'CLM_DC_AMEND_PO_REQUISITION_HEADERS_ALL',
      p_sig_sql                => 'select prh.* 
from po_requisition_headers_all prh
where prh.requisition_header_id = ##$$AMENDID$$##',
      p_title                  => 'PO_REQUISITION_HEADERS_ALL for Amendment',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found. No action is required, informational purposes only. ',
      p_solution               => '',
      p_success_msg            => 'Amendment data from PO_REQUISITION_HEADERS_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_AMEND_PO_REQUISITION_HEADERS_ALL');



debug('begin add_signature: CLM_DC_AMEND_PO_REQUISITION_LINES_ALL');
   l_info('##MASK##REQUESTER_EMAIL'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##REQUESTER_PHONE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8958',
      p_sig_id                 => 'CLM_DC_AMEND_PO_REQUISITION_LINES_ALL',
      p_sig_sql                => 'select prl.* 
from po_requisition_lines_all prl
where prl.requisition_header_id = ##$$AMENDID$$##',
      p_title                  => 'PO_REQUISITION_LINES_ALL for Amendment',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found. No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Amendment data from PO_REQUISITION_LINES_ALL.
No action is required, informational purposes only.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_AMEND_PO_REQUISITION_LINES_ALL');



debug('begin add_signature: CLM_DC_AMEND_PO_REQ_DISTRIBUTIONS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8957',
      p_sig_id                 => 'CLM_DC_AMEND_PO_REQ_DISTRIBUTIONS_ALL',
      p_sig_sql                => 'select prd.* 
from 
po_requisition_lines_all prl, 
po_requisition_headers_all prh,
...
prl.requisition_header_id = ##$$AMENDID$$##',
      p_title                  => 'PO_REQ_DISTRIBUTIONS_ALL for Amendment',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found. No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Amendment data from PO_REQ_DISTRIBUTIONS_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_AMEND_PO_REQ_DISTRIBUTIONS_ALL');



debug('begin add_signature: CLM_DC_AMEND_PO_HEADERS_ALL');
   l_info('##MASK##EMAIL_ADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FAX'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8959',
      p_sig_id                 => 'CLM_DC_AMEND_PO_HEADERS_ALL',
...
FROM po_requisition_headers_all prh,
  ...
  WHERE prh.federal_flag                          = ''Y''
  AND prh.revision_num                           IS NULL
  AND NVL(prh.authorization_status, ''INCOMPLETE'') =''APPROVED''
  AND prh.requisition_header_id                   = prla.requisition_header_id
  AND prh.requisition_header_id                   = prla2.requisition_header_id
  AND prla2.line_location_id                      = pll.line_location_id
  AND pll.po_header_id                            = pha.po_header_id
  AND pll.po_release_id                           = pra.po_release_id (+)
  AND prla.org_id                                 = req_fsp.org_id
  AND ( (prla.amendment_type                                  = ''CHANGED''
  AND prla.amendment_status                                  IN (''N'',''P'')
  AND ( prla.requisition_line_id                              = prla2.requisition_line_id
  OR prla.group_line_id                                      IS NOT NULL
  AND prla2.requisition_line_id                               = prla.group_line_id
  AND prla.CLM_INFO_FLAG                                      = ''Y'' ) )
  OR (prla.amendment_type                                     = ''ADDED'')
  AND prla.amendment_status                                  IN (''N'',''P'')
  AND prla.group_line_id                                     IS NOT NULL)
  AND prh.requisition_header_id in
  (select prh2.conformed_header_id 
  from po_requisition_headers_all prh2
where prh2.requisition_header_id = ##$$AMENDID$$##)',
      p_title                  => 'PO_HEADERS_ALL for Amendment',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found. No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Amendment data for PO_HEADERS_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_AMEND_PO_HEADERS_ALL');



debug('begin add_signature: CLM_DC_AMEND_PO_LINES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8960',
      p_sig_id                 => 'CLM_DC_AMEND_PO_LINES_ALL',
...
FROM po_requisition_headers_all prh,
  ...
  AND prh.requisition_header_id in
    ...
    from po_requisition_headers_all prh2
  where prh2.requisition_header_id =  ##$$AMENDID$$##)',
      p_title                  => 'PO_LINES_ALL for Amendment',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found. No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Amendment data for PO_LINES_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_AMEND_PO_LINES_ALL');



debug('begin add_signature: CLM_DC_AMEND_PO_LINE_LOCATIONS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8961',
      p_sig_id                 => 'CLM_DC_AMEND_PO_LINE_LOCATIONS_ALL',
      p_sig_sql                => 'select pll.*
FROM po_requisition_headers_all prh,
    po_requisition_lines_all prla,
    po_requisition_lines_all prla2,
  ...
  AND prh.requisition_header_id in
    ...
    from po_requisition_headers_all prh2
  where prh2.requisition_header_id = ##$$AMENDID$$##)',
      p_title                  => 'PO_LINE_LOCATIONS_ALL for Amendment',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found. No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Amendment data from PO_LINE_LOCATIONS_ALL.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_AMEND_PO_LINE_LOCATIONS_ALL');



debug('begin add_signature: CLM_DC_AMEND_PO_DISTRIBUTIONS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8962',
      p_sig_id                 => 'CLM_DC_AMEND_PO_DISTRIBUTIONS_ALL',
      p_sig_sql                => 'select pod.*
FROM po_requisition_headers_all prh,
    po_requisition_lines_all prla,
    po_requisition_lines_all prla2,
  ...
  AND prh.requisition_header_id in
    ...
    from po_requisition_headers_all prh2
  where prh2.requisition_header_id = ##$$AMENDID$$##)',
      p_title                  => 'PO_DISTRIBUTIONS_ALL for Amendment',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found. No action is required, informational purposes only.
',
      p_solution               => '',
      p_success_msg            => 'Amendment data from PO_ACTION_HISTORY.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_AMEND_PO_DISTRIBUTIONS_ALL');



debug('begin add_signature: CLM_DC_AMEND_PO_ACTION_HISTORY_FOR_REQ');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8963',
      p_sig_id                 => 'CLM_DC_AMEND_PO_ACTION_HISTORY_FOR_REQ',
      p_sig_sql                => 'select ppf.person_id, pah.*
from po_action_history pah, per_all_people_f ppf
where pah.employee_id = ppf.person_id
and object_id = ##$$AMENDID$$##
and object_type_code = ''REQUISITION''
order by pah.sequence_num asc',
      p_title                  => 'PO_ACTION_HISTORY for Amendment',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found. No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Amendment data from PO_ACTION_HISTORY.
No action is required, informational purposes only.',
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_AMEND_PO_ACTION_HISTORY_FOR_REQ');



debug('begin add_signature: CLM_DC_GL_AWARD_BUDGET_ACCOUNT');
   l_info('##MASK##FUNDING_BUDGET_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8967',
      p_sig_id                 => 'CLM_DC_GL_AWARD_BUDGET_ACCOUNT',
      p_sig_sql                => 'SELECT decode(ba.ENTRY_CODE, ''E'', ''Entered'', ''C'', ''Calculated'', ba.ENTRY_CODE) ASSIGN_TYPE, 
ba.CURRENCY_CODE, 
ba.LEDGER_ID, 
ba.BUDGET_ENTITY_ID, 
ba.CODE_COMBINATION_ID,  
glv.concatenated_segments,
ba.RANGE_ID, 
decode(bco.funds_check_level_code, ''D'', ''Advisory'', ''B'', ''Absolute'', ''N'', ''None'', bco.funds_check_level_code)  Funds_Chk_Lvl, 
bco.SHOW_AMOUNT_TYPE, 
bco.show_boundary, 
bco.funding_budget_name
FROM 
GL_BUDGET_ASSIGNMENTS_V ba,
GL_BUDORG_BC_OPTIONS_V bco,
gl_code_combinations_kfv glv
WHERE BA.RANGE_ID = BCO.RANGE_ID
AND BA.BUDGET_ENTITY_ID = 
  (SELECT BUDGET_ENTITY_ID FROM GL_BUDGET_ENTITIES GBE
   WHERE GBE.LEDGER_ID = (select set_of_books_id from financials_system_params_all fsp, po_headers_all poh
                          where poh.org_id = fsp.org_id
                          and poh.po_header_id =  ##$$AWARDID$$##)
   AND GBE.STATUS_CODE = ''C''
   and ba.budget_entity_id = gbe.budget_entity_id) 
and ba.code_combination_id
in (select distinct budget_account_id
    from po_distributions_all pod, 
    po_headers_all poh
    where poh.po_header_id = pod.po_header_id 
    and pod.po_header_id =  ##$$AWARDID$$##
and ba.code_combination_id = glv.code_combination_id)
order by ba.ordering_value, ba.code_combination_id',
      p_title                  => 'GL_BUDGET_ASSIGNMENTS for Award',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Budget Account for the Award.
No Action is required. Informational Only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_GL_AWARD_BUDGET_ACCOUNT');



debug('begin add_signature: CLM_DC_GL_AWARD_PO_BC_DISTRIBUTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8969',
      p_sig_id                 => 'CLM_DC_GL_AWARD_PO_BC_DISTRIBUTIONS',
      p_sig_sql                => 'SELECT *
FROM   PO_BC_DISTRIBUTIONS
WHERE  JE_SOURCE_NAME = ''Purchasing''
       AND JE_CATEGORY_NAME = ''Purchases''
       AND HEADER_ID = ##$$AWARDID$$##
ORDER BY packet_id',
      p_title                  => 'PO_BC_DISTRIBUTIONS for Award',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. No action is required, informational purposes only.
',
      p_solution               => '',
      p_success_msg            => 'Award Data for PO_BC_DISTRIBUTIONS.
No action is required, informational purposes only. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_GL_AWARD_PO_BC_DISTRIBUTIONS');



debug('begin add_signature: CLM_DC_GL_AWARD_XLA_AE_HEADERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8970',
      p_sig_id                 => 'CLM_DC_GL_AWARD_XLA_AE_HEADERS',
      p_sig_sql                => 'select xh.*
  from xla.xla_transaction_entities xt,
       xla_events xe,
       xla_ae_headers xh
 where xt.application_id = 201
   and xt.entity_code = ''PURCHASE_ORDER'' 
   and xt.source_id_int_1 = ##$$AWARDID$$##
   and xe.application_id = xt.application_id
   and xe.entity_id = xt.entity_id
   and xh.event_id = xe.event_id',
      p_title                  => 'XLA_AE_HEADERS for Award',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. No action is required, informational purposes only.
',
      p_solution               => '',
      p_success_msg            => 'Award Data from XLA_AE_HEADERS.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_GL_AWARD_XLA_AE_HEADERS');



debug('begin add_signature: CLM_DC_GL_AWARD_XLA_AE_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8971',
      p_sig_id                 => 'CLM_DC_GL_AWARD_XLA_AE_LINES',
      p_sig_sql                => 'select xl.*
  from xla.xla_transaction_entities xt,
       xla_events xe,
       xla_ae_headers xh,
 ...
 where xt.application_id = 201
   ...
   and xe.entity_id = xt.entity_id
   and xh.event_id = xe.event_id',
      p_title                  => 'XLA_AE_LINES for Award',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found.
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Award data from XLA_AE_LINES.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_GL_AWARD_XLA_AE_LINES');



debug('begin add_signature: CLM_DC_GL_AWARD_XLA_EVENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8972',
      p_sig_id                 => 'CLM_DC_GL_AWARD_XLA_EVENTS',
      p_sig_sql                => 'select xe.*
  from xla.xla_transaction_entities xt,
       xla_events xe,
       xla_ae_headers xh,
 ...
 where xt.application_id = 201
   ...
   and xe.entity_id = xt.entity_id
   and xh.event_id = xe.event_id',
      p_title                  => 'XLA_AE_EVENTS for Award',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found.
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Award data from XLA_AE_EVENTS. 
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_GL_AWARD_XLA_EVENTS');



debug('begin add_signature: CLM_DC_GL_REQ_BUDGET_ACCOUNT');
   l_info('##MASK##FUNDING_BUDGET_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8968',
      p_sig_id                 => 'CLM_DC_GL_REQ_BUDGET_ACCOUNT',
      p_sig_sql                => 'SELECT decode(ba.ENTRY_CODE, ''E'', ''Entered'', ''C'', ''Calculated'', ba.ENTRY_CODE) ASSIGN_TYPE, 
ba.CURRENCY_CODE, 
ba.LEDGER_ID, 
ba.BUDGET_ENTITY_ID, 
...
AND BA.BUDGET_ENTITY_ID = 
  (SELECT BUDGET_ENTITY_ID FROM GL_BUDGET_ENTITIES GBE
   WHERE GBE.LEDGER_ID = (select fsp.set_of_books_id from financials_system_params_all fsp, po_requisition_headers_all prh
                          where prh.requisition_header_id = ##$$REQHDRID$$##
...
in (select distinct budget_account_id
    ...
    and prl.requisition_header_id = ##$$REQHDRID$$##)
and ba.code_combination_id = glv.code_combination_id 
order by ba.ordering_value, ba.code_combination_id',
      p_title                  => 'GL_BUDGET_ENTITIES for Requisition',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Requisition Budget Account information.
No action is required. Informational only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_GL_REQ_BUDGET_ACCOUNT');



debug('begin add_signature: CLM_DC_GL_REQ_PO_BC_DISTRIBUTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8964',
      p_sig_id                 => 'CLM_DC_GL_REQ_PO_BC_DISTRIBUTIONS',
      p_sig_sql                => 'SELECT *
FROM PO_BC_DISTRIBUTIONS
WHERE JE_SOURCE_NAME = ''Purchasing''
AND JE_CATEGORY_NAME = ''Requisitions''
AND HEADER_ID = ##$$REQHDRID$$##',
      p_title                  => 'PO_BC_DISTRIBUTIONS for Requisition',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found. No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Requisition data from PO_BC_DISTRIBUTIONS.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_GL_REQ_PO_BC_DISTRIBUTIONS');



debug('begin add_signature: CLM_DC_GL_REQ_XLA_AE_HEADERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8965',
      p_sig_id                 => 'CLM_DC_GL_REQ_XLA_AE_HEADERS',
      p_sig_sql                => 'select xh.*
  from xla.xla_transaction_entities xt,
       xla_events xe,
       xla_ae_headers xh
 where xt.application_id = 201
   and xt.entity_code = ''REQUISITION'' 
   and xt.source_id_int_1 = ##$$REQHDRID$$##
   and xe.application_id = xt.application_id
   and xe.entity_id = xt.entity_id
   and xh.event_id = xe.event_id',
      p_title                  => 'XLA_AE_HEADERS for Requisition',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found. No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Award data from XLA_AE_HEADERS.
No action is required, informational purposes only.',
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_GL_REQ_XLA_AE_HEADERS');



debug('begin add_signature: CLM_DC_GL_REQ_XLA_AE_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8966',
      p_sig_id                 => 'CLM_DC_GL_REQ_XLA_AE_LINES',
      p_sig_sql                => 'select xl.*
  from xla.xla_transaction_entities xt,
       xla_events xe,
       xla_ae_headers xh,
 ...
 where xt.application_id = 201
   ...
   and xe.entity_id = xt.entity_id
   and xh.event_id = xe.event_id',
      p_title                  => 'XLA_AE_LINES for Requisition',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found. No Action is required. Informational Only.',
      p_solution               => '',
      p_success_msg            => 'The XLA_AE_LINES information for the requisition was able to be selected.
No Action is required. Informational Only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_GL_REQ_XLA_AE_LINES');
...
debug('begin add_signature: CLM_DC_REQ_REQ_UDA_DISTRIBUTIONS');
   l_info('##MASK##C_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##D_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##N_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##UOM_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '8609',
      p_sig_id                 => 'CLM_DC_REQ_REQ_UDA_DISTRIBUTIONS',
      p_sig_sql                => 'select pord.* 
from PO_REQ_DISTRIBUTIONS_EXT_B pord
where pord.distribution_id  in 
(select distribution_id 
 from po_req_distributions_all pord2,
      po_requisition_lines_all porl
      where pord2.requisition_line_id = porl.requisition_line_id
      and porl.requisition_header_id = ##$$REQHDRID$$##)',
      p_title                  => 'PO_REQ_DISTRIBUTIONS_EXT_B for UDA',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.
',
      p_solution               => '',
      p_success_msg            => 'Requisition data from PO_REQ_DISTRIBUTIONS_EXT_B.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_REQ_REQ_UDA_DISTRIBUTIONS');



debug('begin add_signature: CLM_DC_REQ_REQ_UDA_HEADER');
   l_info('##MASK##C_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##D_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##N_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##UOM_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '8607',
      p_sig_id                 => 'CLM_DC_REQ_REQ_UDA_HEADER',
      p_sig_sql                => 'select porh.* 
from PO_REQ_HEADERS_EXT_B porh
where porh.requisition_header_id = ##$$REQHDRID$$##',
      p_title                  => 'PO_REQ_HEADERS_EXT_B for UDA',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.
',
      p_solution               => '',
      p_success_msg            => 'Requisition data from PO_REQ_HEADERS_EXT_B.
No action is required, informational purposes only.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_REQ_REQ_UDA_HEADER');



debug('begin add_signature: CLM_DC_REQ_REQ_UDA_LINES');
   l_info('##MASK##C_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##D_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##N_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##UOM_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '8608',
      p_sig_id                 => 'CLM_DC_REQ_REQ_UDA_LINES',
      p_sig_sql                => 'select porl.* 
from PO_REQ_LINES_EXT_B porl
where porl.requisition_line_id in 
    (select requisition_line_id 
     from po_requisition_lines_all 
     where requisition_header_id = ##$$REQHDRID$$##)',
      p_title                  => 'PO_REQ_LINES_EXT_B for UDA',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found. 
No action is required, informational purposes only.',
      p_solution               => '',
      p_success_msg            => 'Requisition data from PO_REQ_LINES_EXT_B.
No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CLM_DC_REQ_REQ_UDA_LINES');
...
start_section('Recommended Patches', 'Recommended_Patches');
   set_item_result(check_rec_patches_1); /* Signature CLM_RECOMMENDED_PATCHES */
   IF substr(g_sql_tokens('##$$FWK$$##'),1,3) = 'C.12' THEN
      set_item_result(check_rec_patches_2); /* Signature EBS_ATG_FWK_C12 */
   END IF;
   IF substr(g_sql_tokens('##$$FWK$$##'),1,1) = 'B'	 THEN
      set_item_result(check_rec_patches_3); /* Signature FWK_B */
   END IF;
   IF substr(g_sql_tokens('##$$FWK$$##'),1,3) = 'C.10' THEN
      set_item_result(check_rec_patches_4); /* Signature FWK_C10 */
   END IF;
   IF substr(g_sql_tokens('##$$FWK$$##'),1,3) = 'C.11' THEN
      set_item_result(check_rec_patches_5); /* Signature FWK_C11 */
   END IF;
   IF substr(g_sql_tokens('##$$FWK$$##'),1,3) = 'C.4'	 THEN
      set_item_result(check_rec_patches_6); /* Signature FWK_C4 */
   END IF;
   IF substr(g_sql_tokens('##$$FWK$$##'),1,3) = 'C.5'	 THEN
      set_item_result(check_rec_patches_7); /* Signature FWK_C5 */
   END IF;
   IF substr(g_sql_tokens('##$$FWK$$##'),1,3) = 'C.6'	 THEN
      set_item_result(check_rec_patches_8); /* Signature FWK_C6 */
   END IF;
   IF substr(g_sql_tokens('##$$FWK$$##'),1,3) = 'C.7' THEN
      set_item_result(check_rec_patches_9); /* Signature FWK_C7 */
   END IF;
   IF substr(g_sql_tokens('##$$FWK$$##'),1,3) = 'C.8' THEN
      set_item_result(check_rec_patches_10); /* Signature FWK_C8 */
   END IF;
   IF substr(g_sql_tokens('##$$FWK$$##'),1,3) = 'C.9' THEN
      set_item_result(check_rec_patches_11); /* Signature FWK_C9 */
   END IF;
end_section;
debug('end section: Recommended_Patches');

debug('begin section: Setups');
start_section('Setups', 'Setups');
   set_item_result(run_stored_sig('CLM_SETUP_COMPILE_ATTRIBUTE_TEMPLATES'));
   set_item_result(run_stored_sig('CLM_SETUP_DOC_TYPE_ARCHIVE_METHOD_MISSING'));
   set_item_result(run_stored_sig('CLM_SETUP_ENABLED_PROFILE_CHECK'));
   set_item_result(run_stored_sig('CLM_SETUP_FPDS_CHECKS'));
   set_item_result(run_stored_sig('CLM_SETUP_LOOKUP_CODE'));
end_section;
debug('end section: Setups');

debug('begin section: Requisition_Related_Table_Details');
IF g_sql_tokens('##$$p_req_num$$##') IS NOT NULL THEN
   start_section('Requisition', 'Requisition_Related_Table_Details');
      IF p_pull_ext = 'Y' THEN
         set_item_result(run_stored_sig('CLM_DC_REQ_REQ_UDA_DISTRIBUTIONS'));
         set_item_result(run_stored_sig('CLM_DC_REQ_REQ_UDA_HEADER'));
         set_item_result(run_stored_sig('CLM_DC_REQ_REQ_UDA_LINES'));
      END IF;
      set_item_result(run_stored_sig('CLM_DC_REQ_REQ_HDR'));
      set_item_result(run_stored_sig('CLM_DC_REQ_REQ_LINES'));
      set_item_result(run_stored_sig('CLM_DC_REQ_REQ_DISTRIBUTIONS'));
      set_item_result(run_stored_sig('CLM_DC_REQ_ACTION_HISTORY_1'));
      set_item_result(run_stored_sig('CLM_DC_REQ_PON_HDR'));
      set_item_result(run_stored_sig('CLM_DC_REQ_PON_LINE'));
      set_item_result(run_stored_sig('CLM_DC_REQ_AWARD_PO_HEADERS'));
      set_item_result(run_stored_sig('CLM_DC_REQ_AWARD_PO_LINES'));
      set_item_result(run_stored_sig('CLM_DC_REQ_AWARD_PO_LINE_LOCATIONS'));
      set_item_result(run_stored_sig('CLM_DC_REQ_AWARD_PO_DISTRIBUTIONS'));
   end_section('Requisition information was selected.');
END IF;
debug('end section: Requisition_Related_Table_Details');

debug('begin section: Solicitation_Related_Table_Details');
IF g_sql_tokens('##$$p_sol_num$$##') IS NOT NULL THEN
   start_section('Solicitation', 'Solicitation_Related_Table_Details');
      set_item_result(run_stored_sig('CLM_DC_SOL_PON_HDR'));
      set_item_result(run_stored_sig('CLM_DC_SOL_PON_AUCTION_ITEM_PRICES'));
      set_item_result(run_stored_sig('CLM_DC_SOL_PON_AUCTION_HEADERS_EXT'));
      set_item_result(run_stored_sig('CLM_DC_SOL_PON_AUCTION_ITEM_PRICES_EXT'));
      set_item_result(run_stored_sig('CLM_DC_SOL_PO_REQ_HDRS'));
      set_item_result(run_stored_sig('CLM_DC_SOL_PO_REQ_LINES'));
      set_item_result(run_stored_sig('CLM_DC_SOL_PO_REQ_DIST'));
      set_item_result(run_stored_sig('CLM_DC_SOL_PO_HDRS'));
      set_item_result(run_stored_sig('CLM_DC_SOL_PO_LINES'));
      set_item_result(run_stored_sig('CLM_DC_SOL_PO_LINE_LOCATIONS'));
      set_item_result(run_stored_sig('CLM_DC_SOL_PO_DIST'));
   end_section('Solicitation Information was selected.');
END IF;
debug('end section: Solicitation_Related_Table_Details');

debug('begin section: Award_Related_Table_Details');
IF g_sql_tokens('##$$p_award_num$$##') IS NOT NULL THEN
   start_section('Award', 'Award_Related_Table_Details');
      set_item_result(run_stored_sig('CLM_DC_AWD_PO_HEADERS_ALL'));
      set_item_result(run_stored_sig('CLM_DC_AWD_PO_LINES_ALL'));
      set_item_result(run_stored_sig('CLM_DC_AWD_PO_LINE_LOCATIONS_ALL'));
      set_item_result(run_stored_sig('CLM_DC_AWD_PO_DISTRIBUTIONS_ALL'));
      set_item_result(run_stored_sig('EBS_MFG_PO_CLM_DC_AWD_ACTION_HISTORY_1'));
      set_item_result(run_stored_sig('CLM_DC_AWD_PO_HEADERS_ARCHIVE_ALL'));
      set_item_result(run_stored_sig('CLM_DC_AWD_PO_LINES_ARCHIVE_ALL'));
      set_item_result(run_stored_sig('CLM_DC_AWD_PO_LINE_LOCATIONS_ARCHIVE_ALL'));
      set_item_result(run_stored_sig('CLM_DC_AWD_PO_DISTRIBUTIONS_ARCHIVE_ALL'));
      set_item_result(run_stored_sig('CLM_DC_AWD_PO_HEADERS_ALL_EXT_B'));
      set_item_result(run_stored_sig('CLM_DC_AWD_PO_LINES_ALL_EXT_B'));
      set_item_result(run_stored_sig('CLM_DC_AWD_PO_LINES_LOCATIONS_ALL_EXT_B'));
      set_item_result(run_stored_sig('EBS_MFG_PO_CLM_DC_AWD_PO_DIST_ALL_EXT_B'));
      set_item_result(run_stored_sig('CLM_DC_AWD_PO_HEADERS_DRAFT_ALL'));
      set_item_result(run_stored_sig('CLM_DC_AWD_PO_LINES_DRAFT_ALL'));
      set_item_result(run_stored_sig('CLM_DC_AWD_PO_LINE_LOCATIONS_DRAFT_ALL'));
      set_item_result(run_stored_sig('CLM_DC_AWD_PO_DISTRIBUTIONS_DRAFT_ALL'));
      set_item_result(run_stored_sig('CLM_DC_AWD_PO_REQUISITION_HEADERS_ALL'));
      set_item_result(run_stored_sig('CLM_DC_AWD_PO_REQUISITION_LINES_ALL'));
      set_item_result(run_stored_sig('CLM_DC_AWD_PO_REQ_DISTRIBUTIONS_ALL'));
   end_section;
END IF;
debug('end section: Award_Related_Table_Details');

debug('begin section: PAR_Related_Table_Details');
IF g_sql_tokens('##$$p_par_num$$##') IS NOT NULL THEN
   start_section('Post Award Request', 'PAR_Related_Table_Details');
      set_item_result(run_stored_sig('CLM_DC_PAR_PO_DRAFTS'));
      set_item_result(run_stored_sig('CLM_DC_PAR_PO_LINES_DRAFT_ALL'));
   end_section;
END IF;
debug('end section: PAR_Related_Table_Details');

debug('begin section: MOD_Related_Table_Details');
IF g_sql_tokens('##$$p_mod_num$$##') IS NOT NULL THEN
   start_section('Modification', 'MOD_Related_Table_Details');
      set_item_result(run_stored_sig('CLM_DC_MOD_PO_DRAFTS'));
      set_item_result(run_stored_sig('CLM_DC_MOD_PO_HDR_DRAFTS_ALL'));
      set_item_result(run_stored_sig('CLM_DC_MOD_PO_LINES_DRAFT_ALL'));
      set_item_result(run_stored_sig('CLM_DC_MOD_PO_LINE_LOCATIONS_DRAFT_ALL'));
      set_item_result(run_stored_sig('CLM_DC_MOD_PO_DISTRIBUTIONS_DRAFTS_ALL'));
      set_item_result(run_stored_sig('CLM_DC_MOD_PO_HEADERS_ALL_EXT_B'));
      set_item_result(run_stored_sig('CLM_DC_MOD_PO_LINES_ALL_EXT_B'));
      set_item_result(run_stored_sig('CLM_DC_MOD_PO_LINE_LOCATIONS_ALL_EXT_B'));
   end_section;
END IF;
debug('end section: MOD_Related_Table_Details');

debug('begin section: AMENDMENT_Related_Table_Details');
IF g_sql_tokens('##$$p_amend_num$$##') IS NOT NULL THEN
   start_section('Amendment', 'AMENDMENT_Related_Table_Details');
      set_item_result(run_stored_sig('CLM_DC_AMEND_PO_REQUISITION_HEADERS_ALL'));
      set_item_result(run_stored_sig('CLM_DC_AMEND_PO_REQUISITION_LINES_ALL'));
      set_item_result(run_stored_sig('CLM_DC_AMEND_PO_REQ_DISTRIBUTIONS_ALL'));
      set_item_result(run_stored_sig('CLM_DC_AMEND_PO_HEADERS_ALL'));
      set_item_result(run_stored_sig('CLM_DC_AMEND_PO_LINES_ALL'));
      set_item_result(run_stored_sig('CLM_DC_AMEND_PO_LINE_LOCATIONS_ALL'));
      set_item_result(run_stored_sig('CLM_DC_AMEND_PO_DISTRIBUTIONS_ALL'));
      set_item_result(run_stored_sig('CLM_DC_AMEND_PO_ACTION_HISTORY_FOR_REQ'));
   end_section;
END IF;
debug('end section: AMENDMENT_Related_Table_Details');

debug('begin section: GL_Related_Table_Details');
IF g_sql_tokens('##$$p_include_gl$$##') = 'Y' THEN
   start_section('General Ledger/SLA', 'GL_Related_Table_Details');
      set_item_result(run_stored_sig('CLM_DC_GL_AWARD_BUDGET_ACCOUNT'));
      set_item_result(run_stored_sig('CLM_DC_GL_AWARD_PO_BC_DISTRIBUTIONS'));
      set_item_result(run_stored_sig('CLM_DC_GL_AWARD_XLA_AE_HEADERS'));
      set_item_result(run_stored_sig('CLM_DC_GL_AWARD_XLA_AE_LINES'));
      set_item_result(run_stored_sig('CLM_DC_GL_AWARD_XLA_EVENTS'));
      set_item_result(run_stored_sig('CLM_DC_GL_REQ_BUDGET_ACCOUNT'));
      set_item_result(run_stored_sig('CLM_DC_GL_REQ_PO_BC_DISTRIBUTIONS'));
      set_item_result(run_stored_sig('CLM_DC_GL_REQ_XLA_AE_HEADERS'));
      set_item_result(run_stored_sig('CLM_DC_GL_REQ_XLA_AE_LINES'));
   end_section;
END IF;
debug('end section: GL_Related_Table_Details');

debug('begin section: Diagnostic_Apps_Check');
IF g_sql_tokens('##$$APPS_CHECK$$##') = 'Y' THEN
   start_section('Diagnostics  Apps Check', 'Diagnostic_Apps_Check');
      ...
      set_item_result(run_stored_sig('AC_INVALID_PLSQL_FILE_VERSIONS'));
      ...
      set_item_result(run_stored_sig('AC_PLSQL_FILE_VERSIONS'));
