...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Procurement Accrual Accounting Analyzer|
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE po_accrual_analyzer_pkg AUTHID DEFINER AS
...
PROCEDURE main
(            l_operating_unit_id            IN NUMBER      DEFAULT NULL
           ,l_ledger_id                    IN NUMBER      DEFAULT NULL
           ,l_code_combination_id          IN NUMBER      DEFAULT NULL
           ,l_start_date                   IN DATE        DEFAULT NULL
           ,l_end_date                     IN DATE        DEFAULT NULL
...
END po_accrual_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY po_accrual_analyzer_pkg AS
-- $Id: po_accrual_analyzer.sql, 200.16 2026/01/28 15:25:00 pksethi Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(1969667.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'POACCRUAL_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'POACCRUAL_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>POACCRUAL Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=1969667.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/po_accrual_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,565,EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,565,EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},565,EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/3676509" class="blacklink" target="new">
...
<p>What&apos;s new in this release:</p><p>Version 200.16</p><ul><li>Minor enhancement to analyzer title format</li>
</ul>
<p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>
            <br><br>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,565,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,565,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},565,'||p_sig.sigrepo_id||',EBS,EBS MFG,EBS - Procurement" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Operating Unit ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(l_operating_unit_id,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Ledger ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(l_ledger_id,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Accrual Account ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(l_code_combination_id,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Start Date';
   g_parameters(g_parameters.LAST).pvalue := mask_text(l_start_date,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'End Date';
   g_parameters(g_parameters.LAST).pvalue := mask_text(l_end_date,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/01/28 15:24:59 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'po_accrual_analyzer.sql';
...
debug('begin parameter validation: l_operating_unit_id');
IF l_operating_unit_id IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Operating Unit ID is required.');
...
WHERE U.ORGANIZATION_ID = l_operating_unit_id
 AND 1=1
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
...
The org_id parameter is mandatory.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for l_operating_unit_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: l_operating_unit_id');

debug('begin parameter validation: l_ledger_id');
...
SELECT GL.LEDGER_ID
INTO l_exists_val
FROM GL_LEDGERS GL, HR_OPERATING_UNITS U
WHERE GL.LEDGER_ID = l_ledger_id
 AND U.SET_OF_BOOKS_ID=GL.LEDGER_ID
and U.ORGANIZATION_ID=l_operating_unit_id


 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: No Ledger specified.
The Ledger_id parameter is mandatory.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for l_ledger_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: l_ledger_id');

debug('begin parameter validation: l_code_combination_id');
IF l_code_combination_id IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Accrual Account ID is required.');
   raise invalid_parameters;
END IF;
...
INTO l_exists_val
FROM GL_CODE_COMBINATIONS_KFV GLCC,GL_LEDGERS GL, HR_OPERATING_UNITS U
WHERE GLCC.CODE_COMBINATION_ID = l_code_combination_id
 AND U.SET_OF_BOOKS_ID=GL.LEDGER_ID
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: No CONCATENATED_SEGMENTS specified.
The CONCATENATED_SEGMENTS parameter is mandatory.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for l_code_combination_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: l_code_combination_id');

debug('begin parameter validation: l_start_date');
IF l_start_date IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Start Date is required.');
   raise invalid_parameters;
END IF;
debug('end parameter validation: l_start_date');

debug('begin parameter validation: l_end_date');
IF l_end_date IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter End Date is required.');
   raise invalid_parameters;
END IF;
debug('end parameter validation: l_end_date');
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$OperatingUnit$$##') := l_operating_unit_id;
   g_masked_tokens('##$$OperatingUnit$$##') := mask_text( g_sql_tokens('##$$OperatingUnit$$##'), 'NO_MASK');
   g_sql_tokens('##$$LedgerID$$##') := l_ledger_id;
   g_masked_tokens('##$$LedgerID$$##') := mask_text( g_sql_tokens('##$$LedgerID$$##'), 'NO_MASK');
   g_sql_tokens('##$$AccrualCCID$$##') := l_code_combination_id;
   g_masked_tokens('##$$AccrualCCID$$##') := mask_text( g_sql_tokens('##$$AccrualCCID$$##'), 'NO_MASK');
...
debug('begin add_signature: INVALIDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3484',
      p_sig_id                 => 'INVALIDS',
    ...
    AND a.owner = ''APPS''
    AND (a.object_name like ''CST%'' OR
         a.object_name like ''PO%''  OR 
         a.object_name like ''XLA%707%'')
    AND a.status = ''INVALID''',
      p_title                  => 'PO or Cost Management or XLA Related Invalid Objects',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There exist invalid PO or Cost Management or XLA related objects',
      p_solution               => '<ul>
      <li> For PO or Cost Management Invalid Objects: </li>
    ...
    <li> For XLA Invalid Objects: </li>
    <li>Run Validate Application Accounting Definition program for Cost Management application and check.</li>
   </ul>',
      p_success_msg            => 'No PO or Cost Management or XLA related invalid objects exists in the database',
   ...
   l_info.delete;
debug('end add_signature: INVALIDS');



debug('begin add_signature: SELECT_ACCR_ACC');
   l_info('##SHOW_SQL##'):= 'N';
  add_signature(
      p_sig_repo_id            => '3485',
      p_sig_id                 => 'SELECT_ACCR_ACC',
      p_sig_sql                => 'SELECT * FROM cst_accrual_accounts
WHERE operating_unit_id =##$$OperatingUnit$$##
and accrual_account_id =##$$AccrualCCID$$##',
      p_title                  => 'Accrual Account Setup',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The Accrual Account is not defined in the Select Accrual Accounts form.',
      p_solution               => 'Define the accrual account in the Select Accrual Accounts form.<br>
Navigation:<br>
Purchasing Responsibility > Accounting > Accrual Write Offs > Select Accrual Account form.',
      p_success_msg            => 'The Accrual account is defined in the Select Accrual Accounts form.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: SELECT_ACCR_ACC');



debug('begin add_signature: CST_RECONCILIATION_SUMMARY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5292',
      p_sig_id                 => 'CST_RECONCILIATION_SUMMARY',
      p_sig_sql                => 'SELECT Accrual_account_id,
SUM(NVL(PO_BALANCE,0)) PO_BAL_SUM,
SUM(NVL(AP_BALANCE,0)) AP_BAL_SUM,
SUM(NVL(WRITE_OFF_BALANCE,0)) WO_AMOUNT_SUM
FROM cst_reconciliation_summary
WHERE operating_unit_id =##$$OperatingUnit$$##
AND accrual_Account_id =##$$AccrualCCID$$##
GROUP BY Accrual_account_id',
      p_title                  => 'Summary Accrual Reconciliation Report balance',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Summary Accrual Reconciliation Report balance for accrual reconciliation',
      p_solution               => 'There is no data in Summary Accrual Reconciliation Report. Please run the Accrual Reconciliation Load run program with correct date parameter and re run this report. ',
      p_success_msg            => 'The Accrual Reconciliation Summary report has the accrual balances related to all the accrual codes - AP PO, AP NO PO and Miscellaneous transactions.
Total accrual balance shown in Accrual Reconciliation Summary report should be compared with Account Analysis Report in GL for the source Cost Management with category Receiving (assuming that period end accruals have a different je category) + Source Cost Management with category Inventory and WIP + Source Payables with category Purchase Invoices.',
   ...
   l_info.delete;
debug('end add_signature: CST_RECONCILIATION_SUMMARY');



debug('begin add_signature: CST_AP_PO_RECONCILIATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5291',
      p_sig_id                 => 'CST_AP_PO_RECONCILIATION',
      p_sig_sql                => 'SELECT transaction_type_code, accrual_account_id,
DECODE(INVOICE_DISTRIBUTION_ID, NULL,
DECODE(write_off_id, NULL, ''PO'', ''WO''), ''AP''),
SUM(amount)
FROM cst_ap_po_reconciliation
WHERE operating_unit_id =##$$OperatingUnit$$##
and accrual_Account_id =##$$AccrualCCID$$##
GROUP BY transaction_type_code, accrual_account_id,
DECODE(INVOICE_DISTRIBUTION_ID, NULL,
DECODE(write_off_id, NULL, ''PO'', ''WO''), ''AP'')
',
      p_title                  => 'AP and PO Accrual Reconciliation Report balance',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'AP and PO Accrual Reconciliation Report balance for accrual reconciliation.',
      p_solution               => 'There is no data found in AP and PO Accrual Reconciliation Report,please run the Load run with correct parameter and re run the AP and PO Accrual Reconciliation Report.',
      p_success_msg            => 'The purpose of this report is to show all Oracle AP and PO transactions where the AP transactions are matched to a PO (this could be a receipt as well). The AP and PO Accrual Reconciliation report provides a transnational breakdown of each accrual account with a net balance not equal to zero in a summarized or full transaction details version. Use the balance for accrual reconciliation.
...
',
   ...
   l_info.delete;
debug('end add_signature: CST_AP_PO_RECONCILIATION');



debug('begin add_signature: CST_MISC_RECONCILIATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5293',
      p_sig_id                 => 'CST_MISC_RECONCILIATION',
      p_sig_sql                => 'SELECT build_id,
accrual_account_id,
transaction_type_code,
DECODE(inventory_transaction_id, NULL, ''AP'', ''INV''),
DECODE(NVL(po_distribution_id,0),0, ''NOPOD'', ''POD''),
...
write_off_select_Flag
',
      p_title                  => 'Miscellaneous Accrual Reconciliation Report balance',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Miscellaneous Accrual Reconciliation Report balance for accrual reconciliation. ',
      p_solution               => 'The accrual account is not used for any other miscellaneous transaction in other module.',
      p_success_msg            => 'The purpose of this report is to show all inventory and AP (not matched to PO) transactions that have hit the accrual accounts.The Misc.accrual reconciliation only show the details pertaining to Misc transactions. Please subtract this value from the Summary Accrual Reconciliation report and do the reconciliation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: CST_MISC_RECONCILIATION');



debug('begin add_signature: UNPOSTED_ACCRUAL_BAL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3492',
      p_sig_id                 => 'UNPOSTED_ACCRUAL_BAL',
      p_sig_sql                => 'SELECT gjh.je_source,gjh.je_category,
gjh.period_name,SUM(gjl.accounted_dr),SUM(gjl.accounted_cr)
FROM gl_je_headers gjh,gl_je_lines gjl
WHERE gjh.je_header_id = gjl.je_header_id
AND gjh.status = ''U''
AND gjh.je_source IN (''Cost Management'',''Payables'')
AND gjh.je_category IN (''Receiving'',''Inventory'',''WIP'',''Purchase Invoices'')
AND gjh.actual_flag = ''A''
AND code_combination_id =##$$AccrualCCID$$##
AND gjl.ledger_id =##$$LedgerID$$##
GROUP BY gjh.je_source, gjh.je_category,gjh.period_name
having gjh.period_name in (SELECT DISTINCT period_name
FROM gl_period_statuses
WHERE start_date >= ''##$$StartDATE$$##'' AND end_date<=''##$$EndDATE$$##'')',
      p_title                  => 'Unposted Accrual Balances in General Ledger(Period Range)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Unposted accrual journal balances were found in the GL.
',
      p_solution               => 'Post the journal to the GL and perform the reconciliation.',
      p_success_msg            => 'There were no unposted journals found for the source Cost Management and Payables.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: UNPOSTED_ACCRUAL_BAL');



debug('begin add_signature: POSTED_ACCRUAL_BAL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3493',
      p_sig_id                 => 'POSTED_ACCRUAL_BAL',
      p_sig_sql                => 'SELECT gjh.je_source,gjh.je_category,
gjh.period_name,
...
FROM gl_period_statuses
WHERE start_date >=''##$$StartDATE$$##'' AND end_date<= ''##$$EndDATE$$##'' )',
      p_title                  => 'Posted Accrual Balances(Period Range)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Posted balance in the GL for the source Cost Management and Payables.',
      p_solution               => 'The Accrual Reconciliation reports shows accrual balances for transactions pertaining to the source Cost Management and Payables; whereas, the Account Analysis Report shows the accrual balance pertaining to all the sources. Compare this balance with the Summary Accrual Reconciliation report balance.',
      p_success_msg            => 'There were no posted journals found in the GL. Post the unposted journals and redo the reconciliation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: POSTED_ACCRUAL_BAL');



debug('begin add_signature: SLA_BAL_PAY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3540',
      p_sig_id                 => 'SLA_BAL_PAY',
      p_sig_sql                => 'SELECT h.application_id,
h.je_category_name,
l.code_combination_id ,
SUM(NVL(l.accounted_dr,0) - NVL(l.accounted_cr,0)) DIFF
...
AND l.code_combination_id =##$$AccrualCCID$$##
AND l.accounting_date >=''##$$StartDATE$$##'' AND l.accounting_date <=''##$$EndDATE$$##''
AND l.ae_header_id = h.ae_header_id GROUP BY l.code_combination_id ,h.je_category_name,h.application_id',
      p_title                  => 'Accrual Balance In SLA For Source Payables(Period Range)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'An accrual balance was found in SLA for the source Payables.',
      p_solution               => 'Sum the accrual balance and add it to the SLA accrual balance for the source Cost Management. Then compare the total with the Summary Reconciliation Report balance.',
      p_success_msg            => 'There were no Accrual balances found in SLA for Payables.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: SLA_BAL_PAY');



debug('begin add_signature: SLA_BAL_CST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3541',
      p_sig_id                 => 'SLA_BAL_CST',
      p_sig_sql                => 'SELECT h.application_id,h.je_category_name,
l.code_combination_id ,SUM(NVL(l.accounted_dr,0) - NVL(l.accounted_cr,0)) DIFF
FROM xla_ae_lines l ,xla_ae_headers h
...
AND l.code_combination_id =##$$AccrualCCID$$##
AND l.accounting_date >=''##$$StartDATE$$##''
AND l.accounting_date <=''##$$EndDATE$$##''
AND l.ae_header_id = h.ae_header_id
GROUP BY l.code_combination_id ,h.je_category_name,h.application_id',
      p_title                  => 'Accrual Balance In SLA For Source Cost Management(Period Range)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'An accrual balance was found in SLA for the source Cost Management.',
      p_solution               => 'Sum the accrual balance and add it to the SLA accrual balance for the source Payables. Then compare the total with the Summary Reconciliation Report balance.',
      p_success_msg            => 'There were no Accrual balances found in SLA for Cost Management.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: SLA_BAL_CST');



debug('begin add_signature: LOAD_RUN_CORRECT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3542',
      p_sig_id                 => 'LOAD_RUN_CORRECT',
      p_sig_sql                => 'SELECT Build_id,operating_unit_id,From_date,To_date
FROM cst_reconciliation_build
WHERE operating_unit_id =##$$OperatingUnit$$##
AND to_date >=(SELECT distinct end_date FROM gl_period_statuses
WHERE application_id = 101 AND ledger_id =##$$LedgerID$$##
AND end_date=''##$$EndDATE$$##'')',
      p_title                  => 'The Accrual Reconciliation Load Run Execution',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Accrual Reconciliation Load Run has not run correctly',
      p_solution               => '<p>Run the Accrual Reconciliation Load Run program with the end date as the last date of the to-period, provided in the Account Analysis report.</p>
<p>See the Accrual Reconciliation Process section of [429105/KB627998] Impact of R12 Design in Procure To Pay Accounting Flow (KB627998)</p>',
      p_success_msg            => 'The Accrual Reconciliation Load Run has run correctly.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LOAD_RUN_CORRECT');



debug('begin add_signature: UPGRADED_FRESH_INSTALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3543',
      p_sig_id                 => 'UPGRADED_FRESH_INSTALL',
      p_sig_sql                => 'SELECT set_of_books_id,min(start_date),max(end_date)
FROM gl_period_statuses
WHERE migration_status_code = ''U''
AND set_of_books_id =##$$LedgerID$$##
GROUP BY set_of_books_id',
      p_title                  => 'Upgraded Instance Or Fresh Install',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Upgraded instance or Fresh install ',
      p_solution               => 'This is an upgraded instance.',
      p_success_msg            => 'This is a fresh installed instance.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: UPGRADED_FRESH_INSTALL');



debug('begin add_signature: JE_CATEGORY_RECEIVING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3544',
      p_sig_id                 => 'JE_CATEGORY_RECEIVING',
      p_sig_sql                => 'SELECT gjl.period_name,
(SUM(NVL(gjl.accounted_dr,0))- SUM(NVL(gjl.accounted_cr,0))) DIFF
FROM gl_je_lines gjl,gl_import_references gir,
xla_ae_headers h,xla_ae_lines l
...
AND h.gl_transfer_status_code = ''Y''
AND h.balance_type_code = ''A''
AND h.je_category_name = ''Receiving''
AND h.event_type_code = ''PERIOD_END_ACCRUAL''
AND l.accounting_date >=''##$$StartDATE$$##''
AND l.accounting_date <=''##$$EndDATE$$##''
GROUP BY gjl.period_name',
      p_title                  => 'The Journal Entry Category Usage',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The Journal Entry category was used as Receiving for the period end accruals.',
      p_solution               => '<p>The Account Analysis report balance in GL includes the accruals pertaining to the period end accruals; whereas, the AP and PO Reconciliation report will not. Hence the GL accrual balance for the period end accrual has to be subtracted from the total accrual balance in the GL for the reconciliation report.</p>
<p>See [555547/KB197182] How To Change The Seeded Default Journal Category from "Receiving" to" Accrual"? (KB197182)</p>
',
      p_success_msg            => 'The Journal Entry category was not wrongly used as Receiving for period end accruals.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_CATEGORY_RECEIVING');



debug('begin add_signature: ACCRUAL_BUDGET_AC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3545',
      p_sig_id                 => 'ACCRUAL_BUDGET_AC',
      p_sig_sql                => 'SELECT h.period_name,
(SUM(NVL(l.accounted_dr,0))- SUM(NVL(l.accounted_cr,0))) DIFF
FROM xla_ae_headers h,xla_ae_lines l
WHERE h.gl_transfer_status_code = ''Y''
AND h.balance_type_code = ''E''
AND h.application_id in (200,707)
AND h.ledger_id =##$$LedgerID$$##
...
GROUP BY h.period_name',
      p_title                  => 'The Accrual Account Usage Validation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The Accrual Account was found to be used as a Budget Account.',
      p_solution               => 'The Account Analysis report balance in GL considers the accrual balance if the budget account is used as an accrual account; whereas, the AP and PO Reconciliation report will not consider the encumbrance balance. Hence the GL accrual balance for balance type Encumbrance should to be subtracted from the total accrual balance in GL.',
      p_success_msg            => 'Correct setup:The Accrual Account is not used as Budget Account.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ACCRUAL_BUDGET_AC');



debug('begin add_signature: RRSL_NOT_TFR_SLA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3546',
      p_sig_id                 => 'RRSL_NOT_TFR_SLA',
      p_sig_sql                => 'SELECT rsl.period_name,
(SUM(NVL(rsl.accounted_dr,0))- SUM(NVL(rsl.accounted_cr,0)))DIFF
FROM rcv_receiving_sub_ledger rsl
WHERE rsl.code_combination_id =##$$AccrualCCID$$##
AND rsl.accounting_date  >= ''##$$StartDATE$$##''
AND rsl.accounting_date  <= ''##$$EndDATE$$##''
...
GROUP BY rsl.period_name',
      p_title                  => 'Records In Receiving subledger Not Transferred To SLA',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are records in receiving subledger that are not transferred to SLA.',
      p_solution               => '<p>Run Create Accounting-Receiving program to transfer the records to SLA and GL.</p>
<p>See [2450444/KB744976] Reconciliation Issue Due to Receipt and Invoice Accounting Not Transferred to XLA and GL (KB744976)</p>',
      p_success_msg            => 'All records in receiving subledger are transferred to SLA.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: RRSL_NOT_TFR_SLA');



debug('begin add_signature: WO_NOT_TFR_SLA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3547',
      p_sig_id                 => 'WO_NOT_TFR_SLA',
      p_sig_sql                => 'SELECT To_Char(cwo.transaction_date,''RRRR-MM'') period,
     (SUM(cwo.WRITE_OFF_AMOUNT))AMT
 FROM cst_write_offs cwo
 WHERE cwo.accrual_account_id =##$$AccrualCCID$$##
 AND cwo.operating_unit_id =##$$OperatingUnit$$##
 AND cwo.transaction_date >= ''##$$StartDATE$$##''
 AND cwo.transaction_date <= ''##$$EndDATE$$##''
 AND cwo.write_off_id not in
(SELECT source_distribution_id_num_1
FROM xla_distribution_links
WHERE source_distribution_type = ''CST_WRITE_OFFS''
AND application_id=707)
 GROUP BY To_char(cwo.transaction_date,''RRRR-MM'')',
      p_title                  => 'Accrual Write Offs Not Transferred To SLA',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are accrual write off transactions that are not transferred to SLA.',
      p_solution               => '<p>Run Create Accounting-Receiving program to transfer the records to SLA and GL.</p>
<p>See [2450444/KB744976] Reconciliation Issue Due to Receipt and Invoice Accounting Not Transferred to XLA and GL (KB744976)</p>',
      p_success_msg            => 'All the accrual write off transactions are transferred to SLA.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: WO_NOT_TFR_SLA');



debug('begin add_signature: ACCOUNT_ENTRY_DFT_CST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3548',
      p_sig_id                 => 'ACCOUNT_ENTRY_DFT_CST',
      p_sig_sql                => 'SELECT h.period_name,
  (SUM(NVL(xdl.unrounded_accounted_dr, 0)) -SUM(NVL(xdl.unrounded_accounted_cr, 0))) DIFF
FROM xla_distribution_links xdl,
  xla_ae_lines l,
  xla_ae_headers h
WHERE l.application_id              = 707
...
GROUP BY h.period_name 
',
      p_title                  => 'Records In Draft status in SLA For Source Cost Management',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are records in XLA in Draft status for source Cost Management.',
      p_solution               => 'Run Create Accounting-Cost Management program in Final mode to process the Draft records.',
      p_success_msg            => 'There are no records in XLA in Draft status for source Cost Management.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ACCOUNT_ENTRY_DFT_CST');



debug('begin add_signature: ACCOUNT_ENTRY_FNT_CST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3549',
      p_sig_id                 => 'ACCOUNT_ENTRY_FNT_CST',
      p_sig_sql                => 'SELECT h.application_id,h.event_type_code,h.je_category_name,
h.entity_id,h.ledger_id,l.ae_header_id,h.accounting_date,
h.period_name,l.gl_sl_link_id,l.gl_sl_link_table
FROM xla_ae_lines l, xla_ae_headers h WHERE l.application_id=h.application_id
AND l.ae_header_id=h.ae_header_id
AND h.application_id in (707)
AND h.ledger_id in (SELECT gled.ledger_id FROM gl_ledger_relationships glr, gl_ledgers gled
WHERE glr.primary_ledger_id =##$$LedgerID$$##
...
AND l.accounting_date <=''##$$EndDATE$$##''
AND l.code_combination_id =##$$AccrualCCID$$##',
      p_title                  => 'Records In SLA For Source Cost Management Not Transferred to GL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are records in XLA in Final status for source Cost Management but not transferred to GL.',
      p_solution               => 'Run Transfer Journal Entries to GL program from Cost Management - SLA responsibility to transfer the records.',
      p_success_msg            => 'All records in XLA in Final status for source Cost Management are transferred to GL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: ACCOUNT_ENTRY_FNT_CST');



debug('begin add_signature: ACCOUNT_ENTRY_FNT_PAY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3550',
      p_sig_id                 => 'ACCOUNT_ENTRY_FNT_PAY',
      p_sig_sql                => 'SELECT h.application_id,h.event_type_code,h.je_category_name,
h.entity_id,h.ledger_id,l.ae_header_id,h.accounting_date,
h.period_name,l.gl_sl_link_id,l.gl_sl_link_table
FROM xla_ae_lines l, xla_ae_headers h WHERE l.application_id=h.application_id
AND l.ae_header_id=h.ae_header_id
AND h.application_id in (200)
AND h.ledger_id in (SELECT gled.ledger_id FROM gl_ledger_relationships glr, gl_ledgers gled
WHERE glr.primary_ledger_id =##$$LedgerID$$##
AND glr.application_id = 101
AND ((glr.target_ledger_category_code IN (''SECONDARY'',''ALC'')
...
AND l.accounting_date <=''##$$EndDATE$$##''
AND l.code_combination_id =##$$AccrualCCID$$##',
      p_title                  => 'Records In SLA For Source Payables Not Transferred to GL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are records in XLA in Final status for source Payables but not transferred to GL.',
      p_solution               => '<p>Run Transfer Journal Entries to GL program from Payable responsibility to transfer the records to GL.</p>
<p>See [2450444/KB744976] Reconciliation Issue Due to Receipt and Invoice Accounting Not Transferred to XLA and GL (KB744976)</p>',
      p_success_msg            => 'All records in XLA in Final status for source Payable are transferred to GL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ACCOUNT_ENTRY_FNT_PAY');



debug('begin add_signature: SLA_NOT_IN_GL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3551',
      p_sig_id                 => 'SLA_NOT_IN_GL',
      p_sig_sql                => 'SELECT h.application_id,h.event_type_code,h.je_category_name,
h.entity_id,h.ledger_id,l.ae_header_id,h.accounting_date,
h.period_name,l.gl_sl_link_id,l.gl_sl_link_table
FROM xla_ae_lines l, xla_ae_headers h WHERE l.application_id=h.application_id
AND l.ae_header_id=h.ae_header_id
AND h.application_id in (707,200)
AND h.ledger_id in (SELECT gled.ledger_id FROM gl_ledger_relationships glr, gl_ledgers gled
WHERE glr.primary_ledger_id =##$$LedgerID$$##
AND glr.application_id = 101
AND ((glr.target_ledger_category_code IN (''SECONDARY'',''ALC'')
...
AND l.accounting_date <=''##$$EndDATE$$##''
AND l.code_combination_id =##$$AccrualCCID$$##
AND NOT EXISTS (SELECT 1 FROM gl_import_references jir , gl_je_headers gjh
WHERE jir.gl_sl_link_id=l.gl_sl_link_id
AND jir.gl_sl_link_table=l.gl_sl_link_table
AND jir.je_header_id=gjh.je_header_id
AND jir.je_batch_id=gjh.je_batch_id
AND gjh.ledger_id=h.ledger_id)

',
      p_title                  => 'Data Did Not Reach GL But Shown As Transferred To GL In SLA',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Data was found marked as transferred in SLA but did not reach the GL, source Cost Management and Payables.',
      p_solution               => 'Refer to [883557/KB627857] Subledger Accounting: How To Avoid and Fix Corruption in Data Transfer from SLA - Negative Ledger_ID, Not Reached GL, Duplicate in GL (KB627857)<br>
Apply the recommended root cause patches.<br>
To correct the existing corrupted records log a Service Request, requesting a data fix.<br>',
      p_success_msg            => 'There are no transactions marked as transferred to GL that have not actually reached the GL for Cost Management and Payables.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: SLA_NOT_IN_GL');



debug('begin add_signature: IN_GL_NOT_SLA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3552',
      p_sig_id                 => 'IN_GL_NOT_SLA',
      p_sig_sql                => 'SELECT /*+ parallel (h) parallel(l) leading (h) */
l.ae_header_id,l.gl_sl_link_id,l.gl_sl_link_table ,
gjb.group_id,h.ledger_id FROM xla_ae_lines l,xla_ae_headers h ,
gl_import_references ir ,gl_je_headers gh,gl_je_batches gjb
WHERE l.application_id=h.application_id
AND l.ae_header_id =h.ae_header_id
AND h.application_id in (707,200)
AND h.ledger_id IN
(SELECT gled.ledger_id FROM gl_ledger_relationships glr,
gl_ledgers gled WHERE glr.primary_ledger_id =##$$LedgerID$$##
AND glr.application_id = 101
AND ((glr.target_ledger_category_code IN (''SECONDARY'',''ALC'')
AND glr.relationship_type_code = ''SUBLEDGER'')
OR (glr.target_ledger_category_code IN (''PRIMARY'')
...
AND gh.je_batch_id =gjb.je_batch_id',
      p_title                  => 'Data Reached GL But Shown as Not Transferred To GL In SLA',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Data was found marked as transferred to the GL but stamped as N in SLA for source Cost Management and Payables.',
      p_solution               => 'Refer to [883557/KB627857] Subledger Accounting: How To Avoid and Fix Corruption in Data Transfer from SLA - Negative Ledger_ID, Not Reached GL, Duplicate in GL (KB627857)<br>
Apply the recommended root cause patches.<br>
To correct the existing corrupted records, log a Service Request requesting a data fix.<br>',
      p_success_msg            => 'There is no data which moved to the GL, stamped as N in SLA for Cost Management and Payables.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IN_GL_NOT_SLA');



debug('begin add_signature: NEG_LEDG_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3553',
      p_sig_id                 => 'NEG_LEDG_ID',
      p_sig_sql                => 'select /*+ parallel(h) parallel(i) leading(h) */
  ...
  and h.je_source  in (''Cost Management'',''Payables'')',
      p_title                  => 'Data In GL With Negative Ledger ID',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There is data in GL with a negative ledger ID for the source Cost Management and Payables.',
      p_solution               => 'Refer to [883557/KB627857] Subledger Accounting: How To Avoid and Fix Corruption in Data Transfer from SLA - Negative Ledger_ID, Not Reached GL, Duplicate in GL (KB627857)<br>
Apply the recommended root cause patches.<br>
To correct the existing corrupted records, log a Service Request to  request a data fix.<br>
',
      p_success_msg            => 'There is no data with a negative ledger id in GL for Cost Management and Payables.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: NEG_LEDG_ID');



debug('begin add_signature: SOUR_DIST_NUM_NOT_CORRECT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3554',
      p_sig_id                 => 'SOUR_DIST_NUM_NOT_CORRECT',
      p_sig_sql                => 'SELECT rrsl.period_name,
(SUM(NVL(xdl.unrounded_accounted_dr, 0))-SUM(NVL(xdl.unrounded_accounted_cr, 0))) DIFF
FROM xla.xla_distribution_links xdl,
  xla.xla_ae_lines l,
  rcv_receiving_sub_ledger rrsl
WHERE rrsl.gl_sl_link_id              =l.gl_sl_link_id
AND l.gl_sl_link_table                =''RSL''
AND l.application_id     in (707)
AND xdl.source_distribution_type      =''RCV_RECEIVING_SUB_LEDGER''
AND xdl.source_distribution_id_num_1 IS NULL
AND xdl.application_id                =707
AND xdl.application_id                =l.application_id
AND xdl.ref_ae_header_id              =l.ae_header_id
AND xdl.temp_line_num                 =l.ae_line_num
AND xdl.ae_header_id                  =l.ae_header_id
AND l.accounting_date                >=''##$$StartDATE$$##''
AND l.accounting_date                <=''##$$EndDATE$$##''
AND rrsl.rcv_sub_ledger_id           IS NOT NULL
AND rrsl.code_combination_id         =##$$AccrualCCID$$##
AND l.ledger_id                      =##$$LedgerID$$##
GROUP BY rrsl.period_name

',
      p_title                  => 'The source_distribution_id_num_1 Column Check In SLA Tables For Source Cost Management',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There is incorrect source_distribution_id_num_1 column in XLA for source Cost Management.',
      p_solution               => 'Log a Service Request to request a data fix.',
   ...
   l_info.delete;
debug('end add_signature: SOUR_DIST_NUM_NOT_CORRECT');



debug('begin add_signature: ACCOUNT_ENTRY_NOT_F_CST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3555',
      p_sig_id                 => 'ACCOUNT_ENTRY_NOT_F_CST',
      p_sig_sql                => 'SELECT h.period_name,
  (SUM(NVL(xdl.unrounded_accounted_dr, 0)) -SUM(NVL(xdl.unrounded_accounted_cr, 0))) DIFF
FROM xla_distribution_links xdl,
  xla_ae_lines l,
...
GROUP BY h.period_name 
',
      p_title                  => 'The accounting_entry_status_code Column Check In SLA Tables For Cost Management',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There is incorrect accounting_entry_status_code column in XLA for Cost Management.',
      p_solution               => 'Log a Service Request to request a data fix.',
      p_success_msg            => 'No issue found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: ACCOUNT_ENTRY_NOT_F_CST');



debug('begin add_signature: ACCOUNT_ENTRY_NOT_F_AP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3556',
      p_sig_id                 => 'ACCOUNT_ENTRY_NOT_F_AP',
      p_sig_sql                => 'SELECT h.period_name,
  (SUM(NVL(xdl.unrounded_accounted_dr, 0)) -SUM(NVL(xdl.unrounded_accounted_cr, 0))) DIFF
FROM xla_distribution_links xdl,
  xla_ae_lines l,
...
AND xdl.ae_header_id                = l.ae_header_id
AND xdl.ae_line_num                 = l.ae_line_num
AND xdl.source_distribution_type    = ''AP_INVOICE_DIST''
AND l.code_combination_id           =##$$AccrualCCID$$##
AND l.accounting_date              >=''##$$StartDATE$$##''
AND l.accounting_date              <=''##$$EndDATE$$##''
GROUP BY h.period_name ',
      p_title                  => 'The accounting_entry_status_code Column Check In SLA Tables For PayablesThe accounting_entry_status_code Column Check In SLA Tables For Payables',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There is incorrect accounting_entry_status_code column in XLA for Payables.',
      p_solution               => 'Log a Service Request to request a data fix.',
      p_success_msg            => 'No issue found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: ACCOUNT_ENTRY_NOT_F_AP');
...
BEGIN
  ...
  analyzer_title := 'Procurement Accrual Accounting Analyzer';
...
debug('begin section: Accrual_Account_Setup');
start_section('Accrual Account Setup', 'Accrual_Account_Setup');
   set_item_result(run_stored_sig('SELECT_ACCR_ACC'));
end_section;
debug('end section: Accrual_Account_Setup');

debug('begin section: Accrual_Reconcilaition_Reports');
start_section('Accrual Reconcilaition Reports Balance', 'Accrual_Reconcilaition_Reports');
   set_item_result(run_stored_sig('CST_RECONCILIATION_SUMMARY'));
   set_item_result(run_stored_sig('CST_AP_PO_RECONCILIATION'));
   set_item_result(run_stored_sig('CST_MISC_RECONCILIATION'));
end_section;
debug('end section: Accrual_Reconcilaition_Reports');

debug('begin section: Accrual_Reconciliation_Data_For_Analysis');
start_section('Accrual Reconciliation Data For Analysis', 'Accrual_Reconciliation_Data_For_Analysis');
   set_item_result(run_stored_sig('UNPOSTED_ACCRUAL_BAL'));
   set_item_result(run_stored_sig('POSTED_ACCRUAL_BAL'));
   set_item_result(run_stored_sig('SLA_BAL_PAY'));
   set_item_result(run_stored_sig('SLA_BAL_CST'));
end_section;
debug('end section: Accrual_Reconciliation_Data_For_Analysis');

debug('begin section: Accrual_Reconciliation_Setup_Analysis');
start_section('Accrual Reconciliation Setup Analysis', 'Accrual_Reconciliation_Setup_Analysis');
   set_item_result(run_stored_sig('LOAD_RUN_CORRECT'));
   set_item_result(run_stored_sig('UPGRADED_FRESH_INSTALL'));
end_section;
debug('end section: Accrual_Reconciliation_Setup_Analysis');

debug('begin section: Accrual_Data_Integrity_Issue_Analysis');
start_section('Accrual Data Integrity Issue Analysis', 'Accrual_Data_Integrity_Issue_Analysis');
   set_item_result(run_stored_sig('JE_CATEGORY_RECEIVING'));
   set_item_result(run_stored_sig('ACCRUAL_BUDGET_AC'));
   set_item_result(run_stored_sig('RRSL_NOT_TFR_SLA'));
   set_item_result(run_stored_sig('WO_NOT_TFR_SLA'));
   set_item_result(run_stored_sig('ACCOUNT_ENTRY_DFT_CST'));
   set_item_result(run_stored_sig('ACCOUNT_ENTRY_FNT_CST'));
   set_item_result(run_stored_sig('ACCOUNT_ENTRY_FNT_PAY'));
end_section;
debug('end section: Accrual_Data_Integrity_Issue_Analysis');

debug('begin section: Accrual_Data_Corruption_Issue_Analysis');
start_section('Accrual Data Corruption Issue Analysis', 'Accrual_Data_Corruption_Issue_Analysis');
   set_item_result(run_stored_sig('SLA_NOT_IN_GL'));
   set_item_result(run_stored_sig('IN_GL_NOT_SLA'));
   set_item_result(run_stored_sig('NEG_LEDG_ID'));
   set_item_result(run_stored_sig('SOUR_DIST_NUM_NOT_CORRECT'));
   set_item_result(run_stored_sig('ACCOUNT_ENTRY_NOT_F_CST'));
   set_item_result(run_stored_sig('ACCOUNT_ENTRY_NOT_F_AP'));
end_section;
debug('end section: Accrual_Data_Corruption_Issue_Analysis');
...
BEGIN
  ...
  g_errbuf := null;
   ...
   main(
    ...
    ,l_ledger_id                    => l_ledger_id
    ,l_code_combination_id          => l_code_combination_id
    ,l_start_date                   => FND_DATE.canonical_to_date(l_start_date)
    ,l_end_date                     => FND_DATE.canonical_to_date(l_end_date)
    ,p_max_output_rows              => p_max_output_rows
    ,p_debug_mode                   => p_debug_mode
  );
