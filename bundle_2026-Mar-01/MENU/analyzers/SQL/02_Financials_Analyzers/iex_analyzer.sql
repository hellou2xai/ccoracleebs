...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Advanced Collections Analyzer          |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE iex_analyzer_pkg AUTHID DEFINER AS
...
(            p_org_id                       IN NUMBER      DEFAULT NULL
           ,p_uwq                          IN VARCHAR2    DEFAULT 'N'
           ,p_dunning                      IN VARCHAR2    DEFAULT 'N'
           ,p_strategy                     IN VARCHAR2    DEFAULT 'N'
...
END iex_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY iex_analyzer_pkg AS
-- $Id: iex_analyzer.sql, 200.19 2025/12/08 13:34:10 jnieman Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2536952.1));
...
-- Parameter Related
    ...
    g_cust_account_id	NUMBER := NULL;
    g_site_use_id	NUMBER := NULL;
    g_score_id          NUMBER;
    g_strategy_temp_id  NUMBER;
    g_dunning_plan_id   NUMBER;

-- select column tokens
    g_stra_group        VARCHAR2(1000) := NULL;
    g_stra_temp         VARCHAR2(1000) := NULL;
    g_delq_cust         VARCHAR2(1000) := NULL;
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'IEXANLZ_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'IEXANLZ_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>IEXANLZ Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2536952.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/iex_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1934,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1934,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1934,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4268332" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">1934</span>
...
<p>New Items:</p><ul><li>Framework changes</li>
<li>Corrected different signatures</li>
</ul>
<p>&nbsp;</p>
            <br><br>
...
<!-- '||l_current_sig||' -->
	...
	l_html := l_html || '
			...
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1934,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1934,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
l_first_trx_id        NUMBER;
l_second_trx_id       NUMBER;  


  g_first_tt_grping_rule_id 		  NUMBER;
  g_first_tt_grping_trx_type_id 	  NUMBER;
  g_first_tt_class 		          VARCHAR2(1);
  g_first_gb_grping_trx_type_id 	  NUMBER;
  g_first_gb_column_id 			  NUMBER;
  g_first_gc_column_id			  NUMBER;
  g_first_gc_from_column_name		  VARCHAR2(80);
  g_first_gc_column_type		  VARCHAR2(8);
  g_first_cust_trx_type_id                NUMBER;
  g_second_cust_trx_type_id               NUMBER;

g_trx_class                     VARCHAR2(1);
g_gl_date                       DATE;

g_zx_trx_id                     NUMBER;
g_scust_trx_line_id             NUMBER;
g_scust_trx_dist_line_id        NUMBER;
g_fcust_trx_dist_line_id        NUMBER;
g_fcust_trx_line_id             NUMBER;
...
debug('begin populate parameters hash table');
   ...
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Include Universal Work Queue  (UWQ)';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_uwq,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Include Dunning Information';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_dunning,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Include Strategy Information';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_strategy,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2025/12/08 13:34:09 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'iex_analyzer.sql';
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Organization.');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
debug('begin parameter validation: p_uwq');
IF p_uwq IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Include Universal Work Queue  (UWQ) is required.');
   raise invalid_parameters;
END IF;
IF p_uwq IS NOT NULL AND p_uwq NOT IN ( 'N','Y') THEN
   print_error('INVALID ARGUMENT: Invalid value for Include Universal Work Queue, valid values Y or N.');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_uwq');

debug('begin parameter validation: p_dunning');
IF p_dunning IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Include Dunning Information is required.');
   raise invalid_parameters;
END IF;
IF p_dunning IS NOT NULL AND p_dunning NOT IN ( 'N','Y') THEN
   print_error('INVALID ARGUMENT: Invalid value for Include Dunning Information, valid values Y or N.');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_dunning');

debug('begin parameter validation: p_strategy');
IF p_strategy IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Include Strategy Information is required.');
   raise invalid_parameters;
END IF;
IF p_strategy IS NOT NULL AND p_strategy NOT IN ( 'N','Y') THEN
   print_error('INVALID ARGUMENT: Invalid value for Include Strategy Information, valid values are Y or N.');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_strategy');
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Party ID, please ensure it exists in HZ_PARTIES.');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
DECLARE
   ...
   dummy             NUMBER;
BEGIN
-- validate org_id entered via script or concurrent program and use it to set org context   
   IF g_org_id is null THEN
      print_log('No organization ID provided. The org_id parameter is mandatory.');
      raise invalid_parameters;
   ELSE  
     BEGIN
        ...
        print_log('1. g_org_id = ' || g_org_id || 
                  ' has been validated. Setting org context');
  ...
  where table_name = 'IEX_STRATEGY_TEMPLATE_GROUPS'
  and column_name = 'ORG_ID';

  if dummy <> 0 then

    g_stra_group := 'group_id, group_name, enabled_flag, category_type, change_strategy_yn, check_list_yn, object_filter_id, scoring_engine_id, strategy_level, score_tolerance, org_id';

    g_stra_temp := 'str_tempvla.strategy_temp_id, str_tempvla.strategy_name, str_temp.group_id, str_temp.group_name, str_tempvla.strategy_rank, str_temp.check_list_yn, str_tempvl.strategy_name, str_temp.change_strategy_yn, obj_fi.object_filter_id, obj_fi.entity_name "Segment View Name", obj_fi.select_column, str_temp.enabled_flag, TO_CHAR(str_temp.valid_from_dt, ''DD-MON-YYYY'') " Valid From Date", TO_CHAR(str_temp.valid_to_dt, ''DD-MON-YYYY'') "Valid To Date", str_temp.category_type "Category Type", DECODE(str_temp.strategy_level, 1, ''Customer'', 2, ''Account'', 3, ''Delinquency'', 10, ''Customer'', 20, ''Account'', 30, ''Bill To'', 40 , ''Delinquency'', str_temp.strategy_level) "Strategy Level", str_temp.score_tolerance "Score Tolerance", str_temp.org_id "Org ID"';

  else
     
    g_stra_group := 'group_id, group_name, enabled_flag, category_type, change_strategy_yn, check_list_yn, object_filter_id, scoring_engine_id, strategy_level, score_tolerance';

    g_stra_temp := 'str_tempvla.strategy_temp_id "Strategy Temp Id", str_tempvla.strategy_name "Strategy Name", str_temp.group_id "Group Id", str_temp.group_name "Group Name", str_tempvla.strategy_rank "Lowest Applicable Score", str_temp.check_list_yn "Check List", str_tempvl.strategy_name "Ckeck List Template", str_temp.change_strategy_yn "Change Strategy", obj_fi.object_filter_id "Object Filter Id", obj_fi.entity_name "Segment View Name", obj_fi.select_column "Segment View Column", str_temp.enabled_flag "Enabled", TO_CHAR(str_temp.valid_from_dt, ''DD-MON-YYYY'') " Valid From Date", TO_CHAR(str_temp.valid_to_dt, ''DD-MON-YYYY'') "Valid To Date", str_temp.category_type "Category Type", DECODE(str_temp.strategy_level, 1, ''Customer'', 2, ''Account'', 3, ''Delinquency'', 10, ''Customer'', 20, ''Account'', 30, ''Bill To'', 40 , ''Delinquency'', str_temp.strategy_level) "Strategy Level", str_temp.score_tolerance "Score Tolerance"';
  end if;
     ...
     into dummy
     from all_tab_columns
     where table_name = 'IEX_DELINQUENCIES_ALL'
     and  column_name = 'LAST_DUNNING_DATE';
    
     if dummy <> 0 then

     g_delq_cust := 'delinquency_id, status, creation_date, request_id, party_cust_id, cust_account_id, customer_site_use_id, transaction_id, payment_schedule_id, dunn_yn, org_id, score_value, score_id, source_program_name, uwq_status, uwq_active_date, uwq_complete_date, staged_dunning_level, dunning_level_override_date, last_dunning_date';

     else

     g_delq_cust := 'delinquency_id, status, creation_date, request_id, party_cust_id, cust_account_id, customer_site_use_id, transaction_id, payment_schedule_id, dunn_yn, org_id, score_value, score_id, source_program_name, uwq_status, uwq_active_date, uwq_complete_date, staged_dunning_level, dunning_level_override_date';
...
debug('begin populate sql tokens hash table');
   ...
   g_sql_tokens('##$$A$$##') := 'IEX_ANALYZER_PKG';
   ...
   g_sql_tokens('##$$STRA_GROUP$$##') := g_stra_group;
   g_masked_tokens('##$$STRA_GROUP$$##') := mask_text( g_sql_tokens('##$$STRA_GROUP$$##'), 'NO_MASK');
   g_sql_tokens('##$$STRA_TEMP$$##') := g_stra_temp;
   g_masked_tokens('##$$STRA_TEMP$$##') := mask_text( g_sql_tokens('##$$STRA_TEMP$$##'), 'NO_MASK');
   g_sql_tokens('##$$DELQ_CUST$$##') := g_delq_cust;
   g_masked_tokens('##$$DELQ_CUST$$##') := mask_text( g_sql_tokens('##$$DELQ_CUST$$##'), 'NO_MASK');
...
debug('begin add_signature: IEX_GEN_PROD_INSTALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12370',
      p_sig_id                 => 'IEX_GEN_PROD_INSTALL',
      p_sig_sql                => 'SELECT
    substr(a.application_name, 1, 40) product_name,
    a.application_id,
    substr(application_short_name, 1, 4) short_name,
    DECODE(b.status, ''I'', ''INSTALLED'', DECODE(b.status, ''S'', ''SHARED'', DECODE(b.status, ''N'', ''NOTINSTALLED'', b.status))) status,
    patch_level
FROM
...
ORDER BY
    a.application_name',
      p_title                  => 'Related Product Installation Status',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This displays related product installation status and application levels.',
      p_solution               => '',
      p_success_msg            => 'Displaying Advanced Collections and related products installation status.',
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_PROD_INSTALL');



debug('begin add_signature: IEX_GEN_APP_PREFERENCES_VL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11724',
      p_sig_id                 => 'IEX_GEN_APP_PREFERENCES_VL',
      p_sig_sql                => 'SELECT
    preference_name,
    user_name,
    preference_value,
    enabled_flag
FROM
    iex_app_preferences_vl',
      p_title                  => 'Default Collections Preferences',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This is a data collections of the Advanced Collections Preferences.',
      p_solution               => '',
      p_success_msg            => 'Displaying general Advanced Collections preferences settings.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_APP_PREFERENCES_VL');



debug('begin add_signature: IEX_GEN_METHOD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12533',
      p_sig_id                 => 'IEX_GEN_METHOD',
      p_sig_sql                => 'SELECT
    *
FROM
    iex_questionnaire_items',
      p_title                  => 'Collections Methods',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Displays the defined collections method.',
      p_solution               => '',
      p_success_msg            => 'Displaying the defined collections method.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_METHOD');



debug('begin add_signature: IEX_GEN_OU_SETTINGS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12343',
      p_sig_id                 => 'IEX_GEN_OU_SETTINGS',
      p_sig_sql                => 'SELECT
    org_id,
    preference_name,
    preference_value,
    ...
    last_updated_by
FROM
    iex_app_preferences_b
WHERE
    enabled_flag = ''Y''
    AND collections_method IS NOT NULL',
      p_title                  => 'Operating Unit Specific Settings',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Operating Unit Settings',
      p_solution               => '',
      p_success_msg            => 'Displaying Collections preferences defined by Operating Unit.',
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_OU_SETTINGS');



debug('begin add_signature: IEX_APPLIED_PATCHES_R12');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12458',
      p_sig_id                 => 'IEX_APPLIED_PATCHES_R12',
      p_sig_sql                => 'SELECT
    substr(bug_number, 1, 10) bug,
    DECODE(bug_number, ''4440000'', ''12.0.0'', ''4411250'', ''R12.IEX.A'', ''4175000'', ''R12.FIN_PF.A'', ''5082400'', ''12.0.1'', ''5884587'', ''R12.FIN_PF.A.DELTA.1''
    , ''5484000'', ''R12.0.2'', ''6000030'', ''R12.FIN_PF.A.DELTA.2'', ''5999867'', ''R12.IEX.A.DELTA.2'', ''6141000'', ''R12.0.3'', ''6435000'', ''R12.0.4''
    , ''6836355'', ''R12.0.5'', ''6728000'', ''R12.0.6'', ''9218931'', ''R12.0.6 Fixes'', ''8522751'', ''R12 8522751:R12.IEX.A: PATCH FOR MAY 2009 POST IEX 12.0.6 FIXES''
    , ''9411029'', ''R12.0.6 May 2009 Fixes'', ''9813860'', ''R12.0.6 Nov 2009 Fixes'', ''7828946'', ''R12 Receivables Critical Patch Required for 12.0 support''
    , ''7303030'', ''12.1.1 Maintenance Pack'', ''7303033'', ''12.1.2 Maintenance Pack'', ''9239090'', ''12.1.3 Release Update Pack'', ''10005715''
    , ''Perf/JTA Fix'', ''9474696'', ''IEX 12.1.1'', ''9930484'', ''IEX 12.1.1/12.1.2 Fixes'', ''10046115'', ''IEX 12.1.3 Stand Alone'', ''10043072''
    , ''HZ Fix for Dunning Letter Set Name'', ''10061366'', ''Collections Predelinquent Strategies Patch'', ''12749104'', ''IEX 12.1.3 June 2011 Fixes''
    , ''13788010'', ''IEX 12.1.3 Consolidated Patch Jan 2012'', ''14310239'', ''IEX R12.1: IEX RPC, AUGUST 2012'', ''16201879'', ''IEX R12.1: IEX RPC, MARCH 2013''
    , ''17043270'', ''IEX R12.1: IEX RPC, SEPTEMBER 2013'', ''19048616'', ''IEX R12.1: IEX RPC, AUGUST 2014'', ''20189017'', ''IEX R12.1: IEX RPC, FEBRUARY 2015''
    , ''21277893'', ''IEX R12.1: IEX RPC, AUGUST 2015'', ''22899060'', ''IEX R12.1: IEX RPC, FEBRUARY 2016'', ''24317349'', ''Consolidated Patch after Feb 2016 RPC''
    , ''16207672'', ''12.2.2 Maintenance Pack'', ''21382734'', ''IEX only from 12.2.2 to 12.2.5'', ''17020683'', ''12.2.3 Maintenance Pack'',
    ''17919161'', ''12.2.4 Maintenance Pack'', ''19676458'', ''12.2.5 Maintenance Pack'', ''21900901'', ''12.2.6 Maintenance Pack'', ''24690690''
    , ''12.2.7 Maintenance Pack'', ''26787767'', ''12.2.8 Maintenance Pack'', ''28840850'', ''12.2.9 Maintenance Pack'', ''22142100'', ''R12.FIN_PF.C.DELTA.6''
    , ''21382734'', ''IEX R12.2: IEX Consolidated Patch Upgrades from 12.2.2 to 12.2.5 for IEX ONLY'', ''18491990'', ''R12.AD.C.Delta.4 - R12.AD.C''
    , ''18497540'', ''R12.TXK.C.Delta.4 - R12.TXK.C'', ''17774755'', ''12.1.3 RPC1'', ''4175000'', ''R12.FIN_PF.A'', ''4565490'', ''R12.FIN_PF.B''
    , ''4442885'', ''R12.OCM.A'', ''4565274'', ''R12.OCM.B'') patch,
...
ORDER BY
    creation_date DESC',
      p_title                  => 'Applied Patches',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This is a data collection of the applied patches.',
      p_solution               => '',
      p_success_msg            => 'For the most current recommendations, use the Patch Wizard or the Updates & Patches Tab in My Oracle Support.<br>
...
',
   ...
   l_info.delete;
debug('end add_signature: IEX_APPLIED_PATCHES_R12');



debug('begin add_signature: IEX_GEN_MAX_ROWS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12485',
      p_sig_id                 => 'IEX_GEN_MAX_ROWS',
      p_sig_sql                => 'SELECT
...
WHERE
    default_value = ''select 1000 from dual''
    AND descriptive_flexfield_name = ''$SRS$.IEX_SCORE_OBJECTS''',
      p_title                  => 'Maximum Number of Records Setting',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Maximum Number of Rows is set to 1000.  This will prevent the IEX: Scoring Engine Harness from scoring all records if submitted with Maximum Number of Records = 1000.

<br>It is recommended to always run the IEX: Scoring Engine Harness with Maximum Number of Records = Null (no value).<br>',
      p_solution               => 'Review [1263316.1] ''How do Change the Default on Parameter ''Maximum Number Of Records'' in IEX: Scoring Engine Harness'' for steps to remove the default value.

',
      p_success_msg            => 'No action required.  The scoring engine definition is correct, and doesn''t have a default value defined for Maximum Number of Records.  
...
<br>It is recommended to always run the IEX: Scoring Engine Harness with Maximum Number of Records = Null (no value).<br>',
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_MAX_ROWS');



debug('begin add_signature: IEX_GEN_SCR_ENGINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13144',
      p_sig_id                 => 'IEX_GEN_SCR_ENGINES',
      p_sig_sql                => 'SELECT DISTINCT
    a.score_id,
    a.score_name,
    a.score_description,
    TO_CHAR(a.valid_from_dt, ''DD-MON-YYYY'') "VALID_FROM_DT",
    TO_CHAR(a.valid_to_dt, ''DD-MON-YYYY'') "VALID_TO_DT",
    a.enabled_flag,
    b.name,
...
FROM
    ...
    fnd_user                     e
WHERE
    b.object_code (+) = a.jtf_object_code
    AND c.application_id (+) = 695
    AND c.concurrent_program_name (+) = a.concurrent_prog_name
    AND d.user_id (+) = a.created_by
    AND e.user_id (+) = a.last_updated_by
ORDER BY
    a.score_id ASC',
      p_title                  => 'Scoring Engines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This is a data collection of the defined scoring engines.',
      p_solution               => 'Review [269112.1] ''Using Collections Scoring and Strategies for Superior Collecting'' for steps to create custom scoring engines.',
      p_success_msg            => 'Displaying Defined Scoring Engines.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_SCR_ENGINES');



debug('begin add_signature: IEX_GEN_SCR_DET');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12371',
      p_sig_id                 => 'IEX_GEN_SCR_DET',
      p_sig_sql                => 'SELECT
    a.score_component_id,
    b.score_comp_name,
    a.score_comp_type_id,
    a.score_comp_weight,
    a.enabled_flag,
    c.user_name,
    d.user_name
FROM
    iex_score_components      a,
    iex_score_comp_types_vl   b,
    fnd_user                  c,
    fnd_user                  d
WHERE
    a.score_id = ##$$FK1$$##
    AND b.score_comp_type_id = a.score_comp_type_id
    AND c.user_id (+) = a.created_by
    AND d.user_id (+) = a.last_updated_by
ORDER BY
    a.score_component_id',
      p_title                  => 'Scoring Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no components defined for this scoring engine.',
      p_solution               => '',
      p_success_msg            => 'Displaying the individual components of the scoring engines.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_SCR_DET');



debug('begin add_signature: IEX_GEN_SCORING_ENGINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12324',
      p_sig_id                 => 'IEX_GEN_SCORING_ENGINES',
      p_sig_sql                => 'SELECT DISTINCT
    a.score_id                       "##$$FK1$$##",
    a.score_id                       "Score ID",
    a.score_name                     "Name",
    a.score_description              "Description",
    TO_CHAR(a.valid_from_dt, ''DD-MON-YYYY'') "From Date",
    TO_CHAR(a.valid_to_dt, ''DD-MON-YYYY'') "To Date",
    a.enabled_flag                   "Enabled",
    b.name                           "Object",
    c.user_concurrent_program_name   "Concurrent Program",
    d.user_name                      "Created By",
    e.user_name                      "Last Updated By",
    a.status_determination           "Status Determination",
    a.weight_required                "Weighting Required",
    a.score_range_low                "Score Range Low",
    a.score_range_high               "Score Range High",
    a.out_of_range_rule              "Out Of Range Rule"
FROM
    iex_scores                   a,
    jtf_objects_vl               b,
    fnd_concurrent_programs_vl   c,
...
ORDER BY
    a.score_id ASC',
      p_title                  => 'Scoring Engines and Components',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This is a data collection of the defined scoring engines.',
      p_solution               => '',
      p_success_msg            => 'Displaying Defined Scoring Engines.',
      ...
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('IEX_GEN_SCR_DET'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '15'
      );
   l_info.delete;
debug('end add_signature: IEX_GEN_SCORING_ENGINES');



debug('begin add_signature: IEX_GEN_SCORE_COMPONENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12049',
      p_sig_id                 => 'IEX_GEN_SCORE_COMPONENTS',
      p_sig_sql                => 'SELECT
    a.score_comp_type_id "Component Type Id",
    a.score_comp_name "Type Name",
    a.score_comp_value "Value",
    b.name "Object",
    a.function_flag "Function",
    a.active_flag "Active",
    a.description "Description"
FROM
    iex_score_comp_types_vl a,
    jtf_objects_vl b
WHERE
    b.object_code (+) = a.jtf_object_code
ORDER BY a.score_comp_type_id ASC',
      p_title                  => 'Scoring Components',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Score Component Types',
      p_solution               => 'No score component type records exist.',
      p_success_msg            => 'Displaying score component types.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_SCORE_COMPONENTS');



debug('begin add_signature: IEX_GEN_DEL_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22319',
      p_sig_id                 => 'IEX_GEN_DEL_STATUS',
      p_sig_sql                => 'SELECT
    del_status_id,
...
ORDER BY
    score_id,
    del_status_id',
      p_title                  => 'Scoring Engine Delinquency Status',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This shows the delinquency status for the scoring engines.',
      p_solution               => '',
      p_success_msg            => 'Displaying the profile amounts defined for this customer.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_DEL_STATUS');



debug('begin add_signature: IEX_GEN_SCOREHIST_COUNT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13565',
      p_sig_id                 => 'IEX_GEN_SCOREHIST_COUNT',
      p_sig_sql                => 'SELECT
    score_id,
    COUNT(0)
FROM
    apps.iex_score_histories
GROUP BY
    score_id
ORDER BY
    score_id',
      p_title                  => 'Score History Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This shows how many records are in IEX_SCORE_HISTORIES.',
      p_solution               => '',
      p_success_msg            => 'Displaying the number of records in IEX_SCORE_HISTORIES.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_SCOREHIST_COUNT');



debug('begin add_signature: IEX_STR_GROUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12368',
      p_sig_id                 => 'IEX_STR_GROUP',
      p_sig_sql                => 'SELECT ##$$STRA_GROUP$$##
FROM
    iex_strategy_template_groups
ORDER BY
    group_id',
      p_title                  => 'Strategy Groups',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This is a data collection of the defined strategy groups.',
      p_solution               => '',
      p_success_msg            => 'Displaying defined strategy groups.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_STR_GROUP');



debug('begin add_signature: IEX_GEN_STR_TMP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12985',
      p_sig_id                 => 'IEX_GEN_STR_TMP',
      p_sig_sql                => 'SELECT ##$$STRA_TEMP$$##
FROM
    iex_strategy_template_groups   str_temp,
    iex_strategy_templates_vl      str_tempvl,
    iex_object_filters             obj_fi,
    iex_strategy_templates_vl      str_tempvla
WHERE
    str_temp.check_list_temp_id = str_tempvl.strategy_temp_id (+)
    AND str_temp.object_filter_id = obj_fi.object_filter_id (+)
    AND str_temp.group_id = str_tempvla.strategy_temp_group_id
ORDER BY
    str_temp.group_id,
    str_tempvla.strategy_temp_id ASC',
      p_title                  => 'Strategy Templates',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This is a data collection of the Strategy Templates.',
      p_solution               => '',
      p_success_msg            => 'Displaying all Strategy Templates created in Advanced Collections.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_STR_TMP');



debug('begin add_signature: IEX_STR_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12374',
      p_sig_id                 => 'IEX_STR_DETAILS',
      p_sig_sql                => 'SELECT
    str_temp.name                "Name",
    str_xref.work_temp_xref_id   "Work Template Xref Id",
    str_xref.work_item_temp_id   "Work Item Template Id",
    str_temp.work_type           "Work Type",
    str_xref.work_item_order     "Order",
    str_temp.pre_execution_wait  "Pre-Wait",
    str_temp.schedule_uom        "Pre-Wait UOM",
    str_temp.post_execution_wait "Post Wait",
    str_temp.execution_time_uom  "Post Wait UOM",
    str_temp.optional_yn         "Optional",
    str_temp.option_wait_time    "Optional Wait",
    str_temp.option_wait_time_uom "Optional UOM"
FROM
    iex_strategy_work_temp_xref   str_xref,
    iex_stry_temp_work_items_vl   str_temp
WHERE
    str_xref.strategy_temp_id = ##$$FK2$$##
    AND str_temp.work_item_temp_id = str_xref.work_item_temp_id
ORDER BY
    str_xref.work_item_order',
      p_title                  => 'Strategy Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no work items defined for this strategy.',
      p_solution               => '',
      p_success_msg            => 'Displaying the work items assigned to this strategy.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_STR_DETAILS');



debug('begin add_signature: IEX_GEN_STRATEGY_TEMPLATES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12326',
      p_sig_id                 => 'IEX_GEN_STRATEGY_TEMPLATES',
      p_sig_sql                => 'SELECT
    DISTINCT a.strategy_temp_id         "##$$FK2$$##",
    a.strategy_temp_id         "Strategy Temp ID",
    a.strategy_temp_group_id   "Group ID",
    a.strategy_name            "Strategy Name",
    a.strategy_rank            "Lowest Applicable Score",
    a.check_list_yn            "Check List",
    b.strategy_name            "Check List Template",
    a.change_strategy_yn       "Change Strategy",
    c.object_filter_name       "Filter",
    a.enabled_flag             "Enabled",
    TO_CHAR(a.valid_from_dt, ''DD-MON-YYYY'') "Valid From Date",
    TO_CHAR(a.valid_to_dt, ''DD-MON-YYYY'') "Valid To Date",
    a.category_type            "Category Type",
    DECODE(a.strategy_level, 1, ''Customer'', 2, ''Account'', 3, ''Delinquency'', 10, ''Customer'', 20, ''Account'', 30, ''Bill To'', 40, ''Delinquency''
    , a.strategy_level) "Strategy Level",
    a.score_tolerance          "Score Tolerance"
FROM
    iex_strategy_templates_vl   a,
    iex_strategy_templates_vl   b,
    iex_object_filters          c
WHERE
    b.strategy_temp_id (+) = a.check_list_temp_id
    AND c.object_filter_id (+) = a.object_filter_id
ORDER BY
    a.strategy_temp_id ASC',
      p_title                  => 'Strategy Template Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This is a data collection of Strategy Templates.',
      p_solution               => '',
      p_success_msg            => 'Displaying all Strategy Templates created in Advanced Collections.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      ...
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('IEX_STR_DETAILS'),
      p_include_in_dx_summary  => nvl('Y','N'),
      p_version                => '19'
      );
   l_info.delete;
debug('end add_signature: IEX_GEN_STRATEGY_TEMPLATES');



debug('begin add_signature: IEX_GEN_WORK_ITEMS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12325',
      p_sig_id                 => 'IEX_GEN_WORK_ITEMS',
      p_sig_sql                => 'SELECT
    a.work_item_temp_id,
    a.name,
    a.description,
    ...
    c.meaning,
    d.meaning,
    a.pre_execution_wait,
    a.schedule_uom,
    a.post_execution_wait,
    a.execution_time_uom,
    a.notify_yn,
    a.optional_yn,
    a.option_wait_time,
    a.option_wait_time_uom,
    a.escalate_yn,
    a.closure_time_limit,
    a.closure_time_uom,
    a.enabled_flag,
    a.temp_resource_id,
    a.org_id                 
FROM
    iex_stry_temp_work_items_vl   a,
    iex_lookups_v                 b,
    iex_lookups_v                 c,
    iex_lookups_v                 d,
    xdo_templates_vl              e
WHERE
    b.lookup_type (+) = ''IEX_STRATEGY_WORK_TYPE''
    AND b.lookup_code (+) = a.work_type
    AND c.lookup_type (+) = ''IEX_STRATEGY_WORK_CATEGORY''
    AND c.lookup_code (+) = a.category_type
    AND d.lookup_type (+) = ''IEX_STRATEGY_WORK_PRIORITY''
    AND d.lookup_code (+) = a.priority_type
    AND a.xdo_template_id = e.template_id (+)
ORDER BY
    a.work_item_temp_id ASC',
      p_title                  => 'Strategy Work Items',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This is a data collection of Strategy Work Items.
',
      p_solution               => '',
      p_success_msg            => 'Displaying strategy work items.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_WORK_ITEMS');



debug('begin add_signature: IEX_GEN_FILTERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12327',
      p_sig_id                 => 'IEX_GEN_FILTERS',
      p_sig_sql                => 'SELECT
    a.object_filter_id     "Object Filter Id",
    b.meaning              "Filter Type",
    a.object_filter_name   "Filter Name",
    a.active_flag          "Filter Active",
    a.entity_name          "View Name",
    c.text                 "View Text",
    c.owner                "View Owner",
    a.select_column        "Select Column",
    a.object_id            "Object Id"
FROM
    iex_object_filters   a,
    iex_lookups_v        b,
    all_views            c
WHERE
    b.lookup_type = ''IEX_OBJECT_FILTERS''
    AND b.lookup_code = a.object_filter_type
    AND c.view_name (+) = a.entity_name
ORDER BY
    a.object_filter_id ASC',
      p_title                  => 'Scoring and Strategy Filters',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This is a data collection of Scoring and Strategy Filters.
',
      p_solution               => '',
      p_success_msg            => 'Displaying filters assigned to Scoring Engines and Strategies.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_FILTERS');



debug('begin add_signature: IEX_GEN_PROFILE_ OPTIONS');
   l_info('##MASK##LEVEL VALUE'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11744',
      p_sig_id                 => 'IEX_GEN_PROFILE_ OPTIONS',
...
c.responsibility_id,a.last_update_date,
a.last_updated_by
FROM fnd_profile_option_values a,fnd_application b,
fnd_responsibility_tl c,fnd_user d,
fnd_profile_options e,fnd_profile_options_tl t
WHERE e.application_id in (695,696)
...
AND ((a.level_id = 10003 OR (a.level_id = 10004) 
OR (a.level_id = 10001))  OR (a.level_id = 10002))
ORDER BY t.user_profile_option_name,
a.level_id ASC',
      p_title                  => 'Profile Options',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Profile Option Settings',
      p_solution               => '',
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_PROFILE_ OPTIONS');



debug('begin add_signature: EBS_AR_IEXANLZ_ICX_XDO_PROFILES');
   l_info('##MASK##LEVEL VALUE'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25841',
      p_sig_id                 => 'EBS_AR_IEXANLZ_ICX_XDO_PROFILES',
      p_sig_sql                => 'SELECT
...
WHERE
    ...
    AND ( ( a.level_id = 10003
            ...
            OR ( a.level_id = 10001 ) )
            OR ( a.level_id = 10002 ) )
    AND e.profile_option_id in (''3532'',''1010041'')
ORDER BY
    t.user_profile_option_name,
    a.level_id ASC',
      p_title                  => 'ICX/XDO Numeric Profiles',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This is a data collection of the ICX\XDO Numeric profile options.',
      p_solution               => '',
      p_success_msg            => 'Displaying ICX\XDO Numeric profile options.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_AR_IEXANLZ_ICX_XDO_PROFILES');



debug('begin add_signature: EBS_FIN_AR_IEX_GEN_MOAC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23224',
      p_sig_id                 => 'EBS_FIN_AR_IEX_GEN_MOAC',
      p_sig_sql                => 'SELECT
    decode(to_char(pov.level_id), ''10001'', ''Site'', ''10002'', ''Application'',
           ''10003'', ''Responsibility'', ''10004'', ''User'', ''10005'',
           ''Server'', ''10006'', ''Org'', ''10007'', ''Servresp'',
           ''???'')               "Level",
    decode(to_char(pov.level_id), ''10001'', ''Site'', ''10002'', nvl(app.application_short_name, to_char(pov.level_value)), ''10003'', nvl(rsp.
    responsibility_name, to_char(pov.level_value)), ''10004'', nvl(usr.user_name, to_char(pov.level_value)), ''10005'', svr.node_name, ''10006'',
    org.name,
           ''10007'', pov.level_value
                    || '', ''
                    || pov.level_value_application_id
                    || '', ''
                    || pov.level_value2, ''???'') "Context",
...
WHERE
    po.profile_option_name IN ( ''ORG_ID'', ''DEFAULT_ORG_ID'', ''XLA_MO_SECURITY_PROFILE_LEVEL'' )
    ...
    AND n.language = ''US''
    AND ( pov.level_id IN ( 10001, 10004, 10005, 10006, 10007 )
          OR ( pov.level_id = 10003
               AND rsp.application_id IN (222,695) )
          OR ( pov.level_id = 10002
               AND app.application_id IN (222,695) ) )
ORDER BY
    pov.level_id,
    "Context",
    "Profile Option"',
      p_title                  => 'MOAC Setup for Advanced Collections and Receivables',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This is a data collection of settings for MOAC (Advanced Collections  and Receivables)',
      p_solution               => '',
      p_success_msg            => 'Displaying MOAC profile settings for Advanced Collections and Receivables.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_IEX_GEN_MOAC');



debug('begin add_signature: IEX_CHECK_OPERATING_UNITS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15270',
      p_sig_id                 => 'IEX_CHECK_OPERATING_UNITS',
      p_sig_sql                => 'SELECT
    organization_id,
    name
FROM
...
order by organization_id',
      p_title                  => 'Display Operating Units',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no operating units defined.',
      p_solution               => '',
      p_success_msg            => 'Displaying operating unit information.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: IEX_CHECK_OPERATING_UNITS');



debug('begin add_signature: IEX_GEN_PARTY_DATA');
   l_info('##MASK##PARTY_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13034',
      p_sig_id                 => 'IEX_GEN_PARTY_DATA',
      p_sig_sql                => 'SELECT
    a.party_name,
    a.party_number,
    a.party_id,
...
AND 
    a.party_id = ##$$PRTYID$$## 
ORDER BY b.cust_account_id',
      p_title                  => 'Party Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This displays the party information.',
      p_solution               => '',
      p_success_msg            => 'Displaying Party information for this customer.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_PARTY_DATA');



debug('begin add_signature: IEX_GEN_SITE_INFO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13600',
      p_sig_id                 => 'IEX_GEN_SITE_INFO',
      p_sig_sql                => 'SELECT
    a.party_site_id,
    a.party_id,
    e.cust_account_id,
...
ORDER BY
    ...
    e.cust_account_id,
    d.site_use_id',
      p_title                  => 'Site Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This displays the site level information.',
      p_solution               => '',
      p_success_msg            => 'Displaying site level and language information for this customer.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_SITE_INFO');



debug('begin add_signature: IEX_GEN_AR_SUM_DATA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12775',
      p_sig_id                 => 'IEX_GEN_AR_SUM_DATA',
      p_sig_sql                => 'SELECT
    ''AR_SYSTEM_PARAMETERS'' "Table Name",
    ''DSO Days''             "Information",
    to_char(cer_dso_days)  "Value"
FROM
...
UNION
SELECT
    ''AR_TRX_BAL_SUMMARY''           "Table Name",
    ''Last Updated Date''            "Information",
    to_char(MAX(last_update_date)) "Value"
FROM
    ar_trx_bal_summary
UNION
SELECT
...
UNION
SELECT
    ''AR_CMGT_CHECK_LISTS''         "Table Name",
    ''Submitted Checklist for DSO'' "Information",
    to_char(COUNT(*))
FROM
    ar_cmgt_check_lists
WHERE
...
UNION
SELECT
    ''AR_CMG_SETUP_OPTIONS'' "Table Name",
    ''Record Count'' "Information",
    to_char(COUNT(*))
FROM
    ar_cmgt_setup_options',
      p_title                  => 'AR Summary Table Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This displays general data about the content in the AR summary tables.',
      p_solution               => '',
      p_success_msg            => 'Displaying general statistics from the AR Summary tables.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_AR_SUM_DATA');



debug('begin add_signature: IEX_GEN_AR_SUMMARY_PROFILE');
   l_info('##MASK##LEVEL VALUE'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19227',
      p_sig_id                 => 'IEX_GEN_AR_SUMMARY_PROFILE',
      p_sig_sql                => 'SELECT user_profile_option_name "Profile Option",
e.profile_option_name,
DECODE(a.level_id,
10001,''Site'',10002,''Application'',
...
AND a.level_value = d.user_id (+)
AND t.profile_option_name = e.profile_option_name
AND e.profile_option_name = ''AR_CMGT_ALLOW_SUMMARY_TABLE_REFRESH''
AND t.language = ''US''
AND nvl(c.language,''US'') = ''US''
AND ((a.level_id = 10003 OR (a.level_id = 10004) 
OR (a.level_id = 10001))  OR (a.level_id = 10002))
ORDER BY t.user_profile_option_name,
a.level_id ASC',
      p_title                  => 'AR Summary Table Profile Option',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'AR Summary Table Profile Option Setting',
      p_solution               => '',
      p_success_msg            => 'Displaying settings for the ''AR: Allow summary table refresh'' profile option.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_AR_SUMMARY_PROFILE');



debug('begin add_signature: IEX_GEN_PMTSCHED_COUNT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12335',
      p_sig_id                 => 'IEX_GEN_PMTSCHED_COUNT',
      p_sig_sql                => 'SELECT
    COUNT(*) "Number of Payment Schedules"
FROM
    ar_payment_schedules_all
WHERE
    org_id = ##$$ORGID$$##',
      p_title                  => 'Number of Payment Schedules',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This shows how many payment schedules exist.',
      p_solution               => '',
      p_success_msg            => 'Displaying the number of payment schedules that exist in the system.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_PMTSCHED_COUNT');



debug('begin add_signature: IEX_GEN_DELINQUENCIES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11729',
      p_sig_id                 => 'IEX_GEN_DELINQUENCIES_ALL',
      p_sig_sql                => 'SELECT
    COUNT(*)
FROM
...
WHERE
    ...
    AND org_id = ##$$ORGID$$##',
      p_title                  => 'Collections Delinquencies',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'If there are no delinquencies in IEX_DELINQUENCIES_ALL, the UWQ will not show any data as it is based on delinquencies, and dunning letters will not be created.
',
      p_solution               => 'Run the IEX: Scoring Engine Harness concurrent program to create delinquencies.  Review [2526374.1] How to Create Delinquencies in Advanced Collections for more information.
',
      p_success_msg            => 'Displaying the number of delinquencies that exist in the system.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_DELINQUENCIES_ALL');



debug('begin add_signature: EBS_FIN_AR_IEXANLZ_DEL_BUFFERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25009',
      p_sig_id                 => 'EBS_FIN_AR_IEXANLZ_DEL_BUFFERS',
      p_sig_sql                => 'SELECT
    COUNT(*)
FROM
    iex_del_buffers
',
      p_title                  => 'Delinquency Buffers',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the count of records in IEX_DEL_BUFFERS.',
      p_solution               => '',
      p_success_msg            => 'If there are records in IEX_DEL_BUFFERS, they should be removed by running the IEX: Clear Delinquency Buffers program.

Run  For more information, review [361718.1] IEX_DEL_BUFFERS not Being Cleared During IEX: Delinquency Management process',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_IEXANLZ_DEL_BUFFERS');



debug('begin add_signature: IEX_ORPH_DEL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12607',
      p_sig_id                 => 'IEX_ORPH_DEL',
      p_sig_sql                => 'SELECT
    payment_schedule_id, creation_date
FROM
    iex_delinquencies_all iex
WHERE
    NOT EXISTS (
        SELECT
            1
        ...
        WHERE
            iex.payment_schedule_id = ps.payment_schedule_id)
',
      p_title                  => 'Orphan Delinquencies',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying delinquencies in the system with no corresponding record in Receivables.  This could cause customers and invoices to show as Delinquent, when they are no longer delinquent.',
      p_solution               => 'You will need to remove the orphan records.  For more information, review [1622544.1] Customer Shows as Delinquent, But has No Delinquent Invoices.  ',
      p_success_msg            => 'There are no orphan delinquencies in Advanced Collections.',
   ...
   l_info.delete;
debug('end add_signature: IEX_ORPH_DEL');



debug('begin add_signature: IEX_GEN_COLLECTORS');
   l_info('##MASK##COLLECTOR NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##EMPLOYEE NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12328',
      p_sig_id                 => 'IEX_GEN_COLLECTORS',
      p_sig_sql                => 'SELECT
    a.name            "Collector Name",
    a.description     "Description",
    a.collector_id    "Collector Id",
    b.full_name       "Employee Name",
    a.employee_id     "Employee Id",
    a.resource_type   "Resource Type",
...
ORDER BY 
    name ASC',
      p_title                  => 'Collectors',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This is a data collection of the defined Collectors.',
      p_solution               => '',
      p_success_msg            => 'Displaying the Collectors created in the system.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_COLLECTORS');



debug('begin add_signature: IEX_GEN_FNDUSER_RSC_DETAILS');
   l_info('##MASK##FND USER NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##JTF USER NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##RESOURCE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22028',
      p_sig_id                 => 'IEX_GEN_FNDUSER_RSC_DETAILS',
      p_sig_sql                => 'SELECT
    fnd.user_id         "FND User ID",
    jtf.user_id         "JTF User ID",
    fnd.user_name       "FND User Name",
    jtf.user_name       "JTF User Name",
    fnd.employee_id     "FND Emp ID",
    jtf.source_id       "JTF Emp ID",
    fnd.start_date      "FND Start Date",
    fnd.end_date        "FND End Date",
    fnd.person_party_id "FND Party ID",
    jtf.person_party_id "JTF Party ID",
    jtf.resource_id,
    jtf.resource_number,
    jtf.resource_name,
    jtf.transaction_number
FROM
    fnd_user                 fnd,
    jtf_rs_resource_extns_vl jtf
WHERE
        fnd.user_id = jtf.user_id
AND jtf.transaction_number IS NOT NULL',
      p_title                  => 'FND User and Resources Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This is a data collection of the FND User and JTF Resource Links',
      p_solution               => '',
      p_success_msg            => 'Displaying the FND User and JTF Resource Details',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_FNDUSER_RSC_DETAILS');



debug('begin add_signature: IEX_GEN_CUSTOMER_PROFILES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11731',
      p_sig_id                 => 'IEX_GEN_CUSTOMER_PROFILES',
      p_sig_sql                => 'SELECT count(*) "Party Level Profiles"
FROM HZ_CUSTOMER_PROFILES 
WHERE cust_account_id = -1',
      p_title                  => 'Count of  Customers With a Party Level Profile Class',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'If there are no collectors assigned at the Customer level, the UWQ cannot display data in the Delinquent Customers node.
',
      p_solution               => 'If running Advanced Collections at the Customer Level, collectors need to be assigned at that level using TCA API [Note 1637029.2] or Oracle Territories [Note 1397139.1]',
      p_success_msg            => 'Displaying the number of customers with a Party level profile class.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_CUSTOMER_PROFILES');



debug('begin add_signature: IEX_GEN_COLLECTOR_NORESOURCE');
   l_info('##MASK##COLLECTOR NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##EMPLOYEE NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12344',
      p_sig_id                 => 'IEX_GEN_COLLECTOR_NORESOURCE',
      p_sig_sql                => 'SELECT
    a.name            "Collector Name",
    a.description     "Description",
    a.collector_id    "Collector Id",
...
ORDER BY
    name ASC',
      p_title                  => 'Collectors with No Resource Assigned',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The above list contains all collectors which are not assigned to a resource as corresponding resource columns are blank.  

<br>Receivables Collectors are used to assign work items, and display data in the UWQ. These Receivables collectors must have a resource assigned in order to function properly as collectors in Advanced Collections.<br>
',
      p_solution               => 'To fix manually, review [2544406.1] How to Attach an Employee to a Receivables Collector

<br>If the collectors are not used in Advanced Collections, or not assigned to a customer, they do not need a resource assigned.<br>',
      p_success_msg            => 'All Collectors are assigned to a Resource.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_COLLECTOR_NORESOURCE');



debug('begin add_signature: IEX_GEN_RESOURCE_GROUPS');
   l_info('##MASK##SOURCE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12329',
      p_sig_id                 => 'IEX_GEN_RESOURCE_GROUPS',
      p_sig_sql                => 'SELECT
    a.group_number,
    a.group_name,
    a.group_id,
...
FROM
    jtf_rs_groups_vl        a,
    jtf_rs_group_members    b,
    jtf_rs_resource_extns   e
WHERE
    SYSDATE BETWEEN a.start_date_active AND nvl(a.end_date_active, SYSDATE)
    AND b.group_id = a.group_id
    AND b.resource_id = e.resource_id
    AND b.delete_flag != ''Y''
    AND b.group_id IN (
        SELECT
            c.group_id
        FROM
            jtf_rs_group_usages c
        WHERE
            c.usage = ''IEX_COLLECTIONS''
    )
ORDER BY
    a.group_number',
      p_title                  => 'Resource Groups',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no Resource Groups defined for Collections.
',
      p_solution               => '',
      p_success_msg            => 'Displaying the Resource Groups defined for Collections.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_RESOURCE_GROUPS');



debug('begin add_signature: IEX_GEN_COLLECTIONS_AGENT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12342',
      p_sig_id                 => 'IEX_GEN_COLLECTIONS_AGENT',
      p_sig_sql                => 'SELECT
    b.resource_number   "Resource Number",
    b.resource_id       "Resource Id",
    b.category          "Resource Category",
    b.source_id         "Source Id"
FROM
    jtf_rs_role_relations      a,
    jtf_rs_resource_extns_vl   b
WHERE
    a.role_resource_type = ''RS_INDIVIDUAL''
...
ORDER BY
    b.resource_number ASC',
      p_title                  => 'Resources with Collections Agent Role',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This shows all Resources with the Collections Agent role.',
      p_solution               => '',
      p_success_msg            => 'Displaying all Resources with the Collections Agent role assigned.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_COLLECTIONS_AGENT');



debug('begin add_signature: IEX_GEN_COLLECTIONS_ADMIN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12339',
      p_sig_id                 => 'IEX_GEN_COLLECTIONS_ADMIN',
      p_sig_sql                => 'SELECT
    b.resource_number   "Resource Number",
    b.resource_id       "Resource Id",
    b.category          "Resource Category",
...
ORDER BY
    b.resource_number ASC',
      p_title                  => 'Users With Collections Administrator Role',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This shows all Resources having Collections Administrator role.
',
      p_solution               => '',
      p_success_msg            => 'Displaying all Resources with the Collections Administrator role assigned.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_COLLECTIONS_ADMIN');



debug('begin add_signature: IEX_GEN_COLLECTIONS_MGR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12341',
      p_sig_id                 => 'IEX_GEN_COLLECTIONS_MGR',
      p_sig_sql                => 'SELECT
    b.resource_number   "Resource Number",
    b.resource_id       "Resource Id",
    b.category          "Resource Category",
...
ORDER BY
    b.resource_number ASC',
      p_title                  => 'Resources with Collections Manager Role',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This shows all Resources with the Collections Manager role assigned.',
      p_solution               => '',
      p_success_msg            => 'Displaying all Resources with the Collections Manager role assigned.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_COLLECTIONS_MGR');



debug('begin add_signature: IEX_GEN_COLLECTIONS_ROLES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12338',
      p_sig_id                 => 'IEX_GEN_COLLECTIONS_ROLES',
      p_sig_sql                => 'SELECT
    role_type_code   "Type",
    role_code        "Code",
    role_name        "Name",
...
ORDER BY
    role_type_code,
    role_code',
      p_title                  => 'Collections and Sales Roles',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This is a data collections of the Collections and Sales roles.',
      p_solution               => '',
      p_success_msg            => 'Displaying all Resources with the Collections and Sales role assigned.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_COLLECTIONS_ROLES');



debug('begin add_signature: IEX_GEN_LOOKUPS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12336',
      p_sig_id                 => 'IEX_GEN_LOOKUPS',
      p_sig_sql                => 'SELECT
    lookup_type    "Lookup Code",
    lookup_code    "Lookup Value",
    meaning        "Meaning",
...
ORDER BY
    lookup_type,
    lookup_code DESC',
      p_title                  => 'Advanced Collections Lookups',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This is a data collection of the Advanced Collections Quickcodes.',
      p_solution               => '',
      p_success_msg            => 'Displaying the Advanced Collections quickcode/lookups definitions.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_LOOKUPS');



debug('begin add_signature: IEX_GEN_FULFILL_MESSAGES');
   l_info('##MASK##MESSAGE_TEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13602',
      p_sig_id                 => 'IEX_GEN_FULFILL_MESSAGES',
      p_sig_sql                => 'SELECT
    language_code,
    message_name,
    message_text,
...
WHERE
    ...
    AND message_name IN (
        ''IEX_FULFILL_BODY'',
        ''IEX_FULFILL_SUBJECT'',
        ''IEX_FULFILLMENT_SUBJECT''
    )',
      p_title                  => 'Fulfillment Related Application Messages',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This displays the applications messages and translations for the email subject and body.',
      p_solution               => '',
      p_success_msg            => 'Displaying defined Application Messages related to the email body and subject.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_FULFILL_MESSAGES');



debug('begin add_signature: IEX_CHECK_INSTALLED_LANGUAGES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14116',
      p_sig_id                 => 'IEX_CHECK_INSTALLED_LANGUAGES',
      p_sig_sql                => 'select LANGUAGE_CODE, DESCRIPTION
from FND_LANGUAGES_Vl
where INSTALLED_FLAG in (''I'',''B'')',
      p_title                  => 'Installed Languages',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Correspondence may only be created for installed languages.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: IEX_CHECK_INSTALLED_LANGUAGES');



debug('begin add_signature: IEX_TERRITORY_CMA_CONFIRMATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14202',
      p_sig_id                 => 'IEX_TERRITORY_CMA_CONFIRMATION',
      p_sig_sql                => 'SELECT  *
FROM    jty_trans_usg_pgm_sql
WHERE   source_id = -1600
AND     trans_type_id = -1601
AND     program_name = ''COLLECTIONS/CUSTOMER PROGRAM''',
      p_title                  => 'CMA Confirmation',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no seeded row defined with version_name = Oracle.

',
      p_solution               => '',
      p_success_msg            => 'Displaying seeded custom matching attribute details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_TERRITORY_CMA_CONFIRMATION');



debug('begin add_signature: IEX_TERRITORY_WINNERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14204',
      p_sig_id                 => 'IEX_TERRITORY_WINNERS',
      p_sig_sql                => 'SELECT
    trans_object_id         party_id,
    trans_detail_object_id  party_site_id,
    source_id,
    ...
    org_id
FROM
    jtf_tae_1600_cust_winners 
where trans_object_id = ##$$PRTYID$$##',
      p_title                  => 'Territory Winners',
      p_fail_condition         => 'NRS',
      p_problem_descr          => '<ul> 
<li>There are no territory winners for this party. </li>
<li>Since no winners exist, no collector will be assigned from Territory Management for this party. </li>
<li>Please review [1397139.1] How to Setup Territories/Resources/Collectors to work with R12 Collections, for more information on how this table is populated.</li>
</ul>',
      p_solution               => '',
      p_success_msg            => 'Displaying territory information for this party.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_TERRITORY_WINNERS');



debug('begin add_signature: IEX_CONFIRM_TERRITORY_CREATION');
   l_info('##MASK##SQUAL_CHAR01'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15271',
      p_sig_id                 => 'IEX_CONFIRM_TERRITORY_CREATION',
      p_sig_sql                => 'SELECT *
FROM   jtf_tae_1600_cust_trans
WHERE  trans_object_id = ##$$PRTYID$$##',
      p_title                  => 'JTF_TAE_1600_CUST_TRANS data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => '<ul> 
<li>There are no Territories created for this party. </li>
<li>If Territory Management is used to assign collectors, please review [1397139.1] How to Setup Territories/Resources/Collectors to work with R12 Collections, for details on creating territories for Advanced Collections.</li>
</ul>
',
      p_solution               => '',
      p_success_msg            => 'Displaying defined territories for this party.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: IEX_CONFIRM_TERRITORY_CREATION');



debug('begin add_signature: IEX_CANCEL_DISPUTES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18776',
      p_sig_id                 => 'IEX_CANCEL_DISPUTES',
      p_sig_sql                => 'SELECT
    request_id,
    customer_trx_id,
    total_amount,
...
WHERE
    ...
    AND to_char(request_id) IN (
        SELECT
            item_key
        FROM
            wf_item_activity_statuses_v
        WHERE
            item_type IN ( ''ARCMREQ'', ''ARAMECM'' )
            AND activity_name = ''CMREQ_APPROVAL''
...
WHERE
    ...
    AND NOT EXISTS (
        ...
        WHERE
            item_type IN ( ''ARCMREQ'', ''ARAMECM'' )
            AND item_key = to_char(request_id)
    )',
      p_title                  => 'Disputes in Approved Pending Approval Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Disputes are showing as Pending Approval but the Credit Memo Workflow is in a Complete Status.  ',
      p_solution               => '<ul>
<li>You may need a datafix script to address this issue.</li>
<li>Please log a Service Request and upload this analyzer output, and reference [1928786.1] Cancelling a Dispute in Advanced Collections Doesn''t Actually Cancel the Dispute</li>
</ul>',
      p_success_msg            => 'There are no pending credit requests for completed credit memos.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_CANCEL_DISPUTES');



debug('begin add_signature: EBS_FIN_AR_IEX_ALL_PROMISES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22857',
      p_sig_id                 => 'EBS_FIN_AR_IEX_ALL_PROMISES',
      p_sig_sql                => 'SELECT
    promise_detail_id,
    last_update_date,
    creation_date,
...
WHERE
    ...
    ',
      p_title                  => 'Promises Created for Customer',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This is a data collection of all promises created for this customer.
',
      p_solution               => '',
      p_success_msg            => 'Displaying all Promises created for this customer.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_IEX_ALL_PROMISES');



debug('begin add_signature: EBS_FIN_AR_IEXANLZ_BANKRUPTCY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25194',
      p_sig_id                 => 'EBS_FIN_AR_IEXANLZ_BANKRUPTCY',
      p_sig_sql                => 'SELECT
    *
FROM
    iex_bankruptcies
where 
    party_id = ##$$PRTYID$$##',
      p_title                  => 'Bankruptcies Created for Customer',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This is a data collection of all bankruptcies created for this customer.
',
      p_solution               => '',
      p_success_msg            => 'Displaying all Bankruptcies created for this customer.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_IEXANLZ_BANKRUPTCY');



debug('begin add_signature: EBS_FIN_AR_IEX_REC_WRONG_SITE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23616',
      p_sig_id                 => 'EBS_FIN_AR_IEX_REC_WRONG_SITE',
      p_sig_sql                => 'SELECT
    cr.cash_receipt_id,
    cr.receipt_number,
    cr.pay_from_customer,
    cr.customer_site_use_id,
    hzcas.cust_account_id real_cust_id,
    cr.program_id,
    cr.request_id
FROM
...
WHERE
        cr.pay_from_customer != hzcas.cust_account_id
    AND cr.customer_site_use_id = hzcs.site_use_id
    AND hzcs.cust_acct_site_id = hzcas.cust_acct_site_id  ',
      p_title                  => 'Receipts Attached to Incorrect Site',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying receipts in the system where there is a mismatch between the account and site on the receipt.  This could cause customers to display multiple times in the Delinquent Bill-To node of the UWQ.',
      p_solution               => 'Run a data fix to fix the problem records.  For more information, review [2702167.1] UWQ Delinquent Bill-to Node is Showing Duplicate Rows for Some Customers and Wrong Site Numbers',
      p_success_msg            => 'There are no receipts where the account and sites don''t match.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_IEX_REC_WRONG_SITE');



debug('begin add_signature: EBS_FIN_AR_IEXANLZ_METRIC_OU');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24772',
      p_sig_id                 => 'EBS_FIN_AR_IEXANLZ_METRIC_OU',
      p_sig_sql                => 'SELECT
    *
FROM
    iex_metric_operating_units',
      p_title                  => 'Metrics - By Operating Unit',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This displays the Metric data defined by Operating Unit',
      p_solution               => '',
      p_success_msg            => 'Displaying Operating Unit specific Metrics',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_IEXANLZ_METRIC_OU');
...
debug('begin add_signature: IEX_UWQ_PROFILES');
   l_info('##MASK##LEVEL VALUE'):= 'NO_MASK';
   l_info('##MASK##USER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12508',
      p_sig_id                 => 'IEX_UWQ_PROFILES',
      p_sig_sql                => 'SELECT
    c.profile_option_name,
    c.user_profile_option_name,
    DECODE(b.level_id, 10001, ''Site'', 10002, ''Application'', 10003, ''Responsibility'', 10004, ''User'') "Level",
    DECODE(b.level_id, 10001, ''Site'', 10002, f.application_short_name, 
           10003, e.responsibility_name, 10004, ##$$A$$##.mask_text(d.user_name,''##$$M$$##'')) "Level Value",
...
WHERE
    ...
    AND c.profile_option_name = a.profile_option_name
    AND c.profile_option_name IN (
        ...
        ''IEX_QOR_STRATEGY'',
        ''IEX_QOR_DUNNING'',
        ''IEU_QEN_STRATEGY_WORK_ITEMS:_CUSTOMER'',
        ...
        ''IEX_QEN_PLIST_ACCTS'',
        ''IEX_QEN_PLIST_ALL'',
        ''IEU_QOR_STRATEGY_WORK_ITEMS:_CUSTOMER'',
    ...
    AND b.level_value = f.application_id (+)
    AND c.language = ''US''
    AND nvl(c.language, ''US'') = ''US''
ORDER BY
    c.user_profile_option_name,
    b.level_id ASC',
      p_title                  => 'UWQ Related Profile Options',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Data collection of UWQ related profile options.',
      p_solution               => '',
      p_success_msg            => 'Displaying UWQ related profile option settings.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_UWQ_PROFILES');



debug('begin add_signature: IEX_GEN_DELINQUENCIES_CUSTOMER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11730',
      p_sig_id                 => 'IEX_GEN_DELINQUENCIES_CUSTOMER',
      p_sig_sql                => 'SELECT ##$$DELQ_CUST$$##
FROM
    iex_delinquencies_all
WHERE
    status in (''DELINQUENT'',''PREDELINQUENT'')
    AND party_cust_id = ##$$PRTYID$$##
ORDER BY
    cust_account_id,
    customer_site_use_id',
      p_title                  => 'Details of Delinquencies for This Customer',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'If there is no data in IEX_DELINQUENCIES_ALL for this customer, this customer will not show in the UWQ, be included in a dunning letter, or assigned a strategy.
',
      p_solution               => 'Run the IEX: Scoring Engine Harness concurrent program to create delinquencies.  Review [2526374.1] How to Create Delinquencies in Advanced Collections? for more information.
',
      p_success_msg            => 'This customer has delinquent transactions.  This will ensure they will be include in the UWQ, dunning, or strategies.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_DELINQUENCIES_CUSTOMER');



debug('begin add_signature: IEX_GEN_PMT_SCH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12962',
      p_sig_id                 => 'IEX_GEN_PMT_SCH',
      p_sig_sql                => 'SELECT
    a.trx_number,
    b.delinquency_id,
    b.status,
...
FROM
    ...
    iex_delinquencies_all      b
WHERE
    a.payment_schedule_id = b.payment_schedule_id (+)
...
ORDER BY
    a.due_date',
      p_title                  => 'Open Payment Schedule Information for Party ID ##$$PRTYID$$##',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This displays the open payment schedules for this customer (debits).  Showing criteria on why records may or may not be Delinquent in Advanced Collections.
',
      p_solution               => '',
      p_success_msg            => 'Displaying open payment schedules for this customer.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_PMT_SCH');



debug('begin add_signature: IEX_GEN_AR_TRX_BAL_SUMMARY');
   l_info('##MASK##REFERENCE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11727',
      p_sig_id                 => 'IEX_GEN_AR_TRX_BAL_SUMMARY',
      p_sig_sql                => 'SELECT
    *
FROM
    ar_trx_bal_summary
WHERE
    cust_account_id in (
      ...
      p_title                  => 'AR Summary Table Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'If there is no data in AR_TRX_BAL_SUMMARY for this customer account, this customer will not to show in the UWQ.
',
      p_solution               => 'You will need to run the Refresh AR Transactions Summary Tables program to populate\refresh this table.  Review [784274.1] Why is the UWQ blank or not Showing Correct Data? for more information.
',
      p_success_msg            => 'Data exists in the AR summary table for this customer.  No action required.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_AR_TRX_BAL_SUMMARY');



debug('begin add_signature: EBS_FIN_AR_IEXANLZ_AR_TRX_SUMMARY');
   l_info('##MASK##REFERENCE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25929',
      p_sig_id                 => 'EBS_FIN_AR_IEXANLZ_AR_TRX_SUMMARY',
      p_sig_sql                => 'SELECT
    *
FROM
    ar_trx_summary
...
order by as_of_date desc ',
      p_title                  => 'AR Trx Summary Table Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Display data from AR_TRX_SUMMARY for this customer.
',
      p_solution               => '',
      p_success_msg            => 'Data exists in the AR summary table for this customer.  ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_IEXANLZ_AR_TRX_SUMMARY');



debug('begin add_signature: IEX_UWQ_DLN_UWQ_SUMMARY');
   l_info('##MASK##ACCOUNT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ACCOUNT_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ADDRESS%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CITY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COLLECTOR_RESOURCE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   ...
   l_info('##MASK##PHONE_COUNTRY_CODE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PHONE_EXTENSION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PHONE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##POSTAL_CODE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PROVINCE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SCORE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##STATE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11728',
      p_sig_id                 => 'IEX_UWQ_DLN_UWQ_SUMMARY',
      p_sig_sql                => 'SELECT * 
FROM IEX_DLN_UWQ_SUMMARY 
WHERE party_id =##$$PRTYID$$##',
      p_title                  => 'IEX Summary Table Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'If there is no data in IEX_DLN_UWQ_SUMMARY for this customer account, this customer will not show in the UWQ.
',
      p_solution               => 'You will need to run the IEX: Populate UWQ Summary Table concurrent program to populate\refresh this table.  Review [784274.1] Why is the UWQ blank or not Showing Correct Data? for more information.
',
      p_success_msg            => 'Data exists in the IEX summary table for this customer.  No action required.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_UWQ_DLN_UWQ_SUMMARY');



debug('begin add_signature: IEX_GEN_COLLECTOR_ASSIGNMENT');
   l_info('##MASK##NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11732',
      p_sig_id                 => 'IEX_GEN_COLLECTOR_ASSIGNMENT',
      p_sig_sql                => 'SELECT
    a.name,
    h.collector_id,
    h.status,
    ...
    h.site_use_id,
    h.dunning_letters,
    h.dunning_letter_set_id,
    h.profile_class_id
FROM
    hz_customer_profiles   h,
    ar_collectors          a
WHERE
    party_id = ##$$PRTYID$$##
AND h.collector_id = a.collector_id
ORDER BY
    cust_account_id,
    site_use_id DESC',
      p_title                  => 'Profile Class Details for Party ID ##$$PRTYID$$##',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This shows the Collectors assigned to this Customer at all levels.
',
      p_solution               => '',
      p_success_msg            => 'Displaying the collectors assigned to this customer.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_COLLECTOR_ASSIGNMENT');



debug('begin add_signature: IEX_GEN_RESOURCE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11736',
      p_sig_id                 => 'IEX_GEN_RESOURCE',
      p_sig_sql                => 'SELECT
    resource_id,
    resource_number,
    source_id,
    ...
    person_party_id
FROM
    jtf_rs_resource_extns WHERE resource_id IN ( SELECT
                           resource_id
                       FROM
                           ar_collectors WHERE collector_id IN ( SELECT
                            collector_id
                        FROM
                            hz_customer_profiles WHERE party_id = ##$$PRTYID$$## AND resource_type = ''RS_RESOURCE'' )) order by resource_id',
      p_title                  => 'Resource Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Resource Details',
      p_solution               => '',
      p_success_msg            => 'Displaying details for the Resources assigned to this customer.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_RESOURCE');



debug('begin add_signature: IEX_UWQ_STRATEGY_WORK_ITEMS');
   l_info('##MASK##NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11745',
      p_sig_id                 => 'IEX_UWQ_STRATEGY_WORK_ITEMS',
      p_sig_sql                => 'SELECT
    wkitem.strategy_id strategy_id,
...
AND   str_temp.language = userenv(''LANG'')
AND   str.status_code IN (''OPEN'',''ONHOLD'')
AND   str.party_id = ##$$PRTYID$$##',
      p_title                  => 'Strategy Work Item Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No details exist for this customer.',
      p_solution               => '',
      p_success_msg            => 'Displaying open strategy work items for this customer.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_UWQ_STRATEGY_WORK_ITEMS');



debug('begin add_signature: IEX_UWQ_BROKEN_PROMISE_UWQ');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11742',
      p_sig_id                 => 'IEX_UWQ_BROKEN_PROMISE_UWQ',
      p_sig_sql                => 'SELECT pro.*
FROM  iex_promise_details pro,
      iex_delinquencies_all del
WHERE pro.status IN (''COLLECTABLE'',''PENDING'')
AND pro.state = ''BROKEN_PROMISE''
AND pro.amount_due_remaining > 0
AND del.delinquency_id = pro.delinquency_id
AND del.party_cust_id = ##$$PRTYID$$##
AND del.org_id = ##$$ORGID$$##',
      p_title                  => 'Broken Promise Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No broken promises exist for this customer.',
      p_solution               => '',
      p_success_msg            => 'Displaying broken promise details if any exist for this customer.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_UWQ_BROKEN_PROMISE_UWQ');



debug('begin add_signature: IEX_UWQ_AR_BUS_EVENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11725',
      p_sig_id                 => 'IEX_UWQ_AR_BUS_EVENTS',
      p_sig_sql                => 'SELECT
    we.name "Event Name",
    we.status "Event Status",
    wes.status "Subscription Status"
FROM
...
AND wes.owner_tag = ''AR''',
      p_title                  => 'AR Business Events',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'AR Business Events and Subscriptions.',
      p_solution               => '',
      p_success_msg            => 'Displaying AR business event data.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_UWQ_AR_BUS_EVENTS');



debug('begin add_signature: IEX_UWQ_BUS_EVENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11726',
      p_sig_id                 => 'IEX_UWQ_BUS_EVENTS',
      p_sig_sql                => 'SELECT
    we.name "Event Name",
    we.status "Event Status",
    wes.status "Subscription Status"
...
WHERE we.guid = wes.event_filter_guid
AND we.name LIKE ''oracle.apps.ar.%''
AND wes.owner_tag = ''IEX''',
      p_title                  => 'Collections Business Events',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'IEX Business Events and Subscriptions.',
      p_solution               => '',
      p_success_msg            => 'Displaying IEX business event data.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_UWQ_BUS_EVENTS');



debug('begin add_signature: EBS_FIN_AR_IEXANLZ_UWQ_ASSIGNMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26710',
      p_sig_id                 => 'EBS_FIN_AR_IEXANLZ_UWQ_ASSIGNMENTS',
      p_sig_sql                => 'SELECT
    *
FROM
    iex_assignments',
      p_title                  => 'Collections Resource Assignments',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This displays the details of any resources assignments defined.',
      p_solution               => '',
      p_success_msg            => 'Displaying existing resource assignments.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_IEXANLZ_UWQ_ASSIGNMENTS');



debug('begin add_signature: IEX_DUN_PROFILES');
   l_info('##MASK##LEVEL VALUE'):= 'NO_MASK';
   l_info('##MASK##USER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12511',
      p_sig_id                 => 'IEX_DUN_PROFILES',
      p_sig_sql                => 'SELECT
    c.user_profile_option_name,
    DECODE(b.level_id, 10001, ''Site'', 10002, ''Application'', 10003, ''Responsibility'', 10004, ''User'') "Level",
    DECODE(b.level_id, 10001, ''Site'', 10002, f.application_short_name, 
...
WHERE
    ...
    AND c.profile_option_name IN (
        ...
        ''IEX_CONTROL_DUNNING_XMLGEN'',
        ''IEX_COPY_DUNNING_COLLECTOR'',
...
ORDER BY
    c.user_profile_option_name,
    b.level_id ASC',
      p_title                  => 'Dunning Related Profile Options',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This is a data collection of the dunning related profile options.',
      p_solution               => '',
      p_success_msg            => 'Displaying dunning related profile options.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_DUN_PROFILES');



debug('begin add_signature: IEX_DUN_DUNNING_PLANS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12345',
      p_sig_id                 => 'IEX_DUN_DUNNING_PLANS',
      p_sig_sql                => 'SELECT
    dun.dunning_plan_id                "Dunning Plan ID",
    dun.name                           "Name",
    iex_utilities.get_lookup_meaning(''IEX_DUNNING_PLAN_TYPE'', dun.dunning_type) "Dunning Type",
    dun.start_date                     "Start Date",
    dun.end_date                       "End Date",
    dun.dunning_level                  "Dunning Level",
    dun.enabled_flag                   "Enabled",
    ab.bucket_name                     "Aging Bucket Name",
    sc.score_name                      "Scoring Engine",
    sc.jtf_object_code                 "Scoring Object",
    dun.grace_days                     " Use Grace Days ",
    dun.dun_disputed_items             "Include Disputed Items",
    dun.include_unused_payments_flag   "Include Unapplied Receipts",
    dun.include_current                "Include Current",
    dun.dunning_letter_set_id          "Letter Set Name"
FROM
    iex_dunning_plans_vl   dun,
    iex_scores             sc,
    ar_aging_buckets       ab
WHERE
    ab.aging_bucket_id (+) = dun.aging_bucket_id
    AND sc.score_id = dun.score_id
ORDER BY
    dun.dunning_plan_id',
      p_title                  => 'Dunning Plans',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This is a data collection of the defined dunning plans.
',
      p_solution               => '',
      p_success_msg            => 'Displaying Dunning Plans defined in the system.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_DUN_DUNNING_PLANS');



debug('begin add_signature: IEX_DUN_DUNNING_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12346',
      p_sig_id                 => 'IEX_DUN_DUNNING_DETAILS',
      p_sig_sql                => 'SELECT
    xref.dunning_plan_id    "Dunning Plan ID",
    xdo.template_name       "Template",
    xdo.template_code       "Template Code",
    xref.xdo_template_id    "Template",
    xref.fm_method          "Fulfilment Method",
    abl.report_heading1     "Bucket Line",
    abl.bucket_sequence_num "Bucket Sequence",
    abl.days_start          "Start",
    abl.days_to             "End",
    xref.score_range_low    "Score Low",
    xref.score_range_high   "Score High",
    xref.range_of_dunning_level_from    "Dunning Level From",
    xref.range_of_dunning_level_to      "Dunning Level To",
    xref.invoice_copies     "Include Invoices",
    xref.min_days_between_dunning   "Min Days",
    upper(xref.callback_flag) "Call Back",
    xref.callback_days      "Call Back days"
FROM
    iex_ag_dn_xref          xref,
    xdo_templates_vl        xdo,
    ar_aging_bucket_lines   abl
WHERE
    abl.aging_bucket_id (+) = xref.aging_bucket_id
    AND abl.aging_bucket_line_id  (+) = xref.aging_bucket_line_id
    AND xref.xdo_template_id = xdo.template_id
ORDER BY xref.dunning_plan_id, abl.bucket_sequence_num, xref.range_of_dunning_level_from',
      p_title                  => 'Dunning Plan Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This is a data collection of the dunning plan details.
',
      p_solution               => '',
      p_success_msg            => 'Displaying details of all dunning plans.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_DUN_DUNNING_DETAILS');



debug('begin add_signature: IEX_DUN_LTR_SET');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12507',
      p_sig_id                 => 'IEX_DUN_LTR_SET',
      p_sig_sql                => 'SELECT
    a.dunning_plan_id,
    a.name   "Dunning Plan Name",
    b.dunning_letter_set_id,
    b.name   "Dunning Letter Set Name"
FROM
    iex_dunning_plans_vl     a,
    ar_dunning_letter_sets   b
WHERE
    a.dunning_letter_set_id IS NOT NULL
    AND a.dunning_letter_set_id = b.dunning_letter_set_id',
      p_title                  => 'Dunning Plans Attached to AR Dunning Set',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The Dunning Letter Set Name field is populated on the Dunning Plan definition.
<br>This will only include delinquent customers who have that same value populated in the Customer form in Oracle Receivables in either the ''Account Profile'' tab (customer level) or the ''Profile'' tab (site level).<br>',
      p_solution               => 'Review [1542067.1] How to Setup and Troubleshoot Dunning Plans for steps to show and populate that field in Oracle Receivables.',
      p_success_msg            => 'No Dunning Plans have a Dunning Letter Set Name attached.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_DUN_LTR_SET');



debug('begin add_signature: EBS_FIN_AR_IEXANLZ_DUN_LETTER_SET');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26115',
      p_sig_id                 => 'EBS_FIN_AR_IEXANLZ_DUN_LETTER_SET',
      p_sig_sql                => 'SELECT
...
ORDER BY
    dunning_letter_set_id',
      p_title                  => 'Dunning Letter Sets',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This shows the existing Dunning Letter Sets.
',
      p_solution               => '',
      p_success_msg            => 'Displaying the dunning letter sets definitions.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_IEXANLZ_DUN_LETTER_SET');



debug('begin add_signature: IEX_DUN_SCR_RANGE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12490',
      p_sig_id                 => 'IEX_DUN_SCR_RANGE',
      p_sig_sql                => 'SELECT
    xref.dunning_plan_id      "Dunning Plan ID",
    abl.report_heading1       "Bucket Line",
    xref.score_range_low      "Score Low",
...
WHERE
    ...
    AND abl.aging_bucket_line_id (+) = xref.aging_bucket_line_id
    AND xref.xdo_template_id = xdo.template_id
    AND ( xref.score_range_low <> 1
          OR xref.score_range_high <> 100 )
ORDER BY
    xref.dunning_plan_id,
    abl.bucket_sequence_num,
    xref.range_of_dunning_level_from',
      p_title                  => 'Dunning with Incorrect Score Ranges',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are dunning rows with score ranges not defined 1-100 (Score Low and Score High should be 1 to 100 for each row). 
<br>If these ranges are not defined properly,  the IEX: Send Dunning to delinquent customers could fail with error: AgingBucketLineId NotFound <br>
',
      p_solution               => 'Review [468838.1] Aging Bucket Line Id Not Found Running IEX: Send Dunning for Delinquent Customers for requirements when setting up score ranges.',
      p_success_msg            => 'There are no incorrectly defined score ranges.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_DUN_SCR_RANGE');



debug('begin add_signature: IEX_DUN_INVALID_SCORING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12354',
      p_sig_id                 => 'IEX_DUN_INVALID_SCORING',
      p_sig_sql                => 'SELECT
    dp.dunning_plan_id   "Dunning Plan Id",
    dp.name              "Name",
    dp.dunning_level     "Dunning Level"
FROM
    iex_dunning_plans_vl dp
WHERE
    NOT EXISTS (SELECT 1
        FROM
            iex_scores sc
        WHERE
            sc.score_id = dp.score_id
            AND DECODE(dp.dunning_level, ''CUSTOMER'', ''PARTY'', ''ACCOUNT'', ''IEX_ACCOUNT'', ''BILL_TO'', ''IEX_BILLTO'', ''IEX_INVOICES'') = sc.jtf_object_code)
ORDER BY dp.dunning_plan_id',
      p_title                  => 'Dunning Plans with an Invalid Scoring Engine',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The Dunning Plans have an incorrect scoring engine attached (Example: Dunning Plan = Account Level, Scoring Engine = Bill to level)

<br> The levels must match.  Example: If the Dunning Plan is setup at the Account level, it should have an Account level scoring engine assigned.<br>',
      p_solution               => 'Review [1542067.1] How to Setup and Troubleshoot Dunning Plans',
      p_success_msg            => 'There are no dunning plans with an invalid scoring engine assigned.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_DUN_INVALID_SCORING');



debug('begin add_signature: EBS_FIN_AR_IEXANLZ_AG_DN_XREF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26390',
      p_sig_id                 => 'EBS_FIN_AR_IEXANLZ_AG_DN_XREF',
      p_sig_sql                => 'SELECT
    *
FROM
    iex_ag_dn_xref
ORDER BY
    ag_dn_xref_id',
      p_title                  => 'Dunning and Aging Cross Reference',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This displays the details of the cross reference between dunning and aging buckets.',
      p_solution               => '',
      p_success_msg            => 'Displaying Dunning\Aging cross reference definitions.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_IEXANLZ_AG_DN_XREF');



debug('begin add_signature: EBS_FIN_AR_IEXANLZ_PROFILE_CLASS_DEF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25890',
      p_sig_id                 => 'EBS_FIN_AR_IEXANLZ_PROFILE_CLASS_DEF',
      p_sig_sql                => 'SELECT
    *
FROM
...
WHERE
    profile_class_id IN (
        ...
        WHERE
            party_id = ##$$PRTYID$$##)',
      p_title                  => 'Profile Class Definitions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This shows the Profile Class definitions for the profiles assigned to this customer.
',
      p_solution               => '',
      p_success_msg            => 'Displaying the profile class definitions assigned to this customer.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_IEXANLZ_PROFILE_CLASS_DEF');



debug('begin add_signature: IEX_GEN_PROFILE_AMTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13995',
      p_sig_id                 => 'IEX_GEN_PROFILE_AMTS',
      p_sig_sql                => 'SELECT
    cust_account_id,
    site_use_id,
    currency_code,
...
ORDER BY
    cust_account_id,
    site_use_id DESC',
      p_title                  => 'Profile Amounts for Party ID',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This shows the profile amounts defined at all levels for this customer.',
      p_solution               => '',
      p_success_msg            => 'Displaying the profile amounts defined for this customer.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_PROFILE_AMTS');



debug('begin add_signature: IEX_DUN_DEL_BY_OU');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12353',
      p_sig_id                 => 'IEX_DUN_DEL_BY_OU',
      p_sig_sql                => 'SELECT
    ou.name      "Operating Unit",
    del.org_id   "Org Id",
    round(MAX(SYSDATE - ar.due_date), 0) "Age in days"
FROM
    iex_delinquencies_all      del,
    ar_payment_schedules_all   ar,
    hr_operating_units         ou
WHERE
    del.payment_schedule_id = ar.payment_schedule_id
    AND del.status IN (
        ''DELINQUENT'',
        ''PREDELINQUENT''
    )
    AND del.org_id = ou.organization_id
    AND del.party_cust_id = ##$$PRTYID$$##
GROUP BY
    del.org_id,
    ou.name',
      p_title                  => 'Age of Oldest Delinquency by Operating Unit',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Age of oldest delinquency by operating unit.',
      p_solution               => '',
      p_success_msg            => 'Displaying the oldest delinquency by each operating unit.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_DUN_DEL_BY_OU');



debug('begin add_signature: IEX_GEN_SCORE_HISTORY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12369',
      p_sig_id                 => 'IEX_GEN_SCORE_HISTORY',
      p_sig_sql                => 'SELECT
    score_history_id,
    creation_date,
    score_value,
...
FROM
    iex_score_histories
where score_object_id = ##$$PRTYID$$##
or score_object_id in (select cust_account_id from hz_cust_accounts where party_id = ##$$PRTYID$$##)
or score_object_id in (select site_use_id
from HZ_CUST_SITE_USES_ALL
where cust_acct_site_id in (select cust_acct_site_id
from HZ_CUST_ACCT_SITES_ALL
where cust_account_id in (select cust_account_id from hz_cust_accounts where party_id = ##$$PRTYID$$## ) ))
ORDER BY
    score_history_id DESC',
      p_title                  => 'Score History',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This customer has not been scored by any scoring engine.  Dunning and strategies both depend on a score.  ',
      p_solution               => 'Run the IEX: Scoring Engine Harness for the specific scoring engines used in your system.

<br>Review [471941.1] How Do You Run the Scoring Engines? for more information.<br>',
      p_success_msg            => 'This customer has the following scores created.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_SCORE_HISTORY');



debug('begin add_signature: IEX_GEN_XDO_TEMPLATES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12367',
      p_sig_id                 => 'IEX_GEN_XDO_TEMPLATES',
      p_sig_sql                => 'SELECT
    *
FROM
    xdo_templates_vl
WHERE
    application_short_name = ''IEX''
ORDER BY
    template_code',
      p_title                  => 'Bi Publisher Templates',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This displays the XDO templates for IEX.',
      p_solution               => '',
      p_success_msg            => 'Displaying all templates for Advanced Collections.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_XDO_TEMPLATES');



debug('begin add_signature: EBS_FIN_AR_IEXANLZ_IEX_XML_QUERIES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24709',
      p_sig_id                 => 'EBS_FIN_AR_IEXANLZ_IEX_XML_QUERIES',
      p_sig_sql                => 'SELECT
    query_id,
    description,
    start_date,
...
ORDER BY
    query_id',
      p_title                  => 'XML Queries',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This displays the date from IEX_XML_QUERIES',
      p_solution               => '',
      p_success_msg            => 'Displaying SQL query details for Advanced Collections templates.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_IEXANLZ_IEX_XML_QUERIES');



debug('begin add_signature: EBS_FIN_AR_IEXANLZ_QUERY_XREF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24710',
      p_sig_id                 => 'EBS_FIN_AR_IEXANLZ_QUERY_XREF',
      p_sig_sql                => 'SELECT
    *
FROM
    iex_query_temp_xref
ORDER BY
    template_id',
      p_title                  => 'XML Query XFREF',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This displays the date from IEX_QUERY_TEMP_XREF',
      p_solution               => '',
      p_success_msg            => 'Displaying SQL query cross reference details for Advanced Collections templates.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_IEXANLZ_QUERY_XREF');



debug('begin add_signature: IEX_STR_PROFILES');
   l_info('##MASK##LEVEL VALUE'):= 'NO_MASK';
   l_info('##MASK##USER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12510',
      p_sig_id                 => 'IEX_STR_PROFILES',
      p_sig_sql                => 'SELECT
    c.user_profile_option_name,
    DECODE(b.level_id, 10001, ''Site'', 10002, ''Application'', 10003, ''Responsibility'', 10004, ''User'') "Level",
    DECODE(b.level_id, 10001, ''Site'', 10002, f.application_short_name, 
...
ORDER BY
    c.user_profile_option_name,
    b.level_id ASC',
      p_title                  => 'Strategy Related Profile Options',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This is a data collection of the strategy related profile options.',
      p_solution               => '',
      p_success_msg            => 'Displaying strategy related profile options.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_STR_PROFILES');



debug('begin add_signature: EBS_FIN_AR_IEXANLZ_WI_SKILLS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24992',
      p_sig_id                 => 'EBS_FIN_AR_IEXANLZ_WI_SKILLS',
      p_sig_sql                => 'SELECT
    *
FROM
...
ORDER BY
    work_item_temp_id',
      p_title                  => 'Strategy Work Item Skills',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This shows Skills defined for work items',
      p_solution               => '',
      p_success_msg            => 'Displaying the skills assigned to work items.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_IEXANLZ_WI_SKILLS');



debug('begin add_signature: IEX_STR_UOM_SITE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12364',
      p_sig_id                 => 'IEX_STR_UOM_SITE',
      p_sig_sql                => 'SELECT
    unit_of_measure,
    uom_code,
    uom_class,
...
WHERE
    uom_class = (
        ...
        FROM
            ...
            fnd_profile_options_tl      t
        WHERE
            e.profile_option_name = ''JTF_TIME_UOM_CLASS''
            AND e.application_id = a.application_id
            AND a.profile_option_id = e.profile_option_id
            AND a.level_value = b.application_id (+)
            AND t.profile_option_name = e.profile_option_name
      ...
      p_title                  => 'UOM - Site Level',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This shows the UOM setting and conversions at the site level.',
      p_solution               => '',
      p_success_msg            => 'Displaying UOM and conversions for site level.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_STR_UOM_SITE');



debug('begin add_signature: IEX_STR_UOM_APP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12365',
      p_sig_id                 => 'IEX_STR_UOM_APP',
      p_sig_sql                => 'SELECT
    unit_of_measure,
    uom_code,
    uom_class,
...
WHERE
    uom_class = (
        ...
        WHERE
            ...
            AND t.profile_option_name = e.profile_option_name
            AND t.language = ''US''
            AND b.application_short_name = ''IEX''
    )',
      p_title                  => 'UOM - Application Level',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This shows the UOM setting and conversions at the application level for IEX.',
      p_solution               => '',
      p_success_msg            => 'Displaying UOM settings and conversions at the application level (Application = IEX).',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_STR_UOM_APP');



debug('begin add_signature: IEX_STR_STRATEGY_HIST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12355',
      p_sig_id                 => 'IEX_STR_STRATEGY_HIST',
      p_sig_sql                => 'SELECT
    str.strategy_id             strategy_id,
    str_temp.strategy_temp_id   strategy_temp_id,
    str_temp.strategy_name      strategy_name,
    ...
    str.creation_date,
    str_temp.created_by,
    str_temp.last_update_date,
    str_temp.last_updated_by,
    str.org_id
FROM
    iex_strategy_templates_vl   str_temp,
    iex_strategies              str
WHERE
    str_temp.strategy_temp_id = str.strategy_template_id
    AND str.party_id = ##$$PRTYID$$##
ORDER BY str.creation_date DESC,
  str.strategy_id',
      p_title                  => 'Strategies Created for Customer',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This customer has no strategies assigned.',
      p_solution               => '<li>For more information on Collection Strategies, please review <a href="https://docs.oracle.com/cd/E26401_01/doc.122/e48898/T387641T426675.htm#8629985" target="_blank">Oracle Advanced Collections Implementation Guide</a></li>',
      p_success_msg            => 'Displaying the strategy history for this customer.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_STR_STRATEGY_HIST');



debug('begin add_signature: IEX_STR_WI_HISTORY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12366',
      p_sig_id                 => 'IEX_STR_WI_HISTORY',
      p_sig_sql                => 'SELECT
    str.strategy_id,
    str_wi.work_item_id,
    str_wi.work_item_template_id,
    str_temp.name,
    str_wi.resource_id,
    str_wi.status_code,
    str.object_id,
    str.object_type,
    str_wi.execute_start,
    str_wi.execute_end,
    str_wi.creation_date,
    str_wi.created_by,
    str_wi.last_update_date,
    str_wi.last_updated_by,
    str_wi.schedule_start,
    str_wi.schedule_end,    
    dun.delivery_status
FROM
    iex_strategy_work_items       str_wi,
    iex_stry_temp_work_items_vl   str_temp,
    iex_strategies                str,    
    iex_dunnings                  dun
WHERE
    str_wi.strategy_id = str.strategy_id
    AND str_wi.work_item_template_id = str_temp.work_item_temp_id
    AND dun.object_id(+) = str_wi.work_item_id
    AND str.party_id = ##$$PRTYID$$##
    order by str.strategy_id desc, str_wi.work_item_id desc',
      p_title                  => 'Work Items Created for this Customer',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This shows the history of the work items assigned to this customer.',
      p_solution               => '',
      p_success_msg            => 'Displaying the assigned work item history for this customer.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_STR_WI_HISTORY');



debug('begin add_signature: IEX_STR_WI_ERROR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12357',
      p_sig_id                 => 'IEX_STR_WI_ERROR',
      p_sig_sql                => 'SELECT
    str.strategy_id            "Strategy Id",
    str.strategy_template_id   "Strategy Template Id",
    str.org_id                 "Org Id",
    str.status_code            "Status Code",
    str.score_value            "Score Value",
    str.object_id              "Object Id",
    str.object_type            "Object Type",
    str.strategy_level         "Strategy Level",
    str.creation_date          "Creation Date",
    str.created_by             "Created By",
    str.last_update_date       "Last Update Date",
    str.last_updated_by        "Last Updated By",
    xml.failure_reason         "Failure Reason"
FROM
    iex_strategies              str,
    iex_strategy_work_items     witm,
    iex_xml_request_histories   xml
WHERE
    str.status_code = ''INERROR''
    AND witm.strategy_id = str.strategy_id
    AND xml.object_id (+) = witm.work_item_id
    AND str.party_id = ##$$PRTYID$$##',
      p_title                  => 'Work Items with status In Error',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Displaying work items In Error Status.',
      p_solution               => '',
      p_success_msg            => 'Displaying work items that are In Error status.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_STR_WI_ERROR');



debug('begin add_signature: IEX_STR_WI_NOWF');
   l_info('##MASK##STRATEGY NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12358',
      p_sig_id                 => 'IEX_STR_WI_NOWF',
      p_sig_sql                => 'SELECT
    str.strategy_id            "Strategy Id",
    str_temp.strategy_name     "Strategy Name",
    wi.work_item_template_id   "Work Item Template Id",
    wivl.name                  "Name",
    wi.status_code             "Work Item Status",
    str.status_code            "Strategy Status",
    str.object_id              "Object Id",
    str.object_type            "Object Type"
FROM
    iex_strategy_templates_vl     str_temp,
    ...
    iex_stry_temp_work_items_vl   wivl
WHERE
    str.strategy_id = wi.strategy_id
    AND str.strategy_template_id = str_temp.strategy_temp_id
    AND wivl.work_item_temp_id = wi.work_item_template_id
    AND str.status_code IN (
        ''OPEN'',
        ''ONHOLD''
    )
    AND NOT EXISTS (
        ...
        FROM
            wf_items wf
        WHERE
            wf.item_key = str.strategy_id
            AND wf.item_type = ''IEXSTRY''
    )
    AND str.party_id = ##$$PRTYID$$##',
      p_title                  => 'Open Strategies without a Workflow',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This shows open strategies without a workflow attached.',
      p_solution               => 'Run iexswowf.sql from [1564676.1] How Do We Clean Up Various Types of Data in Advanced Collections? to cancel Open or OnHold Strategies without a workflow.
',
      p_success_msg            => 'Displaying open strategies with no workflow attached.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_STR_WI_NOWF');



debug('begin add_signature: IEX_STR_NO_WI');
   l_info('##MASK##SCORE VALUE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##STRATEGY NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12359',
      p_sig_id                 => 'IEX_STR_NO_WI',
      p_sig_sql                => 'SELECT
    str.strategy_id            "Strategy Id",
    str_temp.strategy_name     "Strategy Name",
    str.strategy_template_id   "Strategy Temp Id",
    str.org_id                 "Org Id",
    str.status_code            "Status Code",
    str.score_value            "Score Value",
    str.strategy_level         "Strategy Level",
...
WHERE
    ...
    AND NOT EXISTS (
        ...
        FROM
            iex_strategy_work_items wi
        WHERE
            wi.strategy_id = str.strategy_id
    )
    AND str.party_id = ##$$PRTYID$$##',
      p_title                  => 'Open strategies with no work items',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This shows open strategies without any assigned work items.',
      p_solution               => '',
      p_success_msg            => 'Displaying open strategies with no work items assigned.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_STR_NO_WI');



debug('begin add_signature: IEX_STR_WI_NOWF_AUTO');
   l_info('##MASK##STRATEGY NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12360',
      p_sig_id                 => 'IEX_STR_WI_NOWF_AUTO',
      p_sig_sql                => 'SELECT
    str.strategy_id            "Strategy Id",
    str_temp.strategy_name     "Strategy Name",
    wi.work_item_template_id   "Work Item Template Id",
...
FROM
    ...
    iex_strategy_work_items       wi,
    iex_stry_temp_work_items_vl   wivl,
    iex_stry_temp_work_items_b    witemp,
    iex_strategy_templates_vl     str_temp
WHERE
    str.strategy_id = wi.strategy_id
    AND wi.work_item_template_id = witemp.work_item_temp_id
    AND wi.work_item_template_id = wivl.work_item_temp_id
    AND witemp.work_type = ''AUTOMATIC''
    AND wi.status_code = ''OPEN''
    AND str_temp.strategy_temp_id = str.strategy_template_id
    AND NOT EXISTS (
        SELECT
            1
        FROM
    ...
    AND str.party_id = ##$$PRTYID$$##',
      p_title                  => 'Automatic Work Items With No Workflow',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Automatic work items with no workflow attached will not allow the strategy to progress to completion.',
      p_solution               => 'Run iexswowf.sql from [1564676.1] How Do We Clean Up Various Types of Data in Advanced Collections? to cancel Open or OnHold Strategies without a workflow.',
      p_success_msg            => 'Displaying automatic work items with no workflow.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_STR_WI_NOWF_AUTO');



debug('begin add_signature: IEX_STR_WI_AUTO_DAYS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12361',
      p_sig_id                 => 'IEX_STR_WI_AUTO_DAYS',
      p_sig_sql                => 'SELECT
    str.strategy_id            "Strategy Id",
    str_temp.strategy_name     "Strategy Name",
    wi.work_item_template_id   "Work Item Template Id",
...
WHERE
    ...
    AND witemp.work_type = ''AUTOMATIC''
    AND str_temp.strategy_temp_id = str.strategy_template_id
    AND wi.status_code IN (
        ''OPEN''
    )
    AND trunc(wi.execute_start + 2) < trunc(SYSDATE)
    AND str.party_id = ##$$PRTYID$$##',
      p_title                  => 'Automatic work items open for more than 2 days',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This shows any automatic work items that are open for > 2 days.',
      p_solution               => '',
      p_success_msg            => 'Displaying any automatic work items open for more than 2 days.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_STR_WI_AUTO_DAYS');



debug('begin add_signature: IEX_STR_WI_CHECK_NOTIFY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12362',
      p_sig_id                 => 'IEX_STR_WI_CHECK_NOTIFY',
      p_sig_sql                => 'SELECT
    str.strategy_id            "Strategy Id",
    str_temp.strategy_name     "Strategy Name",
    wi.work_item_template_id   "Work Item Template Id",
...
WHERE
    ...
    AND wi.work_item_id = xml.object_id (+)
    AND str.party_id = ##$$PRTYID$$##',
      p_title                  => 'Automatic Work Items in Error/Check Notification Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This shows any automatic work items in Error\Check Notification status.',
      p_solution               => 'Make the needed corrections, according to the error text within the application, as detailed in [2060799.1] What is the Proper Method for Resolving the Error - "In Error - Check Notification" on a Work Item?',
      p_success_msg            => 'Displaying automated work items in Error\Check Notification status.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_STR_WI_CHECK_NOTIFY');



debug('begin add_signature: IEX_STR_WI_NOPERF');
   l_info('##MASK##NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##STRATEGY NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12363',
      p_sig_id                 => 'IEX_STR_WI_NOPERF',
      p_sig_sql                => 'SELECT
    str.strategy_id            "Strategy Id",
    str_temp.strategy_name     "Strategy Name",
    wi.work_item_template_id   "Work Item Template Id",
...
WHERE
    ...
    AND wi.strategy_id = str.strategy_id
    AND str_temp.strategy_temp_id = str.strategy_template_id
    AND wivl.work_item_temp_id = wi.work_item_template_id
    AND str.status_code IN (
        ''OPEN'',
    ...
    AND str.party_id = ##$$PRTYID$$##',
      p_title                  => 'Fulfillment Work Items - No Performer',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This display fulfillment work items with workflow notifications with no performer issue.',
      p_solution               => 'Synchronize the workflow or cancel the strategy using the steps from: [1062396.1] Error Completing a Manual Work Item - APP-IEX-240328.',
      p_success_msg            => 'Showing fulfillment work items with no performer issues.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_STR_WI_NOPERF');
...
debug('begin add_signature: IEX_GEN_RDBMS_VERSION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12830',
      p_sig_id                 => 'IEX_GEN_RDBMS_VERSION',
...
',
      p_success_msg            => 'Displaying RDBMS Version.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_RDBMS_VERSION');



debug('begin add_signature: IEX_GEN_AR_PKG_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12731',
      p_sig_id                 => 'IEX_GEN_AR_PKG_VERSIONS',
...
order by 1',
      p_title                  => 'Oracle Advanced Collections (IEX) PL/SQL Package Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Could not locate Oracle Advanced Collections (IEX) PL/SQL package versions.',
      p_solution               => 'Please ensure that you have installed the Oracle Advanced Collections (IEX) application.',
      p_success_msg            => 'Displaying Oracle Advanced Collections (IEX) PL/SQL package versions.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_AR_PKG_VERSIONS');



debug('begin add_signature: IEX_GEN_FORM_LIB_RPT_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12732',
      p_sig_id                 => 'IEX_GEN_FORM_LIB_RPT_VERSIONS',
      p_sig_sql                => 'SELECT
    b.filename,
    a.version,
    a.creation_date,
...
ORDER BY
    1',
      p_title                  => 'Oracle Advanced Collections (IEX) Forms, Libraries and Reports Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Could not locate Oracle Advanced Collections (IEX) forms, libraries and reports versions.',
      p_solution               => 'Please ensure that you have installed the Oracle Advanced Collections (IEX) application.',
      p_success_msg            => 'Displaying Oracle Advanced Collections (IEX) forms, libraries and reports versions.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_FORM_LIB_RPT_VERSIONS');



debug('begin add_signature: IEX_GEN_ODF_FILE_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12733',
      p_sig_id                 => 'IEX_GEN_ODF_FILE_VERSIONS',
...
from ad_files
where app_short_name in (''IEX'') and ( upper(filename) like upper(''%.odf'') or upper(filename) like upper(''%.xdf''))
) files
where files.file_id = file_version.file_id
) que
where rank1 = 1
order by 1',
      p_title                  => 'Oracle Advanced Collections (IEX) .odf / .xdf Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Could not locate Oracle Advanced Collections (IEX) .odf or .xdf files.',
      p_solution               => 'Please ensure that you have applied the Oracle Advanced Collections (IEX) .odf and .xdf files.',
      p_success_msg            => 'Displaying Oracle Advanced Collections (IEX) .odf or .xdf file versions.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_ODF_FILE_VERSIONS');



debug('begin add_signature: IEX_GEN_INVALIDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12459',
      p_sig_id                 => 'IEX_GEN_INVALIDS',
      p_sig_sql                => 'SELECT
    a.object_name,
    DECODE(a.object_type, ''PACKAGE'', ''Package Spec'', ''PACKAGE BODY'', ''Package Body'', a.object_type) type,
    (
        SELECT
            ltrim(rtrim(substr(substr(c.text, instr(c.text, ''Header: '')), instr(substr(c.text, instr(c.text, ''Header: '')), '' '', 1
            , 1), instr(substr(c.text, instr(c.text, ''Header: '')), '' '', 1, 2) - instr(substr(c.text, instr(c.text, ''Header: '')), '' ''
            , 1, 1))))
            || '' - ''
            || ltrim(rtrim(substr(substr(c.text, instr(c.text, ''Header: '')), instr(substr(c.text, instr(c.text, ''Header: '')), '' ''
            , 1, 2), instr(substr(c.text, instr(c.text, ''Header: '')), '' '', 1, 3) - instr(substr(c.text, instr(c.text, ''Header: '')
            ), '' '', 1, 2))))
        FROM
            dba_source c
        WHERE
...
WHERE
    ...
    AND a.owner = ''APPS''
    AND ( a.object_name LIKE ''IEX%'' )
    AND a.status = ''INVALID''',
      p_title                  => 'Oracle Advanced Collections (IEX) Invalid PL/SQL Packages',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are invalid Oracle Advanced Collections (IEX) PL/SQL packages.',
...
<li>If you still have invalid objects, please review steps from [1325394.1] Troubleshooting Guide - Invalid Objects in the E-Business Suite Environment 11i and 12</li>
      ...
      p_success_msg            => 'There are no invalid objects for Oracle Receivables (AR) in the database.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_INVALIDS');



debug('begin add_signature: IEX_GEN_METADATA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12634',
      p_sig_id                 => 'IEX_GEN_METADATA',
      p_sig_sql                => 'SELECT title_text, db_view_name, grid_datasource_name
FROM
    jtf_grid_datasources_vl
WHERE
    grid_datasource_name LIKE ''IEX_%''    
ORDER BY title_text',
      p_title                  => 'Metadata Definitions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This is a data collections of the IEX related metadata.',
      p_solution               => '',
      p_success_msg            => 'Displaying Advanced Collections related Metadata definitions.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_METADATA');



debug('begin add_signature: IEX_GEN_METADATA_COL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12677',
      p_sig_id                 => 'IEX_GEN_METADATA_COL',
      p_sig_sql                => 'SELECT
    label_text,
    db_col_name,
...
FROM
    jtf_grid_cols_vl
WHERE
    grid_datasource_name = ''##$$FK3$$##''
ORDER BY
    query_seq',
      p_title                  => 'Metadata Columns',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no columns defined for this metadata definition.',
      p_solution               => '',
      p_success_msg            => 'Displaying the metadata column definitions.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: IEX_GEN_METADATA_COL');



debug('begin add_signature: IEX_GEN_METADATA_DEF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12676',
      p_sig_id                 => 'IEX_GEN_METADATA_DEF',
      p_sig_sql                => 'SELECT DISTINCT
    grid_datasource_name  "##$$FK3$$##",
    db_view_name,
    title_text,
...
WHERE
    application_id = 695',
      p_title                  => 'Metadata Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This is a data collection of the IEX related metadata.',
      p_solution               => '',
      p_success_msg            => 'Displaying Advanced Collections related Metadata definitions.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      ...
      p_limit_rows             => nvl('N','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('IEX_GEN_METADATA_COL'),
      p_include_in_dx_summary  => nvl('Y','N'),
      p_version                => '6'
      );
   l_info.delete;
debug('end add_signature: IEX_GEN_METADATA_DEF');



debug('begin add_signature: EBS_FIN_AR_IEXANLZ_AGING_AMOUNT_FLAG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25021',
      p_sig_id                 => 'EBS_FIN_AR_IEXANLZ_AGING_AMOUNT_FLAG',
      p_sig_sql                => 'SELECT
    label_text,
    visible_flag
FROM
    jtf_grid_cols_vl
WHERE
        grid_datasource_name = ''IEX_AGING_BUCKET_LINES''
    AND visible_flag = ''F''
    AND label_text = ''Amount''',
      p_title                  => 'Aging Tab Amount Flag',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The display flag for the Amount column is set to No (False).  This setting will not allow the Accounts Receivable Aging to show in the Aging tab of Advanced Collections.
',
      p_solution               => 'The Amount column can be displayed by default using the steps in the note below:

Review [549934.1] How Do You Make The Amount Column Appear In The Aging Tab By Default?',
      p_success_msg            => 'The display flag is set to Yes for the Amount column in the Aging tab of Advanced Collections.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_IEXANLZ_AGING_AMOUNT_FLAG');



debug('begin add_signature: EBS_FIN_AR_IEXANLZ_NOTE_CHAR');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##VERSION'):= 'left,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '26594',
      p_sig_id                 => 'EBS_FIN_AR_IEXANLZ_NOTE_CHAR',
      p_sig_sql                => 'SELECT
    adf.filename,
    adfv.version
FROM
...
WHERE
    ...
    AND ( ( ''12.2'' = substr(''12.2.11'', 1, 4)
            AND fnd_irep_loader_private.compare_versions(adfv.version, ''120.34.12020000.3'') = ''<'' ) )
    AND adf.app_short_name = ''JTF''
    AND adf.filename = ''JTFSTRMB.pls''
    AND adfv.version IN (
        SELECT
            "Current Version"
        FROM
            (
                SELECT
                    afv1.version    "Current Version", RANK()
                                                    OVER(PARTITION BY af1.filename
                                                         ORDER BY afv1.version_segment1 DESC, afv1.version_segment2 DESC,
                ...
                WHERE
                        af1.file_id = afv1.file_id
                    AND af1.filename IN ( ''JTFSTRMB.pls'' )
            )
        WHERE
            rankus = 1
    )
    ',
      p_title                  => 'Version of JTFSTRMB.pls ',
      p_fail_condition         => 'RS',
      p_problem_descr          => '<ul>
<li>The file <i>JTFSTRMB.pls </i> has a version lower than recommended.  This can note not to show in the Notes tab when they contain special characters.</li>
</ul>',
      p_solution               => '<ul>
<li>Upgrade to the latest file version of <i>JTFSTRMB.pls/i>.</li>
<li>For more information, review [2187825.1] Unable to View Notes in Notes Tab on Collections Form When Special Characters Exist.</li>
<li>For the most current recommendations, use the Patch Wizard or the Updates & Patches Tab in My Oracle Support.<br>
<li>Further guidance can be found in the following documents:</li>
<ul>
<li>[11086538] How to Find EBS Patches and EBS Technology Patches</li>
<li>[976188.1] R11i / R12 : Patch Wizard Utility</li>
<li>[10940175] Patch Wizard FAQ</li>
...
<li><b>Best Practice:</b> Always ensure that you are on the latest code with all recommended patches applied. This will help avoid known issues, prevent potential data corruption and provide the latest features and functionality. Having a proactive patching plan and periodic proactive patching process in place are the best ways to stay current.</li>
</ul>

',
      p_success_msg            => 'The file versions are compliant with recommendations in [2187825.1].',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_IEXANLZ_NOTE_CHAR');



debug('begin add_signature: EBS_FIN_AR_IEXANLZ_SEQ_MAXVALUE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28921',
      p_sig_id                 => 'EBS_FIN_AR_IEXANLZ_SEQ_MAXVALUE',
      p_sig_sql                => 'SELECT sequence_name, max_value
FROM    dba_sequences
WHERE sequence_name in (''IEX_SCORE_HISTORIES_S'', ''IEX_DEL_BUFFERS_S'')
AND       max_value < 9999999999999999999999999999',
      p_title                  => 'IEX Sequences with a Maximum Value',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found IEX sequences with a maximum value',
      p_solution               => '<ul><li>The analyzer has identified the problem described in [377516.1]</li>
<li>Please review the note above and implement the solution to avoid issues with these sequences in the future</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_IEXANLZ_SEQ_MAXVALUE');



debug('begin add_signature: EBS_FIN_AR_IEXANLZ_CLOSED_INV');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##VERSION'):= 'left,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '31012',
      p_sig_id                 => 'EBS_FIN_AR_IEXANLZ_CLOSED_INV',
      p_sig_sql                => 'SELECT
    adf.filename,
    adfv.version
FROM
...
WHERE
        adf.file_id = adfv.file_id
    AND ( ( ''12.2'' = substr(''12.2.11'', 1, 4)
            AND fnd_irep_loader_private.compare_versions(adfv.version, ''120.95.12020000.31'') = ''<'' ) )
    AND adf.app_short_name = ''IEX''
    AND adf.filename = ''IEXTRLIB.pll''
    AND adfv.version IN (
        SELECT
            "Current Version"
        FROM
            (
                ...
                WHERE
                        af1.file_id = afv1.file_id
                    AND af1.filename IN ( ''IEXTRLIB.pll'' )
            )
        WHERE
            rankus = 1
    )
    ',
      p_title                  => 'Version of IEXTRLIB.pll',
      p_fail_condition         => 'RS',
      p_problem_descr          => '<ul>
<li>The file <i>IEXTRLIB.pll </i> has a version lower than recommended.  This can cause closed invoices to not be displayed in the Transactions tab.</li>
</ul>',
      p_solution               => '<ul>
<li>Upgrade to the latest file version of <i>IEXTRLIB.pll/i>.</li>
<li>For more information, review [2874655.1 Unable to Display Closed Invoices in the Advanced Collections Transactions Tab in 12.2.11.</li>
<li>For the most current recommendations, use the Patch Wizard or the Updates & Patches Tab in My Oracle Support.<br>
<li>Further guidance can be found in the following documents:</li>
<ul>
<li>[11086538] How to Find EBS Patches and EBS Technology Patches</li>
...
',
      p_success_msg            => 'The file versions are compliant with recommendations in [2874655.1].',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_IEXANLZ_CLOSED_INV');
...
BEGIN
  ...
  analyzer_title := 'Advanced Collections Analyzer';
...
debug('begin section: General');
start_section('General', 'General');
   set_item_result(run_stored_sig('IEX_GEN_PROD_INSTALL'));
   set_item_result(run_stored_sig('IEX_GEN_APP_PREFERENCES_VL'));
   set_item_result(run_stored_sig('IEX_GEN_METHOD'));
   set_item_result(run_stored_sig('IEX_GEN_OU_SETTINGS'));
   set_item_result(run_stored_sig('IEX_APPLIED_PATCHES_R12'));
   set_item_result(run_stored_sig('IEX_GEN_MAX_ROWS'));
   set_item_result(run_stored_sig('IEX_GEN_SCR_ENGINES'));
   set_item_result(run_stored_sig('IEX_GEN_SCORING_ENGINES'));
   set_item_result(run_stored_sig('IEX_GEN_SCORE_COMPONENTS'));
   set_item_result(run_stored_sig('IEX_GEN_DEL_STATUS'));
   set_item_result(run_stored_sig('IEX_GEN_SCOREHIST_COUNT'));
   set_item_result(run_stored_sig('IEX_STR_GROUP'));
   set_item_result(run_stored_sig('IEX_GEN_STR_TMP'));
   set_item_result(run_stored_sig('IEX_GEN_STRATEGY_TEMPLATES'));
   set_item_result(run_stored_sig('IEX_GEN_WORK_ITEMS'));
   set_item_result(run_stored_sig('IEX_GEN_FILTERS'));
   set_item_result(run_stored_sig('IEX_GEN_PROFILE_ OPTIONS'));
   set_item_result(run_stored_sig('EBS_AR_IEXANLZ_ICX_XDO_PROFILES'));
   set_item_result(run_stored_sig('EBS_FIN_AR_IEX_GEN_MOAC'));
   set_item_result(run_stored_sig('IEX_CHECK_OPERATING_UNITS'));
   set_item_result(run_stored_sig('IEX_GEN_PARTY_DATA'));
   set_item_result(run_stored_sig('IEX_GEN_SITE_INFO'));
   set_item_result(run_stored_sig('IEX_GEN_AR_SUM_DATA'));
   set_item_result(run_stored_sig('IEX_GEN_AR_SUMMARY_PROFILE'));
   set_item_result(run_stored_sig('IEX_GEN_PMTSCHED_COUNT'));
   set_item_result(run_stored_sig('IEX_GEN_DELINQUENCIES_ALL'));
   set_item_result(run_stored_sig('EBS_FIN_AR_IEXANLZ_DEL_BUFFERS'));
   set_item_result(run_stored_sig('IEX_ORPH_DEL'));
   set_item_result(run_stored_sig('IEX_GEN_COLLECTORS'));
   set_item_result(run_stored_sig('IEX_GEN_FNDUSER_RSC_DETAILS'));
   set_item_result(run_stored_sig('IEX_GEN_CUSTOMER_PROFILES'));
   set_item_result(run_stored_sig('IEX_GEN_COLLECTOR_NORESOURCE'));
   set_item_result(run_stored_sig('IEX_GEN_RESOURCE_GROUPS'));
   set_item_result(run_stored_sig('IEX_GEN_COLLECTIONS_AGENT'));
   set_item_result(run_stored_sig('IEX_GEN_COLLECTIONS_ADMIN'));
   set_item_result(run_stored_sig('IEX_GEN_COLLECTIONS_MGR'));
   set_item_result(run_stored_sig('IEX_GEN_COLLECTIONS_ROLES'));
   set_item_result(run_stored_sig('IEX_GEN_LOOKUPS'));
   set_item_result(run_stored_sig('IEX_GEN_FULFILL_MESSAGES'));
   set_item_result(run_stored_sig('IEX_CHECK_INSTALLED_LANGUAGES'));
   set_item_result(run_stored_sig('IEX_TERRITORY_CMA_CONFIRMATION'));
   set_item_result(run_stored_sig('IEX_TERRITORY_WINNERS'));
   set_item_result(run_stored_sig('IEX_CONFIRM_TERRITORY_CREATION'));
   set_item_result(run_stored_sig('IEX_CANCEL_DISPUTES'));
   set_item_result(run_stored_sig('EBS_FIN_AR_IEX_ALL_PROMISES'));
   set_item_result(run_stored_sig('EBS_FIN_AR_IEXANLZ_BANKRUPTCY'));
   set_item_result(run_stored_sig('EBS_FIN_AR_IEX_REC_WRONG_SITE'));
   set_item_result(run_stored_sig('EBS_FIN_AR_IEXANLZ_METRIC_OU'));
end_section;
debug('end section: General');

debug('begin section: UWQ');
IF p_uwq = 'Y' THEN
   start_section('Universal Work Queue', 'UWQ');
      set_item_result(run_stored_sig('TCA_HZ_PARTIES'));
      set_item_result(run_stored_sig('IEX_UWQ_PROFILES'));
      set_item_result(run_stored_sig('IEX_GEN_DELINQUENCIES_ALL'));
      set_item_result(run_stored_sig('IEX_GEN_DELINQUENCIES_CUSTOMER'));
      set_item_result(run_stored_sig('IEX_GEN_PMT_SCH'));
      set_item_result(run_stored_sig('IEX_GEN_AR_TRX_BAL_SUMMARY'));
      set_item_result(run_stored_sig('EBS_FIN_AR_IEXANLZ_AR_TRX_SUMMARY'));
      set_item_result(run_stored_sig('IEX_UWQ_DLN_UWQ_SUMMARY'));
      set_item_result(run_stored_sig('IEX_GEN_COLLECTOR_ASSIGNMENT'));
      set_item_result(run_stored_sig('IEX_GEN_RESOURCE'));
      set_item_result(run_stored_sig('IEX_UWQ_STRATEGY_WORK_ITEMS'));
      set_item_result(run_stored_sig('IEX_UWQ_BROKEN_PROMISE_UWQ'));
      set_item_result(run_stored_sig('IEX_UWQ_AR_BUS_EVENTS'));
      set_item_result(run_stored_sig('IEX_UWQ_BUS_EVENTS'));
      set_item_result(run_stored_sig('EBS_FIN_AR_IEXANLZ_UWQ_ASSIGNMENTS'));
   end_section;
END IF;
debug('end section: UWQ');

debug('begin section: DUNNING');
IF p_dunning = 'Y' THEN
   start_section('Dunning', 'DUNNING');
      set_item_result(run_stored_sig('TCA_HZ_PARTIES'));
      set_item_result(run_stored_sig('IEX_DUN_PROFILES'));
      set_item_result(run_stored_sig('IEX_DUN_DUNNING_PLANS'));
      set_item_result(run_stored_sig('IEX_DUN_DUNNING_DETAILS'));
      set_item_result(run_stored_sig('IEX_DUN_LTR_SET'));
      set_item_result(run_stored_sig('EBS_FIN_AR_IEXANLZ_DUN_LETTER_SET'));
      set_item_result(run_stored_sig('IEX_DUN_SCR_RANGE'));
      set_item_result(run_stored_sig('IEX_DUN_INVALID_SCORING'));
      set_item_result(run_stored_sig('EBS_FIN_AR_IEXANLZ_AG_DN_XREF'));
      set_item_result(run_stored_sig('IEX_GEN_COLLECTOR_ASSIGNMENT'));
      set_item_result(run_stored_sig('EBS_FIN_AR_IEXANLZ_PROFILE_CLASS_DEF'));
      set_item_result(run_stored_sig('IEX_GEN_PROFILE_AMTS'));
      set_item_result(run_stored_sig('IEX_GEN_DELINQUENCIES_CUSTOMER'));
      set_item_result(run_stored_sig('IEX_GEN_PMT_SCH'));
      set_item_result(run_stored_sig('IEX_DUN_DEL_BY_OU'));
      set_item_result(run_stored_sig('IEX_GEN_SCORE_HISTORY'));
      set_item_result(run_stored_sig('IEX_GEN_XDO_TEMPLATES'));
      set_item_result(run_stored_sig('EBS_FIN_AR_IEXANLZ_IEX_XML_QUERIES'));
      set_item_result(run_stored_sig('EBS_FIN_AR_IEXANLZ_QUERY_XREF'));
   end_section;
END IF;
debug('end section: DUNNING');

debug('begin section: STRATEGY');
IF p_strategy = 'Y' THEN
   start_section('Strategy', 'STRATEGY');
      set_item_result(run_stored_sig('TCA_HZ_PARTIES'));
      set_item_result(run_stored_sig('IEX_STR_PROFILES'));
      set_item_result(run_stored_sig('IEX_GEN_COLLECTOR_ASSIGNMENT'));
      set_item_result(run_stored_sig('EBS_FIN_AR_IEXANLZ_PROFILE_CLASS_DEF'));
      set_item_result(run_stored_sig('IEX_GEN_PROFILE_AMTS'));
      set_item_result(run_stored_sig('IEX_STR_GROUP'));
      ...
      set_item_result(run_stored_sig('IEX_GEN_STRATEGY_TEMPLATES'));
      set_item_result(run_stored_sig('IEX_GEN_WORK_ITEMS'));
      set_item_result(run_stored_sig('EBS_FIN_AR_IEXANLZ_WI_SKILLS'));
      set_item_result(run_stored_sig('IEX_GEN_FILTERS'));
      set_item_result(run_stored_sig('IEX_STR_UOM_SITE'));
      set_item_result(run_stored_sig('IEX_STR_UOM_APP'));
      set_item_result(run_stored_sig('IEX_STR_STRATEGY_HIST'));
      set_item_result(run_stored_sig('IEX_STR_WI_HISTORY'));
      set_item_result(run_stored_sig('IEX_STR_WI_ERROR'));
      set_item_result(run_stored_sig('IEX_STR_WI_NOWF'));
      set_item_result(run_stored_sig('IEX_STR_NO_WI'));
      set_item_result(run_stored_sig('IEX_STR_WI_NOWF_AUTO'));
      set_item_result(run_stored_sig('IEX_STR_WI_AUTO_DAYS'));
      set_item_result(run_stored_sig('IEX_STR_WI_CHECK_NOTIFY'));
      set_item_result(run_stored_sig('IEX_STR_WI_NOPERF'));
      set_item_result(run_stored_sig('IEX_GEN_XDO_TEMPLATES'));
      set_item_result(run_stored_sig('IEX_GEN_SCORE_HISTORY'));
      set_item_result(run_stored_sig('IEX_GEN_DELINQUENCIES_CUSTOMER'));
      set_item_result(run_stored_sig('IEX_GEN_PMT_SCH'));
...
start_section('Setup and Environment', 'Consolidated_Setup');
   ...
   IF p_apps_check = 'Y' THEN
      set_item_result(run_stored_sig('IEX_GEN_RDBMS_VERSION'));
      set_item_result(run_stored_sig('IEX_GEN_AR_PKG_VERSIONS'));
      set_item_result(run_stored_sig('IEX_GEN_FORM_LIB_RPT_VERSIONS'));
      set_item_result(run_stored_sig('IEX_GEN_ODF_FILE_VERSIONS'));
      set_item_result(run_stored_sig('IEX_GEN_INVALIDS'));
      set_item_result(run_stored_sig('IEX_GEN_METADATA'));
      set_item_result(run_stored_sig('IEX_GEN_METADATA_DEF'));
      set_item_result(run_stored_sig('EBS_FIN_AR_IEXANLZ_AGING_AMOUNT_FLAG'));
      set_item_result(run_stored_sig('EBS_FIN_AR_IEXANLZ_NOTE_CHAR'));
      set_item_result(run_stored_sig('EBS_FIN_AR_IEXANLZ_SEQ_MAXVALUE'));
      set_item_result(run_stored_sig('EBS_FIN_AR_IEXANLZ_CLOSED_INV'));
   END IF;
end_section;
