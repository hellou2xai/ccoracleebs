...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for iReceivables Analyzer                  |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE irec_analyzer_pkg AUTHID DEFINER AS
...
END irec_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY irec_analyzer_pkg AS
-- $Id: irec_analyzer.sql, 200.12 2025/12/08 13:51:58 jnieman Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2652175.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'IRECANLZ_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'IRECANLZ_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>IRECANLZ Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2652175.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/irec_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,2755,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,2755,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},2755,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/mosc/discussion/4478453" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">2755</span>
...
<p>New Items:</p><ul><li>Added signatures to check sequences for 11g and 12C databases</li>
</ul>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,2755,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,2755,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},2755,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
BEGIN
    ...
    print_log('Processing recommended patches signature: OIR_REC_PATCHES (check_rec_patches_1) "Recommended Patches" (version 2)');
...
IF substr(g_rep_info('Apps Version'),1,2) = '12' THEN
   ...
   l_col_rows(1)(l_rows) := '4442900';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIR.A';
   l_col_rows(5)(l_rows) := '[1475230.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '5884354';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIR.A.DELTA.1';
   l_col_rows(5)(l_rows) := '[1475230.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '6000570';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIR.A.DELTA.2';
   l_col_rows(5)(l_rows) := '[1475230.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '6250329';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIR.A.DELTA.3';
   l_col_rows(5)(l_rows) := '[1475230.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '6493811';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIR.A.DELTA.4';
   l_col_rows(5)(l_rows) := '[1475230.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '6833136';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'OIR.A.DELTA.5';
   l_col_rows(5)(l_rows) := '[1475230.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '7293858';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIR.A.DELTA.6';
   l_col_rows(5)(l_rows) := '[1475230.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '4565284';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIR.B';
   l_col_rows(5)(l_rows) := '[1475230.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '7456877';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIR.B.DELTA.1';
   l_col_rows(5)(l_rows) := '[1475230.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '8517010';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIR.B.DELTA.2';
   l_col_rows(5)(l_rows) := '[1475230.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '9244845';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIR.B.DELTA.3';
   l_col_rows(5)(l_rows) := '[1475230.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '9944857';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIR.B - OIR: MAY 2010 ONE-OFF PATCH FOR 12.1.1/12.1.2/12.1.3';
   l_col_rows(5)(l_rows) := '[1475230.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '12679032';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIR.B - OIR: JUN 2011 ONE-OFF PATCH WITH POST 12.1.3 PATCHES';
   l_col_rows(5)(l_rows) := '[1475230.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '14307553';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIR.B - R12.1: iReceivables OIR Recommended Patch Collections RPC AUG 2012';
   l_col_rows(5)(l_rows) := '[1475230.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '16009572';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIR.B - R12.1 iReceivables RPC March 2013';
   l_col_rows(5)(l_rows) := '[1475230.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '17043522';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIR.B - R12.1 iReceivables RPC September 2013';
   l_col_rows(5)(l_rows) := '[1475230.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19011141';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIR.B - Important Fixes in iReceivables 12.1.3.4 and SEP RPC 2013';
   l_col_rows(5)(l_rows) := '[1475230.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19523788';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIR.B - Important Fixes in iReceivables on top of SEP 2013 V2';
   l_col_rows(5)(l_rows) := '[1475230.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '18028409';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIR.B - OIR - RPC MAR 2014';
   l_col_rows(5)(l_rows) := '[1475230.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19052386';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIR.B - OIR - RPC AUG 2014';
   l_col_rows(5)(l_rows) := '[1475230.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '20227874';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIR.B - OIR - RPC FEB 2015';
   l_col_rows(5)(l_rows) := '[1475230.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21277878';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIR.B - OIR - RPC AUG 2015';
   l_col_rows(5)(l_rows) := '[1475230.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '22471980';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIR.B - OIR - RPC FEB 2016';
   l_col_rows(5)(l_rows) := '[1475230.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.1.3 RPC1';
   l_col_rows(5)(l_rows) := '[1475230.1]';
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '18491990';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.AD.C.Delta.4 - R12.AD.C';
   l_col_rows(5)(l_rows) := '[1475230.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '18497540';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.TXK.C.Delta.4 - R12.TXK.C)PATCH';
   l_col_rows(5)(l_rows) := '[1475230.1]';
...
<li>[1475230.1] Current Required Patches for iReceivables CU/PRC Release Level for Release 11i and 12</li>
</ul>
...
';
  ...
  -- Register
  l_step := '60';
  g_signatures('OIR_REC_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'OIR_REC_PATCHES',     -- sig ID
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2025/12/08 13:51:57 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'irec_analyzer.sql';
...
EXCEPTION
when no_data_found then
print_log('invalid username');

END;

-- Validate Get Org ID and LEDGER ID

   BEGIN
    select ar.org_id, hr.name
      into g_org_id, g_ou_name
...
debug('begin populate sql tokens hash table');
   ...
   g_sql_tokens('##$$USER_NAME$$##') := g_user_name;
   g_masked_tokens('##$$USER_NAME$$##') := mask_text( g_sql_tokens('##$$USER_NAME$$##'), 'DISPLAY_BOTH_25_PCNT_WORD');
   g_sql_tokens('##$$A$$##') := 'irec_analyzer_pkg';
...
debug('begin add_signature: OIR_USER_INFO');
...
WHERE
    user_id = ##$$USER_ID$$##',
      p_title                  => 'User Information for ##$$USER_NAME$$##',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying user information of ##$$USER_NAME$$##.
',
      p_solution               => '',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: OIR_USER_INFO');



debug('begin add_signature: OIR_USER_RESP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14440',
      p_sig_id                 => 'OIR_USER_RESP',
      p_sig_sql                => 'SELECT
    rvl.responsibility_name,
    rvl.responsibility_key,
    rvl.responsibility_id,
    rvl.application_id,
    rvl.version,
    rvl.start_date,
    rvl.end_date,
    rvl.last_update_date,
    rvl.last_updated_by,
    rvl.creation_date,
    rvl.created_by,
...
FROM
    ...
    fnd_responsibility_vl   rvl
WHERE
    urg.user_id = ##$$USER_ID$$##  
    AND urg.responsibility_id = rvl.responsibility_id',
      p_title                  => 'User Responsibilities of ##$$USER_NAME$$##',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no responsibilities assigned to ##$$USER_NAME$$##.',
      p_solution               => '',
      p_success_msg            => 'Displaying the responsibilities assigned to ##$$USER_NAME$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OIR_USER_RESP');



debug('begin add_signature: OIR_HZ_PERSON');
...
WHERE
    party_id = (
      ...
      p_title                  => 'Party Information of ##$$USER_NAME$$##',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no party information for ##$$USER_NAME$$##.',
      p_solution               => '',
      p_success_msg            => 'Displaying party information of ##$$USER_NAME$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OIR_HZ_PERSON');



debug('begin add_signature: OIR_HZ_CONTACT_INFO');
   l_info('##MASK##%ADDRESS%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##%NAME%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##%PHONE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15237',
      p_sig_id                 => 'OIR_HZ_CONTACT_INFO',
      p_sig_sql                => 'SELECT PARTY_ID,PARTY_NUMBER,PARTY_NAME,PARTY_TYPE,VALIDATED_FLAG,LAST_UPDATED_BY,CREATION_DATE,LAST_UPDATE_LOGIN,LAST_UPDATE_DATE,
ORIG_SYSTEM_REFERENCE,CUSTOMER_KEY,PERSON_FIRST_NAME,PERSON_MIDDLE_NAME,PERSON_LAST_NAME,PERSON_NAME_SUFFIX,KNOWN_AS,COUNTRY,ADDRESS1,
ADDRESS2,ADDRESS3,ADDRESS4,CITY,POSTAL_CODE,STATE,PROVINCE,STATUS,COUNTY,EMAIL_ADDRESS,DO_NOT_MAIL_FLAG,EMPLOYEES_TOTAL,CREATED_BY_MODULE,
APPLICATION_ID,CERTIFICATION_LEVEL,CERT_REASON_CODE,PRIMARY_PHONE_CONTACT_PT_ID,PRIMARY_PHONE_PURPOSE,PRIMARY_PHONE_LINE_TYPE,
PRIMARY_PHONE_COUNTRY_CODE,PRIMARY_PHONE_AREA_CODE,PRIMARY_PHONE_NUMBER,PRIMARY_PHONE_EXTENSION,PREFERRED_CONTACT_METHOD,PERSON_BO_VERSION,
ORG_BO_VERSION,PERSON_CUST_BO_VERSION,ORG_CUST_BO_VERSION    
FROM HZ_PARTIES 
where party_id in (select PARTY_ID from hz_relationships where  subject_id = (SELECT PERSON_PARTY_ID FROM FND_USER WHERE USER_ID = ##$$USER_ID$$##)  and relationship_code = ''CONTACT_OF'')',
      p_title                  => '"Contact Of" Party Information of ##$$USER_NAME$$##',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no "Contact Of" party information items defined for ##$$USER_NAME$$##.',
      p_solution               => '',
      p_success_msg            => 'Displaying "Contact Of" party information for ##$$USER_NAME$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OIR_HZ_CONTACT_INFO');



debug('begin add_signature: OIR_HZ_RELATIONSHIPS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14674',
      p_sig_id                 => 'OIR_HZ_RELATIONSHIPS',
      p_sig_sql                => 'SELECT
    relationship_id,
    party_number,
    party_type,
...
WHERE
    ...
    AND relationship_code = ''CONTACT_OF''',
      p_title                  => 'Relationships of ##$$USER_NAME$$##',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no relationships defined for ##$$USER_NAME$$##.',
      p_solution               => '',
      p_success_msg            => 'Displaying relationship information for ##$$USER_NAME$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('OIR_HZ_CONTACT_INFO'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '12'
      );
   l_info.delete;
debug('end add_signature: OIR_HZ_RELATIONSHIPS');



debug('begin add_signature: OIR_HZ_ORG');
   l_info('##MASK##%ADDRESS%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##%PHONE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
WHERE
    party_id IN (
      ...
      p_title                  => 'Organization Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no organization information associated to ##$$USER_NAME$$##.',
      p_solution               => '',
      p_success_msg            => 'Displaying organization information associated to ##$$USER_NAME$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: OIR_HZ_ORG');



debug('begin add_signature: OIR_ACCT_ROLES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14489',
      p_sig_id                 => 'OIR_ACCT_ROLES',
      p_sig_sql                => 'SELECT
    cust_account_role_id, party_id, cust_account_id, current_role_state, current_role_state_effective,
    cust_acct_site_id, begin_date, role_type, end_date,primary_flag, last_update_date, source_code,
    last_updated_by, creation_date, created_by, last_update_login, request_id,
    program_application_id, program_id, program_update_date, orig_system_reference,
    status, object_version_number, created_by_module, application_id
FROM
...
WHERE party_id IN (
      ...
      p_title                  => 'Account Roles of ##$$USER_NAME$$##',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no account roles defined for ##$$USER_NAME$$##.',
      p_solution               => '',
      p_success_msg            => 'Displaying account roles for ##$$USER_NAME$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OIR_ACCT_ROLES');



debug('begin add_signature: OIR_REGIST_HSTRY');
   l_info('##MASK##USER_EMAIL_ADDR'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14437',
      p_sig_id                 => 'OIR_REGIST_HSTRY',
      p_sig_sql                => 'SELECT
    registration_id,
    application_code,
    user_email_addr,
    access_domain_cust_id,
    access_domain_billto_id,
    access_domain_search_type,
    access_domain_search_number,
    access_domain_type,
    access_domain_number,
    cust_acct_type,
    status,
    company_id,
    person_id,
    ...
    registration_type
FROM
    ari_reg_verifications
WHERE 
    UPPER(user_email_addr) = (select email_address 
                                from hz_parties 
                               where party_id = (select person_party_id
                                                   from fnd_user
                                                  where user_id = ##$$USER_ID$$##))',
      p_title                  => 'Registration History of ##$$USER_NAME$$##',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no registration history for ##$$USER_NAME$$##.',
      p_solution               => '',
      p_success_msg            => 'Displaying registration history for ##$$USER_NAME$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OIR_REGIST_HSTRY');



debug('begin add_signature: OIR_GUEST_RESP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14428',
      p_sig_id                 => 'OIR_GUEST_RESP',
      p_sig_sql                => 'SELECT
...
ORDER BY c.responsibility_name',
      p_title                  => 'Guest User Responsibilities',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying all user responsibilities associated to ''Guest'' user.',
      p_solution               => '',
      p_success_msg            => 'There are no Responsibilities assigned to the ''Guest'' user.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OIR_GUEST_RESP');



debug('begin add_signature: OIR_GUEST_ACCTMGT_RESP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15765',
      p_sig_id                 => 'OIR_GUEST_ACCTMGT_RESP',
      p_sig_sql                => 'SELECT
    c.responsibility_name,
    c.responsibility_id,
    b.start_date,
...
WHERE
    ...
    AND a.user_id = b.user_id
    AND b.responsibility_id = c.responsibility_id
    AND c.responsibility_name = ''iReceivables Account Management''
    AND b.end_date is null
ORDER BY c.responsibility_name',
      p_title                  => 'iReceivables Account Management Assignment',
      p_fail_condition         => 'NRS',
      p_problem_descr          => '<ul>
<li>The iReceivables Account Management responsibility is not assigned to the Guest user, or is end dated.</li>
<li>This assignment determines if the correct responsibility is assigned to new users in the self registration process.</li>
</ul>',
      p_solution               => '<ul>
<li>This is a valid setting, and may be appropriate for your business, but this could prevent users from being able to access the application after successfully using the self registration process.</li> 
<li>For more information on how this responsibility impacts the application, please review [2303247.1] iReceivables Self Registration Page Is Redirecting To SSO Login URL At Step 2.</li>
</ul>',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: OIR_GUEST_ACCTMGT_RESP');



debug('begin add_signature: OIR_AR_SYSTEM_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15299',
      p_sig_id                 => 'OIR_AR_SYSTEM_OPTIONS',
      p_sig_sql                => 'SELECT
    org_id,
    unearned_discount,
...
where org_id = ##$$ORGID$$##',
      p_title                  => 'AR System Options - iReceivables Related Settings',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no system option record for ##$$ORGID$$##.',
      p_solution               => '',
      p_success_msg            => 'Displaying the iReceivables related settings from Receivables System Options.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: OIR_AR_SYSTEM_OPTIONS');



debug('begin add_signature: OIR_RULES');
   l_info('##MASK##DEFAULT_VALUE'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15231',
      p_sig_id                 => 'OIR_RULES',
      p_sig_sql                => 'SELECT user_rule_object_name,
       rule_object_name,
       fro.application_id,
       ...
       decode(instr(UPPER(default_value),''MAILTO''),0,default_value, ##$$A$$##.mask_text(default_value,''##$$M$$##'')) "DEFAULT_VALUE",
       fro.description,
       flexfield_name,
       flexfield_app_short_name,
       multi_rule_result_flag,
       use_default_value_flag 
FROM   fun_rule_objects_vl fro, fun_lookups flv, fnd_application_vl fav 
WHERE  flv.lookup_type = ''FUN_RULE_RESULT_TYPE'' 
AND    flv.lookup_code = fro.result_type 
AND    fro.application_id = fav.application_id 
AND    fro.rule_object_name LIKE ''ARI%'' 
AND    fro.org_id IS NULL
ORDER BY user_rule_object_name DESC',
      p_title                  => 'Rules',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the rules defined for iReceivables.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OIR_RULES');



debug('begin add_signature: OIR_SELFREG_QS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22318',
      p_sig_id                 => 'OIR_SELFREG_QS',
      p_sig_sql                => 'SELECT
    *
FROM
    ar_irec_selfreg_cust_qs
',
      p_title                  => 'Self Registration Question Setups',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are no Self Registration Questions Defined',
      p_solution               => '',
      p_success_msg            => 'Displaying iReceivables Self Registration Questions',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: OIR_SELFREG_QS');



debug('begin add_signature: EBS_FIN_AR_IREC_IRECANLZ_SELFREG_SITE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24206',
      p_sig_id                 => 'EBS_FIN_AR_IREC_IRECANLZ_SELFREG_SITE',
      p_sig_sql                => 'SELECT
    *
FROM
    ar_irec_selfreg_site_qs',
      p_title                  => 'Self Registration Question Setups - Site Verification',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are no Site level Self Registration Questions Defined',
      p_solution               => '',
      p_success_msg            => 'Displaying iReceivables Self Registration Questions for the Site Level',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_IREC_IRECANLZ_SELFREG_SITE');



debug('begin add_signature: OIR_CVV_ENCRYPT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14444',
      p_sig_id                 => 'OIR_CVV_ENCRYPT',
      p_sig_sql                => 'select ''CREDIT CARD'' AS PAYMENT_INSTRUMENT, decode(CC_ENCRYPTION_MODE, ''IMMEDIATE'', ''Y'', ''SCHEDULED'', ''Y'', ''N'') AS INSTRUMENT_ENCRYPT_MODE, 
CC_ENCRYPTION_MODE AS ENCRYPTION_TYPE, SYS_KEY_FILE_LOCATION, '' '' AS PAYMENT_INSTRUMENT_DISPLAY, '' '' AS ENC_TYPE_DISPLAY, 
NVL(ENCRYPT_SUPPLEMENTAL_CARD_DATA,''N'') AS ENC_SUPPLEMENTAL_DATA 
from iby_sys_security_options 
UNION 
select ''BANK ACCOUNT'' AS PAYMENT_INSTRUMENT, decode(EXT_BA_ENCRYPTION_MODE, ''SCHEDULED'', ''Y'', ''N'') AS INSTRUMENT_ENCRYPT_MODE, 
EXT_BA_ENCRYPTION_MODE AS ENCRYPTION_TYPE, 
SYS_KEY_FILE_LOCATION, '' '' AS PAYMENT_INSTRUMENT_DISPLAY, '' '' AS ENC_TYPE_DISPLAY, ''N'' AS ENC_SUPPLEMENTAL_DATA 
from iby_sys_security_options 
order by 1 desc',
      p_title                  => 'CVV Encryption Settings',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no settings defined for Card Verification Value (CVV) encryption.',
      p_solution               => '',
      p_success_msg            => 'Displaying settings for Card Verification Value (CVV) encryption.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OIR_CVV_ENCRYPT');



debug('begin add_signature: OIR_LOOKUPS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14706',
      p_sig_id                 => 'OIR_LOOKUPS',
      p_sig_sql                => 'SELECT
    lookup_type,
    lookup_code,
    meaning,
...
WHERE
    lookup_type IN (
        ...
        ''ARI_ACCT_STATUS'',
        ''ARI_REG_CUST_SEARCH_TYPE''
    )
ORDER BY
    lookup_type,
    lookup_code',
      p_title                  => 'Lookup Codes Used by  iReceivables',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying list of Lookup codes used by iReceivables.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OIR_LOOKUPS');



debug('begin add_signature: OIR_CC_SURCHARGE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15404',
      p_sig_id                 => 'OIR_CC_SURCHARGE',
      p_sig_sql                => 'SELECT
    lookup_type,
    lookup_code,
    meaning,
...
WHERE
    lookup_type IN (
        ''AR_CREDIT_CARD_SURCHARGE'',
        ''AR_BANK_PAYMENT_SURCHARGE''
    )
ORDER BY
    lookup_type',
      p_title                  => 'Lookup Code Settings for iReceivables Surcharges',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no lookup code values defined for Bank and Credit Card Surcharges.',
      p_solution               => '',
      p_success_msg            => 'Displaying the lookup codes values for Bank and Credit Card Surcharges.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OIR_CC_SURCHARGE');



debug('begin add_signature: OIR_AGING_BUCKETS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15267',
      p_sig_id                 => 'OIR_AGING_BUCKETS',
      p_sig_sql                => 'SELECT
    a.aging_bucket_id,
    a.bucket_name,
    a.status,
...
WHERE
    ...
    AND a.aging_bucket_id IN (
        ...
        WHERE
            ...
            AND a.profile_option_name = ''OIR_AGING_BUCKETS''
    )
ORDER BY
    2,
    1,
    5',
      p_title                  => 'Statement Aging Bucket',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no Statement Aging bucket defined.',
      p_solution               => '',
      p_success_msg            => 'Displaying statement aging bucket information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OIR_AGING_BUCKETS');



debug('begin add_signature: OIR_ACH_BANKS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15232',
      p_sig_id                 => 'OIR_ACH_BANKS',
      p_sig_sql                => 'select BANK_NAME,BANK_BRANCH_NAME,BRANCH_NUMBER,
       ORGANIZATION_PROFILE_ID,PARTY_ID,ORGANIZATION_NAME,
       CREATION_DATE,LAST_UPDATE_DATE,ACTUAL_CONTENT_SOURCE,HOME_COUNTRY from 
...
AND    BankParty.PARTY_ID = BRRel.OBJECT_ID
...
And    NVL(BranchTypeCA.STATUS(+), ''A'') = ''A''
...
and    ''LOCAL'' in (SELECT a.profile_option_value "Profile Value"
...
and t.profile_option_name = ''AR_BANK_DIRECTORY_SOURCE''
AND t.LANGUAGE = ''US''
AND nvl(c.LANGUAGE,''US'') = ''US''
and a.profile_option_value = ''LOCAL'')
order by BranchOrgProfile.effective_start_date desc ) 
where rownum <= 10',
      p_title                  => 'ACH Banks',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying bank details, since OIR: Bank Directory Source = LOCAL.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OIR_ACH_BANKS');



debug('begin add_signature: OIR_PERSONALIZATIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14468',
      p_sig_id                 => 'OIR_PERSONALIZATIONS',
      p_sig_sql                => 'SELECT PATH.PATH_DOCID PERZ_DOC_ID, jdr_mds_internal.getdocumentname(PATH.PATH_DOCID) PERZ_DOC_PATH 
FROM JDR_PATHS PATH 
WHERE jdr_mds_internal.getdocumentname(PATH.PATH_DOCID) like ''/oracle/apps/ar/irec%'' and 
PATH.PATH_DOCID IN (SELECT DISTINCT COMP_DOCID FROM JDR_COMPONENTS WHERE COMP_SEQ = 0 AND 
COMP_ELEMENT = ''customization'' AND COMP_ID IS NULL) ORDER BY PERZ_DOC_PATH',
      p_title                  => 'List of Personalizations',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying list of personalizations for iReceivables.',
      p_solution               => '',
      p_success_msg            => 'There are no personalizations defined for iReceivables.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OIR_PERSONALIZATIONS');



debug('begin add_signature: OIR_PENDING_DISPUTE_CMCREATED');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##STATUS'):= 'left,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '15351',
      p_sig_id                 => 'OIR_PENDING_DISPUTE_CMCREATED',
      p_sig_sql                => 'SELECT
    rcma.request_id,
    rcma.customer_trx_id,
    rcma.cm_customer_trx_id,
    rcma.line_credits_flag,
    rcma.line_amount,
    rcma.tax_amount,
    rcma.freight_amount,
    rcma.cm_reason_code,
    ...
    rcma.created_by,
    rcma.creation_date,
    rcma.last_update_date,
    rcma.total_amount
FROM
    ra_cm_requests_all rcma
WHERE
    rcma.status = ''APPROVED_PEND_COMP''
    AND EXISTS (
        SELECT
            ''CM_CREATED''
        FROM
            ra_cm_requests_all rcmb
        WHERE
            rcmb.customer_trx_id = rcma.customer_trx_id
            AND rcmb.status = ''COMPLETE''
            AND rcmb.cm_customer_trx_id IS NOT NULL
    )',
      p_title                  => 'Disputes in Approved Pending Completion Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Disputes should not be in pending status when a corresponding credit memo already exists.',
      p_solution               => '<ul>
<li>You may need a datafix script to address this issue.</li>
<li>Please log a Service Request and upload this analyzer output, and reference [2423027.1] How to find all "Approved-Pending Completion" Credit Requests in iReceivables for which credit memos have already been created and applied in the system?</li>
</ul>',
   ...
   l_info.delete;
debug('end add_signature: OIR_PENDING_DISPUTE_CMCREATED');



debug('begin add_signature: OIR_UNEARN_DISC');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##UNEARNED_DISCOUNT'):= 'left,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '15330',
      p_sig_id                 => 'OIR_UNEARN_DISC',
      p_sig_sql                => 'SELECT
    org_id, unearned_discount
FROM
    ar_system_parameters_all
WHERE
    org_id = ##$$ORGID$$##
    AND unearned_discount = ''N''',
      p_title                  => 'Unearned Discount Setting = N',
      p_fail_condition         => 'RS',
      p_problem_descr          => '<ul>
<li>The AR System Option setting for ''Allow Unearned Discounts'' is not checked.</li>
<li>This setting determines if unearned discounts are allowed in both Receivables and iReceivables.</li>
</ul> ',
      p_solution               => '<ul>
<li>This is the default setting and may be appropriate for your business, but it may cause an error when trying to pay an invoice from iReceivables.</li>
<li>For more information on this setting, please review [2624891.1] Error Making Payments With Discounts From iReceivables During Discount Periods.</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: OIR_UNEARN_DISC');



debug('begin add_signature: OIR_EXPORT_TEMPLATES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15415',
      p_sig_id                 => 'OIR_EXPORT_TEMPLATES',
      p_sig_sql                => 'SELECT
    lob_code, file_name
FROM
    xdo_lobs
WHERE
    ...
    AND file_name like ''%ARI%_en_US.rtf%''
    AND lob_type IN (''TEMPLATE_SOURCE'')
    AND LOB_CODE in (''ARIADBHDR'',''ARIADBLI'',''ARIALTXLI'',''ARIALTXHDR'')',
      p_title                  => 'Export Templates',
      p_fail_condition         => 'RS',
      p_problem_descr          => '<ul>
<li>The export template definitions are attached to obsolete RTF files.  This will cause the export process to result in a blank page, when exporting from iReceivables.</li>
</ul>',
      p_solution               => '<ul>
<li>The obsolete files need to be replaced with the current files so the export process will correctly export data. </li>
<li>For more information, review [2184656.1] After FEB 2016 RPC 22471980, Exporting Using Seeded Templates Gives Blank Page.</li>
<li>For the most current recommendations, use the Patch Wizard or the Updates & Patches Tab in My Oracle Support.</li>
...
<li><b>Best Practice:</b> Always ensure that you are on the latest code with all recommended patches applied. This will help avoid known issues, prevent potential data corruption and provide the latest features and functionality. Having a proactive patching plan and periodic proactive patching process in place are the best ways to stay current.</li>
      ...
      p_success_msg            => 'The export template definitions are attached to the correct templates.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: OIR_EXPORT_TEMPLATES');



debug('begin add_signature: OIR_CONTACT_US');
   l_info('##MASK##WEB_HTML_CALL'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15405',
      p_sig_id                 => 'OIR_CONTACT_US',
      p_sig_sql                => 'SELECT
    function_name,
    web_html_call
FROM
    fnd_form_functions
WHERE
    function_name = ''ARICONTACTUS''',
      p_title                  => 'Contact Us Setting',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the setting for the Contact Us icon.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OIR_CONTACT_US');



debug('begin add_signature: OIR_PAY_UNRELATED_INV');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##PAY_UNRELATED_INVOICES_FLAG'):= 'left,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '15345',
      p_sig_id                 => 'OIR_PAY_UNRELATED_INV',
      p_sig_sql                => 'SELECT
    org_id, pay_unrelated_invoices_flag
FROM
    ar_system_parameters_all
WHERE
    org_id = ##$$ORGID$$##
    AND  pay_unrelated_invoices_flag = ''Y''',
      p_title                  => 'Allow Payment of Unrelated Transactions Setting',
      p_fail_condition         => 'NRS',
      p_problem_descr          => '<ul>
<li>The AR System Option setting for ''Allow Payment of Unrelated Transactions'' is not checked.</li>
<li>This setting allows customers to pay other customers invoices in the Apply Credits section of iReceivables.</li>
</ul>',
      p_solution               => '<ul>
<li>This is a valid setting and may be appropriate for your business as it determines if customers can pay unrelated customers invoices in Receivables and iReceivables.</li>
<li>For more information on this setting, please review [1670960.1] iReceivables - Why Does the Apply Credits Options Show Credits for All Customers?</li>
</ul>',
      p_success_msg            => 'The AR System Option setting for ''Allow Payment of Unrelated Transactions'' is not checked, and will not allow customer to pay other unrelated customers invoices in iReceivables.',
   ...
   l_info.delete;
debug('end add_signature: OIR_PAY_UNRELATED_INV');



debug('begin add_signature: OIR_APPLICATION_MESSAGES');
   l_info('##MASK##MESSAGE_TEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15416',
      p_sig_id                 => 'OIR_APPLICATION_MESSAGES',
      p_sig_sql                => 'SELECT
    application_id, language_code, message_name, message_text
FROM
    fnd_new_messages
WHERE
    message_name IN (
        ''ARI_HOMEPAGE_CUST_FAQS_BODY'',
        ''ARI_HOMEPAGE_CUST_NEWS_BODY'',
        ''ARI_HOMEPAGE_CUST_POLICY_BODY'',
        ''ARI_HOMEPAGE_CUST_RESRC_BODY''
    )',
      p_title                  => 'Application Messages',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying iReceivables related Application Messages.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OIR_APPLICATION_MESSAGES');



debug('begin add_signature: OIR_FUNC_EXCL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14467',
      p_sig_id                 => 'OIR_FUNC_EXCL',
      p_sig_sql                => 'SELECT R.RESPONSIBILITY_KEY, f.user_function_name 
FROM FND_RESPONSIBILITY_VL R,
FND_FORM_FUNCTIONS_TL F,
fnd_resp_functions frf 
where R.RESPONSIBILITY_KEY in (''ARI_EXTERNAL'', ''ARI_INTERNAL'')
and FRF.ACTION_ID = F.FUNCTION_ID 
and FRF.RULE_TYPE = ''F'' 
and FRF.RESPONSIBILITY_ID = R.RESPONSIBILITY_ID 
and f.LANGUAGE = USERENV(''LANG'')
ORDER BY 1,2',
      p_title                  => 'Function Exclusion for iReceivables Responsibilities',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no function exclusions for internal and external iReceivables responsibilities.',
      p_solution               => '',
      p_success_msg            => 'Displaying the function exclusion for internal and external iReceivables responsibilities.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OIR_FUNC_EXCL');



debug('begin add_signature: EBS_FIN_AR_IREC_IRECANLZ_LANGUAGES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24025',
      p_sig_id                 => 'EBS_FIN_AR_IREC_IRECANLZ_LANGUAGES',
      p_sig_sql                => 'select LANGUAGE_CODE, DESCRIPTION
from FND_LANGUAGES_Vl
where INSTALLED_FLAG in (''I'',''B'')',
      p_title                  => 'Installed Languages',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Displaying the list of all installed languages.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_IREC_IRECANLZ_LANGUAGES');



debug('begin add_signature: OIR_PROFILE_OPTIONS');
   l_info('##MASK##LEVEL VALUE'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15230',
      p_sig_id                 => 'OIR_PROFILE_OPTIONS',
...
fnd_profile_options e,
fnd_profile_options_tl t
WHERE e.application_id in (''222'',''0'',''178'',''602'')
AND e.application_id = a.application_id 
AND a.profile_option_id = e.profile_option_id
AND a.level_value = b.application_id(+)
AND a.level_value = c.responsibility_id(+)
AND a.level_value = d.user_id(+)
AND t.profile_option_name = e.profile_option_name
and (t.profile_option_name like ''OIR%'' or
     t.profile_option_name like ''ARI%'' or
     t.profile_option_name like  ''APPS%AGENT'' or
     t.profile_option_name in 
           (''ICX_SESSION_TIMEOUT'',    
             ''FND_CUSTOM_OA_DEFINTION'',
	    ''AR_BANK_DIRECTORY_SOURCE'',
	    ''UMX_REGISTER_HERE_REG_SRV'',  
            ''FND_SSO_LOCAL_LOGIN_MASK''
            )
    )
AND t.LANGUAGE = ''US''
AND nvl(c.LANGUAGE,''US'') = ''US''
...
a.level_id DESC',
      p_title                  => 'AR/OIR Profile Options',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying profile option settings for Receivables (AR) and iReceivables (OIR).',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OIR_PROFILE_OPTIONS');



debug('begin add_signature: OIR_APPLY_CREDITS_PROFILE');
   l_info('##MASK##LEVEL VALUE'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##PROFILE_OPTION_VALUE'):= 'left,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '15347',
      p_sig_id                 => 'OIR_APPLY_CREDITS_PROFILE',
      p_sig_sql                => 'SELECT c.user_profile_option_name "SHORT NAME",
    c.profile_option_name "LONG NAME", 
    DECODE(b.level_id, 10001, ''Site'', 10002, ''Application'', 10003, ''Responsibility'', 10004, ''User'') "LEVEL",
    DECODE(b.level_id, 10001, ''Site'', 10002, f.application_short_name, 10003, e.responsibility_name, 10004, ##$$A$$##.mask_text(d.user_name,''##$$M$$##'')) "LEVEL VALUE",
    b.profile_option_value,
    a.profile_option_id,
    b.last_update_date,
    b.last_updated_by
...
WHERE
    ...
    AND a.profile_option_name = ''OIR_APPLY_CREDITS''
    AND b.last_updated_by = d.user_id
    AND b.level_value = e.responsibility_id (+)
    AND b.level_value = f.application_id (+)
    AND b.profile_option_value = ''N''
ORDER BY
    c.user_profile_option_name,
    b.level_id ASC',
      p_title                  => 'Apply Credits Profile Option Setting = N',
      p_fail_condition         => 'RS',
      p_problem_descr          => '<ul>
<li>The iReceivables profile option setting for ''OIR: Apply Credits'' is set to No at the levels listed. </li>
<li>This setting will not allow customers to apply credit within iReceivables.</li>
</ul>',
      p_solution               => '<ul>
<li>This is a valid setting, and may be appropriate for your business, but it will not allow customer to apply credit in iReceivables.</li>
<li>For more information on how this profile impacts the application, please review [1953239.1] Error While Trying Pay Invoice and Credit Memo - You cannot pay credit transactions or Closed Invoices</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: OIR_APPLY_CREDITS_PROFILE');



debug('begin add_signature: OIR_ATTACHMENT_PROFILE');
   l_info('##MASK##LEVEL VALUE'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##PROFILE_OPTION_VALUE'):= 'left,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '15348',
      p_sig_id                 => 'OIR_ATTACHMENT_PROFILE',
      p_sig_sql                => 'SELECT c.user_profile_option_name "SHORT NAME",
    c.profile_option_name "LONG NAME", 
    DECODE(b.level_id, 10001, ''Site'', 10002, ''Application'', 10003, ''Responsibility'', 10004, ''User'') "LEVEL",
    DECODE(b.level_id, 10001, ''Site'', 10002, f.application_short_name, 10003, e.responsibility_name, 10004, ##$$A$$##.mask_text(d.user_name,''##$$M$$##'')) "LEVEL VALUE",
...
WHERE
    a.profile_option_id = b.profile_option_id
    AND c.profile_option_name = a.profile_option_name
    AND a.profile_option_name = ''FND_DISABLE_INLINE_ATTACHMENTS''
    AND b.last_updated_by = d.user_id
    AND b.level_value = e.responsibility_id (+)
    AND b.level_value = f.application_id (+)
    AND b.profile_option_value = ''FALSE''
ORDER BY
    c.user_profile_option_name,
    b.level_id ASC',
      p_title                  => 'Attachment Profile Setting = FALSE',
      p_fail_condition         => 'RS',
      p_problem_descr          => '<ul>
<li>The profile option setting for ''FND: Disable Inline Attachments'' is set to False at the levels listed.</li>
<li>This setting determines if customers can download attachments from the iReceivables application.</li>
</ul>',
      p_solution               => '<ul>
<li>This is a valid setting and may be appropriate for your business, but it will not allow customers to download attachments from the iReceivables application.</li>
<li>Please ensure that this is the correct setting for your business processes.</li>
<li>For more information on how this profile impacts the application, please review [2197006.1] Unable to Download Attachments in 12.2 iReceivables.</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: OIR_ATTACHMENT_PROFILE');



debug('begin add_signature: OIR_FUTURE_PMT_PROFILE');
   l_info('##MASK##LEVEL VALUE'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##VALUE'):= 'left,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '15304',
      p_sig_id                 => 'OIR_FUTURE_PMT_PROFILE',
      p_sig_sql                => 'SELECT
    ''Profile Option'' "SOURCE",
    c.user_profile_option_name   "NAME",
    DECODE(b.level_id, 10001, ''Site'', 10002, ''Application'', 10003, ''Responsibility'', 10004, ''User'') "LEVEL",
    DECODE( b.level_id,
  10001,
  ''Site'',
  ...
  10004, ##$$A$$##.mask_text(d.user_name,''##$$M$$##''))
    "LEVEL VALUE",
...
WHERE
    a.profile_option_id = b.profile_option_id
    AND c.profile_option_name = a.profile_option_name
        AND a.profile_option_name = ''OIR_MAX_FUTURE_PAYMENT_DAYS_ALLOWED''
            AND b.last_updated_by = d.user_id
                AND b.level_value = e.responsibility_id (+)
                    AND b.level_value = f.application_id (+)
                        AND b.profile_option_value IS NOT NULL
UNION
SELECT
    ''OIR System Options'' "SOURCE",
    ''Future Dated Payments'' "NAME",
    ''Rule'' "LEVEL",
    ''Default Value'' "LEVEL VALUE",
    default_value "VALUE"
FROM
    fun_rule_objects_vl   fro,
    fun_lookups           flv,
    fnd_application_vl    fav
WHERE
    flv.lookup_type = ''FUN_RULE_RESULT_TYPE''
    AND flv.lookup_code = fro.result_type
    AND fro.application_id = fav.application_id
    AND fro.rule_object_name = ''ARI_MAX_FUTURE_PAYMENT_DATE''
    AND fro.org_id = ##$$ORGID$$##',
      p_title                  => 'Future Payments Profile Option',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The profile setting for ''OIR: Maximum Future Payment Days Allowed'', and System Options Rule, will allow your customers to enter future dated payments.',
      p_solution               => '<ul>
<li>This setting may be appropriate for your business, it is raised as a warning to bring it to your awareness that the value is not null or zero.</li>
<li>For more information, please review [2633405.1] OIR: Maximum Future Payment Days Allowed Profile Option And The Future Dated Payments Rule Functionality.</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: OIR_FUTURE_PMT_PROFILE');



debug('begin add_signature: OIR_PMT_DISABLED');
   l_info('##MASK##LEVEL VALUE'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##PROFILE_OPTION_VALUE'):= 'left,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '15409',
      p_sig_id                 => 'OIR_PMT_DISABLED',
      p_sig_sql                => 'SELECT
    c.user_profile_option_name   "SHORT NAME",
    c.profile_option_name        "LONG NAME",
    DECODE(b.level_id, 10001, ''Site'', 10002, ''Application'', 10003, ''Responsibility'', 10004, ''User'') "LEVEL",
    DECODE(b.level_id, 10001, ''Site'', 10002, f.application_short_name, 10003, e.responsibility_name, 10004, ##$$A$$##.mask_text(d.user_name,''##$$M$$##'')) "LEVEL VALUE"
    ,
...
WHERE
    ...
    AND b.level_value = e.responsibility_id (+)
    AND b.level_value = f.application_id (+)
    AND b.profile_option_value = ''DISABLED''
ORDER BY
    c.user_profile_option_name,
    b.level_id ASC',
      p_title                  => 'Payment Profiles Set to Disabled Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => '<ul>
<li>The profile setting for ''OIR: Bank Account Payment Method'' and/or ''OIR: Credit Card Payment Method'' is set to ''DISABLED'' at the levels listed.</li>
<li>This setting may impact the the ability to make payments from iReceivables</li>
</ul>',
      p_solution               => '<ul>
<li>This is a valid setting, and may be appropriate for your business, but this could impact the ability to make payments from iReceivables.</li>
<li>For more information on how this profile impacts the application, please review [2676805.1] Customer Credit Card Details Not Appearing While Making a Payment.</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: OIR_PMT_DISABLED');



debug('begin add_signature: OIR_DISPUTE_PROFILE');
   l_info('##MASK##LEVEL VALUE'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##PROFILE_OPTION_VALUE'):= 'left,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '15298',
      p_sig_id                 => 'OIR_DISPUTE_PROFILE',
      p_sig_sql                => 'SELECT c.user_profile_option_name "SHORT NAME",
    c.profile_option_name "LONG NAME", 
    DECODE(b.level_id, 10001, ''Site'', 10002, ''Application'', 10003, ''Responsibility'', 10004, ''User'') "LEVEL",
    DECODE(b.level_id, 10001, ''Site'', 10002, f.application_short_name, 10003, e.responsibility_name, 10004, ##$$A$$##.mask_text(d.user_name,''##$$M$$##'')) "LEVEL VALUE",
...
WHERE
    a.profile_option_id = b.profile_option_id
    AND c.profile_option_name = a.profile_option_name
    AND a.profile_option_name = ''ARI_MULTIPLE_DISPUTE''
    AND b.last_updated_by = d.user_id
    AND b.level_value = e.responsibility_id (+)
    AND b.level_value = f.application_id (+)
    AND b.profile_option_value = ''N''
ORDER BY
    c.user_profile_option_name,
    b.level_id ASC',
      p_title                  => 'Multi Dispute Profile Option',
      p_fail_condition         => 'RS',
      p_problem_descr          => '<ul>
<li>The iReceivables profile option setting for ''OIR: Enable Multi Dispute'' is ''N'' or null at the levels listed.</li>  
<li>This setting may impact the appearance of the Dispute button in iReceivables.</li> 
</ul>',
      p_solution               => '<ul>
<li>This is a valid setting, and may be appropriate for your business, but may prevent the Dispute button from appearing in iReceivables.</li>
<li>For more information on how this profile option impacts the application, please review review [2184855.1] Dispute Button is Not Enabled on Account Details Page or Transaction List Page.</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: OIR_DISPUTE_PROFILE');



debug('begin add_signature: OIR_HZ_PARTY_PROFILES');
   l_info('##MASK##LEVEL VALUE'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##PROFILE_OPTION_VALUE'):= 'left,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '15306',
      p_sig_id                 => 'OIR_HZ_PARTY_PROFILES',
      p_sig_sql                => 'SELECT
    c.user_profile_option_name   "SHORT NAME",
    c.profile_option_name        "LONG NAME",
    DECODE(b.level_id, 10001, ''Site'', 10002, ''Application'', 10003, ''Responsibility'', 10004, ''User'') "LEVEL",
...
ORDER BY
    c.user_profile_option_name,
    b.level_id ASC',
      p_title                  => 'HZ Related Profile Options',
      p_fail_condition         => 'RS',
      p_problem_descr          => '<ul>
<li>The profile setting for ''HZ: Generate Party Number'' and/or ''HZ: Generate Party Site Number'' is ''N'' or null.</li>
<li>This setting may impact the iReceivables Self Registration Process, or adding new Credit Cards.</li>
</ul>',
      p_solution               => '<ul>
<li>This is a valid setting, and may be appropriate for your business, but this could impact the self registration process, and adding new credit cards in iReceivables.</li>
<li>For more information on how this profile impacts the application, please review the following:</li>
<li>[2421707.1] eBusiness User Created Thru Self Registration is in Pending Status after Approval</li>
<li>[2541715.1] Unable To Add New Credit Card From iReceivables</li>
</ul>',
      p_success_msg            => 'Displaying the profile setting for HZ: Generate Party Number and HZ: Generate Party Site Number.
...
',
   ...
   l_info.delete;
debug('end add_signature: OIR_HZ_PARTY_PROFILES');



debug('begin add_signature: OIR_DEF_CURRENCY_PROFILE');
   l_info('##MASK##LEVEL VALUE'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15307',
      p_sig_id                 => 'OIR_DEF_CURRENCY_PROFILE',
      p_sig_sql                => 'SELECT
    c.user_profile_option_name   "SHORT NAME",
    c.profile_option_name        "LONG NAME",
    DECODE(b.level_id, 10001, ''Site'', 10002, ''Application'', 10003, ''Responsibility'', 10004, ''User'') "LEVEL",
...
WHERE
    a.profile_option_id = b.profile_option_id
    AND c.profile_option_name = a.profile_option_name
    AND a.profile_option_name = ''OIR_DEFAULT_CURRENCY_CODE''
    AND b.last_updated_by = d.user_id
    AND b.level_value = e.responsibility_id (+)
    AND b.level_value = f.application_id (+)
    AND b.profile_option_value is not null
ORDER BY
    c.user_profile_option_name,
    b.level_id ASC',
      p_title                  => 'Default Currency Code Profile Option',
      p_fail_condition         => 'NRS',
      p_problem_descr          => '<ul>
<li>The profile setting for ''OIR: Default currency code'' is null.</li>
<li>This setting may impact the ability of external users to access the application.</li>
</ul>',
      p_solution               => '<ul>
<li>This is a valid setting, and may be appropriate for your business, but it may cause an error for external users when trying to access iReceivables.</li>
<li>For more information on how this profile impacts the application, please review [2411409.1] Access Denied Error When Searching All Locations For Customers With Multiple Sites.</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: OIR_DEF_CURRENCY_PROFILE');



debug('begin add_signature: OIR_MULTI_PRINT_PROFILE');
   l_info('##MASK##LEVEL VALUE'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##PROFILE_OPTION_VALUE'):= 'left,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '15346',
      p_sig_id                 => 'OIR_MULTI_PRINT_PROFILE',
      p_sig_sql                => 'SELECT c.user_profile_option_name "SHORT NAME",
    c.profile_option_name "LONG NAME", 
    DECODE(b.level_id, 10001, ''Site'', 10002, ''Application'', 10003, ''Responsibility'', 10004, ''User'') "LEVEL",
    DECODE(b.level_id, 10001, ''Site'', 10002, f.application_short_name, 10003, e.responsibility_name, 10004, ##$$A$$##.mask_text(d.user_name,''##$$M$$##'')) "LEVEL VALUE",
...
WHERE
    a.profile_option_id = b.profile_option_id
    AND c.profile_option_name = a.profile_option_name
    AND a.profile_option_name = ''OIR_BPA_MULTI_PRINT_LIMIT''
    AND b.last_updated_by = d.user_id
    AND b.level_value = e.responsibility_id (+)
    AND b.level_value = f.application_id (+)
    AND b.profile_option_value is not null
ORDER BY
    c.user_profile_option_name,
    b.level_id ASC',
      p_title                  => 'Multi Print Profile Option',
      p_fail_condition         => 'RS',
      p_problem_descr          => '<ul>
<li>The iReceivables profile setting for ''OIR: Multi Print Limit'' is set as shown above.</li>
<li>This setting determines the maximum number of invoices customers will be allowed to print at one time.</li>
</ul>',
      p_solution               => '<ul>
<li>This is a valid setting, and may be appropriate for your business, but it will limit the number of invoices customers can print at one time.</li>
<li>For more information on how this profile impacts the application, please review [1952198.1] Error Occurs When User Print Multiple Transactions in the Account Details.</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: OIR_MULTI_PRINT_PROFILE');



debug('begin add_signature: OIR_MANUAL_PW_PROFILE');
   l_info('##MASK##LEVEL VALUE'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##PROFILE_OPTION_VALUE'):= 'left,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '15302',
      p_sig_id                 => 'OIR_MANUAL_PW_PROFILE',
      p_sig_sql                => 'SELECT c.user_profile_option_name "SHORT NAME",
    c.profile_option_name "LONG NAME", 
    DECODE(b.level_id, 10001, ''Site'', 10002, ''Application'', 10003, ''Responsibility'', 10004, ''User'') "LEVEL",
    DECODE(b.level_id, 10001, ''Site'', 10002, f.application_short_name, 10003, e.responsibility_name, 10004, d.user_name) "LEVEL VALUE",
    b.profile_option_value,
    a.profile_option_id,
    b.last_update_date,
    b.last_updated_by,
...
WHERE
    a.profile_option_id = b.profile_option_id
    AND c.profile_option_name = a.profile_option_name
    AND a.profile_option_name = ''MANUAL_PWD_RESET''
    AND b.last_updated_by = d.user_id
    AND b.level_value = e.responsibility_id (+)
    AND b.level_value = f.application_id (+)
    AND nvl(b.profile_option_value,''N'') = ''N''
ORDER BY
    c.user_profile_option_name,
    b.level_id ASC',
      p_title                  => 'Manual Password Profile Option',
      p_fail_condition         => 'RS',
      p_problem_descr          => '<ul>
<li>The profile setting for ''Manual Password Reset Enabled'' is ''N'' or null.</li>
<li>This setting may prevent users from receiving a confirmation email in the self registration process.</li>
</ul>',
      p_solution               => '<ul>
<li>This is a valid setting and may be appropriate for your business, but it may prevent the user from receiving a confirmation email from the self registration process.</li>
<li>For more information on how this profile impacts the application, please review [2689531.1] iReceivables Notification Workflow (Account Request) Going To Default Context And Error Out After Successful Self Registration.</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: OIR_MANUAL_PW_PROFILE');



debug('begin add_signature: OIR_REGIST_HERE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14556',
      p_sig_id                 => 'OIR_REGIST_HERE',
      p_sig_sql                => 'SELECT
    p.user_profile_option_name,
    p.profile_option_name,
    display_name             AS profile_option_value,
    s.profile_option_value   AS profile_option_value_code,
    node.node_name           AS server,
    s.level_id,
    s.creation_date,
    s.last_update_date
FROM
    ...
    umx_reg_services_vl
WHERE
    p.profile_option_id = s.profile_option_id (+)
    AND reg_service_type = ''SELF_SERVICE''
    AND reg_service_code = s.profile_option_value
    AND p.application_id = s.application_id (+)
    AND p.profile_option_name = ''UMX_REGISTER_HERE_REG_SRV''
    AND po.profile_option_id = s.profile_option_id
    AND s.level_id (+) = 10007
    AND node.node_id = s.level_value2
ORDER BY
    s.last_update_date DESC',
      p_title                  => 'Register Here Link',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no ''Register Here'' link settings defined.',
      p_solution               => '',
      p_success_msg            => 'Displaying ''Register Here'' link settings.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OIR_REGIST_HERE');
...
debug('begin add_signature: OIR_BANK_ACCT_FILECHECK');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##VERSION'):= 'left,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '15308',
      p_sig_id                 => 'OIR_BANK_ACCT_FILECHECK',
      p_sig_sql                => 'SELECT
    adf.filename,
    adfv.version
FROM
...
WHERE
    ...
    AND ( ( ''12.2'' = substr(''12.2.9'', 1, 4)
            AND fnd_irep_loader_private.compare_versions(adfv.version, ''120.36.12020000.6'') = ''<'' )
          OR ( ''12.1'' = substr(''12.1.3'', 1, 4)
               AND fnd_irep_loader_private.compare_versions(adfv.version, ''120.31.12010000.11'') = ''<'' ) )
    AND adf.app_short_name = ''AR''
    AND adf.filename = ''ARI_PAYMENT_DETAILS_PAGE.xml''
    AND adfv.version IN (
        SELECT
            "Current Version"
        FROM
            (
                ...
                WHERE
                    ...
                    AND af1.filename IN ( ''ARI_PAYMENT_DETAILS_PAGE.xml'' )
            )
        WHERE
            rankus = 1
    )',
      p_title                  => 'Version of ARI_PAYMENT_DETAILS_PAGE.xml',
      p_fail_condition         => 'RS',
      p_problem_descr          => '<ul>
<li>The file <i>ARI_PAYMENT_DETAILS_PAGE.xml</i> has a version lower than recommended.  This can cause customer bank account details to not show in the Payment pages of iReceivables.</li>
</ul>',
      p_solution               => '<ul>
<li>Upgrade to the latest file version of <i>ARI_PAYMENT_DETAILS_PAGE.xml</i>.</li>
<li>For more information, review [2597555.1] Customer Bank Account detailes missing On iReceivables Payment Details page.</li>
...
',
      p_success_msg            => 'The file versions are compliant with recommendations in [2597555.1].',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OIR_BANK_ACCT_FILECHECK');



debug('begin add_signature: EBS_FIN_AR_OIR_SELFREG_ACCESS');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##VERSION'):= 'left,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '22808',
      p_sig_id                 => 'EBS_FIN_AR_OIR_SELFREG_ACCESS',
      p_sig_sql                => 'SELECT
    adf.filename,
    adfv.version
FROM
...
WHERE
        adf.file_id = adfv.file_id
    AND ( ( ''12.2'' = substr(''12.2.9'', 1, 4)
            AND fnd_irep_loader_private.compare_versions(adfv.version, ''120.34.12020000.13'') = ''<'' )
          OR ( ''12.1'' = substr(''12.1.3'', 1, 4)
               AND fnd_irep_loader_private.compare_versions(adfv.version, ''120.24.12010000.42'') = ''<'' ) )
    AND adf.app_short_name = ''AR''
    AND adf.filename = ''ARISREGB.pls''
    AND adfv.version IN (
        SELECT
            "Current Version"
        FROM
            (
                ...
                WHERE
                        af1.file_id = afv1.file_id
                    AND af1.filename IN ( ''ARISREGB.pls'' )
            )
        WHERE
            rankus = 1
    )',
      p_title                  => 'Version of ARISREGB.pls',
      p_fail_condition         => 'RS',
      p_problem_descr          => '<ul>
<li>The file <i>ARISREGB.pls</i> has a version lower than recommended.  This can cause unauthorized access to iReceivables when multiple customers register with the same name..</li>
</ul>',
      p_solution               => '<ul>
<li>Upgrade to the latest file version of <i>ARISREGB.pls</i>.</li>
<li>For more information, review [2771646.1] iReceivables External User Getting Access to Other Customer Account If the Contact First and Last Name Is the Same.</li>
<li>For the most current recommendations, use the Patch Wizard or the Updates & Patches Tab in My Oracle Support.<br>
<li>Further guidance can be found in the following documents:</li>
<ul>
<li>[11086538] How to Find EBS Patches and EBS Technology Patches</li>
...
',
      p_success_msg            => 'The file versions are compliant with recommendations in [2771646.1].',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_OIR_SELFREG_ACCESS');



debug('begin add_signature: EBS_FIN_AR_IREC_IRECANLZ_ANTISAMY');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##VERSION'):= 'left,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '22872',
      p_sig_id                 => 'EBS_FIN_AR_IREC_IRECANLZ_ANTISAMY',
      p_sig_sql                => '    
SELECT
    adf.filename,
    adfv.version
...
WHERE
        adf.file_id = adfv.file_id
    AND ( ( ''12.2'' = substr(''12.2.9'', 1, 4)
            AND fnd_irep_loader_private.compare_versions(adfv.version, ''120.1.12020000.4'') = ''<'' )
          )
    AND adf.app_short_name = ''FND''
    AND adf.filename = ''antisamy.zip''
    AND adfv.version IN (
        SELECT
            "Current Version"
        FROM
            (
                ...
                WHERE
                        af1.file_id = afv1.file_id
                    AND af1.filename IN ( ''antisamy.zip'' )
            )
        WHERE
            rankus = 1
    )  ',
      p_title                  => 'Version of antisamy.zip',
      p_fail_condition         => 'RS',
      p_problem_descr          => '<ul>
<li>The file <i>antisamy.zip</i> has a version lower than recommended.  This can cause java null pointer errors in the iReceivables pages in 12.2.7 and higher.</li>
</ul>',
      p_solution               => '<ul>
<li>Upgrade to the latest file version of <i>antisamy.zip</i>.</li>
<li>For more information, review [2761102.1] Pressing Pay in iReceivables Account Management Gives Error JBO-29000: Unexpected exception caught: java.lang.NoSuchMethodError, msg=org.owasp.validator.html.CleanResults.getErrorMessages()Ljava/util/ArrayList.</li>
<li>For the most current recommendations, use the Patch Wizard or the Updates & Patches Tab in My Oracle Support.<br>
<li>Further guidance can be found in the following documents:</li>
<ul>
<li>[11086538] How to Find EBS Patches and EBS Technology Patches</li>
...
',
      p_success_msg            => 'The file versions are compliant with recommendations in [2761102.1].',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_IREC_IRECANLZ_ANTISAMY');
...
debug('begin add_signature: OIR_GEN_FILE_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15470',
      p_sig_id                 => 'OIR_GEN_FILE_VERSIONS',
      p_sig_sql                => 'SELECT
b.filename,
a.version,
a.creation_date,
...
ORDER BY
1',
      p_title                  => 'iReceivables Java File Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Oracle iReceivables (AR) Java file versions are missing.',
      p_solution               => 'Please ensure that you have installed the Oracle Receivables (AR) application.',
      p_success_msg            => 'Displaying Oracle iReceivables (AR) Java file versions.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: OIR_GEN_FILE_VERSIONS');
...
debug('begin add_signature: OIR_OWNED_BY_CTXSYS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15234',
      p_sig_id                 => 'OIR_OWNED_BY_CTXSYS',
      p_sig_sql                => 'select object_name, 
       object_type, 
       status   
  from all_objects  
 where owner = ''CTXSYS'' 
   and object_name like ''HZ%''',
      p_title                  => 'Other HZ% Objects Owned by CTXSYS',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying HZ objects owned by CTXSYS.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OIR_OWNED_BY_CTXSYS');



debug('begin add_signature: OIR_PKG_VER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15235',
      p_sig_id                 => 'OIR_PKG_VER',
      p_sig_sql                => 'select * from user_source where name = ''RA_CUSTOMER_TEXT_PKG'' and text like ''%ARXCUTXS.pls%''
UNION
select * from user_source where name = ''RA_CUSTOMER_TEXT_PKG'' and text like ''%ARXCUTXB.pls%''',
      p_title                  => 'Package Version of RA_CUSTOMER_TEXT_PKG',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying package version of RA_CUSTOMER_TEXT_PKG.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OIR_PKG_VER');



debug('begin add_signature: OIR_PROFILE_CURRENCY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15349',
      p_sig_id                 => 'OIR_PROFILE_CURRENCY',
      p_sig_sql                => 'SELECT
    cust_account_id,
    site_use_id,
    currency_code,
...
WHERE
    cust_account_id IN (
        ...
        WHERE
            party_id = nvl(to_number(''##$$PRTYID$$##''),-999)
            AND cust_account_id > 0
    )
ORDER BY
    cust_account_id,
    site_use_id DESC',
      p_title                  => 'Customer Profile Currencies for Party ID',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no currencies assigned to this customer. This could cause error: JBO-27122 CUR.CURRENCY_CODE when viewing customer records.

',
      p_solution               => 'For more information on this setting, please review [2168652.1] JBO-27122 CUR.CURRENCY_CODE Error When Clicking on Account Balance.
',
      p_success_msg            => 'Displaying the currencies assigned to this customer.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: OIR_PROFILE_CURRENCY');
...
BEGIN
  ...
  analyzer_title := 'iReceivables Analyzer';
...
debug('begin section: IREC_ACCESS');
start_section('Access Information', 'IREC_ACCESS');
   set_item_result(run_stored_sig('OIR_USER_INFO'));
   set_item_result(run_stored_sig('OIR_USER_RESP'));
   set_item_result(run_stored_sig('OIR_HZ_PERSON'));
   set_item_result(run_stored_sig('OIR_HZ_RELATIONSHIPS'));
   set_item_result(run_stored_sig('OIR_HZ_ORG'));
   set_item_result(run_stored_sig('OIR_ACCT_ROLES'));
   set_item_result(run_stored_sig('OIR_REGIST_HSTRY'));
   set_item_result(run_stored_sig('OIR_GUEST_RESP'));
   set_item_result(run_stored_sig('OIR_GUEST_ACCTMGT_RESP'));
end_section;
debug('end section: IREC_ACCESS');

debug('begin section: IREC_SETUP');
start_section(' Setup and Environment Information', 'IREC_SETUP');
   set_item_result(run_stored_sig('OIR_AR_SYSTEM_OPTIONS'));
   set_item_result(run_stored_sig('OIR_RULES'));
   set_item_result(run_stored_sig('OIR_SELFREG_QS'));
   set_item_result(run_stored_sig('EBS_FIN_AR_IREC_IRECANLZ_SELFREG_SITE'));
   set_item_result(run_stored_sig('OIR_CVV_ENCRYPT'));
   set_item_result(run_stored_sig('OIR_LOOKUPS'));
   set_item_result(run_stored_sig('OIR_CC_SURCHARGE'));
   set_item_result(run_stored_sig('OIR_AGING_BUCKETS'));
   set_item_result(run_stored_sig('OIR_ACH_BANKS'));
   set_item_result(run_stored_sig('OIR_PERSONALIZATIONS'));
   set_item_result(run_stored_sig('OIR_PENDING_DISPUTE_CMCREATED'));
   IF p_party_id is not null THEN
      set_item_result(run_stored_sig('OIR_PROFILE_CURRENCY'));
   ...
   END IF;
   IF g_index_status  <> 'VALID' THEN
      set_item_result(run_stored_sig('OIR_OWNED_BY_CTXSYS'));
      set_item_result(run_stored_sig('OIR_PKG_VER'));
   END IF;
   set_item_result(run_stored_sig('OIR_UNEARN_DISC'));
   set_item_result(run_stored_sig('OIR_EXPORT_TEMPLATES'));
   set_item_result(run_stored_sig('OIR_CONTACT_US'));
   set_item_result(run_stored_sig('OIR_PAY_UNRELATED_INV'));
   set_item_result(run_stored_sig('OIR_APPLICATION_MESSAGES'));
   set_item_result(run_stored_sig('OIR_FUNC_EXCL'));
   set_item_result(run_stored_sig('EBS_FIN_AR_IREC_IRECANLZ_LANGUAGES'));
end_section;
debug('end section: IREC_SETUP');

debug('begin section: IREC_PROFILE_OPTIONS');
start_section('Profile Options', 'IREC_PROFILE_OPTIONS');
   set_item_result(run_stored_sig('OIR_PROFILE_OPTIONS'));
   set_item_result(run_stored_sig('OIR_APPLY_CREDITS_PROFILE'));
   set_item_result(run_stored_sig('OIR_ATTACHMENT_PROFILE'));
   set_item_result(run_stored_sig('OIR_FUTURE_PMT_PROFILE'));
   set_item_result(run_stored_sig('OIR_PAY_UNRELATED_INV'));
   set_item_result(run_stored_sig('OIR_PMT_DISABLED'));
   set_item_result(run_stored_sig('OIR_DISPUTE_PROFILE'));
   set_item_result(run_stored_sig('OIR_HZ_PARTY_PROFILES'));
   set_item_result(run_stored_sig('OIR_DEF_CURRENCY_PROFILE'));
   set_item_result(run_stored_sig('OIR_MULTI_PRINT_PROFILE'));
   set_item_result(run_stored_sig('OIR_MANUAL_PW_PROFILE'));
   set_item_result(run_stored_sig('OIR_REGIST_HERE'));
   set_item_result(run_stored_sig('EBS_FIN_AR_GEN_MOAC'));
end_section;
debug('end section: IREC_PROFILE_OPTIONS');
...
start_section('AR Recommended Patches', 'RECOMMENDED_PATCHES');
   set_item_result(check_rec_patches_1); /* Signature OIR_REC_PATCHES */
   set_item_result(run_stored_sig('OIR_BANK_ACCT_FILECHECK'));
   set_item_result(run_stored_sig('EBS_FIN_AR_OIR_SELFREG_ACCESS'));
   set_item_result(run_stored_sig('EBS_FIN_AR_IREC_IRECANLZ_ANTISAMY'));
end_section;
...
IF p_apps_check = 'Y' THEN
   start_section('Apps Check Information', 'APPS_CHECK');
      ...
      set_item_result(run_stored_sig('OIR_GEN_FILE_VERSIONS'));
