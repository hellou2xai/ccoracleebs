...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Internet Expenses Analyzer             |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE ap_oie_analyzer_pkg AUTHID DEFINER AS
...
(            p_org_ids                      IN VARCHAR2    DEFAULT NULL
           ...
           ,p_expense_report_num           IN VARCHAR2    DEFAULT NULL
...
END ap_oie_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY ap_oie_analyzer_pkg AS
-- $Id: ap_oie_analyzer.sql, 200.47 2026/02/25 11:25:07 sdenye Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(1559272.1));
...
g_report_header_id NUMBER;
g_expense_check_address_flag VARCHAR2(1);
-- g_snap_days defined in framework
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'APOIE_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'APOIE_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>APOIE Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=1559272.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/oie_latest_ver.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,563,EBS,EBS Financials,EBS - Payables" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,563,EBS,EBS Financials,EBS - Payables" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},563,EBS,EBS Financials,EBS - Payables" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/mosc/discussion/3349972" class="blacklink" target="new">
...
<p>Version 200.47 25-FEB-2026</p><ul><li>Updated index and recommended patch signatures</li>
</ul>
<p>Version 200.46 26-JAN-2026</p><ul><li>Updated to signatures to reflect knowledge article IDs&nbsp;</li>
</ul>
<p>Version 200.45 08-Dec-2025</p><ul><li>Changes to the analyzer template for the new Support Portal</li>
</ul>
<p>Version 200.43 - 25-Nov-2025</p><ul><li>Critical signature updates</li>
</ul>
<p>Version 200.41 - 29-Sep-2025&nbsp;</p><ul><li>Included many signature improvements, including refined SQL Signatures and more clarty on solution insructions.</li>
</ul>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,563,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Payables" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,563,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Payables" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},563,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Payables" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
FUNCTION print_pers(p_path IN VARCHAR2, p_recursive IN BOOLEAN DEFAULT FALSE) RETURN VARCHAR2
  IS
 ...
 l_sig.fail_condition := 'RS';
  l_sig.problem_descr := 'Unsupported customizations and personalizations exist. This might cause unexpected behavior within the application.'; 
  l_sig.solution := 'Please remove customizations or personalizations and retest.<br>
Reference: [304670/KB745118] How to Remove / Disable an OA Framework Personalization ';
  l_sig.success_msg := 'No personalized or customized pages';
  l_sig.print_condition := 'FAILURE';
  l_sig.fail_type := 'W';       
  l_sig.print_sql_output := 'Y';
  l_sig.limit_rows := 'N';
  l_sig.extra_info := CAST(null AS HASH_TBL_4K);  -- For FMW 4.3 additional info
  g_signatures('Personalizations') := l_sig;
   
  l_hdr.extend(1);
  l_hdr(1) := 'Files';
  
  RETURN process_signature_results(
    'Personalizations',     -- sig ID
...
FUNCTION check_rec_patches_1 RETURN VARCHAR2 IS
  /* Signature oie_check_rec_patches */
  l_col_rows   COL_LIST_TBL := col_list_tbl(); -- Row values
...
BEGIN
    ...
    print_log('Processing recommended patches signature: oie_check_rec_patches (check_rec_patches_1) "OIE patch level" (version 14)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(1)(l_rows) := '22142100';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.FIN_PF.C.delta.6';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '22124937';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.AME.C.delta.8';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '22115550';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIE.C.delta.6';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19675026';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIE.C.delta.5';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19060002';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.FIN_PF.C.delta.5';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '17940003';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.FIN_PF.C.delta.4';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '17933923';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIE.C.delta.4';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '17026955';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.FIN_PF.C.delta.3';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '17022460';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIE.C.delta.3';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'REL12.2.2';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '16188355';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIE.C.delta.2';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '15969696';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.FIN_PF.C.delta.2';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '14229062';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIE.C.delta.1';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '14227186';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.FIN_PF.C.delta.1';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '14222221';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'REL12.2.1';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '10197302';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.FIN_PF.C';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '10196256';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIE.C';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '10079002';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'REL12.2.0';
   l_col_rows(5)(l_rows) := NULL;
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '22526147';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.1.3 OIE-RPC Feb 2016';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '20315551';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.1.3 OIE-RPC Feb 2015';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.1.3 PCARD-RPC Feb 2015';
   l_col_rows(5)(l_rows) := '[1563799/FAQ7178]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19163626';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.1.3 OIE-RPC Aug 2014';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19018819';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.1.3 PCARD-RPC Aug 2014';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '18107509';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.AME.B.delta.7';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '17176060';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.1.3 PCARD-RPC Sep 2013';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '16234880';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.1.3 OIE-RPC Mar 2013';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '16213660';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.1.3 PCARD-RPC Mar 2013';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '16040471';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.AME.B.delta.6';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '14098047';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.1.3 OIE-RPC Aug 2012';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '13594830';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.AME.B.delta.5';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '13563489';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.1.3 PCARD-RPC Jan 2012';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '11811841';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.AME.B.delta.4';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '10040337';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.1.3 Mandatory patch';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '9244833';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIE.B.DELTA.3';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'REL12.1.3';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '9147733';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.FIN_PF.B.DELTA.3';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '8517003';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIE.B.DELTA.2';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '8402900';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.FIN_PF.B.DELTA.2';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '7457000';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.FIN_PF.B.DELTA.1';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '7456868';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIE.B.DELTA.1';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'REL12.1.1 Maint';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '7283000';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'REL12.1.DELTA.1';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '4565490';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.FIN_PF.B';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '4565278';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIE.B';
   l_col_rows(5)(l_rows) := NULL;
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.0' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '16664305';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.AME.A.delta.11';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '13955167';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.AME.A.delta.10';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '12424313';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.AME.A.delta.9';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.AP.A.CPC July 2009';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '7294050';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.FIN_PF.A.delta.6';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '7293853';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIE.A.DELTA.6';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '7282993';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'REL12.0.5';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.FIN_PF.A.delta.5';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '6833112';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIE.A.DELTA.5';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '6493806';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIE.A.DELTA.4';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '6493602';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.FIN_PF.A.delta.4';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'REL12.0.4';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '6251856';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.FIN_PF.A.delta.3';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '6250306';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIE.A.DELTA.3';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '5999618';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIE.A.DELTA.2';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.FIN_PF.A.delta.1 - Internal';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '5884349';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIE.A.DELTA.1';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'REL12.0.1';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '4442891';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIE.A';
   l_col_rows(5)(l_rows) := NULL;
...
END IF;
   ...
   l_sig.sigrepo_id := '2826';
   l_sig.title := 'OIE patch level';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := 'When troubleshooting any Internet Expense issue, it is necessary to know the exact OIE Mini-pack / rollup level, and the corresponding Financials Family Pack level.';
   l_sig.solution := 'Above are the recommended patches for this product area from [980053/KB384675].  For the most current recommendations, use the Patch Wizard or the Updates & Patches Tab in My Oracle Support.  Further guidance can be found in the following documents:
<ul>
...
<li>[10940175/KA580] Patch Wizard FAQ</li>
   ...
   l_sig.success_msg := 'All patches from [980053/KB384675] have been applied!';
  ...
  -- Register
  l_step := '60';
  g_signatures('oie_check_rec_patches') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'oie_check_rec_patches',     -- sig ID
    l_sig,                              -- signature information
    l_col_rows,                         -- data
    l_hdr);                             -- headers
...
BEGIN
    ...
    print_log('Processing recommended patches signature: OIE_MOBILE_PATCHES (check_rec_patches_2) "Fusion Expenses Mobile App Patch Level" (version 3)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '20325531';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Expense Mobile 3.1.0 functional issues';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25412697';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Expense Report & Data Services - REST Extensions';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '23117538';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Expense Report & Data Services - REST Extensions';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '23709865';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Employee and Guest attendee count passed in as 0 to the client extensions';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21314548';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.AD.B.delta.7';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '20395533';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.AD.B.delta.6';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19278976';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.AD.B.delta.5';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '17884289';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.AD.B.delta.4';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '9239089';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.AD.B.delta.3';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '8502056';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.AD.B.delta.2';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '7458155';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.AD.B.delta.1';
   l_col_rows(5)(l_rows) := NULL;
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '20784380';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.TXK.C.delta.7';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19330775';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.TXK.C.delta.6';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '18288881';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.TXK.C.delta.5';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '17893964';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.TXK.C.delta.4';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '17021789';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.TXK.C.delta.3';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '15946788';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.TXK.C.delta.2';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '14231141';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.TXK.C.delta.1';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '20745242';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.AD.C.delta.7';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19197270';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.AD.C.delta.6';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '18283295';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.AD.C.delta.5';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '17766337';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.AD.C.delta.4';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '17023760';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.AD.C.delta.3';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '15955263';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.AD.C.delta.2';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '14222207';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.AD.C.delta.1';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '10117518';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.AD.C';
   l_col_rows(5)(l_rows) := NULL;
...
END IF;
   ...
   l_sig.sigrepo_id := '7464';
   l_sig.title := 'Fusion Expenses Mobile App Patch Level';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := 'When troubleshooting any Internet Expense issue, it is necessary to know the exact OIE Mini-pack / rollup level, and the corresponding Financials Family Pack level.';
   l_sig.solution := '<ul><li>Please click on signature and review list.
<li>Make sure the latest rollup/RPC and one off patches are applied.</li>
</li><li>Reference: [1970645/KB698600]</li></ul>';
   l_sig.success_msg := 'All patches from [1970645/KB698600] have been applied!';
   l_sig.print_condition := 'ALWAYS';
   l_sig.fail_type := 'I';
   l_sig.print_sql_output := 'Y';
   l_sig.limit_rows := 'Y';
  ...
  -- Register
  l_step := '60';
  g_signatures('OIE_MOBILE_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'OIE_MOBILE_PATCHES',     -- sig ID
    l_sig,                              -- signature information
    l_col_rows,                         -- data
    l_hdr);                             -- headers
...
FUNCTION check_rec_patches_3 RETURN VARCHAR2 IS
  /* Signature OIE_REQUIRED_1213_PATCH */
  l_col_rows   COL_LIST_TBL := col_list_tbl(); -- Row values
  l_rel_rows   COL_LIST_TBL := col_list_tbl(); -- Row release
  l_hdr        VARCHAR_TBL  := varchar_tbl(); -- Column headings
  l_app_date   DATE;         -- Patch applied date
...
BEGIN
    ...
    print_log('Processing recommended patches signature: OIE_REQUIRED_1213_PATCH (check_rec_patches_3) "12.1.3 Recommended Patch" (version 8)');
...
IF substr(g_rep_info('Apps Version'),1,6) = '12.1.3' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.OIE.B: Oracle Internet Expenses Advanced Receipt Management consolidated changes';
...
END IF;
   ...
   l_sig.sigrepo_id := '7263';
   l_sig.title := '12.1.3 Recommended Patch';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := 'Mandatory R12.1.3 patch has not been applied.';
   l_sig.solution := 'Please apply mandatory {10040337}, whilst this may not fix this issue it is a required patch for all R12.1.3 Internet Expenses installs. This is a mandatory prerequisite for OIE development team to be involved in the analysis of this situation.
<br>It is also strongly recommended that you apply latest Recommended Patch Collection (RPC) which contains fixes for numerous already known issues on top of R12.1.3. See [1920628/KB203601] for details of latest OIE RPC.<br>
...
<li>[976188/KB739927] Patch Wizard Utility</li>
<li>[10940175/KA580] Patch Wizard FAQ</li>';
   l_sig.success_msg := 'Mandatory {10040337} has been applied.';
   l_sig.print_condition := 'ALWAYS';
   l_sig.fail_type := 'E';
   l_sig.print_sql_output := 'Y';
   l_sig.limit_rows := 'N';
  ...
  -- Register
  l_step := '60';
  g_signatures('OIE_REQUIRED_1213_PATCH') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'OIE_REQUIRED_1213_PATCH',     -- sig ID
    l_sig,                              -- signature information
    l_col_rows,                         -- data
    l_hdr);                             -- headers
...
debug('begin populate parameters hash table');
   ...
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Employee Person ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_per,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Responsibility';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_resp,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Expense Report Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_expense_report_num,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/02/25 11:25:06 $','$',''));
...
debug('begin parameter validation: p_org_ids');
...
WHERE SP.ORG_ID = p_org_ids
 AND SP.ORG_ID = O.ORGANIZATION_ID
AND (MO_GLOBAL.IS_MO_INIT_DONE = 'N' OR MO_GLOBAL.CHECK_ACCESS(SP.ORG_ID) = 'Y')
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid operating unit organization ID specified. The org_id parameter is mandatory.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_org_ids failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_org_ids');

debug('begin parameter validation: p_per');
IF p_per IS NOT NULL THEN
BEGIN
SELECT PERSON_ID
INTO l_exists_val
FROM PER_ALL_PEOPLE_F
WHERE PERSON_ID = p_per and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Person_ID specified. This must equal the PERSON_ID column from the table PER_ALL_PEOPLE_F.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_per failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_per');

debug('begin parameter validation: p_resp');
IF p_resp IS NOT NULL THEN
BEGIN
SELECT U.RESPONSIBILITY_NAME
INTO l_exists_val
FROM FND_RESPONSIBILITY SP, FND_RESPONSIBILITY_VL U
WHERE U.RESPONSIBILITY_NAME = p_resp
 AND u.responsibility_id = sp.responsibility_id
and (mo_global.is_mo_init_done = 'N' or 
mo_global.check_access(u.responsibility_id) = 'y')
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid responsibility entered.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_resp failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_resp');

debug('begin parameter validation: p_expense_report_num');
IF p_expense_report_num IS NOT NULL THEN
BEGIN
SELECT INVOICE_NUM
INTO l_exists_val
FROM AP_EXPENSE_REPORT_HEADERS_ALL
WHERE INVOICE_NUM = p_expense_report_num and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Expense Report Number specified. This must equal to INVOICE_NUM from AP_EXPENSE_REPORT_HEADERS_ALL.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_expense_report_num failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_expense_report_num');
    ...
    if p_expense_report_num is not null then
      begin
       select report_header_id
         into g_report_header_id
         from AP_EXPENSE_REPORT_HEADERS_ALL
        where upper(INVOICE_NUM) = upper(p_expense_report_num);
      exception 
       when NO_DATA_FOUND then
        g_report_header_id := null;
        print_log('No Expense Report found for the Expense Report number - '||p_expense_report_num);
       when others then
        g_report_header_id := null;
        print_log('Error in getting the report_header_id for Expense Report number - '||p_expense_report_num);
       raise invalid_parameters;
      end;
    end if;


-- Additional code for Signature: Employee Supplier Site Info (OIE_SUPPLIER_SITE_INFO)
l_step := 5; 

    if p_per is not null then
      begin
	SELECT expense_check_address_flag
	  INTO g_expense_check_address_flag 
	  FROM (
		SELECT emp.expense_check_address_flag, null vendor_id, null vendor_site_id
		  FROM per_employees_x emp
		 WHERE emp.employee_id = p_per 
		   AND NOT AP_WEB_DB_HR_INT_PKG.ispersoncwk(emp.employee_id)='Y'
		UNION ALL
		SELECT emp.expense_check_address_flag, vendor_id,vendor_site_id
		  FROM per_cont_workers_current_x emp
		 WHERE emp.person_id = p_per 
	       );

	IF g_expense_check_address_flag IS NULL THEN
		SELECT expense_check_address_flag
		  INTO g_expense_check_address_flag 
		  FROM financials_system_params_all
		 WHERE ORG_ID = g_org_ids;
	END IF;
 
      exception 
       when NO_DATA_FOUND then
        g_expense_check_address_flag := 'N';
        print_log('Expense Check Address Flag NULL for person ID - '||p_per);
       when others then
        g_expense_check_address_flag  := 'N';
        print_log('Expense Check Address Flag NULL for person ID - '||p_per);
      end;
...
debug('begin populate sql tokens hash table');
   ...
   g_masked_tokens('##$$EMPID$$##') := mask_text( g_sql_tokens('##$$EMPID$$##'), 'NO_MASK');
   g_sql_tokens('##$$RESP$$##') := l_resp_key;
   g_masked_tokens('##$$RESP$$##') := mask_text( g_sql_tokens('##$$RESP$$##'), 'NO_MASK');
   g_sql_tokens('##$$USER$$##') := l_user_id;
   g_masked_tokens('##$$USER$$##') := mask_text( g_sql_tokens('##$$USER$$##'), 'NO_MASK');
   g_sql_tokens('##$$USERNAME$$##') := nvl(to_char(l_user_name),'NULL');
   g_masked_tokens('##$$USERNAME$$##') := mask_text( g_sql_tokens('##$$USERNAME$$##'), 'NO_MASK');
   g_sql_tokens('##$$RESPNAME$$##') := p_resp;
   g_masked_tokens('##$$RESPNAME$$##') := mask_text( g_sql_tokens('##$$RESPNAME$$##'), 'NO_MASK');
   g_sql_tokens('##$$HEADERID$$##') := g_report_header_id;
   ...
   g_sql_tokens('##$$EMPCHECKADDRFLAG$$##') := g_expense_check_address_flag;
   g_masked_tokens('##$$EMPCHECKADDRFLAG$$##') := mask_text( g_sql_tokens('##$$EMPCHECKADDRFLAG$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM6$$##') := 'null';
   g_masked_tokens('##$$APPS_PARAM6$$##') := mask_text( g_sql_tokens('##$$APPS_PARAM6$$##'), 'NO_MASK');
   g_sql_tokens('##$$VENDOR_SITE_ID$$##') := 'select distinct ss.vendor_site_id 
'||
...
debug('begin add_signature: oie_versions');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2827',
      p_sig_id                 => 'oie_versions',
      p_sig_sql                => 'SELECT name,text
      FROM all_source
     WHERE name IN (''AP_WEB_EXPENSE_WF'', ''AP_WEB_ACCTG_PKG'', ''AP_WEB_DB_AP_INT_PKG'', ''AP_WEB_DB_EXPLINE_PKG'')
       AND line    = 2
     ORDER BY name',
      p_title                  => 'OIE commonly used PLSQL file versions - ALL_SOURCE',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Commonly ised PLSQL file versions',
      p_solution               => '',
      p_success_msg            => 'Click on signature to see version of AP_WEB_ACCTG_PKG, AP_WEB_DB_AP_INT_PKG, AP_WEB_DB_EXPLINE_PKG, and AP_WEB_EXPENSE_WF.',
   ...
   l_info.delete;
debug('end add_signature: oie_versions');



debug('begin add_signature: oie_PRODUCT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2885',
      p_sig_id                 => 'oie_PRODUCT',
      p_sig_sql                => 'SELECT DISTINCT t.application_name product_name,
     ...
     ORDER BY 1',
      p_title                  => 'Product Installation Status and Patchset Level',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Product Installation Status and Patchset Level',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: oie_PRODUCT');



debug('begin add_signature: oie_INVALIDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2886',
      p_sig_id                 => 'oie_INVALIDS',
      p_sig_sql                => 'select o.object_name "Object Name",
...
and  (o.object_name like ''OIE\_%'' escape ''\'')
and   s.line between 2 and 3
and   s.text like ''%Header: %''
and   o.status <> ''VALID''
order by 1, 3 desc, 5 desc',
      p_title                  => 'OIE Invalid Objects',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invalid OIE Package(s) found that may impact the application.',
      p_solution               => 'These may have no impact on your instance, they are listed for your information.<br>
See the Apps Check section for any AP invalid Packages also.
<ul>
<li>Recompile the individual objects or recompile the entire APPS schema using the adadmin utility.</li>
<li>Review any error messages provided and see [1527251/KB724238] for details on compiling these invalid objects.</li>
</ul>',
      p_success_msg            => 'No invalid OIE Package found.<br>
See the Apps Check section for any AP invalid Package(s).',
   ...
   l_info.delete;
debug('end add_signature: oie_INVALIDS');



debug('begin add_signature: OIE_INVALID_AP_WEB_EXPENSE_WF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11654',
      p_sig_id                 => 'OIE_INVALID_AP_WEB_EXPENSE_WF',
      p_sig_sql                => 'select object_name, object_type, owner, status
from dba_objects where status = ''INVALID''
and object_name like ''AP_WEB_EXPENSE_WF''',
      p_title                  => 'Expense Report Notification workflow error',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Expense Report Notification workflow errors with message: ORA-04061: existing state of has been invalidated',
      p_solution               => 'Affected Package was INVALID and needed to be recompiled.
Please refer to [1303929/KB488891] to compile the relevant package and make it valid.
',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: OIE_INVALID_AP_WEB_EXPENSE_WF');



debug('begin add_signature: OIE_KEY_PROFILES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2860',
      p_sig_id                 => 'OIE_KEY_PROFILES_ALL',
      p_sig_sql                => 'select
  ...
  ORDER BY "PROFILE"',
      p_title                  => 'Mandatory Key Profile Options (at all levels)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No profile has been set.',
      p_solution               => 'The following profiles are being checked.<br>
Those are noted as key profiles for Internet Expenses.
<ul>
<li>MO: Operating Unit</li>
<li>ICX: Date format mask</li>
<li>ICX: Language</li>
<li>ICX: Limit connect</li>
<li>ICX: Limit time</li>
<li>ICX:Session Timeout</li>
</ul>',
      p_success_msg            => 'Click on arrow above to see which profile(s) has been set.
<br>
The following profiles are being checked:<ul>
<li>MO: Operating Unit</li>
<li>ICX: Date format mask</li>
<li>ICX: Language</li>
<li>ICX: Limit connect</li>
...
<li>ICX:Session Timeout</li>
   ...
   l_info.delete;
debug('end add_signature: OIE_KEY_PROFILES_ALL');



debug('begin add_signature: OIE_OPT_PROFILES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2861',
      p_sig_id                 => 'OIE_OPT_PROFILES_ALL',
      p_sig_sql                => 'select
user_profile_option_name "PROFILE",
MAX(DECODE(lev, ''SITE'', value, NULL)) "SITE",
MAX(DECODE(lev, ''APP'', value, NULL)) "APPLICATION",
...
group by name,user_profile_option_name
ORDER BY "PROFILE"',
      p_title                  => 'Optional Key Profile Options (at all levels)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No profile has been set.',
      p_solution               => 'The following profiles are being checked:<br>
<ul>
<li>AME:Installed</li>
<li>FND: Application Module Connection Pool Enabled</li>
<li>FND: Application Module Pool Enabled</li>
<li>Application Framework Agent</li>
<li>OIE:Allow Credit Lines</li>
<li>OIE:Allow Non-Base Pay</li>
<li>OIE:Enable Approver</li>
<li>OIE:CC Approver Req</li>
<li>OIE:Enable DescFlex</li>
<li>OIE:Enable Project Allocations</li>
<li>OIE:Approver Required</li>
<li>OIE:Grace Period</li>
<li>OIE:Enable Policy</li>
<li>OIE:Purpose Required</li>
<li>OIE:Report Number Prefix</li>
<li>OIE:Enable Tax</li>
<li>Default Country</li>
<li>Journals: Display Inverse Rate</li>
<li>Personalize Self-Service Defn</li>
<li>Disable Self-Service Personal</li>
<li>WF: Notification Reassign Mode</li>
<li>HR:Cross Business Group</li>
<li>ICX: Preferred Currency</li>
<li>OIE:Carry Advances Forward</li>
<li>OIE:Enable Advances</li>
<li>OIE:Enable Expense Allocation Splitting</li>
<li>OIE:Enable Bar Code</li>
<li>OIE:Enable Cost Center</li>
<li>OIE:Enable Expense Allocations</li>
<li>OIE:Enable Project Expenditure Organization</li>
<li>PA: AutoApprove Expense Reports</li>
<li>PA: Allow Project-Related Entry in Oracle Internet Expenses</li>
<li>Printer</li>
<li>OIE:CC Payment Notify</li>
<li>OIE:Enable Credit Card</li>
<li>Sequential Numbering</li>
<li>FND: View Object Max Fetch Size</li>
<li>WF: Mailer Cancellation Email</li>
<li>MO: Security Profile</li>
</ul>',
      p_success_msg            => 'Click on arrow above to see which profile(s) has been set.<br>
The following profiles are being checked:<br>
<ul>
<li>AME:Installed</li>
<li>OIE:Allow Credit Lines</li>
<li>OIE:Allow Non-Base Pay</li>
...
<li>Sequential Numbering</li>
   ...
   l_info.delete;
debug('end add_signature: OIE_OPT_PROFILES_ALL');
...
debug('begin add_signature: oie_HR_INFO');
  ...
  add_signature(
    ...
    (SELECT emp.full_name, 
      ...
      p_title                  => 'Employee HR Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Employee HR Information',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: oie_HR_INFO');
...
debug('begin add_signature: EBS_FIN_AP_APOIE_AP_SUPPLIER_SITES');
...
order by HOU.name, vendor_id, vendor_site_id',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_APOIE_AP_SUPPLIER_SITES');



debug('begin add_signature: oie_SUP_INFO');
   l_info('##MASK##1'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##2'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2843',
      p_sig_id                 => 'oie_SUP_INFO',
      p_sig_sql                => 'SELECT * 
    FROM
    (SELECT emp.full_name, 
                     emp.employee_num, 
      ...
      p_title                  => 'Supervisor Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Supervisor Information',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: oie_SUP_INFO');



debug('begin add_signature: oie_USER_INFO');
   l_info('##MASK##2'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2844',
      p_sig_id                 => 'oie_USER_INFO',
      p_sig_sql                => 'SELECT fu.user_id, fu.user_name, TO_CHAR(fu.start_date, ''DD-MON-YYYY HH24:MI:SS'') User_Start_Date, 
     ...
     AND fu.user_id = sec.web_user_id(+)
      ...
      p_title                  => 'User Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'User Information',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: oie_USER_INFO');



debug('begin add_signature: oie_ACCOUNTING_INFO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2845',
      p_sig_id                 => 'oie_ACCOUNTING_INFO',
      p_sig_sql                => 'SELECT GS.chart_of_accounts_id,
         gl.code_combination_id,
         gl.concatenated_segments,
         ap_oie_analyzer_pkg.is_account_valid(GS.chart_of_accounts_id,gl.concatenated_segments) DEA_Valid,
         ap_oie_analyzer_pkg.get_cost_center(GS.chart_of_accounts_id,gl.code_combination_id) cost_center
      ...
      p_title                  => 'Accounting Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Accounting Information',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: oie_ACCOUNTING_INFO');



debug('begin add_signature: OIE_ILLEGALARGUMENTEXCEPTION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11619',
      p_sig_id                 => 'OIE_ILLEGALARGUMENTEXCEPTION',
      p_sig_sql                => 'SELECT employee_id,
       default_code_combination_id,
       set_of_books_id
FROM per_employees_x
WHERE (default_code_combination_id IS  NULL OR expense_check_address_flag IS NULL OR set_of_books_id IS  NULL)
AND (employee_id = ##$$EMPID$$##)
AND NOT AP_WEB_DB_HR_INT_PKG.ispersoncwk(employee_id)=''Y''',
      p_title                  => 'IllegalArgumentException error when clicking "Next" on General Information page',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'No default expense account and/or Ledger/Set of Books has been setup for the employee and/or there is no Web Expense enabled Template defined.',
      p_solution               => 'Please refer to [1215633/KB217264] for solution steps for each scenario',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: OIE_ILLEGALARGUMENTEXCEPTION');



debug('begin add_signature: OIE_ILLEGALARGUMENTEXCEPTION1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11652',
      p_sig_id                 => 'OIE_ILLEGALARGUMENTEXCEPTION1',
      p_sig_sql                => 'SELECT COUNT(*)
FROM ap_expense_reports_all aera
WHERE aera.web_enabled_flag = ''Y''
AND org_id in (##$$ORGS$$##)',
      p_title                  => 'IllegalArgumentException error when clicking "Next" on General Information page',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no Web Expense enabled Template defined.',
      p_solution               => 'Please refer to [1215633/KB217264] for solution steps on enabling the Expense report template.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: OIE_ILLEGALARGUMENTEXCEPTION1');



debug('begin add_signature: OIE_NULLPOINTEREXCEPTION');
   l_info('##MASK##2'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11620',
      p_sig_id                 => 'OIE_NULLPOINTEREXCEPTION',
      p_sig_sql                => 'select fd.user_id,fd.user_name from fnd_user fd
where fd.employee_id is not null
  and fd.user_id not in (select user_id from fnd_user fd,AK_WEB_USER_SEC_ATTR_VALUES ad
                          where fd.user_id = ad.web_user_id and ad.attribute_application_id = 178
                            and (ad.attribute_Code = ''ICX_HR_PERSON_ID'' or ad.attribute_Code =''TO_PERSON_ID''))
and fd.employee_id = ##$$EMPID$$##',
      p_title                  => 'Null pointer exception when creating Expense Report',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Securing Attributes are not set properly for this user',
      p_solution               => 'Please refer to [1244614/KB547289] and setup the Security attributes for the user.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: OIE_NULLPOINTEREXCEPTION');



debug('begin add_signature: OIE_EMPLOYEE_SETUP');
   l_info('##MASK##2'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##3'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11677',
      p_sig_id                 => 'OIE_EMPLOYEE_SETUP',
      p_sig_sql                => 'SELECT
  h.employee_id,
  h.full_name,
  h.employee_num,
...
WHERE h.employee_id = a.number_value
  ...
  AND a.web_user_id = (select user_id from fnd_user where employee_id=##$$EMPID$$##)
  AND AP_WEB_DB_HR_INT_PKG.isPersonCwk(h.employee_id) = ''N''
  AND h.employee_id = s.person_id (+) 
  AND trunc(sysdate) BETWEEN trunc(s.date_start) AND trunc(nvl(s.final_process_date, sysdate))
...
SELECT h.person_id employee_id,
      ...
      ''C'' assignment_type,
      h.termination_date
FROM per_cont_workers_x h,
     ak_web_user_sec_attr_values a,
	 per_periods_of_placement s
WHERE h.person_id = a.number_value
  AND a.attribute_code = ''ICX_HR_PERSON_ID''
  AND a.web_user_id = (select user_id from fnd_user where employee_id=##$$EMPID$$##)
  AND h.person_id = s.person_id (+) 
  AND trunc(sysdate) BETWEEN trunc(s.date_start) AND trunc(nvl(s.final_process_date, sysdate))',
      p_title                  => 'Employee HR Info',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Employee does not have a valid HR Record OR the ICX Attribute is not setup in the User form',
      p_solution               => 'Review Solution section from [2260071/KB557432] and [1244614/KB547289] and setup the Security attributes for the user.
',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: OIE_EMPLOYEE_SETUP');



debug('begin add_signature: OIE_SUPPLIER_SITE_INFO');
   l_info('##MASK##6'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11569',
      p_sig_id                 => 'OIE_SUPPLIER_SITE_INFO',
      p_sig_sql                => 'SELECT vdr.vendor_id, site.payment_currency_code, c.name,site.vendor_site_id,site.org_id,vdr.vendor_name               	
FROM   ap_suppliers vdr, ap_supplier_sites_all site, fnd_currencies_vl c
WHERE  site.vendor_id = vdr.vendor_id  
AND    vdr.employee_id = ##$$EMPID$$##                   
...
AND    upper(site.vendor_site_code) IN 
      (SELECT upper(meaning)
       ...
       WHERE  lookup_code = ''##$$EMPCHECKADDRFLAG$$##''
       AND    lookup_type = ''HOME_OFFICE'')',
      p_title                  => 'Employee Supplier Site Info',
      p_fail_condition         => 'RSGT1',
      p_problem_descr          => 'Employee has duplicate Supplier Sites, this could prevent from creating expense reports and can cause IllegalArgumentException ',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: OIE_SUPPLIER_SITE_INFO');



debug('begin add_signature: OIE_EMPLOYEE_ASSIGNEMNT_STATUS_NOT_ACTIVE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14177',
      p_sig_id                 => 'OIE_EMPLOYEE_ASSIGNEMNT_STATUS_NOT_ACTIVE',
      p_sig_sql                => 'SELECT
  past.assignment_Status_type_id,past.user_status,papf.full_name,papf.person_id,papf.employee_number
FROM
  PER_ASSIGNMENTS_F paf,
  PER_ASSIGNMENT_STATUS_TYPES past,
  per_all_people_f papf
WHERE
papf.person_id = ##$$EMPID$$##
and papf.person_id=paf.person_id
and paf.assignment_status_type_id =past.assignment_status_type_id
and past.assignment_Status_type_id in (2)',
      p_title                  => 'No Active Employee Assignment Exists to Submit Expense Reports.',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Employee Unable to Submit Expense report Since no Active Assignment Exists.',
      p_solution               => 'Please verify that there exists an Active assignment for this employee.
Refer [1990990/KB311262] for the complete Solution steps.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: OIE_EMPLOYEE_ASSIGNEMNT_STATUS_NOT_ACTIVE');



debug('begin add_signature: EBS_FIN_AP_APOIE_OIE_AP_SSE_NOTIFY_EMPLOYEE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24290',
      p_sig_id                 => 'EBS_FIN_AP_APOIE_OIE_AP_SSE_NOTIFY_EMPLOYEE',
      p_sig_sql                => 'select owner, trigger_name, trigger_type, triggering_event, table_owner, base_object_type, table_name, column_name, description, status 
from all_triggers
where trigger_name=''AP_SSE_NOTIFY_EMPLOYEE''
and status = ''ENABLED''',
      p_title                  => 'Trigger AP_SSE_NOTIFY_EMPLOYEE is ENABLED',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Trigger ''AP_SSE_NOTIFY_EMPLOYEE''  is still enabled ',
      p_solution               => 'Please follow the instructions detailed in [2001127/KB393339]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_APOIE_OIE_AP_SSE_NOTIFY_EMPLOYEE');



debug('begin add_signature: EBS_FIN_AP_APOIE_OIE_SUP_VACS_RULES');
   l_info('##MASK##1'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##2'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25363',
      p_sig_id                 => 'EBS_FIN_AP_APOIE_OIE_SUP_VACS_RULES',
      p_sig_sql                => 'SELECT * 
    FROM
( SELECT fnd.employee_id, fnd.user_name, wrr.*
    FROM fnd_user fnd, fnd_user app, wf_routing_rules wrr
  WHERE fnd.user_name = wrr.action_argument
   and wrr.message_type = ''APEXP'' 
   and wrr.action = ''FORWARD''
   and (TRUNC(SYSDATE) BETWEEN TRUNC((wrr.BEGIN_DATE)) AND TRUNC(NVL(wrr.END_DATE,SYSDATE+1)))
   and wrr.role = app.user_name
   and app.employee_id  IN
    (SELECT emp.employee_id 
         ...
         AND NOT AP_WEB_DB_HR_INT_PKG.ispersoncwk(emp.employee_id)=''Y''
       UNION ALL
         SELECT cwk.person_id
         FROM  per_cont_workers_current_x cwk,
               per_cont_workers_current_x sup_cwk
         WHERE  sup_cwk.person_id = ##$$EMPID$$##
         AND cwk.person_id = sup_cwk.supervisor_id)
)',
      p_title                  => 'Supervisor Vacations Rules',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Supervisor Vacations Rules',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_APOIE_OIE_SUP_VACS_RULES');



debug('begin add_signature: EBS_FIN_AP_APOIE_SUPPLIER_SSITE_INACTIVE');
   l_info('##SHOW_SQL##'):= 'N';
  add_signature(
      p_sig_repo_id            => '25031',
      p_sig_id                 => 'EBS_FIN_AP_APOIE_SUPPLIER_SSITE_INACTIVE',
      p_sig_sql                => 'SELECT   aps.vendor_id, assa.vendor_site_code, aps.employee_id, aps.END_DATE_ACTIVE
             FROM   ap_suppliers aps,
             ap_supplier_sites_all assa ,
             hr_operating_units hou
   WHERE       aps.vendor_id = assa.vendor_id
           AND aps.employee_id =  ##$$EMPID$$##
          AND assa.org_id = hou.organization_id
           AND ((aps.end_date_active IS NOT NULL OR aps.END_DATE_ACTIVE < SYSDATE)
           OR (assa.inactive_date IS NOT NULL OR assa.inactive_date < SYSDATE))

',
      p_title                  => 'Supplier or Supplier Site is Inactive',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Supplier or Supplier Site inactivated',
      p_solution               => 'Please follow the steps in [2915228/KB200748] to help resolve the issue.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_APOIE_SUPPLIER_SSITE_INACTIVE');



debug('begin add_signature: oie_FND_LOOKUP_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2888',
      p_sig_id                 => 'oie_FND_LOOKUP_TYPES',
      p_sig_sql                => 'select * from FND_LOOKUP_TYPES
    where lower(lookup_type) like ''expense report status''
    and view_application_id = 0',
      p_title                  => 'Audit Expense Report Lookup Type',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The lookup type ''Expense Report Status'' was defined more than once in file apoie12alu.ldt',
      p_solution               => '<ul>
   ...
   <li>Follow instructions in [1104883/KB230722]</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: oie_FND_LOOKUP_TYPES');



debug('begin add_signature: oie_FND_LOOKUP_TYPES_TL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2889',
      p_sig_id                 => 'oie_FND_LOOKUP_TYPES_TL',
      p_sig_sql                => 'select * from FND_LOOKUP_TYPES_TL
    where lower(lookup_type) like ''expense report status''
    and view_application_id = 0',
      p_title                  => 'Audit Expense Report Lookup Type TL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The lookup type ''Expense Report Status'' was defined more than once in file apoie12alu.ldt',
      p_solution               => '<ul>
    <li>**Any** rows returned indicate duplicates appear to be present, as the selects are tailored to pull the duplicate data, not the original good data</li>
   ...
   l_info.delete;
debug('end add_signature: oie_FND_LOOKUP_TYPES_TL');



debug('begin add_signature: oie_FND_LOOKUP_VALUES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2890',
      p_sig_id                 => 'oie_FND_LOOKUP_VALUES',
      p_sig_sql                => 'select * from FND_LOOKUP_VALUES
    where lower(lookup_type) like ''expense report status''
    and view_application_id = 0',
      p_title                  => 'Audit Expense Report Lookup Type TL',
      p_fail_condition         => 'RS',
   ...
   l_info.delete;
debug('end add_signature: oie_FND_LOOKUP_VALUES');



debug('begin add_signature: oie_Note403933');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2891',
      p_sig_id                 => 'oie_Note403933',
      p_sig_sql                => 'select aerh.vouchno, aerh.org_id, aerh.report_header_id,aerh.expense_status_code,ap.payment_status_flag
    from ap_expense_report_headers_all aerh, ap_invoices_all ap
    where aerh.report_header_id = nvl(##$$HEADERID$$##,aerh.report_header_id)
    and aerh.expense_status_code = ''INVOICED''
    ...
    and ap.payment_status_flag != ''N''',
      p_title                  => 'Paid Expense Report Shows Incorrect Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Paid Expense Report Shows Incorrect Status',
      p_solution               => '<ul>
    <li>**Any** rows returned indicate that the status of the expense report is incorrect</li>
   <li>Follow instructions in [403933/KB770469]</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: oie_Note403933');



debug('begin add_signature: OIE_DUP_LINE_NUMBER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10287',
      p_sig_id                 => 'OIE_DUP_LINE_NUMBER',
      p_sig_sql                => 'select ael.distribution_line_number, ael.report_header_id, aeh.reject_code,
ael.report_line_id
from ap_expense_report_headers_all aeh,
ap_expense_report_lines_all ael,
ap_expense_report_lines_all aeld
where 1 = 1
and ael.report_header_id = aeh.report_header_id
and aeld.report_header_id = aeh.report_header_id
and ael.report_line_id != aeld.report_line_id
and ael.distribution_line_number = aeld.distribution_line_number
and ael.report_header_id = ##$$HEADERID$$##',
      p_title                  => 'Duplicate Line Number',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Expense report has multiple lines in ap_expense_report_lines_all with same Distribution_line_number',
      p_solution               => 'Apply the GDF patch following the instructions provided in [2501394/KB742327]
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: OIE_DUP_LINE_NUMBER');



debug('begin add_signature: OIE_EXPENSE_HEADER_LINE_MISMATCH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8641',
      p_sig_id                 => 'OIE_EXPENSE_HEADER_LINE_MISMATCH',
      p_sig_sql                => 'SELECT aerha.invoice_num,
...
WHERE 
aerha.report_header_id = nvl(##$$HEADERID$$##,aerha.report_header_id) 
AND aerha.report_header_id = aerla.report_header_id
AND aerha.expense_status_code = ''INVOICED''
AND aerla.itemization_parent_id IS NOT NULL
AND aerla.itemization_parent_id <> -1
AND aerla.itemization_parent_id NOT IN
(SELECT report_line_id
FROM ap_Expense_report_lines_all rl
WHERE rl.itemization_parent_id = -1
)
ORDER BY aerha.invoice_num DESC',
      p_title                  => 'Expense Report Export failing with EXPENSE HEADER LINE MISMATCH',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Expense report line(s) with invalid itemization found',
      p_solution               => 'Apply the GDF patch following the instructions provided in [2501394/KB742327]
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: OIE_EXPENSE_HEADER_LINE_MISMATCH');



debug('begin add_signature: OIE_EXPENSE_HEADER_LINE_MISMATCH_2');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10232',
      p_sig_id                 => 'OIE_EXPENSE_HEADER_LINE_MISMATCH_2',
      p_sig_sql                => 'select aeh.report_header_id,
aeh.amt_due_ccard_company,
sum(ael.amount),
acct.category,
acct.payment_due_from_code,
aeh.reject_code
from ap_expense_report_headers_all AEH ,
ap_expense_report_lines_all AEL,
ap_credit_card_trxns_all ACCT
where 
AEH.report_header_id = nvl(##$$HEADERID$$##,AEH.report_header_id) 
and aeh.report_header_id = ael.report_header_id
...
select sum(amount) from ap_expense_report_lines_all AELA where aela.report_header_id = aeh.report_header_id and aela.credit_card_trx_id is not NULL )
group by aeh.report_header_id,
aeh.amt_due_ccard_company,
acct.category,
acct.payment_due_from_code,
aeh.reject_code
order by 1,5',
      p_title                  => 'Expense Report Export failing EXPENSE HEADER LINE MISMATCH',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Data corruption - an incorrect amount in the amt_due_ccard_company column of the ap_expense_report_headers_all table.',
      p_solution               => 'Apply/Run the select and fix scripts following the instructions provided in [2501394/KB742327]
...
',
   ...
   l_info.delete;
debug('end add_signature: OIE_EXPENSE_HEADER_LINE_MISMATCH_2');



debug('begin add_signature: OIE_EXPENSE_HEADER_LINE_MISMATCH_3');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10237',
      p_sig_id                 => 'OIE_EXPENSE_HEADER_LINE_MISMATCH_3',
      p_sig_sql                => 'SELECT distinct aerla.org_id "ORG ID",
aerla.report_header_id "REPORT HEADER ID",
aerpa.expense_type_code "TYPE",
aerha.total "TOTAL",
to_char(TOTAL,''999,999,999,999.99'')
FROM ap_expense_report_lines_all aerla,
ap_expense_report_headers_all aerha,
...
and aerla.org_id = aerha.org_id
and aerha.reject_code = ''EXPENSE HEADER LINE MISMATCH''
and aerpa.expense_type_code = ''PERSONAL''
and (aerha.source <> ''NONVALIDATEDWEBEXPENSE'' or
aerha.workflow_approved_flag is null)
and aerha.source <> ''BOTH PAY''
and nvl(
aerha.expense_status_code,
ap_web_oa_active_pkg.getreportstatuscode (
aerha.source,
aerha.workflow_approved_flag,
aerha.report_header_id, ''N''))
...
and ( (itemization_parent_id is null) or ( itemization_parent_id <> -1 ))',
      p_title                  => 'Expense Report Export failing with EXPENSE HEADER LINE MISMATCH',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'When running the Expense Report Export, expense report(s) are rejected with ''Expense Report Header and Line amounts do not match''',
      p_solution               => '<strong>Codefix:</strong>
Please check if any code fix is applicable as per the [1525971/KB321372] <br>
<strong>Datafix:</strong>
Please follow the instructions as detailed in [2501394/KB742327].
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: OIE_EXPENSE_HEADER_LINE_MISMATCH_3');



debug('begin add_signature: OIE_EXPENSE_LINE_DIST_AMT_CNT_MISMATCH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10241',
      p_sig_id                 => 'OIE_EXPENSE_LINE_DIST_AMT_CNT_MISMATCH',
      p_sig_sql                => 'SELECT * FROM
(SELECT SUM(lines_total) lines_total, SUM(lines_count) lines_count,
SUM(dist_total) distribution_total, SUM(dist_count) distribution_count, report_header_id
FROM
...
WHERE
al.report_header_id = nvl(##$$HEADERID$$##,al.report_header_id)
AND (al.itemization_parent_id IS NULL
OR al.itemization_parent_id <> -1)
AND al.web_parameter_id NOT IN
( SELECT axp.parameter_id
FROM ap_expense_report_params_all axp
WHERE axp.expense_type_code = ''PERSONAL'') group by al.report_header_id
UNION
...
WHERE
ad.report_header_id = nvl(##$$HEADERID$$##,ad.report_header_id)
AND NVL(ad.web_parameter_id, (SELECT web_parameter_id
                              FROM ap_expense_report_lines_all aerl
                              WHERE aerl.report_line_id = ad.report_line_id))
NOT IN (SELECT axp.parameter_id FROM ap_expense_report_params_all axp
...
or lines_count <> distribution_count',
      p_title                  => 'Expense Report Export failing with EXPENSE LINE DIST MISMATCH',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Internet Expense Report is rejected by the Expense Report Export Program with the following Rejection Description:  Expense Report Line and Distribution Totals do not match.',
      p_solution               => '<strong>Codefix:</strong>
Patch {16286943}<br>
Bounce the Apache server and clear server cache
<br>
Apply/Run the select and fix scripts following the instructions provided in [2501394/KB742327]<br>
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: OIE_EXPENSE_LINE_DIST_AMT_CNT_MISMATCH');



debug('begin add_signature: OIE_EXPENSE_LINE_DIST_MISMATCH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7447',
      p_sig_id                 => 'OIE_EXPENSE_LINE_DIST_MISMATCH',
      p_sig_sql                => 'SELECT distinct aerha.report_header_id, aerha.set_of_books_id, aerha.org_id, aerha.invoice_num, 
aerha.employee_id, aerha.creation_date, aerha.created_by, aerha.last_update_date, aerha.last_updated_by, aerha.total, 
aerha.source, aerha.workflow_approved_flag, aerda.web_parameter_id
FROM ap_expense_report_headers_all aerha, ap_exp_report_dists_all aerda
WHERE 
aerha.report_header_id = nvl(##$$HEADERID$$##,aerha.report_header_id) 
and aerha.report_header_id = aerda.report_header_id
and aerda.web_parameter_id is null
ORDER BY aerha.invoice_num desc',
      p_title                  => 'Expense Report Export failing with EXPENSE LINE DIST MISMATCH',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Null web_parameter_id value in the AP_EXP_REPORT_DISTS_ALL table.',
      p_solution               => '<strong>Codefix:</strong><br> 
Patch {16286943}<br>
Patch {17499237}<br>
Bounce the Apache server and clear server cache
<br>
<strong>Datafix:</strong><br>
Follow the instructions provided in [2501394/KB742327] to apply the generic data fix scripts. <br>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: OIE_EXPENSE_LINE_DIST_MISMATCH');



debug('begin add_signature: OIE_INVALID_LINE_TYPE_LOOKUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10159',
      p_sig_id                 => 'OIE_INVALID_LINE_TYPE_LOOKUP',
      p_sig_sql                => 'SELECT apeh.report_header_id "Report Id",
apeh.invoice_num "Expense Report Number",
apeh.reject_code "Rejection Code",
apeh.EXPENSE_STATUS_CODE "Expense Report Status",
apel.LINE_TYPE_LOOKUP_CODE "Line Type",
apel.report_line_id "Line Id" ,
apel.AMOUNT "Line Amount"
FROM ap_expense_report_headers_all apeh,
ap_expense_report_lines_all apel
WHERE 
apeh.report_header_id = nvl(##$$HEADERID$$##,apeh.report_header_id) 
AND apeh.report_header_id = apel.report_header_id
AND apeh.EXPENSE_STATUS_CODE = ''INVOICED''
AND apel.LINE_TYPE_LOOKUP_CODE <> ''ITEM''
ORDER BY apeh.invoice_num DESC',
      p_title                  => 'Expense Report Export failing with INVALID LINE TYPE LOOKUP',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Export process rejects invoice with reason ''Invalid line type lookup code'' when expense report includes credit card transactions that are itemized because system is incorrectly setting line type lookup code to "TEST" when auto-itemizing cc transactions.',
      p_solution               => 'Code Fix:

    1) For 11i, please refer [1263624/KB342544] and apply the patch {9275805}
    2) For R12, please refer [1276996/KB527310] and apply the patches {7185261}, {9285704} and {7277804}

Data Fix:

Apply the GDF patch following the instructions provided in [2501394/KB742327]
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: OIE_INVALID_LINE_TYPE_LOOKUP');



debug('begin add_signature: OIE_LINE_AMOUNT_IS_NULL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10135',
      p_sig_id                 => 'OIE_LINE_AMOUNT_IS_NULL',
      p_sig_sql                => 'SELECT apeh.report_header_id "Report Id",
apeh.invoice_num "Expense Report Number",
apeh.reject_code "Rejection Code",
apeh.EXPENSE_STATUS_CODE "Expense Report Status",
apel.report_line_id "Line Id" ,
apel.AMOUNT "Line Amount" ,
aped.report_distribution_id "Distribution Id",
aped.amount"Distribution Amount"
FROM ap_expense_report_headers_all apeh,
ap_expense_report_lines_all apel,
...
OR (aped.amount IS NULL) )
ORDER BY apeh.invoice_num DESC',
      p_title                  => 'Expense Report Export failing with LINE AMOUNT IS NULL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'An approved expense report is rejected during export with the Rejection Reason "Invoice line amount is null".',
      p_solution               => 'Apply the GDF patch following the instructions provided in [2501394/KB742327]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: OIE_LINE_AMOUNT_IS_NULL');



debug('begin add_signature: EBS_FIN_AP_APOIE_ERROR_RECEIPT_CURRENCY_SAME_AS_REIMBURSEMENT_CURRENCY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24792',
      p_sig_id                 => 'EBS_FIN_AP_APOIE_ERROR_RECEIPT_CURRENCY_SAME_AS_REIMBURSEMENT_CURRENCY',
      p_sig_sql                => 'SELECT
    trx_id,
    validate_code,
    expensed_amount,
...
WHERE
    ...
    AND billed_amount <> transaction_amount
    AND billed_currency_code = posted_currency_code
    AND trx_id =##$$HEADERID$$##',
      p_title                  => 'Error Receipt Currency Same As Reimbursement Currency, The Exchange Rate Will Default To 1 - AP_CREDIT_CARD_TRXNS_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => ' Receipt Currency Same As Reimbursement Currency, The Exchange Rate Will Default To 1',
      p_solution               => 'Follow action plan from [2252328/KB538080] for the  problematic transaction',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_APOIE_ERROR_RECEIPT_CURRENCY_SAME_AS_REIMBURSEMENT_CURRENCY');



debug('begin add_signature: FINANCIAL_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2847',
      p_sig_id                 => 'FINANCIAL_OPTIONS',
      p_sig_sql                => 'select * from financials_system_params_all where org_id in (##$$ORGS$$##)',
      p_title                  => 'Financial Options - FINANCIALS_SYSTEM_PARAMS_ALL',
      p_fail_condition         => 'NRS',
   ...
   l_info.delete;
debug('end add_signature: FINANCIAL_OPTIONS');



debug('begin add_signature: PAYABLES_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2846',
      p_sig_id                 => 'PAYABLES_OPTIONS',
      p_sig_sql                => 'select * from ap_system_parameters_all where org_id in (##$$ORGS$$##)',
      p_title                  => 'Payables Options - AP_SYSTEM_PARAMETERS_ALL',
      p_fail_condition         => 'NRS',
   ...
   l_info.delete;
debug('end add_signature: PAYABLES_OPTIONS');



debug('begin add_signature: oie_ACCOUNTING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2848',
      p_sig_id                 => 'oie_ACCOUNTING',
      p_sig_sql                => 'SELECT *
  FROM  
  ...
  ORDER BY chart_of_accounts ASC',
      p_title                  => 'Chart of Accounts',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Chart of Accounts',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: oie_ACCOUNTING');



debug('begin add_signature: oie_VAT_SETUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2849',
      p_sig_id                 => 'oie_VAT_SETUP',
      p_sig_sql                => 'select * from AP_WEB_VAT_SETUP_ALL where org_id in (##$$ORGS$$##)',
      p_title                  => 'VAT related Setup - AP_WEB_VAT_SETUP_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'VAT-related Setup',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: oie_VAT_SETUP');



debug('begin add_signature: oie_EXPENSE_PARAMS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2851',
      p_sig_id                 => 'oie_EXPENSE_PARAMS',
      p_sig_sql                => 'SELECT     
  ou.name ORG_NAME,    
  ...
  and sp.org_id in (##$$ORGS$$##)',
      p_title                  => 'Expense Parameters',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Expense Parameters',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: oie_EXPENSE_PARAMS');



debug('begin add_signature: OIE_EXPENSE_REPORT_HEADERS');
   l_info('##MASK##OVERRIDE_APPROVER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10198',
      p_sig_id                 => 'OIE_EXPENSE_REPORT_HEADERS',
      p_sig_sql                => 'select *
from ap_expense_report_headers_all
where report_header_id = ##$$HEADERID$$##',
      p_title                  => 'Expense Report Header Details - AP_EXPENSE_REPORT_HEADERS_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Expense Report Header Details',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OIE_EXPENSE_REPORT_HEADERS');



debug('begin add_signature: OIE_EXPENSE_REPORT_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10200',
      p_sig_id                 => 'OIE_EXPENSE_REPORT_LINES',
      p_sig_sql                => 'select *
from ap_expense_report_lines_all
where report_header_id = ##$$HEADERID$$##',
      p_title                  => 'Expense Report Lines Details - AP_EXPENSE_REPORT_LINES_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Expense Report Lines Details',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OIE_EXPENSE_REPORT_LINES');



debug('begin add_signature: OIE_EXPENSE_REPORT_DISTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10201',
      p_sig_id                 => 'OIE_EXPENSE_REPORT_DISTS',
      p_sig_sql                => 'select *
from ap_exp_report_dists_all
where report_header_id = ##$$HEADERID$$##',
      p_title                  => 'Expense Report Distribution Details - AP_EXP_REPORT_DISTS_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Expense Report Distribution Details',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OIE_EXPENSE_REPORT_DISTS');



debug('begin add_signature: OIE_CREDIT_CARD_TRXNS');
  ...
  add_signature(
      p_sig_repo_id            => '10203',
      p_sig_id                 => 'OIE_CREDIT_CARD_TRXNS',
      p_sig_sql                => 'select * 
from AP_CREDIT_CARD_TRXNS_ALL
where trx_id in
(select unique CREDIT_CARD_TRX_ID
   from ap_expense_report_lines_all
  where report_header_id = ##$$HEADERID$$##)',
      p_title                  => 'Credit Card Transaction Details - AP_CREDIT_CARD_TRXNS_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Credit Card Transaction Details',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OIE_CREDIT_CARD_TRXNS');



debug('begin add_signature: EBS_FIN_AP_APOIE_EXPENSE_REPORT_APPLIED_AS_ADAVANCE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24837',
      p_sig_id                 => 'EBS_FIN_AP_APOIE_EXPENSE_REPORT_APPLIED_AS_ADAVANCE',
      p_sig_sql                => 'SELECT
    a.report_header_id,
    a.employee_id,
    a.invoice_num,
...
WHERE
    upper(a.prepay_num) LIKE ''%''||upper(b.invoice_num)||''%''
    AND b.report_header_id = ##$$HEADERID$$##',
      p_title                  => 'Expense Report Applied as Advance',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Expense report applied as advance',
      p_solution               => 'Expense report applied as advance',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_APOIE_EXPENSE_REPORT_APPLIED_AS_ADAVANCE');



debug('begin add_signature: oie_EXPENSE_REPORTS_TEMPLATES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2850',
      p_sig_id                 => 'oie_EXPENSE_REPORTS_TEMPLATES',
      p_sig_sql                => 'select   
  expense_report_id,   
  report_type,   
  description,   
  ...
  where org_id in (##$$ORGS$$##)',
      p_title                  => 'Expense Template Header - AP_EXPENSE_REPORTS_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Expense Template Header',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: oie_EXPENSE_REPORTS_TEMPLATES');



debug('begin add_signature: OIE_EXP_TYPE_INFO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11249',
      p_sig_id                 => 'OIE_EXP_TYPE_INFO',
      p_sig_sql                => 'select *
from ap_expense_report_params_all
where parameter_id in 
    (select web_parameter_id 
     from ap_expense_report_lines_all 
     where report_header_id in (##$$HEADERID$$##))',
      p_title                  => 'Expense Template Lines - AP_EXPENSE_REPORT_PARAMS_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No accounting data found for the line distributions on the specified expense report.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: OIE_EXP_TYPE_INFO');



debug('begin add_signature: EBS_AP_APOIE_TEMPLATE_ITEMS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24896',
      p_sig_id                 => 'EBS_AP_APOIE_TEMPLATE_ITEMS',
      p_sig_sql                => 'select PARAMETER_ID,
EXPENSE_REPORT_ID,
ORG_ID,
PROMPT,
VAT_CODE,
...
LAST_UPDATED_BY
from ap_expense_report_params_all
WHERE EXPENSE_REPORT_ID in (SELECT DISTINCT d.EXPENSE_REPORT_ID
FROM ap_expense_report_headers_all d
WHERE d. REPORT_HEADER_ID =  ##$$HEADERID$$##)
order by parameter_id asc',
      p_title                  => 'Expense Report Template Items',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Expense Report Template Items',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_AP_APOIE_TEMPLATE_ITEMS');



debug('begin add_signature: oie_TAX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2852',
      p_sig_id                 => 'oie_TAX',
  ...
  AND b.org_id in (##$$ORGS$$##)',
      p_title                  => 'Taxes Enabled for Internet Expenses',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Taxes Enabled for Internet Expenses',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: oie_TAX');



debug('begin add_signature: oie_CARD_PROGRAMS');
   l_info('##MASK##1'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2853',
      p_sig_id                 => 'oie_CARD_PROGRAMS',
      p_sig_sql                => 'select card_program_name, card_program_id, card_code_set_id, card_type_lookup_code,card_program_currency_code,inactive_date,vendor_id,vendor_site_id 
from AP_CARD_PROGRAMS_ALL where org_id in (##$$ORGS$$##)',
      p_title                  => 'Card Programs - AP_CARD_PROGRAMS_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Card Programs',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: oie_CARD_PROGRAMS');



debug('begin add_signature: oie_CARD_SUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2854',
      p_sig_id                 => 'oie_CARD_SUP',
      p_sig_sql                => 'select * from AP_CARD_SUPPLIERS_ALL where org_id in (##$$ORGS$$##)',
      p_title                  => 'Card Suppliers - AP_CARD_SUPPLIERS_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Card Suppliers',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: oie_CARD_SUP');



debug('begin add_signature: EBS_FIN_AP_APOIE_DUPLICATE_CREDIT_CARD_ENTRIES_POST_UPGRADE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29741',
      p_sig_id                 => 'EBS_FIN_AP_APOIE_DUPLICATE_CREDIT_CARD_ENTRIES_POST_UPGRADE',
      p_sig_sql                => 'SELECT
    apc.card_id    AS good_card_id,
    (
        SELECT
            apc2.card_id
        FROM
            ...
            iby_creditcard  cc2
        WHERE
                apc2.card_reference_id = cc2.instrid
            AND cc2.ccnumber = cc1.ccnumber
            AND cc2.chname IS NULL
    )              AS bad_card_id
FROM
    iby_creditcard  cc1,
    ap_cards_all    apc
WHERE
        apc.card_reference_id = cc1.instrid
    AND cc1.chname IS NOT NULL
    AND EXISTS (
        SELECT
            ccnumber,
            COUNT(*)
        FROM
            iby_creditcard cc2
        WHERE
            cc2.ccnumber = cc1.ccnumber
        GROUP BY
            ccnumber
        HAVING
            COUNT(*) > 1
    )',
      p_title                  => 'Duplicate Credit Card Entries Post-Upgrade',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Duplicate Credit Card Entries Post-Upgrade ',
      p_solution               => 'Please refer to the solution mentioned in [3002238/KB761802] to resolve this issue.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_APOIE_DUPLICATE_CREDIT_CARD_ENTRIES_POST_UPGRADE');



debug('begin add_signature: EBS_FIN_AP_APOIE_OIE_DUPLICATE_CREDIT_CARD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30450',
      p_sig_id                 => 'EBS_FIN_AP_APOIE_OIE_DUPLICATE_CREDIT_CARD',
      p_sig_sql                => 'SELECT count(*)
FROM iby_creditcard icc
WHERE (
 ( cc_number_hash1 <> iby_security_pkg.get_hash (ccnumber, ''F'') )
OR 
(cc_number_hash2 <> iby_security_pkg.get_hash (ccnumber, ''T'') ) 
)',
      p_title                  => 'Credit Card Loader Program Create Duplicate Credit Cards - IBY_CREDITCARD',
      p_fail_condition         => '[count(*)]>[0]',
      p_problem_descr          => 'Credit Card Loader Program creating duplicate cards after database character set conversion',
      p_solution               => 'Please review sections A and B in [2765467/KB157331].  Follow the section applicable.
- If still not resolved, update the SR with the steps taken and Support will continue analysis / provide a datafix.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_APOIE_OIE_DUPLICATE_CREDIT_CARD');



debug('begin add_signature: oie_WORKFLOW_SETUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2855',
      p_sig_id                 => 'oie_WORKFLOW_SETUP',
      p_sig_sql                => 'select * from (
                   ...
                   order by to_number(version_segment1) desc,
                   ...
                   where 
                            rownum < 2',
      p_title                  => 'AP Expense Workflow Version',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'AP Expense Workflow Version',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: oie_WORKFLOW_SETUP');



debug('begin add_signature: oie_AME_SETUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2856',
      p_sig_id                 => 'oie_AME_SETUP',
      p_sig_sql                => 'Select decode(
                   ...
                   ,''1.1'',''Pre-AME.B'',''2'',''Post-AME.B'',''Post-AME.B'') 
                    AME_LEVEL From Dual',
      p_title                  => 'AME Setup Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'AME Setup Details',
      p_solution               => '<ul>
   <li>Follow [290032/KB436453] to run the respective getAMESetup11510.sql script</li>
   </ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: oie_AME_SETUP');



debug('begin add_signature: OIE_APPROVER_ERROR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11928',
      p_sig_id                 => 'OIE_APPROVER_ERROR',
      p_sig_sql                => 'select al.transaction_id "Report Header",
aha.invoice_num "Expense Report Number",
aha.vouchno "Invoice Id",
aha.total "Total",
aha.creation_date "Creation Date",
al.EXCEPTION_STRING "Error Message" 
FROM ame_exceptions_log al, ap_expense_report_headers_all aha
WHERE al.transaction_id = aha.REPORT_HEADER_ID
AND al.APPLICATION_ID=''-223''
AND al.EXCEPTION_NUMBER=''-20001''
AND aha.vouchno=0
AND aha.EXPENSE_STATUS_CODE=''PENDMGR'' 
order by al.transaction_id',
      p_title                  => 'Approval not working - getting error: "...the approver passed to ame_api2.updateApprovalStatus does not match anyone on the list of Approvers."',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Getting error "...the approver passed to ame_api2.updateApprovalStatus does not match anyone on the list of Approvers.." on the exceptions log when submitting a new expense report to AME for approval.',
      p_solution               => 'Please refer to the solution mentioned in [1512960/KB201264] to resolve this issue.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: OIE_APPROVER_ERROR');



debug('begin add_signature: oie_AUDITORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2898',
      p_sig_id                 => 'oie_AUDITORS',
      p_sig_sql                => 'select * from AP_AUD_AUDITORS',
      p_title                  => 'Auditors- AP_AUD_AUDITORS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Auditors',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: oie_AUDITORS');



debug('begin add_signature: oie_RULE_SETUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2899',
      p_sig_id                 => 'oie_RULE_SETUP',
      p_sig_sql                => 'select * from AP_AUD_RULE_SETS where rule_set_type = ''RULE''',
      p_title                  => 'Audit Rule Setup - AP_AUD_RULE_SETS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Audit Rule Setup',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: oie_RULE_SETUP');



debug('begin add_signature: oie_RULE_ASSIGN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2900',
      p_sig_id                 => 'oie_RULE_ASSIGN',
      p_sig_sql                => 'select       
  ...
  and aara.org_id in (##$$ORGS$$##)',
      p_title                  => 'Audit Rule Assignments - AP_AUD_RULE_ASSIGNMENTS_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Audit Rule Assignments',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: oie_RULE_ASSIGN');



debug('begin add_signature: oie_LIST_SETUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2902',
      p_sig_id                 => 'oie_LIST_SETUP',
      p_sig_sql                => 'select * from AP_AUD_RULE_SETS where rule_set_type = ''AUDIT_LIST''',
      p_title                  => 'Audit List Rule - AP_AUD_RULE_SETS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Audit List Rule',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: oie_LIST_SETUP');



debug('begin add_signature: oie_LIST_ASSIGN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2903',
      p_sig_id                 => 'oie_LIST_ASSIGN',
      p_sig_sql                => 'select       
  aara.rule_assignment_id,       
  aara.rule_set_id,       
  aars.rule_set_name,       
  ...
  and aara.org_id in (##$$ORGS$$##)',
      p_title                  => 'Audit List Rule Assignments',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Audit List Rule Assignments',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: oie_LIST_ASSIGN');



debug('begin add_signature: oie_RECEIPT_SETUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2904',
      p_sig_id                 => 'oie_RECEIPT_SETUP',
      p_sig_sql                => 'select * from AP_AUD_RULE_SETS where rule_set_type = ''RECEIPT''',
      p_title                  => 'Receipt Rules - AP_AUD_RULE_SETS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Receipt Rules',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: oie_RECEIPT_SETUP');



debug('begin add_signature: oie_RECEIPT_ASSIGN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2905',
      p_sig_id                 => 'oie_RECEIPT_ASSIGN',
      p_sig_sql                => 'select       
  aara.rule_assignment_id,       
  aara.rule_set_id,       
  aars.rule_set_name,       
  ...
  and aars.rule_set_type = ''RECEIPT''
  and aara.org_id in (##$$ORGS$$##)',
      p_title                  => 'Receipt Rule Assignments',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Receipt Rule Assignments',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: oie_RECEIPT_ASSIGN');



debug('begin add_signature: oie_NOTIFY_SETUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2906',
      p_sig_id                 => 'oie_NOTIFY_SETUP',
      p_sig_sql                => 'select * from AP_AUD_RULE_SETS where rule_set_type = ''NOTIFY''',
      p_title                  => 'Notification Rules',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Notification Rules',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: oie_NOTIFY_SETUP');



debug('begin add_signature: oie_NOTIFY_ASSIGN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2908',
      p_sig_id                 => 'oie_NOTIFY_ASSIGN',
      p_sig_sql                => 'select       
  aara.rule_assignment_id,       
  aara.rule_set_id,       
  aars.rule_set_name,       
  ...
  and aara.org_id in (##$$ORGS$$##)',
      p_title                  => 'Notification Rule Assignments',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Notification Rule Assignments',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: oie_NOTIFY_ASSIGN');



debug('begin add_signature: oie_HOLD_SETUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2910',
      p_sig_id                 => 'oie_HOLD_SETUP',
      p_sig_sql                => 'select * from AP_AUD_RULE_SETS where rule_set_type = ''HOLD''',
      p_title                  => 'Hold Rules - AP_AUD_RULE_SETS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Hold Rules',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: oie_HOLD_SETUP');



debug('begin add_signature: oie_HOLD_ASSIGN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2911',
      p_sig_id                 => 'oie_HOLD_ASSIGN',
      p_sig_sql                => 'select       
  aara.rule_assignment_id,       
  aara.rule_set_id,       
  aars.rule_set_name,       
  ...
  and aars.rule_set_type = ''HOLD'' 
  and aara.org_id in (##$$ORGS$$##)',
      p_title                  => 'Hold Rule Assignments',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Hold Rule Assignments',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: oie_HOLD_ASSIGN');



debug('begin add_signature: oie_POL_CONTEXT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2857',
      p_sig_id                 => 'oie_POL_CONTEXT',
      p_sig_sql                => 'select user_id,selected_org_id from AP_POL_CONTEXT where selected_org_id in (##$$ORGS$$##)',
      p_title                  => 'User & Organization Specific Policy Compliance Setup - AP_POL_CONTEXT',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'User & Organization Specific Policy Compliance Setup',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: oie_POL_CONTEXT');



debug('begin add_signature: oie_POL_TOLERANCE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2858',
      p_sig_id                 => 'oie_POL_TOLERANCE',
      p_sig_sql                => 'select b.exchange_rate_id,a.exchange_rate_tolerance_id, a.currency_code, a.tolerance, b.default_exchange_rates, 
     ...
     where a.exchange_rate_id = b.exchange_rate_id
      and b.org_id in (##$$ORGS$$##)',
      p_title                  => 'Exchange Rate Tolerance',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Exchange Rate Tolerance',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: oie_POL_TOLERANCE');



debug('begin add_signature: oie_DIST_SET');
   l_info('##MASK##3'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2887',
      p_sig_id                 => 'oie_DIST_SET',
      p_sig_sql                => 'select a.distribution_set_id,a.distribution_id,b.distribution_set_name,
     ...
     where a.distribution_set_id = b.distribution_set_id
       and b.org_id in (##$$ORGS$$##)',
      p_title                  => 'Distribution Sets',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Distribution Sets',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: oie_DIST_SET');



debug('begin add_signature: OIE_GL_DAILY_RATES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8311',
      p_sig_id                 => 'OIE_GL_DAILY_RATES',
      p_sig_sql                => 'select gl.conversion_rate, gl.from_currency, gl.to_currency, gl.conversion_date, gl.conversion_type, aerh.default_exchange_rate
from ap_expense_report_headers_all aerh,gl_daily_rates gl,ap_system_parameters_all asp
where aerh.default_exchange_date=gl.conversion_date
and aerh.org_id=asp.org_id
and gl.from_currency=aerh.DEFAULT_CURRENCY_CODE
and gl.to_currency=asp.BASE_CURRENCY_CODE
and gl.conversion_type=aerh.DEFAULT_EXCHANGE_RATE_TYPE
and asp.org_id in (##$$ORGS$$##)',
      p_title                  => 'Exchange Rates in GL Daily Rates',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No exchange rates in GL Daily Rates for the organization entered.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: OIE_GL_DAILY_RATES');
...
debug('begin add_signature: oie_KEY_PROFILES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2840',
      p_sig_id                 => 'oie_KEY_PROFILES',
      p_sig_sql                => 'select
  user_profile_option_name "PROFILE",
  MAX(DECODE(lev, ''SITE'', value, NULL)) "SITE",
  MAX(DECODE(lev, ''APP'', value, NULL)) "APPLICATION",
  ...
  group by name,user_profile_option_name
  ORDER BY "PROFILE"',
      p_title                  => 'Mandatory Key Profile Options (at User/Resp entered)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No profile has been set.',
      p_solution               => 'The following profiles are being checked.<br>
Those are noted as key profiles for Internet Expenses.
...
<li>ICX:Session Timeout</li>
      ...
      p_success_msg            => 'Click on arrow above to see which profile(s) has been set at ''##$$USERNAME$$##'' User level and/or at ''##$$RESPNAME$$##'' Responsibility level.<br>
The following profiles are being checked:<ul>
<li>MO: Operating Unit</li>
<li>ICX: Date format mask</li>
<li>ICX: Language</li>
...
<li>ICX:Session Timeout</li>
   ...
   l_info.delete;
debug('end add_signature: oie_KEY_PROFILES');



debug('begin add_signature: OIE_OPT_PROFILES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2841',
      p_sig_id                 => 'OIE_OPT_PROFILES',
      p_sig_sql                => 'select
  user_profile_option_name "PROFILE",
  MAX(DECODE(lev, ''SITE'', value, NULL)) "SITE",
  MAX(DECODE(lev, ''APP'', value, NULL)) "APPLICATION",
  ...
  group by name,user_profile_option_name
  ORDER BY "PROFILE"',
      p_title                  => 'Optional Key Profile Options (at User/Resp entered)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No profile has been set.',
      p_solution               => 'The following profiles are being checked:<br>
<ul>
...
<li>MO: Security Profile</li>
      ...
      p_success_msg            => 'Expand signature to see which profile(s) has been set at <b>''##$$USERNAME$$##''</b> User level and/or at <b>''##$$RESPNAME$$##''</b> Responsibility level.<br>
The following profiles are being checked:<br>
<ul>
<li>AME:Installed</li>
<li>OIE:Allow Credit Lines</li>
...
<li>Sequential Numbering</li>
   ...
   l_info.delete;
debug('end add_signature: OIE_OPT_PROFILES');
...
(select ''$FND_TOP''||substr(af1.subdir,5)||''/''||af1.filename "Filename",
     afv1.version "Current Versions", ''120.8.12020000.5'' "Fixed Version",
...
union all
(select ''$FND_TOP''||substr(af1.subdir,5)||''/''||af1.filename "Filename",
     afv1.version "Current Versions", ''120.6.12020000.2'' "Fixed Version",
	   rank()over(partition by af1.filename
	     order by afv1.version_segment1 desc,
	     afv1.version_segment2 desc,afv1.version_segment3 desc,
	     afv1.version_segment4 desc,afv1.version_segment5 desc,
...
Please follow the steps in [2367572/KB229271] - 12.2 E-Business Suite Background Engine Workflows Are Not Processed And Get Corrupted With An Incorrect Date Stamp After Applying A Patch In Hotpatch Mode.<br><br>
...
debug('begin add_signature: oie_DUP_DETECTION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2859',
      p_sig_id                 => 'oie_DUP_DETECTION',
      p_sig_sql                => 'select b.rule_id,a.rule_set_id, b.rule_name,b.rule_type,b.description,
     ...
     where a.rule_id = b.rule_id
      ...
      p_title                  => 'Duplicate Detection Rules',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Duplicate Detection Rules',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: oie_DUP_DETECTION');
...
BEGIN
  ...
  analyzer_title := 'Internet Expenses Analyzer';
...
start_section('Proactive and Preventative Recommendations', 'Proactive_and_Preventative_Recommendations');
   IF (substr(g_rep_info('Apps Version'),1,6) = '12.1.3') THEN
      set_item_result(check_rec_patches_3); /* Signature OIE_REQUIRED_1213_PATCH */
   END IF;
   set_item_result(check_rec_patches_1); /* Signature oie_check_rec_patches */
   set_item_result(check_rec_patches_2); /* Signature OIE_MOBILE_PATCHES */
   set_item_result(run_stored_sig('oie_versions'));
   set_item_result(run_stored_sig('oie_PRODUCT'));
   set_item_result(run_stored_sig('oie_INVALIDS'));
   set_item_result(run_stored_sig('OIE_INVALID_AP_WEB_EXPENSE_WF'));
end_section;
debug('end section: Proactive_and_Preventative_Recommendations');

debug('begin section: Personalizations_Customizations');
start_section('Personalizations and Customizations');
   set_item_result(print_pers('/oracle/apps/ap/oie',TRUE));
end_section;
debug('end section: Personalizations_Customizations');

debug('begin section: Profile_Options');
start_section('Profile Options', 'Profile_Options');
   IF nvl(g_sql_tokens('##$$RESP$$##'),'no resp') <> 'no resp' OR nvl(g_sql_tokens('##$$USER$$##'),'no user') <> 'no user' THEN
      set_item_result(run_stored_sig('oie_KEY_PROFILES'));
      set_item_result(run_stored_sig('OIE_OPT_PROFILES'));
   END IF;
   set_item_result(run_stored_sig('OIE_KEY_PROFILES_ALL'));
   set_item_result(run_stored_sig('OIE_OPT_PROFILES_ALL'));
   set_item_result(run_stored_sig('EBS_ATG_GEN_FND_APPLWRK'));
end_section;
debug('end section: Profile_Options');

debug('begin section: Employee_Details');
IF p_per is not null THEN
   start_section('Employee/Supplier Details', 'Employee_Details');
      set_item_result(run_stored_sig('oie_HR_INFO'));
      set_item_result(run_stored_sig('AP_SUPPLIERS'));
      set_item_result(run_stored_sig('EBS_FIN_AP_APOIE_AP_SUPPLIER_SITES'));
      set_item_result(run_stored_sig('oie_SUP_INFO'));
      set_item_result(run_stored_sig('oie_USER_INFO'));
      set_item_result(run_stored_sig('oie_ACCOUNTING_INFO'));
      set_item_result(run_stored_sig('OIE_ILLEGALARGUMENTEXCEPTION'));
      set_item_result(run_stored_sig('OIE_ILLEGALARGUMENTEXCEPTION1'));
      set_item_result(run_stored_sig('OIE_NULLPOINTEREXCEPTION'));
      set_item_result(run_stored_sig('OIE_EMPLOYEE_SETUP'));
      set_item_result(run_stored_sig('OIE_SUPPLIER_SITE_INFO'));
      set_item_result(run_stored_sig('OIE_EMPLOYEE_ASSIGNEMNT_STATUS_NOT_ACTIVE'));
      set_item_result(run_stored_sig('EBS_FIN_AP_APOIE_OIE_AP_SSE_NOTIFY_EMPLOYEE'));
      set_item_result(run_stored_sig('EBS_FIN_AP_APOIE_OIE_SUP_VACS_RULES'));
      set_item_result(run_stored_sig('EBS_FIN_AP_APOIE_SUPPLIER_SSITE_INACTIVE'));
   end_section;
END IF;
debug('end section: Employee_Details');

debug('begin section: Corruptions_where_Generic_Data_Fixes___GDF___Exist');
IF p_expense_report_num is not null THEN
   start_section('Corruptions where Generic Data Fixes (GDF) Exist', 'Corruptions_where_Generic_Data_Fixes___GDF___Exist');
      set_item_result(run_stored_sig('oie_FND_LOOKUP_TYPES'));
      set_item_result(run_stored_sig('oie_FND_LOOKUP_TYPES_TL'));
      set_item_result(run_stored_sig('oie_FND_LOOKUP_VALUES'));
      set_item_result(run_stored_sig('oie_Note403933'));
      set_item_result(run_stored_sig('OIE_DUP_LINE_NUMBER'));
      set_item_result(run_stored_sig('OIE_EXPENSE_HEADER_LINE_MISMATCH'));
      set_item_result(run_stored_sig('OIE_EXPENSE_HEADER_LINE_MISMATCH_2'));
      set_item_result(run_stored_sig('OIE_EXPENSE_HEADER_LINE_MISMATCH_3'));
      set_item_result(run_stored_sig('OIE_EXPENSE_LINE_DIST_AMT_CNT_MISMATCH'));
      set_item_result(run_stored_sig('OIE_EXPENSE_LINE_DIST_MISMATCH'));
      set_item_result(run_stored_sig('OIE_INVALID_LINE_TYPE_LOOKUP'));
      set_item_result(run_stored_sig('OIE_LINE_AMOUNT_IS_NULL'));
      set_item_result(run_stored_sig('EBS_FIN_AP_APOIE_ERROR_RECEIPT_CURRENCY_SAME_AS_REIMBURSEMENT_CURRENCY'));
   end_section;
END IF;
debug('end section: Corruptions_where_Generic_Data_Fixes___GDF___Exist');

debug('begin section: Setup_Options_Details');
start_section('Setup Options Details', 'Setup_Options_Details');
   set_item_result(run_stored_sig('FINANCIAL_OPTIONS'));
   set_item_result(run_stored_sig('PAYABLES_OPTIONS'));
   set_item_result(run_stored_sig('oie_ACCOUNTING'));
   set_item_result(run_stored_sig('oie_VAT_SETUP'));
end_section;
debug('end section: Setup_Options_Details');

debug('begin section: Expense_Report_Template_Details');
start_section('Expense Report Template Details', 'Expense_Report_Template_Details');
   set_item_result(run_stored_sig('oie_EXPENSE_PARAMS'));
end_section;
debug('end section: Expense_Report_Template_Details');

debug('begin section: Expense_Report_Details');
IF p_expense_report_num is not null THEN
   start_section('Expense Report Details', 'Expense_Report_Details');
      set_item_result(run_stored_sig('OIE_EXPENSE_REPORT_HEADERS'));
      set_item_result(run_stored_sig('OIE_EXPENSE_REPORT_LINES'));
      set_item_result(run_stored_sig('OIE_EXPENSE_REPORT_DISTS'));
      set_item_result(run_stored_sig('OIE_CREDIT_CARD_TRXNS'));
      set_item_result(run_stored_sig('EBS_FIN_AP_APOIE_EXPENSE_REPORT_APPLIED_AS_ADAVANCE'));
      set_item_result(run_stored_sig('oie_EXPENSE_REPORTS_TEMPLATES'));
      set_item_result(run_stored_sig('OIE_EXP_TYPE_INFO'));
      set_item_result(run_stored_sig('EBS_AP_APOIE_TEMPLATE_ITEMS'));
   end_section;
END IF;
debug('end section: Expense_Report_Details');

debug('begin section: Tax_Details');
start_section('Tax Details', 'Tax_Details');
   set_item_result(run_stored_sig('oie_TAX'));
end_section;
debug('end section: Tax_Details');

debug('begin section: Credit_Card_Details');
start_section('Credit Card Details', 'Credit_Card_Details');
   set_item_result(run_stored_sig('oie_CARD_PROGRAMS'));
   set_item_result(run_stored_sig('oie_CARD_SUP'));
   set_item_result(run_stored_sig('EBS_FIN_AP_APOIE_DUPLICATE_CREDIT_CARD_ENTRIES_POST_UPGRADE'));
   set_item_result(run_stored_sig('EBS_FIN_AP_APOIE_OIE_DUPLICATE_CREDIT_CARD'));
end_section;
debug('end section: Credit_Card_Details');

debug('begin section: Workflow_Processes_Activites_Notifications_Details');
start_section('Workflow Processes/Activites/Notifications Details', 'Workflow_Processes_Activites_Notifications_Details');
   set_item_result(run_stored_sig('oie_WORKFLOW_SETUP'));
   set_item_result(run_stored_sig('oie_AME_SETUP'));
   set_item_result(run_stored_sig('OIE_APPROVER_ERROR'));
   IF (substr(g_rep_info('Apps Version'),1,4) = '12.2') THEN
      set_item_result(run_stored_sig('CHECK_WF_PATCH_27911576_FC'));
   END IF;
end_section;
debug('end section: Workflow_Processes_Activites_Notifications_Details');

debug('begin section: Auditor_Setup_and_Audit_Rules_Details');
start_section('Auditor Setup and Audit Rules Details', 'Auditor_Setup_and_Audit_Rules_Details');
   set_item_result(run_stored_sig('oie_AUDITORS'));
   set_item_result(run_stored_sig('oie_RULE_SETUP'));
   set_item_result(run_stored_sig('oie_RULE_ASSIGN'));
   set_item_result(run_stored_sig('oie_LIST_SETUP'));
   set_item_result(run_stored_sig('oie_LIST_ASSIGN'));
   set_item_result(run_stored_sig('oie_RECEIPT_SETUP'));
   set_item_result(run_stored_sig('oie_RECEIPT_ASSIGN'));
   set_item_result(run_stored_sig('oie_NOTIFY_SETUP'));
   set_item_result(run_stored_sig('oie_NOTIFY_ASSIGN'));
   set_item_result(run_stored_sig('oie_HOLD_SETUP'));
   set_item_result(run_stored_sig('oie_HOLD_ASSIGN'));
end_section;
debug('end section: Auditor_Setup_and_Audit_Rules_Details');

debug('begin section: Policy_Compliance_Setup_Details');
start_section('Policy Compliance Setup Details', 'Policy_Compliance_Setup_Details');
   set_item_result(run_stored_sig('oie_POL_CONTEXT'));
   set_item_result(run_stored_sig('oie_POL_TOLERANCE'));
end_section;
debug('end section: Policy_Compliance_Setup_Details');

debug('begin section: Additional_Setup_Details');
start_section('Additional Setup Details', 'Additional_Setup_Details');
   IF substr(g_rep_info('Apps Version'),1,6) = '12.1.3' THEN
      set_item_result(run_stored_sig('oie_DUP_DETECTION'));
   END IF;
   set_item_result(run_stored_sig('oie_DIST_SET'));
   set_item_result(run_stored_sig('OIE_GL_DAILY_RATES'));
end_section;
debug('end section: Additional_Setup_Details');
