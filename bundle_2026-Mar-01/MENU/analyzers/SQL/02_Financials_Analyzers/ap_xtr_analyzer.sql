...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Treasury Analyzer                      |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE ap_xtr_analyzer_pkg AUTHID DEFINER AS
...
(            p_user_name                    IN VARCHAR2    DEFAULT NULL
           ,p_deal_type                    IN VARCHAR2    DEFAULT NULL
...
END ap_xtr_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY ap_xtr_analyzer_pkg AS
-- $Id: ap_xtr_analyzer.sql, 200.18 2026/02/25 12:33:36 sdenye Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2430571.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'APXTR_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'APXTR_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>APXTR Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2430571.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/ap_xtr_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1754,EBS,EBS Financials,EBS - Payables" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1754,EBS,EBS Financials,EBS - Payables" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1754,EBS,EBS Financials,EBS - Payables" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4200166" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">1754</span>
...
<p><span style="font-size:small;"><strong>Version 200.18 </strong>25-Feb-2026</span></p><ul><li><span style="font-size:small;">Update to index signature</span></li>
</ul>
<p><span style="font-size:small;"><strong>Version 200.17 </strong>27-Jan-2026</span></p><ul><li><span style="font-size:small;">Updates to signatures to include links to knowledge article IDs</span></li>
</ul>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1754,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Payables" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1754,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Payables" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1754,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Payables" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
FUNCTION check_rec_patches_1 RETURN VARCHAR2 IS
  /* Signature XTR_REQUIRED_121_PATCH */
...
BEGIN
    ...
    print_log('Processing recommended patches signature: XTR_REQUIRED_121_PATCH (check_rec_patches_1) "Recommended Patches" (version 5)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_col_rows(1)(l_rows) := '20238208';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.1: Treasury Recommended Patch Collection (RPC), February, 2015';
...
END IF;
   ...
   l_sig.sigrepo_id := '11035';
   l_sig.title := 'Recommended Patches';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := 'Recommended R12.1 patch has not been applied.';
   l_sig.solution := 'It is recommended that you apply the RPC Patch {20238208}.  This patch may not fix your exact issue, but it is a required patch for all R12.1 Treasury installs.  This is also a <b>mandatory</b> prerequisite for the Treasury development team to be involved in the analysis of Treasury issues.

Review [954704/PALRT2285] for more details of latest Treasury (XTR) RPC.
...
Having a proactive patching plan and periodic proactive patching process in place are the best ways to stay current.';
   l_sig.success_msg := 'Recommended {20238208} has been applied.';
  ...
  -- Register
  l_step := '60';
  g_signatures('XTR_REQUIRED_121_PATCH') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'XTR_REQUIRED_121_PATCH',     -- sig ID
...
debug('begin populate parameters hash table');
   ...
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Deal Type';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_deal_type,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Deal Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_deal_number,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Transaction Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_trx_number,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/02/25 12:33:35 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'ap_xtr_analyzer.sql';
...
SELECT FU.USER_NAME
INTO l_exists_val
FROM FND_USER FU , XTR_DEALER_CODES XDC
WHERE FU.USER_NAME = p_user_name
 AND fu.user_id = xdc.user_id
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: The user name passed is either not a valid Application login user or the user is not setup as a Dealer. Please verify and setup.');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
debug('begin parameter validation: p_deal_type');
IF p_deal_type IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Deal Type is required.');
   raise invalid_parameters;
END IF;
IF p_deal_type IS NOT NULL AND p_deal_type NOT IN ( 'EXP','IAC','N/A','OTHER') THEN
   print_error('INVALID ARGUMENT: The valid values for Deal_Type are:
EXP (Exposure)
IAC (Inter-account)
OTHER (All others) 
N/A (Not applicable, null) 

Please provide a correct Deal_Type.');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_deal_type');
...
-- I. Deal_Type validation 
-- Check if the values for Deal_Type passed are in the 5 pre-defined ones:

/*IF p_deal_type NOT IN ('IG','EXP','IAC','OTHER','N/A') THEN
    print_error('The valid values for Deal_Type are - IG,EXP,IAC,OTHER,N/A.... Please pass the correct Deal_Type.');
    print_log('The valid values for Deal_Type are - IG,EXP,IAC,OTHER,N/A.... Please pass the correct Deal_Type.');
    raise invalid_parameters;
END IF;*/

IF p_deal_type IN ('IAC','EXP') AND 
   (p_deal_number <> 0) THEN 
    print_error('When the Deal Type is either IAC or EXP, Deal number should be 0');
    print_log('When the Deal Type is either IAC or EXP, Deal number should be 0');
    raise invalid_parameters;
END IF;

IF p_deal_type IN ('IAC','EXP') AND 
   (p_trx_number = 0 OR p_trx_number IS NULL) THEN 
    print_error('When the Deal Type is either IAC or EXP, Transaction number cannot be null');
    print_log('When the Deal Type is either IAC or EXP, Transaction number cannot be null');
    raise invalid_parameters;
END IF;

IF p_deal_type = 'OTHER' AND 
   (p_deal_number = 0 OR p_deal_number IS NULL) THEN 
    print_error('Deal number is mandatory for this Deal Type');
    print_log('Deal number is mandatory for this Deal Type');
    raise invalid_parameters;
END IF;

-- II. Deal_Type and Deal_Number combination validation
-- Check if the combination for Deal_Type and Deal_number are valid

   BEGIN 

	IF  p_deal_type = 'OTHER' AND p_deal_number IS NOT NULL
	THEN

	     SELECT distinct deal_type, deal_number
	     INTO l_deal_type, l_deal_number
	     FROM xtr_deal_date_amounts
	     WHERE deal_type NOT IN ('EXP','IAC')
	     AND deal_number = p_deal_number;

	END IF;

	IF p_deal_type IN ('EXP','IAC') AND p_deal_number IS NOT NULL
	THEN
    ...
    EXCEPTION
        WHEN NO_DATA_FOUND THEN
	  print_error('Error: '||sqlerrm||' Deal number ('||
            to_char(p_deal_number)||') does not exist for the Deal Type.'||
            'Please provide a valid Deal number.');
          print_log('Error: '||sqlerrm||' Deal number ('||
            to_char(p_deal_number)||') does not exist for the Deal Type. '||
            'Please provide a valid Deal number.');
          raise invalid_parameters;
        WHEN OTHERS THEN
          print_error('Error: '||sqlerrm||' validating Deal Type, Deal number combination: '|| to_char(p_trx_number));
          print_log('Error: '||sqlerrm||' validating Deal Type, Deal number combination:: '|| to_char(p_trx_number));
          raise invalid_parameters;
    END;


-- III. Deal_Type, Deal_Number and Transaction_number combination validation
-- Check if the combination for Deal_Type , Deal_number and Transaction_number are valid

IF  p_deal_type IN ('EXP','IAC') THEN

    BEGIN 

         IF p_deal_number = 0 THEN

	    SELECT distinct deal_type, deal_number, transaction_number 
	    INTO l_deal_type, l_deal_number, l_transaction_number 
	    FROM xtr_deal_date_amounts
	    WHERE deal_type IN ('EXP','IAC')
	    AND deal_number = p_deal_number
	    AND transaction_number = p_trx_number;

         END IF;

    EXCEPTION
        WHEN NO_DATA_FOUND THEN
	  print_error('Error: '||sqlerrm||' Trx number ('||
            to_char(p_trx_number)||') does not exist for the Deal Type, Deal number combination. '||
            'Please provide a valid Trx number parameter value.');
          print_log('Error: '||sqlerrm||' Trx number ('||
            to_char(p_trx_number)||') does not exist for the Deal Type, Deal number combination. '||
            'Please provide a valid Trx number parameter value.');
          raise invalid_parameters;
        WHEN OTHERS THEN
          print_error('Error: '||sqlerrm||' validating Trx number: '|| to_char(p_trx_number));
          print_log('Error: '||sqlerrm||' validating Trx number: '|| to_char(p_trx_number));
          raise invalid_parameters;
    END;
...
IF  p_deal_type = 'IG' THEN
    ...
    BEGIN 
	    ...
	    SELECT deal_type, deal_number, transaction_number 
	    INTO l_deal_type, l_deal_number, l_transaction_number 
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$DEALTYPE$$##') := p_deal_type;
   g_masked_tokens('##$$DEALTYPE$$##') := mask_text( g_sql_tokens('##$$DEALTYPE$$##'), 'NO_MASK');
   g_sql_tokens('##$$DEALNUM$$##') := p_deal_number;
   g_masked_tokens('##$$DEALNUM$$##') := mask_text( g_sql_tokens('##$$DEALNUM$$##'), 'NO_MASK');
   g_sql_tokens('##$$TRXNUM$$##') := p_trx_number;
   g_masked_tokens('##$$TRXNUM$$##') := mask_text( g_sql_tokens('##$$TRXNUM$$##'), 'NO_MASK');
   g_sql_tokens('##$$USERNAME$$##') := p_user_name;
   g_masked_tokens('##$$USERNAME$$##') := mask_text( g_sql_tokens('##$$USERNAME$$##'), 'DISPLAY_BOTH_25_PCNT_WORD');
   g_sql_tokens('##$$APPS_PARAM1$$##') := '185';
   g_masked_tokens('##$$APPS_PARAM1$$##') := mask_text( g_sql_tokens('##$$APPS_PARAM1$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM2$$##') := '260';
...
debug('begin add_signature: SYSTEM PARAMETERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9994',
      p_sig_id                 => 'SYSTEM PARAMETERS',
      p_sig_sql                => 'SELECT AUDIT_INDICATOR ,
  DESCRIPTION ,
  PARAM_NAME ,
  PARAM_TYPE ,
  PARAM_VALUE ,
  ...
  CREATED_ON 
FROM XTR_PRO_PARAM',
      p_title                  => 'Treasury System Parameters',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'System Parameters setup does not exist. 
System parameters define various settings for the operation and control of the Treasury system.',
      p_solution               => 'Set up System Parameters using the navigation steps below:
Treasury : Setup : System : System Parameters
See the Oracle Treasury Users Guide (Release 12.2, Part No. E48862-03, August 2017), starting on page 2-22 (PDF page #55) for more information.',
      p_success_msg            => 'System parameters setup has been defined.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: SYSTEM PARAMETERS');



debug('begin add_signature: DEALER_SETUP');
   l_info('##MASK##2'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##4'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11232',
      p_sig_id                 => 'DEALER_SETUP',
      p_sig_sql                => 'SELECT DEALER_CODE,
  DEALER_USER_NAME,
  USER_ID,
  APPLICATION_USER,
  UPDATED_BY,
...
WHERE USER_ID IN
    (SELECT USER_ID FROM FND_USER WHERE USER_NAME = (''##$$USERNAME$$##''))',
      p_title                  => 'Treasury Dealer',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'User is not set up as a Dealer in Treasury. ',
      p_solution               => 'You will need to setup the treasury user and control access levels.  Please review "Adding Users and Defining User Access Levels" section in [2448253/KB729735] for more information.
',
      p_success_msg            => 'User is set up as a Dealer in Treasury.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: DEALER_SETUP');



debug('begin add_signature: DEALER_COMPANY_ACCESS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11233',
      p_sig_id                 => 'DEALER_COMPANY_ACCESS',
      p_sig_sql                => 'SELECT DEALER_CODE,
  PARTY_CODE,
  COMPANY_AUTHORISED_FOR_INPUT
FROM XTR_COMPANY_AUTHORITIES_V
WHERE DEALER_CODE =
  (SELECT DEALER_CODE
  FROM XTR_DEALER_CODES_V
  WHERE USER_ID IN
    (SELECT USER_ID FROM FND_USER WHERE USER_NAME = (''##$$USERNAME$$##'')))',
      p_title                  => 'Dealer Company Access',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Dealer does not have access to company. ',
      p_solution               => 'You will need to grant the treasury user access to the company. Please review "2. Grant Company Access" section in [2448253/KB729735] for more information.',
      p_success_msg            => 'Dealer has access to company. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: DEALER_COMPANY_ACCESS');



debug('begin add_signature: DEALER_DEAL_ACCESS');
   l_info('##MASK##1'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9995',
      p_sig_id                 => 'DEALER_DEAL_ACCESS',
      p_sig_sql                => 'SELECT USER_NAME
,      DEAL_TYPE
,      DEAL_SUBTYPE
,      PRODUCT_TYPE
,      AUTHORISED
...
where user_name = (select dealer_code from XTR_DEALER_CODES
WHERE user_id IN
  (select USER_ID from FND_USER 
  WHERE user_name =  (''##$$USERNAME$$##'')))',
      p_title                  => 'Dealer Deal Accesss',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Dealer does not have access to deals. ',
      p_solution               => 'You will need to grant the treasury user deal access. Please review "2. Grant Deal Access" section in [2448253/KB729735] 
for more information.
',
      p_success_msg            => 'Dealer has access to deals.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: DEALER_DEAL_ACCESS');



debug('begin add_signature: DEALER_ACCESS_TO_OVERRIDE_INT');
   l_info('##MASK##2'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##4'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11234',
      p_sig_id                 => 'DEALER_ACCESS_TO_OVERRIDE_INT',
      p_sig_sql                => 'SELECT DEALER_CODE,
  DEALER_USER_NAME,
  USER_ID,
  APPLICATION_USER,
...
WHERE USER_ID = 
  (SELECT USER_ID FROM FND_USER WHERE USER_NAME = (''##$$USERNAME$$##''))
    AND ALLOW_OVERRIDE = ''Y''',
      p_title                  => 'Dealer Access to Override Interest',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Dealer cannot override interest. ',
      p_solution               => 'You will need to grant the treasury user access to override interest. Please review "Adding Users and Defining User Access Levels" section in [2448253/KB729735] for more information.
',
      p_success_msg            => 'Dealers has access to override interest.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: DEALER_ACCESS_TO_OVERRIDE_INT');



debug('begin add_signature: AUTH_REVAL_BATCHES_NO_DETAILS');
   l_info('##MASK##9'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11237',
      p_sig_id                 => 'AUTH_REVAL_BATCHES_NO_DETAILS',
      p_sig_sql                => 'SELECT XB.BATCH_ID ,
  XB.COMPANY_CODE ,
  XB.PERIOD_START ,
  XB.PERIOD_END ,
  XB.GL_GROUP_ID ,
...
FROM XTR_BATCHES XB,
  XTR_BATCH_EVENTS XE
WHERE XB.BATCH_ID    = XE.BATCH_ID
AND XE.EVENT_CODE    = ''REVAL''
AND XE.AUTHORIZED    = ''Y''
AND XB.BATCH_ID NOT IN
  (SELECT BATCH_ID FROM XTR_REVALUATION_DETAILS
  )',
      p_title                  => 'Authorized Revaluation Batches Without Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Data issues detected. Authorized revaluation batches found with no revaluations details. <br>
This data state can potentially cause ''Program - Calculate Revaluations'' to fail with error like below: <br>
Sample error: <br>
procedure xtr_revl_onc_curr_gl Error: Internal error. <br>
And certain deals in revaluation process might be marked as ''Incomplete''. <br>
<br>
Note: This check is made independent of parameters entered. Hence this may or may not be related to the deal/transaction in question.',
      p_solution               => 'Review and determine if the the revaluation details were deleted for an authorized batch. You may need to log a Service Request for assistance. ',
      p_success_msg            => 'No Authorized Revaluation Batches found without details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AUTH_REVAL_BATCHES_NO_DETAILS');



debug('begin add_signature: AUTH_ACCRUAL_BATCHES_NO_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11238',
      p_sig_id                 => 'AUTH_ACCRUAL_BATCHES_NO_DETAILS',
      p_sig_sql                => 'SELECT XB.BATCH_ID ,
  XB.COMPANY_CODE ,
  XB.PERIOD_START ,
  XB.PERIOD_END ,
...
FROM XTR_BATCHES XB,
  XTR_BATCH_EVENTS XE
WHERE XB.BATCH_ID = XE.BATCH_ID
AND XE.EVENT_CODE = ''ACCRUAL''
AND XE.AUTHORIZED = ''Y''
AND XB.BATCH_ID  NOT IN
  (SELECT BATCH_ID FROM XTR_ACCRLS_AMORT)',
      p_title                  => 'Authorized Accrual Batches Without Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Warning:  There are authorized accrual batches found with no accrual details.   This data can potentially cause the <i> Program - Revaluation/Accrual Related Journal Processing </i> to fail 
generating required accrual journals due to missing data. 

<br>For example:</br>
Deal Number: XXXX <br>
Transaction Number: XX <br>
If the above deal transaction does not have accrual details, then the journals for the same will not be generated.  This can impact financial reporting.<br>

NOTE: This check is made independent of parameters entered. Hence this may or may not be related to the deal/transaction in question, but should be evaluated.',
      p_solution               => 'Verify how the accruals were deleted for an authorized batch. If not deleted, then verify how the batch was authorized without its details present, as both these actions are not permitted using standard applications UI.

If the issue is reproducible at will using standard applications UI, then log Service Request with Oracle Treasury product support for fix.

Issue is not reproducible at will but if still this data should be reviewed by Oracle support, then a Service Request can be logged to get Oracle Support findings / comments. However set the expectations that the issues not caused by using standard applications UI are out of scope for Oracle Support Datafix Policy.',
      p_success_msg            => 'No Authorized Accrual Batches found without details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AUTH_ACCRUAL_BATCHES_NO_DETAILS');



debug('begin add_signature: COMPANY PARAMETERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10003',
      p_sig_id                 => 'COMPANY PARAMETERS',
      p_sig_sql                => 'SELECT COMPANY_PARAMETER_ID ,
  COMPANY_CODE ,
  PARAMETER_CODE ,
  ...
  LAST_UPDATE_DATE ,
  LAST_UPDATE_LOGIN
from XTR_COMPANY_PARAMETERS where COMPANY_CODE in (select COMPANY_CODE from XTR_DEAL_DATE_AMOUNTS
where deal_number = (''##$$DEALNUM$$##''))',
      p_title                  => 'Company Parameters',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Company Parameter setups do not exist. ',
      p_solution               => 'Set up System Parameters using the navigation steps below:
Treasury : Setup : Parties : Company Profiles',
      p_success_msg            => 'Company parameter setup has been defined.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: COMPANY PARAMETERS');



debug('begin add_signature: COMPANY_INFO');
   l_info('##MASK##ACCOUNT_MANAGER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FULL_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10748',
      p_sig_id                 => 'COMPANY_INFO',
      p_sig_sql                => 'SELECT ACCOUNT_MANAGER
,      ACCOUNT_STATUS
,      AUTHORISED
,      CONFO_ACTION_CODE
,      COUNTRY_CODE
...
FROM XTR_PARTY_INFO
where PARTY_CODE in (select COMPANY_CODE from XTR_DEAL_DATE_AMOUNTS
where deal_number = (''##$$DEALNUM$$##''))
and PARTY_TYPE = ''C''',
      p_title                  => 'Company Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Company Profile setups do not exist.  ',
      p_solution               => 'Set up Company Profile information using the navigation steps below:
Treasury : Setup : Parties : Company Profiles',
      p_success_msg            => 'Company Profile setups have been defined.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: COMPANY_INFO');



debug('begin add_signature: COUNTERPARTY INFO');
   l_info('##MASK##ACCOUNT_MANAGER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FULL_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SHORT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9996',
      p_sig_id                 => 'COUNTERPARTY INFO',
      p_sig_sql                => 'SELECT ACCOUNT_MANAGER
,      ACCOUNT_STATUS
,      AUTHORISED
,      CONFO_ACTION_CODE
...
,      CE_BANK_BRANCH_ID
FROM XTR_PARTY_INFO
where PARTY_CODE in (select CPARTY_CODE from XTR_DEAL_DATE_AMOUNTS
where DEAL_NUMBER = (''##$$DEALNUM$$##''))',
      p_title                  => 'Counterparty Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'CounterParty Information setups do not exist.  ',
      p_solution               => 'Set up CounterParty information using the navigation steps below:
Treasury : Setup : Parties : CounterParty Profiles',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: COUNTERPARTY INFO');



debug('begin add_signature: DEALS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10005',
      p_sig_id                 => 'DEALS',
  ...
  CLIENT_ACCT_USE_ID
from XTR_DEALS
WHERE deal_no = (''##$$DEALNUM$$##'')',
      p_title                  => 'Deal Header',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No header information was found for the specified deal number.',
      p_solution               => 'If this is not for deal type Intercompany (IG), then log Service Request with Oracle Support with analyzer output.',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: DEALS');



debug('begin add_signature: INTERCO_FUNDING_LOANS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11034',
      p_sig_id                 => 'INTERCO_FUNDING_LOANS',
      p_sig_sql                => 'SELECT ACCT_REF
,      ACCUM_INTEREST_BF
...
from XTR_INTERGROUP_TRANSFERS
where DEAL_NUMBER = (''##$$DEALNUM$$##'')',
      p_title                  => 'Intercompany Funding/Loans',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No loan data found for inter-group transfers related to the deal number specified in the Parameters.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: INTERCO_FUNDING_LOANS');



debug('begin add_signature: DDA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10006',
      p_sig_id                 => 'DDA',
      p_sig_sql                => 'SELECT ACCOUNT_NO
,      ACTION_CODE
...
FROM XTR_DEAL_DATE_AMOUNTS
WHERE deal_number = (''##$$DEALNUM$$##'')',
      p_title                  => 'Deal Date Amounts',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Deal Date Amount data does not exist.  ',
      p_solution               => 'Enter at least one transaction for the specified deal in order to update the database with related Deal Date Amount(s).',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: DDA');



debug('begin add_signature: XTR_MIRROR_DDA_LIMIT_ROW');
   l_info('##MASK##1'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10007',
      p_sig_id                 => 'XTR_MIRROR_DDA_LIMIT_ROW',
      p_sig_sql                => 'SELECT ACCOUNT_NO
,      AMOUNT
,      AMOUNT_DATE
,      AMOUNT_INDIC
...
WHERE deal_number = (''##$$DEALNUM$$##'')',
      p_title                  => 'Deal Mirror Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No deal mirror data found for the deal number specified in the Parameters.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: XTR_MIRROR_DDA_LIMIT_ROW');



debug('begin add_signature: ROLLOVER_TRANSACTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10750',
      p_sig_id                 => 'ROLLOVER_TRANSACTIONS',
      p_sig_sql                => 'SELECT ACCUM_INTEREST ,
  ACCUM_INTEREST_BF ,
  ACCUM_INTEREST_BF_HCE ,
  ACCUM_INTEREST_HCE ,
...
WHERE DEAL_NUMBER = (''##$$DEALNUM$$##'')',
      p_title                  => 'Rollover Transactions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No rollover transaction data found for the deal number specified in the Parameters.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: ROLLOVER_TRANSACTIONS');



debug('begin add_signature: SETTLEMENT_RECON_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10755',
      p_sig_id                 => 'SETTLEMENT_RECON_STATUS',
      p_sig_sql                => 'SELECT DECODE(b.STATUS,''R'',''Yes'',''No'') RECONCILIATION_STATUS,
  b.SETTLEMENT_SUMMARY_ID REFERENCE_ID,
  b.SETTLEMENT_NUMBER,
  a.DEAL_NUMBER,
  a.TRANSACTION_NUMBER,
  a.AMOUNT_TYPE
FROM XTR_DEAL_DATE_AMOUNTS a,
  XTR_SETTLEMENT_SUMMARY b
WHERE a.DEAL_NUMBER = (''##$$DEALNUM$$##'')
and a.SETTLEMENT_NUMBER = b.SETTLEMENT_NUMBER
AND a.SETTLE        = ''Y''',
      p_title                  => 'Settlement Reconciliation Status',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No settlement reconciliation status data found for the deal number specified in the Parameters.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: SETTLEMENT_RECON_STATUS');



debug('begin add_signature: SETTLEMENT_SUMMARY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10756',
      p_sig_id                 => 'SETTLEMENT_SUMMARY',
      p_sig_sql                => 'SELECT SETTLEMENT_SUMMARY_ID
,      SETTLEMENT_NUMBER
,      COMPANY
,      CURRENCY
,      SETTLEMENT_AMOUNT
...
WHERE settlement_number IN
  ...
  from XTR_DEAL_DATE_AMOUNTS
  WHERE deal_number = (''##$$DEALNUM$$##'') )',
      p_title                  => 'Settlement Summary',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No settlement summary data found for the deal number specified in the Parameters.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: SETTLEMENT_SUMMARY');



debug('begin add_signature: CE_BANK_ACCOUNT');
   l_info('##MASK##2'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '10751',
      p_sig_id                 => 'CE_BANK_ACCOUNT',
      p_sig_sql                => 'SELECT CBA.BANK_ACCOUNT_ID,
  CBA.BANK_ACCOUNT_NUM_ELECTRONIC,
  CBA.XTR_BANK_ACCOUNT_REFERENCE,
  ...
  CBA.BANK_ID,
  CBA.CURRENCY_CODE,
  CBA.XTR_AMOUNT_TOLERANCE,
  CBA.XTR_PERCENT_TOLERANCE,
...
FROM CE_BANK_ACCOUNTS CBA,
  ...
  XTR_DEAL_DATE_AMOUNTS XDD
WHERE CBA.BANK_ACCOUNT_ID = XBA.CE_BANK_ACCOUNT_ID
AND XDD.ACCOUNT_NO        = XBA.ACCOUNT_NUMBER
AND XDD.DEAL_NUMBER       = (''##$$DEALNUM$$##'')',
      p_title                  => 'Cash Management Bank Account',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found for the internal bank account owned by Cash Management related to the specified deal.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: CE_BANK_ACCOUNT');



debug('begin add_signature: XTR_BANK_ACCT');
   l_info('##MASK##1'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##4'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##5'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10757',
      p_sig_id                 => 'XTR_BANK_ACCT',
      p_sig_sql                => 'SELECT XBA.ACCOUNT_NUMBER
,      XBA.AUTHORISED
,      XBA.BANK_CODE
,      XBA.BANK_NAME
,      XBA.BANK_SHORT_CODE
,      XBA.CASHFLOWS_TO_CURRENT_DATE
,      XBA.CREATED_BY
,      XBA.CREATED_ON
,      XBA.CURRENCY
,      XBA.CURRENT_CASHFLOW_DATE
,      XBA.DEFAULT_ACCT
,      XBA.DIRECT_DEBIT_AUTHORITY
,      XBA.EFT_SCRIPT_NAME
,      XBA.EFT_SCRIPT_OUTPUT_PATH
,      XBA.CODE_COMBINATION_ID
,      XBA.GL_COMPANY_CODE
,      XBA.INTEREST_CALCULATION_BASIS
,      XBA.INTEREST_RATE
,      XBA.INTERNAL_PTY
,      XBA.LIMIT_CODE
,      XBA.OPENING_BALANCE
...
,      XBA.PARTY_TYPE
,      XBA.PORTFOLIO_CODE
,      XBA.PRIMARY_SETTLEMENT_METHOD
,      XBA.PROJECTED_BALANCE
,      XBA.PROJECTED_BALANCE_DATE
,      XBA.PROJECTED_BALANCE_UPDATED_ON
,      XBA.SETOFF
,      XBA.SETOFF_ACCOUNT_YN
,      XBA.SETOFF_COMPANY
,      XBA.STATEMENT_DATE
,      XBA.SUB_ACCOUNT_AT
,      XBA.SUB_ACCOUNT_NUMBER
,      XBA.UPDATED_BY
,      XBA.UPDATED_ON
,      XBA.DOMICILED_CURRENCY
,      XBA.YEAR_CALC_TYPE
,      XBA.SWIFT_ID
,      XBA.AP_BANK_ACCOUNT_ID
,      XBA.ROUNDING_TYPE
,      XBA.DAY_COUNT_TYPE
,      XBA.PRICING_MODEL
,      XBA.LEGAL_ACCOUNT_NAME
,      XBA.TARGET_BALANCE
,      XBA.CASHFLOW_DISPLAY_ORDER
,      XBA.BANK_BRANCH_ID
,      XBA.BANK_ACCT_USE_ID
,      XBA.MAX_TARGET_BALANCE
,      XBA.CASHPOOL_MIN_PAYMENT_AMT
,      XBA.CASHPOOL_MIN_RECEIPT_AMT
,      XBA.CASHPOOL_ROUND_FACTOR
,      XBA.CASHPOOL_ROUND_RULE
,      XBA.CASHPOOL_ID
,      XBA.CE_BANK_ACCOUNT_ID
FROM XTR_BANK_ACCOUNTS XBA,
     XTR_DEAL_DATE_AMOUNTS XDD
WHERE XDD.ACCOUNT_NO       = XBA.ACCOUNT_NUMBER
AND   XDD.DEAL_NUMBER      = (''##$$DEALNUM$$##'')',
      p_title                  => 'Treasury Bank Account',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found for the Treasury bank account related to the deal number specified in the Parameters.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: XTR_BANK_ACCT');



debug('begin add_signature: CE_XTR_GL_ACCTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10759',
      p_sig_id                 => 'CE_XTR_GL_ACCTS',
      p_sig_sql                => 'SELECT CCID.BANK_ACCT_USE_ID ,
  CCID.XTR_ASSET_CCID ,
  CCID.ASSET_CODE_COMBINATION_ID ,
  CCID.LAST_UPDATE_DATE ,
  CCID.LAST_UPDATED_BY ,
  CCID.CREATION_DATE ,
  CCID.CREATED_BY ,
  CCID.LAST_UPDATE_LOGIN ,
  CCID.BANK_INTEREST_EXPENSE_CCID ,
  CCID.BANK_INTEREST_INCOME_CCID
FROM CE_GL_ACCOUNTS_CCID CCID,
...
AND USES.BANK_ACCT_USE_ID    = CCID.BANK_ACCT_USE_ID
AND XDD.ACCOUNT_NO           = XBA.ACCOUNT_NUMBER
AND USES.XTR_USE_ENABLE_FLAG = ''Y''
AND XDD.DEAL_NUMBER          = (''##$$DEALNUM$$##'')',
      p_title                  => 'Cash Management/Treasury GL Accounts',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No GL Account data found for the CE and XTR bank accounts related to the deal number specified in the Parameters.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: CE_XTR_GL_ACCTS');



debug('begin add_signature: XTR_BANK_ACCT_USES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10753',
      p_sig_id                 => 'XTR_BANK_ACCT_USES',
      p_sig_sql                => 'SELECT USES.BANK_ACCT_USE_ID
,      USES.BANK_ACCOUNT_ID
,      USES.LAST_UPDATE_DATE
,      USES.LAST_UPDATED_BY
,      USES.CREATION_DATE
,      USES.CREATED_BY
,      USES.LAST_UPDATE_LOGIN
,      USES.PRIMARY_FLAG
,      USES.ORG_ID
,      USES.ORG_PARTY_ID
,      USES.AP_USE_ENABLE_FLAG
,      USES.AR_USE_ENABLE_FLAG
,      USES.XTR_USE_ENABLE_FLAG
,      USES.PAY_USE_ENABLE_FLAG
,      USES.POOLED_FLAG
,      USES.END_DATE
,      USES.LEGAL_ENTITY_ID
,      USES.INVESTMENT_LIMIT_CODE
,      USES.FUNDING_LIMIT_CODE
,      USES.AP_DEFAULT_SETTLEMENT_FLAG
,      USES.XTR_DEFAULT_SETTLEMENT_FLAG
,      USES.PAYROLL_BANK_ACCOUNT_ID
,      USES.PRICING_MODEL
,      USES.AUTHORIZED_FLAG
,      USES.EFT_SCRIPT_NAME
,      USES.PORTFOLIO_CODE
,      USES.DEFAULT_ACCOUNT_FLAG
,      USES.OBJECT_VERSION_NUMBER
FROM CE_BANK_ACCOUNTS CBA,
  XTR_BANK_ACCOUNTS XBA,
  XTR_DEAL_DATE_AMOUNTS XDD,
  CE_BANK_ACCT_USES_ALL USES
...
and USES.XTR_USE_ENABLE_FLAG = ''Y''
and XDD.DEAL_NUMBER          = (''##$$DEALNUM$$##'')',
      p_title                  => 'Treasury Bank Account Uses',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No bank account use data found for the CE and XTR bank accounts related to the deal number specified in the Parameters.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: XTR_BANK_ACCT_USES');



debug('begin add_signature: CE_BANK_ACCT_BALANCES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10752',
      p_sig_id                 => 'CE_BANK_ACCT_BALANCES',
      p_sig_sql                => 'SELECT BAL.BANK_ACCT_BALANCE_ID ,
  BAL.BANK_ACCOUNT_ID ,
  BAL.BALANCE_DATE ,
  BAL.LEDGER_BALANCE ,
  BAL.AVAILABLE_BALANCE ,
  BAL.VALUE_DATED_BALANCE ,
  BAL.ONE_DAY_FLOAT ,
  BAL.TWO_DAY_FLOAT ,
  BAL.AVERAGE_CLOSE_LEDGER_MTD ,
  BAL.AVERAGE_CLOSE_LEDGER_YTD ,
  BAL.AVERAGE_CLOSE_AVAILABLE_MTD ,
  BAL.AVERAGE_CLOSE_AVAILABLE_YTD ,
  BAL.LAST_UPDATE_DATE ,
  BAL.LAST_UPDATED_BY ,
  BAL.CREATION_DATE ,
  BAL.CREATED_BY ,
  BAL.LAST_UPDATE_LOGIN ,
  BAL.OBJECT_VERSION_NUMBER
...
WHERE CBA.BANK_ACCOUNT_ID = XBA.CE_BANK_ACCOUNT_ID
AND XDD.ACCOUNT_NO        = XBA.ACCOUNT_NUMBER
AND CBA.BANK_ACCOUNT_ID   = BAL.BANK_ACCOUNT_ID
AND XDD.DEAL_NUMBER       = (''##$$DEALNUM$$##'')',
      p_title                  => 'Cash Management Bank Account Balances',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No account balance data found for the internal bank account associated with the specified deal.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: CE_BANK_ACCT_BALANCES');



debug('begin add_signature: XTR_BANK_ACCT_BALANCES');
   l_info('##MASK##1'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10758',
      p_sig_id                 => 'XTR_BANK_ACCT_BALANCES',
      p_sig_sql                => 'SELECT XBAL.ACCOUNT_NUMBER
,      XBAL.ACCUM_INT_BFWD
,      XBAL.ACCUM_INT_CFWD
,      XBAL.AUDIT_INDICATOR
,      XBAL.BALANCE_ADJUSTMENT
,      XBAL.BALANCE_CFLOW
,      XBAL.BALANCE_DATE
,      XBAL.COMPANY_CODE
,      XBAL.INTEREST
,      XBAL.INTEREST_RATE
,      XBAL.INTEREST_SETTLED
,      XBAL.INTEREST_SETTLED_HCE
,      XBAL.NO_OF_DAYS
,      XBAL.SETOFF
,      XBAL.STATEMENT_BALANCE
,      XBAL.UPDATED_BY
,      XBAL.UPDATED_ON
,      XBAL.LIMIT_CODE
,      XBAL.CREATED_BY
,      XBAL.CREATED_ON
,      XBAL.ACCRUAL_INTEREST
,      XBAL.FIRST_BATCH_ID
,      XBAL.LAST_BATCH_ID
,      XBAL.EXCHANGE_RATE
,      XBAL.AVERAGE_EXCHANGE_RATE
,      XBAL.ROUNDING_TYPE
,      XBAL.DAY_COUNT_TYPE
,      XBAL.ORIGINAL_AMOUNT
,      XBAL.ONE_DAY_FLOAT
,      XBAL.TWO_DAY_FLOAT
,      XBAL.BANK_ACCT_USE_ID
,      XBAL.CE_BANK_ACCOUNT_BALANCE_ID
FROM XTR_BANK_BALANCES XBAL,
  CE_BANK_ACCT_BALANCES CBAL,
  CE_BANK_ACCOUNTS CBA,
  XTR_BANK_ACCOUNTS XBA,
  XTR_DEAL_DATE_AMOUNTS XDD,
  CE_BANK_ACCT_USES_ALL USES
WHERE CBA.BANK_ACCOUNT_ID = XBA.CE_BANK_ACCOUNT_ID
AND XDD.ACCOUNT_NO        = XBA.ACCOUNT_NUMBER
AND CBA.BANK_ACCOUNT_ID   = CBAL.BANK_ACCOUNT_ID
AND XBAL.CE_BANK_ACCOUNT_BALANCE_ID = CBAL.BANK_ACCT_BALANCE_ID
AND USES.XTR_USE_ENABLE_FLAG = ''Y''
AND XBAL.BANK_ACCT_USE_ID = USES.BANK_ACCT_USE_ID
AND XDD.DEAL_NUMBER       = (''##$$DEALNUM$$##'')',
      p_title                  => 'Treasury Bank Account Balances',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No bank account balance data found for the XTR bank account related to the deal number specified in the Parameters.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: XTR_BANK_ACCT_BALANCES');



debug('begin add_signature: XTR_BATCHES_REVAL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10009',
      p_sig_id                 => 'XTR_BATCHES_REVAL',
      p_sig_sql                => 'SELECT XB.BATCH_ID ,
  XB.COMPANY_CODE ,
  XB.PERIOD_START ,
  XB.PERIOD_END ,
  XB.GL_GROUP_ID ,
  XB.UPGRADE_BATCH ,
  XB.CREATED_BY BATCH_CREATED_BY,
  XB.CREATION_DATE BATCH_CREATION_DATE,
  XB.LAST_UPDATED_BY BATCH_LAST_UPDATED_BY,
  XB.LAST_UPDATE_DATE BATCH_LAST_UPDATE_DATE_,
  XB.LAST_UPDATE_LOGIN BATCH_LAST_UPDATE_LOGIN,
  XB.BATCH_TYPE ,
  XB.REQUEST_ID ,
  XE.BATCH_EVENT_ID ,
  XE.EVENT_CODE ,
  ...
  XE.AUTHORIZED_BY ,
  XE.AUTHORIZED_ON ,
  XE.CREATED_BY EVENT_CREATED_BY,
  XE.CREATION_DATE EVENT_CREATION_DATE,
  XE.LAST_UPDATED_BY EVENT_LAST_UPDATED_BY,
  XE.LAST_UPDATE_DATE EVENT_LAST_UPDATE_DATE,
  XE.LAST_UPDATE_LOGIN EVENT_LAST_UPDATE_LOGIN
FROM XTR_BATCHES XB,
  XTR_BATCH_EVENTS XE
WHERE XB.BATCH_ID = XE.BATCH_ID
AND XE.EVENT_CODE = ''REVAL''
AND XB.BATCH_ID  IN
  ...
  WHERE DEAL_NO = (''##$$DEALNUM$$##'')
      ...
      p_title                  => 'Revaluation Batch Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No revaluation batch data was found for the deal number specified in the Parameters. ',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: XTR_BATCHES_REVAL');



debug('begin add_signature: XTR_REVALUATION_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10008',
      p_sig_id                 => 'XTR_REVALUATION_DETAILS',
      p_sig_sql                => 'SELECT ACTION_CODE ,
  COMPANY_CODE ,
...
from XTR_REVALUATION_DETAILS
WHERE DEAL_NO = (''##$$DEALNUM$$##'')',
      p_title                  => 'Revaluation Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No revaluation details were found for the deal number specified in the Parameters.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: XTR_REVALUATION_DETAILS');



debug('begin add_signature: ACCRUAL_BATCH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10760',
      p_sig_id                 => 'ACCRUAL_BATCH',
      p_sig_sql                => 'SELECT XB.BATCH_ID ,
  XB.COMPANY_CODE ,
  XB.PERIOD_START ,
  XB.PERIOD_END ,
...
AND XE.EVENT_CODE = ''ACCRUAL''
and XB.BATCH_ID  in
  (select BATCH_ID from XTR_ACCRLS_AMORT where DEAL_NO = (''##$$DEALNUM$$##'') )',
      p_title                  => 'Accrual Batch',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No accrual batch data found for the deal number specified in the Parameters.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ACCRUAL_BATCH');



debug('begin add_signature: ACCRUALS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10761',
      p_sig_id                 => 'ACCRUALS',
      p_sig_sql                => 'SELECT DEAL_NO ,
  TRANS_NO ,
  PERIOD_FROM ,
  PERIOD_TO ,
  COMPANY_CODE ,
...
WHERE DEAL_NO = (''##$$DEALNUM$$##'')',
      p_title                  => 'Accruals',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No accrual data found for the deal number specified in the Parameters.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: ACCRUALS');



debug('begin add_signature: JOURNAL_BATCH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10762',
      p_sig_id                 => 'JOURNAL_BATCH',
      p_sig_sql                => 'SELECT XB.BATCH_ID ,
  XB.COMPANY_CODE ,
  XB.PERIOD_START ,
  XB.PERIOD_END ,
...
FROM XTR_BATCHES XB,
  XTR_BATCH_EVENTS XE
WHERE XB.BATCH_ID = XE.BATCH_ID
AND XE.EVENT_CODE = ''JRNLGN''
AND XB.BATCH_ID  IN
  (SELECT BATCH_ID
  FROM XTR_DEAL_DATE_AMOUNTS
  WHERE DEAL_NUMBER = (''##$$DEALNUM$$##'') )',
      p_title                  => 'Journal Batch',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No journal batch data found for the deal number or transaction number specified in the Parameters. 
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: JOURNAL_BATCH');



debug('begin add_signature: JOURNALS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10764',
      p_sig_id                 => 'JOURNALS',
      p_sig_sql                => 'SELECT AMOUNT_TYPE ,
  AUDIT_INDICATOR ,
  CANCELLED_IN_GL ,
  COMPANY_CODE ,
  CREATED_BY ,
...
WHERE DEAL_NUMBER = (''##$$DEALNUM$$##'')',
      p_title                  => 'Journals',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No journal data was found for the deal number or transaction number specified in the Parameters.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: JOURNALS');



debug('begin add_signature: JOURNAL_STRUCTURE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10763',
      p_sig_id                 => 'JOURNAL_STRUCTURE',
      p_sig_sql                => 'SELECT ACTION_CODE ,
  AMOUNT_TYPE ,
  AUDIT_INDICATOR ,
  COMMENTS ,
  ...
  EFFECTIVE_FROM ,
  EFFECTIVE_TO
FROM XTR_JOURNAL_ENTRY_ACTIONS
WHERE (COMPANY_CODE, DEAL_TYPE, DEAL_SUBTYPE, AMOUNT_TYPE, DATE_TYPE, PRODUCT_TYPE, PORTFOLIO_CODE, ACTION_CODE) IN
  (SELECT COMPANY_CODE,
    DEAL_TYPE,
    DEAL_SUBTYPE,
    AMOUNT_TYPE,
  ...
  FROM XTR_DEAL_DATE_AMOUNTS
  WHERE DEAL_NUMBER = (''##$$DEALNUM$$##'') )',
      p_title                  => 'Journal Structure',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No journal structure setup data was found',
      p_solution               => 'Journal structure is a mandatory setup. You define, for each applicable company name, the daily journal entries that you want to generate automatically for each combination of deal type, deal subtype, product type, and portfolio. You must update journal entries whenever you create a new product type or portfolio, or when you un-authorize a product type. 

Refer to [1328696/KB767001] for sample Journal Entry Actions setup.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: JOURNAL_STRUCTURE');



debug('begin add_signature: CE_RECONCILE_DATA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10765',
      p_sig_id                 => 'CE_RECONCILE_DATA',
      p_sig_sql                => 'SELECT STATEMENT_LINE_ID ,
  REFERENCE_TYPE ,
  REFERENCE_ID ,
  CREATED_BY ,
  CREATION_DATE ,
...
AND REFERENCE_ID    IN
  ...
  WHERE SETTLEMENT_NUMBER IN
    ...
    FROM XTR_DEAL_DATE_AMOUNTS
    WHERE DEAL_NUMBER = (''##$$DEALNUM$$##'')))',
      p_title                  => 'Cash Management Reconcile Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No bank reconciliation data found for the internal bank account associated with the specified deal.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: CE_RECONCILE_DATA');



debug('begin add_signature: CE_STATEMENT_HEADER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10766',
      p_sig_id                 => 'CE_STATEMENT_HEADER',
      p_sig_sql                => 'SELECT STATEMENT_HEADER_ID ,
  BANK_ACCOUNT_ID ,
  STATEMENT_NUMBER ,
  STATEMENT_DATE ,
  CREATED_BY ,
  ...
  WHERE STATEMENT_LINE_ID IN
    ...
    AND REFERENCE_ID    IN
      ...
      WHERE SETTLEMENT_NUMBER IN
        ...
        from XTR_DEAL_DATE_AMOUNTS
        WHERE DEAL_NUMBER = (''##$$DEALNUM$$##'')))))',
      p_title                  => 'Cash Management Statement Header',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No bank account statement header found for the internal bank account associated with the specified deal.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: CE_STATEMENT_HEADER');



debug('begin add_signature: CE_STATEMENT_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10767',
      p_sig_id                 => 'CE_STATEMENT_LINES',
      p_sig_sql                => 'SELECT STATEMENT_LINE_ID ,
  STATEMENT_HEADER_ID ,
  LINE_NUMBER ,
  TRX_DATE ,
...
WHERE STATEMENT_LINE_ID IN
  ...
  AND REFERENCE_ID    IN
    ...
    WHERE SETTLEMENT_NUMBER IN
      ...
      FROM XTR_DEAL_DATE_AMOUNTS
      WHERE DEAL_NUMBER = (''##$$DEALNUM$$##''))))',
      p_title                  => 'Cash Management Statement Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No bank account statement lines found for the internal bank account associated with the specified deal.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: CE_STATEMENT_LINES');



debug('begin add_signature: EXP_COMPANY_INFO');
   l_info('##MASK##ACCOUNT_MANAGER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FULL_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SHORT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
...
Treasury : Setup : Parties : Company Profiles',
   ...
   l_info.delete;
debug('end add_signature: EXP_COMPANY_INFO');



debug('begin add_signature: EXP_COMPANY_PARAMETERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10777',
      p_sig_id                 => 'EXP_COMPANY_PARAMETERS',
      p_sig_sql                => 'SELECT COMPANY_PARAMETER_ID ,
  COMPANY_CODE ,
  PARAMETER_CODE ,
  PARAMETER_VALUE_CODE ,
...
and transaction_number = (''##$$TRXNUM$$##''))',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Company Parameter setups do not exist. ',
      p_solution               => 'Set up Company Parameters using the navigation steps below:
Treasury : Setup : Parties : Company Profiles',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: EXP_COMPANY_PARAMETERS');



debug('begin add_signature: EXP_COUNTERPARTY_INFO');
   l_info('##MASK##ACCOUNT_MANAGER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FULL_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SHORT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10779',
      p_sig_id                 => 'EXP_COUNTERPARTY_INFO',
      p_sig_sql                => 'SELECT ACCOUNT_MANAGER
,      ACCOUNT_STATUS
,      AUTHORISED
,      CONFO_ACTION_CODE
...
and PARTY_TYPE = ''CP''',
      p_title                  => 'Counterparty Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Counterparty Profile setups do not exist.  ',
      p_solution               => 'Enter CounterParty setups using the navigation steps below:
Treasury : Setup : Parties : Counterparty Profiles',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EXP_COUNTERPARTY_INFO');



debug('begin add_signature: EXP_DDA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10781',
      p_sig_id                 => 'EXP_DDA',
...
AND TRANSACTION_NUMBER = (''##$$TRXNUM$$##'')',
   ...
   l_info.delete;
debug('end add_signature: EXP_DDA');



debug('begin add_signature: EXP_DEAL_MIRROR_DATA');
   l_info('##MASK##1'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10782',
      p_sig_id                 => 'EXP_DEAL_MIRROR_DATA',
      p_sig_sql                => 'SELECT ACCOUNT_NO
,      AMOUNT
,      AMOUNT_DATE
,      AMOUNT_INDIC
...
AND TRANSACTION_NUMBER =(''##$$TRXNUM$$##'')',
      p_title                  => 'Deal Mirror Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No deal mirror data found for the deal number or transaction number specified in the Parameters.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EXP_DEAL_MIRROR_DATA');



debug('begin add_signature: EXP_TRANSACTION');
   l_info('##MASK##1'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10780',
      p_sig_id                 => 'EXP_TRANSACTION',
      p_sig_sql                => 'SELECT ACCOUNT_NO
,      ACTION_CODE
,      AMOUNT
,      AMOUNT_HCE
...
from XTR_EXPOSURE_TRANSACTIONS
WHERE TRANSACTION_NUMBER = (''##$$TRXNUM$$##'')',
      p_title                  => 'Transaction',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No transaction data found for the deal number or transaction number specified in the Parameters.   Check to be sure that the deal and transaction numbers you entered are valid.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EXP_TRANSACTION');



debug('begin add_signature: EXP_SETTLEMENT_RECON_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10783',
      p_sig_id                 => 'EXP_SETTLEMENT_RECON_STATUS',
      p_sig_sql                => 'SELECT DECODE(B.STATUS,''R'',''YES'',''NO'') RECONCILIATION_STATUS,
  B.SETTLEMENT_SUMMARY_ID REFERENCE_ID,
  B.SETTLEMENT_NUMBER,
  A.DEAL_NUMBER,
...
AND A.TRANSACTION_NUMBER = (''##$$TRXNUM$$##'')
AND A.SETTLEMENT_NUMBER = B.SETTLEMENT_NUMBER
AND A.SETTLE        = ''Y''',
      p_title                  => 'Settlement Reconciliation Status',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No settlement reconciliation status data found for the deal number or transaction number specified in the Parameters.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EXP_SETTLEMENT_RECON_STATUS');



debug('begin add_signature: EXP_SETTLEMENT_SUMMARY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10784',
      p_sig_id                 => 'EXP_SETTLEMENT_SUMMARY',
      p_sig_sql                => 'SELECT SETTLEMENT_SUMMARY_ID
,      SETTLEMENT_NUMBER
,      COMPANY
,      CURRENCY
...
AND TRANSACTION_NUMBER = (''##$$TRXNUM$$##''))',
      p_title                  => 'Settlement Summary',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No settlement summary data found for the deal number or transaction number specified in the Parameters.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EXP_SETTLEMENT_SUMMARY');
...
debug('begin add_signature: EXP_CE_BANK_ACCT');
   l_info('##MASK##2'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##3'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##5'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##6'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
AND XDD.ACCOUNT_NO        = XBA.ACCOUNT_NUMBER
AND XDD.DEAL_NUMBER       = (''##$$DEALNUM$$##'')
AND XDD.DEAL_TYPE = (''##$$DEALTYPE$$##'')
AND XDD.TRANSACTION_NUMBER = (''##$$TRXNUM$$##'')',
      p_title                  => 'Cash Management Bank Account',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found for the internal bank account associated with the deal number specified in the Parameters.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EXP_CE_BANK_ACCT');



debug('begin add_signature: EXP_CE_BANK_ACCT_BALANCES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10789',
      p_sig_id                 => 'EXP_CE_BANK_ACCT_BALANCES',
      p_sig_sql                => 'SELECT BAL.BANK_ACCT_BALANCE_ID ,
  BAL.BANK_ACCOUNT_ID ,
  BAL.BALANCE_DATE ,
  BAL.LEDGER_BALANCE ,
...
AND XDD. TRANSACTION_NUMBER  = (''##$$TRXNUM$$##'')',
      p_title                  => 'Cash Management Bank Account Balances',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No account balance data found for the internal bank account associated with the deal number specified in the Parameters.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EXP_CE_BANK_ACCT_BALANCES');



debug('begin add_signature: EXP_CE_XTR_GL_ACCTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10787',
      p_sig_id                 => 'EXP_CE_XTR_GL_ACCTS',
      p_sig_sql                => 'SELECT CCID.BANK_ACCT_USE_ID ,
  CCID.XTR_ASSET_CCID ,
  CCID.ASSET_CODE_COMBINATION_ID ,
  CCID.LAST_UPDATE_DATE ,
...
AND XDD. TRANSACTION_NUMBER  = (''##$$TRXNUM$$##'')',
   ...
   l_info.delete;
debug('end add_signature: EXP_CE_XTR_GL_ACCTS');



debug('begin add_signature: EXP_XTR_BANK_ACCT');
   l_info('##MASK##1'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##4'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10786',
      p_sig_id                 => 'EXP_XTR_BANK_ACCT',
      p_sig_sql                => 'SELECT XBA.ACCOUNT_NUMBER
,      XBA.AUTHORISED
,      XBA.BANK_CODE
,      XBA.BANK_NAME
...
AND   XDD.TRANSACTION_NUMBER = (''##$$TRXNUM$$##'')',
   ...
   l_info.delete;
debug('end add_signature: EXP_XTR_BANK_ACCT');



debug('begin add_signature: EXP_XTR_BANK_ACCT_BALANCES');
   l_info('##MASK##1'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10790',
      p_sig_id                 => 'EXP_XTR_BANK_ACCT_BALANCES',
      p_sig_sql                => 'SELECT XBAL.ACCOUNT_NUMBER
,      XBAL.ACCUM_INT_BFWD
,      XBAL.ACCUM_INT_CFWD
,      XBAL.AUDIT_INDICATOR
...
AND XDD. TRANSACTION_NUMBER  = (''##$$TRXNUM$$##'')',
      p_title                  => 'Treasury Bank Account Balances',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No bank account balance data found for the XTR bank accounts related to the deal number specified in the Parameters.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EXP_XTR_BANK_ACCT_BALANCES');



debug('begin add_signature: EXP_XTR_BANK_ACCT_USES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10788',
      p_sig_id                 => 'EXP_XTR_BANK_ACCT_USES',
      p_sig_sql                => 'SELECT USES.BANK_ACCT_USE_ID
,      USES.BANK_ACCOUNT_ID
,      USES.LAST_UPDATE_DATE
,      USES.LAST_UPDATED_BY
...
AND XDD. TRANSACTION_NUMBER  = (''##$$TRXNUM$$##'')',
   ...
   l_info.delete;
debug('end add_signature: EXP_XTR_BANK_ACCT_USES');



debug('begin add_signature: EXP_JOURNAL_BATCH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10791',
      p_sig_id                 => 'EXP_JOURNAL_BATCH',
      p_sig_sql                => 'SELECT XB.BATCH_ID ,
  XB.COMPANY_CODE ,
  XB.PERIOD_START ,
  XB.PERIOD_END ,
...
AND XB.BATCH_ID  IN
  ...
  AND TRANSACTION_NUMBER  = (''##$$TRXNUM$$##''))',
      p_title                  => 'Journal Batch',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No journal batch data was found for the deal number or transaction number specified in the Parameters.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EXP_JOURNAL_BATCH');



debug('begin add_signature: EXP_JOURNALS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10792',
      p_sig_id                 => 'EXP_JOURNALS',
      p_sig_sql                => 'SELECT AMOUNT_TYPE ,
  AUDIT_INDICATOR ,
  CANCELLED_IN_GL ,
  COMPANY_CODE ,
...
and TRANSACTION_NUMBER  = (''##$$TRXNUM$$##'')',
   ...
   l_info.delete;
debug('end add_signature: EXP_JOURNALS');



debug('begin add_signature: EXP_JOURNAL_STRUCTURE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10793',
      p_sig_id                 => 'EXP_JOURNAL_STRUCTURE',
      p_sig_sql                => 'SELECT COMPANY_CODE ,
  EXPOSURE_TYPE ,
  FREQUENCY ,
  CODE_COMBINATION_ID ,
  LAST_DOWNLOAD_DATE ,
  ...
  CREATED_BY ,
  CREATED_ON
FROM XTR_EXPOSURE_TYPES
WHERE EXPOSURE_TYPE IN
  (SELECT EXPOSURE_TYPE
  FROM XTR_EXPOSURE_TRANSACTIONS
  WHERE TRANSACTION_NUMBER = (''##$$TRXNUM$$##'') )',
      p_title                  => 'Exposure Type Setup',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Exposure Types setup found',
      p_solution               => 'Review "2. Do you have to define a journal action for exposures?" in [262477/FAQ5519] for more information about Exposure Types.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EXP_JOURNAL_STRUCTURE');



debug('begin add_signature: EXP_CE_RECONCILE_DATA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10794',
      p_sig_id                 => 'EXP_CE_RECONCILE_DATA',
      p_sig_sql                => 'SELECT STATEMENT_LINE_ID ,
  REFERENCE_TYPE ,
  REFERENCE_ID ,
  CREATED_BY ,
...
and TRANSACTION_NUMBER  = (''##$$TRXNUM$$##'')))',
      p_title                  => 'Cash Management Reconcile Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No reconciliation data found for the internal bank account associated with the deal number or transactions number specified in the Parameters.
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: EXP_CE_RECONCILE_DATA');



debug('begin add_signature: EXP_CE_STATEMENT_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10795',
      p_sig_id                 => 'EXP_CE_STATEMENT_LINES',
      p_sig_sql                => 'SELECT STATEMENT_LINE_ID ,
  STATEMENT_HEADER_ID ,
  LINE_NUMBER ,
  TRX_DATE ,
...
and TRANSACTION_NUMBER  = (''##$$TRXNUM$$##''))))',
      p_title                  => 'Cash Management Statement Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No bank account statement lines information found for the internal bank account associated with the deal number specified in the Parameters.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EXP_CE_STATEMENT_LINES');



debug('begin add_signature: IAC_COMPANY_INFO');
   l_info('##MASK##ACCOUNT_MANAGER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FULL_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SHORT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
...
Treasury : Setup : Parties : Company Profiles',
   ...
   l_info.delete;
debug('end add_signature: IAC_COMPANY_INFO');



debug('begin add_signature: IAC_COMPANY_PARAMETERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10797',
      p_sig_id                 => 'IAC_COMPANY_PARAMETERS',
      p_sig_sql                => 'SELECT COMPANY_PARAMETER_ID ,
  COMPANY_CODE ,
  PARAMETER_CODE ,
  PARAMETER_VALUE_CODE ,
...
Treasury : Setup : Parties : Company Profiles',
   ...
   l_info.delete;
debug('end add_signature: IAC_COMPANY_PARAMETERS');



debug('begin add_signature: IAC_COUNTERPARTY_INFO');
   l_info('##MASK##ACCOUNT_MANAGER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FULL_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SHORT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10799',
      p_sig_id                 => 'IAC_COUNTERPARTY_INFO',
      p_sig_sql                => 'SELECT ACCOUNT_MANAGER
,      ACCOUNT_STATUS
,      AUTHORISED
,      CONFO_ACTION_CODE
...
and transaction_number = (''##$$TRXNUM$$##''))',
      p_title                  => 'Counterparty Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Counterparty Profile setups do not exist.  Enter CounterParty setups using the navigation steps below:
Treasury : Setup : Parties : Counterparty Profiles',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: IAC_COUNTERPARTY_INFO');



debug('begin add_signature: IAC_DDA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10801',
      p_sig_id                 => 'IAC_DDA',
...
AND TRANSACTION_NUMBER = (''##$$TRXNUM$$##'')',
   ...
   l_info.delete;
debug('end add_signature: IAC_DDA');



debug('begin add_signature: IAC_DEAL_MIRROR_DATA');
   l_info('##MASK##1'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10802',
      p_sig_id                 => 'IAC_DEAL_MIRROR_DATA',
      p_sig_sql                => 'SELECT ACCOUNT_NO
,      AMOUNT
,      AMOUNT_DATE
,      AMOUNT_INDIC
...
AND TRANSACTION_NUMBER =(''##$$TRXNUM$$##'')',
   ...
   l_info.delete;
debug('end add_signature: IAC_DEAL_MIRROR_DATA');



debug('begin add_signature: IAC_INTERACCT_TRANSFERS');
   l_info('##MASK##1'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##2'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10800',
      p_sig_id                 => 'IAC_INTERACCT_TRANSFERS',
      p_sig_sql                => 'SELECT ACCOUNT_NO_FROM ,
  ACCOUNT_NO_TO ,
  COMMENTS ,
  COMPANY_CODE ,
  CURRENCY ,
  ...
  EXTERNAL_SOURCE ,
  DEALER_CODE 
from XTR_INTERACCT_TRANSFERS
where TRANSACTION_NUMBER = (''##$$TRXNUM$$##'')',
      p_title                  => 'Inter-Account Transfers',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No transfer data found for the internal bank account associated with the deal number specified in the Parameters.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: IAC_INTERACCT_TRANSFERS');



debug('begin add_signature: IAC_SETTLEMENT_RECON_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10803',
      p_sig_id                 => 'IAC_SETTLEMENT_RECON_STATUS',
      p_sig_sql                => 'SELECT DECODE(B.STATUS,''R'',''YES'',''NO'') RECONCILIATION_STATUS,
  B.SETTLEMENT_SUMMARY_ID REFERENCE_ID,
  B.SETTLEMENT_NUMBER,
  A.DEAL_NUMBER,
...
AND A.SETTLE        = ''Y''',
      p_title                  => 'Settlement Reconciliation Status',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No settlement reconciliation status data was found for the deal number or transaction number specified in the Parameters.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: IAC_SETTLEMENT_RECON_STATUS');



debug('begin add_signature: IAC_SETTLEMENT_SUMMARY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10804',
      p_sig_id                 => 'IAC_SETTLEMENT_SUMMARY',
      p_sig_sql                => 'SELECT SETTLEMENT_SUMMARY_ID
,      SETTLEMENT_NUMBER
,      COMPANY
,      CURRENCY
...
AND TRANSACTION_NUMBER = (''##$$TRXNUM$$##''))',
   ...
   l_info.delete;
debug('end add_signature: IAC_SETTLEMENT_SUMMARY');



debug('begin add_signature: IAC_CE_BANK_ACCT');
   l_info('##MASK##2'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##3'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##5'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##6'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
AND XDD. TRANSACTION_NUMBER = (''##$$TRXNUM$$##'')',
   ...
   l_info.delete;
debug('end add_signature: IAC_CE_BANK_ACCT');



debug('begin add_signature: IAC_CE_BANK_ACCT_BALANCES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10809',
      p_sig_id                 => 'IAC_CE_BANK_ACCT_BALANCES',
      p_sig_sql                => 'SELECT BAL.BANK_ACCT_BALANCE_ID ,
  BAL.BANK_ACCOUNT_ID ,
  BAL.BALANCE_DATE ,
  BAL.LEDGER_BALANCE ,
...
AND XDD. TRANSACTION_NUMBER  = (''##$$TRXNUM$$##'')',
   ...
   l_info.delete;
debug('end add_signature: IAC_CE_BANK_ACCT_BALANCES');



debug('begin add_signature: IAC_CE_XTR_GL_ACCTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10807',
      p_sig_id                 => 'IAC_CE_XTR_GL_ACCTS',
      p_sig_sql                => 'SELECT CCID.BANK_ACCT_USE_ID ,
  CCID.XTR_ASSET_CCID ,
  CCID.ASSET_CODE_COMBINATION_ID ,
  CCID.LAST_UPDATE_DATE ,
...
AND XDD. TRANSACTION_NUMBER  = (''##$$TRXNUM$$##'')',
   ...
   l_info.delete;
debug('end add_signature: IAC_CE_XTR_GL_ACCTS');



debug('begin add_signature: IAC_XTR_BANK_ACCT');
   l_info('##MASK##1'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##4'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10806',
      p_sig_id                 => 'IAC_XTR_BANK_ACCT',
      p_sig_sql                => 'SELECT XBA.ACCOUNT_NUMBER
,      XBA.AUTHORISED
,      XBA.BANK_CODE
,      XBA.BANK_NAME
...
WHERE XDD.ACCOUNT_NO  = XBA.ACCOUNT_NUMBER
  ...
  AND XDD.TRANSACTION_NUMBER = (''##$$TRXNUM$$##'')',
   ...
   l_info.delete;
debug('end add_signature: IAC_XTR_BANK_ACCT');



debug('begin add_signature: IAC_XTR_BANK_ACCT_BALANCES');
   l_info('##MASK##1'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10810',
      p_sig_id                 => 'IAC_XTR_BANK_ACCT_BALANCES',
      p_sig_sql                => 'SELECT XBAL.ACCOUNT_NUMBER
,      XBAL.ACCUM_INT_BFWD
,      XBAL.ACCUM_INT_CFWD
,      XBAL.AUDIT_INDICATOR
...
AND XDD. TRANSACTION_NUMBER  = (''##$$TRXNUM$$##'')',
   ...
   l_info.delete;
debug('end add_signature: IAC_XTR_BANK_ACCT_BALANCES');



debug('begin add_signature: IAC_XTR_BANK_ACCT_USES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10808',
      p_sig_id                 => 'IAC_XTR_BANK_ACCT_USES',
      p_sig_sql                => 'SELECT USES.BANK_ACCT_USE_ID
,      USES.BANK_ACCOUNT_ID
,      USES.LAST_UPDATE_DATE
,      USES.LAST_UPDATED_BY
...
AND XDD. TRANSACTION_NUMBER  = (''##$$TRXNUM$$##'')',
   ...
   l_info.delete;
debug('end add_signature: IAC_XTR_BANK_ACCT_USES');



debug('begin add_signature: IAC_JOURNAL_BATCH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10811',
      p_sig_id                 => 'IAC_JOURNAL_BATCH',
      p_sig_sql                => 'SELECT XB.BATCH_ID ,
  XB.COMPANY_CODE ,
  XB.PERIOD_START ,
  XB.PERIOD_END ,
...
AND XB.BATCH_ID  IN
  ...
  AND TRANSACTION_NUMBER  = (''##$$TRXNUM$$##''))',
   ...
   l_info.delete;
debug('end add_signature: IAC_JOURNAL_BATCH');



debug('begin add_signature: IAC_JOURNALS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10812',
      p_sig_id                 => 'IAC_JOURNALS',
      p_sig_sql                => 'SELECT AMOUNT_TYPE ,
  AUDIT_INDICATOR ,
  CANCELLED_IN_GL ,
  COMPANY_CODE ,
...
and TRANSACTION_NUMBER  = (''##$$TRXNUM$$##'')',
   ...
   l_info.delete;
debug('end add_signature: IAC_JOURNALS');



debug('begin add_signature: IAC_JOURNAL_STRUCTURE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10813',
      p_sig_id                 => 'IAC_JOURNAL_STRUCTURE',
      p_sig_sql                => 'SELECT ACTION_CODE ,
  AMOUNT_TYPE ,
  AUDIT_INDICATOR ,
  COMMENTS ,
...
and TRANSACTION_NUMBER  = (''##$$TRXNUM$$##'') )',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No journal structure setup data was found',
      p_solution               => 'Refer to [1328696/KB767001] for sample Journal Entry Actions setup.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: IAC_JOURNAL_STRUCTURE');



debug('begin add_signature: IAC_CE_RECONCILE_DATA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10814',
      p_sig_id                 => 'IAC_CE_RECONCILE_DATA',
      p_sig_sql                => 'SELECT STATEMENT_LINE_ID ,
  REFERENCE_TYPE ,
  REFERENCE_ID ,
  CREATED_BY ,
...
and TRANSACTION_NUMBER  = (''##$$TRXNUM$$##'')))',
   ...
   l_info.delete;
debug('end add_signature: IAC_CE_RECONCILE_DATA');



debug('begin add_signature: IAC_CE_STATEMENT_HEADER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10816',
      p_sig_id                 => 'IAC_CE_STATEMENT_HEADER',
      p_sig_sql                => 'SELECT STATEMENT_HEADER_ID ,
  BANK_ACCOUNT_ID ,
  STATEMENT_NUMBER ,
  STATEMENT_DATE ,
...
and TRANSACTION_NUMBER  = (''##$$TRXNUM$$##'')))))',
      p_title                  => 'Cash Management Statement Header',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No bank account statement header information found for the internal bank account associated with the deal number specified in the Parameters.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: IAC_CE_STATEMENT_HEADER');



debug('begin add_signature: IAC_CE_STATEMENT_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10815',
      p_sig_id                 => 'IAC_CE_STATEMENT_LINES',
      p_sig_sql                => 'SELECT STATEMENT_LINE_ID ,
  STATEMENT_HEADER_ID ,
  LINE_NUMBER ,
  TRX_DATE ,
...
and TRANSACTION_NUMBER  = (''##$$TRXNUM$$##''))))',
   ...
   l_info.delete;
debug('end add_signature: IAC_CE_STATEMENT_LINES');
...
BEGIN
  ...
  IF (p_deal_type IS NOT NULL) THEN
    g_params_string := g_params_string || to_char(p_deal_type) || '_';
  END IF;
  ...
  analyzer_title := 'Treasury Analyzer';
...
debug('begin section: Proactive_and_Preventive_Recommendations');
IF (substr(g_rep_info('Apps Version'),1,4) = '12.1') THEN
   start_section('Proactive and Preventive Recommendations', 'Proactive_and_Preventive_Recommendations');
      set_item_result(check_rec_patches_1); /* Signature XTR_REQUIRED_121_PATCH */
   end_section;
END IF;
debug('end section: Proactive_and_Preventive_Recommendations');
...
debug('begin section: System_Setups');
start_section('System Setups', 'System_Setups');
   set_item_result(run_stored_sig('SYSTEM PARAMETERS'));
   set_item_result(run_stored_sig('DEALER_SETUP'));
   set_item_result(run_stored_sig('DEALER_COMPANY_ACCESS'));
   set_item_result(run_stored_sig('DEALER_DEAL_ACCESS'));
   set_item_result(run_stored_sig('DEALER_ACCESS_TO_OVERRIDE_INT'));
end_section;
debug('end section: System_Setups');

debug('begin section: Data_Issues');
start_section('Data Issues', 'Data_Issues');
   set_item_result(run_stored_sig('AUTH_REVAL_BATCHES_NO_DETAILS'));
   set_item_result(run_stored_sig('AUTH_ACCRUAL_BATCHES_NO_DETAILS'));
end_section;
debug('end section: Data_Issues');

debug('begin section: Company_Setups');
IF p_deal_type = 'OTHER' THEN
   start_section('Company Setup Information', 'Company_Setups');
      set_item_result(run_stored_sig('COMPANY PARAMETERS'));
      set_item_result(run_stored_sig('COMPANY_INFO'));
   end_section;
END IF;
debug('end section: Company_Setups');

debug('begin section: Counterparty_Information');
IF p_deal_type = 'OTHER' THEN
   start_section('Counterparty Information', 'Counterparty_Information');
      set_item_result(run_stored_sig('COUNTERPARTY INFO'));
   end_section;
END IF;
debug('end section: Counterparty_Information');

debug('begin section: Deal_Data');
IF p_deal_type = 'OTHER' THEN
   start_section('Deal Data', 'Deal_Data');
      set_item_result(run_stored_sig('DEALS'));
      set_item_result(run_stored_sig('INTERCO_FUNDING_LOANS'));
      set_item_result(run_stored_sig('DDA'));
      set_item_result(run_stored_sig('XTR_MIRROR_DDA_LIMIT_ROW'));
      set_item_result(run_stored_sig('ROLLOVER_TRANSACTIONS'));
   end_section;
END IF;
debug('end section: Deal_Data');

debug('begin section: Settlement');
IF p_deal_type = 'OTHER' THEN
   start_section('Settlement', 'Settlement');
      set_item_result(run_stored_sig('SETTLEMENT_RECON_STATUS'));
      set_item_result(run_stored_sig('SETTLEMENT_SUMMARY'));
   end_section;
END IF;
debug('end section: Settlement');

debug('begin section: Bank_Account_Information');
IF p_deal_type = 'OTHER' THEN
   start_section('Bank Account Information', 'Bank_Account_Information');
      set_item_result(run_stored_sig('CE_BANK_ACCOUNT'));
      set_item_result(run_stored_sig('XTR_BANK_ACCT'));
      set_item_result(run_stored_sig('CE_XTR_GL_ACCTS'));
      set_item_result(run_stored_sig('XTR_BANK_ACCT_USES'));
      set_item_result(run_stored_sig('CE_BANK_ACCT_BALANCES'));
      set_item_result(run_stored_sig('XTR_BANK_ACCT_BALANCES'));
   end_section;
END IF;
debug('end section: Bank_Account_Information');

debug('begin section: Revaluations');
IF p_deal_type = 'OTHER' THEN
   start_section('Revaluations', 'Revaluations');
      set_item_result(run_stored_sig('XTR_BATCHES_REVAL'));
      set_item_result(run_stored_sig('XTR_REVALUATION_DETAILS'));
   end_section;
END IF;
debug('end section: Revaluations');

debug('begin section: Accruals');
IF p_deal_type = 'OTHER' THEN
   start_section('Accruals', 'Accruals');
      set_item_result(run_stored_sig('ACCRUAL_BATCH'));
      set_item_result(run_stored_sig('ACCRUALS'));
   end_section;
END IF;
debug('end section: Accruals');

debug('begin section: Journals');
IF p_deal_type = 'OTHER' THEN
   start_section('Journals', 'Journals');
      set_item_result(run_stored_sig('JOURNAL_BATCH'));
      set_item_result(run_stored_sig('JOURNALS'));
      set_item_result(run_stored_sig('JOURNAL_STRUCTURE'));
   end_section;
END IF;
debug('end section: Journals');

debug('begin section: Cash_Management_Reconciliation');
IF p_deal_type = 'OTHER' THEN
   start_section('Cash Management Reconciliation', 'Cash_Management_Reconciliation');
      set_item_result(run_stored_sig('CE_RECONCILE_DATA'));
      set_item_result(run_stored_sig('CE_STATEMENT_HEADER'));
      set_item_result(run_stored_sig('CE_STATEMENT_LINES'));
   end_section;
END IF;
debug('end section: Cash_Management_Reconciliation');

debug('begin section: EXP_Company_Setups');
IF p_deal_type = 'EXP' THEN
   start_section('Company Setup Information', 'EXP_Company_Setups');
      set_item_result(run_stored_sig('EXP_COMPANY_INFO'));
      set_item_result(run_stored_sig('EXP_COMPANY_PARAMETERS'));
   end_section;
END IF;
debug('end section: EXP_Company_Setups');

debug('begin section: EXP_Counterparty_Information');
IF p_deal_type = 'EXP' THEN
   start_section('CounterParty Information', 'EXP_Counterparty_Information');
      set_item_result(run_stored_sig('EXP_COUNTERPARTY_INFO'));
   end_section;
END IF;
debug('end section: EXP_Counterparty_Information');

debug('begin section: EXP_Deal_Data');
IF p_deal_type = 'EXP' THEN
   start_section('Deal Data', 'EXP_Deal_Data');
      set_item_result(run_stored_sig('EXP_DDA'));
      set_item_result(run_stored_sig('EXP_DEAL_MIRROR_DATA'));
      set_item_result(run_stored_sig('EXP_TRANSACTION'));
   end_section;
END IF;
debug('end section: EXP_Deal_Data');

debug('begin section: EXP_Settlement');
IF p_deal_type = 'EXP' THEN
   start_section('Settlement', 'EXP_Settlement');
      set_item_result(run_stored_sig('EXP_SETTLEMENT_RECON_STATUS'));
      set_item_result(run_stored_sig('EXP_SETTLEMENT_SUMMARY'));
   end_section;
END IF;
debug('end section: EXP_Settlement');
...
debug('begin section: EXP_Bank_Account_Information');
IF p_deal_type = 'EXP' THEN
   start_section('Bank Account Information', 'EXP_Bank_Account_Information');
      set_item_result(run_stored_sig('EXP_CE_BANK_ACCT'));
      set_item_result(run_stored_sig('EXP_CE_BANK_ACCT_BALANCES'));
      set_item_result(run_stored_sig('EXP_CE_XTR_GL_ACCTS'));
      set_item_result(run_stored_sig('EXP_XTR_BANK_ACCT'));
      set_item_result(run_stored_sig('EXP_XTR_BANK_ACCT_BALANCES'));
      set_item_result(run_stored_sig('EXP_XTR_BANK_ACCT_USES'));
   end_section;
END IF;
debug('end section: EXP_Bank_Account_Information');

debug('begin section: EXP_Journals');
IF p_deal_type = 'EXP' THEN
   start_section('Journals', 'EXP_Journals');
      set_item_result(run_stored_sig('EXP_JOURNAL_BATCH'));
      set_item_result(run_stored_sig('EXP_JOURNALS'));
      set_item_result(run_stored_sig('EXP_JOURNAL_STRUCTURE'));
   end_section;
END IF;
debug('end section: EXP_Journals');

debug('begin section: EXP_Cash_Management_Reconciliation');
IF p_deal_type = 'EXP' THEN
   start_section('Cash Management Reconciliation', 'EXP_Cash_Management_Reconciliation');
      set_item_result(run_stored_sig('EXP_CE_RECONCILE_DATA'));
      set_item_result(run_stored_sig('CE_STATEMENT_HEADER'));
      set_item_result(run_stored_sig('EXP_CE_STATEMENT_LINES'));
   end_section;
END IF;
debug('end section: EXP_Cash_Management_Reconciliation');

debug('begin section: IAC_Company_Setups');
IF p_deal_type = 'IAC' THEN
   start_section('Company Setup Information', 'IAC_Company_Setups');
      set_item_result(run_stored_sig('IAC_COMPANY_INFO'));
      set_item_result(run_stored_sig('IAC_COMPANY_PARAMETERS'));
   end_section;
END IF;
debug('end section: IAC_Company_Setups');

debug('begin section: IAC_Counterparty_Information');
IF p_deal_type = 'IAC' THEN
   start_section('Counterparty Information', 'IAC_Counterparty_Information');
      set_item_result(run_stored_sig('IAC_COUNTERPARTY_INFO'));
   end_section;
END IF;
debug('end section: IAC_Counterparty_Information');

debug('begin section: IAC_Deal_Data');
IF p_deal_type = 'IAC' THEN
   start_section('Deal Data', 'IAC_Deal_Data');
      set_item_result(run_stored_sig('IAC_DDA'));
      set_item_result(run_stored_sig('IAC_DEAL_MIRROR_DATA'));
      set_item_result(run_stored_sig('IAC_INTERACCT_TRANSFERS'));
   end_section;
END IF;
debug('end section: IAC_Deal_Data');

debug('begin section: IAC_Settlement');
IF p_deal_type = 'IAC' THEN
   start_section('Settlement', 'IAC_Settlement');
      set_item_result(run_stored_sig('IAC_SETTLEMENT_RECON_STATUS'));
      set_item_result(run_stored_sig('IAC_SETTLEMENT_SUMMARY'));
   end_section;
END IF;
debug('end section: IAC_Settlement');

debug('begin section: IAC_Bank_Account_Information');
IF p_deal_type = 'IAC' THEN
   start_section('Bank Account Information', 'IAC_Bank_Account_Information');
      set_item_result(run_stored_sig('IAC_CE_BANK_ACCT'));
      set_item_result(run_stored_sig('IAC_CE_BANK_ACCT_BALANCES'));
      set_item_result(run_stored_sig('IAC_CE_XTR_GL_ACCTS'));
      set_item_result(run_stored_sig('IAC_XTR_BANK_ACCT'));
      set_item_result(run_stored_sig('IAC_XTR_BANK_ACCT_BALANCES'));
      set_item_result(run_stored_sig('IAC_XTR_BANK_ACCT_USES'));
   end_section;
END IF;
debug('end section: IAC_Bank_Account_Information');

debug('begin section: IAC_Journals');
IF p_deal_type = 'IAC' THEN
   start_section('Journals', 'IAC_Journals');
      set_item_result(run_stored_sig('IAC_JOURNAL_BATCH'));
      set_item_result(run_stored_sig('IAC_JOURNALS'));
      set_item_result(run_stored_sig('IAC_JOURNAL_STRUCTURE'));
   end_section;
END IF;
debug('end section: IAC_Journals');

debug('begin section: IAC_Cash_Management_Reconciliation');
IF p_deal_type = 'IAC' THEN
   start_section('Cash Management Reconciliation', 'IAC_Cash_Management_Reconciliation');
      set_item_result(run_stored_sig('IAC_CE_RECONCILE_DATA'));
      set_item_result(run_stored_sig('IAC_CE_STATEMENT_HEADER'));
      set_item_result(run_stored_sig('IAC_CE_STATEMENT_LINES'));
   end_section;
END IF;
debug('end section: IAC_Cash_Management_Reconciliation');
