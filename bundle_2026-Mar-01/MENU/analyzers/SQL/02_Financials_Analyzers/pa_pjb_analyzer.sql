...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Projects Revenue and Billing Analyzer  |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE pa_pjb_analyzer_pkg AUTHID DEFINER AS
...
(            p_project_id                   IN NUMBER      DEFAULT NULL
           ,p_draft_invoice_num            IN NUMBER      DEFAULT NULL
           ,p_draft_revenue_num            IN NUMBER      DEFAULT NULL
...
END pa_pjb_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY pa_pjb_analyzer_pkg AS
-- $Id: pa_pjb_analyzer.sql, 200.28 2026/02/25 21:48:04 aliclin Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2778912.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'PAPJB_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'PAPJB_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>PAPJB Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2778912.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/pa_pjb_latest_ver.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,2815,EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,2815,EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},2815,EBS,EBS Financials,EBS - Projects" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4323111" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">2815</span>
...
<div class="ck-content"><p><strong><u>Version 200.28</u></strong></p><ul><li>Sigs updated for article ID changes and sql updates.</li>
</ul>
<p><strong><u>Version 200.27</u></strong></p><ul><li>Template enhancement: EBS KB Article IDs Shown for Signature KM Links.</li>
<li>Sigs updated for article ID changes.</li>
</ul>
<p><strong><u>Version 200.26</u></strong></p><ul><li>Template enhanced and AC_TABLE_INDEXES modified.</li>
</ul>
<p><strong><u>Version 200.25</u></strong></p><ul><li>Max sequence signatures modified.</li>
</ul>
<p><strong><u>Version 200.24</u></strong></p><ul><li>4 new signatures added to “Informational” section.</li>
<li>2 signatures modified.</li>
</ul>
<p><strong><u>Version 200.23</u></strong></p><ul><li>New Analyzer Framework version 4.7.3 released with enhancements.<ul><li>SQL*Plus Error fixed: SP2-0027: Input is too long</li>
<li>Ability to click to select rows in output tables</li>
</ul>
</li>
<li>Numerous signatures modified.</li>
</ul>
<p><strong><u>Version 200.22</u></strong></p><ul><li>Numerous signatures modified.</li>
</ul>
<p><strong><u>Version 200.21</u></strong></p><ul><li>New signatures added to "Project Details" and to "Data Issues" sections.</li>
<li>Numerous signatures modified.</li>
</ul>
<p><strong><u>Version 200.20</u></strong></p><ul><li>One signature modified</li>
</ul>
<p><strong><u>Version 200.19</u></strong></p><ul><li>New signature added to "Project Details" and to "Data Issues" sections.</li>
<li>Numerous signatures modified.</li>
</ul>
</div>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,2815,'||l_sig.sigrepo_id||',EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,2815,'||l_sig.sigrepo_id||',EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},2815,'||l_sig.sigrepo_id||',EBS,EBS Financials,EBS - Projects" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,2815,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,2815,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},2815,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Projects" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
FUNCTION check_rec_patches_1 RETURN VARCHAR2 IS
  /* Signature EBS_FIN_PA_PAPJB_BILL_RECOMMENDED_PATCHES */
...
BEGIN
    ...
    print_log('Processing recommended patches signature: EBS_FIN_PA_PAPJB_BILL_RECOMMENDED_PATCHES (check_rec_patches_1) "Project Billing Recommended Patches" (version 5)');
...
IF substr(g_rep_info('Apps Version'),1,6) = '12.2.7' THEN
   ...
   l_col_rows(1)(l_rows) := '33767280';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '1OFF:33762892:TRANSFERRED_DATE SHOULD NOT BE RESET IF INVOICE IS SUCCESSFULLY INTERFACED ONCE TO AR';
   l_col_rows(5)(l_rows) := '[2905854/KB382169]';

END IF;

IF substr(g_rep_info('Apps Version'),1,6) = '12.2.8' THEN
   l_rel := 'R12';
...
IF substr(g_rep_info('Apps Version'),1,6) = '12.2.9' THEN
   l_rel := 'R12';
...
IF substr(g_rep_info('Apps Version'),1,7) = '12.2.10' THEN
   l_rel := 'R12';
...
IF substr(g_rep_info('Apps Version'),1,7) = '12.2.11' THEN
   l_rel := 'R12';
...
IF substr(g_rep_info('Apps Version'),1,7) = '12.2.12' THEN
   l_rel := 'R12';
...
IF substr(g_rep_info('Apps Version'),1,7) = '12.2.13' THEN
   l_rel := 'R12';
...
IF substr(g_rep_info('Apps Version'),1,6) = '12.2.7' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '32137123';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'PAIGEN ERRORS WITH ORA ERROR DUE TO DUPLICATE ADJUSTED ITEMS';
   l_col_rows(5)(l_rows) := '[2270694/KB615513]';
...
IF substr(g_rep_info('Apps Version'),1,6) = '12.1.3' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '24708073';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '1OFF:23138910:AR INVOICE NUMBERS GETTING DUPLICATED FOR PROJECTS HAVING MULTIPLE';
   l_col_rows(5)(l_rows) := '[2193265/KB256178]';
...
IF substr(g_rep_info('Apps Version'),1,6) = '12.2.4' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '24620871';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '1OFF:24525308:CANNOT RELEASE DRAFT INVOICES WITH MUTLI CLIENTS IF GENERATED FOR';
   l_col_rows(5)(l_rows) := '[2193265/KB256178]';
...
IF substr(g_rep_info('Apps Version'),1,6) = '12.1.3' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '28973027';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '1OFF:27965617:CREATE ACCOUNTING: GET ERROR 95318 REQUESTED BY DEV FROM 27409643';
   l_col_rows(5)(l_rows) := '[2493318/KB543201]';
...
IF substr(g_rep_info('Apps Version'),1,6) = '12.2.7' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '28799542';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '1OFF : 28384383:ADD BILL GROUP AS AA PARAMTERS FOR REGULAR INVOICES';
   l_col_rows(5)(l_rows) := '[2493318/KB543201]';
...
IF substr(g_rep_info('Apps Version'),1,6) = '12.2.5' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '27584203';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '1OFF:27402778:CREDIT MEMO REJECTION IN AUTO INVOICE';
   l_col_rows(5)(l_rows) := '[2370047/KB771999]';
...
IF substr(g_rep_info('Apps Version'),1,6) = '12.2.4' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '2134677';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '1OFF:20962241:INT1225.XB7:PJB: PRC: INTERFACE INVOICES TO RECEIVABLES ERROR';
   l_col_rows(5)(l_rows) := '[2116354/KB414210]';
...
IF substr(g_rep_info('Apps Version'),1,6) = '12.2.3' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35668831';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Projects Concurrent Processes Complete With Signal 11 Error';
   l_col_rows(5)(l_rows) := '[2987333/KB297305]';
...
END IF;
   ...
   l_sig.sigrepo_id := '26149';
   l_sig.title := 'Project Billing Recommended Patches';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := 'Review the list of recommended patch(es) to see if any have not been applied in your environment.';
   l_sig.solution := 'Please review list by clicking on "Recommended Patches" above and schedule to apply any unapplied patches as soon as possible.<br>
<b>The Recommended Patches include very important fixes for Oracle Grants Accounting application.</b><br><br>
...
Best Practice: Always ensure that you are on the latest code with all recommended patches applied. This will help avoid known issues, prevent potential data corruption and provide the latest features and functionality. Having a proactive patching plan and periodic proactive patching process in place are the best ways to stay current.';
   l_sig.success_msg := 'All verified patches are applied.';
  ...
  -- Register
  l_step := '60';
  g_signatures('EBS_FIN_PA_PAPJB_BILL_RECOMMENDED_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'EBS_FIN_PA_PAPJB_BILL_RECOMMENDED_PATCHES',     -- sig ID
...
FUNCTION get_ORG_ID
   return VARCHAR2 IS
BEGIN
debug('begin sql token function: ORG_ID');
BEGIN
...
EXCEPTION WHEN NO_DATA_FOUND THEN
       return null;
END;
debug('end sql token function: ORG_ID');
END get_ORG_ID;
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Project ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_project_id,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Draft Invoice Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_draft_invoice_num,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Draft Revenue Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_draft_revenue_num,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Expenditure Item ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_expenditure_item_id,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Event ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_event_id,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/02/25 21:48:03 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'pa_pjb_analyzer.sql';
...
debug('begin parameter validation: p_project_id');
IF p_project_id IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Project ID is required.');
...
WHERE P.PROJECT_ID = p_project_id
 AND (mo_global.is_mo_init_done = 'N' OR mo_global.check_access(p.org_id) = 'Y')
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Project Number / ID
The Project Number / ID parameter is mandatory. Please enter a valid one.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_project_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_project_id');

debug('begin parameter validation: p_draft_invoice_num');
IF p_draft_invoice_num IS NOT NULL THEN
BEGIN
SELECT DRAFT_INVOICE_NUM
INTO l_exists_val
FROM PA_DRAFT_INVOICES_ALL INV
WHERE DRAFT_INVOICE_NUM = p_draft_invoice_num
 AND inv.project_id = p_project_id
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Please pass a valid Draft Invoice number');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_draft_invoice_num failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_draft_invoice_num');

debug('begin parameter validation: p_draft_revenue_num');
IF p_draft_revenue_num IS NOT NULL THEN
BEGIN
SELECT DRAFT_REVENUE_NUM
INTO l_exists_val
FROM PA_DRAFT_REVENUES_ALL REV
WHERE DRAFT_REVENUE_NUM = p_draft_revenue_num
 AND rev.project_id = p_project_id
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Please enter a valid Draft Revenue Number');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_draft_revenue_num failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_draft_revenue_num');

debug('begin parameter validation: p_expenditure_item_id');
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Please enter a valid Expenditure Item ID');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_expenditure_item_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_expenditure_item_id');

debug('begin parameter validation: p_event_id');
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: This event ID is not valid for the specified project.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_event_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_event_id');
...
/* Cross Charge Validation for section output BEGIN */
BEGIN
SELECT pt.cc_prvdr_flag INTO l_cc_prvdr_flag
...
END;
-- Cross Charge Validation for section output
g_cc_prvdr_flag := upper(l_cc_prvdr_flag);
/* Cross Charge Validation for section output END*/
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$PROJECT_ID$$##') := p_project_id;
   g_masked_tokens('##$$PROJECT_ID$$##') := mask_text( g_sql_tokens('##$$PROJECT_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$DINV_NUM$$##') := nvl(to_char(p_draft_invoice_num), 'null');
   g_masked_tokens('##$$DINV_NUM$$##') := mask_text( g_sql_tokens('##$$DINV_NUM$$##'), 'NO_MASK');
   g_sql_tokens('##$$DREV_NUM$$##') := nvl(to_char(p_draft_revenue_num),'null');
   g_masked_tokens('##$$DREV_NUM$$##') := mask_text( g_sql_tokens('##$$DREV_NUM$$##'), 'NO_MASK');
   g_sql_tokens('##$$P_EXPENDITURE_ITEM_ID$$##') := nvl(to_char(p_expenditure_item_id),'null');
   g_masked_tokens('##$$P_EXPENDITURE_ITEM_ID$$##') := mask_text( g_sql_tokens('##$$P_EXPENDITURE_ITEM_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM1$$##') := '275';
   g_masked_tokens('##$$APPS_PARAM1$$##') := mask_text( g_sql_tokens('##$$APPS_PARAM1$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM2$$##') := '222';
   ...
   g_sql_tokens('##$$EI_ID$$##') := nvl(to_char(p_expenditure_item_id),'null');
   g_masked_tokens('##$$EI_ID$$##') := mask_text( g_sql_tokens('##$$EI_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$REL$$##') := g_rep_info('Apps Version');
   g_masked_tokens('##$$REL$$##') := mask_text( g_sql_tokens('##$$REL$$##'), 'NO_MASK');
   g_sql_tokens('##$$ORG_ID$$##') := get_ORG_ID();
   l_system_function_var := null;
   g_masked_tokens('##$$ORG_ID$$##') := mask_text( g_sql_tokens('##$$ORG_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$EVENT_ID$$##') := nvl(to_char(p_event_id),'null');
   g_masked_tokens('##$$EVENT_ID$$##') := mask_text( g_sql_tokens('##$$EVENT_ID$$##'), 'NO_MASK');
...
debug('begin add_signature: EBS_FIN_PA_PA_FORMS_PERSONALIZATIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31164',
      p_sig_id                 => 'EBS_FIN_PA_PA_FORMS_PERSONALIZATIONS',
      p_sig_sql                => 'select rules.form_name||''.fmb'' "Form Name",
form2.USER_FORM_NAME "User Form Name",
rules.function_name "Function Name",
func2.USER_FUNCTION_NAME "User Function Name",
rules.sequence "Sequence",
rules.description "Description",
decode(rules.rule_type, ''A'', ''Function'', ''F'', ''Form'', rules.rule_type) "Rule Type Name",
rules.rule_type "Rule Type",
decode(rules.enabled,''N'',''Not Enabled'', ''Y'', ''Enabled'', rules.enabled) "Personalization Enabled",
rules.trigger_event "Trigger",
rules.condition "Condition",
actions.sequence "Action Seq",
decode(actions.action_type, ''P'', ''Property'', ''M'', ''Message'', ''B'', ''Builtin'', ''S'', ''Menu'', actions.action_type) "Action Type Name",
actions.action_type "Action Type",
actions.enabled "Action Enabled",
decode( actions.action_type, ''P'', actions.object_type, ''N/A'') "Object Type",
decode( actions.action_type, ''P'', actions.target_object, ''N/A'') "Target Object",
decode( actions.action_type, ''M'', actions.message_text, ''N/A'') "Message Text",
decode( actions.action_type, ''B'', decode(actions.builtin_type, ''C'', ''Launch SRS Form'', ''E'', ''Launch a Function'', ''U'', ''Launch a URL'', ''D'', ''DO_KEY'', ''P'', ''Execute Procedure'', ''G'', ''GO_ITEM'', ''B'', ''GO_BLOCK'', ''F'', ''FORMS_DDL'', ''R'', ''Raise FORM_TRIGGER_FAILURE'', ''T'', ''Execute Trigger'', ''S'', ''Syncrhonize'', ''L'', ''Call Custom Library'', ''Q'', ''Create Record Group From Query'', ''X'', ''Set Profile Value in Cache'', actions.builtin_type), ''N/A'') "Builtin Type Name",
decode( actions.action_type, ''B'', actions.builtin_type, ''N/A'') "Builtin Type",
decode( actions.action_type, ''B'', actions.builtin_arguments, ''N/A'') "Builtin Arguments"
from fnd_form_custom_actions actions, fnd_form_custom_rules rules, FND_FORM form1, FND_FORM_TL form2, FND_FORM_FUNCTIONS func1, FND_FORM_FUNCTIONS_TL func2
where actions.rule_id=rules.id
and func1.application_id  in (##$$APPS_PARAM1$$##,##$$APPS_PARAM2$$##,##$$APPS_PARAM3$$##,##$$APPS_PARAM4$$##,##$$APPS_PARAM5$$##)
and func1.function_name = rules.function_name
and func1.function_id = func2.function_id
and form1.form_name = rules.form_name
and form1.form_id = form2.form_id
and (actions.enabled = ''Y'' and rules.enabled = ''Y'')
order by rules.form_name, rules.sequence, actions.sequence',
      p_title                  => 'Forms Personalization',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Checking if forms personalizations exist and are enabled. When personalizations are enabled, a warning is raised.',
      p_solution               => 'If you have issues related to the form function and results, suggest that you confirm if the issue remains with Forms Personalizations disabled. Steps to test with personalizations disabled follow. 
<ol>
<li>Open the related form</li>
<li>Choose Help/Diagnostics/Custom - Core Code Only</li>
<li>Choose OK to the warning message</li>
<li>Close the form</li>
<li>Open the form</li>
<li>Again test and confirm - is the same issue occurring?</li></p>
</ol>
If the issue is not occurring after performing above action plan, then it seems a personalization is the cause of the problem. Refer to [2381259/KB211818] for more details.',
      p_success_msg            => 'No forms personalizations detected on the related application''s forms. ',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_FORMS_PERSONALIZATIONS');



debug('begin add_signature: EBS_FIN_PA_2270694_1_DATAFIX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25152',
      p_sig_id                 => 'EBS_FIN_PA_2270694_1_DATAFIX',
      p_sig_sql                => 'select adjusted_expenditure_item_id, count (*)
from pa_expenditure_items_all
where project_id = ##$$PROJECT_ID$$##
and ADJUSTED_EXPENDITURE_ITEM_ID is not NULL
group by adjusted_expenditure_item_id
having count(*) <> 1',
      p_title                  => 'Expenditure Item Transferred/Split Resulting In Creation Of Two Expenditure Items',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'An expenditure item is transferred/split from two different sessions at the same time resulting in two expenditure items being created.',
      p_solution               => 'Follow the instructions in [2270694/KB615513] - PAIGEN: PRC: Generate Draft Invoices for a Single Project Errors with cursor=502 code=-1427: ORA-01427: single-row subquery returns more than one row',
      p_success_msg            => 'No corruption of this kind is encountered.',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_2270694_1_DATAFIX');



debug('begin add_signature: EBS_FIN_PA_2270694_1_CODEFIX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25153',
      p_sig_id                 => 'EBS_FIN_PA_2270694_1_CODEFIX',
...
((''12.1'' = substr(''##$$REL$$##'',1,4) AND
            Fnd_Irep_Loader_Private.Compare_Versions(
              Adfv.Version,''120.45.12010000.42'') = ''<''
             And Adf.Filename = ''PAXEIADJ.pll'' 
             And Adfv.Version in (
  select "Current Version" from (
        select afv1.version "Current Version", rank()over(partition by af1.filename order by afv1.version_segment1 desc,
                          afv1.version_segment2 desc, afv1.version_segment3 desc, afv1.version_segment4 desc, afv1.version_segment5 desc, afv1.version_segment6 desc, afv1.version_segment7 desc,
                           afv1.version_segment8 desc, afv1.version_segment9 desc, afv1.version_segment10 desc, afv1.translation_level desc) as rankUS
          from ad_files af1, ad_file_versions afv1
        where af1.file_id = afv1.file_id
        and af1.filename in (''PAXEIADJ.pll'')
         )
         where rankUS = 1))
    OR
   (''12.1'' = substr(''##$$REL$$##'',1,4) AND
            Fnd_Irep_Loader_Private.Compare_Versions(
              Adfv.Version,''120.133.12010000.125'') = ''<''
             And Adf.Filename = ''PAXTRAPE.fmb'' 
             And Adfv.Version in (
  select "Current Version" from (
        select afv1.version "Current Version", rank()over(partition by af1.filename order by afv1.version_segment1 desc,
                          afv1.version_segment2 desc, afv1.version_segment3 desc, afv1.version_segment4 desc, afv1.version_segment5 desc, afv1.version_segment6 desc, afv1.version_segment7 desc,
          ...
          from ad_files af1, ad_file_versions afv1
        where af1.file_id = afv1.file_id
        and af1.filename in (''PAXTRAPE.fmb'')
         )
         where rankUS = 1)) 
         OR
           (''12.2'' = substr(''##$$REL$$##'',1,4) AND
            Fnd_Irep_Loader_Private.Compare_Versions(
              Adfv.Version,''120.183.12020000.64'') = ''<'' 
             And Adf.Filename = ''PAXTRAPE.fmb''
             And Adfv.Version in (
  select "Current Version" from (
        select afv1.version "Current Version", rank()over(partition by af1.filename order by afv1.version_segment1 desc,
    ...
    OR
           (''12.2'' = substr(''##$$REL$$##'',1,4) AND
            Fnd_Irep_Loader_Private.Compare_Versions(
              Adfv.Version,''120.66.12020000.31'') = ''<'' 
             And Adf.Filename = ''PAXEIADJ.pll''
             And Adfv.Version in (
  select "Current Version" from (
        select afv1.version "Current Version", rank()over(partition by af1.filename order by afv1.version_segment1 desc,
    ...
    OR    
           (''12.2'' = substr(''##$$REL$$##'',1,4) AND
            Fnd_Irep_Loader_Private.Compare_Versions(
              Adfv.Version,''120.26.12020000.11'') = ''<'' 
             And Adf.Filename = ''PATXMASR.rdf''
             And Adfv.Version in (
  select "Current Version" from (
        select afv1.version "Current Version", rank()over(partition by af1.filename order by afv1.version_segment1 desc,
                          afv1.version_segment2 desc, afv1.version_segment3 desc, afv1.version_segment4 desc, afv1.version_segment5 desc, afv1.version_segment6 desc, afv1.version_segment7 desc,
          ...
          from ad_files af1, ad_file_versions afv1
        where af1.file_id = afv1.file_id
        and af1.filename in (''PATXMASR.rdf'')
         )
         where rankUS = 1))
)',
      p_title                  => 'PRC: Generate Draft Invoices for a Single Project Errors with cursor=502 code=-1427',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'When the same expenditure item is transferred/split from two different sessions at the same time, two new expenditure items are created causing PRC: Generate Draft Invoices to fail. ',
      p_solution               => 'Follow the solution in [2270694/KB615513] - PAIGEN: PRC: Generate Draft Invoices for a Single Project Errors with cursor=502 code=-1427: ORA-01427: single-row subquery returns more than one row',
      p_success_msg            => 'Have code level fix per [2270694/KB615513] - PAIGEN: PRC: Generate Draft Invoices for a Single Project Errors with cursor=502 code=-1427: ORA-01427: single-row subquery returns more than one row',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_2270694_1_CODEFIX');



debug('begin add_signature: PA_AR_DUPLICATE_INVOICE_NUMBER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14265',
      p_sig_id                 => 'PA_AR_DUPLICATE_INVOICE_NUMBER',
      p_sig_sql                => 'SELECT * FROM pa.pa_draft_invoices_all WHERE transfer_status_code = ''R'' AND transfer_rejection_reason = ''Duplicate invoice number'' AND org_id in (select org_id from pa_projects_all where project_id = ##$$PROJECT_ID$$## ) ',
      p_title                  => 'AR Duplicate Invoice Number',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invoices are rejected in Receivable interface with error "Duplicate Invoice Number".
',
      p_solution               => 'Follow instructions in [2193265/KB256178] RAXTRX: Project Invoices Rejected During AutoInvoice Import with Duplicate Invoice Number',
      p_success_msg            => 'This kind of corruption is not found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_AR_DUPLICATE_INVOICE_NUMBER');



debug('begin add_signature: INCORRECT_UBR_UER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14312',
      p_sig_id                 => 'INCORRECT_UBR_UER',
      p_sig_sql                => 'SELECT a.segment1 FROM pa_projects_all a,
(SELECT project_id FROM PA_UBR_UER_SUMM_ACCT summ
WHERE ubr_uer_code = ''UBR''
AND summ.unbilled_receivable_dr <>
(Nvl((SELECT Sum(di.unbilled_receivable_dr) FROM pa_draft_invoices_all di
WHERE di.ubr_summary_id = summ.ubr_uer_summary_id),0) +
Nvl((SELECT Sum(dr.unbilled_receivable_dr) FROM pa_draft_revenues_all dr
WHERE dr.ubr_summary_id = summ.ubr_uer_summary_id),0))
UNION
SELECT project_id FROM PA_UBR_UER_SUMM_ACCT summ
WHERE ubr_uer_code = ''UER''
AND summ.unearned_revenue_cr <>
(Nvl((SELECT Sum(di.unearned_revenue_cr) FROM pa_draft_invoices_all di WHERE
di.uer_summary_id = summ.ubr_uer_summary_id),0) +
Nvl((SELECT Sum(dr.unearned_revenue_cr) FROM pa_draft_revenues_all dr WHERE
dr.uer_summary_id = summ.ubr_uer_summary_id),0))) b
WHERE a.project_id = b.project_id AND  a.project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Incorrect Unearned Revenue or Unbilled Receivable',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This Project has incorrect Unearned Revenue or Unbilled Receivable balance.',
      p_solution               => 'Log a Service Request for Oracle Support to get datafix as per [1683814/KB353036].',
      p_success_msg            => 'This kind of corruption is not found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: INCORRECT_UBR_UER');



debug('begin add_signature: PA_BILL_INVALID_RA_INVOICE_NUMBER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9767',
      p_sig_id                 => 'PA_BILL_INVALID_RA_INVOICE_NUMBER',
      p_sig_sql                => 'SELECT project_id, draft_invoice_num, org_id 
FROM pa_draft_invoices_all 
where project_id = ##$$PROJECT_ID$$##
and draft_invoice_num = NVL(##$$DINV_NUM$$##,draft_invoice_num)
and ra_invoice_number = ''-1'' ',
      p_title                  => 'RA_INVOICE_NUMBER Is -1',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invoice numbering is in PA automatic but invoice was created with invoice number as -1 and interfaced to AR and accounted.',
      p_solution               => 'Follow the instructions in [1578232/KB382018] RAXTRX Two Interface Lines Stuck In RA_INTERFACE_LINE_ALL Where RA_INVOICE_NUMBER Has -1 ',
      p_success_msg            => 'No corruption of this kind is encountered.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: PA_BILL_INVALID_RA_INVOICE_NUMBER');



debug('begin add_signature: PA_BILL_MISMATCH_INV_FUNDING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22174',
      p_sig_id                 => 'PA_BILL_MISMATCH_INV_FUNDING',
      p_sig_sql                => 'SELECT spf.agreement_id,spf.task_id,spf.project_id,spf.project_billed_amount,spf.projfunc_billed_amount,spf.invproc_billed_amount,spf.total_billed_amount,dd.dii_project_amount,
       dd.dii_projfunc_amount, dd.dii_amount,dd.dii_funding_amount
    FROM   
     pa_summary_project_fundings spf,
           (SELECT di.project_id,
                   di.agreement_id,
                   dii.task_id ,
                   sum(dii.amount) dii_amount,
                   dii.invproc_currency_code,
                   sum(dii.projfunc_bill_amount) dii_projfunc_amount,
                   dii.projfunc_currency_code,
                   sum(dii.project_bill_amount) dii_project_amount,
                   dii.project_currency_code,
                   sum(dii.funding_bill_amount) dii_funding_amount,
           ...
           GROUP BY di.project_id,
                    ...
                    dii.projfunc_currency_code,
                    dii.project_currency_code,
                    dii.funding_currency_code) dd
    WHERE  dd.project_id    = spf.project_id
    AND    Nvl(spf.task_id,-1)= Nvl(dd.task_id,-1)
    AND    spf.agreement_id = dd.agreement_id
    AND    spf.project_id IN (##$$PROJECT_ID$$##)
       AND    (  spf.project_billed_amount  <> dd.dii_project_amount
           OR spf.projfunc_billed_amount <> dd.dii_projfunc_amount
           OR spf.invproc_billed_amount  <> dd.dii_amount
           OR spf.total_billed_amount    <> dd.dii_funding_amount)
    AND    spf.total_baselined_amount > 0
         AND    EXISTS (
             SELECT 1
             FROM    pa_agreements_all paa
             WHERE   paa.agreement_id         = spf.agreement_id
             AND     dd.funding_currency_code = paa.agreement_currency_code)
     ORDER BY 1 ,2',
      p_title                  => 'Mismatch in Invoice Amount And Funding Summary Amount',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Total invoice amount is not matching with funding summary invoice amount.',
      p_solution               => 'Please log a service request along with analyzer output to get possible data fix as per [2380353/KB546021]',
      p_success_msg            => 'Total invoice amount is matching with funding summary invoice amount.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_BILL_MISMATCH_INV_FUNDING');



debug('begin add_signature: PA_BILL_MISMATCH_REV_FUNDING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22175',
      p_sig_id                 => 'PA_BILL_MISMATCH_REV_FUNDING',
      p_sig_sql                => 'SELECT *
    FROM   pa_summary_project_fundings spf,
           (SELECT  dr.project_id,
                    dr.agreement_id,
                    dri.task_id, 
                    sum(dri.amount) dri_amount,
                    dri.revproc_currency_code,
                    sum(dri.projfunc_revenue_amount) dri_projfunc_amount,
                    dri.projfunc_currency_code,
                    sum(dri.project_revenue_amount) dri_project_amount,
                    dri.project_currency_code,
                    sum(dri.funding_revenue_amount) dri_funding_amount,
                    dri.funding_currency_code
           ...
           GROUP BY dr.project_id,
                    ...
                    dri.projfunc_currency_code,
                    dri.project_currency_code,
                    dri.funding_currency_code) dd
    WHERE  dd.project_id    = spf.project_id
    AND    spf.agreement_id = dd.agreement_id
       AND    Nvl(spf.task_id,-1)= Nvl(dd.task_id,-1)
          AND    spf.project_id =   ##$$PROJECT_ID$$##
    AND    (  spf.total_accrued_amount    <> dd.dri_funding_amount
           OR spf.revproc_accrued_amount  <> dd.dri_amount
           OR spf.projfunc_accrued_amount <> dd.dri_projfunc_amount
           OR spf.project_accrued_amount  <> dd.dri_project_amount
           )
    AND    EXISTS (
             SELECT 1
             FROM    pa_agreements_all paa
             ...
             AND     dd.funding_currency_code = paa.agreement_currency_code)
',
      p_title                  => 'Mismatch in Revenue Amount And Funding Summary Amount',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Total revenue amount is not matching with funding summary invoice amount.',
      p_solution               => 'Please log a service request along with analyzer output to get possible data fix as per [2380353/KB546021]',
      p_success_msg            => 'Total revenue amount is matching with funding summary invoice amount.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_BILL_MISMATCH_REV_FUNDING');



debug('begin add_signature: PA_BILL_PARGDR_WITH_REVENUE_SOURCE_DUMMY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9750',
      p_sig_id                 => 'PA_BILL_PARGDR_WITH_REVENUE_SOURCE_DUMMY',
      p_sig_sql                => 'SELECT dr.DRAFT_REVENUE_NUM 
FROM pa_draft_revenue_items dri, pa_draft_revenues_all dr 
WHERE dri.revenue_source = ''Dummy'' AND dr.released_date IS NOT NULL 
    AND dr.project_id = dri.project_id AND dr.project_id = ##$$PROJECT_ID$$##
    AND dr.draft_revenue_num = dri.draft_revenue_num 
    AND NVL(generation_error_flag,''N'') <> ''Y''',
      p_title                  => 'Revenue Not Transferred to GL - Revenue Lines With Dummy Source',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transaction Exceptions Details has Revenue Exceptions with Exception Reason: Revenue Not Transferred to GL.
There are some draft revenues created with revenue source = ''Dummy'' for revenue lines with agreement_id =0.
These are not displayed in Revenue Review screen, and thus cannot be released from the application. They are therefore stuck in Projects.',
      p_solution               => 'Follow instructions in  [1518709/KB251312] PARGDR Creates Revenue With Source = Dummy And An Exception Reason: Revenue Not Transferred To GL Appears In The Transaction Exception Details Report Output',
      p_success_msg            => 'This kind of corruption was not found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_BILL_PARGDR_WITH_REVENUE_SOURCE_DUMMY');



debug('begin add_signature: PA_BILL_UNINVOICED_REV_DIST_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22176',
      p_sig_id                 => 'PA_BILL_UNINVOICED_REV_DIST_LINES',
      p_sig_sql                => 'SELECT
    rd.expenditure_item_id,
    rd.line_num,
    rd.line_num_reversed,
    rd.project_id,
    rd.draft_revenue_num,
    rd.draft_revenue_item_line_num,
    rd.draft_invoice_num,
    rd.draft_invoice_item_line_num,
    rd.amount
FROM
    pa_cust_rev_dist_lines_all rd
WHERE
        rd.project_id = ##$$PROJECT_ID$$## 
    AND rd.expenditure_item_id = nvl(##$$EI_ID$$## , rd.expenditure_item_id)
    AND rd.draft_invoice_num IS NULL
    AND EXISTS (
        SELECT
            1
        FROM
        ...
        WHERE
                rd.project_id = r.project_id
            AND rd.draft_revenue_num = r.draft_revenue_num
            AND r.generation_error_flag = ''N''
    )
    AND ( rd.line_num_reversed IS NULL
          OR EXISTS (
        SELECT
            NULL
        FROM
            pa_cust_rev_dist_lines_all rd2
        WHERE
                rd.project_id = rd2.project_id
            AND rd.expenditure_item_id = rd2.expenditure_item_id
            AND rd.line_num_reversed = rd2.line_num
            AND rd2.draft_invoice_num IS NULL
    ) )',
      p_title                  => 'Uninvoiced Revenue Distribution Lines',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invoice is not generated for revenue distribution lines',
      p_solution               => '',
      p_success_msg            => 'Invoice is generated for all revenue distribution lines for given parameter.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_BILL_UNINVOICED_REV_DIST_LINES');



debug('begin add_signature: PA_CREDITING_REVENUE_IS_NOT_POPULATED_WITH_CCID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14311',
      p_sig_id                 => 'PA_CREDITING_REVENUE_IS_NOT_POPULATED_WITH_CCID',
      p_sig_sql                => 'SELECT dr.unbilled_code_combination_id, dr.unearned_code_combination_id
FROM   pa_draft_revenues_all pdr, pa_draft_revenues_all dr
WHERE  pdr.project_id = dr.project_id AND dr.project_id = ##$$PROJECT_ID$$## 
    AND pdr.draft_revenue_num = dr.draft_revenue_num_credited 
AND (NVL(pdr.unbilled_code_combination_id,0) = 0 OR NVL(pdr.unearned_code_combination_id,0) = 0)
    AND EXISTS( SELECT 1 FROM xla_events xe
                WHERE xe.application_id = 275
                AND xe.event_id = dr.event_id
                AND xe.event_status_code <> ''P'')',
      p_title                  => 'Missing Accounting Details in Credit Revenue',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Data corruption found in PA_DRAFT_REVENUES_ALL table where code combination id (CCID) is updated to 0 and the same is updated in XLA table, resulting in the following error: <br><br>

ERROR<br>
-----------------------<br>
95318 THE ACCOUNT CODE COMBINATION ID 0 SPECIFIED FOR LINE 2 DOES NOT EXIST
',
      p_solution               => 'Follow instructions in [2493318/KB543201] PRC: Create Accounting program Returns Error 95318 For Revenue Adjustments "The account code combination id 0 specified for line does not exist.".',
      p_success_msg            => 'No data corruption found, in PA_DRAFT_REVENUES_ALL table, for crediting revenue.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_CREDITING_REVENUE_IS_NOT_POPULATED_WITH_CCID');



debug('begin add_signature: REVERSED_EI_WITH_NO_REVENUE_GENERATED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14241',
      p_sig_id                 => 'REVERSED_EI_WITH_NO_REVENUE_GENERATED',
      p_sig_sql                => 'select * 
from pa_expenditure_items_all ei 
where ei.project_id = ##$$PROJECT_ID$$##
   ...
   and 0 <> NVL((select sum(amount) from pa_cust_rev_dist_lines_all crdl1 
            where crdl1.expenditure_item_id = ei.adjusted_expenditure_item_id
                and crdl1.project_id = ##$$PROJECT_ID$$##),0)
',
      p_title                  => 'Reversed Expenditure Items With No Revenue Generated',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are reversed expenditure items for which revenue was not generated.',
      p_solution               => 'Log a Service Request for Oracle Support to get datafix as per [2089590/KB656635].',
      p_success_msg            => 'This kind of corruption is not found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: REVERSED_EI_WITH_NO_REVENUE_GENERATED');



debug('begin add_signature: EBS_FIN_PA_PAPJB_TASK_FUNDING_NOT_EQUAL_BUDGET_CHILD1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26634',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_TASK_FUNDING_NOT_EQUAL_BUDGET_CHILD1',
      p_sig_sql                => 'SELECT ppf.task_id, pt.task_name, sum(nvl(ppf.projfunc_allocated_amount,0)) funding_total
FROM pa_project_fundings ppf, pa_tasks pt
WHERE ppf.project_id = ##$$PROJECT_ID$$##
AND   ppf.budget_type_code in (''BASELINE'', ''DRAFT'')
AND   ppf.task_id is not null
AND   ppf.task_id = pt.task_id
AND   ppf.task_id = ##$$FK1$$##
GROUP BY ppf.task_id, pt.task_name
HAVING nvl(sum(nvl(ppf.projfunc_allocated_amount,0)),0) <> 0
ORDER BY ppf.task_id',
      p_title                  => 'Task Funding Is Not Equal To The Budget Total Of The Task - Funds',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This project has tasks where the funding is not equal to the budget total for the task. ',
      p_solution               => 'Use this query to compare funding versus budget as explained in [2968915/KB219666] PAXBUEBU Error When Baseline Task Level Budget: Task Budget Is Not Equal To The Total Funding Of The Task.',
      p_success_msg            => 'This project has tasks where the funding is equal to the budget total for the task. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_TASK_FUNDING_NOT_EQUAL_BUDGET_CHILD1');



debug('begin add_signature: EBS_FIN_PA_PAPJB_TASK_FUNDING_NOT_EQUAL_BUDGET_CHILD2');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26635',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_TASK_FUNDING_NOT_EQUAL_BUDGET_CHILD2',
      p_sig_sql                => 'SELECT t.top_task_id , t.task_name, sum(l.revenue) revenue
FROM pa_budget_lines l,
     pa_resource_assignments a,
     pa_tasks t,
     pa_budget_versions v
WHERE v.project_id = ##$$PROJECT_ID$$##
AND (v.budget_type_code = ''AR'' OR v.approved_rev_plan_type_flag =''Y'')
AND v.budget_status_code IN (''S'',''W'')
AND decode(v.budget_type_code,null,v.current_working_flag,''Y'')=''Y''
...
GROUP BY t.top_task_id, t.task_name
HAVING nvl(sum(l.revenue),0) <> 0
ORDER BY t.top_task_id',
      p_title                  => 'Task Funding Is Not Equal To The Budget Total Of The Task - Budget',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This project has tasks where the funding is not equal to the budget total for the task. ',
      p_solution               => 'Use this query to compare funding versus budget as explained in [2968915/KB219666] PAXBUEBU Error When Baseline Task Level Budget: Task Budget Is Not Equal To The Total Funding Of The Task.',
      p_success_msg            => 'This project has tasks where the funding is equal to the budget total for the task. ',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_TASK_FUNDING_NOT_EQUAL_BUDGET_CHILD2');



debug('begin add_signature: EBS_FIN_PA_PAPJB_TASK_FUNDING_NOT_EQUAL_BUDGET');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26545',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_TASK_FUNDING_NOT_EQUAL_BUDGET',
      p_sig_sql                => 'select task_id ,  sum(funding_total) diff , task_id "##$$FK1$$##"
from(
...
GROUP BY task_id
HAVING nvl(sum(nvl(projfunc_allocated_amount,0)),0) <> 0
union all
...
AND t.task_id = a.task_id
AND a.task_id is not null
AND exists (select task_id from pa_project_fundings ppf where ppf.project_id = a.project_id and task_id is not null)
AND l.resource_assignment_id = a.resource_assignment_id
GROUP BY t.top_task_id
HAVING nvl(sum(l.revenue),0) <> 0
)
GROUP by task_id
Having nvl(sum(funding_total),0) <> 0',
      p_title                  => 'Task Funding Does Not Match Budget Total For Task(s)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This project has tasks where the funding is not equal to the budget total for the task.',
      p_solution               => 'Please follow the solution in [2968915/KB219666] PAXBUEBU Error When Baseline Task Level Budget: Task Budget Is Not Equal To The Total Funding Of The Task.',
      p_success_msg            => 'This project contains no tasks where the funding does not equal the budget total.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('EBS_FIN_PA_PAPJB_TASK_FUNDING_NOT_EQUAL_BUDGET_CHILD1','EBS_FIN_PA_PAPJB_TASK_FUNDING_NOT_EQUAL_BUDGET_CHILD2'),
      p_include_in_dx_summary  => nvl('Y','N'),
      p_version                => '5'
      );
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_TASK_FUNDING_NOT_EQUAL_BUDGET');



debug('begin add_signature: EBS_FIN_PA_PAP2P_2962514_1_CODEFIX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26359',
      p_sig_id                 => 'EBS_FIN_PA_PAP2P_2962514_1_CODEFIX',
      p_sig_sql                => 'SELECT Adf.Filename, Adfv.Version
    FROM Ad_Files Adf, Ad_File_Versions Adfv
    Where Adf.File_Id = Adfv.File_Id
     and  
     ((''12.2'' = substr(''##$$REL$$##'',1,4) AND
            Fnd_Irep_Loader_Private.Compare_Versions(
              Adfv.Version,''120.9.12020000.15'') = ''<'' 
             And Adf.Filename = ''PAXARTRX.sql''
             And Adfv.Version in (
  select "Current Version" from (
        select afv1.version "Current Version", rank()over(partition by af1.filename order by afv1.version_segment1 desc,
                          afv1.version_segment2 desc, afv1.version_segment3 desc, afv1.version_segment4 desc, afv1.version_segment5 desc, afv1.version_segment6 desc, afv1.version_segment7 desc,
          ...
          from ad_files af1, ad_file_versions afv1
        where af1.file_id = afv1.file_id
        and af1.filename in (''PAXARTRX.sql'')
         )
         where rankUS = 1))
OR
           (''12.2'' = substr(''##$$REL$$##'',1,4) AND
            Fnd_Irep_Loader_Private.Compare_Versions(
              Adfv.Version,''120.12.12020000.34 '') = ''<'' 
             And Adf.Filename = ''PAXITCAB.pls''
             And Adfv.Version in (
  select "Current Version" from (
        select afv1.version "Current Version", rank()over(partition by af1.filename order by afv1.version_segment1 desc,
                          afv1.version_segment2 desc, afv1.version_segment3 desc, afv1.version_segment4 desc, afv1.version_segment5 desc, afv1.version_segment6 desc, afv1.version_segment7 desc,
          ...
          from ad_files af1, ad_file_versions afv1
        where af1.file_id = afv1.file_id
        and af1.filename in (''PAXITCAB.pls'')
         )
         where rankUS = 1)))',
      p_title                  => 'PAXARTRX IMP: Create Invoice Organization Transaction Types Errors',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found duplicated transaction type when process (PAXARTRX) is executed.
',
      p_solution               => 'Please follow the solution in [2962514/KB683910]  PAXARTRX: Cannot Interface Invoices to AR Due to Transaction Type Duplicated on RA_CUST_TRX_TYPES_ALL. <br>
<br>
NOTE: If Centralized Invoice Processing is enabled in your application then this message is not applicable for your case.',
      p_success_msg            => 'No duplicated transaction types found when process (PAXARTRX) is executed.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAP2P_2962514_1_CODEFIX');



debug('begin add_signature: EBS_FIN_PA_PAPJB_2962514_1_DATAFIX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26358',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_2962514_1_DATAFIX',
      p_sig_sql                => ' SELECT *
 FROM ra_cust_trx_types_all trx1
 WHERE EXISTS
 (SELECT *
 FROM ra_cust_trx_types_all trx2
 WHERE trx2.name = trx1.name
 AND trx2.org_id =trx1.org_id
 and trx2.ATTRIBUTE1 =trx1.ATTRIBUTE1
 AND trx2.CUST_TRX_TYPE_ID <> trx1.CUST_TRX_TYPE_ID
 and trx1.pa_organization_id =trx2.pa_organization_id
 and trx1.pa_organization_id is null)',
      p_title                  => 'Duplicate Transaction Types',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Duplicate transaction types exist.',
      p_solution               => 'Follow the instructions in [2962514/KB683910] PAXARTRX: Cannot Interface Invoices to AR Due to Transaction Type Duplicated on RA_CUST_TRX_TYPES_ALL',
      p_success_msg            => 'No corruption of this kind is encountered.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_2962514_1_DATAFIX');



debug('begin add_signature: EBS_FIN_PA_PAPJB_NULL_COMPLETION_DATE_IN_PA_EVENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26595',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_NULL_COMPLETION_DATE_IN_PA_EVENTS',
      p_sig_sql                => 'SELECT a.event_num,b.project_id,b.task_id,b.completion_date,a.draft_revenue_num
FROM pa_cust_event_rdl_all a, pa_events b, pa_projects_all d
WHERE a.project_id = b.project_id
AND nvl(a.task_id,-99) = nvl(b.task_id,-99)
AND a.event_num = b.event_num
AND a.project_id = d.project_id
AND b.project_id = ##$$PROJECT_ID$$##
AND ((b.completion_date IS null) OR
(b.completion_date IS NOT null AND b.completion_date >
                                        (SELECT MAX(ACCRUE_THROUGH_DATE)
                                        FROM  PA_DRAFT_REVENUES_ALL c
                                        WHERE  b.project_id = c.project_id)
))',
      p_title                  => 'Events With Null Or Incorrect Completion Date In PA_EVENTS',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This project has event(s) with a null or incorrect completion date.',
      p_solution               => 'Please follow the solution in [1963131/KB424817] PAXACMPT PRC: Update Project Summary Amounts or PAXACRPT PRC: Refresh Project Summary Amounts Completes With Error ORA-01400: CANNOT INSERT NULL INTO (PA.PA_TXN_ACCUM.MONTH_ENDING_DATE).',
      p_success_msg            => 'This project contains no event(s) where the completion date is null or incorrect.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_NULL_COMPLETION_DATE_IN_PA_EVENTS');



debug('begin add_signature: EBS_FIN_PA_PAPJB_SIGNAL11');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27503',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_SIGNAL11',
      p_sig_sql                => 'SELECT Adf.Filename, Adfv.Version
    FROM Ad_Files Adf, Ad_File_Versions Adfv
    Where  
    Adf.File_Id = Adfv.File_Id
     and  
    (((''12.2'' = substr(''##$$REL$$##'',1,4) AND 3 <= substr(''##$$REL$$##'',6,2) ) AND
            Fnd_Irep_Loader_Private.Compare_Versions(
              Adfv.Version,''120.30.12020000.33'') = ''<'' ))
    And Adf.App_Short_Name = ''FND''
    And Adf.filename = ''fdfkva.o''
    And Adfv.Version in (
    select  "Current Version" from (
          select  afv1.version "Current Version", rank()over(partition by af1.filename order by afv1.version_segment1 desc, 
                           afv1.version_segment2 desc, afv1.version_segment3 desc, afv1.version_segment4 desc, afv1.version_segment5 desc, afv1.version_segment6 desc, afv1.version_segment7 desc,
            ...
            from ad_files af1, ad_file_versions afv1
          where af1.file_id = afv1.file_id
          and af1.filename = ''fdfkva.o''
          ) 
          where rankUS = 1
     )
     ',
      p_title                  => 'PA Concurrent Requests End with Signal 11 Error ',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Old version of FND code level for file fdfkva.lc does not have code fix.',
      p_solution               => 'Please follow solution in [2987333/KB297305] After Applying Patch R12.ATG_PF.C.DELTA.11(33527666) and (CVR) Cross Validation Rule Fails During Auto Accounting, the Projects Concurrent Processes Complete With Signal 11 Error.',
      p_success_msg            => 'Have FND code fix for file fdfkva.lc per [2987333/KB297305] -After Applying Patch R12.ATG_PF.C.DELTA.11(33527666) Projects Concurrent Processes Complete With Signal 11 Error in Log File.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_SIGNAL11');



debug('begin add_signature: EBS_FIN_PA_PAPJB_INV_TRANSFER_REJECTION_REASON');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27659',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_INV_TRANSFER_REJECTION_REASON',
      p_sig_sql                => 'select count(draft_invoice_num) 
from PA_DRAFT_INVOICES_ALL 
where project_id = ##$$PROJECT_ID$$## 
and draft_invoice_num = ##$$DINV_NUM$$## 
and TRANSFER_REJECTION_REASON is not null ',
      p_title                  => 'Invoice with REJECTION_REASON',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This project has a rejected invoice.',
      p_solution               => 'There is no rejected invoice for this project.',
      p_success_msg            => 'This project has a rejected invoice.',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_INV_TRANSFER_REJECTION_REASON');



debug('begin add_signature: EBS_FIN_PA_PAPJB_PA_IC_INVOICE_MISSING_AP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28425',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_PA_IC_INVOICE_MISSING_AP',
      p_sig_sql                => 'SELECT * FROM pa_draft_invoices_all di
WHERE  ib_ap_transfer_status_code = ''A''
AND di.project_id = ##$$PROJECT_ID$$##
AND    NOT EXISTS(SELECT 1 FROM ap_invoices_interface api 
                   WHERE  api.invoice_num = di.ra_invoice_number
                   UNION
                   SELECT 1 FROM ap_invoices_all ap 
                   WHERE ap.invoice_num = di.ra_invoice_number)

',
      p_title                  => 'Intercompany Invoices for Project Deleted From Payables Open Interface',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Intercompany invoice record is deleted from Payables open interface.',
      p_solution               => 'Please log Service Request along with PA Revenue and Billing Analyzer output to get possible data fix based on [3009209/KB380771]',
      p_success_msg            => 'Intercompany invoices interfaced to Payables open interface.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_PA_IC_INVOICE_MISSING_AP');



debug('begin add_signature: EBS_FIN_PA_PAPJB_EXPENDITURES_NOT_COSTED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30483',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_EXPENDITURES_NOT_COSTED',
      p_sig_sql                => 'SELECT ei.*
from pa_expenditure_items_all ei, pa_projects_all pa
where ei.project_id = pa.project_id
and nvl(ei.billable_flag, ''N'') = ''Y''
and ei.project_id = ##$$PROJECT_ID$$##
and nvl(ei.cost_distributed_flag,''N'') = ''N''
and (upper(pa.distribution_rule) like upper(''%work%'') or upper(pa.distribution_rule) like upper(''%cost%''))',
      p_title                  => 'Expenditure Items Not Costed',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This project has expenditure items that are not costed.',
      p_solution               => 'Revenue can not be generated from uncosted expenditures.  Review the solution in:
Concurrent Process PARGDR:PRC:Generate Draft Revenue Showing the Exception: "The project does not have an eligible event or expenditure item"  [2328997/KB169028].',
      p_success_msg            => 'All expenditures in this project are costed.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_EXPENDITURES_NOT_COSTED');



debug('begin add_signature: EBS_FIN_PA_PAPJB_BILLABLE_IS_NOT_ENABLED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30484',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_BILLABLE_IS_NOT_ENABLED',
      p_sig_sql                => 'select ei.* from pa_expenditure_items_all ei , pa_projects_all pa
where ei.project_id = pa.project_id
and nvl(ei.billable_flag, ''N'') = ''N''
and ei.project_id = ##$$PROJECT_ID$$##
and (upper(pa.distribution_rule) like upper(''%work%'') or upper(pa.distribution_rule) like upper(''%cost%''))',
      p_title                  => 'Expenditures Are Not Billable',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This project has expenditures that are not billable.',
      p_solution               => 'Revenue will not be generated for expenditures that are are not billable.  Review the solution in [2328997/KB169028] Concurrent Process PARGDR:PRC:Generate Draft Revenue Showing the Exception: "The project does not have an eligible event or expenditure item".',
      p_success_msg            => 'All expenditures in this project are billable.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_BILLABLE_IS_NOT_ENABLED');



debug('begin add_signature: EBS_FIN_PA_PAPJB_INACTIVE_CUSTOMER_OR_ON_HOLD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30485',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_INACTIVE_CUSTOMER_OR_ON_HOLD',
      p_sig_sql                => 'select * from (
SELECT projcust.customer_id, cust.status customer_status, cpcust.credit_hold customer_on_hold,
projcust.bill_to_address_id, cpbill.credit_hold Bill_to_on_hold, addbill.status Bill_to_add_status,
projcust.ship_to_address_id, addship.status ship_to_add_status
FROM pa_projects_all pa
, HZ_CUST_ACCOUNTS cust
, pa_project_customers projcust
, hz_cust_acct_sites_all addbill
, hz_cust_acct_sites_all addship
, (select * from HZ_CUSTOMER_PROFILES where site_use_id is null )cpcust
, (select * from HZ_CUST_SITE_USES_ALL where upper(site_use_code) = ''BILL_TO'') cubill
, HZ_CUSTOMER_PROFILES cpbill
WHERE pa.project_id = projcust.project_id
and projcust.customer_id = cust.cust_account_id
and projcust.bill_to_address_id = addbill.cust_acct_site_id(+)
and projcust.ship_to_address_id = addship.cust_acct_site_id(+)
and pa.org_id = addbill.org_id(+)
and pa.org_id = addship.org_id(+)
and projcust.customer_id = cpcust.cust_account_id(+)
and projcust.bill_to_address_id = cubill.CUST_ACCT_SITE_ID(+)
and pa.org_id = cubill.org_id(+)
and cubill.SITE_USE_ID = cpbill.SITE_USE_ID(+)
and pa.project_id = ##$$PROJECT_ID$$##
) where nvl(customer_on_hold,''N'') = ''Y''
or nvl(Bill_to_on_hold,''N'') = ''Y''
or nvl(customer_status,''I'') = ''I''
or nvl(Bill_to_add_status,''I'') = ''I''
or nvl(ship_to_add_status,''I'') = ''I'' ',
      p_title                  => 'Inactive Customer/Site Or On Credit Hold',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This projects has customers/sites that are not active or on credit hold.',
      p_solution               => 'Revenue can not be generate if the  customer/site are not active or on credit hold.  Review the solution in [2328997/KB169028] Concurrent Process PARGDR:PRC:Generate Draft Revenue Showing the Exception: "The project does not have an eligible event or expenditure item".',
      p_success_msg            => 'The customers/sites on this project are active and not on hold.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_INACTIVE_CUSTOMER_OR_ON_HOLD');



debug('begin add_signature: EBS_FIN_PA_PAPJB_TASKS_ARE_NOT_READY_TO_ACCRUE_OR_BILL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30486',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_TASKS_ARE_NOT_READY_TO_ACCRUE_OR_BILL',
      p_sig_sql                => 'select * from pa_tasks t
where project_id = ##$$PROJECT_ID$$##
and t.task_id = t.top_task_id
and (nvl(t.ready_to_distribute_flag,''N'') = ''N'' or nvl(t.ready_to_bill_flag,''N'')=''N'')',
      p_title                  => 'Tasks Not Ready to Accrue or Bill',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This project has tasks that are not ready to accrue or bill.',
      p_solution               => 'Revenue can not be generated for tasks that are not ready to accrue or bill.  Review the solution in [2328997/KB169028] Concurrent Process PARGDR:PRC:Generate Draft Revenue Showing the Exception: "The project does not have an eligible event or expenditure item".',
      p_success_msg            => 'All top tasks are ready to accrue and bill for this project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_TASKS_ARE_NOT_READY_TO_ACCRUE_OR_BILL');



debug('begin add_signature: EBS_FIN_PA_PAPJB_SUB_JOURNAL_DIFF_SIGN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30539',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_SUB_JOURNAL_DIFF_SIGN',
      p_sig_sql                => 'SELECT PDR.PROJECT_ID, PDR.DRAFT_REVENUE_NUM,
PDR.UNBILLED_RECEIVABLE_DR, PDR.UNEARNED_REVENUE_CR,
PDR.REVTRANS_UBR_DR, PDR.REVTRANS_UER_CR
FROM PA_DRAFT_REVENUES_ALL PDR
WHERE PDR.EVENT_ID IN (SELECT EVENT_ID FROM XLA_EVENTS
WHERE EVENT_STATUS_CODE = ''U''
AND PROCESS_STATUS_CODE = ''I''
AND APPLICATION_ID = 275)
/* Negative line items that can be moved to new DR exists */
AND EXISTS (SELECT 1 FROM PA_DRAFT_REVENUE_ITEMS
WHERE PROJECT_ID = PDR.PROJECT_ID
AND DRAFT_REVENUE_NUM = PDR.DRAFT_REVENUE_NUM
AND AMOUNT < 0
HAVING SIGN(SUM(AMOUNT)) <> SIGN(SUM(REVTRANS_AMOUNT))
)
/* Entered (REVTRANS_AMOUNT) & Accounted (AMOUNT) amounts have different
sign */
AND EXISTS (SELECT 1 FROM PA_DRAFT_REVENUE_ITEMS
WHERE PROJECT_ID = PDR.PROJECT_ID
AND DRAFT_REVENUE_NUM = PDR.DRAFT_REVENUE_NUM
HAVING SIGN(SUM(AMOUNT)) <> SIGN(SUM(REVTRANS_AMOUNT))
      ...
      p_title                  => 'Create Accounting For Revenue With Subledger Journal Entry Line Have Different Sign',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Create Accounting for revenue errors due to subledger journal entry line having different sign.',
      p_solution               => 'Please review Create Accounting Program Includes Errors For Revenue With Subledger Journal Entry Line Have Different Sign [2108725/KB187270] and log a service request to obtain a data fix.',
      p_success_msg            => 'No Create Accounting for revenue errors due to subledger journal entry line having different sign.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_SUB_JOURNAL_DIFF_SIGN');



debug('begin add_signature: PA_BILL_IMPLEMENTATION_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22195',
      p_sig_id                 => 'PA_BILL_IMPLEMENTATION_OPTIONS',
      p_sig_sql                => 'SELECT led.name "Ledger",
       imp.interface_revenue_to_gl_flag "Interface Revenue to GL",
       imp.invoice_nz_lines "Invoice Net Zero Lines",
       imp.user_defined_invoice_num_code "Invoice Numbering Method",
       imp.manual_invoice_num_type "Type",
       imp.next_automatic_invoice_number "Next Number",
       imp.centralized_invoicing_flag "Centralized Invoice Processing",
       bat.name "Invoice Batch Source",
       imp.cust_acc_rel_code "Customer Relations",
       imp.centralized_invoicing_flag "Centralized Invoice Processing",
       imp.sales_credit_type_code "Sales Credit Type",
       imp.allow_foreign_curr_txn_flag "Enable Multi Currency Flag",
       imp.rate_discount_reason_flag "Require Rate/Discount Reason",
       imp.br_override_flag "Allow Bill Rate Override",
       imp.br_discount_override_flag "Allow Bill Rate Disc Override",
       imp.share_across_ou_br_sch_flag "Share Bill Rate Schedules",
       imp.allow_funding_across_ou_flag "Allow Funding Across OUs",
       imp.retn_accounting_flag "Account for Unbilled Retention",	
       imp.include_gains_losses_flag "Funding Revaluation",
       imp.credit_memo_reason_flag"Require Credit Memo Reason",
       imp.create_on_account_cm "Create On Account Credit Memo"
FROM pa_implementations_all imp,
     gl_ledgers led,
     ra_batch_sources_all bat
WHERE imp.org_id IN (SELECT org_id FROM pa_projects_all WHERE project_id =  ##$$PROJECT_ID$$##)
  AND led.ledger_id = imp.set_of_books_id
  AND bat.batch_source_id = imp.invoice_batch_source_id
  AND bat.org_id = imp.org_id',
      p_title                  => 'PA Implementation Options (PA_IMPLEMENTATIONS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Implementation Option is not setup for project.',
      p_solution               => '',
      p_success_msg            => 'PA_IMPLEMENTATIONS_ALL consists implementation details of project billing. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_BILL_IMPLEMENTATION_OPTIONS');



debug('begin add_signature: EBS_FIN_PA_PAPJB_AR_SYSTEM_PARAMS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25012',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_AR_SYSTEM_PARAMS',
      p_sig_sql                => 'SELECT ar.*  FROM   AR_SYSTEM_PARAMETERS_ALL ar where org_id in (select org_id from pa_projects_all where project_id = ##$$PROJECT_ID$$##)',
      p_title                  => 'AR System Parameters (AR_SYSTEM_PARAMETERS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'AR system parameters have not  been defined at the operating unit level.',
      p_solution               => '',
      p_success_msg            => 'AR system parameters have been defined at the operating unit level.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_AR_SYSTEM_PARAMS');



debug('begin add_signature: PA_PROJECT_BILLING_CYCLE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22172',
      p_sig_id                 => 'PA_PROJECT_BILLING_CYCLE',
      p_sig_sql                => 'SELECT
    proj.project_id,
    proj.segment1,
    c.billing_cycle_id,
    c.billing_cycle_name,
    c.billing_cycle_type,
    c.start_date_active,
    c.end_date_active,
    c.billing_attribute_category,
    c.billing_value1,
    c.billing_value2,
    c.billing_value3,
    c.billing_value4,
...
FROM
    ...
    pa_billing_cycles c
WHERE
        proj.billing_cycle_id = c.billing_cycle_id
    AND proj.project_id =  ##$$PROJECT_ID$$##',
      p_title                  => 'Project Billing Cycles (PA_BILLING_CYCLES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Billing cycle not assigned to the project.',
      p_solution               => '',
      p_success_msg            => 'Billing cycle assigned to the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PROJECT_BILLING_CYCLE');



debug('begin add_signature: EBS_FIN_PA_PAPJB_ALL_BILLING_CYCLES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31931',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_ALL_BILLING_CYCLES',
      p_sig_sql                => 'SELECT
    c.billing_cycle_id,
    c.billing_cycle_name,
    c.billing_cycle_type,
...
FROM
    pa_billing_cycles c
',
      p_title                  => 'All Billing Cycles (PA_BILLING_CYCLES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Billing cycles are defined.',
      p_solution               => '',
      p_success_msg            => 'Billing cycles are not defined.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_ALL_BILLING_CYCLES');



debug('begin add_signature: PROJECT_RATE_SCHEDULES');
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##LONG_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14244',
      p_sig_id                 => 'PROJECT_RATE_SCHEDULES',
      p_sig_sql                => 'SELECT pa.* , cost.ind_rate_sch_name "Cost_Burden_Schedule" , rev.ind_rate_sch_name "Revenue_Burden_Schedule" , rev.cost_plus_structure "Revenue_BS_Structure" , inv.ind_rate_sch_name "Invoice_Burden_Schedule" , inv.cost_plus_structure "Invoice_BS_Structure" , tps1.name "Labor_TP_Schedule" , tps2.name "NonLabor_TP_Schedule" , emp.std_bill_rate_schedule "Emp_Bill_Rate_Schedule" , emp.rate_sch_currency_code "Emp_Rate_Sched_Currency" , job.std_bill_rate_schedule "Job_Bill_Rate_Schedule" , job.rate_sch_currency_code "Job_Rate_Sched_Currency" , nl.rate_sch_currency_code "NonLabor_Rate_Sched_Currency" FROM PA_PROJECTS_ALL pa , PA_IND_RATE_SCHEDULES_ALL_BG cost , PA_IND_RATE_SCHEDULES_ALL_BG rev , PA_IND_RATE_SCHEDULES_ALL_BG inv , PA_CC_TP_SCHEDULES_BG tps1 , PA_CC_TP_SCHEDULES_BG tps2 , HR_ALL_ORGANIZATION_UNITS_VL org , PA_STD_BILL_RATE_SCHEDULES_ALL emp , PA_STD_BILL_RATE_SCHEDULES_ALL job , PA_STD_BILL_RATE_SCHEDULES_ALL nl WHERE org.organization_id (+) = pa.carrying_out_organization_id AND cost.ind_rate_sch_id (+) = pa.cost_ind_rate_sch_id AND inv.ind_rate_sch_id (+) = pa.inv_ind_rate_sch_id AND rev.ind_rate_sch_id (+) = pa.rev_ind_rate_sch_id AND tps1.tp_schedule_id (+) = pa.labor_tp_schedule_id AND tps2.tp_schedule_id (+) = pa.nl_tp_schedule_id AND emp.bill_rate_sch_id (+)  = pa.emp_bill_rate_schedule_id AND job.bill_rate_sch_id (+) = pa.job_bill_rate_schedule_id AND nl.bill_rate_sch_id (+) = pa.non_lab_std_bill_rt_sch_id AND pa.project_id =  ##$$PROJECT_ID$$## ',
      p_title                  => 'Project Rate Schedules',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no rate schedules defined for the project.',
      p_solution               => '',
      p_success_msg            => 'Rate schedules defined for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PROJECT_RATE_SCHEDULES');



debug('begin add_signature: TASK_RATE_SCHEDULES');
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14251',
      p_sig_id                 => 'TASK_RATE_SCHEDULES',
      p_sig_sql                => 'SELECT task.* , cost.ind_rate_sch_name "Cost_Burden_Schedule" , rev.ind_rate_sch_name "Revenue_Burden_Schedule" , rev.cost_plus_structure "Revenue_BS_Structure" , inv.ind_rate_sch_name "Invoice_Burden_Schedule" , inv.cost_plus_structure "Invoice_BS_Structure" , tps1.name "Labor_TP_Schedule" , tps2.name "NonLabor_TP_Schedule" , emp.std_bill_rate_schedule "Emp_Bill_Rate_Schedule" , emp.rate_sch_currency_code "Emp_Rate_Sched_Currency" , job.std_bill_rate_schedule "Job_Bill_Rate_Schedule" , job.rate_sch_currency_code "Job_Rate_Sched_Currency" , nl.rate_sch_currency_code "NonLabor_Rate_Sched_Currency" FROM PA_TASKS task , PA_IND_RATE_SCHEDULES_ALL_BG cost , PA_IND_RATE_SCHEDULES_ALL_BG rev , PA_IND_RATE_SCHEDULES_ALL_BG inv , PA_CC_TP_SCHEDULES_BG tps1 , PA_CC_TP_SCHEDULES_BG tps2 ,  HR_ALL_ORGANIZATION_UNITS_VL org , PA_STD_BILL_RATE_SCHEDULES_ALL emp , PA_STD_BILL_RATE_SCHEDULES_ALL job ,  PA_STD_BILL_RATE_SCHEDULES_ALL nl WHERE org.organization_id (+) = task.carrying_out_organization_id AND cost.ind_rate_sch_id (+)  = task.cost_ind_rate_sch_id AND inv.ind_rate_sch_id (+) = task.inv_ind_rate_sch_id AND rev.ind_rate_sch_id (+) = task.rev_ind_rate_sch_id AND tps1.tp_schedule_id (+) = task.labor_tp_schedule_id AND tps2.tp_schedule_id (+) = task.nl_tp_schedule_id AND emp.bill_rate_sch_id (+)  = task.emp_bill_rate_schedule_id AND job.bill_rate_sch_id (+) = task.job_bill_rate_schedule_id AND nl.bill_rate_sch_id (+) = task.non_lab_std_bill_rt_sch_id AND task.project_id = NVL( ##$$PROJECT_ID$$## , task.project_id) AND task.task_id = NVL( NULL , task.task_id) ORDER BY task.task_number ',
      p_title                  => 'Task Rate Schedules',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No task rate schedules defined for the project.',
      p_solution               => '',
      p_success_msg            => 'Task rate schedules defined for the project.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: TASK_RATE_SCHEDULES');



debug('begin add_signature: PA_EMP_BILL_OVERRIDES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22196',
      p_sig_id                 => 'PA_EMP_BILL_OVERRIDES',
      p_sig_sql                => 'SELECT *
    FROM   PA_EMP_BILL_RATE_OVERRIDES
    WHERE  project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'PA Employee Bill Overrides (PA_EMP_BILL_RATE_OVERRIDES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No employee bill rate overrides exist for the project.',
      p_solution               => '',
      p_success_msg            => 'Employee bill rate overrides defined for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_EMP_BILL_OVERRIDES');



debug('begin add_signature: PA_JOB_ASSIGNMENT_BILL_OVERRIDES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22198',
      p_sig_id                 => 'PA_JOB_ASSIGNMENT_BILL_OVERRIDES',
      p_sig_sql                => 'SELECT *
    FROM   PA_JOB_ASSIGNMENT_OVERRIDES
    WHERE  project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Job Assignment Bill Rate Overrides (PA_JOB_ASSIGNMENT_OVERRIDES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No job assignment bill rate overrides exist for the project.',
      p_solution               => '',
      p_success_msg            => 'Job assignment bill rate overrides exist for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_JOB_ASSIGNMENT_BILL_OVERRIDES');



debug('begin add_signature: EBS_FIN_PA_JOB_BILL_TITLE_OVERRIDES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25962',
      p_sig_id                 => 'EBS_FIN_PA_JOB_BILL_TITLE_OVERRIDES',
      p_sig_sql                => 'SELECT o.*  ,      j.name "Job"  FROM   PA_JOB_BILL_TITLE_OVERRIDES o,per_jobs j  WHERE  ( o.project_id = ##$$PROJECT_ID$$## OR o.task_id = null )   
and j.job_id (+) = o.job_id ',
      p_title                  => 'Job Billing Title Overrides (JOB_BILL_TITLE_OVERRIDES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No job billing title overrides exist for the project.',
      p_solution               => '',
      p_success_msg            => 'Job billing title overrides exist for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_JOB_BILL_TITLE_OVERRIDES');



debug('begin add_signature: PA_JOB_BILL_OVERRIDES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22197',
      p_sig_id                 => 'PA_JOB_BILL_OVERRIDES',
      p_sig_sql                => 'SELECT *
    FROM   PA_JOB_BILL_RATE_OVERRIDES
    WHERE  project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Job Bill Rate Overrides (PA_JOB_BILL_RATE_OVERRIDES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No job bill rate overrides exists for the project.',
      p_solution               => '',
      p_success_msg            => 'Job bill rate overrides exist for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_JOB_BILL_OVERRIDES');



debug('begin add_signature: PA_NONLABOR_BILL_OVERRIDES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22199',
      p_sig_id                 => 'PA_NONLABOR_BILL_OVERRIDES',
      p_sig_sql                => 'SELECT *
    FROM   PA_NL_BILL_RATE_OVERRIDES
    WHERE  project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Non-Labor Bill Rate Overrides (PA_NL_BILL_RATE_OVERRIDES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No non-labor bill rate overrides exists for the project.',
      p_solution               => '',
      p_success_msg            => 'Non-labor bill rate overrides defined for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_NONLABOR_BILL_OVERRIDES');



debug('begin add_signature: PA_FOUND_BUDGET_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12099',
      p_sig_id                 => 'PA_FOUND_BUDGET_TYPES',
      p_sig_sql                => 'SELECT pbt.budget_type_code, pbt.last_update_date, pbt.creation_date, pbt.budget_type, pbt.start_date_active, pbt.budget_amount_code,
pbt.predefined_flag, pbt.accumulation_flag, pbt.end_date_active, pbt.description, pbt.enable_wf_flag, pbt.adw_notify_flag, pbt.plan_type,
pbt.upgrade_budget_type_flag
FROM
    pa_budget_types pbt
WHERE
    budget_type_code IN (
      ...
      p_title                  => 'Budget Types (PA_BUDGET_TYPES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No budget types found for the selected project.',
      p_solution               => '',
      p_success_msg            => 'Budget types found for the selected project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_FOUND_BUDGET_TYPES');



debug('begin add_signature: EBS_FIN_PA_PAPJB_EVENT_TYPE_DETAIL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29611',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_EVENT_TYPE_DETAIL',
...
FROM
    ...
    pa_events      e
WHERE
        e.event_type = et.event_type
    AND e.project_id = ##$$PROJECT_ID$$##  ',
      p_title                  => 'Event Type Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no events associated with the project, so there are no corresponding event types',
      p_solution               => '',
      p_success_msg            => 'Below are the event types corresponding to the events associated with the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_EVENT_TYPE_DETAIL');



debug('begin add_signature: PA_PROGRESS_ROLLUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20974',
      p_sig_id                 => 'PA_PROGRESS_ROLLUP',
      p_sig_sql                => 'SELECT progrollup.*
FROM PA_PROGRESS_ROLLUP progrollup
WHERE progrollup.project_id =  ##$$PROJECT_ID$$##',
      p_title                  => 'Project Progress Rollup Details  (PA_PROGRESS_ROLLUP)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Progress rollup detail  not exists for this project.',
      p_solution               => '',
      p_success_msg            => 'Progress rollup detail for the Project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PROGRESS_ROLLUP');



debug('begin add_signature: PA_P2P_PROJECTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12393',
      p_sig_id                 => 'PA_P2P_PROJECTS',
      p_sig_sql                => 'SELECT *
FROM pa_projects_all
WHERE project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Project Information (PA_PROJECTS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No project details for the selected project.',
      p_solution               => '',
      p_success_msg            => 'Project details found for the selected project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_PROJECTS');



debug('begin add_signature: PA_P2P_TASKS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11799',
      p_sig_id                 => 'PA_P2P_TASKS',
      p_sig_sql                => 'SELECT *
FROM pa_tasks
WHERE project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Task Details (PA_TASKS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No task details found for the project.',
      p_solution               => '',
      p_success_msg            => 'Task details for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_TASKS');



debug('begin add_signature: PA_P2P_PROJECT_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11798',
      p_sig_id                 => 'PA_P2P_PROJECT_TYPES',
      p_sig_sql                => 'SELECT *
FROM pa_project_types_all
WHERE project_type IN (
        SELECT project_type FROM pa_projects_all
        WHERE project_id = ##$$PROJECT_ID$$##)
and org_id = ##$$ORG_ID$$##',
      p_title                  => 'Project Type Details (PA_PROJECT_TYPES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No project type found for the selected project.',
      p_solution               => '',
      p_success_msg            => 'Project type details for the selected project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_PROJECT_TYPES');



debug('begin add_signature: EBS_FIN_PA_PAPJB_PROJ_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30962',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_PROJ_STATUS',
      p_sig_sql                => 'select * from pa_project_status_controls where project_status_code in (select PROJECT_STATUS_CODE from pa_projects_All where project_id = ##$$PROJECT_ID$$##) order by sort_order',
      p_title                  => 'Project Status With Assigned Actions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Project statuses with assigned actions for this project do not exist.',
      p_solution               => '',
      p_success_msg            => 'Project statuses with assigned actions for this project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_PROJ_STATUS');



debug('begin add_signature: PA_PROJECT_KEY_MEMBERS_ROLES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12175',
      p_sig_id                 => 'PA_PROJECT_KEY_MEMBERS_ROLES',
      p_sig_sql                => 'SELECT
    rt.meaning    "Role Type",
    km.project_role_type, km.project_id, km.start_date_active, km.end_date_active
FROM
    pa_project_players km,
    pa_project_role_types rt
WHERE
    km.project_id = ##$$PROJECT_ID$$##
    AND rt.project_role_type (+) = km.project_role_type',
      p_title                  => 'Project Key Members and Roles Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The project is having key members defined.',
      p_solution               => '',
      p_success_msg            => 'The project is  not having key members defined.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PROJECT_KEY_MEMBERS_ROLES');



debug('begin add_signature: PA_PROJECT_CUSTOMERS');
   l_info('##MASK##BILL-TO ADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PARTY_NAME'):= 'DISPLAY_FIRST_25_PCNT_WORD';
   l_info('##MASK##SHIP-TO ADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12105',
      p_sig_id                 => 'PA_PROJECT_CUSTOMERS',
      p_sig_sql                => 'SELECT
    projcust.*,
    party.party_name,--regexp_replace(party.party_name, ''[a-z]'', ''*'', 2) "Customer|Name",
    party.party_number     "Customer|Number",
    cust.cust_account_id   "Customer Id",
    cust.status            "Status",
    bill.concatenated_address   "Bill-To Address", --regexp_replace(bill.concatenated_address, ''[a-z]'', ''*'', 2) "Bill-To Address",
    ship.concatenated_address  "Ship-To Address", --regexp_replace(ship.concatenated_address, ''[a-z]'', ''*'', 2) "Ship-To Address",
    rp.segment1 "Receiver|Project", --regexp_replace(rp.segment1, ''[a-z]'', ''*'', 2) "Receiver|Project",
    pt.task_number         "Receiver|Task"
FROM
    pa_project_customers   projcust,
    hz_cust_accounts       cust,
    hz_parties             party,
    ...
    pa_tasks               pt
WHERE
    projcust.project_id =  ##$$PROJECT_ID$$##
    AND projcust.customer_id = cust.cust_account_id
    AND party.party_id = cust.party_id
    AND projcust.bill_to_address_id = bill.address_id (+)
    AND projcust.ship_to_address_id = ship.address_id (+)
    AND projcust.project_id = rp.project_id
    AND projcust.receiver_task_id = pt.task_id (+)',
      p_title                  => 'Project Customers (PA_PROJECT_CUSTOMERS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No customer details found for the selected project.',
      p_solution               => '',
      p_success_msg            => 'Customer details found for the selected project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PROJECT_CUSTOMERS');



debug('begin add_signature: PA_FOUND_PROJECT_CONTACTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12106',
      p_sig_id                 => 'PA_FOUND_PROJECT_CONTACTS',
      p_sig_sql                => ' SELECT
    pcont.*,
   regexp_replace(rcont.last_name, ''[a-z]'', ''*'', 2) 
    || '', ''
    || regexp_replace(rcont.first_name, ''[a-z]'', ''*'', 2) "Contact|Name",
   regexp_replace(rcont.job_title, ''[a-z]'', ''*'', 2)  "Job|Title"
FROM
    pa_project_contacts pcont,
    ar_contacts_v rcont
WHERE
    rcont.customer_id = pcont.customer_id
    AND   rcont.contact_id = pcont.contact_id
    AND   pcont.project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Project Contacts (PA_PROJECT_CONTACTS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No contacts found for the selected project.',
      p_solution               => '',
      p_success_msg            => 'Project contact details for the selected project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_FOUND_PROJECT_CONTACTS');



debug('begin add_signature: PA_PROJECT_CUSTOMER_PROFILES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22200',
      p_sig_id                 => 'PA_PROJECT_CUSTOMER_PROFILES',
      p_sig_sql                => 'select cp.cust_account_profile_id,
       cp.cust_account_id,
       cp.status,
       cp.credit_checking,
       cp.credit_hold,
       cp.site_use_id, csu.CUST_ACCT_SITE_ID address_id, csu.site_use_code, csu.primary_flag, csu.status
    from HZ_CUSTOMER_PROFILES CP, HZ_CUST_SITE_USES_ALL csu
    where cp.SITE_USE_ID = csu.SITE_USE_ID(+)
    and  cp.cust_account_id IN (SELECT customer_id FROM pa_project_customers WHERE project_id = ##$$PROJECT_ID$$##)
    order by cp.credit_hold desc, csu.primary_flag desc, csu.status desc',
      p_title                  => 'Project Customer Profiles (HZ_CUSTOMER_PROFILES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No customer profile exists for project.',
      p_solution               => '',
      p_success_msg            => 'HZ_CUSTOMER_PROFILES consists customer profile related data.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PROJECT_CUSTOMER_PROFILES');



debug('begin add_signature: PA_AGREEMENTS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14261',
      p_sig_id                 => 'PA_AGREEMENTS_ALL',
      p_sig_sql                => 'SELECT distinct
    agree.*,
    party.party_id     "Party Id",
    party.party_number "Customer_Number" 
FROM
    pa_agreements_all agree,
    hz_cust_accounts  cust,
    hz_parties        party 
WHERE
    agree.customer_id = cust.cust_account_id
    AND party.party_id = cust.party_id
    AND agree.agreement_id IN (
        SELECT
            agreement_id
        FROM
            pa_project_fundings
      ...
      p_title                  => 'Project Agreements (PA_AGREEMENTS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no agreement defined for the project selected.',
      p_solution               => '',
      p_success_msg            => 'PA_AGREEMENTS_ALL stores information about legally binding documents from customers that serve as the basis of work authorization for projects.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_AGREEMENTS_ALL');



debug('begin add_signature: EBS_FIN_PA_PAPJB_INV_TRANSFER_REJ_REASON');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26673',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_INV_TRANSFER_REJ_REASON',
      p_sig_sql                => 'select * from pa_draft_invoices_all where project_id = ##$$PROJECT_ID$$##
and transfer_rejection_reason is not null
order by draft_invoice_num',
      p_title                  => 'Invoices With Transfer Rejection Reason',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invoices exist for the project with a transfer rejection reason in PA_DRAFT_INVOICES_ALL.',
      p_solution               => '',
      p_success_msg            => 'No invoices exist for the project with a transfer rejection reason in PA_DRAFT_INVOICES_ALL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_INV_TRANSFER_REJ_REASON');



debug('begin add_signature: EBS_FIN_PA_PAPJB_REVENUE_BUDGET_LINES');
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_FIRST_4_CHAR';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26130',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_REVENUE_BUDGET_LINES',
      p_sig_sql                => 'select *
from pa_budget_lines where budget_version_id IN (select budget_version_id
from pa_budget_versions 
where project_id = ##$$PROJECT_ID$$## 
    and version_type <> ''COST'')
order by budget_version_id asc, budget_line_id asc',
      p_title                  => 'Projects Revenue Budget Lines (PA_BUDGET_LINES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No revenue budget lines exist for the project.',
      p_solution               => '',
      p_success_msg            => 'Revenue budget lines exist for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_REVENUE_BUDGET_LINES');



debug('begin add_signature: EBS_FIN_PA_PAPJB_REVENUE_RES_ASSIGNMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26131',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_REVENUE_RES_ASSIGNMENTS',
      p_sig_sql                => 'select *
from pa_resource_assignments where budget_version_id IN (select budget_version_id
from pa_budget_versions 
where project_id = ##$$PROJECT_ID$$## 
    and version_type <> ''COST'')
order by budget_version_id asc, resource_assignment_id asc',
      p_title                  => 'Projects Revenue Budget Resource Assignments (PA_RESOURCE_ASSIGNMENTS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No revenue budget resource assignments for the project.',
      p_solution               => '',
      p_success_msg            => 'Revenue budget resource assignments for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_REVENUE_RES_ASSIGNMENTS');



debug('begin add_signature: PA_PROJECT_FUNDINGS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14248',
      p_sig_id                 => 'PA_PROJECT_FUNDINGS',
      p_sig_sql                => 'SELECT * FROM PA_PROJECT_FUNDINGS WHERE project_id = ##$$PROJECT_ID$$## ',
      p_title                  => 'Project Funding (PA_PROJECT_FUNDINGS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No funding amounts found for the selected project.',
      p_solution               => '',
      p_success_msg            => 'Funding amounts found for the selected project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PROJECT_FUNDINGS');



debug('begin add_signature: PA_SUMMARY_PROJECT_FUNDINGS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14247',
      p_sig_id                 => 'PA_SUMMARY_PROJECT_FUNDINGS',
      p_sig_sql                => 'SELECT * FROM PA_SUMMARY_PROJECT_FUNDINGS WHERE project_id = ##$$PROJECT_ID$$## 
',
      p_title                  => 'Project Summary Funding (PA_SUMMARY_PROJECT_FUNDINGS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No summary funding amounts found for the selected project.',
      p_solution               => '',
      p_success_msg            => 'Summary funding amounts found for the selected project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_SUMMARY_PROJECT_FUNDINGS');



debug('begin add_signature: PA_BILLING_EXTENSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14254',
      p_sig_id                 => 'PA_BILLING_EXTENSIONS',
      p_sig_sql                => 'SELECT * FROM PA_BILLING_EXTENSIONS WHERE BILLING_EXTENSION_ID IN (SELECT BILLING_EXTENSION_ID FROM PA_BILLING_ASSIGNMENTS_ALL WHERE NVL(project_type,-1) = (SELECT project_type FROM pa_projects_all WHERE project_id = ##$$PROJECT_ID$$## ) OR NVL(project_id, -1) = ##$$PROJECT_ID$$## OR NVL(top_task_id,-1) IN (SELECT top_task_id FROM pa_tasks WHERE project_id = ##$$PROJECT_ID$$## ) )
',
      p_title                  => 'Billing Extensions (PA_BILLING_EXTENSIONS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No billing extensions for the selected project.',
      p_solution               => '',
      p_success_msg            => 'Billing extensions exist for the selected project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_BILLING_EXTENSIONS');



debug('begin add_signature: PA_BILLING_ASSIGNMENTS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14253',
      p_sig_id                 => 'PA_BILLING_ASSIGNMENTS_ALL',
      p_sig_sql                => 'SELECT * FROM PA_BILLING_ASSIGNMENTS_ALL WHERE NVL(project_type,-1) =  (SELECT project_type FROM pa_projects_all WHERE project_id = ##$$PROJECT_ID$$## ) OR NVL(project_id, -1)  = ##$$PROJECT_ID$$## OR NVL(top_task_id,-1) IN  (SELECT top_task_id FROM pa_tasks WHERE project_id = ##$$PROJECT_ID$$##) and org_id = ##$$ORG_ID$$##',
      p_title                  => 'Billing Assignments (PA_BILLING_ASSIGNMENTS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No billing assignments for the selected project.',
      p_solution               => '',
      p_success_msg            => 'Billing assignments for the selected project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_BILLING_ASSIGNMENTS_ALL');



debug('begin add_signature: PA_PROJECT_CREDIT_RECEIVERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22173',
      p_sig_id                 => 'PA_PROJECT_CREDIT_RECEIVERS',
      p_sig_sql                => 'SELECT *  
FROM   PA_CREDIT_RECEIVERS 
WHERE  project_id =  ##$$PROJECT_ID$$##',
      p_title                  => 'Project Credit Receivers (PA_CREDIT_RECEIVERS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No credit receiver assigned to the selected project.',
      p_solution               => '',
      p_success_msg            => 'Credit receiver assigned to the selected project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PROJECT_CREDIT_RECEIVERS');



debug('begin add_signature: EBS_FIN_PA_DRAFT_REVENUES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25963',
      p_sig_id                 => 'EBS_FIN_PA_DRAFT_REVENUES_ALL',
      p_sig_sql                => 'select *
from pa_draft_revenues_all
where project_id = ##$$PROJECT_ID$$##
and rownum <100
order by draft_revenue_num desc',
      p_title                  => 'Draft Revenue for the Project (PA_DRAFT_REVENUES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no draft revenue for the project.',
      p_solution               => '',
      p_success_msg            => 'Draft revenue exists for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_DRAFT_REVENUES_ALL');



debug('begin add_signature: EBS_FIN_PA_PAPJB_PA_DRAFT_REVENUE_ITEMS_PROJECT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25899',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_PA_DRAFT_REVENUE_ITEMS_PROJECT',
      p_sig_sql                => 'SELECT * 
FROM PA_DRAFT_REVENUE_ITEMS 
WHERE project_id = ##$$PROJECT_ID$$## 
and rownum <200
order by draft_revenue_num desc, line_num asc',
      p_title                  => 'Draft Revenue Items for the Project (PA_DRAFT_REVENUE_ITEMS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no draft revenue items for the project.',
      p_solution               => '',
      p_success_msg            => 'Draft revenue items exist for the project.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_PA_DRAFT_REVENUE_ITEMS_PROJECT');



debug('begin add_signature: EBS_FIN_PA_PAPJB_PCRDL_PROJECT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '32089',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_PCRDL_PROJECT',
      p_sig_sql                => 'SELECT *
FROM PA_CUST_REV_DIST_LINES_ALL 
WHERE project_id = ##$$PROJECT_ID$$## 
and rownum < 1001
order by draft_revenue_num desc, draft_revenue_item_line_num asc',
      p_title                  => 'Revenue Distribution Lines for Project (PA_CUST_REV_DIST_LINES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no revenue distribution lines for this project.',
      p_solution               => '',
      p_success_msg            => 'Revenue distribution lines exist for this project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_PCRDL_PROJECT');



debug('begin add_signature: EBS_FIN_PA_PAPJB_PA_CUST_EVENT_RDL_ALL_PROJECT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '32090',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_PA_CUST_EVENT_RDL_ALL_PROJECT',
      p_sig_sql                => 'SELECT * 
FROM PA_CUST_EVENT_RDL_ALL
WHERE project_id = ##$$PROJECT_ID$$## 
and rownum < 1001
order by draft_revenue_num desc, draft_revenue_item_line_num asc',
      p_title                  => 'Event Revenue Distribution Lines for Project (PA_CUST_EVENT_RDL_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no event revenue distribution lines for this project.',
      p_solution               => '',
      p_success_msg            => 'Event revenue distribution lines exist for this project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_PA_CUST_EVENT_RDL_ALL_PROJECT');



debug('begin add_signature: EBS_FIN_PA_PAPJB_PA_DRAFT_INVOICES_PROJECT');
   l_info('##MASK##INVOICE_COMMENT'):= 'DISPLAY_FIRST_4_CHAR';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25900',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_PA_DRAFT_INVOICES_PROJECT',
      p_sig_sql                => 'select * from PA_DRAFT_INVOICES_ALL 
where project_id = ##$$PROJECT_ID$$##
and rownum <100
order by draft_invoice_num desc
',
      p_title                  => 'Draft Invoices for the Project (PA_DRAFT_INVOICES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no draft invoices generated for this project.',
      p_solution               => '',
      p_success_msg            => 'Draft invoices generated for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_PA_DRAFT_INVOICES_PROJECT');



debug('begin add_signature: EBS_FIN_PA_PAPJB_PA_DRAFT_INVOICE_ITEMS_PROJECT');
   l_info('##MASK##TEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25901',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_PA_DRAFT_INVOICE_ITEMS_PROJECT',
      p_sig_sql                => 'select * from PA_DRAFT_INVOICE_ITEMS
where project_id = ##$$PROJECT_ID$$##
and rownum <200
order by draft_invoice_num desc, line_num asc',
      p_title                  => 'Draft Invoice Items for the Project (PA_DRAFT_INVOICE_ITEMS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no draft invoice items for this project.',
      p_solution               => '',
      p_success_msg            => 'Draft invoice items exist for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_PA_DRAFT_INVOICE_ITEMS_PROJECT');



debug('begin add_signature: PA_EXPENDITURE_ITEMS_ALL-DC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15776',
      p_sig_id                 => 'PA_EXPENDITURE_ITEMS_ALL-DC',
      p_sig_sql                => 'SELECT * FROM PA_EXPENDITURE_ITEMS_ALL WHERE PROJECT_ID = ##$$PROJECT_ID$$##',
      p_title                  => 'Expenditure Items (PA_EXPENDITURE_ITEMS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No expenditure items exist for Project ID ##$$PROJECT_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Expenditure items exist for Project ID ##$$PROJECT_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_EXPENDITURE_ITEMS_ALL-DC');



debug('begin add_signature: PA_EVENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20178',
      p_sig_id                 => 'PA_EVENTS',
      p_sig_sql                => 'select * from PA_EVENTS where project_id = ##$$PROJECT_ID$$##
and rownum <101
order by event_num desc, task_id asc',
      p_title                  => 'Project Events (PA_EVENTS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no events associated with the project.
',
      p_solution               => '',
      p_success_msg            => 'Events exist for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_EVENTS');



debug('begin add_signature: EBS_FIN_PA_PAPJB_BATCH_TRANSACTION_TYPE_INFORMATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25010',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_BATCH_TRANSACTION_TYPE_INFORMATION',
      p_sig_sql                => 'SELECT   
    bs.name                        AS "Batch Source Name",
    bs.batch_source_id             AS "Batch Source Id",
    bs.status                      AS "Batch Status",
    bs.batch_source_type           AS "Batch Source Type",
    bs.allow_sales_credit_flag     AS "Allow Sales Credit Flag",
    bs.start_date                  AS "Start Date",
    bs.end_date                    AS "End Date",
    bs.credit_memo_batch_source_id AS "CM Batch Source Id",
    bs.auto_batch_numbering_flag   AS "Auto Batch Numbering",
    bs.last_batch_num              AS "Last Batch Num",
    bs.auto_trx_numbering_flag     AS "Auto Trx Numbering",
    bs.salesperson_rule            AS "Salesperson Rule",
    bs.sales_credit_rule           AS "Sales Credit Rule",
    bs.sales_credit_type_rule      AS "Sales Credit Type Rule",
    bs.default_inv_trx_type        AS "Default Inv Trx Type",
    ty1.name                       AS "Invoice Trx Type",
    ty1.post_to_gl                 AS "Invoice Post To GL",
    ty1.accounting_affect_flag     AS "Invoice Create Rec",
    ty1.creation_sign              AS "Invoice Creation Sign",
    ty1.start_date                 AS "Invoice Start Date",
    ty1.end_date                   AS "Invoice End Date",
    ty1.credit_memo_type_id        AS "CM Trx Type Id",
    ty2.name                       AS "CM Trx Type",
    ty2.post_to_gl                 AS "CM Post To GL",
    ty2.accounting_affect_flag     AS "CM Create Rec",
    ty2.creation_sign              AS "CM Creation Sign",
    ty2.start_date                 AS "CM Start Date",
    ty2.end_date                   AS "CM End Date"
FROM
    ra_batch_sources_all   bs,
    ra_cust_trx_types_all  ty1,
    ra_cust_trx_types_all  ty2,
    pa_implementations_all i 
WHERE
   i.invoice_batch_source_id = bs.batch_source_id
    AND i.org_id IN (
        SELECT
            org_id
        FROM
    ...
    AND i.org_id = bs.org_id
    AND ty1.cust_trx_type_id (+) = bs.default_inv_trx_type
    AND ty2.cust_trx_type_id (+) = ty1.credit_memo_type_id 
    AND bs.org_id = nvl(ty1.org_id, bs.org_id)
    AND bs.org_id = nvl(ty2.org_id, bs.org_id) 
',
      p_title                  => 'Batch and Transaction Type Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No batch and transaction type information exists.',
      p_solution               => '',
      p_success_msg            => 'Batch and transaction type information exists.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_BATCH_TRANSACTION_TYPE_INFORMATION');



debug('begin add_signature: EBS_FIN_PA_PAPJB_INV_FORMAT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30212',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_INV_FORMAT',
      p_sig_sql                => 'select pif.invoice_format_id, pif.name, pif.customer_invoice_flag, pif.intercompany_invoice_flag, pif.provider_organization_flag, pif.receiver_organization_flag,
pif.invoice_group_id, pig.name, pifd.start_position, pifd.end_position, pigc.name
from PA_INVOICE_FORMATS PIF, PA_Invoice_Groups PIG, PA_invoice_format_details PIFD, PA_invoice_group_Columns PIGC
Where pif.invoice_group_id = pig.invoice_group_id
and   pif.invoice_format_id = pifd.invoice_format_id
and   pifd.invoice_group_column_id = pigc.invoice_group_column_id
and   pif.invoice_format_id in (select LABOR_INVOICE_FORMAT_ID
                                from pa_projects_all ppa
                                where ppa.project_id = ##$$PROJECT_ID$$##
                                union all
                                select NON_LABOR_INVOICE_FORMAT_ID
                                from pa_projects_all ppa
                                where ppa.project_id = ##$$PROJECT_ID$$##
                                )',
      p_title                  => 'Invoice Format Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no invoice formats defined for the project selected.',
      p_solution               => '',
      p_success_msg            => 'PA_INVOICE_FORMATS stores the implementation-defined configurations for grouping expenditure items into invoice lines.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_INV_FORMAT');



debug('begin add_signature: EBS_FIN_PA_PAPJB_PA_DRAFT_INVOICES_ALL_NOT_RELEASED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29298',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_PA_DRAFT_INVOICES_ALL_NOT_RELEASED',
      p_sig_sql                => 'SELECT
    project_id,
    draft_invoice_num,
...
where 
Project_id = ##$$PROJECT_ID$$##
AND ( approved_date IS NULL OR approved_by_person_id IS NULL
                               OR released_date IS NULL
                                  OR released_by_person_id IS NULL
                                     OR ra_invoice_number IS NULL )',
      p_title                  => 'Draft Invoice Numbers Pending For Approval or Release',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The following draft invoice numbers have not been approved or released.',
      p_solution               => 'To interface the invoice to Receivables, approve and release the invoices.',
      p_success_msg            => 'There are no draft invoice numbers pending approval and release.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_PA_DRAFT_INVOICES_ALL_NOT_RELEASED');



debug('begin add_signature: EBS_FIN_PA_PAPJB_PA_DRAFT_INVOICES_ALL_NOT_INTERFACED_TO_AR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29299',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_PA_DRAFT_INVOICES_ALL_NOT_INTERFACED_TO_AR',
      p_sig_sql                => 'SELECT
    di.project_id,
...
AND NOT EXISTS (
    ...
    FROM
        ...
        pa_projects_all     ppa
    WHERE
            rct.interface_header_attribute1 = ppa.segment1
        AND rct.interface_header_attribute2 = TO_CHAR(di.draft_invoice_num)
            AND ppa.project_id = di.project_id
)',
      p_title                  => 'Draft Invoice Numbers Not Interfaced to Receivable',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The following Draft Invoice Numbers have not been interfaced to Receivables.',
      p_solution               => 'To interface the invoice to Receivables, complete the interface process.',
      p_success_msg            => 'The Draft Invoice Numbers pending for interfacing to Receivables do not exist.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_PA_DRAFT_INVOICES_ALL_NOT_INTERFACED_TO_AR');



debug('begin add_signature: PA_PROJ_RETN_RULES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14301',
      p_sig_id                 => 'PA_PROJ_RETN_RULES',
      p_sig_sql                => 'select * from PA_PROJ_RETN_RULES where project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Project Retention Rules Setup (PA_PROJ_RETN_RULES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no retention setup for the project selected.',
      p_solution               => '',
      p_success_msg            => 'PA_PROJ_RETN_RULES stores retention setup rules. These rules are entered at the project or top task level. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PROJ_RETN_RULES');



debug('begin add_signature: PA_RETN_BILL_METHOD_V');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14303',
      p_sig_id                 => 'PA_RETN_BILL_METHOD_V',
      p_sig_sql                => 'select lookup_code, meaning from pa_lookups where lookup_type = ''RETN_BILLING_METHOD''',
      p_title                  => 'Project Retention Billing Method View (PA_RETN_BILL_METHOD_V)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no retention billing method setup.',
      p_solution               => '',
      p_success_msg            => 'PA_RETN_BILL_METHOD_V stores information related to retention billing method.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_RETN_BILL_METHOD_V');



debug('begin add_signature: PA_PROJ_RETN_BILL_RULES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14296',
      p_sig_id                 => 'PA_PROJ_RETN_BILL_RULES',
      p_sig_sql                => 'select * from PA_PROJ_RETN_BILL_RULES where project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Project Retention Billing Rules (PA_PROJ_RETN_BILL_RULES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no retention information related to the project selected.
',
      p_solution               => '',
      p_success_msg            => 'PA_PROJ_RETN_BILL_RULES stores retention billing rules for a project or top task. Retention invoice is generated based on these rules. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PROJ_RETN_BILL_RULES');



debug('begin add_signature: PA_PROJECT_RETENTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14294',
      p_sig_id                 => 'PA_PROJECT_RETENTIONS',
      p_sig_sql                => 'select * from PA_PROJECT_RETENTIONS where project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Project Retention Summary Balances (PA_PROJECT_RETENTIONS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no retention information related to the project selected.
',
      p_solution               => '',
      p_success_msg            => 'PA_PROJECT_RETENTIONS stores retention summary balances, based on project agreement.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PROJECT_RETENTIONS');



debug('begin add_signature: PA_PROJECT_RETENTION_V');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14295',
      p_sig_id                 => 'PA_PROJECT_RETENTION_V',
      p_sig_sql                => 'select p.project_id project_id
, pc.customer_id customer_id
, party.party_id customer_number
, pc.retention_level_code retention_level_code
, lk.meaning retention_level_name
, spr.invproc_currency_code invproc_currency_code
, sum(spr.total_retained) total_retained
, sum(spr.total_billed) total_billed
, sum(spr.total_writeoff) total_writeoff
, pc.record_version_number record_version_number
from pa_projects_all p
, pa_project_customers pc
, pa_summary_project_retn spr
, hz_parties party
, pa_lookups lk
where p.project_id = pc.project_id
and party.party_id = pc.customer_id
and spr.project_id(+) = pc.project_id
and spr.customer_id (+)= pc.customer_id
and lk.lookup_type(+) = ''RETENTION_LEVEL''
and lk.lookup_code(+) = decode (pc.retention_level_code, null, ''NO_RETENTION'', pc.retention_level_code) 
...
, pc.record_version_number',
      p_title                  => 'Project/Customer Retention Summary Balances (PA_PROJECT_RETENTION_V)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no retention information related to the project selected.
',
      p_solution               => '',
      p_success_msg            => 'PA_PROJECT_RETENTION_V stores retention summary balances related to project and customer.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PROJECT_RETENTION_V');



debug('begin add_signature: PA_PROJ_RETN_BILL_VALUES_V');
   l_info('##MASK##TASK_NAME'):= 'REMOVE_COLUMN';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14297',
      p_sig_id                 => 'PA_PROJ_RETN_BILL_VALUES_V',
      p_sig_sql                => 'select bl.retn_billing_rule_id
, bl.project_id
, bl.customer_id
, bl.task_id
, t.task_number
, t.task_name
, bl.billing_method_code
, fd.meaning billing_method
, decode(bl.billing_method_code, ''CLIENT_EXTENSION'', client_extension_flag, ''PERCENT_COMPLETE'', completed_percentage, ''TOTAL_RETENTION_AMOUNT'', total_retention_amount ) method_value
, retn_billing_percentage
, retn_billing_amount
from pa_proj_retn_bill_rules bl
, pa_lookups fd
, pa_tasks t
, pa_projects_all p
where fd.lookup_type = ''RETN_BILLING_METHOD''
and fd.lookup_code = bl.billing_method_code
and t.task_id (+) = bl.task_id 
and bl.project_id = p.project_id
and bl.retn_billing_cycle_id is null 
and p.project_id = ##$$PROJECT_ID$$##
union 
select bl.retn_billing_rule_id
, bl.project_id
, bl.customer_id
, bl.task_id
, t.task_number
...
, bl.billing_method_code
, fd.meaning billing_method
, c.billing_cycle_name method_value
, retn_billing_percentage
, retn_billing_amount
from pa_proj_retn_bill_rules bl
, pa_lookups fd
...
where fd.lookup_type = ''RETN_BILLING_METHOD''
and fd.lookup_code = bl.billing_method_code
and c.billing_cycle_id (+)= bl.retn_billing_cycle_id
and t.task_id (+) = bl.task_id 
and bl.project_id = p.project_id
and bl.retn_billing_cycle_id is not null 
and p.project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Project Retention Billing Values (PA_PROJ_RETN_BILL_VALUES_V)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no retention information related to the project selected.
',
      p_solution               => '',
      p_success_msg            => 'PA_PROJ_RETN_BILL_VALUES_V stores retention billing information related to BILLING_METHOD, RETN_BILLING_PERCENTAGE and RETN_BILLING_AMOUNT for a project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PROJ_RETN_BILL_VALUES_V');



debug('begin add_signature: PA_PROJ_RETN_DEFAULTS_V');
   l_info('##MASK##AGREEMENT_NUM'):= 'DISPLAY_FIRST_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14298',
      p_sig_id                 => 'PA_PROJ_RETN_DEFAULTS_V',
      p_sig_sql                => 'select rt.retention_rule_id
, rl.retention_level_code
, lk1.meaning retention_level_name
, rt.project_id
, decode(pa_security.allow_query(p.project_id), ''Y'', p.segment1, substr(lk.meaning, 1, 25))
, rt.task_id
, decode(pa_security.allow_query(p.project_id), ''Y'', t.task_number, substr(lk.meaning, 1, 25))
, rt.agreement_id
, a.customer_id
, cust_acct.account_number
, rl.effective_start_date
, rl.effective_end_date
, rl.retention_percentage
, rl.retention_amount
, rl.threshold_amount
, rt.invproc_currency_code
, rt.total_retained
, rt.funding_currency_code
, rt.funding_total_retained
, rt.project_currency_code
, rt.project_total_retained
, rt.projfunc_currency_code
, rt.projfunc_total_retained
from pa_lookups lk
, pa_lookups lk1
, pa_tasks t
...
, pa_agreements_all a
, pa_projects_all p
, pa_project_retentions rt
, pa_proj_retn_rules rl
where t.project_id(+) = rt.project_id
and t.task_id(+) = rt.task_id
and rt.retention_rule_id = rl.retention_rule_id
and rl.retention_level_code in (''PROJECT'', ''TOP_TASK'')
and p.project_id = decode(cust_acct.cust_account_id, null, null, rt.project_id)
and cust_acct.party_id = party.party_id
and a.agreement_id = rt.agreement_id
and cust_acct.cust_account_id = a.customer_id
and lk1.lookup_type(+) = ''RETENTION_LEVEL''
and lk1.lookup_code(+) = decode (rl.retention_level_code, null, ''NONE'', rl.retention_level_code)
and lk.lookup_type = decode(p.project_id, null, null, ''TRANSLATION'')
and lk.lookup_code ||'''' = ''SECURED_DATA''
and p.project_id = ##$$PROJECT_ID$$## ',
      p_title                  => 'Project Retention Details (PA_PROJ_RETN_DEFAULTS_V)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no retention information related to the project selected.',
      p_solution               => '',
      p_success_msg            => 'PA_PROJ_RETN_DEFAULTS_V stores detailed retention information about the project selected.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PROJ_RETN_DEFAULTS_V');



debug('begin add_signature: PA_PROJ_RETN_EVENTS_V');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14299',
      p_sig_id                 => 'PA_PROJ_RETN_EVENTS_V',
      p_sig_sql                => 'select rt.retention_rule_id
, rl.retention_level_code
, rt.project_id
, decode(pa_security.allow_query(p.project_id), ''Y'', p.segment1, substr(lk.meaning, 1, 25))
...
, rl.retention_amount
, rl.threshold_amount
, rl.revenue_category_code
, lk1.meaning revenue_category_desc
, rl.event_type
, rt.invproc_currency_code
, rt.total_retained
, rt.funding_currency_code
...
and rt.retention_rule_id = rl.retention_rule_id 
and p.project_id = ##$$PROJECT_ID$$## 
and rl.retention_level_code in (''EVENT_TYPE'', ''REVENUE_CATEGORY'')
and p.project_id = decode(cust_acct.cust_account_id, null, null, rt.project_id)
and cust_acct.party_id=party.party_id
and a.agreement_id = rt.agreement_id
and cust_acct.cust_account_id = a.customer_id
and lk.lookup_type = decode(p.project_id, null, null, ''TRANSLATION'')
and lk.lookup_code ||'''' = ''SECURED_DATA''
and lk1.lookup_type = ''REVENUE CATEGORY''
and lk1.lookup_code = rl.revenue_category_code ',
      p_title                  => 'Project Retention Event (PA_PROJ_RETN_EVENTS_V)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no retention event related to the project selected.',
      p_solution               => '',
      p_success_msg            => 'PA_PROJ_RETN_EVENTS_V stores retention events for a project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PROJ_RETN_EVENTS_V');



debug('begin add_signature: PA_PROJ_RETN_EXP_V');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14300',
      p_sig_id                 => 'PA_PROJ_RETN_EXP_V',
      p_sig_sql                => 'select rt.retention_rule_id
, rl.retention_level_code
, rt.project_id
, decode(pa_security.allow_query(p.project_id), ''Y'', p.segment1, substr(lk.meaning, 1, 25))
...
, rl.retention_amount
, rl.threshold_amount
, rl.expenditure_category
, rl.expenditure_type
, rl.non_labor_resource
, rt.invproc_currency_code
, rt.total_retained
, rt.funding_currency_code
, rt.funding_total_retained
...
and t.task_id(+) = rt.task_id
and rt.retention_rule_id = rl.retention_rule_id
and rl.retention_level_code in (''EXPENDITURE_TYPE'', ''EXPENDITURE_CATEGORY'', ''NON_LABOR'')
and p.project_id = decode(cust_acct.cust_account_id, null, null, rt.project_id)
and cust_acct.party_id = party.party_id
and a.agreement_id = rt.agreement_id
and cust_acct.cust_account_id = a.customer_id
and lk.lookup_type = decode(p.project_id, null, null, ''TRANSLATION'')
and lk.lookup_code ||'''' = ''SECURED_DATA''',
      p_title                  => 'Project Expenditure Retention Details (PA_PROJ_RETN_EXP_V)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no retention information related to the expenditure and project selected.
',
      p_solution               => '',
      p_success_msg            => 'PA_PROJ_RETN_EXP_V stores retention information for a project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PROJ_RETN_EXP_V');



debug('begin add_signature: PA_SUMMARY_PROJECT_RETNS_V');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14308',
      p_sig_id                 => 'PA_SUMMARY_PROJECT_RETNS_V',
      p_sig_sql                => 'select f.project_id
, decode(pa_security.allow_query(p.project_id), ''Y'', p.segment1, substr(lk.meaning, 1, 25))
, f.task_id
, decode(pa_security.allow_query(p.project_id), ''Y'', t.task_number, substr(lk.meaning, 1, 25))
, f.agreement_id
...
and p.project_id = decode(cust_acct.cust_account_id, null, null, f.project_id)
and cust_acct.party_id=party.party_id
...
and p.project_id = ##$$PROJECT_ID$$## 
and lk1.lookup_type(+) = ''RETENTION_LEVEL''
and lk1.lookup_code(+) = decode (pc.retention_level_code, null, ''NO_RETENTION'', pc.retention_level_code)
and lk.lookup_type = decode(p.project_id, null, null, ''TRANSLATION'')
and lk.lookup_code ||'''' = ''SECURED_DATA''',
      p_title                  => 'Project/Customer Retention Summary Details (PA_SUMMARY_PROJECT_RETNS_V)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no retention information related to the project selected.
',
      p_solution               => '',
      p_success_msg            => 'PA_SUMMARY_PROJECT_RETNS_V stores summary retention amounts calculated based on retention and retention billing setup at the project or top task level. This view is a supplementary view used to simplify forms coding.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_SUMMARY_PROJECT_RETNS_V');



debug('begin add_signature: PA_MC_RETN_INV_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14292',
      p_sig_id                 => 'PA_MC_RETN_INV_DETAILS',
      p_sig_sql                => 'select * from PA_MC_RETN_INV_DETAILS where project_id = ##$$PROJECT_ID$$## and draft_invoice_num = NVL(##$$DINV_NUM$$##,draft_invoice_num)',
      p_title                  => 'Invoice Total Retained Amount (PA_MC_RETN_INV_DETAILS )',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no retention information related to the project and draft invoice selected.',
      p_solution               => '',
      p_success_msg            => 'PA_MC_RETN_INV_DETAILS stores total retained amount as of the invoice generated date. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_MC_RETN_INV_DETAILS');



debug('begin add_signature: PA_MC_RETN_INV_DETLS_AR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14293',
      p_sig_id                 => 'PA_MC_RETN_INV_DETLS_AR',
      p_sig_sql                => 'select * from PA_MC_RETN_INV_DETLS_AR where project_id = ##$$PROJECT_ID$$## and draft_invoice_num = NVL(##$$DINV_NUM$$##,draft_invoice_num)',
      p_title                  => 'Invoice Details for Retained Amount (PA_MC_RETN_INV_DETLS_AR)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no retention information related to the project and draft invoice selected.
',
      p_solution               => '',
      p_success_msg            => 'PA_MC_RETN_INV_DETLS_AR stores total retained amount as of the invoice generated date, with information about PURGE_BATCH_ID and PURGE_PROJECT_ID.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_MC_RETN_INV_DETLS_AR');



debug('begin add_signature: PA_RETN_INVOICE_DETAILS_V');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14306',
      p_sig_id                 => 'PA_RETN_INVOICE_DETAILS_V',
      p_sig_sql                => 'select dii.project_id
...
and dii.invoice_line_type=''RETENTION'' and lk.lookup_type(+) = ''REVENUE CATEGORY'' and lk.lookup_code(+) = pprr.revenue_category_code',
      p_title                  => 'Project Invoice/Expenditure Retention Details (PA_RETN_INVOICE_DETAILS_V)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no retention information related to the project and draft invoice selected.
',
      p_solution               => '',
      p_success_msg            => 'PA_RETN_INVOICE_DETAILS_V is a public view which may be useful for custom reporting or other data
requirements.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_RETN_INVOICE_DETAILS_V');



debug('begin add_signature: PA_RETN_INV_DETAILS_AR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14304',
      p_sig_id                 => 'PA_RETN_INV_DETAILS_AR',
      p_sig_sql                => 'select * from PA_RETN_INV_DETAILS_AR where project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Project Invoice Retention Details (PA_RETN_INV_DETAILS_AR)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no retention invoice information related to the project selected.',
      p_solution               => '',
      p_success_msg            => 'PA_RETN_INV_DETAILS_AR stores invoice retention information for PURGE_BATCH_ID related to the project selected.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_RETN_INV_DETAILS_AR');



debug('begin add_signature: EBS_FIN_PA_PAPJB_REVENUE_GL_RECONCILIATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23192',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_REVENUE_GL_RECONCILIATION',
      p_sig_sql                => 'SELECT DISTINCT p.segment1 project_number ,
   nvl(pt.task_number,0) Task_number,
   aeh.period_name ,
   ...
   --NULL event_num ,
   rdl.amount
FROM pa_draft_revenue_items  rdl,
...
AND pia.set_of_books_id              = aeh.ledger_id
...
AND p.project_id = pdr.project_id
AND pt.task_id(+) = rdl.task_id
order by draft_revenue_num desc',
      p_title                  => 'Reconciliation Report For Draft Revenue To General Ledger',
      p_fail_condition         => 'NRS',
      p_problem_descr          => ' Draft revenue successfully interfaced to General Ledger.',
      p_solution               => '',
      p_success_msg            => 'Draft revenues not interfaced to General Ledger.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_REVENUE_GL_RECONCILIATION');



debug('begin add_signature: EBS_FIN_PA_PAPJB_REVENUE_RECONCILIATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23190',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_REVENUE_RECONCILIATION',
      p_sig_sql                => 'SELECT DISTINCT p.segment1 project_number ,
   nvl(pt.task_number,0) Task_number,
   pdr.gl_period_name period_name ,
     pdr.draft_revenue_num ,
    pdr.gl_date ,
    rdl.amount
FROM pa_draft_revenue_items rdl,
   ...
   pa_tasks pt,
   pa_implementations_all pia
WHERE pdr.Transfer_Status_Code in ( ''R'',''P'')
and pa_rev_interface_util.ALLOW_UNRELEASED_REV(pdr.RELEASED_DATE) = ''Y''
AND rdl.project_id              = pdr.project_id
AND rdl.draft_revenue_num       = pdr.draft_revenue_num
AND pdr.event_id               IS NULL
AND p.project_id                = pdr.project_id
AND pt.task_id(+) = rdl.task_id
AND pia.org_id                  = p.org_id
AND pia.interface_revenue_to_gl_flag = ''Y''
AND p.project_id =  ##$$PROJECT_ID$$##',
      p_title                  => 'Draft Revenue Not Interfaced To SLA And GL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Draft revenue not interfaced to Subledger Accounting (SLA) and General Ledger (GL).',
      p_solution               => 'Follow the solution in [2885921/KB351000#Case1] Reconciliation Report for Draft Revenue From Project Accounting to General Ledger.',
      p_success_msg            => 'Draft revenue for the project is interfaced to Subledger Accounting (SLA) and General Ledger (GL).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_REVENUE_RECONCILIATION');



debug('begin add_signature: EBS_FIN_PA_PAPJB_REVENUE_SLA_RECONCILIATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23191',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_REVENUE_SLA_RECONCILIATION',
      p_sig_sql                => 'SELECT DISTINCT p.segment1 project_number,
  pt.task_number,
  pdr.gl_period_name period_name ,
  pdr.draft_revenue_num ,
...
AND p.project_id     = pdr.project_id
AND pt.task_id(+)    = rdl.task_id',
      p_title                  => 'Draft Revenue Interfaced To SLA But Not Interfaced to GL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Reconciliation issue for draft revenue interfaced to Subledger Accounting (SLA) but not interfaced to General Ledger (GL).',
      p_solution               => 'Follow the solution in [2885921/KB351000#Case2] Reconciliation Report for Draft Revenue From Project Accounting to General Ledger.',
      p_success_msg            => 'There is no reconciliation issue with draft revenue interfaced to Subledger Accounting (SLA) but not interfaced to   General Ledger (GL).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_REVENUE_SLA_RECONCILIATION');



debug('begin add_signature: EBS_FIN_PA_PAPJB_TRA_ACCOUNT_SETUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24525',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_TRA_ACCOUNT_SETUP',
      p_sig_sql                => 'SELECT fnc.function_code,
              fnc.function_name,
  ...
  FROM  pa_function_transactions_all ft,
               pa_functions fnc
WHERE fnc.function_code = ''TRA'' 
And ft.enabled_flag = ''N''
and function_transaction_name in ( ''Contract Asset Account'', ''Contract Liability Account'')
and fnc.function_code = ft.function_code
and ft.org_id = (SELECT org_id FROM pa_projects_all WHERE project_id = ##$$PROJECT_ID$$##)
',
      p_title                  => 'Contract Asset Account And Contract Liability Account ',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The SLA or Auto Accounting (AA) setup for function code TRA / function name ''Revenue and Invoice Accounts'' regarding function transactions, ''Contract Asset Account'' and ''Contract Liability Account'' are not enabled.',
      p_solution               => 'Review the rules and functions for function code TRA / function name ''Revenue and Invoice Accounts'' regarding function transactions, ''Contract Asset Account'' and ''Contract Liability Account''.  Follow the instruction in [2467696/KB199546] R12 How To Resolve IFRS 15/ASC-606 Process Error: PA_AA_NO_SUCH_TRANS|FTCODE|CONTRACT-ASSET.
',
      p_success_msg            => 'The SLA or Auto Accounting (AA) setup for function code TRA / function name ''Revenue and Invoice Accounts'' regarding function transactions, ''Contract Asset Account'' and ''Contract Liability Account'' are enabled.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_TRA_ACCOUNT_SETUP');



debug('begin add_signature: PA_BILL_AUTOACCOUNTING_FUNCTION_TRANSACTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22223',
      p_sig_id                 => 'PA_BILL_AUTOACCOUNTING_FUNCTION_TRANSACTIONS',
      p_sig_sql                => 'SELECT fnc.function_code,
       fnc.function_name,
       ft.function_transaction_code,
       ft.function_transaction_name,
       ft.enabled_flag
FROM
    pa_function_transactions_all ft,
    pa_functions fnc
WHERE fnc.function_code IN ( ''GBR'', ''GER'', ''GIR'', ''GJR'', ''GLR'',
                       ''GRR'', ''GUR'', ''GVR'', ''GWR'', ''ICR'',
                       ''TRA'' )
      and fnc.function_code = ft.function_code
      and ft.org_id = (SELECT org_id FROM pa_projects_all WHERE project_id = ##$$PROJECT_ID$$##)',
      p_title                  => 'AutoAccounting Function Transactions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No AutoAccounting function transactions defined for revenue and invoice processing.',
      p_solution               => 'Review the following documents:<br>
[77675/FAQ5791]Which AutoAccounting Function(s) Is Invoked By Each Projects Process?<br>
[552086/FAQ4118]AutoAccounting in Projects Frequently Asked Questions (FAQ)',
      p_success_msg            => 'AutoAccounting function transactions are defined for revenue and invoice processing.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_BILL_AUTOACCOUNTING_FUNCTION_TRANSACTIONS');



debug('begin add_signature: PA_BILL_AUTOACCOUNTING_LOOKUPSETS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22226',
      p_sig_id                 => 'PA_BILL_AUTOACCOUNTING_LOOKUPSETS',
      p_sig_sql                => 'SELECT 
ft.function_code,
ft.function_transaction_code,
ft.function_transaction_name,
...
psv.segment_value_lookup_set_name,
psv.description
FROM PA_SEGMENT_VALUE_LOOKUP_SETS psv,
  pa_rules pr,
  pa_segment_rule_pairings_all srp,
  pa_function_transactions_all ft
WHERE psv.SEGMENT_VALUE_LOOKUP_SET_ID = pr.SEGMENT_VALUE_LOOKUP_SET_ID
AND pr.rule_id                        = srp.rule_id
AND ft.function_transaction_code      = srp.function_transaction_code
AND ft.function_code                  = srp.function_code
AND ft.enabled_flag                   =''Y''
AND srp.org_id                        = ft.org_id
AND srp.function_code                IN  (''GBR'', ''GER'', ''GIR'', ''GJR'', ''GLR'',
                       ''GRR'', ''GUR'', ''GVR'', ''GWR'', ''ICR'',
                       ''TRA'' )
AND ft.org_id = (SELECT org_id FROM pa_projects_all WHERE project_id =  ##$$PROJECT_ID$$##)
',
      p_title                  => 'AutoAccounting Lookup Setups',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No AutoAccounting rule lookup sets defined for revenue and invoice processing.',
      p_solution               => 'Review the following documents:<br>
[77675/FAQ5791]Which AutoAccounting Function(s) Is Invoked By Each Projects Process?<br>
[552086/FAQ4118]AutoAccounting in Projects Frequently Asked Questions (FAQ)',
      p_success_msg            => ' AutoAccounting lookup sets defined for revenue and invoice processing.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_BILL_AUTOACCOUNTING_LOOKUPSETS');



debug('begin add_signature: PA_BILL_AUTOACCOUNTING_RULES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22224',
      p_sig_id                 => 'PA_BILL_AUTOACCOUNTING_RULES',
      p_sig_sql                => 'SELECT
  ft.FUNCTION_CODE,
  ft.FUNCTION_TRANSACTION_name,
  srp.segment_num,
  ...
  pr.constant_value,
  pr.key_parameter_id,
  pr.segment_value_lookup_set_id,
  pr.select_qualifiers_amt,
  pr.select_multiple_rows_flag,
  pr.select_statement
FROM pa_rules pr,
  pa_segment_rule_pairings_all srp,
  pa_function_transactions_all ft
WHERE ft.function_transaction_code = srp.function_transaction_code
AND ft.function_code               = srp.function_code
AND ft.enabled_flag                =''Y''
AND pr.rule_id                     = srp.rule_id
AND srp.org_id                     = ft.org_id
AND srp.function_code             IN ( ''GBR'', ''GER'', ''GIR'', ''GJR'', ''GLR'',
                       ...
                       ''TRA'' )
AND ft.org_id = (SELECT org_id FROM pa_projects_all WHERE project_id = ##$$PROJECT_ID$$##)',
      p_title                  => 'AutoAccounting Rules',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No AutoAccounting rules defined for revenue and invoice processing.',
      p_solution               => 'Review the following documents:<br>
[77675/FAQ5791]Which AutoAccounting Function(s) Is Invoked By Each Projects Process?<br>
[552086/FAQ4118]AutoAccounting in Projects Frequently Asked Questions (FAQ)',
      p_success_msg            => 'AutoAccounting rules defined for revenue and invoice processing.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_BILL_AUTOACCOUNTING_RULES');



debug('begin add_signature: PA_BILL_AUTOACCOUNTING_RULE_PAIRINGS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22225',
      p_sig_id                 => 'PA_BILL_AUTOACCOUNTING_RULE_PAIRINGS',
      p_sig_sql                => 'SELECT distinct
  ft.function_code,ft.function_transaction_name,
  P.SEGMENT_NUM ,
  F.SEGMENT_NAME ,
  R.RULE_NAME,
  ft.org_id
FROM PA_SEGMENT_RULE_PAIRINGS_ALL P ,
  PA_RULES R ,
...
AND F.ID_FLEX_CODE               = P.ID_FLEX_CODE
AND F.ID_FLEX_NUM                = P.ID_FLEX_NUM
AND ft.function_code             = p.function_code
AND ft.function_transaction_code = p.function_transaction_code
AND ft.application_id            = p.application_id
AND ft.org_id                    = p.org_id
AND ft.enabled_flag              = ''Y''
AND ft.function_code             in  ( ''GBR'', ''GER'', ''GIR'', ''GJR'', ''GLR'',
                       ''GRR'', ''GUR'', ''GVR'', ''GWR'', ''ICR'',
                       ''TRA'' )
AND ft.org_id = (SELECT org_id FROM pa_projects_all WHERE project_id = ##$$PROJECT_ID$$##)
',
      p_title                  => 'AutoAccounting Rule Pairings',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No AutoAccounting rule pairings defined for revenue and invoice processing.',
      p_solution               => 'Review the following documents:<br>
[77675/FAQ5791]Which AutoAccounting Function(s) Is Invoked By Each Projects Process?<br>
[552086/FAQ4118]AutoAccounting in Projects Frequently Asked Questions (FAQ)',
      p_success_msg            => 'AutoAccounting rule pairings are defined for revenue and invoice processing.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_BILL_AUTOACCOUNTING_RULE_PAIRINGS');



debug('begin add_signature: PA_BILL_INVALID_AUTOACCOUNTING_PARAMETERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22228',
      p_sig_id                 => 'PA_BILL_INVALID_AUTOACCOUNTING_PARAMETERS',
      p_sig_sql                => 'SELECT f.function_name ,
  srp.org_id ,
  srp.function_code ,
  ...
  ft.function_transaction_name ,
  org.name
FROM pa_segment_rule_pairings_all srp ,
  pa_rules r ,
  pa_parameters p ,
  pa_functions f ,
  pa_function_transactions_all ft ,
  hr_operating_units org
WHERE srp.rule_id                = r.rule_id
AND p.parameter_id               = r.key_parameter_id
AND f.function_code              = srp.function_code
AND ft.function_code             = f.function_code
AND ft.function_transaction_code = srp.function_transaction_code
AND org.organization_id (+)      = NVL(srp.org_id,-99)
AND ft.function_code                             IN (''GBR'', ''GER'', ''GIR'', ''GJR'', ''GLR'',
                       ''GRR'', ''GUR'', ''GVR'', ''GWR'', ''ICR'',
                       ''TRA'' )
AND ft.org_id = (SELECT org_id FROM pa_projects_all WHERE project_id = ##$$PROJECT_ID$$##)
AND NOT EXISTS
  (SELECT NULL
  FROM pa_function_parameters fp
  WHERE fp.function_code = srp.function_code
  AND fp.parameter_id    = r.key_parameter_id
  )
  UNION
...
FROM pa_segment_rule_pairings_all srp ,
  ...
  pa_parameters p ,
  pa_functions f ,
  pa_rule_parameters rp ,
  pa_function_transactions_all ft ,
  hr_operating_units org
WHERE srp.rule_id                = r.rule_id
AND rp.rule_id                   = r.rule_id
AND p.parameter_id               = rp.parameter_id
AND f.function_code              = srp.function_code
AND ft.function_code             = f.function_code
AND ft.function_transaction_code = srp.function_transaction_code
AND org.organization_id (+)      = NVL(srp.org_id,-99)
...
AND NOT EXISTS
  ...
  FROM pa_function_parameters fp
  WHERE fp.function_code = srp.function_code
  AND fp.parameter_id    = rp.parameter_id
  )

',
      p_title                  => 'Invalid AutoAccounting Parameters',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invalid AutoAccounting parameter identified.',
      p_solution               => 'Review the following documents:<br>
[77675/FAQ5791]Which AutoAccounting Function(s) Is Invoked By Each Projects Process?<br>
[552086/FAQ4118]AutoAccounting in Projects Frequently Asked Questions (FAQ)
',
      p_success_msg            => 'No invalid AutoAccounting parameters identified.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_BILL_INVALID_AUTOACCOUNTING_PARAMETERS');



debug('begin add_signature: PA_MISSING_AUTOACCOUNTING_LOOKUPSET');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22227',
      p_sig_id                 => 'PA_MISSING_AUTOACCOUNTING_LOOKUPSET',
      p_sig_sql                => 'SELECT DISTINCT r.key_parameter_id ,
  p.parameter_name ,
  r.segment_value_lookup_set_id lookup_set_id ,
  ls.segment_value_lookup_set_name lookup_set_name
FROM pa_rules r ,
  pa_segment_rule_pairings_all rp ,
  pa_functions f ,
  pa_function_transactions_all ft ,
  pa_parameters p ,
  pa_segment_value_lookup_sets ls
WHERE r.rule_type                  = ''L''
AND r.key_source                   = ''P''
AND rp.rule_id                     = r.rule_id
AND p.parameter_id                 = r.key_parameter_id
AND f.function_code                = rp.function_code
AND f.application_id               = rp.application_id
AND ft.function_code               = rp.function_code
AND ft.function_transaction_code   = rp.function_transaction_code
AND ft.application_id              = rp.application_id
AND ft.org_id                      = rp.org_id
AND ft.enabled_flag                = ''Y''
AND ft.function_code               in (''GBR'', ''GER'', ''GIR'', ''GJR'', ''GLR'',
                       ''GRR'', ''GUR'', ''GVR'', ''GWR'', ''ICR'',
                       ''TRA'' )
AND ft.org_id = (SELECT org_id FROM pa_projects_all WHERE project_id = ##$$PROJECT_ID$$##)
AND ls.segment_value_lookup_set_id = r.segment_value_lookup_set_id',
      p_title                  => 'Missing AutoAccounting Lookup Setup Values',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Missing AutoAccounting lookup set values.',
      p_solution               => 'Review the rules and functions where the parameter/lookup set combination is being used as well as the list of possible missing values that follows and determine if these values should be added to the lookup set.<br>
Review [552086/FAQ4118]AutoAccounting in Projects Frequently Asked Questions (FAQ)',
      p_success_msg            => 'No missing AutoAccounting lookup set values.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_MISSING_AUTOACCOUNTING_LOOKUPSET');



debug('begin add_signature: XLA_ACCOUNTING_ERRORS_FOR_PA_REVENUE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14224',
      p_sig_id                 => 'XLA_ACCOUNTING_ERRORS_FOR_PA_REVENUE',
      p_sig_sql                => 'SELECT * FROM xla_accounting_errors WHERE event_id IN (SELECT EVENT_ID FROM PA_DRAFT_REVENUES_ALL WHERE project_id = ##$$PROJECT_ID$$## AND draft_revenue_num = NVL(##$$DREV_NUM$$##, draft_revenue_num))',
      p_title                  => 'Revenue Event With XLA Error (XLA_ACCOUNTING_ERRORS)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are accounting errors generated for this project.',
      p_solution               => 'Review the errors in the query output. To gather additional error details, review [414094/KB308767] which provides the steps for generating the Transaction Objects Diagnostics report to see more details related to the issue.
<br>
<br>
Based on the error messages review the documents:
<br>
For error messages 95301, 95305 and 95330 review [2384637/KB535262] R12: PRC: Create Accounting Errors 95301, 95305 and 95330.<br>
For error message 95353 review [2329990/KB258016]  PAXACCPB PRC: Create Accounting Process Error 95353 - Subledger Accounting was unable to derive an accounting code combination using the account derivation rule Cost Adjustment Account Rule owned by Oracle. <br>
For error message 95349 review [2115389/KB525693] R12:PA: Create Accounting (PAXACCPB) Not Picking Up Revenue Events, Error Number 95349.<br>
For error message 95318 review [2493318/KB543201] PRC: Create Accounting program Returns Error 95318 For Revenue Adjustments "The account code combination id 0 specified for line does not exist."',
      p_success_msg            => 'There are no accounting errors for this project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: XLA_ACCOUNTING_ERRORS_FOR_PA_REVENUE');



debug('begin add_signature: XLA_AE_HEADERS_FOR_PA_DRAFT_REVENUES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14239',
      p_sig_id                 => 'XLA_AE_HEADERS_FOR_PA_DRAFT_REVENUES',
      p_sig_sql                => 'SELECT ah.* FROM xla_ae_headers ah WHERE ah.application_id =275 AND ah.event_id IN (SELECT EVENT_ID FROM PA_DRAFT_REVENUES_ALL WHERE project_id = ##$$PROJECT_ID$$## AND draft_revenue_num = NVL( ##$$DREV_NUM$$## , draft_revenue_num))',
      p_title                  => 'XLA Revenue In Header (XLA_AE_HEADERS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no accounting header information related to the project and draft revenue.',
      p_solution               => '',
      p_success_msg            => 'Accounting header information related to the project and draft revenue exists.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: XLA_AE_HEADERS_FOR_PA_DRAFT_REVENUES');



debug('begin add_signature: XLA_AE_LINES_FOR_PA_REVENUE_EVENT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14221',
      p_sig_id                 => 'XLA_AE_LINES_FOR_PA_REVENUE_EVENT',
      p_sig_sql                => 'SELECT al.* FROM xla_ae_lines al, xla_ae_headers ah WHERE ah.application_id =275 AND ah.event_id IN (SELECT EVENT_ID FROM PA_DRAFT_REVENUES_ALL WHERE project_id = ##$$PROJECT_ID$$## AND draft_revenue_num = NVL( ##$$DREV_NUM$$##, draft_revenue_num)) AND al.application_id = ah.application_id AND al.ae_header_id = ah.ae_header_id',
      p_title                  => 'XLA Revenue Lines (XLA_AE_LINES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no accounting line for the revenue event.',
      p_solution               => '',
      p_success_msg            => 'Accounting line exists for the revenue event.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: XLA_AE_LINES_FOR_PA_REVENUE_EVENT');



debug('begin add_signature: XLA_DISTRIBUTION_LINKS_FOR_PA_REVENUE_EVENT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14223',
      p_sig_id                 => 'XLA_DISTRIBUTION_LINKS_FOR_PA_REVENUE_EVENT',
      p_sig_sql                => 'SELECT dlnk.* FROM xla_distribution_links dlnk, xla_ae_headers ah WHERE ah.application_id = 275 AND ah.event_id IN (SELECT EVENT_ID FROM PA_DRAFT_REVENUES_ALL WHERE project_id = ##$$PROJECT_ID$$## AND draft_revenue_num = NVL( ##$$DREV_NUM$$##, draft_revenue_num)) AND dlnk.application_id = ah.application_id AND dlnk.event_id = ah.event_id AND dlnk.ae_header_id = ah.ae_header_id',
      p_title                  => 'XLA Revenue Event Distribution Links (XLA_DISTRIBUTION_LINKS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No account distribution for the revenue event.',
      p_solution               => '',
      p_success_msg            => 'Account distribution for the revenue event.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: XLA_DISTRIBUTION_LINKS_FOR_PA_REVENUE_EVENT');



debug('begin add_signature: XLA_EVENTS_FOR_PA_DRAFT_REVENUES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14238',
      p_sig_id                 => 'XLA_EVENTS_FOR_PA_DRAFT_REVENUES',
      p_sig_sql                => 'SELECT ev.* FROM xla_events ev WHERE ev.application_id = 275 AND ev.event_id IN (SELECT EVENT_ID FROM PA_DRAFT_REVENUES_ALL WHERE project_id = ##$$PROJECT_ID$$## AND draft_revenue_num = NVL( ##$$DREV_NUM$$## , draft_revenue_num))
',
      p_title                  => 'XLA Revenue With Events (XLA_EVENTS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No accounting event exists for the project and draft revenue selected.',
      p_solution               => '',
      p_success_msg            => ' Accounting event exists for the project and draft revenue selected.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: XLA_EVENTS_FOR_PA_DRAFT_REVENUES');



debug('begin add_signature: XLA_TRANSACTION_ENTITIES_FOR_PA_REVENUE_EVENT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14222',
      p_sig_id                 => 'XLA_TRANSACTION_ENTITIES_FOR_PA_REVENUE_EVENT',
      p_sig_sql                => 'SELECT ent.* FROM xla_events ev, xla.xla_transaction_entities ent WHERE ev.application_id = 275 AND ev.event_id IN (SELECT EVENT_ID FROM PA_DRAFT_REVENUES_ALL WHERE project_id = ##$$PROJECT_ID$$## AND draft_revenue_num = NVL( ##$$DREV_NUM$$##, draft_revenue_num)) AND ent.entity_id = ev.entity_id AND ent.application_id = ev.application_id',
      p_title                  => 'XLA Revenue Event Transaction Entities (XLA_TRANSACTION_ENTITIES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No accounting transaction exists for the revenue event.',
      p_solution               => '',
      p_success_msg            => 'Accounting transaction exists for the revenue event.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: XLA_TRANSACTION_ENTITIES_FOR_PA_REVENUE_EVENT');



debug('begin add_signature: EBS_FIN_PA_PERIODS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25516',
      p_sig_id                 => 'EBS_FIN_PA_PERIODS',
      p_sig_sql                => ' select period.* from (SELECT  per.*, per.status ||'' = ''|| nvl(lookup.meaning,''Null'') "Status|Meaning"
 FROM pa_periods_all per, PA_LOOKUPS lookup, pa_projects_all p, pa_implementations_all pia
 WHERE lookup.lookup_type = ''CLOSING STATUS''
 AND lookup.lookup_code (+) = per.status
 AND pia.org_id = p.org_id
 and per.org_id= pia.org_id
 and p.project_id =  ##$$PROJECT_ID$$##
 ORDER BY per.start_date desc) period
 where rownum <= 53',
      p_title                  => 'PA Periods',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'PA periods have not been defined.',
      p_solution               => '',
      p_success_msg            => 'PA periods have been defined. These are the most recent 52 periods defined.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PERIODS');



debug('begin add_signature: EBS_FIN_PA_LATEST_OPEN_PA_PERIOD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25526',
      p_sig_id                 => 'EBS_FIN_PA_LATEST_OPEN_PA_PERIOD',
      p_sig_sql                => 'SELECT distinct per.period_name,per.start_date, per.end_date 
FROM pa_periods_all per,
pa_projects_all p,
pa_implementations_all pia
where  per.start_date in (select max(i.start_date) from pa_periods_all i where status = ''O'' AND i.org_id = p.org_id)
AND pia.org_id = p.org_id
and per.org_id= pia.org_id
and p.project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Latest Open PA Period',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No latest open period exists.',
      p_solution               => '',
      p_success_msg            => 'Latest open period exists.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_LATEST_OPEN_PA_PERIOD');



debug('begin add_signature: EBS_FIN_PA_CURRENT_REPORTING_PERIOD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25524',
      p_sig_id                 => 'EBS_FIN_PA_CURRENT_REPORTING_PERIOD',
      p_sig_sql                => 'SELECT distinct per.period_name, per.start_date, per.end_date, decode(status,''O'',''Open'',''F'',''Future'',''Not Open'') status
FROM pa_periods_all per,
pa_projects_all p,
pa_implementations_all pia
WHERE  per.current_pa_period_flag = ''Y''
AND pia.org_id = p.org_id
and per.org_id = pia.org_id 
and p.project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Current PA Reporting Period',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Current PA reporting period not specified.',
      p_solution               => '',
      p_success_msg            => 'Current PA reporting period is specified.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_CURRENT_REPORTING_PERIOD');



debug('begin add_signature: EBS_FIN_PA_GL_DR_EXCEPT_DET');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24741',
      p_sig_id                 => 'EBS_FIN_PA_GL_DR_EXCEPT_DET',
      p_sig_sql                => 'select project_number, project_id, draft_revenue_num, gl_date, period_name, amount, transfer_rejection_reason, 
exception_reason, correction_action
from PA_GL_DR_EXCEPT_DET_V where org_id in (select org_id from pa_projects_all where project_id = ##$$PROJECT_ID$$## )
order by period_name asc',
      p_title                  => 'Revenue Exception Details (PA_GL_DR_EXCEPT_DET_V)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Draft revenues exist that prevent a period from being closed. ',
      p_solution               => 'Review the exception reason and corrective action returned.  Review the Projects tab in [335/KB212329] Period Close Advisor: E-Business Suite (EBS).',
      p_success_msg            => 'There are no draft revenues exist that prevent a period from being closed. ',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GL_DR_EXCEPT_DET');



debug('begin add_signature: PA_PATCH_ONE_OFFS_SINCE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5885',
      p_sig_id                 => 'PA_PATCH_ONE_OFFS_SINCE',
      p_sig_sql                => 'SELECT upper(prb.application_short_name) "Affected_App",
       ap.patch_name "Patch_Name",
       max(pr.start_date) "Applied_Date"
FROM ad_applied_patches ap,
     ad_patch_drivers pd,
     ad_patch_runs pr,
     ad_patch_run_bugs prb
WHERE pr.start_date > to_date(''##$$FK1$$##'')
...
AND   upper(prb.application_short_name) =''PA'' --in (''PA'',''GMS'',''OKE'')
GROUP BY ap.patch_name, prb.application_short_name
ORDER BY ap.patch_name,
         max(pr.start_date)',
      p_title                  => 'PA One-Offs Applied Since Last Patch Level',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No patches applied since upgrading to the current patch level.',
      p_solution               => '',
      p_success_msg            => 'List of patches applied since upgrading to the current patch level.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_PATCH_ONE_OFFS_SINCE');



debug('begin add_signature: PA_PATCH_LEVEL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5886',
      p_sig_id                 => 'PA_PATCH_LEVEL',
      p_sig_sql                => 'SELECT g.release_name "Apps_Version",
       i.version "DB_Version",
       pi.patch_level "Patch_Level",
       p.patchnum "Patch_Num",
       p.patchname "Patch_Name",
       p.creation_date "Date_Applied",
       p.creation_date "##$$FK1$$##"
FROM (
        SELECT distinct(patch_name) PatchNum,
               decode(patch_name,
                 ...
                 ''28493407'', ''(R12.PJ_PF.B.DELTA.8) Projects Upd Pack 8 for 12.1'',
                 ...
                 ''26787767'', ''Release Update Pack 12.2.8'',
                 ''26924444'', ''(R12.PJ_PF.C.DELTA.8) Projects Upd Pack 8 for 12.2'',
                 ''28840850'', ''Release Update Pack 12.2.9'',
                 ''28868281'', ''(R12.PJ_PF.C.DELTA.9) Projects Upd Pack 9 for 12.2'',
                ''30399999'', ''Release Update Pack 12.2.10'',
               ''30649738'', ''(R12.PJ_PF.C.DELTA.10) Projects Upd Pack 10 for 12.2'',
               ''31856789'', ''Release Update Pack 12.2.11'',
               ''32130609'', ''(R12.PJ_PF.C.DELTA.11) Projects Upd Pack 11 for 12.2'',
               ''33527700'', ''Release Update Pack 12.2.12'',
              ''33568654'', ''(R12.PJ_PF.C.DELTA.12) Projects Upd Pack 12 for 12.2'',
              ''34776655'', ''Release Update Pack 12.2.13'',
             ''34799247'', ''(R12.PJ_PF.C.DELTA.13) Projects Upd Pack 13 for 12.2'',
             ''36026788'', ''Release Update Pack 12.2.14'',
             ''36039524'', ''(R12.PJ_PF.C.DELTA.14) Projects Upd Pack 14 for 12.2''
               ) PatchName,
               creation_date
        FROM (SELECT patch_name, creation_date FROM ad_applied_patches UNION
              SELECT bug_number, creation_date  FROM ad_bugs)
        WHERE patch_name IN (
         ''5484000'',  ''6022657'', ''6141000'', ''6266113'', ''6435000'',
         ''6512963'',  ''6728000'', ''7292354'',  -- end R12.0
         ''7303030'',  ''7456340'', ''7303033'', ''8504800'', ''9239090'',
         ''9147711'', ''12378114'',''14162290'',''17839156'',''22687240'',
         ''28493407'', -- end R12.1
         ''14222221'',''14230739'',''16207672'',''16188964'',''17020683'',
         ''17027643'', ''17919161'',''17934640'',''19676458'',''19677790'',
         ''21900901'',''22116538'', ''24690690'',''24715258'',''26787767'',
         ''26924444'',''28840850'',''28868281'',  ''30399999'',  ''30649738'', ''31856789'', ''32130609'',''33568654'',''34799247'',''36039524'' -- end R12.2
        )
        ORDER BY decode(patch_name,
         ''5484000'',  1, ''6022657'', 2, ''6141000'', 2, ''6266113'', 4, ''6435000'', 5,
         ''6512963'',  6, ''6728000'', 7, ''7292354'', 8, -- end R12
         ''7303030'',  9, ''7456340'',10, ''7303033'',11, ''8504800'',12, ''9239090'',13,
         ''9147711'', 14,''12378114'',15,''14162290'',16,''17839156'',17,''22687240'',18,
         ''28493407'',19, -- end R12.1
         ''14222221'',31,''14230739'',32,''16207672'',33,''16188964'',34,''17020683'',35,
         ''17027643'',36,''17919161'',37,''17934640'',38,''19676458'',39,''19677790'',40,
         ''21900901'',41,''22116538'',42,''24690690'',43,''24715258'',44,''26787767'',45,
         ''26924444'',46,''28840850'',47,''28868281'',48, ''30399999'', 49, ''30649738'',50, ''31856789'',51, ''32130609'',52,
''33568654'',53,''34799247'',54,''36039524'',55, -- end R12.2
         100) desc, creation_date desc
     ) p,
     v$instance i,
     fnd_product_groups g,
     fnd_product_installations pi
WHERE pi.application_id = 275
AND   rownum = 1',
      p_title                  => 'Projects Patch Level',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Projects patch level.',
      p_solution               => '',
      p_success_msg            => 'Projects patch level.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('PA_PATCH_ONE_OFFS_SINCE'),
      p_include_in_dx_summary  => nvl('Y','N'),
      p_version                => '21'
      );
   l_info.delete;
debug('end add_signature: PA_PATCH_LEVEL');



debug('begin add_signature: EBS_FIN_PA_PAICGEN_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25943',
      p_sig_id                 => 'EBS_FIN_PA_PAICGEN_VERSIONS',
      p_sig_sql                => 'select distinct
af.filename,
...
order by
af.filename',
      p_title                  => 'PAICGEN File Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No PAICGEN file versions available.',
      p_solution               => 'PAICGEN file version details.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAICGEN_VERSIONS');



debug('begin add_signature: EBS_FIN_PA_PAIGEN_FILE_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25043',
      p_sig_id                 => 'EBS_FIN_PA_PAIGEN_FILE_VERSIONS',
      p_sig_sql                => 'select distinct
af.filename,
--substr(af.filename, instr(af.filename, ''.'') + 1) ext,
--af.app_short_name,
...
order by
af.filename',
      p_title                  => 'PAIGEN File Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No PAIGEN file versions available.',
      p_solution               => 'PAIGEN file version details.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAIGEN_FILE_VERSIONS');



debug('begin add_signature: EBS_FIN_PA_PARGDR_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25944',
      p_sig_id                 => 'EBS_FIN_PA_PARGDR_VERSIONS',
      p_sig_sql                => 'select distinct
af.filename,
--substr(af.filename, instr(af.filename, ''.'') + 1) ext,
--af.app_short_name,
...
order by
af.filename',
      p_title                  => 'PARGDR File Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No PARGDR file versions available.',
      p_solution               => 'PARGDR file version details.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PARGDR_VERSIONS');



debug('begin add_signature: EBS_FIN_PA_PARTAR_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25945',
      p_sig_id                 => 'EBS_FIN_PA_PARTAR_VERSIONS',
      p_sig_sql                => 'select distinct
af.filename,
--substr(af.filename, instr(af.filename, ''.'') + 1) ext,
--af.app_short_name,
...
order by
af.filename',
      p_title                  => 'PARTAR File Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No PARTAR file versions available.',
      p_solution               => 'PARTAR file version details.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PARTAR_VERSIONS');



debug('begin add_signature: EBS_FIN_PA_PATTAR_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25946',
      p_sig_id                 => 'EBS_FIN_PA_PATTAR_VERSIONS',
      p_sig_sql                => 'select distinct
af.filename,
--substr(af.filename, instr(af.filename, ''.'') + 1) ext,
--af.app_short_name,
...
order by
af.filename',
      p_title                  => 'PATTAR File Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No PATTAR file versions available.',
      p_solution               => 'PATTAR file version details.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PATTAR_VERSIONS');



debug('begin add_signature: EBS_FIN_PA_PATTGL_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25947',
      p_sig_id                 => 'EBS_FIN_PA_PATTGL_VERSIONS',
      p_sig_sql                => 'select distinct
af.filename,
--substr(af.filename, instr(af.filename, ''.'') + 1) ext,
--af.app_short_name,
...
order by
af.filename',
      p_title                  => 'PATTGL File Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No PATTGL file versions available.',
      p_solution               => 'PATTGL file version details.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PATTGL_VERSIONS');



debug('begin add_signature: EBS_FIN_PA_PATPOB_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25948',
      p_sig_id                 => 'EBS_FIN_PA_PATPOB_VERSIONS',
      p_sig_sql                => 'select distinct
af.filename,
--substr(af.filename, instr(af.filename, ''.'') + 1) ext,
--af.app_short_name,
...
order by
af.filename',
      p_title                  => 'PATPOB File Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No PATPOB file versions available.',
      p_solution               => 'PATPOB file version details.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PATPOB_VERSIONS');
...
debug('begin add_signature: PA_PROFILE_OPTION_VALUES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5992',
      p_sig_id                 => 'PA_PROFILE_OPTION_VALUES',
      p_sig_sql                => 'SELECT o.user_profile_option_name "Profile_Option",
       o.profile_option_name "System_Name",
       decode(v.level_id, 10001, ''Site'', 10002, ''Application'',
                          10003, ''Responsibility'') "Level",
       decode(v.level_id, 10001, ''Site'', 10002, a.application_name,
                          10003, r.responsibility_name) "Level_Value",
       v.profile_option_value "Profile_Value"
FROM fnd_profile_option_values v,
     fnd_profile_options_vl o,
     fnd_application_vl a,
     fnd_responsibility_vl r
WHERE o.application_id = 275
AND   v.level_id IN (10001,10002,10003)
AND   v.level_value =
           decode(v.level_id, 10003, r.responsibility_id,
...
ORDER BY o.user_profile_option_name, v.level_id,
         decode(v.level_id, 10001, ''Site'',  10002, a.application_name,
                            10003, r.responsibility_name)',
      p_title                  => 'Projects Profile Option Settings',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Projects profile option settings.',
      p_solution               => '',
      p_success_msg            => 'Profile option settings for Oracle Project Costing.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PROFILE_OPTION_VALUES');
...
debug('begin add_signature: PA_CREDIT_MEMO_ERROR_IN AR_AUTOINVOICE_IMPORT');
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_NONE';
   l_info('##MASK##INTERFACE_LINE_ATTRIBUTE3'):= 'DISPLAY_FIRST_4_CHAR';
   l_info('##MASK##INTERFACE_LINE_ATTRIBUTE4'):= 'DISPLAY_FIRST_4_CHAR';
   l_info('##MASK##INTERFACE_LINE_ATTRIBUTE5'):= 'DISPLAY_FIRST_4_CHAR';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14309',
      p_sig_id                 => 'PA_CREDIT_MEMO_ERROR_IN AR_AUTOINVOICE_IMPORT',
      p_sig_sql                => 'select distinct ractl.customer_trx_line_id, ractl.customer_trx_id, ractl.line_number, 
   ractl.set_of_books_id, ractl.quantity_invoiced, ractl.unit_selling_price, 
    ractl.line_type, ractl.interface_line_context, ractl.interface_line_attribute1, 
    ractl.interface_line_attribute3, ractl.interface_line_attribute4, ractl.org_id 
from ra_customer_trx_lines_all ractl, ra_customer_trx_all ract, 
     pa_draft_invoices_all di, pa_projects_all pa 
where ractl.customer_trx_id = ract.customer_trx_id 
    and ract.interface_header_attribute1 = pa.segment1 
    and pa.project_id = ##$$PROJECT_ID$$## 
    and ractl.customer_trx_id IN 
        (SELECT system_reference FROM pa_draft_invoices_all di
        WHERE di.transfer_status_code = ''A'' AND di.consolidated_inv_num IS NULL)
    AND interface_line_attribute9 is NULL
    AND interface_line_attribute10 is NULL
    AND interface_line_attribute11 is NULL AND line_type = ''LINE'' 
    AND exists (select 1 from fnd_product_groups where release_name like ''12.2%'')',
      p_title                  => 'Credit Memo Error: Invalid Reference Line Attribute Value',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Project billing credit memo errors in AR Autoinvoice Import.',
      p_solution               => 'Apply the solution from [2296934/KB764112]  RAXTRX: Project Billing Credit Memo Errors In AR Autoinvoice Import: Invalid reference line attribute value (REFERENCE_LINE_ATTRIBUTE1-15) ',
      p_success_msg            => 'There is no issue with credit memo.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_CREDIT_MEMO_ERROR_IN AR_AUTOINVOICE_IMPORT');



debug('begin add_signature: PA_DRAFT_REVENUES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14215',
      p_sig_id                 => 'PA_DRAFT_REVENUES_ALL',
      p_sig_sql                => 'SELECT * 
FROM PA_DRAFT_REVENUES_ALL 
WHERE project_id = ##$$PROJECT_ID$$##
AND draft_revenue_num = ##$$DREV_NUM$$##

/* SELECT r.* FROM PA_DRAFT_REVENUES_ALL r WHERE r.project_id = ##$$PROJECT_ID$$## AND r.draft_revenue_num = NVL( ##$$DREV_NUM$$## , r.draft_revenue_num) ORDER BY r.draft_revenue_num
*/',
      p_title                  => 'Draft Revenue Number ##$$DREV_NUM$$## (PA_DRAFT_REVENUES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no draft revenue generated.',
      p_solution               => '',
      p_success_msg            => 'Draft revenue number ##$$DREV_NUM$$## detail.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DRAFT_REVENUES_ALL');



debug('begin add_signature: PA_DRAFT_REVENUE_ITEMS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14216',
      p_sig_id                 => 'PA_DRAFT_REVENUE_ITEMS',
      p_sig_sql                => 'SELECT * 
FROM PA_DRAFT_REVENUE_ITEMS 
WHERE project_id = ##$$PROJECT_ID$$## 
AND draft_revenue_num = ##$$DREV_NUM$$##
ORDER BY line_num asc',
      p_title                  => 'Draft Revenue Items for Draft Revenue Number ##$$DREV_NUM$$## (PA_DRAFT_REVENUE_ITEMS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no draft revenue items generated for draft revenue number ##$$DREV_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'Draft revenue items for draft revenue number ##$$DREV_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DRAFT_REVENUE_ITEMS');



debug('begin add_signature: PA_CUST_REV_DIST_LINES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14217',
      p_sig_id                 => 'PA_CUST_REV_DIST_LINES_ALL',
      p_sig_sql                => 'SELECT *
FROM PA_CUST_REV_DIST_LINES_ALL 
WHERE project_id =##$$PROJECT_ID$$## 
AND draft_revenue_num = ##$$DREV_NUM$$##
order by draft_revenue_item_line_num asc, expenditure_item_id',
      p_title                  => 'Revenue Distribution Lines for Draft Revenue Number ##$$DREV_NUM$$## (PA_CUST_REV_DIST_LINES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no revenue distribution lines for this project and draft revenue number.',
      p_solution               => '',
      p_success_msg            => 'Revenue distribution lines exist for this project and draft revenue number.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_CUST_REV_DIST_LINES_ALL');



debug('begin add_signature: PA_CUST_EVENT_RDL_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14218',
      p_sig_id                 => 'PA_CUST_EVENT_RDL_ALL',
      p_sig_sql                => 'SELECT * 
FROM PA_CUST_EVENT_RDL_ALL
WHERE project_id = ##$$PROJECT_ID$$## 
AND draft_revenue_num = ##$$DREV_NUM$$##
order by draft_revenue_item_line_num asc',
      p_title                  => 'Event Revenue Distribution Lines for ##$$DREV_NUM$$## (PA_CUST_EVENT_RDL_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no event revenue distribution lines for this project and draft revenue number.',
      p_solution               => '',
      p_success_msg            => 'Event revenue distribution lines exist for this project and draft revenue number.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_CUST_EVENT_RDL_ALL');



debug('begin add_signature: PA_EXPENDITURE_ITEMS_WITH_REVENUE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14219',
      p_sig_id                 => 'PA_EXPENDITURE_ITEMS_WITH_REVENUE',
      p_sig_sql                => 'SELECT *
FROM PA_EXPENDITURE_ITEMS_ALL 
WHERE expenditure_item_id IN (SELECT expenditure_item_id FROM PA_CUST_REV_DIST_LINES_ALL WHERE project_id = ##$$PROJECT_ID$$## AND draft_revenue_num = ##$$DREV_NUM$$##) 
ORDER BY expenditure_item_id desc',
      p_title                  => ' Expenditure Items for Draft Revenue Number ##$$DREV_NUM$$## (PA_EXPENDITURE_ITEMS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no expenditure items for the project and draft revenue number.',
      p_solution               => '',
      p_success_msg            => 'Expenditure items exist for the project and draft revenue number.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_EXPENDITURE_ITEMS_WITH_REVENUE');



debug('begin add_signature: PA_EVENTS_REVENUE_RELATED');
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14220',
      p_sig_id                 => 'PA_EVENTS_REVENUE_RELATED',
      p_sig_sql                => 'SELECT e.*  
FROM   PA_EVENTS e 
WHERE  (e.project_id, e.event_num, nvl(e.task_id,-99)) 
IN  (SELECT rdl.project_id, rdl.event_num, nvl(rdl.task_id,-99) 
FROM PA_CUST_EVENT_RDL_ALL rdl     
WHERE  rdl.project_id =##$$PROJECT_ID$$##     
AND    rdl.draft_revenue_num = ##$$DREV_NUM$$##)
order by task_id, event_num',
      p_title                  => 'Event Details for Draft Revenue Number ##$$DREV_NUM$$## (PA_EVENTS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no events associated with the project and draft revenue number.',
      p_solution               => '',
      p_success_msg            => 'Event(s) exists for the project and draft revenue number.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_EVENTS_REVENUE_RELATED');



debug('begin add_signature: PA_DRAFT_REVENUE_NUM_CREDITED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14279',
      p_sig_id                 => 'PA_DRAFT_REVENUE_NUM_CREDITED',
      p_sig_sql                => 'SELECT * FROM pa_draft_revenues_all 
where project_id = ##$$PROJECT_ID$$##
    and draft_revenue_num_credited = ##$$DREV_NUM$$##',
      p_title                  => 'Credited Revenue For Draft Revenue Number ##$$DREV_NUM$$##',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No credited revenue exists.',
      p_solution               => '',
      p_success_msg            => 'Credited revenue exists.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DRAFT_REVENUE_NUM_CREDITED');



debug('begin add_signature: PA_DRAFT_INVOICES_ALL');
   l_info('##MASK##INVOICE_COMMENT'):= 'DISPLAY_FIRST_4_CHAR';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14225',
      p_sig_id                 => 'PA_DRAFT_INVOICES_ALL',
      p_sig_sql                => 'select * 
from PA_DRAFT_INVOICES_ALL 
where project_id = ##$$PROJECT_ID$$##
and draft_invoice_num = ##$$DINV_NUM$$##
',
      p_title                  => 'Draft Invoice Number ##$$DINV_NUM$$## (PA_DRAFT_INVOICES_ALL )',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no draft invoice generated. ',
      p_solution               => '',
      p_success_msg            => 'Draft invoice number ##$$DINV_NUM$$## detail.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DRAFT_INVOICES_ALL');



debug('begin add_signature: PA_DRAFT_INVOICE_ITEMS');
   l_info('##MASK##TEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22240',
      p_sig_id                 => 'PA_DRAFT_INVOICE_ITEMS',
      p_sig_sql                => 'SELECT * 
FROM PA_DRAFT_INVOICE_ITEMS 
WHERE project_id = ##$$PROJECT_ID$$## 
AND draft_invoice_num = ##$$DINV_NUM$$##
ORDER BY line_num asc',
      p_title                  => 'Draft Invoice Items for Draft Invoice Number ##$$DINV_NUM$$## (PA_DRAFT_INVOICE_ITEMS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no draft invoice items generated for draft invoice number ##$$DINV_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'Draft invoice items for draft invoice number ##$$DINV_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DRAFT_INVOICE_ITEMS');



debug('begin add_signature: PA_DRAFT_INVOICE_NUM_CREDITED');
   l_info('##MASK##INVOICE_COMMENT'):= 'DISPLAY_FIRST_4_CHAR';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14280',
      p_sig_id                 => 'PA_DRAFT_INVOICE_NUM_CREDITED',
      p_sig_sql                => 'select di.*  
from PA_DRAFT_INVOICES_ALL di 
where di.draft_invoice_num in 
    (select draft_invoice_num_credited from PA_DRAFT_INVOICES_ALL dic 
    where dic.draft_invoice_num = ##$$DINV_NUM$$##
    AND dic.project_id = ##$$PROJECT_ID$$##)
    AND di.project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Credited Invoices Generated For Draft Invoice Number ##$$DINV_NUM$$##',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Credit invoice for draft invoice number ##$$DINV_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'No credit invoice exists for draft invoice number ##$$DINV_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DRAFT_INVOICE_NUM_CREDITED');



debug('begin add_signature: EBS_FIN_PA_PAPJB_PA_CUST_REV_DIST_LINES_INVOICE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25904',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_PA_CUST_REV_DIST_LINES_INVOICE',
      p_sig_sql                => 'SELECT *  
FROM   PA_CUST_REV_DIST_LINES_ALL 
WHERE  project_id = ##$$PROJECT_ID$$##
AND    draft_invoice_num = ##$$DINV_NUM$$##
order by draft_revenue_item_line_num asc, expenditure_item_id',
      p_title                  => 'Revenue Distribution Line(s) for Draft Invoice Number ##$$DINV_NUM$$## (PA_CUST_REV_DIST_LINES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No revenue distribution line(s) exist for draft invoice number ##$$DINV_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'Revenue distribution line(s) exist for draft invoice number ##$$DINV_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_PA_CUST_REV_DIST_LINES_INVOICE');



debug('begin add_signature: EBS_FIN_PA_PAPJB_PA_CUST_EVENT_RDL_INVOICE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25940',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_PA_CUST_EVENT_RDL_INVOICE',
      p_sig_sql                => 'SELECT rdl.*  
FROM   PA_CUST_EVENT_RDL_ALL rdl  
WHERE  rdl.project_id = ##$$PROJECT_ID$$##
AND    rdl.draft_invoice_num = ##$$DINV_NUM$$##',
      p_title                  => 'Event Revenue Distribution Line(s) for Draft Invoice Number ##$$DINV_NUM$$## (PA_CUST_EVENT_RDL_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No event revenue distribution line(s) exists for draft invoice number ##$$DINV_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'Event revenue distribution line(s) exists for draft invoice number ##$$DINV_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_PA_CUST_EVENT_RDL_INVOICE');



debug('begin add_signature: EBS_FIN_PA_PAPJB_PA_EXP_ITEMS_ALL_INV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25941',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_PA_EXP_ITEMS_ALL_INV',
      p_sig_sql                => 'SELECT *  
FROM PA_EXPENDITURE_ITEMS_ALL 
...
AND draft_invoice_num = ##$$DINV_NUM$$##)
ORDER BY expenditure_item_id desc',
      p_title                  => 'Expenditure Item(s) for Draft Invoice Number ##$$DINV_NUM$$## (PA_EXPENDITURE_ITEMS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No expenditure item(s) exists for draft invoice number ##$$DINV_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'Expenditure item(s) exists for draft invoice number ##$$DINV_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_PA_EXP_ITEMS_ALL_INV');



debug('begin add_signature: EBS_FIN_PA_PAPJB_PA_EVENTS_INVOICE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25942',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_PA_EVENTS_INVOICE',
      p_sig_sql                => 'SELECT e.*  
  FROM PA_EVENTS e  
 WHERE  (e.project_id, e.event_num, nvl(e.task_id,-99)) IN (SELECT di.project_id, di.event_num, 
                                                                                                                            nvl(di.event_task_id,-99)     
                                                                                                               FROM PA_DRAFT_INVOICE_ITEMS di     
                                                                                                        WHERE di.project_id = ##$$PROJECT_ID$$##     
                                                                                             AND di.draft_invoice_num = ##$$DINV_NUM$$## )',
      p_title                  => 'Project Events for a Draft Invoice Number ##$$DINV_NUM$$## (PA_EVENTS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No event exists for draft invoice number ##$$DINV_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'Event exists for draft invoice number ##$$DINV_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_PA_EVENTS_INVOICE');



debug('begin add_signature: PA_RA_INTERFACE_LINES_ALL');
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##INTERFACE_LINE_ATTRIBUTE2'):= 'DISPLAY_FIRST_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20176',
      p_sig_id                 => 'PA_RA_INTERFACE_LINES_ALL',
      p_sig_sql                => 'select * from RA_INTERFACE_LINES_ALL where interface_line_attribute1 = (select segment1 from pa_projects_all where project_id = ##$$PROJECT_ID$$##)
AND interface_line_attribute2 = nvl(''##$$DINV_NUM$$##'',interface_line_attribute2)

',
      p_title                  => 'AR Interface Lines Detail for Draft Invoice Number ##$$DINV_NUM$$## (RA_INTERFACE_LINES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no AR interface line details related to Draft Invoice Number ##$$DINV_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'AR interface line details related to Draft Invoice Number ##$$DINV_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_RA_INTERFACE_LINES_ALL');



debug('begin add_signature: PA_RA_INTERFACE_DISTRIBUTIONS_ALL');
   l_info('##MASK##INTERFACE_LINE_ATTRIBUTE4'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20177',
      p_sig_id                 => 'PA_RA_INTERFACE_DISTRIBUTIONS_ALL',
      p_sig_sql                => 'select * from RA_INTERFACE_DISTRIBUTIONS_ALL where interface_line_attribute1 like (select segment1 from pa_projects_all where project_id = ##$$PROJECT_ID$$##)
AND interface_line_attribute2 = nvl(''##$$DINV_NUM$$##'',interface_line_attribute2)
',
      p_title                  => 'AR Interface Distributions Detail for Draft Invoice Number ##$$DINV_NUM$$## (RA_INTERFACE_DISTRIBUTIONS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no Receivable interface distribution details for draft invoice number ##$$DINV_NUM$$##.
',
      p_solution               => '',
      p_success_msg            => 'Receivable interface distribution details for draft invoice number ##$$DINV_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_RA_INTERFACE_DISTRIBUTIONS_ALL');



debug('begin add_signature: PA_RA_INTERFACE_SALESCREDITS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20182',
      p_sig_id                 => 'PA_RA_INTERFACE_SALESCREDITS_ALL',
      p_sig_sql                => 'select * from RA_INTERFACE_SALESCREDITS_ALL where interface_line_attribute1 = (select segment1 from pa_projects_all where project_id = ##$$PROJECT_ID$$##)
AND interface_line_attribute2 = nvl(''##$$DINV_NUM$$##'',interface_line_attribute2)
',
      p_title                  => 'AR Sales Credit Information for Draft Invoice Number ##$$DINV_NUM$$## (RA_INTERFACE_SALESCREDITS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no sales credit information for draft invoice number ##$$DINV_NUM$$##.
',
      p_solution               => '',
      p_success_msg            => 'Sales credit information for draft invoice number ##$$DINV_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_RA_INTERFACE_SALESCREDITS_ALL');



debug('begin add_signature: PA_RA_INTERFACE_ERRORS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20181',
      p_sig_id                 => 'PA_RA_INTERFACE_ERRORS_ALL',
      p_sig_sql                => 'select err.interface_line_id, err.interface_salescredit_id, err.interface_distribution_id, err.message_text, err.invalid_value, 
lines.interface_line_attribute1, lines.interface_line_attribute2
FROM ra_interface_errors_all err,
     ra_interface_lines_all lines 
WHERE err.interface_line_id = lines.interface_line_id 
AND lines.interface_line_attribute1 = (select segment1 from pa_projects_all where project_id =  ##$$PROJECT_ID$$##)
AND lines.interface_line_attribute2 = nvl(''##$$DINV_NUM$$##'', lines.interface_line_attribute2)



',
      p_title                  => 'AR Interface Errors for Draft Invoice Number ##$$DINV_NUM$$## (RA_INTERFACE_ERRORS_ALL)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are AR interface errors for ##$$DINV_NUM$$##.
',
      p_solution               => 'The interface data needs to be fixed. For more information, review [1089172/KB769440] Troubleshooting Autoinvoice Import - Execution Report Errors (Request Status = Completed)',
      p_success_msg            => 'There are no AR interface errors for draft invoice number ##$$DINV_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_RA_INTERFACE_ERRORS_ALL');



debug('begin add_signature: EBS_FIN_PA_PAPJB_RA_CUST_TRX_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26494',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_RA_CUST_TRX_TYPES',
      p_sig_sql                => 'SELECT * FROM ra_cust_trx_types_all 
WHERE cust_trx_type_id IN (SELECT cust_trx_type_id FROM RA_CUSTOMER_TRX_ALL WHERE interface_header_attribute1 = (SELECT segment1 FROM pa_projects_all WHERE project_id = ##$$PROJECT_ID$$##) AND interface_header_attribute2 = ''##$$DINV_NUM$$##'') ',
      p_title                  => 'Transaction Type For Invoice ##$$DINV_NUM$$##',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No transaction type information exists for invoice.',
      p_solution               => '',
      p_success_msg            => 'Transaction type associated to Invoices created for project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_RA_CUST_TRX_TYPES');



debug('begin add_signature: EBS_FIN_PA_INV_RA_CUST_TRX_ALL');
   l_info('##MASK##INTERFACE_HEADER_ATTRIBUTE5'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26021',
      p_sig_id                 => 'EBS_FIN_PA_INV_RA_CUST_TRX_ALL',
      p_sig_sql                => 'select * from RA_CUSTOMER_TRX_ALL where interface_header_attribute1 = (select segment1 from pa_projects_all where project_id = ##$$PROJECT_ID$$##)
AND interface_header_attribute2 = nvl(''##$$DINV_NUM$$##'',interface_header_attribute2)',
      p_title                  => 'AR Header Information for Draft Invoice Number ##$$DINV_NUM$$## (RA_CUSTOMER_TRX_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no header level information related to draft invoice number ##$$DINV_NUM$$##.
',
      p_solution               => '',
      p_success_msg            => 'Header level information related to draft invoice number ##$$DINV_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_INV_RA_CUST_TRX_ALL');



debug('begin add_signature: EBS_FIN_PA_INV_RA_CUST_TRX_LINES_ALL');
   l_info('##MASK##INTERFACE_LINE_ATTRIBUTE5'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26022',
      p_sig_id                 => 'EBS_FIN_PA_INV_RA_CUST_TRX_LINES_ALL',
      p_sig_sql                => 'select * from RA_CUSTOMER_TRX_LINES_ALL where interface_line_attribute1 = (select segment1 from pa_projects_all where project_id = ##$$PROJECT_ID$$##)
AND interface_line_attribute2 = nvl(''##$$DINV_NUM$$##'',interface_line_attribute2)
',
      p_title                  => 'AR Lines Information for Draft Invoice Number ##$$DINV_NUM$$## (RA_CUSTOMER_TRX_LINES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no line level information related to draft invoice number ##$$DINV_NUM$$##.
',
      p_solution               => '',
      p_success_msg            => ' Line level information related to draft invoice number ##$$DINV_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_INV_RA_CUST_TRX_LINES_ALL');



debug('begin add_signature: EBS_FIN_PA_INV_RA_CUST_TRX_LINE_GL_DIST_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26023',
      p_sig_id                 => 'EBS_FIN_PA_INV_RA_CUST_TRX_LINE_GL_DIST_ALL',
      p_sig_sql                => 'select * from RA_CUST_TRX_LINE_GL_DIST_ALL where customer_trx_id in
  (select customer_trx_id from ra_customer_trx_all
   where  interface_header_attribute1 = 
  (select segment1 from pa_projects_all where project_id = ##$$PROJECT_ID$$##)
and interface_header_attribute2 = nvl(''##$$DINV_NUM$$##'',interface_header_attribute2))
 order by cust_trx_line_gl_dist_id asc
',
      p_title                  => 'AR Transaction Line Distribution Details for Draft Invoice Number ##$$DINV_NUM$$## (RA_CUST_TRX_LINE_GL_DIST_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no accounting records for revenue, unearned revenue and unbilled receivables in AR for draft invoice number ##$$DINV_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'Accounting records for revenue, unearned revenue and unbilled receivables in AR for draft invoice number ##$$DINV_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_INV_RA_CUST_TRX_LINE_GL_DIST_ALL');



debug('begin add_signature: PA_TASK_READY_TO_BILL_FLAG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22229',
      p_sig_id                 => 'PA_TASK_READY_TO_BILL_FLAG',
      p_sig_sql                => 'select event_id, task_id,  project_id,
       event_num, 
       (select task_number from pa_tasks tx
         where tx.task_id = e.task_id) task_number 
     from pa_events e 
  where ((e.task_id is not null
        and exists (select 1
               from pa_tasks t1,
                    pa_tasks t2
              where t1.project_id = e.project_id
                and t1.task_id = e.task_id
                and t1.top_task_id = t2.task_id
                and (t1.billable_flag = ''N''
                 or NVL(t2.ready_to_bill_flag,''N'') = ''N'')))
     or nvl(e.bill_hold_flag, ''N'') = ''Y'')
     and e.project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Task Eligible for Invoice Generation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Either Task is not ready to bill or bill hold is applied to event or task is not billable.',
      p_solution               => 'Please go through solution mentioned in below Notes:<br>
[2049674/KB490383] PAIGEN Draft Invoice is not Generating Invoice for Event',
      p_success_msg            => 'All tasks are eligible for invoice generation. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_TASK_READY_TO_BILL_FLAG');



debug('begin add_signature: EBS_FIN_PA_PAPJB_CONSOLIDATED_INV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24849',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_CONSOLIDATED_INV',
      p_sig_sql                => 'SELECT
    *
FROM
    pa_draft_consolidated_inv_all
WHERE
    bill_group_id IN (
        SELECT
            bill_group_id
    ...
    and draft_invoice_num = nvl(##$$DINV_NUM$$##,draft_invoice_num)',
      p_title                  => 'Consolidated Invoices (PA_DRAFT_CONSOLIDATED_INV_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No consolidated invoice generated for project',
      p_solution               => '',
      p_success_msg            => 'PA_DRAFT_CONSOLIDATED_INV_ALL contains consolidated invoices for project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_CONSOLIDATED_INV');



debug('begin add_signature: EBS_FIN_PA_EXPENDITURE_GROUPS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26100',
      p_sig_id                 => 'EBS_FIN_PA_EXPENDITURE_GROUPS_ALL',
      p_sig_sql                => 'select * from pa_expenditure_groups_all
where expenditure_group in (select expenditure_group from pa_expenditures_all
where expenditure_id in (select expenditure_id from pa_expenditure_items_all
where expenditure_item_id = ##$$EI_ID$$##))',
      p_title                  => 'Expenditure Group for Expenditure Item ID ##$$EI_ID$$## (PA_EXPENDITURE_GROUPS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no expenditure group details for expenditure item ID ##$$EI_ID$$## .',
      p_solution               => '',
      p_success_msg            => 'Expenditure group details for expenditure item ID ##$$EI_ID$$## .',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_EXPENDITURE_GROUPS_ALL');



debug('begin add_signature: EBS_FIN_PA_EXPENDITURES_ALL');
   l_info('##MASK##ENTERED_BY_PERSON_ID'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##INCURRED_BY_PERSON_ID'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##OVERRIDING_APPROVER_PERSON_ID'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##VENDOR_ID'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26101',
      p_sig_id                 => 'EBS_FIN_PA_EXPENDITURES_ALL',
      p_sig_sql                => 'select * from pa_expenditures_all
where expenditure_id in (select expenditure_id from pa_expenditure_items_all
where expenditure_item_id = ##$$EI_ID$$##)',
      p_title                  => 'Expenditure Details for Expenditure Item ID ##$$EI_ID$$## (PA_EXPENDITURES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no expenditure details for expenditure item ID ##$$EI_ID$$## .',
      p_solution               => '',
      p_success_msg            => 'Expenditure details for expenditure item ID ##$$EI_ID$$## .',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_EXPENDITURES_ALL');



debug('begin add_signature: EBS_FIN_PA_EXPENDITURE_ITEMS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26102',
      p_sig_id                 => 'EBS_FIN_PA_EXPENDITURE_ITEMS_ALL',
      p_sig_sql                => 'select * from pa_expenditure_items_all
where expenditure_item_id = ##$$EI_ID$$##',
      p_title                  => 'Expenditure Item Details for Expenditure Item ID ##$$EI_ID$$## (PA_EXPENDITURE_ITEMS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no expenditure item details for expenditure item ID ##$$EI_ID$$## .',
      p_solution               => '',
      p_success_msg            => 'Expenditure item details for expenditure item ID ##$$EI_ID$$## .',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_EXPENDITURE_ITEMS_ALL');



debug('begin add_signature: EBS_FIN_PA_COST_DISTRIBUTION_LINES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26103',
      p_sig_id                 => 'EBS_FIN_PA_COST_DISTRIBUTION_LINES_ALL',
      p_sig_sql                => 'select * from pa_cost_distribution_lines_all
where expenditure_item_id = ##$$EI_ID$$##
order by line_num asc',
      p_title                  => 'Cost Distribution Line Details for Expenditure Item ID ##$$EI_ID$$## (PA_COST_DISTRIBUTION_LINES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no cost distribution line details for expenditure item ID ##$$EI_ID$$## .',
      p_solution               => '',
      p_success_msg            => 'Cost distribution line details for expenditure item ID ##$$EI_ID$$##. <br>
For details related to the transfer_status code review [558574/KB502044] What Are The Values For The TRANSFER_STATUS_CODE In The PA_COST_DISTRIBUTION_LINES_ALL Table? 
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_COST_DISTRIBUTION_LINES_ALL');



debug('begin add_signature: EBS_FIN_PA_EXPEND_ITEM_ADJ_ACTIVITIES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26110',
      p_sig_id                 => 'EBS_FIN_PA_EXPEND_ITEM_ADJ_ACTIVITIES',
      p_sig_sql                => 'SELECT adj.*, cpt.user_concurrent_program_name, cp.concurrent_program_name
FROM pa_expend_item_adj_activities adj, fnd_concurrent_programs cp, fnd_concurrent_programs_vl cpt 
 WHERE adj.expenditure_item_id = ##$$EI_ID$$## 
  AND cp.concurrent_program_id (+) = adj.program_id
  AND cp.application_id (+) = adj.program_application_id
  AND cpt.concurrent_program_id (+) = cp.concurrent_program_id
  AND cpt.application_id (+) = cp.application_id
ORDER BY adj.activity_date',
      p_title                  => 'Adjustment Activity For Expenditure Item ID ##$$EI_ID$$##',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no adjustment activities for expenditure item ID ##$$EI_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Adjustment activities exist for expenditure item ID ##$$EI_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_EXPEND_ITEM_ADJ_ACTIVITIES');



debug('begin add_signature: EBS_FIN_PA_DRAFT_REVENUES_ALL_EI');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26105',
      p_sig_id                 => 'EBS_FIN_PA_DRAFT_REVENUES_ALL_EI',
      p_sig_sql                => 'SELECT  dr.*  
FROM PA_DRAFT_REVENUES_ALL dr  
WHERE (dr.project_id, dr.draft_revenue_num) IN (SELECT rdl.project_id, rdl.draft_revenue_num FROM PA_CUST_REV_DIST_LINES_ALL rdl  WHERE rdl.expenditure_item_id = ##$$EI_ID$$##)
order by draft_revenue_num asc',
      p_title                  => 'Draft Revenue for Expenditure Item ID ##$$EI_ID$$## (PA_DRAFT_REVENUES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no draft revenue for the expenditure item ##$$EI_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Draft revenue exists for the expenditure item ##$$EI_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_DRAFT_REVENUES_ALL_EI');



debug('begin add_signature: EBS_FIN_PA_DRAFT_REVENUE_ITEMS_EI');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26106',
      p_sig_id                 => 'EBS_FIN_PA_DRAFT_REVENUE_ITEMS_EI',
      p_sig_sql                => 'SELECT  *  
FROM PA_DRAFT_REVENUE_ITEMS dri  
WHERE (dri.project_id, dri.draft_revenue_num, dri.line_num) IN (SELECT rdl.project_id,
rdl.draft_revenue_num, rdl.draft_revenue_item_line_num FROM PA_CUST_REV_DIST_LINES_ALL rdl WHERE rdl.expenditure_item_id = ##$$EI_ID$$##) ',
      p_title                  => 'Draft Revenue Items for Expenditure Item ID ##$$EI_ID$$## (PA_DRAFT_REVENUE_ITEMS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no draft revenue items generated for expenditure item ID ##$$EI_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Draft revenue items for expenditure item ID ##$$EI_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_DRAFT_REVENUE_ITEMS_EI');



debug('begin add_signature: EBS_FIN_PA_PA_CUST_REV_DIST_LINES_EI');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26107',
      p_sig_id                 => 'EBS_FIN_PA_PA_CUST_REV_DIST_LINES_EI',
      p_sig_sql                => 'SELECT *  
FROM PA_CUST_REV_DIST_LINES_ALL rdl  
WHERE rdl.expenditure_item_id =##$$EI_ID$$##
order by draft_revenue_num asc',
      p_title                  => 'Revenue Distribution Line(s) for Expenditure Item ID ##$$EI_ID$$## (PA_CUST_REV_DIST_LINES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No revenue distribution line(s) exist for expenditure item ID ##$$EI_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Revenue distribution line(s) exist for expenditure item ID ##$$EI_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_CUST_REV_DIST_LINES_EI');



debug('begin add_signature: EBS_FIN_PA_DRAFT_INVOICES_ALL_EI');
   l_info('##MASK##INVOICE_COMMENT'):= 'DISPLAY_FIRST_4_CHAR';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26108',
      p_sig_id                 => 'EBS_FIN_PA_DRAFT_INVOICES_ALL_EI',
      p_sig_sql                => 'SELECT  dii.*  
FROM PA_DRAFT_INVOICES_ALL dii  
WHERE dii.draft_invoice_num in 
(select rdl.draft_invoice_num 
from PA_CUST_REV_DIST_LINES_ALL rdl
where rdl.expenditure_item_id = ##$$EI_ID$$##
AND dii.project_id = rdl.project_id
AND dii.draft_invoice_num = rdl.draft_invoice_num )
order by draft_invoice_num asc',
      p_title                  => 'Draft Invoice For Expenditure Item ID ##$$EI_ID$$## (PA_DRAFT_INVOICES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No draft invoice exists for expenditure item ID ##$$EI_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Draft invoice exists for expenditure item ID ##$$EI_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_DRAFT_INVOICES_ALL_EI');



debug('begin add_signature: EBS_FIN_PA_DRAFT_INVOICE_ITEMS_EI');
   l_info('##MASK##TEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26109',
      p_sig_id                 => 'EBS_FIN_PA_DRAFT_INVOICE_ITEMS_EI',
      p_sig_sql                => 'SELECT  dii.*,rdl.draft_revenue_num, rdl.draft_revenue_item_line_num  
FROM PA_CUST_REV_DIST_LINES_ALL rdl, PA_DRAFT_INVOICE_ITEMS dii  
WHERE rdl.expenditure_item_id = ##$$EI_ID$$##
AND dii.project_id = rdl.project_id  
AND dii.draft_invoice_num = rdl.draft_invoice_num  
AND dii.line_num = rdl.draft_invoice_item_line_num',
      p_title                  => 'Draft Invoice Items for Expenditure Item ID ##$$EI_ID$$## (PA_DRAFT_INVOICE_ITEMS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No draft invoice items exist for expenditure item ID ##$$EI_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Draft invoice items exist for expenditure item ID ##$$EI_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_DRAFT_INVOICE_ITEMS_EI');



debug('begin add_signature: PA_COST_TRANSACTION_CONTROLS');
   l_info('##MASK##EMPLOYEE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10321',
      p_sig_id                 => 'PA_COST_TRANSACTION_CONTROLS',
      p_sig_sql                => 'SELECT tc.* ,
  proj.segment1 "Project_Number" ,
  task.task_number "Task_Number" ,
  person.full_name "Employee" ,
  lookup.meaning "Billable_Indicator"
FROM PA_TRANSACTION_CONTROLS tc ,
  ...
  (select lookup_type, lookup_code, meaning
             ...
             where language = ''US'' 
             and view_application_id = 275 
             and SECURITY_GROUP_ID = 0) lookup
WHERE  tc.project_id   = proj.project_id
AND tc.task_id      = task.task_id (+)
AND tc.person_id    = person.person_id (+)
AND tc.start_date_active BETWEEN NVL(person.effective_start_date, tc.start_date_active) AND NVL(person.effective_end_date, tc.start_date_active+1)
AND lookup.lookup_type    = ''BILLABLE INDICATOR''
AND tc.billable_indicator = lookup.lookup_code (+)
AND proj.project_id = pei.project_id
and task.task_id(+) = pei.task_id
and proj.org_id = pei.org_id
and pei.Expenditure_Item_Id=##$$P_EXPENDITURE_ITEM_ID$$##
ORDER BY tc.task_id',
      p_title                  => 'Transaction Controls',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No transaction controls found for this expenditure item''s project or task.',
      p_solution               => '',
      p_success_msg            => 'PA_TRANSACTION_CONTROLS table stores the transaction controls defined for projects or tasks. <br>
Transaction controls are used to control what expenditure items can be charged to a particular project or task, and whether the items are non-billable.<br>
You can configure transaction controls by employee, expenditure category, expenditure type, and non-labor resource.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_TRANSACTION_CONTROLS');



debug('begin add_signature: EBS_FIN_PA_PAPJB_PA_EVENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25978',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_PA_EVENTS',
      p_sig_sql                => 'select * from PA_EVENTS where project_id = ##$$PROJECT_ID$$##
and event_id = ##$$EVENT_ID$$##',
      p_title                  => 'Project Event For Event ID ##$$EVENT_ID$$## (PA_EVENTS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no event associated with event ID ##$$EVENT_ID$$##.
',
      p_solution               => '',
      p_success_msg            => 'Event exists for event ID ##$$EVENT_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_PA_EVENTS');



debug('begin add_signature: EBS_FIN_PA_PAPJB_PA_DRAFT_REVENU_EVENT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25979',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_PA_DRAFT_REVENU_EVENT',
      p_sig_sql                => 'SELECT dr.*
FROM pa_cust_event_rdl_all rdl,
     pa_events ev,
     pa_draft_revenues_all dr
WHERE rdl.project_id = ev.project_id
AND nvl(rdl.task_id,-99) = nvl(ev.task_id,-99)
  AND rdl.event_num = ev.event_num
  AND ev.event_id = ##$$EVENT_ID$$##
  AND ev.project_id = ##$$PROJECT_ID$$##
  AND rdl.project_id = dr.project_id
  AND rdl.draft_revenue_num = dr.draft_revenue_num
 AND rownum <100',
      p_title                  => 'Draft Revenue For Event ID ##$$EVENT_ID$$## (PA_DRAFT_REVENUES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no draft revenue for event ID ##$$EVENT_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Draft revenue exists for event ID ##$$EVENT_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_PA_DRAFT_REVENU_EVENT');



debug('begin add_signature: EBS_FIN_PA_PAPJB_PA_DRAFT_REVENUE_ITEMS_EVENT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25980',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_PA_DRAFT_REVENUE_ITEMS_EVENT',
      p_sig_sql                => 'SELECT dri.*
FROM pa_cust_event_rdl_all rdl,
     pa_events ev,
...
AND nvl(rdl.task_id,-99) = nvl(ev.task_id,-99)
  ...
  AND ev.event_id = ##$$EVENT_ID$$##
  AND ev.project_id = ##$$PROJECT_ID$$## 
  AND rdl.project_id = dri.project_id
  AND rdl.draft_revenue_num = dri.draft_revenue_num
  AND rdl.draft_revenue_item_line_num = dri.line_num
  AND rownum < 200',
      p_title                  => 'Draft Revenue Items For Event ID ##$$EVENT_ID$$## (PA_DRAFT_REVENUE_ITEMS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no draft revenue items for event ID ##$$EVENT_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Draft revenue items exist for event ID ##$$EVENT_ID$$##.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_PA_DRAFT_REVENUE_ITEMS_EVENT');



debug('begin add_signature: EBS_FIN_PA_PAPJB_PA_CUST_EVENT_RDL_EVENT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25981',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_PA_CUST_EVENT_RDL_EVENT',
      p_sig_sql                => 'SELECT rdl.*
FROM pa_cust_event_rdl_all rdl,
     pa_events ev
WHERE rdl.project_id = ev.project_id
AND nvl(rdl.task_id,-99) = nvl(ev.task_id,-99)
  ...
  AND ev.project_id = ##$$PROJECT_ID$$##
  AND rownum < 200',
      p_title                  => 'Event Revenue Distribution Line For Event ID ##$$EVENT_ID$$## (PA_CUST_EVENT_RDL_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No event revenue distribution line exists for event ID ##$$EVENT_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Event revenue distribution line exists for event ID ##$$EVENT_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_PA_CUST_EVENT_RDL_EVENT');



debug('begin add_signature: EBS_FIN_PA_PAPJB_DRAFT_INVOICES_EVENT');
   l_info('##MASK##INVOICE_COMMENT'):= 'DISPLAY_FIRST_4_CHAR';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26034',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_DRAFT_INVOICES_EVENT',
      p_sig_sql                => 'SELECT di.*
FROM pa_draft_invoices_all di, 
            pa_draft_invoice_items dii,
            pa_events ev
WHERE dii.project_id = ev.project_id
  AND NVL(dii.event_task_id,-99) = NVL(ev.task_id,-99)
  AND dii.event_num = ev.event_num
  AND ev.event_id = ##$$EVENT_ID$$##
  AND ev.project_id = ##$$PROJECT_ID$$##
  AND di.project_id = dii.project_id
  AND di.draft_invoice_num = dii.draft_invoice_num',
      p_title                  => 'Draft Invoice For Event ID ##$$EVENT_ID$$## (PA_DRAFT_INVOICES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no draft invoice generated for event ID ##$$EVENT_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Draft invoice generated for event ID ##$$EVENT_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_DRAFT_INVOICES_EVENT');



debug('begin add_signature: EBS_FIN_PA_PAPJB_DRAFT_INVOICE_ITEMS_EVENT');
   l_info('##MASK##TEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26035',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_DRAFT_INVOICE_ITEMS_EVENT',
      p_sig_sql                => 'SELECT dii.*
FROM pa_draft_invoice_items dii,
     pa_events ev
WHERE dii.project_id = ev.project_id
  ...
  AND ev.event_id = ##$$EVENT_ID$$##
  AND ev.project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Draft Invoice Items For Event ID ##$$EVENT_ID$$## (PA_DRAFT_INVOICE_ITEMS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no draft invoice items generated for event ID ##$$EVENT_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Draft invoice item detail for event ID ##$$EVENT_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_DRAFT_INVOICE_ITEMS_EVENT');



debug('begin add_signature: EBS_FIN_PAPJB_PA_CC_ORG_RELATIONSHIPS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22522',
      p_sig_id                 => 'EBS_FIN_PAPJB_PA_CC_ORG_RELATIONSHIPS',
      p_sig_sql                => 'SELECT
    prvdr_project_id,
    prvdr_org_id,
    recvr_org_id,
    ...
    prvdr_legal_entity_id,
    recvr_legal_entity_id
FROM
    pa_cc_org_relationships where prvdr_Project_id =##$$PROJECT_ID$$## ',
      p_title                  => 'Provider/Receiver Controls (PA_CC_ORG_RELATIONSHIPS) ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Provider/Receiver controls are not defined for the project. No cross charge setup exists.',
      p_solution               => 'The Provider/Receiver controls for the project need to be defined if cross charge setup is required. See [1351653/KB652505] R11i/R12: Technical Brief On Cross-Charge/Borrowed-Lent/InterCompany Processing In Projects.',
      p_success_msg            => 'Provider/Receiver controls exists for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PAPJB_PA_CC_ORG_RELATIONSHIPS');



debug('begin add_signature: EBS_FIN_PAPJB_PA_CC_TP_RULES_BG');
   l_info('##MASK##CC.DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CC.NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22527',
      p_sig_id                 => 'EBS_FIN_PAPJB_PA_CC_TP_RULES_BG',
      p_sig_sql                => 'SELECT
    cc.name,
    cc.tp_rule_id,
    cc.business_group_id,
    cc.rule_type,
    cc.markup_calc_base_code,
    cc.calc_method_code,
    cc.percentage_applied,
    cc.start_date_active,
    cc.end_date_active,
    cc.description,
    cc.schedule_id
FROM
    pa_cc_tp_rules_bg       cc,
    pa_cc_tp_schedule_lines tp,
    pa_projects_all         pp
WHERE
   cc.tp_rule_id = tp.labor_tp_rule_id
    AND cc.rule_type = ''L''
    AND tp.labor_tp_rule_id = pp.ic_labor_tp_schedule_id
and pp.project_id = ##$$PROJECT_ID$$##',
      p_title                  => ' Labor Transfer Price Rules (PA_CC_TP_RULES_BG)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No labor transfer price rules are associated with schedule lines attached to the transfer price schedule.',
      p_solution               => '',
      p_success_msg            => 'Labor transfer price rules are associated with schedule lines attached to the transfer price schedule.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PAPJB_PA_CC_TP_RULES_BG');



debug('begin add_signature: EBS_FIN_PAPJB_PA_CC_TP_SCHEDULES_BG');
   l_info('##MASK##CC.DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CC.NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22523',
      p_sig_id                 => 'EBS_FIN_PAPJB_PA_CC_TP_SCHEDULES_BG',
      p_sig_sql                => 'SELECT
    cc.name,
    cc.tp_schedule_id,
    cc.business_group_id,
    ...
    cc.description
FROM
    pa_cc_tp_schedules_bg cc,
    pa_projects_all       pa
WHERE
    cc.tp_schedule_id = pa.ic_labor_tp_schedule_id
and  pa.project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Labor Transfer Price Schedule (PA_CC_TP_SCHEDULES_BG)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No labor transfer price schedule is attached to the project. ',
      p_solution               => '',
      p_success_msg            => 'Labor transfer price schedule is attached to the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PAPJB_PA_CC_TP_SCHEDULES_BG');



debug('begin add_signature: EBS_FIN_PAPJB_PA_CC_TP_SCHEDULE_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22525',
      p_sig_id                 => 'EBS_FIN_PAPJB_PA_CC_TP_SCHEDULE_LINES',
      p_sig_sql                => 'SELECT
    tp_schedule_id,
    tp_schedule_line_id,
    ...
    end_date_active
FROM
    pa_cc_tp_schedule_lines cc,
    pa_projects_all         pp
WHERE
    cc.tp_schedule_id = pp.ic_labor_tp_schedule_id
and pp.project_id = ##$$PROJECT_ID$$##

',
      p_title                  => ' Labor Transfer Price Schedule Lines (PA_CC_TP_SCHEDULE_LINES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No labor transfer price schedule lines are attached to the transfer price schedule.',
      p_solution               => '',
      p_success_msg            => 'Labor transfer price schedule lines are attached to the transfer price schedule detail.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PAPJB_PA_CC_TP_SCHEDULE_LINES');



debug('begin add_signature: EBS_FIN_PAPJB_PA_CC_NL_TP_RULES_BG');
   l_info('##MASK##CC.DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CC.NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22529',
      p_sig_id                 => 'EBS_FIN_PAPJB_PA_CC_NL_TP_RULES_BG',
      p_sig_sql                => 'SELECT
    cc.name,
    cc.tp_rule_id,
    cc.business_group_id,
...
WHERE
   cc.tp_rule_id = tp.labor_tp_rule_id
    ...
    AND tp.labor_tp_rule_id = pp.ic_labor_tp_schedule_id
and pp.project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Non-Labor Transfer Price Rules (PA_CC_TP_RULES_BG) ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No non-labor transfer price rules are associated to schedule lines attached to the transfer price schedule.',
      p_solution               => '',
      p_success_msg            => 'Non-labor transfer price rules are associated to schedule lines attached to the transfer price schedule.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PAPJB_PA_CC_NL_TP_RULES_BG');



debug('begin add_signature: EBS_FIN_PAPJB_PA_CC_NL_TP_SCHEDULES_BG');
   l_info('##MASK##CC.DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CC.NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22524',
      p_sig_id                 => 'EBS_FIN_PAPJB_PA_CC_NL_TP_SCHEDULES_BG',
      p_sig_sql                => 'SELECT
    cc.name,
    cc.tp_schedule_id,
    cc.business_group_id,
...
FROM
    ...
    pa_projects_all       pa
WHERE
    cc.tp_schedule_id = pa.ic_nl_tp_schedule_id 
and  pa.project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Non-Labor Transfer Price Schedule (PA_CC_TP_SCHEDULES_BG)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No non-labor transfer price schedule is attached to the project.',
      p_solution               => '',
      p_success_msg            => 'Non-labor transfer price schedule detail is attached to the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PAPJB_PA_CC_NL_TP_SCHEDULES_BG');



debug('begin add_signature: EBS_FIN_PAPJB_PA_CC_NL_TP_SCHEDULE_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22526',
      p_sig_id                 => 'EBS_FIN_PAPJB_PA_CC_NL_TP_SCHEDULE_LINES',
      p_sig_sql                => 'SELECT
    cc.tp_schedule_id,
    cc.tp_schedule_line_id,
    cc.prvdr_organization_id,
    cc.start_date_active,
    cc.nl_tp_rule_id,
    cc.nl_percentage_applied,
    cc.recvr_organization_id,
    cc.end_date_active
FROM
    pa_cc_tp_schedule_lines cc,
    pa_projects_all         pp
WHERE
    cc.tp_schedule_id = pp.ic_nl_tp_schedule_id 
and pp.project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Non-Labor Transfer Price Schedule Lines (PA_CC_TP_SCHEDULE_LINES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No non-labor transfer price schedule lines are attached to the transfer price schedule.',
      p_solution               => '',
      p_success_msg            => ' Non-labor transfer price schedule lines are attached to the transfer price schedule.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PAPJB_PA_CC_NL_TP_SCHEDULE_LINES');



debug('begin add_signature: PA_DRAFT_INVOICE_DETAILS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14212',
      p_sig_id                 => 'PA_DRAFT_INVOICE_DETAILS_ALL',
      p_sig_sql                => 'select * from pa_draft_invoice_details_all where expenditure_item_id = NVL(##$$EI_ID$$##, expenditure_item_id) 
and project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Draft Invoice Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no draft invoice generated.',
      p_solution               => '',
      p_success_msg            => 'PA_DRAFT_INVOICE_DETAILS_ALL table',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DRAFT_INVOICE_DETAILS_ALL');



debug('begin add_signature: EBS_FIN_PA_PAPJB_PA_EXP_ITEMS_ALL_INV_IC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26269',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_PA_EXP_ITEMS_ALL_INV_IC',
      p_sig_sql                => 'SELECT *  
FROM PA_EXPENDITURE_ITEMS_ALL 
WHERE  expenditure_item_id IN (SELECT expenditure_item_id   
...
AND draft_invoice_num = ##$$DINV_NUM$$##)
ORDER BY expenditure_item_id desc',
      p_title                  => 'Expenditure Item(s) for Intercompany Draft Invoice Number ##$$DINV_NUM$$## (PA_EXPENDITURE_ITEMS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No expenditure item(s) exists for intercompany draft invoice number ##$$DINV_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'Expenditure item(s) exists for intercompany draft invoice number ##$$DINV_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_PA_EXP_ITEMS_ALL_INV_IC');



debug('begin add_signature: EBS_FIN_PA_PAPJB_RA_INTERFACE_DISTRIBUTIONS_IC');
   l_info('##MASK##INTERFACE_LINE_ATTRIBUTE3'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##INTERFACE_LINE_ATTRIBUTE4'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26093',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_RA_INTERFACE_DISTRIBUTIONS_IC',
      p_sig_sql                => 'select * from RA_INTERFACE_DISTRIBUTIONS_ALL where interface_line_attribute1 like (select segment1 from pa_projects_all where project_id = ##$$PROJECT_ID$$##)
AND interface_line_attribute2 = nvl(''##$$DINV_NUM$$##'',interface_line_attribute2)
AND interface_line_context = ''PA Internal Invoices''
',
      p_title                  => 'Intercompany Interface Distributions Detail for Draft Invoice Number ##$$DINV_NUM$$## (RA_INTERFACE_DISTRIBUTIONS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no Receivable intercompany interface distribution details for draft invoice number ##$$DINV_NUM$$##.
',
      p_solution               => '',
      p_success_msg            => 'Receivable intercompany interface distribution details for draft invoice number ##$$DINV_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_RA_INTERFACE_DISTRIBUTIONS_IC');



debug('begin add_signature: EBS_FIN_PA_PAPJB_RA_INTERFACE_LINES_IC');
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##INTERFACE_LINE_ATTRIBUTE2'):= 'DISPLAY_FIRST_25_PCNT_WORD';
   l_info('##MASK##INTERFACE_LINE_ATTRIBUTE3'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##INTERFACE_LINE_ATTRIBUTE4'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '26091',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_RA_INTERFACE_LINES_IC',
      p_sig_sql                => 'select * from RA_INTERFACE_LINES_ALL where interface_line_attribute1 = (select segment1 from pa_projects_all where project_id = ##$$PROJECT_ID$$##)
AND interface_line_attribute2 = nvl(''##$$DINV_NUM$$##'',interface_line_attribute2)
AND interface_line_context = ''PA Internal Invoices''

',
      p_title                  => 'Intercompany Interface Lines Detail for Draft Invoice Number ##$$DINV_NUM$$## (RA_INTERFACE_LINES_ALL)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are no AR intercompany interface line details related to Draft Invoice Number ##$$DINV_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'AR intercompany interface line details related to Draft Invoice Number ##$$DINV_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_RA_INTERFACE_LINES_IC');



debug('begin add_signature: EBS_FIN_PA_PAPJB_RA_INTERFACE_ERRORS_IC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26092',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_RA_INTERFACE_ERRORS_IC',
      p_sig_sql                => 'select err.interface_line_id, err.interface_salescredit_id, err.interface_distribution_id, err.message_text, err.invalid_value, 
lines.interface_line_attribute1, lines.interface_line_attribute2
FROM ra_interface_errors_all err,
     ra_interface_lines_all lines 
...
AND lines.interface_line_attribute1 = (select segment1 from pa_projects_all where project_id =  ##$$PROJECT_ID$$##)
AND lines.interface_line_attribute2 = nvl(''##$$DINV_NUM$$##'', lines.interface_line_attribute2)
AND lines.interface_line_context = ''PA Internal Invoices''



',
      p_title                  => 'Intercompany Interface Errors for Draft Invoice Number ##$$DINV_NUM$$## (RA_INTERFACE_ERRORS_ALL)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are AR interface errors for ##$$DINV_NUM$$##.
',
      p_solution               => 'The interface data needs to be fixed. For more information, review [1089172/KB769440] Troubleshooting Autoinvoice Import - Execution Report Errors (Request Status = Completed)',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_RA_INTERFACE_ERRORS_IC');



debug('begin add_signature: EBS_FIN_PA_PAPJB_RA_CUST_TRX_IC');
   l_info('##MASK##INTERFACE_HEADER_ATTRIBUTE3'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##INTERFACE_HEADER_ATTRIBUTE4'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26094',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_RA_CUST_TRX_IC',
      p_sig_sql                => 'select * from RA_CUSTOMER_TRX_ALL where interface_header_attribute1 = (select segment1 from pa_projects_all where project_id = ##$$PROJECT_ID$$##)
AND interface_header_attribute2 = nvl(''##$$DINV_NUM$$##'',interface_header_attribute2)
AND interface_header_context = ''PA Internal Invoices''',
      p_title                  => 'AR Intercompany Header Information for Draft Invoice Number ##$$DINV_NUM$$## (RA_CUSTOMER_TRX_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no header level information related to intercompany draft invoice number ##$$DINV_NUM$$##.
',
      p_solution               => '',
      p_success_msg            => 'Header level information related to intercompany draft invoice number ##$$DINV_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_RA_CUST_TRX_IC');



debug('begin add_signature: EBS_FIN_PA_PAPJB_RA_CUST_TRX_LINES_IC');
   l_info('##MASK##INTERFACE_LINE_ATTRIBUTE3'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##INTERFACE_LINE_ATTRIBUTE4'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26095',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_RA_CUST_TRX_LINES_IC',
      p_sig_sql                => 'select * from RA_CUSTOMER_TRX_LINES_ALL where interface_line_attribute1 = (select segment1 from pa_projects_all where project_id = ##$$PROJECT_ID$$##)
AND interface_line_attribute2 = nvl(''##$$DINV_NUM$$##'',interface_line_attribute2)
AND interface_line_context = ''PA Internal Invoices''
',
      p_title                  => 'AR Intercompany Invoice Lines Information for Draft Invoice Number ##$$DINV_NUM$$## (RA_CUSTOMER_TRX_LINES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no line level information related to intercompany draft invoice number ##$$DINV_NUM$$##.
',
      p_solution               => '',
      p_success_msg            => ' Line level information related to intercompany draft invoice number ##$$DINV_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_RA_CUST_TRX_LINES_IC');



debug('begin add_signature: EBS_FIN_PA_PAPJB_RA_CUST_TRX_DIST_IC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26097',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_RA_CUST_TRX_DIST_IC',
      p_sig_sql                => 'select * from RA_CUST_TRX_LINE_GL_DIST_ALL where customer_trx_id in
  (select customer_trx_id from ra_customer_trx_all
   where  interface_header_attribute1 = 
  (select segment1 from pa_projects_all where project_id = ##$$PROJECT_ID$$##)
...
and interface_header_context = ''PA Internal Invoices'')
 order by cust_trx_line_gl_dist_id asc
',
      p_title                  => 'AR Intercompany Invoice Transaction Line Distribution Details for Draft Invoice Number ##$$DINV_NUM$$## (RA_CUST_TRX_LINE_GL_DIST_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no accounting records for revenue, unearned revenue and unbilled receivables in AR for intercompany draft invoice number ##$$DINV_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'Accounting records for revenue, unearned revenue and unbilled receivables in AR for  intercompany draft invoice number ##$$DINV_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_RA_CUST_TRX_DIST_IC');



debug('begin add_signature: EBS_PA_PAPJB_AGREEMENT_RECEIPTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25714',
      p_sig_id                 => 'EBS_PA_PAPJB_AGREEMENT_RECEIPTS',
      p_sig_sql                => 'SELECT
    a.*,
   b.receipt_number,
  b.receipt_date
FROM
    pa_agreement_receipts a,
    ar_cash_receipts_all b
WHERE
    agreement_version_id IN (
        SELECT
            agreement_version_id
        FROM
            pa_agreement_versions agree
        WHERE
            agree.agreement_id IN (
                SELECT
                    agreement_id
                FROM
                    pa_project_fundings
   ...
   AND a.cash_receipt_id = b.cash_receipt_id',
      p_title                  => 'Agreement Receipts (PA_AGREEMENT_RECEIPTS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No agreement receipts exist for the selected project.',
      p_solution               => '',
      p_success_msg            => 'Agreement receipt(s) exist for the selected project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_PA_PAPJB_AGREEMENT_RECEIPTS');



debug('begin add_signature: EBS_FIN_PA_PAPJB_CONS_BILL_GROUP');
   l_info('##MASK##BILL_GROUP_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##INV_PREFIX'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24850',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_CONS_BILL_GROUP',
      p_sig_sql                => 'SELECT
    org_id,
    bill_group_id,
    bill_group_name,
    ...
    bill_to_address_id,
    remit_to_address_id,
    consolidate_inv_flag,
    inv_prefix,
    exclude_txn_bill_group
FROM
    pa_bill_groups_all
WHERE
    bill_group_id IN (
      ...
      p_title                  => 'Consolidated Bill Group (PA_BILL_GROUPS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Consolidated bill group is not attached to project',
      p_solution               => '',
      p_success_msg            => 'PA_BILL_GROUPS_ALL contains consolidated bill group attached to project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_CONS_BILL_GROUP');



debug('begin add_signature: EBS_FIN_PA_PAPJB_POBG_ACCT_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24848',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_POBG_ACCT_LINES',
      p_sig_sql                => 'SELECT *
  FROM  pa_proj_pobg_acct_lines_all
WHERE project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Performance Obligation Account Lines (PA_PROJ_POBG_ACCT_LINES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Performance Obligation is not enabled for the project',
      p_solution               => '',
      p_success_msg            => 'PA_PROJ_POBG_ACCT_LINES_ALL contains performance obligation accounting lines for project',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_POBG_ACCT_LINES');



debug('begin add_signature: EBS_FIN_PA_PAPJB_AGREEMENT_TYPE');
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24852',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_AGREEMENT_TYPE',
      p_sig_sql                => ' SELECT *
      FROM pa_agreement_types
     WHERE agreement_type IN (SELECT agreement_type
                                FROM pa_agreements_all        
                               WHERE agreement_id IN (SELECT agreement_id
                                                        FROM pa_project_fundings
                                                       WHERE project_id = ##$$PROJECT_ID$$##))',
      p_title                  => 'Agreement Types  (PA_AGREEMENT_TYPES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No agreement type exist for the selected project.',
      p_solution               => '',
      p_success_msg            => 'PA_AGREEMENT_TYPES stores type of agreement which is information about legally binding documents from customers that serve as the basis of work authorization for projects.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_AGREEMENT_TYPE');



debug('begin add_signature: EBS_FIN_PA_PAPJB_AGREEMENT_VERSIONS');
   l_info('##MASK##AGREEMENT_NUM'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24851',
      p_sig_id                 => 'EBS_FIN_PA_PAPJB_AGREEMENT_VERSIONS',
      p_sig_sql                => 'SELECT
    agree.*,
    party.party_id     "Party Id",
    party.party_number "Customer_Number" 
...
WHERE
    ...
    AND agree.agreement_id IN (
        ...
        WHERE
            project_id = ##$$PROJECT_ID$$##)',
      p_title                  => 'Agreement Versions (PA_AGREEMENT_VERSIONS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No agreement versions exist for the selected project.',
      p_solution               => '',
      p_success_msg            => 'Agreement version(s) exist for the selected project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAPJB_AGREEMENT_VERSIONS');
...
BEGIN
  ...
  IF (p_project_id IS NOT NULL) THEN
    g_params_string := g_params_string || to_char(p_project_id) || '_';
  END IF;
  ...
  analyzer_title := 'Projects Revenue and Billing Analyzer';
...
start_section('Proactive and Preventative Recommendations', 'Proactive');
   set_item_result(check_rec_patches_1); /* Signature EBS_FIN_PA_PAPJB_BILL_RECOMMENDED_PATCHES */
   set_item_result(run_stored_sig('EBS_FIN_PA_PA_FORMS_PERSONALIZATIONS'));
end_section;
debug('end section: Proactive');

debug('begin section: DATA_ISSUES');
start_section('Data Issues', 'DATA_ISSUES');
   set_item_result(run_stored_sig('EBS_FIN_PA_2270694_1_DATAFIX'));
   set_item_result(run_stored_sig('EBS_FIN_PA_2270694_1_CODEFIX'));
   set_item_result(run_stored_sig('PA_AR_DUPLICATE_INVOICE_NUMBER'));
   set_item_result(run_stored_sig('INCORRECT_UBR_UER'));
   set_item_result(run_stored_sig('PA_BILL_INVALID_RA_INVOICE_NUMBER'));
   set_item_result(run_stored_sig('PA_BILL_MISMATCH_INV_FUNDING'));
   set_item_result(run_stored_sig('PA_BILL_MISMATCH_REV_FUNDING'));
   set_item_result(run_stored_sig('PA_BILL_PARGDR_WITH_REVENUE_SOURCE_DUMMY'));
   set_item_result(run_stored_sig('PA_BILL_UNINVOICED_REV_DIST_LINES'));
   set_item_result(run_stored_sig('PA_CREDITING_REVENUE_IS_NOT_POPULATED_WITH_CCID'));
   set_item_result(run_stored_sig('REVERSED_EI_WITH_NO_REVENUE_GENERATED'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_TASK_FUNDING_NOT_EQUAL_BUDGET'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAP2P_2962514_1_CODEFIX'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_2962514_1_DATAFIX'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_NULL_COMPLETION_DATE_IN_PA_EVENTS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_SIGNAL11'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_INV_TRANSFER_REJECTION_REASON'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_PA_IC_INVOICE_MISSING_AP'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_EXPENDITURES_NOT_COSTED'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_BILLABLE_IS_NOT_ENABLED'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_INACTIVE_CUSTOMER_OR_ON_HOLD'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_TASKS_ARE_NOT_READY_TO_ACCRUE_OR_BILL'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_SUB_JOURNAL_DIFF_SIGN'));
   IF ((substr(g_rep_info('Apps Version'),1,6) >= '12.2.7') OR
    (substr(g_rep_info('Apps Version'),1,7) >= '12.2.10')) THEN
      set_item_result(run_stored_sig('PA_CREDIT_MEMO_ERROR_IN AR_AUTOINVOICE_IMPORT'));
   END IF;
end_section;
debug('end section: DATA_ISSUES');

debug('begin section: SETUP');
start_section('Setup', 'SETUP');
   set_item_result(run_stored_sig('PA_BILL_IMPLEMENTATION_OPTIONS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_AR_SYSTEM_PARAMS'));
   set_item_result(run_stored_sig('PA_PROJECT_BILLING_CYCLE'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_ALL_BILLING_CYCLES'));
   set_item_result(run_stored_sig('PROJECT_RATE_SCHEDULES'));
   set_item_result(run_stored_sig('TASK_RATE_SCHEDULES'));
   set_item_result(run_stored_sig('PA_EMP_BILL_OVERRIDES'));
   set_item_result(run_stored_sig('PA_JOB_ASSIGNMENT_BILL_OVERRIDES'));
   set_item_result(run_stored_sig('EBS_FIN_PA_JOB_BILL_TITLE_OVERRIDES'));
   set_item_result(run_stored_sig('PA_JOB_BILL_OVERRIDES'));
   set_item_result(run_stored_sig('PA_NONLABOR_BILL_OVERRIDES'));
   set_item_result(run_stored_sig('PA_FOUND_BUDGET_TYPES'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_EVENT_TYPE_DETAIL'));
   set_item_result(run_stored_sig('PA_PROGRESS_ROLLUP'));
end_section;
debug('end section: SETUP');

debug('begin section: PROJECT_DETAILS');
start_section('Project Details', 'PROJECT_DETAILS');
   set_item_result(run_stored_sig('PA_P2P_PROJECTS'));
   set_item_result(run_stored_sig('PA_P2P_TASKS'));
   set_item_result(run_stored_sig('PA_P2P_PROJECT_TYPES'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_PROJ_STATUS'));
   set_item_result(run_stored_sig('PROJECT_RATE_SCHEDULES'));
   set_item_result(run_stored_sig('PA_PROJECT_KEY_MEMBERS_ROLES'));
   set_item_result(run_stored_sig('PA_PROJECT_CUSTOMERS'));
   set_item_result(run_stored_sig('PA_FOUND_PROJECT_CONTACTS'));
   set_item_result(run_stored_sig('PA_PROJECT_CUSTOMER_PROFILES'));
   set_item_result(run_stored_sig('PA_AGREEMENTS_ALL'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_INV_TRANSFER_REJ_REASON'));
   IF ((substr(g_rep_info('Apps Version'),1,6) >= '12.2.7') OR
    (substr(g_rep_info('Apps Version'),1,7) >= '12.2.10')) THEN
      set_item_result(run_stored_sig('EBS_PA_PAPJB_AGREEMENT_RECEIPTS'));
   END IF;
   set_item_result(run_stored_sig('PA_FOUND_BUDGET_TYPES'));
   IF substr(g_rep_info('Apps Version'),1,7) >= '12.2.10' THEN
      set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_CONS_BILL_GROUP'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_POBG_ACCT_LINES'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_AGREEMENT_TYPE'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_AGREEMENT_VERSIONS'));
   END IF;
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_REVENUE_BUDGET_LINES'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_REVENUE_RES_ASSIGNMENTS'));
   set_item_result(run_stored_sig('PA_PROJECT_FUNDINGS'));
   set_item_result(run_stored_sig('PA_SUMMARY_PROJECT_FUNDINGS'));
   set_item_result(run_stored_sig('PA_BILLING_EXTENSIONS'));
   set_item_result(run_stored_sig('PA_BILLING_ASSIGNMENTS_ALL'));
   set_item_result(run_stored_sig('PA_BILL_IMPLEMENTATION_OPTIONS'));
   set_item_result(run_stored_sig('PA_EMP_BILL_OVERRIDES'));
   set_item_result(run_stored_sig('PA_JOB_ASSIGNMENT_BILL_OVERRIDES'));
   set_item_result(run_stored_sig('PA_JOB_BILL_OVERRIDES'));
   set_item_result(run_stored_sig('PA_NONLABOR_BILL_OVERRIDES'));
   set_item_result(run_stored_sig('PA_PROJECT_BILLING_CYCLE'));
   set_item_result(run_stored_sig('PA_PROJECT_CREDIT_RECEIVERS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_DRAFT_REVENUES_ALL'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_PA_DRAFT_REVENUE_ITEMS_PROJECT'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_PCRDL_PROJECT'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_PA_CUST_EVENT_RDL_ALL_PROJECT'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_PA_DRAFT_INVOICES_PROJECT'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_PA_DRAFT_INVOICE_ITEMS_PROJECT'));
   set_item_result(run_stored_sig('PA_EXPENDITURE_ITEMS_ALL-DC'));
   set_item_result(run_stored_sig('PA_EVENTS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_BATCH_TRANSACTION_TYPE_INFORMATION'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_INV_FORMAT'));
end_section;
debug('end section: PROJECT_DETAILS');

debug('begin section: REVENUE_DETAILS');
start_section('Revenue Details', 'REVENUE_DETAILS');
   IF p_draft_revenue_num is not null THEN
      set_item_result(run_stored_sig('PA_DRAFT_REVENUES_ALL'));
      set_item_result(run_stored_sig('PA_DRAFT_REVENUE_ITEMS'));
      set_item_result(run_stored_sig('PA_CUST_REV_DIST_LINES_ALL'));
      set_item_result(run_stored_sig('PA_CUST_EVENT_RDL_ALL'));
      set_item_result(run_stored_sig('PA_EXPENDITURE_ITEMS_WITH_REVENUE'));
      set_item_result(run_stored_sig('PA_EVENTS_REVENUE_RELATED'));
      set_item_result(run_stored_sig('PA_DRAFT_REVENUE_NUM_CREDITED'));
   END IF;
end_section;
debug('end section: REVENUE_DETAILS');

debug('begin section: INVOICE_DETAILS');
start_section('Invoice Details ', 'INVOICE_DETAILS');
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_PA_DRAFT_INVOICES_ALL_NOT_RELEASED'));
   IF p_draft_invoice_num is not null THEN
      set_item_result(run_stored_sig('PA_DRAFT_INVOICES_ALL'));
      set_item_result(run_stored_sig('PA_DRAFT_INVOICE_ITEMS'));
      set_item_result(run_stored_sig('PA_DRAFT_INVOICE_NUM_CREDITED'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_PA_CUST_REV_DIST_LINES_INVOICE'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_PA_CUST_EVENT_RDL_INVOICE'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_PA_EXP_ITEMS_ALL_INV'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_PA_EVENTS_INVOICE'));
      set_item_result(run_stored_sig('PA_RA_INTERFACE_LINES_ALL'));
      set_item_result(run_stored_sig('PA_RA_INTERFACE_DISTRIBUTIONS_ALL'));
      set_item_result(run_stored_sig('PA_RA_INTERFACE_SALESCREDITS_ALL'));
      set_item_result(run_stored_sig('PA_RA_INTERFACE_ERRORS_ALL'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_RA_CUST_TRX_TYPES'));
      set_item_result(run_stored_sig('EBS_FIN_PA_INV_RA_CUST_TRX_ALL'));
      set_item_result(run_stored_sig('EBS_FIN_PA_INV_RA_CUST_TRX_LINES_ALL'));
      set_item_result(run_stored_sig('EBS_FIN_PA_INV_RA_CUST_TRX_LINE_GL_DIST_ALL'));
      set_item_result(run_stored_sig('PA_TASK_READY_TO_BILL_FLAG'));
   END IF;
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_PA_DRAFT_INVOICES_ALL_NOT_INTERFACED_TO_AR'));
   IF ((p_draft_invoice_num is not null) and
((substr(g_rep_info('Apps Version'),1,6) >= '12.2.4') OR
    (substr(g_rep_info('Apps Version'),1,7) >= '12.2.10'))) THEN
      set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_CONSOLIDATED_INV'));
   END IF;
end_section;
debug('end section: INVOICE_DETAILS');

debug('begin section: INTERCOMPANY_INVOICE_DETAILS');
start_section('Intercompany Invoice Details', 'INTERCOMPANY_INVOICE_DETAILS');
   IF g_cc_prvdr_flag = 'Y' THEN
      set_item_result(run_stored_sig('EBS_FIN_PAPJB_PA_CC_ORG_RELATIONSHIPS'));
      set_item_result(run_stored_sig('EBS_FIN_PAPJB_PA_CC_TP_RULES_BG'));
      set_item_result(run_stored_sig('EBS_FIN_PAPJB_PA_CC_TP_SCHEDULES_BG'));
      set_item_result(run_stored_sig('EBS_FIN_PAPJB_PA_CC_TP_SCHEDULE_LINES'));
      set_item_result(run_stored_sig('EBS_FIN_PAPJB_PA_CC_NL_TP_RULES_BG'));
      set_item_result(run_stored_sig('EBS_FIN_PAPJB_PA_CC_NL_TP_SCHEDULES_BG'));
      set_item_result(run_stored_sig('EBS_FIN_PAPJB_PA_CC_NL_TP_SCHEDULE_LINES'));
   END IF;
   IF g_cc_prvdr_flag = 'Y'
and p_draft_invoice_num is not null THEN
      set_item_result(run_stored_sig('PA_DRAFT_INVOICES_ALL'));
      set_item_result(run_stored_sig('PA_DRAFT_INVOICE_ITEMS'));
      set_item_result(run_stored_sig('PA_DRAFT_INVOICE_DETAILS_ALL'));
      set_item_result(run_stored_sig('PA_DRAFT_INVOICE_NUM_CREDITED'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_PA_EXP_ITEMS_ALL_INV_IC'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_RA_INTERFACE_DISTRIBUTIONS_IC'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_RA_INTERFACE_LINES_IC'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_RA_INTERFACE_ERRORS_IC'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_RA_CUST_TRX_IC'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_RA_CUST_TRX_LINES_IC'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_RA_CUST_TRX_DIST_IC'));
   END IF;
end_section;
debug('end section: INTERCOMPANY_INVOICE_DETAILS');

debug('begin section: EXPENDITURE_EVENT_DETAILS');
start_section('Expenditure and Event Details', 'EXPENDITURE_EVENT_DETAILS');
   IF p_expenditure_item_id is not null THEN
      set_item_result(run_stored_sig('EBS_FIN_PA_EXPENDITURE_GROUPS_ALL'));
      set_item_result(run_stored_sig('EBS_FIN_PA_EXPENDITURES_ALL'));
      set_item_result(run_stored_sig('EBS_FIN_PA_EXPENDITURE_ITEMS_ALL'));
      set_item_result(run_stored_sig('EBS_FIN_PA_COST_DISTRIBUTION_LINES_ALL'));
      set_item_result(run_stored_sig('EBS_FIN_PA_EXPEND_ITEM_ADJ_ACTIVITIES'));
      set_item_result(run_stored_sig('EBS_FIN_PA_DRAFT_REVENUES_ALL_EI'));
      set_item_result(run_stored_sig('EBS_FIN_PA_DRAFT_REVENUE_ITEMS_EI'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PA_CUST_REV_DIST_LINES_EI'));
      set_item_result(run_stored_sig('EBS_FIN_PA_DRAFT_INVOICES_ALL_EI'));
      set_item_result(run_stored_sig('EBS_FIN_PA_DRAFT_INVOICE_ITEMS_EI'));
      set_item_result(run_stored_sig('PA_COST_TRANSACTION_CONTROLS'));
   END IF;
   IF p_event_id is not null THEN
      set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_PA_EVENTS'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_PA_DRAFT_REVENU_EVENT'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_PA_DRAFT_REVENUE_ITEMS_EVENT'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_PA_CUST_EVENT_RDL_EVENT'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_DRAFT_INVOICES_EVENT'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_DRAFT_INVOICE_ITEMS_EVENT'));
   END IF;
end_section;
debug('end section: EXPENDITURE_EVENT_DETAILS');

debug('begin section: RETENTION_DETAILS');
start_section('Retention Details', 'RETENTION_DETAILS');
   set_item_result(run_stored_sig('PA_PROJ_RETN_RULES'));
   set_item_result(run_stored_sig('PA_RETN_BILL_METHOD_V'));
   set_item_result(run_stored_sig('PA_PROJ_RETN_BILL_RULES'));
   set_item_result(run_stored_sig('PA_PROJECT_RETENTIONS'));
   set_item_result(run_stored_sig('PA_PROJECT_RETENTION_V'));
   set_item_result(run_stored_sig('PA_PROJ_RETN_BILL_VALUES_V'));
   set_item_result(run_stored_sig('PA_PROJ_RETN_DEFAULTS_V'));
   set_item_result(run_stored_sig('PA_PROJ_RETN_EVENTS_V'));
   set_item_result(run_stored_sig('PA_PROJ_RETN_EXP_V'));
   set_item_result(run_stored_sig('PA_SUMMARY_PROJECT_RETNS_V'));
   set_item_result(run_stored_sig('PA_MC_RETN_INV_DETAILS'));
   set_item_result(run_stored_sig('PA_MC_RETN_INV_DETLS_AR'));
   set_item_result(run_stored_sig('PA_RETN_INVOICE_DETAILS_V'));
   set_item_result(run_stored_sig('PA_RETN_INV_DETAILS_AR'));
end_section;
debug('end section: RETENTION_DETAILS');

debug('begin section: ACCOUNTING_DETAILS');
start_section('Accounting Details', 'ACCOUNTING_DETAILS');
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_REVENUE_GL_RECONCILIATION'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_REVENUE_RECONCILIATION'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_REVENUE_SLA_RECONCILIATION'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_TRA_ACCOUNT_SETUP'));
   set_item_result(run_stored_sig('PA_BILL_AUTOACCOUNTING_FUNCTION_TRANSACTIONS'));
   set_item_result(run_stored_sig('PA_BILL_AUTOACCOUNTING_LOOKUPSETS'));
   set_item_result(run_stored_sig('PA_BILL_AUTOACCOUNTING_RULES'));
   set_item_result(run_stored_sig('PA_BILL_AUTOACCOUNTING_RULE_PAIRINGS'));
   set_item_result(run_stored_sig('PA_BILL_INVALID_AUTOACCOUNTING_PARAMETERS'));
   set_item_result(run_stored_sig('PA_MISSING_AUTOACCOUNTING_LOOKUPSET'));
   set_item_result(run_stored_sig('XLA_ACCOUNTING_ERRORS_FOR_PA_REVENUE'));
   set_item_result(run_stored_sig('XLA_AE_HEADERS_FOR_PA_DRAFT_REVENUES'));
   set_item_result(run_stored_sig('XLA_AE_LINES_FOR_PA_REVENUE_EVENT'));
   set_item_result(run_stored_sig('XLA_DISTRIBUTION_LINKS_FOR_PA_REVENUE_EVENT'));
   set_item_result(run_stored_sig('XLA_EVENTS_FOR_PA_DRAFT_REVENUES'));
   set_item_result(run_stored_sig('XLA_TRANSACTION_ENTITIES_FOR_PA_REVENUE_EVENT'));
end_section;
debug('end section: ACCOUNTING_DETAILS');

debug('begin section: PERIOD_DETAILS_CLOSE_EXCEPTIONS');
start_section('Period Details and Period Close Exceptions', 'PERIOD_DETAILS_CLOSE_EXCEPTIONS');
   set_item_result(run_stored_sig('EBS_FIN_PA_PERIODS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_LATEST_OPEN_PA_PERIOD'));
   set_item_result(run_stored_sig('EBS_FIN_PA_CURRENT_REPORTING_PERIOD'));
   set_item_result(run_stored_sig('EBS_FIN_PA_GL_DR_EXCEPT_DET'));
end_section;
debug('end section: PERIOD_DETAILS_CLOSE_EXCEPTIONS');

debug('begin section: AppsCheck_COPY');
start_section('Apps Check', 'AppsCheck_COPY');
   set_item_result(run_stored_sig('PA_PATCH_LEVEL'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAICGEN_VERSIONS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAIGEN_FILE_VERSIONS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PARGDR_VERSIONS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PARTAR_VERSIONS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PATTAR_VERSIONS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PATTGL_VERSIONS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PATPOB_VERSIONS'));
   set_item_result(run_stored_sig('AC_FILE_VERISONS'));
   set_item_result(run_stored_sig('PA_PROFILE_OPTION_VALUES'));
...
end_section;
debug('end section: AppsCheck_COPY');
