...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Receivables Transaction Features Setup |
REM | Analyzer                                                                  |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE ar_trx_feat_analyzer_pkg AUTHID DEFINER AS
...
(            p_user_name                    IN VARCHAR2    DEFAULT NULL
           ...
           ,p_feature                      IN VARCHAR2    DEFAULT NULL
...
FUNCTION calc_begin_balance (p_customer_id IN number, 
                             p_site_use_id IN number, 
                             p_cons_inv_id IN number) return number;

FUNCTION calc_end_balance (p_customer_id IN number, 
                           p_site_use_id IN number, 
                           p_cons_inv_id IN number) return number;


END ar_trx_feat_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY ar_trx_feat_analyzer_pkg AS
-- $Id: ar_trx_feat_analyzer.sql, 200.26 2026/01/29 15:30:07 mamoreir Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2652087.1));
...
g_org_id             NUMBER;
g_feature            VARCHAR2(15);
g_cust_acct_id       NUMBER;

g_user_name_tmp     VARCHAR2(100) := 0;
g_resp_id_tmp       NUMBER := 0;
g_resp_name         VARCHAR2(100) := null;

g_late_charge_site  NUMBER;
g_uses_bfb          VARCHAR2(1);

g_ece_profile       VARCHAR2(240);
g_init_ora          VARCHAR2(240);
g_max_level         NUMBER;

G_BAL_BFB_STMT1     VARCHAR2(500);
G_BAL_BFB_STMT2     VARCHAR2(500);
G_BAL_BFB_STMT3     VARCHAR2(500);

g_set_of_books_id              NUMBER(15) := null;
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'ARTXFANLZ_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'ARTXFANLZ_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>ARTXFANLZ Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2652087.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/ar_trx_feat_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,2675,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,2675,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},2675,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4322327" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">2675</span>
...
<ul><li><p>Updated ATG signatures, template changes</p><p>&nbsp;</p></li>
</ul>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,2675,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,2675,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},2675,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
FUNCTION calc_begin_balance (p_customer_id IN number, 
                             ...
                             p_cons_inv_id IN number) return number
IS	
   l_beginning_balance number := 0;
   l_cons_inv_id number := 0;
   
   -- get prior CONS_INV_ID (if it exists) and this CONS_INV_ID
   cursor cur is
   select nvl(max(cons_inv_id), -1) consinvid, billing_date, beginning_balance, ending_balance, issue_date
   from AR_CONS_INV_ALL
   where status = 'ACCEPTED'
   and customer_id = p_customer_id
   and site_use_id = p_site_use_id
   and ISSUE_DATE < (select issue_date from ar_cons_inv_all where cons_inv_id = p_cons_inv_id)
   and CUT_OFF_DATE is NULL
   and BILLING_DATE is NOT NULL
   group by billing_date, beginning_balance, ending_balance, issue_date
   UNION
   select cons_inv_id, billing_date, beginning_balance, ending_balance, issue_date
   from AR_CONS_INV_ALL
   where status = 'ACCEPTED'
...
begin
   ...
   for c in cur loop
      -- this loop will only run max of two times: 1. for prior cons_inv_id if it exists and 2. cons_inv_id value passed as parameter

      l_cons_inv_id := c.consinvid;

      if l_cons_inv_id <> -1
         and l_cons_inv_id <> p_cons_inv_id then
         -- there exists a previous cons_inv_id

         print_log('   calc_begin_balance, previous cons_inv_id = '||c.consinvid
			      ||' bill_date = '||c.billing_date
			      ||' Start = '||c.beginning_balance
			      ||' End = '||c.ending_balance);
 	      
         -- take ending balance of previous cons_inv_id as beginning balance
         select nvl(ending_balance,0) 
         into l_beginning_balance
	 from AR_CONS_INV_ALL
	 where status = 'ACCEPTED'
	 and cons_inv_id = l_cons_inv_id;

      else
         -- there is no cons_inv_id prior to this one

         print_log('   calc_begin_balance, current cons_inv_id = '||c.consinvid
			      ||' bill_date = '||c.billing_date
			      ||' Start = '||c.beginning_balance
			      ||' End = '||c.ending_balance);

         select nvl(beginning_balance,0) 
         into l_beginning_balance
	 from AR_CONS_INV_ALL
	 where status = 'ACCEPTED'
	 and cons_inv_id = l_cons_inv_id;         
...
IS	
   l_beginning_balance number := 0;
   l_period_trx number := 0;
   l_period_receipts number := 0; 
   l_period_finchrg number := 0;
   l_period_adj number := 0; 
   l_period_credits number := 0;
   l_period_tax number := 0;
   l_ending_balance number := 0;
...
begin
   ...
   for c in cur loop
	 ...
	 and cons_inv_id = l_cons_inv_id;         
      ...
      -- print_log('   calc_end_balance, cons_inv_id = ' || c.consinvid || ' Beginning Balance = ' || l_beginning_balance);

      -- only calculate ending balance for this cons_inv_id

      if l_cons_inv_id = p_cons_inv_id then

      SELECT nvl(sum(amount_original),0)
      INTO l_period_trx
      FROM ar_cons_inv_trx_all
      WHERE cons_inv_id = c.consinvid
      AND transaction_type IN ('INVOICE', 'DEBIT_MEMO', 'DEPOSIT', 'CHARGEBACK');

      --print_log('      Transactions = '||l_period_trx || ' +');
      ...
      --print_log('      Finance Charges = '||l_period_finchrg || ' +');
      ...
      --print_log('      Adjustments = '||l_period_adj || ' +');
      ...
      --print_log('      Credits = '||l_period_credits || ' +');
				 
      SELECT nvl(sum(tax_amount),0)
      INTO l_period_tax
      FROM ar_cons_inv_trx_lines_all
      WHERE cons_inv_id = c.consinvid;

      --print_log('      Tax = '||l_period_tax);

      l_ending_balance := l_beginning_balance + l_period_trx + l_period_receipts + l_period_adj + l_period_credits + l_period_finchrg;   --- change done per automation request id: 227242

      print_log('   calc_end_balance, cons_inv_id = ' || c.consinvid || ' Ending Balance = ' || l_ending_balance);
      end if;
      
   end loop;
   return(l_ending_balance);
end;
...
debug('begin populate parameters hash table');
   ...
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Transaction Feature';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_feature,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Cust Account ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_cust_account_id,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/01/29 15:30:05 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'ar_trx_feat_analyzer.sql';
...
debug('begin parameter validation: p_feature');
IF p_feature IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Transaction Feature is required.');
   raise invalid_parameters;
END IF;
IF p_feature IS NOT NULL AND p_feature NOT IN ( 'BFB','EDI','LATE CHARGES') THEN
   print_error('INVALID ARGUMENT: Invalid transaction feature. Valid Values are: EDI, BFB, LATE CHARGES.');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_feature');

debug('begin parameter validation: p_cust_account_id');
IF p_cust_account_id IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Cust Account ID is required.');
   raise invalid_parameters;
END IF;
...
WHERE CUST_ACCOUNT_ID = p_cust_account_id and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid customer number.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_cust_account_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_cust_account_id');
...
begin
   ...
   g_org_id := p_org_id;
   g_feature := p_feature;
   g_cust_acct_id := p_cust_account_id;
   ...
   BEGIN
      ------------------------------------------------------------------------------------------
      -- LOGIC FOR LATE CHARGES
      -- pick up Late Charge Site if it exists
      BEGIN
          SELECT site_use_id
          INTO   g_late_charge_site
          FROM   hz_cust_site_uses_all
          where  cust_acct_site_id in (SELECT cust_acct_site_id
                                       FROM HZ_CUST_ACCT_SITES_ALL
                                       WHERE cust_account_id = g_cust_acct_id)
          and    site_use_code = 'LATE_CHARGE';
          
          print_log('Late Charges Site = ' || g_late_charge_site);
      EXCEPTION
      WHEN OTHERS THEN
          g_late_charge_site := -1;
      END;

      ------------------------------------------------------------------------------------------
      -- LOGIC FOR BFB
      -- pick up usage of BFB
      BEGIN
          SELECT distinct 'Y'
          INTO   g_uses_bfb
      ...
      begin
         -- this will be used in AR_TXF_EDI_FILE_PATH sig
         -- picking up MAX will return RESP level if it exists, otherwise SITE level
         SELECT max(a.level_id),
          ...
          WHERE e.application_id = a.application_id
            ...
            AND e.profile_option_name = 'ECE_OUT_FILE_PATH'
          GROUP BY a.profile_option_value;
   ...
   print_log('Getting AR_SYSTEM_PARAMETERS data.');

   -- pull AR_SYSTEM_PARAMETERS 
   SELECT set_of_books_id
          into 
          g_set_of_books_id
   FROM   AR_SYSTEM_PARAMETERS_ALL SP, GL_LEDGERS l
   WHERE  NVL(org_id, -99) = g_org_id
   AND    sp.set_of_books_id = l.ledger_id;
...
debug('begin populate sql tokens hash table');
   ...
   g_sql_tokens('##$$LCSITE$$##') := g_late_charge_site;
   g_masked_tokens('##$$LCSITE$$##') := mask_text( g_sql_tokens('##$$LCSITE$$##'), 'NO_MASK');
   ...
   g_sql_tokens('##$$A$$##') := 'AR_TRX_FEAT_ANALYZER_PKG';
   g_masked_tokens('##$$A$$##') := mask_text( g_sql_tokens('##$$A$$##'), 'NO_MASK');
   g_sql_tokens('##$$CUSTACCTID$$##') := p_cust_account_id;
   g_masked_tokens('##$$CUSTACCTID$$##') := mask_text( g_sql_tokens('##$$CUSTACCTID$$##'), 'NO_MASK');
   g_sql_tokens('##$$FEATURE$$##') := p_feature;
   g_masked_tokens('##$$FEATURE$$##') := mask_text( g_sql_tokens('##$$FEATURE$$##'), 'NO_MASK');
   g_sql_tokens('##$$ECE_PROFILE$$##') := g_ece_profile;
   g_masked_tokens('##$$ECE_PROFILE$$##') := mask_text( g_sql_tokens('##$$ECE_PROFILE$$##'), 'NO_MASK');
   g_sql_tokens('##$$INIT_ORA$$##') := g_init_ora;
   g_masked_tokens('##$$INIT_ORA$$##') := mask_text( g_sql_tokens('##$$INIT_ORA$$##'), 'NO_MASK');
   g_sql_tokens('##$$G_BAL_BFB_STMT1$$##') := G_BAL_BFB_STMT1;
   g_masked_tokens('##$$G_BAL_BFB_STMT1$$##') := mask_text( g_sql_tokens('##$$G_BAL_BFB_STMT1$$##'), 'NO_MASK');
   g_sql_tokens('##$$G_BAL_BFB_STMT2$$##') := G_BAL_BFB_STMT2;
   g_masked_tokens('##$$G_BAL_BFB_STMT2$$##') := mask_text( g_sql_tokens('##$$G_BAL_BFB_STMT2$$##'), 'NO_MASK');
   g_sql_tokens('##$$G_BAL_BFB_STMT3$$##') := G_BAL_BFB_STMT3;
   g_masked_tokens('##$$G_BAL_BFB_STMT3$$##') := mask_text( g_sql_tokens('##$$G_BAL_BFB_STMT3$$##'), 'NO_MASK');
   g_sql_tokens('##$$LEDGERID$$##') := g_set_of_books_id;
...
debug('begin add_signature: AR_TXF_BFB_CYCLES_B');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14267',
      p_sig_id                 => 'AR_TXF_BFB_CYCLES_B',
      p_sig_sql                => 'select distinct decode(hcp.site_use_id,null,''Account'',''Site'') "LEVEL", 
       hcp.site_use_id, 
       acb.*
from   ra_terms rt,       
       hz_customer_profiles hcp,       
       AR_CONS_BILL_CYCLES_B acb 
where  hcp.standard_terms = rt.term_id 
and    hcp.cust_account_id = ##$$CUSTACCTID$$## 
and    rt.billing_cycle_id = acb.billing_cycle_id 
order by 1, 2',
      p_title                  => 'AR_CONS_BILL_CYCLES_B',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No records found in AR_CONS_BILL_CYCLES_B for this customer at the account and/or site level.',
      p_solution               => '<ul>
<li>You need to associate billing cycles to your customer record to properly run Balance Forward Billing.</li>
<li>For more information, read section d. Define Balance Forward Billing Enabled Customer in [761180/KB371686#aref_section37] Balance Forward Billing Setup and Usage Guide for Oracle Receivables Users.</li>
</ul>
',
      p_success_msg            => 'Displaying records in AR_CONS_BILL_CYCLES_B for this customer at the account and/or site level.',
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_BFB_CYCLES_B');



debug('begin add_signature: AR_TXF_BFB_CYCLES_TL_ACCT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14268',
      p_sig_id                 => 'AR_TXF_BFB_CYCLES_TL_ACCT',
      p_sig_sql                => 'select distinct acb.* 
from ra_terms rt,       
     hz_customer_profiles hcp,       
     AR_CONS_BILL_CYCLES_TL acb 
where hcp.standard_terms = rt.term_id 
and   hcp.cust_account_id = ##$$CUSTACCTID$$## 
and   rt.billing_cycle_id = acb.billing_cycle_id 
and   hcp.site_use_id is null',
      p_title                  => 'AR_CONS_BILL_CYCLES_TL (Account Level)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no account-level billing cycles defined in AR_CONS_BILL_CYCLES_TL for this customer.',
      p_solution               => '<ul>
<li>This does not necessarily indicate an issue. However, if you expect to generate a consolidated BFB at the account level, then you should associate a BFB cycle at the account level. </li>
<li>For more information, read section d. Define Balance Forward Billing Enabled Customer in [761180/KB371686#aref_section37] Balance Forward Billing Setup and Usage Guide for Oracle Receivables Users.</li>
</ul>
',
      p_success_msg            => 'Displaying records in AR_CONS_BILL_CYCLES_TL for this customer at the account level.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_BFB_CYCLES_TL_ACCT');



debug('begin add_signature: AR_TXF_BFB_CYCLES_TL_SITE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14269',
      p_sig_id                 => 'AR_TXF_BFB_CYCLES_TL_SITE',
      p_sig_sql                => 'select distinct acb.* 
from ra_terms rt,       
     hz_customer_profiles hcp,       
     AR_CONS_BILL_CYCLES_TL acb 
...
and   hcp.site_use_id is not null',
      p_title                  => 'AR_CONS_BILL_CYCLES_TL (Site Level)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no site-level billing cycles defined in AR_CONS_BILL_CYCLES_TL for this customer.',
      p_solution               => '<ul>
<li>This does not necessarily indicate an issue. However, if you expect to generate BFB at the site level, then you should associate a BFB cycle at the site level. </li>
<li>For more information, read section d. Define Balance Forward Billing Enabled Customer in [761180/KB371686#aref_section37] Balance Forward Billing Setup and Usage Guide for Oracle Receivables Users.</li>
</ul>',
      p_success_msg            => 'Displaying records in AR_CONS_BILL_CYCLES_TL for this customer at the site level.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_BFB_CYCLES_TL_SITE');



debug('begin add_signature: AR_TXF_BFB_TERMS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14266',
      p_sig_id                 => 'AR_TXF_BFB_TERMS',
      p_sig_sql                => 'select distinct rt.* 
from   ra_terms rt, hz_customer_profiles hcp 
where  hcp.standard_terms = rt.term_id 
and    hcp.cust_account_id = ##$$CUSTACCTID$$##
and    hcp.cons_inv_flag = ''Y''',
      p_title                  => 'RA_TERMS Associated to BFB',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No records found in RA_TERMS associated to the records in HZ_CUSTOMER_PROFILES for this customer account.',
      p_solution               => '<ul>
<li>There are no Balance Forward Billing (BFB) payment terms defined for this customer.</li>
<li>This does not necessarily indicate an issue. However, if you expect to generate BFB at the account level, then you hve a BFB payment term associated to this customer. </li>
<li>For more information, read section b. Define Balance Forward Billing Payment Terms in [761180/KB371686#aref_section35] Balance Forward Billing Setup and Usage Guide for Oracle Receivables Users.</li>
</ul>',
      p_success_msg            => 'Displaying records in RA_TERMS associated to the records in HZ_CUSTOMER_PROFILES for this customer account.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_BFB_TERMS');



debug('begin add_signature: AR_TXF_BFB_CYCLE_DATES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14374',
      p_sig_id                 => 'AR_TXF_BFB_CYCLE_DATES',
      p_sig_sql                => 'select ''ACCOUNT'' "LEVEL",
       acbd.* 
from AR_CONS_BILL_CYCLE_DATES acbd
where billing_cycle_id in 
  (select acb.billing_cycle_id
   from   ra_terms rt,       
          hz_customer_profiles hcp,       
          AR_CONS_BILL_CYCLES_B acb 
   where  hcp.standard_terms = rt.term_id 
...
where billing_cycle_id in 
  (select acb.billing_cycle_id
   ...
   and    rownum <= 10 
order by 1, 3 desc',
      p_title                  => 'AR_CONS_BILL_CYCLE_DATES',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no records set up in AR_CONS_BILL_CYCLE_DATES for the billing cycle(s) associated to this customer.',
      p_solution               => 'Please review how to define cycle dates in section a. Define Balance Forward Billing Cycles in [761180/KB371686#aref_section34] Balance Forward Billing Setup and Usage Guide for Oracle Receivables Users.',
      p_success_msg            => 'Displaying the latest 10 records in AR_CONS_BILL_CYCLE_DATES for this customer at the account and/or site level.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_BFB_CYCLE_DATES');



debug('begin add_signature: AR_TXF_BFB_VERSION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14286',
      p_sig_id                 => 'AR_TXF_BFB_VERSION',
      p_sig_sql                => 'SELECT name, text, type
FROM   dba_source
where  name like ''AR_BFB%''
and    line = 2
and    type in (''PACKAGE'', ''PACKAGE BODY'')
order by 1',
      p_title                  => 'AR_BFB_UTILS_PVT Package Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Could not locate BFB PL/SQL package.',
      p_solution               => 'Please check that you have applied the proper versions of ARBFBUTS.pls and ARBFBUTB.pls. <br>
To find the latest version for your release, review [1584999/KB625435] How to find the Latest/Newest Version of an Oracle Receivables File.',
      p_success_msg            => 'Displaying the version of the BFB PL/SQL package.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_BFB_VERSION');



debug('begin add_signature: AR_TXF_BFB_CUST_INFO');
   l_info('##MASK##PARTY_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14285',
      p_sig_id                 => 'AR_TXF_BFB_CUST_INFO',
      p_sig_sql                => 'select p.party_name, p.party_number, hca.account_number, hca.status, hca.sales_channel_code 
from hz_parties p, hz_cust_accounts hca
where hca.party_id = p.party_id
and hca.cust_account_id = ##$$CUSTACCTID$$##',
      p_title                  => 'HZ_PARTIES',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying HZ_PARTIES information for this customer account.',
      p_solution               => '',
      p_success_msg            => 'No HZ_PARTIES information for this customer account.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_BFB_CUST_INFO');



debug('begin add_signature: AR_TXF_HZ_CUST_ACCT_SITES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14498',
      p_sig_id                 => 'AR_TXF_HZ_CUST_ACCT_SITES',
      p_sig_sql                => 'select cust_acct_site_id, cust_account_id, party_site_id, creation_date, status, bill_to_flag, ship_to_flag, customer_category_code, territory_id
from   hz_cust_acct_sites_all
where  cust_account_id =  ##$$CUSTACCTID$$##
and    org_id = ##$$ORGID$$##
order by cust_acct_site_id',
      p_title                  => 'HZ_CUST_ACCT_SITES',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No records found in HZ_CUST_ACCT_SITES for this customer account.',
      p_solution               => '',
      p_success_msg            => 'Displaying records in HZ_CUST_ACCT_SITES for this customer account.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_HZ_CUST_ACCT_SITES');



debug('begin add_signature: AR_TXF_BFB_SITE_USES');
   l_info('##MASK##ORIG_SYSTEM_REFERENCE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14499',
      p_sig_id                 => 'AR_TXF_BFB_SITE_USES',
      p_sig_sql                => 'select site_use_id, cust_acct_site_id, site_use_code, primary_flag, status, location, bill_to_site_use_id, orig_system_reference
  from HZ_CUST_SITE_USES_ALL 
 where CUST_ACCT_SITE_ID in 
   (select CUST_ACCT_SITE_ID
    ...
    where CUST_ACCOUNT_ID = ##$$CUSTACCTID$$##)
   and org_id = ##$$ORGID$$##',
      p_title                  => 'HZ_CUST_SITE_USES',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No records found in HZ_CUST_SITE_USES for this customer account.',
      p_solution               => '',
      p_success_msg            => 'Displaying records in HZ_CUST_SITE_USES for this customer account.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_BFB_SITE_USES');



debug('begin add_signature: AR_TXF_BFB_CUST_PROF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14264',
      p_sig_id                 => 'AR_TXF_BFB_CUST_PROF',
      p_sig_sql                => 'SELECT hcp.cust_account_profile_id, hcp.cust_account_id, hcp.site_use_id, hcp.status, hcp.profile_class_id,
       rt.name , hcp.override_terms, hcp.cons_inv_flag, hcp.cons_inv_type, hcp.cons_bill_level, hcpc.DISCOUNT_GRACE_DAYS, hcpc.DISCOUNT_TERMS, 
       hcp.last_updated_by, hcp.last_update_date, hcp.last_update_login,
       hcp.created_by, hcp.creation_date
FROM   hz_customer_profiles hcp, ra_terms rt, hz_cust_profile_classes hcpc
where  hcp.cust_account_id = ##$$CUSTACCTID$$##
and    nvl(hcp.cons_inv_flag,''N'') = ''Y''
and    hcp.standard_terms = rt.term_id
and    hcp.profile_class_id = hcpc.profile_class_id
order by 1,2,3',
      p_title                  => 'HZ_CUSTOMER_PROFILES',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No records found in HZ_CUSTOMER_PROFILES for this customer account.',
      p_solution               => '',
      p_success_msg            => 'Displaying records in HZ_CUSTOMER_PROFILES for this customer account.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_BFB_CUST_PROF');



debug('begin add_signature: AR_TXF_BFB_AR_CONS_INV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14273',
      p_sig_id                 => 'AR_TXF_BFB_AR_CONS_INV',
      p_sig_sql                => 'select aci.*
from  AR_CONS_INV_ALL aci
where customer_id = ##$$CUSTACCTID$$##
order by cons_inv_id, cons_billing_number, customer_id, site_use_id',
      p_title                  => 'AR_CONS_INV_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no Balance Forward Bills (BFB) found in AR_CONS_INV_ALL for this customer account. <br>
If you have not yet generated BFB for this customer, then this does not indicate a problem.',
      p_solution               => '',
      p_success_msg            => 'Displaying records in AR_CONS_INV_ALL for this customer account.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_BFB_AR_CONS_INV');



debug('begin add_signature: AR_TXF_BFB_AR_CONS_TRX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14272',
      p_sig_id                 => 'AR_TXF_BFB_AR_CONS_TRX',
      p_sig_sql                => 'select act.*
from   AR_CONS_INV_ALL aci,        
       AR_CONS_INV_TRX_ALL act 
where  aci.customer_id = ##$$CUSTACCTID$$##
and    aci.cons_inv_id = act.cons_inv_id 
and    act.org_id = ##$$ORGID$$##
ORDER BY act.CONS_INV_ID, act.CONS_INV_LINE_NUMBER',
      p_title                  => 'AR_CONS_INV_TRX_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no Balance Forward Bills found in AR_CONS_INV_TRX_ALL for this customer. <br>
If you have not yet generated BFB for this customer, then this does not indicate a problem.',
      p_solution               => '',
      p_success_msg            => 'Displaying records in AR_CONS_INV_TRX_ALL for this customer account.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_BFB_AR_CONS_TRX');



debug('begin add_signature: AR_TXF_BFB_AR_CONS_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14270',
      p_sig_id                 => 'AR_TXF_BFB_AR_CONS_LINES',
      p_sig_sql                => 'select acl.* 
from AR_CONS_INV_ALL aci, AR_CONS_INV_TRX_LINES_ALL acl 
where aci.customer_id = ##$$CUSTACCTID$$##
and aci.cons_inv_id = acl.cons_inv_id 
and acl.org_id = ##$$ORGID$$##
order by acl.cons_inv_id, acl.cons_inv_line_number,acl.line_number',
      p_title                  => 'AR_CONS_INV_TRX_LINES_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no Balance Forward Bills found in AR_CONS_INV_TRX_LINES_ALL for this customer. <br>
If you have not yet generated BFB for this customer, then this does not indicate a problem.',
      p_solution               => '',
      p_success_msg            => 'Displaying records in AR_CONS_INV_TRX_LINES_ALL for this customer account.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_BFB_AR_CONS_LINES');



debug('begin add_signature: AR_TXF_BFB_CYCLE_DATES_EXP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14375',
      p_sig_id                 => 'AR_TXF_BFB_CYCLE_DATES_EXP',
      p_sig_sql                => 'select max(billable_date) 
...
where billing_cycle_id in 
  (select acb.billing_cycle_id
   ...
   and    hcp.cust_account_id = ##$$CUSTACCTID$$## 
   and    rt.billing_cycle_id = acb.billing_cycle_id )
having max(billable_date) < sysdate - 30',
      p_title                  => 'Maximum Billable Date Expired or Will Expire Soon',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'You have no billable dates beyond a month from now. This means that when you attempt to run the next Balance Forward Bill, you may encounter errors.',
      p_solution               => 'Please review section a. Define Balance Forward Billing Cycles in [761180/KB371686#aref_section34] Balance Forward Billing Setup and Usage Guide for Oracle Receivables Users. <br>
In order to prevent disruption in the creation of Balance Forward Bills, please define billable dates that run at least 2 months into the future.',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_BFB_CYCLE_DATES_EXP');



debug('begin add_signature: AR_TXF_BFB_CUST_NOT_ENABLED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14501',
      p_sig_id                 => 'AR_TXF_BFB_CUST_NOT_ENABLED',
      p_sig_sql                => 'SELECT distinct ''Y'' 
FROM   hz_customer_profiles hcp, ra_terms rt, hz_cust_profile_classes hcpc
where  hcp.cust_account_id = ##$$CUSTACCTID$$##
and    nvl(hcp.cons_inv_flag,''N'') = ''Y''
and    hcp.standard_terms = rt.term_id
and    hcp.profile_class_id = hcpc.profile_class_id',
      p_title                  => 'Customer is not BFB Enabled',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Customer is not BFB enabled.',
      p_solution               => 'The customer account has to be BFB-enabled to create Balance Forward Bills.
For more information, please read section "d. Define Balance Forward Billing Enabled Customer" [761180/KB371686##aref_section37] Balance Forward Billing Setup and Usage Guide for Oracle Receivables Users.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_BFB_CUST_NOT_ENABLED');



debug('begin add_signature: AR_TXF_BFB_TERM_HAS_INSTALLMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14500',
      p_sig_id                 => 'AR_TXF_BFB_TERM_HAS_INSTALLMENTS',
      p_sig_sql                => 'select rt.term_id, rt.billing_cycle_id, rt.cycle_name 
from   ra_terms rt, hz_customer_profiles hcp 
where  hcp.standard_terms = rt.term_id 
and    hcp.cust_account_id = ##$$CUSTACCTID$$##
and    hcp.cons_inv_flag = ''Y''
and    (select count(*) 
        from RA_TERMS_LINES 
        where term_id = rt.term_id) > 1',
      p_title                  => 'Payment Term used for BFB has Installments',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The payment term you have associated to the BFB customer profile has installments.',
      p_solution               => 'Please review the payment terms you have associated to the customer profile used for BFB. BFB payment terms cannot have installments.
For more information, please read [761180/KB371686##aref_section35] Balance Forward Billing Setup and Usage Guide for Oracle Receivables Users.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_BFB_TERM_HAS_INSTALLMENTS');



debug('begin add_signature: AR_TXF_BFB_WRONG_BAL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14518',
      p_sig_id                 => 'AR_TXF_BFB_WRONG_BAL',
      p_sig_sql                => 'select cons_inv_id,
       customer_id, 
       site_use_id, 
       issue_date,
       beginning_balance, 
       ##$$A$$##.calc_begin_balance(customer_id, site_use_id, cons_inv_id) "CALCULATED_BEGINNING_BALANCE", 
       ending_balance, 
       ##$$A$$##.calc_end_balance(customer_id, site_use_id, cons_inv_id) "CALCULATED_ENDING_BALANCE"
  from AR_CONS_INV_ALL
 where status = ''ACCEPTED''
   and CUT_OFF_DATE is NULL
   and BILLING_DATE is NOT NULL
   and customer_id = ##$$CUSTACCTID$$##
   and (beginning_balance <> ##$$A$$##.calc_begin_balance(customer_id, site_use_id, cons_inv_id)
        or ending_balance <>  ##$$A$$##.calc_end_balance(customer_id, site_use_id, cons_inv_id))
   order by customer_id, site_use_id, issue_date',
      p_title                  => 'BFB Balance is Incorrect',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The balances stored in AR_CONS_INV_ALL do not tally with the balances calculated from various tables.',
      p_solution               => '<ul>
<li>The analyzer has identified data corruption described in [2359110/KB723929] Balance Forward Bills Show Incorrect Balance.</li>
<li>Please log a Service Request and upload this analyzer output.</li>
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_BFB_WRONG_BAL');



debug('begin add_signature: AR_TXF_BFB_DUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14605',
      p_sig_id                 => 'AR_TXF_BFB_DUP',
      p_sig_sql                => 'select max(cinv.cons_inv_id) cons_inv_id,
       cinv.customer_id,
       cinv.site_use_id,
       cinv.currency_code,
       cinv.billing_date,
       cinv.beginning_balance,
       cinv.ending_balance
  from ar_cons_inv_all cinv
 where customer_id = ##$$CUSTACCTID$$##
   and status in (''FINAL'',''ACCEPTED'')
and exists
(
 select ''X'' 
  from ar_cons_inv_all cinvin
 where customer_id = cinv.customer_id
   and site_use_id = cinv.site_use_id
   and status in ( ''FINAL'',''ACCEPTED'')
   and currency_code = cinv.currency_code
   and billing_date = cinv.billing_date
   and cinvin.cons_inv_id <> cinv.cons_inv_id
)
and not exists
(
 select ''X'' 
  from ar_cons_inv_trx_all cinvtrx
 where cinvtrx.cons_inv_id = cinv.cons_inv_id
)
group by cinv.customer_id, cinv.site_use_id, cinv.currency_code, cinv.billing_date, cinv.beginning_balance, cinv.ending_balance',
      p_title                  => 'Duplicate BFB Exists',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Duplicate BFBs exist wherein the site, currency and billing date are the same, but one BFB has no records in the AR_CONS_INV_TRX_ALL table.',
      p_solution               => '<ul>
<li>For more information, read [1662265/KB522175] Transactions Workbench Issue: Balance Forward Billing Program Is Stamping Incorrect Opening and Closing Balances.</li>
<li>Please log a Service Request and upload this analyzer output.</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_BFB_DUP');



debug('begin add_signature: EBS_FIN_AR_ARTXFANLZ_AR_TXF_BFB_DRAFT_AR_CONS_INV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31151',
      p_sig_id                 => 'EBS_FIN_AR_ARTXFANLZ_AR_TXF_BFB_DRAFT_AR_CONS_INV',
      p_sig_sql                => 'SELECT * FROM ar_cons_inv_all
where status = ''DRAFT''
and CUSTOMER_ID = ##$$CUSTACCTID$$##
order by cons_inv_id, cons_billing_number, customer_id, site_use_id',
      p_title                  => 'Draft BFB present for this customer account',
      p_fail_condition         => 'RSGT1',
      p_problem_descr          => 'There are DRAFT Balance Forward Bills (BFB) found in AR_CONS_INV_ALL for this customer account. <br>
Draft bill exist for this customer, no new BFB will be generated.',
      p_solution               => 'Run Confirm Balance Forward Bill concurrent program to confirm or reject the existing draft bill for the BFB to pick up the records again.
Please refer to notes:
Balance Forward Billing Setup and Usage Guide for Oracle Receivables Users [761180/KB371686]
FAQ : Balance Forward Billing (BFB) Common Issues and Concerns [1080423/FAQ3705]',
      p_success_msg            => 'Displaying DRAFT records in AR_CONS_INV_ALL for this customer account.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_ARTXFANLZ_AR_TXF_BFB_DRAFT_AR_CONS_INV');



debug('begin add_signature: AR_TXF_EDI_BUS_GROUP');
   l_info('##MASK##LEVEL VALUE'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14348',
      p_sig_id                 => 'AR_TXF_EDI_BUS_GROUP',
 ...
 WHERE e.application_id = a.application_id
   ...
   AND ((a.level_id = 10003 AND a.level_value = ##$$RESP_ID$$##)
         ...
         OR (a.level_id = 10001 )
         OR (a.level_id = 10002 ))
   AND e.profile_option_name = ''PER_BUSINESS_GROUP_ID''
   AND bg.business_group_id = a.profile_option_value',
      p_title                  => 'Business Group',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Did not find Profile Option settings for HR:Business Group.',
      p_solution               => '<ul>
<li>Please evaluate with your HR team to determine the value and level at which this profile option should be set.</li>
<li>For more information, read [214763/KB581779] What Is The Functionality Of The Profile Option : HR:Business Group.</li>
</ul>',
      p_success_msg            => 'Displaying Profile settings for HR:Business Group.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_EDI_BUS_GROUP');



debug('begin add_signature: AR_TXF_EDI_FILE_PATH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14349',
      p_sig_id                 => 'AR_TXF_EDI_FILE_PATH',
      p_sig_sql                => 'SELECT ''##$$ECE_PROFILE$$##'' "ECE: Output File Path",
       ''##$$INIT_ORA$$##'' "UTL_FILE_DIR"
from dual
where instr(''##$$INIT_ORA$$##'', ''##$$ECE_PROFILE$$##'') = 0',
      p_title                  => 'ECE: Output File Path Does not Exist in UTL_FILE_DIR Settings',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The file path settings in Profile option ECE: Output File Path do not exist in init.ora UTL_FILE_DIR settings.',
      p_solution               => 'Please check your settings for profile option ECE: Output File Path and ensure the value also exists in init.ora UTL_FILE_DIR. <br>
Please review [198252/KB203701] How To Setup EDI 810 Outbound and 812 Outbound.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_EDI_FILE_PATH');



debug('begin add_signature: AR_TXF_EDI_FILE_PATH_OK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14350',
      p_sig_id                 => 'AR_TXF_EDI_FILE_PATH_OK',
      p_sig_sql                => 'SELECT ''##$$ECE_PROFILE$$##'' "ECE: Output File Path",
       ''##$$INIT_ORA$$##'' "UTL_FILE_DIR"
from dual
where instr(''##$$INIT_ORA$$##'', ''##$$ECE_PROFILE$$##'') <> 0',
      p_title                  => 'Verified ECE: Output File Path Exists in UTL_FILE_DIR Settings',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The settings are correct, the file path settings in Profile option ECE: Output File Path also exist in init.ora UTL_FILE_DIR settings.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_EDI_FILE_PATH_OK');



debug('begin add_signature: AR_TXF_EDI_INTFC_SETUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14359',
      p_sig_id                 => 'AR_TXF_EDI_INTFC_SETUP',
      p_sig_sql                => 'SELECT distinct 
       a.map_id                  "MAP ID", 
       a.external_level          "EXTERNAL LEVEL",
       a.external_level_id       "EXTERNAL LEVEL ID", 
       SUBSTR(b1.meaning, 1,35)  "LEVEL MEANING",
       SUBSTR(b.meaning,1,35)    "DOCUMENT MEANING", 
       c.map_code                "MAP NAME" 
FROM   ECE_EXTERNAL_LEVELS a, 
       ECE_LOOKUP_VALUES b, 
       ECE_LOOKUP_VALUES b1,
       ECE_MAPPINGS c
WHERE  a.transaction_type = ''INO'' 
AND    b.lookup_type = ''DOCUMENT'' 
AND    b.lookup_code = ''INO'' 
AND    a.map_id = c.map_id
AND    c.enabled = ''Y''
AND    b1.lookup_type = ''OUTPUT_LEVEL_INO''
AND    b1.lookup_code = a.external_level
ORDER BY 2',
      p_title                  => 'Interface Setup',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no interface setup defined for Invoice Outbound (INO).',
      p_solution               => 'There appears to have been a failure in the installation of ECE in your instance, because you are missing even the SEEDED data. <br>
For more information, please read [2664455/KB326420] Missing Seed Data, No Interface Setup Defined For Invoice Outbound (INO).',
      p_success_msg            => 'Displaying interface file setup for Invoice Outbound (INO).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_EDI_INTFC_SETUP');



debug('begin add_signature: AR_TXF_EDI_TRAD_PARTNER_CUST');
   l_info('##MASK##PARTY_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14363',
      p_sig_id                 => 'AR_TXF_EDI_TRAD_PARTNER_CUST',
      p_sig_sql                => 'SELECT  b.tp_code, 
        b.creation_date,
        a.document_type, 
        a.translator_code, 
        a.document_standard, 
        ad.ece_tp_location_code,  
        ab.party_name, 
        c.tp_group_code  
FROM    ECE_TP_DETAILS a, 
        ECE_TP_HEADERS b, 
        ECE_TP_GROUP c, 
        HZ_CUST_ACCOUNTS_ALL aa,  
        HZ_PARTIES ab,  
        HZ_PARTY_SITES ac,  
        HZ_CUST_ACCT_SITES_ALL ad  
WHERE   b.tp_header_id = a.tp_header_id 
AND     a.tp_header_id = ad.tp_header_id 
AND     b.tp_group_id = c.tp_group_id  
AND     a.edi_flag = ''Y'' 
AND     a.document_id = ''INO'' 
AND     a.document_type in (''INV'',''CM'',''DM'')  
AND     aa.CUST_ACCOUNT_ID = ##$$CUSTACCTID$$##
--AND     ab.party_number = aa.account_number 
AND     aa.party_id = ab.party_id 
AND     ab.party_id = ac.party_id 
AND     ac.party_site_id = ad.party_site_id  
AND     aa.status = ''A'' 
AND     ab.status = ''A'' 
AND     ac.status = ''A'' 
AND     ad.status = ''A''  
AND  NVL(ad.org_id, -99) = ##$$ORGID$$##
ORDER BY c.tp_group_id, a.tp_header_id, aa.account_name',
      p_title                  => 'Trading Partners',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no trading partner set up for this customer account.',
      p_solution               => 'To set up trading partners, please review [198252/KB203701#tp] How To Setup EDI 810 Outbound and 812 Outbound.',
      p_success_msg            => 'Displaying the trading partners for this customer account.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_EDI_TRAD_PARTNER_CUST');



debug('begin add_signature: AR_TXF_EDI_PROFILE');
   l_info('##MASK##LEVEL VALUE'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14506',
      p_sig_id                 => 'AR_TXF_EDI_PROFILE',
      p_sig_sql                => 'SELECT
...
FROM
    ...
    fnd_profile_options e
WHERE
    e.profile_option_name IN (''ECE_INO_ENABLED'')
...
AND ((a.level_id = 10003 AND a.level_value = ##$$RESP_ID$$##)
         ...
         OR (a.level_id = 10002 ))
ORDER BY 2,3',
      p_title                  => 'ECE Profile Options',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Did not find Profile Option settings for OUT: Invoice (810/INVOIC).',
      p_solution               => 'The profile option: <em>OUT: Invoice (810/INVOIC)</em> should be set to Yes.
For more information, read [261354/KB757112] How to Troubleshoot ECEINO Failing For: No HEADER level rows processed for transaction INO.

',
      p_success_msg            => 'Displaying Profile settings for OUT: Invoice (810/INVOIC).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_EDI_PROFILE');



debug('begin add_signature: AR_TXF_EDI_CODE_CONV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14429',
      p_sig_id                 => 'AR_TXF_EDI_CODE_CONV',
      p_sig_sql                => 'SELECT interface_column_name,
       base_column_name,
       base_table_name,
       xref_category_id
  FROM ece_interface_columns
 WHERE map_id = (select map_id from ece_mappings
		 where transaction_type = ''INO'')
and xref_category_id is not null
order by 1',
      p_title                  => 'EDI Code Conversions Setup',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the Code conversions that you have set up. <br>
This does not necessarily indicate an issue. <br>
It is just for information to make you aware that you have defined code conversions in your set up.<br>
For more information on using Code Conversions, please read section 4. Setting up code conversions (if necessary) in [198252/KB203701#cc] How To Setup EDI 810 Outbound and 812 Outbound.',
      p_solution               => '',
      p_success_msg            => 'No code conversions exist.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_EDI_CODE_CONV');



debug('begin add_signature: AR_TXF_EDI_CODE_CONV_IN_DAT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14430',
      p_sig_id                 => 'AR_TXF_EDI_CODE_CONV_IN_DAT',
      p_sig_sql                => 'SELECT exd.xref_category_code, exd.xref_int_value, count(exd.xref_int_value) NUMBER_OF_RECORDS
  FROM ece_xref_data exd,
       ece_interface_columns eic
 WHERE exd.xref_category_id = eic.xref_category_id
   AND eic.map_id = (select map_id from ece_mappings
                     where transaction_type=''INO'')
group by exd.xref_category_code, exd.xref_int_value',
      p_title                  => 'EDI Code Conversions Exist in Data File',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the records in the Data file that use Code conversions.<br>
This does not necessarily indicate an issue. <br>
It is just for information to make you aware that you are using code conversions in your data file.<br>
For more information on using Code Conversions, please find the chapter on Code Conversions in the the User''s Guide by navigating to [1604832/KB454959#documentation] Oracle e-Commerce Gateway Release Notes for Release 12.2.3. ',
      p_solution               => '',
      p_success_msg            => 'No code conversions exist in the data file.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_EDI_CODE_CONV_IN_DAT');



debug('begin add_signature: AR_TXF_EDI_INVOICES_CUST');
   l_info('##MASK##BILL_TO_CUSTOMER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14365',
      p_sig_id                 => 'AR_TXF_EDI_INVOICES_CUST',
      p_sig_sql                => 'SELECT   DOCUMENT_TYPE, TP_DOCUMENT_CODE, BILL_TO_CUSTOMER_NAME
FROM     ECE_INO_HEADER_V v, RA_CUSTOMER_TRX_ALL trx
WHERE    v.bill_to_customer_number = ##$$CUSTACCTID$$##
and      v.transaction_id = trx.customer_trx_id
and      nvl(trx.EDI_PROCESSED_FLAG,''N'') = ''N''',
      p_title                  => 'Receivables Invoices',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no invoices waiting to be invoiced for this customer account.',
      p_solution               => '',
      p_success_msg            => 'Displaying invoices waiting to be invoiced for this customer account.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_EDI_INVOICES_CUST');



debug('begin add_signature: AR_TXF_EDI_LOCATION_SETUP_CUST');
   l_info('##MASK##CONCATENATED_ADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14361',
      p_sig_id                 => 'AR_TXF_EDI_LOCATION_SETUP_CUST',
      p_sig_sql                => 'select
ADDR.ORG_ID,
PARTY_SITE.PARTY_SITE_NUMBER,
ADDR.STATUS STATUS,
ARP_ADDR_PKG.FORMAT_ADDRESS(LOC.ADDRESS_STYLE,LOC.ADDRESS1, LOC.ADDRESS2,LOC.ADDRESS3,LOC.ADDRESS4,LOC.CITY,LOC.COUNTY, LOC.STATE,LOC.PROVINCE,LOC.POSTAL_CODE, TERR.TERRITORY_SHORT_NAME ) CONCATENATED_ADDRESS,
...
AND ADDR.ORG_ID = LOC_ASSIGN.ORG_ID
AND ADDR.ORG_ID = ##$$ORGID$$##
AND ADDR.CUST_ACCOUNT_ID = ##$$CUSTACCTID$$##
AND ADDR.ECE_TP_LOCATION_CODE IS NOT NULL
ORDER BY 1,2',
      p_title                  => 'EDI Location Setup',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no EDI locations setup for this customer account.',
      p_solution               => '<ul>
<li>To enable EDI for this customer, you need to define a site that will serve as the EDI Location. </li>
<li>For more information, read section 5. Setting up an EDI location in [198252/KB203701#edi_loc] How To Setup EDI 810 Outbound and 812 Outbound.</li>
</ul>',
      p_success_msg            => 'EDI location is properly set up for this customer account.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_EDI_LOCATION_SETUP_CUST');



debug('begin add_signature: AR_TXF_EDI_LOCATION_BILL_TO');
   l_info('##MASK##CONCATENATED_ADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14426',
      p_sig_id                 => 'AR_TXF_EDI_LOCATION_BILL_TO',
      p_sig_sql                => 'select ADDR.CUST_ACCOUNT_ID,
...
ORDER BY 1,2',
      p_title                  => 'EDI Location Associated to Bill To Site',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The site identified as the EDI Location is not a Bill To site.',
      p_solution               => '<ul>
<li>The site used as EDI Location should have a Bill-To Purpose.</li>
<li>For more information, read section 5. Setting up an EDI location in [198252/KB203701#edi_loc] How To Setup EDI 810 Outbound and 812 Outbound.</li>
</ul>',
      p_success_msg            => 'EDI location is correctly associated to a site with a Bill To purpose.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_EDI_LOCATION_BILL_TO');



debug('begin add_signature: AR_TXF_EDI_INV_NOT_PRINT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14503',
      p_sig_id                 => 'AR_TXF_EDI_INV_NOT_PRINT',
      p_sig_sql                => 'select trx_number, customer_trx_id, bill_to_site_use_id, printing_pending
from ra_customer_trx_all
where bill_to_site_use_id in 
   (select site_use_id 
      from hz_cust_site_uses_all 
     where cust_acct_site_id in
            (select cust_acct_site_id 
              from hz_cust_acct_sites_all
              where cust_account_id = ##$$CUSTACCTID$$##
                and ECE_TP_LOCATION_CODE IS NOT NULL))
and printing_option = ''NOT''
order by 1',
      p_title                  => 'Invoices Set to Not Print',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are invoices associated to the EDI location that have been set to <em>Do Not Print</em>. These transactions will not create EDI invoices.',
      p_solution               => '<ul>
<li>If you expect these transactions to be printed, check the set up for Printing Option associated to the transaction.</li>
<li>For more information read the Note section in [198252/KB203701#trx] How To Setup EDI 810 Outbound and 812 Outbound.</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_EDI_INV_NOT_PRINT');



debug('begin add_signature: AR_TXF_EDI_PRINT_PENDING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14504',
      p_sig_id                 => 'AR_TXF_EDI_PRINT_PENDING',
      p_sig_sql                => 'select trx_number, customer_trx_id, bill_to_site_use_id, printing_pending, printing_count
from ra_customer_trx_all
where bill_to_site_use_id in 
   (select site_use_id 
      from hz_cust_site_uses_all 
     where cust_acct_site_id in
            (select cust_acct_site_id 
              ...
              where cust_account_id = ##$$CUSTACCTID$$##
                and ECE_TP_LOCATION_CODE IS NOT NULL))
and printing_pending = ''N'' 
and EDI_processed_flag = ''N''
and EDI_processed_status = NULL
and org_id = ##$$ORGID$$##
order by 1',
      p_title                  => 'Invoices Printed in Receivables Instead of in EDI',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are invoices that were printed in Receivables instead of in EDI.',
      p_solution               => 'For more information on how to reset the flags so the invoice(s) can be picked up by EDI, [236071/KB714046] 810 Outbound: Invoices Are Not Showing in the List of Values (LOV) for INO - Invoices Have Been Printed in Receivables.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_EDI_PRINT_PENDING');



debug('begin add_signature: AR_TXF_EDI_TRX_BEFORE_TP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14505',
      p_sig_id                 => 'AR_TXF_EDI_TRX_BEFORE_TP',
      p_sig_sql                => 'select trx_number, customer_trx_id, bill_to_site_use_id, trx_date
from ra_customer_trx_all
where bill_to_site_use_id in 
   (select site_use_id 
      from hz_cust_site_uses_all 
...
AND a.document_id = ''INO''
AND a.document_type in (''INV'',''CM'',''DM'')
AND aa.account_number = ##$$CUSTACCTID$$##
AND ab.party_number = aa.account_number
AND aa.party_id = ab.party_id
AND ab.party_id = ac.party_id
AND ac.party_site_id = ad.party_site_id
...
AND ad.status = ''A''
AND NVL(ad.org_id, -99) = ##$$ORGID$$##)',
      p_title                  => 'Transactions Created Prior to Trading Partners Set Up',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are transactions that were created prior to the set up of Trading Partner. These transactions may be excluded from the EDI.',
      p_solution               => 'To set up Trading Partners, please review [198252/KB203701] How To Setup EDI 810 Outbound and 812 Outbound.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_EDI_TRX_BEFORE_TP');



debug('begin add_signature: AR_TXF_LC_SYSTEM_PAR_LC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14325',
      p_sig_id                 => 'AR_TXF_LC_SYSTEM_PAR_LC',
      p_sig_sql                => 'select  set_of_books_id,
        org_id,
        allow_late_charges,
...
where   org_id = ##$$ORGID$$##
and     allow_late_charges = ''Y''',
      p_title                  => 'System Options Setup for Late Charges',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Late charges are not enabled in system options.',
      p_solution               => 'To enable late charges, review the Define Organizational Late Charge Policy section in [1269062/KB620952#aref_section33]',
      p_success_msg            => 'Displaying system options for late charges.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_LC_SYSTEM_PAR_LC');



debug('begin add_signature: AR_TXF_LC_PROFILE');
   l_info('##MASK####MASK##LEVEL VALUE'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14382',
      p_sig_id                 => 'AR_TXF_LC_PROFILE',
      p_sig_sql                => 'SELECT user_profile_option_name "PROFILE OPTION",
a.profile_option_value "PROFILE VALUE",
DECODE(a.level_id, 10001, ''Site'',
10002, ''Application'',
...
AND a.level_value = d.user_id(+)
AND t.profile_option_name = e.profile_option_name
AND e.profile_option_name = ''AR_USE_STATEMENTS_AND_DUNNING_SITE_PROFILE''
AND t.LANGUAGE = ''US''
AND nvl(c.LANGUAGE,''US'') = ''US''
AND ((a.level_id = 10003 AND a.level_value = ##$$RESP_ID$$##)
OR (a.level_id = 10004 AND d.user_name = ''##$$USERNAME$$##'')
...
ORDER BY a.level_id DESC',
      p_title                  => 'Late Charges Profile Setup',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying Late Charges Profile Setup.<br>
For information on how to set up this profile, review [1269062/KB620952] Late Charges Calculation and Set Up: A Guide for Oracle Receivables Use.',
      p_solution               => '',
      p_success_msg            => 'Displaying Late Charges Profile Setup.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_LC_PROFILE');



debug('begin add_signature: AR_TXF_LC_AR_RECEIVABLES_TRX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14333',
      p_sig_id                 => 'AR_TXF_LC_AR_RECEIVABLES_TRX',
      p_sig_sql                => 'select * 
from   ar_receivables_trx 
where  org_id = ##$$ORGID$$## 
and    receivables_trx_id in (select penalty_rec_trx_id       
                              from   ar_system_parameters_all       
			      where  org_id = ##$$ORGID$$##       
			      union       
			      select finchrg_receivables_trx_id       
			      from   ar_system_parameters_all       
			      where  org_id = ##$$ORGID$$##)',
      p_title                  => 'Receivables Activity for Late Charges',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No receivables activity for late charges.  The values set up here are used if you record late charges as adjustments.',
      p_solution               => 'Review the Setup Late Charge Documents section in [1269062/KB620952#define_rec_act] ',
      p_success_msg            => 'Displaying receivables activity for late charges.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_LC_AR_RECEIVABLES_TRX');



debug('begin add_signature: AR_TXF_LC_RA_BATCH_SOURCES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14332',
      p_sig_id                 => 'AR_TXF_LC_RA_BATCH_SOURCES',
      p_sig_sql                => 'select  * 
from 	ra_batch_sources_all
where 	org_id = ##$$ORGID$$##  
and   	batch_source_id in (select late_charge_batch_source_id       	
                             from   ar_system_parameters_all       
		             where  org_id = ##$$ORGID$$##)',
      p_title                  => 'Batch Sources for Late Charges',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No batch sources for late charges. This setup is required for interest invoices and/or debit memos.',
      p_solution               => 'Review the Setup Late Charge Documents section in [1269062/KB620952#define_batch]',
      p_success_msg            => 'Displaying batch sources for late charges.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_LC_RA_BATCH_SOURCES');



debug('begin add_signature: AR_TXF_LC_CUST_TRX_TYPE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14326',
      p_sig_id                 => 'AR_TXF_LC_CUST_TRX_TYPE',
      p_sig_sql                => 'select cust_trx_type_id,
       name,
       description,
       org_id,
       post_to_gl,
...
where  org_id = ##$$ORGID$$## 
and    cust_trx_type_id in (select late_charge_dm_type_id       
	                   from   ar_system_parameters_all       
			   where  org_id = ##$$ORGID$$##       
			   union       
			   select late_charge_inv_type_id       
			   from   ar_system_parameters_all       
			   where  org_id = ##$$ORGID$$##)',
      p_title                  => 'Transaction Type Setup for Late Charges',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No transaction type setup for late charges. This setup is required for interest invoices and/or debit memos, as well as allowing further calculation based upon transaction types for particular customers.',
      p_solution               => 'Review the Setup Late Charge Documents section in [1269062/KB620952#define_trx] ',
      p_success_msg            => 'Displaying transaction type setup for late charges.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_LC_CUST_TRX_TYPE');



debug('begin add_signature: AR_TXF_LC_CUST_TRX_TYPE_EXCLUDED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14327',
      p_sig_id                 => 'AR_TXF_LC_CUST_TRX_TYPE_EXCLUDED',
      p_sig_sql                => 'select cust_trx_type_id,
       name,
       description,
       org_id,
...
from   ra_cust_trx_types_all 
where  org_id = ##$$ORGID$$## 
and    EXCLUDE_FROM_LATE_CHARGES = ''Y''',
      p_title                  => 'Transaction Types Excluded from Late Charges',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the specific transaction types selected to be excluded from late charges, transactions with these transaction types will not have late charges.',
      p_solution               => '',
      p_success_msg            => 'No transaction types excluded from late charges.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_LC_CUST_TRX_TYPE_EXCLUDED');



debug('begin add_signature: AR_TXF_LC_HZ_CUSTOMER_PROFILES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14334',
      p_sig_id                 => 'AR_TXF_LC_HZ_CUSTOMER_PROFILES',
      p_sig_sql                => 'select
...
from   hz_customer_profiles 
where  cust_account_id = ##$$CUSTACCTID$$##
and    interest_charges = ''Y''
order by site_use_id',
      p_title                  => 'HZ_CUSTOMER_PROFILES Enabled for Late Charges',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This customer account has no records enabled in HZ_CUSTOMER_PROFILES for late charges.  This allows you to control how late charges are calculated.',
      p_solution               => 'Review the Define Late Charge Profile section in [1269062/KB620952#aref_section36]
',
      p_success_msg            => 'Displaying the customer account records enabled in HZ_CUSTOMER_PROFILES for late charges.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_LC_HZ_CUSTOMER_PROFILES');



debug('begin add_signature: AR_TXF_LC_HZ_CUSTOMER_PROFILES_EXCLUDED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14496',
      p_sig_id                 => 'AR_TXF_LC_HZ_CUSTOMER_PROFILES_EXCLUDED',
      p_sig_sql                => 'select
CUST_ACCOUNT_PROFILE_ID,
CUST_ACCOUNT_ID,
STATUS,
...
from   hz_customer_profiles 
where  cust_account_id = ##$$CUSTACCTID$$##
and    interest_charges = ''N''
order by site_use_id',
      p_title                  => 'HZ_CUSTOMER_PROFILES Excluded from Late Charges',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying records in HZ_CUSTOMER_PROFILES for this customer account excluded from Late Charges.',
      p_solution               => '',
      p_success_msg            => 'No records found in HZ_CUSTOMER_PROFILES for this customer account excluded from Late Charges.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_LC_HZ_CUSTOMER_PROFILES_EXCLUDED');



debug('begin add_signature: AR_TXF_LC_HZ_CUST_PROFILE_CLASSES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14335',
      p_sig_id                 => 'AR_TXF_LC_HZ_CUST_PROFILE_CLASSES',
      p_sig_sql                => 'SELECT
profile_class_id,
name,
description,
...
where  profile_class_id in (select profile_class_id        
                            from   hz_customer_profiles        
			    where  cust_account_id = ##$$CUSTACCTID$$##)',
      p_title                  => 'HZ_CUST_PROFILE_CLASSES',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying records in HZ_CUST_PROFILE_CLASSES for this customer account.',
      p_solution               => '',
      p_success_msg            => 'No records found in HZ_CUST_PROFILE_CLASSES for this customer account.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_LC_HZ_CUST_PROFILE_CLASSES');



debug('begin add_signature: AR_TXF_LC_HZ_CUST_PROFILES_AMTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14336',
      p_sig_id                 => 'AR_TXF_LC_HZ_CUST_PROFILES_AMTS',
      p_sig_sql                => 'select 
Cust_Account_Profile_Id,
Cust_Account_Profile_Id,
cust_account_id,
...
where  cust_account_id = ##$$CUSTACCTID$$##
order by site_use_id, currency_code',
      p_title                  => 'HZ_CUST_PROFILE_AMTS',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying records in HZ_CUST_PROFILES_AMTS for this customer account.',
      p_solution               => '',
      p_success_msg            => 'No records found in HZ_CUST_PROFILES_AMTS for this customer account.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_LC_HZ_CUST_PROFILES_AMTS');



debug('begin add_signature: AR_TXF_LC_AR_AGING_BUCKETS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14344',
      p_sig_id                 => 'AR_TXF_LC_AR_AGING_BUCKETS',
      p_sig_sql                => 'select * 
...
where  aging_bucket_id in 
	    ...
	    where  schedule_id in           
			(select interest_schedule_id               
			 ...
			 where  cust_account_id = ##$$CUSTACCTID$$##             
			 union               
			 select penalty_schedule_id             
			 from   hz_cust_profile_amts               
			 where  cust_account_id = ##$$CUSTACCTID$$##)) 
order by aging_bucket_id',
      p_title                  => 'AR_AGING_BUCKETS',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying records in AR_AGING_BUCKETS for this customer account.',
      p_solution               => '',
      p_success_msg            => 'No records found in AR_AGING_BUCKETS for this customer account.
For more information review the Define Tiers and Charge Schedules section in [1269062/KB620952#aref_section35].',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_LC_AR_AGING_BUCKETS');



debug('begin add_signature: AR_TXF_LC_AR_CHARGE_SCHEDULES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14341',
      p_sig_id                 => 'AR_TXF_LC_AR_CHARGE_SCHEDULES',
      p_sig_sql                => 'select * 
from   ar_charge_schedules 
where  schedule_id in (select interest_schedule_id        
                       from   hz_cust_profile_amts        
		       where  cust_account_id = ##$$CUSTACCTID$$##      
		       union        
		       select penalty_schedule_id      
...
order by schedule_id',
      p_title                  => 'AR_CHARGE_SCHEDULES',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying records in AR_CHARGE_SCHEDULES for this customer account.',
      p_solution               => '',
      p_success_msg            => 'No records found in AR_CHARGE_SCHEDULES for this customer account.
For more information review the Define Tiers and Charge Schedules section in [1269062/KB620952#aref_section35].',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_LC_AR_CHARGE_SCHEDULES');



debug('begin add_signature: AR_TXF_LC_AR_CHARGE_SCHEDULE_HDRS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14342',
      p_sig_id                 => 'AR_TXF_LC_AR_CHARGE_SCHEDULE_HDRS',
      p_sig_sql                => 'select * 
from   AR_CHARGE_SCHEDULE_HDRS 
where  schedule_id in (select interest_schedule_id  
                       from   hz_cust_profile_amts        
...
order by schedule_header_id',
      p_title                  => 'AR_CHARGE_SCHEDULE_HDRS',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying records in AR_CHARGE_SCHEDULE_HDRS for this customer account.',
      p_solution               => '',
      p_success_msg            => 'No records found in AR_CHARGE_SCHEDULE_HDRS for this customer account.
For more information review the Define Tiers and Charge Schedules section in [1269062/KB620952#aref_section35].',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_LC_AR_CHARGE_SCHEDULE_HDRS');



debug('begin add_signature: AR_TXF_LC_AR_CHARGE_SCHEDULE_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14343',
      p_sig_id                 => 'AR_TXF_LC_AR_CHARGE_SCHEDULE_LINES',
      p_sig_sql                => 'select * 
...
order by schedule_line_id',
      p_title                  => 'AR_CHARGE_SCHEDULE_LINES',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying records in AR_CHARGE_SCHEDULE_LINES for this customer account.',
      p_solution               => '',
      p_success_msg            => 'No records found in AR_CHARGE_SCHEDULE_LINES for this customer account.
For more information review the Define Tiers and Charge Schedules section in [1269062/KB620952#aref_section35].',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_LC_AR_CHARGE_SCHEDULE_LINES');



debug('begin add_signature: AR_TXF_LC_AR_INTEREST_HEADERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14345',
      p_sig_id                 => 'AR_TXF_LC_AR_INTEREST_HEADERS',
      p_sig_sql                => 'select * 
from   AR_INTEREST_HEADERS_ALL 
where  customer_id = ##$$CUSTACCTID$$## 
and    org_id = ##$$ORGID$$## 
order  by INTEREST_HEADER_ID, CUSTOMER_SITE_USE_ID',
      p_title                  => 'AR_INTEREST_HEADERS',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying records in AR_INTEREST_HEADERS for this customer account.',
      p_solution               => '',
      p_success_msg            => 'No records found in AR_INTEREST_HEADERS for this customer account.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_LC_AR_INTEREST_HEADERS');



debug('begin add_signature: AR_TXF_LC_AR_INTEREST_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14346',
      p_sig_id                 => 'AR_TXF_LC_AR_INTEREST_LINES',
      p_sig_sql                => 'select * 
from   AR_INTEREST_LINES_ALL 
where  INTEREST_HEADER_ID in  
			(select interest_header_id 
			 from ar_interest_headers_all 
			 where customer_id = ##$$CUSTACCTID$$##  
			 and org_id = ##$$ORGID$$##) 
order  by interest_header_id, interest_line_id',
      p_title                  => 'AR_INTEREST_LINES',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying records in AR_INTEREST_LINES for this customer account.',
      p_solution               => '',
      p_success_msg            => 'No records found in AR_INTEREST_LINES for this customer account.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_LC_AR_INTEREST_LINES');



debug('begin add_signature: AR_TXF_LC_DRAFT_BATCH_EXISTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14512',
      p_sig_id                 => 'AR_TXF_LC_DRAFT_BATCH_EXISTS',
      p_sig_sql                => 'select  distinct bat.batch_name "BATCH NAME",
        bat.transferred_status,
        bat.gl_date,
        bat.transaction_date
from    ar_interest_headers_all hdr,
        ar_interest_batches_all bat
where   hdr.customer_id = ##$$CUSTACCTID$$##
and     hdr.org_id = ##$$ORGID$$##
and     hdr.interest_batch_id = bat.interest_batch_id
and     bat.batch_status =''D''',
      p_title                  => 'Draft Late Charge Batch Exists',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Draft late charge batches exist for the customer/site, this will prevent new late charge batches from being created.',
      p_solution               => 'Please query the previous draft late charges batch and delete or finalize.
<ul>
<li><b>Navigation:</b> Receivables > Late Charges > Batch Maintenance</li>
<li>Query the draft batch name</li>
<li>Select the record and hit delete icon to remove, or </li>
<li>Click <em>Mode</em> and set to Final</li>
<li>Then select generate</li>
<li>Reference: 	Late Charges Issue: Generate Late Charges is not Picking Overdue Invoices [746324/KB272606]</li>
</ul>',
      p_success_msg            => 'No draft late charge batches exist.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_LC_DRAFT_BATCH_EXISTS');



debug('begin add_signature: AR_TXF_LC_FAILED_BATCH_EXISTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14513',
      p_sig_id                 => 'AR_TXF_LC_FAILED_BATCH_EXISTS',
      p_sig_sql                => 'select  distinct bat.batch_name "BATCH NAME"
from    ar_interest_headers_all hdr,
        ar_interest_batches_all bat
where   hdr.customer_id = ##$$CUSTACCTID$$##
...
and     bat.transferred_status <> ''S''',
      p_title                  => 'Failed Late Charge Batch Exists',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Failed late charge batches exist for the customer, this will prevent new late charge batches from being created.',
      p_solution               => 'Please query the previous failed late charges batch and delete.
<ul>
<li><b>Navigation:</b> Receivables > Late Charges > Batch Maintenance</li>
<li>Query the failed batch name</li>
<li>Click button <em>View Document</em> to review details of the batch in order to identify what invoices have errors which need to be addressed</li>
<li>Reference: Late Charges Issue: Generate Late Charges is not Picking Overdue Invoices [746324/KB272606]</li>
</ul>',
      p_success_msg            => 'No failed late charge batches exist.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_LC_FAILED_BATCH_EXISTS');



debug('begin add_signature: AR_TXF_LC_INACTIVE_SITES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14511',
      p_sig_id                 => 'AR_TXF_LC_INACTIVE_SITES',
      p_sig_sql                => 'SELECT  hz.status "STATUS",
        hz.site_use_id "SITE USE ID",
        hz.org_id "ORG ID"
FROM    HZ_CUST_SITE_USES_ALL hz
where   hz.status <> ''A''
and     hz.site_use_id in (select site_use_id
                           from hz_customer_profiles
                           where cust_account_id = ##$$CUSTACCTID$$##
                           and interest_charges = ''Y'' )',
      p_title                  => 'Inactive Customer Sites with Late Charges Enabled',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The site is inactive with the late charges flag still enabled. ',
      p_solution               => '<ul>
<li>If your business process requires late charges to be calculated for inactive sites, you can disregard this warning.</li>
<li>Otherwise, you need to disable late charges.</li>
<li>For more information, read [1927902/KB330336] Late Charges Are Calculated for Inactive Customer Sites.</li>
</ul>',
      p_success_msg            => 'No inactive customer sites with enabled late charges.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_LC_INACTIVE_SITES');



debug('begin add_signature: AR_TXF_LC_INTINV_ACCTS_MISSING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14508',
      p_sig_id                 => 'AR_TXF_LC_INTINV_ACCTS_MISSING',
      p_sig_sql                => 'Select ractt.Name, Decode(Nvl(Gl_Id_Rec,-1),-1,''Y'',''N'') Missing_Receivable, 
Decode(Nvl(Gl_Id_Rev,-1),-1,''Y'',''N'') Missing_Revenue
From Ra_Cust_Trx_Types_all ractt,
hz_customer_profiles hzp
Where (Nvl(Gl_Id_Rec,-1) = -1 Or
Nvl(Gl_Id_Rev,-1) = -1)
And Cust_Trx_Type_Id In
(Select Late_Charge_inv_Type_Id From Ar_System_Parameters_All
Where Org_Id=##$$ORGID$$##)
and hzp.LATE_CHARGE_TYPE = ''INV''
and hzp.cust_account_id = ##$$CUSTACCTID$$##',
      p_title                  => 'Late Charge Interest Invoice Missing GL Accounts',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The interest invoice transaction type used for Late Charges is missing Receivable and Revenue GL accounts.',
      p_solution               => 'This customer is set up to use an Interest Invoice for Late Charges. However, not all of the GL accounts have been defined for the Interest Invoice transaction type.
<ul>
<li>Reference: ARLCPW Late Charges "A code combination ID is required"  [948711/KB437467]</li>
</ul>',
      p_success_msg            => 'No late charge invoices missing Receivable or Revenue gl accounts.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_LC_INTINV_ACCTS_MISSING');



debug('begin add_signature: AR_TXF_LC_INTINV_POSTING_FLAG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14509',
      p_sig_id                 => 'AR_TXF_LC_INTINV_POSTING_FLAG',
      p_sig_sql                => 'SELECT
     rctta.name "TRANSACTION TYPE NAME",
     aspa.late_charge_inv_type_id "TRANSACTION TYPE ID",
     rctta.post_to_gl "POST TO GL"     
FROM
    ar_system_parameters_all aspa,
    ra_cust_trx_types_all rctta
WHERE
    aspa.late_charge_inv_type_id = rctta.cust_trx_type_id
    and aspa.org_id = rctta.org_id
    and aspa.org_id = ##$$ORGID$$##
    and rctta.post_to_gl = ''N''',
      p_title                  => 'Interest Invoice Transaction Type has Post to GL Unchecked',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The interest invoice transaction type has the <em>Post to GL</em> flag incorrectly set to ''N'' (Unchecked).',
      p_solution               => '<ul>
<li>Reference: Late Charges Error: You cannot supply a GL Date if Post to GL option for your transaction type is No [604343/KB525088]</li>
</ul>',
      p_success_msg            => 'No interest invoices has transaction type with <em>Post to GL</em> flag incorrectly set to ''N'' (Unchecked).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_LC_INTINV_POSTING_FLAG');



debug('begin add_signature: AR_TXF_LC_INV_HEADER_STAMPED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14510',
      p_sig_id                 => 'AR_TXF_LC_INV_HEADER_STAMPED',
      p_sig_sql                => 'Select   distinct inth.interest_batch_id, inth.worker_num
From     ar_interest_batches_all intb,
         ar_interest_headers_all  inth
Where    intb.INTEREST_BATCH_ID = inth.INTEREST_BATCH_ID
And     inth.worker_num is not null
And     intb.batch_status = ''F''
And     intb.transferred_status = ''E''
And     not exists
     (select ''x''  FROM ar_interest_headers_all intho
      WHERE intho.interest_batch_id =inth.interest_batch_id
        AND intho.worker_num        = inth.worker_num
        AND intho.process_status    = ''S''  
      )
And     not exists
     (select ''x''  FROM ar_interest_headers_all  intho
      WHERE intho.interest_batch_id =inth.interest_batch_id
        AND intho.display_flag  = ''Y''  
        AND intho.worker_num    = inth.worker_num
      )
And     not exists
     (select ''x''  FROM ar_interest_headers_all intho
      WHERE intho.interest_batch_id =inth.interest_batch_id
        AND intho.display_flag  <>  ''N''  
        AND intho.worker_num   = inth.worker_num
      )
And     not exists
     (select ''x''  FROM ar_interest_headers_all intho
      WHERE intho.interest_batch_id =inth.interest_batch_id
        AND intho.process_status  <> ''N''  
        AND intho.worker_num    = inth.worker_num
      )
And     not exists
     (
     select ''x'' from ar_interest_headers_all intho
      ...
      p_title                  => 'Late Charge Headers Incorrectly Stamped with Success "S"',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Header late charge records are incorrectly stamped as successful when using multiple workers.',
      p_solution               => '<ul>
<li>Please log a Service Request with Oracle Support to correct this corruption</li>
<li>Reference: Transactions Workbench Issue: Late Charges Ended in Error at Batch Level When Run in Final Mode [1955258/KB795672]</li>
</ul>',
      p_success_msg            => 'No late charge records incorrectly stamped as successful.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_LC_INV_HEADER_STAMPED');



debug('begin add_signature: AR_TXF_LC_MULTI_ORG_CATEGORY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14514',
      p_sig_id                 => 'AR_TXF_LC_MULTI_ORG_CATEGORY',
      p_sig_sql                => 'Select  multi_org_category
from    FND_CONCURRENT_PROGRAMS
where   concurrent_program_name like ''ARLCRPT''
and     multi_org_category <>''M''',
      p_title                  => 'Late Charges Report is Not Multi-Org Enabled',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The late charges report is not defined as multi-org which will result in records not being processed.',
      p_solution               => 'Correct the report to be defined as multi-org.
<ul>
<li><b>Responsibility</b>: System Administration (Take note use System Administra<strong><em>tion</em></strong> and not System Administra<strong><em>tor</em></strong>)<li>
<li><b>Navigation</b>: Concurrent > Programs</li>
<li>Enter the following:
<ul>
<li>Application = Receivables</li>
<li>Short Name = ARLCRPT</li>
<li>Click on Go</li>
<li>Click on Update icon (pencil) to update the details of report.</li>
<li>Click on Request tab.</li>
<li>Select Operating Unit Mode = ''Multiple'' and save it.</li></ul></li>
<li>Reference: Late Charges Issue: Invoking List of Values for Parameter Batch Name Raises ''No Entries Found For List of Values''  [1291389/KB511114] </li>
</ul>',
      p_success_msg            => 'Multi-org flag is enabled.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_LC_MULTI_ORG_CATEGORY');



debug('begin add_signature: AR_TXF_LC_ORPHAN_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14515',
      p_sig_id                 => 'AR_TXF_LC_ORPHAN_LINES',
      p_sig_sql                => 'SELECT *
from   ar_interest_lines_all iline
WHERE NOT EXISTS
           (SELECT ''X''
            FROM   ar_interest_headers_all ihd
            WHERE  ihd.interest_header_id = iline.interest_header_id
            )',
      p_title                  => 'Orphan Late Charge Lines Exist',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Orphaned late charge lines exist which do not have late charge header records.',
      p_solution               => '<ul>
<li>Please log a Service Request with Oracle Support to correct this corruption </li>
<li>Reference: AR Late Charges Adjustments Are Not Generated Due To Previous Late Charges Batch With Status Error [2253593/KB379497] </li>
</ul>',
      p_success_msg            => 'No orphan late charges exist.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_LC_ORPHAN_LINES');



debug('begin add_signature: AR_TXF_LC_DM_ACCTS_MISSING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14507',
      p_sig_id                 => 'AR_TXF_LC_DM_ACCTS_MISSING',
      p_sig_sql                => 'Select ractt.Name, Decode(Nvl(Gl_Id_Rec,-1),-1,''Y'',''N'') Missing_Receivable, 
       Decode(Nvl(Gl_Id_Rev,-1),-1,''Y'',''N'') Missing_Revenue,
       Decode(Nvl(Gl_Id_Unbilled,-1),-1,''Y'',''N'') Missing_Unbilled_Receivable, 
       Decode(Nvl(Gl_Id_Unearned,-1),-1,''Y'',''N'') Missing_Unearned_Revenue,
   ...
   Where  (Nvl(Gl_Id_Rec,-1) = -1 Or
     ...
     And Cust_Trx_Type_Id In
  (Select Late_Charge_Dm_Type_Id From Ar_System_Parameters_All
     Where Org_Id=##$$ORGID$$##)
     and hzp.LATE_CHARGE_TYPE = ''DM''
     and hzp.cust_account_id = ##$$CUSTACCTID$$##',
      p_title                  => 'Late Charge Debit Memo Missing GL Accounts',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The Debit Memo transaction type used for Late Charges is missing GL accounts.',
      p_solution               => 'This customer is setup for Debit Memo late charges. However not all of the GL accounts have been defined for the transaction type.
<ul>
<li>Reference: Late Charges Program Is Completing With Error [2055647/KB72274]</li>
</ul>',
      p_success_msg            => 'No late charges debit memos with missing gl accounts.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_LC_DM_ACCTS_MISSING');



debug('begin add_signature: AR_TXF_HZ_PARTIES');
...
',
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_HZ_PARTIES');



debug('begin add_signature: AR_TXF_HZ_PARTY_SITES');
  ...
  add_signature(
      p_sig_repo_id            => '14541',
      p_sig_id                 => 'AR_TXF_HZ_PARTY_SITES',
      p_sig_sql                => 'SELECT 	*
FROM 	HZ_PARTY_SITES
...
order by party_site_id',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying HZ_PARTY_SITES information for this customer account.',
      p_solution               => '',
      p_success_msg            => 'No HZ_PARTY_SITES information for this customer account.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_HZ_PARTY_SITES');



debug('begin add_signature: AR_TXF_HZ_LOCATIONS1');
   l_info('##MASK##ADDRESS1'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ADDRESS2'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14602',
      p_sig_id                 => 'AR_TXF_HZ_LOCATIONS1',
      p_sig_sql                => 'select hps.party_site_number, hl.country, hl.address1, hl.address2, hl.address3, hl.address4, hl.city, hl.state, hl.postal_code, hl.county, hps.status, hps.addressee
from   hz_locations hl, hz_party_sites hps
where  hps.party_site_id in (select hps.party_site_id 
                             from hz_party_sites hps, hz_cust_acct_sites_all hcas 
                             where hps.party_site_id = hcas.party_site_id
                             and    hcas.cust_account_id = ##$$CUSTACCTID$$##)
and    hps.location_id = hl.location_id
order by country, address1',
      p_title                  => 'HZ_LOCATIONS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No records found in HZ_LOCATIONS for this customer account.',
      p_solution               => '',
      p_success_msg            => 'Displaying records in HZ_LOCATIONS for this customer account.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_HZ_LOCATIONS1');



debug('begin add_signature: AR_TXF_HZ_CUST_ACCOUNTS_ALL');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '14543',
      p_sig_id                 => 'AR_TXF_HZ_CUST_ACCOUNTS_ALL',
      p_sig_sql                => 'SELECT *
from   hz_cust_accounts_all
where  cust_account_id  = ##$$CUSTACCTID$$##',
      p_title                  => 'HZ_CUST_ACCOUNTS_ALL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying HZ_CUST_ACCOUNTS_ALL information for this customer account.',
      p_solution               => '',
      p_success_msg            => 'No HZ_CUST_ACCOUNTS_ALL information for this customer account.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_HZ_CUST_ACCOUNTS_ALL');



debug('begin add_signature: AR_TXF_HZ_CUST_ACCT_SITE_ALL');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '14550',
      p_sig_id                 => 'AR_TXF_HZ_CUST_ACCT_SITE_ALL',
      p_sig_sql                => 'select 	*
from 	hz_cust_acct_sites_all
where 	cust_account_id = ##$$CUSTACCTID$$##
and 	org_id = ##$$ORGID$$##
order by cust_acct_site_id',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying HZ_CUST_ACCT_SITES_ALL information for this customer account.',
      p_solution               => '',
      p_success_msg            => 'No HZ_CUST_ACCT_SITES_ALL information for this customer account.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_HZ_CUST_ACCT_SITE_ALL');



debug('begin add_signature: AR_TXF_HZ_CUST_SITE_USES');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '14551',
      p_sig_id                 => 'AR_TXF_HZ_CUST_SITE_USES',
      p_sig_sql                => 'select 	*
from 	HZ_CUST_SITE_USES_ALL
where 	CUST_ACCT_SITE_ID in (select CUST_ACCT_SITE_ID
			      from HZ_CUST_ACCT_SITES_ALL
...
order by cust_acct_site_id',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying HZ_CUST_SITE_USES_ALL information for this customer account.
',
      p_solution               => '',
      p_success_msg            => 'No HZ_CUST_SITE_USES_ALL information for this customer account.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_HZ_CUST_SITE_USES');



debug('begin add_signature: AR_TXF_HZ_CUSTOMER_PROFILES');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14552',
      p_sig_id                 => 'AR_TXF_HZ_CUSTOMER_PROFILES',
      p_sig_sql                => 'select 	*
from 	hz_customer_profiles
where 	cust_account_id = ##$$CUSTACCTID$$##
order by site_use_id',
      p_title                  => 'HZ_CUSTOMER_PROFILES',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying HZ_CUSTOMER_PROFILES information for this customer account.',
      p_solution               => '',
      p_success_msg            => 'No HZ_CUSTOMER_PROFILES information for this customer account.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_HZ_CUSTOMER_PROFILES');



debug('begin add_signature: AR_TXF_HZ_CUST_PROFILE_AMTS');
   l_info('##MASK##%ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14554',
      p_sig_id                 => 'AR_TXF_HZ_CUST_PROFILE_AMTS',
      p_sig_sql                => 'select 	*
from 	hz_cust_profile_amts
where 	cust_account_id = ##$$CUSTACCTID$$##
order 	by site_use_id, currency_code',
      p_title                  => 'HZ_CUST_PROFILE_AMTS',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying HZ_CUST_PROFILE_AMTS information for this customer account.
',
      p_solution               => '',
      p_success_msg            => 'No HZ_CUST_PROFILE_AMTS information for this customer account.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_HZ_CUST_PROFILE_AMTS');



debug('begin add_signature: AR_TXF_HZ_CUST_PROFILE_CLASSES');
   l_info('##MASK##%ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14553',
      p_sig_id                 => 'AR_TXF_HZ_CUST_PROFILE_CLASSES',
      p_sig_sql                => 'select 	*
from 	hz_cust_profile_classes
where 	profile_class_id in (select profile_class_id
                             from hz_customer_profiles
      ...
      p_title                  => 'HZ_CUST_PROFILE_CLASSES',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying HZ_CUST_PROFILE_CLASSES information for this customer account.
',
      p_solution               => '',
      p_success_msg            => 'No HZ_CUST_PROFILE_CLASSES information for this customer account.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TXF_HZ_CUST_PROFILE_CLASSES');
...
debug('begin add_signature: AR_GEN_ECE_INVALIDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14366',
      p_sig_id                 => 'AR_GEN_ECE_INVALIDS',
      p_sig_sql                => 'SELECT a.object_name,
           decode(a.object_type,
             ''PACKAGE'', ''Package Spec'',
             ''PACKAGE BODY'', ''Package Body'',
    ...
    AND a.object_type = b.type(+)
    AND a.owner = ''APPS''
    AND (a.object_name like ''ECE%'')
    AND a.status = ''INVALID''',
      p_title                  => 'E-Commerce Gateway (ECE) Invalid PL/SQL Packages',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are invalid E-Commerce Gateway (ECE) PL/SQL packages.',
      p_solution               => 'The invalid objects are listed for information only.  They may not impact your task, but it is advisable to review and address them as follows:
<ul>
      <li>Review any error messages provided</li>
      <li>Recompile the individual objects or recompile the entire APPS schema with adadmin utility</li>
      ...
      p_success_msg            => 'There are no invalid objects for E-Commerce Gateway (ECE) in the database.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_GEN_ECE_INVALIDS');



debug('begin add_signature: AR_GEN_ECE_PKG_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14367',
      p_sig_id                 => 'AR_GEN_ECE_PKG_VERSIONS',
      p_sig_sql                => 'SELECT name, text, type
FROM   dba_source
where  (name like ''ECE%'')
and    line = 2
and    type in (''PACKAGE'', ''PACKAGE BODY'')
order by 1',
      p_title                  => 'E-Commerce Gateway (ECE) PL/SQL Package Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Could not locate E-Commerce Gateway (ECE) PL/SQL package versions.',
      p_solution               => 'Please ensure that you have installed the E-Commerce Gateway (ECE) application.',
      p_success_msg            => 'This is a data collection of E-Commerce Gateway (ECE) PL/SQL package versions.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_GEN_ECE_PKG_VERSIONS');



debug('begin add_signature: AR_GEN_ECE_FORM_LIB_RPT_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14368',
      p_sig_id                 => 'AR_GEN_ECE_FORM_LIB_RPT_VERSIONS',
      p_sig_sql                => 'select b.filename, a.version, a.creation_date, b.subdir
from ad_file_versions a, ad_files b
where b.file_id = a.file_id
and b.app_short_name = ''EC''
and b.filename like ''%.rdf''
and a.creation_date = (select max(c.creation_date)
from ad_file_versions c
where c.file_id = a.file_id)
...
where c.file_id = a.file_id)
order by 1',
      p_title                  => 'E-Commerce Gateway (ECE) Forms, Libraries and Reports Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Could not locate E-Commerce Gateway (ECE) forms, libraries and reports versions.',
      p_solution               => 'Please ensure that you have installed the E-Commerce Gateway (ECE) application.',
      p_success_msg            => 'This is a data collection of E-Commerce Gateway (ECE) forms, libraries and reports versions.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_GEN_ECE_FORM_LIB_RPT_VERSIONS');



debug('begin add_signature: AR_GEN_ECE_ODF_FILE_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14370',
      p_sig_id                 => 'AR_GEN_ECE_ODF_FILE_VERSIONS',
      p_sig_sql                => 'select que.filename, que.version
from (
select files.filename filename,files.subdir subdir,
file_version.version version,
...
select filename, app_short_name, subdir, file_id
from ad_files
where app_short_name in (''EC'') and ( upper(filename) like upper(''%.odf'') or upper(filename) like upper(''%.xdf''))
) files
where files.file_id = file_version.file_id
) que
where rank1 = 1
order by 1',
      p_title                  => 'E-Commerce Gateway (ECE) .odf / .xdf Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Could not locate E-Commerce Gateway (ECE) .odf or .xdf files.',
      p_solution               => 'Please ensure that you have applied the E-Commerce Gateway (ECE) .odf and .xdf files.',
      p_success_msg            => 'This is a data collection of E-Commerce Gateway (ECE) .odf or .xdf files.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_GEN_ECE_ODF_FILE_VERSIONS');



debug('begin add_signature: AR_GEN_ECE_FILE_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14369',
      p_sig_id                 => 'AR_GEN_ECE_FILE_VERSIONS',
      p_sig_sql                => 'select ''File Versions for E-Commerce Gateway (ECE)'' "File Version Information"
from dual',
      p_title                  => 'E-Commerce Gateway (ECE) File Version Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Could not locate file versions.',
      p_solution               => 'This section is a data collection of file version information for E-Commerce Gateway (ECE) files.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('AR_GEN_ECE_PKG_VERSIONS','AR_GEN_ECE_FORM_LIB_RPT_VERSIONS','AR_GEN_ECE_ODF_FILE_VERSIONS'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '3'
      );
   l_info.delete;
debug('end add_signature: AR_GEN_ECE_FILE_VERSIONS');
...
BEGIN
  ...
  analyzer_title := 'Receivables Transaction Features Setup Analyzer';
...
debug('begin section: BFB_SETUP');
IF p_feature = 'BFB' THEN
   start_section('Balance Forward Billing Setup', 'BFB_SETUP');
      set_item_result(run_stored_sig('AR_TXF_BFB_CYCLES_B'));
      set_item_result(run_stored_sig('AR_TXF_BFB_CYCLES_TL_ACCT'));
      set_item_result(run_stored_sig('AR_TXF_BFB_CYCLES_TL_SITE'));
      set_item_result(run_stored_sig('AR_TXF_BFB_TERMS'));
      set_item_result(run_stored_sig('AR_TXF_BFB_CYCLE_DATES'));
      set_item_result(run_stored_sig('AR_TXF_BFB_VERSION'));
      set_item_result(run_stored_sig('AR_TXF_BFB_CUST_INFO'));
      set_item_result(run_stored_sig('AR_TXF_HZ_CUST_ACCT_SITES'));
      set_item_result(run_stored_sig('AR_TXF_BFB_SITE_USES'));
      set_item_result(run_stored_sig('AR_TXF_BFB_CUST_PROF'));
      set_item_result(run_stored_sig('AR_TXF_BFB_AR_CONS_INV'));
      set_item_result(run_stored_sig('AR_TXF_BFB_AR_CONS_TRX'));
      set_item_result(run_stored_sig('AR_TXF_BFB_AR_CONS_LINES'));
   end_section;
END IF;
debug('end section: BFB_SETUP');

debug('begin section: BFB_ISSUES');
IF p_feature = 'BFB' THEN
   start_section('Balance Forward Billing Issues', 'BFB_ISSUES');
      set_item_result(run_stored_sig('AR_TXF_BFB_CYCLE_DATES_EXP'));
      set_item_result(run_stored_sig('AR_TXF_BFB_CUST_NOT_ENABLED'));
      set_item_result(run_stored_sig('AR_TXF_BFB_TERM_HAS_INSTALLMENTS'));
      set_item_result(run_stored_sig('AR_TXF_BFB_WRONG_BAL'));
      set_item_result(run_stored_sig('AR_TXF_BFB_DUP'));
      set_item_result(run_stored_sig('EBS_FIN_AR_ARTXFANLZ_AR_TXF_BFB_DRAFT_AR_CONS_INV'));
   end_section;
END IF;
debug('end section: BFB_ISSUES');

debug('begin section: EDI_SETUP');
IF p_feature = 'EDI' THEN
   start_section('EDI Setup', 'EDI_SETUP');
      set_item_result(run_stored_sig('AR_TXF_EDI_BUS_GROUP'));
      set_item_result(run_stored_sig('AR_TXF_EDI_FILE_PATH'));
      set_item_result(run_stored_sig('AR_TXF_EDI_FILE_PATH_OK'));
      set_item_result(run_stored_sig('AR_TXF_EDI_INTFC_SETUP'));
      set_item_result(run_stored_sig('AR_TXF_EDI_TRAD_PARTNER_CUST'));
      set_item_result(run_stored_sig('AR_TXF_EDI_PROFILE'));
      set_item_result(run_stored_sig('AR_TXF_EDI_CODE_CONV'));
      set_item_result(run_stored_sig('AR_TXF_EDI_CODE_CONV_IN_DAT'));
      set_item_result(run_stored_sig('AR_TXF_EDI_INVOICES_CUST'));
   end_section;
END IF;
debug('end section: EDI_SETUP');

debug('begin section: EDI_ISSUES');
IF p_feature = 'EDI' THEN
   start_section('EDI Issues', 'EDI_ISSUES');
      set_item_result(run_stored_sig('AR_TXF_EDI_LOCATION_SETUP_CUST'));
      set_item_result(run_stored_sig('AR_TXF_EDI_LOCATION_BILL_TO'));
      set_item_result(run_stored_sig('AR_TXF_EDI_INV_NOT_PRINT'));
      set_item_result(run_stored_sig('AR_TXF_EDI_PRINT_PENDING'));
      set_item_result(run_stored_sig('AR_TXF_EDI_TRX_BEFORE_TP'));
   end_section;
END IF;
debug('end section: EDI_ISSUES');

debug('begin section: LATE_CHARGES_SETUP');
IF p_feature = 'LATE CHARGES' THEN
   start_section('Late Charges Setup', 'LATE_CHARGES_SETUP');
      set_item_result(run_stored_sig('AR_TXF_LC_SYSTEM_PAR_LC'));
      set_item_result(run_stored_sig('AR_TXF_LC_PROFILE'));
      set_item_result(run_stored_sig('AR_TXF_LC_AR_RECEIVABLES_TRX'));
      set_item_result(run_stored_sig('AR_TXF_LC_RA_BATCH_SOURCES'));
      set_item_result(run_stored_sig('AR_TXF_LC_CUST_TRX_TYPE'));
      set_item_result(run_stored_sig('AR_TXF_LC_CUST_TRX_TYPE_EXCLUDED'));
      set_item_result(run_stored_sig('AR_TXF_LC_HZ_CUSTOMER_PROFILES'));
      set_item_result(run_stored_sig('AR_TXF_LC_HZ_CUSTOMER_PROFILES_EXCLUDED'));
      set_item_result(run_stored_sig('AR_TXF_LC_HZ_CUST_PROFILE_CLASSES'));
      set_item_result(run_stored_sig('AR_TXF_LC_HZ_CUST_PROFILES_AMTS'));
      set_item_result(run_stored_sig('AR_TXF_LC_AR_AGING_BUCKETS'));
      set_item_result(run_stored_sig('AR_TXF_LC_AR_CHARGE_SCHEDULES'));
      set_item_result(run_stored_sig('AR_TXF_LC_AR_CHARGE_SCHEDULE_HDRS'));
      set_item_result(run_stored_sig('AR_TXF_LC_AR_CHARGE_SCHEDULE_LINES'));
      set_item_result(run_stored_sig('AR_TXF_LC_AR_INTEREST_HEADERS'));
      set_item_result(run_stored_sig('AR_TXF_LC_AR_INTEREST_LINES'));
   end_section;
END IF;
debug('end section: LATE_CHARGES_SETUP');

debug('begin section: LATE_CHARGES_ISSUES');
IF p_feature = 'LATE CHARGES' THEN
   start_section('Late Charges Issues', 'LATE_CHARGES_ISSUES');
      set_item_result(run_stored_sig('AR_TXF_LC_DRAFT_BATCH_EXISTS'));
      set_item_result(run_stored_sig('AR_TXF_LC_FAILED_BATCH_EXISTS'));
      set_item_result(run_stored_sig('AR_TXF_LC_INACTIVE_SITES'));
      set_item_result(run_stored_sig('AR_TXF_LC_INTINV_ACCTS_MISSING'));
      set_item_result(run_stored_sig('AR_TXF_LC_INTINV_POSTING_FLAG'));
      set_item_result(run_stored_sig('AR_TXF_LC_INV_HEADER_STAMPED'));
      set_item_result(run_stored_sig('AR_TXF_LC_MULTI_ORG_CATEGORY'));
      set_item_result(run_stored_sig('AR_TXF_LC_ORPHAN_LINES'));
      set_item_result(run_stored_sig('AR_TXF_LC_DM_ACCTS_MISSING'));
   end_section;
END IF;
debug('end section: LATE_CHARGES_ISSUES');

debug('begin section: CUSTOMER_INFO');
start_section('Customer Data', 'CUSTOMER_INFO');
   set_item_result(run_stored_sig('AR_TXF_HZ_PARTIES'));
   set_item_result(run_stored_sig('AR_TXF_HZ_PARTY_SITES'));
   set_item_result(run_stored_sig('AR_TXF_HZ_LOCATIONS1'));
   set_item_result(run_stored_sig('AR_TXF_HZ_CUST_ACCOUNTS_ALL'));
   set_item_result(run_stored_sig('AR_TXF_HZ_CUST_ACCT_SITE_ALL'));
   set_item_result(run_stored_sig('AR_TXF_HZ_CUST_SITE_USES'));
   set_item_result(run_stored_sig('AR_TXF_HZ_CUSTOMER_PROFILES'));
   set_item_result(run_stored_sig('AR_TXF_HZ_CUST_PROFILE_AMTS'));
   set_item_result(run_stored_sig('AR_TXF_HZ_CUST_PROFILE_CLASSES'));
end_section;
debug('end section: CUSTOMER_INFO');

debug('begin section: APPSCHECK');
IF g_sql_tokens('##$$APPSCHECK$$##') = 'Y' THEN
   start_section('Setup and Environment Information', 'APPSCHECK');
      set_item_result(run_stored_sig('AR_GEN_FILE_VERSIONS'));
      set_item_result(run_stored_sig('AR_GEN_LEDGER_ORG_INFO'));
      IF p_feature = 'EDI' THEN
         set_item_result(run_stored_sig('AR_GEN_ECE_FILE_VERSIONS'));
      END IF;
...
start_section('Proactive Recommendations', 'PROACTIVE');
   ...
   IF p_feature = 'EDI' THEN
      set_item_result(run_stored_sig('AR_GEN_ECE_INVALIDS'));
   END IF;
end_section;
