...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Project Planning and Control Analyzer  |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE pa_workplan_analyzer_pkg AUTHID DEFINER AS
...
END pa_workplan_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY pa_workplan_analyzer_pkg AS
-- $Id: pa_workplan_analyzer.sql, 200.19 2026/02/25 21:44:43 aliclin Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2860729.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'PAWORKPLAN_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'PAWORKPLAN_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>PAWORKPLAN Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2860729.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/pa_wp_latest_ver.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,2014,EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,2014,EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},2014,EBS,EBS Financials,EBS - Projects" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/mosc/discussion/4516807/ebs-projects-pa-workplan-analyzer-feedback-thread" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">2014</span>
...
<p><strong>Version 200.19:</strong></p><ul><li>Sigs updated for doc ID changes.</li>
</ul>
<p><strong>Version 200.18:</strong></p><ul><li>Template enhancement: EBS KB Article IDs Shown for Signature KM Links.</li>
<li>Sigs updated for doc ID changes.</li>
</ul>
<p><strong>Version 200.17:</strong></p><ul><li>Template and signatures enhanced.</li>
</ul>
<p><strong>Version 200.16:</strong></p><ul><li>Several signatures enhanced.</li>
</ul>
<p><strong>Version 200.15:</strong></p><ul><li>Several signatures enhanced.</li>
</ul>
<p><strong>Version 200.14:</strong></p><ol><li>New Analyzer Framework version 4.7.3 released with enhancements.<ol><li>SQL*Plus Error fixed: SP2-0027: Input is too long</li>
<li>Ability to click to select rows in output tables</li>
</ol>
</li>
<li>Several signatures enhanced.</li>
</ol>
<p><strong>Version 200.13:</strong></p><ul><li>Several signatures modified.</li>
</ul>
<p><strong>Version 200.12:</strong></p><ul><li>One new signature added to “Setup Details” section.</li>
<li>Two signatures modified.</li>
</ul>
<p><strong>Version 200.11:</strong></p><ul><li>Two signatures modified.</li>
<li>One new signature added to "Data Issues" section</li>
</ul>
<p><strong>Version 200.10:</strong></p><ul><li>Analyzer output name changed from Workplan to Planning and Control.&nbsp;</li>
</ul>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,2014,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,2014,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},2014,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Projects" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
debug('begin populate parameters hash table');
   ...
   g_parameters(g_parameters.LAST).pvalue := mask_text(project_id,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  l_revision := rtrim(replace('$Revision: 200.19  $','$',''));
  l_revision := ltrim(replace(l_revision,'Revision:',''));
  l_date_char := rtrim(replace('$Date: 2026/02/25 21:44:42 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'pa_workplan_analyzer.sql';
...
debug('begin parameter validation: project_id');
...
The Project Number parameter is mandatory.');
   ...
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for project_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: project_id');
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$PROJECT_ID$$##') := project_id;
...
debug('begin add_signature: PA_PROJECTS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12484',
      p_sig_id                 => 'PA_PROJECTS_ALL',
      p_sig_sql                => 'select * from  pa_projects_all
where project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Project Details (PA_PROJECTS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Project does not exists.',
      p_solution               => '',
      p_success_msg            => 'Project detail.',
   ...
   l_info.delete;
debug('end add_signature: PA_PROJECTS_ALL');



debug('begin add_signature: PA_TASKS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20970',
      p_sig_id                 => 'PA_TASKS',
...
',
      p_title                  => 'Financial Task Details (PA_TASKS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Tasks does not exists  for this project.',
      p_solution               => '',
      p_success_msg            => 'Tasks details corresponding to this project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_TASKS');



debug('begin add_signature: PA_PROJ_ELEMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20971',
      p_sig_id                 => 'PA_PROJ_ELEMENTS',
      p_sig_sql                => 'select * FROM pa_proj_elements
where project_id = ##$$PROJECT_ID$$##
order by PROJ_ELEMENT_ID',
      p_title                  => 'Workplan Task Details (PA_PROJ_ELEMENTS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Workplan tasks does not exists for this project.',
      p_solution               => '',
      p_success_msg            => 'Workplan tasks detail for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PROJ_ELEMENTS');
...
debug('begin add_signature: PA_WP_PROJECT_CUSTOMERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20983',
      p_sig_id                 => 'PA_WP_PROJECT_CUSTOMERS',
      p_sig_sql                => 'SELECT * FROM pa_project_customers WHERE project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Project Customer Details (PA_PROJECT_CUSTOMERS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Customer does not exists for this project.',
      p_solution               => '',
      p_success_msg            => 'Customer Detail for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_WP_PROJECT_CUSTOMERS');



debug('begin add_signature: PA_PROJ_ELEMENT_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12190',
      p_sig_id                 => 'PA_PROJ_ELEMENT_VERSIONS',
      p_sig_sql                => ' SELECT element.*  FROM   PA_PROJ_ELEMENT_VERSIONS  element  WHERE  element.project_id = ##$$PROJECT_ID$$##   order by element.ELEMENT_VERSION_ID',
      p_title                  => 'Project Element Versions Details (PA_PROJ_ELEMENT_VERSIONS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No versioned information related to workplan tasks and structures for this project.',
      p_solution               => '',
      p_success_msg            => 'Project element versions detail.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PROJ_ELEMENT_VERSIONS');



debug('begin add_signature: PA_OBJECT_RELATIONSHIPS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12496',
      p_sig_id                 => 'PA_OBJECT_RELATIONSHIPS',
      p_sig_sql                => 'SELECT relat.*
FROM PA_OBJECT_RELATIONSHIPS relat
WHERE relat.OBJECT_ID_FROM1 IN
  (SELECT element.element_version_id
  FROM pa_proj_element_versions element
  WHERE element.project_id = ##$$PROJECT_ID$$##
  )
UNION
SELECT relat.*
FROM PA_OBJECT_RELATIONSHIPS relat
WHERE relat.OBJECT_ID_TO1 IN
  (SELECT element.element_version_id
  FROM pa_proj_element_versions element
  WHERE element.project_id = ##$$PROJECT_ID$$##
  ) ',
      p_title                  => 'Project Objects Relationship Details (PA_OBJECT_RELATIONSHIPS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No relationship relating to projects, structures and tasks for the Project.',
      p_solution               => '',
      p_success_msg            => 'Project objects relationship details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_OBJECT_RELATIONSHIPS');



debug('begin add_signature: PA_PROJ_ELEM_VER_STRUCTURE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12189',
      p_sig_id                 => 'PA_PROJ_ELEM_VER_STRUCTURE',
      p_sig_sql                => 'SELECT struct.*  FROM   PA_PROJ_ELEM_VER_STRUCTURE  struct  WHERE  struct.project_id = ##$$PROJECT_ID$$##  order by struct.PEV_STRUCTURE_ID',
      p_title                  => 'Project Element Version Structure Details (PA_PROJ_ELEM_VER_STRUCTURE)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No workplan structure attributes exists for the project.',
      p_solution               => '',
      p_success_msg            => 'Project workplan structure attributes detail.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PROJ_ELEM_VER_STRUCTURE');



debug('begin add_signature: PA_PROJECT_AS_PROGRAM');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12165',
      p_sig_id                 => 'PA_PROJECT_AS_PROGRAM',
      p_sig_sql                => 'select sub_project_number, sub_project_id, parent_project_number, parent_task_number, parent_task_id, parent_task_name
from PA_FIN_STRUCTURES_LINKS_V
where parent_project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Project having Designated Projects As A Program Details ',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The project is having ''projects as a program'' assigned to its tasks.',
      p_solution               => '',
      p_success_msg            => 'There is no project having ''projects as a program'' assigned to its tasks.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PROJECT_AS_PROGRAM');



debug('begin add_signature: PA_DC_PA_PROJ_ELEM_VER_SCHEDULE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14527',
      p_sig_id                 => 'PA_DC_PA_PROJ_ELEM_VER_SCHEDULE',
      p_sig_sql                => 'SELECT sched.*
FROM PA_PROJ_ELEM_VER_SCHEDULE sched
WHERE sched.project_id = ##$$PROJECT_ID$$##
order by sched.PEV_SCHEDULE_ID',
      p_title                  => 'Project Element Version Schedule Details (PA_PROJ_ELEM_VER_SCHEDULE)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No project workplan version attributes exists  for the Project. ',
      p_solution               => '',
      p_success_msg            => 'PA_PROJ_ELEM_VER_SCHEDULE stores project workplan attributes, which are versioned.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DC_PA_PROJ_ELEM_VER_SCHEDULE');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_PA_RBS_VERSIONS_B');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27427',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_PA_RBS_VERSIONS_B',
      p_sig_sql                => 'SELECT  rbs_header_id "RBS Header ID",
        rbs_version_id "RBS Version ID",
        current_reporting_flag "Current Reporting Flag",
        status_code "Status Code",
     	version_start_date "Version Start Date",
     	version_end_date  "Version End Date"
  FROM    PA_RBS_VERSIONS_B 
 WHERE   RBS_HEADER_ID IN (
                         SELECT  rbs_header_id 
                         FROM    PA_RBS_PRJ_ASSIGNMENTS 
                         WHERE   project_id = ##$$PROJECT_ID$$##) 
             ORDER BY rbs_header_id,rbs_version_id',
      p_title                  => 'Resource Breakdown Version Details (PA_RBS_VERSIONS_B)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Resource Breakdown Structure does not have any version',
      p_solution               => '',
      p_success_msg            => 'Information about Project Resource Breakdown Version Details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_PA_RBS_VERSIONS_B');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_WP_RESOURCE_TXN_ATTRIBUTES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27440',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_WP_RESOURCE_TXN_ATTRIBUTES',
      p_sig_sql                => 'SELECT * FROM pa_resource_txn_attributes WHERE person_id IN (select person_id from pa_resources_denorm where 
resource_id IN (SELECT resource_id FROM pa_project_assignments where project_id = ##$$PROJECT_ID$$##))
  ...
  ',
      p_title                  => 'Resource Transaction Attributes (PA_RESOURCE_TXN_ATTRIBUTES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Resource Transaction Attributes  do not exist for the project .',
      p_solution               => 'Follow the solution from the  [601397/KB464110].',
      p_success_msg            => 'Resource Transaction Attributes for this project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_WP_RESOURCE_TXN_ATTRIBUTES');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_WP_COMPETENCE_PROFILE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27438',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_WP_COMPETENCE_PROFILE',
      p_sig_sql                => 'SELECT * FROM pa_competence_profiles WHERE person_id IN (select person_id from pa_resources_denorm where 
resource_id IN (SELECT resource_id FROM pa_project_assignments where project_id = ##$$PROJECT_ID$$##))
  ...
  ',
      p_title                  => 'Competence Profiles (PA_COMPETENCE_PROFILES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => ' Competence detail do not exist for the project .',
      p_solution               => '',
      p_success_msg            => 'Competence detail for this project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_WP_COMPETENCE_PROFILE');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_WP_PA_RES_AVAILABILITY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27435',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_WP_PA_RES_AVAILABILITY',
      p_sig_sql                => 'SELECT * FROM pa_res_availability WHERE resource_id IN (SELECT resource_id FROM pa_project_assignments where project_id = ##$$PROJECT_ID$$##) ORDER BY start_date



  ',
      p_title                  => 'Resource Availability (PA_RES_AVAILABILITY)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Project Resource availability  not exists for the  Project. .',
      p_solution               => '',
      p_success_msg            => 'Project Resource availability detail for this project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_WP_PA_RES_AVAILABILITY');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_WP_RESOURCE_ASSIGNMENT_DETAIL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27434',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_WP_RESOURCE_ASSIGNMENT_DETAIL',
      p_sig_sql                => 'SELECT * FROM pa_project_assignments WHERE project_id = ##$$PROJECT_ID$$##
 ORDER BY start_date


  ',
      p_title                  => 'Project Assignments (PA_PROJECT_ASSIGNMENTS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Project Resource Assignments does not exist for the  Project .',
      p_solution               => '',
      p_success_msg            => 'Project Resource Assignments detail for this project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_WP_RESOURCE_ASSIGNMENT_DETAIL');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_WP_RESOURCE_DENORM');
   l_info('##MASK##MANAGER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##RESOURCE_CITY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##RESOURCE_COUNTRY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##RESOURCE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##RESOURCE_REGION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27439',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_WP_RESOURCE_DENORM',
      p_sig_sql                => 'SELECT * FROM pa_resources_denorm WHERE resource_id IN (SELECT resource_id FROM pa_project_assignments where project_id = ##$$PROJECT_ID$$##)




  ',
      p_title                  => 'Resource Attributes (PA_RESOURCE_DENORM)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Resource Attribute do not exist for the project .',
      p_solution               => 'Follow the solution from the  [601397/KB464110].',
      p_success_msg            => 'Resource Attribute for this project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_WP_RESOURCE_DENORM');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_PERSON');
   l_info('##MASK##FULL_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27412',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_PERSON',
      p_sig_sql                => 'SELECT person_id,
       ...
       full_name,
       employee_number 
       FROM per_all_people_f WHERE person_id IN (SELECT person_id FROM pa_resources_denorm WHERE resource_id IN (SELECT resource_id FROM pa_project_assignments WHERE project_id = ##$$PROJECT_ID$$##))',
      p_title                  => 'Project Resource Person (PER_ALL_PEOPLE_F)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No resource assigned to project.',
      p_solution               => '',
      p_success_msg            => 'List of people assigned to project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_PERSON');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_PERSON_TYPE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27415',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_PERSON_TYPE',
      p_sig_sql                => 'SELECT
    ptu.person_type_usage_id,
    ptu.effective_start_date ptu_eff_start_date,
    ptu.effective_end_date   ptu_eff_end_date,
    pt.*
FROM
    per_person_types         pt,
...
ORDER BY
    ptu.effective_start_date',
      p_title                  => 'Project Resource Person Type (PER_PERSON_TYPES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Person Type is not assigned for person associated to project.',
      p_solution               => '',
      p_success_msg            => 'Person Type of persons associated to project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_PERSON_TYPE');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_ASSIGNMENT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27413',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_ASSIGNMENT',
      p_sig_sql                => 'SELECT
    a.assignment_id,
    ...
    a.assignment_number,
    a.set_of_books_id, 
    st.user_status       "User Status",
    st.per_system_status "PER System Status",
    st.pay_system_status "PAY System Status",
    st.per_system_status,
    st.active_flag       "Status Type Active",
    st.default_flag      "Status Default",
    st.primary_flag      "Status Primary"
FROM
    per_all_assignments_f       a,
    per_assignment_status_types st
WHERE a.person_id IN (select person_id from pa_resources_denorm where 
resource_id IN (SELECT resource_id FROM pa_project_assignments where project_id = ##$$PROJECT_ID$$##))
    AND a.assignment_status_type_id = st.assignment_status_type_id',
      p_title                  => 'Project Resource Assignment (PER_ALL_ASSIGNMENTS_F) ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No assignment exists for person associated to project.',
      p_solution               => '',
      p_success_msg            => 'Assignment of persons associated to project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_ASSIGNMENT');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_JOB');
   l_info('##MASK##NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27414',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_JOB',
      p_sig_sql                => 'SELECT
    a.assignment_id        "Assignment ID",
    a.primary_flag         "Primary Assignment",
    a.assignment_type      "Assignment Type",
    a.effective_start_date "Assignment Start",
    a.effective_end_date   "Assignment End",
    j.job_id,
    j.business_group_id,
    j.job_definition_id,
    j.date_from,
    j.date_to,
    j.name,
    j.job_information_category,
    j.job_information1,
    j.job_information2,
    j.object_version_number,
    j.benchmark_job_flag,
    j.benchmark_job_id,
    j.emp_rights_flag,
    j.job_group_id,
...
FROM
    ...
    per_jobs j
WHERE
        a.person_id IN (select person_id from pa_resources_denorm where 
resource_id IN (SELECT resource_id FROM pa_project_assignments where project_id = ##$$PROJECT_ID$$##))
    AND a.job_id = j.job_id
ORDER BY
    a.effective_start_date',
      p_title                  => 'Project Resource Job (PER_JOBS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Job is not assigned for person associated to project.',
      p_solution               => '',
      p_success_msg            => 'Job of persons associated to project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_JOB');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_PERIOD_OF_PLACEMENT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27417',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_PERIOD_OF_PLACEMENT',
      p_sig_sql                => 'SELECT pp.* 
FROM per_periods_of_placement pp 
WHERE pp.person_id IN (SELECT person_id FROM pa_resources_denorm 
WHERE resource_id IN (SELECT resource_id FROM pa_project_assignments WHERE project_id = ##$$PROJECT_ID$$##))',
      p_title                  => 'Project Resource Period of Placement (PER_PERIODS_OF_PLACEMENT)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Period of Placement does not have any data for person associated to project.',
      p_solution               => '',
      p_success_msg            => 'Period of Placement Details for person assigned to Project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_PERIOD_OF_PLACEMENT');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_PERIOD_OF_SERVICES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27416',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_PERIOD_OF_SERVICES',
      p_sig_sql                => 'SELECT
    ps.period_of_service_id,
    ps.date_start,
    ps.business_group_id,
    ps.termination_accepted_person_id,
    ps.person_id,
    ps.accepted_termination_date,
    ps.actual_termination_date,
    ps.final_process_date,
    ps.last_standard_process_date,
    ps.leaving_reason,
    ps.notified_termination_date,
    ps.projected_termination_date,
    ps.request_id,
    ps.object_version_number,
    ps.prior_employment_ssp_paid_to,
    ps.prior_employment_ssp_weeks,
    ps.adjusted_svc_date,
    ps.pds_information_category,
    ps.pds_information1,
    ps.pds_information2
FROM
    per_periods_of_service ps
WHERE
    ps.person_id IN (select person_id from pa_resources_denorm where 
resource_id IN (SELECT resource_id FROM pa_project_assignments where project_id = ##$$PROJECT_ID$$##))
ORDER BY
    ps.date_start
      ',
      p_title                  => 'Project Resource Period of Service (PER_PERIODS_OF_SERVICE)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Period of Service does not have any data for person associated to project.',
      p_solution               => '',
      p_success_msg            => 'Period of Service Details for person assigned to Project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_PERIOD_OF_SERVICES');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_WP_RESOURCES');
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27437',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_WP_RESOURCES',
      p_sig_sql                => 'SELECT * FROM pa_resources WHERE resource_id IN (SELECT resource_id FROM pa_project_assignments where project_id = ##$$PROJECT_ID$$##) ORDER BY start_date_active




  ',
      p_title                  => 'Resources (PA_RESOURCES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Project Resource  do not exist for the  Project. .',
      p_solution               => '',
      p_success_msg            => 'Project Resource  detail for this project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_WP_RESOURCES');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_EXPENDITURES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26389',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_EXPENDITURES',
...
order by expenditure_id desc',
      p_title                  => 'Expenditure Details For The Project (PA_EXPENDITURES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no expenditure details for the selected project.',
      p_solution               => '',
      p_success_msg            => 'Expenditure details for the selected project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_EXPENDITURES');



debug('begin add_signature: PA_EXPENDITURE_ITEMS_ALL_WP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '21331',
      p_sig_id                 => 'PA_EXPENDITURE_ITEMS_ALL_WP',
      p_sig_sql                => 'select * from PA_EXPENDITURE_ITEMS_ALL where cost_distributed_flag = ''Y''
and Project_id  = ##$$PROJECT_ID$$##',
      p_title                  => 'Expenditure Details (PA_EXPENDITURE_ITEMS_ALL )',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no transactions exists for this project or not cost distributed.',
      p_solution               => '',
      p_success_msg            => 'Transactions detail with cost distributed.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_EXPENDITURE_ITEMS_ALL_WP');



debug('begin add_signature: PA_EXPENDITURE_ITEMS_ALL_ND');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '21332',
      p_sig_id                 => 'PA_EXPENDITURE_ITEMS_ALL_ND',
      p_sig_sql                => 'select * from PA_EXPENDITURE_ITEMS_ALL where cost_distributed_flag = ''N'' and 
Project_id  = ##$$PROJECT_ID$$##',
      p_title                  => 'Expenditures Not Distributed',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Project expenditures are not cost distributed.',
      p_solution               => 'Follow the [2880073/KB487156]to run the corresponding Distribute Process.<br>
If you get any error or warning when distributing, please log a Service Request along with logfile and output file of concurrent process.<br>
',
      p_success_msg            => 'All expenditures are distributed successfully.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_EXPENDITURE_ITEMS_ALL_ND');



debug('begin add_signature: PA_PROJ_WORKPLAN_ATTR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12192',
      p_sig_id                 => 'PA_PROJ_WORKPLAN_ATTR',
      p_sig_sql                => 'SELECT wpAttr.*  FROM   PA_PROJ_WORKPLAN_ATTR  wpAttr  WHERE  wpAttr.project_id = ##$$PROJECT_ID$$##   order by wpAttr.PROJ_ELEMENT_ID ',
      p_title                  => 'Project Workplan Attribute Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No project workplan attributes exists for this project.',
      p_solution               => '',
      p_success_msg            => ' Project workplan attributes detail.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PROJ_WORKPLAN_ATTR');
...
debug('begin add_signature: PA_PROJ_PROGRESS_ATTR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20976',
      p_sig_id                 => 'PA_PROJ_PROGRESS_ATTR',
      p_sig_sql                => 'SELECT progattr.*
FROM pa_proj_progress_attr progattr
WHERE progattr.project_id = ##$$PROJECT_ID$$##
ORDER BY progattr.proj_progress_attr_id',
      p_title                  => 'Project Progress Attributes  Details (PA_PROJ_PROGRESS_ATTR)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Project progress attributes does not exists for this project.',
      p_solution               => '',
      p_success_msg            => 'Project progress attributes detail for this project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PROJ_PROGRESS_ATTR');



debug('begin add_signature: PA_PERCENT_COMPLETES');
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PROGRESS_COMMENT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20975',
      p_sig_id                 => 'PA_PERCENT_COMPLETES',
      p_sig_sql                => 'select percomp.*
from PA_PERCENT_COMPLETES percomp
where percomp.project_id = ##$$PROJECT_ID$$##
order by perComp.TASK_ID',
      p_title                  => 'Project Percent Complete Details  (PA_PERCENT_COMPLETES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Percent detail not exists for this project.',
      p_solution               => '',
      p_success_msg            => 'Percent detail detail for this project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PERCENT_COMPLETES');



debug('begin add_signature: PA_WORKPLAN_PUBLISHED_VERSION_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12150',
      p_sig_id                 => 'PA_WORKPLAN_PUBLISHED_VERSION_STATUS',
      p_sig_sql                => 'SELECT DECODE(pa_proj_task_struc_pub.published_version_exists(##$$PROJECT_ID$$##),''Y'',''Yes'',''No'') Workplan_Published_Version
FROM dual
WHERE pa_proj_task_struc_pub.published_version_exists(##$$PROJECT_ID$$##) = ''N''
',
      p_title                  => 'Project Workplan Published Version Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Project Workplan is not having a published version.',
      p_solution               => 'Follow the [2880041/KB318690]to publish the Workplan.',
      p_success_msg            => 'Project Workplan is already published.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_WORKPLAN_PUBLISHED_VERSION_STATUS');



debug('begin add_signature: PA_WORKPLAN_WORKFLOW_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12152',
      p_sig_id                 => 'PA_WORKPLAN_WORKFLOW_STATUS',
      p_sig_sql                => 'select
	STA.ITEM_TYPE "ITEM_TYPE", STA.ACTIVITY_RESULT_CODE "RESULT", 
    STA.ACTIVITY_STATUS "STATUS",
	...
	and STA.ITEM_TYPE in (select item_type from pa_wf_processes where entity_key1 = ##$$PROJECT_ID$$## and item_type = ''PAWFPPWP'')
	group by STA.ITEM_TYPE, STA.ACTIVITY_RESULT_CODE, PRA.PROCESS_NAME, PRA.INSTANCE_LABEL , STA.ACTIVITY_STATUS 
	order by STA.ITEM_TYPE, to_char(count(*)) desc',
      p_title                  => 'Project Workplan Workflow Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Project Workplan Workflow PAWFPPWP in error status.',
      p_solution               => 'Review the Project Workplan Workflow status in the Workflow Administrator responsibility > Status Monitor.<br>
For more details you can review the output of the Workflow diagnostic as per [564077/KB684879].<br>.
[168790/KB577733] - R12 11i: Workflow and Account Generator in Oracle Projects',
      p_success_msg            => 'Project Workplan Workflow PAWFPPWP is  not  in error status.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_WORKPLAN_WORKFLOW_STATUS');



debug('begin add_signature: PA_WORKPLAN_WORKING_VERSION_LOCK_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12176',
      p_sig_id                 => 'PA_WORKPLAN_WORKING_VERSION_LOCK_STATUS',
      p_sig_sql                => 'select LOCK_STATUS_CODE
...
and LOCK_STATUS_CODE = ''LOCKED''',
      p_title                  => 'Project Workplan Working Version Lock Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Project Workplan working version is locked.',
      p_solution               => 'Follow [2879996/KB565336] to unlock the working version.',
      p_success_msg            => 'Workplan working  version is not  locked.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_WORKPLAN_WORKING_VERSION_LOCK_STATUS');



debug('begin add_signature: PA_WP_PROJECTS_HAVING_REPORTING_DATA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13273',
      p_sig_id                 => 'PA_WP_PROJECTS_HAVING_REPORTING_DATA',
      p_sig_sql                => 'SELECT p.project_id,
       p.segment1 "Project Number",
       ...
       p.org_id
FROM pa_projects_all p
WHERE pa_project_utils.check_prj_stus_action_allowed(
        p.project_status_code,
        ''STATUS_REPORTING'') = ''Y''
AND   project_id = ##$$PROJECT_ID$$##
',
      p_title                  => 'Project  Reporting Data Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The project  reporting data detail.',
      p_solution               => '',
      p_success_msg            => 'Project not having reporting data.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_WP_PROJECTS_HAVING_REPORTING_DATA');



debug('begin add_signature: PA_DC_PROJECT_DELIVERABLES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12153',
      p_sig_id                 => 'PA_DC_PROJECT_DELIVERABLES',
      p_sig_sql                => 'SELECT status_code,
       project_id,
       proj_element_id,
       element_number,
       element_name
...
WHERE project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Project Defined Deliverables Details (PA_DELIVERABLES_V)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The project is having deliverables defined.',
      p_solution               => '',
      p_success_msg            => 'The project is not having deliverables defined.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DC_PROJECT_DELIVERABLES');



debug('begin add_signature: PA_RESOURCE_LIST_MEMBERS');
   l_info('##MASK##ALIAS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FULL_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20980',
      p_sig_id                 => 'PA_RESOURCE_LIST_MEMBERS',
      p_sig_sql                => 'SELECT resmem.* ,
  per.full_name
FROM pa_resource_list_members resmem ,
  per_all_people_f per
WHERE per.person_id (+)        = resmem.person_id
AND per.effective_end_date (+) > SYSDATE
AND resmem.resource_list_id   IN
  (SELECT DISTINCT resource_list_id
  FROM pa_budget_versions
  WHERE project_id =##$$PROJECT_ID$$##
  )
',
      p_title                  => 'Project Resource List Members Details  (PA_RESOURCE_LIST_MEMBERS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Project resource list members  does not exists for this project.',
      p_solution               => '',
      p_success_msg            => 'Project resource list members detail for this project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_RESOURCE_LIST_MEMBERS');



debug('begin add_signature: PA_RESOURCE_LISTS_ALL');
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20978',
      p_sig_id                 => 'PA_RESOURCE_LISTS_ALL',
      p_sig_sql                => 'SELECT resources.*
FROM pa_resource_lists_all_bg resources
WHERE resource_list_id IN
  (SELECT DISTINCT resource_list_id
  FROM pa_budget_versions
  WHERE project_id = ##$$PROJECT_ID$$##
  )',
      p_title                  => 'Project Resource List Details (PA_RESOURCE_LISTS_ALL_BG)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Project resource list  does not exists  for this project.',
      p_solution               => '',
      p_success_msg            => 'Project resource list detail for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_RESOURCE_LISTS_ALL');



debug('begin add_signature: PA_BUDGET_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20977',
      p_sig_id                 => 'PA_BUDGET_LINES',
      p_sig_sql                => 'select * from PA_BUDGET_LINES where budget_version_id in (select 
  budget_version_id from pa_budget_versions where wp_version_flag=''Y'' and 
  Project_id = ##$$PROJECT_ID$$##)',
      p_title                  => 'Project Budget Lines Details (PA_BUDGET_LINES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Project budget lines does not exists for this project.',
      p_solution               => '',
      p_success_msg            => 'Project budget lines detail for this project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_BUDGET_LINES');



debug('begin add_signature: PA_ETC_METHOD_CODE_SPREAD_CURVE_CODE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12179',
      p_sig_id                 => 'PA_ETC_METHOD_CODE_SPREAD_CURVE_CODE',
      p_sig_sql                => 'select distinct 
prlm.RESOURCE_LIST_ID, prlm.ETC_METHOD_CODE,
pscb.SPREAD_CURVE_CODE
from 
PA_RESOURCE_LIST_MEMBERS prlm,
PA_SPREAD_CURVES_B pscb
WHERE prlm.ETC_METHOD_CODE = ''NONE''
AND pscb.SPREAD_CURVE_CODE = ''NONE''
AND  RESOURCE_LIST_MEMBER_ID in (
  select pra.RESOURCE_LIST_MEMBER_ID from PA_RESOURCE_ASSIGNMENTS pra
where pra.project_id =  ##$$PROJECT_ID$$##)
and prlm.SPREAD_CURVE_ID = pscb.SPREAD_CURVE_ID
',
      p_title                  => 'Project Resource List ETC Method Used And Spread Curve',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Project Resource List without  defined ETC_METHOD_CODE and SPREAD_CURVE_CODE.',
      p_solution               => 'Follow [2879991/KB456156] to define the ETC method and Spread Curve method based on requirement.',
      p_success_msg            => 'Project Resource List attached to workplan are defined with ETC_METHOD_CODE and SPREAD_CURVE_CODE.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_ETC_METHOD_CODE_SPREAD_CURVE_CODE');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_BUDGET_ENTRY_METHOD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26996',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_BUDGET_ENTRY_METHOD',
      p_sig_sql                => 'SELECT bv.budget_version_id,
       bv.budget_type_code,
       bv.version_number,
       bv.fin_plan_type_id,
       bem.budget_entry_method_code,
       bem.budget_entry_method,
       bem.start_date_active,
       bem.entry_level_code,
       bem.categorization_code,
       bem.raw_cost_flag,
       bem.burdened_cost_flag,
       bem.rev_quantity_flag,
       bem.revenue_flag,
       bem.time_phased_type_code,
       bem.end_date_active,
       bem.predefined_flag
FROM pa_budget_entry_methods bem,
     pa_budget_versions bv
WHERE bem.budget_entry_method_code = bv.budget_entry_method_code
  AND bv.project_id =  ##$$PROJECT_ID$$##',
      p_title                  => 'Budget Entry Methods (PA_BUDGET_ENTRY_METHODS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found from PA_BUDGET_ENTRY_METHODS for the project budget.',
      p_solution               => '',
      p_success_msg            => 'PA_BUDGET_ENTRY_METHODS contains information about how budget amounts are entered and what resources, periods, and levels within the project to which budget amounts can be allocated.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_BUDGET_ENTRY_METHOD');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_FINPLAN_AMOUNT_SETS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26988',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_FINPLAN_AMOUNT_SETS',
      p_sig_sql                => 'SELECT
    *
FROM
    pa_fin_plan_amount_sets
WHERE fin_plan_amount_set_id in (SELECT
        all_amount_set_id
    FROM
        pa_proj_fp_options
    WHERE
    ...
    WHERE
      ...
      p_title                  => 'Financial Plan Amount Sets (PA_FIN_PLAN_AMOUNT_SETS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Financial Plan Amount Set does not exist for the project.
',
      p_solution               => '',
      p_success_msg            => 'Various amount sets available for financial plan.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_FINPLAN_AMOUNT_SETS');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_FIN_PLAN_TYPE_B');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26987',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_FIN_PLAN_TYPE_B',
      p_sig_sql                => 'SELECT t.name,t.description,t.language,b.*
FROM PA_FIN_PLAN_TYPES_B b,
            PA_FIN_PLAN_TYPES_TL t
WHERE b.fin_plan_type_id IN (SELECT fin_plan_type_id
                            FROM pa_proj_fp_options
                        WHERE project_id = ##$$PROJECT_ID$$##)
    AND b.fin_plan_type_id = t.fin_plan_type_id',
      p_title                  => 'Financial Plan Type (PA_FIN_PLAN_TYPES_B)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Financial Plan Type does not exist for the project.
',
      p_solution               => '',
      p_success_msg            => 'Financial Plan Type associated with project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_FIN_PLAN_TYPE_B');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_FP_TXN_CURRENCIES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26989',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_FP_TXN_CURRENCIES',
      p_sig_sql                => 'SELECT * FROM PA_FP_TXN_CURRENCIES
WHERE proj_fp_options_id IN (SELECT proj_fp_options_id FROM pa_proj_fp_options WHERE project_id = ##$$PROJECT_ID$$##)',
      p_title                  => 'Financial Plan Transaction Currencies (PA_FP_TXN_CURRENCIES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Financial Plan Transaction Currencies do not exist for the project.
',
      p_solution               => '',
      p_success_msg            => 'Plannable transaction currencies for a project',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_FP_TXN_CURRENCIES');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_RESOURCE_ASSIGNMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26995',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_RESOURCE_ASSIGNMENTS',
      p_sig_sql                => 'SELECT * FROM pa_resource_assignments ra
WHERE ra.project_ID = ##$$PROJECT_ID$$##',
      p_title                  => 'Resource Assignments (PA_RESOURCE_ASSIGNMENTS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found from PA_RESOURCE_ASSIGNMENTS for the Project.',
      p_solution               => '',
      p_success_msg            => 'PA_RESOURCE_ASSIGNMENTS contains data pertaining to the resources assigned to a project budget.  Resource assignments are also the intermediary table between the budget and the budget lines.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_RESOURCE_ASSIGNMENTS');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_RES_CLASSES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26997',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_RES_CLASSES',
      p_sig_sql                => 'select * from PA_RESOURCE_CLASSES_b',
      p_title                  => 'Resource Classes (PA_RESOURCE_CLASSES_B)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Resource Class does not exist in application.
',
      p_solution               => '',
      p_success_msg            => 'These resource classes are available in application.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_RES_CLASSES');



debug('begin add_signature: PA_CURRENT_REPORTING_PERIOD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12183',
      p_sig_id                 => 'PA_CURRENT_REPORTING_PERIOD',
      p_sig_sql                => 'SELECT period_name,
       gl_period_name,
       start_date,
       end_date,
       status,
...
ORDER BY start_date desc',
      p_title                  => 'Current Project Reporting Period',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no current reporting period set in the project''s operating unit.',
      p_solution               => 'To set the project reporting period please follow the [342224/KB559289] - How To Set Current Reporting Period For Specific Period.',
      p_success_msg            => 'Current reporting period already set.',
   ...
   l_info.delete;
debug('end add_signature: PA_CURRENT_REPORTING_PERIOD');



debug('begin add_signature: PA_STRUCTURE_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20973',
      p_sig_id                 => 'PA_STRUCTURE_TYPES',
      p_sig_sql                => 'SELECT struct.*
FROM pa_structure_types struct
WHERE struct.structure_type_id IN
  (SELECT TYPE.structure_type_id
  FROM pa_proj_structure_types TYPE
  WHERE TYPE.proj_element_id IN
    (SELECT elem.proj_element_id
    FROM pa_proj_elements elem
    WHERE elem.project_id = ##$$PROJECT_ID$$##
    )
  )',
      p_title                  => 'Project Structure Types  Details (PA_STRUCTURE_TYPES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Structure type does not exists for this project.',
      p_solution               => '',
      p_success_msg            => 'Structure type detail for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_STRUCTURE_TYPES');



debug('begin add_signature: PA_PROJ_STRUCTURE_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12497',
      p_sig_id                 => 'PA_PROJ_STRUCTURE_TYPES',
      p_sig_sql                => ' SELECT struct.*  FROM   PA_PROJ_STRUCTURE_TYPES  struct  WHERE  struct.proj_element_id in         (SELECT elem.proj_element_id          FROM   pa_proj_elements elem WHERE  elem.project_id = ##$$PROJECT_ID$$## ) order by struct.PROJ_STRUCTURE_TYPE_ID',
      p_title                  => 'Project Structure Types Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No structure types exists  for project structure of Project. ',
      p_solution               => '',
      p_success_msg            => 'PA_PROJ_STRUCTURE_TYPES stores the structure types for a particular project structure.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PROJ_STRUCTURE_TYPES');



debug('begin add_signature: PA_TASK_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20972',
      p_sig_id                 => 'PA_TASK_TYPES',
      p_sig_sql                => 'SELECT tasktypes.*
FROM PA_TASK_TYPES tasktypes
WHERE tasktypes.task_type_id IN
  (SELECT elem.type_id FROM pa_proj_elements elem WHERE elem.project_id = ##$$PROJECT_ID$$##
  )
',
      p_title                  => 'Task Type Details (PA_TASK_TYPES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Task types not associated to task for this project.',
      p_solution               => '',
      p_success_msg            => 'Task types associated to task for this project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_TASK_TYPES');



debug('begin add_signature: PA_PROJ_PERIOD_PROFILES PERIODS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20981',
      p_sig_id                 => 'PA_PROJ_PERIOD_PROFILES PERIODS',
      p_sig_sql                => 'select periods.*
from pa_proj_period_profiles periods
where periods.project_id = ##$$PROJECT_ID$$##
order by periods.period_profile_id ',
      p_title                  => 'Project Period Profile Details (PA_PROJ_PERIOD_PROFILES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Period profile does not exist for this project.',
      p_solution               => 'Follow the solution in How to Set the Period Profile in Workplan [2880063/KB248202].',
      p_success_msg            => 'Period profile exists for this project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PROJ_PERIOD_PROFILES PERIODS');



debug('begin add_signature: WORKPLAN_FINANCIAL_PLAN_SHARING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '21411',
      p_sig_id                 => 'WORKPLAN_FINANCIAL_PLAN_SHARING',
      p_sig_sql                => 'SELECT pa_project_structure_utils.get_structure_sharing_code(##$$PROJECT_ID$$##)
FROM dual',
      p_title                  => 'Workplan And Financial Structure Sharing',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Workplan and Financial structure  is not shared.',
      p_solution               => 'Follow the [2880053/KB301546] to change the Structure setup.<br>
<strong>Note:</strong> Before modifying check with business regarding structure sharing type required.<br>',
      p_success_msg            => 'Workplan and Financial structure  sharing information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: WORKPLAN_FINANCIAL_PLAN_SHARING');



debug('begin add_signature: PA_PROJ_FP_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20982',
      p_sig_id                 => 'PA_PROJ_FP_OPTIONS',
      p_sig_sql                => 'SELECT fpoptions.*
FROM PA_PROJ_FP_OPTIONS FPOPTIONS
WHERE fpoptions.project_id = ##$$PROJECT_ID$$##
ORDER BY fpoptions.proj_fp_options_id',
      p_title                  => 'Project FP Option Details (PA_PROJ_FP_OPTIONS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Project FP options detail not exists for this project.
',
      p_solution               => '',
      p_success_msg            => 'Project FP options detail for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PROJ_FP_OPTIONS');



debug('begin add_signature: PA_FINANCIAL_STRUCTURE_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12148',
      p_sig_id                 => 'PA_FINANCIAL_STRUCTURE_STATUS',
      p_sig_sql                => 'SELECT DECODE(pa_project_structure_utils.check_financial_enabled(##$$PROJECT_ID$$##),''Y'',''Yes'',''No'') Financial_Structure_Status
FROM dual
WHERE pa_project_structure_utils.check_financial_enabled(##$$PROJECT_ID$$##) = ''N''',
      p_title                  => 'Project Financial Structure Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Project Financial Structure is not enabled.',
      p_solution               => 'Follow the [2857141/KB623660]to enable the Financial Plan.<br>
<strong>Note:</strong> Before modifying check with business regarding structure required.',
      p_success_msg            => 'Project Financial Structure is  enabled.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_FINANCIAL_STRUCTURE_STATUS');



debug('begin add_signature: PA_PERIODS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20984',
      p_sig_id                 => 'PA_PERIODS_ALL',
      p_sig_sql                => ' SELECT per.* 
  FROM pa_periods_all per 
  WHERE per.org_id IN (
        SELECT org_id FROM pa_projects_all
        WHERE project_id = ##$$PROJECT_ID$$##)
ORDER BY per.start_date DESC ',
      p_title                  => 'Project Periods Details  (PA_PERIODS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Period information not exists for the project.',
      p_solution               => '',
      p_success_msg            => 'Period detail for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PERIODS_ALL');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_PJI_TIME_CAL_PERIOD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30290',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_PJI_TIME_CAL_PERIOD',
      p_sig_sql                => 'select * from pji_time_cal_period 
where rownum<100
order by calendar_id desc, sequence desc',
      p_title                  => 'Project Intelligence (PJI) Calendar Periods',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Project Intelligence calendar periods are defined.',
      p_solution               => '',
      p_success_msg            => 'Project Intelligence calendar periods are not defined.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_PJI_TIME_CAL_PERIOD');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_PERIOD_MASKS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26985',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_PERIOD_MASKS',
      p_sig_sql                => 'SELECT
    *
FROM
    pa_period_masks_b
WHERE
    period_mask_id IN (
      ...
      p_title                  => 'Period Masks Definition (PA_PERIOD_MASKS_B)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Period Mask Definition is not available for Project
',
      p_solution               => '',
      p_success_msg            => 'Various period mask definitions to be used for displaying periodic data',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_PERIOD_MASKS');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_PERIOD_MASK_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26986',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_PERIOD_MASK_DETAILS',
      p_sig_sql                => 'SELECT
    *
FROM
    pa_period_mask_details
WHERE
    period_mask_id IN (
        SELECT
            period_mask_id
      ...
      p_title                  => 'Period Masks Details (PA.PA_PERIOD_MASK_DETAILS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Period Mask Details are not available for Project
',
      p_solution               => '',
      p_success_msg            => 'Various period mask details to be used for displaying periodic data',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_PERIOD_MASK_DETAILS');



debug('begin add_signature: PA_GATHER_STATS_RUN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20986',
      p_sig_id                 => 'PA_GATHER_STATS_RUN',
      p_sig_sql                => 'SELECT Decode(substr(UPPER(ARGUMENT_TEXT),1,3),''PA'', ''PA'', ''PJI,'', ''PJI'', substr(UPPER(ARGUMENT_TEXT),1,3)) "Schema",
...
FND_LOOKUP_VALUES PHAS
	...
	AND substr(UPPER(ARGUMENT_TEXT),1,3) in (''ALL'',''PJI,'', ''PA'',''PJI'' )
...
order by ACTUAL_COMPLETION_DATE desc',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Gather Schema Statistics had not run in last 30 days for Project Accounting (PA) or Project planning and Control (PJI) or Subledger(SLA) or General Ledger(GL) Schemas. This may lead to performance issues.',
      p_solution               => 'In order to schedule the Gather Stats program, use [419728/KB627293] Concurrent Processing - How To Gather Statistics On Oracle Applications Release 11i and/or Release 12 - Concurrent Process, Temp Tables, Manually.<br> 
This warning can be ignored if gather stats was run using command Prompt.',
   ...
   l_info.delete;
debug('end add_signature: PA_GATHER_STATS_RUN');



debug('begin add_signature: PA_TABLESPACE_ISSUE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20987',
      p_sig_id                 => 'PA_TABLESPACE_ISSUE',
...
',
      ...
      p_solution               => '<p>Review items indicated and add additional data files directly to the tablespace if appropriate .</p>
<p><a href="https://docs.oracle.com/en/database/oracle/oracle-database/21/admin/managing-tablespaces.html">Guidelines for Managing Tablespaces</a></p>',
   ...
   l_info.delete;
debug('end add_signature: PA_TABLESPACE_ISSUE');



debug('begin add_signature: PA_STALE_TABLE_STATS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20988',
      p_sig_id                 => 'PA_STALE_TABLE_STATS',
      p_sig_sql                => 'select table_name, stale_stats, last_analyzed
from dba_tab_statistics
where stale_stats=''YES''
and (table_name like ''PA%''
or table_name like ''PJI%''
or table_name like ''XLA%'')
and table_name NOT LIKE ''PAY%''',
      p_title                  => 'Stale Table Stats',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Stale Table Stats were found and needs optimization for tables in Project Accounting, General Ledger and Subledger.',
      p_solution               => 'For optimal performance run "Gather Schema Statistics" concurrent process for the affected schemas.<br>
Follow the [2877048/KB776783] to run the ''Gather Schema Statistics'' concurrent process for the affected schemas.',
...
',
   ...
   l_info.delete;
debug('end add_signature: PA_STALE_TABLE_STATS');



debug('begin add_signature: PA_OBJECT_LOCK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20989',
      p_sig_id                 => 'PA_OBJECT_LOCK',
...
and (object_name like ''PA%''
           or object_name like ''PJI%'')
order by b.object_name
',
      p_title                  => 'Object Lock',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Table locks were found in Project and Subledger Tables which may lead to performance issues.',
      p_solution               => 'Check if there are any transactions or concurrent programs in progress which has caused object lock, if not report it to DBA.',
      p_success_msg            => 'No table locks were found.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_OBJECT_LOCK');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_FINANCIAL_PLAN_ORIGINAL_AND_CURRENT_BASELINE_FACT_DATA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27432',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_FINANCIAL_PLAN_ORIGINAL_AND_CURRENT_BASELINE_FACT_DATA',
      p_sig_sql                => 'SELECT f.* 
  FROM pji_fp_xbs_accum_f f,
       pa_projects_all p
 WHERE f.project_id         = ##$$PROJECT_ID$$##
   AND f.project_element_id = pa_project_structure_utils.get_fin_structure_id(f.project_id)
   ...
   AND bitand(f.curr_record_type_id,8) = 8
   AND f.project_id         = p.project_id
   AND f.plan_type_id       IN ( SELECT b.fin_plan_type_id
                                   FROM pa_budget_versions b
                                  WHERE b.project_id = f.project_id)
                                    AND f.plan_type_id NOT   IN (-1,10) 
                                    AND f.plan_version_id    IN (-3,-4) 
                                    ORDER BY f.plan_type_id, f.plan_version_id',
      p_title                  => 'Financial Plan (Original and Current Baseline) Fact Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Financial Plan (Original and Current Baseline) Fact Data not exists for the Project.',
      p_solution               => '',
      p_success_msg            => 'Information about Financial Plan (Original and Current Baseline) Fact Data of the Project with summarized cost, revenue, commitments measures for project performance by work breakdown, resource breakdown and program hierarchies.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_FINANCIAL_PLAN_ORIGINAL_AND_CURRENT_BASELINE_FACT_DATA');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_PA_XBS_DENORM');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27433',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_PA_XBS_DENORM',
      p_sig_sql                => 'SELECT xbs.* 
  FROM PA_XBS_DENORM xbs 
 WHERE 1=1 
   AND (xbs.sup_project_id, xbs.struct_version_id) IN (SELECT project_id, project_structure_version_id 
                                                         FROM PA_BUDGET_VERSIONS bv 
														WHERE 1=1 
														  AND (bv.project_structure_version_id = Pa_Project_Structure_Utils.GET_FIN_STRUC_VER_ID(bv.project_id))
                                                          AND bv.wp_version_flag = ''Y'' 
														  AND bv.project_id = ##$$PROJECT_ID$$## )',
      p_title                  => 'XBS Denorm Data (PA_XBS_DENORM)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Project does not have XBS denorm data updated.',
      p_solution               => '',
      p_success_msg            => 'Information about XBS denorm data by the Refresh/Update Project Performance Data.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_PA_XBS_DENORM');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_PJI_FP_XBS_ACCUM_F');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27430',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_PJI_FP_XBS_ACCUM_F',
      p_sig_sql                => 'SELECT tmp.PLAN_VERSION_ID pvi,
       tmp.PLAN_TYPE_ID pti , SUBSTR(tmp.PROJECT_ELEMENT_ID, 1, 10)
       pei , tmp.TIME_ID ti , tmp.CALENDAR_TYPE ct ,
       tmp.RBS_ELEMENT_ID rei, tmp.RBS_VERSION_ID rvi ,
       tmp.RBS_AGGR_LEVEL ral, tmp.WBS_ROLLUP_FLAG wrf,
       tmp.PRG_ROLLUP_FLAG prf , tmp.CURR_RECORD_TYPE_ID crti,
       tmp.CURRENCY_CODE cc , tmp.brdn_cost bc, tmp.act_brdn_cost abc,
       tmp.etc_brdn_cost ebc , tmp.labor_hrs lh, tmp.act_labor_hrs
       alh, tmp.etc_labor_hrs elh , tmp.equipment_hours eh,
       tmp.act_equip_hrs aeh, tmp.etc_equip_hrs eeh 
  FROM PJI_FP_XBS_ACCUM_F tmp 
 WHERE tmp.project_id = ##$$PROJECT_ID$$## 
   AND bitand(tmp.curr_record_type_id, 28) > 0',
      p_title                  => 'Project Summarization Data (PJI_FP_XBS_ACCUM_F)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Project Summarization data not available.',
      p_solution               => '',
      p_success_msg            => 'Information about Project Summarization data with summarized cost, revenue, commitments measures for project performance by work breakdown, resource breakdown and program hierarchies.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_PJI_FP_XBS_ACCUM_F');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_PJI_ORG_EXTR_INFO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27428',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_PJI_ORG_EXTR_INFO',
      p_sig_sql                => 'SELECT * 
FROM PJI_ORG_EXTR_INFO 
WHERE ORG_ID IN (SELECT ORG_ID 
                   FROM  pa_projects_all 
				  WHERE project_id = ##$$PROJECT_ID$$##)',
      p_title                  => 'Project Performance Reporting Organization Details (PJI_ORG_EXTR_INFO)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Performance Reporting Organization Details do not exist for project''s operating unit.',
      p_solution               => '',
      p_success_msg            => 'Information for organizations that have been extracted to project performance-reporting model.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_PJI_ORG_EXTR_INFO');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_PJI_PJP_PROJ_BATCH_MAP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27423',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_PJI_PJP_PROJ_BATCH_MAP',
      p_sig_sql                => 'SELECT * 
FROM pji_pjp_proj_batch_map
WHERE project_id = ##$$PROJECT_ID$$##
',
      p_title                  => 'Project Intelligence PJP summarization state (PJI_PJP_PROJ_BATCH_MAP)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'PJP summarization batch mapping details are not available.',
      p_solution               => '',
      p_success_msg            => 'PJP summarization batch mapping details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_PJI_PJP_PROJ_BATCH_MAP');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_PJI_PJP_RBS_HEADER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27424',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_PJI_PJP_RBS_HEADER',
      p_sig_sql                => 'SELECT * 
FROM PJI_PJP_RBS_HEADER 
WHERE project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'PJI Resource breakdown Structure (PJI_PJP_RBS_HEADER)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Associations between project, plan and Resource Breakdown Structures is not available.',
      p_solution               => '',
      p_success_msg            => 'Tracks associations between project, plan and Resource Breakdown Structures.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_PJI_PJP_RBS_HEADER');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_PJI_PJP_WBS_HEADER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27429',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_PJI_PJP_WBS_HEADER',
      p_sig_sql                => 'SELECT * 
  FROM PJI_PJP_WBS_HEADER 
 WHERE project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'PJI Workbreakdown Structure (PJI_PJP_WBS_HEADER)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Associations between projects and Work Breakdown Structures is not available.',
      p_solution               => '',
      p_success_msg            => 'Tracks associations between projects and Work Breakdown Structures.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_PJI_PJP_WBS_HEADER');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_PJI_SYSTEM_CONFIG_HIST');
   l_info('##MASK##USER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27263',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_PJI_SYSTEM_CONFIG_HIST',
      p_sig_sql                => 'SELECT Main_Request_Id, Request_Id, Process_Name,  Run_Type,
                     User_Name, rtrim(Parameters) Parameters,
                     to_char(start_date,''YYYY/MM/DD HH24:MI:SS'') Start_date,
                     to_char(end_date,''YYYY/MM/DD HH24:MI:SS'') End_Date,
                     Config_Proj_Perf_Flag, Config_Cost_Flag Config_Profit_Flag,
                     Config_Util_Flag
              FROM PJI_SYSTEM_CONFIG_HIST
              ORDER BY START_DATE DESC',
      p_title                  => 'Project Intelligence System Configuration (PJI_SYSTEM_CONFIG_HIST)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Project Intelligence is not configured.',
      p_solution               => '',
      p_success_msg            => 'History of the configuration of your Oracle Projects Intelligence.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_PJI_SYSTEM_CONFIG_HIST');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_PROJECT_RBS_SETUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27426',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_PROJECT_RBS_SETUP',
      p_sig_sql                => 'SELECT  a.project_id "Project ID", 
        a.rbs_header_id "RBS Header ID",
     	h.name "RBS Name",
     	a.rbs_version_id "RBS Version ID",
     	a.reporting_usage_flag "Reporting Usage Flag",
     	a.primary_reporting_rbs_flag  "Primary Reporting RBS Flag",
        a.assignment_status "Assignment Status"
  FROM    PA_RBS_PRJ_ASSIGNMENTS a,
          PA_RBS_HEADERS_TL h 
 WHERE   a.project_id = ##$$PROJECT_ID$$##
   AND     h.rbs_header_id = a.rbs_header_id
   AND     h.LANGUAGE = ''US''',
      p_title                  => 'Project RBS Setup (PA_RBS_PRJ_ASSIGNMENTS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Project does not have RBS setup details.',
      p_solution               => '',
      p_success_msg            => 'Information about Project RBS setup details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_PROJECT_RBS_SETUP');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_STRUCTURE_LEVEL_FACT_DATA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27431',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_STRUCTURE_LEVEL_FACT_DATA',
      p_sig_sql                => 'SELECT f.* 
  FROM pji_fp_xbs_accum_f f,
       pa_projects_all p
 WHERE f.project_id         = ##$$PROJECT_ID$$##
   ...
   AND f.currency_code      = p.projfunc_currency_code
   AND f.project_id         = p.project_id
   ORDER BY f.plan_version_id',
      p_title                  => 'Structure Level Fact Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Structure Level Fact data not updated for the Project.',
      p_solution               => '',
      p_success_msg            => 'Information about Structure Level Fact data with summarized cost, revenue, commitments measures for project performance by work breakdown, resource breakdown and program hierarchies of the Project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_STRUCTURE_LEVEL_FACT_DATA');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_WP_PJI_SYSTEM_PRC_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27441',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_WP_PJI_SYSTEM_PRC_STATUS',
      p_sig_sql                => 'SELECT  process_name , step_seq , step_status , step_name ,
                        to_char(START_DATE, ''DDTH HH24:MI:SS'') START_DATE ,
                        to_char(END_DATE, ''DDTH HH24:MI:SS'') END_DATE ,
                        round((to_number(to_char(END_DATE, ''DD'')) * 24 * 60 +
                          to_number(to_char(END_DATE, ''HH24'')) * 60 +
                          to_number(to_char(END_DATE, ''MI'')) +
                          to_number(to_char(END_DATE, ''SS'')) / 60) -
                          (to_number(to_char(START_DATE, ''DD'')) * 24 * 60 +
                          to_number(to_char(START_DATE, ''HH24'')) * 60 +
                          to_number(to_char(START_DATE, ''MI'')) +
                          to_number(to_char(START_DATE, ''SS'')) / 60), 1) ELAPSED_MINUTES
                FROM    pji_system_prc_status
                WHERE   step_seq between 0 and 10000
  ...
  ',
      p_title                  => 'Summarization Process Detail(PJI_SYSTEM_PRC_STATUS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Summarization not done and no summarization concurrent  process submitted.',
      p_solution               => '',
      p_success_msg            => 'Concurrent process name and status of the steps that have been submitted during summarization.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_WP_PJI_SYSTEM_PRC_STATUS');



debug('begin add_signature: PA_WORKPLAN_STRUCTURE_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12147',
      p_sig_id                 => 'PA_WORKPLAN_STRUCTURE_STATUS',
      p_sig_sql                => 'SELECT DECODE(pa_project_structure_utils.check_workplan_enabled(##$$PROJECT_ID$$##),''Y'',''Yes'',''No'') Workplan_Structure_Status
FROM dual
WHERE pa_project_structure_utils.check_workplan_enabled(##$$PROJECT_ID$$##) = ''N''',
      p_title                  => 'Project Workplan Structure Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Project Workplan Structure is not enabled.',
      p_solution               => 'Follow the [2857141/KB623660]to enable the Work Plan.<br>
<strong>Note:</strong> Before modifying check with business regarding structure required.',
      p_success_msg            => 'Project Workplan Structure is  enabled.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_WORKPLAN_STRUCTURE_STATUS');



debug('begin add_signature: PA_WORKPLAN_VERSIONING_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12149',
      p_sig_id                 => 'PA_WORKPLAN_VERSIONING_STATUS',
      p_sig_sql                => 'SELECT DECODE(pa_proj_task_struc_pub.is_wp_versioning_enabled(##$$PROJECT_ID$$##),''Y'',''Yes'',''No'') versioning_enabled
FROM dual
where pa_proj_task_struc_pub.is_wp_versioning_enabled(##$$PROJECT_ID$$##)= ''N''
',
      p_title                  => 'Project Workplan Versioning Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Project Workplan Versioning is not enabled for this Project.',
      p_solution               => 'Follow the [1938970/KB636473] to enable the Workplan Versioning.<br>
<strong>Note:</strong> Before modifying check with business regarding workplan versioning is required.',
      p_success_msg            => 'Workplan Versioning is enabled for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_WORKPLAN_VERSIONING_STATUS');



debug('begin add_signature: PA_FND_CONCURRENT_REQUESTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '21473',
      p_sig_id                 => 'PA_FND_CONCURRENT_REQUESTS',
      p_sig_sql                => 'SELECT *  FROM pa_proj_elem_ver_structure 
where process_code is not null and nvl(process_code,''X'') <> ''WUS''
and project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Project Workplan Publish Error ',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Publishing the project workplan is not completed as it is stuck in concurrent process PRC: Process Structure Updates.',
      p_solution               => 'Please log a Service Request along with the Project Planning and Control analyzer output to get possible data fix based on [788616/KB199178] Unable to Re-Publish or Update a Project Workplan Due to Error in PRC: Process Structure Updates concurrent program.',
      p_success_msg            => 'Project workplan published successfully .',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_FND_CONCURRENT_REQUESTS');
...
debug('begin add_signature: PA_WP_MISSING_TASKS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17794',
      p_sig_id                 => 'PA_WP_MISSING_TASKS',
      p_sig_sql                => 'SELECT distinct
          project_id,
  ...
  AND    project_id =##$$PROJECT_ID$$##',
      p_title                  => 'Missing Task in Financial Plan',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Mismatch between Task structure and Workplan structure.

',
      p_solution               => 'Download the Generic data fix patch appropriate for your application release as described in [351670/PALRT1517].<br>
Apply the datafix according to the README instructions.',
      p_success_msg            => 'No missing task exists in financial plan.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_WP_MISSING_TASKS');



debug('begin add_signature: PA_WP_PUBLISH_PARENT_TASK_CHARGEABLE');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##task_number'):= 'center,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '17795',
      p_sig_id                 => 'PA_WP_PUBLISH_PARENT_TASK_CHARGEABLE',
      p_sig_sql                => 'SELECT distinct ppa.project_id,
                ppa.segment1 "Project Number",pt.task_id,pt.task_number
FROM pa_projects_all ppa,
     pa_tasks pt,
     pa_proj_elements ppe
WHERE ppa.project_id = pt.project_id
  ...
  AND ppe.object_type =''PA_TASKS''
  AND NVL(ppe.link_task_flag, ''N'')  = ''N''
  AND ppe.chargeable_flag=''Y''
  AND pa_task_utils.check_child_exists(pt.task_id)=1
  AND pa_proj_task_struc_pub.is_wp_versioning_enabled(ppa.project_id)=''Y''
  AND  ppe.project_id= ##$$PROJECT_ID$$##
  ',
      p_title                  => 'Incorrect Chargeable Flag on Parent Task',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'When trying to publish the workplan getting  error message 
as ''Parent Tasks Cannot be Made Chargeable''.',
      p_solution               => 'Please log a Service Request along with workplan analyzer output to get possible data fix based on [2847083/KB602450].',
      p_success_msg            => 'No corruption exists .',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_WP_PUBLISH_PARENT_TASK_CHARGEABLE');



debug('begin add_signature: PA_WP_PUBLISH_TASK_EXISTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17797',
      p_sig_id                 => 'PA_WP_PUBLISH_TASK_EXISTS',
      p_sig_sql                => 'select pm_source_reference, count(*)
  from pa_proj_elements
  where pm_source_reference is not null
  and project_id = ##$$PROJECT_ID$$##
  group by pm_source_reference having count(*) > 1',
      p_title                  => 'Error  "Task Number Already Exists" When Publishing Workplan',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Getting error ''Task Number Already Exists'' when publishing the workplan even though Task number is unique.',
      p_solution               => 'Please log Service Request along with workplan analyzer output to get possible data fix based on [2857149/KB299066].',
      p_success_msg            => 'Workplan Published successfully.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_WP_PUBLISH_TASK_EXISTS');



debug('begin add_signature: PA_WP_EI_INVALID_START_DATE_TASK');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##element_number'):= 'center,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '17788',
      p_sig_id                 => 'PA_WP_EI_INVALID_START_DATE_TASK',
      p_sig_sql                => 'select distinct peia.expenditure_item_id,
peia.expenditure_item_date,    
    ppa.segment1 "Project Number",
    ppe.element_number, --Task Number
    ...
    and peia.project_id = ppe.project_id
    and peia.task_id = ppe.proj_element_id
    and ppe.proj_element_id = ppev.proj_element_id
    and ppev.element_version_id = ppevs.element_version_id
    and (peia.expenditure_item_date < ppevs.scheduled_start_date
    or   peia.expenditure_item_date < ppevs.actual_start_date
    or   peia.expenditure_item_date < ppevs.estimated_start_date )
    order by  ppe.element_number, peia.expenditure_item_id',
      p_title                  => 'Invalid Workplan Scheduled Start Date ',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'When trying to publish the workplan getting error message as 
''An expenditure item exists with a date that is earlier than the start date of the task: &TASKNUM. Please change the task start date to be the same as or earlier than the expenditure item date:
 &EISTARTDATE(PA_EI_INVALID_START_DATE_TSK)''.',
      p_solution               => 'Go to [1671630/KB578956#Case39] and follow section 39 "Exception when publishing the workplan".',
      p_success_msg            => 'Workplan Schedule Dates are valid.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_WP_EI_INVALID_START_DATE_TASK');



debug('begin add_signature: PA_WP_EI_INVALID_END_DATE_TASK');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##element_number'):= 'center,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '17785',
      p_sig_id                 => 'PA_WP_EI_INVALID_END_DATE_TASK',
      p_sig_sql                => 'select distinct peia.expenditure_item_id,
peia.expenditure_item_date,
    ppa.segment1 "Project Number",
    ppe.element_number, --Task Number
    ...
    and ppe.proj_element_id = ppev.proj_element_id
    and ppev.element_version_id = ppevs.element_version_id
    and (ppevs.scheduled_finish_date < peia.expenditure_item_date
    or ppevs.actual_finish_date < peia.expenditure_item_date
    or ppevs.estimated_finish_date < peia.expenditure_item_date )
    order by  ppe.element_number, peia.expenditure_item_id
	',
      p_title                  => 'Invalid  Workplan Scheduled End Date',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'When trying to publish the workplan getting  error message as
''An expenditure item exists with a date that is later than the end date of the task: &TASKNUM. Please change the task end date to be the same as or
 later than the expenditure item date: &EIFINISHDATE''.',
      p_solution               => 'Go to [1671630/KB578956#Case39] and follow section 39 "Exception when publishing the workplan".',
      p_success_msg            => 'Workplan schedule end date is valid.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_WP_EI_INVALID_END_DATE_TASK');



debug('begin add_signature: PA_WP_MISSING_TASKS_WORKPLAN_ATTRIBUTES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17859',
      p_sig_id                 => 'PA_WP_MISSING_TASKS_WORKPLAN_ATTRIBUTES',
      p_sig_sql                => 'SELECT  project_id
   FROM   pa_proj_elements
   ...
   AND project_id NOT IN (
         ...
         AND ppwa.wp_enable_version_flag = ''Y'')
 AND    project_id =##$$PROJECT_ID$$##',
      p_title                  => 'Missing Task in Workplan Attribute',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Mismatch between Task structure and Workplan structure.
',
      p_solution               => 'Download the generic data fix appropriate for your release as described in [351670/PALRT1517]. <br>
Apply the datafix according to the README instructions .',
      p_success_msg            => 'No missing task exists in workplan.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_WP_MISSING_TASKS_WORKPLAN_ATTRIBUTES');



debug('begin add_signature: PA_WP_MISSING_EXCHANGE_RATE_COST_RATE');
   l_info('##MASK##ALIAS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17622',
      p_sig_id                 => 'PA_WP_MISSING_EXCHANGE_RATE_COST_RATE',
      p_sig_sql                => 'SELECT ra.task_id ,
  pe.name task_name ,
  pe.element_number task_no,
  rlm.alias ,
...
WHERE (bl.burden_rejection_code is not null or  bl.cost_rejection_code is not null or  bl.revenue_rejection_code is not null)
...
AND pevs.project_id                =##$$PROJECT_ID$$##
  ',
      p_title                  => 'Missing Cost and/or Conversion Rates',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'When trying to publish the workplan getting  error message as
''Either cost rates, or conversion rates, or both are missing for some planning elements''.
',
      p_solution               => 'Go to [1671630/KB578956#Case12] and follow section 12 to find the exchange rate missing for the resource assignment.<br> Then define the rate/exchange rate based on requirement.',
      p_success_msg            => 'No conversion or cost rate is missing.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_WP_MISSING_EXCHANGE_RATE_COST_RATE');



debug('begin add_signature: PA_PROJ_ELEMENTS_PREPENDED_TASK');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##.element_number'):= 'center,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '13985',
      p_sig_id                 => 'PA_PROJ_ELEMENTS_PREPENDED_TASK',
      p_sig_sql                => 'SELECT distinct pt.project_id, p.segment1 "Project Number", pt.task_number , pt.task_id, pe.element_number, proj_element_id
FROM  pa_tasks pt,
         pa_proj_elements pe,
         pa_projects_all p
WHERE p.project_id = ##$$PROJECT_ID$$##
...
',
      p_title                  => 'Project Task Having Prepended Project Element',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There exists prepended task number having ''-'' in pa_proj_elements table.
This could lead to a mismatch between task structures and workplan structure.',
      p_solution               => 'Download the Generic data fix patch appropriate for your application release as described in [351670/PALRT1517].<br>
Apply the datafix according to the README instructions.',
      p_success_msg            => 'No Corruption exists.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: PA_PROJ_ELEMENTS_PREPENDED_TASK');



debug('begin add_signature: PA_PROJECT_NO_MANAGER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13921',
      p_sig_id                 => 'PA_PROJECT_NO_MANAGER',
      p_sig_sql                => 'SELECT project_id,
       project_role_type,
       person_id,
       resource_id,
...
AND   project_role_type = ''PROJECT MANAGER''',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The project does not have the Project Manager role assigned to a project team member.',
      p_solution               => 'Assign the Project Manager role to the project as per [2635694/KB659109].',
      p_success_msg            => 'Project Manager detail for the project.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PROJECT_NO_MANAGER');
...
debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_NON_UNIQUE_TASKS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26679',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_NON_UNIQUE_TASKS',
      p_sig_sql                => 'SELECT ppe.project_id,  ppe.proj_element_id task_id,  ppe.element_number task_number
FROM pa_proj_elements ppe
WHERE (ppe.project_id,SUBSTR(ppe.element_number,1,25)) IN
  (SELECT ppe1.project_id,
    SUBSTR(ppe1.element_number,1,25)
  FROM pa_proj_elements ppe1,    pa_proj_workplan_attr ppwa,    pa_proj_structure_types ppst,    pa_structure_types pst,
    pa_proj_elem_ver_structure ppevs,    pa_proj_element_versions ppev
  WHERE ppe1.project_id=    ##$$PROJECT_ID$$##
AND ppe1.project_id                 =ppwa.project_id
AND ppwa.proj_element_id            =ppst.proj_element_id
AND ppst.structure_type_id          =pst.structure_type_id
AND ppwa.wp_enable_version_flag     =''Y''
AND pst.structure_type_class_code   =''WORKPLAN''
AND ppevs.proj_element_id           =ppwa.proj_element_id
AND ppevs.current_working_flag      =''Y''
AND ppevs.status_code              <>''STRUCTURE_PUBLISHED''
AND ppe1.object_type                =''PA_TASKS''
AND ppe1.link_task_flag             =''N''
AND ppev.project_id                 =ppe1.project_id
AND ppev.proj_element_id            =ppe1.proj_element_id
AND ppev.parent_structure_version_id=ppevs.element_version_id
AND ppev.financial_task_flag        =''Y''
  GROUP BY ppe1.project_id,
    SUBSTR(ppe1.element_number,1,25)
  HAVING COUNT(*)>1)',
      p_title                  => 'Non-Unique Tasks For The Project',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Non-unique tasks exist for the project.',
      p_solution               => 'Follow the solution in [2569090/KB198750] Workplan Publish Error Please Enter A Unique Number To Identify The Task.',
      p_success_msg            => 'There are not any non-unique tasks for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_NON_UNIQUE_TASKS');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_PA_PROGRESS_PUB_ORA_01427');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29800',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_PA_PROGRESS_PUB_ORA_01427',
      p_sig_sql                => 'Select project_id from pa_proj_elem_ver_structure
where latest_eff_published_flag = ''Y''
and proj_element_id in (Select proj_element_id
  from pa_proj_structure_types
  where structure_type_id = 1)
and element_version_id in (select project_structure_version_id
  from pa_budget_versions
  where wp_version_flag = ''Y'')
group by project_id
having count(1) > 1',
      p_title                  => 'Data Corruption Results in Performance Data Error ORA-01427',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'PRC: Update Project Performance Data results in error:<br><br>
Error<br>
--------------------<br>
ORA-01427: single-row subquery returns more than one row in Package PA_PROGRESS_PUB Procedure GET_SUMMARIZED_ACTUALS',
      p_solution               => 'Please log Service Request along with analyzer output to get possible data fix.<br><br>

Follow the solution in [3002025/KB324249] PJI_PJP_SUMMARIZE_INCR: PRC: Update Project Performance Data Completed With Error ORA-01427 in Package PA_PROGRESS_PUB Procedure GET_SUMMARIZED_ACTUALS.',
      p_success_msg            => 'No data corruption exists when running PRC: Update Project Performance Data.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_PA_PROGRESS_PUB_ORA_01427');
...
debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_COST_BREAKDOWN_STRUCTURE_HIERARCHY_DETAIL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26941',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_COST_BREAKDOWN_STRUCTURE_HIERARCHY_DETAIL',
      p_sig_sql                => 'SELECT
    *
FROM
    pa_cbs_hierarchy cbsh',
      p_title                  => 'Cost Breakdown Structure Hierarchy Detail (PA_CBS_HIERARCHY)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Cost Breakdown Structure Hierarchy Detail',
      p_solution               => '',
      p_success_msg            => 'Cost Breakdown Structure Hierarchy  detail not Exists.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_COST_BREAKDOWN_STRUCTURE_HIERARCHY_DETAIL');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_COST_BREAKDOWN_STRUCTURE_TASK_DETAIL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26943',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_COST_BREAKDOWN_STRUCTURE_TASK_DETAIL',
      p_sig_sql                => 'SELECT
    *
FROM
    pa_alternate_tasks
where 
PROJ_ELEMENT_ID IN (SELECT PROJ_ELEMENT_ID
                                               FROM PA_PROJ_ELEMENTS
                                           WHERE PROJECT_ID = ##$$PROJECT_ID$$##)',
      p_title                  => 'Cost Breakdown Structure Task Detail (PA_ALTERNATE_TASKS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Cost Breakdown Structure Task Detail',
      p_solution               => '',
      p_success_msg            => 'Cost Breakdown Structure Tasks not Exists.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_COST_BREAKDOWN_STRUCTURE_TASK_DETAIL');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_COST_BREAK_DOWN_STRUCTURE_DETAIL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26929',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_COST_BREAK_DOWN_STRUCTURE_DETAIL',
      p_sig_sql                => 'SELECT
    cbs_enable_flag
FROM
    pa_projects_all
WHERE
    cbs_enable_flag = ''Y''
AND PROJECT_ID = ##$$PROJECT_ID$$##',
      p_title                  => 'Cost Break Down Structure Enabled for Project',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Cost break down structure is not enabled .',
      p_solution               => 'Follow the [2008430/KB357359] to change the Cost Break Down  Structure setup.<br>
<strong>Note:</strong> Before modifying ,check with business regarding Cost break down structure feature.<br>',
      p_success_msg            => 'Cost break down structure is  enabled ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_COST_BREAK_DOWN_STRUCTURE_DETAIL');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_PERFORMANCE_OBLIGATIONS_DETAIL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26932',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_PERFORMANCE_OBLIGATIONS_DETAIL',
      p_sig_sql                => 'SELECT
    pobg_flag
FROM
    pa_projects_all
...
AND PROJECT_ID = ##$$PROJECT_ID$$##
',
      p_title                  => 'Performance Obligations Detail',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Performance Obligations  is not enabled .',
      p_solution               => '',
      p_success_msg            => 'Performance Obligations is enabled.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_PERFORMANCE_OBLIGATIONS_DETAIL');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_PERFORMANCE_OBLIGATIONS_LINES_DETAIL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26935',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_PERFORMANCE_OBLIGATIONS_LINES_DETAIL',
      p_sig_sql                => 'SELECT * FROM (SELECT prp.object_id ,
  prp.line_number ,
  prp.quantity,
  prp.percent,
  (
  ...
  (
  CASE
    WHEN percent IS NULL
    THEN total_value
    ELSE NULL
  END) total_quantity,
  cumulative_quantity cumulative_progress_qty ,
  cumulative_percent cumulative_progress_percent,
  cumulative_progress_amt cumulative_rev_amt ,
  as_of_date ,
  prp.project_id,
  pa_perf_obligation_pvt.get_pobg_number(prp.object_id) AS pobg_line_num ,
  ppe.currency
FROM pa_proj_rev_progress prp,
  pa_proj_elements ppe
WHERE ppe.project_id    = prp.project_id
AND ppe.proj_element_id = prp.object_id
AND prp.object_type     =''POBG'') QRSLT  WHERE project_id = ##$$PROJECT_ID$$##  ORDER BY line_number desc',
      p_title                  => 'Performance Obligations Lines Detail',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Performance Obligations Lines  not created',
      p_solution               => '',
      p_success_msg            => 'Performance Obligations Lines Detail',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_PERFORMANCE_OBLIGATIONS_LINES_DETAIL');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_PERFORMANCE_OBLIGATIONS_PERIODIC_SPLIT_DETAIL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26936',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_PERFORMANCE_OBLIGATIONS_PERIODIC_SPLIT_DETAIL',
      p_sig_sql                => 'select * from PA_SOV_PERIODIC_SPLIT where Project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Performance Obligations Periodic Split Detail (PA_SOV_PERIODIC_SPLIT)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Performance Obligations Periodic Split Detail.',
      p_solution               => '',
      p_success_msg            => 'Performance Obligations Periodic Split  not exists.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_PERFORMANCE_OBLIGATIONS_PERIODIC_SPLIT_DETAIL');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_SCHEDULE_OF_VALUE_ACTIVITIES_DETAIL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26937',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_SCHEDULE_OF_VALUE_ACTIVITIES_DETAIL',
      p_sig_sql                => 'SELECT
    *
FROM
    pa_sov_activities where Project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Schedule of Value Activities Detail',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Schedule of Value Activities Detail.',
      p_solution               => '',
      p_success_msg            => 'Schedule of Value Activities detail not Exists.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_SCHEDULE_OF_VALUE_ACTIVITIES_DETAIL');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_SCHEDULE_OF_VALUE_DETAIL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26930',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_SCHEDULE_OF_VALUE_DETAIL',
      p_sig_sql                => 'SELECT proj_sov_level "SOV Status", proj_sov_frm_cntrt_flag "SOV Contract Status"
FROM
    pa_projects_all
WHERE
    proj_sov_level = ''Y''
AND PROJECT_ID = ##$$PROJECT_ID$$##    ',
      p_title                  => 'Schedule of Value  And Schedule of Value From Contract Detail',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Schedule of value  is not enabled .',
      p_solution               => 'Follow the [2313127/KB482136] to setup  the Schedule of value. feature<br>
<strong>Note:</strong> Before modifying ,check with business regarding  Schedule of value feature.<br>',
      p_success_msg            => 'Schedule of value is enabled.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_SCHEDULE_OF_VALUE_DETAIL');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_SCHEDULE_OF_VALUE_LINE_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26934',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_SCHEDULE_OF_VALUE_LINE_DETAILS',
      p_sig_sql                => 'SELECT * FROM (select 
 a.record_version_number record_version_number,
 a.object_type object_type,
 a.project_id project_id ,
 b.proj_element_id  proj_element_id,
 a.element_number sov_line_number,
 a.name sov_line_name,
 a.DESCRIPTION sov_line_description,
 b.parent_structure_version_id  parent_structure_version_id,
 a.parent_structure_id parent_structure_id,
 b.element_version_id element_version_id,
 a.SOV_UOM UOM,
 b.qty quantity,
 b.rate rate,
 b.change_reason change_order,
 b.co_ref change_order_ref,
 a.retainage retainage,
 a.spread_curve_id spread_curve_id,
 (PA_MANAGE_SOV_PVT.DELETE_SOV_LINE_FLAG(a.project_id, b.proj_element_id)) DELETE_FLAG,
 (PA_MANAGE_SOV_PVT.CHK_SOVLINE_PUB(a.project_id, a.proj_element_id)) SOVL_PUB,
 ''N'' AS SELECTED
 , a.pa_sov_line_etcmethod ETC_Method 
 , ppevs.status_code status_code
 , a.multiselect_act multiselect_act
, ppevs.latest_eff_published_flag latest_eff_published_flag
, a.contract_line_id contract_line_id
, ''detailsicon_enabled.gif'' as details_image_source
, ''ARRDetailsOn'' sov_arrdetail_flag
, (select meaning from PA_LOOKUPS where LOOKUP_TYPE = ''UNIT'' and LOOKUP_CODE = a.SOV_UOM) uom_meaning
, nvl(a.multiple_arr_flag, ''Y'') multiple_arr_flag
, nvl(b.SELLING_PRICE, b.rate) SELLING_PRICE
, pobg_progr.quantity Progr_Qty
from pa_proj_elements a
 , pa_proj_element_versions b
 , pa_proj_elem_ver_structure ppevs
 , ( SELECT project_id, OBJECT_ID, sum(quantity) quantity
			from PA_PROJ_REV_PROGRESS
			where OBJECT_TYPE = ''POBG''
			group by project_id, OBJECT_ID
			)POBG_PROGR
 where a.project_id = b.project_id 
 and a.proj_element_id = b.proj_element_id  
 and b.object_type = ''PA_SOV_LINES'' 
 and b.PARENT_STRUCTURE_VERSION_ID = ppevs.element_version_id 
 and ppevs.project_id = a.project_id
and POBG_PROGR.OBJECT_ID(+) = a.proj_element_id 
and POBG_PROGR.project_id(+) = a.PROJECT_ID
order by sov_line_number) QRSLT  WHERE (PROJECT_ID = ##$$PROJECT_ID$$##  AND latest_eff_published_flag = ''Y'')',
      p_title                  => 'Schedule of Value Line Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Schedule of value lines not created  ',
      p_solution               => '',
      p_success_msg            => 'Schedule of Value Line Details',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_SCHEDULE_OF_VALUE_LINE_DETAILS');



debug('begin add_signature: EBS_FIN_PA_PAWORKPLAN_SCHEDULE_OF_VALUE_TASK_DENORM_DETAIL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26938',
      p_sig_id                 => 'EBS_FIN_PA_PAWORKPLAN_SCHEDULE_OF_VALUE_TASK_DENORM_DETAIL',
      p_sig_sql                => 'SELECT
    *
FROM
    pa_sov_tasks_denorm where Project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Schedule of Value Task Denorm Detail (PA_SOV_TASKS_DENORM)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Schedule of Value Task Denorm Detail',
      p_solution               => '',
      p_success_msg            => 'Schedule of Value Task Denorm detail not Exists.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAWORKPLAN_SCHEDULE_OF_VALUE_TASK_DENORM_DETAIL');



debug('begin add_signature: EBS_FIN_PA_BUDGET_VERSIONS_12_2_10HIGHER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30968',
      p_sig_id                 => 'EBS_FIN_PA_BUDGET_VERSIONS_12_2_10HIGHER',
      p_sig_sql                => '    
...
ver.est_equipment_quantity, ver.etc_start_date, ver.purged_flag, ver.olap_change_flag,  ver.max_planning_date, ver.min_planning_date, ver.moved_flag
...
',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_BUDGET_VERSIONS_12_2_10HIGHER');
...
BEGIN
  ...
  analyzer_title := 'Project Planning and Control Analyzer';
...
debug('begin section: ProjectDetails');
start_section('Project Details', 'ProjectDetails');
   set_item_result(run_stored_sig('PA_PROJECTS_ALL'));
   set_item_result(run_stored_sig('PA_TASKS'));
   set_item_result(run_stored_sig('PA_PROJ_ELEMENTS'));
   set_item_result(run_stored_sig('PA_PROJECT_KEY_MEMBERS_ROLES'));
   set_item_result(run_stored_sig('PA_WP_PROJECT_CUSTOMERS'));
   set_item_result(run_stored_sig('PA_PROJ_ELEMENT_VERSIONS'));
   set_item_result(run_stored_sig('PA_OBJECT_RELATIONSHIPS'));
   set_item_result(run_stored_sig('PA_PROJ_ELEM_VER_STRUCTURE'));
   set_item_result(run_stored_sig('PA_PROJECT_AS_PROGRAM'));
   set_item_result(run_stored_sig('PA_DC_PA_PROJ_ELEM_VER_SCHEDULE'));
end_section;
debug('end section: ProjectDetails');

debug('begin section: ResourceDetails');
start_section('Resource Management Details', 'ResourceDetails');
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_PA_RBS_VERSIONS_B'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_WP_RESOURCE_TXN_ATTRIBUTES'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_WP_COMPETENCE_PROFILE'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_WP_PA_RES_AVAILABILITY'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_WP_RESOURCE_ASSIGNMENT_DETAIL'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_WP_RESOURCE_DENORM'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_PERSON'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_PERSON_TYPE'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_ASSIGNMENT'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_JOB'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_PERIOD_OF_PLACEMENT'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_PERIOD_OF_SERVICES'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_WP_RESOURCES'));
end_section;
debug('end section: ResourceDetails');

debug('begin section: ExpenditureDetails');
start_section('Expenditure Details', 'ExpenditureDetails');
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_EXPENDITURES'));
   set_item_result(run_stored_sig('PA_EXPENDITURE_ITEMS_ALL_WP'));
   set_item_result(run_stored_sig('PA_EXPENDITURE_ITEMS_ALL_ND'));
end_section;
debug('end section: ExpenditureDetails');

debug('begin section: WorkplanDetails');
start_section('Workplan Details', 'WorkplanDetails');
   set_item_result(run_stored_sig('PA_PROJ_WORKPLAN_ATTR'));
   set_item_result(run_stored_sig('PA_PROGRESS_ROLLUP'));
   set_item_result(run_stored_sig('PA_PROJ_PROGRESS_ATTR'));
   set_item_result(run_stored_sig('PA_PERCENT_COMPLETES'));
   set_item_result(run_stored_sig('PA_WORKPLAN_PUBLISHED_VERSION_STATUS'));
   set_item_result(run_stored_sig('PA_WORKPLAN_WORKFLOW_STATUS'));
   set_item_result(run_stored_sig('PA_WORKPLAN_WORKING_VERSION_LOCK_STATUS'));
   set_item_result(run_stored_sig('PA_WP_PROJECTS_HAVING_REPORTING_DATA'));
   set_item_result(run_stored_sig('PA_DC_PROJECT_DELIVERABLES'));
   IF substr(g_rep_info('Apps Version'),1,6) >= '12.2.8' THEN
      set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_COST_BREAKDOWN_STRUCTURE_HIERARCHY_DETAIL'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_COST_BREAKDOWN_STRUCTURE_TASK_DETAIL'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_COST_BREAK_DOWN_STRUCTURE_DETAIL'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_PERFORMANCE_OBLIGATIONS_DETAIL'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_PERFORMANCE_OBLIGATIONS_LINES_DETAIL'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_PERFORMANCE_OBLIGATIONS_PERIODIC_SPLIT_DETAIL'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_SCHEDULE_OF_VALUE_ACTIVITIES_DETAIL'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_SCHEDULE_OF_VALUE_DETAIL'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_SCHEDULE_OF_VALUE_LINE_DETAILS'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_SCHEDULE_OF_VALUE_TASK_DENORM_DETAIL'));
   END IF;
end_section;
debug('end section: WorkplanDetails');

debug('begin section: BudgetandForecastDetails');
start_section('Budget and Forecast Details', 'BudgetandForecastDetails');
   set_item_result(run_stored_sig('PA_RESOURCE_LIST_MEMBERS'));
   set_item_result(run_stored_sig('PA_RESOURCE_LISTS_ALL'));
   IF substr(g_rep_info('Apps Version'),1,7) >= '12.2.10' THEN
      set_item_result(run_stored_sig('EBS_FIN_PA_BUDGET_VERSIONS_12_2_10HIGHER'));
   END IF;
   IF substr(g_rep_info('Apps Version'),1,7) < '12.2.10' THEN
      set_item_result(run_stored_sig('PA_BUDGET_VERSIONS'));
   END IF;
   set_item_result(run_stored_sig('PA_BUDGET_LINES'));
   set_item_result(run_stored_sig('PA_ETC_METHOD_CODE_SPREAD_CURVE_CODE'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_BUDGET_ENTRY_METHOD'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_FINPLAN_AMOUNT_SETS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_FIN_PLAN_TYPE_B'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_FP_TXN_CURRENCIES'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_RESOURCE_ASSIGNMENTS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_RES_CLASSES'));
end_section;
debug('end section: BudgetandForecastDetails');

debug('begin section: SetupDetails');
start_section('Setup Details', 'SetupDetails');
   set_item_result(run_stored_sig('PA_CURRENT_REPORTING_PERIOD'));
   set_item_result(run_stored_sig('PA_STRUCTURE_TYPES'));
   set_item_result(run_stored_sig('PA_PROJ_STRUCTURE_TYPES'));
   set_item_result(run_stored_sig('PA_TASK_TYPES'));
   set_item_result(run_stored_sig('PA_PROJ_PERIOD_PROFILES PERIODS'));
   set_item_result(run_stored_sig('WORKPLAN_FINANCIAL_PLAN_SHARING'));
   set_item_result(run_stored_sig('PA_PROJ_FP_OPTIONS'));
   set_item_result(run_stored_sig('PA_FINANCIAL_STRUCTURE_STATUS'));
   set_item_result(run_stored_sig('PA_PERIODS_ALL'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_PJI_TIME_CAL_PERIOD'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_PERIOD_MASKS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_PERIOD_MASK_DETAILS'));
end_section;
debug('end section: SetupDetails');

debug('begin section: PerformanceDetails');
start_section('Performance and Performance Reporting Details', 'PerformanceDetails');
   set_item_result(run_stored_sig('PA_GATHER_STATS_RUN'));
   set_item_result(run_stored_sig('PA_TABLESPACE_ISSUE'));
   set_item_result(run_stored_sig('PA_STALE_TABLE_STATS'));
   set_item_result(run_stored_sig('PA_OBJECT_LOCK'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_FINANCIAL_PLAN_ORIGINAL_AND_CURRENT_BASELINE_FACT_DATA'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_PA_XBS_DENORM'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_PJI_FP_XBS_ACCUM_F'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_PJI_ORG_EXTR_INFO'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_PJI_PJP_PROJ_BATCH_MAP'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_PJI_PJP_RBS_HEADER'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_PJI_PJP_WBS_HEADER'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_PJI_SYSTEM_CONFIG_HIST'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_PROJECT_RBS_SETUP'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_STRUCTURE_LEVEL_FACT_DATA'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_WP_PJI_SYSTEM_PRC_STATUS'));
end_section;
debug('end section: PerformanceDetails');

debug('begin section: DataErrors');
start_section('Data Errors', 'DataErrors');
   set_item_result(run_stored_sig('PA_WORKPLAN_STRUCTURE_STATUS'));
   set_item_result(run_stored_sig('PA_WORKPLAN_VERSIONING_STATUS'));
   set_item_result(run_stored_sig('PA_FND_CONCURRENT_REQUESTS'));
   ...
   set_item_result(run_stored_sig('PA_WP_MISSING_TASKS'));
   set_item_result(run_stored_sig('PA_WP_PUBLISH_PARENT_TASK_CHARGEABLE'));
   set_item_result(run_stored_sig('PA_WP_PUBLISH_TASK_EXISTS'));
   set_item_result(run_stored_sig('PA_WP_EI_INVALID_START_DATE_TASK'));
   set_item_result(run_stored_sig('PA_WP_EI_INVALID_END_DATE_TASK'));
   set_item_result(run_stored_sig('PA_WP_MISSING_TASKS_WORKPLAN_ATTRIBUTES'));
   set_item_result(run_stored_sig('PA_WP_MISSING_EXCHANGE_RATE_COST_RATE'));
   set_item_result(run_stored_sig('PA_PROJ_ELEMENTS_PREPENDED_TASK'));
   set_item_result(run_stored_sig('PA_PROJECT_NO_MANAGER'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_TASK_FUNDING_NOT_EQUAL_BUDGET'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_NON_UNIQUE_TASKS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAWORKPLAN_PA_PROGRESS_PUB_ORA_01427'));
end_section;
