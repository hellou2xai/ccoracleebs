...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Order to Cash E-Business Tax Analyzer  |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE o2c_ebtax_analyzer_pkg AUTHID DEFINER AS
...
(            p_user_name                    IN VARCHAR2    DEFAULT NULL
           ...
           ,p_co_id                        IN NUMBER      DEFAULT NULL
           ,p_tax1                         IN VARCHAR2    DEFAULT NULL
           ,p_customer_trx_id              IN VARCHAR2    DEFAULT NULL
...
END o2c_ebtax_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY o2c_ebtax_analyzer_pkg AS
-- $Id: o2c_ebtax_analyzer.sql, 200.12 2025/12/08 13:36:19 jdhincks Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2543707.1));
...
--PARAMETER RELATED
  ...
  g_user_name        VARCHAR(50)  := NULL;
  g_resp_id          NUMBER       := NULL;
  g_tax_regime       VARCHAR(50)  := NULL;
  g_co_id            NUMBER       := NULL;
  g_tax              VARCHAR2(30) := NULL;
  g_customer_trx_id  NUMBER       := NULL;



--REGIME RELATED
  
  g_party_id             NUMBER       := NULL; --(PRTYID)
  g_country_code         VARCHAR(5)   := NULL; --(COUNTRYCODE)
  g_ledger_id            NUMBER       := NULL; --(LEDGERID)
  g_ledger_currency      VARCHAR2(200);
  g_username             VARCHAR(30)  := NULL; --(USERNAME)
  g_period_name          VARCHAR(30)  := NULL; --(PERIODNAME)
  g_transaction_view     VARCHAR(30)  := NULL; --(TRXVIEW)
  g_i_view               VARCHAR(30)  := NULL; --(IVIEW)
  g_release              NUMBER       := NULL; --(REL)
  g_org_id               NUMBER       := NULL; --(ORGID)
  g_ou_name              VARCHAR(240) := NULL; --(OPERATING_UNIT)
  g_period_tmp           VARCHAR(30)  := NULL; --(GL_PERIOD)
  g_resp_name            VARCHAR(240) := NULL; --(RESPNAME)
  g_sysparam_sob_id      NUMBER       := NULL; --new 10-APR-19
  g_view_options_code    VARCHAR(30)  := NULL; --new 10-APR-19
  g_party_tax_profile_id NUMBER       := NULL; --new 10-APR-19 
  g_parent_pty_org_id    NUMBER       := NULL; --new 10-APR-19
  g_subscriber_flag      VARCHAR(30)  := NULL; --new 10-APR-19
  g_lookup_type		 VARCHAR(30)  := NULL; --new 10-APR-19
  g_lookup_code		 VARCHAR(30)  := NULL; --new 10-APR-19
  g_party_type_code	 VARCHAR(30)  := NULL; --new 10-APR-19
  g_sysdate		 DATE         := NULL; --new 10-APR-19
  g_start_date_active    DATE         := NULL; --new 10-APR-19
  g_end_date_active	 DATE         := NULL; --new 10-APR-19
  g_meaning		 VARCHAR(50)  := NULL; --new 10-APR-19


-- for transaction summary


g_trx_id            VARCHAR2(200);
g_trxnumber         VARCHAR2(200);
g_custref           VARCHAR2(200);
g_source            VARCHAR2(200);  -- transaction type name
g_typename          VARCHAR2(200);  
g_type               VARCHAR2(20);  -- transaction class
g_trxdate           VARCHAR2(200); 
g_complete_flag      VARCHAR2(1);
g_currency          VARCHAR2(200); 
g_exchrate          VARCHAR2(200);
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'O2C_EBTAX_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'O2C_EBTAX_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>O2C_EBTAX Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2543707.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/o2c_ebtax_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1674,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1674,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1674,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4268646" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">1674</span>
...
<div>What&apos;s new:</div>
<ul><li>Added signatures to check for sequences with 70% of max value and large cache size</li>
</ul>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1674,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1674,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1674,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
debug('begin populate parameters hash table');
   ...
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Tax  Regime';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_tax_regime,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Content Owner Id';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_co_id,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Tax';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_tax1,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Customer Trx Id';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_customer_trx_id,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  l_revision := rtrim(replace('$Revision: 200.12  $','$',''));
  l_revision := ltrim(replace(l_revision,'Revision:',''));
  l_date_char := rtrim(replace('$Date: 2025/12/08 13:36:17 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'o2c_ebtax_analyzer.sql';
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Responsibility.');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
debug('begin parameter validation: p_tax_regime');
IF p_tax_regime IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Tax  Regime is required.');
   raise invalid_parameters;
END IF;
IF p_tax_regime IS NOT NULL THEN
BEGIN
SELECT TAX_REGIME_CODE
INTO l_exists_val
FROM ZX_REGIMES_V 
WHERE TAX_REGIME_CODE = p_tax_regime
 AND HAS_SUB_REGIME_FLAG <> 'Y' 
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Tax Regime code.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_tax_regime failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_tax_regime');

debug('begin parameter validation: p_co_id');
IF p_co_id IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Content Owner Id is required.');
   raise invalid_parameters;
END IF;
IF p_co_id IS NOT NULL THEN
BEGIN
SELECT ZFPOMV.PARTY_TAX_PROFILE_ID
INTO l_exists_val
FROM ZX_SUBSCRIPTION_DETAILS ZSD, ZX_FIRST_PARTY_ORGS_ALL_V ZFPOMV, FND_LOOKUPS FL
WHERE ZFPOMV.PARTY_TAX_PROFILE_ID = p_co_id
 AND ZSD.TAX_REGIME_CODE like p_tax_regime
AND ZSD.VIEW_OPTIONS_CODE = 'VFC'  
AND ZFPOMV.PARTY_TAX_PROFILE_ID = ZSD.PARENT_FIRST_PTY_ORG_ID 
AND (ZFPOMV.USE_LE_AS_SUBSCRIBER_FLAG IS NULL OR  ZFPOMV.USE_LE_AS_SUBSCRIBER_FLAG ='N')  
AND FL.LOOKUP_TYPE = 'ZX_PTP_PARTY_TYPE'  
AND FL.LOOKUP_CODE = ZFPOMV.PARTY_TYPE_CODE  
AND SYSDATE BETWEEN FL.START_DATE_ACTIVE AND NVL(FL.END_DATE_ACTIVE, SYSDATE)
AND NVL(FL.ENABLED_FLAG, 'N') = 'Y' 
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Content Owner Id.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_co_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_co_id');

debug('begin parameter validation: p_tax1');
IF p_tax1 IS NOT NULL THEN
BEGIN
SELECT TAX
INTO l_exists_val
FROM ZX_TAXES_B 
WHERE TAX = p_tax1
 AND UPPER(TAX_REGIME_CODE) = upper(p_tax_regime)
AND CONTENT_OWNER_ID = nvl(p_co_id, CONTENT_OWNER_ID)
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Tax.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_tax1 failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_tax1');

debug('begin parameter validation: p_customer_trx_id');
IF p_customer_trx_id IS NOT NULL THEN
BEGIN
SELECT TRX.CUSTOMER_TRX_ID
INTO l_exists_val
FROM ZX_LINES ZX, RA_CUSTOMER_TRX_ALL TRX, HR_OPERATING_UNITS O
WHERE TRX.CUSTOMER_TRX_ID = p_customer_trx_id
 AND ZX.TAX_REGIME_CODE = p_tax_regime
and trx.org_id = o.organization_id
and (mo_global.is_mo_init_done = 'N' 
     or mo_global.check_access(o.organization_id) = 'Y')
and zx.trx_id = trx.customer_trx_id
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid transaction number.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_customer_trx_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_customer_trx_id');
...
-- set up global variables to hold parameter values
g_user_name          := p_user_name;
g_resp_id            := p_resp_id;
g_tax_regime         := p_tax_regime;
g_co_id              := p_co_id;
g_customer_trx_id    := p_customer_trx_id;
g_tax                := p_tax1;

print_log('START of Additional Validation code');

BEGIN
 
   if g_customer_trx_id is not null then

      -- collect data for customer signatures 
      -- given the customer_trx_id, retrieve the party_id and party_site_id
      ...
      begin   
         ...
         -- collect the party_tax_profile_id for the party_id retrieved
         begin

            select party_tax_profile_id
            into g_party_tax_profile_id
            from ZX_PARTY_TAX_PROFILE
            where party_id = g_party_id; 

         exception
         when no_data_found then
            g_party_tax_profile_id := NULL;
            print_log('Unable to retrieve g_party_tax_profile_id.');
         end;

      exception
      when no_data_found then
          g_party_id := NULL;
          print_log('Unable to retrieve g_party_id.');
      end;

      begin
      -- collect transaction summary information
         select trx.org_id,
             to_char(trx.customer_trx_id), 
             trx.trx_number,
         ...
         FROM   RA_CUSTOMER_TRX_ALL   trx,          
                ...
                RA_TERMS              pay,          
                RA_RULES              rul  
         WHERE  trx.customer_trx_id = g_customer_trx_id
         ...
         print_log('Retrieved Transaction Summary Information.');     

     exception
     when no_data_found then
         print_log('Unable to retrieve Transaction Summary Information.');       
     end;

     begin
        -- collect the ledger_id for General Ledger information

        select ar.set_of_books_id, hr.name
        into g_ledger_id, g_ou_name
        from ar_system_parameters_all ar, hr_operating_units hr
        where ar.org_id = g_org_id
        and   ar.org_id = hr.organization_id;

        print_log('Retrieved Ledger and Operating Unit information.');    

     exception
     when no_data_found then
        print_log('Unable to retrieve Ledger and Operating Unit information.');       
     end;
   end if;
END;
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$PRTYID$$##') := g_party_id;
   g_masked_tokens('##$$PRTYID$$##') := mask_text( g_sql_tokens('##$$PRTYID$$##'), 'NO_MASK');
   g_sql_tokens('##$$COUNTRYCODE$$##') :=  g_country_code;
   ...
   g_sql_tokens('##$$USERNAME$$##') := g_username;
   g_masked_tokens('##$$USERNAME$$##') := mask_text( g_sql_tokens('##$$USERNAME$$##'), 'DISPLAY_BOTH_25_PCNT_WORD');
   g_sql_tokens('##$$PERIODNAME$$##') := g_period_name;
   g_masked_tokens('##$$PERIODNAME$$##') := mask_text( g_sql_tokens('##$$PERIODNAME$$##'), 'NO_MASK');
   g_sql_tokens('##$$TRXVIEW$$##') := g_transaction_view;
   g_masked_tokens('##$$TRXVIEW$$##') := mask_text( g_sql_tokens('##$$TRXVIEW$$##'), 'NO_MASK');
   g_sql_tokens('##$$IVIEW$$##') := g_i_view;
   g_masked_tokens('##$$IVIEW$$##') := mask_text( g_sql_tokens('##$$IVIEW$$##'), 'NO_MASK');
   g_sql_tokens('##$$REL$$##') := g_release;
   ...
   g_sql_tokens('##$$CO_ID$$##') := g_co_id;
   g_masked_tokens('##$$CO_ID$$##') := mask_text( g_sql_tokens('##$$CO_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$TAXREGIME$$##') := g_tax_regime;
   g_masked_tokens('##$$TAXREGIME$$##') := mask_text( g_sql_tokens('##$$TAXREGIME$$##'), 'NO_MASK');
   g_sql_tokens('##$$TAX$$##') := g_tax;
   g_masked_tokens('##$$TAX$$##') := mask_text( g_sql_tokens('##$$TAX$$##'), 'NO_MASK');
   g_sql_tokens('##$$TRXID$$##') := g_customer_trx_id;
   g_masked_tokens('##$$TRXID$$##') := mask_text( g_sql_tokens('##$$TRXID$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPSCHECK$$##') := p_apps_check;
   g_masked_tokens('##$$APPSCHECK$$##') := mask_text( g_sql_tokens('##$$APPSCHECK$$##'), 'NO_MASK');
   g_sql_tokens('##$$TRX_ID$$##') := g_trx_id;
   g_masked_tokens('##$$TRX_ID$$##') := mask_text( g_sql_tokens('##$$TRX_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$TRXNUMBER$$##') := g_trxnumber;
...
debug('begin add_signature: AR_EBTAX_SETUP_TAX_REGIME');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12526',
      p_sig_id                 => 'AR_EBTAX_SETUP_TAX_REGIME',
      p_sig_sql                => 'SELECT ZxRegimesB.TAX_REGIME_CODE, ZxRegimesB.PARENT_REGIME_CODE, ZxRegimesB.HAS_SUB_REGIME_FLAG, ZxRegimesB.COUNTRY_OR_GROUP_CODE, ZxRegimesB.COUNTRY_CODE, ZxRegimesB.GEOGRAPHY_TYPE, ZxRegimesB.EFFECTIVE_FROM, ZxRegimesB.EFFECTIVE_TO, ZxRegimesB.EXCHANGE_RATE_TYPE, ZxRegimesB.TAX_CURRENCY_CODE, ZxRegimesB.THRSHLD_GROUPING_LVL_CODE, ZxRegimesB.ROUNDING_RULE_CODE, ZxRegimesB.TAX_PRECISION, ZxRegimesB.MINIMUM_ACCOUNTABLE_UNIT, ZxRegimesB.TAX_STATUS_RULE_FLAG, ZxRegimesB.DEF_PLACE_OF_SUPPLY_TYPE_CODE, ZxRegimesB.APPLICABILITY_RULE_FLAG, ZxRegimesB.PLACE_OF_SUPPLY_RULE_FLAG, ZxRegimesB.TAX_CALC_RULE_FLAG, ZxRegimesB.TAXABLE_BASIS_THRSHLD_FLAG, ZxRegimesB.TAX_RATE_THRSHLD_FLAG, ZxRegimesB.TAX_AMT_THRSHLD_FLAG, ZxRegimesB.TAX_RATE_RULE_FLAG, ZxRegimesB.TAXABLE_BASIS_RULE_FLAG, ZxRegimesB.DEF_INCLUSIVE_TAX_FLAG, ZxRegimesB.HAS_OTHER_JURISDICTIONS_FLAG, ZxRegimesB.ALLOW_ROUNDING_OVERRIDE_FLAG, ZxRegimesB.ALLOW_EXEMPTIONS_FLAG, ZxRegimesB.ALLOW_EXCEPTIONS_FLAG, ZxRegimesB.ALLOW_RECOVERABILITY_FLAG, ZxRegimesB.AUTO_PRVN_FLAG, ZxRegimesB.HAS_TAX_DET_DATE_RULE_FLAG, ZxRegimesB.HAS_EXCH_RATE_DATE_RULE_FLAG, ZxRegimesB.HAS_TAX_POINT_DATE_RULE_FLAG, ZxRegimesB.USE_LEGAL_MSG_FLAG, ZxRegimesB.REGN_NUM_SAME_AS_LE_FLAG, ZxRegimesB.DEF_REC_SETTLEMENT_OPTION_CODE, ZxRegimesB.RECORD_TYPE_CODE, ZxRegimesB.TAX_REGIME_ID, ZxRegimesB.GEOGRAPHY_ID, ZxRegimesB.THRSHLD_CHK_TMPLT_CODE, ZxRegimesB.PERIOD_SET_NAME, ZxRegimesB.REP_TAX_AUTHORITY_ID, ZxRegimesB.COLL_TAX_AUTHORITY_ID  FROM ZX_REGIMES_B ZxRegimesB where TAX_REGIME_CODE = ''##$$TAXREGIME$$##''',
      p_title                  => 'Tax Regime',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no information found for the tax regime (##$$TAXREGIME$$##). ',
      p_solution               => 'Review the definition for this tax regime (##$$TAXREGIME$$##).
Review [1133994.1] R12: Ebtax: How Location Based Tax Works in R12 E-Business Tax (EBTax) - Includes sample setup for more information.',
      p_success_msg            => 'Displaying information for this tax regime (##$$TAXREGIME$$##).',
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_SETUP_TAX_REGIME');



debug('begin add_signature: AR_EBTAX_SETUP_TAX_REGIME_SUBCRIPTIONS');
   l_info('##MASK##ADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PARTY_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SERVICE_PROVIDER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12548',
      p_sig_id                 => 'AR_EBTAX_SETUP_TAX_REGIME_SUBCRIPTIONS',
      p_sig_sql                => 'SELECT * FROM 
(SELECT SubscriptionOptionEO.REGIME_USAGE_ID, 
pty.party_name, 
pty.party_type_code, 
pty.address_line_1 || '' '' || 
pty.address_line_2 || '' '' || 
...
pty.region_1 || '' '' || 
pty.region_2 ||  '' '' || 
pty.postal_code AS Address, 
ter.territory_short_name AS country_name, 
SubscriptionOptionEO.SUBSCRIPTION_OPTION_ID, 
SubscriptionOptionEO.SUBSCRIPTION_OPTION_CODE, 
SubscriptionOptionEO.EXCEPTION_OPTION_CODE, 
SubscriptionOptionEO.PARENT_FIRST_PTY_ORG_ID, 
SubscriptionOptionEO.EFFECTIVE_FROM, 
SubscriptionOptionEO.ENABLED_FLAG, 
SubscriptionOptionEO.ALLOW_SUBSCRIPTION_FLAG,
SubscriptionOptionEO.EFFECTIVE_TO, 
HZP.PARTY_NAME AS SERVICE_PROVIDER, 
ServiceSubscriptionEO.PROD_FAMILY_GRP_CODE, 
ServiceSubscriptionEO.SRVC_PROVIDER_ID, 
ServiceSubscriptionEO.EFFECTIVE_FROM AS ServiceEffFrom, 
ServiceSubscriptionEO.EFFECTIVE_TO AS ServiceEfftO, 
ServiceSubscriptionEO.ENABLED_FLAG AS ServiceEnabledFlag,
RegimesUsage.first_pty_org_id, 
RegimesUsage.tax_regime_id, 
RegimesUsage.tax_regime_code, 
reg.tax_regime_name, 
lkp.meaning as party_type, 
RegimesUsage.first_pty_org_id AS Trans_first_pty_org_id 
FROM zx_regimes_usages RegimesUsage, 
ZX_SUBSCRIPTION_OPTIONS SubscriptionOptionEO, 
ZX_SRVC_SUBSCRIPTIONS ServiceSubscriptionEO, 
...
HZ_PARTIES HZP 
WHERE SubscriptionOptionEO.regime_usage_id = RegimesUsage.regime_usage_id 
AND RegimesUsage.regime_usage_id = ServiceSubscriptionEO.regime_usage_id (+) 
AND ServiceSubscriptionEO.SRVC_PROVIDER_ID = ptp. PARTY_TAX_PROFILE_ID (+) 
AND ptp.PARTY_ID = HZP.PARTY_ID (+) 
AND RegimesUsage.first_pty_org_id = pty.party_tax_profile_id 
...
AND RegimesUsage.tax_regime_id = reg.tax_regime_id 
AND reg.country_code = ter.territory_code(+)) QRSLT  
WHERE (upper(tax_regime_code)  = upper(''##$$TAXREGIME$$##''))
AND FIRST_PTY_ORG_ID = (nvl(''##$$CO_ID$$##'',-99))',
      p_title                  => 'Tax Regime Subscriptions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no tax regime subscriptions for this regime (##$$TAXREGIME$$##).',
      p_solution               => 'You will need to define a tax and make it applicable to multiple operating units.<br>
Please review [1051643.1] R12: How To Make A Single Tax Applicable For Multiple Operating Units for more information.',
      p_success_msg            => 'Displaying tax regime subscriptions for this regime (##$$TAXREGIME$$##).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_SETUP_TAX_REGIME_SUBCRIPTIONS');



debug('begin add_signature: AR_EBTAX_SETUP_TAX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12549',
      p_sig_id                 => 'AR_EBTAX_SETUP_TAX',
      p_sig_sql                => 'SELECT ZxTaxesB.TAX,
ZxTaxesB.EFFECTIVE_FROM,
ZxTaxesB.EFFECTIVE_TO,
ZxTaxesB.TAX_REGIME_CODE,
ZxTaxesB.TAX_TYPE_CODE,
ZxTaxesB.ALLOW_MANUAL_ENTRY_FLAG,
ZxTaxesB.ALLOW_TAX_OVERRIDE_FLAG,
ZxTaxesB.MIN_TXBL_BSIS_THRSHLD,
ZxTaxesB.MAX_TXBL_BSIS_THRSHLD,
ZxTaxesB.MIN_TAX_RATE_THRSHLD,
ZxTaxesB.MAX_TAX_RATE_THRSHLD,
ZxTaxesB.MIN_TAX_AMT_THRSHLD,
ZxTaxesB.MAX_TAX_AMT_THRSHLD,
ZxTaxesB.COMPOUNDING_PRECEDENCE,
ZxTaxesB.PERIOD_SET_NAME,
ZxTaxesB.EXCHANGE_RATE_TYPE,
ZxTaxesB.TAX_CURRENCY_CODE,
ZxTaxesB.TAX_PRECISION,
ZxTaxesB.MINIMUM_ACCOUNTABLE_UNIT,
ZxTaxesB.ROUNDING_RULE_CODE,
ZxTaxesB.TAX_STATUS_RULE_FLAG,
ZxTaxesB.TAX_RATE_RULE_FLAG,
ZxTaxesB.DEF_PLACE_OF_SUPPLY_TYPE_CODE,
ZxTaxesB.PLACE_OF_SUPPLY_RULE_FLAG,
ZxTaxesB.DIRECT_RATE_RULE_FLAG,
ZxTaxesB.APPLICABILITY_RULE_FLAG,
ZxTaxesB.TAX_CALC_RULE_FLAG,
ZxTaxesB.TXBL_BSIS_THRSHLD_FLAG,
ZxTaxesB.TAX_RATE_THRSHLD_FLAG,
ZxTaxesB.TAX_AMT_THRSHLD_FLAG,
ZxTaxesB.TAXABLE_BASIS_RULE_FLAG,
ZxTaxesB.DEF_INCLUSIVE_TAX_FLAG,
ZxTaxesB.THRSHLD_GROUPING_LVL_CODE,
ZxTaxesB.HAS_OTHER_JURISDICTIONS_FLAG,
ZxTaxesB.ALLOW_EXEMPTIONS_FLAG,
ZxTaxesB.ALLOW_EXCEPTIONS_FLAG,
ZxTaxesB.ALLOW_RECOVERABILITY_FLAG,
ZxTaxesB.DEF_TAX_CALC_FORMULA,
ZxTaxesB.TAX_INCLUSIVE_OVERRIDE_FLAG,
ZxTaxesB.DEF_TAXABLE_BASIS_FORMULA,
ZxTaxesB.DEF_REGISTR_PARTY_TYPE_CODE,
ZxTaxesB.REGISTRATION_TYPE_RULE_FLAG,
ZxTaxesB.REPORTING_ONLY_FLAG,
ZxTaxesB.AUTO_PRVN_FLAG,
ZxTaxesB.LIVE_FOR_PROCESSING_FLAG,
ZxTaxesB.HAS_DETAIL_TB_THRSHLD_FLAG,
ZxTaxesB.HAS_TAX_DET_DATE_RULE_FLAG,
ZxTaxesB.HAS_EXCH_RATE_DATE_RULE_FLAG,
ZxTaxesB.HAS_TAX_POINT_DATE_RULE_FLAG,
ZxTaxesB.PRINT_ON_INVOICE_FLAG,
ZxTaxesB.USE_LEGAL_MSG_FLAG,
ZxTaxesB.CALC_ONLY_FLAG,
ZxTaxesB.PRIMARY_RECOVERY_TYPE_CODE,
ZxTaxesB.PRIMARY_REC_TYPE_RULE_FLAG,
ZxTaxesB.SECONDARY_RECOVERY_TYPE_CODE,
ZxTaxesB.SECONDARY_REC_TYPE_RULE_FLAG,
ZxTaxesB.PRIMARY_REC_RATE_DET_RULE_FLAG,
ZxTaxesB.SEC_REC_RATE_DET_RULE_FLAG,
ZxTaxesB.OFFSET_TAX_FLAG,
ZxTaxesB.RECOVERY_RATE_OVERRIDE_FLAG,
ZxTaxesB.ZONE_GEOGRAPHY_TYPE,
ZxTaxesB.REGN_NUM_SAME_AS_LE_FLAG,
ZxTaxesB.DEF_REC_SETTLEMENT_OPTION_CODE,
ZxTaxesB.PARENT_GEOGRAPHY_TYPE,
ZxTaxesB.PARENT_GEOGRAPHY_ID,
ZxTaxesB.ALLOW_MASS_CREATE_FLAG,
ZxTaxesB.APPLIED_AMT_HANDLING_FLAG,
ZxTaxesB.CREATED_BY,
ZxTaxesB.CREATION_DATE,
ZxTaxesB.LAST_UPDATED_BY,
ZxTaxesB.LAST_UPDATE_DATE,
ZxTaxesB.LAST_UPDATE_LOGIN,
ZxTaxesB.REQUEST_ID,
ZxTaxesB.PROGRAM_APPLICATION_ID,
ZxTaxesB.PROGRAM_ID,
ZxTaxesB.RECORD_TYPE_CODE,
ZxTaxesB.ALLOW_ROUNDING_OVERRIDE_FLAG,
ZxTaxesB.SOURCE_TAX_FLAG,
ZxTaxesB.DEF_PRIMARY_REC_RATE_CODE,
ZxTaxesB.ALLOW_DUP_REGN_NUM_FLAG,
ZxTaxesB.DEF_SECONDARY_REC_RATE_CODE,
ZxTaxesB.SPECIAL_INCLUSIVE_TAX_FLAG,
ZxTaxesB.PROGRAM_LOGIN_ID,
ZxTaxesB.TAX_ID,
ZxTaxesB.CONTENT_OWNER_ID,
ZxTaxesB.REP_TAX_AUTHORITY_ID,
ZxTaxesB.COLL_TAX_AUTHORITY_ID,
ZxTaxesB.THRSHLD_CHK_TMPLT_CODE,
ZxTaxesB.TAX_ACCOUNT_SOURCE_TAX,
ZxTaxesB.TAX_ACCOUNT_CREATE_METHOD_CODE, 
ZxTaxesB.OVERRIDE_GEOGRAPHY_TYPE,
ZxTaxesB.LIVE_FOR_APPLICABILITY_FLAG,
ZxTaxesB.TAX_EXMPT_CR_METHOD_CODE,
ZxTaxesB.TAX_EXMPT_SOURCE_TAX,
ZxTaxesB.APPLICABLE_BY_DEFAULT_FLAG,
ZxTaxesB.LEGAL_REPORTING_STATUS_DEF_VAL 
FROM ZX_TAXES_B ZxTaxesB 
WHERE TAX_REGIME_CODE = ''##$$TAXREGIME$$##''
AND   CONTENT_OWNER_ID IN (nvl(''##$$CO_ID$$##'',-99),-99)
AND TAX = nvl(''##$$TAX$$##'',TAX)',
      p_title                  => 'Taxes',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the taxes defined under this regime (##$$TAXREGIME$$##).',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_SETUP_TAX');



debug('begin add_signature: AR_EBTAX_TAX_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12525',
      p_sig_id                 => 'AR_EBTAX_TAX_STATUS',
      p_sig_sql                => 'SELECT ZxStatusB.TAX_STATUS_CODE, 
ZxStatusB.EFFECTIVE_FROM, 
ZxStatusB.EFFECTIVE_TO, 
ZxStatusB.TAX, 
ZxStatusB.TAX_REGIME_CODE, 
ZxStatusB.RULE_BASED_RATE_FLAG, 
ZxStatusB.ALLOW_RATE_OVERRIDE_FLAG, 
ZxStatusB.ALLOW_EXEMPTIONS_FLAG, 
ZxStatusB.ALLOW_EXCEPTIONS_FLAG, 
ZxStatusB.DEFAULT_STATUS_FLAG, 
ZxStatusB.DEFAULT_FLG_EFFECTIVE_FROM, 
ZxStatusB.DEFAULT_FLG_EFFECTIVE_TO, 
ZxStatusB.DEF_REC_SETTLEMENT_OPTION_CODE, 
ZxStatusB.RECORD_TYPE_CODE, 
ZxStatusB.CREATED_BY, 
ZxStatusB.CREATION_DATE, 
ZxStatusB.LAST_UPDATED_BY, 
ZxStatusB.LAST_UPDATE_DATE, 
ZxStatusB.LAST_UPDATE_LOGIN, 
ZxStatusB.REQUEST_ID, 
ZxStatusB.PROGRAM_APPLICATION_ID, 
ZxStatusB.PROGRAM_ID, 
ZxStatusB.TAX_STATUS_ID, 
ZxStatusB.CONTENT_OWNER_ID  
FROM ZX_STATUS_B ZxStatusB 
WHERE TAX_REGIME_CODE = ''##$$TAXREGIME$$##''
AND CONTENT_OWNER_ID IN (nvl(''##$$CO_ID$$##'',-99),-99)
AND TAX = nvl(''##$$TAX$$##'',TAX)',
      p_title                  => 'Tax Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the tax status for regime (##$$TAXREGIME$$##) and tax (##$$TAX$$##).',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_TAX_STATUS');



debug('begin add_signature: AR_EBTAX_TAX_RATES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12550',
      p_sig_id                 => 'AR_EBTAX_TAX_RATES',
      p_sig_sql                => 'SELECT ZxRatesB.TAX_RATE_CODE, 
ZxRatesB.EFFECTIVE_FROM, 
ZxRatesB.EFFECTIVE_TO, 
ZxRatesB.TAX_REGIME_CODE, 
ZxRatesB.TAX, 
ZxRatesB.TAX_STATUS_CODE, 
ZxRatesB.SCHEDULE_BASED_RATE_FLAG,
ZxRatesB.RATE_TYPE_CODE, 
ZxRatesB.PERCENTAGE_RATE, 
ZxRatesB.QUANTITY_RATE, 
ZxRatesB.UOM_CODE, 
ZxRatesB.TAX_JURISDICTION_CODE,
ZxRatesB.RECOVERY_TYPE_CODE, 
ZxRatesB.ACTIVE_FLAG, 
ZxRatesB.DEFAULT_RATE_FLAG, 
ZxRatesB.DEFAULT_FLG_EFFECTIVE_FROM, 
ZxRatesB.DEFAULT_FLG_EFFECTIVE_TO,
ZxRatesB.DEFAULT_REC_TYPE_CODE, 
ZxRatesB.DEFAULT_REC_RATE_CODE, 
ZxRatesB.OFFSET_TAX, 
ZxRatesB.OFFSET_STATUS_CODE, 
ZxRatesB.OFFSET_TAX_RATE_CODE, 
ZxRatesB.RECOVERY_RULE_CODE, 
ZxRatesB.DEF_REC_SETTLEMENT_OPTION_CODE, 
ZxRatesB.VAT_TRANSACTION_TYPE_CODE, 
ZxRatesB.RECORD_TYPE_CODE, 
ZxRatesB.TAX_RATE_ID, 
ZxRatesB.CONTENT_OWNER_ID, 
ZxRatesB.TAXABLE_BASIS_FORMULA_CODE, 
ZxRatesB.TAX_INCLUSIVE_OVERRIDE_FLAG, 
ZxRatesB.ALLOW_EXEMPTIONS_FLAG  
FROM ZX_RATES_B ZxRatesB 
WHERE TAX_REGIME_CODE = ''##$$TAXREGIME$$##''
and CONTENT_OWNER_ID IN (nvl(''##$$CO_ID$$##'',-99),-99) AND TAX = nvl(''##$$TAX$$##'',TAX)',
      p_title                  => 'Tax Rates',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the tax rates for regime (##$$TAXREGIME$$##) and tax (##$$TAX$$##).',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_TAX_RATES');



debug('begin add_signature: AR_EBTAX_EFFECTIVE_TAX_RATE_RANGE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14358',
      p_sig_id                 => 'AR_EBTAX_EFFECTIVE_TAX_RATE_RANGE',
      p_sig_sql                => 'SELECT tax_rate_id,tax_rate_code,effective_to,default_flg_effective_to
from zx_rates_b_tmp WHERE (effective_to IS NOT NULL 
...
AND default_flg_effective_to <> default_flg_effective_from)',
      p_title                  => 'Default Tax Rate Range',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The END_DATE of a tax rate range is incorrect, which will cause an error when attempting to enter a transaction adjustment (RMA).',
      p_solution               => 'You will need to fix this data.<br>
Review [2262872.1] Datafix: Tax Rate Range: Error Occurs when Trying to Enter RMA or Tax on Last Day of Date Range for more information.',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_EFFECTIVE_TAX_RATE_RANGE');



debug('begin add_signature: AR_EBTAX_SETUP_TAX_JURISDICTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12551',
      p_sig_id                 => 'AR_EBTAX_SETUP_TAX_JURISDICTIONS',
      p_sig_sql                => 'SELECT ZxJurisdictionsB.TAX_JURISDICTION_CODE, ZxJurisdictionsB.EFFECTIVE_FROM, ZxJurisdictionsB.EFFECTIVE_TO, ZxJurisdictionsB.TAX_REGIME_CODE, ZxJurisdictionsB.TAX, ZxJurisdictionsB.DEFAULT_JURISDICTION_FLAG, ZxJurisdictionsB.DEFAULT_FLG_EFFECTIVE_FROM, ZxJurisdictionsB.DEFAULT_FLG_EFFECTIVE_TO, ZxJurisdictionsB.RECORD_TYPE_CODE, ZxJurisdictionsB.TAX_JURISDICTION_ID, ZxJurisdictionsB.ZONE_GEOGRAPHY_ID, ZxJurisdictionsB.ALLOW_TAX_REGISTRATIONS_FLAG  FROM ZX_JURISDICTIONS_B ZxJurisdictionsB WHERE TAX_REGIME_CODE = ''##$$TAXREGIME$$##'' and TAX = nvl(''##$$TAX$$##'',TAX)',
      p_title                  => 'Tax Jurisdictions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the tax jurisdictions defined for the regime (##$$TAXREGIME$$##) and tax (##$$TAX$$##).',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_SETUP_TAX_JURISDICTIONS');



debug('begin add_signature: AR_EBTAX_WRONG_TAX_JURISDICTION_START_DATE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14252',
      p_sig_id                 => 'AR_EBTAX_WRONG_TAX_JURISDICTION_START_DATE',
      p_sig_sql                => 'SELECT  tax_regime_code, tax, tax_status_code,content_owner_id, MIN(effective_from) effective_from
FROM    zx_rates_b
...
GROUP BY tax_regime_code,tax,tax_status_code,content_owner_id',
      p_title                  => 'Tax Jurisdiction Date',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The effective dates of the tax jurisdiction are not in sync with the tax rate after migration.  This will cause an error when you attempt to modify a tax rate percentage.',
      p_solution               => 'You will need to fix the data.<br>
Review [2100710.1] Upgraded Tax Jurisdiction Start Date After Associated Tax Rate Start Date for more information.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_WRONG_TAX_JURISDICTION_START_DATE');



debug('begin add_signature: AR_EBTAX_SETUP_TAX_RULES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12557',
      p_sig_id                 => 'AR_EBTAX_SETUP_TAX_RULES',
      p_sig_sql                => 'SELECT ZxRulesB.TAX_RULE_CODE, ZxRulesB.TAX, ZxRulesB.TAX_REGIME_CODE, ZxRulesB.SERVICE_TYPE_CODE, ZxRulesB.APPLICATION_ID, ZxRulesB.RECOVERY_TYPE_CODE, ZxRulesB.PRIORITY, ZxRulesB.DET_FACTOR_TEMPL_CODE, ZxRulesB.SYSTEM_DEFAULT_FLAG, ZxRulesB.EFFECTIVE_FROM, ZxRulesB.EFFECTIVE_TO, ZxRulesB.ENABLED_FLAG, ZxRulesB.RECORD_TYPE_CODE, ZxRulesB.CREATION_DATE, ZxRulesB.LAST_UPDATE_DATE, ZxRulesB.REQUEST_ID, ZxRulesB.PROGRAM_APPLICATION_ID, ZxRulesB.PROGRAM_ID, ZxRulesB.TAX_EVENT_CLASS_CODE, ZxRulesB.PROGRAM_LOGIN_ID, ZxRulesB.TAX_RULE_ID, ZxRulesB.CONTENT_OWNER_ID, ZxRulesB.CREATED_BY, ZxRulesB.LAST_UPDATED_BY, ZxRulesB.LAST_UPDATE_LOGIN, ZxRulesB.DETERMINING_FACTOR_CQ_CODE, ZxRulesB.GEOGRAPHY_TYPE, ZxRulesB.GEOGRAPHY_ID, ZxRulesB.TAX_LAW_REF_CODE, ZxRulesB.LAST_UPDATE_MODE_FLAG, ZxRulesB.NEVER_BEEN_ENABLED_FLAG, ZxRulesB.EVENT_CLASS_MAPPING_ID  FROM ZX_RULES_B ZxRulesB where TAX_REGIME_CODE  = ''##$$TAXREGIME$$##'' AND CONTENT_OWNER_ID IN (nvl(''##$$CO_ID$$##'',-99),-99)
AND TAX = nvl(''##$$TAX$$##'',TAX)',
      p_title                  => 'Tax Rules',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the tax rules for tax regime (##$$TAXREGIME$$##), content owner id (##$$CO_ID$$##) and tax (##$$TAX$$##).',
      p_solution               => '',
      p_success_msg            => 'There are no tax rules defined for tax regime (##$$TAXREGIME$$##), content owner id (##$$CO_ID$$##) and tax (##$$TAX$$##).
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_SETUP_TAX_RULES');



debug('begin add_signature: AR_EBTAX_SETUP_TAX_ACCOUNTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12552',
      p_sig_id                 => 'AR_EBTAX_SETUP_TAX_ACCOUNTS',
      p_sig_sql                => 'SELECT * FROM (SELECT ZA.TAX_ACCOUNT_ENTITY_CODE, ZA.TAX_ACCOUNT_ENTITY_ID, ZA.TAX_ACCOUNT_ID, ZA.INTERNAL_ORGANIZATION_ID, ZA.LEDGER_ID, ZA.TAX_ACCOUNT_CCID, ZA.NON_REC_ACCOUNT_CCID, ZA.INTERIM_TAX_CCID, ZA.ADJ_CCID, ZA.EDISC_CCID, ZA.UNEDISC_CCID, ZA.FINCHRG_CCID, ZA.ADJ_NON_REC_TAX_CCID, ZA.EDISC_NON_REC_TAX_CCID,  ZA.UNEDISC_NON_REC_TAX_CCID, ZA.FINCHRG_NON_REC_TAX_CCID, HROU.NAME, GL.NAME AS LEDGER_NAME, GL.CHART_OF_ACCOUNTS_ID, FIFS.ID_FLEX_STRUCTURE_CODE 
...
AND FIFS.ID_FLEX_NUM = GL.CHART_OF_ACCOUNTS_ID) QRSLT  
WHERE TAX_ACCOUNT_ENTITY_ID IN (SELECT tax_id FROM zx_taxes_b 
WHERE tax_regime_code = ''##$$TAXREGIME$$##'' 
AND tax LIKE ''##$$TAX$$##'' 
AND content_owner_id IN (''##$$CO_ID$$##'',-99)  
UNION ALL SELECT tax_rate_id 
FROM zx_rates_b 
WHERE tax_regime_code = ''##$$TAXREGIME$$##'' 
AND tax LIKE ''##$$TAX$$##'' 
AND content_owner_id IN (''##$$CO_ID$$##'',-99) 
UNION ALL SELECT registration_id 
FROM zx_registrations WHERE tax_regime_code = ''##$$TAXREGIME$$##'' 
AND tax LIKE ''##$$TAX$$##''  
UNION ALL SELECT tax_jurisdiction_id 
FROM zx_jurisdictions_b 
WHERE tax_regime_code = ''##$$TAXREGIME$$##''
AND tax LIKE ''##$$TAX$$##'')',
      p_title                  => 'Tax Accounts',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the tax accounts defined for tax regime (##$$TAXREGIME$$##) and tax (##$$TAX$$##).',
      p_solution               => '',
      p_success_msg            => 'There are no tax accounts defined for tax regime (##$$TAXREGIME$$##) and tax (##$$TAX$$##).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_SETUP_TAX_ACCOUNTS');
...
debug('begin add_signature: TCA_HZ_PARTY_SITES_CUSTOMER');
   l_info('##MASK##ATTRI%'):= 'REMOVE_COLUMN';
   l_info('##MASK##DUNS_NUMBER_C'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##GLOBAL_ATTRI%'):= 'REMOVE_COLUMN';
   l_info('##MASK##PARTY_SITE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9907',
      p_sig_id                 => 'TCA_HZ_PARTY_SITES_CUSTOMER',
      p_sig_sql                => 'select   hps.*
from     HZ_PARTY_SITES hps
where    hps.PARTY_SITE_ID in (select hcas.PARTY_SITE_ID
                               from   HZ_CUST_ACCT_SITES_ALL hcas
                               where  hcas.CUST_ACCOUNT_ID in (select hca.CUST_ACCOUNT_ID
                                                               from   HZ_CUST_ACCOUNTS hca
                                                               where  hca.PARTY_ID = ##$$PRTYID$$##
...
order by hps.PARTY_SITE_ID, hps.LOCATION_ID',
      p_title                  => 'HZ_PARTY_SITES - Customer Account',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no party site linked to the customer account site(s) in HZ_CUST_ACCT_SITES_ALL table.',
      p_solution               => '',
      p_success_msg            => 'Displaying party site(s) linked to the customer account site(s) from HZ_CUST_ACCT_SITES_ALL table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: TCA_HZ_PARTY_SITES_CUSTOMER');



debug('begin add_signature: TCA_HZ_PARTY_SITE_USES_CUSTOMER');
   l_info('##MASK##%ATTRIBUT%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9908',
      p_sig_id                 => 'TCA_HZ_PARTY_SITE_USES_CUSTOMER',
      p_sig_sql                => 'select   hpsu.*
from     HZ_PARTY_SITE_USES hpsu
where    hpsu.PARTY_SITE_ID in (select hcas.PARTY_SITE_ID
                                from   HZ_CUST_ACCT_SITES_ALL hcas
                                where  hcas.CUST_ACCOUNT_ID in (select hca.CUST_ACCOUNT_ID
                                                                from   HZ_CUST_ACCOUNTS hca
                                                                where  hca.PARTY_ID = ##$$PRTYID$$##
...
order by hpsu.PARTY_SITE_ID, hpsu.SITE_USE_TYPE',
      p_title                  => 'HZ_PARTY_SITE_USES - Customer Account',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no party site use linked to the customer account site(s) in HZ_CUST_ACCT_SITES_ALL table.',
      p_solution               => '',
      p_success_msg            => 'Displaying party site use(s) linked to the customer account site(s) from HZ_CUST_ACCT_SITES_ALL table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: TCA_HZ_PARTY_SITE_USES_CUSTOMER');



debug('begin add_signature: TCA_HZ_LOCATIONS_CUSTOMER');
   l_info('##MASK##ATTRI%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##GLOBAL_ATTRI%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##POSTAL_CODE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9909',
      p_sig_id                 => 'TCA_HZ_LOCATIONS_CUSTOMER',
      p_sig_sql                => 'select   LOCATION_ID, LAST_UPDATE_DATE, LAST_UPDATED_BY, CREATION_DATE, CREATED_BY, LAST_UPDATE_LOGIN,
REQUEST_ID,PROGRAM_APPLICATION_ID,PROGRAM_ID, PROGRAM_UPDATE_DATE,WH_UPDATE_DATE,ATTRIBUTE_CATEGORY,
ATTRIBUTE1, ATTRIBUTE2, ATTRIBUTE3, ATTRIBUTE4, ATTRIBUTE5, ATTRIBUTE6, ATTRIBUTE7, ATTRIBUTE8,    
ATTRIBUTE9, ATTRIBUTE10, ATTRIBUTE11, ATTRIBUTE12, ATTRIBUTE13, ATTRIBUTE14, ATTRIBUTE15,      
...
order by hzloc.LOCATION_ID',
      p_title                  => 'HZ_LOCATIONS - Customer Account',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no location associated to any customer account site(s) in HZ_CUST_ACCT_SITES_ALL table.',
      p_solution               => '',
      p_success_msg            => 'Displaying location(s) associated to customer account site(s) from HZ_CUST_ACCT_SITES_ALL table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: TCA_HZ_LOCATIONS_CUSTOMER');
...
debug('begin add_signature: TCA_HZ_GEO_NAME_REFERENCE_LOG');
   l_info('##MASK##MESSAGE_TEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1236',
      p_sig_id                 => 'TCA_HZ_GEO_NAME_REFERENCE_LOG',
      p_sig_sql                => 'SELECT * 
...
AND LOCATION_ID IN (SELECT LOCATION_ID 
      ...
      p_title                  => 'HZ_GEO_NAME_REFERENCE_LOG',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No records found in HZ_GEO_NAME_REFERENCE_LOG.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: TCA_HZ_GEO_NAME_REFERENCE_LOG');
...
debug('begin add_signature: AR_EBTAX_PARTY_ID_TAX_PROFILE');
   l_info('##MASK##ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##REP_REGISTRATION_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12841',
      p_sig_id                 => 'AR_EBTAX_PARTY_ID_TAX_PROFILE',
      p_sig_sql                => 'SELECT zp.PARTY_TYPE_CODE
,    zp.SUPPLIER_FLAG
,    zp.CUSTOMER_FLAG
,    zp.SITE_FLAG
,    zp.PROCESS_FOR_APPLICABILITY_FLAG
,    zp.ROUNDING_LEVEL_CODE
,    zp.ROUNDING_RULE_CODE
,    zp.WITHHOLDING_START_DATE
,    zp.INCLUSIVE_TAX_FLAG
,    zp.ALLOW_AWT_FLAG
,    zp.USE_LE_AS_SUBSCRIBER_FLAG
,    zp.LEGAL_ESTABLISHMENT_FLAG
,    zp.FIRST_PARTY_LE_FLAG
,    zp.REPORTING_AUTHORITY_FLAG
,    zp.COLLECTING_AUTHORITY_FLAG
,    zp.PROVIDER_TYPE_CODE
,    zp.CREATE_AWT_DISTS_TYPE_CODE
,    zp.CREATE_AWT_INVOICES_TYPE_CODE
,    zp.TAX_CLASSIFICATION_CODE
,    zp.SELF_ASSESS_FLAG
,    zp.ALLOW_OFFSET_TAX_FLAG
,    zp.EFFECTIVE_FROM_USE_LE
,    zp.RECORD_TYPE_CODE
,    zp.CREATED_BY
,    zp.CREATION_DATE
,    zp.LAST_UPDATED_BY
,    zp.LAST_UPDATE_DATE
,    zp.LAST_UPDATE_LOGIN
,    zp.REQUEST_ID
,    zp.PROGRAM_APPLICATION_ID
,    zp.PROGRAM_ID
,    zp.ATTRIBUTE1
,    zp.ATTRIBUTE2
,    zp.ATTRIBUTE3
...
,    zp.ATTRIBUTE14
,    zp.ATTRIBUTE15
,    zp.ATTRIBUTE_CATEGORY
,    zp.PROGRAM_LOGIN_ID
,    zp.PARTY_TAX_PROFILE_ID
,    zp.PARTY_ID
,    zp.REP_REGISTRATION_NUMBER
,    zp.OBJECT_VERSION_NUMBER
,    zp.REGISTRATION_TYPE_CODE
,    zp.COUNTRY_CODE
,    zp.MERGED_TO_PTP_ID
,    zp.MERGED_STATUS_CODE
from   ZX_PARTY_TAX_PROFILE zp
where  zp.PARTY_ID = ##$$PRTYID$$##',
      p_title                  => 'ZX_PARTY_TAX_PROFILE',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no record corresponding to this PARTY_ID (##$$PRTYID$$##) in ZX_PARTY_TAX_PROFILE table.',
      p_solution               => 'See Oracle Payables and EBTax Setup [735970.1#aref_section210] for details on how to setup a party tax profile.',
      p_success_msg            => 'Displaying the party tax profile setup for this PARTY_ID (##$$PRTYID$$##).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_PARTY_ID_TAX_PROFILE');



debug('begin add_signature: AR_EBTAX_THIRD_PARTY_SITE_TAX_PROFILE');
   l_info('##MASK##ADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PARTY_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PARTY_SITE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##REP_REGISTRATION_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '12605',
      p_sig_id                 => 'AR_EBTAX_THIRD_PARTY_SITE_TAX_PROFILE',
      p_sig_sql                => 'SELECT fndlookupvalues.meaning party_type,
  hzp.party_id,
  hzp.party_name,
  nvl(nvl(hzps.party_site_name,   hzloc.short_description),   hzloc.address1 || '' '' || hzloc.city || '' '' || hzloc.state) party_site_name,
  hzps.party_site_id,
  hzloc.address1 || '' '' || hzloc.city || '' '' || hzloc.state AS address,
  hzloc.country AS country_code,
  fndlookupvalues.lookup_code party_type_code,
  ptp.supplier_flag,
  ptp.customer_flag,
  ptp.site_flag,
  ...
  ptp.tax_classification_code,
  ptp.self_assess_flag,
  ptp.allow_offset_tax_flag,
  ptp.effective_from_use_le,
  ptp.record_type_code,
  ptp.party_tax_profile_id,
  ptp.party_id party_tax_profile_party_id,
  ptp.rep_registration_number,
  ptp.registration_type_code,
  ptp.country_code,
  ptp.process_for_applicability_flag
FROM hz_parties hzp,
  hz_party_sites hzps,
  hz_locations hzloc,
  fnd_lookups fndlookupvalues,
  fnd_territories_vl,
  zx_party_tax_profile ptp
WHERE hzp.party_id = hzps.party_id
 AND hzp.party_id = ##$$PRTYID$$##
 AND hzps.location_id = hzloc.location_id
 AND fndlookupvalues.lookup_code = ''THIRD_PARTY_SITE''
 AND fndlookupvalues.lookup_type = ''ZX_PTP_PARTY_TYPE''
 AND sysdate BETWEEN fndlookupvalues.start_date_active
 AND nvl(fndlookupvalues.end_date_active,   sysdate)
 AND nvl(fndlookupvalues.enabled_flag,   ''N'') = ''Y''
 AND hzloc.country = fnd_territories_vl.territory_code
 AND ptp.party_id = hzps.party_site_id
 AND ptp.party_type_code = ''THIRD_PARTY_SITE''',
      p_title                  => 'Third Party Site Tax Profile',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No third party site tax profile information found for this PARTY_ID (9##$$PRTYID$$##).',
      p_solution               => '',
      p_success_msg            => 'Displaying third party site tax profile information for this PARTY_ID (##$$PRTYID$$##).',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_THIRD_PARTY_SITE_TAX_PROFILE');



debug('begin add_signature: AR_EBTAX_PARTY_FISCAL_CLASSIFICATION_CODE');
   l_info('##MASK##PARTY_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PARTY_SITE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12565',
      p_sig_id                 => 'AR_EBTAX_PARTY_FISCAL_CLASSIFICATION_CODE',
      p_sig_sql                => 'SELECT HPP.PARTY_NAME,HP.PARTY_SITE_NAME ,HCA.CODE_ASSIGNMENT_ID, HCA.OWNER_TABLE_NAME, HCA.OWNER_TABLE_ID, HCA.CLASS_CATEGORY,HCA.CLASS_CODE, HCA.PRIMARY_FLAG, HCA.CONTENT_SOURCE_TYPE, HCA.START_DATE_ACTIVe, HCA.END_DATE_ACTIVE, HCA.STATUS, HCA.OBJECT_VERSION_NUMBER
    FROM ZX_PARTY_TAX_PROFILE ZP
        ,HZ_CODE_ASSIGNMENTS HCA
        ,HZ_PARTY_SITES HP
        ,HZ_PARTIES HPP
    WHERE ZP.PARTY_TAX_PROFILE_ID = HCA.OWNER_TABLE_ID
    AND ZP.PARTY_ID = ##$$PRTYID$$##
    ...
    ORDER BY ZP.LAST_UPDATE_DATE DESC',
      p_title                  => 'Party Fiscal Classification Code',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Party fiscal classification code information.',
      p_solution               => 'There are no party fiscal classification codes setup for this PARTY_ID (##$$PRTYID$$##).<br>

Review [729486.1] How to Setup and Troubleshoot a Party Fiscal Classification Tax Rule in R12 E-Business Tax on how to utilize Party Fiscal Classification
in Tax Rules.',
      p_success_msg            => 'Displaying party fiscal classification code information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_PARTY_FISCAL_CLASSIFICATION_CODE');
...
debug('begin add_signature: AR_TRX_RA_CUSTOMER_TRX_ALL');
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_REFERENCE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4496',
      p_sig_id                 => 'AR_TRX_RA_CUSTOMER_TRX_ALL',
      p_sig_sql                => 'SELECT *
from RA_CUSTOMER_TRX_ALL
where customer_trx_id = ##$$TRXID$$##',
      p_title                  => 'RA_CUSTOMER_TRX_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found for transaction number/ID provided.',
      p_solution               => 'Please verify the transaction number/ID chosen to ensure it exists in the database.',
      p_success_msg            => 'Displaying header data for this transaction from RA_CUSTOMER_TRX_ALL table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TRX_RA_CUSTOMER_TRX_ALL');



debug('begin add_signature: AR_TRX_RA_CUSTOMER_TRX_LINES_ALL');
   l_info('##MASK##ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##GLOBAL_ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##INTERFACE_LINE_ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4512',
      p_sig_id                 => 'AR_TRX_RA_CUSTOMER_TRX_LINES_ALL',
      p_sig_sql                => 'SELECT * 
...
order by customer_trx_line_id',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no transaction lines for this transaction in RA_CUSTOMER_TRX_LINES_ALL table.',
      p_solution               => 'No transaction lines found for this transaction in RA_CUSTOMER_TRX_LINES_ALL.',
      p_success_msg            => 'Displaying transaction lines for this transaction from RA_CUSTOMER_TRX_LINES_ALL table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TRX_RA_CUSTOMER_TRX_LINES_ALL');



debug('begin add_signature: AR_TRX_RA_CUSTOMER_TRX_LINES_ALL_TOTALS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5027',
      p_sig_id                 => 'AR_TRX_RA_CUSTOMER_TRX_LINES_ALL_TOTALS',
...
GROUP BY customer_trx_id, line_type',
      ...
      p_solution               => 'No transaction lines found for this transaction in RA_CUSTOMER_TRX_LINES_ALL.
',
      p_success_msg            => 'Displaying sum of line amounts for this transaction from RA_CUSTOMER_TRX_LINES_ALL table.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TRX_RA_CUSTOMER_TRX_LINES_ALL_TOTALS');



debug('begin add_signature: AR_TRX_RA_CUST_TRX_LINE_GL_DIST_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4518',
      p_sig_id                 => 'AR_TRX_RA_CUST_TRX_LINE_GL_DIST_ALL',
      p_sig_sql                => 'SELECT *
...
order by cust_trx_line_gl_dist_id',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no GL distributions for this transaction in RA_CUST_TRX_LINE_GL_DIST_ALL table.',
      p_solution               => 'No GL distributions for this transaction in RA_CUST_TRX_LINE_GL_DIST_ALL table.',
      p_success_msg            => 'Displaying GL distributions for this transaction from RA_CUST_TRX_LINE_GL_DIST_ALL table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TRX_RA_CUST_TRX_LINE_GL_DIST_ALL');



debug('begin add_signature: AR_TRX_AR_DIST_TO_TRX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10542',
      p_sig_id                 => 'AR_TRX_AR_DIST_TO_TRX',
      p_sig_sql                => 'SELECT *
...
AND source_table = ''RA''
order by line_id',
      p_title                  => 'AR_DISTRIBUTIONS_ALL for Applications To the Transaction',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no distribution records associated to applications to this transaction from other transactions in AR_DISTRIBUTIONS_ALL table. This does not indicate an error/issue if the credit memo is still unapplied.
',
      p_solution               => 'No distribution records associated to applications to this transaction from other transactions in AR_DISTRIBUTIONS_ALL table. ',
      p_success_msg            => 'Displaying the distributions associated to the applications to this transaction from other transactions in AR_DISTRIBUTIONS_ALL table.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TRX_AR_DIST_TO_TRX');



debug('begin add_signature: AR_TRX_AR_ADJUSTMENTS_ALL');
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4531',
      p_sig_id                 => 'AR_TRX_AR_ADJUSTMENTS_ALL',
      p_sig_sql                => 'SELECT *
...
order by adjustment_id',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no adjustments to this transaction in AR_ADJUSTMENTS table. This does not necessarily indicate an error/issue exists. ',
      p_solution               => 'No adjustments to this transaction in AR_ADJUSTMENTS table.',
      p_success_msg            => 'Displaying adjustments made on this transaction from AR_ADJUSTMENTS_ALL table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TRX_AR_ADJUSTMENTS_ALL');



debug('begin add_signature: AR_TRX_ADJUSTMENT_DIST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4533',
      p_sig_id                 => 'AR_TRX_ADJUSTMENT_DIST',
      p_sig_sql                => 'SELECT *
FROM   ar_distributions_all
...
order by line_id',
      p_title                  => 'AR_DISTRIBUTIONS_ALL (for Adjustment)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no adjustment distributions for this transaction in AR_DISTRIBUTIONS_ALL table. This does not necessarily indicate an error/issue exists.',
      p_solution               => 'No adjustment distributions for this transaction in AR_DISTRIBUTIONS_ALL table. ',
      p_success_msg            => 'Displaying distributions for adjustments made on this transaction from AR_DISTRIBUTIONS_ALL table.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TRX_ADJUSTMENT_DIST');



debug('begin add_signature: AR_TRX_RA_CUST_TRX_TYPES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4508',
      p_sig_id                 => 'AR_TRX_RA_CUST_TRX_TYPES_ALL',
      p_sig_sql                => 'SELECT a.*
    ...
    and   b.org_id = a.org_id',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no transaction type data for this transaction in RA_CUST_TRX_TYPES_ALL table.',
      p_solution               => 'The transaction type used by this transaction does not exist in RA_CUST_TRX_TYPES_ALL.
For more information, please review [1067797.1] Setting Up Transaction Types In Oracle Receivables.',
      p_success_msg            => 'Displaying transaction type information from RA_CUST_TRX_TYPES_ALL table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TRX_RA_CUST_TRX_TYPES_ALL');



debug('begin add_signature: AR_TRX_MTL_SYSTEM_ITEMS_B');
   l_info('##MASK##PLANNER_CODE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4513',
      p_sig_id                 => 'AR_TRX_MTL_SYSTEM_ITEMS_B',
      p_sig_sql                => 'SELECT *
FROM   MTL_SYSTEM_ITEMS_B  msi
WHERE  (msi.organization_id, msi.inventory_item_id ) IN 
  (SELECT nvl(ctl.warehouse_id, sp.master_organization_id ) warehouse_id, 
   ...
   AND    ctl.line_type = ''LINE'')',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no inventory item data for this transaction in MTL_SYSTEM_ITEMS_B table.',
      p_solution               => 'No inventory item data for this transaction in MTL_SYSTEM_ITEMS_B table.',
      p_success_msg            => 'Displaying inventory item data used by this transaction from MTL_SYSTEM_ITEMS_B table.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TRX_MTL_SYSTEM_ITEMS_B');



debug('begin add_signature: AR_TRX_APPLICATIONS_TO');
   l_info('##MASK##ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##GLOBAL_ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4524',
      p_sig_id                 => 'AR_TRX_APPLICATIONS_TO',
      p_sig_sql                => 'SELECT *
FROM   AR_RECEIVABLE_APPLICATIONS_ALL
where  applied_customer_trx_id = ##$$TRXID$$##
order by RECEIVABLE_APPLICATION_ID',
      p_title                  => 'AR_RECEIVABLE_APPLICATIONS_ALL to the Transaction',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no applications to this transaction in AR_RECEIVABLE_APPLICATIONS table. This does not necessarily indicate an error/issue exists.',
      p_solution               => 'No applications to this transaction in AR_RECEIVABLE_APPLICATIONS table.',
      p_success_msg            => 'Displaying the applications to this transaction in AR_RECEIVABLE_APPLICATIONS_ALL table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TRX_APPLICATIONS_TO');



debug('begin add_signature: AR_TRX_AR_PAYMENT_SCHEDULES_ALL');
   l_info('##MASK##ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##GLOBAL_ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4534',
      p_sig_id                 => 'AR_TRX_AR_PAYMENT_SCHEDULES_ALL',
      p_sig_sql                => 'SELECT *
...
order by payment_schedule_id',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no payment schedules for this transaction in AR_PAYMENT_SCHEDULES_ALL table. This does not necessarily indicate an error/issue exists.',
      p_solution               => 'No payment schedules for this transaction in AR_PAYMENT_SCHEDULES_ALL table.',
      p_success_msg            => 'Displaying payment schedules for this transaction from AR_PAYMENT_SCHEDULES_ALL table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TRX_AR_PAYMENT_SCHEDULES_ALL');



debug('begin add_signature: AR_TRX_APPLICATIONS_TO_TOTALS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4525',
      p_sig_id                 => 'AR_TRX_APPLICATIONS_TO_TOTALS',
...
GROUP  BY application_type',
      p_title                  => 'AR_RECEIVABLE_APPLICATIONS_ALL Total to the Transaction',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no applications to this transaction in AR_RECEIVABLE_APPLICATIONS table. This does not necessarily indicate an error/issue exists.',
      p_solution               => 'No applications to this transaction in AR_RECEIVABLE_APPLICATIONS table. ',
      p_success_msg            => 'Displaying the sum of applications to this transaction from AR_RECEIVABLE_APPLICATIONS_ALL table.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TRX_APPLICATIONS_TO_TOTALS');



debug('begin add_signature: AR_TRX_ZX_LINES');
   l_info('##MASK##TAX_REGISTRATION_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4516',
      p_sig_id                 => 'AR_TRX_ZX_LINES',
      p_sig_sql                => 'SELECT zl.*
FROM     ZX_LINES zl
...
AND      zl.trx_id = ##$$TRXID$$##',
      p_title                  => 'ZX_LINES',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no tax lines for this transaction in ZX_LINES table.',
      p_solution               => 'No tax lines for this transaction in ZX_LINES table.',
      p_success_msg            => 'Displaying Tax Lines for this transaction from ZX_LINES table.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TRX_ZX_LINES');



debug('begin add_signature: AR_TRX_ZX_LINES_DET_FACTORS');
   l_info('##MASK##MERCHANT_PARTY_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MERCHANT_PARTY_TAXPAYER_ID'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MERCHANT_PARTY_TAX_REG_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4517',
      p_sig_id                 => 'AR_TRX_ZX_LINES_DET_FACTORS',
...
AND      lines.customer_trx_id = ##$$TRXID$$##',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no tax determining factors for this transaction in ZX_LINES_DET_FACTORS table.',
      p_solution               => 'No tax determining factors for this transaction in ZX_LINES_DET_FACTORS table.',
      p_success_msg            => 'Displaying tax determining factors for this transaction from ZX_LINES_DET_FACTORS table. ',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TRX_ZX_LINES_DET_FACTORS');



debug('begin add_signature: AR_EBTAX_CUST_ZX_TAX_EXEMPTION');
   l_info('##MASK##ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12423',
      p_sig_id                 => 'AR_EBTAX_CUST_ZX_TAX_EXEMPTION',
      p_sig_sql                => 'SELECT TAX_EXEMPTION_ID
,      EXEMPTION_TYPE_CODE
...
from ZX_EXEMPTIONS 
where 
tax_exemption_id in (Select Tax_exemption_id from ZX_LINES where trx_id=##$$TRXID$$##)',
      p_title                  => 'Tax Exemptions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are no tax exemptions setup for this transaction.',
      p_solution               => 'There are no tax exemptions setup for this transaction. <br>
Review [1389965.1] How To Setup a Tax Exemption for Customers in R12 E-Business Tax, if an exemption is expected.',
      p_success_msg            => 'There are no tax exemptions applied to this transaction.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_CUST_ZX_TAX_EXEMPTION');



debug('begin add_signature: AR_EBTAX_TRX_TAX_RULES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12403',
      p_sig_id                 => 'AR_EBTAX_TRX_TAX_RULES',
      p_sig_sql                => 'select * from ZX_PROCESS_RESULTS A where RESULT_ID in
(select TAX_APPLICABILITY_RESULT_ID FROM ZX_LINES
WHERE trx_id= ##$$TRXID$$##
UNION
select DIRECT_RATE_RESULT_ID FROM ZX_LINES
WHERE trx_id= ##$$TRXID$$##
UNION
select STATUS_RESULT_ID FROM ZX_LINES
WHERE trx_id= ##$$TRXID$$##
UNION
select RATE_RESULT_ID FROM ZX_LINES
WHERE trx_id= ##$$TRXID$$##
UNION
select BASIS_RESULT_ID FROM ZX_LINES
WHERE trx_id= ##$$TRXID$$##
UNION
select THRESH_RESULT_ID FROM ZX_LINES
WHERE trx_id= ##$$TRXID$$##
UNION
select CALC_RESULT_ID FROM ZX_LINES
WHERE trx_id= ##$$TRXID$$##
)',
      p_title                  => 'Tax Rules Used',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no tax rules processed for this transaction.',
      p_solution               => 'There are no tax rules setup for this transaction.  This does not indicate an error or setup issue.<br>
Review [473066.1] How To Setup Expert Tax Rules on eBTax, or more information on setting up tax rules.',
      p_success_msg            => 'Displaying tax rules processed for this transaction.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_TRX_TAX_RULES');



debug('begin add_signature: AR_EBTAX_TAX_RULES_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12404',
      p_sig_id                 => 'AR_EBTAX_TAX_RULES_DETAILS',
      p_sig_sql                => 'select * from zx_rules_b where tax_rule_id in (
select tax_rule_id from ZX_PROCESS_RESULTS A where RESULT_ID in
(select TAX_APPLICABILITY_RESULT_ID FROM ZX_LINES
WHERE trx_id=##$$TRXID$$##
UNION
select DIRECT_RATE_RESULT_ID FROM ZX_LINES
...
WHERE trx_id=##$$TRXID$$##
      ...
      p_title                  => 'Tax Rules Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no tax rules processed for this transaction.',
      p_solution               => 'This does not indicate an error or setup issue.<br>
Review [473066.1] How To Setup Expert Tax Rules on eBTax, or more information on setting up tax rules.',
      p_success_msg            => 'Tax rules details used on a Transaction.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_TAX_RULES_DETAILS');



debug('begin add_signature: AR_EBTAX_RULES_CONDITION_SETS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12405',
      p_sig_id                 => 'AR_EBTAX_RULES_CONDITION_SETS',
      p_sig_sql                => 'select * from zx_condition_groups_b where condition_group_code in
(
select condition_group_code from ZX_PROCESS_RESULTS A where RESULT_ID in
(select TAX_APPLICABILITY_RESULT_ID FROM ZX_LINES
WHERE trx_id=##$$TRXID$$##
UNION
select DIRECT_RATE_RESULT_ID FROM ZX_LINES
...
WHERE trx_id=##$$TRXID$$##
      ...
      p_title                  => 'Condition Sets Used on Rules',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no condition sets for custom rules for this transaction.',
      p_solution               => 'There are no condition sets for customer rules. This does not indicate an error or setup issue.<br>
Review [1111553.1] How to Setup Condition Sets and Determining Factor Sets for Tax Rules in R12 E-Business Tax (EBTax), for more information on setting up condition sets.',
      p_success_msg            => 'Condition sets used on rules for this transaction.<br>
Tax Condition Sets identify the conditions placed upon all or some of the determining factors specified in a Determining Factor Set. 
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_RULES_CONDITION_SETS');



debug('begin add_signature: AR_TRX_AR_00022_MISS_TAX_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4683',
      p_sig_id                 => 'AR_TRX_AR_00022_MISS_TAX_LINES',
      p_sig_sql                => 'select distinct ct.customer_trx_id, ctl.customer_trx_line_id, gld.event_id , gld.gl_date,ct.exchange_rate, gld.posting_Control_id,xah.gl_transfer_status_code
...
and not exists
(select ''x'' from ra_customer_trx_lines_all ctlin
where ctlin.customer_trx_id = ctl.customer_trx_Id
and ctlin.line_type = ''TAX''
and ctlin.link_to_cust_Trx_line_id = ctl.customer_trx_line_id
)
and exists
...
AND zl.trx_id = ctl.customer_trx_id
AND zl.trx_line_id = ctl.customer_trx_LINE_ID
)
...
and xah.application_id = 222',
      p_title                  => 'Missing Tax in RA_CUSTOMER_TRX_LINES_ALL (AR_00022)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transaction is Missing Tax in RA_CUSTOMER_TRX_LINES_ALL',
      p_solution               => '<ul><li>The analyzer has identified data corruption described in [1566061.1]</li>
<li>Please log a Service Request and upload this analyzer output.</li>
   ...
   l_info.delete;
debug('end add_signature: AR_TRX_AR_00022_MISS_TAX_LINES');



debug('begin add_signature: AR_TRX_AR_00104_MISS_TAX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4684',
      p_sig_id                 => 'AR_TRX_AR_00104_MISS_TAX',
      p_sig_sql                => 'select distinct ct.customer_trx_id, gld.event_id , gld.gl_date, ct.exchange_rate 
from   ra_customer_trx_all ct, 
       ra_cust_trx_types_all ctt,
       ra_cust_trx_line_gl_dist_all gld 
WHERE  ct.customer_trx_id = ##$$TRXID$$##
...
AND   NOT EXISTS (select ''x'' 
                  ...
                  and    gld.account_set_flag =''N'' 
                  and    gld.posting_control_id <> -3)',
      p_title                  => 'Missing Tax line in AR but are generated in ZX_LINES (AR_00104)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transaction is missing tax lines in AR but tax lines are generated in ZX_LINES.',
      p_solution               => '<ul><li>The analyzer has identified data corruption described in [2060893.1]</li>
<li>Please log a Service Request and upload this analyzer output.</li>
</ul>',
      p_success_msg            => 'Transaction is missing tax lines in AR but tax lines are generated in ZX_LINES.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TRX_AR_00104_MISS_TAX');



debug('begin add_signature: AR_EBTAX_CUST_HQ_ESTB_REG_NUMBER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12645',
      p_sig_id                 => 'AR_EBTAX_CUST_HQ_ESTB_REG_NUMBER',
      p_sig_sql                => 'SELECT /*+ qb_name(appview) */
...
WHERE zl.application_id IN (222)
  ...
  AND EXISTS
      ...
      p_title                  => 'HQ Establishment Registration Number',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The HQ Establishment Registration Number populated with NULL or incorrect value on Tax Lines. <br>
This will result in an exception error <b>VAT registration is not available for this tax line</b>.',
      p_solution               => 'You will need to review and correct the setup for the tax rule.<br>
Review the following documents for more information:
[1903430.1] How is ZX_LINES. HQ_ESTB_REG_NUMBER Populated?
[2338719.1] Error "VAT registration is not available for this tax line. The entire invoice is not transferred" and there is no HQ_ESTB_REG_NUMBER in ZX_LINES',
      p_success_msg            => 'The HQ Establishment Registration Number populated with correct value on Tax Lines.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_CUST_HQ_ESTB_REG_NUMBER');



debug('begin add_signature: AR_EBTAX_THIRD_PARTY_SERVICE_SUBSCRIPTION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12021',
      p_sig_id                 => 'AR_EBTAX_THIRD_PARTY_SERVICE_SUBSCRIPTION',
      p_sig_sql                => 'SELECT TAX_REGIME_CODE, 
SRVC.* FROM ZX_SRVC_SUBSCRIPTIONS SRVC,
ZX_REGIMES_USAGES USG WHERE USG.REGIME_USAGE_ID = SRVC.REGIME_USAGE_ID
and USG.TAX_REGIME_CODE = ''##$$TAXREGIME$$##''',
      p_title                  => 'Third Party Service Subscription',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the third party subscription details.
',
      p_solution               => '',
      p_success_msg            => 'There are no third party subscription details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_THIRD_PARTY_SERVICE_SUBSCRIPTION');



debug('begin add_signature: AR_EBTAX_THIRD_PARTY_TAXFILE_INFO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12020',
      p_sig_id                 => 'AR_EBTAX_THIRD_PARTY_TAXFILE_INFO',
      p_sig_sql                => 'SELECT zcs.provider_id,
zcs.version_loaded,
zcs.provider_regime_code,
zcs.program_application_id,
zrb.tax_regime_code
FROM zx_content_sources zcs, zx_regimes_b zrb
WHERE zcs.provider_regime_code = zrb.tax_regime_code
AND zrb.tax_regime_code= ''##$$TAXREGIME$$##''',
      p_title                  => 'Import Flat File Version',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying most current import flat file version for tax regime (##$$TAXREGIME$$##).',
      p_solution               => '',
      p_success_msg            => 'There is no third party US sales and use tax import flat file version. 
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_THIRD_PARTY_TAXFILE_INFO');



debug('begin add_signature: AR_EBTAX_MIGRATED_TAX_GROUPS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12687',
      p_sig_id                 => 'AR_EBTAX_MIGRATED_TAX_GROUPS',
      p_sig_sql                => 'SELECT TAX_CODE, ORG_ID, START_DATE, END_DATE, ENABLED_FLAG
...
AND NOT EXISTS (SELECT 1 FROM ZX_CONDITION_GROUPS_B GRP
      ...
      p_title                  => 'Upgraded Tax Groups',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'You have tax groups that were not successfully upgraded.  This can prevent proper tax calculation. ',
      p_solution               => 'Follow the recommendations in [1555248.1]  Tax Calculation Issue: Tax is Not Calculating for Migrated Tax Groups.
',
      p_success_msg            => 'Tax groups have been upgraded successfully.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_MIGRATED_TAX_GROUPS');



debug('begin add_signature: AR_EBTAX_JURISDICTION_DATES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12689',
      p_sig_id                 => 'AR_EBTAX_JURISDICTION_DATES',
      p_sig_sql                => 'select RATES.TAX_RATE_CODE, RATES.CONTENT_OWNER_ID, RATES.ACTIVE_FLAG,
...
RATES.RECOVERY_TYPE_CODE',
      p_title                  => 'Tax Jurisdiction Dates',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The tax jurisdiction effective dates are not synchronized with the tax rates after the data was migrated.  This can prevent tax from calculating.',
      p_solution               => 'You will need to fix these records. Review section 29 of [1316316.1#aref_section329] for more information.',
      p_success_msg            => 'Effective dates of jurisdictions are synchronized with rates after setup migration.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_JURISDICTION_DATES');



debug('begin add_signature: AR_EBTAX_STATUS_DATES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12691',
      p_sig_id                 => 'AR_EBTAX_STATUS_DATES',
      p_sig_sql                => 'SELECT tax_status_code,effective_from,tax,tax_regime_code
...
WHERE record_type_code = ''MIGRATED''
   AND EXISTS (SELECT 1 
      ...
      p_title                  => 'Upgraded Tax Status Dates',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The tax status EFFECTIVE_FROM date is later than the tax rate EFFECTIVE_FROM date. This can cause tax to not be calculated.',
      p_solution               => 'You will need to fix these records.  Review Section 45 of [1316316.1#aref_section345] for more information.',
      p_success_msg            => 'The tax status EFFECTIVE_FROM date is in sync with the tax rate EFFECTIVE_FROM date.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_STATUS_DATES');



debug('begin add_signature: AR_EBTAX_MISSING_TAX_REGIME');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12692',
      p_sig_id                 => 'AR_EBTAX_MISSING_TAX_REGIME',
      p_sig_sql                => 'SELECT tax_regime_code,
   ...
   GROUP BY tax_regime_code',
      p_title                  => 'Missing Tax Regime for Upgraded Tax',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Tax under the specified regime cannot be calculated.',
      p_solution               => 'You will need to fix these records. Review Section 11 of [1316316.1#aref_section311] for more information.',
      p_success_msg            => 'There is no missing tax regime for the upgraded tax.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_MISSING_TAX_REGIME');



debug('begin add_signature: AR_EBTAX_MISSING_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12694',
      p_sig_id                 => 'AR_EBTAX_MISSING_STATUS',
      p_sig_sql                => 'SELECT tax_regime_code,
      tax,
      tax_status_code,
    ...
    GROUP BY tax_regime_code,
      tax,
      tax_status_code',
      p_title                  => 'Tax Status for Upgraded Taxes',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are missing tax statuses for the migrated tax.<br>
There will be no tax calculation for regime (##$$TAXREGIME$$##), tax (##$$TAX$$##) and status combinations.  ',
      p_solution               => 'You will need to fix these records. Review Section 11 of [1316316.1#aref_section311] for more information.',
      p_success_msg            => 'All combinations of regime (##$$TAXREGIME$$##), tax (##$$TAX$$##) and statuses have been upgraded to R12 successfully.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_MISSING_STATUS');



debug('begin add_signature: AR_EBTAX_MISSING_TEMPLATE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12698',
      p_sig_id                 => 'AR_EBTAX_MISSING_TEMPLATE',
      p_sig_sql                => 'SELECT *
    FROM
    ...
    WHERE a.regime_count = 0',
      p_title                  => 'Determining Factor Template Code',
      p_fail_condition         => '[regime_count] = [0]',
      p_problem_descr          => 'There is no TAXREGIME template available as a determing factor template. This will cause tax not to calculate after upgrade.',
      p_solution               => 'You will need to fix these records. Review [1151483.1] R12: Regime Determination Set LoV displays only STCC value as Determine Applicable Regimes for more information.',
      p_success_msg            => 'TAXREGIME template is available as a determining factor template code.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_MISSING_TEMPLATE');



debug('begin add_signature: AR_EBTAX_DUP_CLASSIFICATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14226',
      p_sig_id                 => 'AR_EBTAX_DUP_CLASSIFICATION',
      p_sig_sql                => 'Select tcc_mapping_id,org_id,org_id,tax_class,tax_rate_code_id,tax_classification_code 
FROM zx_id_tcc_mapping_all tcc
WHERE EXISTS 
(SELECT 1 FROM zx_rates_b rate 
 WHERE rate.tax_rate_id = tcc.tax_rate_code_id 
 AND rate.rate_type_code = ''RECOVERY'')',
      p_title                  => 'Duplicate Tax Classification Codes',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are duplicate tax classification codes.<br>
This will cause an issue when creating additional tax classification codes.
',
      p_solution               => 'You will need to fix this data.<br>
Review [1439301.1] Tax Setup Issue: Not All Tax Classification Codes are Shown When Querying ZX_INPUT_CLASSIFICATIONS and/or ZX_OUTPUT_CLASSIFICATIONS for more information.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_DUP_CLASSIFICATION');



debug('begin add_signature: AR_EBTAX_WRONG_ZX_FC_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14229',
      p_sig_id                 => 'AR_EBTAX_WRONG_ZX_FC_TYPES',
      p_sig_sql                => 'SELECT CLASSIFICATION_TYPE_CODE,CLASSIFICATION_TYPE_CATEG_CODE,OWNER_TABLE_CODE,OWNER_ID_CHAR
from zx_fc_types_b 
where CLASSIFICATION_TYPE_CATEG_CODE = ''PARTY_FISCAL_CLASS''
and owner_id_char = ''AR_GTA_TAXPAYER_TYPE''',
      p_title                  => 'Invalid Type Code in ZX_FC_TYPES_B',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The RECORD_TYPE_CODE in the X_FC_TYPES_B table is incorrectly defined as USER_DEFINED.  This will cause an exception details error when trying to update the party classification for AR_GTA_TAXPAYER_TYPE.',
      p_solution               => 'You will need to fix this data.<br>
Review [2464269.1] PARTY CLASSIFICATION DEFINING AR_GTA_TAXPAYER_TYPE ERRORS WITH ORA-06512: AT APPS.ZX_FC_TYPES_PKG for more information.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_WRONG_ZX_FC_TYPES');



debug('begin add_signature: AR_EBTAX_TRIGGERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12624',
      p_sig_id                 => 'AR_EBTAX_TRIGGERS',
      p_sig_sql                => 'select   trigger_name, table_name, status, owner
from     dba_triggers
where    table_name like ''ZX%''',
      p_title                  => 'ZX Triggers',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This is a data collection of records in DBA_TRIGGERS for ZX Tables',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_TRIGGERS');



debug('begin add_signature: AR_EBTAX_PROFILES');
   l_info('##MASK##LEVEL VALUE'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12623',
      p_sig_id                 => 'AR_EBTAX_PROFILES',
...
10003, c.responsibility_name, 10004, ##$$A$$##.mask_text(d.user_name,''##$$M$$##'')) "Level Value",
c.responsibility_id
...
AND nvl(c.LANGUAGE,''US'') = ''US''',
      p_title                  => 'E-Business Tax Profiles',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the E-Business Tax Profiles',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_PROFILES');
...
debug('begin add_signature: AR_EBTAX_SETUP_CONFIGURATION_OWNER_TAX_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12522',
      p_sig_id                 => 'AR_EBTAX_SETUP_CONFIGURATION_OWNER_TAX_OPTIONS',
      p_sig_sql                => 'SELECT EventClassTaxOptionEO.EVENT_CLASS_OPTIONS_ID, 
       EventClassTaxOptionEO.EVENT_CLASS_CODE, 
       EventClassTaxOptionEO.APPLICATION_ID, 
       EventClassTaxOptionEO.ENTITY_CODE, 
       EventClassTaxOptionEO.DET_FACTOR_TEMPL_CODE, 
       EventClassTaxOptionEO.DEFAULT_ROUNDING_LEVEL_CODE, 
       EventClassTaxOptionEO.ROUNDING_LEVEL_HIER_1_CODE, 
       EventClassTaxOptionEO.ROUNDING_LEVEL_HIER_2_CODE, 
       EventClassTaxOptionEO.ROUNDING_LEVEL_HIER_3_CODE, 
       EventClassTaxOptionEO.ROUNDING_LEVEL_HIER_4_CODE, 
       EventClassTaxOptionEO.ALLOW_MANUAL_LIN_RECALC_FLAG, 
       EventClassTaxOptionEO.ALLOW_OVERRIDE_FLAG, 
       EventClassTaxOptionEO.ALLOW_MANUAL_LINES_FLAG, 
       EventClassTaxOptionEO.PERF_ADDNL_APPL_FOR_IMPRT_FLAG, 
       EventClassTaxOptionEO.EFFECTIVE_FROM, 
       EventClassTaxOptionEO.EFFECTIVE_TO, 
       EventClassTaxOptionEO.ENABLED_FLAG, 
       EventClassTaxOptionEO.FIRST_PTY_ORG_ID, 
       EventClassTaxOptionEO.ENFORCE_TAX_FROM_ACCT_FLAG, 
       EventClassTaxOptionEO.TAX_TOLERANCE, 
       EventClassTaxOptionEO.TAX_TOL_AMT_RANGE, 
       EventClassTaxOptionEO.OFFSET_TAX_BASIS_CODE, 
       PartyTaxProfileEO.PARTY_TAX_PROFILE_ID, 
       ''ZX_ROUNDING_LEVEL'' AS LOOKUP_TYPE, 
       EventClassTaxOptionEO.DEFAULT_ROUNDING_LEVEL_CODE AS LOOKUP_CODE, 
       zx_util_pkg.get_lookup_meaning(''ZX_ROUNDING_LEVEL'', EventClassTaxOptionEO.DEFAULT_ROUNDING_LEVEL_CODE) DefaultRoundingLevelName,
       ''ZX_ROUND_LEVEL_HIER'' AS LOOKUP_TYPE1, 
       EventClassTaxOptionEO.ROUNDING_LEVEL_HIER_1_CODE  AS LOOKUP_CODE1, 
       zx_util_pkg.get_lookup_meaning(''ZX_ROUND_LEVEL_HIER'', EventClassTaxOptionEO.ROUNDING_LEVEL_HIER_1_CODE) FirstLevelRoundingName,
       ''ZX_ROUND_LEVEL_HIER'' AS LOOKUP_TYPE2, 
       EventClassTaxOptionEO. ROUNDING_LEVEL_HIER_2_CODE AS LOOKUP_CODE2, 
       zx_util_pkg.get_lookup_meaning(''ZX_ROUND_LEVEL_HIER'', EventClassTaxOptionEO. ROUNDING_LEVEL_HIER_2_CODE) SecondLevelRoundingName,
       ''ZX_ROUND_LEVEL_HIER'' AS LOOKUP_TYPE3, 
       EventClassTaxOptionEO.ROUNDING_LEVEL_HIER_3_CODE AS LOOKUP_CODE3, 
       zx_util_pkg.get_lookup_meaning(''ZX_ROUND_LEVEL_HIER'', EventClassTaxOptionEO.ROUNDING_LEVEL_HIER_3_CODE) ThirdLevelRoundingName,
       ''ZX_ROUND_LEVEL_HIER'' AS LOOKUP_TYPE4, 
       EventClassTaxOptionEO.ROUNDING_LEVEL_HIER_4_CODE AS LOOKUP_CODE4, 
       zx_util_pkg.get_lookup_meaning(''ZX_ROUND_LEVEL_HIER'', EventClassTaxOptionEO.ROUNDING_LEVEL_HIER_4_CODE) FourthLevelRoundingName,
       FndApplicationEO.APPLICATION_ID AS APPLICATION_ID1, 
       FndApplicationEO.APPLICATION_NAME, 
       XlaEntityTypeEO.APPLICATION_ID AS APPLICATION_ID2, 
       XlaEntityTypeEO.ENTITY_CODE AS ENTITY_CODE1, 
       XlaEntityTypeEO.NAME AS ENTITY_NAME, 
       XlaEventClassEO.APPLICATION_ID AS APPLICATION_ID3, 
       ...
       ''ZX_OFFSET_TAX_BASIS'' AS LOOKUP_TYPE5, 
       EventClassTaxOptionEO.OFFSET_TAX_BASIS_CODE AS LOOKUP_CODE5, 
       zx_util_pkg.get_lookup_meaning(''ZX_OFFSET_TAX_BASIS'',EventClassTaxOptionEO.OFFSET_TAX_BASIS_CODE) OffsetTaxBasisName,
       DetFactorTempl_tl.DET_FACTOR_TEMPL_ID, 
       DetFactorTempl_tl.DET_FACTOR_TEMPL_NAME AS DriverTemplateName, 
       DetFactorTempl_b.DET_FACTOR_TEMPL_CODE AS DriverTemplateCode, 
       EventClassTaxOptionEO.PROCESS_FOR_APPLICABILITY_FLAG, 
       EventClassTaxOptionEO.CTRL_EFF_OVRD_CALC_LINES_FLAG, 
       EventClassTaxOptionEO.ENTER_OVRD_INCL_TAX_LINES_FLAG, 
       EventClassTaxOptionEO.ALLOW_OFFSET_TAX_CALC_FLAG, 
       EventClassTaxOptionEO.ENFORCE_TAX_FROM_REF_DOC_FLAG, 
       EventClassTaxOptionEO.ALLOW_EXEMPTIONS_FLAG, 
       EventClassTaxOptionEO.EXMPTN_PTY_BASIS_HIER_1_CODE, 
       EventClassTaxOptionEO.EXMPTN_PTY_BASIS_HIER_2_CODE, 
       EventClassMappings.PROD_FAMILY_GRP_CODE
FROM ZX_EVNT_CLS_OPTIONS EventClassTaxOptionEO, 
     ZX_EVNT_CLS_MAPPINGS EventClassMappings,
     ZX_PARTY_TAX_PROFILE PartyTaxProfileEO, 
     XLA_ENTITY_TYPES_VL XlaEntityTypeEO, 
     XLA_EVENT_CLASSES_VL XlaEventClassEO, 
     FND_APPLICATION_VL FndApplicationEO, 
     ZX_DET_FACTOR_TEMPL_TL DetFactorTempl_tl,
     ZX_DET_FACTOR_TEMPL_B DetFactorTempl_b
WHERE 
     EventClassTaxOptionEO.FIRST_PTY_ORG_ID = PartyTaxProfileEO.PARTY_TAX_PROFILE_ID
AND  EventClassTaxOptionEO.EVENT_CLASS_CODE = XlaEventClassEO.EVENT_CLASS_CODE
AND  EventClassTaxOptionEO.APPLICATION_ID = XlaEventClassEO.APPLICATION_ID
AND  EventClassTaxOptionEO.ENTITY_CODE = XlaEventClassEO.ENTITY_CODE
AND  EventClassTaxOptionEO.APPLICATION_ID = FndApplicationEO.APPLICATION_ID
AND  EventClassTaxOptionEO.ENTITY_CODE = XlaEntityTypeEO.ENTITY_CODE
AND  EventClassTaxOptionEO.APPLICATION_ID = XlaEntityTypeEO.APPLICATION_ID
AND  EventClassTaxOptionEO.DET_FACTOR_TEMPL_CODE = DetFactorTempl_b.Det_Factor_Templ_Code(+)
AND  DetFactorTempl_b.DET_FACTOR_TEMPL_ID = DetFactorTempl_tl.DET_FACTOR_TEMPL_ID
AND  DetFactorTempl_tl.LANGUAGE = userenv(''LANG'')
AND  PartyTaxProfileEO.party_tax_profile_id = ''##$$CO_ID$$##''
AND  EventClassTaxOptionEO.EVENT_CLASS_CODE = EventClassMappings.EVENT_CLASS_CODE
AND  EventClassTaxOptionEO.APPLICATION_ID = EventClassMappings.APPLICATION_ID
AND  EventClassTaxOptionEO.ENTITY_CODE = EventClassMappings.ENTITY_CODE',
      p_title                  => 'Configuration Owner Tax Options',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no configuration owner tax options for this content owner (##$$CO_ID$$##).',
      p_solution               => 'Review Section 6 of [1082172.1#aref_section26] How to Troubleshoot a Tax That Does Not Calculate in R12 E-Business Tax (EBTAX) for more information.',
      p_success_msg            => 'This is the configuration owner tax options for the content owner (##$$CO_ID$$##).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_SETUP_CONFIGURATION_OWNER_TAX_OPTIONS');



debug('begin add_signature: AR_EBTAX_PARTY_TAX_PROFILE');
   l_info('##MASK##REP_REGISTRATION_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12524',
      p_sig_id                 => 'AR_EBTAX_PARTY_TAX_PROFILE',
      p_sig_sql                => 'SELECT ZxPartyTaxProfile.PARTY_TYPE_CODE, 
ZxPartyTaxProfile.SUPPLIER_FLAG, 
ZxPartyTaxProfile.CUSTOMER_FLAG, 
ZxPartyTaxProfile.SITE_FLAG, 
ZxPartyTaxProfile.PROCESS_FOR_APPLICABILITY_FLAG, 
ZxPartyTaxProfile.ROUNDING_LEVEL_CODE, 
ZxPartyTaxProfile.ROUNDING_RULE_CODE, 
ZxPartyTaxProfile.WITHHOLDING_START_DATE, 
ZxPartyTaxProfile.INCLUSIVE_TAX_FLAG, 
ZxPartyTaxProfile.ALLOW_AWT_FLAG, 
ZxPartyTaxProfile.USE_LE_AS_SUBSCRIBER_FLAG, 
ZxPartyTaxProfile.LEGAL_ESTABLISHMENT_FLAG, 
ZxPartyTaxProfile.FIRST_PARTY_LE_FLAG, 
ZxPartyTaxProfile.REPORTING_AUTHORITY_FLAG, 
ZxPartyTaxProfile.COLLECTING_AUTHORITY_FLAG, 
ZxPartyTaxProfile.PROVIDER_TYPE_CODE, 
ZxPartyTaxProfile.CREATE_AWT_DISTS_TYPE_CODE, 
ZxPartyTaxProfile.CREATE_AWT_INVOICES_TYPE_CODE, 
ZxPartyTaxProfile.TAX_CLASSIFICATION_CODE, 
ZxPartyTaxProfile.SELF_ASSESS_FLAG, 
ZxPartyTaxProfile.ALLOW_OFFSET_TAX_FLAG, 
ZxPartyTaxProfile.EFFECTIVE_FROM_USE_LE, 
ZxPartyTaxProfile.RECORD_TYPE_CODE, 
ZxPartyTaxProfile.PARTY_TAX_PROFILE_ID, 
ZxPartyTaxProfile.PARTY_ID, 
ZxPartyTaxProfile.REP_REGISTRATION_NUMBER, 
ZxPartyTaxProfile.REGISTRATION_TYPE_CODE, 
ZxPartyTaxProfile.COUNTRY_CODE, 
ZxPartyTaxProfile.MERGED_TO_PTP_ID, 
ZxPartyTaxProfile.MERGED_STATUS_CODE  
FROM ZX_PARTY_TAX_PROFILE ZxPartyTaxProfile 
WHERE ZxPartyTaxProfile.PARTY_TAX_PROFILE_ID = ''##$$CO_ID$$##''',
      p_title                  => 'Party Tax Profile Associated to Content Owner',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no party tax profile for the content owner (##$$CO_ID$$##) subscribed to the regime (##$$TAXREGIME$$##).',
      p_solution               => 'Please review the location name subscribed to the regime (##$$TAXREGIME$$##).

Review [2229550.1] Unable to Create a Party Tax Profile for a newly defined Operating Unit for more information.',
      p_success_msg            => 'Displaying the party tax profile for the content owner (##$$CO_ID$$##) subscribed to the regime (##$$TAXREGIME$$##).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_PARTY_TAX_PROFILE');



debug('begin add_signature: AR_EBTAX_THIRD_PARTY_TAX_PARTNER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12018',
      p_sig_id                 => 'AR_EBTAX_THIRD_PARTY_TAX_PARTNER',
      p_sig_sql                => 'select zl.tax_line_id,zl.trx_id,zl.TRX_LINE_ID,zl.TAX_PROVIDER_ID,zl.application_id from zx_lines zl, RA_CUSTOMER_TRX_ALL RA 
WHERE ZL.trx_id = RA.CUSTOMER_TRX_ID AND ZL.application_id = ''222''
and CUSTOMER_TRX_ID =##$$TRXID$$##',
      p_title                  => 'Third Party Tax Partner Information',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Displaying the third party tax partner value used for the tax calculation for this CUSTOMER_TRX_ID (##$$TRXID$$##).

',
      p_solution               => 'Review if a tax partner used for this regime (##$$TAXREGIME$$##).<br>
See [2492788.1] R12 How to Determine what Tax Engine was used to Calculate Tax on an Invoice.',
      p_success_msg            => 'This transaction (CUSTOMER_TRX_ID ##$$TRXID$$##) does not have a third party tax partner assigned (TAX_PROVIDER_ID = NULL).<br>
If this is not correct, you may not have the third party information installed properly.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_THIRD_PARTY_TAX_PARTNER');



debug('begin add_signature: AR_EBTAX_THIRD_PARTY_EXEMPTION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12022',
      p_sig_id                 => 'AR_EBTAX_THIRD_PARTY_EXEMPTION',
      p_sig_sql                => 'select zl.tax_line_id,zl.trx_id,zl.TRX_LINE_ID,zl.TAX_PROVIDER_ID,zl.EXEMPT_RATE_MODIFIER,zl.application_id from zx_lines zl, RA_CUSTOMER_TRX_ALL RA 
WHERE ZL.trx_id = RA.CUSTOMER_TRX_ID AND ZL.application_id = ''222''
and CUSTOMER_TRX_ID =##$$TRXID$$##',
      p_title                  => 'Third Party Tax Exemption',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This is third party exemption information. <br>
If the EXEMPT_RATE_MODIFIER is 0, then the third party exemption is honored.

',
      p_solution               => 'There may be a third party exemption that is preventing tax from calculating on this transaction.<br> 
Review [2434067.1] Tax Not Calculated on Invoices with Taxware Integration for more information.',
      p_success_msg            => 'Third party exemption value.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_THIRD_PARTY_EXEMPTION');



debug('begin add_signature: AR_EBTAX_DUP_TAX_DISTRIBUTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14671',
      p_sig_id                 => 'AR_EBTAX_DUP_TAX_DISTRIBUTIONS',
      p_sig_sql                => 'SELECT
    rca.org_id,
    rca.trx_number,
    rca.trx_date,
    ...
    COUNT(*),
    MAX(rctl.customer_trx_line_id) customer_trx_line_id
FROM
    apps.ra_customer_trx_lines_all   rctl,
    ra_cust_trx_line_gl_dist_all     rcgd,
    ra_customer_trx_all              rca
WHERE
    rctl.customer_trx_line_id = rcgd.customer_trx_line_id
    AND rctl.customer_trx_id = rcgd.customer_trx_id
    AND rca.customer_trx_id = rctl.customer_trx_id
    AND rctl.line_type = ''TAX''
    AND rcgd.comments IS NOT NULL
  -- AND rca.customer_trx_id = nvl(p_customer_trx_id, rca.customer_trx_id)
AND rca.org_id = ##$$ORGID$$##
    AND nvl(rctl.interface_line_context, ''##'') = nvl(''ORDER ENTRY'', nvl(rctl.interface_line_context, ''##''))
GROUP BY
    rca.org_id,
    rca.trx_number,
    rctl.customer_trx_id,
...
HAVING
  ...
  ORDER BY 1,2,3,4,5,6,7',
      p_title                  => 'Duplicate Tax Distributions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'You have duplicate tax distributions.  This occurs if a change made to a transaction is completed before saved.
',
      p_solution               => '<ul><li>The analyzer has identified data corruption described in [2192599.2]</li>
<li>Please log a Service Request and upload this analyzer output.</li>
</ul>
',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_DUP_TAX_DISTRIBUTIONS');



debug('begin add_signature: AR_EBTAX_INTEGRITY_ AR_EBTAX_CANNOT_CREDIT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12502',
      p_sig_id                 => 'AR_EBTAX_INTEGRITY_ AR_EBTAX_CANNOT_CREDIT',
      p_sig_sql                => 'SELECT LINES.TAX_LINE_ID, 
LINES.CUSTOMER_TRX_LINE_ID, 
VAT.TAX_RATE
FROM RA_CUSTOMER_TRX_ALL HDR,
RA_CUSTOMER_TRX_LINES_ALL LINES,
AR_VAT_TAX_ALL VAT
WHERE HDR.ORG_ID = ##$$ORGID$$##
AND LINES.CUSTOMER_TRX_ID = HDR.CUSTOMER_TRX_ID
AND LINES.ORG_ID = HDR.ORG_ID
AND LINES.LINE_TYPE = ''TAX''
AND LINES.TAX_RATE IS NULL
AND VAT.VAT_TAX_ID = LINES.VAT_TAX_ID
AND VAT.TAX_RATE IS NOT NULL',
      p_title                  => 'Migrated Invoice with Incorrect Tax Code',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'You have missing 11i tax rates in ZX_RATES_B for migrated invoices.  This will prevent any actions to be performed on the transaction(s) (ie. credit).',
      p_solution               => 'You will need to fix the migrated records.  Review [1485382.1] for more information.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_INTEGRITY_ AR_EBTAX_CANNOT_CREDIT');



debug('begin add_signature: AR_EBTAX_INTEGRITY_ MISSING_PARTY_TAX_PROFILE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12504',
      p_sig_id                 => 'AR_EBTAX_INTEGRITY_ MISSING_PARTY_TAX_PROFILE',
      p_sig_sql                => 'SELECT DISTINCT USG.TAX_REGIME_CODE
FROM ZX_REGIMES_USAGES USG,
ZX_PARTY_TAX_PROFILE PTP
WHERE PTP.PARTY_TYPE_CODE = ''OU''
AND PTP.PARTY_ID = ##$$ORGID$$##
AND USG.FIRST_PTY_ORG_ID = PTP.PARTY_TAX_PROFILE_ID
AND NOT EXISTS(SELECT 1 FROM ZX_SRVC_SUBSCRIPTIONS SRVC
WHERE SRVC.REGIME_USAGE_ID = USG.REGIME_USAGE_ID
AND SRVC.PROD_FAMILY_GRP_CODE = ''O2C''
AND SRVC.ENABLED_FLAG = ''Y'')',
      p_title                  => 'Missing Party Tax Profiles',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are missing party tax profiles after your migration to R12.  This will prevent any actions to be performed on the transaction(s).',
      p_solution               => 'A datafix may be required to fix the migrated records.  Please review Section 4 of [1918588.1#aref_section34] for more information.
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_EBTAX_INTEGRITY_ MISSING_PARTY_TAX_PROFILE');
...
BEGIN
  ...
  analyzer_title := 'Order to Cash E-Business Tax Analyzer';
...
debug('begin section: AR_EBTAX_TAX_DATA');
start_section('Tax Data', 'AR_EBTAX_TAX_DATA');
   set_item_result(run_stored_sig('AR_EBTAX_SETUP_TAX_REGIME'));
   IF g_co_id is not null THEN
      set_item_result(run_stored_sig('AR_EBTAX_SETUP_CONFIGURATION_OWNER_TAX_OPTIONS'));
      set_item_result(run_stored_sig('AR_EBTAX_PARTY_TAX_PROFILE'));
   END IF;
   set_item_result(run_stored_sig('AR_EBTAX_SETUP_TAX_REGIME_SUBCRIPTIONS'));
   set_item_result(run_stored_sig('AR_EBTAX_SETUP_TAX'));
   set_item_result(run_stored_sig('AR_EBTAX_TAX_STATUS'));
   set_item_result(run_stored_sig('AR_EBTAX_TAX_RATES'));
   set_item_result(run_stored_sig('AR_EBTAX_EFFECTIVE_TAX_RATE_RANGE'));
   set_item_result(run_stored_sig('AR_EBTAX_SETUP_TAX_JURISDICTIONS'));
   set_item_result(run_stored_sig('AR_EBTAX_WRONG_TAX_JURISDICTION_START_DATE'));
   set_item_result(run_stored_sig('AR_EBTAX_SETUP_TAX_RULES'));
   set_item_result(run_stored_sig('AR_EBTAX_SETUP_TAX_ACCOUNTS'));
end_section;
debug('end section: AR_EBTAX_TAX_DATA');

debug('begin section: AR_EBTAX_CUSTOMER_DATA');
IF g_party_id is not null THEN
   start_section('Customer Data', 'AR_EBTAX_CUSTOMER_DATA');
      ...
      set_item_result(run_stored_sig('TCA_HZ_PARTY_SITES_CUSTOMER'));
      set_item_result(run_stored_sig('TCA_HZ_PARTY_SITE_USES_CUSTOMER'));
      set_item_result(run_stored_sig('TCA_HZ_LOCATIONS_CUSTOMER'));
      set_item_result(run_stored_sig('TCA_HZ_GEOGRAPHIES'));
      set_item_result(run_stored_sig('TCA_HZ_GEO_NAME_REFERENCE_LOG'));
      ...
      set_item_result(run_stored_sig('AR_EBTAX_PARTY_ID_TAX_PROFILE'));
      set_item_result(run_stored_sig('AR_EBTAX_THIRD_PARTY_SITE_TAX_PROFILE'));
      set_item_result(run_stored_sig('AR_EBTAX_PARTY_FISCAL_CLASSIFICATION_CODE'));
   end_section;
END IF;
debug('end section: AR_EBTAX_CUSTOMER_DATA');

debug('begin section: AR_EBTAX_TRANSACTION_DATA');
IF g_customer_trx_id is not null THEN
   start_section('Transaction Data', 'AR_EBTAX_TRANSACTION_DATA');
      set_item_result(run_stored_sig('AR_TRX_SUMMARY_INFO'));
      set_item_result(run_stored_sig('AR_TRX_RA_CUSTOMER_TRX_ALL'));
      set_item_result(run_stored_sig('AR_TRX_RA_CUSTOMER_TRX_LINES_ALL'));
      set_item_result(run_stored_sig('AR_TRX_RA_CUSTOMER_TRX_LINES_ALL_TOTALS'));
      set_item_result(run_stored_sig('AR_TRX_RA_CUST_TRX_LINE_GL_DIST_ALL'));
      set_item_result(run_stored_sig('AR_TRX_AR_DIST_TO_TRX'));
      set_item_result(run_stored_sig('AR_TRX_AR_ADJUSTMENTS_ALL'));
      set_item_result(run_stored_sig('AR_TRX_ADJUSTMENT_DIST'));
      set_item_result(run_stored_sig('AR_TRX_RA_CUST_TRX_TYPES_ALL'));
      set_item_result(run_stored_sig('AR_TRX_MTL_SYSTEM_ITEMS_B'));
      set_item_result(run_stored_sig('AR_TRX_APPLICATIONS_TO'));
      set_item_result(run_stored_sig('AR_TRX_AR_PAYMENT_SCHEDULES_ALL'));
      set_item_result(run_stored_sig('AR_TRX_APPLICATIONS_TO_TOTALS'));
      set_item_result(run_stored_sig('AR_TRX_ZX_LINES'));
      set_item_result(run_stored_sig('AR_TRX_ZX_LINES_DET_FACTORS'));
      set_item_result(run_stored_sig('AR_EBTAX_CUST_ZX_TAX_EXEMPTION'));
      set_item_result(run_stored_sig('AR_EBTAX_TRX_TAX_RULES'));
      set_item_result(run_stored_sig('AR_EBTAX_TAX_RULES_DETAILS'));
      set_item_result(run_stored_sig('AR_EBTAX_RULES_CONDITION_SETS'));
      set_item_result(run_stored_sig('AR_TRX_AR_00022_MISS_TAX_LINES'));
      set_item_result(run_stored_sig('AR_TRX_AR_00104_MISS_TAX'));
      set_item_result(run_stored_sig('AR_EBTAX_CUST_HQ_ESTB_REG_NUMBER'));
   end_section;
END IF;
debug('end section: AR_EBTAX_TRANSACTION_DATA');

debug('begin section: AR_EBTAX_PARTNER_INTEGRATION');
start_section('Partner Integration', 'AR_EBTAX_PARTNER_INTEGRATION');
   set_item_result(run_stored_sig('AR_EBTAX_THIRD_PARTY_SERVICE_SUBSCRIPTION'));
   set_item_result(run_stored_sig('AR_EBTAX_THIRD_PARTY_TAXFILE_INFO'));
   IF g_customer_trx_id is not null THEN
      set_item_result(run_stored_sig('AR_EBTAX_THIRD_PARTY_TAX_PARTNER'));
      set_item_result(run_stored_sig('AR_EBTAX_THIRD_PARTY_EXEMPTION'));
   END IF;
end_section;
debug('end section: AR_EBTAX_PARTNER_INTEGRATION');

debug('begin section: AR_EBTAX_DATA_INTEGRITY');
start_section('Tax Data Integrity', 'AR_EBTAX_DATA_INTEGRITY');
   set_item_result(run_stored_sig('AR_EBTAX_MIGRATED_TAX_GROUPS'));
   set_item_result(run_stored_sig('AR_EBTAX_JURISDICTION_DATES'));
   set_item_result(run_stored_sig('AR_EBTAX_STATUS_DATES'));
   set_item_result(run_stored_sig('AR_EBTAX_MISSING_TAX_REGIME'));
   set_item_result(run_stored_sig('AR_EBTAX_MISSING_STATUS'));
   set_item_result(run_stored_sig('AR_EBTAX_MISSING_TEMPLATE'));
   IF g_org_id is not null THEN
      set_item_result(run_stored_sig('AR_EBTAX_DUP_TAX_DISTRIBUTIONS'));
      set_item_result(run_stored_sig('AR_EBTAX_INTEGRITY_ AR_EBTAX_CANNOT_CREDIT'));
      set_item_result(run_stored_sig('AR_EBTAX_INTEGRITY_ MISSING_PARTY_TAX_PROFILE'));
   END IF;
   set_item_result(run_stored_sig('AR_EBTAX_DUP_CLASSIFICATION'));
   set_item_result(run_stored_sig('AR_EBTAX_WRONG_ZX_FC_TYPES'));
end_section;
debug('end section: AR_EBTAX_DATA_INTEGRITY');

debug('begin section: CONSOLIDATED_SETUP');
start_section('Setup and Environment', 'CONSOLIDATED_SETUP');
   IF g_org_id is not null THEN
      set_item_result(run_stored_sig('AR_GEN_AR_SETUP_INFO'));
      set_item_result(run_stored_sig('AR_GEN_AR_SYSTEM_PARAMETERS'));
   ...
   END IF;
   set_item_result(run_stored_sig('AR_EBTAX_TRIGGERS'));
   set_item_result(run_stored_sig('AR_EBTAX_PROFILES'));
end_section;
...
debug('begin section: Critcal_Alerts');
start_section('Critical Alerts', 'Critcal_Alerts');
...
end_section;
debug('end section: Critcal_Alerts');
