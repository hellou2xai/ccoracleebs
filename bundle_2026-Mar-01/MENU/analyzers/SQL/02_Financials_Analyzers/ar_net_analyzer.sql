...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for AP/AR Netting Analyzer                 |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE ar_net_analyzer_pkg AUTHID DEFINER AS
...
(            p_user_name                    IN VARCHAR2    DEFAULT NULL
           ...
           ,p_net_batch_id                 IN NUMBER      DEFAULT NULL
...
END ar_net_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY ar_net_analyzer_pkg AS
-- $Id: ar_net_analyzer.sql, 200.13 2025/12/08 13:33:46 nchiaram Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2652174.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'ARNETANLZ_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'ARNETANLZ_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>ARNETANLZ Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2652174.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/ar_net_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,2695,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,2695,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},2695,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/mosc/discussion/4485783" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">2695</span>
...
<div class="ck-content"><p>What&apos;s new:</p><ul><li>Added signature <span class="display_only apex-item-display-only" id="P10_DISPLAY_NAME_DISPLAY" data-escape="true">Cross currency rate type is not defined in AR System Options</span></li>
</ul>
</div>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,2695,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,2695,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},2695,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
debug('begin populate parameters hash table');
   ...
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Agreement ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_agreement_id,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Netting Batch ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_net_batch_id,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'AR Customer Trx ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_customer_trx_id,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'AP Invoice ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_invoice_id,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'AP Check ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_check_id,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2025/12/08 13:33:45 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'ar_net_analyzer.sql';
...
debug('begin parameter validation: p_agreement_id');
IF p_agreement_id IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Agreement ID is required.');
   raise invalid_parameters;
END IF;
...
INTO l_exists_val
FROM FUN_NET_AGREEMENTS_ALL F, HR_OPERATING_UNITS O
WHERE F.AGREEMENT_ID = p_agreement_id
 AND f.org_id = o.organization_id
and (mo_global.is_mo_init_done = 'N' or mo_global.check_access(o.organization_id) = 'Y')
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Agreement.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_agreement_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_agreement_id');

debug('begin parameter validation: p_net_batch_id');
IF p_net_batch_id IS NOT NULL THEN
BEGIN
SELECT B.BATCH_ID
INTO l_exists_val
FROM FUN_NET_BATCHES_ALL B, HR_OPERATING_UNITS O
WHERE B.BATCH_ID = p_net_batch_id
 AND b.org_id = o.organization_id
and (mo_global.is_mo_init_done = 'N' or mo_global.check_access(o.organization_id) = 'Y')
and b.agreement_id = nvl(p_agreement_id, -1)
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Incorrect batch.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_net_batch_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_net_batch_id');
...
INTO l_exists_val
FROM RA_CUSTOMER_TRX_ALL TRX, HR_OPERATING_UNITS O
...
SELECT I.INVOICE_ID
INTO l_exists_val
FROM AP_INVOICES_ALL I, HR_OPERATING_UNITS O, AP_SUPPLIERS V, AP_SUPPLIER_SITES_ALL S
WHERE I.INVOICE_ID = p_invoice_id
 AND I.ORG_ID = O.ORGANIZATION_ID(+)
AND I.VENDOR_ID = V.VENDOR_ID(+)
AND I.VENDOR_SITE_ID = S.VENDOR_SITE_ID(+)
AND (mo_global.is_mo_init_done = 'N' or mo_global.check_access(I.ORG_ID) = 'Y')
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid invoice specified.');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
SELECT C.CHECK_ID
INTO l_exists_val
FROM AP_CHECKS_ALL C, HR_OPERATING_UNITS O
WHERE C.CHECK_ID = p_check_id
 AND C.ORG_ID = O.ORGANIZATION_ID(+)
AND (mo_global.is_mo_init_done = 'N' or mo_global.check_access(C.ORG_ID) = 'Y')
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid check specified.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_check_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
...
debug('begin populate sql tokens hash table');
   ...
   g_sql_tokens('##$$RESP_ID$$##') := p_resp_id;
   ...
   g_sql_tokens('##$$AGREEMENT_ID$$##') := p_agreement_id;
   g_masked_tokens('##$$AGREEMENT_ID$$##') := mask_text( g_sql_tokens('##$$AGREEMENT_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$ORGID$$##') := g_org_id_tmp;
   g_masked_tokens('##$$ORGID$$##') := mask_text( g_sql_tokens('##$$ORGID$$##'), 'NO_MASK');
   g_sql_tokens('##$$TRXID$$##') := p_customer_trx_id;
   g_masked_tokens('##$$TRXID$$##') := mask_text( g_sql_tokens('##$$TRXID$$##'), 'NO_MASK');
   g_sql_tokens('##$$BATCH_ID$$##') := p_net_batch_id;
   g_masked_tokens('##$$BATCH_ID$$##') := mask_text( g_sql_tokens('##$$BATCH_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$A$$##') := 'ar_net_analyzer_pkg';
   ...
   g_masked_tokens('##$$CHKID$$##') := mask_text( g_sql_tokens('##$$CHKID$$##'), 'NO_MASK');
...
debug('begin add_signature: AP_AR_NET_FUN_NET_AGREEMENTS_ALL');
   l_info('##MASK##APPROVER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14708',
      p_sig_id                 => 'AP_AR_NET_FUN_NET_AGREEMENTS_ALL',
      p_sig_sql                => 'SELECT fna.* 
FROM fun_net_agreements_all fna
WHERE fna.agreement_id = ##$$AGREEMENT_ID$$##',
      p_title                  => 'FUN_NET_AGREEMENTS_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no agreement Id = ##$$AGREEMENT_ID$$##.',
      p_solution               => 'Please review the section "Create a Netting Agreement" in [1399565.1#aref_section313].',
      p_success_msg            => 'Displaying the information in FUN_NET_AGREEMENTS_ALL for agreement Id = ##$$AGREEMENT_ID$$##.',
   ...
   l_info.delete;
debug('end add_signature: AP_AR_NET_FUN_NET_AGREEMENTS_ALL');



debug('begin add_signature: AP_AR_NET_FUN_NET_AP_INV_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14711',
      p_sig_id                 => 'AP_AR_NET_FUN_NET_AP_INV_TYPES',
      p_sig_sql                => 'SELECT apin.* 
FROM fun_net_ap_inv_types_all apin
WHERE apin.agreement_id = ##$$AGREEMENT_ID$$##
ORDER By apin.invoice_type',
      p_title                  => 'FUN_NET_AP_INV_TYPES_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no AP invoice types assigned to agreement Id = ##$$AGREEMENT_ID$$##.',
      p_solution               => 'Please review the section "Create a Netting Agreement" in [1399565.1#aref_section313].',
      p_success_msg            => 'Displaying AP invoice types assigned to agreement Id = ##$$AGREEMENT_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AP_AR_NET_FUN_NET_AP_INV_TYPES');



debug('begin add_signature: AP_AR_NET_FUN_NET_AR_TRX_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14712',
      p_sig_id                 => 'AP_AR_NET_FUN_NET_AR_TRX_TYPES',
      p_sig_sql                => 'SELECT att.* 
FROM fun_net_ar_trx_types_all att
WHERE att.agreement_id = ##$$AGREEMENT_ID$$##
ORDER BY att.cust_trx_type_id',
      p_title                  => 'FUN_NET_AR_TRX_TYPES_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no AR transaction types assigned to agreement Id = ##$$AGREEMENT_ID$$##.',
      p_solution               => 'Please review the section "Create a Netting Batch" in [1399565.1#aref_section313].',
      p_success_msg            => 'Displaying AR transaction types assigned to agreement Id = ##$$AGREEMENT_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AP_AR_NET_FUN_NET_AR_TRX_TYPES');



debug('begin add_signature: AP_AR_NET_FUN_NET_CUSTOMERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14709',
      p_sig_id                 => 'AP_AR_NET_FUN_NET_CUSTOMERS',
      p_sig_sql                => 'SELECT fnc.*, fnc.cust_account_id "##$$FK3$$##"
FROM fun_net_customers_all fnc
WHERE fnc.agreement_id = ##$$AGREEMENT_ID$$##
ORDER BY fnc.cust_priority',
      p_title                  => 'FUN_NET_CUSTOMERS_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no customers assigned to agreement Id = ##$$AGREEMENT_ID$$##.',
      p_solution               => 'Please review the section "Create a Netting Agreement" in [1399565.1#aref_section313].',
      p_success_msg            => 'Displaying customers assigned to agreement Id = ##$$AGREEMENT_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AP_AR_NET_FUN_NET_CUSTOMERS');



debug('begin add_signature: AP_AR_NET_FUN_NET_SUPPLIERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14710',
      p_sig_id                 => 'AP_AR_NET_FUN_NET_SUPPLIERS',
      p_sig_sql                => 'SELECT fns.*, fns.supplier_id "##$$FK2$$##"
FROM fun_net_suppliers_all fns
WHERE fns.agreement_id = ##$$AGREEMENT_ID$$##
ORDER BY fns.supplier_priority',
      p_title                  => 'FUN_NET_SUPPLIERS_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no suppliers assigned to agreement Id = ##$$AGREEMENT_ID$$##.',
      p_solution               => 'Please review the section "Create a Netting Batch" in [1399565.1#aref_section313].',
      p_success_msg            => 'Displaying suppliers assigned to agreement Id = ##$$AGREEMENT_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AP_AR_NET_FUN_NET_SUPPLIERS');



debug('begin add_signature: AP_AR_NET_ACCOUNT_END_DATED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14822',
      p_sig_id                 => 'AP_AR_NET_ACCOUNT_END_DATED',
      p_sig_sql                => 'SELECT c.bank_account_name, c.start_date, c.end_date
FROM CE_BANK_ACCOUNTS c
WHERE c.bank_account_id IN
(SELECT f.bank_account_id
 FROM FUN_NET_AGREEMENTS_ALL  f
 WHERE f.agreement_id = ##$$AGREEMENT_ID$$##)
AND nvl(end_date, sysdate+1) <= sysdate',
      p_title                  => 'Bank  Account is End-Dated',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The bank account assigned to agreement Id ##$$AGREEMENT_ID$$## is end dated.',
      p_solution               => '<ul>
<li>Please remove the end date for the bank account assigned to this netting agreement or change the bank account.</li>
<li>Read the section "Associate your Bank Account to The Receipt Class AP/AR Netting in Receivables" in [1399565.1#aref_section36].</li>
</ul>',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: AP_AR_NET_ACCOUNT_END_DATED');



debug('begin add_signature: AP_AR_NET_CE_BANK_ACCOUNTS');
   l_info('##MASK##BANK_ACCOUNT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14804',
      p_sig_id                 => 'AP_AR_NET_CE_BANK_ACCOUNTS',
      p_sig_sql                => 'SELECT bank_account_name, 
       ap_use_allowed_flag "Use in Payables", 
       ar_use_allowed_flag "Use in Receivables", 
       netting_acct_flag,
       start_date, 
       end_date,
...
(SELECT f.bank_account_id
 ...
 WHERE agreement_id = ##$$AGREEMENT_ID$$##)',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The bank account associated to the agreement does not exist.',
      p_solution               => 'Please review the section "Define a Netting Bank Account in Payables" in [1399565.1#aref_section35].',
      p_success_msg            => 'Displaying the information of the bank account related to this netting agreement. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AP_AR_NET_CE_BANK_ACCOUNTS');



debug('begin add_signature: AP_AR_NET_STUCK_ CREATE_NETTING_BATCH_PROGRAM');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14852',
      p_sig_id                 => 'AP_AR_NET_STUCK_ CREATE_NETTING_BATCH_PROGRAM',
      p_sig_sql                => 'select REQUEST_ID,REQUEST_DATE,STATUS_CODE,ORACLE_ID,PROGRAM_APPLICATION_ID,CONCURRENT_PROGRAM_ID,RESPONSIBILITY_ID,PARENT_REQUEST_ID,ORACLE_PROCESS_ID,ORACLE_SESSION_ID 
from fnd_concurrent_requests 
where 
 concurrent_program_id in 
  (SELECT p.concurrent_program_id FROM FND_CONCURRENT_PROGRAM_SERIAL s, fnd_concurrent_programs_tl p 
    WHERE (s.to_run_application_id in 
             (select application_id from fnd_concurrent_programs_tl where user_concurrent_program_name=''Create Netting Batch''))
    and   (s.to_run_concurrent_program_id in 
             (select concurrent_program_id from fnd_concurrent_programs_tl where user_concurrent_program_name=''Create Netting Batch''))
  and s.running_concurrent_program_id=p.concurrent_program_id
  )
and phase_code <> ''C''',
      p_title                  => 'Create Netting Batch Program is Incompatible to Itself',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Create netting batch has been set as incompatible to itself. This can cause the program to get stuck in Pending Standby status and not complete. ',
      p_solution               => 'Please review [2270154.1] for solution.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AP_AR_NET_STUCK_ CREATE_NETTING_BATCH_PROGRAM');



debug('begin add_signature: AP_AR_NET_SETTLE_NETTING_BATCH_FAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14853',
      p_sig_id                 => 'AP_AR_NET_SETTLE_NETTING_BATCH_FAILS',
      p_sig_sql                => 'SELECT SEQ.DB_SEQUENCE_NAME "Sequence Name",
SEQ.DOC_SEQUENCE_ID "Sequence Id",
SA.START_DATE "Start Date",
SA.END_DATE "End Date"
 ...
 WHERE SEQ.DOC_SEQUENCE_ID = SA.DOC_SEQUENCE_ID
   ...
   AND  SA.SET_OF_BOOKS_ID = 
     (SELECT set_of_books_id FROM ap_system_parameters WHERE org_id =''##$$ORGID$$##'')',
      p_title                  => 'Document Sequence Setup for Netting',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Document sequence has not been set up for Netting transaction.<br>
Due to this, the Settle Netting Batch program fails with "A sequence name was not found" error.',
      p_solution               => 'Please review [1911211.1] for solution.',
      p_success_msg            => 'Document sequence has been set up for Netting transaction.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AP_AR_NET_SETTLE_NETTING_BATCH_FAILS');



debug('begin add_signature: AP_AR_NET_PAY_REL_TRX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14724',
      p_sig_id                 => 'AP_AR_NET_PAY_REL_TRX',
      p_sig_sql                => 'SELECT pay_unrelated_invoices_flag "ALLOW PAYMENT OF UNRELATED TRX" , org_id
FROM AR_SYSTEM_PARAMETERS_ALL 
WHERE org_id = ##$$ORGID$$## 
AND  pay_unrelated_invoices_flag <> ''Y''',
      p_title                  => 'Incorrect Setting for "Allow payment of unrelated transactions"',
      p_fail_condition         => 'RS',
      p_problem_descr          => '"Allow payment of unrelated transactions" is not checked in System Options.
Note; If the agreement is just for one Customer, then this error can be ignored.',
      p_solution               => 'Please read the section ''Check the "Allow payment of unrelated transactions" in Receivables'' in [1399565.1#aref_section37].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AP_AR_NET_PAY_REL_TRX');



debug('begin add_signature: AP_AR_NET_DUP_RECEIPT_METHOD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14823',
      p_sig_id                 => 'AP_AR_NET_DUP_RECEIPT_METHOD',
      p_sig_sql                => 'SELECT count(*) "Number of  AP/AR Netting Receipt Method"
FROM ar_receipt_methods
WHERE name like ''AP/AR Netting%''
AND receipt_method_id IN (1 , -1)
HAVING count(*) > 1',
      p_title                  => 'Duplicate AP/AR Netting Receipt Method Exists',
      p_fail_condition         => 'RSGT1',
      p_problem_descr          => 'There is more than one ''AP/AR Netting'' receipt method defined. This will cause an error when running the Settle Netting Batch program. ',
      p_solution               => '<ul>
<li>The analyzer has identified data corruption described in [781051.1]</li> <li>Please follow the steps provided in the document in a TEST instance with the same data as PROD. If the issue is resolved, please migrate the solution to the other environments; otherwise, please log a Service Request and upload this Analyzer output</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AP_AR_NET_DUP_RECEIPT_METHOD');



debug('begin add_signature: AP_AR_NET_BATCH_PAST_DUE_SETUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14726',
      p_sig_id                 => 'AP_AR_NET_BATCH_PAST_DUE_SETUP',
      p_sig_sql                => 'select * 
from FUN_NET_AGREEMENTS_ALL
where SEL_REC_PAST_DUE_TXNS_FLAG = ''Y''
and days_past_due <> 0
and agreement_id = ##$$AGREEMENT_ID$$##',
      p_title                  => 'Netting Batch Past Due Transactions Setup',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The "Select Only Past Due Receivable Transactions" is set to Yes. ',
      p_solution               => '<ul>
<li>This setting may be appropriate for your business, it is raised as a warning to bring it to your awareness that the value is Yes.</li>
<li>Review [942904.1] AP/AR Netting Issue: Netting Batch Is Not Selecting AR Transactions Automatically for more information.</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: AP_AR_NET_BATCH_PAST_DUE_SETUP');



debug('begin add_signature: EBS_FIN_AR_AP_NET_CROSS_CUR_TRX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31343',
      p_sig_id                 => 'EBS_FIN_AR_AP_NET_CROSS_CUR_TRX',
      p_sig_sql                => 'SELECT NVL(CROSS_CURRENCY_RATE_TYPE,''Not Defined''), ORG_ID
FROM AR_SYSTEM_PARAMETERS_ALL 
WHERE ORG_ID= ##$$ORGID$$## 
AND CROSS_CURRENCY_RATE_TYPE is NULL',
      p_title                  => 'Cross currency rate type is not defined in AR System Options',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Cross currency rate type is not defined in AR System Options.
',
      p_solution               => 'Please read the section 8 Multi-currency netting batch ends with status "Error" in [786526.1].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_AP_NET_CROSS_CUR_TRX');
...
debug('begin add_signature: AP_AR_NET_TRX_CLASS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15030',
      p_sig_id                 => 'AP_AR_NET_TRX_CLASS',
      p_sig_sql                => 'SELECT ps.customer_trx_id, ps.trx_number, ps.class
FROM AR_PAYMENT_SCHEDULES_ALL ps
WHERE ps.customer_trx_id = nvl(##$$TRXID$$##, ps.customer_trx_id)
AND   ps.class NOT IN (''CB'', ''INV'', ''DM'', ''CM'')',
      p_title                  => 'Invalid Transaction Class',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The transaction class for customer_trx_id ##$$TRXID$$## is not valid for AP/AR netting agreements.',
      p_solution               => 'The only transaction classes that are considered for the AP/AR netting process are:
<ul>
<li>Invoice</li>
<li>Credit Memo</li>
<li>Debit Memo</li>
...
Please review [760456.1] for the conditions required for a transaction to be selected in a netting batch.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AP_AR_NET_TRX_CLASS');



debug('begin add_signature: AP_AR_NET_TRX_CLOSED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15353',
      p_sig_id                 => 'AP_AR_NET_TRX_CLOSED',
      p_sig_sql                => 'SELECT ps.customer_trx_id, ps.trx_number, ps.status, ps.amount_due_original, ps.amount_due_remaining
FROM AR_PAYMENT_SCHEDULES_ALL ps
WHERE ps.customer_trx_id = nvl(##$$TRXID$$##, ps.customer_trx_id)
AND   ps.status = ''CL''',
      p_title                  => 'Transaction is in Closed Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This transaction is no longer outstanding, and is in Closed status.',
      p_solution               => 'Please review [760456.1] for the conditions required for a transaction to be selected in a netting batch.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AP_AR_NET_TRX_CLOSED');



debug('begin add_signature: AP_AR_NET_TRX_CUST_AGR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15057',
      p_sig_id                 => 'AP_AR_NET_TRX_CUST_AGR',
      p_sig_sql                => 'SELECT ps.trx_number, ps.customer_trx_id, ps.customer_id, ps.customer_site_use_id
FROM   AR_PAYMENT_SCHEDULES_ALL ps
WHERE  ps.customer_trx_id = ##$$TRXID$$##
AND    ps.customer_id NOT IN 
    (SELECT fnc.cust_account_id  
     FROM fun_net_customers_all fnc
     WHERE fnc.agreement_id = ##$$AGREEMENT_ID$$##)',
      p_title                  => 'Customer of this Transaction is not Set Up for this Agreement',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The customer associated to this transaction is not setup for agreement Id ##$$AGREEMENT_ID$$##.',
      p_solution               => 'Please review the section "Create a Netting Agreement" in [1399565.1#aref_section313].
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: AP_AR_NET_TRX_CUST_AGR');



debug('begin add_signature: AP_AR_NET_TRX_CUST_SITE_AGR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15354',
      p_sig_id                 => 'AP_AR_NET_TRX_CUST_SITE_AGR',
      p_sig_sql                => 'SELECT ps.trx_number, ps.customer_trx_id, ps.customer_id, ps.customer_site_use_id
FROM   AR_PAYMENT_SCHEDULES_ALL ps
WHERE  ps.customer_trx_id =  ##$$TRXID$$##
AND    ps.customer_site_use_id NOT IN 
    (SELECT fnc.cust_site_use_id  
     FROM fun_net_customers_all fnc
     WHERE fnc.agreement_id = ##$$AGREEMENT_ID$$##
     AND   fnc.cust_account_id = ps.customer_id)',
      p_title                  => 'Customer Site of this Transaction is not Set Up for this Agreement',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The customer site associated to this transaction is not setup for agreement Id ##$$AGREEMENT_ID$$##.',
      p_solution               => 'Please review the section "Create a Netting Agreement" in [1399565.1#aref_section313].
...
',
   ...
   l_info.delete;
debug('end add_signature: AP_AR_NET_TRX_CUST_SITE_AGR');



debug('begin add_signature: AP_AR_NET_TRX_DATE_AGR_DATE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15056',
      p_sig_id                 => 'AP_AR_NET_TRX_DATE_AGR_DATE',
      p_sig_sql                => 'SELECT fna.agreement_id, fna.agreement_name, fna.agreement_start_date, fna.agreement_end_date
FROM FUN_NET_AGREEMENTS_ALL fna
WHERE fna.agreement_id = ##$$AGREEMENT_ID$$##
and exists 
      (SELECT 1 from AR_PAYMENT_SCHEDULES_ALL ps
       WHERE ps.customer_trx_id = nvl(##$$TRXID$$##, ps.customer_trx_id)
       and  (ps.trx_date < fna.agreement_start_date 
             OR ps.trx_date > nvl(fna.agreement_end_date, SYSDATE +1) 
             )
        )',
      p_title                  => 'Invalid Transaction Date',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The transaction date should fall between the Agreement start date and end date.',
      p_solution               => 'Please review the section "Create a Netting Agreement" in [1399565.1#aref_section313]. ',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AP_AR_NET_TRX_DATE_AGR_DATE');



debug('begin add_signature: AP_AR_NET_TRX_DUE_DATE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15029',
      p_sig_id                 => 'AP_AR_NET_TRX_DUE_DATE',
      p_sig_sql                => 'SELECT batch_id, batch_name, batch_number, agreement_id, batch_status_code, transaction_due_date
FROM FUN_NET_BATCHES_ALL b 
where b.AGREEMENT_ID = ##$$AGREEMENT_ID$$##     
and b.batch_id = nvl(##$$BATCH_ID$$##, b.batch_id)
and exists 
      (SELECT 1 from AR_PAYMENT_SCHEDULES_ALL ps
       WHERE ps.customer_trx_id = nvl(##$$TRXID$$##, ps.customer_trx_id)
       and   b.transaction_due_date < ps.due_date)',
      p_title                  => 'Invalid Due Date',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The due date of this transaction should be prior to the transaction due date of netting batch Id ##$$BATCH_ID$$##.',
      p_solution               => 'Please review [760456.1] for the conditions required for a transaction to be selected in a netting batch.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AP_AR_NET_TRX_DUE_DATE');



debug('begin add_signature: AP_AR_NET_TRX_SEL_IN_NET_BATCH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15028',
      p_sig_id                 => 'AP_AR_NET_TRX_SEL_IN_NET_BATCH',
      p_sig_sql                => 'SELECT b.batch_id, b.batch_name, b.batch_number, b.agreement_id, b.batch_status_code
FROM  FUN_NET_BATCHES_ALL b 
WHERE b.batch_status_code = ''SELECTED''
AND   b.batch_id in
 (SELECT aptr.batch_id
  FROM FUN_NET_AR_TXNS_ALL aptr
  WHERE aptr.customer_trx_id = nvl(##$$TRXID$$##, aptr.customer_trx_id))',
      p_title                  => 'Transaction Already Belongs to Another Netting Batch',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This transaction is already selected in another netting batch.',
      p_solution               => 'Please review [760456.1] for the conditions required for a transaction to be selected in a netting batch.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AP_AR_NET_TRX_SEL_IN_NET_BATCH');



debug('begin add_signature: AP_AR_NET_INV_NOT_CLOSED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18772',
      p_sig_id                 => 'AP_AR_NET_INV_NOT_CLOSED',
      p_sig_sql                => 'select net.customer_trx_id, net.cash_receipt_id, ra.receivable_application_id, ra.amount_applied, ra.apply_date
from ar_receivable_applications_all ra, ar_payment_schedules_all ps, fun_net_ar_txns_all net
where net.customer_trx_id = ##$$TRXID$$##
and ps.customer_trx_id = net.customer_trx_id
and ra.cash_receipt_id = net.cash_receipt_id
and ra.applied_customer_trx_id = net.customer_trx_id
and ra.applied_payment_schedule_id = ps.payment_schedule_id
and ra.display = ''Y''
and ra.amount_applied <> net.netted_amt',
      p_title                  => 'Transaction Remains Not Closed After Netting Batch is Processed',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This transaction is not closed despite being processed in a netting batch.',
      p_solution               => 'Please review [1520113.1] for solution.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AP_AR_NET_INV_NOT_CLOSED');



debug('begin add_signature: AP_AR_NET_SUSPENDED_BATCH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14851',
      p_sig_id                 => 'AP_AR_NET_SUSPENDED_BATCH',
      p_sig_sql                => 'select BATCH_NAME,
            BATCH_NUMBER,
            BATCH_STATUS_CODE "STATUS"
from fun_net_batches_all f
where BATCH_ID=''##$$BATCH_ID$$##'' 
and f.checkrun_id in 
 (select distinct aps.checkrun_id from ap_payment_schedules_all aps 
  where aps.invoice_id=''##$$INVID$$##'' and aps.payment_status_flag<>''Y'')
and BATCH_STATUS_CODE=''SUSPENDED''',
      p_title                  => 'Suspended Netting Batch',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'When netting batch is run or a Payment Process Request (PPR) is terminated, the batch status is Suspended and the invoices in the batch are stuck in status "Selected for payment" and the batch cannot be queried from the form.
',
      p_solution               => 'Please review [1634280.1] for solution.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AP_AR_NET_SUSPENDED_BATCH');



debug('begin add_signature: AP_AR_NET_PAYMENTS_CANNOT_BE_VOIDED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14759',
      p_sig_id                 => 'AP_AR_NET_PAYMENTS_CANNOT_BE_VOIDED',
      p_sig_sql                => 'select ac.check_id,
           ac.check_number,
           ac.status_lookup_code STATUS
from ap_checks_all ac  
where payment_type_flag=''N'' 
and exists (select ''Payment Uncleared'' 
                     from   ap_payment_history_all aph
                     where aph.check_id=ac.check_id 
                     and aph.transaction_type = ''PAYMENT UNCLEARING'')
and ac.check_id = ##$$CHKID$$## 
and ac.status_lookup_code <> ''VOIDED''',
      p_title                  => 'Netting Payments Cannot be Voided',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Payment cannot be voided after AP/AR netting batch has been reversed.<br>
Payment has been uncleared in Cash Management.<br>
This can cause the error "APP-SQLAP-10786: No payments" while trying to void the payment.
',
      p_solution               => 'Please review [2606111.1] for solution.
...
',
   ...
   l_info.delete;
debug('end add_signature: AP_AR_NET_PAYMENTS_CANNOT_BE_VOIDED');



debug('begin add_signature: AP_AR_NET_INVOICES_STUCK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14760',
      p_sig_id                 => 'AP_AR_NET_INVOICES_STUCK',
      p_sig_sql                => 'select Batch_id "Batch Id",Batch_name "Batch Name",Batch_status_code Status,Checkrun_id "Checkrun Id"
 from fun_net_batches_all
 where checkrun_id in (
   select checkrun_id from ap_payment_schedules_all aps
   where checkrun_id in (select checkrun_id from ap_payment_schedules_all where invoice_id=''##$$INVID$$##'')
   and not exists 
     (select ''ppr'' from ap_inv_selection_criteria_all aisc where aisc.checkrun_id = aps.checkrun_id )
)',
      p_title                  => 'Netting Invoice Stuck in "Selected For Payment" Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invoice is stuck in ''Selected for Payment'' status and cannot be paid.  The latest Payment Process Request submitted also did not select the stuck invoice.',
      p_solution               => 'Please review [2092627.1] for solution.',
      p_success_msg            => 'No netting invoices stuck in Selected for Payment status.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AP_AR_NET_INVOICES_STUCK');



debug('begin add_signature: AP_AR_NET_FUN_NET_AP_INVS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14714',
      p_sig_id                 => 'AP_AR_NET_FUN_NET_AP_INVS',
      p_sig_sql                => 'SELECT apin.* 
FROM FUN_NET_AP_INVS_ALL apin
WHERE apin.batch_id  = ##$$FK1$$##
ORDER BY apin.ap_txn_rank',
      p_title                  => 'FUN_NET_AP_INVS_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no AP invoices for batch Id = ##$$FK1$$## in agreement Id = ##$$AGREEMENT_ID$$##.',
      p_solution               => 'Please review the section "Enter an invoice for your supplier" in [1399565.1#aref_section311].',
      p_success_msg            => 'Displaying AP invoices for batch Id = ##$$FK1$$## in agreement Id = ##$$AGREEMENT_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AP_AR_NET_FUN_NET_AP_INVS');



debug('begin add_signature: AP_AR_NET_FUN_NET_AR_TXNS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14715',
      p_sig_id                 => 'AP_AR_NET_FUN_NET_AR_TXNS',
      p_sig_sql                => 'SELECT aptr.* 
FROM FUN_NET_AR_TXNS_ALL aptr
where aptr.batch_id = ##$$FK1$$##',
      p_title                  => 'FUN_NET_AR_TXNS_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no AR Transactions for netting batch Id = ##$$FK1$$##.',
      p_solution               => 'Please review the following:
<ul>
<li>[760456.1] Create Netting Batches Finds No Transactions</li>
<li>[1399565.1#aref_section310] Section "Create a transaction in Receivables"</li>
</ul>',
      p_success_msg            => 'Displaying AR transactions in netting batch Id = ##$$FK1$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AP_AR_NET_FUN_NET_AR_TXNS');



debug('begin add_signature: AP_AR_NET_CASH_RCPT_ALL_BATCHES');
   l_info('##MASK##ISSUER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15510',
      p_sig_id                 => 'AP_AR_NET_CASH_RCPT_ALL_BATCHES',
      p_sig_sql                => 'SELECT cr.*
FROM  ar_cash_receipts_all cr
WHERE exists
  (SELECT ''Y''
   FROM FUN_NET_AR_TXNS_ALL ft
   WHERE ft.batch_id = ##$$FK1$$##
   AND ft.cash_receipt_id = cr.cash_receipt_id)',
      p_title                  => 'AR_CASH_RECEIPTS_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no receipt created for this Netting Batch.',
      p_solution               => 'Please review the section "Create a Netting Batch" in [1399565.1#aref_section314].',
      p_success_msg            => 'Displaying the receipt information for the receipt created for this Netting Batch.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AP_AR_NET_CASH_RCPT_ALL_BATCHES');



debug('begin add_signature: AP_AR_NET_FUN_NET_BATCHES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14713',
      p_sig_id                 => 'AP_AR_NET_FUN_NET_BATCHES',
      p_sig_sql                => 'SELECT ba.*, ba.batch_id "##$$FK1$$##"
FROM  fun_net_batches_all ba
WHERE ba.agreement_id = ##$$AGREEMENT_ID$$##
AND   ba.batch_id = ##$$BATCH_ID$$##',
      p_title                  => 'FUN_NET_BATCHES_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no netting batches for agreement Id = ##$$AGREEMENT_ID$$##.',
      p_solution               => 'Please review the section "Create a Netting Batch" in [1399565.1#aref_section314].',
      p_success_msg            => 'Displaying the netting batch information for agreement Id = ##$$AGREEMENT_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('AP_AR_NET_FUN_NET_AP_INVS','AP_AR_NET_FUN_NET_AR_TXNS','AP_AR_NET_CASH_RCPT_ALL_BATCHES'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '21'
      );
   l_info.delete;
debug('end add_signature: AP_AR_NET_FUN_NET_BATCHES');



debug('begin add_signature: AP_AR_NET_NET_BATCH_STUCK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12639',
      p_sig_id                 => 'AP_AR_NET_NET_BATCH_STUCK',
      p_sig_sql                => 'SELECT batch_id, batch_name, batch_number, exchange_rate,  exchange_rate_type, batch_status_code
FROM fun_net_batches_all ba
WHERE ba.agreement_id = ##$$AGREEMENT_ID$$##
AND ba.batch_id = ##$$BATCH_ID$$##
AND ba.exchange_rate_type IS NOT NULL 
AND ba.exchange_rate IS NULL
AND ba.batch_status_code = ''CLEARING''',
      p_title                  => 'AP/AP Netting Batch Stuck in Clearing Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'AP/AP Netting Batch stuck in Clearing status and cannot be updated or cancelled.',
      p_solution               => 'Please review [1577834.1] for solution.
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AP_AR_NET_NET_BATCH_STUCK');



debug('begin add_signature: AP_AR_NET_FUN_NET_BATCHES_AGR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15059',
      p_sig_id                 => 'AP_AR_NET_FUN_NET_BATCHES_AGR',
      p_sig_sql                => 'SELECT ba.*, ba.batch_id "##$$FK1$$##"
FROM fun_net_batches_all ba
WHERE ba.agreement_id = ##$$AGREEMENT_ID$$##
ORDER BY ba.batch_id',
      ...
      p_problem_descr          => 'There are no netting batches for agreement Id = ##$$AGREEMENT_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Displaying all netting batches for agreement Id = ##$$AGREEMENT_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AP_AR_NET_FUN_NET_BATCHES_AGR');
...
BEGIN
  ...
  analyzer_title := 'AP/AR Netting Analyzer';
...
debug('begin section: Netting_Setup');
start_section('Netting Agreement Setup', 'Netting_Setup');
   set_item_result(run_stored_sig('AP_AR_NET_FUN_NET_AGREEMENTS_ALL'));
   set_item_result(run_stored_sig('AP_AR_NET_FUN_NET_AP_INV_TYPES'));
   set_item_result(run_stored_sig('AP_AR_NET_FUN_NET_AR_TRX_TYPES'));
   set_item_result(run_stored_sig('AP_AR_NET_FUN_NET_CUSTOMERS'));
   set_item_result(run_stored_sig('AP_AR_NET_FUN_NET_SUPPLIERS'));
   set_item_result(run_stored_sig('AP_AR_NET_ACCOUNT_END_DATED'));
   set_item_result(run_stored_sig('AP_AR_NET_CE_BANK_ACCOUNTS'));
end_section;
debug('end section: Netting_Setup');

debug('begin section: Netting_batch');
start_section('Netting Batch', 'Netting_batch');
   IF p_net_batch_id is not null THEN
      set_item_result(run_stored_sig('AP_AR_NET_FUN_NET_BATCHES'));
      set_item_result(run_stored_sig('AP_AR_NET_NET_BATCH_STUCK'));
   END IF;
   IF p_net_batch_id is null THEN
      set_item_result(run_stored_sig('AP_AR_NET_FUN_NET_BATCHES_AGR'));
   END IF;
end_section;
debug('end section: Netting_batch');

debug('begin section: AP_Netting_Issue');
start_section('Payables Netting Issues', 'AP_Netting_Issue');
   IF p_net_batch_id is not null and p_invoice_id is not null THEN
      set_item_result(run_stored_sig('AP_AR_NET_SUSPENDED_BATCH'));
   END IF;
   IF p_check_id is not null THEN
      set_item_result(run_stored_sig('AP_AR_NET_PAYMENTS_CANNOT_BE_VOIDED'));
   END IF;
   IF p_invoice_id is not null THEN
      set_item_result(run_stored_sig('AP_AR_NET_INVOICES_STUCK'));
   END IF;
   set_item_result(run_stored_sig('AP_AR_NET_STUCK_ CREATE_NETTING_BATCH_PROGRAM'));
   set_item_result(run_stored_sig('AP_AR_NET_SETTLE_NETTING_BATCH_FAILS'));
end_section;
debug('end section: AP_Netting_Issue');

debug('begin section: AR_Netting_Issues');
start_section('Receivables Netting Issues', 'AR_Netting_Issues');
   set_item_result(run_stored_sig('AP_AR_NET_PAY_REL_TRX'));
   set_item_result(run_stored_sig('AP_AR_NET_DUP_RECEIPT_METHOD'));
   set_item_result(run_stored_sig('AP_AR_NET_BATCH_PAST_DUE_SETUP'));
   set_item_result(run_stored_sig('EBS_FIN_AR_AP_NET_CROSS_CUR_TRX'));
   IF p_customer_trx_id is not null THEN
      set_item_result(run_stored_sig('AP_AR_NET_TRX_CLASS'));
      set_item_result(run_stored_sig('AP_AR_NET_TRX_CLOSED'));
      set_item_result(run_stored_sig('AP_AR_NET_TRX_CUST_AGR'));
      set_item_result(run_stored_sig('AP_AR_NET_TRX_CUST_SITE_AGR'));
      set_item_result(run_stored_sig('AP_AR_NET_TRX_DATE_AGR_DATE'));
      set_item_result(run_stored_sig('AP_AR_NET_TRX_DUE_DATE'));
      set_item_result(run_stored_sig('AP_AR_NET_TRX_SEL_IN_NET_BATCH'));
      set_item_result(run_stored_sig('AP_AR_NET_INV_NOT_CLOSED'));
   END IF;
end_section;
debug('end section: AR_Netting_Issues');

debug('begin section: CONSOLIDATED_SETUP');
start_section('Environment Setup and Information', 'CONSOLIDATED_SETUP');
