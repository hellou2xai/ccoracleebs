...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Loans Analyzer                         |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE lns_analyzer_pkg AUTHID DEFINER AS
...
(            p_user_name                    IN VARCHAR2    DEFAULT NULL
           ...
           ,p_apps_check                   IN VARCHAR2    DEFAULT 'Y'
...
END lns_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY lns_analyzer_pkg AS
-- $Id: lns_analyzer.sql, 200.12 2025/12/08 13:36:01 jnieman Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2652176.1));
...
g_loan_id          NUMBER        := NULL;


-- FOR LOAN INFORMATION

g_ledger_id        NUMBER       := NULL;    -- (LEDGERID)
g_loan_prod_id     NUMBER;                  -- (LOAN_PROD_ID)
g_loan_type_id     NUMBER       := NULL;    -- (LOAN_TYPE_ID)
g_org_id           NUMBER       := NULL;    -- (ORGID)
g_term_id          NUMBER       := NULL;    -- (TERM_ID)
g_loan_type        VARCHAR(30)  := NULL;    -- (LOAN_TYPE)
g_class_code       VARCHAR(30)  := NULL;    -- (CLASS_CODE)
g_loan_class       VARCHAR(30)  := NULL;    -- (LOAN_CLASS)
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'LNSANLZ_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'LNSANLZ_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>LNSANLZ Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2652176.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/lns_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,2735,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,2735,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},2735,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4323435" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">2735</span>
...
<p>What&apos;s new:</p><ul><li>Added conditional block in Critical Alerts for 12C and 11G databases.</li>
</ul>
<p>&nbsp;</p>
            <br><br>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,2735,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,2735,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},2735,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
FUNCTION check_rec_patches_1 RETURN VARCHAR2 IS
  /* Signature LNS_GEN_RECOMMENDED_PATCHES */
...
BEGIN
    ...
    print_log('Processing recommended patches signature: LNS_GEN_RECOMMENDED_PATCHES (check_rec_patches_1) "Recommended Patches - Loans" (version 8)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.0' THEN
   ...
   l_col_rows(1)(l_rows) := '8645283';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.LNS.A - Important fixes on the top of LNS 12.0.6 release - June 2009';
   l_col_rows(5)(l_rows) := '[432801.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '8816272';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.LNS.A - IMPORTANT FIXES ON THE TOP OF LNS 12.0.6 RELEASE - NOV 2009';
   l_col_rows(5)(l_rows) := '[432801.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '9689374';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.LNS.A - IMPORTANT FIXES ON THE TOP OF LNS 12.0.6 RELEASE - AUG 2010';
   l_col_rows(5)(l_rows) := '[432801.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '9682244';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.LNS.B IMPORTANT FIXES ON THE TOP OF LNS 12.1.3 RELEASE - AUG 2010';
   l_col_rows(5)(l_rows) := '[432801.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '11779814';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.LNS.B - IMPORTANT FIXES ON THE TOP OF LNS 12.1.3 RELEASE - JAN 2011';
   l_col_rows(5)(l_rows) := '[432801.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '12318025';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.LNS.B - IMPORTANT FIXES ON THE TOP OF LNS 12.1.3 RELEASE - MAR 2011';
   l_col_rows(5)(l_rows) := '[432801.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '12716029';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.LNS.B - IMPORTANT FIXES ON THE TOP OF LNS 12.1.3 RELEASE - AUG 2011';
   l_col_rows(5)(l_rows) := '[432801.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '13697772';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.LNS.B R12.1: LOANS(LNS) RECOMMENDED PATCH COLLECTION (RPC), AUGUST 2012';
   l_col_rows(5)(l_rows) := '[954704.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '16203360';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.LNS.B R12.1: LOANS(LNS) RECOMMENDED PATCH COLLECTION (RPC), MARCH 2013';
   l_col_rows(5)(l_rows) := '[954704.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '17087621';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.LNS.B.R12.1: LOANS(LNS) RECOMMENDED PATCH COLLECTION (RPC), SEPTEMBER 2013';
   l_col_rows(5)(l_rows) := '[954704.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '18425696';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.LNS.B.R12.1: LOANS(LNS) RECOMMENDED PATCH COLLECTION (RPC), AUGUST 2014';
   l_col_rows(5)(l_rows) := '[954704.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '20223874';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.LNS.B.R12.1: LOANS(LNS) RECOMMENDED PATCH COLLECTION(RPC), FEBRUARY 2015';
   l_col_rows(5)(l_rows) := '[954704.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21129925';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.LNS.B.R12.1: LOANS(LNS) RECOMMENDED PATCH COLLECTION(RPC), AUGUST 2015';
   l_col_rows(5)(l_rows) := '[954704.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '22324389';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.LNS.B.R12.1: LOANS(LNS) RECOMMENDED PATCH COLLECTION(RPC), FEBRUARY 2016';
   l_col_rows(5)(l_rows) := '[954704.1]';
...
IF substr(g_rep_info('Apps Version'),1,6) = '12.2.2' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21757456';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Important fixes for LNS 12.2.2';
   l_col_rows(5)(l_rows) := '[2007358.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '23106406';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Important fixes for LNS 12.2.6';
   l_col_rows(5)(l_rows) := '[432801.1]';
...
END IF;
   ...
   l_sig.sigrepo_id := '14436';
   l_sig.title := 'Recommended Patches - Loans';
...
<b>Best Practice:</b> Always ensure that you are on the latest code with all recommended patches applied. This will help avoid known issues, prevent potential data corruption and provide the latest features and functionality. Having a proactive patching plan and periodic proactive patching process in place are the best ways to stay current.';
  ...
  -- Register
  l_step := '60';
  g_signatures('LNS_GEN_RECOMMENDED_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'LNS_GEN_RECOMMENDED_PATCHES',     -- sig ID
...
debug('begin populate parameters hash table');
   ...
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Loan ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_loan_id,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2025/12/08 13:36:00 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'lns_analyzer.sql';
...
debug('begin parameter validation: p_loan_id');
IF p_loan_id IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Loan ID is required.');
   raise invalid_parameters;
END IF;
...
WHERE LOAN_ID = p_loan_id and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: The Loan Number/ID does not exist in LNS_LOAN_HEADERS_ALL.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_loan_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_loan_id');
...
IF g_loan_id is null THEN
    print_log('The loan_id parameter is mandatory.');
    raise invalid_parameters;
ELSE
...
-- Get Loan ID
   ...
   execute immediate 'alter session set NLS_DATE_FORMAT = ''DD-MON-YYYY''';
     ...
     SELECT  loan_id, loan_type, loan_type_id, org_id, product_id, loan_class_code
      into    g_loan_id, g_loan_type, g_loan_type_id, g_org_id, g_loan_prod_id, g_class_code
     FROM LNS_LOAN_HEADERS_ALL
     WHERE LOAN_ID = g_loan_id;

   EXCEPTION
   WHEN NO_DATA_FOUND then
     print_log('LOAN_ID does not exist in LNS_LOAN_HEADERS_ALL.');
...
-- Get Org ID and LEDGER ID
   ...
   BEGIN
    select ar.set_of_books_id, ar.org_id
...
debug('begin populate sql tokens hash table');
   ...
   g_sql_tokens('##$$A$$##') := 'LNS_ANALYZER_PKG';
   ...
   g_sql_tokens('##$$LOAN_ID$$##') := g_loan_id;
   g_masked_tokens('##$$LOAN_ID$$##') := mask_text( g_sql_tokens('##$$LOAN_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$LOAN_TYPE_ID$$##') := g_loan_type_id;
   g_masked_tokens('##$$LOAN_TYPE_ID$$##') := mask_text( g_sql_tokens('##$$LOAN_TYPE_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$LOAN_PROD_ID$$##') := g_loan_prod_id;
   g_masked_tokens('##$$LOAN_PROD_ID$$##') := mask_text( g_sql_tokens('##$$LOAN_PROD_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$CLASS_CODE$$##') := g_class_code;
   g_masked_tokens('##$$CLASS_CODE$$##') := mask_text( g_sql_tokens('##$$CLASS_CODE$$##'), 'NO_MASK');
   g_sql_tokens('##$$RESP_ID$$##') := g_resp_id;
   g_masked_tokens('##$$RESP_ID$$##') := mask_text( g_sql_tokens('##$$RESP_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$USERNAME$$##') := g_user_name;
...
debug('begin add_signature: LNS_LOAN_HEADER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14376',
      p_sig_id                 => 'LNS_LOAN_HEADER',
      p_sig_sql                => 'SELECT *
FROM LNS_LOAN_HEADERS_ALL
WHERE LOAN_ID = ##$$LOAN_ID$$##',
      p_title                  => 'Header Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No loan header details on this loan.  ',
      p_solution               => '',
      p_success_msg            => 'Displaying the loan header details on this loan.',
   ...
   l_info.delete;
debug('end add_signature: LNS_LOAN_HEADER');



debug('begin add_signature: LNS_TERMS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14377',
      p_sig_id                 => 'LNS_TERMS',
...
WHERE LOAN_ID = ##$$LOAN_ID$$##',
      p_title                  => 'Terms',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No terms on this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying the terms of this loan.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_TERMS');



debug('begin add_signature: LNS_FREQ_SCHEDULE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14380',
      p_sig_id                 => 'LNS_FREQ_SCHEDULE',
      p_sig_sql                => 'SELECT *
FROM  LNS_FREQ_SCHEDULES
WHERE loan_id = ##$$LOAN_ID$$##',
      p_title                  => 'Frequency Schedule',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No loan principal and interest frequency schedule on this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying the loan principal and interest frequency schedule on this loan.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: LNS_FREQ_SCHEDULE');



debug('begin add_signature: LNS_RATE_SCHEDULE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14381',
      p_sig_id                 => 'LNS_RATE_SCHEDULE',
      p_sig_sql                => 'SELECT
    *
FROM
    lns_rate_schedules
...
ORDER BY
    begin_installment_number',
      p_title                  => 'Interest Rate Schedule',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No interest rate schedule on this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying the interest rate schedule on this loan.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_RATE_SCHEDULE');



debug('begin add_signature: LNS_APPROVAL_ACTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14761',
      p_sig_id                 => 'LNS_APPROVAL_ACTIONS',
      p_sig_sql                => 'SELECT
    *
FROM
...
WHERE
    loan_id = ##$$LOAN_ID$$##',
      p_title                  => 'Approval Actions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No approval actions on this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying the approval actions on this loan.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_APPROVAL_ACTIONS');



debug('begin add_signature: LNS_PARTICIPANTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14411',
      p_sig_id                 => 'LNS_PARTICIPANTS',
      p_sig_sql                => 'SELECT *
FROM LNS_PARTICIPANTS
WHERE LOAN_ID = ##$$LOAN_ID$$##',
      p_title                  => 'Participant(s)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No loan participant(s) on this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying the participant(s) on this loan.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_PARTICIPANTS');



debug('begin add_signature: LNS_LOAN_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14415',
      p_sig_id                 => 'LNS_LOAN_LINES',
      p_sig_sql                => 'SELECT *
FROM LNS_LOAN_LINES
WHERE LOAN_ID = ##$$LOAN_ID$$##',
      p_title                  => 'Receivables Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Receivables invoice used to create this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying the Receivables invoice data for this loan.',
   ...
   l_info.delete;
debug('end add_signature: LNS_LOAN_LINES');



debug('begin add_signature: LNS_FEE_ASSIGNMENT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14421',
      p_sig_id                 => 'LNS_FEE_ASSIGNMENT',
      p_sig_sql                => 'SELECT fee_ass.*,
       fee.*
FROM LNS_FEE_ASSIGNMENTS fee_ass,
     LNS_FEES_ALL        fee
WHERE fee_ass.LOAN_ID = ##$$LOAN_ID$$##
  AND fee_ass.FEE_ID = fee.FEE_ID',
      p_title                  => 'Fee Assignments',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No fees assigned to this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying the fees assigned to this loan.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_FEE_ASSIGNMENT');



debug('begin add_signature: LNS_FEE_SCHEDULE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14422',
      p_sig_id                 => 'LNS_FEE_SCHEDULE',
      p_sig_sql                => 'SELECT *
FROM LNS_FEE_SCHEDULES
WHERE LOAN_ID = ##$$LOAN_ID$$##
ORDER BY FEE_INSTALLMENT',
      p_title                  => 'Fee Schedule',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No fee schedule, or any fees, assigned to this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying the fee schedule for this loan.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_FEE_SCHEDULE');



debug('begin add_signature: LNS_DISBURSEMENT_HEADERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14439',
      p_sig_id                 => 'LNS_DISBURSEMENT_HEADERS',
      p_sig_sql                => 'SELECT
    *
FROM
    lns_disb_headers
WHERE
    loan_id = ##$$LOAN_ID$$##',
      p_title                  => 'Disbursement Header',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No loan disbursement header information for this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying the loan disbursement header information for this loan.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_DISBURSEMENT_HEADERS');



debug('begin add_signature: LNS_DISBURSEMENT_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14441',
      p_sig_id                 => 'LNS_DISBURSEMENT_LINES',
      p_sig_sql                => 'SELECT *
FROM lns_disb_lines
WHERE
    disb_header_id IN (
      ...
      p_title                  => 'Disbursement Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No loan disbursement line details on this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying the line level disbursement details on this loan.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_DISBURSEMENT_LINES');



debug('begin add_signature: LNS_ADJUSTMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14442',
      p_sig_id                 => 'LNS_ADJUSTMENTS',
      p_sig_sql                => 'SELECT
    *
FROM
...
WHERE
    loan_id = ##$$LOAN_ID$$##',
      p_title                  => 'Adjustments',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No loan adjustments created for this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying loan adjustments created for this loan.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_ADJUSTMENTS');



debug('begin add_signature: LNS_DISTRIBUTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14445',
      p_sig_id                 => 'LNS_DISTRIBUTIONS',
      p_sig_sql                => 'SELECT
    *
FROM
    lns_distributions
WHERE
    loan_id = ##$$LOAN_ID$$##',
      p_title                  => 'Distributions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No distributions created on this loan. ',
      p_solution               => '',
      p_success_msg            => 'Displaying the loan distributions created on this loan.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_DISTRIBUTIONS');



debug('begin add_signature: LNS_AMORT_ORIGINAL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14412',
      p_sig_id                 => 'LNS_AMORT_ORIGINAL',
      p_sig_sql                => 'SELECT *
FROM  LNS_AM_SCHEDS_EXPORTS
WHERE LOAN_ID = ##$$LOAN_ID$$##
  AND SCHEDULE_TYPE = ''ORIGINAL''
ORDER BY INSTALLMENT_NUMBER',
      p_title                  => 'Original Amortization Schedule',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No original loan amortization schedule on this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying the original loan amortization schedule on this loan.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_AMORT_ORIGINAL');



debug('begin add_signature: LNS_AMORT_CURRENT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14413',
      p_sig_id                 => 'LNS_AMORT_CURRENT',
      p_sig_sql                => 'SELECT *
FROM LNS_AM_SCHEDS_EXPORTS
WHERE LOAN_ID = ##$$LOAN_ID$$##
      AND SCHEDULE_TYPE =  ''CURRENT''
ORDER BY INSTALLMENT_NUMBER',
      p_title                  => 'Current Amortization Schedule',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No current loan amortization schedule on this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying the current loan amortization schedule on this loan.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_AMORT_CURRENT');



debug('begin add_signature: LNS_AMORT_CUSTOM');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14414',
      p_sig_id                 => 'LNS_AMORT_CUSTOM',
      p_sig_sql                => 'SELECT *
FROM  LNS_CUSTOM_PAYMNT_SCHEDS
WHERE LOAN_ID = ##$$LOAN_ID$$##
ORDER BY PAYMENT_NUMBER',
      p_title                  => 'Custom Amortization Schedule',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No custom loan amortization schedule on this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying the custom loan amortization schedule on this loan.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_AMORT_CUSTOM');



debug('begin add_signature: LNS_PMT_SUMMARY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14448',
      p_sig_id                 => 'LNS_PMT_SUMMARY',
      p_sig_sql                => 'SELECT
    *
FROM
    lns_pay_sum_v
WHERE
    loan_id = ##$$LOAN_ID$$##',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No payment information on this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying payment summary information on this loan.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_PMT_SUMMARY');



debug('begin add_signature: LNS_OVERDUE_PMT_SUMMARY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14449',
      p_sig_id                 => 'LNS_OVERDUE_PMT_SUMMARY',
      p_sig_sql                => 'SELECT
    *
FROM
    lns_pay_sum_overdue_v
WHERE
    loan_id = ##$$LOAN_ID$$##',
      p_title                  => 'Overdue Payment Summary',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No overdue payment summary information on this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying overdue payment summary information on this loan.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_OVERDUE_PMT_SUMMARY');



debug('begin add_signature: LNS_PMT_YTD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14450',
      p_sig_id                 => 'LNS_PMT_YTD',
      p_sig_sql                => 'SELECT
    *
FROM
    lns_pay_sum_overdue_v
WHERE
    loan_id = ##$$LOAN_ID$$##',
      p_title                  => 'Year to Date Payment Summary',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No payment summary information on this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying Year to Date payment summary information on this loan.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_PMT_YTD');



debug('begin add_signature: LNS_LOAN_EXTENSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14423',
      p_sig_id                 => 'LNS_LOAN_EXTENSIONS',
      p_sig_sql                => 'SELECT *
FROM LNS_LOAN_EXTENSIONS
WHERE LOAN_ID = ##$$LOAN_ID$$##',
      p_title                  => 'Extensions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No extensions created for this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying extensions created for this loan.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_LOAN_EXTENSIONS');



debug('begin add_signature: LNS_LOAN_SPLITS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14424',
      p_sig_id                 => 'LNS_LOAN_SPLITS',
      p_sig_sql                => 'SELECT *
FROM LNS_LOAN_SPLITS
WHERE LOAN_ID = ##$$LOAN_ID$$##',
      p_title                  => 'Splits',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No splits created for this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying splits created for this loan.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_LOAN_SPLITS');



debug('begin add_signature: LNS_CANCELLATIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14416',
      p_sig_id                 => 'LNS_CANCELLATIONS',
      p_sig_sql                => 'SELECT *
FROM LNS_LOAN_CANCELLATIONS
WHERE LOAN_ID = ##$$LOAN_ID$$##',
      p_title                  => 'Cancellations',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No cancellation requests for this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying the cancellation requests for this loan.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_CANCELLATIONS');



debug('begin add_signature: LNS_CANCELLATION_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14417',
      p_sig_id                 => 'LNS_CANCELLATION_DETAILS',
      p_sig_sql                => 'SELECT *
FROM  LNS_LOAN_CANCEL_DETAILS
WHERE LOAN_ID = ##$$LOAN_ID$$##
ORDER BY LOAN_CANCELLATION_ID',
      p_title                  => 'Cancellation Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No cancellation details for this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying the cancellation details for this loan.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_CANCELLATION_DETAILS');



debug('begin add_signature: LNS_PMT_HIST_AMORT_SCHED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14453',
      p_sig_id                 => 'LNS_PMT_HIST_AMORT_SCHED',
      p_sig_sql                => 'SELECT
    *
FROM
    lns_am_scheds_v
...
ORDER BY
    ...
    amortization_schedule_id',
      p_title                  => 'Amortization Schedule Payment History',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No amortization payment history on this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying the amortization schedule payment history on this loan.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_PMT_HIST_AMORT_SCHED');



debug('begin add_signature: LNS_PMT_HIST_AMORT_SCHED_DET');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14454',
      p_sig_id                 => 'LNS_PMT_HIST_AMORT_SCHED_DET',
      p_sig_sql                => 'SELECT
    *
FROM
    lns_am_scheds_dtl_v
...
ORDER BY
    payment_number,
    amortization_schedule_id',
      p_title                  => 'Amortization Payment History Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No amortization schedule payment history details on this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying the amortization schedule payment history details on this loan.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_PMT_HIST_AMORT_SCHED_DET');



debug('begin add_signature: LNS_AMORT_SCHEDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14431',
      p_sig_id                 => 'LNS_AMORT_SCHEDS',
      p_sig_sql                => 'SELECT
    *
FROM
...
ORDER BY
    payment_number,
    amortization_schedule_id',
      p_title                  => 'Amortization Schedule',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No billed amortization schedule(s) for this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying the billed amortization schedule(s) for this loan.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_AMORT_SCHEDS');



debug('begin add_signature: LNS_AMORTIZATION_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14432',
      p_sig_id                 => 'LNS_AMORTIZATION_LINES',
      p_sig_sql                => 'SELECT
    *
FROM
...
ORDER BY
    amortization_line_id',
      p_title                  => 'Amortization Schedule Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No amortization installment details created for this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying amortization installment details created for this loan.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_AMORTIZATION_LINES');



debug('begin add_signature: LNS_RECEIVABLE_ACTIVITIES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14433',
      p_sig_id                 => 'LNS_RECEIVABLE_ACTIVITIES',
      p_sig_sql                => 'SELECT
    *
FROM
    lns_receivable_activities_v
WHERE
    loan_id = ##$$LOAN_ID$$##',
      p_title                  => 'Receivable Activities',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Receivables payment activities for this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying the Receivables payment activities for this loan.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_RECEIVABLE_ACTIVITIES');



debug('begin add_signature: LNS_PRINCIPAL_ACTIVITIES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14434',
      p_sig_id                 => 'LNS_PRINCIPAL_ACTIVITIES',
      p_sig_sql                => 'SELECT
    *
FROM
    lns_prin_trx_activities_v
WHERE
    loan_id = ##$$LOAN_ID$$##
ORDER BY
    activity_date,
    display_order',
      p_title                  => 'Principal Activities',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No principal activities for this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying the principal activities for this loan.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_PRINCIPAL_ACTIVITIES');



debug('begin add_signature: LNS_INTEREST_ACTIVITIES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14435',
      p_sig_id                 => 'LNS_INTEREST_ACTIVITIES',
      p_sig_sql                => 'SELECT
    *
FROM
    lns_int_trx_activities_v
WHERE
    loan_id = ##$$LOAN_ID$$##
ORDER BY
    activity_date,
    display_order',
      p_title                  => 'Interest Activities',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No interest activities on this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying the interest activities on this loan.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_INTEREST_ACTIVITIES');



debug('begin add_signature: EBS_FIN_AR_LNSANLZ_ASSET_ASG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31137',
      p_sig_id                 => 'EBS_FIN_AR_LNSANLZ_ASSET_ASG',
      p_sig_sql                => 'SELECT *
FROM LNS_ASSET_ASSIGNMENTS
WHERE LOAN_ID = ##$$LOAN_ID$$##
',
      p_title                  => 'Loan Asset Assignments',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No assets are assigned to this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying asset assignments for this loan.
',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_LNSANLZ_ASSET_ASG');



debug('begin add_signature: EBS_FIN_AR_LNSANLZ_ASSET');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31547',
      p_sig_id                 => 'EBS_FIN_AR_LNSANLZ_ASSET',
      p_sig_sql                => 'SELECT
    *
FROM
    lns_assets
...
',
      ...
      p_problem_descr          => 'No assets are assigned to this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying assets related to this loan.
',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_LNSANLZ_ASSET');



debug('begin add_signature: LNS_GEN_LEDGER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14534',
      p_sig_id                 => 'LNS_GEN_LEDGER',
      p_sig_sql                => 'SELECT   l.ledger_id 
      ,        l.name 
      ,        l.short_name 
      ,        l.description
      ,        l.ledger_category_code
      ,        l.alc_ledger_type_code 
      ,        l.le_ledger_type_code
      ,        l.chart_of_accounts_id
      ,        l.currency_code
      ,        l.period_set_name
      ,        l.accounted_period_type
      ,        l.sla_accounting_method_code
      ,        l.sla_accounting_method_type
      ,        l.sla_ledger_cash_basis_flag
      ,        l.latest_opened_period_name
      ,        v.chart_of_accounts_name
      ,        l.ret_earn_code_combination_id
      ,        v.suspense_ccid
      ,        l.rounding_code_combination_id
      ,        l.enable_je_approval_flag
      ,        v.period_end_user_rate_type
      ,        v.period_average_user_rate_type
      ,        l.cum_trans_code_combination_id
      ,        l.enable_reconciliation_flag
      ,        l.enable_budgetary_control_flag
      ,        l.require_budget_journals_flag
      ,        l.res_encumb_code_combination_id
      ,        l.allow_intercompany_post_flag "Enable Intracompany Balancing"
      ,        l.enable_automatic_tax_flag "Enable Journal Entry Tax"
      ,        l.criteria_set_id
      ,        l.future_enterable_periods_limit
      ,        l.first_ledger_period_name
      ,        critset.criteria_set_name
      ,        l.enable_average_balances_flag
      ,        l.consolidation_ledger_flag
      ,        l.translate_eod_flag
      ,        l.translate_qatd_flag
      ,        l.translate_yatd_flag
      ,        l.transaction_calendar_id
      ,        v.transaction_calendar_name
      ,        l.daily_translation_rate_type
      ,        l.net_income_code_combination_id
      FROM     GL_LEDGERS l,
               GL_LEDGERS_V v,
               GL_AUTOREV_CRITERIA_SETS critset
      WHERE    l.ledger_id = ##$$LEDGERID$$##
      AND      v.ledger_id = l.ledger_id
      AND      l.criteria_set_id = critset.criteria_set_id (+)',
      p_title                  => 'Primary Ledger Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Primary and reporting ledger information found.',
      p_solution               => '',
      p_success_msg            => 'Displaying the primary and reporting ledger information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: LNS_GEN_LEDGER');



debug('begin add_signature: LNS_XLA_TRANSACTION_ENTITIES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14398',
      p_sig_id                 => 'LNS_XLA_TRANSACTION_ENTITIES',
      p_sig_sql                => 'SELECT * 
FROM XLA_TRANSACTION_ENTITIES
WHERE source_id_int_1 = ##$$LOAN_ID$$## 
AND application_id = 206',
      p_title                  => 'Subledger (XLA) Transaction Entities',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Subledger Accounting (XLA) lines extracted for this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying the Subledger Accounting (XLA) lines extracted for this loan.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_XLA_TRANSACTION_ENTITIES');



debug('begin add_signature: LNS_ACCOUNTING_HEADERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14446',
      p_sig_id                 => 'LNS_ACCOUNTING_HEADERS',
      p_sig_sql                => 'SELECT
    *
FROM
    lns_loan_headers_ext_v
WHERE
    loan_id = ##$$LOAN_ID$$##',
      p_title                  => 'Accounting Header',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No accounting header information created on this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying the loan accounting header on this loan.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_ACCOUNTING_HEADERS');



debug('begin add_signature: LNS_ACCOUNTING_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14447',
      p_sig_id                 => 'LNS_ACCOUNTING_LINES',
      p_sig_sql                => 'SELECT
    *
FROM
    lns_loan_details_ext_v
WHERE
    loan_id = ##$$LOAN_ID$$##',
      p_title                  => 'Accounting Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No accounting lines on this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying the accounting lines on this loan.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_ACCOUNTING_LINES');



debug('begin add_signature: LNS_XLA_EVENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14399',
      p_sig_id                 => 'LNS_XLA_EVENTS',
      p_sig_sql                => 'select events.* 
from XLA_EVENTS events, 
     XLA_TRANSACTION_ENTITIES ent 
WHERE events.ENTITY_ID = ent.ENTITY_ID 
and ent.SOURCE_ID_INT_1 = ##$$LOAN_ID$$## 
and ent.APPLICATION_ID = 206',
      p_title                  => 'Subledger Accounting (XLA) Events',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No information related to a specific event on this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying the information related to a specific event on this loan.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_XLA_EVENTS');



debug('begin add_signature: LNS_XLA_AE_HEADERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14400',
      p_sig_id                 => 'LNS_XLA_AE_HEADERS',
      p_sig_sql                => 'select head.* 
from XLA_AE_HEADERS head, 
     XLA_TRANSACTION_ENTITIES ent 
WHERE head.ENTITY_ID = ent.ENTITY_ID 
and ent.SOURCE_ID_INT_1 = ##$$LOAN_ID$$## 
and ent.APPLICATION_ID = 206',
      p_title                  => 'Subledger Accounting Entries (AE) Header',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No subledger journal entries on this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying the subledger journal entries on this loan.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_XLA_AE_HEADERS');



debug('begin add_signature: LNS_XLA_AE_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14401',
      p_sig_id                 => 'LNS_XLA_AE_LINES',
      p_sig_sql                => 'SELECT lines.* 
FROM XLA_AE_LINES lines, 
     XLA_AE_HEADERS head, 
     XLA_TRANSACTION_ENTITIES ent
WHERE lines.AE_HEADER_ID = head.AE_HEADER_ID 
and head.ENTITY_ID = ent.ENTITY_ID 
and ent.SOURCE_ID_INT_1 = ##$$LOAN_ID$$## 
and ent.APPLICATION_ID = 206',
      p_title                  => 'Subledger Accounting Entries (AE) Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Accounting Entries (AE) lines for this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying the Accounting Entries (AE) lines for this loan.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_XLA_AE_LINES');



debug('begin add_signature: LNS_GL_BC_PACKETS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14402',
      p_sig_id                 => 'LNS_GL_BC_PACKETS',
      p_sig_sql                => 'select pack.* 
from GL_BC_PACKETS pack, 
     XLA_TRANSACTION_ENTITIES ent 
WHERE pack.ENTITY_ID = ent.ENTITY_ID 
and ent.SOURCE_ID_INT_1 = ##$$LOAN_ID$$## 
and ent.APPLICATION_ID = 206',
      p_title                  => 'General Ledger (GL) Budgetary Control (BC) Packets',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Budgetary Control (BC) information on this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying the Budgetary Control (BC) information on this loan.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_GL_BC_PACKETS');



debug('begin add_signature: LNS_PSA_XLA_ACCOUNTING_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14403',
      p_sig_id                 => 'LNS_PSA_XLA_ACCOUNTING_ERRORS',
      p_sig_sql                => 'SELECT err.* 
FROM PSA_XLA_ACCOUNTING_ERRORS err, 
     XLA_TRANSACTION_ENTITIES ent 
WHERE err.ENTITY_ID = ent.ENTITY_ID 
and ent.SOURCE_ID_INT_1 = ##$$LOAN_ID$$## 
and ent.APPLICATION_ID = 206',
      p_title                  => 'Public Sector (PSA) Subledger Accounting Errors',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Public Sector (PSA) accounting errors on this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying the Public Sector (PSA) accounting errors on this loan.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_PSA_XLA_ACCOUNTING_ERRORS');



debug('begin add_signature: LNS_PSA_BC_ACCOUNTING_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14404',
      p_sig_id                 => 'LNS_PSA_BC_ACCOUNTING_ERRORS',
      p_sig_sql                => 'SELECT err.* 
FROM PSA_BC_ACCOUNTING_ERRORS err, 
XLA_TRANSACTION_ENTITIES ent  
WHERE err.entity_id = ent.entity_id 
and ent.source_id_int_1 = ##$$LOAN_ID$$## 
and ent.application_id = 206',
      p_title                  => 'Public Sector (PSA) Budgetary Control (BC) Accounting Errors',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Public Sector accounting errors for the Budgetary Control on this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying Public Sector accounting errors for the Budgetary Control on this loan.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_PSA_BC_ACCOUNTING_ERRORS');



debug('begin add_signature: LNS_LOAN_TYPES_VL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14389',
      p_sig_id                 => 'LNS_LOAN_TYPES_VL',
      p_sig_sql                => 'SELECT
    loan_type_id,
    loan_type_name,
    loan_type_desc,
...
WHERE loan_type_id = ##$$LOAN_TYPE_ID$$##',
      p_title                  => 'Loan Type',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No loan type available for this loan.',
      p_solution               => '',
      p_success_msg            => 'Displaying the loan type used for this loan.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_LOAN_TYPES_VL');



debug('begin add_signature: LNS_INT_RATE_HEADERS_VL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14390',
      p_sig_id                 => 'LNS_INT_RATE_HEADERS_VL',
      p_sig_sql                => 'SELECT
    *
FROM
    lns_int_rate_headers_vl
ORDER BY
    interest_rate_id',
      p_title                  => 'Interest Rate Name',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No interest rate indexes.',
      p_solution               => '',
      p_success_msg            => 'Displaying the defined interest rate indexes.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_INT_RATE_HEADERS_VL');



debug('begin add_signature: LNS_INT_RATE_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14393',
      p_sig_id                 => 'LNS_INT_RATE_LINES',
      p_sig_sql                => 'SELECT
    *
FROM
    lns_int_rate_lines
ORDER BY
    interest_rate_id,
    interest_rate_line_id',
      p_title                  => 'Interest Rates Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No interest rate index lines.',
      p_solution               => '',
      p_success_msg            => 'Displaying defined interest rate index lines.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_INT_RATE_LINES');



debug('begin add_signature: LNS_SYSTEM_OPTIONS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14394',
      p_sig_id                 => 'LNS_SYSTEM_OPTIONS_ALL',
      p_sig_sql                => 'select * 
from LNS_SYSTEM_OPTIONS_ALL',
      p_title                  => 'Loans System Options',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no System Options setup for Loans.',
      p_solution               => '',
      p_success_msg            => 'Displaying System Options setup for Loans.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_SYSTEM_OPTIONS_ALL');



debug('begin add_signature: LNS_DEFAULT_DISTRIBS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14395',
      p_sig_id                 => 'LNS_DEFAULT_DISTRIBS_ALL',
      p_sig_sql                => 'SELECT default_distribution_id,
       loan_class,
       loan_type,
       line_type,
       account_name,
       ...
       org_id,
       loan_type_id
FROM LNS_DEFAULT_DISTRIBS_ALL 
WHERE ORG_ID = ##$$ORGID$$## 
AND LOAN_CLASS = ''##$$CLASS_CODE$$##'' 
AND LOAN_TYPE_ID =  ##$$LOAN_TYPE_ID$$## 
ORDER BY DISTRIBUTION_TYPE desc',
      p_title                  => 'Default Distributions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No default distributions assigned to the specific loan types.',
      p_solution               => '',
      p_success_msg            => 'Displaying default distributions assigned to the specific loan types.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_DEFAULT_DISTRIBS_ALL');



debug('begin add_signature: LNS_LOAN_PRODUCTS_ALL_VL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14396',
      p_sig_id                 => 'LNS_LOAN_PRODUCTS_ALL_VL',
      p_sig_sql                => 'select * 
from LNS_LOAN_PRODUCTS_ALL_VL 
where LOAN_PRODUCT_ID = nvl(''##$$LOAN_PROD_ID$$##'',-99)',
      p_title                  => 'Loan Product - For this Loan',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No loan product assigned to this loan.',
      p_solution               => 'There is a missing sequence and will need a datafix.<br>
Review [2109246.1] Error When Creating Loan Products - JBO-25013: Too Many Objects Match the Primary Key for more information.                     ',
      p_success_msg            => 'Displaying the loan product assigned to this loan.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_LOAN_PRODUCTS_ALL_VL');



debug('begin add_signature: EBS_FIN_AR_LNSANLZ_ALL_PRODUCTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24557',
      p_sig_id                 => 'EBS_FIN_AR_LNSANLZ_ALL_PRODUCTS',
      p_sig_sql                => 'SELECT
    *
FROM
    lns_loan_products_all_vl
ORDER BY
    loan_product_id',
      p_title                  => 'Loan Products - All',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Data collections of the defined Loan Products',
      p_solution               => '',
      p_success_msg            => 'Displaying all defined loan products.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_LNSANLZ_ALL_PRODUCTS');



debug('begin add_signature: LNS_LOAN_PRODUCT_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14397',
      p_sig_id                 => 'LNS_LOAN_PRODUCT_LINES',
      p_sig_sql                => 'select * 
  from LNS_LOAN_PRODUCT_LINES 
where LOAN_PRODUCT_ID = nvl(''##$$LOAN_PROD_ID$$##'',-99) 
ORDER BY LOAN_PRODUCT_LINE_TYPE',
      p_title                  => 'Product Line Types',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No product line types assigned to this loan.',
      p_solution               => 'There is a missing sequence and will need a datafix.<br>
Review [2109246.1] Error When Creating Loan Products - JBO-25013: Too Many Objects Match the Primary Key for more information.',
      p_success_msg            => 'Displaying the product line types assigned to this loan.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_LOAN_PRODUCT_LINES');



debug('begin add_signature: EBS_FIN_AR_LNSANLZ_EVENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26294',
      p_sig_id                 => 'EBS_FIN_AR_LNSANLZ_EVENTS',
      p_sig_sql                => 'SELECT
    event_id,
    loan_class_code,
    event_name,
...
ORDER BY
    event_id',
      p_title                  => 'Loans Events',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no Notification Events defined for Oracle Loans.
',
      p_solution               => '',
      p_success_msg            => 'Displaying the Notification Events for Oracle Loans.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_LNSANLZ_EVENTS');



debug('begin add_signature: EBS_FIN_AR_LNSANLZ_EVENT_ACTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26295',
      p_sig_id                 => 'EBS_FIN_AR_LNSANLZ_EVENT_ACTIONS',
      p_sig_sql                => 'SELECT
    event_action_id,
    event_id,
    event_action_name,
...
ORDER BY
    event_action_id',
      p_title                  => 'Loans Event Actions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no Notification Event Actions defined for Oracle Loans.
',
      p_solution               => '',
      p_success_msg            => 'Displaying the Notification Event Actions for Oracle Loans.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_LNSANLZ_EVENT_ACTIONS');
...
debug('begin add_signature: LNS_GEN_PROFILES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14387',
      p_sig_id                 => 'LNS_GEN_PROFILES',
...
a.level_id ASC',
      p_title                  => 'Oracle Loans (LNS) Profile Options',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Displaying the profile options for Oracle Loans.
',
      p_solution               => '',
      p_success_msg            => 'Displaying the profile options for Oracle Loans.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_GEN_PROFILES');



debug('begin add_signature: LNS_GEN_INVALIDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14384',
      p_sig_id                 => 'LNS_GEN_INVALIDS',
    ...
    AND a.owner = ''APPS''
    AND (a.object_name like ''LNS%'')
    AND a.status = ''INVALID''',
      p_title                  => 'Oracle Loans (LNS) Invalid PL/SQL Packages',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are invalid PL/SQL packages in your instance for Oracle Loans.',
...
<li>If you still have invalid objects, please review steps from [1325394.1] Troubleshooting Guide - Invalid Objects in the E-Business Suite Environment 11i and 12</li>
      ...
      p_success_msg            => 'There are no invalid PL/SQL packages in your instance for Oracle Loans.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_GEN_INVALIDS');



debug('begin add_signature: LNS_GEN_FORM_LIB_RPT_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14385',
      p_sig_id                 => 'LNS_GEN_FORM_LIB_RPT_VERSIONS',
      p_sig_sql                => 'SELECT
    b.filename,
    a.version,
    a.creation_date,
...
ORDER BY
    1
',
      p_title                  => 'Oracle Loans (LNS) Forms, Libraries and Reports Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Displaying the forms, libraries and report files and versions for Oracle Loans in your instance.',
      p_solution               => '',
      p_success_msg            => 'Displaying the forms, libraries and report files and versions for Oracle Loans in your instance.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_GEN_FORM_LIB_RPT_VERSIONS');



debug('begin add_signature: LNS_GEN_ODF_FILE_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14383',
      p_sig_id                 => 'LNS_GEN_ODF_FILE_VERSIONS',
...
from ad_files
where app_short_name in (''LNS'') and ( upper(filename) like upper(''%.odf'') or upper(filename) like upper(''%.xdf''))
) files
where files.file_id = file_version.file_id
) que
where rank1 = 1
order by 1',
      p_title                  => 'Oracle Loans (LNS) .odf / .xdf Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No ODF and XDF files for Oracle Loans in your instance.',
      p_solution               => '',
      p_success_msg            => 'Displaying the ODF and XDF files for Oracle Loans in your instance.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_GEN_ODF_FILE_VERSIONS');



debug('begin add_signature: LNS_GEN_PKG_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14386',
      p_sig_id                 => 'LNS_GEN_PKG_VERSIONS',
...
order by 1',
      p_title                  => 'Oracle Loans (LNS) PL/SQL Package Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No PL/SQL packages for Oracle Loans in your instance.',
      p_solution               => '',
      p_success_msg            => 'Displaying the PL/SQL packages and versions for Oracle Loans on your instance.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_GEN_PKG_VERSIONS');



debug('begin add_signature: LNS_GEN_RDBMS_VERSION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14388',
      p_sig_id                 => 'LNS_GEN_RDBMS_VERSION',
      p_sig_sql                => 'SELECT banner rdbms_version
FROM   v$version',
      p_title                  => 'RDBMS Version',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Displaying the RDBMS version.',
      p_solution               => '',
      p_success_msg            => 'Displaying the RDBMS version.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_GEN_RDBMS_VERSION');



debug('begin add_signature: LNS_AMORT_FILE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14777',
      p_sig_id                 => 'LNS_AMORT_FILE',
      p_sig_sql                => 'SELECT
    adf.filename,
    adfv.version
FROM
...
WHERE
    ...
    AND adf.app_short_name = ''LNS''
    AND adf.filename = ''AmortizationScheduleAMImpl.class''
    AND adfv.file_version_id = (
        SELECT
            MAX(adfv2.file_version_id)
        FROM
            ad_file_versions adfv2
        WHERE
            adf.file_id = adfv2.file_id
    )
    AND ( ( ''12.2'' = (SELECT substr(max(release_name),1,4) FROM fnd_product_groups)
            AND fnd_irep_loader_private.compare_versions(adfv.version, ''120.22.12020000.6'') = ''<'' ) 
          OR ( ''12.1'' = (SELECT substr(max(release_name),1,4) FROM fnd_product_groups)
               AND fnd_irep_loader_private.compare_versions(adfv.version, ''120.5.12010000.24'') = ''<'' ) )',
      p_title                  => 'Amortization File',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The file <i>AmortizationScheduleAMImpl.java</i> is on a lower recommended version.<br>
This can cause the Current Amortization Schedule to result in an error, or not show correct amounts.',
      p_solution               => 'Upgrade to the latest file version of <i>AmortizationScheduleAMImpl.java</i>. <br>
For more information, review [2424527.1] Amortization Schedule With Large Number Errors With JBO-25028: Number.intValue Creation Error. <br>
<br>
...
',
      p_success_msg            => 'The file versions recommended in [2424527.1] are installed.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_AMORT_FILE');



debug('begin add_signature: LNS_BILLING_FILE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14770',
      p_sig_id                 => 'LNS_BILLING_FILE',
...
(select af1.filename "FILENAME",
     afv1.version "Current Versions", ''120.74.12020000.24'' "FIXED VERSION",
...
where af1.file_id = afv1.file_id
  and af1.filename in (''LNS_BILLING_B.pls'')
  and ''12.2'' = (SELECT substr(max(release_name),1,4) FROM fnd_product_groups)
  )
union all
(select af1.filename "FILENAME",
     afv1.version "Current Versions", ''120.33.12010000.66'' "FIXED VERSION",
	   rank()over(partition by af1.filename
	     order by afv1.version_segment1 desc,
	     afv1.version_segment2 desc,afv1.version_segment3 desc,
	     afv1.version_segment4 desc,afv1.version_segment5 desc,
...
and ds.LINE = 2
AND ds.NAME = ''LNS_BILLING_BATCH_PUB''
AND ds.TYPE = ''PACKAGE BODY''',
      p_title                  => 'Billing Program',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The file <i>LNS_BILLING_B.pls</i> is on a lower recommended version.<br>
This can cause the Loans Billing program to error with a Generation of Loan Billing Statement failed message.',
      p_solution               => 'Upgrade to the latest file version of <i>LNS_BILLING_B.pls</i>.<br>
For more information, review [2462550.1] Generation Of Loan Billing Statement Error After Upgrading LNS_BILLING_B.pls to 120.74.12020000.15. <br>
<br>
For the most current recommendations, use the Patch Wizard or the Updates & Patches Tab in My Oracle Support.<br>
Further guidance can be found in the following documents:<br>
<ul>
...
',
      p_success_msg            => 'Verified that the file versions recommended in [2462550.1] are installed.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_BILLING_FILE');



debug('begin add_signature: LNS_SEARCH_FILE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14772',
      p_sig_id                 => 'LNS_SEARCH_FILE',
      p_sig_sql                => 'SELECT
    adf.filename,
    adfv.version
FROM
...
WHERE
    adf.file_id = adfv.file_id
    AND adf.app_short_name = ''LNS''
    AND adf.filename = ''AdvSearchVO.xml''
    AND adfv.file_version_id = (
        SELECT
            MAX(adfv2.file_version_id)
        FROM
    ...
    AND ( ( ''12.2'' = (SELECT substr(max(release_name),1,4) FROM fnd_product_groups)
            AND fnd_irep_loader_private.compare_versions(adfv.version, ''120.9.12020000.4'') = ''<'' ) 
          OR ( ''12.1'' = (SELECT substr(max(release_name),1,4) FROM fnd_product_groups)
               AND fnd_irep_loader_private.compare_versions(adfv.version, ''120.6.12010000.6'') = ''<'' ) )',
      p_title                  => 'Dashboard Search',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The file <i>AdvSearchVO.xml</i> is on a lower recommended version.<br>
This can cause the Loans Advanced Search to not return all expected Loans.',
      p_solution               => 'Upgrade to the latest file version of <i>AdvSearchVO.xml</i>. <br>
For more information, review [2622557.1] Loans Dashboard Advanced Search Does Not Return Loans With Reversed Bills. <br>
<br>
For the most current recommendations, use the Patch Wizard or the Updates & Patches Tab in My Oracle Support.<br>
Further guidance can be found in the following documents:<br>
<ul>
...
',
      p_success_msg            => 'Verified that the file versions recommended in [2622557.1] are installed.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: LNS_SEARCH_FILE');
...
debug('begin section: LOAN_DATA');
start_section('Loan Data', 'LOAN_DATA');
   set_item_result(run_stored_sig('LNS_LOAN_HEADER'));
   set_item_result(run_stored_sig('LNS_TERMS'));
   set_item_result(run_stored_sig('LNS_FREQ_SCHEDULE'));
   set_item_result(run_stored_sig('LNS_RATE_SCHEDULE'));
   set_item_result(run_stored_sig('LNS_APPROVAL_ACTIONS'));
   set_item_result(run_stored_sig('LNS_PARTICIPANTS'));
   set_item_result(run_stored_sig('LNS_LOAN_LINES'));
   set_item_result(run_stored_sig('LNS_FEE_ASSIGNMENT'));
   set_item_result(run_stored_sig('LNS_FEE_SCHEDULE'));
   set_item_result(run_stored_sig('LNS_DISBURSEMENT_HEADERS'));
   set_item_result(run_stored_sig('LNS_DISBURSEMENT_LINES'));
   set_item_result(run_stored_sig('LNS_ADJUSTMENTS'));
   set_item_result(run_stored_sig('LNS_DISTRIBUTIONS'));
   set_item_result(run_stored_sig('LNS_AMORT_ORIGINAL'));
   set_item_result(run_stored_sig('LNS_AMORT_CURRENT'));
   set_item_result(run_stored_sig('LNS_AMORT_CUSTOM'));
   set_item_result(run_stored_sig('LNS_PMT_SUMMARY'));
   set_item_result(run_stored_sig('LNS_OVERDUE_PMT_SUMMARY'));
   set_item_result(run_stored_sig('LNS_PMT_YTD'));
   set_item_result(run_stored_sig('LNS_LOAN_EXTENSIONS'));
   set_item_result(run_stored_sig('LNS_LOAN_SPLITS'));
   set_item_result(run_stored_sig('LNS_CANCELLATIONS'));
   set_item_result(run_stored_sig('LNS_CANCELLATION_DETAILS'));
   set_item_result(run_stored_sig('LNS_PMT_HIST_AMORT_SCHED'));
   set_item_result(run_stored_sig('LNS_PMT_HIST_AMORT_SCHED_DET'));
   set_item_result(run_stored_sig('LNS_AMORT_SCHEDS'));
   set_item_result(run_stored_sig('LNS_AMORTIZATION_LINES'));
   set_item_result(run_stored_sig('LNS_RECEIVABLE_ACTIVITIES'));
   set_item_result(run_stored_sig('LNS_PRINCIPAL_ACTIVITIES'));
   set_item_result(run_stored_sig('LNS_INTEREST_ACTIVITIES'));
   set_item_result(run_stored_sig('EBS_FIN_AR_LNSANLZ_ASSET_ASG'));
   set_item_result(run_stored_sig('EBS_FIN_AR_LNSANLZ_ASSET'));
end_section;
debug('end section: LOAN_DATA');

debug('begin section: LOAN_ACCOUNTING');
start_section('Loan Accounting', 'LOAN_ACCOUNTING');
   set_item_result(run_stored_sig('LNS_GEN_LEDGER'));
   set_item_result(run_stored_sig('LNS_DISTRIBUTIONS'));
   set_item_result(run_stored_sig('LNS_XLA_TRANSACTION_ENTITIES'));
   set_item_result(run_stored_sig('LNS_ACCOUNTING_HEADERS'));
   set_item_result(run_stored_sig('LNS_ACCOUNTING_LINES'));
   set_item_result(run_stored_sig('LNS_XLA_EVENTS'));
   set_item_result(run_stored_sig('LNS_XLA_AE_HEADERS'));
   set_item_result(run_stored_sig('LNS_XLA_AE_LINES'));
   set_item_result(run_stored_sig('LNS_GL_BC_PACKETS'));
   set_item_result(run_stored_sig('LNS_PSA_XLA_ACCOUNTING_ERRORS'));
   set_item_result(run_stored_sig('LNS_PSA_BC_ACCOUNTING_ERRORS'));
end_section;
debug('end section: LOAN_ACCOUNTING');

debug('begin section: LOAN_SETUP');
start_section('Loan Setup', 'LOAN_SETUP');
   set_item_result(run_stored_sig('LNS_LOAN_TYPES_VL'));
   set_item_result(run_stored_sig('LNS_INT_RATE_HEADERS_VL'));
   set_item_result(run_stored_sig('LNS_INT_RATE_LINES'));
   set_item_result(run_stored_sig('LNS_SYSTEM_OPTIONS_ALL'));
   set_item_result(run_stored_sig('LNS_DEFAULT_DISTRIBS_ALL'));
   set_item_result(run_stored_sig('LNS_LOAN_PRODUCTS_ALL_VL'));
   set_item_result(run_stored_sig('EBS_FIN_AR_LNSANLZ_ALL_PRODUCTS'));
   set_item_result(run_stored_sig('LNS_LOAN_PRODUCT_LINES'));
   set_item_result(run_stored_sig('EBS_FIN_AR_LNSANLZ_EVENTS'));
   set_item_result(run_stored_sig('EBS_FIN_AR_LNSANLZ_EVENT_ACTIONS'));
end_section;
debug('end section: LOAN_SETUP');

debug('begin section: PROACTIVE');
start_section('Setup and Environment', 'PROACTIVE');
   IF p_apps_check = 'Y' THEN
      set_item_result(check_rec_patches_1); /* Signature LNS_GEN_RECOMMENDED_PATCHES */
      set_item_result(run_stored_sig('LNS_GEN_PROFILES'));
      set_item_result(run_stored_sig('LNS_GEN_INVALIDS'));
      set_item_result(run_stored_sig('LNS_GEN_FORM_LIB_RPT_VERSIONS'));
      set_item_result(run_stored_sig('LNS_GEN_ODF_FILE_VERSIONS'));
      set_item_result(run_stored_sig('LNS_GEN_PKG_VERSIONS'));
      set_item_result(run_stored_sig('LNS_GEN_RDBMS_VERSION'));
      set_item_result(run_stored_sig('LNS_AMORT_FILE'));
      set_item_result(run_stored_sig('LNS_BILLING_FILE'));
      set_item_result(run_stored_sig('LNS_SEARCH_FILE'));
