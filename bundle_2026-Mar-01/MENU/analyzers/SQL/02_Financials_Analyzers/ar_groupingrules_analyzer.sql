...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Receivables Grouping Rules Analyzer    |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE ar_groupingrules_analyzer_pkg AUTHID DEFINER AS
...
(            p_org_id                       IN VARCHAR2    DEFAULT NULL
           ,p_first_trx_id                 IN NUMBER      DEFAULT NULL
           ,p_second_trx_id                IN NUMBER      DEFAULT NULL
...
END ar_groupingrules_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY ar_groupingrules_analyzer_pkg AS
-- $Id: ar_groupingrules_analyzer.sql, 200.38 2026/01/29 15:27:07 mamoreir Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2073657.1));
...
-- Parameter Related
    ...
    g_1_trx_id     NUMBER := NULL;
    g_2_trx_id     NUMBER := NULL;


    g_org_id_tmp   NUMBER := NULL;
    g_1_trx_id_tmp NUMBER := NULL;
    g_2_trx_id_tmp NUMBER := NULL;
 
    g_rule_name    RA_GROUPING_RULES.name%type  := NULL;


--Grouping Rule First Transaction/Batch Source related
    g_1_batch_source_id   	NUMBER(15)  := NULL;
    g_1_bill_to_id          NUMBER(15)  := NULL;
    g_1_bill_site           NUMBER(15)  := NULL;
    g_1_cust_trx_type_id    NUMBER(15)  := NULL;
    g_1_grouping_rule_id    NUMBER(15)  := NULL;
    g_1_rule_level          VARCHAR2(30);
    g_trx_class             VARCHAR2(1);  

--Grouping Rule Second Transaction/Transaction Batch Source related
    g_2_batch_source_id   	NUMBER(15)  := NULL;
    g_2_bill_to_id          NUMBER(15)  := NULL;
    g_2_bill_site           NUMBER(15)  := NULL;
    g_2_cust_trx_type_id    NUMBER(15)  := NULL;
    g_2_grouping_rule_id    NUMBER(15)  := NULL;
    g_2_rule_level          VARCHAR2(30);
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'AR_GRPRULE_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'AR_GRPRULE_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>AR_GRPRULE Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2073657.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/ar_group_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,364,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,364,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},364,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/3900583" class="blacklink" target="new">
...
<ul><li>ATG Signatures updated, template changes</li>
</ul>
<p>&nbsp;</p>
            <br><br>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,364,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,364,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},364,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
debug('begin populate parameters hash table');
   ...
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'First Customer Transaction ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_first_trx_id,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Second Customer Transaction ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_second_trx_id,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  l_revision := rtrim(replace('$Revision: 200.38  $','$',''));
  l_revision := ltrim(replace(l_revision,'Revision:',''));
  l_date_char := rtrim(replace('$Date: 2026/01/29 15:27:06 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'ar_groupingrules_analyzer.sql';
...
debug('begin parameter validation: p_first_trx_id');
IF p_first_trx_id IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter First Customer Transaction ID is required.');
   raise invalid_parameters;
END IF;
IF p_first_trx_id IS NOT NULL THEN
BEGIN
SELECT CUSTOMER_TRX_ID
INTO l_exists_val
FROM RA_CUSTOMER_TRX_ALL
WHERE CUSTOMER_TRX_ID = p_first_trx_id
 AND org_id = p_org_id
and batch_source_id is not null
and batch_source_id > 0
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid first customer transaction ID.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_first_trx_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_first_trx_id');

debug('begin parameter validation: p_second_trx_id');
IF p_second_trx_id IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Second Customer Transaction ID is required.');
   raise invalid_parameters;
END IF;
IF p_second_trx_id IS NOT NULL THEN
BEGIN
SELECT CUSTOMER_TRX_ID
INTO l_exists_val
FROM RA_CUSTOMER_TRX_ALL
WHERE CUSTOMER_TRX_ID = p_second_trx_id
 AND org_id = p_org_id
and batch_source_id = (select batch_source_id from ra_customer_trx_all
                       where customer_trx_id = p_first_trx_id)
and customer_trx_id <> p_first_trx_id
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Second Customer Transaction Id');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_second_trx_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_second_trx_id');
...
g_1_trx_id_tmp  := p_first_trx_id;
g_2_trx_id_tmp  := p_second_trx_id;
...
ELSE  
  BEGIN
     select hr.name, ar.set_of_books_id
     into g_ou_name, g_ledger_id
     ...
     print_log('Org_Id = ' || g_org_id_tmp || ' has been validated. Setting org context');
         
  EXCEPTION
  when no_data_found then
     print_log('ERROR: Unable to retrieve record from ar_system_parameters_all and/or hr_operating_units for ORG_ID value = '|| g_org_id_tmp);
     raise invalid_parameters;
  END;
END IF;

-- Check trx ids are valid
IF g_1_trx_id_tmp is null or g_2_trx_id_tmp is null then
   print_log('ERROR: Please provide two transactions to compare.');
   raise invalid_parameters; 
ELSE
   begin
      -- Gather data for grouping rules

      select trx.batch_source_id, trx.bill_to_customer_id, trx.bill_to_site_use_id, trx.cust_trx_type_id, decode(typ.type,'INV','I','CM','C','DM','D')
      into g_1_batch_source_id, g_1_bill_to_id, g_1_bill_site, g_1_cust_trx_type_id, g_trx_class
      from ra_customer_trx trx, ra_cust_trx_types typ
      where trx.customer_trx_id = g_1_trx_id_tmp
      and   trx.cust_trx_type_id = typ.cust_trx_type_id;

      select trx.batch_source_id, trx.bill_to_customer_id, trx.bill_to_site_use_id, trx.cust_trx_type_id
      into g_2_batch_source_id, g_2_bill_to_id, g_2_bill_site, g_2_cust_trx_type_id
      from ra_customer_trx trx, ra_cust_trx_types typ
      where trx.customer_trx_id = g_2_trx_id_tmp
      and   trx.cust_trx_type_id = typ.cust_trx_type_id;

      -- display ALL global variables to be used in SQL token values
      print_log('##$$TRX1$$## = '             || g_1_trx_id_tmp);
      print_log('##$$TRX2$$## = '             || g_2_trx_id_tmp);

      print_log('RA_CUSTOMER_TRX: Details for first TRX = ' || g_1_trx_id_tmp);
      print_log('   batch_source_id     = ' || g_1_batch_source_id);
      print_log('   bill_to_customer_id = ' || g_1_bill_to_id);
      print_log('   bill_to_site_use_id = ' || g_1_bill_site);
      print_log('   cust_trx_type_id    = ' || g_1_cust_trx_type_id);
      print_log('   type                = ' || g_trx_class);


      print_log('RA_CUSTOMER_TRX: Details for second TRX = ' || g_2_trx_id_tmp);
      print_log('   batch_source_id     = ' || g_2_batch_source_id);
      print_log('   bill_to_customer_id = ' || g_2_bill_to_id);
      print_log('   bill_to_site_use_id = ' || g_2_bill_site);
      print_log('   cust_trx_type_id    = ' || g_2_cust_trx_type_id);

   exception
   when no_data_found then
      print_log('ERROR: Could not retrieve data for the transactions you provided.');
      raise invalid_parameters; 
   end;

   begin
      -- determine where the grouping rule ID will come from
      -- hierarchy is:
      -- 1. batch source
      -- 2. site level profile
      -- 3. account level profile
      -- 4. system parameters

      -- derive grouping rule for TRX1
      select nvl(bs.grouping_rule_id, nvl(site.grouping_rule_id, nvl(cust.grouping_rule_id, param.default_grouping_rule_id))),
             decode(bs.grouping_rule_id, null, 
                                         decode(site.grouping_rule_id, null, 
                                                                       decode(cust.grouping_rule_id, null, 'Level 4: System Parameter', 
                                                                                                     'Level 3: Account Profile'), 
                                                                       'Level 2: Site Profile'), 
                                        'Level 1: Batch Source')
      into   g_1_grouping_rule_id, g_1_rule_level
      ...
      and    site.cust_account_id(+) = trx.bill_to_customer_id
      and    site.site_use_id(+) = trx.bill_to_site_use_id
      and    cust.cust_account_id = trx.bill_to_customer_id
      and    cust.site_use_id is null
      and    param.org_id = g_org_id_tmp;

      select name
      into   g_rule_name
      from   RA_GROUPING_RULES
      where  grouping_rule_id = g_1_grouping_rule_id;



      print_log('Grouping rule for TRX1  = ' || g_1_trx_id_tmp );
      print_log('   grouping_rule_id     = ' || g_1_grouping_rule_id);
      print_log('   derived from         = ' || g_1_rule_level);
      print_log('   name                 = ' || g_rule_name);

      -- derive grouping rule for TRX2
      select nvl(bs.grouping_rule_id, nvl(site.grouping_rule_id, nvl(cust.grouping_rule_id, param.default_grouping_rule_id))),
             decode(bs.grouping_rule_id, null, 
                                         decode(site.grouping_rule_id, null, 
                                                                       decode(cust.grouping_rule_id, null, 'Level 4: System Parameter', 
                                                                       ...
                                                                       'Level 2: Site Profile'), 
                                        'Level 1: Batch Source')
      into   g_2_grouping_rule_id, g_2_rule_level
      from   ra_batch_sources bs,
             hz_customer_profiles site,
             hz_customer_profiles cust,
             ar_system_parameters param,
      ...
      print_log('Grouping rule for TRX2  = ' || g_2_trx_id_tmp );
      print_log('   grouping_rule_id     = ' || g_2_grouping_rule_id);
      print_log('   derived from         = ' || g_2_rule_level);           

   exception
   when no_data_found then
      print_log('ERROR: Unable to determine grouping rule id');
      raise invalid_parameters;  
   end;
END IF;
...
debug('begin populate sql tokens hash table');
   ...
   g_sql_tokens('##$$TRX1$$##') := g_1_trx_id_tmp;
   g_masked_tokens('##$$TRX1$$##') := mask_text( g_sql_tokens('##$$TRX1$$##'), 'NO_MASK');
   g_sql_tokens('##$$TRX2$$##') := g_2_trx_id_tmp;
   g_masked_tokens('##$$TRX2$$##') := mask_text( g_sql_tokens('##$$TRX2$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPSCHECK$$##') := p_apps_check;
   g_masked_tokens('##$$APPSCHECK$$##') := mask_text( g_sql_tokens('##$$APPSCHECK$$##'), 'NO_MASK');
   g_sql_tokens('##$$RULE1$$##') := g_1_grouping_rule_id;
   g_masked_tokens('##$$RULE1$$##') := mask_text( g_sql_tokens('##$$RULE1$$##'), 'NO_MASK');
   g_sql_tokens('##$$RULE2$$##') := g_2_grouping_rule_id;
   g_masked_tokens('##$$RULE2$$##') := mask_text( g_sql_tokens('##$$RULE2$$##'), 'NO_MASK');
   g_sql_tokens('##$$LEVEL1$$##') := g_1_rule_level;
   g_masked_tokens('##$$LEVEL1$$##') := mask_text( g_sql_tokens('##$$LEVEL1$$##'), 'NO_MASK');
   g_sql_tokens('##$$LEVEL2$$##') := g_2_rule_level;
   g_masked_tokens('##$$LEVEL2$$##') := mask_text( g_sql_tokens('##$$LEVEL2$$##'), 'NO_MASK');
   g_sql_tokens('##$$RULENAME$$##') := g_rule_name;
   g_masked_tokens('##$$RULENAME$$##') := mask_text( g_sql_tokens('##$$RULENAME$$##'), 'NO_MASK');
   g_sql_tokens('##$$A$$##') := 'AR_GROUPINGRULES_ANALYZER_PKG';
...
debug('begin add_signature: AR_GR_RA_CUSTOMER_TRX_ALL');
   l_info('##MASK##CUSTOMER_REFERENCE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12717',
      p_sig_id                 => 'AR_GR_RA_CUSTOMER_TRX_ALL',
      p_sig_sql                => 'select ''Transaction #1'' "Transaction", trx.trx_number, 
       trx.customer_trx_id, trx.batch_source_id, trx.invoicing_rule_id, 
       trx.cust_trx_type_id, trx.complete_flag, 
       trx.customer_reference, 
       to_char(trx.trx_date,''DD-MON-YYYY''), trx.invoice_currency_code, 
       to_char(trx.exchange_rate), trx.status_trx
FROM   RA_CUSTOMER_TRX_ALL   trx
WHERE  trx.customer_trx_id = ##$$TRX1$$##
AND    trx.org_id = ##$$ORGID$$##
union
select ''Transaction #2'', trx.trx_number, 
       trx.customer_trx_id, trx.batch_source_id, trx.invoicing_rule_id, 
       trx.cust_trx_type_id, trx.complete_flag, 
       trx.customer_reference, 
       to_char(trx.trx_date,''DD-MON-YYYY''), trx.invoice_currency_code, 
       to_char(trx.exchange_rate), trx.status_trx
FROM   RA_CUSTOMER_TRX_ALL   trx 
WHERE  trx.customer_trx_id = ##$$TRX2$$##
AND    trx.org_id = ##$$ORGID$$##
order by 2',
      p_title                  => 'Transaction Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The transaction numbers you provided do not exist in RA_CUSTOMER_TRX_ALL.',
      p_solution               => 'Please verify that you have entered valid transaction numbers.',
      p_success_msg            => 'Displaying details of the transactions you provided.',
   ...
   l_info.delete;
debug('end add_signature: AR_GR_RA_CUSTOMER_TRX_ALL');



debug('begin add_signature: AR_GR_RA_CUST_TRX_TYPES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12718',
      p_sig_id                 => 'AR_GR_RA_CUST_TRX_TYPES_ALL',
      p_sig_sql                => 'select ''Transaction #1'' "Transaction", trx.trx_number, trx.customer_trx_id,
       trx.cust_trx_type_id, 
       typ.type, typ.name, typ.description, typ.status, typ.post_to_gl, typ.accounting_affect_flag
FROM   RA_CUSTOMER_TRX_ALL   trx,          
       RA_CUST_TRX_TYPES_ALL typ
WHERE  trx.customer_trx_id = ##$$TRX1$$##
AND    typ.cust_trx_type_id(+) = trx.cust_trx_type_id 
AND    NVL(typ.org_id(+), -99) = ##$$ORGID$$##
union all
select ''Transaction #2'' , trx.trx_number, trx.customer_trx_id,
       trx.cust_trx_type_id, 
       typ.type, typ.name, typ.description, typ.status, typ.post_to_gl, typ.accounting_affect_flag
FROM   RA_CUSTOMER_TRX_ALL   trx,          
       RA_CUST_TRX_TYPES_ALL typ
...
order by 2',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Transaction types associated to the transactions you provided do not exist.',
      p_solution               => 'Please verify the transactions have valid transaction types. 
For more information read [1067797/KB626659] Setting Up Transaction Types In Receivables.',
      p_success_msg            => 'Displaying general details for the transaction types associated to the transactions provided.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_GR_RA_CUST_TRX_TYPES_ALL');



debug('begin add_signature: AR_GR_RA_BATCH_SOURCES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12719',
      p_sig_id                 => 'AR_GR_RA_BATCH_SOURCES_ALL',
      p_sig_sql                => 'select ''Transaction #1'' "Transaction", trx.trx_number, trx.customer_trx_id, 
       trx.batch_source_id, bat.name, 
       bat.description, bat.status
FROM RA_CUSTOMER_TRX_ALL trx,
...
AND bat.batch_source_id(+) = trx.batch_source_id
order by 2',
      p_title                  => 'Batch Source Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The batch source associated to the transactions you provided do not exist.',
      p_solution               => 'Please verify the transactions have valid batch sources.
For more information, read [1068008/KB626879] Creating Transaction Sources Used For AutoInvoice.',
      p_success_msg            => 'Displaying general details for the batch sources associated to the transactions provided.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_GR_RA_BATCH_SOURCES_ALL');



debug('begin add_signature: AR_GR_BATCH_GROUPING_RULES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12721',
      p_sig_id                 => 'AR_GR_BATCH_GROUPING_RULES',
      p_sig_sql                => 'select ''Transaction #1'' "Transaction", trx.trx_number, trx.customer_trx_id, 
       trx.batch_source_id, bat.name, 
       bat.description, bat.status, 
       bat.grouping_rule_id, rul.name, rul.description, rul.start_date, rul.end_date, rul.ordering_rule_id
FROM RA_CUSTOMER_TRX_ALL trx,
     RA_BATCH_SOURCES_ALL bat,
     RA_GROUPING_RULES rul
WHERE trx.customer_trx_id = ##$$TRX1$$##
AND trx.org_id = ##$$ORGID$$##
AND bat.batch_source_id(+) = trx.batch_source_id
and rul.grouping_rule_id(+) = bat.grouping_rule_id
union all
select ''Transaction #2'', trx.trx_number, trx.customer_trx_id, 
       trx.batch_source_id, bat.name, 
       bat.description, bat.status, 
...
and rul.grouping_rule_id(+) = bat.grouping_rule_id
order by 2',
      p_title                  => 'Level 1: Grouping Rule Details for the Batch Source',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The batch source associated to the transactions you provided do not have grouping rules.',
      p_solution               => 'Defining a grouping rule at the Batch Source level is optional.
For more information, read [1067993/KB626338] How To Use Grouping Rules With AutoInvoice.',
      p_success_msg            => 'Displaying grouping rule details associated to Level 1. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_GR_BATCH_GROUPING_RULES');



debug('begin add_signature: AR_GR_SITE_GROUPING_RULES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12722',
      p_sig_id                 => 'AR_GR_SITE_GROUPING_RULES',
      p_sig_sql                => 'select ''Transaction #1'' "Transaction", trx.trx_number, trx.customer_trx_id, trx.bill_to_customer_id, trx.bill_to_site_use_id, 
       prof.grouping_rule_id, rul.name, rul.description, rul.start_date, rul.end_date, rul.ordering_rule_id
FROM RA_CUSTOMER_TRX_ALL trx,
     HZ_CUSTOMER_PROFILES prof,
     RA_GROUPING_RULES rul
WHERE trx.customer_trx_id = ##$$TRX1$$##
AND trx.org_id = ##$$ORGID$$##
AND prof.cust_account_id = trx.bill_to_customer_id
AND prof.site_use_id = trx.bill_to_site_use_id
and prof.grouping_rule_id = rul.grouping_rule_id(+)
union all
select ''Transaction #2'', trx.trx_number, trx.customer_trx_id, trx.bill_to_customer_id, trx.bill_to_site_use_id, 
       prof.grouping_rule_id, rul.name, rul.description, rul.start_date, rul.end_date, rul.ordering_rule_id
FROM RA_CUSTOMER_TRX_ALL trx,
     HZ_CUSTOMER_PROFILES prof,
     RA_GROUPING_RULES rul
...
AND prof.site_use_id = trx.bill_to_site_use_id
and prof.grouping_rule_id = rul.grouping_rule_id(+)',
      p_title                  => 'Level 2: Grouping Rule Details at Site Level',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The profiles for the site associated to the transactions you provided do not have grouping rules.',
      p_solution               => 'Defining a grouping rule at the site level is optional.
For more information, read [1068008/KB626879] Creating Transaction Sources Used For AutoInvoice.',
      p_success_msg            => 'Displaying grouping rule details associated to Level 2. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_GR_SITE_GROUPING_RULES');



debug('begin add_signature: AR_GR_CUST_GROUPING_RULES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12723',
      p_sig_id                 => 'AR_GR_CUST_GROUPING_RULES',
      p_sig_sql                => 'select ''Transaction #1'' "Transaction", trx.trx_number, trx.customer_trx_id, trx.bill_to_customer_id, trx.bill_to_site_use_id, 
       prof.grouping_rule_id, rul.name, rul.description, rul.start_date, rul.end_date, rul.ordering_rule_id
FROM RA_CUSTOMER_TRX_ALL trx,
     HZ_CUSTOMER_PROFILES prof,
...
and prof.grouping_rule_id = rul.grouping_rule_id(+)
union all
select ''Transaction #2'' "Transaction", trx.trx_number, trx.customer_trx_id, trx.bill_to_customer_id, trx.bill_to_site_use_id, 
       prof.grouping_rule_id, rul.name, rul.description, rul.start_date, rul.end_date, rul.ordering_rule_id
FROM RA_CUSTOMER_TRX_ALL trx,
     HZ_CUSTOMER_PROFILES prof,
     RA_GROUPING_RULES rul
...
and prof.grouping_rule_id = rul.grouping_rule_id(+)
order by 2',
      p_title                  => 'Level 3: Grouping Rule Details at Account Level',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The profiles for the account associated to the transactions you provided do not have grouping rules.',
      p_solution               => 'Defining a grouping rule at the account level is optional.
For more information, read [1068008/KB626879] Creating Transaction Sources Used For AutoInvoice.',
      p_success_msg            => 'Displaying grouping rule details associated to Level 3. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_GR_CUST_GROUPING_RULES');



debug('begin add_signature: AR_GR_SYS_GROUPING_RULES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12724',
      p_sig_id                 => 'AR_GR_SYS_GROUPING_RULES',
      p_sig_sql                => 'select param.default_grouping_rule_id, rul.name, rul.description, rul.start_date, rul.end_date, rul.ordering_rule_id
FROM AR_SYSTEM_PARAMETERS_ALL param,
     RA_GROUPING_RULES rul
WHERE param.org_id = ##$$ORGID$$##
and rul.grouping_rule_id(+) = param.default_grouping_rule_id',
      p_title                  => 'Level 4: Grouping Rule Details from System Parameters',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'You have not set up grouping rules at the System Parameter level.',
      p_solution               => 'For more information, read [1067993/KB626338] How To Use Grouping Rules With AutoInvoice.',
      p_success_msg            => 'Displaying grouping rule details associated to Level 4. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_GR_SYS_GROUPING_RULES');



debug('begin add_signature: AR_GR_GROUPING_RULES_HIERARCHY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12774',
      p_sig_id                 => 'AR_GR_GROUPING_RULES_HIERARCHY',
      p_sig_sql                => 'select ''This Section displays the hierarchy of your Grouping Rules setup.<br><br>'' ||
       ''AutoInvoice uses the following hierarchy to default the Grouping Rules: <br>'' ||
       ''   Level 1: From the <em>Batch Source</em> screen <br>'' ||
       ''   Level 2: From the customer profile at <em>Site Level</em> <br>'' ||
       ''   Level 3: From the customer profile at <em>Account Level</em> <br> '' ||
       ''   Level 4: From the <em>System Parameters</em> <br><br>'' ||
       ''The values for all levels are shown below.'' DESCRIPTION
from dual',
      p_title                  => 'Grouping Rule Setup Hierarchy',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Please open this section to view the hierarchy of your Grouping Rules setup.',
      p_solution               => 'Please open this section to view the hierarchy of your Grouping Rules setup.',
      p_success_msg            => 'AutoInvoice uses the following hierarchy to default the Grouping Rules:<br>
<ul>
<li>Level 1: From the <em>Batch Source</em> screen</li>
<li>Level 2: From the customer profile at <em>Site Level</em></li>
<li>Level 3: From the customer profile at <em>Account Level</em></li>
<li>Level 4: From the <em>System Parameters</em></li>
</ul>

The value for all levels is shown above.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('AR_GR_BATCH_GROUPING_RULES','AR_GR_SITE_GROUPING_RULES','AR_GR_CUST_GROUPING_RULES','AR_GR_SYS_GROUPING_RULES'),
      p_include_in_dx_summary  => nvl('Y','N'),
      p_version                => '22'
      );
   l_info.delete;
debug('end add_signature: AR_GR_GROUPING_RULES_HIERARCHY');



debug('begin add_signature: AR_GR_DERIVED_GRP_RULE_TO_USE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12742',
      p_sig_id                 => 'AR_GR_DERIVED_GRP_RULE_TO_USE',
      p_sig_sql                => 'select ''Transaction #1'' "Transaction", ##$$RULE1$$## "Grouping Rule", ''##$$LEVEL1$$##'' "Derived From", rul.name
FROM RA_GROUPING_RULES rul
WHERE rul.grouping_rule_id(+) = ##$$RULE1$$##
union all
select ''Transaction #2'', ##$$RULE2$$##, ''##$$LEVEL2$$##'' "Derived From", rul.name
FROM RA_GROUPING_RULES rul
WHERE rul.grouping_rule_id(+) = ##$$RULE2$$##',
      p_title                  => 'Derived Grouping Rule To Use',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Unable to derive the hierarchical setup for grouping rules from the transactions you provided.',
      p_solution               => 'Grouping rules can be set up a different levels.
For more information, read [1067993/KB626338] How To Use Grouping Rules With AutoInvoice.',
      p_success_msg            => 'AutoInvoice uses the following hierarchy to default the Grouping Rules:<br>
<ul>
<li>Level 1: From the <em>Batch Source</em> screen</li>
...
Based on your setup, grouping rules will be used from the level shown.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_GR_DERIVED_GRP_RULE_TO_USE');



debug('begin add_signature: AR_GR_GRP_RULES_MATCH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12743',
      p_sig_id                 => 'AR_GR_GRP_RULES_MATCH',
      p_sig_sql                => 'select ##$$RULE1$$## "Grouping Rule", rul.name, rul.description
FROM RA_GROUPING_RULES rul
WHERE rul.grouping_rule_id(+) = ##$$RULE1$$##
AND   ##$$RULE1$$## = ##$$RULE2$$##',
      p_title                  => 'Check Grouping Rules Match',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The derived grouping rules for the transactions you provided do not match.
',
      p_solution               => 'For transactions to be grouped together, the Grouping Rule used for both should be identical. These transactions cannot be grouped together.
For more information, read [1084554/KB627980] Troubleshooting Grouping Rules In AutoInvoice.',
      p_success_msg            => 'The derived grouping rules for the transactions you provided match, this is the grouping rule used to group transactions.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_GR_GRP_RULES_MATCH');



debug('begin add_signature: AR_GR_ALL_GROUPING_ATTRIBS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2406',
      p_sig_id                 => 'AR_GR_ALL_GROUPING_ATTRIBS',
      p_sig_sql                => 'select from_column_name, description, decode(column_type, ''M'', ''Mandatory (Oracle-defined)'', ''O'',''Optional (User-defined)'') "COLUMN_TYPE"
from ra_group_by_columns 
where column_type in ( ''O'',''M'' )
order by 3,1',
      p_title                  => 'Listing of *ALL* Grouping Attributes',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Listing of <em>ALL</em> available mandatory (Oracle-defined) and optional (User-defined) grouping attributes that may be used in grouping rules.',
      p_solution               => 'Listing of all available mandatory (Oracle-defined) and optional (User-defined) grouping attributes that may be used in grouping rules.',
      p_success_msg            => 'Listing of all available mandatory (Oracle-defined) and optional (User-defined) grouping attributes that may be used in grouping rules.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_GR_ALL_GROUPING_ATTRIBS');



debug('begin add_signature: AR_GR_GROUPING_RULE_ATTRIBUTES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2405',
      p_sig_id                 => 'AR_GR_GROUPING_RULE_ATTRIBUTES',
      p_sig_sql                => 'select UPPER (C.FROM_COLUMN_NAME), ''Mandatory (Oracle-defined)'' STATUS
FROM RA_GROUP_BY_COLUMNS C
WHERE  C.COLUMN_TYPE = ''M''
UNION ALL
select UPPER (C.FROM_COLUMN_NAME), ''Optional (User-defined)'' STATUS
FROM RA_GROUPING_TRX_TYPES T,
RA_GROUP_BYS B,
RA_GROUP_BY_COLUMNS C
WHERE T.GROUPING_RULE_ID = ##$$RULE1$$##
AND T.GROUPING_TRX_TYPE_ID = B.GROUPING_TRX_TYPE_ID
AND B.COLUMN_ID = C.COLUMN_ID
AND C.COLUMN_TYPE = ''O''',
      p_title                  => 'Grouping Rule Attributes for '||mask_text(g_rule_name, nvl( upper(''), 'NO_MASK') )||'',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Listing of all grouping attributes used by grouping rule = '||mask_text(g_rule_name, nvl( upper(''), 'NO_MASK') )||'',
      p_solution               => 'The grouping rule attributes for the grouping rule provided do not exist. Please review [1067993/KB626338] How To Use Grouping Rules With AutoInvoice. ',
      p_success_msg            => 'These are the attributes assigned to grouping rule = '||mask_text(g_rule_name, nvl( upper(''), 'NO_MASK') )||' which is used by your transactions.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_GR_GROUPING_RULE_ATTRIBUTES');



debug('begin add_signature: AR_GR_MANDATORY_GROUPING_DIFF');
   l_info('##MASK##VALUE_FOR_TRX 1'):= 'NO_MASK';
   l_info('##MASK##VALUE_FOR_TRX 2'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2407',
      p_sig_id                 => 'AR_GR_MANDATORY_GROUPING_DIFF',
      p_sig_sql                => 'select distinct ''GLOBAL_ATTRIBUTE_CATEGORY'' GROUPING_ATTRIBUTE,
 ##$$A$$##.mask_text(a.global_attribute_category, ''##$$M$$##'') VALUE_FOR_TRX1,
 ##$$A$$##.mask_text(b.global_attribute_category, ''##$$M$$##'') VALUE_FOR_TRX2,
''RA_CUSTOMER_TRX'' SOURCE
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.global_attribute_category,-9) <> nvl(b.global_attribute_category,-9)
UNION
select distinct ''GLOBAL_ATTRIBUTE1'',
 ##$$A$$##.mask_text(a.global_attribute1, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute1, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.global_attribute1,-9) <> nvl(b.global_attribute1,-9)
UNION
select distinct ''GLOBAL_ATTRIBUTE2'',
 ##$$A$$##.mask_text(a.global_attribute2, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute2, ''##$$M$$##''),
''RA_CUSTOMER_TRX''
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.global_attribute2,-9) <> nvl(b.global_attribute2,-9)
UNION
select distinct ''GLOBAL_ATTRIBUTE3'',
 ##$$A$$##.mask_text(a.global_attribute3, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute3, ''##$$M$$##''),
''RA_CUSTOMER_TRX''
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.global_attribute3,-9) <> nvl(b.global_attribute3,-9)
UNION
select distinct ''GLOBAL_ATTRIBUTE4'',
 ##$$A$$##.mask_text(a.global_attribute4, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute4, ''##$$M$$##''),
''RA_CUSTOMER_TRX''
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.global_attribute4,-9) <> nvl(b.global_attribute4,-9)
UNION
select distinct ''GLOBAL_ATTRIBUTE5'',
 ##$$A$$##.mask_text(a.global_attribute5, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute5, ''##$$M$$##''),
''RA_CUSTOMER_TRX''
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.global_attribute5,-9) <> nvl(b.global_attribute5,-9)
UNION
select distinct ''GLOBAL_ATTRIBUTE6'',
 ##$$A$$##.mask_text(a.global_attribute6, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute6, ''##$$M$$##''),
''RA_CUSTOMER_TRX''
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.global_attribute6,-9) <> nvl(b.global_attribute6,-9)
UNION
select distinct ''GLOBAL_ATTRIBUTE7'',
 ##$$A$$##.mask_text(a.global_attribute7, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute7, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.global_attribute7,-9) <> nvl(b.global_attribute7,-9)
UNION
select distinct ''GLOBAL_ATTRIBUTE8'',
 ##$$A$$##.mask_text(a.global_attribute8, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute8, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.global_attribute8,-9) <> nvl(b.global_attribute8,-9)
UNION
select distinct ''GLOBAL_ATTRIBUTE9'',
 ##$$A$$##.mask_text(a.global_attribute9, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute9, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.global_attribute9,-9) <> nvl(b.global_attribute9,-9)
UNION
select distinct ''GLOBAL_ATTRIBUTE10'',
 ##$$A$$##.mask_text(a.global_attribute10, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute10, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.global_attribute10,-9) <> nvl(b.global_attribute10,-9)
UNION
select distinct ''GLOBAL_ATTRIBUTE11'',
 ##$$A$$##.mask_text(a.global_attribute11, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute11, ''##$$M$$##''),
''RA_CUSTOMER_TRX''
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.global_attribute11,-9) <> nvl(b.global_attribute11,-9)
UNION
select distinct ''GLOBAL_ATTRIBUTE12'',
 ##$$A$$##.mask_text(a.global_attribute12, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute12, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.global_attribute12,-9) <> nvl(b.global_attribute12,-9)
UNION
select distinct ''GLOBAL_ATTRIBUTE13'',
 ##$$A$$##.mask_text(a.global_attribute13, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute13, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.global_attribute13,-9) <> nvl(b.global_attribute13,-9)
UNION
select distinct ''GLOBAL_ATTRIBUTE14'',
 ##$$A$$##.mask_text(a.global_attribute14, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute14, ''##$$M$$##''),
''RA_CUSTOMER_TRX''
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.global_attribute14,-9) <> nvl(b.global_attribute14,-9)
UNION
select distinct ''GLOBAL_ATTRIBUTE15'',
 ##$$A$$##.mask_text(a.global_attribute15, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute15, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.global_attribute15,-9) <> nvl(b.global_attribute15,-9)
UNION
select distinct ''GLOBAL_ATTRIBUTE16'',
 ##$$A$$##.mask_text(a.global_attribute16, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute16, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.global_attribute16,-9) <> nvl(b.global_attribute16,-9)
UNION
select distinct ''GLOBAL_ATTRIBUTE17'',
 ##$$A$$##.mask_text(a.global_attribute17, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute17, ''##$$M$$##''),
''RA_CUSTOMER_TRX''
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.global_attribute17,-9) <> nvl(b.global_attribute17,-9)
UNION
select distinct ''GLOBAL_ATTRIBUTE18'',
 ##$$A$$##.mask_text(a.global_attribute18, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute18, ''##$$M$$##''),
''RA_CUSTOMER_TRX''
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.global_attribute18,-9) <> nvl(b.global_attribute18,-9)
UNION
select distinct ''GLOBAL_ATTRIBUTE19'',
 ##$$A$$##.mask_text(a.global_attribute19, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute19, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.global_attribute19,-9) <> nvl(b.global_attribute19,-9)
UNION
select distinct ''GLOBAL_ATTRIBUTE20'',
 ##$$A$$##.mask_text(a.global_attribute20, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute20, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.global_attribute20,-9) <> nvl(b.global_attribute20,-9)
UNION
select distinct ''GLOBAL_ATTRIBUTE21'',
 ##$$A$$##.mask_text(a.global_attribute21, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute21, ''##$$M$$##''),
''RA_CUSTOMER_TRX''
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.global_attribute21,-9) <> nvl(b.global_attribute21,-9)
UNION
select distinct ''GLOBAL_ATTRIBUTE22'',
 ##$$A$$##.mask_text(a.global_attribute22, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute22, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.global_attribute22,-9) <> nvl(b.global_attribute22,-9)
UNION
select distinct ''GLOBAL_ATTRIBUTE23'',
 ##$$A$$##.mask_text(a.global_attribute23, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute23, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.global_attribute23,-9) <> nvl(b.global_attribute23,-9)
UNION
select distinct ''GLOBAL_ATTRIBUTE24'',
 ##$$A$$##.mask_text(a.global_attribute24, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute24, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.global_attribute24,-9) <> nvl(b.global_attribute24,-9)
UNION
select distinct ''GLOBAL_ATTRIBUTE25'',
 ##$$A$$##.mask_text(a.global_attribute25, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute25, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.global_attribute25,-9) <> nvl(b.global_attribute25,-9)
UNION
select distinct ''GLOBAL_ATTRIBUTE26'',
 ##$$A$$##.mask_text(a.global_attribute26, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute26, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.global_attribute26,-9) <> nvl(b.global_attribute26,-9)
UNION
select distinct ''GLOBAL_ATTRIBUTE27'',
 ##$$A$$##.mask_text(a.global_attribute27, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute27, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.global_attribute27,-9) <> nvl(b.global_attribute27,-9)
UNION
select distinct ''GLOBAL_ATTRIBUTE28'',
 ##$$A$$##.mask_text(a.global_attribute28, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute28, ''##$$M$$##''),
''RA_CUSTOMER_TRX''
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.global_attribute29,-9) <> nvl(b.global_attribute29,-9)
UNION
select distinct ''GLOBAL_ATTRIBUTE29'',
 ##$$A$$##.mask_text(a.global_attribute29, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute29, ''##$$M$$##''),
''RA_CUSTOMER_TRX''
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.global_attribute29,-9) <> nvl(b.global_attribute29,-9)
UNION
select distinct ''GLOBAL_ATTRIBUTE30'',
 ##$$A$$##.mask_text(a.global_attribute30, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute30, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.global_attribute30,-9) <> nvl(b.global_attribute30,-9)
UNION
select distinct ''INITIAL_CUSTOMER_TRX_ID'',
to_char(a.initial_customer_trx_id),to_char(b.initial_customer_trx_id),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.initial_customer_trx_id,-9) <> nvl(b.initial_customer_trx_id,-9)
UNION
select distinct ''ATTRIBUTE1'',
 ##$$A$$##.mask_text(a.attribute1, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.attribute1, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.attribute1,-9) <> nvl(b.attribute1,-9)
UNION
select distinct ''ATTRIBUTE2'',
 ##$$A$$##.mask_text(a.attribute2, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.attribute2, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.attribute2,-9) <> nvl(b.attribute2,-9)
UNION
select distinct ''ATTRIBUTE3'',
 ##$$A$$##.mask_text(a.attribute3, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.attribute3, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.attribute3,-9) <> nvl(b.attribute3,-9)
UNION
select distinct ''ATTRIBUTE4'',
 ##$$A$$##.mask_text(a.attribute4, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.attribute4, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.attribute4,-9) <> nvl(b.attribute4,-9)
UNION
select distinct ''ATTRIBUTE5'',
 ##$$A$$##.mask_text(a.attribute5, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.attribute5, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.attribute5,-9) <> nvl(b.attribute5,-9)
UNION
select distinct ''ATTRIBUTE6'',
 ##$$A$$##.mask_text(a.attribute6, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.attribute6, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.attribute6,-9) <> nvl(b.attribute6,-9)
UNION
select distinct ''ATTRIBUTE7'',
 ##$$A$$##.mask_text(a.attribute7, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.attribute7, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.attribute7,-9) <> nvl(b.attribute7,-9)
UNION
select distinct ''ATTRIBUTE8'',
 ##$$A$$##.mask_text(a.attribute8, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.attribute8, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.attribute8,-9) <> nvl(b.attribute8,-9)
UNION
select distinct ''ATTRIBUTE9'',
 ##$$A$$##.mask_text(a.attribute9, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.attribute9, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.attribute9,-9) <> nvl(b.attribute9,-9)
UNION
select distinct ''ATTRIBUTE10'',
 ##$$A$$##.mask_text(a.attribute10, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.attribute10, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.attribute10,-9) <> nvl(b.attribute10,-9)
UNION
select distinct ''ATTRIBUTE11'',
 ##$$A$$##.mask_text(a.attribute11, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.attribute11, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.attribute11,-9) <> nvl(b.attribute11,-9)
UNION
select distinct ''ATTRIBUTE12'',
 ##$$A$$##.mask_text(a.attribute12, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.attribute12, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.attribute12,-9) <> nvl(b.attribute12,-9)
UNION
select distinct ''ATTRIBUTE13'',
 ##$$A$$##.mask_text(a.attribute13, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.attribute13, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.attribute13,-9) <> nvl(b.attribute13,-9)
UNION
select distinct ''ATTRIBUTE14'',
 ##$$A$$##.mask_text(a.attribute14, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.attribute14, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.attribute14,-9) <> nvl(b.attribute14,-9)
UNION
select distinct ''ATTRIBUTE15'',
 ##$$A$$##.mask_text(a.attribute15, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.attribute15, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.attribute15,-9) <> nvl(b.attribute15,-9)
UNION
select distinct ''ATTRIBUTE_CATEGORY'',
 ##$$A$$##.mask_text(a.attribute_category, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.attribute_category, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.attribute_category,-9) <> nvl(b.attribute_category,-9)',
      p_title                  => 'Non-identical Mandatory Flexfield Attribute Values',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Identified differences in mandatory flexfield grouping attributes.',
      p_solution               => 'Please review the differences listed for the mandatory (Oracle-defined) flexfield attributes. <br>
For each grouping attribute listed, compare the values in <em>VALUE FOR TRX 1</em> against <em>VALUE FOR TRX 2</em>. These differences are causing your transactions to be split up.<br><br>
Review the method by which you populate the interface lines table and identify why these values are not the same.<br>
For more information, please review [1084554/KB627980] Troubleshooting Grouping Rules In AutoInvoice.',
      p_success_msg            => 'No differences found for mandatory flexfield grouping attributes.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_GR_MANDATORY_GROUPING_DIFF');



debug('begin add_signature: AR_GR_MANDATORY_GROUPING_DIFF2');
   l_info('##MASK##VALUE_FOR_TRX1'):= 'NO_MASK';
   l_info('##MASK##VALUE_FOR_TRX2'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13067',
      p_sig_id                 => 'AR_GR_MANDATORY_GROUPING_DIFF2',
      p_sig_sql                => 'select distinct ''CUST_TRX_TYPE_ID''  GROUPING_ATTRIBUTE,
to_char(a.cust_trx_type_id) VALUE_FOR_TRX1,
to_char(b.cust_trx_type_id) VALUE_FOR_TRX2,
''RA_CUSTOMER_TRX''  SOURCE
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.cust_trx_type_id,-9) <> nvl(b.cust_trx_type_id,-9)
UNION
select distinct ''SOLD_TO_CUSTOMER_ID'',
to_char(a.sold_to_customer_id),to_char(b.sold_to_customer_id), 
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.sold_to_customer_id,-9) <> nvl(b.sold_to_customer_id,-9)
UNION
select distinct  ''BILL_TO_CUSTOMER_ID'',
to_char(a.bill_to_customer_id),to_char(b.bill_to_customer_id), 
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.bill_to_customer_id,-9) <> nvl(b.bill_to_customer_id,-9)
UNION
select distinct ''BILL_TO_ADDRESS_ID'',
to_char(a.bill_to_address_id),to_char(b.bill_to_address_id),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.bill_to_address_id,-9) <> nvl(b.bill_to_address_id,-9)
UNION
select distinct ''BILL_TO_CONTACT_ID'',
to_char(a.bill_to_contact_id),to_char(b.bill_to_contact_id),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.bill_to_contact_id,-9) <> nvl(b.bill_to_contact_id,-9)
UNION
select distinct ''TERM_ID'',
to_char(a.term_id),to_char(b.term_id),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.term_id,-9) <> nvl(b.term_id,-9)
UNION
select distinct ''PRIMARY_SALESREP_ID'',
to_char(a.primary_salesrep_id),to_char(b.primary_salesrep_id),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.primary_salesrep_id,-9) <> nvl(b.primary_salesrep_id,-9)
UNION
select distinct ''PRINTING_OPTION'',
to_char(a.printing_option),to_char(b.printing_option),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.printing_option,-9) <> nvl(b.printing_option,-9)
UNION
select distinct  ''PURCHASE_ORDER'',
to_char(a.purchase_order),to_char(b.purchase_order),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.purchase_order,-9) <> nvl(b.purchase_order,-9)
UNION
select distinct ''PURCHASE_ORDER_REVISION'',
to_char(a.purchase_order_revision),to_char(b.purchase_order_revision),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.purchase_order_revision,-9) <> nvl(b.purchase_order_revision,-9)
UNION
select distinct ''RECEIPT_METHOD_ID'',
to_char(a.receipt_method_id),to_char(b.receipt_method_id),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.receipt_method_id,-9) <> nvl(b.receipt_method_id,-9)
UNION
select distinct ''PREVIOUS_CUSTOMER_TRX_ID'',
to_char(a.previous_customer_trx_id),to_char(b.previous_customer_trx_id),             
''RA_CUSTOMER_TRX''
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.previous_customer_trx_id,-9) <> nvl(b.previous_customer_trx_id,-9)
UNION
select distinct ''CONTRACT_ID'',
to_char(a.contract_id),to_char(b.contract_id),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.contract_id,-9) <> nvl(b.contract_id,-9)
UNION
select distinct ''AGREEMENT_ID'',
to_char(a.agreement_id),to_char(b.agreement_id),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.agreement_id,-9) <> nvl(b.agreement_id,-9)
UNION
select distinct ''APPLICATION_ID'',
to_char(a.application_id),to_char(b.application_id),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.application_id,-9) <> nvl(b.application_id,-9)
UNION
select distinct ''COMMENTS'',
to_char(a.comments),to_char(b.comments),
''RA_CUSTOMER_TRX''
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.comments,-9) <> nvl(b.comments,-9)
UNION
select distinct ''EXCHANGE_RATE'',
to_char(a.exchange_rate),to_char(b.exchange_rate),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.exchange_rate,-9) <> nvl(b.exchange_rate,-9)
UNION
select distinct ''EXCHANGE_RATE_TYPE'',
to_char(a.exchange_rate_type),to_char(b.exchange_rate_type),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.exchange_rate_type,-9) <> nvl(b.exchange_rate_type,-9)
UNION
select distinct ''CREDIT_METHOD_FOR_RULES'',
to_char(a.credit_method_for_rules),to_char(b.credit_method_for_rules),
''RA_CUSTOMER_TRX''
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.credit_method_for_rules,-9) <> nvl(b.credit_method_for_rules,-9)
UNION
select distinct ''INVOICE_CURRENCY_CODE'',
to_char(a.invoice_currency_code),to_char(b.invoice_currency_code),
''RA_CUSTOMER_TRX''
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.invoice_currency_code,-9) <> nvl(b.invoice_currency_code,-9)
UNION
select distinct ''DOC_SEQUENCE_VALUE'',
to_char(a.doc_sequence_value),to_char(b.doc_sequence_value),
''RA_CUSTOMER_TRX''
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.doc_sequence_value,-9) <> nvl(b.doc_sequence_value,-9)
UNION
select distinct ''DOC_SEQUENCE_ID'',
to_char(a.doc_sequence_id),to_char(b.doc_sequence_id),
''RA_CUSTOMER_TRX''
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.doc_sequence_id,-9) <> nvl(b.doc_sequence_id,-9)
UNION
select distinct ''INTERNAL_NOTES'',
 ##$$A$$##.mask_text(a.internal_notes, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.internal_notes, ''##$$M$$##''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.internal_notes,-9) <> nvl(b.internal_notes,-9)
UNION
select distinct ''TERRITORY_ID'',
to_char(a.territory_id),to_char(b.territory_id),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.territory_id,-9) <> nvl(b.territory_id,-9)
UNION
select distinct ''RELATED_CUSTOMER_TRX_ID'',
to_char(a.related_customer_trx_id),to_char(b.related_customer_trx_id),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.related_customer_trx_id,-9) <> nvl(b.related_customer_trx_id,-9)
UNION
select distinct ''CREDIT_METHOD_FOR_INSTALLMENTS'',
to_char(a.credit_method_for_installments),to_char(b.credit_method_for_installments), 
''RA_CUSTOMER_TRX''
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.credit_method_for_installments,-9) <> nvl(b.credit_method_for_installments,-9)
UNION
select distinct ''ORIG_SYSTEM_BATCH_NAME'',
to_char(a.orig_system_batch_name),to_char(b.orig_system_batch_name),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.orig_system_batch_name,-9) <> nvl(b.orig_system_batch_name,-9)
UNION
select distinct ''LEGAL_ENTITY_ID'',
to_char(a.legal_entity_id),to_char(b.legal_entity_id),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.legal_entity_id,-9) <> nvl(b.legal_entity_id,-9)
UNION
select distinct ''PAYMENT_ATTRIBUTES'',
to_char(a.payment_attributes),to_char(b.payment_attributes),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.payment_attributes,-9) <> nvl(b.payment_attributes,-9)
UNION
select distinct ''PURCHASE_ORDER_DATE'',
to_char(a.purchase_order_date,''MM/DD/YYYY''),to_char(b.purchase_order_date,''MM/DD/YYYY''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.purchase_order_date,trunc(sysdate)) <> nvl(b.purchase_order_date,trunc(sysdate))
UNION
select distinct ''TRX_DATE'',
to_char(a.trx_date,''MM/DD/YYYY''),to_char(b.trx_date,''MM/DD/YYYY''),
''RA_CUSTOMER_TRX'' 
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.trx_date,trunc(sysdate)) <> nvl(b.trx_date,trunc(sysdate))
UNION
select distinct ''BILLING_DATE'',
to_char(a.billing_date,''MM/DD/YYYY''),to_char(b.billing_date,''MM/DD/YYYY''),             
''RA_CUSTOMER_TRX''
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.billing_date,trunc(sysdate)) <> nvl(b.billing_date,trunc(sysdate))
UNION
select distinct ''SET_OF_BOOKS_ID'',
to_char(a.set_of_books_id),to_char(b.set_of_books_id),
''RA_CUSTOMER_TRX''
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.set_of_books_id,-9) <> nvl(b.set_of_books_id,-9)
UNION
select distinct ''CUSTOMER_BANK_ACCOUNT_ID'',
to_char(a.customer_bank_account_id),to_char(b.customer_bank_account_id),
''RA_CUSTOMER_TRX''
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.customer_bank_account_id,-9) <> nvl(b.customer_bank_account_id,-9)
UNION
select distinct ''PAYMENT_SET_ID'',
to_char(a.payment_set_id),to_char(b.payment_set_id),
''RA_CUSTOMER_TRX_LINES''
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.payment_set_id,-9) <> nvl(b.payment_set_id,-9) 
UNION
select distinct ''INVOICING_RULE_ID'',
to_char(a.invoicing_rule_id),to_char(b.invoicing_rule_id),
''RA_CUSTOMER_TRX''
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.invoicing_rule_id,-9) <> nvl(b.invoicing_rule_id,-9) 
UNION
select distinct ''RECEIPT_METHOD_ID'',
to_char(a.receipt_method_id),to_char(b.receipt_method_id),
''RA_CUSTOMER_TRX''
...
to_char(a.reason_code),to_char(b.reason_code),
''RA_CUSTOMER_TRX''
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and b.customer_trx_id = ##$$TRX2$$##
and nvl(a.reason_code,-9) <> nvl(b.reason_code,-9) 
UNION
select distinct ''GL_DATE'',
to_char(a.gl_date, ''MM/DD/YYYY''),
to_char(b.gl_date,''MM/DD/YYYY''),
''RA_CUST_TRX_LINE_GL_DIST''       
from RA_CUST_TRX_LINE_GL_DIST a, RA_CUST_TRX_LINE_GL_DIST b
where a.customer_trx_id = ##$$TRX1$$##
...
and nvl(a.gl_date,trunc(sysdate)) <> nvl(b.gl_date,trunc(sysdate))
UNION
select distinct ''CONS_BILLING_NUMBER'',
to_char(a.cons_billing_number), to_char(b.cons_billing_number),
''AR_CONS_INV'' 
from AR_CONS_INV a,
AR_CONS_INV b,
AR_CONS_INV_TRX a_trx,
AR_CONS_INV_TRX b_trx
where a_trx.customer_trx_id = ##$$TRX1$$##
and b_trx.customer_trx_id =  ##$$TRX2$$##
and a.cons_inv_id = a_trx.cons_inv_id
and b.cons_inv_id = b_trx.cons_inv_id
and nvl(a.cons_billing_number,-9) <> nvl(b.cons_billing_number,-9)',
      p_title                  => 'Non-identical Mandatory Non-Flexfield Attribute Values',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Identified differences in mandatory non-flexfield grouping attributes.',
      p_solution               => 'Please review the differences listed for the mandatory (Oracle-defined) non-flexfield attributes. <br>
For each grouping attribute listed, compare the values in <em>VALUE FOR TRX 1</em> against <em>VALUE FOR TRX 2</em>. These differences are causing your transactions to be split up.<br><br>
Review the method by which you populate the interface lines table and identify why these values are not the same.<br>
For more information, please review [1084554/KB627980] Troubleshooting Grouping Rules In AutoInvoice.',
      p_success_msg            => 'No differences found for mandatory non-flexfield grouping attributes.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_GR_MANDATORY_GROUPING_DIFF2');



debug('begin add_signature: AR_GR_OPTIONAL_GROUPING_DIFF');
   l_info('##MASK##VALUE_FOR_TRX1'):= 'NO_MASK';
   l_info('##MASK##VALUE_FOR_TRX2'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2894',
      p_sig_id                 => 'AR_GR_OPTIONAL_GROUPING_DIFF',
      p_sig_sql                => 'select GROUPING_ATTRIBUTE, VALUE_FOR_TRX1, VALUE_FOR_TRX2, SOURCE 
from
(select distinct ''L.INTERFACE_LINE_ATTRIBUTE1'' GROUPING_ATTRIBUTE,
 ##$$A$$##.mask_text(a.interface_line_attribute1, ''##$$M$$##'') VALUE_FOR_TRX1,
 ##$$A$$##.mask_text(b.interface_line_attribute1, ''##$$M$$##'') VALUE_FOR_TRX2,
''RA_CUSTOMER_TRX_LINES'' SOURCE
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
where a.customer_trx_id = ##$$TRX1$$##
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.interface_line_attribute1,''XX'') <> nvl(b.interface_line_attribute1,''XX'')
UNION
select distinct ''L.INTERFACE_LINE_ATTRIBUTE2'',
 ##$$A$$##.mask_text(a.interface_line_attribute2, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.interface_line_attribute2, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES'' 
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
where a.customer_trx_id = ##$$TRX1$$##
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.interface_line_attribute2,''XX'') <> nvl(b.interface_line_attribute2,''XX'')
UNION
select distinct ''L.INTERFACE_LINE_ATTRIBUTE3'',
 ##$$A$$##.mask_text(a.interface_line_attribute3, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.interface_line_attribute3, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES'' 
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
where a.customer_trx_id = ##$$TRX1$$##
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.interface_line_attribute3,''XX'') <> nvl(b.interface_line_attribute3,''XX'')
UNION
select distinct ''L.INTERFACE_LINE_ATTRIBUTE4'',
 ##$$A$$##.mask_text(a.interface_line_attribute4, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.interface_line_attribute4, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES'' 
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
where a.customer_trx_id = ##$$TRX1$$##
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.interface_line_attribute4,''XX'') <> nvl(b.interface_line_attribute4,''XX'')
UNION
select distinct ''L.INTERFACE_LINE_ATTRIBUTE5'',
 ##$$A$$##.mask_text(a.interface_line_attribute5, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.interface_line_attribute5, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES'' 
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
where a.customer_trx_id = ##$$TRX1$$##
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.interface_line_attribute5,''XX'') <> nvl(b.interface_line_attribute5,''XX'')
UNION
select distinct ''L.INTERFACE_LINE_ATTRIBUTE6'',
 ##$$A$$##.mask_text(a.interface_line_attribute6, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.interface_line_attribute6, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES'' 
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
where a.customer_trx_id = ##$$TRX1$$##
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.interface_line_attribute6,''XX'') <> nvl(b.interface_line_attribute6,''XX'')
UNION
select distinct ''L.INTERFACE_LINE_ATTRIBUTE7'',
 ##$$A$$##.mask_text(a.interface_line_attribute7, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.interface_line_attribute7, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES'' 
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
where a.customer_trx_id = ##$$TRX1$$##
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.interface_line_attribute7,''XX'') <> nvl(b.interface_line_attribute7,''XX'')
UNION
select distinct ''L.INTERFACE_LINE_ATTRIBUTE8'',
 ##$$A$$##.mask_text(a.interface_line_attribute8, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.interface_line_attribute8, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES'' 
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
where a.customer_trx_id = ##$$TRX1$$##
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.interface_line_attribute8,''XX'') <> nvl(b.interface_line_attribute8,''XX'')
UNION
select distinct ''L.INTERFACE_LINE_ATTRIBUTE9'',
 ##$$A$$##.mask_text(a.interface_line_attribute9, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.interface_line_attribute9, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES'' 
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
where a.customer_trx_id = ##$$TRX1$$##
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.interface_line_attribute9,''XX'') <> nvl(b.interface_line_attribute9,''XX'')
UNION
select distinct ''L.INTERFACE_LINE_ATTRIBUTE10'',
 ##$$A$$##.mask_text(a.interface_line_attribute10, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.interface_line_attribute10, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES'' 
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
where a.customer_trx_id = ##$$TRX1$$##
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.interface_line_attribute10,''XX'') <> nvl(b.interface_line_attribute10,''XX'')
UNION
select distinct ''L.INTERFACE_LINE_ATTRIBUTE11'',
 ##$$A$$##.mask_text(a.interface_line_attribute11, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.interface_line_attribute11, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES'' 
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
where a.customer_trx_id = ##$$TRX1$$##
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.interface_line_attribute11,''XX'') <> nvl(b.interface_line_attribute11,''XX'')
UNION
select distinct ''L.INTERFACE_LINE_ATTRIBUTE12'',
 ##$$A$$##.mask_text(a.interface_line_attribute12, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.interface_line_attribute12, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES'' 
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
where a.customer_trx_id = ##$$TRX1$$##
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.interface_line_attribute12,''XX'') <> nvl(b.interface_line_attribute12,''XX'')
UNION
select distinct ''L.INTERFACE_LINE_ATTRIBUTE13'',
 ##$$A$$##.mask_text(a.interface_line_attribute13, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.interface_line_attribute13, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES'' 
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
where a.customer_trx_id = ##$$TRX1$$##
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.interface_line_attribute13,''XX'') <> nvl(b.interface_line_attribute13,''XX'')
UNION
select distinct ''L.INTERFACE_LINE_ATTRIBUTE14'',
 ##$$A$$##.mask_text(a.interface_line_attribute14, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.interface_line_attribute14, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES'' 
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
where a.customer_trx_id = ##$$TRX1$$##
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.interface_line_attribute14,''XX'') <> nvl(b.interface_line_attribute14,''XX'')
UNION
select distinct ''L.INTERFACE_LINE_ATTRIBUTE15'',
 ##$$A$$##.mask_text(a.interface_line_attribute15, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.interface_line_attribute15, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES'' 
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
where a.customer_trx_id = ##$$TRX1$$##
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.interface_line_attribute15,''XX'') <> nvl(b.interface_line_attribute15,''XX'')
UNION
select distinct ''L.INTERFACE_LINE_CONTEXT'',
 ##$$A$$##.mask_text(a.interface_line_context, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.interface_line_context, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES'' 
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
where a.customer_trx_id = ##$$TRX1$$##
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.interface_line_context,''XX'') <> nvl(b.interface_line_context,''XX'')
UNION
select distinct ''L.ATTRIBUTE_CATEGORY'',
 ##$$A$$##.mask_text(a.attribute_category, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.attribute_category, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES'' 
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.attribute_category,''XX'') <> nvl(b.attribute_category,''XX'')
UNION
select distinct ''L.ATTRIBUTE1'',
 ##$$A$$##.mask_text(a.attribute1, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.attribute1, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES''
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.attribute1,''XX'') <> nvl(b.attribute1,''XX'')
UNION
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.attribute2,''XX'') <> nvl(b.attribute2,''XX'')
UNION
select distinct ''L.ATTRIBUTE3'',
 ##$$A$$##.mask_text(a.attribute3, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.attribute3, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES'' 
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.attribute3,''XX'') <> nvl(b.attribute3,''XX'')
UNION
select distinct ''L.ATTRIBUTE4'',
 ##$$A$$##.mask_text(a.attribute4, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.attribute4, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES'' 
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.attribute4,''XX'') <> nvl(b.attribute4,''XX'')
UNION
select distinct ''L.ATTRIBUTE5'',
 ##$$A$$##.mask_text(a.attribute5, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.attribute5, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES'' 
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.attribute5,''XX'') <> nvl(b.attribute5,''XX'')
UNION
select distinct ''L.ATTRIBUTE6'',
 ##$$A$$##.mask_text(a.attribute6, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.attribute6, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES'' 
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.attribute6,''XX'') <> nvl(b.attribute6,''XX'')
UNION
select distinct ''L.ATTRIBUTE7'',
 ##$$A$$##.mask_text(a.attribute7, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.attribute7, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES'' 
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.attribute7,''XX'') <> nvl(b.attribute7,''XX'')
UNION
select distinct ''L.ATTRIBUTE8'',
 ##$$A$$##.mask_text(a.attribute8, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.attribute8, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES'' 
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.attribute8,''XX'') <> nvl(b.attribute8,''XX'')
UNION
select distinct ''L.ATTRIBUTE9'',
 ##$$A$$##.mask_text(a.attribute9, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.attribute9, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES'' 
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.attribute9,''XX'') <> nvl(b.attribute9,''XX'')
UNION
select distinct ''L.ATTRIBUTE10'',
 ##$$A$$##.mask_text(a.attribute10, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.attribute10, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES'' 
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.attribute10,''XX'') <> nvl(b.attribute10,''XX'')
UNION
select distinct ''L.ATTRIBUTE11'',
 ##$$A$$##.mask_text(a.attribute11, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.attribute11, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES'' 
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.attribute11,''XX'') <> nvl(b.attribute11,''XX'')
UNION
select distinct ''L.ATTRIBUTE12'',
 ##$$A$$##.mask_text(a.attribute12, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.attribute12, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES'' 
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.attribute12,''XX'') <> nvl(b.attribute12,''XX'')
UNION
select distinct ''L.ATTRIBUTE13'',
 ##$$A$$##.mask_text(a.attribute13, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.attribute13, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES'' 
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.attribute13,''XX'') <> nvl(b.attribute13,''XX'')
UNION
select distinct ''L.ATTRIBUTE14'',
 ##$$A$$##.mask_text(a.attribute14, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.attribute14, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES'' 
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.attribute14,''XX'') <> nvl(b.attribute14,''XX'')
UNION
select distinct ''L.ATTRIBUTE15'',
 ##$$A$$##.mask_text(a.attribute15, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.attribute15, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES'' 
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.attribute15,''XX'') <> nvl(b.attribute15,''XX'')
UNION
select distinct ''L.INVENTORY_ITEM_ID'',
to_char(a.INVENTORY_ITEM_ID), 
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.INVENTORY_ITEM_ID,-99) <> nvl(b.INVENTORY_ITEM_ID,-99)
UNION
select distinct ''L.LINE_GDF_ATTR_CATEGORY'',
 ##$$A$$##.mask_text(a.global_attribute_category, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute_category, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES''        
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
where a.customer_trx_id = ##$$TRX1$$##
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.GLOBAL_ATTRIBUTE_CATEGORY,''XX'') <> nvl(b.GLOBAL_ATTRIBUTE_CATEGORY,''XX'')
UNION
select distinct ''L.LINE_GDF_ATTRIBUTE1'',
 ##$$A$$##.mask_text(a.global_attribute1, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute1, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES''         
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.global_attribute1,''XX'') <> nvl(b.global_attribute1,''XX'')
UNION
select distinct ''L.LINE_GDF_ATTRIBUTE2'',
 ##$$A$$##.mask_text(a.global_attribute2, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute2, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES''         
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.global_attribute2,''XX'') <> nvl(b.global_attribute2,''XX'')
UNION
select distinct ''L.LINE_GDF_ATTRIBUTE3'',
 ##$$A$$##.mask_text(a.global_attribute3, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute3, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES''         
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.global_attribute3,''XX'') <> nvl(b.global_attribute3,''XX'')
UNION
select distinct ''L.LINE_GDF_ATTRIBUTE4'',
 ##$$A$$##.mask_text(a.global_attribute4, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute4, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES''        
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.global_attribute4,''XX'') <> nvl(b.global_attribute4,''XX'')
UNION
select distinct ''L.LINE_GDF_ATTRIBUTE5'',
 ##$$A$$##.mask_text(a.global_attribute5, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute5, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES''        
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.global_attribute5,''XX'') <> nvl(b.global_attribute5,''XX'')
UNION
select distinct ''L.LINE_GDF_ATTRIBUTE6'',
 ##$$A$$##.mask_text(a.global_attribute6, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute6, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES''        
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.global_attribute6,''XX'') <> nvl(b.global_attribute6,''XX'')
UNION
select distinct ''L.LINE_GDF_ATTRIBUTE7'',
 ##$$A$$##.mask_text(a.global_attribute7, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute7, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES''         
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.global_attribute7,''XX'') <> nvl(b.global_attribute7,''XX'')
UNION
select distinct ''L.LINE_GDF_ATTRIBUTE8'',
 ##$$A$$##.mask_text(a.global_attribute8, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute8, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES''        
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.global_attribute8,''XX'') <> nvl(b.global_attribute8,''XX'')
UNION
select distinct ''L.LINE_GDF_ATTRIBUTE9'',
 ##$$A$$##.mask_text(a.global_attribute9, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute9, ''##$$M$$##''),
       ''RA_CUSTOMER_TRX_LINES''        
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.global_attribute9,''XX'') <> nvl(b.global_attribute9,''XX'')
UNION
select distinct ''L.LINE_GDF_ATTRIBUTE10'',
 ##$$A$$##.mask_text(a.global_attribute10, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute10, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES''        
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.global_attribute10,''XX'') <> nvl(b.global_attribute10,''XX'')
UNION
select distinct ''L.LINE_GDF_ATTRIBUTE11'',
 ##$$A$$##.mask_text(a.global_attribute11, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute11, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES''       
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.global_attribute11,''XX'') <> nvl(b.global_attribute11,''XX'')
UNION
select distinct ''L.LINE_GDF_ATTRIBUTE12'',
 ##$$A$$##.mask_text(a.global_attribute12, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute12, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES''       
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.global_attribute12,''XX'') <> nvl(b.global_attribute12,''XX'')
UNION
select distinct ''L.LINE_GDF_ATTRIBUTE13'',
 ##$$A$$##.mask_text(a.global_attribute13, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute13, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES''       
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.global_attribute13,''XX'') <> nvl(b.global_attribute13,''XX'')
UNION
select distinct ''L.LINE_GDF_ATTRIBUTE14'',
 ##$$A$$##.mask_text(a.global_attribute14, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute14, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES''     
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.global_attribute14,''XX'') <> nvl(b.global_attribute14,''XX'')
UNION
select distinct ''L.LINE_GDF_ATTRIBUTE15'',
 ##$$A$$##.mask_text(a.global_attribute15, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute15, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES''      
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.global_attribute15,''XX'') <> nvl(b.global_attribute15,''XX'')
UNION
select distinct ''L.LINE_GDF_ATTRIBUTE16'',
 ##$$A$$##.mask_text(a.global_attribute16, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute16, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES''       
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.global_attribute16,''XX'') <> nvl(b.global_attribute16,''XX'')
UNION
select distinct ''L.LINE_GDF_ATTRIBUTE17'',
 ##$$A$$##.mask_text(a.global_attribute17, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute17, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES''      
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.global_attribute17,''XX'') <> nvl(b.global_attribute17,''XX'')
UNION
select distinct ''L.LINE_GDF_ATTRIBUTE18'',
 ##$$A$$##.mask_text(a.global_attribute18, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute18, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES''      
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.global_attribute18,''XX'') <> nvl(b.global_attribute18,''XX'')
UNION
select distinct ''L.LINE_GDF_ATTRIBUTE19'',
 ##$$A$$##.mask_text(a.global_attribute19, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute19, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES''     
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.global_attribute19,''XX'') <> nvl(b.global_attribute19,''XX'')
UNION
select distinct ''L.LINE_GDF_ATTRIBUTE20'',
 ##$$A$$##.mask_text(a.global_attribute20, ''##$$M$$##''),
 ##$$A$$##.mask_text(b.global_attribute20, ''##$$M$$##''),
''RA_CUSTOMER_TRX_LINES''      
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.global_attribute20,''XX'') <> nvl(b.global_attribute20,''XX'')
) OPT_ATTR
where OPT_ATTR.GROUPING_ATTRIBUTE in
(select C.FROM_COLUMN_NAME
FROM RA_GROUPING_TRX_TYPES T,
RA_GROUP_BYS B,
RA_GROUP_BY_COLUMNS C
WHERE T.GROUPING_RULE_ID =  ##$$RULE1$$##
...
AND B.COLUMN_ID = C.COLUMN_ID
AND C.COLUMN_TYPE = ''O'')',
      p_title                  => 'Non-identical Optional Flexfield Attribute Values',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Identified differences in optional flexfield grouping attributes.',
      p_solution               => 'Please review the differences listed for the optional (User-defined) flexfield attributes. <br>
For each grouping attribute listed, compare the values in VALUE_FOR_TRX1 against VALUE_FOR_TRX2. These differences are causing your transactions to be split up.<br><br>
Review the method by which you populate the interface lines table and identify why these values are not the same.<br>
For more information, please review [1084554/KB627980] Troubleshooting Grouping Rules In AutoInvoice.',
      p_success_msg            => 'No differences found for optional (User-defined) flexfield grouping attributes.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_GR_OPTIONAL_GROUPING_DIFF');



debug('begin add_signature: AR_GR_OPTIONAL_GROUPING_DIFF2');
   l_info('##MASK##VALUE_FOR_TRX1'):= 'NO_MASK';
   l_info('##MASK##VALUE_FOR_TRX2'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13066',
      p_sig_id                 => 'AR_GR_OPTIONAL_GROUPING_DIFF2',
      p_sig_sql                => 'select GROUPING_ATTRIBUTE, VALUE_FOR_TRX1, VALUE_FOR_TRX2, SOURCE 
from
(select distinct ''L.ACCOUNTING_RULE_DURATION'' GROUPING_ATTRIBUTE,
to_char(a.accounting_rule_duration) VALUE_FOR_TRX1, 
to_char(b.accounting_rule_duration) VALUE_FOR_TRX2,
''RA_CUSTOMER_TRX_LINES'' SOURCE
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
where a.customer_trx_id = ##$$TRX1$$##
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.accounting_rule_duration,-99) <> nvl(b.accounting_rule_duration,-99)
UNION
select distinct ''L.ACCOUNTING_RULE_ID'',
to_char(a.accounting_rule_id),
to_char(b.accounting_rule_id),
''RA_CUSTOMER_TRX_LINES'' 
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
where a.customer_trx_id = ##$$TRX1$$##
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.accounting_rule_id,-99) <> nvl(b.accounting_rule_id,-99)
UNION
select distinct ''ORIG_SYSTEM_SHIP_ADDRESS_ID'',
to_char(a.ship_to_address_id), 
to_char(b.ship_to_address_id),
''RA_CUSTOMER_TRX''      
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and   b.customer_trx_id = ##$$TRX2$$##
--and a.line_type = b.line_type 
and   nvl(a.ship_to_address_id, -99) <> nvl(b.ship_to_address_id,-99)
UNION
select distinct ''L.ORIG_SYSTEM_SHIP_CONTACT_ID'',
to_char(a.ship_to_contact_id), 
to_char(b.ship_to_contact_id),
''RA_CUSTOMER_TRX''       
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and   b.customer_trx_id = ##$$TRX2$$##
 --and a.line_type = b.line_type 
and   nvl(a.ship_to_contact_id,-99) <> nvl(b.ship_to_contact_id,-99)
UNION
select distinct ''L.ORIG_SYSTEM_SHIP_CUSTOMER_ID'',
to_char(a.ship_to_customer_id), 
to_char(b.ship_to_customer_id),
''RA_CUSTOMER_TRX''       
from RA_CUSTOMER_TRX a, RA_CUSTOMER_TRX b
where a.customer_trx_id = ##$$TRX1$$##
and   b.customer_trx_id = ##$$TRX2$$##
 --and a.line_type = b.line_type 
and   nvl(a.ship_to_customer_id,-99) <> nvl(b.ship_to_customer_id,-99)
UNION
select distinct ''L.CUSTOMER_TRX_LINE_ID'',
to_char(a.customer_trx_line_id), 
to_char(b.customer_trx_line_id),
''RA_CUSTOMER_TRX_LINES''      
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
where a.customer_trx_id = ##$$TRX1$$##
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.customer_trx_line_id,-99) <> nvl(b.customer_trx_line_id,-99)
UNION
select distinct ''L.RULE_START_DATE'',
to_char(a.rule_start_date,''MM/DD/YYYY''),
to_char(b.rule_start_date,''MM/DD/YYYY''),
''RA_CUSTOMER_TRX_LINES''       
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
where a.customer_trx_id = ##$$TRX1$$##
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.rule_start_date,trunc(sysdate)) <> nvl(b.rule_start_date,trunc(sysdate))
UNION
select distinct ''L.SALES_ORDER'',
a.sales_order, 
b.sales_order,
''RA_CUSTOMER_TRX_LINES''      
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.sales_order,''XX'') <> nvl(b.sales_order,''XX'')
UNION
select distinct ''L.SALES_ORDER_DATE'',
    to_char(a.sales_order_date,''MM/DD/YYYY''), to_char(b.sales_order_date,''MM/DD/YYYY'') ,             
    ''RA_CUSTOMER_TRX_LINES''         
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
    where a.customer_trx_id = ##$$TRX1$$##
    and   b.customer_trx_id = ##$$TRX2$$##
    and a.line_type = b.line_type 
    and   nvl(a.sales_order_date,trunc(sysdate)) <> nvl(b.sales_order_date,trunc(sysdate))
UNION
select distinct ''L.SALES_ORDER_LINE'',
a.sales_order_line, 
b.sales_order_line,
''RA_CUSTOMER_TRX_LINES''       
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.sales_order_line,''XX'') <> nvl(b.sales_order_line,''XX'')
UNION
select distinct ''L.SALES_ORDER_REVISION'',
       to_char(a.sales_order_revision), 
to_char(b.sales_order_revision),
''RA_CUSTOMER_TRX_LINES''        
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
where a.customer_trx_id = ##$$TRX1$$##
and   b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and   nvl(a.sales_order_revision,-99) <> nvl(b.sales_order_revision,-99)
UNION
select distinct ''L.SALES_ORDER_SOURCE'',
...
and b.customer_trx_id = ##$$TRX2$$##
and a.line_type = b.line_type 
and nvl(a.sales_order_source,''XX'') <> nvl(b.sales_order_source,''XX'')
UNION
select distinct ''D.CODE_COMBINATION_ID'',
to_char(a.code_combination_id), 
to_char(b.code_combination_id),
''RA_CUST_TRX_LINE_GL_DIST''       
from RA_CUST_TRX_LINE_GL_DIST a, RA_CUST_TRX_LINE_GL_DIST b
where a.customer_trx_id = ##$$TRX1$$##
and a.account_class = ''REC''
...
and b.account_class = ''REC''
and b.latest_rec_flag = ''Y''
and   nvl(a.code_combination_id,-99) <> nvl(b.code_combination_id,-99)
UNION
select distinct ''L.TAX_CLASSIFICATION_CODE'',
...
and nvl(a.tax_classification_code,''XX'') <> nvl(b.tax_classification_code,''XX'')
UNION
select distinct ''L.TAX_RATE'',
to_char(a.tax_rate), 
to_char(b.tax_rate),
''RA_CUSTOMER_TRX_LINES''       
from RA_CUSTOMER_TRX_LINES a, RA_CUSTOMER_TRX_LINES b
...
and a.line_type = b.line_type 
and a.line_type = ''TAX'' 
and nvl(a.vat_tax_id,-9) = nvl(b.vat_tax_id,-9)
and nvl(a.tax_rate,-99) <> nvl(b.tax_rate,-99)
) OPT_ATTR
where OPT_ATTR.GROUPING_ATTRIBUTE in
(select C.FROM_COLUMN_NAME
FROM RA_GROUPING_TRX_TYPES T,
...
AND B.COLUMN_ID = C.COLUMN_ID
AND C.COLUMN_TYPE = ''O'')',
      p_title                  => 'Non-identical Optional Non-Flexfield Attribute Values',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Identified differences in optional non-flexfield grouping attributes.',
      p_solution               => 'Please review the differences listed for the optional (User-defined) non-flexfield attributes. <br>
For each grouping attribute listed, compare the values in VALUE_FOR_TRX1 against VALUE_FOR_TRX2. These differences are causing your transactions to be split up.<br><br>
Review the method by which you populate the interface lines table and identify why these values are not the same.<br>
For more information, please review [1084554/KB627980] Troubleshooting Grouping Rules In AutoInvoice.',
      p_success_msg            => 'No differences found for optional (User-defined) non-flexfield grouping attributes.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_GR_OPTIONAL_GROUPING_DIFF2');



debug('begin add_signature: AR_GR_ZX MANDATORY_GROUPING_DIFF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3365',
      p_sig_id                 => 'AR_GR_ZX MANDATORY_GROUPING_DIFF',
      p_sig_sql                => 'select distinct ''DOCUMENT_SUB_TYPE'' GROUPING_ATTRIBUTE,
            to_char(a.document_sub_type)  VALUE_FOR_TRX1, to_char(b.document_sub_type)  VALUE_FOR_TRX2,
           ''ZX_LINES_DET_FACTORS'' SOURCE
     from ZX_LINES_DET_FACTORS a, ZX_LINES_DET_FACTORS b
     where a.trx_id = ##$$TRX1$$##
     and   b.trx_id = ##$$TRX2$$##
     and a.application_id = 222
     and b.application_id = 222
     and      a.entity_code    = ''TRANSACTIONS'' 
     and      b.entity_code    = ''TRANSACTIONS''
     and      a.event_class_code in (''INVOICE'',''DEBIT_MEMO'',''CREDIT_MEMO'')
     and      b.event_class_code in (''INVOICE'',''DEBIT_MEMO'',''CREDIT_MEMO'')
     and   nvl(a.document_sub_type,''X'') <> nvl(b.document_sub_type,''X'')
UNION
   select distinct ''DEFAULT_TAXATION_COUNTRY'',
            to_char(a.default_taxation_country), to_char(b.default_taxation_country),
     ...
     and      a.event_class_code in (''INVOICE'',''DEBIT_MEMO'',''CREDIT_MEMO'')
     and      b.event_class_code in (''INVOICE'',''DEBIT_MEMO'',''CREDIT_MEMO'')
     and   nvl(a.default_taxation_country,''X'') <> nvl(b.default_taxation_country,''X'')  
UNION
   select distinct ''TAX_REPORTING_FLAG'',
            to_char(a.tax_reporting_flag), to_char(b.tax_reporting_flag),
           ''ZX_LINES_DET_FACTORS''
     from ZX_LINES_DET_FACTORS a, ZX_LINES_DET_FACTORS b
     where a.trx_id = ##$$TRX1$$##
     and   b.trx_id = ##$$TRX2$$##
     ...
     and      a.event_class_code in (''INVOICE'',''DEBIT_MEMO'',''CREDIT_MEMO'')
     and      b.event_class_code in (''INVOICE'',''DEBIT_MEMO'',''CREDIT_MEMO'')
     and   nvl(a.tax_reporting_flag,''X'') <> nvl(b.tax_reporting_flag,''X'')',
      p_title                  => 'Non-identical Tax-Related Mandatory Attribute Values',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Identified differences in tax-related mandatory grouping attributes.',
      p_solution               => 'Please review the differences listed for the tax-related mandatory (Oracle-defined) attributes. <br>
For each grouping attribute listed, compare the values in VALUE_FOR_TRX1 against VALUE_FOR_TRX2. These differences are causing your transactions to be split up.<br><br>
Review the method by which you populate the interface lines table and identify why these values are not the same.<br>
For more information, please review [1084554/KB627980] Troubleshooting Grouping Rules In AutoInvoice.',
      p_success_msg            => 'No differences found in tax-related mandatory grouping attributes.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_GR_ZX MANDATORY_GROUPING_DIFF');
...
BEGIN
  ...
  analyzer_title := 'Receivables Grouping Rules Analyzer';
...
debug('begin section: TRX_DETAILS');
start_section('Transaction Details', 'TRX_DETAILS');
   set_item_result(run_stored_sig('AR_GR_RA_CUSTOMER_TRX_ALL'));
   set_item_result(run_stored_sig('AR_GR_RA_CUST_TRX_TYPES_ALL'));
   set_item_result(run_stored_sig('AR_GR_RA_BATCH_SOURCES_ALL'));
end_section;
debug('end section: TRX_DETAILS');

debug('begin section: GRP_SETUP');
start_section('Grouping Rule Setup', 'GRP_SETUP');
   set_item_result(run_stored_sig('AR_GR_GROUPING_RULES_HIERARCHY'));
   set_item_result(run_stored_sig('AR_GR_DERIVED_GRP_RULE_TO_USE'));
   set_item_result(run_stored_sig('AR_GR_GRP_RULES_MATCH'));
end_section;
debug('end section: GRP_SETUP');

debug('begin section: GRP_CHK');
IF g_1_grouping_rule_id = g_2_grouping_rule_id THEN
   start_section('Grouping Rule Verification', 'GRP_CHK');
      set_item_result(run_stored_sig('AR_GR_ALL_GROUPING_ATTRIBS'));
      set_item_result(run_stored_sig('AR_GR_GROUPING_RULE_ATTRIBUTES'));
      set_item_result(run_stored_sig('AR_GR_MANDATORY_GROUPING_DIFF'));
      set_item_result(run_stored_sig('AR_GR_MANDATORY_GROUPING_DIFF2'));
      set_item_result(run_stored_sig('AR_GR_OPTIONAL_GROUPING_DIFF'));
      set_item_result(run_stored_sig('AR_GR_OPTIONAL_GROUPING_DIFF2'));
      set_item_result(run_stored_sig('AR_GR_ZX MANDATORY_GROUPING_DIFF'));
   end_section;
END IF;
debug('end section: GRP_CHK');
