...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Payables Supplier Analyzer             |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE ap_sup_analyzer_pkg AUTHID DEFINER AS
...
(            p_supplier_ID                  IN NUMBER      DEFAULT NULL
           ...
           ,p_to_supplier_ID               IN NUMBER      DEFAULT NULL
           ,p_to_supplier_site_ID          IN NUMBER      DEFAULT NULL
           ,p_include_apps_check           IN VARCHAR2    DEFAULT 'Y'
           ,p_org_id                       IN VARCHAR2    DEFAULT '**Obsolete**'
...
END ap_sup_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY ap_sup_analyzer_pkg AS
-- $Id: ap_sup_analyzer.sql, 200.59 2026/02/25 12:18:28 sdenye Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2380650.1));
...
----------------------------------------------------------------
g_iview           VARCHAR2(1000);
g_cview           VARCHAR2(1000);
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'APSUP_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'APSUP_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>APSUP Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2380650.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/apsup_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1374,EBS,EBS Financials,EBS - Payables" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1374,EBS,EBS Financials,EBS - Payables" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1374,EBS,EBS Financials,EBS - Payables" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4142450" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">1374</span>
...
<p><strong>Version 200.59 </strong>25-FEB-26</p><ul><li>Updated signatures for indexes and recommended patches</li>
</ul>
<p><strong>Version 200.58 </strong>27-JAN-26</p><ul><li>Updated signatures to include knowledge article IDs</li>
<li>Changes to proactive signatures and alerts</li>
</ul>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1374,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Payables" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1374,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Payables" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1374,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Payables" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
FUNCTION check_rec_patches_1 RETURN VARCHAR2 IS
  /* Signature AP_SUPPLIER_REC_PATCHES */
...
BEGIN
    ...
    print_log('Processing recommended patches signature: AP_SUPPLIER_REC_PATCHES (check_rec_patches_1) "Recommended Patches" (version 2)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_col_rows(4)(l_rows) := 'R12.1: Payables Recommended Patch Collection  (Core AP), Feb 2016';
   l_col_rows(5)(l_rows) := '[1397581.2]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.1: Payables Recommended Patch Collection (RPC) for ISP/Suppliers, Aug 2015';
   l_col_rows(5)(l_rows) := '[954704/PALRT2285]';

END IF;

   l_extra_info('##SHOW_SQL##'):= 'Y';

   l_sig.sigrepo_id := '9764';
...
<li>[10940175/KA580] Patch Wizard FAQ</li>
  ...
  -- Register
  l_step := '60';
  g_signatures('AP_SUPPLIER_REC_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'AP_SUPPLIER_REC_PATCHES',     -- sig ID
...
debug('begin populate parameters hash table');
   ...
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Supplier Site ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_supplier_site_ID,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Merged Supplier ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_to_supplier_ID,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Merged Supplier Site ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_to_supplier_site_ID,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  l_revision := rtrim(replace('$Revision: 200.59  $','$',''));
  l_revision := ltrim(replace(l_revision,'Revision:',''));
  l_date_char := rtrim(replace('$Date: 2026/02/25 12:18:27 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'ap_sup_analyzer.sql';
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid supplier specified.');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
debug('begin parameter validation: p_supplier_site_ID');
IF p_supplier_site_ID IS NOT NULL THEN
BEGIN
SELECT S.VENDOR_SITE_ID
INTO l_exists_val
FROM AP_SUPPLIER_SITES_ALL S, HR_OPERATING_UNITS O, HZ_PARTY_SITES A
WHERE S.VENDOR_SITE_ID = p_supplier_site_ID
 AND S.vendor_id = p_supplier_ID
and S.ORG_ID = O.ORGANIZATION_ID
and (mo_global.is_mo_init_done = 'N' or mo_global.check_access(S.org_id) = 'Y')
and S.PARTY_SITE_ID = A.PARTY_SITE_ID(+)
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid supplier site specified.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_supplier_site_ID failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_supplier_site_ID');

debug('begin parameter validation: p_to_supplier_ID');
IF p_to_supplier_ID IS NOT NULL THEN
BEGIN
SELECT VENDOR_ID
INTO l_exists_val
FROM AP_SUPPLIERS
WHERE VENDOR_ID = p_to_supplier_ID and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid merged supplier specified.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_to_supplier_ID failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_to_supplier_ID');

debug('begin parameter validation: p_to_supplier_site_ID');
IF p_to_supplier_site_ID IS NOT NULL THEN
BEGIN
SELECT S.VENDOR_SITE_ID
INTO l_exists_val
FROM AP_SUPPLIER_SITES_ALL S, HR_OPERATING_UNITS O, HZ_PARTY_SITES A
WHERE S.VENDOR_SITE_ID = p_to_supplier_site_ID
 AND S.VENDOR_ID = p_to_supplier_ID
and S.ORG_ID = O.ORGANIZATION_ID
and (mo_global.is_mo_init_done = 'N' or mo_global.check_access(S.ORG_ID) = 'Y')
and S.PARTY_SITE_ID = A.PARTY_SITE_ID(+)
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid merged supplier site specified.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_to_supplier_site_ID failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_to_supplier_site_ID');
...
IF p_include_apps_check IS NOT NULL AND p_include_apps_check NOT IN ( 'N','Y') THEN
   print_error('INVALID ARGUMENT: Invalid Apps Check option specified. Valid values are Y or N.');
   raise invalid_parameters;
END IF;
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$VENDOR_ID$$##') := p_supplier_ID;
   g_masked_tokens('##$$VENDOR_ID$$##') := mask_text( g_sql_tokens('##$$VENDOR_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$VENDOR_SITE_ID$$##') := nvl(p_supplier_site_ID, 0);
   g_masked_tokens('##$$VENDOR_SITE_ID$$##') := mask_text( g_sql_tokens('##$$VENDOR_SITE_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$TO_VENDOR_ID$$##') := nvl(p_to_supplier_ID, 0);
   g_masked_tokens('##$$TO_VENDOR_ID$$##') := mask_text( g_sql_tokens('##$$TO_VENDOR_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$TO_VENDOR_SITE_ID$$##') := nvl(p_to_supplier_site_ID, 0);
   g_masked_tokens('##$$TO_VENDOR_SITE_ID$$##') := mask_text( g_sql_tokens('##$$TO_VENDOR_SITE_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM1$$##') := '200';
   g_masked_tokens('##$$APPS_PARAM1$$##') := mask_text( g_sql_tokens('##$$APPS_PARAM1$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM2$$##') := '177';
   g_masked_tokens('##$$APPS_PARAM2$$##') := mask_text( g_sql_tokens('##$$APPS_PARAM2$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM3$$##') := '673';
   g_masked_tokens('##$$APPS_PARAM3$$##') := mask_text( g_sql_tokens('##$$APPS_PARAM3$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM4$$##') := '260';
   g_masked_tokens('##$$APPS_PARAM4$$##') := mask_text( g_sql_tokens('##$$APPS_PARAM4$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM5$$##') := '235';
   ...
   g_sql_tokens('##$$SOB$$##') := 'select distinct sup.set_of_books_id 
'||
'from ap_suppliers sup 
'||
'where sup.vendor_id =
'||nvl(p_supplier_id,-99)||'';
   g_masked_tokens('##$$SOB$$##') := mask_text( g_sql_tokens('##$$SOB$$##'), 'NO_MASK');
...
debug('begin add_signature: AP_INVALIDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9763',
      p_sig_id                 => 'AP_INVALIDS',
    ...
    AND a.owner = ''APPS''
    AND a.object_name like ''AP_%'' 
    AND a.status = ''INVALID''',
      p_title                  => 'Payables  Invalid Objects',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are invalid Payables objects',
      p_solution               => '<ul>
      ...
      p_success_msg            => 'No Payables invalid objects exists in the database.',
   ...
   l_info.delete;
debug('end add_signature: AP_INVALIDS');



debug('begin add_signature: AP_SUPPLIER_MGD_74');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9885',
      p_sig_id                 => 'AP_SUPPLIER_MGD_74',
      p_sig_sql                => 'SELECT org_id,
          set_of_books_id,
   ...
   WHERE (nvl(asp.rate_var_gain_ccid, -1) = -1 OR
          ...
          AND (mo_global.is_mo_init_done = ''N'' or mo_global.check_access(asp.org_id) = ''Y'')',
      p_title                  => 'NULL Values in Required Columns of AP_SYSTEM_PARAMETERS_ALL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are null values in AP_SYSTEM_PARAMETERS_ALL table, resulting in issues during accounting, like accounting being unexpected or accounting failing in case of GAIN and LOSS lines.',
      p_solution               => 'Apply the GDF patch, following the instructions provided in [1144544/KB776004].
This patch will update these required columns with the default values.
',
      p_success_msg            => 'Checked for null values in AP_SYSTEM_PARAMETERS_ALL table, no issues found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIER_MGD_74');
...
debug('begin add_signature: SUP_AP_SYSTEM_PARAMETERS_ALL');
   l_info('##MASK##FEDERAL_IDENTIFICATION_NUM'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '21162',
      p_sig_id                 => 'SUP_AP_SYSTEM_PARAMETERS_ALL',
      p_sig_sql                => 'select *
       from ap_system_parameters_all
      where set_of_books_id in (##$$SOB$$##)',
   ...
   l_info.delete;
debug('end add_signature: SUP_AP_SYSTEM_PARAMETERS_ALL');



debug('begin add_signature: SUP_FINANCIAL_OPTIONS');
   l_info('##MASK##VAT_REGISTRATION_NUM'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '21164',
      p_sig_id                 => 'SUP_FINANCIAL_OPTIONS',
      p_sig_sql                => 'select * from financials_system_params_all where set_of_books_id in (##$$SOB$$##)',
      p_title                  => 'Financial Options',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Financial Options',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: SUP_FINANCIAL_OPTIONS');



debug('begin add_signature: AP_SUPPLIERS');
...
where vendor_id = ##$$VENDOR_ID$$##',
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIERS');



debug('begin add_signature: AP_SUPPLIER_SITES_ALL');
   ...
   l_info('##MASK##FAX'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##LEGAL_BUSINESS_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##PHONE'):= 'DISPLAY_FIRST_25_PCNT';
  ...
  add_signature(
      p_sig_repo_id            => '8513',
      p_sig_id                 => 'AP_SUPPLIER_SITES_ALL',
      p_sig_sql                => 'SELECT HOU.name OPERATING_UNIT, SITE.* 
  FROM ap_supplier_sites_all SITE,
       hr_all_organization_units HOU
where SITE.org_id = HOU.organization_id
and ( vendor_site_id  = nvl( ##$$VENDOR_SITE_ID$$##, vendor_site_id) or  ##$$VENDOR_SITE_ID$$## = 0 )
and vendor_id = ##$$VENDOR_ID$$##
order by HOU.name, vendor_id, vendor_site_id',
      p_title                  => 'Supplier Sites - AP_SUPPLIER_SITES_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Supplier sites information to display.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIER_SITES_ALL');



debug('begin add_signature: AP_SUPPLIERS_INT');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_FIRST_25_PCNT';
   ...
   l_info('##MASK##SECOND_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TAX_REPORTING_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TCA_SYNC_NUM'):= 'DISPLAY_LAST_25_PCNT';
  ...
  add_signature(
      p_sig_repo_id            => '13467',
      p_sig_id                 => 'AP_SUPPLIERS_INT',
      p_sig_sql                => 'SELECT * FROM AP_SUPPLIERS_INT WHERE VENDOR_INTERFACE_ID = ##$$VENDOR_ID$$##',
      p_title                  => 'Supplier Interface Data - AP_SUPPLIERS_INT',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Supplier Header Interface data found for this Vendor.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIERS_INT');



debug('begin add_signature: AP_SUPPLIER_SITES_INT');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_FIRST_25_PCNT';
  ...
  add_signature(
      p_sig_repo_id            => '14159',
      p_sig_id                 => 'AP_SUPPLIER_SITES_INT',
      p_sig_sql                => 'SELECT * FROM AP_SUPPLIER_SITES_INT WHERE VENDOR_INTERFACE_ID = ##$$VENDOR_ID$$##',
      p_title                  => 'Supplier Site Interface Data - AP_SUPPLIER_SITES_INT',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Supplier Site Interface data found for this Vendor.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIER_SITES_INT');



debug('begin add_signature: PO_VENDORS_OBS_11I');
   l_info('##MASK##ATTRIBUTE%'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##BANK_ACCOUNT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##BANK_ACCOUNT_NUM'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##BANK_NUM'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '8515',
      p_sig_id                 => 'PO_VENDORS_OBS_11I',
      p_sig_sql                => 'Select * 
 from PO_VENDORS_OBS 
where vendor_id in( ##$$VENDOR_ID$$## , ##$$TO_VENDOR_ID$$##)',
      p_title                  => 'Migrated Supplier - PO_VENDORS_OBS_11i',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No migrated supplier information to display.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PO_VENDORS_OBS_11I');



debug('begin add_signature: AP_SUPPLIER_SITE_TABLE_MIGRATED');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '9762',
      p_sig_id                 => 'AP_SUPPLIER_SITE_TABLE_MIGRATED',
      p_sig_sql                => 'SELECT *
FROM po_vendor_sites_obs
WHERE (vendor_site_id = nvl( ##$$VENDOR_SITE_ID$$##, vendor_site_id) or ##$$VENDOR_SITE_ID$$## = 0)
AND vendor_id         = ##$$VENDOR_ID$$## 
ORDER BY vendor_id,
  vendor_site_id',
      p_title                  => 'Migrated Supplier Site - PO_VENDOR_SITES_OBS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No migrated supplier site information.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIER_SITE_TABLE_MIGRATED');



debug('begin add_signature: AP_SUPPLIERS_MERGED_INFORMATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9893',
      p_sig_id                 => 'AP_SUPPLIERS_MERGED_INFORMATION',
      p_sig_sql                => 'SELECT *
FROM AP_DUPLICATE_VENDORS_ALL
WHERE (duplicate_vendor_id    =  ##$$TO_VENDOR_ID$$## or ##$$TO_VENDOR_ID$$## = 0)
AND (duplicate_vendor_site_id = ##$$TO_VENDOR_SITE_ID$$## or ##$$TO_VENDOR_SITE_ID$$## = 0)
AND vendor_id                 = ##$$VENDOR_ID$$##
ORDER BY duplicate_vendor_id',
      p_title                  => 'Merged Supplier - AP_DUPLICATE_VENDORS_ALL_TABLE',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Merged Supplier table information',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIERS_MERGED_INFORMATION');



debug('begin add_signature: 7_DUP_INVOICE_SUPPLIER_MERGE_SUP');
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19015',
      p_sig_id                 => '7_DUP_INVOICE_SUPPLIER_MERGE_SUP',
      p_sig_sql                => 'select  dv.entry_id,
...
and    DV.PROCESS <> ''P''
and INV.PAYMENT_STATUS_FLAG= DECODE(DV.PAID_INVOICES_FLAG,''N'',''N'',INV.PAYMENT_STATUS_FLAG)
and a.vendor_id in (##$$VENDOR_ID$$##)',
      p_title                  => 'Retrieve all the invoice numbers for FROM VENDORS for which merge has not been successful',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are duplicate invoices for which Supplier Merge is unsuccessful.',
      p_solution               => 'Refer to [1357813/KB480152] and follow the action plan to correct the Duplicate Invoice Number.',
      p_success_msg            => 'There is no Duplicate Invoice Number which can cause unsuccessful Supplier Merge',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: 7_DUP_INVOICE_SUPPLIER_MERGE_SUP');



debug('begin add_signature: SUPPLIER_CONTACTS_HZ_PARTIES');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ADDRESS%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CONTACT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   ...
   l_info('##MASK##PRIMARY_PHONE_AREA_CODE'):= 'DISPLAY_LAST_25_PCNT_WORD';
   l_info('##MASK##PRIMARY_PHONE_NUMBER'):= 'DISPLAY_LAST_25_PCNT_WORD';
   l_info('##MASK##RAW_PHONE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '21304',
      p_sig_id                 => 'SUPPLIER_CONTACTS_HZ_PARTIES',
      p_sig_sql                => 'SELECT HP.party_name CONTACT, HP.*   
FROM hz_parties HP, hz_relationships HR, ap_suppliers SUP  
WHERE HP.party_id = HR.subject_id    
AND HR.subject_type = ''PERSON''    
AND HR.object_type = ''ORGANIZATION''    
AND HR.relationship_code = ''CONTACT_OF''    
AND HR.object_id = SUP.party_id    
AND SUP.vendor_id = ##$$VENDOR_ID$$##',
      p_title                  => 'Supplier Contacts - HZ_PARTIES',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Supplier Contacts (HZ_PARTIES)',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: SUPPLIER_CONTACTS_HZ_PARTIES');



debug('begin add_signature: AP_SUPPLIER_CONTACTS');
   l_info('##MASK##%_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##%_NAME_ALT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ALT_PHONE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##AREA_CODE'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##EMAIL_ADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FAX'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PHONE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TITLE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8514',
      p_sig_id                 => 'AP_SUPPLIER_CONTACTS',
      p_sig_sql                => 'SELECT *
FROM AP_SUPPLIER_CONTACTS
WHERE org_party_site_id IN
  (SELECT party_site_id
  FROM ap_supplier_sites_all
  WHERE 
    (vendor_site_id = nvl( ##$$VENDOR_SITE_ID$$##, vendor_site_id) or ##$$VENDOR_SITE_ID$$## = 0)
     AND vendor_id          = ##$$VENDOR_ID$$##  
) 
ORDER BY vendor_contact_id',
      p_title                  => 'Supplier Contacts (Linking table) - AP_SUPPLIER_CONTACTS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No supplier contact information to display.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIER_CONTACTS');



debug('begin add_signature: HZ_CONTACT_POINTS_TABLE');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ADDRESS%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CONTACT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_KEY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   ...
   l_info('##MASK##PERSON_%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PHONE_AREA_CODE'):= 'DISPLAY_LAST_25_PCNT';
   l_info('##MASK##PHONE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##RAW_PHONE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRANSPOSED_PHONE_NUMBER'):= 'DISPLAY_LAST_25_PCNT';
   l_info('##MASK##VENDOR_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9829',
      p_sig_id                 => 'HZ_CONTACT_POINTS_TABLE',
      p_sig_sql                => 'SELECT CON.party_name CONTACT, CP.* 
  FROM hz_contact_points CP, hz_relationships REL, ap_suppliers SUP, hz_parties CON
WHERE CP.owner_table_name = ''HZ_PARTIES''
   AND CP.owner_table_id = REL.party_id
   AND SUP.party_id = REL.object_id
   AND CON.party_id = REL.subject_id
   AND SUP.vendor_id in (##$$VENDOR_ID$$##)
UNION ALL   
SELECT CON.party_site_name CONTACT,CP.*
  FROM hz_contact_points CP
      ,hz_party_sites CON
 WHERE 1 = 1
   AND CON.party_site_id IN (SELECT party_site_id
                             FROM ap_supplier_sites_all
                             WHERE vendor_id  in (##$$VENDOR_ID$$##))
   AND CP.owner_table_id = CON.party_site_id',
      p_title                  => 'Supplier Contacts (Phone, Fax, Email) - HZ_CONTACT_POINTS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No supplier contacts table information to display.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: HZ_CONTACT_POINTS_TABLE');



debug('begin add_signature: EBS_FIN_AP_APSUP_UPDATE_TAXPEYERID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27765',
      p_sig_id                 => 'EBS_FIN_AP_APSUP_UPDATE_TAXPEYERID',
      p_sig_sql                => 'SELECT
  trigger_name,
  trigger_type,
  triggering_event,
...
and table_name like ''AP%SUPP%''
and STATUS = ''ENABLED''
ORDER BY
  trigger_name ASC,
  base_object_type ASC,
  table_name ASC',
      p_title                  => 'Custom Trigger Detected on Supplier Tables',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Custom trigger on supplier tables detected',
      p_solution               => 'Follow the instructions as detailed in [2982095/KB254300] to help resolve the issue.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_APSUP_UPDATE_TAXPEYERID');



debug('begin add_signature: EBS_FIN_AP_INV_SUPP_ADDR_INVALID');
   l_info('##MASK##PARTY_SITE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##VENDOR_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '27628',
      p_sig_id                 => 'EBS_FIN_AP_INV_SUPP_ADDR_INVALID',
      p_sig_sql                => 'SELECT
    sup.vendor_name       supplier,
    sup.vendor_id          supplier_id,
    addr.party_site_name  address,
    site.vendor_site_code site,
    site.vendor_site_id site_id,
    site.inactive_date    site_inactive_date,
    addr.status           address_status,
    addr.end_date_active  address_end_date,
    decode(addr.status, ''I'', least(nvl(addr.end_date_active, sysdate - 1), nvl(site.inactive_date, sysdate - 1)), site.inactive_date) effective_site_inactive_date
FROM
    ap_suppliers          sup,
...
WHERE
    ...
    AND site.party_site_id = addr.party_site_id
    AND (
    (site.inactive_date is not null)
    AND
    (nvl(site.inactive_date, sysdate + 1) <= sysdate))
    and SITE.vendor_id in ((##$$VENDOR_ID$$##))',
      p_title                  => 'Supplier Address associated with the Supplier Site are inactive',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Supplier Address associated with the Supplier Site are inactive',
      p_solution               => 'Please follow the instructions as detailed in [2565860/KB731895].',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_INV_SUPP_ADDR_INVALID');



debug('begin add_signature: SUPPLIER_PER_ALL_PEOPLE_F');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8517',
      p_sig_id                 => 'SUPPLIER_PER_ALL_PEOPLE_F',
      p_sig_sql                => 'Select person_ID, party_id,
...
order by person_id',
      p_title                  => 'Employee Information - PER_ALL_PEOPLE_F',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Supplier employee information to display.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: SUPPLIER_PER_ALL_PEOPLE_F');



debug('begin add_signature: SUPPLIER_EMPLOYEE_PER_ADDRESS');
   l_info('##MASK##ADDRESS_LINE1'):= 'MASK_ALPHANUMERIC';
   l_info('##MASK##ADDRESS_LINE2'):= 'MASK_ALPHANUMERIC';
   l_info('##MASK##ADDRESS_LINE3'):= 'MASK_ALPHANUMERIC';
   l_info('##MASK##COUNTRY'):= 'MASK_ALPHANUMERIC';
   l_info('##MASK##POSTAL_CODE'):= 'MASK_ALPHANUMERIC';
   l_info('##MASK##REGION_1'):= 'MASK_ALPHANUMERIC';
   l_info('##MASK##REGION_2'):= 'MASK_ALPHANUMERIC';
   l_info('##MASK##REGION_3'):= 'MASK_ALPHANUMERIC';
   l_info('##MASK##TOWN_OR_CITY'):= 'MASK_ALPHANUMERIC';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9802',
      p_sig_id                 => 'SUPPLIER_EMPLOYEE_PER_ADDRESS',
...
ORDER BY person_id',
      p_title                  => 'Employee Information - PER_ADDRESS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No supplier employee address information to display.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: SUPPLIER_EMPLOYEE_PER_ADDRESS');



debug('begin add_signature: SUPPLIER_EMP_PER_ALL_ASSIGN_F');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9803',
      p_sig_id                 => 'SUPPLIER_EMP_PER_ALL_ASSIGN_F',
      p_sig_sql                => 'SELECT assignment_id, 
effective_start_date,
effective_end_date,
business_group_id,
job_id,
...
ORDER BY person_id',
      p_title                  => 'Employee Assignments - PER_ALL_ASSIGNMENTS_F',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No supplier employee table assignments information to display.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: SUPPLIER_EMP_PER_ALL_ASSIGN_F');



debug('begin add_signature: AP_SUPPLIER_HR_LOCATIONS_ALL_LOCATIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9804',
      p_sig_id                 => 'AP_SUPPLIER_HR_LOCATIONS_ALL_LOCATIONS',
      p_sig_sql                => 'SELECT LOCATION_ID,
ENTERED_BY,
INACTIVE_DATE ,
...
ORDER BY location_id',
      p_title                  => 'Employee Supplier HR Locations',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No supplier HR locations information to display.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIER_HR_LOCATIONS_ALL_LOCATIONS');



debug('begin add_signature: EBS_FIN_AP_DUPLICATE_SUPPLIERS_WITH_SAME_EMPLOYEE_ID');
   l_info('##MASK##FULL_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##VENDOR_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26300',
      p_sig_id                 => 'EBS_FIN_AP_DUPLICATE_SUPPLIERS_WITH_SAME_EMPLOYEE_ID',
      p_sig_sql                => 'SELECT aps.vendor_id ,
aps.employee_id,
aps.vendor_name,
papf.full_name,
papf.party_id,
...
',
      p_solution               => 'Please log an SR with the output of this analyzer to request a data fix for [2793686/KB605064].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_DUPLICATE_SUPPLIERS_WITH_SAME_EMPLOYEE_ID');



debug('begin add_signature: EBS_FIN_AP_IBY_APSUP_BANK_ASSIGN');
   l_info('##MASK##BANK_ACCOUNT_NUM'):= 'DISPLAY_LAST_4_CHAR';
   l_info('##MASK##BANK_ACCT_NUM'):= 'DISPLAY_LAST_4_CHAR';
   l_info('##MASK##NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PARTY_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25370',
      p_sig_id                 => 'EBS_FIN_AP_IBY_APSUP_BANK_ASSIGN',
      p_sig_sql                => 'SELECT ''Account Owner'' TYPE, HP.party_name NAME, ''*SUPPLIER*'' SITE, IAO.account_owner_id REC_ID, 
       IAO.account_owner_party_id PARTY, SUP.vendor_id, IAO.primary_flag PRIMARY,
       IEBA.bank_id, IEBA.branch_id, IEBA.ext_bank_account_id,
       IEBA.bank_account_num  BANK_ACCT_NUM
  FROM iby_ext_bank_accounts IEBA, iby_account_owners IAO, hz_parties HP, ap_suppliers SUP
 WHERE IEBA.ext_bank_account_id = IAO.ext_bank_account_id
   ...
   AND SUP.vendor_id in (##$$VENDOR_ID$$##)
UNION 
SELECT ''Assignment'' TYPE, HP.party_name NAME, NVL(SITE.vendor_site_code, ''*SUPPLIER*'') SITE, IPIU.instrument_payment_use_id REC_ID, 
       IEP.payee_party_id PARTY, SUP.vendor_id, ''A'' PRIMARY,
       IEBA.bank_id, IEBA.branch_id, IEBA.ext_bank_account_id,
       IEBA.bank_account_num  BANK_ACCT_NUM
  FROM iby_ext_bank_accounts IEBA, iby_pmt_instr_uses_all IPIU, iby_external_payees_all IEP, hz_parties HP, 
       ap_suppliers SUP, ap_supplier_sites_all SITE
 WHERE IEBA.ext_bank_account_id = IPIU.instrument_id
   ...
   AND SUP.vendor_id in (##$$VENDOR_ID$$##)
 ORDER BY 1, 2, 3',
      p_title                  => 'Bank Accounts Ownership and Assignments',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Bank Accounts Ownership and Assignments',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_IBY_APSUP_BANK_ASSIGN');



debug('begin add_signature: IBY_EXT_PARTY_PMT_MTHDS_TABLE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9824',
      p_sig_id                 => 'IBY_EXT_PARTY_PMT_MTHDS_TABLE',
      p_sig_sql                => 'SELECT *
...
WHERE EXT_PMT_PARTY_ID IN
  ...
  WHERE ( payee_party_id =
    (SELECT a.party_id FROM ap_suppliers a WHERE a.vendor_id = ##$$VENDOR_ID$$## 
    )
  AND party_site_id IN
    (SELECT b.party_site_id
    FROM ap_supplier_sites_all b
    WHERE b.vendor_id    = ##$$VENDOR_ID$$## 
    AND (b. vendor_site_id  = nvl( ##$$VENDOR_SITE_ID$$##, vendor_site_id) or  ##$$VENDOR_SITE_ID$$## = 0 )
    ) )
  )
ORDER BY EXT_PMT_PARTY_ID,
  EXT_PARTY_PMT_MTHD_ID',
      p_title                  => 'Supplier Payment Methods - IBY_EXT_PARTY_PMT_MTHDS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No supplier payment methods information to display.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: IBY_EXT_PARTY_PMT_MTHDS_TABLE');



debug('begin add_signature: IBY_PMT_INSTR_USES_ALL_TABLE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9820',
      p_sig_id                 => 'IBY_PMT_INSTR_USES_ALL_TABLE',
      p_sig_sql                => 'SELECT *
...
ORDER BY a.ext_pmt_party_id,
a.instrument_payment_use_id',
      p_title                  => 'Bank Account Assignments - IBY_PMT_INSTR_USES_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No supplier payment instruments table information to display.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: IBY_PMT_INSTR_USES_ALL_TABLE');



debug('begin add_signature: IBY_EXT_BANK_ACCOUNTS_TABLE');
   l_info('##MASK##%HASH_'):= 'REMOVE_COLUMN';
   l_info('##MASK##ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##BANK_ACCOUNT_NUM%'):= 'DISPLAY_LAST_4_CHAR';
   l_info('##MASK##CONTACT%'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##IBAN'):= 'DISPLAY_LAST_4_CHAR';
   l_info('##MASK##MASKED%'):= 'DISPLAY_LAST_4_CHAR';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9821',
      p_sig_id                 => 'IBY_EXT_BANK_ACCOUNTS_TABLE',
      p_sig_sql                => 'SELECT *
...
WHERE ext_bank_account_id IN
  ...
  AND a.EXT_PMT_PARTY_ID IN
    ...
    OR party_site_id IN
      ...
      FROM ap_supplier_sites_all b
      WHERE b.vendor_id         = ##$$VENDOR_ID$$##
      AND (b. vendor_site_id    = NVL( ##$$VENDOR_SITE_ID$$##, vendor_site_id)
      OR ##$$VENDOR_SITE_ID$$## = 0 )
      )))
    )
  )
ORDER BY ext_bank_account_id',
      p_title                  => 'Supplier Bank Accounts - IBY_EXT_BANK_ACCOUNTS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No supplier bank accounts table information to display.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: IBY_EXT_BANK_ACCOUNTS_TABLE');



debug('begin add_signature: IBY_EXTERNAL_PAYEES_ALL_TABLE');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_FIRST_25_PCNT';
  ...
  add_signature(
      p_sig_repo_id            => '9819',
      p_sig_id                 => 'IBY_EXTERNAL_PAYEES_ALL_TABLE',
      p_sig_sql                => 'SELECT *
FROM iby_external_payees_all
WHERE (payee_party_id =
  (SELECT party_id FROM ap_suppliers a WHERE a.vendor_id = ##$$VENDOR_ID$$## 
  ) )
ORDER BY EXT_PAYEE_ID',
      p_title                  => 'Supplier External Payee - IBY_EXTERNAL_PAYEES_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No supplier external payee table information to display.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: IBY_EXTERNAL_PAYEES_ALL_TABLE');



debug('begin add_signature: IBY_EXT_PAYEE_RELATIONSHIPS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9825',
      p_sig_id                 => 'IBY_EXT_PAYEE_RELATIONSHIPS',
      p_sig_sql                => 'SELECT *
...
OR REMIT_PARTY_ID IN
  (SELECT a.party_id
  FROM ap_suppliers a
  WHERE a.vendor_id =  ##$$VENDOR_ID$$##
  )
ORDER BY party_id',
      p_title                  => 'Supplier Relationships - IBY_EXT_PAYEE_RELATIONSHIPS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No supplier relationships table information to display.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: IBY_EXT_PAYEE_RELATIONSHIPS');



debug('begin add_signature: IBY_ACCOUNT_OWNERS_TABLE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9822',
      p_sig_id                 => 'IBY_ACCOUNT_OWNERS_TABLE',
      p_sig_sql                => 'SELECT *
...
ORDER BY ext_bank_account_id,
  ACCOUNT_OWNER_ID',
      p_title                  => 'Supplier Account Owners - IBY_ACCOUNT_OWNERS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No supplier account owners table information to display.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: IBY_ACCOUNT_OWNERS_TABLE');



debug('begin add_signature: HZ_PARTIES_TABLE');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
ORDER BY party_id',
      p_title                  => 'Supplier HZ Party - HZ_PARTIES',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No supplier HZ party table information to display.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: HZ_PARTIES_TABLE');



debug('begin add_signature: HZ_PARTY_SITES_TABLE');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##ADDRESSEE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9831',
      p_sig_id                 => 'HZ_PARTY_SITES_TABLE',
      p_sig_sql                => 'SELECT *
FROM HZ_PARTY_SITES
WHERE party_site_id IN
      (SELECT a.party_site_id FROM ap_supplier_sites_all a 
        WHERE a.vendor_id = ##$$VENDOR_ID$$## )
ORDER BY party_id
',
      p_title                  => 'Supplier Party Sites - HZ_PARTY_SITES',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Supplier Party Sites table information to display.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: HZ_PARTY_SITES_TABLE');



debug('begin add_signature: HZ_PARTY_SITE_USES_TABLE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9832',
      p_sig_id                 => 'HZ_PARTY_SITE_USES_TABLE',
      p_sig_sql                => 'SELECT *
...
ORDER BY party_site_id',
      p_title                  => 'Supplier Party Sites Uses - HZ_PARTY_SITE_USES',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No supplier party sites Uses table information to display.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: HZ_PARTY_SITE_USES_TABLE');



debug('begin add_signature: HZ_PARTY_USG_ASSIGNMENTS_TABLE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9827',
      p_sig_id                 => 'HZ_PARTY_USG_ASSIGNMENTS_TABLE',
      p_sig_sql                => 'SELECT *
...
ORDER BY party_id',
      p_title                  => 'Supplier Party Assignments -  HZ_PARTY_USG_ASSIGNMENTS',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Supplier Party Assignments table information',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: HZ_PARTY_USG_ASSIGNMENTS_TABLE');



debug('begin add_signature: HZ_ORGANIZATION_PROFILES_TABLE');
   l_info('##MASK##ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '9828',
      p_sig_id                 => 'HZ_ORGANIZATION_PROFILES_TABLE',
      p_sig_sql                => 'SELECT *
...
ORDER BY party_id',
      p_title                  => 'Supplier Organization Profiles - HZ_ORGANIZATION_PROFILES',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No supplier Organization Profiles table information to display.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: HZ_ORGANIZATION_PROFILES_TABLE');



debug('begin add_signature: HZ_RELATIONSHIPS_TABLE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9830',
      p_sig_id                 => 'HZ_RELATIONSHIPS_TABLE',
      p_sig_sql                => 'SELECT *
...
OR (object_table_name = ''HZ_PARTIES''
AND object_id        IN
  (SELECT DISTINCT a.party_id
  FROM ap_suppliers a
  WHERE a.vendor_id= ##$$VENDOR_ID$$##
...
ORDER BY subject_id,
  object_id',
      p_title                  => 'Supplier HZ Relationship - HZ_RELATIONSHIPS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No supplier relationship HZ table information to display.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: HZ_RELATIONSHIPS_TABLE');



debug('begin add_signature: HZ_LOCATIONS_TABLE');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##%DESCRIPTION%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ADDRESS%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
WHERE location_id IN
  ...
  FROM hz_party_sites q
  WHERE ( q.party_id =
    (SELECT a.party_id FROM ap_suppliers a WHERE a.vendor_id = ##$$VENDOR_ID$$##
    )
  AND q.party_site_id IN
    (SELECT b.party_site_id
    FROM ap_supplier_sites_all b
    WHERE b.vendor_id    = ##$$VENDOR_ID$$##
    AND (b.vendor_site_id = ##$$VENDOR_SITE_ID$$## or ##$$VENDOR_SITE_ID$$## = 0)
    ) )
  )
ORDER BY location_id',
      p_title                  => 'Supplier Locations - HZ_LOCATIONS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No supplier locations HZ table information to display.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: HZ_LOCATIONS_TABLE');



debug('begin add_signature: EBS_FIN_AP_APSUP_DUP_ADDR1');
   l_info('##MASK##VENDOR_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28786',
      p_sig_id                 => 'EBS_FIN_AP_APSUP_DUP_ADDR1',
      p_sig_sql                => 'SELECT APS.vendor_name, APS.Vendor_id, HZPS.party_site_id, HZCP.contact_point_type, COUNT(*)
  FROM hz_contact_points HZCP, hz_party_sites HZPS, ap_suppliers APS
 WHERE HZCP.status = ''A''
   AND HZCP.primary_flag = ''Y''
   AND HZCP.owner_table_name = ''HZ_PARTY_SITES''
   AND HZPS.party_site_id = HZCP.owner_table_id
   AND APS.party_id = HZPS.party_id
AND APS.vendor_id in (##$$VENDOR_ID$$## )
 GROUP BY APS.vendor_name,APS.Vendor_id, HZPS.party_site_id, HZCP.contact_point_type
HAVING COUNT (*) > 1',
      p_title                  => 'Supplier with Duplicate Primary Contact Points',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Same Supplier address displayed multiple times in Supplier Address book due to duplicate primary contact points',
      p_solution               => 'Please log a service request with Oracle Support to request a data fix for the issue described in [3004980/KB398041].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_APSUP_DUP_ADDR1');



debug('begin add_signature: EBS_FIN_AP_APSUP_DUP_ADDR2');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28956',
      p_sig_id                 => 'EBS_FIN_AP_APSUP_DUP_ADDR2',
      p_sig_sql                => 'SELECT SUP.vendor_id, HPS.party_site_name, HPSA.site_use_type, HPSA.party_site_id, COUNT (*)
  FROM hz_party_site_uses HPSA, hz_party_sites HPS, ap_suppliers SUP
 WHERE HPSA.party_site_id = HPS.party_site_id
   AND HPS.party_id = SUP.party_id
   AND HPSA.status = ''A''
   AND party_site_name IS NOT NULL
   AND SUP.vendor_id in (##$$VENDOR_ID$$##)
 GROUP BY SUP.vendor_id, HPS.party_site_name, HPSA.site_use_type, HPSA.party_site_id
HAVING COUNT (*) > 1
 ORDER BY SUP.vendor_id, HPS.party_site_name',
      p_title                  => 'Supplier with Duplicate Active Addresses',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Same supplier address displayed multiple times in Supplier Address book due to multiple active addresses.',
      p_solution               => 'Please log a service request with Oracle Support to request a data fix for the issue described in [2187113/KB388158].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_APSUP_DUP_ADDR2');



debug('begin add_signature: EBS_FIN_AP_APSUP_NOT_ENABLED');
   l_info('##MASK##VENDOR_NAME%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##ENABLED_FLAG'):= ',#333333,#ffd6cc,bold';
  add_signature(
      p_sig_repo_id            => '22681',
      p_sig_id                 => 'EBS_FIN_AP_APSUP_NOT_ENABLED',
      p_sig_sql                => 'select * from ap_suppliers where vendor_id in (##$$VENDOR_ID$$##) and enabled_flag=''N''',
      p_title                  => 'Supplier Not Enabled',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Supplier has the Enabled Flag set to N in AP_SUPPLIERS',
      p_solution               => 'Log an SR with the output of this analyzer as detailed in [2806940/KB310190] to request a data fix for this issue.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_APSUP_NOT_ENABLED');



debug('begin add_signature: EBS_FIN_AP_APSUP_END_DATE_NULL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29219',
      p_sig_id                 => 'EBS_FIN_AP_APSUP_END_DATE_NULL',
      p_sig_sql                => 'SELECT VENDOR_ID, END_DATE_ACTIVE, ENABLED_FLAG
FROM AP_SUPPLIERS
WHERE ENABLED_FLAG= ''N''
AND END_DATE_ACTIVE IS NULL
AND VENDOR_ID = ''##$$VENDOR_ID$$##''',
      p_title                  => 'End Date Null on Inactive Supplier',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'END_DATE_ACTIVE is NULL but ENABLED_FLAG = N in AP_SUPPLIERS.  Invoices cannot be entered under this supplier in this state.  ',
      p_solution               => 'Please log a Service Request requesting a data fix for [2635721/KB285056].',
      p_success_msg            => 'A data fix will be required to activate this supplier.  ',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_APSUP_END_DATE_NULL');



debug('begin add_signature: EBS_FIN_AP_APSUP_SUPPLIER_STEALE_DATA_FOR_EX_EMPLOYEE');
   l_info('##MASK##VENDOR_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24159',
      p_sig_id                 => 'EBS_FIN_AP_APSUP_SUPPLIER_STEALE_DATA_FOR_EX_EMPLOYEE',
      p_sig_sql                => 'SELECT * FROM ap_suppliers
WHERE employee_id IS NOT NULL
AND vendor_type_lookup_code = ''EX-EMPLOYEE''
AND vendor_id in (##$$VENDOR_ID$$##)
AND enabled_flag = ''Y''',
      p_title                  => 'EMPLOYEE_ID is NOT NULL in AP_SUPPLIERS for EX-EMPLOYEE',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The EMPLOYEE_ID is NOT NULL in AP_SUPPLIERS for VENDOR_TYPE_LOOKUP_CODE of EX-EMPLOYEE.  This can cause Stale Data error when trying to reactivate the employee.',
      p_solution               => 'Log an SR with Oracle Support to request the data fix from [2692467/KB510080].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_APSUP_SUPPLIER_STEALE_DATA_FOR_EX_EMPLOYEE');



debug('begin add_signature: AP_SUPPLIER_SITE_MERGED_INACTIVE_DATE_SUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19009',
      p_sig_id                 => 'AP_SUPPLIER_SITE_MERGED_INACTIVE_DATE_SUP',
      p_sig_sql                => 'select s.VENDOR_ID, s.VENDOR_SITE_ID, s.INACTIVE_DATE, ''Y'' Is_Vendor_Site_Merged 
from AP_SUPPLIER_SITES_ALL s 
where AP_VENDOR_PUB_PKG.Is_Vendor_Site_Merged(s.VENDOR_SITE_ID) = ''Y''
and vendor_id=##$$VENDOR_ID$$##',
      p_title                  => 'Inactive Date Field Not Updatable for Merged Site',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Inactive date of a supplier site cannot be updated.',
      p_solution               => 'This is intended behavior.  Once a vendor site is merged, it will inactivated and cannot be reactivated because it is no longer a valid site after the merge.
The Inactive Date field becomes read-only in this situation.  Reference [1543460/KB703043].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIER_SITE_MERGED_INACTIVE_DATE_SUP');



debug('begin add_signature: AP__SUPPLIERS_MGD_63');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10037',
      p_sig_id                 => 'AP__SUPPLIERS_MGD_63',
      p_sig_sql                => 'SELECT s.vendor_id,
          s.segment1 vendor_number,
          s.vendor_type_lookup_code
   FROM ap_suppliers s
   WHERE s.vendor_name is null
   AND   s.vendor_id = nvl(##$$VENDOR_ID$$##, s.vendor_id)',
      p_title                  => 'Null Vendor Name in AP_SUPPLIERS',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Null vendor name in AP_SUPPLIERS',
      p_solution               => 'Apply the GDF patch following the instructions provided in [1179376/KB457806]',
      p_success_msg            => 'Checked for Null vendor name in AP_SUPPLIERS, no issues found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AP__SUPPLIERS_MGD_63');



debug('begin add_signature: AP_SUPPLIERS_MGD_353');
   l_info('##MASK##PARTY_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##VENDOR_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10028',
      p_sig_id                 => 'AP_SUPPLIERS_MGD_353',
      p_sig_sql                => 'SELECT aps.vendor_id,
       aps.vendor_name,
       hp.party_id,
       hp.party_name
   FROM ap_suppliers aps,
        hz_parties hp
   WHERE aps.vendor_id = nvl(##$$VENDOR_ID$$##, aps.vendor_id)
   AND   aps.party_id = hp.party_id
   AND   aps.employee_id is null
   AND   nvl(aps.vendor_name, ''dummy'') <> nvl(hp.party_name, ''dummy'')',
      p_title                  => 'Vendor Name in Payables / Party Name in HZ Are Not in Sync',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Vendor name in Payables and party name in HZ are not in sync post upgrade causing the vendor name to be displayed inconsistently.',
      p_solution               => 'Apply the pre-install root cause fix from bug {16568150} prior to upgrade or log a Service Request to obtain the data fix.',
      p_success_msg            => 'Checked for vendor name in Payables and party name in HZ not in sync post upgrade, no issues found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIERS_MGD_353');



debug('begin add_signature: AP_SUPPLIERS_MGD_427');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10031',
      p_sig_id                 => 'AP_SUPPLIERS_MGD_427',
   ...
   AND   s.vendor_id = nvl(##$$VENDOR_ID$$##, s.vendor_id)',
      p_title                  => 'Employee PARTY_ID mismatch between AP_SUPPLIERS and PER_ALL_PEOPLE_F',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Employee PARTY_ID mismatch between AP_SUPPLIERS and PER_ALL_PEOPLE_F causing issues when searching for employees  and creating bank accounts for employee suppliers.',
      p_solution               => 'Log a Service Request to obtain the data fix for [2168611/KB742633]',
      p_success_msg            => 'Checked for PARTY_ID value in HR different from that in AP_SUPPLIERS for employee type suppliers, no issues found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIERS_MGD_427');



debug('begin add_signature: AP_SUPPLIERS_MGD_57');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10019',
      p_sig_id                 => 'AP_SUPPLIERS_MGD_57',
      p_sig_sql                => 'SELECT s.vendor_id,
          s.vendor_type_lookup_code,
          s.party_id,
          s.individual_1099,
   ...
   AND   s.vendor_id = nvl(##$$VENDOR_ID$$##, s.vendor_id)',
      p_title                  => 'Suppliers Missing individual_1099/tax_payer_id',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Suppliers missing INDIVIDUAL_1099/TAX_PAYER_ID after upgrade from 11i.',
      p_solution               => 'Apply the GDF patch following the instructions provided in [1271092/KB381586]',
      p_success_msg            => 'Checked for suppliers missing INDIVIDUAL_1099/TAX_PAYER_ID after upgrade from 11i, no issues found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIERS_MGD_57');



debug('begin add_signature: 2598343.1_SUPPLIER_EMPLOYEE_NAME_MISMATCH');
   l_info('##MASK##TCA_SYNC_VENDOR_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##VENDOR_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18177',
      p_sig_id                 => '2598343.1_SUPPLIER_EMPLOYEE_NAME_MISMATCH',
...
FROM AP_SUPPLIERS
WHERE VENDOR_NAME<>TCA_SYNC_VENDOR_NAME
AND VENDOR_TYPE_LOOKUP_CODE=''EMPLOYEE''
and vendor_id=##$$VENDOR_ID$$##',
      p_title                  => 'Supplier Name is different from Employee Name',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Supplier Name is different from Employee Name.
The Vendor Name is not as per TCA_SYNC_VENDOR_NAME  in AP_SUPPLIERS table.',
      p_solution               => '<ul>
<li>Please contact Oracle Support Team for a Data fix.</li>
<li>Follow KM - UnableTo Update Employee Type Supplier Name [2598343/KB731553] </li>
<li>Find the Suppliers whose name not synchronized as per Employee name.</li>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: 2598343.1_SUPPLIER_EMPLOYEE_NAME_MISMATCH');



debug('begin add_signature: AP_SUPPLIERS_MGD_69');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10030',
      p_sig_id                 => 'AP_SUPPLIERS_MGD_69',
      p_sig_sql                => 'SELECT /*+ parallel(s) */
          s.vendor_id,
   ...
   AND   s.vendor_id = nvl(##$$VENDOR_ID$$##, s.vendor_id)',
      p_title                  => 'Employee Type Suppliers with NULL employee_id',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Upgraded employee type suppliers with NULL EMPLOYEE_ID.',
      p_solution               => 'Apply the GDF patch following the instructions provided in [1370138/KB277010]',
      p_success_msg            => 'Checked for upgraded employee type suppliers with NULL EMPLOYEE_ID, no issues found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIERS_MGD_69');



debug('begin add_signature: EBS_FIN_AP_APSUP_EMP_ID_WRONG_TYPE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26031',
      p_sig_id                 => 'EBS_FIN_AP_APSUP_EMP_ID_WRONG_TYPE',
      p_sig_sql                => 'SELECT /*+ parallel(s) */
    s.vendor_id,
    s.segment1 supplier_number,
    s.party_id ap_party_id,
...
WHERE pvo.vendor_id = s.vendor_id
    ...
    AND s.vendor_id = NVL(##$$VENDOR_ID$$##, s.vendor_id)
',
      p_title                  => 'Supplier has Employee ID but is Not Setup as Employee Type Supplier',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Supplier has Employee ID but is not setup as Employee Type Supplier.  This can result in errors creating or updating the supplier.',
      p_solution               => 'Log a service request (SR) and upload this analyzer report to obtain the data fix for [2916446/KB236892].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_APSUP_EMP_ID_WRONG_TYPE');



debug('begin add_signature: AP_SUPPLIERS_EMPLOYEE_WRONG_TYPE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11497',
      p_sig_id                 => 'AP_SUPPLIERS_EMPLOYEE_WRONG_TYPE',
      p_sig_sql                => 'SELECT /*+ parallel(s) */
    s.vendor_id,
    s.segment1 supplier_number,
    s.party_id ap_party_id,
...
WHERE pvo.vendor_id = s.vendor_id
    ...
    AND NOT EXISTS (
        ...
        WHERE s.party_id=hps.party_id 
        AND hps.status=''A'')
    AND s.vendor_id = NVL(##$$VENDOR_ID$$##, s.vendor_id)',
      p_title                  => 'Employee Type Suppliers with Wrong Type',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The vendor type for some employee type suppliers is not ''EMPLOYEE'', causing problems in the Supplier pages like Payment Methods.',
      p_solution               => 'Log a service request (SR) and upload this analyzer report to obtain the data fix.  See [1347916/KB316095] for additional information.',
      p_success_msg            => 'Checked for incorrect vendor_type_lookup_code and no issues found',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIERS_EMPLOYEE_WRONG_TYPE');



debug('begin add_signature: AP_SUPPLIERS_MGD_64');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10038',
      p_sig_id                 => 'AP_SUPPLIERS_MGD_64',
      p_sig_sql                => 'SELECT s.vendor_id,
          s.segment1 vendor_number,
          ss.vendor_site_code,
          ss.org_id,
   ...
   AND   s.vendor_id = nvl(##$$VENDOR_ID$$##, s.vendor_id)',
      p_title                  => 'Employee Type Suppliers with party_site_id Populated',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Employee type suppliers with party_site_id populated',
      p_solution               => 'Apply the GDF patch following the instructions provided in [1271086/KB362059]',
      p_success_msg            => 'Checked for Employee type suppliers with party_site_id populated, no issues found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIERS_MGD_64');



debug('begin add_signature: AP_SUPPLIER_MGD_66');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10025',
      p_sig_id                 => 'AP_SUPPLIER_MGD_66',
      p_sig_sql                => 'SELECT s.vendor_id,
          s.segment1 vendor_number,
          ss.vendor_site_code,
          ss.org_id,
   ...
   AND   s.vendor_id = nvl(##$$VENDOR_ID$$##, s.vendor_id)',
      p_title                  => 'Invalid vendor_site_code in AP_SUPPLIER_SITES_ALL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Employee type suppliers with invalid VENDOR_SITE_CODE in AP_SUPPLIER_SITES_ALL after upgrade to R12.',
      p_solution               => 'Apply the GDF patch following the instructions provided in [1329684/KB312691]',
      p_success_msg            => 'Checked for employee type suppliers with invalid VENDOR_SITE_CODE in AP_SUPPLIER_SITES_ALL after upgrade to R12, no issues found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIER_MGD_66');



debug('begin add_signature: AP_SUPPLIERS_MGD_59');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10032',
      p_sig_id                 => 'AP_SUPPLIERS_MGD_59',
      p_sig_sql                => 'SELECT s.vendor_id,
          ss.vendor_site_id,
          ss.vendor_site_code,
   ...
   AND   s.vendor_id = nvl(##$$VENDOR_ID$$##, s.vendor_id)',
      p_title                  => 'Supplier Site Missing service_tolerance_id',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Supplier site missing SERVICE_TOLERANCE_ID after upgrade from 11i.',
      p_solution               => 'Apply the GDF patch following the instructions provided in [1271092/KB381586]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIERS_MGD_59');



debug('begin add_signature: AP_SUPPLIERS_MGD_342');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10027',
      p_sig_id                 => 'AP_SUPPLIERS_MGD_342',
      p_sig_sql                => 'SELECT assa.vendor_id,
          assa.vendor_site_id,
          assa.tolerance_id,
          assa.services_tolerance_id
   FROM ap_supplier_sites_all assa,
        po_vendor_sites_obs pvso
   WHERE assa.vendor_id = nvl(##$$VENDOR_ID$$##, assa.vendor_id)
   ...
   AND   (nvl(assa.tolerance_id, -99) <> nvl(pvso.tolerance_id, -99) OR
      ...
      p_title                  => 'Supplier Sites are Missing tolerance_id or service_tolerance_id',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Upgraded supplier sites which are missing TOLERANCE_ID or SERVICE_TOLERANCE_ID, though the values were populated prior to the upgrade.',
      p_solution               => 'Apply the root cause fix from bug {16568150} prior to upgrading or log a Service Request to obtain the data fix.',
      p_success_msg            => 'Checked for upgraded supplier sites which are missing TOLERANCE_ID or SERVICE_TOLERANCE_ID, though the values were populated prior to the upgrade, no issues found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIERS_MGD_342');



debug('begin add_signature: AP_SUPPLIERS_MGD_68');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10022',
      p_sig_id                 => 'AP_SUPPLIERS_MGD_68',
      p_sig_sql                => 'SELECT s.vendor_id,
          s.segment1 vendor_number,
          ss.vendor_site_id,
          ss.vendor_site_code,
   ...
   AND   s.vendor_id = ss.vendor_id
   AND   s.vendor_id = nvl(##$$VENDOR_ID$$##, s.vendor_id)',
      p_title                  => 'Supplier Sites Inactivated During Upgrade',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Supplier sites were inactivated during the R12 upgrade',
      p_solution               => 'Apply the GDF patch following the instructions provided in [1370307/KB536122]',
      p_success_msg            => 'Checked for Supplier sites inactivated during the R12 upgrade, no issues found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIERS_MGD_68');



debug('begin add_signature: AP_SUPPLIERS_MGD_73');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10018',
      p_sig_id                 => 'AP_SUPPLIERS_MGD_73',
      p_sig_sql                => 'SELECT s.vendor_id,
          ss.vendor_site_code,
          ss.vendor_site_id,
          ss.inactive_date,
   ...
   AND   s.vendor_id = nvl(##$$VENDOR_ID$$##, s.vendor_id)',
      p_title                  => 'End Dated Supplier Sites Incorrectly Causing Party Addresses Inactivated',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'End dated supplier sites incorrectly causing party addresses to be inactivated during R12 upgrade.',
      p_solution               => 'Apply the GDF patch following the instructions provided in [1370311/KB350751]',
      p_success_msg            => 'Checked for end dated supplier sites incorrectly, no issues found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIERS_MGD_73');



debug('begin add_signature: AP_SUPPLIERS_MGD_424');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##BILL_TO_LOCATION_ID'):= ',red,,bold';
   l_info('##STYLE##SHIP_TO_LOCATION_ID'):= ',red,,bold';
  add_signature(
      p_sig_repo_id            => '10026',
      p_sig_id                 => 'AP_SUPPLIERS_MGD_424',
      p_sig_sql                => 'SELECT s.vendor_id,
   ...
   FROM ap_suppliers s,
        po_vendors_obs obs
   WHERE s.vendor_id = nvl(##$$VENDOR_ID$$##, s.vendor_id)
   ...
   AND   (s.ship_to_location_id = obs.ship_to_location_id OR
      ...
      p_title                  => 'Incorrect Defaulting for Bill and Ship to Locations',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Bill and ship to locations are defaulting onto invoices from upgraded suppliers instead of defaulting the values from the financials system parameters.',
      p_solution               => 'Review affected suppliers and log a Service Request to obtain the data fix.',
      p_success_msg            => 'Checked for employee type suppliers with invalid VENDOR_SITE_CODE in AP_SUPPLIER_SITES_ALL after upgrade to R12, no issues found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIERS_MGD_424');



debug('begin add_signature: AP_SUPPLIERS_MGD_429');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10033',
      p_sig_id                 => 'AP_SUPPLIERS_MGD_429',
      p_sig_sql                => 'SELECT assi.vendor_id,
   ...
   WHERE asu.vendor_id = nvl(##$$VENDOR_ID$$##, asu.vendor_id)
   ...
   AND   assi1.location_id = assi.location_id',
      p_title                  => 'Incorrect,  Non-address Type party_site_id Supplier',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Incorrect, non-address type PARTY_SITE_ID assigned to supplier site records.',
      p_solution               => 'Follow the instructions as detailed in [2207141/KB375594].  You will also need to log an SR to request the data fix for the same.',
      p_success_msg            => 'Checked for incorrect, non-address type PARTY_SITE_ID assigned to supplier site records, no issues found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIERS_MGD_429');



debug('begin add_signature: AP_SUPPLIERS_MGD_72');
   l_info('##MASK##ATTRIBUTE%'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10017',
      p_sig_id                 => 'AP_SUPPLIERS_MGD_72',
      p_sig_sql                => 'SELECT hps2.party_id,
   ...
   WHERE (hps2.location_id, hps2.party_id) IN (
    ...
    AND   s.party_id = hps2.party_id
    AND   s.vendor_id = nvl(##$$VENDOR_ID$$##, s.vendor_id)',
      p_title                  => 'Duplicate Addresses Created During the R12 Upgrade',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Duplicate addresses created during the R12 upgrade of supplier sites due to different values in the attribute columns.',
      p_solution               => 'Apply the GDF patch following the instructions provided in [1349757/KB316154]',
      p_success_msg            => 'Checked for NULL characters in supplier data, no issues found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIERS_MGD_72');



debug('begin add_signature: AP_SUPPLIERS_MGD_58');
   l_info('##MASK##PARTY_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10014',
      p_sig_id                 => 'AP_SUPPLIERS_MGD_58',
      p_sig_sql                => 'SELECT hp.party_name,
          sc.title,
          hoc.job_title,
          hoc.org_contact_id
   FROM ap_suppliers s,
        ap_supplier_contacts sc,
        hz_org_contacts hoc,
        hz_parties hp
   WHERE s.vendor_id = nvl(##$$VENDOR_ID$$##, s.vendor_id)
   AND   hp.party_id = s.party_id
   AND   hoc.org_contact_id = sc.org_contact_id
   AND   hp.party_id = sc.per_party_id
   AND   hoc.job_title is null
   AND   sc.title is not null',
      p_title                  => 'Supplier Contacts Missing JOB_TITLE',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Supplier contacts missing JOB_TITLE after upgrade from 11i',
      p_solution               => 'Apply the GDF patch following the instructions provided in [1271092/KB381586]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIERS_MGD_58');



debug('begin add_signature: AP_SUPPLIERS_MGD_65');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##CURRENT_VENDOR_CONTACT_ID'):= ',red,,bold';
  add_signature(
      p_sig_repo_id            => '10020',
      p_sig_id                 => 'AP_SUPPLIERS_MGD_65',
      p_sig_sql                => 'SELECT s.vendor_id,
   ...
   AND   EXISTS (
           ...
           HAVING   count(*) > 1)
   AND   s.vendor_id = nvl(##$$VENDOR_ID$$##, s.vendor_id)',
      p_title                  => 'Duplicate Supplier Contacts After Upgrade',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Duplicate supplier contacts after upgrade to R12.',
      p_solution               => 'Apply the GDF patch following the instructions provided in [1327197/KB732829]',
      p_success_msg            => 'Checked for duplicate supplier contacts after upgrade to R12, no issues found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIERS_MGD_65');



debug('begin add_signature: AP_SUPPLIER_MGD_70');
   l_info('##MASK##REMIT_ADVICE_EMAIL'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##REMIT_ADVICE_FAX'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9881',
      p_sig_id                 => 'AP_SUPPLIER_MGD_70',
      p_sig_sql                => 'SELECT a.ext_payee_id,
          a.payee_party_id,
          a.payment_function,
   ...
   WHERE s.vendor_id = nvl(##$$VENDOR_ID$$##, s.vendor_id)
   AND   a.payee_party_id = s.party_id
   AND   EXISTS (
      ...
      p_title                  => 'Duplicate External Payees in iby_external_payees_all',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Duplicate external payees in IBY_EXTERNAL_PAYEES_ALL. This will result in errors when attempting to view the invoice from the workbench as documented in [2409619/KB755479].',
      p_solution               => 'Apply the GDF patch following the instructions provided in [1315812/KB627688]',
      p_success_msg            => 'No duplicate external payees in IBY_EXTERNAL_PAYEES_ALL.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIER_MGD_70');



debug('begin add_signature: AP_SUPPLIER_MGD_60');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19040',
      p_sig_id                 => 'AP_SUPPLIER_MGD_60',
  ...
  AND a.EXT_PMT_PARTY_ID IN
    (SELECT EXT_PAYEE_ID
    FROM IBY_EXTERNAL_PAYEES_ALL
    WHERE ( payee_party_id = (SELECT a.party_id FROM ap_suppliers a WHERE a.vendor_id = ##$$VENDOR_ID$$##))
...
and (bank_account_num,
          ...
          nvl(ACCOUNT_SUFFIX,''XX'')) IN (
            ...
            GROUP BY bank_account_num, bank_id, branch_id, currency_code,
                     ...
                     account_suffix
            HAVING count(*) > 1)))',
      p_title                  => 'Duplicate bank accounts',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Duplicate bank accounts.<br/><strong>Impact Area(s): </strong>Payment Selection',
      p_solution               => '<strong>Solution GDF: </strong>10144798</br><strong>Note: </strong>[1265353/KB627120]</br><strong>Script Name: </strong>iby_dup_bnkAcct_Sel.sql</br></br>Apply the GDF patch following the instructions provided in [1265353/KB627120]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIER_MGD_60');



debug('begin add_signature: INVALID_BANK_DETAILS_SUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19013',
      p_sig_id                 => 'INVALID_BANK_DETAILS_SUP',
      p_sig_sql                => 'SELECT EXT_BANK_ACCOUNT_ID,
branch_id,
bank_id,
creation_date,
...
last_updated_by
FROM iby_ext_bank_accounts
WHERE (bank_id, branch_id) NOT IN
...
WHERE payee_party_id = (SELECT a.party_id FROM ap_suppliers a WHERE a.vendor_id =  ##$$VENDOR_ID$$##))
      ...
      p_title                  => 'Missing bank_Id or branch_Id in IBY_EXT_BANK_ACCOUNTS ',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Missing bank_Id, branch_Id in IBY_EXT_BANK_ACCOUNTS can cause  error to occur when updating bank account: 
...
',
      p_solution               => 'Please apply the patch referenced in [1320201/KB794167] and log a service request to obtain the data fix to correct the data.',
      p_success_msg            => 'Checked for Missing bank_Id, branch_Id in IBY_EXT_BANK_ACCOUNTS, no issues found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: INVALID_BANK_DETAILS_SUP');



debug('begin add_signature: AP_BYRMAINCO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14846',
      p_sig_id                 => 'AP_BYRMAINCO',
      p_sig_sql                => 'SELECT Adf.Filename, Adfv.Version
    FROM Ad_Files Adf, Ad_File_Versions Adfv
    Where  
    Adf.File_Id = Adfv.File_Id
    And Adf.App_Short_Name = ''POS''
    And Adf.Filename = ''ByrMainCO.class''
    And Adfv.Version in (
    select  "Current Version" from (
          ...
          and af1.filename in (''ByrMainCO.class'') 
          ) 
          where rankUS = 1
     )
    and  
    ((''12.2'' =  Substr(''##$$REL$$##'',1,4) AND
            FND_IREP_LOADER_PRIVATE.compare_versions(
              Adfv.Version,''120.38.12020000.4'') = ''<'' )
              Or
           (''12.1'' = Substr(''##$$REL$$##'',1,4) AND
            Fnd_Irep_Loader_Private.Compare_Versions(
              Adfv.Version,''120.30.12010000.15'') = ''<'' ))',
      p_title                  => 'Error Trying to End Date Supplier Bank Account',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Unable to end date the Supplier Bank Account using the Supplier web page due to NullPointerException at oracle.apps.iby.disbursement.setup.component.server.IbyPayeeSetupAMImpl.init',
      p_solution               => 'Apply patch 20575403 as detailed in [2014140/KB201392].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: AP_BYRMAINCO');



debug('begin add_signature: 5_DEFAULT_PAY_METHOD');
   l_info('##MASK##VENDOR_NAME'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19018',
      p_sig_id                 => '5_DEFAULT_PAY_METHOD',
      p_sig_sql                => 'SELECT SUP.vendor_name SUPPLIER,
      SITE.vendor_site_code SITE,
 ...
 FROM ap_suppliers SUP,
      ...
      ap_supplier_sites_all SITE
WHERE SUP.vendor_id = ##$$VENDOR_ID$$##
and IBEPPM.payment_method_code is null and 
SUP.party_id = IBEP.payee_party_id
...
SELECT SUP.vendor_name SUPPLIER,
 ...
 FROM ap_suppliers SUP,
      ...
      iby_ext_party_pmt_mthds IBEPPM
WHERE SUP.vendor_id = ##$$VENDOR_ID$$##
and IBEPPM.payment_method_code is null
and SUP.party_id = IBEP.payee_party_id
  AND IBEPPM.ext_pmt_party_id = IBEP.ext_payee_id
  AND IBEP.supplier_site_id IS NULL',
      p_title                  => 'Default Payment Method is NULL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Default Payment Method is not populated for Supplier.',
      p_solution               => 'Review the information in [2730277/KB582194] to resolve the issue.
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: 5_DEFAULT_PAY_METHOD');



debug('begin add_signature: AP_SUPPLIERS_MGD_434');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##NEW_VENDOR_CONTACT_ID'):= ',red,,bold';
  add_signature(
      p_sig_repo_id            => '9883',
      p_sig_id                 => 'AP_SUPPLIERS_MGD_434',
      p_sig_sql                => 'SELECT ''IBY'' acct_source,
          ext_bank_account_id,
          bank_id,
          branch_id,
          currency_code,
   ...
   AND   NOT EXISTS (
           ...
           AND   piu.instrument_id = ao.ext_bank_account_id)
   ORDER BY 12, 1',
      p_title                  => 'Orphan Bank Accounts Which Are Not Upgraded and Have No Owners or Assignments',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Please check the list above for orphan bank accounts which are not upgraded and have no owners or payment instrument assignments.
Orphan bank accounts occur because External Bank Account creation is handled in two transactions.
If the second transaction fails, a bank account is created with no assignment.
The users will not be able to recreate the external bank account in the system, or assign it to a user.',
      p_solution               => 'Apply the GDF patch following the instructions provided in [1370214/KB689127]',
      p_success_msg            => 'Checked for orphan bank accounts which are not upgraded and have no owners or payment instrument assignments, no issues found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIERS_MGD_434');



debug('begin add_signature: AP_SUPPLIERS_MGD_71');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10016',
      p_sig_id                 => 'AP_SUPPLIERS_MGD_71',
      p_sig_sql                => 'SELECT ''AP_SELECTED_INVOICES_ALL'' source_table,
          s.vendor_id,
          s.segment1 vendor_number,
          si.vendor_site_id,
          si.vendor_site_code,
   ...
   AND   (ss.address_line1 = chr(0) OR
          ...
          ss.county        = chr(0))
   AND   s.vendor_id = nvl(##$$VENDOR_ID$$##, s.vendor_id)',
      p_title                  => '"Page no longer active" Error When Submitting Payment Batches',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'NULL characters in supplier data causing ''Page no longer active'' errors when submitting payment batches.',
      p_solution               => 'Apply the GDF patch following the instructions provided in [967157/KB244846]',
      p_success_msg            => 'Checked for NULL characters in supplier data, no issues found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIERS_MGD_71');



debug('begin add_signature: AP_SUPPLIERS_MGD_67');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10021',
      p_sig_id                 => 'AP_SUPPLIERS_MGD_67',
      p_sig_sql                => 'SELECT s.vendor_id,
          s.segment1 vendor_number,
          ss.vendor_site_code,
          ss.vendor_site_id,
   ...
   AND   s.vendor_type_lookup_code = ''EMPLOYEE''
   AND   s.vendor_id = nvl(##$$VENDOR_ID$$##, s.vendor_id)',
      p_title                  => 'Employee Type Suppliers With Different Invoice Currency Codes',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Employee type suppliers with different invoice currency codes at supplier and site levels.',
      p_solution               => 'Apply the GDF patch following the instructions provided in [1152626/KB328338]',
      p_success_msg            => 'Checked for employee type suppliers with different invoice currency codes at supplier and site levels, no issues found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIERS_MGD_67');



debug('begin add_signature: AP_SUPPLIERS_MGD_329');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10034',
      p_sig_id                 => 'AP_SUPPLIERS_MGD_329',
      p_sig_sql                => 'SELECT adv.entry_id,
          adv.vendor_id,
          adv.vendor_site_id,
   ...
   AND   (adv.duplicate_vendor_id = nvl(##$$VENDOR_ID$$##, adv.duplicate_vendor_id) OR
         adv.vendor_id = nvl(##$$VENDOR_ID$$##, adv.duplicate_vendor_id))
   AND   EXISTS (
      ...
      p_title                  => 'Employee Type Suppliers Unsuccessfully Merged',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Employee type suppliers which were unsuccessfully merged using the "Copy Site" option.',
      p_solution               => 'Apply the root cause fix as described in [1175023/KB281958] if you have not done so, and log a Service Request to obtain the data fix.',
      p_success_msg            => 'Checked for employee type suppliers which were unsuccessfully merged using the "Copy Site" option, no issues found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIERS_MGD_329');



debug('begin add_signature: AP_SUPPLIERS_MGD_3');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10029',
      p_sig_id                 => 'AP_SUPPLIERS_MGD_3',
      p_sig_sql                => 'WITH invs AS 
  (
     SELECT /*+ materialize */ 
        DISTINCT d.invoice_id
     FROM ap_invoice_distributions_all d
     WHERE d.invoice_id in (select ai2.invoice_id from ap_invoices_all ai2 where ai2.vendor_id = ##$$VENDOR_ID$$##)
   )
   ...
   AND   CASE
         ...
         END = 1
   AND   ai.invoice_id = invs.invoice_id',
      p_title                  => 'Remit to Columns are Incorrect in AP_INVOICES_ALL and AP_PAYMENT_SCHEDULES_ALL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Remit to columns are incorrect in AP_INVOICES_ALL and AP_PAYMENT_SCHEDULES_ALL after supplier merge',
      p_solution               => 'Apply the GDF patch following the instructions provided in [982802/KB422254]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIERS_MGD_3');



debug('begin add_signature: AP_SUPPLIERS_MGD_333');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10036',
      p_sig_id                 => 'AP_SUPPLIERS_MGD_333',
      p_sig_sql                => 'SELECT aps.vendor_id,
          aps.validation_number
   FROM ap_suppliers aps
   WHERE aps.validation_number = 9.99E125
   AND   aps.vendor_id = nvl(##$$VENDOR_ID$$##, aps.vendor_id)',
      p_title                  => 'Error When Updating Supplier Due to VALIDATION_NUMBER Huge Value',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The VALIDATION_NUMBER field in AP_SUPPLIERS is populated with a huge value which is resulting in errors when trying to maintain the supplier and its sites.',
      p_solution               => 'Apply the code fix from [2767434/KB389763] and log a Service Request to obtain the data fix if required. ',
      p_success_msg            => 'Checked if the VALIDATION_NUMBER field in AP_SUPPLIERS is populated with a huge value which can cause errors, no issues found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIERS_MGD_333');



debug('begin add_signature: AP_SUPPLIERS_MGD_56');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('note'):= '982802.1';
  add_signature(
      p_sig_repo_id            => '10015',
      p_sig_id                 => 'AP_SUPPLIERS_MGD_56',
      p_sig_sql                => 'WITH chks as (select * from ap_checks_all ac where ac.vendor_id=##$$VENDOR_ID$$##)
SELECT ac.check_id,
          ac.check_number,
          ac.org_id,
          ac.vendor_id,
...
',
      p_title                  => 'Remit to Columns Incorrect After Supplier Merge',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Remit to columns are incorrect in ap_checks_all and ap_recurring_payments all after supplier merge',
      p_solution               => 'Apply the GDF patch following the instructions provided in [982802/KB422254]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIERS_MGD_56');



debug('begin add_signature: AP_SUPPLIERS_MGD_425');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10040',
      p_sig_id                 => 'AP_SUPPLIERS_MGD_425',
      p_sig_sql                => 'SELECT /*+ parallel(ptp) */
           ptp.party_id,
   ...
   AND   ptp.party_id IN (
           ...
           FROM ap_supplier_sites_all ss
           WHERE ss.vendor_id = nvl(##$$VENDOR_ID$$##, ss.vendor_id))',
      p_title                  => 'Invoices Cannot be Validated',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invoices cannot be validated due to errors in ZX_TDS_CALC_SERVICES_PUB_PKG.PRORATE_IMPORTED_SUM_TAX_LINES due to incorrect values in ZX_PARTY_TAX_PROFILE.ROUNDING_RULE_CODE',
      p_solution               => 'Generate the Invoice and EBTax Analyzer [1529429/KB539416] for the problem invoice and the Supplier Analyzer [2380650/KB541471] for the related supplier.  Upload the outputs and log a Service Request to obtain a data fix.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIERS_MGD_425');



debug('begin add_signature: AP_SUPPLIERS_MGD_426');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('#IMPACT_AREAS#'):= 'Invoice Approval, Supplier';
   l_info('bug_number'):= '25261610';
   l_info('category'):= 'INVOICE';
   l_info('gdf_flag'):= 'Y';
   l_info('note_number'):= '26611971.1';
   l_info('problem'):= 'Invoices cannot be validated due to errors in ZX_TDS_CALC_SERVICES_PUB_PKG.PRORATE_IMPORTED_SUM_TAX_LINES due to incorrect values in ZX_PARTY_TAX_PROFILE.ROUNDING_RULE_CODE';
   l_info('script_name'):= 'ap_incorr_ptp_rounding_rule_sel.sql';
   l_info('solution'):= 'Apply the GDF patch following the instructions provided in Doc ID 2661197.1';
   l_info('undo_flag'):= 'N';
  add_signature(
      p_sig_repo_id            => '10041',
      p_sig_id                 => 'AP_SUPPLIERS_MGD_426',
      p_sig_sql                => 'SELECT ptp.party_id,
          ptp.party_tax_profile_id,
          ptp.party_type_code,
          ptp.supplier_flag,
          ptp.site_flag,
          ptp.rounding_rule_code
   FROM (select * from ap_invoices_all ai2 where ai2.vendor_id=##$$VENDOR_ID$$##
        ) invs,
        ap_invoices_all ai,
        ap_supplier_sites_all ss,
   ...
   AND   ptp.party_id = ss.party_site_id',
      p_title                  => 'Invoices Cannot be Validated due to Incorrect Values in ZX_PARTY_TAX_PROFILE.ROUNDING_RULE_CODE',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invoices cannot be validated due to errors in ZX_TDS_CALC_SERVICES_PUB_PKG.PRORATE_IMPORTED_SUM_TAX_LINES due to incorrect values in ZX_PARTY_TAX_PROFILE.ROUNDING_RULE_CODE',
      p_solution               => '<strong>Solution GDF: </strong>25261610</br><strong>Note: </strong>[2661197/KB674589]</br><strong>Script Name: </strong>ap_incorr_ptp_rounding_rule_sel.sql Invoice</br></br>Apply the GDF patch following the instructions provided in [2661197/KB674589]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIERS_MGD_426');



debug('begin add_signature: 8_AUTO_TAX_CALC_NO_SUP');
   l_info('##MASK##VENDOR_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19008',
      p_sig_id                 => '8_AUTO_TAX_CALC_NO_SUP',
      p_sig_sql                => 'SELECT DISTINCT APS.VENDOR_NAME, APS.VENDOR_ID, APSS.VENDOR_SITE_CODE, APSS.VENDOR_SITE_ID, APSS.AUTO_TAX_CALC_FLAG
FROM AP_SUPPLIER_SITES_ALL APSS, AP_SUPPLIERS APS, AP_INVOICES_ALL AIA
...
and aps.vendor_id=##$$VENDOR_ID$$##',
      p_title                  => 'Suppliers having Tax not calculated',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Employee specific automatic tax calculation can not be done.',
      p_solution               => 'Tax not calculating for the following supplier with supplier type EMPLOYEE because AUTO_TAX_CALC_FLAG is NO at supplier site level. <br>Please follow the Section 14 of [1316316/KB731274] - and apply the Datafix to correct the issue.</BR>
If you want to enable AUTO_TAX_CALC_FLAG to Y for specific supplier you need to pass the vendor_id in the Update statement.',
      p_success_msg            => 'AUTO_TAX_CALC_FLAG is set properly at supplier site level.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: 8_AUTO_TAX_CALC_NO_SUP');



debug('begin add_signature: 3_MISMATCH_AWT_SITE');
   l_info('##MASK##VENDOR_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2782',
      p_sig_id                 => '3_MISMATCH_AWT_SITE',
      p_sig_sql                => 'SELECT pv.vendor_id,
     pv.vendor_name,
     pvs.vendor_site_id,
...
AND NVL(supp.allow_awt_flag,''N'') = ''N''
and supp.vendor_id=##$$VENDOR_ID$$##',
      p_title                  => 'Retrieve the cases when system disabled the AWT on the Supplier Site during R12 Upgrade',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Since AWT was disabled on the Supplier entity system disabled the AWT on the Supplier Site during R12 Upgrade.',
      p_solution               => 'Go through [1914173/KB534927] and log a Service Request to get the Datafix.',
      p_success_msg            => 'AWT is not disabled during Upgrade at Supplier Site Level.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: 3_MISMATCH_AWT_SITE');



debug('begin add_signature: AP_SUPPIERS_MERGED_DATA_FIX');
   l_info('##MASK##VENDOR_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9889',
      p_sig_id                 => 'AP_SUPPIERS_MERGED_DATA_FIX',
      p_sig_sql                => 'SELECT distinct pov.vendor_name,
 		      vs.vendor_site_code,
 		      vs.org_id
 	       ...
 	       WHERE  ga.po_header_id = pgoa.po_header_id
 		      AND GA.vendor_id = ##$$VENDOR_ID$$##
 		      AND GA.vendor_id =pov.vendor_id
 		      AND VS.vendor_id =pov.vendor_id
 		      AND Nvl(ga.global_agreement_flag, ''N'') = ''Y''
 		      AND vs.vendor_site_id = pgoa.vendor_site_id
 		      AND VS.org_id = pgoa.organization_id',
      p_title                  => 'Supplier merged data fix ',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Supplier and/or Site cannot be merged',
      p_solution               => 'Please follow the steps from the note  [2017875/KB761991]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPIERS_MERGED_DATA_FIX');



debug('begin add_signature: BANK_ACCOUNT_ALT_NAME_UPGRADE_SEL_SUP');
   l_info('##MASK##ACCOUNT_HOLDER_NAME_ALT'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##BANK_ACCOUNT_NAME_ALT'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##BANK_ACCOUNT_NAME_ALT_NEW'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##MASKED_BANK_ACCOUNT_NUM'):= 'DISPLAY_LAST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19012',
      p_sig_id                 => 'BANK_ACCOUNT_ALT_NAME_UPGRADE_SEL_SUP',
      p_sig_sql                => '	SELECT eba.ext_bank_account_id,
  eba.bank_id,
  eba.branch_id,
...
OR ba.account_holder_name_alt   IS NOT NULL)
and eba.ext_bank_account_id in (
SELECT ext_bank_account_id
FROM IBY_ACCOUNT_OWNERS
WHERE ext_bank_account_id IN
  (SELECT DISTINCT a.instrument_id
  ...
  WHERE a.instrument_type   = ''BANKACCOUNT''
  AND a.EXT_PMT_PARTY_ID IN
    (SELECT EXT_PAYEE_ID FROM IBY_EXTERNAL_PAYEES_ALL WHERE payee_party_id = 
(SELECT a.party_id FROM ap_suppliers a WHERE a.vendor_id =  ##$$VENDOR_ID$$##))
    ))
',
      p_title                  => 'Bank Account Alternate Name Missing in R12',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Bank account alternate name missing in r12 for upgraded bank accounts.
Alternate Bank Account name is not updated in r12 for upgraded bank accounts.
There is no Alternate bank account name in the Payment Extract for upgraded bank account having alternate Bank account name in 11i.
Bank account alternate name should be fetched for 11i alternate bank account name and 11i alternate account owner name when the prior is not available',
      p_solution               => 'See [1466998/KB367314] and follow the action plan provided in Issue Description #1.',
      p_success_msg            => 'All upgraded Bank Accounts have Alternate Name.<br>
Reference: [1466998/KB367314] Issue Description #1.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: BANK_ACCOUNT_ALT_NAME_UPGRADE_SEL_SUP');



debug('begin add_signature: EBS_FIN_AP_APSUP_CANNOT_DISPLAY_PAGE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26422',
      p_sig_id                 => 'EBS_FIN_AP_APSUP_CANNOT_DISPLAY_PAGE',
      p_sig_sql                => 'select
  ...
  ORDER BY "PROFILE"
  ',
      p_title                  => 'Cannot Display Page Error',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'When trying to open a supplier page for an update, you get the following error:

Cannot Display Page: You cannot complete this task because you access this page using browser’s navigation buttons',
      p_solution               => 'Follow the instructions in [2236517/KB303631] to help resolve the issue.
 ',
      p_success_msg            => 'Its OK',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_APSUP_CANNOT_DISPLAY_PAGE');



debug('begin add_signature: EBS_FIN_AP_APSUP_LIST_OF_UNPAID_INVOICES_WITH_EXPIRED_RELATIONSHIP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28050',
      p_sig_id                 => 'EBS_FIN_AP_APSUP_LIST_OF_UNPAID_INVOICES_WITH_EXPIRED_RELATIONSHIP',
      p_sig_sql                => 'select aia.invoice_id,aia.INVOICE_NUM, aia.payment_status_flag, aia.relationship_id
from ap_invoices_all aia, ap_suppliers aps
where aia.vendor_id = aps.vendor_id(+)
and aia.payment_status_flag = ''N''
and aps.vendor_id=##$$VENDOR_ID$$##
and aia.relationship_id in (
   select iepr.relationship_id from iby_ext_payee_relationships iepr
   where iepr.active = ''N''
                       )',
      p_title                  => 'Unpaid Invoices Having  Relationship Expired',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'List all unpaid invoices having the relationship expired ',
      p_solution               => 'Follow the instruction in [2978112/KB711010]',
      p_success_msg            => 'OK',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_APSUP_LIST_OF_UNPAID_INVOICES_WITH_EXPIRED_RELATIONSHIP');



debug('begin add_signature: EBS_FIN_AP_APSUP_NO_COUNTRY_CODE');
   l_info('##MASK##%HASH_'):= 'REMOVE_COLUMN';
   l_info('##MASK##ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##BANK_ACCOUNT_NUM%'):= 'DISPLAY_LAST_4_CHAR';
   l_info('##MASK##CONTACT%'):= 'DISPLAY_FIRST_25_PCNT';
  ...
  add_signature(
      p_sig_repo_id            => '29455',
      p_sig_id                 => 'EBS_FIN_AP_APSUP_NO_COUNTRY_CODE',
      p_sig_sql                => 'SELECT *
FROM IBY_EXT_BANK_ACCOUNTS
WHERE country_code is null and 
ext_bank_account_id IN
  ( SELECT DISTINCT a.instrument_id
  FROM iby_pmt_instr_uses_all a
  WHERE a.payment_flow    = ''DISBURSEMENTS''
  AND a.instrument_type   = ''BANKACCOUNT''
...
ORDER BY ext_bank_account_id',
      p_title                  => 'Supplier Bank Account has No Country Code',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Supplier Bank Account has No Country Code which can cause java.lang.NullPointerException error when trying to update.',
      p_solution               => 'Please log an SR to request the data fix for [2325131/KB202021]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_APSUP_NO_COUNTRY_CODE');



debug('begin add_signature: EBS_FIN_AP_APSUP_STALE_DATA_ERROR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29709',
      p_sig_id                 => 'EBS_FIN_AP_APSUP_STALE_DATA_ERROR',
      p_sig_sql                => 'SELECT EXT_BANK_ACCOUNT_ID, BANK_ID, BRANCH_ID, CREATION_DATE
FROM IBY_EXT_BANK_ACCOUNTS i
where bank_id is not null
and branch_id is not null
and (bank_id, branch_id) not in (select a.bank_party_id, a.branch_party_id from iby_ext_bank_branches_v a)
and branch_id  not in (select b.subject_id
from hz_relationships b
where b.subject_table_name = ''HZ_PARTIES''
and b.object_table_name = ''HZ_PARTIES''
and b.relationship_code = ''BRANCH_OF''
and object_type = ''ORGANIZATION''
and b.object_id = i.bank_id)
AND  i.ext_bank_account_id IN
  ( SELECT DISTINCT a.instrument_id
  FROM iby_pmt_instr_uses_all a
  WHERE a.payment_flow    = ''DISBURSEMENTS''
  AND a.instrument_type   = ''BANKACCOUNT''
...
ORDER BY ext_bank_account_id
',
      p_title                  => 'BRANCH_ID in IBY_EXT_BANK_ACCOUNTS is not a valid branch ',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The BRANCH_ID in IBY_EXT_BANK_ACCOUNTS is not a valid branch for the BANK_ID specified.  This can cause a Stale Data Error when updating Supplier Bank Account information.',
      p_solution               => 'Please log an SR with Oracle Support to request a data fix for [2883412/KB791233].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_APSUP_STALE_DATA_ERROR');



debug('begin add_signature: EBS_FIN_AP_APSUP_INCORRECT_SITE_PARTY_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30895',
      p_sig_id                 => 'EBS_FIN_AP_APSUP_INCORRECT_SITE_PARTY_ID',
      p_sig_sql                => 'SELECT SUP.vendor_id, SITE.vendor_site_id, SITE.vendor_site_code, SITE.party_site_id SITE_PTY_SITE_ID,
       ADDR.party_site_id ADDR_PTY_SITE_ID, SUP.party_id SUP_PARTY_ID, ADDR.party_id ADDR_PARTY_ID
  FROM ap_suppliers SUP, ap_supplier_sites_all SITE, hz_party_sites ADDR
 WHERE SUP.vendor_id = SITE.vendor_id
   AND SITE.party_site_id = ADDR.party_site_id
   AND ADDR.party_id <> SUP.party_id
   AND SUP.vendor_id = (##$$VENDOR_ID$$##)',
      p_title                  => 'Supplier with Sites that have an Incorrect Party ID',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Active supplier site is not present in the Address Book page of the Supplier form',
      p_solution               => 'Please log a service request with Oracle Support to request a data fox for the issue described in [3065729/KB302354]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_APSUP_INCORRECT_SITE_PARTY_ID');



debug('begin add_signature: AP_OPEN_INTERFACE_OU_MODE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14475',
      p_sig_id                 => 'AP_OPEN_INTERFACE_OU_MODE',
      p_sig_sql                => 'SELECT
    fcp.application_id,
...
WHERE
    fcp.concurrent_program_name IN (''APXIIMPT'')
    AND fcp.executable_application_id = fe.application_id
    AND fcp.executable_id = fe.executable_id
    AND fcp.multi_org_category = ''S''
ORDER BY
    concurrent_program_name',
      p_title                  => 'Payables Open Interface Import in Single Operating Unit Mode',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The Payables Open Interface Import program is showing no parameter in operating unit LOV.',
      p_solution               => 'Configure the concurrent program to use multiple operating unit mode following the instructions in [947303/KB762827].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AP_OPEN_INTERFACE_OU_MODE');
...
debug('begin add_signature: AP_SUPPLIERS_PROFILE_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10220',
      p_sig_id                 => 'AP_SUPPLIERS_PROFILE_OPTIONS',
      p_sig_sql                => 'SELECT tl.Application_name, b.application_short_name,
b.application_id "##$$FK3$$##",
b.product_code "##$$FK4$$##"
FROM fnd_application_tl tl, fnd_application b
WHERE b.application_id in (200,177)
AND tl.application_id = b.application_id
AND tl.language = ''US''',
      p_title                  => 'Payables Profile Options',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Payables profile options',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AP_SUPPLIERS_PROFILE_OPTIONS');



debug('begin add_signature: EBS_ATG_GEN_FND_APPLWRK');
   l_info('##MASK##LEVEL VALUE'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31912',
      p_sig_id                 => 'EBS_ATG_GEN_FND_APPLWRK',
      p_sig_sql                => 'SELECT user_profile_option_name "Profile Option",
             a.profile_option_value "Profile Value",
             DECODE(a.level_id, 10001, ''Site'',
                                10002, ''Application'',
...
d.user_id, c.responsibility_id
      FROM fnd_profile_option_values a,
           ...
           fnd_profile_options e,
           fnd_profile_options_tl t
      WHERE e.profile_option_name = ''APPLWRK'' 
        AND a.profile_option_id  = e.profile_option_id
        AND a.level_value          = b.application_id(+)
        AND a.level_value          = c.responsibility_id(+)
        AND a.level_value          = d.user_id(+)
        ...
        AND nvl(c.LANGUAGE,''US'') = ''US''
     ORDER BY e.profile_option_name',
      p_title                  => 'FND: Override Directory(APPLWRK)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Profile Value "FND: Override Directory" (APPLWRK) current value.',
      p_solution               => 'The current value of profile Option "FND: Override Directory" (APPLWRK) indicates you may be using custom forms or reports executables (Like the Invoice Workbench or Payment Workbench).  Please reset this profile option to its standard value (No value/ Empty) at All levels and retest.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_ATG_GEN_FND_APPLWRK');
...
BEGIN
  ...
  analyzer_title := 'Payables Supplier Analyzer';
...
start_section('Proactive Recommendations', 'Proactive_Recommendations');
   set_item_result(check_rec_patches_1); /* Signature AP_SUPPLIER_REC_PATCHES */
   set_item_result(run_stored_sig('AP_INVALIDS'));
   set_item_result(run_stored_sig('AP_SUPPLIER_MGD_74'));
   set_item_result(run_stored_sig('EBS_FIN_AP_INV_SEQUENCES'));
end_section;
debug('end section: Proactive_Recommendations');

debug('begin section: SYSTEM_PARAMETERS');
start_section('System Parameters', 'SYSTEM_PARAMETERS');
   set_item_result(run_stored_sig('SUP_AP_SYSTEM_PARAMETERS_ALL'));
   set_item_result(run_stored_sig('SUP_FINANCIAL_OPTIONS'));
end_section;
debug('end section: SYSTEM_PARAMETERS');

debug('begin section: SUPPLIER_TABLE_INFORMATION');
start_section('Supplier Tables Information', 'SUPPLIER_TABLE_INFORMATION');
   set_item_result(run_stored_sig('AP_SUPPLIERS'));
   set_item_result(run_stored_sig('AP_SUPPLIER_SITES_ALL'));
   set_item_result(run_stored_sig('AP_SUPPLIERS_INT'));
   set_item_result(run_stored_sig('AP_SUPPLIER_SITES_INT'));
   set_item_result(run_stored_sig('PO_VENDORS_OBS_11I'));
   set_item_result(run_stored_sig('AP_SUPPLIER_SITE_TABLE_MIGRATED'));
   set_item_result(run_stored_sig('AP_SUPPLIERS_MERGED_INFORMATION'));
   set_item_result(run_stored_sig('7_DUP_INVOICE_SUPPLIER_MERGE_SUP'));
   set_item_result(run_stored_sig('SUPPLIER_CONTACTS_HZ_PARTIES'));
   set_item_result(run_stored_sig('AP_SUPPLIER_CONTACTS'));
   set_item_result(run_stored_sig('HZ_CONTACT_POINTS_TABLE'));
   set_item_result(run_stored_sig('EBS_FIN_AP_APSUP_UPDATE_TAXPEYERID'));
   set_item_result(run_stored_sig('EBS_FIN_AP_INV_SUPP_ADDR_INVALID'));
end_section;
debug('end section: SUPPLIER_TABLE_INFORMATION');

debug('begin section: HR_SUPPLIER');
start_section('HR and Employee Information Tables Information', 'HR_SUPPLIER');
   set_item_result(run_stored_sig('SUPPLIER_PER_ALL_PEOPLE_F'));
   set_item_result(run_stored_sig('SUPPLIER_EMPLOYEE_PER_ADDRESS'));
   set_item_result(run_stored_sig('SUPPLIER_EMP_PER_ALL_ASSIGN_F'));
   set_item_result(run_stored_sig('AP_SUPPLIER_HR_LOCATIONS_ALL_LOCATIONS'));
   set_item_result(run_stored_sig('EBS_FIN_AP_DUPLICATE_SUPPLIERS_WITH_SAME_EMPLOYEE_ID'));
end_section;
debug('end section: HR_SUPPLIER');

debug('begin section: IBY_SUPPLIER');
start_section('IBY Tables Information', 'IBY_SUPPLIER');
   set_item_result(run_stored_sig('EBS_FIN_AP_IBY_APSUP_BANK_ASSIGN'));
   set_item_result(run_stored_sig('IBY_EXT_PARTY_PMT_MTHDS_TABLE'));
   set_item_result(run_stored_sig('IBY_PMT_INSTR_USES_ALL_TABLE'));
   set_item_result(run_stored_sig('IBY_EXT_BANK_ACCOUNTS_TABLE'));
   set_item_result(run_stored_sig('IBY_EXTERNAL_PAYEES_ALL_TABLE'));
   set_item_result(run_stored_sig('IBY_EXT_PAYEE_RELATIONSHIPS'));
   set_item_result(run_stored_sig('IBY_ACCOUNT_OWNERS_TABLE'));
end_section;
debug('end section: IBY_SUPPLIER');

debug('begin section: HZ_SUPPLIER');
start_section('HZ Tables Information', 'HZ_SUPPLIER');
   set_item_result(run_stored_sig('HZ_PARTIES_TABLE'));
   set_item_result(run_stored_sig('HZ_PARTY_SITES_TABLE'));
   set_item_result(run_stored_sig('HZ_PARTY_SITE_USES_TABLE'));
   set_item_result(run_stored_sig('HZ_PARTY_USG_ASSIGNMENTS_TABLE'));
   set_item_result(run_stored_sig('HZ_ORGANIZATION_PROFILES_TABLE'));
   set_item_result(run_stored_sig('HZ_CONTACT_POINTS_TABLE'));
   set_item_result(run_stored_sig('HZ_RELATIONSHIPS_TABLE'));
   set_item_result(run_stored_sig('HZ_LOCATIONS_TABLE'));
   set_item_result(run_stored_sig('EBS_FIN_AP_APSUP_DUP_ADDR1'));
   set_item_result(run_stored_sig('EBS_FIN_AP_APSUP_DUP_ADDR2'));
end_section;
debug('end section: HZ_SUPPLIER');

debug('begin section: SUPPLIER_ERROR');
start_section('Data Corruptions', 'SUPPLIER_ERROR');
   set_item_result(run_stored_sig('EBS_FIN_AP_APSUP_NOT_ENABLED'));
   set_item_result(run_stored_sig('EBS_FIN_AP_APSUP_END_DATE_NULL'));
   set_item_result(run_stored_sig('EBS_FIN_AP_APSUP_SUPPLIER_STEALE_DATA_FOR_EX_EMPLOYEE'));
   set_item_result(run_stored_sig('AP_SUPPLIER_SITE_MERGED_INACTIVE_DATE_SUP'));
   set_item_result(run_stored_sig('AP__SUPPLIERS_MGD_63'));
   set_item_result(run_stored_sig('AP_SUPPLIERS_MGD_353'));
   set_item_result(run_stored_sig('AP_SUPPLIERS_MGD_427'));
   set_item_result(run_stored_sig('AP_SUPPLIERS_MGD_57'));
   set_item_result(run_stored_sig('2598343.1_SUPPLIER_EMPLOYEE_NAME_MISMATCH'));
   set_item_result(run_stored_sig('AP_SUPPLIERS_MGD_69'));
   set_item_result(run_stored_sig('EBS_FIN_AP_APSUP_EMP_ID_WRONG_TYPE'));
   set_item_result(run_stored_sig('AP_SUPPLIERS_EMPLOYEE_WRONG_TYPE'));
   set_item_result(run_stored_sig('AP_SUPPLIERS_MGD_64'));
   set_item_result(run_stored_sig('AP_SUPPLIER_MGD_66'));
   set_item_result(run_stored_sig('AP_SUPPLIERS_MGD_59'));
   set_item_result(run_stored_sig('AP_SUPPLIERS_MGD_342'));
   set_item_result(run_stored_sig('AP_SUPPLIERS_MGD_68'));
   set_item_result(run_stored_sig('AP_SUPPLIERS_MGD_73'));
   set_item_result(run_stored_sig('AP_SUPPLIERS_MGD_424'));
   set_item_result(run_stored_sig('AP_SUPPLIERS_MGD_429'));
   set_item_result(run_stored_sig('AP_SUPPLIERS_MGD_72'));
   set_item_result(run_stored_sig('AP_SUPPLIERS_MGD_58'));
   set_item_result(run_stored_sig('AP_SUPPLIERS_MGD_65'));
   set_item_result(run_stored_sig('AP_SUPPLIER_MGD_70'));
   set_item_result(run_stored_sig('AP_SUPPLIER_MGD_60'));
   set_item_result(run_stored_sig('INVALID_BANK_DETAILS_SUP'));
   set_item_result(run_stored_sig('AP_BYRMAINCO'));
   set_item_result(run_stored_sig('5_DEFAULT_PAY_METHOD'));
   set_item_result(run_stored_sig('AP_SUPPLIERS_MGD_434'));
   set_item_result(run_stored_sig('AP_SUPPLIERS_MGD_71'));
   set_item_result(run_stored_sig('AP_SUPPLIERS_MGD_67'));
   set_item_result(run_stored_sig('AP_SUPPLIERS_MGD_329'));
   set_item_result(run_stored_sig('AP_SUPPLIERS_MGD_333'));
   set_item_result(run_stored_sig('AP_SUPPLIERS_MGD_3'));
   set_item_result(run_stored_sig('AP_SUPPLIERS_MGD_56'));
   set_item_result(run_stored_sig('AP_SUPPLIERS_MGD_425'));
   set_item_result(run_stored_sig('AP_SUPPLIERS_MGD_426'));
   set_item_result(run_stored_sig('8_AUTO_TAX_CALC_NO_SUP'));
   set_item_result(run_stored_sig('3_MISMATCH_AWT_SITE'));
   set_item_result(run_stored_sig('AP_SUPPIERS_MERGED_DATA_FIX'));
   set_item_result(run_stored_sig('BANK_ACCOUNT_ALT_NAME_UPGRADE_SEL_SUP'));
   set_item_result(run_stored_sig('EBS_FIN_AP_APSUP_CANNOT_DISPLAY_PAGE'));
   set_item_result(run_stored_sig('EBS_FIN_AP_APSUP_LIST_OF_UNPAID_INVOICES_WITH_EXPIRED_RELATIONSHIP'));
   set_item_result(run_stored_sig('EBS_FIN_AP_APSUP_NO_COUNTRY_CODE'));
   set_item_result(run_stored_sig('EBS_FIN_AP_APSUP_STALE_DATA_ERROR'));
   set_item_result(run_stored_sig('EBS_FIN_AP_APSUP_INCORRECT_SITE_PARTY_ID'));
end_section;
debug('end section: SUPPLIER_ERROR');

debug('begin section: SUPPLIER_IMPORT');
IF 1=2 THEN
   start_section('Supplier Import', 'SUPPLIER_IMPORT');
      set_item_result(run_stored_sig('AP_OPEN_INTERFACE_OU_MODE'));
   end_section;
END IF;
debug('end section: SUPPLIER_IMPORT');

debug('begin section: AppsCheck');
IF nvl(p_include_apps_check, 'Y') = 'Y' THEN
   start_section('Apps Check', 'AppsCheck');
      set_item_result(run_stored_sig('IBY_AC_FILE_VERSIONS'));
      set_item_result(run_stored_sig('AP_SUPPLIERS_PROFILE_OPTIONS'));
      set_item_result(run_stored_sig('EBS_ATG_GEN_FND_APPLWRK'));
