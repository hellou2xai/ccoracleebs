...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Project Foundation Analyzer            |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE pa_pjf_foundation_analyzer_pkg AUTHID DEFINER AS
...
(            p_org_id                       IN NUMBER      DEFAULT NULL
           ...
           ,p_max_output_rows              IN NUMBER      DEFAULT 250
...
END pa_pjf_foundation_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY pa_pjf_foundation_analyzer_pkg AS
-- $Id: pa_pjf_foundation_analyzer.sql, 200.7 2026/02/25 21:43:44 aliclin Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(3035961.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'PAPJF_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'PAPJF_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>PAPJF Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=3035961.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/pa_pjc_fdn_latest_ver.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,10070,EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,10070,EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},10070,EBS,EBS Financials,EBS - Projects" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/mosc/discussion/4569048" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">10070</span>
...
<p><strong><u>Version 200.7</u></strong></p><ol><li>Sigs updated with new article IDs.</li>
</ol>
<p><strong><u>Version 200.6</u></strong></p><ol><li>Template enhancement: EBS KB Article IDs Shown for Signature KM Links.</li>
<li>Sigs updated with new article IDs.</li>
</ol>
<p><strong><u>Version 200.5</u></strong></p><ol><li>5 Sigs enhanced.<br>
&nbsp;</li>
<li>New Analyzer Framework version 4.8.3 released with enhancements.<br>
a. Km notes links from analyzer output in cmos<br>
b. Change Thumbs up, Thumbs Down and Idea to point to Automation Factory page<br>
c. EBSAF-404 - Remove Contact Us section from Analyzer footer</li>
</ol>
<p><strong><u>Version 200.4</u></strong></p><ol><li>New Analyzer Framework version 4.7.3 released with enhancements.<br>
a. SQL*Plus Error fixed: SP2-0027: Input is too long<br>
b. Ability to click to select rows in output tables<br>
&nbsp;</li>
<li>Several signatures enhanced.</li>
</ol>
<p><strong><u>Version 200.3</u></strong></p><ul><li>Numerous signatures modified</li>
</ul>
<p><strong><u>Version 200.2</u></strong></p><ul><li>Two new signatures added</li>
</ul>
<p><strong><u>Version 200.1</u></strong></p><p>This analyzer will validate project configuration and basic setup data required for implementing Projects. &nbsp;It gathers security and access related configuration data, identifies data issues, and provides solutions for resolving known miscellaneous issues/errors. &nbsp;</p>
            <br><br>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,10070,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,10070,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},10070,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Projects" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
l_responsibilty_name            VARCHAR2(255);
...
debug('begin populate parameters hash table');
   ...
   g_parameters(g_parameters.LAST).pvalue := mask_text(NVL(p_project_id, -1)||' - '||nvl(l_project_number, 'No Project Selected'),'NO_MASK');
   g_parameters.extend();
   ...
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Responsibility ID / Name';
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/02/25 21:43:43 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'pa_pjf_foundation_analyzer.sql';
...
INTO l_exists_val
FROM HR_OPERATING_UNITS U, PA_IMPLEMENTATIONS_ALL PAIA
WHERE U.ORGANIZATION_ID = p_org_id
 AND (mo_global.is_mo_init_done = 'N' or mo_global.check_access(U.ORGANIZATION_ID) = 'Y')
AND paia.org_id =  U.ORGANIZATION_ID
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Error:  No operating unit organization ID specified.  The org_id parameter is mandatory.');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
BEGIN
SELECT NVL(P.PROJECT_ID,-1)
INTO l_exists_val
FROM PA_PROJECTS_ALL P,  HR_ORGANIZATION_UNITS HR
WHERE NVL(P.PROJECT_ID,-1) = p_project_id
 AND P.org_id = HR.ORGANIZATION_ID
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Project Number / Project ID
The Project Number / Project ID parameter is mandatory.  Please enter a valid one.');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
BEGIN
SELECT NVL(RESP.RESPONSIBILITY_ID,-1)
INTO l_exists_val
FROM FND_RESPONSIBILITY_VL RESP, FND_USER_RESP_GROUPS RG
WHERE NVL(RESP.RESPONSIBILITY_ID,-1) = p_resp_id
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Error:  Invalid Responsibility Name.');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
g_resp_id       := p_resp_id;
--g_project_number := NVL(l_project_number, '-1');

-- Get Org ID and LEDGER ID

   BEGIN
    select paia.set_of_books_id, paia.org_id
      into g_ledger_id, g_org_id
    from pa_implementations_all paia, hr_operating_units hr
    where paia.org_id  = p_org_id
    and   paia.org_id = hr.organization_id;

   EXCEPTION
   WHEN NO_DATA_FOUND then
     print_log('ORG_ID does not exist.');
...
-- for RESPONSIBILITY Name  
BEGIN
     SELECT RESPONSIBILITY_NAME INTO l_responsibilty_name
...
debug('begin add_signature: EBS_FIN_PA_MULTI_ORG_CATEGORY');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##Operating_Unit_Mode'):= ',#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '28559',
      p_sig_id                 => 'EBS_FIN_PA_MULTI_ORG_CATEGORY',
      p_sig_sql                => 'SELECT
    CP.concurrent_program_name,
     CP.user_concurrent_program_name,
    decode (CP.multi_org_category , ''S'', ''Single'', ''M'', ''Multiple'', ''Null'') "Operating_Unit_Mode"
...
''PAXUPACC'',
''PAFPUPG'')
AND CP.multi_org_category <> ''S''
    order by 2',
      p_title                  => 'Project Concurrent Programs Multi-Org Category Is Not Single',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Oracle Projects concurrent programs exist that are not set with multi_org_ category = S (Single).  Concurrent programs may fail with REP-1419, REP-57054, REP-0069 or SQL-2112 errors.',
      p_solution               => 'Follow the solution in [436069/PALRT1707] Oracle Projects Concurrent Programs Fail With REP-1419, REP-57054, REP-0069 or SQL-2112 .',
      p_success_msg            => 'All Projects concurrent programs are set with multi_org_ category = S (Single).',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_MULTI_ORG_CATEGORY');



debug('begin add_signature: EBS_FIN_PA_INVALID_OBJECTS_AFTER_19C_UPGRADE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28713',
      p_sig_id                 => 'EBS_FIN_PA_INVALID_OBJECTS_AFTER_19C_UPGRADE',
      p_sig_sql                => 'select do.Object_name, do.object_type, do.status, de.text  from dba_objects do, dba_errors de where do.object_name = de.name
and status = ''INVALID'' and (object_name like ''PA%'' or object_name like ''GMS%'')
and upper(de.text) like upper(''%PL/SQL: ORA-04098: trigger%''''APPS.PA_TRANSACTION_INTERFACE_T4''''%is invalid and failed re-validation%'')
',
      p_title                  => 'DBA After 19c Upgrade - Trigger APPS.PA_TRANSACTION_INTERFACE_T4 is Invalid',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The fix for the following issue has not been applied: [2942075/KB721705]
PA and GMS Invalid Objects After 19c Database Upgrade - PL/SQL ORA-04098 Trigger APPS.PA_TRANSACTION_INTERFACE_T4 is Invalid and Failed Re-validation.',
      p_solution               => 'Review the solution in [2942075/KB721705] PA and GMS Invalid Objects After 19c Database Upgrade - PL/SQL ORA-04098 Trigger APPS.PA_TRANSACTION_INTERFACE_T4 is Invalid and Failed Re-validation.',
      p_success_msg            => 'The fix for the following issue has been applied: [2942075/KB721705]
PA and GMS Invalid Objects After 19c Database Upgrade - PL/SQL ORA-04098 Trigger APPS.PA_TRANSACTION_INTERFACE_T4 is Invalid and Failed Re-validation ',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_INVALID_OBJECTS_AFTER_19C_UPGRADE');



debug('begin add_signature: EBS_FIN_PA_INVALID_USAGE_EFFECTIVE_START_DATE');
   l_info('##MASK##FULL_NAME'):= 'DISPLAY_FIRST_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30573',
      p_sig_id                 => 'EBS_FIN_PA_INVALID_USAGE_EFFECTIVE_START_DATE',
      p_sig_sql                => 'SELECT
full_name,
employee_number,
ASSIGN_EFF_STRT,
USAGE_TYPES_EFF_STRT,
person_id,
person_type
FROM
(
...
min(a.EFFECTIVE_START_DATE) "ASSIGN_EFF_STRT",
min(per_usage.EFFECTIVE_START_DATE) "USAGE_TYPES_EFF_STRT",
p.person_id,
pl.meaning person_type
FROM
per_people_f p,
per_all_assignments_f a,
PER_PERSON_TYPE_USAGES_F per_usage,
...
AND A.EFFECTIVE_END_DATE >= TRUNC(SYSDATE)
AND
(
B.ACTUAL_TERMINATION_DATE >= trunc(sysdate)
OR B.ACTUAL_TERMINATION_DATE is null
)
AND pl.lookup_type = ''PA_PERSON_TYPE''
AND pl.lookup_code = ''EMP''
and a.person_id=per_usage.person_id
group by p.full_name, p.employee_number,p.person_id, pl.meaning
HAving min(per_usage.EFFECTIVE_START_DATE) > (SELECT min(a.EFFECTIVE_START_DATE) FROM per_all_assignments_f a WHERE a.PERSON_ID = p.PERSON_ID AND A.PRIMARY_FLAG = ''Y''
AND A.ASSIGNMENT_TYPE = ''E'' AND A.EFFECTIVE_END_DATE >= TRUNC(SYSDATE))
...
per_all_assignments_f a,
PER_PERSON_TYPE_USAGES_F per_usage,
Per_Periods_Of_Placement b,
pa_lookups pl
WHERE
P.CURRENT_NPW_FLAG = ''Y''
AND P.EFFECTIVE_END_DATE >= TRUNC(SYSDATE)
AND P.NPW_NUMBER IS NOT NULL
AND P.PERSON_ID = A.PERSON_ID
AND A.PRIMARY_FLAG = ''Y''
AND A.ASSIGNMENT_TYPE = ''C''
AND b.date_start = a.period_of_placement_date_start
AND a.person_id = b.person_id
AND A.EFFECTIVE_END_DATE >= TRUNC(SYSDATE)
AND
(
...
and pl.lookup_type = ''PA_PERSON_TYPE''
and pl.lookup_code = ''CWK''
and a.person_id=per_usage.person_id
group by p.full_name, p.npw_number,p.person_id, pl.meaning
HAving min(per_usage.EFFECTIVE_START_DATE) > (SELECT min(a.EFFECTIVE_START_DATE) FROM per_all_assignments_f a WHERE a.PERSON_ID = p.PERSON_ID  AND A.PRIMARY_FLAG = ''Y''
AND A.ASSIGNMENT_TYPE = ''C'')
)
where person_id in (SELECT
        ...
        FROM
            fnd_user fu
        WHERE
            fu.user_name =  nvl( ''##$$USERNAME$$##'' , NULL))',
      p_title                  => 'Invalid Person Usage Effective Start Date',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'An invalid person usage effective date exists resulting in the error: <br><br>
Error<br>
------<br>
FRM-40735: ON-INSERT trigger raised unhandled exception ORA-06502',
      p_solution               => 'Review the solution in: [2692005/KB471271] PAXPREPR: Unable To Add Key Member FRM-40735 On Insert Trigger Raised Unhanded Exception.',
      p_success_msg            => 'The person usage effective date is valid.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_INVALID_USAGE_EFFECTIVE_START_DATE');



debug('begin add_signature: EBS_FIN_PA_PROJECT_STATUS_CONTROL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28420',
      p_sig_id                 => 'EBS_FIN_PA_PROJECT_STATUS_CONTROL',
      p_sig_sql                => 'SELECT  status.project_status_name, 
status.project_status_code, 
statusc.enabled_flag,  
lookup.meaning "Action"  ,
status.start_date_active, 
status.end_date_active, 
status.last_update_date,
status.creation_date
FROM   
PA_PROJECT_STATUS_CONTROLS  statusc  , 
PA_PROJECT_STATUSES status,
PA_LOOKUPS lookup
WHERE 
statusc.project_status_code = status.project_status_code
 AND lookup.lookup_code (+) = statusc.action_code
 AND lookup.lookup_type (+) = ''PROJECT_STATUS_ACTIONS''
 AND lookup.meaning IS NOT NULL
 AND statusc.enabled_flag = ''Y'' 
order by status.project_status_name, lookup.meaning',
      p_title                  => 'Enabled Project Statuses With Assigned Actions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Enabled project statuses with assigned actions for status type PROJECT do not exist.',
      p_solution               => '',
      p_success_msg            => 'Enabled project statuses with assigned actions for status type PROJECT do exist.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PROJECT_STATUS_CONTROL');



debug('begin add_signature: PA_EXPENDITURE_TYPE_COST_RATES_DEFINED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12169',
      p_sig_id                 => 'PA_EXPENDITURE_TYPE_COST_RATES_DEFINED',
      p_sig_sql                => 'SELECT
    expenditure_type,
    expenditure_category,
    expenditure_category_desc,
    revenue_category_code,
    revenue_category_name,uom,
    start_date_active,
    cost_rate_flag
FROM
...
WHERE
    cost_rate_flag = ''Y''
    AND   expenditure_type NOT IN (
        SELECT DISTINCT
            expenditure_type
        FROM
            pa_expenditure_cost_rates_all
    )',
      p_title                  => 'Expenditure Type Cost Rates Missing',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Cost rates have not been defined for some expenditure types, which will cause NO_RATE rejection in Distribute Usage and Miscellaneous Costs process. ',
      p_solution               => 'Review the solution in Distribute Process Exception Shows Error on Output and Log: Missing Cost Rate (NO_RATE) [273388/KB271882].',
      p_success_msg            => 'Cost rates have been defined for expenditure types which require them.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_EXPENDITURE_TYPE_COST_RATES_DEFINED');



debug('begin add_signature: EBS_FIN_PA_PA_PERIODS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28436',
      p_sig_id                 => 'EBS_FIN_PA_PA_PERIODS',
      p_sig_sql                => 'SELECT count(*) from pa_periods_all
WHERE org_id= ##$$ORG_ID$$##',
      p_title                  => 'Projects Periods Defined For Operating Unit',
      p_fail_condition         => '[count(*)] < [0]',
      p_problem_descr          => 'No Projects periods are defined for this operating unit.',
      p_solution               => 'Follow the solution in [3041766/KB614281] Are Projects Periods Required for Reporting and Processing Data in Oracle Projects? ',
      p_success_msg            => 'At least one Projects period has been defined for this operating unit.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_PERIODS');



debug('begin add_signature: EBS_FIN_PA_CURRENT_PA_PERIOD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28437',
      p_sig_id                 => 'EBS_FIN_PA_CURRENT_PA_PERIOD',
      p_sig_sql                => 'SELECT period_name,start_date,end_date,
decode(status,''O'',''Open'',''F'',''Future'',''Not Open'') Status
FROM  pa_periods_all
WHERE current_pa_period_flag = ''Y''
AND org_id= ##$$ORG_ID$$##',
      p_title                  => 'Current Reporting Period',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Current reporting period is not assigned for this operating unit.',
      p_solution               => 'Review the solution in [342224/KB559289] How to Set Current Reporting Period for Specific Period.',
      p_success_msg            => 'Current reporting period has been assigned for this operating unit.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_CURRENT_PA_PERIOD');



debug('begin add_signature: EBS_FIN_PA_RECENT_OPEN_OR_FUTURE_PA_PERIODS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28438',
      p_sig_id                 => 'EBS_FIN_PA_RECENT_OPEN_OR_FUTURE_PA_PERIODS',
      p_sig_sql                => 'SELECT p.period_name,
p.start_date,
p.end_date,
decode(p.status,''O'',''Open'',''F'',''Future'',''Not Open'') Status
FROM  pa_periods_all p
WHERE p.status in (''O'',''F'')
AND   org_id = ##$$ORG_ID$$##
AND   52 > (SELECT count(*)
FROM  pa_periods_all p2
WHERE p2.status in (''O'',''F'')
AND   org_id = ##$$ORG_ID$$##
AND   p2.start_date > p.start_date)
ORDER BY p.start_date desc',
      p_title                  => 'Most Recent Open or Future Enterable Projects Periods',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No recent open or future enterable Projects periods.',
      p_solution               => 'Most recent open or future enterable Projects periods.',
      p_success_msg            => 'Most recent open or future enterable Projects periods.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_RECENT_OPEN_OR_FUTURE_PA_PERIODS');



debug('begin add_signature: EBS_FIN_PA_GL_PERIOD_SETUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28621',
      p_sig_id                 => 'EBS_FIN_PA_GL_PERIOD_SETUP',
      p_sig_sql                => 'SELECT   led.name "Ledger Name"
,        count(ps.period_name) "Number Of Periods Defined"
,        count(decode(ps.closing_status,''O'', ps.period_name, null)) "Number of Periods Open"
,        led.user_period_type "Period Type"
FROM     GL_LEDGERS_V led
,        GL_PERIOD_STATUSES ps 
WHERE    led.ledger_id = ps.ledger_id
AND      ps.application_id = 275
AND      led.ledger_id = ##$$LEDGERID$$##
GROUP BY led.name, led.user_period_type ',
      p_title                  => 'General Ledger Period Setup:  GL Period Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'GL periods are not defined.',
      p_solution               => 'GL periods are defined.',
      p_success_msg            => 'GL periods are defined.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GL_PERIOD_SETUP');



debug('begin add_signature: EBS_FIN_PA_CURRENT_DATE_IN_OPEN_GL_PERIOD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28623',
      p_sig_id                 => 'EBS_FIN_PA_CURRENT_DATE_IN_OPEN_GL_PERIOD',
      p_sig_sql                => 'SELECT   period_name "Period",
...
AND      closing_status = ''O''',
      p_title                  => 'General Ledger Period Setup: Current Date Is in Open GL Period',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Current date is not in open GL period.',
      p_solution               => 'Current date is in open GL period.',
      p_success_msg            => 'Current date is in open GL period.',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_CURRENT_DATE_IN_OPEN_GL_PERIOD');



debug('begin add_signature: EBS_FIN_PA_LATEST_OPEN_GL_PERIOD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28622',
      p_sig_id                 => 'EBS_FIN_PA_LATEST_OPEN_GL_PERIOD',
      p_sig_sql                => 'select  ps.period_name, ps.start_date, ps.end_date
FROM    GL_PERIOD_STATUSES ps
WHERE    ps.application_id = 101
AND      ps.ledger_id = ##$$LEDGERID$$##
and      ps.end_date in (select max(ps1.end_date)
FROM     GL_PERIOD_STATUSES ps1
WHERE    ps1.application_id = ps.application_id
AND      ps1.ledger_id = ps.ledger_id
AND      ps1.closing_status =''O'')
',
      p_title                  => 'General Ledger Period Setup: Latest Open Period',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no open GL periods.',
      p_solution               => 'This is the latest open period for GL.',
      p_success_msg            => 'This is the latest open period for GL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_LATEST_OPEN_GL_PERIOD');



debug('begin add_signature: EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_SYSTEM');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28354',
      p_sig_id                 => 'EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_SYSTEM',
      p_sig_sql                => 'SELECT
    pia.set_of_books_id          "Ledger Id",
    gl.name                      "Ledger Name",
    gl.short_name                "Ledger Short Name",
    gl.description               "Ledger Description",
    gl.ledger_category_code "Ledger Category Code",
    sob.chart_of_accounts_id     "Chart of Accounts Id",
    fifs.id_flex_structure_name  "Chart of Accounts Name",
    gl.first_ledger_period_name "First Ever Opened Period",
    gl.future_enterable_periods_limit "Future Enterable Periods	Limit",
    xam.name "Subledger Accounting Method",
    gl.sla_ledger_cash_basis_flag "Use Cash Basis Accounting",
    pia.business_group_id,
    pia.accumulation_period_type "Summarization Period Type ",
    pia.period_set_name          "Calendar Name",
    gpt.user_period_type         "PA Period Type",
    pia.book_type_code           "Default Asset Book",
    pia.same_pa_gl_period        "Maintain Common Periods",
    pos.name                     "Organization Hierarchy",
    posv.version_number          "Version",
    pia.start_organization_id    "Start Organization Id",
    haou.name                    "Start Organization"
FROM
...
WHERE
        pia.set_of_books_id = gl.ledger_id
    AND pia.set_of_books_id = sob.set_of_books_id (+)
    AND pia.pa_period_type = gpt.period_type (+)
    AND pia.organization_structure_id = pos.organization_structure_id (+)
    AND pia.org_structure_version_id = posv.org_structure_version_id (+)
    AND pia.start_organization_id = haou.organization_id (+)
    AND fifs.id_flex_num = sob.chart_of_accounts_id
    ...
    AND gl.sla_accounting_method_type = xam.accounting_method_type_code
    AND xam.language = userenv(''LANG'')
and pia.org_id = ##$$p_org_id$$##
and pia.org_id = ##$$FK1$$##',
      p_title                  => 'System',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No system implementation options defined for this operating unit.',
      p_solution               => 'Review the solution in [3033787/KB288467] Forms Errors: FRM-40735 and FRM-40212 and FRM-41830 When Implementation Options is Not Defined.',
      p_success_msg            => 'System implementation options are defined for this operating unit.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_SYSTEM');



debug('begin add_signature: EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_CURRENCY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28355',
      p_sig_id                 => 'EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_CURRENCY',
      p_sig_sql                => 'select gl.currency_code "Functional Currency"
    , decode(pia.DEFAULT_RATE_DATE_CODE,''E'',''Expenditure Item Date'', ''P'', ''PA Period Ending Date'', pia.DEFAULT_RATE_DATE_CODE) "Ex Rate Date Type"
    , DEFAULT_RATE_TYPE
from pa_implementations_all pia
   , gl_ledgers gl
where pia.set_of_books_id = gl.ledger_id 
and   pia.org_id = ##$$p_org_id$$##
and   pia.org_id = ##$$FK1$$##',
      p_title                  => 'Currency',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No currency implementation options defined for this operating unit.
',
      p_solution               => 'Review the solution in [3033787/KB288467] Forms Errors: FRM-40735 and FRM-40212 and FRM-41830 When Implementation Options is Not Defined.',
      p_success_msg            => 'Currency implementation options defined for this operating unit.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_CURRENCY');



debug('begin add_signature: EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_PROJECT_SETUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28356',
      p_sig_id                 => 'EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_PROJECT_SETUP',
      p_sig_sql                => 'select  USER_DEFINED_PROJECT_NUM_CODE "Project Numbering Method"
      , pia.MANUAL_PROJECT_NUM_TYPE " Project Numbering Type"
      , pos.name "Project Org. Hierarchy"
      , posv.version_number "Version"
      , pia.PROJ_START_ORG_ID "Project Start Org Id"
      , haou.name "Project Start Org"
from pa_implementations_all pia
   , PER_ORGANIZATION_STRUCTURES pos
   , PER_ORG_STRUCTURE_VERSIONS posv
   , HR_ALL_ORGANIZATION_UNITS HAOU
where pia.PROJ_ORG_STRUCTURE_ID = pos.ORGANIZATION_STRUCTURE_ID(+)
and   pia.PROJ_ORG_STRUCTURE_VERSION_ID = posv.ORG_STRUCTURE_VERSION_ID(+)
and   pia.PROJ_START_ORG_ID = haou.organization_id(+)
and pia.org_id = ##$$p_org_id$$##
and pia.org_id = ##$$FK1$$##',
      p_title                  => 'Project Setup',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No project setup implementation options are defined for this operating unit.
',
      p_solution               => 'Review the solution in [3033787/KB288467] Forms Errors: FRM-40735 and FRM-40212 and FRM-41830 When Implementation Options is Not Defined.',
      p_success_msg            => 'Project setup implementation options are defined for this operating unit.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_PROJECT_SETUP');



debug('begin add_signature: EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_STAFFING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28357',
      p_sig_id                 => 'EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_STAFFING',
      p_sig_sql                => 'select COMPETENCE_MATCH_WT "Competence Match Weightings"
     , AVAILABILITY_MATCH_WT "Availability Match Weightings"
     , JOB_LEVEL_MATCH_WT "Job Level Match Weightings"
     , ADV_ACTION_SET_ID "Adverstisment Rule Id"
     , asets.action_set_name "Adverstisment Rule Name"
     , FTE_DAY "Full Time Hrs per day"
     , FTE_DAY "Full Time Hrs per Week"
from pa_implementations_all pia, pa_action_sets asets
where pia.ADV_ACTION_SET_ID = asets.ACTION_SET_ID(+)
and pia.org_id = ##$$p_org_id$$##
and pia.org_id =##$$FK1$$##',
      p_title                  => 'Staffing',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No staffing implementation options are defined for this operating unit.
',
      p_solution               => 'Review the solution in [3033787/KB288467] Forms Errors: FRM-40735 and FRM-40212 and FRM-41830 When Implementation Options is Not Defined.',
      p_success_msg            => 'Staffing implementation options are defined for this operating unit.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_STAFFING');



debug('begin add_signature: EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_EXPENDITURE_COSTING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28358',
      p_sig_id                 => 'EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_EXPENDITURE_COSTING',
      p_sig_sql                => 'select decode(Pia.EXP_CYCLE_START_DAY_CODE,1,''Sunday'',2, ''Monday'', 3, ''Tuesday'', 4, ''Wednesday'', 5,
                ''Thursday'', 6, ''Friday'', 7, ''Saturday'',Pia.EXP_CYCLE_START_DAY_CODE) "Expenditure Cycle Start Day"
      , ALLOW_NEGATIVE_ACCRUAL "Enable Negative Accrual Trans."
      , OVERTIME_CALC_ENABLED_FLAG "Enable Overtime Calc."
      , XFACE_CWK_TIMECARDS_FLAG "Import CWK TC with PO Int"
      , DEF_SUPPLIER_COST_CR_CCID "Def. Supplier Cost Credit CCID"
      , kfv.concatenated_segments "Def. Supplier Cost Credit"
      , INTERFACE_LABOR_TO_GL_FLAG "To GL Employee Labor Cost"
      , XFACE_CWK_LABOR_TO_GL_FLAG "To GL CWK Labor Cost"
      , INTERFACE_USAGE_TO_GL_FLAG "To GL Usage, inv, Misc, Burden"
      , pos.name "Expenditure Org. Hierarchy"
      , posv.version_number "Version"
      , pia.EXP_START_ORG_ID "Expenditure Start Org Id"
      , haou.name "Expenditure Start Org"
from pa_implementations_all pia
   , gl_code_combinations_kfv kfv
   , PER_ORGANIZATION_STRUCTURES pos
   , PER_ORG_STRUCTURE_VERSIONS posv
   , HR_ALL_ORGANIZATION_UNITS HAOU
where pia.DEF_SUPPLIER_COST_CR_CCID = kfv.code_combination_id(+)
and  pia.EXP_ORG_STRUCTURE_ID = pos.ORGANIZATION_STRUCTURE_ID(+)
and   pia.EXP_ORG_STRUCTURE_VERSION_ID = posv.ORG_STRUCTURE_VERSION_ID(+)
and   pia.EXP_START_ORG_ID = haou.organization_id(+)
and pia.org_id = ##$$p_org_id$$##
and pia.org_id = ##$$FK1$$##',
      p_title                  => 'Expenditure Costing',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Expenditure costing implementation options are not defined for this operating unit.',
      p_solution               => 'Review the solution in [3033787/KB288467] Forms Errors: FRM-40735 and FRM-40212 and FRM-41830 When Implementation Options is Not Defined.',
      p_success_msg            => 'Expenditure costing implementation options are defined for this operating unit.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_EXPENDITURE_COSTING');



debug('begin add_signature: EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_BILLING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28359',
      p_sig_id                 => 'EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_BILLING',
      p_sig_sql                => 'select  pia.INTERFACE_REVENUE_TO_GL_FLAG "Interface Revenue to GL"
      , pia.INVOICE_NZ_LINES "Invoice Net Zero Lines"
      , pia.USER_DEFINED_INVOICE_NUM_CODE "Invoice Numbering Method"
      , pia.NEXT_AUTOMATIC_INVOICE_NUMBER "Invoice Next Number"
      , pia.CENTRALIZED_INVOICING_FLAG "Centralized Invoice Processing"
      , pia.INVOICE_BATCH_SOURCE_ID "Invoice Batch Source Id"
      , rbs.name "Invoice Batch Source Name"
      , pia.CUST_ACC_REL_CODE "Customer Relationships"
      , pia. SALES_CREDIT_TYPE_CODE "Sales Credit Type Id"
      , sct.name "Sales Credit Type name"
      , pia.MULTI_CURRENCY_BILLING_FLAG "Enable Multi Currency Billing"
      , pia.RATE_DISCOUNT_REASON_FLAG "Required Rate and Dis. Reason"
      , pia.BR_OVERRIDE_FLAG "Allow Bill Rate Override"
      , pia.SHARE_ACROSS_OU_BR_SCH_FLAG "Share Bill Rate Across OU"
      , pia.ALLOW_FUNDING_ACROSS_OU_FLAG "Allow Finding Across OU"
      , pia.RETN_ACCOUNTING_FLAG "Account for Unbilled Retention"
      , pia.INCLUDE_GAINS_LOSSES_FLAG "Funding Rev. Incl. Gain Loss"
      , pia.CREDIT_MEMO_REASON_FLAG "Require CM Reason"
      , pia.create_on_account_cm "Create On Account CM"
from pa_implementations_all pia
    , RA_BATCH_SOURCES_ALL rbs
    , SO_SALES_CREDIT_TYPES_115 sct
where rbs.batch_source_id(+) = pia.INVOICE_BATCH_SOURCE_ID
and  sct.Name(+) = pia.SALES_CREDIT_TYPE_CODE
and pia.org_id = ##$$p_org_id$$##
and pia.org_id = ##$$FK1$$##',
      p_title                  => 'Billing',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Billing implementation options are not defined for this operating unit.',
      p_solution               => 'Review the solution in [3033787/KB288467] Forms Errors: FRM-40735 and FRM-40212 and FRM-41830 When Implementation Options is Not Defined.',
      p_success_msg            => 'Billing implementation options are defined for this operating unit.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_BILLING');



debug('begin add_signature: EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_CROSS_CHARGE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28360',
      p_sig_id                 => 'EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_CROSS_CHARGE',
      p_sig_sql                => 'select  pia.CC_DEFAULT_RATE_DATE_CODE "Exchange Rate Type Date"
      , pia.CC_DEFAULT_RATE_TYPE "Exchange Rate Type"
      , pia.CC_MULTI_LE_FLAG "Derive LE from org. setup"
      , decode(CC_PROCESS_IO_CODE,''Borrow and Lent'',''None'') "Cross charge within OU"
      , CC_ALLOW_IU_FLAG "Allow CC to all OU within LE"
      , decode(CC_PROCESS_IU_CODE,''Borrow and Lent'',''None'') "Default Processing Method"
      , pos.name "Project Org. Hierarchy"
      , posv.version_number "Version"
      , pia.CC_PROJ_START_ORG_ID "Project Start Org Id"
      , haou.name "Project Start Org"
      , pos1.name "Expenditure Org. Hierarchy"
      , posv1.version_number "Version"
      , pia.CC_EXP_START_ORG_ID "Expenditure Start Org Id"
      , haou1.name "Expenditure Start Org"
from pa_implementations_all pia
   , PER_ORGANIZATION_STRUCTURES pos
   , PER_ORG_STRUCTURE_VERSIONS posv
   , HR_ALL_ORGANIZATION_UNITS HAOU
...
where  pia.CC_PROJ_ORG_STRUCTURE_ID = pos.ORGANIZATION_STRUCTURE_ID(+)
and   pia.CC_PROJ_ORG_STRUCT_VERSION_ID = posv.ORG_STRUCTURE_VERSION_ID(+)
and   pia.CC_PROJ_START_ORG_ID = haou.organization_id(+)
and   pia.CC_EXP_ORG_STRUCTURE_ID = pos1.ORGANIZATION_STRUCTURE_ID(+)
and   pia.CC_EXP_ORG_STRUCT_VERSION_ID = posv1.ORG_STRUCTURE_VERSION_ID(+)
and   pia.CC_EXP_START_ORG_ID = haou1.organization_id(+)
and pia.org_id = ##$$p_org_id$$##
and pia.org_id = ##$$FK1$$##',
      p_title                  => 'Cross Charge',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Cross charge implementation options are not defined for this operating unit.',
      p_solution               => 'Review the solution in [3033787/KB288467] Forms Errors: FRM-40735 and FRM-40212 and FRM-41830 When Implementation Options is Not Defined.',
      p_success_msg            => 'Cross charge implementation options are defined for this operating unit.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_CROSS_CHARGE');



debug('begin add_signature: EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_MAIN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28351',
      p_sig_id                 => 'EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_MAIN',
      p_sig_sql                => 'select pia.org_id, hou.name , pia.org_id "##$$FK1$$##", pia.creation_date, pia.created_by, pia.last_update_date, pia.last_updated_by
from pa_implementations_all pia, HR_OPERATING_UNITS hou 
where pia.org_id = hou.organization_id and pia.org_id = ##$$p_org_id$$##',
      p_title                  => 'Implementation Options',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No implementation options defined for this operating unit.',
      p_solution               => 'Review the solution in [3033787/KB288467] Forms Errors: FRM-40735 and FRM-40212 and FRM-41830 When Implementation Options is Not defined.',
      p_success_msg            => 'Implementation options are defined for this operating unit.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_SYSTEM','EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_CURRENCY','EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_PROJECT_SETUP','EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_STAFFING','EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_EXPENDITURE_COSTING','EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_BILLING','EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_CROSS_CHARGE'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '14'
      );
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_MAIN');



debug('begin add_signature: EBS_FIN_PA_ACTIVE_PROJECT_ORG_MISSING_FROM_PA_ALL_ORGANIZATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28705',
      p_sig_id                 => 'EBS_FIN_PA_ACTIVE_PROJECT_ORG_MISSING_FROM_PA_ALL_ORGANIZATION',
      p_sig_sql                => 'select Organization_Name,  Organization_Id,  Hierarchy_level, Exist_pa_all_org_project Exists_in_table, pa_all_org_proj_inactive_d End_date
from (

SELECT hou_child.name Organization_Name, organization_id_child Organization_Id, tree_level Hierarchy_level, hou_child.date_to, pa_project_org
, decode(pa_all_org_proj.organization_id,null, ''No'',''Yes'') Exist_pa_all_org_project, pa_all_org_proj.inactive_date pa_all_org_proj_inactive_d
FROM ( 

select pia.business_group_id
,0  organization_id_parent
    , pia.proj_start_org_id organization_id_child
     , 1 tree_level 
     from pa_implementations_all pia where pia.org_id =  ##$$p_org_id$$##
union all
select * from
(
SELECT
...
in (select pia.proj_start_org_id, pia.org_structure_version_id from pa_implementations_all pia where pia.org_id =  ##$$p_org_id$$##))
CONNECT BY
    pose.organization_id_parent = PRIOR pose.organization_id_child
    AND pose.org_structure_version_id  in (select pia.org_structure_version_id 
    from pa_implementations_all pia where pia.org_id =  ##$$p_org_id$$##)
    ORDER siblings BY pose.organization_id_parent)
...
(SELECT i.organization_id , ''Y'' pa_project_org  FROM   hr_organization_information i 
where i.org_information_context = ''CLASS'' 
  AND    i.org_information1 = ''PA_PROJECT_ORG'' 
  AND    i.org_information2 = ''Y'' 
) pa_project_org,
(
SELECT inactive_date, org_id,organization_id 
FROM pa_all_organizations
WHERE pa_org_use_type = ''PROJECTS'') pa_all_org_proj

WHERE org_struc.organization_id_child = hou_child.organization_id
AND org_struc.organization_id_child = pa_all_org_proj.organization_id(+)
AND pa_all_org_proj.org_id(+) =  ##$$p_org_id$$##
AND org_struc.organization_id_child = pa_project_org.organization_id(+)
)
where (nvl(to_date(pa_all_org_proj_inactive_d,''dd-Mon-yy''),trunc(sysdate)) < trunc(sysdate) or Exist_pa_all_org_project = ''No'')
and nvl(date_to,trunc(sysdate)) >= trunc(sysdate)
and nvl(pa_project_org,''N'') = ''Y''',
      p_title                  => 'Active Project Organizations Missing (PA_ALL_ORGANIZATIONS)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Some active project organizations are missing from PA_ALL_ORGANIZATIONS table.',
      p_solution               => 'Review the solution in [184266/KB368465] - R12 R11i: Expenditure or Project Organizations Missing from Lists of Values (LOV).',
      p_success_msg            => 'All active project organizations exists in the PA_ALL_ORGANIZATIONS table .',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_ACTIVE_PROJECT_ORG_MISSING_FROM_PA_ALL_ORGANIZATION');



debug('begin add_signature: EBS_FIN_PA_ACTIVE_EXPENDITURE_ORG_MISSING_FROM_PA_ALL_ORGANIZATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28706',
      p_sig_id                 => 'EBS_FIN_PA_ACTIVE_EXPENDITURE_ORG_MISSING_FROM_PA_ALL_ORGANIZATION',
      p_sig_sql                => 'select Organization_Name,  Organization_Id,  Hirearchy_level, Exist_pa_all_org_exp Exists_in_table, pa_all_org_exp_inactive_d End_date
from (

SELECT hou_child.name Organization_Name, organization_id_child Organization_Id, tree_level Hirearchy_level, hou_child.date_to, PA_EXPENDITURE_ORG
,decode(pa_all_org_exp.organization_id,null, ''No'',''Yes'') Exist_pa_all_org_exp, pa_all_org_exp.inactive_date pa_all_org_exp_inactive_d
FROM ( 

select pia.business_group_id
,0  organization_id_parent
    , pia.exp_start_org_id organization_id_child
     , 1 tree_level 
     from pa_implementations_all pia where pia.org_id =  ##$$p_org_id$$##
union all
select * from
...
FROM
    per_org_structure_elements pose
start with ((pose.organization_id_parent, pose.org_structure_version_id)
in (select pia.exp_start_org_id, pia.exp_org_structure_version_id from pa_implementations_all pia where pia.org_id =  ##$$p_org_id$$##))
CONNECT BY
    pose.organization_id_parent = PRIOR pose.organization_id_child
    AND pose.org_structure_version_id  in (select pia.exp_org_structure_version_id 
    from pa_implementations_all pia where pia.org_id =  ##$$p_org_id$$##)
    ORDER siblings BY pose.organization_id_parent)
...
(SELECT i.organization_id , ''Y'' PA_EXPENDITURE_ORG  FROM   hr_organization_information i 
where i.org_information_context = ''CLASS'' 
  AND    i.org_information1 = ''PA_EXPENDITURE_ORG''  
  AND    i.org_information2 = ''Y'' 
) PA_EXPENDITURE_ORG,
(
SELECT inactive_date, org_id,organization_id 
FROM pa_all_organizations
WHERE pa_org_use_type = ''EXPENDITURES'') pa_all_org_exp

WHERE org_struc.organization_id_child = hou_child.organization_id
AND org_struc.organization_id_child = pa_all_org_exp.organization_id(+)
AND pa_all_org_exp.org_id(+) =  ##$$p_org_id$$##
AND org_struc.organization_id_child = PA_EXPENDITURE_ORG.organization_id(+)
)
where (nvl(to_date(pa_all_org_exp_inactive_d,''dd-Mon-yy''),trunc(sysdate)) < trunc(sysdate) or Exist_pa_all_org_exp = ''No'')
and nvl(date_to,trunc(sysdate)) >= trunc(sysdate)
and nvl(PA_EXPENDITURE_ORG,''N'') = ''Y''',
      p_title                  => 'Active Expenditure Organizations Missing (PA_ALL_ORGANIZATIONS)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Some active expenditure organizations are missing from PA_ALL_ORGANIZATIONS table.',
      p_solution               => 'Review the solution in [184266/KB368465] - R12 R11i: Expenditure or Project Organizations Missing from Lists of Values (LOV).',
      p_success_msg            => 'All active expenditure organizations exists in the PA_ALL_ORGANIZATIONS table ',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_ACTIVE_EXPENDITURE_ORG_MISSING_FROM_PA_ALL_ORGANIZATION');



debug('begin add_signature: EBS_FIN_PA_INACTIVE_ORGANIZATIONS_INCLUDED_IN_PA_ALL_ORGANIZATIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28707',
      p_sig_id                 => 'EBS_FIN_PA_INACTIVE_ORGANIZATIONS_INCLUDED_IN_PA_ALL_ORGANIZATIONS',
      p_sig_sql                => 'select distinct Organization_Name,  Organization_Id, date_from hr_org_date_from, date_to hr_org_date_to, ''Y'' In_Hierarchy,  pa_class_exist,  Exist_pa_all_org_exp Exists_in_table, pa_all_org_exp_inactive_d PA_inactive_date

from (

SELECT hou_child.name Organization_Name, organization_id_child Organization_Id, tree_level Hirearchy_level, pa_class_exist.pa_class_exist, hou_child.date_from, hou_child.date_to
, decode(pa_all_org_proj.organization_id,null, ''No'',''Yes'') Exist_pa_all_org_project, pa_all_org_proj.inactive_date pa_all_org_proj_inactive_d, decode(pa_all_org_exp.organization_id,null, ''No'',''Yes'') Exist_pa_all_org_exp, pa_all_org_exp.inactive_date pa_all_org_exp_inactive_d
FROM ( 
select pia.business_group_id
,0  organization_id_parent
    , pia.proj_start_org_id organization_id_child
...
FROM
    per_org_structure_elements pose
start with ((pose.organization_id_parent, pose.org_structure_version_id)
in (select pia.proj_start_org_id, pia.proj_org_structure_version_id from pa_implementations_all pia where pia.org_id =  ##$$p_org_id$$##))
CONNECT BY
    pose.organization_id_parent = PRIOR pose.organization_id_child
    AND pose.org_structure_version_id  in (select pia.proj_org_structure_version_id 
    from pa_implementations_all pia where pia.org_id =  ##$$p_org_id$$##) 
    ORDER siblings BY pose.organization_id_parent)
union
select pia.business_group_id
...
(SELECT i.organization_id , ''Y'' pa_class_exist  FROM   hr_organization_information i 
where i.org_information_context = ''CLASS'' 
  AND    i.org_information1 in ( ''PA_PROJECT_ORG'' , ''PA_EXPENDITURE_ORG''  )
  AND    i.org_information2 = ''Y'' 
) pa_class_exist,
(
SELECT inactive_date, org_id,organization_id 
...
AND pa_all_org_proj.org_id(+) =  ##$$p_org_id$$##
AND pa_all_org_exp.org_id(+) =  ##$$p_org_id$$##
AND org_struc.organization_id_child = pa_class_exist.organization_id(+)
)
where ((nvl(to_date(pa_all_org_exp_inactive_d,''dd-Mon-yy''),trunc(sysdate)) > trunc(sysdate) and Exist_pa_all_org_exp = ''Yes'')
or
(nvl(to_date(pa_all_org_proj_inactive_d,''dd-Mon-yy''),trunc(sysdate)) > trunc(sysdate) or Exist_pa_all_org_project = ''Yes''))
and nvl(date_to,trunc(sysdate)) < trunc(sysdate)
',
      p_title                  => 'Inactive Project Organizations (PA_ALL_ORGANIZATIONS)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Some inactive project organizations are included in the PA_ALL_ORGANIZATIONS table.',
      p_solution               => 'Review the solution in [184266/KB368465] - R12 R11i: Expenditure or Project Organizations Missing from Lists of Values (LOV).',
      p_success_msg            => 'All inactive project organizations are not included in the PA_ALL_ORGANIZATIONS table.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_INACTIVE_ORGANIZATIONS_INCLUDED_IN_PA_ALL_ORGANIZATIONS');



debug('begin add_signature: EBS_FIN_PA_PROJECT_ORGANIZATION_HIERARCHY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28373',
      p_sig_id                 => 'EBS_FIN_PA_PROJECT_ORGANIZATION_HIERARCHY',
      p_sig_sql                => 'SELECT tree_level||rpad(''-'',3*tree_level,''-'')||hou_child.name||'' (''||organization_id_child||'')'' "Organizations Hierarchy", hou_child.date_from, hou_child.date_to, pa_project_org, PA_EXPENDITURE_ORG, PA_INVOICE_ORG
, decode(pa_all_org_proj.organization_id,null, ''No'',''Yes'') Exist_pa_all_org_project, pa_all_org_proj.inactive_date pa_all_org_proj_inactive_d, decode(pa_all_org_exp.organization_id,null, ''No'',''Yes'') Exist_pa_all_org_exp, pa_all_org_exp.inactive_date pa_all_org_exp_inactive_d
FROM ( 
select pia.business_group_id
,0  organization_id_parent
...
(SELECT i.organization_id , ''Y'' PA_INVOICE_ORG  FROM   hr_organization_information i 
where i.org_information_context = ''CLASS'' 
  AND    i.org_information1 = ''PA_INVOICE_ORG''
  AND    i.org_information2 = ''Y'' 
) PA_INVOICE_ORG,
(
SELECT inactive_date, org_id,organization_id 
...
AND org_struc.organization_id_child = pa_project_org.organization_id(+)
AND org_struc.organization_id_child = PA_EXPENDITURE_ORG.organization_id(+)
AND org_struc.organization_id_child = PA_INVOICE_ORG.organization_id(+)',
      p_title                  => 'Project Organization Hierarchy',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no project organization hierarchy defined.',
      p_solution               => 'Review the following solution:  [184266/KB368465] Expenditure or Project Organizations Missing from Lists of Values (LOV)
',
      p_success_msg            => 'Project organization hierarchy is defined.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PROJECT_ORGANIZATION_HIERARCHY');



debug('begin add_signature: EBS_FIN_PA_EXPENDITURE_EVENT_ORGANIZATION_HIERARCHY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28374',
      p_sig_id                 => 'EBS_FIN_PA_EXPENDITURE_EVENT_ORGANIZATION_HIERARCHY',
      p_sig_sql                => 'SELECT tree_level||rpad(''-'',3*tree_level,''-'')||hou_child.name||'' (''||organization_id_child||'')'' "Organizations Hierarchy", hou_child.date_from, hou_child.date_to, pa_project_org, PA_EXPENDITURE_ORG, PA_INVOICE_ORG
, decode(pa_all_org_proj.organization_id,null, ''No'',''Yes'') Exist_pa_all_org_project, pa_all_org_proj.inactive_date pa_all_org_proj_inactive_d, decode(pa_all_org_exp.organization_id,null, ''No'',''Yes'') Exist_pa_all_org_exp, pa_all_org_exp.inactive_date pa_all_org_exp_inactive_d
FROM ( 
select pia.business_group_id
...
AND org_struc.organization_id_child = PA_EXPENDITURE_ORG.organization_id(+)
AND org_struc.organization_id_child = PA_INVOICE_ORG.organization_id(+)',
      p_title                  => 'Expenditure/Event Organization Hierarchy',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Expenditure and/or event organization hierarchy is not defined.',
      p_solution               => 'For more information review the following solutions:
<li>[184266/KB368465] Expenditure or Project Organizations Missing from Lists of Values (LOV)
<li>[756313/KB199469] Error On Expenditure Entry: The Expenditure Organization Is Not Active',
      p_success_msg            => 'Expenditure/event organization hierarchy is defined.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_EXPENDITURE_EVENT_ORGANIZATION_HIERARCHY');



debug('begin add_signature: EBS_FIN_PA_REPORTING_ORGANIZATION_HIERARCHY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28372',
      p_sig_id                 => 'EBS_FIN_PA_REPORTING_ORGANIZATION_HIERARCHY',
      p_sig_sql                => 'SELECT tree_level||rpad(''-'',3*tree_level,''-'')||hou_child.name||'' (''||organization_id_child||'')'' "Organizations Hierarchy", hou_child.date_from, hou_child.date_to, pa_project_org, PA_EXPENDITURE_ORG, PA_INVOICE_ORG
, decode(pa_all_org_proj.organization_id,null, ''No'',''Yes'') Exist_pa_all_org_project, pa_all_org_proj.inactive_date pa_all_org_proj_inactive_d, decode(pa_all_org_exp.organization_id,null, ''No'',''Yes'') Exist_pa_all_org_exp, pa_all_org_exp.inactive_date pa_all_org_exp_inactive_d
FROM ( 
select pia.business_group_id
,0  organization_id_parent
    , pia.start_organization_id organization_id_child
     , 1 tree_level 
     from pa_implementations_all pia where pia.org_id =  ##$$p_org_id$$##
union all
select * from
...
FROM
    per_org_structure_elements pose
start with ((pose.organization_id_parent, pose.org_structure_version_id)
in (select pia.start_organization_id, pia.org_structure_version_id from pa_implementations_all pia where pia.org_id =  ##$$p_org_id$$##))
CONNECT BY
    pose.organization_id_parent = PRIOR pose.organization_id_child
    AND pose.org_structure_version_id  in (select pia.org_structure_version_id 
    from pa_implementations_all pia where pia.org_id =  ##$$p_org_id$$##) 
...
AND org_struc.organization_id_child = PA_EXPENDITURE_ORG.organization_id(+)
AND org_struc.organization_id_child = PA_INVOICE_ORG.organization_id(+)',
      p_title                  => 'Reporting Organization Hierarchy',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Reporting organization hierarchy is not defined.',
      p_solution               => 'Review the solution in [184266/KB368465] Expenditure or Project Organizations Missing from Lists of Values (LOV).


',
      p_success_msg            => 'Reporting organization hierarchy is defined.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_REPORTING_ORGANIZATION_HIERARCHY');



debug('begin add_signature: EBS_FIN_PA_TAX_HIERARCHY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28348',
      p_sig_id                 => 'EBS_FIN_PA_TAX_HIERARCHY',
      p_sig_sql                => 'SELECT sorder "Hierarchy",
       value "Option"
FROM   (SELECT ''1 ''                  sorder,
               def_option_hier_1_code value,
               org_id,
               application_id,
        ...
        UNION
        SELECT ''5 '',
               def_option_hier_5_code value,
               org_id,
               application_id,
               event_class_mapping_id
        FROM   zx_product_options_all) tax
WHERE  tax.org_id =  ##$$ORG_ID$$##
       AND tax.application_id = 275
       AND tax.event_class_mapping_id IS NULL
ORDER  BY sorder ',
      p_title                  => 'Tax Hierarchy',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No tax hierarchy defined for Projects.',
      p_solution               => '',
      p_success_msg            => ' Tax hierarchy defined for Projects.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_TAX_HIERARCHY');



debug('begin add_signature: EBS_FIN_PA_PROJECT_TASK_STATUS_WF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28787',
      p_sig_id                 => 'EBS_FIN_PA_PROJECT_TASK_STATUS_WF',
      p_sig_sql                => 'SELECT
    ps.status_type "Status Type",
    ps.project_status_code "Status Code",
    ps.project_status_name "Status",
    ps.project_system_status_code "Internal Status Code",
    wit.name "Workflow Item Type",
    wit.display_name "Workflow",
    ps.workflow_process "Process",
    wit.description "Workflow Description",
    ps.wf_success_status_code "Success Status",
    ps.wf_failure_status_code "Failure Status",
    ps.Start_date_active "Status Start Date",
    ps.End_date_active "Status End Date"
FROM
    wf_item_types_tl    wit,
    pa_project_statuses ps
WHERE
        wit.language = ''US''
    AND wit.name = ps.workflow_item_type
    AND ps.status_type IN ( ''PROJECT'', ''TASK'' )',
      p_title                  => 'Project and Task Status Workflows',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No workflows assigned to project and task statuses.',
      p_solution               => '',
      p_success_msg            => 'Workflows assigned to project and task statuses.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PROJECT_TASK_STATUS_WF');



debug('begin add_signature: EBS_FIN_PA_PAYABLES_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28476',
      p_sig_id                 => 'EBS_FIN_PA_PAYABLES_OPTIONS',
      p_sig_sql                => 'select soption "Profile option", value "Value"
from (SELECT ''Automatically Create Employee as Supplier '' soption,
              CREATE_EMPLOYEE_VENDOR_FLAG value,
               org_id
        FROM   AP_SYSTEM_PARAMETERS_ALL
        UNION
        SELECT ''Allow Adjustments to Paid Invoice'' soption,
               ALLOW_PAID_INVOICE_ADJUST value,
               org_id
        FROM   AP_SYSTEM_PARAMETERS_ALL
        UNION
        SELECT ''Discount Method '' soption,
               DISCOUNT_DISTRIBUTION_METHOD value,
               org_id
        FROM   AP_SYSTEM_PARAMETERS_ALL
        UNION
        SELECT ''Automatic Offset Method '' soption,
               AUTOMATIC_OFFSETS_FLAG value,
               org_id
        FROM   AP_SYSTEM_PARAMETERS_ALL)
        where org_id = ##$$ORG_ID$$##
',
      p_title                  => 'Payables Options',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Payables options are defined for this operating unit.',
      p_solution               => '',
      p_success_msg            => 'Payables options are defined for this operating unit. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAYABLES_OPTIONS');



debug('begin add_signature: EBS_FIN_PA_PAYABLES_FINANCIAL_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28492',
      p_sig_id                 => 'EBS_FIN_PA_PAYABLES_FINANCIAL_OPTIONS',
      p_sig_sql                => 'SELECT scolumn "Financial Option" , value "Value"
FROM 
(SELECT ''Ledger Name = '' || sob.name || ''(Id = '' || To_char(fin.set_of_books_id) ||'')''    scolumn,
               to_char(fin.set_of_books_id) value,
               fin.org_id
        FROM   FINANCIALS_SYSTEM_PARAMS_ALL fin,
               gl_sets_of_books sob
        WHERE  fin.set_of_books_id = sob.set_of_books_id (+)
        UNION
        SELECT ''Use Requisition Encumbrance '' scolumn,
               REQ_ENCUMBRANCE_FLAG value,
               org_id
        FROM   FINANCIALS_SYSTEM_PARAMS_ALL
        UNION
        SELECT ''Reserve at completion flag '' scolumn,
               RESERVE_AT_COMPLETION_FLAG value,
               org_id
        FROM   FINANCIALS_SYSTEM_PARAMS_ALL
        UNION
        SELECT ''Purchase encumbrance flag '' scolumn,
               PURCH_ENCUMBRANCE_FLAG value,
               org_id
        FROM  FINANCIALS_SYSTEM_PARAMS_ALL)
       WHERE  org_id = ##$$ORG_ID$$##',
      p_title                  => 'Payables Financial Options',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Payables financial options exist for this operating unit.',
      p_solution               => '',
      p_success_msg            => 'Payables financial options exist for this operating unit.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAYABLES_FINANCIAL_OPTIONS');



debug('begin add_signature: EBS_FIN_PA_AMG_SOURCE_PRODUCT_CONTROLS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28772',
      p_sig_id                 => 'EBS_FIN_PA_AMG_SOURCE_PRODUCT_CONTROLS',
      p_sig_sql                => 'SELECT
    pm_product_name    product_name,
    pm_product_code    product_code,
    action_description action,
    field_value_code   type,
    start_date_active  effective_from,
    end_date_active    effective_to
FROM
    pa_pm_product_control_rules_v
ORDER BY
    pm_product_name,
    action_description  
   ',
      p_title                  => 'Activity Management Gateway (AMG) Source Product Controls ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'AMG source product controls are not defined.',
      p_solution               => '',
      p_success_msg            => 'AMG source product controls are defined.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_AMG_SOURCE_PRODUCT_CONTROLS');
...
debug('begin add_signature: EBS_FIN_PA_PA_PROJECT_TEMPLATE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28709',
      p_sig_id                 => 'EBS_FIN_PA_PA_PROJECT_TEMPLATE',
      p_sig_sql                => 'SELECT pa.*
FROM
    pa_projects_all pa
Where template_flag = ''Y''
start with pa.project_id =##$$PROJECT_ID$$##
CONNECT BY
    pa.project_id = PRIOR pa.created_from_project_id',
      p_title                  => 'Project Template Information ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No project template details for the selected project.',
      p_solution               => 'Project template details for the selected project.',
      p_success_msg            => 'Project template details for the selected project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_PROJECT_TEMPLATE');
...
debug('begin add_signature: PA_DC_PA_TASKS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12237',
      p_sig_id                 => 'PA_DC_PA_TASKS',
      p_sig_sql                => 'SELECT * FROM pa_tasks
WHERE project_id = ##$$PROJECT_ID$$##
ORDER BY task_number',
      p_title                  => 'PA_TASKS Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found from PA_TASKS for the selected project.',
      p_solution               => '',
      p_success_msg            => 'PA_TASKS contains information related to the tasks defined for a project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DC_PA_TASKS');



debug('begin add_signature: EBS_FIN_PA_CLASS_CATEGORIES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28806',
      p_sig_id                 => 'EBS_FIN_PA_CLASS_CATEGORIES',
      p_sig_sql                => ' SELECT
    ...
    class.creation_date,
    class.created_by,
    class.mandatory_flag,
    class.autoaccounting_flag,
    class.pick_one_code_only_flag,
    class.start_date_active,
    class.end_date_active,
    class.description,
    class.attribute_category,
    class.allow_percent_flag,
    class.total_100_percent_flag,
    class.all_types_valid_flag,
    class.include_in_pji_flag,
    class.class_category_id    
FROM
    pa_class_categories class,
    pa_project_classes pc
WHERE
      pc.project_id = ##$$PROJECT_ID$$##
AND   pc.class_category = class.class_category',
      p_title                  => 'Class Categories',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no class categories for the selected project.',
      p_solution               => 'Class categories exist for this project.',
      p_success_msg            => 'Class categories exist for the selected project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_CLASS_CATEGORIES');



debug('begin add_signature: EBS_FIN_PA_PROJECT_PLAYERS_PERSON_ASSIGNMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29434',
      p_sig_id                 => 'EBS_FIN_PA_PROJECT_PLAYERS_PERSON_ASSIGNMENTS',
      p_sig_sql                => 'select paa.assignment_id, paa.supervisor_id,  to_char(paa.effective_start_date,''dd-Mon-yyyy'') effective_start_date, to_char(paa.effective_end_date, ''dd-Mon-yyyy'') effective_end_date, paa.business_group_id, paa.position_id, paa.job_id,
paa.assignment_type, paa.primary_flag, paa.last_update_date, paa.creation_date, paa.set_of_books_id
from per_all_assignments_f paa 
where person_id = nvl(##$$FK3$$##,0)
order by paa.effective_end_date desc',
      p_title                  => 'Job Assignment(s) For Key Member',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No job assignment is associated with this key member.',
      p_solution               => 'Key member has job assignment(s) associated with it.',
      p_success_msg            => 'Key member has job assignment(s) associated with it.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PROJECT_PLAYERS_PERSON_ASSIGNMENTS');



debug('begin add_signature: EBS_FIN_PA_PROJECT_PLAYERS_PERSON_JOB');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29435',
      p_sig_id                 => 'EBS_FIN_PA_PROJECT_PLAYERS_PERSON_JOB',
      p_sig_sql                => 'select pj.job_id, pj.date_from, pj.date_to, pj.name, pj.last_update_date, pj.creation_date from per_jobs pj where job_id in (select job_id from per_all_assignments_f where person_id = nvl(##$$FK3$$##,0))
',
      p_title                  => 'Job Detail For Key Member',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No job detail exists for key member.',
      p_solution               => 'Job detail exists for key member.',
      p_success_msg            => 'Job detail exists for key member.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PROJECT_PLAYERS_PERSON_JOB');



debug('begin add_signature: EBS_FIN_PA_PROJECT_PLAYERS_PERSON_DETAILS');
   l_info('##MASK##FULL_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29436',
      p_sig_id                 => 'EBS_FIN_PA_PROJECT_PLAYERS_PERSON_DETAILS',
      p_sig_sql                => 'select pap.person_id, pap.effective_start_date, pap.effective_end_date, pap.person_type_id, pap.current_emp_or_apl_flag, pap.current_employee_flag, pap.employee_number, pap.full_name  from per_all_people_f pap where person_id = nvl(##$$FK3$$##,0)
',
      p_title                  => 'Person Detail For Key Member',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No person detail exists for project key member.',
      p_solution               => 'Person detail exists for project key member.',
      p_success_msg            => 'Person detail exists for project key member.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PROJECT_PLAYERS_PERSON_DETAILS');



debug('begin add_signature: EBS_FIN_PA_PROJECT_PLAYERS');
   l_info('##MASK##APPLICATION LOGIN'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##KEY MEMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28490',
      p_sig_id                 => 'EBS_FIN_PA_PROJECT_PLAYERS',
      p_sig_sql                => 'SELECT  km.person_id "##$$FK3$$##",  rt.meaning "Role Type",  e.full_name "Key Member",  km.*, nvl(fu.user_name, ''No access to application'') "Application Login"
FROM   PA_PROJECT_PLAYERS km ,
        PA_EMPLOYEES e  ,
        PA_PROJECT_ROLE_TYPES rt,
        FND_USER fu
WHERE  km.project_id = ##$$PROJECT_ID$$##
AND    e.person_id = km.person_id
AND    rt.project_role_type (+) = km.project_role_type
AND    fu.employee_id(+) =  km.person_id
ORDER BY rt.meaning, km.start_date_active',
      p_title                  => 'Project Key Members and Associated User Name',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No project key members with associated user name are defined for the selected project.',
      p_solution               => 'Key members with associated user name are defined for the selected project.',
      p_success_msg            => 'Key members with associated user name are defined for the selected project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('EBS_FIN_PA_PROJECT_PLAYERS_PERSON_ASSIGNMENTS','EBS_FIN_PA_PROJECT_PLAYERS_PERSON_JOB','EBS_FIN_PA_PROJECT_PLAYERS_PERSON_DETAILS'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '10'
      );
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PROJECT_PLAYERS');
...
debug('begin add_signature: PA_LABOR_MULTIPLIERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12107',
      p_sig_id                 => 'PA_LABOR_MULTIPLIERS',
      p_sig_sql                => 'SELECT
    ta.task_number,
    t.*
FROM
    pa_labor_multipliers t,
    pa_tasks ta
WHERE
    (
...
',
      p_title                  => 'Labor Multipliers',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No labor multipliers exist for the selected project.',
      p_solution               => '',
      p_success_msg            => 'Labor multipliers for the selected project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_LABOR_MULTIPLIERS');
...
debug('begin add_signature: PA_BUDGET_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12498',
      p_sig_id                 => 'PA_BUDGET_VERSIONS',
      p_sig_sql                => '    
SELECT ver.budget_version_id, ver.budget_type_code, ver.version_number, ver.budget_status_code, ver.last_update_date, ver.creation_date,
ver.current_flag, ver.original_flag, ver.resource_accumulated_flag, ver.resource_list_id, ver.version_name, ver.budget_entry_method_code, 
ver.baselined_by_person_id, ver.baselined_date, ver.change_reason_code, ver.labor_quantity, ver.labor_unit_of_measure, ver.raw_cost, ver.burdened_cost,
ver.revenue, ver.description, ver.first_budget_period, ver.pm_product_code, ver.pm_budget_reference, ver.wf_status_code, ver.adw_notify_flag,
ver.prc_generated_flag, ver.plan_run_date, ver.plan_processing_code, ver.record_version_number, ver.period_profile_id, ver.fin_plan_type_id, ver.parent_plan_version_id,
ver.project_structure_version_id, ver.total_borrowed_revenue, ver.total_tp_revenue_in, ver.total_tp_revenue_out, ver.total_revenue_adj, ver.total_lent_resource_cost,
ver.total_tp_cost_in, ver.total_tp_cost_out, ver.total_cost_adj, ver.total_unassigned_time_cost, ver.total_utilization_percent, ver.total_utilization_hours, ver.total_utilization_adj,
ver.total_capacity, ver.total_head_count, ver.total_head_count_adj, ver.current_working_flag, ver.version_type, ver.request_id, ver.total_project_raw_cost,
ver.total_project_burdened_cost, ver.total_project_revenue, ver.locked_by_person_id, ver.approved_cost_plan_type_flag, ver.approved_rev_plan_type_flag, ver.est_project_raw_cost,
ver.est_project_burdened_cost, ver.est_project_revenue, ver.est_quantity, ver.est_projfunc_raw_cost, ver.est_projfunc_burdened_cost, ver.est_projfunc_revenue, ver.ci_id,
ver.agreement_id, ver.process_update_wbs_flag, ver.object_type_code, ver.object_id, ver.primary_cost_forecast_flag, ver.primary_rev_forecast_flag, ver.rev_partially_impl_flag,
ver.equipment_quantity, ver.pji_summarized_flag, ver.wp_version_flag, ver.current_planning_period, ver.period_mask_id, ver.last_amt_gen_date, ver.actual_amts_thru_period,
ver.est_equipment_quantity, ver.etc_start_date, ver.purged_flag, ver.olap_change_flag,  ver.max_planning_date, ver.min_planning_date
FROM PA_BUDGET_VERSIONS ver
 WHERE ver.project_id =##$$PROJECT_ID$$##
ORDER BY ver.version_number ',
      p_title                  => 'Project Budget Versions Detail (PA_BUDGET_VERSIONS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Budget version detail does not exist for the selected project.',
      p_solution               => '',
      p_success_msg            => 'Project budget version detail for the selected project.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_BUDGET_VERSIONS');
...
debug('begin add_signature: PA_RESOURCE_LISTS_ALL_BG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12103',
      p_sig_id                 => 'PA_RESOURCE_LISTS_ALL_BG',
      p_sig_sql                => 'SELECT
    rl.resource_list_id, rl.name resource_list_name, rl.description resource_list_description, rl.public_flag, rl.group_resource_type_id
    , rl.start_date_active, rl.end_date_active, rl.uncategorized_flag, rl.last_update_date, rl.creation_date, rl.business_group_id, rl.adw_notify_flag
    , rl.job_group_id, rl.resource_list_type, rl.control_flag, rl.use_for_wp_flag, rl.migration_code, rl.record_version_number, rl.migrated_rbs_version_id
    , rl.resource_class_flag, rl.item_master_id, rl.item_category_set_id, rl.default_expenditure_type, rl.default_cost_type_id, rl.activity_flag, rl.uom_code
    , rl.category_code, rl.quantity, rl.status_flag, rl.currency, rl.source_res_list_id
FROM
    pa_resource_lists_all_bg rl,
    pa_resource_list_assignments rla
where
    rla.project_id =  ##$$PROJECT_ID$$##
    AND   rla.resource_list_id = rl.resource_list_id
ORDER BY
    rl.resource_list_id',
      p_title                  => 'Resource List',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No resource list exists for the selected project.',
      p_solution               => 'Review the solution in [2025409/KB447491]When Creating Project Type, Error "FRM-40212: Invalid Value For Field COST_BUDGET_RESOURCE_LIST".',
      p_success_msg            => 'Resource list for the selected project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_RESOURCE_LISTS_ALL_BG');



debug('begin add_signature: PA_RESOURCE_LIST_ASSIGNMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12104',
      p_sig_id                 => 'PA_RESOURCE_LIST_ASSIGNMENTS',
      p_sig_sql                => 'SELECT
    rla.resource_list_assignment_id, rla.resource_list_id, rla.resource_list_changed_flag, rla.resource_list_accumulated_flag, 
    rla.last_update_date, rla.creation_date, rla.used_in_wp_flag, rla.used_in_fp_flag
FROM
    pa_resource_list_assignments rla
WHERE
    rla.project_id = ##$$PROJECT_ID$$##
ORDER BY
    rla.resource_list_id',
      p_title                  => 'Resource List Assignments',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Resource list assignments do not exist for the selected project.',
      p_solution               => '',
      p_success_msg            => 'Resource list assignments exist for the selected project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_RESOURCE_LIST_ASSIGNMENTS');



debug('begin add_signature: EBS_FIN_PA_TRANS_CONTROLS');
   l_info('##MASK##EMPLOYEE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30566',
      p_sig_id                 => 'EBS_FIN_PA_TRANS_CONTROLS',
      p_sig_sql                => 'SELECT tc.* ,
...
ORDER BY tc.task_id',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No transaction controls found for this project.',
      p_solution               => '',
...
You can configure transaction controls by employee, expenditure category, expenditure type, and non-labor resource.',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_TRANS_CONTROLS');



debug('begin add_signature: EBS_FIN_PA_PROJECTS_SECURITY_EXTENSION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28774',
      p_sig_id                 => 'EBS_FIN_PA_PROJECTS_SECURITY_EXTENSION',
      p_sig_sql                => 'SELECT
    text
FROM
    dba_source
WHERE
    name = ''PA_SECURITY_EXTN''
    AND   owner = ''APPS''
    AND   type = ''PACKAGE BODY''',
      p_title                  => 'Projects Security Extension',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Projects security extension extension found.',
      p_solution               => '',
      p_success_msg            => 'Projects security extension extension found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PROJECTS_SECURITY_EXTENSION');



debug('begin add_signature: EBS_FIN_PA_ORG_AUTHORITY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28952',
      p_sig_id                 => 'EBS_FIN_PA_ORG_AUTHORITY',
      p_sig_sql                => 'SELECT
    decode(mu.menu_name, ''PA_PRM_RES_AUTH'', ''Project Authority'', ''PA_PRM_PROJ_AUTH'', ''Resource Authority'',
           ''PA_PRM_RES_PRMRY_CONTACT'', ''Resource Primary Contact'', ''PA_PRM_UTL_AUTH'', ''Utilization Authority'') "Authority Type",
    org.name                                                                                                   "Organization",
    instance_pk1_value                                                                                         "Organization Id"
FROM
    fnd_grants            fg,
    fnd_objects           fo,
    fnd_menus             mu,
...
WHERE
    ...
    AND org.organization_id = instance_pk1_value
    AND fg.instance_type = ''INSTANCE''
    AND fg.menu_id = mu.menu_id
    AND fg.grantee_type = ''USER''
    AND fg.grantee_key IN (
        SELECT
            wfr.name
        FROM
            per_all_people_f per, wf_roles  wfr
        WHERE
                per.person_id = (
                    SELECT
                        fu.employee_id
    ...
    AND mu.menu_name IN ( ''PA_PRM_RES_AUTH'', ''PA_PRM_PROJ_AUTH'', ''PA_PRM_RES_PRMRY_CONTACT'', ''PA_PRM_UTL_AUTH'' )
ORDER BY     1, 2',
      p_title                  => 'Organization Authority',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'None of the following Organization authorities are granted to the user''s employee.<br/>
 - Project Authority<br/>
 - Resource Authority<br/>
 - Resource Primary Contact <br/>
 - Utilization Authority
',
      p_solution               => '',
      p_success_msg            => 'Organization authorities granted to the user''s employee.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_ORG_AUTHORITY');



debug('begin add_signature: EBS_FIN_PA_RESPONSIBILITY_MENU_EXCLUSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28769',
      p_sig_id                 => 'EBS_FIN_PA_RESPONSIBILITY_MENU_EXCLUSIONS',
      p_sig_sql                => 'SELECT
    frv.responsibility_name                                               responsibility,
    fmv.user_menu_name                                                    menu,
    decode(frf.rule_type, ''F'', ''Function'', ''M'', ''Menu'')                   menu_exclusion_type,
    decode(frf.rule_type, ''F'', fffv.user_function_name, ''M'', fmev.prompt) name
FROM
...
WHERE
        frv.responsibility_id =   ##$$FK2$$##
   AND  frv.responsibility_id =   ##$$RESP_ID$$##
    AND frv.application_id = 275
    AND frv.menu_id = fmv.menu_id
    AND frv.responsibility_id = frf.responsibility_id
    AND frv.application_id = frf.application_id
    AND frf.action_id = decode(frf.rule_type, ''F'', fffv.function_id, ''M'', fmev.menu_id)
    AND fffv.function_id (+) = frf.action_id
    AND fmev.menu_id (+) = frf.action_id',
      p_title                  => 'Responsibility Menu Exclusions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are menu exclusions for this responsibility.',
      p_solution               => '',
      p_success_msg            => 'There are no menu exclusions for this responsibility.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_RESPONSIBILITY_MENU_EXCLUSIONS');



debug('begin add_signature: EBS_FIN_PA_RESPONSIBILITY_EXCLUDED_ITEMS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28770',
      p_sig_id                 => 'EBS_FIN_PA_RESPONSIBILITY_EXCLUDED_ITEMS',
      p_sig_sql                => 'SELECT
    aav.name             excluded_item,
    fav.application_name application
FROM
    fnd_responsibility_vl frv,
    ak_excluded_items     aei,
    ak_attributes_vl      aav,
    fnd_application_vl    fav
WHERE
        frv.responsibility_id =  ##$$FK2$$##
AND   frv.responsibility_id = ##$$RESP_ID$$##
    AND frv.application_id = 275
    AND frv.responsibility_id = aei.responsibility_id
    AND frv.application_id = aei.resp_application_id
    AND aei.attribute_application_id = aav.attribute_application_id
    AND aei.attribute_code = aav.attribute_code
    AND aav.attribute_application_id = fav.application_id',
      p_title                  => 'Responsibility Excluded Item(s)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Responsibility excluded item(s) exist.',
      p_solution               => '',
      p_success_msg            => 'There are no responsibility excluded item(s).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_RESPONSIBILITY_EXCLUDED_ITEMS');



debug('begin add_signature: EBS_FIN_PA_RESPONSIBILITY_SECURING_ATTRIBUTES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28771',
      p_sig_id                 => 'EBS_FIN_PA_RESPONSIBILITY_SECURING_ATTRIBUTES',
      p_sig_sql                => 'SELECT
    aav.name             securing_attribute,
    fav.application_name application
FROM
    fnd_responsibility_vl       frv,
...
AND frv.responsibility_id =  ##$$RESP_ID$$##
    AND frv.application_id = 275
        AND frv.responsibility_id = arsa.responsibility_id
            AND frv.application_id = arsa.resp_application_id
                AND arsa.attribute_application_id = aav.attribute_application_id
                    AND arsa.attribute_code = aav.attribute_code
                        AND aav.attribute_application_id = fav.application_id 
',
      p_title                  => 'Responsibility Securing Attributes ',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Responsibility securing attributes exist.',
      p_solution               => '',
      p_success_msg            => 'No responsibility securing attributes exist.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_RESPONSIBILITY_SECURING_ATTRIBUTES');



debug('begin add_signature: EBS_FIN_PA_RESPONSIBILITY_MENU');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28768',
      p_sig_id                 => 'EBS_FIN_PA_RESPONSIBILITY_MENU',
      p_sig_sql                => 'SELECT
    frv.responsibility_name responsibility,
    fmv.user_menu_name      menu,
 frv.responsibility_id  "##$$FK2$$##"
...
WHERE
    ...
    AND frv.application_id = 275
    AND frv.menu_id = fmv.menu_id',
      p_title                  => 'Menu Assigned to Responsibility',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no menu assigned to the responsibility associated with the Projects application. Either the responsibility is not entered in the analyzer parameter or the application associated with the responsibility is not Projects.',
      p_solution               => '',
      p_success_msg            => 'Menu assigned to the responsibility associated with the Projects application. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('EBS_FIN_PA_RESPONSIBILITY_MENU_EXCLUSIONS','EBS_FIN_PA_RESPONSIBILITY_EXCLUDED_ITEMS','EBS_FIN_PA_RESPONSIBILITY_SECURING_ATTRIBUTES'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '5'
      );
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_RESPONSIBILITY_MENU');



debug('begin add_signature: EBS_FIN_PA_ACCOUNTING_FLEXFIELD_SETUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28362',
      p_sig_id                 => 'EBS_FIN_PA_ACCOUNTING_FLEXFIELD_SETUP',
      p_sig_sql                => 'SELECT
    f.id_flex_name                     "Structure",
    svl.id_flex_structure_code        "Structure Code",
    svl.id_flex_structure_name        "Structure Name",
    svl.enabled_flag                   "Enabled",
    svl.freeze_flex_definition_flag    "Frozen",
    svl.dynamic_inserts_allowed_flag   "Dynamic Inserts Allowed ",
    svl.cross_segment_validation_flag  "Cross Validation Allowed",
    svl.concatenated_segment_delimiter "Segment Delimiter"
FROM
    fnd_id_flexs              f,
    fnd_id_flex_structures_vl svl
WHERE
        f.id_flex_code = svl.id_flex_code
    AND f.application_id = svl.application_id
    ...
    AND svl.id_flex_num = (
        ...
        WHERE
                sob.set_of_books_id = i.set_of_books_id
            AND i.org_id =  ##$$ORG_ID$$##
    )',
      p_title                  => 'Accounting Flexfield Setup',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Key Flexfield: Accounting Flexfield is not setup.',
      p_solution               => '',
      p_success_msg            => 'Key Flexfield: Accounting Flexfield is setup.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_ACCOUNTING_FLEXFIELD_SETUP');



debug('begin add_signature: EBS_FIN_PA_ACCOUNTING_FLEXFIELD_SEGMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28409',
      p_sig_id                 => 'EBS_FIN_PA_ACCOUNTING_FLEXFIELD_SEGMENTS',
      p_sig_sql                => 'SELECT    S.SEGMENT_NUM "Segment number",
     S.SEGMENT_NAME "Segment Name",
     S.ENABLED_FLAG "Enabled",
     S.REQUIRED_FLAG "Required",
     S.APPLICATION_COLUMN_NAME "Application Column Name",
     S.FLEX_VALUE_SET_ID "Valueset Id",
     V.FLEX_VALUE_SET_NAME "Value Set " ,
     seg_prompt ||''(''|| nvl(seg_attribute_type, ''No Qualifiers'')  ||'')'' "Qualifiers (Segment Attr Type)"
          FROM FND_ID_FLEX_SEGMENTS_VL S, FND_FLEX_VALUE_SETS V ,
          (SELECT SAV.APPLICATION_COLUMN_NAME q_app_column_name, SAT.SEGMENT_PROMPT seg_prompt, SAV.SEGMENT_ATTRIBUTE_TYPE seg_attribute_type
          FROM FND_SEGMENT_ATTRIBUTE_VALUES SAV, FND_SEGMENT_ATTRIBUTE_TYPES SAT  
         ...
         AND   SAV.ID_FLEX_NUM = (  SELECT sob.chart_of_accounts_id  FROM   gl_sets_of_books sob, pa_implementations_all i  
         WHERE  sob.set_of_books_id = i.set_of_books_id  and i.org_id = ##$$ORG_ID$$##) ) Qualifiers 
          WHERE S.FLEX_VALUE_SET_ID = V.FLEX_VALUE_SET_ID(+) 
          AND   S.APPLICATION_ID =101 
          AND   S.ID_FLEX_CODE =''GL#''
          AND Qualifiers. q_app_column_name(+)= S.APPLICATION_COLUMN_NAME
          AND  S.ID_FLEX_NUM = (  SELECT sob.chart_of_accounts_id  FROM   gl_sets_of_books sob, pa_implementations_all i  
         WHERE  sob.set_of_books_id = i.set_of_books_id  and i.org_id = ##$$ORG_ID$$##)
          ORDER BY S.SEGMENT_NUM',
      p_title                  => 'Key Flexfield: Accounting Flexfield Segments',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Key Flexfield: Accounting Flexfield Segments are not defined.',
      p_solution               => '',
      p_success_msg            => 'Key Flexfield: Accounting Flexfield Segments are defined.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_ACCOUNTING_FLEXFIELD_SEGMENTS');



debug('begin add_signature: EBS_FIN_PA_INVALID_AA_PARAMETERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28739',
      p_sig_id                 => 'EBS_FIN_PA_INVALID_AA_PARAMETERS',
...
AND ft.function_code in (''DLC'', ''TLC'', ''BER'', ''TER'',
                         ''DUC'', ''TUC'', ''DJC'', ''TJC'',
                         ''DBC'', ''TBC'', ''DVC'', 
                         ''DIC'', ''TIC'', ''DWC'', ''TWC'', 
                         ''CPC'',''CPD'',''CBR'',''CLN'',''GLR'',
...
AND NOT EXISTS
  ...
  AND fp.parameter_id    = rp.parameter_id
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invalid AutoAccounting parameters identified.',
      p_solution               => 'Review the following solutions:<br>
...
[552086/FAQ4118]AutoAccounting in Projects Frequently Asked Questions (FAQ)',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_INVALID_AA_PARAMETERS');
...
debug('begin add_signature: EBS_FIN_PA_AUTOACCOUNTING_FUNCTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28736',
      p_sig_id                 => 'EBS_FIN_PA_AUTOACCOUNTING_FUNCTIONS',
      p_sig_sql                => 'SELECT  fnc.function_code,
       fnc.function_name,
       ft.function_transaction_code,
       ft.function_transaction_name,
       decode (ft.enabled_flag, ''Y'',''Enabled'', ''Not Enabled'') "Enabled Y/N"
FROM
    pa_function_transactions_all ft,
    pa_functions fnc
WHERE fnc.function_code = ft.function_code
      and ft.org_id = ##$$ORG_ID$$## order by 1, 3
',
      p_title                  => 'AutoAccounting Functions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'AutoAccounting functions are not defined.',
      p_solution               => 'AutoAccounting functions are not defined.',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_AUTOACCOUNTING_FUNCTIONS');
...
debug('begin add_signature: EBS_FIN_PA_PA_GL_LEDGER_NAME');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28717',
      p_sig_id                 => 'EBS_FIN_PA_PA_GL_LEDGER_NAME',
      p_sig_sql                => 'select decode(to_char(pov.level_id),''10001'', ''Site'',''10002'', ''Application'',''10003'', ''Responsibility'',''10005'', ''Server'',''10006'', ''Org'',''10007'', ''Servresp'', ''???'') "Level" ,
       decode(to_char(pov.level_id),''10001'', ''Site'',
        ...
        where  po.profile_option_name =''GL_SET_OF_BKS_NAME''
	...
	and    n.language=''US''
        and (pov.level_id in (10001,10002,10005,10006,10007) or ( pov.level_id=10003 and rsp.APPLICATION_ID = 275 ))
        order by pov.level_id,"Context"   
',
      p_title                  => 'Profile GL: Ledger Name',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No profile value(s) defined for the profile option GL: Ledger Name.',
      p_solution               => 'Review the solution in [2597229/KB220345] PRC: Create Accounting - Operating Unit Parameter error message - APP-FND-00806: The default value XXXXX Set of Books is invalid for the Ledger segment. Your default value will be ignored.',
      p_success_msg            => 'Profile value(s) defined for the profile option GL: Ledger Name.  ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_GL_LEDGER_NAME');



debug('begin add_signature: EBS_FIN_PA_PA_GL_DATA_ACCESS_SET');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28718',
      p_sig_id                 => 'EBS_FIN_PA_PA_GL_DATA_ACCESS_SET',
      p_sig_sql                => 'select decode(to_char(pov.level_id),''10001'', ''Site'',''10002'', ''Application'',''10003'', ''Responsibility'',''10005'', ''Server'',''10006'', ''Org'',''10007'', ''Servresp'', ''???'') "Level" ,
       decode(to_char(pov.level_id),''10001'', ''Site'',
              ''10002'', nvl(app.application_short_name,to_char(pov.level_value)),''10003'', nvl(rsp.responsibility_name,to_char(pov.level_value)),
              ''10005'', svr.node_name,''10006'', org.name,''10007'', pov.level_value ||'', ''|| pov.level_value_application_id ||'', ''|| pov.level_value2,''???'') "Context", pov.profile_option_value "Profile Value"
        from   fnd_profile_options po,fnd_profile_option_values pov,fnd_profile_options_tl n,
               fnd_user usr,fnd_application app,fnd_responsibility_vl rsp,fnd_nodes svr,hr_operating_units org
        where  po.profile_option_name =''GL_ACCESS_SET_ID''
        and    pov.application_id = po.application_id
        and    po.profile_option_name = n.profile_option_name
        and    pov.profile_option_id = po.profile_option_id
        and    usr.user_id (+) = pov.level_value
	...
	and    n.language=''US''
        ...
        order by pov.level_id,"Context"   
',
      p_title                  => 'Profile GL: Data Access Set',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No profile value(s) defined for the profile option GL: Data Access Set.',
      p_solution               => '',
      p_success_msg            => 'Profile value(s) defined for GL: Data Access Set.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_GL_DATA_ACCESS_SET');



debug('begin add_signature: EBS_FIN_PA_PA_HR_SECURITY_PROFILE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28719',
      p_sig_id                 => 'EBS_FIN_PA_PA_HR_SECURITY_PROFILE',
      p_sig_sql                => 'select decode(to_char(pov.level_id),''10001'', ''Site'',''10002'', ''Application'',''10003'', ''Responsibility'',''10005'', ''Server'',''10006'', ''Org'',''10007'', ''Servresp'', ''???'') "Level" ,
       decode(to_char(pov.level_id),''10001'', ''Site'',
              ''10002'', nvl(app.application_short_name,to_char(pov.level_value)),''10003'', nvl(rsp.responsibility_name,to_char(pov.level_value)),
              ''10005'', svr.node_name,''10006'', org.name,''10007'', pov.level_value ||'', ''|| pov.level_value_application_id ||'', ''|| pov.level_value2,''???'') "Context", pov.profile_option_value "Profile Value"
...
',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No profile value(s) defined for the profile option HR: Security Profile.
',
      p_solution               => '',
      p_success_msg            => 'Profile value(s) defined for HR: Security Profile.  The profile is used to assign a security profile to each responsibility, to restrict access to the organization, positions, and payrolls defined in a security profile.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_HR_SECURITY_PROFILE');



debug('begin add_signature: EBS_FIN_PA_PA_HR_CROSS_BUSINESS_GROUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28722',
      p_sig_id                 => 'EBS_FIN_PA_PA_HR_CROSS_BUSINESS_GROUP',
      p_sig_sql                => 'select decode(to_char(pov.level_id),''10001'', ''Site'',''10002'', ''Application'',''10003'', ''Responsibility'',''10005'', ''Server'',''10006'', ''Org'',''10007'', ''Servresp'', ''???'') "Level" ,
       decode(to_char(pov.level_id),''10001'', ''Site'',
              ''10002'', nvl(app.application_short_name,to_char(pov.level_value)),''10003'', nvl(rsp.responsibility_name,to_char(pov.level_value)),
              ''10005'', svr.node_name,''10006'', org.name,''10007'', pov.level_value ||'', ''|| pov.level_value_application_id ||'', ''|| pov.level_value2,''???'') "Context", pov.profile_option_value "Profile Value"
        from   fnd_profile_options po,fnd_profile_option_values pov,fnd_profile_options_tl n,
               fnd_user usr,fnd_application app,fnd_responsibility_vl rsp,fnd_nodes svr,hr_operating_units org
        where  po.profile_option_name =''HR_CROSS_BUSINESS_GROUP''
        and    pov.application_id = po.application_id
        and    po.profile_option_name = n.profile_option_name
        and    pov.profile_option_id = po.profile_option_id
        and    usr.user_id (+) = pov.level_value
	...
	and    n.language=''US''
        ...
        order by pov.level_id,"Context"   
',
      p_title                  => 'Profile HR:Cross Business Group',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No profile value(s) defined for the profile option HR:Cross Business Group.',
      p_solution               => 'Review the solution in [1571730/KB601343] Does Oracle Projects Allow Access To All Operating Units Across Business Groups Using One Projects Responsibility?',
      p_success_msg            => 'Profile value(s) defined for the profile option HR:Cross Business Group. This profile defines whether Single Business Group Access mode or Cross Business Group Access mode is used in your installation.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_HR_CROSS_BUSINESS_GROUP');



debug('begin add_signature: EBS_FIN_PA_PA_HR_ENABLE_SECURITY_GROUPS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28723',
      p_sig_id                 => 'EBS_FIN_PA_PA_HR_ENABLE_SECURITY_GROUPS',
      p_sig_sql                => 'select decode(to_char(pov.level_id),''10001'', ''Site'',''10002'', ''Application'',''10003'', ''Responsibility'',''10005'', ''Server'',''10006'', ''Org'',''10007'', ''Servresp'', ''???'') "Level" ,
       decode(to_char(pov.level_id),''10001'', ''Site'',
              ''10002'', nvl(app.application_short_name,to_char(pov.level_value)),''10003'', nvl(rsp.responsibility_name,to_char(pov.level_value)),
              ''10005'', svr.node_name,''10006'', org.name,''10007'', pov.level_value ||'', ''|| pov.level_value_application_id ||'', ''|| pov.level_value2,''???'') "Context", pov.profile_option_value "Profile Value"
	...
	and    n.language=''US''
        ...
        order by pov.level_id,"Context"   
',
      p_title                  => 'Profile HR:  Enable Security Groups',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No profile value(s) defined for the profile option HR:  Enable Security Groups.',
      p_solution               => '',
      p_success_msg            => 'Profile value(s) defined for the profile option HR:  Enable Security Groups.  This profile controls whether you use security groups within security. Only change the default to Yes at the application level if your enterprise is using Cross Business Group Responsibility security. If you change the default to Yes, you must run the Enable Multiple Security Groups process.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_HR_ENABLE_SECURITY_GROUPS');



debug('begin add_signature: EBS_FIN_PA_PA_MO_SECURITY_PROFILE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28720',
      p_sig_id                 => 'EBS_FIN_PA_PA_MO_SECURITY_PROFILE',
      p_sig_sql                => 'select decode(to_char(pov.level_id),''10001'', ''Site'',''10002'', ''Application'',''10003'', ''Responsibility'',''10005'', ''Server'',''10006'', ''Org'',''10007'', ''Servresp'', ''???'') "Level" ,
       decode(to_char(pov.level_id),''10001'', ''Site'',
              ''10002'', nvl(app.application_short_name,to_char(pov.level_value)),''10003'', nvl(rsp.responsibility_name,to_char(pov.level_value)),
              ''10005'', svr.node_name,''10006'', org.name,''10007'', pov.level_value ||'', ''|| pov.level_value_application_id ||'', ''|| pov.level_value2,''???'') "Context", pov.profile_option_value "Profile Value"
	...
	and    n.language=''US''
        ...
        order by pov.level_id,"Context"   
',
      p_title                  => 'Profile MO: Security Profile',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No profile value(s) defined for the profile option MO: Security Profile.
',
      p_solution               => '',
      p_success_msg            => 'Profile value(s) defined for the profile option MO: Security Profile. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_MO_SECURITY_PROFILE');



debug('begin add_signature: EBS_FIN_PA_PA_MO_OPERATING_UNIT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28716',
      p_sig_id                 => 'EBS_FIN_PA_PA_MO_OPERATING_UNIT',
      p_sig_sql                => 'select decode(to_char(pov.level_id),''10001'', ''Site'',''10002'', ''Application'',''10003'', ''Responsibility'',''10005'', ''Server'',''10006'', ''Org'',''10007'', ''Servresp'', ''???'') "Level" ,
       decode(to_char(pov.level_id),''10001'', ''Site'',
              ''10002'', nvl(app.application_short_name,to_char(pov.level_value)),''10003'', nvl(rsp.responsibility_name,to_char(pov.level_value)),
              ''10005'', svr.node_name,''10006'', org.name,''10007'', pov.level_value ||'', ''|| pov.level_value_application_id ||'', ''|| pov.level_value2,''???'') "Context", pov.profile_option_value "Profile Value"
...
',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No profile value(s) defined for the profile option MO: Operating Unit.<br>
Details in<br> 
[414013/KB634487] Troubleshooting MOAC issues in Oracle Projects <br> 
[414003/KB629997] MOAC Feature And MOAC Uptake in Oracle Projects',
      p_solution               => '',
      p_success_msg            => 'Profile value(s) defined for MO: Operating Unit.<br>
Details in<br> 
[414013/KB634487] Troubleshooting MOAC issues in Oracle Projects <br> 
[414003/KB629997] MOAC Feature And MOAC Uptake in Oracle Projects',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_MO_OPERATING_UNIT');



debug('begin add_signature: EBS_FIN_PA_PA_MO_DEFAULT_OPERATING_UNIT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28721',
      p_sig_id                 => 'EBS_FIN_PA_PA_MO_DEFAULT_OPERATING_UNIT',
      p_sig_sql                => 'select decode(to_char(pov.level_id),''10001'', ''Site'',''10002'', ''Application'',''10003'', ''Responsibility'',''10005'', ''Server'',''10006'', ''Org'',''10007'', ''Servresp'', ''???'') "Level" ,
       decode(to_char(pov.level_id),''10001'', ''Site'',
              ''10002'', nvl(app.application_short_name,to_char(pov.level_value)),''10003'', nvl(rsp.responsibility_name,to_char(pov.level_value)),
              ''10005'', svr.node_name,''10006'', org.name,''10007'', pov.level_value ||'', ''|| pov.level_value_application_id ||'', ''|| pov.level_value2,''???'') "Context", pov.profile_option_value "Profile Value"
        from   fnd_profile_options po,fnd_profile_option_values pov,fnd_profile_options_tl n,
               fnd_user usr,fnd_application app,fnd_responsibility_vl rsp,fnd_nodes svr,hr_operating_units org
        where  po.profile_option_name =''DEFAULT_ORG_ID''
        and    pov.application_id = po.application_id
        and    po.profile_option_name = n.profile_option_name
        and    pov.profile_option_id = po.profile_option_id
        and    usr.user_id (+) = pov.level_value
...
',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No profile value(s) defined for the profile option MO: Default Operating Unit.<br>
Details in:<br>
[1310305/KB483405] How to Access Data from Multiple Operating Units from a Single Responsibility like Projects or Resources? <br>
[414003/KB629997] MOAC Feature And MOAC Uptake in Oracle Projects<br>',
      p_solution               => '',
      p_success_msg            => 'Profile value(s) defined for the profile option MO: Default Operating Unit. MO: Default Operating Unit is used to specify the default operating unit option for a responsibility.  This option is valid only when MO: Security Profile profile option is set.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_MO_DEFAULT_OPERATING_UNIT');
...
debug('begin add_signature: EBS_FIN_PA_PROJECT_ACCESS_LEVEL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28807',
      p_sig_id                 => 'EBS_FIN_PA_PROJECT_ACCESS_LEVEL',
      p_sig_sql                => 'select ppa.segment1 "Project Number", 
ppa.name "Project Name", 
pl.meaning "Project Access Level"
from pa_projects_all ppa, pa_lookups pl 
where ppa.project_id = ##$$PROJECT_ID$$##
and ppa.security_level = pl.lookup_code 
and pl.lookup_type = ''PA_PROJECT_ACCESS_LEVEL''
',
      p_title                  => 'Project Access Level',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Project access level gives project access to either users with a certain role/authority on the project or access to all enterprise users (all employees + users with role/authority on project).',
      p_solution               => 'For details see:
<li>[404550/KB385448] How Does Organization Authority Work in Order to View Projects?</li>
<li>[565524/KB440217] Why Are Some Projects Visible in the HTML Pages But Not in the Projects Forms?</li>
<li>[393448/KB498896] How to Only Allow Inquiry/View on Projects and Not Allow Project Creation For Certain Responsibilities</li>
',
      p_success_msg            => 'Project access level is a project attribute that gives project access to either users with a certain role/authority on the project or access to all enterprise users (all employees + users with role/authority on project).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PROJECT_ACCESS_LEVEL');



debug('begin add_signature: EBS_FIN_PA_PROJECT_STATUS_ROLE_MENUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28954',
      p_sig_id                 => 'EBS_FIN_PA_PROJECT_STATUS_ROLE_MENUS',
      p_sig_sql                => 'SELECT
    pps.project_status_name "Project Status",
    pprt.meaning            "Role",
    fmv.user_menu_name      "Project Status Security Menu",
    ppp.start_date_active   "Role Effective From",
    ppp.end_date_active     "Role Effective To"
FROM
    pa_projects_all         ppa,
    pa_project_players      ppp,
    pa_project_role_types   pprt,
    fnd_menus_vl            fmv,
    pa_role_status_menu_map prsmm,
...
WHERE
   ...
   AND ppp.person_id = (
    ...
    AND pprt.project_role_id = prsmm.role_id
    AND ppa.project_id = ppp.project_id
    AND ppa.project_status_code = pps.project_status_code
    AND ppa.project_status_code = prsmm.status_code
    AND prsmm.menu_id = fmv.menu_id
ORDER BY
    pprt.meaning   
    ',
      p_title                  => 'Role Based Authority - User Project Status Role Menus On Project',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'User does not have project status role menus on the selected project.',
      p_solution               => '',
      p_success_msg            => 'User has project status role menus on the selected project.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PROJECT_STATUS_ROLE_MENUS');



debug('begin add_signature: EBS_FIN_PA_USER_ROLE_MENUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28953',
      p_sig_id                 => 'EBS_FIN_PA_USER_ROLE_MENUS',
      p_sig_sql                => 'SELECT
    pprt.meaning        "Role",
    fmv.user_menu_name    "Role Based Menu",
    ppp.start_date_active  "Role Effective From",
    ppp.end_date_active  "Role Effective To"
FROM
    pa_project_players    ppp,
    ...
    fnd_menus_vl          fmv
WHERE
    ppp.project_id = nvl(##$$PROJECT_ID$$## , NULL)
    AND ppp.person_id = (
        SELECT
            fu.employee_id
        FROM
    ...
    AND trunc(sysdate) BETWEEN trunc(ppp.start_date_active) AND trunc(nvl(ppp.end_date_active, sysdate + 1))
    AND ppp.project_role_type = pprt.project_role_type
    AND pprt.menu_id = fmv.menu_id
ORDER BY
    pprt.meaning ',
      p_title                  => 'Role Based Authority - User Role Menus On Project',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No role menus on the selected project for the selected user.
',
      p_solution               => '',
      p_success_msg            => 'Role menus on the selected project for the selected user.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_USER_ROLE_MENUS');



debug('begin add_signature: EBS_FIN_PA_INVALID_TASK_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28477',
      p_sig_id                 => 'EBS_FIN_PA_INVALID_TASK_ID',
      p_sig_sql                => ' SELECT project_id,
   project_number,
   str_version_id
FROM (
    SELECT project_id,
     segment1 project_number,
pa_project_structure_utils.get_latest_fin_struc_ver_id(project_id)
str_version_id
    FROM pa_projects_all pa,
pa_project_statuses pps
    WHERE pa.project_status_code = pps.project_status_code
     AND pps.project_system_status_code != ''CLOSED''
     AND pps.status_type = ''PROJECT''
     AND TRUNC(SYSDATE) BETWEEN pps.start_date_active
  AND NVL(pps.end_date_active, TRUNC(SYSDATE))
--AND pa.structure_sharing_code = ''SHARE_FULL''
--AND pa.template_flag =''N''
     AND
nvl(pa_workplan_attr_utils.check_wp_versioning_enabled(pa.project_id),''N'')=''N''
) p
   WHERE project_id IN(      
       --Find elements missing in element version table
   SELECT pt.project_id
       FROM pa_tasks pt,
        pa_proj_element_versions pev,
pa_proj_elements pe
       WHERE pt.project_id = p.project_id
    AND p.str_version_id = pev.parent_structure_version_id(+)
...
AND pt.task_id = pe.proj_element_id(+)
        AND (pev.proj_element_id IS NULL OR pe.proj_element_id IS NULL)
       UNION
...
AND pev.parent_structure_version_id = p.str_version_id
AND pe.project_id = pt.project_id(+)
AND pe.proj_element_id = pt.task_id(+)
        AND pt.task_id IS NULL)
AND PROJECT_ID= ##$$PROJECT_ID$$##',
      p_title                  => 'Tasks In PA_TASKS Do Not Exist In PA_PROJ_ELEMENTS And Vice Versa',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are tasks which exist in the PA_TASKS table but not in PA_PROJ_ELEMENTS and vice versa.',
      p_solution               => 'Please log a Service Request, for possible datafix, referring to [2774540/KB402174] PAXPREPR When Trying To Update the Task Name on a Project the Following Error Occurs: ''The task has not been updated. Invalid task id''.',
      p_success_msg            => 'All tasks exist in both PA_TASKS and PA_PROJ_ELEMENTS tables.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_INVALID_TASK_ID');



debug('begin add_signature: PA_WP_MISSING_WORKPLAN_FULLY_SHARED_VERSION_DISABLED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '21418',
      p_sig_id                 => 'PA_WP_MISSING_WORKPLAN_FULLY_SHARED_VERSION_DISABLED',
      p_sig_sql                => 'SELECT project_id, 
   project_number,
   str_version_id
  FROM (
    SELECT project_id,
     segment1 project_number,
         pa_project_structure_utils.get_latest_fin_struc_ver_id(project_id) str_version_id
    FROM pa_projects_all pa,
         pa_project_statuses pps
    WHERE pa.project_id=##$$PROJECT_ID$$##
     ...
     AND TRUNC(SYSDATE) BETWEEN pps.start_date_active 
         ...
         AND pa.structure_sharing_code = ''SHARE_FULL''
         --AND pa.template_flag =''N''
     AND (pa_workplan_attr_utils.check_wp_versioning_enabled(pa.project_id)=''N'' OR
          (pa_workplan_attr_utils.check_wp_versioning_enabled(pa.project_id)=''Y''
     AND PA_PROJ_TASK_STRUC_PUB.Published_version_exists(pa.project_id)=''N''))) p
   WHERE project_id IN(      
       --Find elements missing in element version table
           SELECT pt.project_id
       FROM     pa_tasks pt,
       ...
       WHERE  pe.project_id = p.project_id
            ...
            AND pe.project_id = ##$$PROJECT_ID$$##
                ...
                AND pe.proj_element_id = pt.task_id(+)
        AND pt.task_id IS NULL)',
      p_title                  => 'Task Missing In Workplan Table  (Versioning Disabled)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Mismatch between task structure and workplan structure in workplan table for fully shared versioning disabled.
',
      p_solution               => 'Please log Service Request along with Project Planning and Control analyzer [2860729/KB546380] output for the project number to get possible data fix based on [2847100/KB703436#ANCHOR2].',
      p_success_msg            => 'There is no corruption.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_WP_MISSING_WORKPLAN_FULLY_SHARED_VERSION_DISABLED');



debug('begin add_signature: PA_WP_MISSING_WORKPLAN_FULLY_SHARED_VERSION_ENABLED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17858',
      p_sig_id                 => 'PA_WP_MISSING_WORKPLAN_FULLY_SHARED_VERSION_ENABLED',
      p_sig_sql                => 'SELECT project_id, 
   project_number,
   str_version_id
  FROM (
    ...
    WHERE pa.project_status_code = pps.project_status_code
     ...
     AND TRUNC(SYSDATE) BETWEEN pps.start_date_active 
	  AND NVL(pps.end_date_active, TRUNC(SYSDATE))
	 AND pa.structure_sharing_code = ''SHARE_FULL''
     AND pa_workplan_attr_utils.check_wp_versioning_enabled(pa.project_id)=''Y'') p
   WHERE project_id IN(      
	   SELECT pt.project_id
       FROM	pa_tasks pt,
        pa_proj_element_versions pev,
       ...
       WHERE pt.project_id = p.project_id
		...
		AND pt.task_id = pe.proj_element_id(+)
        AND (pev.proj_element_id IS NULL OR pe.proj_element_id IS NULL))',
      p_title                  => 'Task Missing in Workplan Table (Versioning Enabled)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Mismatch between task and workplan structure in workplan table for fully shared versioning enabled.

',
      p_solution               => 'Please log Service Request along with the Project Planning and Control analyzer [2860729/KB546380] output for the project number to get possible data fix based on [2847100/KB703436#ANCHOR1].',
      p_success_msg            => 'No corruption exists.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_WP_MISSING_WORKPLAN_FULLY_SHARED_VERSION_ENABLED');



debug('begin add_signature: PA_WP_MISSING_WBS_WORKPLAN_FULLY_SHARED_VERSION_ENABLED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '21419',
      p_sig_id                 => 'PA_WP_MISSING_WBS_WORKPLAN_FULLY_SHARED_VERSION_ENABLED',
      p_sig_sql                => 'SELECT  ppa.project_id,ppa.segment1 "Project Number"
FROM pa_projects_all ppa,
  pa_tasks pt,
  pa_proj_elements ppe,
  pa_proj_element_versions ppev,
  pa_proj_elem_ver_structure ppevs
WHERE ppa.structure_sharing_code     = ''SHARE_FULL''
...
AND ppevs.element_version_id         =pa_project_structure_utils.get_latest_fin_struc_ver_id(ppa.project_id)
AND pt.wbs_level                    <> ppev.wbs_level
AND pa_proj_task_struc_pub.is_wp_versioning_enabled(ppa.project_id)=''Y''',
      p_title                  => 'WBS Level/Outline Number Missing in Workplan Table (Versioning Enabled)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Mismatch between task and workplan structure.  WBS Level, Outline Number missing in workplan table for fully shared workplan versioning enabled projects.
',
      p_solution               => 'Please log Service Request along with the Project Planning and Control analyzer [2860729/KB546380] output for the project number to get possible data fix based on [2847100/KB703436#ANCHOR3].',
      p_success_msg            => 'There is no corruption.
',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: PA_WP_MISSING_WBS_WORKPLAN_FULLY_SHARED_VERSION_ENABLED');



debug('begin add_signature: PA_WP_MISSING_WBS_WORKPLAN_FULLY_SHARED_VERSION_DISABLED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '21420',
      p_sig_id                 => 'PA_WP_MISSING_WBS_WORKPLAN_FULLY_SHARED_VERSION_DISABLED',
      p_sig_sql                => 'SELECT  ppa.project_id,ppa.segment1 "Project Number"
FROM pa_projects_all ppa,
  pa_tasks pt,
  pa_proj_elements ppe,
...
AND ppevs.element_version_id         =pa_project_structure_utils.get_latest_fin_struc_ver_id(ppa.project_id)
AND pt.wbs_level                    <> ppev.wbs_level
AND ppa.structure_sharing_code     = ''SHARE_FULL'' 
AND pa_proj_task_struc_pub.is_wp_versioning_enabled(ppa.project_id)=''N''',
      p_title                  => 'WBS Level/Outline Number Missing in Workplan Table (Versioning Disabled)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Mismatch between task and workplan structure. WBS Level, Outline Number missing in workplan table for fully shared workplan versioning disabled projects.
',
      p_solution               => 'Please log a Service Request with the Project Planning and Control analyzer [2860729/KB546380] output for the project number for a possible datafix, referring to [2847100/KB703436#ANCHOR4].',
      p_success_msg            => 'No corruption exists.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_WP_MISSING_WBS_WORKPLAN_FULLY_SHARED_VERSION_DISABLED');



debug('begin add_signature: PA_WP_MISSING_TASKS_FULLY_SHARED_VERSION_DISABLED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '21421',
      p_sig_id                 => 'PA_WP_MISSING_TASKS_FULLY_SHARED_VERSION_DISABLED',
      p_sig_sql                => 'SELECT  p.project_id,p.segment1 "Project Number"
FROM pa_projects_all p,
  pa_proj_elements ppe
WHERE p.project_id =ppe.project_id
...
AND ppe.proj_element_id NOT IN
  (SELECT task_id
     FROM pa_tasks pt
    WHERE pt.project_id=ppe.project_id
  )',
      p_title                  => 'Task Missing In Financial Table (Versioning Disabled)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Mismatch between task and workplan structure in financial table for fully shared versioning disabled.

',
      p_solution               => 'Please log Service Request along with the Project Planning and Control analyzer [2860729/KB546380] output for the project number to get possible data fix based on [2847100/KB703436#ANCHOR5].',
      p_success_msg            => 'There is no corruption.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_WP_MISSING_TASKS_FULLY_SHARED_VERSION_DISABLED');



debug('begin add_signature: EBS_FIN_PA_TASK_HIERARCHY_MISMATCH');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##WBS Level'):= ',#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '28731',
      p_sig_id                 => 'EBS_FIN_PA_TASK_HIERARCHY_MISMATCH',
      p_sig_sql                => 'SELECT DISTINCT
ppa.project_id,
...
AND pt.wbs_level > 1
AND ppa.project_id =  ##$$PROJECT_ID$$##',
      p_title                  => 'Task Hierarchy Mismatch',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Mismatch between task structure in the Projects form and workplan structure exists.',
      p_solution               => 'Review the solution in Mismatch of Tasks in Workplan Structure (PA_PROJ_ELEMENTS) And Financial Structure (PA_TASKS) [2847100/KB703436#ANCHOR6].',
      p_success_msg            => 'No mismatch between task structure in the Projects form and workplan structure exists.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_TASK_HIERARCHY_MISMATCH');



debug('begin add_signature: EBS_FIN_PA_MISSING_TASKS_NON_SHARED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28732',
      p_sig_id                 => 'EBS_FIN_PA_MISSING_TASKS_NON_SHARED',
      p_sig_sql                => 'SELECT pt.task_id,
pt.parent_task_id,
decode(pt.start_date,null,trunc(sysdate),pt.start_date) sch_beg_date,
decode(pt.completion_date,null,nvl((pt.start_date),trunc(sysdate)), pt.completion_date) sch_end_date,
pt.task_number,
pt.pm_task_reference,
pp.structure_sharing_code
FROM pa_tasks pt, pa_projects_all pp
WHERE pp.project_id = pt.project_id
AND pp.project_id = ##$$PROJECT_ID$$##
AND nvl(pa_project_structure_utils.check_sharing_enabled(##$$PROJECT_ID$$##),''N'') <> ''N''
AND (pt.task_id NOT IN(
SELECT proj_element_id
FROM pa_proj_element_versions
WHERE project_id =  ##$$PROJECT_ID$$##
AND object_type = ''PA_TASKS'')
OR pt. task_id NOT IN(
SELECT proj_element_id
FROM pa_proj_elements
WHERE project_id = ##$$PROJECT_ID$$##))
ORDER BY wbs_level, task_id',
      p_title                  => 'Tasks Missing In Workplan Tables (Non Shared)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Mismatch between task and workplan structure. Tasks are missing in the workplan tables for non shared structure.  ',
      p_solution               => 'Please log Service Request along with the Project Planning and Control analyzer [2860729/KB546380] output to get possible data fix based on [2847100/KB703436#ANCHOR7].',
      p_success_msg            => 'No tasks are missing in workplan tables for non shared structure.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_MISSING_TASKS_NON_SHARED');



debug('begin add_signature: EBS_FIN_PA_PA_WP_MISSING_AND_PREPENDED_TASKS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28730',
      p_sig_id                 => 'EBS_FIN_PA_PA_WP_MISSING_AND_PREPENDED_TASKS',
      p_sig_sql                => ' SELECT *
 FROM
 (
 SELECT distinct
         ''Identifying Query (1)'' Case_number,
          project_id project_id,
          PA_PROJECT_STRUCTURE_UTILS.GET_FIN_STRUCTURE_ID(project_id) fin_str_id,
          PA_PROJECT_STRUCTURE_UTILS.GET_FIN_STRUC_VER_ID(project_id) fin_str_ver_id,
          '''' pa_tasks_task_number,
          null pa_tasks_task_id
   FROM   pa_proj_elements
   WHERE  project_id in ( 
            SELECT project_id
            FROM   pa_tasks
   ...
   AND project_id NOT IN (
         SELECT ppwa.project_id
         FROM   pa_proj_workplan_attr ppwa,
                pa_proj_elements ppe,
                pa_proj_structure_types ppst,
                pa_structure_types pst
         WHERE  ppe.project_id = ppwa.project_id
         ...
         and project_id =  ##$$PROJECT_ID$$##
union all
         SELECT distinct''Identifying Query (2)'' Case_number, pt.project_id, PA_PROJECT_STRUCTURE_UTILS.GET_FIN_STRUCTURE_ID(pe.project_id) fin_str_id,
          PA_PROJECT_STRUCTURE_UTILS.GET_FIN_STRUC_VER_ID(pe.project_id) fin_str_ver_id, pt.task_number , pt.task_id
   FROM  pa_tasks pt,
         pa_proj_elements pe,
         pa_projects_all p
   WHERE pt.project_id = pe.project_id
   AND   pt.task_id = pe.proj_element_id
   AND   p.project_id = pt.project_id
   AND   pe.element_number = ''-''||pt.task_number
...
where not exists (
   ...
   AND    project_id = main.project_id
   AND    project_id in (
            SELECT project_id
            FROM pa_tasks
            WHERE task_id NOT IN (
   ...
   AND project_id NOT IN (
      ...
      p_title                  => 'Mismatch Between Task and Workplan Structures',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Mismatch between task and workplan structures.',
      p_solution               => 'Review the solution in [351670/PALRT1517] Data Fix for Mismatch Between Task Structures And Workplan Structures.',
      p_success_msg            => 'No mismatch between task and workplan structures.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_WP_MISSING_AND_PREPENDED_TASKS');



debug('begin add_signature: EBS_FIN_PA_PA_WP_MISSING_TASKS_WORKPLAN_CHECK_DELIVERABLES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28773',
      p_sig_id                 => 'EBS_FIN_PA_PA_WP_MISSING_TASKS_WORKPLAN_CHECK_DELIVERABLES',
      p_sig_sql                => ' SELECT *
 FROM
 (
 SELECT distinct
...
where exists (
   ...
   AND project_id NOT IN (
      ...
      p_title                  => 'Mismatch Between Task and Workplan Structure For Deliverables',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Mismatch between task and workplan structures for deliverables.
',
      p_solution               => 'Please log Service Request with Oracle Support and reference: [351670/PALRT1517] Data Fix for Mismatch Between Task Structures And Workplan Structures.

',
      p_success_msg            => 'No mismatch between task and workplan structure deliverables.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_WP_MISSING_TASKS_WORKPLAN_CHECK_DELIVERABLES');
...
BEGIN
  ...
  analyzer_title := 'Project Foundation Analyzer';
...
start_section('Data Issues', 'DATA_ISSUES');
   IF nvl(g_sql_tokens('##$$PROJECT_ID$$##'), 'no projectid') <> 'no projectid'  THEN
      set_item_result(run_stored_sig('EBS_FIN_PA_INVALID_TASK_ID'));
      set_item_result(run_stored_sig('PA_WP_MISSING_WORKPLAN_FULLY_SHARED_VERSION_DISABLED'));
      set_item_result(run_stored_sig('PA_WP_MISSING_WORKPLAN_FULLY_SHARED_VERSION_ENABLED'));
      set_item_result(run_stored_sig('PA_WP_MISSING_WBS_WORKPLAN_FULLY_SHARED_VERSION_ENABLED'));
      set_item_result(run_stored_sig('PA_WP_MISSING_WBS_WORKPLAN_FULLY_SHARED_VERSION_DISABLED'));
      set_item_result(run_stored_sig('PA_WP_MISSING_TASKS_FULLY_SHARED_VERSION_DISABLED'));
      set_item_result(run_stored_sig('EBS_FIN_PA_TASK_HIERARCHY_MISMATCH'));
      set_item_result(run_stored_sig('EBS_FIN_PA_MISSING_TASKS_NON_SHARED'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PA_WP_MISSING_AND_PREPENDED_TASKS'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PA_WP_MISSING_TASKS_WORKPLAN_CHECK_DELIVERABLES'));
   END IF;
   set_item_result(run_stored_sig('EBS_FIN_PA_MULTI_ORG_CATEGORY'));
   set_item_result(run_stored_sig('EBS_FIN_PA_INVALID_OBJECTS_AFTER_19C_UPGRADE'));
   set_item_result(run_stored_sig('EBS_FIN_PA_INVALID_USAGE_EFFECTIVE_START_DATE'));
end_section;
debug('end section: DATA_ISSUES');

debug('begin section: PROJECT_SETUPS');
start_section('Project Setups', 'PROJECT_SETUPS');
   set_item_result(run_stored_sig('EBS_FIN_PA_PROJECT_STATUS_CONTROL'));
   set_item_result(run_stored_sig('PA_EXPENDITURE_TYPE_COST_RATES_DEFINED'));
end_section;
debug('end section: PROJECT_SETUPS');

debug('begin section: PERIOD_DETAILS');
start_section('Period Details', 'PERIOD_DETAILS');
   set_item_result(run_stored_sig('EBS_FIN_PA_PA_PERIODS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_CURRENT_PA_PERIOD'));
   set_item_result(run_stored_sig('EBS_FIN_PA_RECENT_OPEN_OR_FUTURE_PA_PERIODS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_GL_PERIOD_SETUP'));
   set_item_result(run_stored_sig('EBS_FIN_PA_CURRENT_DATE_IN_OPEN_GL_PERIOD'));
   set_item_result(run_stored_sig('EBS_FIN_PA_LATEST_OPEN_GL_PERIOD'));
end_section;
debug('end section: PERIOD_DETAILS');

debug('begin section: IMPLEMENTATION_DETAILS');
start_section('Implementation Details', 'IMPLEMENTATION_DETAILS');
   set_item_result(run_stored_sig('EBS_FIN_PA_PA_IMPLEMENTATION_OPTIONS_MAIN'));
   set_item_result(run_stored_sig('EBS_FIN_PA_ACTIVE_PROJECT_ORG_MISSING_FROM_PA_ALL_ORGANIZATION'));
   set_item_result(run_stored_sig('EBS_FIN_PA_ACTIVE_EXPENDITURE_ORG_MISSING_FROM_PA_ALL_ORGANIZATION'));
   set_item_result(run_stored_sig('EBS_FIN_PA_INACTIVE_ORGANIZATIONS_INCLUDED_IN_PA_ALL_ORGANIZATIONS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PROJECT_ORGANIZATION_HIERARCHY'));
   set_item_result(run_stored_sig('EBS_FIN_PA_EXPENDITURE_EVENT_ORGANIZATION_HIERARCHY'));
   set_item_result(run_stored_sig('EBS_FIN_PA_REPORTING_ORGANIZATION_HIERARCHY'));
   set_item_result(run_stored_sig('EBS_FIN_PA_TAX_HIERARCHY'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PROJECT_TASK_STATUS_WF'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAYABLES_OPTIONS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAYABLES_FINANCIAL_OPTIONS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_AMG_SOURCE_PRODUCT_CONTROLS'));
end_section;
debug('end section: IMPLEMENTATION_DETAILS');
...
IF nvl(g_sql_tokens('##$$PROJECT_ID$$##'), 'no projectid') <> 'no projectid'  THEN
   start_section('Project Details', 'PROJECT_DETAILS');
      ...
      set_item_result(run_stored_sig('EBS_FIN_PA_PA_PROJECT_TEMPLATE'));
      set_item_result(run_stored_sig('PA_P2P_PROJECT_TYPES'));
      set_item_result(run_stored_sig('PA_DC_PA_TASKS'));
      set_item_result(run_stored_sig('EBS_FIN_PA_CLASS_CATEGORIES'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PROJECT_PLAYERS'));
      set_item_result(run_stored_sig('PA_PROJECT_CUSTOMERS'));
      set_item_result(run_stored_sig('PA_FOUND_PROJECT_CONTACTS'));
      set_item_result(run_stored_sig('PA_LABOR_MULTIPLIERS'));
      ...
      set_item_result(run_stored_sig('PA_BUDGET_VERSIONS'));
      set_item_result(run_stored_sig('PA_FOUND_BUDGET_TYPES'));
      set_item_result(run_stored_sig('PA_RESOURCE_LISTS_ALL_BG'));
      set_item_result(run_stored_sig('PA_RESOURCE_LIST_ASSIGNMENTS'));
      set_item_result(run_stored_sig('EBS_FIN_PA_TRANS_CONTROLS'));
   end_section;
END IF;
...
start_section('Security', 'SECURITY');
   IF nvl(g_sql_tokens('##$$PROJECT_ID$$##'), 'no projectid') <> 'no projectid'  THEN
      set_item_result(run_stored_sig('EBS_FIN_PA_PROJECT_ACCESS_LEVEL'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PROJECT_STATUS_ROLE_MENUS'));
      set_item_result(run_stored_sig('EBS_FIN_PA_USER_ROLE_MENUS'));
   END IF;
   set_item_result(run_stored_sig('EBS_FIN_PA_PROJECTS_SECURITY_EXTENSION'));
   set_item_result(run_stored_sig('EBS_FIN_PA_ORG_AUTHORITY'));
   set_item_result(run_stored_sig('EBS_FIN_PA_RESPONSIBILITY_MENU'));
end_section;
debug('end section: SECURITY');

debug('begin section: AA_SETUPS');
start_section('AutoAccounting Setups', 'AA_SETUPS');
   set_item_result(run_stored_sig('EBS_FIN_PA_ACCOUNTING_FLEXFIELD_SETUP'));
   set_item_result(run_stored_sig('EBS_FIN_PA_ACCOUNTING_FLEXFIELD_SEGMENTS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_INVALID_AA_PARAMETERS'));
   set_item_result(run_stored_sig('PA_SELECTIVE_FLEX_SEG'));
   set_item_result(run_stored_sig('EBS_FIN_PA_AUTOACCOUNTING_FUNCTIONS'));
end_section;
debug('end section: AA_SETUPS');
...
start_section('Apps Check', 'AppsCheck');
   ...
   set_item_result(run_stored_sig('EBS_FIN_PA_PA_GL_LEDGER_NAME'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PA_GL_DATA_ACCESS_SET'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PA_HR_SECURITY_PROFILE'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PA_HR_CROSS_BUSINESS_GROUP'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PA_HR_ENABLE_SECURITY_GROUPS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PA_MO_SECURITY_PROFILE'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PA_MO_OPERATING_UNIT'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PA_MO_DEFAULT_OPERATING_UNIT'));
