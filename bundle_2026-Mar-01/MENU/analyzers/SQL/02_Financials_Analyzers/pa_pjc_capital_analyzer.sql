...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Projects Capital Analyzer              |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE pa_pjc_capital_analyzer_pkg AUTHID DEFINER AS
...
END pa_pjc_capital_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY pa_pjc_capital_analyzer_pkg AS
-- $Id: pa_pjc_capital_analyzer.sql, 200.16 2026/02/25 21:45:08 aliclin Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2958343.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'PAPJCCAP_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'PAPJCCAP_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>PAPJCCAP Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2958343.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/pa_pjc_cap_latest_ver.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,8554,EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,8554,EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},8554,EBS,EBS Financials,EBS - Projects" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/mosc/discussion/4550614" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">8554</span>
...
<div class="ck-content"><p><strong>Version 200.16</strong></p><ul><li>Sigs updated for doc ID changes.</li>
</ul>
<p><strong>Version 200.15</strong></p><ul><li>Template enhancement: EBS KB Article IDs Shown for Signature KM Links.</li>
<li>Sigs updated for doc ID changes.</li>
</ul>
<p><strong>Version 200.14</strong></p><ul><li>Template andl signature enhanced.</li>
</ul>
<p><strong>Version 200.13</strong></p><ul><li>Several signatures enhanced.</li>
</ul>
<p><strong>Version 200.12</strong></p><ul><li>Several signatures enhanced.</li>
</ul>
<p><strong>Version 200.11</strong></p><ol><li>New Analyzer Framework version 4.7.3 released with enhancements.<ol><li>SQL*Plus Error fixed: SP2-0027: Input is too long</li>
<li>Ability to click to select rows in output tables</li>
</ol>
</li>
<li>Several signatures enhanced.</li>
</ol>
<p><strong>Version 200.10</strong></p><ul><li>Added two new signatures to “Asset Details” section.</li>
<li>Minor fixes to existing signatures.</li>
</ul>
<p><strong>Version 200.9</strong></p><ul><li>Added one new signature to “Asset Details” section.</li>
<li>Minor fixes to existing signatures.</li>
</ul>
<p><span style="font-family:&apos;Times New Roman&apos;,serif;font-size:12.0pt;mso-fareast-font-family:&apos;Times New Roman&apos;;"><strong>Version 200.8</strong></span></p><ul><li><span style="font-family:&apos;Times New Roman&apos;,serif;font-size:12.0pt;mso-fareast-font-family:&apos;Times New Roman&apos;;">Minor fixes to existing signatures.</span>&nbsp;</li>
<li><span style="font-family:&apos;Times New Roman&apos;,serif;font-size:12.0pt;mso-fareast-font-family:&apos;Times New Roman&apos;;">New signature added to "Asset Details" section.</span></li>
</ul>
<p><span style="font-family:&apos;Times New Roman&apos;,serif;font-size:12.0pt;mso-fareast-font-family:&apos;Times New Roman&apos;;"><strong>Version 200.7</strong></span></p><ul><li><span style="font-family:&apos;Times New Roman&apos;,serif;font-size:12.0pt;mso-fareast-font-family:&apos;Times New Roman&apos;;">Minor change to Project Number parameter.</span>&nbsp;</li>
</ul>
</div>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,8554,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,8554,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},8554,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Projects" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
FUNCTION check_rec_patches_1 RETURN VARCHAR2 IS
  /* Signature EBS_FIN_PA_CAPITAL_RECOMMENDED_PATCHES */
...
BEGIN
    ...
    print_log('Processing recommended patches signature: EBS_FIN_PA_CAPITAL_RECOMMENDED_PATCHES (check_rec_patches_1) "Capital Recommended Patches" (version 5)');
...
END IF;
   ...
   l_sig.sigrepo_id := '26484';
   l_sig.title := 'Capital Recommended Patches';
...
Best Practice: Always ensure that you are on the latest code with all recommended patches applied. This will help avoid known issues, prevent potential data corruption and provide the latest features and functionality. Having a proactive patching plan and periodic proactive patching process in place are the best ways to stay current.';
  ...
  -- Register
  l_step := '60';
  g_signatures('EBS_FIN_PA_CAPITAL_RECOMMENDED_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'EBS_FIN_PA_CAPITAL_RECOMMENDED_PATCHES',     -- sig ID
...
SELECT ppa.org_id into l_org_id
...
FUNCTION get_PROJECT_ASSET_ID
   return VARCHAR2 IS
BEGIN
debug('begin sql token function: PROJECT_ASSET_ID');
BEGIN

select project_asset_id into l_project_asset_id
from pa_project_assets_all
where project_id = p_project_id
and asset_name=p_asset_name;

   return l_project_asset_id;
EXCEPTION WHEN NO_DATA_FOUND THEN
       return null;
END;
debug('end sql token function: PROJECT_ASSET_ID');
END get_PROJECT_ASSET_ID;
...
debug('begin populate parameters hash table');
   ...
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Asset Name';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_asset_name,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  l_revision := rtrim(replace('$Revision: 200.16  $','$',''));
  l_revision := ltrim(replace(l_revision,'Revision:',''));
  l_date_char := rtrim(replace('$Date: 2026/02/25 21:45:07 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'pa_pjc_capital_analyzer.sql';
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid project ID - this project ID does not exist, or is not a capital project.');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
debug('begin parameter validation: p_asset_name');
IF p_asset_name IS NOT NULL THEN
BEGIN
SELECT ASSET_NAME
INTO l_exists_val
FROM PA_PROJECT_ASSETS_ALL PPA, PA_PROJECTS_ALL P
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: This asset is not valid for the specified project.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_asset_name failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_asset_name');
...
INTO l_exists_val
FROM PA_EXPENDITURE_ITEMS_ALL PEIA, PA_PROJECTS_ALL P 
WHERE EXPENDITURE_ITEM_ID = p_expenditure_item_id
 AND p.project_id = p_project_id
and peia.org_id = p.org_id
and peia.project_id = p.project_id

 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: This expenditure item ID is not valid for the specified project.');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
debug('begin populate sql tokens hash table');
   ...
   g_sql_tokens('##$$EIID$$##') := nvl(to_char(p_expenditure_item_id),'null');
   g_masked_tokens('##$$EIID$$##') := mask_text( g_sql_tokens('##$$EIID$$##'), 'NO_MASK');
   g_sql_tokens('##$$ASSET_NAME$$##') := p_asset_name;
   g_masked_tokens('##$$ASSET_NAME$$##') := mask_text( g_sql_tokens('##$$ASSET_NAME$$##'), 'NO_MASK');
   ...
   g_sql_tokens('##$$PROJECT_ASSET_ID$$##') := get_PROJECT_ASSET_ID();
   l_system_function_var := null;
   g_masked_tokens('##$$PROJECT_ASSET_ID$$##') := mask_text( g_sql_tokens('##$$PROJECT_ASSET_ID$$##'), 'NO_MASK');
...
debug('begin add_signature: EBS_FIN_PA_DUPLICATE_ASSET_NAMES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26076',
      p_sig_id                 => 'EBS_FIN_PA_DUPLICATE_ASSET_NAMES',
      p_sig_sql                => 'SELECT t.asset_name "Asset Name", t.PROJECT_ASSET_ID "Project Asset Id", t.project_id "Project Id", t.ASSET_DESCRIPTION "Description"
from   pa_project_assets_all t
where  t.project_id = ##$$PROJECT_ID$$##
and    t.asset_name in 
(select t2.asset_name 
from pa_project_assets_all t2 
where   t.project_id = t2.project_id 
group   by t2.asset_name
having  count(*) > 1)',
      p_title                  => 'Project Duplicate Asset Names',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This project has assets with duplicate asset names.',
      p_solution               => 'Please follow the solution in [1981645/KB205600]  PAXPREPR / PAXCARVW: How to Change the Asset Name or Asset Number After It Has Already Been Assigned and Then Updated in Fixed Assets (FA).',
      p_success_msg            => 'This project contains no assets with duplicate names.  ',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_DUPLICATE_ASSET_NAMES');



debug('begin add_signature: EBS_FIN_PA_PA13112694ASSET_LINES_MISMATCH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26908',
      p_sig_id                 => 'EBS_FIN_PA_PA13112694ASSET_LINES_MISMATCH',
      p_sig_sql                => 'SELECT lines.project_id,
    ...
    AND EXISTS
    (SELECT 1 FROM pa_project_asset_line_details details
     WHERE REVERSED_FLAG                      = ''N''
        AND details.project_asset_line_detail_id = lines.project_asset_line_detail_id
    )
    GROUP BY lines.project_id, project_asset_line_detail_id, original_asset_cost, task_id
    HAVING SUM(current_asset_cost) <> original_asset_cost',
      p_title                  => 'Asset Lines Have Incorrect Amount',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Asset lines exist where for one asset line detail ID the sum of the current asset cost does not match the original asset cost.

',
      p_solution               => 'Follow the solution in [1455964/PALRT1342] Critical Data Fix Patch Released for Customers Using Capital Project Flows in Oracle Projects.',
      p_success_msg            => 'Asset lines exist where for one asset line detail ID the sum of the current asset cost does match the original asset cost.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA13112694ASSET_LINES_MISMATCH');



debug('begin add_signature: EBS_FIN_PA_PA13112694_REV_LINE_MISMATCH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26911',
      p_sig_id                 => 'EBS_FIN_PA_PA13112694_REV_LINE_MISMATCH',
      p_sig_sql                => 'SELECT lines.project_id,
       project_asset_line_detail_id,
        original_asset_cost,
        SUM(current_asset_cost) crnt_ast_cost,
    ...
    AND EXISTS (
    select 1 from  pa_project_asset_line_details details
        WHERE REVERSED_FLAG                      = ''Y''
        AND details.project_asset_line_detail_id = lines.project_asset_line_detail_id
        )
    GROUP BY lines.project_id, project_asset_line_detail_id, original_asset_cost, task_id
    HAVING SUM(current_asset_cost) <> original_asset_cost
    AND sum(current_asset_cost) <> 0',
      p_title                  => 'Reversed Asset Lines Have Incorrect Asset Cost',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Reversed asset lines have incorrect current asset cost.',
      p_solution               => 'Follow the solution in [1455964/PALRT1342] Critical Data Fix Patch Released for Customers Using Capital Project Flows in Oracle Projects.',
      p_success_msg            => 'Reversed asset lines have correct current asset cost.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA13112694_REV_LINE_MISMATCH');



debug('begin add_signature: EBS_FIN_PA_PA13112694_XTRA_LINE_MISMATCH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26909',
      p_sig_id                 => 'EBS_FIN_PA_PA13112694_XTRA_LINE_MISMATCH',
      p_sig_sql                => 'SELECT lines.project_id,
       project_asset_line_detail_id,
        original_asset_cost,
        SUM(current_asset_cost) crnt_ast_cost,
    ...
    AND P.PROJECT_ID               = ##$$PROJECT_ID$$##
    AND NOT EXISTS
    (select 0 FROM pa_project_asset_line_details details,
  ...
  and details.PROJECT_ASSET_LINE_DETAIL_ID = lines.PROJECT_ASSET_LINE_DETAIL_ID
    ...
    GROUP BY lines.project_id, project_asset_line_detail_id, original_asset_cost, task_id',
      p_title                  => 'Asset Lines Exist Without Asset Line Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Asset lines exist that are missing the corresponding detail in pa_project_asset_line_details.',
      p_solution               => 'Follow the solution in [1455964/PALRT1342] Critical Data Fix Patch Released for Customers Using Capital Project Flows in Oracle Projects.',
      p_success_msg            => 'Asset lines exist and have the corresponding detail in pa_project_asset_line_details.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA13112694_XTRA_LINE_MISMATCH');



debug('begin add_signature: EBS_FIN_PA_3112694_FA_MISMATCH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26906',
      p_sig_id                 => 'EBS_FIN_PA_3112694_FA_MISMATCH',
      p_sig_sql                => 'SELECT p.project_id,
  PROJECT_ASSET_LINE_ID,
  PROJECT_ASSET_LINE_DETAIL_ID,
  lines.project_asset_id,
  lines.task_id
FROM pa_project_asset_lines_all lines,
  pa_projects_all p 
WHERE lines.project_id         = p.project_id
...
AND NOT EXISTS
  ...
  WHERE project_id          = lines.project_id
    AND lines.project_id               = ##$$PROJECT_ID$$##
  AND project_asset_line_id = lines.project_asset_line_id
  AND TASK_ID               = LINES.TASK_ID
  UNION
   SELECT 1
    FROM fa_additions fad,
      fa_asset_invoices fai
    WHERE fad.asset_id            = fai.asset_id
    AND fai.project_asset_line_id = lines.project_asset_line_id
    AND fai.project_id            = lines.project_id
    AND lines.project_id               = ##$$PROJECT_ID$$##
   )',
      p_title                  => 'Transferred Asset Lines Missing in Oracle Assets',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Asset lines have a transferred status in Projects but there is no corresponding data in Oracle Assets.',
      p_solution               => 'Follow the solution in [1455964/PALRT1342] Critical Data Fix Patch Released for Customers Using Capital Project Flows in Oracle Projects.',
      p_success_msg            => 'Asset lines have a transferred status in Projects and there is corresponding data in Oracle Assets.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_3112694_FA_MISMATCH');



debug('begin add_signature: EBS_FIN_PA_13112694CDL_DETAIL_MISMATCH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26904',
      p_sig_id                 => 'EBS_FIN_PA_13112694CDL_DETAIL_MISMATCH',
      p_sig_sql                => 'SELECT p.segment1 project_num,
ei.task_id task_id,
...
AND cdl.line_type                = DECODE(pt.capital_cost_type_code, ''B'', DECODE(NVL(pt.total_burden_flag, DECODE(pt.burden_amt_display_method, ''S'',''Y'', ''D'',''N'', ''Y'')), ''Y'',''D'', ''R''), ''R'')
AND EXISTS
  (SELECT 1
  ...
  AND NOT EXISTS
    ...
    AND project_id                         = ei.project_id
      ...
      p_title                  => 'Asset Lines Have Incorrect Current Asset Cost',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Asset lines exist and the total current asset cost is different than original asset cost.',
      p_solution               => 'Follow the solution in [1455964/PALRT1342] Critical Data Fix Patch Released for Customers Using Capital Project Flows in Oracle Projects.',
      p_success_msg            => 'Asset lines exist and the total current asset cost is the same as the original asset cost.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_13112694CDL_DETAIL_MISMATCH');



debug('begin add_signature: EBS_FIN_PA_PA13112694_CDL_RDF_N_MISMATCH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26913',
      p_sig_id                 => 'EBS_FIN_PA_PA13112694_CDL_RDF_N_MISMATCH',
      p_sig_sql                => 'SELECT p.segment1 "Project Number",
p.project_id,
  ei.task_id,
  ...
  ei.raw_cost,
  ei.burden_cost,
  cdl.billable_flag "Capitalizable Flag",
  ei.revenue_distributed_flag "Capitalized Flag",
  transaction_source,
  ''Generated Into Asset Lines'' reason
FROM pa_expenditure_items_all ei,
  pa_cost_distribution_lines_all cdl,
  pa_projects_all p ,
  pa_project_types_all pt
...
AND cdl.transfer_status_code   IN (''P'',''A'',''V'',''T'',''R'',''G'',''B'')
AND cdl.line_type               = DECODE(pt.capital_cost_type_code, ''B'', DECODE(NVL(pt.total_burden_flag,DECODE(pt.burden_amt_display_method,''S'',''Y'',''D'',''N'',''Y'')),''Y'', ''D'',''R''),''R'')
AND   ((cdl.line_type = ''I'' and cdl.transfer_status_code = ''G'') OR
        cdl.line_type in (''R'', ''D'') and cdl.transfer_status_code in (''V'', ''A''))
AND   ei.capital_event_id IS NOT NULL
and CDL.EXPENDITURE_ITEM_ID in
(select EXPENDITURE_ITEM_ID from PA_COST_DISTRIBUTION_LINES_ALL PCDL
where PCDL.LINE_TYPE  = cdl.line_type
and EXISTS
(select 1 from PA_PROJECT_ASSET_LINE_DETAILS D
where d.expenditure_item_id = pcdl.expenditurE_item_id
and d.reversed_flag = ''N'')
and PCDL.EXPENDITURE_ITEM_ID not in
(
select EXPENDITURE_ITEM_ID from PA_COST_DISTRIBUTION_LINES_ALL PCDL1
where PCDL1.EXPENDITURE_ITEM_ID = PCDL.EXPENDITURE_ITEM_ID
and PCDL1.LINE_TYPE = CDL.LINE_TYPE
and (PCDL1.EXPENDITURE_ITEM_ID, PCDL1.LINE_NUM) not in
  (select EXPENDITURE_ITEM_ID, LINE_NUM from  PA_PROJECT_ASSET_LINE_DETAILS DET
where DET.EXPENDITURE_ITEM_ID = PCDL.EXPENDITURE_ITEM_ID
...
AND p.org_id = pt.org_id
AND p.project_id   = ##$$PROJECT_ID$$##',
      p_title                  => 'Expenditure Items with Wrong Flags Set',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Expenditure items exist with an incorrect capitalized flag as ''N'' even when asset lines are already generated.',
      p_solution               => 'Follow the solution in [1455964/PALRT1342] Critical Data Fix Patch Released for Customers Using Capital Project Flows in Oracle Projects.',
      p_success_msg            => 'No expenditure items exist with an incorrect capitalized flag.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA13112694_CDL_RDF_N_MISMATCH');



debug('begin add_signature: EBS_FIN_PA_PA13112694LINES_ASSET_MISMATCH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26912',
      p_sig_id                 => 'EBS_FIN_PA_PA13112694LINES_ASSET_MISMATCH',
      p_sig_sql                => 'SELECT p.project_id,
          ...
          AND p.project_id               =  ##$$PROJECT_ID$$##
          AND project_asset_type = ''AS-BUILT''
          AND capitalized_cost          <>
            ...
            AND EXISTS
	  (select 1 from pa_project_asset_line_details d
	  where d.project_asset_line_detail_id = pal.project_asset_line_detail_id
	  and d.reversed_flag = ''N''
	  AND NOT EXISTS
    (SELECT 1 FROM (SELECT lines.project_id,
       project_asset_line_detail_id
      FROM pa_project_asset_lines_all lines,
        PA_PROJECTS_ALL P
      WHERE lines.project_id           = p.project_id
    ...
    (SELECT 1 FROM pa_project_asset_line_details details
     WHERE REVERSED_FLAG                      = ''N''
        AND details.project_asset_line_detail_id = lines.project_asset_line_detail_id    )
    GROUP BY lines.project_id, project_asset_line_detail_id, original_asset_cost, task_id
    HAVING SUM(current_asset_cost) <> original_asset_cost) m
    WHERE m.project_asset_line_detail_id = pal.project_asset_line_detail_id)
	  ))
        UNION
        SELECT p.project_id,
            PPA.PROJECT_ASSET_ID,
        ...
        WHERE ppa.project_id           = p.project_id
         AND p.project_id               =  ##$$PROJECT_ID$$##
        AND project_asset_type = ''AS-BUILT''
        AND grouped_cip_cost          <>
          (SELECT SUM(CURRENT_ASSET_COST)
          FROM pa_project_asset_lines_all pal
          WHERE project_id         = p.project_id
       AND pal.project_id               =  ##$$PROJECT_ID$$##
          AND pal.project_asset_id = ppa.project_asset_id
           AND EXISTS
	  (select 1 from pa_project_asset_line_details d
	  where d.project_asset_line_detail_id = pal.project_asset_line_detail_id
...
AND EXISTS (    SELECT        1
    ...
    WHERE m.project_asset_line_detail_id = pal.project_asset_line_detail_id)
      ...
      p_title                  => 'Asset Amounts Not in Sync With Asset Line Amounts',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Asset amounts are not in sync with asset line amounts.',
      p_solution               => 'Follow the solution in [1455964/PALRT1342] Critical Data Fix Patch Released for Customers Using Capital Project Flows in Oracle Projects.',
      p_success_msg            => 'Asset and asset line amounts are in sync.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA13112694LINES_ASSET_MISMATCH');
...
debug('begin add_signature: PA_INCORRECT_CIP_COST_CAPITAL_1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15787',
      p_sig_id                 => 'PA_INCORRECT_CIP_COST_CAPITAL_1',
      p_sig_sql                => 'select pad.expenditure_item_id, pad.line_num, pad.project_asset_line_detail_id, pad.cip_cost, ei.burden_cost
 from pa_project_asset_line_details pad, pa_expenditure_items_all ei, pa_cost_distribution_lines_all pacdl
  where ei.project_id = ##$$PROJECT_ID$$##
  and pacdl.expenditure_item_id = ei.expenditure_item_id
  and pad.expenditure_item_id = pacdl.expenditure_item_id
  and pad.line_num = pacdl.line_num
  and cip_cost <> burden_cost
order by pacdl.expenditure_item_id, pad.line_num,
project_asset_line_detail_id',
      p_title                  => 'CIP_AMOUNT is Not Matching',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The cip_amount on the detail is equal to that of the amount on the cost distribution line which is the source for this detail.<br>
This may cause the CIP amount to be incorrect in the Capital Projects Summary form.
',
      p_solution               => 'Log a Service Request for datafix.<br>
Reference: "Incorrect CIP Cost Shown in Capital Projects Summary Screen" in [1578020/KB309128]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_INCORRECT_CIP_COST_CAPITAL_1');



debug('begin add_signature: PA_INCORRECT_CIP_COST_CAPITAL_2');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15784',
      p_sig_id                 => 'PA_INCORRECT_CIP_COST_CAPITAL_2',
      p_sig_sql                => 'select PROJECT_ASSET_LINE_DETAIL_ID, ORIGINAL_ASSET_COST, sum(CURRENT_ASSET_COST)
 from pa_project_asset_lines_all pal
  where project_id = ##$$PROJECT_ID$$##
  group by PROJECT_ASSET_LINE_DETAIL_ID, ORIGINAL_ASSET_COST
  having original_asset_cost <>
   (select sum(cip_cost) from pa_project_asset_line_details pad where pad.PROJECT_ASSET_LINE_DETAIL_ID = pal.PROJECT_ASSET_LINE_DETAIL_ID)
  order by PROJECT_ASSET_LINE_DETAIL_ID, ORIGINAL_ASSET_COST',
      p_title                  => 'CIP_COST in Asset Details is Not Matching',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The cip_cost in asset details is not matching with the original_asset_cost in the asset lines for a particular detail id.<br>
This may cause the CIP amount to be incorrect in the Capital Projects Summary form.
',
      p_solution               => 'Log a Service Request for datafix.<br>
Reference: "Incorrect CIP Cost Shown in Capital Projects Summary Screen" in [1578020/KB309128]',
   ...
   l_info.delete;
debug('end add_signature: PA_INCORRECT_CIP_COST_CAPITAL_2');



debug('begin add_signature: EBS_FIN_PA_FA_BOOK_CONTROLS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25976',
      p_sig_id                 => 'EBS_FIN_PA_FA_BOOK_CONTROLS',
      p_sig_sql                => 'SELECT book.*, book.deprn_status ||'' = ''|| nvl(lookup.meaning,''Null'') "DEPRN_ STATUS", d.period_name, d2.period_name  
FROM FA_BOOK_CONTROLS book, FA_DEPRN_PERIODS d, FA_DEPRN_PERIODS d2, FA_LOOKUPS lookup  
WHERE  book.book_type_code = d.book_type_code  
AND    book.initial_period_counter = d.period_counter  
AND    book.book_type_code = d2.book_type_code  
AND    book.last_period_counter = d2.period_counter  
AND    lookup.lookup_type = ''DEPRN STATUS''  
AND    lookup.lookup_code (+) = book.deprn_status  
AND    book.book_type_code in (SELECT a.book_type_code FROM PA_PROJECT_ASSETS_ALL a WHERE a.project_id = ##$$PROJECT_ID$$## 
AND a.project_asset_id = nvl(''##$$PROJECT_ASSET_ID$$##'',  a.project_asset_id)) 
ORDER BY book.book_type_code',
      p_title                  => 'Project Asset Book Controls (FA_BOOK_CONTROLS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No book controls found for the project
',
      p_solution               => '',
      p_success_msg            => 'Book controls found for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_FA_BOOK_CONTROLS');
...
debug('begin add_signature: EBS_FIN_PA_PROFILE_USE_ASSET_TRACKING_COSTING_HOOK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24742',
      p_sig_id                 => 'EBS_FIN_PA_PROFILE_USE_ASSET_TRACKING_COSTING_HOOK',
      p_sig_sql                => 'select fav.application_name "Application Name", 
       fpo1.user_profile_option_name "Profile Option",
         DECODE(fpov.profile_option_value,''Y'',''Y'',
  DECODE(fpov.profile_option_value,''N'',''N''))"Value",
...
order  by fpov.level_id desc',
      p_title                  => 'Profile Option CSE: Use Asset Tracking Costing Hook',
      p_fail_condition         => '[Value]=[Y]',
      p_problem_descr          => 'Profile option CSE: Use Asset Tracking Costing Hook is set to ''Y''.
',
      p_solution               => '<ul> <li>Review [2920664/KB596626] How Should The Profile Option CSE: Use Asset Tracking Costing Hook Be Set When Using Capital Project Functionality in Oracle Projects? </li> </ul> ',
      p_success_msg            => 'The profile option CSE: Use Asset Tracking Costing Hook is set.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PROFILE_USE_ASSET_TRACKING_COSTING_HOOK');



debug('begin add_signature: EBS_FIN_PA_IMPL_OPTIONS_AND_SUBLEDGER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26844',
      p_sig_id                 => 'EBS_FIN_PA_IMPL_OPTIONS_AND_SUBLEDGER',
      p_sig_sql                => 'SELECT syslevel.name
FROM   (SELECT  ''SYSTEM'' name, .5 sorder, imp.org_id
       from pa_implementations_all imp
              UNION 
       SELECT ''  Ledger Name = '' || sob.name || ''(Id = '' || To_char(imp.set_of_books_id) ||'')''    name,
               1      sorder,
               imp.org_id
        FROM   pa_implementations_all imp,
        ...
        UNION
        SELECT ''  Business Group = '' || busGrp.name|| '' (Id = '' || To_char(imp.business_group_id)||'')''    name,
               2      sorder,
               imp.org_id
        FROM   pa_implementations_all imp,
               hr_all_organization_units busGrp
        WHERE  imp.business_group_id = busGrp.organization_id (+)
        UNION
        SELECT ''  Summarization Period type = '' || imp.accumulation_period_type name,
               3                             sorder,
               imp.org_id
        FROM   pa_implementations_all imp
        UNION
        SELECT ''  Calender Name = '' || imp.period_set_name name,
               4                   sorder,
               imp.org_id
        FROM   pa_implementations_all imp
        UNION
        SELECT ''  Projects Period Type = '' || pt.user_period_type name,
               5                    sorder,
               imp.org_id
        FROM   pa_implementations_all imp,
               gl_period_types pt
        WHERE  imp.pa_period_type = pt.period_type (+)
        UNION
        SELECT ''  Default Asset Book = ''|| imp.book_type_code name,
               6                   sorder,
               imp.org_id
        FROM   pa_implementations_all imp  
        UNION
        SELECT ''  Maintain Common PA and GL Periods = ''|| imp.same_pa_gl_period name,
               7                   sorder,
               imp.org_id
        FROM   pa_implementations_all imp
        UNION
        SELECT  ''EXPENDITURE / COSTING'' name, 
                7.5 sorder, imp.org_id
        from pa_implementations_all imp  
        UNION
        SELECT ''  Expenditure Cycle Start Day = ''||  decode(imp.exp_cycle_start_day_code, 1, ''Sunday'',2,''Monday'',3,
        ...
        FROM   pa_implementations_all imp
       UNION
        SELECT ''  Enable Overtime Calculations Flag = ''|| overtime_calc_enabled_flag name,
               9                   sorder,
               imp.org_id
        FROM   pa_implementations_all imp
       UNION
        SELECT ''  Import Contingent Worker Timecards with Purchase Order Integration= ''|| xface_cwk_timecards_flag name ,
               10                   sorder,
               imp.org_id
        FROM   pa_implementations_all imp
       UNION
        SELECT  ''LEDGER DEFINITION'' name, 
                10.5 sorder, imp.org_id
        from pa_implementations_all imp  
       UNION
       SELECT ''  Name = '' || l.name || ''(Id = '' || To_char(l.ledger_id) ||'')'' name,
               11      sorder,
               imp.org_id
        FROM PA_IMPLEMENTATIONS_all imp, GL_LEDGERS l
        WHERE imp.set_of_books_id = l.ledger_id
        UNION
       SELECT ''  Short Name = '' || l.short_name name,
               12      sorder,
               imp.org_id
        FROM PA_IMPLEMENTATIONS_all imp, GL_LEDGERS l
        WHERE imp.set_of_books_id = l.ledger_id
        UNION
       SELECT ''  Description = '' || l.description name,
               13      sorder,
               imp.org_id
        FROM PA_IMPLEMENTATIONS_all imp, GL_LEDGERS l
        WHERE imp.set_of_books_id = l.ledger_id
        UNION
       SELECT ''  Currency = '' || l.currency_code name,
               14      sorder,
               imp.org_id
        FROM PA_IMPLEMENTATIONS_all imp, GL_LEDGERS l
        WHERE imp.set_of_books_id = l.ledger_id
        UNION
       SELECT ''  Chart of Accounts = '' || v.chart_of_accounts_name name,
               15      sorder,
               imp.org_id
        FROM PA_IMPLEMENTATIONS_all imp, GL_LEDGERS_v v
        WHERE imp.set_of_books_id = v.ledger_id
        UNION
       SELECT ''  Type = '' || l.ledger_category_code name,
               16      sorder,
               imp.org_id
        FROM PA_IMPLEMENTATIONS_all imp, GL_LEDGERS l
        WHERE imp.set_of_books_id = l.ledger_id
       UNION
        SELECT  ''ACCOUNTING CALENDAR'' name, 
                16.5 sorder, imp.org_id
        from pa_implementations_all imp  
        UNION
       SELECT ''  Accounting Calendar = '' || l.period_set_name name,
               17      sorder,
               imp.org_id
        FROM PA_IMPLEMENTATIONS_all imp, GL_LEDGERS l
        WHERE imp.set_of_books_id = l.ledger_id
        UNION
       SELECT ''  Period Type = '' || l.accounted_period_type name,
               18      sorder,
               imp.org_id
        FROM PA_IMPLEMENTATIONS_all imp, GL_LEDGERS l
        WHERE imp.set_of_books_id = l.ledger_id
       UNION
       SELECT ''  First Ever Opened Period = '' || l.first_ledger_period_name name,
               19      sorder,
               imp.org_id
        FROM PA_IMPLEMENTATIONS_all imp, GL_LEDGERS l
        WHERE imp.set_of_books_id = l.ledger_id
       UNION
       SELECT ''  Number of Future Enterable Periods = '' || l.future_enterable_periods_limit name,
               20      sorder,
               imp.org_id
        FROM PA_IMPLEMENTATIONS_all imp, GL_LEDGERS l
        WHERE imp.set_of_books_id = l.ledger_id
       UNION
        SELECT  ''SUBLEDGER ACCOUNTING OPTIONS'' name, 
                20.5 sorder, imp.org_id
        from pa_implementations_all imp 
       UNION
       SELECT ''  Subledger Accounting Method = '' || sla.name name,
               21      sorder,
               imp.org_id
        FROM PA_IMPLEMENTATIONS_all imp, GL_LEDGERS l, XLA_ACCTG_METHODS_VL  sla
        WHERE imp.set_of_books_id = l.ledger_id
       AND  sla.accounting_method_type_code = l.sla_accounting_method_type
       AND  sla.accounting_method_code = l.sla_accounting_method_code 
       UNION
       SELECT ''  Use Cash Basis Accounting = '' || l.sla_ledger_cash_basis_flag name,
               22      sorder,
               imp.org_id
        FROM PA_IMPLEMENTATIONS_all imp, GL_LEDGERS l
        WHERE imp.set_of_books_id = l.ledger_id
) syslevel
WHERE  syslevel.org_id =  ##$$ORG_ID$$##
ORDER  BY sorder',
      p_title                  => 'Implementation Options ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No implementation options found.',
      p_solution               => '',
      p_success_msg            => ' Implementation options found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_IMPL_OPTIONS_AND_SUBLEDGER');



debug('begin add_signature: EBS_FIN_PA_PROJECT_TYPE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27099',
      p_sig_id                 => 'EBS_FIN_PA_PROJECT_TYPE',
      p_sig_sql                => 'SELECT type.Details
FROM   (SELECT ''Project Type = ''
        ...
        UNION
        SELECT '' Type Class Code = ''
               || project_type_class_code Details,
               1                          sorder,
               project_type,
               org_id
        FROM   pa_project_types_all
        UNION
        SELECT '' Burdened = ''
               || burden_cost_flag Details,
               2                   sorder,
               project_type,
               org_id
        FROM   pa_project_types_all
        UNION
        SELECT '' Capital Cost Type = ''
               || Decode(capital_cost_type_code, ''R'', ''Raw'',
                                                 ''B'', ''Burdened'',
                                                 NULL) Details,
               3                                       sorder,
               project_type,
        ...
        FROM   pa_project_types_all
        UNION
        SELECT '' Require Complete Asset Def= ''
               || interface_complete_asset_flag Details,
               4                                sorder,
               project_type,
               org_id
        FROM   pa_project_types_all
        UNION
        SELECT '' Override Asset Assgnmt = ''
               || override_asset_assignment_flag Details,
               .5                                 sorder,
               project_type,
               org_id
        FROM   pa_project_types_all
        ...
        SELECT ''Grouping Method = ''
               || (select meaning from  pa_lookups l 
                  where lookup_type = ''CIP GROUPING METHOD'' and l.lookup_code = pt.CIP_GROUPING_METHOD_CODE)   Details,
               6                                 sorder,
               project_type,
               org_id
        FROM   pa_project_types_all pt
        UNION
        SELECT ''Group Supplier Invoices = ''
               || decode(vendor_invoice_grouping_code,''G'',''Group'',''M'', ''Merge'',''N'',''New'',vendor_invoice_grouping_code)   Details,
               7                                 sorder,
               project_type,
               org_id
        FROM   pa_project_types_all pt
        UNION
        SELECT ''Interface Asset Cost Code = ''
               || decode(interface_asset_cost_code,''F'',''to FA'',''G'',''to GL'', interface_asset_cost_code)   Details,
               8                                sorder,
               project_type,
               org_id
        FROM   pa_project_types_all pt) type
WHERE  project_type = (SELECT project_type
                       FROM   pa_projects_all PA
                       WHERE  project_id = ##$$PROJECT_ID$$##
                              AND type.org_id = PA.org_id)
ORDER  BY sorder ',
      p_title                  => 'Project Type Capitalization Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No project type capitalization information found.',
      p_solution               => '',
      p_success_msg            => 'Project type capitalization information found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PROJECT_TYPE');



debug('begin add_signature: EBS_FIN_PA_INVENTORY_BUDEN_COST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27107',
      p_sig_id                 => 'EBS_FIN_PA_INVENTORY_BUDEN_COST',
      p_sig_sql                => 'select ei.* from pa_projects_all ppa, pa_project_types_all ppt, pa_expenditure_items_all ei
...
and   ppt.capital_cost_type_code = ''R''
and   ppt.project_type_class_code = ''CAPITAL''
and   ei.revenue_distributed_flag= ''N''
and   ei.billable_flag=''Y''
and   nvl(ei.raw_cost,0)=0
and   nvl(ei.quantity,0)=0
and   (ei.system_linkage_function = ''BTC'' and
        ei.burden_sum_dest_run_id in (select distinct cdl.burden_sum_source_run_id
                                    from pa_cost_distribution_lines_all cdl, pa_expenditure_items_all ei1
                                    where cdl.expenditure_item_id = ei1.expenditure_item_id
                                    and   ei1.system_linkage_function in (''INV'',''WIP''))
)
',
      p_title                  => 'Capitalize Work-in-Process(WIP)/Inventory Burden Costs',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'PRC: Generate Asset Lines did not process the burden costs related to Work-in-Process(WIP)/Inventory costs.',
      p_solution               => 'Review the solution in [2685856/KB612180] Unable to Capitalize Work-in-Process(WIP)/Inventory Burden Costs Since Project Type Is Set As Cost Type = Raw.',
      p_success_msg            => 'PRC: Generate Asset Lines processed the burden costs related to Work-in-Process(WIP)/Inventory costs.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_INVENTORY_BUDEN_COST');



debug('begin add_signature: EBS_FIN_PA_PROJECTS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25973',
      p_sig_id                 => 'EBS_FIN_PA_PROJECTS_ALL',
      p_sig_sql                => 'SELECT proj.*  ,      st.project_status_name  ,      org2.name "Operating|Unit"  ,      cb.ind_rate_sch_name "Cost|Burden|Schedule"  ,      bcy.billing_cycle_name   ,      ig1.group_type_code "Labor|Group Type"  ,      li.name "Labor|Invoice|Format"  ,      ig2.group_type_code "Non Labor|Group Type"  ,      nli.name "Non Labor|Invoice|Format"  ,      ri.name "Ret Invoice|Format"  ,      rb.ind_rate_sch_name "Revenue|Burden|Schedule"  ,      ib.ind_rate_sch_name "Invoice|Burden|Schedule"  ,    proj.emp_bill_rate_schedule_id  ,    proj.job_bill_rate_schedule_id  ,    proj.bill_job_group_id  FROM   PA_PROJECTS_ALL proj  ,      PA_PROJECT_STATUSES st  ,      HR_ALL_ORGANIZATION_UNITS org2  ,      PA_IND_RATE_SCHEDULES_ALL_BG cb  ,      PA_BILLING_CYCLES bcy  ,      PA_INVOICE_FORMATS li  ,      PA_INVOICE_FORMATS nli  ,      PA_INVOICE_FORMATS ri  ,      PA_INVOICE_GROUPS ig1  ,      PA_INVOICE_GROUPS ig2   ,      PA_IND_RATE_SCHEDULES_ALL_BG rb  ,      PA_IND_RATE_SCHEDULES_ALL_BG ib ,      PA_STD_BILL_RATE_SCHEDULES_ALL ebrs ,      PA_STD_BILL_RATE_SCHEDULES_ALL jbrs  WHERE  proj.project_id = ##$$PROJECT_ID$$##  AND    st.project_status_code (+) = proj.project_status_code  AND    org2.organization_id (+) = proj.org_id  AND    proj.cost_ind_rate_sch_id = cb.ind_rate_sch_id (+)  AND    proj.labor_invoice_format_id = li.invoice_format_id (+)  AND    proj.non_labor_invoice_format_id = nli.invoice_format_id (+)  AND    ig1.invoice_group_id (+) = li.invoice_group_id  AND    ig2.invoice_group_id (+) = nli.invoice_group_id  AND    proj.retention_invoice_format_id = ri.invoice_format_id (+)  AND    proj.billing_cycle_id = bcy.billing_cycle_id (+)  AND    proj.rev_ind_rate_sch_id  = rb.ind_rate_sch_id (+)  AND    proj.inv_ind_rate_sch_id  = ib.ind_rate_sch_id (+)  and    proj.emp_bill_rate_schedule_id = ebrs.bill_rate_sch_id(+)  and    proj.job_bill_rate_schedule_id = jbrs.bill_rate_sch_id(+)',
      p_title                  => 'Project Information',
      p_fail_condition         => 'NRS',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PROJECTS_ALL');



debug('begin add_signature: EBS_FIN_PA_PA_TASKS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25974',
      p_sig_id                 => 'EBS_FIN_PA_PA_TASKS',
      p_sig_sql                => 'SELECT task.*  ,      org.name "Carrying Out|Organization"  ,      cost.ind_rate_sch_name "Cost Burden|Schedule"  ,      rev.ind_rate_sch_name "Revenue Burden|Schedule"  ,      rev.cost_plus_structure "Revenue BS|Structure"  ,      inv.ind_rate_sch_name "Invoice Burden|Schedule"  ,      inv.cost_plus_structure "Invoice BS|Structure"  ,      tps1.name "Labor TP|Schedule"  ,      tps2.name "Non Labor|TP Schedule"  ,      emp.std_bill_rate_schedule "Emp|Bill Rate|Schedule"  ,      emp.rate_sch_currency_code "Emp Rate|Sched Currency"  ,      job.std_bill_rate_schedule "Job|Bill Rate|Schedule"  ,      job.rate_sch_currency_code "Job Rate|Sched Currency"  ,      nl.rate_sch_currency_code "Non-Labor Rate|Sched Currency"  FROM   PA_TASKS task  ,      PA_IND_RATE_SCHEDULES_ALL_BG cost  ,      PA_IND_RATE_SCHEDULES_ALL_BG rev  ,      PA_IND_RATE_SCHEDULES_ALL_BG inv  ,      PA_CC_TP_SCHEDULES_BG tps1  ,      PA_CC_TP_SCHEDULES_BG tps2  ,      HR_ALL_ORGANIZATION_UNITS_VL org  ,      PA_STD_BILL_RATE_SCHEDULES_ALL emp  ,      PA_STD_BILL_RATE_SCHEDULES_ALL job  ,      PA_STD_BILL_RATE_SCHEDULES_ALL nl  WHERE  org.organization_id (+) = task.carrying_out_organization_id  AND    cost.ind_rate_sch_id (+) = task.cost_ind_rate_sch_id  AND    inv.ind_rate_sch_id (+) = task.inv_ind_rate_sch_id  AND    rev.ind_rate_sch_id (+) = task.rev_ind_rate_sch_id  AND    tps1.tp_schedule_id (+) = task.labor_tp_schedule_id  AND    tps2.tp_schedule_id (+) = task.nl_tp_schedule_id  AND    emp.bill_rate_sch_id (+) = task.emp_bill_rate_schedule_id  AND    job.bill_rate_sch_id (+) = task.job_bill_rate_schedule_id  AND    nl.bill_rate_sch_id (+) = task.non_lab_std_bill_rt_sch_id  AND    task.project_id = nvl( ##$$PROJECT_ID$$## , task.project_id)  AND    task.task_id = nvl( null , task.task_id)  ORDER BY task.task_number ',
      p_title                  => 'Task Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No tasks exist for the project.',
      p_solution               => '',
      p_success_msg            => 'Tasks exist for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_TASKS');



debug('begin add_signature: EBS_FIN_PA_PROJECT_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26046',
      p_sig_id                 => 'EBS_FIN_PA_PROJECT_TYPES',
      p_sig_sql                => 'SELECT type.*  ,      
nvl(lookup.meaning,''null'') "CIP Grouping|Method|Code"  ,      
nvl(lookup2.meaning,''null'') "Capital Cost|Type Code"  ,      
nvl(lookup3.meaning,''null'') "Interface|Asset Cost Code"  ,      
rbe.budget_entry_method   ,      
rbe.start_date_active "Budget|Entry Method|Start Date"  ,      
rbe.end_date_active "Budget|Entry Method|End Date"  ,      
nvl(lookup4.meaning,''null'') "Vendor|Invoice|Grouping Code"  ,      
cb.ind_rate_sch_name "Cost|Burden|Schedule"  ,      
DECODE(type.burden_amt_display_method,''D'',''Separate'',         
''S'',''Same'',type.burden_amt_display_method) "Burden|Amt|Display|Method"  ,      
destproj.segment1 "Burden|Dest|Proj Number"  ,      
desttask.task_number "Burden|Dest|Task Number"  ,      
nvl(lookup5.meaning,''Null'') "Allowable|Funding|Level|Code"  ,      
rb.ind_rate_sch_name "Rev|Burden|Schedule"  ,      
ib.ind_rate_sch_name "Inv|Burden|Schedule"  ,      
li.name "Labor|Invoice|Format"  ,      
nli.name "Non-Labor|Invoice|Format"  ,      
bcy.billing_cycle_name "Billing|Cycle|Name"  
FROM   PA_PROJECT_TYPES_ALL type  ,      PA_LOOKUPS lookup  ,      PA_LOOKUPS lookup2  ,      
PA_LOOKUPS lookup3  ,      PA_LOOKUPS lookup4  ,      PA_BUDGET_ENTRY_METHODS rbe  ,      
PA_IND_RATE_SCHEDULES_ALL_BG cb  ,      PA_PROJECTS_ALL destproj  ,      PA_TASKS desttask  ,      
PA_LOOKUPS lookup5  ,      PA_INVOICE_FORMATS li  ,      PA_INVOICE_FORMATS nli  ,      
PA_IND_RATE_SCHEDULES_ALL_BG rb  ,      PA_IND_RATE_SCHEDULES_ALL_BG ib  ,      PA_BILLING_CYCLES bcy  
WHERE  
type.project_type in (select project_type from pa_projects_all where project_id = ##$$PROJECT_ID$$##) 
AND    lookup.lookup_type (+) = ''CIP GROUPING METHOD''  
AND    lookup.lookup_code (+) = type.cip_grouping_method_code  
AND    lookup2.lookup_type (+) = ''CAPITAL COST TYPE''  
AND    lookup2.lookup_code (+) = type.capital_cost_type_code  
AND    lookup3.lookup_type (+) = ''INTERFACE ASSET COST''  
AND    lookup3.lookup_code (+) = type.interface_asset_cost_code  
AND    rbe.budget_entry_method_code (+) = type.rev_budget_entry_method_code  
AND    lookup4.lookup_type (+) = ''VENDOR_INVOICE_GROUPING_CODE''  
AND    lookup4.lookup_code (+) = type.vendor_invoice_grouping_code   
AND    type.cost_ind_rate_sch_id = cb.ind_rate_sch_id (+)  
AND    destproj.project_id (+) = type.burden_sum_dest_project_id  
AND    desttask.task_id (+) = type.burden_sum_dest_task_id  
and    type.labor_invoice_format_id = li.invoice_format_id (+)  
and    type.non_labor_invoice_format_id = nli.invoice_format_id (+)  
and    type.rev_ind_rate_sch_id  = rb.ind_rate_sch_id (+)  
and    type.inv_ind_rate_sch_id  = ib.ind_rate_sch_id (+)  
and    type.billing_cycle_id = bcy.billing_cycle_id (+)  
AND    lookup5.lookup_type = ''ALLOWABLE FUNDING LEVEL''  
AND    lookup5.lookup_code = type.allowable_funding_level_code
AND    type.org_id = ##$$ORG_ID$$##',
      p_title                  => 'Project Type Details ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Project type details do not exist for the selected project.',
      p_solution               => '',
      p_success_msg            => 'Project type details exist for the selected project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PROJECT_TYPES');



debug('begin add_signature: EBS_FIN_PA_PROJECT_STATUS_ALLOW_CAPITALIZATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26712',
      p_sig_id                 => 'EBS_FIN_PA_PROJECT_STATUS_ALLOW_CAPITALIZATION',
      p_sig_sql                => 'SELECT p.segment1 "Project Number", 
c.project_status_code "Project Status Code"
FROM pa_project_status_controls c,
    pa_projects_all p
WHERE p.project_status_code = c.project_status_code
    AND c.action_code = ''CAPITALIZE''
    AND c.enabled_flag = ''Y''
    AND p.project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Project Status Allows Capitalization',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The project''s status does not allow capitalization.  For transactions to be capitalized, the status controls must allow ''Capitalize Assets''.   ',
      p_solution               => 'Please follow the solution in [2754529/KB252738]  PAXCPGAL: PRC: Generate Asset Lines for a Single Project Returns Exception "The Project Status does not allow this action".',
      p_success_msg            => 'The project status allows capitalization.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PROJECT_STATUS_ALLOW_CAPITALIZATION');



debug('begin add_signature: EBS_FIN_PA_TOT_CAP_FOR_PROJECT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26067',
      p_sig_id                 => 'EBS_FIN_PA_TOT_CAP_FOR_PROJECT',
      p_sig_sql                => 'SELECT count(*)
    FROM  pa_expenditure_items_all ei
    where nvl(ei.billable_flag,''N'') = ''Y''
    and   ei.project_id = ##$$PROJECT_ID$$##

',
      p_title                  => 'Capitalizable Expenditures for Project',
      p_fail_condition         => '[count(*)] = [0]',
      p_problem_descr          => 'This project does not have any capitalizable expenditure items.',
      p_solution               => 'In order to review summary information and capitalize CIP assets, expenditure items need to be capitalizable. Please follow solution in [2958889/KB477621] PAXCARVW No Capitalizable Expenditures In CIP Total.',
      p_success_msg            => 'This project has capitalizable expenditure items.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_TOT_CAP_FOR_PROJECT');



debug('begin add_signature: PA_EXPENDITURE_ITEMS_NOT_GENERATED_INTO_ASSET_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13705',
      p_sig_id                 => 'PA_EXPENDITURE_ITEMS_NOT_GENERATED_INTO_ASSET_LINES',
      p_sig_sql                => 'select  count(*)  "No Expenditure Items",
pt.task_number  "Task Number " ,
pei.task_id  "Task Id " ,
sum(pei.raw_cost)  "Raw Cost " ,
sum(pei.burden_cost)  "Burden Cost " ,
pei.billable_flag  "Capitalizable Flag " ,
pei.cost_distributed_flag  "Cost Distributed Flag " ,
 pei.cost_dist_rejection_code  "Cost Dist Rejection "  ,
pei.cost_burden_distributed_flag  "Cost Burden Dist Flag " ,
pei.ind_cost_dist_rejection_code  "Cost Burden Dist Reject " ,
sum(pei.raw_cost)  "Raw Cost " ,
sum(pei.burden_cost)  "Burden Cost ",
max(cdl_PA_Date) "Maximum CDL PA Date"
FROM   pa_expenditure_items_all pei,
pa_expenditure_types pet,
pa_tasks pt, (select cdl.expenditure_item_id, max(pa_date) cdl_PA_Date from pa_cost_distribution_lines_all cdl group by cdl.expenditure_item_id) cdl1
WHERE  pei.billable_flag = ''Y''
AND    pei.expenditure_item_id = cdl1.expenditure_item_id
AND    pei.task_id = pt.task_id
AND    pei.expenditure_type = pet.expenditure_type
AND    nvl(pei.net_zero_adjustment_flag,''N'') = ''N''
AND    pt.project_id  = ##$$PROJECT_ID$$##
AND    not exists
(select   ''Y''
from      pa_project_asset_line_details
where     expenditure_item_id = pei.expenditure_item_id)
group by pei.task_id, pt.task_number,
pei.billable_flag,
pei.cost_distributed_flag,
pei.cost_dist_rejection_code,
pei.cost_burden_distributed_flag,
pei.ind_cost_dist_rejection_code
order by pei.cost_distributed_flag,
pt.task_number
',
      p_title                  => 'Expenditure Items Not Generated into Asset Lines',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This project has either not had the PRC: Generate Asset Lines process run for it or the project is not ready to generate CIP items.  ',
      p_solution               => 'Please follow the solution in [149234/KB204666] PAXCPGAL: Unable to Generate Asset Lines Even though the PA Through Date Parameter is After Expenditure PA Date.',
      p_success_msg            => 'All eligible expenditures have been generated into asset lines.  ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_EXPENDITURE_ITEMS_NOT_GENERATED_INTO_ASSET_LINES');



debug('begin add_signature: EBS_FIN_PA_RAW_NON_ACCT_DIST_ITEMS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26237',
      p_sig_id                 => 'EBS_FIN_PA_RAW_NON_ACCT_DIST_ITEMS',
      p_sig_sql                => 'SELECT ei.expenditure_item_id "Expenditure Item Id ",
pt.task_number "Task Number ",
ei.raw_cost "Raw Cost " 
FROM   pa_expenditure_items_all ei, 
pa_tasks pt
where  ei.task_id = pt.task_id
and    pt.project_id = ##$$PROJECT_ID$$##
and    ei.cost_distributed_flag = ''Y''
and    ei.cost_burden_distributed_flag <> ''Y'' 
and EXISTS ( select null from pa_cost_distribution_lines pcdl 
where ei.expenditure_item_id = pcdl.expenditure_item_id 
AND pcdl.line_type =''R''
and pcdl.transfer_status_code NOT IN (''V'', ''A'') ) ',
      p_title                  => 'Raw Cost Expenditure Items Not Final Accounted',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This project contains raw cost expenditure items that have not been final accounted in the General Ledger.  ',
      p_solution               => 'Please follow the solution in [2748211/KB570888] PAXCPGAL PRC: Generate Asset Lines Rejection: Expenditure Items not final accounted.',
      p_success_msg            => 'This project has no raw cost items that are not final accounted in the General Ledger.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_RAW_NON_ACCT_DIST_ITEMS');



debug('begin add_signature: EBS_FIN_PA_BURDEN_ITEMS_ACCOUNTED_SQL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26310',
      p_sig_id                 => 'EBS_FIN_PA_BURDEN_ITEMS_ACCOUNTED_SQL',
      p_sig_sql                => 'SELECT ei.expenditure_item_id "Expenditure Item Id ",
    pt.task_number         "Task Number ",
    ei.raw_cost            "Raw Cost ",
    ei.burden_cost         "Burdened Cost "
FROM
    pa_expenditure_items_all ei,
    pa_tasks                 pt,
    pa_projects_all          p,
...
WHERE
        ei.task_id = pt.task_id
    AND pt.project_id =  ##$$PROJECT_ID$$##
    AND pt.project_id = p.project_id
    AND pta.project_type = p.project_type
    AND pta.org_id = p.org_id
    AND p.org_id = ei.org_id
    AND pta.burden_account_flag = ''Y''
    AND ei.cost_distributed_flag = ''Y''
    AND ei.cost_burden_distributed_flag = ''Y''
        AND EXISTS (
        SELECT
        ...
        WHERE
                ei.expenditure_item_id = pcdl.expenditure_item_id
            AND ( ( pcdl.line_type = ''I''
                    AND pcdl.transfer_status_code <> ''G'' )
                  OR pcdl.line_type IN ( ''R'', ''D'' )
                  AND pcdl.transfer_status_code NOT IN ( ''V'', ''A'' ) )
    )',
      p_title                  => 'Burden Cost Distribution Lines Not Final Accounted',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This project contains total burden cost distributions that have not been final accounted in the General Ledger. ',
      p_solution               => 'Please follow the solution in [2748211/KB570888] PAXCPGAL PRC: Generate Asset Lines Rejection: Expenditure Items not final accounted.
',
      p_success_msg            => 'This project has no burden cost items that are not final accounted in the General Ledger.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_BURDEN_ITEMS_ACCOUNTED_SQL');



debug('begin add_signature: EBS_FIN_PA_EI_PAST_PA_THROUGH_DATE_SQL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26309',
      p_sig_id                 => 'EBS_FIN_PA_EI_PAST_PA_THROUGH_DATE_SQL',
      p_sig_sql                => 'SELECT  ei.expenditure_item_id                           "Expenditure Item Id",
    to_char(ei.expenditure_item_date, ''DD-MON-YYYY'') "Expenditure Item Date",
    ei.expenditure_type                              "Expenditure Type",
    pt.task_number                                   "Task Number",
    ei.task_id                                       "Task Id",
    ei.billable_flag                                 "Capitalizable Flag",
    ei.cost_distributed_flag                         "Cost Distributed Flag",
    ei.cost_burden_distributed_flag                  "Cost Burden Dist Flag",
    ei.raw_cost                                      "Raw Cost",
    ei.burden_cost                                   "Burdened Cost"
FROM
    pa_expenditure_items_all ei,
...
WHERE  ei.task_id = pt.task_id
    ...
    AND ei.expenditure_item_date > (
        ...
        FROM pa_periods_all p
        WHERE p.end_date <= sysdate
        AND p.org_id =  ##$$ORG_ID$$##
    )',
      p_title                  => 'Costed Expenditures Exist Beyond the PA Through Date',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Costed expenditures exist on this project beyond the default PA Through Date. ',
      p_solution               => 'Review the solution in [149234/KB204666] PAXCPGAL: Unable to Generate Asset Lines Even though the PA Through Date Parameter is After Expenditure PA Date.',
      p_success_msg            => 'There are no costed expenditures beyond the default PA Through Date.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_EI_PAST_PA_THROUGH_DATE_SQL');



debug('begin add_signature: EBS_FIN_PA_PA_CP_SUM_NOT_MATCH_PSI');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26077',
      p_sig_id                 => 'EBS_FIN_PA_PA_CP_SUM_NOT_MATCH_PSI',
      p_sig_sql                => 'select 
c.PROJECT_NUMBER "Project Number", 
c.EXPENSED "Expensed",
c.CAPITALIZABLE_COST "Capitalizable Cost",
c.CIP_COST "CIP Cost",
c.CAPITALIZED_COST "Capitalized Cost",
c.TOTAL_COSTS "Total Cost",
future_txn "Future Dated Expend Total", 
decode(ppt.capital_cost_type_code,''R'',
a.billable_raw_cost_itd, ''B'', a.billable_burdened_cost_itd) "Summarized Capitalizable Cost",
decode (ppt.capital_cost_type_code,''R'',a.raw_cost_itd, ''B'', a.burdened_cost_itd) "Summarized Total Cost"
from
(select pp.project_id,decode(ppt.capital_cost_type_code,''R'',sum(txn.i_tot_raw_cost),
''B'',sum(txn.i_tot_burdened_cost)) future_txn
FROM
pa_txn_accum txn, pa_projects_all pp, pa_project_types_all ppt
WHERE 
txn.project_id = ##$$PROJECT_ID$$## 
and txn.project_id = pp.project_id
and pp.project_type = ppt.project_type
group by pp.project_id, ppt.capital_cost_type_code) future,
PA_CAPITAL_PROJECTS_V c, pa_project_accum_headers h, pa_project_accum_actuals a,
pa_projects pp, pa_project_types ppt, hr_organization_units org
where c.project_id = ##$$PROJECT_ID$$## 
and future.project_id = c.project_id
and c.project_id = pp.project_id
and h.project_id = pp.project_id
and h.project_accum_id = a.project_accum_id
and h.task_id = 0 and h.resource_id = 0
and pp.project_type = ppt.project_type
and org.organization_id = pp.carrying_out_organization_id
and (pp.org_id is null or pp.org_id = ppt.org_id)
AND future_txn > 0',
      p_title                  => 'Total Cost in Capital Project Summary (Less Future Dated Expenditures) Does Not Match Project Status Inquiry',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Total cost in the Capital Project Summary form less the future dated expenditures does not match the Project Status Inquiry form total.
',
      p_solution               => 'Please follow the solution in [2958573/KB550586] Total Cost in the Capital Project Summary Form (PAXCARVW) Less the Future Dated Expenditures Does Not Match the Project Status Inquiry Form (PAXURVPS) Total. ',
      p_success_msg            => 'Total cost in the Capital Project Summary form less future dated expenditures matches the Project Status Inquiry form total.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_CP_SUM_NOT_MATCH_PSI');



debug('begin add_signature: EBS_FIN_PA_EI_TOTALS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26060',
      p_sig_id                 => 'EBS_FIN_PA_EI_TOTALS',
      p_sig_sql                => 'SELECT ''Total Expenditure Items = '' || COUNT(*) "Expenditure items"
FROM pa_expenditure_items_all ei,
    pa_tasks             pt
WHERE ei.task_id = pt.task_id
    AND pt.project_id = ##$$PROJECT_ID$$##
UNION
SELECT ''Total Capitalizable Expenditures = '' || COUNT(decode(ei.billable_flag, ''Y'', ei.billable_flag, NULL))  "Expenditure items"
FROM pa_expenditure_items_all ei,
    pa_tasks                 pt
WHERE ei.task_id = pt.task_id
    AND pt.project_id = ##$$PROJECT_ID$$##
    AND ( ei.revenue_distributed_flag = ''N''
          OR ( ei.revenue_distributed_flag = ''Y''
               AND NOT EXISTS (
        SELECT NULL
        FROM pa_project_asset_line_details pald,
            pa_project_asset_lines_all  pal -- added _All
        WHERE pald.expenditure_item_id = ei.expenditure_item_id
            AND pal.project_asset_line_detail_id = pald.project_asset_line_detail_id
            AND pal.transfer_status_code = ''T''
    ) ) )
UNION
SELECT ''Total Expensed Expenditure Items = '' || COUNT(*) "Expenditure items"
FROM   pa_expenditure_items_all ei 
,      pa_tasks pt 
where  ei.task_id = pt.task_id 
and    pt.project_id = ##$$PROJECT_ID$$##
AND    nvl(ei.billable_flag, ''N'')  = ''N'' -- add this condition
-- How about adding one more row?
UNION
SELECT ''Total Capitalized Expenditure Items = '' || COUNT(*) "Expenditure items"
FROM   pa_expenditure_items_all ei 
,      pa_tasks pt 
where  ei.task_id = pt.task_id 
and    pt.project_id = ##$$PROJECT_ID$$##
...
',
      p_title                  => 'Expenditure Item Totals',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No expenditure item total details for this capital project.',
      p_solution               => '',
      p_success_msg            => 'Expenditure item total details exist for this project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_EI_TOTALS');



debug('begin add_signature: EBS_FIN_PA_EXP_NOT_ACCUM_CAP_PROJ_SUM');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26112',
      p_sig_id                 => 'EBS_FIN_PA_EXP_NOT_ACCUM_CAP_PROJ_SUM',
      p_sig_sql                => 'select cdl.project_id "Project id", cdl.expenditure_item_id "Expenditure Item Id",      
cdl.line_num "Line Num", to_char(ei.expenditure_item_date, ''DD-MON-YYYY'') "Expenditure Item Date",      
ei.expenditure_type "Expenditure Type", t.task_number "Task Number", ei.task_id "Task Id",      
to_char(cdl.pa_date, ''DD-MON-YYYY'') "PA Date", to_char(cdl.gl_date, ''DD-MON-YYYY'') "GL Date",      
cdl.billable_flag "Capitalizable Flag", ei.cost_distributed_flag "Cost Distributed Flag",      
ei.cost_burden_distributed_flag "Cost Burden Dist Flag",     
cdl.resource_accumulated_flag "Resource Accumd Flag", cdl.amount "Amount", cdl.burdened_cost "Burdened Cost",      
cdl.transfer_status_code "Transfer Status Code", cdl.transfer_rejection_reason "Transfer Reject Reason"  
FROM   
pa_cost_distribution_lines_all cdl, pa_expenditure_items_all ei, pa_tasks t  
WHERE
cdl.expenditure_item_id = ei.expenditure_item_id and cdl.project_id = ##$$PROJECT_ID$$##                
AND    
ei.task_id = t.task_id and cdl.line_type = ''R'' and not exists 
(select ''y'' from pa_txn_accum_details txn                      
where txn.project_id =##$$PROJECT_ID$$##                 
and txn.expenditure_item_id = cdl.expenditure_item_id                      
and txn.line_num = cdl.line_num)  
order by t.task_number  ',
      p_title                  => 'Capital Project Summary Form Does Not Include All Cost Distributions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This project has cost distributions that have not been accumulated into summarization and therefore the Capital Project Summary form will not reflect the total distributed expenditures for this project.                                                                                                                
',
      p_solution               => 'Follow the instructions in [2959946/KB676375] Total Distributed Expenditures are not Showing for a Project in the Capital Project Summary Form (PAXCARVW).
',
      p_success_msg            => 'The expenditures are all accumulated in the Capital Project Summary form for this project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_EXP_NOT_ACCUM_CAP_PROJ_SUM');



debug('begin add_signature: EBS_FIN_PA_EI_BURDEN_NOT_DIST_SQL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26201',
      p_sig_id                 => 'EBS_FIN_PA_EI_BURDEN_NOT_DIST_SQL',
      p_sig_sql                => ' SELECT   ei.expenditure_item_id "Expenditure Item Id" 
 ,       to_char(ei.expenditure_item_date, ''DD-MON-YYYY'') "Expenditure Item Date" 
 ,       ei.expenditure_type "Expenditure Type" 
 ,       pt.task_number "Task Number" 
...
and  pta.CAPITAL_COST_TYPE_CODE = ''B''
 and     ei.cost_distributed_flag = ''Y'' 
 and     ei.cost_burden_distributed_flag = ''N''
',
      p_title                  => 'Expenditure Items Not Yet Burdened',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'All costed expenditure items have not been successfully burdened.',
      p_solution               => 'When project type is set as burden accounting,  expenditures must be cost burdened distributed.<br>
Review the solution in [3037770/KB169352] PAXCPGAL PRC: Generate Asset Lines Does Not Generate Assets For Expenditures',
      p_success_msg            => 'All costed expenditure items have been successfully burdened.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_EI_BURDEN_NOT_DIST_SQL');



debug('begin add_signature: EBS_FIN_PA_PA_COST_UNDO_ACCT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26473',
      p_sig_id                 => 'EBS_FIN_PA_PA_COST_UNDO_ACCT',
...
AND ei.EXPENDITURE_ITEM_ID = NVL(##$$EIID$$##, ei.EXPENDITURE_ITEM_ID)
AND ei.COST_DISTRIBUTED_FLAG = ''Y''
...
AND NOT EXISTS
  ...
  WHERE det.EXPENDITURE_ITEM_ID = cdl.EXPENDITURE_ITEM_ID
      ...
      p_title                  => 'Eligibility of Expenditure Item(s) for Undo Accounting',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The expenditure item(s) are eligible for undo accounting.',
      p_solution               => 'Review the information in [2204563/KB295859] Enhancements to Oracle Projects Suite Release 12.1.3 Delta 7 CU3 <br>
Section: Undo Accounting.<br>',
      p_success_msg            => 'No expenditure item(s)  exists which are eligible for undo accounting.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_COST_UNDO_ACCT');



debug('begin add_signature: EBS_FIN_PA_EI_NOT_COSTED_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26118',
      p_sig_id                 => 'EBS_FIN_PA_EI_NOT_COSTED_DETAILS',
      p_sig_sql                => 'SELECT  ei.expenditure_item_id "Expenditure Item Id", 
ei.expenditure_item_date "Expenditure Item Date", 
ei.expenditure_type "Expenditure Type",
pt.task_number "Task Number", 
ei.task_id "Task Id", 
ei.billable_flag "Capitalizable Flag" , 
...
and  ei.billable_flag = ''Y''
order by ei.expenditure_item_id DESC',
      p_title                  => 'Uncosted Project Expenditure Item Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This project has no costed expenditures.  In order to review expenditure information in the Capital Projects Summary form and in Project Status Inquiry, and capitalize CIP assets,  expenditures must be costed.',
      p_solution               => 'Please follow the solution in [3037770/KB169352] PAXCPGAL PRC: Generate Asset Lines Does Not Generate Assets For Expenditures',
      p_success_msg            => 'All expenditure items are costed on this project.  ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_EI_NOT_COSTED_DETAILS');



debug('begin add_signature: EBS_FIN_PA_TOT_EXPENDITURES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26659',
      p_sig_id                 => 'EBS_FIN_PA_TOT_EXPENDITURES',
      p_sig_sql                => 'SELECT count(*) "Expenditure Count" ,
           sum(pei.raw_cost) "Raw Cost" ,
           sum(pei.burden_cost) "Burden Cost" 
      FROM   PA_EXPENDITURE_ITEMS_ALL pei 
      WHERE  pei.project_id =  ##$$PROJECT_ID$$##
',
      p_title                  => 'Total Expenditure Costs',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No expenditures exist for this capital project.
',
      p_solution               => '',
      p_success_msg            => 'This capital project has expenditures.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_TOT_EXPENDITURES');



debug('begin add_signature: EBS_FIN_PA_TOT_EXPENSED_COST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26658',
      p_sig_id                 => 'EBS_FIN_PA_TOT_EXPENSED_COST',
      p_sig_sql                => 'SELECT count(*) "Expenditure Items Count" ,
           pei.task_id ,
           pt.task_number ,
           sum(pei.raw_cost) "Raw Cost" ,
           sum(pei.burden_cost) "Burden Cost" ,
      ...
      GROUP BY pei.task_id, 
         ...
         pei.cost_burden_distributed_flag ,
         pei.ind_cost_dist_rejection_code 
      ORDER BY pei.cost_distributed_flag, pt.task_number
',
      p_title                  => 'Total Expensed Costs',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No expensed costs exist for this project.
',
      p_solution               => '',
      p_success_msg            => 'Expensed costs exist for this project.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_TOT_EXPENSED_COST');



debug('begin add_signature: EBS_FIN_PA_CAP_EXPEND');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26657',
      p_sig_id                 => 'EBS_FIN_PA_CAP_EXPEND',
      p_sig_sql                => 'SELECT
    COUNT(*)             "Expenditure Items Count",
    pei.task_id,
    pt.task_number,
    SUM(pei.raw_cost)    "Raw Cost",
    SUM(pei.burden_cost) "Burden Cost",
...
ORDER BY
    pei.cost_distributed_flag,
    pt.task_number',
      p_title                  => 'Capitalizable Expenditure Items',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no capitalizable expenditures for the project.',
      p_solution               => '',
      p_success_msg            => 'Capitalizable expenditure items for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_CAP_EXPEND');



debug('begin add_signature: EBS_FIN_PA_PA_CDL_NOT_IN_GL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26656',
      p_sig_id                 => 'EBS_FIN_PA_PA_CDL_NOT_IN_GL',
      p_sig_sql                => 'SELECT
    pcdl.expenditure_item_id,
    COUNT(pcdl.line_num) "Number of Distribution Lines",
    pcdl.pa_date,
    pcdl.billable_flag   "Capitalizable Flag",
    pcdl.transfer_status_code,
    pcdl.transfer_rejection_reason
FROM
    pa_cost_distribution_lines_all pcdl,
    pa_expenditure_items_all pei
WHERE
    pei.expenditure_item_id = pcdl.expenditure_item_id
    AND pei.billable_flag = ''Y''
    AND pcdl.project_id = ##$$PROJECT_ID$$##
    AND pcdl.transfer_status_code NOT IN ( ''T'', ''V'', ''A'', ''G'' )
GROUP BY
    pcdl.expenditure_item_id,
    pcdl.pa_date,
    pcdl.billable_flag,
    ...
    pcdl.transfer_rejection_reason
',
      p_title                  => 'Cost Distribution Lines Not Transferred to GL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'All cost distribution lines are transferred to GL.',
      p_solution               => 'Review the solution in PAXCPCAL: Assets Rejected with the CIP Cost has not been Interfaced to GL [389706/KB199302].',
      p_success_msg            => 'Cost distribution lines are not transferred to GL / not transferred to GL from AP and PO.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_CDL_NOT_IN_GL');



debug('begin add_signature: EBS_FIN_PA_EXP_ITEM_FINAL_ACCOUNTED_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26488',
      p_sig_id                 => 'EBS_FIN_PA_EXP_ITEM_FINAL_ACCOUNTED_STATUS',
      p_sig_sql                => 'SELECT  ccid.task_num "Task Number",  
    nvl(ccid.transaction_source, ''Not Imported'') "Transaction Source",
    ccid.expenditure_type, 
    ccid.expenditure_item_date,
    ccid.expenditure_item_id,
    ccid.billable_flag "Capitalizable Flag",
    ccid.revenue_distributed_flag "Asset Generated",
    ccid.cost_distributed_flag "Cost Distributed",
    ccid.cdl_line_num,
    ccid.line_type,
    ccid.cdl_transfer_status,
    ccid.cip_ccid "CIP_CCID",
    ccid.acct_event_id 
FROM  (select pt.task_number task_num, 
pei.expenditure_item_id, pei.transaction_source, pei.expenditure_type, pei.expenditure_item_date, pei.revenue_distributed_flag, pei.cost_distributed_flag, pei.billable_flag,
  pcdl.line_num cdl_line_num, pcdl.line_type line_type, pcdl.transfer_status_code cdl_transfer_status,  pcdl.acct_event_id,
    decode(pcdl.acct_source_code,
       ...
       WHERE  
        ...
        AND pei.expenditure_item_id = nvl(##$$EIID$$##, pei.expenditure_item_id)
        AND p.project_id =   ##$$PROJECT_ID$$##
       AND pei.project_id              = p.project_id  
      AND p.project_type = pta.project_type
      AND p.org_id = pta.org_id
      AND   pei.revenue_distributed_flag||'''' = ''N'' 
       AND   pei.cost_distributed_flag =''Y''
       AND   pcdl.line_type = DECODE(pta.capital_cost_type_code, ''B'', DECODE(NVL(pta.total_burden_flag,DECODE(pta.burden_amt_display_method,''S'',''Y'',''D'',''N'',''Y'')),''Y'', ''D'',''R''),''R'')
      AND pcdl.transfer_status_code in (''V'', ''A'', ''B'') 
      AND pei.billable_flag = ''Y''
       ) CCID
union
SELECT  t.task_number "Task Number",  
    nvl(ei.transaction_source, ''Not Imported'') "Transaction Source",
    ei.expenditure_type, 
    ei.expenditure_item_date,
    ei.expenditure_item_id,
    ei.billable_flag "Capitalizable Flag",
    ei.revenue_distributed_flag "Asset Generated",
    ei.cost_distributed_flag "Cost Distributed",
    cdl.line_num,
    cdl.line_type,
    cdl.transfer_status_code,
    nvl(cdl.dr_code_combination_id, 0) "CIP_CCID",
    cdl.acct_event_id 
FROM
     pa_expenditure_items_all ei ,
     pa_cost_distribution_lines_all cdl,
...
WHERE  cdl.expenditure_item_id(+) = ei.expenditure_item_id
     ...
     AND i.org_id = ei.org_id 
     AND ei.expenditure_item_id = ##$$EIID$$## 
     AND pr.project_id =   ##$$PROJECT_ID$$##
     AND ei.project_id              = pr.project_id 
     AND pr.project_type = pt.project_type
     AND pr.org_id = pt.org_id 
     AND  cdl.line_type(+) = DECODE(pt.capital_cost_type_code, ''B'', DECODE(NVL(pt.total_burden_flag,DECODE(pt.burden_amt_display_method,''S'',''Y'',''D'',''N'',''Y'')),''Y'', ''D'',''R''),''R'')
     AND ( ei.revenue_distributed_flag = ''Y'' or ei.cost_distributed_flag = ''N'' or ei.billable_flag =''N'')
 ORDER by expenditure_item_id',
      p_title                  => 'Accounting in SLA in Final Mode',
      p_fail_condition         => '[CIP_CCID] is null',
      p_problem_descr          => 'Transaction(s) not final accounted or not final accounted in Source Module.   If you are capitalizing  costs on your project, the transactions which are capitalizable and cost distributed must be accounted in final mode, including transactions imported as accounted from other Oracle applications.',
      p_solution               => 'Review the solution in [3037770/KB169352] PAXCPGAL PRC: Generate Asset Lines Does Not Generate Assets For Expenditures.
',
      p_success_msg            => 'Expenditure(s) final accounted in source module.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_EXP_ITEM_FINAL_ACCOUNTED_STATUS');



debug('begin add_signature: EBS_FIN_PA_ASSETS_FF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25920',
      p_sig_id                 => 'EBS_FIN_PA_ASSETS_FF',
      p_sig_sql                => 'SELECT asset.project_asset_id,
       rtrim(nvl(ca.segment1,'' '')||''-''||nvl(ca.segment2,'' '')||''-''||
nvl(ca.segment3,'' '')||''-''||nvl(ca.segment4,'' '')||''-''||
nvl(ca.segment5,'' '')||''-''||nvl(ca.segment6,'' '')||''-''||
nvl(ca.segment7,'' ''), ''- '')  "Asset Category|Account Values",
       l.segment1 ||''-'' ||l.segment2 ||''-'' ||l.segment3 ||''-'' ||l.segment4  "Location|Account Values",
       c.segment1 ||''-'' ||c.segment2 ||''-'' ||c.segment3 ||''-'' ||c.segment4  "Depreciation|Account Values"
FROM   pa_project_assets_all asset,
       fa_categories ca,
       fa_locations l,
       gl_code_combinations c
WHERE  asset.asset_category_id = ca.category_id (+)
       AND asset.location_id = l.location_id (+)
       AND asset.depreciation_expense_ccid = c.code_combination_id (+)
       AND asset.project_id = ##$$PROJECT_ID$$##
       AND asset.project_asset_id = Nvl(''##$$PROJECT_ASSET_ID$$##'', asset.project_asset_id)
ORDER  BY asset.book_type_code,
          asset.capitalized_flag DESC,
          asset.project_asset_id ',
      p_title                  => 'Assets - Flexfields ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No asset flexfield data  (category, location and depreciation) exists for the project asset.',
      p_solution               => '',
      p_success_msg            => 'Assets flexfield data (category, location and depreciation) exists for this project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_ASSETS_FF');



debug('begin add_signature: PA_PROJECT_ASSETS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13706',
      p_sig_id                 => 'PA_PROJECT_ASSETS_ALL',
      p_sig_sql                => 'SELECT * FROM PA_PROJECT_ASSETS_ALL WHERE project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Project Assets (PA_PROJECT_ASSETS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No assets exist in PA_PROJECT_ASSETS_ALL for Project ID ##$$PROJECT_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Assets exist in PA_PROJECT_ASSETS_ALL for Project ID ##$$PROJECT_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PROJECT_ASSETS_ALL');



debug('begin add_signature: EBS_FIN_PA_PA_PROJECT_ASSET_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25925',
      p_sig_id                 => 'EBS_FIN_PA_PA_PROJECT_ASSET_LINES',
      p_sig_sql                => 'SELECT pt.task_number,
       lines.transfer_status_code ||'' = '' || Nvl(lookup.meaning, ''Null'') "Transfer Status Code",
       lines.*
FROM   pa_project_asset_lines_all lines,
       pa_tasks pt,
       pa_lookups lookup
WHERE  lines.task_id = pt.task_id (+)
       AND lines.project_id = ##$$PROJECT_ID$$##
       AND lookup.lookup_type = ''TRANSFER STATUS''
       AND lookup.lookup_code (+) = lines.transfer_status_code
       AND lines.project_asset_id =  Nvl(''##$$PROJECT_ASSET_ID$$##'', lines.project_asset_id)
ORDER  BY lines.project_asset_id,
          lines.task_id,
          lines.transfer_status_code',
      p_title                  => 'Project Asset Lines (PA_PROJECT_ASSET_LINES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No project asset lines exist for the project asset.',
      p_solution               => '',
      p_success_msg            => 'Project asset lines exist for the project asset.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_PROJECT_ASSET_LINES');



debug('begin add_signature: EBS_FIN_PA_EBS_FIN_PA_PAEXPND_ASSET_LINE_DETAILS_PROJECT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24515',
      p_sig_id                 => 'EBS_FIN_PA_EBS_FIN_PA_PAEXPND_ASSET_LINE_DETAILS_PROJECT',
      p_sig_sql                => 'SELECT * FROM PA_PROJECT_ASSET_LINE_DETAILS
WHERE PROJECT_ASSET_LINE_DETAIL_ID IN (SELECT PROJECT_ASSET_LINE_DETAIL_ID
FROM PA_PROJECT_ASSET_LINES_ALL WHERE PROJECT_ID = ##$$PROJECT_ID$$## )
',
      p_title                  => 'Asset Line Details for the Project (PA_PROJECT_ASSET_LINE_DETAILS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No asset line details exist for Project ID ##$$PROJECT_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Asset line details exist for Project ID ##$$PROJECT_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_EBS_FIN_PA_PAEXPND_ASSET_LINE_DETAILS_PROJECT');



debug('begin add_signature: EBS_FIN_PA_PAEXPND_ASSET_LINE_DETAILS_EI');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24514',
      p_sig_id                 => 'EBS_FIN_PA_PAEXPND_ASSET_LINE_DETAILS_EI',
      p_sig_sql                => 'SELECT * FROM PA_PROJECT_ASSET_LINE_DETAILS
WHERE EXPENDITURE_ITEM_ID IN (SELECT EXPENDITURE_ITEM_ID FROM
PA_EXPENDITURE_ITEMS_ALL WHERE PROJECT_ID = ##$$PROJECT_ID$$## )',
      p_title                  => 'Asset Line Details for Expenditure Items Associated with the Project (PA_PROJECT_ASSET_LINE_DETAILS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data in PA_PROJECT_ASSET_LINE_DETAILS for expenditure items associated with Project ID ##$$PROJECT_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'PA_PROJECT_ASSET_LINE_DETAILS  records exist for expenditure items associated with Project ID ##$$PROJECT_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAEXPND_ASSET_LINE_DETAILS_EI');



debug('begin add_signature: PA_PROJECT_ASSET_ASSIGNMENTS-DC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15778',
      p_sig_id                 => 'PA_PROJECT_ASSET_ASSIGNMENTS-DC',
      p_sig_sql                => 'SELECT * FROM PA_PROJECT_ASSET_ASSIGNMENTS WHERE PROJECT_ID = ##$$PROJECT_ID$$##',
      p_title                  => 'Project Asset Assignments (PA_PROJECT_ASSET_ASSIGNMENTS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No project asset assignments exist for Project ID ##$$PROJECT_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Project asset assignments exist for Project ID ##$$PROJECT_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PROJECT_ASSET_ASSIGNMENTS-DC');



debug('begin add_signature: EBS_FIN_PA_FA_ADDITIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25927',
      p_sig_id                 => 'EBS_FIN_PA_FA_ADDITIONS',
      p_sig_sql                => 'SELECT pal.project_asset_id ,
       fad.*
FROM   fa_additions fad ,
       fa_asset_invoices fai ,
       pa_project_asset_lines_all pal
WHERE  fad.asset_id = fai.asset_id
AND    fai.project_asset_line_id = pal.project_asset_line_id
AND    pal.project_id = ##$$PROJECT_ID$$##
AND    pal.project_asset_id = Nvl(''##$$PROJECT_ASSET_ID$$##'', pal.project_asset_id)',
      p_title                  => 'Asset Additions in Fixed Assets (FA_ADDITIONS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data exists in FA_ADDITIONS for the project asset.',
      p_solution               => '',
      p_success_msg            => 'Descriptive information about assets  in FA for this project asset.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_FA_ADDITIONS');



debug('begin add_signature: PA-FA_MASS_ADDITIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15779',
      p_sig_id                 => 'PA-FA_MASS_ADDITIONS',
      p_sig_sql                => 'SELECT * FROM FA_MASS_ADDITIONS WHERE PROJECT_ID = ##$$PROJECT_ID$$##',
      p_title                  => 'Project Assets in Fixed Assets Mass Additions (FA_MASS_ADDITIONS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Fixed Assets mass addition information not found for Project ID ##$$PROJECT_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Fixed Asset mass addition information found for Project ID ##$$PROJECT_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA-FA_MASS_ADDITIONS');



debug('begin add_signature: PA-FA_DELETED_MASS_ADDITIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15780',
      p_sig_id                 => 'PA-FA_DELETED_MASS_ADDITIONS',
      p_sig_sql                => 'SELECT * FROM FA_DELETED_MASS_ADDITIONS WHERE PROJECT_ID = ##$$PROJECT_ID$$##',
      p_title                  => 'Fixed Assets Deleted Mass Additions (FA_DELETED_MASS_ADDITIONS) ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Fixed Assets deleted mass additions exist for Project ID ##$$PROJECT_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Fixed Assets deleted mass additions exist for Project ID ##$$PROJECT_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA-FA_DELETED_MASS_ADDITIONS');



debug('begin add_signature: EBS_FIN_PA_ASSET_LINES_DELETED_MASS_ADDITIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26180',
      p_sig_id                 => 'EBS_FIN_PA_ASSET_LINES_DELETED_MASS_ADDITIONS',
      p_sig_sql                => 'select famad.asset_number
           ,      famad.description 
           ,      pt.task_number  
           ,      famad.task_id  
           ,      famad.project_asset_line_id   
           ,      famad.fixed_assets_cost  
           ,      famad.payables_cost  
           ,      famad.mass_addition_id   
           ,      famad.parent_mass_addition_id    
           ,      famad.queue_name  
           from   fa_mass_additions famad,  pa_tasks pt  
           where  famad.queue_name = ''DELETE''  
           and    famad.task_id = pt.task_id  
           and    famad.project_id = ##$$PROJECT_ID$$##
           and    not exists (select null  
                              from   fa_asset_invoices fai  
                              where  fai.project_id = famad.project_id  
                              and    fai.project_asset_line_id = famad.project_asset_line_id)',
      p_title                  => 'Asset lines with Status of Delete in Mass Additions (FA_MASS_ADDITIONS)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are transferred asset lines for this project that have been incorrectly set to status DELETE in the Assets Mass Additions.  Project related assets must not be set to status DELETE in Mass Additions.',
      p_solution               => 'Follow the solution in [2958226/KB632808] PAXCARVW: A Line Amount Moves From Construction in Process (CIP) to Interfaced CIP but Does not Appear in Fixed Assets (FA).',
      p_success_msg            => 'There are no transferred asset lines for this project that have been incorrectly set to status DELETE in the Assets Mass Additions. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_ASSET_LINES_DELETED_MASS_ADDITIONS');



debug('begin add_signature: EBS_FIN_PA_FA_INVOICES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26004',
      p_sig_id                 => 'EBS_FIN_PA_FA_INVOICES',
      p_sig_sql                => 'SELECT pal.project_asset_id ,
       fai.*
FROM   fa_additions fad ,
       fa_asset_invoices fai ,
...
AND    pal.project_id = ##$$PROJECT_ID$$##
AND    pal.project_asset_id = Nvl(''##$$PROJECT_ASSET_ID$$##'', pal.project_asset_id)',
      p_title                  => 'Asset Invoices in Fixed Assets (FA_ASSET_INVOICES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Asset invoices do not exist for the project asset.',
      p_solution               => '',
      p_success_msg            => 'Asset invoices exist for the project asset.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_FA_INVOICES');



debug('begin add_signature: EBS_FIN_PA_PA_CAPITAL_EVENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25970',
      p_sig_id                 => 'EBS_FIN_PA_PA_CAPITAL_EVENTS',
      p_sig_sql                => 'SELECT * FROM PA_CAPITAL_EVENTS WHERE project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Project Capital Events (PA_CAPITAL_EVENTS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No capital events exist for the project.',
      p_solution               => '',
      p_success_msg            => 'Capital events exist for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_CAPITAL_EVENTS');



debug('begin add_signature: EBS_FIN_PA_ASSET_NOT_ADJUSTABLE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26178',
      p_sig_id                 => 'EBS_FIN_PA_ASSET_NOT_ADJUSTABLE',
      p_sig_sql                => 'SELECT  a.asset_name, a.asset_description, l.project_asset_id, l.project_asset_line_id
FROM   pa_project_asset_lines_all l, pa_project_assets_all a
WHERE  l.project_asset_id = a.project_asset_id 
AND    a.project_id =  ##$$PROJECT_ID$$##
AND    l.transfer_status_code in (''R'',''X'')
AND    l.transfer_rejection_reason = ''ASSET_NOT_ADJUSTABLE''',
      p_title                  => 'Asset Lines Showing Rejection Reason of Asset Not Adjustable',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are asset lines rejected with rejection reason of ''Asset Not Adjustable''.',
      p_solution               => 'Follow the solution in [1280695/KB273840]R12: PAXCPCAL PA Asset Lines for FA and Retired Assets Rejected with Errors, Asset is not Adjustable',
      p_success_msg            => 'No asset lines rejected with rejection reason of ''Asset Not Adjustable''.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_ASSET_NOT_ADJUSTABLE');



debug('begin add_signature: EBS_FIN_PA_ASSET_NOT_POSTABLE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26177',
      p_sig_id                 => 'EBS_FIN_PA_ASSET_NOT_POSTABLE',
      p_sig_sql                => 'SELECT a.asset_name, a.asset_description, l.project_asset_id, l.project_asset_line_id
FROM   pa_project_asset_lines_all l, pa_project_assets_all a
WHERE  l.project_asset_id = a.project_asset_id 
AND    a.project_id =  ##$$PROJECT_ID$$##
...
AND    l.transfer_rejection_reason = ''ASSET_NOT_POSTED''',
      p_title                  => 'Asset Lines Showing Rejection Reason of Asset Not Postable',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are asset lines rejected with rejection reason of ''Asset not Postable''.',
      p_solution               => 'Follow the solution in [1643785/KB543817] Reversing Asset Lines are Rejected with Original Asset Not Posted in Interface to Fixed Assets. ',
      p_success_msg            => 'No asset lines rejected with rejection reason of ''Asset not Postable''.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_ASSET_NOT_POSTABLE');



debug('begin add_signature: EBS_FIN_PA_CAPITALIZED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26075',
      p_sig_id                 => 'EBS_FIN_PA_CAPITALIZED',
      p_sig_sql                => 'select ASSET_NAME "Asset Name", ASSET_NUMBER "Asset Number", ASSET_DESCRIPTION "Asset Description" 
from PA_PROJECT_ASSETS_ALL 
where project_id = ##$$PROJECT_ID$$## 
and CAPITALIZED_FLAG = ''Y''
order by ASSET_NAME',
      p_title                  => 'Project Capitalized Assets',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no capitalized assets for this project.',
      p_solution               => '',
      p_success_msg            => 'Capitalized assets exist for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_CAPITALIZED');



debug('begin add_signature: EBS_FIN_PA_ASSET_NOT_TRANSFERRED_TO_FA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29607',
      p_sig_id                 => 'EBS_FIN_PA_ASSET_NOT_TRANSFERRED_TO_FA',
      p_sig_sql                => 'select ppa.*
from pa_project_asset_lines_all ppa
where nvl(transfer_status_code,''X'') <> ''T''
and   project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Assets Not Transfered To Fixed Assets',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'All assets are not transferred to Fixed Assets.',
      p_solution               => 'Please review the solution in [3039711/KB600345] Asset Lines in Projects That Are Not Transferred to Fixed Assets.',
      p_success_msg            => 'All assets are transferred to Fixed Assets.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_ASSET_NOT_TRANSFERRED_TO_FA');



debug('begin add_signature: EBS_FIN_PA_ASSET_LINE_TRANS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26216',
      p_sig_id                 => 'EBS_FIN_PA_ASSET_LINE_TRANS',
      p_sig_sql                => 'SELECT ''Total Asset Lines in Assets = '' || count(*) "Total Asset Lines"
      FROM   pa_project_asset_lines_all
      where  project_id = ##$$PROJECT_ID$$##
UNION
SELECT ''Total Transferred Asset Lines  = '' || count(*) "Total Transferred Asset Lines"
      FROM   pa_project_asset_lines_all
      where project_id = ##$$PROJECT_ID$$##
      and  transfer_status_code = ''T''',
      p_title                  => 'Asset Line and Transfer Totals',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No asset lines exist or have been transferred for this project.',
      p_solution               => '',
      p_success_msg            => 'Assets lines exist and have been transferred for this project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_ASSET_LINE_TRANS');



debug('begin add_signature: EBS_FIN_PA_ASSET_LINES_NOT_POSTED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26226',
      p_sig_id                 => 'EBS_FIN_PA_ASSET_LINES_NOT_POSTED',
      p_sig_sql                => 'SELECT BOOK_TYPE_CODE, PROJECT_ASSET_LINE_ID,  POSTING_STATUS
FROM   fa_mass_additions famad
WHERE  
      famad.project_id = ##$$PROJECT_ID$$##
       AND 
       famad.queue_name <> ''POSTED''',
      p_title                  => 'Asset Lines Not Posted',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no asset lines to be posted for this project.',
      p_solution               => '',
      p_success_msg            => 'There are asset lines to be posted for this project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_ASSET_LINES_NOT_POSTED');



debug('begin add_signature: EBS_FIN_PA_READY_TO_CAPITALIZE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26049',
      p_sig_id                 => 'EBS_FIN_PA_READY_TO_CAPITALIZE',
      p_sig_sql                => 'SELECT   pa.asset_name                "Asset Name",
    pa.project_asset_id          "Project Asset Id",
    pa.book_type_code            "FA Book",
    pa.date_placed_in_service    "Date Placed In Service (DPIS)",
    p.calendar_period_close_date "Asset Period",
    pa.estimated_in_service_date "Estimated DPIS",
    pa.capitalized_flag          "Capitalized Flag"
FROM pa_project_assets_all pa,
    fa_deprn_periods      p,
    fa_book_controls      b
WHERE  p.book_type_code = b.book_type_code
    AND b.book_type_code = pa.book_type_code
    AND b.last_period_counter = p.period_counter
    AND pa.project_id =  ##$$PROJECT_ID$$##
    AND pa.capitalized_flag = ''N''
    AND pa.date_placed_in_service <= p.calendar_period_close_date',
      p_title                  => 'Assets Ready to Capitalize',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The assets have a date placed in service and are ready to be capitalized.

',
      p_solution               => 'Follow the instructions in [866310/KB199270] PAXCPGAL & PAXCPCAL - What are the Steps to Generate Asset Lines and Interface them to Oracle Fixed Assets?',
      p_success_msg            => 'All assets have generated asset lines.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_READY_TO_CAPITALIZE');



debug('begin add_signature: EBS_FIN_PA_NO_DPIS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26044',
      p_sig_id                 => 'EBS_FIN_PA_NO_DPIS',
      p_sig_sql                => 'SELECT asset_name                "Asset Name",
    project_asset_id          "Project Asset Id",
    book_type_code            "FA Book",
    date_placed_in_service    "Date Placed In Service (DPIS)",
    estimated_in_service_date "Estimated DPIS",
    capitalized_flag          "Capitalized Flag"
FROM  pa_project_assets_all
WHERE project_id =  ##$$PROJECT_ID$$##
AND date_placed_in_service is NULL
',
      p_title                  => 'Assets with No Date Placed in Service',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The assets do not have a date placed in service and are not ready to be capitalized. 
',
      p_solution               => 'Follow the solution in [2363467/KB264835] PAXCPGAL: Project Has No Assets With Valid In Service Date and enter the actual Date Placed In Service (DPIS).',
      p_success_msg            => 'All assets have Date Placed In Service (DPIS).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_NO_DPIS');



debug('begin add_signature: EBS_FIN_PA_FUTURE_DPIS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26045',
      p_sig_id                 => 'EBS_FIN_PA_FUTURE_DPIS',
      p_sig_sql                => 'SELECT  pa.asset_name                "Asset Name",
    pa.project_asset_id          "Project Asset Id",
    pa.book_type_code            "FA Book",
    pa.date_placed_in_service    "Date Placed In Service (DPIS)",
...
WHERE  p.book_type_code = b.book_type_code
    AND b.book_type_code = pa.book_type_code
    --AND b.last_period_counter = p.period_counter
    and p.period_close_date is null
    AND pa.project_id =  ##$$PROJECT_ID$$##
    AND pa.capitalized_flag = ''N''
    AND pa.date_placed_in_service > p.calendar_period_close_date',
      p_title                  => 'Assets Having Future Date Placed in Service',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The assets will not capitalize as the Date Placed In Service (DPIS) entered is in a future Assets period.',
      p_solution               => 'Follow the solution in [2621724/KB427889] PAXCPCAL: Rejection: Future Period Date Placed in Service and ensure that DPIS is in the asset book''s current period or a prior period.',
      p_success_msg            => 'All assets have a Date Placed In Service (DPIS) prior to the Asset period.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_FUTURE_DPIS');



debug('begin add_signature: EBS_FIN_PA_NO_ASSETS_ASSIGNED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26117',
      p_sig_id                 => 'EBS_FIN_PA_NO_ASSETS_ASSIGNED',
      p_sig_sql                => 'SELECT ppa.asset_name "Asset Name", ppa.project_asset_id "Project Asset Id" 
FROM   pa_project_assets_all ppa 
WHERE  ppa.project_id = ##$$PROJECT_ID$$##
AND    not exists  
(SELECT paa.project_asset_id 
FROM   pa_project_asset_assignments paa
WHERE  paa.project_id = ppa.project_id 
AND    (paa.project_asset_id = ppa.project_asset_id 
OR     paa.project_asset_id = 0))
order by ppa.asset_name',
      p_title                  => 'Unassigned Assets ',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Assets have not been assigned to the project, any of its tasks, and common costs have not been chosen.',
      p_solution               => 'Please follow the solution in [2958875/KB600434] PAXCPCAL: PRC: Interface Assets to Oracle Assets Finds No Assets to Send to Fixed Assets (FA). ',
      p_success_msg            => 'This project has no unassigned assets.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_NO_ASSETS_ASSIGNED');



debug('begin add_signature: EBS_FIN_PA_UNASSIGNED_ASSET_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29091',
      p_sig_id                 => 'EBS_FIN_PA_UNASSIGNED_ASSET_LINES',
      p_sig_sql                => 'select *
from pa_project_asset_lines_all 
where project_id = ##$$PROJECT_ID$$##
and project_asset_id = 0
',
      p_title                  => 'Unassigned Asset Lines',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This project has unassigned asset lines.',
      p_solution               => 'Please follow the solution in [2313720/KB409014] R12 Assign UNASSIGNED Asset Fails With Error FRM-41830: List of Values contains no entries.',
      p_success_msg            => 'This project has no unassigned asset lines.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_UNASSIGNED_ASSET_LINES');



debug('begin add_signature: EBS_FIN_PA_STD_UNIT_COSTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26663',
      p_sig_id                 => 'EBS_FIN_PA_STD_UNIT_COSTS',
      p_sig_sql                => 'SELECT c.*
FROM PA_STANDARD_UNIT_COSTS c
WHERE c.book_type_code in 
(select a.book_type_code
from PA_PROJECT_ASSETS_ALL a
where a.project_id = ##$$PROJECT_ID$$##)',
      p_title                  => 'Standard Costs per Unit for Project Assets',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No standard costs per unit are defined for this projects assets.
',
      p_solution               => '',
      p_success_msg            => 'Standard costs per unit are defined for this projects assets.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_STD_UNIT_COSTS');



debug('begin add_signature: EBS_FIN_PA_ASSETS_ON_HOLD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29606',
      p_sig_id                 => 'EBS_FIN_PA_ASSETS_ON_HOLD',
      p_sig_sql                => 'SELECT * FROM PA_PROJECT_ASSETS_ALL 
WHERE project_id = ##$$PROJECT_ID$$##
and   CAPITAL_HOLD_FLAG = ''Y''',
      p_title                  => 'Assets on Hold',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are assets on hold.',
      p_solution               => 'Review the solution in [3038449/KB445946] PAXCARVW - Capital Project Summary Screen is Displaying Incorrect CIP Amount.',
      p_success_msg            => 'There are no assets on hold.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_ASSETS_ON_HOLD');



debug('begin add_signature: EBS_FIN_PA_IND_RATE_SCHEDULES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26002',
      p_sig_id                 => 'EBS_FIN_PA_IND_RATE_SCHEDULES',
      p_sig_sql                => 'SELECT sched.* , pa.CINT_ELIGIBLE_FLAG, pa.CINT_STOP_DATE
FROM   PA_IND_RATE_SCHEDULES_ALL_BG sched ,  PA_PROJECTS_ALL pa
WHERE  sched.ind_rate_sch_usage like ''CAPITALIZED_INTEREST''  
AND  sched.IND_RATE_SCH_ID  = pa.CINT_RATE_SCH_ID  
AND  sched.project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Capitalized Interest Rate Schedules Assigned',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No capitalized interest rate schedules are assigned to the project.',
      p_solution               => '',
      p_success_msg            => 'Capitalized interest rate schedules assigned to the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_IND_RATE_SCHEDULES');
...
debug('begin add_signature: EBS_FIN_PA_IND_RATE_SCH_REVISIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26000',
      p_sig_id                 => 'EBS_FIN_PA_IND_RATE_SCH_REVISIONS',
      p_sig_sql                => 'SELECT *  FROM   PA_IND_RATE_SCH_REVISIONS version WHERE  version.ind_rate_sch_id in 
(select sched.ind_rate_sch_id from   PA_IND_RATE_SCHEDULES_ALL_BG  sched ,   PA_PROJECTS_ALL PA 
WHERE  sched.ind_rate_sch_usage like ''CAPITALIZED_INTEREST''  AND   sched.IND_RATE_SCH_ID = pa.CINT_RATE_SCH_ID  AND  sched.PROJECT_ID = ##$$PROJECT_ID$$##)',
      p_title                  => 'Capitalized Interest Rate Schedules Setup - Schedule Revisions (PA_IND_RATE_SCH_REVISIONS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No capitalized interest rate schedule revisions identified for the project.',
      p_solution               => '',
      p_success_msg            => 'Capitalized interest rate schedule revisions identified for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_IND_RATE_SCH_REVISIONS');



debug('begin add_signature: EBS_FIN_PA_IND_COST_MULTIPLIERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26001',
      p_sig_id                 => 'EBS_FIN_PA_IND_COST_MULTIPLIERS',
      p_sig_sql                => 'SELECT *  FROM   PA_IND_COST_MULTIPLIERS costmult  WHERE  costmult.ind_rate_sch_revision_id in (select version.ind_rate_sch_revision_id  from   PA_IND_RATE_SCH_REVISIONS version where  version.ind_rate_sch_id in (select sched.ind_rate_sch_id   from   PA_IND_RATE_SCHEDULES_ALL_BG  sched ,  PA_PROJECTS_ALL PA  WHERE  sched.ind_rate_sch_usage  like ''CAPITALIZED_INTEREST''  AND   sched.IND_RATE_SCH_ID  = pa.CINT_RATE_SCH_ID   AND    sched.PROJECT_ID = ##$$PROJECT_ID$$##) )',
      p_title                  => 'Capitalized Interest Rate Schedules Setup  - Cost Multipliers (PA_IND_COST_MULTIPLIERS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No capitalized interest cost multipliers identified for project.',
      p_solution               => '',
      p_success_msg            => 'capitalized interest cost multipliers identified for project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_IND_COST_MULTIPLIERS');



debug('begin add_signature: PA_CINT_RATE_MULTIPLIERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13721',
      p_sig_id                 => 'PA_CINT_RATE_MULTIPLIERS',
      p_sig_sql                => 'SELECT * FROM PA_CINT_RATE_MULTIPLIERS capmult 
WHERE capmult.ind_rate_sch_id IN (
 SELECT sched.ind_rate_sch_id 
 FROM PA_IND_RATE_SCHEDULES_ALL_BG sched, PA_PROJECTS_ALL PA 
 WHERE sched.ind_rate_sch_usage LIKE ''CAPITALIZED_INTEREST'' 
AND sched.IND_RATE_SCH_ID = pa.CINT_RATE_SCH_ID
 AND PA.project_id = ##$$PROJECT_ID$$##)',
      p_title                  => 'Capitalized Interest Rate Multipliers (PA_CINT_RATE_MULTIPLIERS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No capitalized interest rate multipliers exist for the project.',
      p_solution               => '',
      p_success_msg            => 'Capitalized interest rate multipliers exist for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_CINT_RATE_MULTIPLIERS');
...
debug('begin add_signature: EBS_FIN_PA_PA_PROJECT_ACCUM_ACTUALS_HEADERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25918',
      p_sig_id                 => 'EBS_FIN_PA_PA_PROJECT_ACCUM_ACTUALS_HEADERS',
      p_sig_sql                => 'SELECT a.*,
...
AND    h.project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Summarization (PA_PROJECT_ACCUM_ACTUALS/HEADERS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data exists in project accumulation tables for this project.',
      p_solution               => '',
      p_success_msg            => 'Summarization data found in PA_PROJECT_ACCUM_ACTUALS/HEADERS tables for this project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_PROJECT_ACCUM_ACTUALS_HEADERS');



debug('begin add_signature: EBS_FIN_PA_PA_TXN_ACCUM');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25924',
      p_sig_id                 => 'EBS_FIN_PA_PA_TXN_ACCUM',
      p_sig_sql                => 'SELECT PP.segment1                           "Project Number",
       PTA.task_id,
       t.task_number,
       SUM(pta.tot_raw_cost)                 "Accumd Raw Cost",
       SUM(pta.i_tot_raw_cost)               "Future Raw Cost",
       SUM(pta.tot_billable_raw_cost)        "Accumd Capital Raw Cost",
       SUM(pta.i_tot_billable_raw_cost)      "Future Capital Raw Cost",
       SUM(pta.tot_burdened_cost)            "Accumd Burdened Cost",
       SUM(pta.i_tot_burdened_cost)          "Future Burdened Cost",
       SUM(pta.tot_billable_burdened_cost)   "Accumd Capital Burdened Cost",
       SUM(pta.i_tot_billable_burdened_cost) "Future Capital Burd Cost"
...
WHERE  ORG.organization_id = PP.carrying_out_organization_id
       ...
       AND ( pp.org_id IS NULL
              OR pp.org_id = ppt.org_id )
       AND PP.project_id = ##$$PROJECT_ID$$##
GROUP  BY pp.segment1,
          pta.task_id,
          t.task_number
ORDER  BY t.task_number',
      p_title                  => 'Transaction Accumulation (PA_TXN_ACCUM)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data exists in PA_TXN_ACCUM for the project.',
      p_solution               => '',
      p_success_msg            => 'Lowest level of summarized transaction record used in project summary amounts.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_TXN_ACCUM');



debug('begin add_signature: EBS_FIN_PA_PA_CAPITAL_PROJECTS_V');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25923',
      p_sig_id                 => 'EBS_FIN_PA_PA_CAPITAL_PROJECTS_V',
      p_sig_sql                => 'SELECT /*+ push_pred(v) */  V.project_id,
                           V.project_name,
                           V.project_number,
                           ...
                           P.created_by,
                           P.last_update_login,
                           Substr(pa_security.Allow_update(V.project_id), 1, 1),
Substr(pa_security.View_labor_costs(V.project_id), 1, 1),
Decode(GL.mrc_sob_type_code, ''R'', NULL,
...
Decode(GL.mrc_sob_type_code, ''R'', NULL,
                             Sum(V.total_costs)),
Decode(GL.mrc_sob_type_code, ''R'', NULL,
                             ( Sum(V.total_costs) - Sum(V.capitalizable_cost) ))
                                                       EXPENSED,
Decode(GL.mrc_sob_type_code, ''R'', NULL,
                             (
...
V.total_burden_flag,
P.org_id,
GL.mrc_sob_type_code, 
Nvl(lookup.meaning, ''Null'') "Interface Asset Cost Code"
FROM   pa_capital_projects_base_v V,
       ...
       gl_sets_of_books GL,
       pa_lookups lookup 
WHERE  lookup.lookup_type = ''INTERFACE ASSET COST''
       AND lookup.lookup_code (+) = v.interface_asset_cost_code
       AND pa_security.Allow_query(V.project_id) = ''Y''
       AND V.project_id = P.project_id
       AND IMP.org_id = P.org_id
       AND P.project_id = ##$$PROJECT_ID$$##
       AND P.project_status_code = PPS.project_status_code  
       AND PPS.project_system_status_code <> ''PURGED''  
       AND GL.set_of_books_id = IMP.set_of_books_id
GROUP  BY          V.project_id,
          ...
          lookup.meaning
UNION ALL
SELECT /*+ push_pred(v) */  V.project_id,
                           V.project_name,
                           V.project_number,
                           V.project_status_code,
                           V.project_type,
...
GROUP  BY  v.project_id,
          ...
          gl.mrc_sob_type_code,
          lookup.meaning',
      p_title                  => 'Capital Summary (PA_CAPITAL_PROJECTS_V)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No capital summary data exists for the project.',
      p_solution               => '',
      p_success_msg            => 'Capital summary data exists for the project and provides information from the status inquiry/ accumulation tables.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_CAPITAL_PROJECTS_V');



debug('begin add_signature: EBS_FIN_PA_CURRENT_REPORTING_PERIOD_AND_LATEST_OPEN_PA_PERIOD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26099',
      p_sig_id                 => 'EBS_FIN_PA_CURRENT_REPORTING_PERIOD_AND_LATEST_OPEN_PA_PERIOD',
      p_sig_sql                => 'SELECT DISTINCT
    period_name,
    org_id,
    current_pa_period_flag
FROM     pa_periods_all
WHERE  org_id = (select org_id from pa_projects_all where project_id = ##$$PROJECT_ID$$##)
    AND start_date IN (
        SELECT
            MAX(start_date)
        FROM
        ...
        WHERE
                status = ''O''
        AND org_id = (select org_id from pa_projects_all where project_id = ##$$PROJECT_ID$$##))
    AND current_pa_period_flag != ''Y''',
      p_title                  => 'Reporting and Open Periods for Projects',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The latest open period does not match the current reporting period which indicates only expenditures up to current reporting period for the project will show up in the status inquiry. ',
      p_solution               => 'In order to review newly entered expenditures, the reporting period should be set to the latest open Projects period.<br> Please follow solution in [2959679/KB356651] Project Costs Do Not Include New Expenditures in PSI, Capital CIP and Project Planning and Control Reports.',
      p_success_msg            => 'The latest open period matches the current reporting period.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_CURRENT_REPORTING_PERIOD_AND_LATEST_OPEN_PA_PERIOD');



debug('begin add_signature: VALIDATE_FIN_PA_REPORTING_PERIOD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26222',
      p_sig_id                 => 'VALIDATE_FIN_PA_REPORTING_PERIOD',
      p_sig_sql                => 'SELECT  decode( p.pji_source_flag,''Y'', ''PJI Summarization'', ''PSI Summarization'')  "Summarization model",
    to_char(MAX(ah.last_update_date)) "Summarization was last run on",
    lop.period_name                   "Latest Open Period",
    crp.period_name                   "Current Reporting Period"
FROM
    pa_periods_all           lop,
    pa_periods_all           crp,
    pa_project_accum_headers ah,
    pa_projects_all p
WHERE
    crp.current_pa_period_flag = ''Y''
    AND crp.org_id =  ##$$ORG_ID$$##
    AND crp.org_id = lop.org_id
    AND lop.period_name <> crp.period_name
    AND ah.project_id =  ##$$PROJECT_ID$$##
    and ah.project_id = p.project_id
    AND lop.start_date IN (select max(i.start_date) from pa_periods_ALL i where i.status = ''O'' and i.org_id = ##$$ORG_ID$$##) 
GROUP BY
    p.pji_source_flag,
    lop.period_name,
    crp.period_name',
      p_title                  => 'PSI Summarization Reporting Period',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The latest open period does not match the current reporting period which indicates not all expenditures created for the project will be accumulated into the status inquiry.',
      p_solution               => 'Review the solution in [2963390/KB335256] Capital Projects Form (PAXCARVW) Amounts Are Not Correct.',
      p_success_msg            => 'Current reporting period is the same as the latest open period.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: VALIDATE_FIN_PA_REPORTING_PERIOD');



debug('begin add_signature: EBS_FIN_PA_SUMMARIZATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26224',
      p_sig_id                 => 'EBS_FIN_PA_SUMMARIZATION',
      p_sig_sql                => 'SELECT ''Summarization Model'' "Summarization Model",  decode(p.pji_source_flag, ''Y'', ''PJI Model'', ''PSI'') "Value"
FROM   pa_projects_all p
WHERE p.project_id = ##$$PROJECT_ID$$##  
UNION
SELECT ''PSI Summarization was last run on '', nvl(to_char(MAX(ah.last_update_date)), ''N/A'') "Value"
FROM pa_project_accum_headers ah, pa_projects_all p
WHERE ah.project_id = ##$$PROJECT_ID$$## 
AND ah.project_id = p.project_id
and nvl(p.pji_source_flag, ''N'') = ''N''
UNION
SELECT ''Current Reporting Period '', period_name "Value"
FROM pa_periods_all
WHERE current_pa_period_flag = ''Y''
    AND org_id = ##$$ORG_ID$$##  
UNION
SELECT ''Latest Open PA Period '', period_name "Value"
FROM pa_periods_all
WHERE start_date IN (SELECT
            MAX(start_date)
        FROM pa_periods_all
        WHERE status = ''O''
            AND org_id = ##$$ORG_ID$$##  
    ...
    AND org_id = ##$$ORG_ID$$##  
Union SELECT ''Project performance data was last run on '', to_char(max(last_update_date)) "Value"
FROM
    pji_fp_xbs_accum_f fact
WHERE  
        fact.calendar_type = ''A''
    AND fact.period_type_id = 2048
    AND fact.time_id = - 1
    AND fact.wbs_rollup_flag = ''N''
    AND fact.prg_rollup_flag = ''N''
    AND bitand(fact.curr_record_type_id, 4) = 4
    AND fact.rbs_aggr_level = ''L''
    AND fact.plan_version_id = - 1
    AND fact.rbs_element_id = - 1
    AND fact.rbs_version_id = - 1 
AND fact.project_id = ##$$PROJECT_ID$$## ',
      p_title                  => 'Project Summarization Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No project summarization details exist.',
      p_solution               => 'Oracle Projects summarizes costs based on summarization model, refer [2963390/KB335256] Capital Projects form (PAXCARVW) amounts are not correct.',
      p_success_msg            => 'Project summarization details exist.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_SUMMARIZATION');
...
debug('begin add_signature: PA_COST_DISTRIBUTION_LINES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15777',
      p_sig_id                 => 'PA_COST_DISTRIBUTION_LINES_ALL',
      p_sig_sql                => 'SELECT * FROM PA_COST_DISTRIBUTION_LINES_ALL WHERE PROJECT_ID = ##$$PROJECT_ID$$##',
      p_title                  => 'Cost Distribution Lines (PA_COST_DISTRIBUTION_LINES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No cost distribution lines exist for Project ID ##$$PROJECT_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Cost distribution lines exist for Project ID ##$$PROJECT_ID$$##.<br>
For details related to the transfer_status code review [558574/KB502044] What Are The Values For The TRANSFER_STATUS_CODE In The PA_COST_DISTRIBUTION_LINES_ALL Table? ',
   ...
   l_info.delete;
debug('end add_signature: PA_COST_DISTRIBUTION_LINES_ALL');



debug('begin add_signature: PA_PROJECT_ASSET_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13708',
      p_sig_id                 => 'PA_PROJECT_ASSET_LINES',
      p_sig_sql                => 'SELECT lines.* 
FROM PA_PROJECT_ASSET_LINES_ALL lines 
WHERE lines.project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Project Asset Lines (PA_PROJECT_ASSET_LINES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No project asset lines exist for Project ID ##$$PROJECT_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Project asset lines exist for Project ID ##$$PROJECT_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PROJECT_ASSET_LINES');



debug('begin add_signature: PA_FA_ASSET_INVOICES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15782',
      p_sig_id                 => 'PA_FA_ASSET_INVOICES',
      p_sig_sql                => 'SELECT * FROM FA_ASSET_INVOICES WHERE PROJECT_ID = ##$$PROJECT_ID$$##',
      p_title                  => 'Asset Invoice Information for Project (FA_ASSET_INVOICES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No asset invoice records exist for Project ID ##$$PROJECT_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Asset invoice records exist for Project ID ##$$PROJECT_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_FA_ASSET_INVOICES');



debug('begin add_signature: PA_FA_ADDITIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15781',
      p_sig_id                 => 'PA_FA_ADDITIONS',
      p_sig_sql                => 'SELECT * FROM FA_ADDITIONS WHERE ASSET_ID IN 
 (SELECT ASSET_ID FROM FA_ASSET_INVOICES WHERE PROJECT_ID = ##$$PROJECT_ID$$##)',
      p_title                  => 'Fixed Asset Additions (FA_ADDITIONS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Fixed Asset addition records exist for Project ID ##$$PROJECT_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Fixed Asset addition records exist for Project ID ##$$PROJECT_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_FA_ADDITIONS');



debug('begin add_signature: EBS_FIN_PA_EXTN_ASSET_ALLOC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26474',
      p_sig_id                 => 'EBS_FIN_PA_EXTN_ASSET_ALLOC',
      p_sig_sql                => 'SELECT text
FROM dba_source
WHERE name = UPPER(''pa_client_extn_asset_alloc'')',
      p_title                  => 'Asset Allocation Basis Extension',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No asset allocation basis extension found.',
      p_solution               => '',
      p_success_msg            => 'Asset allocation basis extension found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_EXTN_ASSET_ALLOC');



debug('begin add_signature: EBS_FIN_PA_EXTN_ASSET_CREATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26476',
      p_sig_id                 => 'EBS_FIN_PA_EXTN_ASSET_CREATION',
      p_sig_sql                => 'SELECT text
FROM dba_source
WHERE name = UPPER(''pa_client_extn_asset_creation'')
',
      p_title                  => 'Asset Lines Processing Extension',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No asset lines processing extension found.',
      p_solution               => '',
      p_success_msg            => 'Asset lines processing  extension found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_EXTN_ASSET_CREATION');



debug('begin add_signature: EBS_FIN_PA_EXTN_CAP_INT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26480',
      p_sig_id                 => 'EBS_FIN_PA_EXTN_CAP_INT',
      p_sig_sql                => 'SELECT text
FROM dba_source
WHERE name = UPPER(''pa_client_extn_cap_int'')


',
      p_title                  => 'Capitalized Interest Extension',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No capitalized interest processing extension found.',
      p_solution               => '',
      p_success_msg            => 'Capitalized interest processing extension found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_EXTN_CAP_INT');



debug('begin add_signature: EBS_FIN_PA_EXTN_CIP_ACCT_OVR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26477',
      p_sig_id                 => 'EBS_FIN_PA_EXTN_CIP_ACCT_OVR',
      p_sig_sql                => 'SELECT text
FROM dba_source
WHERE name = UPPER(''pa_client_extn_cip_acct_ovr'')
',
      p_title                  => 'CIP Account Override Extension',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No CIP account override extension found.',
      p_solution               => '',
      p_success_msg            => 'CIP account override extension found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_EXTN_CIP_ACCT_OVR');



debug('begin add_signature: EBS_FIN_PA_EXTN_CIP_GROUPING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26478',
      p_sig_id                 => 'EBS_FIN_PA_EXTN_CIP_GROUPING',
      p_sig_sql                => 'SELECT text
FROM dba_source
WHERE name = UPPER(''pa_client_exten_cip_grouping'')

',
      p_title                  => 'CIP Grouping Extension',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No CIP grouping extension found.',
      p_solution               => '',
      p_success_msg            => 'CIP grouping extension found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_EXTN_CIP_GROUPING');



debug('begin add_signature: EBS_FIN_PA_EXTN_DEPRN_EXP_OVR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26481',
      p_sig_id                 => 'EBS_FIN_PA_EXTN_DEPRN_EXP_OVR',
      p_sig_sql                => 'SELECT text
FROM dba_source
WHERE name = UPPER(''pa_client_extn_deprn_exp_ovr'')



',
      p_title                  => 'Depreciation Account Override Extension',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No depreciation account override extension found.',
      p_solution               => '',
      p_success_msg            => 'Depreciation account override extension found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_EXTN_DEPRN_EXP_OVR');



debug('begin add_signature: EBS_FIN_PA_EXTN_GEN_ASSET_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26475',
      p_sig_id                 => 'EBS_FIN_PA_EXTN_GEN_ASSET_LINES',
      p_sig_sql                => 'SELECT text
FROM dba_source
WHERE name = UPPER(''pa_client_extn_gen_asset_lines'')
',
      p_title                  => 'Asset Assignment Extension',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No asset assignment extension found.',
      p_solution               => '',
      p_success_msg            => 'Asset assignment extension found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_EXTN_GEN_ASSET_LINES');



debug('begin add_signature: EBS_FIN_PA_EXTN_PRE_CAP_EVENT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26479',
      p_sig_id                 => 'EBS_FIN_PA_EXTN_PRE_CAP_EVENT',
      p_sig_sql                => 'SELECT text
FROM dba_source
WHERE name = UPPER(''pa_client_extn_pre_cap_event'')
',
      p_title                  => 'Capital Event Processing Extension',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No capital event processing extension found.',
      p_solution               => '',
      p_success_msg            => 'Capital event processing extension found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_EXTN_PRE_CAP_EVENT');
...
debug('begin add_signature: EBS_FIN_PA_CAPITAL_PKG_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26654',
      p_sig_id                 => 'EBS_FIN_PA_CAPITAL_PKG_VERSIONS',
...
FROM dba_source c
WHERE (name in (''PA_ADJUSTMENTS'',
''PA_ASSET_ALLOCATION_PVT'',
''PA_ASSET_REVERSAL_PVT'',
''PA_ASSET_UTILS'',
''PA_ASSIGN_ASSETS_PKG'',
''PA_CAPITALIZED_INTEREST'',
''PA_CAPITAL_DB_PKG'',
''PA_CAPITAL_EVENTS_PKG'',
''PA_CAPITAL_EVENTS_PVT'',
''PA_CAPITAL_PROJECT_UTILS'',
''PA_CAP_INT_PVT'',
...
''PA_FAXFACE'',
''PA_FAXFACE_RET_PVT'',
''PA_PROJECT_ASSETS_PKG'',
''PA_PROJECT_ASSETS_PUB'',
''PA_PROJ_ASSET_ASSIGN_PKG'',
''PA_PURGE_CAPITAL'',
''PA_PURGE_VALIDATE_CAPITAL'',
''PA_UTILS'', 
''PA_UTILS2'',
''PA_UTILS3'',
''PA_UTILS4''))
...
order by name',
      p_title                  => 'Capital Package Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No capital package version details exist.',
      p_solution               => '',
      p_success_msg            => 'Capital package version details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_CAPITAL_PKG_VERSIONS');
...
debug('begin add_signature: EBS_FIN_PA_CAPITAL_EXPENDITURE_ITEMS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26993',
      p_sig_id                 => 'EBS_FIN_PA_CAPITAL_EXPENDITURE_ITEMS_ALL',
      p_sig_sql                => 'select * from pa_expenditure_items_all
where expenditure_item_id = ##$$EIID$$##',
      p_title                  => 'Expenditure Item Details (PA_EXPENDITURE_ITEMS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no expenditure item details for expenditure item ID ##$$EIID$$##.',
      p_solution               => '',
      p_success_msg            => 'Expenditure item details for expenditure item ID  ##$$EIID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_CAPITAL_EXPENDITURE_ITEMS_ALL');



debug('begin add_signature: EBS_FIN_PA_CAPITAL_CDL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26994',
      p_sig_id                 => 'EBS_FIN_PA_CAPITAL_CDL',
      p_sig_sql                => 'select * from pa_cost_distribution_lines_all
where expenditure_item_id = ##$$EIID$$##
order by line_num asc',
      p_title                  => 'Cost Distribution Line Details for Expenditure Item ID (PA_COST_DISTRIBUTION_LINES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no cost distribution line details for expenditure item ID ##$$EIID$$## .',
      p_solution               => '',
      p_success_msg            => 'Cost distribution line details for expenditure item ID ##$$EIID$$##. <br>
For details related to the transfer_status code review [558574/KB502044] What Are The Values For The TRANSFER_STATUS_CODE In The PA_COST_DISTRIBUTION_LINES_ALL Table? ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_CAPITAL_CDL');



debug('begin add_signature: EBS_FIN_PA_IND_COST_CODES_1213');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26918',
      p_sig_id                 => 'EBS_FIN_PA_IND_COST_CODES_1213',
      p_sig_sql                => 'SELECT int.ind_cost_code                "Rate Name",
    int.description                  "Description",
    int.expenditure_type             "Expenditure Type",
    int.start_date_active            "Effective From",
    int.end_date_active              "Effective To",
    info.exp_org_source              "Exp Organization Source",
    info.threshold_amt_type          "Threshold Amount Type",
    info.budget_type_code            "Threshold Budget Type",
    info.fin_plan_type_id            "Threshold Plan Type",
    info.proj_amt_threshold          "Project Threshold Amount",
    info.proj_duration_threshold     "Project Threshold Days",
    info.task_amt_threshold          "Task Threshold Amount",
    info.task_duration_threshold     "Task Threshold Days",
    info.curr_period_convention      "Current Period Convention",
    info.period_rate_code            "Period Rate Convention",
    info.interest_calculation_method "Interest Method"
FROM pa_cint_rate_info_all info,
    pa_ind_cost_codes     int
WHERE info.ind_cost_code = int.ind_cost_code
    AND ind_cost_code_usage LIKE ''CAPITALIZED_INTEREST''
    AND info.org_id = ##$$ORG_ID$$##
',
      p_title                  => 'Capitalized Interest Rate Codes ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No capitalized interest rate codes are defined.',
      p_solution               => '',
      p_success_msg            => 'Capitalized interest rate codes are defined.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_IND_COST_CODES_1213');



debug('begin add_signature: EBS_FIN_PA_IND_COST_CODES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25961',
      p_sig_id                 => 'EBS_FIN_PA_IND_COST_CODES',
      p_sig_sql                => 'SELECT int.ind_cost_code                "Rate Name",
    int.description                  "Description",
    int.expenditure_type             "Expenditure Type",
    int.exclude_fee_invoice          "Exclude from Invoice Fee",
    int.exclude_fee_revenue          "Exclude from Revenue Fee",
    int.column_mapping               "Column Mapping",
    int.start_date_active            "Effective From",
    int.end_date_active              "Effective To",
    info.exp_org_source              "Exp Organization Source",
    info.threshold_amt_type          "Threshold Amount Type",
...
',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_IND_COST_CODES');
...
BEGIN
  ...
  analyzer_title := 'Projects Capital Analyzer';
...
start_section('Proactive and Preventative Recommendations', 'Proactive');
   set_item_result(check_rec_patches_1); /* Signature EBS_FIN_PA_CAPITAL_RECOMMENDED_PATCHES */
...
start_section('Data Issues', 'DATA_ISSUES');
   set_item_result(run_stored_sig('EBS_FIN_PA_DUPLICATE_ASSET_NAMES'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PA13112694ASSET_LINES_MISMATCH'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PA13112694_REV_LINE_MISMATCH'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PA13112694_XTRA_LINE_MISMATCH'));
   set_item_result(run_stored_sig('EBS_FIN_PA_3112694_FA_MISMATCH'));
   set_item_result(run_stored_sig('EBS_FIN_PA_13112694CDL_DETAIL_MISMATCH'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PA13112694_CDL_RDF_N_MISMATCH'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PA13112694LINES_ASSET_MISMATCH'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_SIGNAL11'));
   set_item_result(run_stored_sig('PA_INCORRECT_CIP_COST_CAPITAL_1'));
   set_item_result(run_stored_sig('PA_INCORRECT_CIP_COST_CAPITAL_2'));
end_section;
debug('end section: DATA_ISSUES');

debug('begin section: SETUP_CHECKS');
start_section('General Setup Checks', 'SETUP_CHECKS');
   set_item_result(run_stored_sig('EBS_FIN_PA_FA_BOOK_CONTROLS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PERIODS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PROFILE_USE_ASSET_TRACKING_COSTING_HOOK'));
   set_item_result(run_stored_sig('EBS_FIN_PA_IMPL_OPTIONS_AND_SUBLEDGER'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PROJECT_TYPE'));
   set_item_result(run_stored_sig('EBS_FIN_PA_INVENTORY_BUDEN_COST'));
end_section;
debug('end section: SETUP_CHECKS');

debug('begin section: PROJECT_DETAILS');
start_section('Project Details', 'PROJECT_DETAILS');
   set_item_result(run_stored_sig('EBS_FIN_PA_PROJECTS_ALL'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PA_TASKS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PROJECT_TYPES'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PROJECT_STATUS_ALLOW_CAPITALIZATION'));
end_section;
debug('end section: PROJECT_DETAILS');

debug('begin section: EXPENDITURE_DETAILS');
start_section('Expenditure Details', 'EXPENDITURE_DETAILS');
   IF p_expenditure_item_id is not null THEN
      set_item_result(run_stored_sig('EBS_FIN_PA_CAPITAL_EXPENDITURE_ITEMS_ALL'));
      set_item_result(run_stored_sig('EBS_FIN_PA_CAPITAL_CDL'));
   END IF;
   set_item_result(run_stored_sig('EBS_FIN_PA_TOT_CAP_FOR_PROJECT'));
   set_item_result(run_stored_sig('PA_EXPENDITURE_ITEMS_NOT_GENERATED_INTO_ASSET_LINES'));
   set_item_result(run_stored_sig('EBS_FIN_PA_RAW_NON_ACCT_DIST_ITEMS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_BURDEN_ITEMS_ACCOUNTED_SQL'));
   set_item_result(run_stored_sig('EBS_FIN_PA_EI_PAST_PA_THROUGH_DATE_SQL'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PA_CP_SUM_NOT_MATCH_PSI'));
   set_item_result(run_stored_sig('EBS_FIN_PA_EI_TOTALS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_EXP_NOT_ACCUM_CAP_PROJ_SUM'));
   set_item_result(run_stored_sig('EBS_FIN_PA_EI_BURDEN_NOT_DIST_SQL'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PA_COST_UNDO_ACCT'));
   set_item_result(run_stored_sig('EBS_FIN_PA_EI_NOT_COSTED_DETAILS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_TOT_EXPENDITURES'));
   set_item_result(run_stored_sig('EBS_FIN_PA_TOT_EXPENSED_COST'));
   set_item_result(run_stored_sig('EBS_FIN_PA_CAP_EXPEND'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PA_CDL_NOT_IN_GL'));
   set_item_result(run_stored_sig('EBS_FIN_PA_EXP_ITEM_FINAL_ACCOUNTED_STATUS'));
end_section;
debug('end section: EXPENDITURE_DETAILS');

debug('begin section: ASSET_DETAILS');
start_section('Asset Details', 'ASSET_DETAILS');
   set_item_result(run_stored_sig('EBS_FIN_PA_ASSETS_FF'));
   set_item_result(run_stored_sig('PA_PROJECT_ASSETS_ALL'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PA_PROJECT_ASSET_LINES'));
   set_item_result(run_stored_sig('EBS_FIN_PA_EBS_FIN_PA_PAEXPND_ASSET_LINE_DETAILS_PROJECT'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAEXPND_ASSET_LINE_DETAILS_EI'));
   set_item_result(run_stored_sig('PA_PROJECT_ASSET_ASSIGNMENTS-DC'));
   set_item_result(run_stored_sig('EBS_FIN_PA_FA_ADDITIONS'));
   set_item_result(run_stored_sig('PA-FA_MASS_ADDITIONS'));
   set_item_result(run_stored_sig('PA-FA_DELETED_MASS_ADDITIONS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_ASSET_LINES_DELETED_MASS_ADDITIONS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_FA_INVOICES'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PA_CAPITAL_EVENTS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_ASSET_NOT_ADJUSTABLE'));
   set_item_result(run_stored_sig('EBS_FIN_PA_ASSET_NOT_POSTABLE'));
   set_item_result(run_stored_sig('EBS_FIN_PA_CAPITALIZED'));
   set_item_result(run_stored_sig('EBS_FIN_PA_ASSET_NOT_TRANSFERRED_TO_FA'));
   set_item_result(run_stored_sig('EBS_FIN_PA_ASSET_LINE_TRANS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_ASSET_LINES_NOT_POSTED'));
   set_item_result(run_stored_sig('EBS_FIN_PA_READY_TO_CAPITALIZE'));
   set_item_result(run_stored_sig('EBS_FIN_PA_NO_DPIS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_FUTURE_DPIS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_NO_ASSETS_ASSIGNED'));
   set_item_result(run_stored_sig('EBS_FIN_PA_UNASSIGNED_ASSET_LINES'));
   set_item_result(run_stored_sig('EBS_FIN_PA_STD_UNIT_COSTS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_ASSETS_ON_HOLD'));
end_section;
debug('end section: ASSET_DETAILS');

debug('begin section: CAP_INTEREST');
start_section('Capital Interest', 'CAP_INTEREST');
   IF (substr(g_rep_info('Apps Version'),1,4) = '12.1') THEN
      set_item_result(run_stored_sig('EBS_FIN_PA_IND_COST_CODES_1213'));
   END IF;
   IF (substr(g_rep_info('Apps Version'),1,4) = '12.2') THEN
      set_item_result(run_stored_sig('EBS_FIN_PA_IND_COST_CODES'));
   END IF;
   set_item_result(run_stored_sig('EBS_FIN_PA_IND_RATE_SCHEDULES'));
   set_item_result(run_stored_sig('PA_CINT_EXP_TYPE_EXCL_ALL'));
   set_item_result(run_stored_sig('EBS_FIN_PA_IND_RATE_SCH_REVISIONS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_IND_COST_MULTIPLIERS'));
   set_item_result(run_stored_sig('PA_CINT_RATE_MULTIPLIERS'));
   set_item_result(run_stored_sig('PA_CINT_RATE_INFO_ALL'));
end_section;
debug('end section: CAP_INTEREST');

debug('begin section: SUMMARIZATION');
start_section('Summarization', 'SUMMARIZATION');
   set_item_result(run_stored_sig('EBS_FIN_PA_PA_PROJECT_ACCUM_ACTUALS_HEADERS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PA_TXN_ACCUM'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PA_CAPITAL_PROJECTS_V'));
   set_item_result(run_stored_sig('EBS_FIN_PA_CURRENT_REPORTING_PERIOD_AND_LATEST_OPEN_PA_PERIOD'));
   set_item_result(run_stored_sig('VALIDATE_FIN_PA_REPORTING_PERIOD'));
   set_item_result(run_stored_sig('EBS_FIN_PA_SUMMARIZATION'));
end_section;
debug('end section: SUMMARIZATION');

debug('begin section: PJC_DEV');
start_section('Oracle Project Costing Development ', 'PJC_DEV');
   set_item_result(run_stored_sig('PA_EXPENDITURE_ITEMS_ALL-DC'));
   set_item_result(run_stored_sig('PA_COST_DISTRIBUTION_LINES_ALL'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAEXPND_ASSET_LINE_DETAILS_EI'));
   set_item_result(run_stored_sig('EBS_FIN_PA_EBS_FIN_PA_PAEXPND_ASSET_LINE_DETAILS_PROJECT'));
   set_item_result(run_stored_sig('PA_PROJECT_ASSET_LINES'));
   set_item_result(run_stored_sig('PA_PROJECT_ASSETS_ALL'));
   set_item_result(run_stored_sig('PA_PROJECT_ASSET_ASSIGNMENTS-DC'));
   set_item_result(run_stored_sig('PA-FA_MASS_ADDITIONS'));
   set_item_result(run_stored_sig('PA-FA_DELETED_MASS_ADDITIONS'));
   set_item_result(run_stored_sig('PA_FA_ASSET_INVOICES'));
   set_item_result(run_stored_sig('PA_FA_ADDITIONS'));
end_section;
debug('end section: PJC_DEV');

debug('begin section: CLIENT_EXTENSIONS');
start_section('Client Extensions', 'CLIENT_EXTENSIONS');
   set_item_result(run_stored_sig('EBS_FIN_PA_EXTN_ASSET_ALLOC'));
   set_item_result(run_stored_sig('EBS_FIN_PA_EXTN_ASSET_CREATION'));
   set_item_result(run_stored_sig('EBS_FIN_PA_EXTN_CAP_INT'));
   set_item_result(run_stored_sig('EBS_FIN_PA_EXTN_CIP_ACCT_OVR'));
   set_item_result(run_stored_sig('EBS_FIN_PA_EXTN_CIP_GROUPING'));
   set_item_result(run_stored_sig('EBS_FIN_PA_EXTN_DEPRN_EXP_OVR'));
   set_item_result(run_stored_sig('EBS_FIN_PA_EXTN_GEN_ASSET_LINES'));
   set_item_result(run_stored_sig('EBS_FIN_PA_EXTN_PRE_CAP_EVENT'));
end_section;
debug('end section: CLIENT_EXTENSIONS');

debug('begin section: AppsCheck');
start_section('Apps Check', 'AppsCheck');
   set_item_result(run_stored_sig('PA_PATCH_LEVEL'));
   set_item_result(run_stored_sig('EBS_FIN_PA_CAPITAL_PKG_VERSIONS'));
