...
REM |                                                                           |
REM | FILENAME                                                                  |
REM |    ebs_ginv_analyzer.sql                                                  |
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for EBS G-Invoicing Analyzer               |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
BEGIN
 ...
 if apps_version NOT IN ('12.2') then
    ...
    dbms_output.put_line('***   12.2 ');
    dbms_output.put_line('*** Note: the error below is intentional                    ');
    raise_application_error(-20001, 'ERROR: The script requires eBusiness versions 12.2');
 end if;
...
CREATE OR REPLACE PACKAGE ebs_ginv_analyzer_pkg AUTHID DEFINER AS
...
(            p_org_id                       IN NUMBER      DEFAULT NULL
           ,p_igt_gtnc_number              IN VARCHAR2    DEFAULT NULL
           ,p_igt_document_number          IN VARCHAR2    DEFAULT NULL
           ,p_clm_document_number          IN VARCHAR2    DEFAULT NULL
...
----------------------------------------------------------------
FUNCTION compare_versions(p_version1 IN VARCHAR2, p_version2 IN VARCHAR2) RETURN NUMBER;
FUNCTION max_file_version(p_filename IN VARCHAR2) RETURN VARCHAR2;


END ebs_ginv_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY ebs_ginv_analyzer_pkg AS
-- $Id: ebs_ginv_analyzer.sql, 200.24 2025/12/08 16:01:59 loinonen Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2896823.1));
...
----------------------------------------------------------------
g_trx_num VARCHAR2(24) := '';
g_complex_po  VARCHAR2(1)  := 'N';
g_ledger_id		NUMBER;
g_header_id		NUMBER;
g_release_id		NUMBER;
g_amtrev_col_ext	BOOLEAN := false;
g_db_version       V$INSTANCE.VERSION%TYPE;
g_DBbanner         VARCHAR2(255);
g_igtperfh_reqtxnid  VARCHAR2(20);
g_igt_gtc_number VARCHAR2(20);
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'EBSGINV_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'EBSGINV_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>EBSGINV Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2896823.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/G_Invoicing_analyzer_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,7194,EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,7194,EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},7194,EBS,EBS Financials,EBS - Projects" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/mosc/discussion/4531857" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">7194</span>
...
<div class="ck-content"><p>Introducing the NEW EBS G-Invoicing Analyzer!</p><p>The EBS G-Invoicing Analyzer reviews Oracle Purchasing (Requesting) and Oracle Project Billing (Servicing) related data, analyzes current configurations and settings for the environment and provides feedback and recommendations on best practices.</p><p>Version 200.24<br>
<br>
&nbsp;</p><ul><li><p>Updated Signature AC_TABLE_INDEXES</p><p><br>
&nbsp;</p></li>
</ul>
<p>&nbsp;</p></div>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,7194,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,7194,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},7194,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Projects" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
----------------------------------------------------------------
-----------------------------------------------------------
-- Function to compare two versions of a file
-- Input params:
--    - version1, version2
-- returns:
--    -  1 if version1 is higher than version2
--    -  0 if versions are equal
--    - -1 if version1 is lowen than version2
-----------------------------------------------------------
FUNCTION compare_versions(p_version1 VARCHAR2, p_version2 VARCHAR2)
   RETURN NUMBER IS
   l_step VARCHAR2(10);
   l_version1 VARCHAR2 (100);
   l_version2 VARCHAR2 (100);
   l_ver1_seg  NUMBER;
   l_ver2_seg  NUMBER;
   l_next_pos1 NUMBER;
   l_next_pos2 NUMBER;
...
BEGIN
   l_version1 := p_version1;
   l_version2 := p_version2;
   l_step := '10';
   l_index_count := 1;
   loop
      l_step := '20' || to_char(l_index_count);
      l_next_pos1 := to_number(nvl(instr(l_version1, '.'), 0));
      if (l_next_pos1 != 0) then
         l_ver1_seg := to_number(substr (l_version1, 1, l_next_pos1));
         l_version1 := substr (l_version1, l_next_pos1+1);
      else
         l_ver1_seg := l_version1;
      end if;
      l_next_pos2 := to_number(nvl(instr(l_version2, '.'), 0));
      if (l_next_pos2 != 0) then
         l_ver2_seg := to_number(substr (l_version2, 1, l_next_pos2));
         l_version2 := substr(l_version2, l_next_pos2+1);
      else
          l_ver2_seg := l_version2;
      end if;
      l_step := '40';
      if ((l_ver1_seg > l_ver2_seg) or
          ((l_ver1_seg = l_ver2_seg) and (l_next_pos2 = 0) and (l_next_pos1 > 0))) then
          return 1;
      elsif ((l_ver1_seg < l_ver2_seg) or
           ((l_ver1_seg = l_ver2_seg) and (l_next_pos1 = 0) and (l_next_pos2 > 0))) then
          return -1;
      end if;
     exit when ((l_ver1_seg is null) or (l_ver2_seg is null) or (l_next_pos1 = 0) or (l_next_pos2 = 0));
     l_index_count := l_index_count + 1;
   end loop;
   l_step := '50';
   RETURN 0;
EXCEPTION WHEN OTHERS THEN
  print_log('Error in compare_versions:'||l_step||': '||sqlerrm);
  return -1;
END compare_versions;

-----------------------------------------------------------
-- Function to check the maximum version of a file
-- Input params:
--    - filename
-- returns the maximum version found in ad_file_versions
-----------------------------------------------------------
FUNCTION max_file_version(p_filename VARCHAR2)
    RETURN VARCHAR2 IS
    l_step VARCHAR2(2);
    l_temp_version VARCHAR2(200);
    l_max_version VARCHAR2(200);
    CURSOR c_file_version1 IS
      SELECT av.version
        FROM ad_files af,
             ad_file_versions av
       WHERE af.file_id= av.file_id
         AND lower(af.filename) = p_filename
         AND af.subdir like '%US%';
    CURSOR c_file_version2 IS
      SELECT av.version
        FROM ad_files af,
             ad_file_versions av
       WHERE af.file_id= av.file_id
         AND lower(af.filename) = p_filename
         AND af.subdir like 'patch/115/odf';
BEGIN
     l_step := '10';
     l_max_version := '1';
     IF (regexp_like(p_filename, '.odf')) THEN
         OPEN c_file_version2;
         l_step := '20';
         LOOP
             FETCH c_file_version2 into l_temp_version;
             EXIT WHEN c_file_version2%NOTFOUND;
             IF (compare_versions(l_temp_version, l_max_version) = 1) THEN
                 l_max_version := l_temp_version;
             END IF;
         END LOOP;
         l_step := '30';
         CLOSE c_file_version2;
     ELSE
         OPEN c_file_version1;
         l_step := '20';
         LOOP
             FETCH c_file_version1 into l_temp_version;
             EXIT WHEN c_file_version1%NOTFOUND;
             IF (compare_versions(l_temp_version, l_max_version) = 1) THEN
                 l_max_version := l_temp_version;
             END IF;
         END LOOP;
         l_step := '30';
         CLOSE c_file_version1;
     END IF;
     RETURN l_max_version;
EXCEPTION WHEN OTHERS THEN
   RETURN NULL;
END max_file_version;
...
FUNCTION check_rec_patches_1 RETURN VARCHAR2 IS
  /* Signature EBS_MFG_PO_GINV_CUMULATIVE_UPDATES */
...
BEGIN
    ...
    print_log('Processing recommended patches signature: EBS_MFG_PO_GINV_CUMULATIVE_UPDATES (check_rec_patches_1) "Highly Recommended Patches - Requesting Agency " (version 36)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(1)(l_rows) := '33819305';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Feb-22 G-Invoicing consolidation for Requesting side - includes all the features delivered across different phases';
   l_col_rows(5)(l_rows) := '[2860322.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '34031626';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Apr-22 G-Invoicing consolidation for Requesting side - includes all the features delivered across different phases, bug fixes, minor improvements (April 2022)';
   l_col_rows(5)(l_rows) := '[2860322.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '34081751';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Aug-22 VIEW CHANGES FOR G INVOICING SOURCE ADDITION';
   l_col_rows(5)(l_rows) := '[2860322.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '34033059';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Aug-22 GINV: APPLY PREPAYMENTS AT SCHEDULE LEVEL TO STANDARD INVOICES';
   l_col_rows(5)(l_rows) := '[2860322.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '34463488';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Aug-22 G-invoicing related bug fixes - Post April 2022 core requisition form consolidation';
   l_col_rows(5)(l_rows) := '[2860322.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33839767';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Aug-22 Forms based requisition changes for G-Invoicing. Applicable for customers who create purchase requisitions in core forms.';
   l_col_rows(5)(l_rows) := '[2860322.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '34364284';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Aug-22 G-Invoicing consolidation for Requesting side - includes all the features delivered across different phases, bug fixes, minor improvements (Aug 2022)';
   l_col_rows(5)(l_rows) := '[2860322.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33648179';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Dec-22 Invoicing Consolidation Changes for Requesting side - Includes Phase 3 Batch 2 changes';
   l_col_rows(5)(l_rows) := '[2860322.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33677950';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Dec-22 G-INVOICING CONSOLIDATION CHANGES FOR REQUESTING SIDE - INCLUDES DEFERRED PAYMENTS, SELLER FACILITATED ORDERS AND ORDER CLOSE FUNCTIONALITY';
   l_col_rows(5)(l_rows) := '[2860322.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35004302';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Apr-23  G-Invoicing consolidation for Requesting side - includes all the features delivered across different phases, bug fixes, and improvements (April 2023).';
   l_col_rows(5)(l_rows) := '[2860322.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35894169';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oct-23 G-Invoicing consolidation for Requesting side features, bug fixes and improvements (Oct 2023)';
   l_col_rows(5)(l_rows) := '[2860645.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37541954';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'G-Invoicing consolidation for Requesting side features, bug fixes and improvements (Feb 2025)';
   l_col_rows(5)(l_rows) := '[2860322.1]';
...
END IF;
   ...
   l_sig.sigrepo_id := '23305';
   l_sig.title := 'Highly Recommended Patches - Requesting Agency ';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := '<p>There are highly recommended patches delivered by Requesting Agency (in Oracle Contract Lifecycle Management for Public Sector, Purchasing) for Oracle E-Business Suite G-invoicing that are not applied on this '||mask_text(g_instance, nvl( upper(''), 'NO_MASK') )||' instance.</p>';
   l_sig.solution := '<ul>
<li>Please review list above and schedule to apply any unapplied G-Invoicing recommended patches as soon as possible.</li>
<li>Refer to the note indicated for more information about each patch.</li>
<li>See [2860322.1] - Oracle E-Business Suite Solution for G-Invoicing Cumulative Updates (Bug Fixes).</li>
</ul>';
   l_sig.success_msg := '<p><strong>All known recommended patches delivered by Requesting Agency (in Oracle Contract Lifecycle Management for Public Sector, Purchasing) for Oracle E-Business Suite G-invoicing '||mask_text(g_apps_version, nvl( upper(''), 'NO_MASK') )||' have been applied.</strong><br /><br /> </br> ';
  ...
  -- Register
  l_step := '60';
  g_signatures('EBS_MFG_PO_GINV_CUMULATIVE_UPDATES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'EBS_MFG_PO_GINV_CUMULATIVE_UPDATES',     -- sig ID
...
FUNCTION check_rec_patches_2 RETURN VARCHAR2 IS
  /* Signature EBS_FIN_PA_GINV_SERVICING_CU_PATCHES */
  l_col_rows   COL_LIST_TBL := col_list_tbl(); -- Row values
  l_rel_rows   COL_LIST_TBL := col_list_tbl(); -- Row release
  l_hdr        VARCHAR_TBL  := varchar_tbl(); -- Column headings
  l_app_date   DATE;         -- Patch applied date
...
BEGIN
    ...
    print_log('Processing recommended patches signature: EBS_FIN_PA_GINV_SERVICING_CU_PATCHES (check_rec_patches_2) "Highly Recommended Patches - Servicing Agency" (version 3)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '38083958';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'July 2025:  G-Invoicing Jul-25 Incremental patch to manage performance integration between G-Invoicing and Oracle Projects';
   l_col_rows(5)(l_rows) := '[2860645.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '38084046';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'July 2025: G-Invoicing ECC Jul-25 Incremental patch to manage G-Invoicing GT&CS, Orders and Performance inc ECC dashboard';
   l_col_rows(5)(l_rows) := '[2860645.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37690543';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'April 2025: G-Invoicing Apr-25 Incremental patch to manage performance integration between G-Invoicing and Oracle Projects.';
   l_col_rows(5)(l_rows) := '[2860645.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37690615';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'April 2025: G-Invoicing ECC Apr-25 Incremental patch to manage G-Invoicing GT&CS, Orders and Performance inc ECC dashboard';
   l_col_rows(5)(l_rows) := '[2860645.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37363961';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'January 2025: G-Invoicing ECC Jan-25 Incremental patch to manage G-Invoicing GT&CS, Orders and Performance inc ECC dashboard';
   l_col_rows(5)(l_rows) := '[2860645.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37349661';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'January 2025: G-Invoicing Jan-25 Incremental patch to manage performance integration between G-Invoicing and Oracle Projects.';
   l_col_rows(5)(l_rows) := '[2860645.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37528114';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'January 2025: G-Invoicing Jan-25 Incremental patch to manage performance integration between G-Invoicing and Oracle Projects.';
   l_col_rows(5)(l_rows) := '[2860645.1]';
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37056985';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'October 2024: G-Invoicing Oct-24 Incremental patch to manage performance integration between G-Invoicing and Oracle Projects';
   l_col_rows(5)(l_rows) := '[2860645.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37057123';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'October 2024: G-Invoicing ECC OCT-24 Incremental patch to manage G-Invoicing GT&CS, Orders and Performance inc ECC dashboard';
   l_col_rows(5)(l_rows) := '[2860645.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36541955';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'July 2024: G-Invoicing Jul-24 Incremental patch to manage performance integration between G-Invoicing and Oracle Projects.';
   l_col_rows(5)(l_rows) := '[2860645.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36713112';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'July 2024: G-Invoicing ECC Jul-24 Incremental patch to manage G-Invoicing GT&Cs, Orders and Performance in ECC dashboard.';
   l_col_rows(5)(l_rows) := '[2860645.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36866950';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'July 2024: G-Invoicing Jul-24 Incremental patch to manage performance integration between G-Invoicing and Oracle Projects.';
   l_col_rows(5)(l_rows) := '[2860645.1]';
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36861505';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'July 2024: G-Invoicing ECC Jul-24 Incremental patch(additional fixes) to manage G-Invoicing GT&Cs, Orders and Performance in ECC dashboard';
   l_col_rows(5)(l_rows) := '[2860645.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36393166';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'April 2024: G-Invoicing Apr-24 Incremental patch to manage performance integration between G-Invoicing and Oracle Projects.';
   l_col_rows(5)(l_rows) := '[2860645.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36399104';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'April 2024: G-Invoicing ECC Apr-24 Incremental patch to manage G-Invoicing GT&Cs, Orders and Performance in ECC dashboard.';
   l_col_rows(5)(l_rows) := '[2860645.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36547667';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'April 2024: G-Invoicing servicing additional fixes on Apr-24 CU patch';
   l_col_rows(5)(l_rows) := '[2860645.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36360761';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'December-2023: G-Invoicing Dec-23 Incremental patch to manage performance integration between G-Invoicing and Oracle Projects';
   l_col_rows(5)(l_rows) := '[2860645.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36171425';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'December-2023: G-Invoicing ECC Dec-23 Incremental patch to manage G-Invoicing GT&Cs, Orders and Performance in ECC dashboard';
   l_col_rows(5)(l_rows) := '[2860645.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35988102';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'CONSOLIDATED SFO FIXES ON TOP OF APR-23 CU';
   l_col_rows(5)(l_rows) := '[2860322.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36350937';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'July 2023: G-Invoicing Jul-23 Incremental patch to manage performance integration between G-Invoicing and Oracle Project';
   l_col_rows(5)(l_rows) := '[2860645.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35712012';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'July 2023: G-Invoicing ECC Jul-23 Incremental patch to manage G-Invoicing GT&Cs, Orders and Performance in ECC dashboard';
   l_col_rows(5)(l_rows) := '[2860645.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35060813';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'July 2023: 1OFF:JULYCU: FOR 34685290 - GINV: FUNCTION SECURITY JULY CU';
   l_col_rows(5)(l_rows) := '[2909351.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35084436';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'July 2023: 1OFF :JULY CU FOR BUG 34948691 - G-INVOICING: ORDER PULLED TO SERVICING AGENCY IS NOT DISPLAYED IN DASHBOARD';
   l_col_rows(5)(l_rows) := '[2928778.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35553875';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'June-2023: G-Invoicing Jun-23 Incremental patch to manage performance integration between G-Invoicing and Oracle Projects';
   l_col_rows(5)(l_rows) := '[2860645.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35553881';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'June-2023: G-Invoicing ECC Jun-23 Incremental patch to manage G-Invoicing GT&Cs, Orders and Performance in ECC dashboard';
   l_col_rows(5)(l_rows) := '[2860645.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35335573';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'April-2023: G-Invoicing Apr-23 Incremental patch to manage performance integration between G-Invoicing and Oracle Projects';
   l_col_rows(5)(l_rows) := '[2860645.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35335581';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'April-2023: G-Invoicing ECC Apr-23 Incremental patch to manage G-Invoicing GT&Cs, Orders and Performance in ECC dashboard';
   l_col_rows(5)(l_rows) := '[2860645.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35203177';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'March-2023: G-Invoicing Mar-23 incremental patch to manage performance integration between G-Invoicing and oracle projects';
   l_col_rows(5)(l_rows) := '[2860645.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35221565';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'March-2023: G-Invoicing ECC - Incremental patch to manage G-Invoicing GT&Cs, Orders and Performance in ECC dashboard';
   l_col_rows(5)(l_rows) := '[2860645.1]';
...
END IF;
   ...
   l_sig.sigrepo_id := '30961';
   l_sig.title := 'Highly Recommended Patches - Servicing Agency';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := '<p>There are highly recommended patches delivered for Servicing Agency (in Oracle Projects) 
for Oracle E-Business Suite G-invoicing that are not applied on this '||mask_text(g_instance, nvl( upper(''), 'NO_MASK') )||' instance.</p>';
   l_sig.solution := '<ul>
<li>Please review list above and schedule to apply any unapplied G-Invoicing recommended patches as soon as possible.</li>
<li>Refer to the note indicated for more information about each patch.</li>
<li>See [2860322.1] - Oracle E-Business Suite Solution for G-Invoicing Cumulative Updates (Bug Fixes).</li>
</ul>';
   l_sig.success_msg := '<p><strong>All known recommended patches delivered for Servicing Agency (in Oracle Projects) 
for Oracle E-Business Suite G-invoicing '||mask_text(g_apps_version, nvl( upper(''), 'NO_MASK') )||' have been applied.</strong><br /><br /> </br> ';
   l_sig.print_condition := 'ALWAYS';
   l_sig.fail_type := 'I';
   l_sig.print_sql_output := 'RS';
   l_sig.limit_rows := 'Y';
  ...
  -- Register
  l_step := '60';
  g_signatures('EBS_FIN_PA_GINV_SERVICING_CU_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'EBS_FIN_PA_GINV_SERVICING_CU_PATCHES',     -- sig ID
    l_sig,                              -- signature information
    l_col_rows,                         -- data
    l_hdr);                             -- headers
...
----------------------------------------------------------------
  ...
  l_line_id        NUMBER;
  l_dest_expense     VARCHAR2(1)  := 'N';
  l_dest_inventory   VARCHAR2(1)  := 'N';
  l_dest_inventory_rel    VARCHAR2(1)  := 'N'; 
  l_int_req    VARCHAR2(1)  := 'N';
  l_responsibility_name       VARCHAR2(100); 
  l_user_name                 VARCHAR2(100); 
  l_drop_ship    VARCHAR2(1)  := 'N';
  l_ledger_id     NUMBER := NULL;
  l_header_id     NUMBER := NULL;
  l_po_release_id NUMBER := NULL;
  l_enc_year      NUMBER := NULL;
  l_org_id        NUMBER := NULL;
  l_dest_shopfloor	VARCHAR2(1) := 'N';
  l_doc_type       VARCHAR2(25);
  l_DBbanner        VARCHAR2(255);
  l_contract_id    NUMBER;
  l_compare_versions        NUMBER;
...
debug('begin populate parameters hash table');
   ...
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'IGT GT&C Number (Requesting)';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_igt_gtnc_number,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'IGT Document Number (Requesting)';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_igt_document_number,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'EBS Document Number ( Requesting)';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_clm_document_number,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'IGT Order Number (Servicing)';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_order_number,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2025/12/08 16:01:58 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'ebs_ginv_analyzer.sql';
...
WHERE U.ORGANIZATION_ID = p_org_id
 AND mo_global.is_mo_init_done = 'N' or mo_global.check_access(U.ORGANIZATION_ID) = 'Y'
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
...
debug('begin parameter validation: p_igt_gtnc_number');
IF p_igt_gtnc_number IS NOT NULL THEN
BEGIN
SELECT IGT_GTNC_NUMBER
INTO l_exists_val
FROM (SELECT DISTINCT IGT_GTNC_NUMBER FROM PO_HEADERS_ALL WHERE ORG_ID = P_ORG_ID AND TYPE_LOOKUP_CODE = 'STANDARD')
WHERE IGT_GTNC_NUMBER = p_igt_gtnc_number and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: IGT GTNC Number not found or does not exist.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_igt_gtnc_number failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_igt_gtnc_number');

debug('begin parameter validation: p_igt_document_number');
IF p_igt_document_number IS NOT NULL THEN
BEGIN
SELECT IGT_DOCUMENT_NUMBER
INTO l_exists_val
FROM (SELECT DISTINCT IGT_DOCUMENT_NUMBER FROM PO_HEADERS_ALL WHERE ORG_ID = P_ORG_ID)
WHERE IGT_DOCUMENT_NUMBER = p_igt_document_number and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: No IGT Document Numbers found.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_igt_document_number failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_igt_document_number');

debug('begin parameter validation: p_clm_document_number');
IF p_clm_document_number IS NOT NULL THEN
BEGIN
SELECT CLM_DOCUMENT_NUMBER
INTO l_exists_val
FROM PO_HEADERS_ALL,PO_DOC_STYLE_HEADERS
WHERE CLM_DOCUMENT_NUMBER = p_clm_document_number
 AND PO_HEADERS_ALL.ORG_ID = p_org_id 
and PO_DOC_STYLE_HEADERS.STYLE_ID = PO_HEADERS_ALL.STYLE_ID
and PO_DOC_STYLE_HEADERS.IGT_FLAG = 'Y'
AND  (
   (PO_HEADERS_ALL.type_lookup_code = 'CONTRACT' and PO_HEADERS_ALL.IGT_GTNC_NUMBER is null)
or (PO_HEADERS_ALL.type_lookup_code = 'STANDARD' and PO_HEADERS_ALL.IGT_GTNC_NUMBER is not null)
          )
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: No EBS Document Number found.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_clm_document_number failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_clm_document_number');

debug('begin parameter validation: p_order_number');
IF p_order_number IS NOT NULL THEN
BEGIN
SELECT ORDER_NUMBER
INTO l_exists_val
FROM PA_IGT_ORDER
WHERE ORDER_NUMBER = p_order_number and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid IGT order number - this order does not exist.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_order_number failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_order_number');
...
-- In case validation at the beginning is updated/removed, adding validation here also so execution fails
  ...
  IF substr(l_apps_version,1,4) NOT IN ('12.2') THEN
    print_log('eBusiness Suite version = '||l_apps_version);
    print_log('ERROR: This Analyzer script is compatible for following version(s): 12.2');
    raise invalid_parameters;
  END IF;
...
g_c_shared := 'Shared';
g_c_no := 'No';
l_doc_id := -99;  --set to impossible value to retrieve no data by default and avoid errors when executing sql signatures using this value/token DOCID
l_contract_id := -99; --set to impossible value to retrieve no data by default and avoid errors when executing sql signatures using this value/token CONTRACTID

--l_step := '50';
--   begin
--    SELECT distinct TO_NUMBER(idr.internal_document_number) internal_document_number into l_doc_id
-- from igt_document_requests idr, po_headers_all poh
--where idr.IGT_DOCUMENT_ID = NVL((REGEXP_SUBSTR(p_igt_gtnc_number, '((\w|\d|\-){1,30})',1,1)), (REGEXP_SUBSTR(p_igt_document_number, '((\w|\d|\-)--{1,30})',1,1)))
-- and poh.po_header_id = idr.internal_document_number;
--debug('DOCID: ' || l_doc_id);
--    exception when others then
--      print_log('Could not determine po header doc id for sqltoken DOCID! ' || SQLERRM);
--   end; 
--l_step := '51';
--   begin
--  SELECT DISTINCT(poh.po_header_id) internal_document_number
--  INTO l_doc_id
--  FROM
--     po_headers_all         poh
--  WHERE
--        poh.clm_document_number = p_igt_document_number
...
------------------
------------------
--For ADDITIONAL VALIDATION in Analyzer Builder
--To get the l_doc_id value for use in SQL Token DOCID, and get the l_contract_id value for use in SQL Token CONTRACTID
--use  Order (Requesting)  to match to PO_HEADER_ID.CLM_DOCUMENT_NUMBER
--else use  ITG_DOCUMENT_NUMBER to match to PO_HEADER_ID.IGT_DOCUMENT_NUMBER
--else use  IGT_GTNC_NUMBER to match to PO_HEADERS_ALL.TYPE_LOOKUP_CODE = 'CONTRACT' and PO_HEADERS_ALL.IGT_DOCUMENT_NUMBER = ITG_GTNC_NUMBER (the contract)
l_step := '55';

  BEGIN
    IF (p_clm_document_number is not null) THEN
        l_step := '55.1';
        select poh.po_header_id, NVL(poh.clm_source_document_id,-99)
          into l_doc_id, l_contract_id
          from po_headers_all poh
       where clm_document_number = p_clm_document_number
           and poh.org_id = p_org_id ;
    ELSIF (p_igt_document_number is not null) THEN
        l_step := '55.2';
        select poh.po_header_id, NVL(poh.clm_source_document_id,-99)
          into l_doc_id, l_contract_id
          from po_headers_all poh
        where igt_document_number = p_igt_document_number
           and poh.org_id = p_org_id ;
    ELSIF (p_igt_gtnc_number is not null) THEN
        l_step := '55.3';
        select poh.po_header_id docid, poh.po_header_id contractid
            into l_doc_id, l_contract_id
          from po_headers_all poh
        where igt_document_number = p_igt_gtnc_number
           and poh.org_id = p_org_id 
  ...
  EXCEPTION
    WHEN NO_DATA_FOUND THEN
       l_line_id := NULL;
       print_log('Entered Order (Requesting), IGT Document Number (Requesting), and IGT GT&C Number (Requesting) are not found to be valid numbers for this org ' || p_org_id || ' in this instance.  ');
       print_log('NOTE: Order (Requesting) takes precedence, followed by IGT Document Number (Requesting), and then ITG GT&C Number (Requesting) having lowest preference.  ');
      raise invalid_parameters;
    WHEN OTHERS THEN
       l_line_id := NULL;
         print_log('Exception when trying to retrieve po_header_id for document based on the values for Order (Requesting), IGT Document Number (Requesting), and IGT GT&C Number (Requesting) entered by the user: ' ||SQLERRM);
         raise invalid_parameters;
   END;    

print_log('l_doc_id / DOCID: '||l_doc_id||' ');
print_log('l_contract_id / CONTRACTID: '||l_contract_id||' ');
------------------
------------------
...
--  BEGIN
--    IF (p_doc_type = 'PO' AND p_po_line_number is not null) THEN
--        l_step := '62';
--        select pol.po_line_id into l_line_id
--          from apps.po_lines_all pol
--         where po_header_id = l_doc_id
--           and pol.line_num = p_po_line_number ;
--    ELSIF (p_doc_type = 'REQ' AND p_req_line_number is not null) THEN
--        l_step := '64';
--        select prl.requisition_line_id into l_line_id
--          from apps.po_requisition_lines_all prl
--         where requisition_header_id = l_doc_id
 --          and prl.line_num = p_req_line_number ;
--    ELSIF (p_doc_type = 'BPA' AND p_bpa_line_number is not null) THEN
--        l_step := '64';
--        select pol.po_line_id into l_line_id
--          from apps.po_lines_all pol
--         where po_header_id = l_doc_id
--           and pol.line_num = p_bpa_line_number ;
--    ELSIF (p_doc_type = 'REL' AND p_rel_line_number is not null) THEN
--        l_step := '66';
--        select poll.line_location_id into l_line_id 
--          from po_releases_all por, po_line_locations_all poll, po_lines_all pol
--         where por.po_header_id = l_doc_id
--           and por.po_release_id = l_release_id
--           and substr(poll.shipment_num,0,5) = p_rel_line_number 
...
--    WHEN NO_DATA_FOUND THEN
--       l_line_id := NULL;
--       print_log('Entered document line number not found for document type ' || p_doc_type || ' and document id ' || --l_doc_id ||'.');
 --      raise invalid_parameters;
--    WHEN OTHERS THEN
--       l_line_id := NULL;
----       print_log('Exception when trying to retrieve line id for document: ' ||SQLERRM);
--       raise invalid_parameters;
--   END;    

  
l_step := '100';
  -- populate set of books local variable (to be used in the SOBID token)
  begin
     select oo.set_of_books_id 
      into l_sob_id
      from  financials_system_params_all fsp, 
          org_organization_definitions oo          
      where fsp.inventory_organization_id = oo.organization_id
        and oo.organization_id = p_org_id;

      debug('Set of books id: ' || l_sob_id);
   exception when others then
      print_log('Could not determine set of books id! ' || SQLERRM);
   end; 
...
l_step := '115';
   ...
   begin
      select decode(count(*),0,'N','Y')
        into l_dest_inventory from dual
       where exists
          (select 1
   ...
   exception when others then
      print_log('Could not determine dest inventory! ' || SQLERRM);
   end;

   
--l_step := '120';
-- populate INTREQ token
--   begin
--      select decode(count(*),0,'N','Y')
 --       into l_int_req from dual
--       where exists
--          (select 1
...
--   exception when others then
--      print_log('Could not determine int_req! ' || SQLERRM);
--   end;



l_step := '140';
  -- populate legal entity id variable 
  begin
     select ho.default_legal_context_id 
      into l_legal_entity_id
      from  hr_operating_units ho
      where p_org_id = ho.organization_id;

      debug('Legal Entity Id: ' || l_legal_entity_id);
   exception when others then
      print_log('Could not determine legal entity id! ' || SQLERRM);
   end; 
...
--REQ_TXN_ID added to PO_IGT_PERF_HEADER popo.odf   120.68.12020000.98  and higher
-- If popo.odf >= 120.68.12020000.98 then REQ_TXN_ID column is available in the table PO_IGT_PERF_HEADER.  
-- IF popo.odf < 120.68.12020000.98 then REQ_TXN_ID column is NOT available
   
   IF compare_versions(max_file_version('popo.odf'), '120.68.12020000.97') > 0 THEN
      g_igtperfh_reqtxnid := 'Column available';
   ELSE
     g_igtperfh_reqtxnid := 'Column not available';
 END IF;

--IGT_GTC_NUMBER added to IGT_DOCUMENT_REQUESTS popo.odf   120.68.12020000.93  and higher
-- If popo.odf >= 120.68.12020000.93 then IGT_GTC_NUMBER column is available in the table IGT_DOCUMENT_REQUESTS.  
-- IF popo.odf < 120.68.12020000.93 then IGT_GTC_NUMBER column is NOT available
   
   IF compare_versions(max_file_version('popo.odf'), '120.68.12020000.93') > 0 THEN
      g_igt_gtc_number := 'Column available';
   ELSE
     g_igt_gtc_number := 'Column not available';
   END IF;
  
--Framework
g_instance := l_instance;
g_apps_version := l_apps_version;
-- g_db_version := l_db_version;
...
debug('begin populate sql tokens hash table');
   ...
   g_sql_tokens('##$$RELID$$##') := nvl(to_char(l_release_id),'NULL');
   g_masked_tokens('##$$RELID$$##') := mask_text( g_sql_tokens('##$$RELID$$##'), 'NO_MASK');
   g_sql_tokens('##$$DOCTYPE$$##') := 'PO';
   g_masked_tokens('##$$DOCTYPE$$##') := mask_text( g_sql_tokens('##$$DOCTYPE$$##'), 'NO_MASK');
   g_sql_tokens('##$$DOCNUM$$##') := l_doc_num;
   g_masked_tokens('##$$DOCNUM$$##') := mask_text( g_sql_tokens('##$$DOCNUM$$##'), 'NO_MASK');
   g_sql_tokens('##$$SOBID$$##') := nvl(to_char(l_sob_id),-1);
   g_masked_tokens('##$$SOBID$$##') := mask_text( g_sql_tokens('##$$SOBID$$##'), 'NO_MASK');
   g_sql_tokens('##$$IS_BREQ$$##') := l_backing_req;
   g_masked_tokens('##$$IS_BREQ$$##') := mask_text( g_sql_tokens('##$$IS_BREQ$$##'), 'NO_MASK');
   g_sql_tokens('##$$IS_AUCRPO$$##') := l_assoc_po;
   g_masked_tokens('##$$IS_AUCRPO$$##') := mask_text( g_sql_tokens('##$$IS_AUCRPO$$##'), 'NO_MASK');
   g_sql_tokens('##$$REL$$##') := g_rep_info('Apps Version');
   g_masked_tokens('##$$REL$$##') := mask_text( g_sql_tokens('##$$REL$$##'), 'NO_MASK');
   g_sql_tokens('##$$INTREQ$$##') := l_int_req;
   g_masked_tokens('##$$INTREQ$$##') := mask_text( g_sql_tokens('##$$INTREQ$$##'), 'NO_MASK');
   g_sql_tokens('##$$DINV$$##') := nvl(to_char(l_dest_inventory),'Y');
   g_masked_tokens('##$$DINV$$##') := mask_text( g_sql_tokens('##$$DINV$$##'), 'NO_MASK');
   g_sql_tokens('##$$LEGAL_ENTITY_ID$$##') := nvl(to_char(l_legal_entity_id),-1);
   g_masked_tokens('##$$LEGAL_ENTITY_ID$$##') := mask_text( g_sql_tokens('##$$LEGAL_ENTITY_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$DROPSHIP$$##') := l_drop_ship;
   g_masked_tokens('##$$DROPSHIP$$##') := mask_text( g_sql_tokens('##$$DROPSHIP$$##'), 'NO_MASK');
   g_sql_tokens('##$$LEDGERID$$##') := l_ledger_id;
   g_masked_tokens('##$$LEDGERID$$##') := mask_text( g_sql_tokens('##$$LEDGERID$$##'), 'NO_MASK');
   g_sql_tokens('##$$PORELID$$##') := l_po_release_id;
   ...
   g_sql_tokens('##$$DSF$$##') := l_dest_shopfloor;
   g_masked_tokens('##$$DSF$$##') := mask_text( g_sql_tokens('##$$DSF$$##'), 'NO_MASK');
   g_sql_tokens('##$$ORDER_NUMBER$$##') := nvl(to_char(p_order_number), 'null');
   g_masked_tokens('##$$ORDER_NUMBER$$##') := mask_text( g_sql_tokens('##$$ORDER_NUMBER$$##'), 'NO_MASK');
   g_sql_tokens('##$$ORG_ID$$##') := p_org_id;
   g_masked_tokens('##$$ORG_ID$$##') := mask_text( g_sql_tokens('##$$ORG_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$CONTRACTID$$##') := l_contract_id;
   g_masked_tokens('##$$CONTRACTID$$##') := mask_text( g_sql_tokens('##$$CONTRACTID$$##'), 'NO_MASK');
...
debug('begin add_signature: EBS_MFG_PO_GINV_SETUP_PROFILE_OPTIONS');
   l_info('##MASK##LEVEL_VALUE'):= 'NO_MASK';
   l_info('##MASK##PROFILECOUNT'):= 'DISPLAY_NONE';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23655',
      p_sig_id                 => 'EBS_MFG_PO_GINV_SETUP_PROFILE_OPTIONS',
      p_sig_sql                => 'SELECT fpo.profile_option_id prof_option_id,
       SUBSTR (fpot.user_profile_option_name, 0, 50) profile_name, '''' profvalue, '''' proflevel, '''' levelvalue
  FROM fnd_profile_options_tl fpot,
       fnd_profile_options fpo
 WHERE ((fpot.user_profile_option_name = ''G-Invoicing Integration Admin'') or  (fpot.user_profile_option_name = ''G-Invoicing Service Host'') or (fpot.user_profile_option_name = ''G-Invoicing Service Path'') or (fpot.user_profile_option_name = ''G-Invoicing Service Version''))
AND fpot.language = ''US''
 AND fpo.profile_option_name = fpot.profile_option_name
 AND not exists (select level_id from fnd_profile_option_values fpov where fpov.profile_option_id = fpo.profile_option_id)
...
(CASE WHEN
      (SUBSTR (fpot.user_profile_option_name, 0, 50) like ''G-Invoicing Service Host%''
OR SUBSTR (fpot.user_profile_option_name, 0, 50) like ''G-Invoicing Service Path%''
OR SUBSTR (fpot.user_profile_option_name, 0, 50) like ''G-Invoicing Integration Admin%''
     )
    THEN rpad   (substr(SUBSTR (fpov.profile_option_value, 0, 450), 1,      ceil(length(SUBSTR (fpov.profile_option_value, 0, 450))*0.25) ),     length(SUBSTR (fpov.profile_option_value, 0, 450)), ''*'')
    ELSE SUBSTR (fpov.profile_option_value, 0, 450)
    END) ProfValue,
...
AND fpot.language = ''US''
 AND fpo.profile_option_name = fpot.profile_option_name
   ...
   AND fu.user_id(+) = fpov.level_value',
      p_title                  => 'Setup Profiles Options for G-Invoicing',
      p_fail_condition         => '[profvalue] is null',
      p_problem_descr          => 'Required Profile options for G-Invoicing have not been setup.',
      p_solution               => '<p>The required Profile option(s) for G-Invoicing have not been setup.</p><p>Review [2712555.1#GINV_PROFILE] What Are Required Setup for G-Invoicing Phase I - Requesting Agency - for Oracle Purchasing and Oracle Contract Lifecycle Management for Public Sector?</p>',
      p_success_msg            => 'Defined profile options for G-Invoicing.
<p>Review [2712555.1#GINV_PROFILE] What Are Required Setup for G-Invoicing Phase I - Requesting Agency - for Oracle Purchasing and Oracle Contract Lifecycle Management for Public Sector?</p> 
',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_SETUP_PROFILE_OPTIONS');



debug('begin add_signature: EBS_MFG_PO_GINV_MO_OPERATING_UNIT');
   l_info('##MASK##LEVEL_VALUE'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23669',
      p_sig_id                 => 'EBS_MFG_PO_GINV_MO_OPERATING_UNIT',
      p_sig_sql                => 'SELECT DISTINCT fpo.profile_option_id prof_option_id,
       SUBSTR (fpot.user_profile_option_name, 0, 50) profile_name,
  ...
  FROM fnd_profile_options_tl fpot,
       ...
       fnd_responsibility_tl frt,
       fnd_user fu
 WHERE ((fpot.user_profile_option_name = ''MO: Default Operating Unit''))
    AND fpov.profile_option_value = ''##$$ORGID$$##''
   AND fpo.profile_option_name = fpot.profile_option_name
   AND fpov.profile_option_id = fpo.profile_option_id
   AND fa.application_id = fpov.application_id
   AND fpov.level_value = fa2.application_id(+)
   AND frt.responsibility_id(+) = fpov.level_value
   AND fu.user_id(+) = fpov.level_value',
      p_title                  => 'Profile MO: Default Operating Unit',
      p_fail_condition         => 'NRS',
      p_problem_descr          => ' Profile option MO: Default Operating Unit is not setup.

',
      p_solution               => '<p>The required Profile option for G-Invoicing MO: Default Operating Unit has not been setup. </p><p>Review [2712555.1#MO_OPERATING] What Are Required Setup for G-Invoicing Phase I - Requesting Agency - for Oracle Purchasing and Oracle Contract Lifecycle Management for Public Sector?</p> ',
      p_success_msg            => 'Profile option MO: Default Operating Unit  is setup.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_MO_OPERATING_UNIT');



debug('begin add_signature: EBS_MFG_PO_GINV_FV_FEDERAL_ENABLED');
   l_info('##MASK##LEVEL_VALUE'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23656',
      p_sig_id                 => 'EBS_MFG_PO_GINV_FV_FEDERAL_ENABLED',
      p_sig_sql                => 'SELECT * from 
(SELECT DISTINCT fpo.profile_option_id prof_option_id,
       SUBSTR (fpot.user_profile_option_name, 0, 50) profile_name,
       SUBSTR (fpov.profile_option_value, 0, 450) VALUE,
         fpov.level_id,
       DECODE (fpov.level_id,
  ...
  FROM fnd_profile_options_tl fpot,
       ...
       fnd_responsibility_tl frt,
       fnd_user fu
 WHERE ((fpot.user_profile_option_name = ''FV: Federal Enabled''))
   AND fpo.profile_option_name = fpot.profile_option_name
   AND fpov.profile_option_id = fpo.profile_option_id
   AND fa.application_id = fpov.application_id
   AND fpov.level_value = fa2.application_id(+)
 ...
 Order by a.level_id, ''a.Level_Value''',
      p_title                  => 'Profile FV: Federal Enabled',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Profile option FV: Federal Enabled is not setup.',
      p_solution               => '<p>The required Profile option FV: Federal Enabled for G-Invoicing has not been setup.</p>
<p>Review</p>
<ul>
<li>[2712555.1#GINV_PROFILE] What Are Required Setup for G-Invoicing Phase I - Requesting Agency - for Oracle Purchasing and Oracle Contract Lifecycle Management for Public Sector?</li>
<li>[2712555.1#GINV_PROFILE] What Are Required Setup for G-Invoicing Phase I - Servicing Agency - Project Billing?</li>
</ul>
</p>',
      p_success_msg            => ' Profile option FV: Federal Enabled is setup.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_FV_FEDERAL_ENABLED');



debug('begin add_signature: EBS_MFG_PO_GINV_IGT_FLAG_NOT_ENABLED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23919',
      p_sig_id                 => 'EBS_MFG_PO_GINV_IGT_FLAG_NOT_ENABLED',
      p_sig_sql                => ' SELECT
    pdsh.style_name            doc_style,
    pdsh.style_id              doc_style_id,
     pdsh.igt_flag              igt_flag,
     pdsh.org_id                org_id,
    pdsl.display_name          doc_type,
    pudt.display_name          uda_template_name,
    pudt.template_id           uda_template_id,
    pudt.compiled_flag         uda_compiled_flag,
    pudt.database_view_name    uda_rdmbs_view,
     pudt.*--, pdsh.*
FROM
    po_uda_ag_templates_vl  pudt,
    po_doc_style_headers    pdsh,
    po_doc_style_lines_tl   pdsl
WHERE
        pdsh.style_id = pudt.document_style_id
    AND pdsl.language = ''US''
    AND (pdsh.org_id = ##$$ORG_ID$$## or pdsh.org_id is null)
    AND pdsh.style_id = pdsl.style_id
    AND pdsl.style_id != ''-3''
    AND pdsl.document_subtype = pudt.document_type
    AND nvl(pdsh.igt_flag, ''N'') = ''Y''
     AND pdsh.status = ''ACTIVE''
     AND ((pudt.database_view_name like ''POHEADER%'') or (pudt.database_view_name like ''POLINE%'') or (pudt.database_view_name like ''POSHPMNT%'') or (pudt.database_view_name like ''PODIST%''))
    AND nvl(pudt.effective_to, sysdate) >= sysdate
    order by doc_style_id, doc_type',
      p_title                  => 'Attribute Templates With IGT Flag Enabled',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'IGT Flag for Attribute Templates for document styles are not enabled.',
      p_solution               => '<p>There are no Attribute Templates defined with IGT Enabled for this document style.</>
<p> Review [2712555.1#UDA_SETUP] What Are Required Setup for G-Invoicing Phase I - Requesting Agency - for Oracle Purchasing and Oracle Contract Lifecycle Management for Public Sector?</p>',
      p_success_msg            => 'Attribute Templates for IGT are enabled for the document styles.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_IGT_FLAG_NOT_ENABLED');



debug('begin add_signature: EBS_MFG_PO_GINV_CLM_FLAG_NOT_ENABLED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23922',
      p_sig_id                 => 'EBS_MFG_PO_GINV_CLM_FLAG_NOT_ENABLED',
      p_sig_sql                => 'SELECT
    pdsh.style_name            doc_style,
    pdsh.style_id              doc_style_id,
    pdsh.clm_flag              clm_flag,
    pdsh.org_id                org_id,
    pdsl.display_name          doc_type,
    pudt.display_name          uda_template_name,
    pudt.template_id           uda_template_id,
...
WHERE
  ...
  AND (pdsh.org_id = ##$$ORG_ID$$## or pdsh.org_id is null)
    ...
    AND nvl(pudt.effective_to, sysdate) >= sysdate
    order by doc_style_id, doc_type',
      p_title                  => 'Attribute Templates With CLM Flag Enabled',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'CLM Flag for Attribute Templates for document styles are not enabled.',
      p_solution               => '<p>There are no Attribute Templates defined with CLM Enabled for this document style.</p>
<p> Review [2712555.1#UDA_CLM] What Are Required Setup for G-Invoicing Phase I - Requesting Agency - for Oracle Purchasing and Oracle Contract Lifecycle Management for Public Sector?</p>',
      p_success_msg            => 'Attribute Templates for CLM are enabled for the document styles.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_CLM_FLAG_NOT_ENABLED');



debug('begin add_signature: EBS_MFG_PO_GINV_ATTRIBUTE_TEMPLATE_NOT_COMPILED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23924',
      p_sig_id                 => 'EBS_MFG_PO_GINV_ATTRIBUTE_TEMPLATE_NOT_COMPILED',
      p_sig_sql                => 'SELECT
    pdsh.style_name            doc_style,
    pdsh.style_id              doc_style_id,
    pdsh.clm_flag              clm_flag,
...
WHERE
    ...
    AND pdsl.style_id != ''-3''
    AND pdsl.document_subtype = pudt.document_type
   AND (nvl(pdsh.igt_flag, ''N'') = ''Y'' or nvl(pdsh.clm_flag, ''N'') = ''Y'')
    AND pdsh.status = ''ACTIVE''
   AND (pudt.compiled_flag is null or pudt.compiled_flag = ''N'')
    AND ((pudt.database_view_name like ''POHEADER%'') or (pudt.database_view_name like ''POLINE%'') or (pudt.database_view_name like ''POSHPMNT%'') or (pudt.database_view_name like ''PODIST%''))
    AND nvl(pudt.effective_to, sysdate) >= sysdate
    order by doc_style_id, doc_type',
      p_title                  => 'Attribute Templates Are Not Compiled',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The enabled Attribute Templates are not compiled.
',
      p_solution               => '<p>There are enabled Attribute Templates defined that are not compiled.</p>
<p>Review [2712555.1#COMPILE] What Are Required Setup for G-Invoicing Phase I - Requesting Agency - for Oracle Purchasing and Oracle Contract Lifecycle Management for Public Sector?</p>
',
      p_success_msg            => 'The enabled Attribute Templates defined are compiled.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_ATTRIBUTE_TEMPLATE_NOT_COMPILED');



debug('begin add_signature: EBS_MFG_PO_GINV_IGT_DEFAULT_STYLE_ID_NOT_SETUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24144',
      p_sig_id                 => 'EBS_MFG_PO_GINV_IGT_DEFAULT_STYLE_ID_NOT_SETUP',
      p_sig_sql                => 'select
 poa.igt_default_style_id, 
pods.style_name, 
pods.clm_flag 
from po_system_parameters_all poa,
po_doc_style_headers pods
WHERE
(pods.org_id = ##$$ORG_ID$$## or pods.org_id is null)
and poa.igt_default_style_id = pods.style_id 
and(poa.igt_default_style_id is not null)',
      p_title                  => 'Default IGT Document Style Is Not Setup',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The  Default IGT Document Style has not been setup in the Purchasing Options. ',
      p_solution               => '[2712555.1#TEMPLATE_UDA] - What Are Required Setup for G-Invoicing Phase I - Requesting Agency - for Oracle Purchasing and Oracle Contract Lifecycle Management for Public Sector?',
      p_success_msg            => 'The default IGT Document Style is defined.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_IGT_DEFAULT_STYLE_ID_NOT_SETUP');



debug('begin add_signature: EBS_MFG_PO_GINV_BUYER_SETUP_OPTIONS');
   l_info('##MASK##FULL_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24142',
      p_sig_id                 => 'EBS_MFG_PO_GINV_BUYER_SETUP_OPTIONS',
      p_sig_sql                => 'SELECT 
distinct(ppf.full_name)
FROM
    po_system_parameters_all poa, 
fnd_user fnd, 
per_all_people_f ppf
WHERE
     poa.org_id = ##$$ORG_ID$$##
AND poa.agent_id = fnd.employee_id 
AND poa.agent_id = ppf.person_id
',
      p_title                  => 'Buyer Not Setup In Purchasing Options',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The Purchasing Options do not have a Buyer setup.',
      p_solution               => 'Review [2712555.1#BUYER] - What Are Required Setup for G-Invoicing Phase I - Requesting Agency - for Oracle Purchasing and Oracle Contract Lifecycle Management for Public Sector?',
      p_success_msg            => 'The Buyer has been setup in the Purchasing Options.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_BUYER_SETUP_OPTIONS');
...
Part Number E48931-08</a></p>',
      p_solution               => 'See [429105.1] Impact of R12 Design in Procure To Pay Accounting Flow for additional information.
',
...
FROM dual',
      ...
      p_solution               => 'Review - Impact of R12 Design in Procure To Pay Accounting Flow [429105.1] for additional information.
',
...
debug('begin add_signature: PO - PO_HEADERS_ALL');
   l_info('##MASK##%EMAIL%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FAX'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1845',
      p_sig_id                 => 'PO - PO_HEADERS_ALL',
      p_sig_sql                => 'select *
from po_headers_all where po_header_id = ##$$DOCID$$##',
      p_title                  => 'PO_HEADERS_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of PO_HEADERS_ALL Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of PO_HEADERS_ALL Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PO - PO_HEADERS_ALL');



debug('begin add_signature: PO - PO_LINES_ALL');
   l_info('##MASK##CONTRACTOR_FIRST_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CONTRACTOR_LAST_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2076',
      p_sig_id                 => 'PO - PO_LINES_ALL',
      p_sig_sql                => 'SELECT poh.org_id, poh.segment1, pol.*
FROM po_lines_all pol, po_headers_all poh
WHERE poh.po_header_id = ##$$DOCID$$##
AND poh.po_header_id = pol.po_header_id
AND pol.po_line_id like NVL(''##$$LINEID$$##'',''%'')
order by pol.line_num asc',
      p_title                  => 'PO_LINES_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of PO_LINES_ALL Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of PO_LINES_ALL Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PO - PO_LINES_ALL');



debug('begin add_signature: PO - PO_LINE_LOCATIONS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2077',
      p_sig_id                 => 'PO - PO_LINE_LOCATIONS_ALL',
      p_sig_sql                => 'SELECT poh.org_id, poh.segment1, pol.line_num, poll.shipment_num, poll.*
FROM
...
AND hr.organization_id = poll.org_id
AND poll.po_line_id like NVL(''##$$LINEID$$##'',''%'')
order by pol.line_num asc',
   ...
   l_info.delete;
debug('end add_signature: PO - PO_LINE_LOCATIONS_ALL');



debug('begin add_signature: PO - PO_DISTRIBUTIONS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2078',
      p_sig_id                 => 'PO - PO_DISTRIBUTIONS_ALL',
      p_sig_sql                => 'SELECT poh.org_id, poh.segment1, pol.line_num, poll.shipment_num, pod.*
...
order by pol.line_num asc',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of PO_DISTRIBUTIONS_ALL Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of PO_DISTRIBUTIONS_ALL Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PO - PO_DISTRIBUTIONS_ALL');



debug('begin add_signature: PO - PO_ACTION_HISTORY');
   l_info('##MASK##FULL_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2085',
      p_sig_id                 => 'PO - PO_ACTION_HISTORY',
...
order by poa.sequence_num asc',
      p_title                  => 'PO_ACTION_HISTORY',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of PO_ACTION_HISTORY Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of PO_ACTION_HISTORY Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PO - PO_ACTION_HISTORY');



debug('begin add_signature: EBS_MFG_PO_GINV_PO_HEADERS_ALL_EXT_B');
   l_info('##MASK##CONTRACTOR_FIRST_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CONTRACTOR_LAST_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##C_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##D_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##N_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##UOM_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27236',
      p_sig_id                 => 'EBS_MFG_PO_GINV_PO_HEADERS_ALL_EXT_B',
      p_sig_sql                => 'SELECT *
 FROM PO_HEADERS_ALL_EXT_B 
WHERE PO_HEADER_ID =##$$DOCID$$##',
      p_title                  => 'PO_HEADERS_ALL_EXT_B',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of PO_HEADERS_ALL_EXT_B Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of PO_HEADERS_ALL_EXT_B Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_PO_HEADERS_ALL_EXT_B');



debug('begin add_signature: EBS_MFG_GINV_EXTRACT_OF_PO_LINES_ALL_EXT_B');
   l_info('##MASK##CONTRACTOR_FIRST_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CONTRACTOR_LAST_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##C_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##D_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '27311',
      p_sig_id                 => 'EBS_MFG_GINV_EXTRACT_OF_PO_LINES_ALL_EXT_B',
      p_sig_sql                => 'SELECT * 
FROM PO_LINES_ALL_EXT_B 
WHERE PO_LINE_ID IN
  (SELECT PO_LINE_ID FROM PO_LINES_ALL WHERE PO_HEADER_ID = ##$$DOCID$$##)',
      p_title                  => 'PO_LINES_ALL_EXT_B ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of PO_LINES_ALL_EXT_B Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of PO_LINES_ALL_EXT_B Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_GINV_EXTRACT_OF_PO_LINES_ALL_EXT_B');



debug('begin add_signature: EBS_MFG_GINV_PO_LINE_LOCATIONS_ALL_EXT_B');
   l_info('##MASK##C_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##D_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##N_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##UOM_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '27314',
      p_sig_id                 => 'EBS_MFG_GINV_PO_LINE_LOCATIONS_ALL_EXT_B',
      p_sig_sql                => 'SELECT *
 FROM PO_LINE_LOCATIONS_ALL_EXT_B 
WHERE LINE_LOCATION_ID IN
 (SELECT LINE_LOCATION_ID FROM PO_LINE_LOCATIONS_ALL WHERE PO_HEADER_ID = ##$$DOCID$$##)',
      p_title                  => 'PO_LINE_LOCATIONS_ALL_EXT_B ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of PO_LINE_LOCATIONS_ALL_EXT_B Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of PO_LINE_LOCATIONS_ALL_EXT_B Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_GINV_PO_LINE_LOCATIONS_ALL_EXT_B');



debug('begin add_signature: EBS_MFG_GINV_PO_DISTRIBUTIONS_ALL_EXT_B');
   l_info('##MASK##C_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##D_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##N_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##UOM_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '27317',
      p_sig_id                 => 'EBS_MFG_GINV_PO_DISTRIBUTIONS_ALL_EXT_B',
      p_sig_sql                => 'SELECT 
 ...
 PDB.*
FROM 
 PO_DISTRIBUTIONS_ALL_EXT_B PDB, 
 PO_DISTRIBUTIONS_ALL PDA
WHERE 
 PDB.po_distribution_id = PDA.po_distribution_id 
 and PDA.po_header_id = ##$$DOCID$$##
 order by pdb.po_distribution_id desc



 ',
      p_title                  => 'PO_DISTRIBUTIONS_ALL_EXT_B ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of PO_DISTRIBUTIONS_ALL_EXT_B Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of PO_DISTRIBUTIONS_ALL_EXT_B Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_GINV_PO_DISTRIBUTIONS_ALL_EXT_B');



debug('begin add_signature: EBS_MFG_PO_GINV_PO_HEADERS_ALL_EXT_TL');
   l_info('##MASK##CONTRACTOR_FIRST_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CONTRACTOR_LAST_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##C_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##D_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '27235',
      p_sig_id                 => 'EBS_MFG_PO_GINV_PO_HEADERS_ALL_EXT_TL',
      p_sig_sql                => 'SELECT * 
FROM PO_HEADERS_ALL_EXT_TL 
WHERE PO_HEADER_ID =##$$DOCID$$##',
      p_title                  => 'PO_HEADERS_ALL_EXT_TL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of PO_HEADERS_ALL_EXT_TL Table.',
      p_solution               => '',
      p_success_msg            => ' Extract of PO_HEADERS_ALL_EXT_TL Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_PO_HEADERS_ALL_EXT_TL');



debug('begin add_signature: EBS_MFG_GINV_PO_LINES_ALL_EXT_TL');
   l_info('##MASK##C_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##D_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##N_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##UOM_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '27312',
      p_sig_id                 => 'EBS_MFG_GINV_PO_LINES_ALL_EXT_TL',
      p_sig_sql                => 'SELECT * 
FROM PO_LINES_ALL_EXT_TL 
WHERE PO_LINE_ID IN
  (SELECT PO_LINE_ID FROM PO_LINES_ALL WHERE PO_HEADER_ID = ##$$DOCID$$##)',
      p_title                  => 'PO_LINES_ALL_EXT_TL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of PO_LINES_ALL_EXT_TL Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of PO_LINES_ALL_EXT_TL Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_GINV_PO_LINES_ALL_EXT_TL');



debug('begin add_signature: EBS_MFG_GINV_PO_LINE_LOCATIONS_ALL_EXT_TL');
   l_info('##MASK##C_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##D_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##N_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##UOM_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '27313',
      p_sig_id                 => 'EBS_MFG_GINV_PO_LINE_LOCATIONS_ALL_EXT_TL',
      p_sig_sql                => 'SELECT *
 FROM PO_LINE_LOCATIONS_ALL_EXT_TL 
WHERE LINE_LOCATION_ID IN
 (SELECT LINE_LOCATION_ID FROM PO_LINE_LOCATIONS_ALL WHERE PO_HEADER_ID = ##$$DOCID$$##)',
      p_title                  => 'PO_LINE_LOCATIONS_ALL_EXT_TL ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of PO_LINE_LOCATIONS_ALL_EXT_TL Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of PO_LINE_LOCATIONS_ALL_EXT_TL Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_GINV_PO_LINE_LOCATIONS_ALL_EXT_TL');



debug('begin add_signature: EBS_MFG_GINV_PO_DISTRIBUTIONS_ALL_EXT_TL');
   l_info('##MASK##C_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##D_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##N_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##UOM_EXT_ATTR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '27318',
      p_sig_id                 => 'EBS_MFG_GINV_PO_DISTRIBUTIONS_ALL_EXT_TL',
      p_sig_sql                => 'SELECT 
  PDA.po_distribution_id,
  PDA.line_location_id,
  PDA.po_line_id,
  PDA.po_header_id,
  PDXT.*
FROM PO_DISTRIBUTIONS_ALL_EXT_TL PDXT, PO_DISTRIBUTIONS_ALL PDA
WHERE
 PDXT.po_distribution_id = PDA.po_distribution_id 
 and PDA.po_header_id = ##$$DOCID$$##
 order by pdxt.po_distribution_id desc
',
      p_title                  => 'PO_DISTRIBUTIONS_ALL_EXT_TL ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of PO_DISTRIBUTIONS_ALL_EXT_TL Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of PO_DISTRIBUTIONS_ALL_EXT_TL Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_GINV_PO_DISTRIBUTIONS_ALL_EXT_TL');



debug('begin add_signature: EBS_MFG_PO_GINV_PO_DRAFTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27310',
      p_sig_id                 => 'EBS_MFG_PO_GINV_PO_DRAFTS',
      p_sig_sql                => ' select * 
from PO_DRAFTS
 where document_id = ##$$DOCID$$##',
      p_title                  => 'PO_DRAFTS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found.
No action is required, informational purposes only.
',
      p_solution               => '',
      p_success_msg            => 'No action is required, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_PO_DRAFTS');



debug('begin add_signature: EBS_MFG_PO_GINV_PO_LINES_DRAFTS_ALL');
   l_info('##MASK##CONTRACTOR_FIRST_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CONTRACTOR_LAST_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27231',
      p_sig_id                 => 'EBS_MFG_PO_GINV_PO_LINES_DRAFTS_ALL',
      p_sig_sql                => ' SELECT *
 FROM PO_LINES_DRAFT_ALL 
WHERE PO_HEADER_ID =##$$DOCID$$##',
      p_title                  => 'PO_LINES_DRAFT_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of PO_LINES_DRAFT_ALL Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of PO_LINES_DRAFT_ALL Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_PO_LINES_DRAFTS_ALL');



debug('begin add_signature: EBS_MFG_PO_GINV_PO_LINE_LOCATIONS_DRAFT_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27232',
      p_sig_id                 => 'EBS_MFG_PO_GINV_PO_LINE_LOCATIONS_DRAFT_ALL',
      p_sig_sql                => 'SELECT * 
FROM PO_LINE_LOCATIONS_DRAFT_ALL
 WHERE PO_HEADER_ID =##$$DOCID$$##',
      p_title                  => 'PO_LINE_LOCATIONS_DRAFT_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found.
No action is required, informational purposes only.',
      p_solution               => '',
...
',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_PO_LINE_LOCATIONS_DRAFT_ALL');



debug('begin add_signature: EBS_MFG_PO_GINV_PO_DISTRIBUTIONS_DRAFT_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27233',
      p_sig_id                 => 'EBS_MFG_PO_GINV_PO_DISTRIBUTIONS_DRAFT_ALL',
      p_sig_sql                => 'SELECT *
 FROM PO_DISTRIBUTIONS_DRAFT_ALL
 WHERE ABS(PO_HEADER_ID) = ##$$DOCID$$##',
      p_title                  => 'PO_DISTRIBUTIONS_DRAFT_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data was found.
No action is required, informational purposes only.
',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_PO_DISTRIBUTIONS_DRAFT_ALL');



debug('begin add_signature: PO - PO_HEADERS_ARCHIVE_ALL');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##EMAIL_ADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FAX'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##NOTE_TO%'):= 'DISPLAY_NONE';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2081',
      p_sig_id                 => 'PO - PO_HEADERS_ARCHIVE_ALL',
      p_sig_sql                => 'SELECT *
FROM po_headers_archive_all
WHERE po_header_id = ##$$DOCID$$##
ORDER BY REVISION_NUM DESC',
      p_title                  => 'PO_HEADERS_ARCHIVE_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of PO_HEADERS_ARCHIVE_ALL Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of PO_HEADERS_ARCHIVE_ALL Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PO - PO_HEADERS_ARCHIVE_ALL');



debug('begin add_signature: PO - PO_LINES_ARCHIVE_ALL');
   l_info('##MASK##CONTRACTOR%NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2082',
      p_sig_id                 => 'PO - PO_LINES_ARCHIVE_ALL',
      p_sig_sql                => 'SELECT poh.org_id, poh.segment1, pol.line_num, pol.*
FROM apps.po_lines_archive_all pol, 
apps.po_headers_all poh, 
apps.hr_all_organization_units hr
WHERE poh.po_header_id = ##$$DOCID$$##
and hr.organization_id = poh.org_id
...
AND pol.po_line_id like NVL(''##$$LINEID$$##'',''%'')
order by pol.line_num asc',
      p_title                  => 'PO_LINES_ARCHIVE_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of PO_LINES_ARCHIVE_ALL Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of PO_LINES_ARCHIVE_ALL Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PO - PO_LINES_ARCHIVE_ALL');



debug('begin add_signature: PO - PO_LINE_LOCATIONS_ARCHIVE_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2083',
      p_sig_id                 => 'PO - PO_LINE_LOCATIONS_ARCHIVE_ALL',
      p_sig_sql                => 'SELECT poh.org_id, poh.segment1, pol.line_num, poll.shipment_num, poll.*
FROM apps.po_line_locations_archive_all poll, 
apps.po_lines_all pol, 
apps.po_headers_all poh,
apps.hr_all_organization_units hr
WHERE poh.po_header_id = ##$$DOCID$$##
...
AND poll.po_line_id like NVL(''##$$LINEID$$##'',''%'')
order by pol.line_num asc',
      p_title                  => 'PO_LINE_LOCATIONS_ARCHIVE_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of PO_LINE_LOCATIONS_ARCHIVE_ALL Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of PO_LINE_LOCATIONS_ARCHIVE_ALL Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PO - PO_LINE_LOCATIONS_ARCHIVE_ALL');



debug('begin add_signature: PO - PO_DISTRIBUTIONS_ARCHIVE_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2084',
      p_sig_id                 => 'PO - PO_DISTRIBUTIONS_ARCHIVE_ALL',
      p_sig_sql                => 'SELECT poh.org_id, poh.segment1, pol.line_num, poll.shipment_num, pod.distribution_num, pod.*
FROM apps.po_line_locations_all poll, 
apps.po_lines_all pol, 
apps.po_headers_all poh, 
apps.po_distributions_archive_all pod,
apps.hr_all_organization_units hr
WHERE poh.po_header_id = ##$$DOCID$$##
and poh.po_header_id = pol.po_header_id 
and hr.organization_id = poh.org_id
...
AND pod.po_line_id like NVL(''##$$LINEID$$##'',''%'')
order by pol.line_num asc',
      p_title                  => 'PO_DISTRIBUTIONS_ARCHIVE_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of PO_DISTRIBUTIONS_ARCHIVE_ALL Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of PO_DISTRIBUTIONS_ARCHIVE_ALL Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PO - PO_DISTRIBUTIONS_ARCHIVE_ALL');



debug('begin add_signature: EBS_MFG_GINV_PO_HEADERS_ALL_CLM_SOURCE_DOCUMENT_ID');
   l_info('##MASK##%EMAIL%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FAX'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27299',
      p_sig_id                 => 'EBS_MFG_GINV_PO_HEADERS_ALL_CLM_SOURCE_DOCUMENT_ID',
      p_sig_sql                => 'select *
from po_headers_all 
where po_header_id =##$$CONTRACTID$$##',
      p_title                  => 'PO_HEADERS_ALL_GTNC_DOCUMENT_ID',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of PO_HEADERS_ALL Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of PO_HEADERS_ALL Table.',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_GINV_PO_HEADERS_ALL_CLM_SOURCE_DOCUMENT_ID');



debug('begin add_signature: EBS_MFG_PO_GINV_FND_LOG_IGT_DOCUMENT_REQUEST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29078',
      p_sig_id                 => 'EBS_MFG_PO_GINV_FND_LOG_IGT_DOCUMENT_REQUEST',
      p_sig_sql                => 'SELECT log.module, log.message_text message
FROM fnd_log_messages log, fnd_log_transaction_context con
WHERE con.transaction_id IN (Select request_id
from igt_document_requests igt
where  internal_document_number = ''##$$DOCID$$##'')
AND con.transaction_type = ''REQUEST''
AND con.transaction_context_id = log.transaction_context_id
ORDER BY log.log_sequence',
      p_title                  => 'FND Log Messages for IGT_DOCUMENT_REQUEST',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of FND Log Messages for IGT_DOCUMENT_REQUEST',
      p_solution               => '',
      p_success_msg            => 'Extract of FND Log Messages for IGT_DOCUMENT_REQUEST',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_FND_LOG_IGT_DOCUMENT_REQUEST');



debug('begin add_signature: EBS_MFG_PO_GINV_IGT_IMPORT_WF_NOTIF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24151',
      p_sig_id                 => 'EBS_MFG_PO_GINV_IGT_IMPORT_WF_NOTIF',
      p_sig_sql                => 'select 
wfn.notification_id, 
wfn.recipient_role, 
wfn.subject
...
po_system_parameters_all psa,
fnd_user fnd
where
psa.agent_id = fnd.employee_id and
wfn.recipient_role = fnd.user_name and
wfn.message_name = ''IGT_NOTIF'' and
subject like ''Erro%'' and
psa.org_id = ##$$ORG_ID$$##  and
rownum < 10
order by wfn.begin_date',
      p_title                  => 'Error Notifications Related to the Intragovernmental Interfacing Process',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The following Notifications have identified possible errors encountered during the Interfacing process of Intragovernmental Documents. The records listed may not pertain directly to the document currently being analyzed.',
      p_solution               => '<p>Review the Buyer Notifications in the application. Take the appropriate actions that are given within each Notification.</p><p>Review Intragovernmental Orders Interface Program - Error Handling [2931775.1].</p>',
      p_success_msg            => 'No Error Notifications were found related to the Intragovernmental Interface process.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_IGT_IMPORT_WF_NOTIF');



debug('begin add_signature: EBS_MFG_PO_GINV_IGT_MOD_PO_ACTION_HISTORY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28083',
      p_sig_id                 => 'EBS_MFG_PO_GINV_IGT_MOD_PO_ACTION_HISTORY',
      p_sig_sql                => 'SELECT
    *
FROM
    po_action_history
WHERE
    object_id IN (
      ...
      p_title                  => 'PO_ACTION_HISTORY for IGT Modification',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of PO_ACTION_HISTORY Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of PO_ACTION_HISTORY Table.',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_IGT_MOD_PO_ACTION_HISTORY');



debug('begin add_signature: EBS_MFG_PO_GINV_IGT_ORDER_PO_BC_DISTRIBUTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28066',
      p_sig_id                 => 'EBS_MFG_PO_GINV_IGT_ORDER_PO_BC_DISTRIBUTIONS',
      p_sig_sql                => 'SELECT
    *
FROM
    po_bc_distributions
WHERE
    ...
    AND header_id = ##$$DOCID$$##',
      p_title                  => 'PO_BC_DISTRIBUTIONS for IGT Order',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of PO_BC_DISTRIBUTIONS Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of PO_BC_DISTRIBUTIONS Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_IGT_ORDER_PO_BC_DISTRIBUTIONS');



debug('begin add_signature: EBS_MFG_PO_GINV_IGT_ORDER_XLA_EVENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28068',
      p_sig_id                 => 'EBS_MFG_PO_GINV_IGT_ORDER_XLA_EVENTS',
      p_sig_sql                => 'SELECT
    *
FROM
    xla_events
...
',
      p_title                  => 'XLA_EVENTS for IGT Order',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of XLA_EVENTS Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of XLA_EVENTS Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_IGT_ORDER_XLA_EVENTS');



debug('begin add_signature: EBS_MFG_PO_GINV_IGT_ORDER_XLA_AE_HEADERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28069',
      p_sig_id                 => 'EBS_MFG_PO_GINV_IGT_ORDER_XLA_AE_HEADERS',
      p_sig_sql                => 'SELECT
    *
FROM
    xla_ae_headers
...
',
      p_title                  => 'XLA_AE_HEADERS for IGT Order',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of XLA_AE_HEADERS Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of XLA_AE_HEADERS Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_IGT_ORDER_XLA_AE_HEADERS');



debug('begin add_signature: EBS_MFG_PO_GINV_IGT_ORDER_XLA_AE_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28070',
      p_sig_id                 => 'EBS_MFG_PO_GINV_IGT_ORDER_XLA_AE_LINES',
      p_sig_sql                => 'SELECT
    *
FROM
    xla_ae_lines
WHERE
    ae_header_id IN (
      ...
      p_title                  => 'XLA_AE_LINES for IGT Order',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of XLA_AE_LINES Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of XLA_AE_LINES Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_IGT_ORDER_XLA_AE_LINES');



debug('begin add_signature: EBS_MFG_PO_GINV_IGT_ORDER_XLA_DIST_LINKS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28072',
      p_sig_id                 => 'EBS_MFG_PO_GINV_IGT_ORDER_XLA_DIST_LINKS',
      p_sig_sql                => 'SELECT
    *
FROM
...
WHERE
    event_id IN (
      ...
      p_title                  => 'XLA_DISTRIBUTION_LINKS for IGT Order',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of XLA_DISTRIBUTION_LINKS Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of XLA_DISTRIBUTION_LINKS Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_IGT_ORDER_XLA_DIST_LINKS');



debug('begin add_signature: EBS_MFG_PO_GINV_IGT_ORDER_XLA_TXN_ENTITIES_UPG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28071',
      p_sig_id                 => 'EBS_MFG_PO_GINV_IGT_ORDER_XLA_TXN_ENTITIES_UPG',
      p_sig_sql                => 'SELECT
    *
FROM
...
WHERE
    entity_id IN (
      ...
      p_title                  => 'XLA_TRANSACTION_ENTITIES_UPG for IGT Order',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of XLA_TRANSACTION_ENTITIES_UPG Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of XLA_TRANSACTION_ENTITIES_UPG Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_IGT_ORDER_XLA_TXN_ENTITIES_UPG');



debug('begin add_signature: EBS_MFG_PO_GINV_IGT_ORDER_PSA_XLA_ACCOUNTING_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28067',
      p_sig_id                 => 'EBS_MFG_PO_GINV_IGT_ORDER_PSA_XLA_ACCOUNTING_ERRORS',
      p_sig_sql                => 'SELECT
    *
FROM
    psa_xla_accounting_errors
WHERE
        application_id = 201
    AND entity_code = ''PURCHASE_ORDER''
    AND source_id_int_1 = ##$$DOCID$$##',
      p_title                  => 'PSA_XLA_ACCOUNTING_ERRORS for IGT Order',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of PSA_XLA_ACCOUNTING_ERRORS Table.',
      p_solution               => 'No action is needed, informational purposes only.',
      p_success_msg            => 'No data was found.
No action is needed, informational purposes only.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_IGT_ORDER_PSA_XLA_ACCOUNTING_ERRORS');



debug('begin add_signature: EBS_MFG_PO_GINV_IGT_REQ_HEADERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28058',
      p_sig_id                 => 'EBS_MFG_PO_GINV_IGT_REQ_HEADERS',
      p_sig_sql                => 'SELECT
    *
FROM
...
WHERE
    requisition_header_id IN (
      ...
      p_title                  => 'PO_REQUISITION_HEADERS_ALL for IGT Order',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of PO_REQUISITION_HEADERS_ALL Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of PO_REQUISITION_HEADERS_ALL Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_IGT_REQ_HEADERS');



debug('begin add_signature: EBS_MFG_PO_IGT_REQ_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28059',
      p_sig_id                 => 'EBS_MFG_PO_IGT_REQ_LINES',
      p_sig_sql                => 'SELECT
    *
FROM
    po_requisition_lines_all
...
',
      p_title                  => 'PO_REQUISITION_LINES_ALL for IGT Order',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of PO_REQUISITION_LINES_ALL Table.',
      p_solution               => 'No action is needed, informational purposes only.',
      p_success_msg            => 'Extract of PO_REQUISITION_LINES_ALL Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_IGT_REQ_LINES');



debug('begin add_signature: EBS_MFG_PO_GINV_IGT_REQ_DISTRIBUTIONS');
   l_info('##MASK##ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28060',
      p_sig_id                 => 'EBS_MFG_PO_GINV_IGT_REQ_DISTRIBUTIONS',
      p_sig_sql                => 'SELECT
    *
FROM
...
WHERE
    requisition_line_id IN (
      ...
      p_title                  => 'PO_REQ_distributions_ALL for IGT Order',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of PO_REQ_distributions_ALL Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of PO_REQ_distributions_ALL Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_IGT_REQ_DISTRIBUTIONS');



debug('begin add_signature: EBS_MFG_PO_GINV_IGT_REQ_PO_BC_DISTRIBUTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28061',
      p_sig_id                 => 'EBS_MFG_PO_GINV_IGT_REQ_PO_BC_DISTRIBUTIONS',
      p_sig_sql                => 'SELECT
    *
FROM
    po_bc_distributions
...
',
      p_title                  => 'PO_BC_DISTRIBUTIONS for IGT Requisition',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of PO_BC_DISTRIBUTIONS Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of PO_BC_DISTRIBUTIONS Table.',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_IGT_REQ_PO_BC_DISTRIBUTIONS');



debug('begin add_signature: EBS_MFG_PO_GINV_IGT_REQ_XLA_EVENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28062',
      p_sig_id                 => 'EBS_MFG_PO_GINV_IGT_REQ_XLA_EVENTS',
      p_sig_sql                => 'SELECT
    *
FROM
    xla_events
WHERE
    event_id IN (
      ...
      p_title                  => 'XLA_EVENTS for IGT Requisition',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of XLA_EVENTS Table.',
      p_solution               => 'No action is needed, informational purposes only.',
      p_success_msg            => 'No data was found.
No action is needed, informational purposes only.',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_IGT_REQ_XLA_EVENTS');



debug('begin add_signature: EBS_MFG_PO_GINV_IGT_REQ_XLA_AE_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28064',
      p_sig_id                 => 'EBS_MFG_PO_GINV_IGT_REQ_XLA_AE_LINES',
      p_sig_sql                => 'SELECT
    *
FROM
    xla_ae_lines
...
',
      p_title                  => 'XLA_AE_LINES for IGT Requisition',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of XLA_AE_LINES Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of XLA_AE_LINES Table.',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_IGT_REQ_XLA_AE_LINES');



debug('begin add_signature: EBS_MFG_PO_GINV_IGT_REQ_XLA_TRANSACTION_ENTITIES_UPG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28065',
      p_sig_id                 => 'EBS_MFG_PO_GINV_IGT_REQ_XLA_TRANSACTION_ENTITIES_UPG',
      p_sig_sql                => 'SELECT
    *
FROM
    xla_transaction_entities_upg
WHERE
    entity_id IN (
      ...
      p_title                  => 'XLA_TRANSACTION_ENTITIES_UPG for IGT Requisition',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of XLA_TRANSACTION_ENTITIES_UPG Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of XLA_TRANSACTION_ENTITIES_UPG Table.',
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_IGT_REQ_XLA_TRANSACTION_ENTITIES_UPG');



debug('begin add_signature: EBS_MFG_PO_GINV_PO_IGT_PERF_DETAIL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28075',
      p_sig_id                 => 'EBS_MFG_PO_GINV_PO_IGT_PERF_DETAIL',
      p_sig_sql                => 'SELECT *
FROM  po_igt_perf_detail
WHERE   po_header_id = ##$$DOCID$$##',
      p_title                  => 'PO_IGT_PERF_DETAIL for IGT Order',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of PO_IGT_PERF_DETAIL Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of PO_IGT_PERF_DETAIL Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_PO_IGT_PERF_DETAIL');



debug('begin add_signature: EBS_MFG_PO_GINV_PO_IGT_PERF_TRANS_HISTORY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28076',
      p_sig_id                 => 'EBS_MFG_PO_GINV_PO_IGT_PERF_TRANS_HISTORY',
      p_sig_sql                => 'SELECT
    *
FROM
    po_igt_perf_trans_history
WHERE
    po_header_id = ##$$DOCID$$##',
      p_title                  => 'PO_IGT_PERF_TRANS_HISTORY for IGT Order',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of PO_IGT_PERF_TRANS_HISTORY Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of PO_IGT_PERF_TRANS_HISTORY Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_PO_IGT_PERF_TRANS_HISTORY');



debug('begin add_signature: EBS_MFG_PO_GINV_IGT_ORDER_AP_INVOICES_INTERFACE');
   l_info('##MASK##PERF_AUTH_EMAIL'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PERF_AUTH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PERF_AUTH_PHONE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PREPARER_EMAIL'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PREPARER_PHONE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PREPARE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28077',
      p_sig_id                 => 'EBS_MFG_PO_GINV_IGT_ORDER_AP_INVOICES_INTERFACE',
      p_sig_sql                => 'SELECT
    *
FROM
...
WHERE
    ( po_number IN (
      ...
      OR ( reference_key2 IN (
        ...
        WHERE
           ...
           AND product_table = ''PO_IGT_PERF_HEADER'' ) )',
      p_title                  => 'AP_INVOICES_INTERFACE for IGT Order & Performance',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of AP_INVOICES_INTERFACE Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of AP_INVOICES_INTERFACE Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_IGT_ORDER_AP_INVOICES_INTERFACE');



debug('begin add_signature: EBS_MFG_PO_GINV_IGT_ORDER_AP_INVOICE_LINES_INTERFACE');
   l_info('##MASK##PERF_AUTH_EMAIL'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PERF_AUTH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PERF_AUTH_PHONE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PREPARER_EMAIL'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '28078',
      p_sig_id                 => 'EBS_MFG_PO_GINV_IGT_ORDER_AP_INVOICE_LINES_INTERFACE',
      p_sig_sql                => 'SELECT
    *
FROM
...
WHERE
    ( po_number IN (
      ...
      OR ( reference_key3 IN (
        ...
        WHERE
           ...
           AND product_table = ''PO_IGT_PERF_HEADER'' ) )',
      p_title                  => 'AP_INVOICE_LINES_INTERFACE for IGT Order & Performance',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of AP_INVOICE_LINES_INTERFACE Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of AP_INVOICE_LINES_INTERFACE Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_IGT_ORDER_AP_INVOICE_LINES_INTERFACE');



debug('begin add_signature: EBS_MFG_PO_GINV_IGT_ORDER_AP_INTERFACE_REJECTIONS');
   l_info('##MASK##PERF_AUTH_EMAIL'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PERF_AUTH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PERF_AUTH_PHONE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PREPARER_EMAIL'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '28079',
      p_sig_id                 => 'EBS_MFG_PO_GINV_IGT_ORDER_AP_INTERFACE_REJECTIONS',
      p_sig_sql                => 'SELECT
    *
FROM
...
WHERE
    ...
    OR ( parent_table = ''AP_INVOICE_LINES_INTERFACE''
         AND parent_id IN (
        SELECT
            invoice_id
        FROM
      ...
      p_title                  => 'AP_INTERFACE_REJECTIONS for IGT Order & Performance',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of AP_INTERFACE_REJECTIONS Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of AP_INTERFACE_REJECTIONS Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_IGT_ORDER_AP_INTERFACE_REJECTIONS');



debug('begin add_signature: EBS_MFG_PO_GINV_IGT_ORDER_AP_INVOICES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28080',
      p_sig_id                 => 'EBS_MFG_PO_GINV_IGT_ORDER_AP_INVOICES_ALL',
      p_sig_sql                => 'SELECT
    *
FROM
    ap_invoices_all
WHERE
    invoice_id IN (
      ...
      p_title                  => 'AP_INVOICES_ALL for IGT Order & Performance',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of AP_INVOICES_ALL Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of AP_INVOICES_ALL Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_IGT_ORDER_AP_INVOICES_ALL');



debug('begin add_signature: EBS_MFG_PO_GINV_IGT_ORDER_AP_INVOICE_LINES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28081',
      p_sig_id                 => 'EBS_MFG_PO_GINV_IGT_ORDER_AP_INVOICE_LINES_ALL',
      p_sig_sql                => 'SELECT
    *
FROM
...
WHERE
    invoice_id IN (
      ...
      p_title                  => 'AP_INVOICE_LINES_ALL for IGT Order & Performance',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of AP_INVOICE_LINES_ALL Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of AP_INVOICE_LINES_ALL Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_IGT_ORDER_AP_INVOICE_LINES_ALL');



debug('begin add_signature: EBS_MFG_PO_GINV_IGT_ORDER_AP_INVOICE_DISTRIBUTIONS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28082',
      p_sig_id                 => 'EBS_MFG_PO_GINV_IGT_ORDER_AP_INVOICE_DISTRIBUTIONS_ALL',
      p_sig_sql                => 'SELECT
    *
FROM
    ap_invoice_distributions_all
WHERE
    po_distribution_id IN (
      ...
      p_title                  => 'AP_INVOICE_DISTRIBUTIONS_ALL for IGT Order & Performance',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of AP_INVOICE_DISTRIBUTIONS_ALL Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of AP_INVOICE_DISTRIBUTIONS_ALL Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_IGT_ORDER_AP_INVOICE_DISTRIBUTIONS_ALL');



debug('begin add_signature: EBS_FIN_PA_GINV_PA_IMPLEMENTATION_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23892',
      p_sig_id                 => 'EBS_FIN_PA_GINV_PA_IMPLEMENTATION_OPTIONS',
      p_sig_sql                => 'select * 
from pa_implementations_all
where org_id = ##$$ORGID$$##',
      p_title                  => 'Implementation Options',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Implementation Options have not been defined at the operating unit level.',
      p_solution               => '',
      p_success_msg            => 'Implementation Options have been defined at the operating unit level.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_PA_IMPLEMENTATION_OPTIONS');



debug('begin add_signature: EBS_FIN_PA_GINV_ADJ_ON_STD_INV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23327',
      p_sig_id                 => 'EBS_FIN_PA_GINV_ADJ_ON_STD_INV',
      p_sig_sql                => 'select segment1, project_id, 
decode (adj_on_std_inv,''AL'', ''All'', ''LA'', ''Labor Accruals Only'',''LO'', ''Labor Only'', ''None'')
from pa_projects_all
Where project_id =   (select  link_project_id from pa_igt_order where order_number = ''##$$ORDER_NUMBER$$##'')
and adj_on_std_inv != ''N''
union select task_number, task_id,
decode (adj_on_std_inv,''AL'', ''All'', ''LA'', ''Labor Accruals Only'',''LO'', ''Labor Only'', ''None'')
from pa_tasks
where project_id = (select  link_project_id from pa_igt_order where order_number = ''##$$ORDER_NUMBER$$##'')
and adj_on_std_inv != ''N''',
      p_title                  => 'Adjustments Included on Standard Invoice at Project and Tasks',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'When an expenditure batch is reversed the ''Intragovernmental Performance Interface Program'' process will error if the project and tasks have ''Adjustments included on standard invoice'' not set as None.',
      p_solution               => 'Follow the instructions in [2787449.1] G-Invoicing Expenditure Batch Reversal Receives an Error Code 400 ( Missing Reference Performance) ',
      p_success_msg            => 'With the current design  of G-invoicing ''Adjustments included on standard invoice'' is set as None at project and task levels.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_ADJ_ON_STD_INV');



debug('begin add_signature: EBS_FIN_PA_GINV_IMPL_OPTION_NO_AGREEMENT_TYPE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23732',
      p_sig_id                 => 'EBS_FIN_PA_GINV_IMPL_OPTION_NO_AGREEMENT_TYPE',
      p_sig_sql                => 'select 
SET_OF_BOOKS_ID,                
BUSINESS_GROUP_ID,    
ORG_ID,         
...
CC_MULTI_LE_FLAG,                  
CC_EXP_ORG_STRUCTURE_ID,
CC_EXP_ORG_STRUCT_VERSION_ID,
CC_EXP_START_ORG_ID,      
CC_PROJ_ORG_STRUCTURE_ID,
CC_PROJ_ORG_STRUCT_VERSION_ID,
CC_PROJ_START_ORG_ID,   
CREATE_ON_ACCOUNT_CM_IC,              
LAST_UPDATE_DATE,                
LAST_UPDATED_BY,                
CREATION_DATE,                
CREATED_BY,                  
LAST_UPDATE_LOGIN
from pa_implementations_all
where ginv_agreement_type is NULL
and org_id =  ##$$ORGID$$##',
      p_title                  => 'No Agreement Type in Implementation Options',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Agreement type is not assigned in the Implementation Options for this operating unit and is required.',
      p_solution               => 'Follow the instructions in [2835144.1] G-Invoicing: Implementation Options > Billing TAB, The "Agreement Type" Field Is Missing.',
      p_success_msg            => 'Agreement type has been assigned in the Implementation Options for this operating unit.',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_IMPL_OPTION_NO_AGREEMENT_TYPE');



debug('begin add_signature: EBS_FIN_PA_GINV_NO_AGREEMENT_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23731',
      p_sig_id                 => 'EBS_FIN_PA_GINV_NO_AGREEMENT_TYPES',
      p_sig_sql                => 'select * 
from pa_agreement_types 
where approval_required_flag = ''Y''',
      p_title                  => 'IGT Agreement Types',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no agreement type defined for intragovernmental transactions (IGT).',
      p_solution               => 'At least one agreement type specifically for intragovernmental transactions (IGT) must be defined. See [2898071.1] for additional information.',
      p_success_msg            => 'Agreement type(s) have been defined for intragovernmental transactions (IGT).',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_NO_AGREEMENT_TYPES');



debug('begin add_signature: EBS_FIN_PA_GINV_FV_TREASURY_SYMBOLS_SOB');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31780',
      p_sig_id                 => 'EBS_FIN_PA_GINV_FV_TREASURY_SYMBOLS_SOB',
      p_sig_sql                => 'select * from FV_TREASURY_SYMBOLS
where SET_OF_BOOKS_ID in (select SET_OF_BOOKS_ID from pa_implementations_all where org_id = ##$$ORGID$$##)',
      p_title                  => 'Treasury Symbols Defined for Set of Books',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No records in FV_TREASURY_SYMBOLS for the set of books.',
      p_solution               => '',
      p_success_msg            => 'Records exist in FV_TREASURY_SYMBOLS for the set of books.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_FV_TREASURY_SYMBOLS_SOB');



debug('begin add_signature: EBS_FIN_PA_GINV_FV_TREASURY_SYMBOLS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31808',
      p_sig_id                 => 'EBS_FIN_PA_GINV_FV_TREASURY_SYMBOLS',
      p_sig_sql                => 'select * from FV_TREASURY_SYMBOLS',
      p_title                  => 'FV_TREASURY_SYMBOLS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No records in FV_TREASURY_SYMBOLS.',
      p_solution               => '',
      p_success_msg            => 'Records exist in FV_TREASURY_SYMBOLS.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_FV_TREASURY_SYMBOLS');



debug('begin add_signature: EBS_FIN_PA_GINV_FV_FACTS_FEDERAL_ACCOUNTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31781',
      p_sig_id                 => 'EBS_FIN_PA_GINV_FV_FACTS_FEDERAL_ACCOUNTS',
      p_sig_sql                => 'select * 
from FV_FACTS_FEDERAL_ACCOUNTS
where SET_OF_BOOKS_ID in (select SET_OF_BOOKS_ID from pa_implementations_all where org_id = ##$$ORGID$$##) order by creation_date desc',
      p_title                  => 'FV_FACTS_FEDERAL_ACCOUNTS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No records in FV_FACTS_FEDERAL_ACCOUNTS for the set of books.',
      p_solution               => '',
      p_success_msg            => 'Records exist in FV_FACTS_FEDERAL_ACCOUNTS for the set of books.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_FV_FACTS_FEDERAL_ACCOUNTS');



debug('begin add_signature: EBS_FIN_PA_GINV_ORDER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23723',
      p_sig_id                 => 'EBS_FIN_PA_GINV_ORDER',
      p_sig_sql                => 'select *
from pa_igt_order
...
',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Order Number parameter is not provided.',
      p_solution               => '',
      p_success_msg            => 'Order details found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_ORDER');



debug('begin add_signature: EBS_FIN_PA_GINV_FV_TP_TREASURY_SYMBOLS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23803',
      p_sig_id                 => 'EBS_FIN_PA_GINV_FV_TP_TREASURY_SYMBOLS',
      p_sig_sql                => 'select * from FV_TP_TREASURY_SYMBOLS 
where nvl(org_id, ##$$ORGID$$##) = ##$$ORGID$$##',
      p_title                  => 'Trading Partner Treasury Symbols',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Trading Partner Treasury Account Symbols have not been defined.',
      p_solution               => '',
      p_success_msg            => 'Trading Partner Treasury Account Symbols have been defined.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_FV_TP_TREASURY_SYMBOLS');
...
<li>Review any error messages provided and see [2847600.1]
...
debug('begin add_signature: EBS_FIN_PA_GINV_GINV_AC_FILE_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31295',
      p_sig_id                 => 'EBS_FIN_PA_GINV_GINV_AC_FILE_VERSIONS',
...
',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_GINV_AC_FILE_VERSIONS');
...
debug('begin add_signature: EBS_FIN_ECC_VERSION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30053',
      p_sig_id                 => 'EBS_FIN_ECC_VERSION',
      p_sig_sql                => 'select * from ECC.ECC_ENTITY_VERSIONS
where entity_type = ''PRODUCT''
and active_flag = ''Y''',
      p_title                  => 'ECC Version',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no Active ECC versions installed.',
      p_solution               => 'If you would like to use the ECC functionality, please follow the steps outlined in Oracle Support [2495053.1] - Installing Oracle Enterprise Command Center Framework for EBS Release 12.2. This document provides detailed guidance on how to install and configure the ECC framework for your EBS environment.',
      p_success_msg            => 'A version of ECC has already been installed. For more details, please refer to Oracle Support [2495053.1] - Installing Oracle Enterprise Command Center Framework for EBS Release 12.2. This document provides information on how to install, configure, and manage the ECC framework for your current environment.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_ECC_VERSION');
...
order by name',
      ...
      p_solution               => '',
      p_success_msg            => 'Refer to [396009.1].',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
...
debug('begin add_signature: EBS_FIN_PA_GINV_ORDER_LINE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23722',
      p_sig_id                 => 'EBS_FIN_PA_GINV_ORDER_LINE',
      p_sig_sql                => 'select *
from pa_igt_order_line
where order_id = (select order_id from pa_igt_order where order_number = ''##$$ORDER_NUMBER$$##'')
order by order_line_number
',
      p_title                  => 'Order Line Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no order line details for this order.',
      p_solution               => '',
      p_success_msg            => 'Order line details found for this order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_ORDER_LINE');



debug('begin add_signature: EBS_FIN_PA_GINV_ORDER_LINE_SCHED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23727',
      p_sig_id                 => 'EBS_FIN_PA_GINV_ORDER_LINE_SCHED',
      p_sig_sql                => 'select *
from pa_igt_order_line_sched
where order_id = (select order_id from pa_igt_order where order_number = ''##$$ORDER_NUMBER$$##'')
',
      p_title                  => 'Order Line Schedule Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no order line schedule details for the selected order.',
      p_solution               => '',
      p_success_msg            => 'Order line schedule details for the selected order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_ORDER_LINE_SCHED');



debug('begin add_signature: EBS_FIN_PA_GINV_PA_IGT_PERF_SETUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23789',
      p_sig_id                 => 'EBS_FIN_PA_GINV_PA_IGT_PERF_SETUP',
      p_sig_sql                => 'select * from  pa_igt_perf_setup where org_id = ##$$ORGID$$##  and ( project_id IS NULL or project_id =  (select  link_project_id from pa_igt_order where order_number = ''##$$ORDER_NUMBER$$##''))',
      p_title                  => 'Default Performance Setup',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Default performance setup does not exist.',
      p_solution               => '',
      p_success_msg            => 'Default performance setup exists.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_PA_IGT_PERF_SETUP');



debug('begin add_signature: EBS_FIN_PA_GINV_IGT_DOCUMENT_REQUESTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23730',
      p_sig_id                 => 'EBS_FIN_PA_GINV_IGT_DOCUMENT_REQUESTS',
      p_sig_sql                => 'select
IGT_REQUEST_ID,  
REQUEST_ID ,      
IGT_REQUEST_TYPE,             
...
IGT_LAST_PULL_DATE,               
IGT_URL,
IGT_ATTACH_DOCUMENT_ID ,         
INTERNAL_ATTACHMENT_ID ,            
PARENT_IGT_REQUEST_ID,              
SYSTEM_ID,                         
REQUEST_STATUS,  
RESPONSE_CODE,                
IGT_ERROR_DESC,                 
...
IGT_ORDER_ID,                    
IGT_PERFORMANCE_ID,             
IGT_PERFORMANCE_STATUS,           
IGT_DOCUMENT_STATUS,              
IGT_GROUP_ID             
from igt_document_requests
where org_id = ##$$ORGID$$##
and IGT_ORDER_ID =  ''##$$ORDER_NUMBER$$##''
order by creation_date desc',
      p_title                  => 'Push/Pull Requests For IGT Order Number',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Push/Pull document requests do not exist for the IGT order number.',
      p_solution               => '',
      p_success_msg            => 'Push/Pull document requests exist for the IGT order number.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_IGT_DOCUMENT_REQUESTS');



debug('begin add_signature: EBS_FIN_PA_GINV_PA_IGT_GTC_BASE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23799',
      p_sig_id                 => 'EBS_FIN_PA_GINV_PA_IGT_GTC_BASE',
      p_sig_sql                => 'select *
from pa_igt_gtc_base
where gtc_id = (select gtc_id 
from pa_igt_order
where order_number = ''##$$ORDER_NUMBER$$##'')
',
      p_title                  => 'GT&C Information Pulled',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are is no GT&C information pulled from the G-Invoicing system.
',
      p_solution               => '',
      p_success_msg            => 'GT&C information is pulled from the G-Invoicing system.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_PA_IGT_GTC_BASE');



debug('begin add_signature: EBS_FIN_PA_GINV_PA_IGT_GTC_VERSIONING');
   l_info('##MASK##%EMAIL_ADDRESS%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##%FAX_NUMBER%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##%FULL_NAME%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##%PHONE_NUMBER%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##RA_ROLES'):= 'DISPLAY_LAST_25_PCNT_WORD';
   l_info('##MASK##SA_ROLES'):= 'DISPLAY_LAST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23802',
      p_sig_id                 => 'EBS_FIN_PA_GINV_PA_IGT_GTC_VERSIONING',
      p_sig_sql                => 'select *
from pa_igt_gtc_versioning
where gtc_id = (select gtc_id 
from pa_igt_order
where order_number = ''##$$ORDER_NUMBER$$##'')',
      p_title                  => 'GT&C Versioning Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no GT&C versioning information that is pulled from the G-Invoicing system.
',
      p_solution               => '',
      p_success_msg            => 'GT&C versioning information that is pulled from G-Invoicing system.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_PA_IGT_GTC_VERSIONING');



debug('begin add_signature: EBS_FIN_PA_GINV_PROJ_GINV_PERF_HEADER');
   l_info('##MASK##PREP_BY_EMAIL'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PREP_BY_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PREP_BY_PHONE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23748',
      p_sig_id                 => 'EBS_FIN_PA_GINV_PROJ_GINV_PERF_HEADER',
      p_sig_sql                => 'select *
from pa_proj_ginv_perf_header
where project_id = (select  link_project_id from pa_igt_order where order_number = ''##$$ORDER_NUMBER$$##'')',
      p_title                  => 'Performance Header Record(s) for Order',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Performance header record(s) do not exist for the selected order.',
      p_solution               => '',
      p_success_msg            => 'Performance header record(s) exist for the order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_PROJ_GINV_PERF_HEADER');



debug('begin add_signature: EBS_FIN_PA_GINV_PROJ_GINV_PERF_DETAIL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23746',
      p_sig_id                 => 'EBS_FIN_PA_GINV_PROJ_GINV_PERF_DETAIL',
      p_sig_sql                => 'select *
from pa_proj_ginv_perf_detail
where project_id =  (select  link_project_id from pa_igt_order where order_number =  ''##$$ORDER_NUMBER$$##'')',
      p_title                  => 'Performance Detail for Order',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Performance details do not exist for the selected order.',
      p_solution               => '',
      p_success_msg            => 'Performance details exist for the selected order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_PROJ_GINV_PERF_DETAIL');



debug('begin add_signature: EBS_FIN_PA_GINV_PROJECTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23720',
      p_sig_id                 => 'EBS_FIN_PA_GINV_PROJECTS',
      p_sig_sql                => 'select *
from pa_projects_all
where project_id  =  (Select link_project_id from pa_igt_order where order_number =  ''##$$ORDER_NUMBER$$##'')',
      p_title                  => 'Project Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The project number(s) associated with the selected order is not valid.',
      p_solution               => '',
      p_success_msg            => 'Project details found for the selected order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_PROJECTS');



debug('begin add_signature: EBS_FIN_PA_GINV_PA_TASKS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26465',
      p_sig_id                 => 'EBS_FIN_PA_GINV_PA_TASKS',
      p_sig_sql                => 'select * 
from pa_tasks
where project_id = (select  link_project_id from pa_igt_order where order_number =  ''##$$ORDER_NUMBER$$##'')
order by task_id
...
',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No task details exist for the project associated with the order.',
      p_solution               => '',
      p_success_msg            => 'Task details exist for the project associated with the order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_PA_TASKS');



debug('begin add_signature: EBS_FIN_PA_GINV_PA_PROJ_ELEMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26462',
      p_sig_id                 => 'EBS_FIN_PA_GINV_PA_PROJ_ELEMENTS',
      p_sig_sql                => 'select * 
from pa_proj_elements 
where project_id =(select  link_project_id from pa_igt_order where order_number =  ''##$$ORDER_NUMBER$$##'')
order by PROJ_ELEMENT_ID',
      p_title                  => 'Workplan Task Details (PA_PROJ_ELEMENTS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Workplan tasks do not exists for the project linked to the order.',
      p_solution               => '',
      p_success_msg            => 'Workplan tasks exist for the project linked to the order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_PA_PROJ_ELEMENTS');



debug('begin add_signature: EBS_FIN_PA_GINV_PA_PROJ_ELEMENT_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26463',
      p_sig_id                 => 'EBS_FIN_PA_GINV_PA_PROJ_ELEMENT_VERSIONS',
      p_sig_sql                => 'select * 
from pa_proj_element_versions
where project_id =(select  link_project_id from pa_igt_order where order_number =  ''##$$ORDER_NUMBER$$##'')
order by ELEMENT_VERSION_ID
',
      p_title                  => 'Project Element Version Details (PA_PROJ_ELEMENT_VERSIONS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No versioned information related to workplan tasks and structures exist for the project associated with the order.',
      p_solution               => '',
      p_success_msg            => 'Versioned information related to workplan tasks and structures exists for the project associated with the order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_PA_PROJ_ELEMENT_VERSIONS');



debug('begin add_signature: EBS_FIN_PA_GINV_AGREEMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23728',
      p_sig_id                 => 'EBS_FIN_PA_GINV_AGREEMENTS',
      p_sig_sql                => 'Select * 
from pa_agreements_all 
where agreement_id in (Select link_agreement_id from pa_igt_order where order_number =  ''##$$ORDER_NUMBER$$##'')
',
      p_title                  => 'Agreement Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no agreement for the specified order.',
      p_solution               => '',
      p_success_msg            => 'Agreement details for the specified order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_AGREEMENTS');



debug('begin add_signature: EBS_FIN_PA_GINV_AGREEMENT_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23729',
      p_sig_id                 => 'EBS_FIN_PA_GINV_AGREEMENT_VERSIONS',
      p_sig_sql                => 'Select * 
from pa_agreement_versions 
where agreement_id in (Select link_agreement_id from pa_igt_order where order_number = ''##$$ORDER_NUMBER$$##'')
',
      p_title                  => 'Agreement Version Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Agreement version(s) do not exist for the specified order.',
      p_solution               => '',
      p_success_msg            => 'Agreement version(s) exist for the specified order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_AGREEMENT_VERSIONS');



debug('begin add_signature: EBS_FIN_PA_GINV_PA_AGREEMENT_ERP_EXT_B');
   l_info('##MASK##C_EXT_ATTR1'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##C_EXT_ATTR10'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##C_EXT_ATTR12'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##C_EXT_ATTR12'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##C_EXT_ATTR13'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##C_EXT_ATTR14'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##C_EXT_ATTR15'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##C_EXT_ATTR16'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##C_EXT_ATTR17'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##C_EXT_ATTR18'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##C_EXT_ATTR19'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##C_EXT_ATTR2'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##C_EXT_ATTR20'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##C_EXT_ATTR3'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##C_EXT_ATTR4'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##C_EXT_ATTR5'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##C_EXT_ATTR6'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##C_EXT_ATTR7'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##C_EXT_ATTR8'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##C_EXT_ATTR9'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26466',
      p_sig_id                 => 'EBS_FIN_PA_GINV_PA_AGREEMENT_ERP_EXT_B',
      p_sig_sql                => 'select * 
from pa_agreement_erp_ext_b 
where order_id = (select order_id from pa_igt_order where order_number = ''##$$ORDER_NUMBER$$##'')

',
      p_title                  => 'User-Defined Attribute Data (PA_AGREEMENT_ERP_EXT_B)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No user-defined attribute data exists for the specified order.',
      p_solution               => '',
      p_success_msg            => 'User-defined attribute data exists for the specified order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_PA_AGREEMENT_ERP_EXT_B');



debug('begin add_signature: EBS_FIN_PA_GINV_PA_PROJECT_FUNDINGS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23791',
      p_sig_id                 => 'EBS_FIN_PA_GINV_PA_PROJECT_FUNDINGS',
      p_sig_sql                => 'select * 
from pa_project_fundings
where agreement_id in (select link_agreement_id from pa_igt_order where order_number =  ''##$$ORDER_NUMBER$$##'')',
      p_title                  => 'Agreement Funds Allocated for the Order',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no agreement funds allocated for the order.',
      p_solution               => '',
      p_success_msg            => ' Agreement funds allocated for the order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_PA_PROJECT_FUNDINGS');



debug('begin add_signature: EBS_FIN_PA_GINV_PA_SUMMARY_PROJECT_FUNDINGS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23792',
      p_sig_id                 => 'EBS_FIN_PA_GINV_PA_SUMMARY_PROJECT_FUNDINGS',
      p_sig_sql                => 'select * 
from pa_summary_project_fundings
where agreement_id in (select link_agreement_id from pa_igt_order where order_number =  ''##$$ORDER_NUMBER$$##'')',
      p_title                  => 'Project Summary Funding Amounts',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No project summary funding amounts allocated for the order.',
      p_solution               => '',
      p_success_msg            => 'Project summary funding amounts allocated for the order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_PA_SUMMARY_PROJECT_FUNDINGS');



debug('begin add_signature: EBS_FIN_PA_GINV_DRAFT_REVENUES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23770',
      p_sig_id                 => 'EBS_FIN_PA_GINV_DRAFT_REVENUES',
      p_sig_sql                => 'select *
from pa_draft_revenues_all
where agreement_id =  (Select link_agreement_id from pa_igt_order where order_number =  ''##$$ORDER_NUMBER$$##'')',
      p_title                  => 'Draft Revenue for Order',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No draft revenue generated for the order.',
      p_solution               => '',
      p_success_msg            => 'Draft revenue generated for the order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_DRAFT_REVENUES');



debug('begin add_signature: EBS_FIN_PA_GINV_DRAFT_REVENUE_ITEMS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23773',
      p_sig_id                 => 'EBS_FIN_PA_GINV_DRAFT_REVENUE_ITEMS',
      p_sig_sql                => 'select i.*
from pa_draft_revenue_items i, pa_draft_revenues_all d
where d.project_id = i.project_id and d. draft_revenue_num = i.draft_revenue_num
and d.agreement_id = (Select link_agreement_id from pa_igt_order where order_number = ''##$$ORDER_NUMBER$$##'')',
      p_title                  => 'Draft Revenue Items for Order',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no draft revenue items for the order.',
      p_solution               => '',
      p_success_msg            => 'There are draft revenue items for the order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_DRAFT_REVENUE_ITEMS');



debug('begin add_signature: EBS_FIN_PA_GINV_PA_CUST_REV_DIST_LINES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23790',
      p_sig_id                 => 'EBS_FIN_PA_GINV_PA_CUST_REV_DIST_LINES_ALL',
      p_sig_sql                => 'select * 
from pa_cust_rev_dist_lines_all
where project_id  = (select  link_project_id from pa_igt_order where order_number = ''##$$ORDER_NUMBER$$##'')',
      p_title                  => 'Revenue Distributions of Expenditure Items',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No revenue distribution data exists for expenditure items.',
      p_solution               => '',
      p_success_msg            => 'Revenue distribution data exists for expenditure items.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_PA_CUST_REV_DIST_LINES_ALL');



debug('begin add_signature: EBS_FIN_PA_GINV_DRAFT_INVOICES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23721',
      p_sig_id                 => 'EBS_FIN_PA_GINV_DRAFT_INVOICES',
      p_sig_sql                => 'select *
from pa_draft_invoices_all
where agreement_id =  (Select link_agreement_id from pa_igt_order where order_number =  ''##$$ORDER_NUMBER$$##'')',
      p_title                  => 'Draft Invoice for Order',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No draft invoice generated for the order.',
      p_solution               => '',
      p_success_msg            => 'Draft invoice generated for the order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_DRAFT_INVOICES');



debug('begin add_signature: EBS_FIN_PA_GINV_DRAFT_INVOICE_ITEMS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23774',
      p_sig_id                 => 'EBS_FIN_PA_GINV_DRAFT_INVOICE_ITEMS',
      p_sig_sql                => 'select i.*
from pa_draft_invoice_items i, pa_draft_invoices_all d
where d.project_id = i.project_id and d. draft_invoice_num = i.draft_invoice_num
and d.agreement_id = (Select link_agreement_id from pa_igt_order where order_number = ''##$$ORDER_NUMBER$$##'')',
      p_title                  => 'Draft Invoice Items for Order',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no draft invoice items for the order.
',
      p_solution               => '',
      p_success_msg            => 'There are draft invoice items for the order.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_DRAFT_INVOICE_ITEMS');



debug('begin add_signature: EBS_FIN_PA_GINV_RA_INTERFACE_LINES_ALL');
   l_info('##MASK##INTERFACE_LINE_ATTRIBUTE5'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23793',
      p_sig_id                 => 'EBS_FIN_PA_GINV_RA_INTERFACE_LINES_ALL',
      p_sig_sql                => 'select * from ra_interface_lines_all
where  interface_line_attribute1 in (select p.segment1 
from pa_projects_all p, pa_summary_project_fundings spf, pa_igt_order pigt
where spf.agreement_id = pigt.link_agreement_id 
and spf.project_id = p.project_id
and order_number = ''##$$ORDER_NUMBER$$##'')',
      p_title                  => 'Receivable Interface Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no receivable interface lines related to the order.',
      p_solution               => '',
      p_success_msg            => 'Receivable interface lines related to the order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_RA_INTERFACE_LINES_ALL');



debug('begin add_signature: EBS_FIN_PA_GINV_RA_INTERFACE_DISTRIBUTIONS_ALL');
   l_info('##MASK##INTERFACE_LINE_ATTRIBUTE5'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23795',
      p_sig_id                 => 'EBS_FIN_PA_GINV_RA_INTERFACE_DISTRIBUTIONS_ALL',
      p_sig_sql                => 'select * from ra_interface_distributions_all
where  interface_line_attribute1 in (select p.segment1 
from pa_projects_all p, pa_summary_project_fundings spf, pa_igt_order pigt
where spf.agreement_id = pigt.link_agreement_id 
and spf.project_id = p.project_id
and order_number = ''##$$ORDER_NUMBER$$##'')',
      p_title                  => 'Receivable Interface Distributions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no Receivable interface distribution details related to the order.',
      p_solution               => '',
      p_success_msg            => 'Receivable interface distribution details related to the order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_RA_INTERFACE_DISTRIBUTIONS_ALL');



debug('begin add_signature: EBS_FIN_PA_GINV_AR_RECEIVABLE_APPLICATIONS_ALL');
   l_info('##MASK##%REASON'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23798',
      p_sig_id                 => 'EBS_FIN_PA_GINV_AR_RECEIVABLE_APPLICATIONS_ALL',
      p_sig_sql                => 'select app.*
from ar_receivable_applications_all app, 
pa_draft_invoices_all di,
pa_igt_order pigt,
pa_summary_project_fundings spf
where app.applied_customer_trx_id = di.system_reference
and di.project_id = spf.project_id
and spf.agreement_id = pigt.link_agreement_id 
and pigt.order_number = ''##$$ORDER_NUMBER$$##''',
      p_title                  => 'AR Cash and Credit Memo Applications',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no cash and credit memo applications related to the order.
',
      p_solution               => '',
      p_success_msg            => 'AR cash and credit memo applications related to the order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_AR_RECEIVABLE_APPLICATIONS_ALL');



debug('begin add_signature: EBS_FIN_PA_GINV_AR_CASH_RECEIPTS_ALL');
  ...
  add_signature(
      p_sig_repo_id            => '23797',
      p_sig_id                 => 'EBS_FIN_PA_GINV_AR_CASH_RECEIPTS_ALL',
      p_sig_sql                => 'select cash.*
from ar_receivable_applications_all app,
...
and spf.agreement_id = pigt.link_agreement_id 
and pigt.order_number = ''##$$ORDER_NUMBER$$##''',
      p_title                  => 'AR Cash Receipts',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no AR cash receipts related to the order.',
      p_solution               => '',
      p_success_msg            => 'AR cash receipts related to the order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_AR_CASH_RECEIPTS_ALL');



debug('begin add_signature: EBS_FIN_PA_GINV_DEFAULT_PREPARER');
   l_info('##MASK##EMAIL%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FULL_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '23328',
      p_sig_id                 => 'EBS_FIN_PA_GINV_DEFAULT_PREPARER',
      p_sig_sql                => 'SELECT p.segment1, 
ppf.full_name,
nvl(nvl(ppf.work_telephone, ppf.office_number), ''No Contact Number'') PHONE,
nvl(ppf.email_address, ''No Email Address'') EMAIL
FROM pa_project_parties ppp
  ,per_all_people_f       ppf
 , pa_projects_all p
WHERE ppp.project_id     = (select  link_project_id from pa_igt_order where link_project_id is not null 
       and order_number =  ''##$$ORDER_NUMBER$$##'')
  and p.project_id = ppp.project_id 
  AND ppp.project_role_id = (SELECT role_type_id 
                        FROM pa_igt_perf_setup  WHERE org_id = ##$$ORGID$$##
  ...
  AND TRUNC(SYSDATE) BETWEEN  ppf.effective_start_date AND NVL(ppf.effective_end_Date,trunc(sysdate))
  AND ( nvl(ppf.work_telephone, ppf.office_number) is not null
        AND ppf.email_address is not null)',
      p_title                  => 'Default Preparer Contact Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Default preparer does not have contact number and email address in HR.',
      p_solution               => 'Follow the instructions in [2879639.1] G-Invoicing - Request Full Advance Performance Gives Preparer Contact Error ',
      p_success_msg            => 'Default preparer has contact number and email address in HR.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_DEFAULT_PREPARER');



debug('begin add_signature: EBS_MFG_PO_GINV_IGT_DOCUMENT_REQUESTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27305',
      p_sig_id                 => 'EBS_MFG_PO_GINV_IGT_DOCUMENT_REQUESTS',
      p_sig_sql                => 'SELECT
    igt_request_id,
    request_id,
    igt_request_type,
    ...
    order_type,
    igt_gtc_number,
    igt_util.xmlclob(request_xml),
    igt_util.xmlclob(response_xml),
    igt_util.xmlclob(request_json),
    igt_util.xmlclob(response_json)
FROM
    igt_document_requests
WHERE
    internal_document_number = ''##$$DOCID$$##''
    OR igt_document_id LIKE ''##$$DOCID$$##''
    OR igt_performance_id IN (
        SELECT
            perf_number
        FROM
            po_igt_perf_header
        WHERE
            order_number LIKE ''##$$DOCID$$##''
    )
    OR igt_performance_id IN (
        SELECT
            ref_perf_number
    ...
    OR internal_document_number IN (
        SELECT
            internal_perf_id
        FROM
            po_igt_perf_header
      ...
      p_title                  => 'IGT_DOCUMENT REQUESTS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of IGT_DOCUMENT REQUESTS for IGT Order and Performances ',
      p_solution               => '',
      p_success_msg            => 'Extract of IGT_DOCUMENT REQUESTS',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_IGT_DOCUMENT_REQUESTS');



debug('begin add_signature: EBS_MFG_PO_GINV_IGT_DOC_REQ_XML');
   l_info('##MASK##1))'):= 'NO_MASK';
   l_info('##MASK##2000'):= 'NO_MASK';
   l_info('##MASK##UTL_RAW.CAST_TO_VARCHAR2(DBMS_LOB.SUBSTR(REQUEST_XML'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29076',
      p_sig_id                 => 'EBS_MFG_PO_GINV_IGT_DOC_REQ_XML',
      p_sig_sql                => 'select IGT_REQUEST_ID,REQUEST_ID,IGT_REQUEST_TYPE,IGT_REQUEST_MODE,ORG_ID,                                 
AGENCY_LOCATION_CODE,IGT_DOCUMENT_ID,INTERNAL_DOCUMENT_NUMBER,INTERNAL_DOCUMENT_ID,INTERNAL_DOCUMENT_STATUS,IGT_LAST_PULL_DATE,
IGT_URL,IGT_ATTACH_DOCUMENT_ID,INTERNAL_ATTACHMENT_ID,PARENT_IGT_REQUEST_ID,SYSTEM_ID,REQUEST_STATUS,RESPONSE_CODE,IGT_ERROR_DESC,
IGT_ERROR_TITLE,AGENCY,PROCESS_ERRORED_REQUESTS,ATTACH_FILENAME,IGT_ATTACH_FILENAME,IGT_ATTACH_EXTENSION,CREATION_DATE,CREATED_BY,
LAST_UPDATE_DATE,LAST_UPDATED_BY,LAST_UPDATE_LOGIN,IGT_ORDER_ID,IGT_PERFORMANCE_ID,IGT_PERFORMANCE_STATUS,IGT_DOCUMENT_STATUS,
IGT_GROUP_ID,ORDER_TYPE,IGT_GTC_NUMBER,
REGEXP_REPLACE(
  REGEXP_REPLACE(
    REGEXP_REPLACE(
      REGEXP_REPLACE(
        REGEXP_REPLACE(
          REGEXP_REPLACE( UTL_RAW.CAST_TO_VARCHAR2(DBMS_LOB.SUBSTR(request_xml, 2000, 1)) , ''(.*?)(<ns0:)'', ''\1<''),
        ''(.*?)(</ns0:)'', ''\1</''),
      ''(.*?<EmailAddressText>)(.*?)(<.*)'', ''\1*******\3''),
    ''(.*?<FullName>)(.*?)(<.*)'', ''\1*******\3''),
  ''(.*?<PhoneNumber>)(.*?)(<.*)'', ''\1*******\3''),
''(.*?)(\w{1,15})(@)(\w{1,15}(.*))'', ''\1*****\3*****\5'')  AS request_xml
from  igt_document_requests 
where internal_document_number = ''##$$DOCID$$##''',
      p_title                  => 'IGT_DOCUMENT Request XML',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of IGT_DOCUMENT Request XML',
      p_solution               => '',
      p_success_msg            => 'Extract of IGT_DOCUMENT Request XML',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_IGT_DOC_REQ_XML');



debug('begin add_signature: EBS_MFG_PO_GINV_IGT_DOC_RESP_XML');
   l_info('##MASK##1 ))'):= 'NO_MASK';
   l_info('##MASK##2000'):= 'NO_MASK';
   l_info('##MASK##UTL_RAW.CAST_TO_VARCHAR2( DBMS_LOB.SUBSTR( RESPONSE_XML'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29077',
      p_sig_id                 => 'EBS_MFG_PO_GINV_IGT_DOC_RESP_XML',
      p_sig_sql                => 'select IGT_REQUEST_ID,REQUEST_ID,IGT_REQUEST_TYPE,IGT_REQUEST_MODE,ORG_ID,                                 
AGENCY_LOCATION_CODE,IGT_DOCUMENT_ID,INTERNAL_DOCUMENT_NUMBER,INTERNAL_DOCUMENT_ID,INTERNAL_DOCUMENT_STATUS,IGT_LAST_PULL_DATE,
IGT_URL,IGT_ATTACH_DOCUMENT_ID,INTERNAL_ATTACHMENT_ID,PARENT_IGT_REQUEST_ID,SYSTEM_ID,REQUEST_STATUS,RESPONSE_CODE,IGT_ERROR_DESC,
IGT_ERROR_TITLE,AGENCY,PROCESS_ERRORED_REQUESTS,ATTACH_FILENAME,IGT_ATTACH_FILENAME,IGT_ATTACH_EXTENSION,CREATION_DATE,CREATED_BY,
...
REGEXP_REPLACE(
  REGEXP_REPLACE(
    REGEXP_REPLACE(
      REGEXP_REPLACE(
        REGEXP_REPLACE(
          REGEXP_REPLACE( UTL_RAW.CAST_TO_VARCHAR2(DBMS_LOB.SUBSTR(response_xml, 2000, 1)) , ''(.*?)(<ns0:)'', ''\1<''),
        ''(.*?)(</ns0:)'', ''\1</''),
      ''(.*?<EmailAddressText>)(.*?)(<.*)'', ''\1*******\3''),
    ''(.*?<FullName>)(.*?)(<.*)'', ''\1*******\3''), 
  ''(.*?<PhoneNumber>)(.*?)(<.*)'', ''\1*******\3''),
''(.*?)(\w{1,15})(@)(\w{1,15}(.*))'', ''\1*****\3*****\5'')  AS response_xml
from  igt_document_requests 
where internal_document_number = ''##$$DOCID$$##''',
      p_title                  => 'IGT_DOCUMENT Response XML',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of IGT_DOCUMENT Response XML',
      p_solution               => '',
      p_success_msg            => 'Extract of IGT_DOCUMENT Response XML',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_IGT_DOC_RESP_XML');



debug('begin add_signature: EBS_MFG_PO_GINV_PO_IGT_PERF_HDR');
   l_info('##MASK##PERF_AUTH_EMAIL'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PERF_AUTH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PERF_AUTH_PHONE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PREPARER_EMAIL'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PREPARER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PREPARER_PHONE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31502',
      p_sig_id                 => 'EBS_MFG_PO_GINV_PO_IGT_PERF_HDR',
      p_sig_sql                => 'SELECT
INTERNAL_PERF_ID,
PERF_NUMBER,
REF_PERF_NUMBER,
ORDER_NUMBER,
INTERNAL_PERF_NUMBER,
PERF_ORIG_DATE,
PERF_TRANSACTION_DATE,
PERF_ACCOUNTING_PERIOD,
COMMENTS,
PREPARER_NAME,
PREPARER_PHONE,
PREPARER_EMAIL,
...
WHERE
    po_header_id =##$$DOCID$$##',
      p_title                  => 'PO_IGT_PERF_HEADER for IGT Order',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Extract of PO_IGT_PERF_HEADER Table.',
      p_solution               => '',
      p_success_msg            => 'Extract of PO_IGT_PERF_HEADER Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_PO_IGT_PERF_HDR');



debug('begin add_signature: EBS_MFG_PO_GINV_PO_IGT_PERF_HEADER');
   l_info('##MASK##PERF_AUTH_EMAIL'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PERF_AUTH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PERF_AUTH_PHONE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PREPARER_EMAIL'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PREPARER_NAME'):= 'DISPLAY_LAST_25_PCNT_WORD';
   l_info('##MASK##PREPARER_PHONE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28074',
      p_sig_id                 => 'EBS_MFG_PO_GINV_PO_IGT_PERF_HEADER',
      p_sig_sql                => 'SELECT
INTERNAL_PERF_ID,
PERF_NUMBER,
REF_PERF_NUMBER,
...
WHERE
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_PO_IGT_PERF_HEADER');



debug('begin add_signature: EBS_MFG_PO_GINV_CLM_SETUP_ENABLED_PROFILE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23815',
      p_sig_id                 => 'EBS_MFG_PO_GINV_CLM_SETUP_ENABLED_PROFILE_CHECK',
      p_sig_sql                => 'SELECT fpo.profile_option_id prof_option_id,
       SUBSTR (fpot.user_profile_option_name, 0, 120) profile_name,
       SUBSTR (fpov.profile_option_value, 0, 450) VALUE,
           DECODE (fpov.level_id,
               10001, ''Site'',
               10002, ''Application'',
  ...
  FROM fnd_profile_options_tl fpot,
       ...
       fnd_responsibility_tl frt,
       fnd_user fu
 WHERE fpot.user_profile_option_name like ''%PO%CLM%''
   AND fpo.profile_option_name = fpot.profile_option_name
   AND fpov.profile_option_id = fpo.profile_option_id
   AND fa.application_id = fpov.application_id
   AND fpov.level_value = fa2.application_id(+)
  ...
  FROM fnd_profile_options_tl fpot,
       ...
       fnd_responsibility_tl frt,
       fnd_user fu
 WHERE fpot.user_profile_option_name like ''%FND%Industry%''
   AND fpo.profile_option_name = fpot.profile_option_name
   AND fpov.profile_option_id = fpo.profile_option_id
   AND fa.application_id = fpov.application_id
   AND fpov.level_value = fa2.application_id(+)
   ...
   AND fpov.level_id in (10001,10003)
   AND fpot.language = ''US''',
      p_title                  => 'Requesting Profile: CLM Install and Enabled',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Oracle Contract Lifecycle Management (CLM) not enabled in this Operating Unit. ',
      p_solution               => '<p>The Profile option(s) for CLM Install and Enabled have not been enabled in this Operating Unit.  This profile is only applicable if Oracle Contract Lifecycle Management is being used.</p><p>Review [2712555.1#CLM_PROFILE] CLM Setup and CLM Profile Setups for Oracle Purchasing and Oracle Contract Lifecycle Management for Public Sector.</p> ',
      p_success_msg            => 'CLM  profiles to enable the Contract Lifecyle Management application are setup.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_PO_GINV_CLM_SETUP_ENABLED_PROFILE_CHECK');



debug('begin add_signature: EBS_FIN_PA_GINV_AUTO_AGREEMENT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23901',
      p_sig_id                 => 'EBS_FIN_PA_GINV_AUTO_AGREEMENT',
      p_sig_sql                => ' SELECT fpo.profile_option_id prof_option_id,
       SUBSTR (fpot.user_profile_option_name, 0, 120) profile_name,
       SUBSTR (fpov.profile_option_value, 0, 450) VALUE,
           DECODE (fpov.level_id,
  ...
  FROM fnd_profile_options_tl fpot,
       ...
       fnd_responsibility_tl frt,
       fnd_user fu
 WHERE fpot.user_profile_option_name = ''G-Invoicing Create Auto Agreement''
   AND fpo.profile_option_name = fpot.profile_option_name
   AND fpov.profile_option_id = fpo.profile_option_id
   AND fa.application_id = fpov.application_id
   AND fpov.level_value = fa2.application_id(+)
 ...
 WHERE fpot.user_profile_option_name = ''G-Invoicing Create Auto Agreement''
   ...
   AND fpov.level_id in (10001,10003)
   AND fpot.language = ''US''',
      p_title                  => 'Servicing Profile G-Invoicing Create Auto Agreement',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Profile option G-Invoicing Create Auto Agreement is not setup.',
      p_solution               => '<ul> <li>Review the following manual, Oracle E-Business Suite G-Invoicing Process Guide, Chapter 3, G-Invoicing Setup and Administration: Servicing Agency</li> <li>[2919734.1] - Where Are The G-Invoicing Manuals Available? </li> </ul> ',
      p_success_msg            => 'Profile option G-Invoicing Create Auto Agreement is setup.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_AUTO_AGREEMENT');



debug('begin add_signature: EBS_FIN_PA_GINV_IGT_CONFIRM_FUNDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23900',
      p_sig_id                 => 'EBS_FIN_PA_GINV_IGT_CONFIRM_FUNDS',
      p_sig_sql                => 'SELECT fpo.profile_option_id prof_option_id,
       SUBSTR (fpot.user_profile_option_name, 0, 120) profile_name,
       SUBSTR (fpov.profile_option_value, 0, 450) VALUE,
           DECODE (fpov.level_id,
  ...
  FROM fnd_profile_options_tl fpot,
       ...
       fnd_responsibility_tl frt,
       fnd_user fu
 WHERE fpot.user_profile_option_name = ''G-Invoicing Confirm Funds Availability upon Revenue Budget Baseline''
   AND fpo.profile_option_name = fpot.profile_option_name
   AND fpov.profile_option_id = fpo.profile_option_id
   AND fa.application_id = fpov.application_id
   AND fpov.level_value = fa2.application_id(+)
 ...
 WHERE fpot.user_profile_option_name = ''G-Invoicing Confirm Funds Availability upon Revenue Budget Baseline''
   ...
   AND fpov.level_id in (10001,10003)
   AND fpot.language = ''US''',
      p_title                  => 'Servicing Profile G-Invoicing Confirm Funds Availability Upon Revenue Budget Baseline',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Profile G-Invoicing Confirm Funds Availability upon Revenue Budget Baseline  does not have any value assigned.',
      p_solution               => '<ul> <li>Review the following manual, Oracle E-Business Suite G-Invoicing Process Guide, Chapter 6, Using G-Invoicing: Servicing Agency.  [2919734.1] - Where Are The G-Invoicing Manuals Available?" </li> </ul> ',
      p_success_msg            => 'Profile G-Invoicing Confirm Funds Availability upon Revenue Budget Baseline has a value assigned.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_IGT_CONFIRM_FUNDS');



debug('begin add_signature: EBS_FIN_PA_GINV_MANAGE_REV_BUDGET_MANUALLY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23899',
      p_sig_id                 => 'EBS_FIN_PA_GINV_MANAGE_REV_BUDGET_MANUALLY',
      p_sig_sql                => 'SELECT fpo.profile_option_id prof_option_id,
       SUBSTR (fpot.user_profile_option_name, 0, 120) profile_name,
       SUBSTR (fpov.profile_option_value, 0, 450) VALUE,
           DECODE (fpov.level_id,
  ...
  FROM fnd_profile_options_tl fpot,
       ...
       fnd_responsibility_tl frt,
       fnd_user fu
 WHERE fpot.user_profile_option_name = ''PA: Manage Revenue Budget Manually''
   AND fpo.profile_option_name = fpot.profile_option_name
   AND fpov.profile_option_id = fpo.profile_option_id
   AND fa.application_id = fpov.application_id
   AND fpov.level_value = fa2.application_id(+)
 ...
 WHERE fpot.user_profile_option_name = ''PA: Manage Revenue Budget Manually''
   ...
   AND fpov.level_id in (10001,10003)
   AND fpot.language = ''US''',
      p_title                  => 'Servicing Profile PA: Manage Revenue Budget Manually',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Profile PA: Manage Revenue Budget Manually does not have a value assigned at any level.',
      p_solution               => 'Review the solution in [3041324.1] G-Invoicing - A Baselined Revenue Budget of Entry Method different than Revenue Budget Entry Method Defined at Project Type Level is Created After Approving Agreement and Confirming Fundings ECC dashboard',
      p_success_msg            => 'Profile PA: Manage Revenue Budget Manually is setup.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GINV_MANAGE_REV_BUDGET_MANUALLY');
...
BEGIN
  ...
  analyzer_title := 'EBS G-Invoicing Analyzer';
  analyzer_title := regexp_replace('EBS ' || analyzer_title, '(\S+\s)\1', '\1', 1, 0, 'i');  -- EBSAF-243

  l_step := '15';
   validate_parameters(
     p_org_id                       => p_org_id
    ,p_igt_gtnc_number              => p_igt_gtnc_number
    ,p_igt_document_number          => p_igt_document_number
    ,p_clm_document_number          => p_clm_document_number
...
debug('begin section: GINV_CUMULATIVE_PATCHES');
IF ((substr(g_rep_info('Apps Version'),1,6) >= '12.2.7') OR
    (substr(g_rep_info('Apps Version'),1,7) >= '12.2.10')) THEN
   start_section('Recommended Patches', 'GINV_CUMULATIVE_PATCHES');
      set_item_result(check_rec_patches_1); /* Signature EBS_MFG_PO_GINV_CUMULATIVE_UPDATES */
      set_item_result(check_rec_patches_2); /* Signature EBS_FIN_PA_GINV_SERVICING_CU_PATCHES */
   end_section;
END IF;
debug('end section: GINV_CUMULATIVE_PATCHES');

debug('begin section: PROFILE_OPTIONS');
start_section('Profile Options', 'PROFILE_OPTIONS');
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_SETUP_PROFILE_OPTIONS'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_MO_OPERATING_UNIT'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_FV_FEDERAL_ENABLED'));
   IF p_org_id IS NOT NULL THEN
      set_item_result(run_stored_sig('EBS_MFG_PO_GINV_CLM_SETUP_ENABLED_PROFILE_CHECK'));
   END IF;
   IF p_org_id IS NOT NULL THEN
      set_item_result(run_stored_sig('EBS_FIN_PA_GINV_AUTO_AGREEMENT'));
      set_item_result(run_stored_sig('EBS_FIN_PA_GINV_IGT_CONFIRM_FUNDS'));
      set_item_result(run_stored_sig('EBS_FIN_PA_GINV_MANAGE_REV_BUDGET_MANUALLY'));
   END IF;
end_section;
debug('end section: PROFILE_OPTIONS');

debug('begin section: REQUESTING_SETUP');
start_section('Requesting Setup', 'REQUESTING_SETUP');
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_IGT_FLAG_NOT_ENABLED'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_CLM_FLAG_NOT_ENABLED'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_ATTRIBUTE_TEMPLATE_NOT_COMPILED'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_IGT_DEFAULT_STYLE_ID_NOT_SETUP'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_BUYER_SETUP_OPTIONS'));
   set_item_result(run_stored_sig('PURCHASING_OPTIONS_SETUP_12_2'));
end_section;
debug('end section: REQUESTING_SETUP');

debug('begin section: REQUESTING_DATA');
start_section('Requesting Data', 'REQUESTING_DATA');
   set_item_result(run_stored_sig('PO - PO_HEADERS_ALL'));
   set_item_result(run_stored_sig('PO - PO_LINES_ALL'));
   set_item_result(run_stored_sig('PO - PO_LINE_LOCATIONS_ALL'));
   set_item_result(run_stored_sig('PO - PO_DISTRIBUTIONS_ALL'));
   set_item_result(run_stored_sig('PO - PO_ACTION_HISTORY'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_PO_HEADERS_ALL_EXT_B'));
   set_item_result(run_stored_sig('EBS_MFG_GINV_EXTRACT_OF_PO_LINES_ALL_EXT_B'));
   set_item_result(run_stored_sig('EBS_MFG_GINV_PO_LINE_LOCATIONS_ALL_EXT_B'));
   set_item_result(run_stored_sig('EBS_MFG_GINV_PO_DISTRIBUTIONS_ALL_EXT_B'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_PO_HEADERS_ALL_EXT_TL'));
   set_item_result(run_stored_sig('EBS_MFG_GINV_PO_LINES_ALL_EXT_TL'));
   set_item_result(run_stored_sig('EBS_MFG_GINV_PO_LINE_LOCATIONS_ALL_EXT_TL'));
   set_item_result(run_stored_sig('EBS_MFG_GINV_PO_DISTRIBUTIONS_ALL_EXT_TL'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_PO_DRAFTS'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_PO_LINES_DRAFTS_ALL'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_PO_LINE_LOCATIONS_DRAFT_ALL'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_PO_DISTRIBUTIONS_DRAFT_ALL'));
   set_item_result(run_stored_sig('PO - PO_HEADERS_ARCHIVE_ALL'));
   set_item_result(run_stored_sig('PO - PO_LINES_ARCHIVE_ALL'));
   set_item_result(run_stored_sig('PO - PO_LINE_LOCATIONS_ARCHIVE_ALL'));
   set_item_result(run_stored_sig('PO - PO_DISTRIBUTIONS_ARCHIVE_ALL'));
   set_item_result(run_stored_sig('EBS_MFG_GINV_PO_HEADERS_ALL_CLM_SOURCE_DOCUMENT_ID'));
   IF g_igt_gtc_number = 'Column not available' THEN
      set_item_result(run_stored_sig('EBS_MFG_PO_GINV_IGT_DOCUMENT_REQUESTS'));
      set_item_result(run_stored_sig('EBS_MFG_PO_GINV_IGT_DOC_REQ_XML'));
      set_item_result(run_stored_sig('EBS_MFG_PO_GINV_IGT_DOC_RESP_XML'));
   END IF;
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_FND_LOG_IGT_DOCUMENT_REQUEST'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_IGT_IMPORT_WF_NOTIF'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_IGT_MOD_PO_ACTION_HISTORY'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_IGT_ORDER_PO_BC_DISTRIBUTIONS'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_IGT_ORDER_XLA_EVENTS'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_IGT_ORDER_XLA_AE_HEADERS'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_IGT_ORDER_XLA_AE_LINES'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_IGT_ORDER_XLA_DIST_LINKS'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_IGT_ORDER_XLA_TXN_ENTITIES_UPG'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_IGT_ORDER_PSA_XLA_ACCOUNTING_ERRORS'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_IGT_REQ_HEADERS'));
   set_item_result(run_stored_sig('EBS_MFG_PO_IGT_REQ_LINES'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_IGT_REQ_DISTRIBUTIONS'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_IGT_REQ_PO_BC_DISTRIBUTIONS'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_IGT_REQ_XLA_EVENTS'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_IGT_REQ_XLA_AE_LINES'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_IGT_REQ_XLA_TRANSACTION_ENTITIES_UPG'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_PO_IGT_PERF_DETAIL'));
   IF  g_igtperfh_reqtxnid = 'Column not available' THEN
      set_item_result(run_stored_sig('EBS_MFG_PO_GINV_PO_IGT_PERF_HDR'));
   END IF;
   IF g_igtperfh_reqtxnid = 'Column available' THEN
      set_item_result(run_stored_sig('EBS_MFG_PO_GINV_PO_IGT_PERF_HEADER'));
   END IF;
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_PO_IGT_PERF_TRANS_HISTORY'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_IGT_ORDER_AP_INVOICES_INTERFACE'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_IGT_ORDER_AP_INVOICE_LINES_INTERFACE'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_IGT_ORDER_AP_INTERFACE_REJECTIONS'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_IGT_ORDER_AP_INVOICES_ALL'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_IGT_ORDER_AP_INVOICE_LINES_ALL'));
   set_item_result(run_stored_sig('EBS_MFG_PO_GINV_IGT_ORDER_AP_INVOICE_DISTRIBUTIONS_ALL'));
end_section;
debug('end section: REQUESTING_DATA');

debug('begin section: SERVICING_SETUP');
start_section('Servicing Setup', 'SERVICING_SETUP');
   set_item_result(run_stored_sig('EBS_FIN_PA_GINV_PA_IMPLEMENTATION_OPTIONS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_GINV_ADJ_ON_STD_INV'));
   set_item_result(run_stored_sig('EBS_FIN_PA_GINV_IMPL_OPTION_NO_AGREEMENT_TYPE'));
   set_item_result(run_stored_sig('EBS_FIN_PA_GINV_NO_AGREEMENT_TYPES'));
   set_item_result(run_stored_sig('EBS_FIN_PA_GINV_FV_TREASURY_SYMBOLS_SOB'));
   set_item_result(run_stored_sig('EBS_FIN_PA_GINV_FV_TREASURY_SYMBOLS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_GINV_FV_FACTS_FEDERAL_ACCOUNTS'));
   IF p_order_number is not null THEN
      set_item_result(run_stored_sig('EBS_FIN_PA_GINV_DEFAULT_PREPARER'));
   END IF;
end_section;
debug('end section: SERVICING_SETUP');

debug('begin section: SERVICING_DATA');
start_section('Servicing Data', 'SERVICING_DATA');
   set_item_result(run_stored_sig('EBS_FIN_PA_GINV_ORDER'));
   set_item_result(run_stored_sig('EBS_FIN_PA_GINV_FV_TP_TREASURY_SYMBOLS'));
   IF p_order_number is not null THEN
      set_item_result(run_stored_sig('EBS_FIN_PA_GINV_ORDER_LINE'));
      set_item_result(run_stored_sig('EBS_FIN_PA_GINV_ORDER_LINE_SCHED'));
      set_item_result(run_stored_sig('EBS_FIN_PA_GINV_PA_IGT_PERF_SETUP'));
      set_item_result(run_stored_sig('EBS_FIN_PA_GINV_IGT_DOCUMENT_REQUESTS'));
      set_item_result(run_stored_sig('EBS_FIN_PA_GINV_PA_IGT_GTC_BASE'));
      set_item_result(run_stored_sig('EBS_FIN_PA_GINV_PA_IGT_GTC_VERSIONING'));
      set_item_result(run_stored_sig('EBS_FIN_PA_GINV_PROJ_GINV_PERF_HEADER'));
      set_item_result(run_stored_sig('EBS_FIN_PA_GINV_PROJ_GINV_PERF_DETAIL'));
      set_item_result(run_stored_sig('EBS_FIN_PA_GINV_PROJECTS'));
      set_item_result(run_stored_sig('EBS_FIN_PA_GINV_PA_TASKS'));
      set_item_result(run_stored_sig('EBS_FIN_PA_GINV_PA_PROJ_ELEMENTS'));
      set_item_result(run_stored_sig('EBS_FIN_PA_GINV_PA_PROJ_ELEMENT_VERSIONS'));
      set_item_result(run_stored_sig('EBS_FIN_PA_GINV_AGREEMENTS'));
      set_item_result(run_stored_sig('EBS_FIN_PA_GINV_AGREEMENT_VERSIONS'));
      set_item_result(run_stored_sig('EBS_FIN_PA_GINV_PA_AGREEMENT_ERP_EXT_B'));
      set_item_result(run_stored_sig('EBS_FIN_PA_GINV_PA_PROJECT_FUNDINGS'));
      set_item_result(run_stored_sig('EBS_FIN_PA_GINV_PA_SUMMARY_PROJECT_FUNDINGS'));
      set_item_result(run_stored_sig('EBS_FIN_PA_GINV_DRAFT_REVENUES'));
      set_item_result(run_stored_sig('EBS_FIN_PA_GINV_DRAFT_REVENUE_ITEMS'));
      set_item_result(run_stored_sig('EBS_FIN_PA_GINV_PA_CUST_REV_DIST_LINES_ALL'));
      set_item_result(run_stored_sig('EBS_FIN_PA_GINV_DRAFT_INVOICES'));
      set_item_result(run_stored_sig('EBS_FIN_PA_GINV_DRAFT_INVOICE_ITEMS'));
      set_item_result(run_stored_sig('EBS_FIN_PA_GINV_RA_INTERFACE_LINES_ALL'));
      set_item_result(run_stored_sig('EBS_FIN_PA_GINV_RA_INTERFACE_DISTRIBUTIONS_ALL'));
      set_item_result(run_stored_sig('EBS_FIN_PA_GINV_AR_RECEIVABLE_APPLICATIONS_ALL'));
      set_item_result(run_stored_sig('EBS_FIN_PA_GINV_AR_CASH_RECEIPTS_ALL'));
   END IF;
end_section;
debug('end section: SERVICING_DATA');
...
IF g_sql_tokens('##$$APPS_CHECK$$##') = 'Y' THEN
   start_section('Diagnostic Apps Check', 'Diagnostic_Apps_Check');
      set_item_result(run_stored_sig('EBS_FIN_PA_GINV_GINV_AC_FILE_VERSIONS'));
      ...
      set_item_result(run_stored_sig('EBS_FIN_ECC_VERSION'));
...
start_section('Critical Alert', 'LifetimeSupportPolicy');
