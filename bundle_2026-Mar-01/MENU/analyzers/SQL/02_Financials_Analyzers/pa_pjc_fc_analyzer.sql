...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Projects Funds Check Analyzer          |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE pa_pjc_fc_analyzer_pkg AUTHID DEFINER AS
...
(            p_project_id                   IN NUMBER      DEFAULT NULL
           ,p_project_id_sql               IN NUMBER      DEFAULT NULL
           ,p_task_id                      IN NUMBER      DEFAULT NULL
           ,p_task_id_sql                  IN NUMBER      DEFAULT NULL
...
FUNCTION corr_docs2 (
  ...
  p_bc_amt      IN NUMBER) RETURN NUMBER;
...
FUNCTION corr_docs3 (
  ...
  p_enc_amt     IN NUMBER,
  p_qty_ordered IN NUMBER,
  p_qty_billed  IN NUMBER) RETURN NUMBER;
...
END pa_pjc_fc_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY pa_pjc_fc_analyzer_pkg AS
-- $Id: pa_pjc_fc_analyzer.sql, 200.33 2026/02/25 21:46:13 aliclin Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2231479.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'PA_PJC_FC_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'PA_PJC_FC_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>PA_PJC_FC Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2231479.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/pa_pjc_fc_latest_ver.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,953,EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,953,EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},953,EBS,EBS Financials,EBS - Projects" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4071222" class="blacklink" target="new">
...
<p><strong>Version 200.33</strong></p><ul><li>Sigs updated for article ID changes.</li>
</ul>
<p><strong>Version 200.32</strong></p><ul><li>Template enhancement: EBS KB Article IDs Shown for Signature KM Links.</li>
<li>Sigs updated for article ID changes.</li>
</ul>
<p><strong>Version 200.31</strong></p><ul><li>Template and AC_TABLE_INDEXES modified.</li>
</ul>
<p><strong>Version 200.30</strong></p><ul><li>Max Sequence signatures modified.</li>
</ul>
<p><strong>Version 200.29</strong></p><ul><li>Several signatures modified.</li>
</ul>
<p><strong>Version 200.28</strong></p><ol><li>New Analyzer Framework version 4.7.3 released with enhancements.<ol><li>SQL*Plus Error fixed: SP2-0027: Input is too long</li>
<li>Ability to click to select rows in output tables</li>
</ol>
</li>
<li>Several signatures enhanced.</li>
</ol>
<p><strong>Version 200.27</strong></p><ul><li>Several patches added to “Recommended Patches” section.</li>
</ul>
<p><strong>Version 200.26</strong></p><ul><li>Several signatures modified</li>
</ul>
<p><strong>Version 200.25</strong></p><ul><li>For "Critical Alerts" section, the following 2 new signatures were updated to check for Oracle Database 12c/11g version:<ul><li>Sequences with 32-bit maximum value and large cache size</li>
<li>Sequences above 70 percent of maximum value</li>
</ul>
</li>
</ul>
<p><strong>Version 200.24</strong></p><ul><li>"Lifetime Support Policy" section renamed to "Critical Alerts" and the following 2 new signatures have been added:<ul><li>Sequences with 32-bit maximum value and large cache size</li>
<li>Sequences above 70 percent of maximum value</li>
</ul>
</li>
</ul>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,953,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,953,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},953,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Projects" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
FUNCTION corr_docs3 (
  ...
  p_enc_amt     IN NUMBER,
  p_qty_ordered IN NUMBER,
  p_qty_billed  IN NUMBER) RETURN NUMBER IS
...
BEGIN
  ...
  SELECT sum(nvl(accounted_dr,0) - nvl(accounted_cr,0)) INTO l_bc_amt
  FROM pa_bc_commitments_all
  WHERE document_header_id = p_doc_hdr_id
  AND   document_distribution_id = p_doc_dist_id
  AND   document_type = 'PO'
  AND   project_id = p_project_id;

  /* AGL moved nvl inside sum */
  SELECT sum(nvl(cdl.acct_raw_cost,0)) INTO l_cdl_amt
  FROM pa_cost_distribution_lines_all cdl,
       pa_expenditure_items_all ei
  WHERE ei.expenditure_item_id = cdl.expenditure_item_id
  AND   ei.transaction_source IN ('AP INVOICE','AP NRTAX',
           'AP ERV', 'AP EXPENSE','AP VARIANCE')
  AND   cdl.line_num = 1
  AND   (ei.document_header_id, ei.document_distribution_id) IN (
          SELECT invoice_id, invoice_distribution_id
          FROM ap_invoice_distributions_all
          WHERE po_distribution_id = p_doc_dist_id
          AND   pa_addition_flag IN ('Y'));

  SELECT sum(nvl(base_invoice_price_variance,0) + nvl(exchange_rate_variance,0))
  INTO l_var_amount_interfaced
  FROM ap_invoice_distributions_all
  WHERE po_distribution_id = p_doc_dist_id
  AND   pa_addition_flag = 'Y';

  IF (nvl(p_enc_amt,0) < l_cdl_amt OR p_qty_ordered = p_qty_billed) THEN
    l_amount_tobe_relieved := nvl(l_bc_amt,0);
  ELSE
    l_amount_tobe_relieved := nvl(l_bc_amt,0) -
      (nvl(p_enc_amt,0) - l_cdl_amt + l_var_amount_interfaced);
  END IF;
...
FUNCTION corr_docs4 (
  ...
  CURSOR enc_amount(prj_id NUMBER, header_id NUMBER, dist_id NUMBER) IS
    SELECT prd.encumbered_amount,
    ...
    AND   pod.project_id = prd.project_id
    AND   prd.project_id = prj_id
    AND   requisition_header_id = header_id
    AND   prd.distribution_id = dist_id
    GROUP BY distribution_id, prd.encumbered_amount;


  l_po_enc               NUMBER := 0;
  l_req_enc              NUMBER := 0;
  l_total_enc            NUMBER := 0;
  l_amount_tobe_relieved NUMBER := 0;

BEGIN
  OPEN enc_amount(p_project_id, p_doc_hdr_id, p_doc_dist_id);
  FETCH enc_amount INTO l_req_enc, l_po_enc;
  CLOSE enc_amount;

  IF (l_req_enc <> 0 AND l_po_enc <= l_req_enc) THEN
    l_total_enc := nvl(l_req_enc,0) - nvl(l_po_enc,0);
  END IF ;

  l_amount_tobe_relieved  := p_bc_amt - l_total_enc;
...
BEGIN
  ...
  WHERE project_id = nvl(p_project_id,p_project_id_sql);
...
debug('begin populate parameters hash table');
   ...
   IF NOT g_is_concurrent THEN 
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Project_ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_project_id_sql,'NO_MASK');
   END IF;
   IF g_is_concurrent THEN 
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Task ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_task_id,'NO_MASK');
   END IF;
   IF NOT g_is_concurrent THEN 
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Task_ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_task_id_sql,'NO_MASK');
   END IF;
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  l_revision := rtrim(replace('$Revision: 200.33  $','$',''));
  l_revision := ltrim(replace(l_revision,'Revision:',''));
  l_date_char := rtrim(replace('$Date: 2026/02/25 21:46:11 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'pa_pjc_fc_analyzer.sql';
...
debug('begin parameter validation: p_project_id_sql');
IF NOT g_is_concurrent THEN
IF p_project_id_sql IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Project_ID is required.');
   raise invalid_parameters;
END IF;
IF p_project_id_sql IS NOT NULL THEN
BEGIN
SELECT P.PROJECT_ID
INTO l_exists_val
FROM PA_PROJECTS_ALL P
WHERE P.PROJECT_ID = p_project_id_sql
 AND nvl(p.template_flag,'N') = 'N'
AND EXISTS (
  SELECT 1 FROM pa_budgetary_control_options bco
  WHERE bco.project_id = p.project_id)     
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid project ID - this project ID does not exist or does not have budgetary control enabled.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_project_id_sql failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
END IF;
debug('end parameter validation: p_project_id_sql');

debug('begin parameter validation: p_task_id_sql');
IF NOT g_is_concurrent THEN
IF p_task_id_sql IS NOT NULL THEN
BEGIN
SELECT TASK_ID
INTO l_exists_val
FROM PA_TASKS
WHERE TASK_ID = p_task_id_sql
 AND PROJECT_ID = p_project_id_sql
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid task ID');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_task_id_sql failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
END IF;
debug('end parameter validation: p_task_id_sql');
...
g_project_id := nvl(p_project_id, p_project_id_sql);
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$PROJECT_ID$$##') := g_project_id;
   g_masked_tokens('##$$PROJECT_ID$$##') := mask_text( g_sql_tokens('##$$PROJECT_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$TASK_ID$$##') := nvl(to_char(p_task_id), 'null');
   g_masked_tokens('##$$TASK_ID$$##') := mask_text( g_sql_tokens('##$$TASK_ID$$##'), 'NO_MASK');
...
debug('begin add_signature: PA_FC_UPG_SI_MISSING_EVENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6030',
      p_sig_id                 => 'PA_FC_UPG_SI_MISSING_EVENTS',
      p_sig_sql                => 'SELECT ai.invoice_num,
       ai.invoice_id,
       ''MISSING SLA EVENTS FOR UPGRADED INVOICE'' problem
FROM ap_invoice_distributions_all d,
     ap_invoices_all ai,
     xla_events e
WHERE d.project_id = ##$$PROJECT_ID$$##
AND   d.historical_flag = ''Y''
AND   d.posted_flag = ''Y''
AND   d.encumbered_flag = ''Y''
AND   ai.invoice_id = d.invoice_id
AND   e.event_id = d.bc_event_id
AND   e.application_id = 200
AND   e.event_status_code = ''P''
AND   e.event_type_code  IN (''INVOICE VALIDATED'',''INVOICE CANCELLED'',
        ''INVOICE ADJUSTED'')
AND   NOT EXISTS (
        SELECT 1 from xla_events e2
        WHERE e.entity_id = e2.entity_id
        AND   e2.application_id = 275
        AND   e2.event_type_code IN (''INVOICE_BURDEN_CANCELLED'',
                ''INVOICE_BURDEN_VALIDATED'',''INVOICE_BURDEN_ADJUSTED''))',
      p_title                  => 'Missing Events for Upgraded Supplier Invoices',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Funds check related events are missing for supplier invoices created in 11i and upgraded to R12.',
      p_solution               => 'A service request (SR) should be opened with Oracle Support to obtain a data fix from development.',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: PA_FC_UPG_SI_MISSING_EVENTS');



debug('begin add_signature: PA_FC_UPG_EI_NOT_UPG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6031',
      p_sig_id                 => 'PA_FC_UPG_EI_NOT_UPG',
...
WHERE ei.document_header_id is null
AND   nvl(ei.historical_flag,''Y'') = ''Y''
AND   (ei.transaction_source like ''AP%'' OR
       ei.transaction_source like ''PO %'')
AND   src.predefined_flag = ''Y''
AND   src.system_linkage_function = ''VI''
AND   src.transaction_source = ei.transaction_source
AND   ei.project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Expenditure Items Not Upgraded',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Some funds check related expenditure items have not been upgraded.',
      p_solution               => 'The program UPG: Upgrade Transaction Attributes should be run to properly populate fields that are required for proper functioning in R12.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_FC_UPG_EI_NOT_UPG');



debug('begin add_signature: PA_FC_UPG_PJ_CMTS_NOT_UPG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6032',
      p_sig_id                 => 'PA_FC_UPG_PJ_CMTS_NOT_UPG',
      p_sig_sql                => 'SELECT ai.invoice_num,
       ai.invoice_id,
       cmt.document_type "Doc Type",
       cmt.document_distribution_type "Dist Type"
FROM pa_bc_commitments_all cmt,
     ap_invoices_all ai
WHERE cmt.project_id = ##$$PROJECT_ID$$##
AND   cmt.budget_version_id IN (
        SELECT bv.budget_version_id FROM pa_budget_versions bv
        WHERE bv.project_id = cmt.project_id
        AND   bv.current_flag = ''Y''
        AND   bv.budget_status_code = ''B'')
AND   cmt.document_type = ''AP''
AND   ai.invoice_id = cmt.document_header_id
AND   EXISTS (
        SELECT 1 FROM ap_invoice_distributions_all d
        WHERE d.historical_flag = ''Y''
        AND   d.posted_flag = ''Y''
        AND   d.encumbered_flag = ''Y''
        AND   d.project_id = cmt.project_id
        AND   d.old_dist_line_number = cmt.document_distribution_id
        AND   d.invoice_id = cmt.document_header_id)',
      p_title                  => 'Project Commitments Not Upgraded',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Some project commitment records have not been properly upgraded.',
      p_solution               => 'A service request (SR) should be opened with Oracle Support to obtain a data fix from development.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: PA_FC_UPG_PJ_CMTS_NOT_UPG');



debug('begin add_signature: PA_FC_BUD_BL_REJ_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6034',
      p_sig_id                 => 'PA_FC_BUD_BL_REJ_STATUS',
      p_sig_sql                => 'SELECT bv.budget_version_id,
       ...
       bv.current_working_flag,
       bv.request_id
FROM pa_budget_versions bv
WHERE bv.project_id = ##$$PROJECT_ID$$##
AND   bv.budget_status_code = ''R''',
      p_title                  => 'Budgets in Rejected Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'One or more budget versions has been detected with a "Rejected" status.',
      p_solution               => '<ol><li>Navigate to the Projects responsibility > Expenditures > "Transaction Funds Check Result". This will launch the "Funds Check Result" form.</li>
<li>Enter the project number or name and select "Rejected" from the "Status" drop-down list.</li>
<li>Press ''Find'' to open the "Check Funds" form, with a detailed listing of transactions along with rejection reasons and corrective actions.</li>
<li>Follow the suggested corrective actions and baseline the budget to resolve the issue.</li>
</ol>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: PA_FC_BUD_BL_REJ_STATUS');



debug('begin add_signature: PA_FC_BUD_BL_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6033',
      p_sig_id                 => 'PA_FC_BUD_BL_ERRORS',
      p_sig_sql                => 'SELECT ''XLA_ACCOUNTING_ERRORS'' source,
       err.event_id,
       err.accounting_error_id,
       err.entity_id,
       err.ledger_id,
       err.accounting_batch_id,
       err.message_number,
       err.encoded_msg,
       err.ae_header_id,
       err.ae_line_num,
...
WHERE err.application_id = 275
AND   err.event_id IN (
        SELECT e.event_id FROM xla_events e
        WHERE e.application_id = 275
        AND   e.event_type_code = ''BUDGET_BASELINE''
        AND   e.entity_id IN (
                SELECT xte.entity_id FROM xla_transaction_entities_upg xte
                WHERE xte.application_id = 275
                AND   xte.entity_code = ''BUDGETS''
                AND   nvl(source_id_int_1,-99) IN (
                        SELECT bv.budget_version_id FROM pa_budget_versions bv
                        WHERE project_id = ##$$PROJECT_ID$$##
                        AND   budget_status_code = ''W'')))
UNION
SELECT ''PSA_XLA_ACCOUNTING_ERRORS'',
       err.event_id,
       err.accounting_error_id,
       err.entity_id,
       err.ledger_id,
       ...
       err.event_date,
       err.entity_code,
       err.transaction_number,
       err.source_id_int_1
FROM psa_xla_accounting_errors err
WHERE err.event_id IN (
        SELECT e.event_id FROM xla_events e
        WHERE e.application_id = 275
        AND   e.event_type_code = ''BUDGET_BASELINE''
        AND   e.entity_id IN (
                SELECT xte.entity_id FROM xla_transaction_entities_upg xte
                WHERE xte.application_id = 275
                AND   entity_code = ''BUDGETS''
                AND   nvl(xte.source_id_int_1,-99) IN (
                        SELECT bv.budget_version_id FROM pa_budget_versions bv
                        WHERE bv.project_id = ##$$PROJECT_ID$$##
                        AND   bv.budget_status_code = ''W'')))
ORDER BY 1 DESC',
      p_title                  => 'Baseline Budget Errors',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Errors have occurred during the budget baseline process.',
...
You should also apply the appropriate version of {22334651} for your release if you have not done so already.  This will result in more meaningful error messages being displayed when issues occur during budget baseline to help point you to a solution.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_FC_BUD_BL_ERRORS');



debug('begin add_signature: PA_FC_BUD_BL_F128');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6035',
      p_sig_id                 => 'PA_FC_BUD_BL_F128',
      p_sig_sql                => 'SELECT bc.bc_commitment_id,
       bc.expenditure_type,
...
AND   bc.budget_version_id IN (
        SELECT bv.budget_version_id
        FROM pa_budget_versions bv
        WHERE bv.project_id = bc.project_id
        AND   bv.budget_status_code = ''B''
        AND   bv.current_flag = ''N'')',
      p_title                  => 'F128 Errors in Budget Baseline',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Corruption of the baseline version exists in the PA_BC_COMMITMENTS table.',
      p_solution               => 'Log a service request (SR) with Oracle Support to obtain a datafix from development.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_FC_BUD_BL_F128');



debug('begin add_signature: PA_FC_BUD_BL_SEQUENCE_LIMIT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6097',
      p_sig_id                 => 'PA_FC_BUD_BL_SEQUENCE_LIMIT',
      p_sig_sql                => 'SELECT s.sequence_name, 
       s.last_number,
       s.max_value, 
       s.cache_size,
       s.increment_by
FROM all_sequences s
WHERE s.sequence_name = ''PA_MAPPABLE_TXNS_TMP_S''
AND last_number >= max_value',
      p_title                  => 'Project Budget Baseline Related to PA_MAPPABLE_TXNS_TMP_S Sequence Issue',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The sequence PA_MAPPABLE_TXNS_TMP_S has reached or is approaching its maximum value.  This can result in errors during funds check related processes including budget baseline.',
      p_solution               => 'To resolve this issue, follow the solution from [2231996/KB199320].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_FC_BUD_BL_SEQUENCE_LIMIT');



debug('begin add_signature: PA_FC_BUD_BL_F107');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14186',
      p_sig_id                 => 'PA_FC_BUD_BL_F107',
      p_sig_sql                => 'SELECT cdl.budget_ccid,
       cdl.dr_code_combination_id
FROM pa_cost_distribution_lines_all cdl,
     pa_expenditure_items_all ei
WHERE cdl.project_id = ##$$PROJECT_ID$$##
AND   pa_funds_control_utils.get_bdgt_link(cdl.project_id, ''STD'') = ''Y''
AND   cdl.budget_ccid is null
AND   ei.expenditure_item_id = cdl.expenditure_item_id
AND   ei.transaction_source IN (''AP INVOICE'', ''AP NRTAX'', ''AP VARIANCE'')
...
AND   NOT EXISTS (
        ...
        AND   apd.invoice_id = cdl.system_reference2
        AND   apd.distribution_line_number = cdl.system_reference3
        AND   (api.invoice_type_lookup_code = ''PREPAYMENT'' OR
               apd.line_type_lookup_code = ''PREPAY''))',
      p_title                  => 'F107 Error - The Transaction Account and the Budget Account are Different',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Funds Check Error F107 - The transaction account and the budget account are different',
      p_solution               => 'Apply the datafix from [820963/KB233728#aref_section23] Scenario 3.',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: PA_FC_BUD_BL_F107');



debug('begin add_signature: PA_FC_DOC_APP_SLA_ERROR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6078',
      p_sig_id                 => 'PA_FC_DOC_APP_SLA_ERROR',
      p_sig_sql                => 'SELECT ''XLA_ACCOUNTING_ERRORS'' source,
       ae.message_number,
       ae.error_source_code err_source_or_message_code,
       ae.event_id,
       ae.entity_id,
       ae.ledger_id,
       ae.accounting_error_id,
       ae.accounting_batch_id,
       ae.encoded_msg,
       ae.ae_header_id,
       ae.ae_line_num,
       ae.application_id,
       ...
       null transaction_number,
       null trx_id
FROM xla_accounting_errors ae
WHERE event_id IN (
        SELECT bp.bc_event_id FROM pa_bc_packets bp
        WHERE bp.project_id = ##$$PROJECT_ID$$##
        AND   bp.budget_version_id IN (
                SELECT bv.budget_version_id FROM pa_budget_versions bv
                WHERE bv.project_id = bp.project_id
                AND   bv.current_flag = ''Y''
                AND   bv.budget_status_code = ''B'')
        AND   EXISTS (
                SELECT 1 FROM pa_budgetary_control_options bco
                WHERE bco.external_budget_code = ''GL''
                AND   bco.project_id = bp.project_id))
UNION
SELECT ''PSA_XLA_ACCOUNTING_ERRORS'',
       pae.message_num,
       pae.message_code,
       ...
       pae.entity_code,
       pae.event_date,
       pae.transaction_number,
       pae.source_id_int_1
FROM psa_xla_accounting_errors pae
WHERE pae.event_id IN (
        SELECT bp.bc_event_id FROM pa_bc_packets bp
        WHERE bp.project_id = ##$$PROJECT_ID$$##
        AND   bp.budget_version_id IN (
                SELECT bv.budget_version_id FROM pa_budget_versions bv
        ...
        AND   EXISTS (
                ...
                AND   bco.project_id = bp.project_id))
ORDER BY 1 desc, 2',
      p_title                  => 'SLA Errors in Document Approval',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'SLA Errors have occurred during document approval.',
      p_solution               => 'Review the errors indicated in the query output.  To gather more details on the problem, review [414094/KB308767] which provides the steps for generating the Transaction Objects Diagnostics report to see more details related to the issue.

If the information provided in these steps is insufficient to resolve the issue, you should open a service request (SR) with Oracle Support so that a bug can be created for development assistance.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_FC_DOC_APP_SLA_ERROR');



debug('begin add_signature: PA_FC_DOC_APP_F132_ERROR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6093',
      p_sig_id                 => 'PA_FC_DOC_APP_F132_ERROR',
      p_sig_sql                => 'SELECT bp.document_type,
       bp.document_header_id,
       bp.document_distribution_id,
       bp.gl_date,
       bp.pa_date
FROM pa_bc_packets bp
WHERE bp.result_code = ''F132''
...
AND   bp.budget_version_id IN (
        ...
        AND   bv.current_flag = ''Y'')',
      p_title                  => 'F132 Errors in Funds Check',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Funds check fails during document approval with result code F132 (Could not map to a budget line while deriving budget account). This occurs when the system is unable to locate a budget line for the combination (e.g., project, task, GL date, and resource) when deriving the budget account. ',
      p_solution               => '<ol>
<li>Navigate to the cost budget on which budgetary control is enabled for the failing project.<\li>
<li>Enter a budget line (which can be for $0) for the specific combination that the user tried to use in documents approval process and ensure that the budget line is successfully created.<\li>
<li>Enter again a requisition, purchase order, or invoice with same combination of attributes as previously and verify that the error is resolved.<\li>
</ol>
See also [550124/KB371158] for additional information on this error.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_FC_DOC_APP_F132_ERROR');



debug('begin add_signature: PA_FC_DATA_CORR_GL_DATE_OUT_OF_RNG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6102',
      p_sig_id                 => 'PA_FC_DATA_CORR_GL_DATE_OUT_OF_RNG',
...
WHERE bc.project_id = ##$$PROJECT_ID$$##
AND   (trunc(bc.gl_date) < bc.fc_start_date OR
       trunc(bc.gl_date) > bc.fc_end_date)',
      p_title                  => 'GL Date Out of Funds Check Range',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'In some cases documents are being validated when they should not be because they have GL dates which fall outside the project dates.  This can ultimately result in failure during budget baseline.',
      p_solution               => 'Follow the instructions in [2912823/KB420403] Budget Failure During Baseline Due To GL Dates That Fall Outside The Project Dates.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_FC_DATA_CORR_GL_DATE_OUT_OF_RNG');



debug('begin add_signature: PA_WORKFLOW_WF_STATUS_CODE_IN_ROUTE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13280',
      p_sig_id                 => 'PA_WORKFLOW_WF_STATUS_CODE_IN_ROUTE',
      p_sig_sql                => 'SELECT budget_version_id, budget_status_code, wf_status_code
FROM   pa_budget_versions
WHERE  project_id = ##$$PROJECT_ID$$##
AND    budget_status_code = ''S''
AND    wf_status_code = ''IN_ROUTE''',
      p_title                  => ' Budget Workflow is Stuck in a Status of - In Progress',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Project ID ##$$PROJECT_ID$$## is left in a status of "In Progress", which can be caused from the budget workflow failing or terminated.',
      p_solution               => 'See [1349968/KB303093] to return status to "Working" so that the budget may be resubmitted for approval.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_WORKFLOW_WF_STATUS_CODE_IN_ROUTE');



debug('begin add_signature: PA_FC_DATA_CORR_UNRELIEVED_CMT_CANC_REQ');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15355',
      p_sig_id                 => 'PA_FC_DATA_CORR_UNRELIEVED_CMT_CANC_REQ',
      p_sig_sql                => 'SELECT document_header_id,
  document_distribution_id,
  prd.encumbered_amount,
  prd.org_id,
  com1.project_id,
  prd.task_id,
  prd.gl_encumbered_date transaction_date,
  prd.gl_encumbered_period_name period_name,
  SUM(accounted_dr - accounted_cr) cmt_amount
FROM po_req_distributions_all prd,
  po_requisition_lines_all prl,
  pa_bc_commitments_all com1
WHERE prl.requisition_line_id = prd.requisition_line_id
AND prd.project_id = ##$$PROJECT_ID$$##
AND prd.task_id IS NOT NULL
AND prd.expenditure_type IS NOT NULL
AND prd.expenditure_item_date IS NOT NULL
AND prd.expenditure_organization_id IS NOT NULL
AND prd.gl_cancelled_date IS NOT NULL
AND com1.document_header_id = prl.requisition_header_id
AND com1.document_distribution_id = prd.distribution_id
AND com1.document_type = ''REQ''
AND NOT EXISTS
  (SELECT bc_commitment_id,
  pbc.parent_bc_packet_id
  FROM pa_bc_packets pbc
  WHERE pbc.document_distribution_id = prd.distribution_id
  AND pbc.document_header_id = prl.requisition_header_id
...
AND NOT EXISTS
  ...
  WHERE REQ_DISTRIBUTION_ID = PRD.DISTRIBUTION_ID
  )
...
HAVING SUM(accounted_dr - accounted_cr) <> 0',
      p_title                  => 'Unrelieved Commitments For Canceled Purchase Requisitions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Unrelieved commitments exist for canceled purchase requisitions on the project which may result in incorrect funds available balances and cause errors during baselining of budgets. ',
      p_solution               => 'Please follow the note below and perform the action plan as suggested in the document:<br>
[1929444/KB525739] R12: Commitment exist for cancelled purchase requisition',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_FC_DATA_CORR_UNRELIEVED_CMT_CANC_REQ');



debug('begin add_signature: EBS_FIN_PA_PA_PJC_FC_UNRELIEVED_COMMITMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23954',
      p_sig_id                 => 'EBS_FIN_PA_PA_PJC_FC_UNRELIEVED_COMMITMENTS',
      p_sig_sql                => 'SELECT
    project_num,
    project_id,
    task_number,
...
FROM
    (
        WITH proj_rec AS (
            ...
            WHERE
                ...
                AND EXISTS (
                    ...
                    WHERE
                            status.project_status_code = p.project_status_code
                        AND project_system_status_code NOT IN ( ''CLOSED'', ''PENDING_CLOSE'' )
                )
        )
        SELECT
            proj_rec.segment1 project_num,
            pbc.document_type,
            ...
            ( 
                ...
                WHERE
                    requisition_header_id = document_header_id
            ) AS document_number,
            (
                SELECT
                    line_num
                ...
                WHERE
                        requisition_header_id = document_header_id
                    AND requisition_line_id = (
                        SELECT
                            requisition_line_id
                        FROM
                            po_req_distributions_all
                        WHERE
                            distribution_id = document_distribution_id
                    )
            ) AS line_number,
            (
                SELECT
            ...
            pbc.txn_ccid,
            MAX(pbc.pa_date) pa_date,
            MAX(pbc.gl_date) gl_date,
            MAX(pbc.fc_start_date) fc_start_date,
            MAX(pbc.fc_end_date) fc_end_date,
            SUM(nvl(accounted_dr, 0) - nvl(accounted_cr, 0)) cmt_amt
        FROM
            pa_bc_commitments_all  pbc,
            pa_tasks               pt,
            proj_rec
        WHERE
                pbc.project_id = proj_rec.project_id
            AND pt.task_id = pbc.task_id
                ...
                FROM
                    po_req_distributions_all
                WHERE
                        distribution_id = pbc.document_distribution_id
                ...
                WHERE
                        distribution_id = pbc.document_distribution_id
                    AND project_id = pbc.project_id
                    AND task_id = pbc.task_id
                    AND expenditure_organization_id = pbc.expenditure_organization_id
                    AND expenditure_type = pbc.expenditure_type
            )
                                 OR EXISTS (
                SELECT
                    1
                ...
                WHERE
                        encumbered_flag = ''Y''
                    AND req_distribution_id = document_distribution_id
                        AND project_id = pbc.project_id
                        AND task_id = pbc.task_id
                GROUP BY
                    req_distribution_id
                ...
                WHERE
                        status_code = ''A''
                    AND document_type = pbc.document_type
                    AND document_header_id = pbc.document_header_id
                    AND document_distribution_id = pbc.document_distribution_id
                    AND project_id = pbc.project_id
                    AND task_id = pbc.task_id
                    AND expenditure_organization_id = pbc.expenditure_organization_id
                    AND expenditure_type = pbc.expenditure_type
        ...
        GROUP BY
            ...
            pbc.txn_ccid
        HAVING
            abs(SUM(nvl(accounted_dr, 0) - nvl(accounted_cr, 0))) > 0.25
        UNION ALL
        SELECT
            proj_rec.segment1 project_num,
            pbc.document_type,
            ...
            (
                ...
                FROM
                    po_headers_all
                WHERE
                    po_header_id = document_header_id
            ) document_number,
            (
                SELECT
                    line_num
                ...
                WHERE
                    po_line_id = (
                        ...
                        FROM
                            po_distributions_all
                        WHERE
                            po_distribution_id = document_distribution_id
                    )
            ) AS line_number,
            (
                SELECT
        ...
        WHERE
            ...
            AND document_type = ''PO''
                ...
                FROM
                    po_distributions_all
                WHERE
                        po_header_id = pbc.document_header_id
                    AND po_distribution_id = pbc.document_distribution_id
                    AND project_id = pbc.project_id
                    AND task_id = pbc.task_id
                    AND expenditure_organization_id = pbc.expenditure_organization_id
                    AND expenditure_type = pbc.expenditure_type
                ...
                FROM
                    pa_bc_packets
                WHERE
                        document_header_id = pbc.document_header_id
                    AND document_type = pbc.document_type
                    AND document_distribution_id = pbc.document_distribution_id
                    AND project_id = pbc.project_id
                    AND task_id = pbc.task_id
        ...
        SELECT
            ...
            (
                ...
                WHERE
                    invoice_distribution_id = document_distribution_id
            ) AS line_number,
            (
                SELECT
            ...
            bc.txn_ccid,
            MAX(bc.fc_start_date) fc_start_date,
            MAX(bc.fc_end_date) fc_end_date,
            MAX(bc.pa_date) pa_date,
            MAX(bc.gl_date) gl_date,
            SUM(nvl(accounted_dr, 0) - nvl(accounted_cr, 0)) cmt_amt
        FROM
            pa_bc_commitments_all  bc,
            pa_tasks               pt,
            proj_rec
        WHERE
                bc.document_type = ''AP''
            AND bc.parent_bc_packet_id IS NULL
                AND ( EXISTS (
                SELECT
                    1
                FROM
                ...
                WHERE
                        ap.invoice_id = bc.document_header_id
                    AND ap.invoice_distribution_id = bc.document_distribution_id
                    AND ap.project_id = bc.project_id
                    AND ap.task_id = bc.task_id
                    AND ap.pa_addition_flag IN ( ''Y'', ''F'', ''G'' )
            )
                      OR NOT EXISTS (
                SELECT
                    1
                ...
                WHERE
                    ...
                    AND ap.project_id = bc.project_id
                    AND ap.task_id = bc.task_id
                    AND expenditure_organization_id = bc.expenditure_organization_id
                    AND expenditure_type = bc.expenditure_type
            ) )
                    AND bc.project_id = proj_rec.project_id
                    AND bc.task_id = pt.task_id
                    AND pt.project_id = proj_rec.project_id
                    AND NOT EXISTS (
                SELECT
                    1
                FROM
                    pa_bc_packets
                WHERE
                        document_header_id = bc.document_header_id
                    AND document_distribution_id = bc.document_distribution_id
                    AND document_type = bc.document_type
      ...
      p_title                  => 'Missing/Unrelieved Commitments Reporting Script',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Missing/unrelieved commitment(s) exist.',
      p_solution               => 'Download the generic data fix patch appropriate for your application release as described in [1538911/PALRT2480] Critical Data Fix Patch Released For Customers Using Funds Check Functionality in Project Costing.<br>
',
      p_success_msg            => 'No missing/unrelieved commitment(s) exist.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_PJC_FC_UNRELIEVED_COMMITMENTS');



debug('begin add_signature: EBS_FIN_PA_PA_PJC_FC_INCORRECT_COMMITMENT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24750',
      p_sig_id                 => 'EBS_FIN_PA_PA_PJC_FC_INCORRECT_COMMITMENT',
      p_sig_sql                => 'SELECT project_num,project_id,task_number,expenditure_type,expenditure_organization_id,document_type,document_number,line_number,distribution_number,document_header_id,document_distribution_id,code_combination_id,encumbered_amount,bc_cmt_amt,bc_pkt_amt,cmt_amt_tobe_func,cmt_amt_tobe_txn,difference
FROM
    (
        WITH proj_rec AS (
            SELECT project_id,segment1,org_id
            FROM
                pa_projects_all p
            WHERE
                    p.project_id = ##$$PROJECT_ID$$##
        ...
        SELECT document_type,vendor_id,project_num,project_id,task_id,top_task_id,task_number,expenditure_type,expenditure_organization_id,expenditure_item_date,requisition_header_id document_header_id, distribution_id document_distribution_id,
''Requisitions'' je_category_name,''Purchasing'' je_source_name,document_number,line_number,distribution_number,encumbered_amount,org_id,transaction_date,period_name,rate,currency_code,code_combination_id,nvl(bc_cmt_amt, 0) bc_cmt_amt,nvl(bc_pkt_amt, 0) bc_pkt_amt,cmt_amt_tobe_func,cmt_amt_tobe_txn,
            CASE
                WHEN cmt_amt_tobe_comp_po < 0 THEN
                    nvl(bc_cmt_amt, 0) + nvl(bc_pkt_amt, 0)
                ELSE
                    nvl(cmt_amt_tobe_func, 0) - ( nvl(bc_cmt_amt, 0) + nvl(bc_pkt_amt, 0) )
            END difference
        FROM
            (
                SELECT ''REQ'' document_type,prl.vendor_id,proj_rec.segment1 project_num,prd.project_id,prd.task_id,pt.top_task_id,pt.task_number,prd.expenditure_type,prd.expenditure_organization_id,prd.expenditure_item_date,prl.requisition_header_id,prd.distribution_id,prh.segment1 document_number,
prl.line_num line_number,prd.distribution_num distribution_number,prd.encumbered_amount,prd.org_id,prd.gl_encumbered_date transaction_date,prd.gl_encumbered_period_name period_name,prl.rate,prl.currency_code,prd.code_combination_id,
                    (
                        SELECT
                        ...
                        FROM
                            pa_bc_commitments_all com1
                        WHERE
                                com1.document_header_id = prl.requisition_header_id
                            AND com1.parent_bc_packet_id IS NULL
                            AND com1.document_distribution_id = prd.distribution_id
                            AND com1.document_type = ''REQ''
                            AND com1.task_id = prd.task_id
                            AND com1.project_id = prd.project_id
                            AND com1.expenditure_type = prd.expenditure_type
                            AND com1.expenditure_organization_id = prd.expenditure_organization_id
                    ) bc_cmt_amt,
                    (
                        SELECT
                            SUM(nvl(accounted_dr, 0) - nvl(accounted_cr, 0))
                        ...
                        WHERE
                            ...
                            AND com1.bc_commitment_id IS NULL
                    ) bc_pkt_amt,
                    nvl(prd.encumbered_amount, 0) cmt_amt_tobe_func,
                    nvl(prd.encumbered_amount, 0) / nvl(prl.rate, 1) cmt_amt_tobe_txn,
                    prd.encumbered_amount - (
                        SELECT
                            nvl(SUM(pod.encumbered_amount), 0)
                        FROM
                            po_distributions_all pod
                        WHERE
                                pod.req_distribution_id = prd.distribution_id
                            AND pod.project_id = prd.project_id
                            AND pod.task_id = prd.task_id
                            AND pod.expenditure_type = prd.expenditure_type
                            AND pod.expenditure_organization_id = prd.expenditure_organization_id
                    ) cmt_amt_tobe_comp_po
                FROM
                    ...
                    proj_rec
                WHERE
                        prd.project_id = proj_rec.project_id
                    AND prh.conformed_header_id IS NULL
                    AND pt.project_id = prd.project_id
                    AND pt.task_id = prd.task_id
                    AND prl.requisition_line_id = prd.requisition_line_id
                    AND prh.requisition_header_id = prl.requisition_header_id
                    AND nvl(prd.encumbered_amount, 0) >= 0
                    AND prd.encumbered_flag = ''Y''
                    AND prd.encumbered_amount IS NOT NULL
                    AND prd.task_id IS NOT NULL
                    AND prd.expenditure_type IS NOT NULL
                    AND prd.expenditure_item_date IS NOT NULL
                    AND prd.expenditure_organization_id IS NOT NULL
					AND nvl(prh.authorization_status,''IN PROCESS'') NOT IN  (''IN PROCESS'')
            )
        WHERE
                ( nvl(bc_cmt_amt, 0) + nvl(bc_pkt_amt, 0) ) <> nvl(cmt_amt_tobe_func, 0)
            AND abs(nvl(cmt_amt_tobe_func, 0) -(nvl(bc_cmt_amt, 0) + nvl(bc_pkt_amt, 0))) > 0.25
        UNION ALL
        SELECT
document_type,vendor_id,project_num,project_id,task_id,top_task_id,task_number,expenditure_type,expenditure_organization_id,expenditure_item_date,document_header_id,document_distribution_id,''Purchases'' je_category_name,''Purchasing'' je_source_name,document_number,line_number,distribution_number,encumbered_amount,org_id,transaction_date,period_name,rate,currency_code,code_combination_id,nvl(bc_cmt_amt, 0),nvl(bc_pkt_amt, 0),cmtamttobe cmt_amt_tobe_func,( cmtamttobe / nvl(rate, 1) ) cmt_amt_tobe_txn,nvl(cmtamttobe, 0) - ( nvl(bc_cmt_amt, 0) + nvl(bc_pkt_amt, 0) ) difference
        FROM
            (
                SELECT
''PO'' document_type,vendor_id,project_id,project_num,task_id,top_task_id,task_number,expenditure_type,expenditure_organization_id,expenditure_item_date,po_header_id document_header_id,po_distribution_id document_distribution_id,document_number,line_number,distribution_number,encumbered_amount,org_id,gl_encumbered_date transaction_date,gl_encumbered_period_name period_name,po_intf_date,inv_intf_date,accrue_on_receipt_flag,rate,currency_code,code_combination_id,nvl(bccmtamt, 0) bc_cmt_amt,
nvl(bcpktamt, 0) bc_pkt_amt,
                    decode(rate, null,
                        decode(accrue_on_receipt_flag, ''Y'', 
                                 encumbered_amount- nvl(po_intf_amt,0)- nvl(inv_intf_amount,0)-nvl(inv_posted_amount,0), 
                                 encumbered_amount - nvl(inv_intf_amount,0)-nvl(inv_posted_amount,0)),
                        decode(accrue_on_receipt_flag, ''Y'', 
                                 encumbered_amount- nvl(po_intf_denom_amt,0)*rate
                                                  - nvl(inv_intf_denom_amount,0)*rate
                                                  -nvl(inv_posted_amount,0)*rate, 
                                 encumbered_amount - nvl(inv_intf_denom_amount,0)*rate
                                                   -nvl(inv_posted_denom_amount,0)*rate) 
                        ) CmtAmtToBe
                FROM
                    (
                        SELECT
poh.vendor_id,pod.po_header_id,proj_rec.segment1 project_num,pod.po_distribution_id,poh.segment1 document_number,pol.line_num line_number,pod.distribution_num distribution_number,nvl(pod.org_id, - 99) org_id,pod.project_id,pod.task_id,pt.top_task_id,pt.task_number,pod.expenditure_type,pod.expenditure_item_date,pod.expenditure_organization_id,pod.encumbered_amount,pod.gl_encumbered_date,pod.gl_encumbered_period_name,pod.accrue_on_receipt_flag,pod.nonrecoverable_tax,pod.amount_billed,pod.quantity_ordered,pod.quantity_cancelled,pod.quantity_billed,pol.unit_price,pod.rate,poh.currency_code,pod.code_combination_id,
                            (
                                SELECT
                                    nvl(SUM(cdl.acct_raw_cost), 0)
                                FROM
                                    pa_expenditure_items_all        pei,
                                    pa_cost_distribution_lines_all  cdl
                                WHERE
                                        cdl.expenditure_item_id = pei.expenditure_item_id
                                    AND cdl.line_type = ''R''
                                    AND cdl.transfer_status_code = ''V''
                                    AND cdl.line_num = 1
                                    AND pei.transaction_source IN ( ''PO RECEIPT'', ''PO RECEIPT NRTAX'', ''PO RECEIPT NRTAX PRICE ADJ'',
                                               ''PO RECEIPT PRICE ADJ'' )
                                    AND pei.document_header_id = pod.po_header_id
                                    AND pei.document_line_number = pod.po_distribution_id
                                    AND pod.accrue_on_receipt_flag = ''Y''
                            ) po_intf_amt,
                            (
                                SELECT
                                    nvl(SUM(cdl.denom_raw_cost), 0)
                                FROM
                                    pa_expenditure_items_all        pei,
                                    pa_cost_distribution_lines_all  cdl
                                WHERE
                            ...
                            (
                                ...
                                WHERE
                                    ...
                                    AND cdl.transfer_status_code = ''V''
                                    AND cdl.line_num = 1
                                    AND pei.transaction_source IN ( ''AP INVOICE'', ''AP NRTAX'', ''AP VARIANCE'' )
                                    AND apd.line_type_lookup_code IN ( ''ITEM'', ''NONREC_TAX'', ''ACCRUAL'', ''IPV'' )
                                    AND apd.invoice_id = pei.document_header_id
                                    AND apd.invoice_distribution_id = pei.document_distribution_id
                                    AND apd.po_distribution_id = pod.po_distribution_id
                                    AND pa_addition_flag = ''Y''
                            ) inv_intf_amount,
                            (
                                SELECT
                                    nvl(SUM(nvl(base_amount, amount)), 0)
                                FROM
                                    ap_invoice_distributions_all apd
                                WHERE
                                        apd.po_distribution_id = pod.po_distribution_id
                                    AND pa_addition_flag = ''N''
                                    AND ( apd.posted_flag = ''Y''
                                    OR apd.encumbered_flag = ''Y'' )
                                    AND apd.line_type_lookup_code IN ( ''ITEM'', ''NONREC_TAX'', ''ACCRUAL'', ''IPV'' )
                            ) inv_posted_amount,
                            (
                                SELECT
                            ...
                            (
                                ...
                                WHERE
                                    ...
                                    AND cdl.line_num = 1
                                    AND pei.transaction_source IN ( ''AP INVOICE'', ''AP NRTAX'', ''AP VARIANCE'' )
                                    AND apd.line_type_lookup_code NOT IN ( ''ITEM'', ''NONREC_TAX'', ''ACCRUAL'', ''IPV'' )
                                    AND apd.invoice_id = pei.document_header_id
                                    AND apd.invoice_distribution_id = pei.document_distribution_id
                                    AND apd.po_distribution_id = pod.po_distribution_id
                                    AND pa_addition_flag = ''Y''
                            ...
                            (
                                SELECT
                                    nvl(SUM(nvl(accounted_dr, 0) - nvl(accounted_cr, 0)), 0) curr_cmt
                                FROM
                                    pa_bc_commitments_all pbc
                                WHERE
                                        pbc.document_distribution_id = pod.po_distribution_id
                                    AND pbc.document_header_id = pod.po_header_id
                                    AND parent_bc_packet_id IS NULL
                                    AND pbc.document_type = ''PO''
                                    AND pbc.project_id = pod.project_id
                                    AND pbc.task_id = pod.task_id
                                    AND pbc.expenditure_type = pod.expenditure_type
                                    AND pbc.expenditure_organization_id = pod.expenditure_organization_id
                                GROUP BY
                                    document_header_id,
                                    document_distribution_id,
                                    document_type
                            ...
                            (
                                ...
                                WHERE
                                    ...
                                    AND pbc.bc_commitment_id IS NULL
                                GROUP BY
                                    document_header_id,
                                    document_distribution_id,
                                    document_type
                        ...
                        FROM
                            ...
                            proj_rec
                        WHERE
                                pod.project_id = proj_rec.project_id
                            AND pt.project_id = pod.project_id
                            AND pt.task_id = pod.task_id
                            AND poh.po_header_id = pod.po_header_id
                            AND pol.po_line_id = pod.po_line_id
                            AND pod.encumbered_flag = ''Y''
                            AND pod.encumbered_amount >= 0
                            AND pod.encumbered_amount IS NOT NULL
                            AND pod.destination_type_code = ''EXPENSE''
					        AND nvl(poh.authorization_status,''IN PROCESS'') NOT IN  (''IN PROCESS'')
                    )
            )
        WHERE
                cmtamttobe <> nvl(bc_cmt_amt, 0) + nvl(bc_pkt_amt, 0)
            AND abs(nvl(cmtamttobe, 0) -(nvl(bc_cmt_amt, 0) + nvl(bc_pkt_amt, 0))) > 0.25
        UNION ALL
        SELECT
            ''AP'' document_type,
            vendor_id,
            ...
            currency_code,
            code_combination_id,
            nvl(bccmtamt, 0) bc_cmt_amt,
            nvl(bcpktamt, 0) bc_pkt_amt,
            cmtamttobe cmt_amt_tobe_func,
            ( cmtamttobe / nvl(rate, 1) ) cmt_amt_tobe_txn,
            nvl(cmtamttobe, 0) - ( nvl(bccmtamt, 0) + nvl(bcpktamt, 0) ) difference
        FROM
            (
                SELECT
                    dist.invoice_id document_header_id,
                    dist.invoice_distribution_id document_distribution_id,
                    aia.invoice_num document_number,
                    dist.invoice_line_number line_number,
                    dist.distribution_line_number distribution_number,
                    nvl(dist.org_id, - 99) org_id,
                    nvl(dist.base_amount, dist.amount) encumbered_amount,
                    dist.project_id,
                    proj_rec.segment1 project_num,
                    dist.task_id,
                    pt.top_task_id,
                    ...
                    dist.dist_code_combination_id code_combination_id,
                    dist.expenditure_item_date,
                    dist.accounting_date transaction_date,
                    dist.period_name,
                    aia.invoice_currency_code currency_code,
                    aia.exchange_rate rate,
                    aia.vendor_id,
                    (
                        SELECT
                            nvl(SUM(nvl(accounted_dr, 0) - nvl(accounted_cr, 0)), 0) curr_cmt
                        FROM
                            pa_bc_commitments_all pbc
                        WHERE
                                pbc.document_distribution_id = dist.invoice_distribution_id
                            AND pbc.document_header_id = dist.invoice_id
                            AND parent_bc_packet_id IS NULL
                            AND pbc.document_type = ''AP''
                            AND pbc.project_id = dist.project_id
                            AND pbc.task_id = dist.task_id
                            AND pbc.expenditure_type = dist.expenditure_type
                            AND pbc.expenditure_organization_id = dist.expenditure_organization_id
                        GROUP BY
                            document_header_id,
                            document_distribution_id,
                            document_type
                    ...
                    (
                        SELECT
                            nvl(dist.base_amount, nvl(dist.amount, 0))
                        FROM
                            po_distributions_all pod
                        WHERE
                                pod.po_distribution_id = dist.po_distribution_id
                        ...
                        WHERE
                            ...
                            AND pod.accrue_on_receipt_flag = ''Y''
                            AND dist.pa_addition_flag = ''N''
                            AND dist.line_type_lookup_code NOT IN ( ''ITEM'', ''NONREC_TAX'', ''ACCRUAL'' )
                        UNION ALL
                        SELECT
                            0
                        FROM
                        ...
                        FROM
                            dual
                        WHERE
                            dist.po_distribution_id IS NULL
                            AND dist.pa_addition_flag = ''Y''
                        UNION ALL
                        SELECT
                            nvl(dist.base_amount, nvl(dist.amount, 0))
                ...
                FROM
                    ...
                    ap_invoices_all               aia
                WHERE
                        dist.project_id = proj_rec.project_id
                    AND pt.project_id = dist.project_id
                    AND pt.task_id = dist.task_id
                    AND aia.invoice_id = dist.invoice_id
                    AND pa_addition_flag IN ( ''Y'', ''N'' )
                    AND ( dist.posted_flag = ''Y''
                    OR dist.encumbered_flag = ''Y'' )
                    AND dist.match_status_flag = ''A''
                    AND nvl(dist.reversal_flag, ''N'') = ''N''
                    AND dist.line_type_lookup_code IN ( ''ITEM'', ''NONREC_TAX'', ''ACCRUAL'', ''IPV'' ) 
            )
        WHERE nvl(cmtamttobe, 0) <> nvl(bccmtamt, 0) + nvl(bcpktamt, 0)
            AND abs(nvl(cmtamttobe, 0) -(nvl(bccmtamt, 0) + nvl(bcpktamt, 0))) > 0.25
        ORDER BY project_num,
            document_header_id,
            document_distribution_id
    )',
      p_title                  => 'Incorrect Commitments Reporting Script',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Incorrect commitment(s) exist.',
      p_solution               => 'Download the generic data fix patch appropriate for your application release as described in [1538911/PALRT2480] Critical Data Fix Patch Released For Customers Using Funds Check Functionality in Project Costing.<br>
',
      p_success_msg            => 'No incorrect commitment(s) exist.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_PJC_FC_INCORRECT_COMMITMENT');



debug('begin add_signature: PA_DC_PA_PROJECT_TYPES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6051',
      p_sig_id                 => 'PA_DC_PA_PROJECT_TYPES_ALL',
      p_sig_sql                => 'SELECT * FROM pa_project_types_all
WHERE (project_type, org_id) IN (
        SELECT project_type, org_id FROM pa_projects_all
        WHERE project_id = ##$$PROJECT_ID$$##)',
      p_title                  => 'Project Types',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found from PA_PROJECT_TYPES_ALL for the project.',
      p_solution               => '',
      p_success_msg            => 'PA_PROJECT_TYPES_ALL contains project configuration data which is associated to all projects of that type.  This includes default budgetary control information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DC_PA_PROJECT_TYPES_ALL');



debug('begin add_signature: PA_DC_PA_PROJECTS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6050',
      p_sig_id                 => 'PA_DC_PA_PROJECTS_ALL',
      p_sig_sql                => 'SELECT * FROM pa_projects_all
WHERE project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'PA_PROJECTS_ALL Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found from PA_PROJECTS_ALL for the project.',
      p_solution               => '',
      p_success_msg            => 'PA_PROJECTS_ALL contains information related to the definition of a project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DC_PA_PROJECTS_ALL');
...
debug('begin add_signature: PA_DC_PA_BC_PACKETS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5871',
      p_sig_id                 => 'PA_DC_PA_BC_PACKETS',
      p_sig_sql                => 'SELECT * FROM pa_bc_packets
WHERE project_id = ##$$PROJECT_ID$$##
and task_id = nvl(##$$TASK_ID$$##, task_id)',
      p_title                  => 'PA_BC_PACKETS Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found from PA_BC_PACKETS for the project.',
      p_solution               => '',
      p_success_msg            => 'PA_BC_PACKETS is a temporary table which holds attributes for funds checked transactions before these are included in the funds balances.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DC_PA_BC_PACKETS');



debug('begin add_signature: PA_DC_GL_BC_PACKETS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5872',
      p_sig_id                 => 'PA_DC_GL_BC_PACKETS',
      p_sig_sql                => 'SELECT * FROM gl_bc_packets
WHERE packet_id IN (
        SELECT packet_id FROM pa_bc_packets
        WHERE project_id = ##$$PROJECT_ID$$##
        AND   task_id = nvl(##$$TASK_ID$$##, task_id))',
      p_title                  => 'GL_BC_PACKETS Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found from GL_BC_PACKETS for the project.',
      p_solution               => '',
      p_success_msg            => 'GL_BC_PACKETS stores the results and data used for funds checking of transactions against a GL budget.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DC_GL_BC_PACKETS');



debug('begin add_signature: PA_DC_PA_BC_BALANCES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5873',
      p_sig_id                 => 'PA_DC_PA_BC_BALANCES',
      p_sig_sql                => 'SELECT * FROM pa_bc_balances
WHERE project_id = ##$$PROJECT_ID$$##
and pa_bc_balances.task_id = nvl(##$$TASK_ID$$##, pa_bc_balances.task_id)',
      p_title                  => 'PA_BC_BALANCES Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found from PA_BC_BALANCES for the project.',
      p_solution               => '',
      p_success_msg            => 'PA_BC_BALANCES stores actual, budget and encumbrance balances for the project by task, period, budget version and resource.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DC_PA_BC_BALANCES');



debug('begin add_signature: PA_DC_PA_BC_COMMITMENTS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6008',
      p_sig_id                 => 'PA_DC_PA_BC_COMMITMENTS_ALL',
      p_sig_sql                => 'SELECT * FROM pa_bc_commitments_all bc
WHERE bc.project_id = ##$$PROJECT_ID$$##
AND   bc.task_id = nvl(##$$TASK_ID$$##, bc.task_id)',
      p_title                  => 'PA_BC_COMMITMENTS_ALL Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found from PA_BC_COMMITMENTS_ALL for the project and task.',
      p_solution               => '',
      p_success_msg            => 'PA_BC_COMMITMENTS_ALL contains data related to all funds checked commitments (Requisitions, PO''s, and supplier invoices).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DC_PA_BC_COMMITMENTS_ALL');



debug('begin add_signature: PA_DC_PA_BUDGETARY_CONTROL_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6009',
      p_sig_id                 => 'PA_DC_PA_BUDGETARY_CONTROL_OPTIONS',
      p_sig_sql                => 'SELECT * FROM pa_budgetary_control_options
WHERE project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'PA_BUDGETARY_CONTROL_OPTIONS Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found from PA_BUDGETARY_CONTROL_OPTIONS for the project.',
      p_solution               => '',
      p_success_msg            => 'PA_BUDGETARY_CONTROL_OPTIONS contains the configuration details of the project''s budgetary control for top-down, bottom-up, and non-integrated budgetary control.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DC_PA_BUDGETARY_CONTROL_OPTIONS');



debug('begin add_signature: PA_DC_PA_BUDGET_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6010',
      p_sig_id                 => 'PA_DC_PA_BUDGET_VERSIONS',
      p_sig_sql                => 'SELECT * FROM pa_budget_versions bv
WHERE bv.project_id = ##$$PROJECT_ID$$##
AND (nvl(bv.budget_type_code, ''xxx''), NVL(fin_plan_type_id, -9999)) IN (
SELECT nvl(bco.budget_type_code, ''xxx''), NVL(fin_plan_type_id, -9999)
FROM pa_budgetary_control_options bco
WHERE bco.project_id = ##$$PROJECT_ID$$##)
ORDER BY bv.budget_type_code, bv.version_name',
      p_title                  => 'PA_BUDGET_VERSIONS Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found from PA_BUDGET_VERSIONS for the project budget.',
      p_solution               => '',
      p_success_msg            => 'PA_BUDGET_VERSIONS contains header level data for the draft, original, and baselined versions of the project budget.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DC_PA_BUDGET_VERSIONS');



debug('begin add_signature: PA_DC_PA_BUDGET_ENTRY_METHODS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6011',
      p_sig_id                 => 'PA_DC_PA_BUDGET_ENTRY_METHODS',
      p_sig_sql                => 'SELECT * FROM pa_budget_entry_methods bem
WHERE bem.budget_entry_method_code IN (
        SELECT bv.budget_entry_method_code
        FROM pa_budget_versions bv
        WHERE bv.project_id = ##$$PROJECT_ID$$##
        AND   bv.budget_type_code IN (
                SELECT bco.budget_type_code
                FROM pa_budgetary_control_options bco
                WHERE bco.project_id = ##$$PROJECT_ID$$##))',
      p_title                  => 'PA_BUDGET_ENTRY_METHODS Data',
      p_fail_condition         => 'NRS',
   ...
   l_info.delete;
debug('end add_signature: PA_DC_PA_BUDGET_ENTRY_METHODS');



debug('begin add_signature: PA_DC_PA_BUDGET_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6012',
      p_sig_id                 => 'PA_DC_PA_BUDGET_TYPES',
      p_sig_sql                => 'SELECT * FROM pa_budget_types bt
WHERE bt.budget_type_code IN (
        SELECT bco.budget_type_code
        FROM pa_budgetary_control_options bco
        WHERE bco.project_id = ##$$PROJECT_ID$$##)',
      p_title                  => 'PA_BUDGET_TYPES Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found from PA_BUDGET_TYPES for the project.',
      p_solution               => '',
      p_success_msg            => 'PA_BUDGET_TYPES contains details of the budget types for the project''s budgets.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DC_PA_BUDGET_TYPES');



debug('begin add_signature: PA_DC_AP_INVOICES_ALL');
   l_info('##MASK##AUTHORIZED_BY'):= 'REMOVE_COLUMN';
   l_info('##MASK##CUST_REGISTRATION_NUMBER'):= 'REMOVE_COLUMN';
   l_info('##MASK##CUS_REGISTRATION_CODE'):= 'REMOVE_COLUMN';
   l_info('##MASK##INTERNAL_CONTACT_EMAIL'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##REMIT_TO_SUPPLIER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6019',
      p_sig_id                 => 'PA_DC_AP_INVOICES_ALL',
      p_sig_sql                => 'SELECT * FROM ap_invoices_all i
WHERE i.invoice_id IN (
        SELECT d.invoice_id FROM ap_invoice_distributions_all d
        WHERE d.project_id = ##$$PROJECT_ID$$##
        AND   d.task_id = nvl(##$$TASK_ID$$##, d.task_id))
ORDER BY i.invoice_num',
      p_title                  => 'AP_INVOICES_ALL Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found from AP_INVOICES_ALL for the project.',
      p_solution               => '',
      p_success_msg            => 'Data for supplier invoices associated to this project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DC_AP_INVOICES_ALL');



debug('begin add_signature: PA_DC_AP_INVOICE_DISTRIBUTIONS_ALL');
   l_info('##MASK##MERCHANT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MERCHANT_REFERENCE'):= 'REMOVE_COLUMN';
   l_info('##MASK##MERCHANT_TAX_REG_NUMBER'):= 'REMOVE_COLUMN';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6020',
      p_sig_id                 => 'PA_DC_AP_INVOICE_DISTRIBUTIONS_ALL',
      p_sig_sql                => 'SELECT * FROM ap_invoice_distributions_all d
WHERE d.project_id = ##$$PROJECT_ID$$##
AND   d.task_id = nvl(##$$TASK_ID$$##, d.task_id)
ORDER BY d.invoice_id, d.invoice_line_number,
         d.distribution_line_number',
      p_title                  => 'AP_INVOICE_DISTRIBUTIONS_ALL Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found from AP_INVOICE_DISTRIBUTIONS_ALL for the project.',
      p_solution               => '',
      p_success_msg            => 'AP_INVOICE_DISTRIBUTIONS contains distribution level details of supplier invoice transactions associated to the project and its budgetary controls.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DC_AP_INVOICE_DISTRIBUTIONS_ALL');



debug('begin add_signature: PA_DC_PA_EXPENDITURE_ITEMS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6021',
      p_sig_id                 => 'PA_DC_PA_EXPENDITURE_ITEMS_ALL',
      p_sig_sql                => 'SELECT * FROM pa_expenditure_items_all ei
WHERE ei.project_id = ##$$PROJECT_ID$$##
AND   ei.task_id = nvl(##$$TASK_ID$$##, ei.task_id)
ORDER BY ei.expenditure_item_date',
      p_title                  => 'PA_EXPENDITURE_ITEMS_ALL Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found from PA_EXPENDITURE_ITEMS_ALL for the project and task.',
      p_solution               => '',
      p_success_msg            => 'PA_EXPENDITURE_ITEMS_ALL contains details of cost items associated with the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DC_PA_EXPENDITURE_ITEMS_ALL');



debug('begin add_signature: PA_DC_PA_COST_DISTRIBUTION_LINES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6022',
      p_sig_id                 => 'PA_DC_PA_COST_DISTRIBUTION_LINES_ALL',
      p_sig_sql                => 'SELECT * FROM pa_cost_distribution_lines_all cdl
WHERE cdl.project_id = ##$$PROJECT_ID$$##
AND   cdl.task_id = nvl(##$$TASK_ID$$##, cdl.task_id)
ORDER BY pa_period_name, pa_date',
      p_title                  => 'PA_COST_DISTRIBUTION_LINES_ALL Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found from PA_COST_DISTRIBUTION_LINES_ALL for the project and task.',
      p_solution               => '',
      p_success_msg            => 'PA_COST_DISTRIBUTION_LINES_ALL contains detailed distribution level data for cost and burden amounts for individual expenditure items.<br>
For details related to the transfer_status code review [558574/KB502044] What Are The Values For The TRANSFER_STATUS_CODE In The PA_COST_DISTRIBUTION_LINES_ALL Table? ',
   ...
   l_info.delete;
debug('end add_signature: PA_DC_PA_COST_DISTRIBUTION_LINES_ALL');



debug('begin add_signature: PA_DC_PO_HEADERS_ALL');
  ...
  add_signature(
      p_sig_repo_id            => '6046',
      p_sig_id                 => 'PA_DC_PO_HEADERS_ALL',
      p_sig_sql                => 'SELECT * FROM po_headers_all h
WHERE h.po_header_id IN (
        SELECT d.po_header_id FROM po_distributions_all d
        WHERE d.project_id = ##$$PROJECT_ID$$##
        AND   d.task_id = nvl(##$$TASK_ID$$##, d.task_id))
ORDER BY h.segment1',
      p_title                  => 'PO_HEADERS_ALL Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found from PO_HEADERS_ALL for the project and task.',
      p_solution               => '',
      p_success_msg            => 'PO_HEADERS_ALL contains header level details of purchase orders associated to the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DC_PO_HEADERS_ALL');



debug('begin add_signature: PA_DC_PO_LINES_ALL');
   l_info('##MASK##CONTRACTOR_FIRST_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CONTRACTOR_LAST_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15187',
      p_sig_id                 => 'PA_DC_PO_LINES_ALL',
      p_sig_sql                => 'SELECT * FROM po_lines_all l
WHERE l.po_line_id IN (
        SELECT d.po_line_id FROM po_distributions_all d
        WHERE d.project_id = ##$$PROJECT_ID$$##
        AND   d.task_id = nvl(##$$TASK_ID$$##, d.task_id))
ORDER BY l.po_header_id, l.po_line_id',
      p_title                  => 'PO_LINES_ALL Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found from PO_LINES_ALL for the project and task.',
      p_solution               => '',
      p_success_msg            => 'PO_LINES_ALL contains line level details of purchase order transactions in procurement which are associated to the project and its budgetary controls.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DC_PO_LINES_ALL');



debug('begin add_signature: PA_DC_PO_DISTRIBUTIONS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6047',
      p_sig_id                 => 'PA_DC_PO_DISTRIBUTIONS_ALL',
      p_sig_sql                => 'SELECT * FROM po_distributions_all d
WHERE d.project_id = ##$$PROJECT_ID$$##
AND   d.task_id = nvl(##$$TASK_ID$$##, d.task_id)
ORDER BY d.po_header_id, d.po_line_id, d.line_location_id,
         d.distribution_num',
      p_title                  => 'PO_DISTRIBUTIONS_ALL Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found from PO_DISTRIBUTIONS_ALL for the project and task.',
      p_solution               => '',
      p_success_msg            => 'PO_DISTRIBUTIONS_ALL contains distribution level details of purchase order transaction in procurement which are associated to the project and its budgetary controls.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DC_PO_DISTRIBUTIONS_ALL');



debug('begin add_signature: PA_DC_PO_REQUISITION_HEADERS_ALL');
   l_info('##MASK##CLM_ASSIST_CONTACT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CLM_COTR_CONTACT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6048',
      p_sig_id                 => 'PA_DC_PO_REQUISITION_HEADERS_ALL',
      p_sig_sql                => 'SELECT * FROM po_requisition_headers_all rh
WHERE rh.requisition_header_id IN (
        SELECT l.requisition_header_id
        FROM po_requisition_lines_all l,
             po_req_distributions_all d
        WHERE l.requisition_line_id = d.requisition_line_id
        AND   d.project_id = ##$$PROJECT_ID$$##
        AND   d.task_id = nvl(##$$TASK_ID$$##, d.task_id))
ORDER BY rh.segment1',
      p_title                  => 'PO_REQUISITION_HEADERS_ALL Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found from PO_REQUISITION_HEADERS_ALL for the project and task.',
      p_solution               => '',
      p_success_msg            => 'PO_REQUISTION_HEADERS_ALL displays header level data for requisitions in procurement that are associated with the Project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DC_PO_REQUISITION_HEADERS_ALL');



debug('begin add_signature: PA_DC_PO_REQUISITION_LINES_ALL');
   l_info('##MASK##ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CANDIDATE%NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CONTACT_INFORMATION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##GLOBAL_ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##NOTE_TO%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##REQUESTER%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SUGGESTED_VENDOR%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15189',
      p_sig_id                 => 'PA_DC_PO_REQUISITION_LINES_ALL',
      p_sig_sql                => 'SELECT * FROM po_requisition_lines_all l
WHERE l.requisition_line_id IN (
        SELECT d.requisition_line_id FROM po_req_distributions_all d
        WHERE d.project_id = ##$$PROJECT_ID$$##
        AND   d.task_id = nvl(##$$TASK_ID$$##, d.task_id))
ORDER BY l.requisition_header_id, l.requisition_line_id',
      p_title                  => 'PO_REQUISITION_LINES_ALL Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found from PO_REQUISITION_LINES_ALL for the project and task.',
      p_solution               => '',
      p_success_msg            => 'PO_REQUISITION_LINES_ALL contains line level details of purchase requisition transactions in procurement which are associated to the project and its budgetary controls.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DC_PO_REQUISITION_LINES_ALL');



debug('begin add_signature: PA_DC_PO_REQ_DISTRIBUTIONS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6049',
      p_sig_id                 => 'PA_DC_PO_REQ_DISTRIBUTIONS_ALL',
      p_sig_sql                => 'SELECT * FROM po_req_distributions_all d
WHERE d.project_id = ##$$PROJECT_ID$$##
AND   d.task_id = nvl(##$$TASK_ID$$##, d.task_id)',
      p_title                  => 'PO_REQ_DISTRIBUTIONS_ALL Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found from PO_REQ_DISTRIBUTIONS_ALL for the project and task.',
      p_solution               => '',
      p_success_msg            => 'PO_REQ_DISTRIBUTIONS_ALL contains data related to purchase requisitions in procurement.  These transactions are involved in funds check operations in Projects.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DC_PO_REQ_DISTRIBUTIONS_ALL');



debug('begin add_signature: PA_DC_PA_RESOURCE_ASSIGNMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6720',
      p_sig_id                 => 'PA_DC_PA_RESOURCE_ASSIGNMENTS',
      p_sig_sql                => 'SELECT * FROM pa_resource_assignments ra
WHERE ra.project_ID = ##$$PROJECT_ID$$##
AND   ra.task_ID = nvl(##$$TASK_ID$$##, ra.task_id)
AND   ra.budget_version_id IN (
        SELECT bv.budget_version_id FROM pa_budget_versions bv
        WHERE bv.project_id = ##$$PROJECT_ID$$##
        AND bv.budget_type_code IN (
...
ORDER BY budget_version_id',
      p_title                  => 'PA_RESOURCE_ASSIGNMENTS Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found from PA_RESOURCE_ASSIGNMENTS for the Project/Task.',
      p_solution               => '',
   ...
   l_info.delete;
debug('end add_signature: PA_DC_PA_RESOURCE_ASSIGNMENTS');
...
debug('begin add_signature: PA_DC_PA_RESOURCE_LIST_MEMBERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20450',
      p_sig_id                 => 'PA_DC_PA_RESOURCE_LIST_MEMBERS',
      p_sig_sql                => 'SELECT *
FROM pa_resource_list_members
WHERE resource_list_member_id IN (SELECT resource_list_member_id FROM pa_resource_assignments ra
WHERE ra.project_ID = ##$$PROJECT_ID$$##
AND   ra.task_ID = nvl(##$$TASK_ID$$##, ra.task_id)
AND   ra.budget_version_id IN (
        SELECT bv.budget_version_id FROM pa_budget_versions bv
        ...
        AND bv.budget_type_code IN (
              ...
              FROM pa_budgetary_control_options
              WHERE project_id = ##$$PROJECT_ID$$##)))',
      p_title                  => 'PA_RESOURCE_LIST_MEMBERS Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found for PA_RESOURCE_LIST_MEMBERS for the project/task',
      p_solution               => '',
      p_success_msg            => 'PA_RESOURCE_LIST_MEMBERS contains data for resources attached to project''s budget. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DC_PA_RESOURCE_LIST_MEMBERS');



debug('begin add_signature: PA_AVAILABLE_FUNDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15547',
      p_sig_id                 => 'PA_AVAILABLE_FUNDS',
      p_sig_sql                => 'select prj.segment1 Project_number, pt.task_number,
         sum(bal.actual_period_to_date) Actuals,
         sum(bal.encumb_period_to_date) Encumbrances,
         sum(bal.budget_period_to_date) Budget,
         (sum(bal.budget_period_to_date) - sum(bal.actual_period_to_date) - sum(bal.encumb_period_to_date)) Available_Funds
from pa_bc_balances bal,
       pa_projects_all prj,
       pa_budget_versions bv,
       pa_tasks pt
where bal.project_id = prj.project_id
and bal.task_id = pt.task_id
and bal.budget_version_id = bv.budget_version_id
and bv.project_id = bal.project_id
and bv.budget_status_code = ''B''
and bv.current_flag = ''Y''
and prj.project_id = ##$$PROJECT_ID$$##
group by prj.segment1, pt.task_number 
order by pt.task_number',
      p_title                  => 'PA_AVAILABLE_FUNDS',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Project Funds Status',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PA_AVAILABLE_FUNDS');



debug('begin add_signature: PA_DC_FAILED_PA_BC_PACKETS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22353',
      p_sig_id                 => 'PA_DC_FAILED_PA_BC_PACKETS',
      p_sig_sql                => 'SELECT pbc.*,pl.meaning "Result Code Description"
FROM pa_bc_packets pbc, pa_lookups pl
WHERE pbc.project_id = ##$$PROJECT_ID$$##
and pbc.task_id = nvl(##$$TASK_ID$$##, task_id)
and pbc.result_code LIKE ''F%''
and pbc.result_code = pl.lookup_code
and pl.lookup_type = ''FC_RESULT_CODE''',
      p_title                  => 'Failed Funds Check Packet Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found from PA_BC_PACKETS with failure result code  for the project.',
      p_solution               => '',
      p_success_msg            => 'Provides information of failed funds check packet data. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DC_FAILED_PA_BC_PACKETS');



debug('begin add_signature: FIN_PA_PJC_FC_PA_DC_PA_FIN_PLAN_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22771',
      p_sig_id                 => 'FIN_PA_PJC_FC_PA_DC_PA_FIN_PLAN_TYPES',
      p_sig_sql                => 'select t.name, t.description, t.language, b.*
from PA_FIN_PLAN_TYPES_B b, PA_FIN_PLAN_TYPES_TL t
where b.fin_plan_type_id = t.fin_plan_type_id
and b.fin_plan_type_id in ( select bco.fin_plan_type_id from pa_budgetary_control_options bco
where bco.project_id = ##$$PROJECT_ID$$##)',
      p_title                  => 'PA_FIN_PLAN_TYPES_B Table',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found from PA_FIN_PLAN_TYPES_B for the project.',
      p_solution               => '',
      p_success_msg            => 'PA_FIN_PLAN_TYPES_B contains line level information for the controlled project financial plan types.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: FIN_PA_PJC_FC_PA_DC_PA_FIN_PLAN_TYPES');



debug('begin add_signature: FIN_PA_PJC_FC_PA_DC_PA_PROJ_FP_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22772',
      p_sig_id                 => 'FIN_PA_PJC_FC_PA_DC_PA_PROJ_FP_OPTIONS',
      p_sig_sql                => 'SELECT * FROM PA_PROJ_FP_OPTIONS
WHERE project_id =  ##$$PROJECT_ID$$##
AND FIN_PLAN_TYPE_ID in ( SELECT bco.fin_plan_type_id
FROM pa_budgetary_control_options bco
WHERE bco.project_id = ##$$PROJECT_ID$$##)',
      p_title                  => 'PA_PROJ_FP_OPTIONS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found from PA_PROJ_FP_OPTIONS for the project.',
      p_solution               => '',
      p_success_msg            => 'PA_PROJ_FP_OPTIONS contains line level information for the controlled project financial plan types.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: FIN_PA_PJC_FC_PA_DC_PA_PROJ_FP_OPTIONS');
...
debug('begin add_signature: PA_DC_PA_BUDGET_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6016',
      p_sig_id                 => 'PA_DC_PA_BUDGET_LINES',
      p_sig_sql                => 'SELECT * FROM pa_budget_lines bl
WHERE bl.budget_version_id IN (
SELECT bv.budget_version_id FROM pa_budget_versions bv
WHERE bv.project_id = ##$$PROJECT_ID$$##
AND (nvl(bv.budget_type_code, ''xxx''), NVL(bv.fin_plan_type_id, -9999)) IN (
SELECT nvl(bco.budget_type_code, ''xxx''), NVL(bco.fin_plan_type_id, -9999)
FROM pa_budgetary_control_options bco
WHERE bco.project_id = ##$$PROJECT_ID$$##))
ORDER BY bl.budget_version_id, bl.resource_assignment_id, bl.start_date ',
      p_title                  => 'PA_BUDGET_LINES Table',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found from PA_BUDGET_LINES for the project.',
      p_solution               => '',
      p_success_msg            => 'PA_BUDGET_LINES contains line level information for the controlled project budgets.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DC_PA_BUDGET_LINES');



debug('begin add_signature: PA_DC_PA_BUDGET_ACCT_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6015',
      p_sig_id                 => 'PA_DC_PA_BUDGET_ACCT_LINES',
      p_sig_sql                => 'SELECT * FROM pa_budget_acct_lines bal
WHERE bal.budget_version_id IN (
SELECT bv.budget_version_id FROM pa_budget_versions bv
WHERE bv.project_id = ##$$PROJECT_ID$$##
AND (nvl(bv.budget_type_code, ''xxx''), NVL(bv.fin_plan_type_id, -9999)) IN (
SELECT nvl(bco.budget_type_code, ''xxx''), NVL(bco.fin_plan_type_id, -9999)
FROM pa_budgetary_control_options bco
WHERE bco.project_id = ##$$PROJECT_ID$$##))
ORDER BY bal.budget_version_id, bal.start_date',
      p_title                  => 'PA_BUDGET_ACCT_LINES Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found from PA_BUDGET_ACCT_LINES for the project.',
      p_solution               => '',
      p_success_msg            => 'PA_BUDGET_ACCT_LINES contains accounting data for project budget amounts and funds check results for the accounts against the associated GL budget.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DC_PA_BUDGET_ACCT_LINES');



debug('begin add_signature: EBS_PA_PA_PJC_FC_TRANSACTION_SOURCE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25815',
      p_sig_id                 => 'EBS_PA_PA_PJC_FC_TRANSACTION_SOURCE',
      p_sig_sql                => 'SELECT * 
FROM pa_transaction_sources 
WHERE nvl(process_funds_check,''N'') = ''Y''',
      p_title                  => 'Transaction Sources (PA_TRANSACTION_SOURCES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No transaction source exists for which budgetary control is enabled.',
      p_solution               => '',
      p_success_msg            => 'These are transaction sources for which budgetary control is enabled.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_PA_PA_PJC_FC_TRANSACTION_SOURCE');



debug('begin add_signature: EBS_PA_PA_PJC_FC_BC_PACKET_HIST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25818',
      p_sig_id                 => 'EBS_PA_PA_PJC_FC_BC_PACKET_HIST',
      p_sig_sql                => 'SELECT * FROM pa_bc_packets_hist
WHERE project_id = ##$$PROJECT_ID$$##
and task_id = nvl(##$$TASK_ID$$##, task_id)',
      p_title                  => 'Audit Trail Details For PA_BC_PACKETS (PA_BC_PACKETS_HIST)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No audit trail details found in PA_BC_PACKETS_HIST for the project.',
      p_solution               => '',
      p_success_msg            => 'Audit trail details found in PA_BC_PACKETS_HIST for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_PA_PA_PJC_FC_BC_PACKET_HIST');



debug('begin add_signature: EBS_PA_PA_PJC_FC_AUDIT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25817',
      p_sig_id                 => 'EBS_PA_PA_PJC_FC_AUDIT',
      p_sig_sql                => 'SELECT * FROM pa_fc_audit
WHERE project_id = ##$$PROJECT_ID$$##
and task_id = nvl(##$$TASK_ID$$##, task_id)',
      p_title                  => 'Funds Check Audit Details (PA_FC_AUDIT)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No funds check audit details exist for the project.',
      p_solution               => '',
      p_success_msg            => 'Funds check audit details exist for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_PA_PA_PJC_FC_AUDIT');
...
BEGIN
  ...
  analyzer_title := 'Projects Funds Check Analyzer';
...
debug('begin section: UPGRADE');
start_section('Upgrade ', 'UPGRADE');
   set_item_result(run_stored_sig('PA_FC_UPG_SI_MISSING_EVENTS'));
   set_item_result(run_stored_sig('PA_FC_UPG_EI_NOT_UPG'));
   set_item_result(run_stored_sig('PA_FC_UPG_PJ_CMTS_NOT_UPG'));
end_section('No upgrade related issues detected.');
debug('end section: UPGRADE');

debug('begin section: BUDGET_BASELINE');
start_section('Budget Baseline', 'BUDGET_BASELINE');
   set_item_result(run_stored_sig('PA_FC_BUD_BL_REJ_STATUS'));
   set_item_result(run_stored_sig('PA_FC_BUD_BL_ERRORS'));
   set_item_result(run_stored_sig('PA_FC_BUD_BL_F128'));
   set_item_result(run_stored_sig('PA_FC_BUD_BL_SEQUENCE_LIMIT'));
   set_item_result(run_stored_sig('PA_FC_BUD_BL_F107'));
end_section('No issues affecting budget baseline detected.');
debug('end section: BUDGET_BASELINE');

debug('begin section: DOC_APPROVAL');
start_section('Document Approval', 'DOC_APPROVAL');
   set_item_result(run_stored_sig('PA_FC_DOC_APP_SLA_ERROR'));
   set_item_result(run_stored_sig('PA_FC_DOC_APP_F132_ERROR'));
end_section('No issues with document approval detected.');
debug('end section: DOC_APPROVAL');

debug('begin section: DATA_CORRUPTION');
start_section('Data Issues', 'DATA_CORRUPTION');
   set_item_result(run_stored_sig('PA_FC_DATA_CORR_GL_DATE_OUT_OF_RNG'));
   set_item_result(run_stored_sig('PA_WORKFLOW_WF_STATUS_CODE_IN_ROUTE'));
   set_item_result(run_stored_sig('PA_FC_DATA_CORR_UNRELIEVED_CMT_CANC_REQ'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PA_PJC_FC_UNRELIEVED_COMMITMENTS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PA_PJC_FC_INCORRECT_COMMITMENT'));
end_section('No data corruption issues detected.');
debug('end section: DATA_CORRUPTION');

debug('begin section: DATA_COLLECTION');
start_section('Data Collection', 'DATA_COLLECTION');
   set_item_result(run_stored_sig('PA_DC_PA_PROJECT_TYPES_ALL'));
   set_item_result(run_stored_sig('PA_DC_PA_PROJECTS_ALL'));
   set_item_result(run_stored_sig('PA_DC_PA_TASKS'));
   set_item_result(run_stored_sig('PA_DC_PA_BC_PACKETS'));
   set_item_result(run_stored_sig('PA_DC_GL_BC_PACKETS'));
   set_item_result(run_stored_sig('PA_DC_PA_BC_BALANCES'));
   set_item_result(run_stored_sig('PA_DC_PA_BC_COMMITMENTS_ALL'));
   set_item_result(run_stored_sig('PA_DC_PA_BUDGETARY_CONTROL_OPTIONS'));
   set_item_result(run_stored_sig('PA_DC_PA_BUDGET_VERSIONS'));
   set_item_result(run_stored_sig('PA_DC_PA_BUDGET_ENTRY_METHODS'));
   set_item_result(run_stored_sig('PA_DC_PA_BUDGET_TYPES'));
   set_item_result(run_stored_sig('PA_DC_AP_INVOICES_ALL'));
   set_item_result(run_stored_sig('PA_DC_AP_INVOICE_DISTRIBUTIONS_ALL'));
   set_item_result(run_stored_sig('PA_DC_PA_EXPENDITURE_ITEMS_ALL'));
   set_item_result(run_stored_sig('PA_DC_PA_COST_DISTRIBUTION_LINES_ALL'));
   set_item_result(run_stored_sig('PA_DC_PO_HEADERS_ALL'));
   set_item_result(run_stored_sig('PA_DC_PO_LINES_ALL'));
   set_item_result(run_stored_sig('PA_DC_PO_DISTRIBUTIONS_ALL'));
   set_item_result(run_stored_sig('PA_DC_PO_REQUISITION_HEADERS_ALL'));
   set_item_result(run_stored_sig('PA_DC_PO_REQUISITION_LINES_ALL'));
   set_item_result(run_stored_sig('PA_DC_PO_REQ_DISTRIBUTIONS_ALL'));
   set_item_result(run_stored_sig('PA_DC_PA_RESOURCE_ASSIGNMENTS'));
   set_item_result(run_stored_sig('PA_COST_INT_FLAGS'));
   set_item_result(run_stored_sig('PA_DC_PA_RESOURCE_LIST_MEMBERS'));
   set_item_result(run_stored_sig('PA_AVAILABLE_FUNDS'));
   set_item_result(run_stored_sig('PA_DC_FAILED_PA_BC_PACKETS'));
   set_item_result(run_stored_sig('FIN_PA_PJC_FC_PA_DC_PA_FIN_PLAN_TYPES'));
   set_item_result(run_stored_sig('FIN_PA_PJC_FC_PA_DC_PA_PROJ_FP_OPTIONS'));
   IF ((substr(g_rep_info('Apps Version'),1,6) >= '12.2.5') OR
    (substr(g_rep_info('Apps Version'),1,7) >= '12.2.10')) THEN
      set_item_result(run_stored_sig('PA_DC_PA_BUDGET_LINES'));
      set_item_result(run_stored_sig('PA_DC_PA_BUDGET_ACCT_LINES'));
      set_item_result(run_stored_sig('EBS_PA_PA_PJC_FC_TRANSACTION_SOURCE'));
      set_item_result(run_stored_sig('EBS_PA_PA_PJC_FC_BC_PACKET_HIST'));
      set_item_result(run_stored_sig('EBS_PA_PA_PJC_FC_AUDIT'));
   END IF;
end_section;
debug('end section: DATA_COLLECTION');
