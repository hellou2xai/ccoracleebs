...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Financials for EMEA Analyzer           |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE fin_emea_analyzer_pkg AUTHID DEFINER AS
...
PROCEDURE main
(            p_vat_rep_entity_id            IN NUMBER      DEFAULT NULL
           ,p_emea_vat_sel_process         IN NUMBER      DEFAULT NULL
...
END fin_emea_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY fin_emea_analyzer_pkg AS
-- $Id: fin_emea_analyzer.sql, 200.15 2026/01/28 07:13:01 saananth Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2431799.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'JE_FIN_EMEA_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'JE_FIN_EMEA_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>JE_FIN_EMEA Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2431799.1#feedback");
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4274520" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">1314</span>
...
<p>Version 200.15:</p><ol><li>Framework Changes (Doc to KB)</li>
<li>ATG, PREMIER SUPPORT, INDE Sigs Enhanced</li>
</ol>
<p>Version 200.14:</p><ol><li>Framework Changes (Links Pointing to MOSFS instead of MOS,Patch Downloads)</li>
<li>ATG Sequence Signature Enhanced</li>
<li>1 EMEA Signature Enhanced</li>
</ol>
<p>Version 200.13:</p><ol><li>New Analyzer Framework version 4.7.3 released with enhancements.<ol><li>SQL*Plus Error fixed: SP2-0027: Input is too long</li>
<li>Ability to click to select rows in output tables</li>
</ol>
</li>
<li>Enhanced 3 signatures.</li>
</ol>
<p>Version 200.12:</p><ol><li>New Analyzer Framework version 4.7.1 released with enhancements.</li>
<li>Enhanced 6 signatures.</li>
</ol>
<p>Version 200.11:</p><ol><li>For "Critical Alerts" section, the following 2 new signatures were updated to check for Oracle Database 12c/11g version:</li>
</ol>
<ul><li>Sequences with 32-bit maximum value and large cache size</li>
<li>Sequences above 70 percent of maximum value</li>
</ul>
<p>Version 200.10:</p><ol><li>New Analyzer Framework version 4.6.1 released with enhancements.</li>
<li>"Lifetime Support Policy" section renamed to "Critical Alerts" and the following 2 new signatures have been added:</li>
</ol>
<ul><li>Sequences with 32-bit maximum value and large cache size</li>
<li>Sequences above 70 percent of maximum value</li>
</ul>
<p>Version 200.9:</p><ul><li><span style="font-family:&apos;Times New Roman&apos;,serif;font-size:12.0pt;mso-fareast-font-family:&apos;Times New Roman&apos;;">New Analyzer Framework version 4.6.0.1 released with bug fixes.</span></li>
</ul>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1314,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Financials Common Applications" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1314,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Financials Common Applications" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1314,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Financials Common Applications" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
BEGIN
    ...
    print_log('Processing recommended patches signature: JE_TRL_PATCHES (check_rec_patches_1) "Recommended TRL Patches" (version 8)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.0' THEN
   ...
   l_col_rows(1)(l_rows) := '21528195';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'ARGENTINE RG3685 REPORTS ENHANCEMENT';
   l_col_rows(5)(l_rows) := '[737320.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.1: E-BUSINESS TAX REPORTING RECOMMENDED PATCH COLLECTION (ZX Reports RPC), FEB 2016';
   l_col_rows(5)(l_rows) := '[737320.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.2 : ARGENTINE RG3685 REPORTS ENHANCEMENT';
   l_col_rows(5)(l_rows) := '[737320.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.0' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21440455';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'ZXXVATRN : PERFORMANCE ISSUES WITH TAX RECONCILIATION REPORT';
   l_col_rows(5)(l_rows) := '[737320.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25702324';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'European Sales Listing does not filter based on Reporting context when run for Legal Entity';
   l_col_rows(5)(l_rows) := '[737320.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.0' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25183123';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'FINANCIAL TAX REGISTER SHOWING INCORRECT TAXABLE AMOUNT FOR TRX WITH IPV';
   l_col_rows(5)(l_rows) := '[737320.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.0' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '22572034';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'FINANCIAL TAX REGISTER DOES NOT SHOW GL ACCOUNTS OF AR MISC RECEIPTS';
   l_col_rows(5)(l_rows) := '[737320.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '24482371';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'TAX RECONCILIATION REPORT SHOWING DOUBLE TAX AMOUNTS FOR SOME INVOICES';
   l_col_rows(5)(l_rows) := '[737320.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.0' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21952159';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'FINANCIAL TAX REGISTER: WRONG AMOUNTS FOR TAXABLE AMOUNT AND TAXABLE DISCOUNT AM';
   l_col_rows(5)(l_rows) := '[737320.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '23524970';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'TAXABLE_AMT IS NULL IN EMEA VAT SELECTION PROCESS FOR INVOICES WITH ITEM & TAX HAVING DIFFERENT EVENT ID';
   l_col_rows(5)(l_rows) := '[737320.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.0' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '22904648';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'HEADER TAX ROUNDING IS INCORRECT WHEN LINE ATTRIBUTES WAS MODIFIED ON COPIED INV';
   l_col_rows(5)(l_rows) := '[737320.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26745530';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'ER:Online VAT Reporting For Spain(SII)';
   l_col_rows(5)(l_rows) := '[737320.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.0' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21250488';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'REVERSE MISC RECEIPT SHOWS INCORRECTLY IN TAX RECONCILIATION BY TAXABLE ACCOUNT';
   l_col_rows(5)(l_rows) := '[737320.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25188052';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'ZXJGTAX : PERFORMANCE TAX RECONCILIATION BY TAXABLE ACCOUNT REPORT';
   l_col_rows(5)(l_rows) := '[737320.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21944577';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'TAX RECONCILIATION BY TAXABLE ACCOUNT DISPLAYS ADJUSTMENTS WITH NULL AMOUNTS WHEN NO INVOICES ARE REPORTED FOR THE PERIOD';
   l_col_rows(5)(l_rows) := '[737320.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.0' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19878374';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'CHILEAN PAYABLES PURCHASE LEDGER IS LISTING FOREIGN TRANSACTIONS ON USD AMOUNTS';
   l_col_rows(5)(l_rows) := '[737320.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '24350310';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'CHILEAN PAYABLES PURCHASE LEDGER SHOWS INCORRECT AMT FOR LINE WITH NO TAX LINE';
   l_col_rows(5)(l_rows) := '[737320.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.0' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '22919311';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'FINANCIAL TAX REGISTER DOES NOT DISPLAY AR TRX WITH PARAMETER TRANSFER TO GL';
   l_col_rows(5)(l_rows) := '[737320.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26197666';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'ITALIAN PURCHASE VAT REGISTER SHOWS INCORRECT AMOUNTS FOR INVOICES WITH TAX LINE IMPORTED';
   l_col_rows(5)(l_rows) := '[737320.1]';
...
END IF;
   ...
   l_sig.sigrepo_id := '9912';
   l_sig.title := 'Recommended TRL Patches';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := 'You have recommended patch(es) that are not applied on this environment. Please expand the list above for the details.';
...
<li>[1469025/KB214472] What Are The Latest Patches for Financials for EMEA</li>
</ul>';
   l_sig.success_msg := 'All the recommended patches are applied.';
  ...
  -- Register
  l_step := '60';
  g_signatures('JE_TRL_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'JE_TRL_PATCHES',     -- sig ID
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'VAT Reporting Entity ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_vat_rep_entity_id,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'EMEA VAT Selection Process - Request ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_emea_vat_sel_process,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Application Name';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_application,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Transaction ID / Invoice ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_transaction_id,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/01/28 07:12:59 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'fin_emea_analyzer.sql';
...
debug('begin parameter validation: p_vat_rep_entity_id');
IF p_vat_rep_entity_id IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter VAT Reporting Entity ID is required.');
   raise invalid_parameters;
END IF;
IF p_vat_rep_entity_id IS NOT NULL THEN
BEGIN
SELECT VAT_REPORTING_ENTITY_ID
INTO l_exists_val
FROM JG_ZZ_VAT_REP_ENTITIES
WHERE VAT_REPORTING_ENTITY_ID = p_vat_rep_entity_id and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid VAT Reporting Entity Id provided.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_vat_rep_entity_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_vat_rep_entity_id');

debug('begin parameter validation: p_emea_vat_sel_process');
IF p_emea_vat_sel_process IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter EMEA VAT Selection Process - Request ID is required.');
   raise invalid_parameters;
END IF;
IF p_emea_vat_sel_process IS NOT NULL THEN
BEGIN
SELECT REQUEST_ID
INTO l_exists_val
FROM ZX_REP_CONTEXT_T
WHERE REQUEST_ID = p_emea_vat_sel_process and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid EMEA VAT Selection Process - Request ID provided.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_emea_vat_sel_process failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_emea_vat_sel_process');

debug('begin parameter validation: p_application');
IF p_application IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Application Name is required.');
   raise invalid_parameters;
END IF;
IF p_application IS NOT NULL AND p_application NOT IN ( 'Payables','Receivables') THEN
   print_error('INVALID ARGUMENT: Invalid application name specified.
Value should be Payables or Receivables.');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_application');

debug('begin parameter validation: p_transaction_id');
IF p_transaction_id IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Transaction ID / Invoice ID is required.');
   raise invalid_parameters;
END IF;
...
INTO l_exists_val
FROM ZX_LINES 
WHERE TRX_ID = p_transaction_id and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: This Transaction ID does not exist in ZX_LINES table.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_transaction_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_transaction_id');
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$VAT_REP_ENTITY_ID$$##') := p_vat_rep_entity_id;
   g_masked_tokens('##$$VAT_REP_ENTITY_ID$$##') := mask_text( g_sql_tokens('##$$VAT_REP_ENTITY_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$EMEA_VAT_SELECTION_PROCESS$$##') := p_emea_vat_sel_process;
   g_masked_tokens('##$$EMEA_VAT_SELECTION_PROCESS$$##') := mask_text( g_sql_tokens('##$$EMEA_VAT_SELECTION_PROCESS$$##'), 'NO_MASK');
   g_sql_tokens('##$$TRANSACTION_ID$$##') := p_transaction_id;
   g_masked_tokens('##$$TRANSACTION_ID$$##') := mask_text( g_sql_tokens('##$$TRANSACTION_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPLICATION$$##') := p_application;
   g_masked_tokens('##$$APPLICATION$$##') := mask_text( g_sql_tokens('##$$APPLICATION$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM1$$##') := '7002';
   g_masked_tokens('##$$APPS_PARAM1$$##') := mask_text( g_sql_tokens('##$$APPS_PARAM1$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM2$$##') := '7003';
   g_masked_tokens('##$$APPS_PARAM2$$##') := mask_text( g_sql_tokens('##$$APPS_PARAM2$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM3$$##') := '235';
...
debug('begin add_signature: JE_INVALID_OBJECTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13017',
      p_sig_id                 => 'JE_INVALID_OBJECTS',
...
AND a.owner = ''APPS''
AND (a.object_name like ''ZX_%'' or a.object_name like ''JG_%'' or a.object_name like ''JE_%'')
AND a.status = ''INVALID''',
      p_title                  => 'Invalid Objects',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invalid Objects found for ZX, JE or JG modules.',
...
<li>If you still have invalid objects, please review steps from [1325394/KB401905] Troubleshooting Guide - Invalid Objects in the E-Business Suite Environment 11i and 12</li>
      ...
      p_success_msg            => 'There are no invalid objects for ZX, JE or JG modules.',
   ...
   l_info.delete;
debug('end add_signature: JE_INVALID_OBJECTS');



debug('begin add_signature: JE_TAX_REGIME_UPGRADE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10345',
      p_sig_id                 => 'JE_TAX_REGIME_UPGRADE',
   ...
   GROUP BY tax_regime_code',
      p_title                  => 'Tax Regime Migration',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Tax regime is not migrated and cannot be calculated.',
      p_solution               => 'Log a Service Request with Oracle E-Business Tax support and upload this analyzer output for reference.  
Review Section 11 of Doc [1316316/KB731274#aref_section311] EB-Tax Data Corruption Issues & Recommended Solutions for more information.  
',
      p_success_msg            => 'Tax Regime is correctly migrated.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: JE_TAX_REGIME_UPGRADE');



debug('begin add_signature: JE_TAX_STATUS_UPGRADE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10349',
      p_sig_id                 => 'JE_TAX_STATUS_UPGRADE',
      p_sig_sql                => 'SELECT tax_regime_code,
      tax,
      tax_status_code,
      MIN(effective_from) effective_from
    ...
    GROUP BY tax_regime_code,
      tax,
      tax_status_code',
      p_title                  => 'Tax Status Migration',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Tax Status is not correctly migrated to R12.',
      p_solution               => 'Log a Service Request with Oracle E-Business Tax support and upload this analyzer output for reference.<br>  
Review Section 11 of Doc [1316316/KB731274#aref_section311] EB-Tax Data Corruption Issues & Recommended Solutions for more information.',
      p_success_msg            => 'Tax Status is correctly migrated to R12.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_TAX_STATUS_UPGRADE');



debug('begin add_signature: JE_TAX_UPGRADE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10347',
      p_sig_id                 => 'JE_TAX_UPGRADE',
      p_sig_sql                => 'SELECT tax_regime_code,
      tax,
      MIN(effective_from) effective_from
    FROM zx_update_criteria_results results
    ...
    GROUP BY tax_regime_code,
      tax',
      p_title                  => 'Tax Migration',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Tax is not migrated.
',
      p_solution               => 'Log a Service Request with Oracle E-Business Tax support and upload this analyzer output for reference.<br>  
Review Section 11 of Doc [1316316/KB731274#aref_section311] EB-Tax Data Corruption Issues & Recommended Solutions for more information.',
      p_success_msg            => 'Taxes are correctly migrated to R12.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_TAX_UPGRADE');



debug('begin add_signature: JE_TAX_RATE_UPGRADE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10348',
      p_sig_id                 => 'JE_TAX_RATE_UPGRADE',
      p_sig_sql                => 'SELECT ''Receivables'' Application, codes.tax_code tax_code, codes.last_update_date,codes.last_updated_by last_updared_by,codes.set_of_books_id set_of_books_id, codes.tax_type tax_type,
codes.last_update_login last_update_login,codes.created_by created_by,codes.creation_date creation_date, codes.tax_rate tax_rate,codes.org_id org_id,
codes.vat_tax_id tax_id,codes.global_attribute_category global_attribute_category,codes.enabled_flag enabled_flag,codes.start_date start_date
,codes.end_date end_date
    FROM AR_VAT_TAX_ALL codes
    WHERE codes.TAX_TYPE NOT IN (''TAX_GROUP'', ''LOCATION'')
    AND NOT EXISTS (SELECT 1
                      FROM ZX_RATES_B
                     WHERE TAX_RATE_ID = VAT_TAX_ID
                       AND TAX_CLASS = ''OUTPUT'')
union all
SELECT  ''Payables'' Application, codes.name tax_code, codes.last_update_date,codes.last_updated_by last_updared_by,codes.set_of_books_id set_of_books_id, codes.tax_type tax_type,
codes.last_update_login last_update_login,codes.created_by created_by,codes.creation_date creation_date, codes.tax_rate tax_rate,codes.org_id org_id,
codes.tax_id tax_id,codes.global_attribute_category global_attribute_category,codes.enabled_flag enabled_flag,codes.start_date start_date
,codes.inactive_date end_date
...
AND NOT EXISTS (SELECT 1 FROM ZX_RATES_B
            ...
            AND TAX_CLASS = ''INPUT'')',
      p_title                  => 'Tax Rate Migration',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Tax Rate Setup is not migrated or there is no Tax calculation for this specific Tax Rate.',
      p_solution               => 'Review section 11. Tax Setup not migrated of Doc [1316316/KB731274#aref_section311], and log a Service Request against Oracle E-Business Tax product to get a Datafix.',
      p_success_msg            => 'Tax Rate Setup is migrated correctly.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_TAX_RATE_UPGRADE');



debug('begin add_signature: JE_JG_ZZ_VAT_REGISTERS_VL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9341',
      p_sig_id                 => 'JE_JG_ZZ_VAT_REGISTERS_VL',
      p_sig_sql                => 'SELECT
    jzvr.vat_reporting_entity_id,
    jzvr.legal_entity_id,
    jzvr.party_id,
    jzvr.creation_date,
    jzvr.entity_level_code,
    jzvr.entity_type_code,
    jzvr.entity_identifier
FROM
    jg_zz_vat_rep_entities jzvr
WHERE
        jzvr.vat_reporting_entity_id = ##$$VAT_REP_ENTITY_ID$$##
    AND NOT EXISTS (
        SELECT
            1
        FROM
            jg_zz_vat_registers_vl jzv
        WHERE
            nvl(jzvr.mapping_vat_rep_entity_id, jzvr.vat_reporting_entity_id) = jzv.vat_reporting_entity_id
    )
    AND jzvr.legal_entity_id IN (
        SELECT
            xle.legal_entity_id
        FROM
...
',
      p_title                  => 'Association Between VAT Registers and Entity Identifier (JG_ZZ_VAT_REGISTERS)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are no associations between VAT Registers and reporting Entity ID ##$$VAT_REP_ENTITY_ID$$##, which can cause issues in VAT Register reporting process.',
      p_solution               => 'Review the following for more information:<br>
- [2180204/KB229447] R12: JG: (JGZZVACF) After Upgrade To R12 Some Vat Register Are Missing From EMEA Reporting Entities Setup.<br>
- [1392535/KB314980] Troubleshooting EMEA VAT reporting issues in Release 12.',
      p_success_msg            => 'VAT Registers associated with the reporting Entity ID ##$$VAT_REP_ENTITY_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: JE_JG_ZZ_VAT_REGISTERS_VL');



debug('begin add_signature: JE_JG_ZZ_VAT_DOC_SEQUENCES_ASSIGNMENT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9342',
      p_sig_id                 => 'JE_JG_ZZ_VAT_DOC_SEQUENCES_ASSIGNMENT',
      p_sig_sql                => 'SELECT fnddoc.name, fnddoc.message_flag, fnddoc.start_date, fnddoc.end_date, fnddoc.type,    
fnddoc.TABLE_NAME, jgdoc.*           
FROM jg_zz_vat_doc_sequences jgdoc, fnd_document_sequences fnddoc         
WHERE jgdoc.vat_register_id IN             
(SELECT vat_register_id               
FROM jg_zz_vat_registers_vl            
WHERE vat_reporting_entity_id IN         
(SELECT nvl(mapping_vat_rep_entity_id,vat_reporting_entity_id)                
FROM jg_zz_vat_rep_entities                
WHERE vat_reporting_entity_id = ##$$VAT_REP_ENTITY_ID$$##)               )           
AND jgdoc.doc_sequence_id = fnddoc.doc_sequence_id          
ORDER BY fnddoc.name,               fnddoc.start_date',
      p_title                  => 'Document Sequence Information (JG_ZZ_VAT_DOC_SEQUENCES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no document sequence associated with the VAT register for the reporting Entity ##$$VAT_REP_ENTITY_ID$$##.',
      p_solution               => 'If you are using document sequencing, you will need to perform the proper setups.<br>
Review [2123565/KB641034] R12: JG: Valid Warning message APP-JG-68146 Received While Validating AP Invoices, for more information.',
      p_success_msg            => 'Document sequence is associated with the VAT register for the reporting Entity ID ##$$VAT_REP_ENTITY_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_JG_ZZ_VAT_DOC_SEQUENCES_ASSIGNMENT');



debug('begin add_signature: JE_POLAND_ALLOC_RULES_VAT_REGISTER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15432',
      p_sig_id                 => 'JE_POLAND_ALLOC_RULES_VAT_REGISTER',
      p_sig_sql                => 'SELECT * from
(SELECT distinct JZVAR.*
            FROM jg_zz_vat_alloc_rules JZVAR,
   jg_zz_vat_trx_details JZVTD
            WHERE JZVAR.vat_reporting_entity_id = ##$$VAT_REP_ENTITY_ID$$##
   AND   JZVAR.Tax_code = JZVTD.Tax
   AND JZVAR.Tax_rate_id = ##$$FK1$$##
   AND  ((JZVAR.Tax_rate_id = jzvtd.TAX_RATE_ID) OR JZVAR.Tax_rate_id is null)
   AND  ( JZVTD.Trx_id = ##$$TRANSACTION_ID$$##) 
   AND JZVAR.period_type in (''VAT REGISTERS'')
AND trunc(sysdate) BETWEEN JZVAR.effective_from_date AND nvl(JZVAR.effective_to_date, trunc(sysdate))
            UNION
            SELECT distinct JZVAR.*
            FROM jg_zz_vat_alloc_rules JZVAR,
   jg_zz_vat_trx_details JZVTD
            WHERE JZVAR.vat_reporting_entity_id IN
              (SELECT mapping_vat_rep_entity_id
               FROM jg_zz_vat_rep_entities
               WHERE vat_reporting_entity_id = ##$$VAT_REP_ENTITY_ID$$##)
   AND   JZVAR.Tax_code = JZVTD.Tax
   AND JZVAR.Tax_rate_id = ##$$FK1$$##
...
WHERE exists
(SELECT distinct JZVAR.ALLOCATION_RULE_ID
            FROM jg_zz_vat_alloc_rules JZVAR,
   jg_zz_vat_trx_details JZVTD
            WHERE JZVAR.vat_reporting_entity_id = ##$$VAT_REP_ENTITY_ID$$##
   AND   JZVAR.Tax_code = JZVTD.Tax
...
AND trunc(sysdate) BETWEEN JZVAR.effective_from_date AND nvl(JZVAR.effective_to_date, trunc(sysdate))
AND ALLOCATION_RULE_ID = ##$$FK2$$##)
            ORDER BY 3, 4, 7, 8, 9, 10',
      p_title                  => 'Multiple VAT Allocation Rules Setup for Period Type as VAT Register',
      p_fail_condition         => 'RSGT1',
      p_problem_descr          => 'There are more than one allocation rules defined for tax rate id on VAT Registers period type.
This could cause errors in the JPK VAT Register Report.

',
      p_solution               => 'Keep active only one allocation rule and end date the others.
Follow PREPARATION GUIDE FOR JPK REPORTING - Oracle Financials for Poland, Release 12',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: JE_POLAND_ALLOC_RULES_VAT_REGISTER');



debug('begin add_signature: JE_POLAND_ALLOC_RULES_VAT_INVOICE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15472',
      p_sig_id                 => 'JE_POLAND_ALLOC_RULES_VAT_INVOICE',
      p_sig_sql                => 'SELECT * from
(SELECT distinct JZVAR.*
            FROM jg_zz_vat_alloc_rules JZVAR,
   jg_zz_vat_trx_details JZVTD
   ...
   AND  ((JZVAR.Tax_rate_id = jzvtd.TAX_RATE_ID) OR JZVAR.Tax_rate_id is null)
   AND  ( JZVTD.Trx_id = ##$$TRANSACTION_ID$$##) 
   AND JZVAR.period_type in (''VAT INVOICES'')
AND trunc(sysdate) BETWEEN JZVAR.effective_from_date AND nvl(JZVAR.effective_to_date, trunc(sysdate))
            UNION
            SELECT distinct JZVAR.*
            FROM jg_zz_vat_alloc_rules JZVAR,
...
AND ALLOCATION_RULE_ID = ##$$FK2$$##)
            ORDER BY 3, 4, 7, 8, 9, 10',
      p_title                  => 'Multiple VAT Allocation Rules Setup for Period Type as VAT Invoices',
      p_fail_condition         => 'RSGT1',
      p_problem_descr          => 'There are more than one allocation rules defined for tax rate id on VAT Invoices period type.
This could cause errors in the JPK VAT Invoice Report.',
      p_solution               => 'Keep active one allocation rule and end date the others.
Follow PREPARATION GUIDE FOR JPK REPORTING - Oracle Financials for Poland, Release 12.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: JE_POLAND_ALLOC_RULES_VAT_INVOICE');



debug('begin add_signature: JE_JG_ZZ_VAT_BOX_ALLOCS_RULES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9343',
      p_sig_id                 => 'JE_JG_ZZ_VAT_BOX_ALLOCS_RULES',
      p_sig_sql                => 'SELECT distinct JZVAR.*, JZVAR.Tax_rate_id "##$$FK1$$##", JZVAR.Allocation_rule_id "##$$FK2$$##"
            FROM jg_zz_vat_alloc_rules JZVAR,
   jg_zz_vat_trx_details JZVTD
            WHERE JZVAR.vat_reporting_entity_id = ##$$VAT_REP_ENTITY_ID$$##
   AND   JZVAR.Tax_code = JZVTD.Tax 
   ...
   AND  (( JZVTD.Trx_id = ##$$TRANSACTION_ID$$## ) )
            UNION
            SELECT distinct JZVAR.*, JZVAR.Tax_rate_id "##$$FK1$$##", JZVAR.Allocation_rule_id "##$$FK2$$##"
            FROM jg_zz_vat_alloc_rules JZVAR,
   jg_zz_vat_trx_details JZVTD
            WHERE JZVAR.vat_reporting_entity_id IN
              (SELECT mapping_vat_rep_entity_id
   ...
   AND    (( JZVTD.Trx_id = ##$$TRANSACTION_ID$$## ) )   
            ORDER BY 3, 4, 7, 8, 9, 10',
      p_title                  => 'VAT Box Allocation Rules Setup',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no allocation rules created for the Entity ID ##$$VAT_REP_ENTITY_ID$$## and Invoice ID / Transaction ID ##$$TRANSACTION_ID$$##.<br>
This could cause errors in the Allocation Errors Listing Report.',
      p_solution               => 'Review [2088611/KB642814] R12: JG: (JGZZAERL) Allocation Errors Listing Report - NO_RULE_APPLICABLE for more information.
',
      p_success_msg            => 'Allocation rules for the Entity ID ##$$VAT_REP_ENTITY_ID$$## and Invoice ID / Transaction ID ##$$TRANSACTION_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('JE_POLAND_ALLOC_RULES_VAT_REGISTER','JE_POLAND_ALLOC_RULES_VAT_INVOICE'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '47'
      );
   l_info.delete;
debug('end add_signature: JE_JG_ZZ_VAT_BOX_ALLOCS_RULES');



debug('begin add_signature: JE_IL_VAT_LIMITS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9345',
      p_sig_id                 => 'JE_IL_VAT_LIMITS',
      p_sig_sql                => 'SELECT *
                                FROM je_il_vat_limits
                                WHERE period_set_name IN
                                  (SELECT jg.tax_calendar_name
                                   FROM jg_zz_vat_rep_entities jg, ZX_REP_CONTEXT_T zx
                                   WHERE jg.vat_reporting_entity_id =  ##$$VAT_REP_ENTITY_ID$$##
                                     and zx.REP_ENTITY_ID = jg.LEGAL_ENTITY_ID
                                    and zx.REP_CONTEXT_ENTITY_COUNTRY=''IL''
                                   UNION
                                   SELECT tax_calendar_name
                                   FROM jg_zz_vat_rep_entities
                                   WHERE vat_reporting_entity_id IN
                                    (SELECT jg.mapping_vat_rep_entity_id
                                     FROM jg_zz_vat_rep_entities  jg, ZX_REP_CONTEXT_T zx
                                     WHERE jg.vat_reporting_entity_id =  ##$$VAT_REP_ENTITY_ID$$##
                                    and zx.REP_ENTITY_ID = jg.LEGAL_ENTITY_ID
                                    and zx.REP_CONTEXT_ENTITY_COUNTRY=''IL''))
                                ORDER BY period_set_name,
                                  period_year,
                                  period_num',
      p_title                  => 'Israel VAT Limits Setup',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no Israel VAT limits for the reporting Entity ID ##$$VAT_REP_ENTITY_ID$$##. <br>
This will cause the Israel VAT reports to end with an error message.',
      p_solution               => 'Review Issue#C.1 of [1392535/KB314980#aref_section215] Troubleshooting EMEA VAT reporting issues in Release 12 for more information.
',
      p_success_msg            => 'Israel VAT limits for the reporting Entity ID ##$$VAT_REP_ENTITY_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_IL_VAT_LIMITS');



debug('begin add_signature: JE_JG_ZZ_VAT_REP_ENTITIES');
   l_info('##MASK##ENTITY_IDENTIFIER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TAX_REGISTRATION_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9209',
      p_sig_id                 => 'JE_JG_ZZ_VAT_REP_ENTITIES',
      p_sig_sql                => 'SELECT *
            FROM jg_zz_vat_rep_entities
            where vat_reporting_entity_id = ##$$VAT_REP_ENTITY_ID$$## or mapping_vat_rep_entity_id = ##$$VAT_REP_ENTITY_ID$$##           
            ORDER BY 1',
      p_title                  => 'EMEA VAT Setup (JG_ZZ_VAT_REP_ENTITIES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no EMEA VAT setup information for this Entity ID ##$$VAT_REP_ENTITY_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'EMEA VAT setup information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('JE_JG_ZZ_VAT_REGISTERS_VL','JE_JG_ZZ_VAT_DOC_SEQUENCES_ASSIGNMENT','JE_JG_ZZ_VAT_BOX_ALLOCS_RULES','JE_IL_VAT_LIMITS'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '71'
      );
   l_info.delete;
debug('end add_signature: JE_JG_ZZ_VAT_REP_ENTITIES');



debug('begin add_signature: JE_JG_ZZ_VAT_TRX_DETAILS');
   l_info('##MASK##BANK_ACCOUNT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##BANK_ACCOUNT_NUM'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##HQ_ESTB_REG_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##LEDGER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##LEGAL_CONTACT_PARTY_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MERCHANT_PARTY_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##REP_CONTEXT_ENTITY_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9350',
      p_sig_id                 => 'JE_JG_ZZ_VAT_TRX_DETAILS',
      p_sig_sql                => 'SELECT jgdet.*
            FROM jg_zz_vat_rep_status jgrep,
              jg_zz_vat_trx_details jgdet
            WHERE jgrep.vat_reporting_entity_id = ##$$VAT_REP_ENTITY_ID$$##
             AND jgrep.reporting_status_id = jgdet.reporting_status_id
             AND  ( trx_id = ##$$TRANSACTION_ID$$##)
            ORDER BY application_id,
              trx_line_number',
      p_title                  => 'Transaction Details Populated by EMEA VAT Selection Process',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The transaction is not extracted by EMEA VAT Selection Process.',
      p_solution               => 'Review Issue#B.1 of Doc [1392535/KB314980#aref_section26] Troubleshooting EMEA VAT reporting issues in Release 12, for more information.',
      p_success_msg            => 'The transaction was extracted by EMEA VAT Selection Process concurrent program.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_JG_ZZ_VAT_TRX_DETAILS');



debug('begin add_signature: JE_ZX_TAXES_B_JG_TABLES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9347',
      p_sig_id                 => 'JE_ZX_TAXES_B_JG_TABLES',
      p_sig_sql                => 'SELECT DISTINCT zxtaxes.*
            FROM zx_rates_b zxrates,
              zx_taxes_b zxtaxes
            WHERE zxrates.content_owner_id = zxtaxes.content_owner_id
             AND zxrates.tax_regime_code = zxtaxes.tax_regime_code
             AND zxrates.tax = zxtaxes.tax
             AND zxrates.tax_rate_id IN
              (SELECT DISTINCT jgdet.tax_rate_id
               FROM jg_zz_vat_rep_status jgrep,
                 jg_zz_vat_trx_details jgdet
               WHERE jgrep.vat_reporting_entity_id = ##$$VAT_REP_ENTITY_ID$$##
               AND jgrep.reporting_status_id = jgdet.reporting_status_id
               AND   ( jgdet.trx_id = ##$$TRANSACTION_ID$$##))
			   and zxtaxes.tax = ''##$$FK1$$##''
            ORDER BY zxtaxes.tax_regime_code,
              zxtaxes.tax,
              zxtaxes.tax_type_code',
      p_title                  => 'Tax Information (ZX_TAXES_B)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no tax for Transaction / Invoice ID ##$$TRANSACTION_ID$$##.',
      p_solution               => 'This is a specific EB-Tax issue.<br>
Review [1392535/KB314980] Troubleshooting EMEA VAT reporting issues in Release 12, for more information.',
      p_success_msg            => 'Taxes for Transaction / Invoice ID ##$$TRANSACTION_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_ZX_TAXES_B_JG_TABLES');



debug('begin add_signature: JE_REPORTING_CODE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9348',
      p_sig_id                 => 'JE_REPORTING_CODE',
      p_sig_sql                => 'SELECT zxassoc.*
            FROM zx_rates_b zxrates,
              zx_report_codes_assoc zxassoc
            WHERE zxrates.tax_rate_id = zxassoc.entity_id
             AND zxassoc.entity_code(+) = ''ZX_RATES''
             AND zxrates.tax_rate_id IN
              (SELECT DISTINCT jgdet.tax_rate_id
               FROM jg_zz_vat_rep_status jgrep,
                 jg_zz_vat_trx_details jgdet
               ...
               AND jgrep.reporting_status_id = jgdet.reporting_status_id
               AND ( trx_id = ##$$TRANSACTION_ID$$##))
			 and zxassoc.entity_id = ##$$FK2$$##
            ORDER BY reporting_code_char_value',
      p_title                  => 'Association of Reporting Code and Tax Rate',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no association of a reporting code with a specific tax rate for Transaction / Invoice ID ##$$TRANSACTION_ID$$##.',
      p_solution               => 'This is a specific EB-Tax issue.<br>
Review section Issue#A.3 of [1392535/KB314980#aref_section25] Troubleshooting EMEA VAT reporting issues in Release 12 for more information.',
      p_success_msg            => 'Association of reporting code with a specific tax rate for Transaction / Invoice ID ##$$TRANSACTION_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_REPORTING_CODE');



debug('begin add_signature: JE_ZX_RATES_B_JG_TABLES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9346',
      p_sig_id                 => 'JE_ZX_RATES_B_JG_TABLES',
      p_sig_sql                => 'SELECT zxrates.*,zxrates.TAX "##$$FK1$$##",zxrates.tax_rate_id "##$$FK2$$##"
            FROM zx_rates_b zxrates 
            WHERE zxrates.tax_rate_id IN
              (SELECT DISTINCT jgdet.tax_rate_id
               FROM jg_zz_vat_rep_status jgrep,
                 jg_zz_vat_trx_details jgdet
               WHERE jgrep.vat_reporting_entity_id = ##$$VAT_REP_ENTITY_ID$$##
               AND jgrep.reporting_status_id = jgdet.reporting_status_id
             AND   ( jgdet.trx_id = ##$$TRANSACTION_ID$$##))
            ORDER BY zxrates.tax_regime_code,
              zxrates.tax_rate_code,
              zxrates.tax,
              zxrates.percentage_rate',
      p_title                  => 'Tax Rates Information (ZX_RATES_B)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no tax rates for Transaction / Invoice ID ##$$TRANSACTION_ID$$##. available in the table jg_zz_vat_trx_details',
      p_solution               => 'Review Point no. 2 and 3 in the [2866704/KB631032] : Italian Sales VAT Register Has Not Captured All AR Transactions
',
      p_success_msg            => 'Tax rates for Transaction / Invoice ID ##$$TRANSACTION_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('JE_ZX_TAXES_B_JG_TABLES','JE_REPORTING_CODE'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '27'
      );
   l_info.delete;
debug('end add_signature: JE_ZX_RATES_B_JG_TABLES');



debug('begin add_signature: JE_JG_ZZ_VAT_PAYMENT_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9344',
      p_sig_id                 => 'JE_JG_ZZ_VAT_PAYMENT_DETAILS',
      p_sig_sql                => 'SELECT JP.* 
FROM JG_ZZ_VAT_PAYMENT_DETAILS JP,
jg_zz_vat_trx_details JZVTD  ,
jg_zz_vat_rep_status JZVTS         
WHERE JP.actg_source_id = JZVTD.actg_source_id
AND   JP.reporting_status_id = JZVTD.reporting_status_id
AND   JZVTS.vat_reporting_entity_id = ##$$VAT_REP_ENTITY_ID$$##
AND   JZVTS.reporting_status_id = JZVTD.reporting_status_id
AND  ( trx_id = ##$$TRANSACTION_ID$$##) 
ORDER BY 1, 2',
      p_title                  => 'EMEA VAT Payment (JG_ZZ_VAT_PAYMENT_DETAILS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no VAT payment details for Transaction / Invoice ID ##$$TRANSACTION_ID$$##.',
      p_solution               => 'Review section 4. Applying the latest TRL Patches of Doc [737320/KB725550#aref_section24] Troubleshooting R12 E-Business Tax (EBTax) Reporting Issues. ',
      p_success_msg            => 'VAT payments details for Transaction / Invoice ID ##$$TRANSACTION_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_JG_ZZ_VAT_PAYMENT_DETAILS');



debug('begin add_signature: JE_JG_ZZ_VAT_REP_STATUS');
   l_info('##MASK##TAX_REGISTRATION_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9349',
      p_sig_id                 => 'JE_JG_ZZ_VAT_REP_STATUS',
      p_sig_sql                => 'SELECT *
            FROM jg_zz_vat_rep_status
            WHERE vat_reporting_entity_id = ##$$VAT_REP_ENTITY_ID$$##            
           ORDER BY tax_calendar_year desc,
              tax_calendar_period desc,
              source',
      p_title                  => 'EMEA VAT: Selection Process Run Information (JG_ZZ_VAT_REP_STATUS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no information regarding reporting status for Entity ID ##$$VAT_REP_ENTITY_ID$$##.',
      p_solution               => 'Please check if EMEA VAT Selection Process was executed for the provided entity id. <br>
Review [1392535/KB314980] Troubleshooting EMEA VAT reporting issues in Release 12, for more information.',
      p_success_msg            => 'Information regarding reporting status for Entity ID ##$$VAT_REP_ENTITY_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_JG_ZZ_VAT_REP_STATUS');



debug('begin add_signature: JE_POLAND_LEGAL_CONTACT');
   l_info('##MASK##1'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##1'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##1'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##16)'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##65)'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##9)'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##HL.ADDRESS_LINE_1'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SUBSTR(HL.ADDRESS_LINE_2'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SUBSTR(HL.ADDRESS_LINE_3'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SUBSTR(HZCP.PHONE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##XR.REGISTERED_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##XR.REGISTRATION_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19005',
      p_sig_id                 => 'JE_POLAND_LEGAL_CONTACT',
      p_sig_sql                => 'SELECT
                XR.registered_name
               ...
               ,HL.country
               ,HL.address_line_1
               ,substr(HL.address_line_2,1,65)
               ,substr(HL.address_line_3,1,9)
               ,null address4
               ,substr(HL.town_or_city,1,56)
               ,substr(HL.postal_code,1,8)
               ,hp.party_id
               ,HL.region_1
               ,Hl.region_2
               ,HL.region_3
               ,substr(HL.LOC_INFORMATION14,1,10) flat_number
               ,hl.LOC_INFORMATION15 post
               ,substr(hl.LOC_INFORMATION16,1,56) post_box
               ,substr(dist.meaning,1,36) district
               ,substr(comm.meaning,1,36) community
               ,substr(prov.meaning,1,36) province
			   ,substr(hzcp.phone_number,1,16) phone 
		   ...
		   ,HZ_RELATIONSHIPS hzr 	
                   ...
                   ,XLE_CONTACT_LEGAL_ROLES XC  
            WHERE   XR.source_id       =  XEP.legal_entity_id
            AND  XR.source_table       = ''XLE_ENTITY_PROFILES''
            AND  dist.lookup_code(+)   = hl.region_2
            AND  dist.lookup_type(+)   = ''PL_DISTRICT''
            AND  prov.lookup_type(+)   = ''PL_PROVINCE''
            AND  prov.lookup_code(+)   = hl.region_1
            AND  comm.lookup_type(+)   = ''PL_COMMUNITY''
            AND  comm.lookup_code(+)   = hl.region_3
            AND  XEP.legal_entity_id   in (select legal_entity_id FROM jg_zz_vat_rep_entities
            where vat_reporting_entity_id = ##$$VAT_REP_ENTITY_ID$$## or mapping_vat_rep_entity_id = ##$$VAT_REP_ENTITY_ID$$##)
	    ...
	    and  hzcp.owner_table_id = hzr.subject_id
	    and  hzcp.contact_point_type = ''PHONE''
            and  xc.contact_party_id = hzcp.owner_table_id
            and  xc.le_etb_party_id = hp.party_id
            and  xc.source_table    = ''XLE_ENTITY_PROFILES''
            and  xc.lookup_type     = ''XLE_CONTACT_ROLE''
            and  xc.lookup_code     = ''LEGAL_CONTACT''',
      p_title                  => 'Missing Legal Contact Information for Poland',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no legal contact created for the legal entity attached to  Entity ID ##$$VAT_REP_ENTITY_ID$$##.
This could cause errors in the JPK Report.',
      p_solution               => 'Review [2668890/KB692500] R12: JE: JEPLSAPR JPK Sales and Purchase Registers for Poland empty output',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: JE_POLAND_LEGAL_CONTACT');



debug('begin add_signature: JE_ZX_REP_TRX_DETAIL_T');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12650',
      p_sig_id                 => 'JE_ZX_REP_TRX_DETAIL_T',
      p_sig_sql                => 'SELECT ZXT.*             
FROM zx_rep_trx_detail_t ZXT            
WHERE ZXT.request_id = ##$$EMEA_VAT_SELECTION_PROCESS$$##             
AND (ZXT.trx_id = ##$$TRANSACTION_ID$$##)            
ORDER BY ZXT.trx_number,               
ZXT.trx_line_number',
      p_title                  => 'Transaction Details Extracted by EMEA VAT Selection Process (ZX_REP_TRX_DETAIL_T)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The transaction is not extracted by EMEA VAT Selection Process.',
      p_solution               => 'Review Issue#B.1 of Doc [1392535/KB314980#aref_section26] Troubleshooting EMEA VAT reporting issues in Release 12, for more information.',
      p_success_msg            => 'The transaction was extracted by EMEA VAT Selection Process concurrent program.',
   ...
   l_info.delete;
debug('end add_signature: JE_ZX_REP_TRX_DETAIL_T');



debug('begin add_signature: JE_ZX_REP_TRX_JX_EXT_T');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9354',
      p_sig_id                 => 'JE_ZX_REP_TRX_JX_EXT_T',
      p_sig_sql                => 'SELECT 
              ext.*
            FROM zx_rep_trx_jx_ext_t ext,
              zx_rep_trx_detail_t det
            WHERE det.request_id = ##$$EMEA_VAT_SELECTION_PROCESS$$##
             AND ( det.trx_id = ##$$TRANSACTION_ID$$##)
             AND det.request_id = ext.request_id
             AND ext.detail_tax_line_id(+) = det.detail_tax_line_id
            ORDER BY ext.attribute26',
      p_title                  => 'ZX_REP_TRX_JX_EXT_T Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no transaction related information in temporary TRL table ZX_REP_TRX_JX_EXT_T. ',
      p_solution               => 'This is a specific EB-Tax issue.<br>
Review section 4. Applying the latest TRL Patches of Doc [737320/KB725550#aref_section24] Troubleshooting R12 E-Business Tax (EBTax) Reporting Issues, for more information.',
      p_success_msg            => 'There are transactions related information in temporary TRL table ZX_REP_TRX_JX_EXT_T. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_ZX_REP_TRX_JX_EXT_T');



debug('begin add_signature: JE_ZX_REP_ACTG_EXT_T');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9355',
      p_sig_id                 => 'JE_ZX_REP_ACTG_EXT_T',
      p_sig_sql                => 'SELECT ext.*
            FROM zx_rep_actg_ext_t ext,
              zx_rep_trx_detail_t det
            WHERE det.request_id = ##$$EMEA_VAT_SELECTION_PROCESS$$##
             AND ( det.trx_id = ##$$TRANSACTION_ID$$##) 
             AND det.request_id = ext.request_id
             AND ext.detail_tax_line_id(+) = det.detail_tax_line_id
            ORDER BY ext.actg_line_num',
      p_title                  => 'Temporary TRL Table Accounting Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no accounting related information in ZX_REP_ACTG_EXT_T temporary TRL table.
 
',
      p_solution               => 'This is a specific EB-Tax issue.<br>
Review Code Fixes tab of [2197303/KA1415] R12: AP: EBTax: Troubleshooting Guide for Financial Tax Register Report, for more information.',
      p_success_msg            => 'Accounting related information from ZX_REP_ACTG_EXT_T temporary TRL table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_ZX_REP_ACTG_EXT_T');



debug('begin add_signature: JE_XLA_DISTRIBUTION_LINS_AP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12651',
      p_sig_id                 => 'JE_XLA_DISTRIBUTION_LINS_AP',
      p_sig_sql                => 'SELECT xla_dist.*             
FROM  zx_rep_trx_detail_t zx_dtl,                 
xla_transaction_entities_upg xla_ent,                 
...
WHERE zx_dtl.request_id = ##$$EMEA_VAT_SELECTION_PROCESS$$##           
AND (zx_dtl.trx_id = ##$$TRANSACTION_ID$$##)                
AND zx_dtl.extract_source_ledger = ''AP''             
AND zx_dtl.posted_flag  = ''A''             
AND zx_dtl.trx_id           = nvl(xla_ent.source_id_int_1,-99)                 
...
AND (xla_dist.tax_line_ref_id IS NULL OR xla_dist.tax_rec_nrec_dist_ref_id IS NULL)             
...
AND xla_line.accounting_class_code in (''RTAX'',''NRTAX'',''TRV'')',
      p_title                  => 'Payables Distributions for Extracted Data (XLA_DISTRIBUTION_LINS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no distributions for extracted data by EMEA VAT Selection Process.',
      p_solution               => 'Review section 4. Applying the latest TRL Patches of Doc [737320/KB725550#aref_section24] Troubleshooting R12 E-Business Tax (EBTax) Reporting Issues.',
      p_success_msg            => 'Distributions for extracted data by EMEA VAT Selection Process concurrent program.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_XLA_DISTRIBUTION_LINS_AP');



debug('begin add_signature: JE_XLA_DISTRIBUTION_LINS_AR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12652',
      p_sig_id                 => 'JE_XLA_DISTRIBUTION_LINS_AR',
      p_sig_sql                => 'SELECT xla_dist.*             
...
AND ar_dist.customer_trx_id    = xla_ent.source_id_int_1              
...
AND ar_dist.cust_trx_line_gl_dist_id = xla_dist.source_distribution_id_num_1             
AND xla_line.ae_header_id     = xla_dist.ae_header_id             
AND xla_line.ae_line_num      = xla_dist.ae_line_num             
AND xla_line.application_id   = xla_dist.application_id             
AND (ar_dist.customer_trx_id = ##$$TRANSACTION_ID$$##)',
      p_title                  => 'Receivables Distributions for Extracted Data (XLA_DISTRIBUTION_LINS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no distributions for extracted data by EMEA VAT Selection Process.',
      p_solution               => 'Review section 4. Applying the latest TRL Patches of Doc [737320/KB725550#aref_section24] Troubleshooting R12 E-Business Tax (EBTax) Reporting Issues. ',
      p_success_msg            => 'Distributions for extracted data by EMEA VAT Selection Process concurrent program.',
   ...
   l_info.delete;
debug('end add_signature: JE_XLA_DISTRIBUTION_LINS_AR');



debug('begin add_signature: JE_ZX_REP_CONTEXT_T');
   l_info('##MASK##BANK_ACCOUNT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##BANK_ACCOUNT_NUM'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##HQ_ESTB_REG_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##LEGAL_CONTACT_PARTY_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##LEGAL_CONTACT_PRE_NAME_ADJUNCT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9353',
      p_sig_id                 => 'JE_ZX_REP_CONTEXT_T',
      p_sig_sql                => 'SELECT 
                t.*
            FROM zx_rep_context_t t
            WHERE t.request_id =  ##$$EMEA_VAT_SELECTION_PROCESS$$##',
      p_title                  => 'Context Information for Tax Report (ZX_REP_CONTEXT_T)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no context information of tax report for Request ID ##$$EMEA_VAT_SELECTION_PROCESS$$##.',
      p_solution               => 'This is a specific EB-Tax issue.<br>
Review section 4. Applying the latest TRL Patches of Doc [737320/KB725550#aref_section24] Troubleshooting R12 E-Business Tax (EBTax) Reporting Issues, for more information.',
      p_success_msg            => 'There are context information of tax report for Request ID ##$$EMEA_VAT_SELECTION_PROCESS$$##. <br>
Each row contains operating unit address information for reports run at the ledger or operating unit level and legal entity information for reports run at the legal entity level.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('JE_ZX_REP_TRX_DETAIL_T','JE_ZX_REP_TRX_JX_EXT_T','JE_ZX_REP_ACTG_EXT_T','JE_XLA_DISTRIBUTION_LINS_AP','JE_XLA_DISTRIBUTION_LINS_AR'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '29'
      );
   l_info.delete;
debug('end add_signature: JE_ZX_REP_CONTEXT_T');



debug('begin add_signature: JE_JG_ZZ_VAT_FINAL_REPORTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19004',
      p_sig_id                 => 'JE_JG_ZZ_VAT_FINAL_REPORTS',
      p_sig_sql                => 'SELECT *
FROM jg_zz_vat_final_reports         
WHERE reporting_status_id IN              
(SELECT reporting_status_id
FROM jg_zz_vat_rep_status              
WHERE vat_reporting_entity_id = ##$$VAT_REP_ENTITY_ID$$##)             
',
      p_title                  => 'Italian Report Sequences Information (JG_ZZ_VAT_FINAL_REPORTS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no information regarding Italian Report Sequences for Entity ID ##$$VAT_REP_ENTITY_ID$$##.',
      p_solution               => 'Please check if EMEA VAT: Final Reporting was executed for the provided Entity ID ##$$VAT_REP_ENTITY_ID$$##.',
      p_success_msg            => 'Information regarding Italian Report Sequences for Entity ID ##$$VAT_REP_ENTITY_ID$$##.',
   ...
   l_info.delete;
debug('end add_signature: JE_JG_ZZ_VAT_FINAL_REPORTS');



debug('begin add_signature: JE_INCORRECT_OFFSET_TAX_IN_ZX_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##INVOICE_ID'):= 'center,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '10352',
      p_sig_id                 => 'JE_INCORRECT_OFFSET_TAX_IN_ZX_LINES',
      p_sig_sql                => 'SELECT DISTINCT INV.APPLICATION_ID,INV.LEGAL_ENTITY_ID,INV.SET_OF_BOOKS_ID,INV.INVOICE_DATE,INV.INVOICE_ID
                        ...
                        AND INV.INVOICE_ID                     = ##$$TRANSACTION_ID$$##
                        AND EXISTS
                          (SELECT 1
                          FROM ZX_LINES ZX
      ...
      p_title                  => 'OFFSET_TAX_RATE_CODE in ZX_LINES',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Offset Tax Rate Code is incorrectly populated on migrated Tax Lines.',
      p_solution               => 'Review Section 32: OFFSET_TAX_RATE_CODE is wrongly populated in ZX_Lines of Doc [1316316/KB731274#aref_section332] EB-Tax Data Corruption Issues & Recommended Solutions, for more information.',
      p_success_msg            => 'Offset Tax Rate Code is correctly populated on migrated Tax Lines.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_INCORRECT_OFFSET_TAX_IN_ZX_LINES');



debug('begin add_signature: JE_MISSING_XLA_DISTRIBUTION_FOR_AP_AX_UPGRADE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9356',
      p_sig_id                 => 'JE_MISSING_XLA_DISTRIBUTION_FOR_AP_AX_UPGRADE',
      p_sig_sql                => 'SELECT xla_dist.* FROM zx_rep_trx_detail_t zx_dtl, xla_transaction_entities_upg xla_ent, xla_events xla_event, xla_ae_headers xla_head, xla_ae_lines xla_line, xla_acct_class_assgns acs, xla_assignment_defns_b asd, xla_distribution_links xla_dist WHERE zx_dtl.request_id = ##$$EMEA_VAT_SELECTION_PROCESS$$## AND zx_dtl.trx_id = ##$$TRANSACTION_ID$$## AND zx_dtl.extract_source_ledger = ''AP'' AND zx_dtl.posted_flag = ''A'' AND zx_dtl.trx_id = nvl(xla_ent.source_id_int_1,-99) AND xla_ent.entity_code = ''AP_INVOICES'' AND xla_ent.application_id = 200 AND xla_ent.entity_id = xla_event.entity_id AND xla_event.event_id = xla_head.event_id AND xla_head.ae_header_id = xla_line.ae_header_id AND xla_head.balance_type_code = ''A'' AND xla_head.ledger_id IN (SELECT DISTINCT ledger_id FROM jg_zz_vat_rep_entities WHERE vat_reporting_entity_id = ##$$VAT_REP_ENTITY_ID$$## AND ledger_id IS NOT NULL UNION SELECT DISTINCT ledger_id FROM (select DISTINCT lg.ledger_id from GL_LEDGERS LG, GL_LEDGER_CONFIG_DETAILS CFGDET where lg.configuration_id=cfgdet.configuration_id and lg.ledger_category_code= ''PRIMARY'' and CFGDET.OBJECT_ID in (SELECT DISTINCT legal_entity_id FROM jg_zz_vat_rep_entities WHERE vat_reporting_entity_id = ##$$VAT_REP_ENTITY_ID$$##))) AND acs.program_code = ''TAX_REP_LEDGER_PROCUREMENT'' AND acs.program_code = asd.program_code AND asd.assignment_code = acs.assignment_code AND asd.enabled_flag = ''Y'' AND acs.accounting_class_code = xla_line.accounting_class_code AND (xla_dist.tax_line_ref_id IS NULL OR xla_dist.tax_rec_nrec_dist_ref_id IS NULL) AND xla_head.ae_header_id = xla_dist.ae_header_id AND xla_line.ae_header_id = xla_dist.ae_header_id AND xla_line.ae_line_num = xla_dist.ae_line_num AND xla_head.application_id = xla_ent.application_id AND xla_head.application_id = xla_line.application_id AND xla_line.accounting_class_code in (''RTAX'',''NRTAX'',''TRV'')',
      p_title                  => 'XLA Distribution List for Payables AX Upgrade',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no XLA distribution lines for Invoice ID ##$$TRANSACTION_ID$$##.',
      p_solution               => 'This is a specific Payables issue.<br>
Please read [1054299/KB202267] R12 GDF to Populate Missing XDL for all Migrated Transactions.',
      p_success_msg            => 'Distribution lines for Invoice ID ##$$TRANSACTION_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_MISSING_XLA_DISTRIBUTION_FOR_AP_AX_UPGRADE');



debug('begin add_signature: JE_AP_INVOICE_LINES_ALL');
  ...
  add_signature(
      p_sig_repo_id            => '12848',
      p_sig_id                 => 'JE_AP_INVOICE_LINES_ALL',
      p_sig_sql                => 'SELECT al.* 
FROM AP_INVOICE_LINES_ALL al
WHERE al.invoice_id =##$$TRANSACTION_ID$$##',
      p_title                  => 'Invoice Lines (AP_INVOICE_LINES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no lines for current invoice.',
      p_solution               => '',
      p_success_msg            => 'Invoice lines information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_AP_INVOICE_LINES_ALL');



debug('begin add_signature: JE_AP_INVOICE_DISTRIBUTIONS_ALL');
   l_info('##MASK##ATTRIBUTE%'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##MASK##MERCHANT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MERCHANT_TAXPAYER_ID'):= 'DISPLAY_LAST_25_PCNT';
   l_info('##MASK##MERCHANT_TAX_REG_NUMBER'):= 'DISPLAY_LAST_25_PCNT';
  ...
  add_signature(
      p_sig_repo_id            => '12849',
      p_sig_id                 => 'JE_AP_INVOICE_DISTRIBUTIONS_ALL',
      p_sig_sql                => 'select aid.*
from AP_INVOICE_DISTRIBUTIONS_ALL aid
where aid.invoice_id = ##$$TRANSACTION_ID$$##',
      p_title                  => 'Invoice Distribution Lines (AP_INVOICE_DISTRIBUTIONS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no invoice distribution lines.',
      p_solution               => '',
      p_success_msg            => 'Invoice distribution lines.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_AP_INVOICE_DISTRIBUTIONS_ALL');



debug('begin add_signature: JE_AP_HOLDS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12856',
      p_sig_id                 => 'JE_AP_HOLDS_ALL',
      p_sig_sql                => 'select h.*
from AP_HOLDS_ALL h
where h.invoice_id = ##$$TRANSACTION_ID$$##',
      p_title                  => 'Invoice Holds (AP_HOLDS_ALL)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invoice holds.',
      p_solution               => '',
      p_success_msg            => 'There are no invoice holds.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_AP_HOLDS_ALL');



debug('begin add_signature: JE_AP_INVOICES_ALL');
   l_info('##MASK##ATTRIBUTE%'):= 'DISPLAY_FIRST_25_PCNT';
  ...
  add_signature(
      p_sig_repo_id            => '12847',
      p_sig_id                 => 'JE_AP_INVOICES_ALL',
      p_sig_sql                => 'select ai.*
from ap_invoices_all ai
where ai.invoice_id = ##$$TRANSACTION_ID$$##',
      p_title                  => 'Invoice Header (AP_INVOICES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no invoice header information.',
      p_solution               => '',
      p_success_msg            => 'Invoice header information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('JE_AP_INVOICE_LINES_ALL','JE_AP_INVOICE_DISTRIBUTIONS_ALL','JE_AP_HOLDS_ALL'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '18'
      );
   l_info.delete;
debug('end add_signature: JE_AP_INVOICES_ALL');



debug('begin add_signature: JE_ZX_LINES_SUMMARY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12851',
      p_sig_id                 => 'JE_ZX_LINES_SUMMARY',
      p_sig_sql                => 'select zxs.*
from ZX_LINES_SUMMARY zxs
where zxs.application_id = 200
AND zxs.entity_code = ''AP_INVOICES''
AND zxs.event_class_code in (''STANDARD INVOICES'' , ''PREPAYMENT INVOICES'', ''EXPENSE REPORTS'')
and zxs.trx_id = ##$$TRANSACTION_ID$$##
and zxs.SUMMARY_TAX_LINE_ID = ##$$FK1$$##',
      p_title                  => 'Invoice Tax Line Summary (ZX_LINES_SUMMARY)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no tax line summary information.',
      p_solution               => '',
      p_success_msg            => 'Invoice tax line summary information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_ZX_LINES_SUMMARY');



debug('begin add_signature: JE_ZX_REC_NREC_DIST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12854',
      p_sig_id                 => 'JE_ZX_REC_NREC_DIST',
      p_sig_sql                => 'select zxrec.*
from ZX_REC_NREC_DIST zxrec
where zxrec.application_id = 200
AND zxrec.entity_code = ''AP_INVOICES''
AND zxrec.event_class_code in (''STANDARD INVOICES'' , ''PREPAYMENT INVOICES'', ''EXPENSE REPORTS'')
and zxrec.trx_id = ##$$TRANSACTION_ID$$##
and zxrec.TAX_LINE_ID = ##$$FK2$$##',
      p_title                  => 'Invoice Tax Line Distributions (ZX_REC_NREC_DIST)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no tax line distributions.',
      p_solution               => '',
      p_success_msg            => 'Invoice tax line distributions.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_ZX_REC_NREC_DIST');



debug('begin add_signature: JE_ZX_LINES');
   l_info('##MASK##HQ_ESTB_REG_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12850',
      p_sig_id                 => 'JE_ZX_LINES',
      p_sig_sql                => 'SELECT zx.*,zx.SUMMARY_TAX_LINE_ID "##$$FK1$$##", zx.TAX_LINE_ID "##$$FK2$$##", zx.TRX_LINE_ID "##$$FK3$$##"
from zx_lines zx 
where zx.trx_id = ##$$TRANSACTION_ID$$##
and zx.application_id = 200          
AND zx.entity_code = ''AP_INVOICES''
AND zx.event_class_code in (''STANDARD INVOICES'' , ''PREPAYMENT INVOICES'', ''EXPENSE REPORTS'')',
      p_title                  => 'Invoice Tax Lines (ZX_LINES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no tax line information. ',
      p_solution               => '',
      p_success_msg            => 'Invoice tax line information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('JE_ZX_LINES_SUMMARY','JE_ZX_REC_NREC_DIST'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '23'
      );
   l_info.delete;
debug('end add_signature: JE_ZX_LINES');



debug('begin add_signature: JE_ZX_LINES_DET_FACTORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12855',
      p_sig_id                 => 'JE_ZX_LINES_DET_FACTORS',
      p_sig_sql                => 'select zxdet.*
from ZX_LINES_DET_FACTORS zxdet
where zxdet.application_id = 200
AND zxdet.entity_code = ''AP_INVOICES''
AND zxdet.event_class_code in (''STANDARD INVOICES'' , ''PREPAYMENT INVOICES'', ''EXPENSE REPORTS'')
and zxdet.trx_id = ##$$TRANSACTION_ID$$##',
      p_title                  => 'Invoice Tax Lines Determination Factors (ZX_LINES_DET_FACTORS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no tax lines determination factors.',
      p_solution               => '',
      p_success_msg            => 'Invoice tax line determination factors.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_ZX_LINES_DET_FACTORS');



debug('begin add_signature: JE_AP_CHECKS_ALL');
   l_info('##MASK##BANK_ACCOUNT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##BANK_ACCOUNT_NUM'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '12877',
      p_sig_id                 => 'JE_AP_CHECKS_ALL',
      p_sig_sql                => 'select c.*
from ap_checks_all c
where c.check_id in (select p.check_id from AP_INVOICE_PAYMENTS_ALL p
where p.invoice_id = ##$$TRANSACTION_ID$$##)',
      p_title                  => 'Invoice Check (AP_CHECKS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no details for invoice check.',
      p_solution               => '',
      p_success_msg            => 'Invoice checks information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_AP_CHECKS_ALL');



debug('begin add_signature: JE_AP_PAYMENT_DISTRIBUTIONS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12878',
      p_sig_id                 => 'JE_AP_PAYMENT_DISTRIBUTIONS_ALL',
      p_sig_sql                => 'SELECT   pd.*          
FROM     AP_INVOICE_PAYMENTS_ALL p,                   
AP_PAYMENT_DISTRIBUTIONS_ALL pd          
WHERE    p.invoice_payment_id = pd.invoice_payment_id          
AND      p.invoice_id = ##$$TRANSACTION_ID$$##',
      p_title                  => 'Invoice Payment Distribution (AP_PAYMENT_DISTRIBUTIONS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no payment distribution information for Invoice ID ##$$TRANSACTION_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Payment distribution for Invoice ID ##$$TRANSACTION_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_AP_PAYMENT_DISTRIBUTIONS_ALL');



debug('begin add_signature: JE_AP_PAYMENT_HISTORY_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12879',
      p_sig_id                 => 'JE_AP_PAYMENT_HISTORY_ALL',
      p_sig_sql                => 'SELECT   ph.*          
FROM     AP_PAYMENT_HISTORY_ALL ph        
WHERE    ph.check_id IN                 
( SELECT   distinct p.check_id                   
FROM     AP_INVOICE_PAYMENTS_ALL p                  
WHERE    p.invoice_id = ##$$TRANSACTION_ID$$## )          
ORDER BY ph.accounting_event_id asc',
      p_title                  => 'Invoice Payment History (AP_PAYMENT_HISTORY_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no payment history information.',
      p_solution               => '',
      p_success_msg            => 'Payment history information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_AP_PAYMENT_HISTORY_ALL');



debug('begin add_signature: JE_AP_PAYMENT_HIST_DISTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12880',
      p_sig_id                 => 'JE_AP_PAYMENT_HIST_DISTS',
      p_sig_sql                => 'SELECT  distinct aphd.*                  
...
ORDER BY aphd.payment_history_id asc',
      p_title                  => 'Invoice Payment History Distribution (AP_PAYMENT_HIST_DISTS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no payment history distribution.',
      p_solution               => '',
      p_success_msg            => 'Payment history distribution.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_AP_PAYMENT_HIST_DISTS');



debug('begin add_signature: JE_AP_INVOICE_PAYMENTS_ALL');
   l_info('##MASK##BANK_ACCOUNT_NUM'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##BANK_NUM'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##IBAN_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##REMIT_TO_SUPPLIER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12876',
      p_sig_id                 => 'JE_AP_INVOICE_PAYMENTS_ALL',
      p_sig_sql                => 'select p.*
from AP_INVOICE_PAYMENTS_ALL p
where p.invoice_id = ##$$TRANSACTION_ID$$##',
      p_title                  => 'Invoice Payment (AP_INVOICE_PAYMENTS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no payment details for Invoice ID ##$$TRANSACTION_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Payment details for Invoice ID ##$$TRANSACTION_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('JE_AP_CHECKS_ALL','JE_AP_PAYMENT_DISTRIBUTIONS_ALL','JE_AP_PAYMENT_HISTORY_ALL','JE_AP_PAYMENT_HIST_DISTS'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '21'
      );
   l_info.delete;
debug('end add_signature: JE_AP_INVOICE_PAYMENTS_ALL');



debug('begin add_signature: JE_AP_AWT_GROUPS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12906',
      p_sig_id                 => 'JE_AP_AWT_GROUPS',
      p_sig_sql                => 'select distinct awt.*
from   ap_awt_groups awt
where  awt.group_id in (select distinct aid.awt_group_id
from   ap_invoice_distributions_all aid
where  aid.awt_group_id is not null
and  aid.invoice_id = ##$$TRANSACTION_ID$$##
UNION
...
and  ai.invoice_id = ##$$TRANSACTION_ID$$##
UNION
select distinct ai.pay_awt_group_id
from   ap_invoices_all ai
where  ai.pay_awt_group_id is not null
and  ai.invoice_id = ##$$TRANSACTION_ID$$##)',
      p_title                  => 'Withholding Tax Groups (AP_AWT_GROUPS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no withholding tax groups information for Invoice ID ##$$TRANSACTION_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Withholding tax groups information for Invoice ID ##$$TRANSACTION_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_AP_AWT_GROUPS');



debug('begin add_signature: JE_AP_AWT_GROUP_TAXES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12907',
      p_sig_id                 => 'JE_AP_AWT_GROUP_TAXES_ALL',
      p_sig_sql                => 'select distinct awt.*
...
where  ai.pay_awt_group_id is not null
and  ai.invoice_id = ##$$TRANSACTION_ID$$##)',
      p_title                  => 'Withholding Group Taxes (AP_AWT_GROUP_TAXES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no withholding group taxes information for Invoice ID ##$$TRANSACTION_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Withholding group taxes information for Invoice ID ##$$TRANSACTION_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_AP_AWT_GROUP_TAXES_ALL');



debug('begin add_signature: JE_AP_AWT_TEMP_DISTRIBUTIONS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12908',
      p_sig_id                 => 'JE_AP_AWT_TEMP_DISTRIBUTIONS_ALL',
      p_sig_sql                => 'select *
FROM   ap_awt_temp_distributions_all                 
where  invoice_id = ##$$TRANSACTION_ID$$##',
      p_title                  => 'Withholding Tax Distribution Temporary (AP_AWT_TEMP_DISTRIBUTIONS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no withholding tax distribution temporary information.',
      p_solution               => '',
      p_success_msg            => 'Withholding tax distribution temporary information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_AP_AWT_TEMP_DISTRIBUTIONS_ALL');



debug('begin add_signature: JE_AP_AWT_TAX_RATES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12905',
      p_sig_id                 => 'JE_AP_AWT_TAX_RATES',
      p_sig_sql                => 'select distinct awt.*                           
...
and  aid.invoice_id = ##$$TRANSACTION_ID$$##)',
      p_title                  => 'Witholding Tax Rates (AP_AWT_TAX_RATES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no withholding tax rate information for Invoice ID ##$$TRANSACTION_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Withholding tax rate information for Invoice ID ##$$TRANSACTION_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('JE_AP_AWT_GROUPS','JE_AP_AWT_GROUP_TAXES_ALL','JE_AP_AWT_TEMP_DISTRIBUTIONS_ALL'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '19'
      );
   l_info.delete;
debug('end add_signature: JE_AP_AWT_TAX_RATES');



debug('begin add_signature: JE_XLA_AE_HEADER_INVOICE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12910',
      p_sig_id                 => 'JE_XLA_AE_HEADER_INVOICE',
...
, xeh.ae_header_id ASC',
      p_title                  => 'Accounting Header (XLA_AE_HEADERS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no accounting header information for Invoice ID ##$$TRANSACTION_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Accounting header information for Invoice ID ##$$TRANSACTION_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_XLA_AE_HEADER_INVOICE');



debug('begin add_signature: JE_XLA_AE_LINES_INVOICE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12911',
      p_sig_id                 => 'JE_XLA_AE_LINES_INVOICE',
...
, xel.ae_line_num ASC',
      p_title                  => 'Accounting Line (XLA_AE_LINES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no accounting line information.',
      p_solution               => '',
      p_success_msg            => 'Accounting line information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_XLA_AE_LINES_INVOICE');



debug('begin add_signature: JE_XLA_DISTRIBUTION_LINKS_INVOICE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12954',
      p_sig_id                 => 'JE_XLA_DISTRIBUTION_LINKS_INVOICE',
...
AND NVL(xte.source_id_int_1,-99)=ai.invoice_id 
AND xte.entity_id =xeh.entity_id
ORDER BY xdl.event_id
, xdl.ae_header_id
, xdl.ae_line_num ASC',
      p_title                  => 'Accounting Line Distribution (XLA_DISTRIBUTION_LINKS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no accounting distribution links on Invoice ID ##$$TRANSACTION_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Accounting distribution link on Invoice ID ##$$TRANSACTION_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_XLA_DISTRIBUTION_LINKS_INVOICE');



debug('begin add_signature: JE_XLA_EVENTS_INVOICE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12909',
      p_sig_id                 => 'JE_XLA_EVENTS_INVOICE',
...
, xe.event_number',
      p_title                  => 'Accounting Events (XLA_EVENTS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no accounting events for Invoice ID ##$$TRANSACTION_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Accounting events information for Invoice ID ##$$TRANSACTION_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('JE_XLA_AE_HEADER_INVOICE','JE_XLA_AE_LINES_INVOICE','JE_XLA_DISTRIBUTION_LINKS_INVOICE'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '19'
      );
   l_info.delete;
debug('end add_signature: JE_XLA_EVENTS_INVOICE');



debug('begin add_signature: JE_GL_JE_HEADERS_INVOICE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12956',
      p_sig_id                 => 'JE_GL_JE_HEADERS_INVOICE',
...
AND      gjh.je_header_id = gir.je_header_id',
      p_title                  => 'GL Header (GL_JE_HEADERS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no GL header information for Invoice ID ##$$TRANSACTION_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'GL header information for Invoice ID ##$$TRANSACTION_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_GL_JE_HEADERS_INVOICE');



debug('begin add_signature: JE_GL_JE_LINES_INVOICE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12957',
      p_sig_id                 => 'JE_GL_JE_LINES_INVOICE',
      p_sig_sql                => 'SELECT   distinct gll.*
FROM     GL_IMPORT_REFERENCES gir,
GL_JE_LINES   gll,
XLA_AE_LINES  ael,
XLA_AE_HEADERS   aeh,
...
AND      gll.je_line_num  = gir.je_line_num',
      p_title                  => 'GL Lines (GL_JE_LINES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no GL line information for Invoice ID ##$$TRANSACTION_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'GL line information for Invoice ID ##$$TRANSACTION_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_GL_JE_LINES_INVOICE');



debug('begin add_signature: JE_GL_IMPORT_REFERENCES_INVOICE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12958',
      p_sig_id                 => 'JE_GL_IMPORT_REFERENCES_INVOICE',
...
AND      aea.event_id = aeh.event_id
AND      aeh.ae_header_id = ael.ae_header_id',
      p_title                  => 'GL References (GL_IMPORT_REFERENCES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no GL references information for Invoice ID ##$$TRANSACTION_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'GL references information for Invoice ID ##$$TRANSACTION_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_GL_IMPORT_REFERENCES_INVOICE');



debug('begin add_signature: JE_GL_CODE_COMBINATIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12959',
      p_sig_id                 => 'JE_GL_CODE_COMBINATIONS',
...
AND xel.application_id          =200
AND xeh.application_id          =200
AND aip.invoice_id              =##$$TRANSACTION_ID$$##
AND xel.ae_header_id            =xeh.ae_header_id
...
AND po.po_distribution_id   =aid.po_distribution_id)',
      p_title                  => 'GL Code Combination (GL_CODE_COMBINATIONS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no GL code combination information for Invoice ID ##$$TRANSACTION_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'GL code combination information for Invoice ID ##$$TRANSACTION_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_GL_CODE_COMBINATIONS');



debug('begin add_signature: JE_GL_JE_BATCHES_INVOICE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12955',
      p_sig_id                 => 'JE_GL_JE_BATCHES_INVOICE',
...
AND      gjb.je_batch_id = gir.je_batch_id',
      p_title                  => 'GL Batches (GL_JE_BATCHES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no GL batches information on Invoice ID ##$$TRANSACTION_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'GL batches information on Invoice ID ##$$TRANSACTION_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('JE_GL_JE_HEADERS_INVOICE','JE_GL_JE_LINES_INVOICE','JE_GL_IMPORT_REFERENCES_INVOICE','JE_GL_CODE_COMBINATIONS'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '25'
      );
   l_info.delete;
debug('end add_signature: JE_GL_JE_BATCHES_INVOICE');



debug('begin add_signature: JE_AP_SUPPLIER_SITES_ALL');
   l_info('##MASK##BANK_ACCOUNT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##BANK_ACCOUNT_NUM'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##BANK_NUM'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##VAT_REGISTRATION_NUM'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12961',
      p_sig_id                 => 'JE_AP_SUPPLIER_SITES_ALL',
      p_sig_sql                => 'SELECT   *          FROM     AP_SUPPLIER_SITES_ALL          WHERE    vendor_site_id IN                 ( SELECT   vendor_site_id                   FROM     AP_INVOICES_ALL                   WHERE    invoice_id = ##$$TRANSACTION_ID$$## )',
      p_title                  => 'Supplier Site (AP_SUPPLIER_SITES_ALL)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are no supplier site information for Invoice ID ##$$TRANSACTION_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Supplier site information for Invoice ID ##$$TRANSACTION_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_AP_SUPPLIER_SITES_ALL');



debug('begin add_signature: JE_AP_SUPPLIERS');
   l_info('##MASK##BANK_ACCOUNT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##BANK_ACCOUNT_NUM'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##BANK_NUM'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
WHERE    invoice_id = ##$$TRANSACTION_ID$$## )',
      p_title                  => 'Supplier (AP_SUPPLIERS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no supplier information for Invoice ID ##$$TRANSACTION_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Supplier information for Invoice ID ##$$TRANSACTION_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_AP_SUPPLIERS');



debug('begin add_signature: JE_NULL_VAT_REGISTRATION_CUSTOMER');
   l_info('##MASK##PARTY_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10397',
      p_sig_id                 => 'JE_NULL_VAT_REGISTRATION_CUSTOMER',
      p_sig_sql                => 'SELECT hzp.party_id,
       hzp.party_name
...
AND reg.registration_number     IS NULL',
      p_title                  => 'VAT Registration Number (TRN) at Customer Level',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Vat Registration Number (TRN) is Null.',
      p_solution               => 'Review [1316316/KB731274#aref_section336] EB-Tax Data Corruption Issues & Recommended Solutions - Section 36: The VAT REGISTRATION NUMBER is Null for the following Customers and Customer Sites.',
      p_success_msg            => 'Customer has an associated VAT Registration Number (TRN).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_NULL_VAT_REGISTRATION_CUSTOMER');



debug('begin add_signature: JE_NULL_VAT_REGISTRATION_CUSTOMER_SITE');
   l_info('##MASK##ADDRESS1'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10396',
      p_sig_id                 => 'JE_NULL_VAT_REGISTRATION_CUSTOMER_SITE',
      p_sig_sql                => 'SELECT hzs.party_site_id,
  hzl.CITY,
  hzl.COUNTY,
  hzl.STATE,
  hzl.PROVINCE,
...
AND ptp.rep_registration_number IS NULL
AND reg.registration_number     IS NULL',
      p_title                  => 'VAT Registration Number (TRN) at Customer Site Level',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Vat Registration Number (TRN) is Null for Customer Site.',
      p_solution               => 'Review [1316316/KB731274#aref_section336] EB-Tax Data Corruption Issues & Recommended Solutions - Section 36: The VAT REGISTRATION NUMBER is Null for the following Customers and Customer Sites.',
      p_success_msg            => 'Customer Site has associated VAT Registration Number (TRN).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_NULL_VAT_REGISTRATION_CUSTOMER_SITE');



debug('begin add_signature: JE_RA_BATCH_SOURCES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12967',
      p_sig_id                 => 'JE_RA_BATCH_SOURCES_ALL',
      p_sig_sql                => 'SELECT   a.* FROM     RA_BATCH_SOURCES_ALL a,          
RA_CUSTOMER_TRX_ALL b 
WHERE    a.batch_source_id = b.batch_source_id 
AND      b.customer_trx_id = ##$$TRANSACTION_ID$$##
AND      NVL(a.org_id, -99) = NVL(b.org_id, -99)',
      p_title                  => 'Transaction Batch (RA_BATCH_SOURCES_ALL)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are no transaction batch information.',
      p_solution               => '',
      p_success_msg            => 'Transaction batch information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_RA_BATCH_SOURCES_ALL');



debug('begin add_signature: JE_RA_CUST_TRX_TYPES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12966',
      p_sig_id                 => 'JE_RA_CUST_TRX_TYPES_ALL',
      p_sig_sql                => 'SELECT   a.* FROM     RA_CUST_TRX_TYPES_ALL a,          
RA_CUSTOMER_TRX_ALL b 
WHERE    a.cust_trx_type_id = b.cust_trx_type_id 
AND      b.customer_trx_id = ##$$TRANSACTION_ID$$##
AND      NVL(b.org_id, -99) = NVL(a.org_id, -99)',
      p_title                  => 'Transaction Type (RA_CUST_TRX_TYPES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no transaction type information.',
      p_solution               => '',
      p_success_msg            => 'Transaction type information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_RA_CUST_TRX_TYPES_ALL');



debug('begin add_signature: JE_RA_CUST_TRX_LINE_GL_DIST_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12971',
      p_sig_id                 => 'JE_RA_CUST_TRX_LINE_GL_DIST_ALL',
      p_sig_sql                => 'SELECT   * FROM RA_CUST_TRX_LINE_GL_DIST_ALL WHERE    customer_trx_id = ##$$TRANSACTION_ID$$## ORDER BY cust_trx_line_gl_dist_id',
      p_title                  => 'Transaction Line Distribution (RA_CUST_TRX_LINE_GL_DIST_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are not transaction line distribution information.',
      p_solution               => '',
      p_success_msg            => 'Transaction line distribution information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_RA_CUST_TRX_LINE_GL_DIST_ALL');



debug('begin add_signature: JE_RA_CUSTOMER_TRX_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12965',
      p_sig_id                 => 'JE_RA_CUSTOMER_TRX_ALL',
      p_sig_sql                => 'SELECT   * FROM RA_CUSTOMER_TRX_ALL WHERE    customer_trx_id = ##$$TRANSACTION_ID$$##',
      p_title                  => 'Transaction Information (RA_CUSTOMER_TRX_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no transaction information.',
      p_solution               => '',
      p_success_msg            => 'Transaction information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('JE_RA_BATCH_SOURCES_ALL','JE_RA_CUST_TRX_TYPES_ALL','JE_RA_CUST_TRX_LINE_GL_DIST_ALL'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '16'
      );
   l_info.delete;
debug('end add_signature: JE_RA_CUSTOMER_TRX_ALL');



debug('begin add_signature: JE_ZX_LINES_AR');
   l_info('##MASK##HQ_ESTB_REG_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12969',
      p_sig_id                 => 'JE_ZX_LINES_AR',
      p_sig_sql                => 'SELECT   zl.* FROM     ZX_LINES zl,          
...
AND      lines.customer_trx_id = ##$$TRANSACTION_ID$$##',
      p_title                  => 'Transaction Tax Line (ZX_LINES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no transaction tax line information.',
      p_solution               => '',
      p_success_msg            => 'Transaction tax line information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_ZX_LINES_AR');



debug('begin add_signature: JE_ZX_LINES_DET_FACTORS_AR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12970',
      p_sig_id                 => 'JE_ZX_LINES_DET_FACTORS_AR',
      p_sig_sql                => 'SELECT   zld.* FROM     ZX_LINES_DET_FACTORS zld,          
RA_CUSTOMER_TRX_LINES_ALL lines 
...
AND      lines.customer_trx_id = ##$$TRANSACTION_ID$$##',
      p_title                  => 'Transaction Tax Lines Determination Factors (ZX_LINES_DET_FACTORS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no transaction tax line distribution information.',
      p_solution               => '',
      p_success_msg            => 'Transaction tax line distribution information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_ZX_LINES_DET_FACTORS_AR');



debug('begin add_signature: JE_RA_CUSTOMER_TRX_LINES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12968',
      p_sig_id                 => 'JE_RA_CUSTOMER_TRX_LINES_ALL',
      p_sig_sql                => 'SELECT   * FROM RA_CUSTOMER_TRX_LINES_ALL WHERE    customer_trx_id = ##$$TRANSACTION_ID$$## ORDER BY customer_trx_line_id',
      p_title                  => 'Transaction Lines (RA_CUSTOMER_TRX_LINES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no transaction line information.',
      p_solution               => '',
      p_success_msg            => 'Transaction line information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('JE_ZX_LINES_AR','JE_ZX_LINES_DET_FACTORS_AR'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '16'
      );
   l_info.delete;
debug('end add_signature: JE_RA_CUSTOMER_TRX_LINES_ALL');



debug('begin add_signature: JE_TRANSACTIONS_NOT_SELECTED_WHEN_RUNNING_THE_EMEA_VAT_SELECTION_PROCESS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15344',
      p_sig_id                 => 'JE_TRANSACTIONS_NOT_SELECTED_WHEN_RUNNING_THE_EMEA_VAT_SELECTION_PROCESS',
      p_sig_sql                => 'SELECT zld.trx_id, zld.TAX_EVENT_TYPE_CODE FROM     ZX_LINES_DET_FACTORS zld,          
RA_CUSTOMER_TRX_LINES_ALL lines 
WHERE    zld.application_id = 222 
AND      zld.entity_code    = ''TRANSACTIONS'' 
AND      zld.event_class_code in (''INVOICE'',''DEBIT_MEMO'',''CREDIT_MEMO'') 
...
AND      zld.trx_line_id = lines.customer_trx_line_id 
AND      lines.customer_trx_id = ##$$TRANSACTION_ID$$##
and TAX_EVENT_TYPE_CODE <> ''FREEZE_FOR_TAX''
and TAX_EVENT_TYPE_CODE <> ''VALIDATE_FOR_TAX''',
      p_title                  => 'Transactions Not Selected When Running the EMEA VAT: Selection Process',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Not all the transactions are selected when running the EMEA VAT: Selection Process.',
      p_solution               => 'Please follow note JGZZVATSP :EMEA VAT: Selection Process Does Not Select All Transactions [839853/KB609994]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: JE_TRANSACTIONS_NOT_SELECTED_WHEN_RUNNING_THE_EMEA_VAT_SELECTION_PROCESS');



debug('begin add_signature: JE_XLA_AE_HEADERS_AR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12973',
      p_sig_id                 => 'JE_XLA_AE_HEADERS_AR',
      p_sig_sql                => 'SELECT   * FROM     XLA_AE_HEADERS xah 
...
AND      xte.source_id_int_1 = ##$$TRANSACTION_ID$$## )',
      p_title                  => 'Accounting Header (XLA_AE_HEADERS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no accounting header information for Transaction ID ##$$TRANSACTION_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Accounting header information for Transaction ID ##$$TRANSACTION_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_XLA_AE_HEADERS_AR');



debug('begin add_signature: JE_XLA_AE_LINES_AR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12974',
      p_sig_id                 => 'JE_XLA_AE_LINES_AR',
      p_sig_sql                => 'SELECT   xal.* FROM     XLA_AE_LINES xal,          
XLA_AE_HEADERS xah 
...
AND      xte.source_id_int_1 = ##$$TRANSACTION_ID$$## )',
      p_title                  => 'Accounting Line (XLA_AE_LINES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no accounting line information on Transaction ID ##$$TRANSACTION_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Accounting line information on Transaction ID ##$$TRANSACTION_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_XLA_AE_LINES_AR');



debug('begin add_signature: JE_XLA_DISTRIBUTION_LINKS_AR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12975',
      p_sig_id                 => 'JE_XLA_DISTRIBUTION_LINKS_AR',
      p_sig_sql                => 'SELECT   xdl.* FROM     XLA_DISTRIBUTION_LINKS xdl,          
XLA_AE_HEADERS xah 
...
FROM     XLA.XLA_TRANSACTION_ENTITIES xte         
 ...
 AND      xte.source_id_int_1 = ##$$TRANSACTION_ID$$## )',
      p_title                  => 'Accounting Line Distribution (XLA_DISTRIBUTION_LINKS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no accounting line distribution information.',
      p_solution               => '',
      p_success_msg            => 'Accounting line distribution.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_XLA_DISTRIBUTION_LINKS_AR');



debug('begin add_signature: JE_XLA_EVENTS_AR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12972',
      p_sig_id                 => 'JE_XLA_EVENTS_AR',
...
AND      xte.entity_code     = ''TRANSACTIONS''         
 AND      xte.source_id_int_1 = ##$$TRANSACTION_ID$$## )',
      p_title                  => 'Accounting Event for Transaction (XLA_EVENTS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no accounting event information for Transaction ID ##$$TRANSACTION_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'Accounting event information for Transaction ID ##$$TRANSACTION_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('JE_XLA_AE_HEADERS_AR','JE_XLA_AE_LINES_AR','JE_XLA_DISTRIBUTION_LINKS_AR'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '20'
      );
   l_info.delete;
debug('end add_signature: JE_XLA_EVENTS_AR');



debug('begin add_signature: JE_MISSING_XLA_DISTRIBUTION_FOR_AR_AX_UPGRADE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9357',
      p_sig_id                 => 'JE_MISSING_XLA_DISTRIBUTION_FOR_AR_AX_UPGRADE',
      p_sig_sql                => 'SELECT xla_dist.*
            FROM ra_cust_trx_line_gl_dist_all ar_dist,
                xla_transaction_entities_upg xla_ent,
                xla_events     xla_event,
            ...
            AND xla_event.application_id  = xla_head.application_id
            AND xla_event.event_id        = xla_head.event_id
            AND xla_head.ledger_id   IN    (SELECT DISTINCT ledger_id
                            FROM jg_zz_vat_rep_entities
                            WHERE vat_reporting_entity_id = ##$$VAT_REP_ENTITY_ID$$## AND ledger_id IS NOT NULL
                            UNION
                            SELECT DISTINCT ledger_id
                            FROM gl_ledger_le_v
                            WHERE ledger_category_code = ''PRIMARY''
                            AND legal_entity_id IN (SELECT DISTINCT legal_entity_id  
                            FROM jg_zz_vat_rep_entities
                            WHERE vat_reporting_entity_id = ##$$VAT_REP_ENTITY_ID$$##))
            AND xla_head.balance_type_code = ''A''
            AND xla_line.application_id   = xla_head.application_id
            ...
            AND xla_line.application_id   = xla_dist.application_id
            AND ar_dist.customer_trx_id = ##$$TRANSACTION_ID$$##',
      p_title                  => 'XLA Distribution List for Receivables  AX Upgrade',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no distribution lines for Transaction ID ##$$TRANSACTION_ID$$##.',
      p_solution               => 'This is a specific Receivables issue.<br>
Please read [1329976/KB788304] Posting Issue: Unable To Post Upgraded AX Receipt Due to Missing Rows in XLA_DISTRIBUTION_LINKS.',
      p_success_msg            => 'Distribution lines for Transaction ID ##$$TRANSACTION_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_MISSING_XLA_DISTRIBUTION_FOR_AR_AX_UPGRADE');



debug('begin add_signature: JE_GL_JE_HEADERS_AR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12977',
      p_sig_id                 => 'JE_GL_JE_HEADERS_AR',
      p_sig_sql                => 'SELECT   distinct gjh.* 
...
FROM     XLA.XLA_TRANSACTION_ENTITIES xte         
 ...
 AND      xte.entity_code     = ''TRANSACTIONS''          
 AND      xte.source_id_int_1 = ##$$TRANSACTION_ID$$## )',
      p_title                  => 'GL Header Information on Transaction (GL_JE_HEADERS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no GL Header information.',
      p_solution               => '',
      p_success_msg            => 'GL Header Information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_GL_JE_HEADERS_AR');



debug('begin add_signature: JE_GL_JE_LINES_AR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12978',
      p_sig_id                 => 'JE_GL_JE_LINES_AR',
...
AND      xte.entity_code     = ''TRANSACTIONS''          
AND      xte.source_id_int_1 = ##$$TRANSACTION_ID$$## )',
      p_title                  => 'GL Lines Information on Transaction (GL_JE_LINES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no GL Line information.',
      p_solution               => '',
      p_success_msg            => 'GL Line information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_GL_JE_LINES_AR');



debug('begin add_signature: JE_GL_IMPORT_REFERENCES_AR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12979',
      p_sig_id                 => 'JE_GL_IMPORT_REFERENCES_AR',
      p_sig_sql                => 'SELECT   distinct gir.* 
FROM     GL_IMPORT_REFERENCES gir,          
XLA_AE_LINES         xal,          
XLA_AE_HEADERS       xah 
...
AND      xte.source_id_int_1 = ##$$TRANSACTION_ID$$## )',
      p_title                  => 'GL References (GL_IMPORT_REFERENCES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no GL References information.',
      p_solution               => '',
      p_success_msg            => 'GL References information. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_GL_IMPORT_REFERENCES_AR');



debug('begin add_signature: JE_GL_JE_BATCHES_AR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12976',
      p_sig_id                 => 'JE_GL_JE_BATCHES_AR',
      p_sig_sql                => 'SELECT   distinct gjb.* 
...
AND      xte.source_id_int_1 = ##$$TRANSACTION_ID$$## )',
      p_title                  => 'GL Batches (GL_JE_BATCHES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no GL Batches information for Transaction ID ##$$TRANSACTION_ID$$##.',
      p_solution               => '',
      p_success_msg            => 'GL Batches information for Transaction ID ##$$TRANSACTION_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('JE_GL_JE_HEADERS_AR','JE_GL_JE_LINES_AR','JE_GL_IMPORT_REFERENCES_AR','JE_GL_CODE_COMBINATIONS'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '22'
      );
   l_info.delete;
debug('end add_signature: JE_GL_JE_BATCHES_AR');



debug('begin add_signature: JE_INCORRECT_HQ_ESTAB_REG_NUM');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##trx_id'):= 'center,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '9914',
      p_sig_id                 => 'JE_INCORRECT_HQ_ESTAB_REG_NUM',
...
WHERE decode(zl.application_id,200,''Payables'',222,''Receivables'',''Others'')= ''##$$APPLICATION$$##''
  ...
  AND EXISTS
      ...
      p_title                  => 'Retrieve the HQ Establishment Registration Number Populated With NULL or Incorrect Value on Tax Lines',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The HQ Establishment Registration Number populated with NULL or incorrect value on Tax Lines.',
      p_solution               => 'Review [1316316/KB731274#aref_section334] EB-Tax Data Corruption Issues & Recommended Solutions - Section 34: The HQ Establishment Registration Number populated with NULL or incorrect value on Tax Lines.',
      p_success_msg            => 'The HQ Establishment Registration Number is populated with correct values on Tax Lines.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_INCORRECT_HQ_ESTAB_REG_NUM');



debug('begin add_signature: JE_TAX_LEVEL_SETUP_MISSING_INCORRECT_SETUP');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##LEGAL_REPORTING_STATUS_DEF_VAL'):= 'center,#333333,#FFE864,bold';
   l_info('##STYLE##legal_reporting_status'):= 'center,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '10551',
      p_sig_id                 => 'JE_TAX_LEVEL_SETUP_MISSING_INCORRECT_SETUP',
      p_sig_sql                => 'select zxdet.DEFAULT_TAXATION_COUNTRY,zxlines.application_id, zxlines.tax_line_id, zxlines.trx_id, zxlines.tax_rate_id,
zxlines.tax_rate_code, zxlines.legal_reporting_status, zxtaxes.LEGAL_REPORTING_STATUS_DEF_VAL
...
and decode(zxlines.application_id,200,''Payables'',''Receivables'')=''##$$APPLICATION$$##''
...
and (zxdet.default_taxation_country in (''BE'', ''CH'', ''CZ'', ''DE'', ''DK'',''ES'', ''EX'', ''FI'', ''FR'', ''GR'',''HU'', ''IL'', ''IT'', ''NL'', ''NO'', ''PL'', ''PT'', ''SE'', ''TR'', ''RU'',''SK'', ''UA'', ''RO'', ''KZ'', ''HR'',''SI'', ''BG'', ''RS'' ,''AE'')
    or zxdet.default_taxation_country is null)',
      p_title                  => 'Missing Legal Reporting Status on Tax Lines for Tax Rates With Incorrect Setup',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'No Legal Reporting Status code is attached on Tax causing NULL value on tax lines for legal reporting status and issues on EMEA VAT Reporting.',
      p_solution               => 'Review Issue#A.2 of Doc [1392535/KB314980#aref_section24] Troubleshooting EMEA VAT reporting issues in Release 12, and log an Service Request against Oracle Financials for EMEA product to obtain Datafix for existing transactions.',
      p_success_msg            => 'Legal Reporting Status code is attached on Tax and legal reporting status is correctly populated on tax lines.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_TAX_LEVEL_SETUP_MISSING_INCORRECT_SETUP');



debug('begin add_signature: JE_TAX_LEVEL_SETUP_MISSING_CORRECT_SETUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10400',
      p_sig_id                 => 'JE_TAX_LEVEL_SETUP_MISSING_CORRECT_SETUP',
      p_sig_sql                => 'select zxdet.DEFAULT_TAXATION_COUNTRY,zxlines.application_id, zxlines.tax_line_id, zxlines.trx_id, zxlines.tax_rate_id,
zxlines.tax_rate_code, zxlines.legal_reporting_status, zxtaxes.LEGAL_REPORTING_STATUS_DEF_VAL
from zx_lines zxlines, zx_lines_det_factors zxdet, zx_rates_b zxrates, zx_taxes_b zxtaxes
where zxlines.legal_reporting_status is null
...
and (zxdet.default_taxation_country in (''BE'', ''CH'', ''CZ'', ''DE'', ''DK'',''ES'', ''EX'', ''FI'', ''FR'', ''GR'',''HU'', ''IL'', ''IT'', ''NL'', ''NO'', ''PL'', ''PT'', ''SE'', ''TR'', ''RU'',''SK'', ''UA'', ''RO'', ''KZ'', ''HR'',''SI'', ''BG'', ''RS'' ,''AE'')
    or zxdet.default_taxation_country is null)',
      p_title                  => 'Missing Legal Reporting Status on Tax Lines for Tax Rates With Correct Setup',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Legal Reporting Status code is attached on Tax, but legal reporting status has NULL value on tax lines causing issues on EMEA VAT Reporting.',
      p_solution               => 'Log a Service Request against Oracle Financials for EMEA product and upload this analyzer output for reference. <br>
Review Issue#A.2 of Doc [1392535/KB314980#aref_section24] Troubleshooting EMEA VAT reporting issues in Release 12, for more information.
',
      p_success_msg            => 'Legal Reporting Status code is attached on Tax and legal reporting status is correctly populated on tax lines.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: JE_TAX_LEVEL_SETUP_MISSING_CORRECT_SETUP');



debug('begin add_signature: JE_TAX_RATE_VAT_TRX_TYPE_CODE_IS_NULL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15350',
      p_sig_id                 => 'JE_TAX_RATE_VAT_TRX_TYPE_CODE_IS_NULL',
      p_sig_sql                => 'SELECT jgdet.*
            FROM jg_zz_vat_rep_status jgrep,
              jg_zz_vat_trx_details jgdet
            WHERE jgrep.vat_reporting_entity_id = ##$$VAT_REP_ENTITY_ID$$##
             AND jgrep.reporting_status_id = jgdet.reporting_status_id
             AND  ( trx_id = ##$$TRANSACTION_ID$$##)
             AND jgdet.tax_rate_vat_trx_type_code is null
            ORDER BY application_id,
              trx_line_number',
      p_title                  => 'Missing Tax Transaction Type Setup',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'No Tax Transaction Type is set for the tax rate.
',
      p_solution               => 'Assign Tax Transaction Type for Tax rate in Tax Manager Setup.
Navigate to Tax Manager responsibility -> Tax Configuration -> Tax Rates -> Query the tax rate code -> click on ''Update'' -> Rate Details -> Under ''Reporting Details'' section check on ''Tax Transaction Type'' field and assign the appropriate value. ',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: JE_TAX_RATE_VAT_TRX_TYPE_CODE_IS_NULL');



debug('begin add_signature: JE_DRIVING_DATE_CODE');
   l_info('##MASK##ENTITY_IDENTIFIER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TAX_REGISTRATION_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##DRIVING_DATE_CODE'):= 'center,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '10402',
      p_sig_id                 => 'JE_DRIVING_DATE_CODE',
      p_sig_sql                => 'SELECT *             
FROM jg_zz_vat_rep_entities             
WHERE vat_reporting_entity_id IN               
(SELECT NVL(mapping_vat_rep_entity_id,vat_reporting_entity_id)                
FROM jg_zz_vat_rep_entities                
WHERE vat_reporting_entity_id = ##$$VAT_REP_ENTITY_ID$$##)
and DRIVING_DATE_CODE is null                        
ORDER BY 1',
      p_title                  => 'VAT Date (Driving Date) Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'VAT Date (Driving Date) is not set in EMEA VAT Reporting Entities Setup form.',
      p_solution               => 'Review Issue#B.3 from [1392535/KB314980#aref_section211] Troubleshooting EMEA VAT reporting issues in Release 12, for more information.',
      p_success_msg            => 'VAT Date (Driving Date) is set in EMEA VAT Reporting Entities Setup form.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_DRIVING_DATE_CODE');



debug('begin add_signature: JE_REPORTING_CODE_ASSOCIATION_MISSING_SETUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10401',
      p_sig_id                 => 'JE_REPORTING_CODE_ASSOCIATION_MISSING_SETUP',
      p_sig_sql                => 'SELECT zxassoc.* 
FROM zx_rates_b zxrates, zx_report_codes_assoc zxassoc 
WHERE zxrates.tax_rate_id = zxassoc.entity_id 
and (zxassoc.REPORTING_CODE_CHAR_VALUE is null or length(zxassoc.REPORTING_CODE_CHAR_VALUE) =0) 
AND zxassoc.entity_code (+) = ''ZX_RATES'' AND zxrates.tax_rate_id IN 
(select distinct zxlines.tax_rate_id 
from zx_lines zxlines, zx_lines_det_factors zxdet, zx_rates_b zxrates, zx_taxes_b zxtaxes 
where zxlines.tax_rate_id = zxrates.tax_rate_id 
AND zxrates.tax = zxtaxes.tax 
and zxlines.tax_id = zxtaxes.tax_id 
and zxlines.application_id = zxdet.application_id 
and decode(zxlines.application_id,200,''Payables'',''Receivables'') = ''##$$APPLICATION$$##''
...
and zxlines.trx_id = zxdet.trx_id 
and zxdet.trx_id = ##$$TRANSACTION_ID$$## 
and (zxdet.default_taxation_country in (''BE'', ''CH'', ''CZ'', ''DE'', ''DK'',''ES'', ''EX'', ''FI'', ''FR'', ''GR'',''HU'', ''IL'', ''IT'', ''NL'', ''NO'', ''PL'', ''PT'', ''SE'', ''TR'', ''RU'',''SK'', ''UA'', ''RO'', ''KZ'', ''HR'',''SI'', ''BG'', ''RS'' ,''AE'') or zxdet.default_taxation_country is null)) 
order by reporting_code_char_value',
      p_title                  => 'Reporting Code Association Setup',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Reporting Code Association setup is missing. No reporting code is associated with the tax rates.',
      p_solution               => 'Review Issue#A.3 of Doc [1392535/KB314980#aref_section25] Troubleshooting EMEA VAT reporting issues in Release 12, for more information. ',
      p_success_msg            => 'Reporting Code Association setup is present.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_REPORTING_CODE_ASSOCIATION_MISSING_SETUP');



debug('begin add_signature: JE_TRN_MISSING_EMEA_FORM');
   l_info('##MASK##LEGAL_ENTITY_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TAX_REGISTRATION_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##tax_registration_number'):= 'center,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '10399',
      p_sig_id                 => 'JE_TRN_MISSING_EMEA_FORM',
      p_sig_sql                => 'SELECT xle.name legal_entity_name
...
and zxr.registration_number is not null',
      p_title                  => 'Tax Registration Number (TRN) is Not Available in the List of Values of EMEA VAT Reporting Entities Setup Form',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Tax Registration Number (TRN) is not available in the List of Values of EMEA VAT Reporting Entities setup form.',
      p_solution               => 'Review Issue#A.1 of Doc [1392535/KB314980#aref_section23] Troubleshooting EMEA VAT reporting issues in Release 12, for more information. ',
      p_success_msg            => 'Tax Registration Number is available in the List of Values of EMEA VAT Reporting Entities setup form.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_TRN_MISSING_EMEA_FORM');



debug('begin add_signature: JE_TAX_REPORTING_CODE_UPGRADE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10350',
      p_sig_id                 => 'JE_TAX_REPORTING_CODE_UPGRADE',
      p_sig_sql                => 'SELECT REPORTING_CODE,
      EFFECTIVE_FROM
    FROM
      ...
      p_title                  => 'Tax Reporting Codes Setup Upgrade Status',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Tax Reporting Codes Setup is not upgraded which is causing issues in EMEA VAT Reports.',
      p_solution               => 'Review section 22: Verifying the Tax Reporting Codes Set up not Upgraded of Doc [1316316/KB731274#aref_section322] EB-Tax Data Corruption Issues & Recommended Solutions. ',
      p_success_msg            => 'Tax Reporting Codes Setup is upgraded successfully.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_TAX_REPORTING_CODE_UPGRADE');



debug('begin add_signature: JE_PARTY_TAX_PROFILE_MEMBER_STATE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10351',
      p_sig_id                 => 'JE_PARTY_TAX_PROFILE_MEMBER_STATE',
      p_sig_sql                => 'SELECT *
    ...
    AND REPORTING_CODE_ID         IS NOT NULL',
      p_title                  => 'Associations for Member State Setup at the Party Tax Profile Level',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Associations created for Member State Set up at the party Tax profile level during upgrade are not being visible in the Reporting Code tab under Party tax profile for the Legal Establishment causing issues with Intra EU Audit Trail Report.',
      p_solution               => 'Review [1316316/KB731274#aref_section326] OFFSET_TAX_RATE_CODE is Wrongly Populated in ZX_LINES - Section 26: Associations created for Member State Set up at the party Tax profile level during upgrade are not being visible in the Reporting Code tab under Party tax profile for the Legal Establishment causing issues with Intra EU Audit trail report.',
      p_success_msg            => 'Associations created for Member State Setup at the party Tax profile level during upgrade are correct.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_PARTY_TAX_PROFILE_MEMBER_STATE');



debug('begin add_signature: JE_JG_ZZ_VAT_BOX_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9352',
      p_sig_id                 => 'JE_JG_ZZ_VAT_BOX_ERRORS',
      p_sig_sql                => 'SELECT *
            FROM jg_zz_vat_box_errors
            WHERE vat_transaction_id IN
              (SELECT vat_transaction_id
               FROM jg_zz_vat_trx_details
               WHERE request_id = ##$$EMEA_VAT_SELECTION_PROCESS$$##
               AND (( trx_id = ##$$TRANSACTION_ID$$## )))
            ORDER BY allocation_error_code',
      p_title                  => 'VAT Box Allocation Errors',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are errors that were generated during VAT box allocation process. These errors will be flushed out when allocation processing is run again after setup or corrections are applied.',
      p_solution               => 'Review the following:<br>
- [2126204/KB445673] R12: JG: (JGZZAERL) EMEA VAT: Allocation Errors Listing - NO_BOX_IN_RULE<br>
- [2088611/KB642814] R12: JG: (JGZZAERL) Allocation Errors Listing Report - NO_RULE_APPLICABLE',
      p_success_msg            => 'There are no errors present during VAT box allocation process for Transaction / Invoice ID ##$$TRANSACTION_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_JG_ZZ_VAT_BOX_ERRORS');



debug('begin add_signature: JE_JG_ZZ_VAT_BOX_ALLOCS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9351',
      p_sig_id                 => 'JE_JG_ZZ_VAT_BOX_ALLOCS',
      p_sig_sql                => 'SELECT *
            FROM jg_zz_vat_box_allocs
            WHERE vat_transaction_id IN
              (SELECT vat_transaction_id
               FROM jg_zz_vat_trx_details
               WHERE request_id = ##$$EMEA_VAT_SELECTION_PROCESS$$##
      ...
      p_title                  => 'VAT Box Allocation (JG_ZZ_VAT_BOX_ALLOCS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no records regarding VAT box allocation information for tax and taxable amounts on Transaction / Invoice ID ##$$TRANSACTION_ID$$##.
',
      p_solution               => '',
      p_success_msg            => 'VAT box allocation information for tax and taxable amounts on Transaction / Invoice ID ##$$TRANSACTION_ID$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JE_JG_ZZ_VAT_BOX_ALLOCS');
...
debug('begin add_signature: JE_MODULE_INSTALLATIONS_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15431',
      p_sig_id                 => 'JE_MODULE_INSTALLATIONS_DETAILS',
...
LAST_UPDATE_LOGIN , 
DB_STATUS 
FROM APPLSYS.FND_MODULE_INSTALLATIONS
WHERE APPLICATION_ID IN (7003,7002)
AND STATUS NOT IN (''I'')',
      p_title                  => 'Module Installations Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'List of uninstalled modules on European and Regional Localization.',
      p_solution               => 'There are uninstalled modules for European and Regional Localization.
Follow [351900/KB748836] How To Use OAM To License JA (Asia/Pacific Localizations), JE (European Localizations), JG (Regional Localizations) and JL (Latin-American Localizations) in Oracle Applications.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: JE_MODULE_INSTALLATIONS_DETAILS');
...
BEGIN
  ...
  analyzer_title := 'Financials for EMEA Analyzer';
...
debug('begin section: Proactive_Recommendation');
start_section('Proactive Recommendation', 'Proactive_Recommendation');
   set_item_result(check_rec_patches_1); /* Signature JE_TRL_PATCHES */
   set_item_result(run_stored_sig('JE_INVALID_OBJECTS'));
end_section;
debug('end section: Proactive_Recommendation');

debug('begin section: Tax_Setup');
start_section('Tax Setup', 'Tax_Setup');
   set_item_result(run_stored_sig('JE_TAX_REGIME_UPGRADE'));
   set_item_result(run_stored_sig('JE_TAX_STATUS_UPGRADE'));
   set_item_result(run_stored_sig('JE_TAX_UPGRADE'));
   set_item_result(run_stored_sig('JE_TAX_RATE_UPGRADE'));
end_section;
debug('end section: Tax_Setup');

debug('begin section: EMEA_VAT_Data_Collection');
start_section('EMEA VAT Data Collection', 'EMEA_VAT_Data_Collection');
   set_item_result(run_stored_sig('JE_JG_ZZ_VAT_REP_ENTITIES'));
   set_item_result(run_stored_sig('JE_JG_ZZ_VAT_TRX_DETAILS'));
   set_item_result(run_stored_sig('JE_ZX_RATES_B_JG_TABLES'));
   set_item_result(run_stored_sig('JE_JG_ZZ_VAT_PAYMENT_DETAILS'));
   set_item_result(run_stored_sig('JE_JG_ZZ_VAT_REP_STATUS'));
   set_item_result(run_stored_sig('JE_POLAND_LEGAL_CONTACT'));
   set_item_result(run_stored_sig('JE_ZX_REP_CONTEXT_T'));
   set_item_result(run_stored_sig('JE_JG_ZZ_VAT_FINAL_REPORTS'));
end_section;
debug('end section: EMEA_VAT_Data_Collection');

debug('begin section: Payables_Data_Collection');
IF p_application = 'Payables' THEN
   start_section('Payables Data Collection', 'Payables_Data_Collection');
      set_item_result(run_stored_sig('JE_INCORRECT_OFFSET_TAX_IN_ZX_LINES'));
      set_item_result(run_stored_sig('JE_MISSING_XLA_DISTRIBUTION_FOR_AP_AX_UPGRADE'));
      set_item_result(run_stored_sig('JE_AP_INVOICES_ALL'));
      set_item_result(run_stored_sig('JE_ZX_LINES'));
      set_item_result(run_stored_sig('JE_ZX_LINES_DET_FACTORS'));
      set_item_result(run_stored_sig('JE_AP_INVOICE_PAYMENTS_ALL'));
      set_item_result(run_stored_sig('JE_AP_AWT_TAX_RATES'));
      set_item_result(run_stored_sig('JE_XLA_EVENTS_INVOICE'));
      set_item_result(run_stored_sig('JE_GL_JE_BATCHES_INVOICE'));
      set_item_result(run_stored_sig('JE_AP_SUPPLIER_SITES_ALL'));
      set_item_result(run_stored_sig('JE_AP_SUPPLIERS'));
   end_section;
END IF;
debug('end section: Payables_Data_Collection');

debug('begin section: Receivables_Data_Collection');
IF p_application = 'Receivables' THEN
   start_section('Receivables Data Collection', 'Receivables_Data_Collection');
      set_item_result(run_stored_sig('JE_NULL_VAT_REGISTRATION_CUSTOMER'));
      set_item_result(run_stored_sig('JE_NULL_VAT_REGISTRATION_CUSTOMER_SITE'));
      set_item_result(run_stored_sig('JE_RA_CUSTOMER_TRX_ALL'));
      set_item_result(run_stored_sig('JE_RA_CUSTOMER_TRX_LINES_ALL'));
      set_item_result(run_stored_sig('JE_TRANSACTIONS_NOT_SELECTED_WHEN_RUNNING_THE_EMEA_VAT_SELECTION_PROCESS'));
      set_item_result(run_stored_sig('JE_XLA_EVENTS_AR'));
      set_item_result(run_stored_sig('JE_MISSING_XLA_DISTRIBUTION_FOR_AR_AX_UPGRADE'));
      set_item_result(run_stored_sig('JE_GL_JE_BATCHES_AR'));
   end_section;
END IF;
debug('end section: Receivables_Data_Collection');

debug('begin section: EMEA_VAT_Setup');
start_section('EMEA VAT Setup', 'EMEA_VAT_Setup');
   set_item_result(run_stored_sig('JE_INCORRECT_HQ_ESTAB_REG_NUM'));
   set_item_result(run_stored_sig('JE_TAX_LEVEL_SETUP_MISSING_INCORRECT_SETUP'));
   set_item_result(run_stored_sig('JE_TAX_LEVEL_SETUP_MISSING_CORRECT_SETUP'));
   set_item_result(run_stored_sig('JE_TAX_RATE_VAT_TRX_TYPE_CODE_IS_NULL'));
   set_item_result(run_stored_sig('JE_DRIVING_DATE_CODE'));
   set_item_result(run_stored_sig('JE_REPORTING_CODE_ASSOCIATION_MISSING_SETUP'));
   set_item_result(run_stored_sig('JE_TRN_MISSING_EMEA_FORM'));
   set_item_result(run_stored_sig('JE_TAX_REPORTING_CODE_UPGRADE'));
   set_item_result(run_stored_sig('JE_PARTY_TAX_PROFILE_MEMBER_STATE'));
end_section;
debug('end section: EMEA_VAT_Setup');

debug('begin section: Allocation_Rules');
start_section('Allocation Rules', 'Allocation_Rules');
   set_item_result(run_stored_sig('JE_JG_ZZ_VAT_BOX_ERRORS'));
   set_item_result(run_stored_sig('JE_JG_ZZ_VAT_BOX_ALLOCS'));
   set_item_result(run_stored_sig('JE_JG_ZZ_VAT_BOX_ALLOCS_RULES'));
end_section;
debug('end section: Allocation_Rules');
...
start_section('Apps Check', 'AppsCheck');
   ...
   set_item_result(run_stored_sig('JE_MODULE_INSTALLATIONS_DETAILS'));
