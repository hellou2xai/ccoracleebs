...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Receivables Lockbox Analyzer           |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE ar_lockbox_analyzer_pkg AUTHID DEFINER AS
...
(            p_user_name                    IN VARCHAR2    DEFAULT NULL
           ...
           ,p_trans_name                   IN VARCHAR2    DEFAULT NULL
           ,p_rctnum                       IN VARCHAR2    DEFAULT NULL
...
END ar_lockbox_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY ar_lockbox_analyzer_pkg AS
-- $Id: ar_lockbox_analyzer.sql, 200.66 2026/02/15 16:53:31 bcampesi Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2323322.1));
...
----------------------------------------------------------------
g_trans_name_tmp    VARCHAR2(30) := null;
g_trans_id          NUMBER := NULL;
...
-- for Receipt Information from Interface

g_rctnumber         VARCHAR2(200) := null;
g_custnumber        VARCHAR2(200) := null;
g_bnkacctnum        VARCHAR2(200) := null;
g_routingnum        VARCHAR2(200) := null;
g_funcurr           VARCHAR2(200) := null;
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'AR_LOCKBOX_ANLZ_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'AR_LOCKBOX_ANLZ_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>AR_LOCKBOX_ANLZ Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2323322.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/ar_lockbox_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1116,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1116,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1116,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4101795" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">1116</span>
...
<p>New signature EBS_FIN_AR_GEN_DUP_SYSTEM_PARAMETERS</p>
            <br><br>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1116,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1116,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1116,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_col_rows(5)(l_rows) := '[2102716/PALRT2472]';
...
debug('begin populate parameters hash table');
   ...
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Transmission Name';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_trans_name,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Receipt Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_rctnum,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  l_revision := rtrim(replace('$Revision: 200.66  $','$',''));
  l_revision := ltrim(replace(l_revision,'Revision:',''));
  l_date_char := rtrim(replace('$Date: 2026/02/15 16:53:30 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'ar_lockbox_analyzer.sql';
...
debug('begin parameter validation: p_trans_name');
IF p_trans_name IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Transmission Name is required.');
   raise invalid_parameters;
END IF;
IF p_trans_name IS NOT NULL THEN
BEGIN
SELECT A.TRANSMISSION_NAME
INTO l_exists_val
FROM AR_TRANSMISSIONS_ALL A, HR_OPERATING_UNITS O
WHERE A.TRANSMISSION_NAME = p_trans_name
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid transmission name.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_trans_name failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_trans_name');

debug('begin parameter validation: p_rctnum');
IF p_rctnum IS NOT NULL THEN
BEGIN
SELECT CHECK_NUMBER
INTO l_exists_val
FROM AR_PAYMENTS_INTERFACE_ALL A, AR_TRANSMISSIONS_ALL B, HR_OPERATING_UNITS O
WHERE CHECK_NUMBER = p_rctnum
 AND a.transmission_id = b.transmission_id 
AND b.transmission_name = p_trans_name
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Error: Invalid Receipt Number.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_rctnum failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_rctnum');
...
g_trans_name_tmp := p_trans_name;
g_user_name_tmp := p_user_name;
g_resp_id_tmp := p_resp_id;
g_rctnumber := p_rctnum;


begin

   select U.RESPONSIBILITY_NAME
   into   g_resp_name
   from   FND_RESPONSIBILITY_VL U
   where  u.responsibility_id = g_resp_id_tmp
   and    u.application_id = 222;

   BEGIN

      select org_id, transmission_id
      into   g_org_id, g_trans_id
      from   ar_transmissions_all
      where  transmission_name = g_trans_name_tmp;       
      ...
      select customer_number, transit_routing_number, account
      into   g_custnumber, g_routingnum, g_bnkacctnum
      from   ar_payments_interface_all 
      where  check_number = g_rctnumber
      and    org_id = g_org_id_tmp
      and    transmission_id = (select transmission_id
                                 from ar_transmissions_all
                                 where transmission_name= g_trans_name_tmp);
   ...
   EXCEPTION
   WHEN NO_DATA_FOUND then
      print_log('Transmission name does not exist in AR_TRANSMISSIONS_ALL.');
   END;
...
debug('begin populate sql tokens hash table');
   ...
   g_sql_tokens('##$$TNAME$$##') := g_trans_name_tmp;
   g_masked_tokens('##$$TNAME$$##') := mask_text( g_sql_tokens('##$$TNAME$$##'), 'NO_MASK');
   g_sql_tokens('##$$USERNAME$$##') := g_user_name_tmp;
   g_masked_tokens('##$$USERNAME$$##') := mask_text( g_sql_tokens('##$$USERNAME$$##'), 'DISPLAY_BOTH_25_PCNT_WORD');
   g_sql_tokens('##$$RCTNUMBER$$##') := g_rctnumber;
   g_masked_tokens('##$$RCTNUMBER$$##') := mask_text( g_sql_tokens('##$$RCTNUMBER$$##'), 'NO_MASK');
   g_sql_tokens('##$$CUSTNUMBER$$##') := g_custnumber;
   g_masked_tokens('##$$CUSTNUMBER$$##') := mask_text( g_sql_tokens('##$$CUSTNUMBER$$##'), 'DISPLAY_BOTH_25_PCNT_WORD');
   g_sql_tokens('##$$BNKACCTNUM$$##') := g_bnkacctnum;
   g_masked_tokens('##$$BNKACCTNUM$$##') := mask_text( g_sql_tokens('##$$BNKACCTNUM$$##'), 'DISPLAY_BOTH_25_PCNT_WORD');
   g_sql_tokens('##$$ROUTINGNUM$$##') := g_routingnum ;
   g_masked_tokens('##$$ROUTINGNUM$$##') := mask_text( g_sql_tokens('##$$ROUTINGNUM$$##'), 'DISPLAY_BOTH_25_PCNT_WORD');
   g_sql_tokens('##$$FUNCURR$$##') := g_funcurr ;
   g_masked_tokens('##$$FUNCURR$$##') := mask_text( g_sql_tokens('##$$FUNCURR$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPSCHECK$$##') := p_apps_check;
   g_masked_tokens('##$$APPSCHECK$$##') := mask_text( g_sql_tokens('##$$APPSCHECK$$##'), 'NO_MASK');
   g_sql_tokens('##$$A$$##') := 'AR_LOCKBOX_ANALYZER_PKG';
   ...
   g_sql_tokens('##$$TRANSID$$##') := g_trans_id;
   g_masked_tokens('##$$TRANSID$$##') := mask_text( g_sql_tokens('##$$TRANSID$$##'), 'NO_MASK');
...
debug('begin add_signature: AR_LB_TRANSMISSION');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7304',
      p_sig_id                 => 'AR_LB_TRANSMISSION',
      p_sig_sql                => 'SELECT * 
FROM ar_transmissions_all 
WHERE transmission_name = ''##$$TNAME$$##''',
      p_title                  => 'AR_TRANSMISSIONS_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Lockbox Transmission data in AR_TRANSMISSIONS_ALL.',
      p_solution               => 'Transmission Name does not exist. Please provide a valid Transmission Name.',
      p_success_msg            => 'Displaying Transmission data from AR_TRANSMISSIONS_ALL.',
   ...
   l_info.delete;
debug('end add_signature: AR_LB_TRANSMISSION');



debug('begin add_signature: AR_LB_INTERFACE');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_NAME_ALT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_REFERENCE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##REMITTANCE_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##REMITTANCE_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7308',
      p_sig_id                 => 'AR_LB_INTERFACE',
      p_sig_sql                => 'SELECT *
FROM ar_payments_interface_all
...
ORDER BY transmission_record_id',
      p_title                  => 'AR_PAYMENTS_INTERFACE_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Receipt data in AR_PAYMENTS_INTERFACE_ALL.',
      p_solution               => 'Either no records have been imported into the interface table or the records have already been validated and transferred.',
      p_success_msg            => 'Displaying Receipt data from AR_PAYMENTS_INTERFACE_ALL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_INTERFACE');



debug('begin add_signature: AR_LB_RCT_BATCHES');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
WHERE transmission_id IN (
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Receipt batch data in AR_BATCHES_ALL.',
      p_solution               => 'No Receipt batches have been created for this Transmission.',
      p_success_msg            => 'Displaying data from AR_BATCHES_ALL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_RCT_BATCHES');



debug('begin add_signature: AR_LB_INTERIM_RCT');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_REFERENCE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
...
WHERE batch_id IN (
               ...
               WHERE  transmission_id IN (
                                     ...
                                     FROM ar_transmissions_all
                                     WHERE transmission_name =''##$$TNAME$$##''))',
      p_title                  => 'AR_INTERIM_CASH_RECEIPTS_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Receipt data in AR_INTERIM_CASH_RECEIPTS_ALL.',
      p_solution               => 'Receipts either have not passed the validation yet or have already been imported into Receivables.',
      p_success_msg            => 'Displaying Receipt data from AR_INTERIM_CASH_RECEIPTS_ALL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_INTERIM_RCT');



debug('begin add_signature: AR_LB_INTERIM_RCT_LINES');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_REFERENCE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7318',
      p_sig_id                 => 'AR_LB_INTERIM_RCT_LINES',
      p_sig_sql                => 'SELECT *
...
WHERE batch_id IN (
               ...
               WHERE  transmission_id IN (
                                     ...
                                     FROM ar_transmissions_all
                                     WHERE transmission_name =''##$$TNAME$$##''))',
      p_title                  => 'AR_INTERIM_CASH_RCPT_LINES_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Receipt data in AR_INTERIM_CASH_RCPT_LINES_ALL.',
      p_solution               => 'Receipts either have not passed the validation yet or have already been imported into Receivables.',
      p_success_msg            => 'Displaying Receipt application data from AR_INTERIM_CASH_RCPT_LINES_ALL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_INTERIM_RCT_LINES');



debug('begin add_signature: AR_LB_RCT');
...
WHERE cash_receipt_id IN (
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Receipt data in AR_CASH_RECEIPTS_ALL.',
      p_solution               => 'No Receipts have been imported for this Transmission.',
      p_success_msg            => 'Displaying Receipt data from AR_CASH_RECEIPTS_ALL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_RCT');



debug('begin add_signature: AR_LB_RCT_HISTORY');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7319',
      p_sig_id                 => 'AR_LB_RCT_HISTORY',
      p_sig_sql                => 'SELECT *
FROM ar_cash_receipt_history_all
WHERE batch_id IN (
               SELECT batch_id 
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Receipt data in AR_CASH_RECEIPT_HISTORY_ALL.',
      p_solution               => 'No Receipts have been imported for this Transmission.',
      p_success_msg            => 'Displaying Receipt data from AR_CASH_RECEIPT_HISTORY_ALL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_RCT_HISTORY');



debug('begin add_signature: EBS_FIN_AR_AR_LOCKBOX_ANLZ_RA_CUSTOMER_TRX_ALL');
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_REFERENCE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31730',
      p_sig_id                 => 'EBS_FIN_AR_AR_LOCKBOX_ANLZ_RA_CUSTOMER_TRX_ALL',
      p_sig_sql                => 'SELECT *
FROM   ra_customer_trx_all
WHERE trx_number IN (
  SELECT invoice1 FROM ar_payments_interface_all WHERE transmission_id IN (SELECT transmission_id FROM ar_transmissions_all WHERE transmission_name =''##$$TNAME$$##'')
  UNION
  SELECT invoice2 FROM ar_payments_interface_all WHERE transmission_id IN (SELECT transmission_id FROM ar_transmissions_all WHERE transmission_name =''##$$TNAME$$##'')
  UNION
  SELECT invoice3 FROM ar_payments_interface_all WHERE transmission_id IN (SELECT transmission_id FROM ar_transmissions_all WHERE transmission_name =''##$$TNAME$$##'')
  UNION
  SELECT invoice4 FROM ar_payments_interface_all WHERE transmission_id IN (SELECT transmission_id FROM ar_transmissions_all WHERE transmission_name =''##$$TNAME$$##'')
  UNION
  SELECT invoice5 FROM ar_payments_interface_all WHERE transmission_id IN (SELECT transmission_id FROM ar_transmissions_all WHERE transmission_name =''##$$TNAME$$##'')
  UNION
  SELECT invoice6 FROM ar_payments_interface_all WHERE transmission_id IN (SELECT transmission_id FROM ar_transmissions_all WHERE transmission_name =''##$$TNAME$$##'')
  UNION
  SELECT invoice7 FROM ar_payments_interface_all WHERE transmission_id IN (SELECT transmission_id FROM ar_transmissions_all WHERE transmission_name =''##$$TNAME$$##'')
  UNION
  SELECT invoice8 FROM ar_payments_interface_all WHERE transmission_id IN (SELECT transmission_id FROM ar_transmissions_all WHERE transmission_name =''##$$TNAME$$##'')
)',
      p_title                  => 'RA_CUSTOMER_TRX_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Transaction Header for Transactions in AR_PAYMENTS_INTERFACE_ALL',
      p_solution               => 'Either no records have been imported into the interface table, the records have already been validated and transferred or there is no transaction information in the interface table',
      p_success_msg            => 'Displaying Transaction Header for Transactions in AR_PAYMENTS_INTERFACE_ALL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_AR_LOCKBOX_ANLZ_RA_CUSTOMER_TRX_ALL');



debug('begin add_signature: EBS_FIN_AR_AR_LOCKBOX_ANLZ_AR_PAYMENT_SCHEDULES_ALL');
   l_info('##MASK##ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##GLOBAL_ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31735',
      p_sig_id                 => 'EBS_FIN_AR_AR_LOCKBOX_ANLZ_AR_PAYMENT_SCHEDULES_ALL',
      p_sig_sql                => 'SELECT *
...
WHERE trx_number IN (
  ...
  SELECT invoice8 FROM ar_payments_interface_all WHERE transmission_id IN (SELECT transmission_id FROM ar_transmissions_all WHERE transmission_name =''##$$TNAME$$##'')
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Payment Schedule Record for Transactions in AR_PAYMENTS_INTERFACE_ALL
',
      p_solution               => 'Either no records have been imported into the interface table, the records have already been validated and transferred or there is no transaction information in the interface table',
      p_success_msg            => 'Displaying Payment Schedule for Transactions in AR_PAYMENTS_INTERFACE_ALL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_AR_LOCKBOX_ANLZ_AR_PAYMENT_SCHEDULES_ALL');



debug('begin add_signature: AR_LB_LOCKBOX');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CONTACT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_NAME_ALT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_REFERENCE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##REMITTANCE_BANK_BRANCH_NAM'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##REMITTANCE_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TELEPHONE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7321',
      p_sig_id                 => 'AR_LB_LOCKBOX',
      p_sig_sql                => 'SELECT * 
FROM ar_lockboxes_all
WHERE (lockbox_number, org_id) IN (
                               SELECT lockbox_number, org_id 
                               FROM ar_payments_interface_all
                               WHERE transmission_id IN (
                                                     SELECT transmission_id 
                                                     FROM ar_transmissions_all
                                                     WHERE transmission_name =''##$$TNAME$$##''   )
                               GROUP BY lockbox_number, org_id )
UNION
SELECT * 
FROM ar_lockboxes_all
WHERE lockbox_id IN (
      ...
      p_title                  => 'Lockbox',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Lockbox Setup associated to the Transmission.',
      p_solution               => 'Lockbox number not found in Interface table AR_PAYMENTS_INTERFACE_ALL due to:
<ul>
<li>Lockbox number does not exist, OR</li>
<li>Interface data has not been validated yet. </li>
</ul>
Please verify lockbox# is populated in the interface table, submit Lockbox validation and rerun the Analyzer.',
      p_success_msg            => 'Displaying Lockbox setup data from AR_LOCKBOXES_ALL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_LOCKBOX');



debug('begin add_signature: AR_LB_RCT_SOURCE');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7322',
      p_sig_id                 => 'AR_LB_RCT_SOURCE',
      p_sig_sql                => 'SELECT *
FROM ar_batch_sources_all
WHERE (batch_source_id, org_id) IN (
      ...
      p_title                  => 'Receipt Source',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Receipt Source associated to the Lockbox Transmission.',
      p_solution               => 'Lockbox number not found in Interface table AR_PAYMENTS_INTERFACE_ALL due to:
<ul>
<li>Lockbox number does not exist, OR</li>
<li>Interface data has not been validated yet. </li>
...
Please verify lockbox# is populated in the interface table, submit Lockbox validation and rerun the Analyzer.',
      p_success_msg            => 'Displaying Receipt Source setup data from AR_BATCH_SOURCES_ALL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_RCT_SOURCE');



debug('begin add_signature: AR_LB_RCT_CLASS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7324',
      p_sig_id                 => 'AR_LB_RCT_CLASS',
      p_sig_sql                => 'SELECT *
FROM ar_receipt_classes
WHERE receipt_class_id IN (
                     SELECT default_receipt_class_id 
                     FROM ar_batch_sources_all
                     WHERE (batch_source_id, org_id) IN (
                                                  SELECT batch_source_id, org_id
                                                  FROM ar_lockboxes_all
      ...
      p_title                  => 'Receipt Class',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Receipt Class associated to the Lockbox Transmission.',
      p_solution               => 'Lockbox number not found in Interface table AR_PAYMENTS_INTERFACE_ALL due to:
<ul>
<li>Lockbox number does not exist, OR</li>
<li>Interface data has not been validated yet. </li>
...
Please verify lockbox# is populated in the interface table, submit Lockbox validation and rerun the Analyzer.',
      p_success_msg            => 'Displaying Receipt Class setup data from AR_RECEIPT_CLASSES.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_RCT_CLASS');



debug('begin add_signature: AR_LB_RCT_METHODS');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7325',
      p_sig_id                 => 'AR_LB_RCT_METHODS',
      p_sig_sql                => 'SELECT *
FROM ar_receipt_methods
WHERE receipt_method_id IN (
                     SELECT default_receipt_method_id 
                     FROM ar_batch_sources_all
                     WHERE (batch_source_id, org_id) IN (
                                                  SELECT batch_source_id, org_id
                                                  FROM ar_lockboxes_all
      ...
      p_title                  => 'Receipt Method',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Receipt Method associated to the Lockbox Transmission.',
      p_solution               => 'Lockbox number not found in Interface table AR_PAYMENTS_INTERFACE_ALL due to:
<ul>
<li>Lockbox number does not exist, OR</li>
<li>Interface data has not been validated yet. </li>
...
Please verify lockbox# is populated in the interface table, submit Lockbox validation and rerun the Analyzer.',
      p_success_msg            => 'Displaying Receipt Method setup data from AR_RECEIPT_METHODS.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_RCT_METHODS');



debug('begin add_signature: AR_LB_RCT_METHOD_ACCOUNTS');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7326',
      p_sig_id                 => 'AR_LB_RCT_METHOD_ACCOUNTS',
      p_sig_sql                => 'SELECT *
FROM ar_receipt_method_accounts_all
WHERE (receipt_method_id, remit_bank_acct_use_id, org_id) IN (
                     SELECT default_receipt_method_id, remit_bank_acct_use_id, org_id
                     FROM ar_batch_sources_all
                     WHERE (batch_source_id, org_id) IN (
                                                  SELECT batch_source_id, org_id
                                                  FROM ar_lockboxes_all
      ...
      p_title                  => 'Remittance Bank Account',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Remittance Bank Account associated to the Lockbox Transmission.',
      p_solution               => 'Lockbox number not found in Interface table AR_PAYMENTS_INTERFACE_ALL due to:
<ul>
<li>Lockbox number does not exist, OR</li>
<li>Interface data has not been validated yet. </li>
...
Please verify lockbox# is populated in the interface table, submit Lockbox validation and rerun the Analyzer.',
      p_success_msg            => 'Displaying Remittance Bank Account setup data from AR_RECEIPT_METHOD_ACCOUNTS_ALL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_RCT_METHOD_ACCOUNTS');



debug('begin add_signature: AR_LB_TRANS_FMT_FIELDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7502',
      p_sig_id                 => 'AR_LB_TRANS_FMT_FIELDS',
      p_sig_sql                => 'Select tf.field_start_position, tf.field_end_position, 
       al1.meaning field_type, al2.meaning justify, al3.meaning fill_symbol, 
       tf.date_picture_lookup_code, tf.time_picture_lookup_code, 
       tf.amount_format_lookup_code, tf.overflow_rec_indicator
From ar_trans_field_formats tf, 
ar_lookups al1, ar_lookups al2, ar_lookups al3
Where tf.transmission_format_id = ##$$FK1$$##
And tf.record_format_id = ##$$FK2$$##
AND  al1.lookup_code           = tf.field_type_lookup_code
AND  al1.lookup_type           = ''TRANS_FIELD_TYPES''
AND    al2.lookup_code           = tf.justification_lookup_code
AND    al2.lookup_type           = ''TRANS_JUSTIFICATIONS''
AND    al3.lookup_code           = tf.fill_character_lookup_code
AND    al3.lookup_type           = ''TRANS_FILL_CHARACTERS''  
Order By  tf.record_format_id, tf.field_start_position',
      p_title                  => 'Transmission Format Fields',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This is data collection of Transmission Format Fields associated to Lockbox Transmission Format Setup.',
      p_solution               => 'Transmission Format not found due to:
<ul>
<li>Transmission Name does not exist, OR</li>
<li>Format associated to Transmission does not exist. </li>
</ul>
Please provide a valid Transmission Name that is associated to valid Transmission Format.',
      p_success_msg            => 'Displaying Transmission Format setup data from AR_TRANS_FIELD_FORMATS.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_TRANS_FMT_FIELDS');



debug('begin add_signature: AR_LB_TRANS_FMT_REC_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7501',
      p_sig_id                 => 'AR_LB_TRANS_FMT_REC_TYPES',
      p_sig_sql                => 'Select tr.record_format_id "##$$FK2$$##", tr.record_identifier,al.meaning, tr.description
From ar_trans_record_formats tr, ar_lookups al
Where tr.transmission_format_id = ##$$FK1$$##
And   record_type_lookup_code=al.lookup_code  
And   al.lookup_type = ''TRANS_RECORD_TYPES''
Order By  tr.record_identifier',
      p_title                  => 'Transmission Format Record Types',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This is data collection of Transmission Format Record Types associated to Lockbox Transmission Format Setup.',
      p_solution               => 'Transmission Format not found due to:
<ul>
<li>Transmission Name does not exist, OR</li>
<li>Format associated to Transmission does not exist. </li>
...
Please provide a valid Transmission Name that is associated to valid Transmission Format.',
      p_success_msg            => 'Displaying Transmission Format setup data from AR_TRANS_RECORD_FORMATS.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('AR_LB_TRANS_FMT_FIELDS'),
      p_include_in_dx_summary  => nvl('Y','N'),
      p_version                => '10'
      );
   l_info.delete;
debug('end add_signature: AR_LB_TRANS_FMT_REC_TYPES');



debug('begin add_signature: AR_LB_TRANS_FMT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7496',
      p_sig_id                 => 'AR_LB_TRANS_FMT',
      p_sig_sql                => 'Select transmission_format_id, transmission_format_id "##$$FK1$$##", format_name, description, status_lookup_code Status
From ar_transmission_formats 
Where transmission_format_id in (Select requested_trans_format_id 
                          From ar_transmissions_all
                          Where transmission_name= ''##$$TNAME$$##'')',
      p_title                  => 'Transmission Format',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Transmission Format associated to the Lockbox Transmission.',
      p_solution               => 'Transmission Format not found due to:
<ul>
<li>Transmission Name does not exist, OR</li>
<li>Format associated to Transmission does not exist. </li>
...
',
      p_success_msg            => 'Displaying Transmission Format setup data from AR_TRANSMISSION_FORMATS.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('AR_LB_TRANS_FMT_REC_TYPES'),
      p_include_in_dx_summary  => nvl('Y','N'),
      p_version                => '13'
      );
   l_info.delete;
debug('end add_signature: AR_LB_TRANS_FMT');



debug('begin add_signature: AR_LB_PS_SEED_DATA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7652',
      p_sig_id                 => 'AR_LB_PS_SEED_DATA',
      p_sig_sql                => 'SELECT payment_schedule_id, trx_number
FROM ar_payment_schedules_all
WHERE payment_schedule_id < 0',
      p_title                  => 'Seed Data from AR Payment Schedules',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Seed Data from AR_PAYMENT_SCHEDULES_ALL.',
      p_solution               => 'Missing Seeded records in AR_PAYMENT_SCHEDULES_ALL.  Please log an SR with Oracle Support Services for a datafix.',
      p_success_msg            => 'Displaying Seed data from AR_PAYMENT_SCHEDULES_ALL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_PS_SEED_DATA');



debug('begin add_signature: EBS_FIN_AR_AR_LOCKBOX_ANLZ_AUTOMATCH_ENABLED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23550',
      p_sig_id                 => 'EBS_FIN_AR_AR_LOCKBOX_ANLZ_AUTOMATCH_ENABLED',
      p_sig_sql                => 'SELECT  AUTOMATCH_ENABLED_FLAG, ORG_ID
FROM     AR_SYSTEM_PARAMETERS_ALL
WHERE  AUTOMATCH_ENABLED_FLAG = ''T''
AND       ORG_ID = ##$$ORGID$$##',
      p_title                  => 'Automatic Match Cash Application Feature',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Automatic Match Cash Application Feature is Enabled',
      p_solution               => '<ul><li>The analyzer has detected that you have enabled the Automatic Match Cash Application Feature. This could cause Lockbox Process to fail. Please review ARLPLB AutoLockbox Process Failing With Error AR-ARLVLN: Error from arlvcr [2191912/KB505395]</li>
<li>Please log a Service Request if you need assistance </li>
</ul>',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_AR_LOCKBOX_ANLZ_AUTOMATCH_ENABLED');



debug('begin add_signature: AR_LB_RCT_INFO');
   l_info('##MASK##VALUE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7516',
      p_sig_id                 => 'AR_LB_RCT_INFO',
      p_sig_sql                => 'Select ''Receipt Number'' "Field Name", ''##$$RCTNUMBER$$##'' "Value"
From dual
Union
Select ''Customer Number'', ''##$$CUSTNUMBER$$##''
From dual
Union
Select ''MICR'', ''##$$ROUTINGNUM$$##''||'' ''|| ''##$$BNKACCTNUM$$##''
from dual',
      p_title                  => 'Receipt Summary',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Receipt Information from the Interface Table.',
      p_solution               => 'Receipt Number not found in AR_PAYMENTS_INTERFACE_ALL for this transmission. Please provide a valid Receipt Number. ',
      p_success_msg            => 'Displaying Receipt Information from AR_PAYMENTS_INTERFACE_ALL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_RCT_INFO');



debug('begin add_signature: AR_LB_CUST_MULTIPLE_PRIMARY_BILL_TO');
   l_info('##MASK##ACCOUNT_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7637',
      p_sig_id                 => 'AR_LB_CUST_MULTIPLE_PRIMARY_BILL_TO',
      p_sig_sql                => 'SELECT a.cust_account_id, b.account_number,s.org_id,count(*)
FROM hz_cust_site_uses_all s,hz_cust_acct_sites_all a, hz_cust_accounts b
WHERE a.cust_account_id = b.cust_account_id
AND a.cust_account_id IN (SELECT cust_account_id 
   FROM hz_cust_accounts 
   WHERE account_number IN (SELECT customer_number 
               FROM ar_payments_interface_all 
               WHERE  transmission_id IN (
                       SELECT transmission_id
                       FROM ar_transmissions_all
...
AND (s.site_use_code = ''BILL_TO''OR s.site_use_code = ''DRAWEE''
AND NOT EXISTS ( SELECT ''primary bill to''
FROM hz_cust_site_uses_all s2,hz_cust_acct_sites_all a2
WHERE a2.cust_acct_site_id = s2.cust_acct_site_id
AND s2.site_use_code = ''BILL_TO''
AND s2.primary_flag = ''Y''
AND s2.status = ''A''))
AND s.primary_flag = ''Y''
AND s.status = ''A''
group by a.cust_account_id, b.account_number, s.org_id 
having count(*) > 1',
      p_title                  => 'Customer accounts with more than one active Primary Bill-To location',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Customer Accounts have more than One Active Primary Bill-To location.',
      p_solution               => 'The analyzer has identified customer accounts with multiple primary bill-to as described in [1366298/KB695542#aref_section210].<br><br>
Please perform the following steps:
<ul><li>Responsibility: Receivables Manager</li>
<li>Navigation: Customers > Customers</li>
<li>Query up the customer record  raising the error</li>
<li>Identify the site used and Business Purposes Tab, ensure only one BILL TO is tagged as PRIMARY.</li>
</ul>',
      p_success_msg            => 'There are no customers with more than one active primary Bill-To location.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_CUST_MULTIPLE_PRIMARY_BILL_TO');



debug('begin add_signature: AR_LB_CONC_MULTI_ORG_CATEGORY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7651',
      p_sig_id                 => 'AR_LB_CONC_MULTI_ORG_CATEGORY',
      p_sig_sql                => 'Select concurrent_program_name, multi_org_category 
From fnd_concurrent_programs 
Where concurrent_program_name=''ARLPLB''
And multi_org_category=''M''',
      p_title                  => 'Multi Org Category On Lockbox Concurrent Program',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Lockbox program is supported only for single org since the operating unit parameter is mandatory for this program. Note that this parameter should not be set to ''M''.',
      p_solution               => '<ul><li>The analyzer has identified Lockbox Concurrent program definition is incorrect as described in [1366298/KB695542#aref_section213].</li>
<li>Please follow the solution provided in [1366298/KB695542#aref_section213].</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_CONC_MULTI_ORG_CATEGORY');



debug('begin add_signature: AR_LB_EXCH_RATE_GL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7653',
      p_sig_id                 => 'AR_LB_EXCH_RATE_GL',
      p_sig_sql                => 'SELECT currency_code, receipt_date, exchange_rate_type
FROM ar_payments_interface_all ARI
WHERE ARI.transmission_id IN (
         SELECT transmission_id
         FROM ar_transmissions_all
         WHERE transmission_name =''##$$TNAME$$##'')
AND ARI.exchange_rate_type <> ''User''
AND NOT EXISTS
(SELECT ''x''
FROM gl_daily_rates GDR
WHERE GDR.from_currency = ARI.currency_code
AND GDR.to_currency = ''##$$FUNCURR$$##''
AND GDR.conversion_date = ARI.receipt_date
AND GDR.conversion_type = ARI.exchange_rate_type )',
      p_title                  => 'Missing Exchange Rate in GL Daily Rates',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Exchange Rate between the receipt currency code and functional currency missing in GL_DAILY_RATES. ',
      p_solution               => '<ul><li>The analyzer has identified Exchange Rates missing in GL as described in [1366298/KB695542#aref_section215].</li>
<li>Please follow the solution provided in [1366298/KB695542#aref_section215].</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_EXCH_RATE_GL');



debug('begin add_signature: AR_LB_DIFF_EX_RATES_SAME_TRXN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7654',
      p_sig_id                 => 'AR_LB_DIFF_EX_RATES_SAME_TRXN',
      p_sig_sql                => 'select 
  payment_schedule_id, 
  customer_trx_id, 
  batch_id, 
...
from 
  ar_interim_cash_rcpt_lines_all a
where 
  batch_id in (
    select batch_id 
    from   ar_batches_all 
...
and exists (
  select 1
  from   ar_interim_cash_rcpt_lines_all b
  where  a.payment_schedule_id = b.payment_schedule_id
  and    a.batch_id = b.batch_id
  and    nvl(a.trans_to_receipt_rate, 0) <> nvl(b.trans_to_receipt_rate, 0)
)
order by payment_schedule_id',
      p_title                  => 'Multiple applications against same invoice with different rate',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Multiple receipt applications against same invoice with different exchange rate in AR_PAYMENTS_INTERFACE_ALL.',
      p_solution               => '<ul><li>The analyzer has identified Multiple applications against same invoice with different rates as described in [1366298/KB695542#aref_section293].</li>
<li>Please follow the solution provided in [1366298/KB695542#aref_section293].</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_DIFF_EX_RATES_SAME_TRXN');



debug('begin add_signature: AR_LB_APP_OVERAPPLIED');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '12669',
      p_sig_id                 => 'AR_LB_APP_OVERAPPLIED',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID , CREATION_DATE , CREATED_BY , LAST_UPDATE_LOGIN , LAST_UPDATED_BY , LAST_UPDATE_DATE , RECORD_TYPE , STATUS , TRANSMISSION_REQUEST_ID , DESTINATION_ACCOUNT , ORIGINATION , DEPOSIT_DATE , DEPOSIT_TIME , TRANSMISSION_RECORD_COUNT , TRANSMISSION_AMOUNT , LOCKBOX_NUMBER , LOCKBOX_BATCH_COUNT , LOCKBOX_RECORD_COUNT , LOCKBOX_AMOUNT , BATCH_NAME , BATCH_AMOUNT , BATCH_RECORD_COUNT , ITEM_NUMBER , CURRENCY_CODE , REMITTANCE_AMOUNT , TRANSIT_ROUTING_NUMBER , ACCOUNT , CHECK_NUMBER , CUSTOMER_NUMBER , OVERFLOW_INDICATOR , OVERFLOW_SEQUENCE , GL_DATE , COMMENTS , CUSTOMER_ID , SPECIAL_TYPE , RECEIPT_METHOD , RECEIPT_METHOD_ID , BILL_TO_LOCATION , CUSTOMER_SITE_USE_ID , TRANSFERRED_RECEIPT_COUNT , TRANSFERRED_RECEIPT_AMOUNT , EXCHANGE_RATE_TYPE , EXCHANGE_RATE , CUSTOMER_BANK_ACCOUNT_ID , TRANSMISSION_ID , RECEIPT_DATE , ORG_ID , ANTICIPATED_CLEARING_DATE , CUSTOMER_NAME_ALT , CUSTOMER_BANK_NAME , CUSTOMER_BANK_BRANCH_NAME , REMITTANCE_BANK_NAME , REMITTANCE_BANK_BRANCH_NAME , BANK_TRX_CODE , MATCH_RESOLVED_USING , INVOICE_CURRENCY_CODE1 , INVOICE_CURRENCY_CODE2 , INVOICE_CURRENCY_CODE3 , SOURCE_TYPE_FLAG , SC_MATCHING_STATUS FROM AR_PAYMENTS_INTERFACE_ALL WHERE INSTR(STATUS,''AR_PLB_APP_OVERAPPLIED'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Credit Balance Not Sufficient For Applied Amount',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Credit balance not sufficient for applied amount.',
      p_solution               => '<ul><li>The transmission data was attempting to over apply a receipt</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_APP_OVERAPPLIED');



debug('begin add_signature: AR_LB_AUTOASSOC');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '12670',
      p_sig_id                 => 'AR_LB_AUTOASSOC',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID , CREATION_DATE , CREATED_BY , LAST_UPDATE_LOGIN , LAST_UPDATED_BY , LAST_UPDATE_DATE , RECORD_TYPE , STATUS , TRANSMISSION_REQUEST_ID , DESTINATION_ACCOUNT , ORIGINATION , DEPOSIT_DATE , DEPOSIT_TIME , TRANSMISSION_RECORD_COUNT , TRANSMISSION_AMOUNT , LOCKBOX_NUMBER , LOCKBOX_BATCH_COUNT , LOCKBOX_RECORD_COUNT , LOCKBOX_AMOUNT , BATCH_NAME , BATCH_AMOUNT , BATCH_RECORD_COUNT , ITEM_NUMBER , CURRENCY_CODE , REMITTANCE_AMOUNT , TRANSIT_ROUTING_NUMBER , ACCOUNT , CHECK_NUMBER , CUSTOMER_NUMBER , OVERFLOW_INDICATOR , OVERFLOW_SEQUENCE , GL_DATE , COMMENTS , CUSTOMER_ID , SPECIAL_TYPE , RECEIPT_METHOD , RECEIPT_METHOD_ID , BILL_TO_LOCATION , CUSTOMER_SITE_USE_ID , TRANSFERRED_RECEIPT_COUNT , TRANSFERRED_RECEIPT_AMOUNT , EXCHANGE_RATE_TYPE , EXCHANGE_RATE , CUSTOMER_BANK_ACCOUNT_ID , TRANSMISSION_ID , RECEIPT_DATE , ORG_ID , ANTICIPATED_CLEARING_DATE , CUSTOMER_NAME_ALT , CUSTOMER_BANK_NAME , CUSTOMER_BANK_BRANCH_NAME , REMITTANCE_BANK_NAME , REMITTANCE_BANK_BRANCH_NAME , BANK_TRX_CODE , MATCH_RESOLVED_USING , INVOICE_CURRENCY_CODE1 , INVOICE_CURRENCY_CODE2 , INVOICE_CURRENCY_CODE3 , SOURCE_TYPE_FLAG , SC_MATCHING_STATUS FROM AR_PAYMENTS_INTERFACE_ALL WHERE INSTR(STATUS,''AR_PLB_AUTOASSOC'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Customer Identified By Invoice Numbers',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Currency must match the bank accounts currency.',
      p_solution               => '<ul><li>When using multi-currency receipts in Lockbox, you need a bank with RECEIPT_MULTI_CURRENCY_FLAG = Y</li>
<li>For more information read [2068287/KB444214]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_AUTOASSOC');



debug('begin add_signature: AR_LB_BAD_CUST_NUM');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '12671',
      p_sig_id                 => 'AR_LB_BAD_CUST_NUM',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID , CREATION_DATE , CREATED_BY , LAST_UPDATE_LOGIN , LAST_UPDATED_BY , LAST_UPDATE_DATE , RECORD_TYPE , STATUS , TRANSMISSION_REQUEST_ID , DESTINATION_ACCOUNT , ORIGINATION , DEPOSIT_DATE , DEPOSIT_TIME , TRANSMISSION_RECORD_COUNT , TRANSMISSION_AMOUNT , LOCKBOX_NUMBER , LOCKBOX_BATCH_COUNT , LOCKBOX_RECORD_COUNT , LOCKBOX_AMOUNT , BATCH_NAME , BATCH_AMOUNT , BATCH_RECORD_COUNT , ITEM_NUMBER , CURRENCY_CODE , REMITTANCE_AMOUNT , TRANSIT_ROUTING_NUMBER , ACCOUNT , CHECK_NUMBER , CUSTOMER_NUMBER , OVERFLOW_INDICATOR , OVERFLOW_SEQUENCE , GL_DATE , COMMENTS , CUSTOMER_ID , SPECIAL_TYPE , RECEIPT_METHOD , RECEIPT_METHOD_ID , BILL_TO_LOCATION , CUSTOMER_SITE_USE_ID , TRANSFERRED_RECEIPT_COUNT , TRANSFERRED_RECEIPT_AMOUNT , EXCHANGE_RATE_TYPE , EXCHANGE_RATE , CUSTOMER_BANK_ACCOUNT_ID , TRANSMISSION_ID , RECEIPT_DATE , ORG_ID , ANTICIPATED_CLEARING_DATE , CUSTOMER_NAME_ALT , CUSTOMER_BANK_NAME , CUSTOMER_BANK_BRANCH_NAME , REMITTANCE_BANK_NAME , REMITTANCE_BANK_BRANCH_NAME , BANK_TRX_CODE , MATCH_RESOLVED_USING , INVOICE_CURRENCY_CODE1 , INVOICE_CURRENCY_CODE2 , INVOICE_CURRENCY_CODE3 , SOURCE_TYPE_FLAG , SC_MATCHING_STATUS FROM AR_PAYMENTS_INTERFACE_ALL WHERE INSTR(STATUS,''AR_PLB_BAD_CUST_NUM'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Customer Number Is Invalid',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Customer number is invalid.',
      p_solution               => '<ul><li>Please enter a valid customer number</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_BAD_CUST_NUM');



debug('begin add_signature: AR_LB_BAD_GL_DATE_SOURCE');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '12672',
      p_sig_id                 => 'AR_LB_BAD_GL_DATE_SOURCE',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID , CREATION_DATE , CREATED_BY , LAST_UPDATE_LOGIN , LAST_UPDATED_BY , LAST_UPDATE_DATE , RECORD_TYPE , STATUS , TRANSMISSION_REQUEST_ID , DESTINATION_ACCOUNT , ORIGINATION , DEPOSIT_DATE , DEPOSIT_TIME , TRANSMISSION_RECORD_COUNT , TRANSMISSION_AMOUNT , LOCKBOX_NUMBER , LOCKBOX_BATCH_COUNT , LOCKBOX_RECORD_COUNT , LOCKBOX_AMOUNT , BATCH_NAME , BATCH_AMOUNT , BATCH_RECORD_COUNT , ITEM_NUMBER , CURRENCY_CODE , REMITTANCE_AMOUNT , TRANSIT_ROUTING_NUMBER , ACCOUNT , CHECK_NUMBER , CUSTOMER_NUMBER , OVERFLOW_INDICATOR , OVERFLOW_SEQUENCE , GL_DATE , COMMENTS , CUSTOMER_ID , SPECIAL_TYPE , RECEIPT_METHOD , RECEIPT_METHOD_ID , BILL_TO_LOCATION , CUSTOMER_SITE_USE_ID , TRANSFERRED_RECEIPT_COUNT , TRANSFERRED_RECEIPT_AMOUNT , EXCHANGE_RATE_TYPE , EXCHANGE_RATE , CUSTOMER_BANK_ACCOUNT_ID , TRANSMISSION_ID , RECEIPT_DATE , ORG_ID , ANTICIPATED_CLEARING_DATE , CUSTOMER_NAME_ALT , CUSTOMER_BANK_NAME , CUSTOMER_BANK_BRANCH_NAME , REMITTANCE_BANK_NAME , REMITTANCE_BANK_BRANCH_NAME , BANK_TRX_CODE , MATCH_RESOLVED_USING , INVOICE_CURRENCY_CODE1 , INVOICE_CURRENCY_CODE2 , INVOICE_CURRENCY_CODE3 , SOURCE_TYPE_FLAG , SC_MATCHING_STATUS FROM AR_PAYMENTS_INTERFACE_ALL WHERE INSTR(STATUS,''AR_PLB_BAD_GL_DATE_SOURCE'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'GL Date Cannot Be Determined From The Source',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'General Ledger date cannot be determined from the source.',
      p_solution               => '<ul><li>Please pass a GL Date that is in an open period</li>
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_BAD_GL_DATE_SOURCE');



debug('begin add_signature: AR_LB_BAD_MICR_NUM');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '12673',
      p_sig_id                 => 'AR_LB_BAD_MICR_NUM',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID , CREATION_DATE , CREATED_BY , LAST_UPDATE_LOGIN , LAST_UPDATED_BY , LAST_UPDATE_DATE , RECORD_TYPE , STATUS , TRANSMISSION_REQUEST_ID , DESTINATION_ACCOUNT , ORIGINATION , DEPOSIT_DATE , DEPOSIT_TIME , TRANSMISSION_RECORD_COUNT , TRANSMISSION_AMOUNT , LOCKBOX_NUMBER , LOCKBOX_BATCH_COUNT , LOCKBOX_RECORD_COUNT , LOCKBOX_AMOUNT , BATCH_NAME , BATCH_AMOUNT , BATCH_RECORD_COUNT , ITEM_NUMBER , CURRENCY_CODE , REMITTANCE_AMOUNT , TRANSIT_ROUTING_NUMBER , ACCOUNT , CHECK_NUMBER , CUSTOMER_NUMBER , OVERFLOW_INDICATOR , OVERFLOW_SEQUENCE , GL_DATE , COMMENTS , CUSTOMER_ID , SPECIAL_TYPE , RECEIPT_METHOD , RECEIPT_METHOD_ID , BILL_TO_LOCATION , CUSTOMER_SITE_USE_ID , TRANSFERRED_RECEIPT_COUNT , TRANSFERRED_RECEIPT_AMOUNT , EXCHANGE_RATE_TYPE , EXCHANGE_RATE , CUSTOMER_BANK_ACCOUNT_ID , TRANSMISSION_ID , RECEIPT_DATE , ORG_ID , ANTICIPATED_CLEARING_DATE , CUSTOMER_NAME_ALT , CUSTOMER_BANK_NAME , CUSTOMER_BANK_BRANCH_NAME , REMITTANCE_BANK_NAME , REMITTANCE_BANK_BRANCH_NAME , BANK_TRX_CODE , MATCH_RESOLVED_USING , INVOICE_CURRENCY_CODE1 , INVOICE_CURRENCY_CODE2 , INVOICE_CURRENCY_CODE3 , SOURCE_TYPE_FLAG , SC_MATCHING_STATUS FROM AR_PAYMENTS_INTERFACE_ALL WHERE INSTR(STATUS,''AR_PLB_BAD_MICR_NUM'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'MICR Number Refers To More Than One Customer',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'MICR number refers to more than one customer.',
      p_solution               => '<ul><li>Ensure the MICR number is unique for each customer</li>
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_BAD_MICR_NUM');



debug('begin add_signature: AR_LB_BAD_ORIGIN');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '12674',
      p_sig_id                 => 'AR_LB_BAD_ORIGIN',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID , CREATION_DATE , CREATED_BY , LAST_UPDATE_LOGIN , LAST_UPDATED_BY , LAST_UPDATE_DATE , RECORD_TYPE , STATUS , TRANSMISSION_REQUEST_ID , DESTINATION_ACCOUNT , ORIGINATION , DEPOSIT_DATE , DEPOSIT_TIME , TRANSMISSION_RECORD_COUNT , TRANSMISSION_AMOUNT , LOCKBOX_NUMBER , LOCKBOX_BATCH_COUNT , LOCKBOX_RECORD_COUNT , LOCKBOX_AMOUNT , BATCH_NAME , BATCH_AMOUNT , BATCH_RECORD_COUNT , ITEM_NUMBER , CURRENCY_CODE , REMITTANCE_AMOUNT , TRANSIT_ROUTING_NUMBER , ACCOUNT , CHECK_NUMBER , CUSTOMER_NUMBER , OVERFLOW_INDICATOR , OVERFLOW_SEQUENCE , GL_DATE , COMMENTS , CUSTOMER_ID , SPECIAL_TYPE , RECEIPT_METHOD , RECEIPT_METHOD_ID , BILL_TO_LOCATION , CUSTOMER_SITE_USE_ID , TRANSFERRED_RECEIPT_COUNT , TRANSFERRED_RECEIPT_AMOUNT , EXCHANGE_RATE_TYPE , EXCHANGE_RATE , CUSTOMER_BANK_ACCOUNT_ID , TRANSMISSION_ID , RECEIPT_DATE , ORG_ID , ANTICIPATED_CLEARING_DATE , CUSTOMER_NAME_ALT , CUSTOMER_BANK_NAME , CUSTOMER_BANK_BRANCH_NAME , REMITTANCE_BANK_NAME , REMITTANCE_BANK_BRANCH_NAME , BANK_TRX_CODE , MATCH_RESOLVED_USING , INVOICE_CURRENCY_CODE1 , INVOICE_CURRENCY_CODE2 , INVOICE_CURRENCY_CODE3 , SOURCE_TYPE_FLAG , SC_MATCHING_STATUS FROM AR_PAYMENTS_INTERFACE_ALL WHERE INSTR(STATUS,''AR_PLB_BAD_ORIGIN'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Bank Origination Number Not Defined For This Lockbox',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Bank origination number not defined for this Lockbox.',
      p_solution               => '<ul><li>Please define the Bank Origination Number</li>
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_BAD_ORIGIN');



debug('begin add_signature: AR_LB_BATCH_AMT_BAD');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '12996',
      p_sig_id                 => 'AR_LB_BATCH_AMT_BAD',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
,      CREATION_DATE
,      CREATED_BY
,      LAST_UPDATE_LOGIN
,      LAST_UPDATED_BY
...
,      SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_BATCH_AMT_BAD'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Batch Amount Does Not Equal Sum Of Receipt Amounts',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Batch amount does not equal sum of receipt amounts.',
      p_solution               => '<ul><li>Please make sure Batch amount is equal to sum of the receipt amounts</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_BATCH_AMT_BAD');



debug('begin add_signature: AR_LB_BATCH_COUNT_BAD');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '12997',
      p_sig_id                 => 'AR_LB_BATCH_COUNT_BAD',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
,      CREATION_DATE
,      CREATED_BY
,      LAST_UPDATE_LOGIN
...
,      SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_BATCH_COUNT_BAD'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Batch Record Count Does Not Equal Number Of Receipts',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Batch record count does not equal number of receipts.',
      p_solution               => '<ul><li>Please make sure Batch record count is equal to number of receipts</li>
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_BATCH_COUNT_BAD');



debug('begin add_signature: AR_LB_BR_RESERVED');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
,      SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_BR_RESERVED'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Invoice Has Been Selected For Bills Receivable Transaction',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invoice has been selected for Bills Receivable transaction.',
      p_solution               => '<ul><li>Please verify whether the transaction was selected for Bills Receivable (BR), if it is selected for BR it can not be applied to receipt</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_BR_RESERVED');



debug('begin add_signature: AR_LB_CC_INVALID_VALUE');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '12999',
      p_sig_id                 => 'AR_LB_CC_INVALID_VALUE',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
,      CREATION_DATE
,      CREATED_BY
,      LAST_UPDATE_LOGIN
...
,      SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_CC_INVALID_VALUE'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'The Exchange Rate Is Not Consistent With The Receipt And/Or Transaction Amount Specified',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The exchange rate is not consistent with the receipt and/or transaction amount specified.',
      p_solution               => '<ul><li>Please verify exchange rate of transaction/receipt</li>  
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_CC_INVALID_VALUE');



debug('begin add_signature: AR_LB_CLASS_BAD');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
,      SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_CLASS_BAD'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Receipt May Not Be Applied To This Invoice Type',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Receipt may not be applied to this invoice type. ',
      p_solution               => '<ul><li>Please validate invoice transaction type, it must be one of the following: invoice, debit memo, credit memo, deposit, or chargeback</li> 
<li>For more information, read: [1371529/KB507817]</li> </ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_CLASS_BAD');



debug('begin add_signature: AR_LB_CURRENCY_BAD');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
,      SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_CURRENCY_BAD'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Invoice Currency Code Does Not Match The Invoice Currency Code In System',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The invoice currency code in your lockbox data does not match the invoice currency code in our system.',
      p_solution               => '<ul><li>Please verify the currency code in the datafile, it should be match with invoice''s currency code</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_CURRENCY_BAD');



debug('begin add_signature: AR_LB_CURRENCY_DISABLED');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '13004',
      p_sig_id                 => 'AR_LB_CURRENCY_DISABLED',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
,      CREATION_DATE
,      CREATED_BY
,      LAST_UPDATE_LOGIN
...
,      SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_CURRENCY_DISABLED'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Currency Is Not Available For Use',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Currency is not available for use.',
      p_solution               => '<ul><li>Please verify the currency code and make sure the effective dates are correct</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_CURRENCY_DISABLED');



debug('begin add_signature: AR_LB_CURR_CONFLICT');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
,      SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_CURR_CONFLICT'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Receipts Currency Must Match Invoices Currency',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The receipt currency must match the currency of the invoice.',
      p_solution               => '<ul><li>Please verify Invoice and Receipt currencies match</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_CURR_CONFLICT');



debug('begin add_signature: AR_LB_CUSTOMER_CONFLICT');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '13018',
      p_sig_id                 => 'AR_LB_CUSTOMER_CONFLICT',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
, CREATION_DATE
, CREATED_BY
, LAST_UPDATE_LOGIN
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_CUSTOMER_CONFLICT'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'MICR And Customer Number Do Not Refer To The Same Customer',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'MICR and customer number do not refer to the same customer.',
      p_solution               => '<ul><li>MICR and customer number should refer the same customer number</li> 
<li>For more information, read: [1616063/KB420272] and [1637568/KB375426]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_CUSTOMER_CONFLICT');



debug('begin add_signature: AR_LB_RCT_CUSTOMER');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '7536',
      p_sig_id                 => 'AR_LB_RCT_CUSTOMER',
      p_sig_sql                => 'Select CUST_ACCOUNT_ID, PARTY_ID, ACCOUNT_NUMBER, ACCOUNT_NAME, STATUS, CUSTOMER_TYPE, ACCOUNT_ESTABLISHED_DATE, ACCOUNT_TERMINATION_DATE, CREATION_DATE, LAST_UPDATE_DATE 
From hz_cust_accounts
Where account_number =  ''##$$CUSTNUMBER$$##''',
      p_title                  => 'Customer Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Provided Customer does not exist in Receivables.',
      p_solution               => 'Please use Maintain Transmission Data window and correct the Customer Number for the receipt. ',
      p_success_msg            => 'Displaying Customer Account data from HZ_CUST_ACCOUNTS.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_RCT_CUSTOMER');



debug('begin add_signature: AR_LB_RCT_CUST_PARTY');
  ...
  add_signature(
      p_sig_repo_id            => '7540',
      p_sig_id                 => 'AR_LB_RCT_CUST_PARTY',
      p_sig_sql                => 'Select PARTY_ID, PARTY_NUMBER, PARTY_NAME, PARTY_TYPE, STATUS, CREATION_DATE, LAST_UPDATE_DATE, COUNTRY, ADDRESS1, ADDRESS2, ADDRESS3, ADDRESS4, CITY, POSTAL_CODE, STATE, PROVINCE, COUNTY 
From hz_parties
Where party_id = (Select party_id
      ...
      p_problem_descr          => 'Provided Customer does not exist in Receivables.',
      p_solution               => 'Please use Maintain Transmission Data window and correct the Customer Number for the receipt. ',
      p_success_msg            => 'Displaying Party data from HZ_PARTIES.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_RCT_CUST_PARTY');



debug('begin add_signature: AR_LB_CUST_IDENTIFICATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7775',
      p_sig_id                 => 'AR_LB_CUST_IDENTIFICATION',
      p_sig_sql                => 'Select '' '' "Customer Identification"
From dual',
      p_title                  => 'Customer Identification Using Customer#',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Customer Account on the Receipt in the Interface Table.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      ...
      p_limit_rows             => nvl('N','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('AR_LB_RCT_CUSTOMER','AR_LB_RCT_CUST_PARTY'),
      p_include_in_dx_summary  => nvl('Y','N'),
      p_version                => '14'
      );
   l_info.delete;
debug('end add_signature: AR_LB_CUST_IDENTIFICATION');



debug('begin add_signature: AR_LB_CUST_NUM_CONFLICT');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '13019',
      p_sig_id                 => 'AR_LB_CUST_NUM_CONFLICT',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
, CREATION_DATE
, CREATED_BY
, LAST_UPDATE_LOGIN
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_CUST_NUM_CONFLICT'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Receipt Has More Than One Customer Number',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Receipt has more than one customer number.',
      p_solution               => '<ul><li>Receipt has more than one customer, please validate the data and pass only one customer to the receipt</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_CUST_NUM_CONFLICT');



debug('begin add_signature: AR_LB_DEP_DATE_GT_GL_DATE');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '13095',
      p_sig_id                 => 'AR_LB_DEP_DATE_GT_GL_DATE',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
, CREATION_DATE
, CREATED_BY
, LAST_UPDATE_LOGIN
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_DEP_DATE_GT_GL_DATE'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Deposit Date Cannot Be Later Than GL Date',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Deposit Date cannot be later than GL Date.',
      p_solution               => '<ul><li>Receipt deposit date cannot be later than GL date</li>
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_DEP_DATE_GT_GL_DATE');



debug('begin add_signature: AR_LB_DUP_BANK_ACCT_NAME');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '13096',
      p_sig_id                 => 'AR_LB_DUP_BANK_ACCT_NAME',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
, CREATION_DATE
, CREATED_BY
, LAST_UPDATE_LOGIN
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_DUP_BANK_ACCT_NAME'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'MICR Number Already Exists As Bank Account Name',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'MICR number already exists as bank account name.',
      p_solution               => '<ul><li>Receipt MICR number should be unique to bank account, please validate MICR and Bank Account of the customer</li>
<li>For more information, read: [1371529/KB507817] and [199014/KB767995]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_DUP_BANK_ACCT_NAME');



debug('begin add_signature: AR_LB_DUP_BATCH_NAME');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_DUP_BATCH_NAME'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Duplicate Lockbox Batch Name',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Duplicate lockbox batch name.',
      p_solution               => '<ul><li>Datafile contains duplicate Lockbox batch name, please validate the datafile and pass a unique Lockbox batch name</li>
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_DUP_BATCH_NAME');



debug('begin add_signature: AR_LB_DUP_INV');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_DUP_INV'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Duplicate Invoice Number For Customer',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Duplicate invoice number for customer.',
      p_solution               => '<ul><li>Datafile contains duplicate Invoice Number for customer, please validate the datafile and pass a unique invoice number for customer</li>
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_DUP_INV');



debug('begin add_signature: AR_LB_DUP_ITEM_NUM');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_DUP_ITEM_NUM'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Duplicate Item Number For Receipt',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Duplicate Item Number for receipt.',
      p_solution               => '<ul><li>Datafile contains duplicate Item Number for receipt, please validate the datafile and pass a unique item number for receipt</li>
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_DUP_ITEM_NUM');



debug('begin add_signature: AR_LB_DUP_LB_NUM');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_DUP_LB_NUM'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Duplicate Lockbox Number',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Duplicate lockbox number.',
      p_solution               => '<ul><li>Datafile contains duplicate Lockbox Number, please validate the datafile and pass a unique Lockbox number</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_DUP_LB_NUM');



debug('begin add_signature: AR_LB_DUP_OVRFLW_SEQ');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_DUP_OVRFLW_SEQ'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Duplicate Overflow Sequence For This Receipt',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Duplicate overflow sequence for this receipt.',
      p_solution               => '<ul><li>Overflow sequence should be unique, please validate the overflow sequence and pass a unique value for receipt</li>
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_DUP_OVRFLW_SEQ');



debug('begin add_signature: AR_LB_DUP_PMT');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_DUP_PMT'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Receipt Number Already Exists For This Customer And Amount',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Receipt number already exists for this customer and amount.',
      p_solution               => '<ul><li>Datafile contains duplicate Receipt/Check number, please validate the datafile and pass a unique Receipt/Check number</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_DUP_PMT');



debug('begin add_signature: AR_LB_GL_PERIOD_CLOSED');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '13151',
      p_sig_id                 => 'AR_LB_GL_PERIOD_CLOSED',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
, CREATION_DATE
, CREATED_BY
, LAST_UPDATE_LOGIN
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_GL_PERIOD_CLOSED'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'GL Date Is Not In An Open Or Future Period',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'GL date is not in an open or future period.',
      p_solution               => '<ul><li>Please validate that the GL_DATE passed in datafile and ensure that date is in an open period in AR and GL</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_GL_PERIOD_CLOSED');



debug('begin add_signature: AR_LB_INACTIVE_LB_NUM');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '13152',
      p_sig_id                 => 'AR_LB_INACTIVE_LB_NUM',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
, CREATION_DATE
, CREATED_BY
, LAST_UPDATE_LOGIN
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_INACTIVE_LB_NUM'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Lockbox Is Either Not Defined Or Currently Has a Status of Inactive',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Lockbox is either not defined or currently has a status of Inactive.',
      p_solution               => '<ul><li>Please verify the Lockbox is defined or active</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_INACTIVE_LB_NUM');



debug('begin add_signature: AR_LB_INVALID_BATCH');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_INVALID_BATCH'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Batch Has Invalid Receipts',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Batch has invalid receipts.',
      p_solution               => '<ul><li>Please verify the receipts in datafile batch, the batch should contain valid receipts</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_INVALID_BATCH');



debug('begin add_signature: AR_LB_INVALID_BATCH_NAME');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '13154',
      p_sig_id                 => 'AR_LB_INVALID_BATCH_NAME',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
, CREATION_DATE
, CREATED_BY
, LAST_UPDATE_LOGIN
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_INVALID_BATCH_NAME'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Batch With This Name Does Not Exist In This Transmission',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Batch with this name does not exist in this transmission.',
      p_solution               => '<ul><li>Please verify the batch in datafile, Batch should exists in the transmission</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_INVALID_BATCH_NAME');



debug('begin add_signature: AR_LB_INVALID_CURRENCY');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '13155',
      p_sig_id                 => 'AR_LB_INVALID_CURRENCY',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
, CREATION_DATE
, CREATED_BY
, LAST_UPDATE_LOGIN
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_INVALID_CURRENCY'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Currency Must Match The Bank Account Currency',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Currency must match the bank account''s currency.',
      p_solution               => '<ul><li>Please verify the currency in datafile, it should match the bank account''s currency</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_INVALID_CURRENCY');



debug('begin add_signature: AR_LB_INVALID_INSTALLMENT');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '13156',
      p_sig_id                 => 'AR_LB_INVALID_INSTALLMENT',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
, CREATION_DATE
, CREATED_BY
, LAST_UPDATE_LOGIN
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_INVALID_INSTALLMENT'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Installment Number Is Invalid',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Installment number is invalid.',
      p_solution               => '<ul><li>Please verify the installment in datafile and pass a valid installment value</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_INVALID_INSTALLMENT');



debug('begin add_signature: AR_LB_INVALID_ITEM_NUM');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '13157',
      p_sig_id                 => 'AR_LB_INVALID_ITEM_NUM',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
, CREATION_DATE
, CREATED_BY
, LAST_UPDATE_LOGIN
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_INVALID_ITEM_NUM'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Receipt With This Item Number Does Not Exist',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Receipt with this Item Number does not exist.',
      p_solution               => '<ul><li>Please verify the Item Number in datafile is being passed to the receipt. Please pass the exists Item Number to the receipt number</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_INVALID_ITEM_NUM');



debug('begin add_signature: AR_LB_INVALID_LB_NUM');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_INVALID_LB_NUM'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Lockbox With This Number Does Not Exist In This Transmission',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Lockbox with this number does not exist in this transmission.',
      p_solution               => '<ul><li>Please verify the Lockbox Number in datafile is being passed. Please pass the valid Lockbox Number to the transmission</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_INVALID_LB_NUM');



debug('begin add_signature: AR_LB_INVALID_LOCATION');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '13159',
      p_sig_id                 => 'AR_LB_INVALID_LOCATION',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
, CREATION_DATE
, CREATED_BY
, LAST_UPDATE_LOGIN
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_INVALID_LOCATION'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Receipt Has Invalid Billing Location',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Receipt has invalid billing location.',
      p_solution               => '<ul><li>Please verify the billing location of the receipt. Please pass the valid Billing Location to the receipt which is active/exists to the customer</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_INVALID_LOCATION');



debug('begin add_signature: AR_LB_INVALID_MATCH');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_INVALID_MATCH'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Invalid Matching Number',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invalid matching number.',
      p_solution               => '<ul><li>Please verify the matching number in datafile and pass a valid matching number</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_INVALID_MATCH');



debug('begin add_signature: AR_LB_INVALID_MICR_NUM');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '13161',
      p_sig_id                 => 'AR_LB_INVALID_MICR_NUM',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
, CREATION_DATE
, CREATED_BY
, LAST_UPDATE_LOGIN
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_INVALID_MICR_NUM'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'MICR Number Passed Is Invalid',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'MICR number passed is invalid.',
      p_solution               => '<ul><li>Please verify the MICR number in datafile and pass a valid MICR number</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_INVALID_MICR_NUM');



debug('begin add_signature: AR_LB_INVALID_OVRFLW');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_INVALID_OVRFLW'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Receipt Has Invalid Overflow Records',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Receipt has invalid overflow records.',
      p_solution               => '<ul><li>Please verify the overflow records in datafile and pass the valid overflow records</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_INVALID_OVRFLW');



debug('begin add_signature: AR_LB_INVALID_RECEIPT');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '13163',
      p_sig_id                 => 'AR_LB_INVALID_RECEIPT',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
, CREATION_DATE
, CREATED_BY
, LAST_UPDATE_LOGIN
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_INVALID_RECEIPT'') <> 0  AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Receipt Has Invalid Applications',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Receipt has invalid applications.',
      p_solution               => '<ul><li>Please verify the invoice numbers in datafile being passed, the receipt needs valid applications</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_INVALID_RECEIPT');



debug('begin add_signature: AR_LB_INVALID_RECEIPT_METHOD');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '13164',
      p_sig_id                 => 'AR_LB_INVALID_RECEIPT_METHOD',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
, CREATION_DATE
, CREATED_BY
, LAST_UPDATE_LOGIN
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_INVALID_RECEIPT_METHOD'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Receipt Method Not Valid For This Bank Account',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Receipt method not valid for this bank account.',
      p_solution               => '<ul><li>Please verify the receipt method for the bank account, it should be valid for the bank account</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_INVALID_RECEIPT_METHOD');



debug('begin add_signature: AR_LB_INVALID_REC_TYPE');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '13165',
      p_sig_id                 => 'AR_LB_INVALID_REC_TYPE',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
, CREATION_DATE
, CREATED_BY
, LAST_UPDATE_LOGIN
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_INVALID_REC_TYPE'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Record Identifier Is Not In The Requested Transmission Format',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Record identifier is not in the requested transmission format.',
      p_solution               => '<ul><li>Please verify the record identifier in datafile, this identifier needs to be in the lockbox transmission format</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_INVALID_REC_TYPE');



debug('begin add_signature: AR_LB_INV_BAD');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_INV_BAD'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'The Invoice Does Not Belong To The Paying Customer Or Any Related Customers',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The invoice does not belong to the paying customer or any related customers.',
      p_solution               => '<ul><li>Please verify the invoice and customer details, they should match unless you selected "Pay Unrelated Customer" check box while submitting Lockbox</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_INV_BAD');



debug('begin add_signature: AR_LB_LB_AMT_BAD');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_LB_AMT_BAD'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Lockbox Amount Does Not Equal Sum Of Receipt Amounts',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Lockbox amount does not equal sum of receipt amounts.',
      p_solution               => '<ul><li>Please verify the Lockbox and Receipt amounts, the amounts should match</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_LB_AMT_BAD');



debug('begin add_signature: AR_LB_LB_COUNT_BAD');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_LB_COUNT_BAD'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Lockbox Record Count Does Not Equal Number Of Receipts',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Lockbox record count does not equal number of receipts.',
      p_solution               => '<ul><li>Please verify the Lockbox record count and number of receipts, the lockbox record count should be equal to number of receipts</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_LB_COUNT_BAD');



debug('begin add_signature: AR_LB_MICR_CONFLICT');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_MICR_CONFLICT'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Receipt Has More Than One MICR Number',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Receipt has more than one MICR number.',
      p_solution               => '<ul><li>Please verify the MICR number for receipt, only one MICR number should exists for receipt</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_MICR_CONFLICT');



debug('begin add_signature: AR_LB_MICR_CUST_CONFLICT');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '13179',
      p_sig_id                 => 'AR_LB_MICR_CUST_CONFLICT',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
, CREATION_DATE
, CREATED_BY
, LAST_UPDATE_LOGIN
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_MICR_CUST_CONFLICT'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'MICR Assignment To The Entered Customer Number Is Not Valid On The Receipt Date, Deposit Date Or Creation Date',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'MICR Assignment to the entered customer number is not valid on the receipt date, deposit date or creation date.',
      p_solution               => '<ul><li>Please verify the MICR number entered to the customer, the MICR number should be valid for the customer number for the respective receipt date, deposit date or creation date</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_MICR_CUST_CONFLICT');



debug('begin add_signature: AR_LB_NAT_VIO_CM');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_NAT_VIO_CM'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'This Credit Memo Violates The Natural Application Rule Of Its Transaction Type',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This credit memo violates the natural application rule of its transaction type.',
      p_solution               => '<ul><li>Credit Memo transaction type should not violate the natural application, please verify the Credit Memo transaction type setup</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_NAT_VIO_CM');



debug('begin add_signature: AR_LB_NAT_VIO_INV');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_NAT_VIO_INV'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'This Transaction Violates The Natural Application Rule Of Its Transaction Type',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This transaction violates the natural application rule of its transaction type.',
      p_solution               => '<ul><li>Invoice transaction type should not violate the natural application, please verify the invoice transaction type setup</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_NAT_VIO_INV');



debug('begin add_signature: AR_LB_NEGATIVE_APPLICATION');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '13182',
      p_sig_id                 => 'AR_LB_NEGATIVE_APPLICATION',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
, CREATION_DATE
, CREATED_BY
, LAST_UPDATE_LOGIN
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_NEGATIVE_APPLICATION'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'The Invoice Application Amount Cannot Be Less Than Zero',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The invoice application amount cannot be less than zero.',
      p_solution               => '<ul><li>Please verify the invoice application amount to the receipt, it should not be less than zero</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_NEGATIVE_APPLICATION');



debug('begin add_signature: AR_LB_NEGATIVE_RECEIPT');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_NAME_ALT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13183',
      p_sig_id                 => 'AR_LB_NEGATIVE_RECEIPT',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
, CREATION_DATE
, CREATED_BY
, LAST_UPDATE_LOGIN
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_NEGATIVE_RECEIPT'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Remittance Amount Cannot Be Less Than Zero',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Remittance amount cannot be less than zero.',
      p_solution               => '<ul><li>Remittance amount should be greater than zero. Please verify the datafile and correct the Remittance Amount</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_NEGATIVE_RECEIPT');



debug('begin add_signature: AR_LB_NO_DEPOSIT_DATE');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '13184',
      p_sig_id                 => 'AR_LB_NO_DEPOSIT_DATE',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
, CREATION_DATE
, CREATED_BY
, LAST_UPDATE_LOGIN
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_NO_DEPOSIT_DATE'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'You Have Specified Your GL Date Source To Be The Deposit Date, However No Deposit Date Has Been Provided',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'You have specified your GL Date Source to be the Deposit Date, however no Deposit Date has been provided.',
      p_solution               => '<ul><li>Please verify the Lockbox setup and Datafile. Since you selected GL Date Source as Deposit Date, you need to pass a Deposit Date in datafile</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_NO_DEPOSIT_DATE');



debug('begin add_signature: AR_LB_NO_EXCHANGE_RATE');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '13185',
      p_sig_id                 => 'AR_LB_NO_EXCHANGE_RATE',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
, CREATION_DATE
, CREATED_BY
, LAST_UPDATE_LOGIN
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_NO_EXCHANGE_RATE'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Exchange Rate Is Unavailable',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Exchange rate is unavailable.',
      p_solution               => '<ul><li>Please verify the exchange rate in General Ledger and define the exchange rate accordingly</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_NO_EXCHANGE_RATE');



debug('begin add_signature: AR_LB_NO_FIRST_OVRFLW');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '13209',
      p_sig_id                 => 'AR_LB_NO_FIRST_OVRFLW',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
, CREATION_DATE
, CREATED_BY
, LAST_UPDATE_LOGIN
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_NO_FIRST_OVRFLW'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Overflow Records For Each Receipt Must Begin With The Same Sequence Number',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Overflow records for each receipt must begin with the same sequence number.',
      p_solution               => '<ul><li>Please validate the sequence number for each receipt which needs to begin with same sequence number</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_NO_FIRST_OVRFLW');



debug('begin add_signature: AR_LB_NO_INV_NUMBER');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_NO_INV_NUMBER'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Invoice Number Is Missing For Applied Amount',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invoice number is missing for applied amount.',
      p_solution               => '<ul><li>Invoice number is missing for applied amount</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_NO_INV_NUMBER');



debug('begin add_signature: AR_LB_NO_ITEM_NUM');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_NO_ITEM_NUM'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Receipt Is Missing Item Number',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Receipt is missing item number.',
      p_solution               => '<ul><li>Receipt requires an item number</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_NO_ITEM_NUM');



debug('begin add_signature: AR_LB_NO_LB_NUM');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_NO_LB_NUM'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Lockbox Number Is Missing',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Lockbox number is missing.',
      p_solution               => '<ul><li>Lockbox number is missing in the datafile, please verify the datafile and pass the Lockbox Number</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_NO_LB_NUM');



debug('begin add_signature: AR_LB_NO_NEXT_OVRFLW');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_NO_NEXT_OVRFLW'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Overflow Record With Next Sequence Is Missing',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Overflow record with next sequence is missing.',
      p_solution               => '<ul><li>Overflow record should exists the next sequence. Please verify the datafile and please next sequence number</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_NO_NEXT_OVRFLW');



debug('begin add_signature: AR_LB_NO_ORIGIN');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_NO_ORIGIN'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Bank Origination Number Is Missing From Transmission',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Bank origination number is missing from transmission.',
      p_solution               => '<ul><li>Bank origination number should exists in transmission</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_NO_ORIGIN');



debug('begin add_signature: AR_LB_NO_PRIMARY_LOCATION');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '13215',
      p_sig_id                 => 'AR_LB_NO_PRIMARY_LOCATION',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
, CREATION_DATE
, CREATED_BY
, LAST_UPDATE_LOGIN
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_NO_PRIMARY_LOCATION'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Billing Location Is Required And The Customer Has Not Been Assigned A Primary Bill-To Site',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Billing location is required and the customer has not been assigned a primary Bill-To site.',
      p_solution               => '<ul><li>Bill location is missing. Enter the correct bill-to location or if you have ''Require billing location'' set to Yes in System Options, make it NULL so the process defaults it to primary bill-to</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_NO_PRIMARY_LOCATION');



debug('begin add_signature: AR_LB_NO_RECEIPT_DATE');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '13216',
      p_sig_id                 => 'AR_LB_NO_RECEIPT_DATE',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
, CREATION_DATE
, CREATED_BY
, LAST_UPDATE_LOGIN
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_NO_RECEIPT_DATE'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'AutoLockbox Cannot Derive The Receipt Date For This Transmission Because The Deposit Date Is Missing Or Invalid In The Data File',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'AutoLockbox cannot derive the Receipt Date for this transmission because the Deposit Date is missing or invalid in the data file.',
      p_solution               => '<ul><li>Lockbox cannot derive the receipt date. Please validate the datafile deposit date, it''s either missing or invalid</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_NO_RECEIPT_DATE');



debug('begin add_signature: AR_LB_NO_RECEIPT_NUM');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_NO_RECEIPT_NUM'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Receipt Number Is Missing',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Receipt number is missing.',
      p_solution               => '<ul><li>Receipt number needs to be provided in datafile</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_NO_RECEIPT_NUM');



debug('begin add_signature: AR_LB_NO_REMIT_AMT');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_NO_REMIT_AMT'') <> 0
AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Receipt Is Missing Remittance Amount',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Receipt is missing remittance amount.',
      p_solution               => '<ul><li>Remittance amount should exist for the receipt. Please validate the datafile and pass the remittance amount to the receipt</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_NO_REMIT_AMT');



debug('begin add_signature: AR_LB_NO_REQUESTED_GL_DATE');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '13219',
      p_sig_id                 => 'AR_LB_NO_REQUESTED_GL_DATE',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
, CREATION_DATE
, CREATED_BY
, LAST_UPDATE_LOGIN
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_NO_REQUESTED_GL_DATE'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'GL Date Must Be Entered When The GL Date Source Has Been Defined As A Constant Date',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'GL date must be entered when the GL Date Source has been defined as a Constant Date.',
      p_solution               => '<ul><li>GL Date must be entered in the datafile when the GL Date source has been defined as constant date in Lockbox setup, please validate the datafile and GL Date provided</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_NO_REQUESTED_GL_DATE');



debug('begin add_signature: AR_LB_ORIGIN_CONFLICT');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '13220',
      p_sig_id                 => 'AR_LB_ORIGIN_CONFLICT',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
, CREATION_DATE
, CREATED_BY
, LAST_UPDATE_LOGIN
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_ORIGIN_CONFLICT'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Transmission Has More Than One Bank Origination Number',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transmission has more than one bank origination number.',
      p_solution               => '<ul><li>Bank origination number should be unique for transmission</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_ORIGIN_CONFLICT');



debug('begin add_signature: AR_LB_PENDING_AUTO_RECEIPT');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '13221',
      p_sig_id                 => 'AR_LB_PENDING_AUTO_RECEIPT',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
, CREATION_DATE
, CREATED_BY
, LAST_UPDATE_LOGIN
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_PENDING_AUTO_RECEIPT'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Invoice Has Been Selected For Automatic Receipt',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invoice has been selected for automatic receipt.',
      p_solution               => '<ul><li>Invoice has been already selected in automatic receipt, please validate the datafile and pass the correct invoice</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_PENDING_AUTO_RECEIPT');



debug('begin add_signature: AR_LB_RCPT_DATE_GT_GL_DATE');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '13222',
      p_sig_id                 => 'AR_LB_RCPT_DATE_GT_GL_DATE',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
, CREATION_DATE
, CREATED_BY
, LAST_UPDATE_LOGIN
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_RCPT_DATE_GT_GL_DATE'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Receipt Date Cannot Be Later Than GL Date',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Receipt Date cannot be later than GL Date.',
      p_solution               => '<ul><li>Receipt date in the datafile is later than the GL date. Ensure that the receipt date is the same or less than the GL date</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_RCPT_DATE_GT_GL_DATE');



debug('begin add_signature: AR_LB_REMIT_EXCEEDED');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_REMIT_EXCEEDED'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Sum Of The Applied Amounts Is Greater Than Remittance Amount',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Sum of the applied amounts is greater than remittance amount.',
      p_solution               => '<ul><li>Receipt remittance amount should be equal to sum of amount applied, please validate total Invoice''s amount and ensure it is equal to the sum of remittance amount</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_REMIT_EXCEEDED');



debug('begin add_signature: AR_LB_TRANS_AMT_BAD');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_TRANS_AMT_BAD'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Transmission Amount Does Not Equal Sum Of Receipt Amounts',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transmission amount does not equal sum of receipt amounts.',
      p_solution               => '<ul><li>Transmission amount should be equal to sum of receipt amounts, Validate that the total Transmission amount is equal to sum of receipt amounts</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_TRANS_AMT_BAD');



debug('begin add_signature: AR_LB_TRANS_COUNT_BAD');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '13225',
      p_sig_id                 => 'AR_LB_TRANS_COUNT_BAD',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
, CREATION_DATE
, CREATED_BY
, LAST_UPDATE_LOGIN
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_TRANS_COUNT_BAD'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Transmission Record Count Does Not Equal Number Of Records',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transmission record count does not equal number of records.',
      p_solution               => '<ul><li>Transmission record count should be equal to number of records. Please validate transmission record count and should be equal to number of records</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_TRANS_COUNT_BAD');



debug('begin add_signature: AR_LB_USSGL_TC_INVALID');
   l_info('##MASK##ACCOUNT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_BRANCH_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_BANK_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '13226',
      p_sig_id                 => 'AR_LB_USSGL_TC_INVALID',
      p_sig_sql                => 'SELECT TRANSMISSION_RECORD_ID
, CREATION_DATE
, CREATED_BY
, LAST_UPDATE_LOGIN
...
, SC_MATCHING_STATUS
FROM AR_PAYMENTS_INTERFACE_ALL
WHERE INSTR(STATUS,''AR_PLB_USSGL_TC_INVALID'') <> 0 AND TRANSMISSION_ID = ##$$TRANSID$$##',
      p_title                  => 'Invalid Transaction Code',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invalid Transaction Code.',
      p_solution               => '<ul><li>Transaction code should be valid. Please validate the datafile</li> 
<li>For more information, read: [1371529/KB507817]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_USSGL_TC_INVALID');



debug('begin add_signature: EBS_FIN_AR_AR_LOCKBOX_ANLZ_NULL_TRANS_RECORD_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25905',
      p_sig_id                 => 'EBS_FIN_AR_AR_LOCKBOX_ANLZ_NULL_TRANS_RECORD_ID',
      p_sig_sql                => 'SELECT  ''Yes'' "Are there records with NULL TRANSMISSION_RECORD_ID in AR_PAYMENT_INTERFACE_ALL table?"
FROM     AR_PAYMENTS_INTERFACE_ALL
WHERE  TRANSMISSION_RECORD_ID is NULL
AND       ORG_ID = ##$$ORGID$$##
AND        ROWNUM < 2',
      p_title                  => 'NULL Transmission Record ID in Interface Table',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are records with NULL TRANSMISSION_RECORD_ID  in AR_PAYMENTS_INTERFACE_ALL table ',
      p_solution               => '<ul><li>The analyzer has detected that there are some records with TRANSMISSION_RECORD_ID  NULL in AR_PAYMENTS_INTERFACE_ALL table  . This could cause issues while saving changes in Lockbox Maintain Transmission Data Form. Please review Unable To Save Edits Done In Lockbox Maintain Transmission Data Form [1554432/KB276823]</li>
<li>Please log a Service Request if you need assistance </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_AR_LOCKBOX_ANLZ_NULL_TRANS_RECORD_ID');



debug('begin add_signature: EBS_FIN_AR_AR_LOCKBOX_ANLZ_INV_DIFF_CUSTOMERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31822',
      p_sig_id                 => 'EBS_FIN_AR_AR_LOCKBOX_ANLZ_INV_DIFF_CUSTOMERS',
      p_sig_sql                => 'SELECT item_number, COUNT(*) "Num of Customers From Invoices"
FROM (
      SELECT DISTINCT i.item_number, t.sold_to_customer_id
      FROM   ar_payments_interface_all i,
             ra_customer_trx_all t
      WHERE  i.transmission_id IN (SELECT transmission_id FROM ar_transmissions_all WHERE transmission_name =''##$$TNAME$$##'')
      AND    (
              t.trx_number = i.invoice1 OR
              t.trx_number = i.invoice2 OR
              t.trx_number = i.invoice3 OR
              t.trx_number = i.invoice4 OR
              t.trx_number = i.invoice1 OR
              t.trx_number = i.invoice5 OR
              t.trx_number = i.invoice6 OR
              t.trx_number = i.invoice7 OR
              t.trx_number = i.invoice8
             )
     )
...
ORDER BY item_number
   ',
      p_title                  => 'Receipt Applied to Invoices from Different Customers',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Receipt Applied to Invoices from Different Customers',
      p_solution               => '<ul><li>Invoices must belong to same customer to be able to identify the customer for the receipt, if not passing other ways to identify it. See  [1366298/KB695542] and [1075485/FAQ4011]</li>
<li>Please log a Service Request and upload this analyzer output.</li>
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_AR_LOCKBOX_ANLZ_INV_DIFF_CUSTOMERS');



debug('begin add_signature: EBS_FIN_AR_GEN_OLD_TABLE_STATS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31877',
      p_sig_id                 => 'EBS_FIN_AR_GEN_OLD_TABLE_STATS',
      p_sig_sql                => 'SELECT owner, table_name, last_analyzed
FROM  dba_tables
WHERE last_analyzed < SYSTIMESTAMP - INTERVAL ''14'' DAY
AND     owner IN (''AR'', ''ZX'', ''XLA'')
ORDER BY owner, table_name
   ',
      p_title                  => 'Tables with Statistics Older than Two Weeks',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Tables with Statistics Older than Two Weeks',
      p_solution               => '<ul><li>The analyzer found these tables with statistics older than two weeks. Please see  [1586374/KB859100] for the Best Practices for Gathering Statistics with Oracle E-Business Suite</li>
</ul>',
      p_success_msg            => ' ',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_GEN_OLD_TABLE_STATS');



debug('begin add_signature: EBS_FIN_AR_GEN_OLD_INDEX_STATS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31879',
      p_sig_id                 => 'EBS_FIN_AR_GEN_OLD_INDEX_STATS',
      p_sig_sql                => 'SELECT table_owner "Table Owner", table_name "Table Name", owner "Index Owner", index_name "Index Name", last_analyzed "Last Analyzed"
FROM   dba_indexes
WHERE  last_analyzed < SYSTIMESTAMP - INTERVAL ''14'' DAY
AND      table_owner IN (''AR'', ''ZX'', ''XLA'')
ORDER BY table_owner, table_name, owner, index_name',
      p_title                  => 'Indexes with Statistics Older than Two Weeks',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Indexes with Statistics Older than Two Weeks
',
      p_solution               => '<ul><li>The analyzer found these indexes with statistics older than two weeks. Please see [1586374/KB859100] for the Best Practices for Gathering Statistics with Oracle E-Business Suite</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_GEN_OLD_INDEX_STATS');



debug('begin add_signature: EBS_FIN_AR_GEN_TABLE_STATS_WITH_DBMS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31880',
      p_sig_id                 => 'EBS_FIN_AR_GEN_TABLE_STATS_WITH_DBMS',
      p_sig_sql                => 'SELECT  owner, table_name, last_analyzed
FROM   dba_tables d
...
AND      NOT EXISTS (
  SELECT 1
  FROM   fnd_stats_hist f
  WHERE f.schema_name = d.owner
  AND     f.object_name = d.table_name
  AND     f.last_gather_date >= d.last_analyzed
)',
      p_title                  => 'Statistics on Tables Gathered with DBMS_STATS or ANALYZE',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Statistics on these tables were gathered with DBMS_STATS or ANALYZE command, instead of FND_STATS',
      p_solution               => '<ul><li>The analyzer found statistics on tables that were gathered with DBMS_STATS or ANALYZE command, instead of FND_STATS. Please see [1586374/KB859100] for the Best Practices for Gathering Statistics with Oracle E-Business Suite</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_GEN_TABLE_STATS_WITH_DBMS');



debug('begin add_signature: EBS_FIN_AR_GEN_GTT_TABLES_WITH_STATS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31890',
      p_sig_id                 => 'EBS_FIN_AR_GEN_GTT_TABLES_WITH_STATS',
      p_sig_sql                => 'SELECT  owner, table_name, last_analyzed
FROM   dba_tables
WHERE  owner in (''AR'', ''XLA'', ''ZX'')
AND      temporary = ''Y''
AND      last_analyzed IS NOT NULL
ORDER BY owner, table_name',
      p_title                  => 'Global Temporary Tables with gathered Statistics',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are Global Temporary Tables with gathered statistics
',
      p_solution               => '<ul><li>The analyzer found Global Temporary Tables with Gathered Statistics. Please see [1586374/KB859100] for the Best Practices for Gathering Statistics with Oracle E-Business Suite. If deleting stats from these tables is not working, please see [2312836/KB111839]</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_GEN_GTT_TABLES_WITH_STATS');
...
debug('begin add_signature: AR_GEN_DUP_GL_CODE_COMBI');
 ...
 ORDER BY cck.concatenated_segments,
      ...
      p_solution               => '<ul><li>The analyzer has identified issue described in [258628/KB780485]</li>
<li>Please log a Service Request and upload this analyzer output.</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
...
debug('begin add_signature: AR_GEN_OU_CHECK_ALLREPORTS');
 ...
 and multi_org_category is null',
      ...
      p_solution               => 'Please review [884257/KB625811] for steps to resolve issue.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
...
debug('begin add_signature: EBS_FIN_AR_AR_LOCKBOX_ANLZ_AR_GL_PERIOD_STATUSES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '32014',
      p_sig_id                 => 'EBS_FIN_AR_AR_LOCKBOX_ANLZ_AR_GL_PERIOD_STATUSES',
...
(SELECT   distinct REQUESTED_GL_DATE gl_date, org_id
 FROM     ar_transmissions_all
 WHERE    transmission_name  = ''##$$TNAME$$##'' ) atg_date
WHERE    atg_date.gl_date between gps.start_date and gps.end_date
AND      gps.application_id in ( 222)
AND      NVL(sys.org_id, -99) = atg_date.org_id 
...
ORDER BY gps.set_of_books_id, gps.period_name asc',
      ...
      p_solution               => 'Period status information for AR periods.',
      p_success_msg            => 'Period status information for AR periods.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_AR_LOCKBOX_ANLZ_AR_GL_PERIOD_STATUSES');
...
ORDER BY 1, 2',
      ...
      p_solution               => '<ul><li>The analyzer has identified some discrepancies based on the following document: [3067825/KB721489]</li>
...
debug('begin add_signature: EBS_FIN_AR_GEN_DUP_SYSTEM_PARAMETERS');
   l_info('##MASK##ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##GLOBAL_ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '32525',
      p_sig_id                 => 'EBS_FIN_AR_GEN_DUP_SYSTEM_PARAMETERS',
      p_sig_sql                => 'SELECT a.*
FROM   ar_system_parameters_all a, ar_system_parameters_all b
WHERE  a.org_id = b.org_id
AND    a.rowid <> b.rowid',
      p_title                  => 'Duplicate Rows in AR_SYSTEM_PARAMETERS_ALL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are multiple records for same org_id in table AR_SYSTEM_PARAMETERS_ALL',
      p_solution               => '<ul><li>The analyzer has identified a data corruption in table AR_SYSTEM_PARAMETERS_ALL. This can cause several issues, like the one described in [3109635/KB850731]</li> <li>Please log a Service Request and upload this Analyzer output</li> </ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_GEN_DUP_SYSTEM_PARAMETERS');
...
debug('begin add_signature: EBS_FIN_AR_AR_LOCKBOX_ANLZ_CM_NOTE_2953541_1_122');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29232',
      p_sig_id                 => 'EBS_FIN_AR_AR_LOCKBOX_ANLZ_CM_NOTE_2953541_1_122',
      p_sig_sql                => 'SELECT subdir,
       filename,
       VERSION
  FROM (SELECT a.filename,
        v.VERSION,
        a.subdir,
        ROW_NUMBER () OVER (PARTITION BY a.subdir, a.filename ORDER BY v.version_segment1 DESC,
                v.version_segment2 DESC,
                v.version_segment3 DESC,
                v.version_segment4 DESC,
                v.version_segment5 DESC,
                v.version_segment6 DESC,
                v.version_segment6 DESC,
                v.version_segment7 DESC,
                v.version_segment8 DESC,
                v.version_segment9 DESC,
                v.version_segment10 DESC) num
          FROM apps.ad_file_versions v,
               apps.ad_files a
         WHERE v.file_id = a.file_id
           AND a.filename =''ARATAPPS.pls''
           AND a.subdir = ''patch/115/sql'')
WHERE num = 1
AND substr(VERSION,16) < 9',
      p_title                  => 'Low Version of ARATAPPS.pls - Possible Error While Running Lockbox Process',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Version of ARATAPPS.pls is too low and can cause an error when running Lockbox Process
',
      p_solution               => '<ul><li>The analyzer has identified the problem described in [2953541/KB249668]</li>
<li>Please review the note above and implement the solution to avoid this error while running Lockbox Process in the future</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_AR_LOCKBOX_ANLZ_CM_NOTE_2953541_1_122');



debug('begin add_signature: AR_LB_MICR_ASSIGN');
   l_info('##MASK##ACCOUNT_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PARTY_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7550',
      p_sig_id                 => 'AR_LB_MICR_ASSIGN',
      p_sig_sql                => 'Select  bank_name, bank_number, branch_name, branch_number,account_number, currency_code, assignment_start_date, assignment_end_date, cust_account_id, acct_site_use_id, org_id, a.party_id,  b.party_name, instrument_id, instrument_type 
From iby_fndcpt_payer_assgn_instr_v a, hz_parties b
Where  a.party_id = b.party_id
And  bank_acct_num_hash1 = iby_security_pkg.get_hash(''##$$BNKACCTNUM$$##'', ''F'')
And  bank_acct_num_hash2 = iby_security_pkg.get_hash(''##$$BNKACCTNUM$$##'', ''T'')
And  branch_number = ''##$$ROUTINGNUM$$##''',
      p_title                  => 'Customer Bank Account Assignment',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Provided MICR is not assigned to a customer. Lockbox will identify customer using Matching Number.',
      p_solution               => '',
      p_success_msg            => 'This is data collection of Customer Bank Account Assignment on the Receipt In the Interface Table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_LB_MICR_ASSIGN');



debug('begin add_signature: AR_LB_RCT_MICR');
   l_info('##MASK##BANK_ACCOUNT_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PRIMARY_ACCT_OWNER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7547',
      p_sig_id                 => 'AR_LB_RCT_MICR',
      p_sig_sql                => 'SELECT bank_name, bank_number, bank_branch_name, branch_number, country_code,bank_account_id,bank_account_number, currency_code, 
primary_acct_owner_party_id, primary_acct_owner_name, 
account_classification, start_date, end_date
FROM iby_ext_bank_accounts_v, hz_cust_accounts a
WHERE primary_acct_owner_party_id = a. party_id
AND bank_acct_num_hash1  = iby_security_pkg.get_hash(''##$$BNKACCTNUM$$##'', ''F'') 
AND bank_acct_num_hash2  = iby_security_pkg.get_hash(''##$$BNKACCTNUM$$##'', ''T'')',
      p_title                  => 'Customer Bank Account',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Provided MICR does not exist. ',
      p_solution               => '',
      p_success_msg            => 'This is data collection of Customer Bank Account on the Receipt In the Interface Table.',
   ...
   l_info.delete;
debug('end add_signature: AR_LB_RCT_MICR');



debug('begin add_signature: AR_LB_MICR_IDENTIFICATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7776',
      p_sig_id                 => 'AR_LB_MICR_IDENTIFICATION',
      p_sig_sql                => 'Select '' '' "MICR Identification"
From dual',
      p_title                  => 'Customer Identification Using MICR#',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Customer Bank Account(MICR) on the Receipt in the Interface Table.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      ...
      p_limit_rows             => nvl('N','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('AR_LB_MICR_ASSIGN','AR_LB_RCT_MICR'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '5'
      );
   l_info.delete;
debug('end add_signature: AR_LB_MICR_IDENTIFICATION');
...
BEGIN
  ...
  analyzer_title := 'Receivables Lockbox Analyzer';
...
debug('begin section: LB_INTERFACE_DATA');
start_section('Lockbox Interface Data', 'LB_INTERFACE_DATA');
   set_item_result(run_stored_sig('AR_LB_TRANSMISSION'));
   set_item_result(run_stored_sig('AR_LB_INTERFACE'));
   set_item_result(run_stored_sig('AR_LB_RCT_BATCHES'));
   set_item_result(run_stored_sig('AR_LB_INTERIM_RCT'));
   set_item_result(run_stored_sig('AR_LB_INTERIM_RCT_LINES'));
   set_item_result(run_stored_sig('AR_LB_RCT'));
   set_item_result(run_stored_sig('AR_LB_RCT_HISTORY'));
   set_item_result(run_stored_sig('EBS_FIN_AR_AR_LOCKBOX_ANLZ_RA_CUSTOMER_TRX_ALL'));
   set_item_result(run_stored_sig('EBS_FIN_AR_AR_LOCKBOX_ANLZ_AR_PAYMENT_SCHEDULES_ALL'));
end_section;
debug('end section: LB_INTERFACE_DATA');

debug('begin section: LB_SETUP');
start_section('Lockbox Setup', 'LB_SETUP');
   set_item_result(run_stored_sig('AR_LB_LOCKBOX'));
   set_item_result(run_stored_sig('AR_LB_RCT_SOURCE'));
   set_item_result(run_stored_sig('AR_LB_RCT_CLASS'));
   set_item_result(run_stored_sig('AR_LB_RCT_METHODS'));
   set_item_result(run_stored_sig('AR_LB_RCT_METHOD_ACCOUNTS'));
   set_item_result(run_stored_sig('AR_LB_TRANS_FMT'));
   set_item_result(run_stored_sig('AR_LB_PS_SEED_DATA'));
   set_item_result(run_stored_sig('EBS_FIN_AR_AR_LOCKBOX_ANLZ_AUTOMATCH_ENABLED'));
end_section;
debug('end section: LB_SETUP');

debug('begin section: LB_RCT_INFO');
IF g_rctnumber is not null THEN
   start_section('Lockbox Receipt - Customer Information', 'LB_RCT_INFO');
      set_item_result(run_stored_sig('AR_LB_RCT_INFO'));
      IF g_custnumber is not null THEN
         set_item_result(run_stored_sig('AR_LB_CUST_IDENTIFICATION'));
      END IF;
      IF g_routingnum is not null
and g_bnkacctnum is not null THEN
         set_item_result(run_stored_sig('AR_LB_MICR_IDENTIFICATION'));
      END IF;
   end_section;
END IF;
debug('end section: LB_RCT_INFO');

debug('begin section: LB_ERRORS');
start_section('Lockbox Error Check', 'LB_ERRORS');
   set_item_result(run_stored_sig('AR_LB_CUST_MULTIPLE_PRIMARY_BILL_TO'));
   set_item_result(run_stored_sig('AR_LB_CONC_MULTI_ORG_CATEGORY'));
   set_item_result(run_stored_sig('AR_LB_EXCH_RATE_GL'));
   set_item_result(run_stored_sig('AR_LB_DIFF_EX_RATES_SAME_TRXN'));
   set_item_result(run_stored_sig('AR_LB_APP_OVERAPPLIED'));
   set_item_result(run_stored_sig('AR_LB_AUTOASSOC'));
   set_item_result(run_stored_sig('AR_LB_BAD_CUST_NUM'));
   set_item_result(run_stored_sig('AR_LB_BAD_GL_DATE_SOURCE'));
   set_item_result(run_stored_sig('AR_LB_BAD_MICR_NUM'));
   set_item_result(run_stored_sig('AR_LB_BAD_ORIGIN'));
   set_item_result(run_stored_sig('AR_LB_BATCH_AMT_BAD'));
   set_item_result(run_stored_sig('AR_LB_BATCH_COUNT_BAD'));
   set_item_result(run_stored_sig('AR_LB_BR_RESERVED'));
   set_item_result(run_stored_sig('AR_LB_CC_INVALID_VALUE'));
   set_item_result(run_stored_sig('AR_LB_CLASS_BAD'));
   set_item_result(run_stored_sig('AR_LB_CURRENCY_BAD'));
   set_item_result(run_stored_sig('AR_LB_CURRENCY_DISABLED'));
   set_item_result(run_stored_sig('AR_LB_CURR_CONFLICT'));
   set_item_result(run_stored_sig('AR_LB_CUSTOMER_CONFLICT'));
   set_item_result(run_stored_sig('AR_LB_CUST_IDENTIFICATION'));
   set_item_result(run_stored_sig('AR_LB_CUST_NUM_CONFLICT'));
   set_item_result(run_stored_sig('AR_LB_DEP_DATE_GT_GL_DATE'));
   set_item_result(run_stored_sig('AR_LB_DUP_BANK_ACCT_NAME'));
   set_item_result(run_stored_sig('AR_LB_DUP_BATCH_NAME'));
   set_item_result(run_stored_sig('AR_LB_DUP_INV'));
   set_item_result(run_stored_sig('AR_LB_DUP_ITEM_NUM'));
   set_item_result(run_stored_sig('AR_LB_DUP_LB_NUM'));
   set_item_result(run_stored_sig('AR_LB_DUP_OVRFLW_SEQ'));
   set_item_result(run_stored_sig('AR_LB_DUP_PMT'));
   set_item_result(run_stored_sig('AR_LB_GL_PERIOD_CLOSED'));
   set_item_result(run_stored_sig('AR_LB_INACTIVE_LB_NUM'));
   set_item_result(run_stored_sig('AR_LB_INVALID_BATCH'));
   set_item_result(run_stored_sig('AR_LB_INVALID_BATCH_NAME'));
   set_item_result(run_stored_sig('AR_LB_INVALID_CURRENCY'));
   set_item_result(run_stored_sig('AR_LB_INVALID_INSTALLMENT'));
   set_item_result(run_stored_sig('AR_LB_INVALID_ITEM_NUM'));
   set_item_result(run_stored_sig('AR_LB_INVALID_LB_NUM'));
   set_item_result(run_stored_sig('AR_LB_INVALID_LOCATION'));
   set_item_result(run_stored_sig('AR_LB_INVALID_MATCH'));
   set_item_result(run_stored_sig('AR_LB_INVALID_MICR_NUM'));
   set_item_result(run_stored_sig('AR_LB_INVALID_OVRFLW'));
   set_item_result(run_stored_sig('AR_LB_INVALID_RECEIPT'));
   set_item_result(run_stored_sig('AR_LB_INVALID_RECEIPT_METHOD'));
   set_item_result(run_stored_sig('AR_LB_INVALID_REC_TYPE'));
   set_item_result(run_stored_sig('AR_LB_INV_BAD'));
   set_item_result(run_stored_sig('AR_LB_LB_AMT_BAD'));
   set_item_result(run_stored_sig('AR_LB_LB_COUNT_BAD'));
   set_item_result(run_stored_sig('AR_LB_MICR_CONFLICT'));
   set_item_result(run_stored_sig('AR_LB_MICR_CUST_CONFLICT'));
   set_item_result(run_stored_sig('AR_LB_NAT_VIO_CM'));
   set_item_result(run_stored_sig('AR_LB_NAT_VIO_INV'));
   set_item_result(run_stored_sig('AR_LB_NEGATIVE_APPLICATION'));
   set_item_result(run_stored_sig('AR_LB_NEGATIVE_RECEIPT'));
   set_item_result(run_stored_sig('AR_LB_NO_DEPOSIT_DATE'));
   set_item_result(run_stored_sig('AR_LB_NO_EXCHANGE_RATE'));
   set_item_result(run_stored_sig('AR_LB_NO_FIRST_OVRFLW'));
   set_item_result(run_stored_sig('AR_LB_NO_INV_NUMBER'));
   set_item_result(run_stored_sig('AR_LB_NO_ITEM_NUM'));
   set_item_result(run_stored_sig('AR_LB_NO_LB_NUM'));
   set_item_result(run_stored_sig('AR_LB_NO_NEXT_OVRFLW'));
   set_item_result(run_stored_sig('AR_LB_NO_ORIGIN'));
   set_item_result(run_stored_sig('AR_LB_NO_PRIMARY_LOCATION'));
   set_item_result(run_stored_sig('AR_LB_NO_RECEIPT_DATE'));
   set_item_result(run_stored_sig('AR_LB_NO_RECEIPT_NUM'));
   set_item_result(run_stored_sig('AR_LB_NO_REMIT_AMT'));
   set_item_result(run_stored_sig('AR_LB_NO_REQUESTED_GL_DATE'));
   set_item_result(run_stored_sig('AR_LB_ORIGIN_CONFLICT'));
   set_item_result(run_stored_sig('AR_LB_PENDING_AUTO_RECEIPT'));
   set_item_result(run_stored_sig('AR_LB_RCPT_DATE_GT_GL_DATE'));
   set_item_result(run_stored_sig('AR_LB_RCT_CUST_PARTY'));
   set_item_result(run_stored_sig('AR_LB_REMIT_EXCEEDED'));
   set_item_result(run_stored_sig('AR_LB_TRANS_AMT_BAD'));
   set_item_result(run_stored_sig('AR_LB_TRANS_COUNT_BAD'));
   set_item_result(run_stored_sig('AR_LB_USSGL_TC_INVALID'));
   set_item_result(run_stored_sig('EBS_FIN_AR_AR_LOCKBOX_ANLZ_NULL_TRANS_RECORD_ID'));
   set_item_result(run_stored_sig('EBS_FIN_AR_AR_LOCKBOX_ANLZ_INV_DIFF_CUSTOMERS'));
end_section;
debug('end section: LB_ERRORS');

debug('begin section: LB_PERFORMANCE');
start_section('Performance', 'LB_PERFORMANCE');
   set_item_result(run_stored_sig('EBS_FIN_AR_GEN_OLD_TABLE_STATS'));
   set_item_result(run_stored_sig('EBS_FIN_AR_GEN_OLD_INDEX_STATS'));
   set_item_result(run_stored_sig('EBS_FIN_AR_GEN_TABLE_STATS_WITH_DBMS'));
   set_item_result(run_stored_sig('EBS_FIN_AR_GEN_GTT_TABLES_WITH_STATS'));
end_section;
debug('end section: LB_PERFORMANCE');
...
start_section('Setup and Environment Information', 'CONSOLIDATED_SETUP');
   ...
   END IF;
   set_item_result(run_stored_sig('EBS_FIN_AR_AR_LOCKBOX_ANLZ_AR_GL_PERIOD_STATUSES'));
end_section;
debug('end section: CONSOLIDATED_SETUP');

debug('begin section: Proactive');
start_section('Proactive Recommendations', 'Proactive');
   IF (substr(g_rep_info('Apps Version'),1,4) = '12.2')
 THEN
      set_item_result(run_stored_sig('EBS_FIN_AR_AR_LOCKBOX_ANLZ_CM_NOTE_2953541_1_122'));
   END IF;
   ...
   set_item_result(run_stored_sig('EBS_FIN_AR_GEN_DUP_SYSTEM_PARAMETERS'));
end_section;
