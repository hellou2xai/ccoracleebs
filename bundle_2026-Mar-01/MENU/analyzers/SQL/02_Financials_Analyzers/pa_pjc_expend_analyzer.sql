...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Projects Expenditure Processing        |
REM | Analyzer                                                                  |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE pa_pjc_expend_analyzer_pkg AUTHID DEFINER AS
...
----------------------------------------------------------------
FUNCTION file_version(p_file_id IN NUMBER) RETURN VARCHAR2;


END pa_pjc_expend_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY pa_pjc_expend_analyzer_pkg AS
-- $Id: pa_pjc_expend_analyzer.sql, 200.37 2026/02/25 21:45:24 aliclin Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2443481.1));
...
----------------------------------------------------------------
g_project_id   NUMBER;
g_expenditure_item_id NUMBER;
g_cost_structure VARCHAR2(30);
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'PAEXPND_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'PAEXPND_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>PAEXPND Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2443481.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/pa_pjc_expend_lastest_ver.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1614,EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1614,EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1614,EBS,EBS Financials,EBS - Projects" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4171505" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">1614</span>
...
<p><strong>Version 200.37</strong></p><ul><li>Sigs updated for doc ID changes.</li>
</ul>
<p><strong>Version 200.36</strong></p><ul><li>Template enhancement: EBS KB Article IDs Shown for Signature KM Links.</li>
<li>Sigs updated for doc ID changes.</li>
</ul>
<p><strong>Version 200.35</strong></p><ul><li>Template and AC_TABLE_INDEXES enhanced.</li>
</ul>
<p><strong>Version 200.34</strong></p><ul><li>Max Sequence signatures enhanced.</li>
</ul>
<p><strong>Version 200.33</strong></p><ol><li>New Analyzer Framework version 4.7.3 released with enhancements.<ol><li>SQL*Plus Error fixed: SP2-0027: Input is too long</li>
<li>Ability to click to select rows in output tables</li>
</ol>
</li>
<li>Several signatures enhanced.</li>
</ol>
<p><strong>Version 200.32</strong></p><ul><li>Two new signatures added to “Burdening” section and “Expenditure Data Issues” section.</li>
</ul>
<p><strong>Version 200.31</strong></p><ul><li>One new signature added to “Expenditure Data Issues” section and minor fix to existing signature.</li>
</ul>
<p><strong>Version 200.30</strong></p><ul><li>Five signatures modified and XLA product added to "Apps Check" section.</li>
</ul>
<p><strong>Version 200.29</strong></p><ul><li>Removed "Capitalization" section, two new signatures added to "Expenditure Data Issues" section and one signature removed due to poor performance.</li>
</ul>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1614,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1614,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1614,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Projects" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
----------------------------------------------------------------
FUNCTION file_version(p_file_id IN NUMBER) RETURN VARCHAR2 IS

  CURSOR ordered_versions IS
    SELECT version
    FROM ad_file_versions
    WHERE file_id = p_file_id
    ORDER BY to_number(version_segment1) desc, to_number(version_segment2) desc,
             to_number(version_segment3) desc, to_number(version_segment4) desc,
             to_number(version_segment5) desc, to_number(version_segment6) desc,
             to_number(version_segment7) desc, to_number(version_segment8) desc,
             to_number(version_segment9) desc, to_number(version_segment10) desc;

  l_version VARCHAR2(100);

BEGIN

  OPEN ordered_versions;
  FETCH ordered_versions INTO l_version;
  CLOSE ordered_versions;
...
FUNCTION corr_docs2 (
  p_doc_hdr_id  IN NUMBER,
  p_doc_dist_id IN NUMBER,
  p_enc_amt     IN NUMBER,
  p_qty_ordered IN NUMBER,
  p_qty_billed  IN NUMBER,
  p_mtch_basis  IN VARCHAR2,
  p_accr_on_rct IN VARCHAR2,
  p_bc_amt      IN NUMBER) RETURN NUMBER IS

  CURSOR ap_interfaced_amount(po_dist_id NUMBER) IS
    SELECT sum(cdl.acct_raw_cost)
    FROM pa_cost_distribution_lines_all cdl,
         pa_expenditure_items_all ei
    WHERE ei.expenditure_item_id = cdl.expenditure_item_id
    AND   ei.transaction_source IN ('AP INVOICE','AP NRTAX')
    AND   cdl.line_num = 1
    AND   (ei.document_header_id,ei.document_distribution_id) IN (
            SELECT invoice_id,
                   invoice_distribution_id
            FROM ap_invoice_distributions_all
            WHERE po_distribution_id = po_dist_id
            AND   pa_addition_flag IN ('Y'));

  CURSOR po_interfaced_amount(po_header_id NUMBER, po_dist_id NUMBER) IS
    SELECT sum(cdl.acct_raw_cost)
    FROM pa_cost_distribution_lines_all cdl,
         pa_expenditure_items_all ei
    WHERE ei.expenditure_item_id = cdl.expenditure_item_id
    AND   ei.transaction_source IN ('PO RECEIPT','PO RECEIPT NRTAX',
            'PO RECEIPT PRICE ADJ' ,'PO RECEIPT NRTAX PRICE ADJ')
    AND   cdl.line_num = 1
    AND   ei.document_header_id = po_header_id
    AND   ei.document_line_number = po_dist_id;

  CURSOR ap_interfaced_variance(po_dist_id NUMBER) IS
    SELECT sum(nvl(base_invoice_price_variance, 0) +
             nvl(exchange_rate_variance, 0) + nvl(base_amount,0))
    FROM ap_invoice_distributions_all
    WHERE po_distribution_id = po_dist_id
    AND   line_type_lookup_codE in ('ERV','TRV','TIPV','IPV')
    AND   pa_addition_flag = 'Y';



  l_ap_amount_interfaced  NUMBER := 0;
  l_po_amount_interfaced  NUMBER := 0;
  l_var_amount_interfaced NUMBER := 0;
  l_amount_tobe_relieved  NUMBER := 0;

BEGIN

  OPEN ap_interfaced_amount(p_doc_dist_id);
  FETCH ap_interfaced_amount INTO l_ap_amount_interfaced;
  CLOSE ap_interfaced_amount;

  OPEN po_interfaced_amount(p_doc_hdr_id, p_doc_dist_id);
  FETCH po_interfaced_amount INTO l_po_amount_interfaced;
  CLOSE po_interfaced_amount;

  IF l_po_amount_interfaced <> 0 THEN
    IF nvl(p_enc_amt,0) < nvl(l_po_amount_interfaced,0) THEN
      l_amount_tobe_relieved := nvl(p_bc_amt,0);
    ELSE
      l_amount_tobe_relieved := nvl(p_bc_amt,0) - (nvl(p_enc_amt,0) -
        nvl(l_po_amount_interfaced,0));
    END IF;
  ELSE

    OPEN ap_interfaced_variance(p_doc_dist_id);
    FETCH ap_interfaced_variance INTO l_var_amount_interfaced;
    IF ap_interfaced_variance%NOTFOUND THEN
      l_var_amount_interfaced := 0;
    END IF;
    CLOSE ap_interfaced_variance;

    IF nvl(p_enc_amt,0) < nvl(l_ap_amount_interfaced,0) THEN
      l_amount_tobe_relieved := nvl(p_bc_amt,0);
    ELSE
      IF nvl(l_var_amount_interfaced,0) = 0 THEN
        l_amount_tobe_relieved := nvl(p_bc_amt,0) -
          (nvl(p_enc_amt,0) - nvl(l_ap_amount_interfaced,0));
      ELSE
        l_amount_tobe_relieved := nvl(p_bc_amt,0) -
          (nvl(p_enc_amt,0) - nvl(l_ap_amount_interfaced,0));
      END IF;
  ...
  IF (nvl(p_accr_on_rct,'N') = 'N' AND
      p_qty_ordered = p_qty_billed AND
      nvl(p_mtch_basis, 'QUANTITY') = 'QUANTITY') THEN

    l_amount_tobe_relieved := Nvl(p_bc_amt,0);

  END IF;

  RETURN(l_amount_tobe_relieved);
...
FUNCTION check_rec_patches_1 RETURN VARCHAR2 IS
  /* Signature PA_COST_RECOMMENDED_PATCHES */
...
BEGIN
    ...
    print_log('Processing recommended patches signature: PA_COST_RECOMMENDED_PATCHES (check_rec_patches_1) "Project Costing Recommended Patches" (version 6)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_col_rows(1)(l_rows) := '21625199';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Project Costing Recommended Patch Collection 4 [RPC4]';
   l_col_rows(5)(l_rows) := '[2152266/KB196540]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26674044';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'P2P: Consolidated Critical Patch for Root Cause Fixes';
   l_col_rows(5)(l_rows) := '[1363661/PALRT1343]';
...
IF substr(g_rep_info('Apps Version'),1,6) = '12.2.5' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '26674044:R12.PJC.C P2P: Consolidated Critical Patch for Root Cause Fixes';
   l_col_rows(5)(l_rows) := '[1363661/PALRT1343]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26818120';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'CAPITAL : Consolidated Critical Patch for Root Cause Fixes';
   l_col_rows(5)(l_rows) := '[1538822/KB317325]';
...
END IF;
   ...
   l_sig.sigrepo_id := '10285';
   l_sig.title := 'Project Costing Recommended Patches';
   ...
   l_sig.solution := 'Please review list above and schedule to apply any unappplied patches as soon as possible.  Where indicated review the associated note for details about the patch and its application.

For additional current recommended patches, you can also use the Patch Wizard Further guidance on this tool can be found in the following documents:
<ul>
...
<li>[10940175/KA580] Patch Wizard FAQ</li>
  ...
  -- Register
  l_step := '60';
  g_signatures('PA_COST_RECOMMENDED_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'PA_COST_RECOMMENDED_PATCHES',     -- sig ID
...
FUNCTION check_rec_patches_2 RETURN VARCHAR2 IS
  /* Signature EBS_PA_PAEXPND_2807662_1 */
  l_col_rows   COL_LIST_TBL := col_list_tbl(); -- Row values
  l_rel_rows   COL_LIST_TBL := col_list_tbl(); -- Row release
  l_hdr        VARCHAR_TBL  := varchar_tbl(); -- Column headings
  l_app_date   DATE;         -- Patch applied date
...
BEGIN
    ...
    print_log('Processing recommended patches signature: EBS_PA_PAEXPND_2807662_1 (check_rec_patches_2) "PRC: Generate Cost Accounting Events Terminates Intermittently With Signal 11" (version 6)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33271355';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'PRC: GENERATE COST ACCOUNTING EVENTS INTERMITTENTLY ENDS WITH SIGNAL 11';
   l_col_rows(5)(l_rows) := '[2730902/KB315200]';

END IF;

   l_extra_info('##SHOW_SQL##'):= 'Y';

   l_sig.sigrepo_id := '25788';
   l_sig.title := 'PRC: Generate Cost Accounting Events Terminates Intermittently With Signal 11';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := 'Codefix patch for PAGCAE: PRC: Generate Cost Accounting Events Errors With Signal 11 [2730902/KB315200] has not been applied.';
   l_sig.solution := 'Follow the solution in PAGCAE: PRC: Generate Cost Accounting Events Errors With Signal 11 [2730902/KB315200].';
   l_sig.success_msg := 'Codefix patch for PAGCAE: PRC: Generate Cost Accounting Events Errors With Signal 11 [2730902/KB315200] has been applied.';
   l_sig.print_condition := 'ALWAYS';
   l_sig.fail_type := 'W';
   l_sig.print_sql_output := 'RS';
   l_sig.limit_rows := 'Y';
  ...
  -- Register
  l_step := '60';
  g_signatures('EBS_PA_PAEXPND_2807662_1') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'EBS_PA_PAEXPND_2807662_1',     -- sig ID
    l_sig,                              -- signature information
    l_col_rows,                         -- data
    l_hdr);                             -- headers
...
FUNCTION get_PROJECT_ID
   return VARCHAR2 IS
BEGIN
debug('begin sql token function: PROJECT_ID');
BEGIN

-- project_id
SELECT ei.project_id into l_project_id
FROM PA_EXPENDITURE_ITEMS_ALL ei
where ei.expenditure_item_id= p_expenditure_item_id;
...
debug('end sql token function: PROJECT_ID');
END get_PROJECT_ID;
...
-- org_id
      ...
      select ei.org_id into l_org_id
      from pa_expenditure_items_all ei
      where ei.expenditure_item_id= p_expenditure_item_id;
...
FUNCTION get_COST_STRUCTURE
   return VARCHAR2 IS
BEGIN
debug('begin sql token function: COST_STRUCTURE');
BEGIN
--cost_plus_structure 

select r.cost_plus_structure 
into l_cost_structure
 from pa_expenditure_items_all ei, pa_projects_all p, pa_ind_rate_schedules r
  where p.project_id=ei.project_id 
  and p.cost_ind_rate_sch_id= r.ind_rate_sch_id
  and ei.expenditure_item_id=p_expenditure_item_id;

RETURN l_cost_structure;

EXCEPTION WHEN NO_DATA_FOUND THEN
RETURN NULL;
END;

debug('end sql token function: COST_STRUCTURE');
END get_COST_STRUCTURE;

FUNCTION get_P_PROJECT_ID
   return VARCHAR2 IS
BEGIN
debug('begin sql token function: P_PROJECT_ID');
BEGIN
...
debug('end sql token function: P_PROJECT_ID');
END get_P_PROJECT_ID;
...
-- Revision and date values can be populated by RCS
  l_revision := rtrim(replace('$Revision: 200.37  $','$',''));
  l_revision := ltrim(replace(l_revision,'Revision:',''));
  l_date_char := rtrim(replace('$Date: 2026/02/25 21:45:22 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'pa_pjc_expend_analyzer.sql';
...
IF p_expenditure_item_id IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Expenditure Item ID is required.');
...
WHERE EXPENDITURE_ITEM_ID = p_expenditure_item_id
 AND (mo_global.is_mo_init_done = 'N' or mo_global.check_access(ORG_ID) = 'Y')
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Expenditure Item ID');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
g_cost_structure :=l_cost_structure;
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$PROJECT_ID$$##') := get_PROJECT_ID();
   ...
   g_sql_tokens('##$$P_EXPENDITURE_ITEM_ID$$##') := p_expenditure_item_id;
   g_masked_tokens('##$$P_EXPENDITURE_ITEM_ID$$##') := mask_text( g_sql_tokens('##$$P_EXPENDITURE_ITEM_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$COST_STRUCTURE$$##') := get_COST_STRUCTURE();
   l_system_function_var := null;
   g_masked_tokens('##$$COST_STRUCTURE$$##') := mask_text( g_sql_tokens('##$$COST_STRUCTURE$$##'), 'NO_MASK');
   ...
   g_sql_tokens('##$$P_PROJECT_ID$$##') := get_P_PROJECT_ID();
   l_system_function_var := null;
   g_masked_tokens('##$$P_PROJECT_ID$$##') := mask_text( g_sql_tokens('##$$P_PROJECT_ID$$##'), 'NO_MASK');
...
debug('begin add_signature: 2060157.1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13843',
      p_sig_id                 => '2060157.1',
      p_sig_sql                => 'SELECT af.filename, afv.version
FROM ad_file_versions afv,
  ad_files af
WHERE afv.file_id = af.file_id
AND upper(af.filename)  = upper(''pav0409.odf'')
and afv.version_segment1 = (select max(TO_NUMBER(version_segment1)) from ad_file_versions where file_id = afv.file_id)
and afv.version_segment2 = (select max(TO_NUMBER(version_segment2)) from ad_file_versions where file_id = afv.file_id and afv.version_segment1 = version_segment1)
and afv.version_segment3 = (select max(TO_NUMBER(version_segment3)) from ad_file_versions where file_id = afv.file_id and afv.version_segment1 = version_segment1 and afv.version_segment2 = version_segment2)
and afv.version_segment4 = (select max(TO_NUMBER(version_segment4)) from ad_file_versions where file_id = afv.file_id and afv.version_segment1 = version_segment1 and afv.version_segment2 = version_segment2 and afv.version_segment3 = version_segment3)
and afv.version_segment1 = ''120''
and afv.version_segment2 = ''4''
and afv.version_segment3 = ''12010000''
and afv.version_segment4 < ''4''
union
SELECT af.filename, afv.version
FROM ad_file_versions afv,
  ad_files af
WHERE afv.file_id = af.file_id
AND upper(af.filename)  = upper(''pav0409.odf'')
...
and afv.version_segment4 = (select max(TO_NUMBER(version_segment4)) from ad_file_versions where file_id = afv.file_id and afv.version_segment1 = version_segment1 and afv.version_segment2 = version_segment2 and afv.version_segment3 = version_segment3)
and afv.version_segment1 = ''120''
and afv.version_segment2 = ''9''
and afv.version_segment3 = ''12020000''
and afv.version_segment4 < ''9''',
      p_title                  => 'FRM-41839 Disk IO Error',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There is a known code bug which will cause following error trying to run expenditure on a project. It has been verified that you do not have the code fix.<br>
Error: FRM-41839 Disk I/O Error On Temporary Record Buffer File',
      p_solution               => 'See [2060157/KB318915] for solution.',
      p_success_msg            => 'Verified have fix for [2060157/KB318915] FRM-41839 Disk I/O Error On Temporary Record Buffer File When Exporting Large Volume in Expenditure Inquiry',
   ...
   l_info.delete;
debug('end add_signature: 2060157.1');



debug('begin add_signature: TRANSACTION_IMPORT_WEB_ADI_ISSUES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13343',
      p_sig_id                 => 'TRANSACTION_IMPORT_WEB_ADI_ISSUES',
      p_sig_sql                => 'SELECT DISTINCT table_name, version
FROM (
  SELECT ''bne_interface_cols_tl ''||sequence_num AS table_name, '''' as version
  FROM bne_interface_cols_tl
  WHERE application_id=275
    AND interface_code=''TRANSACTION_INTERFACE''
    AND sequence_num IN (715,720,730)
  UNION ALL
  SELECT ''bne_interface_cols_b ''||sequence_num, ''''
  FROM bne_interface_cols_b
  WHERE application_id=275
    AND interface_code=''TRANSACTION_INTERFACE''
    AND sequence_num IN (715,720,730)
  UNION ALL
  SELECT ''bne_layout_cols ''||interface_seq_num, ''''
  FROM bne_layout_cols
  WHERE application_id=275
    AND interface_code=''TRANSACTION_INTERFACE''
    AND interface_seq_num IN (715,720,730)
  UNION ALL
  SELECT '''', af.filename ||'' ''|| afv.version
  FROM ad_file_versions afv
  JOIN ad_files af ON afv.file_id = af.file_id
  WHERE upper(af.filename)=upper(''pabneint.ldt'')
    AND afv.version_segment1=(SELECT max(TO_NUMBER(version_segment1)) FROM ad_file_versions WHERE file_id=afv.file_id)
    AND afv.version_segment2=(SELECT max(TO_NUMBER(version_segment2)) FROM ad_file_versions WHERE file_id=afv.file_id AND afv.version_segment1=version_segment1)
    AND afv.version_segment3=(SELECT max(TO_NUMBER(version_segment3)) FROM ad_file_versions WHERE file_id=afv.file_id AND afv.version_segment1=version_segment1 AND afv.version_segment2=version_segment2)
    AND afv.version_segment4=(SELECT max(TO_NUMBER(version_segment4)) FROM ad_file_versions WHERE file_id=afv.file_id AND afv.version_segment1=version_segment1 AND afv.version_segment2=version_segment2 AND afv.version_segment3=version_segment3)
    AND afv.version_segment1=''120''
    AND afv.version_segment2=''5''
    AND afv.version_segment3=''12010000''
    AND afv.version_segment4<''14''
  UNION ALL
  SELECT '''', af.filename ||'' ''|| afv.version
  FROM ad_file_versions afv
  JOIN ad_files af ON afv.file_id = af.file_id
  WHERE upper(af.filename)=upper(''pabneint.ldt'')
    ...
    AND afv.version_segment4=(SELECT max(TO_NUMBER(version_segment4)) FROM ad_file_versions WHERE file_id=afv.file_id AND afv.version_segment1=version_segment1 AND afv.version_segment2=version_segment2 AND afv.version_segment3=version_segment3)
    AND afv.version_segment1=''120''
    AND afv.version_segment2=''12''
    AND afv.version_segment3=''12020000''
    AND afv.version_segment4<''10''
)',
      p_title                  => 'Transaction Import Web ADI Issues ',
      p_fail_condition         => 'RS',
      p_problem_descr          => '<p>Projects Transaction Import Web ADI are facing any of below issues:</p>
<ul>
<li>Web ADI layout is not consistent such as having blank spaces between fields.</li>
<li>''Negative Txn Flag'' is appearing twice on ''Define Layout'' page in ''Optional Fields'' section.</li>
<li>''Organization_Name'' field is appearing as mandatory.</li>
<li>Not able to include/exclude fields using check box provided on ''Define Layout'' page.</li>
<li>Getting below error message while importing accounted transactions batch:
<ul>
<li>Debit Acct must be a numeric value</li>
<li>Credit Acct must be a numeric value</li>
</ul>
</li>
</ul>',
      p_solution               => 'Follow [1669751/KB255203] Projects Transaction Import Web ADI Issues',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: TRANSACTION_IMPORT_WEB_ADI_ISSUES');



debug('begin add_signature: PA_WORKFLOWS_ALL_IN_ERROR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13919',
      p_sig_id                 => 'PA_WORKFLOWS_ALL_IN_ERROR',
      p_sig_sql                => 'select
...
rpad(to_char(COUNT(*),''999,999,999,999''), 20, '' '') "ROWS"
   from  WF_ITEM_ACTIVITY_STATUSES  STA, WF_PROCESS_ACTIVITIES PRA
     ...
     and STA.ITEM_TYPE in (''PAPRJEX'', ''PAWFAAP'',	''PAPWPAR'',	''PARADVWF'',	''PARAPTEM'',	''PAWFBUI'',	''PABUDWF'',	''PACANDID'',
                           ''PADCTNWF'',	''PARFIGEN'',	''PAWFCIAC'',	''PAWFCISC'',	''PARMATRX'',	''PAYPRJNT'',	''PAROVCNT'',	''PAPROWF'',
                           ''PAWFPPRA'',	''PATASKWF'',	''PAWFPPWP'',	''PACRMUPD'',	''PAXWFHRU'',	''PARMAAP'',	''PAEXNOWF'',	''PABDACWF'',	''PAAPWEBX'',	''PAAPINVW'')
group by STA.ITEM_TYPE, STA.ACTIVITY_RESULT_CODE, PRA.PROCESS_NAME, PRA.INSTANCE_LABEL
order by COUNT(*) desc',
      p_title                  => 'Project Workflows in Error',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Project Workflows in Error.',
      p_solution               => 'Please review the related workflows.<br>
For more details please review: [224308/FAQ2720] R11 R12 Account Generator & Workflow Frequently Asked Questions',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_WORKFLOWS_ALL_IN_ERROR');



debug('begin add_signature: EBS_FIN_PA_TXN_INTERFACE_TRIGGERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24010',
      p_sig_id                 => 'EBS_FIN_PA_TXN_INTERFACE_TRIGGERS',
      p_sig_sql                => 'SELECT
    trigger_name,
    table_name,
    status,
...
WHERE
    trigger_name IN (
        ''PA_TRANSACTION_INTERFACE_T1'',
        ''PA_TRANSACTION_INTERFACE_T2'',
       ''PA_TRANSACTION_INTERFACE_T3'',
        ''PA_TRANSACTION_INTERFACE_T4''
    )
    AND status = ''DISABLED''',
      p_title                  => 'Transaction Interface Triggers',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Disabled trigger(s) found on PA_TRANSACTION_INTERFACE_ALL.',
      p_solution               => 'Ensure all triggers are created and enabled in PA_TRANSACTION_INTERFACE_ALL.  See [2664914/KB484086] Inserting Records Into PA_TRANSACTION_INTERFACE_ALL Table Errors with ORA-01400: cannot insert NULL into ("PA"."PA_TRANSACTION_INTERFACE_ALL"."TXN_INTERFACE_ID") for additional details.',
      p_success_msg            => 'No disabled trigger(s) found on PA_TRANSACTION_INTERFACE_ALL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_TXN_INTERFACE_TRIGGERS');



debug('begin add_signature: EBS_FIN_PA_PA_OTL_DUPLICATE_EXP_ITEMS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22868',
      p_sig_id                 => 'EBS_FIN_PA_PA_OTL_DUPLICATE_EXP_ITEMS',
      p_sig_sql                => 'select ei.orig_transaction_Reference, count(*)  "# of Duplicate OTL Timecards"
from pa_expenditure_items_all ei
where ei.transaction_source = ''ORACLE TIME AND LABOR''
and org_id =  ##$$ORG_ID$$##
and ei.net_zero_adjustment_Flag = ''N''
and ei.orig_transaction_Reference is not null
group by ei.orig_transaction_Reference
having count(*) > 1',
      p_title                  => 'Duplicate Expenditure Items From Oracle Time and Labor (OTL) Exist',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Duplicate expenditure Items from Oracle Time and Labor (OTL) exist in Projects

',
      p_solution               => 'Follow the instructions in [2765848/KB537884] Duplicate Expenditure Items in Projects Coming From Oracle Time And Labor',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_OTL_DUPLICATE_EXP_ITEMS');



debug('begin add_signature: PA_COST_INVALID_GL_DATE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9730',
      p_sig_id                 => 'PA_COST_INVALID_GL_DATE',
      p_sig_sql                => 'SELECT *
FROM pa_cost_distribution_lines_all
WHERE EXPENDITURE_ITEM_ID = ##$$P_EXPENDITURE_ITEM_ID$$##
AND (gl_date             IS NULL
OR PA_DATE               IS NULL
OR RECVR_PA_DATE         IS NULL
OR RECVR_GL_DATE         IS NULL )',
      p_title                  => 'Transactions with GL_DATE NULL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'GL_DATE is missing in PA_COST_DISTRIBUTION_LINES_ALL table for the listed transactions.',
      p_solution               => 'Please follow below note and apply suggested datafix:<br>
[808022/KB198787] Cost Distribution Lines Do Not Have The PA Period And GL Period Names Populated
Download the version of the generic datafix {3979908} appropriate for your release and apply it according to the README instructions.<br>
This issue is addressed by the first part of the data fix (scripts b3979908.sql) ',
      p_success_msg            => 'No transactions identified without GL_DATE in PA_COST_DISTRIBUTION_LINES_ALL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_INVALID_GL_DATE');



debug('begin add_signature: PA_COST_EXP_COST_COLUMN_NULL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10460',
      p_sig_id                 => 'PA_COST_EXP_COST_COLUMN_NULL',
      p_sig_sql                => 'select ei.expenditure_item_id,ei.denom_raw_cost 
        ,      	ei.acct_raw_cost 
      	,      	ei.raw_cost_rate 
   ...
   where
    ...
    order by ei.expenditure_id, ei.expenditure_item_id',
      p_title                  => 'Distribute Labor Costs Errors with Cannot Insert NULL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Either adjustment is created for the expenditure or data got corrupted causing below error.<br>
The cost distribution process throws the error: ORA-01400: cannot insert NULL into ("PA"."PA_COST_DISTRIBUTION_LINES_ALL"."AMOUNT").<br>
',
      p_solution               => 'Please follow below note and apply suggested datafix:<br>
[800724/KB199433] R11 R12 PALDLC - pacgud: ORA-1400: cannot insert NULL into ("PA"."PA_COST_DISTRIBUTION_LINES_ALL"."AMOUNT")<br>',
      p_success_msg            => 'Data corruption causing ORA-1400 errors on cost distribution process not detected.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_EXP_COST_COLUMN_NULL');



debug('begin add_signature: MISSING_EXPENDITURE_GROUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15133',
      p_sig_id                 => 'MISSING_EXPENDITURE_GROUP',
      p_sig_sql                => 'SELECT DISTINCT
  eg.*
FROM PA_EXPENDITURES_ALL e ,
  PA_EXPENDITURE_ITEMS_ALL ei ,
  PA_EXPENDITURE_GROUPS_ALL eg
WHERE ei.expenditure_item_id     = ##$$P_EXPENDITURE_ITEM_ID$$##  -- ##EIID##
AND ei.expenditure_id        = e.expenditure_id
AND eg.EXPENDITURE_GROUP     = e.EXPENDITURE_GROUP',
      p_title                  => 'Missing Expenditure Group Record',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'For this expenditure item, there is missing the expenditure group record in the PA_EXPENDITURE_GROUPS_ALL table.',
      p_solution               => 'Apply datafix as per [2348396/KB754513].',
      p_success_msg            => 'No missing expenditure group record found in PA_EXPENDITURE_GROUPS_ALL table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: MISSING_EXPENDITURE_GROUP');



debug('begin add_signature: NO_OPEN_OR_FUTURE_PA-GL_PERIOD_FOR_GIVEN_EXPENDITURE_ITEM_DATE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13342',
      p_sig_id                 => 'NO_OPEN_OR_FUTURE_PA-GL_PERIOD_FOR_GIVEN_EXPENDITURE_ITEM_DATE',
      p_sig_sql                => 'SELECT af.filename, afv.version FROM ad_file_versions afv, ad_files af 
WHERE afv.file_id = af.file_id 
AND upper(af.filename)  = upper(''PAXTTXCB.pls'') 
 and afv.version_segment1 = (select max(TO_NUMBER(version_segment1)) from ad_file_versions where file_id = afv.file_id) 
 and afv.version_segment2 = (select max(TO_NUMBER(version_segment2)) from ad_file_versions where file_id = afv.file_id and afv.version_segment1 = version_segment1) 
 and afv.version_segment3 = (select max(TO_NUMBER(version_segment3)) from ad_file_versions where file_id = afv.file_id and afv.version_segment1 = version_segment1 and afv.version_segment2 = version_segment2) 
 and afv.version_segment4 = (select max(TO_NUMBER(version_segment4)) from ad_file_versions where file_id = afv.file_id and afv.version_segment1 = version_segment1 and afv.version_segment2 = version_segment2 and afv.version_segment3 = version_segment3) 
 and afv.version_segment1 = ''120'' 
 and afv.version_segment2 = ''20'' 
 and afv.version_segment3 = ''12010000'' 
 and afv.version_segment4 < ''31'' 
  union SELECT af.filename, afv.version FROM ad_file_versions afv, ad_files af 
  WHERE afv.file_id = af.file_id AND upper(af.filename)  = upper(''PAXTTXCB.pls'') 
  and afv.version_segment1 = (select max(TO_NUMBER(version_segment1)) from ad_file_versions where file_id = afv.file_id) 
  and afv.version_segment2 = (select max(TO_NUMBER(version_segment2)) from ad_file_versions where file_id = afv.file_id and afv.version_segment1 = version_segment1) 
  and  afv.version_segment3 = (select max(TO_NUMBER(version_segment3)) from ad_file_versions where file_id = afv.file_id and afv.version_segment1 = version_segment1 and afv.version_segment2 = version_segment2) 
  and afv.version_segment4 = (select max(TO_NUMBER(version_segment4)) from ad_file_versions where file_id = afv.file_id and afv.version_segment1 = version_segment1 and afv.version_segment2 = version_segment2 and afv.version_segment3 = version_segment3) 
  and afv.version_segment1 = ''120'' and afv.version_segment2 = ''43'' and afv.version_segment3 = ''12020000'' and afv.version_segment4 < ''9'' ',
      p_title                  => 'There is no Open or future PA or GL period for the given Expenditure Item date or GL date',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'If the Expenditure Item date is any date in future than the current open PA period then an error is displayed:<br>
''There is no Open or future PA or GL period for the given Expenditure Item date or GL date''',
      p_solution               => 'Apply fix suggested in [1637717/KB205745] R12 There Is No Open Or Future PA Or GL Period For The Given Expenditure Item Date Or GL Date ',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: NO_OPEN_OR_FUTURE_PA-GL_PERIOD_FOR_GIVEN_EXPENDITURE_ITEM_DATE');



debug('begin add_signature: PA_COST_AT_OT_CAL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10494',
      p_sig_id                 => 'PA_COST_AT_OT_CAL',
      p_sig_sql                => 'select * from pa_implementations_all
where org_id =  ##$$ORG_ID$$##
and OVERTIME_CALC_ENABLED_FLAG=''Y''',
      p_title                  => 'Automatic Overtime Calculation Enabled Flag',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The Automatic Overtime Calculation is not enabled.',
      p_solution               => 'Please review below note to solve common setup issues related to Overtime Calculation:<br>
[2026937/KB657512#aref_section22] Setup And Implementation of Overtime Cost.',
      p_success_msg            => 'The Automatic Overtime Calculation is enabled.<br>
Please review below note to solve common setup issues related to Overtime Calculation:<br>
[2026937/KB657512#aref_section22] Setup And Implementation of Overtime Cost.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_AT_OT_CAL');



debug('begin add_signature: PA_COST_EXP_COST_DIST');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##COST_DISTRIBUTED_FLAG'):= ',#333333,#ffd6cc,bold';
  add_signature(
      p_sig_repo_id            => '9734',
      p_sig_id                 => 'PA_COST_EXP_COST_DIST',
      p_sig_sql                => 'SELECT 
...
AND ei.task_id             = pt.task_id',
      p_title                  => 'Cost Distributed Status for the Expenditure Item',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Cost is not yet distributed for this expenditure item.',
      p_solution               => 'Please review below document to determine the proper program to distribute the costs successfully:<br>
[2449975/KB199350] How to Distribute Expenditure Cost?',
      p_success_msg            => 'Cost was distributed successfully for this expenditure item.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_EXP_COST_DIST');



debug('begin add_signature: PA_COST_EXP_BATCH_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9736',
      p_sig_id                 => 'PA_COST_EXP_BATCH_STATUS',
      p_sig_sql                => 'SELECT DISTINCT 
  ppa.segment1 "PROJECT_NUMBER",
  ppa.name "PROJECT_NAME",
...
and peg.expenditure_group = pea.expenditure_group
and peg.Expenditure_group_Status_Code = pea.expenditure_status_code
AND pei.project_id               = ppa.project_id
AND peg.Expenditure_group_Status_Code <> ''APPROVED''
AND pei.expenditure_item_id      = ##$$P_EXPENDITURE_ITEM_ID$$##',
      p_title                  => 'Expenditure Batch Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Expenditure item ##$$P_EXPENDITURE_ITEM_ID$$## belongs to a batch which is not in approved status.',
      p_solution               => 'See the following document for solution:<br>
[2430340/KB199001] R12 Unable To Close Period Due To ''Uncosted Exceptions'' ''Cost is not distributed for this transaction''.
',
      p_success_msg            => 'Expenditure item ##$$P_EXPENDITURE_ITEM_ID$$## belongs to a batch which is in approved status.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_EXP_BATCH_STATUS');



debug('begin add_signature: PA_COST_REV_DIST_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9737',
      p_sig_id                 => 'PA_COST_REV_DIST_STATUS',
      p_sig_sql                => 'SELECT ppa.segment1 "PROJECT_NUMBER",
  ppa.NAME "PROJECT_NAME",
  ppt.project_type_class_code,
  ppa.revenue_accrual_method,
  ei.billable_flag,
  ei.expenditure_item_id,
...
WHERE revenue_distributed_flag = ''N''
AND ei.expenditure_item_id     = ##$$P_EXPENDITURE_ITEM_ID$$##
AND ei.project_id              = ppa.project_id
AND ppa.project_type           = ppt.project_type',
      p_title                  => 'Revenue / Asset Line Generation Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Revenue / Asset Lines are not generated for this expenditure item.',
      p_solution               => 'To generate revenue/asset lines, please go through steps suggested in the following notes:<br> 
[2452484/KB199558] How to Generate Revenue Based on Expenditure Item?<br>
[866310/KB199270] What are the Steps to Generate Asset Lines and Interface them to Oracle Fixed Assets? <br>',
      p_success_msg            => 'Revenue / Asset Lines generated successfully.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_REV_DIST_STATUS');



debug('begin add_signature: PA_COST_EXP_REL_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10469',
      p_sig_id                 => 'PA_COST_EXP_REL_STATUS',
      p_sig_sql                => 'select ei.*
from pa_expenditure_items_all ei, pa_expenditures_all e, PA_EXPENDITURE_GROUPS_ALL eg
where ei.EXPENDITURE_ITEM_ID = ##$$P_EXPENDITURE_ITEM_ID$$##
and ei.EXPENDITURE_ID = e.EXPENDITURE_ID
and ei.TRANSACTION_SOURCE is null
and e.EXPENDITURE_GROUP = eg.EXPENDITURE_GROUP
and eg.EXPENDITURE_GROUP_STATUS_CODE = ''RELEASED''
and ei.COST_DISTRIBUTED_FLAG = ''N''
and not exists (select null from PA_COST_DISTRIBUTION_LINES_ALL cdl
where cdl.EXPENDITURE_ITEM_ID = ei.EXPENDITURE_ITEM_ID)
union
select ei.*
from pa_expenditure_items_all ei, pa_expenditures_all e, PA_EXPENDITURE_GROUPS_ALL eg, pa_transaction_sources ts
where ei.EXPENDITURE_ITEM_ID = ##$$P_EXPENDITURE_ITEM_ID$$##
and ei.EXPENDITURE_ID = e.EXPENDITURE_ID
and ts.PREDEFINED_FLAG = ''N''
and ts.COSTED_FLAG = ''N''
...
and not exists (select null from PA_COST_DISTRIBUTION_LINES_ALL cdl
where cdl.EXPENDITURE_ITEM_ID = ei.EXPENDITURE_ITEM_ID)',
      p_title                  => 'Eligibility of Expenditure Item for Correction',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This expenditure item is eligible for correction.',
      p_solution               => 'Navigate to Project Responsibility: <br>
Go to Expenditures --> Pre-Approved Batches --> Review <br>
Click on Update.<br>
Changes the batch status from Released to Update Released which allows for corrections.<br>
[1602128/KB281184]Oracle Project Costing Release Notes, Release Update Pack 6 for 12.1<br>
Section: Correction of Expenditure Batches that are in Released Status and not Cost Distributed.
',
      p_success_msg            => 'There are no corrections that are needed for this expenditure item.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_EXP_REL_STATUS');



debug('begin add_signature: PA_EXP_DISTR_ACCOUNTING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12095',
      p_sig_id                 => 'PA_EXP_DISTR_ACCOUNTING',
      p_sig_sql                => 'SELECT ei.project_id, ei.task_id, ei.expenditure_item_id, cdl.line_num, cdl.dr_code_combination_id cost_ccid,
       Decode(ei.system_linkage_function,
         ''VI'',Nvl(cdl.cr_code_combination_id, imp.def_supplier_cost_cr_ccid),
         ''ER'',Nvl(cdl.cr_code_combination_id, imp.def_supplier_cost_cr_ccid),
              cdl.cr_code_combination_id) cost_clearing_ccid,
       Decode(Nvl(cdl.acct_source_code, ''UPG''),
         ''UPG'', cdl.dr_code_combination_id,
         ''EXT'', cdl.dr_code_combination_id,
         ''PA'', Decode(Nvl(cdl.line_num_reversed, cdl.parent_line_num),
                 NULL, cdl.dr_code_combination_id,
                 Decode(cdl.parent_line_num,
                   NULL, cdl.dr_code_combination_id,
                   pa_xla_interface_pkg.Get_sla_ccid(
                     275,
       ...
       Decode(Nvl(cdl.acct_source_code, ''UPG''),
         ''UPG'',Decode(ei.system_linkage_function,
                 ''VI'',Nvl(cdl.cr_code_combination_id, imp.def_supplier_cost_cr_ccid),
                 ''ER'',Nvl(cdl.cr_code_combination_id, imp.def_supplier_cost_cr_ccid),
                  cdl.cr_code_combination_id),
         ''EXT'',Decode(ei.system_linkage_function,
                 ''VI'',Nvl(cdl.cr_code_combination_id, imp.def_supplier_cost_cr_ccid),
                 ''ER'',Nvl(cdl.cr_code_combination_id, imp.def_supplier_cost_cr_ccid),
                  cdl.cr_code_combination_id),
         ''RCV'',Nvl(cdl.cr_code_combination_id, imp.def_supplier_cost_cr_ccid),
         ''AP_INV'', Nvl(cdl.cr_code_combination_id, imp.def_supplier_cost_cr_ccid),
         ''AP_PAY'', Nvl(cdl.cr_code_combination_id, imp.def_supplier_cost_cr_ccid),
         ''AP_APP'', Nvl(cdl.cr_code_combination_id, imp.def_supplier_cost_cr_ccid),
         ''PA'',Decode(Nvl(cdl.line_num_reversed, cdl.parent_line_num),
                NULL,Decode(ei.system_linkage_function,
                       ''VI'',Nvl(cdl.cr_code_combination_id,imp.def_supplier_cost_cr_ccid),
                       ''ER'',Nvl(cdl.cr_code_combination_id,imp.def_supplier_cost_cr_ccid),
                            cdl.cr_code_combination_id),
                Decode(cdl.parent_line_num,
                  NULL, Decode(ei.system_linkage_function,
                          ''VI'',Nvl(cdl.cr_code_combination_id,
                                 imp.def_supplier_cost_cr_ccid),
                          ''ER'', Nvl(cdl.cr_code_combination_id,
                                 imp.def_supplier_cost_cr_ccid),
                          cdl.cr_code_combination_id),
                  pa_xla_interface_pkg.Get_sla_ccid(
                    275,
         ...
         pa_xla_interface_pkg.Get_sla_ccid(
           Decode(Nvl(cdl.acct_source_code, ''UPG''),
             ...
             NULL),
           Decode(Nvl(cdl.acct_source_code, ''UPG''),
             ''INV'', cdl.system_reference4,
             ''WIP'', cdl.system_reference4,
             NULL),
           NULL,
           Decode(cdl.acct_source_code,
             ''RCV'', ''RCV_RECEIVING_SUB_LEDGER'',
...
WHERE ei.expenditure_item_id = cdl.expenditure_item_id
AND   ei.expenditure_item_id = ##$$P_EXPENDITURE_ITEM_ID$$##
--AND   cdl.line_num = &Line_Num
AND   imp.org_id = cdl.org_id
ORDER BY cdl.line_num ASC',
      p_title                  => 'Expenditure Distribution not Accounted in Source Module',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Expenditure distribution from an external source to Projects is not finally accounted in the source module.',
      p_solution               => 'In the source module, please verify if the transaction is fully accounted and if not then please run the appropriate accounting processes to finally account the transaction as recommended in below note:<br>
[866310/KB199270] R12 PAXCPGAL & PAXCPCAL - What are the Steps to Generate Asset Lines and Interface them to Oracle Fixed Assets?',
      p_success_msg            => 'The transaction line distribution is fully accounted in the source module.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_EXP_DISTR_ACCOUNTING');



debug('begin add_signature: PA_INVALID_PROJFUNC_CURR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15099',
      p_sig_id                 => 'PA_INVALID_PROJFUNC_CURR',
      p_sig_sql                => 'SELECT * from pa_expenditure_items_all
 WHERE expenditure_item_id = ##$$P_EXPENDITURE_ITEM_ID$$## 
   and COST_DIST_REJECTION_CODE = ''PA_INVALID_PROJFUNC_CURR'' 
   and PROJFUNC_CURRENCY_CODE is NULL',
      p_title                  => 'Invalid Project Functional Currency',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'For this expenditure item, there is missing value for Project Functional Currency Code.',
      p_solution               => 'Apply the solution from [2268095/KB199216].',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_INVALID_PROJFUNC_CURR');



debug('begin add_signature: PA_CANNOT_INSERT_NULL_INTO_COST_DISTRIBUTION_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20759',
      p_sig_id                 => 'PA_CANNOT_INSERT_NULL_INTO_COST_DISTRIBUTION_LINES',
      p_sig_sql                => 'SELECT ei.*
...
',
      p_title                  => 'PASDUC: ORA-1400: CANNOT INSERT NULL INTO PA_COST_DISTRIBUTION_LINES_ALL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Issue found for PASDUC PRC: Distribute Usage and Miscellaneous Costs<br>
Error<br>
--------<br>
ORA-1400: Cannot Insert NULL Into ("PA"."PA_COST_DISTRIBUTION_LINES_ALL"."AMOUNT#1") ',
      p_solution               => '[2771333/KB401309] PASDUC Distribute Usage and Miscellaneous Costs Errors: ORA-01400: Cannot Insert NULL Into ("PA"."PA_COST_DISTRIBUTION_LINES_ALL"."AMOUNT#1")',
      p_success_msg            => 'No issue found for PASDUC PRC: Distribute Usage and Miscellaneous Costs',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_CANNOT_INSERT_NULL_INTO_COST_DISTRIBUTION_LINES');
...
debug('begin add_signature: EBS_FIN_PA_PA_EI_NOT_ACCOUNTED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29467',
      p_sig_id                 => 'EBS_FIN_PA_PA_EI_NOT_ACCOUNTED',
      p_sig_sql                => 'SELECT
...
FROM
    ...
    xla_events                     evt
WHERE
        cdl.acct_event_id = evt.event_id
    AND evt.application_id = 275
    AND evt.event_status_code <> ''P''
    AND cdl.expenditure_item_id = ##$$P_EXPENDITURE_ITEM_ID$$##',
      p_title                  => 'Transaction Not Accounted to GL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The below transaction(s) has not been accounted to the General Ledger.',
      p_solution               => 'Please follow the solution in [2582233/KB495716] EXC: Transaction Exception Detail Showing Costed Transaction Exception "Could not create a valid GL date, Could not create a valid receiver GL date"',
      p_success_msg            => 'Transactions were accounted to the General Ledger.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_EI_NOT_ACCOUNTED');



debug('begin add_signature: EBS_FIN_PA_PAEXPND_PA_PA_EI_ACCOUNTING_PERIOD_CLOSED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29470',
      p_sig_id                 => 'EBS_FIN_PA_PAEXPND_PA_PA_EI_ACCOUNTING_PERIOD_CLOSED',
      p_sig_sql                => 'SELECT
    cdl.expenditure_item_id,
    cdl.transfer_status_code,
    cdl.amount,
...
FROM
   ...
   WHERE
   xae.event_id = xah.event_id
    and    xah.event_id = cdl.acct_event_id
    and cdl.acct_event_id = xae.event_id
   ...
   AND cdl.expenditure_item_id = ##$$P_EXPENDITURE_ITEM_ID$$##
    ...
    AND imp.set_of_books_id = xah.ledger_id
    AND imp.org_id = cdl.org_id
    and xae.MESSAGE_NUMBER = 95325',
      p_title                  => 'Transaction Not Accounted to GL And GL Period Closed ',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The below transaction(s) has not been accounted for in the General Ledger, and the corresponding GL period is closed.',
      p_solution               => 'Please follow the solution in [2374808/KB238218] R12: PAXACCPB: PRC: Create Accounting: How To Resolve "The GL Date Is Not In An Open Or A Future Enterable Period" When The User Does Not Want To Open The Period',
      p_success_msg            => 'Transactions were accounted to the General Ledger.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAEXPND_PA_PA_EI_ACCOUNTING_PERIOD_CLOSED');



debug('begin add_signature: EBS_FIN_PA_PAEXPND_BUR_COST_ADJ_EI_NOT_DISTRIBUTED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23181',
      p_sig_id                 => 'EBS_FIN_PA_PAEXPND_BUR_COST_ADJ_EI_NOT_DISTRIBUTED',
      p_sig_sql                => 'SELECT p.segment1 project_number,
...
AND   p.project_id = ##$$P_PROJECT_ID$$##',
      p_title                  => 'Adjusted Expenditure Item Is Not Cost Distributed',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'PRC: Distribute Total Burdened Cost process errors with ADJ_EI_NOT_DISTRIBUTED ',
      p_solution               => 'Please log Service Request along with expenditure processing analyzer output to get possible data fix based on [2312417/KB198889].',
      p_success_msg            => 'Burden transactions are cost distributed successfully.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAEXPND_BUR_COST_ADJ_EI_NOT_DISTRIBUTED');



debug('begin add_signature: EBS_FIN_PA_PAEXPND_COST_DISTRIBUTION_REJECTION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30402',
      p_sig_id                 => 'EBS_FIN_PA_PAEXPND_COST_DISTRIBUTION_REJECTION',
      p_sig_sql                => 'select ei.COST_DIST_REJECTION_CODE, ei.system_linkage_function, ei.expenditure_item_id, task_id, expenditure_item_date, expenditure_type, cost_distributed_flag, org_id	 from PA_EXPENDITURE_ITEMS_ALL ei
Where ei.COST_DIST_REJECTION_CODE in (''AA_NULL_CCID'',''KEY_FLEX_FAIL'')
AND   ei.expenditure_item_id = NVL(##$$P_EXPENDITURE_ITEM_ID$$##, 0) AND ei.project_id = ##$$P_PROJECT_ID$$##',
      p_title                  => 'Expenditure Item Cost Distribution Rejection',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Records with cost distribution rejection error(s) exist.
',
      p_solution               => 'Review solution in [3059633/KB381601] PRC: Distribute Costs Contains KEY_FLEX_FAIL or AA_NULL_CCID Errors.
',
      p_success_msg            => 'No records with cost distribution rejection error(s) exist.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAEXPND_COST_DISTRIBUTION_REJECTION');



debug('begin add_signature: PA_COST_PROJ_TYPE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10319',
      p_sig_id                 => 'PA_COST_PROJ_TYPE',
      p_sig_sql                => 'select ppt.*,
DECODE(ppt.burden_amt_display_method,''D'',''Separate'', ''S'',''Same'',ppt.burden_amt_display_method) "Burden|Amt|Display|Method" 
...
and pei.expenditure_item_id = ##$$P_EXPENDITURE_ITEM_ID$$##',
      p_title                  => 'Project Type Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No project type information was found for this expenditure item. ',
      p_solution               => '',
      p_success_msg            => 'PA_PROJECT_TYPES_ALL table stores implementation-defined classifications of projects that specify whether a project burdens labor costs and whether the project is
contract, capital or indirect (based on PROJECT_TYPE_CLASS_CODE).',
   ...
   l_info.delete;
debug('end add_signature: PA_COST_PROJ_TYPE');



debug('begin add_signature: PA_COST_PROJ_DATA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10318',
      p_sig_id                 => 'PA_COST_PROJ_DATA',
      p_sig_sql                => 'SELECT *
FROM PA_PROJECTS_ALL
where project_id in (select project_id from pa_expenditure_items_all where Expenditure_Item_Id=##$$P_EXPENDITURE_ITEM_ID$$##)',
      p_title                  => 'Project Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No project information was found for this expenditure item. ',
      p_solution               => '',
      p_success_msg            => 'PA_PROJECTS_ALL stores the highest units of work defined in Oracle Projects at which funding can be allocated and at which revenue, invoices, unbilled receivables, and unearned revenue are generated and maintained. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_PROJ_DATA');



debug('begin add_signature: PA_COST_TASK_DATA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10320',
      p_sig_id                 => 'PA_COST_TASK_DATA',
      p_sig_sql                => 'SELECT task.* ,
  org.name "Carrying Out|Organization" ,
  cost.ind_rate_sch_name "Cost Burden|Schedule" ,
  rev.ind_rate_sch_name "Revenue Burden|Schedule" ,
  rev.cost_plus_structure "Revenue BS|Structure" ,
  inv.ind_rate_sch_name "Invoice Burden|Schedule" ,
  inv.cost_plus_structure "Invoice BS|Structure" ,
  tps1.name "Labor TP|Schedule" ,
  tps2.name "Non Labor|TP Schedule" ,
  emp.std_bill_rate_schedule "Emp|Bill Rate|Schedule" ,
  emp.rate_sch_currency_code "Emp Rate|Sched Currency" ,
  job.std_bill_rate_schedule "Job|Bill Rate|Schedule" ,
  job.rate_sch_currency_code "Job Rate|Sched Currency" ,
  nl.rate_sch_currency_code "Non-Labor Rate|Sched Currency"
FROM PA_TASKS task ,
  PA_IND_RATE_SCHEDULES_ALL_BG cost ,
  PA_IND_RATE_SCHEDULES_ALL_BG rev ,
  PA_IND_RATE_SCHEDULES_ALL_BG inv ,
  PA_CC_TP_SCHEDULES_BG tps1 ,
  PA_CC_TP_SCHEDULES_BG tps2 ,
  HR_ALL_ORGANIZATION_UNITS_VL org ,
  PA_STD_BILL_RATE_SCHEDULES_ALL emp ,
  PA_STD_BILL_RATE_SCHEDULES_ALL job ,
  PA_STD_BILL_RATE_SCHEDULES_ALL nl,
  pa_expenditure_items_all pei
WHERE org.organization_id (+) = task.carrying_out_organization_id
AND cost.ind_rate_sch_id (+)  = task.cost_ind_rate_sch_id
AND inv.ind_rate_sch_id (+)   = task.inv_ind_rate_sch_id
AND rev.ind_rate_sch_id (+)   = task.rev_ind_rate_sch_id
AND tps1.tp_schedule_id (+)   = task.labor_tp_schedule_id
AND tps2.tp_schedule_id (+)   = task.nl_tp_schedule_id
AND emp.bill_rate_sch_id (+)  = task.emp_bill_rate_schedule_id
AND job.bill_rate_sch_id (+)  = task.job_bill_rate_schedule_id
AND nl.bill_rate_sch_id (+)   = task.non_lab_std_bill_rt_sch_id
AND task.project_id           = pei.project_id
and task.task_id               = pei.task_id
and pei.expenditure_item_id = ##$$P_EXPENDITURE_ITEM_ID$$##
ORDER BY task.task_number',
      p_title                  => 'Project Tasks Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No tasks information identified.',
      p_solution               => '',
      p_success_msg            => 'PA_TASKS stores user-defined subdivisions of project work. Tasks can be broken down into multiple levels of subtasks.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_TASK_DATA');
...
debug('begin add_signature: PA_COST_INT_FLAGS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10467',
      p_sig_id                 => 'PA_COST_INT_FLAGS',
      p_sig_sql                => 'SELECT pia.set_of_books_id,
hou.name, 
pia.org_id,
pia.ALLOW_NEGATIVE_ACCRUAL,
pia.INTERFACE_LABOR_TO_GL_FLAG,
pia.XFACE_CWK_LABOR_TO_GL_FLAG,
pia.INTERFACE_USAGE_TO_GL_FLAG,
pia.XFACE_CWK_TIMECARDS_FLAG,
pia.EXP_ORG_STRUCTURE_ID,
pia.EXP_ORG_STRUCTURE_VERSION_ID,
pia.EXP_START_ORG_ID,
pia.SAME_PA_GL_PERIOD,
pia.LAST_UPDATE_DATE,
pia.DEFAULT_RATE_TYPE,                    
pia.DEFAULT_RATE_DATE_CODE
FROM PA_IMPLEMENTATIONS_all pia, hr_all_organization_units hou
WHERE pia.org_id= hou.organization_id
and pia.org_id = ##$$ORG_ID$$##',
      p_title                  => 'Implementation Options - Interface Cost Flags',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No implementation options data found for this expenditure item''s Operating Unit. ',
      p_solution               => '',
      p_success_msg            => 'Cost Interface Flags for the Operating Unit.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_INT_FLAGS');



debug('begin add_signature: PA_COST_EXP_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10329',
      p_sig_id                 => 'PA_COST_EXP_TYPES',
      p_sig_sql                => 'SELECT pet.*
FROM PA_EXPENDITURE_TYPES pet,
     PA_EXPENDITURE_ITEMS_ALL ei
WHERE pet.expenditure_type = ei.expenditure_type
AND ei.expenditure_item_id =  ##$$P_EXPENDITURE_ITEM_ID$$##',
      p_title                  => 'Expenditure Types',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No expenditure type found for this expenditure item.',
      p_solution               => '',
      p_success_msg            => 'PA_EXPENDITURE_TYPES stores the most detailed implementation-defined classifications of expenditures charged to projects and tasks.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_EXP_TYPES');



debug('begin add_signature: PA_COST_SYS_LINK_FUNC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10330',
      p_sig_id                 => 'PA_COST_SYS_LINK_FUNC',
      p_sig_sql                => 'SELECT PSL.*
FROM PA_SYSTEM_LINKAGES PSL,
PA_EXPENDITURE_ITEMS_ALL ei
WHERE PSL.function = ei.SYSTEM_LINKAGE_FUNCTION
and ei.expenditure_item_id = ##$$P_EXPENDITURE_ITEM_ID$$##',
      p_title                  => 'System Linkage Function',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found from PA_SYSTEM_LINKAGES for this expenditure item.',
      p_solution               => '',
      p_success_msg            => 'PA_SYSTEM_LINKAGES stores system-defined categories used to determine how items should be processed. <br>
Examples of system linkages (Expenditure Type Classes) are: Expense Report, Usages, and Straight Time. ',
   ...
   l_info.delete;
debug('end add_signature: PA_COST_SYS_LINK_FUNC');



debug('begin add_signature: PA_COST_EXP_COA_DYM_INS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10516',
      p_sig_id                 => 'PA_COST_EXP_COA_DYM_INS',
      p_sig_sql                => 'SELECT hra.name || ''(''||imp.org_id ||'')''"Operating Unit (org_id)"
     ,      structV.id_flex_structure_name ||''('' ||struct.id_flex_num ||'')'' "Chart of Accts Name(flex_num)"
     ,      flex.dynamic_inserts_feasible_flag "Dynamic Inserts Feasible"
     ,      struct.dynamic_inserts_allowed_flag "Dynamic Inserts Allowed"
       FROM   FND_ID_FLEXS flex 
     ,      FND_ID_FLEX_STRUCTURES struct 
     ,      FND_ID_FLEX_STRUCTURES_TL structV 
     ,      PA_IMPLEMENTATIONS_ALL imp 
     ,      GL_SETS_OF_BOOKS sob,
     HR_ALL_ORGANIZATION_UNITS  hra
     WHERE  flex.id_flex_code = ''GL#'' 
     AND    flex.application_id = struct.application_id 
     AND    flex.id_flex_code = struct.id_flex_code 
     AND    structV.id_flex_code = struct.id_flex_code 
     AND    structV.id_flex_num = struct.id_flex_num 
     AND    struct.id_flex_num = sob.chart_of_accounts_id 
     AND    sob.set_of_books_id = imp.set_of_books_id 
     AND    (nvl(flex.dynamic_inserts_feasible_flag, ''N'') != ''Y'' 
             OR nvl(struct.dynamic_inserts_allowed_flag, ''N'') != ''Y'')
    AND     hra.ORGANIZATION_ID  = imp.org_id
     ORDER BY imp.org_id',
      p_title                  => 'Chart of Accounts - Dynamic Insertion',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Dynamic inserts is enabled for all ledgers used by Projects.',
      p_solution               => '',
      p_success_msg            => 'Dynamic inserts is not enabled for all ledgers used by Projects.',
   ...
   l_info.delete;
debug('end add_signature: PA_COST_EXP_COA_DYM_INS');



debug('begin add_signature: PA_COST_EXP_GROUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10307',
      p_sig_id                 => 'PA_COST_EXP_GROUP',
      p_sig_sql                => 'SELECT DISTINCT 
  eg.* 
FROM PA_EXPENDITURES_ALL e ,
  PA_EXPENDITURE_ITEMS_ALL ei ,
...
AND ei.expenditure_id        = e.expenditure_id
AND eg.EXPENDITURE_GROUP     = e.EXPENDITURE_GROUP',
      p_title                  => 'Expenditure Group',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'An expenditure group does not exist for this expenditure item and project. ',
      p_solution               => '',
      p_success_msg            => 'PA_EXPENDITURE_GROUPS_ALL stores groups or batches of pre-approved expenditures entered by a user.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_EXP_GROUP');



debug('begin add_signature: PA_COST_EXP_DETAILS');
   l_info('##MASK##INCURRED_BY_PERSON'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10306',
      p_sig_id                 => 'PA_COST_EXP_DETAILS',
      p_sig_sql                => 'SELECT DISTINCT f.full_name "Incurred_by_Person" ,
  e.* ,
  org.name "Incurred_by_Organization"
FROM PA_EXPENDITURES_ALL e ,
  PA_EXPENDITURE_ITEMS_ALL ei ,
  PER_ALL_PEOPLE_F f ,
  HR_ALL_ORGANIZATION_UNITS_VL org
WHERE  ei.expenditure_item_id     = ##$$P_EXPENDITURE_ITEM_ID$$##
AND ei.expenditure_id        = e.expenditure_id
AND f.person_id (+)          = e.incurred_by_person_id
AND f.effective_end_date (+) > sysdate
AND org.organization_id (+)  = e.incurred_by_organization_id
ORDER BY e.expenditure_id',
      p_title                  => 'Expenditures',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PA_EXPENDITURES_ALL table for this expenditure item.',
      p_solution               => '',
      p_success_msg            => 'These are the expenditures incurred by an employee or an organization for the expenditure item '||mask_text(g_expenditure_item_id, nvl( upper(''), 'NO_MASK') )||'. 
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_EXP_DETAILS');



debug('begin add_signature: PA_COST_EXP_ITEM_DETAILS');
   l_info('##MASK##ATTRIBUTE1'):= 'MASK_ALPHANUMERIC';
   l_info('##MASK##ATTRIBUTE10'):= 'MASK_ALPHANUMERIC';
   l_info('##MASK##ATTRIBUTE2'):= 'MASK_ALPHANUMERIC';
   l_info('##MASK##ATTRIBUTE3'):= 'MASK_ALPHANUMERIC';
   l_info('##MASK##ATTRIBUTE4'):= 'MASK_ALPHANUMERIC';
   l_info('##MASK##ATTRIBUTE5'):= 'MASK_ALPHANUMERIC';
   l_info('##MASK##ATTRIBUTE6'):= 'MASK_ALPHANUMERIC';
   l_info('##MASK##ATTRIBUTE7'):= 'MASK_ALPHANUMERIC';
   l_info('##MASK##ATTRIBUTE8'):= 'MASK_ALPHANUMERIC';
   l_info('##MASK##ATTRIBUTE9'):= 'MASK_ALPHANUMERIC';
   l_info('##MASK##ATTRIBUTE_CATEGORY'):= 'MASK_ALPHANUMERIC';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10305',
      p_sig_id                 => 'PA_COST_EXP_ITEM_DETAILS',
      p_sig_sql                => 'SELECT ei.*  FROM   PA_EXPENDITURE_ITEMS_ALL   ei  
WHERE ei.expenditure_item_id  = NVL(##$$P_EXPENDITURE_ITEM_ID$$##, ei.expenditure_item_id)
AND ei.project_id = ##$$P_PROJECT_ID$$##',
      p_title                  => 'Expenditure Items',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PA_EXPENDITURE_ITEMS_ALL for this expenditure item.',
      p_solution               => '',
      p_success_msg            => 'PA_EXPENDITURE_ITEMS_ALL stores the smallest categorized expenditure units charged to projects and tasks.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_EXP_ITEM_DETAILS');



debug('begin add_signature: PA_COST_DIST_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10308',
      p_sig_id                 => 'PA_COST_DIST_LINES',
      p_sig_sql                => 'SELECT cdl.* ,
  NVL(lookup.meaning,''Null'') "Transfer|Status|Code"
FROM PA_COST_DISTRIBUTION_LINES_ALL cdl ,
  PA_LOOKUPS lookup
WHERE lookup.lookup_type        = ''TRANSFER STATUS''
AND cdl.expenditure_item_id     = NVL(##$$P_EXPENDITURE_ITEM_ID$$##,cdl.expenditure_item_id)
AND cdl.project_id = ##$$P_PROJECT_ID$$##
AND cdl.transfer_status_code  = lookup.lookup_code (+)
ORDER BY cdl.line_num',
      p_title                  => 'Cost Distribution Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Cost is not yet distributed for this expenditure item.',
      p_solution               => '',
      p_success_msg            => 'PA_COST_DISTRIBUTION_LINES_ALL stores information about the cost distribution of expenditure items. When a cost distribution program processes an expenditure item, it creates one or more corresponding cost distribution lines to hold the cost amounts and the general ledger account information to which the cost amounts will post. Cost distribution lines amount are implicitly debit amounts.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_DIST_LINES');



debug('begin add_signature: PA_COST_EXP_ITEM_ALL_ADJ');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15082',
      p_sig_id                 => 'PA_COST_EXP_ITEM_ALL_ADJ',
      p_sig_sql                => 'select distinct * from pa_expenditure_items_all
start with EXPENDITURE_ITEM_ID = ##$$P_EXPENDITURE_ITEM_ID$$##
connect by nocycle EXPENDITURE_ITEM_ID =  prior TRANSFERRED_FROM_EXP_ITEM_ID
or prior EXPENDITURE_ITEM_ID =  TRANSFERRED_FROM_EXP_ITEM_ID
or EXPENDITURE_ITEM_ID = prior ADJUSTED_EXPENDITURE_ITEM_ID
or prior EXPENDITURE_ITEM_ID = ADJUSTED_EXPENDITURE_ITEM_ID',
      p_title                  => 'Expenditure Item - All Adjustments',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No adjusted or transferred expenditure items found.',
      p_solution               => '',
      p_success_msg            => ' Adjusted or transferred expenditure items found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_EXP_ITEM_ALL_ADJ');



debug('begin add_signature: PA_COST_EXP_ITEM_ADJ_ACT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10310',
      p_sig_id                 => 'PA_COST_EXP_ITEM_ADJ_ACT',
      p_sig_sql                => 'select * from pa_expend_item_adj_activities
where expenditure_item_id = ##$$P_EXPENDITURE_ITEM_ID$$## 
order by ACTIVITY_DATE desc, LAST_UPDATE_LOGIN',
      p_title                  => 'Expenditure Item Adjustment Activities',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data in PA_EXPEND_ITEM_ADJ_ACTIVITIES for the given project and expenditure item.',
      p_solution               => '',
      p_success_msg            => 'PA_EXPEND_ITEM_ADJ_ACTIVITIES stores audit records of actions chosen by users in any of the Oracle Projects expenditure adjustment windows that may cause adjustments to the cost, revenue, and/or invoice amounts of an expenditure item.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_EXP_ITEM_ADJ_ACT');



debug('begin add_signature: PA_EXP_ADJUSTMENT_ACTIVITIES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13569',
      p_sig_id                 => 'PA_EXP_ADJUSTMENT_ACTIVITIES',
...
FROM pa_expend_item_adj_activities adj, fnd_concurrent_programs cp, fnd_concurrent_programs_vl cpt 
 WHERE adj.expenditure_item_id = ##$$P_EXPENDITURE_ITEM_ID$$## 
...
ORDER BY adj.activity_date',
      p_title                  => 'Adjusted Expenditure Item',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no adjustment activities.',
      p_solution               => '',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: PA_EXP_ADJUSTMENT_ACTIVITIES');



debug('begin add_signature: PA_COST_ADJ_EXP_ITEMS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10312',
      p_sig_id                 => 'PA_COST_ADJ_EXP_ITEMS',
      p_sig_sql                => 'SELECT ei.*
FROM PA_EXPENDITURE_ITEMS_ALL ei
WHERE ei.expenditure_item_id in
  ...
  WHERE expenditure_item_id=##$$P_EXPENDITURE_ITEM_ID$$##
      ...
      p_title                  => 'Adjusted Expenditure Item',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Adjusted Expenditure Items do not exist for this expenditure item. ',
      p_solution               => '',
      p_success_msg            => 'PA_EXPENDITURE_ITEMS_ALL stores expenditure items and adjusted expenditure items information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_ADJ_EXP_ITEMS');



debug('begin add_signature: PA_COST_TRANSFER_FRM_EXP_ITEMS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10313',
      p_sig_id                 => 'PA_COST_TRANSFER_FRM_EXP_ITEMS',
      p_sig_sql                => 'SELECT ei.*
FROM PA_EXPENDITURE_ITEMS_ALL ei
WHERE ei.expenditure_item_id in
  (SELECT TRANSFERRED_FROM_EXP_ITEM_ID 
  FROM PA_EXPENDITURE_ITEMS_ALL PEI
  WHERE expenditure_item_id=##$$P_EXPENDITURE_ITEM_ID$$##
   )',
      p_title                  => 'Transferred Expenditure Item',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Transferred Expenditure Item detected.',
      p_solution               => '',
      p_success_msg            => 'PA_EXPENDITURE_ITEMS_ALL table stores expenditure items and split expenditure items information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_TRANSFER_FRM_EXP_ITEMS');



debug('begin add_signature: PA_COST_EXP_HISTORY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10314',
      p_sig_id                 => 'PA_COST_EXP_HISTORY',
      p_sig_sql                => 'SELECT hist.*
FROM PA_EXPENDITURE_HISTORY hist
WHERE hist.expenditure_id IN
  (SELECT expenditure_id FROM PA_EXPENDITURE_ITEMS_ALL ei 
WHERE ei.expenditure_item_id=##$$P_EXPENDITURE_ITEM_ID$$##
)',
      p_title                  => 'Expenditure History',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Expenditure history does not exist for this expenditure item.',
      p_solution               => '',
      p_success_msg            => 'PA_EXPENDITURE_HISTORY is normalized representation of PA_EI_DENORM, primarily used for storing audit information for timecards created via Oracle Self-Service Time.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_EXP_HISTORY');



debug('begin add_signature: PA_COST_EXP_COMMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10315',
      p_sig_id                 => 'PA_COST_EXP_COMMENTS',
      p_sig_sql                => 'SELECT comments.*
FROM PA_EXPENDITURE_COMMENTS comments
WHERE comments.expenditure_item_id = ##$$P_EXPENDITURE_ITEM_ID$$##',
      p_title                  => 'Expenditure Comments',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Expenditure comments do not exist for this expenditure item.',
      p_solution               => '',
      p_success_msg            => 'PA_EXPENDITURE_COMMENTS stores free text comments associated with expenditure items that describe the work performed for those items.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_EXP_COMMENTS');



debug('begin add_signature: PA_COST_EXP_ITEM_DENORM');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10317',
      p_sig_id                 => 'PA_COST_EXP_ITEM_DENORM',
      p_sig_sql                => 'SELECT * 
FROM PA_EI_DENORM denorm 
WHERE denorm.expenditure_id IN 
(SELECT expenditure_id FROM PA_EXPENDITURE_ITEMS_ALL ei
WHERE ei.expenditure_item_id=##$$P_EXPENDITURE_ITEM_ID$$##)',
      p_title                  => 'Expenditure Item Denormalised',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in the PA_EI_DENORM table for this expenditure item.',
      p_solution               => '',
      p_success_msg            => 'PA_EI_DENORM table is the denormalized representation of the PA_EXPENDITURE_ITEMS_ALL table, primarily used by the Self-Service Time module to enable matrix time entry.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_EXP_ITEM_DENORM');



debug('begin add_signature: PA_COST_TRANSACTION_SOURCE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10322',
      p_sig_id                 => 'PA_COST_TRANSACTION_SOURCE',
      p_sig_sql                => 'SELECT pts.*
FROM PA_TRANSACTION_SOURCES pts,
     PA_EXPENDITURE_ITEMS_ALL ei
WHERE pts.transaction_source = ei.transaction_source
AND ei.expenditure_item_id = ##$$P_EXPENDITURE_ITEM_ID$$##',
      p_title                  => 'Transaction Sources',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No transaction source information found for this expenditure item.',
      p_solution               => '',
      p_success_msg            => 'PA_TRANSACTION_SOURCES stores implementation-defined classifications for transactions originating in an external system and imported into Oracle Projects via the Transaction Import program',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_TRANSACTION_SOURCE');



debug('begin add_signature: OTL_PA_TIMECARD_COMPARE');
   l_info('##MASK##SUM.RESOURCE_ID'):= 'DISPLAY_FIRST_4_CHAR';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12445',
      p_sig_id                 => 'OTL_PA_TIMECARD_COMPARE',
      p_sig_sql                => 'SELECT det.time_building_block_id,
  det.object_version_number,
  sum.resource_id,
  exp.orig_transaction_reference,
  exp.transaction_source ,
  exp.expenditure_id,
  exp.expenditure_item_id ,
  day.start_time otl_day,
  exp.expenditure_item_date ,
  DECODE(TO_CHAR(det.date_to, ''DD-MON-YYYY''), ''31-DEC-4712'', ''ACTIVE'', ''INACTIVE'') OTL_STATE ,
  det.measure otl_hours,
  exp.quantity ,
  att.attribute1 otl_project_id,
  exp.project_id ,
  att.attribute2 otl_task_id,
  exp.task_id ,
  att.attribute3 otl_expenditure_type,
...
WHERE exp.expenditure_item_id           = ##$$P_EXPENDITURE_ITEM_ID$$##
...
AND det.time_building_block_id
  || '':''
  || det.object_version_number = exp.orig_transaction_reference (+)
ORDER BY day.start_time,
  det.time_building_block_id,
  object_version_number',
      p_title                  => 'OTL/PA Details Compare',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No details found.',
      p_solution               => '',
      p_success_msg            => 'This section lists the OTL and PA details compare.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: OTL_PA_TIMECARD_COMPARE');



debug('begin add_signature: PA_EXP_INVENTORY_TRX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12444',
      p_sig_id                 => 'PA_EXP_INVENTORY_TRX',
      p_sig_sql                => 'SELECT ei.expenditure_item_id,
  t.transaction_id,
  t.SOURCE_PROJECT_ID,
  t.SOURCE_TASK_ID,
  t.PA_EXPENDITURE_ORG_ID,
  t.inventory_item_id,
  t.organization_id,
  t.acct_period_id,
  t.transaction_date,
...
WHERE ei.transaction_source LIKE ''Inventory%''
AND ei.orig_transaction_reference = TO_CHAR(t.transaction_id)
AND ei.expenditure_item_id = ##$$P_EXPENDITURE_ITEM_ID$$##',
      p_title                  => 'Inventory Transaction Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No inventory transaction details available.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PA_EXP_INVENTORY_TRX');



debug('begin add_signature: PA_COST_HR_ORGANIZATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10323',
      p_sig_id                 => 'PA_COST_HR_ORGANIZATION',
      p_sig_sql                => 'SELECT hrorg.* ,
  bsorg.name "Business|Group|Name" ,
  bsorg.date_from "Bus Group|Date From" ,
  bsorg.date_to "Bus Group|Date To"
FROM HR_ALL_ORGANIZATION_UNITS hrorg ,
  HR_ALL_ORGANIZATION_UNITS bsorg,
  pa_expenditures_all pea,
  pa_expenditure_items_all pei
WHERE hrorg.organization_id = pea.incurred_by_organization_id
AND pea.expenditure_id = pei.expenditure_id
AND pei.expenditure_item_id = ##$$P_EXPENDITURE_ITEM_ID$$##
AND hrorg.business_group_id = bsorg.organization_id (+)',
      p_title                  => 'HR Organizations',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No HR Organization information found for this expenditure item.',
      p_solution               => '',
      p_success_msg            => 'HR_ALL_ORGANIZATION_UNITS holds the definitions that identify business groups and the organization units within a single business group.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_HR_ORGANIZATION');



debug('begin add_signature: PA_COST_PERSON_INFO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10324',
      p_sig_id                 => 'PA_COST_PERSON_INFO',
      p_sig_sql                => 'SELECT distinct person.PERSON_ID ,
  org.name "Business|Group|Name"
FROM PER_PEOPLE_F person ,
  HR_ORGANIZATION_UNITS org,
  pa_expenditures_all pea,
  pa_expenditure_items_all PEI
WHERE person.person_id       = pea.incurred_by_person_id
AND person.business_group_id = org.organization_id (+) 
AND pea.expenditure_id       = pei.expenditure_id
AND PEI.expenditure_item_id  =##$$P_EXPENDITURE_ITEM_ID$$##',
      p_title                  => 'Expenditure Item Person Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No incurred by person information found for this expenditure item. ',
      p_solution               => '',
      p_success_msg            => 'Information for the person which incurred the expenditure (i.e. pa_expenditures_all.incurred_by_person_id).',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_PERSON_INFO');



debug('begin add_signature: PA_COST_XLA_EVENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10332',
      p_sig_id                 => 'PA_COST_XLA_EVENTS',
      p_sig_sql                => 'SELECT XE.*
FROM XLA_EVENTS XE,
     PA_COST_DISTRIBUTION_LINES_ALL CDL
...
AND CDL.expenditure_item_id = ##$$P_EXPENDITURE_ITEM_ID$$##',
      p_title                  => 'XLA Events',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in XLA_EVENTS for this expenditure item.',
      p_solution               => '',
      p_success_msg            => 'XLA_EVENTS contains sub-ledger level accounting event information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_XLA_EVENTS');



debug('begin add_signature: PA_COST_XLA_TRANS_ENTITIES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10333',
      p_sig_id                 => 'PA_COST_XLA_TRANS_ENTITIES',
      p_sig_sql                => 'SELECT XTE.* 
FROM XLA_TRANSACTION_ENTITIES XTE,
     PA_EXPENDITURE_ITEMS_ALL   ei       
WHERE SOURCE_ID_INT_1 = ei.expenditure_item_id
AND ei.expenditure_item_id = ##$$P_EXPENDITURE_ITEM_ID$$##',
      p_title                  => 'XLA Transaction Entities',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in XLA_TRANSACTION_ENTITIES for this expenditure item.',
      p_solution               => '',
      p_success_msg            => 'XLA_ENTITIES contains information about sub-ledger document or transactions.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_XLA_TRANS_ENTITIES');



debug('begin add_signature: PA_COST_XLA_AE_HEADERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10334',
      p_sig_id                 => 'PA_COST_XLA_AE_HEADERS',
      p_sig_sql                => 'SELECT xae.*
FROM XLA_AE_HEADERS xae,
PA_COST_DISTRIBUTION_LINES_ALL cdl
WHERE xae.EVENT_ID = cdl.ACCT_EVENT_ID
AND cdl.expenditure_item_id = ##$$P_EXPENDITURE_ITEM_ID$$##',
      p_title                  => 'XLA AE Headers',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in XLA_AE_HEADERS for this expenditure item.',
      p_solution               => '',
      p_success_msg            => 'XLA_AE_HEADERS table stores subledger journal entries. There is a one-to-many relationship between accounting events and journal entry headers.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_XLA_AE_HEADERS');



debug('begin add_signature: PA_COST_XLA_AE_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10335',
      p_sig_id                 => 'PA_COST_XLA_AE_LINES',
      p_sig_sql                => '--Modified - 10/20/22
SELECT xal.* 
FROM  XLA_AE_LINES xal 
where  xal.AE_HEADER_ID  
in (SELECT xah.AE_HEADER_ID FROM XLA_AE_HEADERS xah WHERE xah.EVENT_ID 
in (SELECT  ACCT_EVENT_ID FROM PA_COST_DISTRIBUTION_LINES_ALL cdl 
...
AND cdl.expenditure_item_id = ##$$P_EXPENDITURE_ITEM_ID$$##
*/',
      p_title                  => 'XLA AE Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in XLA_AE_LINES for this expenditure item.
',
      p_solution               => '',
      p_success_msg            => 'XLA_AE_LINES table stores the subledger journal entry lines.<br>
There is a one-to-many relationship between subledger journal entry headers and subledger journal entry lines.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_XLA_AE_LINES');



debug('begin add_signature: PA_COST_XLA_DIST_LINKS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10336',
      p_sig_id                 => 'PA_COST_XLA_DIST_LINKS',
      p_sig_sql                => 'SELECT xdl.*
FROM XLA_DISTRIBUTION_LINKS xdl
WHERE xdl.EVENT_ID in (SELECT cdl.ACCT_EVENT_ID
FROM PA_COST_DISTRIBUTION_LINES_ALL cdl
WHERE cdl.expenditure_item_id = ##$$P_EXPENDITURE_ITEM_ID$$##)',
      p_title                  => 'XLA Distribution Links',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in XLA_DISTRIBUTION_LINKS for this expenditure item.
',
      p_solution               => '',
      p_success_msg            => 'XLA_DISTRIBUTION_LINKS table stores the link between transactions and subledger journal entry lines.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_XLA_DIST_LINKS');



debug('begin add_signature: PA_COST_XLA_ACCT_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10337',
      p_sig_id                 => 'PA_COST_XLA_ACCT_ERRORS',
      p_sig_sql                => 'SELECT xae.*
FROM xla_accounting_errors xae,
    PA_COST_DISTRIBUTION_LINES_ALL cdl
WHERE xae.EVENT_ID  = cdl.ACCT_EVENT_ID
AND cdl.expenditure_item_id = ##$$P_EXPENDITURE_ITEM_ID$$##',
      p_title                  => 'XLA Accounting ENCODED_MSG',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No XLA Accounting errors found for this expenditure item.',
      p_solution               => '',
      p_success_msg            => 'XLA_ACCOUNTING_ERRORS contains sub-ledger accounting error information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_XLA_ACCT_ERRORS');



debug('begin add_signature: PA_COST_TIME_CARD_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10517',
      p_sig_id                 => 'PA_COST_TIME_CARD_DETAILS',
      p_sig_sql                => 'SELECT e.expenditure_item_id ,
...
WHERE e.expenditure_item_id = ##$$P_EXPENDITURE_ITEM_ID$$##
AND e.TRANSACTION_SOURCE     = ''ORACLE TIME AND LABOR''
AND det.TIME_BUILDING_BLOCK_ID
  ||'':''
  ||det.OBJECT_VERSION_NUMBER = e.ORIG_TRANSACTION_REFERENCE
AND det.scope                 = ''DETAIL''
AND day.TIME_BUILDING_BLOCK_ID
  ||'':''
  ||day.OBJECT_VERSION_NUMBER = det.PARENT_BUILDING_BLOCK_ID
  ||'':''
  ||det.PARENT_BUILDING_BLOCK_OVN
AND day.scope = ''DAY''
AND tc.TIME_BUILDING_BLOCK_ID
  ||'':''
  ||tc.OBJECT_VERSION_NUMBER = day.PARENT_BUILDING_BLOCK_ID
  ||'':''
  ||day.PARENT_BUILDING_BLOCK_OVN
AND tc.scope                  = ''TIMECARD''
AND tc.TIME_BUILDING_BLOCK_ID = ts.TIMECARD_ID
AND tc.OBJECT_VERSION_NUMBER  = ts.TIMECARD_OVN',
      p_title                  => 'Time Card Details from Expenditure',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Time card details do not exist for this expenditure item.',
      p_solution               => 'HXC_TIMECARD_SUMMARY table denormalizes data about timecards for performance purposes. It also enables the entry level approval functionality.',
      p_success_msg            => 'Time card details exist for the expenditure item.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_TIME_CARD_DETAILS');



debug('begin add_signature: PAXTRIMP_MODIFY_INTERFACE_FLAG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15005',
      p_sig_id                 => 'PAXTRIMP_MODIFY_INTERFACE_FLAG',
      p_sig_sql                => 'select distinct tia.batch_name from PA_TRANSACTION_INTERFACE_ALL tia 
where tia.transaction_source in 
    (select ts.transaction_source from PA_TRANSACTION_SOURCES ts 
where modify_interface_flag = ''Y'')',
      p_title                  => 'Cannot correct rejected transaction in Review Transactions form',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are transactions with source which does not have the "Allow Interface Modifications" option enabled, therefore user cannot correct it in Review Transactions form (PAXTRIMP).',
      p_solution               => 'Enable the "Allow Interface Modifications" option in the Setup > Expenditures > Transaction Sources form for your transaction source.<br>
Reference: [116581/FAQ3120#aref_section23]',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PAXTRIMP_MODIFY_INTERFACE_FLAG');



debug('begin add_signature: PA_TXN_ACCUM');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13723',
      p_sig_id                 => 'PA_TXN_ACCUM',
      p_sig_sql                => 'SELECT pta.project_id,
               pta.i_tot_billable_raw_cost,
               pta.i_tot_billable_burdened_cost,
               pta.i_tot_raw_cost,
               pta.i_tot_burdened_cost
FROM pa_txn_accum pta
WHERE pta.project_id = ##$$PROJECT_ID$$##
    AND  pta.actual_cost_rollup_flag = ''Y''
',
      p_title                  => 'Project Transaction Accumulation',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data in PA_TXN_ACCUM for Project ID ##$$PROJECT_ID$$##

',
      p_solution               => '',
      p_success_msg            => 'PA_TXN_ACCUM stores the lowest level of summarization which is the base for project summary amounts.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_TXN_ACCUM');



debug('begin add_signature: PA_PROJECT_ACCUM_ACTUALS_HEADERS_SUMMARIZATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13722',
      p_sig_id                 => 'PA_PROJECT_ACCUM_ACTUALS_HEADERS_SUMMARIZATION',
      p_sig_sql                => 'SELECT a.*,
h.sum_exception_code 
FROM
...
',
      p_title                  => 'Cost And Revenue Accumulated Amounts Summarization ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data in PA_PROJECT_ACCUM_ACTUALS_HEADERS_Summarization for Project ID ##$$PROJECT_ID$$##

',
      p_solution               => '',
      p_success_msg            => 'PA_PROJECT_ACCUM_ACTUALS_HEADERS stores the summary records for cost and revenue for each combination of project_id, task_id and resource_list_member_id.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_PROJECT_ACCUM_ACTUALS_HEADERS_SUMMARIZATION');



debug('begin add_signature: PA_CINT_EXP_TYPE_EXCL_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13720',
      p_sig_id                 => 'PA_CINT_EXP_TYPE_EXCL_ALL',
      p_sig_sql                => 'SELECT * 
FROM PA_CINT_EXP_TYPE_EXCL_ALL EXCL 
WHERE EXCL.IND_COST_CODE IN (
  SELECT CODE.IND_COST_CODE
  FROM PA_IND_COST_CODES CODE 
  WHERE CODE.IND_COST_CODE_USAGE LIKE ''CAPITALIZED_INTEREST'')
ORDER BY EXCL.IND_COST_CODE 
',
      p_title                  => 'Capitalized Interest Expenditure Type Exclusions (PA_CINT_EXP_TYPE_EXCL_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Capitalized interest expenditure type exclusions do not exist.',
      p_solution               => '',
      p_success_msg            => 'Capitalized interest expenditure type exclusions exist.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_CINT_EXP_TYPE_EXCL_ALL');



debug('begin add_signature: PA_CINT_RATE_INFO_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13719',
      p_sig_id                 => 'PA_CINT_RATE_INFO_ALL',
      p_sig_sql                => 'SELECT * 
FROM PA_CINT_RATE_INFO_ALL RATE 
WHERE RATE.IND_COST_CODE IN (
  SELECT CODE.IND_COST_CODE 
  FROM PA_IND_COST_CODES CODE
  WHERE CODE.IND_COST_CODE_USAGE LIKE ''CAPITALIZED_INTEREST'')
and org_id = ##$$ORG_ID$$##
ORDER BY RATE.IND_COST_CODE  
',
      p_title                  => 'Capitalized Interest Rate Information (PA_CINT_RATE_INFO_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No capitalized interest rate information exists for the project.',
      p_solution               => '',
      p_success_msg            => 'Capitalized interest rate information exists for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_CINT_RATE_INFO_ALL');



debug('begin add_signature: PA_DRAFT_REVENUES_ALL_FROM_PA_CUST_REV_DIST_LINES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14207',
      p_sig_id                 => 'PA_DRAFT_REVENUES_ALL_FROM_PA_CUST_REV_DIST_LINES_ALL',
      p_sig_sql                => 'SELECT dr.* 
FROM PA_DRAFT_REVENUES_ALL dr 
WHERE (dr.project_id, dr.draft_revenue_num) 
IN (
 SELECT rdl.project_id, rdl.draft_revenue_num 
 FROM PA_CUST_REV_DIST_LINES_ALL rdl WHERE rdl.expenditure_item_id = ##$$P_EXPENDITURE_ITEM_ID$$##) 
ORDER BY dr.draft_revenue_num',
      p_title                  => 'Revenue Distribution Of Expenditure Item',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no revenue generated for the expenditure item.',
      p_solution               => '',
      p_success_msg            => 'PA_DRAFT_REVENUES_ALL stores the draft revenues generated for a project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_DRAFT_REVENUES_ALL_FROM_PA_CUST_REV_DIST_LINES_ALL');



debug('begin add_signature: PA_COST_REV_DIST_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10311',
      p_sig_id                 => 'PA_COST_REV_DIST_LINES',
      p_sig_sql                => 'SELECT *  
 FROM     PA_CUST_REV_DIST_LINES_ALL rdl  
 WHERE    rdl.expenditure_item_id     = ##$$P_EXPENDITURE_ITEM_ID$$##
 ORDER BY rdl.draft_revenue_num',
      p_title                  => 'Revenue Distribution Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Revenue is not distributed for this expenditure item.',
      p_solution               => '',
      p_success_msg            => 'PA_CUST_REV_DIST_LINES_ALL stores information about the revenue distribution of expenditure item.<br>
When Generate Draft Revenue processes an expenditure item, it creates one or more corresponding revenue distribution lines to hold the revenue amounts and the General Ledger information to which these revenue amounts will post.<br>
Revenue distribution line amounts are implicitly credit amounts.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_REV_DIST_LINES');



debug('begin add_signature: EBS_FIN_PA_PAEXPND_BATCH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24464',
      p_sig_id                 => 'EBS_FIN_PA_PAEXPND_BATCH',
      p_sig_sql                => 'select * 
from PA_EXPENDITURES_ALL ea1 
where ea1.expenditure_group = 
    (select ea2.expenditure_group 
     from PA_EXPENDITURES_ALL ea2 
     where ea2.expenditure_id in 
          (select ei.expenditure_id 
           from PA_EXPENDITURE_ITEMS_ALL ei 
           where ei.expenditure_item_id = ##$$P_EXPENDITURE_ITEM_ID$$##))',
      p_title                  => 'Expenditure Batch Items',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No information was provided for the Expenditure Item Id.',
      p_solution               => 'Expenditure Batch Items',
      p_success_msg            => 'Details of Expenditure Batch Items.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAEXPND_BATCH');



debug('begin add_signature: PA_COST_HIE_XLA_ACCOUNTING_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10491',
      p_sig_id                 => 'PA_COST_HIE_XLA_ACCOUNTING_ERRORS',
      p_sig_sql                => 'SELECT *
FROM XLA_ACCOUNTING_ERRORS
WHERE APPLICATION_ID = 275
and EVENT_ID in (select acct_event_id from pa_cost_distribution_lines_all 
where EXPENDITURE_ITEM_ID in (select EXPENDITURE_ITEM_ID from pa_expenditure_items_all
start with EXPENDITURE_ITEM_ID = ##$$P_EXPENDITURE_ITEM_ID$$##
connect by nocycle EXPENDITURE_ITEM_ID =  prior TRANSFERRED_FROM_EXP_ITEM_ID
or prior EXPENDITURE_ITEM_ID =  TRANSFERRED_FROM_EXP_ITEM_ID
or EXPENDITURE_ITEM_ID = prior ADJUSTED_EXPENDITURE_ITEM_ID
or prior EXPENDITURE_ITEM_ID = ADJUSTED_EXPENDITURE_ITEM_ID)
group by acct_event_id)',
      p_title                  => 'Expenditure Hierarchy Sub-Ledger Accounting Errors',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Accounting errors found for adjustment and transfer items related to the expenditure item '||mask_text(g_expenditure_item_id, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => '',
      p_success_msg            => 'No accounting errors found for adjustment and transfer items related to the expenditure item '||mask_text(g_expenditure_item_id, nvl( upper(''), 'NO_MASK') )||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_HIE_XLA_ACCOUNTING_ERRORS');



debug('begin add_signature: PA_COST_EXP_TYPE_ACTIVE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9726',
      p_sig_id                 => 'PA_COST_EXP_TYPE_ACTIVE',
      p_sig_sql                => 'SELECT PPA.SEGMENT1 "Project_Number",
  PPA.NAME "Project_Name",
  PET.EXPENDITURE_TYPE,
  PTI.EXPENDITURE_ITEM_DATE,
  PET.START_DATE_ACTIVE,
  PET.END_DATE_ACTIVE,
  PTI.TRANSACTION_STATUS_CODE,
  PTI.TRANSACTION_REJECTION_CODE
FROM PA_TRANSACTION_INTERFACE_ALL PTI,
  PA_EXPENDITURE_TYPES PET,
  PA_PROJECTS_ALL PPA
WHERE PTI.EXPENDITURE_TYPE             = PET.EXPENDITURE_TYPE
AND(PTI.PROJECT_ID                     = PPA.PROJECT_ID
OR PPA.SEGMENT1                        = PTI.PROJECT_NUMBER)
AND PPA.PROJECT_ID                     = ##$$PROJECT_ID$$##
AND (TRUNC(PTI.EXPENDITURE_ITEM_DATE) >=TRUNC( PET.END_DATE_ACTIVE)
OR TRUNC(PTI.EXPENDITURE_ITEM_DATE)   <=TRUNC(PET.START_DATE_ACTIVE))
AND ROWNUM                            <=30',
      p_title                  => 'Expenditure Type Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Corresponding expenditure type has been defined, but it is either not yet effective or has already expired as of the expenditure item date for above list of transactions.',
      p_solution               => 'Please go through navigation steps which are suggested in: <br>
[159855/KB206937]PAXTRTRX - Transaction Import Error - Invalid Expenditure Type/Expenditure Type Class Combination 
',
      p_success_msg            => 'Expenditure item date for the transaction falls under expenditure type active dates.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_EXP_TYPE_ACTIVE');



debug('begin add_signature: PA_COST_HIE_EXP_ITEMS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10485',
      p_sig_id                 => 'PA_COST_HIE_EXP_ITEMS',
      p_sig_sql                => 'select distinct  * from pa_expenditure_items_all
start with EXPENDITURE_ITEM_ID = ##$$P_EXPENDITURE_ITEM_ID$$##
connect by nocycle EXPENDITURE_ITEM_ID =  prior TRANSFERRED_FROM_EXP_ITEM_ID
or prior EXPENDITURE_ITEM_ID =  TRANSFERRED_FROM_EXP_ITEM_ID
or EXPENDITURE_ITEM_ID = prior ADJUSTED_EXPENDITURE_ITEM_ID
or prior EXPENDITURE_ITEM_ID = ADJUSTED_EXPENDITURE_ITEM_ID',
      p_title                  => 'Expenditure Hierarchy Items Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No adjustment or transfer related items found for this expenditure item.',
      p_solution               => '',
      p_success_msg            => 'Expenditure item data for adjustment and transfer items related to this expenditure item.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_HIE_EXP_ITEMS');



debug('begin add_signature: PA_COST_HIE_CDL_DATA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10486',
      p_sig_id                 => 'PA_COST_HIE_CDL_DATA',
...
or EXPENDITURE_ITEM_ID = prior ADJUSTED_EXPENDITURE_ITEM_ID
or prior EXPENDITURE_ITEM_ID = ADJUSTED_EXPENDITURE_ITEM_ID)',
      p_title                  => 'Expenditure Hierarchy Cost Distribution Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No cost distribution data found for adjustment and transfer items related to this expenditure item. ',
      p_solution               => '',
      p_success_msg            => 'Cost distribution line data from PA_COST_DISTRIBUTION_LINES_ALL for adjustment and transfer items related to this expenditure item.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_HIE_CDL_DATA');



debug('begin add_signature: PA_COST_HIE_XLA_EVENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10487',
      p_sig_id                 => 'PA_COST_HIE_XLA_EVENTS',
      p_sig_sql                => 'SELECT * FROM xla_events
WHERE application_id = 275
and event_id in (select acct_event_id from pa_cost_distribution_lines_all 
where EXPENDITURE_ITEM_ID in (select EXPENDITURE_ITEM_ID from pa_expenditure_items_all
start with EXPENDITURE_ITEM_ID = ##$$P_EXPENDITURE_ITEM_ID$$##
...
or prior EXPENDITURE_ITEM_ID = ADJUSTED_EXPENDITURE_ITEM_ID)
group by acct_event_id)',
      p_title                  => 'Expenditure Hierarchy Subledger Events',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No accounting event data found for adjustment and transfer items related to this expenditure item.',
      p_solution               => '',
      p_success_msg            => 'Accounting event data from XLA_EVENTS for adjustment and transfer items related to this expenditure item.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_HIE_XLA_EVENTS');



debug('begin add_signature: PA_COST_HIE_XLA_AE_HEADERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10488',
      p_sig_id                 => 'PA_COST_HIE_XLA_AE_HEADERS',
      p_sig_sql                => 'SELECT * FROM XLA_AE_HEADERS
WHERE application_id = 275
and EVENT_ID IN (select acct_event_id from pa_cost_distribution_lines_all 
where EXPENDITURE_ITEM_ID in (select EXPENDITURE_ITEM_ID from pa_expenditure_items_all
start with EXPENDITURE_ITEM_ID = ##$$P_EXPENDITURE_ITEM_ID$$##
...
or prior EXPENDITURE_ITEM_ID = ADJUSTED_EXPENDITURE_ITEM_ID)
group by acct_event_id)',
      p_title                  => 'Expenditure Hierarchy Subledger Header',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No accounting entry header level data found for adjustment and transfer items related to this expenditure item.',
      p_solution               => '',
      p_success_msg            => 'Accounting entry header level data from XLA_AE_HEADERS for adjustment and transfer items related to this expenditure item.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_HIE_XLA_AE_HEADERS');



debug('begin add_signature: PA_COST_HIE_XLA_AE_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10489',
      p_sig_id                 => 'PA_COST_HIE_XLA_AE_LINES',
      p_sig_sql                => 'SELECT * FROM XLA_AE_LINES
WHERE application_id = 275
and AE_HEADER_ID IN (
...
or prior EXPENDITURE_ITEM_ID = ADJUSTED_EXPENDITURE_ITEM_ID)
group by acct_event_id))',
      p_title                  => 'Expenditure Hierarchy Subledger Line Level Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No accounting entry line level data found for adjustment and transfer items related to this expenditure item.
',
      p_solution               => '',
      p_success_msg            => 'Accounting entry line level data from XLA_AE_LINES for adjustment and transfer items related to this expenditure item.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_HIE_XLA_AE_LINES');



debug('begin add_signature: PA_COST_HIE_XLA_DISTRIBUTION_LINKS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10490',
      p_sig_id                 => 'PA_COST_HIE_XLA_DISTRIBUTION_LINKS',
      p_sig_sql                => 'SELECT * FROM xla_distribution_links
WHERE application_id = 275
and EVENT_ID IN (select acct_event_id from pa_cost_distribution_lines_all 
where EXPENDITURE_ITEM_ID in (select EXPENDITURE_ITEM_ID from pa_expenditure_items_all
start with EXPENDITURE_ITEM_ID = ##$$P_EXPENDITURE_ITEM_ID$$##
...
or prior EXPENDITURE_ITEM_ID = ADJUSTED_EXPENDITURE_ITEM_ID)
group by acct_event_id)',
      p_title                  => 'Expenditure Hierarchy Subledger Distributions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data linking cost distribution lines and subledger accounting entries found for adjustment and transfer items related to this expenditure item.',
      p_solution               => '',
      p_success_msg            => 'Data linking cost distribution lines and subledger accounting entries from XLA_DISTRIBUTION_LINKS for adjustment and transfer items related to this expenditure item.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_HIE_XLA_DISTRIBUTION_LINKS');



debug('begin add_signature: INCORRECT_SEQUENCE_ORDER_OF_ADJUSTED_EXPENDITURE_ITEMS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13403',
      p_sig_id                 => 'INCORRECT_SEQUENCE_ORDER_OF_ADJUSTED_EXPENDITURE_ITEMS',
      p_sig_sql                => 'select * from PA_COST_DISTRIBUTION_LINES_ALL
where TRANSFER_STATUS_CODE = ''X'' 
 AND EXPENDITURE_ITEM_ID IN
  ...
  AND NET_ZERO_ADJUSTMENT_FLAG = ''Y'' AND ADJUSTED_EXPENDITURE_ITEM_ID IS NOT NULL) ',
      p_title                  => 'Cost Distribution Lines with Status as "Rejected in Transfer"',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Incorrect sequence order of adjusted values where reversing expenditure_item_id having expenditure_item_id lower than its parent expenditure_item_id.<br>
TRANSFER_STATUS_CODE = ''X'' in table PA_COST_DISTRIBUTION_LINES_ALL identifies the cause',
      p_solution               => '[2281607/KB199521] R12 Exception Reason : The Generate Accounting Events program is processing the line , Or Usage Transactions Are ''Rejected In Transfer'' Where Cost Distribution Lines Have TRANSFER_STATUS_CODE = ''X'' ',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: INCORRECT_SEQUENCE_ORDER_OF_ADJUSTED_EXPENDITURE_ITEMS');



debug('begin add_signature: ERROR_95318_THE_ACCOUNT_CODE_COMBINATION_ID_0_SPECIFIED_FOR_LINE_2');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13351',
      p_sig_id                 => 'ERROR_95318_THE_ACCOUNT_CODE_COMBINATION_ID_0_SPECIFIED_FOR_LINE_2',
      p_sig_sql                => 'SELECT af.filename, afv.version 
FROM ad_file_versions afv, ad_files af 
WHERE afv.file_id = af.file_id AND upper(af.filename)  = upper(''pablacct.o'') and afv.version_segment1 = (select max(TO_NUMBER(version_segment1)) 
from ad_file_versions where file_id = afv.file_id) and afv.version_segment2 = (select max(TO_NUMBER(version_segment2)) 
from ad_file_versions where file_id = afv.file_id and afv.version_segment1 = version_segment1) and afv.version_segment3 = 
(select max(TO_NUMBER(version_segment3)) from ad_file_versions where file_id = afv.file_id and afv.version_segment1 = version_segment1 and afv.version_segment2 = version_segment2) and afv.version_segment4 = (select max(TO_NUMBER(version_segment4)) from ad_file_versions where file_id = afv.file_id and afv.version_segment1 = version_segment1 and afv.version_segment2 = version_segment2 and afv.version_segment3 = version_segment3) and TO_NUMBER(afv.version_segment1) = 120 and TO_NUMBER(afv.version_segment2) = 2 and (TO_NUMBER(afv.version_segment3) = 12020000 or nvl(afv.version_segment3,0) = 0) and TO_NUMBER(afv.version_segment4) < 3 union SELECT af.filename, afv.version FROM ad_file_versions afv, ad_files af WHERE afv.file_id = af.file_id 
AND upper(af.filename)  = upper(''pablinit.o'') and afv.version_segment1 = (select max(TO_NUMBER(version_segment1)) from ad_file_versions where file_id = afv.file_id) and afv.version_segment2 = (select max(TO_NUMBER(version_segment2)) from ad_file_versions where file_id = afv.file_id and afv.version_segment1 = version_segment1) and afv.version_segment3 = (select max(TO_NUMBER(version_segment3)) from ad_file_versions where file_id = afv.file_id and afv.version_segment1 = version_segment1 and afv.version_segment2 = version_segment2) and afv.version_segment4 = (select max(TO_NUMBER(version_segment4)) from ad_file_versions where file_id = afv.file_id and afv.version_segment1 = version_segment1 and afv.version_segment2 = version_segment2 and afv.version_segment3 = version_segment3) and TO_NUMBER(afv.version_segment1) = 120 and TO_NUMBER(afv.version_segment2) = 9 and (TO_NUMBER(afv.version_segment3) = 12020000 or nvl(afv.version_segment3,0) = 0) and TO_NUMBER(afv.version_segment4) < 5',
      p_title                  => 'Error 95318 for Event Class: Borrowed and Lent When Create Accounting errors',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Code level fix for [2279556/KB199276] R12: Error 95318 The Account Code Combination Id 0 Specified For Line 2 Does Not Exist is missing.',
      p_solution               => 'Please follow solution in [2279556/KB199276] R12: Error 95318 The Account Code Combination Id 0 Specified For Line 2 Does Not Exist',
      p_success_msg            => 'Have code level fix for [2279556/KB199276] R12: Error 95318 The Account Code Combination Id 0 Specified For Line 2 Does Not Exist',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: ERROR_95318_THE_ACCOUNT_CODE_COMBINATION_ID_0_SPECIFIED_FOR_LINE_2');



debug('begin add_signature: PA_SELECTIVE_FLEX_SEG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12287',
      p_sig_id                 => 'PA_SELECTIVE_FLEX_SEG',
      p_sig_sql                => 'select fpo.user_profile_option_name, fpov.profile_option_value 
from fnd_profile_options_vl fpo, fnd_profile_option_values fpov 
where fpo.profile_option_id = fpov.profile_option_id 
and fpo.application_id = 275 
and fpo.profile_option_name = ''PA_SELECTIVE_FLEX_SEG''',
      p_title                  => 'Profile PA: Selective Flexfield Segment for AutoAccounting',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The profile option PA: Selective Flexfield Segment for AutoAccounting has not been defined. 
',
      p_solution               => 'Review the solution in [3046647/KB582275] What Does “Defaulting Key Segment Because Profile PA_SELECTIVE_FLEX_SEG Is Not Defined” in a Log File Mean?',
      p_success_msg            => 'The profile option PA: Selective Flexfield Segment for AutoAccounting has been defined. ',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: PA_SELECTIVE_FLEX_SEG');



debug('begin add_signature: PA_COST_EXP_AUTO_ACC_FUN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10507',
      p_sig_id                 => 'PA_COST_EXP_AUTO_ACC_FUN',
      p_sig_sql                => 'SELECT *
FROM pa_functions
WHERE application_id     =275
AND INTERNAL_PRODUCT_CODE=''C''
AND function_code       in
  (SELECT 
  (
  CASE
    WHEN System_Linkage_Function IN (''ST'',''OT'')
    THEN ''DLC''
    WHEN System_Linkage_Function IN (''USG'')
    THEN ''DUC''
    WHEN System_Linkage_Function IN (''INV'')
    THEN ''DIC''
    WHEN System_Linkage_Function IN (''WIP'')
    THEN ''DWC''
    WHEN System_Linkage_Function IN (''PJ'')
    THEN ''DJC''
    WHEN System_Linkage_Function IN (''ER'')
    THEN ''BER''
    WHEN System_Linkage_Function IN (''VI'')
    THEN ''DVC''
  END)
FROM pa_expenditure_items_all ei
WHERE Expenditure_Item_Id=##$$P_EXPENDITURE_ITEM_ID$$##
AND org_id               =##$$ORG_ID$$##
      ...
      p_title                  => 'Auto Accounting Function',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No AutoAccounting function identified.',
      p_solution               => 'Please go through steps which are suggested in below Notes:<br> 
[77675/FAQ5791] Which AutoAccounting Function(s) Is Invoked By Each Projects Process?<br>
[552086/FAQ4118] AutoAccounting in Projects Frequently Asked Questions (FAQ) <br>
',
      p_success_msg            => 'AutoAccounting functions are defined.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_EXP_AUTO_ACC_FUN');



debug('begin add_signature: PA_COST_EXP_AUTO_ACC_FUN_TRANS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10508',
      p_sig_id                 => 'PA_COST_EXP_AUTO_ACC_FUN_TRANS',
      p_sig_sql                => 'SELECT *
...
WHERE Expenditure_Item_Id=##$$P_EXPENDITURE_ITEM_ID$$##
AND org_id               =##$$ORG_ID$$##
AND ei.org_id               =pft.org_id
  )
AND enabled_flag =''Y''',
      p_title                  => 'Auto Accounting Function Transactions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No AutoAccounting function transactions defined.',
      p_solution               => 'Please go through steps which are suggested in below Notes:<br> 
[77675/FAQ5791]Which AutoAccounting Function(s) Is Invoked By Each Projects Process? 
[552086/FAQ4118]AutoAccounting in Projects Frequently Asked Questions (FAQ)
',
      p_success_msg            => 'The AutoAccounting function transactions are defined.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_EXP_AUTO_ACC_FUN_TRANS');



debug('begin add_signature: PA_COST_EXP_AUTO_ACC_SEG_RULE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10509',
      p_sig_id                 => 'PA_COST_EXP_AUTO_ACC_SEG_RULE',
      p_sig_sql                => 'SELECT distinct
  ft.function_code,ft.function_transaction_code,
  P.SEGMENT_NUM ,
  F.SEGMENT_NAME ,
  R.RULE_NAME
...
AND F.SEGMENT_NAME =
  ...
  AND A.ID_FLEX_CODE     = P.ID_FLEX_CODE
  AND A.ID_FLEX_NUM      = P.ID_FLEX_NUM
  AND A.ENABLED_FLAG     = ''Y''
  AND B.APPLICATION_ID   = 101
  AND B.ENABLED_FLAG     = ''Y''
  AND A.ID_FLEX_CODE     = B.ID_FLEX_CODE
  AND A.ID_FLEX_NUM      = B.ID_FLEX_NUM
  AND A.SEGMENT_NUM     >= B.SEGMENT_NUM
  GROUP BY A.SEGMENT_NAME
  HAVING COUNT(*)-1 IN P.SEGMENT_NUM
  )
ORDER BY 2,3',
      p_title                  => 'Auto Accounting Segment Rule Pairing',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no assignments of AutoAccounting rules to accounting flexfield segments for the function transaction applicable to this expenditure item.',
      p_solution               => 'Please go through steps which are suggested in below Notes:<br> 
[552086/FAQ4118] AutoAccounting in Projects Frequently Asked Questions (FAQ)<br>
[77675/FAQ5791] Which AutoAccounting Function(s) Is Invoked By Each Projects Process? <br>
[226265/KB199162] Troubleshooting Guide for AutoAccounting <br>
',
      p_success_msg            => 'AutoAccounting uses the rule assigned to an accounting flexfield segment to derive the segment value.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_EXP_AUTO_ACC_SEG_RULE');



debug('begin add_signature: PA_COST_EXP_AUTO_ACC_RULE_NAME');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10510',
      p_sig_id                 => 'PA_COST_EXP_AUTO_ACC_RULE_NAME',
      p_sig_sql                => 'SELECT
  ft.FUNCTION_CODE,
...
AND srp.function_code             IN
 ...
 WHERE Expenditure_Item_Id=##$$P_EXPENDITURE_ITEM_ID$$##
 AND org_id =##$$ORG_ID$$##
  AND org_id               =ft.org_id
  )
  order by 4,2,3',
      p_title                  => 'Auto Accounting Rules',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no auto-accounting rules defined for deriving accounting flexfield segment values for this expenditure item.',
      p_solution               => 'Please go through steps which are suggested in below Notes:<br> 
[77675/FAQ5791] Which AutoAccounting Function(s) Is Invoked By Each Projects Process? 
[552086/FAQ4118] AutoAccounting in Projects Frequently Asked Questions (FAQ)
',
      p_success_msg            => 'Auto-accounting rules are defined for deriving accounting flexfield segment values.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_EXP_AUTO_ACC_RULE_NAME');



debug('begin add_signature: PA_COST_EXP_AUTO_ACC_LOOKUP_SET');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10511',
      p_sig_id                 => 'PA_COST_EXP_AUTO_ACC_LOOKUP_SET',
      p_sig_sql                => 'SELECT 
ft.function_code,
ft.function_transaction_code,
...
AND srp.function_code                IN
  ...
  AND org_id               =ft.org_id
      ...
      p_title                  => 'Auto Accounting Lookup Set',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No lookup set information found for Auto-Accounting rules associated with this expenditure item.',
      p_solution               => 'Please go through steps which are suggested in below Notes:<br> 
[552086/FAQ4118] AutoAccounting in Projects Frequently Asked Questions (FAQ)<br>
[226265/KB199162] Troubleshooting Guide for AutoAccounting <br>
...
',
      p_success_msg            => 'Lookup set information is defined for Auto-Accounting rules associated with this expenditure item.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_EXP_AUTO_ACC_LOOKUP_SET');



debug('begin add_signature: PA_COST_EXP_AUTO_ACC_SEG_LOOKUP_VAL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10512',
      p_sig_id                 => 'PA_COST_EXP_AUTO_ACC_SEG_LOOKUP_VAL',
      p_sig_sql                => 'SELECT distinct
  ft.function_code,
  ft.function_transaction_code,
  ft.function_transaction_name,
  ...
  pr.rule_name,
  psv.segment_value_lookup_set_id,
  psv.segment_value_lookup,
  psv.segment_value,
  psvs.segment_value_lookup_set_name
FROM pa_segment_value_lookups psv,
  pa_segment_value_lookup_sets psvs,
  pa_rules pr,
  pa_segment_rule_pairings_all srp,
  pa_function_transactions_all ft
WHERE psv.SEGMENT_VALUE_LOOKUP_SET_ID = psvs.SEGMENT_VALUE_LOOKUP_SET_ID
AND psv.SEGMENT_VALUE_LOOKUP_SET_ID   = pr.segment_value_lookup_set_id
AND pr.rule_id                        =srp.rule_id
AND ft.function_transaction_code      = srp.function_transaction_code
AND ft.function_code                  = srp.function_code
AND ft.org_id                         = srp.org_id
AND ft.enabled_flag                   =''Y''
AND srp.function_code                IN
  (SELECT (
    CASE
  ...
  order by 4,2,3',
      p_title                  => 'Auto Accounting Segment Lookup Values',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No mappings of AutoAccounting rule intermediate values to accounting flexfield segment values exist.',
      p_solution               => 'Please go through steps which are suggested in below Notes:<br> 
[77675/FAQ5791] Which AutoAccounting Function(s) Is Invoked By Each Projects Process? <br>
[552086/FAQ4118] AutoAccounting in Projects Frequently Asked Questions (FAQ)<br>
',
      p_success_msg            => 'The AutoAccounting segment lookup values are defined.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_EXP_AUTO_ACC_SEG_LOOKUP_VAL');



debug('begin add_signature: PA_COST_EXP_AUTO_ACC_INVALID_PARAM');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10513',
      p_sig_id                 => 'PA_COST_EXP_AUTO_ACC_INVALID_PARAM',
...
AND NOT EXISTS
  ...
  AND fp.parameter_id    = rp.parameter_id
      ...
      p_title                  => 'AutoAccounting Invalid Parameters',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invalid AutoAccounting parameter usage identified.',
      p_solution               => 'Please go through steps which are suggested in below Notes:<br> 
[77675/FAQ5791] Which AutoAccounting Function(s) Is Invoked By Each Projects Process? <br>
[552086/FAQ4118] AutoAccounting in Projects Frequently Asked Questions (FAQ) <br>
',
      p_success_msg            => 'No invalid parameters usage found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_EXP_AUTO_ACC_INVALID_PARAM');



debug('begin add_signature: PA_COST_EXP_MISS_ACC_LOOKUP_VAL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10515',
      p_sig_id                 => 'PA_COST_EXP_MISS_ACC_LOOKUP_VAL',
...
AND ft.enabled_flag                = ''Y''
AND ft.function_code               in (SELECT 
  (
  CASE
    WHEN System_Linkage_Function IN (''ST'',''OT'')
    THEN ''DLC''
...
ORDER BY ls.segment_value_lookup_set_name, p.parameter_name',
      p_title                  => 'Missing AutoAccounting Lookup Values',
      p_fail_condition         => 'RS',
...
[552086/FAQ4118]AutoAccounting in Projects Frequently Asked Questions (FAQ)',
      p_success_msg            => 'No missing lookup set values found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_EXP_MISS_ACC_LOOKUP_VAL');



debug('begin add_signature: AA_RULES_WITH_SQL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12291',
      p_sig_id                 => 'AA_RULES_WITH_SQL',
      p_sig_sql                => 'select distinct rl.rule_id , rl.rule_name
from PA_FUNCTIONS f , PA_FUNCTION_TRANSACTIONS_ALL fta, PA_SEGMENT_RULE_PAIRINGS_ALL srp, pa_rules rl 
where f.function_code = fta.function_code 
and fta.function_code = srp.function_code 
and fta.function_transaction_code = srp.function_transaction_code 
and rl.rule_id = srp.rule_id 
and srp.application_id = 275 
and srp.org_id = ##$$ORG_ID$$## 
and fta.enabled_flag = ''Y'' 
and rl.select_statement is not null 
',
      p_title                  => 'Rules with Source SQL Statement',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are AutoAccounting rules defined which have the source based on a SQL statement.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AA_RULES_WITH_SQL');



debug('begin add_signature: AA_RULES_ASIGNMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12297',
      p_sig_id                 => 'AA_RULES_ASIGNMENTS',
      p_sig_sql                => 'select distinct f.function_name , fta.function_transaction_name , 
fta.enabled_flag , srp.segment_num , r.rule_name from pa_functions f , 
pa_function_transactions_all fta , pa_segment_rule_pairings_all srp , pa_rules r 
where f.function_code = fta.function_code
and f.function_code = srp.function_code
and fta.function_transaction_code = srp.function_transaction_code
and srp.rule_id = r.rule_id and f.application_id = 275  
and fta.org_id = ##$$ORG_ID$$## 
and srp.org_id = ##$$ORG_ID$$## 
order by f.function_name , fta.function_transaction_name, srp.segment_num ',
      p_title                  => 'AutoAccounting Rules Assigned',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'List all AutoAccounting rules defined. ',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AA_RULES_ASIGNMENTS');



debug('begin add_signature: AA_FUNCTIONS_NOT_CONFIGURED_FOR_ALL_TRANSACTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12290',
      p_sig_id                 => 'AA_FUNCTIONS_NOT_CONFIGURED_FOR_ALL_TRANSACTIONS',
      p_sig_sql                => 'select distinct f.function_name, f.function_code, f.description 
from PA_FUNCTIONS f, PA_FUNCTION_TRANSACTIONS_ALL fta 
where f.function_code = fta.function_code 
 and f.application_id = 275 
 and fta.org_id = ##$$ORG_ID$$## 
 and fta.enabled_flag = ''Y'' 
 and f.function_code not in 
   (select distinct f.function_code from PA_FUNCTIONS f, PA_FUNCTION_TRANSACTIONS_ALL fta 
     where f.function_code = fta.function_code 
      and f.application_id = 275 
      and fta.org_id = ##$$ORG_ID$$## 
      and fta.enabled_flag = ''Y'' 
      and fta.function_transaction_code = ''ALL'') 
order by f.function_name',
      p_title                  => 'Functions Not Configured For All Misc Transactions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are some AutoAccounting functions not configured for "All Misc Transactions" (which is used when any of the others are disabled).',
      p_solution               => 'See [552086/FAQ4118#aref_section22] for solution.<br>
How do you implement AutoAccounting?',
   ...
   l_info.delete;
debug('end add_signature: AA_FUNCTIONS_NOT_CONFIGURED_FOR_ALL_TRANSACTIONS');



debug('begin add_signature: AA_FUNCTIONS_NOT_CONFIGURED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12289',
      p_sig_id                 => 'AA_FUNCTIONS_NOT_CONFIGURED',
      p_sig_sql                => 'select distinct f.function_name, f.description
from PA_FUNCTIONS f, PA_FUNCTION_TRANSACTIONS_ALL fta
where f.function_code = fta.function_code 
and f.application_id = 275 
and fta.org_id = ##$$ORG_ID$$## 
and fta.enabled_flag = ''N'' 
order by f.function_name
',
      p_title                  => 'Function without Function Transactions enabled',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are functions without Function Transactions enabled (and implicit without Segment Rule Pairings).',
      p_solution               => 'See [552086/FAQ4118#aref_section22] for solution.<br>
How do you implement AutoAccounting?',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: AA_FUNCTIONS_NOT_CONFIGURED');



debug('begin add_signature: DEFAULT_SUPPLIER_COST_CREDIT_ACCOUNT_IS_NOT_SET');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12633',
      p_sig_id                 => 'DEFAULT_SUPPLIER_COST_CREDIT_ACCOUNT_IS_NOT_SET',
      p_sig_sql                => 'select decode(NVL(DEF_SUPPLIER_COST_CR_CCID, ''1''), 1, ''Default Supplier Cost Credit Account is not set'', 
DEF_SUPPLIER_COST_CR_CCID) DEF_SUPPLIER_COST_CR_CCID 
from PA_IMPLEMENTATIONS_ALL where org_id = ##$$ORG_ID$$##
',
      p_title                  => 'Default Supplier Cost Credit Account',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Default Supplier Cost Credit Account is not set',
      p_solution               => 'See below document for possible error:<br>
[1268728/KB396920] R12 PRC: Create Accounting Errors With 95353 For Supplier Invoice Adjustments Costs <br>



',
      p_success_msg            => 'Default Supplier Cost Credit Account is set.<br>
Reference: [1268728/KB396920]',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: DEFAULT_SUPPLIER_COST_CREDIT_ACCOUNT_IS_NOT_SET');



debug('begin add_signature: PA_COST_EXP_REV_ACCT_TRANS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10473',
      p_sig_id                 => 'PA_COST_EXP_REV_ACCT_TRANS',
      p_sig_sql                => 'with eep as (select decode(profile_option_value,''Y'',8721,275) appid from fnd_profile_option_values
where profile_option_id=(select profile_option_id from FND_PROFILE_OPTIONS
where profile_option_name = ''PA_EN_NEW_GLDATE_DERIVATION'')
union
select 101 from dual), 
gl as (
select appid, imp.SET_OF_BOOKS_ID, start_date, end_date from gl_period_statuses pspa, eep, pa_implementations imp
WHERE  pspa.application_id = eep.appid
AND  pspa.set_of_books_id = imp.SET_OF_BOOKS_ID
and pspa.CLOSING_STATUS = ''C'')
select ''Reversal Allowed'' ELIGIBILITY_CHECK  from dual where not exists(
select 1 from (
select ei.EXPENDITURE_ITEM_ID,cdl.gl_date, cdl.pa_date
from pa_expenditure_items_all ei, PA_COST_DISTRIBUTION_LINES_ALL cdl,  pa_transaction_sources ts
where ei.EXPENDITURE_ITEM_ID = cdl.EXPENDITURE_ITEM_ID
and ei.EXPENDITURE_ITEM_ID =  ##$$P_EXPENDITURE_ITEM_ID$$## 
and cdl.line_type = ''R''
and (ts.ALLOW_ADJUSTMENTS_FLAG = ''Y'' or ts.ALLOW_REVERSAL_FLAG = ''Y'')
and ei.TRANSACTION_SOURCE = ts.TRANSACTION_SOURCE
and cdl.TRANSFER_STATUS_CODE in ( ''A'', ''P'')
and ei.NET_ZERO_ADJUSTMENT_FLAG <> ''Y''
union
select ei.EXPENDITURE_ITEM_ID, cdl.gl_date, cdl.pa_date
from pa_expenditure_items_all ei, PA_COST_DISTRIBUTION_LINES_ALL cdl
where ei.EXPENDITURE_ITEM_ID = cdl.EXPENDITURE_ITEM_ID
and ei.EXPENDITURE_ITEM_ID =  ##$$P_EXPENDITURE_ITEM_ID$$## 
and ei.NET_ZERO_ADJUSTMENT_FLAG <> ''Y''
and cdl.line_type = ''R''
and ei.TRANSACTION_SOURCE is null
and cdl.TRANSFER_STATUS_CODE in ( ''A'', ''P'')) tm
where (exists (select null from gl where pa_date between gl.start_date and gl.end_date)
   or exists (select null from gl where gl_date between gl.start_date and gl.end_date)))',
      p_title                  => 'Eligibility of Costed / Accounted Expenditure Item for Reversal',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This costed / accounted expenditure item '||mask_text(g_expenditure_item_id, nvl( upper(''), 'NO_MASK') )||' is eligible for reversal.',
      p_solution               => 'Refer to [11416181/KB867703] Enhancements to Oracle Projects Suite Release 12.1.3 Delta7.',
      p_success_msg            => 'This expenditure item '||mask_text(g_expenditure_item_id, nvl( upper(''), 'NO_MASK') )||' is not eligible for reversal.<br>
Refer to [11416181/KB867703] Enhancements to Oracle Projects Suite Release 12.1.3 Delta7.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_EXP_REV_ACCT_TRANS');



debug('begin add_signature: PA_COST_UNDO_ACCT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10475',
      p_sig_id                 => 'PA_COST_UNDO_ACCT',
      p_sig_sql                => 'SELECT cdl.*
FROM PA_EXPENDITURE_ITEMS_ALL ei,
  PA_COST_DISTRIBUTION_LINES_ALL cdl,
...
AND ei.historical_flag       = ''N''
AND gl.APPLICATION_ID        = 101
AND gl.CLOSING_STATUS       <> ''C''
AND ei.org_id = imp.org_id
AND gl.SET_OF_BOOKS_ID       = imp.SET_OF_BOOKS_ID
AND cdl.gl_date BETWEEN gl.start_date AND gl.end_date
AND NOT EXISTS
  (SELECT NULL
  FROM PA_PROJECT_ASSET_LINE_DETAILS det
  WHERE det.EXPENDITURE_ITEM_ID = cdl.EXPENDITURE_ITEM_ID
  )',
      p_title                  => 'Eligibility of Expenditure Item for Undo Accounting',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The expenditure item '||mask_text(g_expenditure_item_id, nvl( upper(''), 'NO_MASK') )||' is eligible for undo accounting.',
      p_solution               => 'For more details please refer to the below document:<br>
[2204563/KB295859] Enhancements to Oracle Projects Suite Release 12.1.3 Delta 7 CU3 <br>
Section: Undo Accounting.<br>
Navigation: Responsibility Projects -> Expenditures -> Expenditure Inquiry -> Tools -> View Accounting <br>
Click on Undo Accounting. This will change the batch status from Released to Update Released which allows for corrections.
',
      p_success_msg            => 'The expenditure item '||mask_text(g_expenditure_item_id, nvl( upper(''), 'NO_MASK') )||' is not eligible for undo accounting.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_UNDO_ACCT');



debug('begin add_signature: EBS_FIN_PA_PAEXPND_CR_ACC_FUNCTION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25113',
      p_sig_id                 => 'EBS_FIN_PA_PAEXPND_CR_ACC_FUNCTION',
      p_sig_sql                => 'SELECT *
FROM pa_functions
WHERE application_id     =275
AND INTERNAL_PRODUCT_CODE=''C''
...
AND org_id               =##$$ORG_ID$$##
      ...
      p_title                  => 'Auto Accounting Function For Credit Account',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Either no autoAccounting function defined or expenditure item is related to expense report or supplier invoice.',
      p_solution               => 'Please go through steps which are suggested in below Notes:<br> 
[77675/FAQ5791] Which AutoAccounting Function(s) Is Invoked By Each Projects Process?<br>
[552086/FAQ4118] AutoAccounting in Projects Frequently Asked Questions (FAQ) <br>
',
      p_success_msg            => 'AutoAccounting functions for credit account is defined.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAEXPND_CR_ACC_FUNCTION');



debug('begin add_signature: EBS_FIN_PA_PAEXPND_CR_ACC_FUN_TRANS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25114',
      p_sig_id                 => 'EBS_FIN_PA_PAEXPND_CR_ACC_FUN_TRANS',
      p_sig_sql                => 'SELECT *
FROM pa_function_transactions_all pft
WHERE  function_code        in
  (SELECT 
...
AND enabled_flag =''Y''',
      p_title                  => 'Auto Accounting Function Transactions For Credit Account',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Either no auto accounting function transactions defined or expenditure items related to supplier invoice or expense report.',
      p_solution               => 'Please go through steps which are suggested in below Notes:<br> 
[77675/FAQ5791]Which AutoAccounting Function(s) Is Invoked By Each Projects Process? 
[552086/FAQ4118]AutoAccounting in Projects Frequently Asked Questions (FAQ)
',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAEXPND_CR_ACC_FUN_TRANS');



debug('begin add_signature: EBS_FIN_PA_PAEXPND_CR_ACC_INVALID_PARAM');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25119',
      p_sig_id                 => 'EBS_FIN_PA_PAEXPND_CR_ACC_INVALID_PARAM',
      p_sig_sql                => 'SELECT f.function_name ,
  srp.org_id ,
  srp.function_code ,
  srp.function_transaction_code ,
...
AND NOT EXISTS
  ...
  AND fp.parameter_id    = rp.parameter_id
      ...
      p_title                  => 'AutoAccounting Invalid Parameters For Credit Account',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Either invalid AutoAccounting parameter usage identified or expenditure item is related to supplier invoice or expense report.',
      p_solution               => 'Please go through steps which are suggested in below Notes:<br> 
[77675/FAQ5791] Which AutoAccounting Function(s) Is Invoked By Each Projects Process? <br>
[552086/FAQ4118] AutoAccounting in Projects Frequently Asked Questions (FAQ) <br>
',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAEXPND_CR_ACC_INVALID_PARAM');



debug('begin add_signature: EBS_FIN_PA_PAEXPND_CR_ACC_LOOKUP_SEG_VAL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25118',
      p_sig_id                 => 'EBS_FIN_PA_PAEXPND_CR_ACC_LOOKUP_SEG_VAL',
      p_sig_sql                => 'SELECT distinct
  ft.function_code,
  ft.function_transaction_code,
  ft.function_transaction_name,
...
AND srp.function_code                IN
  ...
  order by 4,2,3',
      p_title                  => 'Auto Accounting Segment Lookup Values For Credit Account',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Either no mappings of AutoAccounting rule intermediate values to accounting flexfield segment values exist Or Expenditure Item is related to supplier invoice or expense report.',
      p_solution               => 'Please go through steps which are suggested in below Notes:<br> 
[77675/FAQ5791] Which AutoAccounting Function(s) Is Invoked By Each Projects Process? <br>
[552086/FAQ4118] AutoAccounting in Projects Frequently Asked Questions (FAQ)<br>
',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAEXPND_CR_ACC_LOOKUP_SEG_VAL');



debug('begin add_signature: EBS_FIN_PA_PAEXPND_CR_ACC_LOOKUP_SET');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25117',
      p_sig_id                 => 'EBS_FIN_PA_PAEXPND_CR_ACC_LOOKUP_SET',
      p_sig_sql                => 'SELECT 
ft.function_code,
ft.function_transaction_code,
ft.function_transaction_name,
...
AND srp.function_code                IN
  ...
  AND org_id               =ft.org_id
      ...
      p_title                  => 'Auto Accounting Lookup Set For Credit Account',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Either no lookup set information found for Auto-Accounting rules associated with this expenditure item OR expenditure item is related to supplier invoice or expense report.',
      p_solution               => 'Please go through steps which are suggested in below Notes:<br> 
[552086/FAQ4118] AutoAccounting in Projects Frequently Asked Questions (FAQ)<br>
[226265/KB199162] Troubleshooting Guide for AutoAccounting <br>
...
',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAEXPND_CR_ACC_LOOKUP_SET');



debug('begin add_signature: EBS_FIN_PA_PAEXPND_CR_ACC_RULE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25116',
      p_sig_id                 => 'EBS_FIN_PA_PAEXPND_CR_ACC_RULE',
      p_sig_sql                => 'SELECT
  ft.FUNCTION_CODE,
  ft.FUNCTION_TRANSACTION_CODE,
  srp.segment_num,
...
AND srp.function_code             IN
 ...
 AND org_id =##$$ORG_ID$$##
  ...
  order by 4,2,3',
      p_title                  => 'Auto Accounting Rules For Credit Account',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Either there are no auto-accounting rules defined for deriving accounting flexfield segment values for this expenditure item or expenditure item is related to supplier invoice or expense report.',
      p_solution               => 'Please go through steps which are suggested in below Notes:<br> 
[77675/FAQ5791] Which AutoAccounting Function(s) Is Invoked By Each Projects Process? 
[552086/FAQ4118] AutoAccounting in Projects Frequently Asked Questions (FAQ)
',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAEXPND_CR_ACC_RULE');



debug('begin add_signature: EBS_FIN_PA_PAEXPND_CR_ACC_SEG_RULE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25115',
      p_sig_id                 => 'EBS_FIN_PA_PAEXPND_CR_ACC_SEG_RULE',
      p_sig_sql                => 'SELECT distinct
  ft.function_code,ft.function_transaction_code,
  P.SEGMENT_NUM ,
  F.SEGMENT_NAME ,
...
ORDER BY 2,3',
      p_title                  => 'Auto Accounting Segment Rule Pairing For Credit Account',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Either there are no assignments of AutoAccounting rules to accounting flexfield segments for the function transaction applicable to this expenditure item Or expenditure item could be related to supplier invoice or expense report.',
      p_solution               => 'Please go through steps which are suggested in below Notes:<br> 
[552086/FAQ4118] AutoAccounting in Projects Frequently Asked Questions (FAQ)<br>
[77675/FAQ5791] Which AutoAccounting Function(s) Is Invoked By Each Projects Process? <br>
[226265/KB199162] Troubleshooting Guide for AutoAccounting <br>
',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAEXPND_CR_ACC_SEG_RULE');



debug('begin add_signature: EBS_FIN_PA_PAEXPND_CR_MISS_ACC_LOOKUP_VAL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25120',
      p_sig_id                 => 'EBS_FIN_PA_PAEXPND_CR_MISS_ACC_LOOKUP_VAL',
      p_sig_sql                => 'SELECT DISTINCT r.key_parameter_id ,
  p.parameter_name ,
  r.segment_value_lookup_set_id lookup_set_id ,
  ls.segment_value_lookup_set_name lookup_set_name
...
AND ls.segment_value_lookup_set_id = r.segment_value_lookup_set_id
ORDER BY ls.segment_value_lookup_set_name, p.parameter_name',
      p_title                  => 'Missing AutoAccounting Lookup Values For Credit Account',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Either missing auto accounting lookup set values exist or expenditure item is related to supplier invoice or expense report.',
      p_solution               => 'Review the rules and functions where the parameter/lookup set combination is being used as well as the list of possible missing values that follows and determine if these values should be added to the lookup set.<br>
[552086/FAQ4118]AutoAccounting in Projects Frequently Asked Questions (FAQ)',
      p_success_msg            => 'No missing lookup set values found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAEXPND_CR_MISS_ACC_LOOKUP_VAL');



debug('begin add_signature: PA_COST_BILL_RATES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10484',
      p_sig_id                 => 'PA_COST_BILL_RATES',
      p_sig_sql                => 'SELECT 
distinct 
  bill_rates.std_bill_rate_schedule,
  bill_rates.person_id,
  bill_rates.rate ,
  bill_rates.bill_rate_unit,
  psb.SCHEDULE_TYPE,
  psb.SHARE_ACROSS_OU_FLAG,
  bill_rates.start_date_active ,
  bill_rates.end_date_active,
  ei.ORG_ID
FROM 
  pa_bill_rates_all bill_rates,
  pa_std_bill_rate_schedules_all psb,
  pa_expenditure_items_all ei,
  pa_expenditures_all e,
  PER_ALL_PEOPLE_F pef
WHERE ei.EXPENDITURE_ITEM_ID = ##$$P_EXPENDITURE_ITEM_ID$$##
AND bill_rates.BILL_RATE_SCH_ID = psb.BILL_RATE_SCH_ID
AND bill_rates.BILL_RATE_ORGANIZATION_ID = psb.ORGANIZATION_ID
AND bill_rates.org_id = psb.org_id
AND EI.ORG_ID = psb.org_id
AND ei.EXPENDITURE_ID        = e.EXPENDITURE_ID
AND ei.SYSTEM_LINKAGE_FUNCTION  in (''ST'', ''OT'')
AND TRUNC(ei.expenditure_item_date) BETWEEN TRUNC(bill_rates.start_date_active) AND TRUNC(NVL(bill_rates.end_date_active,ei.expenditure_item_date))
AND bill_rates.person_id = e.incurred_by_person_id
AND bill_rates.person_id = pef.person_id
and EXPENDITURE_ITEM_DATE between PEF.EFFECTIVE_START_DATE and nvl(PEF.EFFECTIVE_END_DATE,sysdate)',
      p_title                  => 'Labor Bill Rates',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Either labor bill rates are not defined for the employees, job, expenditure type or non-labor resource associated with this expenditure item or the specific expenditure item is not a labor expenditure.',
      p_solution               => 'Please review the solution in [2450620/KB199020] How to Define Labor Rates to Process the Expenditure Items?<br>
',
      p_success_msg            => 'Labor bill rates are defined for the employees, job, expenditure type or non-labor resource associated with this expenditure item.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_BILL_RATES');



debug('begin add_signature: PA_COST_EXP_NON_LAB');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11102',
      p_sig_id                 => 'PA_COST_EXP_NON_LAB',
      p_sig_sql                => 'SELECT 
distinct
pet.EXPENDITURE_TYPE,
  pet.UNIT_OF_MEASURE,
...
pa_expenditure_items_all ei,
PA_Expenditure_Types pet,
PA_Expenditure_Cost_Rates_all pec
where ei.EXPENDITURE_ITEM_ID= ##$$P_EXPENDITURE_ITEM_ID$$##
and EI.EXPENDITURE_TYPE= pet.EXPENDITURE_TYPE
and ei.SYSTEM_LINKAGE_FUNCTION not in (''ST'', ''OT'', ''BTC'', ''VI'', ''ER'')
and ei.SYSTEM_LINKAGE_FUNCTION = pet.SYSTEM_LINKAGE_FUNCTION 
and EI.EXPENDITURE_TYPE= pec.EXPENDITURE_TYPE
and ei.org_id = pec.org_id
and ei.EXPENDITURE_ITEM_DATE BETWEEN PEC.START_DATE_ACTIVE AND NVL(PEC.END_DATE_ACTIVE,SYSDATE)',
      p_title                  => 'Non-Labor Bill Rates',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no cost rates defined for non-labor expenditure types.',
      p_solution               => 'Please go through steps which are suggested in below Note:<br> 
[2450703/KB198663] How to Define Non-Labor Rates to Process the Expenditure Items?

',
      p_success_msg            => 'PA_EXPENDITURE_COST_RATES_ALL table stores cost rates of non-labor expenditure types.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_EXP_NON_LAB');



debug('begin add_signature: PA_COST_RATE_COMP_DETAILS');
   l_info('##MASK##FULL_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10478',
      p_sig_id                 => 'PA_COST_RATE_COMP_DETAILS',
      p_sig_sql                => 'SELECT ppf.full_name,ped.*
FROM pa_compensation_details_all ped,
  pa_expenditures_all pea,
  pa_expenditure_items_all pei,
  per_all_people_f ppf
WHERE ped.PERSON_ID    = pea.INCURRED_BY_PERSON_ID
AND pea.EXPENDITURE_ID = pei.EXPENDITURE_ID
AND ped.person_id      = ppf.person_id
AND sysdate between ppf.effective_start_date and ppf.effective_end_date
and pei.EXPENDITURE_ITEM_ID = ##$$P_EXPENDITURE_ITEM_ID$$##',
      p_title                  => 'Compensation Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Compensation rules and cost rates are not defined for the employee who incurred the expenditure item '||mask_text(g_expenditure_item_id, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => 'Please follow below document to complete the setup in-case payroll integration is enabled. <br>
[2436918/KB730734] White Paper On Payroll Integration With Project <br>
Please go through below section:<br>
Project Module setup <br>
Define labor costing rule <br>
Define labor costing overrides<br>
',
      p_success_msg            => 'Compensation rules and cost rates are defined for the employee who incurred the expenditure item '||mask_text(g_expenditure_item_id, nvl( upper(''), 'NO_MASK') )||'.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_RATE_COMP_DETAILS');



debug('begin add_signature: PA_COST_ORG_LABOR_SCH_RULE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10482',
      p_sig_id                 => 'PA_COST_ORG_LABOR_SCH_RULE',
      p_sig_sql                => 'SELECT assign.*
FROM pa_org_labor_sch_rule assign,
  pa_expenditure_items_all ei,
  pa_implementations_all imp
WHERE ei.EXPENDITURE_ITEM_ID = ##$$P_EXPENDITURE_ITEM_ID$$##
AND ei.org_id                = imp.org_id
AND assign.organization_id  IS NULL
AND TRUNC(ei.expenditure_item_date) BETWEEN TRUNC(assign.start_date_active) AND TRUNC(NVL(assign.end_date_active,ei.expenditure_item_date))
AND NVL(assign.org_id,-99) = NVL(imp.org_id, -99)',
      p_title                  => 'Labor Costing Rule and Rate Schedule Assignments',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No labor costing rule and rate schedule identified for the expenditure item '||mask_text(g_expenditure_item_id, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => '',
      p_success_msg            => 'PA_ORG_LABOR_SCH_RULE stores labor costing rule and rate schedule assignments for the expenditure item '||mask_text(g_expenditure_item_id, nvl( upper(''), 'NO_MASK') )||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_ORG_LABOR_SCH_RULE');



debug('begin add_signature: PA_COST_RATE_DATA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10461',
      p_sig_id                 => 'PA_COST_RATE_DATA',
      p_sig_sql                => 'SELECT pec.*
FROM pa_expenditure_items_all pei,
  PA_Expenditure_Cost_Rates_all pec
WHERE pei.EXPENDITURE_TYPE  =pec.EXPENDITURE_TYPE
AND pei.org_id              = pec.org_id
AND pei.expenditure_item_id = ##$$P_EXPENDITURE_ITEM_ID$$##',
      p_title                  => 'Expenditure Cost Rates',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no rate defined for the expenditure type.',
      p_solution               => 'Please follow below steps if corresponding expenditure type rate are required.<br>
Navigate to Project Responsibility<br>
Go to Setup -->Expenditures --> Expenditure Types <br>
Define rates here.
',
      p_success_msg            => 'PA_EXPENDITURE_COST_RATES_ALL contains cost rate data for the expenditure type.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_RATE_DATA');



debug('begin add_signature: PA_COST_EXP_LAB_OVERRIDE');
   l_info('##MASK##FULL_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11101',
      p_sig_id                 => 'PA_COST_EXP_LAB_OVERRIDE',
      p_sig_sql                => 'SELECT distinct
  pef.full_name,
  pcd.person_id,
  HOURLY_COST_RATE,
  OVERRIDE_TYPE,
  START_DATE_ACTIVE,
  END_DATE_ACTIVE,EXPENDITURE_ITEM_ID,
  ei.org_id
FROM pa_compensation_details_all pcd,
PA_EXPENDITURES_ALL pea,
pa_expenditure_items_all ei,
PER_ALL_PEOPLE_F pef
WHERE pcd.person_id = PEA.INCURRED_BY_PERSON_ID
and pcd.org_id = pea.org_id
and pea.expenditure_id = ei.expenditure_id
and PCD.PERSON_ID = pef.person_id
and EI.EXPENDITURE_ITEM_DATE between PCD.START_DATE_ACTIVE and NVL(PCD.END_DATE_ACTIVE,sysdate)
and EXPENDITURE_ITEM_DATE between PEF.EFFECTIVE_START_DATE and NVL(PEF.EFFECTIVE_END_DATE,sysdate)
and ei.EXPENDITURE_ITEM_ID =  ##$$P_EXPENDITURE_ITEM_ID$$##',
      p_title                  => 'Labor Bill Rate Override',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no hourly cost rates and compensation rules defined for employees.',
      p_solution               => '',
      p_success_msg            => 'PA_COMPENSATION_DETAILS_ALL stores hourly cost rates and compensation rules for employees.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_EXP_LAB_OVERRIDE');



debug('begin add_signature: PA_COST_EXP_NON_LAB_OVERRIDE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11103',
      p_sig_id                 => 'PA_COST_EXP_NON_LAB_OVERRIDE',
      p_sig_sql                => 'SELECT distinct
  EI.EXPENDITURE_TYPE,
  pec.NON_LABOR_RESOURCE,
  pet.UNIT_OF_MEASURE,
  pec.START_DATE_ACTIVE,
  pec.END_DATE_ACTIVE,
  pec.RATE,ei.EXPENDITURE_ITEM_ID,
  EI.ORG_ID
FROM
pa_expenditure_items_all ei,
PA_Expenditure_Types pet,
PA_EXPENDITURES_ALL pea,
PA_USAGE_COST_RATE_OVR_ALL pec
where ei.EXPENDITURE_ITEM_ID= ##$$P_EXPENDITURE_ITEM_ID$$##
and EI.EXPENDITURE_TYPE= pet.EXPENDITURE_TYPE
and ei.SYSTEM_LINKAGE_FUNCTION not in (''ST'', ''OT'', ''BTC'', ''VI'', ''ER'')
and ei.SYSTEM_LINKAGE_FUNCTION = pet.SYSTEM_LINKAGE_FUNCTION 
and EI.EXPENDITURE_TYPE= pec.EXPENDITURE_TYPE
and ei.org_id = pec.org_id
and EI.NON_LABOR_RESOURCE = PEC.NON_LABOR_RESOURCE
and ei.EXPENDITURE_ITEM_DATE BETWEEN PEC.START_DATE_ACTIVE AND NVL(PEC.END_DATE_ACTIVE,SYSDATE)',
      p_title                  => 'Non-Labor Bill Rate Override',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no cost rates defined for non-labor resources and owning organizations.
',
      p_solution               => '',
      p_success_msg            => 'PA_USAGE_COST_RATE_OVR_ALL stores special cost rates for non-labor resources and owning organizations.
These cost rates override the cost rates defined for a non-labor resource''s expenditure type.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_EXP_NON_LAB_OVERRIDE');



debug('begin add_signature: EBS_FIN_PA_PAEXPND_NO_RATE_JOB_ID_NOT_NULL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24277',
      p_sig_id                 => 'EBS_FIN_PA_PAEXPND_NO_RATE_JOB_ID_NOT_NULL',
      p_sig_sql                => 'select * from pa_expenditure_items_all
where cost_distributed_flag = ''N''
and cost_dist_rejection_code = ''NO_RATE''
and system_linkage_function = ''ST''
and job_id is not null
and Project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Distribute Labor Costs Exception NO_RATE',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The Concurrent process PALDLC PRC: Distribute Labor Costs Process showing the exception NO_RATE for and employee',
      p_solution               => 'Review [1280057/KB676523] and work with Oracle Support through a Service Request, you might need a datafix.',
      p_success_msg            => 'You did not encounter the issue described in [1280057/KB676523]',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAEXPND_NO_RATE_JOB_ID_NOT_NULL');



debug('begin add_signature: PA_IND_RATE_SCHEDULES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12206',
      p_sig_id                 => 'PA_IND_RATE_SCHEDULES',
      p_sig_sql                => 'SELECT *  FROM   PA_IND_RATE_SCHEDULES  where IND_RATE_SCH_ID = (select COST_IND_RATE_SCH_ID from PA_PROJECTS_ALL where PROJECT_ID = ##$$PROJECT_ID$$##)',
      p_title                  => 'Burden Schedule',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Burden Schedule information identified.',
      p_solution               => '',
      p_success_msg            => 'PA_IND_RATE_SCHEDULES stores Burden Schedule for project/task.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_IND_RATE_SCHEDULES');



debug('begin add_signature: PA_IND_RATE_SCH_REVISIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12207',
      p_sig_id                 => 'PA_IND_RATE_SCH_REVISIONS',
      p_sig_sql                => 'select * from  PA_IND_RATE_SCH_REVISIONS 
where IND_RATE_SCH_ID = (select COST_IND_RATE_SCH_ID from PA_PROJECTS_ALL where PROJECT_ID = ##$$PROJECT_ID$$##)',
      p_title                  => 'Burden Schedule Revision',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Burden Schedule Revision information identified.',
      p_solution               => '',
      p_success_msg            => 'PA_IND_RATE_SCH_REVISIONS stores revisions within burden schedules.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_IND_RATE_SCH_REVISIONS');



debug('begin add_signature: PA_IND_COST_MULTIPLIERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12209',
      p_sig_id                 => 'PA_IND_COST_MULTIPLIERS',
      p_sig_sql                => 'SELECT cm.*  from   PA_IND_COST_MULTIPLIERS cm,  PA_IND_RATE_SCH_REVISIONS rev
where  cm.IND_RATE_SCH_REVISION_ID = rev.IND_RATE_SCH_REVISION_ID 
and    rev.IND_RATE_SCH_ID = (select COST_IND_RATE_SCH_ID from PA_PROJECTS_ALL where PROJECT_ID = ##$$PROJECT_ID$$##)  and rownum < 60
order by cm.IND_RATE_SCH_REVISION_ID desc',
      p_title                  => 'Burden Schedule Cost Multipliers',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Burden Schedule Cost Multipliers information identified.',
      p_solution               => '',
      p_success_msg            => 'PA_IND_COST_MULTIPLIERS stores burden multipliers for burden schedule revisions, organizations, and burden cost codes.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_IND_COST_MULTIPLIERS');



debug('begin add_signature: PA_COST_PLUS_STRUCTURES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12210',
      p_sig_id                 => 'PA_COST_PLUS_STRUCTURES',
      p_sig_sql                => 'select * from PA_COST_PLUS_STRUCTURES WHERE COST_PLUS_STRUCTURE = ''##$$COST_STRUCTURE$$##''',
      p_title                  => 'Burden Structure',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Burden Structure does not exist. ',
      p_solution               => '',
      p_success_msg            => 'PA_COST_PLUS_STRUCTURES table stores structures used for burdening.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_PLUS_STRUCTURES');



debug('begin add_signature: PA_COST_BASES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12211',
      p_sig_id                 => 'PA_COST_BASES',
      p_sig_sql                => 'SELECT v.*, cb.description  from   PA_COST_BASE_V v,   PA_COST_BASES cb
where  v.COST_BASE = cb.COST_BASE
and   cost_plus_structure = ''##$$COST_STRUCTURE$$##'' 
ORDER BY v.COST_BASE',
      p_title                  => 'Burden - Cost Base Assignment ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Burden Cost Base Assignment does not exist for this cost structure.',
      p_solution               => '',
      p_success_msg            => 'PA_COST_BASES table stores implementation defined groupings of expenditure types used for burdening.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_BASES');



debug('begin add_signature: PA_COST_BASE_COST_CODES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12212',
      p_sig_id                 => 'PA_COST_BASE_COST_CODES',
      p_sig_sql                => 'SELECT *  from   PA_COST_BASE_COST_CODES  where  cost_plus_structure = ''##$$COST_STRUCTURE$$##'' order by COST_BASE, PRECEDENCE',
      p_title                  => 'Burden - Cost Code / Cost Base Relationship',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Burden - Cost Code does not exist for this cost structure.',
      p_solution               => '',
      p_success_msg            => 'PA_COST_BASE_COST_CODES stores burden cost codes associated with cost bases.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_BASE_COST_CODES');



debug('begin add_signature: PA_COST_BASE_EXP_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12213',
      p_sig_id                 => 'PA_COST_BASE_EXP_TYPES',
      p_sig_sql                => 'SELECT *  from   PA_COST_BASE_EXP_TYPES  where  cost_plus_structure = ''##$$COST_STRUCTURE$$##''  order by COST_BASE, EXPENDITURE_TYPE',
      p_title                  => 'Burden - Expenditure Type / Cost Base Relationship',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No cost base expenditure type information identified.',
      p_solution               => '',
      p_success_msg            => 'PA_COST_BASE_EXP_TYPES table stores expenditure types associated with cost bases.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COST_BASE_EXP_TYPES');



debug('begin add_signature: PA_COMPILED_MULTIPLIERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12214',
      p_sig_id                 => 'PA_COMPILED_MULTIPLIERS',
      p_sig_sql                => 'SELECT ei.expenditure_item_id,
ei.task_id,
ei.expenditure_type,
NVL(ei.raw_cost,0) ei_raw_cost,
NVL(ei.override_to_organization_id, eb.incurred_by_organization_id)
expenditure_org,
ei.projfunc_currency_code,
ic.expenditure_type brdn_expenditure_type,
ic.ind_cost_code,
cm.compiled_multiplier,
cm.cost_base,
ROUND(ei.raw_cost*cm.compiled_multiplier,3) btc_exp_cost,
ei.cost_ind_compiled_set_id
FROM pa_compiled_multipliers cm,
pa_cost_base_cost_codes cbcc,
pa_cost_base_exp_types cbet,
pa_ind_cost_codes ic,
pa_expenditure_items_all ei,
pa_expenditures_all eb  
WHERE ei.expenditure_id = eb.expenditure_id
AND ei.cost_ind_compiled_set_id > 0
AND ei.cost_distributed_flag = ''Y''
AND ei.system_linkage_function <> ''BTC''
AND cm.ind_compiled_set_id = ei.cost_ind_compiled_set_id
AND cm.cost_base_cost_code_id = cbcc.cost_base_cost_code_id
AND cm.cost_base = cbcc.cost_base
AND cm.ind_cost_code = cbcc.ind_cost_code
AND cbcc.ind_cost_code = ic.ind_cost_code
AND cbcc.cost_plus_structure = cbet.cost_plus_structure
AND cbcc.cost_base = cbet.cost_base
AND cbet.expenditure_type = ei.expenditure_type
AND ei.project_id = ''##$$PROJECT_ID$$##''
AND ei.expenditure_item_id = ''##$$P_EXPENDITURE_ITEM_ID$$##''',
      p_title                  => 'Burden Schedule Compiled Multipliers',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No burden schedule compiled multipliers information identified.',
      p_solution               => '',
      p_success_msg            => 'PA_COMPILED_MULTIPLIERS table stores buildup multipliers used for burdening.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_COMPILED_MULTIPLIERS');



debug('begin add_signature: PA_BURDEN_SUM_DEST_RUN_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12219',
      p_sig_id                 => 'PA_BURDEN_SUM_DEST_RUN_ID',
      p_sig_sql                => 'select *
    from PA_COST_DISTRIBUTION_LINES_ALL cdl
    where cdl.BURDEN_SUM_SOURCE_RUN_ID in
    (select ei.BURDEN_SUM_DEST_RUN_ID
    from PA_EXPENDITURE_ITEMS_ALL ei
    where ei.expenditure_item_id = ##$$P_EXPENDITURE_ITEM_ID$$##)',
      p_title                  => 'Summarized Burden Expenditure Item',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No summarized burden expenditure item have been generated for this expenditure item id.<br>  
This is available when Burden Cost is generated as separate expenditure item.<br>  ',
      p_solution               => 'The first step for any burden process type is to run the PRC: Distribute... standard raw costing processes.<br>  
The next step is to run the burden processes as follows:<br>  

    Same Expenditure items:<br>  
            PRC: Distribute Total Burden Costs<br>  
            PRC: Interface Total Burden Costs<br>  
            PRC: Tieback Total Burden Costs<br>  
    Summarized Expenditure items (Separate Expenditure Item):<br>  
            PRC: Create and Distribute Summarized Burden Transactions<br>  
            PRC: Interface Usage and Miscellaneous Costs to GL<br>  
            PRC: Tieback Usage and Miscellaneous Costs<br>  
    Burden costs reported in another Project:<br>  
        Use the same processes in a and b above.<br>  


The Summarized Burden Transactions process is responsible for placing the expenditure item in the burden project.<br>  
Please see [191136/FAQ3326] Oracle Projects Burdening Frequently Asked Questions (FAQ)
 ',
      p_success_msg            => 'The new summarized burden expenditure item created from the standard raw cost distribution lines gets a counter value, which is placed in the BURDEN_SUM_DEST_RUN_ID column of the PA_EXPENDITURE_ITEMS_ALL table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_BURDEN_SUM_DEST_RUN_ID');



debug('begin add_signature: PA_BURD_CDL_FOR_BUDERN_DISABLED_EI');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '21041',
      p_sig_id                 => 'PA_BURD_CDL_FOR_BUDERN_DISABLED_EI',
      p_sig_sql                => 'SELECT ei.expenditure_item_id,
       ei.cost_distributed_flag,
	   ...
	   ei.ind_cost_dist_rejection_code
          FROM pa_expenditure_items_all ei,
			...
			pa_tasks t
          WHERE NVL(cost_burden_distributed_flag,''Z'') NOT IN (''Y'',''N'')
      ...
      p_title                  => 'Incorrect Cost Burden Distributed Flag for Expenditure Item',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Cost Burden Distributed Flag marked with some junk character even though burden and credit line got generated',
      p_solution               => 'Please log a Service Request to get resolution from Oracle Support based on [2737522/KB380242]',
      p_success_msg            => 'Cost Burden Distributed Flag does not have junk character.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_BURD_CDL_FOR_BUDERN_DISABLED_EI');



debug('begin add_signature: PA_BURD_CDL_GENERATED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '21038',
      p_sig_id                 => 'PA_BURD_CDL_GENERATED',
      p_sig_sql                => 'SELECT ei.expenditure_item_id expenditure_item_id,
...
AND cdl.task_id = ei.task_id
AND line_type IN (''C'',''D''))',
      p_title                  => 'Burden Credit or Debit Line Generated',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Burden Credit and Burden Debit lines generated even they should not be generated',
      p_solution               => 'Please log a Service Request to get resolution from Oracle Support based on [2737522/KB380242]',
      p_success_msg            => 'Burden Credit and/or Debit Line not generated for project type with total_burden_flag as No',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_BURD_CDL_GENERATED');



debug('begin add_signature: PA_BURD_COST_DIFF_FROM_ORIG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '21037',
      p_sig_id                 => 'PA_BURD_COST_DIFF_FROM_ORIG',
      p_sig_sql                => 'SELECT e.expenditure_group expenditure_group,
cei.expenditure_item_id reversing_exp_item_id,
cei.adjusted_expenditure_item_id orig_exp_item_id,
p.segment1 project_number,
cei.raw_cost "Adjusted Raw Cost",
ei.raw_cost "Original Raw Cost",
cei.burden_cost "Adjusted Burden Cost",
ei.burden_cost "Original Burden Cost",
cei.denom_raw_cost "Adjusted Denorm Raw Cost",
ei.denom_raw_cost "Original Denorm Raw Cost",
cei.denom_burdened_cost "Adjusted Denorm Burden Cost",
ei.denom_burdened_cost "Original Denorm Burden Cost",
cei.acct_raw_cost "Adjusted Accounted Raw Cost",
ei.acct_raw_cost "Original Accounted Raw Cost",
cei.acct_burdened_cost "Adjusted Accounted Burden Cost",
ei.acct_burdened_cost "Original Accounted Burden Cost",
cei.project_raw_cost "Adjusted Project Raw Cost",
ei.project_raw_cost "Original Project Raw Cost",
cei.project_burdened_cost "Adjusted Project Burden Cost",
ei.project_burdened_cost "Original Project Burden Cost"
FROM pa_expenditure_items_all ei,
...
NVL(cei.project_burdened_cost,0) <> (NVL(ei.project_burdened_cost,0) * -1))',
      p_title                  => 'Mismatch in Original Expenditure and Adjusted Expenditure Cost',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Raw and/or Burden Cost for adjustment lines are not matching with original expenditure item id',
      p_solution               => 'Please log a Service Request to get resolution from Oracle Support based on [464491/KB198667]',
      p_success_msg            => 'There is no mismatch between raw and/or burden cost between adjusted and original expenditures',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_BURD_COST_DIFF_FROM_ORIG');



debug('begin add_signature: PA_BURD_MISSING_CR_DR_CDLS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '21039',
      p_sig_id                 => 'PA_BURD_MISSING_CR_DR_CDLS',
      p_sig_sql                => 'SELECT C1.EXPENDITURE_ITEM_ID,
          C1.LINE_NUM,
          C1.TRANSFER_STATUS_CODE,
          C1.TRANSFER_REJECTION_REASON,
          P.SEGMENT1 "PROJECT_NUMBER",
          t.TASK_NUMBER "TASK_NUMBER",
          C2.SUM_C "Total Credit Amount",
          C2.SUM_D "Total Debit Amount"
    FROM Pa_Cost_Distribution_Lines_All C1 ,
          (SELECT EXPENDITURE_ITEM_ID,
            SUM(DECODE(LINE_TYPE,''C'',AMOUNT)) SUM_C,
            SUM(DECODE(LINE_TYPE,''D'',AMOUNT)) SUM_D
          FROM Pa_Cost_Distribution_Lines_All Cdl
          WHERE LINE_TYPE          IN (''C'',''D'')
          AND Transfer_Status_Code IN (''A'',''P'',''R'')
          GROUP BY Expenditure_Item_Id
          HAVING NVL(SUM(DECODE(Line_Type,''C'',1,0)), 0) <> NVL(SUM(DECODE(Line_Type,''D'',1,0)) , 0)
          ) C2,
		  pa_projects_all p,
		  pa_tasks t
        WHERE C1.EXPENDITURE_ITEM_ID=C2.EXPENDITURE_ITEM_ID
		AND p.project_id = ##$$P_PROJECT_ID$$##
        AND C1.LINE_TYPE           IN (''C'',''D'')
        AND TRANSFER_STATUS_CODE   IN (''A'',''P'',''R'')
		AND C1.project_id = p.project_id
		AND c1.task_id = t.task_id
		AND p.project_id = t.project_id',
      p_title                  => 'Mismatch in Total Burden Credit and Total Burden Debit Amount',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Burden Credit and Burden Debit Amounts are not matching',
      p_solution               => 'Please log a Service Request to get resolution from Oracle Support based on [2737522/KB380242]',
      p_success_msg            => 'Burden Credit and Burden Debit Amounts are matching',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_BURD_MISSING_CR_DR_CDLS');



debug('begin add_signature: PA_BURD_NO_CDL_FOR_BUDERN_ENABLED_EI');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '21040',
      p_sig_id                 => 'PA_BURD_NO_CDL_FOR_BUDERN_ENABLED_EI',
      p_sig_sql                => 'SELECT ei.expenditure_item_id,
       ei.cost_distributed_flag,
	   ei.cost_burden_distributed_flag,
	   pa.segment1 "PROJECT_NUMBER",
      ...
      p_title                  => 'Missing Either Burden Debit or Burden Credit Line',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Burden Credit and/or Burden Debit Lines are missing for burden distributed expenditure item',
      p_solution               => 'Please log a Service Request to get resolution from Oracle Support based on [2737522/KB380242]',
      p_success_msg            => 'Burden Credit and Debit Lines exist for burden distributed expenditure item',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_BURD_NO_CDL_FOR_BUDERN_ENABLED_EI');



debug('begin add_signature: EBS_FIN_PA_PA_EXP_BURDEN_METHOD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29311',
      p_sig_id                 => 'EBS_FIN_PA_PA_EXP_BURDEN_METHOD',
      p_sig_sql                => 'SELECT
    type.burden_cost_flag          "Burdening Enabled",
    type.burden_amt_display_method "Burden Method"
FROM
    pa_project_types_all type,
    pa_projects_all      pp
where pp.project_id = ##$$PROJECT_ID$$##
AND pp.org_id = type.org_id
    AND pp.project_type = type.project_type
        AND type.burden_amt_display_method = ''D''
            AND type.burden_cost_flag = ''Y''',
      p_title                  => 'Burden Method for the Project',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Burden Cost as separate expenditure item is enabled for the Project.',
      p_solution               => '',
      p_success_msg            => 'Burden Cost on same expenditure item is enabled for the project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PA_EXP_BURDEN_METHOD');



debug('begin add_signature: EBS_FIN_PA_CC_EXCEPTIONS_DET');
   l_info('##MASK##EMPLOYEE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##VENDOR_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24036',
      p_sig_id                 => 'EBS_FIN_PA_CC_EXCEPTIONS_DET',
      p_sig_sql                => 'SELECT psv.project_id project_id , psv.project_number project_number , psv.task_id task_id , pt.task_number , psv.recvr_org_id recvr_org_id , 
psv.recvr_org_name recvr_org_name , psv.employee_id , pf.full_name employee_name , psv.vendor_id vendor_id , pv.vendor_name vendor_name , 
psv.non_labor_org_id non_labor_org_id , otl1.name non_labor_org_name , psv.expnd_org_id expnd_org_id , otl2.name expnd_org_name , psv.EXPENDITURE_ID , 
psv.EXPENDITURE_ITEM_ID , psv.EXPENDITURE_ITEM_DATE , psv.EXPENDITURE_TYPE , psv.CDL_LINE_NUM, psv.PA_DATE , psv.PERIOD_NAME , psv.ACCT_CURRENCY_CODE ,  psv.AMOUNT , psv.EXCEPTION_REASON , psv.CORRECTIVE_ACTION , psv.exception_code , psv.system_linkage_function 
FROM pa_cc_exceptions_sum_v psv, pa_tasks pt, per_people_f pf, po_vendors pv, hr_all_organization_units_tl otl1, hr_all_organization_units_tl otl2 
WHERE psv.task_id=pt.task_id AND psv.employee_id=pf.person_id(+) AND (not exists(select null from per_people_f where person_id=psv.employee_id) 
or sysdate between pf.effective_start_date and pf.effective_end_date ) AND psv.vendor_id=pv.vendor_id(+) 
AND psv.non_labor_org_id=otl1.organization_id(+) AND decode(otl1.organization_id,null,''1'',otl1.language)= decode(otl1.organization_id,null,''1'',userenv(''lang'')) 
AND psv.expnd_org_id=otl2.organization_id(+) AND decode(otl2.organization_id,null,''1'',otl2.language)= decode(otl2.organization_id,null,''1'',userenv(''lang'')) 
AND PSV.EXPND_ORG_ID = ##$$ORG_ID$$##
and psv.project_id = ##$$P_PROJECT_ID$$##
AND exists (select null from pa_cc_dist_lines_all where expenditure_item_id = psv.expenditure_item_id 
and line_num = psv.cdl_line_num 
and (line_type = ''BL'' or ( line_type = ''PC'' and reference_1 in (select draft_invoice_detail_id from pa_draft_invoice_Details_all 
where expenditure_item_id = psv.expenditure_item_id and draft_invoice_num is not null)))) 
order by psv.project_number, psv.period_name, psv.EXPENDITURE_ITEM_DATE desc',
      p_title                  => 'Cross Charge Exceptions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Cross charge distribution lines exist that may prevent closing a period.',
      p_solution               => 'Review the exception reason and corrective action returned.  Review the Project tab in [335/KB212329] Period Close Advisor: E-Business Suite (EBS).',
      p_success_msg            => 'No cross charge distribution lines exist that may prevent closing a period.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_CC_EXCEPTIONS_DET');



debug('begin add_signature: EBS_FIN_PA_GL_CC_EXCEPT_DET');
   l_info('##MASK##EMPLOYEE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##VENDOR_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24041',
      p_sig_id                 => 'EBS_FIN_PA_GL_CC_EXCEPT_DET',
      p_sig_sql                => 'select * from PA_GL_CC_EXCEPT_DET_V where org_id = ##$$ORG_ID$$## 
and set_of_books_id in (select set_of_books_id from pa_implementations_all where org_id=##$$ORG_ID$$##)
and project_id = ##$$P_PROJECT_ID$$##
order by project_number, period_name, expenditure_item_date desc',
      p_title                  => 'Cross Charge Distributions Primary SOB',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Cross charge distributions exist in the primary set of books that may prevent  a period from being closed.',
      p_solution               => 'Review the exception reason and corrective action returned.  Review the Project tab in [335/KB212329]  Period Close Advisor: E-Business Suite (EBS).',
      p_success_msg            => 'Cross charge distributions do not exist in the primary set of books that may prevent  a period from being closed.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GL_CC_EXCEPT_DET');
...
BEGIN
  ...
  analyzer_title := 'Projects Expenditure Processing Analyzer';
...
start_section('Proactive and Preventative Recommendations', 'Proactive');
   set_item_result(check_rec_patches_1); /* Signature PA_COST_RECOMMENDED_PATCHES */
   set_item_result(run_stored_sig('EBS_FIN_PA_PA_FORMS_PERSONALIZATIONS'));
   set_item_result(check_rec_patches_2); /* Signature EBS_PA_PAEXPND_2807662_1 */
   set_item_result(run_stored_sig('2060157.1'));
   set_item_result(run_stored_sig('TRANSACTION_IMPORT_WEB_ADI_ISSUES'));
   set_item_result(run_stored_sig('PA_WORKFLOWS_ALL_IN_ERROR'));
   set_item_result(run_stored_sig('EBS_FIN_PA_TXN_INTERFACE_TRIGGERS'));
end_section;
debug('end section: Proactive');

debug('begin section: EXPENDITURE_DATA_ISSUES');
start_section('Expenditure Data Issues', 'EXPENDITURE_DATA_ISSUES');
   set_item_result(run_stored_sig('EBS_FIN_PA_PA_OTL_DUPLICATE_EXP_ITEMS'));
   set_item_result(run_stored_sig('PA_COST_INVALID_GL_DATE'));
   set_item_result(run_stored_sig('PA_COST_EXP_COST_COLUMN_NULL'));
   set_item_result(run_stored_sig('MISSING_EXPENDITURE_GROUP'));
   set_item_result(run_stored_sig('NO_OPEN_OR_FUTURE_PA-GL_PERIOD_FOR_GIVEN_EXPENDITURE_ITEM_DATE'));
   set_item_result(run_stored_sig('PA_COST_AT_OT_CAL'));
   set_item_result(run_stored_sig('PA_COST_EXP_COST_DIST'));
   set_item_result(run_stored_sig('PA_COST_EXP_BATCH_STATUS'));
   set_item_result(run_stored_sig('PA_COST_REV_DIST_STATUS'));
   set_item_result(run_stored_sig('PA_COST_EXP_REL_STATUS'));
   set_item_result(run_stored_sig('PA_EXP_DISTR_ACCOUNTING'));
   set_item_result(run_stored_sig('PA_INVALID_PROJFUNC_CURR'));
   set_item_result(run_stored_sig('PA_CANNOT_INSERT_NULL_INTO_COST_DISTRIBUTION_LINES'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_SIGNAL11'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PA_EI_NOT_ACCOUNTED'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAEXPND_PA_PA_EI_ACCOUNTING_PERIOD_CLOSED'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAEXPND_BUR_COST_ADJ_EI_NOT_DISTRIBUTED'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAEXPND_COST_DISTRIBUTION_REJECTION'));
end_section;
debug('end section: EXPENDITURE_DATA_ISSUES');

debug('begin section: EXPENDITURE_DATA_COLLECTION');
start_section('Expenditure Data Collection', 'EXPENDITURE_DATA_COLLECTION');
   set_item_result(run_stored_sig('PA_COST_PROJ_TYPE'));
   set_item_result(run_stored_sig('PA_COST_PROJ_DATA'));
   set_item_result(run_stored_sig('PA_COST_TASK_DATA'));
   set_item_result(run_stored_sig('PA_COST_TRANSACTION_CONTROLS'));
   set_item_result(run_stored_sig('PA_COST_INT_FLAGS'));
   set_item_result(run_stored_sig('PA_COST_EXP_TYPES'));
   set_item_result(run_stored_sig('PA_COST_SYS_LINK_FUNC'));
   set_item_result(run_stored_sig('PA_COST_EXP_COA_DYM_INS'));
   set_item_result(run_stored_sig('PA_COST_EXP_GROUP'));
   set_item_result(run_stored_sig('PA_COST_EXP_DETAILS'));
   set_item_result(run_stored_sig('PA_COST_EXP_ITEM_DETAILS'));
   set_item_result(run_stored_sig('PA_COST_DIST_LINES'));
   set_item_result(run_stored_sig('PA_COST_EXP_ITEM_ALL_ADJ'));
   set_item_result(run_stored_sig('PA_COST_EXP_ITEM_ADJ_ACT'));
   set_item_result(run_stored_sig('PA_EXP_ADJUSTMENT_ACTIVITIES'));
   set_item_result(run_stored_sig('PA_COST_ADJ_EXP_ITEMS'));
   set_item_result(run_stored_sig('PA_COST_TRANSFER_FRM_EXP_ITEMS'));
   set_item_result(run_stored_sig('PA_COST_EXP_HISTORY'));
   set_item_result(run_stored_sig('PA_COST_EXP_COMMENTS'));
   set_item_result(run_stored_sig('PA_COST_EXP_ITEM_DENORM'));
   set_item_result(run_stored_sig('PA_COST_TRANSACTION_SOURCE'));
   set_item_result(run_stored_sig('OTL_PA_TIMECARD_COMPARE'));
   set_item_result(run_stored_sig('PA_EXP_INVENTORY_TRX'));
   set_item_result(run_stored_sig('PA_COST_HR_ORGANIZATION'));
   set_item_result(run_stored_sig('PA_COST_PERSON_INFO'));
   set_item_result(run_stored_sig('PA_COST_XLA_EVENTS'));
   set_item_result(run_stored_sig('PA_COST_XLA_TRANS_ENTITIES'));
   set_item_result(run_stored_sig('PA_COST_XLA_AE_HEADERS'));
   set_item_result(run_stored_sig('PA_COST_XLA_AE_LINES'));
   set_item_result(run_stored_sig('PA_COST_XLA_DIST_LINKS'));
   set_item_result(run_stored_sig('PA_COST_XLA_ACCT_ERRORS'));
   set_item_result(run_stored_sig('PA_COST_TIME_CARD_DETAILS'));
   set_item_result(run_stored_sig('PAXTRIMP_MODIFY_INTERFACE_FLAG'));
   set_item_result(run_stored_sig('PA_TXN_ACCUM'));
   set_item_result(run_stored_sig('PA_PROJECT_ACCUM_ACTUALS_HEADERS_SUMMARIZATION'));
   set_item_result(run_stored_sig('PA_CINT_EXP_TYPE_EXCL_ALL'));
   set_item_result(run_stored_sig('PA_CINT_RATE_INFO_ALL'));
   set_item_result(run_stored_sig('PA_DRAFT_REVENUES_ALL_FROM_PA_CUST_REV_DIST_LINES_ALL'));
   set_item_result(run_stored_sig('PA_COST_REV_DIST_LINES'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAEXPND_BATCH'));
end_section;
debug('end section: EXPENDITURE_DATA_COLLECTION');

debug('begin section: EXPENDITURE_HIERARCHY');
start_section('Expenditure Hierarchy', 'EXPENDITURE_HIERARCHY');
   set_item_result(run_stored_sig('PA_COST_HIE_XLA_ACCOUNTING_ERRORS'));
   set_item_result(run_stored_sig('PA_COST_EXP_TYPE_ACTIVE'));
   set_item_result(run_stored_sig('PA_COST_HIE_EXP_ITEMS'));
   set_item_result(run_stored_sig('PA_COST_HIE_CDL_DATA'));
   set_item_result(run_stored_sig('PA_COST_HIE_XLA_EVENTS'));
   set_item_result(run_stored_sig('PA_COST_HIE_XLA_AE_HEADERS'));
   set_item_result(run_stored_sig('PA_COST_HIE_XLA_AE_LINES'));
   set_item_result(run_stored_sig('PA_COST_HIE_XLA_DISTRIBUTION_LINKS'));
end_section;
debug('end section: EXPENDITURE_HIERARCHY');

debug('begin section: AUTO_ACCOUNTING');
start_section('Auto Accounting', 'AUTO_ACCOUNTING');
   set_item_result(run_stored_sig('INCORRECT_SEQUENCE_ORDER_OF_ADJUSTED_EXPENDITURE_ITEMS'));
   set_item_result(run_stored_sig('ERROR_95318_THE_ACCOUNT_CODE_COMBINATION_ID_0_SPECIFIED_FOR_LINE_2'));
   set_item_result(run_stored_sig('PA_SELECTIVE_FLEX_SEG'));
   set_item_result(run_stored_sig('PA_COST_EXP_AUTO_ACC_FUN'));
   set_item_result(run_stored_sig('PA_COST_EXP_AUTO_ACC_FUN_TRANS'));
   set_item_result(run_stored_sig('PA_COST_EXP_AUTO_ACC_SEG_RULE'));
   set_item_result(run_stored_sig('PA_COST_EXP_AUTO_ACC_RULE_NAME'));
   set_item_result(run_stored_sig('PA_COST_EXP_AUTO_ACC_LOOKUP_SET'));
   set_item_result(run_stored_sig('PA_COST_EXP_AUTO_ACC_SEG_LOOKUP_VAL'));
   set_item_result(run_stored_sig('PA_COST_EXP_AUTO_ACC_INVALID_PARAM'));
   set_item_result(run_stored_sig('AA_RULES_WITH_SQL'));
   set_item_result(run_stored_sig('PA_COST_EXP_MISS_ACC_LOOKUP_VAL'));
   set_item_result(run_stored_sig('AA_RULES_ASIGNMENTS'));
   set_item_result(run_stored_sig('AA_FUNCTIONS_NOT_CONFIGURED_FOR_ALL_TRANSACTIONS'));
   set_item_result(run_stored_sig('AA_FUNCTIONS_NOT_CONFIGURED'));
   set_item_result(run_stored_sig('DEFAULT_SUPPLIER_COST_CREDIT_ACCOUNT_IS_NOT_SET'));
   set_item_result(run_stored_sig('PA_COST_EXP_REV_ACCT_TRANS'));
   set_item_result(run_stored_sig('PA_COST_UNDO_ACCT'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAEXPND_CR_ACC_FUNCTION'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAEXPND_CR_ACC_FUN_TRANS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAEXPND_CR_ACC_INVALID_PARAM'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAEXPND_CR_ACC_LOOKUP_SEG_VAL'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAEXPND_CR_ACC_LOOKUP_SET'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAEXPND_CR_ACC_RULE'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAEXPND_CR_ACC_SEG_RULE'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAEXPND_CR_MISS_ACC_LOOKUP_VAL'));
end_section;
debug('end section: AUTO_ACCOUNTING');

debug('begin section: COST_RATES');
start_section('Cost Rates', 'COST_RATES');
   set_item_result(run_stored_sig('PA_COST_BILL_RATES'));
   set_item_result(run_stored_sig('PA_COST_EXP_NON_LAB'));
   set_item_result(run_stored_sig('PA_COST_RATE_COMP_DETAILS'));
   set_item_result(run_stored_sig('PA_COST_ORG_LABOR_SCH_RULE'));
   set_item_result(run_stored_sig('PA_COST_RATE_DATA'));
   set_item_result(run_stored_sig('PA_COST_EXP_LAB_OVERRIDE'));
   set_item_result(run_stored_sig('PA_COST_EXP_NON_LAB_OVERRIDE'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAEXPND_NO_RATE_JOB_ID_NOT_NULL'));
end_section;
debug('end section: COST_RATES');

debug('begin section: BURDENING');
start_section('Burdening', 'BURDENING');
   set_item_result(run_stored_sig('PA_IND_RATE_SCHEDULES'));
   set_item_result(run_stored_sig('PA_IND_RATE_SCH_REVISIONS'));
   set_item_result(run_stored_sig('PA_IND_COST_MULTIPLIERS'));
   set_item_result(run_stored_sig('PA_COST_PLUS_STRUCTURES'));
   set_item_result(run_stored_sig('PA_COST_BASES'));
   set_item_result(run_stored_sig('PA_COST_BASE_COST_CODES'));
   set_item_result(run_stored_sig('PA_COST_BASE_EXP_TYPES'));
   set_item_result(run_stored_sig('PA_COMPILED_MULTIPLIERS'));
   set_item_result(run_stored_sig('PA_BURDEN_SUM_DEST_RUN_ID'));
   set_item_result(run_stored_sig('PA_BURD_CDL_FOR_BUDERN_DISABLED_EI'));
   set_item_result(run_stored_sig('PA_BURD_CDL_GENERATED'));
   set_item_result(run_stored_sig('PA_BURD_COST_DIFF_FROM_ORIG'));
   set_item_result(run_stored_sig('PA_BURD_MISSING_CR_DR_CDLS'));
   set_item_result(run_stored_sig('PA_BURD_NO_CDL_FOR_BUDERN_ENABLED_EI'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PA_EXP_BURDEN_METHOD'));
end_section;
debug('end section: BURDENING');

debug('begin section: PERIOD_CLOSE');
start_section('Period Close Exceptions', 'PERIOD_CLOSE');
   set_item_result(run_stored_sig('EBS_FIN_PA_CC_EXCEPTIONS_DET'));
   set_item_result(run_stored_sig('EBS_FIN_PA_GL_CC_EXCEPT_DET'));
end_section;
debug('end section: PERIOD_CLOSE');

debug('begin section: AppsCheck');
start_section('Apps Check', 'AppsCheck');
