...
REM |                                                                           |
REM | FILENAME                                                                  |
REM |    ar_adj_analyzer.sql                                                    |
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Receivables Adjustment Analyzer        |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE ar_adj_analyzer_pkg AUTHID DEFINER AS
...
(            p_user_name                    IN VARCHAR2    DEFAULT NULL
           ...
           ,p_adjustment_id                IN VARCHAR2    DEFAULT NULL
...
END ar_adj_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY ar_adj_analyzer_pkg AS
-- $Id: ar_adj_analyzer.sql, 200.65 2025/12/08 13:36:42 shramish Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2069916.1));
...
g_adjid			VARCHAR2(200);
g_adjnum		VARCHAR2(200);		
g_adjtype		VARCHAR2(200);
g_adjmeaning		VARCHAR2(200);
g_trxid			VARCHAR2(200);
g_trxlineid		VARCHAR2(200);
g_adjpsid		VARCHAR2(200);
g_cbtrxid		VARCHAR2(200);
g_rctid			VARCHAR2(200);
g_status		VARCHAR2(200);
g_amount		VARCHAR2(200);
g_adjacctdamt		VARCHAR2(200);
g_ax_accounted_flag	VARCHAR2(1);
g_adjtrxid		VARCHAR2(200);		
g_trxnum		VARCHAR2(200);
g_custref		VARCHAR2(200); 
g_source		VARCHAR2(200);
g_trxtype		VARCHAR2(200);
g_trxclass		VARCHAR2(200);
g_trxdate		VARCHAR2(200);
g_complete		VARCHAR2(200);
g_curr			VARCHAR2(200);
g_rate			VARCHAR2(200);	
g_terms			VARCHAR2(200);
g_duedate		VARCHAR2(200);
g_invrule		VARCHAR2(200);
g_trxstatus		VARCHAR2(200);
g_origtrxid		VARCHAR2(200);
g_prevtrxid		VARCHAR2(200);

g_bill_to_customer_id   NUMBER;
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'AR_ADJ_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'AR_ADJ_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>AR_ADJ Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2069916.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/ar_adj_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,765,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,765,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},765,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/3816899" class="blacklink" target="new">
...
<p>What&apos;s new:</p><ul><li>Improved signatures</li>
</ul>
<p>&nbsp;</p>
            <br><br>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,765,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,765,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},765,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
debug('begin populate parameters hash table');
   ...
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Adjustment ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_adjustment_id,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Include GL';
...
-- Revision and date values can be populated by RCS
  l_revision := rtrim(replace('$Revision: 200.65  $','$',''));
  l_revision := ltrim(replace(l_revision,'Revision:',''));
  l_date_char := rtrim(replace('$Date: 2025/12/08 13:36:41 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'ar_adj_analyzer.sql';
...
debug('begin parameter validation: p_adjustment_id');
IF p_adjustment_id IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Adjustment ID is required.');
   raise invalid_parameters;
END IF;
...
WHERE ADJ.ADJUSTMENT_ID = p_adjustment_id
 AND (mo_global.is_mo_init_done = 'N' or mo_global.check_access(adj.org_id) = 'Y')
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: The Adjustment Number/ID does not exist in AR_ADJUSTMENTS_ALL, but will continue to look for orphan records.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_adjustment_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_adjustment_id');

debug('begin parameter validation: p_includeGL');
IF p_includeGL IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Include GL is required.');
   raise invalid_parameters;
END IF;
IF p_includeGL IS NOT NULL AND p_includeGL NOT IN ( 'N','Y') THEN
   print_error('INVALID ARGUMENT: Invalid Include GL value.  Valid values are Y or N.');
   raise invalid_parameters;
END IF;
...
g_adjustment_id_tmp := p_adjustment_id;
g_user_name_tmp := p_user_name;
g_resp_id_tmp := p_resp_id;

----Validate Adjustment ID

IF g_adjustment_id_tmp is null THEN
    print_log('The adjustment_id parameter is mandatory.');
    raise invalid_parameters;
ELSE
   BEGIN
   ...
   execute immediate 'alter session set NLS_DATE_FORMAT = ''DD-MON-YYYY''';
     ...
     SELECT   a.org_id,
              to_char(a.adjustment_id),
              a.adjustment_number,
              a.type,
              l.meaning,
              to_char(a.customer_trx_id), 
              to_Char(a.customer_trx_line_id),
              to_char(a.payment_schedule_id),
              to_char(a.chargeback_customer_trx_id),
              to_char(a.associated_cash_receipt_id),
              a.status,
              to_char(a.amount),
              to_char(a.acctd_amount),
              a.ax_accounted_flag,
              a.gl_date
    into      g_org_id_tmp,
              g_adjid,
    ...
    FROM      AR_ADJUSTMENTS_ALL     a,          
              AR_LOOKUPS         l  
    WHERE     a.adjustment_id  = g_adjustment_id_tmp
    AND       l.lookup_type = 'ADJUSTMENT_CREATION_TYPE' 
    AND       l.lookup_code = a.adjustment_type;

    SELECT   to_char(trx.customer_trx_id),
             trx.trx_number,
             trx.customer_reference,
             bat.name,
             typ.name,
             typ.type,
             to_char(trx.trx_date,'DD-MON-YYYY'),
             trx.complete_flag, 
             trx.invoice_currency_code,
             to_char(trx.exchange_rate),
             pay.name,
             to_char(trx.term_due_date,'DD-MON-YYYY'),
             rul.name, 
             trx.status_trx,
             to_char(trx.initial_customer_trx_id),
             to_char(trx.previous_customer_trx_id),
             decode(typ.type, 'BR', trx.drawee_site_use_id, trx.bill_to_site_use_id),
             decode(typ.type, 'BR', trx.drawee_id, trx.bill_to_customer_id)
    into     g_adjtrxid,
             g_trxnum,
             g_custref,
             g_source,
             ...
             g_origtrxid,
             g_prevtrxid,
             g_bill_to_site_use_id,
             g_bill_to_customer_id
    FROM     RA_CUSTOMER_TRX_ALL   trx,          
             RA_CUST_TRX_TYPES_ALL typ,          
             RA_BATCH_SOURCES_ALL  bat,          
             RA_TERMS              pay,          
             RA_RULES              rul  
    WHERE    trx.customer_trx_id  = to_number(g_trxid)
    AND      typ.cust_trx_type_id(+) = trx.cust_trx_type_id 
    AND      NVL(typ.org_id(+), -99) = NVL(trx.org_id,  -99) 
    AND      bat.batch_source_id(+)  = trx.batch_source_id 
    AND      NVL(bat.org_id(+), -99) = NVL(trx.org_id, -99) 
    AND      pay.term_id(+)          = trx.term_id 
    AND      rul.rule_id(+)          = trx.invoicing_rule_id;

   if g_bill_to_site_use_id is not null then
      -- get Customer related IDs once for use in CUSTOMER DATA sigs
      ...
      where su.site_use_id = g_bill_to_site_use_id   
   ...
   and    g_gl_date between start_date and end_date
  ...
  where  ledger_id = g_ledger_id;
      ...
      loop
         ...
         print_log('Conditions tp check rules: ' || g_seg_cond); 
   

   EXCEPTION
   WHEN NO_DATA_FOUND then
     print_log('Adjustment_id does not exist in AR_ADJUSTMENTS_ALL, but will continue to look for orphan records.');
     -- raise invalid_parameters; 
     END;
END IF;
...
print_log('SQL Token Values');
  ...
  where adjustment_id = g_adjustment_id_tmp
  );
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$ADJID$$##') := g_adjustment_id_tmp;
   g_masked_tokens('##$$ADJID$$##') := mask_text( g_sql_tokens('##$$ADJID$$##'), 'NO_MASK');
   ...
   g_sql_tokens('##$$ADJNUM$$##') := g_adjnum;
   g_masked_tokens('##$$ADJNUM$$##') := mask_text( g_sql_tokens('##$$ADJNUM$$##'), 'NO_MASK');
   g_sql_tokens('##$$ADJTYPE$$##') := g_adjtype;
   g_masked_tokens('##$$ADJTYPE$$##') := mask_text( g_sql_tokens('##$$ADJTYPE$$##'), 'NO_MASK');
   g_sql_tokens('##$$ADJMEANING$$##') := g_adjmeaning;
   g_masked_tokens('##$$ADJMEANING$$##') := mask_text( g_sql_tokens('##$$ADJMEANING$$##'), 'NO_MASK');
   g_sql_tokens('##$$TRX_ID$$##') := g_trxid;
   g_masked_tokens('##$$TRX_ID$$##') := mask_text( g_sql_tokens('##$$TRX_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$TRXLINEID$$##') := g_trxlineid;
   g_masked_tokens('##$$TRXLINEID$$##') := mask_text( g_sql_tokens('##$$TRXLINEID$$##'), 'NO_MASK');
   g_sql_tokens('##$$ADJPSID$$##') := g_adjpsid;
   g_masked_tokens('##$$ADJPSID$$##') := mask_text( g_sql_tokens('##$$ADJPSID$$##'), 'NO_MASK');
   g_sql_tokens('##$$CBTRXID$$##') := g_cbtrxid;
   g_masked_tokens('##$$CBTRXID$$##') := mask_text( g_sql_tokens('##$$CBTRXID$$##'), 'NO_MASK');
   g_sql_tokens('##$$RCTID$$##') := g_rctid;
   g_masked_tokens('##$$RCTID$$##') := mask_text( g_sql_tokens('##$$RCTID$$##'), 'NO_MASK');
   g_sql_tokens('##$$ADJSTATUS$$##') := g_status;
   g_masked_tokens('##$$ADJSTATUS$$##') := mask_text( g_sql_tokens('##$$ADJSTATUS$$##'), 'NO_MASK');
   g_sql_tokens('##$$ADJAMT$$##') := g_amount;
   g_masked_tokens('##$$ADJAMT$$##') := mask_text( g_sql_tokens('##$$ADJAMT$$##'), 'NO_MASK');
   g_sql_tokens('##$$ADJACCTDAMT$$##') := g_adjacctdamt;
   g_masked_tokens('##$$ADJACCTDAMT$$##') := mask_text( g_sql_tokens('##$$ADJACCTDAMT$$##'), 'NO_MASK');
   g_sql_tokens('##$$TRXNUMBER$$##') := g_trxnum;
   g_masked_tokens('##$$TRXNUMBER$$##') := mask_text( g_sql_tokens('##$$TRXNUMBER$$##'), 'NO_MASK');
   g_sql_tokens('##$$CUSTREF$$##') := g_custref;
   g_masked_tokens('##$$CUSTREF$$##') := mask_text( g_sql_tokens('##$$CUSTREF$$##'), 'DISPLAY_BOTH_25_PCNT_WORD');
   g_sql_tokens('##$$SOURCE$$##') := g_source;
   g_masked_tokens('##$$SOURCE$$##') := mask_text( g_sql_tokens('##$$SOURCE$$##'), 'NO_MASK');
   g_sql_tokens('##$$TYPENAME$$##') := g_trxtype;
   g_masked_tokens('##$$TYPENAME$$##') := mask_text( g_sql_tokens('##$$TYPENAME$$##'), 'NO_MASK');
   g_sql_tokens('##$$TYPE$$##') := g_trxclass;
   g_masked_tokens('##$$TYPE$$##') := mask_text( g_sql_tokens('##$$TYPE$$##'), 'NO_MASK');
   g_sql_tokens('##$$TRXDATE$$##') := g_trxdate;
   g_masked_tokens('##$$TRXDATE$$##') := mask_text( g_sql_tokens('##$$TRXDATE$$##'), 'NO_MASK');
   g_sql_tokens('##$$COMPLETE_FLAG$$##') := g_complete;
   g_masked_tokens('##$$COMPLETE_FLAG$$##') := mask_text( g_sql_tokens('##$$COMPLETE_FLAG$$##'), 'NO_MASK');
   g_sql_tokens('##$$CURRENCY$$##') := g_curr;
   g_masked_tokens('##$$CURRENCY$$##') := mask_text( g_sql_tokens('##$$CURRENCY$$##'), 'NO_MASK');
   g_sql_tokens('##$$EXCHRATE$$##') := g_rate;
   g_masked_tokens('##$$EXCHRATE$$##') := mask_text( g_sql_tokens('##$$EXCHRATE$$##'), 'NO_MASK');
   g_sql_tokens('##$$TERMS$$##') := g_terms;
   g_masked_tokens('##$$TERMS$$##') := mask_text( g_sql_tokens('##$$TERMS$$##'), 'NO_MASK');
   g_sql_tokens('##$$DUE$$##') := g_duedate;
   g_masked_tokens('##$$DUE$$##') := mask_text( g_sql_tokens('##$$DUE$$##'), 'NO_MASK');
   g_sql_tokens('##$$RULE$$##') := g_invrule;
   g_masked_tokens('##$$RULE$$##') := mask_text( g_sql_tokens('##$$RULE$$##'), 'NO_MASK');
   g_sql_tokens('##$$STATUS$$##') := g_trxstatus;
   g_masked_tokens('##$$STATUS$$##') := mask_text( g_sql_tokens('##$$STATUS$$##'), 'NO_MASK');
   g_sql_tokens('##$$ORIG$$##') := g_origtrxid;
   g_masked_tokens('##$$ORIG$$##') := mask_text( g_sql_tokens('##$$ORIG$$##'), 'NO_MASK');
   g_sql_tokens('##$$CRED$$##') := g_prevtrxid;
   g_masked_tokens('##$$CRED$$##') := mask_text( g_sql_tokens('##$$CRED$$##'), 'NO_MASK');
   ...
   g_sql_tokens('##$$A$$##') := 'AR_ADJ_ANALYZER_PKG';
   ...
   g_sql_tokens('##$$G_BILL_TO_CUSTOMER_ID$$##') := G_BILL_TO_CUSTOMER_ID;
   g_masked_tokens('##$$G_BILL_TO_CUSTOMER_ID$$##') := mask_text( g_sql_tokens('##$$G_BILL_TO_CUSTOMER_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$G_BILL_TO_SITE_USE_ID$$##') := G_BILL_TO_SITE_USE_ID;
   g_masked_tokens('##$$G_BILL_TO_SITE_USE_ID$$##') := mask_text( g_sql_tokens('##$$G_BILL_TO_SITE_USE_ID$$##'), 'NO_MASK');
...
debug('begin add_signature: AR_ADJ_SUMMARY_INFO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6345',
      p_sig_id                 => 'AR_ADJ_SUMMARY_INFO',
      p_sig_sql                => 'select 1 "Row", ''Adjustment Id'' "Field Name", ''##$$ADJID$$##'' "Value"
from dual
union
select 2, ''Adjustment Number'',  ''##$$ADJNUM$$##''
from dual
union
select 3, ''Type'', ''##$$ADJTYPE$$##''
from dual
union
select 4, ''Adjustment Type'', ''##$$ADJMEANING$$##''
from dual
union
select 5, ''Customer Trx Id'', ''##$$TRX_ID$$##''
from dual
union
select 6, ''Customer Trx Line Id'', ''##$$TRXLINEID$$##''
from dual
union
select 7, ''Payment Schedule Id'', ''##$$ADJPSID$$##''
from dual
union
select 8, ''Chargeback Customer Trx Id'', ''##$$CBTRXID$$##''
from dual
union
select 9, ''Associated Cash Receipt Id'', ''##$$RCTID$$##''
from dual
union
select 10, ''Status'', ''##$$ADJSTATUS$$##''
from dual
union
select 11, ''Amount'', ''##$$ADJAMT$$##''
from dual
union
select 12, ''Acctd Amount'', ''##$$ADJACCTDAMT$$##''
from dual
union
select 13, ''Org Id'', ''##$$ORGID$$##''
from dual
union
select 14, ''Ledger Id'', ''##$$LEDGERID$$##''
from dual',
      p_title                  => 'Adjustment Summary Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no adjustment summary information for this adjustment.',
      p_solution               => 'No adjustment summary information to display.',
      p_success_msg            => 'Displaying adjustment summary information.',
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_SUMMARY_INFO');



debug('begin add_signature: AR_TRX_SUMMARY_INFO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6061',
      p_sig_id                 => 'AR_TRX_SUMMARY_INFO',
      p_sig_sql                => 'select 1 "Row", ''Customer Trx Id'' "Field Name", ''##$$TRX_ID$$##'' "Value"
from dual
union
select 2, ''Transaction Number'',  ''##$$TRXNUMBER$$##''
from dual
union
select 3, ''Customer Reference'', ''##$$CUSTREF$$##''
from dual
union
select 4, ''Source'', ''##$$SOURCE$$##''
from dual
union
select 5, ''Type'', ''##$$TYPENAME$$##''
from dual
union
select 6, ''Class'', ''##$$TYPE$$##''
from dual
union
select 7, ''Trx Date'', ''##$$TRXDATE$$##''
from dual
union
select 8, ''Complete'', ''##$$COMPLETE_FLAG$$##''
from dual
union
select 9, ''Currency'', ''##$$CURRENCY$$##''
from dual
union
select 10, ''Ledger Currency'', ''##$$LEDGERCUR$$##''
from dual
union
select 11, ''Exchange Rate'', ''##$$EXCHRATE$$##''
from dual
union
select 12, ''Payment Terms'', ''##$$TERMS$$##''
from dual
union
select 13, ''Due Date'', ''##$$DUE$$##''
from dual
union
select 14, ''Invoicing Rule'', ''##$$RULE$$##''
from dual
union
select 15, ''Original Customer Trx Id'', ''##$$ORIG$$##''
from dual
union
select 16, ''Credited Customer Trx Id'', ''##$$CRED$$##''
from dual
union
select 17, ''Org Id'', ''##$$ORGID$$##''
from dual
union
select 18, ''Ledger Id'', ''##$$LEDGERID$$##''
from dual
order by 1 ',
      p_title                  => 'Transaction Summary Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no transaction summary information for this transaction.',
      p_solution               => 'No transaction summary information to display. ',
      p_success_msg            => 'Displaying transaction summary information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_TRX_SUMMARY_INFO');



debug('begin add_signature: AR_ADJ_AR_ADJUSTMENTS_ALL');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4940',
      p_sig_id                 => 'AR_ADJ_AR_ADJUSTMENTS_ALL',
      p_sig_sql                => 'SELECT * 
from AR_ADJUSTMENTS_ALL
where adjustment_id = ##$$ADJID$$##',
      p_title                  => 'AR_ADJUSTMENTS_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found for adjustment number/ID provided.',
      p_solution               => 'Please verify the adjustment number/ID chosen to ensure it exists in the database.',
      p_success_msg            => 'Displaying adjustment data in AR_ADJUSTMENTS_ALL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_AR_ADJUSTMENTS_ALL');



debug('begin add_signature: AR_ADJ_AR_DISTRIBUTIONS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4943',
      p_sig_id                 => 'AR_ADJ_AR_DISTRIBUTIONS_ALL',
      p_sig_sql                => 'SELECT * 
from   AR_DISTRIBUTIONS_ALL
where  source_id = ##$$ADJID$$##
and    source_table = ''ADJ''
order by line_id',
      p_title                  => 'AR_DISTRIBUTIONS_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no distribution lines for this adjustment in AR_DISTRIBUTIONS_ALL. This does not necessarily indicate an error/issue exists.

',
      p_solution               => 'No distribution lines for this adjustment in AR_DISTRIBUTIONS_ALL.',
      p_success_msg            => 'Displaying distribution lines for this adjustment in AR_DISTRIBUTIONS_ALL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_AR_DISTRIBUTIONS_ALL');



debug('begin add_signature: AR_ADJ_AR_DISTRIBUTIONS_ALL_TOTALS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4944',
      p_sig_id                 => 'AR_ADJ_AR_DISTRIBUTIONS_ALL_TOTALS',
      p_sig_sql                => 'SELECT   dis.source_table, 
         sum(dis.amount_dr) SUM_AMOUNT_DR,
         sum(dis.amount_cr) SUM_AMOUNT_CR,
         sum(dis.acctd_amount_dr) SUM_ACCTD_AMOUNT_DR,
         sum(dis.acctd_amount_cr) SUM_ACCTD_AMT_CR,
         sum(dis.from_amount_dr) SUM_FROM_AMOUNT_DR,
         sum(dis.from_amount_cr) SUM_FROM_AMOUNT_CR,
         sum(dis.from_acctd_amount_dr) SUM_FROM_ACCTD_AMOUNT_DR,
         sum(dis.from_acctd_amount_cr) SUM_FROM_ACCTD_AMOUNT_CR,
        decode(nvl(sum(dis.amount_dr),0)-nvl(sum(dis.amount_cr),0)+
                      nvl(sum(dis.acctd_amount_dr),0)-nvl(sum(dis.acctd_amount_cr),0)+
                      nvl(sum(dis.from_amount_dr),0)-nvl(sum(dis.from_amount_cr),0)+
                      nvl(sum(dis.from_acctd_amount_dr),0)-nvl(sum(dis.from_acctd_amount_cr),0), 
                      0, ''BALANCED'',''OUT OF BALANCE'') STATUS
FROM     AR_DISTRIBUTIONS_ALL dis,
         AR_ADJUSTMENTS_ALL adj
WHERE    adj.adjustment_id = ##$$ADJID$$##
...
GROUP BY dis.source_table',
      ...
      p_problem_descr          => 'The distribution amounts for this adjustment are out of balance.',
      p_solution               => 'Please review the Data Integrity section of this analyzer, to identify the issue that may be causing the out of balance condition.',
      p_success_msg            => 'Displaying total of distributions for this adjustment in AR_DISTRIBUTIONS_ALL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_AR_DISTRIBUTIONS_ALL_TOTALS');



debug('begin add_signature: AR_ADJ_AR_RECEIVABLES_TRX_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22089',
      p_sig_id                 => 'AR_ADJ_AR_RECEIVABLES_TRX_ALL',
      p_sig_sql                => 'select 
adj.adjustment_id,
...
from ar_adjustments_all adj , ar_receivables_trx_all art
where adj.receivables_trx_id = art.receivables_trx_id
and adj.org_id = art.org_id
and adj.adjustment_id = ##$$ADJID$$##
',
      p_title                  => 'AR_RECEIVABLES_TRX_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Displaying Receivable Activity for this Adjustment in AR_RECEIVABLES_TRX_ALL',
      p_solution               => 'There is no receivable activity for this adjustment in AR_RECEIVABLES_TRX_ALL',
      p_success_msg            => 'Displaying Receivable Activity for this Adjustment in AR_RECEIVABLES_TRX_ALL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_AR_RECEIVABLES_TRX_ALL');



debug('begin add_signature: AR_ADJ_AR_ACCOUNTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4945',
      p_sig_id                 => 'AR_ADJ_AR_ACCOUNTS',
      p_sig_sql                => 'SELECT distinct code_combination_id, concatenated_segments account, 
...
where  code_combination_id in (select distinct code_combination_id
                               ...
                               and    source_table = ''ADJ''
                               union
                               select art.code_combination_id
                               from   ar_adjustments_all adj,
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'GL Accounts used by this adjustment do not exist in GL_CODE_COMBINATIONS_KFV.
',
      p_solution               => 'Please review the GL accounts used by the adjustment and ensure the GL accounts are defined.',
      p_success_msg            => 'Displaying GL accounts in AR for this adjustment from GL_CODE_COMBINATIONS_KFV ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_AR_ACCOUNTS');



debug('begin add_signature: AR_ADJ_VIOLATE_CROSS_VAL_RULE');
   l_info('##SHOW_SQL##'):= 'Y';
  ...
  add_signature(
      p_sig_repo_id            => '15962',
      p_sig_id                 => 'AR_ADJ_VIOLATE_CROSS_VAL_RULE',
      p_sig_sql                => 'select distinct adj.adjustment_id,
           adj.adjustment_number,
...
and rule.enabled_flag = ''Y''',
      p_title                  => 'Adjustment Uses GL Account which may Violate Cross-Validation Rules',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Adjustment uses a GL Account with segment that violates the cross-validation rules.',
      p_solution               => '<ul>
...
<li>If you need further assistance, please log a Service Request and upload this analyzer output.</li>
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_VIOLATE_CROSS_VAL_RULE');



debug('begin add_signature: AR_ADJ_XLA_TRANSACTION_ENTITIES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4946',
      p_sig_id                 => 'AR_ADJ_XLA_TRANSACTION_ENTITIES',
      p_sig_sql                => 'SELECT *
FROM   xla_transaction_entities_upg
WHERE  application_id = 222
AND    entity_code in (''ADJUSTMENTS'',''MANUAL'')
and    nvl(source_id_int_1,-99) = ##$$ADJID$$##
order by entity_id',
      p_title                  => 'XLA_TRANSACTION_ENTITIES',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no SLA transaction entities for this adjustment in XLA_TRANSACTION_ENTITIES. ',
      p_solution               => 'No SLA transaction entities for this adjustment in XLA_TRANSACTION_ENTITIES. ',
      p_success_msg            => 'Displaying SLA transaction entities for this adjustment in XLA_TRANSACTION_ENTITIES. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_XLA_TRANSACTION_ENTITIES');



debug('begin add_signature: AR_ADJ_XLA_EVENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4947',
      p_sig_id                 => 'AR_ADJ_XLA_EVENTS',
      p_sig_sql                => 'SELECT * 
FROM   XLA_EVENTS 
WHERE  application_id = 222  
and    entity_id in
       (SELECT entity_id
        ...
        AND    xte.entity_code in (''ADJUSTMENTS'',''MANUAL'')
        and    nvl(source_id_int_1,-99) = ##$$ADJID$$##)
order  by event_id',
      p_title                  => 'XLA_EVENTS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no SLA events for this adjustment in XLA_EVENTS. ',
      p_solution               => 'No SLA events for this adjustment in XLA_EVENTS. ',
      p_success_msg            => 'Displaying SLA events for this adjustment in XLA_EVENTS. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_XLA_EVENTS');



debug('begin add_signature: AR_ADJ_XLA_AE_HEADERS');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4948',
      p_sig_id                 => 'AR_ADJ_XLA_AE_HEADERS',
      p_sig_sql                => 'SELECT * 
FROM  XLA_AE_HEADERS
WHERE application_id = 222
...
order  by ae_header_id',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no SLA headers for this adjustment in XLA_AE_HEADERS. This does not necessarily indicate an error/issue exists.',
      p_solution               => 'No SLA headers for this adjustment in XLA_AE_HEADERS.',
      p_success_msg            => 'Displaying SLA headers for this adjustment in XLA_AE_HEADERS.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_XLA_AE_HEADERS');



debug('begin add_signature: AR_ADJ_XLA_AE_LINES');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4949',
      p_sig_id                 => 'AR_ADJ_XLA_AE_LINES',
      p_sig_sql                => 'SELECT * 
FROM   XLA_AE_LINES
...
order by ae_header_id, ae_line_num',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no SLA lines for this adjustment in XLA_AE_LINES. This does not necessarily indicate an error/issue exists.',
      p_solution               => 'No SLA lines for this adjustment in XLA_AE_LINES.',
      p_success_msg            => 'Displaying SLA lines for this adjustment in XLA_AE_LINES.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_XLA_AE_LINES');



debug('begin add_signature: AR_ADJ_XLA_ ACCOUNTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4951',
      p_sig_id                 => 'AR_ADJ_XLA_ ACCOUNTS',
...
where  code_combination_id in (select distinct code_combination_id
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no GL Accounts used by this adjustment in Subledger Accounting do not exist in GL_CODE_COMBINATIONS_KFV.
',
      p_solution               => 'No GL Accounts used by this adjustment in Subledger Accounting do not exist in GL_CODE_COMBINATIONS_KFV.',
      p_success_msg            => 'Displaying GL Accounts used by this adjustment in Subledger Accounting do not exist in GL_CODE_COMBINATIONS_KFV.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_XLA_ ACCOUNTS');



debug('begin add_signature: AR_ADJ_XLA_DISTRIBUTION_LINKS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4952',
      p_sig_id                 => 'AR_ADJ_XLA_DISTRIBUTION_LINKS',
      p_sig_sql                => 'SELECT * 
...
order by ae_header_id, ae_line_num',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no SLA distribution lines for this adjustment in XLA_DISTRIBUTION_LINKS. This does not necessarily indicate an error/issue exists.',
      p_solution               => 'No SLA distribution lines for this adjustment in XLA_DISTRIBUTION_LINKS.',
      p_success_msg            => 'Displaying SLA distribution lines for this adjustment in XLA_DISTRIBUTION_LINKS.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_XLA_DISTRIBUTION_LINKS');



debug('begin add_signature: AR_ADJ_XLA_ACCOUNTING_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4953',
      p_sig_id                 => 'AR_ADJ_XLA_ACCOUNTING_ERRORS',
      p_sig_sql                => 'select *
...
order by event_id',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no accounting errors for this adjustment in XLA_ACCOUNTING_ERRORS. This does not necessarily indicate an error/issue exists.
',
      p_solution               => 'No accounting errors for this adjustment in XLA_ACCOUNTING_ERRORS.',
      p_success_msg            => 'Displaying accounting errors for this adjustment in XLA_ACCOUNTING_ERRORS.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_XLA_ACCOUNTING_ERRORS');



debug('begin add_signature: EBS_FIN_AR_ADJ_XLA_CUSTOM_ADRS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23358',
      p_sig_id                 => 'EBS_FIN_AR_ADJ_XLA_CUSTOM_ADRS',
...
ORDER BY
    adr.accounting_line_code',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no custom ADR associated with this adjustment''s Accounting. This does not necessarily indicate an error/issue exists.
',
      p_solution               => 'No custom ADR associated with this adjustment''s Accounting.',
      p_success_msg            => 'Displaying Custom ADR''s associated with this adjustment''s Accounting.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_ADJ_XLA_CUSTOM_ADRS');



debug('begin add_signature: AR_ADJ_AX_EVENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5595',
      p_sig_id                 => 'AR_ADJ_AX_EVENTS',
      p_sig_sql                => 'SELECT *
FROM   AX.AX_EVENTS
WHERE  application_id = 222
AND    event_field1 = ##$$ADJID$$##
AND    event_type = (''NON_CASH_ADJUSTMENT'') 
ORDER  BY set_of_books_id',
      p_title                  => 'AX_EVENTS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no AX events for this adjustment in AX_EVENTS. This does not necessarily indicate an error/issue exists.',
      p_solution               => 'No AX events for this adjustment in AX_EVENTS.',
      p_success_msg            => 'Displaying AX events for this adjustment in AX_EVENTS.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_AX_EVENTS');



debug('begin add_signature: AR_ADJ_AX_SLE_HEADERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5596',
      p_sig_id                 => 'AR_ADJ_AX_SLE_HEADERS',
      p_sig_sql                => 'SELECT H.*
FROM   AX.AX_EVENTS E,
       AX.AX_SLE_HEADERS H
...
ORDER BY H.set_of_books_id, H.journal_sequence_id, H.sle_header_id',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no AX header lines for this adjustment in AX_SLE_HEADERS. This does not necessarily indicate an error/issue exists.',
      p_solution               => 'No AX header lines for this adjustment in AX_SLE_HEADERS.',
      p_success_msg            => 'Displaying AX header lines for this adjustment in AX_SLE_HEADERS.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_AX_SLE_HEADERS');



debug('begin add_signature: AR_ADJ_AX_SLE_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5597',
      p_sig_id                 => 'AR_ADJ_AX_SLE_LINES',
      p_sig_sql                => 'SELECT L.*
FROM   AX.AX_EVENTS E,
       AX.AX_SLE_HEADERS H,
       AX.AX_SLE_LINES L
...
ORDER BY L.set_of_books_id, L.journal_sequence_id, L.sle_header_id, L.sle_line_num',
      p_title                  => 'AX_SLE_LINES',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no AX lines for this adjustment in AX_SLE_LINES. This does not necessarily indicate an error/issue exists.
',
      p_solution               => 'No AX lines for this adjustment in AX_SLE_LINES.',
      p_success_msg            => 'Displaying AX lines for this adjustment in AX_SLE_LINES.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_AX_SLE_LINES');



debug('begin add_signature: AR_ADJ_RA_CUSTOMER_TRX_ALL');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '4917',
      p_sig_id                 => 'AR_ADJ_RA_CUSTOMER_TRX_ALL',
      p_sig_sql                => 'SELECT * 
    from RA_CUSTOMER_TRX_ALL
    where customer_trx_id = ##$$TRX_ID$$##',
      p_title                  => 'RA_CUSTOMER_TRX_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no transaction header for the adjusted transaction in RA_CUSTOMER_TRX_ALL.
',
      p_solution               => 'No transaction header for the adjusted transaction in RA_CUSTOMER_TRX_ALL.',
      p_success_msg            => 'Displaying transaction header for the adjusted transaction in RA_CUSTOMER_TRX_ALL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_RA_CUSTOMER_TRX_ALL');



debug('begin add_signature: AR_ADJ_TRX_FND_CURRENCY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22452',
      p_sig_id                 => 'AR_ADJ_TRX_FND_CURRENCY',
      p_sig_sql                => 'select  cur.currency_code,
            cur.precision,
            cur.minimum_accountable_unit,
            cur.last_update_date
from    fnd_currencies cur
where   currency_code in (select invoice_currency_code 
                          from   ra_customer_trx_all
                          where  customer_trx_id = ##$$TRX_ID$$##)
union
...
',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Transaction and ledger currency code and precision.',
      p_solution               => 'There is no currency on the transaction.',
      p_success_msg            => 'Displaying transaction and ledger currency code and precision.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_TRX_FND_CURRENCY');



debug('begin add_signature: AR_ADJ_TRX_GL_DAILY_RATES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22453',
      p_sig_id                 => 'AR_ADJ_TRX_GL_DAILY_RATES',
...
AND    conversion_date = to_date(''##$$TRXDATE$$##'',''DD-MON-YYYY'')
ORDER BY from_currency,
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no exchange rate defined for the invoice currency.  ',
      p_solution               => 'Please make sure you setup an exchange_rate for '||mask_text(g_curr, nvl( upper(''), 'NO_MASK') )||'',
      p_success_msg            => 'Displaying exchange rate information for currency_code '||mask_text(g_curr, nvl( upper(''), 'NO_MASK') )||'',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_TRX_GL_DAILY_RATES');



debug('begin add_signature: AR_ADJ_RA_BATCH_SOURCES_ALL');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COPY_INV_TIDFF_TO_CM_FLAG'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##DEFAULT_REFERENCE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4920',
      p_sig_id                 => 'AR_ADJ_RA_BATCH_SOURCES_ALL',
      p_sig_sql                => 'SELECT * 
from RA_BATCH_SOURCES_ALL a,
     RA_CUSTOMER_TRX_ALL b
where a.batch_source_id = b.batch_source_id
and   b.customer_trx_id = ##$$TRX_ID$$##
and   b.org_id = a.org_id',
      p_title                  => 'RA_BATCH_SOURCES_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no transaction batch for the adjusted transaction in RA_BATCH_SOURCES_ALL. This does not necessarily indicate an error/issue exists.',
      p_solution               => 'No transaction batch for the adjusted transaction in RA_BATCH_SOURCES_ALL.',
      p_success_msg            => 'Displaying transaction batch for the adjusted transaction in RA_BATCH_SOURCES_ALL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_RA_BATCH_SOURCES_ALL');



debug('begin add_signature: AR_ADJ_RA_CUST_TRX_TYPES_ALL');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4918',
      p_sig_id                 => 'AR_ADJ_RA_CUST_TRX_TYPES_ALL',
      p_sig_sql                => 'SELECT a.* 
    ...
    and   b.customer_trx_id = ##$$TRX_ID$$##
    and   b.org_id = a.org_id',
      p_title                  => 'RA_CUST_TRX_TYPES_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no transaction type for the adjusted transaction in RA_BATCH_SOURCES_ALL. ',
      p_solution               => 'No transaction type for the adjusted transaction in RA_BATCH_SOURCES_ALL. ',
      p_success_msg            => 'Displaying transaction type for the adjusted transaction in RA_BATCH_SOURCES_ALL. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_RA_CUST_TRX_TYPES_ALL');



debug('begin add_signature: AR_ADJ_RA_CUSTOMER_TRX_LINES_ALL');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##DEFAULT_USSGL_TRANSACTION_CODE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##DEFAULT_USSGL_TRX_CODE_CONTEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ITEM_CONTEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4921',
      p_sig_id                 => 'AR_ADJ_RA_CUSTOMER_TRX_LINES_ALL',
      p_sig_sql                => 'SELECT * 
from RA_CUSTOMER_TRX_LINES_ALL
where customer_trx_id = ##$$TRX_ID$$##
order by customer_trx_line_id',
      p_title                  => 'RA_CUSTOMER_TRX_LINES_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no transaction lines for the adjusted transaction in RA_CUSTOMER_TRX_LINES_ALL.',
      p_solution               => 'No transaction lines for the adjusted transaction in RA_CUSTOMER_TRX_LINES_ALL.',
      p_success_msg            => 'Displaying transaction lines for the adjusted transaction in RA_CUSTOMER_TRX_LINES_ALL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_RA_CUSTOMER_TRX_LINES_ALL');



debug('begin add_signature: AR_ADJ_TRX_RA_CUSTOMER_TRX_LINES_ALL_TOTALS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15296',
      p_sig_id                 => 'AR_ADJ_TRX_RA_CUSTOMER_TRX_LINES_ALL_TOTALS',
      p_sig_sql                => 'SELECT customer_trx_id,
line_type,
sum(nvl(Extended_Amount,0)),
...
sum(Chrg_Amount_Remaining),
sum(Chrg_Acctd_Amount_Remaining),
sum(Frt_Adj_Remaining),
sum(Frt_Adj_Acctd_Remaining)
from ra_customer_trx_lines_all
where customer_trx_id = ##$$TRX_ID$$##
GROUP BY customer_trx_id, line_type',
      p_title                  => 'RA_CUSTOMER_TRX_LINES_ALL Totals',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no transaction lines for the adjusted transaction in RA_CUSTOMER_TRX_LINES_ALL table.',
      p_solution               => 'No transaction lines found for the adjusted transaction in RA_CUSTOMER_TRX_LINES_ALL.
',
      p_success_msg            => 'Displaying sum of line amounts for the adjusted transaction from RA_CUSTOMER_TRX_LINES_ALL table.',
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_TRX_RA_CUSTOMER_TRX_LINES_ALL_TOTALS');



debug('begin add_signature: AR_ADJ_ZX_LINES');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4922',
      p_sig_id                 => 'AR_ADJ_ZX_LINES',
      p_sig_sql                => 'SELECT   zl.* 
FROM     ZX_LINES zl,
...
AND      lines.customer_trx_id = ##$$TRX_ID$$##',
      p_title                  => 'ZX_LINES',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no tax lines for the adjusted transaction in ZX_LINES.',
      p_solution               => 'No tax lines for the adjusted transaction in ZX_LINES.',
      p_success_msg            => 'Displaying tax lines for the adjusted transaction in ZX_LINES.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_ZX_LINES');



debug('begin add_signature: AR_ADJ_ZX_LINES_DET_FACTORS');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4923',
      p_sig_id                 => 'AR_ADJ_ZX_LINES_DET_FACTORS',
      p_sig_sql                => 'SELECT   zld.* 
...
AND      lines.customer_trx_id = ##$$TRX_ID$$##',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no tax detail for the adjusted transaction in ZX_LINES_DET_FACTORS.',
      p_solution               => 'No tax detail for the adjusted transaction in ZX_LINES_DET_FACTORS.',
      p_success_msg            => 'Displaying tax detail for the adjusted transaction in ZX_LINES_DET_FACTORS.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_ZX_LINES_DET_FACTORS');



debug('begin add_signature: AR_ADJ_RA_CUST_TRX_LINE_GL_DIST_ALL');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4924',
      p_sig_id                 => 'AR_ADJ_RA_CUST_TRX_LINE_GL_DIST_ALL',
      p_sig_sql                => 'SELECT * 
from RA_CUST_TRX_LINE_GL_DIST_ALL
where customer_trx_id = ##$$TRX_ID$$##
order by cust_trx_line_gl_dist_id',
      p_title                  => 'RA_CUST_TRX_LINE_GL_DIST_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no transaction distribution lines for the adjusted transaction in RA_CUST_TRX_LINE_GL_DIST_ALL.',
      p_solution               => 'No transaction distribution lines for the adjusted transaction in RA_CUST_TRX_LINE_GL_DIST_ALL.',
      p_success_msg            => 'Displaying transaction distribution lines for the adjusted transaction in RA_CUST_TRX_LINE_GL_DIST_ALL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_RA_CUST_TRX_LINE_GL_DIST_ALL');



debug('begin add_signature: AR_ADJ_RA_CUST_TRX_LINE_GL_DIST_ALL_TOTALS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4926',
      p_sig_id                 => 'AR_ADJ_RA_CUST_TRX_LINE_GL_DIST_ALL_TOTALS',
      p_sig_sql                => 'SELECT customer_trx_id,
       account_class,
       sum(amount) SUM_AMOUNT,
       sum(acctd_amount) SUM_ACCTD_AMOUNT,
       sum(percent) SUM_PERCENT
from   RA_CUST_TRX_LINE_GL_DIST_ALL
where customer_trx_id = ##$$TRX_ID$$##
and   account_set_flag = ''N''
GROUP BY customer_trx_id, account_class',
      p_title                  => 'RA_CUST_TRX_LINE_GL_DIST_ALL Totals',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no transaction distribution lines for the adjusted transaction in RA_CUST_TRX_LINE_GL_DIST_ALL.',
      p_solution               => 'No transaction distribution lines for the adjusted transaction in RA_CUST_TRX_LINE_GL_DIST_ALL.',
      p_success_msg            => 'Displaying transaction distribution lines for the adjusted transaction in RA_CUST_TRX_LINE_GL_DIST_ALL.',
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_RA_CUST_TRX_LINE_GL_DIST_ALL_TOTALS');



debug('begin add_signature: AR_ADJ_GL_DIST_TOTALS_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19595',
      p_sig_id                 => 'AR_ADJ_GL_DIST_TOTALS_CHECK',
      p_sig_sql                => 'select a.customer_trx_id, a.rec_amt TOTAL_REC_AMOUNT, b.non_rec_amt TOTAL_NON_REC_AMOUNT, 
            a.rec_acctd_amt TOTAL_REC_ACCTD_AMOUNT, b.non_rec_acctd_amt TOTAL_NON_REC_ACCTD_AMOUNT,
decode((a.rec_amt - b.non_rec_amt)+(a.rec_acctd_amt - b.non_rec_acctd_amt),0,''BALANCED'',''OUT OF BALANCE'') STATUS
from (select customer_trx_id, sum(amount) REC_AMT, sum(acctd_amount) REC_ACCTD_AMT from ra_cust_trx_line_gl_dist_all
           where account_set_flag = ''N'' 
           and customer_trx_id = ##$$TRX_ID$$##
           and account_class = ''REC''
           group by customer_trx_id) a,  
         (select sum(amount) NON_REC_AMT, sum(acctd_amount) NON_REC_ACCTD_AMT from ra_cust_trx_line_gl_dist_all
          where account_set_flag = ''N'' 
          and customer_trx_id = ##$$TRX_ID$$##
          and account_class <> ''REC'') b
',
      p_title                  => 'Check RA_CUST_TRX_LINE_GL_DIST_ALL Totals',
      p_fail_condition         => '[STATUS] = [OUT OF BALANCE]',
      p_problem_descr          => 'The amounts in RA_CUST_TRX_LINE_GL_DIST_ALL for the adjusted transaction are out of balance.',
      p_solution               => 'Please review the detailed balances shown in the child signature to determine which account class is causing the imbalance, then review the Data Integrity section of this analyzer, to identify the issue that may be causing the out of balance condition.',
      p_success_msg            => 'Displaying total of distributions for the adjusted transaction in RA_CUST_TRX_LINE_GL_DIST_ALL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('AR_ADJ_RA_CUST_TRX_LINE_GL_DIST_ALL_TOTALS'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '2'
      );
   l_info.delete;
debug('end add_signature: AR_ADJ_GL_DIST_TOTALS_CHECK');



debug('begin add_signature: AR_ADJ_AR_ACCOUNT_FOR_TRANSACTION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4925',
      p_sig_id                 => 'AR_ADJ_AR_ACCOUNT_FOR_TRANSACTION',
      p_sig_sql                => 'SELECT code_combination_id, concatenated_segments account, 
       gl_control_account control_account, 
       enabled_flag enabled,
       detail_posting_allowed "Allow Posting", 
...
where code_combination_id in (select distinct code_combination_id
                               ...
                               where  customer_trx_id = ##$$TRX_ID$$##
and    account_set_flag = ''N'')',
      p_title                  => 'GL Accounts for Adjusted Transaction',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no GL accounts for the adjusted transaction in GL_CODE_COMBINATIONS_KFV.',
      p_solution               => 'No GL accounts for the adjusted transaction in GL_CODE_COMBINATIONS_KFV.',
      p_success_msg            => 'Displaying GL accounts for the adjusted transaction in GL_CODE_COMBINATIONS_KFV.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_AR_ACCOUNT_FOR_TRANSACTION');



debug('begin add_signature: AR_ADJ_TRX_APPLICATIONS_TO');
   l_info('##MASK##%ATTRIBUTES%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_REFERENCE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4927',
      p_sig_id                 => 'AR_ADJ_TRX_APPLICATIONS_TO',
      p_sig_sql                => 'SELECT *
FROM   AR_RECEIVABLE_APPLICATIONS_ALL
where  applied_customer_trx_id = ##$$TRX_ID$$##',
      p_title                  => 'AR_RECEIVABLE_APPLICATIONS_ALL for the Adjusted Transaction',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no applications on the adjusted transaction in AR_RECEIVABLE_APPLICATIONS_ALL. This does not necessarily indicate an error/issue exists.',
      p_solution               => 'No applications on the adjusted transaction in AR_RECEIVABLE_APPLICATIONS_ALL.',
      p_success_msg            => 'Displaying applications on the adjusted transaction in AR_RECEIVABLE_APPLICATIONS_ALL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_TRX_APPLICATIONS_TO');



debug('begin add_signature: AR_ADJ_APPLICATIONS_TO_TRANSACTION_TOTALS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4928',
      p_sig_id                 => 'AR_ADJ_APPLICATIONS_TO_TRANSACTION_TOTALS',
      p_sig_sql                => 'SELECT application_type,
...
GROUP BY application_type',
      p_title                  => 'AR_RECEIVABLE_APPLICATIONS_ALL Totals for the Adjusted Transaction',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no applications against the adjusted transaction in AR_RECEIVABLE_APPLICATIONS_ALL. This does not necessarily indicate an error/issue exists.',
      p_solution               => 'No applications against the adjusted transaction in AR_RECEIVABLE_APPLICATIONS_ALL.',
      p_success_msg            => 'Displaying application totals against the adjusted transaction in AR_RECEIVABLE_APPLICATIONS_ALL. ',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_APPLICATIONS_TO_TRANSACTION_TOTALS');



debug('begin add_signature: AR_ADJ_TRANSACTION_APPLICATIONS');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CUSTOMER_REFERENCE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4929',
      p_sig_id                 => 'AR_ADJ_TRANSACTION_APPLICATIONS',
      p_sig_sql                => 'SELECT *
FROM   AR_RECEIVABLE_APPLICATIONS_ALL
where  customer_trx_id = ##$$TRX_ID$$##',
      p_title                  => 'AR_RECEIVABLE_APPLICATIONS_ALL of the Adjusted Transaction',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no applications to other transactions for the adjusted transaction in AR_RECEIVABLE_APPLICATIONS_ALL. This does not necessarily indicate an error/issue exists.
',
      p_solution               => 'No applications to other transactions for the adjusted transaction in AR_RECEIVABLE_APPLICATIONS_ALL.',
      p_success_msg            => 'Displaying applications to other transactions for the adjusted transaction in AR_RECEIVABLE_APPLICATIONS_ALL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_TRANSACTION_APPLICATIONS');



debug('begin add_signature: AR_ADJ_APPLICATIONS_TO_FROM_DISTRIBUTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4930',
      p_sig_id                 => 'AR_ADJ_APPLICATIONS_TO_FROM_DISTRIBUTIONS',
      p_sig_sql                => 'SELECT *
FROM AR_DISTRIBUTIONS_ALL 
...
AND    source_table = ''RA''
order by line_id',
      p_title                  => 'AR_DISTRIBUTIONS_ALL (All Applications From/To)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no distributions for applications to the adjusted transaction in AR_DISTRIBUTIONS_ALL. This does not necessarily indicate an error/issue exists.',
      p_solution               => 'No distributions for applications to the adjusted transaction in AR_DISTRIBUTIONS_AL',
      p_success_msg            => 'Displaying distributions for applications to the adjusted transaction in AR_DISTRIBUTIONS_AL',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_APPLICATIONS_TO_FROM_DISTRIBUTIONS');



debug('begin add_signature: AR_ADJ_ADJUSTMENTS_ON_TRANSACTION');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4935',
      p_sig_id                 => 'AR_ADJ_ADJUSTMENTS_ON_TRANSACTION',
      p_sig_sql                => 'SELECT *
FROM   ar_adjustments_all
WHERE  customer_trx_id = ##$$TRX_ID$$##
order by creation_date asc',
      p_title                  => 'AR_ADJUSTMENTS_ALL on the Transaction',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no adjustments against the adjusted transaction in AR_ADJUSTMENTS_ALL. ',
      p_solution               => 'No other adjustments against the adjusted transaction in AR_ADJUSTMENTS_ALL.',
      p_success_msg            => 'Displaying adjustments against the adjusted transaction in AR_ADJUSTMENTS_ALL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_ADJUSTMENTS_ON_TRANSACTION');



debug('begin add_signature: AR_ADJ_ADJ_DIST_ON_TRX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4936',
      p_sig_id                 => 'AR_ADJ_ADJ_DIST_ON_TRX',
      p_sig_sql                => 'select *
from ar_distributions_all
...
and source_table = ''ADJ''
order by line_id',
      p_title                  => 'AR_DISTRIBUTIONS_ALL of the Adjustments on the Transaction',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no adjustment distributions for all adjustments on adjusted transaction in AR_DISTRIBUTIONS_ALL.',
      p_solution               => 'No adjustment distributions for all adjustments on adjusted transaction in AR_DISTRIBUTIONS_ALL.',
      p_success_msg            => 'Displaying adjustment distributions for all adjustments on adjusted transaction in AR_DISTRIBUTIONS_ALL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_ADJ_DIST_ON_TRX');



debug('begin add_signature: AR_ADJ_AR_PAYMENT_SCHEDULES_ALL');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4934',
      p_sig_id                 => 'AR_ADJ_AR_PAYMENT_SCHEDULES_ALL',
      p_sig_sql                => 'SELECT *
FROM ar_payment_schedules_all
WHERE customer_trx_id = ##$$TRX_ID$$##
order by payment_schedule_id',
      p_title                  => 'AR_PAYMENT_SCHEDULES_ALL of the Transaction',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no payment_schedule for the adjusted transaction in AR_PAYMENT_SCHEDULES_ALL.',
      p_solution               => 'No payment_schedule for the adjusted transaction in AR_PAYMENT_SCHEDULES_ALL.',
      p_success_msg            => 'Displaying payment_schedule for the adjusted transaction in AR_PAYMENT_SCHEDULES_ALL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_AR_PAYMENT_SCHEDULES_ALL');



debug('begin add_signature: AR_ADJ_GL_JE_BATCHES');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CONTEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CONTEXT2'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11031',
      p_sig_id                 => 'AR_ADJ_GL_JE_BATCHES',
...
order by gjb.je_batch_id',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no journal batch for this adjustment in GL_JE_BATCHES. This does not necessarily indicate an error/issue exists.
',
      p_solution               => 'No journal batch for this adjustment in GL_JE_BATCHES.
',
      p_success_msg            => 'Displaying journal batch for this adjustment in GL_JE_BATCHES.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_GL_JE_BATCHES');



debug('begin add_signature: AR_ADJ_GL_JE_HEADERS');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CONTEXT2'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##EXTERNAL_REFERENCE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##JGZZ_RECON_CONTEXT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##JGZZ_RECON_REF'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4954',
      p_sig_id                 => 'AR_ADJ_GL_JE_HEADERS',
...
order by gjh.je_header_id',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no journal header for this adjustment in GL_JE_HEADERS. This does not necessarily indicate an error/issue exists.',
      p_solution               => 'No journal header for this adjustment in GL_JE_HEADERS.',
      p_success_msg            => 'Displaying journal header for this adjustment in GL_JE_HEADERS. 
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_GL_JE_HEADERS');



debug('begin add_signature: AR_ADJ_GL_JE_LINES');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CONTEXT%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
order by gjl.je_header_id, gjl.je_line_num',
      p_title                  => 'GL_JE_LINES',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no journal lines for this adjustment in GL_JE_LINES. This does not necessarily indicate an error/issue exists.',
      p_solution               => 'No journal lines for this adjustment in GL_JE_LINES.',
      p_success_msg            => 'Displaying journal lines for this adjustment in GL_JE_LINES.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_GL_JE_LINES');



debug('begin add_signature: EBS_FIN_AR_ADJ_GL_ACCTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27923',
      p_sig_id                 => 'EBS_FIN_AR_ADJ_GL_ACCTS',
      p_sig_sql                => 'SELECT code_combination_id, concatenated_segments account, 
       gl_control_account control_account, 
       enabled_flag enabled,
       detail_posting_allowed "Allow Posting", 
...
where  code_combination_id in (select distinct gjl.code_combination_id
      ...
      p_title                  => 'GL Accounts',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'GL Accounts used by this Adjustment journal in GL do not exist in GL_CODE_COMBINATIONS_KFV.  ',
      p_solution               => 'No GL Accounts used by this Adjustment journal in GL in GL_CODE_COMBINATIONS_KFV.
',
      p_success_msg            => 'Displaying GL Accounts used by this Adjustment journal in GL in GL_CODE_COMBINATIONS_KFV.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_ADJ_GL_ACCTS');



debug('begin add_signature: AR_ADJ_GL_IMPORT_REFERENCES');
   l_info('##MASK##REFERENCE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4956',
      p_sig_id                 => 'AR_ADJ_GL_IMPORT_REFERENCES',
...
order by gir.je_header_id, gir.je_line_num',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no journal references for this adjustment in GL_IMPORT_REFERENCES. This does not necessarily indicate an error/issue exists.',
      p_solution               => 'No journal references for this adjustment in GL_IMPORT_REFERENCES. ',
      p_success_msg            => 'Displaying journal references for this adjustment in GL_IMPORT_REFERENCES. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_GL_IMPORT_REFERENCES');



debug('begin add_signature: AR_ADJ_HZ_CUST_ACCOUNTS_ALL');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '4912',
      p_sig_id                 => 'AR_ADJ_HZ_CUST_ACCOUNTS_ALL',
      p_sig_sql                => 'select *
from   hz_cust_accounts_all
where  cust_account_id  = ##$$G_BILL_TO_CUSTOMER_ID$$##',
      p_title                  => 'HZ_CUST_ACCOUNTS_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no customer account for the adjusted transaction in HZ_CUST_ACCOUNTS_ALL. ',
      p_solution               => 'No customer account for the adjusted transaction in HZ_CUST_ACCOUNTS_ALL. ',
      p_success_msg            => 'Displaying customer account for the adjusted transaction in HZ_CUST_ACCOUNTS_ALL. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_HZ_CUST_ACCOUNTS_ALL');



debug('begin add_signature: AR_ADJ_HZ_CUST_ACCT_RELATE_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19383',
      p_sig_id                 => 'AR_ADJ_HZ_CUST_ACCT_RELATE_ALL',
      p_sig_sql                => 'SELECT *
...
where cust_account_id = ##$$G_BILL_TO_CUSTOMER_ID$$##',
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_HZ_CUST_ACCT_RELATE_ALL');



debug('begin add_signature: AR_ADJ_HZ_CUST_ACCT_SITES_ALL');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '4913',
      p_sig_id                 => 'AR_ADJ_HZ_CUST_ACCT_SITES_ALL',
      p_sig_sql                => 'SELECT cas.*
FROM HZ_CUST_ACCT_SITES_ALL cas
WHERE cust_acct_site_id = NVL(##$$G_CUST_ACCT_SITE_ID$$##,0)',
      p_title                  => 'HZ_CUST_ACCT_SITES_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no customer sites for the adjusted transaction in HZ_CUST_ACCT_SITES_ALL. ',
      p_solution               => 'No customer sites for the adjusted transaction in HZ_CUST_ACCT_SITES_ALL. ',
      p_success_msg            => 'No displaying customer sites for the adjusted transaction in HZ_CUST_ACCT_SITES_ALL. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_HZ_CUST_ACCT_SITES_ALL');



debug('begin add_signature: AR_ADJ_HZ_CUST_SITE_USES_ALL');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '4914',
      p_sig_id                 => 'AR_ADJ_HZ_CUST_SITE_USES_ALL',
      p_sig_sql                => 'SELECT * 
FROM   HZ_CUST_SITE_USES_ALL 
WHERE  site_use_id = NVL(##$$G_BILL_TO_SITE_USE_ID$$##,0)',
      p_title                  => 'HZ_CUST_SITE_USES_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no customer site uses for the adjusted transaction in HZ_CUST_SITE_USES_ALL.',
      p_solution               => 'No customer site uses for the adjusted transaction in HZ_CUST_SITE_USES_ALL.',
      p_success_msg            => 'Displaying customer site uses for the adjusted transaction in HZ_CUST_SITE_USES_ALL.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_HZ_CUST_SITE_USES_ALL');



debug('begin add_signature: AR_ADJ_HZ_LOCATIONS');
   l_info('##MASK##%ADDRESS%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##POSTAL_CODE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4916',
      p_sig_id                 => 'AR_ADJ_HZ_LOCATIONS',
...
from   hz_locations
where  location_id = NVL(##$$G_LOCATION_ID$$##,0)',
      p_title                  => 'HZ_LOCATIONS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no customer locations for the adjusted transaction in HZ_LOCATIONS.',
      p_solution               => 'No customer locations for the adjusted transaction in HZ_LOCATIONS.',
      p_success_msg            => 'Displaying customer locations for the adjusted transaction in HZ_LOCATIONS.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_HZ_LOCATIONS');



debug('begin add_signature: AR_ADJ_HZ_PARTIES');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##%PHONE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   ...
   l_info('##MASK##PERSON%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##POSTAL_CODE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
...
where customer_trx_id = ##$$TRX_ID$$##))',
      p_title                  => 'HZ_PARTIES',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no party information for the adjusted transaction in HZ_PARTIES.',
      p_solution               => 'No party information for the adjusted transaction in HZ_PARTIES.',
      p_success_msg            => 'Displaying party information for the adjusted transaction in HZ_PARTIES.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_HZ_PARTIES');



debug('begin add_signature: AR_ADJ_HZ_PARTY_SITES');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '4915',
      p_sig_id                 => 'AR_ADJ_HZ_PARTY_SITES',
      p_sig_sql                => 'SELECT   * 
FROM     HZ_PARTY_SITES
WHERE    party_site_id = NVL(##$$G_PARTY_SITE_ID$$##,0)',
      p_title                  => 'HZ_PARTY_SITES',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no party sites for the adjusted transaction in HZ_PARTY_SITES.',
      p_solution               => 'No party sites for the adjusted transaction in HZ_PARTY_SITES.',
      p_success_msg            => 'Displaying party sites for the adjusted transaction in HZ_PARTY_SITES.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_HZ_PARTY_SITES');



debug('begin add_signature: AR_ADJ_HZ_CUSTOMER_PROFILES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14802',
      p_sig_id                 => 'AR_ADJ_HZ_CUSTOMER_PROFILES',
      p_sig_sql                => 'SELECT   * 
FROM     HZ_CUSTOMER_PROFILES 
WHERE    site_use_id = NVL(##$$G_BILL_TO_SITE_USE_ID$$##,0)',
      p_title                  => 'HZ_CUSTOMER_PROFILES',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no site use record for the adjusted transaction in HZ_CUSTOMER_PROFILES table.',
      p_solution               => 'No customer site uses for the adjusted transaction in HZ_CUSTOMER_PROFILES table.',
      p_success_msg            => 'Displaying site use record for the adjusted transaction in HZ_CUSTOMER_PROFILES table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_HZ_CUSTOMER_PROFILES');



debug('begin add_signature: EBS_FIN_AR_ADJ_HZ_ORG_PROF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31545',
      p_sig_id                 => 'EBS_FIN_AR_ADJ_HZ_ORG_PROF',
      p_sig_sql                => 'SELECT  COUNT(ORGANIZATION_PROFILE_ID) "Organization Profile Count"
...
HAVING count(ORGANIZATION_PROFILE_ID) > 0
',
      p_title                  => 'Missing HZ_ORGANIZATION_PROFILES Data for the Party of the Adjusted Transaction.',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No active row exists in HZ_ORGANIZATION_PROFILES for the Party of the Adjusted Transaction. This Adjustment may not appear in ''Adjustment Register Report''
',
      p_solution               => '<ul><li>The analyzer has identified data corruption described in [3040578.1]</li>
<li>Please log a Service Request and upload this analyzer output.</li>
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_ADJ_HZ_ORG_PROF');



debug('begin add_signature: AR_ADJ_SCRIPT_PARAMETERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '16350',
      p_sig_id                 => 'AR_ADJ_SCRIPT_PARAMETERS',
...
from dual',
      ...
      p_solution               => 'No adjustment parameters selected.',
      p_success_msg            => 'Displaying parameter values to be used in a Generic Data Fix (GDF) script, if needed for this adjustment.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_SCRIPT_PARAMETERS');



debug('begin add_signature: AR_ADJ_AR_00034_AR_00044_AR_00237_INCOMP_XLA_EVENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4964',
      p_sig_id                 => 'AR_ADJ_AR_00034_AR_00044_AR_00237_INCOMP_XLA_EVENTS',
      p_sig_sql                => 'select adj.adjustment_id 
from   ar_adjustments_all adj, 
       xla_events xe 
where  adjustment_id = ##$$ADJID$$##
and    adj.posting_control_id = -3 
...
and    xe.event_status_code in (''I'', ''U'')',
      p_title                  => 'XLA_EVENTS Showing Incomplete Event for a Rejected Adjustment (AR_00034) (AR_00044) (AR_00237)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This shows an incomplete event in XLA_EVENTS for a rejected adjustment.',
      p_solution               => '<ul><li>The analyzer has identified data corruption described in [1513473.1]</li>
<li>Please follow the steps provided in the document in a TEST instance with the same data as PROD.  If the issue is resolved, please migrate the solution to the other environments; otherwise, please log a Service Request and upload this Analyzer output</li> </ul>',
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_AR_00034_AR_00044_AR_00237_INCOMP_XLA_EVENTS');



debug('begin add_signature: AR_ADJ_AR_00037_UNPOSTED_ADJ_FOR_INV_WITH_RULE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4963',
      p_sig_id                 => 'AR_ADJ_AR_00037_UNPOSTED_ADJ_FOR_INV_WITH_RULE',
      p_sig_sql                => 'select adj.adjustment_number, adj.adjustment_id, adj.gl_date, adj.status, adj.event_id, adj.amount, adj.acctd_amount 
from ar_adjustments_all adj, ra_customer_trx_all ct, fnd_currencies fc
...
group by source_id
having (sum(nvl(round(amount_dr*nvl(currency_conversion_rate,1),fc.precision),0)) <> sum(nvl(acctd_amount_dr,0))
or sum(nvl(round(amount_cr*nvl(currency_conversion_rate,1),fc.precision),0)) <> sum(nvl(acctd_amount_cr,0)))
)',
      p_title                  => 'Adjustment Ar_distributions are out of Balance (AR_00037)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The ar_distributions are out of balance for adjustment. ',
      p_solution               => '<ul><li>The analyzer has identified data corruption described in [1513287.1]</li>
<li>Please log a Service Request and upload this analyzer output.</li></ul>',
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_AR_00037_UNPOSTED_ADJ_FOR_INV_WITH_RULE');



debug('begin add_signature: AR_ADJ_AR_00039_INCORRECT_JE_CATEGORY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4965',
      p_sig_id                 => 'AR_ADJ_AR_00039_INCORRECT_JE_CATEGORY',
      p_sig_sql                => 'select ae_header_id 
from   xla_transaction_entities_upg et, 
       xla_ae_headers hd 
where  et.source_id_int_1 = ##$$ADJID$$##
and    et.application_id = 222 
and    et. entity_code = ''ADJUSTMENTS''
and    et.application_id = hd.application_id 
and    et.entity_id = hd.entity_id 
and    hd.upg_batch_id is not null 
and    hd.je_category_name = ''Adjustments''',
      p_title                  => 'Incorrect JE_CATEGORY for Adjustment in XLA_AE_HEADERS (AR_00039)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The upgrade script stamps incorrect JE_CATEGORY for Adjustment entries in XLA_AE_HEADERS',
      p_solution               => '<ul><li>The analyzer has identified data corruption described in [1513396.1]</li>
<li>Please log a Service Request and upload this analyzer output.</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_AR_00039_INCORRECT_JE_CATEGORY');



debug('begin add_signature: AR_ADJ_AR_00040_ADJ_NON_POSTABLE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4967',
      p_sig_id                 => 'AR_ADJ_AR_00040_ADJ_NON_POSTABLE',
      p_sig_sql                => 'select adj.adjustment_id 
from   ar_adjustments_all adj 
where  adj.adjustment_id = ##$$ADJID$$##
and    adj.posting_control_id = -3 
...
and exists (select ''x''
      ...
      p_title                  => 'Unposted Adjustment Against Non-Postable Transaction (AR_00040)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Unposted Adjustment against a Transaction with POST_TO_GL = N.',
      p_solution               => '<ul><li>The analyzer has identified data corruption described in [1513455.1]</li>
<li>Please log a Service Request and upload this analyzer output.</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_AR_00040_ADJ_NON_POSTABLE');



debug('begin add_signature: AR_ADJ_AR_00047_ADJUSTMENT_WITH_NULL_EVENT_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4968',
      p_sig_id                 => 'AR_ADJ_AR_00047_ADJUSTMENT_WITH_NULL_EVENT_ID',
      p_sig_sql                => 'select adjustment_id 
from   ar_adjustments_all 
WHERE  adjustment_id = ##$$ADJID$$##
AND    posting_control_id = -3 
AND    nvl(POSTABLE,''N'') = ''Y'' 
and    event_id is null',
      p_title                  => 'Adjustment with EVENT_ID = Null (AR_00047)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This Adjustment has a NULL EVENT_ID.',
      p_solution               => '<ul><li>The analyzer has identified data corruption described in [1513689.1]</li>
<li>Please log a Service Request and upload this analyzer output.</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_AR_00047_ADJUSTMENT_WITH_NULL_EVENT_ID');



debug('begin add_signature: AR_ADJ_AR_00050_DUP_DEFER_TAX_DIST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4969',
      p_sig_id                 => 'AR_ADJ_AR_00050_DUP_DEFER_TAX_DIST',
      p_sig_sql                => 'select adj.customer_trx_id
from   ar_adjustments_all adj, 
       xla_events xe
where  adjustment_id = ##$$ADJID$$##
and    adj.event_id = xe.event_id
and    xe.application_id = 222
and exists (select ''x''
            from   ra_cust_trx_line_gl_dist_all
            where  customer_trx_id = adj.customer_trx_id
            and    account_class = ''TAX''
            and    account_set_flag = ''N''
            and    collected_tax_ccid is not null)
and exists (select ''x''
            from    ar_distributions_all
            where   source_id = adj.adjustment_id
            and     source_table = ''ADJ''
            and     source_type in (''DEFERRED_TAX'',''TAX'')
            and     source_type_secondary = ''RECONCILE'')',
      p_title                  => 'Adjustment has Duplicate DEFERRED_TAX Distribution Rows (AR_00050)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This Adjustment has duplicate DEFERRED_TAX distribution rows.',
      p_solution               => '<ul><li>The analyzer has identified data corruption described in [1269244.1]</li>
<li>Please log a Service Request and upload this analyzer output.</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_AR_00050_DUP_DEFER_TAX_DIST');



debug('begin add_signature: AR_ADJ_AR_00141_UPGRADED_11I_ADJ_INCOMP_EVENT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4970',
      p_sig_id                 => 'AR_ADJ_AR_00141_UPGRADED_11I_ADJ_INCOMP_EVENT',
      p_sig_sql                => 'select  adj.adjustment_id, adj.gl_date, adj.event_id  
from    ar_adjustments_all adj, 
        xla_events xe  
where   adjustment_id = ##$$ADJID$$##
and     adj.posting_control_id = -3  
...
and     adj.event_id is null  
and     xe.application_id = 222  
and     xe.REFERENCE_NUM_2  = adj.ADJUSTMENT_ID  
and     xe.upg_source_application_id = 222  
AND     XE.UPG_BATCH_ID IS NOT NULL  
and     xe.event_status_code in (''I'',''U'')',
      p_title                  => 'Upgraded Non-postable 11i Adjustment has Incomplete Event (AR_00141)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Upgrade Non-Postable Adjustment from 11i with Incomplete Event.',
      p_solution               => '<ul><li>The analyzer has identified data corruption described in [1556780.1]</li>
<li>Please log a Service Request and upload this analyzer output.</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_AR_00141_UPGRADED_11I_ADJ_INCOMP_EVENT');



debug('begin add_signature: AR_ADJ_AR_00229_DIST_MISSING_REF_COLUMN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4972',
      p_sig_id                 => 'AR_ADJ_AR_00229_DIST_MISSING_REF_COLUMN',
      p_sig_sql                => 'Select gld.customer_trx_id customer_trx_id,
...
Where  adjustment_id = ##$$ADJID$$##
And    gld.customer_trx_id = adj.customer_trx_id
...
And    ard.source_type = ''ADJ''
And    adj.posting_control_id = -3
And    ((ard.ref_customer_trx_line_id in (-6, -8)) or (ard.ref_customer_trx_line_id is NULL))
And    ((ard.ref_cust_trx_line_gl_dist_id in (-6, -8)) or (ard.ref_cust_trx_line_gl_dist_id is NULL))
And     ps.amount_line_items_original = 0
And     ps.amount_line_items_remaining <> 0
And     ps.status = ''OP''
And     ps.class = ''INV''
',
      p_title                  => 'Adjustment Distribution Rows with Null Reference Column (AR_00229)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The Adjustment distribution rows are created with missing reference column information.',
      p_solution               => '<ul><li>The analyzer has identified data corruption described in [1585960.1]</li>
<li>Please log a Service Request and upload this analyzer output.</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_AR_00229_DIST_MISSING_REF_COLUMN');



debug('begin add_signature: AR_ADJ_AR_00257_ADJ_APP_REV_REC_NOT_RUN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4973',
      p_sig_id                 => 'AR_ADJ_AR_00257_ADJ_APP_REV_REC_NOT_RUN',
      p_sig_sql                => 'SELECT DISTINCT  ADJ.ADJUSTMENT_ID, ADJ.CUSTOMER_TRX_ID ,ADJ.GL_DATE
FROM AR_ADJUSTMENTS_ALL ADJ , AR_DISTRIBUTIONS_ALL  ARD
WHERE adj.adjustment_id = ##$$ADJID$$##
AND ADJ.ADJUSTMENT_ID = ARD.SOURCE_ID
AND ARD.SOURCE_TABLE = ''ADJ''
AND ARD.SOURCE_TYPE IN( ''ADJ'', ''DEFERRED_TAX'', ''TAX'')
AND ( ARD.REF_CUSTOMER_TRX_LINE_ID IS NULL OR  ARD.REF_CUSTOMER_TRX_LINE_ID < 0 )
AND Exists ( Select 1 from RA_CUSTOMER_TRX_ALL ra
                                       where ra.customer_trx_id = adj.customer_trx_id 
                                       and ra.invoicing_rule_id in (-2,-3) )',
      p_title                  => 'Adjustment Applied to a Transaction that is Missing Revenue Recognition (AR_00257)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This Adjustment is applied to an Invoice with Rules and Revenue Recognition has not been run.',
      p_solution               => '<ul><li>The analyzer has identified data corruption described in [1559845.1]</li>
<li>Please log a Service Request and upload this analyzer output.</li></ul>
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_AR_00257_ADJ_APP_REV_REC_NOT_RUN');



debug('begin add_signature: AR_ADJ_AR_S_00005_ADJ_MISS_DIST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4971',
      p_sig_id                 => 'AR_ADJ_AR_S_00005_ADJ_MISS_DIST',
      p_sig_sql                => 'select * 
from   ar_adjustments_all adj
where  adjustment_id = ##$$ADJID$$##
and adj.posting_control_id = -3
...
OR NOT EXISTS
(
SELECT sum (nvl (ard.acctd_amount_dr,0)) ,sum (nvl (ard.acctd_amount_cr,0))
...
HAVING sum (nvl (ard.acctd_amount_dr,0)) = sum (nvl (ard.acctd_amount_cr,0))
      ...
      p_title                  => 'Adjustment with Missing Distribution Lines (AR_S_00005)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The adjustment is missing distributions lines.',
      p_solution               => '<ul><li>The analyzer has identified data corruption described in [2062470.1]</li>
<li>Please follow the steps provided in the document in a TEST instance with the same data as PROD.  If the issue is resolved, please migrate the solution to the other environments; otherwise, please log a Service Request and upload this Analyzer output</li> </ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_AR_S_00005_ADJ_MISS_DIST');



debug('begin add_signature: AR_ADJ_AR_S_00015_ADJ_MISSING_EVENT');
   l_info('##MASK##%ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7157',
      p_sig_id                 => 'AR_ADJ_AR_S_00015_ADJ_MISSING_EVENT',
...
and  adj.event_id = xe.event_id)',
      p_title                  => 'Adjustment is Missing Event in Xla_Events',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found record(s) with event in AR_ADJUSTMENTS_ALL but missing in XLA_EVENTS',
...
<li>Please log a Service Request and upload this analyzer output.</li></ul>',
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_AR_S_00015_ADJ_MISSING_EVENT');



debug('begin add_signature: AR_ADJ_AR_S_00052_POSTABLE_NON_POST_EVENT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14156',
      p_sig_id                 => 'AR_ADJ_AR_S_00052_POSTABLE_NON_POST_EVENT',
      p_sig_sql                => 'SELECT adj.adjustment_number, adj.adjustment_id, adj.gl_date, adj.status, adj.postable, adj.event_id
FROM   ar_adjustments_all adj
WHERE  adj.status = ''A''
AND    adj.postable = ''Y''
AND    adj.posting_control_id =-3
...
FROM xla_events xe
WHERE
xe.application_id = 222
AND xe.event_status_code = ''N''
AND xe.event_id = adj.event_id)',
      p_title                  => 'Postable Adjustment with Non-postable Event (AR_S_00052)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Adjustment is approved and postable but with event that is non-postable.',
      p_solution               => '<ul><li>The analyzer has identified data corruption described in [2274763.1]</li>
<li>Please log a Service Request and upload this analyzer output.</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_AR_S_00052_POSTABLE_NON_POST_EVENT');



debug('begin add_signature: AR_ADJ_AR_S_00053_AMT_NOT_ZERO_ACCT_AMT_ZERO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14775',
      p_sig_id                 => 'AR_ADJ_AR_S_00053_AMT_NOT_ZERO_ACCT_AMT_ZERO',
      p_sig_sql                => 'SELECT 
  adj.adjustment_id,
  adj.adjustment_number,
  trx.customer_trx_id,
...
AND adj.adjustment_id = ##$$ADJID$$##
AND adj.org_id = ##$$ORGID$$##',
      p_title                  => 'Adjustment with Non-Zero Adjustment Amount and Accounted Amount = 0  (AR_S_00053)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Adjustment with non zero amount and acctd_amount = 0 ',
      p_solution               => '<ul><li>The analyzer has identified data corruption described in [1520391.1]</li>
<li>Please log a Service Request and upload this analyzer output.</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_AR_S_00053_AMT_NOT_ZERO_ACCT_AMT_ZERO');



debug('begin add_signature: AR_ADJ_AR_S_00070_ADJ_GLDATE_TIMESTAMP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '17550',
      p_sig_id                 => 'AR_ADJ_AR_S_00070_ADJ_GLDATE_TIMESTAMP',
      p_sig_sql                => 'select adjustment_id,
	   adjustment_number,
       event_id,
       to_char(gl_date, ''DD-MON-YYYY fmHH:MI:SS'') gldate
from   ar_adjustments_all
where  posting_control_id = -3
and    status = ''A''
and    postable = ''Y'' 
and    gl_date <> trunc(gl_date)
and    adjustment_id = ##$$ADJID$$##',
      p_title                  => 'Adjustment has GL Date with Time Stamp in ar_adjustments_all (AR_S_00070)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Adjustment has GL Date with Time Stamp in ar_adjustments_all.',
      p_solution               => '<ul><li>The analyzer has identified data corruption described in [2756428.1]</li>
<li>Please log a Service Request and upload this analyzer output.</li>
</ul>',
      p_success_msg            => 'There is no GL date with timestamp in ar_adjustments_all.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_AR_S_00070_ADJ_GLDATE_TIMESTAMP');



debug('begin add_signature: AR_ADJ_AR_S_00074_REJECTED_ADJ_HAS_DIST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18722',
      p_sig_id                 => 'AR_ADJ_AR_S_00074_REJECTED_ADJ_HAS_DIST',
      p_sig_sql                => 'select adj.adjustment_number, adj.adjustment_id, adj.status, adj.amount
from ar_adjustments_all adj
where adj.status = ''R''
and    adj.adjustment_id = ##$$ADJID$$##
and exists (select ''Y''
            ...
            and   dist.source_id = adj.adjustment_id)
',
      p_title                  => 'Rejected Adjustment has records in AR_DISTRIBUTIONS_ALL (AR_S_00074)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Rejected adjustment incorrectly has records in AR_DISTRIBUTIONS_ALL.',
      p_solution               => '<ul><li>The analyzer has identified data corruption described in [2773238.1]</li>
<li>Please log a Service Request and upload this analyzer output.</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_AR_S_00074_REJECTED_ADJ_HAS_DIST');



debug('begin add_signature: AR_ADJ_AR_S_00097_ARD_AMOUNT_DIFF_ACCTD_AMOHNT_FUNC_CURR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '21827',
      p_sig_id                 => 'AR_ADJ_AR_S_00097_ARD_AMOUNT_DIFF_ACCTD_AMOHNT_FUNC_CURR',
      p_sig_sql                => 'select adj.adjustment_id, adj.amount, adj.acctd_amount, adj.code_combination_id
from   ar_adjustments_all adj, 
       ra_customer_trx_all ct
where adj.posting_control_id = -3
and    adj.adjustment_id = ##$$ADJID$$##
and    adj.customer_trx_id = ct.customer_trx_id
and    nvl(ct.exchange_rate,1) = 1
and   exists (select ''x'' 
              from ar_distributions_all
	          where source_table = ''ADJ''
              and   source_id = adj.adjustment_id
              group by source_id
              having ( sum(nvl(amount_cr,0)) <> sum(nvl(acctd_amount_cr,0))
                       or sum(nvl(amount_dr,0)) <> sum(nvl(acctd_amount_dr,0)))
        	  )',
      p_title                  => 'Records in AR_DISTRIBUTIONS_ALL with AMOUNT <> ACCTD_AMOUNT for Adjustment created in functional currency',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are records in AR_DISTIBUTIONS_ALL with AMOUNT <> ACCTD_AMOUNT for adjustments created in functional currency.',
      p_solution               => '<ul><li>The analyzer has identified data corruption described in [2854638.1]</li>
<li>Please log a Service Request and upload this analyzer output.</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_AR_S_00097_ARD_AMOUNT_DIFF_ACCTD_AMOHNT_FUNC_CURR');



debug('begin add_signature: AR_ADJ_AR_S_00103_DUP_XLA_AE_HEADERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22395',
      p_sig_id                 => 'AR_ADJ_AR_S_00103_DUP_XLA_AE_HEADERS',
      p_sig_sql                => 'SELECT xte.source_id_int_1    Adjustment_Id,
       xte.transaction_number ADJ_Number,
       ev.event_id,
       ev.event_date, 
       ev.event_type_code,
...
WHERE  xte.application_id = 222
       ...
       AND Nvl(xte.source_id_int_1, -99) = ##$$ADJID$$##
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Adjustment has duplicate record(s) in XLA_AE_HEADERS.',
...
',
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_AR_S_00103_DUP_XLA_AE_HEADERS');



debug('begin add_signature: EBS_FIN_AR_ADJ_AR_S_00107_UPG_PENDING_APPROVAL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22810',
      p_sig_id                 => 'EBS_FIN_AR_ADJ_AR_S_00107_UPG_PENDING_APPROVAL',
      p_sig_sql                => 'select adjustment_id 
from   ar_adjustments_all 
WHERE  adjustment_id = ##$$ADJID$$##
AND    posting_control_id = -3 
and  (postable = ''N'' and status = ''W'') 
and    event_id is null',
      p_title                  => 'Adjustment with EVENT_ID = Null (AR_00047)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This upgraded Adjustment in pending Approval status has a NULL EVENT_ID.',
      p_solution               => '<ul><li>The analyzer has identified data corruption described in [971418.1]</li>
<li>Please log a Service Request and upload this analyzer output.</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_ADJ_AR_S_00107_UPG_PENDING_APPROVAL');



debug('begin add_signature: EBS_FIN_AR_ADJ_AR_S_00112_REV_ADJ_INVALID_CCID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22877',
      p_sig_id                 => 'EBS_FIN_AR_ADJ_AR_S_00112_REV_ADJ_INVALID_CCID',
      p_sig_sql                => 'select /* leading rev, adj) */ rev.adjustment_number rev_adj_number,
       decode(adj.CODE_COMBINATION_ID, rev.CODE_COMBINATION_ID, ''='', ''x'') chk1,
       decode(adj_dst.CODE_COMBINATION_ID, rev_dst.CODE_COMBINATION_ID, ''='', ''x'') chk2,
       adj.ADJUSTMENT_ID afj_id, adj.ADJUSTMENT_ID rev_id,
       adj.CODE_COMBINATION_ID adj_ccid, rev.CODE_COMBINATION_ID rev_ccid,
       adj_dst.line_id, adj_dst.source_type adj_src, adj_dst.CODE_COMBINATION_ID ccid, adj_dst.AMOUNT_DR adj_dr, adj_dst.AMOUNT_CR adj_cr,
       rev_dst.line_id, rev_dst.source_type rev_src, rev_dst.CODE_COMBINATION_ID ccid, rev_dst.AMOUNT_DR rev_dr, rev_dst.AMOUNT_CR rev_cr
from   ar_adjustments_all adj, 
       ar_adjustments_all rev,
       ar_distributions_all adj_dst, 
	   ar_distributions_all rev_dst
where  adj.customer_trx_id = rev.customer_trx_id
and    rev.adjustment_id= ##$$ADJID$$##
and    adj.adjustment_id < rev.adjustment_id
and    rev.created_from = ''REVERSE_ADJUSTMENT''
and    adj.associated_application_id = rev.associated_application_id
and    adj.amount = (-1)*rev.amount
and    rev.postable = ''Y''
and    rev.posting_control_id = -3
and    adj_dst.SOURCE_TABLE = ''ADJ''
and    adj_dst.SOURCE_ID = adj.adjustment_id
and    rev_dst.SOURCE_TABLE = ''ADJ''
and    rev_dst.SOURCE_ID = rev.adjustment_id
and    adj_dst.SOURCE_TYPE = rev_dst.SOURCE_TYPE
and    (adj_dst.AMOUNT_DR = rev_dst.AMOUNT_CR
        or rev_dst.AMOUNT_DR = adj_dst.AMOUNT_CR)
and    nvl(adj_dst.REF_CUSTOMER_TRX_LINE_ID, -1) = nvl(rev_dst.REF_CUSTOMER_TRX_LINE_ID,-1)
and    nvl(adj_dst.REF_CUST_TRX_LINE_GL_DIST_ID,-1) = nvl(rev_dst.REF_CUST_TRX_LINE_GL_DIST_ID,-1)
and    nvl(adj_dst.REF_ACCOUNT_CLASS,-1) = nvl(rev_dst.REF_ACCOUNT_CLASS,-1) 
and    adj_dst.CODE_COMBINATION_ID <> rev_dst.CODE_COMBINATION_ID',
      p_title                  => 'Reversal Adjustment With Invalid CODE_COMBINATION_ID',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Reversal adjustment with invalid account',
      p_solution               => '<ul><li>The analyzer has identified data corruption described in [2265927.1].</li>
<li>Please log a Service Request and upload this Adjustment Analyzer output.</li>
</ul>',
      p_success_msg            => 'There are no Reversal Adjustments with invalid account',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_ADJ_AR_S_00112_REV_ADJ_INVALID_CCID');



debug('begin add_signature: EBS_FIN_AR_ADJ_XLA_GL_XFR_IN_XLA_NOT_IN_GL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23209',
      p_sig_id                 => 'EBS_FIN_AR_ADJ_XLA_GL_XFR_IN_XLA_NOT_IN_GL',
...
AND NOT EXISTS (SELECT 1 
      ...
      p_title                  => 'Marked as Transferred in XLA but not in GL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Adjustment has record(s) marked as transferred in XLA but not in GL.',
      p_solution               => '<ul>
<li>The analyzer has identified data corruption described in [3071537.1]</li> <li>Please follow the steps provided in the document in a TEST instance with the same data as PROD. If the issue is resolved, please migrate the solution to the other environments; otherwise, please log a Service Request and upload this Analyzer output</li>
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_ADJ_XLA_GL_XFR_IN_XLA_NOT_IN_GL');



debug('begin add_signature: EBS_FIN_AR_ADJ_AR_S_00125_MISS_DIST_TYPE_ADJ');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26208',
      p_sig_id                 => 'EBS_FIN_AR_ADJ_AR_S_00125_MISS_DIST_TYPE_ADJ',
      p_sig_sql                => 'select * 
from   ar_adjustments_all adj
where  adjustment_id = ##$$ADJID$$##
and    adj.posting_control_id = -3
and    adj.postable = ''Y''
and exists ( select ''x'' from ar_distributions_all
                      where source_table = ''ADJ''
                      and source_id = adj.adjustment_id
                      and SOURCE_TYPE =''REC'' )
and not exists ( select ''x'' from ar_distributions_all
                            where source_table = ''ADJ''
                            and source_id = adj.adjustment_id
                                and SOURCE_TYPE <> ''REC'' )',
      p_title                  => 'Adjustment with Missing Distribution Line(s) for SOURCE_TYPE = ADJ  (AR_S_00125)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The adjustment is missing distributions lines for SOURCE_TYPE  ''ADJ'' ',
      p_solution               => '<ul><li>The analyzer has identified data corruption described in [1573903.1]</li>
<li>Please log a Service Request and upload this analyzer output.</li></ul>
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_ADJ_AR_S_00125_MISS_DIST_TYPE_ADJ');



debug('begin add_signature: EBS_FIN_AR_ADJ_ACCTD_AMOUNT_FUNC_CURR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29284',
      p_sig_id                 => 'EBS_FIN_AR_ADJ_ACCTD_AMOUNT_FUNC_CURR',
      p_sig_sql                => 'select adj.ADJUSTMENT_ID, adj.AMOUNT, adj.STATUS,adj.POSTING_CONTROL_ID,
adj.ACCTD_AMOUNT, ct.INVOICE_CURRENCY_CODE, gl.CURRENCY_CODE LEDGER_CURRENCY_CODE
from AR_ADJUSTMENTS_ALL adj, RA_CUSTOMER_TRX_ALL ct, GL_LEDGERS gl
...
and adj.ADJUSTMENT_ID = ##$$ADJID$$##',
      p_title                  => 'Incorrect ACCTD_AMOUNT for Adjustment in Functional Currency',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Adjustment in Functional Currency have ACCTD_AMOUNT that is not equal to AMOUNT in AR_ADJUSTMENTS_ALL.
',
      p_solution               => '<ul><li>The analyzer has identified data corruption described in [2997932.1]</li>
<li>Please log a Service Request and upload this analyzer output.</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_ADJ_ACCTD_AMOUNT_FUNC_CURR');



debug('begin add_signature: AR_ADJ_ORPHAN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5829',
      p_sig_id                 => 'AR_ADJ_ORPHAN',
      p_sig_sql                => 'select
xte.source_id_int_1 Adjustment_Id,
xte.transaction_number ADJ_Number,
xte.entity_id,
xe.event_id,
xe.event_date,
...
(select ''x''
from ar_adjustments_all
where adjustment_id = xte.source_id_int_1
and posting_control_id = -3
and event_id = xe.event_id)
order by xte.source_id_int_1 asc, xe.event_id',
      p_title                  => 'Orphan Adjustment Event',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Orphan adjustments event exist
',
      p_solution               => '<ul><li>The analyzer has identified data corruption described in [549020.1]</li>
<li>Check if adjustment exist and event needs to be populated in AR table if event_id is null.</li>
<li>Please log a Service Request and upload this analyzer output.</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_ORPHAN');



debug('begin add_signature: EBS_FIN_AR_ADJ_INACTIVE_SALESREP_TRX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31840',
      p_sig_id                 => 'EBS_FIN_AR_ADJ_INACTIVE_SALESREP_TRX',
      p_sig_sql                => 'select trx.trx_number, trx.primary_salesrep_id, jtf.name, jtf.status, 
jtf.start_date_active, jtf.end_date_active, jtf.person_id,
per.effective_start_date, per.effective_end_date
from ra_customer_trx_all trx, jtf_rs_salesreps jtf, per_all_assignments_f per
where trx.primary_salesrep_id = jtf.salesrep_id
and jtf.person_id = per.person_id
and ( jtf.status <> ''A'' or  jtf.end_date_active <= sysdate )
and not exists (select 1 from   per_all_assignments_f
   where trunc(sysdate) between trunc(effective_start_date) and trunc(nvl(effective_end_date,sysdate+1)))
and trx.customer_trx_id = ##$$TRX_ID$$##',
      p_title                  => 'Inactive Salesperson in Transaction',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This transaction has an inactive salesperson.',
      p_solution               => '<ul> <li>The analyzer has identified the issue described in [2247298.1].</li> <li>Please log a Service Request and upload this analyzer output.</li> </ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_ADJ_INACTIVE_SALESREP_TRX');
...
debug('begin add_signature: AR_PC_AR_PERIOD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3644',
      p_sig_id                 => 'AR_PC_AR_PERIOD',
      p_sig_sql                => 'SELECT application_id, set_of_books_id, closing_status, period_year, period_name, start_date, end_date, to_char(last_update_date,''DD-MON-YYYY HH24:MI:SS'') last_update_date
FROM gl_period_statuses gps
WHERE application_id = 222
AND nvl(adjustment_period_flag,''N'') = ''N'' 
AND set_of_books_id in 
( 
 select distinct a.target_ledger_id ledger_id
from   gl_ledger_relationships a,
       gl_ledgers b
where  ledger_id = ##$$LEDGERID$$##
and    a.primary_ledger_id = b.ledger_id
AND    gps.period_year =  (select period_year
                           from   gl_period_statuses gps2
                           where  gps2.period_name = ''##$$PERIODNAME$$##''
                           and    gps2.application_id = 222
                           and    gps2.set_of_books_id = ##$$LEDGERID$$##))
order by 1 desc, 2 asc, 6 asc',
      p_title                  => 'AR Period Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Could not locate period status information for Oracle Receivables for the year associated to the period = '||mask_text(g_period_tmp, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => 'Please check your calendar setup for Oracle Receivables.',
      p_success_msg            => 'This is a data collection of period status information for Oracle Receivables for the year associated to the period = '||mask_text(g_period_tmp, nvl( upper(''), 'NO_MASK') )||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_PC_AR_PERIOD');



debug('begin add_signature: AR_PC_GL_PERIOD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5864',
      p_sig_id                 => 'AR_PC_GL_PERIOD',
      p_sig_sql                => 'SELECT application_id, set_of_books_id, closing_status, period_year, period_name, start_date, end_date, to_char(last_update_date,''DD-MON-YYYY HH24:MI:SS'') last_update_date
FROM gl_period_statuses gps
WHERE application_id = 101
AND nvl(adjustment_period_flag,''N'') = ''N'' 
...
order by 1 desc, 2 asc, 6 asc',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Could not locate period status information for Oracle General Ledger for the year associated to the period = '||mask_text(g_period_tmp, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => 'Please check your calendar setup for Oracle General Ledger.',
      p_success_msg            => 'This is a data collection of period status information for Oracle General Ledger for the year associated to the period = '||mask_text(g_period_tmp, nvl( upper(''), 'NO_MASK') )||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_PC_GL_PERIOD');



debug('begin add_signature: AR_PC_COMPARE_GL_PERIOD_STATUSES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19672',
      p_sig_id                 => 'AR_PC_COMPARE_GL_PERIOD_STATUSES',
    ...
    WHERE  gps.period_year = (select  period_year
                                                       from    gl_period_statuses gps3
                                                       where  gps3.period_name =  ''##$$PERIODNAME$$##''
                                                       and      gps3.application_id = 222
                                                       and      gps3.set_of_books_id = ##$$LEDGERID$$##)
    ...
    ORDER BY gps.set_of_books_id asc, gps.start_date asc',
      ...
      p_problem_descr          => 'GL period statuses are inconsistent between AR and GL.
',
   ...
   l_info.delete;
debug('end add_signature: AR_PC_COMPARE_GL_PERIOD_STATUSES');



debug('begin add_signature: AR_GEN_PERIOD_INFO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5819',
      p_sig_id                 => 'AR_GEN_PERIOD_INFO',
      p_sig_sql                => 'select gl.period_name
from GL_PERIOD_STATUSES GL, AR_SYSTEM_PARAMETERS_ALL AR
where ar.org_id = ##$$ORGID$$##
and gl.period_name = ''##$$PERIODNAME$$##''
...
and gl.set_of_books_id = ar.set_of_books_id',
      ...
      p_solution               => 'This section is a data collection for period information for Oracle Receivables (AR) and General Ledger (GL) for the year associated with '||mask_text(g_period_tmp, nvl( upper(''), 'NO_MASK') )||'.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('AR_PC_AR_PERIOD','AR_PC_GL_PERIOD','AR_PC_COMPARE_GL_PERIOD_STATUSES'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '26'
      );
   l_info.delete;
debug('end add_signature: AR_GEN_PERIOD_INFO');
...
debug('begin add_signature: AR_ADJ_ADJUSTMENT_PENDING_APPROVAL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4941',
      p_sig_id                 => 'AR_ADJ_ADJUSTMENT_PENDING_APPROVAL',
      p_sig_sql                => 'select adjustment_id, adjustment_number, status, amount, gl_date
from   ar_adjustments_all
where  adjustment_id = ##$$ADJID$$##
and    status not in (''A'',''R'')',
      p_title                  => 'Adjustment Pending Approval',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This adjustment has not yet been approved/rejected.',
      p_solution               => 'This adjustment is pending approval. Please perform one of the following to process this adjustment:
<ul>
<li>Approve the adjustment and run Create Accounting.</li>
<li>Reject the adjustment.</li>
<li>For more information, review [1571833.1] How to Approve Adjustments?</li>
</ul>
',
      p_success_msg            => 'This adjustment is not waiting for approval. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_ADJUSTMENT_PENDING_APPROVAL');



debug('begin add_signature: AR_ADJ_USER_HAS_NO_APPROVAL_LIMIT');
   l_info('##MASK##USER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4942',
      p_sig_id                 => 'AR_ADJ_USER_HAS_NO_APPROVAL_LIMIT',
      p_sig_sql                => 'select adjustment_id, adjustment_number, amount, 
       invoice_currency_code currency_code, b.user_name user_name
from   ar_adjustments_all adj,
       ar_approval_user_limits aul,
       fnd_user b,
       ra_customer_trx_all trx
where  trx.customer_trx_id = ##$$TRX_ID$$##
and    adj.customer_trx_id = trx.customer_trx_id
and    aul.user_id = adj.created_by
and    adj.amount not between aul.amount_from and aul.amount_to
and    aul.user_id = b.user_id
and    aul.document_type = ''ADJ''
and    currency_code = ''##$$CURRENCY$$##''',
      p_title                  => 'Approval Limits Setup',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The adjustment amount is outside the user approval limit.',
      p_solution               => '<ul>
<li>The adjustment amount for the user approval limit has to be reviewed/updated.</li>
<li>Please review [1609261.1] Transactions Workbench: Approving Adjustments and Receive Error - APP-AR-11363: You Cannot Approve This Adjustment Because it is Not Within Your Approval Limits.</li>
</ul>',
      p_success_msg            => 'No issues found with approval limits.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AR_ADJ_USER_HAS_NO_APPROVAL_LIMIT');



debug('begin add_signature: EBS_FIN_AR_ADJ_PREVENT_PERIOD_CLOSURE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29539',
      p_sig_id                 => 'EBS_FIN_AR_ADJ_PREVENT_PERIOD_CLOSURE',
      p_sig_sql                => 'select ADJUSTMENT_ID, ADJUSTMENT_NUMBER, STATUS, AMOUNT, GL_DATE
from AR_ADJUSTMENTS_ALL
where ADJUSTMENT_ID= ##$$ADJID$$##
and STATUS = ''M''',
      p_title                  => 'Adjustment Prevents Period Closure',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This adjustment has status M (More Research) which will prevent period closure.',
      p_solution               => 'Please perform one of the following to process this adjustment:
<ul>
<li>Approve the adjustment and run Create Accounting.</li>
<li>Reject the adjustment.</li>
<li>For more information, review [2905513.1] Period Close Error Due to Incomplete Adjustment: ''APP-AR-294571: The PERIOD_NAME cannot be closed due to some unprocessed accounting events or untransferred journal entries.''</li>
</ul>
',
      p_success_msg            => 'This adjustment will not prevent period closure.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_ADJ_PREVENT_PERIOD_CLOSURE');
...
BEGIN
  ...
  IF (p_includeGL IS NOT NULL) THEN
    g_params_string := g_params_string || to_char(p_includeGL) || '_';
  END IF;
  ...
  analyzer_title := 'Receivables Adjustment Analyzer';
...
debug('begin section: ADJ_DATA');
start_section('Adjustment Data', 'ADJ_DATA');
   set_item_result(run_stored_sig('AR_ADJ_SUMMARY_INFO'));
   set_item_result(run_stored_sig('AR_TRX_SUMMARY_INFO'));
   set_item_result(run_stored_sig('AR_ADJ_AR_ADJUSTMENTS_ALL'));
   IF g_status not in ('A','R') THEN
      set_item_result(run_stored_sig('AR_ADJ_ADJUSTMENT_PENDING_APPROVAL'));
      set_item_result(run_stored_sig('AR_ADJ_USER_HAS_NO_APPROVAL_LIMIT'));
      IF g_status='M' THEN
         set_item_result(run_stored_sig('EBS_FIN_AR_ADJ_PREVENT_PERIOD_CLOSURE'));
      END IF;
   END IF;
   set_item_result(run_stored_sig('AR_ADJ_AR_DISTRIBUTIONS_ALL'));
   set_item_result(run_stored_sig('AR_ADJ_AR_DISTRIBUTIONS_ALL_TOTALS'));
   set_item_result(run_stored_sig('AR_ADJ_AR_RECEIVABLES_TRX_ALL'));
   set_item_result(run_stored_sig('AR_ADJ_AR_ACCOUNTS'));
   set_item_result(run_stored_sig('AR_ADJ_VIOLATE_CROSS_VAL_RULE'));
end_section;
debug('end section: ADJ_DATA');

debug('begin section: XLA_DATA');
start_section('XLA Data', 'XLA_DATA');
   set_item_result(run_stored_sig('AR_ADJ_XLA_TRANSACTION_ENTITIES'));
   set_item_result(run_stored_sig('AR_ADJ_XLA_EVENTS'));
   set_item_result(run_stored_sig('AR_ADJ_XLA_AE_HEADERS'));
   set_item_result(run_stored_sig('AR_ADJ_XLA_AE_LINES'));
   set_item_result(run_stored_sig('AR_ADJ_XLA_ ACCOUNTS'));
   set_item_result(run_stored_sig('AR_ADJ_XLA_DISTRIBUTION_LINKS'));
   set_item_result(run_stored_sig('AR_ADJ_XLA_ACCOUNTING_ERRORS'));
   set_item_result(run_stored_sig('EBS_FIN_AR_ADJ_XLA_CUSTOM_ADRS'));
end_section;
...
IF nvl(g_ax_accounted_flag,'N') = 'Y' THEN
   start_section('AX Data', 'AX_DATA');
      set_item_result(run_stored_sig('AR_ADJ_AX_EVENTS'));
      set_item_result(run_stored_sig('AR_ADJ_AX_SLE_HEADERS'));
      set_item_result(run_stored_sig('AR_ADJ_AX_SLE_LINES'));
   end_section;
END IF;
debug('end section: AX_DATA');

debug('begin section: TRANSACTION_DATA');
start_section('Transaction Data', 'TRANSACTION_DATA');
   set_item_result(run_stored_sig('AR_ADJ_RA_CUSTOMER_TRX_ALL'));
   set_item_result(run_stored_sig('AR_ADJ_TRX_FND_CURRENCY'));
   set_item_result(run_stored_sig('AR_ADJ_TRX_GL_DAILY_RATES'));
   set_item_result(run_stored_sig('AR_ADJ_RA_BATCH_SOURCES_ALL'));
   set_item_result(run_stored_sig('AR_ADJ_RA_CUST_TRX_TYPES_ALL'));
   set_item_result(run_stored_sig('AR_ADJ_RA_CUSTOMER_TRX_LINES_ALL'));
   set_item_result(run_stored_sig('AR_ADJ_TRX_RA_CUSTOMER_TRX_LINES_ALL_TOTALS'));
   set_item_result(run_stored_sig('AR_ADJ_ZX_LINES'));
   set_item_result(run_stored_sig('AR_ADJ_ZX_LINES_DET_FACTORS'));
   set_item_result(run_stored_sig('AR_ADJ_RA_CUST_TRX_LINE_GL_DIST_ALL'));
   set_item_result(run_stored_sig('AR_ADJ_GL_DIST_TOTALS_CHECK'));
   set_item_result(run_stored_sig('AR_ADJ_AR_ACCOUNT_FOR_TRANSACTION'));
   set_item_result(run_stored_sig('AR_ADJ_TRX_APPLICATIONS_TO'));
   set_item_result(run_stored_sig('AR_ADJ_APPLICATIONS_TO_TRANSACTION_TOTALS'));
   set_item_result(run_stored_sig('AR_ADJ_TRANSACTION_APPLICATIONS'));
   set_item_result(run_stored_sig('AR_ADJ_APPLICATIONS_TO_FROM_DISTRIBUTIONS'));
   set_item_result(run_stored_sig('AR_ADJ_ADJUSTMENTS_ON_TRANSACTION'));
   set_item_result(run_stored_sig('AR_ADJ_ADJ_DIST_ON_TRX'));
   set_item_result(run_stored_sig('AR_ADJ_AR_PAYMENT_SCHEDULES_ALL'));
end_section;
debug('end section: TRANSACTION_DATA');

debug('begin section: GL_DATA');
IF upper(p_includeGL) = 'Y' THEN
   start_section('GL Data', 'GL_DATA');
      set_item_result(run_stored_sig('AR_ADJ_GL_JE_BATCHES'));
      set_item_result(run_stored_sig('AR_ADJ_GL_JE_HEADERS'));
      set_item_result(run_stored_sig('AR_ADJ_GL_JE_LINES'));
      set_item_result(run_stored_sig('EBS_FIN_AR_ADJ_GL_ACCTS'));
      set_item_result(run_stored_sig('AR_ADJ_GL_IMPORT_REFERENCES'));
   end_section;
END IF;
...
start_section('Customer Data', 'CUSTOMER_DATA');
   set_item_result(run_stored_sig('AR_ADJ_HZ_CUST_ACCOUNTS_ALL'));
   set_item_result(run_stored_sig('AR_ADJ_HZ_CUST_ACCT_RELATE_ALL'));
   set_item_result(run_stored_sig('AR_ADJ_HZ_CUST_ACCT_SITES_ALL'));
   set_item_result(run_stored_sig('AR_ADJ_HZ_CUST_SITE_USES_ALL'));
   set_item_result(run_stored_sig('AR_ADJ_HZ_LOCATIONS'));
   set_item_result(run_stored_sig('AR_ADJ_HZ_PARTIES'));
   set_item_result(run_stored_sig('AR_ADJ_HZ_PARTY_SITES'));
   set_item_result(run_stored_sig('AR_ADJ_HZ_CUSTOMER_PROFILES'));
   set_item_result(run_stored_sig('EBS_FIN_AR_ADJ_HZ_ORG_PROF'));
end_section;
debug('end section: CUSTOMER_DATA');

debug('begin section: DATA_INTEGRITY');
start_section('Data Integrity', 'DATA_INTEGRITY');
   set_item_result(run_stored_sig('AR_ADJ_SCRIPT_PARAMETERS'));
   set_item_result(run_stored_sig('AR_ADJ_AR_00034_AR_00044_AR_00237_INCOMP_XLA_EVENTS'));
   set_item_result(run_stored_sig('AR_ADJ_AR_00037_UNPOSTED_ADJ_FOR_INV_WITH_RULE'));
   set_item_result(run_stored_sig('AR_ADJ_AR_00039_INCORRECT_JE_CATEGORY'));
   set_item_result(run_stored_sig('AR_ADJ_AR_00040_ADJ_NON_POSTABLE'));
   set_item_result(run_stored_sig('AR_ADJ_AR_00047_ADJUSTMENT_WITH_NULL_EVENT_ID'));
   set_item_result(run_stored_sig('AR_ADJ_AR_00050_DUP_DEFER_TAX_DIST'));
   set_item_result(run_stored_sig('AR_ADJ_AR_00141_UPGRADED_11I_ADJ_INCOMP_EVENT'));
   set_item_result(run_stored_sig('AR_ADJ_AR_00229_DIST_MISSING_REF_COLUMN'));
   set_item_result(run_stored_sig('AR_ADJ_AR_00257_ADJ_APP_REV_REC_NOT_RUN'));
   set_item_result(run_stored_sig('AR_ADJ_AR_S_00005_ADJ_MISS_DIST'));
   set_item_result(run_stored_sig('AR_ADJ_AR_S_00015_ADJ_MISSING_EVENT'));
   set_item_result(run_stored_sig('AR_ADJ_AR_S_00052_POSTABLE_NON_POST_EVENT'));
   set_item_result(run_stored_sig('AR_ADJ_AR_S_00053_AMT_NOT_ZERO_ACCT_AMT_ZERO'));
   set_item_result(run_stored_sig('AR_ADJ_AR_S_00070_ADJ_GLDATE_TIMESTAMP'));
   set_item_result(run_stored_sig('AR_ADJ_AR_S_00074_REJECTED_ADJ_HAS_DIST'));
   set_item_result(run_stored_sig('AR_ADJ_AR_S_00097_ARD_AMOUNT_DIFF_ACCTD_AMOHNT_FUNC_CURR'));
   set_item_result(run_stored_sig('AR_ADJ_AR_S_00103_DUP_XLA_AE_HEADERS'));
   set_item_result(run_stored_sig('EBS_FIN_AR_ADJ_AR_S_00107_UPG_PENDING_APPROVAL'));
   set_item_result(run_stored_sig('EBS_FIN_AR_ADJ_AR_S_00112_REV_ADJ_INVALID_CCID'));
   set_item_result(run_stored_sig('EBS_FIN_AR_ADJ_XLA_GL_XFR_IN_XLA_NOT_IN_GL'));
   set_item_result(run_stored_sig('EBS_FIN_AR_ADJ_AR_S_00125_MISS_DIST_TYPE_ADJ'));
   set_item_result(run_stored_sig('EBS_FIN_AR_ADJ_ACCTD_AMOUNT_FUNC_CURR'));
   set_item_result(run_stored_sig('AR_ADJ_ORPHAN'));
   set_item_result(run_stored_sig('EBS_FIN_AR_ADJ_INACTIVE_SALESREP_TRX'));
end_section;
...
start_section('Setup and Environment Information', 'CONSOLIDATED_SETUP');
   ...
   set_item_result(run_stored_sig('AR_GEN_PERIOD_INFO'));
