...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Property Manager Analyzer              |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
BEGIN
 ...
 if apps_version NOT IN ('12.1','12.2') then
    ...
    dbms_output.put_line('***   12.1,12.2 ');
    dbms_output.put_line('*** Note: the error below is intentional                    ');
    raise_application_error(-20001, 'ERROR: The script requires eBusiness versions 12.1,12.2');
 end if;
...
CREATE OR REPLACE PACKAGE pn_analyzer_pkg AUTHID DEFINER AS
...
(            p_org_id                       IN VARCHAR2    DEFAULT NULL
           ,p_lease_num                    IN VARCHAR2    DEFAULT NULL
           ,P_VAR_RENT_ID                  IN VARCHAR2    DEFAULT NULL
           ,p_equipment_lease_num          IN VARCHAR2    DEFAULT NULL
...
CREATE OR REPLACE PACKAGE BODY pn_analyzer_pkg AS
-- $Id: pn_analyzer.sql, 200.46 2026/01/28 13:15:49 monikgup Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2365436.1));
...
----------------------------------------------------------------
--G_TABLES_EXISTS BOOLEAN := FALSE;
--G_TABLES_EXISTS NUMBER := 0;
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'PNANALYZER_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'PNANALYZER_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>PNANALYZER Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2365436.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/pn_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1554,EBS,EBS Financials,EBS - Fixed Assets" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1554,EBS,EBS Financials,EBS - Fixed Assets" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1554,EBS,EBS Financials,EBS - Fixed Assets" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4139530" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">1554</span>
...
<p><strong>Version 200.46:</strong></p><ol><li>EBS KB Article IDs Shown for Signature KM Links</li>
</ol>
<p><strong>Version 200.45</strong>:</p><p>&nbsp; &nbsp;1. Analyzer formatting change for new Support portal.&nbsp;</p><p>&nbsp; &nbsp;2. Changed to critical sequences signatures.</p><p>&nbsp; &nbsp;3. Several signatures were updated to improve performance and fetch data and some new signatures were added to capture equipment lease errors/ item distribution details for equipment lease/combined data for PN stream headers and lines to Equipment lease.</p><p><strong>Version 200.44</strong>:</p><ol><li><span style="font-family:&apos;Times New Roman&apos;,serif;font-size:12.0pt;">For "Diagnostics: Apps Check" section, the following new signature was added for Oracle Support:</span><ul><li><span style="font-family:&apos;Times New Roman&apos;,serif;font-size:12.0pt;">Instance Summary</span></li>
</ul>
</li>
</ol>
<p><strong>Version 200.43</strong>:</p><ol><li><span style="font-family:&apos;Times New Roman&apos;,serif;font-size:12.0pt;">New Analyzer Framework version 4.7.3 released with enhancements.</span><ul><li><span style="font-family:&apos;Times New Roman&apos;,serif;font-size:12.0pt;">SQL*Plus Error fixed: SP2-0027: Input is too long</span></li>
<li><span style="font-family:&apos;Times New Roman&apos;,serif;font-size:12.0pt;">Ability to click to select rows in output tables</span></li>
</ul>
</li>
<li><span style="font-family:&apos;Times New Roman&apos;,serif;font-size:12.0pt;">‘Recommended Patches’ section</span> includes the latest CU patch:<ul><li>Patch 36778823 - 12.2 Cumulative Update 2024.10 : Property &amp; Equipment Leases: IFRS 16, ASC 842 &amp; SFFAS 54 Compliance Solution</li>
</ul>
</li>
</ol>
<p><strong>Version 200.42:</strong></p><ol><li>Signatures were enhanced in these sections:<ol><li>"Setup and Profiles" - "GL Calendar of the Organization" script modified.</li>
<li>"Diagnostics: Apps Check" - “Application Installation Details” script modified.</li>
</ol>
</li>
</ol>
<p><strong>Version 200.41:</strong></p><ol><li>New Analyzer Framework version 4.7.2 released with enhancements.</li>
<li>For section: "IFRS" - Signature "Stream Headers and Lines Data (PN_STREAM_LINES_ALL)" / EBS_FIN_FA_PNANALYZER_PN_STREAM_HEADER_LINES SQL script modified for signature.</li>
<li>For section: "ToolBox - Helpful IFRS guidelines, Tips and API Information" &gt; "API Documentation" the following 4 API documents were added:<ul><li>DocID 2944817.1 - Oracle Property Manager Lease Versioning Property Lease API Documentation Supplement</li>
<li>DocID 2990040.1 - Oracle Property Manager Lease Versioning Equipment Lease API Documentation Supplement</li>
<li>DocID 3007963.1 - Oracle Property Manager Statements of Federal Financial Accounting Standards 54(SFFAS 54) API Documentation Supplement</li>
<li>DocID 2066548.1 - Property Manager Create/Update Variable Rent APIs Technical Brief</li>
</ul>
</li>
</ol>
<p><strong>Version 200.40:</strong></p><ol><li>New Analyzer Framework version 4.7.1 released with enhancements.</li>
<li>For Sig: EBS_FIN_FA_PNANALYZER_PN_GL_CALENDAR_INFO - Added period_num and period_year for Support.</li>
</ol>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1554,'||l_sig.sigrepo_id||',EBS,EBS Financials,EBS - Fixed Assets" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1554,'||l_sig.sigrepo_id||',EBS,EBS Financials,EBS - Fixed Assets" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1554,'||l_sig.sigrepo_id||',EBS,EBS Financials,EBS - Fixed Assets" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1554,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Fixed Assets" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1554,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Fixed Assets" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1554,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Fixed Assets" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
FUNCTION check_rec_patches_1 RETURN VARCHAR2 IS
  /* Signature PN_CHECK_REC_PATCHES */
...
BEGIN
    ...
    print_log('Processing recommended patches signature: PN_CHECK_REC_PATCHES (check_rec_patches_1) "Recommended Patches" (version 20)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_col_rows(1)(l_rows) := '22687431';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.PN.B.delta.5: R12.PN.B.DELTA.5';
   l_col_rows(5)(l_rows) := '[1346567.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '22923637';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Property Manager Cumulative Update 1 Release for 12.1 (R12.PN.B.DELTA.5)';
   l_col_rows(5)(l_rows) := '[1346567.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '23584859';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Property Manager Cumulative Update 2 Release for 12.1 (R12.PN.B.DELTA.5)';
   l_col_rows(5)(l_rows) := '[1346567.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '29288372';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.1 Cumulative Update 2019.02 : Property & Equipment Leases: IFRS 16 & ASC 842 Compliance Solution';
   l_col_rows(5)(l_rows) := '[2482062.2]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Cumulative Update 2019.02 : Property & Equipment Leases: IFRS 16 & ASC 842 Compliance Solution';
   l_col_rows(5)(l_rows) := '[2482062.2]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '29439436';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Cumulative Update 2019.03 : Property & Equipment Leases: IFRS 16 & ASC 842 Compliance Solution';
   l_col_rows(5)(l_rows) := '[2482062.2]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.2 Cumulative Update 2019.03 : Property & Equipment Leases: IFRS 16 & ASC 842 Compliance Solution';
   l_col_rows(5)(l_rows) := '[2482062.2]';
...
IF substr(g_rep_info('Apps Version'),1,6) = '12.1.3' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30554810';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.1 Cumulative Update 2020.05 : Property & Equipment Leases: IFRS 16 & ASC 842 Compliance Solution';
   l_col_rows(5)(l_rows) := '[2482062.2]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.2 Cumulative Update 2020.05 : Property & Equipment Leases: IFRS 16 & ASC 842 Compliance Solution';
   l_col_rows(5)(l_rows) := '[2482062.2]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30746709';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.2 Cumulative Update 2019.11 : Property & Equipment Leases: IFRS 16 & ASC 842 Compliance Solution';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '29876415';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.2 Cumulative Update 2019.07 : Property & Equipment Leases: IFRS 16 & ASC 842 Compliance Solution';
   l_col_rows(5)(l_rows) := NULL;

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '29789413';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.2 Cumulative Update 2019.05 : Property & Equipment Leases: IFRS 16 & ASC 842 Compliance Solution';
   l_col_rows(5)(l_rows) := NULL;
...
IF substr(g_rep_info('Apps Version'),1,6) = '12.1.3' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30133777';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.1 Cumulative Update 2019.11 : Property & Equipment Leases: IFRS 16 & ASC 842 Compliance Solution';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.1 Cumulative Update 2019.07 : Property & Equipment Leases: IFRS 16 & ASC 842 Compliance Solution';
   l_col_rows(5)(l_rows) := NULL;
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.1 Cumulative Update 2019.05 : Property & Equipment Leases: IFRS 16 & ASC 842 Compliance Solution';
   l_col_rows(5)(l_rows) := NULL;
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '31955152';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.1 Cumulative Update 2020.11 : Property & Equipment Leases: IFRS 16 & ASC 842 Compliance Solution';
   l_col_rows(5)(l_rows) := '[2482062.2]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.2 Cumulative Update 2020.11 : Property & Equipment Leases: IFRS 16 & ASC 842 Compliance Solution';
   l_col_rows(5)(l_rows) := '[2482062.2]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33025473';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.1 Cumulative Update 2021.05 : Property & Equipment Leases: IFRS 16 & ASC 842 Compliance Solution';
   l_col_rows(5)(l_rows) := '[2482062.2]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '32169559';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.2 Cumulative Update 2021.05 : Property & Equipment Leases: IFRS 16 & ASC 842 Compliance Solution';
   l_col_rows(5)(l_rows) := '[2482062.2]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '32933883';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'IFRS LEASE BUG FIXES CONSOLIDATION 2021 YEAR END';
   l_col_rows(5)(l_rows) := '[2482062.2]';
...
IF substr(g_rep_info('Apps Version'),1,6) = '12.1.3' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33388253';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'PN: 12.1.3 DELTA8 CU 2021.11(CU6) RELEASE DATE 15-NOV-2021';
   l_col_rows(5)(l_rows) := '[2482062.2]';
...
IF substr(g_rep_info('Apps Version'),1,6) = '12.2.4' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35573606';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.2 Cumulative Update 2023.08 : Property & Equipment Leases: IFRS 16, ASC 842 & SFFAS 54 Compliance Solution';
   l_col_rows(5)(l_rows) := '[2482062.2]';
...
IF substr(g_rep_info('Apps Version'),1,6) = '12.2.4' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '34534575';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.2 Cumulative Update 2022.07 : Property & Equipment Leases: IFRS 16 & ASC 842 Compliance Solution';
   l_col_rows(5)(l_rows) := '[2482062.2]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33616383';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.1 Cumulative Update 2022.07 : Property & Equipment Leases: IFRS 16 & ASC 842 Compliance Solution';
   l_col_rows(5)(l_rows) := '[2482062.2]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '35781424';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.2 Cumulative Update 2024.06 : Property & Equipment Leases: IFRS 16, ASC 842 & SFFAS 54 Compliance Solution';
   l_col_rows(5)(l_rows) := '[2482062.2]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '36778823';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.2 Cumulative Update 2024.10 : Property & Equipment Leases: IFRS 16, ASC 842 & SFFAS 54 Compliance Solution';
   l_col_rows(5)(l_rows) := '[2482062.2]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '37974617';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '12.2 Cumulative Update 2025.07 : Property & Equipment Leases: IFRS 16, ASC 842 & SFFAS 54 Compliance Solution';
   l_col_rows(5)(l_rows) := '[2482062.2]';
...
<b>The Recommended Patches include very important fixes for Oracle Property Manager application.</b><br><br>
...
Best Practice: Always ensure that you are on the latest code with all recommended patches applied. This will help avoid known issues, prevent potential data corruption and provide the latest features and functionality. Having a proactive patching plan and periodic proactive patching process in place are the best ways to stay current.';
  ...
  -- Register
  l_step := '60';
  g_signatures('PN_CHECK_REC_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'PN_CHECK_REC_PATCHES',     -- sig ID
...
----------------------------------------------------------------
l_count  NUMBER := 0;
l_equipment_lease_num VARCHAR2(100);
l_param_sql   VARCHAR2(300);
--l_ORG_ID           VARCHAR (512); -- Added 2/8/21
--l_ORG_ID          NUMBER; -- Added 2/8/21
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Operating Unit';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_org_id,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Lease Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_lease_num,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Variable Rent Id';
   g_parameters(g_parameters.LAST).pvalue := mask_text(P_VAR_RENT_ID,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Equipment Lease Number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_equipment_lease_num,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  l_revision := rtrim(replace('$Revision: 200.46  $','$',''));
  l_revision := ltrim(replace(l_revision,'Revision:',''));
  l_date_char := rtrim(replace('$Date: 2026/01/28 13:15:48 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'pn_analyzer.sql';
...
IF p_org_id IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Operating Unit is required.');
...
SELECT SS.ORG_ID
INTO l_exists_val
FROM HR_OPERATING_UNITS O, PN_SYSTEM_SETUP_OPTIONS SS
WHERE SS.ORG_ID = p_org_id
 AND SS.ORG_ID = O.ORGANIZATION_ID
and (mo_global.is_mo_init_done = 'N'  or mo_global.check_access(O.ORGANIZATION_ID) = 'Y')

 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Organization ID specified. Make sure to enter org_id obtained from PN_SYSTEM_SETUP_OPTIONS.');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
debug('begin parameter validation: p_lease_num');
IF p_lease_num IS NOT NULL THEN
BEGIN
SELECT LEASE_NUM
INTO l_exists_val
FROM PN_LEASES_ALL
WHERE LEASE_NUM = p_lease_num
 AND LEASE_NUM in (SELECT DISTINCT LEASE_NUM
FROM PN_LEASES_ALL
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Lease number not found');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_lease_num failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_lease_num');

debug('begin parameter validation: P_VAR_RENT_ID');
IF P_VAR_RENT_ID IS NOT NULL THEN
BEGIN
SELECT VAR_RENT_ID
INTO l_exists_val
FROM PN_VAR_RENTS_ALL
WHERE VAR_RENT_ID = P_VAR_RENT_ID and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Variable Rent Id not found.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for P_VAR_RENT_ID failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: P_VAR_RENT_ID');
...
-- In case validation at the beginning is updated/removed, adding validation here also so execution fails
  ...
  IF substr(l_apps_version,1,4) NOT IN ('12.1','12.2') THEN
    print_log('eBusiness Suite version = '||l_apps_version);
    print_log('ERROR: This Analyzer script is compatible for following version(s): 12.1,12.2');
    raise invalid_parameters;
  END IF;
...
/* 22-Jan-2019: Modified code to fix IFRS/Equip Lease table missing error during compiling: 'ORA-00942: table or view does not exist' */

select count(*) 
	into l_count
from dba_tables
where table_name = 'PN_EQP_LEASES_ALL'
and owner = 'APPS';

IF l_count > 0 THEN
l_param_sql := 'select lease_num from pn_eqp_leases_all where lease_num = '|| p_equipment_lease_num;

 IF (p_equipment_lease_num is not null) then
  BEGIN
   execute immediate l_param_sql INTO l_equipment_lease_num USING p_equipment_lease_num;     
  EXCEPTION WHEN OTHERS THEN
    print_log('Invalid lease number specified. '||sqlerrm);
    raise invalid_parameters; 
  END;
 END IF;
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$ORG_ID$$##') := p_org_id;
   g_masked_tokens('##$$ORG_ID$$##') := mask_text( g_sql_tokens('##$$ORG_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$LEASE_NUM$$##') := p_lease_num;
   g_masked_tokens('##$$LEASE_NUM$$##') := mask_text( g_sql_tokens('##$$LEASE_NUM$$##'), 'NO_MASK');
   ...
   g_sql_tokens('##$$APPS_PARAM1$$##') := '240';
   g_masked_tokens('##$$APPS_PARAM1$$##') := mask_text( g_sql_tokens('##$$APPS_PARAM1$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM2$$##') := '0';
   g_masked_tokens('##$$APPS_PARAM2$$##') := mask_text( g_sql_tokens('##$$APPS_PARAM2$$##'), 'NO_MASK');
   g_sql_tokens('##$$VAR_RENT_ID$$##') := P_VAR_RENT_ID;
   g_masked_tokens('##$$VAR_RENT_ID$$##') := mask_text( g_sql_tokens('##$$VAR_RENT_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$EQP_LEASE_NUM$$##') := p_equipment_lease_num;
   g_masked_tokens('##$$EQP_LEASE_NUM$$##') := mask_text( g_sql_tokens('##$$EQP_LEASE_NUM$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPLICATION_ID$$##') := 'NULL';
   g_masked_tokens('##$$APPLICATION_ID$$##') := mask_text( g_sql_tokens('##$$APPLICATION_ID$$##'), 'NO_MASK');
...
debug('begin add_signature: PN_PROFILES');
   l_info('##MASK##LEVEL VALUE'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9781',
      p_sig_id                 => 'PN_PROFILES',
      p_sig_sql                => 'SELECT 
  user_profile_option_name "Profile Option",
  ...
  c.responsibility_name, 10004, rpad( 
...
AND (user_profile_option_name like ''PN:%''
or user_profile_option_name like ''FV: Federal Enabled'')
ORDER BY
  e.profile_option_name',
      p_title                  => 'All Property Manager Profiles',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No property manager profile setup done',
      p_solution               => 'Refer to Oracle Property Manager User Guide:<br>
<a href="https://docs.oracle.com/cd/E18727_01/doc.121/e13616/toc.htm">R12.1 User Guide</a>
<br>
[2348739/KB743454]',
      p_success_msg            => 'These details were found for property manager system profiles',
   ...
   l_info.delete;
debug('end add_signature: PN_PROFILES');



debug('begin add_signature: PN_DEBUG_MODE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9050',
      p_sig_id                 => 'PN_DEBUG_MODE',
      p_sig_sql                => 'SELECT
  user_profile_option_name "Profile Option",
  a.profile_option_value "Profile Value",
  DECODE(a.level_id, 10001, ''Site'', 10002, ''Application'', 10003,
  ''Responsibility'', 10004, ''User'') "Level",
  DECODE(a.level_id, 10001, ''Site'', 10002, b.application_short_name, 10003,
  c.responsibility_name, 10004, d.user_name) "Level Value",
  c.responsibility_id
FROM
  fnd_profile_option_values a,
  fnd_application b,
...
AND t.LANGUAGE              = ''US''
AND NVL(c.LANGUAGE,''US'')    = ''US''
AND user_profile_option_name=''PN: Debug Mode'' 
and upper(a.profile_option_value) = ''Y''',
      p_title                  => 'Profile PN: Debug Mode is On',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'System profile "PN: Debug Mode" is enabled (set to Yes) which may result in slow and/or cause performance problems.
',
      p_solution               => 'Follow instructions from [2385620/KB199274] Slow Performance of Property Manager Forms While Querying.',
      p_success_msg            => 'Profile "PN: Debug Mode" is NOT enabled at any levels.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: PN_DEBUG_MODE');



debug('begin add_signature: PN_USE_LEASE_APPROVAL_WORKFLOW');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9959',
      p_sig_id                 => 'PN_USE_LEASE_APPROVAL_WORKFLOW',
      p_sig_sql                => 'SELECT
  user_profile_option_name "Profile Option",
  a.profile_option_value "Profile Value",
  DECODE(a.level_id, 10001, ''Site'', 10002, ''Application'', 10003,
...
AND t.LANGUAGE            = ''US''
AND NVL(c.LANGUAGE,''US'')  = ''US''
AND user_profile_option_name=''PN: Use Lease Approval Workflow''
and upper(a.profile_option_value) = ''Y''',
      p_title                  => 'PN_Use_Lease_Approval_Workflow',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Profile "PN: Use Lease Approval Workflow" is set to ''Y''. When the value is Y, the submission of the schedules and items will depend on the 
lease approval workflow and the Schedules and Items Program does not generate items after finalizing the lease.
',
      p_solution               => 'Follow  [1438236/KB199311] Schedules and Items Program Does Not Generate Items After Finalizing the Lease.
',
      p_success_msg            => 'PN: Use Lease Approval Workflow is Setup correctly.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_USE_LEASE_APPROVAL_WORKFLOW');



debug('begin add_signature: PN_SYSTEM_SETUP_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9678',
      p_sig_id                 => 'PN_SYSTEM_SETUP_OPTIONS',
      p_sig_sql                => 'select * from  PN_SYSTEM_SETUP_OPTIONS
where ORG_ID= ##$$ORG_ID$$##',
      p_title                  => 'PN System Options',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'System options setup is missing for this Org.',
      p_solution               => 'Follow instructions from Doc [2385640/KB288527]
',
      p_success_msg            => 'Data from PN_SYSTEM_SETUP_OPTIONS',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_SYSTEM_SETUP_OPTIONS');



debug('begin add_signature: CHG_TRANS_DATE');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##POST_TRANSITION_DATE'):= ',#333333,#ffd6cc,bold';
  add_signature(
      p_sig_repo_id            => '19671',
      p_sig_id                 => 'CHG_TRANS_DATE',
      p_sig_sql                => 'SELECT decode(psso.transition_flag,''Y'',psso.transition_date,(
    SELECT MAX(ppia.creation_date) max_date
FROM
    pn_payment_items_all ppia,
    pn_payment_terms_all ppta
WHERE
    ppia.payment_term_id = ppta.payment_term_id
    AND psso.org_id = ppta.org_id    
    AND ppia.creation_date IS NOT NULL
AND (Nvl(Ppta.Rou_Asset_Flag, ''N'') = ''Y'' OR
Nvl(Ppta.Liability_Flag, ''N'') = ''Y'')
UNION
SELECT MAX(Poia.Creation_Date) Max_Date
FROM Pn_Option_Items_All Poia, Pn_Options_All Poa
WHERE poa.Option_Id = Poia.Option_Period_Id
AND psso.org_id=Poia.org_id
AND poia.creation_date IS NOT NULL 
    AND ( nvl(poa.rou_asset_flag,''N'') = ''Y''
          OR nvl(poa.liability_flag,''N'') = ''Y'' ) )) "POST_TRANSITION_DATE"
          FROM pn_system_setup_options psso
          WHERE psso.org_id = ##$$ORG_ID$$##
       AND psso.transition_flag IS NULL',
      p_title                  => 'Transactions Post Transition Date',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'When attempting to set Transition date in System options the following error occurs.<br><br>

ERROR <br>
=========<br>
Change the Transition Date. There are unprocessed transactions after the transition date
',
      p_solution               => 'Please refer to Solution in [2435226/KB782078] - Error- Change the Transition Date. There are unprocessed transactions after the transition date while Setting Up System Options ',
      p_success_msg            => 'Transaction date in System options correctly set.',
   ...
   l_info.delete;
debug('end add_signature: CHG_TRANS_DATE');



debug('begin add_signature: PN_PRODUCT_INSTALL_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22349',
      p_sig_id                 => 'PN_PRODUCT_INSTALL_STATUS',
      p_sig_sql                => 'SELECT SUBSTR(a.application_name, 1,40) product_name
         , a.application_id
         ...
         and a.application_id = ##$$APPS_PARAM1$$##',
      p_title                  => 'Product Installation Status',
      p_fail_condition         => '[status] = [NOTINSTALLED]',
      p_problem_descr          => 'Property Manager product is NOT installed.',
      p_solution               => 'Please follow solution in [1090881/KB441406] - PNTLEASE: FRM-40735: On-Insert Trigger Raised Unhandled Exception ORA-04062',
      p_success_msg            => 'Property Manager product is installed.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_PRODUCT_INSTALL_STATUS');



debug('begin add_signature: EBS_FIN_FA_PNANALYZER_PN_GL_CALENDAR_INFO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23844',
      p_sig_id                 => 'EBS_FIN_FA_PNANALYZER_PN_GL_CALENDAR_INFO',
      p_sig_sql                => 'SELECT 
    glp.period_set_name AS Calendar_Name, 
    glp.period_name, 
    glp.period_num, 
    glp.period_year, 
    glp.start_date, 
    glp.end_date, 
    glps.closing_status,
CASE glps.closing_status
    WHEN ''O'' THEN ''Open''
    WHEN ''C'' THEN ''Closed''
    WHEN ''F'' THEN ''Future Enterable''
    WHEN ''P'' THEN ''Permanently Closed''
    WHEN ''N'' THEN ''Never Opened''
    ELSE ''Z'' END "Closing Status Definition"
FROM 
    gl_periods glp
INNER JOIN 
    gl_sets_of_books glsob ON glsob.period_set_name = glp.period_set_name AND glp.period_type = glsob.accounted_period_type
INNER JOIN 
    pn_system_setup_options imp ON glsob.set_of_books_id = imp.set_of_books_id
INNER JOIN 
    gl_period_statuses glps ON glps.set_of_books_id = imp.set_of_books_id AND glps.APPLICATION_ID = 101
WHERE 
    glp.PERIOD_NAME = glps.PERIOD_NAME
AND
    glp.period_year = EXTRACT(YEAR FROM SYSDATE)
AND 
    imp.org_id = ##$$ORG_ID$$##
ORDER BY 
    glp.start_date DESC',
      p_title                  => 'GL Calendar of the Organization',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No GL Calendar information found for this organization.',
      p_solution               => '',
      p_success_msg            => 'Found GL Calendar information for this organization.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PNANALYZER_PN_GL_CALENDAR_INFO');



debug('begin add_signature: PN_LEASES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9045',
      p_sig_id                 => 'PN_LEASES_ALL',
      p_sig_sql                => 'SELECT   * FROM
  PN_LEASES_ALL
WHERE
  LEASE_NUM = ''##$$LEASE_NUM$$##''
AND ORG_ID  = ##$$ORG_ID$$##',
      p_title                  => 'PN_LEASES_ALL Table Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No lease data found.',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_LEASES_ALL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_LEASES_ALL');



debug('begin add_signature: PN_LEASE_CHANGES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9448',
      p_sig_id                 => 'PN_LEASE_CHANGES_ALL',
      p_sig_sql                => 'SELECT * FROM
...
lease_change_id asc',
      p_title                  => 'Lease Change Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No lease change data found.',
      p_solution               => '',
      p_success_msg            => 'Data found in  PN_LEASE_CHANGES_ALL ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_LEASE_CHANGES_ALL');



debug('begin add_signature: PN_LEASE_DETAILS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9449',
      p_sig_id                 => 'PN_LEASE_DETAILS_ALL',
      p_sig_sql                => 'SELECT *
FROM
...
ORDER BY
  lease_id desc ,
  LEASE_DETAIL_ID asc',
      p_title                  => 'Lease Details Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No detail data for lease.',
      p_solution               => '',
      p_success_msg            => 'Data found in  PN_LEASE_DETAILS_ALL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_LEASE_DETAILS_ALL');



debug('begin add_signature: PN_DISTRIBUTIONS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20476',
      p_sig_id                 => 'PN_DISTRIBUTIONS_ALL',
      p_sig_sql                => 'select * from PN_DISTRIBUTIONS_ALL
where payment_term_id in (select payment_term_id from
PN_PAYMENT_TERMS_ALL where lease_id in ( SELECT
    lease_id
                   FROM
    pn_leases_all
                   WHERE
...
AND ORG_ID = ##$$ORG_ID$$## ))
and ROWNUM < 201
order by payment_term_id desc, distribution_id asc',
      p_title                  => 'Distribution Accounts Information of Paymnents/Billings (PN_DISTRIBUTIONS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No lease distribution data found',
      p_solution               => '',
      p_success_msg            => ' Lease distribution data found',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_DISTRIBUTIONS_ALL');



debug('begin add_signature: PN_DISTRIBUTIONS_HISTORY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20477',
      p_sig_id                 => 'PN_DISTRIBUTIONS_HISTORY',
      p_sig_sql                => 'SELECT
    *
FROM
...
AND ORG_ID  = ##$$ORG_ID$$##
    ...
    order by distribution_id',
      p_title                  => 'History of Distributions Associated with Payment/Billing Terms (PN_DISTRIBUTIONS_HISTORY)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No lease history distribution data found',
      p_solution               => '',
      p_success_msg            => 'Lease history distribution data found',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_DISTRIBUTIONS_HISTORY');



debug('begin add_signature: PN_LEASE_DETAILS_HISTORY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9450',
      p_sig_id                 => 'PN_LEASE_DETAILS_HISTORY',
      p_sig_sql                => 'SELECT *
FROM
...
ORDER BY
  LEASE_ID desc,
  LEASE_DETAIL_ID asc,
  DETAIL_HISTORY_ID asc',
      p_title                  => 'Lease Details History',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No history found for lease details.',
      p_solution               => '',
      p_success_msg            => 'Found lease details history.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_LEASE_DETAILS_HISTORY');



debug('begin add_signature: PN_LEASE_TRANSACTIONS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9046',
      p_sig_id                 => 'PN_LEASE_TRANSACTIONS_ALL',
      p_sig_sql                => 'SELECT
*
FROM
...
ORDER BY
LEASE_ID desc,
  LEASE_TRANSACTION_ID asc',
      p_title                  => 'Lease Transaction Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Lease transaction data found.',
      p_solution               => 'Make sure entered Lease_Num and Org_id are valid.',
      p_success_msg            => 'Found Lease transaction data.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_LEASE_TRANSACTIONS_ALL');



debug('begin add_signature: PN_TENANCIES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9451',
      p_sig_id                 => 'PN_TENANCIES_ALL',
      p_sig_sql                => 'SELECT *
FROM
  PN_TENANCIES_ALL
WHERE
...
TENANCY_ID asc,
  LOCATION_ID asc',
      p_title                  => 'Lease Tenancy Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No tenancy data found.',
      p_solution               => '',
      p_success_msg            => 'Found lease tenancy data.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_TENANCIES_ALL');



debug('begin add_signature: PN_PAYMENT_ITEMS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9455',
      p_sig_id                 => 'PN_PAYMENT_ITEMS_ALL',
      p_sig_sql                => ' SELECT *
FROM
...
ORDER BY
  ...
  PAYMENT_ITEM_ID asc',
      p_title                  => 'Lease Payment Item',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Found no payment item.',
      p_solution               => 'you can create payment items and schedules for the various payments you have to make in connection with your property. These can be payments
of rent you make to the landlord, or payments you make to any of your suppliers.
Refer to Oracle Property Manager User Guide:<br>

[2348739/KB743454] - Oracle Property Manager User Guide For Release 12.1.x and 12.2.x',
      p_success_msg            => 'Found lease payment items.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_PAYMENT_ITEMS_ALL');



debug('begin add_signature: PN_PAYMENT_SCHEDULES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9454',
      p_sig_id                 => 'PN_PAYMENT_SCHEDULES_ALL',
      p_sig_sql                => 'SELECT *
FROM
...
lease_id desc,
  PAYMENT_SCHEDULE_ID asc',
      p_title                  => 'Lease Payment Schedule',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No payment schedule found.',
      p_solution               => 'Please create and approve payment schedule.

Refer to Oracle Property Manager User Guide:<br>
[2348739/KB743454] Oracle Property Manager User Guide For Release 12.1.x and 12.2.x',
      p_success_msg            => 'Data found in  PN_PAYMENT_SCHEDULES_ALL ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_PAYMENT_SCHEDULES_ALL');



debug('begin add_signature: PN_PAYMENT_TERMS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9453',
      p_sig_id                 => 'PN_PAYMENT_TERMS_ALL',
      p_sig_sql                => 'SELECT *
FROM
  PN_PAYMENT_TERMS_ALL
WHERE
...
lease_id desc,
  PAYMENT_TERM_ID ASC',
      p_title                  => 'Lease Payment Term Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No payment term details found for the lease.',
      p_solution               => '',
      p_success_msg            => 'Found payment term details for the lease.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_PAYMENT_TERMS_ALL');



debug('begin add_signature: PN_PAYMENT_ITEM_DIST_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12452',
      p_sig_id                 => 'PN_PAYMENT_ITEM_DIST_ALL',
      p_sig_sql                => 'select pida.* from
PN_PAYMENT_ITEM_DIST_ALL pida,
PN_PAYMENT_ITEMS_ALL, ppia,
PN_PAYMENT_TERMS_ALL ppta,
PN_LEASES_ALL pla
where pida.PAYMENT_ITEM_ID =ppia.PAYMENT_ITEM_ID
and ppia.PAYMENT_TERM_ID = ppta.PAYMENT_TERM_ID
and ppta.lease_id=pla.lease_id  
and pla.LEASE_NUM = ''##$$LEASE_NUM$$##''
AND ORG_ID = ##$$ORG_ID$$##
',
      p_title                  => 'PN_PAYMENT_ITEM_DIST_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data in PN_PAYMENT_ITEM_DIST_ALL table',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_PAYMENT_ITEM_DIST_ALL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_PAYMENT_ITEM_DIST_ALL');



debug('begin add_signature: PN_OPTIONS_HISTORY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9518',
      p_sig_id                 => 'PN_OPTIONS_HISTORY',
      p_sig_sql                => 'SELECT *
FROM
  PN_OPTIONS_HISTORY
WHERE
...
lease_id desc,
  OPTION_ID asc,
  OPTION_HISTORY_ID asc',
      p_title                  => 'Details of PN Option History',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No history records found for PN option.',
      p_solution               => '',
      p_success_msg            => 'Found records of option history.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_OPTIONS_HISTORY');



debug('begin add_signature: PN_OPTIONS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9517',
      p_sig_id                 => 'PN_OPTIONS_ALL',
      p_sig_sql                => 'SELECT *
FROM
  PN_OPTIONS_ALL
WHERE
...
lease_id desc,
  OPTION_ID asc',
      p_title                  => 'Option Details for Lease',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No details found.',
      p_solution               => 'Please go through PN User guide to understand and define PN options:

Refer to Oracle Property Manager User Guide:<br>
[2348739/KB743454] - R12 Oracle Property Manager User Guide, Jan-2018',
      p_success_msg            => 'Found records for options.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_OPTIONS_ALL');



debug('begin add_signature: PN_OPTION_PERIODS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11218',
      p_sig_id                 => 'PN_OPTION_PERIODS_ALL',
      p_sig_sql                => 'SELECT *
FROM PN_OPTION_PERIODS_ALL
WHERE option_id in
  (SELECT option_id
  FROM pn_options_all
  WHERE lease_id in
    (SELECT LEASE_ID
    FROM PN_LEASES_ALL
    WHERE  LEASE_NUM = ''##$$LEASE_NUM$$##''
AND ORG_ID = ##$$ORG_ID$$##))
order by option_id desc',
      p_title                  => 'Details of Periods for Options Generated (PN_OPTION_PERIODS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_OPTION_PERIODS_ALL table',
      p_solution               => '',
      p_success_msg            => 'Found data on PN_OPTION_PERIODS_ALL table ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_OPTION_PERIODS_ALL');



debug('begin add_signature: PN_OPTION_ITEMS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11219',
      p_sig_id                 => 'PN_OPTION_ITEMS_ALL',
      p_sig_sql                => 'SELECT *
FROM PN_OPTION_ITEMS_ALL
WHERE option_period_id IN
  (SELECT option_period_id
  FROM PN_OPTION_PERIODS_ALL
  WHERE option_id IN
    (SELECT option_id
    FROM PN_OPTIONS_all
...
AND ORG_ID = ##$$ORG_ID$$##
  ...
  order by option_item_id desc',
      p_title                  => 'Details of Options (PN_OPTION_ITEMS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_OPTION_ITEMS_ALL table.',
      p_solution               => '',
      p_success_msg            => 'Found data on PN_OPTION_ITEMS_ALL table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_OPTION_ITEMS_ALL');



debug('begin add_signature: EBS_FIN_FA_PNANALYZER_PN_SCHEDULES_OUTPUT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23778',
      p_sig_id                 => 'EBS_FIN_FA_PNANALYZER_PN_SCHEDULES_OUTPUT',
      p_sig_sql                => '  select * from PN_SCHEDULES_OUTPUT
WHERE lease_id in
    (SELECT LEASE_ID
    FROM PN_LEASES_ALL
    WHERE  LEASE_NUM = ''##$$LEASE_NUM$$##''
...
version_num asc,
schedule_date asc',
      p_title                  => 'Schedules Output (PN_SCHEDULES_OUTPUT)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No details found.',
      p_solution               => 'Output for PN_SCHEDULES_OUTPUT',
      p_success_msg            => 'Found records for Schedules',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PNANALYZER_PN_SCHEDULES_OUTPUT');



debug('begin add_signature: PN_INDEX_EXCLUDE_TERM_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9526',
      p_sig_id                 => 'PN_INDEX_EXCLUDE_TERM_ALL',
      p_sig_sql                => 'select pieta.* from PN_INDEX_EXCLUDE_TERM_ALL pieta,PN_INDEX_LEASES_ALL pila, PN_LEASES_ALL pla
where pieta.INDEX_LEASE_ID =pila.INDEX_LEASE_ID
and pila.lease_id=pla.lease_id
and pla.LEASE_NUM = ''##$$LEASE_NUM$$##''
  and pla.ORG_ID = ##$$ORG_ID$$##
  order by pieta.INDEX_LEASE_ID,
  pieta.INDEX_EXCLUDE_TERM_ID',
      p_title                  => 'Payment Terms to be Excluded During Calculation of Basis for Rent Increase',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Payment term found with exclusion.',
      p_solution               => '',
      p_success_msg            => 'Found these Payment term records for payment term exclusion.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_INDEX_EXCLUDE_TERM_ALL');



debug('begin add_signature: PN_INDEX_HISTORY_HEADERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9527',
      p_sig_id                 => 'PN_INDEX_HISTORY_HEADERS',
      p_sig_sql                => 'select pihh.* from PN_INDEX_HISTORY_HEADERS pihh,PN_INDEX_LEASES_ALL pila, PN_LEASES_ALL pla
where pihh.INDEX_ID =pila.INDEX_ID
and pila.lease_id=pla.lease_id
and pla.LEASE_NUM = ''##$$LEASE_NUM$$##''
and pla.ORG_ID = ##$$ORG_ID$$##
order by pihh.INDEX_ID',
      p_title                  => 'Index History Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No records found for index history.',
      p_solution               => '',
      p_success_msg            => 'Found records for index history.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_INDEX_HISTORY_HEADERS');



debug('begin add_signature: PN_INDEX_LEASES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9523',
      p_sig_id                 => 'PN_INDEX_LEASES_ALL',
      p_sig_sql                => 'select pila.* from PN_INDEX_LEASES_ALL pila, PN_LEASES_ALL pla
where pila.lease_id=pla.lease_id
and pla.LEASE_NUM = ''##$$LEASE_NUM$$##''
  and pla.ORG_ID = ##$$ORG_ID$$##
  order by pila.INDEX_LEASE_ID',
      p_title                  => 'Details of all Rent Increases Associated With Existing Lease',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No details of rent increases associated with lease found.',
      p_solution               => '',
      p_success_msg            => 'Found details of rent increase.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_INDEX_LEASES_ALL');



debug('begin add_signature: PN_INDEX_LEASE_CONSTRAINTS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9525',
      p_sig_id                 => 'PN_INDEX_LEASE_CONSTRAINTS_ALL',
      p_sig_sql                => 'select pilca.* from PN_INDEX_LEASE_CONSTRAINTS_ALL pilca,PN_INDEX_LEASES_ALL pila, PN_LEASES_ALL pla
where pilca.INDEX_LEASE_ID =pila.INDEX_LEASE_ID
and pila.lease_id=pla.lease_id
and pla.LEASE_NUM = ''##$$LEASE_NUM$$##''
and pla.ORG_ID = ##$$ORG_ID$$##
order by pilca.INDEX_LEASE_ID,
pilca.INDEX_CONSTRAINT_ID',
      p_title                  => 'Details of Constraints That Apply to Rent Increase',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No constraint details found.',
      p_solution               => '',
      p_success_msg            => 'Found details for constraints that apply to rent increase',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_INDEX_LEASE_CONSTRAINTS_ALL');



debug('begin add_signature: PN_INDEX_LEASE_PERIODS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9524',
      p_sig_id                 => 'PN_INDEX_LEASE_PERIODS_ALL',
      p_sig_sql                => 'select pilpa.* from PN_INDEX_LEASE_PERIODS_ALL pilpa,PN_INDEX_LEASES_ALL pila, PN_LEASES_ALL pla
where pilpa.INDEX_LEASE_ID =pila.INDEX_LEASE_ID
and pila.lease_id=pla.lease_id
and pla.LEASE_NUM = ''##$$LEASE_NUM$$##''
and pla.ORG_ID = ##$$ORG_ID$$##
order by pilpa.INDEX_LEASE_ID , pilpa.INDEX_PERIOD_ID',
      p_title                  => 'Details Associated With All Rent Increase Periods',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No records found for rent increase periods.',
      p_solution               => '',
      p_success_msg            => 'Found records for rent increase periods.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_INDEX_LEASE_PERIODS_ALL');



debug('begin add_signature: EBS_FIN_FA_PNANALYZER_PN_INDEX_HISTORY_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25983',
      p_sig_id                 => 'EBS_FIN_FA_PNANALYZER_PN_INDEX_HISTORY_LINES',
      p_sig_sql                => 'select pihl.* from PN_INDEX_HISTORY_LINES pihl,PN_INDEX_LEASES_ALL pila, PN_LEASES_ALL pla
where pihl.INDEX_ID =pila.INDEX_ID
and pila.lease_id=pla.lease_id
and pla.LEASE_NUM = ''##$$LEASE_NUM$$##''
and pla.ORG_ID = ##$$ORG_ID$$##
order by pihl.INDEX_ID, pihl.index_line_id',
      p_title                  => 'Index Lines History Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No records found for index history.',
      p_solution               => '',
      p_success_msg            => 'Found records for index history.',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PNANALYZER_PN_INDEX_HISTORY_LINES');



debug('begin add_signature: EBS_FIN_FA_PNANALYZER_PN_INDEX_LEASE_TERMS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25985',
      p_sig_id                 => 'EBS_FIN_FA_PNANALYZER_PN_INDEX_LEASE_TERMS_ALL',
      p_sig_sql                => 'select pilta.* from PN_INDEX_LEASE_TERMS_ALL pilta, PN_INDEX_LEASES_ALL pila, PN_LEASES_ALL pla
where pilta.INDEX_LEASE_ID =pila.INDEX_LEASE_ID
and pila.lease_id=pla.lease_id
and pla.LEASE_NUM = ''##$$LEASE_NUM$$##''
and pla.ORG_ID = ##$$ORG_ID$$##
order by pilta.INDEX_LEASE_ID ,
pilta.index_lease_term_id',
      p_title                  => 'Details of Rent Increase Terms',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No rent increase details found.',
      p_solution               => '',
      p_success_msg            => 'Found details for rent increase terms',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PNANALYZER_PN_INDEX_LEASE_TERMS_ALL');



debug('begin add_signature: EBS_FIN_FA_PNANALYZER_PN_RENT_INCREASE_DETAILACC_ITF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25986',
      p_sig_id                 => 'EBS_FIN_FA_PNANALYZER_PN_RENT_INCREASE_DETAILACC_ITF',
      p_sig_sql                => 'select pridi.* from PN_RENT_INCREASE_DETAILACC_ITF pridi, PN_LEASES_ALL pla
where pridi.lease_num=pla.lease_num
and pla.LEASE_NUM = ''##$$LEASE_NUM$$##''
and pla.ORG_ID = ##$$ORG_ID$$##',
      p_title                  => 'Details for Rent Increase Account Detail Report',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found for Rent Increase Account Detail Report',
      p_solution               => '',
      p_success_msg            => 'Found details for Rent Increase Account Detail Report',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PNANALYZER_PN_RENT_INCREASE_DETAILACC_ITF');



debug('begin add_signature: EBS_FIN_FA_PNANALYZER_PN_RENT_INCREASE_DETAIL_ITF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25987',
      p_sig_id                 => 'EBS_FIN_FA_PNANALYZER_PN_RENT_INCREASE_DETAIL_ITF',
      p_sig_sql                => 'select pridi.* from PN_RENT_INCREASE_DETAIL_ITF pridi, PN_LEASES_ALL pla
where pridi.lease_num=pla.lease_num
and pla.LEASE_NUM = ''##$$LEASE_NUM$$##''
and pla.ORG_ID = ##$$ORG_ID$$##',
      p_title                  => 'Details for Rent Increase Detail Report',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found for Rent Increase Detail Report',
      p_solution               => '',
      p_success_msg            => 'Found details for Rent Increase Detail Report',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PNANALYZER_PN_RENT_INCREASE_DETAIL_ITF');



debug('begin add_signature: EBS_FIN_FA_PNANALYZER_PN_RENT_ROLL_LEASE_EXP_ITF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25988',
      p_sig_id                 => 'EBS_FIN_FA_PNANALYZER_PN_RENT_ROLL_LEASE_EXP_ITF',
      p_sig_sql                => 'select prrlei.* from PN_RENT_ROLL_LEASE_EXP_ITF prrlei, PN_LEASES_ALL pla
  where prrlei.lease_number=pla.lease_num
  and pla.LEASE_NUM = ''##$$LEASE_NUM$$##''
  and pla.ORG_ID = ##$$ORG_ID$$##',
      p_title                  => 'Details for Rent Roll And Lease Expiration Report',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found for Rent Roll And Lease Expiration Report',
      p_solution               => '',
      p_success_msg            => 'Found details for Rent Roll And Lease Expiration Report',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PNANALYZER_PN_RENT_ROLL_LEASE_EXP_ITF');



debug('begin add_signature: PN_VAR_RENTS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9528',
      p_sig_id                 => 'PN_VAR_RENTS_ALL',
      p_sig_sql                => 'SELECT * FROM PN_VAR_RENTS_ALL
WHERE VAR_RENT_ID = ##$$VAR_RENT_ID$$## and ORG_ID= ##$$ORG_ID$$##',
      p_title                  => 'Variable Rent Agreement Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No variable rent agreement information found.',
      p_solution               => 'Please go through managing variable rent for creating and managing variable rent.

Refer to Oracle Property Manager User Guide:<br>
[2348739/KB743454] - R12 Oracle Property Manager User Guide, Jan-2018',
      p_success_msg            => 'Found variable rent agreement information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_VAR_RENTS_ALL');



debug('begin add_signature: PN_VAR_GRP_DATES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9703',
      p_sig_id                 => 'PN_VAR_GRP_DATES_ALL',
      p_sig_sql                => 'SELECT * FROM PN_VAR_GRP_DATES_ALL
WHERE VAR_RENT_ID = ##$$VAR_RENT_ID$$##
 and ORG_ID= ##$$ORG_ID$$##',
      p_title                  => 'Critical Dates Related to Variable Rent Agreement',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No critical dates related to Variable Rent found.',
      p_solution               => 'Go through Managing Variable Rent in PN User guide.

Refer to Oracle Property Manager User Guide:<br>

[2348739/KB743454] - R12 Oracle Property Manager User Guide, Jan-2018',
      p_success_msg            => 'Found details related to Variable Rent.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_VAR_GRP_DATES_ALL');



debug('begin add_signature: PN_VAR_LINES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9698',
      p_sig_id                 => 'PN_VAR_LINES_ALL',
      p_sig_sql                => 'SELECT * FROM PN_VAR_LINES_ALL
WHERE VAR_RENT_ID = ##$$VAR_RENT_ID$$##  and ORG_ID= ##$$ORG_ID$$##',
      p_title                  => 'Variable Rent Line',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Variable Rent Lines found.',
      p_solution               => 'Go through Managing Variable Rent in PN User guide.

Refer to Oracle Property Manager User Guide:<br>
[2348739/KB743454] - R12 Oracle Property Manager User Guide, Jan-2018',
      p_success_msg            => 'Found details for Variable Rent Lines.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_VAR_LINES_ALL');



debug('begin add_signature: PN_VAR_PERIODS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9699',
      p_sig_id                 => 'PN_VAR_PERIODS_ALL',
      p_sig_sql                => 'SELECT * FROM PN_VAR_PERIODS_ALL
WHERE VAR_RENT_ID = ##$$VAR_RENT_ID$$## and ORG_ID= ##$$ORG_ID$$##',
      p_title                  => 'Periods Critical Date Information for Variable Rent',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Period information for Variable Rent found.',
      p_solution               => 'Go through Managing Variable Rent in PN User guide.

Refer to Oracle Property Manager User Guide:<br>
[2348739/KB743454] - R12 Oracle Property Manager User Guide, Jan-2018',
      p_success_msg            => 'Found Variable Rent details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_VAR_PERIODS_ALL');



debug('begin add_signature: PN_VAR_RENT_DATES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9702',
      p_sig_id                 => 'PN_VAR_RENT_DATES_ALL',
      p_sig_sql                => 'SELECT * FROM PN_VAR_RENT_DATES_ALL
WHERE VAR_RENT_ID = ##$$VAR_RENT_ID$$##
 and ORG_ID= ##$$ORG_ID$$##',
      p_title                  => 'Date Related Frequencies for Variable Rent Agreement',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No date details found for Variable Rent.',
      p_solution               => 'Go through Managing Variable Rent in PN User guide.

Refer to Oracle Property Manager User Guide:<br>
[2348739/KB743454] - R12 Oracle Property Manager User Guide, Jan-2018',
      p_success_msg            => 'Found details for Variable Rent.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_VAR_RENT_DATES_ALL');



debug('begin add_signature: PN_VAR_RENT_SUMM_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9529',
      p_sig_id                 => 'PN_VAR_RENT_SUMM_ALL',
      p_sig_sql                => 'SELECT * FROM PN_VAR_RENT_SUMM_ALL
WHERE VAR_RENT_ID = ##$$VAR_RENT_ID$$## and ORG_ID= ##$$ORG_ID$$##',
      p_title                  => 'Calculated Variable Rent for Line Item for Group Date',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Calculated Variable Rent found.',
      p_solution               => 'Go through Managing Variable Rent in PN User guide.

Refer to Oracle Property Manager User Guide:<br>
[2348739/KB743454] - R12 Oracle Property Manager User Guide, Jan-2018',
      p_success_msg            => 'Found details for Calculated Variable Rent.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_VAR_RENT_SUMM_ALL');



debug('begin add_signature: PN_VAR_TRX_HEADERS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9700',
      p_sig_id                 => 'PN_VAR_TRX_HEADERS_ALL',
      p_sig_sql                => 'SELECT * FROM PN_VAR_TRX_HEADERS_ALL
WHERE VAR_RENT_ID =  ##$$VAR_RENT_ID$$##
 and ORG_ID= ##$$ORG_ID$$##',
      p_title                  => 'Header Details of Variable Rent Calculations',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Variable Rent calculation details found for table PN_VAR_TRX_HEADERS_ALL',
      p_solution               => '',
      p_success_msg            => 'Found header details of Variable Rent calculations.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_VAR_TRX_HEADERS_ALL');



debug('begin add_signature: PN_VAR_TRX_DETAILS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9701',
      p_sig_id                 => 'PN_VAR_TRX_DETAILS_ALL',
      p_sig_sql                => 'SELECT * FROM PN_VAR_TRX_DETAILS_ALL
WHERE TRX_HEADER_ID IN (
SELECT TRX_HEADER_ID
FROM PN_VAR_TRX_HEADERS_ALL
WHERE VAR_RENT_ID = ##$$VAR_RENT_ID$$##  and ORG_ID= ##$$ORG_ID$$## )',
      p_title                  => 'Variable Rent Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No details for Variable Rent found for table PN_VAR_TRX_DETAILS_ALL.',
      p_solution               => '',
      p_success_msg            => 'Found details for Variable Rent.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PN_VAR_TRX_DETAILS_ALL');



debug('begin add_signature: PN_VAR_BKPTS_HEAD_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9939',
      p_sig_id                 => 'PN_VAR_BKPTS_HEAD_ALL',
      p_sig_sql                => 'SELECT * FROM PN_VAR_BKPTS_HEAD_ALL
WHERE VAR_RENT_ID =  ##$$VAR_RENT_ID$$##
and ORG_ID=  ##$$ORG_ID$$##',
      p_title                  => 'Breakpoint Related Information to be Used in Calculation of Variable Rent',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No records found for breakpoint',
      p_solution               => 'Please go through managing variable rent for creating and managing variable rent.
...
<br>
[2348739/KB743454] - R12 Oracle Property Manager User Guide, Jan-2018',
      p_success_msg            => 'Found breakpoint records',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_VAR_BKPTS_HEAD_ALL');



debug('begin add_signature: PN_VAR_BKPTS_DET_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9938',
      p_sig_id                 => 'PN_VAR_BKPTS_DET_ALL',
      p_sig_sql                => 'SELECT * FROM PN_VAR_BKPTS_DET_ALL
WHERE VAR_RENT_ID =  ##$$VAR_RENT_ID$$##
 and ORG_ID= ##$$ORG_ID$$##',
      p_title                  => 'PN_VAR_BKPTS_DET_ALL Table Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'no data found for  PN_VAR_BKPTS_DET_ALL',
      p_solution               => 'Please go through managing variable rent for creating and managing variable rent.
...
<br>
[2348739/KB743454] - R12 Oracle Property Manager User Guide, Jan-2018',
      p_success_msg            => 'Found records for PN_VAR_BKPTS_DET_ALL table',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_VAR_BKPTS_DET_ALL');



debug('begin add_signature: PN_VAR_RENT_INV_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9937',
      p_sig_id                 => 'PN_VAR_RENT_INV_ALL',
      p_sig_sql                => 'SELECT * FROM PN_VAR_RENT_INV_ALL
WHERE VAR_RENT_ID =  ##$$VAR_RENT_ID$$##
 and ORG_ID= ##$$ORG_ID$$##',
      p_title                  => 'Variable Rent Calculation Details by Period And by Invoice Date',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Found no data for table records',
      p_solution               => 'Please go through managing variable rent for creating and managing variable rent.
...
<br>
[2348739/KB743454] - R12 Oracle Property Manager User Guide, Jan-2018',
      p_success_msg            => 'Found records for  PN_VAR_RENT_INV_ALL table',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_VAR_RENT_INV_ALL');



debug('begin add_signature: PN_VAR_REPORT_DATES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9936',
      p_sig_id                 => 'PN_VAR_REPORT_DATES_ALL',
      p_sig_sql                => 'SELECT * FROM PN_VAR_REPORT_DATES_ALL
WHERE VAR_RENT_ID = ##$$VAR_RENT_ID$$##
 and ORG_ID= ##$$ORG_ID$$##',
      p_title                  => 'PN_VAR_REPORT_DATES_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data for PN_VAR_REPORT_DATES_ALL  table',
      p_solution               => '',
      p_success_msg            => 'Found records for  PN_VAR_REPORT_DATES_ALL table',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_VAR_REPORT_DATES_ALL');



debug('begin add_signature: PN_LEASES_ALL_N');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9774',
      p_sig_id                 => 'PN_LEASES_ALL_N',
      p_sig_sql                => 'SELECT * FROM PN_LEASES_ALL
WHERE LEASE_NUM =  ''##$$LEASE_NUM$$##''
AND ORG_ID = ##$$ORG_ID$$##',
      p_title                  => 'Lease Table for Normalization',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found for lease',
      p_solution               => 'Refer to Oracle Property Manager User Guide:<br>
<a href="https://docs.oracle.com/cd/E18727_01/doc.121/e13616/toc.htm">R12.1 User Guide</a>
<br>
[2348739/KB743454]',
      p_success_msg            => 'Following data was found',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_LEASES_ALL_N');



debug('begin add_signature: PN_LEASE_DETAILS_ALL_N');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9775',
      p_sig_id                 => 'PN_LEASE_DETAILS_ALL_N',
      p_sig_sql                => 'SELECT * FROM PN_LEASE_DETAILS_ALL
WHERE LEASE_ID in
(SELECT LEASE_ID
FROM PN_LEASES_ALL
WHERE LEASE_NUM = ''##$$LEASE_NUM$$##''
...
order by lease_id desc,
lease_change_id asc',
      p_title                  => 'Lease Details for Normalization',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Lease details found.',
      p_solution               => 'Refer to Oracle Property Manager User Guide:<br>
<a href="https://docs.oracle.com/cd/E18727_01/doc.121/e13616/toc.htm">R12.1 User Guide</a>
<br>
[2348739/KB743454] - R12 Oracle Property Manager User Guide, Jan-2018',
      p_success_msg            => 'Found details for lease.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_LEASE_DETAILS_ALL_N');



debug('begin add_signature: PN_LEASE_CHANGES_ALL_N');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9776',
      p_sig_id                 => 'PN_LEASE_CHANGES_ALL_N',
      p_sig_sql                => 'SELECT * FROM PN_LEASE_CHANGES_ALL
WHERE LEASE_ID in
(SELECT LEASE_ID
FROM PN_LEASES_ALL
WHERE LEASE_NUM = ''##$$LEASE_NUM$$##''
...
ORDER BY lease_id desc,
LEASE_CHANGE_ID asc',
      p_title                  => 'Lease Change Data for Normalization',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No lease change data found',
      p_solution               => 'Refer to Oracle Property Manager User Guide:<br>

[2348739/KB743454] - R12 Oracle Property Manager User Guide, Jan-2018',
      p_success_msg            => 'Found details on lease change',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_LEASE_CHANGES_ALL_N');



debug('begin add_signature: PN_PAYMENT_SCHEDULES_ALL_N');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9777',
      p_sig_id                 => 'PN_PAYMENT_SCHEDULES_ALL_N',
      p_sig_sql                => 'SELECT * FROM PN_PAYMENT_SCHEDULES_ALL
WHERE LEASE_ID in
(SELECT LEASE_ID
FROM PN_LEASES_ALL
WHERE LEASE_NUM =  ''##$$LEASE_NUM$$##''
...
ORDER BY lease_id desc,
PAYMENT_SCHEDULE_ID asc',
      p_title                  => 'Lease Payment Schedule For Normalization',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Payment schedule found',
      p_solution               => 'Refer to Oracle Property Manager User Guide:<br>
<a href="https://docs.oracle.com/cd/E18727_01/doc.121/e13616/toc.htm">R12.1 User Guide</a>
<br>
[2348739/KB743454] - R12 Oracle Property Manager User Guide, Jan-2018',
      p_success_msg            => 'Found payment schedule details',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_PAYMENT_SCHEDULES_ALL_N');



debug('begin add_signature: PN_PAYMENT_TERMS_ALL_N');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9778',
      p_sig_id                 => 'PN_PAYMENT_TERMS_ALL_N',
      p_sig_sql                => 'SELECT * FROM PN_PAYMENT_ITEMS_ALL
...
ORDER BY PAYMENT_TERM_ID desc, PAYMENT_SCHEDULE_ID asc, PAYMENT_ITEM_ID asc',
      p_title                  => 'Payment Term for Normalize Lease',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No payment term found',
      p_solution               => '',
      p_success_msg            => 'Found payment terms for normalized lease',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_PAYMENT_TERMS_ALL_N');



debug('begin add_signature: PN_PAYMENT_ITEMS_ALL_N1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9779',
      p_sig_id                 => 'PN_PAYMENT_ITEMS_ALL_N1',
      p_sig_sql                => 'SELECT * FROM PN_PAYMENT_ITEMS_ALL
WHERE PAYMENT_TERM_ID IN
(SELECT PAYMENT_TERM_ID
FROM PN_PAYMENT_TERMS_ALL
...
and payment_item_type_lookup_code=''NORMALIZED''
ORDER BY PAYMENT_TERM_ID desc, PAYMENT_SCHEDULE_ID asc, PAYMENT_ITEM_ID asc',
      p_title                  => 'Normalized Lease Payment Item details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No payment items found for normalized lease.',
      p_solution               => '',
      p_success_msg            => 'Found details for normalized lease.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_PAYMENT_ITEMS_ALL_N1');



debug('begin add_signature: PN_PAYMENT_ITEMS_ALL__N2');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9780',
      p_sig_id                 => 'PN_PAYMENT_ITEMS_ALL__N2',
      p_sig_sql                => 'SELECT PAYMENT_TERM_ID, PAYMENT_ITEM_TYPE_LOOKUP_CODE,
        SUM(ACTUAL_AMOUNT) FROM PN_PAYMENT_ITEMS_ALL WHERE PAYMENT_TERM_ID IN (SELECT PAYMENT_TERM_ID FROM PN_PAYMENT_TERMS_ALL WHERE NORMALIZE = ''Y''
AND LEASE_ID in
(SELECT LEASE_ID
FROM PN_LEASES_ALL
WHERE LEASE_NUM =  ''##$$LEASE_NUM$$##''
AND ORG_ID = ##$$ORG_ID$$##))
GROUP BY PAYMENT_TERM_ID, PAYMENT_ITEM_TYPE_LOOKUP_CODE
ORDER BY PAYMENT_TERM_ID desc, PAYMENT_ITEM_TYPE_LOOKUP_CODE',
      p_title                  => 'Payment Items Summary for Normalized Lease',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No payment items found',
      p_solution               => '',
      p_success_msg            => 'Found records for payment items summary for normalized lease',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_PAYMENT_ITEMS_ALL__N2');



debug('begin add_signature: EBS_FIN_FA_PNANALYZER_NORMALIZED_XLA_AE_HEADERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23784',
      p_sig_id                 => 'EBS_FIN_FA_PNANALYZER_NORMALIZED_XLA_AE_HEADERS',
      p_sig_sql                => 'select * from xla_ae_headers
where application_id=##$$APPS_PARAM1$$##
and event_id in (select event_id from xla_events
where event_id in (select xla_event_id from PN_PAYMENT_ITEMS_ALL WHERE PAYMENT_TERM_ID IN (select distinct payment_term_id  
FROM PN_PAYMENT_TERMS_ALL
WHERE NORMALIZE = ''Y''
and org_id=##$$ORG_ID$$##
AND LEASE_ID in
...
and payment_item_type_lookup_code=''NORMALIZED''
and xla_event_id is not null
))
and application_id=##$$APPS_PARAM1$$##)
order by ae_header_id asc',
      p_title                  => 'XLA_AE_HEADERS for Normalized Terms',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in XLA_AE_HEADERS  table for Normalized terms',
      p_solution               => '',
      p_success_msg            => 'Data found in XLA_EVENTS table for Normalized terms',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PNANALYZER_NORMALIZED_XLA_AE_HEADERS');



debug('begin add_signature: EBS_FIN_FA_PNANALYZER_NORMALIZED_XLA_EVENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23783',
      p_sig_id                 => 'EBS_FIN_FA_PNANALYZER_NORMALIZED_XLA_EVENTS',
      p_sig_sql                => 'select xe.* from apps.xla_events xe, apps.PN_PAYMENT_ITEMS_ALL ppia, apps.PN_PAYMENT_TERMS_ALL ppta
where 
  xe.event_id= ppia.xla_event_id
  and ppia.payment_term_id= ppta.payment_term_id
  and ppta.normalize = ''Y''
  and ppia.payment_item_type_lookup_code=''NORMALIZED''
  and ppia.xla_event_id is not null
  and ppta.LEASE_ID in
(SELECT pla.LEASE_ID
FROM apps.PN_LEASES_ALL pla
WHERE pla.LEASE_NUM = ''##$$LEASE_NUM$$##''
and pla.ORG_ID = ##$$ORG_ID$$##)
and xe.application_id= ##$$APPS_PARAM1$$##',
      p_title                  => 'XLA_EVENTS for Normalized Terms',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in table XLA_EVENTS for Normalized Terms ',
      p_solution               => '',
      p_success_msg            => 'Data found in XLA_EVENTS table  for Normalized Terms ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PNANALYZER_NORMALIZED_XLA_EVENTS');



debug('begin add_signature: EBS_FIN_FA_PNANALYZER_NORMALZIED_XLA_AE_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23785',
      p_sig_id                 => 'EBS_FIN_FA_PNANALYZER_NORMALZIED_XLA_AE_LINES',
      p_sig_sql                => 'select * from xla_ae_lines
where application_id=##$$APPS_PARAM1$$##
and ae_header_id in (select ae_header_id from xla_ae_headers
where application_id=##$$APPS_PARAM1$$##
and event_id in (select event_id from xla_events
where event_id in (select xla_event_id from PN_PAYMENT_ITEMS_ALL WHERE PAYMENT_TERM_ID IN (select distinct payment_term_id  
FROM PN_PAYMENT_TERMS_ALL
...
and application_id=##$$APPS_PARAM1$$##)))
order by ae_header_id  asc',
      p_title                  => 'XLA_AE_LINES for Normalized Terms',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in XLA_AE_LINES table for Normalized terms',
      p_solution               => '',
      p_success_msg            => 'Data found in XLA_AE_LINES table for Normalized terms',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PNANALYZER_NORMALZIED_XLA_AE_LINES');



debug('begin add_signature: EBS_FIN_FA_PNANALYZER_PN_STREAM_HEADER_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25999',
      p_sig_id                 => 'EBS_FIN_FA_PNANALYZER_PN_STREAM_HEADER_LINES',
      p_sig_sql                => 'SELECT 
    psa.org_id,
    psa.stream_header_id,
    psa.lease_change_id,
    psa.lease_change_line_id,
    psa.lease_id,
    psa.payment_term_id,
    psa.option_id,
    psa.stream_type_code,
    psa.stream_version,
    psa.regime_code,
    psa.created_by,
    psa.creation_date,
...
FROM 
    pn_streams_all psa
INNER JOIN 
    pn_stream_lines_all psla ON psa.org_id = psla.org_id
                            AND psa.stream_header_id = psla.stream_header_id
                            AND psa.lease_id = psla.lease_id
WHERE 
    psa.lease_id IN (
        SELECT 
            lease_id 
      ...
      p_title                  => 'Stream Headers and Lines Data (PN_STREAM_LINES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Data in PN_STREAMS_ALL and PN_STREAM_LINES_ALL table',
      p_solution               => '',
      p_success_msg            => 'Found Data in PN_STREAMS_ALL and PN_STREAM_LINES_ALL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PNANALYZER_PN_STREAM_HEADER_LINES');



debug('begin add_signature: PN_LEASE_STREAM_TEMP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10930',
      p_sig_id                 => 'PN_LEASE_STREAM_TEMP',
      p_sig_sql                => 'SELECT
    *
FROM
    pn_lease_stream_temp
WHERE lease_id IN (
    SELECT
        lease_id
    FROM
...
ORDER BY lease_id DESC',
      p_title                  => 'Lease Stream Temporary Data (PN_LEASE_STREAM_TEMP)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data in PN_LEASE_STREAM_TEMP Table',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_LEASE_STREAM_TEMP table',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_LEASE_STREAM_TEMP');



debug('begin add_signature: PN_ACCT_TRX_HEADERS_LINES_INFO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '21445',
      p_sig_id                 => 'PN_ACCT_TRX_HEADERS_LINES_INFO',
      p_sig_sql                => 'SELECT
hdrs.ORG_ID HDR_ORG_ID
,hdrs.LEASE_ID HDR_LEASE_ID
,hdrs.ACCT_TRANSACTION_ID HDR_ACCT_TRANSACTION_ID
,hdrs.TRANSACTION_NUMBER HDR_TRNASCATION_NUM
,hdrs.TRANSACTION_TYPE HDR_TRANSACTION_TYPE
,hdrs.CURRENCY_CODE HDR_CURRENCY_CODE
,hdrs.RATE HDR_RATE
,hdrs.TRANSACTION_DATE HDR_TRANSACTION_DATE
,hdrs.TRANSACTION_STATUS HDR_TRANSACTION_STATUS
,hdrs.DESCRIPTION HDR_DESCRIPTION
,hdrs.REGIME_CODE HDR_REGIME_CODE
,hdrs.EVENT_ID HDR_EVENT_ID
,hdrs.LEASE_CHANGE_ID HDR_LEASE_CHANGE_ID
,hdrs.CREATION_DATE HDR_CREATION_DATE
,lines.*
FROM pn_acct_trx_headers_all hdrs, pn_acct_trx_lines_all lines
WHERE hdrs.ACCT_TRANSACTION_ID = lines. TRANSACTION_ID
AND hdrs.lease_id in ( SELECT lease_id FROM     pn_leases_all
					   WHERE lease_num = ''##$$LEASE_NUM$$##''
AND ORG_ID = ##$$ORG_ID$$##)
order by hdrs.ACCT_TRANSACTION_ID,lines.TRANSACTION_LINE_ID',
      p_title                  => 'Lease Transactions Accounting Details (PN_ACCT_TRX_HEADERS_LINES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Lease Transactions Accounting data found.',
      p_solution               => '',
      p_success_msg            => 'Data found for Lease Transactions Accounting.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_ACCT_TRX_HEADERS_LINES_INFO');



debug('begin add_signature: PN_LEASE_CHG_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10933',
      p_sig_id                 => 'PN_LEASE_CHG_DETAILS',
      p_sig_sql                => 'select * from PN_LEASE_CHG_DETAILS
WHERE lease_id IN ( SELECT
    lease_id
FROM
    pn_leases_all
WHERE
    lease_num = ''##$$LEASE_NUM$$##''
AND ORG_ID = ##$$ORG_ID$$##)
order by lease_id desc,lease_change_id asc',
      p_title                  => 'Details of Changes on the Lease (PN_LEASE_CHG_DETAILS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_LEASE_CHG_DETAILS',
      p_solution               => '',
      p_success_msg            => 'Data from PN_LEASE_CHG_DETAILS table',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_LEASE_CHG_DETAILS');



debug('begin add_signature: PN_LEASE_ACCNT_TEMP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10934',
      p_sig_id                 => 'PN_LEASE_ACCNT_TEMP',
      p_sig_sql                => 'select * from PN_LEASE_ACCNT_TEMP
WHERE lease_id in( SELECT
    lease_id
FROM
    pn_leases_all
...
AND ORG_ID = ##$$ORG_ID$$##)
order by lease_id desc',
      p_title                  => 'Details for Calculation and Recalculation (PN_LEASE_ACCNT_TEMP)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data in table PN_LEASE_ACCNT_TEMP',
      p_solution               => '',
      p_success_msg            => 'Data in table PN_LEASE_ACCNT_TEMP',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_LEASE_ACCNT_TEMP');



debug('begin add_signature: XLA_EVENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12440',
      p_sig_id                 => 'XLA_EVENTS',
      p_sig_sql                => 'SELECT xe.*
FROM XLA_EVENTS xe,
     PN_ACCT_TRX_HEADERS_ALL pth,
     PN_LEASES_ALL pla
WHERE xe.event_id = pth.event_id
  AND pth.lease_id = pla.lease_id
  AND pla.LEASE_NUM = ''##$$LEASE_NUM$$##''
  AND pla.ORG_ID = ''##$$ORG_ID$$##''
ORDER BY xe.event_id ASC',
      p_title                  => 'Accounting Transaction Event (PN_XLA_EVENTS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in XLA_EVENTS table',
      p_solution               => '',
      p_success_msg            => 'Data found in XLA_EVENTS table',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: XLA_EVENTS');



debug('begin add_signature: XLA_AE_HEADERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12441',
      p_sig_id                 => 'XLA_AE_HEADERS',
      p_sig_sql                => 'SELECT xah.*
FROM XLA_AE_HEADERS xah,
     PN_ACCT_TRX_HEADERS_ALL pth,
     PN_LEASES_ALL pla
WHERE xah.event_id = pth.event_id
  AND pth.lease_id = pla.lease_id
  AND pla.lease_num = ''##$$LEASE_NUM$$##''
  AND pla.ORG_ID = ''##$$ORG_ID$$##''',
      p_title                  => 'Journals Header Information Transfer to GL (PN_XLA_AE_HEADERS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in XLA_AE_HEADERS table',
      p_solution               => '',
      p_success_msg            => 'Data found in XLA_AE_HEADERS table',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: XLA_AE_HEADERS');



debug('begin add_signature: XLA_AE_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12442',
      p_sig_id                 => 'XLA_AE_LINES',
      p_sig_sql                => 'SELECT
xal.*
FROM
xla_ae_lines xal,
...
AND xah.event_id = pth.event_id
AND pth.lease_id = pla.lease_id
AND pla.lease_num = ''##$$LEASE_NUM$$##''
AND pla.ORG_ID = ''##$$ORG_ID$$##''',
      p_title                  => 'Journals Transfer to GL (PN_XLA_AE_LINES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in XLA_AE_LINES table',
      p_solution               => '',
      p_success_msg            => 'Data found in XLA_AE_LINES table',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: XLA_AE_LINES');



debug('begin add_signature: PN_PMT_ITEM_PV_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10937',
      p_sig_id                 => 'PN_PMT_ITEM_PV_ALL',
      p_sig_sql                => 'select * from PN_PMT_ITEM_PV_ALL
WHERE lease_id in ( SELECT
    lease_id
FROM
    pn_leases_all
...
AND ORG_ID = ##$$ORG_ID$$##)
order by lease_id desc',
      p_title                  => 'Present Value (PV) Calculations for All Eligible Payment Terms and Options (PN_PMT_ITEM_PV_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data in PN_PMT_ITEM_PV_ALL',
      p_solution               => '',
      p_success_msg            => 'Data from PN_PMT_ITEM_PV_ALL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_PMT_ITEM_PV_ALL');



debug('begin add_signature: PN_PMT_ITEM_PV_HIST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10938',
      p_sig_id                 => 'PN_PMT_ITEM_PV_HIST',
      p_sig_sql                => 'select * from PN_PMT_ITEM_PV_HIST
WHERE lease_id in ( SELECT
    lease_id
FROM
    pn_leases_all
...
AND ORG_ID = ##$$ORG_ID$$##)
order by lease_id desc',
      p_title                  => 'Details of Present Value (PV) Calculation of ROU, Liability (PN_PMT_ITEM_PV_HIST)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data in PN_PMT_ITEM_PV_HIST table',
      p_solution               => '',
      p_success_msg            => 'Data from PN_PMT_ITEM_PV_HIST table',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_PMT_ITEM_PV_HIST');



debug('begin add_signature: PN_PMT_ITEM_PV_HST_CRRNCY_CHG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10939',
      p_sig_id                 => 'PN_PMT_ITEM_PV_HST_CRRNCY_CHG',
      p_sig_sql                => 'select * from PN_PMT_ITEM_PV_HST_CRRNCY_CHG
WHERE lease_id in ( SELECT
    lease_id
FROM
    pn_leases_all
...
AND ORG_ID = ##$$ORG_ID$$##)
order by lease_id desc',
      p_title                  => 'Currency Change in Present Value (PV) (PN_PMT_ITEM_PV_HST_CRRNCY_CHG)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data in PN_PMT_ITEM_PV_HST_CRRNCY_CHG',
      p_solution               => '',
      p_success_msg            => 'data found in PN_PMT_ITEM_PV_HST_CRRNCY_CHG',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_PMT_ITEM_PV_HST_CRRNCY_CHG');



debug('begin add_signature: PN_PMT_ITEM_PV_STREAM_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10940',
      p_sig_id                 => 'PN_PMT_ITEM_PV_STREAM_ALL',
      p_sig_sql                => 'select * from PN_PMT_ITEM_PV_STREAM_ALL
WHERE lease_id in ( SELECT
    lease_id
FROM
    pn_leases_all
...
AND ORG_ID = ##$$ORG_ID$$##)
and ROWNUM < 201
order by lease_id desc, due_date asc',
      p_title                  => 'Present Value (PV) Calculation for ROU and Liability Stream Period Wise (PN_PMT_ITEM_PV_STREAM_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data in PN_PMT_ITEM_PV_STREAM_ALL',
      p_solution               => '',
      p_success_msg            => 'Found data in PN_PMT_ITEM_PV_STREAM_ALL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_PMT_ITEM_PV_STREAM_ALL');



debug('begin add_signature: PN_PMT_ITM_AMTZ_HST_CRRNCY_CHG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10941',
      p_sig_id                 => 'PN_PMT_ITM_AMTZ_HST_CRRNCY_CHG',
      p_sig_sql                => 'select * from PN_PMT_ITM_AMTZ_HST_CRRNCY_CHG
WHERE lease_id in ( SELECT
    lease_id
FROM
    pn_leases_all
...
AND ORG_ID = ##$$ORG_ID$$##)
order by lease_id desc',
      p_title                  => 'History  of Currency Changes in Amortization (PN_PMT_ITM_AMTZ_HST_CRRNCY_CHG)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_PMT_ITM_AMTZ_HST_CRRNCY_CHG',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_PMT_ITM_AMTZ_HST_CRRNCY_CHG',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_PMT_ITM_AMTZ_HST_CRRNCY_CHG');



debug('begin add_signature: PN_INTEREST_INDEX_HEADERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11215',
      p_sig_id                 => 'PN_INTEREST_INDEX_HEADERS',
      p_sig_sql                => 'SELECT *
FROM PN_INTEREST_INDEX_HEADERS where index_id IN
  (SELECT discount_rate_index_id
  FROM pn_leases_all
  WHERE lease_num = ''##$$LEASE_NUM$$##''
AND ORG_ID = ##$$ORG_ID$$##)
order by effective_start_date desc',
      p_title                  => 'Rate Index (PN_INTEREST_INDEX_HEADERS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_INTEREST_INDEX_HEADERS table',
      p_solution               => '',
      p_success_msg            => 'Found data on PN_INTEREST_INDEX_HEADERS table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_INTEREST_INDEX_HEADERS');



debug('begin add_signature: PN_INTEREST_INDEX_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11216',
      p_sig_id                 => 'PN_INTEREST_INDEX_LINES',
      p_sig_sql                => 'SELECT *
FROM PN_INTEREST_INDEX_LINES
WHERE index_id IN
  (SELECT discount_rate_index_id
  FROM pn_leases_all
  WHERE lease_num = ''##$$LEASE_NUM$$##''
AND ORG_ID = ##$$ORG_ID$$##)
order by index_line_id asc',
      p_title                  => 'Discount Rates Created for Discount Rate Index (PN_INTEREST_INDEX_LINES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_INTEREST_INDEX_LINES table',
      p_solution               => '',
      p_success_msg            => 'Found data on PN_INTEREST_INDEX_LINES table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_INTEREST_INDEX_LINES');



debug('begin add_signature: PN_LEASES_HIST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11217',
      p_sig_id                 => 'PN_LEASES_HIST',
      p_sig_sql                => 'select * from PN_LEASES_HIST
WHERE lease_id in ( SELECT
    lease_id
FROM
    pn_leases_all
...
AND ORG_ID = ##$$ORG_ID$$##)
order by lease_id desc',
      p_title                  => 'Archive/History Information for Leases (PN_LEASES_HIST)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_LEASES_HIST table',
      p_solution               => '',
      p_success_msg            => 'Found data on PN_LEASES_HIST table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_LEASES_HIST');



debug('begin add_signature: PN_OPTION_PERIODS_HIST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11220',
      p_sig_id                 => 'PN_OPTION_PERIODS_HIST',
      p_sig_sql                => 'SELECT *
FROM PN_OPTION_PERIODS_HIST
WHERE option_id IN
  (SELECT option_id
  FROM PN_OPTIONS_all
  WHERE lease_id IN
...
AND ORG_ID = ##$$ORG_ID$$##))
order by option_id desc',
      p_title                  => 'Historical Data of Option Periods (PN_OPTION_PERIODS_HIST)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_OPTION_PERIODS_HIST table',
      p_solution               => '',
      p_success_msg            => 'Found data on PN_OPTION_PERIODS_HIST table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_OPTION_PERIODS_HIST');



debug('begin add_signature: PN_OPTION_ITEMS_HIST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11221',
      p_sig_id                 => 'PN_OPTION_ITEMS_HIST',
      p_sig_sql                => 'SELECT *
FROM PN_OPTION_ITEMS_HIST
WHERE option_period_id IN
  (SELECT option_period_id
  FROM PN_OPTION_PERIODS_ALL
  WHERE option_id IN
...
AND ORG_ID = ##$$ORG_ID$$##
  ...
  order by option_item_id desc',
      p_title                  => 'Historical Information of Options (PN_OPTION_ITEMS_HIST)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_OPTION_ITEMS_HIST table',
      p_solution               => '',
      p_success_msg            => 'Found data on PN_OPTION_ITEMS_HIST table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_OPTION_ITEMS_HIST');



debug('begin add_signature: PN_LEASE_DETAILS_HIST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11222',
      p_sig_id                 => 'PN_LEASE_DETAILS_HIST',
      p_sig_sql                => 'select * from PN_LEASE_DETAILS_HIST
WHERE lease_id in(SELECT
    lease_id
FROM
    pn_leases_all
...
AND ORG_ID = ##$$ORG_ID$$##)
order by lease_id desc',
      p_title                  => 'Historical Data on Lease Details (PN_LEASE_DETAILS_HIST)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_LEASE_DETAILS_HIST table',
      p_solution               => '',
      p_success_msg            => 'Found data on PN_LEASE_DETAILS_HIST table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_LEASE_DETAILS_HIST');



debug('begin add_signature: PN_PMT_ITEM_AMRTZN_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10935',
      p_sig_id                 => 'PN_PMT_ITEM_AMRTZN_ALL',
      p_sig_sql                => 'select * from PN_PMT_ITEM_AMRTZN_ALL
WHERE lease_id in ( SELECT
    lease_id
FROM
    pn_leases_all
...
order by lease_id desc,
amrtzn_item_id asc',
      p_title                  => 'Amortization Calculation Details (PN_PMT_ITEM_AMRTZN_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data in PN_PMT_ITEM_AMRTZN_ALL',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_PMT_ITEM_AMRTZN_ALL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_PMT_ITEM_AMRTZN_ALL');



debug('begin add_signature: PN_PMT_ITEM_AMRTZN_HIST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10936',
      p_sig_id                 => 'PN_PMT_ITEM_AMRTZN_HIST',
      p_sig_sql                => 'select * from PN_PMT_ITEM_AMRTZN_HIST
WHERE lease_id in ( SELECT
    lease_id
FROM
    pn_leases_all
...
order by lease_id desc,
amrtzn_item_id asc',
      p_title                  => 'History Information of Amortization Schedules and Balance Amounts (PN_PMT_ITEM_AMRTZN_HIST)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data in PN_PMT_ITEM_AMRTZN_HIST',
      p_solution               => '',
      p_success_msg            => 'Data in PN_PMT_ITEM_AMRTZN_HIST',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_PMT_ITEM_AMRTZN_HIST');



debug('begin add_signature: PN_PMT_ITEM_PV_GTT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11214',
      p_sig_id                 => 'PN_PMT_ITEM_PV_GTT',
      p_sig_sql                => 'select * from PN_PMT_ITEM_PV_GTT
WHERE lease_id in ( SELECT
    lease_id
FROM
    pn_leases_all
...
order by lease_id desc,
due_date asc',
      p_title                  => 'Derived Amounts of Present Value (PV) (PN_PMT_ITEM_PV_GTT)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_PMT_ITEM_PV_GTT table.',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_PMT_ITEM_PV_GTT',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_PMT_ITEM_PV_GTT');



debug('begin add_signature: EBS_FIN_FA_PNANALYZER_PN_STREAM_ACD_BALANCE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23782',
      p_sig_id                 => 'EBS_FIN_FA_PNANALYZER_PN_STREAM_ACD_BALANCE',
      p_sig_sql                => 'select * from PN_STREAM_ACD_BALANCE
WHERE lease_id in ( SELECT
    lease_id
FROM
    pn_leases_all
...
and ROWNUM < 201
order by lease_id desc,
change_commencement_date asc',
      p_title                  => 'Streams Balances as of Amendment Commencement Date (PN_STREAM_ACD_BALANCE)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_STREAM_ACD_BALANCE table',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_STREAM_ACD_BALANCE table',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PNANALYZER_PN_STREAM_ACD_BALANCE');



debug('begin add_signature: EBS_FIN_FA_PNANALYZER_PN_LEASE_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25995',
      p_sig_id                 => 'EBS_FIN_FA_PNANALYZER_PN_LEASE_ERRORS',
      p_sig_sql                => 'select * from PN_LEASE_ERRORS 
where LEASE_ID in
(SELECT LEASE_ID
FROM PN_LEASES_ALL
WHERE LEASE_NUM = ''##$$LEASE_NUM$$##''
AND ORG_ID = ##$$ORG_ID$$##)',
      p_title                  => 'Details of Lease Errors in PN_LEASE_ERRORS ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_LEASE_ERRORS for Lease',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_LEASE_ERRORS for Lease',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PNANALYZER_PN_LEASE_ERRORS');



debug('begin add_signature: EBS_FIN_FA_PNANALYZER_PN_PAY_GROUP_CHANGES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '32448',
      p_sig_id                 => 'EBS_FIN_FA_PNANALYZER_PN_PAY_GROUP_CHANGES_ALL',
      p_sig_sql                => 'select * from PN_PAY_GROUP_CHANGES_ALL ppgca, PN_LEASES_ALL pla
where pla.lease_id=ppgca.lease_id and 
 pla.LEASE_NUM = ''##$$LEASE_NUM$$##''
AND pla.ORG_ID = ##$$ORG_ID$$##
',
      p_title                  => 'PN_PAY_GROUP_CHANGES_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data in PN_PAY_GROUP_CHANGES_ALL table',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_PAY_GROUP_CHANGES_ALL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PNANALYZER_PN_PAY_GROUP_CHANGES_ALL');



debug('begin add_signature: PN_EQP_LEASES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11281',
      p_sig_id                 => 'PN_EQP_LEASES_ALL',
      p_sig_sql                => 'SELECT
   *
FROM
    pn_eqp_leases_all
WHERE
    lease_num = ''##$$EQP_LEASE_NUM$$##''
AND org_id = ''##$$ORG_ID$$##''',
      p_title                  => 'Lease Header Information (PN_EQP_LEASES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in table PN_EQP_LEASES_ALL table',
      p_solution               => '',
      p_success_msg            => 'Data found in table PN_EQP_LEASES_ALL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_EQP_LEASES_ALL');



debug('begin add_signature: PN_EQP_LEASE_CHANGES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11282',
      p_sig_id                 => 'PN_EQP_LEASE_CHANGES_ALL',
      p_sig_sql                => 'SELECT
    *
FROM
    pn_eqp_lease_changes_all
WHERE
    lease_id in (
        SELECT
            lease_id
...
AND org_id = ''##$$ORG_ID$$##''
      ...
      p_title                  => 'Details of All Changes on the Lease (PN_EQP_LEASE_CHANGES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_EQP_LEASE_CHANGES_ALL table',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_EQP_LEASE_CHANGES_ALL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_EQP_LEASE_CHANGES_ALL');



debug('begin add_signature: PN_EQP_LEASE_CHG_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11283',
      p_sig_id                 => 'PN_EQP_LEASE_CHG_DETAILS',
      p_sig_sql                => 'SELECT
    *
FROM
    pn_eqp_lease_chg_details
WHERE
    payment_term_id IN (
        SELECT
            payment_term_id
        FROM
            pn_eqp_payment_terms_all
        WHERE
            lease_id in (
                SELECT
                    lease_id
...
AND org_id = ''##$$ORG_ID$$##''
      ...
      p_title                  => 'Details of Changes Performed (PN_EQP_LEASE_CHG_DETAILS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_EQP_LEASE_CHG_DETAILS table ',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PN_EQP_LEASE_CHG_DETAILS');



debug('begin add_signature: PN_EQP_LEASE_DETAILS_HISTORY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11285',
      p_sig_id                 => 'PN_EQP_LEASE_DETAILS_HISTORY',
      p_sig_sql                => 'SELECT
    *
FROM
    PN_EQP_LEASE_DETAILS_HISTORY
    WHERE
            lease_id in (
                SELECT
                    lease_id
                ...
                WHERE
                    lease_num = ''##$$EQP_LEASE_NUM$$##''
AND org_id = ''##$$ORG_ID$$##'')',
      p_title                  => 'Historical Data of Lease Changes (PN_EQP_LEASE_DETAILS_HISTORY)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_EQP_LEASE_DETAILS_HISTORY table',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_EQP_LEASE_DETAILS_HISTORY',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_EQP_LEASE_DETAILS_HISTORY');



debug('begin add_signature: PN_EQP_PARTIES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11292',
      p_sig_id                 => 'PN_EQP_PARTIES_ALL',
      p_sig_sql                => 'SELECT
    *
FROM
    PN_EQP_PARTIES_ALL where   lease_id in (
                SELECT
                    lease_id
                FROM
                    pn_eqp_leases_all
                WHERE
                    lease_num = ''##$$EQP_LEASE_NUM$$##''
AND org_id = ''##$$ORG_ID$$##'')',
      p_title                  => 'Lessor/Lessee of the Lease (PN_EQP_PARTIES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_EQP_PARTIES_ALL table',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_EQP_PARTIES_ALL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_EQP_PARTIES_ALL');



debug('begin add_signature: PN_EQP_ASSETS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11278',
      p_sig_id                 => 'PN_EQP_ASSETS_ALL',
      p_sig_sql                => 'SELECT
    *
FROM
   PN_EQP_ASSETS_ALL
...
WHERE
    lease_num = ''##$$EQP_LEASE_NUM$$##''
AND org_id = ''##$$ORG_ID$$##'')',
      p_title                  => 'Asset Information (PN_EQP_ASSETS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_EQP_ASSETS_ALL table',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_EQP_ASSETS_ALL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_EQP_ASSETS_ALL');



debug('begin add_signature: PN_EQP_PAYMENT_TERMS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11295',
      p_sig_id                 => 'PN_EQP_PAYMENT_TERMS_ALL',
      p_sig_sql                => 'SELECT
    *
FROM
    pn_eqp_payment_terms_all
...
AND org_id = ''##$$ORG_ID$$##''
      ...
      p_title                  => 'Payment/Billing Terms Defined (PN_EQP_PAYMENT_TERMS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_EQP_PAYMENT_TERMS_ALL table',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_EQP_PAYMENT_TERMS_ALL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_EQP_PAYMENT_TERMS_ALL');



debug('begin add_signature: PN_EQP_OPTIONS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11288',
      p_sig_id                 => 'PN_EQP_OPTIONS_ALL',
      p_sig_sql                => 'SELECT
    *
FROM
    PN_EQP_OPTIONS_ALL
    WHERE
            lease_id in (
                ...
                WHERE
                    lease_num = ''##$$EQP_LEASE_NUM$$##''
AND org_id = ''##$$ORG_ID$$##'')',
      p_title                  => 'Options On this Lease (PN_EQP_OPTIONS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_EQP_OPTIONS_ALL table',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_EQP_OPTIONS_ALL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_EQP_OPTIONS_ALL');



debug('begin add_signature: PN_EQP_OPTIONS_HISTORY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11289',
      p_sig_id                 => 'PN_EQP_OPTIONS_HISTORY',
      p_sig_sql                => 'SELECT
    *
FROM
    PN_EQP_OPTIONS_HISTORY
    WHERE
            lease_id in (
                SELECT
                    lease_id
                ...
                WHERE
                    lease_num =''##$$EQP_LEASE_NUM$$##''
AND org_id = ''##$$ORG_ID$$##'')',
      p_title                  => 'History of All Option Items (PN_EQP_OPTIONS_HISTORY)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_EQP_OPTIONS_HISTORY table',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_EQP_OPTIONS_HISTORY',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_EQP_OPTIONS_HISTORY');



debug('begin add_signature: PN_EQP_ADJ_SUMMARIES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11277',
      p_sig_id                 => 'PN_EQP_ADJ_SUMMARIES',
      p_sig_sql                => 'SELECT
    *
FROM
    pn_eqp_adj_summaries
WHERE payment_term_id in ( SELECT
    payment_term_id
                         FROM
    pn_eqp_payment_terms_all
WHERE lease_id in ( SELECT
    ...
    lease_num =''##$$EQP_LEASE_NUM$$##''
AND org_id = ''##$$ORG_ID$$##'' ) )',
      p_title                  => 'Adjustments in Summary (PN_EQP_ADJ_SUMMARIES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_EQP_ADJ_SUMMARIES table',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_EQP_ADJ_SUMMARIES',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_EQP_ADJ_SUMMARIES');



debug('begin add_signature: PN_EQP_ADJUSTMENT_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11276',
      p_sig_id                 => 'PN_EQP_ADJUSTMENT_DETAILS',
      p_sig_sql                => 'SELECT
    *
FROM
    pn_eqp_adjustment_details
WHERE payment_item_id in ( SELECT
    payment_item_id
                          FROM
    pn_eqp_payment_items_all
WHERE payment_term_id in ( SELECT
    payment_term_id
                         FROM
    pn_eqp_payment_terms_all
WHERE lease_id in ( SELECT
    ...
    lease_num = ''##$$EQP_LEASE_NUM$$##''
AND org_id = ''##$$ORG_ID$$##'' )))',
      p_title                  => 'Details of Adjustments (PN_EQP_ADJUSTMENT_DETAILS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_EQP_ADJUSTMENT_DETAILS table',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_EQP_ADJUSTMENT_DETAILS',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_EQP_ADJUSTMENT_DETAILS');



debug('begin add_signature: PN_EQP_DISTRIBUTIONS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11279',
      p_sig_id                 => 'PN_EQP_DISTRIBUTIONS_ALL',
      p_sig_sql                => 'SELECT
    *
FROM
    PN_EQP_DISTRIBUTIONS_ALL
WHERE payment_term_id in ( SELECT
    payment_term_id
                         FROM
    pn_eqp_payment_terms_all
WHERE lease_id in ( SELECT
    ...
    lease_num =''##$$EQP_LEASE_NUM$$##''
AND org_id = ''##$$ORG_ID$$##'') )',
      p_title                  => 'Accounts Information for Payment/Billing Terms or Term Templates (PN_EQP_DISTRIBUTIONS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data in PN_EQP_DISTRIBUTIONS_ALL table',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_EQP_DISTRIBUTIONS_ALL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_EQP_DISTRIBUTIONS_ALL');



debug('begin add_signature: PN_EQP_DISTRIBUTIONS_HISTORY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11280',
      p_sig_id                 => 'PN_EQP_DISTRIBUTIONS_HISTORY',
      p_sig_sql                => 'SELECT
    *
FROM
    pn_eqp_distributions_history
WHERE
    distribution_id in (
        SELECT
            distribution_id
...
AND org_id = ''##$$ORG_ID$$##''
      ...
      p_title                  => 'Historical Information Distributions (PN_EQP_DISTRIBUTIONS_HISTORY)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_EQP_DISTRIBUTIONS_HISTORY table',
      p_solution               => '',
      p_success_msg            => 'Data found in table PN_EQP_DISTRIBUTIONS_HISTORY',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_EQP_DISTRIBUTIONS_HISTORY');



debug('begin add_signature: PN_EQP_LEASE_TRANSACTIONS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11286',
      p_sig_id                 => 'PN_EQP_LEASE_TRANSACTIONS_ALL',
      p_sig_sql                => 'SELECT
    *
FROM
    PN_EQP_LEASE_TRANSACTIONS_ALL
    WHERE
    lease_id = (
        SELECT
            lease_id
        ...
        WHERE
            lease_num = ''##$$LEASE_NUM$$##''
AND ORG_ID = ##$$ORG_ID$$##)',
      p_title                  => 'Transactions Information (PN_EQP_LEASE_TRANSACTIONS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_EQP_LEASE_TRANSACTIONS_ALL table',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_EQP_LEASE_TRANSACTIONS_ALL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_EQP_LEASE_TRANSACTIONS_ALL');



debug('begin add_signature: PN_EQP_OPTION_ITEMS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11290',
      p_sig_id                 => 'PN_EQP_OPTION_ITEMS_ALL',
      p_sig_sql                => 'SELECT *
FROM PN_EQP_OPTION_ITEMS_ALL
WHERE option_period_id IN
  (SELECT option_period_id
  FROM PN_EQP_OPTION_PERIODS_ALL
  WHERE option_id in
    (SELECT option_id
    FROM PN_EQP_OPTIONS_HISTORY
    WHERE lease_id in
      (SELECT lease_id
      FROM pn_eqp_leases_all
      WHERE lease_num = ''##$$EQP_LEASE_NUM$$##''
      AND org_id      = ''##$$ORG_ID$$##''
      )))',
      p_title                  => 'All Option Items (PN_EQP_OPTION_ITEMS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_EQP_OPTION_ITEMS_ALL table',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_EQP_OPTION_ITEMS_ALL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_EQP_OPTION_ITEMS_ALL');



debug('begin add_signature: PN_EQP_OPTION_PERIODS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11291',
      p_sig_id                 => 'PN_EQP_OPTION_PERIODS_ALL',
      p_sig_sql                => 'SELECT
    *
FROM
    PN_EQP_OPTION_PERIODS_ALL 
    where option_id in (select option_id from PN_EQP_OPTIONS_HISTORY where   lease_id in (
                SELECT
                    lease_id
                FROM
                    pn_eqp_leases_all
                WHERE
                    lease_num = ''##$$EQP_LEASE_NUM$$##''
AND org_id =''##$$ORG_ID$$##''))',
      p_title                  => 'Periods for Options Generated (PN_EQP_OPTION_PERIODS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_EQP_OPTION_PERIODS_ALL table',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_EQP_OPTION_PERIODS_ALL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_EQP_OPTION_PERIODS_ALL');



debug('begin add_signature: PN_EQP_PAYMENT_ITEMS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11293',
      p_sig_id                 => 'PN_EQP_PAYMENT_ITEMS_ALL',
      p_sig_sql                => 'SELECT
 *
                          FROM
    pn_eqp_payment_items_all
...
WHERE lease_id in ( SELECT
    ...
    lease_num = ''##$$EQP_LEASE_NUM$$##''
AND org_id = ''##$$ORG_ID$$##'' ))',
      p_title                  => 'Payment/Billing Items Associated with Payment/Billing Schedule (PN_EQP_PAYMENT_ITEMS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_EQP_PAYMENT_ITEMS_ALL table',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_EQP_PAYMENT_ITEMS_ALL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_EQP_PAYMENT_ITEMS_ALL');



debug('begin add_signature: PN_EQP_PAYMENT_SCHEDULES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11294',
      p_sig_id                 => 'PN_EQP_PAYMENT_SCHEDULES_ALL',
      p_sig_sql                => 'SELECT
    *
FROM
    PN_EQP_PAYMENT_SCHEDULES_ALL
    where   lease_id in (
                SELECT
                    lease_id
                FROM
                ...
                WHERE
                    lease_num = ''##$$EQP_LEASE_NUM$$##''
AND org_id = ''##$$ORG_ID$$##'')',
      p_title                  => 'Payment/Billing Schedules (PN_EQP_PAYMENT_SCHEDULES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_EQP_PAYMENT_SCHEDULES_ALL table',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_EQP_PAYMENT_SCHEDULES_ALL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_EQP_PAYMENT_SCHEDULES_ALL');



debug('begin add_signature: PN_EQP_NOTE_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11287',
      p_sig_id                 => 'PN_EQP_NOTE_DETAILS',
      p_sig_sql                => 'SELECT
    *
FROM
    PN_EQP_NOTE_DETAILS
    WHERE
            lease_id = (
                ...
                WHERE
                    lease_num = ''##$$EQP_LEASE_NUM$$##''
AND org_id = ''##$$ORG_ID$$##'')',
      p_title                  => 'Note of the Lease (PN_EQP_NOTE_DETAILS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_EQP_NOTE_DETAILS table',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_EQP_NOTE_DETAILS',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_EQP_NOTE_DETAILS');



debug('begin add_signature: PN_EQP_LEASE_DETAILS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11284',
      p_sig_id                 => 'PN_EQP_LEASE_DETAILS_ALL',
      p_sig_sql                => 'SELECT
    *
FROM
    PN_EQP_LEASE_DETAILS_ALL
    WHERE
            lease_id in (
                SELECT
                    lease_id
                ...
                WHERE
                    lease_num =''##$$EQP_LEASE_NUM$$##''
AND org_id = ''##$$ORG_ID$$##'')',
      p_title                  => 'Details of the Lease (PN_EQP_LEASE_DETAILS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_EQP_LEASE_DETAILS_ALL table',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_EQP_LEASE_DETAILS_ALL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_EQP_LEASE_DETAILS_ALL');



debug('begin add_signature: PN_EQP_ACCT_TRX_HEADERS_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '21644',
      p_sig_id                 => 'PN_EQP_ACCT_TRX_HEADERS_LINES',
      p_sig_sql                => 'SELECT
hdrs.ORG_ID HDR_ORG_ID
,hdrs.LEASE_ID HDR_LEASE_ID
,hdrs.ACCT_TRANSACTION_ID HDR_ACCT_TRANSACTION_ID
...
FROM pn_acct_trx_headers_all hdrs, pn_acct_trx_lines_all lines
WHERE hdrs.ACCT_TRANSACTION_ID = lines. TRANSACTION_ID
AND hdrs.lease_id in ( SELECT lease_id FROM     pn_eqp_leases_all
					   WHERE lease_num = ''##$$LEASE_NUM$$##''
AND ORG_ID = ##$$ORG_ID$$##)
order by hdrs.ACCT_TRANSACTION_ID,lines.TRANSACTION_LINE_ID',
      p_title                  => 'Equipment Lease Transactons Accounting Details (PN_EQP_ACCT_TRX_HEADERS_LINES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Check for the data in 
PN_ACCT_TRX_HEADERS_ALL and PN_ACCT_TRX_LINES_ALL',
      p_solution               => '',
      p_success_msg            => 'Verify the accounting transaction details along with Event information',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_EQP_ACCT_TRX_HEADERS_LINES');



debug('begin add_signature: XLA_EVENTS -EQP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12437',
      p_sig_id                 => 'XLA_EVENTS -EQP',
      p_sig_sql                => 'SELECT xe.*
FROM 
XLA_EVENTS xe,
PN_ACCT_TRX_HEADERS_ALL pth,
...
AND pla.ORG_ID = ''##$$ORG_ID$$##''
ORDER BY xe.event_id ASC',
      p_title                  => 'Accounting Transaction Event (PN_XLA_EVENTS_EQP)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in XLA_EVENTS table',
      p_solution               => '',
      p_success_msg            => 'Data found in XLA_EVENTS table',
   ...
   l_info.delete;
debug('end add_signature: XLA_EVENTS -EQP');



debug('begin add_signature: XLA_AE_HEADERS - EQP LEASE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12438',
      p_sig_id                 => 'XLA_AE_HEADERS - EQP LEASE',
      p_sig_sql                => 'SELECT xah.*
FROM 
XLA_AE_HEADERS xah,
PN_ACCT_TRX_HEADERS_ALL pth,
...
AND pla.lease_num = ''##$$LEASE_NUM$$##''
AND pla.ORG_ID = ''##$$ORG_ID$$##''',
      p_title                  => 'Journals Header Information Transfer to GL (PN_XLA_AE_HEADERS_EQP_LEASE)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in  XLA_AE_HEADERS table',
      p_solution               => '',
      p_success_msg            => 'Data found in  XLA_AE_HEADERS table',
   ...
   l_info.delete;
debug('end add_signature: XLA_AE_HEADERS - EQP LEASE');



debug('begin add_signature: XLA_AE_LINES -EQP LEASE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12439',
      p_sig_id                 => 'XLA_AE_LINES -EQP LEASE',
      p_sig_sql                => 'SELECT
xal.*
FROM
xla_ae_lines xal,
...
AND pla.lease_num = ''##$$LEASE_NUM$$##''
AND pla.ORG_ID = ''##$$ORG_ID$$##''',
      p_title                  => 'Journal Entry Lines Information of the Lease/Transaction (PN_XLA_AE_LINES_EQP_LEASE)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in XLA_AE_LINES table',
      p_solution               => '',
      p_success_msg            => 'Data found in XLA_AE_LINES table',
   ...
   l_info.delete;
debug('end add_signature: XLA_AE_LINES -EQP LEASE');



debug('begin add_signature: PN_EQP_LEASE_STREAM_TEMP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12433',
      p_sig_id                 => 'PN_EQP_LEASE_STREAM_TEMP',
      p_sig_sql                => 'SELECT
*
FROM
PN_LEASE_STREAM_TEMP
...
lease_num = ''##$$EQP_LEASE_NUM$$##''
AND org_id = ''##$$ORG_ID$$##'')',
      p_title                  => 'Temporary Initial Calculation of Streams (PN_EQP_LEASE_STREAM_TEMP)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_LEASE_STREAM_TEMP table',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_LEASE_STREAM_TEMP table',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PN_EQP_LEASE_STREAM_TEMP');



debug('begin add_signature: PN_EQP_PMT_ITEM_PV_STREAM_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12436',
      p_sig_id                 => 'PN_EQP_PMT_ITEM_PV_STREAM_ALL',
      p_sig_sql                => 'SELECT
*
FROM
...
lease_num = ''##$$EQP_LEASE_NUM$$##''
AND org_id = ''##$$ORG_ID$$##'')',
      p_title                  => 'Present Value (PV) Period Wise Calculation for ROU and Liability Stream (PN_EQP_PMT_ITEM_PV_STREAM_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_PMT_ITEM_PV_STREAM_ALL table',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_PMT_ITEM_PV_STREAM_ALL table',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_EQP_PMT_ITEM_PV_STREAM_ALL');



debug('begin add_signature: PN_EQP_SRN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11297',
      p_sig_id                 => 'PN_EQP_SRN',
...
WHERE
    lease_num =''##$$EQP_LEASE_NUM$$##''
AND org_id = ''##$$ORG_ID$$##'' ))',
      p_title                  => 'Serial Numbers for the Assets (PN_EQP_SRN)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_EQP_SRN table',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_EQP_SRN',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_EQP_SRN');



debug('begin add_signature: PN_EQP_SYSTEM_SETUP_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11298',
      p_sig_id                 => 'PN_EQP_SYSTEM_SETUP_OPTIONS',
      p_sig_sql                => 'SELECT
    *
FROM
    PN_EQP_SYSTEM_SETUP_OPTIONS where org_id=(select org_id FROM
                    pn_eqp_leases_all
                WHERE
                    lease_num = ''##$$EQP_LEASE_NUM$$##''
AND org_id = ''##$$ORG_ID$$##'')',
      p_title                  => 'System Setup Information (PN_EQP_SYSTEM_SETUP_OPTIONS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_EQP_SYSTEM_SETUP_OPTIONS table',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_EQP_SYSTEM_SETUP_OPTIONS',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_EQP_SYSTEM_SETUP_OPTIONS');



debug('begin add_signature: PN_EQP_TERM_TEMPLATES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11299',
      p_sig_id                 => 'PN_EQP_TERM_TEMPLATES_ALL',
      p_sig_sql                => 'SELECT
    *
FROM
    pn_eqp_term_templates_all
WHERE term_template_id in (
SELECT
    term_template_id
FROM
    pn_eqp_lease_details_all
...
AND org_id = ''##$$ORG_ID$$##''
      ...
      p_title                  => 'Payment/Billing Terms Details (PN_EQP_TERM_TEMPLATES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_EQP_TERM_TEMPLATES_ALL table',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_EQP_TERM_TEMPLATES_ALL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_EQP_TERM_TEMPLATES_ALL');



debug('begin add_signature: PN_EQP_INTEREST_INDEX_HEADERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20567',
      p_sig_id                 => 'PN_EQP_INTEREST_INDEX_HEADERS',
      p_sig_sql                => 'SELECT *
FROM PN_INTEREST_INDEX_HEADERS where index_id IN
  (SELECT discount_rate_index_id
  FROM pn_eqp_leases_all
  ...
  AND org_id      = ''##$$ORG_ID$$##''
      ...
      p_title                  => 'Discount Rate Setup Information at Header Level (PN_EQP_INTEREST_INDEX_HEADERS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Discount interest data found',
      p_solution               => '',
      p_success_msg            => 'Discount interest data found',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_EQP_INTEREST_INDEX_HEADERS');



debug('begin add_signature: PN_EQP_INTEREST_INDEX_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20568',
      p_sig_id                 => 'PN_EQP_INTEREST_INDEX_LINES',
      p_sig_sql                => 'SELECT *
FROM PN_INTEREST_INDEX_LINES
WHERE index_id IN
  (SELECT discount_rate_index_id
  ...
  WHERE lease_num = ''##$$LEASE_NUM$$##''
  AND org_id      = ''##$$ORG_ID$$##''
  ) order by index_line_id desc',
      p_title                  => 'Discount Rate Setup Information at Line Level (PN_EQP_INTEREST_INDEX_LINES)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No discount lines data found',
      p_solution               => '',
      p_success_msg            => 'Discount lines data found',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_EQP_INTEREST_INDEX_LINES');



debug('begin add_signature: EBS_FIN_FA_PNANALYZER_PN_EQP_PAYMENT_ITEM_DIST_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '32439',
      p_sig_id                 => 'EBS_FIN_FA_PNANALYZER_PN_EQP_PAYMENT_ITEM_DIST_ALL',
      p_sig_sql                => 'SELECT pida.*
FROM
PN_EQP_PAYMENT_ITEM_DIST_ALL pida,
pn_eqp_payment_items_all ppia,
...
AND pla.LEASE_NUM = ''##$$LEASE_NUM$$##''
AND pla.ORG_ID = ''##$$ORG_ID$$##''',
      p_title                  => 'PN_EQP_PAYMENT_ITEM_DIST_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data in PN_EQP_PAYMENT_ITEM_DIST_ALL table',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_EQP_PAYMENT_ITEM_DIST_ALL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PNANALYZER_PN_EQP_PAYMENT_ITEM_DIST_ALL');



debug('begin add_signature: EBS_FIN_FA_PNANALYZER_PN_EQP_LEASE_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '32437',
      p_sig_id                 => 'EBS_FIN_FA_PNANALYZER_PN_EQP_LEASE_ERRORS',
      p_sig_sql                => 'select * from PN_LEASE_ERRORS
where LEASE_ID in
(SELECT LEASE_ID
FROM pn_eqp_leases_all
WHERE LEASE_NUM = ''##$$LEASE_NUM$$##''
AND ORG_ID = ##$$ORG_ID$$##)',
      p_title                  => 'Error details for PN_EQP_LEASE_ERRORS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in PN_EQP_LEASE_ERRORS for Lease',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_EQP_LEASE_ERRORS for Lease',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PNANALYZER_PN_EQP_LEASE_ERRORS');



debug('begin add_signature: EBS_FIN_FA_PNANALYZER_PN_EQP_STREAM_HEADER_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '32438',
      p_sig_id                 => 'EBS_FIN_FA_PNANALYZER_PN_EQP_STREAM_HEADER_LINES',
      p_sig_sql                => 'SELECT
psa.org_id,
psa.stream_header_id,
psa.lease_change_id,
...
psa.stream_mode,
psa.currency_code,
--psa.change_type_code,
--psa.parent_record_id,
psla.*
FROM
pn_streams_all psa,
pn_stream_lines_all psla
WHERE psa.org_id = psla.org_id
AND psa.stream_header_id = psla.stream_header_id
AND psa.lease_id = psla.lease_id
AND psa.lease_id IN (
  SELECT lease_id
  ...
  AND org_id = ''##$$ORG_ID$$##''
      ...
      p_title                  => 'Equipment Stream Headers and Lines Data (PN_STREAMS_ALL and PN_STREAM_LINES_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Data in PN_STREAMS_ALL and PN_STREAM_LINES_ALL table',
      p_solution               => '',
      p_success_msg            => 'Found Data in PN_STREAMS_ALL and PN_STREAM_LINES_ALL',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PNANALYZER_PN_EQP_STREAM_HEADER_LINES');



debug('begin add_signature: EBS_FIN_FA_PNANALYZER_PN_EQP_PAY_GROUP_CHANGES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '32449',
      p_sig_id                 => 'EBS_FIN_FA_PNANALYZER_PN_EQP_PAY_GROUP_CHANGES_ALL',
      p_sig_sql                => 'SELECT *
FROM PN_EQP_PAY_GROUP_CHANGES_ALL ppgca,
pn_eqp_leases_all pla
WHERE pla.lease_id = ppgca.lease_id
AND pla.LEASE_NUM = ''##$$LEASE_NUM$$##''
AND pla.ORG_ID = ''##$$ORG_ID$$##''',
      p_title                  => 'PN_EQP_PAY_GROUP_CHANGES_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data in PN_EQP_PAY_GROUP_CHANGES_ALL table',
      p_solution               => '',
      p_success_msg            => 'Data found in PN_EQP_PAY_GROUP_CHANGES_ALL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PNANALYZER_PN_EQP_PAY_GROUP_CHANGES_ALL');



debug('begin add_signature: EBS_FIN_FA_PNANALYZER_PN_EQP_PAYMENT_ITEMS_ALL_NOMRALIZED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25990',
      p_sig_id                 => 'EBS_FIN_FA_PNANALYZER_PN_EQP_PAYMENT_ITEMS_ALL_NOMRALIZED',
      p_sig_sql                => 'SELECT pepia.* FROM PN_EQP_PAYMENT_ITEMS_ALL pepia,PN_EQP_PAYMENT_TERMS_ALL pepta, PN_EQP_LEASES_ALL pela
WHERE pepia.PAYMENT_TERM_ID = pepta.PAYMENT_TERM_ID
and pepta.NORMALIZE = ''Y''
and pepta.LEASE_ID =pela.LEASE_ID
and pela.LEASE_NUM = ''##$$EQP_LEASE_NUM$$##''
AND pela.ORG_ID = ##$$ORG_ID$$##
and pepia.payment_item_type_lookup_code=''NORMALIZED''
ORDER BY pepia.PAYMENT_TERM_ID desc, pepia.PAYMENT_ITEM_ID asc',
      p_title                  => 'Payment Term for Normalize Equipment Lease',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Equipment Normalized Payment Term Found',
      p_solution               => '',
      p_success_msg            => 'Found payment terms for normalized  equipment lease',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PNANALYZER_PN_EQP_PAYMENT_ITEMS_ALL_NOMRALIZED');



debug('begin add_signature: EBS_FIN_FA_PNANALYZER_PN_EQP_PAYMENT_ITEMS_ALL_SUM_NORMALIZE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25991',
      p_sig_id                 => 'EBS_FIN_FA_PNANALYZER_PN_EQP_PAYMENT_ITEMS_ALL_SUM_NORMALIZE',
      p_sig_sql                => 'SELECT PAYMENT_TERM_ID, PAYMENT_ITEM_TYPE_LOOKUP_CODE,
        SUM(ACTUAL_AMOUNT) FROM PN_EQP_PAYMENT_ITEMS_ALL WHERE PAYMENT_TERM_ID IN (SELECT PAYMENT_TERM_ID FROM PN_EQP_PAYMENT_TERMS_ALL WHERE NORMALIZE = ''Y''
AND LEASE_ID in
(SELECT LEASE_ID
FROM PN_EQP_LEASES_ALL
WHERE LEASE_NUM =  ''##$$EQP_LEASE_NUM$$##''
...
GROUP BY PAYMENT_TERM_ID, PAYMENT_ITEM_TYPE_LOOKUP_CODE
ORDER BY PAYMENT_TERM_ID desc, PAYMENT_ITEM_TYPE_LOOKUP_CODE',
      p_title                  => 'Payment Items Summary for Equipment Normalized Lease',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No equipment normalized  payment items found',
      p_solution               => '',
      p_success_msg            => 'Found records for payment items summary for equipment normalized lease',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PNANALYZER_PN_EQP_PAYMENT_ITEMS_ALL_SUM_NORMALIZE');



debug('begin add_signature: EBS_FIN_FA_PNANALYZER_XLA_EVENTS_EQUIP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25992',
      p_sig_id                 => 'EBS_FIN_FA_PNANALYZER_XLA_EVENTS_EQUIP',
      p_sig_sql                => 'select xe.* from apps.xla_events xe, apps.PN_EQP_PAYMENT_ITEMS_ALL ppia, apps.PN_EQP_PAYMENT_TERMS_ALL ppta
where 
  xe.event_id= ppia.xla_event_id
  and ppia.payment_term_id= ppta.payment_term_id
  and ppta.normalize = ''Y''
  ...
  and ppta.LEASE_ID in
(SELECT pla.LEASE_ID
FROM apps.PN_EQP_LEASES_ALL pla
WHERE pla.LEASE_NUM = ''##$$EQP_LEASE_NUM$$##''
and pla.ORG_ID = ##$$ORG_ID$$##)
and xe.application_id= ##$$APPS_PARAM1$$##',
      p_title                  => 'XLA_EVENTS for Equipment Normalized Terms',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in table XLA_EVENTS for Equipment Normalized Terms ',
      p_solution               => '',
      p_success_msg            => 'Data found in XLA_EVENTS table for Equipment Normalized Terms ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PNANALYZER_XLA_EVENTS_EQUIP');



debug('begin add_signature: EBS_FIN_FA_PNANALYZER_XLA_AE_HEADERS_EQUIP_NORM');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25993',
      p_sig_id                 => 'EBS_FIN_FA_PNANALYZER_XLA_AE_HEADERS_EQUIP_NORM',
      p_sig_sql                => 'select xah.* from xla_ae_headers xah ,xla_events xe, PN_EQP_PAYMENT_ITEMS_ALL ppia ,PN_EQP_PAYMENT_TERMS_ALL ppta
where xah.application_id=##$$APPS_PARAM1$$##
and xah.event_id= xe.event_id 
and xe.event_id =ppia.xla_event_id and 
ppia.PAYMENT_TERM_ID =ppta.payment_term_id  
and ppta.NORMALIZE = ''Y''
and ppta.org_id=##$$ORG_ID$$##
and ppta.LEASE_ID in
(SELECT LEASE_ID
FROM PN_EQP_LEASES_ALL
WHERE LEASE_NUM = ''##$$EQP_LEASE_NUM$$##''
...
and ppia.xla_event_id is not null
and xe.application_id=##$$APPS_PARAM1$$##
order by xah.ae_header_id asc',
      p_title                  => 'XLA_AE_HEADERS for Equipment Normalized Terms',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in XLA_AE_HEADERS  table for Equipment 
 Normalized terms',
      p_solution               => '',
      p_success_msg            => 'Data found in XLA_AE_HEADERS table for Equipment 
 Normalized terms',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PNANALYZER_XLA_AE_HEADERS_EQUIP_NORM');



debug('begin add_signature: EBS_FIN_FA_PNANALYZER_XLA_AE_LINES_EQUIP_NORM');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25994',
      p_sig_id                 => 'EBS_FIN_FA_PNANALYZER_XLA_AE_LINES_EQUIP_NORM',
      p_sig_sql                => 'select xal.* from xla_ae_lines xal, xla_ae_headers xah, xla_events xe, PN_EQP_PAYMENT_ITEMS_ALL ppia, PN_EQP_PAYMENT_TERMS_ALL ppta
where xal.application_id= ##$$APPS_PARAM1$$##
and xal.ae_header_id= xah.ae_header_id 
and xah.application_id=##$$APPS_PARAM1$$##
and xah.event_id=xe.event_id 
and xe.event_id =ppia.xla_event_id
and ppia.PAYMENT_TERM_ID=ppta.payment_term_id  
and ppta.NORMALIZE = ''Y''
and ppta.org_id=##$$ORG_ID$$##
AND ppta.LEASE_ID in
...
and ppia.xla_event_id is not null
and xe.application_id=##$$APPS_PARAM1$$##
order by xal.ae_header_id  asc',
      p_title                  => 'XLA_AE_LINES for Equipment Normalized Terms',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found in XLA_AE_LINES table for Equipment Normalized terms',
      p_solution               => '',
      p_success_msg            => 'Data found in XLA_AE_LINES table for Equipment Normalized terms',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PNANALYZER_XLA_AE_LINES_EQUIP_NORM');



debug('begin add_signature: ASSIGNABLE AREA IS NULL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9672',
      p_sig_id                 => 'ASSIGNABLE AREA IS NULL',
      p_sig_sql                => 'SELECT
  ASSIGNABLE_AREA ,
  RENTABLE_AREA ,
  USABLE_AREA ,
...
ORDER BY
  1',
      p_title                  => 'Assignable Area is Null',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'ASSIGNABLE_AREA is null in PN_LOCATIONS_ALL. Due to this user cannot enter lease and may get error:

''The location XXXXXXXXXXX cannot be assigned because it is a common space''',
      p_solution               => 'Follow instructions from [751731/KB789116] - Can Not Assign Some Building Locations To Leases.',
      p_success_msg            => 'No data found with assignable area as Null.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ASSIGNABLE AREA IS NULL');



debug('begin add_signature: MISSING_AP_AR_TERM_ID_CUST_TRX_TYPE_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9782',
      p_sig_id                 => 'MISSING_AP_AR_TERM_ID_CUST_TRX_TYPE_ID',
      p_sig_sql                => 'select * from PN_PAYMENT_TERMS_ALL
WHERE
LEASE_ID =
(
SELECT
...
PN_LEASES_ALL
WHERE LEASE_NUM = ''##$$LEASE_NUM$$##''
and lease_class_code=''THIRD_PARTY''
)
and ( Ap_Ar_Term_Id is NULL and Cust_Trx_Type_Id is NULL)
ORDER BY
PAYMENT_TERM_ID',
      p_title                  => 'Missing AP_AR_TERM_ID CUST_TRX_TYPE_ID in Payment Term',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'FRM-40202 Field must be entered and prompts to enter Payment term and Transaction type fields in Billing Tab ',
      p_solution               => 'Missing values for AP_AR_TERM_ID CUST_TRX_TYPE_ID in Payment term table .
Log SR to get datafix for missing record. Refer to [261210/KB714342] Leases: Field Must Be Entered Frm-40202',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: MISSING_AP_AR_TERM_ID_CUST_TRX_TYPE_ID');



debug('begin add_signature: ORPHAN RECORDS IN PAYMENT ITEMS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9669',
      p_sig_id                 => 'ORPHAN RECORDS IN PAYMENT ITEMS',
      p_sig_sql                => 'SELECT 
 PAYMENT_ITEM_ID,
 DUE_DATE ,
 SET_OF_BOOKS_ID ,
 ...
 PERIOD_FRACTION
FROM
 pn_payment_items_all ppa
 where ppa.org_id=##$$ORG_ID$$##
  and NVL(ppa.EXPORT_TO_AP_FLAG,''N'') <> ''Y''
and
 ppa.payment_term_id NOT IN
 (
   SELECT
     ppt.payment_term_id
   FROM
     pn_payment_terms_all  ppt
     where ppt.org_id=ppa.org_id
 )',
      p_title                  => 'Orphan Records in Payment Items',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Orphan records exist in PN_PAYMENT_ITEMS_ALL table. This can cause Authorize Billing or Payment schedule screen showing incorrect amount for a billing/Payment schedule for the lease.',
      p_solution               => 'Follow instructions from [561036/KB684207] - The Authorize Billing/Payment Schedule Screen Shows Incorrect Amount For Billing/Payment Schedules and provide SQL output.',
      p_success_msg            => 'No orphan records found in PN_PAYMENT_ITEMS_ALL table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: ORPHAN RECORDS IN PAYMENT ITEMS');



debug('begin add_signature: TRANSACTIONS IN CLOSED PERIOD NOT TRANSFERRED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9670',
      p_sig_id                 => 'TRANSACTIONS IN CLOSED PERIOD NOT TRANSFERRED',
      p_sig_sql                => 'select xah.event_id,xah.ae_header_id,glp.period_name, xah.upg_batch_id,xah.ledger_id
 ...
 and glp.closing_status in (''C'', ''P'')',
      p_title                  => 'Transactions in Closed Period Not Transferred',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transactions in closed period not transferred. This can cause reconciliation difference between general ledger and property manager.
',
      p_solution               => 'Follow instructions from [2385664/KB163051] How to Fix the 95325 in Create Accounting For Property Manager SLA Events?',
      p_success_msg            => 'No untransferred transactions found in closed period.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: TRANSACTIONS IN CLOSED PERIOD NOT TRANSFERRED');



debug('begin add_signature: PN_EQUIP_CLOSED_GL_PERIOD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15619',
      p_sig_id                 => 'PN_EQUIP_CLOSED_GL_PERIOD',
      p_sig_sql                => 'select pl.lease_num,xe.event_id
from PN_EQP_LEASES_ALL pl,
xla_events xe,
PN_ACCT_TRX_HEADERS_ALL pah
where  xe.event_status_code =''U''
and xe.application_id=##$$APPS_PARAM1$$##
and xe.event_id=pah.EVENT_ID
and 	pl.org_id=##$$ORG_ID$$##
and pah.lease_id=pl.lease_id
and exists (
Select * from gl_period_statuses glp
where xe.event_date between glp.start_date and glp.end_date
and glp.application_id=101
and glp.closing_status IN (''C'',''P''))',
      p_title                  => 'Equipment GL Period is Closed',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found Equipment leases where GL period is closed. This is data corruption and needs a fix.',
      p_solution               => 'Please log a data fix Service Request with Oracle Support.',
      p_success_msg            => 'Found no Equipment leases where GL period is closed.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_EQUIP_CLOSED_GL_PERIOD');



debug('begin add_signature: PN_EQUIP_UNPROCESSED_EVENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15623',
      p_sig_id                 => 'PN_EQUIP_UNPROCESSED_EVENTS',
      p_sig_sql                => 'select pl.lease_num,xe.event_id,pah.TRANSACTION_TYPE,pah.TRANSACTION_NUMBER,xe.event_date,pah.REGIME_CODE
from PN_EQP_LEASES_ALL pl, xla_events xe, PN_ACCT_TRX_HEADERS_ALL pah
where  xe.event_status_code =''U''
and xe.application_id=##$$APPS_PARAM1$$##
and 	pl.org_id=##$$ORG_ID$$##
and xe.event_id=pah.EVENT_ID
and pah.lease_id=pl.lease_id',
      p_title                  => 'Equipment Lease Unprocessed Events are Present',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found Equipment Lease with unprocessed events. This is data corruption and needs a fix.',
      p_solution               => 'Please log a data fix Service Request with Oracle Support.',
      p_success_msg            => 'Found no Equipment Lease with unprocessed events.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_EQUIP_UNPROCESSED_EVENTS');



debug('begin add_signature: PN_IFRS_CLOSED_GL_PERIOD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15618',
      p_sig_id                 => 'PN_IFRS_CLOSED_GL_PERIOD',
      p_sig_sql                => 'select pl.lease_num,xe.event_id
...
and glp.application_id=101
and glp.closing_status IN (''C'',''P''))',
      p_title                  => 'IFRS GL Period is Closed',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found IFRS leases where GL period is closed. This is data corruption and needs a fix.',
      p_solution               => 'Please log a data fix Service Request with Oracle Support.',
      p_success_msg            => 'Found no IFRS leases where GL period is closed.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_IFRS_CLOSED_GL_PERIOD');



debug('begin add_signature: PN_IFRS_UNPROCESSED_EVENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15622',
      p_sig_id                 => 'PN_IFRS_UNPROCESSED_EVENTS',
      p_sig_sql                => 'select pl.lease_num,xe.event_id,pah.TRANSACTION_TYPE,pah.TRANSACTION_NUMBER,xe.event_date,pah.REGIME_CODE
from pn_leases_all pl, xla_events xe, PN_ACCT_TRX_HEADERS_ALL pah
where  xe.event_status_code =''U''
and xe.application_id=##$$APPS_PARAM1$$##
and pl.org_id=##$$ORG_ID$$##
and xe.event_id=pah.EVENT_ID
and pah.lease_id=pl.lease_id',
      p_title                  => 'IFRS Lease Unprocessed Events are Present',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found IFRS Lease with unprocessed events. This is data corruption and needs a fix.',
      p_solution               => 'Please log a data fix Service Request with Oracle Support.',
      p_success_msg            => 'Found No IFRS Lease with unprocessed events.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_IFRS_UNPROCESSED_EVENTS');



debug('begin add_signature: PN_ITEM_EXP_NORM_NOT_GENERATED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15580',
      p_sig_id                 => 'PN_ITEM_EXP_NORM_NOT_GENERATED',
      p_sig_sql                => 'select pl.lease_num,pt.payment_term_id,pi.due_date
       from pn_leases_all pl,
       pn_payment_terms_all pt,
       PN_PAYMENT_ITEMS_ALL pi
       where pl.lease_id=pt.lease_id
       and pt.normalize=''Y''
	   and pl.org_id=##$$ORG_ID$$##
       and pt.payment_term_id=pi.payment_term_id
       and pi.payment_item_type_lookup_code=''NORMALIZED''
       and pi.xla_event_id is null
       and exists (select * from PN_PAYMENT_ITEMS_ALL pi1
       where pt.payment_term_id=pi1.payment_term_id
       and pi.payment_schedule_id=pi1.payment_schedule_id
       and pi1.payment_item_type_lookup_code=''CASH''
       and pi1.transferred_to_ap_flag =''Y'')',
      p_title                  => 'Payment items export and accounted flag is enabled but normalized event id is not generated',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found payment items export and accounted flag is enabled but normalized event id is not generated . This is data corruption and needs a fix.',
      p_solution               => 'Please log a data fix Service Request with Oracle Support.
',
      p_success_msg            => 'Found no payment items export and accounted flag being enabled with no normalized event_id generated.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_ITEM_EXP_NORM_NOT_GENERATED');



debug('begin add_signature: PN_PREV_PER_UNPROCESS_NOR_EVENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15579',
      p_sig_id                 => 'PN_PREV_PER_UNPROCESS_NOR_EVENTS',
      p_sig_sql                => 'select pl.lease_num,xe.event_id
from pn_leases_all pl,
xla_events xe,
PN_PAYMENT_ITEMS_ALL ppia,
...
and glp.closing_status IN (''C'',''P'')
      ...
      p_title                  => 'Previous Period Normalized Events are in Unprocessed Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found previous unprocessed normalization events. This is data corruption and needs a fix.',
      p_solution               => 'Please log a data fix Service Request with Oracle Support.
',
      p_success_msg            => 'Found no previous unprocessed normalization events.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_PREV_PER_UNPROCESS_NOR_EVENTS');



debug('begin add_signature: PN_SCH_MISSING_TERM');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15578',
      p_sig_id                 => 'PN_SCH_MISSING_TERM',
      p_sig_sql                => 'select pl.lease_num, pt.payment_term_id 
from 
pn_leases_all pl,
pn_payment_terms_all pt
where pl.lease_id=pt.lease_id
and pl.status=''F''
and pl.org_id=##$$ORG_ID$$##
and not exists (select  distinct pi.payment_term_id from pn_payment_items_all pi
where pi.payment_term_id=pt.payment_term_id
and pi.org_id=pt.org_id)',
      p_title                  => 'Schedules Missing for a Term',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found schedules missing for a term for a lease. This is data corruption and needs a fix.',
      p_solution               => 'Please log a data fix Service Request with Oracle Support.
',
      p_success_msg            => 'Found no schedules missing for any term.
',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PN_SCH_MISSING_TERM');



debug('begin add_signature: PN_STALE_TABLE_STATS');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##table_name'):= 'left,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '19531',
      p_sig_id                 => 'PN_STALE_TABLE_STATS',
      p_sig_sql                => 'select table_name, stale_stats, last_analyzed
from dba_tab_statistics
where stale_stats=''YES''
and (table_name like ''PN%''
or table_name like ''GL%''
or table_name like ''XLA%'')
order by table_name, last_analyzed',
      p_title                  => 'PN Stale Table Stats',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Stale Table Stats were found and needs optimization for tables in Property Manager, General Ledger and Subledger.',
      p_solution               => 'For optimal performance run "Gather Schema Statistics" concurrent process for the affected schemas.
',
      p_success_msg            => 'No Stale Table Stats were found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_STALE_TABLE_STATS');



debug('begin add_signature: PN_TABLESPACE_ISSUE');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##TableSpace Name'):= 'left,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '19529',
      p_sig_id                 => 'PN_TABLESPACE_ISSUE',
  ...
  order  by ((a.BYTES-b.BYTES)/a.BYTES) desc',
      p_title                  => ' Potential Tablespace Issue',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The objects listed above have 3% or less tablespace free and will create performance issues.',
      p_solution               => '<p>Review items indicated and add additional data files to the tablespace as required.</p>
<p><a href="https://docs.oracle.com/en/database/oracle/oracle-database/21/admin/managing-tablespaces.html">Guidelines for Managing Tablespaces</a></p>',
   ...
   l_info.delete;
debug('end add_signature: PN_TABLESPACE_ISSUE');



debug('begin add_signature: PN_OBJECT_LOCK');
   l_info('##MASK##A.ORACLE_USERNAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##A.OS_USER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##B.OWNER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('##STYLE##b.object_name'):= 'left,#333333,#FFE864,bold';
  add_signature(
      p_sig_repo_id            => '19532',
      p_sig_id                 => 'PN_OBJECT_LOCK',
      p_sig_sql                => 'SELECT b.owner
     , b.object_name
     , a.oracle_username
     , a.os_user_name
...
and (object_name like ''PN%''
           or object_name like ''XLA%'')
order by b.object_name',
      p_title                  => ' PN Object Lock',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Table locks were found for Property Manager and Subledger Tables and may lead to performance issue.',
      p_solution               => 'Please check if there are any transactions or concurrent programs in progress which has caused object locks, if not report it to DBA.',
      p_success_msg            => 'No table locks are found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_OBJECT_LOCK');



debug('begin add_signature: PN_GATHER_STATS_RUN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19530',
      p_sig_id                 => 'PN_GATHER_STATS_RUN',
      p_sig_sql                => 'SELECT Decode(substr(UPPER(ARGUMENT_TEXT),1,3),''PN'', ''PN'', ''GL,'', ''GL'',''XDO'',''XDO'', substr(UPPER(ARGUMENT_TEXT),1,3)) "Schema",
...
FND_LOOKUP_VALUES PHAS
	...
	AND substr(UPPER(ARGUMENT_TEXT),1,3) in (''ALL'',''GL,'', ''PN'',''XDO'' )
...
order by ACTUAL_COMPLETION_DATE desc',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Gather schema statistics was not run for  Property Manager, Subledger or General Ledger Schema in last 30 days.',
      p_solution               => 'In order to schedule the program, use [419728/KB627293] Concurrent Processing - How To Gather Statistics On Oracle Applications Release 11i and/or Release 12 - Concurrent Process, Temp Tables, Manually. 
This warning can be ignored if gather stats was run using command Prompt.',
      p_success_msg            => 'Gather statistics was run in last 30 days. No Stale Stats exists.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_GATHER_STATS_RUN');



debug('begin add_signature: EBS_FIN_FA_INSTANCE_OVERVIEW');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31654',
      p_sig_id                 => 'EBS_FIN_FA_INSTANCE_OVERVIEW',
...
union
SELECT distinct ''Forms Server = '' || extractValue(XMLType(TEXT),''//forms_version[@oa_var="s_forms_version"]'') FROM fnd_oam_context_files WHERE name NOT IN (''TEMPLATE'',''METADATA'') AND (status IS NULL OR status !=''H'') AND CTX_TYPE IN (''A'')and rownum=1
union
...
union
SELECT ''Product status: Oracle Assets (OFA) is '' || L.MEANING
...
AND (b.APPLICATION_ID = ''140'')
AND (L.LOOKUP_TYPE = ''FND_PRODUCT_STATUS'')
AND (L.LOOKUP_CODE = I.Status)
AND t.language = ''US'' AND l.language = ''US''
union
SELECT ''Product status: Oracle Property Manager (PN) is '' || L.MEANING
FROM fnd_application b, fnd_application_tl t, FND_PRODUCT_INSTALLATIONS I, fnd_lookup_values L
WHERE (b.APPLICATION_ID = I.APPLICATION_ID)
AND b.application_id = t.application_id
AND (b.APPLICATION_ID = ''240'')
AND (L.LOOKUP_TYPE = ''FND_PRODUCT_STATUS'')
AND (L.LOOKUP_CODE = I.Status)
AND t.language = ''US'' AND l.language = ''US''
union
...
SELECT ''Multi Currency = '' || MULTI_CURRENCY_FLAG FROM FND_PRODUCT_GROUPS',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_INSTANCE_OVERVIEW');



debug('begin add_signature: EBS_FIN_FA_PNANALYZER_APPSCHECK_PLSQL_FILE_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30164',
      p_sig_id                 => 'EBS_FIN_FA_PNANALYZER_APPSCHECK_PLSQL_FILE_VERSIONS',
...
--and   (o.object_name like substr(''##$$FK2$$##'',2,2)||''%'' escape ''\'') 
and (o.object_name like ''##$$FK2$$##%'')
...
order by 1, 3 desc, 5 desc',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PNANALYZER_APPSCHECK_PLSQL_FILE_VERSIONS');



debug('begin add_signature: EBS_FIN_FA_PNANALYZER_APPSCHECK_OTHER_FILE_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30163',
      p_sig_id                 => 'EBS_FIN_FA_PNANALYZER_APPSCHECK_OTHER_FILE_VERSIONS',
...
order by
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PNANALYZER_APPSCHECK_OTHER_FILE_VERSIONS');



debug('begin add_signature: EBS_FIN_FA_PNANALYZER_APPSCHECK_INVALID_PLSQL_FILE_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30165',
      p_sig_id                 => 'EBS_FIN_FA_PNANALYZER_APPSCHECK_INVALID_PLSQL_FILE_VERSIONS',
...
order by 1, 3 desc, 5 desc',
      ...
      p_solution               => '<p>The invalid object(s) might not be the root cause to your problem(s) but it is suggested to review the list. They may not impact your task, but it is advisable to review and address them as follows:<br>
<ul>
...
<li>If you still have invalid objects, please review steps from [1325394/KB401905] Troubleshooting Guide - Invalid Objects in the E-Business Suite Environment 11i and 12</li>
      ...
      p_success_msg            => 'No related invalid objects exists in the database.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PNANALYZER_APPSCHECK_INVALID_PLSQL_FILE_VERSIONS');



debug('begin add_signature: EBS_FIN_FA_PNANALYZER_APPSCHECK_FILE_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30162',
      p_sig_id                 => 'EBS_FIN_FA_PNANALYZER_APPSCHECK_FILE_VERSIONS',
      p_sig_sql                => 'SELECT tl.Application_name, 
       b.application_short_name,
       b.application_id "##$$FK1$$##",
       b.product_code "##$$FK2$$##"
FROM fnd_application_tl tl, fnd_application b
WHERE b.application_id = ##$$APPS_PARAM1$$##
AND tl.application_id = b.application_id
AND tl.language = ''US''',
      p_title                  => 'Versions and Invalid objects (PN Product Only)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => '  ',
      p_solution               => '',
      p_success_msg            => '',
      ...
      p_limit_rows             => nvl('N','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('EBS_FIN_FA_PNANALYZER_APPSCHECK_PLSQL_FILE_VERSIONS','EBS_FIN_FA_PNANALYZER_APPSCHECK_OTHER_FILE_VERSIONS','EBS_FIN_FA_PNANALYZER_APPSCHECK_INVALID_PLSQL_FILE_VERSIONS'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '2'
      );
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PNANALYZER_APPSCHECK_FILE_VERSIONS');



debug('begin add_signature: EBS_FIN_FA_PNANALYZER_APPSCHECK_PLSQL_FILE_VERSIONS_2');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30168',
      p_sig_id                 => 'EBS_FIN_FA_PNANALYZER_APPSCHECK_PLSQL_FILE_VERSIONS_2',
      p_sig_sql                => 'select o.object_name,
       substr(ltrim(rtrim(substr(substr(s.text, instr(s.text,''Header: '')),
                                    instr(substr(s.text, instr(s.text,''Header: '')), '' '', 1, 1),
                                    instr(substr(s.text, instr(s.text,''Header: '')), '' '', 1, 2) -
...
order by 1, 3 desc, 5 desc',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PNANALYZER_APPSCHECK_PLSQL_FILE_VERSIONS_2');



debug('begin add_signature: EBS_FIN_FA_PNANALYZER_APPSCHECK_OTHER_FILE_VERSIONS_2');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30167',
      p_sig_id                 => 'EBS_FIN_FA_PNANALYZER_APPSCHECK_OTHER_FILE_VERSIONS_2',
      p_sig_sql                => 'select distinct
   af.filename,
   substr(af.filename, instr(af.filename, ''.'') + 1) ext,
   af.app_short_name,
...
order by
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PNANALYZER_APPSCHECK_OTHER_FILE_VERSIONS_2');



debug('begin add_signature: EBS_FIN_FA_PNANALYZER_INVALID_PLSQL_FILE_VERSIONS_2');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30169',
      p_sig_id                 => 'EBS_FIN_FA_PNANALYZER_INVALID_PLSQL_FILE_VERSIONS_2',
      p_sig_sql                => 'select distinct o.object_name,
       substr(ltrim(rtrim(substr(substr(s.text, instr(s.text,''Header: '')),
                                    instr(substr(s.text, instr(s.text,''Header: '')), '' '', 1, 1),
                                    instr(substr(s.text, instr(s.text,''Header: '')), '' '', 1, 2) -
...
<li>If you still have invalid objects, please review steps from [1325394/KB401905] Troubleshooting Guide - Invalid Objects in the E-Business Suite Environment 11i and 12</li>
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PNANALYZER_INVALID_PLSQL_FILE_VERSIONS_2');



debug('begin add_signature: EBS_FIN_FA_PNANALYZER_APPSCHECK_FILE_VERSIONS_2');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30166',
      p_sig_id                 => 'EBS_FIN_FA_PNANALYZER_APPSCHECK_FILE_VERSIONS_2',
      p_sig_sql                => 'SELECT tl.Application_name, 
       b.application_short_name,
       b.application_id "##$$FK1$$##",
       b.product_code "##$$FK2$$##"
FROM fnd_application_tl tl, fnd_application b
WHERE b.application_id in (##$$APPS_PARAM2$$##,##$$APPS_PARAM3$$##,##$$APPS_PARAM4$$##,##$$APPS_PARAM5$$##)
AND tl.application_id = b.application_id
AND tl.language = ''US''
order by 1',
      p_title                  => 'File Versions and Invalid objects (For Other Products)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => '  ',
      p_solution               => '',
      p_success_msg            => '',
      ...
      p_limit_rows             => nvl('N','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('EBS_FIN_FA_PNANALYZER_APPSCHECK_PLSQL_FILE_VERSIONS_2','EBS_FIN_FA_PNANALYZER_APPSCHECK_OTHER_FILE_VERSIONS_2','EBS_FIN_FA_PNANALYZER_INVALID_PLSQL_FILE_VERSIONS_2'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '2'
      );
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PNANALYZER_APPSCHECK_FILE_VERSIONS_2');



debug('begin add_signature: PN_APPSCHECK_PRODUCT_PROFILE_VALUES');
   l_info('##MASK##USER'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9693',
      p_sig_id                 => 'PN_APPSCHECK_PRODUCT_PROFILE_VALUES',
      p_sig_sql                => 'Select fpon.profile_option_name "Profile Option Name"
,site_pov.profile_option_value "Site"
,appl_pov.profile_option_value "Application"
,resp_pov.profile_option_value "Responsibility"
,user_pov.profile_option_value "User" 
from fnd_profile_options fpon, fnd_profile_option_values user_pov
        ...
        and fpon.application_id like ##$$FK3$$##
        and resp_pov.LEVEL_VALUE(+) = FND_GLOBAL.RESP_ID
        and user_pov.LEVEL_VALUE(+) = FND_GLOBAL.USER_ID
...
ORDER BY fpon.profile_option_name
...
*/',
   ...
   l_info.delete;
debug('end add_signature: PN_APPSCHECK_PRODUCT_PROFILE_VALUES');



debug('begin add_signature: PN_APPSCHECK_PROFILE_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9694',
      p_sig_id                 => 'PN_APPSCHECK_PROFILE_OPTIONS',
      p_sig_sql                => 'SELECT tl.Application_name, b.application_short_name,
            b.application_id "##$$FK3$$##",
            b.product_code "##$$FK4$$##"
      FROM fnd_application_tl tl, fnd_application b
      WHERE b.application_id in (##$$APPS_PARAM1$$##)
        AND tl.application_id = b.application_id
        AND tl.language = ''US''',
      ...
      p_limit_rows             => nvl('N','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('PN_APPSCHECK_PRODUCT_PROFILE_VALUES'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '13'
      );
   l_info.delete;
debug('end add_signature: PN_APPSCHECK_PROFILE_OPTIONS');
...
debug('begin add_signature: PN_FORM_PERSONALIZATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19528',
      p_sig_id                 => 'PN_FORM_PERSONALIZATION',
      p_sig_sql                => 'select a.form_name||''.fmb'' "Form Name", 
a.function_name "Function Name", 
a.sequence "Sequence", 
a.description "Description",
 a.rule_type "Rule Type", 
decode(a.enabled,''N'',''Not Enabled'', ''Y'', ''Enabled'', a.enabled) "Forms Personalization",
a.trigger_event "Trigger", 
t.sequence "Action Seq",
t.action_type "Action Type",
 t.enabled "Action Enabled", 
 t.object_type "Object Type",
 t.target_object "Target Object"  
from fnd_form_custom_actions t,
fnd_form_custom_rules a
where t.rule_id=a.id
and ( a.form_name like ''PN%'')
order by a.form_name,a.sequence,t.sequence ',
      p_title                  => 'PN Forms Personalization',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Form Personalization Details not found.',
      p_solution               => 'This section is a data collection of Form Personalization Details ( Oracle Applications) from Database as per<br>
[395117/KB716220] Oracle Forms Personalization in Oracle E-Business Suite (EBS)',
      p_success_msg            => 'Form Personalization Details found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PN_FORM_PERSONALIZATION');
...
debug('begin add_signature: PN_IFRS_RESOURCEGUIDE');
   l_info('##SHOW_SQL##'):= 'N';
  add_signature(
      p_sig_repo_id            => '18768',
      p_sig_id                 => 'PN_IFRS_RESOURCEGUIDE',
      p_sig_sql                => 'select 1 from dual',
      p_title                  => 'IFRS resources',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'IFRS resources',
      p_solution               => '<p>Documents intended to provide details and instruction of how to accommodate the financial environment in Property Manager module in order to be compliant to IFRS Regime 
and also provides the expected calculation scenarios when different types of transactions, under the IFRS and Equipment lease Regime, are performed.</p>

IFRS useful reference documents:<br>
<p>
<ol>
<li>[2396463/KB695363] - Sub Ledger Accounting Configuration for IFRS16 and ASC842 Accounting from Property Manager including Equipment</li>
<li>[2478166/KB755833] - IFRS & Equipment Lease - Amendment Functionality and Scenario''s</li>
<li>[2470955/KB468087] - Property Manager IFRS Data Model (Operating Lease)</li>
</ol>
</p>',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: PN_IFRS_RESOURCEGUIDE');



debug('begin add_signature: PN_IFRS_TRANSITIONPROCGUIDE');
   l_info('##SHOW_SQL##'):= 'N';
  add_signature(
      p_sig_repo_id            => '18767',
      p_sig_id                 => 'PN_IFRS_TRANSITIONPROCGUIDE',
      p_sig_sql                => 'select 1 from dual',
      p_title                  => 'Transition process guidelines',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transition process guidelines',
      p_solution               => '<p>Document intended to provide the details of steps to be followed to migrate the existing leases to IFRS regime.</p>

Refer to:<br>
[2497968/KB730330] - IFRS - Transition Process to Migrate the Existing Leases to IFRS Regime',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PN_IFRS_TRANSITIONPROCGUIDE');



debug('begin add_signature: PN_PERIOD_CLOSE');
   l_info('##SHOW_SQL##'):= 'N';
  add_signature(
      p_sig_repo_id            => '18765',
      p_sig_id                 => 'PN_PERIOD_CLOSE',
      p_sig_sql                => 'select 1 from dual',
      p_title                  => 'Period Close Process',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Period Close Process',
      p_solution               => '<p>Document intended to provide details of period closure process / Activities that need to be followed for the IFRS and Equipment lease Regimes.</p>

Refer to:<br>
[2482582/KB265943] - IFRS & Equipment Lease - Period Closure Process Document',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PN_PERIOD_CLOSE');



debug('begin add_signature: PN_IFRS_TROUBLESHOOTINGGUIDE');
   l_info('##SHOW_SQL##'):= 'N';
  add_signature(
      p_sig_repo_id            => '18766',
      p_sig_id                 => 'PN_IFRS_TROUBLESHOOTINGGUIDE',
      p_sig_sql                => 'select 1 from dual',
      p_title                  => 'IFRS Trouble Shooting Guide',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'IFRS Compliance & Equipment Lease - Trouble Shooting Guide',
      p_solution               => '<p>This Trouble Shooting Guide documents how to resolve commonly faced issues in Property Manager IFRS Compliance and Equipment Lease</p>

Refer to:<br>
[2459804/KB664583] - Property Manager IFRS Compliance and Equipment Lease - Trouble Shooting Guide',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PN_IFRS_TROUBLESHOOTINGGUIDE');



debug('begin add_signature: PN_API_SCRIPTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '18764',
      p_sig_id                 => 'PN_API_SCRIPTS',
      p_sig_sql                => 'select 1 from dual',
      p_title                  => 'API Documentation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Property Manager API Documentation Supplement List',
      p_solution               => '<p>API documents intended use is for users who are well versed in PL/SQL and are interested in using the APIs directly rather than creating/updating Property Manager via different forms.</p>

<p><b>Property Manager API Documentation Supplement List:</b></p>
<p>
<ol>
<li>[2655705/KB473174] - Oracle Property Manager Property Lease API Documentation Supplement</li>
<li>[2666681/KB637010] - Oracle Property Manager Equipment Lease API Documentation Supplement</li>
<li>[2653625/KB606870] - Oracle Property Manager Variable Rent API Documentation Supplement</li>
<li>[2659220/KB280550] - Oracle Property Manager Rent Increase API Documentation Supplement</li>
<li>[2944817/KB522850] - Oracle Property Manager Lease Versioning Property Lease API Documentation Supplement</li>
<li>[2990040/KB471285] - Oracle Property Manager Lease Versioning Equipment Lease API Documentation Supplement</li>
<li>[3007963/KB257519] - Oracle Property Manager Statements of Federal Financial Accounting Standards 54(SFFAS 54) API Documentation Supplement</li>
<li>[2066548/KB497249] - Property Manager Create/Update Variable Rent APIs Technical Brief</li>
</ol>
</p>
',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: PN_API_SCRIPTS');
...
debug('begin add_signature: EBS_FIN_FA_PN_LEASE_VIEW_TRANSACTIONS_PAGE_ERROR_2968230_1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26461',
      p_sig_id                 => 'EBS_FIN_FA_PN_LEASE_VIEW_TRANSACTIONS_PAGE_ERROR_2968230_1',
...
((''12.2'' = substr(''##$$REL$$##'',1,4) AND
            Fnd_Irep_Loader_Private.Compare_Versions(
              Adfv.Version,''120.0.12020000.7'') = ''<''
             And Adf.Filename = ''QueryHeaderVOImpl.class'' 
             And Adfv.Version in (
  select "Current Version" from (
        ...
        and af1.filename in (''QueryHeaderVOImpl.class'')
         )
         where rankUS = 1))
    OR
           (''12.2'' = substr(''##$$REL$$##'',1,4) AND
            Fnd_Irep_Loader_Private.Compare_Versions(
              Adfv.Version,''120.0.12020000.11'') = ''<'' 
             And Adf.Filename = ''InqueryHeaderCO.class''
             And Adfv.Version in (
  select "Current Version" from (
        select afv1.version "Current Version", rank()over(partition by af1.filename order by afv1.version_segment1 desc,
                          afv1.version_segment2 desc, afv1.version_segment3 desc, afv1.version_segment4 desc, afv1.version_segment5 desc, afv1.version_segment6 desc, afv1.version_segment7 desc,
          ...
          from ad_files af1, ad_file_versions afv1
        where af1.file_id = afv1.file_id
        and af1.filename in (''InqueryHeaderCO.class'')
         )
         where rankUS = 1))
    OR
           (''12.2'' = substr(''##$$REL$$##'',1,4) AND
            Fnd_Irep_Loader_Private.Compare_Versions(
              Adfv.Version,''120.0.12020000.17'') = ''<'' 
             And Adf.Filename = ''QueryPG.xml''
             And Adfv.Version in (
  select "Current Version" from (
        select afv1.version "Current Version", rank()over(partition by af1.filename order by afv1.version_segment1 desc,
                          afv1.version_segment2 desc, afv1.version_segment3 desc, afv1.version_segment4 desc, afv1.version_segment5 desc, afv1.version_segment6 desc, afv1.version_segment7 desc,
          ...
          from ad_files af1, ad_file_versions afv1
        where af1.file_id = afv1.file_id
        and af1.filename in (''QueryPG.xml'')
         )
         where rankUS = 1))
)',
      p_title                  => 'View Transactions Page Errors with "Lease Number - Select a Valid Value" for Leases with Multiple Locations',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'In View Transactions page the following issue was identified:<br><br>
When user try to choose lease number which has more than 1 location code or more than the same lease name,<br>
system does not pick the lease and error message appears:<br><br>

ERROR<br>
-----------------------<br>
"Lease Number - Select a valid value"<br>',
      p_solution               => '<ul>
<li>Apply patch {34091953}:R12.FND.C and patch {35482427}:R12.PN.C, if not applied.</li>
<li>Please follow solution in [2968230/KB769527] - View Transactions Page Error "Lease Number - Select a Valid Value" When Querying for Leases with Multiple Locations</li>
</ul>',
      p_success_msg            => 'Have code level fix per [2968230/KB769527] - View Transactions Page Error "Lease Number - Select a Valid Value" When Querying for Leases with Multiple Locations',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FA_PN_LEASE_VIEW_TRANSACTIONS_PAGE_ERROR_2968230_1');
...
BEGIN
  ...
  analyzer_title := 'Property Manager Analyzer';
...
debug('begin section: Recommended_Patches');
IF ((substr(g_rep_info('Apps Version'),1,4) = '12.1')OR (substr(g_rep_info('Apps Version'),1,4) = '12.2')) THEN
   start_section('Recommended Patches', 'Recommended_Patches');
      set_item_result(check_rec_patches_1); /* Signature PN_CHECK_REC_PATCHES */
   end_section;
END IF;
debug('end section: Recommended_Patches');

debug('begin section: Setup_Profiles');
start_section('Setup and Profiles', 'Setup_Profiles');
   set_item_result(run_stored_sig('PN_PROFILES'));
   set_item_result(run_stored_sig('PN_DEBUG_MODE'));
   set_item_result(run_stored_sig('PN_USE_LEASE_APPROVAL_WORKFLOW'));
   set_item_result(run_stored_sig('PN_SYSTEM_SETUP_OPTIONS'));
   set_item_result(run_stored_sig('CHG_TRANS_DATE'));
   set_item_result(run_stored_sig('PN_PRODUCT_INSTALL_STATUS'));
   set_item_result(run_stored_sig('EBS_FIN_FA_PNANALYZER_PN_GL_CALENDAR_INFO'));
end_section;
debug('end section: Setup_Profiles');

debug('begin section: Main_Lease');
IF nvl(g_sql_tokens('##$$LEASE_NUM$$##'),'No Lease') <> 'No Lease' THEN
   start_section('Main Lease', 'Main_Lease');
      set_item_result(run_stored_sig('PN_LEASES_ALL'));
      set_item_result(run_stored_sig('PN_LEASE_CHANGES_ALL'));
      set_item_result(run_stored_sig('PN_LEASE_DETAILS_ALL'));
      set_item_result(run_stored_sig('PN_DISTRIBUTIONS_ALL'));
      set_item_result(run_stored_sig('PN_DISTRIBUTIONS_HISTORY'));
      set_item_result(run_stored_sig('PN_LEASE_DETAILS_HISTORY'));
      set_item_result(run_stored_sig('PN_LEASE_TRANSACTIONS_ALL'));
      set_item_result(run_stored_sig('PN_TENANCIES_ALL'));
      set_item_result(run_stored_sig('PN_PAYMENT_ITEMS_ALL'));
      set_item_result(run_stored_sig('PN_PAYMENT_SCHEDULES_ALL'));
      set_item_result(run_stored_sig('PN_PAYMENT_TERMS_ALL'));
      set_item_result(run_stored_sig('PN_PAYMENT_ITEM_DIST_ALL'));
      set_item_result(run_stored_sig('PN_OPTIONS_HISTORY'));
      set_item_result(run_stored_sig('PN_OPTIONS_ALL'));
      set_item_result(run_stored_sig('PN_OPTION_PERIODS_ALL'));
      set_item_result(run_stored_sig('PN_OPTION_ITEMS_ALL'));
      set_item_result(run_stored_sig('EBS_FIN_FA_PNANALYZER_PN_SCHEDULES_OUTPUT'));
      IF (substr(g_rep_info('Apps Version'),1,4) = '12.2') THEN
         set_item_result(run_stored_sig('EBS_FIN_FA_PN_LEASE_VIEW_TRANSACTIONS_PAGE_ERROR_2968230_1'));
      END IF;
   end_section;
END IF;
debug('end section: Main_Lease');

debug('begin section: Rent_Increase');
IF nvl(g_sql_tokens('##$$LEASE_NUM$$##'),'No Lease') <> 'No Lease' THEN
   start_section('Rent Increase', 'Rent_Increase');
      set_item_result(run_stored_sig('PN_LEASES_ALL'));
      set_item_result(run_stored_sig('PN_INDEX_EXCLUDE_TERM_ALL'));
      set_item_result(run_stored_sig('PN_INDEX_HISTORY_HEADERS'));
      set_item_result(run_stored_sig('PN_INDEX_LEASES_ALL'));
      set_item_result(run_stored_sig('PN_INDEX_LEASE_CONSTRAINTS_ALL'));
      set_item_result(run_stored_sig('PN_INDEX_LEASE_PERIODS_ALL'));
      set_item_result(run_stored_sig('EBS_FIN_FA_PNANALYZER_PN_INDEX_HISTORY_LINES'));
      set_item_result(run_stored_sig('EBS_FIN_FA_PNANALYZER_PN_INDEX_LEASE_TERMS_ALL'));
      set_item_result(run_stored_sig('EBS_FIN_FA_PNANALYZER_PN_RENT_INCREASE_DETAILACC_ITF'));
      set_item_result(run_stored_sig('EBS_FIN_FA_PNANALYZER_PN_RENT_INCREASE_DETAIL_ITF'));
      set_item_result(run_stored_sig('EBS_FIN_FA_PNANALYZER_PN_RENT_ROLL_LEASE_EXP_ITF'));
   end_section;
END IF;
debug('end section: Rent_Increase');

debug('begin section: Variable_Rent');
IF nvl(g_sql_tokens('##$$VAR_RENT_ID$$##'),'no variable rent') <> 'no variable rent' THEN
   start_section('Variable Rent', 'Variable_Rent');
      set_item_result(run_stored_sig('PN_VAR_RENTS_ALL'));
      set_item_result(run_stored_sig('PN_VAR_GRP_DATES_ALL'));
      set_item_result(run_stored_sig('PN_VAR_LINES_ALL'));
      set_item_result(run_stored_sig('PN_VAR_PERIODS_ALL'));
      set_item_result(run_stored_sig('PN_VAR_RENT_DATES_ALL'));
      set_item_result(run_stored_sig('PN_VAR_RENT_SUMM_ALL'));
      set_item_result(run_stored_sig('PN_VAR_TRX_HEADERS_ALL'));
      set_item_result(run_stored_sig('PN_VAR_TRX_DETAILS_ALL'));
      set_item_result(run_stored_sig('PN_VAR_BKPTS_HEAD_ALL'));
      set_item_result(run_stored_sig('PN_VAR_BKPTS_DET_ALL'));
      set_item_result(run_stored_sig('PN_VAR_RENT_INV_ALL'));
      set_item_result(run_stored_sig('PN_VAR_REPORT_DATES_ALL'));
   end_section;
END IF;
debug('end section: Variable_Rent');

debug('begin section: Property_Lease_Normalization');
start_section('Property Lease Normalization', 'Property_Lease_Normalization');
   set_item_result(run_stored_sig('PN_LEASES_ALL_N'));
   set_item_result(run_stored_sig('PN_LEASE_DETAILS_ALL_N'));
   set_item_result(run_stored_sig('PN_LEASE_CHANGES_ALL_N'));
   set_item_result(run_stored_sig('PN_PAYMENT_SCHEDULES_ALL_N'));
   set_item_result(run_stored_sig('PN_PAYMENT_TERMS_ALL_N'));
   set_item_result(run_stored_sig('PN_PAYMENT_ITEMS_ALL_N1'));
   set_item_result(run_stored_sig('PN_PAYMENT_ITEMS_ALL__N2'));
   set_item_result(run_stored_sig('EBS_FIN_FA_PNANALYZER_NORMALIZED_XLA_AE_HEADERS'));
   set_item_result(run_stored_sig('EBS_FIN_FA_PNANALYZER_NORMALIZED_XLA_EVENTS'));
   set_item_result(run_stored_sig('EBS_FIN_FA_PNANALYZER_NORMALZIED_XLA_AE_LINES'));
end_section;
debug('end section: Property_Lease_Normalization');

debug('begin section: IFRS');
IF ((substr(g_rep_info('Apps Version'),1,6) = '12.1.3') OR 
    (substr(g_rep_info('Apps Version'),1,4) = '12.2'))
 THEN
   start_section('IFRS', 'IFRS');
      set_item_result(run_stored_sig('EBS_FIN_FA_PNANALYZER_PN_STREAM_HEADER_LINES'));
      set_item_result(run_stored_sig('PN_LEASE_STREAM_TEMP'));
      set_item_result(run_stored_sig('PN_ACCT_TRX_HEADERS_LINES_INFO'));
      set_item_result(run_stored_sig('PN_LEASE_CHG_DETAILS'));
      set_item_result(run_stored_sig('PN_LEASE_ACCNT_TEMP'));
      ...
      set_item_result(run_stored_sig('PN_PMT_ITEM_PV_ALL'));
      set_item_result(run_stored_sig('PN_PMT_ITEM_PV_HIST'));
      set_item_result(run_stored_sig('PN_PMT_ITEM_PV_HST_CRRNCY_CHG'));
      set_item_result(run_stored_sig('PN_PMT_ITEM_PV_STREAM_ALL'));
      set_item_result(run_stored_sig('PN_PMT_ITM_AMTZ_HST_CRRNCY_CHG'));
      set_item_result(run_stored_sig('PN_INTEREST_INDEX_HEADERS'));
      set_item_result(run_stored_sig('PN_INTEREST_INDEX_LINES'));
      set_item_result(run_stored_sig('PN_LEASES_HIST'));
      set_item_result(run_stored_sig('PN_OPTION_PERIODS_HIST'));
      set_item_result(run_stored_sig('PN_OPTION_ITEMS_HIST'));
      set_item_result(run_stored_sig('PN_LEASE_DETAILS_HIST'));
      set_item_result(run_stored_sig('PN_PMT_ITEM_AMRTZN_ALL'));
      set_item_result(run_stored_sig('PN_PMT_ITEM_AMRTZN_HIST'));
      set_item_result(run_stored_sig('PN_PMT_ITEM_PV_GTT'));
      set_item_result(run_stored_sig('EBS_FIN_FA_PNANALYZER_PN_STREAM_ACD_BALANCE'));
      set_item_result(run_stored_sig('EBS_FIN_FA_PNANALYZER_PN_LEASE_ERRORS'));
      set_item_result(run_stored_sig('EBS_FIN_FA_PNANALYZER_PN_PAY_GROUP_CHANGES_ALL'));
   end_section;
END IF;
debug('end section: IFRS');

debug('begin section: Equipment_Lease');
IF ((substr(g_rep_info('Apps Version'),1,6) = '12.1.3') OR 
    (substr(g_rep_info('Apps Version'),1,4) = '12.2'))
 THEN
   start_section('Equipment Lease', 'Equipment_Lease');
      set_item_result(run_stored_sig('PN_EQP_LEASES_ALL'));
      set_item_result(run_stored_sig('PN_EQP_LEASE_CHANGES_ALL'));
      set_item_result(run_stored_sig('PN_EQP_LEASE_CHG_DETAILS'));
      set_item_result(run_stored_sig('PN_EQP_LEASE_DETAILS_HISTORY'));
      set_item_result(run_stored_sig('PN_EQP_PARTIES_ALL'));
      set_item_result(run_stored_sig('PN_EQP_ASSETS_ALL'));
      set_item_result(run_stored_sig('PN_EQP_PAYMENT_TERMS_ALL'));
      set_item_result(run_stored_sig('PN_EQP_OPTIONS_ALL'));
      set_item_result(run_stored_sig('PN_EQP_OPTIONS_HISTORY'));
      set_item_result(run_stored_sig('PN_EQP_ADJ_SUMMARIES'));
      set_item_result(run_stored_sig('PN_EQP_ADJUSTMENT_DETAILS'));
      set_item_result(run_stored_sig('PN_EQP_DISTRIBUTIONS_ALL'));
      set_item_result(run_stored_sig('PN_EQP_DISTRIBUTIONS_HISTORY'));
      set_item_result(run_stored_sig('PN_EQP_LEASE_TRANSACTIONS_ALL'));
      set_item_result(run_stored_sig('PN_EQP_OPTION_ITEMS_ALL'));
      set_item_result(run_stored_sig('PN_EQP_OPTION_PERIODS_ALL'));
      set_item_result(run_stored_sig('PN_EQP_PAYMENT_ITEMS_ALL'));
      set_item_result(run_stored_sig('PN_EQP_PAYMENT_SCHEDULES_ALL'));
      set_item_result(run_stored_sig('PN_EQP_NOTE_DETAILS'));
      set_item_result(run_stored_sig('PN_EQP_LEASE_DETAILS_ALL'));
      set_item_result(run_stored_sig('PN_EQP_ACCT_TRX_HEADERS_LINES'));
      set_item_result(run_stored_sig('XLA_EVENTS -EQP'));
      set_item_result(run_stored_sig('XLA_AE_HEADERS - EQP LEASE'));
      set_item_result(run_stored_sig('XLA_AE_LINES -EQP LEASE'));
      set_item_result(run_stored_sig('PN_EQP_LEASE_STREAM_TEMP'));
      set_item_result(run_stored_sig('PN_EQP_PMT_ITEM_PV_STREAM_ALL'));
      set_item_result(run_stored_sig('PN_EQP_SRN'));
      set_item_result(run_stored_sig('PN_EQP_SYSTEM_SETUP_OPTIONS'));
      set_item_result(run_stored_sig('PN_EQP_TERM_TEMPLATES_ALL'));
      set_item_result(run_stored_sig('PN_EQP_INTEREST_INDEX_HEADERS'));
      set_item_result(run_stored_sig('PN_EQP_INTEREST_INDEX_LINES'));
      set_item_result(run_stored_sig('EBS_FIN_FA_PNANALYZER_PN_STREAM_ACD_BALANCE'));
      set_item_result(run_stored_sig('EBS_FIN_FA_PNANALYZER_PN_LEASE_ERRORS'));
      set_item_result(run_stored_sig('EBS_FIN_FA_PNANALYZER_PN_EQP_PAYMENT_ITEM_DIST_ALL'));
      set_item_result(run_stored_sig('EBS_FIN_FA_PNANALYZER_PN_EQP_LEASE_ERRORS'));
      set_item_result(run_stored_sig('EBS_FIN_FA_PNANALYZER_PN_EQP_STREAM_HEADER_LINES'));
      set_item_result(run_stored_sig('EBS_FIN_FA_PNANALYZER_PN_EQP_PAY_GROUP_CHANGES_ALL'));
   end_section;
END IF;
debug('end section: Equipment_Lease');

debug('begin section: Equipment_Lease_Normalization');
IF ((substr(g_rep_info('Apps Version'),1,6) = '12.1.3') OR 
    (substr(g_rep_info('Apps Version'),1,4) = '12.2')) THEN
   start_section('Equipment Lease Normalization', 'Equipment_Lease_Normalization');
      set_item_result(run_stored_sig('EBS_FIN_FA_PNANALYZER_PN_EQP_PAYMENT_ITEMS_ALL_NOMRALIZED'));
      set_item_result(run_stored_sig('EBS_FIN_FA_PNANALYZER_PN_EQP_PAYMENT_ITEMS_ALL_SUM_NORMALIZE'));
      set_item_result(run_stored_sig('EBS_FIN_FA_PNANALYZER_XLA_EVENTS_EQUIP'));
      set_item_result(run_stored_sig('EBS_FIN_FA_PNANALYZER_XLA_AE_HEADERS_EQUIP_NORM'));
      set_item_result(run_stored_sig('EBS_FIN_FA_PNANALYZER_XLA_AE_LINES_EQUIP_NORM'));
   end_section;
END IF;
debug('end section: Equipment_Lease_Normalization');

debug('begin section: Data_Corruptions');
start_section('Known Issues', 'Data_Corruptions');
   set_item_result(run_stored_sig('ASSIGNABLE AREA IS NULL'));
   set_item_result(run_stored_sig('MISSING_AP_AR_TERM_ID_CUST_TRX_TYPE_ID'));
   set_item_result(run_stored_sig('ORPHAN RECORDS IN PAYMENT ITEMS'));
   set_item_result(run_stored_sig('TRANSACTIONS IN CLOSED PERIOD NOT TRANSFERRED'));
   set_item_result(run_stored_sig('PN_EQUIP_CLOSED_GL_PERIOD'));
   set_item_result(run_stored_sig('PN_EQUIP_UNPROCESSED_EVENTS'));
   set_item_result(run_stored_sig('PN_IFRS_CLOSED_GL_PERIOD'));
   set_item_result(run_stored_sig('PN_IFRS_UNPROCESSED_EVENTS'));
   set_item_result(run_stored_sig('PN_ITEM_EXP_NORM_NOT_GENERATED'));
   set_item_result(run_stored_sig('PN_PREV_PER_UNPROCESS_NOR_EVENTS'));
   set_item_result(run_stored_sig('PN_SCH_MISSING_TERM'));
end_section;
debug('end section: Data_Corruptions');

debug('begin section: PN_Performance_Checks');
start_section('Performance', 'PN_Performance_Checks');
   set_item_result(run_stored_sig('PN_STALE_TABLE_STATS'));
   set_item_result(run_stored_sig('PN_TABLESPACE_ISSUE'));
   set_item_result(run_stored_sig('PN_OBJECT_LOCK'));
   set_item_result(run_stored_sig('PN_GATHER_STATS_RUN'));
end_section;
debug('end section: PN_Performance_Checks');

debug('begin section: AppsCheck');
start_section('Diagnostics: Apps Check', 'AppsCheck');
   set_item_result(run_stored_sig('EBS_FIN_FA_INSTANCE_OVERVIEW'));
   set_item_result(run_stored_sig('EBS_FIN_FA_PNANALYZER_APPSCHECK_FILE_VERSIONS'));
   set_item_result(run_stored_sig('EBS_FIN_FA_PNANALYZER_APPSCHECK_FILE_VERSIONS_2'));
   set_item_result(run_stored_sig('PN_APPSCHECK_PROFILE_OPTIONS'));
   ...
   set_item_result(run_stored_sig('PN_FORM_PERSONALIZATION'));
   set_item_result(run_stored_sig('AC_DB_INFO'));
   set_item_result(run_stored_sig('AC_DB_PARAMETERS'));
end_section;
debug('end section: AppsCheck');

debug('begin section: PN_ToolBox');
start_section('<b>ToolBox</b> - Helpful IFRS guidelines, Tips and API Information', 'PN_ToolBox');
   set_item_result(run_stored_sig('PN_IFRS_RESOURCEGUIDE'));
   set_item_result(run_stored_sig('PN_IFRS_TRANSITIONPROCGUIDE'));
   set_item_result(run_stored_sig('PN_PERIOD_CLOSE'));
   set_item_result(run_stored_sig('PN_IFRS_TROUBLESHOOTINGGUIDE'));
   set_item_result(run_stored_sig('PN_API_SCRIPTS'));
end_section;
debug('end section: PN_ToolBox');
