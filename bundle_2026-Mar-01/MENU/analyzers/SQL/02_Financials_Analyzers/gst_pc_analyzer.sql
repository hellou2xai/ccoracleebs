...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for GST Period Close Analyzer              |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE gst_pc_analyzer_pkg AUTHID DEFINER AS
...
(            p_org_id                       IN NUMBER      DEFAULT NULL
           ...
           ,p_recon_report                 IN VARCHAR2    DEFAULT NULL
...
END gst_pc_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY gst_pc_analyzer_pkg AS
-- $Id: gst_pc_analyzer.sql, 200.11 2026/01/27 09:47:36 saananth Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2611916.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'GSTPC_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'GSTPC_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>GSTPC Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2611916.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/gst_pc_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,2315,EBS,EBS Financials,EBS - Financials Common Applications" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,2315,EBS,EBS Financials,EBS - Financials Common Applications" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},2315,EBS,EBS Financials,EBS - Financials Common Applications" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4302421" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">2315</span>
...
<p><strong>Version 200.11</strong></p><ol><li>Framework Changes (Doc ID to KB)</li>
<li>ATG and PREMIER SUPPORT SIG&apos;s&nbsp;</li>
<li>35 SIG&apos;s Solution Text are changed</li>
</ol>
<p><strong>Version 200.10</strong></p><ol><li>Framework Changes (Links Pointing to MOSFS instead of MOS,Patch Downloads)</li>
<li>Enhanced Signatures Related to Sequence</li>
</ol>
<p><strong>Version 200.9</strong></p><ol><li>New Analyzer Framework version 4.7.3 released with enhancements.<ul><li>SQL*Plus Error fixed: SP2-0027: Input is too long</li>
<li>Ability to click to select rows in output tables</li>
</ul>
</li>
<li>Enhanced 2 signatures.</li>
</ol>
<p><strong>Version 200.8</strong></p><ol><li>New Analyzer Framework version 4.7.1 released with enhancements.</li>
<li>Enhanced 6 signatures:</li>
</ol>
<p><strong>Version 200.7</strong></p><ol><li>For "Critical Alerts" section, the following 2 new signatures were updated to check for Oracle Database 12c/11g version:<ul><li>Sequences with 32-bit maximum value and large cache size</li>
<li>Sequences above 70 percent of maximum value</li>
</ul>
</li>
</ol>
<p><strong>Version 200.6</strong></p><ul><li>New Analyzer Framework version 4.6.1 released with enhancements.</li>
...
<li>Enhanced signature: GST_REQUIRED_TRIGGERS</li>
</ul>
<p><strong>Version 200.5</strong></p><ul><li>Analyzer Framework 4.6.0.1 version released.</li>
</ul>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,2315,'||l_sig.sigrepo_id||',EBS,EBS Financials,EBS - Financials Common Applications" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,2315,'||l_sig.sigrepo_id||',EBS,EBS Financials,EBS - Financials Common Applications" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},2315,'||l_sig.sigrepo_id||',EBS,EBS Financials,EBS - Financials Common Applications" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,2315,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Financials Common Applications" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,2315,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Financials Common Applications" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},2315,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Financials Common Applications" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
BEGIN
    ...
    print_log('Processing recommended patches signature: GST_RUP_LEVEL_12_1 (check_rec_patches_1) "RUP Patches" (version 29)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_col_rows(1)(l_rows) := '25776820';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'RUP 1: GST_ILS: RUP INCLUSION TRACKING BUG FOR 12.1.X';
   l_col_rows(5)(l_rows) := '[2253455.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25873470';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'RUP2: GST_ILS: APR17 RUP INCLUSION TRACKING BUG FOR 12.1.X';
   l_col_rows(5)(l_rows) := '[2253455.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25928062';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'RUP3: GST_ILS: 30APR-17 RUP INCLUSION TRACKING BUG FOR 12.1.X';
   l_col_rows(5)(l_rows) := '[2253455.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25708609';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'RUP4: DUMMY BUG FOR TRACKING MISSED DUECHECKIN FOR ISUPPLIER/IPROCUMENT';
   l_col_rows(5)(l_rows) := '[2253455.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26041797';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'RUP5: GST_ILS: MAY_30 RUP INCLUSION TRACKING BUG FOR 12.1.X';
   l_col_rows(5)(l_rows) := '[2253455.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26266406';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'RUP6: GST_ILS: JUNE_15 RUP INCLUSION TRACKING BUG FOR 12.1.X(RUP6)';
   l_col_rows(5)(l_rows) := '[2253455.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26349544';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'RUP7: GST_ILS: RUP-7 for India GST feature for 12.1.X';
   l_col_rows(5)(l_rows) := '[2253455.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26512966';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'GST_CMP:GST CONSOLIDATED CMP FOR JUL-17';
   l_col_rows(5)(l_rows) := '[2268465.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26522421';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'RUP 9: GST_ILS: RUP-9 FOR INDIA GST FEATURE FOR 12.1.X(AUG17)';
   l_col_rows(5)(l_rows) := '[2268465.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26579487';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'RUP10: GST : AUGW3 RUP FOR 12.1.X';
   l_col_rows(5)(l_rows) := '[2268465.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '27212160';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'GST : NOV RUP 11 CONSOLIDATED PATCH';
   l_col_rows(5)(l_rows) := '[2268465.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '27651381';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'GST RUP 11 : FEB 2018 CONSOLIDATION';
   l_col_rows(5)(l_rows) := '[2342288.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '27734327';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'GST RUP 11 : MAR 2018 CONSOLIDATION';
   l_col_rows(5)(l_rows) := '[2342288.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '28040425';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'GST RUP 11 : MAY 2018 CONSOLIDATION';
   l_col_rows(5)(l_rows) := '[2342288.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '28124448';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'GST RUP 11 : JUN 2018 CONSOLIDATION';
   l_col_rows(5)(l_rows) := '[2342288.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '28271023';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'GST RUP 11 : JULY 2018 CONSOLIDATION';
   l_col_rows(5)(l_rows) := '[2342288.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '28433027';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'GST RUP 11 : AUGUST 2018 CONSOLIDATION';
   l_col_rows(5)(l_rows) := '[2342288.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '28656394';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'GST RUP 11 : SEPTEMBER 2018 CONSOLIDATION';
   l_col_rows(5)(l_rows) := '[2342288.1]';
...
END IF;
   ...
   l_sig.sigrepo_id := '7559';
   l_sig.title := 'RUP Patches';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := 'You have <strong>RUP patch(es)</strong> not applied to this environment. Please expand the list above for the details.';
...
<p><strong>Financials for India Specific Patches</strong></p>
<ul>
<li>[2268465/KB630332] GST : Phase 3 Approach to Final Release - Patch Details</li>
<li>[2342288/KB256001] India GST - Latest Patches Released (RUP 11 onwards)</li>
</ul>
...
';
   l_sig.success_msg := 'All <strong>RUP patch(es)</strong> have been applied to this environment.';
  ...
  -- Register
  l_step := '60';
  g_signatures('GST_RUP_LEVEL_12_1') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'GST_RUP_LEVEL_12_1',     -- sig ID
...
BEGIN
    ...
    print_log('Processing recommended patches signature: GST_RUP_LEVEL_12_2 (check_rec_patches_2) "RUP Patches" (version 27)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25873509';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'RUP1: GST_ILS: APR17 RUP INCLUSION TRACKING BUG FOR 12.2.X';
   l_col_rows(5)(l_rows) := '[2253455.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '25928066';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'RUP2: GST_ILS: 30APR-17 RUP INCLUSION TRACKING BUG FOR 12.2.X';
   l_col_rows(5)(l_rows) := '[2253455.1]';
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'RUP3: Step 1 - DUMMY BUG FOR TRACKING MISSED DUECHECKIN FOR ISUPPLIER/IPROCUMENT';
   l_col_rows(5)(l_rows) := '[2253455.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '24838886';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'RUP3: Step 2 - [IL-GST] ISUPPLIER/IPROCUREMENT CHANGES FOR GST';
   l_col_rows(5)(l_rows) := '[2253455.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26042169';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'RUP4: GST_ILS: MAY_30 RUP INCLUSION TRACKING BUG FOR 12.2.X';
   l_col_rows(5)(l_rows) := '[2253455.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26266413';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'RUP5: GST_ILS: JUNE_15 RUP INCLUSION TRACKING BUG FOR 12.2.X';
   l_col_rows(5)(l_rows) := '[2253455.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26349537';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'RUP6: GST_ILS: RUP-7 for India GST feature for 12.2.X';
   l_col_rows(5)(l_rows) := '[2253455.1]';
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26576846';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'RUP 9: GST_ILS: RUP-8 FOR INDIA GST FEATURE FOR 12.2.X(AUG17)';
   l_col_rows(5)(l_rows) := '[2268465.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26696305';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'RUP10: GST_ILS: AUGW3 RUP FOR 12.2.X';
   l_col_rows(5)(l_rows) := '[2268465.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '27421320';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'GST : NOV RUP 11 CONSOLIDATED PATCH';
   l_col_rows(5)(l_rows) := '[2268465.1]';
...
<ul>
<li>[2268465/KB630332] GST : Phase 3 Approach to Final Release - Patch Details</li>
<li>[2253455/KB489455] GST: Oracle Financials for India (OFI) RUP Patches</li>
</ul>
Best Practice: Always ensure that you are on the latest code with all recommended patches applied. 
This will help avoid known issues, prevent potential data corruption and provide the latest features and functionality. Having a proactive patching plan and periodic proactive patching process in place are the best ways to stay current.
';
  ...
  -- Register
  l_step := '60';
  g_signatures('GST_RUP_LEVEL_12_2') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'GST_RUP_LEVEL_12_2',     -- sig ID
    l_sig,                              -- signature information
    l_col_rows,                         -- data
    l_hdr);                             -- headers
...
CURSOR chk_period(c_period VARCHAR2) IS
SELECT count(l.name) cnt
  FROM gl_ledgers l, gl_period_statuses ps, hr_operating_units hou
WHERE  ps.ledger_id = l.ledger_id
       AND ps.application_id = 200
       AND ps.period_name = c_period
       AND ps.closing_status IN ('O', 'F')
       AND hou.organization_id = p_org_id
       AND l.ledger_id = hou.set_of_books_id;
                   
CURSOR chk_Inventory_Org(c_organization_id NUMBER) IS
SELECT count(ood.organization_id)     cnt
  FROM org_organization_definitions ood
WHERE ood.organization_id = c_organization_id
...
debug('begin populate parameters hash table');
   ...
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Inventory Organization ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_organization_id,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Include Reconciliation Report';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_recon_report,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/01/27 09:47:35 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'gst_pc_analyzer.sql';
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Inventory Organization Id Specified');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
debug('begin parameter validation: p_per_name');
IF p_per_name IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Period Name is required.');
   raise invalid_parameters;
END IF;
...
INTO l_exists_val
FROM GL_LEDGERS L, GL_PERIOD_STATUSES PS, HR_OPERATING_UNITS HOU
WHERE PS.PERIOD_NAME = p_per_name
...
EXCEPTION
   ...
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_per_name failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_per_name');

debug('begin parameter validation: p_organization_id');
...
EXCEPTION
   ...
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_organization_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_organization_id');

debug('begin parameter validation: p_recon_report');
IF p_recon_report IS NOT NULL AND p_recon_report NOT IN ( 'No','Yes') THEN
   print_error('INVALID ARGUMENT: Please select a valid value');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_recon_report');
...
--g_per_name := p_period_name;
--g_inv_org_id := p_organization_id;

l_cnt := 0;
-- Derive Ledger Name and OU name

BEGIN
      SELECT l.ledger_id,l.name, hou.name
      INTO l_ledger_id, l_ledger_name, l_ou_name
      FROM gl_ledgers l, 
           hr_operating_units hou
      WHERE hou.set_of_books_id = l.ledger_id 
      AND hou.organization_id = p_org_id;
      EXCEPTION
        WHEN OTHERS THEN
          print_log('The Operating Unit Id '||p_org_id || ' does not have valid Ledger Associated');
          raise invalid_parameters;
END;
...
-- Validate period
-- Must be valid open period for relevant ledger

OPEN chk_period(p_per_name);

 FETCH chk_period INTO l_cnt;
  IF chk_period%NOTFOUND THEN
     print_log('The period ('||p_per_name||') '||
...
-- Validate Inventory Organization id, if passed
-- Must be a valid Inventory Organization associated to Operating Unit passed i.e. VALID_ORGS

IF p_organization_id IS NOT NULL 
THEN
     OPEN chk_Inventory_Org( l_inv_org_id );                
 
    FETCH chk_Inventory_Org INTO l_cnt;
      IF chk_Inventory_Org%NOTFOUND THEN
     print_log('The organization Unit Id '||p_organization_id || ' is not associated to Operating Unit '||l_ou_name);                              
 
   CLOSE chk_Inventory_Org;
   raise invalid_parameters;
   END IF;
...
BEGIN
    SELECT start_date, end_date
     ...
     WHERE set_of_books_id = NVL (l_ledger_id, set_of_books_id)
           AND period_name = p_per_name
           AND application_id IN (101);
EXCEPTION
    WHEN OTHERS
    THEN
        print_log ('Error in validating the period name: ' || p_per_name);
        print_log (  'Others: Issue in getting the start date and end date for the period name.'
            || SQLERRM);
        RAISE;
END;
...
debug('begin populate sql tokens hash table');
   ...
   g_sql_tokens('##$$EDT$$##') := l_end_date;
   g_masked_tokens('##$$EDT$$##') := mask_text( g_sql_tokens('##$$EDT$$##'), 'NO_MASK');
   g_sql_tokens('##$$SDT$$##') := l_start_date;
   g_masked_tokens('##$$SDT$$##') := mask_text( g_sql_tokens('##$$SDT$$##'), 'NO_MASK');
   g_sql_tokens('##$$P_ORGANIZATION_ID$$##') := nvl(to_char(P_ORGANIZATION_ID),'NULL');
   g_masked_tokens('##$$P_ORGANIZATION_ID$$##') := mask_text( g_sql_tokens('##$$P_ORGANIZATION_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$REL$$##') := g_rep_info('Apps Version');
   g_masked_tokens('##$$REL$$##') := mask_text( g_sql_tokens('##$$REL$$##'), 'NO_MASK');
   g_sql_tokens('##$$P_GST_REG_NUM$$##') := 'NULL';
   g_masked_tokens('##$$P_GST_REG_NUM$$##') := mask_text( g_sql_tokens('##$$P_GST_REG_NUM$$##'), 'NO_MASK');
...
debug('begin add_signature: GST_PC_AP_RTV_DM_DIFF_TAX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13076',
      p_sig_id                 => 'GST_PC_AP_RTV_DM_DIFF_TAX',
      p_sig_sql                => 'SELECT trx_number,
       trx_id,
       trx_line_id,
       trx_date,
       entity_code,
       event_class_code,
       organization_id     AS "Inventory Organization Id"
  FROM jai_tax_det_factors jta
 WHERE     jta.application_id = 200
       AND jta.entity_code = ''AP_INVOICES''
       AND jta.trx_type = ''DEBIT''
       AND jta.applied_to_application_id IS NOT NULL
       AND jta.org_id IN (##$$VALID_ORGS$$##)
       AND jta.organization_id =
           NVL (##$$P_ORGANIZATION_ID$$##, jta.organization_id)
       AND TRUNC (jta.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
       AND EXISTS
               (SELECT 1
                  FROM ap_invoices_all aia
                 WHERE     aia.invoice_id = jta.trx_id
                       AND aia.source = ''RTS''
                       AND UPPER (ap_invoices_pkg.get_approval_status (
                                      aia.invoice_id,
                                      aia.invoice_amount,
                                      aia.payment_status_flag,
                                      aia.invoice_type_lookup_code)) NOT IN
                               (''VALIDATED'', ''CANCELLED'', ''APPROVED''))
       AND EXISTS
               (SELECT 1
                  FROM jai_tax_lines jtlr1
                 WHERE     jtlr1.application_id = 707
                       AND jtlr1.entity_code = jta.applied_to_entity_code
                       AND jtlr1.trx_id = jta.applied_to_trx_id
                       AND jtlr1.trx_line_id = jta.applied_to_trx_line_id
                       AND jtlr1.trx_type = jta.applied_to_trx_type
                       AND jtlr1.trx_loc_line_id = jta.applied_to_loc_line_id
                       AND NVL (jtlr1.rounded_tax_amt_fun_curr, 0) > 0
                       AND NVL (
                               jai_boe_tax_det_pkg.is_boe_tax (
                                   jtlr1.tax_type_id),
                               ''n'') <>
                           ''y''
                       AND (jtlr1.tax_rate_id, jtlr1.tax_type_id) NOT IN
                               (SELECT jtli.tax_rate_id, jtli.tax_type_id
                                  FROM jai_tax_lines jtli
                                 WHERE     jtli.det_factor_id =
                                           jta.det_factor_id
                                       AND NVL (
                                               jtli.rounded_tax_amt_fun_curr,
                                               0) >
                                           0))',
      p_title                  => 'Incorrect Taxes For Debit Memo Compared To The Retrun To Vendor (RTV) Transaction',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This lists the Return To Vendor (RTV) debit memo invoices not having same taxes compared to RTV transaction. 
This could cause accounting imbalance in the system.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S26] and apply the detailed action plan from S.No.26 </li>
</ul>',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: GST_PC_AP_RTV_DM_DIFF_TAX');



debug('begin add_signature: GST_PC_AP_ERS_NO_TAX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13075',
      p_sig_id                 => 'GST_PC_AP_ERS_NO_TAX',
      p_sig_sql                => 'SELECT jtdf.trx_number,
       jtdf.trx_id,
       jtdf.trx_line_id,
       jtdf.trx_date,
       jtdf.entity_code,
       jtdf.event_class_code,
       jtdf.organization_id     AS "Inventory Organization Id"
  FROM jai_tax_det_factors jtdf
 WHERE     1 = 1
       AND jtdf.org_id IN (##$$VALID_ORGS$$##)
       AND jtdf.organization_id = NVL (##$$P_ORGANIZATION_ID$$##, jtdf.organization_id)
       AND TRUNC (jtdf.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
       AND EXISTS
               (SELECT 1
                  FROM jai_tax_lines jtl
                 WHERE     jtl.det_factor_id = jtdf.det_factor_id
                       AND NVL (jtl.self_assessed_flag, ''N'') <> ''Y''
                       AND NVL (jai_boe_tax_det_pkg.is_boe_tax (jtl.tax_type_id),''N'') <> ''Y''
                       AND NOT EXISTS
                               (SELECT 1
                                  FROM ap_invoice_lines_all aida
                                 WHERE     aida.invoice_id = jtl.trx_id
                                       AND description = jtl.tax_rate_code
                                       AND reference_2 =
                                           TO_CHAR (jtl.tax_line_id)))
       AND jtdf.entity_code = ''AP_INVOICES''
       AND jtdf.application_id = 200
       AND jtdf.party_id IS NOT NULL
       AND jtdf.party_type = ''Supplier''
       AND jtdf.applied_to_trx_id IS NOT NULL
       AND jtdf.applied_to_trx_type = ''RECEIVE''',
      p_title                  => 'Tax Distributions Are Missing On ERS Invoice',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invoice distributions are not created for ERS invoice where taxes exists on invoice.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S25] and apply the detailed action plan from S.No.25 </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_AP_ERS_NO_TAX');



debug('begin add_signature: GST_PC_INTER_AP_AR_DIFF_TAX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13074',
      p_sig_id                 => 'GST_PC_INTER_AP_AR_DIFF_TAX',
      p_sig_sql                => 'SELECT aia.invoice_num, aia.invoice_id, aila.accounting_date
  FROM ap_invoice_lines_all aila, ap_invoices_all aia
 WHERE     aila.line_type_lookup_code = ''ITEM''
       AND aila.line_source = ''IMPORTED''
       AND aila.match_type = ''NOT_MATCHED''
       AND aila.org_id IN (##$$VALID_ORGS$$##)
       AND TRUNC (aila.accounting_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
       ...
       AND UPPER (ap_invoices_pkg.get_approval_status (
                      ...
                      aia.invoice_amount,
                      aia.payment_status_flag,
                      aia.invoice_type_lookup_code)) NOT IN (''VALIDATED'', ''CANCELLED'', ''APPROVED'')
       AND EXISTS
               (SELECT 1
                  FROM jai_tax_lines jtl
                 WHERE     jtl.trx_id = aila.invoice_id
                       AND jtl.trx_line_id = aila.line_number
                       AND jtl.application_id = 200
                       AND jtl.entity_code = ''AP_INVOICES''
                       --AND NVL(JTL.ROUNDED_TAX_AMT_FUN_CURR,0) > 0
                       AND (jtl.tax_rate_id, jtl.tax_type_id) NOT IN
                               (SELECT jtl1.tax_rate_id, jtl1.tax_type_id
                                  FROM jai_tax_lines jtl1
                                 WHERE     jtl1.application_id = 222
                                       AND jtl1.entity_code = ''TRANSACTIONS''
                                       AND jtl1.event_class_code = ''INVOICE''
                                       AND jtl1.tax_event_class_code = ''SALES_TRANSACTION''
                                       AND jtl1.trx_id = aila.source_trx_id
                                       AND jtl1.trx_line_id = aila.source_line_id))
       AND EXISTS
               (SELECT 1
                  FROM jai_tax_lines jtl2
                 WHERE     jtl2.application_id = 222
                       AND jtl2.entity_code = ''TRANSACTIONS''
                       AND jtl2.event_class_code = ''INVOICE''
                       AND jtl2.tax_event_class_code = ''SALES_TRANSACTION''
                       AND jtl2.trx_id = aila.source_trx_id
                       AND jtl2.trx_line_id = aila.source_line_id)',
      p_title                  => 'Intercompany AP And AR Invoice Taxes Mismatches',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Inter company AP Invoice taxes mismatches compared to AR Invoice.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S24] and apply the detailed action plan from S.No.24 </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_INTER_AP_AR_DIFF_TAX');



debug('begin add_signature: GST_PC_AP_RTV_DM_NO_TAX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13073',
      p_sig_id                 => 'GST_PC_AP_RTV_DM_NO_TAX',
      p_sig_sql                => 'SELECT aia.invoice_id,
       aia.invoice_num,
       aia.invoice_date,
       aia.creation_date
  FROM ap_invoices_all aia
 WHERE     aia.invoice_type_lookup_code = ''DEBIT''
       AND aia.source = ''RTS''
       AND aia.org_id IN (##$$VALID_ORGS$$##)
       AND TRUNC (aia.creation_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
       AND EXISTS
               (SELECT 1
       ...
       AND (   NOT EXISTS
                   (SELECT 1
                      FROM jai_tax_det_factors jtdf
                     WHERE     jtdf.trx_id = aia.invoice_id
                           AND jtdf.application_id = 200
                           AND jtdf.entity_code = ''AP_INVOICES'')
            OR NOT EXISTS
                   (SELECT 1
                      FROM jai_tax_lines jtdf
                     WHERE     jtdf.trx_id = aia.invoice_id
                           AND jtdf.application_id = 200
                           AND jtdf.entity_code = ''AP_INVOICES''))
       AND UPPER (ap_invoices_pkg.get_approval_status (
                      ...
                      aia.invoice_type_lookup_code)) NOT IN
               (''VALIDATED'', ''CANCELLED'', ''APPROVED'')',
      p_title                  => 'Return To Vendor (RTV) Debit Memo Invoice Missing RTV Taxes',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Return To Vendor (RTV) debit memo invoice is not having taxes of RTV transaction.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S23] and apply the detailed action plan from S.No.23 </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_AP_RTV_DM_NO_TAX');



debug('begin add_signature: GST_PC_AP_ERS_INCOR_TAX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13054',
      p_sig_id                 => 'GST_PC_AP_ERS_INCOR_TAX',
      p_sig_sql                => 'SELECT
       jta.trx_number,
       jta.trx_id,
       jta.trx_line_id,
       jta.trx_date,
       jta.entity_code,
       jta.event_class_code,
       jta.organization_id     AS "Inventory Organization Id" 
 FROM
     jai_tax_det_factors jta
 WHERE
     jta.application_id = 200
     AND jta.entity_code = ''AP_INVOICES''
     AND jta.trx_type = ''STANDARD''
     AND jta.applied_to_application_id IS NOT NULL
         AND jta.org_id IN (##$$VALID_ORGS$$##)
AND jta.organization_id = NVL(##$$P_ORGANIZATION_ID$$##,jta.organization_id)
      AND    TRUNC(jta.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
      AND EXISTS (
    SELECT
        1
    FROM
        ap_invoices_all aia
    WHERE
        aia.invoice_id = jta.trx_id
        AND UPPER(ap_invoices_pkg.get_approval_status(aia.invoice_id,aia.invoice_amount,aia.payment_status_flag,aia.invoice_type_lookup_code
        ) ) NOT IN (
            ''VALIDATED'',
            ''CANCELLED'',
            ''APPROVED''
    ...
    FROM
        jai_tax_lines jtlr1
    WHERE
        jtlr1.application_id = 707
--AND jtlr1.FIRST_PARTY_REGISTRATION_NUM = NVL(''##$$P_GST_REG_NUM$$##'',jtlr1.FIRST_PARTY_REGISTRATION_NUM)
        AND jtlr1.entity_code = jta.applied_to_entity_code
            AND jtlr1.trx_id = jta.applied_to_trx_id
                AND jtlr1.trx_line_id = jta.applied_to_trx_line_id
                    AND jtlr1.trx_type = jta.applied_to_trx_type
                        AND jtlr1.trx_loc_line_id = jta.applied_to_loc_line_id
                            AND nvl(jtlr1.rounded_tax_amt_fun_curr,0) > 0
                                AND nvl(jai_boe_tax_det_pkg.is_boe_tax(jtlr1.tax_type_id),''N'') <> ''Y''
                                    AND ( jtlr1.tax_rate_id,
                                          jtlr1.tax_type_id ) NOT IN (
            SELECT
                jtli.tax_rate_id,
                jtli.tax_type_id
            FROM
                jai_tax_lines jtli
            WHERE
                jtli.det_factor_id = jta.det_factor_id
                AND nvl(jtli.rounded_tax_amt_fun_curr,0) > 0
        )
)',
      p_title                  => 'Evaluated Receipt Settlement (ERS) Invoice(s) Missing Tax Distributions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This lists the ERS (Evaluated Receipt Settlement) invoices where the tax distributions are missing.
This could cause accounting imbalance in the system.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S14] and apply the detailed action plan from S.No.14 </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_AP_ERS_INCOR_TAX');



debug('begin add_signature: GST_PC_AP_INTERCOMPANY_NO_TAX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13047',
      p_sig_id                 => 'GST_PC_AP_INTERCOMPANY_NO_TAX',
      p_sig_sql                => 'SELECT
     aia.invoice_id,
     aia.invoice_num,
     aia.invoice_amount,
 ...
 FROM
     ap_invoices_all aia
 WHERE
     aia.invoice_type_lookup_code = ''STANDARD''
     AND aia.SOURCE = ''Intercompany''
     AND aia.org_id IN (##$$VALID_ORGS$$##)
     AND TRUNC(aia.invoice_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
     AND EXISTS (
         SELECT
             *
         FROM
     ...
     AND ( ( NOT EXISTS (
         ...
         WHERE
             jtdf.trx_id = aia.invoice_id
             AND jtdf.application_id = 200
--AND jtdf.FIRST_PARTY_REGISTRATION_NUM = NVL(''##$$P_GST_REG_NUM$$##'',jtdf.FIRST_PARTY_REGISTRATION_NUM)
             AND jtdf.entity_code = ''AP_INVOICES''
     ) ) )
     AND UPPER(ap_invoices_pkg.get_approval_status(aia.invoice_id,aia.invoice_amount,aia.payment_status_flag,aia.invoice_type_lookup_code
     ) ) NOT IN (
      ...
      p_title                  => 'Tax Lines Are Missing in Intercompany AP (Account Payables) Invoice',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This lists the transactions where there are no taxes in Intercompany AP (Account Payables) invoice.
This will lead to missing accounting of taxes which will hamper further reporting.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S7] and apply the detailed action plan from S.No.7 </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_AP_INTERCOMPANY_NO_TAX');



debug('begin add_signature: GST_PC_AP_DM_TAX_INV_NUM_GEN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13044',
      p_sig_id                 => 'GST_PC_AP_DM_TAX_INV_NUM_GEN',
      p_sig_sql                => 'SELECT
     jtdf.trx_number,
     jtdf.trx_id,
     jtdf.trx_line_id,
 ...
 FROM
     jai_tax_det_factors jtdf
 WHERE
     jtdf.application_id = 200
     AND jtdf.entity_code = ''AP_INVOICES''
     AND jtdf.org_id IN (##$$VALID_ORGS$$##)
      AND TRUNC(jtdf.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
      AND jtdf.organization_id = NVL(##$$P_ORGANIZATION_ID$$##,jtdf.organization_id)
AND jtdf.tax_event_class_code = ''PURCHASE_TRANSACTION''
    AND jtdf.event_type_code = ''STANDARD CREATED''
        AND jtdf.event_class_code = ''STANDARD INVOICES''
            AND jtdf.trx_type = ''DEBIT''
                AND jtdf.applied_to_application_id = 707
                    AND jtdf.applied_to_entity_code = ''RCV_TRANSACTION''
                        AND jtdf.applied_to_event_class_code = ''RECEIVING''
                            AND jtdf.acknowledgement_number IS NULL
                                AND EXISTS (
    SELECT
        NULL
    FROM
 ...
 ORDER by trx_id desc',
      p_title                  => 'Debit Memo Tax Invoice Number Not Generated Even After Invoice Validation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This lists the debit memo invoices where tax invoice number is not generated post validation.
This will lead to reporting issues and causes imbalance in claim accounting.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S4] and apply the detailed action plan from S.No.4 </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_AP_DM_TAX_INV_NUM_GEN');



debug('begin add_signature: GST_PC_INV_RCPT_ORPHAN_ACCT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13086',
      p_sig_id                 => 'GST_PC_INV_RCPT_ORPHAN_ACCT',
      p_sig_sql                => 'SELECT jj.tax_det_factor_id,
       jj.tax_line_id,
       jj.tax_type_id,
       jj.transaction_date,
       jj.event_class_code,
       jj.event_type_code,
       jj.accounting_date,
       jj.organization_id     AS "Inventory Organization Id"
  FROM jai_tax_journal_entries jj
 WHERE     tax_line_id > 0
       AND tax_det_factor_id IN
               (SELECT jtd.det_factor_id
                  FROM jai_tax_det_factors jtd
                 WHERE     jtd.application_id = 707
                       AND jtd.entity_code = ''RCV_TRANSACTION''
                       AND jtd.org_id IN (##$$VALID_ORGS$$##)
                       AND jtd.organization_id = NVL (##$$P_ORGANIZATION_ID$$##,jtd.organization_id)
                       AND TRUNC (jtd.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##'')
       AND journal_entry_id > 0
       AND user_je_source_name = ''Financials India''
       AND user_je_category_name = ''PO Receiving''
       AND last_updated_by <> ''-29497211''
       AND NOT EXISTS
               (SELECT ''1''
                  FROM jai_tax_lines
                 WHERE     application_id = 707
                       AND entity_code = ''RCV_TRANSACTION''
                       AND tax_line_id = jj.tax_line_id)
       AND EXISTS
               (SELECT ''1''
                  FROM gl_je_headers gjh, gl_je_lines gjl
                 WHERE     gjh.je_header_id = gjl.je_header_id
                       AND gjh.je_source = ''Financials India''
                       AND reference_3 = TO_CHAR (jj.tax_det_factor_id)
                       AND reference_4 = TO_CHAR (jj.tax_line_id))',
      p_title                  => 'Orphan Accounting For Inventory Receipts',
      p_fail_condition         => '[cnt] >= [1]',
      p_problem_descr          => 'There exists orphan accounting entries in GL of source Financials India. This leads reconciliation issues.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S42] and apply the detailed action plan from S.No.42 </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_INV_RCPT_ORPHAN_ACCT');



debug('begin add_signature: GST_PC_REV_ACCT_FOR_RMA_RCPT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13085',
      p_sig_id                 => 'GST_PC_REV_ACCT_FOR_RMA_RCPT',
      p_sig_sql                => 'SELECT jtdf.trx_number,
       jtdf.trx_id,
       jtdf.trx_line_id,
       jtdf.trx_date,
       ...
       jtdf.event_class_code,
       jtdf.organization_id     AS "Inventory Organization Id"
  FROM jai_tax_det_factors jtdf, rcv_transactions rt
 WHERE     jtdf.trx_loc_line_id = rt.transaction_id
       AND rt.source_document_code = ''RMA''
       AND jtdf.entity_code = ''RCV_TRANSACTION''
       AND jtdf.application_id = 707
       AND jtdf.org_id IN (##$$VALID_ORGS$$##)
       AND jtdf.organization_id = NVL (##$$P_ORGANIZATION_ID$$##, jtdf.organization_id)
       AND TRUNC (jtdf.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
       AND jtdf.last_updated_by <> ''-26810233''
       AND EXISTS
               (SELECT 1
                  FROM jai_tax_lines jtl
                 WHERE     jtl.det_factor_id = jtdf.det_factor_id
                       ...
                       AND EXISTS
                               (SELECT 1
                                  FROM jai_tax_journal_entries jtje
                                 WHERE     jtje.tax_line_id = jtl.tax_line_id
                                       AND SIGN (jtje.journal_entry_id) >= 0))',
      p_title                  => 'RMA Receipt Taxes Accounted',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Return Material Authorization (RMA) receipt taxes should not be accounted. The would lead double liability decrease as taxes are accounted at RMA credit memo invoice.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S36] and apply the detailed action plan from S.No.36 </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_REV_ACCT_FOR_RMA_RCPT');



debug('begin add_signature: GST_PC_DUAL_ACCT_FOR_REC_TAX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13084',
      p_sig_id                 => 'GST_PC_DUAL_ACCT_FOR_REC_TAX',
      p_sig_sql                => 'SELECT jtl.trx_number,
       jtl.trx_id,
       jtl.trx_line_id,
       jtl.trx_date,
       jtl.entity_code,
       jtl.event_class_code,
       jtl.organization_id     AS "Inventory Organization Id"
  FROM jai_tax_lines jtl
 WHERE     jtl.application_id = 707
       AND jtl.entity_code = ''RCV_TRANSACTION''
       AND jtl.trx_type = ''DELIVER''
       AND jtl.tax_point_basis = ''DELIVERY''
       AND jtl.recoverable_flag = ''Y''
       AND jtl.rounded_tax_amt_fun_curr <> 0
       AND SIGN (jtl.tax_line_id) >= 0
       AND jtl.org_id IN (##$$VALID_ORGS$$##)
       AND jtl.organization_id = NVL (##$$P_ORGANIZATION_ID$$##, jtl.organization_id)
       AND TRUNC (jtl.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
       AND EXISTS
               (SELECT 1
                  FROM jai_tax_journal_entries jtje, jai_tax_accounts jta
                 WHERE     jtje.last_updated_by <> ''-26675808''
                       AND jtje.user_je_source_name = ''Financials India''
                       AND jtje.user_je_category_name = ''Delivery''
                       AND jtje.tax_line_id = jtl.tax_line_id
                       AND jtje.tax_det_factor_id = jtl.det_factor_id
                       AND jtje.tax_type_id = jta.tax_account_entity_id
                       AND jtje.accounted_dr IS NOT NULL
                       AND jta.interim_recovery_ccid = jtje.code_combination_id
                       AND jtje.accounted_dr IS NOT NULL
                       AND SIGN (jtje.journal_entry_id) >= 0
                       AND tax_dist_id NOT IN
                               (SELECT claim_schedule_id
                                  FROM jai_rgm_recovery_lines
                                 WHERE tax_line_id = jtje.tax_line_id))
       AND NOT EXISTS
               (SELECT 1
                  FROM jai_rgm_recovery_lines jrrl
                 WHERE     jrrl.tax_line_id = jtl.tax_line_id
                       AND NVL (jrrl.status, ''XX'') = ''REVERSED'')',
      p_title                  => 'Duplicate Accounting Entry At Deliver Transaction',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'For recoverable taxes, duplicate accounting entry created at Deliver. This causes accounting reconciliation issue.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S35] and apply the detailed action plan from S.No.35 </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_DUAL_ACCT_FOR_REC_TAX');



debug('begin add_signature: GST_PC_PO_TO_RCPT_RTV_DIFF_OR_NO_TAX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13083',
      p_sig_id                 => 'GST_PC_PO_TO_RCPT_RTV_DIFF_OR_NO_TAX',
      p_sig_sql                => 'SELECT jtdf.trx_number,
       jtdf.trx_id,
       jtdf.trx_line_id,
       jtdf.trx_date,
 ...
 WHERE     1 = 1
       ...
       AND jtdf.organization_id = NVL (##$$P_ORGANIZATION_ID$$##, jtdf.organization_id)
       AND TRUNC (jtdf.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
       AND jtdf.trx_type IN (''RECEIVE'')
       AND NOT (    jtdf.override_tax_category_id IS NOT NULL
                AND jtdf.override_tax_category_id <> NVL (jtdf.default_tax_category_id, 0))
       AND rt.transaction_id = jtdf.trx_loc_line_id
       AND EXISTS
               (SELECT 1
                  FROM jai_tax_lines jtlb
                 WHERE     jtlb.trx_id = NVL (rt.po_release_id, rt.po_header_id)
                       AND jtlb.trx_line_id = rt.po_line_id
                       AND jtlb.trx_loc_line_id =NVL (rt.po_line_location_id, jtlb.trx_loc_line_id)
                       AND jtlb.application_id = 201
                       AND (jtlb.tax_rate_id, jtlb.tax_type_id) NOT IN
                               (SELECT jtlr1.tax_rate_id, jtlr1.tax_type_id
                                  FROM jai_tax_lines jtlr1
                                 WHERE     jtlr1.det_factor_id = jtdf.det_factor_id
                                       AND jtlr1.tax_line_id > 0))',
      p_title                  => 'Receipt Taxes Are Different From Source',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This lists receipt details for which taxes are not matching with source transaction or no taxes copied from source transaction.
This caused accounting issues in system.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S34] and apply the detailed action plan from S.No.34 </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_PO_TO_RCPT_RTV_DIFF_OR_NO_TAX');



debug('begin add_signature: GST_PC_INV_EXP_ORG_ACCT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13082',
      p_sig_id                 => 'GST_PC_INV_EXP_ORG_ACCT',
      p_sig_sql                => 'SELECT jtd.trx_number,
       jtd.trx_id,
       jtd.trx_line_id,
       jtd.trx_date,
       jtd.entity_code,
       jtd.event_class_code,
       jtd.organization_id     AS "Inventory Organization Id"
  FROM jai_tax_det_factors jtd, rcv_transactions rt
 WHERE     jtd.entity_code = ''RCV_TRANSACTION''
       AND jtd.application_id = 707
       AND jtd.org_id IN (##$$VALID_ORGS$$##)
       AND jtd.organization_id = NVL (##$$P_ORGANIZATION_ID$$##, jtd.organization_id)
       AND TRUNC (jtd.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
       AND jtd.trx_type IN (''DELIVER'', ''RETURN TO RECEIVING'')
       AND jtd.trx_loc_line_id = rt.transaction_id
       AND rt.destination_type_code IN (''INVENTORY'', ''SHOP FLOOR'')
       AND EXISTS
               (SELECT 1
                  FROM mtl_system_items msi
                 WHERE     msi.inventory_item_id = jtd.item_id
                       AND msi.organization_id = jtd.organization_id
       ...
       AND (   (NOT EXISTS
                    (SELECT 1
                       FROM jai_tax_journal_entries jtje
                      WHERE     jtje.journal_entry_id > 0
                            AND jtje.tax_det_factor_id = jtd.det_factor_id))
            OR (NOT EXISTS
                    (SELECT 1
                       FROM gl_je_headers gh, gl_je_lines gjl
                      WHERE     gh.je_header_id = gjl.je_header_id
                            AND gh.je_source = ''Financials India''
                            AND gjl.reference_3 = TO_CHAR (jtd.det_factor_id))))',
      p_title                  => 'Tax Accounting Entries Missing For Expense Inventory Org',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'DELIVER transaction taxes not accounted for expense inventory organization. This would cause accounting imbalance of Inventory Account.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S33] and apply the detailed action plan from S.No.33 </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_INV_EXP_ORG_ACCT');



debug('begin add_signature: GST_PC_INV_RCPT_DEL_EXP_ACCT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13081',
      p_sig_id                 => 'GST_PC_INV_RCPT_DEL_EXP_ACCT',
      p_sig_sql                => 'SELECT jtd.trx_number,
       jtd.trx_id,
       jtd.trx_line_id,
       jtd.trx_date,
            ...
            OR (NOT EXISTS
                    (SELECT 1
                      ...
                      WHERE     gh.je_header_id = gjl.je_header_id
                            AND gh.je_source = ''Financials India''
                            AND gjl.reference_3 = TO_CHAR (jtd.det_factor_id))))',
      p_title                  => 'Deliver Transaction Accounting Not Created For Expense Items',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Expense accounting entries are not generated for DELIVER transaction. This would lead to reconciliation issue of material account.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S33] and apply the detailed action plan from S.No.33 </li>
</ul>',
   ...
   l_info.delete;
debug('end add_signature: GST_PC_INV_RCPT_DEL_EXP_ACCT');



debug('begin add_signature: GST_PC_INV_RECEIVE_NO_ACCT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13080',
      p_sig_id                 => 'GST_PC_INV_RECEIVE_NO_ACCT',
      p_sig_sql                => 'SELECT jtd.trx_number,
       jtd.trx_id,
       jtd.trx_line_id,
       jtd.trx_date,
 ...
 WHERE     jtd.entity_code = ''RCV_TRANSACTION''
       AND jtd.application_id = 707
       AND jtd.trx_type NOT IN (''DELIVER'', ''RETURN TO RECEIVING'')
       AND jtd.org_id IN (##$$VALID_ORGS$$##)
       AND jtd.organization_id = NVL (##$$P_ORGANIZATION_ID$$##, jtd.organization_id)
       AND TRUNC (jtd.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
       AND EXISTS
            ...
            OR (NOT EXISTS
                    (SELECT 1
                      ...
                      WHERE     gh.je_header_id = gjl.je_header_id
                            AND gh.je_source = ''Financials India''
                            AND gjl.reference_3 = TO_CHAR (jtd.det_factor_id))))',
      p_title                  => 'Receive Transaction Accounting Not Created',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The lists displays receipts for no accounting generated for RECEIVE transactions. This causes accounting reconciliation issues with payables invoice.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S33] and apply the detailed action plan from S.No.33 </li>
</ul>',
   ...
   l_info.delete;
debug('end add_signature: GST_PC_INV_RECEIVE_NO_ACCT');



debug('begin add_signature: GST_PC_INV_RCPT_UOM_CHG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13078',
      p_sig_id                 => 'GST_PC_INV_RCPT_UOM_CHG',
      p_sig_sql                => 'SELECT jr.trx_number,
       jr.trx_id,
       jr.trx_line_id,
       jr.trx_date,
       jr.entity_code,
       jr.event_class_code,
       jr.organization_id     AS "Inventory Organization Id"
  FROM jai_tax_det_factors jr, jai_tax_det_factors jrtv
 WHERE     jr.trx_id = jrtv.applied_from_trx_id
       AND jrtv.org_id IN (##$$VALID_ORGS$$##)
       AND jrtv.organization_id = NVL (##$$P_ORGANIZATION_ID$$##, jrtv.organization_id)
       AND TRUNC (jrtv.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
       AND jr.trx_line_id = jrtv.applied_from_trx_line_id
       AND jr.trx_uom_code <> jrtv.trx_uom_code
       AND ROUND (NVL (jr.line_amt, 0)) <> ROUND (NVL (jrtv.line_amt, 0))
       AND jr.entity_code = ''RCV_TRANSACTION''
       AND jr.trx_type = ''RECEIVE''
       AND jrtv.trx_type <> ''RECEIVE''
       AND jrtv.entity_code = ''RCV_TRANSACTION''
       AND jr.ref_doc_entity_code IS NOT NULL
       AND jr.ref_doc_application_id = 201',
      p_title                  => 'Deliver Taxes Discrepancy Due To UOM Code Mismatch',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'UOM code is different at deliver than receive and full quantity is delivered. Tax amounts are not matching at receive and deliver events.
This leads to reconciliation issue of inventory account. ',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S31] and apply the detailed action plan from S.No.31 </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_INV_RCPT_UOM_CHG');



debug('begin add_signature: GST_PC_CORRECT_NEG_TAX_ACCT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13077',
      p_sig_id                 => 'GST_PC_CORRECT_NEG_TAX_ACCT',
      p_sig_sql                => 'SELECT jtl.trx_number,
       jtl.trx_id,
       jtl.trx_line_id,
       jtl.trx_date,
       ...
       jtl.organization_id     AS "Inventory Organization Id"
  FROM jai_tax_lines jtl
 WHERE     rounded_tax_amt_fun_curr < 0
       AND tax_rate_percentage > 0
       AND NVL (self_assessed_flag, ''N'') <> ''Y''
       AND jtl.tax_point_basis = ''DELIVERY''
       AND jtl.application_id = 707
       AND jtl.entity_code = ''RCV_TRANSACTION''
       AND jtl.tax_line_id > 0
       AND jtl.tax_rate_type <> ''ADHOC_AMOUNT''
       AND NVL (jtl.self_assessed_flag, ''N'') <> ''Y''
       AND jtl.org_id IN (##$$VALID_ORGS$$##)
       AND jtl.organization_id = NVL (##$$P_ORGANIZATION_ID$$##, jtl.organization_id)
       AND TRUNC (jtl.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
       AND EXISTS
               (SELECT 1
                  FROM jai_tax_journal_entries jtje
                 WHERE     jtje.tax_line_id = jtl.tax_line_id
                       AND jtje.entered_dr IS NOT NULL
                       AND jtje.entered_dr < 0
                       AND EXISTS
                               (SELECT 1
                                  FROM gl_je_headers gh, gl_je_lines gjl
                                 WHERE     gh.je_header_id = gjl.je_header_id
                                       AND gh.je_source = ''Financials India''
                                       AND gjl.reference_4 =TO_CHAR (jtje.tax_line_id)
                                       AND gjl.entered_dr IS NOT NULL
                                       AND gjl.entered_dr > 0
                                       AND gjl.code_combination_id =jtje.code_combination_id))',
      p_title                  => 'Negative Rate Taxes Accounted With Positive Amounts',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Negative rate taxes are accounted with positive amount. Incorrect amount accounted for.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S27] and apply the detailed action plan from S.No.27 </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_CORRECT_NEG_TAX_ACCT');



debug('begin add_signature: GST_PC_INV_RTV_DIFF_TAX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13072',
      p_sig_id                 => 'GST_PC_INV_RTV_DIFF_TAX',
      p_sig_sql                => 'SELECT jtd.trx_number,
       jtd.trx_id,
       jtd.trx_line_id,
       jtd.trx_date,
 ...
 WHERE     jtd.entity_code = ''RCV_TRANSACTION''
       AND jtd.application_id = 707
       AND jtd.trx_type IN (''RETURN TO VENDOR'', ''RETURN TO RECEIVING'')
       AND jtd.applied_from_application_id = 707
       AND jtd.applied_from_entity_code = ''RCV_TRANSACTION''
       AND jtd.org_id IN (##$$VALID_ORGS$$##)
       AND jtd.organization_id = NVL (##$$P_ORGANIZATION_ID$$##, jtd.organization_id)
       AND TRUNC (jtd.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
       AND EXISTS
               (SELECT 1
                 ...
                 WHERE     rt.transaction_id = jtd.trx_loc_line_id
                       AND rt.source_document_code = ''PO''
                       AND rt.vendor_id IS NOT NULL)
       AND (EXISTS
                (SELECT 1
                   FROM jai_tax_lines jtld
                  WHERE     jtld.det_factor_id = jtd.det_factor_id
                        AND (jtld.tax_type_id, jtld.tax_rate_id) NOT IN
                                (SELECT jtlr.tax_type_id, jtlr.tax_rate_id
                                   FROM jai_tax_lines jtlr
                                  WHERE     jtlr.application_id = 707
                                        AND jtlr.entity_code = ''RCV_TRANSACTION''
                                        AND jtlr.trx_type = ''RECEIVE''
                                        AND jtlr.trx_number = jtd.trx_number
                                        AND jtlr.trx_id = jtd.trx_id
                                        AND jtlr.trx_line_id = jtd.trx_line_id
                                        AND jtlr.organization_id = jtd.organization_id)))
       AND EXISTS
               (SELECT 1
                  FROM jai_tax_lines jtlr1
                 WHERE     jtlr1.application_id = 707
                       AND jtlr1.entity_code = ''RCV_TRANSACTION''
                       AND jtlr1.trx_type = ''RECEIVE''
                       AND jtlr1.trx_number = jtd.trx_number
                       AND jtlr1.trx_id = jtd.trx_id
                       AND jtlr1.trx_line_id = jtd.trx_line_id
                       AND jtlr1.organization_id = jtd.organization_id)',
      p_title                  => 'Return To Vendor Taxes Mismatch With Receive Taxes',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Return To Vendor (RTV) taxes mismatches with corresponding receive taxes. This causes reconciliation issues.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S22] and apply the detailed action plan from S.No.22 </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_INV_RTV_DIFF_TAX');



debug('begin add_signature: GST_PC_INV_RTV_NO_TAX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13071',
      p_sig_id                 => 'GST_PC_INV_RTV_NO_TAX',
      p_sig_sql                => 'SELECT jtd.trx_number,
       jtd.trx_id,
       jtd.trx_line_id,
       jtd.trx_date,
       ...
       AND EXISTS
               (SELECT 1
                 ...
                 WHERE     jtlr1.application_id = 707
                       ...
                       AND jtlr1.trx_line_id = jtd.trx_line_id
                       AND jtlr1.organization_id = jtd.organization_id)',
      p_title                  => 'Return To Vendor Missing Taxes From Receive',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Return To Vendor (RTV) does not transfer from Receive. This causes imbalances in reconciliation.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S22] and apply the detailed action plan from S.No.22 </li>
</ul>',
   ...
   l_info.delete;
debug('end add_signature: GST_PC_INV_RTV_NO_TAX');



debug('begin add_signature: GST_PC_INV_IRISO_TO_RCT_UP_COR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13052',
      p_sig_id                 => 'GST_PC_INV_IRISO_TO_RCT_UP_COR',
      p_sig_sql                => 'SELECT
     jtr.trx_number,
     jtr.trx_id,
     jtr.trx_line_id,
     jtr.trx_date,
     jtr.entity_code,
     jtr.event_class_code,
     jtr.organization_id   AS "Inventory Organization Id"
 FROM
     jai_tax_det_factors jtr,
     rcv_shipment_headers rsh
 WHERE
     jtr.entity_code = ''RCV_TRANSACTION''
     AND jtr.application_id = 707
     AND jtr.trx_type = ''RECEIVE''
         AND jtr.org_id IN (##$$VALID_ORGS$$##)
AND jtr.organization_id = NVL(##$$P_ORGANIZATION_ID$$##,jtr.organization_id)
      AND    TRUNC(jtr.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
     AND EXISTS (
         SELECT
             1
         FROM
             rcv_transactions rt
         WHERE
             rt.transaction_id = jtr.trx_loc_line_id
             AND rt.shipment_header_id = jtr.trx_id
             AND rt.shipment_line_id = jtr.trx_line_id
             AND rt.transaction_type = ''RECEIVE''
             AND rt.source_document_code = ''REQ''
             AND rt.organization_id = jtr.organization_id
     )
     AND rsh.shipment_header_id = jtr.trx_id
     AND rsh.receipt_num = jtr.trx_number
     AND EXISTS (
         SELECT
             ''1''
         FROM
             jai_tax_det_factors jtp
         WHERE
             jtp.trx_number = rsh.shipment_num
             AND jtp.trx_line_number = jtr.trx_line_number
             AND jtp.entity_code = ''SALES_ORDER_ISSUE''
             AND jtp.application_id = 707
             AND jtp.event_class_code = ''SALES_ORDER_ISSUE''
             AND jtp.trx_type = ''STANDARD''
             AND jtp.item_id = jtr.item_id
             AND jtp.trx_uom_code = jtr.trx_uom_code
             AND nvl(round(jtp.unit_price,2),0) <> nvl(round(jtr.unit_price,2),0)
     )
 UNION
 SELECT
     jtr.trx_number,
...
AND jtr.organization_id = NVL(##$$P_ORGANIZATION_ID$$##,jtr.organization_id)
     ...
     AND EXISTS (
      ...
      p_title                  => 'Incorrect Unit Price for Internal Receipts Created Referencing the Internal Sales Order',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This lists the transactions where the unit price of the internal receipt is the same compared to the internal sales order.
This could cause accounting imbalance in the system.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S12] and apply the detailed action plan from S.No.12 </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_INV_IRISO_TO_RCT_UP_COR');



debug('begin add_signature: GST_PC_INV_ACC_ENT_AMT_NON_INR_REC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13061',
      p_sig_id                 => 'GST_PC_INV_ACC_ENT_AMT_NON_INR_REC',
      p_sig_sql                => 'SELECT
     jtdf.trx_number,
     jtdf.trx_id,
     jtdf.trx_line_id,
     ...
     jtdf.organization_id   AS "Inventory Organization Id"
 FROM
     jai_tax_journal_entries jje,
     jai_tax_det_factors jtdf,
     jai_tax_lines jtl
 WHERE
     user_je_source_name = ''Financials India''
     AND user_je_category_name IN (
         ''PO Receiving''
     )
     ...
     AND jtl.tax_rate_code NOT LIKE ''%FREIGHT%''
         AND jtdf.org_id IN (##$$VALID_ORGS$$##)
AND jtdf.organization_id = NVL(##$$P_ORGANIZATION_ID$$##,jtdf.organization_id)
      --AND    jtl.FIRST_PARTY_REGISTRATION_NUM = NVL(''##$$P_GST_REG_NUM$$##'',jtdf.FIRST_PARTY_REGISTRATION_NUM)
      AND    TRUNC(jtdf.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
     AND EXISTS (
         SELECT
             ''1''
...
AND EXISTS (
    ...
    WHERE
      ...
      p_title                  => 'Accounted and Entered GL Amounts Are Not Correct for Foreign Currency Receipt Transactions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This lists the transactions that have been accounted for and the entered GL amounts are not correct for foreign currency receipt transactions.
This could cause accounting imbalance in the system.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S21] and apply the detailed action plan from S.No.21 </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_INV_ACC_ENT_AMT_NON_INR_REC');



debug('begin add_signature: GST_PC_INV_IRISO_DEL_UP_COR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13058',
      p_sig_id                 => 'GST_PC_INV_IRISO_DEL_UP_COR',
      p_sig_sql                => 'SELECT
     jr.trx_number,
     jr.trx_id,
     jr.trx_line_id,
     ...
     jr.organization_id   AS "Inventory Organization Id"
 FROM
     jai_tax_det_factors jr,
     jai_tax_det_factors jd
 WHERE
     jr.trx_id = jd.trx_id
     AND jr.trx_line_id = jd.trx_line_id
     AND jr.trx_uom_code = jd.trx_uom_code
     AND nvl(jr.unit_price,0) <> nvl(jd.unit_price,0)
                  AND jr.org_id IN (##$$VALID_ORGS$$##)
AND jr.organization_id = NVL(##$$P_ORGANIZATION_ID$$##,jr.organization_id)
      AND    TRUNC(jr.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
      AND    jr.entity_code = ''RCV_TRANSACTION''
      AND    jr.trx_type = ''RECEIVE''
      AND    jd.trx_type <> ''RECEIVE''
      AND    jd.entity_code = ''RCV_TRANSACTION''
      AND    EXISTS (SELECT 1
              FROM   rcv_transactions rt
              WHERE  rt.transaction_id = jr.trx_loc_line_id
              AND    rt.shipment_header_id = jr.trx_id
              AND    rt.shipment_line_id = jr.trx_line_id
              AND    rt.transaction_type = ''RECEIVE''
              AND    rt.source_document_code IN (''REQ''
                                              ,''INVENTORY'')
              AND    rt.organization_id = jr.organization_id)
      UNION
      SELECT
       jr.trx_number,
       jr.trx_id,
       ...
       jr.event_class_code,
       jr.organization_id     AS "Inventory Organization Id"
      FROM   jai_tax_det_factors jr
          ,jai_tax_det_factors jd
      WHERE  jr.trx_id = jd.trx_id
      AND    jr.trx_line_id = jd.trx_line_id
      AND    jr.trx_uom_code <> jd.trx_uom_code
      AND    nvl(jd.unit_price
              ,0) <> (jai_wsh_tax_det_pkg.uom_conversion(jd.trx_uom_code
                                                              ,jr.trx_uom_code
                                                              ,jd.item_id) * jr.unit_price)
      AND    jr.org_id IN (##$$VALID_ORGS$$##)
      AND    TRUNC(jr.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
     AND jr.organization_id = NVL(##$$P_ORGANIZATION_ID$$##,jr.organization_id) AND jr.entity_code = ''RCV_TRANSACTION''
AND jr.trx_type = ''RECEIVE''
    AND jd.trx_type <> ''RECEIVE''
        AND jd.entity_code = ''RCV_TRANSACTION''
            AND EXISTS (
    ...
    FROM
        rcv_transactions rt
    WHERE
        rt.transaction_id = jr.trx_loc_line_id
        AND rt.shipment_header_id = jr.trx_id
            AND rt.shipment_line_id = jr.trx_line_id
                AND rt.transaction_type = ''RECEIVE''
                    AND rt.source_document_code IN (
            ''REQ'',
            ''INVENTORY''
        )
                        AND rt.organization_id = jr.organization_id
)',
      p_title                  => 'Incorrect Unit Price for IRISO (Internal Receipt-Internal Sales Order) Receipts for Events Other Than RECEIVE',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This lists the transactions where unit price for IRISO (Internal Receipt-Internal Sales Order) receipts are incorrect for the events other than RECEIVE.
This could cause accounting imbalance in the system.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S18] and apply the detailed action plan from S.No.18 </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_INV_IRISO_DEL_UP_COR');



debug('begin add_signature: GST_PC_INV_IRISO_DEL_DIFF_NO_TAX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13057',
      p_sig_id                 => 'GST_PC_INV_IRISO_DEL_DIFF_NO_TAX',
      p_sig_sql                => 'SELECT
     jtr.trx_number,
     jtr.trx_id,
     jtr.trx_line_id,
...
AND jtr.organization_id = NVL(##$$P_ORGANIZATION_ID$$##,jtr.organization_id)
    ...
    FROM
        jai_tax_lines jtld
    WHERE
        jtld.det_factor_id = jtr.det_factor_id
--AND jtld.FIRST_PARTY_REGISTRATION_NUM = NVL(''##$$P_GST_REG_NUM$$##'',jtld.FIRST_PARTY_REGISTRATION_NUM)
        AND ( jtld.tax_rate_id,
              jtld.tax_type_id ) NOT IN (
            SELECT
                tax_rate_id,
                tax_type_id
            FROM
                jai_tax_lines jtlr
            WHERE
                jtlr.trx_id = jtld.trx_id
                AND jtlr.trx_line_id = jtld.trx_line_id
                    AND jtlr.item_id = jtld.item_id
                        AND jtlr.application_id = jtld.application_id
                            AND jtlr.entity_code = jtld.entity_code
                                AND jtlr.trx_type = ''RECEIVE''
                                    AND jtlr.trx_uom = jtld.trx_uom
                                        AND jtlr.organization_id = jtld.organization_id
        )
) )
                                                                                                                          OR ( NOT
                                                                                                                          EXISTS (
    ...
    FROM
        jai_tax_lines jtld1
    WHERE
        jtld1.det_factor_id = jtr.det_factor_id
) ) )
            --CHECK RECEIVE SHOULD HAVE TAXES
                                                                                                                        AND EXISTS
                                                                                                                        (
    SELECT
        1
    FROM
        jai_tax_lines jtlr1
    WHERE
        jtr.trx_id = jtlr1.trx_id
        AND jtr.trx_line_id = jtlr1.trx_line_id
            AND jtr.item_id = jtlr1.item_id
                AND jtr.application_id = jtlr1.application_id
                    AND jtr.entity_code = jtlr1.entity_code
                        AND jtlr1.trx_type = ''RECEIVE''
                            AND jtr.trx_uom_code = jtlr1.trx_uom
                                AND jtr.organization_id = jtlr1.organization_id
)',
      p_title                  => 'Tax Rates at Receive and Deliver Not Equal for IRISO (Internal Receipt-Internal Sales Order) Receipts or Missing Taxes at Deliver Event',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This lists the transactions where tax rates at receive and deliver are not equal for IRISO (Internal Receipt-Internal Sales Order) receipts or no taxes at deliver event. This could cause accounting imbalance in the system.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S17] and apply the detailed action plan from S.No.17 </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_INV_IRISO_DEL_DIFF_NO_TAX');



debug('begin add_signature: GST_PC_INV_PO_RTV_UP_COR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13056',
      p_sig_id                 => 'GST_PC_INV_PO_RTV_UP_COR',
      p_sig_sql                => 'SELECT
     jr.trx_number         trx_number,
     jr.trx_id             trx_id,
     jr.trx_line_id        trx_line_id,
     jr.trx_date           trx_date,
     jr.entity_code        entity_code,
     jr.event_class_code   event_class_code,
     jr.organization_id    AS "Inventory Organization Id"
 FROM
     jai_tax_det_factors jr,
     jai_tax_det_factors jrtv
 WHERE
     jr.trx_id = jrtv.applied_from_trx_id
     AND jr.trx_line_id = jrtv.applied_from_trx_line_id
    --AND jr.trx_number = nvl(p_receipt_num,jr.trx_number)
     AND jr.trx_uom_code = jrtv.trx_uom_code
         AND jr.org_id IN (##$$VALID_ORGS$$##)
AND jr.organization_id = NVL(##$$P_ORGANIZATION_ID$$##,jr.organization_id)
AND trunc(jr.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
    AND nvl(jr.unit_price,0) <> nvl(jrtv.unit_price,0)
        AND jr.entity_code = ''RCV_TRANSACTION''
            AND jr.trx_type = ''RECEIVE''
                AND jrtv.trx_type IN (
    ''RETURN TO VENDOR'',
    ''RETURN TO RECEIVING''
)
                    AND jrtv.entity_code = ''RCV_TRANSACTION''
                        AND jr.ref_doc_entity_code IN (
    ''PURCHASE_ORDER'',
    ''RELEASE''
)
                            AND jr.ref_doc_application_id = 201 UNION
SELECT
    rsh.receipt_num          trx_number,
    rsh.shipment_header_id   trx_id,
    rsl.shipment_line_id     trx_line_id,
    NULL trx_date,
    NULL entity_code,
    NULL event_class_code,
    NULL AS "Inventory Organization Id"
FROM
    rcv_shipment_headers rsh,
        ...
        WHERE
            ...
            AND nvl(rt.po_unit_price,0) <> 0
                ...
                FROM
                    jai_tax_det_factors jtdf
                WHERE
                    jtdf.trx_loc_line_id = rt.transaction_id
                    AND jtdf.application_id = 707
                        AND jtdf.entity_code = ''RCV_TRANSACTION''
                            AND jtdf.trx_id = rt.shipment_header_id
                                AND jtdf.trx_line_id = rt.shipment_line_id
                                    AND nvl(jtdf.unit_price,0) = 0
            )
                    AND NOT EXISTS (
                SELECT
                    1
                FROM
                    jai_tax_det_factors jtdf1
                WHERE
                    jtdf1.application_id = 707
                    AND jtdf1.entity_code = ''RCV_TRANSACTION''
                        AND jtdf1.trx_id = rt.shipment_header_id
                            AND jtdf1.trx_line_id = rt.shipment_line_id
                                AND jtdf1.trx_type IN (
                        ''RECEIVE'',
                        ''DELIVER''
                    )
            )
    )',
      p_title                  => 'Incorrect unit price for (RTV) Return To Vendor Transactions of Purchase Order Receipts',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This lists the transactions where the unit price for transaction type RTV (Return To vendor) is incorrect for purchase order receipts.
This could cause accounting imbalance in the system.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S16] and apply the detailed action plan from S.No.16 </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_INV_PO_RTV_UP_COR');



debug('begin add_signature: GST_PC_INV_IRISO_RCPT_DIFF_TAX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13050',
      p_sig_id                 => 'GST_PC_INV_IRISO_RCPT_DIFF_TAX',
      p_sig_sql                => 'SELECT
       jtdf.trx_number,
       jtdf.trx_id,
       jtdf.trx_line_id,
 ...
 FROM
     jai_tax_det_factors jtdf
 WHERE
     jtdf.entity_code = ''RCV_TRANSACTION''
     AND jtdf.trx_type = ''RECEIVE''
     AND jtdf.application_id = 707
     AND jtdf.applied_from_entity_code IN (
         ''SALES_ORDER_ISSUE''
     )
     AND jtdf.applied_from_application_id = 707
         AND jtdf.org_id IN (##$$VALID_ORGS$$##)
      AND    jtdf.organization_id = NVL(##$$P_ORGANIZATION_ID$$##,jtdf.organization_id)
      AND    TRUNC(jtdf.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
      AND    EXISTS
       (SELECT 1
              FROM   jai_tax_lines jtr
              WHERE  jtr.det_factor_id = jtdf.det_factor_id
--AND jtr.FIRST_PARTY_REGISTRATION_NUM = NVL(''##$$P_GST_REG_NUM$$##'',jtr.FIRST_PARTY_REGISTRATION_NUM)
              AND    jtr.tax_line_id > 0
              AND    (jtr.tax_rate_id, jtr.tax_type_id) NOT IN
                     (SELECT jto.tax_rate_id
                           ,jto.tax_type_id
                       FROM   jai_tax_lines jto
                       WHERE  jto.det_factor_id IN (SELECT D.det_factor_id
                                                    FROM   jai_tax_det_factors       D
                                                        ,rcv_shipment_lines        L
                                                        ,mtl_material_transactions T
                                                    WHERE  D.application_id = 707
                                                    AND    D.entity_code = ''SALES_ORDER_ISSUE''
                                                    AND    D.event_class_code = ''SALES_ORDER_ISSUE''
                                                    AND    D.ref_doc_line_id = T.trx_source_line_id
                                                    AND    L.mmt_transaction_id = T.transaction_id
                                                    AND    L.shipment_line_id = jtr.trx_line_id
                                                    AND    jtr.item_id = D.item_id
                                                    AND    D.det_factor_id > 0
                                                    AND    EXISTS (SELECT 1
                                                            FROM   wsh_delivery_assignments wda
                                                            WHERE  wda.delivery_id = D.trx_id))))
      -- Add query with actual tax rate populated wrongfully.
      UNION ALL
      SELECT
       jtdf.trx_number,
       jtdf.trx_id,
       ...
       jtdf.organization_id     AS "Inventory Organization Id"  
      FROM   jai_tax_det_factors jtdf
      WHERE  jtdf.entity_code = ''RCV_TRANSACTION''
      AND    jtdf.trx_type = ''RECEIVE''
      AND    jtdf.application_id = 707
      AND    jtdf.applied_from_entity_code IN (''SALES_ORDER_ISSUE'')
      AND    jtdf.applied_from_application_id = 707
      AND jtdf.org_id IN (##$$VALID_ORGS$$##)
AND jtdf.organization_id = NVL(##$$P_ORGANIZATION_ID$$##,jtdf.organization_id) AND TRUNC(jtdf.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
AND EXISTS (
    SELECT
        1
    FROM
        jai_tax_lines jtr
    WHERE
        jtr.det_factor_id = jtdf.det_factor_id
--AND jtr.FIRST_PARTY_REGISTRATION_NUM = NVL(''##$$P_GST_REG_NUM$$##'',jtr.FIRST_PARTY_REGISTRATION_NUM)
        AND jtr.tax_line_id > 0
                    -- Identify actual tax rate populated wrongfully. 
            AND ( jtr.tax_rate_percentage > 0
                  AND nvl(actual_tax_rate,0) = 0 )
                AND ( jtr.tax_rate_id,
                      jtr.tax_type_id ) IN (
            SELECT
                jto.tax_rate_id,
            ...
            FROM
                jai_tax_lines jto
            WHERE
                ( jto.tax_rate_percentage > 0
                  AND nvl(jto.actual_tax_rate,0) <> 0 )
                AND jto.det_factor_id IN (
                    SELECT
                        D.det_factor_id
                    FROM
                        jai_tax_det_factors D,
                        rcv_shipment_lines L,
                        mtl_material_transactions T
                    WHERE
                        D.application_id = 707
                        AND D.entity_code = ''SALES_ORDER_ISSUE''
                            AND D.event_class_code = ''SALES_ORDER_ISSUE''
                                AND D.ref_doc_line_id = T.trx_source_line_id
                                    AND L.mmt_transaction_id = T.transaction_id
                            ...
                            WHERE
                                wda.delivery_id = D.trx_id
                        )
                )
        )
)',
      p_title                  => 'Incorrect Taxes for IRISO Receipt Compared to the Shipment',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This lists the IRISO (Internal Requisition-Internal Sales Order) receipts not having same taxes compared to shipment.
This could cause accounting imbalance in the system.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S10] and apply the detailed action plan from S.No.10 </li>
</ul>
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_INV_IRISO_RCPT_DIFF_TAX');



debug('begin add_signature: GST_PC_INV_IRISO_RCPT_NO_TAX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13049',
      p_sig_id                 => 'GST_PC_INV_IRISO_RCPT_NO_TAX',
      p_sig_sql                => 'SELECT jtdf.trx_number,
       jtdf.trx_id,
       jtdf.trx_line_id,
       jtdf.trx_date,
      ...
      FROM   jai_tax_det_factors  jtdf
            ,rcv_shipment_headers rsh
      WHERE  trx_loc_line_id IN ((SELECT transaction_id
                                 FROM   rcv_transactions
                                 WHERE  source_document_code = ''REQ''))
      AND jtdf.org_id IN (##$$VALID_ORGS$$##)
AND jtdf.organization_id = NVL(##$$P_ORGANIZATION_ID$$##,jtdf.organization_id)
    AND    TRUNC(jtdf.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
      AND    entity_code = ''RCV_TRANSACTION''
      AND    application_id = 707 -- AND APPLICATION_ID IS NOT NULL
            --AND APPLIED_FROM_ENTITY_CODE IS NULL
            --AND REF_DOC_ENTITY_CODE IS NULL
      AND    trx_type = ''RECEIVE''
      AND    NOT EXISTS (SELECT 1
              FROM   jai_tax_lines jtl
              WHERE  jtl.det_factor_id = jtdf.det_factor_id)
             --AND jtl.FIRST_PARTY_REGISTRATION_NUM = NVL(''##$$P_GST_REG_NUM$$##'',jtl.FIRST_PARTY_REGISTRATION_NUM)
      AND    rsh.shipment_header_id = jtdf.trx_id
      AND    rsh.receipt_num = jtdf.trx_number
      AND    EXISTS (SELECT D.*
              FROM   jai_tax_det_factors D
              WHERE  D.trx_number = rsh.shipment_num
              AND    D.item_id = jtdf.item_id
              AND    D.trx_uom_code = jtdf.trx_uom_code
              AND    D.entity_code = ''SALES_ORDER_ISSUE''
              AND    D.application_id = 707
              AND    D.event_class_code = ''SALES_ORDER_ISSUE''
              AND    D.trx_type = ''STANDARD''
              AND    EXISTS (SELECT 1
                      FROM   jai_tax_lines jtls
                      WHERE  jtls.det_factor_id = D.det_factor_id
                      AND    jtls.rounded_tax_amt_fun_curr > 0))',
      p_title                  => 'Taxes Are Missing in IRISO (Internal Receipt-Internal Sales Order) Receipt',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This lists the transactions where taxes are missing in IRISO (Internal Receipt-Internal Sales Order) receipt.
This could cause accounting imbalance in the system.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S9] and apply the detailed action plan from S.No.9 </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_INV_IRISO_RCPT_NO_TAX');



debug('begin add_signature: GST_PC_INV_PO_DEL_DIFF_OR_NO_TAX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13045',
      p_sig_id                 => 'GST_PC_INV_PO_DEL_DIFF_OR_NO_TAX',
      p_sig_sql                => 'SELECT
     jtd.trx_number,
     jtd.trx_id,
     jtd.trx_line_id,
 ...
 WHERE
     jtd.entity_code = ''RCV_TRANSACTION''
     AND jtd.application_id = 707
     AND jtd.trx_type IN (
         ''ACCEPT'',
         ''DELIVER'',
...
AND jtd.organization_id = NVL(##$$P_ORGANIZATION_ID$$##,jtd.organization_id)
     ...
     AND EXISTS (
         ...
         FROM
             rcv_transactions rt
         WHERE
             rt.transaction_id = jtd.trx_loc_line_id
             AND rt.source_document_code = ''PO''
             AND rt.vendor_id IS NOT NULL
     )
     AND ( EXISTS (
         ...
         FROM
             jai_tax_lines jtld
         WHERE
             jtld.det_factor_id = jtd.det_factor_id
--   AND jtld.FIRST_PARTY_REGISTRATION_NUM = NVL(''##$$P_GST_REG_NUM$$##'',jtld.FIRST_PARTY_REGISTRATION_NUM)
             AND ( jtld.tax_type_id,
                   jtld.tax_rate_id ) NOT IN (
                 SELECT
                     jtlr.tax_type_id,
                     jtlr.tax_rate_id
                 FROM
...
AND jtd.organization_id = NVL(##$$P_ORGANIZATION_ID$$##,jtd.organization_id)
     ...
     AND NOT EXISTS (
         ...
         FROM
             jai_tax_lines jtl
         WHERE
             jtl.det_factor_id = jtd.det_factor_id
     )
--AND jtl.FIRST_PARTY_REGISTRATION_NUM = NVL(''##$$P_GST_REG_NUM$$##'',jtl.FIRST_PARTY_REGISTRATION_NUM)
     AND EXISTS (
         SELECT
 ...
 WHERE
     ...
     AND jtd.trx_type IN (
         ...
         ''TRANSFER''
              ...
              AND jtd.org_id IN (##$$VALID_ORGS$$##)
AND jtd.organization_id = NVL(##$$P_ORGANIZATION_ID$$##,jtd.organization_id)
              AND    TRUNC(jtd.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##'' AND jtd.applied_from_application_id = 707
     AND jtd.applied_from_entity_code = ''RCV_TRANSACTION''
     AND EXISTS (
         SELECT
             1
...
--AND jtld.FIRST_PARTY_REGISTRATION_NUM = NVL(''##$$P_GST_REG_NUM$$##'',jtld.FIRST_PARTY_REGISTRATION_NUM)
             ...
             AND jtlr.organization_id = jtd.organization_id
             AND jtlr.tax_line_id > 0
             AND ( jtlr.tax_type_id,
                   jtlr.tax_rate_id ) NOT IN (
                 SELECT
                     jtld.tax_type_id,
                     jtld.tax_rate_id
                 FROM
      ...
      p_title                  => 'Tax Rates at Receive and Deliver Are Not Equal for Purchase Order Receipts or Missing Taxes at Deliver Event',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This lists the transactions where the tax rates are not the same in transaction type deliver compared to transaction type receive (OR) the tax rates are missing at deliver event. This could cause accounting imbalance in the system.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S5] and apply the detailed action plan from S.No.5 </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_INV_PO_DEL_DIFF_OR_NO_TAX');



debug('begin add_signature: GST_PC_INV_RMA_TO_RCPT_TO_DEL_UP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13043',
      p_sig_id                 => 'GST_PC_INV_RMA_TO_RCPT_TO_DEL_UP',
      p_sig_sql                => 'SELECT
     jtr.trx_number,
     jtr.trx_id,
     jtr.trx_line_id,
...
AND jtr.organization_id = NVL(##$$P_ORGANIZATION_ID$$##,jtr.organization_id)
      AND TRUNC(jtr.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
     AND jtr.trx_loc_line_id = rt.transaction_id
     AND rt.source_document_code = ''RMA''
     AND EXISTS (
         SELECT
             ''1''
         ...
         WHERE
             ...
             AND jtp.trx_uom_code = jtr.trx_uom_code
             AND nvl(jtp.unit_price,0) <> nvl(jtr.unit_price,0)
     )',
      p_title                  => 'Incorrect Unit Price in Receipt Compared to RMA (Return Material Authorization)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This lists the receipt transactions where the unit price is not the same compared to the RMA (Return Material Authorization).
This could cause accounting imbalance in the system.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S2] and apply the detailed action plan from S.No.2 </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_INV_RMA_TO_RCPT_TO_DEL_UP');



debug('begin add_signature: GST_PC_INV_PO_RCPT_NO_TAX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13059',
      p_sig_id                 => 'GST_PC_INV_PO_RCPT_NO_TAX',
      p_sig_sql                => 'SELECT
       jtr.trx_number,
       jtr.trx_id,
       jtr.trx_line_id,
...
AND jtr.organization_id = NVL(##$$P_ORGANIZATION_ID$$##,jtr.organization_id)
     ...
     AND NOT EXISTS (
         ...
         FROM
             jai_tax_lines jto
         WHERE
             jto.det_factor_id = jtr.det_factor_id
     )',
      p_title                  => 'Purchase Order Receipts Are Not Having Taxes but Det Factors Exists',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This lists the transactions where purchase order receipts are not having taxes but Det factors exists.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S19] and apply the detailed action plan from S.No.19 </li>
</ul>
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_INV_PO_RCPT_NO_TAX');



debug('begin add_signature: GST_PC_RECFLAG_REC_FLAG_COR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13055',
      p_sig_id                 => 'GST_PC_RECFLAG_REC_FLAG_COR',
      p_sig_sql                => 'SELECT
       jtl.trx_number,
       jtl.trx_id,
       jtl.trx_line_id,
...
AND jtl.organization_id = NVL(##$$P_ORGANIZATION_ID$$##,jtl.organization_id)
     AND TRUNC(jtl.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
      AND    EXISTS (SELECT 1
              ...
              WHERE  jtt.tax_type_id = jtl.tax_type_id
              AND    nvl(recoverable_flag
                        ,''N'') = ''Y'')
      AND    EXISTS (SELECT 1
              FROM   jai_tax_rates jtr
              WHERE  jtr.tax_rate_id = jtl.tax_rate_id
              AND    nvl(jtr.recovery_percentage
                        ,0) > 0)',
      p_title                  => 'Recoverable Flag Is Not Checked for Eligible Receipt Transactions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This lists the transactions where the recoverable flag is not checked for receipt transactions.
This could cause accounting imbalance in the system.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S15] and apply the detailed action plan from S.No.15 </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_RECFLAG_REC_FLAG_COR');



debug('begin add_signature: GST_PC_INV_PO_DEL_UP_COR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13053',
      p_sig_id                 => 'GST_PC_INV_PO_DEL_UP_COR',
      p_sig_sql                => 'SELECT
     jr.trx_number,
     jr.trx_id,
     jr.trx_line_id,
...
AND jr.organization_id = NVL(##$$P_ORGANIZATION_ID$$##,jr.organization_id)
     ...
     AND jr.ref_doc_application_id = 201',
      p_title                  => 'Incorrect Unit Price for Purchase Order Receipts for Transaction Type Other Than Receive',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This lists the transactions where the unit price is incorrect for PO receipts for transaction type other than RECEIVE.
This could cause accounting imbalance in the system.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S13] and apply the detailed action plan from S.No.13 </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_INV_PO_DEL_UP_COR');



debug('begin add_signature: GST_PC_INV_PO_DEL_TAX_INC_AMT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13042',
      p_sig_id                 => 'GST_PC_INV_PO_DEL_TAX_INC_AMT',
      p_sig_sql                => 'SELECT
     jtdf.trx_number,
       jtdf.trx_id,
       jtdf.trx_line_id,
 ...
 WHERE
    ...
    FROM
        jai_tax_lines A
    WHERE
        A.det_factor_id = jtdf.det_factor_id
        AND A.tax_line_id > 0
              --AND    a.FIRST_PARTY_REGISTRATION_NUM = NVL(''##$$P_GST_REG_NUM$$##'',a.FIRST_PARTY_REGISTRATION_NUM)
            AND EXISTS (
            SELECT
                1
            FROM
                jai_tax_lines b
            WHERE
                b.application_id = 707
                AND b.entity_code = ''RCV_TRANSACTION''
                    AND b.tax_line_id > 0
                        AND b.trx_type = ''RECEIVE''
                            AND b.tax_rate_id = A.tax_rate_id
                                AND b.trx_id = A.trx_id
                                    AND b.trx_line_id = A.trx_line_id
                            --AND B.TRX_UOM                            = A.TRX_UOM
                                        AND b.unit_price = A.unit_price
                                            AND A.tax_rate_code = b.tax_rate_code
                                                AND A.trx_line_quantity = b.trx_line_quantity
                                                    AND nvl(A.line_amt,0) = nvl(b.line_amt,0)
                                                        AND nvl(A.rounded_tax_amt_fun_curr,0) <> nvl(b.rounded_tax_amt_fun_curr,0
                                                        )
        )
)',
      p_title                  => 'Incorrect ROUNDED_TAX_AMT_FUN_CURR for Tax Lines at DELIVERY When Compared With Same Tax Rate Line at RECEIVE When Unit Price and Quantity Are Same',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This lists the receipt delivery transactions where the ROUNDED_TAX_AMT_FUN_CURR is incorrect when compared with same tax rate line at RECEIVE when unit price and quantity are same. This will cause accounting imbalance in the system.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S1] and apply the detailed action plan from S.No.1 </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_INV_PO_DEL_TAX_INC_AMT');



debug('begin add_signature: GST_PC_INV_PO_TO_RCT_UP_COR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13051',
      p_sig_id                 => 'GST_PC_INV_PO_TO_RCT_UP_COR',
      p_sig_sql                => 'SELECT
     jtr.trx_number,
     jtr.trx_id,
     jtr.trx_line_id,
 ...
 WHERE
     jtr.entity_code = ''RCV_TRANSACTION''
     AND jtr.application_id = 707
     AND jtr.ref_doc_entity_code IN (
         ''PURCHASE_ORDER'',
         ''RELEASE''
     )
     AND jtr.ref_doc_application_id = 201
...
AND jtr.organization_id = NVL(##$$P_ORGANIZATION_ID$$##,jtr.organization_id)
     ...
     AND EXISTS (
      ...
      p_title                  => 'Incorrect Unit Price in All Transaction Types for Receipts Created Based on Purchase Order',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This will list all the purchase order based receipts where the unit price is wrong compared to the parent transaction.
This could cause accounting imbalance in the system.

',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S11] and apply the detailed action plan from S.No.11 </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_INV_PO_TO_RCT_UP_COR');



debug('begin add_signature: GST_PC_INV_PO_TO_RCPT_DIFF_TAX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13048',
      p_sig_id                 => 'GST_PC_INV_PO_TO_RCPT_DIFF_TAX',
      p_sig_sql                => 'SELECT
       jtdf.trx_number,
       jtdf.trx_id,
       jtdf.trx_line_id,
 ...
 WHERE
     ...
     AND jtdf.application_id = 707
     AND jtdf.trx_type = ''RECEIVE''
     AND nvl(jtdf.default_tax_category_id,0) = nvl(jtdf.override_tax_category_id,nvl(jtdf.default_tax_category_id,0) ) --IT MEANS USER NOT OVERRIDED TAX CATEGORY AT RECEIPT MANUALLY
     AND rt.transaction_id = jtdf.trx_loc_line_id
     AND jtdf.org_id IN (##$$VALID_ORGS$$##)
     AND jtdf.organization_id = NVL(##$$P_ORGANIZATION_ID$$##,jtdf.organization_id)
     AND TRUNC(jtdf.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
    ...
    FROM
        jai_tax_lines jtlb
    WHERE
        jtlb.trx_id = nvl(rt.po_release_id,rt.po_header_id)
--AND jtlb.FIRST_PARTY_REGISTRATION_NUM = NVL(''##$$P_GST_REG_NUM$$##'',jtlb.FIRST_PARTY_REGISTRATION_NUM)
        AND jtlb.trx_line_id = rt.po_line_id
            AND jtlb.trx_loc_line_id = nvl(rt.po_line_location_id,jtlb.trx_loc_line_id)
                AND jtlb.application_id = 201
                    AND ( jtlb.tax_rate_id,
                          jtlb.tax_type_id ) NOT IN (
            SELECT
                jtlr1.tax_rate_id,
                jtlr1.tax_type_id
            FROM
                jai_tax_lines jtlr1
            WHERE
                jtlr1.det_factor_id = jtdf.det_factor_id
                AND jtlr1.tax_line_id > 0
        )
)',
      p_title                  => 'Incorrect Taxes for Transaction Type Deliver Compared to Transaction Type Receive',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This lists the transactions where the tax rates are different for transaction type DELIVER compared to transaction type RECEIVE.
This could cause accounting imbalance in the system.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S8] and apply the detailed action plan from S.No.8 </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_INV_PO_TO_RCPT_DIFF_TAX');



debug('begin add_signature: GST_PC_FP_FIRST_PARTY_NULL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13046',
      p_sig_id                 => 'GST_PC_FP_FIRST_PARTY_NULL',
      p_sig_sql                => 'SELECT
       jtl.trx_number,
       jtl.trx_id,
       jtl.trx_line_id,
 ...
 FROM
     jai_tax_lines jtl
 WHERE
     jtl.first_party_primary_reg_num IS NULL
     AND jtl.organization_id IS NOT NULL
     AND jtl.location_id IS NOT NULL
     AND jtl.tax_regime_type = ''T''
     AND jtl.org_id IN (##$$VALID_ORGS$$##)
     AND jtl.organization_id = NVL(##$$P_ORGANIZATION_ID$$##,jtl.organization_id) 
     AND TRUNC(jtl.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
     --AND jtl.FIRST_PARTY_REGISTRATION_NUM = NVL(''##$$P_GST_REG_NUM$$##'',jtl.FIRST_PARTY_REGISTRATION_NUM)
    ...
    FROM
        jai_party_regs jpr
    WHERE
        jpr.party_type_code = ''IO''
        AND jpr.party_id = jtl.organization_id
            AND jpr.party_site_id = jtl.location_id
                AND EXISTS (
            SELECT
                1
            FROM
            ...
            WHERE
                jprl.party_reg_id = jpr.party_reg_id
                AND jprl.regime_id = jr.regime_id
                    AND jprl.regime_id = jtl.tax_regime_id
                        AND jr.regime_type = jtl.tax_regime_type
        )
)',
      p_title                  => 'First Party Registration Details Are Missing in JAI_TAX_LINES',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This lists the transactions where the first party registration details are missing in JAI_TAX_LINES.',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S6] and apply the detailed action plan from S.No.6 </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_FP_FIRST_PARTY_NULL');



debug('begin add_signature: GST_PC_RMA_NO_TAX_INV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13079',
      p_sig_id                 => 'GST_PC_RMA_NO_TAX_INV',
      p_sig_sql                => 'SELECT jtl.trx_number,
       jtl.trx_id,
       jtl.trx_line_id,
       jtl.trx_date,
 ...
 WHERE     rctl.customer_trx_id = trx.customer_trx_id
       ...
       AND jtl.trx_line_id = rctl.customer_trx_line_id
       AND jtl.org_id IN (##$$VALID_ORGS$$##)
       AND jtl.organization_id = NVL (##$$P_ORGANIZATION_ID$$##, jtl.organization_id)
       AND TRUNC (jtl.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
       AND jtl.application_id = 222
       AND entity_code = ''TRANSACTIONS''
       AND NVL (jtl.reporting_only_flag, ''N'') = ''N''
       AND jtl.entity_code = ''TRANSACTIONS''
       AND jtl.event_class_code = ''CREDIT_MEMO''
       AND jtl.tax_invoice_num IS NULL
       AND jtl.applied_from_application_id = 660
       AND jtl.applied_from_entity_code = ''OE_ORDER_HEADERS''
       AND jtl.application_id = 222',
      p_title                  => 'Tax Invoice Number Missing For RMA Credit Memo',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Tax invoice is not generated for RMA credit memo invoices. This leads to compliance issues with GST authorities. ',
      p_solution               => '<ul>
<li>Please execute datafix to fix corruption in the transactions listed.</li>
<li>Follow [2292715/KB790895#S32] and apply the detailed action plan from S.No.32 </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_RMA_NO_TAX_INV');



debug('begin add_signature: GST_PC_OM_DELIVERY_NO_TAX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13070',
      p_sig_id                 => 'GST_PC_OM_DELIVERY_NO_TAX',
      p_sig_sql                => 'SELECT a.*
  FROM (SELECT wda.delivery_id,
               wda.delivery_detail_id,
               wdd.source_header_id trx_id,
               wdd.source_line_id trx_line_id,
               DECODE (jtdf.trx_line_id, NULL, ''CREATE'', ''UPDATE'') line_level_action,
               jtdf.det_factor_id
          FROM wsh_delivery_assignments  wda,
               wsh_delivery_details      wdd,
               jai_tax_det_factors       jtdf
         WHERE     wda.delivery_detail_id = jtdf.trx_line_id(+)
               AND wda.delivery_id = jtdf.trx_id(+)
               AND ''SALES_ORDER_ISSUE'' = jtdf.entity_code(+)
               AND wda.delivery_detail_id = wdd.delivery_detail_id
               AND wdd.org_id IN (##$$VALID_ORGS$$##)
               AND wdd.organization_id = NVL (##$$P_ORGANIZATION_ID$$##, wdd.organization_id)
               AND TRUNC (wdd.creation_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
        ) a
 WHERE    a.det_factor_id IS NULL
       OR NOT EXISTS
              (SELECT 1
                 FROM jai_tax_journal_entries j
                WHERE j.tax_det_factor_id = a.det_factor_id)',
      p_title                  => 'Shipment Delivery Missing Sales Order Taxes',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are shipment deliveries for which taxes are not transferred from the sales order. The sales invoice are then created with out taxes.',
      p_solution               => '<ul>
<li>Download and apply datafix Shipping_data_fix_generic_final.zip from [2292715/KB790895]</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_OM_DELIVERY_NO_TAX');



debug('begin add_signature: GST_PC_SO_IOT_SHIPMENT_RECON');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13449',
      p_sig_id                 => 'GST_PC_SO_IOT_SHIPMENT_RECON',
      p_sig_sql                => 'SELECT jtl.trx_id,
       jtl.trx_line_id,
       jtl.trx_loc_line_id,
       jtl.trx_type,
       jtl.trx_number
       ...
       (SELECT segment1
         ...
         WHERE     inventory_item_id = jtl.item_id
               AND organization_id = jtl.organization_id)
           "Description/item Details",
       DECODE (jtl.event_type_code,
               ''DIR_INTERORG_SHIP'', ''Inter Org Transfer'',
               ''SALES_ORDER_ISSUE'', ''Sales Order Issue'',
               jtl.event_class_code)
           "Event",
       jtl.tax_type_name
           "Tax Type Name",
       ...
       rl.liability_amount
           "Liability Amount",
       jtje.period_name
           AS "GST SLA Period Name",
       jtje.accounted_dr
           AS "GST SLA Debit",
       jtje.accounted_cr
           AS "GST SLA Credit",
       jtje.accounting_date
           AS "GST SLA Accounting Date",
       DECODE (jtje.accounted_dr,
               NULL, NULL,
               (SELECT gcck.concatenated_segments
                  FROM gl_code_combinations_kfv gcck
                 WHERE gcck.code_combination_id = jtje.code_combination_id))
           "Subledger GST Dr. Account",
       DECODE (jtje.accounted_cr,
               NULL, NULL,
               (SELECT gcck1.concatenated_segments
                  FROM gl_code_combinations_kfv gcck1
                 WHERE gcck1.code_combination_id = jtje.code_combination_id))
           "Subledger GST Cr. Account",
       gjl.period_name
           AS "GL period name",
       gjl.accounted_dr
           AS "GL Debit",
       ...
       DECODE (gjl.accounted_dr,
               NULL, NULL,
               (SELECT gcck2.concatenated_segments
                  FROM gl_code_combinations_kfv gcck2
                 WHERE gcck2.code_combination_id = gjl.code_combination_id))
           "Ledger GST Dr. Account",
       DECODE (gjl.accounted_cr,
               NULL, NULL,
               (SELECT gcck3.concatenated_segments
                  FROM gl_code_combinations_kfv gcck3
                 WHERE gcck3.code_combination_id = gjl.code_combination_id))
           "Ledger GST Cr. Account"
  FROM apps.jai_tax_lines_v          jtl,
       apps.jai_tax_journal_entries  jtje,
       apps.gl_je_lines              gjl,
       apps.jai_rgm_recovery_lines   rl
 WHERE     1 = 1
       AND jtl.entity_code IN (''SALES_ORDER_ISSUE'', ''DIR_INTERORG_SHIP'')
       AND jtl.tax_point_basis = ''DELIVERY''
       AND jtl.det_factor_id = jtje.tax_det_factor_id(+)
       AND jtl.tax_line_id = jtje.tax_line_id(+)
       AND TO_CHAR (jtl.det_factor_id) = gjl.reference_3(+)
       AND TO_CHAR (jtl.tax_line_id) = gjl.reference_4(+)
       AND jtl.trx_id = rl.document_id(+)
       AND jtl.tax_line_id = rl.tax_line_id(+)
       AND (   jtl.rounded_tax_amt_fun_curr <>
               COALESCE (jtje.accounted_dr, jtje.accounted_cr, 0) -- tax amount <> GST SLA
            OR jtl.rounded_tax_amt_fun_curr <>
               COALESCE (gjl.accounted_dr, gjl.accounted_cr, 0) -- tax amount <> GL
            OR COALESCE (jtje.accounted_dr, jtje.accounted_cr, 0) <>
               COALESCE (gjl.accounted_dr, gjl.accounted_cr, 0) -- GST SLA <> GL
            OR (jtl.rounded_tax_amt_fun_curr <> NVL (rl.liability_amount, -1) -- repository mismatch
                                                                             ))
       AND (   (    DECODE (jtje.accounted_dr,
                            NULL, ''ACCOUNTED_CR'',
                            ''ACCOUNTED_DR'') =
                    DECODE (gjl.accounted_dr,
                            NULL, ''ACCOUNTED_CR'',
                            ''ACCOUNTED_DR'')
                AND COALESCE (gjl.accounted_dr, gjl.accounted_cr, 0) <> 0)
            OR COALESCE (gjl.accounted_dr, gjl.accounted_cr, 0) = 0)
       AND jtl.org_id IN (##$$VALID_ORGS$$##)
       AND jtl.organization_id =
           NVL (##$$P_ORGANIZATION_ID$$##, jtl.organization_id)
       AND TRUNC (jtl.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''',
      p_title                  => 'GST Sales Order and Inter Org Shipment Tax Accounting Reconciliation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'GST sales order and inter org transfer taxes accounting mismatch with general ledger accounting.',
      p_solution               => '<ul>
<li>Please review the tax amount details for the specific problematic transaction number / tax invoice number. See [2356043/KB695232].</li>
<li>This requires datafix to remove corruption. Please log Service request using My Oracle Support</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PC_SO_IOT_SHIPMENT_RECON');



debug('begin add_signature: GST_PC_AR_DM_CM_RECON');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13445',
      p_sig_id                 => 'GST_PC_AR_DM_CM_RECON',
      p_sig_sql                => '/* Formatted on 12/7/2019 12:49:13 PM (QP5 v5.354) */
SELECT jtl.entity_code,
       jtl.trx_id,
       jtl.trx_line_id,
       jtl.trx_loc_line_id,
       jtl.trx_type,
       ...
       rl.status
           "Repository Status",
       TO_CHAR (rl.recoverable_amount)
           "Recoverable Amount",
       TO_CHAR (rl.recovered_amount)
           "Recovered Amount",
       TO_CHAR (rl.liability_amount)
           "Liability Amount",
       ''NA''
           AS "GST SLA Period Name",
       ''NA''
       ...
       ''NA''
           AS "GST SLA Accounting Date",
       ''NA''
           AS "Subledger GST Dr. Account",
       ''NA''
           AS "Subledger GST Cr. Account",
       (SELECT DISTINCT ps.period_name     "Period Name"
          FROM gl_period_statuses ps, gl_sets_of_books sob
         WHERE     sob.set_of_books_id = ps.set_of_books_id
               AND ps.set_of_books_id = rdl.set_of_books_id
               AND (TRUNC (NVL (rdl.gl_posted_date, rdl.gl_date)) BETWEEN TRUNC (
                                                                              ps.start_date)
                                                                      AND TRUNC (
                                                                              ps.end_date)))
           AS "GL period name",
       TO_CHAR (rdl.acctd_amount)
           AS "GL Debit",
       TO_CHAR (rdl.acctd_amount)
           AS "GL Credit",
       DECODE (
           ...
           (SELECT gcck2.concatenated_segments
              FROM gl_code_combinations_kfv      gcck2,
                   ra_cust_trx_line_gl_dist_all  rl
             WHERE     account_class = ''REC''
                   AND rl.code_combination_id = gcck2.code_combination_id
                   -- and rl.code_combination_id=rdl.code_combination_id
                   AND rl.customer_trx_id = rdl.customer_trx_id))
           "Ledger GST Dr. Account",
       DECODE (rdl.acctd_amount,
               NULL, NULL,
               (SELECT gcck3.concatenated_segments
                  FROM gl_code_combinations_kfv gcck3
                 WHERE gcck3.code_combination_id = rdl.code_combination_id))
           "Ledger GST Cr. Account",
       (SELECT TO_CHAR (SUM (jtlv.rounded_tax_amt_fun_curr))
          FROM jai_tax_lines_v jtlv
         WHERE jtlv.trx_id = jtl.trx_id AND jtlv.trx_number = jtl.trx_number)
           AS "Sum of Total Tax Amount",
       (SELECT TO_CHAR (SUM (tax_recoverable))
          FROM ra_customer_trx_lines_all
         WHERE customer_trx_id = rcl.customer_trx_id AND line_type = ''LINE'')
           AS "Sum of Tax Amount in GLD"
  FROM apps.jai_tax_lines_v               jtl,
       apps.ra_customer_trx_lines_all     rcl,
       apps.ra_cust_trx_line_gl_dist_all  rdl,
       apps.jai_rgm_recovery_lines        rl
 WHERE     1 = 1
       AND jtl.entity_code = NVL (''TRANSACTIONS'', jtl.entity_code) --''AP_INVOICES'' -- ''RCV_TRANSACTION''
       AND jtl.event_class_code IN
               (NVL (''CREDIT_MEMO'', jtl.event_class_code),
                NVL (''DEBIT_MEMO'', jtl.event_class_code))
       --AND jtl.trx_id          = 1516705
       AND jtl.trx_id = rcl.customer_trx_id(+)
       AND jtl.trx_line_id = rcl.link_to_cust_trx_line_id(+)
       AND jtl.tax_line_num = rcl.line_number(+)
       AND jtl.trx_id = rdl.customer_trx_id(+)
       --and jtl.trx_line_id=RDL.CUSTOMER_TRX_LINE_ID
       AND rcl.customer_trx_line_id = rdl.customer_trx_line_id
       --and rdl.account_class=''REV''
       AND rcl.line_type = ''TAX''
       AND jtl.trx_id = rl.document_id(+)
       AND jtl.tax_line_id = rl.tax_line_id(+)
       AND (   (SELECT SUM (jtlv.rounded_tax_amt_fun_curr)
                  FROM jai_tax_lines_v jtlv
                 WHERE     jtlv.trx_id = jtl.trx_id
                       AND jtlv.trx_number = jtl.trx_number) <>
               (SELECT SUM (tax_recoverable)
                  FROM ra_customer_trx_lines_all
                 WHERE     customer_trx_id = rcl.customer_trx_id
                       AND line_type = ''LINE'')
            -- tax amount <> GL
            OR (jtl.rounded_tax_amt_fun_curr <> NVL (rdl.acctd_amount, 0))
            OR (jtl.rounded_tax_amt_fun_curr <>
                NVL (
                    DECODE (rl.entity_code,
                            ''TRANSACTIONS'', rl.liability_amount,
                            rl.recoverable_amount),
                    0)                                  -- repository mismatch
                      ))
       AND jtl.org_id IN (##$$VALID_ORGS$$##)
       AND jtl.organization_id =
           NVL (##$$P_ORGANIZATION_ID$$##, jtl.organization_id)
       AND TRUNC (jtl.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
       AND jtl.tax_point_basis = ''INVOICE''
       AND EXISTS
               (SELECT 1
                  FROM jai_tax_types_v
                 WHERE     tax_type_id IN (SELECT DISTINCT tax_type_id
                                             FROM jai_tax_lines
                                            WHERE trx_id = jtl.trx_id)
                       AND tax_point_basis IS NOT NULL
                       AND NVL (self_assessed_flag, ''N'') <> ''Y''
                       AND NVL (reporting_only_flag, ''N'') <> ''Y'')
UNION
SELECT jtl.entity_code,
       jtl.trx_id,
       jtl.trx_line_id,
       ...
       ''AR Distributions not created''
           AS "Sum of Tax Amount in GLD"
  FROM apps.jai_tax_lines_v jtl, apps.jai_rgm_recovery_lines rl
 WHERE     1 = 1
       AND jtl.entity_code = NVL (''TRANSACTIONS'', jtl.entity_code) --''AP_INVOICES'' -- ''RCV_TRANSACTION''
       AND jtl.event_class_code IN
               (NVL (''CREDIT_MEMO'', jtl.event_class_code),
       ...
       AND NOT EXISTS
               (SELECT 1
                 ...
                 WHERE     jtl.trx_id = rcl.customer_trx_id
                       AND jtl.trx_line_id = rcl.link_to_cust_trx_line_id
                       AND jtl.tax_line_num = rcl.line_number
                       AND line_type = ''TAX'')
       AND jtl.org_id IN (##$$VALID_ORGS$$##)
       ...
       AND EXISTS
               (SELECT 1
                 ...
                 WHERE     tax_type_id IN (SELECT DISTINCT tax_type_id
                       ...
                       AND NVL (reporting_only_flag, ''N'') <> ''Y'')
ORDER BY 2, 3',
      p_title                  => 'GST AR Debit and Credit Memo Invoices Reconciliation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There exists mismatch between GST Ledger taxes versus general ledger accounted amounts.',
      p_solution               => '<ul>
<li>Please review the tax amount details for the specific problematic transaction number / tax invoice number. See [2356043/KB695232].</li>
<li>This requires datafix to remove corruption. Please log Service request using My Oracle Support</li>
</ul>',
   ...
   l_info.delete;
debug('end add_signature: GST_PC_AR_DM_CM_RECON');



debug('begin add_signature: GST_PC_AR_INVOICE_RECON');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13448',
      p_sig_id                 => 'GST_PC_AR_INVOICE_RECON',
      p_sig_sql                => '/*Mismatch in amounts in transaction,repository and GLD*/
SELECT jtl.entity_code,
       jtl.trx_id,
       jtl.trx_line_id,
       jtl.trx_loc_line_id,
       ...
       (SELECT TO_CHAR (SUM (tax_recoverable))
         ...
         WHERE customer_trx_id = rcl.customer_trx_id AND line_type = ''LINE'')
           AS "Sum of Tax Amount in GLD"
  FROM apps.jai_tax_lines_v               jtl---,    apps.jai_tax_journal_entries jtje
                                             --,    apps.gl_je_lines gjl
                                             ,
       apps.ra_customer_trx_lines_all     rcl,
       apps.ra_cust_trx_line_gl_dist_all  rdl,
 ...
 WHERE     1 = 1
       AND jtl.entity_code = NVL (''TRANSACTIONS'', jtl.entity_code) --''AP_INVOICES'' -- ''RCV_TRANSACTION''
       AND jtl.event_class_code = NVL (''INVOICE'', jtl.event_class_code)
       --AND jtl.trx_id          = 1516705
       AND jtl.trx_id = rcl.customer_trx_id(+)
       AND jtl.trx_line_id = rcl.link_to_cust_trx_line_id(+)
       AND jtl.tax_line_num = rcl.line_number(+)
       ...
       AND jtl.organization_id =
           NVL (##$$P_ORGANIZATION_ID$$##, jtl.organization_id)
       AND TRUNC (jtl.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
/*Data matching in transaction and Repository but not created in GLD */
UNION
SELECT jtl.entity_code,
       jtl.trx_id,
       jtl.trx_line_id,
 ...
 WHERE     1 = 1
       ...
       AND jtl.organization_id =
           NVL (##$$P_ORGANIZATION_ID$$##, jtl.organization_id)
       AND TRUNC (jtl.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
/*Sales Order cases with TPB=DELIVERY*/
UNION
SELECT jtl.entity_code,
       jtl.trx_id,
       jtl.trx_line_id,
       ...
       jtl.recoverable_flag
           "Recoverable?",
       ''NA as Liability is booked at Sales Order Shipment''
           "Repository Status",
       ''NA as Liability is booked at Sales Order Shipment''
           "Recoverable Amount",
       ''NA as Liability is booked at Sales Order Shipment''
 ...
 WHERE     1 = 1
       ...
       AND (   (SELECT SUM (jtlv.rounded_tax_amt_fun_curr)
               ...
               (SELECT SUM (tax_recoverable)
                 ...
                 WHERE     customer_trx_id = rcl.customer_trx_id
                       AND line_type = ''LINE'')
            -- tax amount <> GL
            OR (jtl.rounded_tax_amt_fun_curr <> NVL (rdl.acctd_amount, 0))--OR ( jtl.rounded_tax_amt_fun_curr <> NVL(DECODE(rl.entity_code, ''TRANSACTIONS'',rl.liability_amount,rl.recoverable_amount ),0) -- repository mismatch
                                                                          -- )
                                                                          )
       AND jtl.tax_point_basis = ''DELIVERY''
       ...
       AND jtl.organization_id =
           NVL (##$$P_ORGANIZATION_ID$$##, jtl.organization_id)
       AND TRUNC (jtl.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
/*Sales Order cases with TPB=DELIVERY where Tax lines are not imported to GLD*/
UNION
SELECT jtl.entity_code,
       jtl.trx_id,
       jtl.trx_line_id,
...
SELECT DISTINCT
       ...
       gjl.period_name
           AS "GL period name",
       TO_CHAR (gjl.accounted_dr)
           AS "GL Debit",
       TO_CHAR (gjl.accounted_cr)
           AS "GL Credit",
       DECODE (gjl.accounted_dr,
               NULL, NULL,
               (SELECT gcck2.concatenated_segments
 ...
 WHERE     1 = 1
       ...
       AND jtl.organization_id =
           NVL (##$$P_ORGANIZATION_ID$$##, jtl.organization_id)
       AND TRUNC (jtl.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
       AND jtl.tax_point_basis IN ''DELIVERY''
       AND EXISTS
               (SELECT 1
                  FROM jai_tax_types_v
                 WHERE     tax_type_id IN (SELECT DISTINCT tax_type_id
                       ...
                       AND NVL (reporting_only_flag, ''N'') <> ''Y'')
ORDER BY 2, 3',
      p_title                  => 'GST AR Invoice Taxes Amount Reconciliation With Sales Order Shipment And Invoice Distributions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'GST AR invoice taxes amount mismatch with sales order shipment and invoice distributions.',
      p_solution               => '<ul>
<li>Please review the tax amount details for the specific problematic transaction number / tax invoice number. See [2356043/KB695232].</li>
<li>This requires datafix to remove corruption. Please log Service request using My Oracle Support</li>
</ul>',
   ...
   l_info.delete;
debug('end add_signature: GST_PC_AR_INVOICE_RECON');



debug('begin add_signature: GST_PC_AR_RECEIPTS_RECON');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13444',
      p_sig_id                 => 'GST_PC_AR_RECEIPTS_RECON',
      p_sig_sql                => '(SELECT jtje.journal_entry_id,
        jtl.entity_code
            "Entity Type",
        DECODE (jtl.trx_type, ''CASH'', ''Advanced Receipt'', jtl.trx_type)
            "Transaction Type",
        jtl.trx_number
            "Document Number",
        jtl.trx_line_number
            "Document Line No.",
        jtl.tax_invoice_date
            "Tax Invoice Number",
        jtl.tax_invoice_date
            "Tax Invoice date",
        jtl.trx_line_quantity
        ...
        acra.comments
            "Description",
        DECODE (jtl.event_type_code,
                ''RECEIPT_CREATE'', ''Receipt tax confirm'',
                jtl.event_type_code)
            "Event",
        jtl.tax_type_code
            "Tax Type Code",
        ...
        jtl.rounded_tax_amt_fun_curr
            "Transaction Tax Amount",
        jrrl.liability_amount
            "GST Repository Amount",
        jrrl.status
            "Repository Status",
        jrrl.recoverable_amount
            "Recoverable Amount",
        jrrl.recovered_amount
            "Recovered Amount",
        DECODE (jtje.accounted_dr,
                NULL, NULL,
                (SELECT gcck.concatenated_segments
        ...
        DECODE (
            ...
            (SELECT gcck1.concatenated_segments
              ...
              WHERE gcck1.code_combination_id = jtje.code_combination_id))
            "Subledger GST Cr. Account",
        NVL (jtje.accounted_dr, jtje.accounted_cr)
            "SL tax accouned Amount",
        jtje.period_name
            "Sub Ledger Period Name",
        DECODE (gjl.accounted_dr,
                NULL, NULL,
                (SELECT gcck2.concatenated_segments
                   FROM gl_code_combinations_kfv gcck2
        ...
        NVL (gjl.accounted_dr, gjl.accounted_cr)
            "GL tax accouned Amount",
        gjl.period_name
            "GL Period Name"
   FROM jai_tax_lines_v          jtl,
        ar_cash_receipts_all     acra,
        jai_rgm_recovery_lines   jrrl,
        jai_tax_journal_entries  jtje,
        gl_je_lines              gjl
  WHERE     jtl.det_factor_id = jtje.tax_det_factor_id
        AND jtl.trx_id = jrrl.document_id
        AND jtl.trx_id = acra.cash_receipt_id
        AND jtl.tax_line_id = jrrl.tax_line_id
        AND jtl.tax_line_id = jtje.tax_line_id
        AND TO_CHAR (jtje.tax_det_factor_id) = gjl.reference_3(+)
        AND TO_CHAR (jtje.tax_line_id) = gjl.reference_4(+)
        AND jtje.tax_dist_id IS NULL
        AND gjl.reference_5 IS NULL
        AND jrrl.base_trx_id IS NULL
        AND jtje.code_combination_id = gjl.code_combination_id(+)
        AND (   jtl.rounded_tax_amt_fun_curr <>
                COALESCE (jtje.accounted_dr, jtje.accounted_cr, 0) -- tax amount <> GST SLA
             OR jtl.rounded_tax_amt_fun_curr <>
                COALESCE (gjl.accounted_dr, gjl.accounted_cr, 0) -- tax amount <> GL
             OR COALESCE (jtje.accounted_dr, jtje.accounted_cr, 0) <>
                COALESCE (gjl.accounted_dr, gjl.accounted_cr, 0) -- GST SLA <> GL
             OR (ABS (jtl.rounded_tax_amt_fun_curr) <>
                 ABS (jrrl.liability_amount))           -- repository mismatch
                                             )
        AND jtje.user_je_category_name IN (''Receipt Create'')
        AND jtl.entity_code = ''RECEIPTS''
        AND jtl.org_id IN (##$$VALID_ORGS$$##)
        AND jtl.organization_id =
            NVL (##$$P_ORGANIZATION_ID$$##, jtl.organization_id)
        AND TRUNC (jtl.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##'') --enter date in dd-MON-YY format
UNION
(SELECT jtje.journal_entry_id,
        jtl.entity_code
            "Entity Type",
        DECODE (jtl.trx_type, ''CASH'', ''Advanced Receipt'', jtl.trx_type)
            "Transaction Type",
        ...
        DECODE (
            ...
            ''AP_REFUND_REQUEST'', ''Receipt Refund'',
            (DECODE (SIGN (amount_applied),
                     ''1'', ''Receipt 
Application'',
                     ''-1'', ''Receipt Unapplication'')))
            "Event",
        jtl.tax_type_code
            "Tax Type Code",
        jtl.recoverable_flag
  ...
  WHERE     jtl.det_factor_id = jtje.tax_det_factor_id
        ...
        AND jtl.tax_line_id = jrrl.tax_line_id
        AND jrrl.base_trx_id = jtje.tax_dist_id
        AND jtl.det_factor_id = jtje.tax_det_factor_id
        AND jtl.tax_line_id = jtje.tax_line_id
        AND araa.receivable_application_id = jrrl.base_trx_id
        AND TO_CHAR (jtje.tax_det_factor_id) = gjl.reference_3(+)
        AND TO_CHAR (jtje.tax_line_id) = gjl.reference_4(+)
        AND TO_CHAR (jtje.tax_dist_id) = gjl.reference_5(+)
        AND jtje.code_combination_id = gjl.code_combination_id(+)
        AND (   jtl.rounded_tax_amt_fun_curr <>
                COALESCE (jtje.accounted_dr, jtje.accounted_cr, 0) -- tax amount <> GST SLA
             OR jtl.rounded_tax_amt_fun_curr <>
        ...
        AND jtje.user_je_category_name IN (''Receipt Apply'')
        AND jtl.entity_code = ''RECEIPTS''
        AND jtl.org_id IN (##$$VALID_ORGS$$##)
        AND jtl.organization_id =
            NVL (##$$P_ORGANIZATION_ID$$##, jtl.organization_id)
        AND TRUNC (jtl.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##'')',
      p_title                  => 'GST AR Receipts Reconciliation With General Ledger Accounting',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Reconciliation of AR advance receipt taxes accounting and receipt application/un-application events accounting with GL.',
      p_solution               => '<ul>
<li>Please review the tax amount details for the specific problematic transaction number / tax invoice number. See [2356043/KB695232].</li>
<li>This requires datafix to remove corruption. Please log Service request using My Oracle Support</li>
</ul>',
   ...
   l_info.delete;
debug('end add_signature: GST_PC_AR_RECEIPTS_RECON');



debug('begin add_signature: GST_PC_INV_RECEIPT_TAXES_RECON');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13447',
      p_sig_id                 => 'GST_PC_INV_RECEIPT_TAXES_RECON',
      p_sig_sql                => 'SELECT jtl.trx_id,
         jtl.trx_line_id,
         jtl.trx_loc_line_id,
         jtl.tax_line_id,
         ...
         jtl.rounded_tax_amt_fun_curr
             "Transaction Tax Amount",
         (SELECT NVL (df.tax_confirmed_flag, ''N'')
            FROM jai_tax_det_factors df
           WHERE df.det_factor_id = jtl.det_factor_id)
             "Tax Confrimed Flag",
         jtl.recoverable_flag
             "Recoverable?",
         rl.status
   ...
   WHERE     1 = 1
         ...
         AND jtl.trx_id = rl.document_id(+)
         AND jtl.tax_line_id = rl.tax_line_id(+)
         AND (   ABS (jtl.rounded_tax_amt_fun_curr) <>
                 COALESCE (jtje.accounted_dr, jtje.accounted_cr, 0) -- tax amount <> GST SLA
              OR ABS (jtl.rounded_tax_amt_fun_curr) <>
                 COALESCE (gjl.accounted_dr, gjl.accounted_cr, 0) -- tax amount <> GL
              OR COALESCE (jtje.accounted_dr, jtje.accounted_cr, 0) <>
                 COALESCE (gjl.accounted_dr, gjl.accounted_cr, 0) -- GST SLA <> GL
              OR ABS (jtl.rounded_tax_amt_fun_curr) <> rl.recoverable_amount -- repository mismatch
                                                                            )
         AND (   (    DECODE (jtje.accounted_dr,
                              NULL, ''ACCOUNTED_CR'',
                              ''ACCOUNTED_DR'') =
         ...
         AND TRUNC (jtl.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
ORDER BY 1, 2, 3',
      p_title                  => 'Inventory Receipt Taxes Reconciliation With General Ledger Accounting',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Receipt taxes accounting does not match with general ledger accounting entries.',
      p_solution               => '<ul>
<li>Please review the tax amount details for the specific problematic transaction number / tax invoice number. See [2356043/KB695232].</li>
<li>This requires datafix to remove corruption. Please log Service request using My Oracle Support</li>
</ul>',
   ...
   l_info.delete;
debug('end add_signature: GST_PC_INV_RECEIPT_TAXES_RECON');



debug('begin add_signature: GST_PC_NR_TAX_NOT_ADDED_TO_ITEM_COST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13443',
      p_sig_id                 => 'GST_PC_NR_TAX_NOT_ADDED_TO_ITEM_COST',
      p_sig_sql                => 'SELECT jtl.trx_id,
         jtl.trx_line_id,
         jtl.trx_loc_line_id,
         jtl.tax_line_id,
         ...
         (SELECT NVL (df.tax_confirmed_flag, ''N'')
           ...
           WHERE df.det_factor_id = jtl.det_factor_id)
             "Tax Confirmed Flag"
    FROM jai_tax_lines_v jtl, rcv_transactions rt
   WHERE     1 = 1
         AND jtl.entity_code = ''RCV_TRANSACTION''
         AND jtl.application_id = 707
         AND rt.transaction_type = ''DELIVER''
         ...
         AND jtl.rounded_tax_amt_fun_curr > 0
         AND NVL (self_assessed_flag, ''N'') <> ''Y''
         AND NVL (jtl.recoverable_flag, ''N'') <> ''Y''
         AND NVL (jtl.inclusive_flag, ''N'') = ''N''
         AND jtl.tax_point_basis = ''DELIVERY''
         AND jtl.org_id IN (##$$VALID_ORGS$$##)
         AND jtl.organization_id =
             NVL (##$$P_ORGANIZATION_ID$$##, jtl.organization_id)
         ...
         AND EXISTS
                 (SELECT 1
                    FROM mtl_system_items msi
                   WHERE     msi.inventory_item_id = jtl.item_id
         ...
         AND EXISTS
                 (SELECT 1
                   ...
                   WHERE     organization_id = jtl.organization_id
                         AND secondary_inventory_name = rt.subinventory
                         AND asset_inventory = 1 -- 1: Inventory 2:non-inventory
                                                )
         AND NOT EXISTS
                 (SELECT 1
                    FROM mtl_material_transactions mmt
                   WHERE     mmt.source_code = ''Localization-Value Change''
                         AND mmt.transaction_source_type_id = 13
                         AND mmt.transaction_action_id = 24
                         AND mmt.transaction_type_id = 80
                         AND mmt.transaction_reference =
                             TO_CHAR (jtl.trx_loc_line_id))
ORDER BY 1, 2, 3',
      p_title                  => 'Non Recoverable Taxes Not Added To Item Cost',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'For inventory receipts, non recoverable taxes are not added or loaded to item cost.',
      p_solution               => '<ul>
<li>Please review the tax amount details for the specific problematic transaction number / tax invoice number. See [2356043/KB695232].</li>
<li>This requires datafix to remove corruption. Please log Service request using My Oracle Support</li>
</ul>',
   ...
   l_info.delete;
debug('end add_signature: GST_PC_NR_TAX_NOT_ADDED_TO_ITEM_COST');



debug('begin add_signature: GST_PC_AP_INVOICES_RECON');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13450',
      p_sig_id                 => 'GST_PC_AP_INVOICES_RECON',
      p_sig_sql                => 'SELECT aia.invoice_id,
       aia.invoice_type_lookup_code,
       aia.invoice_num,
       jtlv.trx_type,
       ...
       jtlv.trx_line_number
           AS "Document Line No.",
       jtlv.trx_line_quantity
           "Line Qty",
       (SELECT segment1
          FROM mtl_system_items_b
         WHERE     inventory_item_id = jtlv.item_id
               AND organization_id = jtlv.organization_id)
           "Description/item Details",
       ...
       jtlv.tax_rate_name
           "Tax Rate Name",
       jtlv.rounded_tax_amt_fun_curr
           "Taxable Amount",
       jtlv.actual_tax_rate
           "Tax Rate",
       jtlv.rounded_tax_amt_fun_curr
           "Transaction Tax Amount",
       jtlv.recoverable_flag
           "Recoverable?",
       jrrl.status
           "Repository Status",
       jrrl.recoverable_amount
  ...
  FROM jai_tax_lines_v          jtlv,
       ...
       jai_tax_journal_entries  jtje,
       gl_je_lines              gjl
 WHERE     aia.invoice_id = jtlv.trx_id
       AND aia.invoice_type_lookup_code IN (''STANDARD'')
       AND jtlv.trx_id = jtdf.trx_id
       AND jtlv.trx_id = jrrl.document_id(+) -- entry in tax but not in repository
       AND TO_CHAR (jtlv.det_factor_id) = gjl.reference_3(+)
       AND TO_CHAR (jtlv.tax_line_id) = gjl.reference_4(+)
       AND jtlv.det_factor_id = jtje.tax_det_factor_id(+)
       AND jtlv.tax_line_id = jtje.tax_line_id(+)
       AND jtlv.recoverable_flag = ''Y''
       AND jtlv.self_assessed_flag = ''N''
       AND jtlv.entity_code = ''AP_INVOICES''
       AND (   ABS (jtlv.rounded_tax_amt_fun_curr) <>
               ABS (
                   COALESCE (jrrl.recovered_amount, jrrl.recoverable_amount)) -- tax lines with repository
            OR (   jtdf.original_tax_invoice_num IS NULL
                OR jtdf.original_tax_invoice_date IS NULL
                OR jrrl.process_action <> ''RECOVER'')
            OR (ABS (jrrl.recoverable_amount) <> ABS (jrrl.recovered_amount))
            OR (ABS (jtlv.rounded_tax_amt_fun_curr) <>
                ABS (COALESCE (gjl.accounted_dr, gjl.accounted_cr, 0))) -- taxes lines with GL lines
            OR (ABS (jtlv.rounded_tax_amt_fun_curr) <>
                ABS (
                    DECODE (jrrl.entity_code,
                            ''AP_INVOICES'', jrrl.recoverable_amount,
                            jrrl.liability_amount))) -- mismatch with repository
            OR (ABS (jtlv.rounded_tax_amt_fun_curr) <>
                ABS (COALESCE (jtje.accounted_dr, jtje.accounted_cr, 0))) -- tax amount <> GST SLA )
            OR (ABS (COALESCE (jtje.accounted_dr, jtje.accounted_cr, 0))) <>
               ABS ((COALESCE (gjl.accounted_dr, gjl.accounted_cr, 0))) -- GST SLA <> GL
                                                                       )
       AND jtlv.org_id IN (##$$VALID_ORGS$$##)
       AND jtlv.organization_id =
           NVL (##$$P_ORGANIZATION_ID$$##, jtlv.organization_id)
       AND TRUNC (jtlv.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''',
      p_title                  => 'GST Payables Invoices Taxes Reconciliation With General Ledger',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'GST payables invoices taxes reconciliation with GST sub-ledger and general ledger accounting entries.',
      p_solution               => '<ul>
<li>Please review the tax amount details for the specific problematic transaction number / tax invoice number. See [2356043/KB695232].</li>
<li>This requires datafix to remove corruption. Please log Service request using My Oracle Support</li>
</ul>',
   ...
   l_info.delete;
debug('end add_signature: GST_PC_AP_INVOICES_RECON');



debug('begin add_signature: GST_PC_RCM_TAX_RECON');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13446',
      p_sig_id                 => 'GST_PC_RCM_TAX_RECON',
      p_sig_sql                => '/* Formatted on 12/7/2019 12:26:36 PM (QP5 v5.354) */
-- Query to get the list of Invoices having RCM taxes and having any discrepency in repository , IL subledger or GL journal tables

SELECT jtl.trx_number
           AS "Document No.",
       jtl.trx_type
           AS "Document Type",
       jtl.trx_date
       ...
       DECODE (gjl.accounted_cr,
               ...
               (SELECT gcck3.concatenated_segments
                 ...
                 WHERE gcck3.code_combination_id = gjl.code_combination_id))
           "Ledger GST Cr. Account",
       ''Invoices with RCM recoverable taxes and having any discrepency in repository , IL subledger or GL journal tables''
           remarks
  FROM ap_invoices_all               aia,
       apps.jai_tax_lines_v          jtl,
       apps.jai_tax_journal_entries  jtje,
       apps.gl_je_lines              gjl,
       apps.jai_rgm_recovery_lines   rl
 WHERE     aia.invoice_id = jtl.trx_id
       AND jtl.entity_code = ''AP_INVOICES''
       AND jai_rgm_recovery_pkg.get_inv_status (aia.invoice_id) IN
               (''APPROVED'',
                ''VALIDATED'',
                ''AVAILABLE'',
                ''FULL'')
       ...
       AND jtl.det_factor_id = jtje.tax_det_factor_id(+)
       AND jtl.tax_line_id = jtje.tax_line_id(+)
       AND jtl.event_type_code = jtje.event_type_code(+)
       AND TO_CHAR (jtl.det_factor_id) = gjl.reference_3(+)
       AND TO_CHAR (jtl.tax_line_id) = gjl.reference_4(+)
       AND TO_CHAR (jtl.event_type_code) = gjl.reference_6(+)
       AND jtl.trx_id = rl.document_id(+)
       AND jtl.tax_line_id = rl.tax_line_id(+)
       AND jtl.event_type_code = rl.event_type_code(+)
       AND (   jtl.rounded_tax_amt_fun_curr <>
               COALESCE (jtje.accounted_dr, jtje.accounted_cr, 0) -- tax amount <> GST SLA
            OR jtl.rounded_tax_amt_fun_curr <>
               COALESCE (gjl.accounted_dr, gjl.accounted_cr, 0) -- tax amount <> GL
            OR COALESCE (jtje.accounted_dr, jtje.accounted_cr, 0) <>
               COALESCE (gjl.accounted_dr, gjl.accounted_cr, 0) -- GST SLA <> GL
            OR (jtl.rounded_tax_amt_fun_curr <>
                DECODE (rl.tax_event_type_code,
                        ''VALIDATE'', rl.recoverable_amount,
                        ABS (rl.liability_amount))      -- repository mismatch
                                                  ))
       AND (   (    DECODE (jtje.accounted_dr,
                            NULL, ''ACCOUNTED_CR'',
                            ''ACCOUNTED_DR'') =
       ...
       AND jtl.organization_id =
           NVL (##$$P_ORGANIZATION_ID$$##, jtl.organization_id)
       AND TRUNC (jtl.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
-- Query to get the list of Prepayment applications having RCM taxes and with discrepency in repository , IL subledger or GL journal tables
UNION
SELECT jtl.trx_number
           AS "Document No.",
       jtl.trx_type
       ...
       DECODE (gjl.accounted_cr,
               ...
               (SELECT gcck3.concatenated_segments
                 ...
                 WHERE gcck3.code_combination_id = gjl.code_combination_id))
           "Ledger GST Cr. Account",
       ''Prepayment applications having RCM recoverable taxes and with discrepency in repository , IL subledger or GL journal tables''
           remarks
  FROM ap_invoices_all               aia,
       apps.jai_tax_lines_v          jtl,
       apps.jai_tax_journal_entries  jtje,
 ...
 WHERE     aia.invoice_id = jtl.trx_id
       ...
       AND jtl.trx_id = rl.document_id(+)
       AND jtl.tax_line_id = rl.tax_line_id(+)
       AND NVL (jtje.event_type_code, ''STANDARD DISTRIBUTE'') =
           ''STANDARD DISTRIBUTE''
       AND NVL (rl.event_type_code, ''STANDARD DISTRIBUTE'') =
           ''STANDARD DISTRIBUTE''
       AND NVL (gjl.reference_6, ''STANDARD DISTRIBUTE'') =
           ''STANDARD DISTRIBUTE''
       AND (   jtl.rounded_tax_amt_fun_curr <>
               COALESCE (jtje.accounted_dr, jtje.accounted_cr, 0) -- tax amount <> GST SLA
            OR jtl.rounded_tax_amt_fun_curr <>
            ...
            OR COALESCE (jtje.accounted_dr, jtje.accounted_cr, 0) <>
               COALESCE (gjl.accounted_dr, gjl.accounted_cr, 0) -- GST SLA <> GL
            OR (jtl.rounded_tax_amt_fun_curr <> ABS (rl.liability_amount)) -- repository mismatch
                                                                          )
       AND (   (    DECODE (jtje.accounted_dr,
                            NULL, ''ACCOUNTED_CR'',
                            ''ACCOUNTED_DR'') =
       ...
       AND jtl.organization_id =
           NVL (##$$P_ORGANIZATION_ID$$##, jtl.organization_id)
       AND TRUNC (jtl.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
-- Query to get the list of cancelled Invoices having RCM taxes and with discrepency in repository , IL subledger or GL journal tables
UNION
SELECT jtl.trx_number
           AS "Document No.",
       jtl.trx_type
       ...
       DECODE (gjl.accounted_cr,
               ...
               (SELECT gcck3.concatenated_segments
                 ...
                 WHERE gcck3.code_combination_id = gjl.code_combination_id))
           "Ledger GST Cr. Account",
       ''cancelled Invoices having RCM recoverable taxes and with discrepency in repository , IL subledger or GL journal tables''
           remarks
  FROM ap_invoices_all               aia,
       apps.jai_tax_lines_v          jtl,
       apps.jai_tax_journal_entries  jtje,
 ...
 WHERE     aia.invoice_id = jtl.trx_id
       AND jtl.entity_code = ''AP_INVOICES''
       AND jai_rgm_recovery_pkg.get_inv_status (aia.invoice_id) = ''CANCELLED''
       AND jtl.self_assessed_flag = ''Y''
       AND jtl.recoverable_flag = ''Y''
       AND jtl.det_factor_id = jtje.tax_det_factor_id(+)
       AND jtl.tax_line_id = jtje.tax_line_id(+)
       ...
       AND jtl.trx_id = rl.document_id(+)
       AND jtl.tax_line_id = rl.tax_line_id(+)
       AND NVL (jtje.event_type_code, ''STANDARD CANCELLED TAX'') =
           ''STANDARD CANCELLED TAX''
       AND NVL (rl.event_type_code, ''STANDARD CANCELLED TAX'') =
           ''STANDARD CANCELLED TAX''
       AND NVL (gjl.reference_6, ''STANDARD CANCELLED TAX'') =
           ''STANDARD CANCELLED TAX''
       AND (   jtl.original_tax_amt <>
               COALESCE (jtje.accounted_dr, jtje.accounted_cr, 0) -- tax amount <> GST SLA
            OR jtl.original_tax_amt <>
               COALESCE (gjl.accounted_dr, gjl.accounted_cr, 0) -- tax amount <> GL
            OR COALESCE (jtje.accounted_dr, jtje.accounted_cr, 0) <>
               COALESCE (gjl.accounted_dr, gjl.accounted_cr, 0) -- GST SLA <> GL
            OR (jtl.original_tax_amt <> ABS (rl.liability_amount)) -- repository mismatch
                                                                  )
       AND (   (    DECODE (jtje.accounted_dr,
                            NULL, ''ACCOUNTED_CR'',
                            ''ACCOUNTED_DR'') =
       ...
       AND TRUNC (jtl.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''
UNION
SELECT jtl.trx_number                                                                    AS "Document No.",
       jtl.trx_type                                                                      AS "Document Type",
       jtl.trx_date                                                                      AS "Document Date",
       jtl.trx_line_number                                                               AS "Document Line No.",
       jtl.event_type_code                                                               event,
       jtl.tax_type_name                                                                 "Tax Type Name",
       jtl.tax_rate_name                                                                 "Tax Rate Name",
       jtl.actual_tax_rate                                                               "Tax Rate",
       jtl.rounded_tax_amt_fun_curr                                                      "Tax Amount",
       jtl.event_type_code                                                               AS "Event type code",
       NULL                                                                              "Recoverable?",
       NULL                                                                              "Repository Status",
       NULL                                                                              "Recoverable Amount",
       NULL                                                                              "Recovered Amount",
       NULL                                                                              "Liability Amount",
       NULL                                                                              "GST SLA Period Name",
       NULL                                                                              "GST SLA Debit",
       NULL                                                                              "Subledger GST Dr. Account",
       NULL                                                                              "GST SLA Credit",
       NULL                                                                              "Subledger GST Cr. Account",
       NULL                                                                              "GST SLA Accounting Date",
       NULL                                                                              "GL period name",
       NULL                                                                              "GL Debit",
       NULL                                                                              "Ledger GST Dr. Account",
       NULL                                                                              "GL Credit",
       NULL                                                                              "Ledger GST Cr. Account",
       ''Invoice having RCM recoverable Taxes but did not generate repository entries''    remarks
  FROM ap_invoices_all aia, apps.jai_tax_lines_v jtl
 WHERE     aia.invoice_id = jtl.trx_id
       AND jtl.entity_code = ''AP_INVOICES''
       AND jai_rgm_recovery_pkg.get_inv_status (aia.invoice_id) IN
               (''APPROVED'',
       ...
       AND NOT EXISTS
               (SELECT 1
                  FROM jai_rgm_recovery_lines rl
                 WHERE     rl.document_id = aia.invoice_id
                       AND rl.entity_code = ''AP_INVOICES'')
       AND jtl.org_id IN (##$$VALID_ORGS$$##)
       AND jtl.organization_id =
           NVL (##$$P_ORGANIZATION_ID$$##, jtl.organization_id)
       AND TRUNC (jtl.trx_date) BETWEEN ''##$$SDT$$##'' AND ''##$$EDT$$##''',
      p_title                  => 'GST Reverse Charge Taxes Accounting Reconciliation With General Ledger Entries',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Discrepancy between reverse charge taxes and general ledger entries amounts.',
      p_solution               => '<ul>
<li>Please review the tax amount details for the specific problematic transaction number / tax invoice number. See [2356043/KB695232].</li>
<li>This requires datafix to remove corruption. Please log Service request using My Oracle Support</li>
</ul>',
   ...
   l_info.delete;
debug('end add_signature: GST_PC_RCM_TAX_RECON');



debug('begin add_signature: GST_IL_LICENSE_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7562',
      p_sig_id                 => 'GST_IL_LICENSE_STATUS',
      p_sig_sql                => 'SELECT IL_GST_ANALYZER_PKG.is_il_licensed() IL_LICENSE_STATUS FROM DUAL',
      p_title                  => 'India Localization License setup',
      p_fail_condition         => '[IL_LICENSE_STATUS] <> [India Localization License Setup is Done]',
      p_problem_descr          => 'India Localization License Setup is not complete.',
      p_solution               => 'See [1585265/KB645325] Why JA (Oracle Financial For India) objects are not compiled while compiling through Ad Admin Utility?',
      p_success_msg            => 'India Localization License Setup is complete.',
   ...
   l_info.delete;
debug('end add_signature: GST_IL_LICENSE_STATUS');



debug('begin add_signature: GST_IL_LICENSE_INFO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7569',
      p_sig_id                 => 'GST_IL_LICENSE_INFO',
      p_sig_sql                => 'SELECT IL_GST_ANALYZER_PKG.il_event_status() IL_EVENT_STATUS FROM DUAL',
      p_title                  => 'Mandatory JAI events Status',
      p_fail_condition         => '[IL_EVENT_STATUS] <> [Event JAI_EXISTENCE_OF_TABLES for JA is set]',
      p_problem_descr          => 'Event JAI_EXISTENCE_OF_TABLES for JA is NOT set. ',
      p_solution               => '<p>Apply jai5188052.drv</p>
<p>See [954143/KB567718] - Oracle Financial for India R12 Installation Licensing And Pre-Requisite Steps</p>',
      p_success_msg            => 'Event JAI_EXISTENCE_OF_TABLES for JA is set.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: GST_IL_LICENSE_INFO');



debug('begin add_signature: GST_INVALID_OBJECTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7586',
      p_sig_id                 => 'GST_INVALID_OBJECTS',
      p_sig_sql                => 'SELECT sequence,
       type,
       name,
       line,
       position,
 ...
 ORDER BY 3,
          1',
      p_title                  => 'Invalid Objects For Financials Of India',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'No IL Objects should be Invalid which cause data corruption integrity issues',
      p_solution               => '<ul>
...
entire APPS schema using the adadmin utility.</li>
      ...
      p_success_msg            => 'No Invalid IL Objects Found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: GST_INVALID_OBJECTS');



debug('begin add_signature: GST_REQUIRED_TRIGGERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8161',
      p_sig_id                 => 'GST_REQUIRED_TRIGGERS',
      p_sig_sql                => 'SELECT decode(data.status, ''DISABLED'', ''*'', ''ENABLED-12.2'', ''*'',
              '' '') "-",
       data.table_name,
       data.trigger_name,
       data.status
  FROM (
   SELECT table_name,
          trigger_name,
          CASE
             WHEN trigger_name in (''JAI_AP_IA_DTC_BRIUD_T1'', ''JAI_AP_HA_BRIUD_T1'')
                AND (
                SELECT substr(release_name, 4, 1)
                  FROM fnd_product_groups
             ) > 1
                AND status = ''DISABLED'' THEN
                ''DISABLED-12.2''
             WHEN trigger_name in (''JAI_AP_IA_DTC_BRIUD_T1'', ''JAI_AP_HA_BRIUD_T1'')
                AND (
                SELECT substr(release_name, 4, 1)
...
''JAI_AP_DVA_ARIUD_T1'',
''JAI_AP_IA_ARIUD_T1'',
''JAI_AP_IA_DTC_BRIUD_T1'',
''JAI_AP_IDA_BRIUD_DTC_T1'',
''JAI_AP_PSA_BRIUD_T1'',
''JAI_ARRA_AD_ARIUD_TRG'',
''JAI_AR_CR_AD_ARIUD_T1'',
''JAI_AR_RC_ARIUD_T1'',
''JAI_FA_MA_ARIUD_T1'',
''JAI_FA_MA_BRIUD_T1'',
''JAI_JAP_TY_ARIUD_T1'',
...
''JAI_JOM_LM_ARIUD_T1'',
''JAI_JOM_ST_BRIUD_T1'',
''JAI_JPO_LLT_BRIUD_T1'',
''JAI_JPO_RLT_BRIUD_T1'',
''JAI_JRG_23AC1_BRIUD_T1'',
''JAI_JRG_23AC2_BRIUD_T1'',
''JAI_JRG_OTH_BRIUD_T1'',
''JAI_JRG_PLA_BRIUD_T1'',
''JAI_OE_OHA_ARIUD_T1'',
''JAI_OE_OLA_ARIUD_T2'',
''JAI_OE_OLA_ARIUD_TRG'',
...
''JAI_AP_HA_BRIUD_T1'' )
 ...
 ORDER BY 1 DESC,
          table_name,
          trigger_name',
      p_title                  => 'GST Triggers That Must Be Enabled/Disabled',
      p_fail_condition         => '[status] in [DISABLED, ENABLED-12.2]',
      p_problem_descr          => 'In order for GST to work properly the above highlighted triggers need to be enabled/disabled.',
      p_solution               => 'see [2286133/KB339748] GST - Triggers that must be in Enabled State',
      p_success_msg            => 'All required GST triggers have the correct status.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: GST_REQUIRED_TRIGGERS');



debug('begin add_signature: GST_MISSING_TRIGGERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8162',
      p_sig_id                 => 'GST_MISSING_TRIGGERS',
      p_sig_sql                => 'select column_value Missing_Trigger_Name
from table(sys.dbms_debug_vc2coll(
''JAI_AP_DVA_ARIUD_T1'',
''JAI_AP_HA_BRIUD_T1'',
''JAI_AP_IA_ARIUD_T1'',
''JAI_AP_IDA_PROC_ARIUD_T1'',
''JAI_AP_PSA_BRIUD_T1'',
''JAI_ARRA_AD_ARIUD_TRG'',
''JAI_AR_CR_AD_ARIUD_T1'',
''JAI_AR_RC_ARIUD_T1'',
...
''JAI_RCV_RT_ARI_T1'',
''JAI_RCV_RT_BRI_T1''))
where Column_Value not in (Select Trigger_Name
from DBA_Triggers)',
      p_title                  => 'GST Triggers That Are Missing',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Some of the triggers shows as disabled. This may cause certain modules/part of GST not to work as expected. Please raise a Service Request with Oracle Support to check if the triggers are required or not.',
      p_solution               => 'see [2286133/KB339748] GST - Triggers that must be in Enabled State',
      p_success_msg            => 'All GST triggers are available and enabled.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: GST_MISSING_TRIGGERS');



debug('begin add_signature: GST_DISABLED_TRIGGERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7587',
      p_sig_id                 => 'GST_DISABLED_TRIGGERS',
      p_sig_sql                => 'SELECT table_name,trigger_name, SUBSTR(owner,1,10) OWN,status FROM all_triggers
WHERE trigger_name not in (''JAI_AP_HA_ARIUD_T1'')
AND  trigger_name like ''JA%''
ORDER BY 4,1',
      p_title                  => 'India Localization Triggers',
      p_fail_condition         => '[STATUS] = [DISABLED]',
      p_problem_descr          => 'IL triggers should always be enabled. Disabling the triggers can cause a loss of functionality and create data integrity issues.',
      p_solution               => 'See [199126/KB463261] How to Enable a Database Trigger',
      p_success_msg            => 'All IL triggers are enabled.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: GST_DISABLED_TRIGGERS');



debug('begin add_signature: GST_TRIGGER_NON_JAI');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8262',
      p_sig_id                 => 'GST_TRIGGER_NON_JAI',
    ...
    WHERE fa.application_id in (660,665,222,401,201,275)
    AND   atrg.table_owner  = fa.application_short_name
    ORDER BY atrg.table_owner, atrg.table_name, atrg.trigger_type',
      p_title                  => 'Database Triggers by Product',
      p_fail_condition         => '[status] = [DISABLED]',
      p_problem_descr          => 'You have invalid database triggers in products that are used in India Localization.  This can cause a loss of functionality and create data integrity issues. ',
      p_solution               => 'You will need to enable the triggers in order to have the proper functionality.
See [199126/KB463261] How to Enable a Database Trigger.',
      p_success_msg            => 'All IL triggers are enabled.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: GST_TRIGGER_NON_JAI');



debug('begin add_signature: GST_TRIGGER_FILE_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7588',
      p_sig_id                 => 'GST_TRIGGER_FILE_VERSIONS',
      p_sig_sql                => 'SELECT subdir, filename, VERSION
FROM ad_files af, ad_file_versions afv
WHERE app_short_name LIKE ''JA''
AND upper(filename) LIKE ''JAI%.SQL%''
AND af.file_id = afv.file_id
AND afv.file_version_id IN (SELECT MAX (file_version_id)
                            FROM ad_file_versions affv
                            WHERE afv.file_id = affv.file_id)',
      p_title                  => 'India Localization Trigger/Sql File Versions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Trigger/Sql file versions',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_TRIGGER_FILE_VERSIONS');



debug('begin add_signature: GST_REQUIRED_DISABLED_TRIGGERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8898',
      p_sig_id                 => 'GST_REQUIRED_DISABLED_TRIGGERS',
      p_sig_sql                => 'select Decode(Status, ''ENABLED'', ''*'', '' '') "-",
...
Order by Status, Table_name, Trigger_Name',
      p_title                  => 'GST Triggers that must be disabled',
      p_fail_condition         => '[status]=[ENABLED]',
      p_problem_descr          => 'In order for GST to work properly the above triggers all need to be disabled.',
      p_solution               => 'see [2286133/KB339748] GST - Triggers that must be in Enabled State',
      p_success_msg            => 'All GST triggers have been disabled.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: GST_REQUIRED_DISABLED_TRIGGERS');



debug('begin add_signature: GST_PROCEDURE_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7590',
      p_sig_id                 => 'GST_PROCEDURE_VERSIONS',
      p_sig_sql                => 'SELECT Distinct name,
                line,
                text, type
FROM all_source
WHERE name like ''JA%''
...
AND     OWNER = ''APPS''                            
AND     INSTR(text,''$H'') > 0',
      p_title                  => 'Procedure Versions For Financials For India',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Procedure versions.',
      p_solution               => '',
      p_success_msg            => 'No Procedure versions found.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: GST_PROCEDURE_VERSIONS');



debug('begin add_signature: GST_PACKAGE_SPEC_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7591',
      p_sig_id                 => 'GST_PACKAGE_SPEC_VERSIONS',
      p_sig_sql                => 'SELECT Distinct name,
                line,
                text, type
FROM all_source
...
AND     OWNER = ''APPS''                            
AND     INSTR(text,''$H'') > 0',
      p_title                  => 'Package Spec Versions For Financials For India',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Package spec versions.',
      p_solution               => '',
      p_success_msg            => 'No Package spec versions found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: GST_PACKAGE_SPEC_VERSIONS');



debug('begin add_signature: GST_PACKAGE_BODY_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7593',
      p_sig_id                 => 'GST_PACKAGE_BODY_VERSIONS',
      p_sig_sql                => 'SELECT Distinct name,
                line,
                text, type
FROM all_source
...
AND     OWNER = ''APPS''                            
AND     INSTR(text,''$H'') > 0',
      p_title                  => 'Package Body Versions For Financials For India',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Package body versions.',
      p_solution               => '',
      p_success_msg            => 'No Package body versions found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: GST_PACKAGE_BODY_VERSIONS');



debug('begin add_signature: GST_FUNCTION_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7597',
      p_sig_id                 => 'GST_FUNCTION_VERSIONS',
      p_sig_sql                => 'SELECT Distinct name,
                line,
                text, type
FROM all_source
WHERE name like ''JA%''
AND     TYPE like ''FUNCTION''
AND     OWNER = ''APPS''                            
AND     INSTR(text,''$H'') > 0',
      p_title                  => 'Function Versions For Financials For India',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Function versions.',
      p_solution               => '',
      p_success_msg            => 'No function versions found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: GST_FUNCTION_VERSIONS');



debug('begin add_signature: GST_PLL_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7602',
      p_sig_id                 => 'GST_PLL_VERSIONS',
      p_sig_sql                => 'SELECT subdir, filename, VERSION
FROM ad_files af, ad_file_versions afv
WHERE app_short_name = ''JA''
AND upper(filename) LIKE ''JAI%PLL''
AND af.file_id = afv.file_id
AND subdir = ''resource''
AND afv.file_version_id IN (SELECT MAX (file_version_id)
                            FROM ad_file_versions affv
                            WHERE afv.file_id = affv.file_id)',
      p_title                  => 'India Localization PLL Versions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'PLL versions.',
      p_solution               => '',
      p_success_msg            => 'No PLL versions.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: GST_PLL_VERSIONS');



debug('begin add_signature: GST_FMB_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7603',
      p_sig_id                 => 'GST_FMB_VERSIONS',
      p_sig_sql                => 'SELECT subdir, filename, VERSION
FROM ad_files af, ad_file_versions afv
WHERE app_short_name LIKE ''JA''
AND upper(filename) LIKE ''JAI%.FMB%''
AND af.file_id = afv.file_id
AND subdir LIKE ''%US%''
AND afv.file_version_id IN (SELECT MAX (file_version_id)
                            FROM ad_file_versions affv
                            WHERE afv.file_id = affv.file_id)',
      p_title                  => 'India Localization FMB Versions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Form FMB versions.',
      p_solution               => '',
      p_success_msg            => 'No form FMB versions.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: GST_FMB_VERSIONS');



debug('begin add_signature: GST_RDF_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7604',
      p_sig_id                 => 'GST_RDF_VERSIONS',
      p_sig_sql                => 'SELECT subdir, filename, VERSION
FROM ad_files af, ad_file_versions afv
WHERE app_short_name LIKE ''JA''
AND upper(filename) LIKE ''JAI%.RDF%''
AND af.file_id = afv.file_id
AND subdir LIKE ''%US%''
AND afv.file_version_id IN (SELECT MAX (file_version_id)
                            FROM ad_file_versions affv
                            WHERE afv.file_id = affv.file_id)',
      p_title                  => 'India Localization RDF Versions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Report versions.',
      p_solution               => '',
      p_success_msg            => 'No report versions.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: GST_RDF_VERSIONS');



debug('begin add_signature: GST_LDT_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7605',
      p_sig_id                 => 'GST_LDT_VERSIONS',
      p_sig_sql                => 'SELECT subdir, filename, VERSION
FROM ad_files af, ad_file_versions afv
WHERE app_short_name LIKE ''JA''
AND upper(filename) LIKE ''JAI%.LDT%''
AND af.file_id = afv.file_id
AND subdir LIKE ''%US%''
AND afv.file_version_id IN (SELECT MAX (file_version_id)
                            FROM ad_file_versions affv
                            WHERE afv.file_id = affv.file_id)',
      p_title                  => 'India Localization LDT Versions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'LDT versions.',
      p_solution               => '',
      p_success_msg            => 'No LDT versions.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: GST_LDT_VERSIONS');



debug('begin add_signature: GST_ODF_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7606',
      p_sig_id                 => 'GST_ODF_VERSIONS',
      p_sig_sql                => 'SELECT subdir, filename, VERSION
FROM ad_files af, ad_file_versions afv
WHERE app_short_name LIKE ''JA''
AND upper(filename) LIKE ''JAI%.ODF%''
AND af.file_id = afv.file_id
AND afv.file_version_id IN (SELECT MAX (file_version_id)
                            FROM ad_file_versions affv
                            WHERE afv.file_id = affv.file_id)',
      p_title                  => 'India Localization ODF Versions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'ODF versions.',
      p_solution               => '',
      p_success_msg            => 'No ODF versions.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: GST_ODF_VERSIONS');



debug('begin add_signature: GST_XML_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7607',
      p_sig_id                 => 'GST_XML_VERSIONS',
      p_sig_sql                => 'SELECT subdir, filename, VERSION
FROM ad_files af, ad_file_versions afv
WHERE app_short_name LIKE ''JA''
AND upper(filename) LIKE ''JAI%.XML%''
AND af.file_id = afv.file_id
AND afv.file_version_id IN (SELECT MAX (file_version_id)
                            FROM ad_file_versions affv
                            WHERE afv.file_id = affv.file_id)',
      p_title                  => 'India Localization XML Versions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'XML versions.',
      p_solution               => '',
      p_success_msg            => 'No XML versions.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: GST_XML_VERSIONS');



debug('begin add_signature: GST_RTF_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8275',
      p_sig_id                 => 'GST_RTF_VERSIONS',
      p_sig_sql                => 'SELECT subdir, filename, VERSION
FROM ad_files af, ad_file_versions afv
WHERE app_short_name LIKE ''JA''
AND upper(filename) LIKE ''JAI%.RTF%''
AND af.file_id = afv.file_id
AND afv.file_version_id IN (SELECT MAX (file_version_id)
                            FROM ad_file_versions affv
                            WHERE afv.file_id = affv.file_id)',
      p_title                  => 'India Localization RTF Versions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'RTF versions.',
      p_solution               => '',
      p_success_msg            => 'No RTF versions.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: GST_RTF_VERSIONS');



debug('begin add_signature: GST_IL_ALL_INDEX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8276',
      p_sig_id                 => 'GST_IL_ALL_INDEX',
      p_sig_sql                => 'select
  iu.name table_owner
, io.name table_name
, o.name index_name
...
from sys.user$ iu, sys.obj$ io, sys.user$ u, sys.ind$ i, sys.obj$ o, fnd_application fa, sys.all_ind_columns aic
where u.user# = o.owner#
  ...
  and fa.application_id = 7000
  and iu.name = fa.application_short_name
  and aic.index_name = o.name
  order by iu.name, io.name, o.name, aic.column_name',
      p_title                  => 'GST Table Indexes',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'GST Table Indexes',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_IL_ALL_INDEX');
...
debug('begin add_signature: GST_PATCHES_APPLIED_12_1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7574',
      p_sig_id                 => 'GST_PATCHES_APPLIED_12_1',
      p_sig_sql                => 'SELECT DISTINCT app.patch_name, patch_type, apr.orig_bug_number, success_flag,
                                                failure_comments, patch_abstract, driver_file_name
                                           FROM ad_patch_drivers apd,
                                                ad_applied_patches app,
                                                ad_patch_run_bugs apr
                                          WHERE apd.applied_patch_id = app.applied_patch_id
                                            AND apr.orig_bug_number = app.patch_name
                                            AND UPPER (apr.application_short_name) LIKE ''JA%''',
      p_title                  => 'Financials for India Patches',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Applied Patches - Financials for India.',
      p_solution               => '',
      p_success_msg            => 'No Financials for India Patches applied.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: GST_PATCHES_APPLIED_12_1');



debug('begin add_signature: GST_PATCHES_APPLIED_12_2');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7572',
      p_sig_id                 => 'GST_PATCHES_APPLIED_12_2',
      p_sig_sql                => 'SELECT distinct asp.adop_session_id, asp.bug_number, 
                (
                SELECT DISTINCT  apd.patch_abstract 
                FROM ad_patch_drivers apd,
                ad_applied_patches app
                WHERE apd.applied_patch_id = app.applied_patch_id
                AND apr.orig_bug_number = app.patch_name
                AND Rownum=1
                )patch_abstract ,asp.session_type,
       ...
       asp.applied_file_system_base, asp.patch_file_system_base,
       asp.node_name, asp.start_date, asp.end_date,
       ROUND((asp.end_date - asp.start_date) * 24*60,2) exec_time,
       asp.adpatch_options, asp.autoconfig_status, asp.driver_file_name,UPPER (apr.application_short_name)
FROM ad_adop_session_patches asp, ad_patch_run_bugs apr
WHERE session_type IN (''ADPATCH'',''HOTPATCH'',''DOWNTIME'',''ONLINE'')
AND asp.bug_number = apr.orig_bug_number
AND UPPER (apr.application_short_name) LIKE ''JA%''
ORDER BY adop_session_id, start_date, end_date',
      p_title                  => 'Financials for India Patches',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'All Applied Patches - Financials for India.',
      p_solution               => '',
      p_success_msg            => 'No Financials for India Patches applied.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: GST_PATCHES_APPLIED_12_2');
...
BEGIN
  ...
  analyzer_title := 'GST Period Close Analyzer';
...
start_section('Proactive and Preventive Recommendations', 'Proactive_Recommendations');
   IF substr(g_sql_tokens('##$$REL$$##'),1,4) = '12.1' THEN
      set_item_result(check_rec_patches_1); /* Signature GST_RUP_LEVEL_12_1 */
   END IF;
   IF substr(g_sql_tokens('##$$REL$$##'),1,4) = '12.2' THEN
      set_item_result(check_rec_patches_2); /* Signature GST_RUP_LEVEL_12_2 */
   END IF;
end_section;
debug('end section: Proactive_Recommendations');

debug('begin section: GST_Payables');
start_section('GST Payables', 'GST_Payables');
   set_item_result(run_stored_sig('GST_PC_AP_RTV_DM_DIFF_TAX'));
   set_item_result(run_stored_sig('GST_PC_AP_ERS_NO_TAX'));
   set_item_result(run_stored_sig('GST_PC_INTER_AP_AR_DIFF_TAX'));
   set_item_result(run_stored_sig('GST_PC_AP_RTV_DM_NO_TAX'));
   set_item_result(run_stored_sig('GST_PC_AP_ERS_INCOR_TAX'));
   set_item_result(run_stored_sig('GST_PC_AP_INTERCOMPANY_NO_TAX'));
   set_item_result(run_stored_sig('GST_PC_AP_DM_TAX_INV_NUM_GEN'));
end_section;
debug('end section: GST_Payables');

debug('begin section: GST_Inventory');
start_section('GST Inventory', 'GST_Inventory');
   set_item_result(run_stored_sig('GST_PC_INV_RCPT_ORPHAN_ACCT'));
   set_item_result(run_stored_sig('GST_PC_REV_ACCT_FOR_RMA_RCPT'));
   set_item_result(run_stored_sig('GST_PC_DUAL_ACCT_FOR_REC_TAX'));
   set_item_result(run_stored_sig('GST_PC_PO_TO_RCPT_RTV_DIFF_OR_NO_TAX'));
   set_item_result(run_stored_sig('GST_PC_INV_EXP_ORG_ACCT'));
   set_item_result(run_stored_sig('GST_PC_INV_RCPT_DEL_EXP_ACCT'));
   set_item_result(run_stored_sig('GST_PC_INV_RECEIVE_NO_ACCT'));
   set_item_result(run_stored_sig('GST_PC_INV_RCPT_UOM_CHG'));
   set_item_result(run_stored_sig('GST_PC_CORRECT_NEG_TAX_ACCT'));
   set_item_result(run_stored_sig('GST_PC_INV_RTV_DIFF_TAX'));
   set_item_result(run_stored_sig('GST_PC_INV_RTV_NO_TAX'));
   set_item_result(run_stored_sig('GST_PC_INV_IRISO_TO_RCT_UP_COR'));
   set_item_result(run_stored_sig('GST_PC_INV_ACC_ENT_AMT_NON_INR_REC'));
   set_item_result(run_stored_sig('GST_PC_INV_IRISO_DEL_UP_COR'));
   set_item_result(run_stored_sig('GST_PC_INV_IRISO_DEL_DIFF_NO_TAX'));
   set_item_result(run_stored_sig('GST_PC_INV_PO_RTV_UP_COR'));
   set_item_result(run_stored_sig('GST_PC_INV_IRISO_RCPT_DIFF_TAX'));
   set_item_result(run_stored_sig('GST_PC_INV_IRISO_RCPT_NO_TAX'));
   set_item_result(run_stored_sig('GST_PC_INV_PO_DEL_DIFF_OR_NO_TAX'));
   set_item_result(run_stored_sig('GST_PC_INV_RMA_TO_RCPT_TO_DEL_UP'));
end_section;
debug('end section: GST_Inventory');


debug('begin section: GST_Purchasing');
start_section('GST Purchasing', 'GST_Purchasing');
   set_item_result(run_stored_sig('GST_PC_INV_PO_RCPT_NO_TAX'));
   set_item_result(run_stored_sig('GST_PC_RECFLAG_REC_FLAG_COR'));
   set_item_result(run_stored_sig('GST_PC_INV_PO_DEL_UP_COR'));
   set_item_result(run_stored_sig('GST_PC_INV_PO_DEL_TAX_INC_AMT'));
   set_item_result(run_stored_sig('GST_PC_INV_PO_TO_RCT_UP_COR'));
   set_item_result(run_stored_sig('GST_PC_INV_PO_TO_RCPT_DIFF_TAX'));
   set_item_result(run_stored_sig('GST_PC_FP_FIRST_PARTY_NULL'));
end_section;
debug('end section: GST_Purchasing');

debug('begin section: GST_Order_To_Cash');
start_section('GST Order to Cash', 'GST_Order_To_Cash');
   set_item_result(run_stored_sig('GST_PC_RMA_NO_TAX_INV'));
   set_item_result(run_stored_sig('GST_PC_OM_DELIVERY_NO_TAX'));
end_section;
debug('end section: GST_Order_To_Cash');

debug('begin section: Reconciliation_Report');
IF upper(p_recon_report) = 'YES' THEN
   start_section('Reconciliation Report', 'Reconciliation_Report');
      set_item_result(run_stored_sig('GST_PC_SO_IOT_SHIPMENT_RECON'));
      set_item_result(run_stored_sig('GST_PC_AR_DM_CM_RECON'));
      set_item_result(run_stored_sig('GST_PC_AR_INVOICE_RECON'));
      set_item_result(run_stored_sig('GST_PC_AR_RECEIPTS_RECON'));
      set_item_result(run_stored_sig('GST_PC_INV_RECEIPT_TAXES_RECON'));
      set_item_result(run_stored_sig('GST_PC_NR_TAX_NOT_ADDED_TO_ITEM_COST'));
      set_item_result(run_stored_sig('GST_PC_AP_INVOICES_RECON'));
      set_item_result(run_stored_sig('GST_PC_RCM_TAX_RECON'));
   end_section;
END IF;
debug('end section: Reconciliation_Report');

debug('begin section: GST_Apps_Check');
start_section('GST Apps Check', 'GST_Apps_Check');
   set_item_result(run_stored_sig('GST_IL_LICENSE_STATUS'));
   IF substr(g_sql_tokens('##$$REL$$##'),1,4) = '12.1' THEN
      set_item_result(run_stored_sig('GST_PATCHES_APPLIED_12_1'));
   END IF;
   IF substr(g_sql_tokens('##$$REL$$##'),1,4) = '12.2' THEN
      set_item_result(run_stored_sig('GST_PATCHES_APPLIED_12_2'));
   END IF;
   set_item_result(run_stored_sig('GST_IL_LICENSE_INFO'));
   set_item_result(run_stored_sig('GST_INVALID_OBJECTS'));
   set_item_result(run_stored_sig('GST_REQUIRED_TRIGGERS'));
   set_item_result(run_stored_sig('GST_MISSING_TRIGGERS'));
   set_item_result(run_stored_sig('GST_DISABLED_TRIGGERS'));
   set_item_result(run_stored_sig('GST_TRIGGER_NON_JAI'));
   set_item_result(run_stored_sig('GST_TRIGGER_FILE_VERSIONS'));
   set_item_result(run_stored_sig('GST_REQUIRED_DISABLED_TRIGGERS'));
   set_item_result(run_stored_sig('GST_PROCEDURE_VERSIONS'));
   set_item_result(run_stored_sig('GST_PACKAGE_SPEC_VERSIONS'));
   set_item_result(run_stored_sig('GST_PACKAGE_BODY_VERSIONS'));
   set_item_result(run_stored_sig('GST_FUNCTION_VERSIONS'));
   set_item_result(run_stored_sig('GST_PLL_VERSIONS'));
   set_item_result(run_stored_sig('GST_FMB_VERSIONS'));
   set_item_result(run_stored_sig('GST_RDF_VERSIONS'));
   set_item_result(run_stored_sig('GST_LDT_VERSIONS'));
   set_item_result(run_stored_sig('GST_ODF_VERSIONS'));
   set_item_result(run_stored_sig('GST_XML_VERSIONS'));
   set_item_result(run_stored_sig('GST_RTF_VERSIONS'));
   set_item_result(run_stored_sig('GST_IL_ALL_INDEX'));
end_section;
debug('end section: GST_Apps_Check');
