...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Projects Procure to Pay Integration    |
REM | Analyzer                                                                  |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE pa_pjc_p2p_analyzer_pkg AUTHID DEFINER AS
...
END pa_pjc_p2p_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY pa_pjc_p2p_analyzer_pkg AS
-- $Id: pa_pjc_p2p_analyzer.sql, 200.28 2026/02/25 21:47:02 aliclin Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2596062.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'PAP2P_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'PAP2P_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>PAP2P Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2596062.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/pa_pjc_p2p_lastest_ver.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1954,EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1954,EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1954,EBS,EBS Financials,EBS - Projects" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4294594" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">1954</span>
...
<div class="ck-content"><p><strong><u>Version 200.28</u></strong></p><ol><li>Sigs updated for article ID changes.</li>
</ol>
<p><strong><u>Version 200.27</u></strong></p><ol><li>Template enhancement: EBS KB Article IDs Shown for Signature KM Links.</li>
<li>Sigs updated for article ID changes.</li>
</ol>
<p><strong><u>Version 200.26</u></strong></p><ol><li>Template and AC_TABLE_INDEXES enhanced.</li>
</ol>
<p><strong><u>Version 200.25</u></strong></p><ol><li>Max Sequence signatures enhanced.</li>
</ol>
<p><strong><u>Version 200.24</u></strong></p><ol><li>Several signatures enhanced.</li>
<li>New signatures added to “Informational” section.</li>
</ol>
<p><strong><u>Version 200.23</u></strong></p><ol><li>New Analyzer Framework version 4.7.3 released with enhancements.<ol><li>SQL*Plus Error fixed: SP2-0027: Input is too long</li>
<li>Ability to click to select rows in output tables</li>
</ol>
</li>
<li>Several signatures enhanced.</li>
</ol>
<p><strong><u>Version 200.22</u></strong></p><ul><li>New signature added to “Data Errors” section.</li>
<li>Many signatures enhanced.</li>
</ul>
<p><strong><u>Version 200.21</u></strong></p><ul><li>Five new signatures added.</li>
<li>Many signatures enhanced.</li>
</ul>
<p><strong><u>Version 200.20</u></strong></p><ul><li>For "Critical Alerts" section, the following 2 new signatures were updated to check for Oracle Database 12c/11g version:<ul><li>Sequences with 32-bit maximum value and large cache size</li>
<li>Sequences above 70 percent of maximum value</li>
</ul>
</li>
</ul>
<p><strong><u>Version 200.19</u></strong></p><ul><li>New Analyzer Framework version 4.6.1 released with enhancements.</li>
<li>"Lifetime Support Policy" section renamed to "Critical Alerts" and the following 2 new signatures have been added:<ul><li>Sequences with 32-bit maximum value and large cache size</li>
<li>Sequences above 70 percent of maximum value</li>
</ul>
</li>
</ul>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1954,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1954,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1954,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Projects" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
FUNCTION check_rec_patches_1 RETURN VARCHAR2 IS
  /* Signature PA_PJC_RECOMMENDED_PATCHES */
...
BEGIN
    ...
    print_log('Processing recommended patches signature: PA_PJC_RECOMMENDED_PATCHES (check_rec_patches_1) "Project Costing Recommended Patches" (version 19)');
...
IF substr(g_rep_info('Apps Version'),1,6) = '12.2.9' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'PA Concurrent Requests End with Signal 11 Error';
...
IF substr(g_rep_info('Apps Version'),1,6) = '12.1.3' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '26642982';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Funds Check : Consolidated Critical Patch for Root Cause Fixes';
   l_col_rows(5)(l_rows) := '[1430023/PALRT1341]';
...
IF substr(g_rep_info('Apps Version'),1,6) = '12.2.9' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '31597837';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Projects Funds Check : Consolidated Patch for Critical Root Cause Fixes - 12.2.5 and above';
   l_col_rows(5)(l_rows) := '[2702680/PALRT2003]';
...
IF substr(g_rep_info('Apps Version'),1,6) = '12.2.9' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '31703726';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Projects Funds Check : Consolidated Patch for Critical Root Cause Fixes by PO and PSA - 12.2.5 and above';
   l_col_rows(5)(l_rows) := '[2702680/PALRT2003]';
...
IF substr(g_rep_info('Apps Version'),1,6) = '12.2.4' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '28876997';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Funds Check : Consolidated Critical Patch for Root Cause Fixes - 12.2.4 Release';
   l_col_rows(5)(l_rows) := '[2649508/PALRT1406]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'PSA CONSOLIDATED PATCH FOR MAR-16';
   l_col_rows(5)(l_rows) := '[2649508/PALRT1406]';
...
IF substr(g_rep_info('Apps Version'),1,6) = '12.1.3' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30861233';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'PO CANCELLATION WITH RECREATE DEMAND IS FAILING IF FUNDS AVAILABLE IS ZERO';
...
IF substr(g_rep_info('Apps Version'),1,6) = '12.1.3' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33251815';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'FUNDS CHECK IS FAILING WITH DEAD LOCK ISSUE';
   l_col_rows(5)(l_rows) := NULL;
...
Best Practice: Always ensure that you are on the latest code with all recommended patches applied. This will help avoid known issues, prevent potential data corruption and provide the latest features and functionality. Having a proactive patching plan and periodic proactive patching process in place are the best ways to stay current.';
   l_sig.success_msg := 'Recommended patches are applied on the instance.';
  ...
  -- Register
  l_step := '60';
  g_signatures('PA_PJC_RECOMMENDED_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'PA_PJC_RECOMMENDED_PATCHES',     -- sig ID
...
FUNCTION get_PA_ORG_ID
   return VARCHAR2 IS
BEGIN
debug('begin sql token function: PA_ORG_ID');
BEGIN
  SELECT to_char(org_id) INTO l_system_function_var
...
EXCEPTION WHEN OTHERS THEN
  return('null');
END;
debug('end sql token function: PA_ORG_ID');
END get_PA_ORG_ID;
...
FUNCTION get_PO_ORG_ID
   return VARCHAR2 IS
BEGIN
debug('begin sql token function: PO_ORG_ID');
BEGIN
...
EXCEPTION WHEN OTHERS THEN
  return('null');
END;
debug('end sql token function: PO_ORG_ID');
END get_PO_ORG_ID;
...
debug('begin populate parameters hash table');
   ...
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Supplier Invoice';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_invoice_id,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Purchase Order';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_po_header_id,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/02/25 21:47:01 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'pa_pjc_p2p_analyzer.sql';
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Project Number.
The Project Number parameter is mandatory.');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: This invoice is not valid for the provided project.');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
debug('begin parameter validation: p_po_header_id');
IF p_po_header_id IS NOT NULL THEN
BEGIN
...
WHERE P.PO_HEADER_ID = p_po_header_id
 AND EXISTS (
  SELECT 1 FROM po_distributions_all d
  WHERE d.po_header_id = p.po_header_id
  AND   d.project_id = p_project_id)
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: This Purchase Order is not valid for the selected project.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_po_header_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_po_header_id');
...
IF p_invoice_id is null AND p_po_header_id is null THEN
  print_error('Invalid parameters: You must supply a value for the invoice '||
    'or the purchase order or both');
  raise invalid_parameters;
END IF;
...
debug('begin populate sql tokens hash table');
   ...
   g_sql_tokens('##$$PA_ORG_ID$$##') := get_PA_ORG_ID();
   l_system_function_var := null;
   g_masked_tokens('##$$PA_ORG_ID$$##') := mask_text( g_sql_tokens('##$$PA_ORG_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$INVOICE_ID$$##') := nvl(to_char(p_invoice_id), 'null');
   g_masked_tokens('##$$INVOICE_ID$$##') := mask_text( g_sql_tokens('##$$INVOICE_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$PO_HEADER_ID$$##') := nvl(to_char(p_po_header_id), 'null');
   g_masked_tokens('##$$PO_HEADER_ID$$##') := mask_text( g_sql_tokens('##$$PO_HEADER_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$ORG_ID$$##') := get_ORG_ID();
   l_system_function_var := null;
   g_masked_tokens('##$$ORG_ID$$##') := mask_text( g_sql_tokens('##$$ORG_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$PO_ORG_ID$$##') := get_PO_ORG_ID();
   l_system_function_var := null;
   g_masked_tokens('##$$PO_ORG_ID$$##') := mask_text( g_sql_tokens('##$$PO_ORG_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM1$$##') := '275';
   g_masked_tokens('##$$APPS_PARAM1$$##') := mask_text( g_sql_tokens('##$$APPS_PARAM1$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM2$$##') := '8402';
...
debug('begin add_signature: EBS_FIN_PA_P2P_2873574_1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24146',
      p_sig_id                 => 'EBS_FIN_PA_P2P_2873574_1',
      p_sig_sql                => 'SELECT Adf.Filename, Adfv.Version
    FROM Ad_Files Adf, Ad_File_Versions Adfv
    Where  
    Adf.File_Id = Adfv.File_Id
     and  
    ((''12.2.11'' = substr(''##$$REL$$##'',1,7) AND
            Fnd_Irep_Loader_Private.Compare_Versions(
              Adfv.Version,''120.28.12020000.9'') = ''<'' ))
    And Adf.App_Short_Name = ''PA''
    And Adf.Filename = ''PAPOUTLB.pls''
    And Adfv.Version in (
    select  "Current Version" from (
          ...
          and af1.filename in (''PAPOUTLB.pls'') 
          ) 
          where rankUS = 1
     )',
      p_title                  => 'Performance Issue with the Receiving Transaction Processor (RTP) while Saving Receipts after Upgrade to R12.2.11',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Old version of code level for PA PO Integration (package PAPOUTLB.pls) does not have code fix.
',
      p_solution               => 'Please follow solution in [2873574/KB514681] - Performance Issue with the ''Receiving Transaction Processor'' (RTP) while Saving Receipts after Upgrade to R12.2.11. Users sometime Receive a TM-TIMEOUT Error.',
      p_success_msg            => 'Have code level fix for PA PO Integration [2873574/KB514681]  Performance Issue with the ''Receiving Transaction Processor'' (RTP) while Saving Receipts after Upgrade to R12.2.11. Users sometime Receive a TM-TIMEOUT Error.',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_P2P_2873574_1');



debug('begin add_signature: PA_P2P_AA_LOOKUP_SETS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11866',
      p_sig_id                 => 'PA_P2P_AA_LOOKUP_SETS',
...
AND   rp.org_id = NVL(##$$ORG_ID$$##,##$$PA_ORG_ID$$##)
...
AND   ft.function_code IN (''BER'',''DVC'')
...
ORDER BY ls.segment_value_lookup_set_name, p.parameter_name',
      p_title                  => 'Auto Accounting Lookup Sets',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No lookup set used for Expense Report Cost Account and Supplier Invoice Cost Account functions.',
      p_solution               => '',
      p_success_msg            => 'Auto Accounting Lookup Sets.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_AA_LOOKUP_SETS');



debug('begin add_signature: PA_P2P_AA_RULE_PAIRINGS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11865',
      p_sig_id                 => 'PA_P2P_AA_RULE_PAIRINGS',
...
AND   srp.org_id = NVL(##$$ORG_ID$$##,##$$PA_ORG_ID$$##)
AND   ft.function_code IN (''BER'',''DVC'')
AND   NOT EXISTS (
        SELECT null FROM pa_function_parameters fp
...
AND   NOT EXISTS (
      ...
      p_title                  => 'Autoaccounting Parameters',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invalid AutoAccounting parameter usage identified.',
      p_solution               => 'Follow the steps which are suggested in the notes below:<br> 
...
[552086/FAQ4118] AutoAccounting in Projects Frequently Asked Questions (FAQ) <br>',
      p_success_msg            => 'Autoaccounting rules against each accounting segment is properly defined for functions Supplier Invoice Cost Account and Expense Report Cost Account.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_AA_RULE_PAIRINGS');



debug('begin add_signature: PA_P2P_PAYABLE_SYSTEM_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11803',
      p_sig_id                 => 'PA_P2P_PAYABLE_SYSTEM_OPTIONS',
      p_sig_sql                => 'SELECT create_employee_vendor_flag "Create_Employee_as_Supplier",
       allow_paid_invoice_adjust "Allow_Paid_Inv_Adjustment_Flag",
       allow_flex_override_flag "Allow_Account_Override_Flag",
       accounting_method_option "Accounting_Method_Option",
       discount_distribution_method "Discount_Distribution_Method"
FROM ap_system_parameters_all
WHERE org_id = NVL(##$$ORG_ID$$##,##$$PA_ORG_ID$$##)',
      p_title                  => 'Payables System Options',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Payables setup options not found for the organization.',
      p_solution               => '',
      p_success_msg            => 'Payables setup options.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_PAYABLE_SYSTEM_OPTIONS');



debug('begin add_signature: PA_P2P_PA_ADDITION_FLAG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11800',
      p_sig_id                 => 'PA_P2P_PA_ADDITION_FLAG',
      p_sig_sql                => 'SELECT lookup_code,
       meaning,
       enabled_flag
FROM pa_lookups
WHERE lookup_type = ''PA_ADDITION_FLAG''',
      p_title                  => 'Project Addition Flag Lookup Codes',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'PA Addition Lookup Type is not defined.',
      p_solution               => '',
      p_success_msg            => 'Project Addition Flag Lookup Codes.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_PA_ADDITION_FLAG');



debug('begin add_signature: PA_P2P_PROFILE_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11802',
      p_sig_id                 => 'PA_P2P_PROFILE_OPTIONS',
...
AND   o.profile_option_name IN (
        ''PA_ALLOW_FLEXBUILDER_OVERRIDES'',''PA_DEFAULT_EXP_ORG'',''PA_TASKS_DISPLAYED'',
        ''PA_TRANSFER_DFF_AP'',''PA_SUMMARIZE_EXPENSE_REPORT_LINES'',''PA_NUM_EXPENDITURES_PER_SET'', ''PA_AP_EI_DATE_DEFAULT'')
ORDER BY o.user_profile_option_name, v.level_id,
         decode(v.level_id, 10001, ''Site'',  10002, a.application_name,
                            10003, r.responsibility_name)',
      p_title                  => 'Project Profile Options Related to Payables',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Project related profile options related to payables are not setup.',
      p_solution               => '',
      p_success_msg            => 'Projects profile option values related to payables at different level. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_PROFILE_OPTIONS');



debug('begin add_signature: PA_P2P_SUPPLIER_INV_ADJ_CREDIT_ACCOUNT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11812',
      p_sig_id                 => 'PA_P2P_SUPPLIER_INV_ADJ_CREDIT_ACCOUNT',
      p_sig_sql                => 'SELECT concatenated_segments "CREDIT_ACCOUNT"
FROM gl_code_combinations_kfv
WHERE code_combination_id = (
        SELECT nvl(def_supplier_cost_cr_ccid,-1)
        FROM pa_implementations_all
        WHERE org_id = NVL(##$$ORG_ID$$##,##$$PA_ORG_ID$$##))',
      p_title                  => 'Default Credit Account for Supplier Cost Adjustment',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Default credit account is not setup for the operating unit.',
      p_solution               => 'Follow the steps indicated in [1080212/KB777808] to setup the default credit account.',
      p_success_msg            => 'Default credit account detail has been setup in implementation option for the operating unit. This account is used as credit entry for supplier cost adjustments performed in Project Accounting.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_SUPPLIER_INV_ADJ_CREDIT_ACCOUNT');



debug('begin add_signature: PA_P2P_TRANSACTION_SOURCES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12376',
      p_sig_id                 => 'PA_P2P_TRANSACTION_SOURCES',
      p_sig_sql                => 'SELECT *
FROM pa_transaction_sources
WHERE system_linkage_function IN (''VI'',''ER'')',
      p_title                  => 'Transaction Source Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No supplier invoice/purchase receipt transaction sources found.',
      p_solution               => '',
      p_success_msg            => 'Supplier invoice and purchase receipt transaction source details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_TRANSACTION_SOURCES');
...
debug('begin add_signature: EBS_FIN_PA_PAP2P_COST_DIST_SYSTEM_REF_NULL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23182',
      p_sig_id                 => 'EBS_FIN_PA_PAP2P_COST_DIST_SYSTEM_REF_NULL',
      p_sig_sql                => 'SELECT cdl.expenditure_item_id,
         cdl.line_num,
         ei.project_id,
         ei.task_id,
  ...
  AND   ei.project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Missing System Reference For Reversed Expense Report',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'System reference columns for reversed AP expense report expenditures are not populated.',
      p_solution               => 'Please follow the solution in [2457575/KB363268] R12: PA: System Reference Details Not Getting Updated On The Reversal Cost Distributions.',
      p_success_msg            => 'System Reference columns for reversed AP expense report expenditures are populated.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAP2P_COST_DIST_SYSTEM_REF_NULL');
...
debug('begin add_signature: EBS_FIN_PA_PAP2P_GST_TAX_PROJECT_APINV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29394',
      p_sig_id                 => 'EBS_FIN_PA_PAP2P_GST_TAX_PROJECT_APINV',
      p_sig_sql                => 'select * from JAI_TAX_LINES where entity_Code = ''AP_INVOICES'' and
trx_id in (select invoice_id from ap_invoice_distributions_all d  where Project_id = ##$$PROJECT_ID$$##)',
      p_title                  => ' GST Tax Lines For Project Related Supplier Invoices',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'India GST tax lines do not exist for project related supplier invoices.',
      p_solution               => '',
      p_success_msg            => 'India GST tax lines exist for project related supplier invoices.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAP2P_GST_TAX_PROJECT_APINV');



debug('begin add_signature: EBS_FIN_PA_PAP2P_GST_TAX_PROJECT_PO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29393',
      p_sig_id                 => 'EBS_FIN_PA_PAP2P_GST_TAX_PROJECT_PO',
      p_sig_sql                => 'select * from JAI_TAX_LINES where entity_Code = ''PURCHASE_ORDER'' and
trx_id in (select PO_HEADER_ID from PO_DISTRIBUTIONS_ALL where project_id  = ##$$PROJECT_ID$$##
and destination_type_code = ''EXPENSE'')',
      p_title                  => 'India GST Tax Lines For Project Related Purchase Orders',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'India GST tax lines do not exist for project related purchase orders.',
      p_solution               => '',
      p_success_msg            => 'India GST tax lines exist for project related purchase orders.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAP2P_GST_TAX_PROJECT_PO');



debug('begin add_signature: PA_P2P_ACC_GEN_WORKFLOW_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11804',
      p_sig_id                 => 'PA_P2P_ACC_GEN_WORKFLOW_DETAILS',
      p_sig_sql                => 'SELECT fwp.wf_item_type "Item Type",
       fwp.wf_process_name "Process Name",
       wa.runnable_flag,
       version,
       wpa.activity_name,
       wpa.instance_label,
...
WHERE fwp.id_flex_code = ''GL#''
AND   fwp.application_id = 101
AND   fwp.id_flex_num = l.chart_of_accounts_id
AND   l.ledger_id = i.set_of_books_id
AND   i.org_id = NVL(##$$ORG_ID$$##,##$$PA_ORG_ID$$##)
AND   fwp.wf_item_type IN (''PAAPINVW'')
AND   fwp.wf_item_type = wa.item_type
AND   wa.type = ''PROCESS''
AND   wa.name = fwp.wf_process_name
AND   wa.item_type = wpa.process_item_type
AND   wa.name = wpa.process_name
AND   wa.version = wpa.process_version
ORDER BY fwp.wf_item_type,wpa.start_end desc nulls last',
      p_title                  => 'Supplier Invoice Account Generator Workflow',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Supplier Invoice Account Generator workflow setup is not defined.',
      p_solution               => 'Follow steps mentioned in [1344854/KB244406] to customize supplier invoice account generator workflow.',
      p_success_msg            => 'Supplier Invoice Account Generator workflow setup is defined.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_ACC_GEN_WORKFLOW_DETAILS');



debug('begin add_signature: PA_P2P_ACC_GEN_WF_ACTIVITY_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11808',
      p_sig_id                 => 'PA_P2P_ACC_GEN_WF_ACTIVITY_STATUS',
      p_sig_sql                => 'SELECT item_type_display_name "ITEM TYPE",
       activity_display_name "ACTIVITY",
       activity_type_display_name "ACTIVITY TYPE",
       activity_result_display_name "ACTIVITY RESULT",
       ERROR_MESSAGE
FROM wf_item_activity_statuses_v
WHERE item_type = ''PAAPINVW''
AND   item_key = (SELECT MAX(item_key) FROM wf_items WHERE item_type = ''PAAPINVW'')',
      p_title                  => 'Supplier Invoice Account Generator Activity Status',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No activity status information found for the Supplier Invoice Account Generator workflow.<br>
Please enable profile option Account Generator Run in Debug Mode to review activity status.',
      p_solution               => '',
      p_success_msg            => 'Activity status details for the Supplier Invoice Account Generator workflow.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_ACC_GEN_WF_ACTIVITY_STATUS');



debug('begin add_signature: PA_P2P_ACC_GEN_WF_ACCOUNT_ASSIGNMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11805',
      p_sig_id                 => 'PA_P2P_ACC_GEN_WF_ACCOUNT_ASSIGNMENTS',
      p_sig_sql                => 'SELECT ATL.DISPLAY_NAME,
       PA.INSTANCE_LABEL,
       PA.INSTANCE_ID,
       PA.ACTIVITY_NAME,
       V1.TEXT_VALUE "IDENTIFIED BY",
       V2.TEXT_VALUE "IDENTIFIER VALUE",
       V3.TEXT_VALUE "ATTRIBUTE VALUE",
       PA.PROCESS_NAME
FROM wf_process_activities pa,
     wf_activities_vl atl,
     wf_activity_attr_values v1,
     wf_activity_attr_values v2,
     wf_activity_attr_values v3,
     fnd_flex_workflow_processes fwp,
     pa_implementations_all i,
     gl_ledgers l
WHERE fwp.id_flex_code = ''GL#''
AND   fwp.application_id = 101
...
AND   i.org_id = NVL(##$$ORG_ID$$##,##$$PA_ORG_ID$$##)
AND   fwp.wf_item_type IN (''PAAPINVW'')
AND   fwp.wf_item_type = pa.process_item_type
AND   fwp.wf_process_name = pa.process_name
AND   pa.activity_name IN (
        ''FND_FLEX_COPY_SEG_FROM_COMB'', ''FND_FLEX_COPY_SEG_FROM_COMB2'',
        ''FND_FLEX_ASSIGN_TO_SEGMENT'')
AND   atl.item_type = pa.activity_item_type
AND   atl.name = pa.activity_name
AND   atl.version = (
        SELECT max(version) FROM wf_activities
        WHERE item_type = pa.activity_item_type
        AND   name = pa.activity_name)
        AND   v1.PROCESS_ACTIVITY_ID = pa.instance_id
        AND   v2.PROCESS_ACTIVITY_ID = pa.instance_id
        AND   v3.PROCESS_ACTIVITY_ID = pa.instance_id
        AND   v1.name = ''SEGMENT_IDENTIFIER''
        AND   v2.name = ''SEGMENT''
        AND   v3.name = ''VALUE''',
      p_title                  => 'Supplier Invoice Account Generator Segment Assignments',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Either profile option Account Generator Run in Debug Mode is not enabled or Not all segments have an assignment in Supplier Account Generator workflow.<br>

If all segments are not derived through supplier invoice account generator workflow then payable invoice could not be validated.',
      p_solution               => 'Set profile option Account Generator Run in Debug Mode as Yes and if after setting this profile option this section has no data then follow below action plan.<p>

Review the supplier invoice account generator workflow and correct assignments.<br>
Follow the steps mentioned [1344854/KB244406] to customize workflow.</p>',
      p_success_msg            => 'This gives us information of values assigned to each segment for accounting key flexfield derived through supplier account generator workflow.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_ACC_GEN_WF_ACCOUNT_ASSIGNMENTS');



debug('begin add_signature: PA_P2P_ACC_GEN_WF_ATTRIBUTE_VALUES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11806',
      p_sig_id                 => 'PA_P2P_ACC_GEN_WF_ATTRIBUTE_VALUES',
      p_sig_sql                => 'SELECT a.name "Attribute Name",
       a.text_value,
       a.number_value,
       a.date_value
...
WHERE item_type = ''PAAPINVW''
AND   item_key = (SELECT MAX(item_key) FROM wf_items WHERE item_type = ''PAAPINVW'')',
      p_title                  => 'Supplier Invoice Account Generator Attribute Values',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No workflow attribute values found for the Supplier Invoice Account Generator workflow.',
      p_solution               => '',
      p_success_msg            => 'Workflow attribute values for the Supplier Invoice Account Generator Workflow.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_ACC_GEN_WF_ATTRIBUTE_VALUES');



debug('begin add_signature: PA_P2P_ACC_GEN_WORKFLOW_DETAILS2');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11810',
      p_sig_id                 => 'PA_P2P_ACC_GEN_WORKFLOW_DETAILS2',
      p_sig_sql                => 'SELECT fwp.wf_item_type "Item Type",
       fwp.wf_process_name "Process Name",
       wa.runnable_flag,
       version,
...
AND   l.ledger_id = i.set_of_books_id
AND   i.org_id = NVL(##$$ORG_ID$$##,##$$PA_ORG_ID$$##)
AND   fwp.wf_item_type IN (''PAAPWEBX'')
AND   fwp.wf_item_type = wa.item_type
AND   wa.type = ''PROCESS''
AND   wa.name = fwp.wf_process_name
AND   wa.item_type = wpa.process_item_type
...
AND   wa.version = wpa.process_version
ORDER BY fwp.wf_item_type, wpa.start_end desc nulls last',
      p_title                  => 'Expense Report Account Generator Workflow',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Expense Report Account Generator workflow setup is not defined. ',
      p_solution               => 'Review [1344854/KB244406] where steps are given to customize Supplier Invoice Account Generator Workflow.<br> 
Please use similar steps to customize Expense Report Account Generator Workflow.',
      p_success_msg            => 'Expense Report Account Generator workflow setup is defined.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_ACC_GEN_WORKFLOW_DETAILS2');



debug('begin add_signature: PA_P2P_ACC_GEN_WF_ACTIVITY_STATUS2');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11809',
      p_sig_id                 => 'PA_P2P_ACC_GEN_WF_ACTIVITY_STATUS2',
      p_sig_sql                => 'SELECT item_type_display_name "ITEM TYPE",
       activity_display_name "ACTIVITY",
       activity_type_display_name "ACTIVITY TYPE",
       activity_result_display_name "ACTIVITY RESULT",
       ERROR_MESSAGE
FROM wf_item_activity_statuses_v
WHERE item_type = ''PAAPWEBX''
AND   item_key = (SELECT MAX(item_key) FROM wf_items WHERE item_type = ''PAAPWEBX'')',
      p_title                  => 'Expense Report Account Generator Activity Status',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No activity status information found for the Expense Report Account Generator workflow.<br>
Please enable profile option Account Generator Run in Debug Mode to review activity status.',
      p_solution               => '',
      p_success_msg            => 'Activity status details for the Expense Report Account Generator workflow.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_ACC_GEN_WF_ACTIVITY_STATUS2');



debug('begin add_signature: PA_P2P_ACC_GEN_WF_ACCOUNT_ASSIGNMENTS2');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11811',
      p_sig_id                 => 'PA_P2P_ACC_GEN_WF_ACCOUNT_ASSIGNMENTS2',
      p_sig_sql                => 'SELECT ATL.DISPLAY_NAME,
       PA.INSTANCE_LABEL,
       PA.INSTANCE_ID,
       PA.ACTIVITY_NAME,
...
AND   atl.version = (
         ...
         WHERE a.item_type = pa.activity_item_type
         AND   a.name = pa.activity_name)
         AND   v1.PROCESS_ACTIVITY_ID = pa.instance_id
         AND   v2.PROCESS_ACTIVITY_ID = pa.instance_id
         AND   v3.PROCESS_ACTIVITY_ID = pa.instance_id
         AND   v1.name = ''SEGMENT_IDENTIFIER''
         AND   v2.name = ''SEGMENT''
         AND   v3.name = ''VALUE''',
      p_title                  => 'Expense Report Account Generator Segment Assignments',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Either profile option Account Generator Run in Debug Mode is not enabled or Not all segments have an assignment in Expense Report Account Generator workflow.<br>

If all segments are not derived through expense report account generator workflow then payable invoice created against expense report could not be validated.',
      p_solution               => 'Set profile option Account Generator Run in Debug Mode as Yes and if after setting this profile option this section has no data then follow below action plan.<p>

Review the expense report generator workflow and correct assignments.<br>
See [1344854/KB244406] where steps are given for customizing the Supplier Invoice Account Generator Workflow. Similar steps can be followed for customizing Expense Report Account Generator workflow.</p>',
      p_success_msg            => 'This gives us information of values assigned to each segment for accounting key flexfield derived through expense report account generator workflow.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_ACC_GEN_WF_ACCOUNT_ASSIGNMENTS2');



debug('begin add_signature: PA_P2P_ACC_GEN_WF_ATTRIBUTE_VALUES2');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11807',
      p_sig_id                 => 'PA_P2P_ACC_GEN_WF_ATTRIBUTE_VALUES2',
      p_sig_sql                => 'SELECT a.name "ATTRIBUTE NAME",
       a.text_value,
       a.number_value,
       a.date_value
...
WHERE item_type = ''PAAPWEBX''
AND item_key = (SELECT MAX(item_key) FROM wf_items WHERE item_type = ''PAAPWEBX'')',
      p_title                  => 'Expense Report Account Generator Attribute Values',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No workflow attribute values found for the Expense Report Account Generator workflow.',
      p_solution               => '',
      p_success_msg            => 'Workflow attribute values for the Expense Report Account Generator Workflow.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_ACC_GEN_WF_ATTRIBUTE_VALUES2');



debug('begin add_signature: PA_P2P_XLA_ACC_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12417',
      p_sig_id                 => 'PA_P2P_XLA_ACC_ERRORS',
...
AND   cdl.expenditure_item_id IN (
        ...
        WHERE project_id = ##$$PROJECT_ID$$##
        AND   document_header_id = nvl(##$$INVOICE_ID$$##,document_header_id)
        AND   system_linkage_function IN (''VI'',''ER'')
        AND   transaction_source IN (
                ''AP DISCOUNTS'',''AP ERV'',''AP EXPENSE'',''AP INVOICE'',
                ''AP NRTAX'',''AP VARIANCE'')
        UNION
        SELECT expenditure_item_id
        FROM pa_expenditure_items_all
        WHERE project_id = ##$$PROJECT_ID$$##
        AND   document_header_id = nvl(##$$PO_HEADER_ID$$##,document_header_id)
        AND   system_linkage_function IN (''VI'',''ER'')
        AND   transaction_source IN (
                ''PO RECEIPT'',''PO RECEIPT NRTAX'',''PO RECEIPT NRTAX PRICE ADJ'',
                ''PO RECEIPT PRICE ADJ''))',
      p_title                  => 'XLA Accounting Errors',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Accounting errors exist for given project.',
      p_solution               => 'Review the errors indicated in the query output. To gather more details on the problem, review [414094/KB308767] which provides the steps for generating the Transaction Objects Diagnostics report to see more details related to the issue.

Based on error messages follow document ids mentioned below. <br>

For error messages 95301, 95305 and 95330 refer to [2384637/KB535262].<br>
For error message 95353 refer to [1268728/KB396920].<br>
For error message 95349 refer to [1455406/KB349676].',
      p_success_msg            => 'There are no accounting errors exist for Supplier invoice or purchase order receipt.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_XLA_ACC_ERRORS');



debug('begin add_signature: PA_P2P_XLA_TRANS_ENTITIES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12418',
      p_sig_id                 => 'PA_P2P_XLA_TRANS_ENTITIES',
      p_sig_sql                => 'SELECT xe.*
FROM xla.xla_transaction_entities xe,
     pa_cost_distribution_lines_all cdl
WHERE xe.source_id_int_1 = cdl.expenditure_item_id
AND   cdl.acct_event_id IS NOT NULL
AND   cdl.expenditure_item_id IN (
        SELECT expenditure_item_id
        FROM pa_expenditure_items_all
        ...
        AND   document_header_id = nvl(##$$INVOICE_ID$$##,document_header_id)
        AND   system_linkage_function IN (''VI'',''ER'')
        AND   transaction_source IN (''AP DISCOUNTS'',''AP ERV'',''AP EXPENSE'',''AP INVOICE'',''AP NRTAX'',''AP VARIANCE'')
        UNION
        SELECT expenditure_item_id
        FROM pa_expenditure_items_all
        WHERE project_id = ##$$PROJECT_ID$$##
        AND   document_header_id = nvl(##$$PO_HEADER_ID$$##,document_header_id)
        AND   system_linkage_function IN (''VI'',''ER'')
        AND   transaction_source IN (''PO RECEIPT'',''PO RECEIPT NRTAX'',''PO RECEIPT NRTAX PRICE ADJ'',''PO RECEIPT PRICE ADJ''))',
      p_title                  => 'XLA Transaction Entities',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'XLA transaction entities do not exist for the given parameters.',
      p_solution               => '',
      p_success_msg            => 'XLA transaction entity details for the selected project expenditure documents.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_XLA_TRANS_ENTITIES');



debug('begin add_signature: PA_P2P_XLA_EVENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12413',
      p_sig_id                 => 'PA_P2P_XLA_EVENTS',
      p_sig_sql                => 'SELECT xe.*
FROM xla_events xe,
     pa_cost_distribution_lines_all cdl
...
AND   cdl.expenditure_item_id IN (
      ...
      p_title                  => 'XLA Events',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No accounting events exist for given project.',
      p_solution               => '',
      p_success_msg            => 'Accounting event details for supplier invoice and purchase order receipt related expenditures.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_XLA_EVENTS');



debug('begin add_signature: PA_P2P_XLA_AE_HEADERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12414',
      p_sig_id                 => 'PA_P2P_XLA_AE_HEADERS',
      p_sig_sql                => 'SELECT xah.*
FROM xla_ae_headers xah,
     pa_cost_distribution_lines_all cdl
WHERE xah.event_id = cdl.acct_event_id
AND   cdl.acct_event_id IS NOT NULL
AND   cdl.expenditure_item_id IN (
        SELECT expenditure_item_id
        FROM pa_expenditure_items_all
        ...
        AND   transaction_source IN (
                ''PO RECEIPT'',''PO RECEIPT NRTAX'',''PO RECEIPT NRTAX PRICE ADJ'',
                ''PO RECEIPT PRICE ADJ''))',
      p_title                  => 'XLA Accounting Entry Headers',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No accounting entry headers found for the given project expenditure documents.',
      p_solution               => '',
      p_success_msg            => 'Accounting entry header details for the given project and invoice/purchase order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_XLA_AE_HEADERS');



debug('begin add_signature: PA_P2P_XLA_AE_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12415',
      p_sig_id                 => 'PA_P2P_XLA_AE_LINES',
      p_sig_sql                => 'SELECT xal.*
...
AND   cdl.expenditure_item_id IN (
        ...
        AND   transaction_source IN (
                ''PO RECEIPT'',''PO RECEIPT NRTAX'',''PO RECEIPT NRTAX PRICE ADJ'',
                ''PO RECEIPT PRICE ADJ''))',
      p_title                  => 'XLA Accounting Entry Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Accounting Entry Lines not found for the given project.',
      p_solution               => '',
      p_success_msg            => 'Accounting entry lines details for selected project expenditure documents.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_XLA_AE_LINES');



debug('begin add_signature: PA_P2P_XLA_DISTRIBUTION_LINKS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12416',
      p_sig_id                 => 'PA_P2P_XLA_DISTRIBUTION_LINKS',
      p_sig_sql                => 'SELECT xdl.*
FROM xla_distribution_links xdl,
     pa_cost_distribution_lines_all cdl
WHERE xdl.event_id = cdl.acct_event_id
AND   cdl.acct_event_id IS NOT NULL
AND   cdl.expenditure_item_id IN (
        SELECT expenditure_item_id
        FROM pa_expenditure_items_all
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'XLA Distribution Links not found for the given project expenditure documents.',
      p_solution               => '',
      p_success_msg            => 'XLA distribution link information for the selected project invoice/purchase order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_XLA_DISTRIBUTION_LINKS');



debug('begin add_signature: EBS_FIN_PA_PAP2P_AP_PA_RECONCILIATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23187',
      p_sig_id                 => 'EBS_FIN_PA_PAP2P_AP_PA_RECONCILIATION',
      p_sig_sql                => 'SELECT
    ...
    ( nvl(xal.accounted_dr, 0) - nvl(xal.accounted_cr, 0) ) xla_amount
FROM
...
WHERE
    ...
    AND xev.event_id = aid.accounting_event_id
    ...
    AND  pp.project_id= ##$$PROJECT_ID$$##',
      p_title                  => 'Reconciliation Report for the Payable Invoice to Project ',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Reconciliation report for the Payable Invoice  with Project.',
      p_solution               => 'Run the query from [2885898/KB650965#Case2] to know the Payable Invoice accounted to GL but not interfaced to Project.<br>
Run the concurrent process PRC: Interface Supplier Costs with parameter Interface Supplier Invoices as ''Yes'' to interface the Payable Invoice to Project.',
      p_success_msg            => 'There is no Reconciliation issue between Payable Invoice  with Project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAP2P_AP_PA_RECONCILIATION');



debug('begin add_signature: PA_P2P_TRANSACTION_CONTROLS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11797',
      p_sig_id                 => 'PA_P2P_TRANSACTION_CONTROLS',
      p_sig_sql                => 'SELECT *
FROM pa_transaction_controls
WHERE project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Transaction Controls',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No transaction control exist for the project.',
      p_solution               => '',
      p_success_msg            => 'Transaction Controls Details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_TRANSACTION_CONTROLS');



debug('begin add_signature: PA_P2P_EXPENDITURES_HISTORY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12411',
      p_sig_id                 => 'PA_P2P_EXPENDITURES_HISTORY',
      p_sig_sql                => 'SELECT *
FROM pa_expenditure_history
WHERE EXPENDITURE_ID IN (
        SELECT expenditure_id FROM pa_expenditure_items_all
        WHERE project_id = ##$$PROJECT_ID$$##
        AND   document_header_id = nvl(##$$INVOICE_ID$$##,document_header_id)
        AND   system_linkage_function IN (''VI'',''ER'')
        AND   transaction_source IN (
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Expenditure History does not exist for the given parameters.',
      p_solution               => '',
      p_success_msg            => 'Expenditure history details for the selected project expenditure documents.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_EXPENDITURES_HISTORY');



debug('begin add_signature: PA_P2P_EXPENDITURE_COMMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12412',
      p_sig_id                 => 'PA_P2P_EXPENDITURE_COMMENTS',
      p_sig_sql                => 'SELECT com.*
FROM pa_expenditure_comments com
WHERE expenditure_item_id IN (
        SELECT expenditure_item_id FROM pa_expenditure_items_all
        WHERE project_id = ##$$PROJECT_ID$$##
        AND   document_header_id = nvl(##$$INVOICE_ID$$##,document_header_id)
        AND   system_linkage_function IN (''VI'',''ER'')
        AND   transaction_source IN (
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Expenditure Comments do not exist for the given parameters.',
      p_solution               => '',
      p_success_msg            => 'Expenditure comments for the given parameters.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_EXPENDITURE_COMMENTS');
...
debug('begin add_signature: PA_P2P_INVALID_EXP_ORG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12256',
      p_sig_id                 => 'PA_P2P_INVALID_EXP_ORG',
      p_sig_sql                => 'SELECT p.segment1 AS "PROJECT_NUMBER",
       i.INVOICE_NUM,
...
AND   d.invoice_id = NVL(##$$INVOICE_ID$$##,d.invoice_id)
AND   d.project_id = p.project_id
AND   d.invoice_id = i.invoice_id
AND   d.expenditure_organization_id = hou.organization_id
AND   NOT EXISTS (
        SELECT 1 FROM pa_all_organizations org
        WHERE d.org_id = org.org_id
        AND   d.expenditure_organization_id = org.organization_id
        AND   org.pa_org_use_type = ''EXPENDITURES''
        AND   org.inactive_date is null)',
      p_title                  => 'Expenditure Organization for Invoice is Invalid',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Expenditure Organization used on the invoice is not valid.',
      p_solution               => 'Please follow the note below and perform the action plan as suggested in the document:<br>
[756313/KB199469] Error On Expenditure Entry: The Expenditure Organization Is Not Active<br>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_INVALID_EXP_ORG');



debug('begin add_signature: PA_P2P_INVALID_RCV_CCID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12254',
      p_sig_id                 => 'PA_P2P_INVALID_RCV_CCID',
      p_sig_sql                => 'SELECT pod.PO_HEADER_ID,
       rcvs.RCV_TRANSACTION_ID,
       pod.PO_DISTRIBUTION_ID,
       pod.code_combination_id "PO CHARGE ACCOUNT",
       rcvs.code_combination_id "RCV CHARGE ACCOUNT"
FROM rcv_receiving_sub_ledger rcvs,
     rcv_Transactions rcvt ,
     po_distributions_all pod
WHERE pod.project_id = ##$$PROJECT_ID$$##
AND   pod.po_header_id = nvl(##$$PO_HEADER_ID$$##,pod.po_header_id)
AND   rcvs.rcv_transaction_id = rcvt.transaction_id
AND   rcvs.accounting_line_type = ''Charge''
AND   rcvt.po_distribution_id = pod.po_distribution_id
AND   rcvs.code_combination_id <> pod.code_combination_id',
      p_title                  => 'Mismatch Between Charge Account for Receipt And Purchase Order',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Charge account is not matching between PO Distribution and Receipt Subledger.',
      p_solution               => 'Please follow section PA-PO Integration and case #9 of [1965211/KB345984#Case9] and log a service request to get data fix through bug as suggested.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_INVALID_RCV_CCID');



debug('begin add_signature: PA_P2P_MISMATCH_AMT_FUNC_ENT_CURRENCY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12255',
      p_sig_id                 => 'PA_P2P_MISMATCH_AMT_FUNC_ENT_CURRENCY',
...
AND   ai.invoice_id = nvl(##$$INVOICE_ID$$##,ai.invoice_id)
...
AND   ((aid.base_amount  is not null AND
      ...
      p_title                  => 'Mismatch Between Entered and Accounted Amounts for Supplier Invoice',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Functional currency invoices created with BASE_AMOUNT incorrectly populated.',
      p_solution               => 'Please review [2020226/KB219137] R12: PRC: Interface Supplier Costs - Functional and Transaction Currency Costs Must Be Equal<br>
Apply the data fix as described in [1272497/KB328520] as well as the root cause patch indicated there if it is not already applied and is applicable to your version.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_MISMATCH_AMT_FUNC_ENT_CURRENCY');



debug('begin add_signature: PA_P2P_INVALID_PA_ADDITION_FLAG_ASSET_TRACK_INV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12243',
      p_sig_id                 => 'PA_P2P_INVALID_PA_ADDITION_FLAG_ASSET_TRACK_INV',
      p_sig_sql                => 'SELECT PROJ.SEGMENT1 PROJECT_NUMBER,
       PROJ.PROJECT_STATUS_CODE PROJECT_STATUS,
       INV.INVOICE_NUM,
       DIST.AMOUNT,
...
AND   dist.line_type_lookup_code NOT IN (''REC_TAX'', ''RETAINAGE'', ''PREPAY'')
AND   dist.line_type_lookup_code NOT IN (''ERV'', ''TRV'', ''IPV'', ''TIPV'', ''TERV'')
AND   dist.pa_addition_flag IS NOT NULL
AND   nvl(dist.pa_addition_flag, ''N'') = ''N''
AND   dist.po_distribution_id IS NOT NULL
AND   dist.amount <> 0
AND   dist.posted_flag = ''Y''
AND   nvl(dist.reversal_flag, ''N'') = ''N''
...
AND   inv.invoice_id = nvl(##$$INVOICE_ID$$##, inv.invoice_id)
AND   dist.org_id = nvl(##$$ORG_ID$$##, dist.org_id)
AND   dist.org_id = inv.org_id
AND   EXISTS (
...
AND   NOT EXISTS (
        ...
        WHERE ei.document_header_id = dist.invoice_id
...
AND   EXISTS (
      ...
      p_title                  => 'Wrong PA Addition Flag for Invoices Matched to PO of Asset Trackable Item',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invoice transactions matched to a Purchase Order for asset trackable items with incorrect pa_addition_flag values.',
      p_solution               => 'If application version is on or above R12.1.3 Delta6 (For Release R12.1) or on or above R12.2.5 (For Release 12.2) then download the version of the generic datafix {22311067} appropriate for your release (as described in [2109948/KB416871#Case8]) and apply it according to the README instructions. <br> 
This issue is addressed by the Case # 8 of the data fix, follow instruction mentioned in [2109948/KB416871#Case8] for Case 8.<br>
If application version is below R12.1.3 Delta6 (For Release R12.1) or below R12.2.5 (For Release 12.2) then log service request to get data fix.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_INVALID_PA_ADDITION_FLAG_ASSET_TRACK_INV');



debug('begin add_signature: PA_P2P_INVALID_PA_ADDITION_FLAG_IMPORTED_EXP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12233',
      p_sig_id                 => 'PA_P2P_INVALID_PA_ADDITION_FLAG_IMPORTED_EXP',
...
AND   ppa.project_id = dist.project_id
AND   inv.invoice_id = dist.invoice_id
AND   inv.invoice_id = nvl(##$$INVOICE_ID$$##, inv.invoice_id)
AND   dist.project_id > 0
AND   dist.line_type_lookup_code NOT IN (
        ''ERV'',''TRV'',''IPV'',''TIPV'',''TERV'', ''REC_TAX'',''RETAINAGE'',''PREPAY'')
AND   nvl(dist.pa_addition_flag,''N'') NOT IN (''Y'',''E'')
AND   dist.posted_flag  = ''Y''
AND   nvl(dist.reversal_flag,''N'') = ''N''
AND   nvl(dist.historical_flag,''N'') = ''N''
AND   dist.org_id = nvl(##$$ORG_ID$$##,dist.org_id)
...
AND   EXISTS (
      ...
      p_title                  => 'Wrong PA Addition Flag for Imported Invoice Transactions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invoice transactions interfaced to projects having incorrect pa_addition_flag values.',
      p_solution               => 'If application version is on or above R12.1.3 Delta6 (For Release R12.1) or on or above R12.2.5 (For Release 12.2) then download the version of the generic datafix {22311067} appropriate for your release (as described in [2109948/KB416871#Case1]) and apply it according to the README instructions. <br> 
This issue is addressed by the Case # 1 of the data fix, follow instruction mentioned in [2109948/KB416871#Case1] for Case 1.<br>
If application version is below R12.1.3 Delta6 (For Release R12.1) or below R12.2.5 (For Release 12.2) then download the version of the generic datafix {13833481} appropriate for your release (as described in [1363661/PALRT1343]) and apply it according to the README instructions. <br> 
This issue is addressed by the Case # 8 of the data fix, follow instruction mentioned in patch {13833481} for Case 8.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_INVALID_PA_ADDITION_FLAG_IMPORTED_EXP');



debug('begin add_signature: PA_P2P_INVALID_PA_ADDITION_FLAG_IMPORTED_INV_VARIANCE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12235',
      p_sig_id                 => 'PA_P2P_INVALID_PA_ADDITION_FLAG_IMPORTED_INV_VARIANCE',
      p_sig_sql                => 'SELECT PPA.SEGMENT1 PROJECT_NUMBER,
       PPA.PROJECT_STATUS_CODE PROJECT_STATUS,
       INV.INVOICE_NUM,
       DIST.AMOUNT,
...
AND   inv.invoice_id = dist.invoice_id
AND   inv.invoice_id = nvl(##$$INVOICE_ID$$##, inv.invoice_id)
AND   nvl(dist.pa_addition_flag,''N'') <> ''Y''
AND   nvl(dist.reversal_flag,''N'') = ''N''
AND   dist.posted_flag = ''Y''
AND   dist.project_id >0
AND   nvl(dist.historical_flag,''N'') = ''N''
AND   dist.line_type_lookup_code IN (''ERV'',''TRV'',''IPV'',''TIPV'',''TERV'' )
AND   dist.org_id = nvl(##$$ORG_ID$$##, dist.org_id)
AND   dist.org_id = inv.org_id
AND   EXISTS (
        SELECT ''X'' FROM pa_expenditure_items_all ei
        ...
        AND   ei.document_distribution_id = dist.invoice_distribution_id
        AND   ei.document_distribution_type is not null
        AND   ei.transaction_source IN (''AP VARIANCE'',''AP NRTAX'',''AP ERV''))',
      p_title                  => 'Wrong PA Addition Flag for Imported Invoice Variance Transactions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invoice variance transactions interfaced to projects having incorrect pa_addition_flag values.',
      p_solution               => 'If application version is on or above R12.1.3 Delta6 (For Release R12.1) or on or above R12.2.5 (For Release 12.2) then download the version of the generic datafix {22311067} appropriate for your release (as described in [2109948/KB416871#Case3]) and apply it according to the README instructions. <br> 
This issue is addressed by the Case # 3 of the data fix, follow instruction mentioned in [2109948/KB416871#Case3] for Case 3.<br>
If application version is below R12.1.3 Delta6 (For Release R12.1) or below R12.2.5 (For Release 12.2) then download the version of the generic datafix {13833481} appropriate for your release (as described in [1363661/PALRT1343]) and apply it according to the README instructions. <br> 
This issue is addressed by the Case # 3 of the data fix, follow instruction mentioned in patch {13833481} for Case 3.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_INVALID_PA_ADDITION_FLAG_IMPORTED_INV_VARIANCE');



debug('begin add_signature: PA_P2P_INVALID_PA_ADDITION_FLAG_IMPORTED_NET_ZERO_EXP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12234',
      p_sig_id                 => 'PA_P2P_INVALID_PA_ADDITION_FLAG_IMPORTED_NET_ZERO_EXP',
      p_sig_sql                => 'SELECT PPA.SEGMENT1 PROJECT_NUMBER,
       PPA.PROJECT_STATUS_CODE PROJECT_STATUS,
       INV.INVOICE_NUM,
       DIST.EXPENDITURE_ITEM_DATE,
...
AND   dist.org_id = inv.org_id
AND   EXISTS (
        SELECT 1 FROM ap_invoice_distributions_all dist2
        WHERE dist.invoice_id = dist2.invoice_id
        AND   dist2.parent_reversal_id = dist.invoice_distribution_id
        AND   dist2.pa_addition_flag = ''Y''
        AND   nvl(dist2.reversal_Flag,''N'') = ''Y''
        AND   EXISTS (
                SELECT 1 FROM pa_expenditure_items_all ei1
                WHERE ei1.document_header_id = dist2.invoice_id
                AND   ei1.document_distribution_id = dist2.invoice_distribution_id))
AND   EXISTS (
...
AND   EXISTS (
        SELECT 1 FROM ap_invoice_distributions_all dist2
        WHERE dist.parent_reversal_id = dist2.invoice_distribution_id
        AND   dist2.pa_addition_flag = ''Y''
        AND   nvl(dist2.reversal_flag,''N'') = ''Y''
        AND   EXISTS (
                SELECT 1 FROM pa_expenditure_items_all ei2
                WHERE ei2.document_header_id = dist2.invoice_id
        AND   ei2.document_distribution_id = dist2.invoice_distribution_id))
AND   EXISTS (
        SELECT 1 FROM pa_expenditure_items_all ei
        WHERE ei.document_header_id = dist.invoice_id
        AND   ei.document_distribution_id = dist.invoice_distribution_id
        AND   ei.document_distribution_type is not null)',
      p_title                  => 'Wrong PA Addition Flag for Net Zero Imported Invoice Transactions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Net zero invoice transactions which have interfaced to Projects having incorrect pa_addition_flag values.',
      p_solution               => 'If application version is on or above R12.1.3 Delta6 (For Release R12.1) or on or above R12.2.5 (For Release 12.2) then download the version of the generic datafix {22311067} appropriate for your release (as described in [2109948/KB416871#Case2]) and apply it according to the README instructions. <br> 
This issue is addressed by the Case # 2 of the data fix, follow instruction mentioned in [2109948/KB416871#Case2] for Case 2.<br>
If application version is below R12.1.3 Delta6 (For Release R12.1) or below R12.2.5 (For Release 12.2) then download the version of the generic datafix {13833481} appropriate for your release (as described in [1363661/PALRT1343]) and apply it according to the README instructions. <br> 
This issue is addressed by the Case # 8 of the data fix, follow instruction mentioned in patch {13833481} for Case 8.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_INVALID_PA_ADDITION_FLAG_IMPORTED_NET_ZERO_EXP');



debug('begin add_signature: PA_P2P_INVALID_PA_ADDITION_FLAG_IMPORTED_PO_RECEIPTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12239',
      p_sig_id                 => 'PA_P2P_INVALID_PA_ADDITION_FLAG_IMPORTED_PO_RECEIPTS',
      p_sig_sql                => 'SELECT PROJ.SEGMENT1 PROJECT_NUMBER,
       TASKS.TASK_NUMBER,
       PO_DIST.EXPENDITURE_TYPE,
       PO_DIST.EXPENDITURE_ITEM_DATE,
       PO_DIST.EXPENDITURE_ORGANIZATION_ID EXP_ORG_ID,
       (NVL(RCV_SUB1.ENTERED_DR, 0) - NVL(RCV_SUB1.ENTERED_CR, 0)) AMOUNT,
       POH.SEGMENT1 PO_NUMBER,
       RSH.RECEIPT_NUM RECEIPT_NUMBER,
       PROJ.PROJECT_STATUS_CODE,
       RCV_SUB1.RCV_SUB_LEDGER_ID
...
AND   poh.po_header_id = po_dist.po_header_id
AND   po_dist.project_ID           > 0
AND   proj.project_id = ##$$PROJECT_ID$$##
AND   poh.po_header_id = nvl(##$$PO_HEADER_ID$$##,poh.po_header_id)
AND   po_dist.project_id = proj.project_id
AND   po_dist.task_id = tasks.task_id
AND   proj.project_id = tasks.project_id
AND   po_dist.accrue_on_receipt_flag = ''Y''
AND   nvl(rcv_sub1.pa_addition_flag,''N'') <> ''Y''
AND   rcv_sub1.actual_flag = ''A''
AND   rcv_sub1.accounting_line_type = ''Charge''
AND   po_dist.org_id = nvl(##$$PO_ORG_ID$$##,po_dist.org_id)
AND   poh.org_id = po_dist.org_id
AND   EXISTS (
        SELECT ''X'' FROM pa_expenditure_items_all ei
        WHERE ei.document_distribution_id = rcv_txn.transaction_id
        AND   ei.document_header_id = po_dist.po_header_id
        AND   ei.DOCUMENT_LINE_NUMBER = po_dist.po_distribution_id
        AND   ei.project_id = po_dist.project_id
        AND   ei.task_id = po_dist.task_id
        AND   ei.transaction_source IN (
                ''PO RECEIPT'',''PO RECEIPT NRTAX'',''PO RECEIPT NRTAX PRICE ADJ'',
                ''PO RECEIPT PRICE ADJ''))',
      p_title                  => 'Wrong PA Addition Flag for Imported Purchase Order Receipts',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'PO Receipt transactions interfaced to projects with wrong pa_addition_flag.',
      p_solution               => 'If application version is on or above R12.1.3 Delta6 (For Release R12.1) or on or above R12.2.5 (For Release 12.2) then download the version of the generic datafix {22311067} appropriate for your release (as described in [2109948/KB416871#Case4]) and apply it according to the README instructions. <br> 
This issue is addressed by the Case # 4 of the data fix, follow instruction mentioned in [2109948/KB416871#Case4] for Case 4.<br>
If application version is below R12.1.3 Delta6 (For Release R12.1) or below R12.2.5 (For Release 12.2) then download the version of the generic datafix {13833481} appropriate for your release (as described in [1363661/PALRT1343]) and apply it according to the README instructions. <br> 
This issue is addressed by the Case # 7 of the data fix, follow instruction mentioned in patch {13833481} for Case 7.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_INVALID_PA_ADDITION_FLAG_IMPORTED_PO_RECEIPTS');



debug('begin add_signature: PA_P2P_INVALID_PA_ADDITION_FLAG_NOT_IMPORTED_INVOICE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12240',
      p_sig_id                 => 'PA_P2P_INVALID_PA_ADDITION_FLAG_NOT_IMPORTED_INVOICE',
      p_sig_sql                => 'SELECT PROJ.SEGMENT1 PROJECT_NUMBER,
       PROJ.PROJECT_STATUS_CODE   PROJECT_STATUS,
       INV.INVOICE_NUM,
       DIST.AMOUNT,
...
WHERE dist.project_id > 0
AND   dist.line_type_lookup_code NOT IN (
        ''NONREC_TAX'', ''REC_TAX'',''RETAINAGE'',''PREPAY'',''ERV'',''TRV'',''IPV'',''TIPV'',
        ''TERV'',''AWT'',''RETROTAX'',''TAX'' )
AND   dist.pa_addition_Flag is not null
AND   nvl(dist.PA_ADDITION_FLAG,''N'') NOT IN (''N'',''E'')
...
AND   proj.project_id = ##$$PROJECT_ID$$##
AND   inv.INVOICE_iD = dist.invoice_id
AND   nvl(inv.source, ''xx'' ) NOT IN (''CREDIT CARD'',''Both Pay'')
...
FROM ap_invoice_distributions_all dist,
     ...
     pa_projects_all proj
WHERE dist.project_id > 0
AND   dist.line_type_lookup_code IN (''NONREC_TAX'', ''ACCRUAL'')
AND   nvl(dist.pa_addition_flag,''Y'') <> ''G''
AND   dist.posted_flag = ''Y''
AND   dist.amount <> 0
AND   dist.po_distribution_id is not null
AND   nvl(dist.reversal_flag,''N'') = ''N''
...
AND   EXISTS (
        SELECT 1 FROM po_distributions_all pod
        WHERE pod.po_distribution_id = dist.po_distribution_id
        AND   nvl(pod.distribution_type,''XXX'') <> ''PREPAYMENT''
...
WHERE dist.project_id > 0
AND   dist.line_type_lookup_code NOT IN (
        ''ACCRUAL'',''REC_TAX'',''RETAINAGE'',''PREPAY'',''ERV'',''TRV'',''IPV'',
        ''TIPV'',''TERV'',''AWT'',''RETROTAX'',''TAX'' )
AND   nvl(dist.pa_addition_flag,''Y'') <> ''N''
AND   dist.amount <> 0
AND   dist.posted_flag = ''Y''
AND   nvl(dist.reversal_flag,''N'') = ''N''
AND   nvl(dist.historical_flag,''N'') = ''N''
...
AND   (pa_nl_installed.is_nl_installed = ''N'' OR
       (pa_nl_installed.is_nl_installed = ''Y'' AND
        NOT EXISTS (
          SELECT ''X''
          FROM po_distributions_all pod,
               mtl_system_items si, po_lines_all pol
          WHERE  pod.po_distribution_id = dist.po_distribution_id
          AND    pod.po_line_id = pol.po_line_id
          AND      si.inventory_item_id = pol.item_id
          AND      si.comms_nl_trackable_flag = ''Y''
        ...
        NOT EXISTS (
          ...
          FROM ap_invoice_distributions apdist,
               ...
               mtl_system_items si,
               po_lines_all pol
          WHERE dist.charge_applicable_to_dist_id = apdist.invoice_distribution_id
...
AND   NOT EXISTS (
        ...
        AND   ei.document_distribution_type is not null
        AND   nvl(ei.net_zero_Adjustment_Flag,''N'') = ''N'')',
      p_title                  => 'Invoice Transactions Which Are Not Imported Having Wrong PA Addition Flag',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invoice transactions not interfaced to projects with wrong pa_addition_flag values.',
      p_solution               => 'If application version is on or above R12.1.3 Delta6 (For Release R12.1) or on or above R12.2.5 (For Release 12.2) then download the version of the generic datafix {22311067} appropriate for your release (as described in [2109948/KB416871#Case5]) and apply it according to the README instructions. <br> 
This issue is addressed by the Case # 5 of the data fix, follow instruction mentioned in [2109948/KB416871#Case5] for Case 5.<br>
If application version is below R12.1.3 Delta6 (For Release R12.1) or below R12.2.5 (For Release 12.2) then download the version of the generic datafix {13833481} appropriate for your release (as described in [1363661/PALRT1343]) and apply it according to the README instructions. <br> 
This issue is addressed by the Case # 8 of the data fix, follow instruction mentioned in patch {13833481} for Case 8.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_INVALID_PA_ADDITION_FLAG_NOT_IMPORTED_INVOICE');



debug('begin add_signature: PA_P2P_INVALID_PA_ADDITION_FLAG_NOT_IMPORTED_INV_VARIANCE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12241',
      p_sig_id                 => 'PA_P2P_INVALID_PA_ADDITION_FLAG_NOT_IMPORTED_INV_VARIANCE',
      p_sig_sql                => 'SELECT PPA.SEGMENT1 PROJECT_NUMBER,
       PPA.PROJECT_STATUS_CODE PROJECT_STATUS,
       INV.INVOICE_NUM,
       DIST.AMOUNT,
...
AND   dist.line_type_lookup_code IN (''ERV'',''TRV'',''IPV'',''TIPV'',''TERV'')
AND   dist.org_id = nvl(##$$ORG_ID$$##,dist.org_id)
AND   inv.org_id = dist.org_id
AND   NOT EXISTS (
        SELECT  ''X'' FROM pa_expenditure_items_all ei
        WHERE ei.document_header_id = dist.invoice_id
        AND   ei.document_distribution_id = dist.invoice_distribution_id
        AND   nvl(ei.net_zero_Adjustment_Flag,''N'') = ''N'')',
      p_title                  => 'Wrong PA Addition Flag for Invoice Variances Which Are Not Imported',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invoice variances not interfaced to Projects having incorrect pa_addition_flag values.',
      p_solution               => 'If application version is on or above R12.1.3 Delta6 (For Release R12.1) or on or above R12.2.5 (For Release 12.2) then download the version of the generic datafix {22311067} appropriate for your release (as described in [2109948/KB416871#Case6]) and apply it according to the README instructions. <br> 
This issue is addressed by the Case # 6 of the data fix, follow instruction mentioned in [2109948/KB416871#Case6] for Case 6.<br>
If application version is below R12.1.3 Delta6 (For Release R12.1) or below R12.2.5 (For Release 12.2) then log service request to get datafix.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_INVALID_PA_ADDITION_FLAG_NOT_IMPORTED_INV_VARIANCE');



debug('begin add_signature: PA_P2P_INVALID_PA_ADDITION_FLAG_NOT_IMPORTED_PO_RECEIPT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12242',
      p_sig_id                 => 'PA_P2P_INVALID_PA_ADDITION_FLAG_NOT_IMPORTED_PO_RECEIPT',
      p_sig_sql                => 'SELECT PPA.SEGMENT1 PROJECT_NUMBER,
       POH.SEGMENT1 PO_NUMBER,
       PO_DIST.EXPENDITURE_TYPE,
       PO_DIST.EXPENDITURE_ITEM_DATE,
       ...
       RSH.RECEIPT_NUM RECEIPT_NUMBER,
       RCV_SUB.RCV_TRANSACTION_ID RECEIPT_TXN_ID,
       RCV_TXN.DESTINATION_TYPE_CODE,
       RCV_TXN.TRANSACTION_TYPE,
       RCV_SUB.ACCOUNTING_LINE_TYPE ,
...
WHERE (rcv_txn.destination_type_code = ''EXPENSE'' OR
  ...
  AND   rsh.shipment_header_id = rcv_txn.shipment_header_id
  AND   ppa.project_id = ##$$PROJECT_ID$$##
  AND   ppa.project_id = po_dist.project_id
  AND   po_dist.project_ID  > 0
  AND   po_dist.accrue_on_receipt_flag = ''Y''
  AND   nvl(rcv_sub.pa_addition_flag, ''Y'') <> ''N''
  AND   rcv_sub.actual_flag = ''A''
  AND   rcv_sub.accounting_line_type = ''Charge''
  AND   po_dist.org_id = nvl(##$$PO_ORG_ID$$##,po_dist.org_id)
  AND   po_dist.org_id = poh.org_id
  AND   (pa_nl_installed.is_nl_installed = ''N'' OR
         (pa_nl_installed.is_nl_installed = ''Y'' AND
          NOT EXISTS (
            SELECT ''X''
            FROM mtl_system_items si,
                 po_lines_all pol
            WHERE pol.po_line_id = po_dist.po_line_id
            AND   si.inventory_item_id = pol.item_id
            AND   si.comms_nl_trackable_flag = ''Y''
            AND   (si.organization_id = po_dist.org_id OR
                   si.organization_id IN (
                     SELECT nvl(ship_to_organization_id,-9999)
                     FROM po_line_locations_all pll
                     WHERE pll.po_header_id = po_dist.po_header_id
                     AND   pll.po_line_id = po_dist.po_line_id)))))
AND   NOT EXISTS (
        SELECT ''X'' FROM pa_expenditure_items_all ei
        WHERE ei.document_distribution_id = rcv_sub.rcv_transaction_id
        AND   ei.document_header_id = to_number(rcv_sub.reference2)
        AND   ei.document_line_number = to_number(rcv_sub.reference3)
        AND   ei.project_id = po_dist.project_id
        AND   ei.task_id = po_dist.task_id
        AND   ei.transaction_source IN (
                ''PO RECEIPT'',''PO RECEIPT NRTAX'',''PO RECEIPT NRTAX PRICE ADJ'',
                ''PO RECEIPT PRICE ADJ''))',
      p_title                  => 'Wrong PA Addition Flag for PO Receipt Which Are Not Imported',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Purchase receipts which are not interfaced to projects having incorrect pa_addition_flag values.',
      p_solution               => 'If application version is on or above R12.1.3 Delta6 (For Release R12.1) or on or above R12.2.5 (For Release 12.2) then download the version of the generic datafix {22311067} appropriate for your release (as described in [2109948/KB416871#Case7]) and apply it according to the README instructions. <br> 
This issue is addressed by the Case # 7 of the data fix, follow instruction mentioned in [2109948/KB416871#Case7] for Case 7.<br>
If application version is below R12.1.3 Delta6 (For Release R12.1) or below R12.2.5 (For Release 12.2) then download the version of the generic datafix {13833481} appropriate for your release (as described in [1363661/PALRT1343]) and apply it according to the README instructions. <br> 
This issue is addressed by the Case # 7 of the data fix, follow instruction mentioned in patch {13833481} for Case 7.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_INVALID_PA_ADDITION_FLAG_NOT_IMPORTED_PO_RECEIPT');



debug('begin add_signature: PA_P2P_NET_ZERO_ADJ_PARENT_OR_CHILD_IMPORTED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12244',
      p_sig_id                 => 'PA_P2P_NET_ZERO_ADJ_PARENT_OR_CHILD_IMPORTED',
      p_sig_sql                => 'SELECT PAP.SEGMENT1 PROJECT_NUMBER,
       PAP.PROJECT_STATUS_CODE,
       AP.INVOICE_NUM INVOICE_NUMBER,
       APDIST.INVOICE_ID,
       APDIST.INVOICE_DISTRIBUTION_ID,
       APDIST.PO_DISTRIBUTION_ID,
       APDIST.LINE_TYPE_LOOKUP_CODE,
       APDIST.ORG_ID,
       APDIST.PROJECT_ID,
       APDIST.TASK_ID,
       APDIST.PA_ADDITION_FLAG,
       APDIST.REVERSAL_FLAG,
       APDIST.PARENT_REVERSAL_ID,
       APDIST.AMOUNT,
       APDIST.BASE_AMOUNT,
       APDIST.EXPENDITURE_TYPE,
       APDIST.EXPENDITURE_ITEM_DATE
FROM ap_invoice_distributions_all apdist,
     pa_projects_all pap,
     ap_invoices_all ap
WHERE apdist.project_id = pap.project_id
AND   pap.project_id = ##$$PROJECT_ID$$##
AND   ap.invoice_id = apdist.invoice_id
AND   apdist.line_type_lookup_code NOT IN (''REC_TAX'')
AND   nvl(apdist.pa_addition_flag,''N'') <> ''E''
AND   ap.invoice_id = nvl(##$$INVOICE_ID$$##,ap.invoice_id)
AND   nvl(apdist.reversal_flag,''N'') = ''Y''
AND   apdist.parent_reversal_id is not null
AND   apdist.org_id = nvl(##$$ORG_ID$$##,apdist.org_id)
AND   apdist.org_id = ap.org_id
AND   EXISTS (
        SELECT 1 FROM pa_expenditure_items_all ei
        WHERE ei.document_header_id = apdist.invoice_id
...
AND   EXISTS (
        SELECT 1 FROM ap_invoice_distributions_all apdist2
        WHERE apdist2.invoice_id = apdist.invoice_id
        AND   apdist2.invoice_distribution_id = apdist.parent_reversal_id
        AND   apdist2.line_type_lookup_code NOT IN (''REC_TAX'')
        AND   nvl(apdist2.pa_addition_Flag,''N'') <> ''E''
        AND   nvl(apdist2.reversal_flag,''N'') = ''Y''
        AND   NOT EXISTS (
                SELECT 1 FROM pa_expenditure_items_all ei1
                WHERE ei1.document_header_id = apdist2.invoice_id
                AND   ei1.document_distribution_id = apdist2.invoice_distribution_id))
UNION ALL
SELECT PAP.SEGMENT1,
       PAP.PROJECT_STATUS_CODE,
       AP.INVOICE_NUM,
...
AND   EXISTS (
      ...
      p_title                  => 'Parent or Child Net Zero Invoice Transactions Imported to PA',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'One net zero invoice distribution interfaced to Projects without the other.',
      p_solution               => 'If application version is on or above R12.1.3 Delta6 (For Release R12.1) or on or above R12.2.5 (For Release 12.2) then download the version of the generic datafix {22311067} appropriate for your release (as described in [2109948/KB416871#Case9]) and apply it according to the README instructions. <br> 
This issue is addressed by the Case # 9 of the data fix, follow instruction mentioned in [2109948/KB416871#Case9] for Case 9.<br>
If application version is below R12.1.3 Delta6 (For Release R12.1) or below R12.2.5 (For Release 12.2) then download the version of the generic datafix {13833481} appropriate for your release (as described in [1363661/PALRT1343]) and apply it according to the README instructions. <br> 
This issue is addressed by the Case # 8 of the data fix, follow instruction mentioned in patch {13833481} for Case 8.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_NET_ZERO_ADJ_PARENT_OR_CHILD_IMPORTED');



debug('begin add_signature: PA_P2P_INC_AMOUNTS_PO_RECEIPT_RETURNS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12245',
      p_sig_id                 => 'PA_P2P_INC_AMOUNTS_PO_RECEIPT_RETURNS',
      p_sig_sql                => 'SELECT DISTINCT
       EI.ORG_ID,
       ...
       RCV_SUB.RCV_TRANSACTION_ID,
       TO_CHAR(EI.DOCUMENT_DISTRIBUTION_ID) TXN_ID,
       EI.DOCUMENT_DISTRIBUTION_TYPE TRANSACTION_TYPE,
       EI.TRANSACTION_SOURCE,
       DECODE(EI.TRANSACTION_SOURCE,
         ''PO RECEIPT NRTAX'',NVL(RCV_SUB.ACCOUNTED_NR_TAX,0),
         DECODE(NVL(RCV_SUB.ENTERED_DR,0),
           0,-RCV_SUB.ENTERED_CR+NVL(RCV_SUB.ENTERED_NR_TAX,0),
           RCV_SUB.ENTERED_DR-NVL(RCV_SUB.ENTERED_NR_TAX,0))) RECEIPT_AMOUNT,
       PAP.PROJECT_STATUS_CODE
FROM pa_expenditure_items_all ei,
     ...
     po_lines_all pol,
     po_distributions_all pod
WHERE ei.project_id = pap.project_id
AND   ei.task_id = pt.task_id
AND   ei.project_id = pt.project_id
AND   ei.document_header_id = poh.po_header_id
AND   pap.project_id = ##$$PROJECT_ID$$##
AND   ei.adjusted_expenditure_item_id is null
AND   nvl(ei.net_zero_adjustment_flag,''N'') = ''N''
AND   ei.document_distribution_id = rcv_sub.rcv_transaction_id
AND   to_char(ei.document_line_number) = rcv_sub.reference3
AND   nvl(rcv_sub.pa_addition_flag,''N'') = ''Y''
AND   rcv_sub.rcv_transaction_id = rcv_txn.Transaction_id
AND   rcv_txn.shipment_header_id = rcv_shp.shipment_header_id
AND   rcv_sub.reference3 = to_char(pod.po_distribution_id)
AND   pod.po_line_id = pol.po_line_id
AND   ei.org_id = nvl(##$$PO_ORG_ID$$##,ei.org_id)
...
AND   ((ei.Transaction_Source = ''PO RECEIPT NRTAX'' AND
        ((ei.document_distribution_type = ''RETURN TO RECEIVING'' AND
          nvl(rcv_sub.accounted_nr_tax,0) <> -1* ei.acct_Raw_Cost) OR
         (ei.document_distribution_type = ''CORRECT'' AND
          nvl(rcv_sub.accounted_nr_tax,0) <> ei.acct_Raw_Cost) OR
       ...
       (ei.Transaction_Source = ''PO RECEIPT'' AND
        ((ei.document_distribution_type = ''RETURN TO RECEIVING'' AND
          (decode(nvl(rcv_sub.entered_dr,0),
             0,-rcv_sub.entered_cr + nvl(rcv_sub.entered_nr_tax,0),
             rcv_sub.entered_dr - nvl(rcv_sub.entered_nr_tax,0)) <> ei.denom_Raw_Cost)) OR
         (ei.document_distribution_type = ''CORRECT'' AND
          (decode(nvl(rcv_sub.entered_dr,0),
             0,- rcv_sub.entered_cr+nvl(rcv_sub.entered_nr_tax,0),
             rcv_sub.entered_dr-nvl(rcv_sub.entered_nr_tax,0)) <> ei.denom_Raw_Cost)) OR
         (ei.document_distribution_type = ''DELIVER'' AND
          (decode(nvl(rcv_sub.entered_dr,0),
             0,-rcv_sub.entered_cr+nvl(rcv_sub.entered_nr_tax,0),
             rcv_sub.entered_dr-nvl(rcv_sub.entered_nr_tax,0)) <> ei.denom_Raw_Cost)))))',
      p_title                  => 'PO Receipt Returns Interfaced to Projects with Incorrect Amounts',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'PO receipt return transactions interfaced to Projects with incorrect amounts.',
      p_solution               => 'If application version is on or above R12.1.3 Delta6 (For Release R12.1) or on or above R12.2.5 (For Release 12.2) then download the version of the generic datafix {22311067} appropriate for your release (as described in [2109948/KB416871#Case12]) and apply it according to the README instructions. <br> 
This issue is addressed by the Case # 12 of the data fix, follow instruction mentioned in [2109948/KB416871#Case12] for Case 12.<br>
If application version is below R12.1.3 Delta6 (For Release R12.1) or below R12.2.5 (For Release 12.2) then download the version of the generic datafix {13833481} appropriate for your release (as described in [1363661/PALRT1343]) and apply it according to the README instructions. <br> 
This issue is addressed by the Case # 6 of the data fix, follow instruction mentioned in patch {13833481} for Case 6.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_INC_AMOUNTS_PO_RECEIPT_RETURNS');



debug('begin add_signature: PA_P2P_CDL_ACC_ERROR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12246',
      p_sig_id                 => 'PA_P2P_CDL_ACC_ERROR',
      p_sig_sql                => 'SELECT CDL.rowid ROW_ID ,
       ...
       ITEM.TRANSACTION_SOURCE TXN_SRC
FROM pa_cost_distribution_lines_all cdl2,
     pa_expenditure_items_all item,
     pa_cost_distribution_lines_all cdl ,
     pa_projects_all p ,
     pa_project_types_all pt
WHERE cdl.expenditure_item_id = item.expenditure_item_id
AND   item.cost_dist_rejection_code is null
AND   item.system_linkage_function = ''VI''
AND   item.transaction_source IN (''AP DISCOUNTS'',''PO RECEIPT'')
...
AND   item.org_id = cdl.org_id
AND   p.project_id = ##$$PROJECT_ID$$##
AND   p.project_type = pt.project_type
AND   cdl2.expenditure_item_id =
        decode(item.adjusted_expenditure_item_id,
          null, decode(item.transferred_from_exp_item_id,
                  null, item.expenditure_item_id,
                  decode(cdl.line_num,
                    1, item.transferred_from_exp_item_id,
                    item.expenditure_item_id)),
          item.adjusted_expenditure_item_id)
AND   cdl2.line_num = (
        SELECT max(cdl3.line_num) FROM pa_cost_distribution_lines_all cdl3
        WHERE cdl3.expenditure_item_id = cdl2.expenditure_item_id
        AND   (cdl3.system_reference4 is not null OR cdl3.system_reference5 is not null)
        AND   cdl3.line_type = ''R'')',
      p_title                  => 'Distribution Lines Getting Rejected in Accounting with Error',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Distribution Lines getting rejected in Accounting with the error: Original transaction not accounted in final mode.',
      p_solution               => 'If application version is on or above R12.1.3 Delta6 (For Release R12.1) or on or above R12.2.5 (For Release 12.2) then download the version of the generic datafix {22311067} appropriate for your release (as described in [2109948/KB416871#Case13]) and apply it according to the README instructions. <br> 
This issue is addressed by the Case # 13 of the data fix, follow instruction mentioned in [2109948/KB416871#Case13] for Case # 13.<br>
If application version is below R12.1.3 Delta6 (For Release R12.1) or below R12.2.5 (For Release 12.2) then log service request to get datafix.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_CDL_ACC_ERROR');



debug('begin add_signature: PA_P2P_DUP_TRANSACTION_FROM_AP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12836',
      p_sig_id                 => 'PA_P2P_DUP_TRANSACTION_FROM_AP',
      p_sig_sql                => 'SELECT EI.DOCUMENT_HEADER_ID,
       EI.DOCUMENT_DISTRIBUTION_ID,
...
AND   nvl(ei.net_zero_Adjustment_Flag,''N'') = ''N''
AND   ppa.project_id = ##$$PROJECT_ID$$##
AND   ei.document_header_id = NVL(##$$INVOICE_ID$$##,ei.document_header_id)
...
AND   ei.org_id = nvl(##$$ORG_ID$$##,ei.org_id)
AND   ei.org_id = cdl.org_id
AND   ei.document_header_id is not null
AND   ei.document_distribution_id is not null
AND   ei.document_distribution_type is not null
GROUP BY ei.document_header_id, ei.document_distribution_id,
         ei.document_distribution_type, cdl.amount, cdl.org_id,
         cdl.line_type, ei.transaction_source
HAVING count(1) > 1',
      p_title                  => 'Duplicate Transactions in Projects from Supplier Invoice',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transactions causing duplicate actuals in PA from AP Invoice.',
      p_solution               => 'If application version is on or above R12.1.3 Delta6 (For Release R12.1) or on or above R12.2.5 (For Release 12.2) then download the version of the generic datafix {22311067} appropriate for your release (as described in [2109948/KB416871#Case 11]) and apply it according to the README instructions. <br> 
This issue is addressed by the Case # 11 of the data fix, follow instruction mentioned in [2109948/KB416871#Case 11] for Case 11.<br>
If application version is below R12.1.3 Delta6 (For Release R12.1) or below R12.2.5 (For Release 12.2) then download the version of the generic datafix {13833481} appropriate for your release (as described in [1363661/PALRT1343]) and apply it according to the README instructions. <br> 
This issue is addressed by the Case # 5 of the data fix, follow instruction mentioned in patch {13833481} for Case 5.',
      p_success_msg            => 'There are no duplicate AP invoice transactions appearing for this project.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_DUP_TRANSACTION_FROM_AP');



debug('begin add_signature: PA_P2P_DUP_TRANSACTION_FROM_AP_PO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12247',
      p_sig_id                 => 'PA_P2P_DUP_TRANSACTION_FROM_AP_PO',
      p_sig_sql                => 'SELECT EI.ORG_ID,
       PAP.SEGMENT1 PROJECT_NUMBER,
       PAT.TASK_NUMBER,
       EI.EXPENDITURE_TYPE,
       EI.EXPENDITURE_ITEM_DATE,
...
AND   pap.project_id = ##$$PROJECT_ID$$##
AND   ap.invoice_id = apdist.invoice_id
AND   pap.project_id = ei.project_id
AND   pat.task_id = ei.task_id
...
AND   apdist.project_id is not null
AND   nvl(apdist.historical_flag, ''N'') = ''N''
AND   poh.po_header_id = NVL(##$$PO_HEADER_ID$$##,poh.po_header_id)
AND   apdist.org_id = nvl(##$$ORG_ID$$##,apdist.org_id)
AND   apdist.org_id = ap.org_id
AND   pod.org_id = poh.org_id
AND   EXISTS (
        ...
        FROM rcv_receiving_sub_ledger rcv_sub,
             rcv_transactions rcvt,
             po_distributions_all pod
        WHERE rcv_sub.reference3 = to_char(apdist.po_distribution_id)
        ...
        AND   rcv_sub.accounting_line_type = ''Charge'')',
      p_title                  => 'Duplicate Transactions in Projects from AP Invoices and PO Receipts',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transactions causing duplicate actuals in PA from AP Invoices and PO receipts.',
      p_solution               => 'If application version is on or above R12.1.3 Delta6 (For Release R12.1) or on or above R12.2.5 (For Release 12.2) then download the version of the generic datafix {22311067} appropriate for your release (as described in [2109948/KB416871#Case14]) and apply it according to the README instructions. <br> 
This issue is addressed by the Case # 14 of the data fix, follow instruction mentioned in [2109948/KB416871#Case14] for Case 14.<br>
If application version is below R12.1.3 Delta6 (For Release R12.1) or below R12.2.5 (For Release 12.2) then download the version of the generic datafix {13833481} appropriate for your release (as described in [1363661/PALRT1343]) and apply it according to the README instructions. <br> 
This issue is addressed by the Case # 1 of the data fix, follow instruction mentioned in patch {13833481} for Case 1.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_DUP_TRANSACTION_FROM_AP_PO');



debug('begin add_signature: PA_P2P_DUP_TRANSACTION_FROM_PO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12835',
      p_sig_id                 => 'PA_P2P_DUP_TRANSACTION_FROM_PO',
      p_sig_sql                => 'SELECT
  cdl.system_reference2 SYSTEM_REFERENCE2,
  cdl.system_reference3 SYSTEM_REFERENCE3,
  cdl.system_reference4 SYSTEM_REFERENCE4,
  cdl.amount AMOUNT,
  cdl.org_id ORG_ID,
...
AND   rcv_sub1.actual_flag = ''A''
AND   rcv_sub1.accounting_line_type = ''Charge''
AND   ei.document_distribution_id = rcv_sub1.rcv_transaction_id
AND   rcv_sub1.reference2 = to_char(ei.document_header_id)
AND   rcv_sub1.reference3 = to_char(ei.DOCUMENT_LINE_NUMBER)
AND   ei.project_id = po_dist.project_id
AND   ei.task_id = po_dist.task_id
...
HAVING count(1) > 1',
      p_title                  => 'Duplicate Transactions in PA from PO Receipts',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Duplicate PO receipt transactions in Projects for the project/purchase order.',
      p_solution               => 'If application version is on and above R12.1.3 Delta6 (For Release R12.1) or on and above R12.2.5 (For Release 12.2) then download the version of the generic datafix {22311067} appropriate for your release (as described in [2109948/KB416871#Case10]) and apply it according to the README instructions. <br> 
This issue is addressed by the Case # 10 of the data fix, follow instruction mentioned in [2109948/KB416871#Case10] for Case 10.<br>
If application version is below R12.1.3 Delta6 (For Release R12.1) or below R12.2.5 (For Release 12.2) then download the version of the generic datafix {13833481} appropriate for your release (as described in [1363661/PALRT1343]) and apply it according to the README instructions. <br> 
This issue is addressed by the Case # 4 of the data fix, follow instruction mentioned in patch {13833481} for Case 4.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_DUP_TRANSACTION_FROM_PO');



debug('begin add_signature: PA_P2P_WRONG_PERIOD_CASH_ADJ_TRANSACTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12249',
      p_sig_id                 => 'PA_P2P_WRONG_PERIOD_CASH_ADJ_TRANSACTIONS',
      p_sig_sql                => 'SELECT PPA.SEGMENT1 PROJECT_NUMBER,
       PPA.PROJECT_STATUS_CODE,
       PPA.PROJECT_ID,
       EI.EXPENDITURE_ITEM_ID,
       ...
       APHA.ACCOUNTING_DATE ADJUSTED_DATE,
       APD.LINE_TYPE_LOOKUP_CODE,
       APD.ACCOUNTING_DATE INVOICE_ACC_DATE,
...
AND   aphd.invoice_distribution_id = apd.invoice_distribution_id
AND   ap.invoice_id = apd.invoice_id
AND   ap.invoice_id = nvl(##$$INVOICE_ID$$##,ap.invoice_id)
AND   apd.project_id = ppa.project_id
AND   ppa.project_id = ##$$PROJECT_ID$$##
...
AND   cdl.system_reference2 = apd.invoice_id
AND   ei.project_id = apd.project_id
AND   ei.task_id = apd.task_id
AND   cdl.project_id = apd.project_id
AND   cdl.task_id = apd.task_id
AND   cdl.gl_date <> apd.accounting_date
AND   apd.org_id = nvl(##$$ORG_ID$$##,apd.org_id)
AND   apd.org_id = ap.org_id
AND   apd.org_id = ei.org_id
AND   ei.org_id = cdl.org_id
AND   apd.org_id = apha.org_id',
      p_title                  => 'Cash Discount Adjusted Transactions Wrong Period',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Cash discount adjusted transactions are assigned to the wrong period.',
      p_solution               => 'If application version is on or above R12.1.3 Delta6 (For Release R12.1) or on or above R12.2.5 (For Release 12.2) then download the version of the generic datafix {22311067} appropriate for your release (as described in [2109948/KB416871#Case16]) and apply it according to the README instructions. <br> 
This issue is addressed by the Case # 16 of the data fix, follow instruction mentioned in [2109948/KB416871#Case16] for Case 16.<br>
If application version is below R12.1.3 Delta6 (For Release R12.1) or below R12.2.5 (For Release 12.2) then log service request to get data fix.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_WRONG_PERIOD_CASH_ADJ_TRANSACTIONS');



debug('begin add_signature: EBS_FIN_PA_PAP2P_DUP_EXP_SUP_INV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30538',
      p_sig_id                 => 'EBS_FIN_PA_PAP2P_DUP_EXP_SUP_INV',
      p_sig_sql                => 'SELECT
ei.document_header_id,
ei.document_distribution_id,
ei.document_distribution_type,
...
ei.transaction_source
  HAVING
  COUNT(1) >1 ',
      p_title                  => 'Duplicate Expenditures Created When Supplier Invoice Costs Imported From Payables Into Projects',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Duplicate expenditures created when supplier invoice costs imported from Payables into Projects.',
      p_solution               => 'Please review Duplicate Expenditures Created When Supplier Invoice Costs Imported From Payables Into Projects [2537496/KB474032] and log a service request to obtain a data fix.',
      p_success_msg            => 'No duplicate expenditures created when supplier invoice costs imported from Payables into Projects.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAP2P_DUP_EXP_SUP_INV');
...
debug('begin add_signature: PAAPIMPB_FILE_VERSION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20033',
      p_sig_id                 => 'PAAPIMPB_FILE_VERSION',
      p_sig_sql                => 'SELECT name,
               substr(ltrim(rtrim(substr(substr(s.text, instr(s.text,''Header: '')),
                                    instr(substr(s.text, instr(s.text,''Header: '')), '' '', 1, 1),
                                    instr(substr(s.text, instr(s.text,''Header: '')), '' '', 1, 2) -
                                    instr(substr(s.text, instr(s.text,''Header: '')), '' '', 1, 1) ))), 1, 25) "File Name",
            substr(ltrim(rtrim(substr(substr(s.text, instr(s.text,''Header: '')),
                                    ...
                                    instr(substr(s.text, instr(s.text,''Header: '')), '' '', 1, 2) ))), 1, 30) "File version"
FROM dba_source s
WHERE name = ''PAAPIMP_PKG''
AND text LIKE ''%Header: %''',
      p_title                  => 'Projects P2P Package Version',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'File version of package associated to PRC: Interface Supplier Cost',
      p_solution               => 'File version of package associated to PRC: Interface Supplier Cost',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: PAAPIMPB_FILE_VERSION');
...
debug('begin add_signature: PA_P2P_INVALID_TASK_DATES_AP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14745',
      p_sig_id                 => 'PA_P2P_INVALID_TASK_DATES_AP',
      p_sig_sql                => 'SELECT pt.task_number,
       pt.start_date,
       pt.completion_date,
       d.invoice_id,
       d.project_id,
...
AND   d.task_id    = pt.task_id
AND   (d.expenditure_item_date > pt.completion_date OR
       d.expenditure_item_date < pt.start_date) 
',
      p_title                  => 'Expenditure Item Date Outside Task Effective Dates for Supplier Invoice',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The item date is not within the task active dates for given project and invoice.',
      p_solution               => 'Refer to [1921745/KB159400] and follow the indicated steps to resolve this issue.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_INVALID_TASK_DATES_AP');



debug('begin add_signature: EBS_FIN_PA_PAP2P_INVALID_PROJECT_DATES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26780',
      p_sig_id                 => 'EBS_FIN_PA_PAP2P_INVALID_PROJECT_DATES',
      p_sig_sql                => 'SELECT p.segment1,
       p.start_date,
       p.completion_date,
       d.invoice_id,
       d.project_id
...
AND   d.project_id = ##$$PROJECT_ID$$##
AND   d.project_id = p.project_id
AND   (d.expenditure_item_date > p.completion_date OR
       d.expenditure_item_date < p.start_date) 
',
      p_title                  => 'Expenditure Item Date Outside Project Effective Dates for Supplier Invoice',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The item date is not within the project active dates for given project and invoice.',
      p_solution               => 'Refer to [2391251/KB490635] and follow the indicated steps to resolve this issue.',
      p_success_msg            => 'Expenditure Item Date for Supplier Invoice falls between Project and Task',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAP2P_INVALID_PROJECT_DATES');



debug('begin add_signature: PA_P2P_INVALID_TASK_DATES_PO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14746',
      p_sig_id                 => 'PA_P2P_INVALID_TASK_DATES_PO',
      p_sig_sql                => 'SELECT pt.task_number,
       pt.start_date,
       pt.completion_date,
       d.invoice_id,
...
AND   (d.expenditure_item_date > pt.completion_date OR
       d.expenditure_item_date < pt.start_date)',
      p_title                  => 'Expenditure Item Date Outside Task Effective Dates for Purchase Order',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The item date is not within the task active dates for given project and purchase order.',
      p_solution               => 'Refer to [1921745/KB159400] and follow the indicates steps to resolve this issue.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_INVALID_TASK_DATES_PO');



debug('begin add_signature: EBS_FIN_PA_PAP2P_INVALID_PROJECT_DATES_PO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26781',
      p_sig_id                 => 'EBS_FIN_PA_PAP2P_INVALID_PROJECT_DATES_PO',
      p_sig_sql                => 'SELECT p.segment1,
       p.start_date,
       p.completion_date,
       pd.po_header_id,
...
AND   (pd.expenditure_item_date > p.completion_date OR
       pd.expenditure_item_date < p.start_date)',
      p_title                  => 'Expenditure Item Date Outside Project Effective Dates for Purchase Order',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The item date is not within the project active dates for given project and purchase order.',
      p_solution               => 'Refer to [2391251/KB490635] and follow the indicates steps to resolve this issue.',
      p_success_msg            => 'Expenditure Item Date of Purchase Order falls between Project Effective Dates',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAP2P_INVALID_PROJECT_DATES_PO');



debug('begin add_signature: PA_P2P_PURCHASE_ORDERS');
   l_info('##MASK##CHANGE_REQUESTED_BY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CLM_AWARD_ADMINISTRATOR'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CLM_CONTRACT_OFFICER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CLM_COTR_CONTACT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CLM_SUPPLIER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CLM_SUPPLIER_SITE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMMENTS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##EMAIL_ADDRESS'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FAX'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11771',
      p_sig_id                 => 'PA_P2P_PURCHASE_ORDERS',
      p_sig_sql                => 'SELECT h.*
FROM po_headers_all h
WHERE h.po_header_id = ##$$PO_HEADER_ID$$##',
      p_title                  => 'Purchase Order Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Purchase Order does not exist for given purchase header id.',
      p_solution               => '',
      p_success_msg            => 'Purchase order details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_PURCHASE_ORDERS');



debug('begin add_signature: PA_P2P_PURCHASE_ORDER_LINES');
   l_info('##MASK##CONTRACTOR_FIRST_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CONTRACTOR_LAST_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12379',
      p_sig_id                 => 'PA_P2P_PURCHASE_ORDER_LINES',
      p_sig_sql                => 'SELECT l.*
FROM po_lines_all l
WHERE l.po_header_id = ##$$PO_HEADER_ID$$##',
      p_title                  => 'Purchase Order Line Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Purchase order lines do not exist for the given parameters.',
      p_solution               => '',
      p_success_msg            => 'Purchase order line details for the selected purchase order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_PURCHASE_ORDER_LINES');



debug('begin add_signature: PA_P2P_PURCHASE_ORDER_LINE_LOCATIONS');
   l_info('##MASK##NOTE_TO_RECEIVER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12380',
      p_sig_id                 => 'PA_P2P_PURCHASE_ORDER_LINE_LOCATIONS',
      p_sig_sql                => 'SELECT l.*
FROM po_line_locations_all l
WHERE l.po_header_id = ##$$PO_HEADER_ID$$##',
      p_title                  => 'Purchase Order Line Location Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Purchase order line locations do not exist for given project and purchase order combination.',
      p_solution               => '',
      p_success_msg            => 'Purchase order line location details for the selected project and purchase order combination.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_PURCHASE_ORDER_LINE_LOCATIONS');



debug('begin add_signature: PA_P2P_PURCHASE_ORDER_DISTRIBUTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11772',
      p_sig_id                 => 'PA_P2P_PURCHASE_ORDER_DISTRIBUTIONS',
      p_sig_sql                => 'SELECT d.*
FROM po_distributions_all d
WHERE d.po_header_id = ##$$PO_HEADER_ID$$##
AND   d.project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Purchase Order Distribution Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Purchase order distributions do not exist for the given parameters.',
      p_solution               => '',
      p_success_msg            => 'Purchase order distribution details for the selected project and purchase order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_PURCHASE_ORDER_DISTRIBUTIONS');



debug('begin add_signature: PA_P2P_RCV_TRANSACTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11773',
      p_sig_id                 => 'PA_P2P_RCV_TRANSACTIONS',
      p_sig_sql                => 'SELECT r.*
FROM rcv_transactions r
WHERE r.po_distribution_id IN (
        SELECT d.po_distribution_id FROM po_distributions_all d
        WHERE d.po_header_id = ##$$PO_HEADER_ID$$##
        AND   d.project_id = ##$$PROJECT_ID$$##)',
      p_title                  => 'Receipt Transaction Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Receipt transactions do not exist for given parameters.',
      p_solution               => '',
      p_success_msg            => 'Receipt transaction details for the selected purchase order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_RCV_TRANSACTIONS');



debug('begin add_signature: EBS_FIN_PA_P2P_WIP_TRANSACTIONS_FOR_PO_WITH_DEST_SHOP_FLOOR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29043',
      p_sig_id                 => 'EBS_FIN_PA_P2P_WIP_TRANSACTIONS_FOR_PO_WITH_DEST_SHOP_FLOOR',
      p_sig_sql                => 'select wt.pm_cost_collected,
    wt.pm_cost_collector_group_id,
    decode(wt.PM_COST_COLLECTED,''N'',''Cost Collection has not run but transactions are eligible to be transferred to Projects''
                                  ,''E'', ''Transactions in error after running cost collection''
                                  , null, decode (wt.PM_COST_COLLECTOR_GROUP_ID, null,''Not applicable to transfer to project''
                                                 ,''Transactions are already cost collected and transferred to Projects''))            transaction_status_description,
    wt.transaction_id,
    wt.last_update_date,
    wt.last_updated_by,
    wt.creation_date,
    ...
    wt.source_code
from wip_transactions  wt where wt.rcv_transaction_id in (
SELECT r.TRANSACTION_ID
FROM rcv_transactions r, po_distributions_all d
WHERE r.po_distribution_id =  d.po_distribution_id
AND   d.po_header_id = ##$$PO_HEADER_ID$$##
AND   d.project_id = ##$$PROJECT_ID$$##
and   D.PROJECT_ID IS NOT NULL
AND   r.DESTINATION_TYPE_CODE = ''SHOP FLOOR'')',
      p_title                  => 'WIP Transactions for PO with Destination Shop Floor',
      p_fail_condition         => '[PM_COST_COLLECTED] in [N, E]',
      p_problem_descr          => 'WIP transaction(s) for the purchase order with destination type of Inventory or Shop Floor exist and the Cost Collection Manager has not been run or the transaction(s) are stuck in error.',
      p_solution               => 'Review [3024400/KB780469] How to Check The Status of the Transactions in Projects That Results From Purchase Order With Destination Type Inventory Or Shop Floor?
',
      p_success_msg            => 'WIP transactions for the purchase order with destination type of Inventory or Shop Floor exist and have been transferred to Projects or are not eligible to be transferred.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_P2P_WIP_TRANSACTIONS_FOR_PO_WITH_DEST_SHOP_FLOOR');



debug('begin add_signature: EBS_FIN_PA_P2P_PROJECT_INTERFACE_FOR_PO_WITH_DEST_INV_AND_SHOP_FLOOR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29044',
      p_sig_id                 => 'EBS_FIN_PA_P2P_PROJECT_INTERFACE_FOR_PO_WITH_DEST_INV_AND_SHOP_FLOOR',
      p_sig_sql                => 'select *  from pa_transaction_interface_all
where system_linkage = ''WIP''
and   orig_transaction_reference in (select wt.transaction_id
FROM rcv_transactions r, po_distributions_all d, wip_transactions wt
WHERE r.po_distribution_id =  d.po_distribution_id
and   r.TRANSACTION_ID = wt.rcv_transaction_id
AND   d.po_header_id = ##$$PO_HEADER_ID$$##
AND   d.project_id = ##$$PROJECT_ID$$##
AND   r.DESTINATION_TYPE_CODE = ''SHOP FLOOR''
)
...
where system_linkage = ''INV''
and   orig_transaction_reference in (select to_char(mt.transaction_id)
FROM rcv_transactions r, po_distributions_all d, mtl_material_transactions  mt
WHERE r.po_distribution_id =  d.po_distribution_id
and   r.TRANSACTION_ID = mt.rcv_transaction_id
AND   d.po_header_id = ##$$PO_HEADER_ID$$##
AND   d.project_id = ##$$PROJECT_ID$$##
AND   r.DESTINATION_TYPE_CODE = ''INVENTORY''
)',
      p_title                  => 'Projects Interface for PO with Destination Inventory and Shop Floor',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Transaction does not exist in the interface for this purchase order.',
      p_solution               => 'Review [2612258/KB715711]Technical Brief on Integrating Oracle Projects with Oracle Inventory and Oracle Project Manufacturing.',
      p_success_msg            => 'Transaction exists in the interface for this purchase order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_P2P_PROJECT_INTERFACE_FOR_PO_WITH_DEST_INV_AND_SHOP_FLOOR');



debug('begin add_signature: EBS_FIN_PA_P2P_MATERIAL_TRANSACTIONS_FOR_PO_WITH_DEST_INV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29042',
      p_sig_id                 => 'EBS_FIN_PA_P2P_MATERIAL_TRANSACTIONS_FOR_PO_WITH_DEST_INV',
      p_sig_sql                => 'SELECT
    mt.pm_cost_collected,
    mt.pm_cost_collector_group_id,
    decode(mt.pm_cost_collected, ''N'', ''Cost Collection has not run but transactions are eligible to be transferred to Projects'', ''E'',
    ''Transactions in error after running cost collection'',
           NULL, decode(mt.pm_cost_collector_group_id, NULL, ''Not applicable to transfer to project'', ''Transactions are already cost collected and transferred to Projects''))
    ...
    mt.source_code
from mtl_material_transactions  mt where mt.rcv_transaction_id in (
SELECT r.TRANSACTION_ID
FROM rcv_transactions r, po_distributions_all d
WHERE r.po_distribution_id =  d.po_distribution_id
AND   d.po_header_id = ##$$PO_HEADER_ID$$##
...
and   D.PROJECT_ID IS NOT NULL
AND   r.DESTINATION_TYPE_CODE = ''INVENTORY'')',
      p_title                  => 'Material Transactions For PO With Destination Inventory',
      p_fail_condition         => '[PM_COST_COLLECTED] in [N, E]',
      p_problem_descr          => 'Material transaction(s) for the purchase order with destination type of Inventory exist and the Cost Collection Manager has not been run or the transaction(s) are stuck in error.
',
      p_solution               => 'Review the solution in [3024400/KB780469] How to Check The Status of the Transactions in Projects That Results From Purchase Order With Destination Type Inventory Or Shop Floor?',
      p_success_msg            => 'Material transaction(s) for the purchase order with destination type of Inventory have already been cost collected and transferred to Projects or are not eligible to be transferred to Projects.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_P2P_MATERIAL_TRANSACTIONS_FOR_PO_WITH_DEST_INV');



debug('begin add_signature: PA_P2P_RCV_SHIPMENT_HEADERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12394',
      p_sig_id                 => 'PA_P2P_RCV_SHIPMENT_HEADERS',
      p_sig_sql                => 'SELECT h.*
FROM rcv_shipment_headers h
WHERE h.shipment_header_id IN (
        SELECT r.shipment_header_id FROM rcv_transactions r
        WHERE r.po_distribution_id IN (
                SELECT d.po_distribution_id
                FROM po_distributions_all d
                WHERE d.po_header_id = ##$$PO_HEADER_ID$$##
                AND   d.project_id = ##$$PROJECT_ID$$##))',
      p_title                  => 'Receipt Shipment Header Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Receipt Shipment do not exist for given parameters.',
      p_solution               => '',
      p_success_msg            => 'Receipt shipment for given purchase order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_RCV_SHIPMENT_HEADERS');



debug('begin add_signature: PA_P2P_RCV_SHIPMENT_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12395',
      p_sig_id                 => 'PA_P2P_RCV_SHIPMENT_LINES',
      p_sig_sql                => 'SELECT l.*
FROM rcv_shipment_lines l
WHERE l.shipment_line_id IN (
        ...
        WHERE r.po_distribution_id IN (
                ...
                WHERE d.po_header_id = ##$$PO_HEADER_ID$$##
                AND   d.project_id = ##$$PROJECT_ID$$##))',
      p_title                  => 'Receipt Shipment Line Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Receipt Shipment Lines do not exist for given parameters.',
      p_solution               => '',
      p_success_msg            => 'Details for receipt shipment lines associated with given purchase order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_RCV_SHIPMENT_LINES');



debug('begin add_signature: PA_P2P_RCV_RECEIVING_SUB_LEDGERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11794',
      p_sig_id                 => 'PA_P2P_RCV_RECEIVING_SUB_LEDGERS',
      p_sig_sql                => 'SELECT *
FROM rcv_receiving_sub_ledger rcv_sub
WHERE rcv_sub.rcv_transaction_id IN (
        SELECT r.transaction_id FROM rcv_transactions r
        WHERE r.po_distribution_id IN (
                SELECT d.po_distribution_id FROM po_distributions_all d
                WHERE d.po_header_id = ##$$PO_HEADER_ID$$##
                AND   d.project_id = ##$$PROJECT_ID$$##))',
      p_title                  => 'Receiving Sub Ledger Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Receipt Subledgers do not exist for given parameters.',
      p_solution               => '',
      p_success_msg            => 'Receipt subledger details for the given purchase order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_RCV_RECEIVING_SUB_LEDGERS');



debug('begin add_signature: PA_P2P_SUPPLIERS_BASED_ON_PO');
   l_info('##MASK##BANK_ACCOUNT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##BANK_ACCOUNT_NUM'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##BANK_NUM'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##BANK_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##COMPANY_REGISTRATION_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##FIRST_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##LAST_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##NATIONAL_INSURANCE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PARTNERSHIP_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SECOND_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TCA_SYNC_NUM_1099'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TCA_SYNC_VAT_REG_NUM'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TCA_SYNC_VENDOR_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRADING_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##UNIQUE_TAX_REFERENCE_NUM'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##VENDOR_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##VENDOR_NAME_ALT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11801',
      p_sig_id                 => 'PA_P2P_SUPPLIERS_BASED_ON_PO',
      p_sig_sql                => 'SELECT v.*
FROM ap_suppliers v
WHERE v.vendor_id IN (
      ...
      p_title                  => 'PO Supplier Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Suppliers not found for the  purchase order selected.',
      p_solution               => '',
      p_success_msg            => 'Supplier details for the selected purchase order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_SUPPLIERS_BASED_ON_PO');



debug('begin add_signature: PA_P2P_RECEIPT_DELIVERY_MISSING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14747',
      p_sig_id                 => 'PA_P2P_RECEIPT_DELIVERY_MISSING',
      p_sig_sql                => 'SELECT rct.transaction_id,
       rct.po_header_id,
...
FROM rcv_transactions rct,
     po_distributions_all pod
WHERE rct.po_header_id = ##$$PO_HEADER_ID$$##
AND   transaction_type = ''DELIVER''
AND   pod.po_distribution_id = rct.po_distribution_id
AND   pod.accrue_on_receipt_flag = ''Y''
AND   pod.project_id = ##$$PROJECT_ID$$##
',
      p_title                  => 'Missing Receipt Delivery Transaction',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The Delivery action has not been completed for the purchase order receipt.',
      p_solution               => 'Follow the solution indicated in [2652516/KB422183]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_RECEIPT_DELIVERY_MISSING');



debug('begin add_signature: PA_P2P_PURCHASE_ORDERS_BASED_ON_INVOICE');
   l_info('##MASK##CHANGE_REQUESTED_BY'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CLM_AWARD_ADMINISTRATOR'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CLM_CONTRACT_OFFICER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CLM_COTR_CONTACT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '12455',
      p_sig_id                 => 'PA_P2P_PURCHASE_ORDERS_BASED_ON_INVOICE',
      p_sig_sql                => 'SELECT h.*
FROM po_headers_all h
WHERE EXISTS (
        SELECT 1
        FROM po_distributions_all d,
             ap_invoice_distributions_all aid
        WHERE d.po_distribution_id = aid.po_distribution_id
        AND h.po_header_id = d.po_header_id
        AND aid.invoice_id = ##$$INVOICE_ID$$##)',
      p_title                  => 'Purchase Order Details for Supplier Invoice',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Purchase order details do not exist for the given invoice.',
      p_solution               => '',
      p_success_msg            => 'Purchase order details for the selected invoice.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_PURCHASE_ORDERS_BASED_ON_INVOICE');



debug('begin add_signature: PA_P2P_PURCHASE_ORDER_LINES_BASED_ON_INV');
   l_info('##MASK##CONTRACTOR_FIRST_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##CONTRACTOR_LAST_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12658',
      p_sig_id                 => 'PA_P2P_PURCHASE_ORDER_LINES_BASED_ON_INV',
      p_sig_sql                => 'SELECT l.*
FROM po_lines_all l,
     po_distributions_all d
WHERE l.po_line_id = d.po_line_id
AND   d.project_id = ##$$PROJECT_ID$$##
AND   EXISTS (
        SELECT 1 FROM ap_invoice_distributions_all aid
        WHERE d.po_distribution_id = aid.po_distribution_id
        AND   aid.invoice_id = ##$$INVOICE_ID$$##)',
      p_title                  => 'Purchase Order Line Details for Supplier Invoice',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Purchase order lines do not exist for the selected supplier invoice.',
      p_solution               => '',
      p_success_msg            => 'Purchase order line details for the selected Payables supplier invoice.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_PURCHASE_ORDER_LINES_BASED_ON_INV');



debug('begin add_signature: PA_P2P_PURCHASE_ORDER_LINE_LOCS_BASED_ON_INV');
   l_info('##MASK##NOTE_TO_RECEIVER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12659',
      p_sig_id                 => 'PA_P2P_PURCHASE_ORDER_LINE_LOCS_BASED_ON_INV',
      p_sig_sql                => 'SELECT l.*
FROM po_line_locations_all l,
     po_distributions_all d
...
AND   EXISTS (
        ...
        WHERE d.po_distribution_id = aid.po_distribution_id
        AND   aid.invoice_id = ##$$INVOICE_ID$$##)',
      p_title                  => 'Purchase Order Line Location Details for Supplier Invoice',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Purchase order line locations do not exist for the selected supplier invoice.',
      p_solution               => '',
      p_success_msg            => 'Purchase order line location details for the selected Payables supplier invoice.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_PURCHASE_ORDER_LINE_LOCS_BASED_ON_INV');



debug('begin add_signature: PA_P2P_PURCHASE_ORDER_DISTS_BASED_ON_INV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12660',
      p_sig_id                 => 'PA_P2P_PURCHASE_ORDER_DISTS_BASED_ON_INV',
      p_sig_sql                => 'SELECT d.*
FROM po_distributions_all d,
     ap_invoice_distributions_all aid
WHERE d.project_id = ##$$PROJECT_ID$$##
...
AND   aid.invoice_id = ##$$INVOICE_ID$$##',
      p_title                  => 'Purchase Order Distribution Details for Supplier Invoice',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Purchase order distributions do not exist for the supplier invoice.',
      p_solution               => '',
      p_success_msg            => 'Purchase order distributions related to the selected Payables supplier invoice.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_PURCHASE_ORDER_DISTS_BASED_ON_INV');



debug('begin add_signature: PA_P2P_RCV_TRANSACTIONS_BASED_ON_INV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12663',
      p_sig_id                 => 'PA_P2P_RCV_TRANSACTIONS_BASED_ON_INV',
      p_sig_sql                => 'SELECT r.*
FROM rcv_transactions r
WHERE r.po_distribution_id IN (
        SELECT d.po_distribution_id
      ...
      p_problem_descr          => 'Receipt transactions do not exist for given parameters.',
      p_solution               => '',
      p_success_msg            => 'Receipt transactions for the selected supplier invoice.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_RCV_TRANSACTIONS_BASED_ON_INV');



debug('begin add_signature: PA_P2P_RCV_SHIPMENT_HEADERS_BASED_ON_INV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12661',
      p_sig_id                 => 'PA_P2P_RCV_SHIPMENT_HEADERS_BASED_ON_INV',
      p_sig_sql                => 'SELECT *
FROM rcv_shipment_headers h
WHERE h.shipment_header_id IN (
        SELECT r.shipment_header_id FROM rcv_transactions r
      ...
      p_title                  => 'Receipt Shipment Header Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Receipt Shipment Headers do not exist for the given parameters.',
      p_solution               => '',
      p_success_msg            => 'Receipt shipment header details for the selected project and invoice.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_RCV_SHIPMENT_HEADERS_BASED_ON_INV');



debug('begin add_signature: PA_P2P_RCV_SHIPMENT_LINES_BASED_ON_INV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12662',
      p_sig_id                 => 'PA_P2P_RCV_SHIPMENT_LINES_BASED_ON_INV',
      p_sig_sql                => 'SELECT *
FROM RCV_SHIPMENT_LINES L
WHERE (L.SHIPMENT_HEADER_ID,L.SHIPMENT_LINE_ID) IN (SELECT R.SHIPMENT_HEADER_ID,R.SHIPMENT_LINE_ID
                                 FROM RCV_TRANSACTIONS R
                                WHERE R.PO_DISTRIBUTION_ID IN (SELECT D.PO_DISTRIBUTION_ID
                                                                 FROM PO_DISTRIBUTIONS_ALL D,
                                                                      AP_INVOICE_DISTRIBUTIONS_ALL AID
                                                                WHERE D.PO_DISTRIBUTION_ID = AID.PO_DISTRIBUTION_ID
                                                                  AND AID.INVOICE_ID = ##$$INVOICE_ID$$##
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_RCV_SHIPMENT_LINES_BASED_ON_INV');



debug('begin add_signature: PA_P2P_RCV_RECEIVING_SUB_LEDGERS_BASED_ON_INV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12664',
      p_sig_id                 => 'PA_P2P_RCV_RECEIVING_SUB_LEDGERS_BASED_ON_INV',
      p_sig_sql                => 'SELECT *
FROM rcv_receiving_sub_ledger rcv_sub
WHERE  rcv_sub.rcv_transaction_id IN (
         SELECT r.transaction_id FROM rcv_transactions r
         WHERE r.po_distribution_id IN (
                 ...
                 AND   aid.invoice_id = ##$$INVOICE_ID$$##
                 AND   d.project_id = ##$$PROJECT_ID$$##))',
      p_title                  => 'Receiving SubLedger Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Receipt Subledger data not found for the given parameters.',
      p_solution               => '',
      p_success_msg            => 'Receipt Subledger details for the given invoice number.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_RCV_RECEIVING_SUB_LEDGERS_BASED_ON_INV');



debug('begin add_signature: PA_P2P_SUPPLIER_INVOICE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11764',
      p_sig_id                 => 'PA_P2P_SUPPLIER_INVOICE',
...
WHERE invoice_id = ##$$INVOICE_ID$$##',
      p_title                  => 'Supplier Invoice Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Supplier invoice selected does not exist.',
      p_solution               => '',
      p_success_msg            => 'Supplier invoice details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_SUPPLIER_INVOICE');



debug('begin add_signature: PA_P2P_SUPPLIER_INVOICE_LINES');
   l_info('##MASK##MERCHANT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MERCHANT_TAX_REG_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11770',
      p_sig_id                 => 'PA_P2P_SUPPLIER_INVOICE_LINES',
      p_sig_sql                => 'SELECT l.*
FROM ap_invoice_lines_all l
WHERE l.invoice_id = ##$$INVOICE_ID$$##',
      p_title                  => 'Supplier Invoice Line Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Supplier invoice lines do not exist for given project and invoice combination.',
      p_solution               => '',
      p_success_msg            => 'Supplier invoice line details for the selected project and invoice.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_SUPPLIER_INVOICE_LINES');



debug('begin add_signature: PA_P2P_SUPPLIER_INVOICE_DISTRIBUTIONS');
   l_info('##MASK##MERCHANT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MERCHANT_TAXPAYER_ID'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MERCHANT_TAX_REG_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11769',
      p_sig_id                 => 'PA_P2P_SUPPLIER_INVOICE_DISTRIBUTIONS',
      p_sig_sql                => 'SELECT d.*
FROM ap_invoice_distributions_all d
WHERE d.invoice_id = ##$$INVOICE_ID$$##
AND   d.project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Supplier Invoice Distribution Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Supplier Invoice distributions do not exist for given parameters.',
      p_solution               => '',
      p_success_msg            => 'Supplier invoice distribution details for the given invoice and project combination.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_SUPPLIER_INVOICE_DISTRIBUTIONS');



debug('begin add_signature: PA_P2P_SUPPLIER_INVOICE_DISCOUNTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12253',
      p_sig_id                 => 'PA_P2P_SUPPLIER_INVOICE_DISCOUNTS',
      p_sig_sql                => 'SELECT aid.invoice_id,
       pay.payment_hist_dist_id,
       pay.invoice_distribution_id,
       pay.amount,
       pay.invoice_payment_id,
       pay.historical_flag,
       pay.pa_addition_flag
FROM ap_payment_hist_dists pay,
     ap_invoice_distributions_all aid
WHERE pay.invoice_distribution_id = aid.invoice_distribution_id
AND   aid.project_id = ##$$PROJECT_ID$$##
AND   aid.invoice_id = ##$$INVOICE_ID$$##
AND   pay.pay_dist_lookup_code = ''DISCOUNT''',
      p_title                  => 'Supplier Invoice Discounts Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Display information related supplier invoice discounts.',
      p_solution               => '',
      p_success_msg            => 'Supplier invoice discounts for given project and invoice number combination.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_SUPPLIER_INVOICE_DISCOUNTS');



debug('begin add_signature: PA_P2P_SUPPLIERS_BASED_ON_INV');
   l_info('##MASK##BANK_ACCOUNT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##BANK_ACCOUNT_NUM'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##BANK_NUM'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##BANK_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '12654',
      p_sig_id                 => 'PA_P2P_SUPPLIERS_BASED_ON_INV',
      p_sig_sql                => 'SELECT v.*
FROM ap_suppliers v,
     ap_invoices_all i
WHERE i.invoice_id = ##$$INVOICE_ID$$##
AND   i.vendor_id = v.vendor_id',
      p_title                  => 'Invoice Supplier Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Supplier does not exist for the selected invoice.',
      p_solution               => '',
      p_success_msg            => 'Supplier details for the selected invoice.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_SUPPLIERS_BASED_ON_INV');



debug('begin add_signature: PA_NULL_EXPENDITURE_ITEM_DATE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15509',
      p_sig_id                 => 'PA_NULL_EXPENDITURE_ITEM_DATE',
      p_sig_sql                => 'SELECT aid.invoice_id,
       aia.invoice_num,
       aid.org_id,
       aid.invoice_line_number,
...
FROM ap_invoice_distributions_all aid,
     ap_invoices_all  aia,
     pa_projects_all ppa
WHERE aid.expenditure_item_date is NULL
AND   aia.invoice_id = nvl(''##$$INVOICE_ID$$##'',aia.invoice_id)
AND   ppa.segment1 = nvl(''##$$PROJECT_ID$$##'', ppa.segment1)
AND   ppa.project_id = aid.project_id
AND   aia.invoice_id = aid.invoice_id
AND   aid.pa_addition_flag = ''N''
AND   aid.line_type_lookup_code NOT IN (''REC_TAX'', ''PREPAY'')
AND   aid.project_id > 0',
      p_title                  => 'Null Expenditure Item Date',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Project-related invoice distributions which have a null expenditure item date have been found.<br>
The null expenditure item date can result in invoices being placed on ''CANT FUNDS CHECK'' hold and errors in the funds check process during invoice validation.',
      p_solution               => 'See [1486372/KB205190#aref_section26] for solution of code and data fix.
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: PA_NULL_EXPENDITURE_ITEM_DATE');



debug('begin add_signature: PA_P2P_SELF_ASSESSED_TAX_DIST_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '20082',
      p_sig_id                 => 'PA_P2P_SELF_ASSESSED_TAX_DIST_LINES',
      p_sig_sql                => 'SELECT *
FROM ap_self_assessed_tax_dist_all
WHERE project_id = ##$$PROJECT_ID$$##
AND   invoice_id = ##$$INVOICE_ID$$##
',
      p_title                  => 'Self Assessed Tax Details for Invoice',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Payable self assessed tax lines do not exist for given parameters.',
      p_solution               => '',
      p_success_msg            => 'Self assessed tax details for the selected invoice.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_SELF_ASSESSED_TAX_DIST_LINES');



debug('begin add_signature: EBS_FIN_PA_PAP2P_DISCOUNTS_INTERFACED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31499',
      p_sig_id                 => 'EBS_FIN_PA_PAP2P_DISCOUNTS_INTERFACED',
      p_sig_sql                => 'SELECT * FROM ap_payment_hist_dists dist
WHERE invoice_distribution_id in ( select invoice_distribution_id from ap_invoice_distributions_all where invoice_id = ##$$INVOICE_ID$$##)',
      p_title                  => 'Discounts Interfaced to Projects',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No discounts interfaced to Projects for the selected invoice.',
      p_solution               => '',
      p_success_msg            => 'Discounts are interfaced to Projects for the selected invoice.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAP2P_DISCOUNTS_INTERFACED');



debug('begin add_signature: EBS_FIN_PA_PAP2P_AP_INV_INTERFACE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31777',
      p_sig_id                 => 'EBS_FIN_PA_PAP2P_AP_INV_INTERFACE',
      p_sig_sql                => 'select * from ap_invoices_interface 
where invoice_id = ##$$INVOICE_ID$$##',
      p_title                  => 'AP_INVOICES_INTERFACE',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Data does not exist in the ap_invoices_interface table for the selected invoice.',
      p_solution               => 'NA',
      p_success_msg            => 'Data exists in the ap_invoices_interface table for the selected invoice.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAP2P_AP_INV_INTERFACE');



debug('begin add_signature: EBS_FIN_PA_PAP2P_AP_INV_LINES_INTERFACE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31778',
      p_sig_id                 => 'EBS_FIN_PA_PAP2P_AP_INV_LINES_INTERFACE',
      p_sig_sql                => 'select * from ap_invoice_lines_interface where invoice_id = ##$$INVOICE_ID$$##',
      p_title                  => 'AP_INVOICE_LINES_INTERFACE',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data exists in the ap_invoice_lines_interface table for the selected invoice.',
      p_solution               => 'NA',
      p_success_msg            => 'Data exists in the ap_invoice_lines_interface table for the selected invoice.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAP2P_AP_INV_LINES_INTERFACE');



debug('begin add_signature: EBS_FIN_PA_PAP2P_AP_INTERFACE_REJECTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31779',
      p_sig_id                 => 'EBS_FIN_PA_PAP2P_AP_INTERFACE_REJECTIONS',
      p_sig_sql                => 'select * 
  from ap_interface_rejections  
 where parent_id in (
         select ##$$INVOICE_ID$$## from dual  
         union all  
         select invoice_line_id 
           from ap_invoice_lines_interface 
          where invoice_id = ##$$INVOICE_ID$$##
       )
   and parent_table in (''AP_INVOICES_INTERFACE'',''AP_INVOICE_LINES_INTERFACE'')',
      p_title                  => 'AP_INTERFACE_REJECTIONS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data exists in the ap_interface_rejections table for the selected invoice.

',
      p_solution               => 'NA',
      p_success_msg            => 'Data exists in the ap_interface_rejections table for the selected invoice.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAP2P_AP_INTERFACE_REJECTIONS');



debug('begin add_signature: PA_P2P_PAYMENT_DETAILS');
   l_info('##MASK##BANK_ACCOUNT_NUM'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##BANK_NUM'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##VENDOR_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12377',
      p_sig_id                 => 'PA_P2P_PAYMENT_DETAILS',
      p_sig_sql                => 'SELECT inv.invoice_id,
       pay.invoice_payment_id,
       inv.invoice_num,
       pay.payment_num,
       inv.invoice_amount,
       pay.amount "PAYMENT_AMOUNT",
       pay.period_name "PAYEMENT_PERIOD",
       pay.posted_flag "PAYMENT_POSTED_FLAG",
       ...
       ch.checkrun_name,
       ch.status_lookup_code "CHECK_STATUS",
       ch.vendor_name,
       ch.vendor_site_code,
       ch.cleared_amount,
       ch.cleared_date,
...
AND   pay.check_id = ch.check_id',
      p_title                  => 'Supplier Invoice Payment Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No supplier invoice payment information found.',
      p_solution               => '',
      p_success_msg            => 'Supplier invoice payment details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_PAYMENT_DETAILS');



debug('begin add_signature: PA_P2P_RETAINAGE_INV_TO_PA');
   l_info('##MASK##VENDOR_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12248',
      p_sig_id                 => 'PA_P2P_RETAINAGE_INV_TO_PA',
      p_sig_sql                => 'SELECT EI.ORG_ID,
       PAP.SEGMENT1 PROJECT_NUMBER,
       PAT.TASK_NUMBER,
       PO.VENDOR_NAME,
...
AND   pap.project_id = ##$$PROJECT_ID$$##
AND   pap.project_id = dist.project_id
AND   ap.invoice_id = dist.invoice_id
AND   pap.project_id = ei.project_id
AND   pat.task_id = ei.task_id
...
AND   ei.org_id = cdl.org_id
AND   ei.org_id = dist.org_id
AND   dist.org_id = ap.org_id
AND   cdl.amount <> 0
AND   ei.document_header_id = dist.invoice_id
AND   ei.document_distribution_id = dist.invoice_distribution_id
AND   dist.project_id > 0
AND   nvl(dist.pa_addition_flag,''N'') = ''Y''
AND   dist.line_type_lookup_code = ''RETAINAGE''',
      p_title                  => 'Retainage Invoice Transactions Interfaced',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Retainage Invoice Transactions Interfaced to Projects.',
      p_solution               => 'If application version is on or above R12.1.3 Delta6 (For Release R12.1) or on or above R12.2.5 (For Release 12.2) then download the version of the generic datafix {22311067} appropriate for your release (as described in [2109948/KB416871#Case15]) and apply it according to the README instructions. <br> 
This issue is addressed by the Case # 15 of the data fix, follow instruction mentioned in [2109948/KB416871#Case15] for Case 15.<br>
If application version is below R12.1.3 Delta6 (For Release R12.1) or below R12.2.5 (For Release 12.2) then download the version of the generic datafix {13833481} appropriate for your release (as described in [1363661/PALRT1343]) and apply it according to the README instructions. <br> 
This issue is addressed by the Case # 9 of the data fix, follow instruction mentioned in patch {13833481} for Case 9.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_RETAINAGE_INV_TO_PA');



debug('begin add_signature: PA_P2P_SELF_ASSESD_TAX_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12378',
      p_sig_id                 => 'PA_P2P_SELF_ASSESD_TAX_DETAILS',
      p_sig_sql                => 'SELECT inv.invoice_num,
       d.distribution_line_number,
       d.invoice_distribution_id,
       d.dist_code_combination_id,
       d.parent_reversal_id,
       d.prepay_distribution_id,
       d.line_type_lookup_code,
       d.amount,
       d.self_assessed_flag,
       d.posted_flag,
       d.pa_addition_flag,
       ...
       d.program_update_date
FROM ap_self_assessed_tax_dist_all d,
     ap_invoices_all inv
WHERE inv.invoice_id = d.invoice_id
AND   inv.invoice_id   = NVL(##$$INVOICE_ID$$##,inv.invoice_id)
AND   d.project_id = ##$$PROJECT_ID$$##',
      p_title                  => 'Supplier Invoice Self Assesed Tax Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No self assessed tax distribution details found for the selected parameters. ',
      p_solution               => '',
      p_success_msg            => 'Self assessed tax distribution details for the selected invoice and project.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_SELF_ASSESD_TAX_DETAILS');



debug('begin add_signature: PA_P2P_SUPPLIER_INVOICE_BASED_ON_PO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12657',
      p_sig_id                 => 'PA_P2P_SUPPLIER_INVOICE_BASED_ON_PO',
      p_sig_sql                => 'SELECT i.invoice_id,
       i.invoice_num,
       i.vendor_id,
...
WHERE i.invoice_id in (
        ...
        AND   pod.po_header_id = ##$$PO_HEADER_ID$$##)',
      p_title                  => 'Supplier Invoice Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Supplier invoice does not exist for the project and purchase order combination.',
      p_solution               => '',
      p_success_msg            => 'Supplier invoice details for the project and purchase order combination.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_SUPPLIER_INVOICE_BASED_ON_PO');



debug('begin add_signature: PA_P2P_SUPPLIER_INVOICE_LINES_BASED_ON_PO');
   l_info('##MASK##MERCHANT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MERCHANT_TAX_REG_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12656',
      p_sig_id                 => 'PA_P2P_SUPPLIER_INVOICE_LINES_BASED_ON_PO',
      p_sig_sql                => 'SELECT l.*
FROM ap_invoice_lines_all l
WHERE l.invoice_id IN (
        ...
        WHERE d.po_distribution_id = pod.po_distribution_id
        AND   pod.po_header_id = ##$$PO_HEADER_ID$$##)',
      p_title                  => 'Supplier Invoice Line Details for Purchase Order',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Supplier invoice lines do not exist for given project and purchase order combination.',
      p_solution               => '',
      p_success_msg            => 'Supplier invoice line details for the selected project and purchase order combination.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_SUPPLIER_INVOICE_LINES_BASED_ON_PO');



debug('begin add_signature: PA_P2P_SUPPLIER_INVOICE_DIST_BASED_ON_PO');
   l_info('##MASK##MERCHANT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MERCHANT_TAXPAYER_ID'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MERCHANT_TAX_REG_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12655',
      p_sig_id                 => 'PA_P2P_SUPPLIER_INVOICE_DIST_BASED_ON_PO',
      p_sig_sql                => 'SELECT d.*
FROM ap_invoice_distributions_all d,
     po_distributions_all pod
WHERE d.project_id = ##$$PROJECT_ID$$##
...
AND   pod.po_header_id = ##$$PO_HEADER_ID$$##',
      p_title                  => 'Supplier Invoice Distribution Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Supplier Invoice distributions do not exist for the given project and purchase order combination.',
      p_solution               => '',
      p_success_msg            => 'Supplier invoice distribution details for the selected project and purchase order combination.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_SUPPLIER_INVOICE_DIST_BASED_ON_PO');



debug('begin add_signature: PA_P2P_EXPENDITURES_BASED_ON_INV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12406',
      p_sig_id                 => 'PA_P2P_EXPENDITURES_BASED_ON_INV',
      p_sig_sql                => 'SELECT * FROM pa_expenditures_all
WHERE expenditure_id IN (
        SELECT expenditure_id
        FROM pa_expenditure_items_all
        WHERE project_id = ##$$PROJECT_ID$$##
        AND   document_header_id = ##$$INVOICE_ID$$##
        AND system_linkage_function IN (''VI'',''ER''))',
      p_title                  => 'Expenditure Details for Invoice',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Expenditures do not exist for the selected invoice.',
      p_solution               => '',
      p_success_msg            => 'Expenditure details for the selected invoice.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_EXPENDITURES_BASED_ON_INV');



debug('begin add_signature: PA_P2P_EXPENDITURE_ITEMS_BASED_ON_INV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11796',
      p_sig_id                 => 'PA_P2P_EXPENDITURE_ITEMS_BASED_ON_INV',
      p_sig_sql                => 'SELECT *
FROM pa_expenditure_items_all
WHERE project_id = ##$$PROJECT_ID$$##
AND   document_header_id = ##$$INVOICE_ID$$##
AND   system_linkage_function IN (''VI'',''ER'')',
      p_title                  => 'Expenditure Item Details for Invoice',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Expenditure Items do not exist for given parameters.',
      p_solution               => '',
      p_success_msg            => 'Expenditure item details for the selected invoice.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_EXPENDITURE_ITEMS_BASED_ON_INV');



debug('begin add_signature: PA_P2P_COST_DISTRIBUTION_LINES_BASED_ON_INV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11795',
      p_sig_id                 => 'PA_P2P_COST_DISTRIBUTION_LINES_BASED_ON_INV',
      p_sig_sql                => 'SELECT *
...
WHERE expenditure_item_id IN (
        ...
        AND document_header_id = ##$$INVOICE_ID$$##
        AND system_linkage_function IN (''VI'',''ER''))',
      p_title                  => 'Cost Distribution Lines for Invoice',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Cost is not distributed for expenditure items.',
      p_solution               => '',
      p_success_msg            => 'Cost distribution line details for expenditure items for the selected invoice.<br>
For details related to the transfer_status code review [558574/KB502044] What Are The Values For The TRANSFER_STATUS_CODE In The PA_COST_DISTRIBUTION_LINES_ALL Table? ',
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_COST_DISTRIBUTION_LINES_BASED_ON_INV');



debug('begin add_signature: PA_P2P_EXP_ADJUSTMENT_ACTIVITIES_BASED_ON_INV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12410',
      p_sig_id                 => 'PA_P2P_EXP_ADJUSTMENT_ACTIVITIES_BASED_ON_INV',
      p_sig_sql                => 'SELECT adj.*,
       cpt.user_concurrent_program_name,
       cp.concurrent_program_name
FROM pa_expend_item_adj_activities adj,
     fnd_concurrent_programs cp,
     fnd_concurrent_programs_tl cpt,
     pa_cost_distribution_lines_all cdl
WHERE cdl.expenditure_item_id = adj.expenditure_item_id
AND   cdl.project_id = ##$$PROJECT_ID$$##
AND   cdl.system_reference2 = TO_CHAR(##$$INVOICE_ID$$##)
...
AND   cpt.language = USERENV(''LANG'')',
      p_title                  => 'Expenditure Item Adjustment Activities Against Invoice Based Expenditure',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No expenditure item adjustment activities identified for the given project and invoice.',
      p_solution               => '',
      p_success_msg            => 'Audit history of expenditure adjustment actions for the selected project and supplier invoice.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_EXP_ADJUSTMENT_ACTIVITIES_BASED_ON_INV');



debug('begin add_signature: PA_P2P_EXPENDITURES_BASED_ON_PO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12668',
      p_sig_id                 => 'PA_P2P_EXPENDITURES_BASED_ON_PO',
      p_sig_sql                => 'SELECT *
...
WHERE expenditure_id IN (
  ...
  FROM pa_expenditure_items_all
  WHERE project_id = ##$$PROJECT_ID$$##
  AND document_header_id = ##$$PO_HEADER_ID$$##
  AND system_linkage_function IN (''VI'',''ER''))',
      p_title                  => 'Expenditure Details for Purchase Order',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No expenditure details found for selected purchase order.',
      p_solution               => '',
      p_success_msg            => 'Expenditure details for purchase order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_EXPENDITURES_BASED_ON_PO');



debug('begin add_signature: PA_P2P_EXPENDITURE_ITEMS_BASED_ON_PO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12665',
      p_sig_id                 => 'PA_P2P_EXPENDITURE_ITEMS_BASED_ON_PO',
      p_sig_sql                => 'SELECT *
FROM pa_expenditure_items_all
WHERE project_id = ##$$PROJECT_ID$$##
AND   document_header_id = ##$$PO_HEADER_ID$$##
...
where system_linkage_function = ''WIP''
and   orig_transaction_reference in (select wt.transaction_id
FROM rcv_transactions r, po_distributions_all d, wip_transactions wt
WHERE r.po_distribution_id =  d.po_distribution_id
and   r.TRANSACTION_ID = wt.rcv_transaction_id
...
union all
select *  from pa_expenditure_items_all 
where system_linkage_function = ''INV''
and   orig_transaction_reference in (select to_char(mt.transaction_id)
FROM rcv_transactions r, po_distributions_all d, mtl_material_transactions  mt
WHERE r.po_distribution_id =  d.po_distribution_id
and   r.TRANSACTION_ID = mt.rcv_transaction_id
...
AND   r.DESTINATION_TYPE_CODE = ''INVENTORY''
      ...
      p_title                  => 'Expenditure Item Details for Purchase Order',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Expenditure items do not exist for the selected purchase order.',
      p_solution               => '',
      p_success_msg            => 'Expenditure item details for expenditure items related to the selected purchase order.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_EXPENDITURE_ITEMS_BASED_ON_PO');



debug('begin add_signature: PA_P2P_COST_DISTRIBUTION_LINES_BASED_ON_PO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12666',
      p_sig_id                 => 'PA_P2P_COST_DISTRIBUTION_LINES_BASED_ON_PO',
      p_sig_sql                => 'SELECT *
FROM pa_cost_distribution_lines_all
WHERE expenditure_item_id IN (
        SELECT expenditure_item_id
        ...
        AND document_header_id = ##$$PO_HEADER_ID$$##
        AND system_linkage_function IN (''VI'',''ER''))',
      p_title                  => 'Cost Distribution Lines for Purchase Order',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No cost distribution lines exist for the selected project and purchase order.',
      p_solution               => '',
      p_success_msg            => 'Cost distribution line details for the project and purchase order selected.<br>
Review [558574/KB502044] What Are The Values For The TRANSFER_STATUS_CODE In The PA_COST_DISTRIBUTION_LINES_ALL Table? for additional details related to the transfer_status code.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_COST_DISTRIBUTION_LINES_BASED_ON_PO');



debug('begin add_signature: PA_P2P_EXP_ADJUSTMENT_ACTIVITIES_BASED_ON_PO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12667',
      p_sig_id                 => 'PA_P2P_EXP_ADJUSTMENT_ACTIVITIES_BASED_ON_PO',
      p_sig_sql                => 'SELECT adj.*,
       cpt.user_concurrent_program_name,
       cp.concurrent_program_name
FROM pa_expend_item_adj_activities adj,
...
WHERE cdl.expenditure_item_id = adj.expenditure_item_id
AND   cdl.project_id = ##$$PROJECT_ID$$##
AND   cdl.system_reference2 = to_char(##$$PO_HEADER_ID$$##)
AND   cp.concurrent_program_id (+) = adj.program_id
AND   cp.application_id (+) = adj.program_application_id
AND   cpt.concurrent_program_id (+) = cp.concurrent_program_id
AND   cpt.application_id (+) = cp.application_id
AND   cpt.language = USERENV(''LANG'')',
      p_title                  => 'Expenditure Item Adjustment Activities Against PO Based Expenditure',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No expenditure item adjustment activities identified for the given projects and purchase order.',
      p_solution               => '',
      p_success_msg            => 'PA_EXPEND_ITEM_ADJ_ACTIVITIES stores audit records of adjustments which may alter the cost, revenue, and/or invoice amounts of an expenditure item.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: PA_P2P_EXP_ADJUSTMENT_ACTIVITIES_BASED_ON_PO');



debug('begin add_signature: EBS_FIN_PA_PAP2P_PO_PA_RECONCILIATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23186',
      p_sig_id                 => 'EBS_FIN_PA_PAP2P_PO_PA_RECONCILIATION',
      p_sig_sql                => 'SELECT
    ...
    gjh.name,
    gjl.je_line_num,
    gjl.code_combination_id                                 gl_ccid,
    gjl.period_name,
    gjl.status,
    rrsl.actual_flag,
    xal.entered_dr                                          xla_dr,
    xal.entered_cr                                          xla_cr,
    xal.accounted_dr                                        xla_acc_dr,
    xal.accounted_cr                                        xla_acc_cr,
    ( nvl(xal.accounted_dr, 0) - nvl(xal.accounted_cr, 0) ) xla_bal,
    rrsl.code_combination_id                                r_ccid,
    rrsl.entered_dr,
    rrsl.entered_cr,
    rrsl.accounted_dr,
    rrsl.accounted_cr,
...
WHERE
    ...
    AND rrsl.accounting_line_type = ''Charge''
     AND rrsl.pa_addition_flag  <> ''Y''
    AND rrsl.rcv_transaction_id = rt.transaction_id
    AND rt.po_distribution_id = pda.po_distribution_id
    AND pla.po_header_id = pda.po_header_id
    AND pla.po_line_id = pda.po_line_id
    AND pha.po_header_id = pda.po_header_id
    AND pda.accrue_on_receipt_flag = ''Y''
    AND pda.project_id = pp.project_id
    AND pda.project_id =  ##$$PROJECT_ID$$##',
      p_title                  => 'Reconciliation Report for the Purchase Order to Project ',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Reconciliation report for the Purchase order having enabled accrue_on_receipt_flag with project.',
      p_solution               => 'Run the query from [2885898/KB650965#Case1] to know the Purchasing receipt accounted to GL but not interfaced to Project.<br>
Run the concurrent process PRC: Interface Supplier Costs with parameter Interface Receipt Accruals as ''Yes'' to interface the receipt accrual to Project.',
      p_success_msg            => 'There is no Reconciliation issue between Project and General Ledger for the Purchasing Receipt',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_PAP2P_PO_PA_RECONCILIATION');
...
BEGIN
  ...
  analyzer_title := 'Projects Procure to Pay Integration Analyzer';
...
IF substr(g_rep_info('Apps Version'),1,4) IN ('12.0','12.1','12.2') THEN
   start_section('Proactive and Preventative Recommendations', 'Proactive');
      set_item_result(check_rec_patches_1); /* Signature PA_PJC_RECOMMENDED_PATCHES */
      set_item_result(run_stored_sig('EBS_FIN_PA_PA_FORMS_PERSONALIZATIONS'));
      set_item_result(run_stored_sig('EBS_FIN_PA_P2P_2873574_1'));
   end_section('All recommended patches have been applied');
END IF;
debug('end section: Proactive');

debug('begin section: Setup');
start_section('Setup', 'Setup');
   set_item_result(run_stored_sig('PA_P2P_AA_LOOKUP_SETS'));
   set_item_result(run_stored_sig('PA_P2P_AA_RULE_PAIRINGS'));
   set_item_result(run_stored_sig('PA_P2P_PAYABLE_SYSTEM_OPTIONS'));
   set_item_result(run_stored_sig('PA_P2P_PA_ADDITION_FLAG'));
   set_item_result(run_stored_sig('PA_P2P_PROFILE_OPTIONS'));
   set_item_result(run_stored_sig('PA_P2P_SUPPLIER_INV_ADJ_CREDIT_ACCOUNT'));
   set_item_result(run_stored_sig('PA_P2P_TRANSACTION_SOURCES'));
   set_item_result(run_stored_sig('PA_COST_INT_FLAGS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAP2P_COST_DIST_SYSTEM_REF_NULL'));
end_section;
debug('end section: Setup');

debug('begin section: Project');
start_section('Project Details', 'Project');
   ...
   set_item_result(run_stored_sig('EBS_FIN_PA_PAP2P_GST_TAX_PROJECT_APINV'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAP2P_GST_TAX_PROJECT_PO'));
end_section;
debug('end section: Project');

debug('begin section: AccountGenerator');
start_section('Account Generator Workflow', 'AccountGenerator');
   set_item_result(run_stored_sig('PA_P2P_ACC_GEN_WORKFLOW_DETAILS'));
   set_item_result(run_stored_sig('PA_P2P_ACC_GEN_WF_ACTIVITY_STATUS'));
   set_item_result(run_stored_sig('PA_P2P_ACC_GEN_WF_ACCOUNT_ASSIGNMENTS'));
   set_item_result(run_stored_sig('PA_P2P_ACC_GEN_WF_ATTRIBUTE_VALUES'));
   set_item_result(run_stored_sig('PA_P2P_ACC_GEN_WORKFLOW_DETAILS2'));
   set_item_result(run_stored_sig('PA_P2P_ACC_GEN_WF_ACTIVITY_STATUS2'));
   set_item_result(run_stored_sig('PA_P2P_ACC_GEN_WF_ACCOUNT_ASSIGNMENTS2'));
   set_item_result(run_stored_sig('PA_P2P_ACC_GEN_WF_ATTRIBUTE_VALUES2'));
end_section;
debug('end section: AccountGenerator');

debug('begin section: Accounting');
start_section('Accounting', 'Accounting');
   set_item_result(run_stored_sig('PA_P2P_XLA_ACC_ERRORS'));
   set_item_result(run_stored_sig('PA_P2P_XLA_TRANS_ENTITIES'));
   set_item_result(run_stored_sig('PA_P2P_XLA_EVENTS'));
   set_item_result(run_stored_sig('PA_P2P_XLA_AE_HEADERS'));
   set_item_result(run_stored_sig('PA_P2P_XLA_AE_LINES'));
   set_item_result(run_stored_sig('PA_P2P_XLA_DISTRIBUTION_LINKS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_PAP2P_AP_PA_RECONCILIATION'));
   IF ((substr(g_rep_info('Apps Version'),1,6) >= '12.2.7') OR
    (substr(g_rep_info('Apps Version'),1,7) >= '12.2.10')) THEN
      set_item_result(run_stored_sig('EBS_FIN_PA_PAP2P_PO_PA_RECONCILIATION'));
   END IF;
end_section;
debug('end section: Accounting');

debug('begin section: Expenditure');
start_section('Expenditure Details', 'Expenditure');
   set_item_result(run_stored_sig('PA_P2P_TRANSACTION_CONTROLS'));
   set_item_result(run_stored_sig('PA_P2P_EXPENDITURES_HISTORY'));
   set_item_result(run_stored_sig('PA_P2P_EXPENDITURE_COMMENTS'));
   IF p_invoice_id is not null THEN
      set_item_result(run_stored_sig('PA_P2P_EXPENDITURES_BASED_ON_INV'));
      set_item_result(run_stored_sig('PA_P2P_EXPENDITURE_ITEMS_BASED_ON_INV'));
      set_item_result(run_stored_sig('PA_P2P_COST_DISTRIBUTION_LINES_BASED_ON_INV'));
      set_item_result(run_stored_sig('PA_P2P_EXP_ADJUSTMENT_ACTIVITIES_BASED_ON_INV'));
   END IF;
   IF p_po_header_id is not null THEN
      set_item_result(run_stored_sig('PA_P2P_EXPENDITURES_BASED_ON_PO'));
      set_item_result(run_stored_sig('PA_P2P_EXPENDITURE_ITEMS_BASED_ON_PO'));
      set_item_result(run_stored_sig('PA_P2P_COST_DISTRIBUTION_LINES_BASED_ON_PO'));
      set_item_result(run_stored_sig('PA_P2P_EXP_ADJUSTMENT_ACTIVITIES_BASED_ON_PO'));
   END IF;
end_section;
debug('end section: Expenditure');

debug('begin section: Invoice');
start_section('Invoice Details', 'Invoice');
   IF p_invoice_id is not null THEN
      set_item_result(run_stored_sig('PA_P2P_SUPPLIER_INVOICE'));
      set_item_result(run_stored_sig('PA_P2P_SUPPLIER_INVOICE_LINES'));
      set_item_result(run_stored_sig('PA_P2P_SUPPLIER_INVOICE_DISTRIBUTIONS'));
      set_item_result(run_stored_sig('PA_P2P_SUPPLIER_INVOICE_DISCOUNTS'));
      set_item_result(run_stored_sig('PA_P2P_SUPPLIERS_BASED_ON_INV'));
      set_item_result(run_stored_sig('PA_NULL_EXPENDITURE_ITEM_DATE'));
      set_item_result(run_stored_sig('PA_P2P_SELF_ASSESSED_TAX_DIST_LINES'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAP2P_DISCOUNTS_INTERFACED'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAP2P_AP_INV_INTERFACE'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAP2P_AP_INV_LINES_INTERFACE'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAP2P_AP_INTERFACE_REJECTIONS'));
   END IF;
   IF p_invoice_id is not null and p_po_header_id is null THEN
      set_item_result(run_stored_sig('PA_P2P_PAYMENT_DETAILS'));
      set_item_result(run_stored_sig('PA_P2P_RETAINAGE_INV_TO_PA'));
      set_item_result(run_stored_sig('PA_P2P_SELF_ASSESD_TAX_DETAILS'));
   END IF;
   IF p_po_header_id is not null and p_invoice_id is null THEN
      set_item_result(run_stored_sig('PA_P2P_SUPPLIER_INVOICE_BASED_ON_PO'));
      set_item_result(run_stored_sig('PA_P2P_SUPPLIER_INVOICE_LINES_BASED_ON_PO'));
      set_item_result(run_stored_sig('PA_P2P_SUPPLIER_INVOICE_DIST_BASED_ON_PO'));
   END IF;
end_section;
debug('end section: Invoice');

debug('begin section: POAndReceiving');
start_section('Purchase Order and Receiving Details', 'POAndReceiving');
   IF p_po_header_id is not null THEN
      set_item_result(run_stored_sig('PA_P2P_PURCHASE_ORDERS'));
      set_item_result(run_stored_sig('PA_P2P_PURCHASE_ORDER_LINES'));
      set_item_result(run_stored_sig('PA_P2P_PURCHASE_ORDER_LINE_LOCATIONS'));
      set_item_result(run_stored_sig('PA_P2P_PURCHASE_ORDER_DISTRIBUTIONS'));
      set_item_result(run_stored_sig('PA_P2P_RCV_TRANSACTIONS'));
      set_item_result(run_stored_sig('EBS_FIN_PA_P2P_WIP_TRANSACTIONS_FOR_PO_WITH_DEST_SHOP_FLOOR'));
      set_item_result(run_stored_sig('EBS_FIN_PA_P2P_PROJECT_INTERFACE_FOR_PO_WITH_DEST_INV_AND_SHOP_FLOOR'));
      set_item_result(run_stored_sig('EBS_FIN_PA_P2P_MATERIAL_TRANSACTIONS_FOR_PO_WITH_DEST_INV'));
      set_item_result(run_stored_sig('PA_P2P_RCV_SHIPMENT_HEADERS'));
      set_item_result(run_stored_sig('PA_P2P_RCV_SHIPMENT_LINES'));
      set_item_result(run_stored_sig('PA_P2P_RCV_RECEIVING_SUB_LEDGERS'));
      set_item_result(run_stored_sig('PA_P2P_SUPPLIERS_BASED_ON_PO'));
      set_item_result(run_stored_sig('PA_P2P_RECEIPT_DELIVERY_MISSING'));
   END IF;
   IF p_po_header_id is null and p_invoice_id is not null THEN
      set_item_result(run_stored_sig('PA_P2P_PURCHASE_ORDERS_BASED_ON_INVOICE'));
      set_item_result(run_stored_sig('PA_P2P_PURCHASE_ORDER_LINES_BASED_ON_INV'));
      set_item_result(run_stored_sig('PA_P2P_PURCHASE_ORDER_LINE_LOCS_BASED_ON_INV'));
      set_item_result(run_stored_sig('PA_P2P_PURCHASE_ORDER_DISTS_BASED_ON_INV'));
      set_item_result(run_stored_sig('PA_P2P_RCV_TRANSACTIONS_BASED_ON_INV'));
      set_item_result(run_stored_sig('PA_P2P_RCV_SHIPMENT_HEADERS_BASED_ON_INV'));
      set_item_result(run_stored_sig('PA_P2P_RCV_SHIPMENT_LINES_BASED_ON_INV'));
      set_item_result(run_stored_sig('PA_P2P_RCV_RECEIVING_SUB_LEDGERS_BASED_ON_INV'));
   END IF;
end_section;
debug('end section: POAndReceiving');

debug('begin section: DataErrors');
start_section('Data Errors', 'DataErrors');
   set_item_result(run_stored_sig('EBS_FIN_PA_PAPJB_SIGNAL11'));
   set_item_result(run_stored_sig('PA_P2P_INVALID_EXP_ORG'));
   set_item_result(run_stored_sig('PA_P2P_INVALID_RCV_CCID'));
   set_item_result(run_stored_sig('PA_P2P_MISMATCH_AMT_FUNC_ENT_CURRENCY'));
   set_item_result(run_stored_sig('PA_P2P_INVALID_PA_ADDITION_FLAG_ASSET_TRACK_INV'));
   set_item_result(run_stored_sig('PA_P2P_INVALID_PA_ADDITION_FLAG_IMPORTED_EXP'));
   set_item_result(run_stored_sig('PA_P2P_INVALID_PA_ADDITION_FLAG_IMPORTED_INV_VARIANCE'));
   set_item_result(run_stored_sig('PA_P2P_INVALID_PA_ADDITION_FLAG_IMPORTED_NET_ZERO_EXP'));
   set_item_result(run_stored_sig('PA_P2P_INVALID_PA_ADDITION_FLAG_IMPORTED_PO_RECEIPTS'));
   set_item_result(run_stored_sig('PA_P2P_INVALID_PA_ADDITION_FLAG_NOT_IMPORTED_INVOICE'));
   set_item_result(run_stored_sig('PA_P2P_INVALID_PA_ADDITION_FLAG_NOT_IMPORTED_INV_VARIANCE'));
   set_item_result(run_stored_sig('PA_P2P_INVALID_PA_ADDITION_FLAG_NOT_IMPORTED_PO_RECEIPT'));
   set_item_result(run_stored_sig('PA_P2P_NET_ZERO_ADJ_PARENT_OR_CHILD_IMPORTED'));
   set_item_result(run_stored_sig('PA_P2P_INC_AMOUNTS_PO_RECEIPT_RETURNS'));
   set_item_result(run_stored_sig('PA_P2P_CDL_ACC_ERROR'));
   set_item_result(run_stored_sig('PA_P2P_DUP_TRANSACTION_FROM_AP'));
   set_item_result(run_stored_sig('PA_P2P_DUP_TRANSACTION_FROM_AP_PO'));
   set_item_result(run_stored_sig('PA_P2P_DUP_TRANSACTION_FROM_PO'));
   set_item_result(run_stored_sig('PA_P2P_WRONG_PERIOD_CASH_ADJ_TRANSACTIONS'));
   IF p_invoice_id is not null THEN
      set_item_result(run_stored_sig('PA_P2P_INVALID_TASK_DATES_AP'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAP2P_INVALID_PROJECT_DATES'));
   END IF;
   set_item_result(run_stored_sig('EBS_FIN_PA_PAP2P_COST_DIST_SYSTEM_REF_NULL'));
   IF p_po_header_id is not null THEN
      set_item_result(run_stored_sig('PA_P2P_INVALID_TASK_DATES_PO'));
      set_item_result(run_stored_sig('EBS_FIN_PA_PAP2P_INVALID_PROJECT_DATES_PO'));
   END IF;
   set_item_result(run_stored_sig('EBS_FIN_PA_PAP2P_DUP_EXP_SUP_INV'));
end_section('No data issues found');
debug('end section: DataErrors');
...
start_section('Apps Check', 'AppsCheck');
   ...
   set_item_result(run_stored_sig('PAAPIMPB_FILE_VERSION'));
end_section;
