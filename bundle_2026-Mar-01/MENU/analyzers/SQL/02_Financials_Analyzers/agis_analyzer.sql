...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for AGIS Analyzer                          |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE agis_analyzer_pkg AUTHID DEFINER AS
...
END agis_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY agis_analyzer_pkg AS
-- $Id: agis_analyzer.sql, 200.34 2025/12/13 22:12:34 viakula Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2208479.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'FUNAGIS_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'FUNAGIS_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>FUNAGIS Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2208479.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/agis_analyzer_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,806,EBS,EBS Financials,EBS - Financial Control" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,806,EBS,EBS Financials,EBS - Financial Control" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},806,EBS,EBS Financials,EBS - Financial Control" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4005828" class="blacklink" target="new">
...
<p><strong>In Version 200.33</strong><br>
Changes to Framework due to MOSFS migration</p><p><strong>In Version 200.32</strong><br>
The following signature have been updated with enhancements<br>
Sequences With 32-bit Maximum Value and Large Cache Size</p><p><strong>In Version 200.31</strong><br>
Just a Framework Template changes.</p><p><strong>In Version 200.30</strong><br>
The following signatures have been updated with additional details:<br>
- Ledger Definition<br>
- Ledger Details</p><p><strong>In Version 200.29</strong><br>
The following new signatures are added to the Files and Versions section:<br>
- Potential Custom Table Indexes<br>
- Invalid Table Indexes<br>
- Potential Custom Database Triggers</p><p>The following signatures have been updated with enhancements and with current latest patches:<br>
- AGIS Recommended Patches<br>
- Sequences with 32-bit maximum value and large cache size<br>
- Sequences above 70 percent of maximum value&nbsp;</p><p><strong>In Version 200.28</strong><br>
The following signatures have been enhanced in this release:<br>
- Recommended Patches<br>
- Sequences with 32-bit maximum value and large cache size<br>
- Sequences above 70 percent of maximum value&nbsp;</p>
            <br><br>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,806,'||l_sig.sigrepo_id||',EBS,EBS Financials,EBS - Financial Control" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,806,'||l_sig.sigrepo_id||',EBS,EBS Financials,EBS - Financial Control" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},806,'||l_sig.sigrepo_id||',EBS,EBS Financials,EBS - Financial Control" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,806,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Financial Control" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,806,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Financial Control" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},806,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Financial Control" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
FUNCTION check_rec_patches_1 RETURN VARCHAR2 IS
  /* Signature AGIS RECOMMENDED PATCHES */
...
BEGIN
    ...
    print_log('Processing recommended patches signature: AGIS RECOMMENDED PATCHES (check_rec_patches_1) "Recommended Patches" (version 12)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_col_rows(1)(l_rows) := '17448042';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'FUN: Consolidated Recommended Patch';
   l_col_rows(5)(l_rows) := '[1337466.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '18207386';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'FUNPRDSTSB: Agis Sweep Changes Created_by to Person Running the Sweep Process';
   l_col_rows(5)(l_rows) := '[1337466.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '17376162';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.FUN.B R12.1: FUN Recommended Patches on top of 12.1.3';
   l_col_rows(5)(l_rows) := '[1337466.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '18323140';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Informative Message Needed When Intercompany Import Process Fails';
   l_col_rows(5)(l_rows) := '[1337466.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '18177472';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'View the Attachments in Intercompany Transaction Notification';
   l_col_rows(5)(l_rows) := '[1337466.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '16983914';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Initiator not receiving request for more information notification';
   l_col_rows(5)(l_rows) := '[1337466.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21562032';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'R12.1: Financials Common Module Recommended Patch Collection (RPC), Aug 2015';
   l_col_rows(5)(l_rows) := '[954704.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '22462852';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'LOG IN AS ONE USER SHOWING AS ANOTHER USER WHEN UPDATE - APPROVE AGIS';
   l_col_rows(5)(l_rows) := '[2100753.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21789427';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'CONTINGENT WORKER NOT AVAILABLE ANYMORE ON THE AGIS SECURITY PAGE';
   l_col_rows(5)(l_rows) := '[2064204.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21762526';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'AME Patch for 12.1';
   l_col_rows(5)(l_rows) := '[2101244.1]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'AME patch for 12.2';
   l_col_rows(5)(l_rows) := '[2101244.1]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '30723290';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'AGIS AME USER ABLE TO APPROVE FROM INBOUND EVEN IF HE IS NOT A VALID APPROVER';
...
Above are the recommended patches for this product area as of 01-JAN-17.  For the most current recommendations, use the Patch Wizard or the Updates & Patches Tab in My Oracle Support. Further guidance can be found in the following documents:<br>
<ul><li>[11086538] How to Find EBS Patches and EBS Technology Patches</li>
<li>[976188.1] R11i / R12 : Patch Wizard Utility</li>
<li>[10940175] Patch Wizard FAQ </li></ul>
...
';
   l_sig.success_msg := 'All recommended patches applied.';
  ...
  -- Register
  l_step := '60';
  g_signatures('AGIS RECOMMENDED PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'AGIS RECOMMENDED PATCHES',     -- sig ID
...
----------------------------------------------------------------
l_calname VARCHAR2(50);



FUNCTION get_CALNAME
   return VARCHAR2 IS
BEGIN
debug('begin sql token function: CALNAME');
BEGIN

-- for Calendar Name

  SELECT led.period_set_name into l_calname
       FROM gl_ledgers led
...
EXCEPTION WHEN NO_DATA_FOUND THEN
       return null;
    END;
debug('end sql token function: CALNAME');
END get_CALNAME;
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Ledger Id';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_ledger_id,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Batch number';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_batch_number,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'User ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_user_id,'DISPLAY_BOTH_25_PCNT_WORD');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2025/12/13 22:12:33 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'agis_analyzer.sql';
...
debug('begin parameter validation: p_ledger_id');
IF p_ledger_id IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Ledger Id is required.');
...
INTO l_exists_val
FROM GL_LEDGERS GLL,GL_ACCESS_SET_LEDGERS GASL
WHERE GLL.LEDGER_ID = p_ledger_id
 AND GLL.LEDGER_ID = GASL.LEDGER_ID
AND (
mo_global.is_mo_init_done = 'N'
or
fnd_profile.value('GL_ACCESS_SET_ID') = GASL.ACCESS_SET_ID
)
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Ledger id. Please enter a Valid Ledger ID.
');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_ledger_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_ledger_id');

debug('begin parameter validation: p_batch_number');
...
WHERE BATCH_NUMBER = p_batch_number
 AND from_ledger_id=p_ledger_id
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Batch number. Please enter a valid batch number.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_batch_number failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_batch_number');

debug('begin parameter validation: p_user_id');
IF p_user_id IS NOT NULL THEN
BEGIN
SELECT USER_ID
INTO l_exists_val
FROM FND_USER
WHERE USER_ID = p_user_id and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid User_Id. Please enter a valid user_Id.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_user_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_user_id');
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$LEDGER_ID$$##') := p_ledger_id;
   g_masked_tokens('##$$LEDGER_ID$$##') := mask_text( g_sql_tokens('##$$LEDGER_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$USER_ID$$##') := p_user_id;
   g_masked_tokens('##$$USER_ID$$##') := mask_text( g_sql_tokens('##$$USER_ID$$##'), 'DISPLAY_BOTH_25_PCNT_WORD');
   g_sql_tokens('##$$BATCH_NUMBER$$##') := p_batch_number;
   g_masked_tokens('##$$BATCH_NUMBER$$##') := mask_text( g_sql_tokens('##$$BATCH_NUMBER$$##'), 'NO_MASK');
   g_sql_tokens('##$$p_ledger_id$$##') := p_ledger_id;
   g_masked_tokens('##$$p_ledger_id$$##') := mask_text( g_sql_tokens('##$$p_ledger_id$$##'), 'NO_MASK');
   g_sql_tokens('##$$LEDGID$$##') := p_ledger_id;
   g_masked_tokens('##$$LEDGID$$##') := mask_text( g_sql_tokens('##$$LEDGID$$##'), 'NO_MASK');
   g_sql_tokens('##$$CALNAME$$##') := get_CALNAME();
   l_system_function_var := null;
   g_masked_tokens('##$$CALNAME$$##') := mask_text( g_sql_tokens('##$$CALNAME$$##'), 'NO_MASK');
...
debug('begin add_signature: AGIS_DB_RELEASE_INFO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5608',
      p_sig_id                 => 'AGIS_DB_RELEASE_INFO',
      p_sig_sql                => 'select ''Instance Name = ''|| instance_name  ||  ''   ''||  upper(sys_context(''USERENV'',''DB_NAME''))  "Instance Summary" from v$instance
union
select ''Hostname = '' || host_name "Details" FROM v$instance
union
...
SELECT ''Creation Date = '' ||to_char(created, ''DD-MON-YYYY HH:MI:SS'') created from v$database',
      ...
      p_problem_descr          => 'Database / Release / Tools Details',
      p_solution               => '',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: AGIS_DB_RELEASE_INFO');



debug('begin add_signature: AGIS_DB_PARAMETERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5609',
      p_sig_id                 => 'AGIS_DB_PARAMETERS',
      p_sig_sql                => 'select
name "Parameter Name"
...
order by name',
   ...
   l_info.delete;
debug('end add_signature: AGIS_DB_PARAMETERS');



debug('begin add_signature: AGIS_LANGUAGES_INSTALLED_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5662',
      p_sig_id                 => 'AGIS_LANGUAGES_INSTALLED_DETAILS',
...
order by LANGUAGE_CODE',
      ...
      p_solution               => 'Please ensure that the Database and the Database-Listener is up and running. Additionally ensure that the EBS Middle-Tier OS Environment has been sourced and that the binary <i>sqlplus</i> is findable.''',
      p_success_msg            => 'For more information on National Language Support (NLS) or Multi-Language Support (MLS) and how to install it, please have a look into following documents:<br>
<ul>
<li>[1314621.1] - "Oracle E-Business Suite NLS Release Notes, Release 12.2"</li>
<li>[405992.1] - "Oracle Applications Release 12.2, 12.1 & Release 12.0 Translation Scope and Availability"</li>
<li>[393861.1] - "Globalization Guide for Oracle Applications Release 12"</li>
<li>[314411.1] - "Translation Scope for Oracle Applications Release 11i Software"</li>
</ul>',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_LANGUAGES_INSTALLED_DETAILS');



debug('begin add_signature: EBS_FIN_FC_FUNAGIS_PROD_LEVELS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24488',
      p_sig_id                 => 'EBS_FIN_FC_FUNAGIS_PROD_LEVELS',
      p_sig_sql                => 'SELECT Upper(abbreviation) Short_name,
name,
codelevel code_level
FROM AD_TRACKABLE_ENTITIES
WHERE abbreviation IN (''fnd'', ''fwk'',''bne'',  ''ad'', ''atg_pf'', ''xdo'', ''gl'', ''ofa'', ''fun'')
ORDER BY 1',
      p_title                  => 'Current Product Code Levels',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Product Code levels for ''FND'', ''FWK'',''BNE'', ''AD'', ''ATG_PF'', ''FUN'', and ''GL'' applications.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FC_FUNAGIS_PROD_LEVELS');



debug('begin add_signature: AGIS INVALIDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5395',
      p_sig_id                 => 'AGIS INVALIDS',
      p_sig_sql                => 'SELECT initcap(a.object_name) "Object Name",
initcap(decode(a.object_type,
''PACKAGE'', ''Package Specification'',
''PACKAGE BODY'', ''Package Body'',
a.object_type)) "Object Type",
(
...
And A.Owner = ''APPS''
And (A.Object_Name Like ''FUN%'')
AND a.status = ''INVALID''',
      p_title                  => 'FUN Related Invalid Objects',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'FUN Invalids Objects found',
      p_solution               => 'Please take action on FUN Invalids Objects. <br>
<ul>
...
<li>The invalid object(s) might not be the root cause to your problem(s) but it is suggested to review the list.</li>
</ul>',
      p_success_msg            => 'No FUN invalids objects detected.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AGIS INVALIDS');



debug('begin add_signature: AGIS_TABLESPACE_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5682',
      p_sig_id                 => 'AGIS_TABLESPACE_CHECK',
      p_sig_sql                => 'SELECT a.TABLESPACE_NAME "TableSpace Name",
to_char(ROUND(((A.BYTES-NVL(B.BYTES, 0))/A.BYTES)*100,2) )||''%''   "% Used",
to_char(round((1-((a.BYTES-nvl(b.BYTES,0))/a.BYTES))*100,2))||''%''   "% Free",
...
order by ((a.BYTES-b.BYTES)/a.BYTES) desc',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The objects listed above have 3% or less tablespace free.',
      p_solution               => '<ul> <li>Ask DBA to review items indicated and add additional data files to the tablespace as required</li></ul>',
      p_success_msg            => 'No Potential Tablespace Issues detected.',
   ...
   l_info.delete;
debug('end add_signature: AGIS_TABLESPACE_CHECK');



debug('begin add_signature: AGIS PRODUCT INSTALLATION INFORMATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5487',
      p_sig_id                 => 'AGIS PRODUCT INSTALLATION INFORMATION',
      p_sig_sql                => 'SELECT app.application_short_name product_name,
...
WHERE app.application_id = prod.application_id
 ...
 and prod.status not in (''I'',''S'')',
      p_title                  => 'FUN Product Installation',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'FUN Product is not in status ''Installed'' or ''Shared''.<br>
',
      p_solution               => 'If FUN Product status is NOT ''I'' (means ''Installed'') or ''S'' (means ''Shared''), please review and follow the instructions from below documents:<br>
[454668.1] AGIS - Initiator Transaction Status Changes to "Submitted" But The Recipient Cannot View Notification<br>
[371016.1] How To License A New Product<br>
[602491.1] How To Run "Synchronize Product License and Workflow BES License" (FNDWFLIC) Concurrent Program?',
      p_success_msg            => 'FUN Product is in status ''I'' (means ''Installed'') or ''S'' (means ''Shared'').<br>
For more details, please review and follow the instructions from below documents:<br>
[454668.1] AGIS - Initiator Transaction Status Changes to "Submitted" But The Recipient Cannot View Notification<br>
[371016.1] How To License A New Product<br>
[602491.1] How To Run "Synchronize Product License and Workflow BES License" (FNDWFLIC) Concurrent Program?',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: AGIS PRODUCT INSTALLATION INFORMATION');



debug('begin add_signature: AGIS PRODUCT INSTALLATION ISSUE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5814',
      p_sig_id                 => 'AGIS PRODUCT INSTALLATION ISSUE',
      p_sig_sql                => 'SELECT app.application_short_name product_name,
  DECODE(prod.status, ''I'', ''Installed'', ''S'', ''Shared'', ''Uninstalled'') status
FROM fnd_product_installations prod,
  fnd_application app
WHERE app.application_id = prod.application_id
 and App.Application_Short_Name = ''FUN''
 and nvl(prod.status,''N'') not in (''I'', ''S'')',
      p_title                  => 'FUN Product',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'FUN Product Installation Issue',
      p_solution               => '1.If status is NOT ''I'' (means ''Installed'') or ''S'' (means ''Shared''), then follow the instructions from [351453.1] (replace the Product code FPA with FUN).<br>
2.Execute the concurrent program, ''Synchronize Product License and Workflow BES License''.',
      p_success_msg            => 'FUN Product ''Installed''',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AGIS PRODUCT INSTALLATION ISSUE');



debug('begin add_signature: AGIS PRODUCT LICENSED DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5486',
      p_sig_id                 => 'AGIS PRODUCT LICENSED DETAILS',
      p_sig_sql                => 'SELECT we.name,
  wes.wf_process_type,
  wes.wf_process_name,
  wes.licensed_flag "LICENSED_FLAG"
FROM wf_events we,
  wf_event_subscriptions wes
WHERE we.guid = wes.event_filter_guid
 And Wes.Wf_Process_Type Like ''FUN%''',
      p_title                  => 'FUN Workflow Product Licenses',
      p_fail_condition         => '[LICENSED_FLAG]<>[Y]',
      p_problem_descr          => 'FUN Workflow Product Licenses with licensed_flag unset identified.',
      p_solution               => 'For AGIS workflow to work as expected, the value in the field licensed_flag must be ''Y''.<br>
Check Workflow Licenses and ensure that all processes have licensed_flag set to ''Y''.<br> 
If the value in the licensed_flag  is ''N'' but product installation status is ''I'' or ''S'', 
then need to submit the concurrent program ''Synchronize Product License and Workflow BES License''.<br>
This program synchronizes (sets/resets) the license flag on all Events/Subscriptions based on the product license settings.<br>
Useful documentation:<br> 
[454668.1] AGIS - Initiator Transaction Status Changes to "Submitted" But The Recipient Cannot View Notification<br>
[785167.1] Advanced Global Intercompany Troubleshooting AGIS Workflow Technical Brief.',
      p_success_msg            => 'For AGIS workflow to work as expected, the value in the field licensed_flag must be ''Y''.<br>
If the value in the licensed_flag  is ''N'' but product installation status is ''I'' or ''S'', 
then need to submit the concurrent program ''Synchronize Product License and Workflow BES License''.<br>
This program synchronizes (sets/resets) the license flag on all Events/Subscriptions based on the product license settings.<br>
Useful documentation:<br> 
...
[785167.1] Advanced Global Intercompany Troubleshooting AGIS Workflow Technical Brief.',
   ...
   l_info.delete;
debug('end add_signature: AGIS PRODUCT LICENSED DETAILS');



debug('begin add_signature: EBS_FIN_FC_FUNAGIS_PROFILES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23939',
      p_sig_id                 => 'EBS_FIN_FC_FUNAGIS_PROFILES',
      p_sig_sql                => 'SELECT
n.user_profile_option_name "NAME",
DECODE(v.level_id, 10001, ''Site'', 10002, ''Application'', 10003, ''Responsibility'', 10004, ''User'', 10005, ''Server'', ''UnDef'') "SCOPE",
v.profile_option_value "VALUE",
p.profile_option_name "CODE",
DECODE(TO_CHAR(v.level_id), ''10001'', '''', ''10002'', app.application_short_name, ''10003'', rsp.responsibility_key, ''10005'', svr.node_name
, ''10006'', org.name, ''10004'', (decode(LENgth(usr.user_name), 0, NULL,SUBSTR(usr.user_name,1,LENgth(usr.user_name)-3)) || ''***'' ), ''UnDef'') "CONTEXT",
n.language "LANGUAGE"
FROM
...
AND n.language = ''US''
ORDER BY 1, v.level_id, 5, 3',
      p_title                  => 'GL and FUN Profiles',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'FUN and a few core General Ledger (GL) Profiles that are set on this instance.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FC_FUNAGIS_PROFILES');



debug('begin add_signature: AGIS SYSTEM OPTION INFORMATION1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5672',
      p_sig_id                 => 'AGIS SYSTEM OPTION INFORMATION1',
      p_sig_sql                => 'SELECT s.default_currency Trx_currency_Code,
s.min_trx_amt,
s.min_trx_amt_currency,
g.user_conversion_type Exchange_Rate_Type_Meaning,
decode(s.allow_reject_flag,''Y'',''Yes'',''N'',''No'') Allow_Recipient_to_Reject_Trx,
decode(s.gl_batch_flag,''B'',''Batch'',''O'',''Online'')  Transfer_Trx_to_GL,
decode(s.apar_batch_flag,''B'',''Batch'',''O'',''Online'') Transfer_Trx_to_AP_and_AR,
decode(s.numbering_type,''MAN'',''Manual'', ''SYS'',''System Generated'') Intercompany_batch_numbering,
s.inteco_calendar,
s.inteco_period_type
--s.ALLOW_INTER_INTRA --not for all versions
FROM apps.fun_system_options s,
gl_daily_conversion_types g
WHERE s.exchg_rate_type = g.conversion_type
And S.System_Option_Id = 0',
      p_title                  => 'AGIS System Option Information',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Intercompany system options helps to manage intercompany transactions across the enterprise.<br>
Use the Intercompany System Options page to set enterprise level settings to govern the behavior of the Intercompany system and determine how transactions are processed.<br>
By defining these options at the enterprise level, this can minimize disputes, decrease processing time and cut administrative costs.<br>
For example, if the companies in an enterprise use the same currency for all transactions, it ensures that the transactions are posted in the same currency, which in turn, simplifies reconciliation.<br>
Note: Before setting up intercompany system options, you must decide how to process Intercompany transactions. You must decide whether to enforce an enterprise-wide currency or allow Intercompany transactions in local currencies, allow recipients to reject intercompany transactions, what minimum amount of transactions should be processed, and so forth.<br>
Changing system options does not affect transactions already in progress. It affects new transactions only.<br>
',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: AGIS SYSTEM OPTION INFORMATION1');



debug('begin add_signature: AGIS_FLEX_FIELD_INFORMATION');
   l_info('##MASK##FLEX_VALUE_SET_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5681',
      p_sig_id                 => 'AGIS_FLEX_FIELD_INFORMATION',
      p_sig_sql                => 'select Id_Flex_Num As Chart_Of_Accounts_Id,
       coa.ID_FLEX_CODE 	 Flex_code,
       coa.application_column_name,
       coa.segment_name,
       coa.segment_num,
       coa.enabled_flag,
       coa.required_flag,
       ...
       coa.default_type,
       coa.default_value,
       coa.flex_value_set_id,
       vs.flex_value_set_name,
       vs.validation_type,
       coa.security_enabled_flag,
       --coa.security_group_id,  
       coa.additional_where_clause
from fnd_id_flex_segments coa,
   Fnd_Flex_Value_Sets  Vs
where coa.id_flex_code in (''GL#'',''GLLE'')
and id_flex_num = (select chart_of_accounts_id from gl_ledgers where ledger_id = ##$$LEDGER_ID$$##)
And Coa.Flex_Value_Set_Id = Vs.Flex_Value_Set_Id
order by  coa.ID_FLEX_CODE,coa.application_column_name',
      p_title                  => 'Chart Of Accounts Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This identifies Chart Of Accounts Flex Field Information for Initiator Ledger.',
      p_solution               => '',
      p_success_msg            => 'This identifies Chart Of Accounts Flex Field Information for Initiator Ledger.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_FLEX_FIELD_INFORMATION');



debug('begin add_signature: AGIS_ALLOW_INTERCOMPANY_FLAG_FOR_LEDGER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5495',
      p_sig_id                 => 'AGIS_ALLOW_INTERCOMPANY_FLAG_FOR_LEDGER',
      p_sig_sql                => 'select ALLOW_INTERCOMPANY_POST_FLAG from gl_ledgers
where ledger_id = ##$$LEDGER_ID$$##
and ALLOW_INTERCOMPANY_POST_FLAG =''Y''',
      p_title                  => 'IntraCompany Balancing Flag',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Intracompany Balancing flag is not enabled.',
      p_solution               => 'The Intracompany Balancing Flag should be ''Y'' for the Ledger.<br>
To check this flag, please follow below steps: <br>
1. Responsibility: General Ledger<br>
2. Setup: Financials: Accounting Setup Manager: Accounting Setups<br>
3. Search for the ledger and click on Update Accounting Options icon.<br>
4. Click on Update icon for "Define and update the journal processing options for your ledger" of the primary ledger.<br>
5. Click "Next" or select "Ledger Options".<br>
6. Ensure that the "Enable Intracompany Balancing" flag is checked.<br>
For more details, see [813397.1]- How To Troubleshoot AGIS Accounting.',
      p_success_msg            => 'Intracompany Balancing flag is enabled.<br>

Journal entries must be balance by balancing segment values (total debit = total credit for each balancing segment value for a journal entry)<br>
If the balancing segment values in a journal entry belong to different legal entities, intercompany balancing rule is used to balance the journal.<br>
If the balancing segment values in a journal entry belong to one single legal entities, intracompany balancing rule is used.<br>
For more details, see [813397.1]- How To Troubleshoot AGIS Accounting.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_ALLOW_INTERCOMPANY_FLAG_FOR_LEDGER');



debug('begin add_signature: AGIS_BSV_OPTION_CODE_FOR_LEDGER');
   l_info('##MASK##ENTITY_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##LEDGER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5675',
      p_sig_id                 => 'AGIS_BSV_OPTION_CODE_FOR_LEDGER',
      p_sig_sql                => 'select 
ledger.name Ledger_name,
ledger.bal_seg_value_option_code ,
gl_seg.LEGAL_ENTITY_ID Entity_Id,
gl_seg.LEGAL_ENTITY_NAME Entity_Name,
gl_seg.segment_value,
gl_seg.start_date,
gl_seg.end_date

FROM gl_ledgers ledger,
apps.gl_ledger_le_bsv_specific_v gl_seg
WHERE ledger.ledger_id =gl_seg.ledger_id
AND gl_seg.ledger_id = ##$$LEDGER_ID$$##',
      p_title                  => 'Balancing Segment Value Option Code for the Ledger',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This identifies the balancing segment value option code for Initiator Ledger.<br>
The balancing segment value option code for a ledger can be either "A" (All) or "I" (Specific).<br>
Where "A" means there are no balancing segment values attached to the ledger or any of the legal entities attached to the ledger. <br>
And hence all the balancing segment values available in the chart of accounts attached to the ledger are valid.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_BSV_OPTION_CODE_FOR_LEDGER');



debug('begin add_signature: AGIS_INTERCOMPANY_BALANCING_RULES');
   l_info('##MASK##TRANSACTING_LEDGER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRANSACTING_LE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5494',
      p_sig_id                 => 'AGIS_INTERCOMPANY_BALANCING_RULES',
      p_sig_sql                => 'SELECT interaccteo.from_le_id transacting_legal_entity,
gll1.legal_entity_name transacting_le_name,
interaccteo.ledger_id transacting_ledger,
gll1.ledger_name transacting_ledger_name,
...
gl_ledger_le_v gll1
where gll1.legal_entity_id = interaccteo.from_le_id
AND gll1.ledger_category_code in (''PRIMARY'',''SECONDARY'')
AND interaccteo.ccid = glkfv.code_combination_id
and interaccteo.ledger_id=gll1.ledger_id
and gll1.ledger_id= ##$$LEDGER_ID$$##',
      p_title                  => 'InterCompany Balancing Rules',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no InterCompany Balancing Rules defined for the ledger.<br>
',
      p_solution               => 'Define the InterCompany rules, at least the generic rule All Other All Other.<br>
See the suggestions from [813397.1] - How To Troubleshoot AGIS Accounting.',
      p_success_msg            => 'This identifies InterCompany Balancing Rules defined for the ledger.<br>
Define the Intercompany rules, at least the generic rule All Other All Other.<br>
See the suggestions from [813397.1] - How To Troubleshoot AGIS Accounting.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_INTERCOMPANY_BALANCING_RULES');



debug('begin add_signature: AGIS_INTRACOMPANY_BALANCING_RULES');
   l_info('##MASK##LEGAL_ENTITY_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5492',
      p_sig_id                 => 'AGIS_INTRACOMPANY_BALANCING_RULES',
      p_sig_sql                => 'select fbo.ledger_id,fbo.le_id,
decode(xle.name,null,''No Legal Entity'',xle.name)Legal_Entity_name,fbo.je_source_name,
fbo.je_category_name,
decode(fbo.clearing_option, ''1D'', ''1D - Do not use'', ''2E'', ''2E - Enter Manually on All Journals'', ''3A'', ''3A- Use for All Journals'', ''4M'',  ''4M - Use for M-M Journals Only'', ''3M'', ''3M - Use for Many-to-Many Journals Only'', fbo.clearing_option) clearing_option,
fbo.clearing_bsv,
fbo.balance_by_flag,
fbo.status_flag,
decode(fbo.many_to_many_option, ''1D'', ''1D - Default Rule'', ''2D'', ''2D - Default Rule'',  ''2C'', ''2C - Use Clearing BSV'', ''2E'', ''2E - Manually Entered Clearing Balancing Segment Value'', ''3B'', ''3B - Use All Balancing Rules'', fbo.many_to_many_option) many_to_many_option,
fba.Dr_ccid,
fba.cr_ccid,
Glc.Concatenated_Segments Intercompany_Payables,
glc.GL_Control_account,
Glc2.Concatenated_Segments Intercompany_Receivables,
glc.gl_control_account
from fun_balance_options fbo,fun_balance_accounts fba , gl_ledgers gll, gl_code_combinations_kfv glc,gl_code_combinations_kfv glc2,
xle_entity_profiles Xle
where fbo.ledger_id=gll.ledger_id
and fba.dr_ccid=glc.code_combination_id
and fba.cr_ccid=glc2.code_combination_id
and fbo.template_id=fba.template_id
and fbo.status_flag=''Y''
and gll.ledger_id= ##$$LEDGER_ID$$##
and fbo.le_id=xle.legal_entity_id(+)',
      p_title                  => 'IntraCompany Balancing Rules for the Ledger',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no IntraCompany rules defined at the Initiator ledger level.<br>
',
      p_solution               => 'IntraCompany balancing rules are used to create balancing lines on journals between balancing
segment values either within the same legal entity, or where there is no legal entity context.<br>
Define the Intracompany rules, at least the generic rule All Other All Other.<br>
See the suggestions from [813397.1] - How To Troubleshoot AGIS Accounting.',
      p_success_msg            => 'This identifies the INTRACompany rules defined at the Initiator ledger level.<br>
...
See the suggestions from [813397.1] - How To Troubleshoot AGIS Accounting.',
   ...
   l_info.delete;
debug('end add_signature: AGIS_INTRACOMPANY_BALANCING_RULES');



debug('begin add_signature: AGIS_INTERCOMPANY_SEGMENT_AND_BALANCING_SEGMENTS');
   l_info('##MASK##LEDGER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5493',
      p_sig_id                 => 'AGIS_INTERCOMPANY_SEGMENT_AND_BALANCING_SEGMENTS',
      p_sig_sql                => 'select application_column_name Segment_name,
       segment_attribute_type Segment_type,
       attribute_value, 
       l.chart_of_accounts_id,
       l.name ledger_name      
from FND_SEGMENT_ATTRIBUTE_VALUES sav1,
     gl_ledgers l
WHERE sav1.application_id = 101
And Sav1.Id_Flex_Code = ''GL#''
and SAV1.ID_FLEX_NUM = l.chart_of_accounts_id 
and l.ledger_id =##$$LEDGER_ID$$##
and sav1.attribute_value = ''Y''
and SAV1.SEGMENT_ATTRIBUTE_TYPE != ''GL_GLOBAL''
Order By Application_Column_Name',
      p_title                  => 'InterCompany Segment and Balancing Segments in the Accounting Flexfield',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no InterCompany segment and Balancing segments defined in the Accounting Flexfield.<br>',
      p_solution               => 'InterCompany segment is a qualifier in the Chart of Accounts Segment setup. It helps to track the InterCompany transaction and provide better audit and control.<br>
Useful documentation:<br>
[975235.1] - General Ledger FAQ for AGIS (Advanced Global Intercompany Systems)<br>
[100326.1] - What is the Intercompany Segment Flexfield Qualifier in 11i and 12? Is it Backported?<br>',
      p_success_msg            => 'This identifies the INTERCompany segment and Balancing segments in the Accounting Flexfield.<br>
INTERCompany segment is a qualifier in the Chart of Accounts Segment setup. It helps to track the intercompany transaction and provide better audit and control.<br>
Useful documentation:<br>
[975235.1] - General Ledger FAQ for AGIS (Advanced Global Intercompany Systems)<br>
[100326.1] - What is the Intercompany Segment Flexfield Qualifier in 11i and 12? Is it Backported?<br>',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_INTERCOMPANY_SEGMENT_AND_BALANCING_SEGMENTS');



debug('begin add_signature: AGIS RECEIVABLES ASSIGNMENT DETAILS');
   l_info('##MASK##AR_CM_TRX_TYPE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##AR_TRX_TYPE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##MEMO_LINE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##ORG_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRX_TYPE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5514',
      p_sig_id                 => 'AGIS RECEIVABLES ASSIGNMENT DETAILS',
      p_sig_sql                => 'SELECT DISTINCT tm.trx_type_id,
  tm.org_id,
  tm.trx_type_map_id,
  hr.name org_name,
  tm.ar_trx_type_id,
  tm.ar_cm_trx_type_id,
  tm.memo_line_id,
  tt.trx_type_name,
  ar.name ar_trx_type_name,
  DECODE(tm.ar_cm_trx_type_id, NULL, NULL, arcm.name) ar_cm_trx_type_name,
  memot.name memo_line_name,
  memob.SET_OF_BOOKS_ID
FROM fun_trx_type_ar_maps tm,
  --FUN_TRX_TYPES_VL tt,
  fun_trx_types_tl tt,
  FUN_TRX_TYPES_B B,
  RA_CUST_TRX_TYPES_ALL ar,
  ra_cust_trx_types_all arcm,
  --ar_memo_lines_all_vl m--,
  ar_memo_lines_all_tl memot,
  ar_memo_lines_all_b memob,
  --HR_OPERATING_UNITS hr
  hr_all_organization_units hr
WHERE tm.trx_type_id                             = tt.trx_type_id
AND tm.ar_trx_type_id                            = ar.cust_trx_type_id
AND b.trx_type_id                                = tt.trx_type_id
AND tt.language                                  =''US''
AND NVL(tm.ar_cm_trx_type_id, tm.ar_trx_type_id) = arcm.cust_trx_type_id
AND memob.memo_line_id                           = memot.memo_line_id
AND memob.org_id                                 = memot.org_id
AND tm.memo_line_id                              = memob.memo_line_id
AND tm.org_id                                    = hr.organization_id
AND ar.org_id                                    =memob.org_id
AND arcm.org_id                                  =memob.org_id
AND memob.org_id                                 =hr.organization_id
AND memob.set_of_books_id                        =##$$LEDGER_ID$$##',
      p_title                  => 'Receivables Assignments',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This identifies Receivables Assignments defined.<br>
The Receivables Assignments and Customer and Supplier Associations subtabs are prerequisites of intercompany invoicing options.',
      p_solution               => 'If an invoice is required for intercompany transactions, you must associate intercompany organizations with operating units and then assign the intercompany transaction types with Receivables transaction types for each operating unit.<br>
Use the Receivables Assignments page to search for operating units and update or create assignments for operating units.<br>
See [1065260.1] R12: What Is The Setup Needed To Send AGIS Transactions To AP-AR Or Directly To GL',
      p_success_msg            => 'This identifies Receivables Assignments defined.<br>
The Receivables Assignments and Customer and Supplier Associations subtabs are prerequisites of intercompany invoicing options.<br>
If an invoice is required for intercompany transactions, you must associate intercompany organizations with operating units and then assign the intercompany transaction types with Receivables transaction types for each operating unit.<br>
Use the Receivables Assignments page to search for operating units and update or create assignments for operating units.<br>
See [1065260.1] R12: What Is The Setup Needed To Send AGIS Transactions To AP-AR Or Directly To GL',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: AGIS RECEIVABLES ASSIGNMENT DETAILS');



debug('begin add_signature: AGIS_BSV_ASSIGNMENTS_AT_LEGAL_ENTITY_LEVEL');
   l_info('##MASK##NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5496',
      p_sig_id                 => 'AGIS_BSV_ASSIGNMENTS_AT_LEGAL_ENTITY_LEVEL',
      p_sig_sql                => 'select xep.name,glle.legal_entity_id,
glle.flex_value_set_id,
glle.flex_segment_value BSV_Segment_Value,
glle.start_date,
glle.end_date
from gl_legal_entities_bsvs glle ,xle_entity_profiles xep
    where glle.legal_entity_id in(
    select object_id from gl_ledger_config_details where configuration_id in (select configuration_id from gl_ledgers where ledger_id=##$$LEDGER_ID$$##)
        and object_type_code = ''LEGAL_ENTITY''
        and glle.legal_entity_id=xep.legal_entity_id)',
      p_title                  => 'BSV Assignments at Legal Entity level',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This identifies the BSV  (balancing segment values) assigned at Legal Entity level.',
      p_solution               => 'It is not mandatory to assign BSVs to Legal Entities (LE) but for some specific cases it will not work otherwise.<br>
Assign the Balancing Segment Values to the Legal Entity.<br>
OR<br>
Define the Intracompany rules under the ''No Legal Entity Context''.<br>
Useful documentation: <br>
[2075694.1] - AGIS: Is BSV Assignment to Legal Entities Mandatory in Order to Use AGIS?',
      p_success_msg            => 'This identifies the BSV  (balancing segment values) assigned at Legal Entity level.<br> 
The list of values displays all the balancing segment values in the transacting ledger to which the transacting legal entity is mapped.
Useful documentation: <br>
[2075694.1] - AGIS: Is BSV Assignment to Legal Entities Mandatory in Order to Use AGIS?',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_BSV_ASSIGNMENTS_AT_LEGAL_ENTITY_LEVEL');



debug('begin add_signature: AGIS_BSV_ASSIGNMENTS_AT_LEDGER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5497',
      p_sig_id                 => 'AGIS_BSV_ASSIGNMENTS_AT_LEDGER',
      p_sig_sql                => 'select distinct a.* from gl_ledger_norm_seg_vals a, gl_ledger_relationships b,
gl_ledger_config_details c,gl_ledgers d
where a.ledger_id=c.object_id 
and c.object_type_code <> ''LEGAL_ENTITY''
and c.configuration_id=d.configuration_id
and b.source_ledger_id=d.ledger_id
and b.relationship_type_code<>''ADJUST''
and a.legal_entity_id is  NULL
and a.ledger_id=b.target_ledger_id
and d.ledger_id= ##$$LEDGER_ID$$##',
      p_title                  => 'BSV Assignments at Ledger',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This identifies BSV (Balancing Segment Values) assignments at Ledger level.',
      p_solution               => 'Defining Intracompany rules for the Legal Entity or "No Legal Entity Context".<br>

Navigation<br>
1. Responsibility: General Ledger responsibility.<br>
2. Setup: Financials: Accounting Setup Manager: Accounting Setups<br>
3. If the LE-BSV association is as expected, the Intracompany rules must be defined for the legal entity for the appropriate Source and Category.<br>
4. If the user does not want to assign the BSV to a legal entity below steps must be performed for "No Legal Entity".<br>
5. Click on the update icon for Intracompany Balancing Rule.<br>
6. Click on define rules icon for the appropriate legal entity/No Legal entity Context.<br>
7. Check that a rule with correct source and category exists.<br>
8. If a rule does not exist please create one with appropriate source and category.<br>
9. It is always advised to have a default rule with Source "Other" and Category "Other".<br>
10. If a rule already exists, click on the update icon for the rule.<br>
11. Make sure the rule has a "Enabled" status, and a intracompany rule with Debit BSV "All Other" and credit BSV "All Other" must be defined.<br>',
      p_success_msg            => 'This identifies BSV (Balancing Segment Values) assignments at Ledger level.<br>
Each row specifies a balancing segment value, the ledger it is assigned to, the start and end date of the assignment, and the legal entity, if any, that it is assigned to.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_BSV_ASSIGNMENTS_AT_LEDGER');



debug('begin add_signature: AGIS_SECUIRTY RULES FOR GL AND AGIS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5718',
      p_sig_id                 => 'AGIS_SECUIRTY RULES FOR GL AND AGIS',
 ...
 WHERE fvru.responsibility_id = frt.responsibility_id					
   ...
   AND led.Ledger_id = ##$$LEDGER_ID$$##				
   AND ifs.id_flex_code = ''GL#''					
   AND frt.application_id in (435, 101)				
 ORDER BY ifs.segment_num,					
       fvr.flex_value_rule_name,					
       fvrl.include_exclude_indicator Desc',
      p_title                  => 'Security Rules',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This identifies security rules defined for the accounting flexfield segments, for AGIS and GL responsibilities.<br>
For more details, please review:<br>
[1488115.1] AGIS: How To Restrict Access To Balancing Segment Values (BSV)<br>
[790698.1] Is It Possible to Assign Security Rules for AGIS Intercompany Super User Responsibility.',
      p_solution               => '',
      p_success_msg            => 'This identifies security rules defined for the accounting flexfield segments, for AGIS and GL responsibilities.<br>
For more details, please review:<br>
[1488115.1] AGIS: How To Restrict Access To Balancing Segment Values (BSV)<br>
[790698.1] Is It Possible to Assign Security Rules for AGIS Intercompany Super User Responsibility.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_SECUIRTY RULES FOR GL AND AGIS');



debug('begin add_signature: AGIS_SUPPLIER_ASSOCIATION_DETAILS_FOR_THE_LEDGER');
   l_info('##MASK##TP_LEDGER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRADING_IC_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRADING_LE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRADING_OU_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRANSACTION_IC_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRANSACTION_LE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRANSACTION_OU_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##VENDOR_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##VENDOR_SITE_CODE'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5513',
      p_sig_id                 => 'AGIS_SUPPLIER_ASSOCIATION_DETAILS_FOR_THE_LEDGER',
      p_sig_sql                => 'SELECT rt.relation_id,
  ...
  sm.vendor_id,
  vo.vendor_name,
  vo.start_date_active supplier_start_date_active, 
  vo.end_date_active supplier_end_date_active,
  sm.vendor_site_id,
  vos.vendor_site_code,
  vos.end_date_active supp_site_end_date_active,
   vos.inactive_date supp_site_inactive_date_active 
...
and Trl.Ledger_Category_Code        =''PRIMARY''
and tpl.ledger_category_code        =''PRIMARY''
...
and trl.ledger_id       = ##$$LEDGER_ID$$##',
      p_title                  => 'AGIS Supplier Association Details for the Ledger',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This identifies Supplier associations details for the Initiator Ledger.<br>
To create invoices in Payables, suppliers must be set up and associated to the transacting organizations.<br>
When a legal entity is represented in another legal entity as a supplier, the represented legal entity has a supplier association.<br>
Refer [1639537.1] How to Create an AGIS Customer Supplier Association.
<br>  [2879705.1] Error: "The Intercompany Transaction requires Invoice and a Supplier Association does not exist between the Recipient Organization and Initiator Organization" When Approving Intercompany Transaction',
      p_solution               => '',
      p_success_msg            => 'This identifies Supplier associations details for the Initiator Ledger.<br>
To create invoices in Payables, suppliers must be set up and associated to the transacting organizations.<br>
When a legal entity is represented in another legal entity as a supplier, the represented legal entity has a supplier association.<br>
See [1639537.1] How to Create an AGIS Customer Supplier Association.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_SUPPLIER_ASSOCIATION_DETAILS_FOR_THE_LEDGER');



debug('begin add_signature: AGIS CUSTOMER ASSOCIATION DETAILS FOR THE LEDGER');
   ...
   l_info('##MASK##TP_LEDGER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRADING_IC_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRADING_LE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRADING_OU_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRANSACTION_IC_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
  ...
  add_signature(
      p_sig_repo_id            => '5512',
      p_sig_id                 => 'AGIS CUSTOMER ASSOCIATION DETAILS FOR THE LEDGER',
      p_sig_sql                => 'select rt.relation_id,
  trl.ledger_name,
  rt.transaction_le_id,
...
and ou1.organization_id = rt.tp_org_id
and trl.ledger_id=##$$LEDGER_ID$$##',
      p_title                  => 'AGIS Customer Association Details for the Ledger',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This identifies Customer associations details for the Initiator Ledger.<br>
To create invoices in Receivables, customers must be set up and associated to the transacting organizations.<br>
When a legal entity is represented in another legal entity as a customer, the represented legal entity has a customer association.<br>
See [1639537.1] How to Create an AGIS Customer Supplier Association.',
      p_solution               => '',
      p_success_msg            => 'This identifies Customer associations details for the Initiator Ledger.<br>
To create invoices in Receivables, customers must be set up and associated to the transacting organizations.<br>
When a legal entity is represented in another legal entity as a customer, the represented legal entity has a customer association.<br>
See [1639537.1] How to Create an AGIS Customer Supplier Association.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: AGIS CUSTOMER ASSOCIATION DETAILS FOR THE LEDGER');



debug('begin add_signature: XLA_SEG_RULE_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13149',
      p_sig_id                 => 'XLA_SEG_RULE_DETAILS',
      p_sig_sql                => 'SELECT
     xsr.segment_rule_code,
     xsr.user_sequence   priority,
     xla_conditions_pkg.display_condition(xsr.application_id,''DEFAULT'',NULL,NULL,NULL,NULL,xc.segment_rule_detail_id,NULL,NULL,''S''
     ) adr_condition,
     xsr.application_id,
     ...
     xsr.last_updated_by
 FROM
     xla_tab_acct_defs_vl tabacctdefeo,
     fun_trx_acct_definitions tad,
     XLA_TAB_ACCT_DEF_DETAILS tadd,
     xla_seg_rule_details xsr,
     xla_conditions xc
 WHERE
      tad.account_definition_code = tabacctdefeo.account_definition_code
     AND tadd.APPLICATION_ID = tabacctdefeo.APPLICATION_ID
     AND tadd.AMB_CONTEXT_CODE = tabacctdefeo.AMB_CONTEXT_CODE
     AND tadd.ACCOUNT_DEFINITION_TYPE_CODE = tabacctdefeo.ACCOUNT_DEFINITION_TYPE_CODE
     AND tadd.ACCOUNT_DEFINITION_CODE = tabacctdefeo.ACCOUNT_DEFINITION_CODE
     AND xsr.segment_rule_code = tadd.SEGMENT_RULE_CODE
     AND xsr.segment_rule_detail_id = xc.segment_rule_detail_id
     AND tadd.application_id = xsr.application_id
     AND tadd.amb_context_code = xsr.amb_context_code
     AND tadd.segment_rule_type_code = xsr.segment_rule_type_code
     AND tad.ledger_id = ##$$LEDGER_ID$$##',
      p_title                  => 'Account Derivation Rule Details with Conditions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Account Derivation Rule Details',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: XLA_SEG_RULE_DETAILS');



debug('begin add_signature: FUN_TRX_ACCT_DEFINITIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13146',
      p_sig_id                 => 'FUN_TRX_ACCT_DEFINITIONS',
      p_sig_sql                => 'SELECT
     tabacctdefeo.name        account_definition_name,
     tabacctdefeo.account_definition_code,
     tabacctdefeo.description,
     tabacctdefeo.account_definition_type_code,
     tabacctdefeo.amb_context_code,
     id_flex_structure_name   chart_of_accounts_name,
     tabacctdefeo.chart_of_accounts_id,
     l4.meaning               owner,
     l1.meaning               compile_status_code_dsp,
     tabacctdefeo.compile_status_code,
     l2.meaning               locking_status_flag_dsp,
     tabacctdefeo.locking_status_flag,
     l3.meaning               enabled_flag_dsp,
     tabacctdefeo.enabled_flag,
     ''UpdateEnabled'' AS update_switcher,
     ''DeleteEnabled'' AS delete_switcher,
     ''DuplicateEnabled'' AS duplicate_switcher,
     ''N'' selector,
     tabacctdefeo.request_id,
     tabacctdefeo.application_id,
     tabacctdefeo.creation_date,
     tabacctdefeo.created_by,
     tabacctdefeo.last_update_date,
     tabacctdefeo.last_updated_by,
     tabacctdefeo.last_update_login,
     fnd_profile.value(''XLA_SETUP_USER_MODE'') profile_value
 FROM
     xla_tab_acct_defs_vl tabacctdefeo,
     xla_lookups l1,
     xla_lookups l2,
     xla_lookups l3,
     xla_lookups l4,
     fnd_id_flex_structures_v f,
     fun_trx_acct_definitions tad
 WHERE
     tabacctdefeo.compile_status_code = l1.lookup_code
     AND l1.lookup_type = ''XLA_COMPILE_STATUS_TYPE''
     AND tabacctdefeo.locking_status_flag = l2.lookup_code
     AND l2.lookup_type = ''XLA_YES_NO''
     AND tabacctdefeo.enabled_flag = l3.lookup_code
     AND l3.lookup_type = ''XLA_YES_NO''
     AND tabacctdefeo.account_definition_type_code = l4.lookup_code
     AND l4.lookup_type = ''XLA_OWNER_TYPE''
     AND tabacctdefeo.chart_of_accounts_id = f.id_flex_num (+)
     AND f.id_flex_code (+) = ''GL#''
     AND f.application_id (+) = 101
     AND tad.account_definition_code = tabacctdefeo.account_definition_code
     AND tad.ledger_id = ##$$LEDGER_ID$$##',
      p_title                  => 'Transaction Account Definition',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Transaction Account Definition',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: FUN_TRX_ACCT_DEFINITIONS');



debug('begin add_signature: XLA_TAB_ACCT_DEF_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13147',
      p_sig_id                 => 'XLA_TAB_ACCT_DEF_DETAILS',
      p_sig_sql                => 'SELECT
tadd.*,
     tabacctdefeo.description,
     id_flex_structure_name   chart_of_accounts_name,
 ...
 FROM
     ...
     XLA_TAB_ACCT_DEF_DETAILS tadd
 WHERE
      tabacctdefeo.account_definition_type_code = l4.lookup_code
     AND l4.lookup_type = ''XLA_OWNER_TYPE''
     AND tabacctdefeo.chart_of_accounts_id = f.id_flex_num (+)
     AND f.id_flex_code (+) = ''GL#''
     AND f.application_id (+) = 101
     ...
     AND tadd.ACCOUNT_DEFINITION_CODE = tabacctdefeo.ACCOUNT_DEFINITION_CODE
     AND tad.ledger_id = ##$$LEDGER_ID$$##',
      p_title                  => 'Account Derivation Rule Assignments',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Account Derivation Rule Assignments',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: XLA_TAB_ACCT_DEF_DETAILS');



debug('begin add_signature: FUN_DIST_LINES.PARTY_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13093',
      p_sig_id                 => 'FUN_DIST_LINES.PARTY_ID',
      p_sig_sql                => 'SELECT d.dist_id, d.party_id, h.recipient_id, d.party_type_flag
  FROM fun_dist_lines d, fun_trx_headers h
 WHERE h.trx_id = d.trx_id
   AND d.party_type_flag = ''R''
   AND d.party_id <> h.recipient_id
union all
SELECT d.dist_id, d.party_id, h.recipient_id, d.party_type_flag
  FROM fun_dist_lines d, fun_trx_headers h
 WHERE h.trx_id = d.trx_id
   AND d.party_type_flag = ''I''
   AND d.party_id <> h.initiator_id',
      p_title                  => 'INCORRECT FUN_DIST_LINES.PARTY_ID',
      p_fail_condition         => 'RS',
      p_problem_descr          => '1. When FUN_DIST_LINES.PARTY_TYPE_FLAG column is ''R''
FUN_DIST_LINES.PARTY_ID：Recipient party identifier, that also is FUN_TRX_HEADERS.RECIPIENT_ID.
2. When FUN_DIST_LINES.PARTY_TYPE_FLAG column is ''I''：
FUN_DIST_LINES.PARTY_ID：Initiator party identifier，that also is FUN_TRX_HEADERS.INITIATOR_ID.',
      p_solution               => 'Log a SR to Oracle Support for datafix.
Use the note below:
[2567891.1]R12: What Is the Meaning of PARTY_ID Column in the FUN_DIST_LINES Table',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: FUN_DIST_LINES.PARTY_ID');



debug('begin add_signature: AGIS_LEGAL_ENTITY_NAME_CHANGES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22027',
      p_sig_id                 => 'AGIS_LEGAL_ENTITY_NAME_CHANGES',
      p_sig_sql                => 'select gl.configuration_id, gl.status_code, gl.object_ID, gl.object_name "ASM_LE_NAME", le.Name "LE_CURRENT_NAME"
from gl_ledger_config_Details gl, XLE_ENTITY_PROFILES le
where gl.object_ID = le.Legal_entity_ID
and gl.OBJECT_TYPE_CODE = ''LEGAL_ENTITY''
and gl.object_name <> le.Name',
      p_title                  => 'Legal Entity Name Changes',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Legal Entity name change not reflected in AGIS Intracompany/Intercompany Balancing Rules.<br>
',
      p_solution               => 'Refer [1356214.1] - Legal Entity Name Change Not Reflected in AGIS Intracompany/Intercompany Balancing Rules.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_LEGAL_ENTITY_NAME_CHANGES');



debug('begin add_signature: DC_CALENDAR_DEFINITION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6939',
      p_sig_id                 => 'DC_CALENDAR_DEFINITION',
      p_sig_sql                => 'SELECT
gll.ledger_id "Ledger ID",
gll.name "Ledger Name",
period_set_name "Calendar",
gll.accounted_period_type "Period Type ID",
future_enterable_periods_limit "No. of Future Enterable period",
latest_opened_period_name "Latest Open Period",
number_per_fiscal_year "Periods in Fiscal Year",
user_period_type "Period Type Name"
FROM
gl_ledgers gll, gl_period_types
WHERE
gll.ledger_id = ##$$LEDGID$$##
and gll.accounted_period_type = period_type',
      p_title                  => 'Calendar Setup',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This provides the Calendar definition.',
      p_solution               => '',
      p_success_msg            => 'This provides the Calendar definition.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: DC_CALENDAR_DEFINITION');



debug('begin add_signature: EBS_FIN_FC_FUNAGIS_CAL_PER_SETUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24456',
      p_sig_id                 => 'EBS_FIN_FC_FUNAGIS_CAL_PER_SETUP',
      p_sig_sql                => 'SELECT gp.period_set_name,
       gp.description,
       gp.period_name,
       gp.start_date,
       gp.end_date,
...
where gll.ledger_id = ##$$LEDGID$$##
AND gp.period_set_name = gll.period_set_name
        AND gp.period_year >= (to_char(sysdate, ''YYYY'') - 1 )',
      p_title                  => 'Calendar Period Setup',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This provides the calendar period setup of the calendar.',
      p_solution               => 'There are no calendar periods setup of the calendar.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FC_FUNAGIS_CAL_PER_SETUP');



debug('begin add_signature: EBS_FIN_FC_FUNAGIS_GL_PERIOD_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24457',
      p_sig_id                 => 'EBS_FIN_FC_FUNAGIS_GL_PERIOD_STATUS',
      p_sig_sql                => 'SELECT ps.application_id,
 ps.ledger_id,
 ps.period_name,
 ps.closing_status,
 ps.start_date,
...
WHERE ps.ledger_id = led.ledger_id+0
AND led.ledger_id = ##$$LEDGID$$##
AND period_year >= to_char(sysdate, ''YYYY'') - 1
AND period_year <= to_char(sysdate, ''YYYY'') + 1
order by ps.application_id, ps.period_year, ps.start_date',
      p_title                  => 'General Ledger and Subledger Period Statuses',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This provides the period status in General Ledger as well as in subledger applications for the selected Ledger.',
      p_solution               => '',
      p_success_msg            => 'This provides the period status in General Ledger as well as in subledger applications for the selected Ledger.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FC_FUNAGIS_GL_PERIOD_STATUS');



debug('begin add_signature: DC_ALL_LEDGERS_OF_CALENDAR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6073',
      p_sig_id                 => 'DC_ALL_LEDGERS_OF_CALENDAR',
      p_sig_sql                => 'SELECT led.*
       FROM gl_ledgers led
       WHERE led.period_set_name = ''##$$CALNAME$$##''',
      p_title                  => 'All Ledgers that use the Calendar',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This provides the details of all ledgers which use the calendar in question.',
      p_solution               => 'This provides the details of all ledgers which use the calendar in question.',
      p_success_msg            => 'This provides the details of all ledgers which use the calendar in question.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: DC_ALL_LEDGERS_OF_CALENDAR');



debug('begin add_signature: DC_GL_PERIODS_INFO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6074',
      p_sig_id                 => 'DC_GL_PERIODS_INFO',
      p_sig_sql                => 'SELECT
period_name,
period_num,
quarter_num,
...
gl_periods
WHERE
period_year between ''2018'' and ''2033''
and period_set_name = ''##$$CALNAME$$##''
ORDER BY
period_type,
period_year,
period_num',
      p_title                  => 'GL_Periods Information for Year 2018 to 2033',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This provides GL_Periods Table Information for the Year 2018 to 2033.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: DC_GL_PERIODS_INFO');



debug('begin add_signature: DC_GL_PERIOD_STATUSES_INFO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '6075',
      p_sig_id                 => 'DC_GL_PERIOD_STATUSES_INFO',
      p_sig_sql                => 'SELECT
application_id,
period_name,
period_num,
...
WHERE
period_year between ''2018'' and ''2033''
and set_of_books_id = ##$$LEDGID$$##
ORDER BY
application_id,
period_type,
period_year,
period_num',
      p_title                  => 'GL_PERIOD_STATUSES Table Info For Years 2018 to 2033',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This provides the GL_PERIOD_STATUSES Table info for Years 2018 to 2033',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: DC_GL_PERIOD_STATUSES_INFO');



debug('begin add_signature: LEDGER_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2416',
      p_sig_id                 => 'LEDGER_DETAILS',
      p_sig_sql                => 'select 
 gll.ledger_id "Ledger ID",
 gll.name "Ledger Name",
 gll.short_name "Ledger Short Name",
 gll.description "Description",
 gll.ledger_category_code "Ledger Category Code",
 gll.configuration_id "Primary Configuration ID" ,
 gll.chart_of_accounts_id "COA ID",
 gll.currency_code "Currency",
 gll.Period_set_name "Calendar",
 gll.accounted_period_type "Period Type",
 gll.first_ledger_period_name "First Ever Period",
 gcc.concatenated_segments||'' (''|| gll.ret_earn_code_combination_id||'')'' "Primary RE Account/CCID",
 gll.suspense_allowed_flag "Suspense Flag",
 gll.allow_intercompany_post_flag "Intercompany Flag",
 gll.Track_rounding_imbalance_flag "Track Rounding Imbalance Flag",
 gll.ENABLE_AVERAGE_BALANCES_FLAG "Average Balances Flag",
 gll.bal_seg_value_option_code,
 decode(cumgcc.concatenated_segments, Null, Null,cumgcc.concatenated_segments||'' (''||  gll.CUM_TRANS_CODE_COMBINATION_ID||'')'') "Primary CTA Account/CCID",
 gll.criteria_set_id "Journal Reversal Set ID",
 glac.CRITERIA_SET_NAME "Journal Reversal Set Name",
 decode(resgcc.concatenated_segments, null, null,resgcc.concatenated_segments||'' (''||  gll.res_encumb_code_combination_id||'')'') "Promary RFE Account/CCID",
 decode(netgcc.concatenated_segments, null, null,netgcc.concatenated_segments||'' (''||  gll.Net_income_code_combination_id||'')'') "Primary Net Income Acct/CCID",
 decode(rndgcc.concatenated_segments, null, null,rndgcc.concatenated_segments||'' (''||  gll.rounding_code_combination_id||'')'') "Primary Rounding Acct/CCID",
 gll.Enable_budgetary_control_flag "Enable Budgetary Flag",
 gll.require_budget_journals_flag "Require Budget Journlas Flag",
 gll.enable_je_approval_flag "Journal Approval Flag",
 gll.enable_automatic_tax_flag "Enable Automatic Tax",
 gll.consolidation_ledger_flag "Consolidation Ledger Flag",
 gll.translate_EOD_FLAG "Avg EOD Flag",
 gll.translate_qatd_flag "Avg QTD Flag",
 gll.translate_yatd_flag "Avg YTD Flag",
 gll.transaction_calendar_id "Avg Transaction Cal ID",
 gll.daily_translation_rate_type "Avg Daily Rate Type",
 gll.bal_seg_column_name "Balance Segment Column",
 gll.bal_seg_value_set_id "Balance Segment Valiue Set ID",
 gll.future_enterable_periods_limit "Future Enterable Periods Limit",
 gll.latest_opened_period_name "Latest Open Period Name",
 gll.latest_encumbrance_year "Latest Encumbrance Year",
 gll.period_average_rate_type "Period Average Rate Type",
 gldt1.user_conversion_type "User Conversion Type",
 gll.period_end_rate_type "Period End Rate Type",
 gldt2.user_conversion_type "EOD Conversion Name",
 gll.budget_period_avg_rate_type "Budget Period Avg Rate Type",
 gldt3.user_conversion_type "Budget Avg Conversion Name",
 gll.budget_period_end_rate_type "Budget Period End Rate Type",
 gldt4.user_conversion_type "Budget EOD Conversion Name",
 gll.sla_accounting_method_code "SLA Name",
 gll.sla_accounting_method_code "SLA Code",
 decode(curgcc.concatenated_segments, null, null,curgcc.concatenated_segments||'' (''||  gll.sla_entered_cur_bal_sus_ccid||'')'') Primary_Entered_curr_bal_ccid,
 gll.sla_bal_by_ledger_curr_flag "SLA Bal by Ledger Currency",
 gll.enable_secondary_track_flag "Enable Secondary Track Flag",
 gll.enable_reval_ss_track_flag "Enable Reval SS Track Flag",
 gll.enable_reconciliation_flag "Enable Reconciliation Flag"
 from gl_ledgers gll , GL_AUTOREV_CRITERIA_SETS glac,gl_daily_conversion_types gldt1
 ,gl_daily_conversion_types gldt2,gl_daily_conversion_types gldt3,gl_daily_conversion_types gldt4, gl_code_combinations_kfv gcc,
 gl_code_combinations_kfv cumgcc,  gl_code_combinations_kfv resgcc, gl_code_combinations_kfv netgcc, gl_code_combinations_kfv rndgcc,
 gl_code_combinations_kfv curgcc
 where gll.ledger_id= ##$$LEDGID$$##
 and gll.ret_earn_code_combination_id = gcc.code_combination_id(+)
 and gll.CUM_TRANS_CODE_COMBINATION_ID = cumgcc.code_combination_id(+)
 and gll.res_encumb_code_combination_id = resgcc.code_combination_id(+)
 and gll.Net_income_code_combination_id = netgcc.code_combination_id(+)
 and gll.rounding_code_combination_id = rndgcc.code_combination_id(+)
  and gll.sla_entered_cur_bal_sus_ccid  = curgcc.code_combination_id(+)
 and gll.criteria_set_id=glac.CRITERIA_SET_ID(+)
 and gldt1.conversion_type(+)=gll.period_average_rate_type
 and gldt2.conversion_type(+)=gll.period_end_rate_type
 and gldt3.conversion_type(+)=gll.budget_period_avg_rate_type
 and gldt4.conversion_type(+)=gll.budget_period_end_rate_type',
      p_title                  => 'Ledger Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This provides the Ledger details of the selected Ledger.',
      p_solution               => 'Not a Valid Ledger',
      p_success_msg            => 'This provides the Ledger details of the selected Ledger.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LEDGER_DETAILS');



debug('begin add_signature: LEDGER_ASSO_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2417',
      p_sig_id                 => 'LEDGER_ASSO_DETAILS',
      p_sig_sql                => 'select * from gl_ledgers a 
where a.configuration_id in (select configuration_id from gl_ledgers b where b.ledger_id=##$$LEDGID$$##)order by ledger_id',
      p_title                  => 'Primary Ledger And All Its Associated Ledgers',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This provides Primary Ledger and all its associated ledgers.',
      p_solution               => '',
      p_success_msg            => 'This provides Primary Ledger and all its associated ledgers.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LEDGER_ASSO_DETAILS');



debug('begin add_signature: LEDGER_CONFIGURATIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2418',
      p_sig_id                 => 'LEDGER_CONFIGURATIONS',
      p_sig_sql                => 'select * from GL_LEDGER_CONFIGURATIONS
where configuration_id in (select configuration_id from gl_ledgers where ledger_id=##$$LEDGID$$##)',
      p_title                  => 'GL Ledger Configurations Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This provides GL Ledger Configurations Information.',
      p_solution               => '',
      p_success_msg            => 'This provides GL Ledger Configurations Information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: LEDGER_CONFIGURATIONS');



debug('begin add_signature: JOURNAL_CONVERSION_RULES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2419',
      p_sig_id                 => 'JOURNAL_CONVERSION_RULES',
      p_sig_sql                => 'select 
     gllrs.target_ledger_name,
     glir.je_rule_set_id,glir.je_source_name,
     glir.je_category_name,
     glir.user_updatable_flag USER_UPDATABLE_FLAG,
     glir.include_flag INCLUDE_FLAG
          from gl_je_inclusion_rules glir,gl_ledger_relationships gllrs
     where gllrs.source_ledger_id=##$$LEDGID$$##
    and relationship_enabled_flag=''Y''
    and relationship_type_code <> ''NONE''
    and gllrs.gl_je_conversion_set_id=glir.je_rule_set_id',
      p_title                  => 'Journal Conversion Rules',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This provides the Journal Conversion Rules.',
      p_solution               => '',
      p_success_msg            => 'This provides the Journal Conversion Rules.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JOURNAL_CONVERSION_RULES');



debug('begin add_signature: GL_LEDGER_CONFIGURATION_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2420',
      p_sig_id                 => 'GL_LEDGER_CONFIGURATION_DETAILS',
      p_sig_sql                => 'select * from gl_ledger_config_Details where status_code=''CONFIRMED'' and configuration_id in (select configuration_id from gl_ledgers where ledger_id =##$$LEDGID$$##)',
      p_title                  => 'GL Ledger Configuration Details.',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This provides the GL Ledger Configuration Details.',
      p_solution               => '',
      p_success_msg            => 'This provides the GL Ledger Configuration Details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: GL_LEDGER_CONFIGURATION_DETAILS');



debug('begin add_signature: GL Ledger Relationships Information');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2421',
      p_sig_id                 => 'GL Ledger Relationships Information',
      p_sig_sql                => 'SELECT 
    glr.relationship_id,
    glr.source_ledger_id,
    pl.name AS "Primary Ledger",
    glr.target_ledger_id,
    tl.name AS "Target Ledger",
    glr.sla_ledger_id,
    glr.primary_ledger_id,
    glr.target_currency_code,
    glr.target_ledger_name,
    glr.target_ledger_short_name,
    glr.target_ledger_category_code,
    glr.relationship_type_code,
    glr.relationship_enabled_flag,
    glr.inherit_creation_user_flag,
    glr.last_update_date,
    glr.last_updated_by,
    glr.creation_date,
    glr.created_by,
    glr.last_update_login,
    glr.gl_je_conversion_set_id,
    glr.sl_coa_mapping_id,
    glr.automatic_post_flag,
    glr.alc_default_conv_rate_type,
    glr.alc_no_rate_action_code,
    glr.alc_max_days_roll_rate,
    glr.alc_inherit_conversion_type,
    glr.alc_init_conv_option_code,
    glr.alc_init_period,
    glr.alc_init_date,
    glr.alc_initializing_rate_date,
    glr.alc_initializing_rate_type,
    glr.alc_period_average_rate_type,
    glr.alc_period_end_rate_type,
    glr.application_id,
    glr.org_id,
    glr.disable_conversion_date,
    glr.status_code,
    glr.hist_conv_status_code,
    pl.name AS primary_ledger_name,
    tl.name AS target_ledger_name
FROM gl_ledger_relationships glr
JOIN gl_ledgers pl ON glr.primary_ledger_id = pl.ledger_id
JOIN gl_ledgers tl ON glr.target_ledger_id = tl.ledger_id
WHERE pl.ledger_id = ##$$LEDGID$$##',
      p_title                  => 'GL Ledger Relationships Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This provides the GL Ledger Relationships Information.',
      p_solution               => '',
      p_success_msg            => 'This provides the GL Ledger Relationships Information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: GL Ledger Relationships Information');



debug('begin add_signature: GL_FLEXFIELD_INFORMATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2422',
      p_sig_id                 => 'GL_FLEXFIELD_INFORMATION',
      p_sig_sql                => 'Select Id_Flex_Num,
       coa.ID_FLEX_CODE,
       coa.application_column_name,
       coa.segment_name,
       coa.segment_num,
...
from fnd_id_flex_segments coa,
   Fnd_Flex_Value_Sets  Vs
where coa.id_flex_code in (''GL#'',''GLLE'')
and id_flex_num = (select chart_of_accounts_id from gl_ledgers where ledger_id = ##$$LEDGID$$##)
And Coa.Flex_Value_Set_Id = Vs.Flex_Value_Set_Id
order by  coa.ID_FLEX_CODE,coa.application_column_name',
      p_title                  => 'GL FLexfield Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This provides the General Ledger FLexfield Information.',
      p_solution               => '',
      p_success_msg            => 'This provides the General Ledger FLexfield Information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: GL_FLEXFIELD_INFORMATION');



debug('begin add_signature: FLEX_QUALIFIER_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2423',
      p_sig_id                 => 'FLEX_QUALIFIER_DETAILS',
      p_sig_sql                => 'select application_column_name,
       segment_attribute_type,
       attribute_value
from FND_SEGMENT_ATTRIBUTE_VALUES sav1
WHERE sav1.application_id = 101
AND sav1.id_flex_code = ''GL#''
and SAV1.ID_FLEX_NUM = (select chart_of_accounts_id from gl_ledgers where ledger_id = ##$$LEDGID$$##)
AND sav1.attribute_value = ''Y''
and SAV1.SEGMENT_ATTRIBUTE_TYPE != ''GL_GLOBAL''
order by application_column_name',
      p_title                  => 'Flexfield Qualifier Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This provides the Flexfield Qualifier Details.',
      p_solution               => '',
      p_success_msg            => 'This provides the Flexfield Qualifier Details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: FLEX_QUALIFIER_DETAILS');



debug('begin add_signature: GL_CHART_OF_ACCOUNTS_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2424',
      p_sig_id                 => 'GL_CHART_OF_ACCOUNTS_DETAILS',
      p_sig_sql                => 'select 
b.id_flex_structure_code,
tl.id_flex_structure_name,
b.concatenated_segment_delimiter ,
b.cross_segment_validation_flag CROSS_SEGMENT_VALIDATION_FLAG,
b.dynamic_inserts_allowed_flag DYNAMIC_INSERTS_ALLOWED_FLAG
from fnd_id_flex_structures b,
    fnd_id_flex_structures_tl tl
where b.application_id = 101
and b.id_flex_code = ''GL#''
AND b.id_flex_num = (select chart_of_accounts_id from gl_ledgers where ledger_id = ##$$LEDGID$$##)
and tl.application_id = b.application_id
and tl.id_flex_code = b.id_flex_code
and tl.id_flex_num  = b.id_flex_num
and tl.language = userenv(''lang'')',
      p_title                  => 'GL Chart Of Accounts Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This provides the General Ledger Chart Of Accounts Details.',
      p_solution               => '',
      p_success_msg            => 'This provides the General Ledger Chart Of Accounts Details.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: GL_CHART_OF_ACCOUNTS_DETAILS');



debug('begin add_signature: BSV_ASSIGNMENTS_AT_LEGAL_ENTITY_LEVEL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2425',
      p_sig_id                 => 'BSV_ASSIGNMENTS_AT_LEGAL_ENTITY_LEVEL',
      p_sig_sql                => 'select xep.name,glle.legal_entity_id,
glle.flex_value_set_id,
glle.flex_segment_value BSV_Segment_Value,
glle.start_date,
...
from gl_legal_entities_bsvs glle ,xle_entity_profiles xep
    where glle.legal_entity_id in(
    select object_id from gl_ledger_config_details where configuration_id in (select configuration_id from gl_ledgers where ledger_id=##$$LEDGID$$##)
        and object_type_code = ''LEGAL_ENTITY''
        and glle.legal_entity_id=xep.legal_entity_id)',
      p_title                  => 'BSV Assignments at Legal Entity level',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This provides the BSV Assignments at Legal Entity level.',
      p_solution               => '',
      p_success_msg            => 'This provides the BSV Assignments at Legal Entity level.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: BSV_ASSIGNMENTS_AT_LEGAL_ENTITY_LEVEL');



debug('begin add_signature: BSV_ASSIGNMENT_AT_LEDGER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2426',
      p_sig_id                 => 'BSV_ASSIGNMENT_AT_LEDGER',
      p_sig_sql                => 'select distinct a.* from gl_ledger_norm_seg_vals a, gl_ledger_relationships b,
gl_ledger_config_details c,gl_ledgers d
where a.ledger_id=c.object_id 
and c.object_type_code <> ''LEGAL_ENTITY''
...
and a.legal_entity_id is  NULL
and a.ledger_id=b.target_ledger_id
and d.ledger_id=##$$LEDGID$$##',
      p_title                  => 'BSV Assignment at Ledger Level',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This provides the BSV Assignment at Ledger Level.',
      p_solution               => '',
      p_success_msg            => 'This provides the BSV Assignment at Ledger Level.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: BSV_ASSIGNMENT_AT_LEDGER');



debug('begin add_signature: REPORTING_AND_ACCOUNTING_SEQUENCE_INFORMATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2427',
      p_sig_id                 => 'REPORTING_AND_ACCOUNTING_SEQUENCE_INFORMATION',
      p_sig_sql                => 'select fsa.Assignment_id ,
fsa.seq_context_id,
fsa.seq_header_id,
fsa.control_attribute_structure,
fsa.balance_type,
fsa.journal_source,
...
fsv.start_date,
fsv.end_date
from FUN_SEQ_ASSIGNMENTS fsa ,
gl_ledgers gll ,
FUN_SEQ_CONTEXTS fsc,
FUN_SEQ_VERSIONS FSV
where fsc.context_value=to_char(gll.ledger_id)
and fsc.seq_context_id=fsa.seq_context_id
AND FSA.SEQ_HEADER_ID=FSV.SEQ_HEADER_ID
and gll.ledger_id =##$$LEDGID$$##',
      p_title                  => 'Reporting and Accounting Sequence Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This provides the Reporting and Accounting Sequence Information.',
      p_solution               => 'No Reporting and Accounting Sequence Information exists.',
      p_success_msg            => 'This provides the Reporting and Accounting Sequence Information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: REPORTING_AND_ACCOUNTING_SEQUENCE_INFORMATION');



debug('begin add_signature: INTRA_COMPANY_RULES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2428',
      p_sig_id                 => 'INTRA_COMPANY_RULES',
      p_sig_sql                => 'select fbo.ledger_id,fbo.le_id,
decode(xle.name,null,''No Legal Entity'',xle.name)Legal_Entity_name,
fba.dr_bsv, 
fba.cr_bsv,
fbo.je_source_name,
fbo.je_category_name,
...
and gll.ledger_id=##$$LEDGID$$##
and fbo.le_id=xle.legal_entity_id(+)',
      p_title                  => 'Intra Company Rules',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This provides the Intra Company Rules.',
      p_solution               => 'No Intra Company Rules exist.',
      p_success_msg            => 'This provides the Intra Company Rules.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: INTRA_COMPANY_RULES');



debug('begin add_signature: INTER_COMPANY_RULES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2429',
      p_sig_id                 => 'INTER_COMPANY_RULES',
      p_sig_sql                => 'SELECT interaccteo.from_le_id transacting_legal_entity,
gll1.legal_entity_name transacting_le_name,
interaccteo.ledger_id transacting_ledger,
...
AND interaccteo.ccid = glkfv.code_combination_id
and interaccteo.ledger_id=gll1.ledger_id
and gll1.ledger_id=##$$LEDGID$$##',
      p_title                  => 'Inter Company Rules',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This provides the Inter Company Rules.',
      p_solution               => 'No InterCompany Rules exist.',
      p_success_msg            => 'This provides the Inter Company Rules.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: INTER_COMPANY_RULES');



debug('begin add_signature: GL_LEDGER_NORM_SEG_VALS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2430',
      p_sig_id                 => 'GL_LEDGER_NORM_SEG_VALS',
      p_sig_sql                => 'select * from gl_ledger_norm_seg_vals
    where
    ledger_id in (select OBJECT_ID from gl_ledger_config_Details where
    configuration_id in (select configuration_id from gl_ledgers where ledger_id=##$$LEDGID$$##)
    and object_type_code in (''PRIMARY'',''SECONDARY''))
    or legal_entity_id in (select OBJECT_ID from gl_ledger_config_Details where
    configuration_id in (select configuration_id from gl_ledgers where ledger_id=##$$LEDGID$$##)
    and object_type_code in (''LEGAL_ENTITY'') ) order by ledger_id',
      p_title                  => 'GL_LEDGER_NORM_SEG_VALS Table Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This provides the Table Details for GL_LEDGER_NORM_SEG_VALS.',
      p_solution               => '',
      p_success_msg            => 'This provides the Table Details for GL_LEDGER_NORM_SEG_VALS.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: GL_LEDGER_NORM_SEG_VALS');



debug('begin add_signature: GL_LEDGER_SEGMENT_VALUES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2431',
      p_sig_id                 => 'GL_LEDGER_SEGMENT_VALUES',
      p_sig_sql                => 'select * from gl_ledger_segment_values
    where
    ledger_id in (select OBJECT_ID from gl_ledger_config_Details where
    configuration_id in (select configuration_id from gl_ledgers where ledger_id=##$$LEDGID$$##)
    and object_type_code in (''PRIMARY'',''SECONDARY''))
    ...
    configuration_id in (select configuration_id from gl_ledgers where ledger_id=##$$LEDGID$$##)
    and object_type_code in (''LEGAL_ENTITY'') ) order by ledger_id',
      p_title                  => 'GL_LEDGER_SEGMENT_VALUES Table Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This provides the Table Details for GL_LEDGER_SEGMENT_VALUES.',
      p_solution               => '',
      p_success_msg            => 'This provides the Table Details for GL_LEDGER_SEGMENT_VALUES.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: GL_LEDGER_SEGMENT_VALUES');



debug('begin add_signature: OPERATING_UNITS_ASSIGNMENT_DETAILS_FOR_PRIMARY_LEDGER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2432',
      p_sig_id                 => 'OPERATING_UNITS_ASSIGNMENT_DETAILS_FOR_PRIMARY_LEDGER',
      p_sig_sql                => 'SELECT distinct O.BUSINESS_GROUP_ID ,
       O.ORGANIZATION_ID ,
    OTL.NAME ,
    O.DATE_FROM ,
    O.DATE_TO ,
    O3.ORG_INFORMATION5 SHORT_CODE,
    O3.ORG_INFORMATION3 Ledger_id ,
    O3.ORG_INFORMATION2 DEFAULT_LEGAL_CONTEXT_ID,
    xep.name Legal_Entity_name,
    O3.ORG_INFORMATION6 USABLE_FLAG
  ...
  AND O3.ORG_INFORMATION2=xep.legal_entity_id
    AND O3.ORG_INFORMATION_CONTEXT = ''Operating Unit Information''
  AND O2.ORG_INFORMATION1        = ''OPERATING_UNIT''
  AND O2.ORG_INFORMATION2        = ''Y''
  AND O.ORGANIZATION_ID          = OTL.ORGANIZATION_ID
  And to_number(O3.ORG_INFORMATION3)=##$$LEDGID$$##',
      p_title                  => 'Operating Units Assignment Details For Primary Ledger',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This provides the Operating Units Assignment Details For Primary Ledger.',
      p_solution               => '',
      p_success_msg            => 'This provides the Operating Units Assignment Details For Primary Ledger.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: OPERATING_UNITS_ASSIGNMENT_DETAILS_FOR_PRIMARY_LEDGER');



debug('begin add_signature: GL_LE_VALUE_SETS_INFORMATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '2433',
      p_sig_id                 => 'GL_LE_VALUE_SETS_INFORMATION',
      p_sig_sql                => 'select * from  gl_le_value_sets where legal_entity_id in(
select object_id from gl_ledger_config_details where configuration_id in (select configuration_id from gl_ledgers where ledger_id=##$$LEDGID$$##)
and object_type_code = ''LEGAL_ENTITY'')order by legal_entity_id',
      p_title                  => 'GL_LE_VALUE_SETS Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This provides the GL_LE_VALUE_SETS Information.',
      p_solution               => '',
      p_success_msg            => 'This provides the GL_LE_VALUE_SETS Information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: GL_LE_VALUE_SETS_INFORMATION');



debug('begin add_signature: COA_ROLLUP_RULES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13815',
      p_sig_id                 => 'COA_ROLLUP_RULES',
      p_sig_sql                => 'SELECT
    a.to_segment_name            "Target Segment",
    a.single_value               "Target Segment Detail Value",
    a.segment_map_type_display   "Transfer Level Using",
    a.parent_rollup_value        "Source Segment Parent Value",
    a.child_flex_value_low       "Source Segment Ranges Low",
    a.child_flex_value_high      "Source Segment Ranges High",
    a.mapping_id,
    a.segment_map_id,
    a.segment_map_type
FROM (
        ( SELECT
    mapv.row_id                         row_id,
    mapv.segment_map_id                 segment_map_id,
    mapv.coa_mapping_id                 mapping_id,
    mapv.last_update_date               last_update_date,
    mapv.last_updated_by                last_updated_by,
    mapv.to_value_set_id                to_value_set_id,
    mapv.to_application_column_name     to_application_column_name,
    ffs1.segment_name                   to_segment_name,
    ffs1.segment_num                    to_segment_num,
    mapv.segment_map_type               segment_map_type,
    l.meaning                           segment_map_type_display,
    mapv.creation_date                  creation_date,
    mapv.created_by                     created_by,
    mapv.last_update_login              last_update_login,
    mapv.from_value_set_id              from_value_set_id,
    mapv.from_application_column_name   from_application_column_name,
    ffs2.segment_name                   from_segment_name,
    ffs2.segment_num                    from_segment_num,
    mapv.single_value                   single_value,
    mapv.attribute1                     attribute1,
    mapv.attribute2                     attribute2,
    mapv.attribute3                     attribute3,
    mapv.attribute4                     attribute4,
    mapv.attribute5                     attribute5,
    mapv.context                        context,
    mapv.parent_rollup_value            parent_rollup_value,
    fvs.validation_type                 validation_type,
    gcrrv.child_flex_value_low,
    gcrrv.child_flex_value_high
FROM
    gl_lookups l,
    fnd_id_flex_segments ffs1,
    fnd_id_flex_segments ffs2,
    fnd_flex_value_sets fvs,
    gl_segment_map_cons_v mapv,
    gl_cons_rollup_ranges_v gcrrv
WHERE
    ffs1.application_id = 101
    AND ffs1.id_flex_code = ''GL#''
    AND ffs1.id_flex_num = mapv.to_chart_of_accounts_id
    AND ffs1.application_column_name = mapv.to_application_column_name
    AND ffs2.application_id (+) = 101
    AND ffs2.id_flex_code (+) = ''GL#''
    AND ffs2.id_flex_num (+) = mapv.from_chart_of_accounts_id
    AND ffs2.application_column_name (+) = mapv.from_application_column_name
    AND l.lookup_type = ''SEGMENT_MAP_TYPE''
    AND l.lookup_code = mapv.segment_map_type
    AND fvs.flex_value_set_id = mapv.to_value_set_id
    AND ffs1.segment_name = ''##$$FK3$$##''
    AND gcrrv.segment_map_id(+) = mapv.segment_map_id
    AND gcrrv.segment_map_type(+) = mapv.segment_map_type
    AND mapv.segment_map_type <> ''P''
        AND mapv.coa_mapping_id = ##$$FK2$$##
            AND l.meaning IN (
                ''Detail Rollup Ranges'',
                ''Parent Value'',
                ''Detail Rollup Via Parent''
            )
        )
        UNION ALL
        ( SELECT
        ...
        WHERE
            ...
            AND mapv.coa_mapping_id = ##$$FK2$$##
            AND ffs1.segment_name = ''##$$FK3$$##''
            AND gcrrv.flex_value_set_id = ##$$FK4$$## AND gcrrv.parent_flex_value = mapv.parent_rollup_value )
    ) a
ORDER BY
    a.single_value,
    a.child_flex_value_low,
    a.child_flex_value_high',
      p_title                  => 'Rollup Rules',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Chart of Accounts Mapping Segment/Rollup Rules with Source Segment Ranges.',
      p_solution               => '',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: COA_ROLLUP_RULES');



debug('begin add_signature: COA_SEGMENT_RULES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13814',
      p_sig_id                 => 'COA_SEGMENT_RULES',
      p_sig_sql                => 'SELECT DISTINCT
    NVL(a.from_value_set_id, -1) "##$$FK4$$##"
    , to_segment_num    "Seg#"
    , to_segment_name   "Target Segment"
    , to_segment_name "##$$FK3$$##"
    , DECODE(segment_map_type, ''C'', ''Copy Value From'', ''S'', ''Assign Single Value'', ''R'', ''Use Rollup Rules From'', ''N'', ''Not Assigned''
    , segment_map_type) "Action"
    , DECODE(from_segment_name, NULL, single_value, from_segment_name) "Source Segment"
    , mapping_id "##$$FK2$$##"
FROM
    gl_cons_segment_map_v a
WHERE
    mapping_id = ##$$FK1$$##
    AND a.segment_map_type IN (
        ''C'',
        ''R'',
        ''S'',
        ''U''
...
ORDER BY
    a.to_segment_num',
      p_title                  => 'Segment Rules',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Chart of Accounts Mapping Segment Rules.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      ...
      p_limit_rows             => nvl('N','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('COA_ROLLUP_RULES'),
      p_include_in_dx_summary  => nvl('Y','N'),
      p_version                => '2'
      );
   l_info.delete;
debug('end add_signature: COA_SEGMENT_RULES');



debug('begin add_signature: COA_ACCOUNT_RULES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13816',
      p_sig_id                 => 'COA_ACCOUNT_RULES',
      p_sig_sql                => 'select map.name||'' (''||map.coa_mapping_id||'')'' "COA Mapping Name/ID"
  ,gcmm.segment1_low||''.''||gcmm.segment2_low||''.''||gcmm.segment3_low||''.''||gcmm.segment4_low||''.''||gcmm.segment5_low "Source Accounts LOW"
  ,gcmm.segment1_high||''.''||gcmm.segment2_high||''.''||gcmm.segment3_high||''.''||gcmm.segment4_high||''.''||gcmm.segment5_high "Source Accounts HIGH"
  ,gcc.concatenated_segments "Target Account"
  ,gcmm.to_code_combination_id  "Target Account CCID"
  from GL_CONS_FLEXFIELD_MAP  gcmm, gl_code_combinations_kfv gcc, gl_coa_mappings map 
  where gcmm.to_code_combination_id = gcc.code_combination_id
  and map.coa_mapping_id = gcmm.coa_mapping_id
and map.coa_mapping_id = ##$$FK1$$##',
      p_title                  => 'Account Rules',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Chart of Accounts Mapping Account Rules.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: COA_ACCOUNT_RULES');



debug('begin add_signature: COA_MAPPING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13813',
      p_sig_id                 => 'COA_MAPPING',
      p_sig_sql                => 'SELECT
    a.mapping_id                    mapping_id,
    a.mapping_id                    "##$$FK1$$##",
    a.mapping_name                  "COA Mapping",
    a.to_chart_of_accounts_name     "COA Target",
    a.from_chart_of_accounts_name   "COA Source",
    a.start_date_active             "Start Date",
    a.end_date_active               "End Date",
    DECODE(a.security_flag, ''N'', ''No'', ''Y'', ''Yes'', a.security_flag) "Security Enabled"
FROM
    (
        SELECT
            map.rowid                         row_id,
            map.coa_mapping_id                mapping_id,
            map.name                          mapping_name,
            map.last_update_date              last_update_date,
            map.last_updated_by               last_updated_by,
            from_coa.id_flex_structure_name   from_chart_of_accounts_name,
            from_coa.id_flex_num              from_chart_of_accounts_id,
            to_coa.id_flex_structure_name     to_chart_of_accounts_name,
            to_coa.id_flex_num                to_chart_of_accounts_id,
            map.creation_date                 creation_date,
            map.created_by                    created_by,
            map.last_update_login             last_update_login,
            map.description                   description,
            map.start_date_active             start_date_active,
            map.end_date_active               end_date_active,
            map.security_flag                 security_flag,
            DECODE(map.security_flag, ''Y'', DECODE(fnd_data_security.check_function(1.0, ''GL_DAS_COA_MAPPING_V'', ''GL_DAS_COA_MAPPING''
            , TO_CHAR(map.coa_mapping_id), NULL, NULL, NULL, NULL, fnd_global.user_name), ''T'', ''Y'', ''N''), ''Y'') view_privilege,
            DECODE(map.security_flag, ''Y'', DECODE(fnd_data_security.check_function(1.0, ''GL_DAS_COA_MAPPING_U'', ''GL_DAS_COA_MAPPING''
            , TO_CHAR(map.coa_mapping_id), NULL, NULL, NULL, NULL, fnd_global.user_name), ''T'', ''Y'', ''N''), ''Y'') use_privilege,
            DECODE(map.security_flag, ''Y'', DECODE(fnd_data_security.check_function(1.0, ''GL_DAS_COA_MAPPING_M'', ''GL_DAS_COA_MAPPING''
            , TO_CHAR(map.coa_mapping_id), NULL, NULL, NULL, NULL, fnd_global.user_name), ''T'', ''Y'', ''N''), ''Y'') modify_privilege
        FROM
            gl_coa_mappings map,
            gl_ledger_relationships glr,
            fnd_id_flex_structures_v from_coa,
            fnd_id_flex_structures_v to_coa
        WHERE
            map.from_coa_id = from_coa.id_flex_num
            AND map.coa_mapping_id = glr.sl_coa_mapping_id
            AND map.to_coa_id = to_coa.id_flex_num
            AND from_coa.application_id = 101
            AND from_coa.id_flex_code = ''GL#''
            AND to_coa.application_id = 101
            AND to_coa.id_flex_code = ''GL#''
            AND glr.primary_ledger_id = nvl(##$$LEDGID$$##, - 1)
    ) a',
      p_title                  => 'Chart of Accounts Mapping',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Chart of Accounts Mapping details for the selected Ledger ID/Name.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      ...
      p_limit_rows             => nvl('N','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('COA_SEGMENT_RULES','COA_ACCOUNT_RULES'),
      p_include_in_dx_summary  => nvl('Y','N'),
      p_version                => '3'
      );
   l_info.delete;
debug('end add_signature: COA_MAPPING');



debug('begin add_signature: DEFAULT INTERCOMPANY ACCOUNTS NOT ACTIVE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15830',
      p_sig_id                 => 'DEFAULT INTERCOMPANY ACCOUNTS NOT ACTIVE',
      p_sig_sql                => 'SELECT
    gl.name ledger_name,
    fia.from_le_id, fia.to_le_id, fia.CCID,
    kfv.concatenated_segments,
    fia.default_flag,
    fia.end_date
FROM
    fun_inter_accounts fia,
    gl_ledgers gl,
    gl_code_combinations_kfv kfv
WHERE fia.end_date < sysdate
    AND fia.ledger_id = gl.ledger_id
    AND fia.ccid = kfv.code_combination_id
   and gl.ledger_id = ##$$LEDGID$$##',
      p_title                  => 'Default Intercompany Accounts Are Not Active',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'End date given for  default intercompany accounts is not active for the system date. Ensure end date used allows the use of intercompany accounts for balancing the intercompany transactions ',
      p_solution               => '<ul><li>End date of intercompany accounts not active for the system date</li>
<li> Read [1575958.1] Error: "Transaction 1 encountered errors deriving Intercompany Accounts" when creating intercompany transactions </li></ul>',
      p_success_msg            => 'Default intercompany accounts are active for the system date.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: DEFAULT INTERCOMPANY ACCOUNTS NOT ACTIVE');



debug('begin add_signature: USE FOR BALANCING OPTION FOR INTERCOMPANY ACCOUNTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15829',
      p_sig_id                 => 'USE FOR BALANCING OPTION FOR INTERCOMPANY ACCOUNTS',
      p_sig_sql                => 'Select gl.name ledger_name,fia.from_le_id, fia.to_le_id, fia.CCID, kfv.concatenated_segments , fia.default_flag from fun_inter_accounts fia, gl_ledgers gl, gl_code_combinations_kfv kfv   where fia.default_flag != ''Y''
and fia.ledger_id = gl.ledger_id
and fia.CCID = kfv.code_combination_id
and gl.ledger_id = ##$$LEDGID$$##',
      p_title                  => 'Use for Balancing Option for Default Intercompany Accounts',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Use for Balancing Option not enabled for Default Intercompany Accounts.
This option has to be enabled for balancing intercompany transactions.',
      p_solution               => '<ul><li>Use for Balancing Option not enabled</li>
<li> Read [1575958.1] Error: "Transaction 1 encountered errors deriving Intercompany Accounts" when creating intercompany transactions </li></ul>',
      p_success_msg            => 'Use for balancing option enabled for all default intercompany accounts.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: USE FOR BALANCING OPTION FOR INTERCOMPANY ACCOUNTS');



debug('begin add_signature: AGIS_OPEN_TRANSACTIONS_BY_PERIODS');
   l_info('##MASK##TRX_TYPE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5734',
      p_sig_id                 => 'AGIS_OPEN_TRANSACTIONS_BY_PERIODS',
      p_sig_sql                => 'select fps.period_name,
fps.status ||''(''|| lkup.meaning ||'')'' period_status,
fps.trx_type_id,
ftt.trx_type_name trx_type_name,
(
CASE
WHEN MAX(mcount) >10
THEN ''More than 10''
else to_char(nvl(max(mcount),0))
END ) open_trx_no,
(
CASE
WHEN (MAX(mcount)>0 )
...
(
CASE
WHEN (fps.status IN (''C'',''N'',''S''))
THEN ''Y''
ELSE ''N''
END ) ckeck_flag

FROM fun_period_statuses fps,
fun_system_options fso,
fun_trx_types_tl ftt,
fnd_lookup_values lkup,
(SELECT COUNT(FPS1.TRX_TYPE_ID) mcount,
FPS1.TRX_TYPE_ID mTrxId,
FPS1.PERIOD_NAME mPeriodName
FROM fUN_TRX_BATCHES FTB1,
FUN_TRX_HEADERS FTH1 ,
FUN_period_statuses FPS1,
fun_system_options fso1
WHERE Fps1.trx_type_id = ftb1.trx_type_id
AND fth1.status IN (''SENT'',''ERROR'',''RECEIVED'')
AND ftb1.gl_date BETWEEN fps1.start_date AND fps1.end_date
AND ftb1.batch_id = fth1.batch_id
AND fps1.inteco_calendar =NVL(fso1.inteco_calendar,''~~'')
AND fps1.inteco_period_type=NVL(fso1.inteco_period_type,''~~'')
GROUP BY FPS1.TRX_TYPE_ID,
FPS1.PERIOD_NAME
) TrxDet
WHERE lkup.lookup_type =''FUN_PERIOD_STATUS''
and lkup.lookup_code =fps.status
AND lkup.language =''US''
...
AND fps.trx_type_id = TrxDet.mTrxId(+)
and fps.period_name = trxdet.mperiodname(+)
--and fps.period_name = ''Dec-16''
--and fps.status =''O''
AND fps.inteco_calendar =NVL(fso.inteco_calendar,''~~'')
AND fps.inteco_period_type =NVL(fso.inteco_period_type,''~~'')
GROUP BY ftt.trx_type_name,
fps.status ,
fps.period_name,
fps.trx_type_id,
lkup.meaning
...
order by trx_type_name',
      p_title                  => 'Number of Open Transactions by Period',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Open transactions in AGIS periods detected.',
      p_solution               => 'Please complete all open transactions before starting period close process in AGIS, AR, AP and GL. <br>
Review steps from [418649.1] Advanced Global Intercompany (AGIS) in Release 12 (R12) - Setup, Transaction Processing and Reports.',
      p_success_msg            => 'No open transactions found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_OPEN_TRANSACTIONS_BY_PERIODS');



debug('begin add_signature: AGIS_PERIOD_OPEN_TRANSACTION_TYPE_DETAILS');
   l_info('##MASK##TRX_TYPE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5735',
      p_sig_id                 => 'AGIS_PERIOD_OPEN_TRANSACTION_TYPE_DETAILS',
      p_sig_sql                => 'select 
ftt.trx_type_id trx_type_id,
ftt.trx_type_name Trx_Type_Name,
decode(fps1.period_name , null , '' '' , fps1.period_name )open_trx,
decode(fps.status,''O'',''Y'',''N'') check_flag,
fps.period_name period_name,
fps.status ||''(''|| lkup.meaning ||'')'' period_status
FROM fun_period_statuses fps,
fun_system_options fso,
(SELECT MAX(Period_name) KEEP (DENSE_RANK LAST
ORDER BY period_year,period_num) period_name ,
trx_type_id
FROM fun_period_statuses fps_in,
fun_system_options fso_in
WHERE status =''O''
AND fps_in.inteco_calendar =NVL(fso_in.inteco_calendar,''~~'')
AND fps_in.inteco_period_type=NVL(fso_in.inteco_period_type,''~~'')
GROUP BY trx_type_id
)fps1,
fun_trx_types_tl ftt,
fnd_lookup_values lkup
WHERE fps.trx_type_id = ftt.trx_type_id
AND fps.trx_type_id =fps1.trx_type_id(+)
AND lkup.lookup_type =''FUN_PERIOD_STATUS''
AND lkup.VIEW_APPLICATION_ID = 435
AND lkup.SECURITY_GROUP_ID = fnd_global.lookup_security_group(lkup.LOOKUP_TYPE,435)
and lkup.lookup_code =fps.status
and lkup.language = ''US''--USERENV(''LANG'')
--and fps.period_name = ''Oct-16''
and fps.status =''O''
AND fps.inteco_calendar =NVL(fso.inteco_calendar,''~~'')
AND fps.inteco_period_type =NVL(fso.inteco_period_type,''~~'')
...
lkup.meaning
order by Trx_Type_Name',
      p_title                  => 'Transaction Types',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transaction Type Details for Open Periods.',
      p_solution               => 'Please close the transaction types.<br>
Intercompany transactions are recorded and accounted for in an open period. Use the Open/Close Intercompany Period Status pages to search for a period and open or close the period for a transaction.<br>
Optionally, you can close a period for all transactions.<br>
Useful documentation: [2175020.1] R12: Is There Any API for AGIS Automated Period Closure? <br>
[726980.1] R12: How To Prevent Users From Entering AGIS Transactions In Closed GL Periods.',
   ...
   l_info.delete;
debug('end add_signature: AGIS_PERIOD_OPEN_TRANSACTION_TYPE_DETAILS');



debug('begin add_signature: AGIS_WF_VERSION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5676',
      p_sig_id                 => 'AGIS_WF_VERSION',
      p_sig_sql                => 'SELECT w.TEXT Workflow_Version
FROM WF_RESOURCES w
WHERE TYPE = ''WFTKN''
AND NAME = ''WF_VERSION''
AND LANGUAGE = ''US''',
   ...
   l_info.delete;
debug('end add_signature: AGIS_WF_VERSION');



debug('begin add_signature: AGIS WORKFLOW LISTENERS NOT RUNNING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5601',
      p_sig_id                 => 'AGIS WORKFLOW LISTENERS NOT RUNNING',
      p_sig_sql                => 'SELECT  fsc.COMPONENT_ID "COMPONENT_ID", fsc.COMPONENT_NAME "COMPONENT",fsc.STARTUP_MODE "STARTUP_MODE",
fsc.COMPONENT_STATUS "STATUS",v.PARAMETER_VALUE "#THREADS",
fcq.MAX_PROCESSES "TARGET",fcq.RUNNING_PROCESSES "ACTUAL",  fcq.ENABLED_FLAG "ENABLED", 
fsc.CORRELATION_ID "CORRELATION_ID",
FCQ.USER_CONCURRENT_QUEUE_NAME "CONTAINER",
...
APPS.FND_SVC_COMPONENTS FSC, FND_SVC_COMP_PARAM_VALS V , FND_SVC_COMP_PARAMS_B B
...
AND B.PARAMETER_NAME = ''PROCESSOR_IN_THREAD_COUNT''
ORDER BY FCP.OS_PROCESS_ID, FSC.STARTUP_MODE, fsc.COMPONENT_ID',
      p_title                  => 'Workflow Services Status',
      p_fail_condition         => '[STATUS] <> [RUNNING]',
      p_problem_descr          => 'Workflow Services not running identified.',
      p_solution               => 'Use the Oracle Workflow Manager component of Oracle Applications Manager to manage the required parameters and components that enables message propagation for the Business Event System.<br> Check the Workflow Services that are not running. There can be several reasons why a Workflow Agent Listener is not running: <br>
<ol>
<li>It has been shut down, or deactivated by a user<br>
The Agent Listener can simply be restarted. <br>
</li>
...
package. Check the state of the database packages. </p>

<p> To check workflow listeners, follow below steps: <br>
<ul><li>Responsibility -> Workflow Administrator Web Applications -> Oracle Applications Manager --> Workflow Manager</li>
<li>Notification Mailers> Check all the components in this region.</li>
<li>Agent Listeners -> Check all the components in this region.</li>
<li>If any of the listener components are not in ''Running'' status, then stop and start the listeners.</li>
See [785167.1]- Advanced Global Intercompany Troubleshooting AGIS Workflow Technical Brief.
<ul>

<p>
Please also refer to Step 21: Setting Up the Business Event System in
<a href="http://docs.oracle.com/cd/E26401_01/doc.122/e22008/T319398T319402.htm#T319588" target="_blank">Oracle Workflow Administrators Guide</a>
      ...
      p_success_msg            => 'Workflow Services are up and running.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AGIS WORKFLOW LISTENERS NOT RUNNING');



debug('begin add_signature: AGIS_AME_PROF_INSTALLED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9043',
      p_sig_id                 => 'AGIS_AME_PROF_INSTALLED',
      p_sig_sql                => 'SELECT 
  po.profile_option_name,
  SUBSTR (pot.user_profile_option_name,1,60) user_profile_option_name,
  DECODE (TO_CHAR (pov.level_id), ''10001'', ''SITE'', ''10002'', ''APP'', ''10003'', ''RESP'' ) "LEVEL",
  DECODE (TO_CHAR (pov.level_id), ''10001'', '''', ''10002'', app.application_short_name, ''10003'', rsp.responsibility_name ) "CONTEXT",
  SUBSTR (pov.profile_option_value,1,60) value
...
AND pot.PROFILE_OPTION_NAME  = po.PROFILE_OPTION_NAME
AND pot.language             =''US''
AND rsp.application_id(+)    = pov.level_value_application_id
AND rsp.responsibility_id(+) = pov.level_value
AND app.application_id(+)    = pov.level_value
AND UPPER(po.profile_option_name) LIKE Upper(''AME%'')',
      p_title                  => 'Profile Option: AME Installed',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This section check if the profile option "AME: Installed" has been set.<br>

This user profile is predefined by AME and is available for integrating applications such as AGIS, Internet Expenses, iProcurement, General Ledger to make use of.<br>

This is the mandatory profile option that needs to be set to "Y"(Yes) at required application level.<br>',
      p_solution               => 'To set the profile Option, please follow the below steps:<br>
1. Log in to System Administrator responsibility<br>
2. Navigate to Profile > System <br>
3. Query the profile option "AME: Installed" at site level <br>
4. Set this ti YES at site level <br>
5. Save <br>',
      p_success_msg            => 'Profile option "AME: Installed" has been set. <br>

This user profile is predefined by AME and is available for integrating applications such as AGIS, Internet Expenses, iProcurement, General Ledger to make use of. <br>

This is the mandatory profile option that needs to be set to "Y"(Yes) at required application level. <br>
To set the profile Option, please follow the below steps: <br>
1. Log in to System Administrator responsibility <br>
2. Navigate to Profile > System <br>
3. Query the profile option "AME: Installed" at site level <br>
4. Set this ti YES at site level <br>
5. Save <br>',
   ...
   l_info.delete;
debug('end add_signature: AGIS_AME_PROF_INSTALLED');



debug('begin add_signature: AGIS_AME_APP_DET');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8887',
      p_sig_id                 => 'AGIS_AME_APP_DET',
      p_sig_sql                => 'Select * from ame_Calling_Apps where fnd_Application_Id = 435',
      p_title                  => 'AME Application Details for AGIS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'AME application is not configured for AGIS.',
      p_solution               => 'Please refer the following technical brief which explains on AME setup.<br>
[1371982.1] Approvals Management Engine (AME) Usage and Setup in AGIS.<br>
<br>
Approval Management for AGIS is introduced with the patch 6995183 in R12.0.<br>
For R12.1, the same is supplied by default and no patch required.',
      p_success_msg            => 'This sections gives the AME application setup details.<br>
<br>
Please refer the following technical brief which explains on AME setup.<br>
[1371982.1] Approvals Management Engine (AME) Usage and Setup in AGIS.<br>
<br>
Approval Management for AGIS is introduced with the patch 6995183 in R12.0.<br>
For R12.1, the same is supplied by default and no patch required.',
   ...
   l_info.delete;
debug('end add_signature: AGIS_AME_APP_DET');



debug('begin add_signature: AGIS_AME_RULES_DEF');
   l_info('##MASK##RULE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8889',
      p_sig_id                 => 'AGIS_AME_RULES_DEF',
      p_sig_sql                => 'SELECT ARV.Rule_id ,
  ARV.Description Rule_Name,
  ARV.Item_Class_ID,
  --ICV.USER_ITEM_CLASS_NAME,
  icv.name,
  ARV.Rule_Type                                                                                                                                                                                                      AS Rule_Type_Id,
  DECODE(ARV.Rule_type, 0, ''Combination'', 1, ''List Creation'', 2, ''List Creation Exception'', 3, ''List Modification'', 4, ''Substitution'', 5, ''Pre List Approver Group'', 6, ''Post List Approver Group'', 7, ''Production'') AS Rule_Type_Meaning,
  TO_CHAR(ARV.Start_Date, ''DD-MM-YYYY'')                                                                                                                                                                              AS Start_date,
  TO_CHAR(ARV.End_Date,''DD-MM-YYYY'')                                                                                                                                                                                 AS End_Date,
  ARU.item_id                                                                                                                                                                                                        AS Application_id,
  DECODE(ARU.Approver_Category, ''A'', ''Approver'', ''F'', ''For Your Information'')                                                                                                                                        AS Category ,
  ARU.Priority,
  FU.User_Id                            AS Created_By_UserId,
  TO_CHAR(ARV.Creation_Date, ''DD_MM-YYYY'') AS Creation_Date
FROM AME_Rules ARV,
  AME_Rule_Usages ARU,
  ame_item_classes ICV,
  FND_User FU
WHERE ARV.Item_Class_Id = ICV.Item_Class_Id
AND ARV.Created_By      = FU.User_id
AND ARV.Rule_Id         = ARU.Rule_Id
AND ARU.Item_Id         IN
  (SELECT application_Id FROM ame_Calling_Apps WHERE fnd_Application_Id = 435
  )
AND sysdate BETWEEN ICV.start_date AND NVL(ICV.end_date -(1/84600),sysdate)
AND sysdate BETWEEN ARV.start_date AND NVL(ARV.end_date -(1/84600),sysdate)
AND sysdate BETWEEN ARU.start_date AND NVL(ARU.end_date -(1/84600),sysdate)',
      p_title                  => 'AME AGIS Rules Defined',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no AME rules defined for the GL journals.',
      p_solution               => 'Refer following notes on AME Rules:<br>
[1609965.1] AGIS Inbound page showing update button as grayed out ( Disable ).<br>
[1614815.1] R12: Cannot Update Recipient AGIS Transaction When AME Approval Rule Is Assigned To Transaction Type .<br>
[2079282.1] How to Disable AME Setup For AGIS ?<br>

Refer following technical brief for complete details:<br>
[1371982.1] Approvals Management Engine (AME) Usage and Setup in AGIS <br>
',
      p_success_msg            => 'This sections gives us all the AME rules defined for the AGIS transactions.<br>
Refer following notes on AME Rules:<br>
[1609965.1] AGIS Inbound page showing update button as grayed out ( Disable ).<br>
[1614815.1] R12: Cannot Update Recipient AGIS Transaction When AME Approval Rule Is Assigned To Transaction Type .<br>
[2079282.1] How to Disable AME Setup For AGIS ?<br>
...
',
   ...
   l_info.delete;
debug('end add_signature: AGIS_AME_RULES_DEF');



debug('begin add_signature: AGIS_AME_REQ_ATT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8890',
      p_sig_id                 => 'AGIS_AME_REQ_ATT',
      p_sig_sql                => 'SELECT *
FROM
(SELECT AttributesEO.ATTRIBUTE_ID AS ATTRIBUTE_ID ,
AttributeUsagesEO.APPLICATION_ID AS APPLICATION_ID ,
AttributesEO.NAME AS ATTRIBUTE_NAME ,
AttributesEO.DESCRIPTION AS DESCRIPTION ,
AttributeUsagesEO.QUERY_STRING AS QUERY_STRING ,
Usd.Meaning AS DATA_TYPE ,
Usl.Meaning AS USAGE_TYPE ,
Usc.Meaning AS CATEGORY ,
AttributesEO.START_DATE AS START_DATE ,
AttributesEO.END_DATE AS END_DATE ,
AttributeUsagesEO.START_DATE AS START_DATE1 ,
AttributeUsagesEO.END_DATE AS END_DATE1 ,
AttributesEO.ATTRIBUTE_TYPE AS ATTRIBUTE_TYPE ,
Itc.NAME AS ITEM_CLASS_NAME ,
--Itc.USER_ITEM_CLASS_NAME AS ITEM_CLASS ,
DECODE(ame_utility_pkg.check_seeddb ,''N'',DECODE(Usc.Meaning ,''Mandatory'',''SeededDel'' ,DECODE(ame_utility_pkg.is_seed_user(AttributeUsagesEO.CREATED_BY) ,1,''SeededDel'' ,''UnseededDel'')) ,''UnseededDel'') AS SEEDED_DELETE ,
DECODE(ame_utility_pkg.is_seed_user(AttributeUsagesEO.CREATED_BY) ,1,''SeededUpd'' ,''UnseededUpd'') AS SEEDED_UPDATE
FROM AME_ATTRIBUTES AttributesEO , 
--AME_ATTRIBUTES_VL AttributesEO ,
AME_ATTRIBUTE_USAGES AttributeUsagesEO ,
AME_ITEM_CLASSES Itc ,
--AME_ITEM_CLASSES_VL Itc ,
FND_LOOKUP_VALUES Usl ,
FND_LOOKUP_VALUES Usd ,
FND_LOOKUP_VALUES Usc
--FND_LOOKUPS Usl ,
--FND_LOOKUPS Usd ,
--FND_LOOKUPS Usc
WHERE AttributesEO.ATTRIBUTE_ID = AttributeUsagesEO.ATTRIBUTE_ID
AND AttributesEO.ITEM_CLASS_ID = Itc.ITEM_CLASS_ID
AND Usl.LOOKUP_TYPE = ''AME_QUERY_USAGE_TYPE''
AND Usl.LOOKUP_CODE = AttributeUsagesEO.IS_STATIC
AND Usl.ENABLED_FLAG = ''Y''
AND USL.LANGUAGE =''US''
AND Usd.LOOKUP_TYPE = ''AME_ATTRIBUTE_DATA_TYPE''
AND Usd.LOOKUP_CODE = UPPER(AttributesEO.ATTRIBUTE_TYPE)
AND Usd.ENABLED_FLAG = ''Y''
AND USD.LANGUAGE =''US''
AND Usc.LOOKUP_TYPE = ''AME_ATTRIBUTE_CATEGORY''
AND Usc.LOOKUP_CODE = ame_utility_pkg.get_attribute_category(AttributesEO.ATTRIBUTE_ID)
AND Usc.ENABLED_FLAG = ''Y''
AND USC.LANGUAGE =''US''
AND sysdate BETWEEN AttributesEO.start_date AND NVL(AttributesEO.end_date -(1/84600),sysdate)
AND sysdate BETWEEN AttributeUsagesEO.start_date AND NVL(AttributeUsagesEO.end_date-(1/84600),sysdate)
AND sysdate BETWEEN Itc.start_date AND NVL(Itc.end_date -(1/84600),sysdate)
AND Usc.Meaning = ''Others''
AND AttributeUsagesEO.APPLICATION_ID IN
(SELECT application_Id FROM ame_Calling_Apps WHERE fnd_Application_Id = 435
)
) QRSLT
ORDER BY ATTRIBUTE_Name',
      p_title                  => 'AME Required Attributes for AGIS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no Mandatory Attributes for AME.
',
      p_solution               => 'Please refer the following note for the explanation of the Mandatory Attributes:
[2010498.1] Break in Supervisor Hierarchy Generates Error For All AME Rules.	',
      p_success_msg            => 'This sections shows all the Mandatory Attributes for AME.<br>
Please refer the following note for the explanation of the Mandatory Attributes:<br>
[2010498.1] Break in Supervisor Hierarchy Generates Error For All AME Rules.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_AME_REQ_ATT');



debug('begin add_signature: AGIS_AME_CONDITIONS');
   l_info('##MASK##RULE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8891',
      p_sig_id                 => 'AGIS_AME_CONDITIONS',
      p_sig_sql                => 'SELECT ARV.Description Rule_Name,
...
FROM AME_Condition_Usages ACU,
  ...
  AME_Rules ARV,
  --AME_Rules_VL ARV,
  --ame_item_classes_vl ICV,
  ame_item_classes ICV,
  AME_Attributes AA,
  FND_Lookup_values AME_CT
  --FND_Lookups AME_CT
WHERE ACU.Condition_id       = AC.Condition_Id
AND ACU.Rule_Id              = ARU.Rule_Id
AND ACU.Rule_Id              = ARV.Rule_ID
AND AA.Attribute_Id          = AC.Attribute_Id
AND Upper(AC.Condition_Type) = Upper(AME_CT.Lookup_Code)
AND AME_CT.lookup_Type       = ''AME_CONDITION_TYPE''
AND AME_CT.LANGUAGE          =''US''
AND AME_CT.Enabled_Flag      = ''Y''
AND AA.Item_Class_Id         = ICV.Item_Class_Id
AND ARU.Item_Id             IN
  ( SELECT application_Id FROM ame_Calling_Apps WHERE fnd_Application_Id = 435
  )
AND sysdate BETWEEN ARU.start_date AND NVL(ARU.end_date -(1/84600),sysdate)
AND sysdate BETWEEN ACU.start_date AND NVL(ACU.end_date -(1/84600),sysdate)
AND sysdate BETWEEN AA.start_date AND NVL(AA.end_date   -(1/84600),sysdate)
AND sysdate BETWEEN ARV.start_date AND NVL(ARV.end_date -(1/84600),sysdate)
AND sysdate BETWEEN AC.start_date AND NVL(AC.end_date   -(1/84600),sysdate)
AND sysdate BETWEEN ICV.start_date AND NVL(ICV.end_date -(1/84600),sysdate)',
      p_title                  => 'AGIS AME Conditions Used',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no AME conditions defined for the AGIS batches.',
      p_solution               => 'Please refer the following technical brief which explains on AME conditions definition.<br>
[1371982.1] Approvals Management Engine (AME) Usage and Setup in AGIS <br>',
      p_success_msg            => 'This sections gives all the AME conditions defined for the AGIS batches.<br>
Please refer the following technical brief which explains on AME conditions definition.<br>
[1371982.1] Approvals Management Engine (AME) Usage and Setup in AGIS <br>',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_AME_CONDITIONS');



debug('begin add_signature: AGIS_AME_AT');
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8892',
      p_sig_id                 => 'AGIS_AME_AT',
      p_sig_sql                => 'SELECT AATC.Application_id,
AATV.Action_Type_ID,
AATV.name,
--AATV.USER_ACTION_TYPE_NAME,
AATV.Description,
FL_RT.Meaning Rule_Type,
AATC.Order_Number,
FL_OM.Meaning Ordering,
FL_VR.Meaning Voting_Method
FROM AME_Action_Type_Config AATC,
AME_Action_Types AATV,
--AME_Action_Types_VL AATV,
AME_Action_Type_Usages AATU,
(SELECT lookup_code,
Meaning
...
FROM fnd_lookup_values
--fnd_lookups
WHERE Lookup_type = ''AME_ACT_RULE_TYPE''
and language =''US''
)FL_RT,
(SELECT lookup_code,
Meaning
...
WHERE AATC.Action_Type_Id = AATV.Action_Type_Id
AND AATC.Action_Type_Id = AATU.Action_Type_Id
AND AATV.Action_Type_Id = AATU.Action_Type_Id
AND AATC.application_id IN
(SELECT application_Id FROM ame_Calling_Apps WHERE fnd_Application_Id = 435
)
AND FL_VR.Lookup_code(+) = AATC.Voting_Regime
AND FL_RT.Lookup_code(+) = AATU.Rule_Type
AND FL_OM.Lookup_code(+) = AATC.CHAIN_ORDERING_MODE
AND sysdate BETWEEN AATC.start_date AND NVL(AATC.end_date -(1/84600),sysdate)
AND sysdate BETWEEN AATV.start_date AND NVL(AATV.end_date -(1/84600),sysdate)
AND sysdate BETWEEN AATU.start_date AND NVL(AATU.end_date -(1/84600),sysdate)
ORDER BY AATC.Order_number',
      p_title                  => 'AME AGIS Action Types',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no Action Types defined for the AGIS transactions.',
      p_solution               => 'Please refer the following technical brief:<br>
[1371982.1] Approvals Management Engine (AME) Usage and Setup in AGIS <br>
<br>
Please check the following notes on few known issues:<br>
[2219545.1] What are all AME Action types are supporting AME Self approval? <br>	
',
      p_success_msg            => 'This sections gives all the action types defined for the AGIS transactions.<br>
Please refer the following technical brief:<br>
[1371982.1] Approvals Management Engine (AME) Usage and Setup in AGIS <br>
<br>
Please check the following notes on few known issues:<br>
[2219545.1] What are all AME Action types are supporting AME Self approval? <br>	
',
   ...
   l_info.delete;
debug('end add_signature: AGIS_AME_AT');



debug('begin add_signature: AGIS_AME_AG');
   l_info('##MASK##DESCRIPTION'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##USER_APPROVAL_GROUP_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8893',
      p_sig_id                 => 'AGIS_AME_AG',
      p_sig_sql                => 'SELECT *
FROM
...
ApproverGroupEO.NAME USER_APPROVAL_GROUP_NAME,
...
FROM AME_APPROVAL_GROUPS ApproverGroupEO,
AME_APPROVAL_GROUP_CONFIG ApproverGroupConfigEO,
FND_LOOKUP_VALUES QryLookup,
FND_LOOKUP_VALUES VotingLookup
...
AND ApproverGroupConfigEO.APPLICATION_ID IN
( SELECT application_Id FROM ame_Calling_Apps WHERE fnd_Application_Id = 435
)
) QRSLT
ORDER BY ORDER_NUMBER',
      p_title                  => 'AME AGIS Approval Groups',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no Approval groups defined in the system for AGIS transactions.',
      p_solution               => 'Refer following technical brief for complete details:<br>
[1371982.1] Approvals Management Engine (AME) Usage and Setup in AGIS
',
      p_success_msg            => 'This section displays all the Approval groups defined in the system for AGIS transactions.<br>
Refer following technical brief for complete details:<br>
[1371982.1] Approvals Management Engine (AME) Usage and Setup in AGIS',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_AME_AG');



debug('begin add_signature: AGIS_INTERFACE_BATCHES');
   l_info('##MASK##INITIATOR_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRX_TYPE_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5683',
      p_sig_id                 => 'AGIS_INTERFACE_BATCHES',
      p_sig_sql                => 'SELECT   b.*
FROM fun_interface_batches b
WHERE from_ledger_id = ##$$LEDGER_ID$$##
--and nvl(import_status_code,'' '') in (''R'', ''A'')',
      p_title                  => 'Interface Batches -  FUN_INTERFACE_BATCHES',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are records in Interface tables.
',
      p_solution               => 'The system is not automatically deleting successful imported rows (status A = Accepted) nor rejected rows (status R = Rejected).<br>
To delete the rejected AGIS transactions stuck in the fun interface tables, please submit the "Purge Rejected Intercompany Transactions Program".<br>
See [749620.1] How To Delete The Data Existing In FUN_INTERFACE_BATCHES Tables? 
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_INTERFACE_BATCHES');



debug('begin add_signature: AGIS_INTERFACE_HEADERS');
   l_info('##MASK##RECIPIENT_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRX_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5730',
      p_sig_id                 => 'AGIS_INTERFACE_HEADERS',
      p_sig_sql                => 'select b.batch_id, b.batch_number, h.* 
from fun_interface_batches b,
     fun_interface_headers h
where b.from_ledger_id = ##$$LEDGER_ID$$##
and b.batch_id=h.batch_id
order by b.batch_id, h.trx_id',
      p_title                  => 'Interface Headers - FUN_INTERFACE_HEADERS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Interface Headers details',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_INTERFACE_HEADERS');



debug('begin add_signature: AGIS_INTERFACE_DISTRIBUTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5731',
      p_sig_id                 => 'AGIS_INTERFACE_DISTRIBUTIONS',
      p_sig_sql                => 'select b.batch_id, b.batch_number, d.* 
from fun_interface_dist_lines d,
fun_interface_batches b,
fun_interface_headers h
where b.from_ledger_id = ##$$LEDGER_ID$$##
and b.batch_id=h.batch_id
and d.trx_id=h.trx_id
order by d.trx_id, d.dist_id',
      p_title                  => 'Interface Distributions and Lines details - FUN_INTERFACE_DIST_LINES',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Interface Distributions and Lines',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_INTERFACE_DISTRIBUTIONS');



debug('begin add_signature: AGIS_INTERFACE_CONTROLS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5797',
      p_sig_id                 => 'AGIS_INTERFACE_CONTROLS',
      p_sig_sql                => 'select c.* 
from FUN_INTERFACE_CONTROLS c',
      p_title                  => 'Interface Controls - FUN_INTERFACE_CONTROLS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Interface Controls Details',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_INTERFACE_CONTROLS');



debug('begin add_signature: EBS_FIN_FUNAGIS_DUPLICATE_FUN_DIST_IDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '28239',
      p_sig_id                 => 'EBS_FIN_FUNAGIS_DUPLICATE_FUN_DIST_IDS',
      p_sig_sql                => 'select dist_id,count(*)
from fun_interface_dist_lines
group by dist_id
having count(dist_id) >1',
      p_title                  => 'Duplicate FUN Distribution ID',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are duplicate distribution id exists in the FUN_INTERFACE_DIST_LINES table.',
      p_solution               => 'Please refer to [2075214.1] FUNXIMPB Intercompany Import Program Error: FND_API.G_EXC_UNEXPECTED_ERROR and ORA-01422 to help resolve this issue.
',
      p_success_msg            => 'No duplicate distribution id exists in the FUN_INTERFACE_DIST_LINES table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FUNAGIS_DUPLICATE_FUN_DIST_IDS');



debug('begin add_signature: AGIS_TABLES_AND_VIEWS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5680',
      p_sig_id                 => 'AGIS_TABLES_AND_VIEWS',
      p_sig_sql                => 'select o.owner, substr(o.object_name,1,50) "OBJECT_NANE                   ",o.object_type,o.status "STATUS                       "
from dba_objects o
where o.object_type in( ''TABLE'' ,''VIEW'')
and o.object_name like ''FUN_%''
and o.owner in (''FUN'',''APPS'')
order by o.object_type, o.object_name',
      p_title                  => 'FUN Tables and Views',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No FUN Tables and Views',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_TABLES_AND_VIEWS');



debug('begin add_signature: AGIS PACKAGE DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5485',
      p_sig_id                 => 'AGIS PACKAGE DETAILS',
      p_sig_sql                => 'SELECT name ,type Object_type,
...
order by name',
      p_title                  => 'PLSQL Package Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No package file versions found.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AGIS PACKAGE DETAILS');



debug('begin add_signature: AGIS_SQL_VERSION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5667',
      p_sig_id                 => 'AGIS_SQL_VERSION',
...
from ad_files
where app_short_name=''FUN'' and upper(filename) like upper(''%.sql'')
) files
where files.file_id = file_version.file_id
) que
where rank1 = 1
order by 1,2',
      p_title                  => 'SQL versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'SQL file versions',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_SQL_VERSION');



debug('begin add_signature: AGIS_PLS_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5671',
      p_sig_id                 => 'AGIS_PLS_VERSIONS',
      p_sig_sql                => 'select que.subdir,que.filename, que.version
from (
select files.filename filename,files.subdir subdir,
file_version.version version,
...
select filename, app_short_name, subdir, file_id
from ad_files
where app_short_name=''FUN'' and upper(filename) like upper(''%.pls'')
) files
where files.file_id = file_version.file_id
) que
where rank1 = 1
order by 2',
      p_title                  => 'PLS files versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'PLS file versions',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_PLS_VERSIONS');



debug('begin add_signature: AGIS_JAVA_FILES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5663',
      p_sig_id                 => 'AGIS_JAVA_FILES',
      p_sig_sql                => 'select que.subdir,que.filename, que.version
from (
select files.filename filename,files.subdir subdir,
file_version.version version,
...
select filename, app_short_name, subdir, file_id
from ad_files
where app_short_name=''FUN'' and upper(filename) like upper(''%.class'')
) files
where files.file_id = file_version.file_id
) que
where rank1 = 1
order by 1,2',
      p_title                  => 'Java Class Files',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Java Class Files',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_JAVA_FILES');



debug('begin add_signature: AGIS_REPORTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5665',
      p_sig_id                 => 'AGIS_REPORTS',
      p_sig_sql                => 'select que.subdir,que.filename, que.version
from (
select files.filename filename,files.subdir subdir,
file_version.version version,
...
select filename, app_short_name, subdir, file_id
from ad_files
where app_short_name=''FUN'' and upper(filename) like upper(''%.rdf'') and subdir like ''rep%US''
) files
where files.file_id = file_version.file_id
) que
where rank1 = 1
order by 1,2',
   ...
   l_info.delete;
debug('end add_signature: AGIS_REPORTS');



debug('begin add_signature: AGIS_OTHER_FILE_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5612',
      p_sig_id                 => 'AGIS_OTHER_FILE_VERSIONS',
      p_sig_sql                => 'select que.subdir,que.filename, que.version
from (
select files.filename filename,files.subdir subdir,
file_version.version version,
...
select filename, app_short_name, subdir, file_id
from ad_files
where app_short_name=''FUN'' 
and subdir not like ''admin%''
and subdir not like ''help%''
and subdir not like ''%driver%''
and subdir not like ''%readme%''
and substr(subdir, instr(subdir, ''/'', -1)+1) not in (select language_code
from fnd_languages
where installed_flag <> ''B'')
and 1=1--upper(filename) like upper(''%.class'')
and upper(filename) not like upper(''%.class'')
and upper(filename) not like upper(''%.pls'')
and upper(filename) not like upper(''%.sql'')
and upper(filename) not like upper(''%.ldt'')
and upper(filename) not like upper(''%.txt'')
and upper(filename) not like upper(''%.a'')
and upper(filename) not like upper(''%.gif'')
and upper(filename) not like upper(''%.htm'')
and upper(filename) not like upper(''%.html'')
) files
where files.file_id = file_version.file_id
) que
where rank1 = 1
order by 1,2',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Other Fun files versions.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_OTHER_FILE_VERSIONS');



debug('begin add_signature: EBS_FIN_CUSTOM_TABLE_INDEXES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30343',
      p_sig_id                 => 'EBS_FIN_CUSTOM_TABLE_INDEXES',
    ...
    AND fa.application_id in  ( 101, 168, 435)
...
For assistance, see the following <a href="https://docs.oracle.com/cd/B14117_01/server.101/b10759/statements_1008.htm" target="_blank">Oracle documentation</a>',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_CUSTOM_TABLE_INDEXES');



debug('begin add_signature: EBS_FIN_INVALID_TABLE_INDEXES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30344',
      p_sig_id                 => 'EBS_FIN_INVALID_TABLE_INDEXES',
      p_sig_sql                => 'SELECT iu.name table_owner,
           io.name table_name,
           o.name index_name,
           decode(bitand(i.property, 16), 0, '''', ''FUNCTION-BASED '') ||
...
',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_INVALID_TABLE_INDEXES');



debug('begin add_signature: EBS_FIN_CUSTOM_DB_TRIGGERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30345',
      p_sig_id                 => 'EBS_FIN_CUSTOM_DB_TRIGGERS',
...
WHERE fa.application_id in ( 101, 168, 435)
...
For assistance, see the following <a href="https://docs.oracle.com/cd/B28359_01/server.111/b28310/general004.htm" target="_blank">Oracle documentation</a>',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_CUSTOM_DB_TRIGGERS');
...
debug('begin add_signature: AGIS_WF_CHILD_PROCESSES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5823',
      p_sig_id                 => 'AGIS_WF_CHILD_PROCESSES',
      p_sig_sql                => 'select  ITEM_TYPE,
        item_key,
       -- INST_ID,
        PARENT_ITEM_TYPE,
        PARENT_ITEM_KEY,
        ...
        OWNER_ROLE
from    wf_items
where   parent_item_type = ''##$$FK3$$##''
and     parent_item_key = ''##$$FK4$$##''',
      p_title                  => 'WFSTAT - Child processes',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No WF Child processes found for the combination of Item Type / Item Key.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_WF_CHILD_PROCESSES');



debug('begin add_signature: AGIS_WF_ACTIVITY_STATUSES');
   l_info('##MASK##ASSIGNED_USER'):= 'DISPLAY_FIRST_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5720',
      p_sig_id                 => 'AGIS_WF_ACTIVITY_STATUSES',
      p_sig_sql                => 'select  --ias.inst_id,
pa.activity_name,
substr(ias.error_message,1,200) "Error",
...
where   ias.item_type =''##$$FK3$$##''
and     ias.item_key  =''##$$FK4$$##''
...
order by ias.begin_date, ias.execution_time',
      p_title                  => 'WFSTAT - Activity Statuses',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No WF Activity Statuses found for the combination of Item Type / Item Key',
      p_solution               => 'Refer to [1525154.1] AGIS: Debugging Steps for AGIS Workflow Issues',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_WF_ACTIVITY_STATUSES');



debug('begin add_signature: AGIS_WF_ACTIVITY STATUSES HISTORY');
   l_info('##MASK##ASSIGNED_USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5721',
      p_sig_id                 => 'AGIS_WF_ACTIVITY STATUSES HISTORY',
      p_sig_sql                => 'select  --ias.inst_id,
        to_char(ias.begin_date,''DD-MON-RR HH24:MI:SS'') begin_date,
        ap.name||''/''||pa.instance_label Activity,
        ias.activity_status Status,
...
and     ntf.notification_id(+)  = ias.notification_id
order by ias.begin_date, ias.execution_time',
      p_title                  => 'WFSTAT - Activity Statuses History',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'WF Activity Status History found for the combination of Item Type / Item Key',
      p_solution               => '',
      p_success_msg            => 'No WF Activity Status History found for the combination of Item Type / Item Key',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_WF_ACTIVITY STATUSES HISTORY');



debug('begin add_signature: AGIS_WF_NOTIFICATIONS_CLOSED');
  ...
  add_signature(
      p_sig_repo_id            => '5722',
      p_sig_id                 => 'AGIS_WF_NOTIFICATIONS_CLOSED',
      p_sig_sql                => 'select  wn.notification_id nid, 
        wn.context, 
        wn.group_id, 
        wn.status, 
        wn.mail_status, 
...
and  wias.item_type =''##$$FK3$$##''
and  wias.item_key  =''##$$FK4$$##''',
      p_title                  => 'Worflow Closed Notifications',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Workflow Closed Notifications.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_WF_NOTIFICATIONS_CLOSED');



debug('begin add_signature: AGIS_WF_NOTIFICATION_OPEN');
   l_info('##MASK##FROM_USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SUBJECT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TO_USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5839',
      p_sig_id                 => 'AGIS_WF_NOTIFICATION_OPEN',
      p_sig_sql                => 'select  wn.notification_id nid, 
        wn.context, 
        wn.group_id, 
        wn.status, 
...
and  wias.item_type =''##$$FK3$$##''
and  wias.item_key  =''##$$FK4$$##''',
      p_title                  => 'Workflow Open Notifications',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are open notifications having issues. ',
      p_solution               => 'For MESSAGE_NAME =''ERROR_GENERATING_ACCTS'', please follow
[1332026.1] AGIS - Intercompany Errors With "Transaction 1 Encountered Errors Deriving Intercompany Accounts".<br>
For MESSAGE_NAME =''FIX_ACCT_DIST_MSG'', please follow [1057959.1] - AGIS Transaction Accounting Distribution Errors With ORA-01403 Error name 100 Error Stack FUNRMAIN Has No Performer.<br>',
      p_success_msg            => 'No Open notifications.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_WF_NOTIFICATION_OPEN');



debug('begin add_signature: AGIS_WF_ERRORED_ACTIVITIES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5723',
      p_sig_id                 => 'AGIS_WF_ERRORED_ACTIVITIES',
      p_sig_sql                => 'select  ac.name Activity,
        ias.activity_result_code Result,
...
and     i.begin_date            < nvl(ac.end_date, i.begin_date+1)
order by ias.begin_date, ias.execution_time',
      p_title                  => 'WFSTAT - Errored Activities',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Errored Activities found for the combination of Item Type / Item Key',
      p_solution               => 'Please review [1525154.1] AGIS: Debugging Steps for AGIS Workflow Issues.',
      p_success_msg            => 'No Errored Activities found for the combination of Item Type / Item Key',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_WF_ERRORED_ACTIVITIES');



debug('begin add_signature: AGIS_WF_ERROR_PROCESS_ACTIVITY_STATUSES');
   l_info('##MASK##ASSIGNED_USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5824',
      p_sig_id                 => 'AGIS_WF_ERROR_PROCESS_ACTIVITY_STATUSES',
      p_sig_sql                => 'select  to_char(ias.begin_date,''DD-MON-RR HH24:MI:SS'') begin_date,
        ap.name||''/''||pa.instance_label Activity,
        ias.activity_status Status,
        ias.activity_result_code Result,
        ias.assigned_user assigned_user,
...
and     pa.process_item_type    = ap.item_type
and     pa.process_version      = ap.version
and     i.parent_item_type      = ''##$$FK3$$##''
and     i.parent_item_key       = ''##$$FK4$$##''
and     i.begin_date            >= ac.begin_date 
and     i.begin_date            < nvl(ac.end_date, i.begin_date+1)
and     ntf.notification_id(+)  = ias.notification_id
order by ias.begin_date, ias.execution_time',
      p_title                  => 'WFSTAT - Error Process Activity Statuses',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Error Process Activity Statuses found for the combination of Item Type / Item Key.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_WF_ERROR_PROCESS_ACTIVITY_STATUSES');



debug('begin add_signature: AGIS_WF_ERROR_PROCESS_ACTIVITY_STATUSES_HISTORY');
   l_info('##MASK##ASSIGNED_USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5825',
      p_sig_id                 => 'AGIS_WF_ERROR_PROCESS_ACTIVITY_STATUSES_HISTORY',
      p_sig_sql                => 'select  to_char(ias.begin_date,''DD-MON-RR HH24:MI:SS'') begin_date,
        ap.name||''/''||pa.instance_label Activity,
        ias.activity_status Status,
        ias.activity_result_code Result,
...
and     ntf.notification_id(+)  = ias.notification_id
order by ias.begin_date, ias.execution_time',
      p_title                  => 'WFSTAT - Error Process Activity Statuses History',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Error Process Activity Statuses History found for the combination of Item Type / Item Key',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_WF_ERROR_PROCESS_ACTIVITY_STATUSES_HISTORY');



debug('begin add_signature: AGIS_WF_ERROR_PROCESS_ERRORED_ACTIVITIES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5826',
      p_sig_id                 => 'AGIS_WF_ERROR_PROCESS_ERRORED_ACTIVITIES',
      p_sig_sql                => 'select  ac.name Activity,
        ias.activity_result_code Result,
	ias.error_name ERROR_NAME, 
	ias.error_message ERROR_MESSAGE,
...
order by ias.execution_time',
      p_title                  => 'WFSTAT - Error Process Errored Activities',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Error Process Errored Activities found for the combination of Item Type / Item Key',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_WF_ERROR_PROCESS_ERRORED_ACTIVITIES');



debug('begin add_signature: AGIS_WF_ITEM_ATRIBUTE_VALUES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5787',
      p_sig_id                 => 'AGIS_WF_ITEM_ATRIBUTE_VALUES',
      p_sig_sql                => 'SELECT wiav.name attr_name,
           wia.type value_type,
           nvl(wiav.text_value,
    ...
    WHERE wiav.item_type = ''##$$FK3$$##''
    AND   wiav.item_key = ''##$$FK4$$##''
    AND   wia.item_type(+) = wiav.item_type
    AND   wia.name(+) = wiav.name
    AND   wia.type(+) <> ''EVENT''',
      p_title                  => 'WFSTAT - Item Atribute Values',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Item Attribute Values found for the combination of Item Type / Item Key',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_WF_ITEM_ATRIBUTE_VALUES');



debug('begin add_signature: AGIS_WF_EVENT_DATATYPE_ITEM_ATTRIBUTE_VALUES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5827',
      p_sig_id                 => 'AGIS_WF_EVENT_DATATYPE_ITEM_ATTRIBUTE_VALUES',
      p_sig_sql                => 'SELECT wiav.name attr_name,
-- wiav.event_value value ,
...
and     wia.name       = wiav.name
and     wia.type       = ''EVENT''',
      p_title                  => 'WFSTAT - Event Datatype Item Attribute Values',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Item Attribute Values found for the combination of Item Type / Item Key',
      p_solution               => '',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: AGIS_WF_EVENT_DATATYPE_ITEM_ATTRIBUTE_VALUES');



debug('begin add_signature: AGIS_WFSTAT_FOR_BATCH');
   l_info('##MASK##TRX_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5786',
      p_sig_id                 => 'AGIS_WFSTAT_FOR_BATCH',
      p_sig_sql                => 'SELECT DISTINCT wi.ITEM_TYPE,
  wi.item_key,
  b.batch_id,
  b.batch_number,
...
AND wi.item_key LIKE to_char(b.batch_id) ||''%''
  --and h.reci_wf_key= wi.item_key
  --and h.reci_wf_key=''48059_6344542008B08673620E1BE0535609DC0ADE52''
and wi.item_type = ''FUNRMAIN''
order by  wi.item_key',
      p_title                  => 'WFSTAT - Batch Items',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Item type and Item key identified for the batch_number provided.<br>
',
      p_solution               => 'The commonly encountered AGIS workflow issues are mainly due to customer specific setup data and requires user intervention to resolve the issue.<br>
Useful documentation:<br>
[785167.1] Advanced Global Intercompany Troubleshooting AGIS Workflow Technical Brief.<br>
[418649.1] Advanced Global Intercompany (AGIS) in Release 12 (R12) - Setup, Transaction Processing and Reports.',
      p_success_msg            => 'Item type and Item key for the batch_number provided.<br>
Useful documentation:<br>
[785167.1] Advanced Global Intercompany Troubleshooting AGIS Workflow Technical Brief.<br>
[418649.1] Advanced Global Intercompany (AGIS) in Release 12 (R12) - Setup, Transaction Processing and Reports.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      ...
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('AGIS_WF_CHILD_PROCESSES','AGIS_WF_ACTIVITY_STATUSES','AGIS_WF_ACTIVITY STATUSES HISTORY','AGIS_WF_NOTIFICATIONS_CLOSED','AGIS_WF_NOTIFICATION_OPEN','AGIS_WF_ERRORED_ACTIVITIES','AGIS_WF_ERROR_PROCESS_ACTIVITY_STATUSES','AGIS_WF_ERROR_PROCESS_ACTIVITY_STATUSES_HISTORY','AGIS_WF_ERROR_PROCESS_ERRORED_ACTIVITIES','AGIS_WF_ITEM_ATRIBUTE_VALUES','AGIS_WF_EVENT_DATATYPE_ITEM_ATTRIBUTE_VALUES'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '39'
      );
   l_info.delete;
debug('end add_signature: AGIS_WFSTAT_FOR_BATCH');



debug('begin add_signature: AGIS_WF_ITEMS_IN_ERROR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5784',
      p_sig_id                 => 'AGIS_WF_ITEMS_IN_ERROR',
      p_sig_sql                => 'SELECT DISTINCT 
  p.process_item_type,
  wi.item_key,
  p.activity_name,
  s.activity_result_code result_code,
  s.error_name error_name,
  --s.error_message error_message,
  substr(s.error_message,1,200) error_message,
  s.error_stack error_stack,
  s.begin_date,
  s.notification_id,
  s.begin_date
...
and p.process_item_type like ''FUN%''
ORDER BY p.process_item_type,p.activity_name, wi.item_key',
      p_title                  => 'Workflow items with error',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Workflow Items with activity_status ''ERROR'' identified.',
      p_solution               => 'Please follow steps from [1525154.1] AGIS: Debugging Steps for AGIS Workflow Issues.',
      p_success_msg            => 'No workflow items in error.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_WF_ITEMS_IN_ERROR');



debug('begin add_signature: AGIS_WF_OPEN_NOTIFICATIONS');
   l_info('##MASK##FROM_USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##SUBJECT'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TO_USER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5785',
      p_sig_id                 => 'AGIS_WF_OPEN_NOTIFICATIONS',
      p_sig_sql                => 'SELECT wn.notification_id ,
  wias.item_type,
  wias.item_key,
  wn.context,
  wn.group_id,
...
WHERE wn.group_id = wias.notification_id
AND wias.item_type LIKE ''FUN%''
AND wn.status           <>''CLOSED''
AND wn.message_name NOT IN (''APPROVAL_MSG'')
  -- and   wias.item_key  like ''48059%''
AND wn.begin_date>=sysdate-90',
      p_title                  => 'Opened Notifications',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Stuck notifications identified.',
      p_solution               => 'Please review [1525154.1] AGIS: Debugging Steps for AGIS Workflow Issues.',
      p_success_msg            => 'No notifications in error.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_WF_OPEN_NOTIFICATIONS');



debug('begin add_signature: AGIS_TRX_FOR_BATCHE_NO');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5684',
      p_sig_id                 => 'AGIS_TRX_FOR_BATCHE_NO',
      p_sig_sql                => 'select b.batch_id "##$$FK1$$##", b.*
from fun_trx_batches b 
where BATCH_NUMBER  = nvl(''##$$BATCH_NUMBER$$##'',''NO BATCH'')',
      p_title                  => 'Batch Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No details for batch number provided.',
      p_solution               => 'Verify that the batch number exists.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_TRX_FOR_BATCHE_NO');



debug('begin add_signature: AGIS_TRX_NEW_B');
   l_info('##MASK##AR_INVOICE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRX_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5809',
      p_sig_id                 => 'AGIS_TRX_NEW_B',
      p_sig_sql                => 'select h.trx_id "##$$FK2$$##",b.batch_number, b.status BATCH_STATUS, h.*
from fun_trx_batches b ,
fun_trx_headers h
where b.batch_id=h.batch_id
and h.status in (''NEW'')
and b.batch_number  = nvl(''##$$BATCH_NUMBER$$##'',''NO BATCH'')
order by b.batch_id,h.trx_id',
      p_title                  => 'Transaction Header Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transaction header with status NEW.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_TRX_NEW_B');



debug('begin add_signature: AGIS_TRX_COMPLETE_B');
   l_info('##MASK##AR_INVOICE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRX_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5810',
      p_sig_id                 => 'AGIS_TRX_COMPLETE_B',
      p_sig_sql                => 'select h.trx_id "##$$FK2$$##",b.batch_number, b.status BATCH_STATUS, h.*
from fun_trx_batches b ,
fun_trx_headers h
where b.batch_id=h.batch_id
and h.status in (''COMPLETE'')
and b.batch_number  = nvl(''##$$BATCH_NUMBER$$##'',''NO BATCH'')
order by b.batch_id,h.trx_id',
      p_title                  => 'Transaction Header Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transaction header with status COMPLETE.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_TRX_COMPLETE_B');



debug('begin add_signature: AGIS_TRX_REVERSED_B');
   l_info('##MASK##AR_INVOICE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRX_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5804',
      p_sig_id                 => 'AGIS_TRX_REVERSED_B',
      p_sig_sql                => 'select h.trx_id "##$$FK2$$##" , b.batch_number, b.status BATCH_STATUS, h.*
from fun_trx_batches b ,
fun_trx_headers h
where b.batch_id=h.batch_id
...
order by b.batch_id,h.trx_id',
      p_title                  => 'Transaction Header Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transaction header with status REVERSED.',
      p_solution               => 'This transaction was reversed and the transaction id of the reversed transaction is stored in fun_trx_headers.reversed_trx_id.<br>
See [2064399.1] Reverse Button Is Greyed Out In AGIS Outbound: Not Able to Reverse An AGIS Batch.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_TRX_REVERSED_B');



debug('begin add_signature: AGIS_TRX_REJECTED_B');
   l_info('##MASK##AR_INVOICE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRX_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5805',
      p_sig_id                 => 'AGIS_TRX_REJECTED_B',
      p_sig_sql                => 'select h.trx_id "##$$FK2$$##" , b.batch_number, b.status BATCH_STATUS, h.*
from fun_trx_batches b ,
fun_trx_headers h
where b.batch_id=h.batch_id
...
order by b.batch_id,h.trx_id',
      p_title                  => 'Transaction Header Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transaction header with status REJECTED',
      p_solution               => 'This transaction was rejected by the approval.<br>
Please see [1286564.1] How the Status Field gets Populated in the Table FUN_TRX_HEADERS?',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_TRX_REJECTED_B');



debug('begin add_signature: AGIS_TRX_APPROVED_B');
   l_info('##MASK##AR_INVOICE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRX_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5806',
      p_sig_id                 => 'AGIS_TRX_APPROVED_B',
      p_sig_sql                => 'select h.trx_id "##$$FK2$$##" , b.batch_number, b.status BATCH_STATUS, h.*
from fun_trx_batches b ,
fun_trx_headers h
where b.batch_id=h.batch_id
...
order by b.batch_id,h.trx_id',
      p_title                  => 'Transaction Header Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transaction with status APPROVED',
      p_solution               => 'Please submit the ''Transfer Intercompany Transactions to Receivables'' (invoice required) or Transfer intercompany transactions to general ledger (invoice not required).<br>
See also:<br>
[1538364.1] AGIS: Approved Transactions (Online Mode) are not Passed to AR, AP Interfaces<br>
[1588964.1] AGIS Approved Transactions Are Not Getting Transferred to Receivables
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_TRX_APPROVED_B');



debug('begin add_signature: AGIS_TRX_ERROR_B');
   l_info('##MASK##AR_INVOICE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRX_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5799',
      p_sig_id                 => 'AGIS_TRX_ERROR_B',
      p_sig_sql                => 'select h.trx_id "##$$FK2$$##" , b.batch_number, b.status BATCH_STATUS, h.*
from fun_trx_batches b ,
fun_trx_headers h
where b.batch_id=h.batch_id
...
order by b.batch_id,h.trx_id',
      p_title                  => 'Transaction Header Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transaction header with status ERROR',
      p_solution               => 'Please review:
[1525154.1] AGIS: Debugging Steps for AGIS Workflow Issues.<br>
[813397.1] How To Troubleshoot AGIS Accounting ',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_TRX_ERROR_B');



debug('begin add_signature: AGIS_TRX_RECEIVED_B');
   l_info('##MASK##AR_INVOICE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRX_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5800',
      p_sig_id                 => 'AGIS_TRX_RECEIVED_B',
      p_sig_sql                => 'select h.trx_id "##$$FK2$$##" , b.batch_number, b.status BATCH_STATUS, h.*
from fun_trx_batches b ,
fun_trx_headers h
where b.batch_id=h.batch_id
...
order by b.batch_id,h.trx_id',
      p_title                  => 'Transaction Header Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transaction header with status RECEIVED',
      p_solution               => 'Please review:
[1295352.1] AGIS: Inbound "Update Transaction" Button Greyed Out, but Batch is in Status "Received"<br> 
[1558224.1] Status  Of Intercompany Batch(AGIS) Remains In ''Submitted'' When Few  Transactions In The Batch Are In ''Received'' Status And Few Transactions  Are In ''Complete'' Status.<br>
[1571283.1] AGIS: The Batch Is Not Getting Approved. It Is in ''RECEIVED'' Status Only.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_TRX_RECEIVED_B');



debug('begin add_signature: AGIS_TRX_XFER_INI_GL_B');
   l_info('##MASK##AR_INVOICE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRX_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5803',
      p_sig_id                 => 'AGIS_TRX_XFER_INI_GL_B',
      p_sig_sql                => 'select h.trx_id "##$$FK2$$##",b.batch_number, b.status BATCH_STATUS, h.*
from fun_trx_batches b ,
fun_trx_headers h
where b.batch_id=h.batch_id
and h.status = ''XFER_INI_GL''
and b.batch_number  = nvl(''##$$BATCH_NUMBER$$##'',''NO BATCH'')
order by b.batch_id,h.trx_id',
      p_title                  => 'Transaction Header Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transaction header with status XFER_INI_GL.',
      p_solution               => 'Please check section "How to reflect the status XFER_INI_GL and XFER_RECI_GL in FUN_TRX_HEADERS" from [975235.1] FAQ for AGIS (Advanced Global Intercompany Systems).
...
',
   ...
   l_info.delete;
debug('end add_signature: AGIS_TRX_XFER_INI_GL_B');



debug('begin add_signature: AGIS_TRX_XFER_RECI_GL_B');
   l_info('##MASK##AR_INVOICE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRX_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5802',
      p_sig_id                 => 'AGIS_TRX_XFER_RECI_GL_B',
      p_sig_sql                => 'select h.trx_id "##$$FK2$$##",b.batch_number, b.status BATCH_STATUS, h.*
from fun_trx_batches b ,
fun_trx_headers h
where b.batch_id=h.batch_id
and h.status = ''XFER_RECI_GL''
and b.batch_number  = nvl(''##$$BATCH_NUMBER$$##'',''NO BATCH'')
order by b.batch_id,h.trx_id',
      p_title                  => 'Transaction Header Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transaction header with status  XFER_RECI_GL',
      p_solution               => 'Please check section "How to reflect the status XFER_INI_GL and XFER_RECI_GL in FUN_TRX_HEADERS" from [975235.1] FAQ for AGIS (Advanced Global Intercompany Systems).
...
',
   ...
   l_info.delete;
debug('end add_signature: AGIS_TRX_XFER_RECI_GL_B');



debug('begin add_signature: AGIS_TRX_XFER_AP_B');
   l_info('##MASK##AR_INVOICE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRX_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5807',
      p_sig_id                 => 'AGIS_TRX_XFER_AP_B',
      p_sig_sql                => 'select h.trx_id "##$$FK2$$##",b.batch_number, b.status BATCH_STATUS, h.*
from fun_trx_batches b ,
fun_trx_headers h
where b.batch_id=h.batch_id
and h.status = ''XFER_AP''
and b.batch_number  = nvl(''##$$BATCH_NUMBER$$##'',''NO BATCH'')
order by b.batch_id,h.trx_id',
      p_title                  => 'Transaction Header Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transaction header with status XFER_AP',
      p_solution               => 'Please check whether the period is closed in AP and open it.<br>
If the period cannot be opened, follow [1955766.1] How To Process An AGIS Batch When Receivables/Payables Period is Already Closed.
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_TRX_XFER_AP_B');



debug('begin add_signature: EBS_FIN_CX_FUNAGIS_AP_INV_DIST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22548',
      p_sig_id                 => 'EBS_FIN_CX_FUNAGIS_AP_INV_DIST',
      p_sig_sql                => 'SELECT
    aida.invoice_id
    , aida.invoice_line_number
    , aida.distribution_line_number
    , aida.line_type_lookup_code   distribution_type
...
WHERE
    aida.invoice_id = ##$$FK2$$##
    AND aida.invoice_line_number = ##$$FK3$$##
    AND aida.dist_code_combination_id = gcc.code_combination_id
ORDER BY
    aida.invoice_id
    , aida.invoice_line_number',
      p_title                  => 'AP Invoice Distributions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This provided AP Invoice distributions details for the selected AGIS batch number.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_CX_FUNAGIS_AP_INV_DIST');



debug('begin add_signature: EBS_FIN_FUNAGIS_AP_INV_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22549',
      p_sig_id                 => 'EBS_FIN_FUNAGIS_AP_INV_LINES',
      p_sig_sql                => 'SELECT
    aila.invoice_id "##$$FK2$$##"
    ,aila.line_number "##$$FK3$$##"
    ,aila.invoice_id
    ,aila.line_number
...
ORDER BY
    aila.invoice_id
    , aila.line_number',
      p_title                  => 'AP Invoice Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This provided AP Invoice Lines details for the selected AGIS batch number.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      ...
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('EBS_FIN_CX_FUNAGIS_AP_INV_DIST'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '5'
      );
   l_info.delete;
debug('end add_signature: EBS_FIN_FUNAGIS_AP_INV_LINES');



debug('begin add_signature: EBS_FIN_FUNAGIS_AP_INV_HDRS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22550',
      p_sig_id                 => 'EBS_FIN_FUNAGIS_AP_INV_HDRS',
      p_sig_sql                => 'SELECT 
aia.invoice_id "##$$FK1$$##"
    , aia.invoice_id
    ,aia.invoice_num
...
WHERE
    ...
    AND aia.invoice_id IN (
        ...
        WHERE
            ...
            AND rct.interface_header_attribute1 = ftb.batch_id
            AND ftb.batch_number =  nvl(''##$$BATCH_NUMBER$$##'',''NO BATCH'') 
            AND ftb.from_ledger_id = ##$$LEDGER_ID$$##
            AND rct.interface_header_attribute2 = fth.trx_id
            AND rct.trx_number = fth.ar_invoice_number
            AND rct.set_of_books_id = ftb.from_ledger_id
            AND aila.source_application_id = 222
            AND aila.source_event_class_code = ''INTERCOMPANY_TRX''
            AND aila.source_entity_code = ''TRANSACTIONS''
            AND aila.source_trx_id = rct.customer_trx_id
            AND aila.source_line_id = rcl.customer_trx_line_id
            AND aila.source_trx_level_type = ''LINE''
    )
ORDER BY
    aia.invoice_num',
      p_title                  => 'AP Invoice Headers',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no AP Invoice Headers details found for the selected AGIS batch number.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      ...
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('EBS_FIN_FUNAGIS_AP_INV_LINES'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '10'
      );
   l_info.delete;
debug('end add_signature: EBS_FIN_FUNAGIS_AP_INV_HDRS');



debug('begin add_signature: AGIS_TRX_XFER_AR_B');
   l_info('##MASK##AR_INVOICE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRX_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5808',
      p_sig_id                 => 'AGIS_TRX_XFER_AR_B',
      p_sig_sql                => 'select h.trx_id "##$$FK2$$##",b.batch_number, b.status BATCH_STATUS, h.*
from fun_trx_batches b ,
fun_trx_headers h
where b.batch_id=h.batch_id
and h.status = ''XFER_AR''
and b.batch_number  = nvl(''##$$BATCH_NUMBER$$##'',''NO BATCH'')
order by b.batch_id,h.trx_id',
      p_title                  => 'Transaction Header Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transaction header with status XFER_AR',
      p_solution               => 'Please check whether the period is closed in AR and if so, open it and resubmit the Transfer Intercompany Transactions to Payables program.<br>
If the period cannot be opened, follow [1955766.1] How To Process An AGIS Batch When Receivables/Payables Period is Already Closed<br>
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_TRX_XFER_AR_B');



debug('begin add_signature: EBS_FIN_FUNAGIS_AR_INV_DIST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22556',
      p_sig_id                 => 'EBS_FIN_FUNAGIS_AR_INV_DIST',
      p_sig_sql                => 'SELECT
    rcg.customer_trx_id
    , rcl.customer_trx_line_id
    , rcl.line_number
    , rcg.cust_trx_line_gl_dist_id
...
FROM
    ...
    , gl_code_combinations_kfv       gcc
WHERE
    rcl.customer_trx_id =  ##$$FK2$$##
    AND  rcl.customer_trx_line_id = ##$$FK3$$##
    AND rcl.customer_trx_line_id = rcg.customer_trx_line_id
    AND gcc.code_combination_id = rcg.code_combination_id
ORDER BY
    rcg.customer_trx_id
    , rcl.line_number
    , rcl.customer_trx_line_id
    , rcg.cust_trx_line_gl_dist_id',
      p_title                  => 'AR Invoice Distributions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This provided AR Invoice distributions details for the selected AGIS batch number.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_FUNAGIS_AR_INV_DIST');



debug('begin add_signature: EBS_FIN_FUNAGIS_AR_INV_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22557',
      p_sig_id                 => 'EBS_FIN_FUNAGIS_AR_INV_LINES',
      p_sig_sql                => 'SELECT
rcl.customer_trx_id "##$$FK2$$##"
    , rcl.customer_trx_line_id "##$$FK3$$##"
    ,rcl.customer_trx_id
    , rcl.customer_trx_line_id
    , rcl.line_type
    , rcl.line_number
...
FROM
    ra_customer_trx_lines_all rcl
WHERE
    rcl.customer_trx_id = ##$$FK1$$##
ORDER BY
    rcl.customer_trx_id
    , rcl.line_number
    , rcl.customer_trx_line_id',
      p_title                  => 'AR Invoice Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This provided AR Invoice Lines details for the selected AGIS batch number.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      ...
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('EBS_FIN_FUNAGIS_AR_INV_DIST'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '1'
      );
   l_info.delete;
debug('end add_signature: EBS_FIN_FUNAGIS_AR_INV_LINES');



debug('begin add_signature: EBS_FIN_FUNAGIS_AR_INV_HDRS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22558',
      p_sig_id                 => 'EBS_FIN_FUNAGIS_AR_INV_HDRS',
      p_sig_sql                => 'SELECT
    rct.customer_trx_id "##$$FK1$$##"
    , rct.customer_trx_id 
...
ORDER BY rct.customer_trx_id 
    , rct.trx_number ',
      p_title                  => 'AR Invoice Headers',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no AR Invoice Header details found for the selected AGIS batch number.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      ...
      p_limit_rows             => nvl('Y','Y'),
      p_extra_info             => l_info,
      p_child_sigs             => VARCHAR_TBL('EBS_FIN_FUNAGIS_AR_INV_LINES'),
      p_include_in_dx_summary  => nvl('P','N'),
      p_version                => '4'
      );
   l_info.delete;
debug('end add_signature: EBS_FIN_FUNAGIS_AR_INV_HDRS');



debug('begin add_signature: AGIS_TRX_SENT_B');
   l_info('##MASK##AR_INVOICE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRX_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5801',
      p_sig_id                 => 'AGIS_TRX_SENT_B',
      p_sig_sql                => 'select h.trx_id "##$$FK2$$##" , b.batch_number, b.status BATCH_STATUS, h.*
from fun_trx_batches b ,
fun_trx_headers h
where b.batch_id=h.batch_id
...
order by b.batch_id,h.trx_id',
      p_title                  => 'Transaction Header Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transaction header with status SENT.',
      p_solution               => 'Please review:
[739949.1] AGIS Outbound Transaction Is Not Getting Populated In Inbound Screen, Status Is Submitted<br>
[1983945.1] AGIS Transactions are Stuck In Approved And Submitted Status transactions will not pass to Receivables<br>
[454668.1] AGIS - Initiator Transaction Status Changes to "Submitted" But The Recipient Cannot View Notification<br>
[1996883.1] AGIS Batches Got Stuck (Status: SENT), Unable to Approve, Reject or Change Accounting; Errors Relate to FUN_RECIPIENT_WF or WF_USER_ROLE.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_TRX_SENT_B');



debug('begin add_signature: AGIS_TRX_LINES');
   l_info('##MASK##TRX_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5719',
      p_sig_id                 => 'AGIS_TRX_LINES',
      p_sig_sql                => 'select b.batch_id, b.batch_number,  h.trx_id, h.trx_number, l.* 
from fun_trx_headers h ,fun_trx_batches b , fun_trx_lines l
where h.batch_id  = b.batch_id
and l.trx_id  = h.trx_id
and b.batch_number  = nvl(''##$$BATCH_NUMBER$$##'',''NO BATCH'')

order by l.line_id',
      p_title                  => 'Transaction Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No transaction lines details for batch_number provided.',
      p_solution               => 'Verify that the batch_number exists for this Ledger_id.',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_TRX_LINES');



debug('begin add_signature: AGIS_DISTRIBUTIONS');
   l_info('##MASK##TRX_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5686',
      p_sig_id                 => 'AGIS_DISTRIBUTIONS',
      p_sig_sql                => 'select b.batch_id, b.batch_number,  h.trx_id, h.trx_number, l.line_number,cc.CHART_OF_ACCOUNTS_ID, cc.CONCATENATED_SEGMENTS, d.* 
...
where b.batch_id  = h.batch_id
and h.trx_id  = l.trx_id
and l.line_id = d.line_id
and d.ccid = cc.code_combination_id
and b.batch_number  = nvl(''##$$BATCH_NUMBER$$##'',''NO BATCH'')
order by b.batch_id, h.trx_id, l.line_id, d.dist_id',
      p_title                  => 'Distributions Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No distributions details for batch_number provided.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_DISTRIBUTIONS');



debug('begin add_signature: AGIS_TRX_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5738',
      p_sig_id                 => 'AGIS_TRX_STATUS',
      p_sig_sql                => 'select distinct h.status "##$$FK1$$##", h.status TRX_STATUS, count(h.status) TRX_COUNT
from fun_trx_batches b ,
fun_trx_headers h
where b.batch_id=h.batch_id
and h.status not in (''COMPLETE'',''NEW'')
and b.from_ledger_id =  ##$$LEDGER_ID$$##
group by h.status
order by h.status',
      p_title                  => 'Transactions Statuses',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Stuck transactions for initiator ledger',
      p_solution               => 'Please review:
[1525154.1] AGIS: Debugging Steps for AGIS Workflow Issues.<br>
[813397.1] How To Troubleshoot AGIS Accounting 
',
   ...
   l_info.delete;
debug('end add_signature: AGIS_TRX_STATUS');



debug('begin add_signature: AGIS_TRX_APPROVED');
   l_info('##MASK##AR_INVOICE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRX_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5741',
      p_sig_id                 => 'AGIS_TRX_APPROVED',
      p_sig_sql                => 'select h.trx_id "##$$FK2$$##" , b.batch_number, b.status BATCH_STATUS, h.*
from fun_trx_batches b ,
fun_trx_headers h
where b.batch_id=h.batch_id
...
and b.from_ledger_id = ''##$$LEDGER_ID$$##''
order by b.batch_id,h.trx_id',
      p_title                  => 'APPROVED - Transaction Headers Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transaction with status APPROVED',
      p_solution               => 'Please submit the ''Transfer Intercompany Transactions to Receivables'' (invoice required) or Transfer intercompany transactions to general ledger (invoice not required).<br>
See also:<br>
...
',
   ...
   l_info.delete;
debug('end add_signature: AGIS_TRX_APPROVED');



debug('begin add_signature: AGIS_TRX_ERROR');
   l_info('##MASK##AR_INVOICE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRX_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5739',
      p_sig_id                 => 'AGIS_TRX_ERROR',
      p_sig_sql                => 'select h.trx_id "##$$FK2$$##" , b.batch_number, b.status BATCH_STATUS, h.*
from fun_trx_batches b ,
fun_trx_headers h
where b.batch_id=h.batch_id
...
and b.from_ledger_id = ''##$$LEDGER_ID$$##''
order by b.batch_id,h.trx_id',
      p_title                  => 'ERROR - Transaction Headers Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transactions with status ERROR',
      p_solution               => 'Please review:
[1525154.1] AGIS: Debugging Steps for AGIS Workflow Issues.<br>
[813397.1] How To Troubleshoot AGIS Accounting ',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: AGIS_TRX_ERROR');



debug('begin add_signature: AGIS_TRX_RECEIVED');
   l_info('##MASK##AR_INVOICE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRX_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5742',
      p_sig_id                 => 'AGIS_TRX_RECEIVED',
      p_sig_sql                => 'select h.trx_id "##$$FK2$$##" , b.batch_number, b.status BATCH_STATUS, h.*
from fun_trx_batches b ,
fun_trx_headers h
where b.batch_id=h.batch_id
...
and b.from_ledger_id = ''##$$LEDGER_ID$$##''
order by b.batch_id,h.trx_id',
      p_title                  => 'RECEIVED - Transaction Headers Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transaction with status RECEIVED',
      p_solution               => 'Please review:
[1295352.1] AGIS: Inbound "Update Transaction" Button Greyed Out, but Batch is in Status "Received"<br> 
[1558224.1] Status  Of Intercompany Batch(AGIS) Remains In ''Submitted'' When Few  Transactions In The Batch Are In ''Received'' Status And Few Transactions  Are In ''Complete'' Status.<br>
[1571283.1] AGIS: The Batch Is Not Getting Approved. It Is in ''RECEIVED'' Status Only.',
   ...
   l_info.delete;
debug('end add_signature: AGIS_TRX_RECEIVED');



debug('begin add_signature: AGIS_TRX_SENT');
   l_info('##MASK##AR_INVOICE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRX_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5743',
      p_sig_id                 => 'AGIS_TRX_SENT',
      p_sig_sql                => 'select h.trx_id "##$$FK2$$##" , b.batch_number, b.status BATCH_STATUS, h.*
from fun_trx_batches b ,
fun_trx_headers h
where b.batch_id=h.batch_id
...
and b.from_ledger_id = ''##$$LEDGER_ID$$##''
order by b.batch_id,h.trx_id',
      p_title                  => 'SENT - Transaction Headers Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transactions with status SENT',
      p_solution               => 'Please review:
[739949.1] AGIS Outbound Transaction Is Not Getting Populated In Inbound Screen, Status Is Submitted<br>
[1983945.1] AGIS Transactions are Stuck In Approved And Submitted Status transactions will not pass to Receivables<br>
[454668.1] AGIS - Initiator Transaction Status Changes to "Submitted" But The Recipient Cannot View Notification<br>
[1996883.1] AGIS Batches Got Stuck (Status: SENT), Unable to Approve, Reject or Change Accounting; Errors Relate to FUN_RECIPIENT_WF or WF_USER_ROLE.',
   ...
   l_info.delete;
debug('end add_signature: AGIS_TRX_SENT');



debug('begin add_signature: AGIS_TRX_XFER_AP');
   l_info('##MASK##AR_INVOICE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRX_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5744',
      p_sig_id                 => 'AGIS_TRX_XFER_AP',
      p_sig_sql                => 'select h.trx_id "##$$FK2$$##",b.batch_number, b.status BATCH_STATUS, h.*
from fun_trx_batches b ,
fun_trx_headers h
where b.batch_id=h.batch_id
...
and b.from_ledger_id = ''##$$LEDGER_ID$$##''
order by b.batch_id,h.trx_id',
      p_title                  => 'XFER_AP - Transaction Headers Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transactions with status XFER_AP',
      p_solution               => 'Please check whether the period is closed in AP and open it.<br>
If the period cannot be opened, follow [1955766.1] How To Process An AGIS Batch When Receivables/Payables Period is Already Closed.
',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: AGIS_TRX_XFER_AP');



debug('begin add_signature: AGIS_TRX_XFER_AR');
   l_info('##MASK##AR_INVOICE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRX_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5740',
      p_sig_id                 => 'AGIS_TRX_XFER_AR',
      p_sig_sql                => 'select h.trx_id "##$$FK2$$##",b.batch_number, b.status BATCH_STATUS, h.*
from fun_trx_batches b ,
fun_trx_headers h
where b.batch_id=h.batch_id
...
and b.from_ledger_id = ''##$$LEDGER_ID$$##''
order by b.batch_id,h.trx_id',
      p_title                  => 'XFER_AR - Transaction Headers Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transactions with status XFER_AR.',
      p_solution               => 'Please check whether the period is closed in AR and if so, open it and resubmit the Transfer Intercompany Transactions to Payables program.<br>
If the period cannot be opened, follow instructions from below document:<br>
[1955766.1] How To Process An AGIS Batch When Receivables/Payables Period is Already Closed<br>
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_TRX_XFER_AR');



debug('begin add_signature: AGIS_TRX_XFER_INI_GL');
   l_info('##MASK##AR_INVOICE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRX_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5747',
      p_sig_id                 => 'AGIS_TRX_XFER_INI_GL',
      p_sig_sql                => 'select h.trx_id "##$$FK2$$##",b.batch_number, b.status BATCH_STATUS, h.*
from fun_trx_batches b ,
fun_trx_headers h
where b.batch_id=h.batch_id
...
and b.from_ledger_id = ''##$$LEDGER_ID$$##''
order by b.batch_id,h.trx_id',
      p_title                  => 'XFER_INI_GL - Transaction Headers Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transactions with status XFER_INI_GL',
      p_solution               => 'Please check section "How to reflect the status XFER_INI_GL and XFER_RECI_GL in FUN_TRX_HEADERS" from [975235.1] FAQ for AGIS (Advanced Global Intercompany Systems).
...
',
   ...
   l_info.delete;
debug('end add_signature: AGIS_TRX_XFER_INI_GL');



debug('begin add_signature: AGIS_TRX_XFER_RECI_GL');
   l_info('##MASK##AR_INVOICE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRX_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5748',
      p_sig_id                 => 'AGIS_TRX_XFER_RECI_GL',
      p_sig_sql                => 'select h.trx_id "##$$FK2$$##",b.batch_number, b.status BATCH_STATUS, h.*
from fun_trx_batches b ,
fun_trx_headers h
where b.batch_id=h.batch_id
...
and b.from_ledger_id = ''##$$LEDGER_ID$$##''
order by b.batch_id,h.trx_id',
      p_title                  => 'XFER_RECI_GL - Transaction Headers Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transactions with status  XFER_RECI_GL',
      p_solution               => 'Please check section "How to reflect the status XFER_INI_GL and XFER_RECI_GL in FUN_TRX_HEADERS" from [975235.1] FAQ for AGIS (Advanced Global Intercompany Systems).
...
',
   ...
   l_info.delete;
debug('end add_signature: AGIS_TRX_XFER_RECI_GL');



debug('begin add_signature: AGIS_TRX_REVERSED');
   l_info('##MASK##AR_INVOICE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRX_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5746',
      p_sig_id                 => 'AGIS_TRX_REVERSED',
      p_sig_sql                => 'select h.trx_id "##$$FK2$$##" , b.batch_number, b.status BATCH_STATUS, h.*
from fun_trx_batches b ,
fun_trx_headers h
where b.batch_id=h.batch_id
...
and b.from_ledger_id = ''##$$LEDGER_ID$$##''
order by b.batch_id,h.trx_id',
      p_title                  => 'REVERSED - Transaction Headers Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transactions with status REVERSED',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_TRX_REVERSED');



debug('begin add_signature: AGIS_TRX_REJECTED');
   l_info('##MASK##AR_INVOICE_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##TRX_NUMBER'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5745',
      p_sig_id                 => 'AGIS_TRX_REJECTED',
      p_sig_sql                => 'select h.trx_id "##$$FK2$$##" , b.batch_number, b.status BATCH_STATUS, h.*
from fun_trx_batches b ,
fun_trx_headers h
where b.batch_id=h.batch_id
...
and b.from_ledger_id = ''##$$LEDGER_ID$$##''
order by b.batch_id,h.trx_id',
      p_title                  => 'REJECTED - Transaction Headers Details',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transactions with status REJECTED',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_TRX_REJECTED');



debug('begin add_signature: AGIS_PERSON_APPROVERS_FROM_LEDGER_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5679',
      p_sig_id                 => 'AGIS_PERSON_APPROVERS_FROM_LEDGER_ID',
      p_sig_sql                => 'SELECT DISTINCT fb.from_ledger_id,
  ftrx.to_ledger_id,
...
AND sysdate BETWEEN NVL(hzr.start_date, sysdate -1) AND NVL(hzr.end_date, sysdate + 1)
  --AND   ftrx.trx_id =
AND fb.from_ledger_id           = ''##$$LEDGER_ID$$##''
...
ORDER BY USER_ID',
      p_title                  => 'User Assigments for Initiator Ledger',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This identifies organization user assignments for Initiator Ledger.
The user trying to see the inbound transactions must have access to the recipient organization.<br>
Verify at least one user for both the Initiator and Recipient organization has options ''Send Approval Notification'' and ''Access to Transactions'' checked.<br>
Please review [965970.1] R12: AGIS Outbound throws ''Update the organization assignments for at least one user of..''',
      p_solution               => '',
      p_success_msg            => 'This identifies organization user assignments for Initiator Ledger.
The user trying to see the inbound transactions must have access to the recipient organization.<br>
Verify at least one user for both the Initiator and Recipient organization has options ''Send Approval Notification'' and ''Access to Transactions'' checked.<br>
Please review [965970.1] R12: AGIS Outbound throws ''Update the organization assignments for at least one user of..''',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_PERSON_APPROVERS_FROM_LEDGER_ID');



debug('begin add_signature: AGIS_ORGANIZATION ASSIGNMENT DETAILS FOR USER_NAME');
   l_info('##MASK##LENAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##PERSON_ID'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##USER_ID'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '5489',
      p_sig_id                 => 'AGIS_ORGANIZATION ASSIGNMENT DETAILS FOR USER_NAME',
      p_sig_sql                => 'SELECT *
FROM
  (SELECT 
   ''##$$USER_ID$$##'' USER_ID,
  -- HZP.PARTY_NAME PERSON_NAME,
   HZP.PARTY_ID PERSON_ID,
    HZP2.PARTY_NAME ORGNAME,
    HZP2.PARTY_ID ORGID,
    FUN_TCA_PKG.GET_LE_ID(HZP2.PARTY_ID) LEID,
    Xfi.Name Lename,
    HZR.RELATIONSHIP_ID RELATION_SHIP_ID,
    --FL.MEANING LOCAL_DISPLAY,
    --FL.LOOKUP_CODE LOCAL,
    FUN_SECURITY.IS_ACCESS_VALID(HZP.PARTY_ID, HZP2.PARTY_ID) Access_to_Transactions,
    DECODE(HZR.STATUS,''A'',''Y'',''I'',''N'') STATUS,
    HZR.ADDITIONAL_INFORMATION1 Send_Approval_Notification
  FROM HZ_PARTIES HZP,
    HZ_PARTIES HZP2,
    HZ_RELATIONSHIPS HZR,
  ...
  --AND FL.LOOKUP_CODE            =DECODE(XFI.PARTY_ID,NULL,''N'',''Y'')
  AND XFI.PARTY_ID              = FUN_TCA_PKG.GET_LE_ID(HZP2.PARTY_ID)
...
WHERE (PERSON_ID in (select person_party_id from fnd_user where user_id=''##$$USER_ID$$##'')) --2049
Order By Orgname Asc',
      p_title                  => 'AGIS Organization Assignment Details for User_Id provided',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Organization Assignments for this User_Id.',
      p_solution               => 'The user trying to see the inbound transactions must have access to the recipient organization.<br>
Verify at least one user for both the Initiator and Recipient organization has options ''Send Approval Notification'' and ''Access to Transactions'' checked.<br>
Use the Intercompany Organization Assignments page to search for and update an organization assignment, or to create new assignments.<br>
Please review [965970.1] R12: AGIS Outbound throws ''Update the organization assignments for at least one user of..''',
      p_success_msg            => 'This identifies organization user assignments  for User_Name provided.
The user trying to see the inbound transactions must have access to the recipient organization.<br>
Verify at least one user for both the Initiator and Recipient organization has options ''Send Approval Notification'' and ''Access to Transactions'' checked.<br>
Please review [965970.1] R12: AGIS Outbound throws ''Update the organization assignments for at least one user of..''"
',
   ...
   l_info.delete;
debug('end add_signature: AGIS_ORGANIZATION ASSIGNMENT DETAILS FOR USER_NAME');



debug('begin add_signature: AGIS_TR_USER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8894',
      p_sig_id                 => 'AGIS_TR_USER',
...
FROM fnd_User
WHERE user_Id =
  (SELECT created_by FROM fun_Trx_Batches WHERE batch_Number = nvl(''##$$BATCH_NUMBER$$##'',''NO BATCH'') )',
      p_title                  => 'Batch Preparer',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'This section displays the details of the user who prepared the batch.',
      p_solution               => '',
      p_success_msg            => 'This section displays the details of the user who prepared the batch.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: AGIS_TR_USER');
...
start_section('Instance Overview', 'OVERVIEW');
   set_item_result(run_stored_sig('AGIS_DB_RELEASE_INFO'));
   set_item_result(run_stored_sig('AGIS_DB_PARAMETERS'));
   set_item_result(run_stored_sig('AGIS_LANGUAGES_INSTALLED_DETAILS'));
   set_item_result(run_stored_sig('EBS_FIN_FC_FUNAGIS_PROD_LEVELS'));
end_section;
debug('end section: OVERVIEW');

debug('begin section: PROACTIVE_RECOMMENDATIONS');
start_section('Proactive Actions and Recommendations', 'PROACTIVE_RECOMMENDATIONS');
   set_item_result(check_rec_patches_1); /* Signature AGIS RECOMMENDED PATCHES */
   set_item_result(run_stored_sig('AGIS INVALIDS'));
   set_item_result(run_stored_sig('AGIS_TABLESPACE_CHECK'));
end_section;
debug('end section: PROACTIVE_RECOMMENDATIONS');

debug('begin section: LICENSES');
start_section('FUN Product and Workflow Licenses', 'LICENSES');
   set_item_result(run_stored_sig('AGIS PRODUCT INSTALLATION INFORMATION'));
   set_item_result(run_stored_sig('AGIS PRODUCT INSTALLATION ISSUE'));
   set_item_result(run_stored_sig('AGIS PRODUCT LICENSED DETAILS'));
end_section;
debug('end section: LICENSES');

debug('begin section: SETUP');
start_section('Setup', 'SETUP');
   set_item_result(run_stored_sig('EBS_FIN_FC_FUNAGIS_PROFILES'));
   set_item_result(run_stored_sig('AGIS SYSTEM OPTION INFORMATION1'));
   set_item_result(run_stored_sig('AGIS_FLEX_FIELD_INFORMATION'));
   set_item_result(run_stored_sig('AGIS_ALLOW_INTERCOMPANY_FLAG_FOR_LEDGER'));
   set_item_result(run_stored_sig('AGIS_BSV_OPTION_CODE_FOR_LEDGER'));
   set_item_result(run_stored_sig('AGIS_INTERCOMPANY_BALANCING_RULES'));
   set_item_result(run_stored_sig('AGIS_INTRACOMPANY_BALANCING_RULES'));
   set_item_result(run_stored_sig('AGIS_INTERCOMPANY_SEGMENT_AND_BALANCING_SEGMENTS'));
   set_item_result(run_stored_sig('AGIS RECEIVABLES ASSIGNMENT DETAILS'));
   set_item_result(run_stored_sig('AGIS_BSV_ASSIGNMENTS_AT_LEGAL_ENTITY_LEVEL'));
   set_item_result(run_stored_sig('AGIS_BSV_ASSIGNMENTS_AT_LEDGER'));
   set_item_result(run_stored_sig('AGIS_SECUIRTY RULES FOR GL AND AGIS'));
   set_item_result(run_stored_sig('AGIS_SUPPLIER_ASSOCIATION_DETAILS_FOR_THE_LEDGER'));
   IF p_user_id is null THEN
      set_item_result(run_stored_sig('AGIS_PERSON_APPROVERS_FROM_LEDGER_ID'));
   END IF;
   IF p_user_Id is not null THEN
      set_item_result(run_stored_sig('AGIS_ORGANIZATION ASSIGNMENT DETAILS FOR USER_NAME'));
   END IF;
   set_item_result(run_stored_sig('AGIS CUSTOMER ASSOCIATION DETAILS FOR THE LEDGER'));
   set_item_result(run_stored_sig('XLA_SEG_RULE_DETAILS'));
   set_item_result(run_stored_sig('FUN_TRX_ACCT_DEFINITIONS'));
   set_item_result(run_stored_sig('XLA_TAB_ACCT_DEF_DETAILS'));
   set_item_result(run_stored_sig('FUN_DIST_LINES.PARTY_ID'));
   set_item_result(run_stored_sig('AGIS_LEGAL_ENTITY_NAME_CHANGES'));
end_section;
debug('end section: SETUP');

debug('begin section: Calendar_Data_Collection');
start_section('Calendar Data Collection', 'Calendar_Data_Collection');
   set_item_result(run_stored_sig('DC_CALENDAR_DEFINITION'));
   set_item_result(run_stored_sig('EBS_FIN_FC_FUNAGIS_CAL_PER_SETUP'));
   set_item_result(run_stored_sig('EBS_FIN_FC_FUNAGIS_GL_PERIOD_STATUS'));
   set_item_result(run_stored_sig('DC_ALL_LEDGERS_OF_CALENDAR'));
   set_item_result(run_stored_sig('DC_GL_PERIODS_INFO'));
   set_item_result(run_stored_sig('DC_GL_PERIOD_STATUSES_INFO'));
end_section;
debug('end section: Calendar_Data_Collection');

debug('begin section: ASM_DATA_COLLECTION');
start_section('Accounting Setup Manager (ASM) Data Collection', 'ASM_DATA_COLLECTION');
   set_item_result(run_stored_sig('LEDGER_DETAILS'));
   set_item_result(run_stored_sig('LEDGER_ASSO_DETAILS'));
   set_item_result(run_stored_sig('LEDGER_CONFIGURATIONS'));
   set_item_result(run_stored_sig('JOURNAL_CONVERSION_RULES'));
   set_item_result(run_stored_sig('GL_LEDGER_CONFIGURATION_DETAILS'));
   set_item_result(run_stored_sig('GL Ledger Relationships Information'));
   set_item_result(run_stored_sig('GL_FLEXFIELD_INFORMATION'));
   set_item_result(run_stored_sig('FLEX_QUALIFIER_DETAILS'));
   set_item_result(run_stored_sig('GL_CHART_OF_ACCOUNTS_DETAILS'));
   set_item_result(run_stored_sig('BSV_ASSIGNMENTS_AT_LEGAL_ENTITY_LEVEL'));
   set_item_result(run_stored_sig('BSV_ASSIGNMENT_AT_LEDGER'));
   set_item_result(run_stored_sig('REPORTING_AND_ACCOUNTING_SEQUENCE_INFORMATION'));
   set_item_result(run_stored_sig('INTRA_COMPANY_RULES'));
   set_item_result(run_stored_sig('INTER_COMPANY_RULES'));
   set_item_result(run_stored_sig('GL_LEDGER_NORM_SEG_VALS'));
   set_item_result(run_stored_sig('GL_LEDGER_SEGMENT_VALUES'));
   set_item_result(run_stored_sig('OPERATING_UNITS_ASSIGNMENT_DETAILS_FOR_PRIMARY_LEDGER'));
   set_item_result(run_stored_sig('GL_LE_VALUE_SETS_INFORMATION'));
   set_item_result(run_stored_sig('COA_MAPPING'));
   set_item_result(run_stored_sig('DEFAULT INTERCOMPANY ACCOUNTS NOT ACTIVE'));
   set_item_result(run_stored_sig('USE FOR BALANCING OPTION FOR INTERCOMPANY ACCOUNTS'));
end_section;
debug('end section: ASM_DATA_COLLECTION');

debug('begin section: OPEN_TRANSACTIONS');
start_section('Open Transactions', 'OPEN_TRANSACTIONS');
   set_item_result(run_stored_sig('AGIS_OPEN_TRANSACTIONS_BY_PERIODS'));
   set_item_result(run_stored_sig('AGIS_PERIOD_OPEN_TRANSACTION_TYPE_DETAILS'));
end_section;
debug('end section: OPEN_TRANSACTIONS');

debug('begin section: BATCHES_AND_TRANSACTIONS');
start_section('Batches and Transactions Details', 'BATCHES_AND_TRANSACTIONS');
   IF p_batch_number is not null THEN
      set_item_result(run_stored_sig('AGIS_TRX_FOR_BATCHE_NO'));
      set_item_result(run_stored_sig('AGIS_TRX_NEW_B'));
      set_item_result(run_stored_sig('AGIS_TRX_COMPLETE_B'));
      set_item_result(run_stored_sig('AGIS_TRX_REVERSED_B'));
      set_item_result(run_stored_sig('AGIS_TRX_REJECTED_B'));
      set_item_result(run_stored_sig('AGIS_TRX_APPROVED_B'));
      set_item_result(run_stored_sig('AGIS_TRX_ERROR_B'));
      set_item_result(run_stored_sig('AGIS_TRX_RECEIVED_B'));
      set_item_result(run_stored_sig('AGIS_TRX_XFER_INI_GL_B'));
      set_item_result(run_stored_sig('AGIS_TRX_XFER_RECI_GL_B'));
      set_item_result(run_stored_sig('AGIS_TRX_XFER_AP_B'));
      set_item_result(run_stored_sig('EBS_FIN_FUNAGIS_AP_INV_HDRS'));
      set_item_result(run_stored_sig('AGIS_TRX_XFER_AR_B'));
      set_item_result(run_stored_sig('EBS_FIN_FUNAGIS_AR_INV_HDRS'));
      set_item_result(run_stored_sig('AGIS_TRX_SENT_B'));
      set_item_result(run_stored_sig('AGIS_TRX_LINES'));
      set_item_result(run_stored_sig('AGIS_DISTRIBUTIONS'));
   END IF;
   IF p_batch_number is null THEN
      set_item_result(run_stored_sig('AGIS_TRX_STATUS'));
      set_item_result(run_stored_sig('AGIS_TRX_APPROVED'));
      set_item_result(run_stored_sig('AGIS_TRX_ERROR'));
      set_item_result(run_stored_sig('AGIS_TRX_RECEIVED'));
      set_item_result(run_stored_sig('AGIS_TRX_SENT'));
      set_item_result(run_stored_sig('AGIS_TRX_XFER_AP'));
      set_item_result(run_stored_sig('AGIS_TRX_XFER_AR'));
      set_item_result(run_stored_sig('AGIS_TRX_XFER_INI_GL'));
      set_item_result(run_stored_sig('AGIS_TRX_XFER_RECI_GL'));
      set_item_result(run_stored_sig('AGIS_TRX_REVERSED'));
      set_item_result(run_stored_sig('AGIS_TRX_REJECTED'));
   END IF;
end_section;
debug('end section: BATCHES_AND_TRANSACTIONS');

debug('begin section: WORKFLOW');
start_section('FUN Workflow Details', 'WORKFLOW');
   set_item_result(run_stored_sig('AGIS_WF_VERSION'));
   set_item_result(run_stored_sig('AGIS WORKFLOW LISTENERS NOT RUNNING'));
   IF p_batch_number is not null THEN
      set_item_result(run_stored_sig('AGIS_WFSTAT_FOR_BATCH'));
   END IF;
   IF p_batch_number is null THEN
      set_item_result(run_stored_sig('AGIS_WF_ITEMS_IN_ERROR'));
      set_item_result(run_stored_sig('AGIS_WF_OPEN_NOTIFICATIONS'));
   END IF;
end_section;
debug('end section: WORKFLOW');

debug('begin section: AME_for_AGIS');
start_section('AME for AGIS', 'AME_for_AGIS');
   set_item_result(run_stored_sig('AGIS_AME_PROF_INSTALLED'));
   set_item_result(run_stored_sig('AGIS_AME_APP_DET'));
   set_item_result(run_stored_sig('AGIS_AME_RULES_DEF'));
   set_item_result(run_stored_sig('AGIS_AME_REQ_ATT'));
   set_item_result(run_stored_sig('AGIS_AME_CONDITIONS'));
   set_item_result(run_stored_sig('AGIS_AME_AT'));
   set_item_result(run_stored_sig('AGIS_AME_AG'));
   IF p_batch_number is not null THEN
      set_item_result(run_stored_sig('AGIS_TR_USER'));
   END IF;
end_section;
debug('end section: AME_for_AGIS');

debug('begin section: INTERFACES');
start_section('FUN Interfaces', 'INTERFACES');
   set_item_result(run_stored_sig('AGIS_INTERFACE_BATCHES'));
   set_item_result(run_stored_sig('AGIS_INTERFACE_HEADERS'));
   set_item_result(run_stored_sig('AGIS_INTERFACE_DISTRIBUTIONS'));
   set_item_result(run_stored_sig('AGIS_INTERFACE_CONTROLS'));
   set_item_result(run_stored_sig('EBS_FIN_FUNAGIS_DUPLICATE_FUN_DIST_IDS'));
end_section;
debug('end section: INTERFACES');

debug('begin section: FILES_AND_VERSIONS');
start_section('Files and Versions', 'FILES_AND_VERSIONS');
   set_item_result(run_stored_sig('AGIS_TABLES_AND_VIEWS'));
   set_item_result(run_stored_sig('AGIS PACKAGE DETAILS'));
   set_item_result(run_stored_sig('AGIS_SQL_VERSION'));
   set_item_result(run_stored_sig('AGIS_PLS_VERSIONS'));
   set_item_result(run_stored_sig('AGIS_JAVA_FILES'));
   set_item_result(run_stored_sig('AGIS_REPORTS'));
   set_item_result(run_stored_sig('AGIS_OTHER_FILE_VERSIONS'));
   set_item_result(run_stored_sig('EBS_FIN_CUSTOM_TABLE_INDEXES'));
   set_item_result(run_stored_sig('EBS_FIN_INVALID_TABLE_INDEXES'));
   set_item_result(run_stored_sig('EBS_FIN_CUSTOM_DB_TRIGGERS'));
end_section;
debug('end section: FILES_AND_VERSIONS');
