...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Latin Tax Analyzer                     |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE jl_latin_tax_analyzer_pkg AUTHID DEFINER AS
...
(            p_user_name                    IN VARCHAR2    DEFAULT NULL
           ...
           ,p_tax_category_id              IN VARCHAR2    DEFAULT NULL
...
END jl_latin_tax_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY jl_latin_tax_analyzer_pkg AS
-- $Id: jl_latin_tax_analyzer.sql, 200.11 2025/12/08 13:35:43 jdhincks Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2389945.1));
...
----------------------------------------------------------------
g_country_code           VARCHAR2(60);
g_cust_trx_type_id       NUMBER := 0;
g_latin_tax_regime       VARCHAR2(30);
g_location_id            NUMBER := 0;
g_org_id_tmp             NUMBER := 0;
g_tax                    VARCHAR2(30) := null;
g_tax_code               VARCHAR2(30);
g_tax_category_id_tmp    VARCHAR2(30) := null;
g_customer_trx_id_tmp    NUMBER := 0;
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'JL_TAX_ANLZ_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'JL_TAX_ANLZ_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>JL_TAX_ANLZ Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2389945.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/jl_latin_tax_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1117,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1117,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1117,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4138625" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">1117</span>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,1117,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,1117,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},1117,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
FUNCTION check_rec_patches_1 RETURN VARCHAR2 IS
  /* Signature JL_GEN_RECOMMENDED_PATCHES */
...
BEGIN
    ...
    print_log('Processing recommended patches signature: JL_GEN_RECOMMENDED_PATCHES (check_rec_patches_1) "Recommended Patches" (version 2)');
...
Best Practice: Always ensure that you are on the latest code with all recommended patches applied. This will help avoid known issues, prevent potential data corruption and provide the latest features and functionality. Having a proactive patching plan and periodic proactive patching process in place are the best ways to stay current.';
   l_sig.success_msg := 'You have applied all the recommended patches in this environment.';
  ...
  -- Register
  l_step := '60';
  g_signatures('JL_GEN_RECOMMENDED_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'JL_GEN_RECOMMENDED_PATCHES',     -- sig ID
...
debug('begin populate parameters hash table');
   ...
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Tax Category ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_tax_category_id,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2025/12/08 13:35:42 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'jl_latin_tax_analyzer.sql';
...
INTO l_exists_val
FROM FND_RESPONSIBILITY SP, FND_RESPONSIBILITY_VL U, FND_USER_RESP_GROUPS RG
WHERE SP.RESPONSIBILITY_ID = p_resp_id
...
debug('begin parameter validation: p_tax_category_id');
IF p_tax_category_id IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Tax Category ID is required.');
   raise invalid_parameters;
END IF;
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Error: The Tax Category ID does not exist.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_tax_category_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_tax_category_id');
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Transaction.');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
g_tax_category_id_tmp := p_tax_category_id;
g_customer_trx_id_tmp := p_customer_trx_id;


BEGIN
 
   -- workaround to force dates to display in this format
   execute immediate 'alter session set NLS_DATE_FORMAT = ''DD-MON-YYYY'''; 

   if g_customer_trx_id_tmp is not null then
   -- given the customer_trx_id, retrieve the transaction type
      begin   
         select trx.cust_trx_type_id, trx.trx_date
         into   g_cust_trx_type_id, g_trx_date
         from   ra_customer_trx_all trx,
                ra_cust_trx_types_all trx_type
         where  trx.customer_trx_id = g_customer_trx_id_tmp
         and    trx.cust_trx_type_id = trx_type.cust_trx_type_id;

      exception
      when no_data_found then
         g_cust_trx_type_id := -1;
         g_trx_date := NULL;
         print_log('Did not find cust_trx_type_id.');
      end;

      begin
         -- picking up Location_id
         select location_id
         into   g_location_id
         from   hz_locations
         where  location_id = (select ps.location_id
                               from hz_party_sites ps,
                                    hz_cust_acct_sites_all cas
                               where ps.party_site_id = cas.party_site_id
                               and cas.cust_acct_site_id = (select cust_acct_site_id
                                                          from hz_cust_site_uses_all su, ra_customer_trx_all trx
                                                          where su.site_use_id = trx.bill_to_site_use_id
                                                          and customer_trx_id = g_customer_trx_id_tmp));
      exception
      when no_data_found then
         g_location_id := -1;
         print_log('Did not find location_id.');
      end;

      begin
         -- pick up latin tax regime code and tax
         select distinct tax_regime_code
         into   g_latin_tax_regime
         from   zx_lines
         where  trx_id = g_customer_trx_id_tmp;
      exception
      when no_data_found then
         g_latin_tax_regime := -1;
         print_log('Did not find tax_regime_code & tax.');
      when too_many_rows then
         g_latin_tax_regime := -1;
         print_log('Trx has more than one tax regime');
      end;  

 

   else
   -- customer_trx_id was not provided
      g_cust_trx_type_id := -1;
      g_location_id := -1;
      g_latin_tax_regime := -1;
   end if;
   ...
   begin
      -- pick up the Tax code
      select a.tax_code
      into g_tax_code
      from JL_ZZ_AR_TX_CATEG_ALL a
      where a.org_id = g_org_id_tmp
      and a.tax_category_id = g_tax_category_id_tmp
      and a.tax_code is not null;

      print_log('g_tax_code = ' || g_tax_code);

      select b.tax
      into g_tax
      from AR_VAT_TAX_ALL_B b
      where b.tax_code = g_tax_code
      and   b.org_id = g_org_id_tmp;

      print_log('g_tax = ' || g_tax);
   ...
   -- picking up COUNTRY CODE
   select country 
   into  g_country_code
   from  hr_locations loc, hr_organization_units orgs
   where loc.location_id = orgs.location_id
   and   organization_id = g_org_id_tmp;

EXCEPTION
WHEN NO_DATA_FOUND then
   print_log('Did not find country.');
   g_country_code := null;
END;
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$ORG_ID$$##') := g_org_id_tmp;
   g_masked_tokens('##$$ORG_ID$$##') := mask_text( g_sql_tokens('##$$ORG_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$TAX_CATEGORY_ID$$##') := g_tax_category_id_tmp;
   g_masked_tokens('##$$TAX_CATEGORY_ID$$##') := mask_text( g_sql_tokens('##$$TAX_CATEGORY_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$TRXID$$##') := g_customer_trx_id_tmp;
   g_masked_tokens('##$$TRXID$$##') := mask_text( g_sql_tokens('##$$TRXID$$##'), 'NO_MASK');
   g_sql_tokens('##$$COUNTRY_CODE$$##') := g_country_code;
   g_masked_tokens('##$$COUNTRY_CODE$$##') := mask_text( g_sql_tokens('##$$COUNTRY_CODE$$##'), 'NO_MASK');
   g_sql_tokens('##$$LATIN_TAX_REGIME$$##') := g_latin_tax_regime;
   g_masked_tokens('##$$LATIN_TAX_REGIME$$##') := mask_text( g_sql_tokens('##$$LATIN_TAX_REGIME$$##'), 'NO_MASK');
   g_sql_tokens('##$$TAX$$##') := g_tax;
   g_masked_tokens('##$$TAX$$##') := mask_text( g_sql_tokens('##$$TAX$$##'), 'NO_MASK');
   g_sql_tokens('##$$LOCATION_ID$$##') := g_location_id;
   g_masked_tokens('##$$LOCATION_ID$$##') := mask_text( g_sql_tokens('##$$LOCATION_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$CUST_TRX_TYPE_ID$$##') := g_cust_trx_type_id;
   g_masked_tokens('##$$CUST_TRX_TYPE_ID$$##') := mask_text( g_sql_tokens('##$$CUST_TRX_TYPE_ID$$##'), 'NO_MASK');
   ...
   g_sql_tokens('##$$TRX_DATE$$##') := g_trx_date;
   g_masked_tokens('##$$TRX_DATE$$##') := mask_text( g_sql_tokens('##$$TRX_DATE$$##'), 'NO_MASK');
   g_sql_tokens('##$$A$$##') := 'JL_LATIN_TAX_ANALYZER_PKG';
...
debug('begin add_signature: JL_ZZ_AR_TX_CATEG_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7137',
      p_sig_id                 => 'JL_ZZ_AR_TX_CATEG_ALL',
      p_sig_sql                => 'select * from JL_ZZ_AR_TX_CATEG_ALL
where org_id = ##$$ORG_ID$$##
and tax_category_id = ##$$TAX_CATEGORY_ID$$##',
      p_title                  => 'JL_ZZ_AR_TX_CATEG_ALL (Tax Categories)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data in JL_ZZ_AR_TX_CATEG_ALL for tax category = '||mask_text(g_tax_category_id_tmp, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => 'Please ensure that the value you provided for tax category actually exists in JL_ZZ_AR_TX_CATEG_ALL.',
      p_success_msg            => 'Displaying Latin Tax category information that use tax category = '||mask_text(g_tax_category_id_tmp, nvl( upper(''), 'NO_MASK') )||'.',
   ...
   l_info.delete;
debug('end add_signature: JL_ZZ_AR_TX_CATEG_ALL');



debug('begin add_signature: JL_ZZ_AR_TX_CAT_DTL_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7135',
      p_sig_id                 => 'JL_ZZ_AR_TX_CAT_DTL_ALL',
      p_sig_sql                => 'select * from JL_ZZ_AR_TX_CAT_DTL_ALL
where org_id = ##$$ORG_ID$$##
and tax_category_id = ##$$TAX_CATEGORY_ID$$##',
      p_title                  => 'JL_ZZ_AR_TX_CAT_DTL_ALL (Tax Categories Details)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data in JL_ZZ_AR_TX_CAT_DTL_ALL for tax category = '||mask_text(g_tax_category_id_tmp, nvl( upper(''), 'NO_MASK') )||'.
',
      p_solution               => 'No data found in JL_ZZ_AR_TX_CAT_DTL_ALL, does not necessarily indicate a problem.<br>
Latin Tax minimum settings are stored in this table and are optional.  <br>
This table is used to store one or more of the following types of information for specific date ranges: <br>
<ul>
<li>Default tax code </li>
<li>Minimum tax amount</li>
<li>Minimum percentage</li>
<li>Minimum taxable basis</li>
</ul>
',
      p_success_msg            => 'Displaying Latin Tax minimum settings information that use tax category = '||mask_text(g_tax_category_id_tmp, nvl( upper(''), 'NO_MASK') )||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_ZZ_AR_TX_CAT_DTL_ALL');



debug('begin add_signature: JL_ZZ_AR_TX_ATT_VAL_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7138',
      p_sig_id                 => 'JL_ZZ_AR_TX_ATT_VAL_ALL',
      p_sig_sql                => 'select * from JL_ZZ_AR_TX_ATT_VAL_ALL
where org_id = ##$$ORG_ID$$##
and tax_category_id = ##$$TAX_CATEGORY_ID$$##',
      p_title                  => 'JL_ZZ_AR_TX_ATT_VAL_ALL (Link Tax Categories with Tax Conditions)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data in JL_ZZ_AR_TX_ATT_VAL_ALL for tax category = '||mask_text(g_tax_category_id_tmp, nvl( upper(''), 'NO_MASK') )||'.
',
      p_solution               => 'Please create values for a condition that are associated with a tax category.<br>
<ul>
<li>One of the values associated with a condition must be declared as a default.</li>
<li>This value will be used as the default value for the condition when a class is created.</li>
</ul>',
      p_success_msg            => 'Displaying Latin Tax condition value information that use tax category = '||mask_text(g_tax_category_id_tmp, nvl( upper(''), 'NO_MASK') )||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_ZZ_AR_TX_ATT_VAL_ALL');



debug('begin add_signature: JL_ZZ_AR_TX_ATT_CLS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7139',
      p_sig_id                 => 'JL_ZZ_AR_TX_ATT_CLS_ALL',
      p_sig_sql                => 'select * from JL_ZZ_AR_TX_ATT_CLS_ALL
where org_id = ##$$ORG_ID$$##
and tax_category_id = ##$$TAX_CATEGORY_ID$$##',
      p_title                  => 'JL_ZZ_AR_TX_ATT_CLS_ALL (Tax Condition Classes)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data in JL_ZZ_AR_TX_ATT_CLS_ALL for tax category = '||mask_text(g_tax_category_id_tmp, nvl( upper(''), 'NO_MASK') )||' for:
<ul>
<li>Organizations</li>
<li>Customers</li>
<li>Transactions</li>
</ul>',
      p_solution               => 'Please navigate to Latin class code and the condition value for one or more conditions of a tax category.<br>
<ul>
<li>Those conditions defined as mandatory for a tax category should exist in every class.</li>
<li>Mandatory tax categories should have at least their mandatory conditions present in every class.</li>
</ul>',
      p_success_msg            => 'Displaying Latin class code and the condition value information that use tax category = '||mask_text(g_tax_category_id_tmp, nvl( upper(''), 'NO_MASK') )||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_ZZ_AR_TX_ATT_CLS_ALL');



debug('begin add_signature: JL_ZZ_AR_TX_FSC_CLS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7128',
      p_sig_id                 => 'JL_ZZ_AR_TX_FSC_CLS_ALL',
      p_sig_sql                => 'select * from JL_ZZ_AR_TX_FSC_CLS_ALL
where org_id = ##$$ORG_ID$$##
and tax_category_id = ##$$TAX_CATEGORY_ID$$##',
      p_title                  => 'JL_ZZ_AR_TX_FSC_CLS_ALL (Fiscal Classifications)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data in JL_ZZ_AR_TX_FSC_CLS_ALL for specified tax category = '||mask_text(g_tax_category_id_tmp, nvl( upper(''), 'NO_MASK') )||'.
',
      p_solution               => 'No data found in JL_ZZ_AR_TX_FSC_CLS_ALL, does not necessarily indicate a problem.  Fiscal Classifications are optional.<br>
<ul>
<li>This table stores the Fiscal Classifications and is the table on which the Latin Fiscal Classifications window is based.</li>
<li>Each row represents an exception, valid between START_DATE_ACTIVE and END_DATE_ACTIVE, for a tax category and a Fiscal Classification code, which has a specific tax code assigned.</li> 
<li>(Optionally, both tax code and base rate modifier could be assigned for a given exception.)</li>
</ul>',
      p_success_msg            => 'Displaying fiscal classification information that use tax category = '||mask_text(g_tax_category_id_tmp, nvl( upper(''), 'NO_MASK') )||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_ZZ_AR_TX_FSC_CLS_ALL');



debug('begin add_signature: JL_ZZ_AR_TX_GROUPS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7127',
      p_sig_id                 => 'JL_ZZ_AR_TX_GROUPS_ALL',
      p_sig_sql                => 'select * from JL_ZZ_AR_TX_GROUPS_ALL
where tax_group_record_id in (select distinct tax_group_record_id
                              from JL_ZZ_AR_TX_GROUPS_ALL
                              where tax_category_id = ##$$TAX_CATEGORY_ID$$##
                              and org_id = ##$$ORG_ID$$##)',
      p_title                  => 'JL_ZZ_AR_TX_GROUPS_ALL (Tax Groups)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data in JL_ZZ_AR_TX_GROUPS_ALL which uses tax category = '||mask_text(g_tax_category_id_tmp, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => 'Please define a tax group that uses the tax category = '||mask_text(g_tax_category_id_tmp, nvl( upper(''), 'NO_MASK') )||'. For more information please read [784692.1] Troubleshooting Latin America Tax Release 12 Tax Calculation Issues.',
      p_success_msg            => 'Displaying Latin Tax groups that use tax category =  '||mask_text(g_tax_category_id_tmp, nvl( upper(''), 'NO_MASK') )||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_ZZ_AR_TX_GROUPS_ALL');



debug('begin add_signature: JL_ZZ_AR_TX_RULES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7124',
      p_sig_id                 => 'JL_ZZ_AR_TX_RULES_ALL',
      p_sig_sql                => 'select * from JL_ZZ_AR_TX_RULES_ALL
where tax_category_id = ##$$TAX_CATEGORY_ID$$##
and org_id = ##$$ORG_ID$$##
and cust_trx_type_id = decode(##$$CUST_TRX_TYPE_ID$$##, -1, cust_trx_type_id)',
      p_title                  => 'JL_ZZ_AR_TX_RULES_ALL (Tax Rules)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data in JL_ZZ_AR_TX_RULES_ALL for tax category = '||mask_text(g_tax_category_id_tmp, nvl( upper(''), 'NO_MASK') )||'.
This table stores the rules for determination of tax and is the table on which the Latin Tax Rules window is based. 
Each row is an association of a rule with a combination of tax category, transaction type, contributor type and rule level.',
      p_solution               => 'Please define Tax Rules for specified Tax Category.
For more information, please read [784692.1] Troubleshooting Latin America Tax Release 12 Tax Calculation Issues.',
      p_success_msg            => 'Displaying Latin Tax rules information that use tax category = '||mask_text(g_tax_category_id_tmp, nvl( upper(''), 'NO_MASK') )||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_ZZ_AR_TX_RULES_ALL');



debug('begin add_signature: JL_ZZ_AR_TX_LOCN_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7125',
      p_sig_id                 => 'JL_ZZ_AR_TX_LOCN_ALL',
      p_sig_sql                => 'select * from JL_ZZ_AR_TX_LOCN_ALL
where tax_category_id = ##$$TAX_CATEGORY_ID$$##
and org_id = ##$$ORG_ID$$##
order by LOCN_ID',
      p_title                  => 'JL_ZZ_AR_TX_LOCN_ALL (Locations)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data in JL_ZZ_AR_TX_LOCN_ALL for tax category = '||mask_text(g_tax_category_id_tmp, nvl( upper(''), 'NO_MASK') )||'.
',
      p_solution               => 'No data found in JL_ZZ_AR_TX_LOCN_ALL, does not necessarily indicate a problem.<br>
<ul>
<li>This table stores the associations of tax categories with shipment locations and is the table on which the Latin Locations window is based. </li>
<li>Each row is an exception for a tax category and a combination of ship-from and ship-to locations valid between START_DATE_ACTIVE and END_DATE_ACTIVE.</li>
<li>Each exception row must have a value in TAX_CODE or BASE_RATE. Optionally, both TAX_CODE and BASE_RATE can be entered.</li>
</ul>',
      p_success_msg            => 'Displaying Latin Tax locations information that use tax category = '||mask_text(g_tax_category_id_tmp, nvl( upper(''), 'NO_MASK') )||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_ZZ_AR_TX_LOCN_ALL');



debug('begin add_signature: JL_ZZ_AR_TX_EXC_FSC_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7130',
      p_sig_id                 => 'JL_ZZ_AR_TX_EXC_FSC_ALL',
      p_sig_sql                => 'select * from JL_ZZ_AR_TX_EXC_FSC_ALL
where org_id = ##$$ORG_ID$$##
and tax_category_id = ##$$TAX_CATEGORY_ID$$##',
      p_title                  => 'JL_ZZ_AR_TX_EXC_FSC_ALL (Exception Fiscal Classification)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data in JL_ZZ_AR_TX_EXC_FSC_ALL for tax category = '||mask_text(g_tax_category_id_tmp, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => 'No data found in JL_ZZ_AR_TX_EXC_FSC_ALL, does not necessarily indicate a problem.  Latin Tax Exceptions by Fiscal Classifications are optional.<br>
<ul>
<li>This table stores all the exceptions by fiscal classifications and is the table on which the Latin Exceptions window is based.</li>
<li>Each row represents an exception for a tax category, a ship from/to combination and a fiscal classification code.</li>
<li>For each exception either a tax code or a base rate modifier is assigned, and is valid between START_DATE_ACTIVE and END_DATE_ACTIVE.</li>
<li>Optionally, both tax code and base rate modifier could be assigned for a given combination.</li>
</ul>',
      p_success_msg            => 'Displaying Latin Tax exceptions by fiscal classifications information that use tax category = '||mask_text(g_tax_category_id_tmp, nvl( upper(''), 'NO_MASK') )||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_ZZ_AR_TX_EXC_FSC_ALL');



debug('begin add_signature: JL_ZZ_AR_TX_EXC_ITM_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7129',
      p_sig_id                 => 'JL_ZZ_AR_TX_EXC_ITM_ALL',
      p_sig_sql                => 'select * from JL_ZZ_AR_TX_EXC_ITM_ALL
where org_id = ##$$ORG_ID$$##
and tax_category_id = ##$$TAX_CATEGORY_ID$$##',
      p_title                  => 'JL_ZZ_AR_TX_EXC_ITM_ALL (Exception Item)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data in JL_ZZ_AR_TX_EXC_ITM_ALL for tax category = '||mask_text(g_tax_category_id_tmp, nvl( upper(''), 'NO_MASK') )||'.
',
      p_solution               => 'No data found in JL_ZZ_AR_TX_EXC_ITM_ALL, does not necessarily indicate a problem.  Latin Tax Exception by Inventory Items are optional.<br>
<ul>
<li>This table stores all the exceptions by inventory items and is the table on which the Latin Exceptions by Items window is based. Each row represents an exception for a tax category, a ship from/to combination and an inventory item.</li>
<li>Each exception is valid between START_DATE_ACTIVE and END_DATE_ACTIVE and you must enter the tax code or a base rate modifier.</li>
<li>Optionally, both tax code and base rate modifier could be assigned for a given combination.</li>
</ul>',
      p_success_msg            => 'Displaying Latin Tax exception by inventory item information that use tax category = '||mask_text(g_tax_category_id_tmp, nvl( upper(''), 'NO_MASK') )||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_ZZ_AR_TX_EXC_ITM_ALL');



debug('begin add_signature: JL_ZZ_AR_TX_CUS_CLS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7134',
      p_sig_id                 => 'JL_ZZ_AR_TX_CUS_CLS_ALL',
      p_sig_sql                => 'select * from JL_ZZ_AR_TX_CUS_CLS_ALL
where org_id = ##$$ORG_ID$$##
and tax_category_id = ##$$TAX_CATEGORY_ID$$##',
      p_title                  => 'JL_ZZ_AR_TX_CUS_CLS_ALL (Customer Classifications)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data in JL_ZZ_AR_TX_CUS_CLS_ALL for tax category = '||mask_text(g_tax_category_id_tmp, nvl( upper(''), 'NO_MASK') )||'.
',
      p_solution               => 'No data found in JL_ZZ_AR_TX_CUS_CLS_ALL. This does not necessarily indicate a problem.<br>
If you want to define a class, please do the following:
<ul>
<li>Create a class of one of three types, Organization, Transaction and Contributor, for a given customer site (ADDRESS_ID).</li>
<li>For this combination, you can associate condition values for conditions of one or more tax categories. </li>
<li>Mandatory tax categories should have at least their mandatory conditions present in every class.</li>
</ul>
For more information, please read [784692.1#aref_section214] Troubleshooting Latin America Tax Release 12 Tax Calculation Issues.',
      p_success_msg            => 'Displaying Latin Tax class information that use tax category = '||mask_text(g_tax_category_id_tmp, nvl( upper(''), 'NO_MASK') )||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_ZZ_AR_TX_CUS_CLS_ALL');



debug('begin add_signature: JL_ZZ_AR_TX_CAT_ATT_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7136',
      p_sig_id                 => 'JL_ZZ_AR_TX_CAT_ATT_ALL',
      p_sig_sql                => 'select * from JL_ZZ_AR_TX_CAT_ATT_ALL
where org_id = ##$$ORG_ID$$##
and tax_category_id = ##$$TAX_CATEGORY_ID$$##',
      p_title                  => 'JL_ZZ_AR_TX_CAT_ATT_ALL (Tax Condition Values)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data in JL_ZZ_AR_TX_CAT_ATT_ALL for tax category = '||mask_text(g_tax_category_id_tmp, nvl( upper(''), 'NO_MASK') )||'.
',
      p_solution               => 'Please associate a tax category with all the conditions that are applicable for it.<br>
<ul>
<li>It is also used to indicate conditions which are mandatory in every class and those which are determining factors.</li>
<li>When MANDATORY_IN_CLASS is set to Yes for a condition, Oracle Receivables will ensure that any tax class with this tax category includes this condition.</li>
<li>Exactly one mandatory condition can have the DETERMINING_FACTOR set to Yes for a given tax category and type. </li>
<li>This information is updated in JL_ZZ_AR_TX_CATEG_ALL automatically by Oracle Receivables.</li>
</ul>
',
      p_success_msg            => 'Displaying Latin Tax category association with conditions information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_ZZ_AR_TX_CAT_ATT_ALL');



debug('begin add_signature: JL_ZZ_AR_TX_LGL_MSG_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7126',
      p_sig_id                 => 'JL_ZZ_AR_TX_LGL_MSG_ALL',
      p_sig_sql                => 'select * from JL_ZZ_AR_TX_LGL_MSG_ALL
where org_id = ##$$ORG_ID$$##',
      p_title                  => 'JL_ZZ_AR_TX_LGL_MSG_ALL (Legal Messages)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'No data in JL_ZZ_AR_TX_LGL_MSG_ALL.
',
      p_solution               => 'No data found in JL_ZZ_AR_TX_LGL_MSG_ALL, does not necessarily indicate a problem.  Legal Messages are optional.<br>
<ul>
<li>This table stores the legal messages for tax exceptions and is the table on which the Latin Legal Messages form and Legal Messages windows in other forms are based.</li>
<li>Each row is an association of rule type and corresponding rule data, with an exception for which a legal message is assigned.</li>
</ul>',
      p_success_msg            => 'Displaying Latin Tax legal messages information that use tax category = '||mask_text(g_tax_category_id_tmp, nvl( upper(''), 'NO_MASK') )||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_ZZ_AR_TX_LGL_MSG_ALL');



debug('begin add_signature: JL_AR_LTE_APPLICATION_TAX_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10068',
      p_sig_id                 => 'JL_AR_LTE_APPLICATION_TAX_OPTIONS',
      p_sig_sql                => 'SELECT distinct ProductOptionAllEO.ORG_ID,   
 HrOperatingUnits.NAME as Operating_Unit,
ProductOptionAllEO.APPLICATION_ID,    
  Decode(ProductOptionAllEO.EVENT_CLASS_MAPPING_ID,null,( SELECT  APPLICATION_SHORT_NAME
  FROM FND_APPLICATION_VL 
 WHERE APPLICATION_ID = ProductOptionAllEO.APPLICATION_ID),''OIE_NAME'' ) as Application_Short_Name,
ProductOptionAllEO.DEF_OPTION_HIER_1_CODE,    
ProductOptionAllEO.DEF_OPTION_HIER_2_CODE,    
ProductOptionAllEO.DEF_OPTION_HIER_3_CODE,    
ProductOptionAllEO.DEF_OPTION_HIER_4_CODE,    
ProductOptionAllEO.DEF_OPTION_HIER_5_CODE,    
ProductOptionAllEO.DEF_OPTION_HIER_6_CODE,  
ProductOptionAllEO.DEF_OPTION_HIER_7_CODE,   
ProductOptionAllEO.TAX_CLASSIFICATION_CODE,   
ProductOptionAllEO.TAX_METHOD_CODE,           
ProductOptionAllEO.TAX_USE_CUSTOMER_EXEMPT_FLAG,  
ProductOptionAllEO.TAX_ROUNDING_RULE,         
ProductOptionAllEO.TAX_PRECISION,                  
ProductOptionAllEO.TAX_MINIMUM_ACCOUNTABLE_UNIT,   
ProductOptionAllEO.USE_TAX_CLASSIFICATION_FLAG,   
ProductOptionAllEO.ALLOW_TAX_ROUNDING_OVRD_FLAG ,   
ProductOptionAllEO.RECORD_TYPE_CODE,                 
ProductOptionAllEO.EVENT_CLASS_MAPPING_ID,
ProductOptionAllEO.PRODUCT_OPTIONS_ID,
ProductOptionAllEO.SALES_TAX_GEOCODE,
        ProductOptionAllEO.ORG_ID TRANS_ORG_ID 
FROM    ZX_PRODUCT_OPTIONS_ALL ProductOptionAllEO,
HR_OPERATING_UNITS HrOperatingUnits,
ZX_PARTY_TAX_PROFILE ZXPTP
WHERE   ProductOptionAllEO.ORG_ID= HrOperatingUnits.ORGANIZATION_ID
AND ProductOptionAllEO.tax_method_code = ''EBTAX''
AND ProductOptionAllEO.APPLICATION_ID = ''222''
AND ProductOptionAllEO.ORG_ID = ''##$$ORG_ID$$##''',
      p_title                  => 'Setup for Application Tax Options',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Application Tax Options is not set to Tax Method = Latin Tax. This will cause taxes to fail to calculate when the Latin Tax engine is in use.',
      p_solution               => 'For more information, please read section 3b in [784692.1#aref_section25] Troubleshooting Latin America Tax Release 12 Tax Calculation Issues.',
      p_success_msg            => 'Application Tax Options has Tax Method = ''Latin Tax'' set correctly.',
   ...
   l_info.delete;
debug('end add_signature: JL_AR_LTE_APPLICATION_TAX_OPTIONS');



debug('begin add_signature: JL_AR_LTE_LATIN TAX_REGIME_SUBSCRIPTION');
  ...
  add_signature(
      p_sig_repo_id            => '10070',
      p_sig_id                 => 'JL_AR_LTE_LATIN TAX_REGIME_SUBSCRIPTION',
      p_sig_sql                => 'SELECT * FROM (SELECT SubscriptionOptionEO.REGIME_USAGE_ID, pty.party_name, pty.party_type_code, 
pty.address_line_1 || '' '' ||  pty.address_line_2 || '' '' || pty.address_line_3 || '' '' || pty.town_or_city || '' '' || 
pty.region_1 || '' '' || pty. region_2 ||  '' '' || pty.postal_code 
AS Address, ter.territory_short_name AS country_name, SubscriptionOptionEO.SUBSCRIPTION_OPTION_ID, 
SubscriptionOptionEO.SUBSCRIPTION_OPTION_CODE, SubscriptionOptionEO.EXCEPTION_OPTION_CODE, 
SubscriptionOptionEO.PARENT_FIRST_PTY_ORG_ID, SubscriptionOptionEO.EFFECTIVE_FROM, SubscriptionOptionEO.ENABLED_FLAG,    
SubscriptionOptionEO.ALLOW_SUBSCRIPTION_FLAG, SubscriptionOptionEO.EFFECTIVE_TO, HZP. PARTY_NAME AS SERVICE_PROVIDER,     
ServiceSubscriptionEO.PROD_FAMILY_GRP_CODE, ServiceSubscriptionEO.SRVC_PROVIDER_ID, ServiceSubscriptionEO.EFFECTIVE_FROM 
AS ServiceEffFrom, ServiceSubscriptionEO.EFFECTIVE_TO AS ServiceEfftO, ServiceSubscriptionEO.ENABLED_FLAG 
AS ServiceEnabledFlag, RegimesUsage.first_pty_org_id, RegimesUsage.tax_regime_id, RegimesUsage.tax_regime_code, 
reg.tax_regime_name, lkp.meaning as party_type, RegimesUsage.first_pty_org_id AS Trans_first_pty_org_id        
FROM zx_regimes_usages RegimesUsage, ZX_SUBSCRIPTION_OPTIONS SubscriptionOptionEO, ZX_SRVC_SUBSCRIPTIONS ServiceSubscriptionEO, 
zx_first_party_orgs_all_v pty, fnd_lookups lkp, zx_regimes_vl reg, fnd_territories_vl ter, ZX_PARTY_TAX_PROFILE ptp, HZ_PARTIES HZP 
...
AND SubscriptionOptionEO.subscription_option_code = ''GCO_ONLY''
...
WHERE (upper(tax_regime_code) = upper(''##$$LATIN_TAX_REGIME$$##'') 
AND FIRST_PTY_ORG_ID = ''##$$ORG_ID$$##'')',
      p_title                  => 'Common Configuration with Party Overrides',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Configuration for taxes and rules is not set to <em>Common Configuration with Party Overrides</em>.',
      p_solution               => 'For more information, please read step 3d [784692.1#aref_section27] Troubleshooting Latin America Tax Release 12 Tax Calculation Issues.',
      p_success_msg            => 'Configuration for Tax Regime is set to Common Configuration with Party Overrides.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_AR_LTE_LATIN TAX_REGIME_SUBSCRIPTION');



debug('begin add_signature: JL_AR_LTE_WRONG_TAX_METHOD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7164',
      p_sig_id                 => 'JL_AR_LTE_WRONG_TAX_METHOD',
      p_sig_sql                => 'select application_id, org_id, tax_method_code from ZX_PRODUCT_OPTIONS_ALL
WHERE application_id = 222
AND ORG_ID = ##$$ORG_ID$$##
AND tax_method_code = ''EBTAX''',
      p_title                  => 'Incorrect Tax Determination Method',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Tax Determination Method incorrectly set to E-Business Tax instead of Latin Tax Engine.',
      p_solution               => 'For more information, please read [554712.1] Change Tax Determination Method From Latin Tax Engine To E-Business Tax? ',
      p_success_msg            => 'Latin Tax method is setup.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: JL_AR_LTE_WRONG_TAX_METHOD');



debug('begin add_signature: JL_AR_LTE_TRANSACTION_TYPE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10151',
      p_sig_id                 => 'JL_AR_LTE_TRANSACTION_TYPE',
      p_sig_sql                => 'SELECT a.name, a.description, a.cust_trx_type_id, a.org_id, a.tax_calculation_flag FROM RA_CUST_TRX_TYPES_ALL a
WHERE a.cust_trx_type_id = ##$$CUST_TRX_TYPE_ID$$##
AND NVL(a.org_id, -99) = ##$$ORG_ID$$##
AND a.tax_calculation_flag = ''N''',
      p_title                  => 'Default Tax Classification Flag on Transaction  Type',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Default Tax Classification flag for the transaction type is not enabled.',
      p_solution               => 'To allow for tax calculation, the transaction type must be enabled to calculate tax. Please do the following:
<ul>
<li>Responsibility: Receivables Manager</li>
<li>Navigation: Setup > Transactions > Transaction Types</li>
<li>Query the transaction type, and check <em>Default Tax Classification Code</em></li>
<li>Save</li>
</ul>

For more information, please read step 3f [784692.1#aref_section29] Troubleshooting Latin America Tax Release 12 Tax Calculation Issues.',
      p_success_msg            => 'Default Tax Classification flag for the transaction type is checked.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_AR_LTE_TRANSACTION_TYPE');



debug('begin add_signature: JL_AR_LTE_CAT_NOT_SYNC_ZX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7118',
      p_sig_id                 => 'JL_AR_LTE_CAT_NOT_SYNC_ZX',
      p_sig_sql                => 'SELECT VAT.TAX_CODE 
...
AND PTP.PARTY_ID = VAT.ORG_ID
AND PTP.PARTY_TAX_PROFILE_ID = TAX.CONTENT_OWNER_ID
AND TAX.TAX = CATEG.TAX_CATEGORY
AND CATEG.TAX_CATEGORY_ID = GLOBAL_ATTRIBUTE1
AND CATEG.ORG_ID = VAT.ORG_ID)',
      p_title                  => 'Unsynchronized Tax Records in ZX and JL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Tax records exist in AR_VAT_TAX_ALL, but do not exist in ZX/JL tables.
',
      p_solution               => 'For more information, please read [1333342.1] Need A Report Or Query To Make Sure All The LTE Tax Categories Are Migrated To Ebtax ZX Tables.',
      p_success_msg            => 'Tax categories and tax codes are synchronized between AR, JL and ZX tables.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_AR_LTE_CAT_NOT_SYNC_ZX');



debug('begin add_signature: JL_AR_LTE_DEFAULT_COUNTRY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7120',
      p_sig_id                 => 'JL_AR_LTE_DEFAULT_COUNTRY',
      p_sig_sql                => 'select default_country from AR_system_parameters_all
where ORG_ID = ##$$ORG_ID$$##
and default_country not in (''BR'',''CO'',''AR'')',
      p_title                  => 'Incorrect Default Country',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'When assigning tax condition classes to the organization, invoking the list of values for Tax Code does not show tax codes you previously defined.
',
      p_solution               => 'For more information, please read [731989.1] Latin Tax Engine Issue: Tax Codes Not Displaying in List of Values (LOV) When Setting Up Latin America Localizations.',
      p_success_msg            => 'No issues identified in default country setup.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_AR_LTE_DEFAULT_COUNTRY');



debug('begin add_signature: JL_AR_LTE_NULL_GLOBAL_ATT1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7112',
      p_sig_id                 => 'JL_AR_LTE_NULL_GLOBAL_ATT1',
      p_sig_sql                => 'select tax_code, global_attribute1, tax_regime_code FROM ar_vat_tax_all_b
where global_attribute1 is null
and tax_regime_code = ''##$$LATIN_TAX_REGIME$$##''',
      p_title                  => 'GLOBAL_ATTRIBUTE1 is NULL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The GLOBAL_ATTRIBUTE1 field is incorrectly set to NULL.  When you attempt to add a new category on Fiscal Classifications, you may receive error:<br> 
FRM-41830: List of Values contains no entries.',
      p_solution               => 'For more information, please read [1593259.1] Latin Tax Engine: Tax Codes Are Not Available On List Of Values For Latin Fiscal Classifications.
',
      p_success_msg            => 'Tax Category is associated to Latin Tax Code.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_AR_LTE_NULL_GLOBAL_ATT1');



debug('begin add_signature: JL_AR_LTE_DISABLED_CALCULATE_IN_OM');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7165',
      p_sig_id                 => 'JL_AR_LTE_DISABLED_CALCULATE_IN_OM',
      p_sig_sql                => 'select b.tax_code TAX_GROUP_NAME, a.TAX_GROUP_RECORD_ID, a.GROUP_TAX_ID, a.TAX_CATEGORY_ID, a.ESTABLISHMENT_TYPE, 
       a.CONTRIBUTOR_TYPE, a.TRANSACTION_NATURE, a.CALCULATE_IN_OE "CALCULATE IN OM FLAG"
from jl_zz_ar_tx_groups_all a, ar_vat_tax_all_vl b
WHERE NVL(a.calculate_in_oe,''N'') = ''N'' 
and a.tax_category_id = ##$$TAX_CATEGORY_ID$$##
and a.group_tax_id = b.vat_tax_id',
      p_title                  => 'Disabled "Calculate in OM" Flag',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The setting for ''Calculate in OM'' flag is not checked. This can cause error: ORA-20001: APP-AR-11526: Could Not Expand Tax Group Successfully when attempting to Calculate Latin Tax in Order Management.',
      p_solution               => 'For more information, please read [1995865.1] There are no applicable tax categories for the tax group and [2021246.1] Latin Tax Engine: ORA-20001: APP-AR-11526: Could Not Expand Tax Group Successfully.',
      p_success_msg            => 'No issue detected regarding <em>Calculate in OM</em> flag.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_AR_LTE_DISABLED_CALCULATE_IN_OM');



debug('begin add_signature: JL_AR_LTE_INCORRECT_COUNTRY_CODE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7159',
      p_sig_id                 => 'JL_AR_LTE_INCORRECT_COUNTRY_CODE',
      p_sig_sql                => 'select country_code from ZX_FC_CODES_B
where classification_code = ''DEFAULT''
AND CLASSIFICATION_TYPE_CODE = ''PRODUCT_CATEGORY''
AND PARENT_CLASSIFICATION_CODE = ''FISCAL CLASSIFICATION CODE''
and country_code is null',
      p_title                  => 'Missing Country Code = NULL Record',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'When defining a memo line for a transaction, and you unable to populate tax product category. <br>
You may receive error: FRM-41830: List Of Values Contains No Entries.',
      p_solution               => 'The issue is due to the absence of a record that has country code set to Null which can be used for any country. <br>
For more information, please read [2077296.1] Tax Product Category Not Showing DEFAULT Value For Argentina.',
      p_success_msg            => 'Country code is not null on Tax Product Category.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_AR_LTE_INCORRECT_COUNTRY_CODE');



debug('begin add_signature: JL_AR_LTE_MEMO_LINE_NO_ORG_CLASS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7121',
      p_sig_id                 => 'JL_AR_LTE_MEMO_LINE_NO_ORG_CLASS',
      p_sig_sql                => 'SELECT HRL.LOCATION_ID,
HRL.GLOBAL_ATTRIBUTE1
FROM HR_LOCATIONS_ALL HRL ,
HR_ORGANIZATION_UNITS ORG
WHERE ORG.LOCATION_ID = HRL.LOCATION_ID
AND ORG.ORGANIZATION_ID = ##$$ORG_ID$$##',
      p_title                  => 'Missing Organization Class',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Unable to complete an invoice with memo lines.<br> 
You may receive error:<br> 
There are no applicable tax categories for the tax group.
',
      p_solution               => 'For more information, please read [804659.1] Latin Tax Error: Calculating Taxes for Memo Lines Raises Error: There are no applicable tax categories for the tax group.',
      p_success_msg            => 'Your Organization Tax Class of the Internal Org_ID  matches that defined for the Inventory Org_ID.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_AR_LTE_MEMO_LINE_NO_ORG_CLASS');



debug('begin add_signature: JL_AR_LTE_MISSING_COUNTRY_DEFAULTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7122',
      p_sig_id                 => 'JL_AR_LTE_MISSING_COUNTRY_DEFAULTS',
      p_sig_sql                => 'SELECT ''Located records for country code'' Status
FROM ZX_FC_PRODUCT_FISCAL_V
where country_code = ''##$$COUNTRY_CODE$$##''',
      p_title                  => 'Missing Country Default',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'When attempting to save the line items in the Line Items tab of the Sales Orders form, you discover that there are missing record(s) in ZX_FC_PRODUCT_FISCAL_V.<br> You may receive error: No Tax Code associated to RATE level rule for Tax Category.',
      p_solution               => 'For more information, please read [1479647.1] Latin Tax: The Fiscal Classification Code is Not Passed to the Tax Engine - No Tax Code associated to RATE level rule for Tax Category VAT and Contributor Type CLIENTES NACIONALES.',
      p_success_msg            => 'Country contains link to FISCAL_CLASSIFICATION.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_AR_LTE_MISSING_COUNTRY_DEFAULTS');



debug('begin add_signature: JL_AR_LTE_END_DATED_TAX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7152',
      p_sig_id                 => 'JL_AR_LTE_END_DATED_TAX',
      p_sig_sql                => 'select tax 
from ZX_TAXES_B
where tax = ''##$$TAX$$##''
and ''##$$TAX$$##'' is not null
and effective_to  < sysdate',
      p_title                  => 'End-Dated Tax',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The tax being used is end-dated. This may cause an error when importing transactions using AutoInvoice:<br>
The system cannot find tax information for tax regime and tax.
',
      p_solution               => 'For more information, please read [1916481.1] Latin Tax: Running AutoInvoice Getting Error: The System Cannot Find Tax Information for Tax Regime ARGENTINA-VAT and Tax IVA. Please Contact Your Tax Manager.',
      p_success_msg            => 'No issue found. The tax is not end-dated, or there is no tax code associated to the tax category. ',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_AR_LTE_END_DATED_TAX');



debug('begin add_signature: JL_AR_LTE_MISSING_LOOKUP_TAX_CATEGORY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7166',
      p_sig_id                 => 'JL_AR_LTE_MISSING_LOOKUP_TAX_CATEGORY',
      p_sig_sql                => 'select lookup_type, end_date_active from fnd_lookup_values
where lookup_type = ''JLZZ_AR_TX_FISCAL_CLASS_CODE''
and end_date_active is not null',
      p_title                  => 'Missing Tax Product Category Lookup',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Unable to populate the Tax Product Category field on the Memo Lines form.<br>
You may receive error.:<br>
FRM-41830: List Of Values Contains No Entries.
',
      p_solution               => 'For more information, please read [1949891.1] Latin Tax: On Memo Lines Form: Tax Product Category Is Not Listing Any Values.',
      p_success_msg            => 'Fiscal Classification is enabled.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_AR_LTE_MISSING_LOOKUP_TAX_CATEGORY');



debug('begin add_signature: JL_AR_LTE_TAX_CODE_MISSING_FROM_TAX_GROUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7119',
      p_sig_id                 => 'JL_AR_LTE_TAX_CODE_MISSING_FROM_TAX_GROUP',
      p_sig_sql                => 'SELECT TAX_GROUP_RECORD_ID, GROUP_TAX_ID, TAX_CATEGORY_ID, ESTABLISHMENT_TYPE, CONTRIBUTOR_TYPE, TRANSACTION_NATURE, TAX_CODE
FROM JL_ZZ_AR_TX_GROUPS_ALL g
WHERE TAX_CODE is NULL
AND tax_category_id = ##$$TAX_CATEGORY_ID$$##
AND ORG_ID = ##$$ORG_ID$$##
AND EXISTS (SELECT 1
            FROM JL_ZZ_AR_TX_RULES_ALL r
            where r.tax_category_id = g.tax_category_id)',
      p_title                  => 'Tax Code Missing From Tax Group',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Attempt to save an invoice and discover that the tax code on tax category = '||mask_text(g_tax_category_id_tmp, nvl( upper(''), 'NO_MASK') )||'. in tax group is null. This may cause error:<br>
No tax Code associated to Rate level rule for Tax Category.',
      p_solution               => 'For more information, please read [1539196.1] Using LTE, Got No Tax Code Associated To Rate Level Rule For Tax Category ICMS_ST_C Saving A Transaction.',
      p_success_msg            => 'Tax code is present on the tax group for tax category = '||mask_text(g_tax_category_id_tmp, nvl( upper(''), 'NO_MASK') )||'.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_AR_LTE_TAX_CODE_MISSING_FROM_TAX_GROUP');



debug('begin add_signature: JL_AR_LTE_TAX_RATE_DOES_NOT_EXIST');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7074',
      p_sig_id                 => 'JL_AR_LTE_TAX_RATE_DOES_NOT_EXIST',
      p_sig_sql                => 'SELECT tax_code 
FROM AR_VAT_TAX_ALL v
WHERE TAX_TYPE = ''TAX_GROUP''
and org_id = ##$$ORG_ID$$##
and not exists (select 1
                from ZX_OUTPUT_CLASSIFICATIONS_V z
                where z.tax_type = v.tax_type
                and   v.tax_code = z.meaning)',
      p_title                  => 'Tax Code Does Not Exist in ZX',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'AR_VAT_TAX_ALL.TAX_CODE does not exist in ZX_OUTPUT_CLASSIFICATIONS_V.MEANING. This may cause AutoInvoice to raise error:<br>
This Tax Rate does not exist.',
      p_solution               => 'For more information, please read [1524582.1] Latin Tax Engine (LTE): AutoInvoice Completes with Error - Tax Rate Does Not Exist.',
      p_success_msg            => 'No issues identified with tax group setup.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_AR_LTE_TAX_RATE_DOES_NOT_EXIST');



debug('begin add_signature: JL_AR_LTE_APP_AR_11526');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7155',
      p_sig_id                 => 'JL_AR_LTE_APP_AR_11526',
      p_sig_sql                => 'SELECT VAT_TAX_ID,TAX_TYPE,TAX_CODE
FROM AR_VAT_TAX_ALL
WHERE TAX_TYPE <> ''TAX_GROUP''
AND ORG_ID = ##$$ORG_ID$$##
AND NOT EXISTS (SELECT 1 FROM ZX_RATES_B
                WHERE TAX_RATE_ID = VAT_TAX_ID)',
      p_title                  => 'Missing Records in ZX_RATES_B',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'AR_VAT_TAX_ALL.VAT_TAX_ID does not exist in ZX_RATES_B.TAX_RATE_ID. This could cause AutoInvoice to fail with error: ORA-20001: APP-AR-11526: EXCEPTION(NO_DATA_FOUND): jl_zz_tax.calculate.',
      p_solution               => 'For more information, please read [1963693.1] LAC/LAS: Autoinvoice Import Error: ERROR From EBusiness Tax - Return Code = 2.',
      p_success_msg            => 'Tax rate setup is correct.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_AR_LTE_APP_AR_11526');



debug('begin add_signature: JL_AR_LTE_INCONSISTENT_INV');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7117',
      p_sig_id                 => 'JL_AR_LTE_INCONSISTENT_INV',
      p_sig_sql                => 'select  int.interface_line_id,  int.batch_source_name, bat.inventory_item_rule
from ra_interface_lines_all int, ra_batch_sources_all bat
where int. batch_source_name =  bat.name
and int.org_id = ##$$ORG_ID$$##
and bat.org_id = int.org_id
and ((bat.inventory_item_rule = ''Id'' and int.mtl_system_items_seg1 is not null)
      or 
      (bat.inventory_item_rule = ''Segment'' and int.inventory_item_id is not null))',
      p_title                  => 'Inconsistent Inventory Item ID/Segment',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Inventory item information provided in RA_INTERFACE_LINES_ALL does not conform to the batch source setup. <br>
Passing the value into the incorrect field may cause issues in AutoInvoice wherein no tax lines are created. <br>
The interface tax line may error, but process runs successfully and created the line but not the taxes. <br>
The following errors may be found in the tax debug logfile:<br>
APP-JL-62589: There are no applicable tax categories for the tax group
ORA-20001: APP-AR-11526: Required Parameter Missing: Transaction Condition Class
',
      p_solution               => 'Please validate that you are passing the right value into the right field depending on how you have defined your batch source.<br>
For more information, please read [1524578.1] Autoinvoice Runs Successful But Tax Lines Were Not Created Using Latin Tax Engine (LTE) Error in Log for Tax Lines - APP-JL-62589 ORA-20001.',
      p_success_msg            => 'Inventory item information provided in RA_INTERFACE_LINES_ALL matches batch source.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_AR_LTE_INCONSISTENT_INV');



debug('begin add_signature: JL_AR_LTE_MISSING_FISCAL_CLASS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7116',
      p_sig_id                 => 'JL_AR_LTE_MISSING_FISCAL_CLASS',
      p_sig_sql                => 'SELECT concat_classif_code classification_code, classification_name, effective_from, effective_to
FROM ZX_FC_CODES_DENORM_B FC
WHERE FC.CLASSIFICATION_TYPE_CODE = ''PRODUCT_CATEGORY''
AND FC.LANGUAGE = USERENV(''LANG'')
AND FC.ENABLED_FLAG = ''Y''
AND ANCESTOR_CODE = ''FISCAL CLASSIFICATION CODE''
AND country_code IN (''BR'',''AR'',''CO'')
AND sysdate >= effective_from
AND sysdate <= NVL(effective_to, sysdate)
AND NOT EXISTS (SELECT 1 FROM JL_ZZ_AR_TX_FSC_CLS_ALL
WHERE fiscal_classification_code = classification_code
AND enabled_flag = ''Y'')',
      p_title                  => 'Fiscal Classification Missing in JL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Fiscal classification code is missing from JL table. When you attempt to populate the Tax Product Category field on the memo Lines screen you may receive error:<br>
FRM-41830: List of values contains no entries.',
      p_solution               => 'For more information, please read [1637966.1] Latin Tax Engine: Attempting to Populate Tax Product Category Field on the Memo Lines Screen and Receive Error - FRM-41830: List Of Values Contains No Entries.',
      p_success_msg            => 'Tax Category is assigned to the Fiscal Classification.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_AR_LTE_MISSING_FISCAL_CLASS');



debug('begin add_signature: JL_ZZ_AR_TX_EXC_CUS_ALL');
   l_info('##MASK##ATTRIBUTE%'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7131',
      p_sig_id                 => 'JL_ZZ_AR_TX_EXC_CUS_ALL',
      p_sig_sql                => 'SELECT *
from JL_ZZ_AR_TX_EXC_CUS_ALL
where org_id = ##$$ORG_ID$$##
and tax_category_id = ##$$TAX_CATEGORY_ID$$##',
      p_title                  => 'JL_ZZ_AR_TX_EXC_CUS_ALL (Exception Customer Site)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data in JL_ZZ_AR_TX_EXC_CUS_ALL for tax category = '||mask_text(g_tax_category_id_tmp, nvl( upper(''), 'NO_MASK') )||'.',
      p_solution               => 'No data found in JL_ZZ_AR_TX_EXC_CUS_ALL, does not necessarily indicate a problem.  Latin Tax Customer Site Exceptions are optional.<br>
<ul>
<li>This table stores exceptions by customer site. </li>
<li> It can also be used to store different tax codes or base rate modifier for different effective periods for a given customer site (ADDRESS_ID). </li>
</ul>.',
      p_success_msg            => 'Displaying Latin Tax customer site exception information that use tax category = '||mask_text(g_tax_category_id_tmp, nvl( upper(''), 'NO_MASK') )||'.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_ZZ_AR_TX_EXC_CUS_ALL');



debug('begin add_signature: JL_AR_ICMS_CATEGORY_TYPE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14230',
      p_sig_id                 => 'JL_AR_ICMS_CATEGORY_TYPE',
      p_sig_sql                => 'select application_id,lookup_type,customization_level,view_application_id
from fnd_lookup_types
where lookup_type = ''JLZZ_AR_ICMS_CATEGORY_TYPE''',
      p_title                  => 'ICMS Category Type',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The ICMS Category Type is missing ICMS attributes values.<br>
This is required for interstate transactions for the new Brazilian legislation.',
      p_solution               => 'You will need a code change to resolve this issue.<br>
Review [2136249.1] ICMS Category Type does not Show on Tax Categories Screen.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: JL_AR_ICMS_CATEGORY_TYPE');
...
debug('begin add_signature: JL_AR_LTE_UNSYNCH_GLOBAL_ATT1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7154',
      p_sig_id                 => 'JL_AR_LTE_UNSYNCH_GLOBAL_ATT1',
      p_sig_sql                => 'select ar.tax_code, ar.tax, ar.global_attribute1, ar.tax_regime_code, ar.org_id from ar_vat_tax_all_b ar
WHERE ar.global_attribute1 IS NULL
AND ar.tax_regime_code = ''##$$LATIN_TAX_REGIME$$##''
AND not exists (SELECT jl.tax_category_id
                FROM jl_zz_ar_tx_categ_all jl
                WHERE jl.tax_category = ar.tax
                AND jl.org_id = ar.org_id
                AND jl.tax_rule_set in (''COLOMBIA'',''BRAZIL'',''ARGENTINA''))',
      p_title                  => 'Unsynchronized GLOBAL_ATTRIBUTE1 and TAX_CATEGORY_ID',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The association of tax category to tax code is missing. This may cause the following error:<br>
FRM-41830: List Of Value Contains No Entries when you invoke the list of values for tax code on tax group form.',
      p_solution               => 'For more information, please read [1943052.1] Latin Tax Group Does Not Show All Tax Codes in the List of Values (LOV) - FRM-41830 List of Value Contain No Entries.',
      p_success_msg            => 'Tax Category is associated with Tax Code.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_AR_LTE_UNSYNCH_GLOBAL_ATT1');



debug('begin add_signature: JL_AR_LTE_MISSING_TAX_CODE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7115',
      p_sig_id                 => 'JL_AR_LTE_MISSING_TAX_CODE',
      p_sig_sql                => 'SELECT rate.tax_rate_id,
rate.tax_rate_code,
...
zx_taxes_b tax,
zx_status_b status
WHERE rate.tax_rate_id NOT IN (SELECT vat_tax_id FROM ar_vat_tax_all_b)
...
and regime.tax_regime_code = ''##$$LATIN_TAX_REGIME$$##''',
      p_title                  => 'Tax Code Missing from AR_VAT_TAX_ALL_B',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Cannot create Latin Tax Group.<br>
You may receive error:<br>
ORA-20001: APP-AR-11526: EXCEPTION(NO_DATA_FOUND): jl_zz_tax.calculate.',
      p_solution               => 'For more information, please read [959854.1] Latin Tax Group Errors.',
      p_success_msg            => 'No corrupted Tax Codes.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_AR_LTE_MISSING_TAX_CODE');



debug('begin add_signature: JL_AR_LTE_UNSYNCH_AR_ZX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7163',
      p_sig_id                 => 'JL_AR_LTE_UNSYNCH_AR_ZX',
      p_sig_sql                => 'select z.tax_rate_code, z.tax "ZX_RATES_B Tax", a.tax "AR_VAT_TAX_ALL Tax"
from zx_rates_b z, ar_vat_tax_all a
where z.tax_rate_code = a.tax_code
and org_id = ##$$ORG_ID$$##
and z.tax <> a.tax
and z.active_flag = ''Y'' 
and a.enabled_flag = ''Y''',
      p_title                  => 'Unsynchronized data in ZX_RATES_B and AR_VAT_TAX_ALL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'While running the Autoinvoice using Latin Tax Engine, the same tax is applied on multiple lines for one LINE_TYPE = Line.  This may result in an error:<br>  
ERROR: from eBusiness Tax - return code = 2 <br>
and/or<br>
Error occurred while inserting tax lines in ZX_DETAIL_TAX_LINES_GT when running AutoInvoice.<br>
<br>
The tax in ZX_RATES_B and AR_VAT_TAX_ALL needs to be in sync for the same rate.',
      p_solution               => 'Please open a SR with Oracle support to fix your data.  For more information, please read [2239867.1] Autoinvoice: ERROR: from EBusiness Tax - Return Code = 2.
',
      p_success_msg            => 'Data in ZX_RATES_B and AR_VAT_TAX_ALL is synchronized.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_AR_LTE_UNSYNCH_AR_ZX');



debug('begin add_signature: JL_GEN_JL_INVALIDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9855',
      p_sig_id                 => 'JL_GEN_JL_INVALIDS',
...
AND a.owner = ''APPS''
AND (a.object_name like ''JL%'')
AND a.status = ''INVALID''
order by 1',
      p_title                  => 'Oracle Financials for the Americas (JL)  Invalid PL/SQL Packages',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are Oracle Financials for the Americas (JL) invalid PL/SQL packages.',
...
<li>If you still have invalid objects, please review steps from [1325394.1] Troubleshooting Guide - Invalid Objects in the E-Business Suite Environment 11i and 12</li>
      ...
      p_success_msg            => 'There are no invalid objects for Oracle Financials for the Americas (JL) in the database.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_GEN_JL_INVALIDS');
...
debug('begin add_signature: JL_GEN_TRIGGERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10595',
      p_sig_id                 => 'JL_GEN_TRIGGERS',
      p_sig_sql                => 'select   trigger_name, table_name, status, owner
from     dba_triggers
where    table_name like ''JL%''',
      p_title                  => 'Oracle Financials for the Americas (JL) Triggers',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No database triggers found on Oracle Financials for the Americas (JL) tables.',
      p_solution               => '',
      p_success_msg            => 'Displaying database triggers on Oracle Financials for the Americas (JL) tables.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_GEN_TRIGGERS');



debug('begin add_signature: JL_GEN_JL_PKG_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10593',
      p_sig_id                 => 'JL_GEN_JL_PKG_VERSIONS',
...
order by 1',
      p_title                  => 'Oracle Financials for the Americas (JL) PL/SQL Package Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Could not locate Oracle Financials for the Americas (JL) PL/SQL package versions.',
      p_solution               => 'Please ensure that you have installed the Oracle Financials for the Americas (JL) application.',
      p_success_msg            => 'This is a data collection of Oracle Financials for the Americas (JL) PL/SQL package versions.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_GEN_JL_PKG_VERSIONS');



debug('begin add_signature: JL_GEN_JL_FORM_LIB_RPT_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10594',
      p_sig_id                 => 'JL_GEN_JL_FORM_LIB_RPT_VERSIONS',
...
and    a.creation_date = (select max(c.creation_date) 
                          ...
                          where   c.file_id = a.file_id)
order by 1',
      p_title                  => 'Oracle Financials for the Americas (JL) Forms, Libraries and Reports Versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Could not locate Oracle Financials for the Americas (JL) forms, libraries and reports versions.',
      p_solution               => 'Please ensure that you have installed the Oracle Financials for the Americas (JL) application.',
      p_success_msg            => 'Listing Oracle Financials for the Americas (JL) forms, libraries and reports versions.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_GEN_JL_FORM_LIB_RPT_VERSIONS');
...
debug('begin add_signature: JL_AR_LTE_PROF_JL_TAX_ID');
   l_info('##MASK##LVALUE'):= 'NO_MASK';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7073',
      p_sig_id                 => 'JL_AR_LTE_PROF_JL_TAX_ID',
      p_sig_sql                => 'SELECT SUBSTR(e.profile_option_name,1,25) PROFILE,
       DECODE(a.level_id,10001,''Site'',10002,''Application'',10003,''Resp'',10004,''User'') L,
       DECODE(a.level_id,10001,''Site'',10002,c.application_short_name,10003,b.responsibility_name,10004,##$$A$$##.mask_text(d.user_name,''##$$M$$##'')) LValue,
...
WHERE e.profile_option_name IN (''JLZZ_TAXID_RAISE_ERROR'')
...
ORDER BY profile_option_name',
      p_title                  => 'Profile Option - JL: Tax ID Validation Failure',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'You have not defined settings for Profile option JL: Tax ID Validation Failure. This profile allows you to control whether messages will appear as warnings or errors to help ensure taxpayer ID values are entered properly.',
      p_solution               => 'For more information on how to set this profile option based on Argentina requirements, please read [136201.1] Receivables Taxpayer ID Validation for Argentina.',
      p_success_msg            => 'Displaying Profile option JL: Tax ID Validation Failure information.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_AR_LTE_PROF_JL_TAX_ID');



debug('begin add_signature: JL_AR_LTE_INCORRECT_STATE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7151',
      p_sig_id                 => 'JL_AR_LTE_INCORRECT_STATE',
      p_sig_sql                => 'select geography_code 
from hz_geographies 
where geography_type = ''STATE'' 
and geography_code = (SELECT state 
                      FROM hz_locations where location_id = ##$$LOCATION_ID$$##)',
      p_title                  => 'Incorrect State Value',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'State code from HZ_LOCATIONS does not exist in HZ_GEOGRAPHIES. When you attempt to create an invoice, you may receive error:<br> Error: No Tax Code associated to RATE level rule.',
      p_solution               => 'For more information, please read [1634117.1] Creating an Invoice and Find the Latin Tax Engine Returns Error for the Ship From / Ship To Rule on Save - Error: No Tax Code Associated to RATE Level Rule for Tax Category ICMS-C and Contributor Type CONTRIBUINTE.',
      p_success_msg            => 'State code in HZ_LOCATIONS and state code in HZ_GEOGRAPHIES match.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_AR_LTE_INCORRECT_STATE');



debug('begin add_signature: JL_AR_LTE_UNSYNCH_TAX_CLASS_CODE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7114',
      p_sig_id                 => 'JL_AR_LTE_UNSYNCH_TAX_CLASS_CODE',
      p_sig_sql                => 'select trx.customer_trx_line_id, trx.tax_classification_code, zxl.output_tax_classification_code
from RA_CUSTOMER_TRX_LINES_ALL trx, ZX_LINES_DET_FACTORS zxl
Where trx.customer_trx_id = zxl.trx_id
And trx.customer_trx_id = ##$$TRXID$$##
And trx.line_type= ''LINE''
And nvl(trx.tax_classification_code,''xxx'') <> nvl(zxl.output_tax_classification_code,''xxx'')
And trx.customer_trx_line_id = zxl.trx_line_id',
      p_title                  => 'Unsynchronized Tax Classification Code',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Tax classification code in AR does not match value in ZX.  When attempting to create and apply a credit memo, you may receive error:<br>
JL_ZZ_TAX.calculate()- : tax_vendor_return_code 9.
',
      p_solution               => 'For more information, please read [1601888.1] Latin Tax Engine: Transactions Workbench: Creating A Credit Memo Gets An Unexpected Error Has Occurred. Please Contact Your System Administrator.',
      p_success_msg            => 'Tax classification code in AR matches value in ZX.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_AR_LTE_UNSYNCH_TAX_CLASS_CODE');



debug('begin add_signature: JL_AR_LTE_UNSYNCH_TAX_RATE_AND_CODE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7111',
      p_sig_id                 => 'JL_AR_LTE_UNSYNCH_TAX_RATE_AND_CODE',
      p_sig_sql                => 'select l.tax_rate_code, l.tax_rate_id, l.application_id, l.trx_id from zx_lines l
where l.tax_rate_code <> (select r.tax_rate_code
  from zx_rates_B r
  where r.tax_rate_id = l.tax_rate_id)
and l.trx_id = ##$$TRXID$$##
and l.application_id = 222
and l.ENTITY_CODE = ''TRANSACTIONS''
and l.EVENT_CLASS_CODE = ''INVOICE''
and l.internal_organization_id = ##$$ORG_ID$$##',
      p_title                  => 'Unsynchronized Tax Rate Code and Tax Rate ID',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The value in tax_rate_code does not match the expected tax_rate_id value. When attempting to credit a transaction you may receive an error:<br>
ORA-00001: unique constraint (ZX.ZX_DETAIL_TAX_LINES_GT_U1) violated.',
      p_solution               => 'For more information, please read [1593216.1] Latin Tax Engine: Credit An Invoice Gets An Unexpected Error Has Occurred. ORA-00001: unique constraint (ZX.ZX_DETAIL_TAX_LINES_GT_U1) violated.',
      p_success_msg            => 'The value in tax_rate_code matches expected tax_rate_id value.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_AR_LTE_UNSYNCH_TAX_RATE_AND_CODE');



debug('begin add_signature: JL_AR_LTE_COULD_NOT_EXPAND_TAX_GROUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '7158',
      p_sig_id                 => 'JL_AR_LTE_COULD_NOT_EXPAND_TAX_GROUP',
      p_sig_sql                => 'select group_tax_id, start_date_active, end_date_active, tax_code
FROM jl_zz_ar_tx_groups_all
where ''##$$TRX_DATE$$##'' between start_date_active and end_date_active',
      p_title                  => 'Transaction Date Not Within Tax Date Range',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'The transaction date does not fall within the date range for the tax group. This may cause an Autoinvoice error: Could not expand tax group successfully.
',
      p_solution               => 'For more information, please read [1666771.1] Latin Tax Engine Issue: Running Autoinvoice Receive Error - Could Not Expand Tax Group Successfully.',
      p_success_msg            => 'Tax group falls within transaction date.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: JL_AR_LTE_COULD_NOT_EXPAND_TAX_GROUP');
...
BEGIN
  ...
  analyzer_title := 'Latin Tax Analyzer';
...
debug('begin section: LTE_SETUP');
start_section('Setup', 'LTE_SETUP');
   set_item_result(run_stored_sig('JL_ZZ_AR_TX_CATEG_ALL'));
   set_item_result(run_stored_sig('JL_ZZ_AR_TX_CAT_DTL_ALL'));
   set_item_result(run_stored_sig('JL_ZZ_AR_TX_ATT_VAL_ALL'));
   set_item_result(run_stored_sig('JL_ZZ_AR_TX_ATT_CLS_ALL'));
   set_item_result(run_stored_sig('JL_ZZ_AR_TX_FSC_CLS_ALL'));
   set_item_result(run_stored_sig('JL_ZZ_AR_TX_GROUPS_ALL'));
   set_item_result(run_stored_sig('JL_ZZ_AR_TX_RULES_ALL'));
   set_item_result(run_stored_sig('JL_ZZ_AR_TX_LOCN_ALL'));
   set_item_result(run_stored_sig('JL_ZZ_AR_TX_EXC_FSC_ALL'));
   set_item_result(run_stored_sig('JL_ZZ_AR_TX_EXC_ITM_ALL'));
   set_item_result(run_stored_sig('JL_ZZ_AR_TX_CUS_CLS_ALL'));
   set_item_result(run_stored_sig('JL_ZZ_AR_TX_CAT_ATT_ALL'));
   set_item_result(run_stored_sig('JL_ZZ_AR_TX_LGL_MSG_ALL'));
   IF g_country_code = 'AR' THEN
      set_item_result(run_stored_sig('JL_AR_LTE_PROF_JL_TAX_ID'));
   END IF;
   IF g_customer_trx_id_tmp is not null THEN
      set_item_result(run_stored_sig('JL_AR_LTE_INCORRECT_STATE'));
   END IF;
   set_item_result(run_stored_sig('JL_AR_LTE_APPLICATION_TAX_OPTIONS'));
   set_item_result(run_stored_sig('JL_AR_LTE_LATIN TAX_REGIME_SUBSCRIPTION'));
   set_item_result(run_stored_sig('JL_AR_LTE_WRONG_TAX_METHOD'));
   set_item_result(run_stored_sig('JL_AR_LTE_TRANSACTION_TYPE'));
   set_item_result(run_stored_sig('JL_AR_LTE_CAT_NOT_SYNC_ZX'));
   set_item_result(run_stored_sig('JL_AR_LTE_DEFAULT_COUNTRY'));
   set_item_result(run_stored_sig('JL_AR_LTE_NULL_GLOBAL_ATT1'));
   set_item_result(run_stored_sig('JL_AR_LTE_DISABLED_CALCULATE_IN_OM'));
   set_item_result(run_stored_sig('JL_AR_LTE_INCORRECT_COUNTRY_CODE'));
   set_item_result(run_stored_sig('JL_AR_LTE_MEMO_LINE_NO_ORG_CLASS'));
   set_item_result(run_stored_sig('JL_AR_LTE_MISSING_COUNTRY_DEFAULTS'));
   set_item_result(run_stored_sig('JL_AR_LTE_END_DATED_TAX'));
   set_item_result(run_stored_sig('JL_AR_LTE_MISSING_LOOKUP_TAX_CATEGORY'));
   set_item_result(run_stored_sig('JL_AR_LTE_TAX_CODE_MISSING_FROM_TAX_GROUP'));
   set_item_result(run_stored_sig('JL_AR_LTE_TAX_RATE_DOES_NOT_EXIST'));
   set_item_result(run_stored_sig('JL_AR_LTE_APP_AR_11526'));
   set_item_result(run_stored_sig('JL_AR_LTE_INCONSISTENT_INV'));
   set_item_result(run_stored_sig('JL_AR_LTE_MISSING_FISCAL_CLASS'));
   set_item_result(run_stored_sig('JL_ZZ_AR_TX_EXC_CUS_ALL'));
   set_item_result(run_stored_sig('JL_AR_ICMS_CATEGORY_TYPE'));
end_section;
debug('end section: LTE_SETUP');

debug('begin section: TRX_DATA');
IF p_customer_trx_id is not null THEN
   start_section('Transaction Data', 'TRX_DATA');
   ...
   end_section;
END IF;
debug('end section: TRX_DATA');

debug('begin section: LTE_DATA_ISSUES');
start_section('Data Integrity', 'LTE_DATA_ISSUES');
   IF g_customer_trx_id_tmp is not null  THEN
      set_item_result(run_stored_sig('JL_AR_LTE_UNSYNCH_TAX_CLASS_CODE'));
      set_item_result(run_stored_sig('JL_AR_LTE_UNSYNCH_TAX_RATE_AND_CODE'));
      set_item_result(run_stored_sig('JL_AR_LTE_COULD_NOT_EXPAND_TAX_GROUP'));
   END IF;
   set_item_result(run_stored_sig('JL_AR_LTE_UNSYNCH_GLOBAL_ATT1'));
   set_item_result(run_stored_sig('JL_AR_LTE_MISSING_TAX_CODE'));
   set_item_result(run_stored_sig('JL_AR_LTE_UNSYNCH_AR_ZX'));
end_section;
debug('end section: LTE_DATA_ISSUES');

debug('begin section: PROACTIVE');
start_section('Proactive Recommendations', 'PROACTIVE');
   set_item_result(check_rec_patches_1); /* Signature JL_GEN_RECOMMENDED_PATCHES */
   set_item_result(run_stored_sig('JL_GEN_JL_INVALIDS'));
   set_item_result(run_stored_sig('AR_GEN_AR_INVALIDS'));
   set_item_result(run_stored_sig('AR_GEN_ZX_INVALIDS'));
   set_item_result(run_stored_sig('JL_GEN_TRIGGERS'));
   set_item_result(run_stored_sig('JL_GEN_JL_PKG_VERSIONS'));
   set_item_result(run_stored_sig('JL_GEN_JL_FORM_LIB_RPT_VERSIONS'));
   set_item_result(run_stored_sig('AR_GEN_AR_PKG_VERSIONS'));
   set_item_result(run_stored_sig('AR_GEN_FORM_LIB_RPT_VERSIONS'));
   set_item_result(run_stored_sig('AR_GEN_ZX_PKG_VERSIONS'));
   set_item_result(run_stored_sig('AR_GEN_ZX_FORM_LIB_RPT_VERSIONS'));
end_section;
