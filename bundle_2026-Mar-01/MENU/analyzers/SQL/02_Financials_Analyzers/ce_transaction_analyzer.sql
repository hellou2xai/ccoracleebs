...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Cash Management Transaction Analyzer   |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE ce_transaction_analyzer_pkg AUTHID DEFINER AS
...
(            p_ledger_id                    IN NUMBER      DEFAULT NULL
           ,p_ledger_id2                   IN NUMBER      DEFAULT NULL
...
END ce_transaction_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY ce_transaction_analyzer_pkg AS
-- $Id: ce_transaction_analyzer.sql, 200.47 2026/02/25 10:48:15 sdenye Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2069274.1));
...
----------------------------------------------------------------
g_trx_type            VARCHAR2(240);
g_org_ids             VARCHAR2(240);
g_invoice_id          NUMBER;
g_ledger_id           VARCHAR2(240); /* Added for new parameter Ledger ID*/
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'CETRXN_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'CETRXN_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>CETRXN Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2069274.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/ce_txn_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,346,EBS,EBS Financials,EBS - Payables" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,346,EBS,EBS Financials,EBS - Payables" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},346,EBS,EBS Financials,EBS - Payables" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/3870205" class="blacklink" target="new">
...
<p>Version 200.47 25-FEB-2026</p><ul><li>Updates to 1 Index signature&nbsp;</li>
</ul>
<p>Version 200.46 26-JAN-2026</p><ul><li>Updated signatures to reflect knowledge article IDs&nbsp;</li>
</ul>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,346,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Payables" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,346,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Payables" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},346,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Payables" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
FUNCTION check_rec_patches_1 RETURN VARCHAR2 IS
  /* Signature CE_Trxn_check_rec_patches */
...
BEGIN
    ...
    print_log('Processing recommended patches signature: CE_Trxn_check_rec_patches (check_rec_patches_1) "Recommended Patch Collection (RPC)" (version 3)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.1' THEN
   ...
   l_col_rows(1)(l_rows) := '22455213';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Cash Management Recommended Patch Collection (RPC), Feb 2016';
   l_col_rows(5)(l_rows) := '[1367845/KB709955]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '21204692';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Cash Management Recommended Patch Collection (RPC), August, 2015';
   l_col_rows(5)(l_rows) := '[1367845/KB709955]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '20302484';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Cash Management Recommended Patch Collection (RPC), February, 2015';
   l_col_rows(5)(l_rows) := '[1367845/KB709955]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19149948';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Cash Management Recommended Patch Collection (RPC), August, 2014';
   l_col_rows(5)(l_rows) := '[1367845/KB709955]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '17217076';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Cash Management Recommended Patch Collection (RPC), Sept, 2013';
   l_col_rows(5)(l_rows) := '[1367845/KB709955]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '16242196';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Cash Management Recommended Patch Collection (RPC), Mar, 2013';
   l_col_rows(5)(l_rows) := '[1367845/KB709955]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '14374740';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Cash Management Recommended Patch Collection (RPC), Aug 2012';
   l_col_rows(5)(l_rows) := '[1367845/KB709955]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.0' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '13024047';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Cash Management Consolidated Patch Collection September 2011';
   l_col_rows(5)(l_rows) := '[1367845/KB709955]';
...
END IF;
   ...
   l_sig.sigrepo_id := '1066';
   l_sig.title := 'Recommended Patch Collection (RPC)';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := 'Some recommended RPC patches were not applied in this instance.';
   l_sig.solution := 'Please review list by clicking on "Recommended Patch Collection (RPC)" above and schedule to apply the latest RPC if not applied.<br>
<b>The consolidated patch is strongly recommended for all customers using EBS R12 Cash Management--It will ensure proper operation of the product.</b><br><br>
...
';
  ...
  -- Register
  l_step := '60';
  g_signatures('CE_Trxn_check_rec_patches') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'CE_Trxn_check_rec_patches',     -- sig ID
...
debug('begin populate parameters hash table');
   ...
   END IF;
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Transaction Type';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_trx_type,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Transaction ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_trx_id,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/02/25 10:48:14 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'ce_transaction_analyzer.sql';
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Ledger ID specified. ');
   raise invalid_parameters;
   WHEN OTHERS THEN
...
IF p_trx_type IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Transaction Type is required.');
   raise invalid_parameters;
END IF;
IF p_trx_type IS NOT NULL AND p_trx_type NOT IN ( 'CASHFLOW','JOURNAL','PAYMENT','RECEIPT') THEN
   print_error('INVALID ARGUMENT: Invalid Transaction Type');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_trx_type');

debug('begin parameter validation: p_trx_id');
IF p_trx_id IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Transaction ID is required.');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_trx_id');
...
/* Added for new parameter Ledger ID*/
g_ledger_id := trim(nvl(p_ledger_id,p_ledger_id2)); 

IF (p_trx_id IS NOT NULL) THEN
  BEGIN

      IF  p_trx_type = 'PAYMENT' THEN
        SELECT to_char(org_id) INTO l_org_list
        FROM   ap_checks_all
        WHERE  check_id = p_trx_id
        AND (mo_global.is_mo_init_done = 'N'  or mo_global.check_access(ap_checks_all.org_id) = 'Y');
      ...
      IF  p_trx_type = 'RECEIPT' THEN
        SELECT to_char(org_id) INTO l_org_list
        FROM   ar_cash_receipts_all
        WHERE  cash_receipt_id = p_trx_id
        AND (mo_global.is_mo_init_done = 'N'  or mo_global.check_access(ar_cash_receipts_all.org_id) = 'Y');
      END IF;
      
      IF  p_trx_type = 'CASHFLOW' THEN
        SELECT to_char(CASHFLOW_LEGAL_ENTITY_ID) INTO l_org_list
        FROM   CE_CASHFLOWS
        WHERE  cashflow_id = p_trx_id
          AND  cashflow_ledger_id = g_ledger_id;
      END IF;
      
      IF  p_trx_type = 'JOURNAL' THEN
        SELECT to_char(ledger_id) INTO l_org_list--to check and change
        FROM   GL_JE_HEADERS
        WHERE  je_header_id = p_trx_id
          AND  ledger_id = g_ledger_id;

       g_trx_type := 'JE_LINE';
      END IF;

g_org_ids := nvl(l_org_list, -99);
g_trx_type := nvl(p_trx_type, NULL);
g_invoice_id := nvl(l_invoice_id, NULL);

EXCEPTION
        WHEN NO_DATA_FOUND THEN
          print_log('Error: '||sqlerrm||' Trx id ('||
            to_char(p_trx_id)||') does not exist.  '||
            'Please provide a valid Trx id parameter value for the Ledger and Transaction Type combination.');
          raise invalid_parameters;
        WHEN OTHERS THEN
          print_log('Error: '||sqlerrm||' validating Trx id: '||
            to_char(p_trx_id));
          raise invalid_parameters;
        END;
END IF;
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$TRXID$$##') := nvl(to_char(p_trx_id),'NULL');
   g_masked_tokens('##$$TRXID$$##') := mask_text( g_sql_tokens('##$$TRXID$$##'), 'NO_MASK');
   g_sql_tokens('##$$TRXTYPE$$##') := nvl(to_char(g_trx_type),'NULL');
   g_masked_tokens('##$$TRXTYPE$$##') := mask_text( g_sql_tokens('##$$TRXTYPE$$##'), 'NO_MASK');
   g_sql_tokens('##$$ORGS$$##') := g_org_ids;
   g_masked_tokens('##$$ORGS$$##') := mask_text( g_sql_tokens('##$$ORGS$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPS_PARAM1$$##') := '260';
...
debug('begin add_signature: CE_Trxn_FILE_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1067',
      p_sig_id                 => 'CE_Trxn_FILE_VERSIONS',
      p_sig_sql                => 'SELECT name , SUBSTR(text,12,32)
    FROM dba_source
    WHERE name in (''CE_AUTO_BANK_MATCH'',''CE_AUTO_BANK_REC'', ''CE_AUTO_BANK_CLEAR'', ''CE_AUTO_BANK_CLEAR1'', ''AP_RECONCILIATION_PKG'')
    AND   type = ''PACKAGE BODY''
    and   line = 2
    AND   text like ''%$Header%''
    UNION ALL
     select  upper(af.filename)     FileName , 
    max(av.version)   FileVersion
    from    ad_files af,
    ad_file_versions av
    where   af.file_id= av.file_id
    and     af.filename in (''cevw.odf'')                            
    and     version=(select version from ad_file_versions afv where file_version_id = (select max(file_version_id) from  ad_file_versions afv1
        where afv1.file_id=af.file_id ))
    group by  Filename
     UNION ALL
    select  upper(af.filename)     FileName , 
    max(av.version)   FileVersion
    ...
    ad_file_versions av
    where   af.file_id= av.file_id
    and     af.filename in (''CEXAVTRX.rdf'',''CEXRECRE.rdf'',''CEXAVBCH.rdf'',''CEXCSHTR.rdf'')                            
    and     version=(select version from ad_file_versions afv where file_version_id = (select max(file_version_id) from  ad_file_versions afv1
        where afv1.file_id=af.file_id ))
    group by  Filename
    UNION ALL
    ...
    ad_file_versions av
    where   af.file_id= av.file_id
    and     af.filename in (''CEXCABMR.fmb'')                            
    and     version=(select version from ad_file_versions afv where file_version_id = (select max(file_version_id) from  ad_file_versions afv1
        where afv1.file_id=af.file_id ))
    group by  Filename
    UNION ALL
    ...
    ad_file_versions av
    where   af.file_id= av.file_id
    and     af.filename in (''CEXLAAAD.ldt'')                            
    and     version=(select version from ad_file_versions afv where file_version_id = (select max(file_version_id) from  ad_file_versions afv1
        where afv1.file_id=af.file_id ))
    group by  Filename',
      p_title                  => 'Packages and File versions',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Packages and File versions',
      p_solution               => '',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: CE_Trxn_FILE_VERSIONS');



debug('begin add_signature: CE_GL_LEDGERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1068',
      p_sig_id                 => 'CE_GL_LEDGERS',
    ...
    where glr3.source_ledger_id = glr2.primary_ledger_id 
          ...
          and glr3.source_ledger_id IN ( SELECT  asp.set_of_books_id
                          FROM    ar_cash_receipts_all ai,
                                  ar_system_parameters_all asp
                          WHERE   ai.org_id     = asp.org_id 
                          and     ai.cash_receipt_id = NVL(##$$TRXID$$##, -99)
                         UNION    
                          SELECT  asp.set_of_books_id
                          FROM    ap_checks_all ac,
                                  ap_system_parameters_all asp
                          WHERE   ac.org_id   = asp.org_id
                          AND     ac.check_id = NVL(##$$TRXID$$##,-99)
                         UNION
                          SELECT  ce.cashflow_ledger_id
                          From    ce_cashflows ce,
                                  ce_system_parameters csp
                          WHERE   ce.cashflow_ledger_id   = csp.set_of_books_id
                          AND     ce.cashflow_id = NVL(##$$TRXID$$##,-99))',
      p_title                  => 'General Ledger Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No General Ledger Information',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CE_GL_LEDGERS');



debug('begin add_signature: CE SYSTEM OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1069',
      p_sig_id                 => 'CE SYSTEM OPTIONS',
      p_sig_sql                => 'SELECT   *
     FROM      CE_SYSTEM_PARAMETERS a,
               GL_SETS_OF_BOOKS c       
     WHERE     a.set_of_books_id = c.set_of_books_id 
     AND       a.LEGAL_ENTITY_ID is not null
     AND       c.set_of_books_id = (SELECT  SET_OF_BOOKS_ID 
                                    FROM    HR_OPERATING_UNITS
                                    WHERE   ORGANIZATION_ID = NVL(##$$ORGS$$##,-99))',
      p_title                  => 'CE System Options',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'CE System Options',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CE SYSTEM OPTIONS');



debug('begin add_signature: INTERNAL BANK ACCOUNTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1071',
      p_sig_id                 => 'INTERNAL BANK ACCOUNTS',
      p_sig_sql                => 'select cba.* 
    from  ap_checks_all apc
    inner join ce_bank_acct_uses_all uses
    on apc.ce_bank_acct_use_id = uses.bank_acct_use_id
    inner join ce_bank_accounts cba 
    on cba.bank_account_id = uses.bank_account_id
    where apc.check_id   = NVL(##$$TRXID$$##,-99)
    and cba.account_classification = ''INTERNAL''
    UNION
    select cba.* 
    from  CE_CASHFLOWS cc
    inner join ce_bank_accounts cba
    on cc.cashflow_bank_account_id = cba.bank_account_id
    where cc.cashflow_id    = NVL(##$$TRXID$$##,-99)
    and cba.account_classification = ''INTERNAL''
    UNION
    select cba.* 
    from  AR_CASH_RECEIPTS_ALL arc
    inner join ce_bank_accounts cba
    on arc.remittance_bank_account_id = cba.bank_account_id
    where arc.cash_receipt_id    = NVL(##$$TRXID$$##,-99)
    and cba.account_classification = ''INTERNAL''',
      p_title                  => 'Internal Bank Accounts',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No internal Bank Account for transaction',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: INTERNAL BANK ACCOUNTS');



debug('begin add_signature: BANK ACCOUNT USE INFORMATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1072',
      p_sig_id                 => 'BANK ACCOUNT USE INFORMATION',
      p_sig_sql                => 'select cba.* 
    from  ap_checks_all apc
    inner join ce_bank_acct_uses_all cba
    on apc.bank_account_id = cba.bank_account_id
    where apc.check_id   = NVL(##$$TRXID$$##,-99)
  UNION
   select cba.* 
    from  ap_checks_all apc
    inner join ce_bank_acct_uses_all cba
    on apc.ce_bank_acct_use_id = cba.bank_acct_use_id
    where apc.check_id   = NVL(##$$TRXID$$##,-99)
    UNION
    select cba.* 
    from  CE_CASHFLOWS cc
    ...
    on arc.remittance_bank_account_id = cba.bank_account_id
    where arc.cash_receipt_id    = NVL(##$$TRXID$$##,-99)',
      p_title                  => 'Bank Account Use Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No bank account information for transaction',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: BANK ACCOUNT USE INFORMATION');



debug('begin add_signature: BANK ACCOUNT CCID SETUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1073',
      p_sig_id                 => 'BANK ACCOUNT CCID SETUP',
      p_sig_sql                => 'select cgl.* 
    from  ce_gl_accounts_ccid cgl
    inner join ce_bank_acct_uses_all cba
    on cgl.bank_acct_use_id = cba.bank_acct_use_id    
    inner join ap_checks_all apc
    on apc.bank_account_id = cba.bank_account_id
    where apc.check_id   = NVL(##$$TRXID$$##,-99)
   UNION
   select cgl.* 
    ...
    inner join ce_bank_acct_uses_all cba
    on cgl.bank_acct_use_id = cba.bank_acct_use_id    
    inner join AR_CASH_RECEIPTS_ALL arc
    on arc.remittance_bank_account_id = cba.bank_account_id
    where arc.cash_receipt_id  = NVL(##$$TRXID$$##,-99)',
      p_title                  => 'Bank Account ccid setup',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Bank Account ccid setup',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: BANK ACCOUNT CCID SETUP');



debug('begin add_signature: DUPLICATE BRANCH_PARTY_ID IN CE_BANK_BRANCHES_V');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19835',
      p_sig_id                 => 'DUPLICATE BRANCH_PARTY_ID IN CE_BANK_BRANCHES_V',
      p_sig_sql                => 'select bank_home_country,
       bank_party_id,
       bank_name,
       branch_party_id,
       bank_branch_name,
    ...
    ''Y'' process_flag
       ...
       (
        select bank_home_country,
               ...
               bank_branch_name,
               bank_branch_type,
               count(*) over(partition by bank_party_id order by bank_party_id) cnt 
        from ce_bank_branches_v
        where branch_party_id in(
                             select branch_party_id 
                             from ce_bank_branches_v
                             group by branch_party_id
                             having count(branch_party_id) > 1)
          group by bank_home_country,
                 bank_party_id,
                 bank_name,
                 branch_party_id,
                 bank_branch_name,
...
',
      p_title                  => 'Duplicate Branch_Party_Id In CE_BANK_BRANCHES_V',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Query  to identify  issue where same bank branch is assigned to 2 banks.',
      p_solution               => '<ul>
<li>Execute the fix script 
ce_ dup_brn_fix.sql
</li>
<li>Follow the instructions provided in [2154115/KB299647]</li>
<li><B>Impact Area:</B>Bank Setup/ Payments</li>
</ul>',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: DUPLICATE BRANCH_PARTY_ID IN CE_BANK_BRANCHES_V');



debug('begin add_signature: EBS_FIN_AP_CETRXN_UD_AAD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26251',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_UD_AAD',
      p_sig_sql                => 'SELECT ''Payment Product Rule Code'' component_type,
     ...
     FROM         ap_checks_all ac,
          ...
          Xla_Ae_Headers Xah
     WHERE ac.check_id = NVL(##$$TRXID$$##, -99)
     ...
     Union
     SELECT ''Payment Journal Line Definition'',
     ...
     Union
     SELECT ''Payment Journal Line Type'',
     ...
     AND   xdl.application_id = 200
Union
SELECT ''Cashflow Product Rule Code'' component_type,
            xah.product_rule_code "Code",
            xah.ledger_id
     FROM       ce_cashflows cf,
          xla_transaction_entities_upg xte,
          xla_ae_headers xah
     WHERE  cf.cashflow_id = NVL(##$$TRXID$$##, -99)
     AND   xte.application_id = 260
     AND   xte.ledger_id = cf.cashflow_ledger_id 
     AND   nvl( xte.source_id_int_1, - 99 ) = cf.cashflow_id
     AND   xte.entity_code = ''CE_CASHFLOWS''
     AND   xte.entity_id = xah.entity_id
     AND   xah.application_id = 260
     AND   xah.product_rule_type_code = ''C''
     Union All
     SELECT ''Cashflow Journal Line Definition'',
            xdl.line_definition_code,
            xah.ledger_id
     FROM      ce_cashflows cf,
          xla_transaction_entities_upg xte,
     ...
     AND   xdl.ae_header_id = xah.ae_header_id
     AND   xdl.line_definition_owner_code = ''C''
     AND   xdl.application_id = 260
     Union All
     SELECT ''Cashflow Journal Line Type'',
           xdl.accounting_line_code,
           xah.ledger_id
     FROM    ce_cashflows cf,
          xla_transaction_entities_upg xte,
     ...
     AND   xdl.accounting_line_type_code = ''C''
     And   Xdl.Application_Id = 260',
      p_title                  => 'User-defined Application Accounting Definition (AAD)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Displays details of User-defined Application Accounting Definition (AAD)',
      p_solution               => 'Details of User-defined Application Accounting Definition (AAD)',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_UD_AAD');



debug('begin add_signature: EBS_FIN_AP_CETRXN_XLA_ADR_JLD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26252',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_XLA_ADR_JLD',
...
ORDER BY
    ...
    flexfield_segment_code',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Details of Journal Line Definitions',
      p_solution               => 'Details of Journal Line Definitions',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_XLA_ADR_JLD');



debug('begin add_signature: EBS_FIN_AP_CETRXN_CE_BANK_BRANCHES_V');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26096',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_CE_BANK_BRANCHES_V',
      p_sig_sql                => 'select * from ce_bank_branches_v
where  branch_party_id in 
( select cba.bank_branch_id
    ...
    and cba.account_classification = ''INTERNAL''
      ...
      p_title                  => 'CE_BANK_BRANCHES_V',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Details of Bank Branch',
      p_solution               => 'Details of Bank Branch of internal bank account',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_CE_BANK_BRANCHES_V');



debug('begin add_signature: EBS_FIN_AP_CETRXN_CE_BANKS_V');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26098',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_CE_BANKS_V',
      p_sig_sql                => 'select * from ce_banks_v
where  bank_party_id in 
( select cba.bank_id
    from  ap_checks_all apc
    inner join ce_bank_acct_uses_all uses
    on apc.ce_bank_acct_use_id = uses.bank_acct_use_id
...
debug('begin add_signature: EBS_FIN_AP_CA_EBS_FIN_AP_CETRXN_XLA_LAUNCH_OPTIONS');
  ...
  add_signature(
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CA_EBS_FIN_AP_CETRXN_XLA_LAUNCH_OPTIONS');



debug('begin add_signature: EBS_FIN_AP_CETRXN_EBS_FIN_AP_CETRXN_XLA_JOURNAL_LINE_TYPE_CONDITIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26352',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_EBS_FIN_AP_CETRXN_XLA_JOURNAL_LINE_TYPE_CONDITIONS',
...
<li>Log a service request if further assistance is needed.</li>
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_EBS_FIN_AP_CETRXN_XLA_JOURNAL_LINE_TYPE_CONDITIONS');



debug('begin add_signature: EBS_FIN_AP_CA_EBS_CE_XLA_LEDGER_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26253',
      p_sig_id                 => 'EBS_FIN_AP_CA_EBS_CE_XLA_LEDGER_OPTIONS',
...
AND glr3.source_ledger_id = glr2.primary_ledger_id AND glr2.target_ledger_id = glr1.primary_ledger_id AND gl.ledger_id = glr1.source_ledger_id AND gl.application_id = 260 ORDER BY gl.ledger_id',
      p_title                  => 'EBS_CE_XLA_LEDGER_OPTIONS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'EBS_CE_XLA_LEDGER_OPTIONS',
      p_solution               => 'Cash Management Transaction',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CA_EBS_CE_XLA_LEDGER_OPTIONS');



debug('begin add_signature: EBS_FIN_AP_CA_EBS_FIN_AP_CETRXN_FND_ID_FLEX_STRUCTURES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26350',
      p_sig_id                 => 'EBS_FIN_AP_CA_EBS_FIN_AP_CETRXN_FND_ID_FLEX_STRUCTURES',
...
order by 1',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CA_EBS_FIN_AP_CETRXN_FND_ID_FLEX_STRUCTURES');



debug('begin add_signature: EBS_FIN_AP_CA_JOURNAL_LINE_TYPES_ASSIGNED_TO_EACH_EVENT_CLASS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26256',
      p_sig_id                 => 'EBS_FIN_AP_CA_JOURNAL_LINE_TYPES_ASSIGNED_TO_EACH_EVENT_CLASS',
      p_sig_sql                => 'SELECT distinct *
FROM 
    xla_acct_line_types_fvl xa,
    xla_line_defn_jlt_assgns xl
WHERE xa.application_id =260
...
<li>Log a service request if further assistance is needed.</li>
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CA_JOURNAL_LINE_TYPES_ASSIGNED_TO_EACH_EVENT_CLASS');



debug('begin add_signature: EBS_FIN_AP_CETRXN_ADR_SEGMENT_RULES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26232',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_ADR_SEGMENT_RULES',
      p_sig_sql                => 'select distinct *
...
AND
    line_definition_code IN (
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Display ADR Segment Rules',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_ADR_SEGMENT_RULES');



debug('begin add_signature: EBS_FIN_AP_CETRXN_ADR_SEGMENT_RULE_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26257',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_ADR_SEGMENT_RULE_DETAILS',
      p_sig_sql                => 'select distinct *
...
<li>Log a service request if further assistance is needed.</li>
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_ADR_SEGMENT_RULE_DETAILS');



debug('begin add_signature: EBS_FIN_AP_CETRXN_CE_XLA_JLD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26214',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_CE_XLA_JLD',
      p_sig_sql                => 'SELECT distinct lda.*, ld.*
FROM
    xla_aad_line_defn_assgns lda,
    xla_line_definitions_b ld,
    xla_event_classes_b ec
WHERE lda.application_id = 260
...
ORDER BY
    ...
    lda.event_type_code',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Journal Line Definitions Assigned to the Accounting Definition',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_CE_XLA_JLD');



debug('begin add_signature: EBS_FIN_AP_CETRXN_CE_XLA_SHOW_SOURCES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26233',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_CE_XLA_SHOW_SOURCES',
      p_sig_sql                => 'select *
from xla_sources_fvl
where application_id = 260
order by source_code',
      p_title                  => 'CE Sources (Including Custom Sources)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'User-defined components have been detected.',
      p_solution               => '',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_CE_XLA_SHOW_SOURCES');



debug('begin add_signature: EBS_FIN_AP_CETRXN_CHART_OF_ACCOUNTS_SEGMENT_QUALIFIERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26243',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_CHART_OF_ACCOUNTS_SEGMENT_QUALIFIERS',
      p_sig_sql                => 'SELECT DISTINCT
    ldgr.chart_of_accounts_id,
    ldgr.chart_of_accounts_name,
    sgmt.flex_value_set_id,
    sgmt.segment_num,
    sgmt.segment_name,
    qlfr.segment_attribute_type,
    qlfr.value_attribute_type,
    qlfr.assignment_date
FROM
    gl_ledgers_v ldgr,
    fnd_id_flex_segments sgmt,
    fnd_flex_validation_qualifiers qlfr
WHERE
    ldgr.ledger_id in (##$$LGRIDS$$##)
    AND   ldgr.chart_of_accounts_id = sgmt.id_flex_num
    AND   sgmt.id_flex_code = ''GL#''
    AND   sgmt.application_id = qlfr.id_flex_application_id
    AND   sgmt.id_flex_code = qlfr.id_flex_code
    AND   sgmt.flex_value_set_id = qlfr.flex_value_set_id
ORDER BY
    chart_of_accounts_name,
    segment_num,
    segment_attribute_type,
    value_attribute_type',
      p_title                  => 'Chart of Accounts Segment Qualifiers',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Display chart of accounts segment validation qualifiers.',
      p_solution               => '',
      p_success_msg            => 'No chart of accounts segment validation qualifiers found.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_CHART_OF_ACCOUNTS_SEGMENT_QUALIFIERS');



debug('begin add_signature: EBS_FIN_AP_CETRXN_CM_GL_LEDGERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26262',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_CM_GL_LEDGERS',
      p_sig_sql                => 'SELECT distinct gl.* 
    FROM  gl_ledgers gl
          , gl_ledger_relationships glr1
          , gl_ledger_relationships glr2
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_CM_GL_LEDGERS');



debug('begin add_signature: EBS_FIN_AP_CETRXN_DYNAMIC_INSERT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26250',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_DYNAMIC_INSERT',
      p_sig_sql                => 'select gl.ledger_id, flex.* 
from fnd_id_flex_structures flex, 
          gl_ledgers gl 
where flex.application_id = 101 
and flex.id_flex_code = ''GL#'' 
and flex.id_flex_num = gl.chart_of_accounts_id 
...
order by 1',
      p_title                  => 'Dynamic Insert ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Details of Dynamic Insert',
      p_solution               => 'Information on Dynamic Insert',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_DYNAMIC_INSERT');



debug('begin add_signature: EBS_FIN_AP_CETRXN_EBS_CE_SLAM');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26255',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_EBS_CE_SLAM',
...
<li>Log a service request if further assistance is needed.</li>
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_EBS_CE_SLAM');



debug('begin add_signature: EBS_FIN_AP_CETRXN_EBS_CE_XLA_SHOW_CUSTOM_SOURCE_PARAMS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26254',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_EBS_CE_XLA_SHOW_CUSTOM_SOURCE_PARAMS',
      p_sig_sql                => 'SELECT DISTINCT
    ldgr.chart_of_accounts_id,
    ldgr.chart_of_accounts_name,
    sgmt.*,
...
ORDER BY
    ...
    segment_attribute_type',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Chart of Accounts Segment Data',
      p_solution               => 'Cash Management Transaction',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_EBS_CE_XLA_SHOW_CUSTOM_SOURCE_PARAMS');



debug('begin add_signature: EBS_FIN_AP_CETRXN_EBS_FIN_AP_CETRXN_AAD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26351',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_EBS_FIN_AP_CETRXN_AAD',
      p_sig_sql                => 'with dob as
(
    select xpr.*, obj.* from all_objects obj, xla_product_rules_fvl xpr
    where xpr.application_id = 260
    and xpr.AMB_CONTEXT_CODE = ''DEFAULT''
    and (obj.object_name LIKE ''XLA_00260_AAD_%_''
    || lpad(xpr.product_rule_hash_id,6,0)
    || ''_PKG''
    OR obj.object_name LIKE ''XLA_00260_AAD_%_''
    || lpad(xpr.product_rule_hash_id,6,0)
    || ''BC_PKG'')
...
<li>Log a service request if further assistance is needed.</li>
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_EBS_FIN_AP_CETRXN_AAD');



debug('begin add_signature: EBS_FIN_AP_CETRXN_EBS_FIN_AP_CETRXN_XLA_SOURCE_NA_PROB');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26353',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_EBS_FIN_AP_CETRXN_XLA_SOURCE_NA_PROB',
      p_sig_sql                => 'select *
from xla_sources_fvl
where application_id = 260
...
5. Save',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_EBS_FIN_AP_CETRXN_XLA_SOURCE_NA_PROB');



debug('begin add_signature: EBS_FIN_AP_CETRXN_EVENT_CLASS_ASSIGNMENT_FOR_CASH_MANAGEMENT_AAD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26245',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_EVENT_CLASS_ASSIGNMENT_FOR_CASH_MANAGEMENT_AAD',
      p_sig_sql                => 'select *
...
order by product_rule_code, entity_code, event_class_code, event_type_code',
      p_title                  => 'Event Class Assignment For Cash Management AAD',
      p_fail_condition         => '[PRODUCT_RULE_TYPE_CODE] = [C]',
      p_problem_descr          => 'User-defined components have been detected.',
      p_solution               => '<ul>
<li>Verify if the user-defined change has downstream impact on any accounting issues being reported.</li>
...
<li>Log a service request if further assistance is needed.</li>
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_EVENT_CLASS_ASSIGNMENT_FOR_CASH_MANAGEMENT_AAD');



debug('begin add_signature: EBS_FIN_AP_CETRXN_GL_PERIOD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26234',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_GL_PERIOD',
      p_sig_sql                => 'SELECT distinct gps.*
FROM GL_PERIOD_STATUSES gps, (
  SELECT accounting_date
  FROM AP_INVOICE_PAYMENTS_ALL
  WHERE check_id = nvl(##$$TRXID$$##,-99)
UNION
 SELECT accounting_date
  FROM AP_PAYMENT_HISTORY_ALL
  WHERE check_id = nvl(##$$TRXID$$##,-99)
UNION
 SELECT xah.accounting_date
  FROM xla_ae_headers xah, xla.xla_transaction_entities xte
  WHERE xah.application_id = 200
    AND xte.application_id = 200
    AND xah.entity_id = xte.entity_id
    AND xte.entity_code = ''AP_PAYMENTS''
    AND xte.source_id_int_1 = nvl(##$$TRXID$$##,-99)
    ) atg_date
WHERE gps.application_id in (101,200)
  AND gps.ledger_id in (##$$LGRIDS$$##)
  AND atg_date.accounting_date BETWEEN gps.start_date AND gps.end_date
UNION
(SELECT distinct gps.*
FROM GL_PERIOD_STATUSES gps, (
     select  accounting_date 
     from ce_cashflow_acct_h 
     where cashflow_id = NVL(##$$TRXID$$##,-99)
    ) atg_date
WHERE gps.application_id in (101)
  AND gps.ledger_id in (##$$LGRIDS$$##)
  AND atg_date.accounting_date BETWEEN gps.start_date AND gps.end_date
)
UNION 
...
select gps.*
from gl_period_statuses gps
where gps.LEDGER_id in (##$$LGRIDS$$##)
and gps.period_name in (
select period_name 
from gl_je_headers
where je_header_id = nvl(##$$TRXID$$##,-99)
)
...
where cash_receipt_id = NVL(##$$TRXID$$##,-99))atg_date
where gps.application_id in (101, 222)
and gps.ledger_id in (##$$LGRIDS$$##)
AND atg_date.gl_date BETWEEN gps.start_date AND gps.end_date
)
ORDER BY 25, 28, 1',
      p_title                  => 'Period Status Check',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Period Status Check',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_GL_PERIOD');



debug('begin add_signature: EBS_FIN_AP_CETRXN_HR_ORGANIZATION_UNITS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26242',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_HR_ORGANIZATION_UNITS',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_HR_ORGANIZATION_UNITS');



debug('begin add_signature: EBS_FIN_AP_CETRXN_XLA_ACCOUNT_DERIVATION_RULE_CONDITIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26263',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_XLA_ACCOUNT_DERIVATION_RULE_CONDITIONS',
...
<li>Log a service request if further assistance is needed.</li>
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_XLA_ACCOUNT_DERIVATION_RULE_CONDITIONS');



debug('begin add_signature: EBS_FIN_AP_CUSTOM_SOURCE_PARAMETERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26258',
      p_sig_id                 => 'EBS_FIN_AP_CUSTOM_SOURCE_PARAMETERS',
      p_sig_sql                => 'select *
...
where application_id = 260',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CUSTOM_SOURCE_PARAMETERS');



debug('begin add_signature: EBS_MFG_DM_CSTPERIODCLOSE_COST_CUTOFF_DATE_UNCOSTED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26767',
      p_sig_id                 => 'EBS_MFG_DM_CSTPERIODCLOSE_COST_CUTOFF_DATE_UNCOSTED',
      p_sig_sql                => 'select to_char(min(mmt.transaction_date),''DD-MON-YYYY HH24:MI:SS'') min_trx_date ,mp.organization_code, to_char(mp.cost_cutoff_date,''dd-mon-rrrr HH24:MI:SS'') "Cost Cutoff Date"
from mtl_parameters mp, mtl_material_transactions mmt
where mp.cost_cutoff_date is not null
and mmt.organization_id=mp.organization_id
and  mmt.costed_flag in(''N'')
group by mp.organization_code,mp.cost_cutoff_date
order by min_trx_date',
      p_title                  => 'Uncosted transactions exist and there is a Cost Cutoff Date set in Organization Parameters',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Uncosted transactions exist and there is a Cost Cutoff Date set in Organization Parameters.',
      p_solution               => 'Please review [2901817/KB418087]
What To Verify When Cost Manger Is Not Costing Transactions',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_MFG_DM_CSTPERIODCLOSE_COST_CUTOFF_DATE_UNCOSTED');



debug('begin add_signature: ce_recon_curr_rec_flag_fix.sql');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1081',
      p_sig_id                 => 'ce_recon_curr_rec_flag_fix.sql',
      p_sig_sql                => 'select * from ce_statement_reconcils_all a  
    where  a.reference_id = NVL(##$$TRXID$$##,-99)
    and    rowid in (select rowid from 
                  (select rowid,row_number() over (partition by reference_type, reference_id,je_header_id order by creation_date) rn,
                  count(*) over (partition by reference_type, reference_id, je_header_id) cn
                  from ce_statement_reconcils_all a 
                  where a.current_record_flag =''N'')
                where rn = cn   and rn > 1 ) 
                and not exists ( select ''x'' from ce_statement_reconcils_all b
                                where b.reference_id = a.reference_id
                                and b.reference_type = a.reference_type
                                and nvl(b.je_header_id,0) = nvl(a.je_header_id,0) and
                                b.current_record_flag =''Y'')
  order by reference_id, reference_type',
      p_title                  => 'Corruption in CURRENT_RECORD_FLAG',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'No records exist with CURRENT_RECORD_FLAG as Y in the CE_STATEMENT_RECONCILS_ALL table',
      p_solution               => '<ul>
  <li>Please run  ce_recon_curr_rec_flag_fix.sql  from Patch 20925972.</li>
  <li>Follow the instructions provided in [2013609/KB785885]</li>
  <li><B>Impact Area:</B>Reconciliation / Unreconciliation / Reconciliation reports</li>
  </ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: ce_recon_curr_rec_flag_fix.sql');



debug('begin add_signature: ce13080978.sql');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1082',
      p_sig_id                 => 'ce13080978.sql',
      p_sig_sql                => 'SELECT csr.org_id csrorg, ac.org_id aporg, check_number,
            check_date, check_id, csr.last_update_date lud,
            csr.last_updated_by lub
            from ap_checks_all ac, ce_statement_reconcils_all csr
                  where csr.reference_id = ac.check_id
                  and csr.reference_type =''PAYMENT''
                  and csr.status_flag =''M''
                  and csr.current_record_flag =''Y''
                  and csr.org_id  <> ac.org_id
                  and csr.reference_id = NVL(##$$TRXID$$##,-99)
      UNION
          select csr.org_id csrorg, arcrh.org_id arorg, cash_receipt_history_id,
                 trx_date,arcrh.cash_receipt_id, csr.last_update_date lud, csr.last_updated_by lub
          from ar_cash_receipt_history_all arcrh, ce_statement_reconcils_all csr,ar_cash_receipts_all c 
          where c.cash_receipt_id = arcrh.cash_receipt_id
          and csr.reference_id = arcrh.cash_receipt_history_id
          and csr.reference_type =''RECEIPT''
          and csr.status_flag =''M''
          and csr.current_record_flag =''Y''
          and csr.org_id  <> arcrh.org_id
          and csr.reference_id in(select d.cash_receipt_history_id from AR_CASH_RECEIPT_HISTORY_ALL d
          where d.cash_receipt_id in(select e.cash_receipt_id from ar_cash_receipts_all e where e.cash_receipt_id = NVL(##$$TRXID$$##,-99)))
      UNION
          select  distinct  
                  ceba.account_owner_org_id cbale,
                  null,
                  cere.reference_id,
                  null,
                  cere.je_header_id,
                  cere.last_update_date lud,
                  cere.last_updated_by lub
          from    ce_statement_reconcils_all cere,
                  ce_statement_lines cesl,
                  ce_statement_headers cesh,
                  ce_bank_accounts ceba
          where cere.reference_type =''XTR_LINE''
          and cere.legal_entity_id is null
          and cesl.statement_line_id = cere.statement_line_id
          and cesl.statement_header_id = cesh.statement_header_id
          and ceba.bank_account_id = cesh.bank_account_id
          and cere.reference_id = NVL(##$$TRXID$$##,-99)',
      p_title                  => 'ORG_ID mismatch in Reconciliation and Transaction table',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There is ORG_ID mismatch in CE_STATEMENT_RECONCILS_ALL and transaction table',
      p_solution               => '<ul>
  <li>Please run  ce13080978.sql from Patch 17006783.</li>
  <li>Follow the instructions provided in [1669261/KB161289]</li>
  <li><B>Impact Area:</B>Reconciliation / Unreconciliation</li>
  </ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: ce13080978.sql');



debug('begin add_signature: EBS_FIN_AP_CETRXN_CE_INVALID_BRANCH_CODE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '29575',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_CE_INVALID_BRANCH_CODE',
      p_sig_sql                => 'select * from hz_code_assignments
where owner_table_name = ''HZ_PARTIES''
and class_category = ''BANK_BRANCH_TYPE''
and class_code not in (''ABA'', ''CHIPS'', ''SWIFT'', ''OTHER'')
and primary_flag = ''Y''
and end_date_active is not null',
      p_title                  => 'Invalid Branch Type Detected',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Unable To Update Branch Details Due To Invalid Branch Type, Error-"You have encountered an unexpected error. Please contact the System Administrator for assistance." ',
      p_solution               => 'Please follow the steps as detailed in [2940572/KB726823]. ',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_CE_INVALID_BRANCH_CODE');



debug('begin add_signature: CE_BRANCH_TYPE_NULL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14793',
      p_sig_id                 => 'CE_BRANCH_TYPE_NULL',
      p_sig_sql                => ' SELECT *
  FROM ce_bank_branches_v
  WHERE bank_branch_type IS NULL',
      p_title                  => 'BANK_BRANCH_TYPE_NULL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Null Pointer exception while updating upgraded Bank branch due to bank_branch_type as NULL',
      p_solution               => 'Apply Action plan as per [2395710/KB494366]',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CE_BRANCH_TYPE_NULL');



debug('begin add_signature: ap_pay_upg_cancel_x_event_num_fix.sql');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1083',
      p_sig_id                 => 'ap_pay_upg_cancel_x_event_num_fix.sql',
      p_sig_sql                => 'SELECT DISTINCT APH1.CHECK_ID,
      ...
      FROM ap_payment_history_all aph1,
          ...
          xla_events xe1,
          xla_events xe2
      WHERE aph1.check_id          = NVL(##$$TRXID$$##,-99)
      ...
      p_title                  => 'Event order mismatch for upgraded voided payments',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Upgraded payment cancelled event number is less than payment created event.',
      p_solution               => '<ul>
    <li>Please log sr to get approved fix script ap_pay_upg_cancel_x_event_num_fix.sql</li>
    <li>Follow the instructions provided in [1682097/KB453881]</li>
    <li><B>Impact Area:</B>Reconciliation reports</li>
    </ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: ap_pay_upg_cancel_x_event_num_fix.sql');



debug('begin add_signature: pay_upg_clr_x_event_num.sql');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1084',
      p_sig_id                 => 'pay_upg_clr_x_event_num.sql',
      p_sig_sql                => 'SELECT DISTINCT APH1.CHECK_ID,
              APH3.PAYMENT_HISTORY_ID,
              APH3.ACCOUNTING_EVENT_ID
            FROM ap_payment_history_all aph1 ,
                 ap_payment_history_all aph3,
                 xla_events xe1,
                 xla_events xe2
            WHERE aph1.check_id          = NVL(##$$TRXID$$##,-99)
            AND aph1.check_id          = aph3.check_id
            AND aph1.historical_flag     =''Y''
            AND aph3.historical_flag     =''Y''
            AND aph1.posted_flag         =''Y''
            AND Aph3.Posted_Flag         =''Y''
            AND APH1.TRANSACTION_TYPE     IN (''PAYMENT CREATED'', ''REFUND RECORDED'', ''PAYMENT MATURITY'',''PAYMENT UNCLEARING'')
            AND Aph3.Transaction_Type    =''PAYMENT CLEARING''
            AND APH1.ACCOUNTING_EVENT_ID > APH3.ACCOUNTING_EVENT_ID
            AND xe1.application_id=200
            AND xe2.application_id  =200
            AND xe1.event_id        =aph1.accounting_event_id
            AND xe2.event_id        =aph3.accounting_event_id
            AND Xe1.Event_Number    > Xe2.Event_Number
            AND NOT EXISTS
              (SELECT ''no unclearing''
               FROM ap_payment_history_all aph4
               WHERE aph4.transaction_type=''PAYMENT UNCLEARING''
               AND aph4.REV_PMT_HIST_ID   =APH3.PAYMENT_HISTORY_ID
               AND APH4.CHECK_ID = APH3.CHECK_ID)',
      p_title                  => 'Event order mismatch for upgraded payments',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Upgraded payment created event number is more than payment cleared event.',
      p_solution               => '<ul>
    <li>Please log sr to get approved fix script pay_upg_clr_x_event_num.sql</li>
    <li>Follow the instructions provided in [1578051/KB261226]</li>
    <li><B>Impact Area:</B>Reconciliation reports</li>
    </ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: pay_upg_clr_x_event_num.sql');



debug('begin add_signature: CE_DUPLICATE_PAY_DOCUMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15567',
      p_sig_id                 => 'CE_DUPLICATE_PAY_DOCUMENTS',
      p_sig_sql                => 'SELECT payment_document_id,
  COUNT(*) doc_count
FROM ce_payment_documents
GROUP BY payment_document_id
HAVING COUNT(*) >1',
      p_title                  => 'Duplicate Payment Document',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Duplicate document in CE_PAYMENT_DOCUMENTS exist.',
      p_solution               => 'See [2267105/KB757425] for problem this will cause and solution.',
      p_success_msg            => 'No duplicate document in CE_PAYMENT_DOCUMENTS found.<br>
Reference: [2267105/KB757425]',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CE_DUPLICATE_PAY_DOCUMENTS');



debug('begin add_signature: INCORRECT PAYMENT CLEARING ACCOUNT DUE TO FINAL ROUNDING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19834',
      p_sig_id                 => 'INCORRECT PAYMENT CLEARING ACCOUNT DUE TO FINAL ROUNDING',
      p_sig_sql                => 'SELECT DISTINCT ACA.check_id, ACA.check_number, APH.accounting_event_id 
     FROM AP_Checks_All            ACA 
        , AP_Payment_History_All   APH 
        , AP_Payment_Hist_Dists    PHD 
        , AP_System_Parameters_All ASP 
        , XLA_AE_Headers           XAH 
    WHERE ACA.check_id = nvl(##$$TRXID$$##, - 99)
      ...
      AND PHD.payment_history_id = APH.payment_history_id 
      AND PHD.accounting_event_id = APH.accounting_event_id 
      AND PHD.pay_dist_lookup_code = ''FINAL CASH ROUNDING'' 
      AND ACA.cleared_base_amount IS NOT NULL 
      AND (    (0.05 > ABS( ABS(PHD.cleared_base_amount) 
                        - ABS( ACA.base_amount - ACA.cleared_base_amount 
                               + NVL( ACA.cleared_charges_base_amount, 0 ) ) ) ) 
            OR ( ACA.cleared_charges_base_amount > 0 AND 
                 (0.05 > ( ABS(PHD.cleared_base_amount) - ACA.cleared_charges_base_amount )) )) 
      AND ACA.void_date IS NULL 


',
      p_title                  => 'Incorrect Payment Clearing Account Due To Final Rounding',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Query  to identify and correct PAYMENT CLEARING accounting events having large FINAL CASH ROUNDING lines.',
      p_solution               => '<ul>
<li>Follow the instructions provided in [2004116/KB828328]</li>
<li><B>Impact Area:</B>Accounting / Reconciliation</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: INCORRECT PAYMENT CLEARING ACCOUNT DUE TO FINAL ROUNDING');



debug('begin add_signature: EBS_FIN_AP_CETRXN_NO_LOV_TRANSACTIONS_AVL_RECONCILATION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27697',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_NO_LOV_TRANSACTIONS_AVL_RECONCILATION',
      p_sig_sql                => '            
select  concurrent_program_name, multi_org_category  from fnd_concurrent_programs
Where concurrent_program_name = ''CEXAVTRX''
AND application_id = 260
AND multi_org_category<>''M''',
      p_title                  => 'No List Of Values When Trying To Run Transactions Available For Reconciliation Report',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'No List Of Values When Trying To Run Transactions Available For Reconciliation Report',
      p_solution               => 'Apply the solution in [1279464/KB289893]',
      p_success_msg            => 'Ok.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_NO_LOV_TRANSACTIONS_AVL_RECONCILATION');



debug('begin add_signature: ce_bat_dupacct_fix.sql');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1085',
      p_sig_id                 => 'ce_bat_dupacct_fix.sql',
      p_sig_sql                => 'select * from ce_cashflow_acct_h where cashflow_id in (SELECT cashflow_id
    FROM
      (SELECT cashflow_id ,
        ccah.event_id ,
        event_type ,
        ...
        lead(event_type, 1,''NONE'') over ( order by ccah.event_id ) next_event,
        lag(event_type, 1,''NONE'') over ( order by ccah.event_id ) prev_event
    FROM ce_cashflow_acct_h ccah,
        xla_events xe
        ...
        WHERE cashflow_id IN
          ...
          FROM
            (SELECT cashflow_id,
              event_type ,
              status_code,
              lead(event_type, 1,0) over ( partition BY cashflow_id order by event_id ) next_row
            FROM ce_cashflow_acct_h
            WHERE event_type != ''CE_BAT_CREATED''
            )
          WHERE event_type = next_row
          )
        )
      AND ccah.cashflow_id        = NVL(##$$TRXID$$##,-99)
      AND ccah.event_type        != ''CE_BAT_CREATED''
      AND xe.event_id             = ccah.event_id
      AND xe.event_status_code   IN (''U'',''P'')
      AND xe.process_status_code IN (''U'',''P'')
      AND xe.application_id       = 260
      ) j
    WHERE j.current_record_flag = ''N''
    and J.EVENT_TYPE            = J.NEXT_EVENT
    AND j.event_type            =''CE_BAT_CLEARED'')',
      p_title                  => 'Duplicate cashflow CLEARED events / Double accounting for BAT cashflows',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are duplicate Bank Account Transfer cashflow clearing events which is causing duplicate accounting.',
      p_solution               => 'Please follow the instructions as detailed in [2075579/KB753025].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: ce_bat_dupacct_fix.sql');



debug('begin add_signature: ce10170527.sql');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1086',
      p_sig_id                 => 'ce10170527.sql',
      p_sig_sql                => 'Select e.event_id,e.event_type_code,e.entity_id,e.event_status_code,e.process_status_code,a.cashflow_id/*e.event_id rowid, e.event_id, rownum*/
        From xla_events e,ce_cashflow_acct_h a
        Where  a.cashflow_id = NVL(##$$TRXID$$##,-99)
        and   e.event_status_code in (''P'',''U'')
        and   e.application_id = 260
        and   e.event_type_code in (''CE_BAT_CREATED'', ''CE_BAT_CANCELED'')
        and   a.event_id = e.event_id
        union all
Select e.event_id,e.event_type_code,e.entity_id,e.event_status_code,e.process_status_code,a.cashflow_id/*e.event_id rowid, e.event_id, rownum*/
        From   xla_events  e,ce_cashflow_acct_h a
        Where  a.cashflow_id = NVL(##$$TRXID$$##,-99)
        and    e.event_status_code =''N''
        and    e.process_status_code = ''E''
        and    e.application_id = 260
        and    e.event_type_code in (''CE_BAT_CREATED'', ''CE_BAT_CANCELED'')
        and    a.event_id = e.event_id',
      p_title                  => 'Incorrect EVENT_STATUS_CODE for BAT Events',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The EVENT_STATUS_CODE in XLA_EVENTS is not ''N'' for CE_BAT_CREATED and CE_BAT_CANCELED events.',
      p_solution               => '<ul>
    <li>Please execute script ce7387802.sql from Patch 10170527.</li>
    <li>Follow the instructions provided in [1261895/KB752554]</li>
    <li><B>Impact Area:</B>Accounting / Reconciliation</li>
    </ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: ce10170527.sql');



debug('begin add_signature: ce_stmt_duplicate_fix.sql');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1087',
      p_sig_id                 => 'ce_stmt_duplicate_fix.sql',
      p_sig_sql                => 'select * from (select ccah.cashflow_id , 
    ccah.event_id , 
    ccah.event_type , 
    ccah.accounting_date , 
    xe.event_date , 
    status_code , 
    current_record_flag , 
    cleared_date , 
    cleared_amount , 
    lead(ccah.event_type, 1,''NONE'') over ( partition by cashflow_id order by 
    xe.event_number ) next_event, 
    lag(ccah.event_type, 1,''NONE'') over ( partition by cashflow_id order by 
    xe.event_number ) prev_event, 
    rowidtochar(ccah.rowid) rid , 
    ccah.reversal_second_dist_num rev_num, 
    lag(rowidtochar(ccah.rowid), 1,null ) over ( partition by cashflow_id 
    order by xe.event_number ) prev_reversal 
    from ce_cashflow_acct_h ccah, 
    xla_events xe 
    where ccah.cashflow_id = NVL(##$$TRXID$$##,-99)
    and   ccah.event_type like ''CE_STMT%''
    and   xe.event_id = ccah.event_id 
    ) 
    where event_type = ''CE_STMT_CANCELED'' 
    and next_event in (''CE_STMT_CANCELED'',''NONE'' ) 
    and prev_event = ''CE_STMT_CANCELED''',
      p_title                  => 'Duplicate cancelled events exist for Cashflow',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are duplicate cancelled events for the Cashflow which prevents accounting',
      p_solution               => '<ul>
    <li>Please execute script ce_stmt_duplicate_fix.sql from Patch 21046974</li>
    <li>Follow the instructions provided in [2013664/KB733078]</li>
    <li><B>Impact Area:</B>Accounting</li>
    </ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: ce_stmt_duplicate_fix.sql');



debug('begin add_signature: ce14041779.sql');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1088',
      p_sig_id                 => 'ce14041779.sql',
      p_sig_sql                => 'SELECT *
        FROM ce_payment_transactions
       WHERE trxn_reference_number IN
       (SELECT trxn_reference_number
          FROM ce_cashflows
         WHERE cashflow_id IN
         (SELECT a.cashflow_id
            FROM ce_cashflow_acct_h a
           WHERE a.cashflow_id = NVL(##$$TRXID$$##,-99)
           AND   event_type=''CE_BAT_CANCELED''
         AND (SELECT COUNT(*)
              FROM ce_cashflow_acct_h
      ...
      p_title                  => 'Bank Account Transfer is cancelled without clearing',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This Bank Account Transfer was cancelled without clearing.',
      p_solution               => 'Please follow the instructions in GDF [2075609/KB794103].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: ce14041779.sql');



debug('begin add_signature: ce_negative_ccid_gdf.sql');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1089',
      p_sig_id                 => 'ce_negative_ccid_gdf.sql',
      p_sig_sql                => 'Select t.rowid,
             t.trxn_reference_number,
             t.source_legal_entity_id,
             t.source_bank_account_id,
             t.destination_legal_entity_id,
             t.transaction_date,
             t.destination_bank_account_id,
          ( select asset_code_combination_id
          from ce_bank_accounts
          where bank_account_id = source_bank_account_id) source_cash,
          ( select asset_code_combination_id
          from ce_bank_accounts
          where bank_account_id = destination_bank_account_id) dest_cash
          From ce_payment_transactions t,CE_CASHFLOWS c
          Where c.cashflow_id   = NVL(##$$TRXID$$##,-99)
          AND   t.trxn_reference_number = c.trxn_reference_number
          AND   t.transaction_type =''BAT''
          AND ((nvl(t.receipt_offset_ccid,-1) < 0) OR (nvl(t.payment_offset_ccid,-1) < 0))',
      p_title                  => 'Negative or Null value for Offset CCID',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Offset CCID is negative or null for the BAT which prevents accounting',
      p_solution               => '<ul>
    <li>Please execute script ce_negative_ccid_gdf.sql from patch 12607963</li>
    <li>Follow instructions from [1388822/KB745868]</li>
    <li><B>Impact Area:</B>Accounting</li>
    </ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: ce_negative_ccid_gdf.sql');



debug('begin add_signature: ce13588856.sql');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1090',
      p_sig_id                 => 'ce13588856.sql',
      p_sig_sql                => 'select cah.cashflow_id, cah.event_id, cah.event_type, cah.status_code, cah.creation_date
      from ce_cashflows cf,
          ce_cashflow_acct_h cah,
          ce_bank_accounts ba,
          ce_system_parameters sys,
          gl_period_statuses glp
      where cah.cashflow_id = NVL(##$$TRXID$$##,-99)
      and cf.cashflow_id = cah.cashflow_id
      and cah.status_code = ''UNACCOUNTED''
      and cah.event_type = ''CE_BAT_UNCLEARED''
      --and trunc(cah.creation_date) IN (to_date(''12/15/2011'',''mm/dd/yyyy''),to_date(''10/28/2011'',''mm/dd/yyyy''))
      and ba.bank_account_id = cf.cashflow_bank_account_id
      ...
      and cah.accounting_date between glp.start_date and glp.end_date
      AND glp.closing_status not in (''O'',''F'')',
      p_title                  => 'BAT Events in closed period',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are unprocessed events in closed period which prevents accounting',
      p_solution               => '<ul>
    <li>Please log sr to get datafix  script ce22221914.sql </li>
    <li>Follow instructions from [1473896/KB732130]</li>
    <li><B>Impact Area:</B>Accounting</li>
    </ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: ce13588856.sql');



debug('begin add_signature: ce_clrbat_cancel_sel.sql');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3029',
      p_sig_id                 => 'ce_clrbat_cancel_sel.sql',
      p_sig_sql                => 'select cpt.TRXN_REFERENCE_NUMBER,   
  	       cpt.SETTLE_BY_SYSTEM_FLAG,	  
  	       cpt.TRANSACTION_TYPE,	  
  	       cpt.SOURCE_BANK_ACCOUNT_ID,	  
  	       cpt.DESTINATION_BANK_ACCOUNT_ID,	  
           ''N''   PROCESS_FLAG	  
  	from  (select cashflow_id,	  
  	              current_record_flag,	  
  	              event_type,	  
  	              lead(event_type, 1, ''NONE''  ) over ( partition by cashflow_id order by ccah.creation_date ) next_event,	  
  	              lag(event_type, 1,  ''NONE''  ) over ( partition by cashflow_id order by ccah.creation_date ) prev_event	  
  	      from  ce_cashflow_acct_h ccah,	  
  	            xla_events xe	  
  	      where 1=1	  
  	      and ccah.event_type        != ''CE_BAT_CREATED''     	  
  	      ...
  	      ce_cashflows cf	  
  	where prev_event          =     ''CE_BAT_CLEARED''    	  
  	  and event_type          =     ''CE_BAT_CANCELED''    	  
  	  and current_record_flag =     ''Y''
      and cf.cashflow_id      =     NVL(##$$TRXID$$##,-99)
      and cpt.TRXN_REFERENCE_NUMBER = cf.TRXN_REFERENCE_NUMBER	  
  	  and cf.cashflow_id = ces.cashflow_id	 
     	group by cpt.TRXN_REFERENCE_NUMBER,	  
  	         cpt.SETTLE_BY_SYSTEM_FLAG,	  
  	         cpt.TRANSACTION_TYPE,	  
  	         cpt.SOURCE_BANK_ACCOUNT_ID,	  
  	         cpt.DESTINATION_BANK_ACCOUNT_ID',
      p_title                  => 'BAT cancelled without being uncleared',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Bank Account Transfer(s) cancelled without unclearing.',
      p_solution               => 'Please follow the instructions in GDF [2075609/KB794103].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: ce_clrbat_cancel_sel.sql');



debug('begin add_signature: ce_cf_acct_stasel.sql');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '3104',
      p_sig_id                 => 'ce_cf_acct_stasel.sql',
      p_sig_sql                => 'SELECT  crh.cashflow_id
                , crh.event_id
                , crh.event_type
                , crh.status_code
                , crh.accounting_date
                ...
                , ''Y'' process_flag
      FROM   ce_cashflow_acct_h crh
      WHERE status_code = ''UNACCOUNTED''
      AND crh.cashflow_id        = NVL(##$$TRXID$$##,-99)
        AND EXISTS ( SELECT ''x'' FROM xla_events xe
                   WHERE xe.event_id = crh.event_id
                   AND event_status_code =''P''
                   AND process_status_code =''P'')',
      p_title                  => 'Accounted cashflows with unaccounted status in CE',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Cashflows those that have been accounted but status in CE still shows UNACCOUNTED                              ',
      p_solution               => '<ul>
    <li>Please run fix script ce_cf_acct_stafix.sql from Patch 23303193</li>
    <li>Follow instructions from [2104378/KB248003]</li>
    <li><B>Impact Area:</B>Accounting</li>
    </ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: ce_cf_acct_stasel.sql');



debug('begin add_signature: DUPLICATE BANK ACCOUNT TRANSFER  CREATED EVENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19836',
      p_sig_id                 => 'DUPLICATE BANK ACCOUNT TRANSFER  CREATED EVENTS',
      ...
      SELECT cf.cashflow_id 
              ...
              ,ccah.cleared_date 
              ,ccah.cleared_amount 
              ,ccah.clearing_charges_amount 
              ,ccah.clearing_error_amount 
              ,lead(event_type, 1,''NONE'') over ( partition BY ccah.cashflow_id order by xe.event_number ) next_event 
              ,lag(event_type, 1,''NONE'') over ( partition BY ccah.cashflow_id order by xe.event_number ) prev_event 
              ,xe.event_number
              ,''Y'' PROCESS_FLAG 
       FROM 
        ce_cashflows cf,
        ...
        xla_events xe
      WHERE cf.cashflow_id = ccah.cashflow_id
      and ccah.event_id = xe.event_id
      and ccah.event_type= ''CE_BAT_CREATED''
      AND ccah.cashflow_id IN (SELECT
                           cashflow_id
                           FROM 
                           ce_cashflow_acct_h 
                           WHERE 
                           event_type = ''CE_BAT_CREATED''
                           and cashflow_id IN (##$$TRXID$$##)
                           group by cashflow_id
                           having count(*) > 1))
where next_event =  ''CE_BAT_CREATED''
',
      p_title                  => 'Duplicate Bank Account Transfer  Created Events',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There are Bank Account Transfer (BAT) Cashflows which have duplicate created events',
      p_solution               => '<ul>
    <li>Please execute script ce_cf_dup_bat_created_fix.sql from Patch 23081621</li>
    <li>Follow the instructions provided in [2148028/KB774773]</li>
    <li><B>Impact Area:</B>Accounting</li>
    </ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: DUPLICATE BANK ACCOUNT TRANSFER  CREATED EVENTS');



debug('begin add_signature: EBS_FIN_AP_CETRXN_CE_XLA_CANCELLED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24763',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_CE_XLA_CANCELLED',
      p_sig_sql                => '	

select *  from XLA_EVENTS
where application_id = 260
and event_type_code = ''CE_STMT_RECORDED''
and event_status_code =''N''
and process_status_code = ''P''
and event_id IN (select event_id from CE_CASHFLOW_ACCT_H
                 where cashflow_id =NVL(##$$TRXID$$##,-99))',
      p_title                  => 'Statement Cashflow Cancelled',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Subledger Period Close Exception Shows Statement Cashflow Cancelled',
      p_solution               => 'Please log a Service request  to get a datafix as per [2273160/KB706753]',
      p_success_msg            => 'As CE_STMT_RECORDED event is set as N/P (Accounting not needed) hence CE_STMT_CANCELED fails to account.',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_CE_XLA_CANCELLED');



debug('begin add_signature: EBS_FIN_AP_CETRXN_INCORRECT_CASHFLOW_AMOUNT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25080',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_INCORRECT_CASHFLOW_AMOUNT',
      p_sig_sql                => 'select *
from CE_Cashflows
where cleared_amount = 0
and cashflow_amount > 0
and cashflow_id = NVL(##$$TRXID$$##,-99)',
      p_title                  => 'Incorrect cleared amount for cashflow',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Incorrect cleared amount for cashflow',
      p_solution               => 'Follow datafix in [2894363/KB794984]',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_INCORRECT_CASHFLOW_AMOUNT');



debug('begin add_signature: CE_BAT_CREATED EVENT GENERATED WITH EVENT_ID AS 0');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4504',
      p_sig_id                 => 'CE_BAT_CREATED EVENT GENERATED WITH EVENT_ID AS 0',
      p_sig_sql                => ' select cah.cashflow_id,
xe.event_id,
cah.accounting_date,
''A'' mm_type
from ce_cashflow_acct_h cah,
xla_events xe,
xla_transaction_entities_upg xt
where xt.application_id = 260
and xe.application_id = 260
and cah.cashflow_id = nvl(##$$TRXID$$##, - 99)
and cah.event_id = xe.event_id
and xt.entity_code <> ''MANUAL''
and xt.entity_id <> xe.entity_id
and xt.source_id_int_1 = cah.cashflow_id
union
select cah.cashflow_id,
xe.event_id,
cah.accounting_date,
''B'' mm_type
from ce_cashflow_acct_h cah,
xla_events xe
where xe.application_id = 260
  and cah.cashflow_id = nvl(##$$TRXID$$##, -99)
and xe.event_id = cah.event_id
and xe.event_type_code <> cah.event_type
union
select cah.cashflow_id,
xh.event_id,
cah.accounting_date,
...
xla_ae_lines xl,
xla_distribution_links xdl
where xh.application_id = 260
  and cah.cashflow_id = nvl(##$$TRXID$$##, -99)
and xh.event_id = cah.event_id
and xl.application_id = 260
and xh.ae_header_id = xl.ae_header_id
and xl.accounting_class_code = ''CASH''
and xdl.application_id = 260
and xdl.ae_header_id = xh.ae_header_id
and xl.ae_line_num = xdl.ae_line_num
and ((xdl.source_distribution_id_num_1 <> cah.cashflow_id)
or
(xdl.source_distribution_id_char_2 <> rowidtochar(cah.rowid)))
union
select cah.cashflow_id,
0,
cah.accounting_date,
...
where event_id = 0
  and cah.cashflow_id = nvl(##$$TRXID$$##, -99)
',
      p_title                  => 'CE_BAT_CREATED event generated with event_id as 0',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'CE_BAT_CREATED event is generated with event_id as 0 causing the other events not to trigger and fail.',
      p_solution               => '<ul>
<li>Please log an SR with Oracle to get fix ce_bat_acct_errors_fix_new.sql.</li>
<li>Follow the instructions provided in [2104721/KB729325]</li>
<li><B>Impact Area:</B>Accounting / Reconciliation</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: CE_BAT_CREATED EVENT GENERATED WITH EVENT_ID AS 0');



debug('begin add_signature: EBS_FIN_AP_CETRXN_EBS_FIN_AP_CE_PAYROLL_PMT_RECON_ERROR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30805',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_EBS_FIN_AP_CE_PAYROLL_PMT_RECON_ERROR',
      p_sig_sql                => 'select * from pay_ce_reconciled_payments p
where status_code=''C''
and not exists (select 1 from ce_statement_reconcils_all
where reference_id = p.assignment_action_id
and reference_type = ''PAY''
and current_record_flag = ''Y''
and status_flag = ''M'')',
      p_title                  => 'Reconcile Payroll Payments Error APP-PAY-52789',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Reconciling Payroll Payments receive error message: APP-PAY-52789 "This payment is not available for reconciliation in Oracle Payroll".',
      p_solution               => 'R12 CE:Unable To Reconcile Payroll Payments Error APP-PAY-52789: "This payment is not available for reconciliation in Oracle Payroll
[2866738/KB715153]',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_EBS_FIN_AP_CE_PAYROLL_PMT_RECON_ERROR');



debug('begin add_signature: EBS_FIN_AP_CETRXN_DUP_ACCTG_BANK_STMNT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30333',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_DUP_ACCTG_BANK_STMNT',
      p_sig_sql                => 'SELECT 
xah.event_id dh_event_id, 
xah.ledger_id, xah.event_type_code 
FROM 
xla_ae_headers xah 
WHERE 
xah.application_id = 260 
...
xla_transaction_entities_upg xte 
WHERE 
xte.application_id = 260 
AND NVL(source_id_int_1,-99) = ##$$TRXID$$## 
) 
AND xah.event_type_code = ''CE_STMT_RECORDED'' 
GROUP BY 
xah.event_id, 
xah.ledger_id, xah.event_type_code 
HAVING 
COUNT(*) > 1 
',
      p_title                  => 'Bank Statement Cashflow Recorded Events (CE_STMT_RECORDED) With Duplicate Accounting',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Bank Statement Cashflow recorded events (CE_STMT_RECORDED) have duplicate accounting, being posted to GL twice in different batches.

',
      p_solution               => 'Please log a service request with Oracle Support and request the data fix from [2960862/KB750986].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_DUP_ACCTG_BANK_STMNT');



debug('begin add_signature: EBS_FIN_AP_CETRXN_CE_BAT_UNCLEARED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '32318',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_CE_BAT_UNCLEARED',
      p_sig_sql                => 'select a.rowid RID, a.*
from CE_CASHFLOW_ACCT_H a, xla_events xe, xla_distribution_links xdl,CE_CASHFLOW_ACCT_H aa
where 1=1
and xdl.SOURCE_DISTRIBUTION_ID_CHAR_2 != aa.rowid
and aa.event_id =xdl.event_id
and aa.event_type =''CE_BAT_CLEARED''
and aa.CASHFLOW_ID =a.CASHFLOW_ID
and aa.rowid = a.REVERSAL_SECOND_DIST_NUM
and xe.process_status_code =''U''
and xe.event_status_code =''U''
and xe.event_id = a.event_id 
and a.status_code =''UNACCOUNTED''
and a.event_type =''CE_BAT_UNCLEARED''
and a.CASHFLOW_ID = ##$$TRXID$$##',
      p_title                  => 'Cash flow with CE_BAT_UNCLEARED event not getting picked for accounting',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Bank Account Transfer Uncleared is Not Getting Picked Up By Create Accounting',
      p_solution               => 'Please follow the instructions in [2350666/KB784629] to help resolve the issue.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_CE_BAT_UNCLEARED');



debug('begin add_signature: ce11704499.sql');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1091',
      p_sig_id                 => 'ce11704499.sql',
      p_sig_sql                => 'select * from ce_statement_reconcils_all a
        where exists ( SELECT NULL
        FROM ce_statement_reconcils_all cre2
        WHERE a.je_header_id = NVL(##$$TRXID$$##,-99)
        and a.je_header_id = cre2.je_header_id
        and a.reference_id = cre2.reference_id
        and cre2.status_flag = ''M''
        and nvl(cre2.current_record_flag, ''Y'') = ''Y'')
        and a.reference_type =''JE_LINE''
        and a.status_flag =''U''
        and a.current_record_flag = ''Y''',
      p_title                  => 'Type 1: Corruption in CURRENT_RECORD_FLAG / Type 2: Corruption in CURRENT_RECORD_FLAG',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Incorrect CURRENT_RECORD_FLAG for the Journal in  CE_STATEMENT_RECONCILS_ALL.',
      p_solution               => 'Please follow the instructions from [1291152/KB706852] to help troubleshoot the issue.  ',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: ce11704499.sql');



debug('begin add_signature: Reconciliation Data');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1092',
      p_sig_id                 => 'Reconciliation Data',
      p_sig_sql                => 'select *  from CE_STATEMENT_RECONCILS_ALL 
   where reference_id = NVL(##$$TRXID$$##,-99)
   and   reference_type NOT IN(''RECEIPT'',''JE_LINE'')
   and   reference_type = NVL(''##$$TRXTYPE$$##'',NULL)
   UNION
   select *  from CE_STATEMENT_RECONCILS_ALL
   where reference_id in (select d.cash_receipt_history_id from AR_CASH_RECEIPT_HISTORY_ALL d
          where d.cash_receipt_id in(select e.cash_receipt_id from ar_cash_receipts_all e where e.cash_receipt_id = NVL(##$$TRXID$$##,-99)))
   and   reference_type = NVL(''RECEIPT'',NULL)
   UNION
   select *  from CE_STATEMENT_RECONCILS_ALL 
   where JE_Header_id = NVL(##$$TRXID$$##,-99)
   and   reference_type = ''JE_LINE''',
      p_title                  => 'Transaction Information Respective To Reconciliation Status (CE_STATEMENT_RECONCILS_ALL)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No transaction information respective to Reconciliation Status',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: Reconciliation Data');



debug('begin add_signature: STATEMENT LINES DATA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4505',
      p_sig_id                 => 'STATEMENT LINES DATA',
      p_sig_sql                => 'select L.*  from CE_STATEMENT_Lines L Left Outer JOIN
   CE_STATEMENT_RECONCILS_ALL R
   ON L.statement_line_id = R.statement_line_id
   where R.reference_id = NVL(##$$TRXID$$##,-99)
   and   R.reference_type NOT IN(''RECEIPT'',''JE_LINE'')
   and   R.reference_type = NVL(''##$$TRXTYPE$$##'',NULL)
   UNION
  select L.*  from CE_STATEMENT_Lines L Left Outer JOIN
   CE_STATEMENT_RECONCILS_ALL R
   ON L.statement_line_id = R.statement_line_id
   where R.reference_id in (select d.cash_receipt_history_id from AR_CASH_RECEIPT_HISTORY_ALL d
          where d.cash_receipt_id in(select e.cash_receipt_id from ar_cash_receipts_all e where               e.cash_receipt_id =  NVL(##$$TRXID$$##,-99)))
   and   R.reference_type = NVL(''RECEIPT'',NULL)
   UNION
  select L.*  from CE_STATEMENT_Lines L Left Outer JOIN
   CE_STATEMENT_RECONCILS_ALL R
   ON L.statement_line_id = R.statement_line_id
   where R.JE_Header_id =  NVL(##$$TRXID$$##,-99)
   and   R.reference_type = ''JE_LINE''',
      p_title                  => 'CE Statement Lines Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'CE Statement Lines Table Data',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: STATEMENT LINES DATA');



debug('begin add_signature: STATEMENT HEADER DATA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '4506',
      p_sig_id                 => 'STATEMENT HEADER DATA',
      p_sig_sql                => 'select H.*  from ce_statement_headers H  INNER JOIN
   CE_STATEMENT_Lines L 
   ON L.statement_header_id = H.statement_header_id  
  LEFT  JOIN CE_STATEMENT_RECONCILS_ALL R   
   ON L.statement_line_id = R.statement_line_id  
   where R.reference_id = NVL(##$$TRXID$$##,-99)
   and   R.reference_type NOT IN(''RECEIPT'',''JE_LINE'')
   and   R.reference_type = NVL(''##$$TRXTYPE$$##'',NULL)
   UNION
  select H.*  from ce_statement_headers H  INNER JOIN
   CE_STATEMENT_Lines L 
   ON L.statement_header_id = H.statement_header_id  
  LEFT  JOIN CE_STATEMENT_RECONCILS_ALL R   
   ON L.statement_line_id = R.statement_line_id  
  ...
  LEFT  JOIN CE_STATEMENT_RECONCILS_ALL R   
   ...
   where R.JE_Header_id =  NVL(##$$TRXID$$##,-99)
   and   R.reference_type = ''JE_LINE''',
      p_title                  => 'CE Statement Header Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'CE Statement Header Table Data',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: STATEMENT HEADER DATA');



debug('begin add_signature: CE_CASHFLOWS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19094',
      p_sig_id                 => 'CE_CASHFLOWS',
      p_sig_sql                => 'Select *   
        From CE_Cashflows  a
        Where  a.cashflow_id = NVL(##$$TRXID$$##,-99)',
      p_title                  => 'Cashflow Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'CE_Cashflows Data',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CE_CASHFLOWS');



debug('begin add_signature: CE_PAYMENT_TRANSACTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19107',
      p_sig_id                 => 'CE_PAYMENT_TRANSACTIONS',
      p_sig_sql                => 'select * from CE_PAYMENT_TRANSACTIONS  
where TRXN_REFERENCE_NUMBER IN (SELECT TRXN_REFERENCE_NUMBER from CE_CASHFLOWS  
where cashflow_id = NVL(##$$TRXID$$##,-99))',
      p_title                  => 'Bank Account Transfer Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'CE_Payment_transactions Data',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CE_PAYMENT_TRANSACTIONS');



debug('begin add_signature: CE_CASHFLOW_ACCT_H');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19108',
      p_sig_id                 => 'CE_CASHFLOW_ACCT_H',
      p_sig_sql                => 'select * 
from CE_CASHFLOW_ACCT_H  
where cashflow_id = NVL(##$$TRXID$$##,-99)',
      p_title                  => 'Cashflow Accounting History Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'CE_Cashflow_Acct_H Data',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CE_CASHFLOW_ACCT_H');



debug('begin add_signature: CE_XLA_TRANSACTION_ENTITIES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19109',
      p_sig_id                 => 'CE_XLA_TRANSACTION_ENTITIES',
      p_sig_sql                => 'select * from 
xla.xla_transaction_entities
where application_id = 260
and source_id_int_1 = NVL(##$$TRXID$$##,-99)',
      p_title                  => 'Cashflow XLA Transaction Entity Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'XLA_Transaction_Entities Data',
      p_solution               => 'Improvement: Added schema name XLA to the table XLA.xla_transaction_entities',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: CE_XLA_TRANSACTION_ENTITIES');



debug('begin add_signature: CE_XLA_EVENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19110',
      p_sig_id                 => 'CE_XLA_EVENTS',
      p_sig_sql                => 'select *  from XLA_EVENTS  
where application_id = 260 
and event_id IN (select event_id from CE_CASHFLOW_ACCT_H  
                 where cashflow_id =NVL(##$$TRXID$$##,-99))',
      p_title                  => 'Cashflows XLA Events Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'XLA_Events Data',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CE_XLA_EVENTS');



debug('begin add_signature: CE_XLA_AE_HEADERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19111',
      p_sig_id                 => 'CE_XLA_AE_HEADERS',
...
and event_id IN (select event_id  from XLA_EVENTS  
				 ...
				 and event_id IN (select event_id from CE_CASHFLOW_ACCT_H  
				                  where cashflow_id = NVL(##$$TRXID$$##,-99)))',
      p_title                  => 'Cashflows XLA AE Headers Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'XLA_AE_Headers Data',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CE_XLA_AE_HEADERS');



debug('begin add_signature: CE_XLA_AE_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19112',
      p_sig_id                 => 'CE_XLA_AE_LINES',
      p_sig_sql                => 'SELECT xal.*, 
fnd_flex_ext.get_segs(''SQLGL'', ''GL#'', gl.chart_of_accounts_id, xal.code_combination_id) "Account" 
FROM XLA_AE_LINES xal, gl_ledgers gl 
WHERE xal.ledger_id = gl.ledger_id 
and xal.application_id = 260 
and xal.AE_HEADER_ID IN (SELECT xah.AE_HEADER_ID 
FROM XLA_AE_HEADERS xah 
WHERE xah.application_id = 260 
and xah.EVENT_ID IN (SELECT xe.EVENT_ID FROM XLA_EVENTS xe 
WHERE xe.application_id = 260 
and xe.EVENT_ID IN (SELECT EVENT_ID ccah 
FROM CE_CASHFLOW_ACCT_H ccah 
WHERE ccah.CASHFLOW_ID = NVL(##$$TRXID$$##,-99))))',
      p_title                  => 'Cashflows XLA AE Lines Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'XLA_AE_Lines Data',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CE_XLA_AE_LINES');



debug('begin add_signature: CE_XLA_DISTRIBUTION_LINKS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19113',
      p_sig_id                 => 'CE_XLA_DISTRIBUTION_LINKS',
      p_sig_sql                => 'SELECT *  FROM XLA_DISTRIBUTION_LINKS  
WHERE application_id = 260 
AND EVENT_ID IN (SELECT EVENT_ID FROM CE_CASHFLOW_ACCT_H  
                 WHERE CASHFLOW_ID = NVL(##$$TRXID$$##,-99))',
      p_title                  => 'Cashflows XLA Distribution Links Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'XLA_Distribution_Links Data',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CE_XLA_DISTRIBUTION_LINKS');



debug('begin add_signature: CE_XLA_ACCOUNTING_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19114',
      p_sig_id                 => 'CE_XLA_ACCOUNTING_ERRORS',
      p_sig_sql                => 'SELECT *  FROM XLA_ACCOUNTING_ERRORS  
WHERE application_id = 260 
AND EVENT_ID IN (SELECT EVENT_ID FROM CE_CASHFLOW_ACCT_H  
                 WHERE CASHFLOW_ID = NVL(##$$TRXID$$##,-99))',
      p_title                  => 'Cashflows Accounting Error Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'XLA_Accounting_Errors Data',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CE_XLA_ACCOUNTING_ERRORS');



debug('begin add_signature: CE_GL_PERIOD_STATUSES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19123',
      p_sig_id                 => 'CE_GL_PERIOD_STATUSES',
      p_sig_sql                => 'select distinct application_id, set_of_books_id, period_name, closing_status, start_date, end_date, period_type, period_year
from (SELECT gps.*  FROM GL_PERIOD_STATUSES gps 
                 , (select  accounting_date from ce_cashflow_acct_h 
     where cashflow_id = NVL(##$$TRXID$$##,-99)) atg_date                  
WHERE atg_date.accounting_date between gps.start_date and gps.end_date               
AND gps.application_id IN(101)                 
AND gps.ledger_id  in (SELECT SET_OF_BOOKS_ID  FROM CE_SYSTEM_PARAMETERS  
WHERE LEGAL_ENTITY_ID IN (SELECT CASHFLOW_LEGAL_ENTITY_ID  FROM CE_CASHFLOWS  
WHERE CASHFLOW_ID = NVL(##$$TRXID$$##,-99) )))',
      p_title                  => 'Cashflows GL Period Statuses Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'GL_Period_Statuses Data',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CE_GL_PERIOD_STATUSES');



debug('begin add_signature: CE_GL_IMPORT_REFERENCES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19115',
      p_sig_id                 => 'CE_GL_IMPORT_REFERENCES',
      p_sig_sql                => 'SELECT *  FROM GL_IMPORT_REFERENCES  
WHERE GL_SL_LINK_TABLE = ''XLAJEL''  
AND GL_SL_LINK_ID IN (SELECT GL_SL_LINK_ID  FROM XLA_AE_LINES  
WHERE application_id = 260 
AND AE_HEADER_ID IN (SELECT AE_HEADER_ID  FROM XLA_AE_HEADERS  
WHERE application_id =260
AND EVENT_ID IN (SELECT EVENT_ID FROM CE_CASHFLOW_ACCT_H  
WHERE CASHFLOW_ID = NVL(##$$TRXID$$##,-99))))',
      p_title                  => 'Cashflows GL Import References',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'GL_Import_References Data',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CE_GL_IMPORT_REFERENCES');



debug('begin add_signature: CE_GL_JE_BATCHES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19116',
      p_sig_id                 => 'CE_GL_JE_BATCHES',
      p_sig_sql                => 'SELECT *  FROM GL_JE_BATCHES  
WHERE JE_BATCH_ID IN (SELECT JE_BATCH_ID  FROM GL_IMPORT_REFERENCES  
WHERE GL_SL_LINK_TABLE = ''XLAJEL''  
AND GL_SL_LINK_ID IN (SELECT GL_SL_LINK_ID  FROM XLA_AE_LINES  
WHERE  APPLICATION_ID =260
AND AE_HEADER_ID IN (SELECT AE_HEADER_ID  FROM XLA_AE_HEADERS  
...
AND EVENT_ID IN (SELECT EVENT_ID FROM CE_CASHFLOW_ACCT_H  
WHERE CASHFLOW_ID = NVL(##$$TRXID$$##,-99)))))',
      p_title                  => 'Cashflows GL JE Batches Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'GL_JE_Batches Data',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CE_GL_JE_BATCHES');



debug('begin add_signature: CE_GL_JE_HEADERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19117',
      p_sig_id                 => 'CE_GL_JE_HEADERS',
      p_sig_sql                => 'SELECT *  FROM GL_JE_HEADERS  
WHERE JE_BATCH_ID IN (SELECT JE_BATCH_ID  FROM GL_IMPORT_REFERENCES  
WHERE GL_SL_LINK_TABLE = ''XLAJEL''  
AND GL_SL_LINK_ID IN (SELECT GL_SL_LINK_ID  FROM XLA_AE_LINES  
WHERE APPLICATION_ID =260 
...
AND EVENT_ID IN (SELECT EVENT_ID FROM CE_CASHFLOW_ACCT_H  
WHERE CASHFLOW_ID = NVL(##$$TRXID$$##,-99)))))',
      p_title                  => 'Cashflows GL JE Headers Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'GL_JE_Headers Data',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CE_GL_JE_HEADERS');



debug('begin add_signature: CE_GL_JE_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19118',
      p_sig_id                 => 'CE_GL_JE_LINES',
      p_sig_sql                => 'SELECT *  FROM GL_JE_LINES 
WHERE JE_HEADER_ID IN (SELECT JE_HEADER_ID FROM GL_JE_HEADERS
                       WHERE JE_BATCH_ID IN (SELECT JE_BATCH_ID  FROM GL_IMPORT_REFERENCES
                                             WHERE GL_SL_LINK_TABLE = ''XLAJEL''
                                             AND GL_SL_LINK_ID IN (SELECT GL_SL_LINK_ID  FROM XLA_AE_LINES
                                             WHERE APPLICATION_ID= 260
                                             AND AE_HEADER_ID IN (SELECT AE_HEADER_ID  FROM XLA_AE_HEADERS
                                                                  ...
                                                                  AND EVENT_ID IN (SELECT EVENT_ID FROM CE_CASHFLOW_ACCT_H
                                                                  WHERE CASHFLOW_ID = NVL(##$$TRXID$$##,-99))))))
AND JE_LINE_NUM IN (SELECT JE_LINE_NUM FROM GL_IMPORT_REFERENCES
                    WHERE GL_SL_LINK_TABLE = ''XLAJEL''
                    AND GL_SL_LINK_ID IN (SELECT GL_SL_LINK_ID  FROM XLA_AE_LINES
                                          WHERE APPLICATION_ID= 260
                                          AND AE_HEADER_ID IN (SELECT AE_HEADER_ID  FROM XLA_AE_HEADERS
                                          ...
                                          AND EVENT_ID IN (SELECT EVENT_ID FROM CE_CASHFLOW_ACCT_H
                                           WHERE CASHFLOW_ID = NVL(##$$TRXID$$##,-99)))))',
      p_title                  => 'Cashflows GL JE Lines Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'GL_JE_Lines Data',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CE_GL_JE_LINES');



debug('begin add_signature: CE_FUN_INTER_ACCOUNTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19122',
      p_sig_id                 => 'CE_FUN_INTER_ACCOUNTS',
      p_sig_sql                => 'SELECT * FROM FUN_INTER_ACCOUNTS  
WHERE FROM_LE_ID IN (select cashflow_legal_entity_id  from CE_cashflows 
where cashflow_id  = NVL(##$$TRXID$$##,-99))',
      p_title                  => 'Cashflows FUN Inter Accounts Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'FUN_Inter_Accounts Data',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CE_FUN_INTER_ACCOUNTS');



debug('begin add_signature: CE_FUN_BALANCE_ACCOUNTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19121',
      p_sig_id                 => 'CE_FUN_BALANCE_ACCOUNTS',
      p_sig_sql                => 'select * from FUN_BALANCE_ACCOUNTS 
where template_id IN (select template_id from FUN_BALANCE_OPTIONS 
where ledger_id IN ( select set_Of_books_id from CE_SYSTEM_PARAMETERS 
where legal_entity_id IN (select cashflow_legal_entity_id from CE_cashflows 
 where cashflow_id = NVL(##$$TRXID$$##,-99))))',
      p_title                  => 'Cashflows FUN Balance Accounts Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'FUN_Balance_Accounts Data',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CE_FUN_BALANCE_ACCOUNTS');



debug('begin add_signature: CE_FUN_BALANCE_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19120',
      p_sig_id                 => 'CE_FUN_BALANCE_OPTIONS',
      p_sig_sql                => 'select * from FUN_BALANCE_OPTIONS 
where ledger_id IN ( select set_Of_books_id from CE_SYSTEM_PARAMETERS 
 where legal_entity_id IN (select cashflow_legal_entity_id from CE_cashflows 
WHERE CASHFLOW_ID = NVL(##$$TRXID$$##,-99)))',
      p_title                  => 'Cashflows FUN Balance Options Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'FUN_Balance_Options Data',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CE_FUN_BALANCE_OPTIONS');



debug('begin add_signature: CE_GL_LEGAL_ENTITIES_BSVS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '19119',
      p_sig_id                 => 'CE_GL_LEGAL_ENTITIES_BSVS',
      p_sig_sql                => 'SELECT *  FROM GL_LEGAL_ENTITIES_BSVS  
WHERE LEGAL_ENTITY_ID IN  (SELECT OBJECT_ID  
FROM GL_LEDGER_CONFIG_DETAILS  
WHERE CONFIGURATION_ID IN (SELECT CONFIGURATION_ID  
FROM GL_LEDGER_CONFIGURATIONS  
WHERE NAME IN (SELECT NAME  FROM GL_LEDGERS  
WHERE LEDGER_ID IN (SELECT SET_OF_BOOKS_ID  
FROM CE_SYSTEM_PARAMETERS  
WHERE LEGAL_ENTITY_ID IN  (SELECT CASHFLOW_LEGAL_ENTITY_ID  
FROM CE_CASHFLOWS  
WHERE CASHFLOW_ID = NVL(##$$TRXID$$##,-99))))))',
      p_title                  => 'Cashflows Legal Entities BSVS Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'GL_Legal_Entities_BSVS Data',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CE_GL_LEGAL_ENTITIES_BSVS');



debug('begin add_signature: EBS_FIN_AP_CETRXN_UNDO_EVENT_LOG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30651',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_UNDO_EVENT_LOG',
      p_sig_sql                => 'select * 
from cashflow_undo_log
where cashflow_id = NVL(##$$TRXID$$##,-99)',
      p_title                  => 'CASHFLOW_UNDO_LOG',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'CASHFLOW_UNDO_LOG',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_UNDO_EVENT_LOG');



debug('begin add_signature: EBS_FIN_AP_CETRXN_UNDO_ORIG_XLA_EVENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30653',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_UNDO_ORIG_XLA_EVENTS',
      p_sig_sql                => 'select distinct xe.* 
from 
xla_events xe, 
cashflow_undo_log undo 
where xe.application_id = 260 
and xe.event_id = undo.NEW_EVENT_ID
and undo.cashflow_id = NVL(##$$TRXID$$##,-99) 
order by xe.event_id',
      p_title                  => 'Original/incorrect Accounting XLA_EVENTS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Original/Incorrect Accounting XLA_EVENTS',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_UNDO_ORIG_XLA_EVENTS');



debug('begin add_signature: EBS_FIN_AP_CETRXN_UNDO_ORIG_XLA_AE_HEADERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30654',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_UNDO_ORIG_XLA_AE_HEADERS',
      p_sig_sql                => 'select distinct xeh.* 
from xla_ae_headers xeh,
xla_events xe, 
cashflow_undo_log undo 
where xe.application_id = 260 
and xeh.application_id = 260 
and xe.event_id = undo.NEW_EVENT_ID
...
order by xeh.ae_header_id',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_UNDO_ORIG_XLA_AE_HEADERS');



debug('begin add_signature: EBS_FIN_AP_CETRXN_UNDO_ORIG_XLA_AE_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30656',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_UNDO_ORIG_XLA_AE_LINES',
      p_sig_sql                => 'select distinct xel.* 
...
where xe.application_id = 260 
and xeh.application_id = 260 
and xel.application_id = 260 
and xe.event_id = undo.NEW_EVENT_ID
and xel.ae_header_id = xeh.ae_header_id 
and xe.event_id = xeh.event_id 
and undo.cashflow_id = NVL(##$$TRXID$$##,-99)
order by xel.ae_header_id, xel.AE_LINE_NUM',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_UNDO_ORIG_XLA_AE_LINES');



debug('begin add_signature: EBS_FIN_AP_CETRXN_UNDO_ORIG_XDL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30657',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_UNDO_ORIG_XDL',
      p_sig_sql                => 'select distinct xdl.* 
...
order by xdl.ae_header_id, xdl.AE_LINE_NUM',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_UNDO_ORIG_XDL');



debug('begin add_signature: EBS_FIN_AP_CETRXN_UNDO_ORIGINAL_XTE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30441',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_UNDO_ORIGINAL_XTE',
      p_sig_sql                => 'select distinct xte.* 
from xla.xla_transaction_entities xte, 
cashflow_undo_log undo 
where xte.application_id = 260
and xte.entity_id = undo.NEW_ENTITY_ID
and xte.source_id_int_1 = NVL(##$$TRXID$$##,-99)
order by xte.entity_id',
      p_title                  => 'Original/incorrect Accounting from Undo in XLA_TRANSACTION_ENTITIES',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Original/Incorrect Accounting XLA_TRANSACTION_ENTITIES.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_UNDO_ORIGINAL_XTE');



debug('begin add_signature: EBS_FIN_AP_CETRXN_UNDO_REV_XLA_EVENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30659',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_UNDO_REV_XLA_EVENTS',
      p_sig_sql                => 'select distinct xe.* 
from xla_events xe, 
cashflow_undo_log undo 
where xe.application_id = 260 
and xe.event_id = undo.REV_EVENT_ID 
and undo.cashflow_id = NVL(##$$TRXID$$##,-99)  
order by xe.event_id',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_UNDO_REV_XLA_EVENTS');



debug('begin add_signature: EBS_FIN_AP_CETRXN_UNDO_REV_XLA_AE_HEADERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30660',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_UNDO_REV_XLA_AE_HEADERS',
      p_sig_sql                => 'select distinct xeh.* 
from xla_ae_headers xeh, 
xla_events xe, 
cashflow_undo_log undo 
...
and xeh.application_id = 260  
and xe.event_id = undo.REV_EVENT_ID 
and xeh.ae_header_id = undo.REV_AE_HEADER_ID
and xe.event_id = xeh.event_id 
and undo.cashflow_id = NVL(##$$TRXID$$##,-99) 
order by xeh.event_id',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_UNDO_REV_XLA_AE_HEADERS');



debug('begin add_signature: EBS_FIN_AP_CETRXN_UNDO_REV_XLA_AE_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30661',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_UNDO_REV_XLA_AE_LINES',
      p_sig_sql                => 'select distinct xel.* 
from xla_ae_lines xel, 
xla_ae_headers xeh, 
xla_events xe, 
...
order by xel.ae_header_id, xel.AE_LINE_NUM',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_UNDO_REV_XLA_AE_LINES');



debug('begin add_signature: EBS_FIN_AP_CETRXN_UNDO_REV_XDL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30662',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_UNDO_REV_XDL',
      p_sig_sql                => 'select distinct xdl.* 
from xla_distribution_links xdl, 
xla_ae_headers xeh, 
xla_events xe, 
...
and xdl.event_id = xe.event_id 
and undo.cashflow_id = NVL(##$$TRXID$$##,-99) 
order by xdl.event_id, xdl.AE_LINE_NUM',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_UNDO_REV_XDL');



debug('begin add_signature: EBS_FIN_AP_CETRXN_UNDO_REVERSAL_XTE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30437',
      p_sig_id                 => 'EBS_FIN_AP_CETRXN_UNDO_REVERSAL_XTE',
      p_sig_sql                => 'select distinct xte.* 
from xla.xla_transaction_entities xte, 
cashflow_undo_log undo 
where xte.application_id = 260
and xte.entity_id = undo.REV_ENTITY_ID
and xte.source_id_int_1 = NVL(##$$TRXID$$##,-99)
order by xte.entity_id',
      p_title                  => 'Reversal Accounting Data from Undo in XLA_TRANSACTION_ENTITIES',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Reversal generated by Undo in XLA_TRANSACTION_ENTITIES.',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_CETRXN_UNDO_REVERSAL_XTE');
...
debug('begin add_signature: APLIST_270_AP_INVOICES_ALL');
  ...
  add_signature(
      p_sig_repo_id            => '10721',
      p_sig_id                 => 'APLIST_270_AP_INVOICES_ALL',
      p_sig_sql                => 'SELECT distinct ai.*, fnd_flex_ext.get_segs(''SQLGL'',''GL#'', gl.chart_of_accounts_id , ai.accts_pay_code_combination_id) "Accts Pay Account" 
FROM AP_INVOICES_ALL ai, gl_ledgers gl 
WHERE 1=1 
and gl.ledger_id = ai.set_of_books_id
...
AND aip2.invoice_id IN (##$$ICVIEW$$##) 
UNION 
SELECT x.invoice_id 
from ap_invoices_all x 
where x.invoice_id in (##$$ICVIEW$$##)) 
ORDER BY decode (INVOICE_ID, ##$$ICVIEW$$##, 0, 1) asc, INVOICE_ID',
   ...
   l_info.delete;
debug('end add_signature: APLIST_270_AP_INVOICES_ALL');
...
debug('begin add_signature: APLIST_1470_GL_BC_PACKETS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '11002',
      p_sig_id                 => 'APLIST_1470_GL_BC_PACKETS',
      p_sig_sql                => 'SELECT * 
FROM GL_BC_PACKETS 
WHERE je_source_name = ''Payables'' 
AND reference2 = TO_CHAR (-99)',
      p_title                  => 'GL_BC_PACKETS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No rows selected',
      p_solution               => '',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: APLIST_1470_GL_BC_PACKETS');
...
debug('begin add_signature: CE_APPSCHECK_PROFILE_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10091',
      p_sig_id                 => 'CE_APPSCHECK_PROFILE_OPTIONS',
      p_sig_sql                => 'SELECT tl.Application_name, b.application_short_name,
            b.application_id "##$$FK3$$##",
            b.product_code "##$$FK4$$##"
      FROM fnd_application_tl tl, fnd_application b
      WHERE b.application_id in (260)
        AND tl.application_id = b.application_id
        AND tl.language = ''US''',
   ...
   l_info.delete;
debug('end add_signature: CE_APPSCHECK_PROFILE_OPTIONS');
...
debug('begin add_signature: PAYABLES OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1074',
      p_sig_id                 => 'PAYABLES OPTIONS',
      p_sig_sql                => 'select when_to_account_pmt,             
          nvl(recon_accounting_flag,''N'') recon_accounting_flag,    
          when_to_account_gain_loss, 
          future_dated_pmt_acct_source ,     
         automatic_offsets_flag,liability_post_lookup_code
  FROM    AP_SYSTEM_PARAMETERS_ALL   
  where   org_id = NVL(##$$ORGS$$##,-99)',
      p_title                  => 'Payables Options',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Payables Options',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: PAYABLES OPTIONS');



debug('begin add_signature: Receipt_Details');
   l_info('##MASK##10'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##11'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##12'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##17'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##MASK##2'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1075',
      p_sig_id                 => 'Receipt_Details',
      p_sig_sql                => 'SELECT   a.cash_receipt_id AS CashReceiptID,           
              a.receipt_number ReceiptNumber,            
              a.type Type1,                  
              to_char(a.receipt_date, ''DD-MON-YYYY'') ReceiptDate,
              a.amount Amount1 ,                    
              s.meaning  Meaning ,              
              a.currency_code Currency,
              round(a.exchange_rate,5) Erate,              
              to_char(a.exchange_date, ''DD-MON-YYYY'') ExchangeDate,
              substr(p.party_name, 1,50) PartyName,
              a.pay_from_customer PayFromCustomer,          
              cu.account_number AccountNumber,         
              su.location   Location,         
              a.customer_site_use_id  CustomerSiteID,     
              m.name MethodName,
              a.receipt_method_id ReceiptMethodID,        
              c.name ClassName,             
              a.payment_server_order_num ServerOrderNO, 
              a.approval_code ApprovalCode,           
              a.reversal_date ReversalDate,            
              r.meaning LookupMeaning,             
              a.reversal_comments ReversalComments,        
              rr.meaning LookupMeaning
  ...
  WHERE    a.cash_receipt_id = NVL(##$$TRXID$$##,-99)
    AND      m.receipt_method_id = a.receipt_method_id
    AND      c.receipt_class_id = m.receipt_class_id
    AND      s.lookup_type(+)  = ''CHECK_STATUS''
    AND      s.lookup_code(+)  = a.status
    AND      r.lookup_type(+)  = ''REVERSAL_CATEGORY_TYPE''
    AND      r.lookup_code(+)  = a.reversal_category 
    AND      rr.lookup_type(+) = ''CKAJST_REASON''
    AND      rr.lookup_code(+) = a.reversal_reason_code
    AND      cu.cust_account_id(+) = a.pay_from_customer
    AND      p.party_id(+) = cu.party_id
    AND      su.site_use_id(+) = a.customer_site_use_id',
      p_title                  => 'Receipt Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Receipt Details',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: Receipt_Details');



debug('begin add_signature: RECEIPT CLASS');
   l_info('##MASK##2'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '1070',
      p_sig_id                 => 'RECEIPT CLASS',
      p_sig_sql                => 'SELECT  a.receipt_class_id ,
        a.name,
        a.notes_receivable,
        a.creation_method_code,
        a.confirm_flag,
        a.remit_method_code,
        a.bill_of_exchange_flag,
        a.clear_flag,
        a.remit_flag,
        a.creation_status
  ...
  AND     c.cash_receipt_id   = NVL(##$$TRXID$$##,-99)',
      p_title                  => 'Receipt Class',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Receipt Class for transaction',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: RECEIPT CLASS');
...
BEGIN
  ...
  analyzer_title := 'Cash Management Transaction Analyzer';
...
start_section('Proactive and Preventative Recommendations', 'Proactive_and_Preventative_Recommendations');
   set_item_result(check_rec_patches_1); /* Signature CE_Trxn_check_rec_patches */
   set_item_result(run_stored_sig('CE_Trxn_FILE_VERSIONS'));
end_section;
debug('end section: Proactive_and_Preventative_Recommendations');

debug('begin section: LedgerandSubledgerDetails');
IF p_trx_id is not null  THEN
   start_section('Ledger and Subledger Details', 'LedgerandSubledgerDetails');
      set_item_result(run_stored_sig('CE_GL_LEDGERS'));
      set_item_result(run_stored_sig('CE SYSTEM OPTIONS'));
      set_item_result(run_stored_sig('INTERNAL BANK ACCOUNTS'));
      set_item_result(run_stored_sig('BANK ACCOUNT USE INFORMATION'));
      set_item_result(run_stored_sig('BANK ACCOUNT CCID SETUP'));
      IF p_trx_id is not null and p_trx_type = 'PAYMENT' THEN
         set_item_result(run_stored_sig('PAYABLES OPTIONS'));
      END IF;
      set_item_result(run_stored_sig('DUPLICATE BRANCH_PARTY_ID IN CE_BANK_BRANCHES_V'));
      IF p_trx_id is not null and p_trx_type = 'RECEIPT' THEN
         set_item_result(run_stored_sig('Receipt_Details'));
         set_item_result(run_stored_sig('RECEIPT CLASS'));
      END IF;
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_UD_AAD'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_XLA_ADR_JLD'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_CE_BANK_BRANCHES_V'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_CE_BANKS_V'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CA_EBS_FIN_AP_CETRXN_XLA_LAUNCH_OPTIONS'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_EBS_FIN_AP_CETRXN_XLA_JOURNAL_LINE_TYPE_CONDITIONS'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CA_EBS_CE_XLA_LEDGER_OPTIONS'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CA_EBS_FIN_AP_CETRXN_FND_ID_FLEX_STRUCTURES'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CA_JOURNAL_LINE_TYPES_ASSIGNED_TO_EACH_EVENT_CLASS'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_ADR_SEGMENT_RULES'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_ADR_SEGMENT_RULE_DETAILS'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_CE_XLA_JLD'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_CE_XLA_SHOW_SOURCES'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_CHART_OF_ACCOUNTS_SEGMENT_QUALIFIERS'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_CM_GL_LEDGERS'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_DYNAMIC_INSERT'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_EBS_CE_SLAM'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_EBS_CE_XLA_SHOW_CUSTOM_SOURCE_PARAMS'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_EBS_FIN_AP_CETRXN_AAD'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_EBS_FIN_AP_CETRXN_XLA_SOURCE_NA_PROB'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_EVENT_CLASS_ASSIGNMENT_FOR_CASH_MANAGEMENT_AAD'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_GL_PERIOD'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_HR_ORGANIZATION_UNITS'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_XLA_ACCOUNT_DERIVATION_RULE_CONDITIONS'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CUSTOM_SOURCE_PARAMETERS'));
      set_item_result(run_stored_sig('EBS_MFG_DM_CSTPERIODCLOSE_COST_CUTOFF_DATE_UNCOSTED'));
   end_section;
END IF;
debug('end section: LedgerandSubledgerDetails');

debug('begin section: Generic_Issues');
start_section('Generic Issues', 'Generic_Issues');
   set_item_result(run_stored_sig('ce_recon_curr_rec_flag_fix.sql'));
   set_item_result(run_stored_sig('ce13080978.sql'));
   set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_CE_INVALID_BRANCH_CODE'));
   set_item_result(run_stored_sig('CE_BRANCH_TYPE_NULL'));
end_section;
debug('end section: Generic_Issues');

debug('begin section: Payment');
IF p_trx_id is not null and p_trx_type = 'PAYMENT' THEN
   start_section('Payment', 'Payment');
      set_item_result(run_stored_sig('ap_pay_upg_cancel_x_event_num_fix.sql'));
      set_item_result(run_stored_sig('pay_upg_clr_x_event_num.sql'));
      set_item_result(run_stored_sig('CE_DUPLICATE_PAY_DOCUMENTS'));
      set_item_result(run_stored_sig('INCORRECT PAYMENT CLEARING ACCOUNT DUE TO FINAL ROUNDING'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_NO_LOV_TRANSACTIONS_AVL_RECONCILATION'));
   end_section;
END IF;
debug('end section: Payment');

debug('begin section: Cashflow');
IF p_trx_id is not null and p_trx_type = 'CASHFLOW' THEN
   start_section('Cashflow', 'Cashflow');
      set_item_result(run_stored_sig('ce_bat_dupacct_fix.sql'));
      set_item_result(run_stored_sig('ce10170527.sql'));
      set_item_result(run_stored_sig('ce_stmt_duplicate_fix.sql'));
      set_item_result(run_stored_sig('ce14041779.sql'));
      set_item_result(run_stored_sig('ce_negative_ccid_gdf.sql'));
      set_item_result(run_stored_sig('ce13588856.sql'));
      set_item_result(run_stored_sig('ce_clrbat_cancel_sel.sql'));
      set_item_result(run_stored_sig('ce_cf_acct_stasel.sql'));
      set_item_result(run_stored_sig('DUPLICATE BANK ACCOUNT TRANSFER  CREATED EVENTS'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_CE_XLA_CANCELLED'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_INCORRECT_CASHFLOW_AMOUNT'));
      set_item_result(run_stored_sig('CE_BAT_CREATED EVENT GENERATED WITH EVENT_ID AS 0'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_EBS_FIN_AP_CE_PAYROLL_PMT_RECON_ERROR'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_DUP_ACCTG_BANK_STMNT'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_CE_BAT_UNCLEARED'));
   end_section;
END IF;
debug('end section: Cashflow');

debug('begin section: Journal');
IF p_trx_id is not null and p_trx_type = 'JOURNAL' THEN
   start_section('Journal', 'Journal');
      set_item_result(run_stored_sig('ce11704499.sql'));
   end_section;
END IF;
debug('end section: Journal');

debug('begin section: Reconciliation_Data');
start_section('Reconciliation Data', 'Reconciliation_Data');
   set_item_result(run_stored_sig('Reconciliation Data'));
   set_item_result(run_stored_sig('STATEMENT LINES DATA'));
   set_item_result(run_stored_sig('STATEMENT HEADER DATA'));
end_section;
debug('end section: Reconciliation_Data');

debug('begin section: CEList');
IF p_trx_id is not null and p_trx_type = 'CASHFLOW' THEN
   start_section('Cashflow Data Collection(CE List)', 'CEList');
      set_item_result(run_stored_sig('CE_CASHFLOWS'));
      set_item_result(run_stored_sig('CE_PAYMENT_TRANSACTIONS'));
      set_item_result(run_stored_sig('CE_CASHFLOW_ACCT_H'));
      set_item_result(run_stored_sig('CE_XLA_TRANSACTION_ENTITIES'));
      set_item_result(run_stored_sig('CE_XLA_EVENTS'));
      set_item_result(run_stored_sig('CE_XLA_AE_HEADERS'));
      set_item_result(run_stored_sig('CE_XLA_AE_LINES'));
      set_item_result(run_stored_sig('CE_XLA_DISTRIBUTION_LINKS'));
      set_item_result(run_stored_sig('CE_XLA_ACCOUNTING_ERRORS'));
      set_item_result(run_stored_sig('CE_GL_PERIOD_STATUSES'));
      set_item_result(run_stored_sig('CE_GL_IMPORT_REFERENCES'));
      set_item_result(run_stored_sig('CE_GL_JE_BATCHES'));
      set_item_result(run_stored_sig('CE_GL_JE_HEADERS'));
      set_item_result(run_stored_sig('CE_GL_JE_LINES'));
      set_item_result(run_stored_sig('CE_FUN_INTER_ACCOUNTS'));
      set_item_result(run_stored_sig('CE_FUN_BALANCE_ACCOUNTS'));
      set_item_result(run_stored_sig('CE_FUN_BALANCE_OPTIONS'));
      set_item_result(run_stored_sig('CE_GL_LEGAL_ENTITIES_BSVS'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_UNDO_EVENT_LOG'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_UNDO_ORIG_XLA_EVENTS'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_UNDO_ORIG_XLA_AE_HEADERS'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_UNDO_ORIG_XLA_AE_LINES'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_UNDO_ORIG_XDL'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_UNDO_ORIGINAL_XTE'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_UNDO_REV_XLA_EVENTS'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_UNDO_REV_XLA_AE_HEADERS'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_UNDO_REV_XLA_AE_LINES'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_UNDO_REV_XDL'));
      set_item_result(run_stored_sig('EBS_FIN_AP_CETRXN_UNDO_REVERSAL_XTE'));
   end_section;
END IF;
debug('end section: CEList');

debug('begin section: APList');
IF p_trx_id is not null and p_trx_type = 'PAYMENT' THEN
   start_section('Payment Data Collection (APList)', 'APList');
      ...
      set_item_result(run_stored_sig('APLIST_270_AP_INVOICES_ALL'));
      ...
      set_item_result(run_stored_sig('APLIST_1470_GL_BC_PACKETS'));
...
start_section('Apps Check', 'AppsCheck');
   ...
   set_item_result(run_stored_sig('CE_APPSCHECK_PROFILE_OPTIONS'));
