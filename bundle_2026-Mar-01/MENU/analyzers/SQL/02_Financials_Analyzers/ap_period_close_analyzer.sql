...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Payables Period Close Analyzer         |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE ap_pclose_analyzer_pkg AUTHID DEFINER AS
...
(            p_ledger_id                    IN VARCHAR2    DEFAULT NULL
           ,p_ledger_id2                   IN VARCHAR2    DEFAULT NULL
           ,p_per_name                     IN VARCHAR2    DEFAULT NULL
           ,p_per_name2                    IN VARCHAR2    DEFAULT NULL
           ,p_org_ids                      IN VARCHAR2    DEFAULT NULL
           ,p_org_ids2                     IN VARCHAR2    DEFAULT NULL
           ,p_master_gdf                   IN VARCHAR2    DEFAULT 'N'
           ,p_max_output_rows              IN NUMBER      DEFAULT 500
...
END ap_pclose_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY ap_pclose_analyzer_pkg AS
-- $Id: ap_period_close_analyzer.sql, 200.68 2026/02/24 19:53:45 aliclin Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(1489381.1));
...
g_rec_patch_in_dx   VARCHAR2(1) := nvl('F','A'); -- 'A' all rows, change to 'F' for failing rows in DX only
...
----------------------------------------------------------------
g_ledger_id       VARCHAR2(240);
g_per_name       VARCHAR2(240);
g_org_ids         VARCHAR2(1150);
g_master_gdf      VARCHAR2(1);
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'AP_PCLOSE_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'AP_PCLOSE_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>AP_PCLOSE Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=1489381.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/ap_pclose_latest_ver.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,242,EBS,EBS Financials,EBS - Payables" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,242,EBS,EBS Financials,EBS - Payables" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},242,EBS,EBS Financials,EBS - Payables" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/3523183" class="blacklink" target="new">
...
<ul><li>200.68 24-FEB-2026 1 sig updated with latest KM/KB.</li>
<li>200.67 27-JAN-2026 Template &amp; sig changes for article ID replacements</li>
<li>200.66 05-DEC-2025 Template changes and 1 signatures updated&nbsp;</li>
<li>200.65 24-NOV-2025 5 signatures updated&nbsp;</li>
<li>200.64 26-SEP-2025 1 signature updated</li>
<li>200.63 29-AUG-2025 4 signature updated</li>
<li>200.62 25-JUL-2025 4 signature updated</li>
<li>200.61 30-JUN-2025 select deselect icons added, hover over text dark font</li>
<li>200.60 28-APR-2025 2 signature updated</li>
<li>200.59 21-MAR-2025 1 signature updated</li>
<li>200.58 25-OCT-2024 2 signatures updated</li>
<li>200.57 22-AUG-2024 2 signatures updated</li>
<li>200.56 22-JUL-2024 3 signatures updated</li>
<li>200.55 25-JUN-2024&nbsp; 1 signatures updated along template changes</li>
<li>200.54 22-MAY-2024 2 signatures updated</li>
<li>200.53 26-APR-2024 5 signatures updated</li>
<li>200.52 26-MAR-2024 3 signatures updated</li>
<li>200.51 22-DEC-2023&nbsp; &nbsp;2 signatures updated</li>
<li>200.50 21-NOV-2023&nbsp; 2 signatures updated</li>
<li>200.49 27-OCT-2023 &nbsp;2 signatures updated</li>
<li>200.48 26-SEP-2023 &nbsp;2 signatures updated</li>
<li>200.47 28-JUL-2023 &nbsp;1 signature updated along template changes</li>
<li>200.46 28-JUL-2023 &nbsp; 3 signatures updated</li>
<li>200.45 23-JUN-2023 &nbsp;2 signatures updated</li>
<li>200.44 25-MAY-2023 1 signature updated</li>
<li>200.43 05-MAY-2023 1 signature updated</li>
<li>200.42 27-MAR-2023 1 signature updated</li>
<li>200.41 22-FEB-2023 6 signatures updated</li>
<li>200.40 25-JAN-2023 Template changes, 3 signature changes</li>
<li>200.39 22-NOV-2022 1 signature change</li>
<li>200.38 23-SEP-2022 Template changes, 2 signature changes</li>
<li>200.37 25-AUG-2022 various signature changes</li>
<li>200.36 23-MAR-2022 various signature changes</li>
<li>200.35 Dec 23 2021 various signature changes including adding solutions</li>
<li>200.34 Oct 14 2021 Crowdsource feedback option included and other framework changes</li>
<li>200.33: March-2021-Added Lifetime Support Policy</li>
<li>200.32: Many New Signatures added in the Data Integrity section</li>
<li>200.31: Configured standardized timestamp format on query results</li>
<li>200.30: Bug fixes and enhancements<ul><li>Added section for XLA to GL transfer issues</li>
</ul>
</li>
<li>200.29: New features from the latest analyzer framework<ul><li>Failure conditions are shown with the signature queries</li>
<li>Failed rows in query results are highlighted in addition to the failed column</li>
<li>Leading/trailing whitespace and invalid characters in query results are hidden by default and can be shown when present</li>
<li>Added ability to filter signatures to only those containing such hidden data</li>
<li>Search matches within query results are highlighted</li>
</ul>
</li>
<li>200.28: Several section updates:<ul><li>Enhanced ledger setup details</li>
<li>Minor bug fixes</li>
</ul>
</li>
<li>200.27: The Data Masking feature has been expanded:<ul><li>Select data is now pre-masked at the point of collection</li>
<li>The masked information displayed will be just enough to permit effective review and troubleshooting of an issue. For example:<ul><li>A credit card number would be displayed as ****-****-****-1234</li>
<li>An employee name would be displayed as Display first and last 25% per word (J**n S**w = John Snow)</li>
</ul>
</li>
<li>The existing “Lock Icon” still provides customers the manual column scrambling capabilities, which can be used in addition to the newly introduced pre-masked data feature</li>
</ul>
</li>
<li>200.26: Bug fixes and enhancements.</li>
</ul>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,242,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Payables" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,242,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Payables" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},242,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Payables" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
----------------------------------------------------------------
-- Wrapper to submit gdf import via FND_REQUEST.SUBMIT_REQUEST
FUNCTION submit_mgd(p_start_date in varchar2,
                           p_end_date in varchar2,
                           p_org_id in varchar2,
                           p_max_no_rows in varchar2 default 10,
                           p_debug_mode in varchar2 default 'Y'
                           )
RETURN BOOLEAN
IS
...
BEGIN
  ...
  v_request_id := Fnd_Request.submit_request (
                         application => 'SQLAP',
                         program     => 'APGDFVAL',
                         description => 'AP Data validation report',
                         start_time  => SYSDATE,
                         sub_request => FALSE,
                         argument1 => 'ALL',  -- Transaction Type
                         argument2 => p_start_date,--'01-JUN-2012',    -- Start Date
                         argument3 => p_end_date,--'30-JUN-2012',    -- End Date
                         argument4 => p_org_id,--'204',    -- Operating Unit
                         argument5 => p_max_no_rows, --null,    -- Max Rows per Validation
                         argument6 => p_debug_mode--'Y' -- Debug Mode
                       );
  COMMIT;

  IF ( v_request_id = 0 ) THEN
    dbms_output.put_line( 'AP GDF validation Program Not Submitted');
        v_sub_status := FALSE;
  ELSE
  ...
  --Testing end statusv_request_id
    IF ( UPPER(v_request_status) in ('NORMAL','WARNING')) THEN
          v_sub_status := TRUE;
    END IF;
  END IF;
  RETURN (v_sub_status);
EXCEPTION
  WHEN OTHERS THEN
   DBMS_OUTPUT.PUT_LINE('Error in Submitting AP GDF validation Program and error is '||SUBSTR(SQLERRM,1,200));
   RETURN (FALSE);
END submit_mgd;
...
e_gdf_pkg       exception;
l_sql           varchar2(1000);
l_sub_status    boolean;
p_debug_mode    varchar2(1);

CURSOR  chk_pkg IS
    SELECT  count(*)
    FROM    all_objects
    WHERE   object_name LIKE 'AP_GDF_DETECT_PKG'
    AND     status = 'VALID';

BEGIN

-- Running the AP Data Validation Report based on user input
    IF (nvl(g_master_gdf,'N') = 'Y' AND (NOT g_is_concurrent)) THEN
          OPEN chk_pkg;
          FETCH chk_pkg INTO l_chk_pkg;
          IF l_chk_pkg = 2 THEN
            l_sql := 'begin ap_gdf_detect_pkg.main('||
              'p_start_date  => :a1, '||
              'p_end_date  => :a2, '||
              'p_org_ids  => :a3, '||
              'p_trx_type  => ''ALL'', '||
            ...
            EXECUTE immediate (l_sql)
              USING g_start_date, g_end_date, g_org_ids, g_debug_mode;
            CLOSE chk_pkg;
          else
            dbms_output.put_line(chr(10)||
              'The AP Data Validation Package is not defined/invalid. '||
              'Please follow note 1360390.1 to install it.');
            print_log('The AP Data Validation Package is not defined/invalid. '||
              'Please follow note 1360390.1 to install it or make sure package is valid.');
            CLOSE chk_pkg;
            raise e_gdf_pkg;
         end if;
    ELSIF (nvl(g_master_gdf,'N') = 'Y' and g_is_concurrent) then
          OPEN chk_pkg;
          FETCH chk_pkg INTO l_chk_pkg;
          IF l_chk_pkg = 2 THEN
          l_sub_status := submit_mgd(
            p_start_date => to_char(g_start_date,'YYYY-MM-DD HH24:MI:SS'),
            p_end_date => to_char(g_end_date,'YYYY-MM-DD HH24:MI:SS'),
            p_org_id => g_org_ids,
            p_max_no_rows => to_char(g_max_output_rows),
            p_debug_mode => g_debug_mode);
          IF l_sub_status THEN
            print_log('AP GDF validation Status: Sucessful');
            DBMS_OUTPUT.PUT_LINE( 'AP GDF validation Status: Sucessful');
          ELSE
            print_log('AP GDF validation Status: Failed');
            DBMS_OUTPUT.PUT_LINE( 'AP GDF validation Status: Failed');
          END IF;
            CLOSE chk_pkg;
          else
            dbms_output.put_line(chr(10)||'AP Data Validation Package is not defined/invalid. Please follow note 1360390.1');
            print_log('The AP Data Validation Package is not defined/invalid. '||
              'Please follow note 1360390.1 to install it or make sure package is valid.');
            CLOSE chk_pkg;
            raise e_gdf_pkg;
...
print_log('Invalid value provided for parameter p_master_gdf: '|| p_debug_mode);
...
BEGIN
    ...
    print_log('Processing recommended patches signature: AP_RPC_PATCHES (check_rec_patches_1) "AP Recommended Patch Collection (RPC)" (version 28)');
...
FUNCTION check_rec_patches_2 RETURN VARCHAR2 IS
  /* Signature pclose_check_rec_patches */
  l_col_rows   COL_LIST_TBL := col_list_tbl(); -- Row values
  l_rel_rows   COL_LIST_TBL := col_list_tbl(); -- Row release
  l_hdr        VARCHAR_TBL  := varchar_tbl(); -- Column headings
  l_app_date   DATE;         -- Patch applied date
...
BEGIN
    ...
    print_log('Processing recommended patches signature: pclose_check_rec_patches (check_rec_patches_2) "Consolidated GDF UNDO Accounting Pre-req patch" (version 5)');
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.0' THEN
   ...
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Consolidated GDF Pre-Req for Undo Acctg';
   l_col_rows(5)(l_rows) := NULL;
...
END IF;
   ...
   l_sig.sigrepo_id := '920';
   l_sig.title := 'Consolidated GDF UNDO Accounting Pre-req patch';
   l_sig.fail_condition := '[Applied] = [No]';
   l_sig.problem_descr := 'Without this patch, undo accounting failures may not be reported and a GDF may appear to fail to fix the data when an undo error has occurred.';
   l_sig.solution := 'Please schedule to apply patch.';
   l_sig.success_msg := '';
   l_sig.print_condition := 'ALWAYS';
   l_sig.fail_type := 'W';
   l_sig.print_sql_output := 'Y';
  ...
  -- Register
  l_step := '60';
  g_signatures('pclose_check_rec_patches') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'pclose_check_rec_patches',     -- sig ID
    l_sig,                              -- signature information
    l_col_rows,                         -- data
    l_hdr);                             -- headers
...
CURSOR chk_period(c_ledger_id NUMBER, c_period VARCHAR2) IS
    SELECT l.name
    FROM gl_ledgers l,
         gl_period_statuses ps
    WHERE l.ledger_id = c_ledger_id
    AND   ps.ledger_id = l.ledger_id
    AND   ps.application_id = 200
    AND   ps.period_name = c_period
...
debug('begin populate parameters hash table');
   ...
   IF NOT g_is_concurrent THEN 
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Ledger_ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_ledger_id2,'NO_MASK');
   END IF;
   IF g_is_concurrent THEN 
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Period Name';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_per_name,'NO_MASK');
   END IF;
   IF NOT g_is_concurrent THEN 
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Period_Name';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_per_name2,'NO_MASK');
   END IF;
   IF g_is_concurrent THEN 
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Org ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_org_ids,'NO_MASK');
   END IF;
   IF NOT g_is_concurrent THEN 
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Org_IDs';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_org_ids2,'NO_MASK');
   END IF;
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Run MGD';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_master_gdf,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Max Rows';
...
-- Revision and date values can be populated by RCS
  l_revision := rtrim(replace('$Revision: 200.68  $','$',''));
  l_revision := ltrim(replace(l_revision,'Revision:',''));
  l_date_char := rtrim(replace('$Date: 2026/02/24 19:53:44 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'ap_period_close_analyzer.sql';
...
debug('begin parameter validation: p_ledger_id2');
IF NOT g_is_concurrent THEN
IF p_ledger_id2 IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Ledger_ID is required.');
   raise invalid_parameters;
END IF;
IF p_ledger_id2 IS NOT NULL THEN
BEGIN
SELECT LEDGER_ID
INTO l_exists_val
FROM GL_LEDGERS
WHERE LEDGER_ID = p_ledger_id2 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid ledger specified.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_ledger_id2 failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
END IF;
debug('end parameter validation: p_ledger_id2');

debug('begin parameter validation: p_per_name2');
IF NOT g_is_concurrent THEN
IF p_per_name2 IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Period_Name is required.');
   raise invalid_parameters;
END IF;
IF p_per_name2 IS NOT NULL THEN
BEGIN
SELECT PERIOD_NAME
INTO l_exists_val
FROM GL_PERIOD_STATUSES
WHERE PERIOD_NAME = p_per_name2
 AND application_id = 200 and set_of_books_id = p_ledger_id2 and closing_status not in ('N','C','P') and adjustment_period_flag <> 'Y'
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid period specified.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_per_name2 failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
END IF;
debug('end parameter validation: p_per_name2');


debug('begin parameter validation: p_master_gdf');
IF p_master_gdf IS NOT NULL AND p_master_gdf NOT IN ( 'N','Y') THEN
   print_error('INVALID ARGUMENT: Invalid MGD option specified. Valid values are Y or N.');
   raise invalid_parameters;
END IF;
debug('end parameter validation: p_master_gdf');
...
g_ledger_id := nvl(p_ledger_id,p_ledger_id2);

g_org_ids     := rtrim(ltrim(replace(nvl(p_org_ids,p_org_ids2),' ',''),','),',');
debug('g_org_ids= '||g_org_ids);

g_per_name := nvl(p_per_name,p_per_name2);
debug('g_per_name= '||g_per_name);

g_master_gdf  := upper(p_master_gdf);
debug('g_master_gdf= '||g_master_gdf);

g_DBbanner := l_DBbanner;

-- Validate ledger_id and period
-- Must be valid ledger ID and open period for that ledger
  OPEN chk_period(g_ledger_id, g_per_name);
  FETCH chk_period INTO l_ledger_name;
  IF chk_period%NOTFOUND THEN
    BEGIN
      SELECT name INTO l_ledger_name
      FROM gl_ledgers
      WHERE ledger_id = g_ledger_id;
    EXCEPTION WHEN NO_DATA_FOUND THEN
      print_log('The ledger id provided ('||g_ledger_id||
        ') is not a valid ledger_id');
      raise invalid_parameters;
    END;
    print_log('The period ('||g_per_name||') '||
      'is not an open period for the ledger '||l_ledger_name||'. '||
      'The period selected must be defined and in Open or Future '||
...
-- Getting the start and end date from the period name
  IF g_per_name is not null THEN
    BEGIN
      SELECT start_date, end_date
      INTO g_start_date, g_end_date
      FROM gl_period_statuses
      WHERE set_of_books_id = nvl(g_ledger_id,set_of_books_id)
      AND   period_name = g_per_name
      AND   application_id in (200);
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
        print_log('Error in validating the period name: '||g_per_name);
        print_log('No Date Found: Issue in getting the start date and '||
          'end date for the period name.');
          raise invalid_parameters;
      WHEN OTHERS THEN
        print_log('Error in validating the period name: '||g_per_name);
        print_log('Others: Issue in getting the start date and '||
          'end date for the period name.'||sqlerrm);
          raise;
    END;
  END IF;
...
-- Validate org_ids
  IF g_org_ids is not null THEN
    ...
    EXCEPTION WHEN OTHERS THEN
      ...
      print_log('All OU''s must be associated with ledger: '||l_ledger_name);
      print_log('Error on: '||l_org);
      raise;
    END;
  ELSE
    FOR rec IN (SELECT org_id FROM ap_system_parameters_all
                WHERE set_of_books_id = g_ledger_id
                AND   (mo_global.is_mo_init_done = 'N' or mo_global.check_access(org_id) = 'Y')
    ) LOOP
      IF g_org_ids is null THEN
        g_org_ids := rec.org_id;
      ELSE
        g_org_ids := g_org_ids||','||rec.org_id;
      END IF; 
    END LOOP;
    IF g_org_ids is null THEN
      print_log('Unable to obtain valid operating units for ledger '||
        l_ledger_name);
      raise invalid_parameters;
    END IF;
  END IF;
...
-- Not NULL
  IF (g_start_date is null OR g_end_date is null) THEN
    print_log('Error: unable to obtain start or end dates for the period '||
      g_per_name);
    raise invalid_parameters;
  END IF;


/* -- g_print_to_stdout is not global parameter in alta fmw
-- do not see why this is used so commenting it
...
-- Validate master_gdf  parameter
  IF upper(g_master_gdf) NOT IN ('Y','N') THEN
    print_log('Invalid value provided for parameter p_master_gdf: '||
      p_debug_mode);
    print_log('Valid values are Y and N. Using default value: N');
    g_master_gdf := 'N';
  END IF;
...
-- Calling procedure for MGD Data Validation Report
begin
  mgd;
end;
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$SDT$$##') := g_start_date;
   g_masked_tokens('##$$SDT$$##') := mask_text( g_sql_tokens('##$$SDT$$##'), 'NO_MASK');
   g_sql_tokens('##$$EDT$$##') := g_end_date;
   g_masked_tokens('##$$EDT$$##') := mask_text( g_sql_tokens('##$$EDT$$##'), 'NO_MASK');
   g_sql_tokens('##$$ORGS$$##') := g_org_ids;
   g_masked_tokens('##$$ORGS$$##') := mask_text( g_sql_tokens('##$$ORGS$$##'), 'NO_MASK');
   g_sql_tokens('##$$PNAME$$##') := chr(39)||g_per_name||chr(39);
   g_masked_tokens('##$$PNAME$$##') := mask_text( g_sql_tokens('##$$PNAME$$##'), 'NO_MASK');
   g_sql_tokens('##$$LID$$##') := g_ledger_id;
   g_masked_tokens('##$$LID$$##') := mask_text( g_sql_tokens('##$$LID$$##'), 'NO_MASK');
   g_sql_tokens('##$$DVIEW$$##') := 'SELECT /*+ qb_name(dview) */ '||
     'd.invoice_distribution_id '||
     'FROM ap_invoice_distributions_all d '||
     'WHERE d.org_id in ('||g_org_ids||') '||
     'AND   d.accounting_date BETWEEN '||
     '        to_date('''||g_start_date||''') AND '||
     '        to_date('''||g_end_date||''')';
   g_masked_tokens('##$$DVIEW$$##') := mask_text( g_sql_tokens('##$$DVIEW$$##'), 'NO_MASK');
   g_sql_tokens('##$$LVIEW$$##') := 'SELECT /*+ qb_name(lview) */ '||
     'DISTINCT l.invoice_id,l.line_number '||
     'FROM ap_invoice_lines_all l '||
     'WHERE l.org_id in ('||g_org_ids||') '||
     'AND   l.accounting_date BETWEEN '||
     '        to_date('''||g_start_date||''') AND '||
     '        to_date('''||g_end_date||''')';
   g_masked_tokens('##$$LVIEW$$##') := mask_text( g_sql_tokens('##$$LVIEW$$##'), 'NO_MASK');
   g_sql_tokens('##$$CVIEW$$##') := 'SELECT /*+ qb_name(cview) */ '||
     'DISTINCT ph.check_id '||
   ...
   g_sql_tokens('##$$IVIEW$$##') := 'SELECT /*+ qb_name(iview) */ '||
   ...
   g_sql_tokens('##$$PLGRID$$##') := 'select ledger_id
from gl_ledgers
where ledger_id in (
'||nvl(p_ledger_id,-99)||',
'||nvl(p_ledger_id2,-99)||')';
   g_masked_tokens('##$$PLGRID$$##') := mask_text( g_sql_tokens('##$$PLGRID$$##'), 'NO_MASK');
   g_sql_tokens('##$$LGRIDS$$##') := 'select ledger_id from gl_ledgers where ledger_id in ( '||nvl(p_ledger_id,-99)||', '||nvl(p_ledger_id2,-99)||')';
   g_masked_tokens('##$$LGRIDS$$##') := mask_text( g_sql_tokens('##$$LGRIDS$$##'), 'NO_MASK');
   g_sql_tokens('##$$LGRS$$##') := 'SELECT distinct gl.ledger_id FROM gl_ledgers gl , gl_ledger_relationships glr1 , gl_ledger_relationships glr2 , gl_ledger_relationships glr3 where glr3.source_ledger_id = glr2.primary_ledger_id and glr2.target_ledger_id = glr1.primary_ledger_id and gl.ledger_id = glr1.source_ledger_id and glr3.source_ledger_id  
IN ( '||nvl(p_ledger_id,-99)||', '||nvl(p_ledger_id2,-99)||')';
   g_masked_tokens('##$$LGRS$$##') := mask_text( g_sql_tokens('##$$LGRS$$##'), 'NO_MASK');
   g_sql_tokens('##$$MIVIEW$$##') := 'SELECT /*+ materialize */ '||
     'DISTINCT d.invoice_id '||
     'FROM ap_invoice_distributions_all d '||
     'WHERE d.org_id in ('||g_org_ids||') '||
     'AND   d.accounting_date BETWEEN '||
     '        to_date('''||g_start_date||''') AND '||
     '        to_date('''||g_end_date||''')';
   g_masked_tokens('##$$MIVIEW$$##') := mask_text( g_sql_tokens('##$$MIVIEW$$##'), 'NO_MASK');
...
debug('begin add_signature: GL_LEDGERS');
  ...
  add_signature(
    ...
    where glr3.source_ledger_id = glr2.primary_ledger_id 
          ...
          and glr3.source_ledger_id in (##$$PLGRID$$##)',
...
debug('begin add_signature: GL_PERIOD_STATUSES2');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10587',
      p_sig_id                 => 'GL_PERIOD_STATUSES2',
      p_sig_sql                => 'select *
from gl_period_statuses
where LEDGER_id in (##$$PLGRID$$##)
and period_name = ##$$PNAME$$##
and application_id in (101,200)
ORDER BY LEDGER_ID',
      p_title                  => 'GL Period Statuses Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'GL Period Statuses Information',
      p_solution               => 'GL Period Statuses Information',
      p_success_msg            => 'GL Period Statuses Information',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: GL_PERIOD_STATUSES2');



debug('begin add_signature: CAA_GL_LEDGER_RELATIONSHIPS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10236',
      p_sig_id                 => 'CAA_GL_LEDGER_RELATIONSHIPS',
    ...
    where glr3.source_ledger_id = glr2.primary_ledger_id 
          and glr2.target_ledger_id = glr1.primary_ledger_id 
          and gl.ledger_id = glr1.source_ledger_id 
          and glr3.source_ledger_id in (##$$LGRIDS$$##)
order by glr1.primary_ledger_id',
      p_title                  => 'General Ledger Relationship Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'General Ledger Relationship Information',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: CAA_GL_LEDGER_RELATIONSHIPS');



debug('begin add_signature: APLIST_50_XLA_LEDGER_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10416',
      p_sig_id                 => 'APLIST_50_XLA_LEDGER_OPTIONS',
      p_sig_sql                => 'SELECT DISTINCT gl.* FROM XLA_LEDGER_OPTIONS gl, gl_ledger_relationships glr1, gl_ledger_relationships glr2, gl_ledger_relationships glr3 WHERE glr3.source_ledger_id in (##$$LGRIDS$$##)
AND glr3.source_ledger_id = glr2.primary_ledger_id AND glr2.target_ledger_id = glr1.primary_ledger_id AND gl.ledger_id = glr1.source_ledger_id AND gl.application_id = 200 ORDER BY gl.ledger_id',
      p_title                  => 'XLA_LEDGER_OPTIONS',
      p_fail_condition         => 'NRS',
   ...
   l_info.delete;
debug('end add_signature: APLIST_50_XLA_LEDGER_OPTIONS');



debug('begin add_signature: APLIST_60_XLA_LAUNCH_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10417',
      p_sig_id                 => 'APLIST_60_XLA_LAUNCH_OPTIONS',
      p_sig_sql                => 'SELECT DISTINCT gl.* FROM XLA_LAUNCH_OPTIONS gl, gl_ledger_relationships glr1, gl_ledger_relationships glr2, gl_ledger_relationships glr3 WHERE glr3.source_ledger_id in (##$$LGRIDS$$##) AND glr3.source_ledger_id = glr2.primary_ledger_id AND glr2.target_ledger_id = glr1.primary_ledger_id AND gl.ledger_id = glr1.source_ledger_id AND gl.application_id = 200 ORDER BY gl.ledger_id',
      p_title                  => 'XLA_LAUNCH_OPTIONS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'XLA_LAUNCH_OPTIONS',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: APLIST_60_XLA_LAUNCH_OPTIONS');



debug('begin add_signature: AP_SYSTEM_PARAMETERS_ALL');
   l_info('##MASK##FEDERAL_IDENTIFICATION_NUM'):= 'DISPLAY_FIRST_25_PCNT';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '937',
      p_sig_id                 => 'AP_SYSTEM_PARAMETERS_ALL',
      p_sig_sql                => 'select *
       from ap_system_parameters_all
      where set_of_books_id = nvl(##$$LID$$##,set_of_books_id)',
      p_title                  => 'Payables Options Set for Ledger',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Payables Options Set for Ledger',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: AP_SYSTEM_PARAMETERS_ALL');



debug('begin add_signature: pclose_HR_ORGANIZATION_UNITS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '938',
      p_sig_id                 => 'pclose_HR_ORGANIZATION_UNITS',
    ...
    WHERE organization_id IN (
            SELECT org_id FROM ap_system_parameters_all
            WHERE set_of_books_id = nvl(##$$LID$$##,set_of_books_id))',
      p_title                  => 'Operating Units attached to the Ledger',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Operating Units attached to the Ledger',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: pclose_HR_ORGANIZATION_UNITS');



debug('begin add_signature: GL_CHART_OF_ACCOUNTS_SEGMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8990',
      p_sig_id                 => 'GL_CHART_OF_ACCOUNTS_SEGMENTS',
      p_sig_sql                => 'SELECT DISTINCT
    ldgr.chart_of_accounts_id,
    ldgr.chart_of_accounts_name,
    sgmt.*,
    attr.segment_attribute_type
FROM
    gl_ledgers_v ldgr,
    fnd_id_flex_segments sgmt,
    fnd_segment_attribute_values attr
WHERE
    ldgr.ledger_id in (##$$LGRS$$##)
    AND   ldgr.chart_of_accounts_id = sgmt.id_flex_num
    AND   sgmt.id_flex_code = ''GL#''
    AND   sgmt.application_id = attr.application_id(+)
    AND   sgmt.id_flex_code = attr.id_flex_code(+)
    AND   sgmt.id_flex_num = attr.id_flex_num(+)
    AND   sgmt.application_column_name = attr.application_column_name(+)
    AND   attr.segment_attribute_type(+) != ''GL_GLOBAL''
    AND   attr.attribute_value(+) = ''Y''
ORDER BY
    chart_of_accounts_name,
    segment_num,
    segment_attribute_type',
      p_title                  => 'Chart of Accounts Segment Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Display chart of accounts segment data',
      p_solution               => '',
      p_success_msg            => 'Display chart of accounts segment data',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: GL_CHART_OF_ACCOUNTS_SEGMENTS');



debug('begin add_signature: GL_FND_ID_FLEX_STRUCTURES2');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10619',
      p_sig_id                 => 'GL_FND_ID_FLEX_STRUCTURES2',
      p_sig_sql                => 'select gl.ledger_id, flex.* from 
fnd_id_flex_structures flex, gl_ledgers gl
where flex.application_id = 101
and flex.id_flex_code = ''GL#''
and flex.id_flex_num = gl.chart_of_accounts_id
and gl.ledger_id in (##$$LGRIDS$$##)
order by 1',
      p_title                  => 'FND_ID_FLEX_STRUCTURES Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Display FND_ID_FLEX_STRUCTURES Data',
      p_solution               => '',
      p_success_msg            => 'Display FND_ID_FLEX_STRUCTURES Data',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: GL_FND_ID_FLEX_STRUCTURES2');



debug('begin add_signature: CA_DYNAMIC_INSERTS_ENABLED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10620',
      p_sig_id                 => 'CA_DYNAMIC_INSERTS_ENABLED',
      p_sig_sql                => 'select gl.ledger_id, flex.* from 
fnd_id_flex_structures flex, gl_ledgers gl
where flex.application_id = 101
and flex.id_flex_code = ''GL#''
and flex.id_flex_num = gl.chart_of_accounts_id
and gl.ledger_id in (##$$LGRIDS$$##)
and nvl(flex.dynamic_inserts_allowed_flag,''N'') = ''N''
order by 1',
      p_title                  => 'Dynamic Inserts',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Dynamic inserts is disabled for one or more related ledgers.  If Inter/Intra company, automatic offsets or any Account Derivation Rules attempt to create account combinations that do not exist yet, accounting will fail if Dynamic Inserts is not enabled.',
      p_solution               => 'Consider enabling Dynamic Inserts [162392/KB564114].',
      p_success_msg            => 'Dynamic Inserts is enabled.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: CA_DYNAMIC_INSERTS_ENABLED');



debug('begin add_signature: GL_COA_MAPPINGS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8991',
      p_sig_id                 => 'GL_COA_MAPPINGS',
      p_sig_sql                => 'Select distinct *
from 	gl_coa_mappings
where from_coa_id in (select chart_of_accounts_id from gl_ledgers where ledger_id in (##$$LGRIDS$$##))
and to_coa_id in (select chart_of_accounts_id from gl_ledgers where ledger_id in (##$$LGRS$$##))',
      p_title                  => 'GL COA Mappings',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Display GL_COA_MAPPINGS Table data',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: GL_COA_MAPPINGS');



debug('begin add_signature: GL_CONS_SEGMENT_MAP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '9026',
      p_sig_id                 => 'GL_CONS_SEGMENT_MAP',
      p_sig_sql                => 'select * from gl_cons_segment_map
where coa_mapping_id in ( Select distinct coa_mapping_id 
from gl_coa_mappings where from_coa_id in (select chart_of_accounts_id 
from gl_ledgers where ledger_id in (##$$LGRIDS$$##)) and to_coa_id in (select chart_of_accounts_id 
from gl_ledgers where ledger_id in (##$$LGRS$$##)))',
      p_title                  => 'GL_CONS_SEGMENT_MAP Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Display GL_CONS_SEGMENT_MAP Data',
      p_solution               => '',
      p_success_msg            => 'Display GL_CONS_SEGMENT_MAP Data',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: GL_CONS_SEGMENT_MAP');



debug('begin add_signature: GL_CONS_FLEXFIED_MAP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8992',
      p_sig_id                 => 'GL_CONS_FLEXFIED_MAP',
      p_sig_sql                => 'SELECT	*
FROM	gl_cons_flexfield_map
where coa_mapping_id in (
Select distinct coa_mapping_id
from 	gl_coa_mappings
where from_coa_id in (select chart_of_accounts_id from gl_ledgers where ledger_id in (##$$LGRIDS$$##))
and to_coa_id in (select chart_of_accounts_id from gl_ledgers where ledger_id in (##$$LGRS$$##)))',
      p_title                  => 'GL_CONS_FLEXFIED_MAP Data',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Display GL_CONS_FLEXFIED_MAP Data',
      p_solution               => '',
      p_success_msg            => 'Display GL_CONS_FLEXFIED_MAP Data',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: GL_CONS_FLEXFIED_MAP');



debug('begin add_signature: XLA_HISTORIC_CONTROL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8989',
      p_sig_id                 => 'XLA_HISTORIC_CONTROL',
      p_sig_sql                => 'select * from xla_historic_control',
      p_title                  => 'XLA Historic Control',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Display XLA_HISTORIC_CONTROL table data',
      p_solution               => '',
      p_success_msg            => 'Display XLA_HISTORIC_CONTROL table data',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: XLA_HISTORIC_CONTROL');
...
debug('begin add_signature: SLAM');
  ...
  add_signature(
      p_sig_repo_id            => '710',
      p_sig_id                 => 'SLAM',
      p_sig_sql                => 'select distinct gl.ledger_id, gl.name ledger_name, xam.* 
from xla_acctg_methods_fvl xam,
    gl_ledgers gl
where gl.ledger_id in (##$$LGRS$$##)
and gl.sla_accounting_method_code = xam.accounting_method_code
order by gl.name, xam.accounting_method_code',
      p_title                  => 'SubLedger Accounting Method (SLAM)',
      p_fail_condition         => '[ACCOUNTING_METHOD_TYPE_CODE] = [C]',
      p_problem_descr          => 'User-defined components have been detected.',
      p_solution               => '<ul>
<li>Verify if the user-defined change has downstream impact on any accounting issues being reported.</li>
<li>User-defined components may show incorrect behavior after the equivalent seeded components have been corrected by patcing.</li>
<li>See [1359966/KB350804] to determine if there was a bug or change implemented for your component, and correct your definitions accordingly.</li>
<li>Verify in a test instance whether using the seeded component results in the same issue to confirm the cause.</li>
<li>Log a service request if further assistance is needed.</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
...
debug('begin add_signature: AADS');
  ...
  add_signature(
      p_sig_repo_id            => '711',
      p_sig_id                 => 'AADS',
      p_sig_sql                => 'with dob as
(
    select xpr.*, obj.* from all_objects obj, xla_product_rules_fvl xpr
    where xpr.application_id = 200
    and xpr.AMB_CONTEXT_CODE = ''DEFAULT''
    and (obj.object_name LIKE ''XLA_00200_AAD_%_''
    || lpad(xpr.product_rule_hash_id,6,0)
    || ''_PKG''
    OR obj.object_name LIKE ''XLA_00200_AAD_%_''
    || lpad(xpr.product_rule_hash_id,6,0)
    || ''BC_PKG'')
    and obj.object_name like ''XLA%''
    and obj.owner = ''APPS''
    AND obj.object_type = ''PACKAGE BODY''
)
select gl.ledger_id, gl.name ledger_name, dob.*
FROM gl_ledgers gl,
  xla_acctg_method_rules_fvl xamr,
  dob
WHERE gl.ledger_id in (##$$LGRS$$##)
AND gl.sla_accounting_method_code = xamr.accounting_method_code
AND xamr.application_id = 200
AND xamr.AMB_CONTEXT_CODE = ''DEFAULT''
AND SYSDATE <= nvl(end_date_active,SYSDATE)
AND dob.product_rule_code = xamr.product_rule_code
order by gl.name, dob.product_rule_code',
      p_title                  => 'Payables Application Accounting Definition assigned to SLAM',
      p_fail_condition         => '[PRODUCT_RULE_TYPE_CODE] = [C]',
      p_problem_descr          => 'User-defined components have been detected.',
      p_solution               => '<ul>
<li>Verify if the user-defined change has downstream impact on any accounting issues being reported.</li>
<li>User-defined components may show incorrect behavior after the equivalent seeded components have been corrected by patcing.</li>
...
debug('begin add_signature: SHOW_AAD');
  ...
  add_signature(
      p_sig_repo_id            => '713',
      p_sig_id                 => 'SHOW_AAD',
      p_sig_sql                => 'select distinct xpr.* 
from xla_product_rules_fvl xpr 
where xpr.application_id = 200
and xpr.amb_context_code = ''DEFAULT''
and xpr.compile_status_code in (''N'',''E'')
and xpr.product_rule_code in (
    select xamr.product_rule_code
    from xla_acctg_method_rules_fvl xamr
    where xamr.application_id = 200
    and xamr.amb_context_code = ''DEFAULT''
...
<li>Follow the instructions provided in [1406203/KB203811] </li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
...
debug('begin add_signature: STUCK_AAD');
  ...
  add_signature(
    ...
    and     xpr.product_rule_code in (select xamr.product_rule_code
      ...
      p_solution               => '<ul>
   <li>Please run the Validate Application Accounting Definitions program</li>
   <li>Follow the instructions provided in [1325761/KB530468] </li>
   </ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
...
and xpa.amb_context_code = ''DEFAULT''
and xpa.validation_status_code in (''N'',''E'')
and xpa.product_rule_code in (
    select xamr.product_rule_code
    from xla_acctg_method_rules_fvl xamr
    where xamr.application_id = 200
    and xamr.amb_context_code = ''DEFAULT''
...
debug('begin add_signature: SHOW_EVENTCLASS_AAD');
  ...
  add_signature(
      ...
      p_sig_sql                => 'select *
from xla_prod_acct_headers_fvl 
where application_id = 200
and amb_context_code = ''DEFAULT''
and product_rule_code in (
    select xamr.product_rule_code
    from xla_acctg_method_rules_fvl xamr
    where xamr.application_id = 200
    and xamr.amb_context_code = ''DEFAULT''
...
order by product_rule_code, entity_code, event_class_code, event_type_code',
...
debug('begin add_signature: XLA_JOURNAL_LINE_DEFINITIONS_ASSIGNED_TO_THE_ACCOUNTING_DEFINITION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8974',
      p_sig_id                 => 'XLA_JOURNAL_LINE_DEFINITIONS_ASSIGNED_TO_THE_ACCOUNTING_DEFINITION',
      p_sig_sql                => 'SELECT distinct lda.*, ld.*
FROM
    xla_aad_line_defn_assgns lda,
    xla_line_definitions_b ld,
    xla_event_classes_b ec
WHERE lda.application_id = 200
AND lda.amb_context_code = ''DEFAULT''
AND lda.line_definition_code = ld.line_definition_code
AND lda.application_id = ld.application_id
AND lda.amb_context_code = ld.amb_context_code
AND lda.event_type_code = ld.event_type_code
AND lda.line_definition_owner_code = ld.line_definition_owner_code
AND ec.event_class_code = lda.event_class_code
AND ec.application_id = lda.application_id
AND lda.product_rule_code IN (
    select xamr.product_rule_code
    from xla_acctg_method_rules_fvl xamr
    where xamr.application_id = 200
    and xamr.amb_context_code = ''DEFAULT''
...
ORDER BY
    lda.product_rule_code,
    lda.event_class_code,
    lda.event_type_code',
      p_title                  => 'Journal Line Definitions Assigned to the Accounting Definition',
      p_fail_condition         => '[LINE_DEFINITION_OWNER_CODE] = [C]',
      p_problem_descr          => 'User-defined components have been detected.',
      p_solution               => '<ul>
<li>Verify if the user-defined change has downstream impact on any accounting issues being reported.</li>
<li>User-defined components may show incorrect behavior after the equivalent seeded components have been corrected by patcing.</li>
...
<li>Log a service request if further assistance is needed.</li>
   ...
   l_info.delete;
debug('end add_signature: XLA_JOURNAL_LINE_DEFINITIONS_ASSIGNED_TO_THE_ACCOUNTING_DEFINITION');



debug('begin add_signature: XLA_JOURNAL_LINE_TYPES_ASSIGNED_TO_EACH_EVENT_CLASS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8975',
      p_sig_id                 => 'XLA_JOURNAL_LINE_TYPES_ASSIGNED_TO_EACH_EVENT_CLASS',
      p_sig_sql                => 'SELECT distinct *
FROM 
    xla_acct_line_types_fvl xa,
    xla_line_defn_jlt_assgns xl
WHERE xa.application_id =200
AND xa.amb_context_code = ''DEFAULT''
AND xa.accounting_line_code = xl.accounting_line_code
AND xa.application_id = xl.application_id
AND xa.amb_context_code = xl.amb_context_code
AND xa.accounting_line_type_code = xl.accounting_line_type_code
AND xl.line_definition_code IN (
    SELECT line_definition_code
...
ORDER BY 
    xl.event_class_code,
    xl.line_definition_code,
    xl.accounting_line_code',
      p_title                  => 'Journal Line Types Assigned to Each Event Class',
      p_fail_condition         => '[ACCOUNTING_LINE_TYPE_CODE] = [C]',
      p_problem_descr          => 'User-defined components have been detected.',
      p_solution               => '<ul>
<li>Verify if the user-defined change has downstream impact on any accounting issues being reported.</li>
<li>User-defined components may show incorrect behavior after the equivalent seeded components have been corrected by patcing.</li>
...
<li>Log a service request if further assistance is needed.</li>
   ...
   l_info.delete;
debug('end add_signature: XLA_JOURNAL_LINE_TYPES_ASSIGNED_TO_EACH_EVENT_CLASS');



debug('begin add_signature: XLA_JOURNAL_LINE_TYPE_CONDITIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8976',
      p_sig_id                 => 'XLA_JOURNAL_LINE_TYPE_CONDITIONS',
      p_sig_sql                => 'SELECT distinct xjt.*, ec.*,
    xla_conditions_pkg.display_condition(
        xjt.application_id,
        ''DEFAULT'',
        entity_code,
        xjt.event_class_code,
        xjt.accounting_line_type_code,
        xjt.accounting_line_code,
        NULL,
        NULL,
        NULL,
        ''A''
...
FROM
    xla_line_defn_jlt_assgns xjt,
    xla_event_classes_b ec
WHERE xjt.application_id =200
AND xjt.amb_context_code = ''DEFAULT''
AND ec.event_class_code = xjt.event_class_code
AND ec.application_id = xjt.application_id
AND line_definition_code IN (
    SELECT line_definition_code
    FROM xla_aad_line_defn_assgns
    WHERE application_id =200
    AND amb_context_code = ''DEFAULT''
...
ORDER BY
    ec.event_class_code,
    xjt.line_definition_code,
    xjt.accounting_line_code',
      p_title                  => 'Journal Line Type Conditions',
      p_fail_condition         => '[ACCOUNTING_LINE_TYPE_CODE] = [C]',
      p_problem_descr          => 'User-defined components have been detected.',
      p_solution               => '<ul>
<li>Verify if the user-defined change has downstream impact on any accounting issues being reported.</li>
...
<li>Log a service request if further assistance is needed.</li>
   ...
   l_info.delete;
debug('end add_signature: XLA_JOURNAL_LINE_TYPE_CONDITIONS');



debug('begin add_signature: XLA_ACCOUNT_DERIVATION_RULES_ASSOCIATED_TO_THE_JOURNAL_LINE_DEFINITIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8977',
      p_sig_id                 => 'XLA_ACCOUNT_DERIVATION_RULES_ASSOCIATED_TO_THE_JOURNAL_LINE_DEFINITIONS',
      p_sig_sql                => 'SELECT distinct *
FROM xla_line_defn_adr_assgns_f_v
WHERE application_id =200
AND amb_context_code = ''DEFAULT''
AND line_definition_code IN (
    SELECT line_definition_code
...
ORDER BY 
    ...
    flexfield_segment_code',
      p_title                  => 'Account Derivation Rules Associated to the Journal Line Definitions',
      p_fail_condition         => '[LINE_DEFINITION_OWNER_CODE] = [C]',
      p_problem_descr          => 'User-defined components have been detected.',
      p_solution               => '<ul>
<li>Verify if the user-defined change has downstream impact on any accounting issues being reported.</li>
...
<li>Log a service request if further assistance is needed.</li>
   ...
   l_info.delete;
debug('end add_signature: XLA_ACCOUNT_DERIVATION_RULES_ASSOCIATED_TO_THE_JOURNAL_LINE_DEFINITIONS');



debug('begin add_signature: XLA_ACCOUNT_DERIVATION_RULE_CONDITIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8978',
      p_sig_id                 => 'XLA_ACCOUNT_DERIVATION_RULE_CONDITIONS',
      p_sig_sql                => 'with ldc as (
    SELECT /*+ MATERIALIZE */ *
    FROM xla_aad_line_defn_assgns
    WHERE application_id = 200
    AND amb_context_code = ''DEFAULT''
...
adr as (
    SELECT DISTINCT /*+ MATERIALIZE */  
        xjt.event_class_code xjt_event_class_code, xjt.event_Type_code xjt_event_type_code, xjt.line_definition_owner_code xjt_line_def_owner_code,
        xjt.line_Definition_code xjt_line_def_code, xjt.accounting_line_code xjt_accounting_line_code, xjt.accounting_line_type_code xjt_accounting_line_type_code, xc.user_sequence xc_user_sequence,
        xjt.side_code xjt_side_code, xjt.FLEXFIELD_SEGMENT_CODE xjt_flex_seg_code, xjt.FLEXFIELD_SEGMENT_NUM xjt_flex_seg_num, xjt.FLEXFIELD_SEGMENT_NAME xjt_flex_seg_name,
        xjt.inherit_adr_flag xjt_inherit_adr_Flag, xjt.SEGMENT_RULE_NAME xjt_segment_Rule_name, 
        xjt.SEGMENT_RULE_CODE xjt_segment_rule_code, xjt.creation_date xjt_creation_date, xjt.last_update_date xjt_last_update_date,
        xsr.*,
        xla_conditions_pkg.display_condition(
            xjt.application_id,
            ''DEFAULT'',
            ...
            NULL,
            NULL,
            xc.segment_rule_detail_id,
            NULL,
            NULL,
            ''S''
        ) adr_condition
    FROM
        xla_line_defn_adr_assgns_f_v xjt,
        xla_seg_rule_details xsr,
        xla_conditions xc
    WHERE xjt.application_id = 200
    AND xjt.amb_context_code = ''DEFAULT''
    AND xsr.segment_rule_code = xjt.segment_rule_code
    AND xsr.application_id = xjt.application_id
    AND xsr.amb_context_code = xjt.amb_context_code
    AND xsr.segment_rule_detail_id = xc.segment_rule_detail_id
    AND xc.application_id = xjt.application_id
)
select *
from adr,ldc
where adr.xjt_line_def_code = ldc.line_definition_code
order by
    adr.xjt_event_class_code,
    adr.xjt_line_def_code,
    adr.xjt_segment_rule_code,
    adr.user_sequence',
      p_title                  => 'Account Derivation Rule Conditions',
      p_fail_condition         => '[SEGMENT_RULE_TYPE_CODE] = [C]',
      p_problem_descr          => 'User-defined components have been detected.',
      p_solution               => '<ul>
<li>Verify if the user-defined change has downstream impact on any accounting issues being reported.</li>
<li>User-defined components may show incorrect behavior after the equivalent seeded components have been corrected by patcing.</li>
...
<li>Log a service request if further assistance is needed.</li>
   ...
   l_info.delete;
debug('end add_signature: XLA_ACCOUNT_DERIVATION_RULE_CONDITIONS');



debug('begin add_signature: XLA_ADR_SEGMENT_RULES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8987',
      p_sig_id                 => 'XLA_ADR_SEGMENT_RULES',
      p_sig_sql                => 'select distinct *
from xla_seg_rules_fvl
where application_id = 200
and amb_context_code = ''DEFAULT''
and segment_rule_code in (
    select segment_rule_code
    from xla_line_defn_adr_assgns 
    where application_id = 200
    and amb_context_code = ''DEFAULT''
    and accounting_line_code in (
...
order by segment_rule_code',
      p_title                  => 'ADR Segment Rules',
      p_fail_condition         => '[SEGMENT_RULE_TYPE_CODE] = [C]',
      p_problem_descr          => 'User-defined components have been detected.',
      p_solution               => '<ul>
<li>Verify if the user-defined change has downstream impact on any accounting issues being reported.</li>
...
<li>Log a service request if further assistance is needed.</li>
   ...
   l_info.delete;
debug('end add_signature: XLA_ADR_SEGMENT_RULES');



debug('begin add_signature: XLA_ADR_SEGMENT_RULE_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8988',
      p_sig_id                 => 'XLA_ADR_SEGMENT_RULE_DETAILS',
      p_sig_sql                => 'select distinct *
...
order by segment_rule_code, user_sequence',
      p_title                  => 'ADR Segment Rule Details',
      p_fail_condition         => '[SEGMENT_RULE_TYPE_CODE] = [C]',
      p_problem_descr          => 'User-defined components have been detected.',
      p_solution               => '<ul>
<li>Verify if the user-defined change has downstream impact on any accounting issues being reported.</li>
...
<li>Log a service request if further assistance is needed.</li>
   ...
   l_info.delete;
debug('end add_signature: XLA_ADR_SEGMENT_RULE_DETAILS');



debug('begin add_signature: XLA_MPA_ADR_SEGMENT_RULES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8985',
      p_sig_id                 => 'XLA_MPA_ADR_SEGMENT_RULES',
      p_sig_sql                => 'select distinct *
from xla_seg_rules_fvl
WHERE APPLICATION_ID = 200
and segment_rule_code in (
select segment_rule_code
from xla_mpa_jlt_adr_assgns_f_v 
where application_id = 200
and mpa_accounting_line_code in (
select accounting_line_code
from XLA_MPA_JLT_ASSGNS_F_V 
where application_id = 200
AND
    line_definition_code IN (
        SELECT
            line_definition_code
        FROM
...
',
      p_title                  => 'MPA ADR Segment Rules',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Display MPA ADR Segment Rules',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: XLA_MPA_ADR_SEGMENT_RULES');



debug('begin add_signature: XLA_MPA_JLT_ASSIGN');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8984',
      p_sig_id                 => 'XLA_MPA_JLT_ASSIGN',
      p_sig_sql                => 'select distinct *
from XLA_MPA_JLT_ASSGNS_F_V 
where application_id = 200
AND
...
',
      p_title                  => 'MPA JLT Assignments',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Display MPA JLT Assignments',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: XLA_MPA_JLT_ASSIGN');



debug('begin add_signature: XLA_MPA_SEGMENT_RULE_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8986',
      p_sig_id                 => 'XLA_MPA_SEGMENT_RULE_DETAILS',
      p_sig_sql                => 'select distinct *
from xla_seg_rule_details 
WHERE APPLICATION_ID = 200
and segment_rule_code in (
...
AND
    line_definition_code IN (
      ...
      p_title                  => 'MPA ADR Segment Rule Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Display MPA ADR Segment Rule details',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: XLA_MPA_SEGMENT_RULE_DETAILS');



debug('begin add_signature: XLA_SHOW_SOURCES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8981',
      p_sig_id                 => 'XLA_SHOW_SOURCES',
      p_sig_sql                => 'select *
from xla_sources_fvl
where application_id = 200
order by source_code',
      p_title                  => 'AP Sources (Including Custom Sources)',
      p_fail_condition         => '[SOURCE_TYPE_CODE] = [D]',
      p_problem_descr          => 'User-defined components have been detected.',
      p_solution               => '<ul>
<li>Verify if the user-defined change has downstream impact on any accounting issues being reported.</li>
<li>User-defined components may show incorrect behavior after the equivalent seeded components have been corrected by patcing.</li>
...
<li>Log a service request if further assistance is needed.</li>
   ...
   l_info.delete;
debug('end add_signature: XLA_SHOW_SOURCES');



debug('begin add_signature: XLA_SHOW_CUSTOM_SOURCE_PARAMS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8982',
      p_sig_id                 => 'XLA_SHOW_CUSTOM_SOURCE_PARAMS',
      p_sig_sql                => 'select *
from xla_source_params
where application_id = 200',
      p_title                  => 'Custom Source Parameters',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Display custom source parameters',
      p_solution               => '',
      p_success_msg            => '',
      p_print_condition        => nvl('SUCCESS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
   ...
   l_info.delete;
debug('end add_signature: XLA_SHOW_CUSTOM_SOURCE_PARAMS');



debug('begin add_signature: XLA_SOURCE_NA_PROB');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8983',
      p_sig_id                 => 'XLA_SOURCE_NA_PROB',
      p_sig_sql                => 'select *
from xla_sources_fvl
where application_id = 200
and (enabled_flag = ''N'' or visible_flag = ''N'')',
      p_title                  => 'XLA Sources that are Disabled or not Visible',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Check for sources that are not enabled or not visible.',
      p_solution               => 'A source will not be available for use in XLA setup if Enabled and Visible is not checked (missing from Source LOVs).  Do the following to enable/display the source:

1. Navigate:  AP Responsibility > Setup > Accounting Setups > Subledger Accounting Setup > Accounting Methods Builder > Sources > Sources

2. Query the source

3. Click on the Source Options tab

4. Check Enabled and Displayed to enable and display the source.
...
5. Save',
   ...
   l_info.delete;
debug('end add_signature: XLA_SOURCE_NA_PROB');



debug('begin add_signature: pclose_AP_INVOICE_DIST_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '921',
      p_sig_id                 => 'pclose_AP_INVOICE_DIST_ALL',
    ...
    WHERE aid.invoice_distribution_id = dists.invoice_distribution_id
    AND   ai.invoice_id = aid.invoice_id
    AND   ai.approval_ready_flag <> ''S''
    AND   aid.posted_flag  in (''N'' , ''S'', ''P'')',
      p_title                  => 'Unaccounted Invoices Distributions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Unaccounted invoice distribution rows exist.',
      p_solution               => '<ul>
   <li></b>1) Run the create accounting process to account these transactions and post to General Ledger. See [1313324/KB485741#aref_section25]</li></br>
    <li></b>2) Alternative - The period can still be closed by sweeping the unposted rows to the next period. See [560378/KB708263] for more information on the sweep process.</li></br>
   <li></b>3) If the transactions do not get accounted after running Create Accounting program and no relevant fixes are listed in the Error or Warning section in this analyzer, then run the MGD diagnostic [1360390/KB627723] for the transaction in question, log a new service request for assistance and upload the MGD output.</li></br>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: pclose_AP_INVOICE_DIST_ALL');



debug('begin add_signature: pclose_AP_INVOICE_DIST_ALL_E');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '922',
      p_sig_id                 => 'pclose_AP_INVOICE_DIST_ALL_E',
      p_sig_sql                => 'SELECT ai.invoice_id,
           ai.invoice_num,
           aid.invoice_distribution_id,
           aid.awt_invoice_payment_id,
    ...
    AND   ai.approval_ready_flag <> ''S''
    AND   aid.posted_flag  in (''N'' , ''S'', ''P'')',
      p_title                  => 'Unaccounted Invoices Distributions (Encumbrance)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Unaccounted invoices distribution rows (encumbrance) exist.',
      p_solution               => '<ul>
   <li></b>1) Run the create accounting process to account these transactions and post to General Ledger. See [1313324/KB485741#aref_section25]</li></br>
    <li></b>2) Alternative - The period can still be closed by sweeping the unposted rows to the next period. See [560378/KB708263] for more information on the sweep process.</li></br>
   <li></b>3) If the transactions do not get accounted after running Create Accounting program and no relevant fixes are listed in the Error or Warning section in this analyzer, then run the MGD diagnostic [1360390/KB627723] for the transaction in question, log a new service request for assistance and upload the MGD output.</li></br>
   ...
   l_info.delete;
debug('end add_signature: pclose_AP_INVOICE_DIST_ALL_E');



debug('begin add_signature: pclose_AP_self_assessed_tax_dist_all');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '923',
      p_sig_id                 => 'pclose_AP_self_assessed_tax_dist_all',
      p_sig_sql                => 'select     ai.invoice_id
                ,ai.invoice_num
      ...
      where ai.invoice_id = astd.invoice_id
        ...
        and trunc(astd.ACCOUNTING_DATE) BETWEEN nvl(to_date(''##$$SDT$$##''), trunc(astd.accounting_date))
        AND nvl(to_date(''##$$EDT$$##''), trunc(astd.accounting_date))
        and astd.org_id in (##$$ORGS$$##)',
      p_title                  => 'Unaccounted Self Assessed Tax Distributions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Unaccounted self assessed tax distribution rows exist.',
      p_solution               => '<ul>
   <li></b>1) Run the create accounting process to account these transactions and post to General Ledger. See [1313324/KB485741#aref_section25].</li></br>
    <li></b>2) Alternative - The period can still be closed by sweeping the unposted rows to the next period. See [560378/KB708263] for more information on the sweep process.</li></br>
   <li></b>3) If the transactions do not get accounted after running Create Accounting program and no relevant fixes are listed in the Error or Warning section in this analyzer, then run the MGD diagnostic [1360390/KB627723] for the transaction in question, log a new service request for assistance and upload the MGD output.</li></br>
   ...
   l_info.delete;
debug('end add_signature: pclose_AP_self_assessed_tax_dist_all');



debug('begin add_signature: pclose_AP_self_assessed_tax_dist_all_E');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '924',
      p_sig_id                 => 'pclose_AP_self_assessed_tax_dist_all_E',
      p_sig_sql                => 'select     ai.invoice_id
                ,ai.invoice_num
                ,astd.invoice_distribution_id
                    ,astd.accounting_event_id
      ...
      where ai.invoice_id = astd.invoice_id
        ...
        AND nvl(to_date(''##$$EDT$$##''), trunc(astd.accounting_date))
        and astd.org_id in (##$$ORGS$$##)',
      p_title                  => 'Unaccounted Invoices Tax Distributions (Encumbrance)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Unaccounted invoice tax distribution rows (encumbrance) exists',
      p_solution               => '<ul>
   <li></b>1) Run the create accounting process to account these transactions and post to General Ledger. See [1313324/KB485741#aref_section25].</li></br>
    <li></b>2) Alternative - The period can still be closed by sweeping the unposted rows to the next period. See [560378/KB708263] for more information on the sweep process.</li></br>
   <li></b>3) If the transactions do not get accounted after running Create Accounting program and no relevant fixes are listed in the Error or Warning section in this analyzer, then run the MGD diagnostic [1360390/KB627723] for the transaction in question, log a new service request for assistance and upload the MGD output.</li></br>
...
',
   ...
   l_info.delete;
debug('end add_signature: pclose_AP_self_assessed_tax_dist_all_E');



debug('begin add_signature: AP_INVOICE_LINES_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '925',
      p_sig_id                 => 'AP_INVOICE_LINES_ALL',
      p_sig_sql                => 'SELECT /*+ ordered, use_nl(ai, ail) */ 
ai.invoice_id,
ai.invoice_num,
ail.line_number,
ail.org_id,
...
FROM (##$$LVIEW$$##) lines,  
     ...
     ap_invoices_all ai
WHERE ail.invoice_id = lines.invoice_id
AND   ail.line_number = lines.line_number
...
AND   ai.approval_ready_flag <> ''S''
AND NOT EXISTS (
       SELECT /*+ no_unnest use_nl(aid) */ 1
       FROM ap_invoice_distributions_all aid
       WHERE aid.invoice_id = ail.invoice_id
       AND aid.invoice_line_number = ail.line_number)',
      p_title                  => 'Invoice Lines Without Distribution',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invoice Lines without distributions',
      p_solution               => '<ul>
   <li>Please validate the invoice to generate invoice distributions or enter the distribution lines manually</li>
   <li>Alternative - The period can still be closed by sweeping the transactions to the next period</li>
   <li>Please follow the instructions provided in [560378/KB708263] for more information on sweeping process</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: AP_INVOICE_LINES_ALL');



debug('begin add_signature: pclose_ap_prepay_history_all');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '926',
      p_sig_id                 => 'pclose_ap_prepay_history_all',
      p_sig_sql                => 'select     ai.invoice_id
                ,ai.invoice_num
      ...
      where ai.invoice_id = apph.invoice_id
        and trunc(apph.ACCOUNTING_DATE) BETWEEN nvl(to_date(''##$$SDT$$##''), trunc(apph.accounting_date))
        AND nvl(to_date(''##$$EDT$$##''), trunc(apph.accounting_date))
        and ai.org_id in (##$$ORGS$$##)
      ...
      p_title                  => 'Unaccounted Prepayments',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Unaccounted prepayment invoice rows exist',
      p_solution               => '<ul>
   <li></b>1) Run the create accounting process to account these transactions and post to General Ledger. See [1313324/KB485741#aref_section25]</li></br>
    <li></b>2) Alternative - The period can still be closed by sweeping the unposted rows to the next period. See [560378/KB708263] for more information on the sweep process.</li></br>
   <li></b>3) If the transactions do not get accounted after running Create Accounting program and no relevant fixes are listed in the Error or Warning section in this analyzer, then run the MGD diagnostic [1360390/KB627723] for the transaction in question, log a new service request for assistance and upload the MGD output.</li></br>
   ...
   l_info.delete;
debug('end add_signature: pclose_ap_prepay_history_all');



debug('begin add_signature: unrev_man_awt_sel');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('bug'):= '19637573';
  add_signature(
      p_sig_repo_id            => '927',
      p_sig_id                 => 'unrev_man_awt_sel',
     ...
     AND   ai.invoice_id = invs.invoice_id',
      p_title                  => 'Invoice Holds',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Witholding invoice distributions which are not reversed, but the withholding line amount is 0. These invoices will be on distribution variance hold after cancelation.',
      p_solution               => '<ul>
   <li>Apply the GDF patch following the instructions provided in [964952/KB202492]</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: unrev_man_awt_sel');



debug('begin add_signature: pclose_AP_INV_SELECTION_CRITERIA_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '928',
      p_sig_id                 => 'pclose_AP_INV_SELECTION_CRITERIA_ALL',
      p_sig_sql                => 'SELECT DISTINCT aisc.checkrun_name, 
aisc.check_date, 
aisc.period_name, 
DECODE(iprs.payment_service_request_id, NULL, 
aisc.status, 
AP_PAYMENT_UTIL_PKG.get_psr_status(iprs.payment_service_request_id, 
iprs.payment_service_request_status)) status, 
aisc.start_print_document, 
aisc.end_print_document, 
asi.org_id 
FROM ap_inv_selection_criteria_all aisc, 
iby_pay_service_requests iprs, 
ap_selected_invoices_all asi 
WHERE iprs.call_app_pay_service_req_code (+) = aisc.checkrun_name 
AND trunc(aisc.check_date) BETWEEN 
nvl(to_date(''##$$SDT$$##''), aisc.check_date) AND
nvl(to_date(''##$$EDT$$##''), aisc.check_date)
AND DECODE(iprs.payment_service_request_id, NULL, 
aisc.status, 
AP_PAYMENT_UTIL_PKG.get_psr_status(iprs.payment_service_request_id, 
iprs.payment_service_request_status)) 
NOT IN (''CONFIRMED'', ''CANCELED'', ''QUICKCHECK'', ''CANCELLED NO PAYMENTS'', ''TERMINATED'') 
AND aisc.checkrun_id = asi.checkrun_id 
AND asi.org_id in (##$$ORGS$$##)',
      p_title                  => 'Outstanding Payment Batches',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Outstanding payment transactions',
      p_solution               => '<ul>
   <li>Please confirm or cancel any open payment process requests (PPR) to close the period successfully. Any other PPR status will prevent period from closing.</li>
   <li>Source: [1375017/KB396064]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: pclose_AP_INV_SELECTION_CRITERIA_ALL');



debug('begin add_signature: pclose_AP_CHECKS_ALL');
  ...
  add_signature(
      ...
      WHERE FUTURE_PAY_DUE_DATE IS NOT NULL
        ...
        and org_id in (##$$ORGS$$##)
        AND trunc(FUTURE_PAY_DUE_DATE) BETWEEN nvl(to_date(''##$$SDT$$##''), FUTURE_PAY_DUE_DATE)
        AND nvl(to_date(''##$$EDT$$##''), FUTURE_PAY_DUE_DATE)',
      p_title                  => 'Checks Which Need To Be Matured',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Checks which need to be matured',
      p_solution               => '<ul>
   <li>Please submit the Update Matured Bills Payables Status process</li>
   <li>The future dated payments still to mature in this period would be processed</li>
   <li>Navigation: Payables Responsibility > Other > Request > Run > Update Matured Bills Payables Status</li>
   <li>Source: [1375017/KB396064]</li></ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: pclose_AP_CHECKS_ALL');



debug('begin add_signature: pclose_AP_INVOICE_PAYMENTS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '930',
      p_sig_id                 => 'pclose_AP_INVOICE_PAYMENTS_ALL',
    ...
    and trunc(aip.ACCOUNTING_DATE) BETWEEN nvl(to_date(''##$$SDT$$##''), trunc(aip.accounting_date))
    AND nvl(to_date(''##$$EDT$$##''), trunc(aip.accounting_date))
    and     aip.org_id in (##$$ORGS$$##)
    AND     ac.check_id = aip.check_id',
      p_title                  => 'Unaccounted Payments',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Unaccounted payment rows exist',
      p_solution               => '<ul>
   <li></b>1) Run the create accounting process to account these transactions and post to General Ledger. See [1313324/KB485741#aref_section25]</li></br>
    <li></b>2) Alternative - The period can still be closed by sweeping the unposted rows to the next period. See [560378/KB708263] for more information on the sweep process.</li></br>
   <li></b>3) If the transactions do not get accounted after running Create Accounting program and no relevant fixes are listed in the Error or Warning section in this analyzer, then run the MGD diagnostic [1360390/KB627723] for the transaction in question, log a new service request for assistance and upload the MGD output.</li></br>
   ...
   l_info.delete;
debug('end add_signature: pclose_AP_INVOICE_PAYMENTS_ALL');



debug('begin add_signature: pclose_AP_PAYMENT_HISTORY_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '931',
      p_sig_id                 => 'pclose_AP_PAYMENT_HISTORY_ALL',
    ...
    and trunc(aph.ACCOUNTING_DATE) BETWEEN nvl(to_date(''##$$SDT$$##''), trunc(aph.accounting_date))
    AND nvl(to_date(''##$$EDT$$##''), trunc(aph.accounting_date))
    and    aph.org_id in (##$$ORGS$$##)
    AND    ac.check_id = aph.check_id',
      p_title                  => 'Unaccounted Payment History',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Unaccounted payment history rows exist',
      p_solution               => '<ul>
   <li></b>1) Run the create accounting process to account these transactions and post to General Ledger. See [1313324/KB485741#aref_section25]</li></br>
    <li></b>2) Alternative - The period can still be closed by sweeping the unposted rows to the next period. See [560378/KB708263] for more information on the sweep process.</li></br>
   <li></b>3) If the transactions do not get accounted after running Create Accounting program and no relevant fixes are listed in the Error or Warning section in this analyzer, then run the MGD diagnostic [1360390/KB627723] for the transaction in question, log a new service request for assistance and upload the MGD output.</li></br>
   ...
   l_info.delete;
debug('end add_signature: pclose_AP_PAYMENT_HISTORY_ALL');



debug('begin add_signature: GL_PERIOD_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '932',
      p_sig_id                 => 'GL_PERIOD_CHECK',
      p_sig_sql                => 'SELECT ledger_id, period_name, start_date, closing_status
    FROM gl_period_statuses
    WHERE set_of_books_id = nvl(##$$LID$$##,set_of_books_id)
    AND   period_name = ##$$PNAME$$##
    ...
    AND   application_id in (101,200)',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Checks whether the GL period is open to avoid 95325 error in accounting',
      p_solution               => '<ul>
   <li>Please follow the instructions provided in [2998621/KB748889]</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: GL_PERIOD_CHECK');



debug('begin add_signature: PCLOSE_XLA_EVENTS_MANUAL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13456',
      p_sig_id                 => 'PCLOSE_XLA_EVENTS_MANUAL',
...
WHERE  xle.entity_id = xte.entity_id
       ...
       and trunc(xle.EVENT_DATE) BETWEEN nvl(to_date(''##$$SDT$$##''), trunc(xle.event_date))
       AND nvl(to_date(''##$$EDT$$##''), trunc(xle.event_date))
       AND xle.application_id = 200
       AND xle.event_type_code = ''MANUAL''
       ...
       AND EXISTS (SELECT 1
                   ...
                   WHERE  glr1.target_ledger_id = xlo.ledger_id
                          AND glr2.target_ledger_id in ( SELECT set_of_books_id FROM   AP_SYSTEM_PARAMETERS_ALL WHERE  org_id in (##$$ORGS$$##))
      ...
      p_title                  => 'Unaccounted Manual Events',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Manual events were entered, but never completed',
      p_solution               => '<ul>
   <li>Query the unprocessed manual events from within the application and delete them.</li>
   <li>The search form is available from Payables Responsibility go to Accounting -> SubLedger Accounting -> Accounting Events.</li>
   <li>Ensure the search option to only include events with journal entries is unchecked.</li>
   <li>See [2593628/KB264351] for more details.</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: PCLOSE_XLA_EVENTS_MANUAL');



debug('begin add_signature: pclose_XLA_EVENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '933',
      p_sig_id                 => 'pclose_XLA_EVENTS',
      p_sig_sql                => 'SELECT xte.ledger_id            LEDGER_ID,
       xte.source_id_int_1      SOURCE_ID_INT_1,
       xte.security_id_int_1    SECURITY_ID_INT_1,
       xte.entity_code          ENTITY_CODE,
...
WHERE  xle.entity_id = xte.entity_id
       ...
       AND NOT EXISTS (
        ...
        WHERE
            xte2.entity_id = xte.entity_id
            AND xte2.application_id = xte.application_id
            AND xte2.entity_code = ''THIRD_PARTY_MERGE''
    )
       AND xle.event_status_code IN (''I'',''U'')
       AND xle.process_status_code IN (''I'',''U'',''R'',''D'',''E'')
       AND xle.application_id = xlo.application_id
       ...
       AND EXISTS (SELECT 1
                   FROM   gl_ledger_relationships glr1,
                          gl_ledger_relationships glr2
                   WHERE  glr1.target_ledger_id = xlo.ledger_id
                          AND glr2.target_ledger_id in ( SELECT set_of_books_id FROM   AP_SYSTEM_PARAMETERS_ALL WHERE  org_id = (204))
                          AND glr2.source_ledger_id = glr1.source_ledger_id
                          AND glr2.application_id = glr1.application_id
                          AND (glr1.target_ledger_id = xte.ledger_id
                                OR glr1.primary_ledger_id = xte.ledger_id)
                          AND (glr1.relationship_type_code = ''SUBLEDGER''
                                OR (glr1.target_ledger_category_code = ''PRIMARY''
                                    AND glr1.relationship_type_code = ''NONE''))
                          AND glr2.application_id = 101)',
      p_title                  => 'Unaccounted Transactions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Unaccounted Transactions',
      p_solution               => '<ul>
   <li></b>1) Run the create accounting process to account these transactions and post to General Ledger. See [1313324/KB485741#aref_section25]</li></br>
    <li></b>2) Alternative - The period can still be closed by sweeping the unposted rows to the next period. See [560378/KB708263] for more information on the sweep process.</li></br>
    <li></b>3) If there are Partial Merge events listed in the Errors section under Unaccounted events, then run the ''Create Accounting for Third Party Merge'' program to process these events as per [2600280/KB200978].</li></br>
   <li></b>4) If the transactions do not get accounted after running Create Accounting program and no relevant fixes are listed in the Error or Warning section in this analyzer, then run the MGD diagnostic [1360390/KB627723] for the transaction in question, log a new service request for assistance and upload the MGD output.</li></br>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: pclose_XLA_EVENTS');



debug('begin add_signature: pclose_XLA_AE_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '934',
      p_sig_id                 => 'pclose_XLA_AE_ERRORS',
      ...
      WHERE  EXISTS (SELECT 1
             ...
             and trunc(aeh.ACCOUNTING_DATE) BETWEEN nvl(to_date(''##$$SDT$$##''), trunc(aeh.accounting_date))
             AND nvl(to_date(''##$$EDT$$##''), trunc(aeh.accounting_date))
             AND xte.application_id = 200',
      p_title                  => 'Transactions with Accounting Errors',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transactions with accounting errors',
      p_solution               => '<ul>
   <li>Please review the transaction before running the create accounting process to account these transactions and post it to General Ledger</li>
   <li>Alternative - The period can still be closed by sweeping the accounting errors to the next period</li>
   <li>Please follow the instructions provided in [560378/KB708263] for more information on sweeping process</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: pclose_XLA_AE_ERRORS');



debug('begin add_signature: pclose_XLA_AE_HEADERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '935',
      p_sig_id                 => 'pclose_XLA_AE_HEADERS',
      p_sig_sql                => 'SELECT aeh.ledger_id           LEDGER_ID,
       aeh.ae_header_id        AE_HEADER_ID,
       aeh.ACCOUNTING_DATE     ACCOUNTING_DATE,
       ...
       xle.creation_date       CREATION_DATE,
       xle.last_update_date    LAST_UPDATE_DATE ,
       gpsg.closing_status GL_CLOSING_STATUS,
       gpsp.closing_status AP_CLOSING_STATUS,
       aeh.accounting_entry_status_code            ACCOUNTING_ENTRY_STATUS_CODE,
       aeh.gl_transfer_status_code                 GL_TRANSFER_STATUS_CODE,
       aeh.application_id      APPLICATION_ID
      FROM   xla_ae_headers aeh,
             xla_events xle,
             xla.xla_transaction_entities xte,
             gl.gl_period_statuses gpsg,
             gl.gl_period_statuses gpsp
      WHERE  EXISTS (SELECT 1
                     FROM   gl_ledger_relationships glr1,
                            gl_ledger_relationships glr2
                     WHERE  aeh.ledger_id = glr2.target_ledger_id
             ...
             AND xle.event_id = aeh.event_id
             and aeh.ledger_id = gpsp.ledger_id
             and aeh.period_name = gpsp.period_name
             and gpsp.application_id = 200
             and aeh.ledger_id = gpsg.ledger_id
             and aeh.period_name = gpsg.period_name
             and gpsg.application_id = 101
             AND xle.application_id = aeh.application_id
--            and trunc(aeh.ACCOUNTING_DATE) BETWEEN nvl(to_date(''##$$SDT$$##''), trunc(aeh.accounting_date))
--            AND nvl(to_date(''##$$EDT$$##''), trunc(aeh.accounting_date))
            AND xte.application_id = 200
            AND aeh.period_name in (##$$PNAME$$##)

',
      p_title                  => 'Untransferred Accounting Headers',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Accounted transactions which are not transferred to General Ledger(GL)',
      p_solution               => '<ul>
<li>If the transactions listed are final accounted ''F'' status, then the header rows must be transferred to the GL. Otherwise, the Payables period cannot be set to Closed.</li>
<li>For the untransferred rows that have GL status = Open ''O'', see [2887915/KB201533] on running the Transfer to General Ledger process.</li>
<li>For the rows that have GL status = Closed ''C'', there is no option but to reopen the GL period in order to transfer the accounted headers. GL should never be closed before all subledgers are first set to Closed status for the same period.</li>
<li>NOTE for MPA: These headers may be generated from MultiPeriod (MPA) Accounting. To confirm, see the Ledger and Subledger Details section of the analyzer. The bottom left will display MPA setup information if MPA is detected. If MPA is detected, run the Complete Multiperiod Accounting Program to transfer the headers. Please see [1499698/KB781319].</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: pclose_XLA_AE_HEADERS');



debug('begin add_signature: SLA_ MULTIPLE_HEADERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8313',
      p_sig_id                 => 'SLA_ MULTIPLE_HEADERS',
...
and xah1.entity_id = xah.entity_id
and xah1.balance_type_code = xah.balance_type_code
...
and xe.process_status_code = ''P''
      ...
      p_title                  => 'Multiple Headers exists for same event',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Multiple Headers exists for same event, entity and ledger, one with Invalid Header (Accounting_entry_status_code = ''I'' ) and other with Final Accounted Header.',
      p_solution               => 'Please log Service Request with Support to obtain datafix.<br>
Reference: [1935201/KB756363]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: SLA_ MULTIPLE_HEADERS');



debug('begin add_signature: SLA_INCORRECT_EVENT_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8314',
      p_sig_id                 => 'SLA_INCORRECT_EVENT_STATUS',
      p_sig_sql                => 'select distinct h.*
from XLA_AE_LINES L
, XLA_AE_HEADERS H
, xla_ae_headers oh
, XLA_EVENTS E
where L.CODE_COMBINATION_ID = -1
and L.APPLICATION_ID = 200
and l.ae_header_id = h.ae_header_id
and H.APPLICATION_ID = 200
and H.PARENT_AE_HEADER_ID is not null
and H.PARENT_AE_HEADER_ID = OH.AE_HEADER_ID
and h.event_id = oh.event_id
and OH.APPLICATION_ID = 200
and OH.ACCOUNTING_ENTRY_STATUS_CODE <> ''F''
and oh.event_id = e.event_id
And E.Application_Id = 200
and e.event_status_code = ''P''',
      p_title                  => 'Incorrect Event Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'When accounting is run for Multi-Period Accounting (MPA) transactions, if the Account Derivation Rule (ADR) fails to fetch the Code Combination ID (CCID), then the ACCOUNTING_ENTRY_STATUS_CODE remains as ''I'' and events'' statuses are ''P'' / ''P''.',
      p_solution               => 'Please log Service Request with Support to obtain datafix.<br>
Reference: [1935201/KB756363]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: SLA_INCORRECT_EVENT_STATUS');



debug('begin add_signature: ap_orphan_upg_events_sel_mgd_116');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('bug'):= '17488502';
  add_signature(
      p_sig_repo_id            => '767',
      p_sig_id                 => 'ap_orphan_upg_events_sel_mgd_116',
...
distinct ai.invoice_id,
     ...
     AND   ai.invoice_id = invs.invoice_id',
      ...
      p_solution               => '<ul>
   <li>Apply the GDF patch following the instructions provided in [1333548/KB325559]</li>
   </ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: ap_orphan_upg_events_sel_mgd_116');



debug('begin add_signature: ap_dup_upg_pay_cancel');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('MGD'):= '238';
  add_signature(
      p_sig_repo_id            => '953',
      p_sig_id                 => 'ap_dup_upg_pay_cancel',
      p_sig_sql                => 'SELECT count(*),aae.source_id
              FROM   ap_accounting_events_all aae
              WHERE  aae.source_table = ''AP_CHECKS''
              AND    aae.event_type_code = ''PAYMENT CANCELLATION''
              GROUP BY source_id
              HAVING count(*) > 1',
      p_title                  => 'Duplicate Unaccounted Payment Cancelled events',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Transactions with duplicate unaccounted payment cancellation event',
      p_solution               => '<ul>
   <li>Follow the  instructions provided in [1457134/KB711849]</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: ap_dup_upg_pay_cancel');



debug('begin add_signature: orphan_events');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '954',
      p_sig_id                 => 'orphan_events',
      p_sig_sql                => 'select 
    xte.entity_code source_table, xte.source_id_int_1 source_id, xte.security_id_int_1 org_id, 
    xe.*
from 
    xla_events xe,
    xla.xla_transaction_entities xte
where 
    ...
    and xte.ledger_id in (##$$LGRS$$##)
    and xte.security_id_int_1 in (##$$ORGS$$##)
    and nvl(xte.upg_batch_id, -9999) = -9999
    and xte.entity_id = xe.entity_id
    and xe.event_type_code not in (''MANUAL'', ''REVERSAL'', ''PREPAYMENT APPLICATION ADJ'',''INVOICE_BURDEN_VALIDATED'',''INVOICE_BURDEN_CANCELLED'')
    and xe.application_id = 200
    and nvl(xe.upg_batch_id, -9999) = -9999
    and xe.event_status_code <> ''P''
    and xe.event_date between nvl(to_date(''##$$SDT$$##''), xe.event_date )
    and nvl(to_date(''##$$EDT$$##''), xe.event_date)
    and nvl(xe.budgetary_control_flag,''N'') = ''N''
    ...
    and not exists (select 1
        ...
        where apha.accounting_event_id = xe.event_id)
    and not exists (select 1
        from AP_SELF_ASSESSED_TAX_DIST_ALL asat
        where asat.accounting_event_id = xe.event_id)
order by
    xte.entity_code, xte.source_id_int_1,
    xe.event_id',
      p_title                  => 'Orphan Accounting Events',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The orphan accounting events in the XLA tables are listed here',
      p_solution               => '<ul>
   <li>These orphan records have to be deleted to sucessfully close the period</li>
   <li>Please follow the instructions provided in [788135/KB157909]</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: orphan_events');



debug('begin add_signature: orphan_bc_events');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '955',
      p_sig_id                 => 'orphan_bc_events',
      p_sig_sql                => 'select *
      from XLA_EVENTS xe, xla.xla_transaction_entities xte
     where xe.application_id = 200
       and xte.application_id = 200
       and xe.entity_id = xte.entity_id
       and xte.ledger_id in (##$$PLGRID$$##)
       AND xe.event_type_code not in (''MANUAL'',''PARTIAL_MERGE'')
       AND xe.process_status_code            != ''P''
       AND XE.EVENT_DATE BETWEEN nvl(to_date(''##$$SDT$$##''), XE.EVENT_DATE )
       AND nvl(to_date(''##$$EDT$$##''), XE.EVENT_DATE)
      ...
      p_title                  => 'Orphan Encumbrance Accounting Events',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The orphan BC accounting events are listed here',
      p_solution               => '<ul>
   <li>Please run Budgetary Control Optimizer program(Shortname = BCOPT)</li>
   <li>Any orphan BC events that prevent period close should be fixed now</li>
   <li>Reference: [1055606/KB633271]</li>
<br/>

   <li>Note Per bug {17711945}, the Optimizer program does not delete all orphan budgetary control events.  For some cases customers must run the Unaccounted Transaction Sweep program from the AP Control Payables Period Form.  If orphan budgetary control events exist after running the Optimizer to delete, verify all accounting is created for the period that can be accounted, review what is going to be swept, and then run the Unaccounted Transaction Sweep program to delete the remaining orphan budgetary control events.  If there are unaccounted events/transactions that are not orphan budgetary control events, it will sweep them, so be sure everything you want accounted in that period is accounted.</li>
</ul>
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: orphan_bc_events');



debug('begin add_signature: PARTIAL_MERGE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '956',
      p_sig_id                 => 'PARTIAL_MERGE',
      p_sig_sql                => 'select * from xla_events xe
      where xe.application_id = 200
        and xe.event_status_code = ''P''
        and xe.process_status_code = ''F''
        and xe.event_type_code = ''PARTIAL_MERGE''
        and xe.event_date between nvl(to_date(''##$$SDT$$##''), XE.EVENT_DATE )
        AND nvl(to_date(''##$$EDT$$##''), XE.EVENT_DATE)
        and exists (select 1 from
            ...
            and xah.accounting_entry_status_code = ''F''
            and xah.gl_transfer_status_code = ''N''
            and xah.period_name = ##$$PNAME$$##
            and XAH.EVENT_TYPE_CODE = ''PARTIAL_MERGE''
            )',
      p_title                  => 'Not Transferred Accounting Events - PARTIAL_MERGE',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The PARTIAL_MERGE accounting events which are not transferred to GL are listed here',
      p_solution               => '<ul>
   <li>These records should be transferred to sucessfully close the period</li>
   <li>Please raise an Service Request with Oracle but uploading this file and suggesting solution from bug 16056423</li>
   </ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: PARTIAL_MERGE');



debug('begin add_signature: pclose_AP_INVOICE_DISTRIBUTIONS_ALL_O');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '957',
      p_sig_id                 => 'pclose_AP_INVOICE_DISTRIBUTIONS_ALL_O',
      p_sig_sql                => 'SELECT aid.invoice_id,
          ai.invoice_num,
          aid.org_id,
          aid.invoice_line_number,
    ...
    WHERE nvl(aid.historical_flag, ''N'') = ''N''
     ...
     AND   ai.invoice_id = invs.invoice_id',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The Invoice distributions(both Posted/Unposted) which do not have corresponding invoice lines are listed here',
      p_solution               => '<ul>
   <li>Please follow the instructions provided in [1060644/KB627475]</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: pclose_AP_INVOICE_DISTRIBUTIONS_ALL_O');



debug('begin add_signature: AP_PAYMENT_HISTORY_ALL_O');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '958',
      p_sig_id                 => 'AP_PAYMENT_HISTORY_ALL_O',
      p_sig_sql                => 'select *
      ...
      where not exists (select 1
               ...
               where aip.accounting_event_id = aph.accounting_event_id
                 ...
                 and aip.org_id = aph.org_id)
        and transaction_type not like ''%CLEAR%''
          and transaction_type not like ''%ADJUSTED%''
          and transaction_type not like ''%MATURITY%''
          and aph.accounting_date BETWEEN nvl(to_date(''##$$SDT$$##''), aph.accounting_date )
        AND nvl(to_date(''##$$EDT$$##''), aph.accounting_date)
        and aph.org_id in (##$$ORGS$$##)',
      p_title                  => 'Orphan Checks',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The orphan checks not paying any invoice and where another check exists with the same check number and vendor information or payment document are listed here.',
      p_solution               => 'Log a Service Request and upload this analyzer report to obtain the data fix.<br>
Be sure to reference [2147940/KB784873] and also include the results from the select query inside the note.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: AP_PAYMENT_HISTORY_ALL_O');



debug('begin add_signature: pclose_AP_SELF_ASSESSED_TAX_DIST_ALL_O');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '959',
      p_sig_id                 => 'pclose_AP_SELF_ASSESSED_TAX_DIST_ALL_O',
      p_sig_sql                => 'select satd.invoice_id,
            satd.distribution_line_number,
            satd.invoice_distribution_id,
            satd.charge_applicable_to_dist_id,
            satd.invoice_line_number,
            satd.line_type_lookup_code,
            satd.accrual_posted_flag,
            satd.amount
      ...
      where not exists (select 1
        ...
        and satd.accounting_date BETWEEN nvl(to_date(''##$$SDT$$##''), satd.accounting_date )
        AND nvl(to_date(''##$$EDT$$##''), satd.accounting_date)
        and satd.org_id in (##$$ORGS$$##)',
      p_title                  => 'Orphan Self Assessed Tax',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The self assessed tax distribution lines without a corresponding parent record in the ap_invoice_distributions_all table are listed in this section',
      p_solution               => '<ul>
   <li>Please run the AP Data Validation Report for the transactions listed</li>
   <li>Please follow the instructions in [1360390/KB627723]</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: pclose_AP_SELF_ASSESSED_TAX_DIST_ALL_O');



debug('begin add_signature: pclose_out_of_sync');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '960',
      p_sig_id                 => 'pclose_out_of_sync',
      p_sig_sql                => 'SELECT DISTINCT
           aid.invoice_id,
    ...
    FROM (
          ...
          xla_ae_headers ah
    WHERE aid.accounting_event_id = xe.event_id
    AND   aid.invoice_distribution_id = dists.invoice_distribution_id
    ...
    AND   ah.accounting_entry_status_code<>''F''',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invoice distribution records where the accounting date is different from the date on the accounting event record',
      p_solution               => '<ul>
   <li>If the accounting date is in the current period, and the item is not accounted, it may cause a problem with closing</li>
   <li>Please follow the instructions provided in [874904/KB769084]</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: pclose_out_of_sync');



debug('begin add_signature: pclose_out_of_sync_pay');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '961',
      p_sig_id                 => 'pclose_out_of_sync_pay',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Payment records where the accounting date is different from the date on the accounting event record',
      p_solution               => '<ul>
   <li>If the accounting date is in the current period, and the item is not accounted, it may cause a problem with closing</li>
   <li>Please follow the instructions provided in [874904/KB769084]</li>
</ul>',
   ...
   l_info.delete;
debug('end add_signature: pclose_out_of_sync_pay');



debug('begin add_signature: pclose_out_of_sync_pay_hist');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '962',
      p_sig_id                 => 'pclose_out_of_sync_pay_hist',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Payment history (clearing) records where the accounting date is different from the date on the accounting event record',
      p_solution               => '<ul>
   <li>If the accounting date is in the current period, and the item is not accounted, it may cause a problem with closing</li>
   <li>Please follow the instructions provided in [874904/KB769084]</li>
</ul>',
   ...
   l_info.delete;
debug('end add_signature: pclose_out_of_sync_pay_hist');



debug('begin add_signature: APCA_MGD_120');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13622',
      p_sig_id                 => 'APCA_MGD_120',
   ...
   AND   ac.check_id = chks.check_id',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Missing records in XLA_DISTRIBUTION_LINKS for migrated transactions',
      p_solution               => 'Apply the GDF patch following the instructions provided in [1054299/KB202267]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: APCA_MGD_120');



debug('begin add_signature: APCA_MGD_229');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13636',
      p_sig_id                 => 'APCA_MGD_229',
      p_sig_sql                => 'SELECT  xe.event_type_code,
           xe.event_id,
           xe.entity_id,
           xe.event_status_code,
           xe.process_status_code,
   ...
   AND   xe.event_date BETWEEN
      ...
      p_title                  => 'Manual events which remain in an unprocessed status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Manual events which remain in an unprocessed status even though they have been finally accounted',
      p_solution               => 'Apply the GDF patch following the instructions provided in [1348372/KB631937]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: APCA_MGD_229');



debug('begin add_signature: pclose_ap_trx_missing_event_sel_mgd_75and119');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('bug'):= '21916712';
  add_signature(
      p_sig_repo_id            => '966',
      p_sig_id                 => 'pclose_ap_trx_missing_event_sel_mgd_75and119',
      p_sig_sql                => 'WITH invs AS (##$$MIVIEW$$##),
     chks as (##$$CVIEW$$##)
SELECT distinct ''INVOICE'' transaction_type, ai.invoice_id transaction_id,
...
ap_invoices_all ai,
  ...
  financials_system_params_all fsp
WHERE 1                          =1
and invs.invoice_id = ai.invoice_id
...
UNION ALL
SELECT distinct ''CHECK'' transaction_type, aip.check_id transaction_id,
  TO_CHAR(ac.check_number) transaction_number,
  ac.org_id,
  aip.posted_flag,
  aip.period_name,
  aip.accounting_event_id
FROM chks, ap_checks_all ac,
  ap_invoice_payments_all aip
WHERE ac.check_id              = aip.check_id
and ac.check_id = chks.check_id
AND ((aip.accounting_event_id IS NULL
...
OR EXISTS
  ...
  AND NVL(aph.posted_flag, ''N'') <> ''Y''
      ...
      p_title                  => 'Approved Invoice Distributions and / or Payments Missing ACCOUNTING_EVENT_ID',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Approved invoice distributions and / or payments missing Accounting_Event_ID',
      p_solution               => '<ul>
   <li>Apply the GDF patch following the instructions provided in [972261/KB202043]</li>
   <li>NOTE: If issue is related to INTEREST type invoices, then only follow the steps in [2847783/KB713185]</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: pclose_ap_trx_missing_event_sel_mgd_75and119');



debug('begin add_signature: APCA_MGD_76');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13604',
      p_sig_id                 => 'APCA_MGD_76',
      p_sig_sql                => 'SELECT /*+ ordered use_nl(ai, xte, xe) */
          ai.invoice_id,
          ai.invoice_num,
          ai.invoice_date,
   ...
   l_info.delete;
debug('end add_signature: APCA_MGD_76');



debug('begin add_signature: APCA_MGD_78');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13615',
      p_sig_id                 => 'APCA_MGD_78',
      p_sig_sql                => 'SELECT aid.invoice_id,
          aid.org_id,
          aid.invoice_line_number,
   ...
   AND   aid.invoice_id = invs.invoice_id',
      ...
      p_solution               => 'Apply the GDF patch following the instructions provided in [985228/KB729439]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: APCA_MGD_78');



debug('begin add_signature: APCA_MGD_79');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13611',
      p_sig_id                 => 'APCA_MGD_79',
      p_sig_sql                => 'SELECT aid.invoice_id,
          aid.org_id,
          aid.invoice_distribution_id,
          aid.invoice_line_number,
   ...
   l_info.delete;
debug('end add_signature: APCA_MGD_79');



debug('begin add_signature: pclose_ap_AcctgDateOutOfSynch_sel');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '970',
      p_sig_id                 => 'pclose_ap_AcctgDateOutOfSynch_sel',
      p_sig_sql                => 'WITH ai AS (
      SELECT /*+ ordered use_nl(ai) */ DISTINCT
            ai.invoice_id,
            ai.invoice_num,
            ai.org_id
     FROM (##$$IVIEW$$##) invs,
     ...
     AND   apph.accounting_date <> xe.event_date',
      ...
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Out of Sync Accounting dates between the Invoicing transaction tables and the Accounting Events table',
      p_solution               => '<ul>
   <li>Apply the GDF patch following the instructions provided in [874904/KB769084]</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: pclose_ap_AcctgDateOutOfSynch_sel');



debug('begin add_signature: pclose_ap_unacct_trx_closed_prd_sel');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '971',
      p_sig_id                 => 'pclose_ap_unacct_trx_closed_prd_sel',
      p_sig_sql                => 'SELECT /*+ ordered use_nl(ai, xte, xe) */
            ai.invoice_id,
            ai.invoice_num,
            ai.org_id,
     ...
     AND   ai.invoice_id = invs.invoice_id',
      p_title                  => 'Unaccounted accounting events having event dates in closed periods',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Unaccounted accounting events having event dates in closed periods',
      p_solution               => '<ul>
   <li>Apply the GDF patch following the instructions provided in [875012/KB628145]</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: pclose_ap_unacct_trx_closed_prd_sel');



debug('begin add_signature: APCA_MGD_103');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13644',
      p_sig_id                 => 'APCA_MGD_103',
      p_sig_sql                => 'SELECT ai.invoice_id,
          ai.invoice_num,
          ai.invoice_date,
          ai.org_id,
   ...
   AND   nvl(xte.source_id_int_1, -99) = ai.invoice_id',
      ...
      p_solution               => 'Apply the GDF patch following the instructions provided in [742429/KB619667]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: APCA_MGD_103');



debug('begin add_signature: ap_incorrect_posted_flag_sel_mgd_104');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '779',
      p_sig_id                 => 'ap_incorrect_posted_flag_sel_mgd_104',
     ...
     AND   ai.invoice_id = invs.invoice_id',
      ...
      p_solution               => '<ul>
   <li>Apply the GDF patch following the instructions provided in [1071876/KB207473]</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: ap_incorrect_posted_flag_sel_mgd_104');



debug('begin add_signature: pclose_xla_mulent_sel_mgd_227');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('bug'):= '21221141';
  add_signature(
      p_sig_repo_id            => '975',
      p_sig_id                 => 'pclose_xla_mulent_sel_mgd_227',
     ...
     GROUP BY ai.invoice_id, ai.invoice_num, ai.org_id,
      ...
      p_title                  => 'Invoices with multiple transaction entity records in SLA',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invoices with multiple transaction entity records in SLA',
      p_solution               => '<ul>
   <li>Apply the GDF patch following the instructions provided in [1133423/KB787666]</li>
</ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: pclose_xla_mulent_sel_mgd_227');



debug('begin add_signature: 132');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('#IMPACT_AREAS#'):= 'Period Close';
   l_info('bug_number'):= '9341402';
   l_info('category'):= 'PAYMENT';
   l_info('gdf_flag'):= 'Y';
   l_info('note_number'):= '1072017.1';
   l_info('problem'):= 'Payment history record missing for accounted checks';
   l_info('solution'):= 'Apply the GDF patch following the instructions provided in Doc ID 1072017.1';
   l_info('sub_category'):= 'ACCOUNTING';
   l_info('undo_flag'):= 'N';
  add_signature(
      p_sig_repo_id            => '3902',
      p_sig_id                 => '132',
   ...
   AND   ac.check_id = chks.check_id',
      p_title                  => 'MGD-132',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Payment history record missing for accounted checks<br/><strong>Impact Area(s): </strong>Period Close',
      p_solution               => '<strong>Solution GDF: </strong>9341402</br><strong>Note: </strong>[1072017/KB758652]</br><strong>Script Name: </strong>ap_missing_pay_hist_sel.sql</br></br>Apply the GDF patch following the instructions provided in [1072017/KB758652]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: 132');



debug('begin add_signature: 126');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('#IMPACT_AREAS#'):= 'Period Close';
   l_info('bug_number'):= '18997214';
   l_info('category'):= 'PAYMENT';
   l_info('gdf_flag'):= 'Y';
   l_info('note_number'):= '970956.1';
   l_info('problem'):= 'Invalid Payment Cascade events without corresponding invoice distributions';
   l_info('solution'):= 'Apply the GDF patch following the instructions provided in Doc ID 970956.1';
   l_info('sub_category'):= 'ACCOUNTING';
   l_info('undo_flag'):= 'N';
  add_signature(
      p_sig_repo_id            => '3822',
   ...
   AND   aph.check_id = chks.check_id',
      p_title                  => 'MGD-126',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Invalid Payment Cascade events without corresponding invoice distributions<br/><strong>Impact Area(s): </strong>Period Close',
      p_solution               => '<strong>Solution GDF: </strong>18997214</br><strong>Note: </strong>[970956/KB792143]</br><strong>Script Name: </strong>ap_orphan_pay_hist_sel.sql</br></br>Apply the GDF patch following the instructions provided in [970956/KB792143]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: 126');



debug('begin add_signature: 142');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('#IMPACT_AREAS#'):= 'Accounting Failure, Period Close';
   l_info('bug_number'):= '18997188';
   l_info('category'):= 'PAYMENT';
   l_info('gdf_flag'):= 'Y';
   l_info('note_number'):= '742429.1';
   l_info('problem'):= 'Accounting Events marked as Incomplete in the Accounting events table even though the Invoices related to the event do not contain any Non-Postable holds';
   l_info('solution'):= 'Apply the GDF patch following the instructions provided in Doc ID 742429.1';
   l_info('sub_category'):= 'ACCOUNTING';
   l_info('undo_flag'):= 'N';
  add_signature(
      p_sig_repo_id            => '3893',
   ...
   AND   ac.check_id = chks.check_id',
      p_title                  => 'MGD-142',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Accounting Events marked as Incomplete in the Accounting events table even though the Invoices related to the event do not contain any Non-Postable holds<br/><strong>Impact Area(s): </strong>Accounting Failure, Period Close',
      p_solution               => '<strong>Solution GDF: </strong>18997188</br><strong>Note: </strong>[742429/KB619667]</br><strong>Script Name: </strong>ap_inv_event_status_code_sel.sql</br></br>Apply the GDF patch following the instructions provided in [742429/KB619667]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: 142');



debug('begin add_signature: 228');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('#IMPACT_AREAS#'):= 'Accounting Failure, Period Close, Sweep';
   l_info('bug_number'):= '9651687';
   l_info('category'):= 'PAYMENT';
   l_info('gdf_flag'):= 'Y';
   l_info('note_number'):= '1133423.1';
   l_info('problem'):= 'Checks with multiple transaction entity records in SLA';
   l_info('solution'):= 'Apply the GDF patch following the instructions provided in Doc ID 1133423.1.
Note: GDF 9651687 is released for 12.0 & 12.2. GDF patch 21221141 is released for 12.1.';
   l_info('sub_category'):= 'ACCOUNTING';
   l_info('undo_flag'):= 'N';
  add_signature(
      p_sig_repo_id            => '4065',
   ...
   GROUP BY ac.check_id, ac.check_number, ac.org_id,
      ...
      p_title                  => 'MGD-228',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Checks with multiple transaction entity records in SLA<br/><strong>Impact Area(s): </strong>Accounting Failure, Period Close, Sweep',
      p_solution               => '<strong>Solution GDF: </strong>9651687</br><strong>Note: </strong>[1133423/KB787666]</br><strong>Script Name: </strong>xla_mulent_sel.sql</br></br>Apply the GDF patch following the instructions provided in [1133423/KB787666].
Note: GDF 9651687 is released for 12.0 & 12.2. GDF patch 21221141 is released for 12.1.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: 228');



debug('begin add_signature: 194');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('#IMPACT_AREAS#'):= 'Payment Data, Period Close';
   l_info('bug_number'):= '22873624';
   l_info('category'):= 'PAYMENT';
   l_info('gdf_flag'):= 'Y';
   l_info('note_number'):= '2115968.1';
   l_info('problem'):= 'Checks with no corresponding invoice payment records';
   l_info('solution'):= 'Apply the GDF patch following the instructions provided in Doc ID 2115968.1.';
   l_info('sub_category'):= 'ACCOUNTING';
   l_info('undo_flag'):= 'N';
  add_signature(
      p_sig_repo_id            => '4121',
   ...
   AND   NOT EXISTS (
           ...
           AND   ac1.payment_id is null
           AND   ac1.status_lookup_code NOT IN (''OVERFLOW'',''SET UP'',''SPOILED'')
           AND   ac1.check_id = aph1.check_id
           AND   nvl(aph1.historical_flag,''N'') != ''Y''
           ...
           AND   EXISTS (
                   ...
                   AND   ac1.org_id = ac2.org_id
                   AND   ac1.check_number = ac2.check_number
                   AND   ((ac1.vendor_id = ac2.vendor_id AND
                           ac1.vendor_site_id = ac2.vendor_site_id) OR
                          ac1.payment_document_id =ac2.payment_document_id)))',
      p_title                  => 'MGD-194',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Checks with no corresponding invoice payment records<br/><strong>Impact Area(s): </strong>Payment Data, Period Close',
      p_solution               => '<strong>Solution GDF: </strong>22873624</br><strong>Note: </strong>[2115968/KB778253]</br><strong>Script Name: </strong>ap_incorrect_checks_sel.sql Case 3</br></br>Apply the GDF patch following the instructions provided in [2115968/KB778253].',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: 194');



debug('begin add_signature: 316');
   l_info('##SHOW_SQL##'):= 'Y';
   l_info('#IMPACT_AREAS#'):= 'Accounting Failure';
   l_info('bug_number'):= '22733950';
   l_info('category'):= 'INVOICE';
   l_info('gdf_flag'):= 'Y';
   l_info('note_number'):= '2157173.1';
   l_info('problem'):= 'Orphan prepay application or unapplication events in ap_prepay_history_all which do not exist in xla_events or ap_invoice_distributions_all.';
   l_info('solution'):= 'Apply the GDF patch following the instructions provided in Doc ID 2157173.1';
   l_info('sub_category'):= 'ACCOUNTING';
   l_info('undo_flag'):= 'N';
  add_signature(
      p_sig_repo_id            => '4134',
   ...
   AND   NOT EXISTS (
      ...
      p_title                  => 'MGD-316',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Orphan prepay application or unapplication events in ap_prepay_history_all which do not exist in xla_events or ap_invoice_distributions_all.<br/><strong>Impact Area(s): </strong>Accounting Failure',
      p_solution               => '<strong>Solution GDF: </strong>22733950</br><strong>Note: </strong>[2157173/KB371288]</br><strong>Script Name: </strong>ap_orphan_prep_events_sel.sql</br></br>Apply the GDF patch following the instructions provided in [2157173/KB371288]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: 316');



debug('begin add_signature: PCA-MGD-80');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15860',
      p_sig_id                 => 'PCA-MGD-80',
...
AND xdl.source_distribution_id_num_1 = aid.invoice_distribution_id )
AND ai.invoice_id = invs.invoice_id',
      p_title                  => 'Out of Sync Amounts',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Out of sync amounts between Invoice distributions and XLA_Distribution_Links<br/><strong>Impact Area(s): </strong>Accounting Incorrect, Invoice Discard, Trial Balance',
      p_solution               => '<strong>Solution GDF: </strong>20086994</br><strong>Note: </strong>[1063263/KB627822]</br><strong>Script Name: </strong>ap_incl_excl_tax_sel.sql</br></br>Apply the GDF patch following the instructions provided in [1063263/KB627822]</br></br><strong>IMPORTANT:</strong> This fix will undo accounting.<strong>NOTE:</strong>For transactions posted in <strong>closed periods</strong> the reversing and corrected events will be accounted <strong>in the current open period.</strong><br/>For a deeper understanding of the undo accounting process please refer to [753695/KB218158]</br>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PCA-MGD-80');



debug('begin add_signature: PCA-MGD-82');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '15861',
      p_sig_id                 => 'PCA-MGD-82',
...
AND l.line_number = p.invoice_line_number)))
AND ai.invoice_id = invs.invoice_id',
      p_title                  => 'Orphan Invoice Distributions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Orphan invoice distributions with no corresponding invoice line.<br/><strong>Impact Area(s): </strong>Accounting Failure',
      p_solution               => '<strong>Solution GDF: </strong>17983453</br><strong>Note: </strong>[1060644/KB627475]</br><strong>Script Name: </strong>ap_orphan_dists_s.sql</br></br>Apply the GDF patch following the instructions provided in [1060644/KB627475]</br></br><strong>IMPORTANT:</strong> This fix will undo accounting.<br/><br/><strong>NOTE:</strong>For transactions posted in <strong>closed periods</strong> the reversing and corrected events will be accounted <strong>in the current open period.</strong><br/>For a deeper understanding of the undo accounting process please refer to [753695/KB218158]</br>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: PCA-MGD-82');



debug('begin add_signature: AP_PC_XLA_GL_NEG_LEDGER_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14817',
      p_sig_id                 => 'AP_PC_XLA_GL_NEG_LEDGER_ID',
      p_sig_sql                => 'select h.ledger_id as LEDGER_ID, h.period_name as PERIOD_NAME,gjb.name as BATCH_NAME,gjb.je_batch_id as BATCH_ID,
...
and    h.ledger_id = -1 * ##$$LID$$##            
and    h.je_header_id = l.je_header_id
and    l.ledger_id = h.ledger_id 
and    UPPER(h.je_source) = ''PAYABLES''
and    h.period_name in (select distinct period_name 
                         from   gl_period_statuses
                         where  application_id = 101
                         and    start_date >= to_date(''##$$SDT$$##'')
                         and    end_date <= to_date(''##$$EDT$$##'')
                         and    ledger_id = ##$$LID$$##)
group by h.ledger_id, h.period_name, gjb.name, gjb.je_batch_id,
...
order by gjb.name,gjb.je_batch_id,gjb.group_id,ccid',
      ...
      p_solution               => '<ul><li>The analyzer has identified data corruption described in [883557/KB627857], see section: Corruption Type 1.</li>
...
',
   ...
   l_info.delete;
debug('end add_signature: AP_PC_XLA_GL_NEG_LEDGER_ID');



debug('begin add_signature: AP_PC_XLA_GL_NULL_GL_SL_LINK_ID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14819',
      p_sig_id                 => 'AP_PC_XLA_GL_NULL_GL_SL_LINK_ID',
...
and    h.ledger_id = ##$$LID$$## 
and    h.accounting_date between to_date(''##$$SDT$$##'') 
       and to_date(''##$$EDT$$##'')
...
and    l.gl_sl_link_id is null',
      ...
      p_solution               => '<ul><li>The analyzer has identified data corruption described in [883557/KB627857], see section: Corruption Type 7.</li>
<li>Please log a Service Request and upload this analyzer output.</li>
</ul>
',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: AP_PC_XLA_GL_NULL_GL_SL_LINK_ID');



debug('begin add_signature: AP_PC_XLA_GL_XFR_IN_XLA_NOT_IN_GL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14820',
      p_sig_id                 => 'AP_PC_XLA_GL_XFR_IN_XLA_NOT_IN_GL',
...
AND NOT EXISTS (SELECT 1 
                FROM   gl_import_references ir, 
                       gl_je_headers gh 
                WHERE  gh.period_name = ##$$PNAME$$##
                AND    gh.ledger_id = ##$$LID$$##
...
order by h.period_name,h.group_id, ccid',
      ...
      p_solution               => '<ul><li>The analyzer has identified data corruption described in [883557/KB627857], see section: Corruption Type 2.</li>
<li>Please log a Service Request and upload this analyzer output.</li>
</ul>
',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: AP_PC_XLA_GL_XFR_IN_XLA_NOT_IN_GL');



debug('begin add_signature: AP_PC_XLA_GL_XFR_IN_XLA_REV_IN_GL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14821',
      p_sig_id                 => 'AP_PC_XLA_GL_XFR_IN_XLA_REV_IN_GL',
...
order by h.period_name,h.group_id, ccid',
      ...
      p_solution               => '<ul><li>The analyzer has identified data corruption described in [883557/KB627857], Corruption Type 2.</li>
<li>Please log a Service Request and upload this analyzer output.</li>
</ul>
',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: AP_PC_XLA_GL_XFR_IN_XLA_REV_IN_GL');



debug('begin add_signature: AP_PC_XLA_GL_EXISTS_IN_GL_NOT_IN_XLA');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14815',
      p_sig_id                 => 'AP_PC_XLA_GL_EXISTS_IN_GL_NOT_IN_XLA',
...
and     UPPER(gh.je_source) = ''PAYABLES''
and     gh.ledger_id = ##$$LID$$## 
and     nvl(gh.accrual_rev_je_header_id,0) = 0 
...
order by gh.period_name, gjb.name, gjb.group_id, ccid',
      ...
      p_solution               => '<ul><li>The analyzer has identified data corruption described in [883557/KB627857], see section: Corruption Type 5.</li>
<li>Please log a Service Request and upload this analyzer output.</li>
</ul>
',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: AP_PC_XLA_GL_EXISTS_IN_GL_NOT_IN_XLA');



debug('begin add_signature: AP_PC_XLA_GL_NOT_XFR_IN_XLA_BUT_IN_GL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14818',
      p_sig_id                 => 'AP_PC_XLA_GL_NOT_XFR_IN_XLA_BUT_IN_GL',
      p_sig_sql                => 'SELECT  /*+ parallel (h,l) leading (h) */
        gh.period_name,gjb.name, 
        gjb.group_id,
...
order by gh.period_name, gjb.name, gjb.group_id, ccid',
      ...
      p_solution               => '<ul><li>The analyzer has identified data corruption described in [883557/KB627857], see section: Corruption Type 3.</li>
<li>Please log a Service Request and upload this analyzer output.</li>
</ul>
',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: AP_PC_XLA_GL_NOT_XFR_IN_XLA_BUT_IN_GL');



debug('begin add_signature: AP_PC_XLA_GL_MULTIPLE_POST_IN_GL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '14816',
      p_sig_id                 => 'AP_PC_XLA_GL_MULTIPLE_POST_IN_GL',
       ...
       (select gir.gl_sl_link_id, 
        ...
        and    exists
             (select /*+ parallel(xah,xal) leading(xah) */  ''found_dup''
              ...
              and      xah.ae_header_id = xal.ae_header_id   
              and      xah.ledger_id = ##$$LID$$##
              and      xah.application_id = 200
              and      xah.accounting_entry_status_code = ''F''   
              and      xah.accounting_date between to_date(''##$$SDT$$##'') 
                                           and to_date(''##$$EDT$$##'')
              and      nvl(xah.upg_batch_id, -9999) = -9999
...
and     UPPER(gjh.je_source) = ''PAYABLES''',
      p_title                  => 'Posted Multiple Times in GL',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Found record(s) which are posted multiple times in GL.',
      p_solution               => '<ul><li>The analyzer has identified data corruption described in [883557/KB627857], see section: Corruption Type 4.</li>
<li>Please log a Service Request and upload this analyzer output.</li>
</ul>
',
      p_success_msg            => '',
   ...
   l_info.delete;
debug('end add_signature: AP_PC_XLA_GL_MULTIPLE_POST_IN_GL');



debug('begin add_signature: EBS_FIN_AP_GL_INTERFACE_PROCESSED_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26429',
      p_sig_id                 => 'EBS_FIN_AP_GL_INTERFACE_PROCESSED_STATUS',
      p_sig_sql                => 'select distinct ledger_id "Ledger ID",
...
from gl_interface
where ledger_id = (##$$LGRIDS$$##)
and status = ''PROCESSED''
and user_je_source_name = ''Payables''
group by ledger_id , date_created ,   group_id ,  user_je_source_name ,  user_je_category_name,  je_batch_id ,  period_name 
order by "Number of Rows" desc',
      p_title                  => 'GL_INTERFACE Contains Processed Status Rows',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'GL_INTERFACE Rows with Status PROCESSED Remain in the Table.',
      p_solution               => '<ul><li>GL_INTERFACE table has some rows with status Processed.</li><li>Please review the [262861/KB774086] to resolve this issue.</li></ul>',
      p_success_msg            => 'No Issue found. GL_INTERFACE table doesn''t have any rows with status Processed.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_GL_INTERFACE_PROCESSED_STATUS');
...
debug('begin add_signature: EBS_FIN_AP_AC_PATCHES_APPLIED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27641',
      p_sig_id                 => 'EBS_FIN_AP_AC_PATCHES_APPLIED',
...
ad_bugs adb
where UPPER(ab.application_short_name) in (select distinct fa.application_short_name from fnd_application fa where fa.application_id in (##$$APPS_PARAM1$$##,##$$APPS_PARAM2$$##,##$$APPS_PARAM3$$##,##$$APPS_PARAM4$$##,##$$APPS_PARAM5$$##,##$$APPS_PARAM6$$##))
...
<p>There may be duplicate patches and this is due to the start and end dates of when the patch driver was applied. This is expected behavior.</p>',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AP_AC_PATCHES_APPLIED');



debug('begin add_signature: CA_ACCOUNTING_PROGRAM_RUN_HISTORY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8655',
      p_sig_id                 => 'CA_ACCOUNTING_PROGRAM_RUN_HISTORY',
      p_sig_sql                => 'SELECT DISTINCT
    fcr.request_id,
    ...
    fcpp.argument1 REPORT_TEMPLATE_APPLICATION,
    fcpp.argument2 REPORT_TEMPLATE_CODE
FROM
...
WHERE
    ...
    AND   rsp.responsibility_id (+) = fcr.responsibility_id
    AND   fcpp.concurrent_request_id (+) = fcr.request_id
    AND   fcp.concurrent_program_name IN (
        ''XLAACCPB'',''XLAACCUP'',''XLAGLTRN'',''XLABABUP'',''XLABAPUB'',
        ''APXTRSWP'',''APXUATR_XMLP'',''APXPCER_XMLP'',
        ''GLLEZL'',''GLPPOSS''
    )
    AND   trunc(fcr.request_date) > SYSDATE - 90
ORDER BY
    request_id DESC',
      p_title                  => 'Accounting Program Run History (90 days)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => '90 day run history for accounting related programs',
      p_solution               => '',
      p_success_msg            => '90 day run history for accounting related programs',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CA_ACCOUNTING_PROGRAM_RUN_HISTORY');



debug('begin add_signature: CA_DISABLE_JOURNAL_IMPORT');
   l_info('##MASK##USER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8672',
      p_sig_id                 => 'CA_DISABLE_JOURNAL_IMPORT',
      p_sig_sql                => 'select distinct v.user_profile_option_name,
r.responsibility_name,
fndu.user_name,
v.profile_option_name,
o.profile_option_value,
u.name, R.RESPONSIBILITY_KEY, o.level_id
from fnd_profile_options_vl v,
fnd_profile_option_values o,
fnd_responsibility_vl r,
fnd_application fnda,
fnd_user fndu,
hr_operating_units u
where v.profile_option_ID = o.profile_option_id
and fnda.application_id(+) = o.level_value
and fndu.user_id(+) = o.level_value
and v.user_profile_option_name = ''SLA: Disable Journal Import''
and r.responsibility_id(+) = o.level_value
and user_profile_option_name like ''SLA:%''
and profile_option_value = ''Y''
and to_char(u.organization_id(+)) = o.profile_option_value
and (decode(level_id, 10003, r.responsibility_id) = r.responsibility_id
or decode(level_id, 10002, fnda.application_id) = 200
or decode(level_id, 10004, fndu.user_id) = fndu.user_id
or decode(level_id, 10001, 1) =1)',
      p_title                  => 'SLA: Disable Journal Import set to Yes',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'SLA: Disable Journal Import is set to Yes

',
      p_solution               => 'This setting for the profile option indicates that the transferring of data from Subledgers will take place in the same manner as it happens in Release 11i. However changing the value of the Profile option to Yes is strictly not suppported and should NEVER be used as this may lead to issues related to the linking between SLA and GL journals. 

The SLA: Disable Journal Import profile option is hidden and disabled in the latest code.  For further information please refer to [459383/KB562764]',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: CA_DISABLE_JOURNAL_IMPORT');



debug('begin add_signature: CA_REPORT_PARAMETERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8669',
      p_sig_id                 => 'CA_REPORT_PARAMETERS',
      p_sig_sql                => 'SELECT
    fcp.application_id,
    fcp.concurrent_program_name,
    fcp.user_concurrent_program_name,
    fcp.description,
    fcp.multi_org_category,
    fcp.enabled_flag program_enabled_flag,
    fcp.srs_flag,
    fe.executable_name,
    fe.user_executable_name,
    fcp.execution_options,
    fcp.output_file_type,
    fcp.template_appl_short_name,
    fcp.template_code,
    fdf.column_seq_num parameter_seq_num,
...
FROM
    ...
    fnd_descr_flex_col_usage_vl fdf,
...
WHERE
    ...
    AND fcp.application_id = fdf.application_id
    AND (''$SRS$.'' || fcp.concurrent_program_name) = fdf.descriptive_flexfield_name
    AND fdf.flex_value_set_id = ffvs.flex_value_set_id
ORDER BY
    concurrent_program_name,
    column_seq_num',
      p_title                  => 'Accounting Program Report parameters',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Accounting Program Report Parameters',
      p_solution               => '',
      p_success_msg            => 'Accounting Program Report Parameters',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: CA_REPORT_PARAMETERS');



debug('begin add_signature: CA_SINGLE_MULTI_MODE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8670',
      p_sig_id                 => 'CA_SINGLE_MULTI_MODE',
      p_sig_sql                => 'SELECT
    fcp.application_id,
    fcp.concurrent_program_name,
    fcp.user_concurrent_program_name,
...
WHERE
    fcp.concurrent_program_name IN (
        ''XLAACCPB'',''XLAACCUP'',''XLAGLTRN'',''XLABABUP'',''GLLEZL''
    )
    AND fcp.executable_application_id = fe.application_id
    AND fcp.executable_id = fe.executable_id
    AND fcp.multi_org_category = ''S''
ORDER BY
    concurrent_program_name',
      p_title                  => 'Accounting Program Single Mode',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'One or more of the accounting programs is setup to run for single OU.',
      p_solution               => 'Switch to Multiple Orgs if you want to create and transfer accounting for all orgs at one time.  See [2266685/KB767167] for more details',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: CA_SINGLE_MULTI_MODE');



debug('begin add_signature: CA_SLA_SETUP_USER_MODE');
   l_info('##MASK##USER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '8673',
      p_sig_id                 => 'CA_SLA_SETUP_USER_MODE',
      p_sig_sql                => 'select distinct v.user_profile_option_name,
r.responsibility_name,
fndu.user_name,
v.profile_option_name,
...
and fnda.application_id(+) = o.level_value
and fndu.user_id(+) = o.level_value
and v.user_profile_option_name = ''SLA: Setup User Mode (INTERNAL use only, do not ship)''
and r.responsibility_id(+) = o.level_value
and user_profile_option_name like ''SLA:%''
and profile_option_value = ''I''
and to_char(u.organization_id(+)) = o.profile_option_value
and (decode(level_id, 10003, r.responsibility_id) = r.responsibility_id
or decode(level_id, 10002, fnda.application_id) = 200
or decode(level_id, 10004, fndu.user_id) = fndu.user_id
or decode(level_id, 10001, 1) =1)',
      p_title                  => 'SLA: Setup User Mode set to Internal',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'When the profile ''SLA: Setup user mode'' is set to Internal, the application will allow updates to the seeded accounting setup which is not supported.',
      p_solution               => 'Set the profile option ''SLA: Setup user mode'' to Customer at the site level by logging in as System Administrator > Profile > System, Query up the profile option and choose Customer.

Review [454132/KB398335] for more details on this profile option.',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: CA_SLA_SETUP_USER_MODE');



debug('begin add_signature: PC_SWEEP_SINGLE_MODE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10265',
      p_sig_id                 => 'PC_SWEEP_SINGLE_MODE',
      p_sig_sql                => 'SELECT FCP.*,
 fe.executable_name,
...
and ''$SRS$.''||fcp.concurrent_program_name = fdf.descriptive_flexfield_name
--and fcptl.user_concurrent_program_name like (''Unaccounted%(XML)%'')
and fcptl.concurrent_program_id = fcp.concurrent_program_id
AND fcp.concurrent_program_name IN (''APXTRSWP'',''APXUATR_XMLP'',''APXPCER_XMLP'')
and multi_org_category = ''S''
 --and fcp.concurrent_program_name in (''APXPOPMT'', ''APXPOINV'')
 --and ffvs.flex_value_set_name in (''XLA_SRS_ACCOUNTING_FLEXFIELD'', ''XLA_SRS_TB_ACCT_FLEXFIELD'')
AND ffvs.flex_value_set_id = fdf.flex_value_set_id(+)
ORDER BY 1',
      p_title                  => 'Unaccounted Transactin Sweep Program set to Single Mode',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The Unaccounted Transactions Report concurrent program Operating Unit was set as "Single".
',
      p_solution               => 'Verify MO security profile attached to "Payables Manager" has access to all the organizations.
Please set Operating Unit in System Administration responsibility for Unaccounted Transactions Report concurrent program,  to "Multiple", not "Single".

Path:
System Administration/Concurrent/Programs/query for APXUATR_XMLP and Update.
Under tab "Request" you have: "Operating Unit Mode"
See [1122493/KB751096] for more details',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: PC_SWEEP_SINGLE_MODE');



debug('begin add_signature: PC_INITIALIZATION_SQL_PROFILE_CHECK');
   l_info('##MASK##USER_NAME'):= 'DISPLAY_BOTH_25_PCNT_WORD';
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10267',
      p_sig_id                 => 'PC_INITIALIZATION_SQL_PROFILE_CHECK',
      p_sig_sql                => 'select distinct v.user_profile_option_name,
r.responsibility_name,
fndu.user_name,
v.profile_option_name,
...
and fndu.user_id(+) = o.level_value
and r.responsibility_id(+) = o.level_value
and profile_option_name like ''FND_INIT_SQL''
and lower(profile_option_value) like ''%mo_global.init(''''s''''%''
and to_char(u.organization_id(+)) = o.profile_option_value
and (decode(level_id, 10003, r.responsibility_id) = r.responsibility_id
or decode(level_id, 10002, fnda.application_id) = 200
or decode(level_id, 10004, fndu.user_id) = fndu.user_id
or decode(level_id, 10001, 1) =1)',
      p_title                  => 'Initialization SQL Statement - Custom Profile Setup Check',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The profile option "Initialization SQL Statement - Custom", is set to "begin mo_global.init(''S'',null); end;"
This signifies the multi-org (MO) access of the customer was set to "S" (single), which overrides the MO settings that should allow the customer access across multiple organizations.',
      p_solution               => 'Per [1247735/KB727430], assign the profile option "Initialization SQL Statement - Custom" to value "begin null; end;" at the User level. See [1247735/KB727430] for more details.

[135389/KB353455] - Using profile option ''Initialization SQL Statement - Custom''
can also be reviewed to see how the profile value can be overridden at the Responsibility level when multiple org accesses is needed for operations such as Period Close, Sweep etc.


',
      p_success_msg            => 'If the profile option "Initialization SQL Statement - Custom", is set to "begin mo_global.init(''S'',null); end;",
this signifies the multi-org (MO) access of the customer was set to "S" (single), which overrides the MO settings that should allow the customer access across multiple organizations.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: PC_INITIALIZATION_SQL_PROFILE_CHECK');



debug('begin add_signature: PCLOSE_IGI_PKG_SWEEP_ERROR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10268',
      p_sig_id                 => 'PCLOSE_IGI_PKG_SWEEP_ERROR',
      p_sig_sql                => 'select ds.*, ''Fix missing for Sweep Bug 21833391'' problem
from dba_source ds
where line = 2 
and name = ''IGI_EXP_HOLDS''
and NOT exists (
SELECT *
FROM AD_FILE_VERSIONS ADF, AD_FILES AD
WHERE AD.FILE_ID = ADF.FILE_ID
AND FILENAME IN (''igiexprb.pls'')
and version_segment1 = 120
and version_segment2 = 16
and version_segment3 = 12010000
and version_segment4 >= 4)
and NOT exists (
SELECT 1
FROM AD_FILE_VERSIONS ADF, AD_FILES AD
WHERE AD.FILE_ID = ADF.FILE_ID
...
and version_segment1 = 120
and version_segment2 = 16
and version_segment3 = 12020000
and version_segment4 >= 4
)',
      p_title                  => 'Check for IGI Package Version that causes the Sweep program to Error',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The BEFOREREPORTTRIGGER on ap_invoice_lines fails due to the MOAC errors in the package IGI_EXP_HOLDS
(igiexprb.pls) in the derivation of encumbrance flag from financial system parameters',
      p_solution               => 'Apply patch 21833391:R12.IGI.B/21833391:R12.IGI.C to get fixed version of IGI_EXP_HOLDS (igiexprb.pls)
See bug {21833391} for more details.  ',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: PCLOSE_IGI_PKG_SWEEP_ERROR');



debug('begin add_signature: PCLOSE_CUSTOM_TRIGGERS_CAUSE_SWEEP_ERROR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10269',
      p_sig_id                 => 'PCLOSE_CUSTOM_TRIGGERS_CAUSE_SWEEP_ERROR',
      p_sig_sql                => 'select *
from dba_triggers
where table_name in (''AP_INVOICES_LINES_ALL'',
...
''XLA_AE_HEADERS'',
''XLA_AE_LINES'')
and (trigger_name not like ''AP%''
and trigger_name not like ''JAI%''
and trigger_name not like ''ALR%''
and trigger_name not like ''IGI%''
)',
      p_title                  => 'Check for Customer Triggers that may cause the Sweep program to fail',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Customer triggers on AP and XLA tables may cause the Sweep program and other accounting programs to error.',
      p_solution               => 'Confirm trigger is custom.
Disable/modify(fix) the applicable customer triggers.***
See bug {27481237} for more details.  

***Make sure you know the purpose of the custom trigger before disabling',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
   ...
   l_info.delete;
debug('end add_signature: PCLOSE_CUSTOM_TRIGGERS_CAUSE_SWEEP_ERROR');



debug('begin add_signature: PCLOSE_SHOW_ACCOUNTING_ERRORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '10270',
      p_sig_id                 => 'PCLOSE_SHOW_ACCOUNTING_ERRORS',
      p_sig_sql                => 'select *
from xla_accounting_errors xae,
xla_events xe
where xe.event_id = xae.event_id
and xe.application_id = 200
and xae.application_id = 200
and xae.entity_id  = xe.entity_id
and xe.event_status_code not in (''N'',''P'')
AND trunc(XE.EVENT_DATE) BETWEEN nvl(to_date(''##$$SDT$$##''), XE.EVENT_DATE )
AND nvl(to_date(''##$$EDT$$##''), XE.EVENT_DATE)
and xae.ledger_id in (##$$LGRIDS$$##)',
      p_title                  => 'Show Accounting Errors for Unaccounted Events',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'This section shows all accounting errors that exist for the Unaccounted events.',
      p_solution               => 'Review the error message details for each transaction and follow the instructions to resolve errors.
If instructions do not resolve or do not provide enough detail to resolve, run the Create Accounting Analyzer from
[1553507/KB187747] and resolve any issues detected.
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: PCLOSE_SHOW_ACCOUNTING_ERRORS');
...
BEGIN
  ...
  analyzer_title := 'Payables Period Close Analyzer';
  ...
  l_step := '15';
   validate_parameters(
    ...
    ,p_master_gdf                   => trim(upper(p_master_gdf))
...
start_section('Proactive and Preventative Recommendations', 'Proactive_and_Preventative_Recommendations');
   IF (substr(g_rep_info('Apps Version'),1,4) = '12.1') THEN
      set_item_result(check_rec_patches_1); /* Signature AP_RPC_PATCHES */
   END IF;
   IF ((substr(g_rep_info('Apps Version'),1,4) = '12.0') OR 
    (substr(g_rep_info('Apps Version'),1,4) = '12.1')) THEN
      set_item_result(check_rec_patches_2); /* Signature pclose_check_rec_patches */
   END IF;
   set_item_result(run_stored_sig('EBS_FIN_AP_INV_SEQUENCES'));
end_section;
debug('end section: Proactive_and_Preventative_Recommendations');

debug('begin section: Ledger_and_Subledger_Details');
start_section('Ledger and Subledger Details', 'Ledger_and_Subledger_Details');
   set_item_result(run_stored_sig('GL_LEDGERS'));
   set_item_result(run_stored_sig('GL_PERIOD_STATUSES2'));
   set_item_result(run_stored_sig('CAA_GL_LEDGER_RELATIONSHIPS'));
   set_item_result(run_stored_sig('APLIST_50_XLA_LEDGER_OPTIONS'));
   set_item_result(run_stored_sig('APLIST_60_XLA_LAUNCH_OPTIONS'));
   set_item_result(run_stored_sig('AP_SYSTEM_PARAMETERS_ALL'));
   set_item_result(run_stored_sig('pclose_HR_ORGANIZATION_UNITS'));
   set_item_result(run_stored_sig('GL_CHART_OF_ACCOUNTS_SEGMENTS'));
   set_item_result(run_stored_sig('GL_FND_ID_FLEX_STRUCTURES2'));
   set_item_result(run_stored_sig('CA_DYNAMIC_INSERTS_ENABLED'));
   set_item_result(run_stored_sig('GL_COA_MAPPINGS'));
   set_item_result(run_stored_sig('GL_CONS_SEGMENT_MAP'));
   set_item_result(run_stored_sig('GL_CONS_FLEXFIED_MAP'));
   set_item_result(run_stored_sig('XLA_HISTORIC_CONTROL'));
   ...
   set_item_result(run_stored_sig('XLA_JOURNAL_LINE_DEFINITIONS_ASSIGNED_TO_THE_ACCOUNTING_DEFINITION'));
   set_item_result(run_stored_sig('XLA_JOURNAL_LINE_TYPES_ASSIGNED_TO_EACH_EVENT_CLASS'));
   set_item_result(run_stored_sig('XLA_JOURNAL_LINE_TYPE_CONDITIONS'));
   set_item_result(run_stored_sig('XLA_ACCOUNT_DERIVATION_RULES_ASSOCIATED_TO_THE_JOURNAL_LINE_DEFINITIONS'));
   set_item_result(run_stored_sig('XLA_ACCOUNT_DERIVATION_RULE_CONDITIONS'));
   set_item_result(run_stored_sig('XLA_ADR_SEGMENT_RULES'));
   set_item_result(run_stored_sig('XLA_ADR_SEGMENT_RULE_DETAILS'));
   set_item_result(run_stored_sig('XLA_MPA_ADR_SEGMENT_RULES'));
   set_item_result(run_stored_sig('XLA_MPA_JLT_ASSIGN'));
   set_item_result(run_stored_sig('XLA_MPA_SEGMENT_RULE_DETAILS'));
   set_item_result(run_stored_sig('XLA_SHOW_SOURCES'));
   set_item_result(run_stored_sig('XLA_SHOW_CUSTOM_SOURCE_PARAMS'));
   set_item_result(run_stored_sig('XLA_SOURCE_NA_PROB'));
end_section;
debug('end section: Ledger_and_Subledger_Details');

debug('begin section: Invoices');
start_section('Invoices', 'Invoices');
   set_item_result(run_stored_sig('pclose_AP_INVOICE_DIST_ALL'));
   set_item_result(run_stored_sig('pclose_AP_INVOICE_DIST_ALL_E'));
   set_item_result(run_stored_sig('pclose_AP_self_assessed_tax_dist_all'));
   set_item_result(run_stored_sig('pclose_AP_self_assessed_tax_dist_all_E'));
   set_item_result(run_stored_sig('AP_INVOICE_LINES_ALL'));
   set_item_result(run_stored_sig('pclose_ap_prepay_history_all'));
   set_item_result(run_stored_sig('unrev_man_awt_sel'));
end_section;
debug('end section: Invoices');

debug('begin section: Payments');
start_section('Payments', 'Payments');
   set_item_result(run_stored_sig('pclose_AP_INV_SELECTION_CRITERIA_ALL'));
   set_item_result(run_stored_sig('pclose_AP_CHECKS_ALL'));
   set_item_result(run_stored_sig('pclose_AP_INVOICE_PAYMENTS_ALL'));
   set_item_result(run_stored_sig('pclose_AP_PAYMENT_HISTORY_ALL'));
end_section;
debug('end section: Payments');

debug('begin section: Accounting');
start_section('Accounting', 'Accounting');
   set_item_result(run_stored_sig('GL_PERIOD_CHECK'));
   set_item_result(run_stored_sig('PCLOSE_XLA_EVENTS_MANUAL'));
   set_item_result(run_stored_sig('pclose_XLA_EVENTS'));
   set_item_result(run_stored_sig('pclose_XLA_AE_ERRORS'));
   set_item_result(run_stored_sig('pclose_XLA_AE_HEADERS'));
   set_item_result(run_stored_sig('SLA_ MULTIPLE_HEADERS'));
   set_item_result(run_stored_sig('SLA_INCORRECT_EVENT_STATUS'));
end_section;
debug('end section: Accounting');

debug('begin section: Data_Integrity_Issues');
start_section('Data Integrity Issues', 'Data_Integrity_Issues');
   set_item_result(run_stored_sig('ap_orphan_upg_events_sel_mgd_116'));
   set_item_result(run_stored_sig('ap_dup_upg_pay_cancel'));
   set_item_result(run_stored_sig('orphan_events'));
   set_item_result(run_stored_sig('orphan_bc_events'));
   set_item_result(run_stored_sig('PARTIAL_MERGE'));
   set_item_result(run_stored_sig('pclose_AP_INVOICE_DISTRIBUTIONS_ALL_O'));
   set_item_result(run_stored_sig('AP_PAYMENT_HISTORY_ALL_O'));
   set_item_result(run_stored_sig('pclose_AP_SELF_ASSESSED_TAX_DIST_ALL_O'));
   set_item_result(run_stored_sig('pclose_out_of_sync'));
   set_item_result(run_stored_sig('pclose_out_of_sync_pay'));
   set_item_result(run_stored_sig('pclose_out_of_sync_pay_hist'));
   set_item_result(run_stored_sig('APCA_MGD_120'));
   set_item_result(run_stored_sig('APCA_MGD_229'));
   set_item_result(run_stored_sig('pclose_ap_trx_missing_event_sel_mgd_75and119'));
   set_item_result(run_stored_sig('APCA_MGD_76'));
   set_item_result(run_stored_sig('APCA_MGD_78'));
   set_item_result(run_stored_sig('APCA_MGD_79'));
   set_item_result(run_stored_sig('pclose_ap_AcctgDateOutOfSynch_sel'));
   set_item_result(run_stored_sig('pclose_ap_unacct_trx_closed_prd_sel'));
   set_item_result(run_stored_sig('APCA_MGD_103'));
   set_item_result(run_stored_sig('ap_incorrect_posted_flag_sel_mgd_104'));
   set_item_result(run_stored_sig('pclose_xla_mulent_sel_mgd_227'));
   set_item_result(run_stored_sig('132'));
   set_item_result(run_stored_sig('126'));
   set_item_result(run_stored_sig('142'));
   set_item_result(run_stored_sig('228'));
   set_item_result(run_stored_sig('194'));
   set_item_result(run_stored_sig('316'));
   set_item_result(run_stored_sig('PCA-MGD-80'));
   set_item_result(run_stored_sig('PCA-MGD-82'));
end_section;
debug('end section: Data_Integrity_Issues');

debug('begin section: XLA_GL_TRANSFER');
start_section('XLA-GL Transfer Issues', 'XLA_GL_TRANSFER');
   set_item_result(run_stored_sig('AP_PC_XLA_GL_NEG_LEDGER_ID'));
   set_item_result(run_stored_sig('AP_PC_XLA_GL_NULL_GL_SL_LINK_ID'));
   set_item_result(run_stored_sig('AP_PC_XLA_GL_XFR_IN_XLA_NOT_IN_GL'));
   set_item_result(run_stored_sig('AP_PC_XLA_GL_XFR_IN_XLA_REV_IN_GL'));
   set_item_result(run_stored_sig('AP_PC_XLA_GL_EXISTS_IN_GL_NOT_IN_XLA'));
   set_item_result(run_stored_sig('AP_PC_XLA_GL_NOT_XFR_IN_XLA_BUT_IN_GL'));
   set_item_result(run_stored_sig('AP_PC_XLA_GL_MULTIPLE_POST_IN_GL'));
   set_item_result(run_stored_sig('EBS_FIN_AP_GL_INTERFACE_PROCESSED_STATUS'));
end_section;
debug('end section: XLA_GL_TRANSFER');
...
start_section('Apps Check', 'Apps_Check');
   ...
   set_item_result(run_stored_sig('EBS_FIN_AP_AC_PATCHES_APPLIED'));
end_section;
debug('end section: Apps_Check');

debug('begin section: 80CA_Miscellaneous');
start_section('Miscellaneous (Programs, Profiles, etc...)', '80CA_Miscellaneous');
   set_item_result(run_stored_sig('CA_ACCOUNTING_PROGRAM_RUN_HISTORY'));
   set_item_result(run_stored_sig('CA_DISABLE_JOURNAL_IMPORT'));
   set_item_result(run_stored_sig('CA_REPORT_PARAMETERS'));
   set_item_result(run_stored_sig('CA_SINGLE_MULTI_MODE'));
   set_item_result(run_stored_sig('CA_SLA_SETUP_USER_MODE'));
   set_item_result(run_stored_sig('PC_SWEEP_SINGLE_MODE'));
   set_item_result(run_stored_sig('PC_INITIALIZATION_SQL_PROFILE_CHECK'));
   set_item_result(run_stored_sig('PCLOSE_IGI_PKG_SWEEP_ERROR'));
   set_item_result(run_stored_sig('PCLOSE_CUSTOM_TRIGGERS_CAUSE_SWEEP_ERROR'));
   set_item_result(run_stored_sig('PCLOSE_SHOW_ACCOUNTING_ERRORS'));
end_section;
debug('end section: 80CA_Miscellaneous');
