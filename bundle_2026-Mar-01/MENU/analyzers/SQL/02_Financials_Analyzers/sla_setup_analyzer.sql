...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Subledger Accounting Setup Analyzer    |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE sla_setup_analyzer_pkg AUTHID DEFINER AS
...
(            p_ledger_id                    IN NUMBER      DEFAULT NULL
           ...
           ,p_slam                         IN VARCHAR2    DEFAULT NULL
           ,p_aad                          IN VARCHAR2    DEFAULT NULL
           ,p_context                      IN VARCHAR2    DEFAULT NULL
           ,p_event_class                  IN VARCHAR2    DEFAULT NULL
           ,p_jld                          IN VARCHAR2    DEFAULT NULL
           ,p_jlt                          IN VARCHAR2    DEFAULT NULL
...
END sla_setup_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY sla_setup_analyzer_pkg AS
-- $Id: sla_setup_analyzer.sql, 200.4 2025/12/08 13:48:00 kgnanase Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2889525.1));
...
----------------------------------------------------------------
g_ledger_name    VARCHAR2(500);
g_app_name       VARCHAR2(500);
g_slam_name      VARCHAR2(500);
g_aad_name       VARCHAR2(500);
g_ev_class_name  VARCHAR2(500);
g_jld_name       VARCHAR2(500);
g_jlt_name       VARCHAR2(500);


g_jld_append1     VARCHAR2(500);
g_jld_append2     VARCHAR2(500);

g_jlt_append1     VARCHAR2(500);
g_jlt_append2     VARCHAR2(500);

g_adr_append1     VARCHAR2(500);
g_adr_append2     VARCHAR2(500);

g_hdes_append1    VARCHAR2(500);
g_hdes_append2    VARCHAR2(500);

g_ldes_append1    VARCHAR2(500);
g_ldes_append2    VARCHAR2(500);

g_ev_append1      VARCHAR2(500);
g_ev_append2      VARCHAR2(500);
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'SLASTPANLZ_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'SLASTPANLZ_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>SLASTPANLZ Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2889525.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/sla_setup_analyzer_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,6309,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,6309,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},6309,EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/mosc/discussion/4518669" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">6309</span>
...
<ul><li>New Framework features</li>
</ul>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,6309,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,6309,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},6309,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Receivables" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
debug('begin populate parameters hash table');
   ...
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_application_id,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Subledger Accounting Method (SLAM) Name';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_slam,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Application Accounting Definition (AAD)';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_aad,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Context';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_context,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Event Class';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_event_class,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Journal Line Definition (JLD)';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_jld,'NO_MASK');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Journal Line Type (JLT)';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_jlt,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2025/12/08 13:47:59 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'sla_setup_analyzer.sql';
...
debug('begin parameter validation: p_application_id');
...
BEGIN
SELECT FTL.APPLICATION_ID 
INTO l_exists_val
FROM FND_APPLICATION_TL FTL
WHERE FTL.APPLICATION_ID  = p_application_id
 AND FTL.language = 'US'
and  FTL.application_id in (Select distinct SLAM.application_id from  XLA_ACCTG_METHOD_RULES_FVL SLAM ) 
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Application');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_application_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_application_id');

debug('begin parameter validation: p_slam');
IF p_slam IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Subledger Accounting Method (SLAM) Name is required.');
   raise invalid_parameters;
END IF;
IF p_slam IS NOT NULL THEN
BEGIN
SELECT SLAM.ACCOUNTING_METHOD_CODE
INTO l_exists_val
FROM GL_LEDGERS T1, XLA_ACCTG_METHODS_FVL SLAM
WHERE SLAM.ACCOUNTING_METHOD_CODE = p_slam
 AND T1.ledger_id = p_ledger_id
and T1.sla_accounting_method_code = SLAM.ACCOUNTING_METHOD_CODE
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid SLAM');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_slam failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_slam');

debug('begin parameter validation: p_aad');
IF p_aad IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Application Accounting Definition (AAD) is required.');
   raise invalid_parameters;
END IF;
IF p_aad IS NOT NULL THEN
BEGIN
SELECT AAD.PRODUCT_RULE_CODE
INTO l_exists_val
FROM XLA_PRODUCT_RULES_B AAD, XLA_ACCTG_METHOD_RULES_FVL SLAM
WHERE AAD.PRODUCT_RULE_CODE = p_aad
 AND AAD.application_id = p_application_id
and     SLAM.ACCOUNTING_METHOD_CODE = p_slam
and     SLAM.PRODUCT_RULE_CODE = AAD.PRODUCT_RULE_CODE
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Application Accounting Definition (AAD)');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_aad failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_aad');

debug('begin parameter validation: p_context');
IF p_context IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Context is required.');
   raise invalid_parameters;
END IF;
IF p_context IS NOT NULL THEN
BEGIN
SELECT AAD.AMB_CONTEXT_CODE
INTO l_exists_val
FROM XLA_PRODUCT_RULES_B AAD
WHERE AAD.AMB_CONTEXT_CODE = p_context
 AND AAD.APPLICATION_ID = p_application_id
and AAD.PRODUCT_RULE_CODE = p_aad
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Context Name.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_context failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_context');

debug('begin parameter validation: p_event_class');
IF p_event_class IS NOT NULL THEN
BEGIN
SELECT EVENT_CLASS_CODE
INTO l_exists_val
FROM  XLA_EVENT_CLASSES_FVL
WHERE EVENT_CLASS_CODE = p_event_class
 AND application_id = p_application_id
and event_class_code in
    (select distinct ec.event_class_code 
    from   xla_aad_line_defn_assgns lda, 
               xla_event_classes_fvl ec, 
               xla_event_types_tl et
    where lda.application_id = p_application_id
    AND    ec.enabled_flag = 'Y'
    AND    lda.product_rule_code = p_aad
    AND    lda.amb_context_code = p_context
    AND    ec.application_id = lda.application_id
    AND    ec.event_class_code = lda.event_class_code
    AND    et.event_type_code = lda.event_type_code
    AND    et.application_id = lda.application_id
    AND    et.language = USERENV('LANG')
    AND    et.event_class_code = ec.event_class_code)
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Event Class Code');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_event_class failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_event_class');

debug('begin parameter validation: p_jld');
IF p_jld IS NOT NULL THEN
BEGIN
SELECT JLD.LINE_DEFINITION_CODE
INTO l_exists_val
FROM XLA_LINE_DEFINITIONS_VL JLD, XLA_AAD_LINE_DEFN_ASSGNS JLD_ASGN
WHERE JLD.LINE_DEFINITION_CODE = p_jld
 AND jld_asgn.application_id = p_application_id
and jld_asgn.application_id = jld.application_id
and jld_asgn.product_rule_code = p_aad
and jld_asgn.event_class_code = p_event_class
and jld_asgn.amb_context_code = p_context
and jld_asgn.amb_context_code = jld.amb_context_code
and jld_asgn.line_definition_code = jld.line_definition_code
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: There are no Journal Line Definitions defined for the selected Event Type.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_jld failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_jld');

debug('begin parameter validation: p_jlt');
IF p_jlt IS NOT NULL THEN
BEGIN
SELECT  JLT.ACCOUNTING_LINE_CODE
INTO l_exists_val
FROM XLA_ACCT_LINE_TYPES_FVL JLT, XLA_LINE_DEFN_JLT_ASSGNS JLT_ASGN
WHERE  JLT.ACCOUNTING_LINE_CODE = p_jlt
 AND jlt_asgn.application_id = p_application_id
and jlt_asgn.application_id = jlt.application_id
and jlt.amb_context_code = p_context
and jlt.amb_context_code = jlt_asgn.amb_context_code
and jlt_asgn.line_definition_code = nvl(p_jld , 'Dummy')
and jlt_asgn.accounting_line_code = jlt.accounting_line_code
 and rownum < 2;
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: There are no Journal Line Types defined for the Event Class');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_jlt failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_jlt');
...
select gl.name into g_ledger_name         
from gl_ledgers gl 
where gl.ledger_id =p_ledger_id;

-- APPLICATION

select distinct ftl.application_name into g_app_name         
from fnd_application_tl ftl
where ftl.application_id  =p_application_id
and ftl.Language = 'US';

-- SLAM
select distinct slam.name into g_slam_name         
from xla_acctg_methods_fvl slam
where slam.accounting_method_code =p_slam;

--AAD

select distinct aad.PRODUCT_RULE_NAME into g_aad_name         
...
If (p_event_class is not null) then 
        ...
        select distinct event_class_name into g_ev_class_name            
        from xla_event_classes_fvl jld
        where EVENT_CLASS_CODE  =p_event_class;
...
If (p_jld is not null) then 
        ...
        select distinct jld.name into g_jld_name         
        from xla_line_definitions_vl jld
        where jld.line_definition_code  =p_jld;
...
If (p_jlt is not null) then 
        ...
        select distinct jlt.name into g_jlt_name         
        from xla_acct_line_types_fvl jlt
        where  jlt.accounting_line_code  =p_jlt;
        
end if;

If g_jlt_name is not null then
    
    g_jld_append1:= null;
    g_jld_append2 := g_jld_name;    
    
    g_hdes_append1 :='associated with Event Class ';
    g_hdes_append2 := g_ev_class_name; 
    
    g_jlt_append1:= null;
    g_jlt_append2 := g_jlt_name;    
    
    g_adr_append1 := 'associated with Journal Line Types (JLT) ';
    g_adr_append2 := g_jlt_name;
    
    g_ldes_append1 := 'associated with Journal Line Types (JLT) ';
    g_ldes_append2 := g_jlt_name;
    
    g_ev_append1 :='associated with Event Class ';
    g_ev_append2 :=g_ev_class_name; 

elsif g_jld_name is not null then
    ...
    g_jlt_append1:= 'associated with Journal Line Definition (JLD) ';
    g_jlt_append2 := g_jld_name;    
    
    g_adr_append1:= 'associated with Journal Line Definition (JLD) ';
    g_adr_append2 := g_jld_name;  
    
    g_ldes_append1:= 'associated with Journal Line Definition (JLD) ';
    g_ldes_append2 := g_jld_name;  
    
    g_ev_append1 :='associated with Event Class ';
    g_ev_append2 :=g_ev_class_name; 
   
elsif g_ev_class_name is not null then

    g_jld_append1:= 'associated with Event Class ';
    g_jld_append2 := g_ev_class_name; 
    
    g_hdes_append1 :='associated with Event Class ';
    g_hdes_append2 := g_ev_class_name; 

    g_jlt_append1:= 'associated with Event Class ';
    g_jlt_append2 := g_ev_class_name;   
      
    g_adr_append1:= 'associated with Event Class ';
    g_adr_append2 := g_ev_class_name;  
    
    g_ldes_append1:= 'associated with Event Class ';
    g_ldes_append2 := g_ev_class_name;  
    ...
    g_jld_append1:= 'associated with Application Accounting Definition (AAD) ';
    g_jld_append2 := g_aad_name; 
    
    g_hdes_append1:= 'associated with Application Accounting Definition (AAD) ';
    g_hdes_append2 := g_aad_name; 
    
    g_jlt_append1:= 'associated with Application Accounting Definition (AAD) ';
    g_jlt_append2 := g_aad_name;    
        
    g_adr_append1:= 'associated with Application Accounting Definition (AAD) ';
    g_adr_append2 := g_aad_name; 
    
    g_ldes_append1:= 'associated with Application Accounting Definition (AAD) ';
    g_ldes_append2 := g_aad_name; 
    
    g_ev_append1 :='associated with Application ';
    g_ev_append2 :=g_app_name; 
...
debug('begin populate sql tokens hash table');
   g_sql_tokens('##$$AADCODE$$##') := p_aad;
   g_masked_tokens('##$$AADCODE$$##') := mask_text( g_sql_tokens('##$$AADCODE$$##'), 'NO_MASK');
   g_sql_tokens('##$$APPID$$##') := p_application_id;
   g_masked_tokens('##$$APPID$$##') := mask_text( g_sql_tokens('##$$APPID$$##'), 'NO_MASK');
   g_sql_tokens('##$$CONTEXT$$##') := p_context;
   g_masked_tokens('##$$CONTEXT$$##') := mask_text( g_sql_tokens('##$$CONTEXT$$##'), 'NO_MASK');
   g_sql_tokens('##$$EVENTCLASS$$##') := p_event_class;
   g_masked_tokens('##$$EVENTCLASS$$##') := mask_text( g_sql_tokens('##$$EVENTCLASS$$##'), 'NO_MASK');
   g_sql_tokens('##$$LEDGERID$$##') := p_ledger_id;
   g_masked_tokens('##$$LEDGERID$$##') := mask_text( g_sql_tokens('##$$LEDGERID$$##'), 'NO_MASK');
   g_sql_tokens('##$$SLAM$$##') := p_slam;
   g_masked_tokens('##$$SLAM$$##') := mask_text( g_sql_tokens('##$$SLAM$$##'), 'NO_MASK');
   g_sql_tokens('##$$JLDCODE$$##') := p_jld;
   g_masked_tokens('##$$JLDCODE$$##') := mask_text( g_sql_tokens('##$$JLDCODE$$##'), 'NO_MASK');
   g_sql_tokens('##$$JLTCODE$$##') := p_jlt;
   g_masked_tokens('##$$JLTCODE$$##') := mask_text( g_sql_tokens('##$$JLTCODE$$##'), 'NO_MASK');
...
debug('begin add_signature: SLA_SETUP_SLAM');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22222',
      p_sig_id                 => 'SLA_SETUP_SLAM',
      p_sig_sql                => '  SELECT slam.accounting_method_code slam_code,
       slam2.NAME slam_name, 
       slam2.accounting_method_type_dsp SLAM_owner ,        
       slam2.description slam_description, 
       slam.product_rule_code AAD_code, 
       slam.product_rule_name AAD_name, 
       to_char(slam.start_date_active,''DD-MON-YYYY'')  start_date, 
       to_char(slam.end_date_active,''DD-MON-YYYY'') end_date,
       slam.acctg_method_rule_id Rule_id,
       to_char(slam.last_update_date, ''DD-MON-YYYY HH24:MI:SS'')  last_update_date,         
       to_char(slam.creation_date,    ''DD-MON-YYYY HH24:MI:SS'')  creation_date ,
       slam.application_name ,
       slam.last_updated_by,
       slam.created_by
FROM   xla_acctg_method_rules_fvl slam,  
       xla_acctg_methods_fvl slam2
WHERE  slam.accounting_method_code =  ''##$$SLAM$$##''
       AND slam.application_id = ##$$APPID$$##
       AND slam.amb_context_code = ''##$$CONTEXT$$##''
       AND slam.accounting_method_code = slam2.accounting_method_code 
       AND slam.accounting_method_type_code = slam2.accounting_method_type_code',
      p_title                  => 'Subledger Accounting Methods (SLAM)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Subledger Accounting Method (SLAM) Identified for Ledger  <b>'||mask_text(g_ledger_name, nvl( upper(''), 'NO_MASK') )||'</b> and application <b>'||mask_text(g_app_name, nvl( upper(''), 'NO_MASK') )||'</b>.
',
      p_solution               => 'Please make sure there is a Subledger Accounting Method (SLAM) associated with Ledger  <b>'||mask_text(g_ledger_name, nvl( upper(''), 'NO_MASK') )||'</b> and application <b>'||mask_text(g_app_name, nvl( upper(''), 'NO_MASK') )||'</b> following the steps in [841593.1].
',
      p_success_msg            => 'This is a data collection of Subledger Accounting Method (SLAM) associated with Ledger  <b>'||mask_text(g_ledger_name, nvl( upper(''), 'NO_MASK') )||'</b> and application <b>'||mask_text(g_app_name, nvl( upper(''), 'NO_MASK') )||'</b>.',
   ...
   l_info.delete;
debug('end add_signature: SLA_SETUP_SLAM');



debug('begin add_signature: SLA_SETUP_AAD');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22249',
      p_sig_id                 => 'SLA_SETUP_AAD',
      p_sig_sql                => 'select product_rule_code AAD_Code, 
       NAME aad_name, 
       product_rule_type_dsp AAD_Owner,         
       application_name aad_application, 
       description aad_description, 
       transaction_coa_id aad_transaction_coa_id, 
       accounting_coa_id aad_accounting_coa_id, 
       transaction_coa_name aad_transaction_coa_name, 
       accounting_coa_name aad_accounting_coa_name,
       ...
       decode(COMPILE_STATUS_CODE,''Y'',''Compiled'',
                                  ...
                                  ''I'',''Invalid'',
                                  ''R'',''Validating'',
                                  ''Invalid - ''||COMPILE_STATUS_CODE) aad_compile_status,
...
AND  product_rule_code = ''##$$AADCODE$$##''',
      p_title                  => 'Application Accounting Definition (AAD)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Valid Application Accounting Definition (AAD) Identified for Subledger Accounting Methods (SLAM) <b>'||mask_text(g_slam_name, nvl( upper(''), 'NO_MASK') )||'</b>.
',
      p_solution               => '<li>Please make sure there is at least one active and valid Application Accounting Definition (AAD) associated with the ledger following the steps in [2912183.1].</li><li>Please log a Service Request if issue persists after following the action plan in [2912183.1].</li> ',
      p_success_msg            => 'This is a data collection of Application Accounting Definitions (AAD) associated with Subledger Accounting Method (SLAM) <b>'||mask_text(g_slam_name, nvl( upper(''), 'NO_MASK') )||'</b>.
...
',
   ...
   l_info.delete;
debug('end add_signature: SLA_SETUP_AAD');



debug('begin add_signature: SLA_SETUP_JOURNAL_LINE_DEFINITIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22250',
      p_sig_id                 => 'SLA_SETUP_JOURNAL_LINE_DEFINITIONS',
      p_sig_sql                => 'SELECT   ld.event_class_code, 
         ld.event_type_code,
         ec.event_class_name eventclass_name,
         et.name eventtype_name, 
         ld.line_definition_code, 
         Decode(ld.line_definition_owner_code,''S'',''Oracle'', ''User'') line_definition_owner, 
         ld.NAME jld_name, 
         ld.transaction_coa_id jld_transaction_coa_id, 
         ld.accounting_coa_id jld_accounting_coa_id, 
         ld.validation_status_code, 
         ld.budgetary_control_flag, 
         ld.description jld_description, 
         ld.enabled_flag jld_enabled, 
         ld.validation_status_code event_class_validation_status
FROM     xla_aad_line_defn_assgns lda, 
         xla_line_definitions_vl ld, 
         xla_event_classes_fvl ec,
         xla_event_types_tl et 
WHERE    lda.application_id =  ##$$APPID$$##
         AND lda.product_rule_code = nvl(''##$$AADCODE$$##'' ,lda.product_rule_code)
         ...
         AND lda.event_class_code = ld.event_class_code 
         AND lda.event_type_code = ld.event_type_code 
         AND ld.enabled_flag = ''Y'' 
         AND lda.amb_context_code = ''##$$CONTEXT$$##''
         AND ld.amb_context_code = lda.amb_context_code
         AND lda.event_class_code = Nvl(''##$$EVENTCLASS$$##'' ,lda.event_class_code) 
         AND ec.application_id = lda.application_id
         AND ec.event_class_code = ld.event_class_code
         AND et.event_type_code = ld.event_type_code
         AND et.application_id = ld.application_id
         AND ec.event_class_code = lda.event_class_code
         AND et.language = USERENV(''LANG'')
         AND et.event_class_code = ec.event_class_code
ORDER BY eventclass_name',
      p_title                  => 'Journal Line Definition (JLD)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Journal Line Definition (JLD)  '||mask_text(g_jld_append1, nvl( upper(''), 'NO_MASK') )||'<b>'||mask_text(g_jld_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_solution               => '<li>Please make sure there is at least one Journal Line Definition (JLD) is associated with the event class following the steps in [2912164.1],</li> <li>Please log a Service Request if issue persists after following the action plan in [2912164.1]. </li>.
',
      p_success_msg            => 'This is a data collection of Journal Line Definition(JLD) '||mask_text(g_jld_append1, nvl( upper(''), 'NO_MASK') )||'<b>'||mask_text(g_jld_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SLA_SETUP_JOURNAL_LINE_DEFINITIONS');



debug('begin add_signature: SLA_SETUP_JOURNAL_LINE_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22315',
      p_sig_id                 => 'SLA_SETUP_JOURNAL_LINE_TYPES',
      p_sig_sql                => 'SELECT   ld.event_class_code,
         ld.line_definition_code,
         lt.accounting_line_code, 
         lt.NAME jlt_name, 
         lt.description jlt_description,
         lt.accounting_line_type_dsp ,
         accounting_class_code, 
         lt.accounting_class_dsp,      
         lt.enabled_flag jlt_enabled, 
         ld.active_flag jlt_active_flag,        xla_conditions_pkg.Display_condition(ld.application_id,ld.amb_context_code,lt.entity_code,ld.event_class_code,lt.accounting_line_type_code,lt.accounting_line_code, NULL,NULL,NULL,''A'') jlt_condition ,
		 jdes.NAME jdescription_name, 
         jdes.description_type_code_dsp, 
         ld.description_code,  
         Decode(ld.inherit_desc_flag,''N'',''No'', ''Y'',''Yes'') jlt_inherit_description,
         lt.rounding_class_code, 
         lt.rounding_class_dsp,           
         lt.transaction_coa_id jlt_transaction_coa_id, 
         lt.transaction_coa_name jlt_transaction_coa_name, 
         decode(lt.business_method_code,''NONE'', ''None'', ''SAME_ENTRY'', ''Same Entry'', ''PRIOR_ENTRY'', ''Prior Entry'') business_method_code, 
         lt.business_class_code,           
         Decode(lt.accounting_entry_type_code,''A'',''Actual'', ''E'',''Encumbrance'', ''B'',''Budget'') accounting_entry_type_code, 
         Decode(natural_side_code,''D'',''Debit'', ''C'',''Credit'',''Gain/Loss'') natural_side_code, 
         Decode(lt.gl_transfer_mode_code,''D'',''Detail'', ''S'',''Summary'') gl_transfer_mode, 
         Decode(lt.switch_side_flag,''Y'',''Yes'', ''N'',''No'') switch_side_flag, 
         Decode(lt.gain_or_loss_flag,''Y'',''Yes'', ''N'',''No'') subledger_gain_loss_flag, 
         lt.merge_duplicate_code, 
         lt.merge_duplicate_dsp, 
         decode(lt.mpa_option_code, ''ACCRUAL'', ''Accrual'', ''RECOGNITION'', ''Recognition'', ''NONE'', ''None'') mpa_option_code,
         lt.encumbrance_type_id, 
         lt.encumbrance_type   
FROM     xla_line_defn_jlt_assgns ld, 
         xla_acct_line_types_fvl lt, 
         xla_descriptions_fvl jdes,
         xla_aad_line_defn_assgns lda
WHERE    ld.application_id =  ##$$APPID$$##
         AND lda.product_rule_code = nvl(''##$$AADCODE$$##'' ,lda.product_rule_code)
         AND lda.application_id = ld.application_id 
         AND lda.line_definition_code = ld.line_definition_code 
         AND lda.line_definition_owner_code = ld.line_definition_owner_code 
         AND lda.event_class_code = ld.event_class_code 
         AND lda.event_type_code = ld.event_type_code
         AND ld.event_class_code = nvl(''##$$EVENTCLASS$$##'',ld.event_class_code)
         AND ld.line_definition_code = nvl(''##$$JLDCODE$$##'' ,ld.line_definition_code )
         AND ld.accounting_line_code  =  nvl(''##$$JLTCODE$$##'',ld.accounting_line_code)
         AND ld.application_id = lt.application_id 
         AND ld.accounting_line_code = lt.accounting_line_code 
         AND ld.accounting_line_type_code = lt.accounting_line_type_code 
         AND ld.event_class_code = lt.event_class_code 
         AND lt.enabled_flag = ''Y''
		 AND nvl(jdes.enabled_flag, ''Y'') = ''Y''
		 AND ld.active_flag = ''Y'' 
         AND lda.amb_context_code = ''##$$CONTEXT$$##''
         AND lt.amb_context_code = lda.amb_context_code
         AND ld.amb_context_code = lt.amb_context_code
         AND jdes.application_id (+) = ld.application_id 
         AND jdes.amb_context_code (+) = ld.amb_context_code 
         AND jdes.description_code (+) = ld.description_code 
         AND jdes.description_type_code (+) = ld.description_type_code 
ORDER BY   ld.event_class_code,
         ld.line_definition_code,
         lt.accounting_line_code',
      p_title                  => 'Journal Line types (JLT)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Journal Line Types (JLT) '||mask_text(g_jlt_append1, nvl( upper(''), 'NO_MASK') )||'<b>'||mask_text(g_jlt_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_solution               => '<li>Associate required  Journal Line Types (JLT) to Journal Line Definitions (JLDs) following the steps in [2912172.1].</li><li>Please log a Service Request if issue persists after following the action plan in [2912172.1].</li> 
',
      p_success_msg            => 'This is a data collection of Journal Line Types (JLT) '||mask_text(g_jlt_append1, nvl( upper(''), 'NO_MASK') )||'<b>'||mask_text(g_jlt_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SLA_SETUP_JOURNAL_LINE_TYPES');



debug('begin add_signature: SLA_SETUP_JLT_ACCOUNTING_ATTRIBUTE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22341',
      p_sig_id                 => 'SLA_SETUP_JLT_ACCOUNTING_ATTRIBUTE',
      p_sig_sql                => 'SELECT   ld.event_class_code,
         ld.line_definition_code,
         lt.accounting_line_code, 
         lt.NAME jlt_name, 
         lts.accounting_attribute_code,
         lts.source_code,
         lts.source_type_code,
         lts.source_application_id,
         lts.event_class_default_flag 
FROM     xla_line_defn_jlt_assgns ld, 
         xla_acct_line_types_fvl lt,
         xla_aad_line_defn_assgns lda,
         XLA_JLT_ACCT_ATTRS lts
WHERE    ld.application_id =   ##$$APPID$$##
         AND lda.product_rule_code =  nvl(''##$$AADCODE$$##'' , lda.product_rule_code)
         AND lda.application_id = ld.application_id 
         AND lda.line_definition_code = ld.line_definition_code 
         ...
         AND lt.amb_context_code = lda.amb_context_code
         AND ld.amb_context_code = lt.amb_context_code
         AND lts.amb_context_code=  lt.amb_context_code
         AND lts.application_id  = lt.application_id 
         AND lts.accounting_line_code  =lt.accounting_line_code 
         AND lts.accounting_line_type_code  = lt.accounting_line_type_code 
         AND lts.event_class_code  =lt.event_class_code 
ORDER BY jlt_name,accounting_attribute_code',
      p_title                  => 'Journal Line Types (JLT) Accounting Attributes',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Journal Line Types (JLT) Accounting Attributes '||mask_text(g_jlt_append1, nvl( upper(''), 'NO_MASK') )||'<b>'||mask_text(g_jlt_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_solution               => '<li>Associate required Accounting Attributes to the Journal Line Types (JLT) following the steps in [2912193.1].</li><li>Please log a Service Request if issue persists after following the action plan in [2912193.1].</li> 
',
      p_success_msg            => 'This is a data collection of Journal Line Types (JLT) Accounting Attributes '||mask_text(g_jlt_append1, nvl( upper(''), 'NO_MASK') )||'<b>'||mask_text(g_jlt_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SLA_SETUP_JLT_ACCOUNTING_ATTRIBUTE');



debug('begin add_signature: SLA_SETUP_ACCOUNT_DERIVATION_RULES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22316',
      p_sig_id                 => 'SLA_SETUP_ACCOUNT_DERIVATION_RULES',
      p_sig_sql                => 'SELECT   da.event_class_code,
         da.line_definition_code,
         da.accounting_line_code,
         da.side_code, 
         da.side_code_dsp, 
         da.flexfield_segment_name, 
         da.flexfield_segment_code, 
         da.segment_rule_name, 
         da.segment_rule_code, 
         da.segment_rule_owner, 
         da.segment_rule_desc, 
         da.segment_rule_type_code, 
         Decode(da.inherit_adr_flag,''N'',''No'',''Y'',''Yes'') inherit_adr_flag 
FROM     xla_line_defn_adr_assgns_f_v da ,
         xla_aad_line_defn_assgns  lda
WHERE    da.application_id = ##$$APPID$$##
         AND lda.product_rule_code = nvl(''##$$AADCODE$$##'' ,lda.product_rule_code)
         AND lda.application_id = da.application_id 
         AND lda.line_definition_code = da.line_definition_code 
         AND lda.line_definition_owner_code = da.line_definition_owner_code 
         AND lda.event_class_code = da.event_class_code 
         AND lda.event_type_code = da.event_type_code  
         AND da.event_class_code = nvl(''##$$EVENTCLASS$$##'',da.event_class_code)
         AND da.line_definition_code =  nvl(''##$$JLDCODE$$##'' ,da.line_definition_code )
         AND da.accounting_line_code =  nvl(''##$$JLTCODE$$##'',da.accounting_line_code)
         AND da.amb_context_code =  ''##$$CONTEXT$$##''
         AND lda.amb_context_code = da.amb_context_code 
ORDER BY da.flexfield_segment_code',
      p_title                  => 'Account Derivation Rules (ADR) Associated to the Journal Line types (JLT)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Account Derivation Rules (ADR) '||mask_text(g_adr_append1, nvl( upper(''), 'NO_MASK') )||' <b>'||mask_text(g_adr_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_solution               => '<li>Associate required Account Derivation Rules (ADR) to the Journal Line Types (JLT) following the steps in [2912469.1].</li><li>Please log a Service Request if issue persists after following the action plan in [2912469.1].</li> 
',
      p_success_msg            => 'This is a data collection of Account Derivation Rules (ADR) '||mask_text(g_adr_append1, nvl( upper(''), 'NO_MASK') )||' <b>'||mask_text(g_adr_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
   ...
   l_info.delete;
debug('end add_signature: SLA_SETUP_ACCOUNT_DERIVATION_RULES');



debug('begin add_signature: SLA_SETUP_ACCOUNT_DERIVATION_RULE_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22317',
      p_sig_id                 => 'SLA_SETUP_ACCOUNT_DERIVATION_RULE_DETAILS',
      p_sig_sql                => 'SELECT distinct sr.segment_rule_code,
       sr.name name_adr, 
       ...
       xla_conditions_pkg.Display_condition(sd.application_id,sd.amb_context_code ,NULL,NULL,NULL,NULL,sd.segment_rule_detail_id,NULL,NULL,''S'') adr_condition,
	   XLA_RPT_SARDLR_PKG.populate_fields
		    (sd.value_type_code                 ,
			 ...
			 sr.flex_value_set_id               ,  
			 sd.input_source_code                  ,
			 sd.input_source_application_id        ,
			 sd.input_source_type_code             ,
			 sd.value_flexfield_segment_code       ,
			 sr.transaction_coa_id                 ,
			 sr.accounting_coa_id                  ,
			 1
			 ) adr_value,
         XLA_RPT_SARDLR_PKG.populate_fields
		    (sd.value_type_code                 ,
...
WHERE  sd.application_id             =   ##$$APPID$$##
   ...
   AND sr.amb_context_code            = ''##$$CONTEXT$$##''
   AND sd.amb_context_code            =  sr.amb_context_code 
   AND sr.segment_rule_type_code = adr.segment_rule_type_code
   AND sr.segment_rule_code= adr.segment_rule_code  
   AND jld.application_id = sd.application_id 
   AND jld.product_rule_code = nvl(''##$$AADCODE$$##'' ,jld.product_rule_code)
   AND jld.amb_context_code = sr.amb_context_code 
   ...
   AND adr.amb_context_code = jld.amb_context_code 
   AND adr.application_id = jld.application_id
   AND adr.event_class_code = nvl(''##$$EVENTCLASS$$##'',adr.event_class_code) 
   AND adr.line_definition_code = nvl(''##$$JLDCODE$$##'' ,adr.line_definition_code )
   AND adr.accounting_line_code = nvl(''##$$JLTCODE$$##'',adr.accounting_line_code)
   AND adr.event_class_code =jld.event_class_code
   AND adr.event_type_code = jld.event_type_code 
   AND adr.segment_rule_code IS NOT NULL 
   AND jld_2.enabled_flag = ''Y'' 
   AND jld_2.event_class_code = jld.event_class_code 
   AND jld_2.event_type_code = jld.event_type_code  
   AND jld_2.application_id = jld.application_id 
   AND jld_2.amb_context_code = jld.amb_context_code 
   ...
   order by name_adr, adr_priority',
      p_title                  => 'Account Derivation Rule (ADR) Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Account Derivation Rules (ADR) '||mask_text(g_adr_append1, nvl( upper(''), 'NO_MASK') )||' <b>'||mask_text(g_adr_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_solution               => '<li>Associate required Account Derivation Rules (ADR) to the Journal Line Types (JLT) following the steps in [2912469.1].</li><li>Please log a Service Request if issue persists after following the action plan in [2912469.1].</li> ',
      p_success_msg            => 'This is a data collection of Account Derivation Rules (ADR) Details '||mask_text(g_adr_append1, nvl( upper(''), 'NO_MASK') )||' <b>'||mask_text(g_adr_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SLA_SETUP_ACCOUNT_DERIVATION_RULE_DETAILS');



debug('begin add_signature: SLA_SETUP_JOURNAL_ENTRY_HEADER_DEFINITION_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22327',
      p_sig_id                 => 'SLA_SETUP_JOURNAL_ENTRY_HEADER_DEFINITION_DETAILS',
      p_sig_sql                => 'SELECT distinct desf.description_code, 
       desf.description_type_code_dsp, 
       desf.name, 
       desf.transaction_coa_name, 
       desf.description, 
       desp.user_sequence description_priority, 
       desp.description_prio_id,  xla_conditions_pkg.Display_condition_substr(desf.application_id,desf.amb_context_code,NULL,NULL,NULL,NULL,NULL,desp.description_prio_id,NULL,''D'',1,4000) condition, 
	   xla_descript_details_pkg.Display_desc_prio_details(desp.description_prio_id,desf.transaction_coa_id) detail 
FROM   xla_descriptions_fvl desf, 
       xla_desc_priorities desp,
       xla_product_rules_fvl aad, 
       xla_prod_header_desc_fvl hdesc 
WHERE      desf.application_id =  ##$$APPID$$##
       AND desf.amb_context_code =  ''##$$CONTEXT$$##''
       AND desp.application_id = desf.application_id 
       AND desp.amb_context_code = desf.amb_context_code
       AND desf.enabled_flag = ''Y'' 
       AND desp.description_code = desf.description_code 
       AND desp.description_type_code = desf.description_type_code 
       AND aad.application_id =   desf.application_id
       AND aad.product_rule_code =  nvl(''##$$AADCODE$$##'' ,aad.product_rule_code)
       AND aad.amb_context_code = desf.amb_context_code 
       AND aad.product_rule_type_code = hdesc.product_rule_type_code 
       AND aad.product_rule_code = hdesc.product_rule_code 
       AND aad.enabled_flag = ''Y'' 
       AND hdesc.application_id =  aad.application_id
       AND hdesc.amb_context_code = aad.amb_context_code
       AND hdesc.event_class_code =   Nvl(''##$$EVENTCLASS$$##'',hdesc.event_class_code) 
       AND hdesc.header_desc_code IS NOT NULL 
       AND hdesc.header_desc_type_code IS NOT NULL 	    
       AND desp.description_code = hdesc.header_desc_code 
       AND desp.description_type_code =hdesc.header_desc_type_code
ORDER BY   name, description_priority',
      p_title                  => 'Journal Entry Header Description Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Journal Entry Header Description(JED) '||mask_text(g_hdes_append1, nvl( upper(''), 'NO_MASK') )||' <b>'||mask_text(g_hdes_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_solution               => 'There is no Journal Entry Header Description(JED) '||mask_text(g_hdes_append1, nvl( upper(''), 'NO_MASK') )||' <b>'||mask_text(g_hdes_append2, nvl( upper(''), 'NO_MASK') )||'</b>.
<li>Please refer [1920593.1] if you want to setup Journal Entry Description (JED) to get more details on the journal line and header level. </li>',
      p_success_msg            => 'This is a data collection of Journal Entry Header Description(JED) Details '||mask_text(g_hdes_append1, nvl( upper(''), 'NO_MASK') )||' <b>'||mask_text(g_hdes_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SLA_SETUP_JOURNAL_ENTRY_HEADER_DEFINITION_DETAILS');



debug('begin add_signature: EBS_FIN_AR_SLA_SETUP_JED_ASSGN_JLT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30273',
      p_sig_id                 => 'EBS_FIN_AR_SLA_SETUP_JED_ASSGN_JLT',
      p_sig_sql                => 'SELECT DISTINCT jlt.LINE_DEFINITION_CODE, JLT.ACCOUNTING_LINE_CODE, JLT.DESCRIPTION_CODE
FROM   xla_product_rules_fvl aad,
       xla_aad_line_defn_assgns jld,
       xla_line_defn_jlt_assgns jlt,
       xla_line_definitions_vl jld_2
WHERE   aad.application_id = 222
       AND aad.product_rule_code = nvl(''##$$AADCODE$$##'' ,aad.product_rule_code)
       AND aad.amb_context_code = ''##$$CONTEXT$$##''
       ...
       AND jld.application_id = aad.application_id
       AND jld.amb_context_code = aad.amb_context_code
       AND jld.event_class_code = jlt.event_class_code
       AND jld.event_type_code = jlt.event_type_code
       AND jld.line_definition_owner_code = jlt.line_definition_owner_code
       AND jld.line_definition_code = jlt.line_definition_code
       AND jlt.amb_context_code = jld.amb_context_code
       AND jlt.application_id = jld.application_id
       AND jld.event_class_code = Nvl(''##$$EVENTCLASS$$##'',jld.event_class_code)
       AND jld.line_definition_code =  nvl(''##$$JLDCODE$$##'' ,jld.line_definition_code )
       AND jlt.accounting_line_code =  nvl(''##$$JLTCODE$$##'',jlt.accounting_line_code)
       AND jlt.event_class_code =jld.event_class_code
       AND jlt.event_type_code =jld.event_type_cod
       AND jlt.description_code IS NOT NULL
       AND jlt.description_type_code IS NOT NULL
       AND jld_2.enabled_flag = ''Y''
       AND jld_2.event_class_code = jld.event_class_code
       AND jld_2.event_type_code = jld.event_type_code
       AND jld_2.application_id = jld.application_id
       ...
       AND jld.line_definition_owner_code = jld_2.line_definition_owner_code
       AND jld.line_definition_code = jld_2.line_definition_code',
      p_title                  => 'Journal Entry Description (JED) Associated to the Journal Line types (JLT)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'No Journal Entry Line Description (JED) '||mask_text(g_ldes_append1, nvl( upper(''), 'NO_MASK') )||' <b>'||mask_text(g_ldes_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_solution               => 'There is no Journal Entry Line Description (JED) '||mask_text(g_ldes_append1, nvl( upper(''), 'NO_MASK') )||' <b>'||mask_text(g_ldes_append2, nvl( upper(''), 'NO_MASK') )||'</b>.
<li>Please refer [958394.1] if you want to setup Journal Entry Line Description (JED) to get more details on the journal line. </li> ',
      p_success_msg            => 'This is a data collection of Journal Entry Line Description (JED) Details '||mask_text(g_ldes_append1, nvl( upper(''), 'NO_MASK') )||' <b>'||mask_text(g_ldes_append2, nvl( upper(''), 'NO_MASK') )||'</b>',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_SLA_SETUP_JED_ASSGN_JLT');



debug('begin add_signature: SLA_SETUP_JOURNAL_ENTRY_DEFINITIONS_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22328',
      p_sig_id                 => 'SLA_SETUP_JOURNAL_ENTRY_DEFINITIONS_DETAILS',
      p_sig_sql                => 'SELECT   desf.description_code, 
         desf.description_type_code, 
         desf.description_type_code_dsp, 
         desf.NAME, 
         desf.transaction_coa_name, 
         desf.description, 
         desp.user_sequence  description_priority, 
         desp.description_prio_id, 
         xla_conditions_pkg.Display_condition(desf.application_id,desf.amb_context_code ,NULL,NULL,NULL,NULL,NULL,desp.description_prio_id,NULL,''D'') condition, 
		 xla_descript_details_pkg.Display_desc_prio_details(desp.description_prio_id,desf.transaction_coa_id) detail
FROM     xla_descriptions_fvl desf, 
         xla_desc_priorities desp 
WHERE    desf.application_id = ##$$APPID$$##
         ...
         AND desp.description_code = desf.description_code 
         AND desp.description_type_code = desf.description_type_code 
         AND (desp.description_code,desp.description_type_code) IN 
		 (
SELECT DISTINCT jlt.description_code, 
                jlt.description_type_code 
FROM   xla_product_rules_fvl aad, 
       xla_aad_line_defn_assgns jld, 
       xla_line_defn_jlt_assgns jlt, 
       xla_line_definitions_vl jld_2 
WHERE   aad.application_id = desf.application_id 
       AND aad.product_rule_code = nvl(''##$$AADCODE$$##'' ,aad.product_rule_code)
       AND aad.amb_context_code = desf.amb_context_code        
       AND aad.product_rule_type_code = jld.product_rule_type_code 
       AND aad.product_rule_code = jld.product_rule_code 
       ...
       AND jld.event_class_code = Nvl(''##$$EVENTCLASS$$##'',jld.event_class_code) 
       AND jlt.event_class_code =jld.event_class_code
       AND jlt.event_type_code =jld.event_type_code
       AND jlt.description_code IS NOT NULL 
       AND jlt.description_type_code IS NOT NULL 
       AND jld_2.enabled_flag = ''Y'' 
       AND jld_2.event_class_code = jld.event_class_code
...
ORDER BY NAME,  description_priority',
      p_title                  => 'Journal Entry Line Description Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Journal Entry Line Description (JED) '||mask_text(g_ldes_append1, nvl( upper(''), 'NO_MASK') )||' <b>'||mask_text(g_ldes_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_solution               => 'There is no Journal Entry Line Description (JED) '||mask_text(g_ldes_append1, nvl( upper(''), 'NO_MASK') )||' <b>'||mask_text(g_ldes_append2, nvl( upper(''), 'NO_MASK') )||'</b>.
<li>Please refer [958394.1] if you want to setup Journal Entry Line Description (JED) to get more details on the journal line. </li>',
...
',
   ...
   l_info.delete;
debug('end add_signature: SLA_SETUP_JOURNAL_ENTRY_DEFINITIONS_DETAILS');



debug('begin add_signature: EBS_FIN_AR_SLA_SETUP_MAPPING_SETS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '30488',
      p_sig_id                 => 'EBS_FIN_AR_SLA_SETUP_MAPPING_SETS',
      p_sig_sql                => 'SELECT
 b.mapping_set_code
,flex.id_flex_structure_code acct_coa_id_flex_struct_code
,val.flex_value_set_name
,oval.flex_value_set_name output_flex_value_set_name
,b.flexfield_assign_mode_code
,b.flexfield_segment_code
,b.enabled_flag
,app.application_short_name view_app_short_name
,b.lookup_type
,TO_CHAR(NVL(b.version_num,1)) version_num
,fnd_load_util.owner_name(b.last_updated_by) owner
,TO_CHAR(b.last_update_date, ''YYYY/MM/DD'') last_update_date
,b.name
,b.description
FROM  xla_mapping_sets_vl      b
     ,fnd_application          app
     ,fnd_id_flex_structures   flex
     ,fnd_flex_value_sets      val
     ,fnd_flex_value_sets      oval
WHERE app.application_id(+)       = b.view_application_id
AND   val.flex_value_set_id(+)    = b.value_set_id
AND   oval.flex_value_set_id(+)   = b.flex_value_set_id
AND   flex.id_flex_code(+)        = ''GL#''
AND   flex.application_id(+)      = 101
AND   flex.id_flex_num(+)         = b.accounting_coa_id
AND   b.amb_context_code          = ''DEFAULT''
AND   b.mapping_set_code IN 
      (SELECT value_mapping_set_code
         FROM xla_seg_rule_details       d
            , xla_aad_line_defn_assgns x
            , xla_line_defn_adr_assgns y
        WHERE d.application_id             = y.application_id
          AND d.amb_context_code           = y.amb_context_code
          AND d.segment_rule_type_code     = y.segment_rule_type_code
          AND d.segment_rule_code          = y.segment_rule_code
          AND x.application_id             = y.application_id
          AND x.amb_context_code           = y.amb_context_code
          AND x.event_class_code           = y.event_class_code
          AND x.event_type_code            = y.event_type_code
          AND x.line_definition_owner_code = y.line_definition_owner_code
          AND x.line_definition_code       = y.line_definition_code
         AND x.application_id             =  ##$$APPID$$##
          AND x.amb_context_code           =   ''##$$CONTEXT$$##'' )
ORDER BY b.MAPPING_SET_CODE



',
      p_title                  => 'Mapping Sets ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Mapping Sets '||mask_text(g_ev_append1, nvl( upper(''), 'NO_MASK') )||'<b>'||mask_text(g_ev_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_solution               => 'There is no Mapping Sets '||mask_text(g_ev_append1, nvl( upper(''), 'NO_MASK') )||'<b>'||mask_text(g_ev_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_success_msg            => 'This is a data collection of Mapping Sets '||mask_text(g_ev_append1, nvl( upper(''), 'NO_MASK') )||'<b>'||mask_text(g_ev_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_AR_SLA_SETUP_MAPPING_SETS');



debug('begin add_signature: SLA_SETUP_LEDGER');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22213',
      p_sig_id                 => 'SLA_SETUP_LEDGER',
      p_sig_sql                => 'select  ledger_id, name, short_name, description, ledger_category_code
from   gl_ledgers 
where ledger_id =##$$LEDGERID$$##',
      p_title                  => 'Ledger Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Ledger Defined.',
      p_solution               => 'Please verify the chosen ledger exists in the database.',
      p_success_msg            => 'This is the information of the Ledger, <b>'||mask_text(g_ledger_name, nvl( upper(''), 'NO_MASK') )||'</b>, for which this analyzer was run.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SLA_SETUP_LEDGER');



debug('begin add_signature: SLA_SETUP_RELATED_LEDGERS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22212',
      p_sig_id                 => 'SLA_SETUP_RELATED_LEDGERS',
      p_sig_sql                => 'SELECT leg_pri.ledger_id ledger_id, 
       leg_pri.name ledger_name, 
       leg_pri.currency_code currency_code,
       leg_pri.sla_accounting_method_code SLAM, 
       leg_pri.ledger_category_code ledger_type, 
       leg_pri.application_id,
       leg_pri.chart_of_accounts_id
FROM   xla_subledger_options_v leg,
              xla_subledger_options_v leg_pri
WHERE  leg_pri.primary_ledger_id =leg.primary_ledger_id
AND leg.application_id = ##$$APPID$$##
AND leg.application_id =leg_pri.application_id
and leg.ledger_id = ##$$LEDGERID$$##
',
      p_title                  => 'Related Ledger Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Related Ledgers.',
      p_solution               => 'There are no Related Ledgers.',
      p_success_msg            => 'This is a data collection of primary and reporting ledger information associated with Ledger <b>'||mask_text(g_ledger_name, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SLA_SETUP_RELATED_LEDGERS');



debug('begin add_signature: SLA_SETUP_LEGAL_ENTITY');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22214',
      p_sig_id                 => 'SLA_SETUP_LEGAL_ENTITY',
      p_sig_sql                => 'select * from gl_ledger_le_bsv_specific_v where ledger_id =  ##$$LEDGERID$$##',
      p_title                  => 'Legal Entity Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Legal Entity Information.',
      p_solution               => 'There is no Legal Entity Information.',
      p_success_msg            => 'This is a data collection of Legal Entity Information associated with Ledger <b>'||mask_text(g_ledger_name, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SLA_SETUP_LEGAL_ENTITY');



debug('begin add_signature: SLA_SETUP_GL_COA_SEGMENT_Details');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22334',
      p_sig_id                 => 'SLA_SETUP_GL_COA_SEGMENT_Details',
      p_sig_sql                => 'SELECT DISTINCT ldgr.chart_of_accounts_id,
                ldgr.chart_of_accounts_name,
                sgmt.application_column_name,
                sgmt.segment_name,
                sgmt.segment_num,
                ...
                sgmt.default_type,
                sgmt.default_value,
                sgmt.application_column_index_flag,
                sgmt.enabled_flag,
                sgmt.required_flag,
                sgmt.display_flag,
                sgmt.security_enabled_flag,
                sgmt.segment_insert_flag,
                sgmt.segment_update_flag,
                sgmt.additional_where_clause,
                sgmt.security_group_id,
                sgmt.flex_value_set_id                
FROM   gl_ledgers_v ldgr,
       fnd_id_flex_segments sgmt,
       fnd_segment_attribute_values attr
WHERE  ldgr.ledger_id IN ( ##$$LEDGERID$$## )
...
ORDER  BY chart_of_accounts_name,
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No chart of accounts segments associated with Ledger <b>'||mask_text(g_ledger_name, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_solution               => 'Please make sure there is at least one chart of accounts segments associated with Ledger <b>'||mask_text(g_ledger_name, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_success_msg            => 'This is a data collection of chart of accounts segments associated with Ledger <b>'||mask_text(g_ledger_name, nvl( upper(''), 'NO_MASK') )||'</b>.',
   ...
   l_info.delete;
debug('end add_signature: SLA_SETUP_GL_COA_SEGMENT_Details');



debug('begin add_signature: SLA_SETUP_ENTITY_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22215',
      p_sig_id                 => 'SLA_SETUP_ENTITY_TYPES',
      p_sig_sql                => 'SELECT    *
FROM    xla_entity_types_b
WHERE    application_id = ##$$APPID$$##
ORDER BY    entity_code
',
      p_title                  => 'SLA Entity Type Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Entity Types associated with application <b>'||mask_text(g_app_name, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_solution               => 'Please make sure there is at least one Entity Types associated with application <b>'||mask_text(g_app_name, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_success_msg            => 'This is a data collection of Entity Types associated with application <b>'||mask_text(g_app_name, nvl( upper(''), 'NO_MASK') )||'</b>.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: SLA_SETUP_ENTITY_TYPES');



debug('begin add_signature: SLA_SETUP_ENTITY_MAPPING');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22216',
      p_sig_id                 => 'SLA_SETUP_ENTITY_MAPPING',
      p_sig_sql                => 'SELECT    entity_code,
...
ORDER BY    entity_code
',
      p_title                  => 'SLA Entity Mapping Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Entity Mapping associated with application <b>'||mask_text(g_app_name, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_solution               => 'Please make sure there is at least one Entity Mapping associated with application <b>'||mask_text(g_app_name, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_success_msg            => 'This is a data collection of Entity Mapping associated with application <b>'||mask_text(g_app_name, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SLA_SETUP_ENTITY_MAPPING');



debug('begin add_signature: SLA_SETUP_EVENT_CLASSES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22217',
      p_sig_id                 => 'SLA_SETUP_EVENT_CLASSES',
      p_sig_sql                => ' SELECT
    ec.entity_code,
    ec.event_class_code,
    ec.enabled_flag
FROM    xla_event_classes_b ec,
    xla_entity_types_b et
WHERE    et.application_id = ##$$APPID$$## 
    AND et.application_id = ec.application_id
    AND et.entity_code = ec.entity_code
ORDER BY    ec.entity_code,
    ec.event_class_code ',
      p_title                  => 'Event Class Information',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Event Classes associated with application <b>'||mask_text(g_app_name, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_solution               => 'Please make sure there is at least one Event Classes associated with application <b>'||mask_text(g_app_name, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_success_msg            => 'This is a data collection of Event Classes associated with application <b>'||mask_text(g_app_name, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SLA_SETUP_EVENT_CLASSES');



debug('begin add_signature: SLA_SETUP_EVENT_CLASS_PREDECESSORS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22218',
      p_sig_id                 => 'SLA_SETUP_EVENT_CLASS_PREDECESSORS',
      p_sig_sql                => 'SELECT
    event_class_code,
    prior_event_class_code,
    prior_event_class_name,
    prior_entity_name
FROM
    xla_event_class_predecs_f_v
WHERE
    application_id =  ##$$APPID$$##
ORDER BY
    event_class_code',
      p_title                  => 'Event Class Predecessors',
      p_fail_condition         => 'NRS',
      p_problem_descr          => ' ',
      p_solution               => '',
      p_success_msg            => 'This is a data collection of Event Class Predecessors associated with application <b>'||mask_text(g_app_name, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SLA_SETUP_EVENT_CLASS_PREDECESSORS');



debug('begin add_signature: SLA_SETUP_EVENT_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22219',
      p_sig_id                 => 'SLA_SETUP_EVENT_TYPES',
      p_sig_sql                => 'SELECT
    ec.entity_code,
    ec.event_class_code,
    evt.event_type_code,
    ...
    evt.enabled_flag
FROM
    xla_event_types_b evt,
    xla_event_classes_b ec,
    xla_entity_types_b et
WHERE
    et.application_id = ##$$APPID$$##
    AND ec.event_class_code = nvl(''##$$EVENTCLASS$$##'', ec.event_class_code)
    AND et.application_id = ec.application_id
    AND ec.application_id = evt.application_id
    AND et.entity_code = ec.entity_code
    AND ec.entity_code = evt.entity_code
    AND ec.event_class_code = evt.event_class_code
ORDER BY
    ec.entity_code,
    event_class_code,
    event_type_code',
      p_title                  => 'Event Class Types',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Event Class Types  '||mask_text(g_ev_append1, nvl( upper(''), 'NO_MASK') )||' <b>'||mask_text(g_ev_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_solution               => 'Please make sure there is at least one Event Class Types '||mask_text(g_ev_append1, nvl( upper(''), 'NO_MASK') )||' <b>'||mask_text(g_ev_append2, nvl( upper(''), 'NO_MASK') )||'</b>. ',
      p_success_msg            => 'This is a data collection of Event Class Types '||mask_text(g_ev_append1, nvl( upper(''), 'NO_MASK') )||' <b>'||mask_text(g_ev_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SLA_SETUP_EVENT_TYPES');



debug('begin add_signature: SLA_SETUP_IDENTIFIERS_RPT_VIEWS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22220',
      p_sig_id                 => 'SLA_SETUP_IDENTIFIERS_RPT_VIEWS',
      p_sig_sql                => 'SELECT
    ea.entity_code,
    ea.event_class_code,
    em.column_name,
    ea.reporting_view_name,
    ea.event_class_group_code,
    ea.je_category_name
FROM
    xla_event_mappings_vl em,
    xla_event_class_attrs ea
WHERE
    em.application_id = ##$$APPID$$##
    AND em.event_class_code = nvl(''##$$EVENTCLASS$$##'', em.event_class_code)
    AND em.application_id = ea.application_id
    AND em.event_class_code = ea.event_class_code
ORDER BY
    ea.entity_code,
    em.event_class_code',
      p_title                  => 'Transaction Identifiers and Reporting View',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Transaction Identifiers and Reporting View '||mask_text(g_ev_append1, nvl( upper(''), 'NO_MASK') )||'<b>'||mask_text(g_ev_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_solution               => 'Please make sure there is at least one Transaction Identifiers and Reporting View '||mask_text(g_ev_append1, nvl( upper(''), 'NO_MASK') )||'<b>'||mask_text(g_ev_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_success_msg            => 'This is a data collection of Transaction Identifiers and Reporting View '||mask_text(g_ev_append1, nvl( upper(''), 'NO_MASK') )||'<b>'||mask_text(g_ev_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SLA_SETUP_IDENTIFIERS_RPT_VIEWS');



debug('begin add_signature: SLA_SETUP_EVENT_CLASS_OPTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22221',
      p_sig_id                 => 'SLA_SETUP_EVENT_CLASS_OPTIONS',
      p_sig_sql                => 'SELECT *
FROM
    xla_event_class_attrs_fvl
WHERE
    application_id = ##$$APPID$$##
    AND event_class_code = nvl(''##$$EVENTCLASS$$##'', event_class_code)
ORDER BY
    entity_code,
    event_class_code ',
      p_title                  => 'Event Class Options',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Event Class Options '||mask_text(g_ev_append1, nvl( upper(''), 'NO_MASK') )||'<b>'||mask_text(g_ev_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_solution               => 'Please make sure there is at least one Event Class Options '||mask_text(g_ev_append1, nvl( upper(''), 'NO_MASK') )||'<b>'||mask_text(g_ev_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_success_msg            => 'This is a data collection of Event Class Options '||mask_text(g_ev_append1, nvl( upper(''), 'NO_MASK') )||'<b>'||mask_text(g_ev_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SLA_SETUP_EVENT_CLASS_OPTIONS');



debug('begin add_signature: SLA_SETUP_EXTRACT_OBJECTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22337',
      p_sig_id                 => 'SLA_SETUP_EXTRACT_OBJECTS',
      p_sig_sql                => 'SELECT *
FROM   xla_extract_objects
WHERE  application_id = ##$$APPID$$##
AND event_class_code = nvl(''##$$EVENTCLASS$$##'', event_class_code)',
      p_title                  => 'Extract Objects',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Extract Objects '||mask_text(g_ev_append1, nvl( upper(''), 'NO_MASK') )||'<b>'||mask_text(g_ev_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_solution               => 'Please make sure there is at least one Extract Objects '||mask_text(g_ev_append1, nvl( upper(''), 'NO_MASK') )||'<b>'||mask_text(g_ev_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_success_msg            => 'This is a data collection of Extract Objects '||mask_text(g_ev_append1, nvl( upper(''), 'NO_MASK') )||'<b>'||mask_text(g_ev_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SLA_SETUP_EXTRACT_OBJECTS');



debug('begin add_signature: SLA_SETUP_EVENT_CLASS_ACCOUNTING_ATTRIBUTE');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22343',
      p_sig_id                 => 'SLA_SETUP_EVENT_CLASS_ACCOUNTING_ATTRIBUTE',
      p_sig_sql                => 'select * from XLA_EVT_CLASS_ACCT_ATTRS  
where application_id = ##$$APPID$$##
and event_class_code =  nvl(''##$$EVENTCLASS$$##'',''DUMMY'')',
      p_title                  => 'Accounting Attributes Assignments',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Accounting Attributes '||mask_text(g_ev_append1, nvl( upper(''), 'NO_MASK') )||'<b>'||mask_text(g_ev_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_solution               => 'Please make sure there are Accounting Attributes '||mask_text(g_ev_append1, nvl( upper(''), 'NO_MASK') )||'<b>'||mask_text(g_ev_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_success_msg            => 'This is a data collection of Accounting Attributes '||mask_text(g_ev_append1, nvl( upper(''), 'NO_MASK') )||'<b>'||mask_text(g_ev_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SLA_SETUP_EVENT_CLASS_ACCOUNTING_ATTRIBUTE');



debug('begin add_signature: SLA_SETUP_REFERENCE_OBJECTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22338',
      p_sig_id                 => 'SLA_SETUP_REFERENCE_OBJECTS',
      p_sig_sql                => 'SELECT *
FROM   xla_reference_objects
WHERE  application_id = ##$$APPID$$##
AND event_class_code = nvl(''##$$EVENTCLASS$$##'', event_class_code)',
      p_title                  => 'Reference Objects',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Reference Objects '||mask_text(g_ev_append1, nvl( upper(''), 'NO_MASK') )||'<b>'||mask_text(g_ev_append2, nvl( upper(''), 'NO_MASK') )||'</b>. ',
      p_solution               => 'There is no Reference Objects for '||mask_text(g_ev_append1, nvl( upper(''), 'NO_MASK') )||'<b>'||mask_text(g_ev_append2, nvl( upper(''), 'NO_MASK') )||'</b>. ',
      p_success_msg            => 'This is a data collection of Reference Objects '||mask_text(g_ev_append1, nvl( upper(''), 'NO_MASK') )||'<b>'||mask_text(g_ev_append2, nvl( upper(''), 'NO_MASK') )||'</b>. ',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SLA_SETUP_REFERENCE_OBJECTS');



debug('begin add_signature: SLA_SETUP_SOURCES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22336',
      p_sig_id                 => 'SLA_SETUP_SOURCES',
      p_sig_sql                => 'SELECT *
FROM   xla_sources_fvl
WHERE  application_id = ##$$APPID$$##
       AND source_type_code <> ''D''
ORDER  BY source_code  ',
      p_title                  => 'Source Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Sources associated with application <b>'||mask_text(g_app_name, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_solution               => 'Please make sure there are Sources associated with application <b>'||mask_text(g_app_name, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_success_msg            => 'This is a data collection of Sources associated with application <b>'||mask_text(g_app_name, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SLA_SETUP_SOURCES');



debug('begin add_signature: SLA_SETUP_CUSTOM_SOURCE_DETAILS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22335',
      p_sig_id                 => 'SLA_SETUP_CUSTOM_SOURCE_DETAILS',
      p_sig_sql                => ' SELECT src.source_code,
       src.NAME source_name,
       src.description,
       src.datatype_code,
       srcp.source_param_id,
       srcp.user_sequence,
       srcp.parameter_type_code,
       srcp.ref_source_code,
       srcp.constant_value,
       src.enabled_flag,
       src.datatype_code,
       src.plsql_function_name,
       src.flex_value_set_name,
       src.visible_flag,
       src.sum_flag,
       src.translated_flag,
       src.key_flexfield_flag
FROM   xla_source_params srcp,
       xla_sources_fvl src
WHERE  srcp.application_id = ##$$APPID$$##
       AND srcp.application_id = src.application_id
       AND srcp.source_code = src.source_code
       AND src.source_type_code = ''D''
ORDER  BY src.source_code  	',
      p_title                  => 'Custom Source Details',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Custom Sources associated with application <b>'||mask_text(g_app_name, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_solution               => 'There are no Custom Sources associated with application <b>'||mask_text(g_app_name, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_success_msg            => 'This is a data collection of Custom Sources associated with application <b>'||mask_text(g_app_name, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SLA_SETUP_CUSTOM_SOURCE_DETAILS');



debug('begin add_signature: SLA_SETUP_AAD_SOURCES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22329',
      p_sig_id                 => 'SLA_SETUP_AAD_SOURCES',
      p_sig_sql                => 'SELECT DISTINCT    s1.*
FROM
    xla_aad_sources s1,
    xla_acctg_method_rules_fvl xamr
WHERE
    s1.application_id = xamr.application_id
    AND s1.product_rule_code = xamr.product_rule_code
    AND s1.amb_context_code = xamr.amb_context_code
    AND xamr.application_id = ##$$APPID$$##
    AND xamr.amb_context_code = ''##$$CONTEXT$$##'' 
    AND SYSDATE <= nvl(xamr.end_date_active, SYSDATE)
    AND xamr.product_rule_code = nvl(''##$$AADCODE$$##'' ,xamr.product_rule_code)
ORDER BY
    event_class_code,
    source_level_code,
    source_code',
      p_title                  => 'Sources Associated with AAD',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No Sources associated with Application Accounting Definition(AAD) <b>'||mask_text(g_aad_name, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_solution               => 'There is no Sources associated with Application Accounting Definition(AAD) <b>'||mask_text(g_aad_name, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_success_msg            => 'This is a data collection of Sources associated with Application Accounting Definition(AAD) <b>'||mask_text(g_aad_name, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: SLA_SETUP_AAD_SOURCES');



debug('begin add_signature: EBS_FIN_SLA_SETUP_AAD_INVALID');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23539',
      p_sig_id                 => 'EBS_FIN_SLA_SETUP_AAD_INVALID',
...
xamr.PRODUCT_RULE_NAME  DEFINITION_NAME,
xpr.compile_status_code COMPILE_STATUS
FROM xla_product_rules_b xpr ,
xla_acctg_method_rules_fvl xamr,
gl_ledgers gl
WHERE xpr.application_id = ##$$APPID$$##
AND xpr.compile_status_code IN (''N'', ''E'', ''R'',''I'')
AND xpr.product_rule_code = xamr.product_rule_code
AND xamr.application_id = xpr.application_id
AND sysdate < = nvl(xamr.end_date_active, sysdate)
AND xamr.amb_context_code =  xpr.amb_context_code
AND xpr.amb_context_code =  ''##$$CONTEXT$$##''
AND xamr.accounting_method_code = gl.sla_accounting_method_code
AND xpr.product_rule_code = ''##$$AADCODE$$##''
...
<li>Please log a Service Request if you need assistance validating Application Accounting Definition</li>
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_SLA_SETUP_AAD_INVALID');



debug('begin add_signature: EBS_FIN_SLA_SETUP_AAD_IN_VALIDATING_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23540',
      p_sig_id                 => 'EBS_FIN_SLA_SETUP_AAD_IN_VALIDATING_STATUS',
      p_sig_sql                => 'select product_rule_code, validation_status_code status_code, entity_code invalid_object
	from xla_prod_acct_headers
	where application_id =  ##$$APPID$$##
	and validation_status_code = ''R'' 
       and product_rule_code = ''##$$AADCODE$$##''
union
select product_rule_code, compile_status_code status_code, product_rule_code invalid_object
	from xla_product_rules_b
	where application_id =  ##$$APPID$$##
	and compile_status_code = ''R''
         and product_rule_code = ''##$$AADCODE$$##''',
      p_title                  => 'Application Accounting Definition in Validating Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The Application Accounting Definition is in Validating Status',
      p_solution               => '<ul>
<li>Please review Validate Application Accounting Definitions From the Form Does Not Complete and Remains Stuck with Status ''Validating'' [2881865.1]</li>
<li>Please log a Service Request if you need assistance validating Application Accounting Definition</li>
</ul>	',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_SLA_SETUP_AAD_IN_VALIDATING_STATUS');



debug('begin add_signature: EBS_FIN_SLA_SETUP_MULTIPLE_ACTIVE_AADS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '23541',
      p_sig_id                 => 'EBS_FIN_SLA_SETUP_MULTIPLE_ACTIVE_AADS',
...
where application_id =  ##$$APPID$$##
and   amb_context_code = ''##$$CONTEXT$$##''
and accounting_method_code =''##$$SLAM$$##''
and end_date_active is null',
      p_title                  => 'Multiple Active AADs Associated with SLAM',
      p_fail_condition         => 'RSGT1',
      p_problem_descr          => 'There is more than one active  Application Accounting Definition (AAD) associated with the Subledger Accounting Method (SLAM)
',
      p_solution               => '<ul>
 The analyzer has identified data corruption described in [1587401.1]

<li>Please follow the steps provided in the document.  If there is still an issue, please log a Service Request and upload this output file.</li>
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_SLA_SETUP_MULTIPLE_ACTIVE_AADS');



debug('begin add_signature: EBS_FIN_SLA_SETUP_ENDDATED_XLA_BF_LU');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24252',
      p_sig_id                 => 'EBS_FIN_SLA_SETUP_ENDDATED_XLA_BF_LU',
      p_sig_sql                => 'SELECT  distinct xld.event_class_code, xld.event_type_code,
xld.accounting_line_type_code, xld.accounting_line_code
, xld.amb_context_code
, xld.line_definition_owner_code
,xld.line_definition_code
, xal.business_class_code
FROM xla_line_defn_jlt_assgns    xld, xla_acct_line_types_b xal
WHERE xld.application_id             = ##$$APPID$$##
AND xld.amb_context_code           =''##$$CONTEXT$$##''
AND xld.event_class_code           = ''##$$EVENTCLASS$$##''
AND xld.line_definition_code       = ''##$$JLDCODE$$##''
...
AND lkp.end_date_active            IS NULL) ',
      p_title                  => 'Journal Line Types effected by end-dated Create Accounting Business Flow lookup',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The business flow lookup is end dated.',
      p_solution               => '<ul> The analyzer has identified data corruption described in [1910845.1] </li> <li>Please log a Service Request and upload this analyzer output.</li> </ul>',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_SLA_SETUP_ENDDATED_XLA_BF_LU');



debug('begin add_signature: EBS_FIN_SLA_SETUP_INVALID_ACCOUNTING_PKG');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24254',
      p_sig_id                 => 'EBS_FIN_SLA_SETUP_INVALID_ACCOUNTING_PKG',
      p_sig_sql                => 'select   object_name, status , object_type
from all_objects 
where owner = ''APPS'' 
and status = ''INVALID''
and object_name in 
(select Decode (l.enable_budgetary_control_flag, ''Y'', ''XLA_'' || LPAD(c.application_id ,5 ,0) || ''_AAD_''|| c.product_rule_type_code || ''_'' || LPAD(c.product_rule_hash_id,6 ,0) || ''_BC_PKG'',
                                                                                    ''XLA_'' || LPAD(c.application_id ,5 ,0) || ''_AAD_''|| c.product_rule_type_code || ''_'' || LPAD(c.product_rule_hash_id,6 ,0) || ''_PKG'')OBJECT_NAME
from xla_acctg_method_rules b,
xla_product_rules_vl c,
 gl_ledgers l
where b.accounting_method_code =l.sla_accounting_method_code
and l.ledger_id = 1
and b.application_id = ##$$APPID$$##
and b.amb_context_code =''##$$CONTEXT$$##'' 
and c.product_rule_code = b.product_rule_code
AND b.product_rule_code = ''##$$AADCODE$$##'' 
and c.application_id = b.application_id
and c.amb_context_code = b.amb_context_code)',
      p_title                  => 'Invalid Accounting Package',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The Accounting package is not valid.',
      p_solution               => 'The accounting package associated with Application Accounting Definition(AAD) <b>'||mask_text(g_aad_name, nvl( upper(''), 'NO_MASK') )||'</b> is not valid.<li> Please review [461990.1] for steps to run Import and Validate Accounting Definitions. </li> <li>Please log a Service Request if you need assistance validating Application Accounting Definition.</li> ',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_SLA_SETUP_INVALID_ACCOUNTING_PKG');



debug('begin add_signature: EBS_FIN_SLA_SETUP_MFAR_PURGED_JLT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24251',
      p_sig_id                 => 'EBS_FIN_SLA_SETUP_MFAR_PURGED_JLT',
      p_sig_sql                => 'Select (1) from (select (1) from XLA_LINE_DEFN_JLT_ASSGNS where
accounting_line_code=''MFAR_CM_APP_FROM_REC''
and application_id =222
union
select (1) from xla_acct_line_types_tl
where accounting_line_code=''MFAR_CM_APP_FROM_REC''
and application_id =222 )tab
where ''YES'' = (SELECT decode(FND_PROFILE.value(''AR_MFAR_ACTIVATED'')
,''Y'',''YES'',''N'',''NO'',''NULL'') AR_MFAR_ACTIVATED
from dual)',
      p_title                  => 'MFAR Application Accounting Definitions contains purged JLT',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'There is purged Journal line type in MFAR Application Accounting Definitions.',
      p_solution               => '<ul> The analyzer has identified data corruption described in [1554597.1]  <li>Please log a Service Request and upload this analyzer output.</li>  </ul>
',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_SLA_SETUP_MFAR_PURGED_JLT');



debug('begin add_signature: EBS_FIN_SLA_SETUP_MULTIPLE_JLDS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24253',
      p_sig_id                 => 'EBS_FIN_SLA_SETUP_MULTIPLE_JLDS',
      p_sig_sql                => 'SELECT   ld.event_class_code, 
         ld.event_type_code,
         ec.event_class_name eventclass_name,
         et.name eventtype_name, 
...
WHERE    lda.application_id =  ##$$APPID$$##
         ...
         AND lda.amb_context_code = ''##$$CONTEXT$$##''
         AND ld.amb_context_code = lda.amb_context_code
         AND lda.event_class_code =''##$$EVENTCLASS$$##''  
         AND ec.application_id = lda.application_id
         AND ec.event_class_code = ld.event_class_code
         AND et.event_type_code = ld.event_type_code
         AND et.application_id = ld.application_id
         ...
         AND et.event_class_code = ec.event_class_code
ORDER BY eventclass_name',
      p_title                  => 'More than one JLD associated to the Event Class',
      p_fail_condition         => 'RSGT1',
      p_problem_descr          => 'There are more than one Journal Line Definitions (JLDs) '||mask_text(g_jld_append1, nvl( upper(''), 'NO_MASK') )||'<b>'||mask_text(g_jld_append2, nvl( upper(''), 'NO_MASK') )||'</b>.',
      p_solution               => 'The analyzer has identified data corruption described in [2910117.1]. <li>If this is not expected and if you need more assistance, please log a Service Request and upload this analyzer output.</li> ',
      p_success_msg            => '',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_SLA_SETUP_MULTIPLE_JLDS');
...
BEGIN
  ...
  analyzer_title := 'Subledger Accounting Setup Analyzer';
...
debug('begin section: SLA_AAD_SETUP');
start_section('AAD Setup', 'SLA_AAD_SETUP');
   set_item_result(run_stored_sig('SLA_SETUP_SLAM'));
   set_item_result(run_stored_sig('SLA_SETUP_AAD'));
   set_item_result(run_stored_sig('SLA_SETUP_JOURNAL_LINE_DEFINITIONS'));
   set_item_result(run_stored_sig('SLA_SETUP_JOURNAL_LINE_TYPES'));
   set_item_result(run_stored_sig('SLA_SETUP_JLT_ACCOUNTING_ATTRIBUTE'));
   set_item_result(run_stored_sig('SLA_SETUP_ACCOUNT_DERIVATION_RULES'));
   set_item_result(run_stored_sig('SLA_SETUP_ACCOUNT_DERIVATION_RULE_DETAILS'));
   set_item_result(run_stored_sig('SLA_SETUP_JOURNAL_ENTRY_HEADER_DEFINITION_DETAILS'));
   set_item_result(run_stored_sig('EBS_FIN_AR_SLA_SETUP_JED_ASSGN_JLT'));
   set_item_result(run_stored_sig('SLA_SETUP_JOURNAL_ENTRY_DEFINITIONS_DETAILS'));
   set_item_result(run_stored_sig('EBS_FIN_AR_SLA_SETUP_MAPPING_SETS'));
end_section;
debug('end section: SLA_AAD_SETUP');

debug('begin section: LEDGER_INFORMATION');
start_section('Ledger Information', 'LEDGER_INFORMATION');
   set_item_result(run_stored_sig('SLA_SETUP_LEDGER'));
   set_item_result(run_stored_sig('SLA_SETUP_RELATED_LEDGERS'));
   set_item_result(run_stored_sig('SLA_SETUP_LEGAL_ENTITY'));
   set_item_result(run_stored_sig('SLA_SETUP_GL_COA_SEGMENT_Details'));
end_section;
debug('end section: LEDGER_INFORMATION');

debug('begin section: SLA_General_Setup');
start_section('SLA General Setup', 'SLA_General_Setup');
   set_item_result(run_stored_sig('SLA_SETUP_ENTITY_TYPES'));
   set_item_result(run_stored_sig('SLA_SETUP_ENTITY_MAPPING'));
   set_item_result(run_stored_sig('SLA_SETUP_EVENT_CLASSES'));
   set_item_result(run_stored_sig('SLA_SETUP_EVENT_CLASS_PREDECESSORS'));
   set_item_result(run_stored_sig('SLA_SETUP_EVENT_TYPES'));
   set_item_result(run_stored_sig('SLA_SETUP_IDENTIFIERS_RPT_VIEWS'));
   set_item_result(run_stored_sig('SLA_SETUP_EVENT_CLASS_OPTIONS'));
   set_item_result(run_stored_sig('SLA_SETUP_EXTRACT_OBJECTS'));
   set_item_result(run_stored_sig('SLA_SETUP_EVENT_CLASS_ACCOUNTING_ATTRIBUTE'));
   set_item_result(run_stored_sig('SLA_SETUP_REFERENCE_OBJECTS'));
end_section;
debug('end section: SLA_General_Setup');

debug('begin section: SLA_SOURCES');
start_section('SLA Sources', 'SLA_SOURCES');
   set_item_result(run_stored_sig('SLA_SETUP_SOURCES'));
   set_item_result(run_stored_sig('SLA_SETUP_CUSTOM_SOURCE_DETAILS'));
   set_item_result(run_stored_sig('SLA_SETUP_AAD_SOURCES'));
end_section;
debug('end section: SLA_SOURCES');

debug('begin section: DATA_INTEGRITY');
start_section('Data Integrity', 'DATA_INTEGRITY');
   set_item_result(run_stored_sig('EBS_FIN_SLA_SETUP_AAD_INVALID'));
   set_item_result(run_stored_sig('EBS_FIN_SLA_SETUP_AAD_IN_VALIDATING_STATUS'));
   set_item_result(run_stored_sig('EBS_FIN_SLA_SETUP_MULTIPLE_ACTIVE_AADS'));
   set_item_result(run_stored_sig('EBS_FIN_SLA_SETUP_ENDDATED_XLA_BF_LU'));
   set_item_result(run_stored_sig('EBS_FIN_SLA_SETUP_INVALID_ACCOUNTING_PKG'));
   set_item_result(run_stored_sig('EBS_FIN_SLA_SETUP_MFAR_PURGED_JLT'));
   set_item_result(run_stored_sig('EBS_FIN_SLA_SETUP_MULTIPLE_JLDS'));
end_section;
