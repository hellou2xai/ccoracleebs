...
REM |                                                                           |
REM | DESCRIPTION                                                               |
REM |    SQL to install package used for Grants Award Analyzer                  |
REM |                                                                           |
REM | HISTORY                                                                   |
REM +===========================================================================+
...
CREATE OR REPLACE PACKAGE gms_analyzer_pkg AUTHID DEFINER AS
...
END gms_analyzer_pkg;
/
show errors


CREATE OR REPLACE PACKAGE BODY gms_analyzer_pkg AS
-- $Id: gms_award_analyzer.sql, 200.21 2026/02/25 21:42:38 aliclin Exp $
...
g_analyzer_doc_id VARCHAR2(15) := TO_CHAR(TRUNC(2627952.1));
...
BEGIN
  ...
  l_step := '2';
    ...
    l_log_file := 'GRANTS_AWARD_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.log';
    l_out_file := 'GRANTS_AWARD_Analyzer_'||l_db_name||'_'||g_params_string||l_date_char||'.html';
    l_step := '4';
...
BEGIN
    ...
    print_out('<TITLE>GRANTS_AWARD Analyzer Report</TITLE>');
...
function updateInternalViewer() {
    ...
    if (window.location.href.indexOf("oracle.com/iss/") >= 0 ||
        ...
        $("div#feedback").find("a.blacklink").attr("href", "https://mosemp.us.oracle.com/epmos/faces/DocumentDisplay?id=2627952.1#feedback");
...
-- page title
    print_out('        <div class="header_title">'||p_analyzer_title|| ' Report <br>
        ...
        <img class="header_version" src="https://www.oracle.com/webfolder/s/analyzer/gms_award_latest_version.gif" title="Click here to download the latest version of Analyzer" alt="Latest Version Icon"></a>');
    print_cloud_image;
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,2255,EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_up_lg" title="Analyzer Feedback: Thumbs Up"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,2255,EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_dn_lg" title="Analyzer Feedback: Thumbs Down"></span></a>');
    print_out('<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},2255,EBS,EBS Financials,EBS - Projects" target="_blank"><span class="af_idea_lg" title="Analyzer Idea"></span></a>');
    print_out('        </div>
    </div>');
...
-- top right menu
    ...
    print_out('<div class="menubutton" id="execParameters" title="Shows the analyzer''s execution parameters" data-popup-open="popup-2">
          ...
          Parameters</div>');
    print_out('<div class="menubutton" id="feedback" title="Opens the Oracle Community feedback thread"><a href="https://community.oracle.com/thread/4310200" class="blacklink" target="new">
...
BEGIN
    ...
    <div style="display: none;">
        ...
        <span id="feedback-azr">2255</span>
...
<div class="ck-content"><p class="MsoNormal"><strong><u>Version 200.21:</u></strong></p><ul><li><p class="MsoNormal">Added new sig and modified solution format on another sig.</p></li>
</ul>
<p class="MsoNormal"><strong><u>Version 200.20:</u></strong></p><ul><li><p class="MsoNormal">Template enhancement: EBS KB Article IDs Shown for Signature KM Links.</p></li>
<li><p class="MsoNormal">Sigs updated for doc ID changes.</p></li>
</ul>
<p class="MsoNormal"><strong><u>Version 200.19:</u></strong></p><ul><li><p class="MsoNormal">Template enhancement.</p></li>
</ul>
<p class="MsoNormal"><strong><u>Version 200.18:</u></strong></p><ul><li><p class="MsoNormal">Several signatures enhanced.</p></li>
</ul>
<p class="MsoNormal"><strong><u>Version 200.17:</u></strong></p><ul><li><p class="MsoNormal">Several signatures enhanced.</p></li>
</ul>
<p class="MsoNormal"><strong><u>Version 200.16:</u></strong></p><ol><li><p class="MsoNormal">New Analyzer Framework version 4.7.3 released with enhancements.</p><ol><li><p class="MsoNormal">SQL*Plus Error fixed: SP2-0027: Input is too long</p></li>
<li><p class="MsoNormal">Ability to click to select rows in output tables</p></li>
</ol>
</li>
<li><p class="MsoNormal">Several signatures enhanced.</p></li>
</ol>
<p class="MsoNormal"><strong><u>Version 200.15:</u></strong></p><ul><li><p class="MsoNormal">One signatures modified.</p></li>
</ul>
<p class="MsoNormal"><span style="mso-fareast-font-family:&apos;Times New Roman&apos;;"><strong><u>Version 200.14:</u></strong></span></p><ul><li class="MsoNormal">One new signature added to "Data Issues" section.</li>
<li class="MsoNormal">Minor fixes to existing signatures</li>
</ul>
<p class="MsoNormal"><span style="mso-fareast-font-family:&apos;Times New Roman&apos;;"><strong><u>Version 200.13:</u></strong></span></p><ol><li><p class="MsoNormal"><span style="mso-fareast-font-family:&apos;Times New Roman&apos;;">Rename “Lifetime Support Policy” with “Critical Alerts”</span></p></li>
<li><p class="MsoNormal"><span style="mso-fareast-font-family:&apos;Times New Roman&apos;;">Added 2 signatures in the section</span></p><ul><li><p class="MsoNormal"><span style="mso-fareast-font-family:&apos;Times New Roman&apos;;">EBS_ATG_UGLE_32BIT_SEQUENCES_CLOSE_TO_MAX</span></p></li>
<li><p class="MsoNormal"><span style="mso-fareast-font-family:&apos;Times New Roman&apos;;">EBS_ATG_UGLE_SEQUENCES_CLOSE_TO_MAXIMUM_VALUE</span></p></li>
</ul>
</li>
<li><p class="MsoNormal"><span style="mso-fareast-font-family:&apos;Times New Roman&apos;;">Framework changes</span></p></li>
</ol>
<p><strong><u>Version 200.12:</u></strong></p><ul><li>Minor fixes to existing signatures</li>
</ul>
</div>
...
<!-- '||l_current_sig||' -->
    ...
    -- Add feedback
	l_html := l_html || '
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},up,Analyzer,2255,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_up" title="Signature Feedback: Thumbs Up"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:17::::11,RIR,RP:P17_SR_NUMBER,P17_THUMB,P17_TYPE,P17_ANALYZER_ID,P17_SIGNATURE_ID,P17_PLA_LINE,P17_PLA_FAMILY,P17_PLA_Area:{SR},dn,Analyzer,2255,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Projects" target="_blank"><span class="thumb_dn" title="Signature Feedback: Thumbs Down"></span></a>
			<a class="detailsmall internal" data-sr-href="https://aseobs.oraclecorp.com/ords/f?p=345:56::::11,RIR,RP:P56_SR,P56_ANALYZER_ID,P56_SIGNATURE_ID,P56_PLA_LINE_ANALYTICS,P56_PLA_FAMILY_1,P56_PLA_Area_1:{SR},2255,'||p_sig.sigrepo_id||',EBS,EBS Financials,EBS - Projects" target="_blank"><span class="af_idea" title="Signature Idea"></span></a>
	</div>';
...
FUNCTION check_rec_patches_1 RETURN VARCHAR2 IS
  /* Signature EBS_FIN_PA_GMS_CHECK_REC_PATCHES */
...
BEGIN
    ...
    print_log('Processing recommended patches signature: EBS_FIN_PA_GMS_CHECK_REC_PATCHES (check_rec_patches_1) "Recommended Patches" (version 3)');
...
IF substr(g_rep_info('Apps Version'),1,6) = '12.1.3' THEN
   ...
   l_col_rows(1)(l_rows) := '16975483';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Grants:CONSOLIDATED CRITICAL CODEFIX PATCH: This patch includes all the critical fixes for Budget Baseline, Revenue/Invoice Generation and mismatch Issue. This patch is recommended for all Oracle Grants Accounting customers.';
   l_col_rows(5)(l_rows) := '[1638535/KB203513]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '19293971';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Oracle Grants Accounting Release 12.1.3+ Recommended Patch Collection 2 [RPC2]';
   l_col_rows(5)(l_rows) := '[1920628/KB203601]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '17861442';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'GMS: CUMULATIVE RELEASE 1 ON TOP OF 12.1.3 DELTA6 RELEASE DATE 23-JAN-2014';
   l_col_rows(5)(l_rows) := '[1618313/KB753745]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '31409070';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '1OFF:29677032:PADEV: WHAT PROCESS POPULATES THE ENCUMBRANCE TASK_ID FROM LD';
   l_col_rows(5)(l_rows) := '[2695729/KB717275]';
...
IF substr(g_rep_info('Apps Version'),1,4) = '12.2' THEN
   ...
   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '34533420';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := 'Intermittent issue while processing Payroll from LD to GMS and some ADLs stamped with the wrong encumbrance task_id';
   l_col_rows(5)(l_rows) := '[2695729/KB717275]';

   l_rows := l_rows + 1;
   l_rel_rows(1)(l_rows) := l_rel;
   l_col_rows(1)(l_rows) := '33440430';
   l_col_rows(2)(l_rows) := 'No';
   l_col_rows(3)(l_rows) := NULL;
   l_col_rows(4)(l_rows) := '1OFF:33018850:REVENUE CORRUPTION AFTER AA FAILURE';
   l_col_rows(5)(l_rows) := '[2822781/KB794595]';

END IF;

   l_extra_info('##SHOW_SQL##'):= 'Y';

   l_sig.sigrepo_id := '25576';
...
';
  ...
  -- Register
  l_step := '60';
  g_signatures('EBS_FIN_PA_GMS_CHECK_REC_PATCHES') := l_sig;

  --Render
  l_step := '70';
  RETURN process_signature_results(
    'EBS_FIN_PA_GMS_CHECK_REC_PATCHES',     -- sig ID
...
debug('begin populate parameters hash table');
   g_parameters.extend();
   g_parameters(g_parameters.LAST).pname := 'Award ID';
   g_parameters(g_parameters.LAST).pvalue := mask_text(p_award_id,'NO_MASK');
   g_parameters.extend();
...
-- Revision and date values can be populated by RCS
  ...
  l_date_char := rtrim(replace('$Date: 2026/02/25 21:42:37 $','$',''));
...
-- Do not report host details (EBSAF-274); reverted by EBSAF-293
  ...
  g_rep_info('File Name') := 'gms_award_analyzer.sql';
...
debug('begin parameter validation: p_award_id');
IF p_award_id IS NULL THEN
   print_error('INVALID ARGUMENT: Parameter Award ID is required.');
...
EXCEPTION
   WHEN NO_DATA_FOUND THEN
   print_error('INVALID ARGUMENT: Invalid Award ID specified.');
   raise invalid_parameters;
   WHEN OTHERS THEN
   print_error('INVALID ARGUMENT: Validation query for p_award_id failed with '||sqlerrm||'.');
   raise invalid_parameters;
END;
END IF;
debug('end parameter validation: p_award_id');
...
--Get Award Number from Award ID
  if (p_award_id is not null) then
    begin
      select award_number
      into l_award_num
    ...
    exception
      when others then
        print_log('Invalid award_id specified.'||sqlerrm);
        raise invalid_parameters;
    end;
  end if;
...
debug('begin populate sql tokens hash table');
   ...
   g_sql_tokens('##$$AWARD_ID$$##') := p_award_id;
   g_masked_tokens('##$$AWARD_ID$$##') := mask_text( g_sql_tokens('##$$AWARD_ID$$##'), 'NO_MASK');
   g_sql_tokens('##$$AWARD_NUM$$##') := l_award_num;
   g_masked_tokens('##$$AWARD_NUM$$##') := mask_text( g_sql_tokens('##$$AWARD_NUM$$##'), 'NO_MASK');
...
debug('begin add_signature: GMS_DC_PRODUCT_INSTALL_STATUS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13116',
      p_sig_id                 => 'GMS_DC_PRODUCT_INSTALL_STATUS',
      p_sig_sql                => 'select t.application_name, 
       b.application_id,
       b.application_short_name ,  
       decode(a.status, ''I'', ''Installed'', ''S'', ''Shared'', ''N'', ''Not Installed'', ''L'', ''Custom'', a.status ) installation_status,
       nvl(a.patch_level,''Not Available'') patch_level
...
and nvl(t.language,''US'')   = ''US''
and a.application_id  = 8402
order by t.application_name',
      p_title                  => 'Grants Installation Status',
      p_fail_condition         => '[installation_status] !=[Installed]',
      p_problem_descr          => 'Grants Accounting is not fully installed.',
      p_solution               => 'If appropriate, use the License Manager to fully install Grants Accounting.<br>
[1133413/KB757523] How To Use License Manager in R12? ',
      p_success_msg            => 'Grants is Installed.',
   ...
   l_info.delete;
debug('end add_signature: GMS_DC_PRODUCT_INSTALL_STATUS');



debug('begin add_signature: GMS_PA_BILLING_LICENSED_REQUIRED');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13249',
      p_sig_id                 => 'GMS_PA_BILLING_LICENSED_REQUIRED',
...
from   fnd_profile_options po,  fnd_profile_option_values pov
 where po.profile_option_name =''PA_BILLING_LICENSED''
  and pov.level_id=''10001'' 
  and pov.application_id = po.application_id
  and pov.profile_option_id = po.profile_option_id',
      p_title                  => 'PA: Licensed to Use Project Billing Profile',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Profile option "PA: Licensed to Use Project Billing" is not set at the Site level.',
      p_solution               => 'Review [2580261/KB304574] R12: Does The Profile Option PA: Licensed to Use Project Billing Need To Be Set When Using Grants Accounting?',
      p_success_msg            => 'Profile option "PA: Licensed to Use Project Billing" is set at the Site level.<br>
Reference: [2580261/KB304574] R12: Does The Profile Option PA: Licensed to Use Project Billing Need To Be Set When Using Grants Accounting?
',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: GMS_PA_BILLING_LICENSED_REQUIRED');



debug('begin add_signature: GMS_ENC_FLAG_SETUP_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13691',
      p_sig_id                 => 'GMS_ENC_FLAG_SETUP_CHECK',
      p_sig_sql                => 'select purch_encumbrance_flag, req_encumbrance_flag
from financials_system_parameters
where purch_encumbrance_flag = ''N''
or purch_encumbrance_flag = NULL
or req_encumbrance_flag= ''N''
or req_encumbrance_flag = NULL
and org_id = ##$$ORG_ID$$##',
      p_title                  => 'Encumbrance Options',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Use Requisition Encumbrance and Use PO Encumbrance options are not enabled.',
      p_solution               => 'Review [2612991/KB762079] R12: To Implement Oracle Grants Accounting, Does Use Requisition Encumbrance and Use PO Encumbrance Options in Oracle Purchasing or Oracle Payables Need To Be Enabled? ',
      p_success_msg            => 'Use Requisition Encumbrance and Use PO Encumbrance options are enabled.<br>
Reference: [2612991/KB762079] R12: To Implement Oracle Grants Accounting, Does Use Requisition Encumbrance and Use PO Encumbrance Options in Oracle Purchasing or Oracle Payables Need To Be Enabled? ',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: GMS_ENC_FLAG_SETUP_CHECK');



debug('begin add_signature: GMS_IMP_INVALID_CWK_OPTION');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13692',
      p_sig_id                 => 'GMS_IMP_INVALID_CWK_OPTION',
      p_sig_sql                => 'select XFACE_CWK_TIMECARDS_FLAG 
from pa_implementations_all 
where org_id = ##$$ORG_ID$$##
and XFACE_CWK_TIMECARDS_FLAG = ''Y''',
      p_title                  => 'Import Contingent Worker Timecard Setting',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The ''Import Contingent Worker Timecards with Purchase Order Integration'' option cannot be used when Grants is implemented in this operating unit.',
      p_solution               => 'Review [2612984/KB760149] R12: How Should The Implementation Option ''Import Contingent Worker Timecards with Purchase Order Integration'' Be Set When Using Grants Accounting?
',
      p_success_msg            => 'The ''Import Contingent Worker Timecards with Purchase Order Integration'' option is not set, which is correct when Grants Accounting is implemented.<br>
Reference: [2612984/KB760149] R12: How Should The Implementation Option ''Import Contingent Worker Timecards with Purchase Order Integration'' Be Set When Using Grants Accounting?',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: GMS_IMP_INVALID_CWK_OPTION');



debug('begin add_signature: GMS_CROSS_CHARGE_ENABLED_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13270',
      p_sig_id                 => 'GMS_CROSS_CHARGE_ENABLED_CHECK',
      p_sig_sql                => 'select * from pa_implementations_all 
where org_id = ##$$ORG_ID$$##
and CC_PROCESS_IU_CODE=''Y''
and CC_PROCESS_IO_CODE = ''Y''',
      p_title                  => 'Cross Charge Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Grants does not support cross charging.',
      p_solution               => 'Review [2572589/KB455436] R12: Does Grants Accounting Support Cross Charge Functionality?',
      p_success_msg            => 'Cross charge is not enabled for Grants.<br>
Grants does not support cross charging, so this the appropriate setup.<br>
For more information, review [2572589/KB455436] R12: Does Grants Accounting Support Cross Charge Functionality? ',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: GMS_CROSS_CHARGE_ENABLED_CHECK');



debug('begin add_signature: GMS_INTERNAL_BILLING_CHECK');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13271',
      p_sig_id                 => 'GMS_INTERNAL_BILLING_CHECK',
      p_sig_sql                => 'select distinct CC_IC_BILLING_RECVR_FLAG,  CC_IC_BILLING_PRVDR_FLAG
from pa_implementations_all 
where org_id = ##$$ORG_ID$$##
and CC_IC_BILLING_RECVR_FLAG=''Y''
or CC_IC_BILLING_PRVDR_FLAG = ''Y''',
      p_title                  => 'Internal Billing Status',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Internal billing setups are incorrect in the Implementation Options form. Grants does not support internal billing.',
      p_solution               => 'Review [2613022/KB752223] R12: Is Internal Billing Supported in Grants Accounting? ',
      p_success_msg            => 'Internal Billing setups are correct in the Implementation Options form.<br>
Reference: [2613022/KB752223] R12: Is Internal Billing Supported in Grants Accounting? ',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: GMS_INTERNAL_BILLING_CHECK');



debug('begin add_signature: GMS_DC_EXPEND_TYPE_IN_COST_SCH');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13174',
      p_sig_id                 => 'GMS_DC_EXPEND_TYPE_IN_COST_SCH',
      p_sig_sql                => 'select * from gms_allowable_expenditures
 where allowability_schedule_id in
     (select allowable_schedule_id
      from gms_awards_all
      where award_id = ##$$AWARD_ID$$##)',
      p_title                  => 'Expenditure Types in Allowed Cost Schedule',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Expenditure type(s) not in the allowed cost schedule.
',
      p_solution               => 'Review [2575727/KB466383] R12: How To Add An Expenditure Type To An Allowed Cost Schedule?
',
      p_success_msg            => 'Expenditure types are included in the allowed cost schedule.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: GMS_DC_EXPEND_TYPE_IN_COST_SCH');



debug('begin add_signature: GMS_PERSONNEL_OUT_OF_SYNC');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13188',
      p_sig_id                 => 'GMS_PERSONNEL_OUT_OF_SYNC',
      p_sig_sql                => 'select a.award_number, ppf.full_name, 
       gp.start_date_active "Start Date", gp.end_date_active "End Date"
  from gms_awards_all a
     , gms_personnel gp
     , per_all_people_f ppf
 where gp.award_role = ''AM''
   and ppf.person_id = gp.person_id
   ...
   and not exists
       ...
       select 1
        ...
        where a.award_project_id = ppp.project_id
          and ppp.resource_type_id = 101
          and ppp.resource_source_id = gp.person_id
          and ppp.start_date_active = gp.start_date_active
          and nvl(ppp.end_date_active,trunc(sysdate)) = nvl(gp.end_date_active, trunc(sysdate))
         )
and a.award_id = ##$$AWARD_ID$$##',
      p_title                  => 'Award Manager Out of Sync',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'GMS_PERSONNEL and PA_PROJECT_PARTIES being out of sync can cause several issues such as:<br>
<ul>
<li>When trying to change anything related to personnel in the Award form, the error GMS_PROJ_MANAGER_NOT_FOUND_1 can occur.</li>
<li>When trying to find an invoice in "Invoice Review" the invoice will not be found.</li>
</ul>',
      p_solution               => 'GDF Patch 14476644:R12.GMS.B correct the data that is out of sync.<p>
References:
<ul>
<li>[281996/KB768334] No Active Project Manager Is Present and GMS_PROJ_MANAGER_NOT_FOUND_1</li>
<li>[1482506/KB726531] R12 Invoice Review - Invoices Not Visible for Awards Where Award Manager Is Terminated</li>
<u/>',
      p_success_msg            => 'Award Manager GMS_PERSONNEL is in sync with PA_PROJECT_PARTIES.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: GMS_PERSONNEL_OUT_OF_SYNC');



debug('begin add_signature: GMS_WORKFLOW_ERROR');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12568',
      p_sig_id                 => 'GMS_WORKFLOW_ERROR',
      p_sig_sql                => 'SELECT A.item_type "ITEM_TYPE"
, b.text_value "AWARD_NUMBER"
, sta.activity_result_code "RESULT"
, a.item_key "ITEM_KEY"
, sta.error_message "ERROR_MESSAGE"
, a.begin_date "BEGIN_DATE"
, a.end_date "END_DATE"
FROM APPS.wf_item_attribute_values b
, APPS.wf_items A
, wf_item_activity_statuses sta
where a.item_type = ''GMSWF''
and b.item_type = a.item_type
AND b.item_key = A.item_key
AND A.item_key = sta.item_key
AND A.item_type = sta.item_type
AND sta.activity_status = ''ERROR'' 
AND b.name = ''AWARD_NUMBER''
AND b.text_value = ''##$$AWARD_NUM$$##''
order by a.item_type, a.item_key, a.begin_date',
      p_title                  => 'Award Workflow Errors',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Award budget approval workflow is in error for award number ##$$AWARD_NUM$$##.',
      p_solution               => 'Review [2108649/KB707993] Grants Accounting: When The Approval Workflow For An Award Budget Is Reject The Budget Amounts Do Not Reset.
',
      p_success_msg            => 'No workflow errors have been found for award number ##$$AWARD_NUM$$##.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: GMS_WORKFLOW_ERROR');



debug('begin add_signature: GMS_DC_DUPLICATE_ADL_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13148',
      p_sig_id                 => 'GMS_DC_DUPLICATE_ADL_LINES',
      p_sig_sql                => 'SELECT expenditure_item_id,
       cdl_line_num,
       award_id,
       adl_line_num,
       project_id,
...
GROUP BY expenditure_item_id, cdl_line_num,
         award_id, adl_line_num,
         project_id, task_id, resource_list_member_id,
         bud_task_id, document_type
HAVING COUNT(*) > 1',
      p_title                  => 'Duplicate Award Distribution Lines',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Duplicate award distribution lines exist in the GMS_AWARD_DISTRIBUTIONS table for award number ##$$AWARD_NUM$$##.<br>
This will cause PRC: Interface Supplier Costs (and possibly other reporting) to fail with an internal error or something similar.',
      p_solution               => 'The analyzer has identified data corruption described in [2574855/KB792223]<br>
Please log a Service Request and upload this analyzer output.',
      p_success_msg            => 'There are no duplicate award distribution lines in the GMS_AWARD_DISTRIBUTIONS table for award number ##$$AWARD_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: GMS_DC_DUPLICATE_ADL_LINES');



debug('begin add_signature: GMS_REQUISITION_MISSING_ADL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12777',
      p_sig_id                 => 'GMS_REQUISITION_MISSING_ADL',
      p_sig_sql                => 'SELECT prd.project_id ,
prd.task_id,
prd.award_id,
pll.requisition_header_id,
prd.distribution_id,
...
WHERE prd.task_id = pt.task_id
AND prd.requisition_line_id = pll.requisition_line_id and prd.project_id = pp.project_id
AND pll.source_type_code <> ''INVENTORY'' -- To ignore Internal requisitons.
and pp.project_type = ppt.project_type
AND nvl(ppt.sponsored_flag,''N'') = ''Y''and NOT exists (SELECT ''1''
FROM gms_award_distributions gad
WHERE gad.distribution_id = prd.distribution_id
AND gad.award_set_id = NVL(prd.award_id ,0)
AND gad.document_type = ''REQ''
AND gad.adl_status = ''A'')',
      p_title                  => 'Missing Award Distribution Lines for Requisitions',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Missing one or more Award Distribution Lines (ADL''s) associated with a requisition on an award.',
      p_solution               => 'Review [1670924/KB746216] R12.1 Grants Accounting: NEW ADL Toolkit Fixes AP SELF ASSESSED TAX Data Issues.',
      p_success_msg            => 'There are no missing Award Distribution Lines (ADL''s) associated with a requisition on an award.<br>
Reference: [1670924/KB746216] R12.1 Grants Accounting: NEW ADL Toolkit Fixes AP SELF ASSESSED TAX Data Issues.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: GMS_REQUISITION_MISSING_ADL');



debug('begin add_signature: GMS_MISSING_EXP_ADL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12776',
      p_sig_id                 => 'GMS_MISSING_EXP_ADL',
      p_sig_sql                => 'SELECT t.project_id,t.task_id,a.expenditure_item_id
from pa.pa_expenditure_items_all a,pa.pa_tasks t, pa.pa_projects_all pp,
pa.pa_project_types_all pt
where a.system_linkage_function <> ''BTC''
and a.task_id = t.task_id
and t.project_id = pp.project_id
and pp.project_type = pt.project_type
and pt.sponsored_flag =''Y''
and NOT EXISTS (select adl.expenditure_item_id from
gms.gms_award_distributions adl
where adl.expenditure_item_id = a.expenditure_item_id
and adl.document_type = ''EXP'' 
and adl.adl_status = ''A'' 
and adl_line_num = 1)',
      p_title                  => 'Missing Award Distribution Lines for Expenditure Items',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Missing one or more Award Distribution Lines (ADL''s) associated with an expenditure item.',
      p_solution               => 'Review [1670924/KB746216] R12.1 Grants Accounting: NEW ADL Toolkit Fixes AP SELF ASSESSED TAX Data Issues.',
      p_success_msg            => 'There are no missing Award Distribution Lines (ADL''s) associated with an expenditure item.<br>
Reference: [1670924/KB746216] R12.1 Grants Accounting: NEW ADL Toolkit Fixes AP SELF ASSESSED TAX Data Issues.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: GMS_MISSING_EXP_ADL');



debug('begin add_signature: GMS_AP_INVOICE_MISSING_ADL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12779',
      p_sig_id                 => 'GMS_AP_INVOICE_MISSING_ADL',
...
pa_tasks pt,
pa_projects_all pp, pa_project_types pt WHERE aid.task_id = pt.task_id
...
FROM gms_award_distributions gad
WHERE gad.invoice_id = aid.invoice_id
AND gad.invoice_distribution_id = aid.invoice_distribution_id
AND gad.award_set_id = NVL(aid.award_id ,0)
AND gad.document_type = ''AP''
AND gad.adl_status = ''A'')',
      p_title                  => 'Missing Award Distribution Lines for AP Invoices',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Missing one or more Award Distribution Lines (ADL''s) associated with an AP Invoice.',
      p_solution               => 'Review [1670924/KB746216] R12.1 Grants Accounting: NEW ADL Toolkit Fixes AP SELF ASSESSED TAX Data Issues.',
      p_success_msg            => 'There are no missing Award Distribution Lines (ADL''s) associated with an AP Invoice.<br>
Reference: [1670924/KB746216] R12.1 Grants Accounting: NEW ADL Toolkit Fixes AP SELF ASSESSED TAX Data Issues.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: GMS_AP_INVOICE_MISSING_ADL');



debug('begin add_signature: GMS_PO_MISSING_ADLS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12778',
      p_sig_id                 => 'GMS_PO_MISSING_ADLS',
      p_sig_sql                => 'SELECT po.po_header_id ,
...
po.award_id,
po.expenditure_type ,
po.expenditure_item_date,
po.expenditure_organization_id ,
po.encumbered_flag
FROM po_distributions_all po,
pa_tasks pt,
pa_projects_all pp,
pa_project_types_all pt
WHERE po.task_id = pt.task_id
and pt.project_id = pp.project_id
and pp.project_type = pt.project_type
and nvl(pt.sponsored_flag,''N'') = ''Y''
and NOT exists (SELECT ''1''
FROM gms_award_distributions gad
WHERE gad.po_distribution_id = po.po_distribution_id
AND gad.award_set_id = NVL(po.award_id ,0)
AND gad.document_type = ''PO''
AND gad.adl_status = ''A'')',
      p_title                  => 'Missing Award Distribution Lines for Purchase Orders',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Missing one or more Award Distribution Lines (ADL''s) associated with a Purchase Order matched to an award.',
      p_solution               => 'Review [1670924/KB746216] R12.1 Grants Accounting: NEW ADL Toolkit Fixes AP SELF ASSESSED TAX Data Issues.',
      p_success_msg            => 'There are no missing Award Distribution Lines (ADL''s) associated with a Purchase Order matched to an award.<br>
Reference: [1670924/KB746216] R12.1 Grants Accounting: NEW ADL Toolkit Fixes AP SELF ASSESSED TAX Data Issues.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: GMS_PO_MISSING_ADLS');



debug('begin add_signature: EBS_FIN_PA_GRANTS_AWARD_2721640_1_DF');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25698',
      p_sig_id                 => 'EBS_FIN_PA_GRANTS_AWARD_2721640_1_DF',
      p_sig_sql                => 'SELECT *
FROM gms_budget_versions
WHERE budget_type_code = ''AC''
AND budget_status_code = ''W''
AND current_flag = ''R''',
      p_title                  => 'Changes To Funding For The Project Are Not Allowed As Budget Re-Baselining Is In Progress For This Project ',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Changes to the funding for the project are not allowed as the budget re-baselining is in progress for this project. ',
      p_solution               => 'Follow the instructions in [2721640/KB157280] Fund Projects Form: Changes To The Funding For The Project Are Not Allowed As The Budget Re-Baselining Is In Progress For This Project.',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GRANTS_AWARD_2721640_1_DF');



debug('begin add_signature: EBS_FIN_PA_GRANTS_AWARD_1337204_1');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '26238',
      p_sig_id                 => 'EBS_FIN_PA_GRANTS_AWARD_1337204_1',
      p_sig_sql                => 'select award_id, award_number, min(expenditure_item_date) mindate, start_date_Active, end_date_Active
from (select g.award_id, award_number,e.expenditure_item_date, a.start_date_Active, a.end_date_Active
from gms_Awards_all a, gms_award_distributions g,
...
and (e.expenditure_item_date < nvl(preaward_date,start_date_Active)
 or e.expenditure_item_date > end_date_Active)
UNION
select g.award_id, award_number,e.expenditure_item_date, start_date_Active, end_date_Active
from gms_Awards_all a, gms_award_distributions g,
ap_invoice_distributions_all e
where g.award_id=a.award_id
and g.document_type=''AP''
and g.award_set_id=e.award_id
and (e.expenditure_item_date < nvl(preaward_date,start_date_Active)
 or e.expenditure_item_date > end_date_Active)
UNION
select g.award_id, award_number,e.expenditure_item_date, start_date_Active, end_date_Active
from gms_Awards_all a, gms_award_distributions g, po_distributions_all e
where g.award_id=a.award_id
and g.document_type=''PO''
and g.award_set_id=e.award_id
and (e.expenditure_item_date < nvl(preaward_date,start_date_Active)
 or e.expenditure_item_date > end_date_Active)
UNION
select g.award_id, award_number,e.expenditure_item_date, start_date_Active, end_date_Active
from gms_Awards_all a, gms_award_distributions g,
po_req_distributions_all e
where g.award_id=a.award_id
and g.document_type=''REQ''
and g.award_set_id=e.award_id
and (e.expenditure_item_date < nvl(preaward_date,start_date_Active)
 or e.expenditure_item_date > end_date_Active)
UNION
SELECT g.award_id, award_number,e.ENCUMBRANCE_ITEM_DATE, a.start_date_Active, a.end_date_Active
from gms_Awards_all a, gms_award_distributions g,
gms_encumbrance_items_all e
where g.award_id=a.award_id
and g.document_type=''ENC''
and g.expenditure_item_id=e.ENCUMBRANCE_ITEM_ID
and (e.encumbrance_item_date < nvl(preaward_date,start_date_Active)
  or e.encumbrance_item_date > end_date_Active))
group by award_id, award_number, start_date_Active, end_date_active',
      p_title                  => 'Expenditures, Commitments Or Encumbrances With Item Dates Beyond The Award, Project Or Task Dates',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Expenditures, commitments, or encumbrances with expenditure item dates exist beyond the award, project or task dates.',
      p_solution               => 'Follow the solution in [1337204/KB794248] Grants Accounting: Baseline Award Budget Fails ORA-00001: unique constraint (GMS.GMS_BALANCES_U1) violated.',
      p_success_msg            => 'Expenditures, commitments, or encumbrances with expenditure item dates do not exist beyond the award, project or task dates.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GRANTS_AWARD_1337204_1');



debug('begin add_signature: EBS_FIN_PA_GRANTS_AWARD_END_DATED_AWARD_OR_INSTALLMENT');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '31104',
      p_sig_id                 => 'EBS_FIN_PA_GRANTS_AWARD_END_DATED_AWARD_OR_INSTALLMENT',
      p_sig_sql                => 'SELECT a.award_number
,a.award_id
,a.hard_limit_flag
,i.installment_num
,spf.project_id
,spf.task_id
,spf.total_funding_amount
,spf.total_revenue_amount
,spf.creation_date
,i.start_date_active install_start_date
,i.end_date_active install_end_date
,i.close_date install_close_date
,i.direct_cost
,i.indirect_cost
,i.active_flag install_active
,i.billable_flag install_billable
,a.start_date_active award_start_date
,a.end_date_active award_end_date
,a.close_date award_close_date
...
,a.billing_offset
,a.billing_cycle_id
FROM gms.gms_summary_project_fundings spf,
gms.gms_installments i,
gms.gms_awards_all a
WHERE spf.installment_id = i.installment_id
AND i.award_id = a.award_id
AND a.award_id = ##$$AWARD_ID$$##
and (i.end_date_active <sysdate or a.end_date_active <sysdate)',
      p_title                  => 'End Dated Award and/or Installment(s)',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'The award and/or installment(s) are end dated.',
      p_solution               => 'Review the solution in Grants Accounting: What to Check When GMS: Generate Draft Revenue Rejection Reason is No Eligible Event or Expenditure Item Exists [337219/KB751406].',
      p_success_msg            => 'The award and/or installment(s) are not end dated.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('W','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GRANTS_AWARD_END_DATED_AWARD_OR_INSTALLMENT');



debug('begin add_signature: GMS_IMPLEMENTATUIONS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13021',
      p_sig_id                 => 'GMS_IMPLEMENTATUIONS_ALL',
      p_sig_sql                => 'select * 
from gms_implementations_all 
where org_id in (select org_id from gms_awards_all where award_id = ##$$AWARD_ID$$##)',
      p_title                  => 'GMS_IMPLEMENTATIONS_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No implementation data found for award number ##$$AWARD_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'Contains the implementation setup information for award number ##$$AWARD_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: GMS_IMPLEMENTATUIONS_ALL');
...
debug('begin add_signature: GMS_AWARDS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '12609',
      p_sig_id                 => 'GMS_AWARDS_ALL',
      p_sig_sql                => 'SELECT * 
FROM gms_awards_all 
WHERE award_id = ##$$AWARD_ID$$##',
      p_title                  => 'GMS_AWARDS_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No data found for award number ##$$AWARD_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'Contains the award detail for award number ##$$AWARD_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('Y','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: GMS_AWARDS_ALL');



debug('begin add_signature: EBS_FIN_PA_GRANTS_AWARD_GMS_AWARD_DISTRIBUTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '24989',
      p_sig_id                 => 'EBS_FIN_PA_GRANTS_AWARD_GMS_AWARD_DISTRIBUTIONS',
      p_sig_sql                => 'SELECT * 
FROM gms_award_distributions
WHERE award_id = ##$$AWARD_ID$$##',
      p_title                  => 'Award Distributions (GMS_AWARD_DISTRIBUTIONS)',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No distribution data found for award number ##$$AWARD_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'Award distribution details for award number ##$$AWARD_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GRANTS_AWARD_GMS_AWARD_DISTRIBUTIONS');



debug('begin add_signature: GMS_DC_FUNDED_PROJECTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13127',
      p_sig_id                 => 'GMS_DC_FUNDED_PROJECTS',
      p_sig_sql                => 'SELECT *  
FROM pa_projects_all  
 WHERE project_id in 
   (select project_id 
     from gms_summary_project_fundings  
       where installment_id in 
        (select installment_id from gms_installments where award_id = ##$$AWARD_ID$$##) )',
      p_title                  => 'Funded Projects',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No funded projects associated with award number ##$$AWARD_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'Contains the funded projects associated with award number ##$$AWARD_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: GMS_DC_FUNDED_PROJECTS');



debug('begin add_signature: GMS_DC_PA_TASKS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13287',
      p_sig_id                 => 'GMS_DC_PA_TASKS',
      p_sig_sql                => 'select *
from pa_tasks
...
ORDER BY task_number',
      p_title                  => 'PA_TASKS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No tasks found for project of award number ##$$AWARD_NUM$$##.
',
      p_solution               => '',
      p_success_msg            => 'Contains the tasks defined for project of award number ##$$AWARD_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: GMS_DC_PA_TASKS');



debug('begin add_signature: GMS_DC_FUNDED_PROJECT_TYPES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13266',
      p_sig_id                 => 'GMS_DC_FUNDED_PROJECT_TYPES',
      p_sig_sql                => 'SELECT pt.* 
FROM pa_project_types_all pt
WHERE pt.project_type in ( 
SELECT project_type 
FROM pa_projects_all 
WHERE project_id in ( 
select project_id from gms_summary_project_fundings 
where installment_id in (select installment_id from gms_installments 
where award_id = ##$$AWARD_ID$$##  ) ) )

',
      p_title                  => 'Funded Project Types',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No project type found for the project of award number ##$$AWARD_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'Project types used in the projects funded by award number ##$$AWARD_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: GMS_DC_FUNDED_PROJECT_TYPES');



debug('begin add_signature: GMS_DC_GMS_INSTALLMENTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13128',
      p_sig_id                 => 'GMS_DC_GMS_INSTALLMENTS',
      p_sig_sql                => 'SELECT *
FROM GMS_INSTALLMENTS
WHERE award_id = ##$$AWARD_ID$$##',
      p_title                  => 'GMS_INSTALLMENTS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No installment details found for award number ##$$AWARD_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'Contains installment details related to award number ##$$AWARD_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: GMS_DC_GMS_INSTALLMENTS');



debug('begin add_signature: GMS_DC_GMS_PROJECT_FUNDINGS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13129',
      p_sig_id                 => 'GMS_DC_GMS_PROJECT_FUNDINGS',
      p_sig_sql                => 'SELECT *
FROM GMS_PROJECT_FUNDINGS
where installment_id in (select installment_id from gms_installments  where award_id = ##$$AWARD_ID$$##)',
      p_title                  => 'GMS_PROJECT_FUNDINGS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No installment-funded projects and funding amounts exist for award number ##$$AWARD_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'Contains the installment-funded projects and funding amounts for award number ##$$AWARD_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: GMS_DC_GMS_PROJECT_FUNDINGS');



debug('begin add_signature: GMS_DC_GMS_SUMMARY_PROJECT_FUNDINGS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13130',
      p_sig_id                 => 'GMS_DC_GMS_SUMMARY_PROJECT_FUNDINGS',
      p_sig_sql                => 'SELECT *
FROM GMS_SUMMARY_PROJECT_FUNDINGS
where installment_id in (select installment_id from gms_installments where award_id = ##$$AWARD_ID$$##)',
      p_title                  => 'GMS_SUMMARY_PROJECT_FUNDINGS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No summarized funding amount information found for the funded project(s) for award number ##$$AWARD_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'Contains summarized funding amount information for the funded project(s) for award number ##$$AWARD_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: GMS_DC_GMS_SUMMARY_PROJECT_FUNDINGS');



debug('begin add_signature: GMS_DC_AWARD_FUNDING_SOURCES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13131',
      p_sig_id                 => 'GMS_DC_AWARD_FUNDING_SOURCES',
      p_sig_sql                => 'select *
from pa_project_customers
where project_id in 
 (select award_project_id from gms_awards_all where award_id = ##$$AWARD_ID$$##)',
      p_title                  => 'Award Customer/Funding Source',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No customer data found for the funding source for award number ##$$AWARD_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'Contains funding sources related to award number ##$$AWARD_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: GMS_DC_AWARD_FUNDING_SOURCES');



debug('begin add_signature: GMS_DC_PA_PROJECT_CONTACTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13132',
      p_sig_id                 => 'GMS_DC_PA_PROJECT_CONTACTS',
      p_sig_sql                => 'select *
from pa_project_contacts 
where project_id  in (select award_project_id from gms_awards_all where award_id = ##$$AWARD_ID$$##)',
      p_title                  => 'Award Customer Contacts',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No funding source contact found for the award funding source for award number ##$$AWARD_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'Contains award funding source contact for award number ##$$AWARD_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: GMS_DC_PA_PROJECT_CONTACTS');



debug('begin add_signature: GMS_AWARDS_CONTACTS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13110',
      p_sig_id                 => 'GMS_AWARDS_CONTACTS',
      p_sig_sql                => 'select *  from gms_awards_contacts
where award_id = ##$$AWARD_ID$$##',
      p_title                  => 'GMS_AWARDS_CONTACTS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No contact exists for award number ##$$AWARD_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'Contains information about the contacts for award number ##$$AWARD_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: GMS_AWARDS_CONTACTS');



debug('begin add_signature: GMS_DC_NOTIFICATIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13930',
      p_sig_id                 => 'GMS_DC_NOTIFICATIONS',
      p_sig_sql                => 'select * from gms_notifications where award_id = ##$$AWARD_ID$$##',
      p_title                  => 'GMS_NOTIFICATIONS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No notifications for award number ##$$AWARD_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'Contains USER_IDS receiving notifications associated with different event types for award number ##$$AWARD_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: GMS_DC_NOTIFICATIONS');



debug('begin add_signature: GMS_DC_GMS_BUDGET_VERSIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13167',
      p_sig_id                 => 'GMS_DC_GMS_BUDGET_VERSIONS',
      p_sig_sql                => 'select * from gms_budget_versions  where award_id = ##$$AWARD_ID$$##',
      p_title                  => 'GMS_BUDGET_VERSIONS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No budget version details found for award number ##$$AWARD_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'Contains the versions of the award budgets for award number ##$$AWARD_NUM$$##. 
<br>There are three categories of budget versions: Draft, Baselined, and Original. 
<br>For an award and budget type, there is only one draft budget.
<br>There can be many baselined budgets for an award and budget type. 
<br>One baselined budget version is identified as the current budget and one is identified as the original budget. 
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: GMS_DC_GMS_BUDGET_VERSIONS');



debug('begin add_signature: GMS_DC_GMS_BUDGET_LINES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13168',
      p_sig_id                 => 'GMS_DC_GMS_BUDGET_LINES',
      p_sig_sql                => 'select * from gms_budget_lines  where resource_assignment_id in
    (select resource_assignment_id  from gms_resource_assignments 
     where budget_version_id in         
     (select budget_version_id from gms_budget_versions gbv where award_id = nvl(##$$AWARD_ID$$##, award_id)))',
      p_title                  => 'Award Budget Lines',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No award budget lines exist for award number ##$$AWARD_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'Contains the budget line detail information for award number ##$$AWARD_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: GMS_DC_GMS_BUDGET_LINES');



debug('begin add_signature: GMS_DC_GMS_BUDGETARY_CONTROLS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13169',
      p_sig_id                 => 'GMS_DC_GMS_BUDGETARY_CONTROLS',
      p_sig_sql                => 'select gbc.* 
from gms_budgetary_controls gbc 
where award_id = ##$$AWARD_ID$$##',
      p_title                  => 'GMS_BUDGETARY_CONTROLS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No budgetary controls found for award number ##$$AWARD_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'Contains budgetary control levels for award number ##$$AWARD_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: GMS_DC_GMS_BUDGETARY_CONTROLS');



debug('begin add_signature: GMS_DC_GMS_PERSONNEL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13170',
      p_sig_id                 => 'GMS_DC_GMS_PERSONNEL',
      p_sig_sql                => 'select * from gms_personnel
where award_id = ##$$AWARD_ID$$##',
      p_title                  => 'GMS_PERSONNEL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No award personnel found for award number ##$$AWARD_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'Contains information about the personnel for award number ##$$AWARD_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: GMS_DC_GMS_PERSONNEL');



debug('begin add_signature: GMS_DC_GMS_ALLOWABILITY_SCHEDULES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13172',
      p_sig_id                 => 'GMS_DC_GMS_ALLOWABILITY_SCHEDULES',
      p_sig_sql                => 'select * from gms_allowability_schedules 
where allowability_schedule_id in (
 select allowable_schedule_id from gms_awards_all where award_id = ##$$AWARD_ID$$##)',
      p_title                  => 'GMS_ALLOWABILITY_SCHEDULES',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No allowable schedules found for award number ##$$AWARD_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'Contains the allowability schedules for award number ##$$AWARD_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: GMS_DC_GMS_ALLOWABILITY_SCHEDULES');



debug('begin add_signature: GMS_DC_GMS_ALLOWABLE_EXPENDITURES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13173',
      p_sig_id                 => 'GMS_DC_GMS_ALLOWABLE_EXPENDITURES',
      p_sig_sql                => 'select * from gms_allowable_expenditures 
where allowability_schedule_id in 
 (select allowable_schedule_id from gms_awards_all where award_id = ##$$AWARD_ID$$##)',
      p_title                  => 'GMS_ALLOWABLE_EXPENDITURES',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No expenditure types found for the schedule for award number ##$$AWARD_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'Contains the expenditure types allowed for a particular schedule and what the burden limits are for those expenditure types for award number ##$$AWARD_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: GMS_DC_GMS_ALLOWABLE_EXPENDITURES');



debug('begin add_signature: GMS_DC_GMS_FUNDING_PATTERNS_ALL');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13268',
      p_sig_id                 => 'GMS_DC_GMS_FUNDING_PATTERNS_ALL',
      p_sig_sql                => 'select * 
from gms_funding_patterns_all
where funding_pattern_id in  
 (select funding_pattern_id 
  from gms_fp_distributions where award_id = ##$$AWARD_ID$$## )',
      p_title                  => 'GMS_FUNDING_PATTERNS_ALL',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No funding pattern details found for award number ##$$AWARD_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'Contains funding pattern details for award number ##$$AWARD_NUM$$##.
',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
   ...
   l_info.delete;
debug('end add_signature: GMS_DC_GMS_FUNDING_PATTERNS_ALL');



debug('begin add_signature: GMS_DC_GMS_FP_DISTRIBUTIONS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '13269',
      p_sig_id                 => 'GMS_DC_GMS_FP_DISTRIBUTIONS',
      p_sig_sql                => 'select *  
from gms_fp_distributions 
where funding_pattern_id in   
 (select funding_pattern_id from gms_fp_distributions 
  where award_id = ##$$AWARD_ID$$##)',
      p_title                  => 'GMS_FP_DISTRIBUTIONS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'No funding pattern distribution details found for award number ##$$AWARD_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'Contains the funding pattern distribution details for award number ##$$AWARD_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: GMS_DC_GMS_FP_DISTRIBUTIONS');



debug('begin add_signature: EBS_FIN_PA_GRANTS_AWARD_GMS_BALANCES');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22791',
      p_sig_id                 => 'EBS_FIN_PA_GRANTS_AWARD_GMS_BALANCES',
      p_sig_sql                => 'select * from gms_balances 
where award_id = ##$$AWARD_ID$$## 
order by budget_version_id desc',
      p_title                  => 'Grant Award GMS_BALANCES ',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There is no specific details in GMS_BALANCES table.',
      p_solution               => '',
      p_success_msg            => 'Details from GMS_BALANCES table.',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GRANTS_AWARD_GMS_BALANCES');



debug('begin add_signature: EBS_FIN_PA_GRANTS_AWARD_GMS_BC_PACKETS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '22790',
      p_sig_id                 => 'EBS_FIN_PA_GRANTS_AWARD_GMS_BC_PACKETS',
      p_sig_sql                => 'select * from gms_bc_packets where award_id = ##$$AWARD_ID$$##',
      p_title                  => 'Grant Award GMS_BC_PACKETS',
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'There are no specific details in GMS_BC_PACKETS table.',
      p_solution               => '',
      p_success_msg            => 'Details from GMS_BC_PACKETS table.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GRANTS_AWARD_GMS_BC_PACKETS');



debug('begin add_signature: EBS_FIN_PA_GRANTS_AWARD_EXP_ITEMS');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '32146',
      p_sig_id                 => 'EBS_FIN_PA_GRANTS_AWARD_EXP_ITEMS',
      p_sig_sql                => 'SELECT *
...
AND award_id =##$$AWARD_ID$$##)',
      ...
      p_fail_condition         => 'NRS',
      p_problem_descr          => 'Expenditure items for award number ##$$AWARD_NUM$$##.',
      p_solution               => '',
      p_success_msg            => 'No expenditure items for award number ##$$AWARD_NUM$$##.',
      p_print_condition        => nvl('ALWAYS','ALWAYS'),
      p_fail_type              => nvl('I','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('N','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GRANTS_AWARD_EXP_ITEMS');
...
debug('begin add_signature: EBS_FIN_PA_GRANTS_AWARD_2695729_1_CODEFIX');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '25577',
      p_sig_id                 => 'EBS_FIN_PA_GRANTS_AWARD_2695729_1_CODEFIX',
...
((''12.1'' = substr(''##$$REL$$##'',1,4) AND
            Fnd_Irep_Loader_Private.Compare_Versions(
              Adfv.Version,''120.5.12010000.12'') = ''<''
             And Adf.Filename = ''gmsenxfb.pls'' 
             And Adfv.Version in (
  select "Current Version" from (
        ...
        and af1.filename in (''gmsenxfb.pls'')
         )
         where rankUS = 1))
            OR
           (''12.2'' = substr(''##$$REL$$##'',1,4) AND
            Fnd_Irep_Loader_Private.Compare_Versions(
              Adfv.Version,''120.5.12020000.15'') = ''<'' 
             And Adf.Filename = ''gmsenxfb.pls''
             And Adfv.Version in (
  select "Current Version" from (
        select afv1.version "Current Version", rank()over(partition by af1.filename order by afv1.version_segment1 desc,
      ...
      p_title                  => 'Labor Distribution Encumbrance Transactions With Wrong Task Ids Displayed',
      p_fail_condition         => 'RS',
      p_problem_descr          => 'Labor distribution encumbrance transactions with incorrect task id''s are displayed.',
      p_solution               => 'Follow the solution in [2695729/KB717275] Labor Distribution Encumbrance Transactions With Wrong Task Ids Showing in Grants Accounting.',
      p_success_msg            => 'Have code level fix per [2695729/KB717275] Labor Distribution Encumbrance Transactions With Wrong Task Ids Showing in Grants Accounting.',
      p_print_condition        => nvl('FAILURE','ALWAYS'),
      p_fail_type              => nvl('E','W'),
      p_print_sql_output       => nvl('RS','RS'),
      p_limit_rows             => nvl('Y','Y'),
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GRANTS_AWARD_2695729_1_CODEFIX');



debug('begin add_signature: EBS_FIN_PA_GRANTS_AWARD_TRA_ACCOUNT_SETUP');
   l_info('##SHOW_SQL##'):= 'Y';
  add_signature(
      p_sig_repo_id            => '27644',
      p_sig_id                 => 'EBS_FIN_PA_GRANTS_AWARD_TRA_ACCOUNT_SETUP',
...
and ft.org_id = (SELECT org_id FROM gms_awards_all WHERE  award_id = ##$$AWARD_ID$$##)
',
      ...
      p_solution               => 'Follow the solution in [2481918/KB730789] 	GMS: Interface Invoices To Receivables Shows Error: PA_AA_NO_SUCH_TRANS|FTCODE|CONTRACT-ASSET After Upgrade From 12.1.3 to 12.2.8.',
   ...
   l_info.delete;
debug('end add_signature: EBS_FIN_PA_GRANTS_AWARD_TRA_ACCOUNT_SETUP');
...
BEGIN
  ...
  analyzer_title := 'Grants Award Analyzer';
...
start_section('Proactive and Preventative Recommendations', 'Proactive');
   set_item_result(check_rec_patches_1); /* Signature EBS_FIN_PA_GMS_CHECK_REC_PATCHES */
   set_item_result(run_stored_sig('EBS_FIN_PA_PA_FORMS_PERSONALIZATIONS'));
   set_item_result(run_stored_sig('GMS_DC_PRODUCT_INSTALL_STATUS'));
   set_item_result(run_stored_sig('GMS_PA_BILLING_LICENSED_REQUIRED'));
   set_item_result(run_stored_sig('GMS_ENC_FLAG_SETUP_CHECK'));
   set_item_result(run_stored_sig('GMS_IMP_INVALID_CWK_OPTION'));
end_section;
debug('end section: Proactive');

debug('begin section: DataIssues');
start_section('Data Issues', 'DataIssues');
   set_item_result(run_stored_sig('GMS_CROSS_CHARGE_ENABLED_CHECK'));
   set_item_result(run_stored_sig('GMS_INTERNAL_BILLING_CHECK'));
   set_item_result(run_stored_sig('GMS_DC_EXPEND_TYPE_IN_COST_SCH'));
   set_item_result(run_stored_sig('GMS_PERSONNEL_OUT_OF_SYNC'));
   set_item_result(run_stored_sig('GMS_WORKFLOW_ERROR'));
   set_item_result(run_stored_sig('GMS_DC_DUPLICATE_ADL_LINES'));
   set_item_result(run_stored_sig('GMS_REQUISITION_MISSING_ADL'));
   set_item_result(run_stored_sig('GMS_MISSING_EXP_ADL'));
   set_item_result(run_stored_sig('GMS_AP_INVOICE_MISSING_ADL'));
   set_item_result(run_stored_sig('GMS_PO_MISSING_ADLS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_GRANTS_AWARD_2721640_1_DF'));
   IF ((substr(g_rep_info('Apps Version'),1,4) = '12.1') OR 
    (substr(g_rep_info('Apps Version'),1,4) = '12.2')) THEN
      set_item_result(run_stored_sig('EBS_FIN_PA_GRANTS_AWARD_2695729_1_CODEFIX'));
      set_item_result(run_stored_sig('EBS_FIN_PA_GRANTS_AWARD_TRA_ACCOUNT_SETUP'));
   END IF;
   set_item_result(run_stored_sig('EBS_FIN_PA_GRANTS_AWARD_1337204_1'));
   set_item_result(run_stored_sig('EBS_FIN_PA_GRANTS_AWARD_END_DATED_AWARD_OR_INSTALLMENT'));
end_section;
debug('end section: DataIssues');

debug('begin section: DataCollection');
start_section('Data Collection', 'DataCollection');
   set_item_result(run_stored_sig('GMS_IMPLEMENTATUIONS_ALL'));
   set_item_result(run_stored_sig('PA_COST_INT_FLAGS'));
   set_item_result(run_stored_sig('GMS_AWARDS_ALL'));
   set_item_result(run_stored_sig('EBS_FIN_PA_GRANTS_AWARD_GMS_AWARD_DISTRIBUTIONS'));
   set_item_result(run_stored_sig('GMS_DC_FUNDED_PROJECTS'));
   set_item_result(run_stored_sig('GMS_DC_PA_TASKS'));
   set_item_result(run_stored_sig('GMS_DC_FUNDED_PROJECT_TYPES'));
   set_item_result(run_stored_sig('GMS_DC_GMS_INSTALLMENTS'));
   set_item_result(run_stored_sig('GMS_DC_GMS_PROJECT_FUNDINGS'));
   set_item_result(run_stored_sig('GMS_DC_GMS_SUMMARY_PROJECT_FUNDINGS'));
   set_item_result(run_stored_sig('GMS_DC_AWARD_FUNDING_SOURCES'));
   set_item_result(run_stored_sig('GMS_DC_PA_PROJECT_CONTACTS'));
   set_item_result(run_stored_sig('GMS_AWARDS_CONTACTS'));
   set_item_result(run_stored_sig('GMS_DC_NOTIFICATIONS'));
   set_item_result(run_stored_sig('GMS_DC_GMS_BUDGET_VERSIONS'));
   set_item_result(run_stored_sig('GMS_DC_GMS_BUDGET_LINES'));
   set_item_result(run_stored_sig('GMS_DC_GMS_BUDGETARY_CONTROLS'));
   set_item_result(run_stored_sig('GMS_DC_GMS_PERSONNEL'));
   set_item_result(run_stored_sig('GMS_DC_GMS_ALLOWABILITY_SCHEDULES'));
   set_item_result(run_stored_sig('GMS_DC_GMS_ALLOWABLE_EXPENDITURES'));
   set_item_result(run_stored_sig('GMS_DC_GMS_FUNDING_PATTERNS_ALL'));
   set_item_result(run_stored_sig('GMS_DC_GMS_FP_DISTRIBUTIONS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_GRANTS_AWARD_GMS_BALANCES'));
   set_item_result(run_stored_sig('EBS_FIN_PA_GRANTS_AWARD_GMS_BC_PACKETS'));
   set_item_result(run_stored_sig('EBS_FIN_PA_GRANTS_AWARD_EXP_ITEMS'));
end_section;
debug('end section: DataCollection');
